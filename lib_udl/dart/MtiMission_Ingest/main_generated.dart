...
class MtiMissionIngest {
  MtiMissionIngest._(this._bc, this._bcOffset);
  factory MtiMissionIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MtiMissionIngest> reader = _MtiMissionIngestReader();
  ...
  @override
  String toString() {
    return 'MtiMissionIngest{m1: ${m1}, m2: ${m2}, m3: ${m3}, m4: ${m4}, msnRefTs: ${msnRefTs}}';
  }
}

class _MtiMissionIngestReader extends fb.TableReader<MtiMissionIngest> {
  const _MtiMissionIngestReader();

  @override
  MtiMissionIngest createObject(fb.BufferContext bc, int offset) => 
    MtiMissionIngest._(bc, offset);
}

class MtiMissionIngestBuilder {
  MtiMissionIngestBuilder(this.fbBuilder);
...
class MtiMissionIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _m1;
  final String? _m2;
  final String? _m3;
  final String? _m4;
