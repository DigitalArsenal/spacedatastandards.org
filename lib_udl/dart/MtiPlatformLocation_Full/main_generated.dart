...
class MtiPlatformLocationFull {
  MtiPlatformLocationFull._(this._bc, this._bcOffset);
  factory MtiPlatformLocationFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MtiPlatformLocationFull> reader = _MtiPlatformLocationFullReader();
  ...
  @override
  String toString() {
    return 'MtiPlatformLocationFull{l1: ${l1}, l2: ${l2}, l3: ${l3}, l4: ${l4}, l5: ${l5}, l6: ${l6}, l7: ${l7}, platlocts: ${platlocts}}';
  }
}

class _MtiPlatformLocationFullReader extends fb.TableReader<MtiPlatformLocationFull> {
  const _MtiPlatformLocationFullReader();

  @override
  MtiPlatformLocationFull createObject(fb.BufferContext bc, int offset) => 
    MtiPlatformLocationFull._(bc, offset);
}

class MtiPlatformLocationFullBuilder {
  MtiPlatformLocationFullBuilder(this.fbBuilder);
...
class MtiPlatformLocationFullObjectBuilder extends fb.ObjectBuilder {
  final int? _l1;
  final double? _l2;
  final double? _l3;
  final int? _l4;
  ...
  MtiPlatformLocationFullObjectBuilder({
    int? l1,
    double? l2,
    double? l3,
    int? l4,
