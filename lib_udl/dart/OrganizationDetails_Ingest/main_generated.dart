...
class OrganizationDetailsIngestDataModeEnum {
  final int value;
  const OrganizationDetailsIngestDataModeEnum._(this.value);

  factory OrganizationDetailsIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OrganizationDetailsIngestDataModeEnum');
    }
    return result;
  }

  static OrganizationDetailsIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OrganizationDetailsIngestDataModeEnum.fromValue(value);
  ...
  static const OrganizationDetailsIngestDataModeEnum REAL = OrganizationDetailsIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OrganizationDetailsIngestDataModeEnum TEST = OrganizationDetailsIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OrganizationDetailsIngestDataModeEnum SIMULATED = OrganizationDetailsIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OrganizationDetailsIngestDataModeEnum EXERCISE = OrganizationDetailsIngestDataModeEnum._(3);
  static const Map<int, OrganizationDetailsIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OrganizationDetailsIngestDataModeEnum> reader = _OrganizationDetailsIngestDataModeEnumReader();

  @override
  String toString() {
    return 'OrganizationDetailsIngestDataModeEnum{value: $value}';
  }
}

class _OrganizationDetailsIngestDataModeEnumReader extends fb.Reader<OrganizationDetailsIngestDataModeEnum> {
  const _OrganizationDetailsIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OrganizationDetailsIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      OrganizationDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Model representation of additional detailed organization data as collected by a particular source.
class OrganizationDetailsIngest {
  OrganizationDetailsIngest._(this._bc, this._bcOffset);
  factory OrganizationDetailsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OrganizationDetailsIngest> reader = _OrganizationDetailsIngestReader();
  ...
  OrganizationDetailsIngestDataModeEnum get dataMode => OrganizationDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 68, 0));
...
class OrganizationDetailsIngestBuilder {
  ...
  int addDataMode(OrganizationDetailsIngestDataModeEnum? dataMode) {
...
class OrganizationDetailsIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final OrganizationDetailsIngestDataModeEnum? _dataMode;
  final List<String>? _tags;
  final String? _createdAt;
  final String? _createdBy;
  final String? _origNetwork;

  OrganizationDetailsIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    OrganizationDetailsIngestDataModeEnum? dataMode,
    List<String>? tags,
    String? createdAt,
    String? createdBy,
    String? origNetwork,
