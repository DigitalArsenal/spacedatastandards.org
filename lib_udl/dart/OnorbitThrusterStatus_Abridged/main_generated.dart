...
class OnorbitThrusterStatusAbridgedDataModeEnum {
  final int value;
  const OnorbitThrusterStatusAbridgedDataModeEnum._(this.value);

  factory OnorbitThrusterStatusAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OnorbitThrusterStatusAbridgedDataModeEnum');
    }
    return result;
  }

  static OnorbitThrusterStatusAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OnorbitThrusterStatusAbridgedDataModeEnum.fromValue(value);
  ...
  static const OnorbitThrusterStatusAbridgedDataModeEnum REAL = OnorbitThrusterStatusAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OnorbitThrusterStatusAbridgedDataModeEnum TEST = OnorbitThrusterStatusAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OnorbitThrusterStatusAbridgedDataModeEnum SIMULATED = OnorbitThrusterStatusAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OnorbitThrusterStatusAbridgedDataModeEnum EXERCISE = OnorbitThrusterStatusAbridgedDataModeEnum._(3);
  static const Map<int, OnorbitThrusterStatusAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OnorbitThrusterStatusAbridgedDataModeEnum> reader = _OnorbitThrusterStatusAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'OnorbitThrusterStatusAbridgedDataModeEnum{value: $value}';
  }
}

class _OnorbitThrusterStatusAbridgedDataModeEnumReader extends fb.Reader<OnorbitThrusterStatusAbridgedDataModeEnum> {
  const _OnorbitThrusterStatusAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OnorbitThrusterStatusAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      OnorbitThrusterStatusAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Status information for OnorbitThruster objects.
class OnorbitThrusterStatusAbridged {
  OnorbitThrusterStatusAbridged._(this._bc, this._bcOffset);
  factory OnorbitThrusterStatusAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OnorbitThrusterStatusAbridged> reader = _OnorbitThrusterStatusAbridgedReader();
  ...
  OnorbitThrusterStatusAbridgedDataModeEnum get dataMode => OnorbitThrusterStatusAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 50, 0));

  @override
  String toString() {
    return 'OnorbitThrusterStatusAbridged{id: ${id}, classificationMarking: ${classificationMarking}, idOnorbitThruster: ${idOnorbitThruster}, name: ${name}, statusTime: ${statusTime}, propMassMin: ${propMassMin}, propMassAvg: ${propMassAvg}, propMassMedian: ${propMassMedian}, propMassMax: ${propMassMax}, fuelMass: ${fuelMass}, fuelMassUnc: ${fuelMassUnc}, totalDeltaV: ${totalDeltaV}, minDeltaV: ${minDeltaV}, estDeltaV: ${estDeltaV}, maxDeltaV: ${maxDeltaV}, thrustMax: ${thrustMax}, isp: ${isp}, operational: ${operational}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _OnorbitThrusterStatusAbridgedReader extends fb.TableReader<OnorbitThrusterStatusAbridged> {
  const _OnorbitThrusterStatusAbridgedReader();

  @override
  OnorbitThrusterStatusAbridged createObject(fb.BufferContext bc, int offset) => 
    OnorbitThrusterStatusAbridged._(bc, offset);
}

class OnorbitThrusterStatusAbridgedBuilder {
  OnorbitThrusterStatusAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(OnorbitThrusterStatusAbridgedDataModeEnum? dataMode) {
...
class OnorbitThrusterStatusAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final OnorbitThrusterStatusAbridgedDataModeEnum? _dataMode;

  OnorbitThrusterStatusAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    OnorbitThrusterStatusAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
