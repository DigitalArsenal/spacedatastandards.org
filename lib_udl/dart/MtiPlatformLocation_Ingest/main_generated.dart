...
class MtiPlatformLocationIngest {
  MtiPlatformLocationIngest._(this._bc, this._bcOffset);
  factory MtiPlatformLocationIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MtiPlatformLocationIngest> reader = _MtiPlatformLocationIngestReader();
  ...
  @override
  String toString() {
    return 'MtiPlatformLocationIngest{l1: ${l1}, l2: ${l2}, l3: ${l3}, l4: ${l4}, l5: ${l5}, l6: ${l6}, l7: ${l7}, platlocts: ${platlocts}}';
  }
}

class _MtiPlatformLocationIngestReader extends fb.TableReader<MtiPlatformLocationIngest> {
  const _MtiPlatformLocationIngestReader();

  @override
  MtiPlatformLocationIngest createObject(fb.BufferContext bc, int offset) => 
    MtiPlatformLocationIngest._(bc, offset);
}

class MtiPlatformLocationIngestBuilder {
  MtiPlatformLocationIngestBuilder(this.fbBuilder);
...
class MtiPlatformLocationIngestObjectBuilder extends fb.ObjectBuilder {
  final int? _l1;
  final double? _l2;
  final double? _l3;
  final int? _l4;
  ...
  MtiPlatformLocationIngestObjectBuilder({
    int? l1,
    double? l2,
    double? l3,
    int? l4,
