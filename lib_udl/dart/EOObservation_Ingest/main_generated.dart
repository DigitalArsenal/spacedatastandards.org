...
class EoobservationIngestDataModeEnum {
  final int value;
  const EoobservationIngestDataModeEnum._(this.value);

  factory EoobservationIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EoobservationIngestDataModeEnum');
    }
    return result;
  }

  static EoobservationIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EoobservationIngestDataModeEnum.fromValue(value);
  ...
  static const EoobservationIngestDataModeEnum REAL = EoobservationIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EoobservationIngestDataModeEnum TEST = EoobservationIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EoobservationIngestDataModeEnum SIMULATED = EoobservationIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EoobservationIngestDataModeEnum EXERCISE = EoobservationIngestDataModeEnum._(3);
  static const Map<int, EoobservationIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EoobservationIngestDataModeEnum> reader = _EoobservationIngestDataModeEnumReader();

  @override
  String toString() {
    return 'EoobservationIngestDataModeEnum{value: $value}';
  }
}

class _EoobservationIngestDataModeEnumReader extends fb.Reader<EoobservationIngestDataModeEnum> {
  const _EoobservationIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EoobservationIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      EoobservationIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class EoobservationIngestReferenceFrameEnum {
  final int value;
  const EoobservationIngestReferenceFrameEnum._(this.value);

  factory EoobservationIngestReferenceFrameEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EoobservationIngestReferenceFrameEnum');
    }
    return result;
  }

  static EoobservationIngestReferenceFrameEnum? _createOrNull(int? value) => 
      value == null ? null : EoobservationIngestReferenceFrameEnum.fromValue(value);
  ...
  static const EoobservationIngestReferenceFrameEnum J2000 = EoobservationIngestReferenceFrameEnum._(0);

  ///  No description available.
  static const EoobservationIngestReferenceFrameEnum GCRF = EoobservationIngestReferenceFrameEnum._(1);

  ///  No description available.
  static const EoobservationIngestReferenceFrameEnum ITRF = EoobservationIngestReferenceFrameEnum._(2);

  ///  No description available.
  static const EoobservationIngestReferenceFrameEnum TEME = EoobservationIngestReferenceFrameEnum._(3);
  static const Map<int, EoobservationIngestReferenceFrameEnum> values = {
    0: J2000,
    1: GCRF,
    2: ITRF,
    3: TEME};

  static const fb.Reader<EoobservationIngestReferenceFrameEnum> reader = _EoobservationIngestReferenceFrameEnumReader();

  @override
  String toString() {
    return 'EoobservationIngestReferenceFrameEnum{value: $value}';
  }
}

class _EoobservationIngestReferenceFrameEnumReader extends fb.Reader<EoobservationIngestReferenceFrameEnum> {
  const _EoobservationIngestReferenceFrameEnumReader();

  @override
  int get size => 1;

  @override
  EoobservationIngestReferenceFrameEnum read(fb.BufferContext bc, int offset) =>
      EoobservationIngestReferenceFrameEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class EoobservationIngestSenReferenceFrameEnum {
  final int value;
  const EoobservationIngestSenReferenceFrameEnum._(this.value);

  factory EoobservationIngestSenReferenceFrameEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EoobservationIngestSenReferenceFrameEnum');
    }
    return result;
  }

  static EoobservationIngestSenReferenceFrameEnum? _createOrNull(int? value) => 
      value == null ? null : EoobservationIngestSenReferenceFrameEnum.fromValue(value);
  ...
  ///  No description available.
  static const EoobservationIngestSenReferenceFrameEnum J2000 = EoobservationIngestSenReferenceFrameEnum._(0);

  ///  No description available.
  static const EoobservationIngestSenReferenceFrameEnum EFG_TDR = EoobservationIngestSenReferenceFrameEnum._(1);

  ///  No description available.
  static const EoobservationIngestSenReferenceFrameEnum ECR_ECEF = EoobservationIngestSenReferenceFrameEnum._(2);

  ///  No description available.
  static const EoobservationIngestSenReferenceFrameEnum TEME = EoobservationIngestSenReferenceFrameEnum._(3);

  ///  No description available.
  static const EoobservationIngestSenReferenceFrameEnum ITRF = EoobservationIngestSenReferenceFrameEnum._(4);

  ///  No description available.
  static const EoobservationIngestSenReferenceFrameEnum GCRF = EoobservationIngestSenReferenceFrameEnum._(5);
  static const Map<int, EoobservationIngestSenReferenceFrameEnum> values = {
    0: J2000,
    1: EFG_TDR,
    2: ECR_ECEF,
    3: TEME,
  ...
  static const fb.Reader<EoobservationIngestSenReferenceFrameEnum> reader = _EoobservationIngestSenReferenceFrameEnumReader();

  @override
  String toString() {
    return 'EoobservationIngestSenReferenceFrameEnum{value: $value}';
  }
}

class _EoobservationIngestSenReferenceFrameEnumReader extends fb.Reader<EoobservationIngestSenReferenceFrameEnum> {
  const _EoobservationIngestSenReferenceFrameEnumReader();

  @override
  int get size => 1;

  @override
  EoobservationIngestSenReferenceFrameEnum read(fb.BufferContext bc, int offset) =>
      EoobservationIngestSenReferenceFrameEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class EoobservationIngest {
  EoobservationIngest._(this._bc, this._bcOffset);
  factory EoobservationIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EoobservationIngest> reader = _EoobservationIngestReader();
  ...
  EoobservationIngestDataModeEnum get dataMode => EoobservationIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 164, 0));
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 24
  EoobservationIngestReferenceFrameEnum get referenceFrame => EoobservationIngestReferenceFrameEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 176, 0));
  ///  The reference frame of the observing sensor state. If the senReferenceFrame is null it is assumed to be J2000.
  ///  Example: /// Example: J2000
  ///  Constraints: Minimum length = 0, Maximum length = 24
  EoobservationIngestSenReferenceFrameEnum get senReferenceFrame => EoobservationIngestSenReferenceFrameEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 178, 0));
  ///  Boolean indicating that the target object was in umbral eclipse at the time of this observation.
  ///  Example: /// Example: False
  ///  Constraints: No constraints specified.
  bool get umbra => const fb.BoolReader().vTableGet(_bc, _bcOffset, 180, false);
  ///  Boolean indicating that the target object was in a penumbral eclipse at the time of this observation.
  ///  Example: /// Example: False
  ///  Constraints: No constraints specified.
  bool get penumbra => const fb.BoolReader().vTableGet(_bc, _bcOffset, 182, false);
  ...
  ///  Example: /// Example: AXE
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get sourceDl => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 186);
  ///  Read only enumeration specifying the type of observation (e.g. OPTICAL, RADAR, RF, etc).
  ///  Example: /// Example: OPTICAL
  ///  Constraints: No constraints specified.
  String? get type => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 188);

  @override
  String toString() {
    return 'EoobservationIngest{id: ${id}, classificationMarking: ${classificationMarking}, obTime: ${obTime}, corrQuality: ${corrQuality}, idOnOrbit: ${idOnOrbit}, idSensor: ${idSensor}, idSkyImagery: ${idSkyImagery}, collectMethod: ${collectMethod}, satNo: ${satNo}, taskId: ${taskId}, transactionId: ${transactionId}, trackId: ${trackId}, obPosition: ${obPosition}, origObjectId: ${origObjectId}, origSensorId: ${origSensorId}, uct: ${uct}, azimuth: ${azimuth}, azimuthUnc: ${azimuthUnc}, azimuthBias: ${azimuthBias}, azimuthRate: ${azimuthRate}, elevation: ${elevation}, elevationUnc: ${elevationUnc}, elevationBias: ${elevationBias}, elevationRate: ${elevationRate}, range: ${range}, rangeUnc: ${rangeUnc}, rangeBias: ${rangeBias}, rangeRate: ${rangeRate}, rangeRateUnc: ${rangeRateUnc}, ra: ${ra}, raRate: ${raRate}, raUnc: ${raUnc}, raBias: ${raBias}, declination: ${declination}, declinationRate: ${declinationRate}, declinationUnc: ${declinationUnc}, declinationBias: ${declinationBias}, losx: ${losx}, losy: ${losy}, losz: ${losz}, losUnc: ${losUnc}, losxvel: ${losxvel}, losyvel: ${losyvel}, loszvel: ${loszvel}, senlat: ${senlat}, senlon: ${senlon}, senalt: ${senalt}, senx: ${senx}, seny: ${seny}, senz: ${senz}, senvelx: ${senvelx}, senvely: ${senvely}, senvelz: ${senvelz}, senQuat: ${senQuat}, fovCount: ${fovCount}, expDuration: ${expDuration}, zeroptd: ${zeroptd}, netObjSig: ${netObjSig}, netObjSigUnc: ${netObjSigUnc}, mag: ${mag}, magUnc: ${magUnc}, magNormRange: ${magNormRange}, geolat: ${geolat}, geolon: ${geolon}, geoalt: ${geoalt}, georange: ${georange}, skyBkgrnd: ${skyBkgrnd}, primaryExtinction: ${primaryExtinction}, primaryExtinctionUnc: ${primaryExtinctionUnc}, solarPhaseAngle: ${solarPhaseAngle}, solarEqPhaseAngle: ${solarEqPhaseAngle}, solarDecAngle: ${solarDecAngle}, shutterDelay: ${shutterDelay}, timingBias: ${timingBias}, rawFileUri: ${rawFileUri}, intensity: ${intensity}, bgIntensity: ${bgIntensity}, descriptor: ${descriptor}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, tags: ${tags}, createdAt: ${createdAt}, createdBy: ${createdBy}, zeroPtdUnc: ${zeroPtdUnc}, eoobservationDetails: ${eoobservationDetails}, referenceFrame: ${referenceFrame}, senReferenceFrame: ${senReferenceFrame}, umbra: ${umbra}, penumbra: ${penumbra}, origNetwork: ${origNetwork}, sourceDl: ${sourceDl}, type: ${type}}';
  }
}

class _EoobservationIngestReader extends fb.TableReader<EoobservationIngest> {
  const _EoobservationIngestReader();

  @override
  EoobservationIngest createObject(fb.BufferContext bc, int offset) => 
    EoobservationIngest._(bc, offset);
}

class EoobservationIngestBuilder {
  EoobservationIngestBuilder(this.fbBuilder);

  final fb.Builder fbBuilder;

  void begin() {
    fbBuilder.startTable(93);
  }
  ...
  int addDataMode(EoobservationIngestDataModeEnum? dataMode) {
  ...
  int addReferenceFrame(EoobservationIngestReferenceFrameEnum? referenceFrame) {
    fbBuilder.addInt8(86, referenceFrame?.value);
    return fbBuilder.offset;
  }
  int addSenReferenceFrame(EoobservationIngestSenReferenceFrameEnum? senReferenceFrame) {
    fbBuilder.addInt8(87, senReferenceFrame?.value);
    return fbBuilder.offset;
  }
  int addUmbra(bool? umbra) {
    fbBuilder.addBool(88, umbra);
    return fbBuilder.offset;
  }
  int addPenumbra(bool? penumbra) {
    fbBuilder.addBool(89, penumbra);
    return fbBuilder.offset;
  }
...
class EoobservationIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EoobservationIngestDataModeEnum? _dataMode;
  final List<String>? _tags;
  final String? _createdAt;
  final String? _createdBy;
  final double? _zeroPtdUnc;
  final String? _eoobservationDetails;
  final EoobservationIngestReferenceFrameEnum? _referenceFrame;
  final EoobservationIngestSenReferenceFrameEnum? _senReferenceFrame;
  final bool? _umbra;
  ...
  EoobservationIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    EoobservationIngestDataModeEnum? dataMode,
    List<String>? tags,
    String? createdAt,
    String? createdBy,
    double? zeroPtdUnc,
    String? eoobservationDetails,
    EoobservationIngestReferenceFrameEnum? referenceFrame,
    EoobservationIngestSenReferenceFrameEnum? senReferenceFrame,
    bool? umbra,
    bool? penumbra,
    String? origNetwork,
    String? sourceDl,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addInt8(86, _referenceFrame?.value);
    fbBuilder.addInt8(87, _senReferenceFrame?.value);
    fbBuilder.addBool(88, _umbra);
    fbBuilder.addBool(89, _penumbra);
    fbBuilder.addOffset(90, origNetworkOffset);
    fbBuilder.addOffset(91, sourceDlOffset);
    fbBuilder.addOffset(92, typeOffset);
    return fbBuilder.endTable();
  }
