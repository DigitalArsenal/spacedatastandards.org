...
class GroundImageryIngestDataModeEnum {
  final int value;
  const GroundImageryIngestDataModeEnum._(this.value);

  factory GroundImageryIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum GroundImageryIngestDataModeEnum');
    }
    return result;
  }

  static GroundImageryIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : GroundImageryIngestDataModeEnum.fromValue(value);
  ...
  static const GroundImageryIngestDataModeEnum REAL = GroundImageryIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const GroundImageryIngestDataModeEnum TEST = GroundImageryIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const GroundImageryIngestDataModeEnum SIMULATED = GroundImageryIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const GroundImageryIngestDataModeEnum EXERCISE = GroundImageryIngestDataModeEnum._(3);
  static const Map<int, GroundImageryIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<GroundImageryIngestDataModeEnum> reader = _GroundImageryIngestDataModeEnumReader();

  @override
  String toString() {
    return 'GroundImageryIngestDataModeEnum{value: $value}';
  }
}

class _GroundImageryIngestDataModeEnumReader extends fb.Reader<GroundImageryIngestDataModeEnum> {
  const _GroundImageryIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  GroundImageryIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      GroundImageryIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Imagery of terrestrial regions from on-orbit, air, and other sensors.
class GroundImageryIngest {
  GroundImageryIngest._(this._bc, this._bcOffset);
  factory GroundImageryIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<GroundImageryIngest> reader = _GroundImageryIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  GroundImageryIngestDataModeEnum get dataMode => GroundImageryIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 40, 0));
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get transactionId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 46);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get keywords => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 50);
  ...
  String? get format => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 54);
  ///  Size of the image file. Units in bytes. If filesize is provided without an associated file, it defaults to 0.
  ///  Example: /// Example: 0
  ///  Constraints: No constraints specified.
  int get filesize => const fb.Int64Reader().vTableGet(_bc, _bcOffset, 56, 0);
  ...
  String? get checksumValue => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 58);

  @override
  String toString() {
    return 'GroundImageryIngest{id: ${id}, idSensor: ${idSensor}, classificationMarking: ${classificationMarking}, imageTime: ${imageTime}, filename: ${filename}, region: ${region}, regionText: ${regionText}, regionGeoJson: ${regionGeoJson}, regionType: ${regionType}, regionNdims: ${regionNdims}, regionSrid: ${regionSrid}, origSensorId: ${origSensorId}, subjectId: ${subjectId}, name: ${name}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, sourceDl: ${sourceDl}, dataMode: ${dataMode}, createdAt: ${createdAt}, createdBy: ${createdBy}, transactionId: ${transactionId}, tags: ${tags}, keywords: ${keywords}, notes: ${notes}, format: ${format}, filesize: ${filesize}, checksumValue: ${checksumValue}}';
  }
}

class _GroundImageryIngestReader extends fb.TableReader<GroundImageryIngest> {
  const _GroundImageryIngestReader();

  @override
  GroundImageryIngest createObject(fb.BufferContext bc, int offset) => 
    GroundImageryIngest._(bc, offset);
}

class GroundImageryIngestBuilder {
  GroundImageryIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(GroundImageryIngestDataModeEnum? dataMode) {
  ...
  int addFilesize(int? filesize) {
    fbBuilder.addInt64(26, filesize);
    return fbBuilder.offset;
  }
...
class GroundImageryIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final GroundImageryIngestDataModeEnum? _dataMode;
  ...
  GroundImageryIngestObjectBuilder({
    String? id,
    String? idSensor,
    ...
    String? origNetwork,
    String? sourceDl,
    GroundImageryIngestDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(21, transactionIdOffset);
    fbBuilder.addOffset(22, tagsOffset);
    fbBuilder.addOffset(23, keywordsOffset);
    fbBuilder.addOffset(24, notesOffset);
    fbBuilder.addOffset(25, formatOffset);
    fbBuilder.addInt64(26, _filesize);
    fbBuilder.addOffset(27, checksumValueOffset);
    return fbBuilder.endTable();
  }
