...
class AttitudeSetAbridgedDataModeEnum {
  final int value;
  const AttitudeSetAbridgedDataModeEnum._(this.value);

  factory AttitudeSetAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AttitudeSetAbridgedDataModeEnum');
    }
    return result;
  }

  static AttitudeSetAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AttitudeSetAbridgedDataModeEnum.fromValue(value);
  ...
  static const AttitudeSetAbridgedDataModeEnum REAL = AttitudeSetAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AttitudeSetAbridgedDataModeEnum TEST = AttitudeSetAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AttitudeSetAbridgedDataModeEnum SIMULATED = AttitudeSetAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AttitudeSetAbridgedDataModeEnum EXERCISE = AttitudeSetAbridgedDataModeEnum._(3);
  static const Map<int, AttitudeSetAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AttitudeSetAbridgedDataModeEnum> reader = _AttitudeSetAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'AttitudeSetAbridgedDataModeEnum{value: $value}';
  }
}

class _AttitudeSetAbridgedDataModeEnumReader extends fb.Reader<AttitudeSetAbridgedDataModeEnum> {
  const _AttitudeSetAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AttitudeSetAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      AttitudeSetAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AttitudeSetAbridged {
  AttitudeSetAbridged._(this._bc, this._bcOffset);
  factory AttitudeSetAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AttitudeSetAbridged> reader = _AttitudeSetAbridgedReader();
  ...
  ///  Constraints: No constraints specified.
  String? get startTime => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 22);
  ...
  ///  Constraints: No constraints specified.
  String? get endTime => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 24);
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 36
  String? get frame1 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 26);
  ///  Reference frame 2 of the quaternion or Euler angle transformation utilized in this attitude parameter or attitude ephemeris.  The UDL convention is that transformations occur FROM frame1 TO frame2.  A specific spacecraft frame or instrument name may be provided with the assumption the consumer understands the location of these frames (ex. SC BODY, J2000, LVLH, ICRF, INSTRUMENTx, THRUSTERx, etc.).
  ///  Example: /// Example: J2000
  ///  Constraints: Minimum length = 1, Maximum length = 36
  String? get frame2 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 28);
  ///  Number of attitude records contained in this set.
  ///  Example: /// Example: 120
  ///  Constraints: No constraints specified.
  int get numPoints => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 30, 0);
  ///  Attitude ephemeris step size, in seconds. This applies to Attitude Ephemeris Messages (AEM) that employ a fixed step size.
  ///  Example: /// Example: 60
  ///  Constraints: No constraints specified.
  int get stepSize => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 32, 0);
  ///  Initial precession angle (ECI J2000 frame) in degrees.
  ///  Example: /// Example: 30.5
  ///  Constraints: No constraints specified.
  double get precAngleInit => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 34, 0.0);
  ///  Initial spin angle (ECI J2000 frame) in degrees.
  ///  Example: /// Example: 25.5
  ///  Constraints: No constraints specified.
  double get spinAngleInit => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 36, 0.0);
  ...
  String? get eulerRotSeq => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 38);
  ///  Recommended interpolation method for estimating attitude ephemeris data.
  ///  Example: /// Example: LINEAR
  ///  Constraints: Minimum length = 0, Maximum length = 16
  String? get interpolator => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 40);
  ///  Recommended polynomial interpolation degree.
  ///  Example: /// Example: 2
  ///  Constraints: No constraints specified.
  int get interpolatorDegree => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 42, 0);
  ...
  AttitudeSetAbridgedDataModeEnum get dataMode => AttitudeSetAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 54, 0));
  ...
  @override
  String toString() {
    return 'AttitudeSetAbridged{id: ${id}, classificationMarking: ${classificationMarking}, idOnOrbit: ${idOnOrbit}, satNo: ${satNo}, origObjectId: ${origObjectId}, type: ${type}, esId: ${esId}, idSensor: ${idSensor}, origSensorId: ${origSensorId}, startTime: ${startTime}, endTime: ${endTime}, frame1: ${frame1}, frame2: ${frame2}, numPoints: ${numPoints}, stepSize: ${stepSize}, precAngleInit: ${precAngleInit}, spinAngleInit: ${spinAngleInit}, eulerRotSeq: ${eulerRotSeq}, interpolator: ${interpolator}, interpolatorDegree: ${interpolatorDegree}, notes: ${notes}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, origNetwork: ${origNetwork}}';
  }
}

class _AttitudeSetAbridgedReader extends fb.TableReader<AttitudeSetAbridged> {
  const _AttitudeSetAbridgedReader();

  @override
  AttitudeSetAbridged createObject(fb.BufferContext bc, int offset) => 
    AttitudeSetAbridged._(bc, offset);
}

class AttitudeSetAbridgedBuilder {
  AttitudeSetAbridgedBuilder(this.fbBuilder);
  ...
  int addNumPoints(int? numPoints) {
    fbBuilder.addInt32(13, numPoints);
    return fbBuilder.offset;
  }
  int addStepSize(int? stepSize) {
    fbBuilder.addInt32(14, stepSize);
    return fbBuilder.offset;
  }
  int addPrecAngleInit(double? precAngleInit) {
    fbBuilder.addFloat64(15, precAngleInit);
    return fbBuilder.offset;
  }
  int addSpinAngleInit(double? spinAngleInit) {
    fbBuilder.addFloat64(16, spinAngleInit);
    return fbBuilder.offset;
  }
  ...
  int addInterpolatorDegree(int? interpolatorDegree) {
    fbBuilder.addInt32(19, interpolatorDegree);
    return fbBuilder.offset;
  }
  ...
  int addDataMode(AttitudeSetAbridgedDataModeEnum? dataMode) {
...
class AttitudeSetAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AttitudeSetAbridgedDataModeEnum? _dataMode;
  final String? _origNetwork;

  AttitudeSetAbridgedObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    AttitudeSetAbridgedDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(10, endTimeOffset);
    fbBuilder.addOffset(11, frame1Offset);
    fbBuilder.addOffset(12, frame2Offset);
    fbBuilder.addInt32(13, _numPoints);
    fbBuilder.addInt32(14, _stepSize);
    fbBuilder.addFloat64(15, _precAngleInit);
    fbBuilder.addFloat64(16, _spinAngleInit);
    fbBuilder.addOffset(17, eulerRotSeqOffset);
    fbBuilder.addOffset(18, interpolatorOffset);
    fbBuilder.addInt32(19, _interpolatorDegree);
