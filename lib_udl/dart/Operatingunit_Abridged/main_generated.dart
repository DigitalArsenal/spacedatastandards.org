...
class OperatingunitAbridgedDataModeEnum {
  final int value;
  const OperatingunitAbridgedDataModeEnum._(this.value);

  factory OperatingunitAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OperatingunitAbridgedDataModeEnum');
    }
    return result;
  }

  static OperatingunitAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OperatingunitAbridgedDataModeEnum.fromValue(value);
  ...
  static const OperatingunitAbridgedDataModeEnum REAL = OperatingunitAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OperatingunitAbridgedDataModeEnum TEST = OperatingunitAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OperatingunitAbridgedDataModeEnum SIMULATED = OperatingunitAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OperatingunitAbridgedDataModeEnum EXERCISE = OperatingunitAbridgedDataModeEnum._(3);
  static const Map<int, OperatingunitAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OperatingunitAbridgedDataModeEnum> reader = _OperatingunitAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'OperatingunitAbridgedDataModeEnum{value: $value}';
  }
}

class _OperatingunitAbridgedDataModeEnumReader extends fb.Reader<OperatingunitAbridgedDataModeEnum> {
  const _OperatingunitAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OperatingunitAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      OperatingunitAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class OperatingunitAbridged {
  OperatingunitAbridged._(this._bc, this._bcOffset);
  factory OperatingunitAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OperatingunitAbridged> reader = _OperatingunitAbridgedReader();
  ...
  ///  Constraints: No constraints specified.
  String? get createdAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 114);
  ///  Application user who created the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 1, Maximum length = 64
  String? get createdBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 116);
  ///  Source of the data.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 1, Maximum length = 64
  String? get source => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 118);
  ///  Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
  ///  Example: /// Example: THIRD_PARTY_DATASOURCE
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get origin => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 120);
  ...
  OperatingunitAbridgedDataModeEnum get dataMode => OperatingunitAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 122, 0));

  @override
  String toString() {
    return 'OperatingunitAbridged{idOperatingUnit: ${idOperatingUnit}, classificationMarking: ${classificationMarking}, altOperatingUnitId: ${altOperatingUnitId}, name: ${name}, description: ${description}, idLocation: ${idLocation}, idContact: ${idContact}, idOrganization: ${idOrganization}, unitIdentifier: ${unitIdentifier}, countryCode: ${countryCode}, altCountryCode: ${altCountryCode}, wac: ${wac}, operStatus: ${operStatus}, condition: ${condition}, conditionAvail: ${conditionAvail}, eval: ${eval}, fpa: ${fpa}, ident: ${ident}, allegiance: ${allegiance}, altAllegiance: ${altAllegiance}, locName: ${locName}, locReason: ${locReason}, force: ${force}, forceName: ${forceName}, functRole: ${functRole}, msnPrimary: ${msnPrimary}, msnPrimarySpecialty: ${msnPrimarySpecialty}, masterUnit: ${masterUnit}, stylizedUnit: ${stylizedUnit}, divCat: ${divCat}, echelon: ${echelon}, echelonTier: ${echelonTier}, fleetId: ${fleetId}, deployStatus: ${deployStatus}, flagFlown: ${flagFlown}, coordDatum: ${coordDatum}, coord: ${coord}, coordDerivAcc: ${coordDerivAcc}, lat: ${lat}, lon: ${lon}, elevMsl: ${elevMsl}, elevMslConfLvl: ${elevMslConfLvl}, elevMslDerivAcc: ${elevMslDerivAcc}, geoidalMslSep: ${geoidalMslSep}, milGridSys: ${milGridSys}, milGrid: ${milGrid}, utm: ${utm}, airDefArea: ${airDefArea}, polSubdiv: ${polSubdiv}, symCode: ${symCode}, classRating: ${classRating}, recStatus: ${recStatus}, reviewDate: ${reviewDate}, resProd: ${resProd}, referenceDoc: ${referenceDoc}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}}';
  }
}

class _OperatingunitAbridgedReader extends fb.TableReader<OperatingunitAbridged> {
  const _OperatingunitAbridgedReader();

  @override
  OperatingunitAbridged createObject(fb.BufferContext bc, int offset) => 
    OperatingunitAbridged._(bc, offset);
}

class OperatingunitAbridgedBuilder {
  OperatingunitAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(OperatingunitAbridgedDataModeEnum? dataMode) {
...
class OperatingunitAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  final OperatingunitAbridgedDataModeEnum? _dataMode;

  OperatingunitAbridgedObjectBuilder({
    ...
    String? source,
    String? origin,
    OperatingunitAbridgedDataModeEnum? dataMode,
  })
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(55, createdAtOffset);
    fbBuilder.addOffset(56, createdByOffset);
    fbBuilder.addOffset(57, sourceOffset);
    fbBuilder.addOffset(58, originOffset);
