...
class AirfieldSlotConsumptionAbridgedStatusEnum {
  final int value;
  const AirfieldSlotConsumptionAbridgedStatusEnum._(this.value);

  factory AirfieldSlotConsumptionAbridgedStatusEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirfieldSlotConsumptionAbridgedStatusEnum');
    }
    return result;
  }

  static AirfieldSlotConsumptionAbridgedStatusEnum? _createOrNull(int? value) => 
      value == null ? null : AirfieldSlotConsumptionAbridgedStatusEnum.fromValue(value);
  ...
  static const AirfieldSlotConsumptionAbridgedStatusEnum REQUESTED = AirfieldSlotConsumptionAbridgedStatusEnum._(0);

  ///  No description available.
  static const AirfieldSlotConsumptionAbridgedStatusEnum APPROVED = AirfieldSlotConsumptionAbridgedStatusEnum._(1);

  ///  No description available.
  static const AirfieldSlotConsumptionAbridgedStatusEnum DENIED = AirfieldSlotConsumptionAbridgedStatusEnum._(2);

  ///  No description available.
  static const AirfieldSlotConsumptionAbridgedStatusEnum BLOCKED = AirfieldSlotConsumptionAbridgedStatusEnum._(3);

  ///  No description available.
  static const AirfieldSlotConsumptionAbridgedStatusEnum OTHER = AirfieldSlotConsumptionAbridgedStatusEnum._(4);
  static const Map<int, AirfieldSlotConsumptionAbridgedStatusEnum> values = {
    0: REQUESTED,
    1: APPROVED,
    2: DENIED,
    3: BLOCKED,
  ...
  static const fb.Reader<AirfieldSlotConsumptionAbridgedStatusEnum> reader = _AirfieldSlotConsumptionAbridgedStatusEnumReader();

  @override
  String toString() {
    return 'AirfieldSlotConsumptionAbridgedStatusEnum{value: $value}';
  }
}

class _AirfieldSlotConsumptionAbridgedStatusEnumReader extends fb.Reader<AirfieldSlotConsumptionAbridgedStatusEnum> {
  const _AirfieldSlotConsumptionAbridgedStatusEnumReader();

  @override
  int get size => 1;

  @override
  AirfieldSlotConsumptionAbridgedStatusEnum read(fb.BufferContext bc, int offset) =>
      AirfieldSlotConsumptionAbridgedStatusEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class AirfieldSlotConsumptionAbridgedDataModeEnum {
  final int value;
  const AirfieldSlotConsumptionAbridgedDataModeEnum._(this.value);

  factory AirfieldSlotConsumptionAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirfieldSlotConsumptionAbridgedDataModeEnum');
    }
    return result;
  }

  static AirfieldSlotConsumptionAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AirfieldSlotConsumptionAbridgedDataModeEnum.fromValue(value);
  ...
  static const AirfieldSlotConsumptionAbridgedDataModeEnum REAL = AirfieldSlotConsumptionAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AirfieldSlotConsumptionAbridgedDataModeEnum TEST = AirfieldSlotConsumptionAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AirfieldSlotConsumptionAbridgedDataModeEnum SIMULATED = AirfieldSlotConsumptionAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AirfieldSlotConsumptionAbridgedDataModeEnum EXERCISE = AirfieldSlotConsumptionAbridgedDataModeEnum._(3);
  static const Map<int, AirfieldSlotConsumptionAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AirfieldSlotConsumptionAbridgedDataModeEnum> reader = _AirfieldSlotConsumptionAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'AirfieldSlotConsumptionAbridgedDataModeEnum{value: $value}';
  }
}

class _AirfieldSlotConsumptionAbridgedDataModeEnumReader extends fb.Reader<AirfieldSlotConsumptionAbridgedDataModeEnum> {
  const _AirfieldSlotConsumptionAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AirfieldSlotConsumptionAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      AirfieldSlotConsumptionAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AirfieldSlotConsumptionAbridged {
  AirfieldSlotConsumptionAbridged._(this._bc, this._bcOffset);
  factory AirfieldSlotConsumptionAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirfieldSlotConsumptionAbridged> reader = _AirfieldSlotConsumptionAbridgedReader();
  ...
  AirfieldSlotConsumptionAbridgedStatusEnum get status => AirfieldSlotConsumptionAbridgedStatusEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 10, 0));
...
class AirfieldSlotConsumptionAbridgedBuilder {
  ...
  int addStatus(AirfieldSlotConsumptionAbridgedStatusEnum? status) {
  ...
  int addDataMode(AirfieldSlotConsumptionAbridgedDataModeEnum? dataMode) {
...
class AirfieldSlotConsumptionAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _classificationMarking;
  final String? _idAirfieldSlot;
  final AirfieldSlotConsumptionAbridgedStatusEnum? _status;
  ...
  final AirfieldSlotConsumptionAbridgedDataModeEnum? _dataMode;

  AirfieldSlotConsumptionAbridgedObjectBuilder({
    String? id,
    String? classificationMarking,
    String? idAirfieldSlot,
    AirfieldSlotConsumptionAbridgedStatusEnum? status,
    bool? occupied,
    String? consumer,
    ...
    String? origin,
    String? origNetwork,
    AirfieldSlotConsumptionAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
