...
class MtiFreeTextAbridged {
  MtiFreeTextAbridged._(this._bc, this._bcOffset);
  factory MtiFreeTextAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MtiFreeTextAbridged> reader = _MtiFreeTextAbridgedReader();
  ...
  @override
  String toString() {
    return 'MtiFreeTextAbridged{f1: ${f1}, f2: ${f2}, f3: ${f3}}';
  }
}

class _MtiFreeTextAbridgedReader extends fb.TableReader<MtiFreeTextAbridged> {
  const _MtiFreeTextAbridgedReader();

  @override
  MtiFreeTextAbridged createObject(fb.BufferContext bc, int offset) => 
    MtiFreeTextAbridged._(bc, offset);
}

class MtiFreeTextAbridgedBuilder {
  MtiFreeTextAbridgedBuilder(this.fbBuilder);
...
class MtiFreeTextAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _f1;
  final String? _f2;
  final String? _f3;

  MtiFreeTextAbridgedObjectBuilder({
    String? f1,
    String? f2,
    String? f3,
  })
