...
class AirspaceTimePeriodIngest {
  AirspaceTimePeriodIngest._(this._bc, this._bcOffset);
  factory AirspaceTimePeriodIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirspaceTimePeriodIngest> reader = _AirspaceTimePeriodIngestReader();
  ...
  @override
  String toString() {
    return 'AirspaceTimePeriodIngest{timeMode: ${timeMode}, timeStart: ${timeStart}, timeEnd: ${timeEnd}, intFreq: ${intFreq}, intDur: ${intDur}}';
  }
}

class _AirspaceTimePeriodIngestReader extends fb.TableReader<AirspaceTimePeriodIngest> {
  const _AirspaceTimePeriodIngestReader();

  @override
  AirspaceTimePeriodIngest createObject(fb.BufferContext bc, int offset) => 
    AirspaceTimePeriodIngest._(bc, offset);
}

class AirspaceTimePeriodIngestBuilder {
  AirspaceTimePeriodIngestBuilder(this.fbBuilder);
...
class AirspaceTimePeriodIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  AirspaceTimePeriodIngestObjectBuilder({
    String? timeMode,
    String? timeStart,
    String? timeEnd,
    List<String>? intFreq,
