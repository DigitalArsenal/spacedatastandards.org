...
class RfobservationAbridgedPolarityTypeEnum {
  final int value;
  const RfobservationAbridgedPolarityTypeEnum._(this.value);

  factory RfobservationAbridgedPolarityTypeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum RfobservationAbridgedPolarityTypeEnum');
    }
    return result;
  }

  static RfobservationAbridgedPolarityTypeEnum? _createOrNull(int? value) => 
      value == null ? null : RfobservationAbridgedPolarityTypeEnum.fromValue(value);
  ...
  static const RfobservationAbridgedPolarityTypeEnum H = RfobservationAbridgedPolarityTypeEnum._(0);

  ///  No description available.
  static const RfobservationAbridgedPolarityTypeEnum V = RfobservationAbridgedPolarityTypeEnum._(1);

  ///  No description available.
  static const RfobservationAbridgedPolarityTypeEnum R = RfobservationAbridgedPolarityTypeEnum._(2);

  ///  No description available.
  static const RfobservationAbridgedPolarityTypeEnum L = RfobservationAbridgedPolarityTypeEnum._(3);
  static const Map<int, RfobservationAbridgedPolarityTypeEnum> values = {
    0: H,
    1: V,
    2: R,
    3: L};

  static const fb.Reader<RfobservationAbridgedPolarityTypeEnum> reader = _RfobservationAbridgedPolarityTypeEnumReader();

  @override
  String toString() {
    return 'RfobservationAbridgedPolarityTypeEnum{value: $value}';
  }
}

class _RfobservationAbridgedPolarityTypeEnumReader extends fb.Reader<RfobservationAbridgedPolarityTypeEnum> {
  const _RfobservationAbridgedPolarityTypeEnumReader();

  @override
  int get size => 1;

  @override
  RfobservationAbridgedPolarityTypeEnum read(fb.BufferContext bc, int offset) =>
      RfobservationAbridgedPolarityTypeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class RfobservationAbridgedDataModeEnum {
  final int value;
  const RfobservationAbridgedDataModeEnum._(this.value);

  factory RfobservationAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum RfobservationAbridgedDataModeEnum');
    }
    return result;
  }

  static RfobservationAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : RfobservationAbridgedDataModeEnum.fromValue(value);
  ...
  static const RfobservationAbridgedDataModeEnum REAL = RfobservationAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const RfobservationAbridgedDataModeEnum TEST = RfobservationAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const RfobservationAbridgedDataModeEnum SIMULATED = RfobservationAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const RfobservationAbridgedDataModeEnum EXERCISE = RfobservationAbridgedDataModeEnum._(3);
  static const Map<int, RfobservationAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<RfobservationAbridgedDataModeEnum> reader = _RfobservationAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'RfobservationAbridgedDataModeEnum{value: $value}';
  }
}

class _RfobservationAbridgedDataModeEnumReader extends fb.Reader<RfobservationAbridgedDataModeEnum> {
  const _RfobservationAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  RfobservationAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      RfobservationAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
