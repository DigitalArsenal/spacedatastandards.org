...
class IonoObservationCharAttsIngest {
  IonoObservationCharAttsIngest._(this._bc, this._bcOffset);
  factory IonoObservationCharAttsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationCharAttsIngest> reader = _IonoObservationCharAttsIngestReader();
  ...
  @override
  String toString() {
    return 'IonoObservationCharAttsIngest{ursiId: ${ursiId}, charName: ${charName}, lowerBound: ${lowerBound}, upperBound: ${upperBound}, q: ${q}, d: ${d}, climateModelName: ${climateModelName}, climateModelOptions: ${climateModelOptions}, climateModelInputParams: ${climateModelInputParams}, uncertaintyBoundType: ${uncertaintyBoundType}}';
  }
}

class _IonoObservationCharAttsIngestReader extends fb.TableReader<IonoObservationCharAttsIngest> {
  const _IonoObservationCharAttsIngestReader();

  @override
  IonoObservationCharAttsIngest createObject(fb.BufferContext bc, int offset) => 
    IonoObservationCharAttsIngest._(bc, offset);
}

class IonoObservationCharAttsIngestBuilder {
  IonoObservationCharAttsIngestBuilder(this.fbBuilder);
...
class IonoObservationCharAttsIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  IonoObservationCharAttsIngestObjectBuilder({
    String? ursiId,
    String? charName,
    double? lowerBound,
    double? upperBound,
