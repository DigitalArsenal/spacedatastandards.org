...
class ChannelIngestDataModeEnum {
  final int value;
  const ChannelIngestDataModeEnum._(this.value);

  factory ChannelIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ChannelIngestDataModeEnum');
    }
    return result;
  }

  static ChannelIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : ChannelIngestDataModeEnum.fromValue(value);
  ...
  static const ChannelIngestDataModeEnum REAL = ChannelIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const ChannelIngestDataModeEnum TEST = ChannelIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const ChannelIngestDataModeEnum SIMULATED = ChannelIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const ChannelIngestDataModeEnum EXERCISE = ChannelIngestDataModeEnum._(3);
  static const Map<int, ChannelIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<ChannelIngestDataModeEnum> reader = _ChannelIngestDataModeEnumReader();

  @override
  String toString() {
    return 'ChannelIngestDataModeEnum{value: $value}';
  }
}

class _ChannelIngestDataModeEnumReader extends fb.Reader<ChannelIngestDataModeEnum> {
  const _ChannelIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  ChannelIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      ChannelIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Channel information on a particular transponder.
class ChannelIngest {
  ChannelIngest._(this._bc, this._bcOffset);
  factory ChannelIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<ChannelIngest> reader = _ChannelIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  ChannelIngestDataModeEnum get dataMode => ChannelIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 42, 0));
  ...
  @override
  String toString() {
    return 'ChannelIngest{id: ${id}, idTransponder: ${idTransponder}, name: ${name}, classificationMarking: ${classificationMarking}, type: ${type}, idBeam: ${idBeam}, beamName: ${beamName}, idRfband: ${idRfband}, encryption: ${encryption}, pkg: ${pkg}, res: ${res}, compression: ${compression}, vpid: ${vpid}, apid: ${apid}, sid: ${sid}, owner: ${owner}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, createdAt: ${createdAt}, createdBy: ${createdBy}}';
  }
}

class _ChannelIngestReader extends fb.TableReader<ChannelIngest> {
  const _ChannelIngestReader();

  @override
  ChannelIngest createObject(fb.BufferContext bc, int offset) => 
    ChannelIngest._(bc, offset);
}

class ChannelIngestBuilder {
  ChannelIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(ChannelIngestDataModeEnum? dataMode) {
...
class ChannelIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final ChannelIngestDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;

  ChannelIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    ChannelIngestDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
  })
      : _id = id,
