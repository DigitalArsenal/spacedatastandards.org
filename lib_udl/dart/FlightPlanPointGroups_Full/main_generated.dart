...
class FlightPlanPointGroupsFull {
  FlightPlanPointGroupsFull._(this._bc, this._bcOffset);
  factory FlightPlanPointGroupsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<FlightPlanPointGroupsFull> reader = _FlightPlanPointGroupsFullReader();
...
class _FlightPlanPointGroupsFullReader extends fb.TableReader<FlightPlanPointGroupsFull> {
  const _FlightPlanPointGroupsFullReader();

  @override
  FlightPlanPointGroupsFull createObject(fb.BufferContext bc, int offset) => 
    FlightPlanPointGroupsFull._(bc, offset);
}

class FlightPlanPointGroupsFullBuilder {
  FlightPlanPointGroupsFullBuilder(this.fbBuilder);
...
class FlightPlanPointGroupsFullObjectBuilder extends fb.ObjectBuilder {
  ...
  FlightPlanPointGroupsFullObjectBuilder({
