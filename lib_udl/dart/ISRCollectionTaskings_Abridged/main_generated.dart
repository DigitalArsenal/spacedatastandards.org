...
class IsrcollectionTaskingsAbridgedTypeEnum {
  final int value;
  const IsrcollectionTaskingsAbridgedTypeEnum._(this.value);

  factory IsrcollectionTaskingsAbridgedTypeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum IsrcollectionTaskingsAbridgedTypeEnum');
    }
    return result;
  }

  static IsrcollectionTaskingsAbridgedTypeEnum? _createOrNull(int? value) => 
      value == null ? null : IsrcollectionTaskingsAbridgedTypeEnum.fromValue(value);
  ...
  static const IsrcollectionTaskingsAbridgedTypeEnum DELIBERATE = IsrcollectionTaskingsAbridgedTypeEnum._(0);

  ///  No description available.
  static const IsrcollectionTaskingsAbridgedTypeEnum DYNAMIC = IsrcollectionTaskingsAbridgedTypeEnum._(1);

  ///  No description available.
  static const IsrcollectionTaskingsAbridgedTypeEnum TRAINING = IsrcollectionTaskingsAbridgedTypeEnum._(2);

  ///  No description available.
  static const IsrcollectionTaskingsAbridgedTypeEnum TRANSIT = IsrcollectionTaskingsAbridgedTypeEnum._(3);
  static const Map<int, IsrcollectionTaskingsAbridgedTypeEnum> values = {
    0: DELIBERATE,
    1: DYNAMIC,
    2: TRAINING,
    3: TRANSIT};

  static const fb.Reader<IsrcollectionTaskingsAbridgedTypeEnum> reader = _IsrcollectionTaskingsAbridgedTypeEnumReader();

  @override
  String toString() {
    return 'IsrcollectionTaskingsAbridgedTypeEnum{value: $value}';
  }
}

class _IsrcollectionTaskingsAbridgedTypeEnumReader extends fb.Reader<IsrcollectionTaskingsAbridgedTypeEnum> {
  const _IsrcollectionTaskingsAbridgedTypeEnumReader();

  @override
  int get size => 1;

  @override
  IsrcollectionTaskingsAbridgedTypeEnum read(fb.BufferContext bc, int offset) =>
      IsrcollectionTaskingsAbridgedTypeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class IsrcollectionTaskingsAbridgedCollectionTypeEnum {
  final int value;
  const IsrcollectionTaskingsAbridgedCollectionTypeEnum._(this.value);

  factory IsrcollectionTaskingsAbridgedCollectionTypeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum IsrcollectionTaskingsAbridgedCollectionTypeEnum');
    }
    return result;
  }

  static IsrcollectionTaskingsAbridgedCollectionTypeEnum? _createOrNull(int? value) => 
      value == null ? null : IsrcollectionTaskingsAbridgedCollectionTypeEnum.fromValue(value);
  ...
  ///  No description available.
  static const IsrcollectionTaskingsAbridgedCollectionTypeEnum SIMULTANEOUS = IsrcollectionTaskingsAbridgedCollectionTypeEnum._(0);

  ///  No description available.
  static const IsrcollectionTaskingsAbridgedCollectionTypeEnum SEQUENTIAL = IsrcollectionTaskingsAbridgedCollectionTypeEnum._(1);

  ///  No description available.
  static const IsrcollectionTaskingsAbridgedCollectionTypeEnum OPERATIONALLY = IsrcollectionTaskingsAbridgedCollectionTypeEnum._(2);

  ///  No description available.
  static const IsrcollectionTaskingsAbridgedCollectionTypeEnum DRIVEN = IsrcollectionTaskingsAbridgedCollectionTypeEnum._(3);

  ///  No description available.
  static const IsrcollectionTaskingsAbridgedCollectionTypeEnum PRIORITY = IsrcollectionTaskingsAbridgedCollectionTypeEnum._(4);

  ///  No description available.
  static const IsrcollectionTaskingsAbridgedCollectionTypeEnum ORDER = IsrcollectionTaskingsAbridgedCollectionTypeEnum._(5);
  static const Map<int, IsrcollectionTaskingsAbridgedCollectionTypeEnum> values = {
    0: SIMULTANEOUS,
    1: SEQUENTIAL,
    2: OPERATIONALLY,
    3: DRIVEN,
  ...
  static const fb.Reader<IsrcollectionTaskingsAbridgedCollectionTypeEnum> reader = _IsrcollectionTaskingsAbridgedCollectionTypeEnumReader();

  @override
  String toString() {
    return 'IsrcollectionTaskingsAbridgedCollectionTypeEnum{value: $value}';
  }
}

class _IsrcollectionTaskingsAbridgedCollectionTypeEnumReader extends fb.Reader<IsrcollectionTaskingsAbridgedCollectionTypeEnum> {
  const _IsrcollectionTaskingsAbridgedCollectionTypeEnumReader();

  @override
  int get size => 1;

  @override
  IsrcollectionTaskingsAbridgedCollectionTypeEnum read(fb.BufferContext bc, int offset) =>
      IsrcollectionTaskingsAbridgedCollectionTypeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Individual taskings to complete the mission.
class IsrcollectionTaskingsAbridged {
  IsrcollectionTaskingsAbridged._(this._bc, this._bcOffset);
  factory IsrcollectionTaskingsAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IsrcollectionTaskingsAbridged> reader = _IsrcollectionTaskingsAbridgedReader();
  ...
  IsrcollectionTaskingsAbridgedTypeEnum get type => IsrcollectionTaskingsAbridgedTypeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 6, 0));
  ///  Type of collection tasked.
  ///  Example: /// Example: Simultaneous
  ///  Constraints: Minimum length = 1, Maximum length = 16
  IsrcollectionTaskingsAbridgedCollectionTypeEnum get collectionType => IsrcollectionTaskingsAbridgedCollectionTypeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 8, 0));
...
class IsrcollectionTaskingsAbridgedBuilder {
  ...
  int addType(IsrcollectionTaskingsAbridgedTypeEnum? type) {
    fbBuilder.addInt8(1, type?.value);
    return fbBuilder.offset;
  }
  int addCollectionType(IsrcollectionTaskingsAbridgedCollectionTypeEnum? collectionType) {
...
class IsrcollectionTaskingsAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final IsrcollectionTaskingsAbridgedTypeEnum? _type;
  final IsrcollectionTaskingsAbridgedCollectionTypeEnum? _collectionType;
  ...
  IsrcollectionTaskingsAbridgedObjectBuilder({
    String? id,
    IsrcollectionTaskingsAbridgedTypeEnum? type,
    IsrcollectionTaskingsAbridgedCollectionTypeEnum? collectionType,
    String? taskingAor,
    String? eightLine,
