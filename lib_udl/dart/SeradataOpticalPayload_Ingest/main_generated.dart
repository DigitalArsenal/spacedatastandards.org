...
class SeradataOpticalPayloadIngestDataModeEnum {
  final int value;
  const SeradataOpticalPayloadIngestDataModeEnum._(this.value);

  factory SeradataOpticalPayloadIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SeradataOpticalPayloadIngestDataModeEnum');
    }
    return result;
  }

  static SeradataOpticalPayloadIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SeradataOpticalPayloadIngestDataModeEnum.fromValue(value);
  ...
  static const SeradataOpticalPayloadIngestDataModeEnum REAL = SeradataOpticalPayloadIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SeradataOpticalPayloadIngestDataModeEnum TEST = SeradataOpticalPayloadIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SeradataOpticalPayloadIngestDataModeEnum SIMULATED = SeradataOpticalPayloadIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SeradataOpticalPayloadIngestDataModeEnum EXERCISE = SeradataOpticalPayloadIngestDataModeEnum._(3);
  static const Map<int, SeradataOpticalPayloadIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SeradataOpticalPayloadIngestDataModeEnum> reader = _SeradataOpticalPayloadIngestDataModeEnumReader();

  @override
  String toString() {
    return 'SeradataOpticalPayloadIngestDataModeEnum{value: $value}';
  }
}

class _SeradataOpticalPayloadIngestDataModeEnumReader extends fb.Reader<SeradataOpticalPayloadIngestDataModeEnum> {
  const _SeradataOpticalPayloadIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SeradataOpticalPayloadIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      SeradataOpticalPayloadIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Details for an optical payload from  Seradata.
class SeradataOpticalPayloadIngest {
  SeradataOpticalPayloadIngest._(this._bc, this._bcOffset);
  factory SeradataOpticalPayloadIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SeradataOpticalPayloadIngest> reader = _SeradataOpticalPayloadIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SeradataOpticalPayloadIngestDataModeEnum get dataMode => SeradataOpticalPayloadIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 54, 0));

  @override
  String toString() {
    return 'SeradataOpticalPayloadIngest{id: ${id}, classificationMarking: ${classificationMarking}, spacecraftId: ${spacecraftId}, idSensor: ${idSensor}, hostedForCompanyOrgId: ${hostedForCompanyOrgId}, manufacturerOrgId: ${manufacturerOrgId}, imagingPayloadCategory: ${imagingPayloadCategory}, name: ${name}, spectralBand: ${spectralBand}, spectralFrequencyLimits: ${spectralFrequencyLimits}, numberOfFilmReturnCanisters: ${numberOfFilmReturnCanisters}, bestResolution: ${bestResolution}, swathWidth: ${swathWidth}, recorderSize: ${recorderSize}, fieldOfView: ${fieldOfView}, fieldOfRegard: ${fieldOfRegard}, pointingMethod: ${pointingMethod}, groundStations: ${groundStations}, groundStationLocations: ${groundStationLocations}, notes: ${notes}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _SeradataOpticalPayloadIngestReader extends fb.TableReader<SeradataOpticalPayloadIngest> {
  const _SeradataOpticalPayloadIngestReader();

  @override
  SeradataOpticalPayloadIngest createObject(fb.BufferContext bc, int offset) => 
    SeradataOpticalPayloadIngest._(bc, offset);
}

class SeradataOpticalPayloadIngestBuilder {
  SeradataOpticalPayloadIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(SeradataOpticalPayloadIngestDataModeEnum? dataMode) {
...
class SeradataOpticalPayloadIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SeradataOpticalPayloadIngestDataModeEnum? _dataMode;

  SeradataOpticalPayloadIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    SeradataOpticalPayloadIngestDataModeEnum? dataMode,
  })
      : _id = id,
