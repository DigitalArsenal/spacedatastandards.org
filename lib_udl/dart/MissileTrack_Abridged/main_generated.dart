...
class MissileTrackAbridgedEnvEnum {
  final int value;
  const MissileTrackAbridgedEnvEnum._(this.value);

  factory MissileTrackAbridgedEnvEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum MissileTrackAbridgedEnvEnum');
    }
    return result;
  }

  static MissileTrackAbridgedEnvEnum? _createOrNull(int? value) => 
      value == null ? null : MissileTrackAbridgedEnvEnum.fromValue(value);
  ...
  static const MissileTrackAbridgedEnvEnum AIR = MissileTrackAbridgedEnvEnum._(0);

  ///  On the surface of dry land.
  static const MissileTrackAbridgedEnvEnum LAND = MissileTrackAbridgedEnvEnum._(1);

  ///  Above the Kármán line, which has an altitude of 100 kilometers (62 miles).
  static const MissileTrackAbridgedEnvEnum SPACE = MissileTrackAbridgedEnvEnum._(2);

  ///  On the surface of a body of water.
  static const MissileTrackAbridgedEnvEnum SURFACE = MissileTrackAbridgedEnvEnum._(3);

  ///  Below the surface of a body of water.
  static const MissileTrackAbridgedEnvEnum SUBSURFACE = MissileTrackAbridgedEnvEnum._(4);

  ///  Environment is not known.
  static const MissileTrackAbridgedEnvEnum UNKNOWN = MissileTrackAbridgedEnvEnum._(5);
  static const Map<int, MissileTrackAbridgedEnvEnum> values = {
    0: AIR,
    1: LAND,
    2: SPACE,
    3: SURFACE,
  ...
  static const fb.Reader<MissileTrackAbridgedEnvEnum> reader = _MissileTrackAbridgedEnvEnumReader();

  @override
  String toString() {
    return 'MissileTrackAbridgedEnvEnum{value: $value}';
  }
}

class _MissileTrackAbridgedEnvEnumReader extends fb.Reader<MissileTrackAbridgedEnvEnum> {
  const _MissileTrackAbridgedEnvEnumReader();

  @override
  int get size => 1;

  @override
  MissileTrackAbridgedEnvEnum read(fb.BufferContext bc, int offset) =>
      MissileTrackAbridgedEnvEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class MissileTrackAbridgedObjIdentEnum {
  final int value;
  const MissileTrackAbridgedObjIdentEnum._(this.value);

  factory MissileTrackAbridgedObjIdentEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum MissileTrackAbridgedObjIdentEnum');
    }
    return result;
  }

  static MissileTrackAbridgedObjIdentEnum? _createOrNull(int? value) => 
      value == null ? null : MissileTrackAbridgedObjIdentEnum.fromValue(value);
  ...
  static const MissileTrackAbridgedObjIdentEnum ASSUMED_FRIEND = MissileTrackAbridgedObjIdentEnum._(0);

  ///  Track object supporting friendly forces and belonging to a declared friendly nation or entity.
  static const MissileTrackAbridgedObjIdentEnum FRIEND = MissileTrackAbridgedObjIdentEnum._(1);
  ...
  static const MissileTrackAbridgedObjIdentEnum HOSTILE = MissileTrackAbridgedObjIdentEnum._(2);
  ...
  static const MissileTrackAbridgedObjIdentEnum NEUTRAL = MissileTrackAbridgedObjIdentEnum._(3);

  ///  Track object which has not been evaluated.
  static const MissileTrackAbridgedObjIdentEnum PENDING = MissileTrackAbridgedObjIdentEnum._(4);

  ///  Track object deemed potentially hostile due to the object characteristics, behavior, nationality, and/or origin.
  static const MissileTrackAbridgedObjIdentEnum SUSPECT = MissileTrackAbridgedObjIdentEnum._(5);

  ///  Track object which has been evaluated and does not meet criteria for any standard identity.
  static const MissileTrackAbridgedObjIdentEnum UNKNOWN = MissileTrackAbridgedObjIdentEnum._(6);
  static const Map<int, MissileTrackAbridgedObjIdentEnum> values = {
    0: ASSUMED_FRIEND,
    1: FRIEND,
    2: HOSTILE,
    3: NEUTRAL,
  ...
  static const fb.Reader<MissileTrackAbridgedObjIdentEnum> reader = _MissileTrackAbridgedObjIdentEnumReader();

  @override
  String toString() {
    return 'MissileTrackAbridgedObjIdentEnum{value: $value}';
  }
}

class _MissileTrackAbridgedObjIdentEnumReader extends fb.Reader<MissileTrackAbridgedObjIdentEnum> {
  const _MissileTrackAbridgedObjIdentEnumReader();

  @override
  int get size => 1;

  @override
  MissileTrackAbridgedObjIdentEnum read(fb.BufferContext bc, int offset) =>
      MissileTrackAbridgedObjIdentEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class MissileTrackAbridgedDataModeEnum {
  final int value;
  const MissileTrackAbridgedDataModeEnum._(this.value);

  factory MissileTrackAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum MissileTrackAbridgedDataModeEnum');
    }
    return result;
  }

  static MissileTrackAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : MissileTrackAbridgedDataModeEnum.fromValue(value);
  ...
  static const MissileTrackAbridgedDataModeEnum REAL = MissileTrackAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const MissileTrackAbridgedDataModeEnum TEST = MissileTrackAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const MissileTrackAbridgedDataModeEnum SIMULATED = MissileTrackAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const MissileTrackAbridgedDataModeEnum EXERCISE = MissileTrackAbridgedDataModeEnum._(3);
  static const Map<int, MissileTrackAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<MissileTrackAbridgedDataModeEnum> reader = _MissileTrackAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'MissileTrackAbridgedDataModeEnum{value: $value}';
  }
}

class _MissileTrackAbridgedDataModeEnumReader extends fb.Reader<MissileTrackAbridgedDataModeEnum> {
  const _MissileTrackAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  MissileTrackAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      MissileTrackAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class MissileTrackAbridged {
  MissileTrackAbridged._(this._bc, this._bcOffset);
  factory MissileTrackAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MissileTrackAbridged> reader = _MissileTrackAbridgedReader();
  ...
  ///  Example: /// Example: AIR
  ///  Constraints: Minimum length = 0, Maximum length = 16
  MissileTrackAbridgedEnvEnum get env => MissileTrackAbridgedEnvEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 14, 0));
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 32
  MissileTrackAbridgedObjIdentEnum get objIdent => MissileTrackAbridgedObjIdentEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 22, 0));
  ...
  MissileTrackAbridgedDataModeEnum get dataMode => MissileTrackAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 116, 0));
...
class _MissileTrackAbridgedReader extends fb.TableReader<MissileTrackAbridged> {
  const _MissileTrackAbridgedReader();

  @override
  MissileTrackAbridged createObject(fb.BufferContext bc, int offset) => 
    MissileTrackAbridged._(bc, offset);
}

class MissileTrackAbridgedBuilder {
  MissileTrackAbridgedBuilder(this.fbBuilder);
  ...
  int addEnv(MissileTrackAbridgedEnvEnum? env) {
  ...
  int addObjIdent(MissileTrackAbridgedObjIdentEnum? objIdent) {
  ...
  int addDataMode(MissileTrackAbridgedDataModeEnum? dataMode) {
...
class MissileTrackAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _classificationMarking;
  final String? _msgType;
  final String? _msgSubType;
  final String? _msgCreateDate;
  final MissileTrackAbridgedEnvEnum? _env;
  final String? _objType;
  final int? _objTypeConf;
  final String? _objPlat;
  final MissileTrackAbridgedObjIdentEnum? _objIdent;
  ...
  final MissileTrackAbridgedDataModeEnum? _dataMode;

  MissileTrackAbridgedObjectBuilder({
    String? id,
    String? classificationMarking,
    String? msgType,
    String? msgSubType,
    String? msgCreateDate,
    MissileTrackAbridgedEnvEnum? env,
    String? objType,
    int? objTypeConf,
    String? objPlat,
    MissileTrackAbridgedObjIdentEnum? objIdent,
    String? spaceAmp,
    String? objAct,
    ...
    String? source,
    String? origin,
    MissileTrackAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
