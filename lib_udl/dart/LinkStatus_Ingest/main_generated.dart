...
class LinkStatusIngestDataModeEnum {
  final int value;
  const LinkStatusIngestDataModeEnum._(this.value);

  factory LinkStatusIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum LinkStatusIngestDataModeEnum');
    }
    return result;
  }

  static LinkStatusIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : LinkStatusIngestDataModeEnum.fromValue(value);
  ...
  static const LinkStatusIngestDataModeEnum REAL = LinkStatusIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const LinkStatusIngestDataModeEnum TEST = LinkStatusIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const LinkStatusIngestDataModeEnum SIMULATED = LinkStatusIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const LinkStatusIngestDataModeEnum EXERCISE = LinkStatusIngestDataModeEnum._(3);
  static const Map<int, LinkStatusIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<LinkStatusIngestDataModeEnum> reader = _LinkStatusIngestDataModeEnumReader();

  @override
  String toString() {
    return 'LinkStatusIngestDataModeEnum{value: $value}';
  }
}

class _LinkStatusIngestDataModeEnumReader extends fb.Reader<LinkStatusIngestDataModeEnum> {
  const _LinkStatusIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  LinkStatusIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      LinkStatusIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Captures link status.
class LinkStatusIngest {
  LinkStatusIngest._(this._bc, this._bcOffset);
  factory LinkStatusIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LinkStatusIngest> reader = _LinkStatusIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  LinkStatusIngestDataModeEnum get dataMode => LinkStatusIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 60, 0));
...
class LinkStatusIngestBuilder {
  ...
  int addDataMode(LinkStatusIngestDataModeEnum? dataMode) {
...
class LinkStatusIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final LinkStatusIngestDataModeEnum? _dataMode;
  final int? _satNo1;
  final int? _satNo2;

  LinkStatusIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    LinkStatusIngestDataModeEnum? dataMode,
    int? satNo1,
    int? satNo2,
  })
      : _id = id,
