...
class OrbitDeterminationAbridgedDataModeEnum {
  final int value;
  const OrbitDeterminationAbridgedDataModeEnum._(this.value);

  factory OrbitDeterminationAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OrbitDeterminationAbridgedDataModeEnum');
    }
    return result;
  }

  static OrbitDeterminationAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OrbitDeterminationAbridgedDataModeEnum.fromValue(value);
  ...
  static const OrbitDeterminationAbridgedDataModeEnum REAL = OrbitDeterminationAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OrbitDeterminationAbridgedDataModeEnum TEST = OrbitDeterminationAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OrbitDeterminationAbridgedDataModeEnum SIMULATED = OrbitDeterminationAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OrbitDeterminationAbridgedDataModeEnum EXERCISE = OrbitDeterminationAbridgedDataModeEnum._(3);
  static const Map<int, OrbitDeterminationAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OrbitDeterminationAbridgedDataModeEnum> reader = _OrbitDeterminationAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'OrbitDeterminationAbridgedDataModeEnum{value: $value}';
  }
}

class _OrbitDeterminationAbridgedDataModeEnumReader extends fb.Reader<OrbitDeterminationAbridgedDataModeEnum> {
  const _OrbitDeterminationAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OrbitDeterminationAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      OrbitDeterminationAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class OrbitDeterminationAbridged {
  OrbitDeterminationAbridged._(this._bc, this._bcOffset);
  factory OrbitDeterminationAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OrbitDeterminationAbridged> reader = _OrbitDeterminationAbridgedReader();
  ...
  OrbitDeterminationAbridgedDataModeEnum get dataMode => OrbitDeterminationAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 90, 0));

  @override
  String toString() {
    return 'OrbitDeterminationAbridged{id: ${id}, classificationMarking: ${classificationMarking}, startTime: ${startTime}, endTime: ${endTime}, idOnOrbit: ${idOnOrbit}, origObjectId: ${origObjectId}, satNo: ${satNo}, aprioriIdElset: ${aprioriIdElset}, aprioriElset: ${aprioriElset}, aprioriIdStateVector: ${aprioriIdStateVector}, aprioriStateVector: ${aprioriStateVector}, initialOd: ${initialOd}, lastObStart: ${lastObStart}, lastObEnd: ${lastObEnd}, timeSpan: ${timeSpan}, effectiveFrom: ${effectiveFrom}, effectiveUntil: ${effectiveUntil}, wrms: ${wrms}, previousWrms: ${previousWrms}, firstPassWrms: ${firstPassWrms}, bestPassWrms: ${bestPassWrms}, errorGrowthRate: ${errorGrowthRate}, edr: ${edr}, method: ${method}, methodSource: ${methodSource}, fitSpan: ${fitSpan}, ballisticCoeffEst: ${ballisticCoeffEst}, ballisticCoeffModel: ${ballisticCoeffModel}, agomEst: ${agomEst}, agomModel: ${agomModel}, rmsConvergenceCriteria: ${rmsConvergenceCriteria}, numIterations: ${numIterations}, acceptedObTyps: ${acceptedObTyps}, acceptedObIds: ${acceptedObIds}, rejectedObTyps: ${rejectedObTyps}, rejectedObIds: ${rejectedObIds}, sensorIds: ${sensorIds}, createdAt: ${createdAt}, createdBy: ${createdBy}, sourceDl: ${sourceDl}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _OrbitDeterminationAbridgedReader extends fb.TableReader<OrbitDeterminationAbridged> {
  const _OrbitDeterminationAbridgedReader();

  @override
  OrbitDeterminationAbridged createObject(fb.BufferContext bc, int offset) => 
    OrbitDeterminationAbridged._(bc, offset);
}

class OrbitDeterminationAbridgedBuilder {
  OrbitDeterminationAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(OrbitDeterminationAbridgedDataModeEnum? dataMode) {
...
class OrbitDeterminationAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final OrbitDeterminationAbridgedDataModeEnum? _dataMode;

  OrbitDeterminationAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    OrbitDeterminationAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
