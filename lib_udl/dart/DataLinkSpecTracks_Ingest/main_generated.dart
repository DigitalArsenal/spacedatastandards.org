...
class DataLinkSpecTracksIngest {
  DataLinkSpecTracksIngest._(this._bc, this._bcOffset);
  factory DataLinkSpecTracksIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DataLinkSpecTracksIngest> reader = _DataLinkSpecTracksIngestReader();
  ...
  @override
  String toString() {
    return 'DataLinkSpecTracksIngest{specTrackNum: ${specTrackNum}, specTrackNumDesc: ${specTrackNumDesc}}';
  }
}

class _DataLinkSpecTracksIngestReader extends fb.TableReader<DataLinkSpecTracksIngest> {
  const _DataLinkSpecTracksIngestReader();

  @override
  DataLinkSpecTracksIngest createObject(fb.BufferContext bc, int offset) => 
    DataLinkSpecTracksIngest._(bc, offset);
}

class DataLinkSpecTracksIngestBuilder {
  DataLinkSpecTracksIngestBuilder(this.fbBuilder);
...
class DataLinkSpecTracksIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _specTrackNum;
  final String? _specTrackNumDesc;

  DataLinkSpecTracksIngestObjectBuilder({
    String? specTrackNum,
