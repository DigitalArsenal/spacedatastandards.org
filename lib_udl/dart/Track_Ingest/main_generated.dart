...
class TrackIngestDataModeEnum {
  final int value;
  const TrackIngestDataModeEnum._(this.value);

  factory TrackIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum TrackIngestDataModeEnum');
    }
    return result;
  }

  static TrackIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : TrackIngestDataModeEnum.fromValue(value);
  ...
  static const TrackIngestDataModeEnum REAL = TrackIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const TrackIngestDataModeEnum TEST = TrackIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const TrackIngestDataModeEnum SIMULATED = TrackIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const TrackIngestDataModeEnum EXERCISE = TrackIngestDataModeEnum._(3);
  static const Map<int, TrackIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<TrackIngestDataModeEnum> reader = _TrackIngestDataModeEnumReader();

  @override
  String toString() {
    return 'TrackIngestDataModeEnum{value: $value}';
  }
}

class _TrackIngestDataModeEnumReader extends fb.Reader<TrackIngestDataModeEnum> {
  const _TrackIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  TrackIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      TrackIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class TrackIngest {
  TrackIngest._(this._bc, this._bcOffset);
  factory TrackIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<TrackIngest> reader = _TrackIngestReader();
  ...
  TrackIngestDataModeEnum get dataMode => TrackIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 136, 0));
...
class TrackIngestBuilder {
  ...
  int addDataMode(TrackIngestDataModeEnum? dataMode) {
...
class TrackIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final TrackIngestDataModeEnum? _dataMode;
  final String? _origNetwork;

  TrackIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    TrackIngestDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
