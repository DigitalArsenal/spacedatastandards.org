...
class DataLinkMultiDutyVoiceCoordAbridged {
  DataLinkMultiDutyVoiceCoordAbridged._(this._bc, this._bcOffset);
  factory DataLinkMultiDutyVoiceCoordAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DataLinkMultiDutyVoiceCoordAbridged> reader = _DataLinkMultiDutyVoiceCoordAbridgedReader();
  ...
  @override
  String toString() {
    return 'DataLinkMultiDutyVoiceCoordAbridged{multiVoiceNetDes: ${multiVoiceNetDes}, multiFreqDes: ${multiFreqDes}, multiCommPri: ${multiCommPri}, multiTeleFreqNums: ${multiTeleFreqNums}}';
  }
}

class _DataLinkMultiDutyVoiceCoordAbridgedReader extends fb.TableReader<DataLinkMultiDutyVoiceCoordAbridged> {
  const _DataLinkMultiDutyVoiceCoordAbridgedReader();

  @override
  DataLinkMultiDutyVoiceCoordAbridged createObject(fb.BufferContext bc, int offset) => 
    DataLinkMultiDutyVoiceCoordAbridged._(bc, offset);
}

class DataLinkMultiDutyVoiceCoordAbridgedBuilder {
  DataLinkMultiDutyVoiceCoordAbridgedBuilder(this.fbBuilder);
...
class DataLinkMultiDutyVoiceCoordAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _multiVoiceNetDes;
  final String? _multiFreqDes;
  final String? _multiCommPri;
  final List<String>? _multiTeleFreqNums;

  DataLinkMultiDutyVoiceCoordAbridgedObjectBuilder({
