...
class AirspaceTimePeriodFull {
  AirspaceTimePeriodFull._(this._bc, this._bcOffset);
  factory AirspaceTimePeriodFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirspaceTimePeriodFull> reader = _AirspaceTimePeriodFullReader();
  ...
  @override
  String toString() {
    return 'AirspaceTimePeriodFull{timeMode: ${timeMode}, timeStart: ${timeStart}, timeEnd: ${timeEnd}, intFreq: ${intFreq}, intDur: ${intDur}}';
  }
}

class _AirspaceTimePeriodFullReader extends fb.TableReader<AirspaceTimePeriodFull> {
  const _AirspaceTimePeriodFullReader();

  @override
  AirspaceTimePeriodFull createObject(fb.BufferContext bc, int offset) => 
    AirspaceTimePeriodFull._(bc, offset);
}

class AirspaceTimePeriodFullBuilder {
  AirspaceTimePeriodFullBuilder(this.fbBuilder);
...
class AirspaceTimePeriodFullObjectBuilder extends fb.ObjectBuilder {
  ...
  AirspaceTimePeriodFullObjectBuilder({
    String? timeMode,
    String? timeStart,
    String? timeEnd,
    List<String>? intFreq,
