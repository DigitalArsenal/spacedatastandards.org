...
class EvacMedicationIngest {
  EvacMedicationIngest._(this._bc, this._bcOffset);
  factory EvacMedicationIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EvacMedicationIngest> reader = _EvacMedicationIngestReader();
  ...
  @override
  String toString() {
    return 'EvacMedicationIngest{type: ${type}, bodyPart: ${bodyPart}, dose: ${dose}, adminRoute: ${adminRoute}, time: ${time}, comments: ${comments}}';
  }
}

class _EvacMedicationIngestReader extends fb.TableReader<EvacMedicationIngest> {
  const _EvacMedicationIngestReader();

  @override
  EvacMedicationIngest createObject(fb.BufferContext bc, int offset) => 
    EvacMedicationIngest._(bc, offset);
}

class EvacMedicationIngestBuilder {
  EvacMedicationIngestBuilder(this.fbBuilder);
...
class EvacMedicationIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _type;
  ...
  EvacMedicationIngestObjectBuilder({
    String? type,
    String? bodyPart,
    String? dose,
    String? adminRoute,
