...
class AirTaskingOrderIngestDataModeEnum {
  final int value;
  const AirTaskingOrderIngestDataModeEnum._(this.value);

  factory AirTaskingOrderIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirTaskingOrderIngestDataModeEnum');
    }
    return result;
  }

  static AirTaskingOrderIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AirTaskingOrderIngestDataModeEnum.fromValue(value);
  ...
  static const AirTaskingOrderIngestDataModeEnum REAL = AirTaskingOrderIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AirTaskingOrderIngestDataModeEnum TEST = AirTaskingOrderIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AirTaskingOrderIngestDataModeEnum SIMULATED = AirTaskingOrderIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AirTaskingOrderIngestDataModeEnum EXERCISE = AirTaskingOrderIngestDataModeEnum._(3);
  static const Map<int, AirTaskingOrderIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AirTaskingOrderIngestDataModeEnum> reader = _AirTaskingOrderIngestDataModeEnumReader();

  @override
  String toString() {
    return 'AirTaskingOrderIngestDataModeEnum{value: $value}';
  }
}

class _AirTaskingOrderIngestDataModeEnumReader extends fb.Reader<AirTaskingOrderIngestDataModeEnum> {
  const _AirTaskingOrderIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AirTaskingOrderIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      AirTaskingOrderIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AirTaskingOrderIngest {
  AirTaskingOrderIngest._(this._bc, this._bcOffset);
  factory AirTaskingOrderIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirTaskingOrderIngest> reader = _AirTaskingOrderIngestReader();
  ...
  AirTaskingOrderIngestDataModeEnum get dataMode => AirTaskingOrderIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 46, 0));

  @override
  String toString() {
    return 'AirTaskingOrderIngest{id: ${id}, classificationMarking: ${classificationMarking}, rawFileUri: ${rawFileUri}, opExerName: ${opExerName}, msgOriginator: ${msgOriginator}, msgSn: ${msgSn}, msgMonth: ${msgMonth}, msgQualifier: ${msgQualifier}, ackReqInd: ${ackReqInd}, ackUnitInstructions: ${ackUnitInstructions}, beginTs: ${beginTs}, endTs: ${endTs}, genText: ${genText}, acMsnTasking: ${acMsnTasking}, navalFltOps: ${navalFltOps}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, sourceDl: ${sourceDl}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _AirTaskingOrderIngestReader extends fb.TableReader<AirTaskingOrderIngest> {
  const _AirTaskingOrderIngestReader();

  @override
  AirTaskingOrderIngest createObject(fb.BufferContext bc, int offset) => 
    AirTaskingOrderIngest._(bc, offset);
}

class AirTaskingOrderIngestBuilder {
  AirTaskingOrderIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(AirTaskingOrderIngestDataModeEnum? dataMode) {
...
class AirTaskingOrderIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AirTaskingOrderIngestDataModeEnum? _dataMode;

  AirTaskingOrderIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    AirTaskingOrderIngestDataModeEnum? dataMode,
  })
      : _id = id,
