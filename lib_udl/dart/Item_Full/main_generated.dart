...
class ItemFullDataModeEnum {
  final int value;
  const ItemFullDataModeEnum._(this.value);

  factory ItemFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ItemFullDataModeEnum');
    }
    return result;
  }

  static ItemFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : ItemFullDataModeEnum.fromValue(value);
  ...
  static const ItemFullDataModeEnum REAL = ItemFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const ItemFullDataModeEnum TEST = ItemFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const ItemFullDataModeEnum SIMULATED = ItemFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const ItemFullDataModeEnum EXERCISE = ItemFullDataModeEnum._(3);
  static const Map<int, ItemFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<ItemFullDataModeEnum> reader = _ItemFullDataModeEnumReader();

  @override
  String toString() {
    return 'ItemFullDataModeEnum{value: $value}';
  }
}

class _ItemFullDataModeEnumReader extends fb.Reader<ItemFullDataModeEnum> {
  const _ItemFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  ItemFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      ItemFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// No description available.
class ItemFull {
  ItemFull._(this._bc, this._bcOffset);
  factory ItemFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<ItemFull> reader = _ItemFullReader();
  ...
  ///  Constraints: No constraints specified.
  String? get updatedAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 96);
  ///  Application user who updated the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get updatedBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 98);
  ///  The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
  ///  Example: /// Example: AXE
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get sourceDl => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 100);
  ///  Source of the data.
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  ItemFullDataModeEnum get dataMode => ItemFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 108, 0));

  @override
  String toString() {
    return 'ItemFull{id: ${id}, classificationMarking: ${classificationMarking}, idAirLoadPlan: ${idAirLoadPlan}, scanCode: ${scanCode}, scGenTool: ${scGenTool}, type: ${type}, cargoType: ${cargoType}, name: ${name}, destination: ${destination}, departure: ${departure}, receivingUnit: ${receivingUnit}, receivingBranch: ${receivingBranch}, lastArrDate: ${lastArrDate}, uln: ${uln}, weight: ${weight}, weightTs: ${weightTs}, commodityCode: ${commodityCode}, commoditySys: ${commoditySys}, productCode: ${productCode}, productSys: ${productSys}, width: ${width}, length: ${length}, height: ${height}, volume: ${volume}, cg: ${cg}, fs: ${fs}, centerlineOffset: ${centerlineOffset}, moment: ${moment}, airdrop: ${airdrop}, tcn: ${tcn}, hazCodes: ${hazCodes}, netExpWt: ${netExpWt}, container: ${container}, itemContains: ${itemContains}, numPalletPos: ${numPalletPos}, dvCode: ${dvCode}, notes: ${notes}, keys: ${keys}, values: ${values}, altDataFormat: ${altDataFormat}, accSystem: ${accSystem}, accSysNotes: ${accSysNotes}, accSysKeys: ${accSysKeys}, accSysValues: ${accSysValues}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, sourceDl: ${sourceDl}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _ItemFullReader extends fb.TableReader<ItemFull> {
  const _ItemFullReader();

  @override
  ItemFull createObject(fb.BufferContext bc, int offset) => 
    ItemFull._(bc, offset);
}

class ItemFullBuilder {
  ItemFullBuilder(this.fbBuilder);
  ...
  int addDataMode(ItemFullDataModeEnum? dataMode) {
...
class ItemFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final ItemFullDataModeEnum? _dataMode;

  ItemFullObjectBuilder({
    String? id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(46, updatedAtOffset);
    fbBuilder.addOffset(47, updatedByOffset);
    fbBuilder.addOffset(48, sourceDlOffset);
