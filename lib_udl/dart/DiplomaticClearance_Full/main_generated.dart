...
class DiplomaticClearanceFullDataModeEnum {
  final int value;
  const DiplomaticClearanceFullDataModeEnum._(this.value);

  factory DiplomaticClearanceFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum DiplomaticClearanceFullDataModeEnum');
    }
    return result;
  }

  static DiplomaticClearanceFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : DiplomaticClearanceFullDataModeEnum.fromValue(value);
  ...
  static const DiplomaticClearanceFullDataModeEnum REAL = DiplomaticClearanceFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const DiplomaticClearanceFullDataModeEnum TEST = DiplomaticClearanceFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const DiplomaticClearanceFullDataModeEnum SIMULATED = DiplomaticClearanceFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const DiplomaticClearanceFullDataModeEnum EXERCISE = DiplomaticClearanceFullDataModeEnum._(3);
  static const Map<int, DiplomaticClearanceFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<DiplomaticClearanceFullDataModeEnum> reader = _DiplomaticClearanceFullDataModeEnumReader();

  @override
  String toString() {
    return 'DiplomaticClearanceFullDataModeEnum{value: $value}';
  }
}

class _DiplomaticClearanceFullDataModeEnumReader extends fb.Reader<DiplomaticClearanceFullDataModeEnum> {
  const _DiplomaticClearanceFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  DiplomaticClearanceFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      DiplomaticClearanceFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// A diplomatic clearance is an authorization for an aircraft to traverse or land within a specified country.
class DiplomaticClearanceFull {
  DiplomaticClearanceFull._(this._bc, this._bcOffset);
  factory DiplomaticClearanceFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DiplomaticClearanceFull> reader = _DiplomaticClearanceFullReader();
  ...
  DiplomaticClearanceFullDataModeEnum get dataMode => DiplomaticClearanceFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 40, 0));

  @override
  String toString() {
    return 'DiplomaticClearanceFull{id: ${id}, classificationMarking: ${classificationMarking}, idMission: ${idMission}, externalWorksheetId: ${externalWorksheetId}, dipWorksheetName: ${dipWorksheetName}, firstDepDate: ${firstDepDate}, docDeadline: ${docDeadline}, apacsId: ${apacsId}, diplomaticClearanceDetails: ${diplomaticClearanceDetails}, diplomaticClearanceRemarks: ${diplomaticClearanceRemarks}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, sourceDl: ${sourceDl}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _DiplomaticClearanceFullReader extends fb.TableReader<DiplomaticClearanceFull> {
  const _DiplomaticClearanceFullReader();

  @override
  DiplomaticClearanceFull createObject(fb.BufferContext bc, int offset) => 
    DiplomaticClearanceFull._(bc, offset);
}

class DiplomaticClearanceFullBuilder {
  DiplomaticClearanceFullBuilder(this.fbBuilder);
  ...
  int addDataMode(DiplomaticClearanceFullDataModeEnum? dataMode) {
...
class DiplomaticClearanceFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final DiplomaticClearanceFullDataModeEnum? _dataMode;

  DiplomaticClearanceFullObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    DiplomaticClearanceFullDataModeEnum? dataMode,
  })
      : _id = id,
