...
class LogisticsTransportationPlansFull {
  LogisticsTransportationPlansFull._(this._bc, this._bcOffset);
  factory LogisticsTransportationPlansFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LogisticsTransportationPlansFull> reader = _LogisticsTransportationPlansFullReader();
...
class LogisticsTransportationPlansFullObjectBuilder extends fb.ObjectBuilder {
  ...
  LogisticsTransportationPlansFullObjectBuilder({
    String? plansNumber,
    bool? missionChange,
