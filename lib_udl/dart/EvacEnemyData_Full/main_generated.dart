...
class EvacEnemyDataFull {
  EvacEnemyDataFull._(this._bc, this._bcOffset);
  factory EvacEnemyDataFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EvacEnemyDataFull> reader = _EvacEnemyDataFullReader();
  ...
  @override
  String toString() {
    return 'EvacEnemyDataFull{dirToEnemy: ${dirToEnemy}, hostileFireType: ${hostileFireType}, friendliesRemarks: ${friendliesRemarks}, hlzRemarks: ${hlzRemarks}}';
  }
}

class _EvacEnemyDataFullReader extends fb.TableReader<EvacEnemyDataFull> {
  const _EvacEnemyDataFullReader();

  @override
  EvacEnemyDataFull createObject(fb.BufferContext bc, int offset) => 
    EvacEnemyDataFull._(bc, offset);
}

class EvacEnemyDataFullBuilder {
  EvacEnemyDataFullBuilder(this.fbBuilder);
