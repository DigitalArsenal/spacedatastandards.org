...
class DiplomaticClearanceDetailsAbridged {
  DiplomaticClearanceDetailsAbridged._(this._bc, this._bcOffset);
  factory DiplomaticClearanceDetailsAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DiplomaticClearanceDetailsAbridged> reader = _DiplomaticClearanceDetailsAbridgedReader();
  ...
  @override
  String toString() {
    return 'DiplomaticClearanceDetailsAbridged{idSortie: ${idSortie}, legNum: ${legNum}, routeString: ${routeString}, validStartTime: ${validStartTime}, validEndTime: ${validEndTime}, clearanceId: ${clearanceId}, externalClearanceId: ${externalClearanceId}, clearedCallSign: ${clearedCallSign}, sequenceNum: ${sequenceNum}, countryCode: ${countryCode}, altCountryCode: ${altCountryCode}, countryName: ${countryName}, validDesc: ${validDesc}, windowRemark: ${windowRemark}, entryPoint: ${entryPoint}, entryNet: ${entryNet}, exitPoint: ${exitPoint}, exitNlt: ${exitNlt}, reqIcao: ${reqIcao}, action: ${action}, status: ${status}, profile: ${profile}, reqPoint: ${reqPoint}, clearanceRemark: ${clearanceRemark}}';
  }
}

class _DiplomaticClearanceDetailsAbridgedReader extends fb.TableReader<DiplomaticClearanceDetailsAbridged> {
  const _DiplomaticClearanceDetailsAbridgedReader();

  @override
  DiplomaticClearanceDetailsAbridged createObject(fb.BufferContext bc, int offset) => 
    DiplomaticClearanceDetailsAbridged._(bc, offset);
}

class DiplomaticClearanceDetailsAbridgedBuilder {
  DiplomaticClearanceDetailsAbridgedBuilder(this.fbBuilder);
...
class DiplomaticClearanceDetailsAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  DiplomaticClearanceDetailsAbridgedObjectBuilder({
    String? idSortie,
    int? legNum,
    String? routeString,
