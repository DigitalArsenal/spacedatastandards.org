...
class IndividualAircraftTaskingIngest {
  IndividualAircraftTaskingIngest._(this._bc, this._bcOffset);
  factory IndividualAircraftTaskingIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IndividualAircraftTaskingIngest> reader = _IndividualAircraftTaskingIngestReader();
...
class _IndividualAircraftTaskingIngestReader extends fb.TableReader<IndividualAircraftTaskingIngest> {
  const _IndividualAircraftTaskingIngestReader();

  @override
  IndividualAircraftTaskingIngest createObject(fb.BufferContext bc, int offset) => 
    IndividualAircraftTaskingIngest._(bc, offset);
}

class IndividualAircraftTaskingIngestBuilder {
  IndividualAircraftTaskingIngestBuilder(this.fbBuilder);
...
class IndividualAircraftTaskingIngestObjectBuilder extends fb.ObjectBuilder {
  final int? _numAcft;
  ...
  IndividualAircraftTaskingIngestObjectBuilder({
    int? numAcft,
    String? acftType,
    String? callSign,
