...
class AltitudeBlocksAbridged {
  AltitudeBlocksAbridged._(this._bc, this._bcOffset);
  factory AltitudeBlocksAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AltitudeBlocksAbridged> reader = _AltitudeBlocksAbridgedReader();
  ...
  @override
  String toString() {
    return 'AltitudeBlocksAbridged{altitudeSequenceId: ${altitudeSequenceId}, lowerAltitude: ${lowerAltitude}, upperAltitude: ${upperAltitude}}';
  }
}

class _AltitudeBlocksAbridgedReader extends fb.TableReader<AltitudeBlocksAbridged> {
  const _AltitudeBlocksAbridgedReader();

  @override
  AltitudeBlocksAbridged createObject(fb.BufferContext bc, int offset) => 
    AltitudeBlocksAbridged._(bc, offset);
}

class AltitudeBlocksAbridgedBuilder {
  AltitudeBlocksAbridgedBuilder(this.fbBuilder);
...
class AltitudeBlocksAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _altitudeSequenceId;
  final double? _lowerAltitude;
  final double? _upperAltitude;

  AltitudeBlocksAbridgedObjectBuilder({
