...
class CrewFullDataModeEnum {
  final int value;
  const CrewFullDataModeEnum._(this.value);

  factory CrewFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum CrewFullDataModeEnum');
    }
    return result;
  }

  static CrewFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : CrewFullDataModeEnum.fromValue(value);
  ...
  static const CrewFullDataModeEnum REAL = CrewFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const CrewFullDataModeEnum TEST = CrewFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const CrewFullDataModeEnum SIMULATED = CrewFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const CrewFullDataModeEnum EXERCISE = CrewFullDataModeEnum._(3);
  static const Map<int, CrewFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<CrewFullDataModeEnum> reader = _CrewFullDataModeEnumReader();

  @override
  String toString() {
    return 'CrewFullDataModeEnum{value: $value}';
  }
}

class _CrewFullDataModeEnumReader extends fb.Reader<CrewFullDataModeEnum> {
  const _CrewFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  CrewFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      CrewFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Crew Services.
class CrewFull {
  CrewFull._(this._bc, this._bcOffset);
  factory CrewFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<CrewFull> reader = _CrewFullReader();
  ...
  CrewFullDataModeEnum get dataMode => CrewFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 48, 0));

  @override
  String toString() {
    return 'CrewFull{id: ${id}, classificationMarking: ${classificationMarking}, origCrewId: ${origCrewId}, crewName: ${crewName}, status: ${status}, idSortie: ${idSortie}, legalAlertTime: ${legalAlertTime}, legalBravoTime: ${legalBravoTime}, alertedTime: ${alertedTime}, returnTime: ${returnTime}, fdpEligType: ${fdpEligType}, fdpType: ${fdpType}, crewType: ${crewType}, armsCrewUnit: ${armsCrewUnit}, crewMembers: ${crewMembers}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _CrewFullReader extends fb.TableReader<CrewFull> {
  const _CrewFullReader();

  @override
  CrewFull createObject(fb.BufferContext bc, int offset) => 
    CrewFull._(bc, offset);
}

class CrewFullBuilder {
  CrewFullBuilder(this.fbBuilder);
  ...
  int addDataMode(CrewFullDataModeEnum? dataMode) {
...
class CrewFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final CrewFullDataModeEnum? _dataMode;

  CrewFullObjectBuilder({
    String? id,
