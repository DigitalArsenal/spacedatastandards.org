...
class MtiJobRequestFull {
  MtiJobRequestFull._(this._bc, this._bcOffset);
  factory MtiJobRequestFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MtiJobRequestFull> reader = _MtiJobRequestFullReader();
  ...
  @override
  String toString() {
    return 'MtiJobRequestFull{r1: ${r1}, r2: ${r2}, r3: ${r3}, r4: ${r4}, r5: ${r5}, r6: ${r6}, r7: ${r7}, r8: ${r8}, r9: ${r9}, r10: ${r10}, r11: ${r11}, r12: ${r12}, r13: ${r13}, r14: ${r14}, jobReqEst: ${jobReqEst}, r21: ${r21}, r22: ${r22}, r23: ${r23}, r24: ${r24}, r25: ${r25}, r26: ${r26}}';
  }
}

class _MtiJobRequestFullReader extends fb.TableReader<MtiJobRequestFull> {
  const _MtiJobRequestFullReader();

  @override
  MtiJobRequestFull createObject(fb.BufferContext bc, int offset) => 
    MtiJobRequestFull._(bc, offset);
}

class MtiJobRequestFullBuilder {
  MtiJobRequestFullBuilder(this.fbBuilder);
...
class MtiJobRequestFullObjectBuilder extends fb.ObjectBuilder {
  final String? _r1;
  final String? _r2;
  final int? _r3;
  final double? _r4;
  ...
  MtiJobRequestFullObjectBuilder({
    String? r1,
    String? r2,
    int? r3,
    double? r4,
