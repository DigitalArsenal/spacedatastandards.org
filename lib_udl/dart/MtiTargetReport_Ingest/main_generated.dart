...
class MtiTargetReportIngest {
  MtiTargetReportIngest._(this._bc, this._bcOffset);
  factory MtiTargetReportIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MtiTargetReportIngest> reader = _MtiTargetReportIngestReader();
  ...
  @override
  String toString() {
    return 'MtiTargetReportIngest{d321: ${d321}, d322: ${d322}, d323: ${d323}, d324: ${d324}, d325: ${d325}, d326: ${d326}, d327: ${d327}, d328: ${d328}, d329: ${d329}, d3210: ${d3210}, d3211: ${d3211}, d3212: ${d3212}, d3213: ${d3213}, d3214: ${d3214}, d3215: ${d3215}, d3216: ${d3216}, d3217: ${d3217}, d3218: ${d3218}}';
  }
}

class _MtiTargetReportIngestReader extends fb.TableReader<MtiTargetReportIngest> {
  const _MtiTargetReportIngestReader();

  @override
  MtiTargetReportIngest createObject(fb.BufferContext bc, int offset) => 
    MtiTargetReportIngest._(bc, offset);
}

class MtiTargetReportIngestBuilder {
  MtiTargetReportIngestBuilder(this.fbBuilder);
...
class MtiTargetReportIngestObjectBuilder extends fb.ObjectBuilder {
  final int? _d321;
  final double? _d322;
  final double? _d323;
  final int? _d324;
  ...
  MtiTargetReportIngestObjectBuilder({
    int? d321,
    double? d322,
    double? d323,
    int? d324,
