...
class RfobservationFullPolarityTypeEnum {
  final int value;
  const RfobservationFullPolarityTypeEnum._(this.value);

  factory RfobservationFullPolarityTypeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum RfobservationFullPolarityTypeEnum');
    }
    return result;
  }

  static RfobservationFullPolarityTypeEnum? _createOrNull(int? value) => 
      value == null ? null : RfobservationFullPolarityTypeEnum.fromValue(value);
  ...
  static const RfobservationFullPolarityTypeEnum H = RfobservationFullPolarityTypeEnum._(0);

  ///  No description available.
  static const RfobservationFullPolarityTypeEnum V = RfobservationFullPolarityTypeEnum._(1);

  ///  No description available.
  static const RfobservationFullPolarityTypeEnum R = RfobservationFullPolarityTypeEnum._(2);

  ///  No description available.
  static const RfobservationFullPolarityTypeEnum L = RfobservationFullPolarityTypeEnum._(3);
  static const Map<int, RfobservationFullPolarityTypeEnum> values = {
    0: H,
    1: V,
    2: R,
    3: L};

  static const fb.Reader<RfobservationFullPolarityTypeEnum> reader = _RfobservationFullPolarityTypeEnumReader();

  @override
  String toString() {
    return 'RfobservationFullPolarityTypeEnum{value: $value}';
  }
}

class _RfobservationFullPolarityTypeEnumReader extends fb.Reader<RfobservationFullPolarityTypeEnum> {
  const _RfobservationFullPolarityTypeEnumReader();

  @override
  int get size => 1;

  @override
  RfobservationFullPolarityTypeEnum read(fb.BufferContext bc, int offset) =>
      RfobservationFullPolarityTypeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class RfobservationFullDataModeEnum {
  final int value;
  const RfobservationFullDataModeEnum._(this.value);

  factory RfobservationFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum RfobservationFullDataModeEnum');
    }
    return result;
  }

  static RfobservationFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : RfobservationFullDataModeEnum.fromValue(value);
  ...
  static const RfobservationFullDataModeEnum REAL = RfobservationFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const RfobservationFullDataModeEnum TEST = RfobservationFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const RfobservationFullDataModeEnum SIMULATED = RfobservationFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const RfobservationFullDataModeEnum EXERCISE = RfobservationFullDataModeEnum._(3);
  static const Map<int, RfobservationFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<RfobservationFullDataModeEnum> reader = _RfobservationFullDataModeEnumReader();

  @override
  String toString() {
    return 'RfobservationFullDataModeEnum{value: $value}';
  }
}

class _RfobservationFullDataModeEnumReader extends fb.Reader<RfobservationFullDataModeEnum> {
  const _RfobservationFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  RfobservationFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      RfobservationFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class RfobservationFull {
  RfobservationFull._(this._bc, this._bcOffset);
  factory RfobservationFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<RfobservationFull> reader = _RfobservationFullReader();
  ...
  RfobservationFullPolarityTypeEnum get polarityType => RfobservationFullPolarityTypeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 94, 0));
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  RfobservationFullDataModeEnum get dataMode => RfobservationFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 134, 0));
...
class RfobservationFullBuilder {
  ...
  int addPolarityType(RfobservationFullPolarityTypeEnum? polarityType) {
  ...
  int addDataMode(RfobservationFullDataModeEnum? dataMode) {
...
class RfobservationFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final RfobservationFullPolarityTypeEnum? _polarityType;
  final int? _channel;
  ...
  final RfobservationFullDataModeEnum? _dataMode;
  ...
  RfobservationFullObjectBuilder({
    String? id,
    ...
    double? nominalSnr,
    double? polarity,
    RfobservationFullPolarityTypeEnum? polarityType,
    int? channel,
    ...
    String? source,
    String? origin,
    RfobservationFullDataModeEnum? dataMode,
    List<String>? tags,
    String? createdAt,
    String? createdBy,
