...
class IonoObservationAmplitudeAbridged {
  IonoObservationAmplitudeAbridged._(this._bc, this._bcOffset);
  factory IonoObservationAmplitudeAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationAmplitudeAbridged> reader = _IonoObservationAmplitudeAbridgedReader();
  ...
  @override
  String toString() {
    return 'IonoObservationAmplitudeAbridged{notes: ${notes}, dimensions: ${dimensions}, dimensionName: ${dimensionName}, data: ${data}}';
  }
}

class _IonoObservationAmplitudeAbridgedReader extends fb.TableReader<IonoObservationAmplitudeAbridged> {
  const _IonoObservationAmplitudeAbridgedReader();

  @override
  IonoObservationAmplitudeAbridged createObject(fb.BufferContext bc, int offset) => 
    IonoObservationAmplitudeAbridged._(bc, offset);
}

class IonoObservationAmplitudeAbridgedBuilder {
  IonoObservationAmplitudeAbridgedBuilder(this.fbBuilder);
...
class IonoObservationAmplitudeAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _notes;
  final List<String>? _dimensions;
  final List<String>? _dimensionName;
  final List<String>? _data;

  IonoObservationAmplitudeAbridgedObjectBuilder({
    String? notes,
