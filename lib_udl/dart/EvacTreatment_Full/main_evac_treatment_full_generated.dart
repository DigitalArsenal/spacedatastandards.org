...
class EvacTreatmentFull {
  EvacTreatmentFull._(this._bc, this._bcOffset);
  factory EvacTreatmentFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EvacTreatmentFull> reader = _EvacTreatmentFullReader();
  ...
  @override
  String toString() {
    return 'EvacTreatmentFull{type: ${type}, bodyPart: ${bodyPart}, time: ${time}, comments: ${comments}}';
  }
}

class _EvacTreatmentFullReader extends fb.TableReader<EvacTreatmentFull> {
  const _EvacTreatmentFullReader();

  @override
  EvacTreatmentFull createObject(fb.BufferContext bc, int offset) => 
    EvacTreatmentFull._(bc, offset);
}

class EvacTreatmentFullBuilder {
  EvacTreatmentFullBuilder(this.fbBuilder);
...
class EvacTreatmentFullObjectBuilder extends fb.ObjectBuilder {
  final String? _type;
  final String? _bodyPart;
  final String? _time;
  final String? _comments;

  EvacTreatmentFullObjectBuilder({
    String? type,
    String? bodyPart,
    String? time,
    String? comments,
