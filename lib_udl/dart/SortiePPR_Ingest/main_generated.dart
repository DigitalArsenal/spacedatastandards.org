...
class SortiePprIngestTypeEnum {
  final int value;
  const SortiePprIngestTypeEnum._(this.value);

  factory SortiePprIngestTypeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SortiePprIngestTypeEnum');
    }
    return result;
  }

  static SortiePprIngestTypeEnum? _createOrNull(int? value) => 
      value == null ? null : SortiePprIngestTypeEnum.fromValue(value);
  ...
  static const SortiePprIngestTypeEnum M = SortiePprIngestTypeEnum._(0);

  ///  No description available.
  static const SortiePprIngestTypeEnum C = SortiePprIngestTypeEnum._(1);
  static const Map<int, SortiePprIngestTypeEnum> values = {
    0: M,
    1: C};

  static const fb.Reader<SortiePprIngestTypeEnum> reader = _SortiePprIngestTypeEnumReader();

  @override
  String toString() {
    return 'SortiePprIngestTypeEnum{value: $value}';
  }
}

class _SortiePprIngestTypeEnumReader extends fb.Reader<SortiePprIngestTypeEnum> {
  const _SortiePprIngestTypeEnumReader();

  @override
  int get size => 1;

  @override
  SortiePprIngestTypeEnum read(fb.BufferContext bc, int offset) =>
      SortiePprIngestTypeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class SortiePprIngestDataModeEnum {
  final int value;
  const SortiePprIngestDataModeEnum._(this.value);

  factory SortiePprIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SortiePprIngestDataModeEnum');
    }
    return result;
  }

  static SortiePprIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SortiePprIngestDataModeEnum.fromValue(value);
  ...
  static const SortiePprIngestDataModeEnum REAL = SortiePprIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SortiePprIngestDataModeEnum TEST = SortiePprIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SortiePprIngestDataModeEnum SIMULATED = SortiePprIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SortiePprIngestDataModeEnum EXERCISE = SortiePprIngestDataModeEnum._(3);
  static const Map<int, SortiePprIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SortiePprIngestDataModeEnum> reader = _SortiePprIngestDataModeEnumReader();

  @override
  String toString() {
    return 'SortiePprIngestDataModeEnum{value: $value}';
  }
}

class _SortiePprIngestDataModeEnumReader extends fb.Reader<SortiePprIngestDataModeEnum> {
  const _SortiePprIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SortiePprIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      SortiePprIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class SortiePprIngest {
  SortiePprIngest._(this._bc, this._bcOffset);
  factory SortiePprIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SortiePprIngest> reader = _SortiePprIngestReader();
  ...
  SortiePprIngestTypeEnum get type => SortiePprIngestTypeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 22, 0));
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SortiePprIngestDataModeEnum get dataMode => SortiePprIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 38, 0));

  @override
  String toString() {
    return 'SortiePprIngest{id: ${id}, classificationMarking: ${classificationMarking}, idSortie: ${idSortie}, externalId: ${externalId}, number: ${number}, startTime: ${startTime}, endTime: ${endTime}, requestor: ${requestor}, grantor: ${grantor}, type: ${type}, remarks: ${remarks}, createdAt: ${createdAt}, createdBy: ${createdBy}, sourceDl: ${sourceDl}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _SortiePprIngestReader extends fb.TableReader<SortiePprIngest> {
  const _SortiePprIngestReader();

  @override
  SortiePprIngest createObject(fb.BufferContext bc, int offset) => 
    SortiePprIngest._(bc, offset);
}

class SortiePprIngestBuilder {
  SortiePprIngestBuilder(this.fbBuilder);
  ...
  int addType(SortiePprIngestTypeEnum? type) {
  ...
  int addDataMode(SortiePprIngestDataModeEnum? dataMode) {
...
class SortiePprIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SortiePprIngestTypeEnum? _type;
  ...
  final SortiePprIngestDataModeEnum? _dataMode;

  SortiePprIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    SortiePprIngestDataModeEnum? dataMode,
  })
      : _id = id,
