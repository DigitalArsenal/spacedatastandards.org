...
class PointOfContactFull {
  PointOfContactFull._(this._bc, this._bcOffset);
  factory PointOfContactFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PointOfContactFull> reader = _PointOfContactFullReader();
  ...
  @override
  String toString() {
    return 'PointOfContactFull{pocSequenceId: ${pocSequenceId}, pocTypeName: ${pocTypeName}, pocName: ${pocName}, office: ${office}, username: ${username}, rank: ${rank}, pocOrg: ${pocOrg}, phone: ${phone}, remark: ${remark}}';
  }
}

class _PointOfContactFullReader extends fb.TableReader<PointOfContactFull> {
  const _PointOfContactFullReader();

  @override
  PointOfContactFull createObject(fb.BufferContext bc, int offset) => 
    PointOfContactFull._(bc, offset);
}

class PointOfContactFullBuilder {
  PointOfContactFullBuilder(this.fbBuilder);
...
class PointOfContactFullObjectBuilder extends fb.ObjectBuilder {
  ...
  PointOfContactFullObjectBuilder({
    int? pocSequenceId,
    String? pocTypeName,
    String? pocName,
    String? office,
