...
class GnssobservationFull {
  GnssobservationFull._(this._bc, this._bcOffset);
  factory GnssobservationFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<GnssobservationFull> reader = _GnssobservationFullReader();
  ...
  @override
  String toString() {
    return 'GnssobservationFull{gnssSatId: ${gnssSatId}, trackingStatus: ${trackingStatus}, agcState: ${agcState}, obsCodeSet: ${obsCodeSet}, ob: ${ob}}';
  }
}

class _GnssobservationFullReader extends fb.TableReader<GnssobservationFull> {
  const _GnssobservationFullReader();

  @override
  GnssobservationFull createObject(fb.BufferContext bc, int offset) => 
    GnssobservationFull._(bc, offset);
}

class GnssobservationFullBuilder {
  GnssobservationFullBuilder(this.fbBuilder);
...
class GnssobservationFullObjectBuilder extends fb.ObjectBuilder {
  ...
  GnssobservationFullObjectBuilder({
    String? gnssSatId,
    int? trackingStatus,
    int? agcState,
