...
class SpaceEnvObservationIngestSenReferenceFrameEnum {
  final int value;
  const SpaceEnvObservationIngestSenReferenceFrameEnum._(this.value);

  factory SpaceEnvObservationIngestSenReferenceFrameEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SpaceEnvObservationIngestSenReferenceFrameEnum');
    }
    return result;
  }

  static SpaceEnvObservationIngestSenReferenceFrameEnum? _createOrNull(int? value) => 
      value == null ? null : SpaceEnvObservationIngestSenReferenceFrameEnum.fromValue(value);
  ...
  static const SpaceEnvObservationIngestSenReferenceFrameEnum J2000 = SpaceEnvObservationIngestSenReferenceFrameEnum._(0);

  ///  No description available.
  static const SpaceEnvObservationIngestSenReferenceFrameEnum EFG_TDR = SpaceEnvObservationIngestSenReferenceFrameEnum._(1);

  ///  No description available.
  static const SpaceEnvObservationIngestSenReferenceFrameEnum ECR_ECEF = SpaceEnvObservationIngestSenReferenceFrameEnum._(2);

  ///  No description available.
  static const SpaceEnvObservationIngestSenReferenceFrameEnum TEME = SpaceEnvObservationIngestSenReferenceFrameEnum._(3);

  ///  No description available.
  static const SpaceEnvObservationIngestSenReferenceFrameEnum ITRF = SpaceEnvObservationIngestSenReferenceFrameEnum._(4);

  ///  No description available.
  static const SpaceEnvObservationIngestSenReferenceFrameEnum GCRF = SpaceEnvObservationIngestSenReferenceFrameEnum._(5);
  static const Map<int, SpaceEnvObservationIngestSenReferenceFrameEnum> values = {
    0: J2000,
    1: EFG_TDR,
    2: ECR_ECEF,
    3: TEME,
  ...
  static const fb.Reader<SpaceEnvObservationIngestSenReferenceFrameEnum> reader = _SpaceEnvObservationIngestSenReferenceFrameEnumReader();

  @override
  String toString() {
    return 'SpaceEnvObservationIngestSenReferenceFrameEnum{value: $value}';
  }
}

class _SpaceEnvObservationIngestSenReferenceFrameEnumReader extends fb.Reader<SpaceEnvObservationIngestSenReferenceFrameEnum> {
  const _SpaceEnvObservationIngestSenReferenceFrameEnumReader();

  @override
  int get size => 1;

  @override
  SpaceEnvObservationIngestSenReferenceFrameEnum read(fb.BufferContext bc, int offset) =>
      SpaceEnvObservationIngestSenReferenceFrameEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class SpaceEnvObservationIngestDataModeEnum {
  final int value;
  const SpaceEnvObservationIngestDataModeEnum._(this.value);

  factory SpaceEnvObservationIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SpaceEnvObservationIngestDataModeEnum');
    }
    return result;
  }

  static SpaceEnvObservationIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SpaceEnvObservationIngestDataModeEnum.fromValue(value);
  ...
  static const SpaceEnvObservationIngestDataModeEnum REAL = SpaceEnvObservationIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SpaceEnvObservationIngestDataModeEnum TEST = SpaceEnvObservationIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SpaceEnvObservationIngestDataModeEnum SIMULATED = SpaceEnvObservationIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SpaceEnvObservationIngestDataModeEnum EXERCISE = SpaceEnvObservationIngestDataModeEnum._(3);
  static const Map<int, SpaceEnvObservationIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SpaceEnvObservationIngestDataModeEnum> reader = _SpaceEnvObservationIngestDataModeEnumReader();

  @override
  String toString() {
    return 'SpaceEnvObservationIngestDataModeEnum{value: $value}';
  }
}

class _SpaceEnvObservationIngestDataModeEnumReader extends fb.Reader<SpaceEnvObservationIngestDataModeEnum> {
  const _SpaceEnvObservationIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SpaceEnvObservationIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      SpaceEnvObservationIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// SpaceEnvObservation data.
class SpaceEnvObservationIngest {
  SpaceEnvObservationIngest._(this._bc, this._bcOffset);
  factory SpaceEnvObservationIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SpaceEnvObservationIngest> reader = _SpaceEnvObservationIngestReader();
  ...
  SpaceEnvObservationIngestSenReferenceFrameEnum get senReferenceFrame => SpaceEnvObservationIngestSenReferenceFrameEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 46, 0));
  ...
  SpaceEnvObservationIngestDataModeEnum get dataMode => SpaceEnvObservationIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 82, 0));
...
class SpaceEnvObservationIngestBuilder {
  ...
  int addSenReferenceFrame(SpaceEnvObservationIngestSenReferenceFrameEnum? senReferenceFrame) {
  ...
  int addDataMode(SpaceEnvObservationIngestDataModeEnum? dataMode) {
...
class SpaceEnvObservationIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final double? _lon;
  final double? _alt;
  final SpaceEnvObservationIngestSenReferenceFrameEnum? _senReferenceFrame;
  ...
  final SpaceEnvObservationIngestDataModeEnum? _dataMode;
  final String? _origNetwork;

  SpaceEnvObservationIngestObjectBuilder({
    String? id,
    ...
    double? lon,
    double? alt,
    SpaceEnvObservationIngestSenReferenceFrameEnum? senReferenceFrame,
    List<String>? senPos,
    List<String>? senVel,
    String? measType,
    ...
    String? source,
    String? origin,
    SpaceEnvObservationIngestDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
