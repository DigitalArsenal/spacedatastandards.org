...
class ObjectOfInterestAbridgedDataModeEnum {
  final int value;
  const ObjectOfInterestAbridgedDataModeEnum._(this.value);

  factory ObjectOfInterestAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ObjectOfInterestAbridgedDataModeEnum');
    }
    return result;
  }

  static ObjectOfInterestAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : ObjectOfInterestAbridgedDataModeEnum.fromValue(value);
  ...
  static const ObjectOfInterestAbridgedDataModeEnum REAL = ObjectOfInterestAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const ObjectOfInterestAbridgedDataModeEnum TEST = ObjectOfInterestAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const ObjectOfInterestAbridgedDataModeEnum SIMULATED = ObjectOfInterestAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const ObjectOfInterestAbridgedDataModeEnum EXERCISE = ObjectOfInterestAbridgedDataModeEnum._(3);
  static const Map<int, ObjectOfInterestAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<ObjectOfInterestAbridgedDataModeEnum> reader = _ObjectOfInterestAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'ObjectOfInterestAbridgedDataModeEnum{value: $value}';
  }
}

class _ObjectOfInterestAbridgedDataModeEnumReader extends fb.Reader<ObjectOfInterestAbridgedDataModeEnum> {
  const _ObjectOfInterestAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  ObjectOfInterestAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      ObjectOfInterestAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// OnOrbit objects of interest, which include information about the last known state of the object.
class ObjectOfInterestAbridged {
  ObjectOfInterestAbridged._(this._bc, this._bcOffset);
  factory ObjectOfInterestAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<ObjectOfInterestAbridged> reader = _ObjectOfInterestAbridgedReader();
  ...
  String? get origin => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 84);
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  ObjectOfInterestAbridgedDataModeEnum get dataMode => ObjectOfInterestAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 88, 0));

  @override
  String toString() {
    return 'ObjectOfInterestAbridged{id: ${id}, classificationMarking: ${classificationMarking}, idOnOrbit: ${idOnOrbit}, satNo: ${satNo}, name: ${name}, sensorTaskingStartTime: ${sensorTaskingStartTime}, sensorTaskingStopTime: ${sensorTaskingStopTime}, priority: ${priority}, status: ${status}, statusDate: ${statusDate}, description: ${description}, lastObTime: ${lastObTime}, missedObTime: ${missedObTime}, deltaVs: ${deltaVs}, deltaTs: ${deltaTs}, svEpoch: ${svEpoch}, x: ${x}, y: ${y}, z: ${z}, xvel: ${xvel}, yvel: ${yvel}, zvel: ${zvel}, elsetEpoch: ${elsetEpoch}, meanMotion: ${meanMotion}, eccentricity: ${eccentricity}, inclination: ${inclination}, raan: ${raan}, argOfPerigee: ${argOfPerigee}, meanAnomaly: ${meanAnomaly}, revNo: ${revNo}, bStar: ${bStar}, meanMotionDot: ${meanMotionDot}, meanMotionDdot: ${meanMotionDdot}, semiMajorAxis: ${semiMajorAxis}, period: ${period}, apogee: ${apogee}, perigee: ${perigee}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _ObjectOfInterestAbridgedReader extends fb.TableReader<ObjectOfInterestAbridged> {
  const _ObjectOfInterestAbridgedReader();

  @override
  ObjectOfInterestAbridged createObject(fb.BufferContext bc, int offset) => 
    ObjectOfInterestAbridged._(bc, offset);
}

class ObjectOfInterestAbridgedBuilder {
  ObjectOfInterestAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(ObjectOfInterestAbridgedDataModeEnum? dataMode) {
    fbBuilder.addInt8(42, dataMode?.value);
    return fbBuilder.offset;
  }
...
class ObjectOfInterestAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final ObjectOfInterestAbridgedDataModeEnum? _dataMode;

  ObjectOfInterestAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    ObjectOfInterestAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(40, originOffset);
    fbBuilder.addOffset(41, origNetworkOffset);
    fbBuilder.addInt8(42, _dataMode?.value);
    return fbBuilder.endTable();
  }
