...
class AircraftAbridgedDataModeEnum {
  final int value;
  const AircraftAbridgedDataModeEnum._(this.value);

  factory AircraftAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AircraftAbridgedDataModeEnum');
    }
    return result;
  }

  static AircraftAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AircraftAbridgedDataModeEnum.fromValue(value);
  ...
  static const AircraftAbridgedDataModeEnum REAL = AircraftAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AircraftAbridgedDataModeEnum TEST = AircraftAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AircraftAbridgedDataModeEnum SIMULATED = AircraftAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AircraftAbridgedDataModeEnum EXERCISE = AircraftAbridgedDataModeEnum._(3);
  static const Map<int, AircraftAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AircraftAbridgedDataModeEnum> reader = _AircraftAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'AircraftAbridgedDataModeEnum{value: $value}';
  }
}

class _AircraftAbridgedDataModeEnumReader extends fb.Reader<AircraftAbridgedDataModeEnum> {
  const _AircraftAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AircraftAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      AircraftAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
