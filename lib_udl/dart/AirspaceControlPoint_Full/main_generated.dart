...
class AirspaceControlPointFull {
  AirspaceControlPointFull._(this._bc, this._bcOffset);
  factory AirspaceControlPointFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirspaceControlPointFull> reader = _AirspaceControlPointFullReader();
  ...
  @override
  String toString() {
    return 'AirspaceControlPointFull{ctrlPtType: ${ctrlPtType}, ctrlPtName: ${ctrlPtName}, ctrlPtLocation: ${ctrlPtLocation}, ctrlPtAltitude: ${ctrlPtAltitude}}';
  }
}

class _AirspaceControlPointFullReader extends fb.TableReader<AirspaceControlPointFull> {
  const _AirspaceControlPointFullReader();

  @override
  AirspaceControlPointFull createObject(fb.BufferContext bc, int offset) => 
    AirspaceControlPointFull._(bc, offset);
}

class AirspaceControlPointFullBuilder {
  AirspaceControlPointFullBuilder(this.fbBuilder);
...
class AirspaceControlPointFullObjectBuilder extends fb.ObjectBuilder {
  final String? _ctrlPtType;
  final String? _ctrlPtName;
  final String? _ctrlPtLocation;
  final String? _ctrlPtAltitude;

  AirspaceControlPointFullObjectBuilder({
    String? ctrlPtType,
    String? ctrlPtName,
