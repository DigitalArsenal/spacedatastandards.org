...
class AntennaDetailsModeEnum {
  final int value;
  const AntennaDetailsModeEnum._(this.value);

  factory AntennaDetailsModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AntennaDetailsModeEnum');
    }
    return result;
  }

  static AntennaDetailsModeEnum? _createOrNull(int? value) => 
      value == null ? null : AntennaDetailsModeEnum.fromValue(value);
  ...
  static const AntennaDetailsModeEnum TX = AntennaDetailsModeEnum._(0);

  ///  No description available.
  static const AntennaDetailsModeEnum RX = AntennaDetailsModeEnum._(1);
  static const Map<int, AntennaDetailsModeEnum> values = {
    0: TX,
    1: RX};

  static const fb.Reader<AntennaDetailsModeEnum> reader = _AntennaDetailsModeEnumReader();

  @override
  String toString() {
    return 'AntennaDetailsModeEnum{value: $value}';
  }
}

class _AntennaDetailsModeEnumReader extends fb.Reader<AntennaDetailsModeEnum> {
  const _AntennaDetailsModeEnumReader();

  @override
  int get size => 1;

  @override
  AntennaDetailsModeEnum read(fb.BufferContext bc, int offset) =>
      AntennaDetailsModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class AntennaDetailsDataModeEnum {
  final int value;
  const AntennaDetailsDataModeEnum._(this.value);

  factory AntennaDetailsDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AntennaDetailsDataModeEnum');
    }
    return result;
  }

  static AntennaDetailsDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AntennaDetailsDataModeEnum.fromValue(value);
  ...
  static const AntennaDetailsDataModeEnum REAL = AntennaDetailsDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AntennaDetailsDataModeEnum TEST = AntennaDetailsDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AntennaDetailsDataModeEnum SIMULATED = AntennaDetailsDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AntennaDetailsDataModeEnum EXERCISE = AntennaDetailsDataModeEnum._(3);
  static const Map<int, AntennaDetailsDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AntennaDetailsDataModeEnum> reader = _AntennaDetailsDataModeEnumReader();

  @override
  String toString() {
    return 'AntennaDetailsDataModeEnum{value: $value}';
  }
}

class _AntennaDetailsDataModeEnumReader extends fb.Reader<AntennaDetailsDataModeEnum> {
  const _AntennaDetailsDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AntennaDetailsDataModeEnum read(fb.BufferContext bc, int offset) =>
      AntennaDetailsDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AntennaDetails {
  AntennaDetails._(this._bc, this._bcOffset);
  factory AntennaDetails(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AntennaDetails> reader = _AntennaDetailsReader();
  ...
  AntennaDetailsModeEnum get mode => AntennaDetailsModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 14, 0));
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  AntennaDetailsDataModeEnum get dataMode => AntennaDetailsDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 54, 0));
  ...
  @override
  String toString() {
    return 'AntennaDetails{id: ${id}, idAntenna: ${idAntenna}, classificationMarking: ${classificationMarking}, type: ${type}, position: ${position}, mode: ${mode}, steerable: ${steerable}, beamForming: ${beamForming}, manufacturerOrgId: ${manufacturerOrgId}, diameter: ${diameter}, size: ${size}, startFrequency: ${startFrequency}, endFrequency: ${endFrequency}, beamwidth: ${beamwidth}, gain: ${gain}, gainTolerance: ${gainTolerance}, polarization: ${polarization}, description: ${description}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, tags: ${tags}, manufacturerOrg: ${manufacturerOrg}}';
  }
}

class _AntennaDetailsReader extends fb.TableReader<AntennaDetails> {
  const _AntennaDetailsReader();

  @override
  AntennaDetails createObject(fb.BufferContext bc, int offset) => 
    AntennaDetails._(bc, offset);
}

class AntennaDetailsBuilder {
  AntennaDetailsBuilder(this.fbBuilder);
  ...
  int addMode(AntennaDetailsModeEnum? mode) {
  ...
  int addDataMode(AntennaDetailsDataModeEnum? dataMode) {
...
class AntennaDetailsObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _idAntenna;
  final String? _classificationMarking;
  final String? _type;
  final String? _position;
  final AntennaDetailsModeEnum? _mode;
  ...
  final AntennaDetailsDataModeEnum? _dataMode;
  final List<String>? _tags;
  final String? _manufacturerOrg;

  AntennaDetailsObjectBuilder({
    String? id,
    String? idAntenna,
    String? classificationMarking,
    String? type,
    String? position,
    AntennaDetailsModeEnum? mode,
    bool? steerable,
    bool? beamForming,
    ...
    String? origin,
    String? origNetwork,
    AntennaDetailsDataModeEnum? dataMode,
    List<String>? tags,
