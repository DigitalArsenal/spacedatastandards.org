...
class DataLinkIngestDataModeEnum {
  final int value;
  const DataLinkIngestDataModeEnum._(this.value);

  factory DataLinkIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum DataLinkIngestDataModeEnum');
    }
    return result;
  }

  static DataLinkIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : DataLinkIngestDataModeEnum.fromValue(value);
  ...
  static const DataLinkIngestDataModeEnum REAL = DataLinkIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const DataLinkIngestDataModeEnum TEST = DataLinkIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const DataLinkIngestDataModeEnum SIMULATED = DataLinkIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const DataLinkIngestDataModeEnum EXERCISE = DataLinkIngestDataModeEnum._(3);
  static const Map<int, DataLinkIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<DataLinkIngestDataModeEnum> reader = _DataLinkIngestDataModeEnumReader();

  @override
  String toString() {
    return 'DataLinkIngestDataModeEnum{value: $value}';
  }
}

class _DataLinkIngestDataModeEnumReader extends fb.Reader<DataLinkIngestDataModeEnum> {
  const _DataLinkIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  DataLinkIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      DataLinkIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Beta Version DataLink: Detailed instructions regarding the operations of data links.
class DataLinkIngest {
  DataLinkIngest._(this._bc, this._bcOffset);
  factory DataLinkIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DataLinkIngest> reader = _DataLinkIngestReader();
...
class DataLinkIngestBuilder {
  ...
  int addDataMode(DataLinkIngestDataModeEnum? dataMode) {
...
class DataLinkIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final DataLinkIngestDataModeEnum? _dataMode;

  DataLinkIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    DataLinkIngestDataModeEnum? dataMode,
  })
      : _id = id,
