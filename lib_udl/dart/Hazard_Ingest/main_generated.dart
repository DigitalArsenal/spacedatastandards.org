...
class HazardIngestDataModeEnum {
  final int value;
  const HazardIngestDataModeEnum._(this.value);

  factory HazardIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum HazardIngestDataModeEnum');
    }
    return result;
  }

  static HazardIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : HazardIngestDataModeEnum.fromValue(value);
  ...
  static const HazardIngestDataModeEnum REAL = HazardIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const HazardIngestDataModeEnum TEST = HazardIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const HazardIngestDataModeEnum SIMULATED = HazardIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const HazardIngestDataModeEnum EXERCISE = HazardIngestDataModeEnum._(3);
  static const Map<int, HazardIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<HazardIngestDataModeEnum> reader = _HazardIngestDataModeEnumReader();

  @override
  String toString() {
    return 'HazardIngestDataModeEnum{value: $value}';
  }
}

class _HazardIngestDataModeEnumReader extends fb.Reader<HazardIngestDataModeEnum> {
  const _HazardIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  HazardIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      HazardIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class HazardIngest {
  HazardIngest._(this._bc, this._bcOffset);
  factory HazardIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<HazardIngest> reader = _HazardIngestReader();
...
class HazardIngestBuilder {
  ...
  int addDataMode(HazardIngestDataModeEnum? dataMode) {
...
class HazardIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final HazardIngestDataModeEnum? _dataMode;

  HazardIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    HazardIngestDataModeEnum? dataMode,
  })
      : _id = id,
