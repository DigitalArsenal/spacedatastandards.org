...
class RfemitterDetailsFullDataModeEnum {
  final int value;
  const RfemitterDetailsFullDataModeEnum._(this.value);

  factory RfemitterDetailsFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum RfemitterDetailsFullDataModeEnum');
    }
    return result;
  }

  static RfemitterDetailsFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : RfemitterDetailsFullDataModeEnum.fromValue(value);
  ...
  static const RfemitterDetailsFullDataModeEnum REAL = RfemitterDetailsFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const RfemitterDetailsFullDataModeEnum TEST = RfemitterDetailsFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const RfemitterDetailsFullDataModeEnum SIMULATED = RfemitterDetailsFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const RfemitterDetailsFullDataModeEnum EXERCISE = RfemitterDetailsFullDataModeEnum._(3);
  static const Map<int, RfemitterDetailsFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<RfemitterDetailsFullDataModeEnum> reader = _RfemitterDetailsFullDataModeEnumReader();

  @override
  String toString() {
    return 'RfemitterDetailsFullDataModeEnum{value: $value}';
  }
}

class _RfemitterDetailsFullDataModeEnumReader extends fb.Reader<RfemitterDetailsFullDataModeEnum> {
  const _RfemitterDetailsFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  RfemitterDetailsFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      RfemitterDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class RfemitterDetailsFull {
  RfemitterDetailsFull._(this._bc, this._bcOffset);
  factory RfemitterDetailsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<RfemitterDetailsFull> reader = _RfemitterDetailsFullReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  RfemitterDetailsFullDataModeEnum get dataMode => RfemitterDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 68, 0));
  ...
  ///  Example: /// Example: 2018-01-01T16:00:00.123Z
  ///  Constraints: No constraints specified.
  String? get updatedAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 74);
  ///  Application user who updated the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get updatedBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 76);
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  String? get productionFacilityLocation => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 78);
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  String? get manufacturerOrg => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 80);

  @override
  String toString() {
    return 'RfemitterDetailsFull{id: ${id}, idRfemitter: ${idRfemitter}, classificationMarking: ${classificationMarking}, designator: ${designator}, altName: ${altName}, family: ${family}, productionFacilityName: ${productionFacilityName}, alternateFacilityName: ${alternateFacilityName}, manufacturerOrgId: ${manufacturerOrgId}, productionFacilityLocationId: ${productionFacilityLocationId}, systemSensitivityStart: ${systemSensitivityStart}, systemSensitivityEnd: ${systemSensitivityEnd}, receiverType: ${receiverType}, receiverSensitivity: ${receiverSensitivity}, receiverBandwidth: ${receiverBandwidth}, transmitterFrequency: ${transmitterFrequency}, transmitterBandwidth: ${transmitterBandwidth}, transmitPower: ${transmitPower}, barrageNoiseBandwidth: ${barrageNoiseBandwidth}, dopplerNoise: ${dopplerNoise}, drfmInstantaneousBandwidth: ${drfmInstantaneousBandwidth}, numChannels: ${numChannels}, numBits: ${numBits}, antennaSize: ${antennaSize}, antennaDiameter: ${antennaDiameter}, notes: ${notes}, secondaryNotes: ${secondaryNotes}, description: ${description}, urls: ${urls}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, productionFacilityLocation: ${productionFacilityLocation}, manufacturerOrg: ${manufacturerOrg}}';
  }
}

class _RfemitterDetailsFullReader extends fb.TableReader<RfemitterDetailsFull> {
  const _RfemitterDetailsFullReader();

  @override
  RfemitterDetailsFull createObject(fb.BufferContext bc, int offset) => 
    RfemitterDetailsFull._(bc, offset);
}

class RfemitterDetailsFullBuilder {
  RfemitterDetailsFullBuilder(this.fbBuilder);
  ...
  int addDataMode(RfemitterDetailsFullDataModeEnum? dataMode) {
  ...
  int addProductionFacilityLocationOffset(int? offset) {
...
class RfemitterDetailsFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final RfemitterDetailsFullDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final String? _updatedAt;
  final String? _updatedBy;
  final String? _productionFacilityLocation;
  final String? _manufacturerOrg;

  RfemitterDetailsFullObjectBuilder({
    String? id,
    String? idRfemitter,
    ...
    String? origin,
    String? origNetwork,
    RfemitterDetailsFullDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? updatedAt,
    String? updatedBy,
    String? productionFacilityLocation,
    String? manufacturerOrg,
      ...
      : _id = id,
        ...
        _productionFacilityLocation = productionFacilityLocation,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    final int? productionFacilityLocationOffset = _productionFacilityLocation == null ? null
        : fbBuilder.writeString(_productionFacilityLocation!);
    ...
    fbBuilder.addOffset(35, updatedAtOffset);
    fbBuilder.addOffset(36, updatedByOffset);
    fbBuilder.addOffset(37, productionFacilityLocationOffset);
    fbBuilder.addOffset(38, manufacturerOrgOffset);
    return fbBuilder.endTable();
  }
