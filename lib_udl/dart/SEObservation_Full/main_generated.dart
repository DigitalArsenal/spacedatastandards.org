...
class SeobservationFull {
  SeobservationFull._(this._bc, this._bcOffset);
  factory SeobservationFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SeobservationFull> reader = _SeobservationFullReader();
  ...
  @override
  String toString() {
    return 'SeobservationFull{obType: ${obType}, obUoM: ${obUoM}, obValue: ${obValue}, obString: ${obString}, obArray: ${obArray}, obBool: ${obBool}, obQuality: ${obQuality}, obDescription: ${obDescription}}';
  }
}

class _SeobservationFullReader extends fb.TableReader<SeobservationFull> {
  const _SeobservationFullReader();

  @override
  SeobservationFull createObject(fb.BufferContext bc, int offset) => 
    SeobservationFull._(bc, offset);
}

class SeobservationFullBuilder {
  SeobservationFullBuilder(this.fbBuilder);
...
class SeobservationFullObjectBuilder extends fb.ObjectBuilder {
  ...
  SeobservationFullObjectBuilder({
    String? obType,
    String? obUoM,
    double? obValue,
    String? obString,
