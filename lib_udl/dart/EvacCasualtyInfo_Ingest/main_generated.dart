...
class EvacCasualtyInfoIngest {
  EvacCasualtyInfoIngest._(this._bc, this._bcOffset);
  factory EvacCasualtyInfoIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EvacCasualtyInfoIngest> reader = _EvacCasualtyInfoIngestReader();
...
class EvacCasualtyInfoIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  EvacCasualtyInfoIngestObjectBuilder({
    String? priority,
    String? evacType,
    String? casualtyType,
    String? bodyPart,
