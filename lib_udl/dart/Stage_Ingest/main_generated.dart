...
class StageIngestDataModeEnum {
  final int value;
  const StageIngestDataModeEnum._(this.value);

  factory StageIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum StageIngestDataModeEnum');
    }
    return result;
  }

  static StageIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : StageIngestDataModeEnum.fromValue(value);
  ...
  static const StageIngestDataModeEnum REAL = StageIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const StageIngestDataModeEnum TEST = StageIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const StageIngestDataModeEnum SIMULATED = StageIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const StageIngestDataModeEnum EXERCISE = StageIngestDataModeEnum._(3);
  static const Map<int, StageIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<StageIngestDataModeEnum> reader = _StageIngestDataModeEnumReader();

  @override
  String toString() {
    return 'StageIngestDataModeEnum{value: $value}';
  }
}

class _StageIngestDataModeEnumReader extends fb.Reader<StageIngestDataModeEnum> {
  const _StageIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  StageIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      StageIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class StageIngest {
  StageIngest._(this._bc, this._bcOffset);
  factory StageIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<StageIngest> reader = _StageIngestReader();
...
class StageIngestBuilder {
  ...
  int addDataMode(StageIngestDataModeEnum? dataMode) {
...
class StageIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final StageIngestDataModeEnum? _dataMode;

  StageIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    StageIngestDataModeEnum? dataMode,
  })
      : _id = id,
