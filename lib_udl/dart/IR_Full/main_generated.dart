...
class IrFullDataModeEnum {
  final int value;
  const IrFullDataModeEnum._(this.value);

  factory IrFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum IrFullDataModeEnum');
    }
    return result;
  }

  static IrFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : IrFullDataModeEnum.fromValue(value);
  ...
  static const IrFullDataModeEnum REAL = IrFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const IrFullDataModeEnum TEST = IrFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const IrFullDataModeEnum SIMULATED = IrFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const IrFullDataModeEnum EXERCISE = IrFullDataModeEnum._(3);
  static const Map<int, IrFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<IrFullDataModeEnum> reader = _IrFullDataModeEnumReader();

  @override
  String toString() {
    return 'IrFullDataModeEnum{value: $value}';
  }
}

class _IrFullDataModeEnumReader extends fb.Reader<IrFullDataModeEnum> {
  const _IrFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  IrFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      IrFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// IR represents Infrared entities within the SSA environment.
class IrFull {
  IrFull._(this._bc, this._bcOffset);
  factory IrFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IrFull> reader = _IrFullReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  IrFullDataModeEnum get dataMode => IrFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 28, 0));
  ...
  @override
  String toString() {
    return 'IrFull{id: ${id}, classificationMarking: ${classificationMarking}, idEntity: ${idEntity}, name: ${name}, description: ${description}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, entity: ${entity}}';
  }
}

class _IrFullReader extends fb.TableReader<IrFull> {
  const _IrFullReader();

  @override
  IrFull createObject(fb.BufferContext bc, int offset) => 
    IrFull._(bc, offset);
}

class IrFullBuilder {
  IrFullBuilder(this.fbBuilder);
  ...
  int addDataMode(IrFullDataModeEnum? dataMode) {
...
class IrFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final IrFullDataModeEnum? _dataMode;
