...
class BatteryDetailsAbridgedDataModeEnum {
  final int value;
  const BatteryDetailsAbridgedDataModeEnum._(this.value);

  factory BatteryDetailsAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum BatteryDetailsAbridgedDataModeEnum');
    }
    return result;
  }

  static BatteryDetailsAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : BatteryDetailsAbridgedDataModeEnum.fromValue(value);
  ...
  static const BatteryDetailsAbridgedDataModeEnum REAL = BatteryDetailsAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const BatteryDetailsAbridgedDataModeEnum TEST = BatteryDetailsAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const BatteryDetailsAbridgedDataModeEnum SIMULATED = BatteryDetailsAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const BatteryDetailsAbridgedDataModeEnum EXERCISE = BatteryDetailsAbridgedDataModeEnum._(3);
  static const Map<int, BatteryDetailsAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<BatteryDetailsAbridgedDataModeEnum> reader = _BatteryDetailsAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'BatteryDetailsAbridgedDataModeEnum{value: $value}';
  }
}

class _BatteryDetailsAbridgedDataModeEnumReader extends fb.Reader<BatteryDetailsAbridgedDataModeEnum> {
  const _BatteryDetailsAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  BatteryDetailsAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      BatteryDetailsAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class BatteryDetailsAbridged {
  BatteryDetailsAbridged._(this._bc, this._bcOffset);
  factory BatteryDetailsAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<BatteryDetailsAbridged> reader = _BatteryDetailsAbridgedReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  BatteryDetailsAbridgedDataModeEnum get dataMode => BatteryDetailsAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 32, 0));

  @override
  String toString() {
    return 'BatteryDetailsAbridged{id: ${id}, idBattery: ${idBattery}, classificationMarking: ${classificationMarking}, technology: ${technology}, capacity: ${capacity}, dischargeDepth: ${dischargeDepth}, model: ${model}, description: ${description}, manufacturerOrgId: ${manufacturerOrgId}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _BatteryDetailsAbridgedReader extends fb.TableReader<BatteryDetailsAbridged> {
  const _BatteryDetailsAbridgedReader();

  @override
  BatteryDetailsAbridged createObject(fb.BufferContext bc, int offset) => 
    BatteryDetailsAbridged._(bc, offset);
}

class BatteryDetailsAbridgedBuilder {
  BatteryDetailsAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(BatteryDetailsAbridgedDataModeEnum? dataMode) {
...
class BatteryDetailsAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final BatteryDetailsAbridgedDataModeEnum? _dataMode;

  BatteryDetailsAbridgedObjectBuilder({
    String? id,
    String? idBattery,
    ...
    String? origin,
    String? origNetwork,
    BatteryDetailsAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
