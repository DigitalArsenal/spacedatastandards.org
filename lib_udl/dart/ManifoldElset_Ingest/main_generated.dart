...
class ManifoldElsetIngestDataModeEnum {
  final int value;
  const ManifoldElsetIngestDataModeEnum._(this.value);

  factory ManifoldElsetIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ManifoldElsetIngestDataModeEnum');
    }
    return result;
  }

  static ManifoldElsetIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : ManifoldElsetIngestDataModeEnum.fromValue(value);
  ...
  static const ManifoldElsetIngestDataModeEnum REAL = ManifoldElsetIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const ManifoldElsetIngestDataModeEnum TEST = ManifoldElsetIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const ManifoldElsetIngestDataModeEnum SIMULATED = ManifoldElsetIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const ManifoldElsetIngestDataModeEnum EXERCISE = ManifoldElsetIngestDataModeEnum._(3);
  static const Map<int, ManifoldElsetIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<ManifoldElsetIngestDataModeEnum> reader = _ManifoldElsetIngestDataModeEnumReader();

  @override
  String toString() {
    return 'ManifoldElsetIngestDataModeEnum{value: $value}';
  }
}

class _ManifoldElsetIngestDataModeEnumReader extends fb.Reader<ManifoldElsetIngestDataModeEnum> {
  const _ManifoldElsetIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  ManifoldElsetIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      ManifoldElsetIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class ManifoldElsetIngest {
  ManifoldElsetIngest._(this._bc, this._bcOffset);
  factory ManifoldElsetIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<ManifoldElsetIngest> reader = _ManifoldElsetIngestReader();
  ...
  ManifoldElsetIngestDataModeEnum get dataMode => ManifoldElsetIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 54, 0));
...
class ManifoldElsetIngestBuilder {
  ...
  int addDataMode(ManifoldElsetIngestDataModeEnum? dataMode) {
...
class ManifoldElsetIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final ManifoldElsetIngestDataModeEnum? _dataMode;
  final String? _origNetwork;

  ManifoldElsetIngestObjectBuilder({
    String? id,
    String? idManifold,
    ...
    String? source,
    String? origin,
    ManifoldElsetIngestDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
