...
class TrackDetailsFullEnvEnum {
  final int value;
  const TrackDetailsFullEnvEnum._(this.value);

  factory TrackDetailsFullEnvEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum TrackDetailsFullEnvEnum');
    }
    return result;
  }

  static TrackDetailsFullEnvEnum? _createOrNull(int? value) => 
      value == null ? null : TrackDetailsFullEnvEnum.fromValue(value);
  ...
  static const TrackDetailsFullEnvEnum AIR = TrackDetailsFullEnvEnum._(0);

  ///  On the surface of dry land.
  static const TrackDetailsFullEnvEnum LAND = TrackDetailsFullEnvEnum._(1);

  ///  Above the Kármán line, which has an altitude of 100 kilometers (62 miles).
  static const TrackDetailsFullEnvEnum SPACE = TrackDetailsFullEnvEnum._(2);

  ///  On the surface of a body of water.
  static const TrackDetailsFullEnvEnum SURFACE = TrackDetailsFullEnvEnum._(3);

  ///  Below the surface of a body of water.
  static const TrackDetailsFullEnvEnum SUBSURFACE = TrackDetailsFullEnvEnum._(4);

  ///  Environment is not known.
  static const TrackDetailsFullEnvEnum UNKNOWN = TrackDetailsFullEnvEnum._(5);
  static const Map<int, TrackDetailsFullEnvEnum> values = {
    0: AIR,
    1: LAND,
    2: SPACE,
    3: SURFACE,
  ...
  static const fb.Reader<TrackDetailsFullEnvEnum> reader = _TrackDetailsFullEnvEnumReader();

  @override
  String toString() {
    return 'TrackDetailsFullEnvEnum{value: $value}';
  }
}

class _TrackDetailsFullEnvEnumReader extends fb.Reader<TrackDetailsFullEnvEnum> {
  const _TrackDetailsFullEnvEnumReader();

  @override
  int get size => 1;

  @override
  TrackDetailsFullEnvEnum read(fb.BufferContext bc, int offset) =>
      TrackDetailsFullEnvEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class TrackDetailsFullObjIdentEnum {
  final int value;
  const TrackDetailsFullObjIdentEnum._(this.value);

  factory TrackDetailsFullObjIdentEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum TrackDetailsFullObjIdentEnum');
    }
    return result;
  }

  static TrackDetailsFullObjIdentEnum? _createOrNull(int? value) => 
      value == null ? null : TrackDetailsFullObjIdentEnum.fromValue(value);
  ...
  static const TrackDetailsFullObjIdentEnum ASSUMED_FRIEND = TrackDetailsFullObjIdentEnum._(0);

  ///  Track object supporting friendly forces and belonging to a declared friendly nation or entity.
  static const TrackDetailsFullObjIdentEnum FRIEND = TrackDetailsFullObjIdentEnum._(1);
  ...
  static const TrackDetailsFullObjIdentEnum HOSTILE = TrackDetailsFullObjIdentEnum._(2);
  ...
  static const TrackDetailsFullObjIdentEnum NEUTRAL = TrackDetailsFullObjIdentEnum._(3);

  ///  Track object which has not been evaluated.
  static const TrackDetailsFullObjIdentEnum PENDING = TrackDetailsFullObjIdentEnum._(4);

  ///  Track object deemed potentially hostile due to the object characteristics, behavior, nationality, and/or origin.
  static const TrackDetailsFullObjIdentEnum SUSPECT = TrackDetailsFullObjIdentEnum._(5);

  ///  Track object which has been evaluated and does not meet criteria for any standard identity.
  static const TrackDetailsFullObjIdentEnum UNKNOWN = TrackDetailsFullObjIdentEnum._(6);
  static const Map<int, TrackDetailsFullObjIdentEnum> values = {
    0: ASSUMED_FRIEND,
    1: FRIEND,
    2: HOSTILE,
    3: NEUTRAL,
  ...
  static const fb.Reader<TrackDetailsFullObjIdentEnum> reader = _TrackDetailsFullObjIdentEnumReader();

  @override
  String toString() {
    return 'TrackDetailsFullObjIdentEnum{value: $value}';
  }
}

class _TrackDetailsFullObjIdentEnumReader extends fb.Reader<TrackDetailsFullObjIdentEnum> {
  const _TrackDetailsFullObjIdentEnumReader();

  @override
  int get size => 1;

  @override
  TrackDetailsFullObjIdentEnum read(fb.BufferContext bc, int offset) =>
      TrackDetailsFullObjIdentEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class TrackDetailsFullDataModeEnum {
  final int value;
  const TrackDetailsFullDataModeEnum._(this.value);

  factory TrackDetailsFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum TrackDetailsFullDataModeEnum');
    }
    return result;
  }

  static TrackDetailsFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : TrackDetailsFullDataModeEnum.fromValue(value);
  ...
  static const TrackDetailsFullDataModeEnum REAL = TrackDetailsFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const TrackDetailsFullDataModeEnum TEST = TrackDetailsFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const TrackDetailsFullDataModeEnum SIMULATED = TrackDetailsFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const TrackDetailsFullDataModeEnum EXERCISE = TrackDetailsFullDataModeEnum._(3);
  static const Map<int, TrackDetailsFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<TrackDetailsFullDataModeEnum> reader = _TrackDetailsFullDataModeEnumReader();

  @override
  String toString() {
    return 'TrackDetailsFullDataModeEnum{value: $value}';
  }
}

class _TrackDetailsFullDataModeEnumReader extends fb.Reader<TrackDetailsFullDataModeEnum> {
  const _TrackDetailsFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  TrackDetailsFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      TrackDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class TrackDetailsFull {
  TrackDetailsFull._(this._bc, this._bcOffset);
  factory TrackDetailsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<TrackDetailsFull> reader = _TrackDetailsFullReader();
  ...
  TrackDetailsFullEnvEnum get env => TrackDetailsFullEnvEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 8, 0));
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 32
  TrackDetailsFullObjIdentEnum get objIdent => TrackDetailsFullObjIdentEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 50, 0));
  ...
  TrackDetailsFullDataModeEnum get dataMode => TrackDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 316, 0));
...
class TrackDetailsFullBuilder {
  ...
  int addEnv(TrackDetailsFullEnvEnum? env) {
  ...
  int addObjIdent(TrackDetailsFullObjIdentEnum? objIdent) {
  ...
  int addDataMode(TrackDetailsFullDataModeEnum? dataMode) {
...
class TrackDetailsFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _classificationMarking;
  final TrackDetailsFullEnvEnum? _env;
  ...
  final TrackDetailsFullObjIdentEnum? _objIdent;
  ...
  final TrackDetailsFullDataModeEnum? _dataMode;
  final String? _origNetwork;

  TrackDetailsFullObjectBuilder({
    String? id,
    String? classificationMarking,
    TrackDetailsFullEnvEnum? env,
    String? msgType,
    String? hullNum,
    String? pif,
    String? sconum,
    ...
    String? elnot1,
    String? elnot2,
    TrackDetailsFullObjIdentEnum? objIdent,
    String? objType,
    String? objPlat,
    String? objAct,
    String? objNat,
    ...
    String? source,
    String? origin,
    TrackDetailsFullDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
