...
class LaunchDetectionFullDataModeEnum {
  final int value;
  const LaunchDetectionFullDataModeEnum._(this.value);

  factory LaunchDetectionFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum LaunchDetectionFullDataModeEnum');
    }
    return result;
  }

  static LaunchDetectionFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : LaunchDetectionFullDataModeEnum.fromValue(value);
  ...
  static const LaunchDetectionFullDataModeEnum REAL = LaunchDetectionFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const LaunchDetectionFullDataModeEnum TEST = LaunchDetectionFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const LaunchDetectionFullDataModeEnum SIMULATED = LaunchDetectionFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const LaunchDetectionFullDataModeEnum EXERCISE = LaunchDetectionFullDataModeEnum._(3);
  static const Map<int, LaunchDetectionFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<LaunchDetectionFullDataModeEnum> reader = _LaunchDetectionFullDataModeEnumReader();

  @override
  String toString() {
    return 'LaunchDetectionFullDataModeEnum{value: $value}';
  }
}

class _LaunchDetectionFullDataModeEnumReader extends fb.Reader<LaunchDetectionFullDataModeEnum> {
  const _LaunchDetectionFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  LaunchDetectionFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      LaunchDetectionFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Data to analyze launch detections.
class LaunchDetectionFull {
  LaunchDetectionFull._(this._bc, this._bcOffset);
  factory LaunchDetectionFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LaunchDetectionFull> reader = _LaunchDetectionFullReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  LaunchDetectionFullDataModeEnum get dataMode => LaunchDetectionFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 48, 0));
  ...
  @override
  String toString() {
    return 'LaunchDetectionFull{id: ${id}, classificationMarking: ${classificationMarking}, launchTime: ${launchTime}, messageType: ${messageType}, launchLatitude: ${launchLatitude}, launchLongitude: ${launchLongitude}, launchAzimuth: ${launchAzimuth}, raan: ${raan}, inclination: ${inclination}, observationTime: ${observationTime}, observationLatitude: ${observationLatitude}, observationLongitude: ${observationLongitude}, observationAltitude: ${observationAltitude}, stereoFlag: ${stereoFlag}, highZenithAzimuth: ${highZenithAzimuth}, sequenceNumber: ${sequenceNumber}, eventId: ${eventId}, source: ${source}, origin: ${origin}, descriptor: ${descriptor}, tags: ${tags}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}}';
  }
}

class _LaunchDetectionFullReader extends fb.TableReader<LaunchDetectionFull> {
  const _LaunchDetectionFullReader();

  @override
  LaunchDetectionFull createObject(fb.BufferContext bc, int offset) => 
    LaunchDetectionFull._(bc, offset);
}

class LaunchDetectionFullBuilder {
  LaunchDetectionFullBuilder(this.fbBuilder);
  ...
  int addDataMode(LaunchDetectionFullDataModeEnum? dataMode) {
...
class LaunchDetectionFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final LaunchDetectionFullDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final String? _updatedAt;
  final String? _updatedBy;

  LaunchDetectionFullObjectBuilder({
    String? id,
    ...
    List<String>? tags,
    String? origNetwork,
    LaunchDetectionFullDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? updatedAt,
    String? updatedBy,
