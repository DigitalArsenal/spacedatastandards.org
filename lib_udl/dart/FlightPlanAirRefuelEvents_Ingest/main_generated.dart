...
class FlightPlanAirRefuelEventsIngest {
  FlightPlanAirRefuelEventsIngest._(this._bc, this._bcOffset);
  factory FlightPlanAirRefuelEventsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<FlightPlanAirRefuelEventsIngest> reader = _FlightPlanAirRefuelEventsIngestReader();
  ...
  @override
  String toString() {
    return 'FlightPlanAirRefuelEventsIngest{arDegrade: ${arDegrade}, arNum: ${arNum}, arExchangedFuel: ${arExchangedFuel}, divertFuel: ${divertFuel}, exitFuel: ${exitFuel}}';
  }
}

class _FlightPlanAirRefuelEventsIngestReader extends fb.TableReader<FlightPlanAirRefuelEventsIngest> {
  const _FlightPlanAirRefuelEventsIngestReader();

  @override
  FlightPlanAirRefuelEventsIngest createObject(fb.BufferContext bc, int offset) => 
    FlightPlanAirRefuelEventsIngest._(bc, offset);
}

class FlightPlanAirRefuelEventsIngestBuilder {
  FlightPlanAirRefuelEventsIngestBuilder(this.fbBuilder);
...
class FlightPlanAirRefuelEventsIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  FlightPlanAirRefuelEventsIngestObjectBuilder({
    double? arDegrade,
    int? arNum,
