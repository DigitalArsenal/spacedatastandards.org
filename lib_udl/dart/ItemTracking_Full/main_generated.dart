...
class ItemTrackingFullDataModeEnum {
  final int value;
  const ItemTrackingFullDataModeEnum._(this.value);

  factory ItemTrackingFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ItemTrackingFullDataModeEnum');
    }
    return result;
  }

  static ItemTrackingFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : ItemTrackingFullDataModeEnum.fromValue(value);
  ...
  static const ItemTrackingFullDataModeEnum REAL = ItemTrackingFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const ItemTrackingFullDataModeEnum TEST = ItemTrackingFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const ItemTrackingFullDataModeEnum SIMULATED = ItemTrackingFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const ItemTrackingFullDataModeEnum EXERCISE = ItemTrackingFullDataModeEnum._(3);
  static const Map<int, ItemTrackingFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<ItemTrackingFullDataModeEnum> reader = _ItemTrackingFullDataModeEnumReader();

  @override
  String toString() {
    return 'ItemTrackingFullDataModeEnum{value: $value}';
  }
}

class _ItemTrackingFullDataModeEnumReader extends fb.Reader<ItemTrackingFullDataModeEnum> {
  const _ItemTrackingFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  ItemTrackingFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      ItemTrackingFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// No description available.
class ItemTrackingFull {
  ItemTrackingFull._(this._bc, this._bcOffset);
  factory ItemTrackingFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<ItemTrackingFull> reader = _ItemTrackingFullReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  ItemTrackingFullDataModeEnum get dataMode => ItemTrackingFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 46, 0));

  @override
  String toString() {
    return 'ItemTrackingFull{id: ${id}, classificationMarking: ${classificationMarking}, scanCode: ${scanCode}, scGenTool: ${scGenTool}, scannerId: ${scannerId}, ts: ${ts}, idItem: ${idItem}, type: ${type}, lat: ${lat}, lon: ${lon}, scanType: ${scanType}, dvCode: ${dvCode}, notes: ${notes}, keys: ${keys}, values: ${values}, createdAt: ${createdAt}, createdBy: ${createdBy}, sourceDl: ${sourceDl}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _ItemTrackingFullReader extends fb.TableReader<ItemTrackingFull> {
  const _ItemTrackingFullReader();

  @override
  ItemTrackingFull createObject(fb.BufferContext bc, int offset) => 
    ItemTrackingFull._(bc, offset);
}

class ItemTrackingFullBuilder {
  ItemTrackingFullBuilder(this.fbBuilder);
  ...
  int addDataMode(ItemTrackingFullDataModeEnum? dataMode) {
...
class ItemTrackingFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final ItemTrackingFullDataModeEnum? _dataMode;

  ItemTrackingFullObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    ItemTrackingFullDataModeEnum? dataMode,
  })
      : _id = id,
