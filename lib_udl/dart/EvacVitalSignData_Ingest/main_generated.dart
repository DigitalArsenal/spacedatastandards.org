...
class EvacVitalSignDataIngest {
  EvacVitalSignDataIngest._(this._bc, this._bcOffset);
  factory EvacVitalSignDataIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EvacVitalSignDataIngest> reader = _EvacVitalSignDataIngestReader();
  ...
  @override
  String toString() {
    return 'EvacVitalSignDataIngest{vitalSign: ${vitalSign}, vitalSign1: ${vitalSign1}, vitalSign2: ${vitalSign2}, medConfFactor: ${medConfFactor}, time: ${time}}';
  }
}

class _EvacVitalSignDataIngestReader extends fb.TableReader<EvacVitalSignDataIngest> {
  const _EvacVitalSignDataIngestReader();

  @override
  EvacVitalSignDataIngest createObject(fb.BufferContext bc, int offset) => 
    EvacVitalSignDataIngest._(bc, offset);
}

class EvacVitalSignDataIngestBuilder {
  EvacVitalSignDataIngestBuilder(this.fbBuilder);
...
class EvacVitalSignDataIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  EvacVitalSignDataIngestObjectBuilder({
    String? vitalSign,
    double? vitalSign1,
    double? vitalSign2,
    int? medConfFactor,
