...
class FlightPlanWaypointsIngest {
  FlightPlanWaypointsIngest._(this._bc, this._bcOffset);
  factory FlightPlanWaypointsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<FlightPlanWaypointsIngest> reader = _FlightPlanWaypointsIngestReader();
...
class FlightPlanWaypointsIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _type;
  ...
  FlightPlanWaypointsIngestObjectBuilder({
    String? type,
    String? waypointName,
    int? waypointNum,
    String? airway,
