...
class EffectResponseFullDataModeEnum {
  final int value;
  const EffectResponseFullDataModeEnum._(this.value);

  factory EffectResponseFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EffectResponseFullDataModeEnum');
    }
    return result;
  }

  static EffectResponseFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EffectResponseFullDataModeEnum.fromValue(value);
  ...
  static const EffectResponseFullDataModeEnum REAL = EffectResponseFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EffectResponseFullDataModeEnum TEST = EffectResponseFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EffectResponseFullDataModeEnum SIMULATED = EffectResponseFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EffectResponseFullDataModeEnum EXERCISE = EffectResponseFullDataModeEnum._(3);
  static const Map<int, EffectResponseFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EffectResponseFullDataModeEnum> reader = _EffectResponseFullDataModeEnumReader();

  @override
  String toString() {
    return 'EffectResponseFullDataModeEnum{value: $value}';
  }
}

class _EffectResponseFullDataModeEnumReader extends fb.Reader<EffectResponseFullDataModeEnum> {
  const _EffectResponseFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EffectResponseFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      EffectResponseFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// A response for various effects on a target.
class EffectResponseFull {
  EffectResponseFull._(this._bc, this._bcOffset);
  factory EffectResponseFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EffectResponseFull> reader = _EffectResponseFullReader();
  ...
  EffectResponseFullDataModeEnum get dataMode => EffectResponseFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 50, 0));
...
class EffectResponseFullBuilder {
  ...
  int addDataMode(EffectResponseFullDataModeEnum? dataMode) {
...
class EffectResponseFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EffectResponseFullDataModeEnum? _dataMode;
  final String? _origNetwork;

  EffectResponseFullObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    EffectResponseFullDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
