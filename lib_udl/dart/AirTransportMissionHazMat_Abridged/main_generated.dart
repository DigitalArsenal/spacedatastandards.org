...
class AirTransportMissionHazMatAbridged {
  AirTransportMissionHazMatAbridged._(this._bc, this._bcOffset);
  factory AirTransportMissionHazMatAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirTransportMissionHazMatAbridged> reader = _AirTransportMissionHazMatAbridgedReader();
  ...
  @override
  String toString() {
    return 'AirTransportMissionHazMatAbridged{extHazMatId: ${extHazMatId}, itemName: ${itemName}, unNum: ${unNum}, pieces: ${pieces}, weight: ${weight}, netExpWt: ${netExpWt}, classDiv: ${classDiv}, cgc: ${cgc}, cgn: ${cgn}, applicableNotes: ${applicableNotes}, onItin: ${onItin}, onIcao: ${onIcao}, offItin: ${offItin}, offIcao: ${offIcao}, planned: ${planned}}';
  }
}

class _AirTransportMissionHazMatAbridgedReader extends fb.TableReader<AirTransportMissionHazMatAbridged> {
  const _AirTransportMissionHazMatAbridgedReader();

  @override
  AirTransportMissionHazMatAbridged createObject(fb.BufferContext bc, int offset) => 
    AirTransportMissionHazMatAbridged._(bc, offset);
}

class AirTransportMissionHazMatAbridgedBuilder {
  AirTransportMissionHazMatAbridgedBuilder(this.fbBuilder);
...
class AirTransportMissionHazMatAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  AirTransportMissionHazMatAbridgedObjectBuilder({
    String? extHazMatId,
    String? itemName,
    String? unNum,
    int? pieces,
