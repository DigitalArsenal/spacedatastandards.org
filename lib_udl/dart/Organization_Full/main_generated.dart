...
class OrganizationFullDataModeEnum {
  final int value;
  const OrganizationFullDataModeEnum._(this.value);

  factory OrganizationFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OrganizationFullDataModeEnum');
    }
    return result;
  }

  static OrganizationFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OrganizationFullDataModeEnum.fromValue(value);
  ...
  static const OrganizationFullDataModeEnum REAL = OrganizationFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OrganizationFullDataModeEnum TEST = OrganizationFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OrganizationFullDataModeEnum SIMULATED = OrganizationFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OrganizationFullDataModeEnum EXERCISE = OrganizationFullDataModeEnum._(3);
  static const Map<int, OrganizationFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OrganizationFullDataModeEnum> reader = _OrganizationFullDataModeEnumReader();

  @override
  String toString() {
    return 'OrganizationFullDataModeEnum{value: $value}';
  }
}

class _OrganizationFullDataModeEnumReader extends fb.Reader<OrganizationFullDataModeEnum> {
  const _OrganizationFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OrganizationFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      OrganizationFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class OrganizationFull {
  OrganizationFull._(this._bc, this._bcOffset);
  factory OrganizationFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OrganizationFull> reader = _OrganizationFullReader();
  ...
  OrganizationFullDataModeEnum get dataMode => OrganizationFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 28, 0));
  ...
  @override
  String toString() {
    return 'OrganizationFull{id: ${id}, classificationMarking: ${classificationMarking}, name: ${name}, type: ${type}, category: ${category}, externalId: ${externalId}, description: ${description}, countryCode: ${countryCode}, nationality: ${nationality}, active: ${active}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, organizationDetails: ${organizationDetails}, origNetwork: ${origNetwork}}';
  }
}

class _OrganizationFullReader extends fb.TableReader<OrganizationFull> {
  const _OrganizationFullReader();

  @override
  OrganizationFull createObject(fb.BufferContext bc, int offset) => 
    OrganizationFull._(bc, offset);
}

class OrganizationFullBuilder {
  OrganizationFullBuilder(this.fbBuilder);
  ...
  int addDataMode(OrganizationFullDataModeEnum? dataMode) {
...
class OrganizationFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final OrganizationFullDataModeEnum? _dataMode;
  ...
  OrganizationFullObjectBuilder({
    ...
    String? source,
    String? origin,
    OrganizationFullDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? updatedAt,
    String? updatedBy,
