...
class DiffOfArrivalAbridgedDataModeEnum {
  final int value;
  const DiffOfArrivalAbridgedDataModeEnum._(this.value);

  factory DiffOfArrivalAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum DiffOfArrivalAbridgedDataModeEnum');
    }
    return result;
  }

  static DiffOfArrivalAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : DiffOfArrivalAbridgedDataModeEnum.fromValue(value);
  ...
  static const DiffOfArrivalAbridgedDataModeEnum REAL = DiffOfArrivalAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const DiffOfArrivalAbridgedDataModeEnum TEST = DiffOfArrivalAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const DiffOfArrivalAbridgedDataModeEnum SIMULATED = DiffOfArrivalAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const DiffOfArrivalAbridgedDataModeEnum EXERCISE = DiffOfArrivalAbridgedDataModeEnum._(3);
  static const Map<int, DiffOfArrivalAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<DiffOfArrivalAbridgedDataModeEnum> reader = _DiffOfArrivalAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'DiffOfArrivalAbridgedDataModeEnum{value: $value}';
  }
}

class _DiffOfArrivalAbridgedDataModeEnumReader extends fb.Reader<DiffOfArrivalAbridgedDataModeEnum> {
  const _DiffOfArrivalAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  DiffOfArrivalAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      DiffOfArrivalAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class DiffOfArrivalAbridged {
  DiffOfArrivalAbridged._(this._bc, this._bcOffset);
  factory DiffOfArrivalAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DiffOfArrivalAbridged> reader = _DiffOfArrivalAbridgedReader();
  ...
  DiffOfArrivalAbridgedDataModeEnum get dataMode => DiffOfArrivalAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 70, 0));
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get descriptor => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 78);
...
class DiffOfArrivalAbridgedBuilder {
  ...
  int addDataMode(DiffOfArrivalAbridgedDataModeEnum? dataMode) {
...
class DiffOfArrivalAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final DiffOfArrivalAbridgedDataModeEnum? _dataMode;
  ...
  DiffOfArrivalAbridgedObjectBuilder({
    String? id,
    ...
    String? source,
    DiffOfArrivalAbridgedDataModeEnum? dataMode,
    String? origin,
    String? createdAt,
    String? createdBy,
    String? descriptor,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(37, descriptorOffset);
