...
class IsrcollectionPocFull {
  IsrcollectionPocFull._(this._bc, this._bcOffset);
  factory IsrcollectionPocFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IsrcollectionPocFull> reader = _IsrcollectionPocFullReader();
  ...
  @override
  String toString() {
    return 'IsrcollectionPocFull{id: ${id}, name: ${name}, callsign: ${callsign}, unit: ${unit}, email: ${email}, phone: ${phone}, radioFrequency: ${radioFrequency}, chatSystem: ${chatSystem}, chatName: ${chatName}, notes: ${notes}}';
  }
}

class _IsrcollectionPocFullReader extends fb.TableReader<IsrcollectionPocFull> {
  const _IsrcollectionPocFullReader();

  @override
  IsrcollectionPocFull createObject(fb.BufferContext bc, int offset) => 
    IsrcollectionPocFull._(bc, offset);
}

class IsrcollectionPocFullBuilder {
  IsrcollectionPocFullBuilder(this.fbBuilder);
...
class IsrcollectionPocFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _name;
  ...
  IsrcollectionPocFullObjectBuilder({
    String? id,
    String? name,
    String? callsign,
    String? unit,
