...
class SpaceEnvObservationFullSenReferenceFrameEnum {
  final int value;
  const SpaceEnvObservationFullSenReferenceFrameEnum._(this.value);

  factory SpaceEnvObservationFullSenReferenceFrameEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SpaceEnvObservationFullSenReferenceFrameEnum');
    }
    return result;
  }

  static SpaceEnvObservationFullSenReferenceFrameEnum? _createOrNull(int? value) => 
      value == null ? null : SpaceEnvObservationFullSenReferenceFrameEnum.fromValue(value);
  ...
  static const SpaceEnvObservationFullSenReferenceFrameEnum J2000 = SpaceEnvObservationFullSenReferenceFrameEnum._(0);

  ///  No description available.
  static const SpaceEnvObservationFullSenReferenceFrameEnum EFG_TDR = SpaceEnvObservationFullSenReferenceFrameEnum._(1);

  ///  No description available.
  static const SpaceEnvObservationFullSenReferenceFrameEnum ECR_ECEF = SpaceEnvObservationFullSenReferenceFrameEnum._(2);

  ///  No description available.
  static const SpaceEnvObservationFullSenReferenceFrameEnum TEME = SpaceEnvObservationFullSenReferenceFrameEnum._(3);

  ///  No description available.
  static const SpaceEnvObservationFullSenReferenceFrameEnum ITRF = SpaceEnvObservationFullSenReferenceFrameEnum._(4);

  ///  No description available.
  static const SpaceEnvObservationFullSenReferenceFrameEnum GCRF = SpaceEnvObservationFullSenReferenceFrameEnum._(5);
  static const Map<int, SpaceEnvObservationFullSenReferenceFrameEnum> values = {
    0: J2000,
    1: EFG_TDR,
    2: ECR_ECEF,
    3: TEME,
  ...
  static const fb.Reader<SpaceEnvObservationFullSenReferenceFrameEnum> reader = _SpaceEnvObservationFullSenReferenceFrameEnumReader();

  @override
  String toString() {
    return 'SpaceEnvObservationFullSenReferenceFrameEnum{value: $value}';
  }
}

class _SpaceEnvObservationFullSenReferenceFrameEnumReader extends fb.Reader<SpaceEnvObservationFullSenReferenceFrameEnum> {
  const _SpaceEnvObservationFullSenReferenceFrameEnumReader();

  @override
  int get size => 1;

  @override
  SpaceEnvObservationFullSenReferenceFrameEnum read(fb.BufferContext bc, int offset) =>
      SpaceEnvObservationFullSenReferenceFrameEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class SpaceEnvObservationFullDataModeEnum {
  final int value;
  const SpaceEnvObservationFullDataModeEnum._(this.value);

  factory SpaceEnvObservationFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SpaceEnvObservationFullDataModeEnum');
    }
    return result;
  }

  static SpaceEnvObservationFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SpaceEnvObservationFullDataModeEnum.fromValue(value);
  ...
  static const SpaceEnvObservationFullDataModeEnum REAL = SpaceEnvObservationFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SpaceEnvObservationFullDataModeEnum TEST = SpaceEnvObservationFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SpaceEnvObservationFullDataModeEnum SIMULATED = SpaceEnvObservationFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SpaceEnvObservationFullDataModeEnum EXERCISE = SpaceEnvObservationFullDataModeEnum._(3);
  static const Map<int, SpaceEnvObservationFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SpaceEnvObservationFullDataModeEnum> reader = _SpaceEnvObservationFullDataModeEnumReader();

  @override
  String toString() {
    return 'SpaceEnvObservationFullDataModeEnum{value: $value}';
  }
}

class _SpaceEnvObservationFullDataModeEnumReader extends fb.Reader<SpaceEnvObservationFullDataModeEnum> {
  const _SpaceEnvObservationFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SpaceEnvObservationFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      SpaceEnvObservationFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// SpaceEnvObservation data.
class SpaceEnvObservationFull {
  SpaceEnvObservationFull._(this._bc, this._bcOffset);
  factory SpaceEnvObservationFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SpaceEnvObservationFull> reader = _SpaceEnvObservationFullReader();
  ...
  SpaceEnvObservationFullSenReferenceFrameEnum get senReferenceFrame => SpaceEnvObservationFullSenReferenceFrameEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 46, 0));
  ...
  SpaceEnvObservationFullDataModeEnum get dataMode => SpaceEnvObservationFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 82, 0));
...
class SpaceEnvObservationFullBuilder {
  ...
  int addSenReferenceFrame(SpaceEnvObservationFullSenReferenceFrameEnum? senReferenceFrame) {
  ...
  int addDataMode(SpaceEnvObservationFullDataModeEnum? dataMode) {
...
class SpaceEnvObservationFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final double? _lon;
  final double? _alt;
  final SpaceEnvObservationFullSenReferenceFrameEnum? _senReferenceFrame;
  ...
  final SpaceEnvObservationFullDataModeEnum? _dataMode;
  final String? _origNetwork;

  SpaceEnvObservationFullObjectBuilder({
    String? id,
    ...
    double? lon,
    double? alt,
    SpaceEnvObservationFullSenReferenceFrameEnum? senReferenceFrame,
    List<String>? senPos,
    List<String>? senVel,
    String? measType,
    ...
    String? source,
    String? origin,
    SpaceEnvObservationFullDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
