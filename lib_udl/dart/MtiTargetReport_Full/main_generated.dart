...
class MtiTargetReportFull {
  MtiTargetReportFull._(this._bc, this._bcOffset);
  factory MtiTargetReportFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MtiTargetReportFull> reader = _MtiTargetReportFullReader();
  ...
  @override
  String toString() {
    return 'MtiTargetReportFull{d321: ${d321}, d322: ${d322}, d323: ${d323}, d324: ${d324}, d325: ${d325}, d326: ${d326}, d327: ${d327}, d328: ${d328}, d329: ${d329}, d3210: ${d3210}, d3211: ${d3211}, d3212: ${d3212}, d3213: ${d3213}, d3214: ${d3214}, d3215: ${d3215}, d3216: ${d3216}, d3217: ${d3217}, d3218: ${d3218}}';
  }
}

class _MtiTargetReportFullReader extends fb.TableReader<MtiTargetReportFull> {
  const _MtiTargetReportFullReader();

  @override
  MtiTargetReportFull createObject(fb.BufferContext bc, int offset) => 
    MtiTargetReportFull._(bc, offset);
}

class MtiTargetReportFullBuilder {
  MtiTargetReportFullBuilder(this.fbBuilder);
...
class MtiTargetReportFullObjectBuilder extends fb.ObjectBuilder {
  final int? _d321;
  final double? _d322;
  final double? _d323;
  final int? _d324;
  ...
  MtiTargetReportFullObjectBuilder({
    int? d321,
    double? d322,
    double? d323,
    int? d324,
