...
class LogisticsDiscrepancyInfosFull {
  LogisticsDiscrepancyInfosFull._(this._bc, this._bcOffset);
  factory LogisticsDiscrepancyInfosFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LogisticsDiscrepancyInfosFull> reader = _LogisticsDiscrepancyInfosFullReader();
  ...
  @override
  String toString() {
    return 'LogisticsDiscrepancyInfosFull{jcn: ${jcn}, discrepancyInfo: ${discrepancyInfo}, jobStTime: ${jobStTime}, closureTime: ${closureTime}}';
  }
}

class _LogisticsDiscrepancyInfosFullReader extends fb.TableReader<LogisticsDiscrepancyInfosFull> {
  const _LogisticsDiscrepancyInfosFullReader();

  @override
  LogisticsDiscrepancyInfosFull createObject(fb.BufferContext bc, int offset) => 
    LogisticsDiscrepancyInfosFull._(bc, offset);
}

class LogisticsDiscrepancyInfosFullBuilder {
  LogisticsDiscrepancyInfosFullBuilder(this.fbBuilder);
...
class LogisticsDiscrepancyInfosFullObjectBuilder extends fb.ObjectBuilder {
  final String? _jcn;
  final String? _discrepancyInfo;
  final String? _jobStTime;
  final String? _closureTime;

  LogisticsDiscrepancyInfosFullObjectBuilder({
    String? jcn,
