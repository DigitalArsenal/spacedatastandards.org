...
class AirspaceControlMeansStatusIngest {
  AirspaceControlMeansStatusIngest._(this._bc, this._bcOffset);
  factory AirspaceControlMeansStatusIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirspaceControlMeansStatusIngest> reader = _AirspaceControlMeansStatusIngestReader();
  ...
  @override
  String toString() {
    return 'AirspaceControlMeansStatusIngest{cmStat: ${cmStat}, cmStatId: ${cmStatId}, airspaceControlMeans: ${airspaceControlMeans}}';
  }
}

class _AirspaceControlMeansStatusIngestReader extends fb.TableReader<AirspaceControlMeansStatusIngest> {
  const _AirspaceControlMeansStatusIngestReader();

  @override
  AirspaceControlMeansStatusIngest createObject(fb.BufferContext bc, int offset) => 
    AirspaceControlMeansStatusIngest._(bc, offset);
}

class AirspaceControlMeansStatusIngestBuilder {
  AirspaceControlMeansStatusIngestBuilder(this.fbBuilder);
...
class AirspaceControlMeansStatusIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _cmStat;
  final List<String>? _cmStatId;
  final List<String>? _airspaceControlMeans;

  AirspaceControlMeansStatusIngestObjectBuilder({
    String? cmStat,
