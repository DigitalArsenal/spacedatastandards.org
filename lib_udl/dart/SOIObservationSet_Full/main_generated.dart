...
class SoiobservationSetFullTypeEnum {
  final int value;
  const SoiobservationSetFullTypeEnum._(this.value);

  factory SoiobservationSetFullTypeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SoiobservationSetFullTypeEnum');
    }
    return result;
  }

  static SoiobservationSetFullTypeEnum? _createOrNull(int? value) => 
      value == null ? null : SoiobservationSetFullTypeEnum.fromValue(value);
  ...
  static const SoiobservationSetFullTypeEnum OPTICAL = SoiobservationSetFullTypeEnum._(0);

  ///  No description available.
  static const SoiobservationSetFullTypeEnum RADAR = SoiobservationSetFullTypeEnum._(1);
  static const Map<int, SoiobservationSetFullTypeEnum> values = {
    0: OPTICAL,
    1: RADAR};

  static const fb.Reader<SoiobservationSetFullTypeEnum> reader = _SoiobservationSetFullTypeEnumReader();

  @override
  String toString() {
    return 'SoiobservationSetFullTypeEnum{value: $value}';
  }
}

class _SoiobservationSetFullTypeEnumReader extends fb.Reader<SoiobservationSetFullTypeEnum> {
  const _SoiobservationSetFullTypeEnumReader();

  @override
  int get size => 1;

  @override
  SoiobservationSetFullTypeEnum read(fb.BufferContext bc, int offset) =>
      SoiobservationSetFullTypeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class SoiobservationSetFullReferenceFrameEnum {
  final int value;
  const SoiobservationSetFullReferenceFrameEnum._(this.value);

  factory SoiobservationSetFullReferenceFrameEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SoiobservationSetFullReferenceFrameEnum');
    }
    return result;
  }

  static SoiobservationSetFullReferenceFrameEnum? _createOrNull(int? value) => 
      value == null ? null : SoiobservationSetFullReferenceFrameEnum.fromValue(value);
  ...
  ///  No description available.
  static const SoiobservationSetFullReferenceFrameEnum J2000 = SoiobservationSetFullReferenceFrameEnum._(0);

  ///  No description available.
  static const SoiobservationSetFullReferenceFrameEnum EFG_TDR = SoiobservationSetFullReferenceFrameEnum._(1);

  ///  No description available.
  static const SoiobservationSetFullReferenceFrameEnum ECR_ECEF = SoiobservationSetFullReferenceFrameEnum._(2);

  ///  No description available.
  static const SoiobservationSetFullReferenceFrameEnum TEME = SoiobservationSetFullReferenceFrameEnum._(3);

  ///  No description available.
  static const SoiobservationSetFullReferenceFrameEnum ITRF = SoiobservationSetFullReferenceFrameEnum._(4);

  ///  No description available.
  static const SoiobservationSetFullReferenceFrameEnum GCRF = SoiobservationSetFullReferenceFrameEnum._(5);
  static const Map<int, SoiobservationSetFullReferenceFrameEnum> values = {
    0: J2000,
    1: EFG_TDR,
    2: ECR_ECEF,
    3: TEME,
  ...
  static const fb.Reader<SoiobservationSetFullReferenceFrameEnum> reader = _SoiobservationSetFullReferenceFrameEnumReader();

  @override
  String toString() {
    return 'SoiobservationSetFullReferenceFrameEnum{value: $value}';
  }
}

class _SoiobservationSetFullReferenceFrameEnumReader extends fb.Reader<SoiobservationSetFullReferenceFrameEnum> {
  const _SoiobservationSetFullReferenceFrameEnumReader();

  @override
  int get size => 1;

  @override
  SoiobservationSetFullReferenceFrameEnum read(fb.BufferContext bc, int offset) =>
      SoiobservationSetFullReferenceFrameEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class SoiobservationSetFullSenReferenceFrameEnum {
  final int value;
  const SoiobservationSetFullSenReferenceFrameEnum._(this.value);

  factory SoiobservationSetFullSenReferenceFrameEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SoiobservationSetFullSenReferenceFrameEnum');
    }
    return result;
  }

  static SoiobservationSetFullSenReferenceFrameEnum? _createOrNull(int? value) => 
      value == null ? null : SoiobservationSetFullSenReferenceFrameEnum.fromValue(value);
  ...
  ///  No description available.
  static const SoiobservationSetFullSenReferenceFrameEnum J2000 = SoiobservationSetFullSenReferenceFrameEnum._(0);

  ///  No description available.
  static const SoiobservationSetFullSenReferenceFrameEnum EFG_TDR = SoiobservationSetFullSenReferenceFrameEnum._(1);

  ///  No description available.
  static const SoiobservationSetFullSenReferenceFrameEnum ECR_ECEF = SoiobservationSetFullSenReferenceFrameEnum._(2);

  ///  No description available.
  static const SoiobservationSetFullSenReferenceFrameEnum TEME = SoiobservationSetFullSenReferenceFrameEnum._(3);

  ///  No description available.
  static const SoiobservationSetFullSenReferenceFrameEnum ITRF = SoiobservationSetFullSenReferenceFrameEnum._(4);

  ///  No description available.
  static const SoiobservationSetFullSenReferenceFrameEnum GCRF = SoiobservationSetFullSenReferenceFrameEnum._(5);
  static const Map<int, SoiobservationSetFullSenReferenceFrameEnum> values = {
    0: J2000,
    1: EFG_TDR,
    2: ECR_ECEF,
    3: TEME,
  ...
  static const fb.Reader<SoiobservationSetFullSenReferenceFrameEnum> reader = _SoiobservationSetFullSenReferenceFrameEnumReader();

  @override
  String toString() {
    return 'SoiobservationSetFullSenReferenceFrameEnum{value: $value}';
  }
}

class _SoiobservationSetFullSenReferenceFrameEnumReader extends fb.Reader<SoiobservationSetFullSenReferenceFrameEnum> {
  const _SoiobservationSetFullSenReferenceFrameEnumReader();

  @override
  int get size => 1;

  @override
  SoiobservationSetFullSenReferenceFrameEnum read(fb.BufferContext bc, int offset) =>
      SoiobservationSetFullSenReferenceFrameEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class SoiobservationSetFullDataModeEnum {
  final int value;
  const SoiobservationSetFullDataModeEnum._(this.value);

  factory SoiobservationSetFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SoiobservationSetFullDataModeEnum');
    }
    return result;
  }

  static SoiobservationSetFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SoiobservationSetFullDataModeEnum.fromValue(value);
  ...
  static const SoiobservationSetFullDataModeEnum REAL = SoiobservationSetFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SoiobservationSetFullDataModeEnum TEST = SoiobservationSetFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SoiobservationSetFullDataModeEnum SIMULATED = SoiobservationSetFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SoiobservationSetFullDataModeEnum EXERCISE = SoiobservationSetFullDataModeEnum._(3);
  static const Map<int, SoiobservationSetFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SoiobservationSetFullDataModeEnum> reader = _SoiobservationSetFullDataModeEnumReader();

  @override
  String toString() {
    return 'SoiobservationSetFullDataModeEnum{value: $value}';
  }
}

class _SoiobservationSetFullDataModeEnumReader extends fb.Reader<SoiobservationSetFullDataModeEnum> {
  const _SoiobservationSetFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SoiobservationSetFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      SoiobservationSetFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// These services provide operations for posting space object idenfification observation sets.
class SoiobservationSetFull {
  SoiobservationSetFull._(this._bc, this._bcOffset);
  factory SoiobservationSetFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SoiobservationSetFull> reader = _SoiobservationSetFullReader();
  ...
  SoiobservationSetFullTypeEnum get type => SoiobservationSetFullTypeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 48, 0));
  ...
  SoiobservationSetFullReferenceFrameEnum get referenceFrame => SoiobservationSetFullReferenceFrameEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 54, 0));
  ///  The reference frame of the observing sensor state. If the senReferenceFrame is null it is assumed to be J2000.
  ///  Example: /// Example: J2000
  ///  Constraints: Minimum length = 0, Maximum length = 24
  SoiobservationSetFullSenReferenceFrameEnum get senReferenceFrame => SoiobservationSetFullSenReferenceFrameEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 56, 0));
...
class SoiobservationSetFullBuilder {
  ...
  int addType(SoiobservationSetFullTypeEnum? type) {
  ...
  int addReferenceFrame(SoiobservationSetFullReferenceFrameEnum? referenceFrame) {
    fbBuilder.addInt8(25, referenceFrame?.value);
    return fbBuilder.offset;
  }
  int addSenReferenceFrame(SoiobservationSetFullSenReferenceFrameEnum? senReferenceFrame) {
  ...
  int addDataMode(SoiobservationSetFullDataModeEnum? dataMode) {
...
class SoiobservationSetFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final int? _numObs;
  final SoiobservationSetFullTypeEnum? _type;
  final double? _polarAngleStart;
  final double? _polarAngleEnd;
  final SoiobservationSetFullReferenceFrameEnum? _referenceFrame;
  final SoiobservationSetFullSenReferenceFrameEnum? _senReferenceFrame;
  ...
  final SoiobservationSetFullDataModeEnum? _dataMode;

  SoiobservationSetFullObjectBuilder({
    String? id,
    ...
    String? endTime,
    int? numObs,
    SoiobservationSetFullTypeEnum? type,
    double? polarAngleStart,
    double? polarAngleEnd,
    SoiobservationSetFullReferenceFrameEnum? referenceFrame,
    SoiobservationSetFullSenReferenceFrameEnum? senReferenceFrame,
    ...
    String? origNetwork,
    String? sourceDl,
    SoiobservationSetFullDataModeEnum? dataMode,
  })
      : _id = id,
