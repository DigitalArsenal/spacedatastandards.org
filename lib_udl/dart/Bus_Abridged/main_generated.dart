...
class BusAbridgedDataModeEnum {
  final int value;
  const BusAbridgedDataModeEnum._(this.value);

  factory BusAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum BusAbridgedDataModeEnum');
    }
    return result;
  }

  static BusAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : BusAbridgedDataModeEnum.fromValue(value);
  ...
  static const BusAbridgedDataModeEnum REAL = BusAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const BusAbridgedDataModeEnum TEST = BusAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const BusAbridgedDataModeEnum SIMULATED = BusAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const BusAbridgedDataModeEnum EXERCISE = BusAbridgedDataModeEnum._(3);
  static const Map<int, BusAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<BusAbridgedDataModeEnum> reader = _BusAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'BusAbridgedDataModeEnum{value: $value}';
  }
}

class _BusAbridgedDataModeEnumReader extends fb.Reader<BusAbridgedDataModeEnum> {
  const _BusAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  BusAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      BusAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
