...
class EvacMedicationFull {
  EvacMedicationFull._(this._bc, this._bcOffset);
  factory EvacMedicationFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EvacMedicationFull> reader = _EvacMedicationFullReader();
  ...
  @override
  String toString() {
    return 'EvacMedicationFull{type: ${type}, bodyPart: ${bodyPart}, dose: ${dose}, adminRoute: ${adminRoute}, time: ${time}, comments: ${comments}}';
  }
}

class _EvacMedicationFullReader extends fb.TableReader<EvacMedicationFull> {
  const _EvacMedicationFullReader();

  @override
  EvacMedicationFull createObject(fb.BufferContext bc, int offset) => 
    EvacMedicationFull._(bc, offset);
}

class EvacMedicationFullBuilder {
  EvacMedicationFullBuilder(this.fbBuilder);
...
class EvacMedicationFullObjectBuilder extends fb.ObjectBuilder {
  final String? _type;
  ...
  EvacMedicationFullObjectBuilder({
    String? type,
    String? bodyPart,
    String? dose,
    String? adminRoute,
