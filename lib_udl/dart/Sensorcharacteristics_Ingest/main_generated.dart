...
class SensorcharacteristicsIngestDataModeEnum {
  final int value;
  const SensorcharacteristicsIngestDataModeEnum._(this.value);

  factory SensorcharacteristicsIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SensorcharacteristicsIngestDataModeEnum');
    }
    return result;
  }

  static SensorcharacteristicsIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SensorcharacteristicsIngestDataModeEnum.fromValue(value);
  ...
  static const SensorcharacteristicsIngestDataModeEnum REAL = SensorcharacteristicsIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SensorcharacteristicsIngestDataModeEnum TEST = SensorcharacteristicsIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SensorcharacteristicsIngestDataModeEnum SIMULATED = SensorcharacteristicsIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SensorcharacteristicsIngestDataModeEnum EXERCISE = SensorcharacteristicsIngestDataModeEnum._(3);
  static const Map<int, SensorcharacteristicsIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SensorcharacteristicsIngestDataModeEnum> reader = _SensorcharacteristicsIngestDataModeEnumReader();

  @override
  String toString() {
    return 'SensorcharacteristicsIngestDataModeEnum{value: $value}';
  }
}

class _SensorcharacteristicsIngestDataModeEnumReader extends fb.Reader<SensorcharacteristicsIngestDataModeEnum> {
  const _SensorcharacteristicsIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SensorcharacteristicsIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      SensorcharacteristicsIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Model representation of characteristics and capabilities of a sensor.
class SensorcharacteristicsIngest {
  SensorcharacteristicsIngest._(this._bc, this._bcOffset);
  factory SensorcharacteristicsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SensorcharacteristicsIngest> reader = _SensorcharacteristicsIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SensorcharacteristicsIngestDataModeEnum get dataMode => SensorcharacteristicsIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 106, 0));
...
class SensorcharacteristicsIngestBuilder {
  ...
  int addDataMode(SensorcharacteristicsIngestDataModeEnum? dataMode) {
...
class SensorcharacteristicsIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SensorcharacteristicsIngestDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;

  SensorcharacteristicsIngestObjectBuilder({
    String? id,
    String? idSensor,
    ...
    String? source,
    SensorcharacteristicsIngestDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
  })
      : _id = id,
