...
class NavalFlightOperationsAbridged {
  NavalFlightOperationsAbridged._(this._bc, this._bcOffset);
  factory NavalFlightOperationsAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<NavalFlightOperationsAbridged> reader = _NavalFlightOperationsAbridgedReader();
  ...
  @override
  String toString() {
    return 'NavalFlightOperationsAbridged{shipName: ${shipName}, fltOpStart: ${fltOpStart}, fltOpStop: ${fltOpStop}, schdLaunchRcvyTime: ${schdLaunchRcvyTime}}';
  }
}

class _NavalFlightOperationsAbridgedReader extends fb.TableReader<NavalFlightOperationsAbridged> {
  const _NavalFlightOperationsAbridgedReader();

  @override
  NavalFlightOperationsAbridged createObject(fb.BufferContext bc, int offset) => 
    NavalFlightOperationsAbridged._(bc, offset);
}

class NavalFlightOperationsAbridgedBuilder {
  NavalFlightOperationsAbridgedBuilder(this.fbBuilder);
...
class NavalFlightOperationsAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _shipName;
  final String? _fltOpStart;
  final String? _fltOpStop;
  final List<String>? _schdLaunchRcvyTime;

  NavalFlightOperationsAbridgedObjectBuilder({
    String? shipName,
    String? fltOpStart,
    String? fltOpStop,
