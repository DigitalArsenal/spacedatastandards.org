...
class IonoObservationElevationAbridged {
  IonoObservationElevationAbridged._(this._bc, this._bcOffset);
  factory IonoObservationElevationAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationElevationAbridged> reader = _IonoObservationElevationAbridgedReader();
  ...
  @override
  String toString() {
    return 'IonoObservationElevationAbridged{notes: ${notes}, dimensions: ${dimensions}, dimensionName: ${dimensionName}, data: ${data}}';
  }
}

class _IonoObservationElevationAbridgedReader extends fb.TableReader<IonoObservationElevationAbridged> {
  const _IonoObservationElevationAbridgedReader();

  @override
  IonoObservationElevationAbridged createObject(fb.BufferContext bc, int offset) => 
    IonoObservationElevationAbridged._(bc, offset);
}

class IonoObservationElevationAbridgedBuilder {
  IonoObservationElevationAbridgedBuilder(this.fbBuilder);
...
class IonoObservationElevationAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _notes;
  final List<String>? _dimensions;
  final List<String>? _dimensionName;
  final List<String>? _data;

  IonoObservationElevationAbridgedObjectBuilder({
    String? notes,
