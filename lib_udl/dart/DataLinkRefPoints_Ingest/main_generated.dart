...
class DataLinkRefPointsIngest {
  DataLinkRefPointsIngest._(this._bc, this._bcOffset);
  factory DataLinkRefPointsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DataLinkRefPointsIngest> reader = _DataLinkRefPointsIngestReader();
  ...
  @override
  String toString() {
    return 'DataLinkRefPointsIngest{refPointType: ${refPointType}, refDes: ${refDes}, refLocName: ${refLocName}, refLat: ${refLat}, refLon: ${refLon}, effEventTime: ${effEventTime}}';
  }
}

class _DataLinkRefPointsIngestReader extends fb.TableReader<DataLinkRefPointsIngest> {
  const _DataLinkRefPointsIngestReader();

  @override
  DataLinkRefPointsIngest createObject(fb.BufferContext bc, int offset) => 
    DataLinkRefPointsIngest._(bc, offset);
}

class DataLinkRefPointsIngestBuilder {
  DataLinkRefPointsIngestBuilder(this.fbBuilder);
...
class DataLinkRefPointsIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  DataLinkRefPointsIngestObjectBuilder({
    String? refPointType,
    String? refDes,
    String? refLocName,
    double? refLat,
