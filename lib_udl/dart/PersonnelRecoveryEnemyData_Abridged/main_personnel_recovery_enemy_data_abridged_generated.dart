...
library personnel_recovery_enemy_data_abridged;
...
class PersonnelRecoveryEnemyDataAbridged {
  PersonnelRecoveryEnemyDataAbridged._(this._bc, this._bcOffset);
  factory PersonnelRecoveryEnemyDataAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PersonnelRecoveryEnemyDataAbridged> reader = _PersonnelRecoveryEnemyDataAbridgedReader();
  ...
  @override
  String toString() {
    return 'PersonnelRecoveryEnemyDataAbridged{dirToEnemy: ${dirToEnemy}, hostileFireType: ${hostileFireType}, friendliesRemarks: ${friendliesRemarks}, hlzRemarks: ${hlzRemarks}}';
  }
}

class _PersonnelRecoveryEnemyDataAbridgedReader extends fb.TableReader<PersonnelRecoveryEnemyDataAbridged> {
  const _PersonnelRecoveryEnemyDataAbridgedReader();

  @override
  PersonnelRecoveryEnemyDataAbridged createObject(fb.BufferContext bc, int offset) => 
    PersonnelRecoveryEnemyDataAbridged._(bc, offset);
}

class PersonnelRecoveryEnemyDataAbridgedBuilder {
  PersonnelRecoveryEnemyDataAbridgedBuilder(this.fbBuilder);
...
class PersonnelRecoveryEnemyDataAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _dirToEnemy;
  final String? _hostileFireType;
  final String? _friendliesRemarks;
  final String? _hlzRemarks;

  PersonnelRecoveryEnemyDataAbridgedObjectBuilder({
    String? dirToEnemy,
