...
class SeradataSpacecraftDetailsIngestDataModeEnum {
  final int value;
  const SeradataSpacecraftDetailsIngestDataModeEnum._(this.value);

  factory SeradataSpacecraftDetailsIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SeradataSpacecraftDetailsIngestDataModeEnum');
    }
    return result;
  }

  static SeradataSpacecraftDetailsIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SeradataSpacecraftDetailsIngestDataModeEnum.fromValue(value);
  ...
  static const SeradataSpacecraftDetailsIngestDataModeEnum REAL = SeradataSpacecraftDetailsIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SeradataSpacecraftDetailsIngestDataModeEnum TEST = SeradataSpacecraftDetailsIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SeradataSpacecraftDetailsIngestDataModeEnum SIMULATED = SeradataSpacecraftDetailsIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SeradataSpacecraftDetailsIngestDataModeEnum EXERCISE = SeradataSpacecraftDetailsIngestDataModeEnum._(3);
  static const Map<int, SeradataSpacecraftDetailsIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SeradataSpacecraftDetailsIngestDataModeEnum> reader = _SeradataSpacecraftDetailsIngestDataModeEnumReader();

  @override
  String toString() {
    return 'SeradataSpacecraftDetailsIngestDataModeEnum{value: $value}';
  }
}

class _SeradataSpacecraftDetailsIngestDataModeEnumReader extends fb.Reader<SeradataSpacecraftDetailsIngestDataModeEnum> {
  const _SeradataSpacecraftDetailsIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SeradataSpacecraftDetailsIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      SeradataSpacecraftDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// On-orbit spacecraft details compiled by Seradata for a particular satellite.
class SeradataSpacecraftDetailsIngest {
  SeradataSpacecraftDetailsIngest._(this._bc, this._bcOffset);
  factory SeradataSpacecraftDetailsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SeradataSpacecraftDetailsIngest> reader = _SeradataSpacecraftDetailsIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SeradataSpacecraftDetailsIngestDataModeEnum get dataMode => SeradataSpacecraftDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 188, 0));
...
class SeradataSpacecraftDetailsIngestBuilder {
  ...
  int addDataMode(SeradataSpacecraftDetailsIngestDataModeEnum? dataMode) {
...
class SeradataSpacecraftDetailsIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SeradataSpacecraftDetailsIngestDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;

  SeradataSpacecraftDetailsIngestObjectBuilder({
    String? id,
    String? idOnOrbit,
    ...
    String? origin,
    String? origNetwork,
    SeradataSpacecraftDetailsIngestDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
  })
      : _id = id,
