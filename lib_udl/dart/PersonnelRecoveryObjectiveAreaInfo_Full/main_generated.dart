...
class PersonnelRecoveryObjectiveAreaInfoFull {
  PersonnelRecoveryObjectiveAreaInfoFull._(this._bc, this._bcOffset);
  factory PersonnelRecoveryObjectiveAreaInfoFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PersonnelRecoveryObjectiveAreaInfoFull> reader = _PersonnelRecoveryObjectiveAreaInfoFullReader();
  ...
  @override
  String toString() {
    return 'PersonnelRecoveryObjectiveAreaInfoFull{pzLocation: ${pzLocation}, pzDesc: ${pzDesc}, oscCallSign: ${oscCallSign}, oscFreq: ${oscFreq}, enemyData: ${enemyData}}';
  }
}

class _PersonnelRecoveryObjectiveAreaInfoFullReader extends fb.TableReader<PersonnelRecoveryObjectiveAreaInfoFull> {
  const _PersonnelRecoveryObjectiveAreaInfoFullReader();

  @override
  PersonnelRecoveryObjectiveAreaInfoFull createObject(fb.BufferContext bc, int offset) => 
    PersonnelRecoveryObjectiveAreaInfoFull._(bc, offset);
}

class PersonnelRecoveryObjectiveAreaInfoFullBuilder {
  PersonnelRecoveryObjectiveAreaInfoFullBuilder(this.fbBuilder);
...
class PersonnelRecoveryObjectiveAreaInfoFullObjectBuilder extends fb.ObjectBuilder {
  ...
  PersonnelRecoveryObjectiveAreaInfoFullObjectBuilder({
