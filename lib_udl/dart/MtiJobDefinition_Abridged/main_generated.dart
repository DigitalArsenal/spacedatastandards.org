...
class MtiJobDefinitionAbridged {
  MtiJobDefinitionAbridged._(this._bc, this._bcOffset);
  factory MtiJobDefinitionAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MtiJobDefinitionAbridged> reader = _MtiJobDefinitionAbridgedReader();
  ...
  String? get j2 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 4);
  ///  Identifier of the particular variant of the sensor type.
  ///  Example: /// Example: J3-ID
  ///  Constraints: Minimum length = 0, Maximum length = 8
  String? get j3 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 6);
  ///  Flag field indicating whether filtering has been applied to the targets detected within the dwell area.
  ///  Example: /// Example: 3
  ///  Constraints: No constraints specified.
  int get j4 => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 8, 0);
  ...
  ///  Example: /// Example: 1
  ///  Constraints: No constraints specified.
  int get j5 => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 10, 0);
  ...
  ///  Constraints: No constraints specified.
  double get j6 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 12, 0.0);
  ...
  ///  Example: /// Example: 10.23
  ///  Constraints: No constraints specified.
  double get j7 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 14, 0.0);
  ...
  ///  Example: /// Example: 10.23
  ///  Constraints: No constraints specified.
  double get j8 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 16, 0.0);
  ...
  ///  Example: /// Example: 10.23
  ///  Constraints: No constraints specified.
  double get j9 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 18, 0.0);
  ...
  ///  Example: /// Example: 10.23
  ///  Constraints: No constraints specified.
  double get j10 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 20, 0.0);
  ...
  ///  Example: /// Example: 10.23
  ///  Constraints: No constraints specified.
  double get j11 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 22, 0.0);
  ...
  ///  Example: /// Example: 10.23
  ///  Constraints: No constraints specified.
  double get j12 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 24, 0.0);
  ...
  ///  Example: /// Example: 10.23
  ///  Constraints: No constraints specified.
  double get j13 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 26, 0.0);
  ///  Mode in which the radar will operate for the given job ID.
  ///  Example: /// Example: MODE
  ///  Constraints: Minimum length = 0, Maximum length = 32
  String? get j14 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 28);
  ...
  ///  Example: /// Example: 100
  ///  Constraints: No constraints specified.
  int get j15 => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 30, 0);
  ...
  ///  Example: /// Example: 100
  ///  Constraints: No constraints specified.
  int get j16 => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 32, 0);
  ...
  ///  Example: /// Example: 10
  ///  Constraints: No constraints specified.
  int get j24 => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 48, 0);
  ///  Nominal probability that an unobscured ten square-meter target will be detected within the given area of surveillance.
  ///  Example: /// Example: 10
  ///  Constraints: No constraints specified.
  int get j25 => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 50, 0);
  ///  The expected density of False Alarms (FA), expressed as the negative of the decibel value.
  ///  Example: /// Example: 10
  ///  Constraints: No constraints specified.
  int get j26 => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 52, 0);
  ///  The terrain elevation model used for developing the target reports.
  ///  Example: /// Example: MODEL
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get j27 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 54);
  ///  The geoid model used for developing the target reports.
  ///  Example: /// Example: MODEL
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get j28 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 56);

  @override
  String toString() {
    return 'MtiJobDefinitionAbridged{j2: ${j2}, j3: ${j3}, j4: ${j4}, j5: ${j5}, j6: ${j6}, j7: ${j7}, j8: ${j8}, j9: ${j9}, j10: ${j10}, j11: ${j11}, j12: ${j12}, j13: ${j13}, j14: ${j14}, j15: ${j15}, j16: ${j16}, j17: ${j17}, j18: ${j18}, j19: ${j19}, j20: ${j20}, j21: ${j21}, j22: ${j22}, j23: ${j23}, j24: ${j24}, j25: ${j25}, j26: ${j26}, j27: ${j27}, j28: ${j28}}';
  }
}

class _MtiJobDefinitionAbridgedReader extends fb.TableReader<MtiJobDefinitionAbridged> {
  const _MtiJobDefinitionAbridgedReader();

  @override
  MtiJobDefinitionAbridged createObject(fb.BufferContext bc, int offset) => 
    MtiJobDefinitionAbridged._(bc, offset);
}

class MtiJobDefinitionAbridgedBuilder {
  MtiJobDefinitionAbridgedBuilder(this.fbBuilder);
  ...
  int addJ4(int? j4) {
    fbBuilder.addInt32(2, j4);
    return fbBuilder.offset;
  }
  int addJ5(int? j5) {
    fbBuilder.addInt32(3, j5);
    return fbBuilder.offset;
  }
  int addJ6(double? j6) {
    fbBuilder.addFloat64(4, j6);
    return fbBuilder.offset;
  }
  int addJ7(double? j7) {
    fbBuilder.addFloat64(5, j7);
    return fbBuilder.offset;
  }
  int addJ8(double? j8) {
    fbBuilder.addFloat64(6, j8);
    return fbBuilder.offset;
  }
  int addJ9(double? j9) {
    fbBuilder.addFloat64(7, j9);
    return fbBuilder.offset;
  }
  int addJ10(double? j10) {
    fbBuilder.addFloat64(8, j10);
    return fbBuilder.offset;
  }
  int addJ11(double? j11) {
    fbBuilder.addFloat64(9, j11);
    return fbBuilder.offset;
  }
  int addJ12(double? j12) {
    fbBuilder.addFloat64(10, j12);
    return fbBuilder.offset;
  }
  int addJ13(double? j13) {
    fbBuilder.addFloat64(11, j13);
    return fbBuilder.offset;
  }
  ...
  int addJ15(int? j15) {
    fbBuilder.addInt32(13, j15);
    return fbBuilder.offset;
  }
  int addJ16(int? j16) {
    fbBuilder.addInt32(14, j16);
    return fbBuilder.offset;
  }
  int addJ17(int? j17) {
    fbBuilder.addInt32(15, j17);
    return fbBuilder.offset;
  }
  int addJ18(int? j18) {
    fbBuilder.addInt32(16, j18);
    return fbBuilder.offset;
  }
  int addJ19(int? j19) {
    fbBuilder.addInt32(17, j19);
    return fbBuilder.offset;
  }
  int addJ20(int? j20) {
    fbBuilder.addInt32(18, j20);
    return fbBuilder.offset;
  }
  int addJ21(int? j21) {
    fbBuilder.addInt32(19, j21);
    return fbBuilder.offset;
  }
  int addJ22(double? j22) {
    fbBuilder.addFloat64(20, j22);
    return fbBuilder.offset;
  }
  int addJ23(int? j23) {
    fbBuilder.addInt32(21, j23);
    return fbBuilder.offset;
  }
  int addJ24(int? j24) {
    fbBuilder.addInt32(22, j24);
    return fbBuilder.offset;
  }
  int addJ25(int? j25) {
    fbBuilder.addInt32(23, j25);
    return fbBuilder.offset;
  }
  int addJ26(int? j26) {
    fbBuilder.addInt32(24, j26);
    return fbBuilder.offset;
  }
...
class MtiJobDefinitionAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _j2;
  final String? _j3;
  final int? _j4;
  final int? _j5;
  ...
  MtiJobDefinitionAbridgedObjectBuilder({
    String? j2,
    String? j3,
    int? j4,
    int? j5,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.startTable(27);
    fbBuilder.addOffset(0, j2Offset);
    fbBuilder.addOffset(1, j3Offset);
    fbBuilder.addInt32(2, _j4);
    fbBuilder.addInt32(3, _j5);
    fbBuilder.addFloat64(4, _j6);
    fbBuilder.addFloat64(5, _j7);
    fbBuilder.addFloat64(6, _j8);
    fbBuilder.addFloat64(7, _j9);
    fbBuilder.addFloat64(8, _j10);
    fbBuilder.addFloat64(9, _j11);
    fbBuilder.addFloat64(10, _j12);
    fbBuilder.addFloat64(11, _j13);
    fbBuilder.addOffset(12, j14Offset);
    fbBuilder.addInt32(13, _j15);
    fbBuilder.addInt32(14, _j16);
    fbBuilder.addInt32(15, _j17);
    fbBuilder.addInt32(16, _j18);
    fbBuilder.addInt32(17, _j19);
    fbBuilder.addInt32(18, _j20);
    fbBuilder.addInt32(19, _j21);
    fbBuilder.addFloat64(20, _j22);
    fbBuilder.addInt32(21, _j23);
    fbBuilder.addInt32(22, _j24);
    fbBuilder.addInt32(23, _j25);
    fbBuilder.addInt32(24, _j26);
    fbBuilder.addOffset(25, j27Offset);
    fbBuilder.addOffset(26, j28Offset);
    return fbBuilder.endTable();
  }
