...
class MtiFullDataModeEnum {
  final int value;
  const MtiFullDataModeEnum._(this.value);

  factory MtiFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum MtiFullDataModeEnum');
    }
    return result;
  }

  static MtiFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : MtiFullDataModeEnum.fromValue(value);
  ...
  static const MtiFullDataModeEnum REAL = MtiFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const MtiFullDataModeEnum TEST = MtiFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const MtiFullDataModeEnum SIMULATED = MtiFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const MtiFullDataModeEnum EXERCISE = MtiFullDataModeEnum._(3);
  static const Map<int, MtiFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<MtiFullDataModeEnum> reader = _MtiFullDataModeEnumReader();

  @override
  String toString() {
    return 'MtiFullDataModeEnum{value: $value}';
  }
}

class _MtiFullDataModeEnumReader extends fb.Reader<MtiFullDataModeEnum> {
  const _MtiFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  MtiFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      MtiFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Information on the mission and flight plans, the type and configuration of the platform, and the reference time.
class MtiFull {
  MtiFull._(this._bc, this._bcOffset);
  factory MtiFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MtiFull> reader = _MtiFullReader();
  ...
  MtiFullDataModeEnum get dataMode => MtiFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 12, 0));
  ...
  @override
  String toString() {
    return 'MtiFull{classificationMarking: ${classificationMarking}, source: ${source}, origin: ${origin}, id: ${id}, dataMode: ${dataMode}, createdBy: ${createdBy}, createdAt: ${createdAt}, p3: ${p3}, p6: ${p6}, p7: ${p7}, p8: ${p8}, p9: ${p9}, p10: ${p10}, missions: ${missions}, dwells: ${dwells}, hrrs: ${hrrs}, jobDefs: ${jobDefs}, freeTexts: ${freeTexts}, platformLocs: ${platformLocs}, jobRequests: ${jobRequests}, origNetwork: ${origNetwork}}';
  }
}

class _MtiFullReader extends fb.TableReader<MtiFull> {
  const _MtiFullReader();

  @override
  MtiFull createObject(fb.BufferContext bc, int offset) => 
    MtiFull._(bc, offset);
}

class MtiFullBuilder {
  MtiFullBuilder(this.fbBuilder);
  ...
  int addDataMode(MtiFullDataModeEnum? dataMode) {
...
class MtiFullObjectBuilder extends fb.ObjectBuilder {
  final String? _classificationMarking;
  final String? _source;
  final String? _origin;
  final String? _id;
  final MtiFullDataModeEnum? _dataMode;
  ...
  MtiFullObjectBuilder({
    String? classificationMarking,
    String? source,
    String? origin,
    String? id,
    MtiFullDataModeEnum? dataMode,
    String? createdBy,
    String? createdAt,
    String? p3,
    String? p6,
