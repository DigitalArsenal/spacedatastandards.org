...
class AirspaceControlOrderIngestDataModeEnum {
  final int value;
  const AirspaceControlOrderIngestDataModeEnum._(this.value);

  factory AirspaceControlOrderIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirspaceControlOrderIngestDataModeEnum');
    }
    return result;
  }

  static AirspaceControlOrderIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AirspaceControlOrderIngestDataModeEnum.fromValue(value);
  ...
  static const AirspaceControlOrderIngestDataModeEnum REAL = AirspaceControlOrderIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AirspaceControlOrderIngestDataModeEnum TEST = AirspaceControlOrderIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AirspaceControlOrderIngestDataModeEnum SIMULATED = AirspaceControlOrderIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AirspaceControlOrderIngestDataModeEnum EXERCISE = AirspaceControlOrderIngestDataModeEnum._(3);
  static const Map<int, AirspaceControlOrderIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AirspaceControlOrderIngestDataModeEnum> reader = _AirspaceControlOrderIngestDataModeEnumReader();

  @override
  String toString() {
    return 'AirspaceControlOrderIngestDataModeEnum{value: $value}';
  }
}

class _AirspaceControlOrderIngestDataModeEnumReader extends fb.Reader<AirspaceControlOrderIngestDataModeEnum> {
  const _AirspaceControlOrderIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AirspaceControlOrderIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      AirspaceControlOrderIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AirspaceControlOrderIngest {
  AirspaceControlOrderIngest._(this._bc, this._bcOffset);
  factory AirspaceControlOrderIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirspaceControlOrderIngest> reader = _AirspaceControlOrderIngestReader();
...
class AirspaceControlOrderIngestBuilder {
  ...
  int addDataMode(AirspaceControlOrderIngestDataModeEnum? dataMode) {
...
class AirspaceControlOrderIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AirspaceControlOrderIngestDataModeEnum? _dataMode;

  AirspaceControlOrderIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    AirspaceControlOrderIngestDataModeEnum? dataMode,
  })
      : _id = id,
