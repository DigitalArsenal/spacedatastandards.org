...
class EvacFullTypeEnum {
  final int value;
  const EvacFullTypeEnum._(this.value);

  factory EvacFullTypeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EvacFullTypeEnum');
    }
    return result;
  }

  static EvacFullTypeEnum? _createOrNull(int? value) => 
      value == null ? null : EvacFullTypeEnum.fromValue(value);
  ...
  static const EvacFullTypeEnum REQUEST = EvacFullTypeEnum._(0);

  ///  No description available.
  static const EvacFullTypeEnum RESPONSE = EvacFullTypeEnum._(1);
  static const Map<int, EvacFullTypeEnum> values = {
    0: REQUEST,
    1: RESPONSE};

  static const fb.Reader<EvacFullTypeEnum> reader = _EvacFullTypeEnumReader();

  @override
  String toString() {
    return 'EvacFullTypeEnum{value: $value}';
  }
}

class _EvacFullTypeEnumReader extends fb.Reader<EvacFullTypeEnum> {
  const _EvacFullTypeEnumReader();

  @override
  int get size => 1;

  @override
  EvacFullTypeEnum read(fb.BufferContext bc, int offset) =>
      EvacFullTypeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class EvacFullDataModeEnum {
  final int value;
  const EvacFullDataModeEnum._(this.value);

  factory EvacFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EvacFullDataModeEnum');
    }
    return result;
  }

  static EvacFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EvacFullDataModeEnum.fromValue(value);
  ...
  static const EvacFullDataModeEnum REAL = EvacFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EvacFullDataModeEnum TEST = EvacFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EvacFullDataModeEnum SIMULATED = EvacFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EvacFullDataModeEnum EXERCISE = EvacFullDataModeEnum._(3);
  static const Map<int, EvacFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EvacFullDataModeEnum> reader = _EvacFullDataModeEnumReader();

  @override
  String toString() {
    return 'EvacFullDataModeEnum{value: $value}';
  }
}

class _EvacFullDataModeEnumReader extends fb.Reader<EvacFullDataModeEnum> {
  const _EvacFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EvacFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      EvacFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Casualty report and evacuation request. Used to report and request support to evacuate friendly and enemy casualties.
class EvacFull {
  EvacFull._(this._bc, this._bcOffset);
  factory EvacFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EvacFull> reader = _EvacFullReader();
  ...
  EvacFullTypeEnum get type => EvacFullTypeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 10, 0));
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  List<String>? get relatedDocs => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 72);
  ...
  EvacFullDataModeEnum get dataMode => EvacFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 84, 0));

  @override
  String toString() {
    return 'EvacFull{id: ${id}, classificationMarking: ${classificationMarking}, medevacId: ${medevacId}, type: ${type}, missionType: ${missionType}, idWeatherReport: ${idWeatherReport}, numKia: ${numKia}, numWia: ${numWia}, numLitter: ${numLitter}, numAmbulatory: ${numAmbulatory}, medicReq: ${medicReq}, reqNum: ${reqNum}, reqTime: ${reqTime}, reqCallSign: ${reqCallSign}, pickupTime: ${pickupTime}, pickupLat: ${pickupLat}, pickupLon: ${pickupLon}, pickupAlt: ${pickupAlt}, ce: ${ce}, le: ${le}, terrain: ${terrain}, obstaclesRemarks: ${obstaclesRemarks}, terrainRemarks: ${terrainRemarks}, zoneName: ${zoneName}, zoneMarking: ${zoneMarking}, zoneSecurity: ${zoneSecurity}, zoneMarkingColor: ${zoneMarkingColor}, zoneHot: ${zoneHot}, cntctFreq: ${cntctFreq}, zoneContrCallSign: ${zoneContrCallSign}, numCasualties: ${numCasualties}, comments: ${comments}, casualtyInfo: ${casualtyInfo}, enemyData: ${enemyData}, relatedDocs: ${relatedDocs}, origNetwork: ${origNetwork}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}}';
  }
}

class _EvacFullReader extends fb.TableReader<EvacFull> {
  const _EvacFullReader();

  @override
  EvacFull createObject(fb.BufferContext bc, int offset) => 
    EvacFull._(bc, offset);
}

class EvacFullBuilder {
  EvacFullBuilder(this.fbBuilder);
  ...
  int addType(EvacFullTypeEnum? type) {
  ...
  int addDataMode(EvacFullDataModeEnum? dataMode) {
...
class EvacFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _classificationMarking;
  final String? _medevacId;
  final EvacFullTypeEnum? _type;
  ...
  final EvacFullDataModeEnum? _dataMode;

  EvacFullObjectBuilder({
    String? id,
    String? classificationMarking,
    String? medevacId,
    EvacFullTypeEnum? type,
    String? missionType,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(34, relatedDocsOffset);
