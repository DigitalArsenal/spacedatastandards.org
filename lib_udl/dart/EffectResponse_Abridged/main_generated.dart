...
class EffectResponseAbridgedDataModeEnum {
  final int value;
  const EffectResponseAbridgedDataModeEnum._(this.value);

  factory EffectResponseAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EffectResponseAbridgedDataModeEnum');
    }
    return result;
  }

  static EffectResponseAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EffectResponseAbridgedDataModeEnum.fromValue(value);
  ...
  static const EffectResponseAbridgedDataModeEnum REAL = EffectResponseAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EffectResponseAbridgedDataModeEnum TEST = EffectResponseAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EffectResponseAbridgedDataModeEnum SIMULATED = EffectResponseAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EffectResponseAbridgedDataModeEnum EXERCISE = EffectResponseAbridgedDataModeEnum._(3);
  static const Map<int, EffectResponseAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EffectResponseAbridgedDataModeEnum> reader = _EffectResponseAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'EffectResponseAbridgedDataModeEnum{value: $value}';
  }
}

class _EffectResponseAbridgedDataModeEnumReader extends fb.Reader<EffectResponseAbridgedDataModeEnum> {
  const _EffectResponseAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EffectResponseAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      EffectResponseAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// A response for various effects on a target.
class EffectResponseAbridged {
  EffectResponseAbridged._(this._bc, this._bcOffset);
  factory EffectResponseAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EffectResponseAbridged> reader = _EffectResponseAbridgedReader();
  ...
  EffectResponseAbridgedDataModeEnum get dataMode => EffectResponseAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 50, 0));
...
class EffectResponseAbridgedBuilder {
  ...
  int addDataMode(EffectResponseAbridgedDataModeEnum? dataMode) {
...
class EffectResponseAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EffectResponseAbridgedDataModeEnum? _dataMode;
  final String? _origNetwork;

  EffectResponseAbridgedObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    EffectResponseAbridgedDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
