...
library evac_enemy_data_ingest;
...
class EvacEnemyDataIngest {
  EvacEnemyDataIngest._(this._bc, this._bcOffset);
  factory EvacEnemyDataIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EvacEnemyDataIngest> reader = _EvacEnemyDataIngestReader();
  ...
  @override
  String toString() {
    return 'EvacEnemyDataIngest{dirToEnemy: ${dirToEnemy}, hostileFireType: ${hostileFireType}, friendliesRemarks: ${friendliesRemarks}, hlzRemarks: ${hlzRemarks}}';
  }
}

class _EvacEnemyDataIngestReader extends fb.TableReader<EvacEnemyDataIngest> {
  const _EvacEnemyDataIngestReader();

  @override
  EvacEnemyDataIngest createObject(fb.BufferContext bc, int offset) => 
    EvacEnemyDataIngest._(bc, offset);
}

class EvacEnemyDataIngestBuilder {
  EvacEnemyDataIngestBuilder(this.fbBuilder);
