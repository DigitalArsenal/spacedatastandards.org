...
class LaunchVehicleDetailsIngestDataModeEnum {
  final int value;
  const LaunchVehicleDetailsIngestDataModeEnum._(this.value);

  factory LaunchVehicleDetailsIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum LaunchVehicleDetailsIngestDataModeEnum');
    }
    return result;
  }

  static LaunchVehicleDetailsIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : LaunchVehicleDetailsIngestDataModeEnum.fromValue(value);
  ...
  static const LaunchVehicleDetailsIngestDataModeEnum REAL = LaunchVehicleDetailsIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const LaunchVehicleDetailsIngestDataModeEnum TEST = LaunchVehicleDetailsIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const LaunchVehicleDetailsIngestDataModeEnum SIMULATED = LaunchVehicleDetailsIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const LaunchVehicleDetailsIngestDataModeEnum EXERCISE = LaunchVehicleDetailsIngestDataModeEnum._(3);
  static const Map<int, LaunchVehicleDetailsIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<LaunchVehicleDetailsIngestDataModeEnum> reader = _LaunchVehicleDetailsIngestDataModeEnumReader();

  @override
  String toString() {
    return 'LaunchVehicleDetailsIngestDataModeEnum{value: $value}';
  }
}

class _LaunchVehicleDetailsIngestDataModeEnumReader extends fb.Reader<LaunchVehicleDetailsIngestDataModeEnum> {
  const _LaunchVehicleDetailsIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  LaunchVehicleDetailsIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      LaunchVehicleDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class LaunchVehicleDetailsIngest {
  LaunchVehicleDetailsIngest._(this._bc, this._bcOffset);
  factory LaunchVehicleDetailsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LaunchVehicleDetailsIngest> reader = _LaunchVehicleDetailsIngestReader();
...
class LaunchVehicleDetailsIngestBuilder {
  ...
  int addDataMode(LaunchVehicleDetailsIngestDataModeEnum? dataMode) {
...
class LaunchVehicleDetailsIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final LaunchVehicleDetailsIngestDataModeEnum? _dataMode;
  final List<String>? _tags;

  LaunchVehicleDetailsIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    LaunchVehicleDetailsIngestDataModeEnum? dataMode,
    List<String>? tags,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(54, tagsOffset);
    return fbBuilder.endTable();
  }
