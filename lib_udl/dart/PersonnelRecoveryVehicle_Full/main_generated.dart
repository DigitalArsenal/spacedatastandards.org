...
class PersonnelRecoveryVehicleFull {
  PersonnelRecoveryVehicleFull._(this._bc, this._bcOffset);
  factory PersonnelRecoveryVehicleFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PersonnelRecoveryVehicleFull> reader = _PersonnelRecoveryVehicleFullReader();
  ...
  @override
  String toString() {
    return 'PersonnelRecoveryVehicleFull{callSign: ${callSign}, type: ${type}, primaryFreq: ${primaryFreq}, strength: ${strength}}';
  }
}

class _PersonnelRecoveryVehicleFullReader extends fb.TableReader<PersonnelRecoveryVehicleFull> {
  const _PersonnelRecoveryVehicleFullReader();

  @override
  PersonnelRecoveryVehicleFull createObject(fb.BufferContext bc, int offset) => 
    PersonnelRecoveryVehicleFull._(bc, offset);
}

class PersonnelRecoveryVehicleFullBuilder {
  PersonnelRecoveryVehicleFullBuilder(this.fbBuilder);
...
class PersonnelRecoveryVehicleFullObjectBuilder extends fb.ObjectBuilder {
  final String? _callSign;
  final String? _type;
  final double? _primaryFreq;
  final int? _strength;

  PersonnelRecoveryVehicleFullObjectBuilder({
    String? callSign,
    String? type,
    double? primaryFreq,
    int? strength,
