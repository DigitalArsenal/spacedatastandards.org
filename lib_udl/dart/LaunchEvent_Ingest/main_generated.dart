...
class LaunchEventIngestDataModeEnum {
  final int value;
  const LaunchEventIngestDataModeEnum._(this.value);

  factory LaunchEventIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum LaunchEventIngestDataModeEnum');
    }
    return result;
  }

  static LaunchEventIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : LaunchEventIngestDataModeEnum.fromValue(value);
  ...
  static const LaunchEventIngestDataModeEnum REAL = LaunchEventIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const LaunchEventIngestDataModeEnum TEST = LaunchEventIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const LaunchEventIngestDataModeEnum SIMULATED = LaunchEventIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const LaunchEventIngestDataModeEnum EXERCISE = LaunchEventIngestDataModeEnum._(3);
  static const Map<int, LaunchEventIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<LaunchEventIngestDataModeEnum> reader = _LaunchEventIngestDataModeEnumReader();

  @override
  String toString() {
    return 'LaunchEventIngestDataModeEnum{value: $value}';
  }
}

class _LaunchEventIngestDataModeEnumReader extends fb.Reader<LaunchEventIngestDataModeEnum> {
  const _LaunchEventIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  LaunchEventIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      LaunchEventIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Information on known launch events.
class LaunchEventIngest {
  LaunchEventIngest._(this._bc, this._bcOffset);
  factory LaunchEventIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LaunchEventIngest> reader = _LaunchEventIngestReader();
  ...
  LaunchEventIngestDataModeEnum get dataMode => LaunchEventIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 38, 0));
...
class LaunchEventIngestBuilder {
  ...
  int addDataMode(LaunchEventIngestDataModeEnum? dataMode) {
...
class LaunchEventIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final LaunchEventIngestDataModeEnum? _dataMode;
  final String? _origNetwork;
  final int? _satNo;

  LaunchEventIngestObjectBuilder({
    String? id,
    String? idOnOrbit,
    String? origObjectId,
    ...
    String? origin,
    String? source,
    LaunchEventIngestDataModeEnum? dataMode,
    String? origNetwork,
    int? satNo,
  })
      : _id = id,
