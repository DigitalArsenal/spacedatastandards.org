...
class MtiMissionAbridged {
  MtiMissionAbridged._(this._bc, this._bcOffset);
  factory MtiMissionAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MtiMissionAbridged> reader = _MtiMissionAbridgedReader();
  ...
  @override
  String toString() {
    return 'MtiMissionAbridged{m1: ${m1}, m2: ${m2}, m3: ${m3}, m4: ${m4}, msnRefTs: ${msnRefTs}}';
  }
}

class _MtiMissionAbridgedReader extends fb.TableReader<MtiMissionAbridged> {
  const _MtiMissionAbridgedReader();

  @override
  MtiMissionAbridged createObject(fb.BufferContext bc, int offset) => 
    MtiMissionAbridged._(bc, offset);
}

class MtiMissionAbridgedBuilder {
  MtiMissionAbridgedBuilder(this.fbBuilder);
...
class MtiMissionAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _m1;
  final String? _m2;
  final String? _m3;
  final String? _m4;
  ...
  MtiMissionAbridgedObjectBuilder({
    String? m1,
    String? m2,
    String? m3,
    String? m4,
