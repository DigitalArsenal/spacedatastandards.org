...
class OnorbitEventFullDataModeEnum {
  final int value;
  const OnorbitEventFullDataModeEnum._(this.value);

  factory OnorbitEventFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OnorbitEventFullDataModeEnum');
    }
    return result;
  }

  static OnorbitEventFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OnorbitEventFullDataModeEnum.fromValue(value);
  ...
  static const OnorbitEventFullDataModeEnum REAL = OnorbitEventFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OnorbitEventFullDataModeEnum TEST = OnorbitEventFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OnorbitEventFullDataModeEnum SIMULATED = OnorbitEventFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OnorbitEventFullDataModeEnum EXERCISE = OnorbitEventFullDataModeEnum._(3);
  static const Map<int, OnorbitEventFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OnorbitEventFullDataModeEnum> reader = _OnorbitEventFullDataModeEnumReader();

  @override
  String toString() {
    return 'OnorbitEventFullDataModeEnum{value: $value}';
  }
}

class _OnorbitEventFullDataModeEnumReader extends fb.Reader<OnorbitEventFullDataModeEnum> {
  const _OnorbitEventFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OnorbitEventFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      OnorbitEventFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// No description available.
class OnorbitEventFull {
  OnorbitEventFull._(this._bc, this._bcOffset);
  factory OnorbitEventFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OnorbitEventFull> reader = _OnorbitEventFullReader();
  ...
  OnorbitEventFullDataModeEnum get dataMode => OnorbitEventFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 104, 0));
...
class OnorbitEventFullBuilder {
  ...
  int addDataMode(OnorbitEventFullDataModeEnum? dataMode) {
...
class OnorbitEventFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final OnorbitEventFullDataModeEnum? _dataMode;
  ...
  OnorbitEventFullObjectBuilder({
    ...
    String? source,
    String? origin,
    OnorbitEventFullDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? updatedAt,
    String? updatedBy,
