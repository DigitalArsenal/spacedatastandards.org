...
class DiffOfArrivalFullDataModeEnum {
  final int value;
  const DiffOfArrivalFullDataModeEnum._(this.value);

  factory DiffOfArrivalFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum DiffOfArrivalFullDataModeEnum');
    }
    return result;
  }

  static DiffOfArrivalFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : DiffOfArrivalFullDataModeEnum.fromValue(value);
  ...
  static const DiffOfArrivalFullDataModeEnum REAL = DiffOfArrivalFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const DiffOfArrivalFullDataModeEnum TEST = DiffOfArrivalFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const DiffOfArrivalFullDataModeEnum SIMULATED = DiffOfArrivalFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const DiffOfArrivalFullDataModeEnum EXERCISE = DiffOfArrivalFullDataModeEnum._(3);
  static const Map<int, DiffOfArrivalFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<DiffOfArrivalFullDataModeEnum> reader = _DiffOfArrivalFullDataModeEnumReader();

  @override
  String toString() {
    return 'DiffOfArrivalFullDataModeEnum{value: $value}';
  }
}

class _DiffOfArrivalFullDataModeEnumReader extends fb.Reader<DiffOfArrivalFullDataModeEnum> {
  const _DiffOfArrivalFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  DiffOfArrivalFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      DiffOfArrivalFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class DiffOfArrivalFull {
  DiffOfArrivalFull._(this._bc, this._bcOffset);
  factory DiffOfArrivalFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DiffOfArrivalFull> reader = _DiffOfArrivalFullReader();
  ...
  DiffOfArrivalFullDataModeEnum get dataMode => DiffOfArrivalFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 72, 0));
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  String? get onOrbit => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 82);
  ///  Optional source-provided and searchable metadata or descriptor of the data.
  ///  Example: /// Example: Example descriptor
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get descriptor => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 84);
  ///  Optional identifier to track a commercial or marketplace transaction executed to produce this data.
  ///  Example: /// Example: TRANSACTION-ID
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get transactionId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 86);
  ...
  ///  Example: /// Example: AXE
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get sourceDl => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 90);

  @override
  String toString() {
    return 'DiffOfArrivalFull{id: ${id}, classificationMarking: ${classificationMarking}, obTime: ${obTime}, idOnOrbit: ${idOnOrbit}, idSensor1: ${idSensor1}, idSensor2: ${idSensor2}, satNo: ${satNo}, taskId: ${taskId}, origObjectId: ${origObjectId}, origSensorId1: ${origSensorId1}, origSensorId2: ${origSensorId2}, uct: ${uct}, sensor1Delay: ${sensor1Delay}, sensor2Delay: ${sensor2Delay}, senlat: ${senlat}, senlon: ${senlon}, senalt: ${senalt}, sen2lat: ${sen2lat}, sen2lon: ${sen2lon}, sen2alt: ${sen2alt}, frequency: ${frequency}, bandwidth: ${bandwidth}, deltaRange: ${deltaRange}, deltaRangeUnc: ${deltaRangeUnc}, deltaRangeRate: ${deltaRangeRate}, deltaRangeRateUnc: ${deltaRangeRateUnc}, snr: ${snr}, tdoa: ${tdoa}, tdoaUnc: ${tdoaUnc}, fdoa: ${fdoa}, fdoaUnc: ${fdoaUnc}, collectionMode: ${collectionMode}, rawFileUri: ${rawFileUri}, source: ${source}, dataMode: ${dataMode}, tags: ${tags}, origin: ${origin}, createdAt: ${createdAt}, createdBy: ${createdBy}, onOrbit: ${onOrbit}, descriptor: ${descriptor}, transactionId: ${transactionId}, origNetwork: ${origNetwork}, sourceDl: ${sourceDl}}';
  }
}

class _DiffOfArrivalFullReader extends fb.TableReader<DiffOfArrivalFull> {
  const _DiffOfArrivalFullReader();

  @override
  DiffOfArrivalFull createObject(fb.BufferContext bc, int offset) => 
    DiffOfArrivalFull._(bc, offset);
}

class DiffOfArrivalFullBuilder {
  DiffOfArrivalFullBuilder(this.fbBuilder);
  ...
  int addDataMode(DiffOfArrivalFullDataModeEnum? dataMode) {
...
class DiffOfArrivalFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final DiffOfArrivalFullDataModeEnum? _dataMode;
  ...
  DiffOfArrivalFullObjectBuilder({
    String? id,
    ...
    String? rawFileUri,
    String? source,
    DiffOfArrivalFullDataModeEnum? dataMode,
    List<String>? tags,
    String? origin,
    String? createdAt,
    String? createdBy,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(39, onOrbitOffset);
    fbBuilder.addOffset(40, descriptorOffset);
    fbBuilder.addOffset(41, transactionIdOffset);
    fbBuilder.addOffset(42, origNetworkOffset);
    fbBuilder.addOffset(43, sourceDlOffset);
    return fbBuilder.endTable();
  }
