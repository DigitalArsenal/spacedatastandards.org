...
class GnssobservationSetFullDataModeEnum {
  final int value;
  const GnssobservationSetFullDataModeEnum._(this.value);

  factory GnssobservationSetFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum GnssobservationSetFullDataModeEnum');
    }
    return result;
  }

  static GnssobservationSetFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : GnssobservationSetFullDataModeEnum.fromValue(value);
  ...
  static const GnssobservationSetFullDataModeEnum REAL = GnssobservationSetFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const GnssobservationSetFullDataModeEnum TEST = GnssobservationSetFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const GnssobservationSetFullDataModeEnum SIMULATED = GnssobservationSetFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const GnssobservationSetFullDataModeEnum EXERCISE = GnssobservationSetFullDataModeEnum._(3);
  static const Map<int, GnssobservationSetFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<GnssobservationSetFullDataModeEnum> reader = _GnssobservationSetFullDataModeEnumReader();

  @override
  String toString() {
    return 'GnssobservationSetFullDataModeEnum{value: $value}';
  }
}

class _GnssobservationSetFullDataModeEnumReader extends fb.Reader<GnssobservationSetFullDataModeEnum> {
  const _GnssobservationSetFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  GnssobservationSetFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      GnssobservationSetFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Set of GNSSObservation data.
class GnssobservationSetFull {
  GnssobservationSetFull._(this._bc, this._bcOffset);
  factory GnssobservationSetFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<GnssobservationSetFull> reader = _GnssobservationSetFullReader();
  ...
  GnssobservationSetFullDataModeEnum get dataMode => GnssobservationSetFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 70, 0));
...
class _GnssobservationSetFullReader extends fb.TableReader<GnssobservationSetFull> {
  const _GnssobservationSetFullReader();

  @override
  GnssobservationSetFull createObject(fb.BufferContext bc, int offset) => 
    GnssobservationSetFull._(bc, offset);
}

class GnssobservationSetFullBuilder {
  GnssobservationSetFullBuilder(this.fbBuilder);
  ...
  int addDataMode(GnssobservationSetFullDataModeEnum? dataMode) {
...
class GnssobservationSetFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final GnssobservationSetFullDataModeEnum? _dataMode;
  final String? _origNetwork;
  final List<String>? _gnssObservationList;

  GnssobservationSetFullObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    GnssobservationSetFullDataModeEnum? dataMode,
    String? origNetwork,
