...
class LogisticsSpecialtiesFull {
  LogisticsSpecialtiesFull._(this._bc, this._bcOffset);
  factory LogisticsSpecialtiesFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LogisticsSpecialtiesFull> reader = _LogisticsSpecialtiesFullReader();
  ...
  @override
  String toString() {
    return 'LogisticsSpecialtiesFull{specialty: ${specialty}, skillLevel: ${skillLevel}, firstName: ${firstName}, lastName: ${lastName}, rankCode: ${rankCode}, last4Ssn: ${last4Ssn}, roleTypeCode: ${roleTypeCode}}';
  }
}

class _LogisticsSpecialtiesFullReader extends fb.TableReader<LogisticsSpecialtiesFull> {
  const _LogisticsSpecialtiesFullReader();

  @override
  LogisticsSpecialtiesFull createObject(fb.BufferContext bc, int offset) => 
    LogisticsSpecialtiesFull._(bc, offset);
}

class LogisticsSpecialtiesFullBuilder {
  LogisticsSpecialtiesFullBuilder(this.fbBuilder);
...
class LogisticsSpecialtiesFullObjectBuilder extends fb.ObjectBuilder {
  ...
  LogisticsSpecialtiesFullObjectBuilder({
    String? specialty,
    int? skillLevel,
    String? firstName,
    String? lastName,
