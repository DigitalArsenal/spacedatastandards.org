...
class IsrcollectionRequirementsFull {
  IsrcollectionRequirementsFull._(this._bc, this._bcOffset);
  factory IsrcollectionRequirementsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IsrcollectionRequirementsFull> reader = _IsrcollectionRequirementsFullReader();
  ...
  @override
  String toString() {
    return 'IsrcollectionRequirementsFull{id: ${id}, hash: ${hash}, type: ${type}, cridNumbers: ${cridNumbers}, priority: ${priority}, recordId: ${recordId}, reconSurvey: ${reconSurvey}, intelDiscipline: ${intelDiscipline}, secondary: ${secondary}, emphasized: ${emphasized}, isPrismCr: ${isPrismCr}, start: ${start}, stop: ${stop}, operation: ${operation}, supportedUnit: ${supportedUnit}, country: ${country}, region: ${region}, subregion: ${subregion}, specialComGuidance: ${specialComGuidance}, criticalTimes: ${criticalTimes}, exploitationRequirement: ${exploitationRequirement}, targetList: ${targetList}}';
  }
}

class _IsrcollectionRequirementsFullReader extends fb.TableReader<IsrcollectionRequirementsFull> {
  const _IsrcollectionRequirementsFullReader();

  @override
  IsrcollectionRequirementsFull createObject(fb.BufferContext bc, int offset) => 
    IsrcollectionRequirementsFull._(bc, offset);
}

class IsrcollectionRequirementsFullBuilder {
  IsrcollectionRequirementsFullBuilder(this.fbBuilder);
...
class IsrcollectionRequirementsFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _hash;
  final String? _type;
  ...
  IsrcollectionRequirementsFullObjectBuilder({
    String? id,
    String? hash,
    String? type,
    String? cridNumbers,
