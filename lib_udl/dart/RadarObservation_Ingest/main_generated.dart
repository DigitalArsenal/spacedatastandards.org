...
class RadarObservationIngestDataModeEnum {
  final int value;
  const RadarObservationIngestDataModeEnum._(this.value);

  factory RadarObservationIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum RadarObservationIngestDataModeEnum');
    }
    return result;
  }

  static RadarObservationIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : RadarObservationIngestDataModeEnum.fromValue(value);
  ...
  static const RadarObservationIngestDataModeEnum REAL = RadarObservationIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const RadarObservationIngestDataModeEnum TEST = RadarObservationIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const RadarObservationIngestDataModeEnum SIMULATED = RadarObservationIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const RadarObservationIngestDataModeEnum EXERCISE = RadarObservationIngestDataModeEnum._(3);
  static const Map<int, RadarObservationIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<RadarObservationIngestDataModeEnum> reader = _RadarObservationIngestDataModeEnumReader();

  @override
  String toString() {
    return 'RadarObservationIngestDataModeEnum{value: $value}';
  }
}

class _RadarObservationIngestDataModeEnumReader extends fb.Reader<RadarObservationIngestDataModeEnum> {
  const _RadarObservationIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  RadarObservationIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      RadarObservationIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class RadarObservationIngestSenReferenceFrameEnum {
  final int value;
  const RadarObservationIngestSenReferenceFrameEnum._(this.value);

  factory RadarObservationIngestSenReferenceFrameEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum RadarObservationIngestSenReferenceFrameEnum');
    }
    return result;
  }

  static RadarObservationIngestSenReferenceFrameEnum? _createOrNull(int? value) => 
      value == null ? null : RadarObservationIngestSenReferenceFrameEnum.fromValue(value);
  ...
  static const RadarObservationIngestSenReferenceFrameEnum J2000 = RadarObservationIngestSenReferenceFrameEnum._(0);

  ///  No description available.
  static const RadarObservationIngestSenReferenceFrameEnum EFG_TDR = RadarObservationIngestSenReferenceFrameEnum._(1);

  ///  No description available.
  static const RadarObservationIngestSenReferenceFrameEnum ECR_ECEF = RadarObservationIngestSenReferenceFrameEnum._(2);

  ///  No description available.
  static const RadarObservationIngestSenReferenceFrameEnum TEME = RadarObservationIngestSenReferenceFrameEnum._(3);

  ///  No description available.
  static const RadarObservationIngestSenReferenceFrameEnum ITRF = RadarObservationIngestSenReferenceFrameEnum._(4);

  ///  No description available.
  static const RadarObservationIngestSenReferenceFrameEnum GCRF = RadarObservationIngestSenReferenceFrameEnum._(5);
  static const Map<int, RadarObservationIngestSenReferenceFrameEnum> values = {
    0: J2000,
    1: EFG_TDR,
    2: ECR_ECEF,
    3: TEME,
  ...
  static const fb.Reader<RadarObservationIngestSenReferenceFrameEnum> reader = _RadarObservationIngestSenReferenceFrameEnumReader();

  @override
  String toString() {
    return 'RadarObservationIngestSenReferenceFrameEnum{value: $value}';
  }
}

class _RadarObservationIngestSenReferenceFrameEnumReader extends fb.Reader<RadarObservationIngestSenReferenceFrameEnum> {
  const _RadarObservationIngestSenReferenceFrameEnumReader();

  @override
  int get size => 1;

  @override
  RadarObservationIngestSenReferenceFrameEnum read(fb.BufferContext bc, int offset) =>
      RadarObservationIngestSenReferenceFrameEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class RadarObservationIngest {
  RadarObservationIngest._(this._bc, this._bcOffset);
  factory RadarObservationIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<RadarObservationIngest> reader = _RadarObservationIngestReader();
  ...
  RadarObservationIngestDataModeEnum get dataMode => RadarObservationIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 106, 0));
  ...
  RadarObservationIngestSenReferenceFrameEnum get senReferenceFrame => RadarObservationIngestSenReferenceFrameEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 114, 0));
  ///  Optional source-provided and searchable metadata or descriptor of the data.
  ///  Example: /// Example: descriptor
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get descriptor => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 116);
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  String? get origNetwork => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 118);
  ///  The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
  ///  Example: /// Example: AXE
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get sourceDl => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 120);
  ///  Read only enumeration specifying the type of observation (e.g. OPTICAL, RADAR, RF, etc).
  ///  Example: /// Example: RADAR
  ///  Constraints: No constraints specified.
  String? get type => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 122);

  @override
  String toString() {
    return 'RadarObservationIngest{id: ${id}, classificationMarking: ${classificationMarking}, obTime: ${obTime}, idOnOrbit: ${idOnOrbit}, idSensor: ${idSensor}, satNo: ${satNo}, taskId: ${taskId}, transactionId: ${transactionId}, trackId: ${trackId}, obPosition: ${obPosition}, origObjectId: ${origObjectId}, origSensorId: ${origSensorId}, uct: ${uct}, azimuth: ${azimuth}, azimuthUnc: ${azimuthUnc}, azimuthBias: ${azimuthBias}, azimuthRate: ${azimuthRate}, elevation: ${elevation}, elevationUnc: ${elevationUnc}, elevationBias: ${elevationBias}, elevationRate: ${elevationRate}, range: ${range}, rangeAccel: ${rangeAccel}, rangeAccelUnc: ${rangeAccelUnc}, rangeUnc: ${rangeUnc}, rangeBias: ${rangeBias}, rangeRate: ${rangeRate}, rangeRateUnc: ${rangeRateUnc}, doppler: ${doppler}, dopplerUnc: ${dopplerUnc}, ra: ${ra}, declination: ${declination}, x: ${x}, y: ${y}, z: ${z}, xvel: ${xvel}, yvel: ${yvel}, zvel: ${zvel}, senx: ${senx}, seny: ${seny}, senz: ${senz}, rcs: ${rcs}, rcsUnc: ${rcsUnc}, orthogonalRcs: ${orthogonalRcs}, orthogonalRcsUnc: ${orthogonalRcsUnc}, snr: ${snr}, beam: ${beam}, timingBias: ${timingBias}, rawFileUri: ${rawFileUri}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, tags: ${tags}, createdAt: ${createdAt}, createdBy: ${createdBy}, senReferenceFrame: ${senReferenceFrame}, descriptor: ${descriptor}, origNetwork: ${origNetwork}, sourceDl: ${sourceDl}, type: ${type}}';
  }
}

class _RadarObservationIngestReader extends fb.TableReader<RadarObservationIngest> {
  const _RadarObservationIngestReader();

  @override
  RadarObservationIngest createObject(fb.BufferContext bc, int offset) => 
    RadarObservationIngest._(bc, offset);
}

class RadarObservationIngestBuilder {
  RadarObservationIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(RadarObservationIngestDataModeEnum? dataMode) {
  ...
  int addSenReferenceFrame(RadarObservationIngestSenReferenceFrameEnum? senReferenceFrame) {
    fbBuilder.addInt8(55, senReferenceFrame?.value);
    return fbBuilder.offset;
  }
...
class RadarObservationIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final RadarObservationIngestDataModeEnum? _dataMode;
  final List<String>? _tags;
  final String? _createdAt;
  final String? _createdBy;
  final RadarObservationIngestSenReferenceFrameEnum? _senReferenceFrame;
  final String? _descriptor;
  final String? _origNetwork;
  final String? _sourceDl;
  final String? _type;

  RadarObservationIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    RadarObservationIngestDataModeEnum? dataMode,
    List<String>? tags,
    String? createdAt,
    String? createdBy,
    RadarObservationIngestSenReferenceFrameEnum? senReferenceFrame,
    String? descriptor,
    String? origNetwork,
    String? sourceDl,
    String? type,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addInt8(55, _senReferenceFrame?.value);
    fbBuilder.addOffset(56, descriptorOffset);
    fbBuilder.addOffset(57, origNetworkOffset);
    fbBuilder.addOffset(58, sourceDlOffset);
    fbBuilder.addOffset(59, typeOffset);
    return fbBuilder.endTable();
  }
