...
class SgiAbridgedStateEnum {
  final int value;
  const SgiAbridgedStateEnum._(this.value);

  factory SgiAbridgedStateEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SgiAbridgedStateEnum');
    }
    return result;
  }

  static SgiAbridgedStateEnum? _createOrNull(int? value) => 
      value == null ? null : SgiAbridgedStateEnum.fromValue(value);
  ...
  static const SgiAbridgedStateEnum I = SgiAbridgedStateEnum._(0);

  ///  No description available.
  static const SgiAbridgedStateEnum N = SgiAbridgedStateEnum._(1);

  ///  No description available.
  static const SgiAbridgedStateEnum P = SgiAbridgedStateEnum._(2);
  static const Map<int, SgiAbridgedStateEnum> values = {
    0: I,
    1: N,
    2: P};

  static const fb.Reader<SgiAbridgedStateEnum> reader = _SgiAbridgedStateEnumReader();

  @override
  String toString() {
    return 'SgiAbridgedStateEnum{value: $value}';
  }
}

class _SgiAbridgedStateEnumReader extends fb.Reader<SgiAbridgedStateEnum> {
  const _SgiAbridgedStateEnumReader();

  @override
  int get size => 1;

  @override
  SgiAbridgedStateEnum read(fb.BufferContext bc, int offset) =>
      SgiAbridgedStateEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class SgiAbridgedPrecedenceEnum {
  final int value;
  const SgiAbridgedPrecedenceEnum._(this.value);

  factory SgiAbridgedPrecedenceEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SgiAbridgedPrecedenceEnum');
    }
    return result;
  }

  static SgiAbridgedPrecedenceEnum? _createOrNull(int? value) => 
      value == null ? null : SgiAbridgedPrecedenceEnum.fromValue(value);
  ...
  ///  No description available.
  static const SgiAbridgedPrecedenceEnum O = SgiAbridgedPrecedenceEnum._(0);

  ///  No description available.
  static const SgiAbridgedPrecedenceEnum P = SgiAbridgedPrecedenceEnum._(1);

  ///  No description available.
  static const SgiAbridgedPrecedenceEnum R = SgiAbridgedPrecedenceEnum._(2);

  ///  No description available.
  static const SgiAbridgedPrecedenceEnum Y = SgiAbridgedPrecedenceEnum._(3);

  ///  No description available.
  static const SgiAbridgedPrecedenceEnum Z = SgiAbridgedPrecedenceEnum._(4);
  static const Map<int, SgiAbridgedPrecedenceEnum> values = {
    0: O,
    1: P,
    2: R,
    3: Y,
  ...
  static const fb.Reader<SgiAbridgedPrecedenceEnum> reader = _SgiAbridgedPrecedenceEnumReader();

  @override
  String toString() {
    return 'SgiAbridgedPrecedenceEnum{value: $value}';
  }
}

class _SgiAbridgedPrecedenceEnumReader extends fb.Reader<SgiAbridgedPrecedenceEnum> {
  const _SgiAbridgedPrecedenceEnumReader();

  @override
  int get size => 1;

  @override
  SgiAbridgedPrecedenceEnum read(fb.BufferContext bc, int offset) =>
      SgiAbridgedPrecedenceEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class SgiAbridgedDataModeEnum {
  final int value;
  const SgiAbridgedDataModeEnum._(this.value);

  factory SgiAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SgiAbridgedDataModeEnum');
    }
    return result;
  }

  static SgiAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SgiAbridgedDataModeEnum.fromValue(value);
  ...
  static const SgiAbridgedDataModeEnum REAL = SgiAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SgiAbridgedDataModeEnum TEST = SgiAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SgiAbridgedDataModeEnum SIMULATED = SgiAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SgiAbridgedDataModeEnum EXERCISE = SgiAbridgedDataModeEnum._(3);
  static const Map<int, SgiAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SgiAbridgedDataModeEnum> reader = _SgiAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'SgiAbridgedDataModeEnum{value: $value}';
  }
}

class _SgiAbridgedDataModeEnumReader extends fb.Reader<SgiAbridgedDataModeEnum> {
  const _SgiAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SgiAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      SgiAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Model representation of space weather/solar, geomagnetic, and radiation belt indices.
class SgiAbridged {
  SgiAbridged._(this._bc, this._bcOffset);
  factory SgiAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SgiAbridged> reader = _SgiAbridgedReader();
  ...
  SgiAbridgedStateEnum get state => SgiAbridgedStateEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 14, 0));
  ...
  ///  Example: /// Example: R
  ///  Constraints: Minimum length = 0, Maximum length = 1
  SgiAbridgedPrecedenceEnum get precedence => SgiAbridgedPrecedenceEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 24, 0));
  ...
  String? get rawFileUri => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 86);
  ...
  String? get source => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 90);
  ///  Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
  ///  Example: /// Example: THIRD_PARTY_DATASOURCE
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get origin => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 92);
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SgiAbridgedDataModeEnum get dataMode => SgiAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 96, 0));
  ...
  @override
  String toString() {
    return 'SgiAbridged{id: ${id}, classificationMarking: ${classificationMarking}, effectiveDate: ${effectiveDate}, sgiDate: ${sgiDate}, type: ${type}, state: ${state}, stationName: ${stationName}, idSensor: ${idSensor}, origSensorId: ${origSensorId}, mode: ${mode}, precedence: ${precedence}, coeffDegree: ${coeffDegree}, coeffOrder: ${coeffOrder}, ctce: ${ctce}, stce: ${stce}, ctci: ${ctci}, stci: ${stci}, e10: ${e10}, e54: ${e54}, s10: ${s10}, s54: ${s54}, m10: ${m10}, m54: ${m54}, y10: ${y10}, y54: ${y54}, f10: ${f10}, f54: ${f54}, f81: ${f81}, ap: ${ap}, apDuration: ${apDuration}, kIndex: ${kIndex}, kp: ${kp}, kpDuration: ${kpDuration}, gamma: ${gamma}, dst: ${dst}, dtc: ${dtc}, rbRegionCode: ${rbRegionCode}, rbIndex: ${rbIndex}, normFactor: ${normFactor}, rbDuration: ${rbDuration}, analyzerAttenuation: ${analyzerAttenuation}, rawFileUri: ${rawFileUri}, transactionId: ${transactionId}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, createdAt: ${createdAt}, createdBy: ${createdBy}}';
  }
}

class _SgiAbridgedReader extends fb.TableReader<SgiAbridged> {
  const _SgiAbridgedReader();

  @override
  SgiAbridged createObject(fb.BufferContext bc, int offset) => 
    SgiAbridged._(bc, offset);
}

class SgiAbridgedBuilder {
  SgiAbridgedBuilder(this.fbBuilder);

  final fb.Builder fbBuilder;

  void begin() {
    fbBuilder.startTable(49);
  }
  ...
  int addState(SgiAbridgedStateEnum? state) {
  ...
  int addPrecedence(SgiAbridgedPrecedenceEnum? precedence) {
  ...
  int addDataMode(SgiAbridgedDataModeEnum? dataMode) {
...
class SgiAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _classificationMarking;
  final String? _effectiveDate;
  final String? _sgiDate;
  final String? _type;
  final SgiAbridgedStateEnum? _state;
  final String? _stationName;
  final String? _idSensor;
  final String? _origSensorId;
  final int? _mode;
  final SgiAbridgedPrecedenceEnum? _precedence;
  ...
  final SgiAbridgedDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;

  SgiAbridgedObjectBuilder({
    String? id,
    String? classificationMarking,
    String? effectiveDate,
    String? sgiDate,
    String? type,
    SgiAbridgedStateEnum? state,
    String? stationName,
    String? idSensor,
    String? origSensorId,
    int? mode,
    SgiAbridgedPrecedenceEnum? precedence,
    ...
    String? origin,
    String? origNetwork,
    SgiAbridgedDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(41, rawFileUriOffset);
    fbBuilder.addOffset(42, transactionIdOffset);
    fbBuilder.addOffset(43, sourceOffset);
    fbBuilder.addOffset(44, originOffset);
