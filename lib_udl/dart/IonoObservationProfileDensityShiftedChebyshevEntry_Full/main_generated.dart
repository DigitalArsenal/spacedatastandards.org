...
class IonoObservationProfileDensityShiftedChebyshevEntryFull {
  IonoObservationProfileDensityShiftedChebyshevEntryFull._(this._bc, this._bcOffset);
  factory IonoObservationProfileDensityShiftedChebyshevEntryFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationProfileDensityShiftedChebyshevEntryFull> reader = _IonoObservationProfileDensityShiftedChebyshevEntryFullReader();
  ...
  @override
  String toString() {
    return 'IonoObservationProfileDensityShiftedChebyshevEntryFull{layer: ${layer}, fstart: ${fstart}, fstop: ${fstop}, peakheight: ${peakheight}, zhalfNm: ${zhalfNm}, n: ${n}, coeffs: ${coeffs}, error: ${error}}';
  }
}

class _IonoObservationProfileDensityShiftedChebyshevEntryFullReader extends fb.TableReader<IonoObservationProfileDensityShiftedChebyshevEntryFull> {
  const _IonoObservationProfileDensityShiftedChebyshevEntryFullReader();

  @override
  IonoObservationProfileDensityShiftedChebyshevEntryFull createObject(fb.BufferContext bc, int offset) => 
    IonoObservationProfileDensityShiftedChebyshevEntryFull._(bc, offset);
}

class IonoObservationProfileDensityShiftedChebyshevEntryFullBuilder {
  IonoObservationProfileDensityShiftedChebyshevEntryFullBuilder(this.fbBuilder);
...
class IonoObservationProfileDensityShiftedChebyshevEntryFullObjectBuilder extends fb.ObjectBuilder {
  final String? _layer;
  ...
  IonoObservationProfileDensityShiftedChebyshevEntryFullObjectBuilder({
    String? layer,
    double? fstart,
    double? fstop,
    double? peakheight,
