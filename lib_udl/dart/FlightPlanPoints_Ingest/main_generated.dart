...
class FlightPlanPointsIngest {
  FlightPlanPointsIngest._(this._bc, this._bcOffset);
  factory FlightPlanPointsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<FlightPlanPointsIngest> reader = _FlightPlanPointsIngestReader();
  ...
  @override
  String toString() {
    return 'FlightPlanPointsIngest{pointName: ${pointName}, fppLat: ${fppLat}, fppLon: ${fppLon}, fppEta: ${fppEta}, fppReqFuel: ${fppReqFuel}}';
  }
}

class _FlightPlanPointsIngestReader extends fb.TableReader<FlightPlanPointsIngest> {
  const _FlightPlanPointsIngestReader();

  @override
  FlightPlanPointsIngest createObject(fb.BufferContext bc, int offset) => 
    FlightPlanPointsIngest._(bc, offset);
}

class FlightPlanPointsIngestBuilder {
  FlightPlanPointsIngestBuilder(this.fbBuilder);
...
class FlightPlanPointsIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  FlightPlanPointsIngestObjectBuilder({
    String? pointName,
    double? fppLat,
    double? fppLon,
    String? fppEta,
