...
class AircraftIngestDataModeEnum {
  final int value;
  const AircraftIngestDataModeEnum._(this.value);

  factory AircraftIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AircraftIngestDataModeEnum');
    }
    return result;
  }

  static AircraftIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AircraftIngestDataModeEnum.fromValue(value);
  ...
  static const AircraftIngestDataModeEnum REAL = AircraftIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AircraftIngestDataModeEnum TEST = AircraftIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AircraftIngestDataModeEnum SIMULATED = AircraftIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AircraftIngestDataModeEnum EXERCISE = AircraftIngestDataModeEnum._(3);
  static const Map<int, AircraftIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AircraftIngestDataModeEnum> reader = _AircraftIngestDataModeEnumReader();

  @override
  String toString() {
    return 'AircraftIngestDataModeEnum{value: $value}';
  }
}

class _AircraftIngestDataModeEnumReader extends fb.Reader<AircraftIngestDataModeEnum> {
  const _AircraftIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AircraftIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      AircraftIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AircraftIngest {
  AircraftIngest._(this._bc, this._bcOffset);
  factory AircraftIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AircraftIngest> reader = _AircraftIngestReader();
  ...
  String? get sourceDl => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 42);
  ///  Source of the data.
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 64
  AircraftIngestDataModeEnum get dataMode => AircraftIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 48, 0));
...
class AircraftIngestBuilder {
  ...
  int addDataMode(AircraftIngestDataModeEnum? dataMode) {
...
class AircraftIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AircraftIngestDataModeEnum? _dataMode;
  final String? _origNetwork;

  AircraftIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    AircraftIngestDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(19, sourceDlOffset);
