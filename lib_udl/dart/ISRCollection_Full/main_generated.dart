...
class IsrcollectionFullDataModeEnum {
  final int value;
  const IsrcollectionFullDataModeEnum._(this.value);

  factory IsrcollectionFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum IsrcollectionFullDataModeEnum');
    }
    return result;
  }

  static IsrcollectionFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : IsrcollectionFullDataModeEnum.fromValue(value);
  ...
  static const IsrcollectionFullDataModeEnum REAL = IsrcollectionFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const IsrcollectionFullDataModeEnum TEST = IsrcollectionFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const IsrcollectionFullDataModeEnum SIMULATED = IsrcollectionFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const IsrcollectionFullDataModeEnum EXERCISE = IsrcollectionFullDataModeEnum._(3);
  static const Map<int, IsrcollectionFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<IsrcollectionFullDataModeEnum> reader = _IsrcollectionFullDataModeEnumReader();

  @override
  String toString() {
    return 'IsrcollectionFullDataModeEnum{value: $value}';
  }
}

class _IsrcollectionFullDataModeEnumReader extends fb.Reader<IsrcollectionFullDataModeEnum> {
  const _IsrcollectionFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  IsrcollectionFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      IsrcollectionFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// ISR Collection data.
class IsrcollectionFull {
  IsrcollectionFull._(this._bc, this._bcOffset);
  factory IsrcollectionFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IsrcollectionFull> reader = _IsrcollectionFullReader();
  ...
  IsrcollectionFullDataModeEnum get dataMode => IsrcollectionFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 68, 0));
...
class IsrcollectionFullBuilder {
  ...
  int addDataMode(IsrcollectionFullDataModeEnum? dataMode) {
...
class IsrcollectionFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final IsrcollectionFullDataModeEnum? _dataMode;
  final String? _origNetwork;

  IsrcollectionFullObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    IsrcollectionFullDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
