...
class StarCatalogIngestAstrometryOriginEnum {
  final int value;
  const StarCatalogIngestAstrometryOriginEnum._(this.value);

  factory StarCatalogIngestAstrometryOriginEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum StarCatalogIngestAstrometryOriginEnum');
    }
    return result;
  }

  static StarCatalogIngestAstrometryOriginEnum? _createOrNull(int? value) => 
      value == null ? null : StarCatalogIngestAstrometryOriginEnum.fromValue(value);
  ...
  static const StarCatalogIngestAstrometryOriginEnum GAIADR3 = StarCatalogIngestAstrometryOriginEnum._(0);

  ///  No description available.
  static const StarCatalogIngestAstrometryOriginEnum HIPPARCOS = StarCatalogIngestAstrometryOriginEnum._(1);

  ///  No description available.
  static const StarCatalogIngestAstrometryOriginEnum USNOBSC = StarCatalogIngestAstrometryOriginEnum._(2);
  static const Map<int, StarCatalogIngestAstrometryOriginEnum> values = {
    0: GAIADR3,
    1: HIPPARCOS,
    2: USNOBSC};

  static const fb.Reader<StarCatalogIngestAstrometryOriginEnum> reader = _StarCatalogIngestAstrometryOriginEnumReader();

  @override
  String toString() {
    return 'StarCatalogIngestAstrometryOriginEnum{value: $value}';
  }
}

class _StarCatalogIngestAstrometryOriginEnumReader extends fb.Reader<StarCatalogIngestAstrometryOriginEnum> {
  const _StarCatalogIngestAstrometryOriginEnumReader();

  @override
  int get size => 1;

  @override
  StarCatalogIngestAstrometryOriginEnum read(fb.BufferContext bc, int offset) =>
      StarCatalogIngestAstrometryOriginEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class StarCatalogIngestDataModeEnum {
  final int value;
  const StarCatalogIngestDataModeEnum._(this.value);

  factory StarCatalogIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum StarCatalogIngestDataModeEnum');
    }
    return result;
  }

  static StarCatalogIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : StarCatalogIngestDataModeEnum.fromValue(value);
  ...
  static const StarCatalogIngestDataModeEnum REAL = StarCatalogIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const StarCatalogIngestDataModeEnum TEST = StarCatalogIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const StarCatalogIngestDataModeEnum SIMULATED = StarCatalogIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const StarCatalogIngestDataModeEnum EXERCISE = StarCatalogIngestDataModeEnum._(3);
  static const Map<int, StarCatalogIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<StarCatalogIngestDataModeEnum> reader = _StarCatalogIngestDataModeEnumReader();

  @override
  String toString() {
    return 'StarCatalogIngestDataModeEnum{value: $value}';
  }
}

class _StarCatalogIngestDataModeEnumReader extends fb.Reader<StarCatalogIngestDataModeEnum> {
  const _StarCatalogIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  StarCatalogIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      StarCatalogIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// The star catalog provides the position, proper motion, parallax, and photometric magnitudes at various bandpasses of a star.
class StarCatalogIngest {
  StarCatalogIngest._(this._bc, this._bcOffset);
  factory StarCatalogIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<StarCatalogIngest> reader = _StarCatalogIngestReader();
  ...
  StarCatalogIngestAstrometryOriginEnum get astrometryOrigin => StarCatalogIngestAstrometryOriginEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 42, 0));
...
class StarCatalogIngestBuilder {
  ...
  int addAstrometryOrigin(StarCatalogIngestAstrometryOriginEnum? astrometryOrigin) {
  ...
  int addDataMode(StarCatalogIngestDataModeEnum? dataMode) {
...
class StarCatalogIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final StarCatalogIngestAstrometryOriginEnum? _astrometryOrigin;
  ...
  final StarCatalogIngestDataModeEnum? _dataMode;

  StarCatalogIngestObjectBuilder({
    String? id,
    ...
    double? pmdecUnc,
    bool? pmUncFlag,
    StarCatalogIngestAstrometryOriginEnum? astrometryOrigin,
    double? starEpoch,
    double? gmag,
    double? gmagUnc,
    double? bpmag,
    ...
    String? origin,
    String? origNetwork,
    StarCatalogIngestDataModeEnum? dataMode,
  })
      : _id = id,
