...
class ManifoldElsetFullDataModeEnum {
  final int value;
  const ManifoldElsetFullDataModeEnum._(this.value);

  factory ManifoldElsetFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ManifoldElsetFullDataModeEnum');
    }
    return result;
  }

  static ManifoldElsetFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : ManifoldElsetFullDataModeEnum.fromValue(value);
  ...
  static const ManifoldElsetFullDataModeEnum REAL = ManifoldElsetFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const ManifoldElsetFullDataModeEnum TEST = ManifoldElsetFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const ManifoldElsetFullDataModeEnum SIMULATED = ManifoldElsetFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const ManifoldElsetFullDataModeEnum EXERCISE = ManifoldElsetFullDataModeEnum._(3);
  static const Map<int, ManifoldElsetFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<ManifoldElsetFullDataModeEnum> reader = _ManifoldElsetFullDataModeEnumReader();

  @override
  String toString() {
    return 'ManifoldElsetFullDataModeEnum{value: $value}';
  }
}

class _ManifoldElsetFullDataModeEnumReader extends fb.Reader<ManifoldElsetFullDataModeEnum> {
  const _ManifoldElsetFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  ManifoldElsetFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      ManifoldElsetFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class ManifoldElsetFull {
  ManifoldElsetFull._(this._bc, this._bcOffset);
  factory ManifoldElsetFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<ManifoldElsetFull> reader = _ManifoldElsetFullReader();
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  String? get updatedAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 50);
  ...
  String? get updatedBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 52);
  ///  Source of the data.
  ...
  ManifoldElsetFullDataModeEnum get dataMode => ManifoldElsetFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 58, 0));
  ...
  @override
  String toString() {
    return 'ManifoldElsetFull{id: ${id}, idManifold: ${idManifold}, classificationMarking: ${classificationMarking}, tmpSatNo: ${tmpSatNo}, epoch: ${epoch}, meanMotion: ${meanMotion}, eccentricity: ${eccentricity}, inclination: ${inclination}, raan: ${raan}, argOfPerigee: ${argOfPerigee}, meanAnomaly: ${meanAnomaly}, revNo: ${revNo}, bStar: ${bStar}, meanMotionDot: ${meanMotionDot}, meanMotionDdot: ${meanMotionDdot}, semiMajorAxis: ${semiMajorAxis}, period: ${period}, apogee: ${apogee}, perigee: ${perigee}, line1: ${line1}, line2: ${line2}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, origNetwork: ${origNetwork}}';
  }
}

class _ManifoldElsetFullReader extends fb.TableReader<ManifoldElsetFull> {
  const _ManifoldElsetFullReader();

  @override
  ManifoldElsetFull createObject(fb.BufferContext bc, int offset) => 
    ManifoldElsetFull._(bc, offset);
}

class ManifoldElsetFullBuilder {
  ManifoldElsetFullBuilder(this.fbBuilder);
  ...
  int addDataMode(ManifoldElsetFullDataModeEnum? dataMode) {
...
class ManifoldElsetFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final ManifoldElsetFullDataModeEnum? _dataMode;
  final String? _origNetwork;

  ManifoldElsetFullObjectBuilder({
    String? id,
    String? idManifold,
    ...
    String? source,
    String? origin,
    ManifoldElsetFullDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(23, updatedAtOffset);
    fbBuilder.addOffset(24, updatedByOffset);
