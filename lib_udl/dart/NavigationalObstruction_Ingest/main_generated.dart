...
class NavigationalObstructionIngestDataModeEnum {
  final int value;
  const NavigationalObstructionIngestDataModeEnum._(this.value);

  factory NavigationalObstructionIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum NavigationalObstructionIngestDataModeEnum');
    }
    return result;
  }

  static NavigationalObstructionIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : NavigationalObstructionIngestDataModeEnum.fromValue(value);
  ...
  static const NavigationalObstructionIngestDataModeEnum REAL = NavigationalObstructionIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const NavigationalObstructionIngestDataModeEnum TEST = NavigationalObstructionIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const NavigationalObstructionIngestDataModeEnum SIMULATED = NavigationalObstructionIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const NavigationalObstructionIngestDataModeEnum EXERCISE = NavigationalObstructionIngestDataModeEnum._(3);
  static const Map<int, NavigationalObstructionIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<NavigationalObstructionIngestDataModeEnum> reader = _NavigationalObstructionIngestDataModeEnumReader();

  @override
  String toString() {
    return 'NavigationalObstructionIngestDataModeEnum{value: $value}';
  }
}

class _NavigationalObstructionIngestDataModeEnumReader extends fb.Reader<NavigationalObstructionIngestDataModeEnum> {
  const _NavigationalObstructionIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  NavigationalObstructionIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      NavigationalObstructionIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class NavigationalObstructionIngest {
  NavigationalObstructionIngest._(this._bc, this._bcOffset);
  factory NavigationalObstructionIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<NavigationalObstructionIngest> reader = _NavigationalObstructionIngestReader();
...
class NavigationalObstructionIngestBuilder {
  ...
  int addDataMode(NavigationalObstructionIngestDataModeEnum? dataMode) {
...
class NavigationalObstructionIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final NavigationalObstructionIngestDataModeEnum? _dataMode;

  NavigationalObstructionIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    NavigationalObstructionIngestDataModeEnum? dataMode,
  })
      : _id = id,
