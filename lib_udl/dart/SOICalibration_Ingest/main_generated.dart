...
class SoicalibrationIngest {
  SoicalibrationIngest._(this._bc, this._bcOffset);
  factory SoicalibrationIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SoicalibrationIngest> reader = _SoicalibrationIngestReader();
  ...
  @override
  String toString() {
    return 'SoicalibrationIngest{calExtinctionCoeff: ${calExtinctionCoeff}, calSkyBg: ${calSkyBg}, calBgIntensity: ${calBgIntensity}, calSpectralFilterSolarMag: ${calSpectralFilterSolarMag}, calZeroPoint: ${calZeroPoint}, calNumDetectedStars: ${calNumDetectedStars}, calNumCorrelatedStars: ${calNumCorrelatedStars}, calExtinctionCoeffUnc: ${calExtinctionCoeffUnc}, calExtinctionCoeffMaxUnc: ${calExtinctionCoeffMaxUnc}, calTime: ${calTime}, calType: ${calType}}';
  }
}

class _SoicalibrationIngestReader extends fb.TableReader<SoicalibrationIngest> {
  const _SoicalibrationIngestReader();

  @override
  SoicalibrationIngest createObject(fb.BufferContext bc, int offset) => 
    SoicalibrationIngest._(bc, offset);
}

class SoicalibrationIngestBuilder {
  SoicalibrationIngestBuilder(this.fbBuilder);
...
class SoicalibrationIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  SoicalibrationIngestObjectBuilder({
