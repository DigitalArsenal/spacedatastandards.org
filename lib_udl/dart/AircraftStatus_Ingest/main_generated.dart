...
class AircraftStatusIngestAirToAirStatusEnum {
  final int value;
  const AircraftStatusIngestAirToAirStatusEnum._(this.value);

  factory AircraftStatusIngestAirToAirStatusEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AircraftStatusIngestAirToAirStatusEnum');
    }
    return result;
  }

  static AircraftStatusIngestAirToAirStatusEnum? _createOrNull(int? value) => 
      value == null ? null : AircraftStatusIngestAirToAirStatusEnum.fromValue(value);
  ...
  static const AircraftStatusIngestAirToAirStatusEnum OPERATIONAL = AircraftStatusIngestAirToAirStatusEnum._(0);

  ///  No description available.
  static const AircraftStatusIngestAirToAirStatusEnum NON_OPERATIONAL = AircraftStatusIngestAirToAirStatusEnum._(1);

  ///  No description available.
  static const AircraftStatusIngestAirToAirStatusEnum OFF = AircraftStatusIngestAirToAirStatusEnum._(2);
  static const Map<int, AircraftStatusIngestAirToAirStatusEnum> values = {
    0: OPERATIONAL,
    1: NON_OPERATIONAL,
    2: OFF};

  static const fb.Reader<AircraftStatusIngestAirToAirStatusEnum> reader = _AircraftStatusIngestAirToAirStatusEnumReader();

  @override
  String toString() {
    return 'AircraftStatusIngestAirToAirStatusEnum{value: $value}';
  }
}

class _AircraftStatusIngestAirToAirStatusEnumReader extends fb.Reader<AircraftStatusIngestAirToAirStatusEnum> {
  const _AircraftStatusIngestAirToAirStatusEnumReader();

  @override
  int get size => 1;

  @override
  AircraftStatusIngestAirToAirStatusEnum read(fb.BufferContext bc, int offset) =>
      AircraftStatusIngestAirToAirStatusEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class AircraftStatusIngestAirToGroundStatusEnum {
  final int value;
  const AircraftStatusIngestAirToGroundStatusEnum._(this.value);

  factory AircraftStatusIngestAirToGroundStatusEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AircraftStatusIngestAirToGroundStatusEnum');
    }
    return result;
  }

  static AircraftStatusIngestAirToGroundStatusEnum? _createOrNull(int? value) => 
      value == null ? null : AircraftStatusIngestAirToGroundStatusEnum.fromValue(value);
  ...
  ///  No description available.
  static const AircraftStatusIngestAirToGroundStatusEnum OPERATIONAL = AircraftStatusIngestAirToGroundStatusEnum._(0);

  ///  No description available.
  static const AircraftStatusIngestAirToGroundStatusEnum NON_OPERATIONAL = AircraftStatusIngestAirToGroundStatusEnum._(1);

  ///  No description available.
  static const AircraftStatusIngestAirToGroundStatusEnum OFF = AircraftStatusIngestAirToGroundStatusEnum._(2);
  static const Map<int, AircraftStatusIngestAirToGroundStatusEnum> values = {
    0: OPERATIONAL,
    1: NON_OPERATIONAL,
    2: OFF};

  static const fb.Reader<AircraftStatusIngestAirToGroundStatusEnum> reader = _AircraftStatusIngestAirToGroundStatusEnumReader();

  @override
  String toString() {
    return 'AircraftStatusIngestAirToGroundStatusEnum{value: $value}';
  }
}

class _AircraftStatusIngestAirToGroundStatusEnumReader extends fb.Reader<AircraftStatusIngestAirToGroundStatusEnum> {
  const _AircraftStatusIngestAirToGroundStatusEnumReader();

  @override
  int get size => 1;

  @override
  AircraftStatusIngestAirToGroundStatusEnum read(fb.BufferContext bc, int offset) =>
      AircraftStatusIngestAirToGroundStatusEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class AircraftStatusIngestDataModeEnum {
  final int value;
  const AircraftStatusIngestDataModeEnum._(this.value);

  factory AircraftStatusIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AircraftStatusIngestDataModeEnum');
    }
    return result;
  }

  static AircraftStatusIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AircraftStatusIngestDataModeEnum.fromValue(value);
  ...
  static const AircraftStatusIngestDataModeEnum REAL = AircraftStatusIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AircraftStatusIngestDataModeEnum TEST = AircraftStatusIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AircraftStatusIngestDataModeEnum SIMULATED = AircraftStatusIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AircraftStatusIngestDataModeEnum EXERCISE = AircraftStatusIngestDataModeEnum._(3);
  static const Map<int, AircraftStatusIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AircraftStatusIngestDataModeEnum> reader = _AircraftStatusIngestDataModeEnumReader();

  @override
  String toString() {
    return 'AircraftStatusIngestDataModeEnum{value: $value}';
  }
}

class _AircraftStatusIngestDataModeEnumReader extends fb.Reader<AircraftStatusIngestDataModeEnum> {
  const _AircraftStatusIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AircraftStatusIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      AircraftStatusIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AircraftStatusIngest {
  AircraftStatusIngest._(this._bc, this._bcOffset);
  factory AircraftStatusIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AircraftStatusIngest> reader = _AircraftStatusIngestReader();
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 16
  AircraftStatusIngestAirToAirStatusEnum get airToAirStatus => AircraftStatusIngestAirToAirStatusEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 44, 0));
  ///  The status of the air-to-ground weapon release system (OPERATIONAL, NON-OPERATIONAL, OFF).
  ///  Example: /// Example: OPERATIONAL
  ///  Constraints: Minimum length = 0, Maximum length = 16
  AircraftStatusIngestAirToGroundStatusEnum get airToGroundStatus => AircraftStatusIngestAirToGroundStatusEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 46, 0));
  ...
  AircraftStatusIngestDataModeEnum get dataMode => AircraftStatusIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 104, 0));
...
class AircraftStatusIngestBuilder {
  ...
  int addAirToAirStatus(AircraftStatusIngestAirToAirStatusEnum? airToAirStatus) {
    fbBuilder.addInt8(20, airToAirStatus?.value);
    return fbBuilder.offset;
  }
  int addAirToGroundStatus(AircraftStatusIngestAirToGroundStatusEnum? airToGroundStatus) {
  ...
  int addDataMode(AircraftStatusIngestDataModeEnum? dataMode) {
...
class AircraftStatusIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AircraftStatusIngestAirToAirStatusEnum? _airToAirStatus;
  final AircraftStatusIngestAirToGroundStatusEnum? _airToGroundStatus;
  ...
  final AircraftStatusIngestDataModeEnum? _dataMode;
  final String? _origNetwork;

  AircraftStatusIngestObjectBuilder({
    String? id,
    ...
    int? gunRdsMin,
    int? gunRdsMax,
    AircraftStatusIngestAirToAirStatusEnum? airToAirStatus,
    AircraftStatusIngestAirToGroundStatusEnum? airToGroundStatus,
    ...
    String? source,
    String? origin,
    AircraftStatusIngestDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
