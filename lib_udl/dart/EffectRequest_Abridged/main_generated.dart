...
class EffectRequestAbridgedDataModeEnum {
  final int value;
  const EffectRequestAbridgedDataModeEnum._(this.value);

  factory EffectRequestAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EffectRequestAbridgedDataModeEnum');
    }
    return result;
  }

  static EffectRequestAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EffectRequestAbridgedDataModeEnum.fromValue(value);
  ...
  static const EffectRequestAbridgedDataModeEnum REAL = EffectRequestAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EffectRequestAbridgedDataModeEnum TEST = EffectRequestAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EffectRequestAbridgedDataModeEnum SIMULATED = EffectRequestAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EffectRequestAbridgedDataModeEnum EXERCISE = EffectRequestAbridgedDataModeEnum._(3);
  static const Map<int, EffectRequestAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EffectRequestAbridgedDataModeEnum> reader = _EffectRequestAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'EffectRequestAbridgedDataModeEnum{value: $value}';
  }
}

class _EffectRequestAbridgedDataModeEnumReader extends fb.Reader<EffectRequestAbridgedDataModeEnum> {
  const _EffectRequestAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EffectRequestAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      EffectRequestAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// A request for various effects on a target.
class EffectRequestAbridged {
  EffectRequestAbridged._(this._bc, this._bcOffset);
  factory EffectRequestAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EffectRequestAbridged> reader = _EffectRequestAbridgedReader();
  ...
  EffectRequestAbridgedDataModeEnum get dataMode => EffectRequestAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 42, 0));
  ...
  @override
  String toString() {
    return 'EffectRequestAbridged{id: ${id}, classificationMarking: ${classificationMarking}, externalRequestId: ${externalRequestId}, effectList: ${effectList}, state: ${state}, context: ${context}, startTime: ${startTime}, endTime: ${endTime}, deadlineType: ${deadlineType}, targetSrcType: ${targetSrcType}, targetSrcId: ${targetSrcId}, priority: ${priority}, modelClass: ${modelClass}, metricTypes: ${metricTypes}, metricWeights: ${metricWeights}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, origNetwork: ${origNetwork}}';
  }
}

class _EffectRequestAbridgedReader extends fb.TableReader<EffectRequestAbridged> {
  const _EffectRequestAbridgedReader();

  @override
  EffectRequestAbridged createObject(fb.BufferContext bc, int offset) => 
    EffectRequestAbridged._(bc, offset);
}

class EffectRequestAbridgedBuilder {
  EffectRequestAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(EffectRequestAbridgedDataModeEnum? dataMode) {
...
class EffectRequestAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EffectRequestAbridgedDataModeEnum? _dataMode;
  final String? _origNetwork;

  EffectRequestAbridgedObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    EffectRequestAbridgedDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
