...
class AirLoadPlanIngestDataModeEnum {
  final int value;
  const AirLoadPlanIngestDataModeEnum._(this.value);

  factory AirLoadPlanIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirLoadPlanIngestDataModeEnum');
    }
    return result;
  }

  static AirLoadPlanIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AirLoadPlanIngestDataModeEnum.fromValue(value);
  ...
  static const AirLoadPlanIngestDataModeEnum REAL = AirLoadPlanIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AirLoadPlanIngestDataModeEnum TEST = AirLoadPlanIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AirLoadPlanIngestDataModeEnum SIMULATED = AirLoadPlanIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AirLoadPlanIngestDataModeEnum EXERCISE = AirLoadPlanIngestDataModeEnum._(3);
  static const Map<int, AirLoadPlanIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AirLoadPlanIngestDataModeEnum> reader = _AirLoadPlanIngestDataModeEnumReader();

  @override
  String toString() {
    return 'AirLoadPlanIngestDataModeEnum{value: $value}';
  }
}

class _AirLoadPlanIngestDataModeEnumReader extends fb.Reader<AirLoadPlanIngestDataModeEnum> {
  const _AirLoadPlanIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AirLoadPlanIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      AirLoadPlanIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Information related to how an aircraft is loaded with cargo, equipment, and passengers.
class AirLoadPlanIngest {
  AirLoadPlanIngest._(this._bc, this._bcOffset);
  factory AirLoadPlanIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirLoadPlanIngest> reader = _AirLoadPlanIngestReader();
...
class AirLoadPlanIngestBuilder {
  ...
  int addDataMode(AirLoadPlanIngestDataModeEnum? dataMode) {
...
class AirLoadPlanIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AirLoadPlanIngestDataModeEnum? _dataMode;

  AirLoadPlanIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    AirLoadPlanIngestDataModeEnum? dataMode,
  })
      : _id = id,
