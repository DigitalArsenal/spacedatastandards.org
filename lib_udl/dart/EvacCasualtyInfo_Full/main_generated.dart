...
class EvacCasualtyInfoFull {
  EvacCasualtyInfoFull._(this._bc, this._bcOffset);
  factory EvacCasualtyInfoFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EvacCasualtyInfoFull> reader = _EvacCasualtyInfoFullReader();
...
class EvacCasualtyInfoFullObjectBuilder extends fb.ObjectBuilder {
  ...
  EvacCasualtyInfoFullObjectBuilder({
    String? priority,
    String? evacType,
    String? casualtyType,
    String? bodyPart,
