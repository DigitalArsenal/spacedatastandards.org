...
class ConjunctionIngestDataModeEnum {
  final int value;
  const ConjunctionIngestDataModeEnum._(this.value);

  factory ConjunctionIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ConjunctionIngestDataModeEnum');
    }
    return result;
  }

  static ConjunctionIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : ConjunctionIngestDataModeEnum.fromValue(value);
  ...
  static const ConjunctionIngestDataModeEnum REAL = ConjunctionIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const ConjunctionIngestDataModeEnum TEST = ConjunctionIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const ConjunctionIngestDataModeEnum SIMULATED = ConjunctionIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const ConjunctionIngestDataModeEnum EXERCISE = ConjunctionIngestDataModeEnum._(3);
  static const Map<int, ConjunctionIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<ConjunctionIngestDataModeEnum> reader = _ConjunctionIngestDataModeEnumReader();

  @override
  String toString() {
    return 'ConjunctionIngestDataModeEnum{value: $value}';
  }
}

class _ConjunctionIngestDataModeEnumReader extends fb.Reader<ConjunctionIngestDataModeEnum> {
  const _ConjunctionIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  ConjunctionIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      ConjunctionIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Stores the results of a particular Conjunction Assessment (CA) run.
class ConjunctionIngest {
  ConjunctionIngest._(this._bc, this._bcOffset);
  factory ConjunctionIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<ConjunctionIngest> reader = _ConjunctionIngestReader();
  ...
  ConjunctionIngestDataModeEnum get dataMode => ConjunctionIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 122, 0));
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get origIdOnOrbit1 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 136);
  ///  Optional place holder for an OnOrbit ID that does not exist in UDL.
  ///  Example: /// Example: ORIGONORBIT2-ID
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get origIdOnOrbit2 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 138);
...
class ConjunctionIngestBuilder {
  ...
  int addDataMode(ConjunctionIngestDataModeEnum? dataMode) {
...
class ConjunctionIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final ConjunctionIngestDataModeEnum? _dataMode;
  ...
  ConjunctionIngestObjectBuilder({
    String? id,
    ...
    String? descriptor,
    List<String>? tags,
    ConjunctionIngestDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? stateVector1,
    String? stateVector2,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(66, origIdOnOrbit1Offset);
    fbBuilder.addOffset(67, origIdOnOrbit2Offset);
