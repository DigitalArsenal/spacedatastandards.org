...
class SkyImageryFullDataModeEnum {
  final int value;
  const SkyImageryFullDataModeEnum._(this.value);

  factory SkyImageryFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SkyImageryFullDataModeEnum');
    }
    return result;
  }

  static SkyImageryFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SkyImageryFullDataModeEnum.fromValue(value);
  ...
  static const SkyImageryFullDataModeEnum REAL = SkyImageryFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SkyImageryFullDataModeEnum TEST = SkyImageryFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SkyImageryFullDataModeEnum SIMULATED = SkyImageryFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SkyImageryFullDataModeEnum EXERCISE = SkyImageryFullDataModeEnum._(3);
  static const Map<int, SkyImageryFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SkyImageryFullDataModeEnum> reader = _SkyImageryFullDataModeEnumReader();

  @override
  String toString() {
    return 'SkyImageryFullDataModeEnum{value: $value}';
  }
}

class _SkyImageryFullDataModeEnumReader extends fb.Reader<SkyImageryFullDataModeEnum> {
  const _SkyImageryFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SkyImageryFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      SkyImageryFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class SkyImageryFull {
  SkyImageryFull._(this._bc, this._bcOffset);
  factory SkyImageryFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SkyImageryFull> reader = _SkyImageryFullReader();
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get idAttitudeSet => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 14);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get senQuat => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 34);
  ...
  ///  Example: /// Example: [0.03, 0.02, 0.01, 0.012]
  ///  Constraints: No constraints specified.
  List<String>? get senQuatDot => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 36);
  ///  The type of image associated with this record (e.g. FITS, EOSSA, EOCHIP).
  ///  Example: /// Example: imageType
  ///  Constraints: Minimum length = 1, Maximum length = 24
  String? get imageType => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 38);
  ///  Start time of the exposure, in ISO 8601 UTC format with microsecond precision.
  ///  Example: /// Example: 2021-01-01T01:01:01.123456Z
  ///  Constraints: No constraints specified.
  String? get expStartTime => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 40);
  ///  End time of the exposure, in ISO 8601 UTC format with microsecond precision.
  ///  Example: /// Example: 2021-01-01T01:01:01.123456Z
  ///  Constraints: No constraints specified.
  String? get expEndTime => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 42);
  ///  String that uniquely identifies the data source.
  ///  Example: /// Example: imageSourceInfo
  ///  Constraints: Minimum length = 0, Maximum length = 100
  String? get imageSourceInfo => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 44);
  ///  The telescope pointing azimuth, in degrees, at the exposure start epoch.
  ///  Example: /// Example: 146.321
  ///  Constraints: No constraints specified.
  double get topLeftStartAz => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 46, 0.0);
  ///  The telescope pointing elevation, in degrees, at the exposure start epoch.
  ///  Example: /// Example: 146.321
  ///  Constraints: No constraints specified.
  double get topLeftStartEl => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 48, 0.0);
  ///  The telescope pointing azimuth, in degrees, at the exposure stop epoch.
  ///  Example: /// Example: 3.7
  ///  Constraints: No constraints specified.
  double get topLeftStopAz => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 50, 0.0);
  ///  The telescope pointing elevation, in degrees, at the exposure stop epoch.
  ///  Example: /// Example: 34.233
  ///  Constraints: No constraints specified.
  double get topLeftStopEl => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 52, 0.0);
  ///  The user-defined set ID of a sequence of images.
  ///  Example: /// Example: imageSetId
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get imageSetId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 54);
  ///  The number of images in an image set.
  ///  Example: /// Example: 9
  ///  Constraints: No constraints specified.
  int get imageSetLength => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 56, 0);
  ///  The sequence ID of an image within an image set.
  ///  Example: /// Example: 1
  ///  Constraints: No constraints specified.
  int get sequenceId => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 58, 0);
  ///  Field Of View frame width, in degrees.
  ///  Example: /// Example: 21.23
  ///  Constraints: No constraints specified.
  double get frameFovwidth => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 60, 0.0);
  ///  Field Of View frame height, in degrees.
  ///  Example: /// Example: 21.23
  ///  Constraints: No constraints specified.
  double get frameFovheight => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 62, 0.0);
  ///  Field Of View pixel width, in degrees.
  ///  Example: /// Example: 321.123
  ///  Constraints: No constraints specified.
  double get pixelFovwidth => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 64, 0.0);
  ///  Field Of View pixel height, in degrees.
  ///  Example: /// Example: 321.123
  ///  Constraints: No constraints specified.
  double get pixelFovheight => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 66, 0.0);
  ///  Frame width of the image, in number of pixels.
  ///  Example: /// Example: 1
  ///  Constraints: No constraints specified.
  int get frameWidthPixels => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 68, 0);
  ///  Frame height of the image, in number of pixels.
  ///  Example: /// Example: 1
  ///  Constraints: No constraints specified.
  int get frameHeightPixels => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 70, 0);
  ///  Bit depth of the image, in number of pixels.
  ///  Example: /// Example: 1
  ///  Constraints: No constraints specified.
  int get pixelBitDepth => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 72, 0);
  ///  Reference to an annotation document associated with this image.
  ///  Example: /// Example: annotationKey
  ///  Constraints: Minimum length = 0, Maximum length = 128
  String? get annotationKey => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 74);
  ///  Reference to a calibration document associated with this image.
  ///  Example: /// Example: calibrationKey
  ///  Constraints: Minimum length = 0, Maximum length = 128
  String? get calibrationKey => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 76);
  ///  Name of the uploaded image file.
  ///  Example: /// Example: filename.jpg
  ///  Constraints: Minimum length = 0, Maximum length = 128
  String? get filename => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 78);
  ///  Size of the image file, in bytes.
  ///  Example: /// Example: 371945
  ///  Constraints: No constraints specified.
  int get filesize => const fb.Int64Reader().vTableGet(_bc, _bcOffset, 80, 0);
  ...
  String? get checksumValue => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 82);
  ...
  ///  Example: /// Example: AXE
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get sourceDl => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 94);
  ///  Optional name/description associated with this image.
  ///  Example: /// Example: description
  ///  Constraints: Minimum length = 0, Maximum length = 2147483647
  String? get description => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 96);
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SkyImageryFullDataModeEnum get dataMode => SkyImageryFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 98, 0));
...
class SkyImageryFullBuilder {
  ...
  int addTopLeftStartAz(double? topLeftStartAz) {
    fbBuilder.addFloat64(21, topLeftStartAz);
    return fbBuilder.offset;
  }
  int addTopLeftStartEl(double? topLeftStartEl) {
    fbBuilder.addFloat64(22, topLeftStartEl);
    return fbBuilder.offset;
  }
  int addTopLeftStopAz(double? topLeftStopAz) {
    fbBuilder.addFloat64(23, topLeftStopAz);
    return fbBuilder.offset;
  }
  int addTopLeftStopEl(double? topLeftStopEl) {
    fbBuilder.addFloat64(24, topLeftStopEl);
    return fbBuilder.offset;
  }
  ...
  int addImageSetLength(int? imageSetLength) {
    fbBuilder.addInt32(26, imageSetLength);
    return fbBuilder.offset;
  }
  int addSequenceId(int? sequenceId) {
    fbBuilder.addInt32(27, sequenceId);
    return fbBuilder.offset;
  }
  int addFrameFovwidth(double? frameFovwidth) {
    fbBuilder.addFloat64(28, frameFovwidth);
    return fbBuilder.offset;
  }
  int addFrameFovheight(double? frameFovheight) {
    fbBuilder.addFloat64(29, frameFovheight);
    return fbBuilder.offset;
  }
  int addPixelFovwidth(double? pixelFovwidth) {
    fbBuilder.addFloat64(30, pixelFovwidth);
    return fbBuilder.offset;
  }
  int addPixelFovheight(double? pixelFovheight) {
    fbBuilder.addFloat64(31, pixelFovheight);
    return fbBuilder.offset;
  }
  int addFrameWidthPixels(int? frameWidthPixels) {
    fbBuilder.addInt32(32, frameWidthPixels);
    return fbBuilder.offset;
  }
  int addFrameHeightPixels(int? frameHeightPixels) {
    fbBuilder.addInt32(33, frameHeightPixels);
    return fbBuilder.offset;
  }
  int addPixelBitDepth(int? pixelBitDepth) {
    fbBuilder.addInt32(34, pixelBitDepth);
    return fbBuilder.offset;
  }
  ...
  int addFilesize(int? filesize) {
    fbBuilder.addInt64(38, filesize);
    return fbBuilder.offset;
  }
  ...
  int addDataMode(SkyImageryFullDataModeEnum? dataMode) {
...
class SkyImageryFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SkyImageryFullDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final List<String>? _eoObservations;

  SkyImageryFullObjectBuilder({
    String? id,
    ...
    String? sourceDl,
    String? description,
    SkyImageryFullDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(5, idAttitudeSetOffset);
    ...
    fbBuilder.addOffset(15, senQuatOffset);
    fbBuilder.addOffset(16, senQuatDotOffset);
    fbBuilder.addOffset(17, imageTypeOffset);
    fbBuilder.addOffset(18, expStartTimeOffset);
    fbBuilder.addOffset(19, expEndTimeOffset);
    fbBuilder.addOffset(20, imageSourceInfoOffset);
    fbBuilder.addFloat64(21, _topLeftStartAz);
    fbBuilder.addFloat64(22, _topLeftStartEl);
    fbBuilder.addFloat64(23, _topLeftStopAz);
    fbBuilder.addFloat64(24, _topLeftStopEl);
    fbBuilder.addOffset(25, imageSetIdOffset);
    fbBuilder.addInt32(26, _imageSetLength);
    fbBuilder.addInt32(27, _sequenceId);
    fbBuilder.addFloat64(28, _frameFovwidth);
    fbBuilder.addFloat64(29, _frameFovheight);
    fbBuilder.addFloat64(30, _pixelFovwidth);
    fbBuilder.addFloat64(31, _pixelFovheight);
    fbBuilder.addInt32(32, _frameWidthPixels);
    fbBuilder.addInt32(33, _frameHeightPixels);
    fbBuilder.addInt32(34, _pixelBitDepth);
    fbBuilder.addOffset(35, annotationKeyOffset);
    fbBuilder.addOffset(36, calibrationKeyOffset);
    fbBuilder.addOffset(37, filenameOffset);
    fbBuilder.addInt64(38, _filesize);
    fbBuilder.addOffset(39, checksumValueOffset);
    ...
    fbBuilder.addOffset(45, sourceDlOffset);
    fbBuilder.addOffset(46, descriptionOffset);
    fbBuilder.addInt8(47, _dataMode?.value);
    fbBuilder.addOffset(48, createdAtOffset);
    fbBuilder.addOffset(49, createdByOffset);
    fbBuilder.addOffset(50, eoObservationsOffset);
    return fbBuilder.endTable();
  }
