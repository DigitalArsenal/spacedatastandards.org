...
class SolarArrayDetailsIngestDataModeEnum {
  final int value;
  const SolarArrayDetailsIngestDataModeEnum._(this.value);

  factory SolarArrayDetailsIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SolarArrayDetailsIngestDataModeEnum');
    }
    return result;
  }

  static SolarArrayDetailsIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SolarArrayDetailsIngestDataModeEnum.fromValue(value);
  ...
  static const SolarArrayDetailsIngestDataModeEnum REAL = SolarArrayDetailsIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SolarArrayDetailsIngestDataModeEnum TEST = SolarArrayDetailsIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SolarArrayDetailsIngestDataModeEnum SIMULATED = SolarArrayDetailsIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SolarArrayDetailsIngestDataModeEnum EXERCISE = SolarArrayDetailsIngestDataModeEnum._(3);
  static const Map<int, SolarArrayDetailsIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SolarArrayDetailsIngestDataModeEnum> reader = _SolarArrayDetailsIngestDataModeEnumReader();

  @override
  String toString() {
    return 'SolarArrayDetailsIngestDataModeEnum{value: $value}';
  }
}

class _SolarArrayDetailsIngestDataModeEnumReader extends fb.Reader<SolarArrayDetailsIngestDataModeEnum> {
  const _SolarArrayDetailsIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SolarArrayDetailsIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      SolarArrayDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class SolarArrayDetailsIngest {
  SolarArrayDetailsIngest._(this._bc, this._bcOffset);
  factory SolarArrayDetailsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SolarArrayDetailsIngest> reader = _SolarArrayDetailsIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SolarArrayDetailsIngestDataModeEnum get dataMode => SolarArrayDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 34, 0));
  ///  Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
  ///  Example: /// Example: ['TAG1', 'TAG2']
  ///  Constraints: No constraints specified.
  List<String>? get tags => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 36);

  @override
  String toString() {
    return 'SolarArrayDetailsIngest{id: ${id}, idSolarArray: ${idSolarArray}, classificationMarking: ${classificationMarking}, type: ${type}, technology: ${technology}, junctionTechnology: ${junctionTechnology}, manufacturerOrgId: ${manufacturerOrgId}, span: ${span}, area: ${area}, description: ${description}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, tags: ${tags}}';
  }
}

class _SolarArrayDetailsIngestReader extends fb.TableReader<SolarArrayDetailsIngest> {
  const _SolarArrayDetailsIngestReader();

  @override
  SolarArrayDetailsIngest createObject(fb.BufferContext bc, int offset) => 
    SolarArrayDetailsIngest._(bc, offset);
}

class SolarArrayDetailsIngestBuilder {
  SolarArrayDetailsIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(SolarArrayDetailsIngestDataModeEnum? dataMode) {
...
class SolarArrayDetailsIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SolarArrayDetailsIngestDataModeEnum? _dataMode;
  final List<String>? _tags;

  SolarArrayDetailsIngestObjectBuilder({
    String? id,
    String? idSolarArray,
    ...
    String? origin,
    String? origNetwork,
    SolarArrayDetailsIngestDataModeEnum? dataMode,
    List<String>? tags,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(16, tagsOffset);
    return fbBuilder.endTable();
  }
