...
class AirspaceControlMeansStatusFull {
  AirspaceControlMeansStatusFull._(this._bc, this._bcOffset);
  factory AirspaceControlMeansStatusFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirspaceControlMeansStatusFull> reader = _AirspaceControlMeansStatusFullReader();
  ...
  @override
  String toString() {
    return 'AirspaceControlMeansStatusFull{cmStat: ${cmStat}, cmStatId: ${cmStatId}, airspaceControlMeans: ${airspaceControlMeans}}';
  }
}

class _AirspaceControlMeansStatusFullReader extends fb.TableReader<AirspaceControlMeansStatusFull> {
  const _AirspaceControlMeansStatusFullReader();

  @override
  AirspaceControlMeansStatusFull createObject(fb.BufferContext bc, int offset) => 
    AirspaceControlMeansStatusFull._(bc, offset);
}

class AirspaceControlMeansStatusFullBuilder {
  AirspaceControlMeansStatusFullBuilder(this.fbBuilder);
...
class AirspaceControlMeansStatusFullObjectBuilder extends fb.ObjectBuilder {
  final String? _cmStat;
  final List<String>? _cmStatId;
  final List<String>? _airspaceControlMeans;

  AirspaceControlMeansStatusFullObjectBuilder({
    String? cmStat,
