...
class GnssrawIfAbridgedDataModeEnum {
  final int value;
  const GnssrawIfAbridgedDataModeEnum._(this.value);

  factory GnssrawIfAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum GnssrawIfAbridgedDataModeEnum');
    }
    return result;
  }

  static GnssrawIfAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : GnssrawIfAbridgedDataModeEnum.fromValue(value);
  ...
  static const GnssrawIfAbridgedDataModeEnum REAL = GnssrawIfAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const GnssrawIfAbridgedDataModeEnum TEST = GnssrawIfAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const GnssrawIfAbridgedDataModeEnum SIMULATED = GnssrawIfAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const GnssrawIfAbridgedDataModeEnum EXERCISE = GnssrawIfAbridgedDataModeEnum._(3);
  static const Map<int, GnssrawIfAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<GnssrawIfAbridgedDataModeEnum> reader = _GnssrawIfAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'GnssrawIfAbridgedDataModeEnum{value: $value}';
  }
}

class _GnssrawIfAbridgedDataModeEnumReader extends fb.Reader<GnssrawIfAbridgedDataModeEnum> {
  const _GnssrawIfAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  GnssrawIfAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      GnssrawIfAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class GnssrawIfAbridged {
  GnssrawIfAbridged._(this._bc, this._bcOffset);
  factory GnssrawIfAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<GnssrawIfAbridged> reader = _GnssrawIfAbridgedReader();
  ...
  GnssrawIfAbridgedDataModeEnum get dataMode => GnssrawIfAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 80, 0));
...
class GnssrawIfAbridgedBuilder {
  ...
  int addDataMode(GnssrawIfAbridgedDataModeEnum? dataMode) {
...
class GnssrawIfAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final GnssrawIfAbridgedDataModeEnum? _dataMode;
  final String? _origNetwork;

  GnssrawIfAbridgedObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    GnssrawIfAbridgedDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
