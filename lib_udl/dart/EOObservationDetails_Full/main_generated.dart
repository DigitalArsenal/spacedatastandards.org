...
class EoobservationDetailsFullDataModeEnum {
  final int value;
  const EoobservationDetailsFullDataModeEnum._(this.value);

  factory EoobservationDetailsFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EoobservationDetailsFullDataModeEnum');
    }
    return result;
  }

  static EoobservationDetailsFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EoobservationDetailsFullDataModeEnum.fromValue(value);
  ...
  static const EoobservationDetailsFullDataModeEnum REAL = EoobservationDetailsFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EoobservationDetailsFullDataModeEnum TEST = EoobservationDetailsFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EoobservationDetailsFullDataModeEnum SIMULATED = EoobservationDetailsFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EoobservationDetailsFullDataModeEnum EXERCISE = EoobservationDetailsFullDataModeEnum._(3);
  static const Map<int, EoobservationDetailsFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EoobservationDetailsFullDataModeEnum> reader = _EoobservationDetailsFullDataModeEnumReader();

  @override
  String toString() {
    return 'EoobservationDetailsFullDataModeEnum{value: $value}';
  }
}

class _EoobservationDetailsFullDataModeEnumReader extends fb.Reader<EoobservationDetailsFullDataModeEnum> {
  const _EoobservationDetailsFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EoobservationDetailsFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      EoobservationDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Model representation of additional detailed observation data for electro-optical based sensor phenomenologies.
class EoobservationDetailsFull {
  EoobservationDetailsFull._(this._bc, this._bcOffset);
  factory EoobservationDetailsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EoobservationDetailsFull> reader = _EoobservationDetailsFullReader();
  ...
  EoobservationDetailsFullDataModeEnum get dataMode => EoobservationDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 164, 0));
...
class EoobservationDetailsFullBuilder {
  ...
  int addDataMode(EoobservationDetailsFullDataModeEnum? dataMode) {
...
class EoobservationDetailsFullObjectBuilder extends fb.ObjectBuilder {
  ...
  final EoobservationDetailsFullDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;

  EoobservationDetailsFullObjectBuilder({
    ...
    double? does,
    String? source,
    EoobservationDetailsFullDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
  })
