...
class LogisticsPartsIngest {
  LogisticsPartsIngest._(this._bc, this._bcOffset);
  factory LogisticsPartsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LogisticsPartsIngest> reader = _LogisticsPartsIngestReader();
  ...
  @override
  String toString() {
    return 'LogisticsPartsIngest{partNumber: ${partNumber}, nationalStockNumber: ${nationalStockNumber}, measurementUnitCode: ${measurementUnitCode}, workUnitCode: ${workUnitCode}, technicalOrderText: ${technicalOrderText}, figureNumber: ${figureNumber}, indexNumber: ${indexNumber}, requestVerifier: ${requestVerifier}, locationVerifier: ${locationVerifier}, supplyDocumentNumber: ${supplyDocumentNumber}, logisticsStocks: ${logisticsStocks}}';
  }
}

class _LogisticsPartsIngestReader extends fb.TableReader<LogisticsPartsIngest> {
  const _LogisticsPartsIngestReader();

  @override
  LogisticsPartsIngest createObject(fb.BufferContext bc, int offset) => 
    LogisticsPartsIngest._(bc, offset);
}

class LogisticsPartsIngestBuilder {
  LogisticsPartsIngestBuilder(this.fbBuilder);
...
class LogisticsPartsIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  LogisticsPartsIngestObjectBuilder({
    String? partNumber,
