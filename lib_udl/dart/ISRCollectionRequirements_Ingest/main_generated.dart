...
class IsrcollectionRequirementsIngest {
  IsrcollectionRequirementsIngest._(this._bc, this._bcOffset);
  factory IsrcollectionRequirementsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IsrcollectionRequirementsIngest> reader = _IsrcollectionRequirementsIngestReader();
  ...
  @override
  String toString() {
    return 'IsrcollectionRequirementsIngest{id: ${id}, hash: ${hash}, type: ${type}, cridNumbers: ${cridNumbers}, priority: ${priority}, recordId: ${recordId}, reconSurvey: ${reconSurvey}, intelDiscipline: ${intelDiscipline}, secondary: ${secondary}, emphasized: ${emphasized}, isPrismCr: ${isPrismCr}, start: ${start}, stop: ${stop}, operation: ${operation}, supportedUnit: ${supportedUnit}, country: ${country}, region: ${region}, subregion: ${subregion}, specialComGuidance: ${specialComGuidance}, criticalTimes: ${criticalTimes}, exploitationRequirement: ${exploitationRequirement}, targetList: ${targetList}}';
  }
}

class _IsrcollectionRequirementsIngestReader extends fb.TableReader<IsrcollectionRequirementsIngest> {
  const _IsrcollectionRequirementsIngestReader();

  @override
  IsrcollectionRequirementsIngest createObject(fb.BufferContext bc, int offset) => 
    IsrcollectionRequirementsIngest._(bc, offset);
}

class IsrcollectionRequirementsIngestBuilder {
  IsrcollectionRequirementsIngestBuilder(this.fbBuilder);
...
class IsrcollectionRequirementsIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _hash;
  final String? _type;
  ...
  IsrcollectionRequirementsIngestObjectBuilder({
    String? id,
    String? hash,
    String? type,
    String? cridNumbers,
