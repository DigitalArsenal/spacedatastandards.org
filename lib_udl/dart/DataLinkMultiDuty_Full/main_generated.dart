...
class DataLinkMultiDutyFull {
  DataLinkMultiDutyFull._(this._bc, this._bcOffset);
  factory DataLinkMultiDutyFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DataLinkMultiDutyFull> reader = _DataLinkMultiDutyFullReader();
  ...
  @override
  String toString() {
    return 'DataLinkMultiDutyFull{unitDes: ${unitDes}, name: ${name}, rank: ${rank}, duty: ${duty}, dutyTeleFreqNums: ${dutyTeleFreqNums}, multiDutyVoiceCoord: ${multiDutyVoiceCoord}}';
  }
}

class _DataLinkMultiDutyFullReader extends fb.TableReader<DataLinkMultiDutyFull> {
  const _DataLinkMultiDutyFullReader();

  @override
  DataLinkMultiDutyFull createObject(fb.BufferContext bc, int offset) => 
    DataLinkMultiDutyFull._(bc, offset);
}

class DataLinkMultiDutyFullBuilder {
  DataLinkMultiDutyFullBuilder(this.fbBuilder);
...
class DataLinkMultiDutyFullObjectBuilder extends fb.ObjectBuilder {
  ...
  DataLinkMultiDutyFullObjectBuilder({
    String? unitDes,
    String? name,
    String? rank,
    String? duty,
