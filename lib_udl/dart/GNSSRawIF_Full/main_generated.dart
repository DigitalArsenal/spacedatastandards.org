...
class GnssrawIfFullDataModeEnum {
  final int value;
  const GnssrawIfFullDataModeEnum._(this.value);

  factory GnssrawIfFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum GnssrawIfFullDataModeEnum');
    }
    return result;
  }

  static GnssrawIfFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : GnssrawIfFullDataModeEnum.fromValue(value);
  ...
  static const GnssrawIfFullDataModeEnum REAL = GnssrawIfFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const GnssrawIfFullDataModeEnum TEST = GnssrawIfFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const GnssrawIfFullDataModeEnum SIMULATED = GnssrawIfFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const GnssrawIfFullDataModeEnum EXERCISE = GnssrawIfFullDataModeEnum._(3);
  static const Map<int, GnssrawIfFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<GnssrawIfFullDataModeEnum> reader = _GnssrawIfFullDataModeEnumReader();

  @override
  String toString() {
    return 'GnssrawIfFullDataModeEnum{value: $value}';
  }
}

class _GnssrawIfFullDataModeEnumReader extends fb.Reader<GnssrawIfFullDataModeEnum> {
  const _GnssrawIfFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  GnssrawIfFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      GnssrawIfFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class GnssrawIfFull {
  GnssrawIfFull._(this._bc, this._bcOffset);
  factory GnssrawIfFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<GnssrawIfFull> reader = _GnssrawIfFullReader();
  ...
  GnssrawIfFullDataModeEnum get dataMode => GnssrawIfFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 80, 0));
...
class GnssrawIfFullBuilder {
  ...
  int addDataMode(GnssrawIfFullDataModeEnum? dataMode) {
...
class GnssrawIfFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final GnssrawIfFullDataModeEnum? _dataMode;
  final String? _origNetwork;

  GnssrawIfFullObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    GnssrawIfFullDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
