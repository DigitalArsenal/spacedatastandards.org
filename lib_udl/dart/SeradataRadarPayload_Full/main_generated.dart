...
class SeradataRadarPayloadFullDataModeEnum {
  final int value;
  const SeradataRadarPayloadFullDataModeEnum._(this.value);

  factory SeradataRadarPayloadFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SeradataRadarPayloadFullDataModeEnum');
    }
    return result;
  }

  static SeradataRadarPayloadFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SeradataRadarPayloadFullDataModeEnum.fromValue(value);
  ...
  static const SeradataRadarPayloadFullDataModeEnum REAL = SeradataRadarPayloadFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SeradataRadarPayloadFullDataModeEnum TEST = SeradataRadarPayloadFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SeradataRadarPayloadFullDataModeEnum SIMULATED = SeradataRadarPayloadFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SeradataRadarPayloadFullDataModeEnum EXERCISE = SeradataRadarPayloadFullDataModeEnum._(3);
  static const Map<int, SeradataRadarPayloadFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SeradataRadarPayloadFullDataModeEnum> reader = _SeradataRadarPayloadFullDataModeEnumReader();

  @override
  String toString() {
    return 'SeradataRadarPayloadFullDataModeEnum{value: $value}';
  }
}

class _SeradataRadarPayloadFullDataModeEnumReader extends fb.Reader<SeradataRadarPayloadFullDataModeEnum> {
  const _SeradataRadarPayloadFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SeradataRadarPayloadFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      SeradataRadarPayloadFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Details for an radar payload from  Seradata.
class SeradataRadarPayloadFull {
  SeradataRadarPayloadFull._(this._bc, this._bcOffset);
  factory SeradataRadarPayloadFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SeradataRadarPayloadFull> reader = _SeradataRadarPayloadFullReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SeradataRadarPayloadFullDataModeEnum get dataMode => SeradataRadarPayloadFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 70, 0));

  @override
  String toString() {
    return 'SeradataRadarPayloadFull{id: ${id}, classificationMarking: ${classificationMarking}, spacecraftId: ${spacecraftId}, idSensor: ${idSensor}, hostedForCompanyOrgId: ${hostedForCompanyOrgId}, manufacturerOrgId: ${manufacturerOrgId}, category: ${category}, name: ${name}, frequencyBand: ${frequencyBand}, frequency: ${frequency}, waveLength: ${waveLength}, bestResolution: ${bestResolution}, swathWidth: ${swathWidth}, recorderSize: ${recorderSize}, fieldOfView: ${fieldOfView}, fieldOfRegard: ${fieldOfRegard}, pointingMethod: ${pointingMethod}, groundStations: ${groundStations}, groundStationLocations: ${groundStationLocations}, transmitPolarization: ${transmitPolarization}, receivePolarization: ${receivePolarization}, dutyCycle: ${dutyCycle}, partnerSpacecraft: ${partnerSpacecraft}, constellationInterferometricCapability: ${constellationInterferometricCapability}, notes: ${notes}, bandwidth: ${bandwidth}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _SeradataRadarPayloadFullReader extends fb.TableReader<SeradataRadarPayloadFull> {
  const _SeradataRadarPayloadFullReader();

  @override
  SeradataRadarPayloadFull createObject(fb.BufferContext bc, int offset) => 
    SeradataRadarPayloadFull._(bc, offset);
}

class SeradataRadarPayloadFullBuilder {
  SeradataRadarPayloadFullBuilder(this.fbBuilder);
  ...
  int addDataMode(SeradataRadarPayloadFullDataModeEnum? dataMode) {
...
class SeradataRadarPayloadFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SeradataRadarPayloadFullDataModeEnum? _dataMode;

  SeradataRadarPayloadFullObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    SeradataRadarPayloadFullDataModeEnum? dataMode,
  })
      : _id = id,
