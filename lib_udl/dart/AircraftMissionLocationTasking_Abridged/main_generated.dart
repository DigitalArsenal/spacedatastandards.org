...
class AircraftMissionLocationTaskingAbridged {
  AircraftMissionLocationTaskingAbridged._(this._bc, this._bcOffset);
  factory AircraftMissionLocationTaskingAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AircraftMissionLocationTaskingAbridged> reader = _AircraftMissionLocationTaskingAbridgedReader();
  ...
  @override
  String toString() {
    return 'AircraftMissionLocationTaskingAbridged{startTime: ${startTime}, endTime: ${endTime}, msnLocName: ${msnLocName}, alt: ${alt}, airMsnPri: ${airMsnPri}, areaGeoRad: ${areaGeoRad}, msnLocPtName: ${msnLocPtName}, msnLocPtLat: ${msnLocPtLat}, msnLocPtLon: ${msnLocPtLon}, msnLocPtBarT: ${msnLocPtBarT}}';
  }
}

class _AircraftMissionLocationTaskingAbridgedReader extends fb.TableReader<AircraftMissionLocationTaskingAbridged> {
  const _AircraftMissionLocationTaskingAbridgedReader();

  @override
  AircraftMissionLocationTaskingAbridged createObject(fb.BufferContext bc, int offset) => 
    AircraftMissionLocationTaskingAbridged._(bc, offset);
}

class AircraftMissionLocationTaskingAbridgedBuilder {
  AircraftMissionLocationTaskingAbridgedBuilder(this.fbBuilder);
...
class AircraftMissionLocationTaskingAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  AircraftMissionLocationTaskingAbridgedObjectBuilder({
    String? startTime,
    String? endTime,
    String? msnLocName,
    int? alt,
