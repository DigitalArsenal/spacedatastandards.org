...
class WeatherDataFullDataModeEnum {
  final int value;
  const WeatherDataFullDataModeEnum._(this.value);

  factory WeatherDataFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum WeatherDataFullDataModeEnum');
    }
    return result;
  }

  static WeatherDataFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : WeatherDataFullDataModeEnum.fromValue(value);
  ...
  static const WeatherDataFullDataModeEnum REAL = WeatherDataFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const WeatherDataFullDataModeEnum TEST = WeatherDataFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const WeatherDataFullDataModeEnum SIMULATED = WeatherDataFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const WeatherDataFullDataModeEnum EXERCISE = WeatherDataFullDataModeEnum._(3);
  static const Map<int, WeatherDataFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<WeatherDataFullDataModeEnum> reader = _WeatherDataFullDataModeEnumReader();

  @override
  String toString() {
    return 'WeatherDataFullDataModeEnum{value: $value}';
  }
}

class _WeatherDataFullDataModeEnumReader extends fb.Reader<WeatherDataFullDataModeEnum> {
  const _WeatherDataFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  WeatherDataFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      WeatherDataFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class WeatherDataFull {
  WeatherDataFull._(this._bc, this._bcOffset);
  factory WeatherDataFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<WeatherDataFull> reader = _WeatherDataFullReader();
...
class WeatherDataFullBuilder {
  ...
  int addDataMode(WeatherDataFullDataModeEnum? dataMode) {
...
class WeatherDataFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final WeatherDataFullDataModeEnum? _dataMode;

  WeatherDataFullObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    WeatherDataFullDataModeEnum? dataMode,
  })
      : _id = id,
