...
class PortIngestDataModeEnum {
  final int value;
  const PortIngestDataModeEnum._(this.value);

  factory PortIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum PortIngestDataModeEnum');
    }
    return result;
  }

  static PortIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : PortIngestDataModeEnum.fromValue(value);
  ...
  static const PortIngestDataModeEnum REAL = PortIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const PortIngestDataModeEnum TEST = PortIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const PortIngestDataModeEnum SIMULATED = PortIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const PortIngestDataModeEnum EXERCISE = PortIngestDataModeEnum._(3);
  static const Map<int, PortIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<PortIngestDataModeEnum> reader = _PortIngestDataModeEnumReader();

  @override
  String toString() {
    return 'PortIngestDataModeEnum{value: $value}';
  }
}

class _PortIngestDataModeEnumReader extends fb.Reader<PortIngestDataModeEnum> {
  const _PortIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  PortIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      PortIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Properties and characteristics of a maritime port, which includes location, port identifiers, and remarks.
class PortIngest {
  PortIngest._(this._bc, this._bcOffset);
  factory PortIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PortIngest> reader = _PortIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 64
  PortIngestDataModeEnum get dataMode => PortIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 44, 0));
  ...
  @override
  String toString() {
    return 'PortIngest{id: ${id}, classificationMarking: ${classificationMarking}, idSite: ${idSite}, externalId: ${externalId}, locode: ${locode}, portName: ${portName}, harborType: ${harborType}, harborSize: ${harborSize}, maxDraught: ${maxDraught}, avgDuration: ${avgDuration}, tideRange: ${tideRange}, shelter: ${shelter}, pilotReqd: ${pilotReqd}, lat: ${lat}, lon: ${lon}, countryCode: ${countryCode}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, origNetwork: ${origNetwork}}';
  }
}

class _PortIngestReader extends fb.TableReader<PortIngest> {
  const _PortIngestReader();

  @override
  PortIngest createObject(fb.BufferContext bc, int offset) => 
    PortIngest._(bc, offset);
}

class PortIngestBuilder {
  PortIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(PortIngestDataModeEnum? dataMode) {
...
class PortIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final PortIngestDataModeEnum? _dataMode;
  final String? _origNetwork;

  PortIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    PortIngestDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
