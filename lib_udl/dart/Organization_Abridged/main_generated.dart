...
class OrganizationAbridgedDataModeEnum {
  final int value;
  const OrganizationAbridgedDataModeEnum._(this.value);

  factory OrganizationAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OrganizationAbridgedDataModeEnum');
    }
    return result;
  }

  static OrganizationAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OrganizationAbridgedDataModeEnum.fromValue(value);
  ...
  static const OrganizationAbridgedDataModeEnum REAL = OrganizationAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OrganizationAbridgedDataModeEnum TEST = OrganizationAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OrganizationAbridgedDataModeEnum SIMULATED = OrganizationAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OrganizationAbridgedDataModeEnum EXERCISE = OrganizationAbridgedDataModeEnum._(3);
  static const Map<int, OrganizationAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OrganizationAbridgedDataModeEnum> reader = _OrganizationAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'OrganizationAbridgedDataModeEnum{value: $value}';
  }
}

class _OrganizationAbridgedDataModeEnumReader extends fb.Reader<OrganizationAbridgedDataModeEnum> {
  const _OrganizationAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OrganizationAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      OrganizationAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
