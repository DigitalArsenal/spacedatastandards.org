...
class SensorMaintenanceIngestDataModeEnum {
  final int value;
  const SensorMaintenanceIngestDataModeEnum._(this.value);

  factory SensorMaintenanceIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SensorMaintenanceIngestDataModeEnum');
    }
    return result;
  }

  static SensorMaintenanceIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SensorMaintenanceIngestDataModeEnum.fromValue(value);
  ...
  static const SensorMaintenanceIngestDataModeEnum REAL = SensorMaintenanceIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SensorMaintenanceIngestDataModeEnum TEST = SensorMaintenanceIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SensorMaintenanceIngestDataModeEnum SIMULATED = SensorMaintenanceIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SensorMaintenanceIngestDataModeEnum EXERCISE = SensorMaintenanceIngestDataModeEnum._(3);
  static const Map<int, SensorMaintenanceIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SensorMaintenanceIngestDataModeEnum> reader = _SensorMaintenanceIngestDataModeEnumReader();

  @override
  String toString() {
    return 'SensorMaintenanceIngestDataModeEnum{value: $value}';
  }
}

class _SensorMaintenanceIngestDataModeEnumReader extends fb.Reader<SensorMaintenanceIngestDataModeEnum> {
  const _SensorMaintenanceIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SensorMaintenanceIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      SensorMaintenanceIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Maintenance schedule and operational status of Sensor.
class SensorMaintenanceIngest {
  SensorMaintenanceIngest._(this._bc, this._bcOffset);
  factory SensorMaintenanceIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SensorMaintenanceIngest> reader = _SensorMaintenanceIngestReader();
  ...
  SensorMaintenanceIngestDataModeEnum get dataMode => SensorMaintenanceIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 62, 0));
...
class SensorMaintenanceIngestBuilder {
  ...
  int addDataMode(SensorMaintenanceIngestDataModeEnum? dataMode) {
...
class SensorMaintenanceIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SensorMaintenanceIngestDataModeEnum? _dataMode;
  final String? _origNetwork;

  SensorMaintenanceIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    SensorMaintenanceIngestDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
