...
class FlightPlanAirRefuelEventsFull {
  FlightPlanAirRefuelEventsFull._(this._bc, this._bcOffset);
  factory FlightPlanAirRefuelEventsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<FlightPlanAirRefuelEventsFull> reader = _FlightPlanAirRefuelEventsFullReader();
  ...
  @override
  String toString() {
    return 'FlightPlanAirRefuelEventsFull{arDegrade: ${arDegrade}, arNum: ${arNum}, arExchangedFuel: ${arExchangedFuel}, divertFuel: ${divertFuel}, exitFuel: ${exitFuel}}';
  }
}

class _FlightPlanAirRefuelEventsFullReader extends fb.TableReader<FlightPlanAirRefuelEventsFull> {
  const _FlightPlanAirRefuelEventsFullReader();

  @override
  FlightPlanAirRefuelEventsFull createObject(fb.BufferContext bc, int offset) => 
    FlightPlanAirRefuelEventsFull._(bc, offset);
}

class FlightPlanAirRefuelEventsFullBuilder {
  FlightPlanAirRefuelEventsFullBuilder(this.fbBuilder);
...
class FlightPlanAirRefuelEventsFullObjectBuilder extends fb.ObjectBuilder {
  ...
  FlightPlanAirRefuelEventsFullObjectBuilder({
    double? arDegrade,
    int? arNum,
