...
///  /// Array of Doppler.
class IonoObservationDopplerFull {
  IonoObservationDopplerFull._(this._bc, this._bcOffset);
  factory IonoObservationDopplerFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationDopplerFull> reader = _IonoObservationDopplerFullReader();
  ...
  @override
  String toString() {
    return 'IonoObservationDopplerFull{notes: ${notes}, dimensions: ${dimensions}, dimensionName: ${dimensionName}, data: ${data}}';
  }
}

class _IonoObservationDopplerFullReader extends fb.TableReader<IonoObservationDopplerFull> {
  const _IonoObservationDopplerFullReader();

  @override
  IonoObservationDopplerFull createObject(fb.BufferContext bc, int offset) => 
    IonoObservationDopplerFull._(bc, offset);
}

class IonoObservationDopplerFullBuilder {
  IonoObservationDopplerFullBuilder(this.fbBuilder);
...
class IonoObservationDopplerFullObjectBuilder extends fb.ObjectBuilder {
  final String? _notes;
  final List<String>? _dimensions;
  final List<String>? _dimensionName;
  final List<String>? _data;

  IonoObservationDopplerFullObjectBuilder({
    String? notes,
