...
class GnssobservationIngest {
  GnssobservationIngest._(this._bc, this._bcOffset);
  factory GnssobservationIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<GnssobservationIngest> reader = _GnssobservationIngestReader();
  ...
  @override
  String toString() {
    return 'GnssobservationIngest{gnssSatId: ${gnssSatId}, trackingStatus: ${trackingStatus}, agcState: ${agcState}, obsCodeSet: ${obsCodeSet}, ob: ${ob}}';
  }
}

class _GnssobservationIngestReader extends fb.TableReader<GnssobservationIngest> {
  const _GnssobservationIngestReader();

  @override
  GnssobservationIngest createObject(fb.BufferContext bc, int offset) => 
    GnssobservationIngest._(bc, offset);
}

class GnssobservationIngestBuilder {
  GnssobservationIngestBuilder(this.fbBuilder);
...
class GnssobservationIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  GnssobservationIngestObjectBuilder({
    String? gnssSatId,
    int? trackingStatus,
    int? agcState,
