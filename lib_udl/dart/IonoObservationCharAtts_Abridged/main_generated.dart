...
class IonoObservationCharAttsAbridged {
  IonoObservationCharAttsAbridged._(this._bc, this._bcOffset);
  factory IonoObservationCharAttsAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationCharAttsAbridged> reader = _IonoObservationCharAttsAbridgedReader();
  ...
  @override
  String toString() {
    return 'IonoObservationCharAttsAbridged{ursiId: ${ursiId}, charName: ${charName}, lowerBound: ${lowerBound}, upperBound: ${upperBound}, q: ${q}, d: ${d}, climateModelName: ${climateModelName}, climateModelOptions: ${climateModelOptions}, climateModelInputParams: ${climateModelInputParams}, uncertaintyBoundType: ${uncertaintyBoundType}}';
  }
}

class _IonoObservationCharAttsAbridgedReader extends fb.TableReader<IonoObservationCharAttsAbridged> {
  const _IonoObservationCharAttsAbridgedReader();

  @override
  IonoObservationCharAttsAbridged createObject(fb.BufferContext bc, int offset) => 
    IonoObservationCharAttsAbridged._(bc, offset);
}

class IonoObservationCharAttsAbridgedBuilder {
  IonoObservationCharAttsAbridgedBuilder(this.fbBuilder);
...
class IonoObservationCharAttsAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  IonoObservationCharAttsAbridgedObjectBuilder({
    String? ursiId,
    String? charName,
    double? lowerBound,
    double? upperBound,
