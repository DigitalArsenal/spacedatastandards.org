...
class CrewAbridgedDataModeEnum {
  final int value;
  const CrewAbridgedDataModeEnum._(this.value);

  factory CrewAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum CrewAbridgedDataModeEnum');
    }
    return result;
  }

  static CrewAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : CrewAbridgedDataModeEnum.fromValue(value);
  ...
  static const CrewAbridgedDataModeEnum REAL = CrewAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const CrewAbridgedDataModeEnum TEST = CrewAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const CrewAbridgedDataModeEnum SIMULATED = CrewAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const CrewAbridgedDataModeEnum EXERCISE = CrewAbridgedDataModeEnum._(3);
  static const Map<int, CrewAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<CrewAbridgedDataModeEnum> reader = _CrewAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'CrewAbridgedDataModeEnum{value: $value}';
  }
}

class _CrewAbridgedDataModeEnumReader extends fb.Reader<CrewAbridgedDataModeEnum> {
  const _CrewAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  CrewAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      CrewAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Crew Services.
class CrewAbridged {
  CrewAbridged._(this._bc, this._bcOffset);
  factory CrewAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<CrewAbridged> reader = _CrewAbridgedReader();
  ...
  CrewAbridgedDataModeEnum get dataMode => CrewAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 48, 0));

  @override
  String toString() {
    return 'CrewAbridged{id: ${id}, classificationMarking: ${classificationMarking}, origCrewId: ${origCrewId}, crewName: ${crewName}, status: ${status}, idSortie: ${idSortie}, legalAlertTime: ${legalAlertTime}, legalBravoTime: ${legalBravoTime}, alertedTime: ${alertedTime}, returnTime: ${returnTime}, fdpEligType: ${fdpEligType}, fdpType: ${fdpType}, crewType: ${crewType}, armsCrewUnit: ${armsCrewUnit}, crewMembers: ${crewMembers}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _CrewAbridgedReader extends fb.TableReader<CrewAbridged> {
  const _CrewAbridgedReader();

  @override
  CrewAbridged createObject(fb.BufferContext bc, int offset) => 
    CrewAbridged._(bc, offset);
}

class CrewAbridgedBuilder {
  CrewAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(CrewAbridgedDataModeEnum? dataMode) {
...
class CrewAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final CrewAbridgedDataModeEnum? _dataMode;

  CrewAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    CrewAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
