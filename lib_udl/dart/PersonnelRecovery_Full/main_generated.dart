...
class PersonnelRecoveryFullDataModeEnum {
  final int value;
  const PersonnelRecoveryFullDataModeEnum._(this.value);

  factory PersonnelRecoveryFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum PersonnelRecoveryFullDataModeEnum');
    }
    return result;
  }

  static PersonnelRecoveryFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : PersonnelRecoveryFullDataModeEnum.fromValue(value);
  ...
  static const PersonnelRecoveryFullDataModeEnum REAL = PersonnelRecoveryFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const PersonnelRecoveryFullDataModeEnum TEST = PersonnelRecoveryFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const PersonnelRecoveryFullDataModeEnum SIMULATED = PersonnelRecoveryFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const PersonnelRecoveryFullDataModeEnum EXERCISE = PersonnelRecoveryFullDataModeEnum._(3);
  static const Map<int, PersonnelRecoveryFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<PersonnelRecoveryFullDataModeEnum> reader = _PersonnelRecoveryFullDataModeEnumReader();

  @override
  String toString() {
    return 'PersonnelRecoveryFullDataModeEnum{value: $value}';
  }
}

class _PersonnelRecoveryFullDataModeEnumReader extends fb.Reader<PersonnelRecoveryFullDataModeEnum> {
  const _PersonnelRecoveryFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  PersonnelRecoveryFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      PersonnelRecoveryFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Provides information concerning search and rescue operations and other situations involving personnel recovery.
class PersonnelRecoveryFull {
  PersonnelRecoveryFull._(this._bc, this._bcOffset);
  factory PersonnelRecoveryFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PersonnelRecoveryFull> reader = _PersonnelRecoveryFullReader();
...
class PersonnelRecoveryFullBuilder {
  ...
  int addDataMode(PersonnelRecoveryFullDataModeEnum? dataMode) {
...
class PersonnelRecoveryFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final PersonnelRecoveryFullDataModeEnum? _dataMode;

  PersonnelRecoveryFullObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    PersonnelRecoveryFullDataModeEnum? dataMode,
  })
      : _id = id,
