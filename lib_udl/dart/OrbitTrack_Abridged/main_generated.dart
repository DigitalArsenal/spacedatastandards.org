...
class OrbitTrackAbridgedObjIdentEnum {
  final int value;
  const OrbitTrackAbridgedObjIdentEnum._(this.value);

  factory OrbitTrackAbridgedObjIdentEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OrbitTrackAbridgedObjIdentEnum');
    }
    return result;
  }

  static OrbitTrackAbridgedObjIdentEnum? _createOrNull(int? value) => 
      value == null ? null : OrbitTrackAbridgedObjIdentEnum.fromValue(value);
  ...
  static const OrbitTrackAbridgedObjIdentEnum ASSUMED_FRIEND = OrbitTrackAbridgedObjIdentEnum._(0);

  ///  Track object supporting friendly forces and belonging to a declared friendly nation or entity.
  static const OrbitTrackAbridgedObjIdentEnum FRIEND = OrbitTrackAbridgedObjIdentEnum._(1);
  ...
  static const OrbitTrackAbridgedObjIdentEnum HOSTILE = OrbitTrackAbridgedObjIdentEnum._(2);
  ...
  static const OrbitTrackAbridgedObjIdentEnum NEUTRAL = OrbitTrackAbridgedObjIdentEnum._(3);

  ///  Track object which has not been evaluated.
  static const OrbitTrackAbridgedObjIdentEnum PENDING = OrbitTrackAbridgedObjIdentEnum._(4);

  ///  Track object deemed potentially hostile due to the object characteristics, behavior, nationality, and/or origin.
  static const OrbitTrackAbridgedObjIdentEnum SUSPECT = OrbitTrackAbridgedObjIdentEnum._(5);

  ///  Track object which has been evaluated and does not meet criteria for any standard identity.
  static const OrbitTrackAbridgedObjIdentEnum UNKNOWN = OrbitTrackAbridgedObjIdentEnum._(6);
  static const Map<int, OrbitTrackAbridgedObjIdentEnum> values = {
    0: ASSUMED_FRIEND,
    1: FRIEND,
    2: HOSTILE,
    3: NEUTRAL,
  ...
  static const fb.Reader<OrbitTrackAbridgedObjIdentEnum> reader = _OrbitTrackAbridgedObjIdentEnumReader();

  @override
  String toString() {
    return 'OrbitTrackAbridgedObjIdentEnum{value: $value}';
  }
}

class _OrbitTrackAbridgedObjIdentEnumReader extends fb.Reader<OrbitTrackAbridgedObjIdentEnum> {
  const _OrbitTrackAbridgedObjIdentEnumReader();

  @override
  int get size => 1;

  @override
  OrbitTrackAbridgedObjIdentEnum read(fb.BufferContext bc, int offset) =>
      OrbitTrackAbridgedObjIdentEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class OrbitTrackAbridgedObjectTypeEnum {
  final int value;
  const OrbitTrackAbridgedObjectTypeEnum._(this.value);

  factory OrbitTrackAbridgedObjectTypeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OrbitTrackAbridgedObjectTypeEnum');
    }
    return result;
  }

  static OrbitTrackAbridgedObjectTypeEnum? _createOrNull(int? value) => 
      value == null ? null : OrbitTrackAbridgedObjectTypeEnum.fromValue(value);
  ...
  static const OrbitTrackAbridgedObjectTypeEnum DEBRIS = OrbitTrackAbridgedObjectTypeEnum._(0);

  ///  No description available.
  static const OrbitTrackAbridgedObjectTypeEnum MANNED = OrbitTrackAbridgedObjectTypeEnum._(1);

  ///  No description available.
  static const OrbitTrackAbridgedObjectTypeEnum PAYLOAD = OrbitTrackAbridgedObjectTypeEnum._(2);

  ///  No description available.
  static const OrbitTrackAbridgedObjectTypeEnum PLATFORM = OrbitTrackAbridgedObjectTypeEnum._(3);

  ///  No description available.
  static const OrbitTrackAbridgedObjectTypeEnum ROCKET_BODY = OrbitTrackAbridgedObjectTypeEnum._(4);

  ///  No description available.
  static const OrbitTrackAbridgedObjectTypeEnum UNKNOWN = OrbitTrackAbridgedObjectTypeEnum._(5);
  static const Map<int, OrbitTrackAbridgedObjectTypeEnum> values = {
    0: DEBRIS,
    1: MANNED,
    2: PAYLOAD,
    3: PLATFORM,
  ...
  static const fb.Reader<OrbitTrackAbridgedObjectTypeEnum> reader = _OrbitTrackAbridgedObjectTypeEnumReader();

  @override
  String toString() {
    return 'OrbitTrackAbridgedObjectTypeEnum{value: $value}';
  }
}

class _OrbitTrackAbridgedObjectTypeEnumReader extends fb.Reader<OrbitTrackAbridgedObjectTypeEnum> {
  const _OrbitTrackAbridgedObjectTypeEnumReader();

  @override
  int get size => 1;

  @override
  OrbitTrackAbridgedObjectTypeEnum read(fb.BufferContext bc, int offset) =>
      OrbitTrackAbridgedObjectTypeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class OrbitTrackAbridgedDataModeEnum {
  final int value;
  const OrbitTrackAbridgedDataModeEnum._(this.value);

  factory OrbitTrackAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OrbitTrackAbridgedDataModeEnum');
    }
    return result;
  }

  static OrbitTrackAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OrbitTrackAbridgedDataModeEnum.fromValue(value);
  ...
  static const OrbitTrackAbridgedDataModeEnum REAL = OrbitTrackAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OrbitTrackAbridgedDataModeEnum TEST = OrbitTrackAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OrbitTrackAbridgedDataModeEnum SIMULATED = OrbitTrackAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OrbitTrackAbridgedDataModeEnum EXERCISE = OrbitTrackAbridgedDataModeEnum._(3);
  static const Map<int, OrbitTrackAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OrbitTrackAbridgedDataModeEnum> reader = _OrbitTrackAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'OrbitTrackAbridgedDataModeEnum{value: $value}';
  }
}

class _OrbitTrackAbridgedDataModeEnumReader extends fb.Reader<OrbitTrackAbridgedDataModeEnum> {
  const _OrbitTrackAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OrbitTrackAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      OrbitTrackAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class OrbitTrackAbridged {
  OrbitTrackAbridged._(this._bc, this._bcOffset);
  factory OrbitTrackAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OrbitTrackAbridged> reader = _OrbitTrackAbridgedReader();
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 32
  OrbitTrackAbridgedObjIdentEnum get objIdent => OrbitTrackAbridgedObjIdentEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 30, 0));
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 32
  OrbitTrackAbridgedObjectTypeEnum get objectType => OrbitTrackAbridgedObjectTypeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 36, 0));
  ...
  OrbitTrackAbridgedDataModeEnum get dataMode => OrbitTrackAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 90, 0));
  ...
  @override
  String toString() {
    return 'OrbitTrackAbridged{id: ${id}, classificationMarking: ${classificationMarking}, idOnOrbit: ${idOnOrbit}, satNo: ${satNo}, origObjectId: ${origObjectId}, idElset: ${idElset}, ts: ${ts}, lat: ${lat}, lon: ${lon}, alt: ${alt}, rdfRf: ${rdfRf}, callSign: ${callSign}, rptNum: ${rptNum}, objIdent: ${objIdent}, identAmp: ${identAmp}, satStatus: ${satStatus}, objectType: ${objectType}, countryCode: ${countryCode}, decay: ${decay}, charlieLine: ${charlieLine}, aouType: ${aouType}, aouData: ${aouData}, spd: ${spd}, angElev: ${angElev}, cntnmnt: ${cntnmnt}, xref: ${xref}, chXref: ${chXref}, amplification: ${amplification}, iff: ${iff}, reinforced: ${reinforced}, reduced: ${reduced}, hq: ${hq}, dummy: ${dummy}, taskForce: ${taskForce}, feint: ${feint}, installation: ${installation}, vehType: ${vehType}, trkId: ${trkId}, trackSensors: ${trackSensors}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, origNetwork: ${origNetwork}}';
  }
}

class _OrbitTrackAbridgedReader extends fb.TableReader<OrbitTrackAbridged> {
  const _OrbitTrackAbridgedReader();

  @override
  OrbitTrackAbridged createObject(fb.BufferContext bc, int offset) => 
    OrbitTrackAbridged._(bc, offset);
}

class OrbitTrackAbridgedBuilder {
  OrbitTrackAbridgedBuilder(this.fbBuilder);
  ...
  int addObjIdent(OrbitTrackAbridgedObjIdentEnum? objIdent) {
  ...
  int addObjectType(OrbitTrackAbridgedObjectTypeEnum? objectType) {
  ...
  int addDataMode(OrbitTrackAbridgedDataModeEnum? dataMode) {
...
class OrbitTrackAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final OrbitTrackAbridgedObjIdentEnum? _objIdent;
  final String? _identAmp;
  final String? _satStatus;
  final OrbitTrackAbridgedObjectTypeEnum? _objectType;
  ...
  final OrbitTrackAbridgedDataModeEnum? _dataMode;
  final String? _origNetwork;

  OrbitTrackAbridgedObjectBuilder({
    String? id,
    ...
    String? callSign,
    String? rptNum,
    OrbitTrackAbridgedObjIdentEnum? objIdent,
    String? identAmp,
    String? satStatus,
    OrbitTrackAbridgedObjectTypeEnum? objectType,
    String? countryCode,
    double? decay,
    String? charlieLine,
    String? aouType,
    ...
    String? source,
    String? origin,
    OrbitTrackAbridgedDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
