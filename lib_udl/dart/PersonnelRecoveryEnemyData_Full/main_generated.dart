...
class PersonnelRecoveryEnemyDataFull {
  PersonnelRecoveryEnemyDataFull._(this._bc, this._bcOffset);
  factory PersonnelRecoveryEnemyDataFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PersonnelRecoveryEnemyDataFull> reader = _PersonnelRecoveryEnemyDataFullReader();
  ...
  @override
  String toString() {
    return 'PersonnelRecoveryEnemyDataFull{dirToEnemy: ${dirToEnemy}, hostileFireType: ${hostileFireType}, friendliesRemarks: ${friendliesRemarks}, hlzRemarks: ${hlzRemarks}}';
  }
}

class _PersonnelRecoveryEnemyDataFullReader extends fb.TableReader<PersonnelRecoveryEnemyDataFull> {
  const _PersonnelRecoveryEnemyDataFullReader();

  @override
  PersonnelRecoveryEnemyDataFull createObject(fb.BufferContext bc, int offset) => 
    PersonnelRecoveryEnemyDataFull._(bc, offset);
}

class PersonnelRecoveryEnemyDataFullBuilder {
  PersonnelRecoveryEnemyDataFullBuilder(this.fbBuilder);
...
class PersonnelRecoveryEnemyDataFullObjectBuilder extends fb.ObjectBuilder {
  final String? _dirToEnemy;
  final String? _hostileFireType;
  final String? _friendliesRemarks;
  final String? _hlzRemarks;

  PersonnelRecoveryEnemyDataFullObjectBuilder({
    String? dirToEnemy,
