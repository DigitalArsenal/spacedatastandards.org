...
class AntennaDetailsIngestModeEnum {
  final int value;
  const AntennaDetailsIngestModeEnum._(this.value);

  factory AntennaDetailsIngestModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AntennaDetailsIngestModeEnum');
    }
    return result;
  }

  static AntennaDetailsIngestModeEnum? _createOrNull(int? value) => 
      value == null ? null : AntennaDetailsIngestModeEnum.fromValue(value);
  ...
  static const AntennaDetailsIngestModeEnum TX = AntennaDetailsIngestModeEnum._(0);

  ///  No description available.
  static const AntennaDetailsIngestModeEnum RX = AntennaDetailsIngestModeEnum._(1);
  static const Map<int, AntennaDetailsIngestModeEnum> values = {
    0: TX,
    1: RX};

  static const fb.Reader<AntennaDetailsIngestModeEnum> reader = _AntennaDetailsIngestModeEnumReader();

  @override
  String toString() {
    return 'AntennaDetailsIngestModeEnum{value: $value}';
  }
}

class _AntennaDetailsIngestModeEnumReader extends fb.Reader<AntennaDetailsIngestModeEnum> {
  const _AntennaDetailsIngestModeEnumReader();

  @override
  int get size => 1;

  @override
  AntennaDetailsIngestModeEnum read(fb.BufferContext bc, int offset) =>
      AntennaDetailsIngestModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class AntennaDetailsIngestDataModeEnum {
  final int value;
  const AntennaDetailsIngestDataModeEnum._(this.value);

  factory AntennaDetailsIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AntennaDetailsIngestDataModeEnum');
    }
    return result;
  }

  static AntennaDetailsIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AntennaDetailsIngestDataModeEnum.fromValue(value);
  ...
  static const AntennaDetailsIngestDataModeEnum REAL = AntennaDetailsIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AntennaDetailsIngestDataModeEnum TEST = AntennaDetailsIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AntennaDetailsIngestDataModeEnum SIMULATED = AntennaDetailsIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AntennaDetailsIngestDataModeEnum EXERCISE = AntennaDetailsIngestDataModeEnum._(3);
  static const Map<int, AntennaDetailsIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AntennaDetailsIngestDataModeEnum> reader = _AntennaDetailsIngestDataModeEnumReader();

  @override
  String toString() {
    return 'AntennaDetailsIngestDataModeEnum{value: $value}';
  }
}

class _AntennaDetailsIngestDataModeEnumReader extends fb.Reader<AntennaDetailsIngestDataModeEnum> {
  const _AntennaDetailsIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AntennaDetailsIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      AntennaDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AntennaDetailsIngest {
  AntennaDetailsIngest._(this._bc, this._bcOffset);
  factory AntennaDetailsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AntennaDetailsIngest> reader = _AntennaDetailsIngestReader();
  ...
  AntennaDetailsIngestModeEnum get mode => AntennaDetailsIngestModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 14, 0));
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  AntennaDetailsIngestDataModeEnum get dataMode => AntennaDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 50, 0));
  ...
  @override
  String toString() {
    return 'AntennaDetailsIngest{id: ${id}, idAntenna: ${idAntenna}, classificationMarking: ${classificationMarking}, type: ${type}, position: ${position}, mode: ${mode}, steerable: ${steerable}, beamForming: ${beamForming}, manufacturerOrgId: ${manufacturerOrgId}, diameter: ${diameter}, size: ${size}, startFrequency: ${startFrequency}, endFrequency: ${endFrequency}, beamwidth: ${beamwidth}, gain: ${gain}, gainTolerance: ${gainTolerance}, polarization: ${polarization}, description: ${description}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, tags: ${tags}}';
  }
}

class _AntennaDetailsIngestReader extends fb.TableReader<AntennaDetailsIngest> {
  const _AntennaDetailsIngestReader();

  @override
  AntennaDetailsIngest createObject(fb.BufferContext bc, int offset) => 
    AntennaDetailsIngest._(bc, offset);
}

class AntennaDetailsIngestBuilder {
  AntennaDetailsIngestBuilder(this.fbBuilder);
  ...
  int addMode(AntennaDetailsIngestModeEnum? mode) {
  ...
  int addDataMode(AntennaDetailsIngestDataModeEnum? dataMode) {
...
class AntennaDetailsIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _idAntenna;
  final String? _classificationMarking;
  final String? _type;
  final String? _position;
  final AntennaDetailsIngestModeEnum? _mode;
  ...
  final AntennaDetailsIngestDataModeEnum? _dataMode;
  final List<String>? _tags;

  AntennaDetailsIngestObjectBuilder({
    String? id,
    String? idAntenna,
    String? classificationMarking,
    String? type,
    String? position,
    AntennaDetailsIngestModeEnum? mode,
    bool? steerable,
    bool? beamForming,
    ...
    String? origin,
    String? origNetwork,
    AntennaDetailsIngestDataModeEnum? dataMode,
    List<String>? tags,
  })
      : _id = id,
