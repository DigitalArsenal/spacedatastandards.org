...
class IsrcollectionPocAbridged {
  IsrcollectionPocAbridged._(this._bc, this._bcOffset);
  factory IsrcollectionPocAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IsrcollectionPocAbridged> reader = _IsrcollectionPocAbridgedReader();
  ...
  @override
  String toString() {
    return 'IsrcollectionPocAbridged{id: ${id}, name: ${name}, callsign: ${callsign}, unit: ${unit}, email: ${email}, phone: ${phone}, radioFrequency: ${radioFrequency}, chatSystem: ${chatSystem}, chatName: ${chatName}, notes: ${notes}}';
  }
}

class _IsrcollectionPocAbridgedReader extends fb.TableReader<IsrcollectionPocAbridged> {
  const _IsrcollectionPocAbridgedReader();

  @override
  IsrcollectionPocAbridged createObject(fb.BufferContext bc, int offset) => 
    IsrcollectionPocAbridged._(bc, offset);
}

class IsrcollectionPocAbridgedBuilder {
  IsrcollectionPocAbridgedBuilder(this.fbBuilder);
...
class IsrcollectionPocAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _name;
  ...
  IsrcollectionPocAbridgedObjectBuilder({
    String? id,
    String? name,
    String? callsign,
    String? unit,
