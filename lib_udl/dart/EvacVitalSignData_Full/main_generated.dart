...
class EvacVitalSignDataFull {
  EvacVitalSignDataFull._(this._bc, this._bcOffset);
  factory EvacVitalSignDataFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EvacVitalSignDataFull> reader = _EvacVitalSignDataFullReader();
  ...
  @override
  String toString() {
    return 'EvacVitalSignDataFull{vitalSign: ${vitalSign}, vitalSign1: ${vitalSign1}, vitalSign2: ${vitalSign2}, medConfFactor: ${medConfFactor}, time: ${time}}';
  }
}

class _EvacVitalSignDataFullReader extends fb.TableReader<EvacVitalSignDataFull> {
  const _EvacVitalSignDataFullReader();

  @override
  EvacVitalSignDataFull createObject(fb.BufferContext bc, int offset) => 
    EvacVitalSignDataFull._(bc, offset);
}

class EvacVitalSignDataFullBuilder {
  EvacVitalSignDataFullBuilder(this.fbBuilder);
...
class EvacVitalSignDataFullObjectBuilder extends fb.ObjectBuilder {
  ...
  EvacVitalSignDataFullObjectBuilder({
    String? vitalSign,
    double? vitalSign1,
    double? vitalSign2,
    int? medConfFactor,
