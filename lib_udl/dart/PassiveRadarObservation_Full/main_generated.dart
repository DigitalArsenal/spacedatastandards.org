...
class PassiveRadarObservationFullDataModeEnum {
  final int value;
  const PassiveRadarObservationFullDataModeEnum._(this.value);

  factory PassiveRadarObservationFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum PassiveRadarObservationFullDataModeEnum');
    }
    return result;
  }

  static PassiveRadarObservationFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : PassiveRadarObservationFullDataModeEnum.fromValue(value);
  ...
  static const PassiveRadarObservationFullDataModeEnum REAL = PassiveRadarObservationFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const PassiveRadarObservationFullDataModeEnum TEST = PassiveRadarObservationFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const PassiveRadarObservationFullDataModeEnum SIMULATED = PassiveRadarObservationFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const PassiveRadarObservationFullDataModeEnum EXERCISE = PassiveRadarObservationFullDataModeEnum._(3);
  static const Map<int, PassiveRadarObservationFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<PassiveRadarObservationFullDataModeEnum> reader = _PassiveRadarObservationFullDataModeEnumReader();

  @override
  String toString() {
    return 'PassiveRadarObservationFullDataModeEnum{value: $value}';
  }
}

class _PassiveRadarObservationFullDataModeEnumReader extends fb.Reader<PassiveRadarObservationFullDataModeEnum> {
  const _PassiveRadarObservationFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  PassiveRadarObservationFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      PassiveRadarObservationFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class PassiveRadarObservationFull {
  PassiveRadarObservationFull._(this._bc, this._bcOffset);
  factory PassiveRadarObservationFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PassiveRadarObservationFull> reader = _PassiveRadarObservationFullReader();
...
class PassiveRadarObservationFullBuilder {
  ...
  int addDataMode(PassiveRadarObservationFullDataModeEnum? dataMode) {
...
class PassiveRadarObservationFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final PassiveRadarObservationFullDataModeEnum? _dataMode;
  final String? _onOrbit;
  final String? _type;

  PassiveRadarObservationFullObjectBuilder({
    String? id,
    ...
    String? origNetwork,
    String? sourceDl,
    PassiveRadarObservationFullDataModeEnum? dataMode,
    String? onOrbit,
    String? type,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(66, onOrbitOffset);
    fbBuilder.addOffset(67, typeOffset);
    return fbBuilder.endTable();
  }
