...
class LogisticsSegmentsIngest {
  LogisticsSegmentsIngest._(this._bc, this._bcOffset);
  factory LogisticsSegmentsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LogisticsSegmentsIngest> reader = _LogisticsSegmentsIngestReader();
  ...
  @override
  String toString() {
    return 'LogisticsSegmentsIngest{segmentNumber: ${segmentNumber}, modeCode: ${modeCode}, missionType: ${missionType}, idMission: ${idMission}, extMissionId: ${extMissionId}, missionNumber: ${missionNumber}, itin: ${itin}, segTailNumber: ${segTailNumber}, segAircraftMds: ${segAircraftMds}, departureIcao: ${departureIcao}, segActDepTime: ${segActDepTime}, arrivalIcao: ${arrivalIcao}, segActArrTime: ${segActArrTime}, segEstDepTime: ${segEstDepTime}, segEstArrTime: ${segEstArrTime}}';
  }
}

class _LogisticsSegmentsIngestReader extends fb.TableReader<LogisticsSegmentsIngest> {
  const _LogisticsSegmentsIngestReader();

  @override
  LogisticsSegmentsIngest createObject(fb.BufferContext bc, int offset) => 
    LogisticsSegmentsIngest._(bc, offset);
}

class LogisticsSegmentsIngestBuilder {
  LogisticsSegmentsIngestBuilder(this.fbBuilder);
...
class LogisticsSegmentsIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  LogisticsSegmentsIngestObjectBuilder({
    int? segmentNumber,
    String? modeCode,
    String? missionType,
    String? idMission,
