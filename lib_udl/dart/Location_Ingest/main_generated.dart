...
class LocationIngestDataModeEnum {
  final int value;
  const LocationIngestDataModeEnum._(this.value);

  factory LocationIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum LocationIngestDataModeEnum');
    }
    return result;
  }

  static LocationIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : LocationIngestDataModeEnum.fromValue(value);
  ...
  static const LocationIngestDataModeEnum REAL = LocationIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const LocationIngestDataModeEnum TEST = LocationIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const LocationIngestDataModeEnum SIMULATED = LocationIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const LocationIngestDataModeEnum EXERCISE = LocationIngestDataModeEnum._(3);
  static const Map<int, LocationIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<LocationIngestDataModeEnum> reader = _LocationIngestDataModeEnumReader();

  @override
  String toString() {
    return 'LocationIngestDataModeEnum{value: $value}';
  }
}

class _LocationIngestDataModeEnumReader extends fb.Reader<LocationIngestDataModeEnum> {
  const _LocationIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  LocationIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      LocationIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class LocationIngest {
  LocationIngest._(this._bc, this._bcOffset);
  factory LocationIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LocationIngest> reader = _LocationIngestReader();
  ...
  LocationIngestDataModeEnum get dataMode => LocationIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 26, 0));
  ...
  @override
  String toString() {
    return 'LocationIngest{idLocation: ${idLocation}, classificationMarking: ${classificationMarking}, name: ${name}, countryCode: ${countryCode}, lat: ${lat}, lon: ${lon}, altitude: ${altitude}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, origNetwork: ${origNetwork}}';
  }
}

class _LocationIngestReader extends fb.TableReader<LocationIngest> {
  const _LocationIngestReader();

  @override
  LocationIngest createObject(fb.BufferContext bc, int offset) => 
    LocationIngest._(bc, offset);
}

class LocationIngestBuilder {
  LocationIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(LocationIngestDataModeEnum? dataMode) {
...
class LocationIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  final LocationIngestDataModeEnum? _dataMode;
  final String? _origNetwork;

  LocationIngestObjectBuilder({
    String? idLocation,
    ...
    String? source,
    String? origin,
    LocationIngestDataModeEnum? dataMode,
    String? origNetwork,
  })
