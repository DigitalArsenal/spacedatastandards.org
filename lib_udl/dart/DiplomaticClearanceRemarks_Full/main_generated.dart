...
class DiplomaticClearanceRemarksFull {
  DiplomaticClearanceRemarksFull._(this._bc, this._bcOffset);
  factory DiplomaticClearanceRemarksFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DiplomaticClearanceRemarksFull> reader = _DiplomaticClearanceRemarksFullReader();
  ...
  @override
  String toString() {
    return 'DiplomaticClearanceRemarksFull{gdssRemarkId: ${gdssRemarkId}, text: ${text}, date: ${date}, user: ${user}}';
  }
}

class _DiplomaticClearanceRemarksFullReader extends fb.TableReader<DiplomaticClearanceRemarksFull> {
  const _DiplomaticClearanceRemarksFullReader();

  @override
  DiplomaticClearanceRemarksFull createObject(fb.BufferContext bc, int offset) => 
    DiplomaticClearanceRemarksFull._(bc, offset);
}

class DiplomaticClearanceRemarksFullBuilder {
  DiplomaticClearanceRemarksFullBuilder(this.fbBuilder);
...
class DiplomaticClearanceRemarksFullObjectBuilder extends fb.ObjectBuilder {
  final String? _gdssRemarkId;
  final String? _text;
  final String? _date;
  final String? _user;

  DiplomaticClearanceRemarksFullObjectBuilder({
    String? gdssRemarkId,
    String? text,
    String? date,
    String? user,
