...
class SensortypeIngest {
  SensortypeIngest._(this._bc, this._bcOffset);
  factory SensortypeIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SensortypeIngest> reader = _SensortypeIngestReader();
  ...
  @override
  String toString() {
    return 'SensortypeIngest{id: ${id}, type: ${type}, createdAt: ${createdAt}, createdBy: ${createdBy}, origNetwork: ${origNetwork}}';
  }
}

class _SensortypeIngestReader extends fb.TableReader<SensortypeIngest> {
  const _SensortypeIngestReader();

  @override
  SensortypeIngest createObject(fb.BufferContext bc, int offset) => 
    SensortypeIngest._(bc, offset);
}

class SensortypeIngestBuilder {
  SensortypeIngestBuilder(this.fbBuilder);
...
class SensortypeIngestObjectBuilder extends fb.ObjectBuilder {
  final int? _id;
  final String? _type;
