...
class AirfieldSlotConsumptionFullStatusEnum {
  final int value;
  const AirfieldSlotConsumptionFullStatusEnum._(this.value);

  factory AirfieldSlotConsumptionFullStatusEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirfieldSlotConsumptionFullStatusEnum');
    }
    return result;
  }

  static AirfieldSlotConsumptionFullStatusEnum? _createOrNull(int? value) => 
      value == null ? null : AirfieldSlotConsumptionFullStatusEnum.fromValue(value);
  ...
  static const AirfieldSlotConsumptionFullStatusEnum REQUESTED = AirfieldSlotConsumptionFullStatusEnum._(0);

  ///  No description available.
  static const AirfieldSlotConsumptionFullStatusEnum APPROVED = AirfieldSlotConsumptionFullStatusEnum._(1);

  ///  No description available.
  static const AirfieldSlotConsumptionFullStatusEnum DENIED = AirfieldSlotConsumptionFullStatusEnum._(2);

  ///  No description available.
  static const AirfieldSlotConsumptionFullStatusEnum BLOCKED = AirfieldSlotConsumptionFullStatusEnum._(3);

  ///  No description available.
  static const AirfieldSlotConsumptionFullStatusEnum OTHER = AirfieldSlotConsumptionFullStatusEnum._(4);
  static const Map<int, AirfieldSlotConsumptionFullStatusEnum> values = {
    0: REQUESTED,
    1: APPROVED,
    2: DENIED,
    3: BLOCKED,
  ...
  static const fb.Reader<AirfieldSlotConsumptionFullStatusEnum> reader = _AirfieldSlotConsumptionFullStatusEnumReader();

  @override
  String toString() {
    return 'AirfieldSlotConsumptionFullStatusEnum{value: $value}';
  }
}

class _AirfieldSlotConsumptionFullStatusEnumReader extends fb.Reader<AirfieldSlotConsumptionFullStatusEnum> {
  const _AirfieldSlotConsumptionFullStatusEnumReader();

  @override
  int get size => 1;

  @override
  AirfieldSlotConsumptionFullStatusEnum read(fb.BufferContext bc, int offset) =>
      AirfieldSlotConsumptionFullStatusEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class AirfieldSlotConsumptionFullDataModeEnum {
  final int value;
  const AirfieldSlotConsumptionFullDataModeEnum._(this.value);

  factory AirfieldSlotConsumptionFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirfieldSlotConsumptionFullDataModeEnum');
    }
    return result;
  }

  static AirfieldSlotConsumptionFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AirfieldSlotConsumptionFullDataModeEnum.fromValue(value);
  ...
  static const AirfieldSlotConsumptionFullDataModeEnum REAL = AirfieldSlotConsumptionFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AirfieldSlotConsumptionFullDataModeEnum TEST = AirfieldSlotConsumptionFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AirfieldSlotConsumptionFullDataModeEnum SIMULATED = AirfieldSlotConsumptionFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AirfieldSlotConsumptionFullDataModeEnum EXERCISE = AirfieldSlotConsumptionFullDataModeEnum._(3);
  static const Map<int, AirfieldSlotConsumptionFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AirfieldSlotConsumptionFullDataModeEnum> reader = _AirfieldSlotConsumptionFullDataModeEnumReader();

  @override
  String toString() {
    return 'AirfieldSlotConsumptionFullDataModeEnum{value: $value}';
  }
}

class _AirfieldSlotConsumptionFullDataModeEnumReader extends fb.Reader<AirfieldSlotConsumptionFullDataModeEnum> {
  const _AirfieldSlotConsumptionFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AirfieldSlotConsumptionFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      AirfieldSlotConsumptionFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Airfield slot use data. Contains the dynamic data associated with the status and use of specific airfield slots.
class AirfieldSlotConsumptionFull {
  AirfieldSlotConsumptionFull._(this._bc, this._bcOffset);
  factory AirfieldSlotConsumptionFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirfieldSlotConsumptionFull> reader = _AirfieldSlotConsumptionFullReader();
  ...
  AirfieldSlotConsumptionFullStatusEnum get status => AirfieldSlotConsumptionFullStatusEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 10, 0));
  ...
  ///  Example: /// Example: 2018-01-01T16:00:00.123Z
  ///  Constraints: No constraints specified.
  String? get updatedAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 68);
  ///  Application user who updated the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get updatedBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 70);
  ...
  AirfieldSlotConsumptionFullDataModeEnum get dataMode => AirfieldSlotConsumptionFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 80, 0));

  @override
  String toString() {
    return 'AirfieldSlotConsumptionFull{id: ${id}, classificationMarking: ${classificationMarking}, idAirfieldSlot: ${idAirfieldSlot}, status: ${status}, occupied: ${occupied}, consumer: ${consumer}, occAircraftMds: ${occAircraftMds}, occTailNumber: ${occTailNumber}, callSigns: ${callSigns}, missionId: ${missionId}, numAircraft: ${numAircraft}, occStartTime: ${occStartTime}, resAircraftMds: ${resAircraftMds}, resTailNumber: ${resTailNumber}, resType: ${resType}, resReason: ${resReason}, resMissionId: ${resMissionId}, startTime: ${startTime}, endTime: ${endTime}, targetTime: ${targetTime}, idArrSortie: ${idArrSortie}, idDepSortie: ${idDepSortie}, altArrSortieId: ${altArrSortieId}, altDepSortieId: ${altDepSortieId}, reqComment: ${reqComment}, appComment: ${appComment}, reqOrg: ${reqOrg}, reqInitials: ${reqInitials}, appOrg: ${appOrg}, appInitials: ${appInitials}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, sourceDl: ${sourceDl}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _AirfieldSlotConsumptionFullReader extends fb.TableReader<AirfieldSlotConsumptionFull> {
  const _AirfieldSlotConsumptionFullReader();

  @override
  AirfieldSlotConsumptionFull createObject(fb.BufferContext bc, int offset) => 
    AirfieldSlotConsumptionFull._(bc, offset);
}

class AirfieldSlotConsumptionFullBuilder {
  AirfieldSlotConsumptionFullBuilder(this.fbBuilder);
  ...
  int addStatus(AirfieldSlotConsumptionFullStatusEnum? status) {
  ...
  int addDataMode(AirfieldSlotConsumptionFullDataModeEnum? dataMode) {
...
class AirfieldSlotConsumptionFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _classificationMarking;
  final String? _idAirfieldSlot;
  final AirfieldSlotConsumptionFullStatusEnum? _status;
  ...
  final AirfieldSlotConsumptionFullDataModeEnum? _dataMode;

  AirfieldSlotConsumptionFullObjectBuilder({
    String? id,
    String? classificationMarking,
    String? idAirfieldSlot,
    AirfieldSlotConsumptionFullStatusEnum? status,
    bool? occupied,
    String? consumer,
    ...
    String? origin,
    String? origNetwork,
    AirfieldSlotConsumptionFullDataModeEnum? dataMode,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(32, updatedAtOffset);
    fbBuilder.addOffset(33, updatedByOffset);
