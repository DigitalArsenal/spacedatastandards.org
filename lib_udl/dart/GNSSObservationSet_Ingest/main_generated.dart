...
class GnssobservationSetIngestDataModeEnum {
  final int value;
  const GnssobservationSetIngestDataModeEnum._(this.value);

  factory GnssobservationSetIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum GnssobservationSetIngestDataModeEnum');
    }
    return result;
  }

  static GnssobservationSetIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : GnssobservationSetIngestDataModeEnum.fromValue(value);
  ...
  static const GnssobservationSetIngestDataModeEnum REAL = GnssobservationSetIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const GnssobservationSetIngestDataModeEnum TEST = GnssobservationSetIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const GnssobservationSetIngestDataModeEnum SIMULATED = GnssobservationSetIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const GnssobservationSetIngestDataModeEnum EXERCISE = GnssobservationSetIngestDataModeEnum._(3);
  static const Map<int, GnssobservationSetIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<GnssobservationSetIngestDataModeEnum> reader = _GnssobservationSetIngestDataModeEnumReader();

  @override
  String toString() {
    return 'GnssobservationSetIngestDataModeEnum{value: $value}';
  }
}

class _GnssobservationSetIngestDataModeEnumReader extends fb.Reader<GnssobservationSetIngestDataModeEnum> {
  const _GnssobservationSetIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  GnssobservationSetIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      GnssobservationSetIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Set of GNSSObservation data.
class GnssobservationSetIngest {
  GnssobservationSetIngest._(this._bc, this._bcOffset);
  factory GnssobservationSetIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<GnssobservationSetIngest> reader = _GnssobservationSetIngestReader();
  ...
  GnssobservationSetIngestDataModeEnum get dataMode => GnssobservationSetIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 70, 0));
...
class GnssobservationSetIngestBuilder {
  ...
  int addDataMode(GnssobservationSetIngestDataModeEnum? dataMode) {
...
class GnssobservationSetIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final GnssobservationSetIngestDataModeEnum? _dataMode;
  final String? _origNetwork;
  final List<String>? _gnssObservationList;

  GnssobservationSetIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    GnssobservationSetIngestDataModeEnum? dataMode,
    String? origNetwork,
