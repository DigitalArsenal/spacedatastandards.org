...
class FlightPlanWaypointsAbridged {
  FlightPlanWaypointsAbridged._(this._bc, this._bcOffset);
  factory FlightPlanWaypointsAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<FlightPlanWaypointsAbridged> reader = _FlightPlanWaypointsAbridgedReader();
...
class FlightPlanWaypointsAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _type;
  ...
  FlightPlanWaypointsAbridgedObjectBuilder({
    String? type,
    String? waypointName,
    int? waypointNum,
    String? airway,
