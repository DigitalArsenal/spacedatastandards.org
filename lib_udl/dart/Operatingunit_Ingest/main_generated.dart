...
class OperatingunitIngestDataModeEnum {
  final int value;
  const OperatingunitIngestDataModeEnum._(this.value);

  factory OperatingunitIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OperatingunitIngestDataModeEnum');
    }
    return result;
  }

  static OperatingunitIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OperatingunitIngestDataModeEnum.fromValue(value);
  ...
  static const OperatingunitIngestDataModeEnum REAL = OperatingunitIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OperatingunitIngestDataModeEnum TEST = OperatingunitIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OperatingunitIngestDataModeEnum SIMULATED = OperatingunitIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OperatingunitIngestDataModeEnum EXERCISE = OperatingunitIngestDataModeEnum._(3);
  static const Map<int, OperatingunitIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OperatingunitIngestDataModeEnum> reader = _OperatingunitIngestDataModeEnumReader();

  @override
  String toString() {
    return 'OperatingunitIngestDataModeEnum{value: $value}';
  }
}

class _OperatingunitIngestDataModeEnumReader extends fb.Reader<OperatingunitIngestDataModeEnum> {
  const _OperatingunitIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OperatingunitIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      OperatingunitIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class OperatingunitIngest {
  OperatingunitIngest._(this._bc, this._bcOffset);
  factory OperatingunitIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OperatingunitIngest> reader = _OperatingunitIngestReader();
...
class OperatingunitIngestBuilder {
  ...
  int addDataMode(OperatingunitIngestDataModeEnum? dataMode) {
...
class OperatingunitIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  final OperatingunitIngestDataModeEnum? _dataMode;

  OperatingunitIngestObjectBuilder({
    ...
    String? source,
    String? origin,
    OperatingunitIngestDataModeEnum? dataMode,
  })
