...
class RadarSoiobservationIngest {
  RadarSoiobservationIngest._(this._bc, this._bcOffset);
  factory RadarSoiobservationIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<RadarSoiobservationIngest> reader = _RadarSoiobservationIngestReader();
...
class RadarSoiobservationIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  RadarSoiobservationIngestObjectBuilder({
    String? obStartTime,
    List<String>? tovs,
    List<String>? rspaces,
    List<String>? xspaces,
