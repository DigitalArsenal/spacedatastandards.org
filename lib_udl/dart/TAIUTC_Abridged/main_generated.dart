...
class TaiutcAbridgedDataModeEnum {
  final int value;
  const TaiutcAbridgedDataModeEnum._(this.value);

  factory TaiutcAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum TaiutcAbridgedDataModeEnum');
    }
    return result;
  }

  static TaiutcAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : TaiutcAbridgedDataModeEnum.fromValue(value);
  ...
  static const TaiutcAbridgedDataModeEnum REAL = TaiutcAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const TaiutcAbridgedDataModeEnum TEST = TaiutcAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const TaiutcAbridgedDataModeEnum SIMULATED = TaiutcAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const TaiutcAbridgedDataModeEnum EXERCISE = TaiutcAbridgedDataModeEnum._(3);
  static const Map<int, TaiutcAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<TaiutcAbridgedDataModeEnum> reader = _TaiutcAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'TaiutcAbridgedDataModeEnum{value: $value}';
  }
}

class _TaiutcAbridgedDataModeEnumReader extends fb.Reader<TaiutcAbridgedDataModeEnum> {
  const _TaiutcAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  TaiutcAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      TaiutcAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class TaiutcAbridged {
  TaiutcAbridged._(this._bc, this._bcOffset);
  factory TaiutcAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<TaiutcAbridged> reader = _TaiutcAbridgedReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  TaiutcAbridgedDataModeEnum get dataMode => TaiutcAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 22, 0));
  ...
  @override
  String toString() {
    return 'TaiutcAbridged{id: ${id}, classificationMarking: ${classificationMarking}, adjustmentDate: ${adjustmentDate}, taiUtc: ${taiUtc}, multiplicationFactor: ${multiplicationFactor}, rawFileUri: ${rawFileUri}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, createdAt: ${createdAt}, createdBy: ${createdBy}}';
  }
}

class _TaiutcAbridgedReader extends fb.TableReader<TaiutcAbridged> {
  const _TaiutcAbridgedReader();

  @override
  TaiutcAbridged createObject(fb.BufferContext bc, int offset) => 
    TaiutcAbridged._(bc, offset);
}

class TaiutcAbridgedBuilder {
  TaiutcAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(TaiutcAbridgedDataModeEnum? dataMode) {
...
class TaiutcAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final TaiutcAbridgedDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;

  TaiutcAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    TaiutcAbridgedDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
  })
      : _id = id,
