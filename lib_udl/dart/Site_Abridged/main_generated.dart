...
class SiteAbridgedDataModeEnum {
  final int value;
  const SiteAbridgedDataModeEnum._(this.value);

  factory SiteAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SiteAbridgedDataModeEnum');
    }
    return result;
  }

  static SiteAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SiteAbridgedDataModeEnum.fromValue(value);
  ...
  static const SiteAbridgedDataModeEnum REAL = SiteAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SiteAbridgedDataModeEnum TEST = SiteAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SiteAbridgedDataModeEnum SIMULATED = SiteAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SiteAbridgedDataModeEnum EXERCISE = SiteAbridgedDataModeEnum._(3);
  static const Map<int, SiteAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SiteAbridgedDataModeEnum> reader = _SiteAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'SiteAbridgedDataModeEnum{value: $value}';
  }
}

class _SiteAbridgedDataModeEnumReader extends fb.Reader<SiteAbridgedDataModeEnum> {
  const _SiteAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SiteAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      SiteAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Properties and characteristics of a site entity, such as an airbase, airfield, naval station, etc.
class SiteAbridged {
  SiteAbridged._(this._bc, this._bcOffset);
  factory SiteAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SiteAbridged> reader = _SiteAbridgedReader();
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get idParentSite => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 8);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get origSiteId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 12);
  ///  Unique identifier of the LZ record from the originating system.
  ///  Example: /// Example: ORIG-LZ-ID
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get origLzId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 14);
  ///  Site number of a specific electronic site or its associated equipment.
  ///  Example: /// Example: 25200
  ///  Constraints: Minimum length = 0, Maximum length = 5
  String? get pin => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 16);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 16
  String? get usage => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 20);
  ...
  String? get lzUsage => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 22);
  ...
  ///  Example: /// Example: WGS
  ///  Constraints: Minimum length = 0, Maximum length = 3
  String? get coordDatum => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 26);
  ...
  String? get coord => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 28);
  ///  Indicates the plus or minus error assessed against the method used to derive the coordinate.
  ///  Example: /// Example: 12.345
  ///  Constraints: No constraints specified.
  double get coordDerivAcc => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 30, 0.0);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 16
  String? get utm => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 42);
  ///  Indicates the grid system used in the development of the milGrid coordinates. Values are:
  ///  UPS - Universal Polar System
  ///  UTM - Universal Transverse Mercator.
  ///  Example: /// Example: UTM
  ///  Constraints: Minimum length = 0, Maximum length = 3
  String? get milGridSys => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 44);
  ...
  String? get polSubdiv => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 54);
  ...
  String? get geoArea => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 56);
  ///  The distance between Mean Sea Level and a referenced ellipsoid, in meters.
  ///  Example: /// Example: 12.34
  ///  Constraints: No constraints specified.
  double get geoidalMslSep => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 58, 0.0);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 4
  String? get allegiance => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 60);
  ...
  ///  Example: /// Example: HL
  ///  Constraints: Minimum length = 0, Maximum length = 4
  String? get altAllegiance => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 62);
  ...
  String? get classRating => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 64);
  ...
  ///  Example: /// Example: EOB
  ///  Constraints: Minimum length = 0, Maximum length = 5
  String? get fpa => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 66);
  ...
  String? get beNumber => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 68);
  ///  The number of runways at the site, if applicable.
  ///  Example: /// Example: 5
  ///  Constraints: No constraints specified.
  int get runways => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 70, 0);
  ///  The length of the longest runway at this site, if applicable, in meters.
  ///  Example: /// Example: 1000
  ///  Constraints: No constraints specified.
  int get maxRunwayLength => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 72, 0);
  ...
  ///  Example: /// Example: RDY
  ///  Constraints: Minimum length = 0, Maximum length = 4
  String? get condition => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 74);
  ...
  ///  Example: /// Example: A
  ///  Constraints: Minimum length = 0, Maximum length = 4
  String? get conditionAvail => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 76);
  ...
  ///  Example: /// Example: OPR
  ///  Constraints: Minimum length = 0, Maximum length = 3
  String? get operStatus => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 78);
  ...
  ///  Example: /// Example: 5
  ///  Constraints: No constraints specified.
  int get grade => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 80, 0);
  ...
  ///  Example: /// Example: OCC
  ///  Constraints: Minimum length = 0, Maximum length = 3
  String? get activity => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 82);
  ...
  ///  Example: /// Example: JG
  ///  Constraints: Minimum length = 0, Maximum length = 4
  String? get functPrimary => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 84);
  ...
  ///  Example: /// Example: AA
  ///  Constraints: Minimum length = 0, Maximum length = 4
  String? get msnPrimary => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 86);
  ...
  ///  Example: /// Example: AB
  ///  Constraints: Minimum length = 0, Maximum length = 4
  String? get msnPrimarySpec => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 88);
  ...
  ///  Example: /// Example: A
  ///  Constraints: Minimum length = 0, Maximum length = 1
  String? get nucCap => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 90);
  ...
  String? get ident => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 92);
  ...
  ///  Constraints: No constraints specified.
  double get elevMsl => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 94, 0.0);
  ...
  ///  Example: /// Example: 50
  ///  Constraints: No constraints specified.
  int get elevMslConfLvl => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 96, 0);
  ///  Indicates the plus or minus error assessed against the method used to derive the elevation.
  ///  Example: /// Example: 12.34
  ///  Constraints: No constraints specified.
  double get elevMslDerivAcc => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 98, 0.0);
  ///  Maximum expected height of the vegetation in the Landing Zone (LZ), in meters.
  ///  Example: /// Example: 3
  ///  Constraints: No constraints specified.
  double get vegHt => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 100, 0.0);
  ...
  ///  Example: /// Example: FR
  ///  Constraints: Minimum length = 0, Maximum length = 4
  String? get vegType => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 102);
  ...
  ///  Constraints: No constraints specified.
  bool get popArea => const fb.BoolReader().vTableGet(_bc, _bcOffset, 104, false);
  ///  Indicates the distance to nearest populated area (over 1,000 people) in nautical miles.
  ///  Example: /// Example: 12.345
  ///  Constraints: No constraints specified.
  double get popAreaProx => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 106, 0.0);
  ///  Optional notes/comments for the site.
  ///  Example: /// Example: Example Notes
  ///  Constraints: Minimum length = 0, Maximum length = 1024
  String? get notes => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 108);
  ...
  ///  Example: /// Example: 7
  ///  Constraints: No constraints specified.
  int get eval => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 112, 0);
  ...
  ///  Constraints: No constraints specified.
  String? get reviewDate => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 114);
  ...
  ///  Example: /// Example: A
  ///  Constraints: Minimum length = 0, Maximum length = 1
  String? get recStatus => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 116);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 15
  String? get symCode => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 118);
  ...
  String? get referenceDoc => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 120);
...
class SiteAbridgedBuilder {
  ...
  int addCoordDerivAcc(double? coordDerivAcc) {
    fbBuilder.addFloat64(13, coordDerivAcc);
    return fbBuilder.offset;
  }
  ...
  int addGeoidalMslSep(double? geoidalMslSep) {
    fbBuilder.addFloat64(27, geoidalMslSep);
    return fbBuilder.offset;
  }
  ...
  int addRunways(int? runways) {
    fbBuilder.addInt32(33, runways);
    return fbBuilder.offset;
  }
  int addMaxRunwayLength(int? maxRunwayLength) {
    fbBuilder.addInt32(34, maxRunwayLength);
    return fbBuilder.offset;
  }
  ...
  int addElevMsl(double? elevMsl) {
    fbBuilder.addFloat64(45, elevMsl);
    return fbBuilder.offset;
  }
  int addElevMslConfLvl(int? elevMslConfLvl) {
    fbBuilder.addInt32(46, elevMslConfLvl);
    return fbBuilder.offset;
  }
  int addElevMslDerivAcc(double? elevMslDerivAcc) {
    fbBuilder.addFloat64(47, elevMslDerivAcc);
    return fbBuilder.offset;
  }
  int addVegHt(double? vegHt) {
    fbBuilder.addFloat64(48, vegHt);
    return fbBuilder.offset;
  }
  ...
  int addPopArea(bool? popArea) {
    fbBuilder.addBool(50, popArea);
    return fbBuilder.offset;
  }
  int addPopAreaProx(double? popAreaProx) {
    fbBuilder.addFloat64(51, popAreaProx);
    return fbBuilder.offset;
  }
  ...
  int addDataMode(SiteAbridgedDataModeEnum? dataMode) {
...
class SiteAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SiteAbridgedDataModeEnum? _dataMode;

  SiteAbridgedObjectBuilder({
    String? id,
    String? idEntity,
    String? idParentSite,
    ...
    String? origin,
    String? origNetwork,
    SiteAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
        _idEntity = idEntity,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(2, idParentSiteOffset);
    fbBuilder.addOffset(3, classificationMarkingOffset);
    fbBuilder.addOffset(4, origSiteIdOffset);
    fbBuilder.addOffset(5, origLzIdOffset);
    fbBuilder.addOffset(6, pinOffset);
    fbBuilder.addOffset(7, typeOffset);
    fbBuilder.addOffset(8, usageOffset);
    fbBuilder.addOffset(9, lzUsageOffset);
    fbBuilder.addOffset(10, nameOffset);
    fbBuilder.addOffset(11, coordDatumOffset);
    fbBuilder.addOffset(12, coordOffset);
    fbBuilder.addFloat64(13, _coordDerivAcc);
    fbBuilder.addOffset(14, osuffixOffset);
    fbBuilder.addOffset(15, iataOffset);
    fbBuilder.addOffset(16, icaoOffset);
    fbBuilder.addOffset(17, faaOffset);
    fbBuilder.addOffset(18, airDefAreaOffset);
    fbBuilder.addOffset(19, utmOffset);
    fbBuilder.addOffset(20, milGridSysOffset);
    fbBuilder.addOffset(21, milGridOffset);
    fbBuilder.addOffset(22, catCodeOffset);
    fbBuilder.addOffset(23, catTextOffset);
    fbBuilder.addOffset(24, wacOffset);
    fbBuilder.addOffset(25, polSubdivOffset);
    fbBuilder.addOffset(26, geoAreaOffset);
    fbBuilder.addFloat64(27, _geoidalMslSep);
    fbBuilder.addOffset(28, allegianceOffset);
    fbBuilder.addOffset(29, altAllegianceOffset);
    fbBuilder.addOffset(30, classRatingOffset);
    fbBuilder.addOffset(31, fpaOffset);
    fbBuilder.addOffset(32, beNumberOffset);
    fbBuilder.addInt32(33, _runways);
    fbBuilder.addInt32(34, _maxRunwayLength);
    fbBuilder.addOffset(35, conditionOffset);
    fbBuilder.addOffset(36, conditionAvailOffset);
    fbBuilder.addOffset(37, operStatusOffset);
    fbBuilder.addInt32(38, _grade);
    fbBuilder.addOffset(39, activityOffset);
    fbBuilder.addOffset(40, functPrimaryOffset);
    fbBuilder.addOffset(41, msnPrimaryOffset);
    fbBuilder.addOffset(42, msnPrimarySpecOffset);
    fbBuilder.addOffset(43, nucCapOffset);
    fbBuilder.addOffset(44, identOffset);
    fbBuilder.addFloat64(45, _elevMsl);
    fbBuilder.addInt32(46, _elevMslConfLvl);
    fbBuilder.addFloat64(47, _elevMslDerivAcc);
    fbBuilder.addFloat64(48, _vegHt);
    fbBuilder.addOffset(49, vegTypeOffset);
    fbBuilder.addBool(50, _popArea);
    fbBuilder.addFloat64(51, _popAreaProx);
    fbBuilder.addOffset(52, notesOffset);
    fbBuilder.addOffset(53, resProdOffset);
    fbBuilder.addInt32(54, _eval);
    fbBuilder.addOffset(55, reviewDateOffset);
    fbBuilder.addOffset(56, recStatusOffset);
    fbBuilder.addOffset(57, symCodeOffset);
    fbBuilder.addOffset(58, referenceDocOffset);
