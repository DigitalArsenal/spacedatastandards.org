...
class ElsetFullDataModeEnum {
  final int value;
  const ElsetFullDataModeEnum._(this.value);

  factory ElsetFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ElsetFullDataModeEnum');
    }
    return result;
  }

  static ElsetFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : ElsetFullDataModeEnum.fromValue(value);
  ...
  static const ElsetFullDataModeEnum REAL = ElsetFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const ElsetFullDataModeEnum TEST = ElsetFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const ElsetFullDataModeEnum SIMULATED = ElsetFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const ElsetFullDataModeEnum EXERCISE = ElsetFullDataModeEnum._(3);
  static const Map<int, ElsetFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<ElsetFullDataModeEnum> reader = _ElsetFullDataModeEnumReader();

  @override
  String toString() {
    return 'ElsetFullDataModeEnum{value: $value}';
  }
}

class _ElsetFullDataModeEnumReader extends fb.Reader<ElsetFullDataModeEnum> {
  const _ElsetFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  ElsetFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      ElsetFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class ElsetFullSourcedDataTypesEnum {
  final int value;
  const ElsetFullSourcedDataTypesEnum._(this.value);

  factory ElsetFullSourcedDataTypesEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ElsetFullSourcedDataTypesEnum');
    }
    return result;
  }

  static ElsetFullSourcedDataTypesEnum? _createOrNull(int? value) => 
      value == null ? null : ElsetFullSourcedDataTypesEnum.fromValue(value);
  ...
  static const ElsetFullSourcedDataTypesEnum EO = ElsetFullSourcedDataTypesEnum._(0);

  ///  No description available.
  static const ElsetFullSourcedDataTypesEnum RADAR = ElsetFullSourcedDataTypesEnum._(1);

  ///  No description available.
  static const ElsetFullSourcedDataTypesEnum RF = ElsetFullSourcedDataTypesEnum._(2);

  ///  No description available.
  static const ElsetFullSourcedDataTypesEnum DOA = ElsetFullSourcedDataTypesEnum._(3);

  ///  No description available.
  static const ElsetFullSourcedDataTypesEnum ELSET = ElsetFullSourcedDataTypesEnum._(4);

  ///  No description available.
  static const ElsetFullSourcedDataTypesEnum SV = ElsetFullSourcedDataTypesEnum._(5);
  static const Map<int, ElsetFullSourcedDataTypesEnum> values = {
    0: EO,
    1: RADAR,
    2: RF,
    3: DOA,
  ...
  static const fb.Reader<ElsetFullSourcedDataTypesEnum> reader = _ElsetFullSourcedDataTypesEnumReader();

  @override
  String toString() {
    return 'ElsetFullSourcedDataTypesEnum{value: $value}';
  }
}

class _ElsetFullSourcedDataTypesEnumReader extends fb.Reader<ElsetFullSourcedDataTypesEnum> {
  const _ElsetFullSourcedDataTypesEnumReader();

  @override
  int get size => 1;

  @override
  ElsetFullSourcedDataTypesEnum read(fb.BufferContext bc, int offset) =>
      ElsetFullSourcedDataTypesEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class ElsetFull {
  ElsetFull._(this._bc, this._bcOffset);
  factory ElsetFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<ElsetFull> reader = _ElsetFullReader();
  ...
  ///  Constraints: No constraints specified.
  String? get effectiveFrom => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 52);
  ...
  ///  Example: /// Example: 2018-01-01T16:00:00.123Z
  ///  Constraints: No constraints specified.
  String? get effectiveUntil => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 54);
  ...
  String? get line1 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 56);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 69
  String? get line2 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 58);
  ///  Optional source-provided and searchable metadata or descriptor of the data.
  ///  Example: /// Example: Example description
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get descriptor => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 60);
  ...
  String? get rawFileUri => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 66);
  ...
  ElsetFullDataModeEnum get dataMode => ElsetFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 74, 0));
  ///  Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
  ///  Example: /// Example: ['PROVIDER_TAG1', 'PROVIDER_TAG2']
  ///  Constraints: No constraints specified.
  List<String>? get tags => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 76);
  ///  Optional algorithm used to produce this record.
  ///  Example: /// Example: Example algorithm
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get algorithm => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 78);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get sourcedData => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 80);
  ...
  ///  Constraints: No constraints specified.
  ElsetFullSourcedDataTypesEnum get sourcedDataTypes => ElsetFullSourcedDataTypesEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 82, 0));
  ...
  ///  Example: /// Example: 1
  ///  Constraints: No constraints specified.
  int get ephemType => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 86, 0);
  ...
  ///  Constraints: No constraints specified.
  String? get onOrbit => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 90);

  @override
  String toString() {
    return 'ElsetFull{idElset: ${idElset}, classificationMarking: ${classificationMarking}, satNo: ${satNo}, epoch: ${epoch}, meanMotion: ${meanMotion}, idOnOrbit: ${idOnOrbit}, uct: ${uct}, eccentricity: ${eccentricity}, inclination: ${inclination}, raan: ${raan}, argOfPerigee: ${argOfPerigee}, meanAnomaly: ${meanAnomaly}, revNo: ${revNo}, bStar: ${bStar}, agom: ${agom}, ballisticCoeff: ${ballisticCoeff}, meanMotionDot: ${meanMotionDot}, meanMotionDdot: ${meanMotionDdot}, semiMajorAxis: ${semiMajorAxis}, period: ${period}, apogee: ${apogee}, perigee: ${perigee}, origObjectId: ${origObjectId}, idOrbitDetermination: ${idOrbitDetermination}, effectiveFrom: ${effectiveFrom}, effectiveUntil: ${effectiveUntil}, line1: ${line1}, line2: ${line2}, descriptor: ${descriptor}, createdAt: ${createdAt}, createdBy: ${createdBy}, rawFileUri: ${rawFileUri}, origin: ${origin}, sourceDl: ${sourceDl}, source: ${source}, dataMode: ${dataMode}, tags: ${tags}, algorithm: ${algorithm}, sourcedData: ${sourcedData}, sourcedDataTypes: ${sourcedDataTypes}, transactionId: ${transactionId}, ephemType: ${ephemType}, origNetwork: ${origNetwork}, onOrbit: ${onOrbit}}';
  }
}

class _ElsetFullReader extends fb.TableReader<ElsetFull> {
  const _ElsetFullReader();

  @override
  ElsetFull createObject(fb.BufferContext bc, int offset) => 
    ElsetFull._(bc, offset);
}

class ElsetFullBuilder {
  ElsetFullBuilder(this.fbBuilder);
  ...
  int addDataMode(ElsetFullDataModeEnum? dataMode) {
  ...
  int addSourcedDataTypes(ElsetFullSourcedDataTypesEnum? sourcedDataTypes) {
    fbBuilder.addInt8(39, sourcedDataTypes?.value);
    return fbBuilder.offset;
  }
  ...
  int addEphemType(int? ephemType) {
    fbBuilder.addInt32(41, ephemType);
    return fbBuilder.offset;
  }
...
class ElsetFullObjectBuilder extends fb.ObjectBuilder {
  ...
  final ElsetFullDataModeEnum? _dataMode;
  final List<String>? _tags;
  final String? _algorithm;
  final List<String>? _sourcedData;
  final ElsetFullSourcedDataTypesEnum? _sourcedDataTypes;
  final String? _transactionId;
  final int? _ephemType;
  final String? _origNetwork;
  final String? _onOrbit;

  ElsetFullObjectBuilder({
    String? idElset,
    ...
    String? sourceDl,
    String? source,
    ElsetFullDataModeEnum? dataMode,
    List<String>? tags,
    String? algorithm,
    List<String>? sourcedData,
    ElsetFullSourcedDataTypesEnum? sourcedDataTypes,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(24, effectiveFromOffset);
    fbBuilder.addOffset(25, effectiveUntilOffset);
    fbBuilder.addOffset(26, line1Offset);
    fbBuilder.addOffset(27, line2Offset);
    fbBuilder.addOffset(28, descriptorOffset);
    fbBuilder.addOffset(29, createdAtOffset);
    fbBuilder.addOffset(30, createdByOffset);
    fbBuilder.addOffset(31, rawFileUriOffset);
    ...
    fbBuilder.addOffset(36, tagsOffset);
    fbBuilder.addOffset(37, algorithmOffset);
    fbBuilder.addOffset(38, sourcedDataOffset);
    fbBuilder.addInt8(39, _sourcedDataTypes?.value);
    fbBuilder.addOffset(40, transactionIdOffset);
    fbBuilder.addInt32(41, _ephemType);
    fbBuilder.addOffset(42, origNetworkOffset);
    fbBuilder.addOffset(43, onOrbitOffset);
    return fbBuilder.endTable();
  }
