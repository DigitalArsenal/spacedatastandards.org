...
class AircraftMissionRequirementsIngest {
  AircraftMissionRequirementsIngest._(this._bc, this._bcOffset);
  factory AircraftMissionRequirementsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AircraftMissionRequirementsIngest> reader = _AircraftMissionRequirementsIngestReader();
  ...
  @override
  String toString() {
    return 'AircraftMissionRequirementsIngest{gdssReqId: ${gdssReqId}, onloadId: ${onloadId}, onloadLocode: ${onloadLocode}, offloadId: ${offloadId}, offloadLocode: ${offloadLocode}, uln: ${uln}, transReqNum: ${transReqNum}, projName: ${projName}, oplan: ${oplan}, numPax: ${numPax}, numLitter: ${numLitter}, numAmbulatory: ${numAmbulatory}, numAttendant: ${numAttendant}, bulkWeight: ${bulkWeight}, oversizeWeight: ${oversizeWeight}, outsizeWeight: ${outsizeWeight}, ead: ${ead}, lad: ${lad}}';
  }
}

class _AircraftMissionRequirementsIngestReader extends fb.TableReader<AircraftMissionRequirementsIngest> {
  const _AircraftMissionRequirementsIngestReader();

  @override
  AircraftMissionRequirementsIngest createObject(fb.BufferContext bc, int offset) => 
    AircraftMissionRequirementsIngest._(bc, offset);
}

class AircraftMissionRequirementsIngestBuilder {
  AircraftMissionRequirementsIngestBuilder(this.fbBuilder);
...
class AircraftMissionRequirementsIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  AircraftMissionRequirementsIngestObjectBuilder({
    String? gdssReqId,
    int? onloadId,
    String? onloadLocode,
    int? offloadId,
