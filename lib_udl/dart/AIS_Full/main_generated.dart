...
class AisFullDataModeEnum {
  final int value;
  const AisFullDataModeEnum._(this.value);

  factory AisFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AisFullDataModeEnum');
    }
    return result;
  }

  static AisFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AisFullDataModeEnum.fromValue(value);
  ...
  static const AisFullDataModeEnum REAL = AisFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AisFullDataModeEnum TEST = AisFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AisFullDataModeEnum SIMULATED = AisFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AisFullDataModeEnum EXERCISE = AisFullDataModeEnum._(3);
  static const Map<int, AisFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AisFullDataModeEnum> reader = _AisFullDataModeEnumReader();

  @override
  String toString() {
    return 'AisFullDataModeEnum{value: $value}';
  }
}

class _AisFullDataModeEnumReader extends fb.Reader<AisFullDataModeEnum> {
  const _AisFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AisFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      AisFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AisFull {
  AisFull._(this._bc, this._bcOffset);
  factory AisFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AisFull> reader = _AisFullReader();
  ...
  AisFullDataModeEnum get dataMode => AisFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 102, 0));
...
class AisFullBuilder {
  ...
  int addDataMode(AisFullDataModeEnum? dataMode) {
...
class AisFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AisFullDataModeEnum? _dataMode;
  final String? _origNetwork;

  AisFullObjectBuilder({
    String? id,
