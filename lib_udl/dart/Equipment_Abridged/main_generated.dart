...
class EquipmentAbridgedDataModeEnum {
  final int value;
  const EquipmentAbridgedDataModeEnum._(this.value);

  factory EquipmentAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EquipmentAbridgedDataModeEnum');
    }
    return result;
  }

  static EquipmentAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EquipmentAbridgedDataModeEnum.fromValue(value);
  ...
  static const EquipmentAbridgedDataModeEnum REAL = EquipmentAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EquipmentAbridgedDataModeEnum TEST = EquipmentAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EquipmentAbridgedDataModeEnum SIMULATED = EquipmentAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EquipmentAbridgedDataModeEnum EXERCISE = EquipmentAbridgedDataModeEnum._(3);
  static const Map<int, EquipmentAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EquipmentAbridgedDataModeEnum> reader = _EquipmentAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'EquipmentAbridgedDataModeEnum{value: $value}';
  }
}

class _EquipmentAbridgedDataModeEnumReader extends fb.Reader<EquipmentAbridgedDataModeEnum> {
  const _EquipmentAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EquipmentAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      EquipmentAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Properties and characteristics of equipment that can be associated with a site or other entity.
class EquipmentAbridged {
  EquipmentAbridged._(this._bc, this._bcOffset);
  factory EquipmentAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EquipmentAbridged> reader = _EquipmentAbridgedReader();
...
class EquipmentAbridgedBuilder {
  ...
  int addDataMode(EquipmentAbridgedDataModeEnum? dataMode) {
...
class EquipmentAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EquipmentAbridgedDataModeEnum? _dataMode;

  EquipmentAbridgedObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    EquipmentAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
