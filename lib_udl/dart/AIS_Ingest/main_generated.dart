...
class AisIngestDataModeEnum {
  final int value;
  const AisIngestDataModeEnum._(this.value);

  factory AisIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AisIngestDataModeEnum');
    }
    return result;
  }

  static AisIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AisIngestDataModeEnum.fromValue(value);
  ...
  static const AisIngestDataModeEnum REAL = AisIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AisIngestDataModeEnum TEST = AisIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AisIngestDataModeEnum SIMULATED = AisIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AisIngestDataModeEnum EXERCISE = AisIngestDataModeEnum._(3);
  static const Map<int, AisIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AisIngestDataModeEnum> reader = _AisIngestDataModeEnumReader();

  @override
  String toString() {
    return 'AisIngestDataModeEnum{value: $value}';
  }
}

class _AisIngestDataModeEnumReader extends fb.Reader<AisIngestDataModeEnum> {
  const _AisIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AisIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      AisIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AisIngest {
  AisIngest._(this._bc, this._bcOffset);
  factory AisIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AisIngest> reader = _AisIngestReader();
  ...
  AisIngestDataModeEnum get dataMode => AisIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 102, 0));
...
class AisIngestBuilder {
  ...
  int addDataMode(AisIngestDataModeEnum? dataMode) {
...
class AisIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AisIngestDataModeEnum? _dataMode;
  final String? _origNetwork;

  AisIngestObjectBuilder({
    String? id,
    ...
    String? sourceDl,
    String? origin,
    AisIngestDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
