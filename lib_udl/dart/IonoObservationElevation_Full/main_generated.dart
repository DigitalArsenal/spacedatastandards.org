...
class IonoObservationElevationFull {
  IonoObservationElevationFull._(this._bc, this._bcOffset);
  factory IonoObservationElevationFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationElevationFull> reader = _IonoObservationElevationFullReader();
  ...
  @override
  String toString() {
    return 'IonoObservationElevationFull{notes: ${notes}, dimensions: ${dimensions}, dimensionName: ${dimensionName}, data: ${data}}';
  }
}

class _IonoObservationElevationFullReader extends fb.TableReader<IonoObservationElevationFull> {
  const _IonoObservationElevationFullReader();

  @override
  IonoObservationElevationFull createObject(fb.BufferContext bc, int offset) => 
    IonoObservationElevationFull._(bc, offset);
}

class IonoObservationElevationFullBuilder {
  IonoObservationElevationFullBuilder(this.fbBuilder);
...
class IonoObservationElevationFullObjectBuilder extends fb.ObjectBuilder {
  final String? _notes;
  final List<String>? _dimensions;
  final List<String>? _dimensionName;
  final List<String>? _data;

  IonoObservationElevationFullObjectBuilder({
    String? notes,
