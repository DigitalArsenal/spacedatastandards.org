...
class OnorbitDetailsAbridgedDataModeEnum {
  final int value;
  const OnorbitDetailsAbridgedDataModeEnum._(this.value);

  factory OnorbitDetailsAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OnorbitDetailsAbridgedDataModeEnum');
    }
    return result;
  }

  static OnorbitDetailsAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OnorbitDetailsAbridgedDataModeEnum.fromValue(value);
  ...
  static const OnorbitDetailsAbridgedDataModeEnum REAL = OnorbitDetailsAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OnorbitDetailsAbridgedDataModeEnum TEST = OnorbitDetailsAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OnorbitDetailsAbridgedDataModeEnum SIMULATED = OnorbitDetailsAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OnorbitDetailsAbridgedDataModeEnum EXERCISE = OnorbitDetailsAbridgedDataModeEnum._(3);
  static const Map<int, OnorbitDetailsAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OnorbitDetailsAbridgedDataModeEnum> reader = _OnorbitDetailsAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'OnorbitDetailsAbridgedDataModeEnum{value: $value}';
  }
}

class _OnorbitDetailsAbridgedDataModeEnumReader extends fb.Reader<OnorbitDetailsAbridgedDataModeEnum> {
  const _OnorbitDetailsAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OnorbitDetailsAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      OnorbitDetailsAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Contains details of the OnOrbit object.
class OnorbitDetailsAbridged {
  OnorbitDetailsAbridged._(this._bc, this._bcOffset);
  factory OnorbitDetailsAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OnorbitDetailsAbridged> reader = _OnorbitDetailsAbridgedReader();
  ...
  OnorbitDetailsAbridgedDataModeEnum get dataMode => OnorbitDetailsAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 92, 0));
  ...
  @override
  String toString() {
    return 'OnorbitDetailsAbridged{id: ${id}, idOnOrbit: ${idOnOrbit}, classificationMarking: ${classificationMarking}, lastObTime: ${lastObTime}, vismag: ${vismag}, vismagMin: ${vismagMin}, vismagMax: ${vismagMax}, vismagMean: ${vismagMean}, rcs: ${rcs}, rcsMin: ${rcsMin}, rcsMax: ${rcsMax}, rcsMean: ${rcsMean}, bolDeltaV: ${bolDeltaV}, maxDeltaV: ${maxDeltaV}, deltaVunc: ${deltaVunc}, estDeltaVduration: ${estDeltaVduration}, numMission: ${numMission}, missionTypes: ${missionTypes}, busType: ${busType}, geoSlot: ${geoSlot}, driftRate: ${driftRate}, dryMass: ${dryMass}, additionalMass: ${additionalMass}, launchMassMin: ${launchMassMin}, launchMass: ${launchMass}, launchMassMax: ${launchMassMax}, bolFuelMass: ${bolFuelMass}, currentMass: ${currentMass}, totalMassUnc: ${totalMassUnc}, solarArrayArea: ${solarArrayArea}, maneuverable: ${maneuverable}, fuelRemaining: ${fuelRemaining}, crossSection: ${crossSection}, busCrossSection: ${busCrossSection}, maxRadius: ${maxRadius}, colaRadius: ${colaRadius}, adeptRadius: ${adeptRadius}, numDeployable: ${numDeployable}, depNames: ${depNames}, depEstMasses: ${depEstMasses}, depMassUncs: ${depMassUncs}, source: ${source}, origin: ${origin}, lastObSource: ${lastObSource}, dataMode: ${dataMode}, createdAt: ${createdAt}, createdBy: ${createdBy}, origNetwork: ${origNetwork}}';
  }
}

class _OnorbitDetailsAbridgedReader extends fb.TableReader<OnorbitDetailsAbridged> {
  const _OnorbitDetailsAbridgedReader();

  @override
  OnorbitDetailsAbridged createObject(fb.BufferContext bc, int offset) => 
    OnorbitDetailsAbridged._(bc, offset);
}

class OnorbitDetailsAbridgedBuilder {
  OnorbitDetailsAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(OnorbitDetailsAbridgedDataModeEnum? dataMode) {
...
class OnorbitDetailsAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final OnorbitDetailsAbridgedDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final String? _origNetwork;

  OnorbitDetailsAbridgedObjectBuilder({
    String? id,
    String? idOnOrbit,
    ...
    String? origin,
    String? lastObSource,
    OnorbitDetailsAbridgedDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? origNetwork,
  })
