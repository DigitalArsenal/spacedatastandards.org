...
class OrganizationDetailsFullDataModeEnum {
  final int value;
  const OrganizationDetailsFullDataModeEnum._(this.value);

  factory OrganizationDetailsFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OrganizationDetailsFullDataModeEnum');
    }
    return result;
  }

  static OrganizationDetailsFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OrganizationDetailsFullDataModeEnum.fromValue(value);
  ...
  static const OrganizationDetailsFullDataModeEnum REAL = OrganizationDetailsFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OrganizationDetailsFullDataModeEnum TEST = OrganizationDetailsFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OrganizationDetailsFullDataModeEnum SIMULATED = OrganizationDetailsFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OrganizationDetailsFullDataModeEnum EXERCISE = OrganizationDetailsFullDataModeEnum._(3);
  static const Map<int, OrganizationDetailsFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OrganizationDetailsFullDataModeEnum> reader = _OrganizationDetailsFullDataModeEnumReader();

  @override
  String toString() {
    return 'OrganizationDetailsFullDataModeEnum{value: $value}';
  }
}

class _OrganizationDetailsFullDataModeEnumReader extends fb.Reader<OrganizationDetailsFullDataModeEnum> {
  const _OrganizationDetailsFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OrganizationDetailsFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      OrganizationDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class OrganizationDetailsFull {
  OrganizationDetailsFull._(this._bc, this._bcOffset);
  factory OrganizationDetailsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OrganizationDetailsFull> reader = _OrganizationDetailsFullReader();
  ...
  OrganizationDetailsFullDataModeEnum get dataMode => OrganizationDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 68, 0));
...
class OrganizationDetailsFullBuilder {
  ...
  int addDataMode(OrganizationDetailsFullDataModeEnum? dataMode) {
...
class OrganizationDetailsFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final OrganizationDetailsFullDataModeEnum? _dataMode;
  ...
  OrganizationDetailsFullObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    OrganizationDetailsFullDataModeEnum? dataMode,
    List<String>? tags,
    String? createdAt,
    String? createdBy,
    String? updatedAt,
