...
class TrackDetailsIngestEnvEnum {
  final int value;
  const TrackDetailsIngestEnvEnum._(this.value);

  factory TrackDetailsIngestEnvEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum TrackDetailsIngestEnvEnum');
    }
    return result;
  }

  static TrackDetailsIngestEnvEnum? _createOrNull(int? value) => 
      value == null ? null : TrackDetailsIngestEnvEnum.fromValue(value);
  ...
  static const TrackDetailsIngestEnvEnum AIR = TrackDetailsIngestEnvEnum._(0);

  ///  On the surface of dry land.
  static const TrackDetailsIngestEnvEnum LAND = TrackDetailsIngestEnvEnum._(1);

  ///  Above the Kármán line, which has an altitude of 100 kilometers (62 miles).
  static const TrackDetailsIngestEnvEnum SPACE = TrackDetailsIngestEnvEnum._(2);

  ///  On the surface of a body of water.
  static const TrackDetailsIngestEnvEnum SURFACE = TrackDetailsIngestEnvEnum._(3);

  ///  Below the surface of a body of water.
  static const TrackDetailsIngestEnvEnum SUBSURFACE = TrackDetailsIngestEnvEnum._(4);

  ///  Environment is not known.
  static const TrackDetailsIngestEnvEnum UNKNOWN = TrackDetailsIngestEnvEnum._(5);
  static const Map<int, TrackDetailsIngestEnvEnum> values = {
    0: AIR,
    1: LAND,
    2: SPACE,
    3: SURFACE,
  ...
  static const fb.Reader<TrackDetailsIngestEnvEnum> reader = _TrackDetailsIngestEnvEnumReader();

  @override
  String toString() {
    return 'TrackDetailsIngestEnvEnum{value: $value}';
  }
}

class _TrackDetailsIngestEnvEnumReader extends fb.Reader<TrackDetailsIngestEnvEnum> {
  const _TrackDetailsIngestEnvEnumReader();

  @override
  int get size => 1;

  @override
  TrackDetailsIngestEnvEnum read(fb.BufferContext bc, int offset) =>
      TrackDetailsIngestEnvEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class TrackDetailsIngestObjIdentEnum {
  final int value;
  const TrackDetailsIngestObjIdentEnum._(this.value);

  factory TrackDetailsIngestObjIdentEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum TrackDetailsIngestObjIdentEnum');
    }
    return result;
  }

  static TrackDetailsIngestObjIdentEnum? _createOrNull(int? value) => 
      value == null ? null : TrackDetailsIngestObjIdentEnum.fromValue(value);
  ...
  static const TrackDetailsIngestObjIdentEnum ASSUMED_FRIEND = TrackDetailsIngestObjIdentEnum._(0);

  ///  Track object supporting friendly forces and belonging to a declared friendly nation or entity.
  static const TrackDetailsIngestObjIdentEnum FRIEND = TrackDetailsIngestObjIdentEnum._(1);
  ...
  static const TrackDetailsIngestObjIdentEnum HOSTILE = TrackDetailsIngestObjIdentEnum._(2);
  ...
  static const TrackDetailsIngestObjIdentEnum NEUTRAL = TrackDetailsIngestObjIdentEnum._(3);

  ///  Track object which has not been evaluated.
  static const TrackDetailsIngestObjIdentEnum PENDING = TrackDetailsIngestObjIdentEnum._(4);

  ///  Track object deemed potentially hostile due to the object characteristics, behavior, nationality, and/or origin.
  static const TrackDetailsIngestObjIdentEnum SUSPECT = TrackDetailsIngestObjIdentEnum._(5);

  ///  Track object which has been evaluated and does not meet criteria for any standard identity.
  static const TrackDetailsIngestObjIdentEnum UNKNOWN = TrackDetailsIngestObjIdentEnum._(6);
  static const Map<int, TrackDetailsIngestObjIdentEnum> values = {
    0: ASSUMED_FRIEND,
    1: FRIEND,
    2: HOSTILE,
    3: NEUTRAL,
  ...
  static const fb.Reader<TrackDetailsIngestObjIdentEnum> reader = _TrackDetailsIngestObjIdentEnumReader();

  @override
  String toString() {
    return 'TrackDetailsIngestObjIdentEnum{value: $value}';
  }
}

class _TrackDetailsIngestObjIdentEnumReader extends fb.Reader<TrackDetailsIngestObjIdentEnum> {
  const _TrackDetailsIngestObjIdentEnumReader();

  @override
  int get size => 1;

  @override
  TrackDetailsIngestObjIdentEnum read(fb.BufferContext bc, int offset) =>
      TrackDetailsIngestObjIdentEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class TrackDetailsIngestDataModeEnum {
  final int value;
  const TrackDetailsIngestDataModeEnum._(this.value);

  factory TrackDetailsIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum TrackDetailsIngestDataModeEnum');
    }
    return result;
  }

  static TrackDetailsIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : TrackDetailsIngestDataModeEnum.fromValue(value);
  ...
  static const TrackDetailsIngestDataModeEnum REAL = TrackDetailsIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const TrackDetailsIngestDataModeEnum TEST = TrackDetailsIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const TrackDetailsIngestDataModeEnum SIMULATED = TrackDetailsIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const TrackDetailsIngestDataModeEnum EXERCISE = TrackDetailsIngestDataModeEnum._(3);
  static const Map<int, TrackDetailsIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<TrackDetailsIngestDataModeEnum> reader = _TrackDetailsIngestDataModeEnumReader();

  @override
  String toString() {
    return 'TrackDetailsIngestDataModeEnum{value: $value}';
  }
}

class _TrackDetailsIngestDataModeEnumReader extends fb.Reader<TrackDetailsIngestDataModeEnum> {
  const _TrackDetailsIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  TrackDetailsIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      TrackDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class TrackDetailsIngest {
  TrackDetailsIngest._(this._bc, this._bcOffset);
  factory TrackDetailsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<TrackDetailsIngest> reader = _TrackDetailsIngestReader();
  ...
  TrackDetailsIngestEnvEnum get env => TrackDetailsIngestEnvEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 8, 0));
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 32
  TrackDetailsIngestObjIdentEnum get objIdent => TrackDetailsIngestObjIdentEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 50, 0));
  ...
  TrackDetailsIngestDataModeEnum get dataMode => TrackDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 316, 0));
...
class TrackDetailsIngestBuilder {
  ...
  int addEnv(TrackDetailsIngestEnvEnum? env) {
  ...
  int addObjIdent(TrackDetailsIngestObjIdentEnum? objIdent) {
  ...
  int addDataMode(TrackDetailsIngestDataModeEnum? dataMode) {
...
class TrackDetailsIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _classificationMarking;
  final TrackDetailsIngestEnvEnum? _env;
  ...
  final TrackDetailsIngestObjIdentEnum? _objIdent;
  ...
  final TrackDetailsIngestDataModeEnum? _dataMode;
  final String? _origNetwork;

  TrackDetailsIngestObjectBuilder({
    String? id,
    String? classificationMarking,
    TrackDetailsIngestEnvEnum? env,
    String? msgType,
    String? hullNum,
    String? pif,
    String? sconum,
    ...
    String? elnot1,
    String? elnot2,
    TrackDetailsIngestObjIdentEnum? objIdent,
    String? objType,
    String? objPlat,
    String? objAct,
    String? objNat,
    ...
    String? source,
    String? origin,
    TrackDetailsIngestDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
