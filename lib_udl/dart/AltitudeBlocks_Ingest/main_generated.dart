...
class AltitudeBlocksIngest {
  AltitudeBlocksIngest._(this._bc, this._bcOffset);
  factory AltitudeBlocksIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AltitudeBlocksIngest> reader = _AltitudeBlocksIngestReader();
  ...
  @override
  String toString() {
    return 'AltitudeBlocksIngest{altitudeSequenceId: ${altitudeSequenceId}, lowerAltitude: ${lowerAltitude}, upperAltitude: ${upperAltitude}}';
  }
}

class _AltitudeBlocksIngestReader extends fb.TableReader<AltitudeBlocksIngest> {
  const _AltitudeBlocksIngestReader();

  @override
  AltitudeBlocksIngest createObject(fb.BufferContext bc, int offset) => 
    AltitudeBlocksIngest._(bc, offset);
}

class AltitudeBlocksIngestBuilder {
  AltitudeBlocksIngestBuilder(this.fbBuilder);
...
class AltitudeBlocksIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _altitudeSequenceId;
  final double? _lowerAltitude;
  final double? _upperAltitude;

  AltitudeBlocksIngestObjectBuilder({
