...
class LogisticsSupportAbridgedDataModeEnum {
  final int value;
  const LogisticsSupportAbridgedDataModeEnum._(this.value);

  factory LogisticsSupportAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum LogisticsSupportAbridgedDataModeEnum');
    }
    return result;
  }

  static LogisticsSupportAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : LogisticsSupportAbridgedDataModeEnum.fromValue(value);
  ...
  static const LogisticsSupportAbridgedDataModeEnum REAL = LogisticsSupportAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const LogisticsSupportAbridgedDataModeEnum TEST = LogisticsSupportAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const LogisticsSupportAbridgedDataModeEnum SIMULATED = LogisticsSupportAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const LogisticsSupportAbridgedDataModeEnum EXERCISE = LogisticsSupportAbridgedDataModeEnum._(3);
  static const Map<int, LogisticsSupportAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<LogisticsSupportAbridgedDataModeEnum> reader = _LogisticsSupportAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'LogisticsSupportAbridgedDataModeEnum{value: $value}';
  }
}

class _LogisticsSupportAbridgedDataModeEnumReader extends fb.Reader<LogisticsSupportAbridgedDataModeEnum> {
  const _LogisticsSupportAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  LogisticsSupportAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      LogisticsSupportAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class LogisticsSupportAbridged {
  LogisticsSupportAbridged._(this._bc, this._bcOffset);
  factory LogisticsSupportAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LogisticsSupportAbridged> reader = _LogisticsSupportAbridgedReader();
  ...
  LogisticsSupportAbridgedDataModeEnum get dataMode => LogisticsSupportAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 62, 0));

  @override
  String toString() {
    return 'LogisticsSupportAbridged{id: ${id}, classificationMarking: ${classificationMarking}, extSystemId: ${extSystemId}, tailNumber: ${tailNumber}, aircraftMds: ${aircraftMds}, currIcao: ${currIcao}, suppIcao: ${suppIcao}, rptCreatedTime: ${rptCreatedTime}, rptClosedTime: ${rptClosedTime}, meTime: ${meTime}, mcTime: ${mcTime}, logisticAction: ${logisticAction}, logisticsRecordId: ${logisticsRecordId}, etic: ${etic}, etmc: ${etmc}, maintStatusCode: ${maintStatusCode}, reopenFlag: ${reopenFlag}, owner: ${owner}, logisticsRemarks: ${logisticsRemarks}, logisticsDiscrepancyInfos: ${logisticsDiscrepancyInfos}, logisticsTransportationPlans: ${logisticsTransportationPlans}, logisticsSupportItems: ${logisticsSupportItems}, origNetwork: ${origNetwork}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}}';
  }
}

class _LogisticsSupportAbridgedReader extends fb.TableReader<LogisticsSupportAbridged> {
  const _LogisticsSupportAbridgedReader();

  @override
  LogisticsSupportAbridged createObject(fb.BufferContext bc, int offset) => 
    LogisticsSupportAbridged._(bc, offset);
}

class LogisticsSupportAbridgedBuilder {
  LogisticsSupportAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(LogisticsSupportAbridgedDataModeEnum? dataMode) {
...
class LogisticsSupportAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final LogisticsSupportAbridgedDataModeEnum? _dataMode;

  LogisticsSupportAbridgedObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    LogisticsSupportAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
