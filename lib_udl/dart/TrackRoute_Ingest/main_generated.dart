...
class TrackRouteIngestDataModeEnum {
  final int value;
  const TrackRouteIngestDataModeEnum._(this.value);

  factory TrackRouteIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum TrackRouteIngestDataModeEnum');
    }
    return result;
  }

  static TrackRouteIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : TrackRouteIngestDataModeEnum.fromValue(value);
  ...
  static const TrackRouteIngestDataModeEnum REAL = TrackRouteIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const TrackRouteIngestDataModeEnum TEST = TrackRouteIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const TrackRouteIngestDataModeEnum SIMULATED = TrackRouteIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const TrackRouteIngestDataModeEnum EXERCISE = TrackRouteIngestDataModeEnum._(3);
  static const Map<int, TrackRouteIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<TrackRouteIngestDataModeEnum> reader = _TrackRouteIngestDataModeEnumReader();

  @override
  String toString() {
    return 'TrackRouteIngestDataModeEnum{value: $value}';
  }
}

class _TrackRouteIngestDataModeEnumReader extends fb.Reader<TrackRouteIngestDataModeEnum> {
  const _TrackRouteIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  TrackRouteIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      TrackRouteIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class TrackRouteIngest {
  TrackRouteIngest._(this._bc, this._bcOffset);
  factory TrackRouteIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<TrackRouteIngest> reader = _TrackRouteIngestReader();
...
class TrackRouteIngestBuilder {
  ...
  int addDataMode(TrackRouteIngestDataModeEnum? dataMode) {
...
class TrackRouteIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final TrackRouteIngestDataModeEnum? _dataMode;

  TrackRouteIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    TrackRouteIngestDataModeEnum? dataMode,
  })
      : _id = id,
