...
class AirEventReceiversFull {
  AirEventReceiversFull._(this._bc, this._bcOffset);
  factory AirEventReceiversFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirEventReceiversFull> reader = _AirEventReceiversFullReader();
...
class AirEventReceiversFullObjectBuilder extends fb.ObjectBuilder {
  ...
  AirEventReceiversFullObjectBuilder({
