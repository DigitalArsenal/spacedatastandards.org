...
class SwirIngestDataModeEnum {
  final int value;
  const SwirIngestDataModeEnum._(this.value);

  factory SwirIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SwirIngestDataModeEnum');
    }
    return result;
  }

  static SwirIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SwirIngestDataModeEnum.fromValue(value);
  ...
  static const SwirIngestDataModeEnum REAL = SwirIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SwirIngestDataModeEnum TEST = SwirIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SwirIngestDataModeEnum SIMULATED = SwirIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SwirIngestDataModeEnum EXERCISE = SwirIngestDataModeEnum._(3);
  static const Map<int, SwirIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SwirIngestDataModeEnum> reader = _SwirIngestDataModeEnumReader();

  @override
  String toString() {
    return 'SwirIngestDataModeEnum{value: $value}';
  }
}

class _SwirIngestDataModeEnumReader extends fb.Reader<SwirIngestDataModeEnum> {
  const _SwirIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SwirIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      SwirIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Data representing observed short wave infrared (SWIR) measurements.
class SwirIngest {
  SwirIngest._(this._bc, this._bcOffset);
  factory SwirIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SwirIngest> reader = _SwirIngestReader();
  ...
  ///  Constraints: No constraints specified.
  List<String>? get wavelengths => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 22);
  ...
  ///  Example: /// Example: [1.23, 4.56]
  ///  Constraints: No constraints specified.
  List<String>? get absFluxes => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 24);
  ///  Array of ratio wavelength data. This array should correspond with the same-sized array of fluxRatios.
  ///  Example: /// Example: [1.23, 4.56]
  ///  Constraints: No constraints specified.
  List<String>? get ratioWavelengths => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 26);
  ///  Array of flux ratio data. This array should correspond with the same-sized array of ratioWavelengths.
  ///  Example: /// Example: [1.23, 4.56]
  ///  Constraints: No constraints specified.
  List<String>? get fluxRatios => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 28);
  ...
  ///  Constraints: No constraints specified.
  int get satNo => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 36, 0);
  ...
  SwirIngestDataModeEnum get dataMode => SwirIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 38, 0));
  ...
  @override
  String toString() {
    return 'SwirIngest{id: ${id}, classificationMarking: ${classificationMarking}, idOnOrbit: ${idOnOrbit}, ts: ${ts}, solarPhaseAngle: ${solarPhaseAngle}, lat: ${lat}, lon: ${lon}, locationName: ${locationName}, badWave: ${badWave}, wavelengths: ${wavelengths}, absFluxes: ${absFluxes}, ratioWavelengths: ${ratioWavelengths}, fluxRatios: ${fluxRatios}, origObjectId: ${origObjectId}, source: ${source}, origin: ${origin}, satNo: ${satNo}, dataMode: ${dataMode}, createdAt: ${createdAt}, createdBy: ${createdBy}, origNetwork: ${origNetwork}}';
  }
}

class _SwirIngestReader extends fb.TableReader<SwirIngest> {
  const _SwirIngestReader();

  @override
  SwirIngest createObject(fb.BufferContext bc, int offset) => 
    SwirIngest._(bc, offset);
}

class SwirIngestBuilder {
  SwirIngestBuilder(this.fbBuilder);
  ...
  int addSatNo(int? satNo) {
    fbBuilder.addInt32(16, satNo);
    return fbBuilder.offset;
  }
  int addDataMode(SwirIngestDataModeEnum? dataMode) {
...
class SwirIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final int? _satNo;
  final SwirIngestDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final String? _origNetwork;

  SwirIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    int? satNo,
    SwirIngestDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? origNetwork,
  })
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(9, wavelengthsOffset);
    fbBuilder.addOffset(10, absFluxesOffset);
    fbBuilder.addOffset(11, ratioWavelengthsOffset);
    fbBuilder.addOffset(12, fluxRatiosOffset);
    fbBuilder.addOffset(13, origObjectIdOffset);
    fbBuilder.addOffset(14, sourceOffset);
    fbBuilder.addOffset(15, originOffset);
    fbBuilder.addInt32(16, _satNo);
