...
class IsrcollectionCriticalTimesFull {
  IsrcollectionCriticalTimesFull._(this._bc, this._bcOffset);
  factory IsrcollectionCriticalTimesFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IsrcollectionCriticalTimesFull> reader = _IsrcollectionCriticalTimesFullReader();
  ...
  @override
  String toString() {
    return 'IsrcollectionCriticalTimesFull{earliestImagingTime: ${earliestImagingTime}, latestImagingTime: ${latestImagingTime}}';
  }
}

class _IsrcollectionCriticalTimesFullReader extends fb.TableReader<IsrcollectionCriticalTimesFull> {
  const _IsrcollectionCriticalTimesFullReader();

  @override
  IsrcollectionCriticalTimesFull createObject(fb.BufferContext bc, int offset) => 
    IsrcollectionCriticalTimesFull._(bc, offset);
}

class IsrcollectionCriticalTimesFullBuilder {
  IsrcollectionCriticalTimesFullBuilder(this.fbBuilder);
...
class IsrcollectionCriticalTimesFullObjectBuilder extends fb.ObjectBuilder {
  final String? _earliestImagingTime;
  final String? _latestImagingTime;

  IsrcollectionCriticalTimesFullObjectBuilder({
