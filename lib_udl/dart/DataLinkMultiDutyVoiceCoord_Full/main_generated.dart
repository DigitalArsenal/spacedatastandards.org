...
class DataLinkMultiDutyVoiceCoordFull {
  DataLinkMultiDutyVoiceCoordFull._(this._bc, this._bcOffset);
  factory DataLinkMultiDutyVoiceCoordFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DataLinkMultiDutyVoiceCoordFull> reader = _DataLinkMultiDutyVoiceCoordFullReader();
  ...
  @override
  String toString() {
    return 'DataLinkMultiDutyVoiceCoordFull{multiVoiceNetDes: ${multiVoiceNetDes}, multiFreqDes: ${multiFreqDes}, multiCommPri: ${multiCommPri}, multiTeleFreqNums: ${multiTeleFreqNums}}';
  }
}

class _DataLinkMultiDutyVoiceCoordFullReader extends fb.TableReader<DataLinkMultiDutyVoiceCoordFull> {
  const _DataLinkMultiDutyVoiceCoordFullReader();

  @override
  DataLinkMultiDutyVoiceCoordFull createObject(fb.BufferContext bc, int offset) => 
    DataLinkMultiDutyVoiceCoordFull._(bc, offset);
}

class DataLinkMultiDutyVoiceCoordFullBuilder {
  DataLinkMultiDutyVoiceCoordFullBuilder(this.fbBuilder);
...
class DataLinkMultiDutyVoiceCoordFullObjectBuilder extends fb.ObjectBuilder {
  final String? _multiVoiceNetDes;
  final String? _multiFreqDes;
  final String? _multiCommPri;
  final List<String>? _multiTeleFreqNums;

  DataLinkMultiDutyVoiceCoordFullObjectBuilder({
