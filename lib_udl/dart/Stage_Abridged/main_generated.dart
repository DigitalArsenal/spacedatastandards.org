...
class StageAbridgedDataModeEnum {
  final int value;
  const StageAbridgedDataModeEnum._(this.value);

  factory StageAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum StageAbridgedDataModeEnum');
    }
    return result;
  }

  static StageAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : StageAbridgedDataModeEnum.fromValue(value);
  ...
  static const StageAbridgedDataModeEnum REAL = StageAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const StageAbridgedDataModeEnum TEST = StageAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const StageAbridgedDataModeEnum SIMULATED = StageAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const StageAbridgedDataModeEnum EXERCISE = StageAbridgedDataModeEnum._(3);
  static const Map<int, StageAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<StageAbridgedDataModeEnum> reader = _StageAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'StageAbridgedDataModeEnum{value: $value}';
  }
}

class _StageAbridgedDataModeEnumReader extends fb.Reader<StageAbridgedDataModeEnum> {
  const _StageAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  StageAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      StageAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class StageAbridged {
  StageAbridged._(this._bc, this._bcOffset);
  factory StageAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<StageAbridged> reader = _StageAbridgedReader();
...
class StageAbridgedBuilder {
  ...
  int addDataMode(StageAbridgedDataModeEnum? dataMode) {
...
class StageAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final StageAbridgedDataModeEnum? _dataMode;

  StageAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    StageAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
