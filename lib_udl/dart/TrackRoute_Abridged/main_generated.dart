...
class TrackRouteAbridgedDataModeEnum {
  final int value;
  const TrackRouteAbridgedDataModeEnum._(this.value);

  factory TrackRouteAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum TrackRouteAbridgedDataModeEnum');
    }
    return result;
  }

  static TrackRouteAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : TrackRouteAbridgedDataModeEnum.fromValue(value);
  ...
  static const TrackRouteAbridgedDataModeEnum REAL = TrackRouteAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const TrackRouteAbridgedDataModeEnum TEST = TrackRouteAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const TrackRouteAbridgedDataModeEnum SIMULATED = TrackRouteAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const TrackRouteAbridgedDataModeEnum EXERCISE = TrackRouteAbridgedDataModeEnum._(3);
  static const Map<int, TrackRouteAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<TrackRouteAbridgedDataModeEnum> reader = _TrackRouteAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'TrackRouteAbridgedDataModeEnum{value: $value}';
  }
}

class _TrackRouteAbridgedDataModeEnumReader extends fb.Reader<TrackRouteAbridgedDataModeEnum> {
  const _TrackRouteAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  TrackRouteAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      TrackRouteAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// A track route is a prescribed route for performing training events or operations such as air refueling.
class TrackRouteAbridged {
  TrackRouteAbridged._(this._bc, this._bcOffset);
  factory TrackRouteAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<TrackRouteAbridged> reader = _TrackRouteAbridgedReader();
...
class TrackRouteAbridgedBuilder {
  ...
  int addDataMode(TrackRouteAbridgedDataModeEnum? dataMode) {
...
class TrackRouteAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final TrackRouteAbridgedDataModeEnum? _dataMode;

  TrackRouteAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    TrackRouteAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
