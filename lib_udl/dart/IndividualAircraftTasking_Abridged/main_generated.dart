...
class IndividualAircraftTaskingAbridged {
  IndividualAircraftTaskingAbridged._(this._bc, this._bcOffset);
  factory IndividualAircraftTaskingAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IndividualAircraftTaskingAbridged> reader = _IndividualAircraftTaskingAbridgedReader();
...
class _IndividualAircraftTaskingAbridgedReader extends fb.TableReader<IndividualAircraftTaskingAbridged> {
  const _IndividualAircraftTaskingAbridgedReader();

  @override
  IndividualAircraftTaskingAbridged createObject(fb.BufferContext bc, int offset) => 
    IndividualAircraftTaskingAbridged._(bc, offset);
}

class IndividualAircraftTaskingAbridgedBuilder {
  IndividualAircraftTaskingAbridgedBuilder(this.fbBuilder);
...
class IndividualAircraftTaskingAbridgedObjectBuilder extends fb.ObjectBuilder {
  final int? _numAcft;
  ...
  IndividualAircraftTaskingAbridgedObjectBuilder({
    int? numAcft,
    String? acftType,
    String? callSign,
