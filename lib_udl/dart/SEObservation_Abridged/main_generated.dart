...
class SeobservationAbridged {
  SeobservationAbridged._(this._bc, this._bcOffset);
  factory SeobservationAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SeobservationAbridged> reader = _SeobservationAbridgedReader();
  ...
  @override
  String toString() {
    return 'SeobservationAbridged{obType: ${obType}, obUoM: ${obUoM}, obValue: ${obValue}, obString: ${obString}, obArray: ${obArray}, obBool: ${obBool}, obQuality: ${obQuality}, obDescription: ${obDescription}}';
  }
}

class _SeobservationAbridgedReader extends fb.TableReader<SeobservationAbridged> {
  const _SeobservationAbridgedReader();

  @override
  SeobservationAbridged createObject(fb.BufferContext bc, int offset) => 
    SeobservationAbridged._(bc, offset);
}

class SeobservationAbridgedBuilder {
  SeobservationAbridgedBuilder(this.fbBuilder);
...
class SeobservationAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  SeobservationAbridgedObjectBuilder({
    String? obType,
    String? obUoM,
    double? obValue,
    String? obString,
