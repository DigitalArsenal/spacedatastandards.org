...
class FlightPlanPointsFull {
  FlightPlanPointsFull._(this._bc, this._bcOffset);
  factory FlightPlanPointsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<FlightPlanPointsFull> reader = _FlightPlanPointsFullReader();
  ...
  @override
  String toString() {
    return 'FlightPlanPointsFull{pointName: ${pointName}, fppLat: ${fppLat}, fppLon: ${fppLon}, fppEta: ${fppEta}, fppReqFuel: ${fppReqFuel}}';
  }
}

class _FlightPlanPointsFullReader extends fb.TableReader<FlightPlanPointsFull> {
  const _FlightPlanPointsFullReader();

  @override
  FlightPlanPointsFull createObject(fb.BufferContext bc, int offset) => 
    FlightPlanPointsFull._(bc, offset);
}

class FlightPlanPointsFullBuilder {
  FlightPlanPointsFullBuilder(this.fbBuilder);
...
class FlightPlanPointsFullObjectBuilder extends fb.ObjectBuilder {
  ...
  FlightPlanPointsFullObjectBuilder({
    String? pointName,
    double? fppLat,
    double? fppLon,
    String? fppEta,
