...
class EffectResponseActionsListFull {
  EffectResponseActionsListFull._(this._bc, this._bcOffset);
  factory EffectResponseActionsListFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EffectResponseActionsListFull> reader = _EffectResponseActionsListFullReader();
  ...
  @override
  String toString() {
    return 'EffectResponseActionsListFull{summary: ${summary}, actionId: ${actionId}, actionStartTime: ${actionStartTime}, actionEndTime: ${actionEndTime}, totStartTime: ${totStartTime}, totEndTime: ${totEndTime}, actionActorSrcType: ${actionActorSrcType}, actionActorSrcId: ${actionActorSrcId}, effector: ${effector}, targetSrcType: ${targetSrcType}, targetSrcId: ${targetSrcId}, actorInterceptLat: ${actorInterceptLat}, actorInterceptLon: ${actorInterceptLon}, actorInterceptAlt: ${actorInterceptAlt}, weaponInterceptLat: ${weaponInterceptLat}, weaponInterceptLon: ${weaponInterceptLon}, weaponInterceptAlt: ${weaponInterceptAlt}, actionMetrics: ${actionMetrics}}';
  }
}

class _EffectResponseActionsListFullReader extends fb.TableReader<EffectResponseActionsListFull> {
  const _EffectResponseActionsListFullReader();

  @override
  EffectResponseActionsListFull createObject(fb.BufferContext bc, int offset) => 
    EffectResponseActionsListFull._(bc, offset);
}

class EffectResponseActionsListFullBuilder {
  EffectResponseActionsListFullBuilder(this.fbBuilder);
...
class EffectResponseActionsListFullObjectBuilder extends fb.ObjectBuilder {
  ...
  EffectResponseActionsListFullObjectBuilder({
    String? summary,
    String? actionId,
