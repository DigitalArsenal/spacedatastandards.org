...
class OnorbitEventAbridgedDataModeEnum {
  final int value;
  const OnorbitEventAbridgedDataModeEnum._(this.value);

  factory OnorbitEventAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OnorbitEventAbridgedDataModeEnum');
    }
    return result;
  }

  static OnorbitEventAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OnorbitEventAbridgedDataModeEnum.fromValue(value);
  ...
  static const OnorbitEventAbridgedDataModeEnum REAL = OnorbitEventAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OnorbitEventAbridgedDataModeEnum TEST = OnorbitEventAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OnorbitEventAbridgedDataModeEnum SIMULATED = OnorbitEventAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OnorbitEventAbridgedDataModeEnum EXERCISE = OnorbitEventAbridgedDataModeEnum._(3);
  static const Map<int, OnorbitEventAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OnorbitEventAbridgedDataModeEnum> reader = _OnorbitEventAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'OnorbitEventAbridgedDataModeEnum{value: $value}';
  }
}

class _OnorbitEventAbridgedDataModeEnumReader extends fb.Reader<OnorbitEventAbridgedDataModeEnum> {
  const _OnorbitEventAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OnorbitEventAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      OnorbitEventAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// No description available.
class OnorbitEventAbridged {
  OnorbitEventAbridged._(this._bc, this._bcOffset);
  factory OnorbitEventAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OnorbitEventAbridged> reader = _OnorbitEventAbridgedReader();
  ...
  OnorbitEventAbridgedDataModeEnum get dataMode => OnorbitEventAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 104, 0));
...
class OnorbitEventAbridgedBuilder {
  ...
  int addDataMode(OnorbitEventAbridgedDataModeEnum? dataMode) {
...
class OnorbitEventAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final OnorbitEventAbridgedDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final String? _origNetwork;

  OnorbitEventAbridgedObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    OnorbitEventAbridgedDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? origNetwork,
  })
