...
class EventEvolutionIngestDataModeEnum {
  final int value;
  const EventEvolutionIngestDataModeEnum._(this.value);

  factory EventEvolutionIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EventEvolutionIngestDataModeEnum');
    }
    return result;
  }

  static EventEvolutionIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EventEvolutionIngestDataModeEnum.fromValue(value);
  ...
  static const EventEvolutionIngestDataModeEnum REAL = EventEvolutionIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EventEvolutionIngestDataModeEnum TEST = EventEvolutionIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EventEvolutionIngestDataModeEnum SIMULATED = EventEvolutionIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EventEvolutionIngestDataModeEnum EXERCISE = EventEvolutionIngestDataModeEnum._(3);
  static const Map<int, EventEvolutionIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EventEvolutionIngestDataModeEnum> reader = _EventEvolutionIngestDataModeEnumReader();

  @override
  String toString() {
    return 'EventEvolutionIngestDataModeEnum{value: $value}';
  }
}

class _EventEvolutionIngestDataModeEnumReader extends fb.Reader<EventEvolutionIngestDataModeEnum> {
  const _EventEvolutionIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EventEvolutionIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      EventEvolutionIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class EventEvolutionIngest {
  EventEvolutionIngest._(this._bc, this._bcOffset);
  factory EventEvolutionIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EventEvolutionIngest> reader = _EventEvolutionIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  EventEvolutionIngestDataModeEnum get dataMode => EventEvolutionIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 62, 0));

  @override
  String toString() {
    return 'EventEvolutionIngest{id: ${id}, classificationMarking: ${classificationMarking}, eventId: ${eventId}, category: ${category}, summary: ${summary}, startTime: ${startTime}, endTime: ${endTime}, status: ${status}, countryCode: ${countryCode}, geoAdminLevel1: ${geoAdminLevel1}, geoAdminLevel2: ${geoAdminLevel2}, geoAdminLevel3: ${geoAdminLevel3}, redact: ${redact}, srcTyps: ${srcTyps}, srcIds: ${srcIds}, dataDescription: ${dataDescription}, area: ${area}, atext: ${atext}, agjson: ${agjson}, atype: ${atype}, andims: ${andims}, asrid: ${asrid}, url: ${url}, tags: ${tags}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _EventEvolutionIngestReader extends fb.TableReader<EventEvolutionIngest> {
  const _EventEvolutionIngestReader();

  @override
  EventEvolutionIngest createObject(fb.BufferContext bc, int offset) => 
    EventEvolutionIngest._(bc, offset);
}

class EventEvolutionIngestBuilder {
  EventEvolutionIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(EventEvolutionIngestDataModeEnum? dataMode) {
...
class EventEvolutionIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EventEvolutionIngestDataModeEnum? _dataMode;

  EventEvolutionIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    EventEvolutionIngestDataModeEnum? dataMode,
  })
      : _id = id,
