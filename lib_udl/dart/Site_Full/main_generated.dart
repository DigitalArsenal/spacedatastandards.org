...
class SiteFullDataModeEnum {
  final int value;
  const SiteFullDataModeEnum._(this.value);

  factory SiteFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SiteFullDataModeEnum');
    }
    return result;
  }

  static SiteFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SiteFullDataModeEnum.fromValue(value);
  ...
  static const SiteFullDataModeEnum REAL = SiteFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SiteFullDataModeEnum TEST = SiteFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SiteFullDataModeEnum SIMULATED = SiteFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SiteFullDataModeEnum EXERCISE = SiteFullDataModeEnum._(3);
  static const Map<int, SiteFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SiteFullDataModeEnum> reader = _SiteFullDataModeEnumReader();

  @override
  String toString() {
    return 'SiteFullDataModeEnum{value: $value}';
  }
}

class _SiteFullDataModeEnumReader extends fb.Reader<SiteFullDataModeEnum> {
  const _SiteFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SiteFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      SiteFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Properties and characteristics of a site entity, such as an airbase, airfield, naval station, etc.
class SiteFull {
  SiteFull._(this._bc, this._bcOffset);
  factory SiteFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SiteFull> reader = _SiteFullReader();
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  List<String>? get siteRemarks => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 124);
  ///  Time the row was created in the database, auto-populated by the system.
  ///  Example: /// Example: 2018-01-01T16:00:00.123Z
  ///  Constraints: No constraints specified.
  String? get createdAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 126);
  ///  Application user who created the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 1, Maximum length = 64
  String? get createdBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 128);
  ///  Time the row was updated in the database, auto-populated by the system.
  ///  Example: /// Example: 2018-01-01T16:00:00.123Z
  ///  Constraints: No constraints specified.
  String? get updatedAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 130);
  ///  Application user who updated the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 1, Maximum length = 64
  String? get updatedBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 132);
  ///  Source of the data.
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SiteFullDataModeEnum get dataMode => SiteFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 140, 0));

  @override
  String toString() {
    return 'SiteFull{id: ${id}, entity: ${entity}, idEntity: ${idEntity}, idParentSite: ${idParentSite}, classificationMarking: ${classificationMarking}, origSiteId: ${origSiteId}, origLzId: ${origLzId}, pin: ${pin}, type: ${type}, usage: ${usage}, lzUsage: ${lzUsage}, name: ${name}, coordDatum: ${coordDatum}, coord: ${coord}, coordDerivAcc: ${coordDerivAcc}, osuffix: ${osuffix}, iata: ${iata}, icao: ${icao}, faa: ${faa}, airDefArea: ${airDefArea}, utm: ${utm}, milGridSys: ${milGridSys}, milGrid: ${milGrid}, catCode: ${catCode}, catText: ${catText}, wac: ${wac}, polSubdiv: ${polSubdiv}, geoArea: ${geoArea}, geoidalMslSep: ${geoidalMslSep}, allegiance: ${allegiance}, altAllegiance: ${altAllegiance}, classRating: ${classRating}, fpa: ${fpa}, beNumber: ${beNumber}, runways: ${runways}, maxRunwayLength: ${maxRunwayLength}, condition: ${condition}, conditionAvail: ${conditionAvail}, operStatus: ${operStatus}, grade: ${grade}, activity: ${activity}, functPrimary: ${functPrimary}, msnPrimary: ${msnPrimary}, msnPrimarySpec: ${msnPrimarySpec}, nucCap: ${nucCap}, ident: ${ident}, elevMsl: ${elevMsl}, elevMslConfLvl: ${elevMslConfLvl}, elevMslDerivAcc: ${elevMslDerivAcc}, vegHt: ${vegHt}, vegType: ${vegType}, popArea: ${popArea}, popAreaProx: ${popAreaProx}, notes: ${notes}, resProd: ${resProd}, eval: ${eval}, reviewDate: ${reviewDate}, recStatus: ${recStatus}, symCode: ${symCode}, referenceDoc: ${referenceDoc}, siteRemarks: ${siteRemarks}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _SiteFullReader extends fb.TableReader<SiteFull> {
  const _SiteFullReader();

  @override
  SiteFull createObject(fb.BufferContext bc, int offset) => 
    SiteFull._(bc, offset);
}

class SiteFullBuilder {
  SiteFullBuilder(this.fbBuilder);
  ...
  int addSiteRemarksOffset(int? offset) {
  ...
  int addDataMode(SiteFullDataModeEnum? dataMode) {
...
class SiteFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final List<String>? _siteRemarks;
  ...
  final SiteFullDataModeEnum? _dataMode;

  SiteFullObjectBuilder({
    String? id,
    String? entity,
    String? idEntity,
    String? idParentSite,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    final int? siteRemarksOffset = _siteRemarks == null ? null
        : fbBuilder.writeList(_siteRemarks!.map(fbBuilder.writeString).toList());
    ...
    fbBuilder.addOffset(60, siteRemarksOffset);
    fbBuilder.addOffset(61, createdAtOffset);
    fbBuilder.addOffset(62, createdByOffset);
    fbBuilder.addOffset(63, updatedAtOffset);
    fbBuilder.addOffset(64, updatedByOffset);
