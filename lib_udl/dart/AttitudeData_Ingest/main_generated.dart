...
class AttitudeDataIngestDataModeEnum {
  final int value;
  const AttitudeDataIngestDataModeEnum._(this.value);

  factory AttitudeDataIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AttitudeDataIngestDataModeEnum');
    }
    return result;
  }

  static AttitudeDataIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AttitudeDataIngestDataModeEnum.fromValue(value);
  ...
  static const AttitudeDataIngestDataModeEnum REAL = AttitudeDataIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AttitudeDataIngestDataModeEnum TEST = AttitudeDataIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AttitudeDataIngestDataModeEnum SIMULATED = AttitudeDataIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AttitudeDataIngestDataModeEnum EXERCISE = AttitudeDataIngestDataModeEnum._(3);
  static const Map<int, AttitudeDataIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AttitudeDataIngestDataModeEnum> reader = _AttitudeDataIngestDataModeEnumReader();

  @override
  String toString() {
    return 'AttitudeDataIngestDataModeEnum{value: $value}';
  }
}

class _AttitudeDataIngestDataModeEnumReader extends fb.Reader<AttitudeDataIngestDataModeEnum> {
  const _AttitudeDataIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AttitudeDataIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      AttitudeDataIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AttitudeDataIngest {
  AttitudeDataIngest._(this._bc, this._bcOffset);
  factory AttitudeDataIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AttitudeDataIngest> reader = _AttitudeDataIngestReader();
  ...
  AttitudeDataIngestDataModeEnum get dataMode => AttitudeDataIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 66, 0));
  ...
  @override
  String toString() {
    return 'AttitudeDataIngest{id: ${id}, classificationMarking: ${classificationMarking}, asId: ${asId}, idOnOrbit: ${idOnOrbit}, satNo: ${satNo}, origObjectId: ${origObjectId}, ts: ${ts}, motionType: ${motionType}, q1: ${q1}, q2: ${q2}, q3: ${q3}, qc: ${qc}, q1Dot: ${q1Dot}, q2Dot: ${q2Dot}, q3Dot: ${q3Dot}, qcDot: ${qcDot}, xAngle: ${xAngle}, yAngle: ${yAngle}, zAngle: ${zAngle}, xRate: ${xRate}, yRate: ${yRate}, zRate: ${zRate}, ra: ${ra}, declination: ${declination}, coningAngle: ${coningAngle}, precPeriod: ${precPeriod}, spinPeriod: ${spinPeriod}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, origNetwork: ${origNetwork}}';
  }
}

class _AttitudeDataIngestReader extends fb.TableReader<AttitudeDataIngest> {
  const _AttitudeDataIngestReader();

  @override
  AttitudeDataIngest createObject(fb.BufferContext bc, int offset) => 
    AttitudeDataIngest._(bc, offset);
}

class AttitudeDataIngestBuilder {
  AttitudeDataIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(AttitudeDataIngestDataModeEnum? dataMode) {
...
class AttitudeDataIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AttitudeDataIngestDataModeEnum? _dataMode;
  final String? _origNetwork;

  AttitudeDataIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    AttitudeDataIngestDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
