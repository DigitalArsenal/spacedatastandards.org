...
class DataLinkAbridgedDataModeEnum {
  final int value;
  const DataLinkAbridgedDataModeEnum._(this.value);

  factory DataLinkAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum DataLinkAbridgedDataModeEnum');
    }
    return result;
  }

  static DataLinkAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : DataLinkAbridgedDataModeEnum.fromValue(value);
  ...
  static const DataLinkAbridgedDataModeEnum REAL = DataLinkAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const DataLinkAbridgedDataModeEnum TEST = DataLinkAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const DataLinkAbridgedDataModeEnum SIMULATED = DataLinkAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const DataLinkAbridgedDataModeEnum EXERCISE = DataLinkAbridgedDataModeEnum._(3);
  static const Map<int, DataLinkAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<DataLinkAbridgedDataModeEnum> reader = _DataLinkAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'DataLinkAbridgedDataModeEnum{value: $value}';
  }
}

class _DataLinkAbridgedDataModeEnumReader extends fb.Reader<DataLinkAbridgedDataModeEnum> {
  const _DataLinkAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  DataLinkAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      DataLinkAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Beta Version DataLink: Detailed instructions regarding the operations of data links.
class DataLinkAbridged {
  DataLinkAbridged._(this._bc, this._bcOffset);
  factory DataLinkAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DataLinkAbridged> reader = _DataLinkAbridgedReader();
...
class DataLinkAbridgedBuilder {
  ...
  int addDataMode(DataLinkAbridgedDataModeEnum? dataMode) {
...
class DataLinkAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final DataLinkAbridgedDataModeEnum? _dataMode;

  DataLinkAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    DataLinkAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
