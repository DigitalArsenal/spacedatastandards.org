...
class PoiAbridgedDataModeEnum {
  final int value;
  const PoiAbridgedDataModeEnum._(this.value);

  factory PoiAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum PoiAbridgedDataModeEnum');
    }
    return result;
  }

  static PoiAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : PoiAbridgedDataModeEnum.fromValue(value);
  ...
  static const PoiAbridgedDataModeEnum REAL = PoiAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const PoiAbridgedDataModeEnum TEST = PoiAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const PoiAbridgedDataModeEnum SIMULATED = PoiAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const PoiAbridgedDataModeEnum EXERCISE = PoiAbridgedDataModeEnum._(3);
  static const Map<int, PoiAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<PoiAbridgedDataModeEnum> reader = _PoiAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'PoiAbridgedDataModeEnum{value: $value}';
  }
}

class _PoiAbridgedDataModeEnumReader extends fb.Reader<PoiAbridgedDataModeEnum> {
  const _PoiAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  PoiAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      PoiAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class PoiAbridged {
  PoiAbridged._(this._bc, this._bcOffset);
  factory PoiAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PoiAbridged> reader = _PoiAbridgedReader();
  ...
  ///  Constraints: No constraints specified.
  String? get atext => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 66);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 128
  String? get atype => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 70);
  ///  Number of dimensions of the geometry depicted by region.
  ///  Example: /// Example: 3
  ///  Constraints: No constraints specified.
  int get andims => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 72, 0);
  ///  Geographical spatial_ref_sys for region.
  ///  Example: /// Example: 3
  ///  Constraints: No constraints specified.
  int get asrid => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 74, 0);
  ///  Time the row was created in the database.
  ///  Example: /// Example: 2018-01-01T16:00:00.123Z
  ///  Constraints: No constraints specified.
  String? get createdAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 76);
  ///  Application user who created the row in the database.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 1, Maximum length = 64
  String? get createdBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 78);
  ///  The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
  ///  Example: /// Example: AXE
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get sourceDl => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 80);
  ///  Source of the data.
  ///  Example: /// Example: Bluestaq
  ///  Constraints: Minimum length = 1, Maximum length = 36
  String? get source => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 82);
  ...
  PoiAbridgedDataModeEnum get dataMode => PoiAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 84, 0));
  ...
  ///  Constraints: No constraints specified.
  List<String>? get groups => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 88);
  ///  ID/name of the platform or entity providing the POI data.
  ///  Example: /// Example: PLATFORM_NAME
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get asset => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 90);
  ///  The Basic Encyclopedia Number associated with the POI, if applicable.
  ///  Example: /// Example: 0427RT1030
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get beNumber => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 92);
  ...
  ///  Example: /// Example: 45.23
  ///  Constraints: No constraints specified.
  double get orientation => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 94, 0.0);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get transactionId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 98);

  @override
  String toString() {
    return 'PoiAbridged{id: ${id}, classificationMarking: ${classificationMarking}, pps: ${pps}, msnid: ${msnid}, pri: ${pri}, trkid: ${trkid}, idWeatherReport: ${idWeatherReport}, poiid: ${poiid}, name: ${name}, desc: ${desc}, spec: ${spec}, ident: ${ident}, env: ${env}, plat: ${plat}, activity: ${activity}, ts: ${ts}, start: ${start}, stale: ${stale}, how: ${how}, type: ${type}, lat: ${lat}, lon: ${lon}, alt: ${alt}, az: ${az}, el: ${el}, le: ${le}, ce: ${ce}, elle: ${elle}, cntct: ${cntct}, conf: ${conf}, urls: ${urls}, atext: ${atext}, agjson: ${agjson}, atype: ${atype}, andims: ${andims}, asrid: ${asrid}, createdAt: ${createdAt}, createdBy: ${createdBy}, sourceDl: ${sourceDl}, source: ${source}, dataMode: ${dataMode}, origin: ${origin}, groups: ${groups}, asset: ${asset}, beNumber: ${beNumber}, orientation: ${orientation}, origNetwork: ${origNetwork}, transactionId: ${transactionId}}';
  }
}

class _PoiAbridgedReader extends fb.TableReader<PoiAbridged> {
  const _PoiAbridgedReader();

  @override
  PoiAbridged createObject(fb.BufferContext bc, int offset) => 
    PoiAbridged._(bc, offset);
}

class PoiAbridgedBuilder {
  PoiAbridgedBuilder(this.fbBuilder);
  ...
  int addAndims(int? andims) {
    fbBuilder.addInt32(34, andims);
    return fbBuilder.offset;
  }
  int addAsrid(int? asrid) {
    fbBuilder.addInt32(35, asrid);
    return fbBuilder.offset;
  }
  ...
  int addDataMode(PoiAbridgedDataModeEnum? dataMode) {
  ...
  int addOrientation(double? orientation) {
    fbBuilder.addFloat64(45, orientation);
    return fbBuilder.offset;
  }
...
class PoiAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final PoiAbridgedDataModeEnum? _dataMode;
  ...
  PoiAbridgedObjectBuilder({
    ...
    String? sourceDl,
    String? source,
    PoiAbridgedDataModeEnum? dataMode,
    String? origin,
    List<String>? groups,
    String? asset,
    String? beNumber,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(31, atextOffset);
    fbBuilder.addOffset(32, agjsonOffset);
    fbBuilder.addOffset(33, atypeOffset);
    fbBuilder.addInt32(34, _andims);
    fbBuilder.addInt32(35, _asrid);
    fbBuilder.addOffset(36, createdAtOffset);
    fbBuilder.addOffset(37, createdByOffset);
    fbBuilder.addOffset(38, sourceDlOffset);
    fbBuilder.addOffset(39, sourceOffset);
    fbBuilder.addInt8(40, _dataMode?.value);
    fbBuilder.addOffset(41, originOffset);
    fbBuilder.addOffset(42, groupsOffset);
    fbBuilder.addOffset(43, assetOffset);
    fbBuilder.addOffset(44, beNumberOffset);
    fbBuilder.addFloat64(45, _orientation);
    fbBuilder.addOffset(46, origNetworkOffset);
    fbBuilder.addOffset(47, transactionIdOffset);
    return fbBuilder.endTable();
  }
