...
///  /// Injury specifics.
class EvacInjuryAbridged {
  EvacInjuryAbridged._(this._bc, this._bcOffset);
  factory EvacInjuryAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EvacInjuryAbridged> reader = _EvacInjuryAbridgedReader();
  ...
  @override
  String toString() {
    return 'EvacInjuryAbridged{type: ${type}, bodyPart: ${bodyPart}, time: ${time}, comments: ${comments}}';
  }
}

class _EvacInjuryAbridgedReader extends fb.TableReader<EvacInjuryAbridged> {
  const _EvacInjuryAbridgedReader();

  @override
  EvacInjuryAbridged createObject(fb.BufferContext bc, int offset) => 
    EvacInjuryAbridged._(bc, offset);
}

class EvacInjuryAbridgedBuilder {
  EvacInjuryAbridgedBuilder(this.fbBuilder);
...
class EvacInjuryAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _type;
  final String? _bodyPart;
  final String? _time;
  final String? _comments;

  EvacInjuryAbridgedObjectBuilder({
    String? type,
    String? bodyPart,
    String? time,
    String? comments,
