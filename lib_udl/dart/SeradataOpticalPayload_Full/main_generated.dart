...
class SeradataOpticalPayloadFullDataModeEnum {
  final int value;
  const SeradataOpticalPayloadFullDataModeEnum._(this.value);

  factory SeradataOpticalPayloadFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SeradataOpticalPayloadFullDataModeEnum');
    }
    return result;
  }

  static SeradataOpticalPayloadFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SeradataOpticalPayloadFullDataModeEnum.fromValue(value);
  ...
  static const SeradataOpticalPayloadFullDataModeEnum REAL = SeradataOpticalPayloadFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SeradataOpticalPayloadFullDataModeEnum TEST = SeradataOpticalPayloadFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SeradataOpticalPayloadFullDataModeEnum SIMULATED = SeradataOpticalPayloadFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SeradataOpticalPayloadFullDataModeEnum EXERCISE = SeradataOpticalPayloadFullDataModeEnum._(3);
  static const Map<int, SeradataOpticalPayloadFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SeradataOpticalPayloadFullDataModeEnum> reader = _SeradataOpticalPayloadFullDataModeEnumReader();

  @override
  String toString() {
    return 'SeradataOpticalPayloadFullDataModeEnum{value: $value}';
  }
}

class _SeradataOpticalPayloadFullDataModeEnumReader extends fb.Reader<SeradataOpticalPayloadFullDataModeEnum> {
  const _SeradataOpticalPayloadFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SeradataOpticalPayloadFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      SeradataOpticalPayloadFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Details for an optical payload from  Seradata.
class SeradataOpticalPayloadFull {
  SeradataOpticalPayloadFull._(this._bc, this._bcOffset);
  factory SeradataOpticalPayloadFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SeradataOpticalPayloadFull> reader = _SeradataOpticalPayloadFullReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 64
  String? get source => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 52);
  ///  Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
  ///  Example: /// Example: THIRD_PARTY_DATASOURCE
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get origin => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 54);
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SeradataOpticalPayloadFullDataModeEnum get dataMode => SeradataOpticalPayloadFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 58, 0));

  @override
  String toString() {
    return 'SeradataOpticalPayloadFull{id: ${id}, classificationMarking: ${classificationMarking}, spacecraftId: ${spacecraftId}, idSensor: ${idSensor}, hostedForCompanyOrgId: ${hostedForCompanyOrgId}, manufacturerOrgId: ${manufacturerOrgId}, imagingPayloadCategory: ${imagingPayloadCategory}, name: ${name}, spectralBand: ${spectralBand}, spectralFrequencyLimits: ${spectralFrequencyLimits}, numberOfFilmReturnCanisters: ${numberOfFilmReturnCanisters}, bestResolution: ${bestResolution}, swathWidth: ${swathWidth}, recorderSize: ${recorderSize}, fieldOfView: ${fieldOfView}, fieldOfRegard: ${fieldOfRegard}, pointingMethod: ${pointingMethod}, groundStations: ${groundStations}, groundStationLocations: ${groundStationLocations}, notes: ${notes}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _SeradataOpticalPayloadFullReader extends fb.TableReader<SeradataOpticalPayloadFull> {
  const _SeradataOpticalPayloadFullReader();

  @override
  SeradataOpticalPayloadFull createObject(fb.BufferContext bc, int offset) => 
    SeradataOpticalPayloadFull._(bc, offset);
}

class SeradataOpticalPayloadFullBuilder {
  SeradataOpticalPayloadFullBuilder(this.fbBuilder);
  ...
  int addDataMode(SeradataOpticalPayloadFullDataModeEnum? dataMode) {
...
class SeradataOpticalPayloadFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SeradataOpticalPayloadFullDataModeEnum? _dataMode;

  SeradataOpticalPayloadFullObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    SeradataOpticalPayloadFullDataModeEnum? dataMode,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(24, sourceOffset);
    fbBuilder.addOffset(25, originOffset);
