...
class BeamContourIngestTypeEnum {
  final int value;
  const BeamContourIngestTypeEnum._(this.value);

  factory BeamContourIngestTypeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum BeamContourIngestTypeEnum');
    }
    return result;
  }

  static BeamContourIngestTypeEnum? _createOrNull(int? value) => 
      value == null ? null : BeamContourIngestTypeEnum.fromValue(value);
  ...
  static const BeamContourIngestTypeEnum BORESIGHT = BeamContourIngestTypeEnum._(0);

  ///  No description available.
  static const BeamContourIngestTypeEnum CONTOUR = BeamContourIngestTypeEnum._(1);

  ///  No description available.
  static const BeamContourIngestTypeEnum SVC_AREA = BeamContourIngestTypeEnum._(2);
  static const Map<int, BeamContourIngestTypeEnum> values = {
    0: BORESIGHT,
    1: CONTOUR,
    2: SVC_AREA};

  static const fb.Reader<BeamContourIngestTypeEnum> reader = _BeamContourIngestTypeEnumReader();

  @override
  String toString() {
    return 'BeamContourIngestTypeEnum{value: $value}';
  }
}

class _BeamContourIngestTypeEnumReader extends fb.Reader<BeamContourIngestTypeEnum> {
  const _BeamContourIngestTypeEnumReader();

  @override
  int get size => 1;

  @override
  BeamContourIngestTypeEnum read(fb.BufferContext bc, int offset) =>
      BeamContourIngestTypeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class BeamContourIngestDataModeEnum {
  final int value;
  const BeamContourIngestDataModeEnum._(this.value);

  factory BeamContourIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum BeamContourIngestDataModeEnum');
    }
    return result;
  }

  static BeamContourIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : BeamContourIngestDataModeEnum.fromValue(value);
  ...
  static const BeamContourIngestDataModeEnum REAL = BeamContourIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const BeamContourIngestDataModeEnum TEST = BeamContourIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const BeamContourIngestDataModeEnum SIMULATED = BeamContourIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const BeamContourIngestDataModeEnum EXERCISE = BeamContourIngestDataModeEnum._(3);
  static const Map<int, BeamContourIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<BeamContourIngestDataModeEnum> reader = _BeamContourIngestDataModeEnumReader();

  @override
  String toString() {
    return 'BeamContourIngestDataModeEnum{value: $value}';
  }
}

class _BeamContourIngestDataModeEnumReader extends fb.Reader<BeamContourIngestDataModeEnum> {
  const _BeamContourIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  BeamContourIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      BeamContourIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class BeamContourIngest {
  BeamContourIngest._(this._bc, this._bcOffset);
  factory BeamContourIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<BeamContourIngest> reader = _BeamContourIngestReader();
  ...
  BeamContourIngestTypeEnum get type => BeamContourIngestTypeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 10, 0));
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  BeamContourIngestDataModeEnum get dataMode => BeamContourIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 40, 0));

  @override
  String toString() {
    return 'BeamContourIngest{id: ${id}, classificationMarking: ${classificationMarking}, idBeam: ${idBeam}, type: ${type}, contourIdx: ${contourIdx}, gain: ${gain}, regionName: ${regionName}, geography: ${geography}, geographyText: ${geographyText}, geographyJson: ${geographyJson}, geographyType: ${geographyType}, geographyNdims: ${geographyNdims}, geographySrid: ${geographySrid}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _BeamContourIngestReader extends fb.TableReader<BeamContourIngest> {
  const _BeamContourIngestReader();

  @override
  BeamContourIngest createObject(fb.BufferContext bc, int offset) => 
    BeamContourIngest._(bc, offset);
}

class BeamContourIngestBuilder {
  BeamContourIngestBuilder(this.fbBuilder);
  ...
  int addType(BeamContourIngestTypeEnum? type) {
  ...
  int addDataMode(BeamContourIngestDataModeEnum? dataMode) {
...
class BeamContourIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _classificationMarking;
  final String? _idBeam;
  final BeamContourIngestTypeEnum? _type;
  ...
  final BeamContourIngestDataModeEnum? _dataMode;

  BeamContourIngestObjectBuilder({
    String? id,
    String? classificationMarking,
    String? idBeam,
    BeamContourIngestTypeEnum? type,
    int? contourIdx,
    double? gain,
    String? regionName,
    String? geography,
    ...
    String? origin,
    String? origNetwork,
    BeamContourIngestDataModeEnum? dataMode,
  })
      : _id = id,
