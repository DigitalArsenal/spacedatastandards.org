...
class SeradataSigIntPayloadIngestDataModeEnum {
  final int value;
  const SeradataSigIntPayloadIngestDataModeEnum._(this.value);

  factory SeradataSigIntPayloadIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SeradataSigIntPayloadIngestDataModeEnum');
    }
    return result;
  }

  static SeradataSigIntPayloadIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SeradataSigIntPayloadIngestDataModeEnum.fromValue(value);
  ...
  static const SeradataSigIntPayloadIngestDataModeEnum REAL = SeradataSigIntPayloadIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SeradataSigIntPayloadIngestDataModeEnum TEST = SeradataSigIntPayloadIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SeradataSigIntPayloadIngestDataModeEnum SIMULATED = SeradataSigIntPayloadIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SeradataSigIntPayloadIngestDataModeEnum EXERCISE = SeradataSigIntPayloadIngestDataModeEnum._(3);
  static const Map<int, SeradataSigIntPayloadIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SeradataSigIntPayloadIngestDataModeEnum> reader = _SeradataSigIntPayloadIngestDataModeEnumReader();

  @override
  String toString() {
    return 'SeradataSigIntPayloadIngestDataModeEnum{value: $value}';
  }
}

class _SeradataSigIntPayloadIngestDataModeEnumReader extends fb.Reader<SeradataSigIntPayloadIngestDataModeEnum> {
  const _SeradataSigIntPayloadIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SeradataSigIntPayloadIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      SeradataSigIntPayloadIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Details for an sigint payload from  Seradata.
class SeradataSigIntPayloadIngest {
  SeradataSigIntPayloadIngest._(this._bc, this._bcOffset);
  factory SeradataSigIntPayloadIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SeradataSigIntPayloadIngest> reader = _SeradataSigIntPayloadIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SeradataSigIntPayloadIngestDataModeEnum get dataMode => SeradataSigIntPayloadIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 44, 0));

  @override
  String toString() {
    return 'SeradataSigIntPayloadIngest{id: ${id}, classificationMarking: ${classificationMarking}, spacecraftId: ${spacecraftId}, idSensor: ${idSensor}, hostedForCompanyOrgId: ${hostedForCompanyOrgId}, manufacturerOrgId: ${manufacturerOrgId}, type: ${type}, swathWidth: ${swathWidth}, groundStations: ${groundStations}, groundStationLocations: ${groundStationLocations}, frequencyCoverage: ${frequencyCoverage}, positionalAccuracy: ${positionalAccuracy}, interceptParameters: ${interceptParameters}, name: ${name}, notes: ${notes}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _SeradataSigIntPayloadIngestReader extends fb.TableReader<SeradataSigIntPayloadIngest> {
  const _SeradataSigIntPayloadIngestReader();

  @override
  SeradataSigIntPayloadIngest createObject(fb.BufferContext bc, int offset) => 
    SeradataSigIntPayloadIngest._(bc, offset);
}

class SeradataSigIntPayloadIngestBuilder {
  SeradataSigIntPayloadIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(SeradataSigIntPayloadIngestDataModeEnum? dataMode) {
...
class SeradataSigIntPayloadIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SeradataSigIntPayloadIngestDataModeEnum? _dataMode;

  SeradataSigIntPayloadIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    SeradataSigIntPayloadIngestDataModeEnum? dataMode,
  })
      : _id = id,
