...
class EquipmentFullDataModeEnum {
  final int value;
  const EquipmentFullDataModeEnum._(this.value);

  factory EquipmentFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EquipmentFullDataModeEnum');
    }
    return result;
  }

  static EquipmentFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EquipmentFullDataModeEnum.fromValue(value);
  ...
  static const EquipmentFullDataModeEnum REAL = EquipmentFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EquipmentFullDataModeEnum TEST = EquipmentFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EquipmentFullDataModeEnum SIMULATED = EquipmentFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EquipmentFullDataModeEnum EXERCISE = EquipmentFullDataModeEnum._(3);
  static const Map<int, EquipmentFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EquipmentFullDataModeEnum> reader = _EquipmentFullDataModeEnumReader();

  @override
  String toString() {
    return 'EquipmentFullDataModeEnum{value: $value}';
  }
}

class _EquipmentFullDataModeEnumReader extends fb.Reader<EquipmentFullDataModeEnum> {
  const _EquipmentFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EquipmentFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      EquipmentFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Properties and characteristics of equipment that can be associated with a site or other entity.
class EquipmentFull {
  EquipmentFull._(this._bc, this._bcOffset);
  factory EquipmentFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EquipmentFull> reader = _EquipmentFullReader();
  ...
  ///  Constraints: No constraints specified.
  List<String>? get equipmentRemarks => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 100);
  ///  Time the row was created in the database, auto-populated by the system.
  ///  Example: /// Example: 2018-01-01T16:00:00.123Z
  ///  Constraints: No constraints specified.
  String? get createdAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 102);
  ///  Application user who created the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 1, Maximum length = 64
  String? get createdBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 104);
  ///  Time the row was last updated in the database, auto-populated by the system.
  ///  Example: /// Example: 2018-01-01T16:00:00.123Z
  ///  Constraints: No constraints specified.
  String? get updatedAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 106);
  ///  Application user who updated the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get updatedBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 108);
  ///  Source of the data.
  ...
  EquipmentFullDataModeEnum get dataMode => EquipmentFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 114, 0));

  @override
  String toString() {
    return 'EquipmentFull{id: ${id}, classificationMarking: ${classificationMarking}, idParentEquipment: ${idParentEquipment}, idSite: ${idSite}, idOperatingUnit: ${idOperatingUnit}, altEqpId: ${altEqpId}, eqpCode: ${eqpCode}, eqpIdNum: ${eqpIdNum}, countryCode: ${countryCode}, altCountryCode: ${altCountryCode}, wac: ${wac}, seqNum: ${seqNum}, nomen: ${nomen}, operStatus: ${operStatus}, condition: ${condition}, conditionAvail: ${conditionAvail}, eval: ${eval}, fpa: ${fpa}, function: ${function}, ident: ${ident}, allegiance: ${allegiance}, altAllegiance: ${altAllegiance}, locReason: ${locReason}, operAreaPrimary: ${operAreaPrimary}, functPrimary: ${functPrimary}, coordDatum: ${coordDatum}, coord: ${coord}, coordDerivAcc: ${coordDerivAcc}, lat: ${lat}, lon: ${lon}, elevMsl: ${elevMsl}, elevMslConfLvl: ${elevMslConfLvl}, elevMslDerivAcc: ${elevMslDerivAcc}, geoidalMslSep: ${geoidalMslSep}, milGridSys: ${milGridSys}, milGrid: ${milGrid}, utm: ${utm}, airDefArea: ${airDefArea}, polSubdiv: ${polSubdiv}, qtyOh: ${qtyOh}, symCode: ${symCode}, classRating: ${classRating}, recStatus: ${recStatus}, reviewDate: ${reviewDate}, resProd: ${resProd}, referenceDoc: ${referenceDoc}, srcTyps: ${srcTyps}, srcIds: ${srcIds}, equipmentRemarks: ${equipmentRemarks}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}}';
  }
}

class _EquipmentFullReader extends fb.TableReader<EquipmentFull> {
  const _EquipmentFullReader();

  @override
  EquipmentFull createObject(fb.BufferContext bc, int offset) => 
    EquipmentFull._(bc, offset);
}

class EquipmentFullBuilder {
  EquipmentFullBuilder(this.fbBuilder);
  ...
  int addEquipmentRemarksOffset(int? offset) {
  ...
  int addDataMode(EquipmentFullDataModeEnum? dataMode) {
...
class EquipmentFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final List<String>? _equipmentRemarks;
  ...
  final EquipmentFullDataModeEnum? _dataMode;

  EquipmentFullObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    EquipmentFullDataModeEnum? dataMode,
  })
      : _id = id,
        ...
        _srcTyps = srcTyps,
        _srcIds = srcIds,
        _equipmentRemarks = equipmentRemarks,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    final int? equipmentRemarksOffset = _equipmentRemarks == null ? null
        : fbBuilder.writeList(_equipmentRemarks!.map(fbBuilder.writeString).toList());
    ...
    fbBuilder.addOffset(48, equipmentRemarksOffset);
    fbBuilder.addOffset(49, createdAtOffset);
    fbBuilder.addOffset(50, createdByOffset);
    fbBuilder.addOffset(51, updatedAtOffset);
    fbBuilder.addOffset(52, updatedByOffset);
