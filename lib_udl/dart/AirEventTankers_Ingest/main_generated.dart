...
class AirEventTankersIngest {
  AirEventTankersIngest._(this._bc, this._bcOffset);
  factory AirEventTankersIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirEventTankersIngest> reader = _AirEventTankersIngestReader();
  ...
  @override
  String toString() {
    return 'AirEventTankersIngest{idTankerSortie: ${idTankerSortie}, idTankerMission: ${idTankerMission}, idTankerAirfield: ${idTankerAirfield}, externalTankerId: ${externalTankerId}, tankerCoord: ${tankerCoord}, tankerMds: ${tankerMds}, amcTankerMissionId: ${amcTankerMissionId}, altTankerMissionId: ${altTankerMissionId}, tankerCallSign: ${tankerCallSign}, tankerOwner: ${tankerOwner}, tankerPoc: ${tankerPoc}, tankerLegNum: ${tankerLegNum}, tankerDeployedIcao: ${tankerDeployedIcao}, tankerDeliveryMethod: ${tankerDeliveryMethod}, fuelOff: ${fuelOff}, tankerCellPosition: ${tankerCellPosition}, tankerFuelType: ${tankerFuelType}, dualRole: ${dualRole}}';
  }
}

class _AirEventTankersIngestReader extends fb.TableReader<AirEventTankersIngest> {
  const _AirEventTankersIngestReader();

  @override
  AirEventTankersIngest createObject(fb.BufferContext bc, int offset) => 
    AirEventTankersIngest._(bc, offset);
}

class AirEventTankersIngestBuilder {
  AirEventTankersIngestBuilder(this.fbBuilder);
...
class AirEventTankersIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  AirEventTankersIngestObjectBuilder({
