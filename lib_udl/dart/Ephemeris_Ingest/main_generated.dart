...
class EphemerisIngestDataModeEnum {
  final int value;
  const EphemerisIngestDataModeEnum._(this.value);

  factory EphemerisIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EphemerisIngestDataModeEnum');
    }
    return result;
  }

  static EphemerisIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EphemerisIngestDataModeEnum.fromValue(value);
  ...
  static const EphemerisIngestDataModeEnum REAL = EphemerisIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EphemerisIngestDataModeEnum TEST = EphemerisIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EphemerisIngestDataModeEnum SIMULATED = EphemerisIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EphemerisIngestDataModeEnum EXERCISE = EphemerisIngestDataModeEnum._(3);
  static const Map<int, EphemerisIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EphemerisIngestDataModeEnum> reader = _EphemerisIngestDataModeEnumReader();

  @override
  String toString() {
    return 'EphemerisIngestDataModeEnum{value: $value}';
  }
}

class _EphemerisIngestDataModeEnumReader extends fb.Reader<EphemerisIngestDataModeEnum> {
  const _EphemerisIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EphemerisIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      EphemerisIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class EphemerisIngest {
  EphemerisIngest._(this._bc, this._bcOffset);
  factory EphemerisIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EphemerisIngest> reader = _EphemerisIngestReader();
  ...
  EphemerisIngestDataModeEnum get dataMode => EphemerisIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 38, 0));
  ...
  @override
  String toString() {
    return 'EphemerisIngest{id: ${id}, classificationMarking: ${classificationMarking}, esId: ${esId}, ts: ${ts}, xpos: ${xpos}, ypos: ${ypos}, zpos: ${zpos}, xvel: ${xvel}, yvel: ${yvel}, zvel: ${zvel}, xaccel: ${xaccel}, yaccel: ${yaccel}, zaccel: ${zaccel}, cov: ${cov}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, dataMode: ${dataMode}, idOnOrbit: ${idOnOrbit}, origObjectId: ${origObjectId}, origin: ${origin}}';
  }
}

class _EphemerisIngestReader extends fb.TableReader<EphemerisIngest> {
  const _EphemerisIngestReader();

  @override
  EphemerisIngest createObject(fb.BufferContext bc, int offset) => 
    EphemerisIngest._(bc, offset);
}

class EphemerisIngestBuilder {
  EphemerisIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(EphemerisIngestDataModeEnum? dataMode) {
...
class EphemerisIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EphemerisIngestDataModeEnum? _dataMode;
  final String? _idOnOrbit;
  final String? _origObjectId;
  final String? _origin;

  EphemerisIngestObjectBuilder({
    String? id,
    ...
    String? createdBy,
    String? source,
    EphemerisIngestDataModeEnum? dataMode,
    String? idOnOrbit,
    String? origObjectId,
    String? origin,
  })
