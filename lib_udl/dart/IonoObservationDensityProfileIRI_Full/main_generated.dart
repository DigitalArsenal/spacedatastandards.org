...
class IonoObservationDensityProfileIriFull {
  IonoObservationDensityProfileIriFull._(this._bc, this._bcOffset);
  factory IonoObservationDensityProfileIriFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationDensityProfileIriFull> reader = _IonoObservationDensityProfileIriFullReader();
  ...
  @override
  String toString() {
    return 'IonoObservationDensityProfileIriFull{description: ${description}, nmF2: ${nmF2}, hmF2: ${hmF2}, b0: ${b0}, b1: ${b1}, nmF1: ${nmF1}, hmF1: ${hmF1}, d1: ${d1}, hz: ${hz}, hValTop: ${hValTop}, nValB: ${nValB}, nmE: ${nmE}, hmE: ${hmE}, hdx: ${hdx}, nmD: ${nmD}, hmD: ${hmD}, ha: ${ha}, fp1: ${fp1}, fp2: ${fp2}, fp30: ${fp30}, fp3U: ${fp3U}, chi: ${chi}}';
  }
}

class _IonoObservationDensityProfileIriFullReader extends fb.TableReader<IonoObservationDensityProfileIriFull> {
  const _IonoObservationDensityProfileIriFullReader();

  @override
  IonoObservationDensityProfileIriFull createObject(fb.BufferContext bc, int offset) => 
    IonoObservationDensityProfileIriFull._(bc, offset);
}

class IonoObservationDensityProfileIriFullBuilder {
  IonoObservationDensityProfileIriFullBuilder(this.fbBuilder);
...
class IonoObservationDensityProfileIriFullObjectBuilder extends fb.ObjectBuilder {
  ...
  IonoObservationDensityProfileIriFullObjectBuilder({
    String? description,
    double? nmF2,
    double? hmF2,
    double? b0,
