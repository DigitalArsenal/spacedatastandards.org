...
class AirLoadPlanAbridgedDataModeEnum {
  final int value;
  const AirLoadPlanAbridgedDataModeEnum._(this.value);

  factory AirLoadPlanAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirLoadPlanAbridgedDataModeEnum');
    }
    return result;
  }

  static AirLoadPlanAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AirLoadPlanAbridgedDataModeEnum.fromValue(value);
  ...
  static const AirLoadPlanAbridgedDataModeEnum REAL = AirLoadPlanAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AirLoadPlanAbridgedDataModeEnum TEST = AirLoadPlanAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AirLoadPlanAbridgedDataModeEnum SIMULATED = AirLoadPlanAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AirLoadPlanAbridgedDataModeEnum EXERCISE = AirLoadPlanAbridgedDataModeEnum._(3);
  static const Map<int, AirLoadPlanAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AirLoadPlanAbridgedDataModeEnum> reader = _AirLoadPlanAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'AirLoadPlanAbridgedDataModeEnum{value: $value}';
  }
}

class _AirLoadPlanAbridgedDataModeEnumReader extends fb.Reader<AirLoadPlanAbridgedDataModeEnum> {
  const _AirLoadPlanAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AirLoadPlanAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      AirLoadPlanAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Information related to how an aircraft is loaded with cargo, equipment, and passengers.
class AirLoadPlanAbridged {
  AirLoadPlanAbridged._(this._bc, this._bcOffset);
  factory AirLoadPlanAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirLoadPlanAbridged> reader = _AirLoadPlanAbridgedReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 64
  String? get source => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 94);
  ///  Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
  ///  Example: /// Example: THIRD_PARTY_DATASOURCE
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get origin => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 96);
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 0, Maximum length = 32
  String? get origNetwork => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 98);
  ...
  AirLoadPlanAbridgedDataModeEnum get dataMode => AirLoadPlanAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 100, 0));

  @override
  String toString() {
    return 'AirLoadPlanAbridged{id: ${id}, classificationMarking: ${classificationMarking}, externalId: ${externalId}, idMission: ${idMission}, missionNumber: ${missionNumber}, idSortie: ${idSortie}, legNum: ${legNum}, callSign: ${callSign}, tailNumber: ${tailNumber}, aircraftMds: ${aircraftMds}, depIcao: ${depIcao}, depAirfield: ${depAirfield}, estDepTime: ${estDepTime}, arrIcao: ${arrIcao}, arrAirfield: ${arrAirfield}, estArrTime: ${estArrTime}, crewSize: ${crewSize}, cargoConfig: ${cargoConfig}, equipConfig: ${equipConfig}, tankConfig: ${tankConfig}, basicWeight: ${basicWeight}, basicMoment: ${basicMoment}, fuelWeight: ${fuelWeight}, fuelMoment: ${fuelMoment}, estLandingFuelWeight: ${estLandingFuelWeight}, estLandingFuelMoment: ${estLandingFuelMoment}, operatingWeight: ${operatingWeight}, operatingMoment: ${operatingMoment}, cargoWeight: ${cargoWeight}, cargoMoment: ${cargoMoment}, zeroFuelWeight: ${zeroFuelWeight}, zeroFuelMoment: ${zeroFuelMoment}, zeroFuelCg: ${zeroFuelCg}, grossWeight: ${grossWeight}, grossMoment: ${grossMoment}, grossCg: ${grossCg}, landingWeight: ${landingWeight}, landingMoment: ${landingMoment}, landingCg: ${landingCg}, cargoBayFsmin: ${cargoBayFsmin}, cargoBayFsmax: ${cargoBayFsmax}, cargoBayWidth: ${cargoBayWidth}, createdAt: ${createdAt}, createdBy: ${createdBy}, sourceDl: ${sourceDl}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _AirLoadPlanAbridgedReader extends fb.TableReader<AirLoadPlanAbridged> {
  const _AirLoadPlanAbridgedReader();

  @override
  AirLoadPlanAbridged createObject(fb.BufferContext bc, int offset) => 
    AirLoadPlanAbridged._(bc, offset);
}

class AirLoadPlanAbridgedBuilder {
  AirLoadPlanAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(AirLoadPlanAbridgedDataModeEnum? dataMode) {
    fbBuilder.addInt8(48, dataMode?.value);
    return fbBuilder.offset;
  }
...
class AirLoadPlanAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AirLoadPlanAbridgedDataModeEnum? _dataMode;

  AirLoadPlanAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    AirLoadPlanAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(45, sourceOffset);
    fbBuilder.addOffset(46, originOffset);
    fbBuilder.addOffset(47, origNetworkOffset);
    fbBuilder.addInt8(48, _dataMode?.value);
    return fbBuilder.endTable();
  }
