...
class RfemitterDetailsIngestDataModeEnum {
  final int value;
  const RfemitterDetailsIngestDataModeEnum._(this.value);

  factory RfemitterDetailsIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum RfemitterDetailsIngestDataModeEnum');
    }
    return result;
  }

  static RfemitterDetailsIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : RfemitterDetailsIngestDataModeEnum.fromValue(value);
  ...
  static const RfemitterDetailsIngestDataModeEnum REAL = RfemitterDetailsIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const RfemitterDetailsIngestDataModeEnum TEST = RfemitterDetailsIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const RfemitterDetailsIngestDataModeEnum SIMULATED = RfemitterDetailsIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const RfemitterDetailsIngestDataModeEnum EXERCISE = RfemitterDetailsIngestDataModeEnum._(3);
  static const Map<int, RfemitterDetailsIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<RfemitterDetailsIngestDataModeEnum> reader = _RfemitterDetailsIngestDataModeEnumReader();

  @override
  String toString() {
    return 'RfemitterDetailsIngestDataModeEnum{value: $value}';
  }
}

class _RfemitterDetailsIngestDataModeEnumReader extends fb.Reader<RfemitterDetailsIngestDataModeEnum> {
  const _RfemitterDetailsIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  RfemitterDetailsIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      RfemitterDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class RfemitterDetailsIngest {
  RfemitterDetailsIngest._(this._bc, this._bcOffset);
  factory RfemitterDetailsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<RfemitterDetailsIngest> reader = _RfemitterDetailsIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  RfemitterDetailsIngestDataModeEnum get dataMode => RfemitterDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 68, 0));
...
class RfemitterDetailsIngestBuilder {
  ...
  int addDataMode(RfemitterDetailsIngestDataModeEnum? dataMode) {
...
class RfemitterDetailsIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final RfemitterDetailsIngestDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;

  RfemitterDetailsIngestObjectBuilder({
    String? id,
    String? idRfemitter,
    ...
    String? origin,
    String? origNetwork,
    RfemitterDetailsIngestDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
  })
      : _id = id,
