...
class RoutePointsFull {
  RoutePointsFull._(this._bc, this._bcOffset);
  factory RoutePointsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<RoutePointsFull> reader = _RoutePointsFullReader();
  ...
  @override
  String toString() {
    return 'RoutePointsFull{ptSequenceId: ${ptSequenceId}, ptTypeCode: ${ptTypeCode}, ptTypeName: ${ptTypeName}, waypointName: ${waypointName}, dafifPt: ${dafifPt}, ptLat: ${ptLat}, ptLon: ${ptLon}, magDec: ${magDec}, navaidLength: ${navaidLength}, navaid: ${navaid}, countryCode: ${countryCode}, altCountryCode: ${altCountryCode}, navaidType: ${navaidType}}';
  }
}

class _RoutePointsFullReader extends fb.TableReader<RoutePointsFull> {
  const _RoutePointsFullReader();

  @override
  RoutePointsFull createObject(fb.BufferContext bc, int offset) => 
    RoutePointsFull._(bc, offset);
}

class RoutePointsFullBuilder {
  RoutePointsFullBuilder(this.fbBuilder);
...
class RoutePointsFullObjectBuilder extends fb.ObjectBuilder {
