...
class MonoRadarAbridgedDataModeEnum {
  final int value;
  const MonoRadarAbridgedDataModeEnum._(this.value);

  factory MonoRadarAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum MonoRadarAbridgedDataModeEnum');
    }
    return result;
  }

  static MonoRadarAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : MonoRadarAbridgedDataModeEnum.fromValue(value);
  ...
  static const MonoRadarAbridgedDataModeEnum REAL = MonoRadarAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const MonoRadarAbridgedDataModeEnum TEST = MonoRadarAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const MonoRadarAbridgedDataModeEnum SIMULATED = MonoRadarAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const MonoRadarAbridgedDataModeEnum EXERCISE = MonoRadarAbridgedDataModeEnum._(3);
  static const Map<int, MonoRadarAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<MonoRadarAbridgedDataModeEnum> reader = _MonoRadarAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'MonoRadarAbridgedDataModeEnum{value: $value}';
  }
}

class _MonoRadarAbridgedDataModeEnumReader extends fb.Reader<MonoRadarAbridgedDataModeEnum> {
  const _MonoRadarAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  MonoRadarAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      MonoRadarAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class MonoRadarAbridged {
  MonoRadarAbridged._(this._bc, this._bcOffset);
  factory MonoRadarAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MonoRadarAbridged> reader = _MonoRadarAbridgedReader();
  ...
  MonoRadarAbridgedDataModeEnum get dataMode => MonoRadarAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 142, 0));
  ...
  @override
  String toString() {
    return 'MonoRadarAbridged{id: ${id}, classificationMarking: ${classificationMarking}, tti: ${tti}, idSensor: ${idSensor}, senlat: ${senlat}, senlon: ${senlon}, senalt: ${senalt}, sac: ${sac}, sic: ${sic}, tgtid: ${tgtid}, addr: ${addr}, msgfmt: ${msgfmt}, msgtyp: ${msgtyp}, af: ${af}, faa: ${faa}, spi: ${spi}, aims: ${aims}, mti: ${mti}, bcnhits: ${bcnhits}, ts: ${ts}, msgts: ${msgts}, rng: ${rng}, az: ${az}, acp: ${acp}, alt3d: ${alt3d}, mc: ${mc}, mcv: ${mcv}, mcg: ${mcg}, m1: ${m1}, m1v: ${m1v}, m1g: ${m1g}, m2: ${m2}, m2v: ${m2v}, m2xv: ${m2xv}, m2g: ${m2g}, m3a: ${m3a}, m3av: ${m3av}, m3ag: ${m3ag}, m3axv: ${m3axv}, m4: ${m4}, m4v: ${m4v}, m4d1d2: ${m4d1d2}, mscommb: ${mscommb}, milemrgcy: ${milemrgcy}, code7500: ${code7500}, code7600: ${code7600}, code7700: ${code7700}, grndspd: ${grndspd}, hdng: ${hdng}, trknum: ${trknum}, rad: ${rad}, mah: ${mah}, cdm: ${cdm}, cartpos: ${cartpos}, psrrl: ${psrrl}, ssrl: ${ssrl}, rngdelt: ${rngdelt}, azdelt: ${azdelt}, wectc: ${wectc}, mrgrpt: ${mrgrpt}, artsqual: ${artsqual}, trkelig: ${trkelig}, tgtconf: ${tgtconf}, tgtcorr: ${tgtcorr}, tis: ${tis}, tags: ${tags}, origSensorId: ${origSensorId}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, createdAt: ${createdAt}, createdBy: ${createdBy}, origNetwork: ${origNetwork}}';
  }
}

class _MonoRadarAbridgedReader extends fb.TableReader<MonoRadarAbridged> {
  const _MonoRadarAbridgedReader();

  @override
  MonoRadarAbridged createObject(fb.BufferContext bc, int offset) => 
    MonoRadarAbridged._(bc, offset);
}

class MonoRadarAbridgedBuilder {
  MonoRadarAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(MonoRadarAbridgedDataModeEnum? dataMode) {
...
class MonoRadarAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final MonoRadarAbridgedDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final String? _origNetwork;

  MonoRadarAbridgedObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    MonoRadarAbridgedDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? origNetwork,
  })
