...
class AnalyticImageryIngestDataModeEnum {
  final int value;
  const AnalyticImageryIngestDataModeEnum._(this.value);

  factory AnalyticImageryIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AnalyticImageryIngestDataModeEnum');
    }
    return result;
  }

  static AnalyticImageryIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AnalyticImageryIngestDataModeEnum.fromValue(value);
  ...
  static const AnalyticImageryIngestDataModeEnum REAL = AnalyticImageryIngestDataModeEnum._(0);

  ///  No description available.
  static const AnalyticImageryIngestDataModeEnum TEST = AnalyticImageryIngestDataModeEnum._(1);

  ///  No description available.
  static const AnalyticImageryIngestDataModeEnum SIMULATED = AnalyticImageryIngestDataModeEnum._(2);

  ///  No description available.
  static const AnalyticImageryIngestDataModeEnum EXERCISE = AnalyticImageryIngestDataModeEnum._(3);
  static const Map<int, AnalyticImageryIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AnalyticImageryIngestDataModeEnum> reader = _AnalyticImageryIngestDataModeEnumReader();

  @override
  String toString() {
    return 'AnalyticImageryIngestDataModeEnum{value: $value}';
  }
}

class _AnalyticImageryIngestDataModeEnumReader extends fb.Reader<AnalyticImageryIngestDataModeEnum> {
  const _AnalyticImageryIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AnalyticImageryIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      AnalyticImageryIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AnalyticImageryIngest {
  AnalyticImageryIngest._(this._bc, this._bcOffset);
  factory AnalyticImageryIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AnalyticImageryIngest> reader = _AnalyticImageryIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  AnalyticImageryIngestDataModeEnum get dataMode => AnalyticImageryIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 84, 0));
...
class _AnalyticImageryIngestReader extends fb.TableReader<AnalyticImageryIngest> {
  const _AnalyticImageryIngestReader();

  @override
  AnalyticImageryIngest createObject(fb.BufferContext bc, int offset) => 
    AnalyticImageryIngest._(bc, offset);
}

class AnalyticImageryIngestBuilder {
  AnalyticImageryIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(AnalyticImageryIngestDataModeEnum? dataMode) {
...
class AnalyticImageryIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AnalyticImageryIngestDataModeEnum? _dataMode;

  AnalyticImageryIngestObjectBuilder({
    String? id,
    ...
    String? origNetwork,
    String? sourceDl,
    AnalyticImageryIngestDataModeEnum? dataMode,
  })
      : _id = id,
