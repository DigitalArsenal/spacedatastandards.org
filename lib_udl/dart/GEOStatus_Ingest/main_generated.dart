...
class GeostatusIngestDataModeEnum {
  final int value;
  const GeostatusIngestDataModeEnum._(this.value);

  factory GeostatusIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum GeostatusIngestDataModeEnum');
    }
    return result;
  }

  static GeostatusIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : GeostatusIngestDataModeEnum.fromValue(value);
  ...
  static const GeostatusIngestDataModeEnum REAL = GeostatusIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const GeostatusIngestDataModeEnum TEST = GeostatusIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const GeostatusIngestDataModeEnum SIMULATED = GeostatusIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const GeostatusIngestDataModeEnum EXERCISE = GeostatusIngestDataModeEnum._(3);
  static const Map<int, GeostatusIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<GeostatusIngestDataModeEnum> reader = _GeostatusIngestDataModeEnumReader();

  @override
  String toString() {
    return 'GeostatusIngestDataModeEnum{value: $value}';
  }
}

class _GeostatusIngestDataModeEnumReader extends fb.Reader<GeostatusIngestDataModeEnum> {
  const _GeostatusIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  GeostatusIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      GeostatusIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Information for the specified on-orbit GEO spacecraft, including status, expected longitude limits, and drift rates.
class GeostatusIngest {
  GeostatusIngest._(this._bc, this._bcOffset);
  factory GeostatusIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<GeostatusIngest> reader = _GeostatusIngestReader();
  ...
  GeostatusIngestDataModeEnum get dataMode => GeostatusIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 46, 0));
...
class GeostatusIngestBuilder {
  ...
  int addDataMode(GeostatusIngestDataModeEnum? dataMode) {
...
class GeostatusIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final GeostatusIngestDataModeEnum? _dataMode;
  final int? _satNo;
  final String? _origNetwork;

  GeostatusIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    GeostatusIngestDataModeEnum? dataMode,
    int? satNo,
    String? origNetwork,
  })
      : _id = id,
