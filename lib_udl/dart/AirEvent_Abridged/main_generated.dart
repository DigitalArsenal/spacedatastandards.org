...
class AirEventAbridgedDataModeEnum {
  final int value;
  const AirEventAbridgedDataModeEnum._(this.value);

  factory AirEventAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirEventAbridgedDataModeEnum');
    }
    return result;
  }

  static AirEventAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AirEventAbridgedDataModeEnum.fromValue(value);
  ...
  static const AirEventAbridgedDataModeEnum REAL = AirEventAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AirEventAbridgedDataModeEnum TEST = AirEventAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AirEventAbridgedDataModeEnum SIMULATED = AirEventAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AirEventAbridgedDataModeEnum EXERCISE = AirEventAbridgedDataModeEnum._(3);
  static const Map<int, AirEventAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AirEventAbridgedDataModeEnum> reader = _AirEventAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'AirEventAbridgedDataModeEnum{value: $value}';
  }
}

class _AirEventAbridgedDataModeEnumReader extends fb.Reader<AirEventAbridgedDataModeEnum> {
  const _AirEventAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AirEventAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      AirEventAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Information related to an air event (e.g. FUEL TRANSFER, AIR DROP) and the associated aircraft.
class AirEventAbridged {
  AirEventAbridged._(this._bc, this._bcOffset);
  factory AirEventAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirEventAbridged> reader = _AirEventAbridgedReader();
...
class AirEventAbridgedBuilder {
  ...
  int addDataMode(AirEventAbridgedDataModeEnum? dataMode) {
...
class AirEventAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AirEventAbridgedDataModeEnum? _dataMode;

  AirEventAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    AirEventAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
