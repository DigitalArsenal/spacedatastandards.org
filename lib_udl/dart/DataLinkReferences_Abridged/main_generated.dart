...
class DataLinkReferencesAbridged {
  DataLinkReferencesAbridged._(this._bc, this._bcOffset);
  factory DataLinkReferencesAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DataLinkReferencesAbridged> reader = _DataLinkReferencesAbridgedReader();
  ...
  @override
  String toString() {
    return 'DataLinkReferencesAbridged{refSerialId: ${refSerialId}, refType: ${refType}, refOriginator: ${refOriginator}, refTs: ${refTs}, refSerialNum: ${refSerialNum}, refSpecialNotation: ${refSpecialNotation}, refSics: ${refSics}}';
  }
}

class _DataLinkReferencesAbridgedReader extends fb.TableReader<DataLinkReferencesAbridged> {
  const _DataLinkReferencesAbridgedReader();

  @override
  DataLinkReferencesAbridged createObject(fb.BufferContext bc, int offset) => 
    DataLinkReferencesAbridged._(bc, offset);
}

class DataLinkReferencesAbridgedBuilder {
  DataLinkReferencesAbridgedBuilder(this.fbBuilder);
...
class DataLinkReferencesAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  DataLinkReferencesAbridgedObjectBuilder({
    String? refSerialId,
    String? refType,
