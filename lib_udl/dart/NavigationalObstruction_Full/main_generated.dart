...
class NavigationalObstructionFullDataModeEnum {
  final int value;
  const NavigationalObstructionFullDataModeEnum._(this.value);

  factory NavigationalObstructionFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum NavigationalObstructionFullDataModeEnum');
    }
    return result;
  }

  static NavigationalObstructionFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : NavigationalObstructionFullDataModeEnum.fromValue(value);
  ...
  static const NavigationalObstructionFullDataModeEnum REAL = NavigationalObstructionFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const NavigationalObstructionFullDataModeEnum TEST = NavigationalObstructionFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const NavigationalObstructionFullDataModeEnum SIMULATED = NavigationalObstructionFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const NavigationalObstructionFullDataModeEnum EXERCISE = NavigationalObstructionFullDataModeEnum._(3);
  static const Map<int, NavigationalObstructionFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<NavigationalObstructionFullDataModeEnum> reader = _NavigationalObstructionFullDataModeEnumReader();

  @override
  String toString() {
    return 'NavigationalObstructionFullDataModeEnum{value: $value}';
  }
}

class _NavigationalObstructionFullDataModeEnumReader extends fb.Reader<NavigationalObstructionFullDataModeEnum> {
  const _NavigationalObstructionFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  NavigationalObstructionFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      NavigationalObstructionFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class NavigationalObstructionFull {
  NavigationalObstructionFull._(this._bc, this._bcOffset);
  factory NavigationalObstructionFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<NavigationalObstructionFull> reader = _NavigationalObstructionFullReader();
  ...
  ///  Constraints: No constraints specified.
  String? get updatedAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 148);
  ///  Application user who updated the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get updatedBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 150);
  ///  The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
  ///  Example: /// Example: AXE
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get sourceDl => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 152);
  ///  Source of the data.
...
class NavigationalObstructionFullBuilder {
  ...
  int addDataMode(NavigationalObstructionFullDataModeEnum? dataMode) {
...
class NavigationalObstructionFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final NavigationalObstructionFullDataModeEnum? _dataMode;

  NavigationalObstructionFullObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    NavigationalObstructionFullDataModeEnum? dataMode,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(72, updatedAtOffset);
    fbBuilder.addOffset(73, updatedByOffset);
    fbBuilder.addOffset(74, sourceDlOffset);
