...
class EntityFullTypeEnum {
  final int value;
  const EntityFullTypeEnum._(this.value);

  factory EntityFullTypeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EntityFullTypeEnum');
    }
    return result;
  }

  static EntityFullTypeEnum? _createOrNull(int? value) => 
      value == null ? null : EntityFullTypeEnum.fromValue(value);
  ...
  static const EntityFullTypeEnum AIRCRAFT = EntityFullTypeEnum._(0);

  ///  No description available.
  static const EntityFullTypeEnum BUS = EntityFullTypeEnum._(1);

  ///  No description available.
  static const EntityFullTypeEnum COMM = EntityFullTypeEnum._(2);

  ///  No description available.
  static const EntityFullTypeEnum IR = EntityFullTypeEnum._(3);

  ///  No description available.
  static const EntityFullTypeEnum NAVIGATION = EntityFullTypeEnum._(4);

  ///  No description available.
  static const EntityFullTypeEnum ONORBIT = EntityFullTypeEnum._(5);

  ///  No description available.
  static const EntityFullTypeEnum RFEMITTER = EntityFullTypeEnum._(6);

  ///  No description available.
  static const EntityFullTypeEnum SCIENTIFIC = EntityFullTypeEnum._(7);

  ///  No description available.
  static const EntityFullTypeEnum SENSOR = EntityFullTypeEnum._(8);

  ///  No description available.
  static const EntityFullTypeEnum SITE = EntityFullTypeEnum._(9);

  ///  No description available.
  static const EntityFullTypeEnum VESSEL = EntityFullTypeEnum._(10);
  static const Map<int, EntityFullTypeEnum> values = {
    0: AIRCRAFT,
    1: BUS,
    2: COMM,
    3: IR,
  ...
  static const fb.Reader<EntityFullTypeEnum> reader = _EntityFullTypeEnumReader();

  @override
  String toString() {
    return 'EntityFullTypeEnum{value: $value}';
  }
}

class _EntityFullTypeEnumReader extends fb.Reader<EntityFullTypeEnum> {
  const _EntityFullTypeEnumReader();

  @override
  int get size => 1;

  @override
  EntityFullTypeEnum read(fb.BufferContext bc, int offset) =>
      EntityFullTypeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class EntityFullOwnerTypeEnum {
  final int value;
  const EntityFullOwnerTypeEnum._(this.value);

  factory EntityFullOwnerTypeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EntityFullOwnerTypeEnum');
    }
    return result;
  }

  static EntityFullOwnerTypeEnum? _createOrNull(int? value) => 
      value == null ? null : EntityFullOwnerTypeEnum.fromValue(value);
  ...
  ///  No description available.
  static const EntityFullOwnerTypeEnum COMMERCIAL = EntityFullOwnerTypeEnum._(0);

  ///  No description available.
  static const EntityFullOwnerTypeEnum GOVERNMENT = EntityFullOwnerTypeEnum._(1);

  ///  No description available.
  static const EntityFullOwnerTypeEnum ACADEMIC = EntityFullOwnerTypeEnum._(2);

  ///  No description available.
  static const EntityFullOwnerTypeEnum CONSORTIUM = EntityFullOwnerTypeEnum._(3);

  ///  No description available.
  static const EntityFullOwnerTypeEnum OTHER = EntityFullOwnerTypeEnum._(4);
  static const Map<int, EntityFullOwnerTypeEnum> values = {
    0: COMMERCIAL,
    1: GOVERNMENT,
    2: ACADEMIC,
    3: CONSORTIUM,
  ...
  static const fb.Reader<EntityFullOwnerTypeEnum> reader = _EntityFullOwnerTypeEnumReader();

  @override
  String toString() {
    return 'EntityFullOwnerTypeEnum{value: $value}';
  }
}

class _EntityFullOwnerTypeEnumReader extends fb.Reader<EntityFullOwnerTypeEnum> {
  const _EntityFullOwnerTypeEnumReader();

  @override
  int get size => 1;

  @override
  EntityFullOwnerTypeEnum read(fb.BufferContext bc, int offset) =>
      EntityFullOwnerTypeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class EntityFullDataModeEnum {
  final int value;
  const EntityFullDataModeEnum._(this.value);

  factory EntityFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EntityFullDataModeEnum');
    }
    return result;
  }

  static EntityFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EntityFullDataModeEnum.fromValue(value);
  ...
  static const EntityFullDataModeEnum REAL = EntityFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EntityFullDataModeEnum TEST = EntityFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EntityFullDataModeEnum SIMULATED = EntityFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EntityFullDataModeEnum EXERCISE = EntityFullDataModeEnum._(3);
  static const Map<int, EntityFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EntityFullDataModeEnum> reader = _EntityFullDataModeEnumReader();

  @override
  String toString() {
    return 'EntityFullDataModeEnum{value: $value}';
  }
}

class _EntityFullDataModeEnumReader extends fb.Reader<EntityFullDataModeEnum> {
  const _EntityFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EntityFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      EntityFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class EntityFull {
  EntityFull._(this._bc, this._bcOffset);
  factory EntityFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EntityFull> reader = _EntityFullReader();
  ...
  EntityFullTypeEnum get type => EntityFullTypeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 10, 0));
  ...
  EntityFullOwnerTypeEnum get ownerType => EntityFullOwnerTypeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 16, 0));
  ...
  EntityFullDataModeEnum get dataMode => EntityFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 34, 0));
...
class EntityFullBuilder {
  ...
  int addType(EntityFullTypeEnum? type) {
  ...
  int addOwnerType(EntityFullOwnerTypeEnum? ownerType) {
  ...
  int addDataMode(EntityFullDataModeEnum? dataMode) {
...
class EntityFullObjectBuilder extends fb.ObjectBuilder {
  final String? _idEntity;
  final String? _name;
  final String? _classificationMarking;
  final EntityFullTypeEnum? _type;
  final String? _idLocation;
  final String? _countryCode;
  final EntityFullOwnerTypeEnum? _ownerType;
  ...
  final EntityFullDataModeEnum? _dataMode;
  ...
  EntityFullObjectBuilder({
    String? idEntity,
    String? name,
    String? classificationMarking,
    EntityFullTypeEnum? type,
    String? idLocation,
    String? countryCode,
    EntityFullOwnerTypeEnum? ownerType,
    bool? taskable,
    List<String>? urls,
    String? createdAt,
    String? createdBy,
    ...
    String? source,
    String? origin,
    EntityFullDataModeEnum? dataMode,
    String? location,
    String? onOrbit,
    String? idOnOrbit,
