...
class TransponderAbridgedDataModeEnum {
  final int value;
  const TransponderAbridgedDataModeEnum._(this.value);

  factory TransponderAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum TransponderAbridgedDataModeEnum');
    }
    return result;
  }

  static TransponderAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : TransponderAbridgedDataModeEnum.fromValue(value);
  ...
  static const TransponderAbridgedDataModeEnum REAL = TransponderAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const TransponderAbridgedDataModeEnum TEST = TransponderAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const TransponderAbridgedDataModeEnum SIMULATED = TransponderAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const TransponderAbridgedDataModeEnum EXERCISE = TransponderAbridgedDataModeEnum._(3);
  static const Map<int, TransponderAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<TransponderAbridgedDataModeEnum> reader = _TransponderAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'TransponderAbridgedDataModeEnum{value: $value}';
  }
}

class _TransponderAbridgedDataModeEnumReader extends fb.Reader<TransponderAbridgedDataModeEnum> {
  const _TransponderAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  TransponderAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      TransponderAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class TransponderAbridged {
  TransponderAbridged._(this._bc, this._bcOffset);
  factory TransponderAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<TransponderAbridged> reader = _TransponderAbridgedReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  TransponderAbridgedDataModeEnum get dataMode => TransponderAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 34, 0));
  ...
  @override
  String toString() {
    return 'TransponderAbridged{id: ${id}, idComm: ${idComm}, name: ${name}, classificationMarking: ${classificationMarking}, nid: ${nid}, tid: ${tid}, ttf: ${ttf}, symbolRate: ${symbolRate}, fec: ${fec}, modulation: ${modulation}, format: ${format}, system: ${system}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, createdAt: ${createdAt}, createdBy: ${createdBy}}';
  }
}

class _TransponderAbridgedReader extends fb.TableReader<TransponderAbridged> {
  const _TransponderAbridgedReader();

  @override
  TransponderAbridged createObject(fb.BufferContext bc, int offset) => 
    TransponderAbridged._(bc, offset);
}

class TransponderAbridgedBuilder {
  TransponderAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(TransponderAbridgedDataModeEnum? dataMode) {
...
class TransponderAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final TransponderAbridgedDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;

  TransponderAbridgedObjectBuilder({
    String? id,
    String? idComm,
    String? name,
    ...
    String? origin,
    String? origNetwork,
    TransponderAbridgedDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
  })
      : _id = id,
