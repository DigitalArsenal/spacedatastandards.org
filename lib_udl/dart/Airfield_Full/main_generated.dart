...
class AirfieldFullDataModeEnum {
  final int value;
  const AirfieldFullDataModeEnum._(this.value);

  factory AirfieldFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirfieldFullDataModeEnum');
    }
    return result;
  }

  static AirfieldFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AirfieldFullDataModeEnum.fromValue(value);
  ...
  static const AirfieldFullDataModeEnum REAL = AirfieldFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AirfieldFullDataModeEnum TEST = AirfieldFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AirfieldFullDataModeEnum SIMULATED = AirfieldFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AirfieldFullDataModeEnum EXERCISE = AirfieldFullDataModeEnum._(3);
  static const Map<int, AirfieldFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AirfieldFullDataModeEnum> reader = _AirfieldFullDataModeEnumReader();

  @override
  String toString() {
    return 'AirfieldFullDataModeEnum{value: $value}';
  }
}

class _AirfieldFullDataModeEnumReader extends fb.Reader<AirfieldFullDataModeEnum> {
  const _AirfieldFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AirfieldFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      AirfieldFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Properties and characteristics of an airfield, which includes location, airfield codes, suitability codes, and remarks.
class AirfieldFull {
  AirfieldFull._(this._bc, this._bcOffset);
  factory AirfieldFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirfieldFull> reader = _AirfieldFullReader();
  ...
  ///  Example: /// Example: 2022-01-01T16:00:00.123Z
  ///  Constraints: No constraints specified.
  String? get updatedAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 64);
  ///  Application user who updated the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get updatedBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 66);
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  AirfieldFullDataModeEnum get dataMode => AirfieldFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 76, 0));

  @override
  String toString() {
    return 'AirfieldFull{id: ${id}, classificationMarking: ${classificationMarking}, idSite: ${idSite}, altAirfieldId: ${altAirfieldId}, wacInnr: ${wacInnr}, zarId: ${zarId}, icao: ${icao}, iata: ${iata}, faa: ${faa}, hostNatCode: ${hostNatCode}, name: ${name}, type: ${type}, lat: ${lat}, lon: ${lon}, elevFt: ${elevFt}, elevM: ${elevM}, magDec: ${magDec}, regionName: ${regionName}, countryCode: ${countryCode}, city: ${city}, state: ${state}, geoloc: ${geoloc}, gmtOffset: ${gmtOffset}, suitabilityCodes: ${suitabilityCodes}, miscCodes: ${miscCodes}, runways: ${runways}, maxRunwayLength: ${maxRunwayLength}, infoUrl: ${infoUrl}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, sourceDl: ${sourceDl}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _AirfieldFullReader extends fb.TableReader<AirfieldFull> {
  const _AirfieldFullReader();

  @override
  AirfieldFull createObject(fb.BufferContext bc, int offset) => 
    AirfieldFull._(bc, offset);
}

class AirfieldFullBuilder {
  AirfieldFullBuilder(this.fbBuilder);
  ...
  int addDataMode(AirfieldFullDataModeEnum? dataMode) {
...
class AirfieldFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AirfieldFullDataModeEnum? _dataMode;

  AirfieldFullObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    AirfieldFullDataModeEnum? dataMode,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(30, updatedAtOffset);
    fbBuilder.addOffset(31, updatedByOffset);
