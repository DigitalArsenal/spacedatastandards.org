...
class ManeuverFullDataModeEnum {
  final int value;
  const ManeuverFullDataModeEnum._(this.value);

  factory ManeuverFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ManeuverFullDataModeEnum');
    }
    return result;
  }

  static ManeuverFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : ManeuverFullDataModeEnum.fromValue(value);
  ...
  static const ManeuverFullDataModeEnum REAL = ManeuverFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const ManeuverFullDataModeEnum TEST = ManeuverFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const ManeuverFullDataModeEnum SIMULATED = ManeuverFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const ManeuverFullDataModeEnum EXERCISE = ManeuverFullDataModeEnum._(3);
  static const Map<int, ManeuverFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<ManeuverFullDataModeEnum> reader = _ManeuverFullDataModeEnumReader();

  @override
  String toString() {
    return 'ManeuverFullDataModeEnum{value: $value}';
  }
}

class _ManeuverFullDataModeEnumReader extends fb.Reader<ManeuverFullDataModeEnum> {
  const _ManeuverFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  ManeuverFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      ManeuverFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class ManeuverFullSourcedDataTypesEnum {
  final int value;
  const ManeuverFullSourcedDataTypesEnum._(this.value);

  factory ManeuverFullSourcedDataTypesEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ManeuverFullSourcedDataTypesEnum');
    }
    return result;
  }

  static ManeuverFullSourcedDataTypesEnum? _createOrNull(int? value) => 
      value == null ? null : ManeuverFullSourcedDataTypesEnum.fromValue(value);
  ...
  static const ManeuverFullSourcedDataTypesEnum EO = ManeuverFullSourcedDataTypesEnum._(0);

  ///  No description available.
  static const ManeuverFullSourcedDataTypesEnum RADAR = ManeuverFullSourcedDataTypesEnum._(1);

  ///  No description available.
  static const ManeuverFullSourcedDataTypesEnum RF = ManeuverFullSourcedDataTypesEnum._(2);

  ///  No description available.
  static const ManeuverFullSourcedDataTypesEnum DOA = ManeuverFullSourcedDataTypesEnum._(3);

  ///  No description available.
  static const ManeuverFullSourcedDataTypesEnum ELSET = ManeuverFullSourcedDataTypesEnum._(4);

  ///  No description available.
  static const ManeuverFullSourcedDataTypesEnum SV = ManeuverFullSourcedDataTypesEnum._(5);
  static const Map<int, ManeuverFullSourcedDataTypesEnum> values = {
    0: EO,
    1: RADAR,
    2: RF,
    3: DOA,
  ...
  static const fb.Reader<ManeuverFullSourcedDataTypesEnum> reader = _ManeuverFullSourcedDataTypesEnumReader();

  @override
  String toString() {
    return 'ManeuverFullSourcedDataTypesEnum{value: $value}';
  }
}

class _ManeuverFullSourcedDataTypesEnumReader extends fb.Reader<ManeuverFullSourcedDataTypesEnum> {
  const _ManeuverFullSourcedDataTypesEnumReader();

  @override
  int get size => 1;

  @override
  ManeuverFullSourcedDataTypesEnum read(fb.BufferContext bc, int offset) =>
      ManeuverFullSourcedDataTypesEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Model representation of on-orbit object maneuver information for detected, possible, and confirmed maneuvers.
class ManeuverFull {
  ManeuverFull._(this._bc, this._bcOffset);
  factory ManeuverFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<ManeuverFull> reader = _ManeuverFullReader();
  ...
  ManeuverFullDataModeEnum get dataMode => ManeuverFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 182, 0));
...
class ManeuverFullBuilder {
  ...
  int addDataMode(ManeuverFullDataModeEnum? dataMode) {
  ...
  int addSourcedDataTypes(ManeuverFullSourcedDataTypesEnum? sourcedDataTypes) {
...
class ManeuverFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final ManeuverFullDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final List<String>? _tags;
  final String? _algorithm;
  final List<String>? _sourcedData;
  final ManeuverFullSourcedDataTypesEnum? _sourcedDataTypes;
  final String? _onOrbit;
  final String? _transactionId;
  final String? _origNetwork;

  ManeuverFullObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    ManeuverFullDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    List<String>? tags,
    String? algorithm,
    List<String>? sourcedData,
    ManeuverFullSourcedDataTypesEnum? sourcedDataTypes,
    String? onOrbit,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(96, onOrbitOffset);
    fbBuilder.addOffset(97, transactionIdOffset);
    fbBuilder.addOffset(98, origNetworkOffset);
    return fbBuilder.endTable();
  }
