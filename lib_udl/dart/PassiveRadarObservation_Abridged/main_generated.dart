...
class PassiveRadarObservationAbridgedDataModeEnum {
  final int value;
  const PassiveRadarObservationAbridgedDataModeEnum._(this.value);

  factory PassiveRadarObservationAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum PassiveRadarObservationAbridgedDataModeEnum');
    }
    return result;
  }

  static PassiveRadarObservationAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : PassiveRadarObservationAbridgedDataModeEnum.fromValue(value);
  ...
  static const PassiveRadarObservationAbridgedDataModeEnum REAL = PassiveRadarObservationAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const PassiveRadarObservationAbridgedDataModeEnum TEST = PassiveRadarObservationAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const PassiveRadarObservationAbridgedDataModeEnum SIMULATED = PassiveRadarObservationAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const PassiveRadarObservationAbridgedDataModeEnum EXERCISE = PassiveRadarObservationAbridgedDataModeEnum._(3);
  static const Map<int, PassiveRadarObservationAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<PassiveRadarObservationAbridgedDataModeEnum> reader = _PassiveRadarObservationAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'PassiveRadarObservationAbridgedDataModeEnum{value: $value}';
  }
}

class _PassiveRadarObservationAbridgedDataModeEnumReader extends fb.Reader<PassiveRadarObservationAbridgedDataModeEnum> {
  const _PassiveRadarObservationAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  PassiveRadarObservationAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      PassiveRadarObservationAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class PassiveRadarObservationAbridged {
  PassiveRadarObservationAbridged._(this._bc, this._bcOffset);
  factory PassiveRadarObservationAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PassiveRadarObservationAbridged> reader = _PassiveRadarObservationAbridgedReader();
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get transactionId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 116);
  ...
  ///  Constraints: No constraints specified.
  String? get createdAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 120);
  ///  Application user who created the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 1, Maximum length = 64
  String? get createdBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 122);
  ///  Source of the data.
  ...
  String? get origNetwork => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 128);
...
class PassiveRadarObservationAbridgedBuilder {
  ...
  int addDataMode(PassiveRadarObservationAbridgedDataModeEnum? dataMode) {
...
class PassiveRadarObservationAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final PassiveRadarObservationAbridgedDataModeEnum? _dataMode;
  final String? _type;

  PassiveRadarObservationAbridgedObjectBuilder({
    String? id,
    ...
    String? origNetwork,
    String? sourceDl,
    PassiveRadarObservationAbridgedDataModeEnum? dataMode,
    String? type,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(56, transactionIdOffset);
    fbBuilder.addOffset(57, descriptorOffset);
    fbBuilder.addOffset(58, createdAtOffset);
    fbBuilder.addOffset(59, createdByOffset);
    fbBuilder.addOffset(60, sourceOffset);
    fbBuilder.addOffset(61, originOffset);
    fbBuilder.addOffset(62, origNetworkOffset);
    fbBuilder.addOffset(63, sourceDlOffset);
    fbBuilder.addInt8(64, _dataMode?.value);
    fbBuilder.addOffset(65, typeOffset);
    return fbBuilder.endTable();
  }
