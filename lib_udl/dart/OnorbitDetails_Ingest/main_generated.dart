...
class OnorbitDetailsIngestDataModeEnum {
  final int value;
  const OnorbitDetailsIngestDataModeEnum._(this.value);

  factory OnorbitDetailsIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OnorbitDetailsIngestDataModeEnum');
    }
    return result;
  }

  static OnorbitDetailsIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OnorbitDetailsIngestDataModeEnum.fromValue(value);
  ...
  static const OnorbitDetailsIngestDataModeEnum REAL = OnorbitDetailsIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OnorbitDetailsIngestDataModeEnum TEST = OnorbitDetailsIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OnorbitDetailsIngestDataModeEnum SIMULATED = OnorbitDetailsIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OnorbitDetailsIngestDataModeEnum EXERCISE = OnorbitDetailsIngestDataModeEnum._(3);
  static const Map<int, OnorbitDetailsIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OnorbitDetailsIngestDataModeEnum> reader = _OnorbitDetailsIngestDataModeEnumReader();

  @override
  String toString() {
    return 'OnorbitDetailsIngestDataModeEnum{value: $value}';
  }
}

class _OnorbitDetailsIngestDataModeEnumReader extends fb.Reader<OnorbitDetailsIngestDataModeEnum> {
  const _OnorbitDetailsIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OnorbitDetailsIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      OnorbitDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Contains details of the OnOrbit object.
class OnorbitDetailsIngest {
  OnorbitDetailsIngest._(this._bc, this._bcOffset);
  factory OnorbitDetailsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OnorbitDetailsIngest> reader = _OnorbitDetailsIngestReader();
  ...
  OnorbitDetailsIngestDataModeEnum get dataMode => OnorbitDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 92, 0));
...
class OnorbitDetailsIngestBuilder {
  ...
  int addDataMode(OnorbitDetailsIngestDataModeEnum? dataMode) {
...
class OnorbitDetailsIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final OnorbitDetailsIngestDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final String? _origNetwork;

  OnorbitDetailsIngestObjectBuilder({
    String? id,
    String? idOnOrbit,
    ...
    String? origin,
    String? lastObSource,
    OnorbitDetailsIngestDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? origNetwork,
  })
