...
class EcpsdrIngestDataModeEnum {
  final int value;
  const EcpsdrIngestDataModeEnum._(this.value);

  factory EcpsdrIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EcpsdrIngestDataModeEnum');
    }
    return result;
  }

  static EcpsdrIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EcpsdrIngestDataModeEnum.fromValue(value);
  ...
  static const EcpsdrIngestDataModeEnum REAL = EcpsdrIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EcpsdrIngestDataModeEnum TEST = EcpsdrIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EcpsdrIngestDataModeEnum SIMULATED = EcpsdrIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EcpsdrIngestDataModeEnum EXERCISE = EcpsdrIngestDataModeEnum._(3);
  static const Map<int, EcpsdrIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EcpsdrIngestDataModeEnum> reader = _EcpsdrIngestDataModeEnumReader();

  @override
  String toString() {
    return 'EcpsdrIngestDataModeEnum{value: $value}';
  }
}

class _EcpsdrIngestDataModeEnumReader extends fb.Reader<EcpsdrIngestDataModeEnum> {
  const _EcpsdrIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EcpsdrIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      EcpsdrIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class EcpsdrIngest {
  EcpsdrIngest._(this._bc, this._bcOffset);
  factory EcpsdrIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EcpsdrIngest> reader = _EcpsdrIngestReader();
...
class EcpsdrIngestBuilder {
  ...
  int addDataMode(EcpsdrIngestDataModeEnum? dataMode) {
...
class EcpsdrIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EcpsdrIngestDataModeEnum? _dataMode;

  EcpsdrIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    EcpsdrIngestDataModeEnum? dataMode,
  })
      : _id = id,
