...
class EvacEtiologyFull {
  EvacEtiologyFull._(this._bc, this._bcOffset);
  factory EvacEtiologyFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EvacEtiologyFull> reader = _EvacEtiologyFullReader();
  ...
  @override
  String toString() {
    return 'EvacEtiologyFull{type: ${type}, bodyPart: ${bodyPart}, time: ${time}, comments: ${comments}}';
  }
}

class _EvacEtiologyFullReader extends fb.TableReader<EvacEtiologyFull> {
  const _EvacEtiologyFullReader();

  @override
  EvacEtiologyFull createObject(fb.BufferContext bc, int offset) => 
    EvacEtiologyFull._(bc, offset);
}

class EvacEtiologyFullBuilder {
  EvacEtiologyFullBuilder(this.fbBuilder);
...
class EvacEtiologyFullObjectBuilder extends fb.ObjectBuilder {
  final String? _type;
  final String? _bodyPart;
  final String? _time;
  final String? _comments;

  EvacEtiologyFullObjectBuilder({
    String? type,
    String? bodyPart,
    String? time,
    String? comments,
