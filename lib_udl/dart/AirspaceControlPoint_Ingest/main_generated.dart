...
class AirspaceControlPointIngest {
  AirspaceControlPointIngest._(this._bc, this._bcOffset);
  factory AirspaceControlPointIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirspaceControlPointIngest> reader = _AirspaceControlPointIngestReader();
  ...
  @override
  String toString() {
    return 'AirspaceControlPointIngest{ctrlPtType: ${ctrlPtType}, ctrlPtName: ${ctrlPtName}, ctrlPtLocation: ${ctrlPtLocation}, ctrlPtAltitude: ${ctrlPtAltitude}}';
  }
}

class _AirspaceControlPointIngestReader extends fb.TableReader<AirspaceControlPointIngest> {
  const _AirspaceControlPointIngestReader();

  @override
  AirspaceControlPointIngest createObject(fb.BufferContext bc, int offset) => 
    AirspaceControlPointIngest._(bc, offset);
}

class AirspaceControlPointIngestBuilder {
  AirspaceControlPointIngestBuilder(this.fbBuilder);
...
class AirspaceControlPointIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _ctrlPtType;
  final String? _ctrlPtName;
  final String? _ctrlPtLocation;
  final String? _ctrlPtAltitude;

  AirspaceControlPointIngestObjectBuilder({
    String? ctrlPtType,
    String? ctrlPtName,
