...
class RfgeoLocationFullDataModeEnum {
  final int value;
  const RfgeoLocationFullDataModeEnum._(this.value);

  factory RfgeoLocationFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum RfgeoLocationFullDataModeEnum');
    }
    return result;
  }

  static RfgeoLocationFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : RfgeoLocationFullDataModeEnum.fromValue(value);
  ...
  static const RfgeoLocationFullDataModeEnum REAL = RfgeoLocationFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const RfgeoLocationFullDataModeEnum TEST = RfgeoLocationFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const RfgeoLocationFullDataModeEnum SIMULATED = RfgeoLocationFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const RfgeoLocationFullDataModeEnum EXERCISE = RfgeoLocationFullDataModeEnum._(3);
  static const Map<int, RfgeoLocationFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<RfgeoLocationFullDataModeEnum> reader = _RfgeoLocationFullDataModeEnumReader();

  @override
  String toString() {
    return 'RfgeoLocationFullDataModeEnum{value: $value}';
  }
}

class _RfgeoLocationFullDataModeEnumReader extends fb.Reader<RfgeoLocationFullDataModeEnum> {
  const _RfgeoLocationFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  RfgeoLocationFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      RfgeoLocationFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Model representation of geolocation data for a radio frequency (RF) signal or emitter.
class RfgeoLocationFull {
  RfgeoLocationFull._(this._bc, this._bcOffset);
  factory RfgeoLocationFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<RfgeoLocationFull> reader = _RfgeoLocationFullReader();
  ...
  RfgeoLocationFullDataModeEnum get dataMode => RfgeoLocationFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 86, 0));
...
class RfgeoLocationFullBuilder {
  ...
  int addDataMode(RfgeoLocationFullDataModeEnum? dataMode) {
...
class RfgeoLocationFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final RfgeoLocationFullDataModeEnum? _dataMode;
  final String? _onOrbit;

  RfgeoLocationFullObjectBuilder({
    String? id,
    ...
    String? origNetwork,
    String? sourceDl,
    RfgeoLocationFullDataModeEnum? dataMode,
    String? onOrbit,
  })
      : _id = id,
