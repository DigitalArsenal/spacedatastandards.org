...
class SensorMaintenanceFullDataModeEnum {
  final int value;
  const SensorMaintenanceFullDataModeEnum._(this.value);

  factory SensorMaintenanceFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SensorMaintenanceFullDataModeEnum');
    }
    return result;
  }

  static SensorMaintenanceFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SensorMaintenanceFullDataModeEnum.fromValue(value);
  ...
  static const SensorMaintenanceFullDataModeEnum REAL = SensorMaintenanceFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SensorMaintenanceFullDataModeEnum TEST = SensorMaintenanceFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SensorMaintenanceFullDataModeEnum SIMULATED = SensorMaintenanceFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SensorMaintenanceFullDataModeEnum EXERCISE = SensorMaintenanceFullDataModeEnum._(3);
  static const Map<int, SensorMaintenanceFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SensorMaintenanceFullDataModeEnum> reader = _SensorMaintenanceFullDataModeEnumReader();

  @override
  String toString() {
    return 'SensorMaintenanceFullDataModeEnum{value: $value}';
  }
}

class _SensorMaintenanceFullDataModeEnumReader extends fb.Reader<SensorMaintenanceFullDataModeEnum> {
  const _SensorMaintenanceFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SensorMaintenanceFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      SensorMaintenanceFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Maintenance schedule and operational status of Sensor.
class SensorMaintenanceFull {
  SensorMaintenanceFull._(this._bc, this._bcOffset);
  factory SensorMaintenanceFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SensorMaintenanceFull> reader = _SensorMaintenanceFullReader();
  ...
  SensorMaintenanceFullDataModeEnum get dataMode => SensorMaintenanceFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 62, 0));
  ...
  @override
  String toString() {
    return 'SensorMaintenanceFull{id: ${id}, classificationMarking: ${classificationMarking}, siteCode: ${siteCode}, idSensor: ${idSensor}, startTime: ${startTime}, endTime: ${endTime}, recall: ${recall}, duration: ${duration}, mwOpsCap: ${mwOpsCap}, ssOpsCap: ${ssOpsCap}, mdOpsCap: ${mdOpsCap}, impactedFaces: ${impactedFaces}, equipStatus: ${equipStatus}, activity: ${activity}, remark: ${remark}, requestor: ${requestor}, changer: ${changer}, approver: ${approver}, eowId: ${eowId}, rev: ${rev}, priority: ${priority}, rel: ${rel}, lineNumber: ${lineNumber}, resource: ${resource}, inactiveDate: ${inactiveDate}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, origNetwork: ${origNetwork}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}}';
  }
}

class _SensorMaintenanceFullReader extends fb.TableReader<SensorMaintenanceFull> {
  const _SensorMaintenanceFullReader();

  @override
  SensorMaintenanceFull createObject(fb.BufferContext bc, int offset) => 
    SensorMaintenanceFull._(bc, offset);
}

class SensorMaintenanceFullBuilder {
  SensorMaintenanceFullBuilder(this.fbBuilder);
  ...
  int addDataMode(SensorMaintenanceFullDataModeEnum? dataMode) {
...
class SensorMaintenanceFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SensorMaintenanceFullDataModeEnum? _dataMode;
  final String? _origNetwork;
  final String? _updatedAt;
  final String? _updatedBy;

  SensorMaintenanceFullObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    SensorMaintenanceFullDataModeEnum? dataMode,
    String? origNetwork,
    String? updatedAt,
    String? updatedBy,
  })
