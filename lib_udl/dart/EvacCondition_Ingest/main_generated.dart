...
class EvacConditionIngest {
  EvacConditionIngest._(this._bc, this._bcOffset);
  factory EvacConditionIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EvacConditionIngest> reader = _EvacConditionIngestReader();
  ...
  @override
  String toString() {
    return 'EvacConditionIngest{type: ${type}, bodyPart: ${bodyPart}, time: ${time}, comments: ${comments}}';
  }
}

class _EvacConditionIngestReader extends fb.TableReader<EvacConditionIngest> {
  const _EvacConditionIngestReader();

  @override
  EvacConditionIngest createObject(fb.BufferContext bc, int offset) => 
    EvacConditionIngest._(bc, offset);
}

class EvacConditionIngestBuilder {
  EvacConditionIngestBuilder(this.fbBuilder);
...
class EvacConditionIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _type;
  final String? _bodyPart;
  final String? _time;
  final String? _comments;

  EvacConditionIngestObjectBuilder({
    String? type,
    String? bodyPart,
    String? time,
    String? comments,
