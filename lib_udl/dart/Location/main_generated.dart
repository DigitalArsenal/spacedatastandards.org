...
class LocationDataModeEnum {
  final int value;
  const LocationDataModeEnum._(this.value);

  factory LocationDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum LocationDataModeEnum');
    }
    return result;
  }

  static LocationDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : LocationDataModeEnum.fromValue(value);
  ...
  static const LocationDataModeEnum REAL = LocationDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const LocationDataModeEnum TEST = LocationDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const LocationDataModeEnum SIMULATED = LocationDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const LocationDataModeEnum EXERCISE = LocationDataModeEnum._(3);
  static const Map<int, LocationDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<LocationDataModeEnum> reader = _LocationDataModeEnumReader();

  @override
  String toString() {
    return 'LocationDataModeEnum{value: $value}';
  }
}

class _LocationDataModeEnumReader extends fb.Reader<LocationDataModeEnum> {
  const _LocationDataModeEnumReader();

  @override
  int get size => 1;

  @override
  LocationDataModeEnum read(fb.BufferContext bc, int offset) =>
      LocationDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class Location {
  ...
  LocationDataModeEnum get dataMode => LocationDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 30, 0));
  ...
  @override
  String toString() {
    return 'Location{idLocation: ${idLocation}, classificationMarking: ${classificationMarking}, name: ${name}, countryCode: ${countryCode}, lat: ${lat}, lon: ${lon}, altitude: ${altitude}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, origNetwork: ${origNetwork}}';
  }
}
...
class LocationBuilder {
  ...
  int addDataMode(LocationDataModeEnum? dataMode) {
...
class LocationObjectBuilder extends fb.ObjectBuilder {
  ...
  final LocationDataModeEnum? _dataMode;
