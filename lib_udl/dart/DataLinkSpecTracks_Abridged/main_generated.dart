...
class DataLinkSpecTracksAbridged {
  DataLinkSpecTracksAbridged._(this._bc, this._bcOffset);
  factory DataLinkSpecTracksAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DataLinkSpecTracksAbridged> reader = _DataLinkSpecTracksAbridgedReader();
  ...
  @override
  String toString() {
    return 'DataLinkSpecTracksAbridged{specTrackNum: ${specTrackNum}, specTrackNumDesc: ${specTrackNumDesc}}';
  }
}

class _DataLinkSpecTracksAbridgedReader extends fb.TableReader<DataLinkSpecTracksAbridged> {
  const _DataLinkSpecTracksAbridgedReader();

  @override
  DataLinkSpecTracksAbridged createObject(fb.BufferContext bc, int offset) => 
    DataLinkSpecTracksAbridged._(bc, offset);
}

class DataLinkSpecTracksAbridgedBuilder {
  DataLinkSpecTracksAbridgedBuilder(this.fbBuilder);
...
class DataLinkSpecTracksAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _specTrackNum;
  final String? _specTrackNumDesc;

  DataLinkSpecTracksAbridgedObjectBuilder({
    String? specTrackNum,
