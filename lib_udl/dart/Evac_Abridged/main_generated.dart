...
class EvacAbridgedTypeEnum {
  final int value;
  const EvacAbridgedTypeEnum._(this.value);

  factory EvacAbridgedTypeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EvacAbridgedTypeEnum');
    }
    return result;
  }

  static EvacAbridgedTypeEnum? _createOrNull(int? value) => 
      value == null ? null : EvacAbridgedTypeEnum.fromValue(value);
  ...
  static const EvacAbridgedTypeEnum REQUEST = EvacAbridgedTypeEnum._(0);

  ///  No description available.
  static const EvacAbridgedTypeEnum RESPONSE = EvacAbridgedTypeEnum._(1);
  static const Map<int, EvacAbridgedTypeEnum> values = {
    0: REQUEST,
    1: RESPONSE};

  static const fb.Reader<EvacAbridgedTypeEnum> reader = _EvacAbridgedTypeEnumReader();

  @override
  String toString() {
    return 'EvacAbridgedTypeEnum{value: $value}';
  }
}

class _EvacAbridgedTypeEnumReader extends fb.Reader<EvacAbridgedTypeEnum> {
  const _EvacAbridgedTypeEnumReader();

  @override
  int get size => 1;

  @override
  EvacAbridgedTypeEnum read(fb.BufferContext bc, int offset) =>
      EvacAbridgedTypeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class EvacAbridgedDataModeEnum {
  final int value;
  const EvacAbridgedDataModeEnum._(this.value);

  factory EvacAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EvacAbridgedDataModeEnum');
    }
    return result;
  }

  static EvacAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EvacAbridgedDataModeEnum.fromValue(value);
  ...
  static const EvacAbridgedDataModeEnum REAL = EvacAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EvacAbridgedDataModeEnum TEST = EvacAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EvacAbridgedDataModeEnum SIMULATED = EvacAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EvacAbridgedDataModeEnum EXERCISE = EvacAbridgedDataModeEnum._(3);
  static const Map<int, EvacAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EvacAbridgedDataModeEnum> reader = _EvacAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'EvacAbridgedDataModeEnum{value: $value}';
  }
}

class _EvacAbridgedDataModeEnumReader extends fb.Reader<EvacAbridgedDataModeEnum> {
  const _EvacAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EvacAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      EvacAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Casualty report and evacuation request. Used to report and request support to evacuate friendly and enemy casualties.
class EvacAbridged {
  EvacAbridged._(this._bc, this._bcOffset);
  factory EvacAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EvacAbridged> reader = _EvacAbridgedReader();
  ...
  EvacAbridgedTypeEnum get type => EvacAbridgedTypeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 10, 0));
  ...
  EvacAbridgedDataModeEnum get dataMode => EvacAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 82, 0));

  @override
  String toString() {
    return 'EvacAbridged{id: ${id}, classificationMarking: ${classificationMarking}, medevacId: ${medevacId}, type: ${type}, missionType: ${missionType}, idWeatherReport: ${idWeatherReport}, numKia: ${numKia}, numWia: ${numWia}, numLitter: ${numLitter}, numAmbulatory: ${numAmbulatory}, medicReq: ${medicReq}, reqNum: ${reqNum}, reqTime: ${reqTime}, reqCallSign: ${reqCallSign}, pickupTime: ${pickupTime}, pickupLat: ${pickupLat}, pickupLon: ${pickupLon}, pickupAlt: ${pickupAlt}, ce: ${ce}, le: ${le}, terrain: ${terrain}, obstaclesRemarks: ${obstaclesRemarks}, terrainRemarks: ${terrainRemarks}, zoneName: ${zoneName}, zoneMarking: ${zoneMarking}, zoneSecurity: ${zoneSecurity}, zoneMarkingColor: ${zoneMarkingColor}, zoneHot: ${zoneHot}, cntctFreq: ${cntctFreq}, zoneContrCallSign: ${zoneContrCallSign}, numCasualties: ${numCasualties}, comments: ${comments}, casualtyInfo: ${casualtyInfo}, enemyData: ${enemyData}, origNetwork: ${origNetwork}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}}';
  }
}

class _EvacAbridgedReader extends fb.TableReader<EvacAbridged> {
  const _EvacAbridgedReader();

  @override
  EvacAbridged createObject(fb.BufferContext bc, int offset) => 
    EvacAbridged._(bc, offset);
}

class EvacAbridgedBuilder {
  EvacAbridgedBuilder(this.fbBuilder);
  ...
  int addType(EvacAbridgedTypeEnum? type) {
  ...
  int addDataMode(EvacAbridgedDataModeEnum? dataMode) {
...
class EvacAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _classificationMarking;
  final String? _medevacId;
  final EvacAbridgedTypeEnum? _type;
  ...
  final EvacAbridgedDataModeEnum? _dataMode;

  EvacAbridgedObjectBuilder({
    String? id,
    String? classificationMarking,
    String? medevacId,
    EvacAbridgedTypeEnum? type,
    String? missionType,
    ...
    String? source,
    String? origin,
    EvacAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
