...
class MissileTrackVectorAbridged {
  MissileTrackVectorAbridged._(this._bc, this._bcOffset);
  factory MissileTrackVectorAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MissileTrackVectorAbridged> reader = _MissileTrackVectorAbridgedReader();
  ...
  @override
  String toString() {
    return 'MissileTrackVectorAbridged{type: ${type}, object: ${object}, epoch: ${epoch}, idSensor: ${idSensor}, origSensorId: ${origSensorId}, pos: ${pos}, vel: ${vel}, accel: ${accel}, course: ${course}, spd: ${spd}, referenceFrame: ${referenceFrame}, cov: ${cov}, covReferenceFrame: ${covReferenceFrame}, vectorLat: ${vectorLat}, vectorLon: ${vectorLon}, vectorAlt: ${vectorAlt}, confidence: ${confidence}, status: ${status}, timeSource: ${timeSource}, quat: ${quat}, flightAz: ${flightAz}}';
  }
}

class _MissileTrackVectorAbridgedReader extends fb.TableReader<MissileTrackVectorAbridged> {
  const _MissileTrackVectorAbridgedReader();

  @override
  MissileTrackVectorAbridged createObject(fb.BufferContext bc, int offset) => 
    MissileTrackVectorAbridged._(bc, offset);
}

class MissileTrackVectorAbridgedBuilder {
  MissileTrackVectorAbridgedBuilder(this.fbBuilder);
...
class MissileTrackVectorAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _type;
  ...
  MissileTrackVectorAbridgedObjectBuilder({
    String? type,
    String? object,
    String? epoch,
    String? idSensor,
