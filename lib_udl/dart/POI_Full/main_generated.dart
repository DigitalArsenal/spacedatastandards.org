...
class PoiFullDataModeEnum {
  final int value;
  const PoiFullDataModeEnum._(this.value);

  factory PoiFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum PoiFullDataModeEnum');
    }
    return result;
  }

  static PoiFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : PoiFullDataModeEnum.fromValue(value);
  ...
  static const PoiFullDataModeEnum REAL = PoiFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const PoiFullDataModeEnum TEST = PoiFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const PoiFullDataModeEnum SIMULATED = PoiFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const PoiFullDataModeEnum EXERCISE = PoiFullDataModeEnum._(3);
  static const Map<int, PoiFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<PoiFullDataModeEnum> reader = _PoiFullDataModeEnumReader();

  @override
  String toString() {
    return 'PoiFullDataModeEnum{value: $value}';
  }
}

class _PoiFullDataModeEnumReader extends fb.Reader<PoiFullDataModeEnum> {
  const _PoiFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  PoiFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      PoiFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class PoiFull {
  PoiFull._(this._bc, this._bcOffset);
  factory PoiFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PoiFull> reader = _PoiFullReader();
  ...
  PoiFullDataModeEnum get dataMode => PoiFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 86, 0));
  ...
  @override
  String toString() {
    return 'PoiFull{id: ${id}, classificationMarking: ${classificationMarking}, pps: ${pps}, msnid: ${msnid}, pri: ${pri}, trkid: ${trkid}, idWeatherReport: ${idWeatherReport}, poiid: ${poiid}, name: ${name}, desc: ${desc}, spec: ${spec}, ident: ${ident}, env: ${env}, plat: ${plat}, activity: ${activity}, ts: ${ts}, start: ${start}, stale: ${stale}, how: ${how}, type: ${type}, lat: ${lat}, lon: ${lon}, alt: ${alt}, az: ${az}, el: ${el}, le: ${le}, ce: ${ce}, elle: ${elle}, cntct: ${cntct}, conf: ${conf}, urls: ${urls}, area: ${area}, atext: ${atext}, agjson: ${agjson}, atype: ${atype}, andims: ${andims}, asrid: ${asrid}, createdAt: ${createdAt}, createdBy: ${createdBy}, sourceDl: ${sourceDl}, source: ${source}, dataMode: ${dataMode}, origin: ${origin}, groups: ${groups}, asset: ${asset}, tags: ${tags}, srcTyps: ${srcTyps}, srcIds: ${srcIds}, beNumber: ${beNumber}, orientation: ${orientation}, origNetwork: ${origNetwork}, transactionId: ${transactionId}}';
  }
}

class _PoiFullReader extends fb.TableReader<PoiFull> {
  const _PoiFullReader();

  @override
  PoiFull createObject(fb.BufferContext bc, int offset) => 
    PoiFull._(bc, offset);
}

class PoiFullBuilder {
  PoiFullBuilder(this.fbBuilder);
  ...
  int addDataMode(PoiFullDataModeEnum? dataMode) {
...
class PoiFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final PoiFullDataModeEnum? _dataMode;
