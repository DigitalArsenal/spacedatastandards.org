...
class SarobservationAbridgedDataModeEnum {
  final int value;
  const SarobservationAbridgedDataModeEnum._(this.value);

  factory SarobservationAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SarobservationAbridgedDataModeEnum');
    }
    return result;
  }

  static SarobservationAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SarobservationAbridgedDataModeEnum.fromValue(value);
  ...
  static const SarobservationAbridgedDataModeEnum REAL = SarobservationAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SarobservationAbridgedDataModeEnum TEST = SarobservationAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SarobservationAbridgedDataModeEnum SIMULATED = SarobservationAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SarobservationAbridgedDataModeEnum EXERCISE = SarobservationAbridgedDataModeEnum._(3);
  static const Map<int, SarobservationAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SarobservationAbridgedDataModeEnum> reader = _SarobservationAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'SarobservationAbridgedDataModeEnum{value: $value}';
  }
}

class _SarobservationAbridgedDataModeEnumReader extends fb.Reader<SarobservationAbridgedDataModeEnum> {
  const _SarobservationAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SarobservationAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      SarobservationAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class SarobservationAbridged {
  SarobservationAbridged._(this._bc, this._bcOffset);
  factory SarobservationAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SarobservationAbridged> reader = _SarobservationAbridgedReader();
  ...
  ///  Constraints: No constraints specified.
  String? get agjson => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 72);
  ///  Type of region as projected on the ground (POLYGON, POINT, LINE).
  ///  Example: /// Example: POLYGON
  ///  Constraints: Minimum length = 0, Maximum length = 128
  String? get atype => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 74);
  ///  Number of dimensions of the geometry depicted by region.
  ///  Example: /// Example: 3
  ///  Constraints: No constraints specified.
  int get andims => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 76, 0);
  ///  Geographical spatial_ref_sys for region.
  ///  Example: /// Example: 3
  ///  Constraints: No constraints specified.
  int get asrid => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 78, 0);
  ///  The pixel spacing in the range direction measured in meters.
  ///  Example: /// Example: 0.123
  ///  Constraints: No constraints specified.
  double get spacingRange => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 80, 0.0);
  ///  The pixel spacing in the azimuth direction measured in meters.
  ///  Example: /// Example: 0.123
  ///  Constraints: No constraints specified.
  double get spacingAzimuth => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 82, 0.0);
  ///  The number of looks in the azimuth direction.
  ///  Example: /// Example: 2
  ///  Constraints: No constraints specified.
  int get looksAzimuth => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 84, 0);
  ///  The number of looks in the range direction.
  ///  Example: /// Example: 1
  ///  Constraints: No constraints specified.
  int get looksRange => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 86, 0);
  ///  The resolution in the range direction measured in meters.
  ///  Example: /// Example: 0.123
  ///  Constraints: No constraints specified.
  double get resolutionRange => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 88, 0.0);
  ///  The resolution in the azimuth direction measured in meters.
  ///  Example: /// Example: 0.123
  ///  Constraints: No constraints specified.
  double get resolutionAzimuth => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 90, 0.0);
  ///  The antenna pointing direction (LEFT, RIGHT).
  ///  Example: /// Example: RIGHT
  ///  Constraints: Minimum length = 0, Maximum length = 16
  String? get obDirection => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 92);
  ///  The coordinate system used for the sensor velocity and target position vectors for the collection.
  ///  Example: /// Example: ECEF
  ///  Constraints: Minimum length = 0, Maximum length = 16
  String? get coordSys => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 94);
  ///  The collection target X position in kilometers.
  ///  Example: /// Example: 50.23
  ///  Constraints: No constraints specified.
  double get targetposx => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 96, 0.0);
  ///  The collection target Y position in kilometers.
  ///  Example: /// Example: 50.23
  ///  Constraints: No constraints specified.
  double get targetposy => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 98, 0.0);
  ///  The collection target Z position in kilometers.
  ///  Example: /// Example: 50.23
  ///  Constraints: No constraints specified.
  double get targetposz => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 100, 0.0);
  ///  Sensor altitude during collection in kilometers.
  ///  Example: /// Example: 1.1
  ///  Constraints: No constraints specified.
  double get senalt => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 102, 0.0);
  ...
  ///  Example: /// Example: 45.1
  ///  Constraints: No constraints specified.
  double get senlatStart => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 110, 0.0);
  ...
  ///  Constraints: No constraints specified.
  double get senlonStart => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 112, 0.0);
  ...
  ///  Example: /// Example: 45.1
  ///  Constraints: No constraints specified.
  double get senlatEnd => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 114, 0.0);
  ...
  ///  Example: /// Example: 179.1
  ///  Constraints: No constraints specified.
  double get senlonEnd => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 116, 0.0);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get srcTyps => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 120);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get srcIds => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 122);
  ...
  ///  Example: /// Example: AXE
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get sourceDl => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 134);
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SarobservationAbridgedDataModeEnum get dataMode => SarobservationAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 136, 0));

  @override
  String toString() {
    return 'SarobservationAbridged{id: ${id}, classificationMarking: ${classificationMarking}, idOnOrbit: ${idOnOrbit}, satNo: ${satNo}, origObjectId: ${origObjectId}, idSensor: ${idSensor}, origSensorId: ${origSensorId}, externalId: ${externalId}, collectionId: ${collectionId}, detectionId: ${detectionId}, collectionStart: ${collectionStart}, collectionEnd: ${collectionEnd}, centerTime: ${centerTime}, detectionStart: ${detectionStart}, detectionEnd: ${detectionEnd}, dwellTime: ${dwellTime}, orbitState: ${orbitState}, sarMode: ${sarMode}, operatingBand: ${operatingBand}, operatingFreq: ${operatingFreq}, snr: ${snr}, txPolarization: ${txPolarization}, rxPolarization: ${rxPolarization}, grazeAngle: ${grazeAngle}, incidenceAngle: ${incidenceAngle}, squintAngle: ${squintAngle}, pulseBandwidth: ${pulseBandwidth}, pulseDuration: ${pulseDuration}, continuousSpotAngle: ${continuousSpotAngle}, slantRange: ${slantRange}, nearRange: ${nearRange}, farRange: ${farRange}, swathLength: ${swathLength}, atext: ${atext}, agjson: ${agjson}, atype: ${atype}, andims: ${andims}, asrid: ${asrid}, spacingRange: ${spacingRange}, spacingAzimuth: ${spacingAzimuth}, looksAzimuth: ${looksAzimuth}, looksRange: ${looksRange}, resolutionRange: ${resolutionRange}, resolutionAzimuth: ${resolutionAzimuth}, obDirection: ${obDirection}, coordSys: ${coordSys}, targetposx: ${targetposx}, targetposy: ${targetposy}, targetposz: ${targetposz}, senalt: ${senalt}, senvelx: ${senvelx}, senvely: ${senvely}, senvelz: ${senvelz}, senlatStart: ${senlatStart}, senlonStart: ${senlonStart}, senlatEnd: ${senlatEnd}, senlonEnd: ${senlonEnd}, transactionId: ${transactionId}, srcTyps: ${srcTyps}, srcIds: ${srcIds}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, sourceDl: ${sourceDl}, dataMode: ${dataMode}}';
  }
}

class _SarobservationAbridgedReader extends fb.TableReader<SarobservationAbridged> {
  const _SarobservationAbridgedReader();

  @override
  SarobservationAbridged createObject(fb.BufferContext bc, int offset) => 
    SarobservationAbridged._(bc, offset);
}

class SarobservationAbridgedBuilder {
  SarobservationAbridgedBuilder(this.fbBuilder);
  ...
  int addAndims(int? andims) {
    fbBuilder.addInt32(36, andims);
    return fbBuilder.offset;
  }
  int addAsrid(int? asrid) {
    fbBuilder.addInt32(37, asrid);
    return fbBuilder.offset;
  }
  int addSpacingRange(double? spacingRange) {
    fbBuilder.addFloat64(38, spacingRange);
    return fbBuilder.offset;
  }
  int addSpacingAzimuth(double? spacingAzimuth) {
    fbBuilder.addFloat64(39, spacingAzimuth);
    return fbBuilder.offset;
  }
  int addLooksAzimuth(int? looksAzimuth) {
    fbBuilder.addInt32(40, looksAzimuth);
    return fbBuilder.offset;
  }
  int addLooksRange(int? looksRange) {
    fbBuilder.addInt32(41, looksRange);
    return fbBuilder.offset;
  }
  int addResolutionRange(double? resolutionRange) {
    fbBuilder.addFloat64(42, resolutionRange);
    return fbBuilder.offset;
  }
  int addResolutionAzimuth(double? resolutionAzimuth) {
    fbBuilder.addFloat64(43, resolutionAzimuth);
    return fbBuilder.offset;
  }
  ...
  int addTargetposx(double? targetposx) {
    fbBuilder.addFloat64(46, targetposx);
    return fbBuilder.offset;
  }
  int addTargetposy(double? targetposy) {
    fbBuilder.addFloat64(47, targetposy);
    return fbBuilder.offset;
  }
  int addTargetposz(double? targetposz) {
    fbBuilder.addFloat64(48, targetposz);
    return fbBuilder.offset;
  }
  int addSenalt(double? senalt) {
    fbBuilder.addFloat64(49, senalt);
    return fbBuilder.offset;
  }
  ...
  int addSenlatStart(double? senlatStart) {
    fbBuilder.addFloat64(53, senlatStart);
    return fbBuilder.offset;
  }
  int addSenlonStart(double? senlonStart) {
    fbBuilder.addFloat64(54, senlonStart);
    return fbBuilder.offset;
  }
  int addSenlatEnd(double? senlatEnd) {
    fbBuilder.addFloat64(55, senlatEnd);
    return fbBuilder.offset;
  }
  int addSenlonEnd(double? senlonEnd) {
    fbBuilder.addFloat64(56, senlonEnd);
    return fbBuilder.offset;
  }
  ...
  int addDataMode(SarobservationAbridgedDataModeEnum? dataMode) {
...
class SarobservationAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SarobservationAbridgedDataModeEnum? _dataMode;

  SarobservationAbridgedObjectBuilder({
    String? id,
    ...
    String? origNetwork,
    String? sourceDl,
    SarobservationAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(34, agjsonOffset);
    fbBuilder.addOffset(35, atypeOffset);
    fbBuilder.addInt32(36, _andims);
    fbBuilder.addInt32(37, _asrid);
    fbBuilder.addFloat64(38, _spacingRange);
    fbBuilder.addFloat64(39, _spacingAzimuth);
    fbBuilder.addInt32(40, _looksAzimuth);
    fbBuilder.addInt32(41, _looksRange);
    fbBuilder.addFloat64(42, _resolutionRange);
    fbBuilder.addFloat64(43, _resolutionAzimuth);
    fbBuilder.addOffset(44, obDirectionOffset);
    fbBuilder.addOffset(45, coordSysOffset);
    fbBuilder.addFloat64(46, _targetposx);
    fbBuilder.addFloat64(47, _targetposy);
    fbBuilder.addFloat64(48, _targetposz);
    fbBuilder.addFloat64(49, _senalt);
    fbBuilder.addFloat64(50, _senvelx);
    fbBuilder.addFloat64(51, _senvely);
    fbBuilder.addFloat64(52, _senvelz);
    fbBuilder.addFloat64(53, _senlatStart);
    fbBuilder.addFloat64(54, _senlonStart);
    fbBuilder.addFloat64(55, _senlatEnd);
    fbBuilder.addFloat64(56, _senlonEnd);
    fbBuilder.addOffset(57, transactionIdOffset);
    fbBuilder.addOffset(58, srcTypsOffset);
    fbBuilder.addOffset(59, srcIdsOffset);
    ...
    fbBuilder.addOffset(65, sourceDlOffset);
