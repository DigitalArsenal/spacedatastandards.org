...
class SeradataNavigationAbridgedDataModeEnum {
  final int value;
  const SeradataNavigationAbridgedDataModeEnum._(this.value);

  factory SeradataNavigationAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SeradataNavigationAbridgedDataModeEnum');
    }
    return result;
  }

  static SeradataNavigationAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SeradataNavigationAbridgedDataModeEnum.fromValue(value);
  ...
  static const SeradataNavigationAbridgedDataModeEnum REAL = SeradataNavigationAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SeradataNavigationAbridgedDataModeEnum TEST = SeradataNavigationAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SeradataNavigationAbridgedDataModeEnum SIMULATED = SeradataNavigationAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SeradataNavigationAbridgedDataModeEnum EXERCISE = SeradataNavigationAbridgedDataModeEnum._(3);
  static const Map<int, SeradataNavigationAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SeradataNavigationAbridgedDataModeEnum> reader = _SeradataNavigationAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'SeradataNavigationAbridgedDataModeEnum{value: $value}';
  }
}

class _SeradataNavigationAbridgedDataModeEnumReader extends fb.Reader<SeradataNavigationAbridgedDataModeEnum> {
  const _SeradataNavigationAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SeradataNavigationAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      SeradataNavigationAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Details for a navigation payload from  Seradata.
class SeradataNavigationAbridged {
  SeradataNavigationAbridged._(this._bc, this._bcOffset);
  factory SeradataNavigationAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SeradataNavigationAbridged> reader = _SeradataNavigationAbridgedReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SeradataNavigationAbridgedDataModeEnum get dataMode => SeradataNavigationAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 44, 0));

  @override
  String toString() {
    return 'SeradataNavigationAbridged{id: ${id}, classificationMarking: ${classificationMarking}, idNavigation: ${idNavigation}, spacecraftId: ${spacecraftId}, hostedForCompanyOrgId: ${hostedForCompanyOrgId}, manufacturerOrgId: ${manufacturerOrgId}, payloadType: ${payloadType}, modes: ${modes}, modeFrequency: ${modeFrequency}, locationAccuracy: ${locationAccuracy}, partnerSpacecraftId: ${partnerSpacecraftId}, areaCoverage: ${areaCoverage}, notes: ${notes}, name: ${name}, clockType: ${clockType}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _SeradataNavigationAbridgedReader extends fb.TableReader<SeradataNavigationAbridged> {
  const _SeradataNavigationAbridgedReader();

  @override
  SeradataNavigationAbridged createObject(fb.BufferContext bc, int offset) => 
    SeradataNavigationAbridged._(bc, offset);
}

class SeradataNavigationAbridgedBuilder {
  SeradataNavigationAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(SeradataNavigationAbridgedDataModeEnum? dataMode) {
...
class SeradataNavigationAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SeradataNavigationAbridgedDataModeEnum? _dataMode;

  SeradataNavigationAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    SeradataNavigationAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
