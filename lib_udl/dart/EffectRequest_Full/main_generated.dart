...
class EffectRequestFullDataModeEnum {
  final int value;
  const EffectRequestFullDataModeEnum._(this.value);

  factory EffectRequestFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EffectRequestFullDataModeEnum');
    }
    return result;
  }

  static EffectRequestFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EffectRequestFullDataModeEnum.fromValue(value);
  ...
  static const EffectRequestFullDataModeEnum REAL = EffectRequestFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EffectRequestFullDataModeEnum TEST = EffectRequestFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EffectRequestFullDataModeEnum SIMULATED = EffectRequestFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EffectRequestFullDataModeEnum EXERCISE = EffectRequestFullDataModeEnum._(3);
  static const Map<int, EffectRequestFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EffectRequestFullDataModeEnum> reader = _EffectRequestFullDataModeEnumReader();

  @override
  String toString() {
    return 'EffectRequestFullDataModeEnum{value: $value}';
  }
}

class _EffectRequestFullDataModeEnumReader extends fb.Reader<EffectRequestFullDataModeEnum> {
  const _EffectRequestFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EffectRequestFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      EffectRequestFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// A request for various effects on a target.
class EffectRequestFull {
  EffectRequestFull._(this._bc, this._bcOffset);
  factory EffectRequestFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EffectRequestFull> reader = _EffectRequestFullReader();
  ...
  EffectRequestFullDataModeEnum get dataMode => EffectRequestFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 42, 0));
  ...
  @override
  String toString() {
    return 'EffectRequestFull{id: ${id}, classificationMarking: ${classificationMarking}, externalRequestId: ${externalRequestId}, effectList: ${effectList}, state: ${state}, context: ${context}, startTime: ${startTime}, endTime: ${endTime}, deadlineType: ${deadlineType}, targetSrcType: ${targetSrcType}, targetSrcId: ${targetSrcId}, priority: ${priority}, modelClass: ${modelClass}, metricTypes: ${metricTypes}, metricWeights: ${metricWeights}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, origNetwork: ${origNetwork}}';
  }
}

class _EffectRequestFullReader extends fb.TableReader<EffectRequestFull> {
  const _EffectRequestFullReader();

  @override
  EffectRequestFull createObject(fb.BufferContext bc, int offset) => 
    EffectRequestFull._(bc, offset);
}

class EffectRequestFullBuilder {
  EffectRequestFullBuilder(this.fbBuilder);
  ...
  int addDataMode(EffectRequestFullDataModeEnum? dataMode) {
...
class EffectRequestFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EffectRequestFullDataModeEnum? _dataMode;
  final String? _origNetwork;

  EffectRequestFullObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    EffectRequestFullDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
