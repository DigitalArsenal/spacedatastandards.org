...
class NotificationFullDataModeEnum {
  final int value;
  const NotificationFullDataModeEnum._(this.value);

  factory NotificationFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum NotificationFullDataModeEnum');
    }
    return result;
  }

  static NotificationFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : NotificationFullDataModeEnum.fromValue(value);
  ...
  static const NotificationFullDataModeEnum REAL = NotificationFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const NotificationFullDataModeEnum TEST = NotificationFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const NotificationFullDataModeEnum SIMULATED = NotificationFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const NotificationFullDataModeEnum EXERCISE = NotificationFullDataModeEnum._(3);
  static const Map<int, NotificationFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<NotificationFullDataModeEnum> reader = _NotificationFullDataModeEnumReader();

  @override
  String toString() {
    return 'NotificationFullDataModeEnum{value: $value}';
  }
}

class _NotificationFullDataModeEnumReader extends fb.Reader<NotificationFullDataModeEnum> {
  const _NotificationFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  NotificationFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      NotificationFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class NotificationFull {
  NotificationFull._(this._bc, this._bcOffset);
  factory NotificationFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<NotificationFull> reader = _NotificationFullReader();
  ...
  NotificationFullDataModeEnum get dataMode => NotificationFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 12, 0));
  ...
  @override
  String toString() {
    return 'NotificationFull{id: ${id}, classificationMarking: ${classificationMarking}, msgType: ${msgType}, msgBody: ${msgBody}, dataMode: ${dataMode}, sourceDl: ${sourceDl}, source: ${source}, origin: ${origin}, tags: ${tags}, createdAt: ${createdAt}, createdBy: ${createdBy}, origNetwork: ${origNetwork}}';
  }
}

class _NotificationFullReader extends fb.TableReader<NotificationFull> {
  const _NotificationFullReader();

  @override
  NotificationFull createObject(fb.BufferContext bc, int offset) => 
    NotificationFull._(bc, offset);
}

class NotificationFullBuilder {
  NotificationFullBuilder(this.fbBuilder);
  ...
  int addDataMode(NotificationFullDataModeEnum? dataMode) {
...
class NotificationFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _classificationMarking;
  final String? _msgType;
  final String? _msgBody;
  final NotificationFullDataModeEnum? _dataMode;
  ...
  NotificationFullObjectBuilder({
    String? id,
    String? classificationMarking,
    String? msgType,
    String? msgBody,
    NotificationFullDataModeEnum? dataMode,
    String? sourceDl,
    String? source,
    String? origin,
    List<String>? tags,
