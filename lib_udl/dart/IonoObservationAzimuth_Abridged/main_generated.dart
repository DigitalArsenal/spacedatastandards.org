...
class IonoObservationAzimuthAbridged {
  IonoObservationAzimuthAbridged._(this._bc, this._bcOffset);
  factory IonoObservationAzimuthAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationAzimuthAbridged> reader = _IonoObservationAzimuthAbridgedReader();
  ...
  @override
  String toString() {
    return 'IonoObservationAzimuthAbridged{notes: ${notes}, dimensions: ${dimensions}, dimensionName: ${dimensionName}, data: ${data}}';
  }
}

class _IonoObservationAzimuthAbridgedReader extends fb.TableReader<IonoObservationAzimuthAbridged> {
  const _IonoObservationAzimuthAbridgedReader();

  @override
  IonoObservationAzimuthAbridged createObject(fb.BufferContext bc, int offset) => 
    IonoObservationAzimuthAbridged._(bc, offset);
}

class IonoObservationAzimuthAbridgedBuilder {
  IonoObservationAzimuthAbridgedBuilder(this.fbBuilder);
...
class IonoObservationAzimuthAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _notes;
  final List<String>? _dimensions;
  final List<String>? _dimensionName;
  final List<String>? _data;

  IonoObservationAzimuthAbridgedObjectBuilder({
    String? notes,
