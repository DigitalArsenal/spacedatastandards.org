...
class AntennaDetailsFullModeEnum {
  final int value;
  const AntennaDetailsFullModeEnum._(this.value);

  factory AntennaDetailsFullModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AntennaDetailsFullModeEnum');
    }
    return result;
  }

  static AntennaDetailsFullModeEnum? _createOrNull(int? value) => 
      value == null ? null : AntennaDetailsFullModeEnum.fromValue(value);
  ...
  static const AntennaDetailsFullModeEnum TX = AntennaDetailsFullModeEnum._(0);

  ///  No description available.
  static const AntennaDetailsFullModeEnum RX = AntennaDetailsFullModeEnum._(1);
  static const Map<int, AntennaDetailsFullModeEnum> values = {
    0: TX,
    1: RX};

  static const fb.Reader<AntennaDetailsFullModeEnum> reader = _AntennaDetailsFullModeEnumReader();

  @override
  String toString() {
    return 'AntennaDetailsFullModeEnum{value: $value}';
  }
}

class _AntennaDetailsFullModeEnumReader extends fb.Reader<AntennaDetailsFullModeEnum> {
  const _AntennaDetailsFullModeEnumReader();

  @override
  int get size => 1;

  @override
  AntennaDetailsFullModeEnum read(fb.BufferContext bc, int offset) =>
      AntennaDetailsFullModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class AntennaDetailsFullDataModeEnum {
  final int value;
  const AntennaDetailsFullDataModeEnum._(this.value);

  factory AntennaDetailsFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AntennaDetailsFullDataModeEnum');
    }
    return result;
  }

  static AntennaDetailsFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AntennaDetailsFullDataModeEnum.fromValue(value);
  ...
  static const AntennaDetailsFullDataModeEnum REAL = AntennaDetailsFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AntennaDetailsFullDataModeEnum TEST = AntennaDetailsFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AntennaDetailsFullDataModeEnum SIMULATED = AntennaDetailsFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AntennaDetailsFullDataModeEnum EXERCISE = AntennaDetailsFullDataModeEnum._(3);
  static const Map<int, AntennaDetailsFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AntennaDetailsFullDataModeEnum> reader = _AntennaDetailsFullDataModeEnumReader();

  @override
  String toString() {
    return 'AntennaDetailsFullDataModeEnum{value: $value}';
  }
}

class _AntennaDetailsFullDataModeEnumReader extends fb.Reader<AntennaDetailsFullDataModeEnum> {
  const _AntennaDetailsFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AntennaDetailsFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      AntennaDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AntennaDetailsFull {
  AntennaDetailsFull._(this._bc, this._bcOffset);
  factory AntennaDetailsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AntennaDetailsFull> reader = _AntennaDetailsFullReader();
  ...
  AntennaDetailsFullModeEnum get mode => AntennaDetailsFullModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 14, 0));
  ...
  ///  Example: /// Example: 2018-01-01T16:00:00.123Z
  ///  Constraints: No constraints specified.
  String? get updatedAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 44);
  ///  Application user who updated the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get updatedBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 46);
  ///  Source of the data.
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  AntennaDetailsFullDataModeEnum get dataMode => AntennaDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 54, 0));
  ///  Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
  ///  Example: /// Example: ['PROVIDER_TAG1', 'PROVIDER_TAG2']
  ///  Constraints: No constraints specified.
  List<String>? get tags => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 56);
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  String? get manufacturerOrg => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 58);

  @override
  String toString() {
    return 'AntennaDetailsFull{id: ${id}, idAntenna: ${idAntenna}, classificationMarking: ${classificationMarking}, type: ${type}, position: ${position}, mode: ${mode}, steerable: ${steerable}, beamForming: ${beamForming}, manufacturerOrgId: ${manufacturerOrgId}, diameter: ${diameter}, size: ${size}, startFrequency: ${startFrequency}, endFrequency: ${endFrequency}, beamwidth: ${beamwidth}, gain: ${gain}, gainTolerance: ${gainTolerance}, polarization: ${polarization}, description: ${description}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, tags: ${tags}, manufacturerOrg: ${manufacturerOrg}}';
  }
}

class _AntennaDetailsFullReader extends fb.TableReader<AntennaDetailsFull> {
  const _AntennaDetailsFullReader();

  @override
  AntennaDetailsFull createObject(fb.BufferContext bc, int offset) => 
    AntennaDetailsFull._(bc, offset);
}

class AntennaDetailsFullBuilder {
  AntennaDetailsFullBuilder(this.fbBuilder);
  ...
  int addMode(AntennaDetailsFullModeEnum? mode) {
  ...
  int addDataMode(AntennaDetailsFullDataModeEnum? dataMode) {
...
class AntennaDetailsFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _idAntenna;
  final String? _classificationMarking;
  final String? _type;
  final String? _position;
  final AntennaDetailsFullModeEnum? _mode;
  ...
  final AntennaDetailsFullDataModeEnum? _dataMode;
  final List<String>? _tags;
  final String? _manufacturerOrg;

  AntennaDetailsFullObjectBuilder({
    String? id,
    String? idAntenna,
    String? classificationMarking,
    String? type,
    String? position,
    AntennaDetailsFullModeEnum? mode,
    bool? steerable,
    bool? beamForming,
    ...
    String? origin,
    String? origNetwork,
    AntennaDetailsFullDataModeEnum? dataMode,
    List<String>? tags,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(20, updatedAtOffset);
    fbBuilder.addOffset(21, updatedByOffset);
    ...
    fbBuilder.addOffset(26, tagsOffset);
    fbBuilder.addOffset(27, manufacturerOrgOffset);
    return fbBuilder.endTable();
  }
