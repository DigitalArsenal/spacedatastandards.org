...
class AirTransportMissionAbridgedDataModeEnum {
  final int value;
  const AirTransportMissionAbridgedDataModeEnum._(this.value);

  factory AirTransportMissionAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirTransportMissionAbridgedDataModeEnum');
    }
    return result;
  }

  static AirTransportMissionAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AirTransportMissionAbridgedDataModeEnum.fromValue(value);
  ...
  static const AirTransportMissionAbridgedDataModeEnum REAL = AirTransportMissionAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AirTransportMissionAbridgedDataModeEnum TEST = AirTransportMissionAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AirTransportMissionAbridgedDataModeEnum SIMULATED = AirTransportMissionAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AirTransportMissionAbridgedDataModeEnum EXERCISE = AirTransportMissionAbridgedDataModeEnum._(3);
  static const Map<int, AirTransportMissionAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AirTransportMissionAbridgedDataModeEnum> reader = _AirTransportMissionAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'AirTransportMissionAbridgedDataModeEnum{value: $value}';
  }
}

class _AirTransportMissionAbridgedDataModeEnumReader extends fb.Reader<AirTransportMissionAbridgedDataModeEnum> {
  const _AirTransportMissionAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AirTransportMissionAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      AirTransportMissionAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AirTransportMissionAbridged {
  AirTransportMissionAbridged._(this._bc, this._bcOffset);
  factory AirTransportMissionAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirTransportMissionAbridged> reader = _AirTransportMissionAbridgedReader();
  ...
  AirTransportMissionAbridgedDataModeEnum get dataMode => AirTransportMissionAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 70, 0));
...
class AirTransportMissionAbridgedBuilder {
  ...
  int addDataMode(AirTransportMissionAbridgedDataModeEnum? dataMode) {
...
class AirTransportMissionAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AirTransportMissionAbridgedDataModeEnum? _dataMode;
  final String? _origNetwork;
  final List<String>? _requirements;
  final List<String>? _remarks;
  final List<String>? _hazMat;

  AirTransportMissionAbridgedObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    AirTransportMissionAbridgedDataModeEnum? dataMode,
    String? origNetwork,
