...
class PersonnelRecoveryExecutionInfoAbridged {
  PersonnelRecoveryExecutionInfoAbridged._(this._bc, this._bcOffset);
  factory PersonnelRecoveryExecutionInfoAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PersonnelRecoveryExecutionInfoAbridged> reader = _PersonnelRecoveryExecutionInfoAbridgedReader();
  ...
  @override
  String toString() {
    return 'PersonnelRecoveryExecutionInfoAbridged{initialPoint: ${initialPoint}, ingress: ${ingress}, objStrategy: ${objStrategy}, egressPoint: ${egressPoint}, egress: ${egress}, recoveryVehicle: ${recoveryVehicle}, escortVehicle: ${escortVehicle}}';
  }
}

class _PersonnelRecoveryExecutionInfoAbridgedReader extends fb.TableReader<PersonnelRecoveryExecutionInfoAbridged> {
  const _PersonnelRecoveryExecutionInfoAbridgedReader();

  @override
  PersonnelRecoveryExecutionInfoAbridged createObject(fb.BufferContext bc, int offset) => 
    PersonnelRecoveryExecutionInfoAbridged._(bc, offset);
}

class PersonnelRecoveryExecutionInfoAbridgedBuilder {
  PersonnelRecoveryExecutionInfoAbridgedBuilder(this.fbBuilder);
...
class PersonnelRecoveryExecutionInfoAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  PersonnelRecoveryExecutionInfoAbridgedObjectBuilder({
