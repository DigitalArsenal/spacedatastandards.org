...
class MtiFreeTextFull {
  MtiFreeTextFull._(this._bc, this._bcOffset);
  factory MtiFreeTextFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MtiFreeTextFull> reader = _MtiFreeTextFullReader();
  ...
  @override
  String toString() {
    return 'MtiFreeTextFull{f1: ${f1}, f2: ${f2}, f3: ${f3}}';
  }
}

class _MtiFreeTextFullReader extends fb.TableReader<MtiFreeTextFull> {
  const _MtiFreeTextFullReader();

  @override
  MtiFreeTextFull createObject(fb.BufferContext bc, int offset) => 
    MtiFreeTextFull._(bc, offset);
}

class MtiFreeTextFullBuilder {
  MtiFreeTextFullBuilder(this.fbBuilder);
...
class MtiFreeTextFullObjectBuilder extends fb.ObjectBuilder {
  final String? _f1;
  final String? _f2;
  final String? _f3;

  MtiFreeTextFullObjectBuilder({
    String? f1,
    String? f2,
    String? f3,
  })
