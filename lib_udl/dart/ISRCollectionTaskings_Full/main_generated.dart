...
class IsrcollectionTaskingsFullTypeEnum {
  final int value;
  const IsrcollectionTaskingsFullTypeEnum._(this.value);

  factory IsrcollectionTaskingsFullTypeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum IsrcollectionTaskingsFullTypeEnum');
    }
    return result;
  }

  static IsrcollectionTaskingsFullTypeEnum? _createOrNull(int? value) => 
      value == null ? null : IsrcollectionTaskingsFullTypeEnum.fromValue(value);
  ...
  static const IsrcollectionTaskingsFullTypeEnum DELIBERATE = IsrcollectionTaskingsFullTypeEnum._(0);

  ///  No description available.
  static const IsrcollectionTaskingsFullTypeEnum DYNAMIC = IsrcollectionTaskingsFullTypeEnum._(1);

  ///  No description available.
  static const IsrcollectionTaskingsFullTypeEnum TRAINING = IsrcollectionTaskingsFullTypeEnum._(2);

  ///  No description available.
  static const IsrcollectionTaskingsFullTypeEnum TRANSIT = IsrcollectionTaskingsFullTypeEnum._(3);
  static const Map<int, IsrcollectionTaskingsFullTypeEnum> values = {
    0: DELIBERATE,
    1: DYNAMIC,
    2: TRAINING,
    3: TRANSIT};

  static const fb.Reader<IsrcollectionTaskingsFullTypeEnum> reader = _IsrcollectionTaskingsFullTypeEnumReader();

  @override
  String toString() {
    return 'IsrcollectionTaskingsFullTypeEnum{value: $value}';
  }
}

class _IsrcollectionTaskingsFullTypeEnumReader extends fb.Reader<IsrcollectionTaskingsFullTypeEnum> {
  const _IsrcollectionTaskingsFullTypeEnumReader();

  @override
  int get size => 1;

  @override
  IsrcollectionTaskingsFullTypeEnum read(fb.BufferContext bc, int offset) =>
      IsrcollectionTaskingsFullTypeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class IsrcollectionTaskingsFullCollectionTypeEnum {
  final int value;
  const IsrcollectionTaskingsFullCollectionTypeEnum._(this.value);

  factory IsrcollectionTaskingsFullCollectionTypeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum IsrcollectionTaskingsFullCollectionTypeEnum');
    }
    return result;
  }

  static IsrcollectionTaskingsFullCollectionTypeEnum? _createOrNull(int? value) => 
      value == null ? null : IsrcollectionTaskingsFullCollectionTypeEnum.fromValue(value);
  ...
  ///  No description available.
  static const IsrcollectionTaskingsFullCollectionTypeEnum SIMULTANEOUS = IsrcollectionTaskingsFullCollectionTypeEnum._(0);

  ///  No description available.
  static const IsrcollectionTaskingsFullCollectionTypeEnum SEQUENTIAL = IsrcollectionTaskingsFullCollectionTypeEnum._(1);

  ///  No description available.
  static const IsrcollectionTaskingsFullCollectionTypeEnum OPERATIONALLY = IsrcollectionTaskingsFullCollectionTypeEnum._(2);

  ///  No description available.
  static const IsrcollectionTaskingsFullCollectionTypeEnum DRIVEN = IsrcollectionTaskingsFullCollectionTypeEnum._(3);

  ///  No description available.
  static const IsrcollectionTaskingsFullCollectionTypeEnum PRIORITY = IsrcollectionTaskingsFullCollectionTypeEnum._(4);

  ///  No description available.
  static const IsrcollectionTaskingsFullCollectionTypeEnum ORDER = IsrcollectionTaskingsFullCollectionTypeEnum._(5);
  static const Map<int, IsrcollectionTaskingsFullCollectionTypeEnum> values = {
    0: SIMULTANEOUS,
    1: SEQUENTIAL,
    2: OPERATIONALLY,
    3: DRIVEN,
  ...
  static const fb.Reader<IsrcollectionTaskingsFullCollectionTypeEnum> reader = _IsrcollectionTaskingsFullCollectionTypeEnumReader();

  @override
  String toString() {
    return 'IsrcollectionTaskingsFullCollectionTypeEnum{value: $value}';
  }
}

class _IsrcollectionTaskingsFullCollectionTypeEnumReader extends fb.Reader<IsrcollectionTaskingsFullCollectionTypeEnum> {
  const _IsrcollectionTaskingsFullCollectionTypeEnumReader();

  @override
  int get size => 1;

  @override
  IsrcollectionTaskingsFullCollectionTypeEnum read(fb.BufferContext bc, int offset) =>
      IsrcollectionTaskingsFullCollectionTypeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Individual taskings to complete the mission.
class IsrcollectionTaskingsFull {
  IsrcollectionTaskingsFull._(this._bc, this._bcOffset);
  factory IsrcollectionTaskingsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IsrcollectionTaskingsFull> reader = _IsrcollectionTaskingsFullReader();
  ...
  IsrcollectionTaskingsFullTypeEnum get type => IsrcollectionTaskingsFullTypeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 6, 0));
  ///  Type of collection tasked.
  ///  Example: /// Example: Simultaneous
  ///  Constraints: Minimum length = 1, Maximum length = 16
  IsrcollectionTaskingsFullCollectionTypeEnum get collectionType => IsrcollectionTaskingsFullCollectionTypeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 8, 0));
...
class IsrcollectionTaskingsFullBuilder {
  ...
  int addType(IsrcollectionTaskingsFullTypeEnum? type) {
    fbBuilder.addInt8(1, type?.value);
    return fbBuilder.offset;
  }
  int addCollectionType(IsrcollectionTaskingsFullCollectionTypeEnum? collectionType) {
...
class IsrcollectionTaskingsFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final IsrcollectionTaskingsFullTypeEnum? _type;
  final IsrcollectionTaskingsFullCollectionTypeEnum? _collectionType;
  ...
  IsrcollectionTaskingsFullObjectBuilder({
    String? id,
    IsrcollectionTaskingsFullTypeEnum? type,
    IsrcollectionTaskingsFullCollectionTypeEnum? collectionType,
    String? taskingAor,
    String? eightLine,
