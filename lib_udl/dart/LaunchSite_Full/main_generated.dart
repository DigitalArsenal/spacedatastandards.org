...
class LaunchSiteFullDataModeEnum {
  final int value;
  const LaunchSiteFullDataModeEnum._(this.value);

  factory LaunchSiteFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum LaunchSiteFullDataModeEnum');
    }
    return result;
  }

  static LaunchSiteFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : LaunchSiteFullDataModeEnum.fromValue(value);
  ...
  static const LaunchSiteFullDataModeEnum REAL = LaunchSiteFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const LaunchSiteFullDataModeEnum TEST = LaunchSiteFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const LaunchSiteFullDataModeEnum SIMULATED = LaunchSiteFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const LaunchSiteFullDataModeEnum EXERCISE = LaunchSiteFullDataModeEnum._(3);
  static const Map<int, LaunchSiteFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<LaunchSiteFullDataModeEnum> reader = _LaunchSiteFullDataModeEnumReader();

  @override
  String toString() {
    return 'LaunchSiteFullDataModeEnum{value: $value}';
  }
}

class _LaunchSiteFullDataModeEnumReader extends fb.Reader<LaunchSiteFullDataModeEnum> {
  const _LaunchSiteFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  LaunchSiteFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      LaunchSiteFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
