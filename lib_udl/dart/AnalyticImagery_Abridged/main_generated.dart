...
class AnalyticImageryAbridgedDataModeEnum {
  final int value;
  const AnalyticImageryAbridgedDataModeEnum._(this.value);

  factory AnalyticImageryAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AnalyticImageryAbridgedDataModeEnum');
    }
    return result;
  }

  static AnalyticImageryAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AnalyticImageryAbridgedDataModeEnum.fromValue(value);
  ...
  static const AnalyticImageryAbridgedDataModeEnum REAL = AnalyticImageryAbridgedDataModeEnum._(0);

  ///  No description available.
  static const AnalyticImageryAbridgedDataModeEnum TEST = AnalyticImageryAbridgedDataModeEnum._(1);

  ///  No description available.
  static const AnalyticImageryAbridgedDataModeEnum SIMULATED = AnalyticImageryAbridgedDataModeEnum._(2);

  ///  No description available.
  static const AnalyticImageryAbridgedDataModeEnum EXERCISE = AnalyticImageryAbridgedDataModeEnum._(3);
  static const Map<int, AnalyticImageryAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AnalyticImageryAbridgedDataModeEnum> reader = _AnalyticImageryAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'AnalyticImageryAbridgedDataModeEnum{value: $value}';
  }
}

class _AnalyticImageryAbridgedDataModeEnumReader extends fb.Reader<AnalyticImageryAbridgedDataModeEnum> {
  const _AnalyticImageryAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AnalyticImageryAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      AnalyticImageryAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AnalyticImageryAbridged {
  AnalyticImageryAbridged._(this._bc, this._bcOffset);
  factory AnalyticImageryAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AnalyticImageryAbridged> reader = _AnalyticImageryAbridgedReader();
  ...
  ///  Constraints: No constraints specified.
  List<String>? get satId => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 56);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get satIdConf => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 58);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get srcTyps => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 60);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get srcIds => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 62);
  ///  Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
  ///  Example: /// Example: ['TAG1', 'TAG2']
  ///  Constraints: No constraints specified.
  List<String>? get tags => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 64);
  ///  MD5 checksum value of the file. The ingest/create operation will automatically generate the value.
  ///  Example: /// Example: 123
  ///  Constraints: Minimum length = 0, Maximum length = 256
  String? get checksumValue => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 66);
  ///  Optional identifier to track a commercial or marketplace transaction executed to produce this data.
  ///  Example: /// Example: a7bdef1f-5a4f-4716-bee4-7a1e0ec7d35a
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get transactionId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 68);
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  AnalyticImageryAbridgedDataModeEnum get dataMode => AnalyticImageryAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 82, 0));

  @override
  String toString() {
    return 'AnalyticImageryAbridged{id: ${id}, classificationMarking: ${classificationMarking}, content: ${content}, msgTime: ${msgTime}, imageType: ${imageType}, filename: ${filename}, filesize: ${filesize}, imgWidth: ${imgWidth}, imgHeight: ${imgHeight}, xUnits: ${xUnits}, yUnits: ${yUnits}, zUnits: ${zUnits}, imageSetId: ${imageSetId}, imageSetLength: ${imageSetLength}, sequenceId: ${sequenceId}, description: ${description}, dataStart: ${dataStart}, dataStop: ${dataStop}, annLims: ${annLims}, annText: ${annText}, keywords: ${keywords}, atext: ${atext}, agjson: ${agjson}, atype: ${atype}, andims: ${andims}, asrid: ${asrid}, satId: ${satId}, satIdConf: ${satIdConf}, srcTyps: ${srcTyps}, srcIds: ${srcIds}, tags: ${tags}, checksumValue: ${checksumValue}, transactionId: ${transactionId}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, sourceDl: ${sourceDl}, dataMode: ${dataMode}}';
  }
}

class _AnalyticImageryAbridgedReader extends fb.TableReader<AnalyticImageryAbridged> {
  const _AnalyticImageryAbridgedReader();

  @override
  AnalyticImageryAbridged createObject(fb.BufferContext bc, int offset) => 
    AnalyticImageryAbridged._(bc, offset);
}

class AnalyticImageryAbridgedBuilder {
  AnalyticImageryAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(AnalyticImageryAbridgedDataModeEnum? dataMode) {
...
class AnalyticImageryAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AnalyticImageryAbridgedDataModeEnum? _dataMode;

  AnalyticImageryAbridgedObjectBuilder({
    String? id,
    ...
    String? origNetwork,
    String? sourceDl,
    AnalyticImageryAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(26, satIdOffset);
    fbBuilder.addOffset(27, satIdConfOffset);
    fbBuilder.addOffset(28, srcTypsOffset);
    fbBuilder.addOffset(29, srcIdsOffset);
    fbBuilder.addOffset(30, tagsOffset);
    fbBuilder.addOffset(31, checksumValueOffset);
    fbBuilder.addOffset(32, transactionIdOffset);
