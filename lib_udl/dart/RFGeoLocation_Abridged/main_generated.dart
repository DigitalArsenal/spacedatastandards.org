...
class RfgeoLocationAbridgedDataModeEnum {
  final int value;
  const RfgeoLocationAbridgedDataModeEnum._(this.value);

  factory RfgeoLocationAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum RfgeoLocationAbridgedDataModeEnum');
    }
    return result;
  }

  static RfgeoLocationAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : RfgeoLocationAbridgedDataModeEnum.fromValue(value);
  ...
  static const RfgeoLocationAbridgedDataModeEnum REAL = RfgeoLocationAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const RfgeoLocationAbridgedDataModeEnum TEST = RfgeoLocationAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const RfgeoLocationAbridgedDataModeEnum SIMULATED = RfgeoLocationAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const RfgeoLocationAbridgedDataModeEnum EXERCISE = RfgeoLocationAbridgedDataModeEnum._(3);
  static const Map<int, RfgeoLocationAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<RfgeoLocationAbridgedDataModeEnum> reader = _RfgeoLocationAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'RfgeoLocationAbridgedDataModeEnum{value: $value}';
  }
}

class _RfgeoLocationAbridgedDataModeEnumReader extends fb.Reader<RfgeoLocationAbridgedDataModeEnum> {
  const _RfgeoLocationAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  RfgeoLocationAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      RfgeoLocationAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Model representation of geolocation data for a radio frequency (RF) signal or emitter.
class RfgeoLocationAbridged {
  RfgeoLocationAbridged._(this._bc, this._bcOffset);
  factory RfgeoLocationAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<RfgeoLocationAbridged> reader = _RfgeoLocationAbridgedReader();
  ...
  ///  Example: /// Example: 3
  ///  Constraints: No constraints specified.
  int get andims => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 60, 0);
  ///  Geographical spatial_ref_sys for region.
  ///  Example: /// Example: 3
  ///  Constraints: No constraints specified.
  int get asrid => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 62, 0);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get passGroupId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 64);
  ///  The RFGeo algorithm type and version used in geolocation calculations.
  ///  Example: /// Example: v1.0-3-gps_nb_3ball
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get algVersion => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 66);
  ///  Optional ID from external systems. This field has no meaning within UDL and is provided as a convenience for systems that require tracking of an internal system generated ID.
  ///  Example: /// Example: 780180925
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get externalId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 68);
...
class RfgeoLocationAbridgedBuilder {
  ...
  int addAndims(int? andims) {
    fbBuilder.addInt32(28, andims);
    return fbBuilder.offset;
  }
  int addAsrid(int? asrid) {
    fbBuilder.addInt32(29, asrid);
    return fbBuilder.offset;
  }
  ...
  int addDataMode(RfgeoLocationAbridgedDataModeEnum? dataMode) {
...
class RfgeoLocationAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final RfgeoLocationAbridgedDataModeEnum? _dataMode;

  RfgeoLocationAbridgedObjectBuilder({
    String? id,
    ...
    String? origNetwork,
    String? sourceDl,
    RfgeoLocationAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addInt32(28, _andims);
    fbBuilder.addInt32(29, _asrid);
    fbBuilder.addOffset(30, passGroupIdOffset);
    fbBuilder.addOffset(31, algVersionOffset);
    fbBuilder.addOffset(32, externalIdOffset);
