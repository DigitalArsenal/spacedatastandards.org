...
class AircraftMissionRemarksFull {
  AircraftMissionRemarksFull._(this._bc, this._bcOffset);
  factory AircraftMissionRemarksFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AircraftMissionRemarksFull> reader = _AircraftMissionRemarksFullReader();
  ...
  @override
  String toString() {
    return 'AircraftMissionRemarksFull{gdssRemarkId: ${gdssRemarkId}, type: ${type}, text: ${text}, date: ${date}, user: ${user}, itineraryNum: ${itineraryNum}}';
  }
}

class _AircraftMissionRemarksFullReader extends fb.TableReader<AircraftMissionRemarksFull> {
  const _AircraftMissionRemarksFullReader();

  @override
  AircraftMissionRemarksFull createObject(fb.BufferContext bc, int offset) => 
    AircraftMissionRemarksFull._(bc, offset);
}

class AircraftMissionRemarksFullBuilder {
  AircraftMissionRemarksFullBuilder(this.fbBuilder);
...
class AircraftMissionRemarksFullObjectBuilder extends fb.ObjectBuilder {
  ...
  AircraftMissionRemarksFullObjectBuilder({
    String? gdssRemarkId,
    String? type,
    String? text,
    String? date,
