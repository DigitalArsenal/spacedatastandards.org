...
class ManeuverIngestDataModeEnum {
  final int value;
  const ManeuverIngestDataModeEnum._(this.value);

  factory ManeuverIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ManeuverIngestDataModeEnum');
    }
    return result;
  }

  static ManeuverIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : ManeuverIngestDataModeEnum.fromValue(value);
  ...
  static const ManeuverIngestDataModeEnum REAL = ManeuverIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const ManeuverIngestDataModeEnum TEST = ManeuverIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const ManeuverIngestDataModeEnum SIMULATED = ManeuverIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const ManeuverIngestDataModeEnum EXERCISE = ManeuverIngestDataModeEnum._(3);
  static const Map<int, ManeuverIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<ManeuverIngestDataModeEnum> reader = _ManeuverIngestDataModeEnumReader();

  @override
  String toString() {
    return 'ManeuverIngestDataModeEnum{value: $value}';
  }
}

class _ManeuverIngestDataModeEnumReader extends fb.Reader<ManeuverIngestDataModeEnum> {
  const _ManeuverIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  ManeuverIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      ManeuverIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class ManeuverIngestSourcedDataTypesEnum {
  final int value;
  const ManeuverIngestSourcedDataTypesEnum._(this.value);

  factory ManeuverIngestSourcedDataTypesEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ManeuverIngestSourcedDataTypesEnum');
    }
    return result;
  }

  static ManeuverIngestSourcedDataTypesEnum? _createOrNull(int? value) => 
      value == null ? null : ManeuverIngestSourcedDataTypesEnum.fromValue(value);
  ...
  static const ManeuverIngestSourcedDataTypesEnum EO = ManeuverIngestSourcedDataTypesEnum._(0);

  ///  No description available.
  static const ManeuverIngestSourcedDataTypesEnum RADAR = ManeuverIngestSourcedDataTypesEnum._(1);

  ///  No description available.
  static const ManeuverIngestSourcedDataTypesEnum RF = ManeuverIngestSourcedDataTypesEnum._(2);

  ///  No description available.
  static const ManeuverIngestSourcedDataTypesEnum DOA = ManeuverIngestSourcedDataTypesEnum._(3);

  ///  No description available.
  static const ManeuverIngestSourcedDataTypesEnum ELSET = ManeuverIngestSourcedDataTypesEnum._(4);

  ///  No description available.
  static const ManeuverIngestSourcedDataTypesEnum SV = ManeuverIngestSourcedDataTypesEnum._(5);
  static const Map<int, ManeuverIngestSourcedDataTypesEnum> values = {
    0: EO,
    1: RADAR,
    2: RF,
    3: DOA,
  ...
  static const fb.Reader<ManeuverIngestSourcedDataTypesEnum> reader = _ManeuverIngestSourcedDataTypesEnumReader();

  @override
  String toString() {
    return 'ManeuverIngestSourcedDataTypesEnum{value: $value}';
  }
}

class _ManeuverIngestSourcedDataTypesEnumReader extends fb.Reader<ManeuverIngestSourcedDataTypesEnum> {
  const _ManeuverIngestSourcedDataTypesEnumReader();

  @override
  int get size => 1;

  @override
  ManeuverIngestSourcedDataTypesEnum read(fb.BufferContext bc, int offset) =>
      ManeuverIngestSourcedDataTypesEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Model representation of on-orbit object maneuver information for detected, possible, and confirmed maneuvers.
class ManeuverIngest {
  ManeuverIngest._(this._bc, this._bcOffset);
  factory ManeuverIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<ManeuverIngest> reader = _ManeuverIngestReader();
  ...
  ManeuverIngestDataModeEnum get dataMode => ManeuverIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 182, 0));
  ...
  ///  Constraints: No constraints specified.
  List<String>? get tags => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 188);
  ///  Optional algorithm used to produce this record.
  ///  Example: /// Example: Example algorithm
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get algorithm => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 190);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get sourcedData => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 192);
  ...
  ///  Constraints: No constraints specified.
  ManeuverIngestSourcedDataTypesEnum get sourcedDataTypes => ManeuverIngestSourcedDataTypesEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 194, 0));
...
class ManeuverIngestBuilder {
  ...
  int addDataMode(ManeuverIngestDataModeEnum? dataMode) {
  ...
  int addSourcedDataTypes(ManeuverIngestSourcedDataTypesEnum? sourcedDataTypes) {
    fbBuilder.addInt8(95, sourcedDataTypes?.value);
    return fbBuilder.offset;
  }
...
class ManeuverIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final ManeuverIngestDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final List<String>? _tags;
  final String? _algorithm;
  final List<String>? _sourcedData;
  final ManeuverIngestSourcedDataTypesEnum? _sourcedDataTypes;
  final String? _transactionId;
  final String? _origNetwork;

  ManeuverIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    ManeuverIngestDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    List<String>? tags,
    String? algorithm,
    List<String>? sourcedData,
    ManeuverIngestSourcedDataTypesEnum? sourcedDataTypes,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(92, tagsOffset);
    fbBuilder.addOffset(93, algorithmOffset);
    fbBuilder.addOffset(94, sourcedDataOffset);
    fbBuilder.addInt8(95, _sourcedDataTypes?.value);
