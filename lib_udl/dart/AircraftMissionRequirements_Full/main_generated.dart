...
class AircraftMissionRequirementsFull {
  AircraftMissionRequirementsFull._(this._bc, this._bcOffset);
  factory AircraftMissionRequirementsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AircraftMissionRequirementsFull> reader = _AircraftMissionRequirementsFullReader();
  ...
  @override
  String toString() {
    return 'AircraftMissionRequirementsFull{gdssReqId: ${gdssReqId}, onloadId: ${onloadId}, onloadLocode: ${onloadLocode}, offloadId: ${offloadId}, offloadLocode: ${offloadLocode}, uln: ${uln}, transReqNum: ${transReqNum}, projName: ${projName}, oplan: ${oplan}, numPax: ${numPax}, numLitter: ${numLitter}, numAmbulatory: ${numAmbulatory}, numAttendant: ${numAttendant}, bulkWeight: ${bulkWeight}, oversizeWeight: ${oversizeWeight}, outsizeWeight: ${outsizeWeight}, ead: ${ead}, lad: ${lad}}';
  }
}

class _AircraftMissionRequirementsFullReader extends fb.TableReader<AircraftMissionRequirementsFull> {
  const _AircraftMissionRequirementsFullReader();

  @override
  AircraftMissionRequirementsFull createObject(fb.BufferContext bc, int offset) => 
    AircraftMissionRequirementsFull._(bc, offset);
}

class AircraftMissionRequirementsFullBuilder {
  AircraftMissionRequirementsFullBuilder(this.fbBuilder);
...
class AircraftMissionRequirementsFullObjectBuilder extends fb.ObjectBuilder {
  ...
  AircraftMissionRequirementsFullObjectBuilder({
    String? gdssReqId,
    int? onloadId,
    String? onloadLocode,
    int? offloadId,
