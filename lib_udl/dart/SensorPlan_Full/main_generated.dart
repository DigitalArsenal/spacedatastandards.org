...
class SensorPlanFullDataModeEnum {
  final int value;
  const SensorPlanFullDataModeEnum._(this.value);

  factory SensorPlanFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SensorPlanFullDataModeEnum');
    }
    return result;
  }

  static SensorPlanFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SensorPlanFullDataModeEnum.fromValue(value);
  ...
  static const SensorPlanFullDataModeEnum REAL = SensorPlanFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SensorPlanFullDataModeEnum TEST = SensorPlanFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SensorPlanFullDataModeEnum SIMULATED = SensorPlanFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SensorPlanFullDataModeEnum EXERCISE = SensorPlanFullDataModeEnum._(3);
  static const Map<int, SensorPlanFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SensorPlanFullDataModeEnum> reader = _SensorPlanFullDataModeEnumReader();

  @override
  String toString() {
    return 'SensorPlanFullDataModeEnum{value: $value}';
  }
}

class _SensorPlanFullDataModeEnumReader extends fb.Reader<SensorPlanFullDataModeEnum> {
  const _SensorPlanFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SensorPlanFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      SensorPlanFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class SensorPlanFull {
  SensorPlanFull._(this._bc, this._bcOffset);
  factory SensorPlanFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SensorPlanFull> reader = _SensorPlanFullReader();
  ...
  SensorPlanFullDataModeEnum get dataMode => SensorPlanFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 44, 0));
  ...
  ///  Constraints: No constraints specified.
  List<String>? get collectRequests => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 48);
  ...
  @override
  String toString() {
    return 'SensorPlanFull{id: ${id}, classificationMarking: ${classificationMarking}, type: ${type}, recType: ${recType}, startTime: ${startTime}, endTime: ${endTime}, name: ${name}, idSensor: ${idSensor}, origSensorId: ${origSensorId}, purpose: ${purpose}, senNetwork: ${senNetwork}, reqTotal: ${reqTotal}, customer: ${customer}, status: ${status}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, origNetwork: ${origNetwork}, collectRequests: ${collectRequests}, tags: ${tags}}';
  }
}

class _SensorPlanFullReader extends fb.TableReader<SensorPlanFull> {
  const _SensorPlanFullReader();

  @override
  SensorPlanFull createObject(fb.BufferContext bc, int offset) => 
    SensorPlanFull._(bc, offset);
}

class SensorPlanFullBuilder {
  SensorPlanFullBuilder(this.fbBuilder);
  ...
  int addDataMode(SensorPlanFullDataModeEnum? dataMode) {
...
class SensorPlanFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SensorPlanFullDataModeEnum? _dataMode;
  final String? _origNetwork;
  final List<String>? _collectRequests;
  final List<String>? _tags;

  SensorPlanFullObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    SensorPlanFullDataModeEnum? dataMode,
    String? origNetwork,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(22, collectRequestsOffset);
