...
class CrewMembersAbridged {
  CrewMembersAbridged._(this._bc, this._bcOffset);
  factory CrewMembersAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<CrewMembersAbridged> reader = _CrewMembersAbridgedReader();
  ...
  @override
  String toString() {
    return 'CrewMembersAbridged{lastName: ${lastName}, firstName: ${firstName}, middleInitial: ${middleInitial}, memberId: ${memberId}, civilian: ${civilian}, commander: ${commander}, last4Ssn: ${last4Ssn}, dodId: ${dodId}, dutyPosition: ${dutyPosition}, crewPosition: ${crewPosition}, memberType: ${memberType}, branch: ${branch}, rank: ${rank}, wing: ${wing}, squadron: ${squadron}, memberRemarks: ${memberRemarks}, username: ${username}}';
  }
}

class _CrewMembersAbridgedReader extends fb.TableReader<CrewMembersAbridged> {
  const _CrewMembersAbridgedReader();

  @override
  CrewMembersAbridged createObject(fb.BufferContext bc, int offset) => 
    CrewMembersAbridged._(bc, offset);
}

class CrewMembersAbridgedBuilder {
  CrewMembersAbridgedBuilder(this.fbBuilder);
...
class CrewMembersAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  CrewMembersAbridgedObjectBuilder({
    String? lastName,
    String? firstName,
