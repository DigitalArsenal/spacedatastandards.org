...
class CollectRequestAbridgedDataModeEnum {
  final int value;
  const CollectRequestAbridgedDataModeEnum._(this.value);

  factory CollectRequestAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum CollectRequestAbridgedDataModeEnum');
    }
    return result;
  }

  static CollectRequestAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : CollectRequestAbridgedDataModeEnum.fromValue(value);
  ...
  static const CollectRequestAbridgedDataModeEnum REAL = CollectRequestAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const CollectRequestAbridgedDataModeEnum TEST = CollectRequestAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const CollectRequestAbridgedDataModeEnum SIMULATED = CollectRequestAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const CollectRequestAbridgedDataModeEnum EXERCISE = CollectRequestAbridgedDataModeEnum._(3);
  static const Map<int, CollectRequestAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<CollectRequestAbridgedDataModeEnum> reader = _CollectRequestAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'CollectRequestAbridgedDataModeEnum{value: $value}';
  }
}

class _CollectRequestAbridgedDataModeEnumReader extends fb.Reader<CollectRequestAbridgedDataModeEnum> {
  const _CollectRequestAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  CollectRequestAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      CollectRequestAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class CollectRequestAbridged {
  CollectRequestAbridged._(this._bc, this._bcOffset);
  factory CollectRequestAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<CollectRequestAbridged> reader = _CollectRequestAbridgedReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  CollectRequestAbridgedDataModeEnum get dataMode => CollectRequestAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 172, 0));
...
class CollectRequestAbridgedBuilder {
  ...
  int addDataMode(CollectRequestAbridgedDataModeEnum? dataMode) {
...
class CollectRequestAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final CollectRequestAbridgedDataModeEnum? _dataMode;
  final String? _stateVector;
  final String? _elset;

  CollectRequestAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    CollectRequestAbridgedDataModeEnum? dataMode,
    String? stateVector,
    String? elset,
  })
      : _id = id,
