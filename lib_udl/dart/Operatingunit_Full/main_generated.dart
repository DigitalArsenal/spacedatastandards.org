...
class OperatingunitFullDataModeEnum {
  final int value;
  const OperatingunitFullDataModeEnum._(this.value);

  factory OperatingunitFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OperatingunitFullDataModeEnum');
    }
    return result;
  }

  static OperatingunitFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OperatingunitFullDataModeEnum.fromValue(value);
  ...
  static const OperatingunitFullDataModeEnum REAL = OperatingunitFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OperatingunitFullDataModeEnum TEST = OperatingunitFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OperatingunitFullDataModeEnum SIMULATED = OperatingunitFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OperatingunitFullDataModeEnum EXERCISE = OperatingunitFullDataModeEnum._(3);
  static const Map<int, OperatingunitFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OperatingunitFullDataModeEnum> reader = _OperatingunitFullDataModeEnumReader();

  @override
  String toString() {
    return 'OperatingunitFullDataModeEnum{value: $value}';
  }
}

class _OperatingunitFullDataModeEnumReader extends fb.Reader<OperatingunitFullDataModeEnum> {
  const _OperatingunitFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OperatingunitFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      OperatingunitFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class OperatingunitFull {
  OperatingunitFull._(this._bc, this._bcOffset);
  factory OperatingunitFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OperatingunitFull> reader = _OperatingunitFullReader();
  ...
  OperatingunitFullDataModeEnum get dataMode => OperatingunitFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 128, 0));
...
class OperatingunitFullBuilder {
  ...
  int addDataMode(OperatingunitFullDataModeEnum? dataMode) {
...
class OperatingunitFullObjectBuilder extends fb.ObjectBuilder {
  ...
  final OperatingunitFullDataModeEnum? _dataMode;
  final String? _organization;
  final String? _location;

  OperatingunitFullObjectBuilder({
    ...
    String? source,
    String? origin,
    OperatingunitFullDataModeEnum? dataMode,
    String? organization,
    String? location,
  })
