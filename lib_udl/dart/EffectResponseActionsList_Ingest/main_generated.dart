...
class EffectResponseActionsListIngest {
  EffectResponseActionsListIngest._(this._bc, this._bcOffset);
  factory EffectResponseActionsListIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EffectResponseActionsListIngest> reader = _EffectResponseActionsListIngestReader();
  ...
  @override
  String toString() {
    return 'EffectResponseActionsListIngest{summary: ${summary}, actionId: ${actionId}, actionStartTime: ${actionStartTime}, actionEndTime: ${actionEndTime}, totStartTime: ${totStartTime}, totEndTime: ${totEndTime}, actionActorSrcType: ${actionActorSrcType}, actionActorSrcId: ${actionActorSrcId}, effector: ${effector}, targetSrcType: ${targetSrcType}, targetSrcId: ${targetSrcId}, actorInterceptLat: ${actorInterceptLat}, actorInterceptLon: ${actorInterceptLon}, actorInterceptAlt: ${actorInterceptAlt}, weaponInterceptLat: ${weaponInterceptLat}, weaponInterceptLon: ${weaponInterceptLon}, weaponInterceptAlt: ${weaponInterceptAlt}, actionMetrics: ${actionMetrics}}';
  }
}

class _EffectResponseActionsListIngestReader extends fb.TableReader<EffectResponseActionsListIngest> {
  const _EffectResponseActionsListIngestReader();

  @override
  EffectResponseActionsListIngest createObject(fb.BufferContext bc, int offset) => 
    EffectResponseActionsListIngest._(bc, offset);
}

class EffectResponseActionsListIngestBuilder {
  EffectResponseActionsListIngestBuilder(this.fbBuilder);
...
class EffectResponseActionsListIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  EffectResponseActionsListIngestObjectBuilder({
    String? summary,
    String? actionId,
