...
class DiplomaticClearanceAbridgedDataModeEnum {
  final int value;
  const DiplomaticClearanceAbridgedDataModeEnum._(this.value);

  factory DiplomaticClearanceAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum DiplomaticClearanceAbridgedDataModeEnum');
    }
    return result;
  }

  static DiplomaticClearanceAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : DiplomaticClearanceAbridgedDataModeEnum.fromValue(value);
  ...
  static const DiplomaticClearanceAbridgedDataModeEnum REAL = DiplomaticClearanceAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const DiplomaticClearanceAbridgedDataModeEnum TEST = DiplomaticClearanceAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const DiplomaticClearanceAbridgedDataModeEnum SIMULATED = DiplomaticClearanceAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const DiplomaticClearanceAbridgedDataModeEnum EXERCISE = DiplomaticClearanceAbridgedDataModeEnum._(3);
  static const Map<int, DiplomaticClearanceAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<DiplomaticClearanceAbridgedDataModeEnum> reader = _DiplomaticClearanceAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'DiplomaticClearanceAbridgedDataModeEnum{value: $value}';
  }
}

class _DiplomaticClearanceAbridgedDataModeEnumReader extends fb.Reader<DiplomaticClearanceAbridgedDataModeEnum> {
  const _DiplomaticClearanceAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  DiplomaticClearanceAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      DiplomaticClearanceAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class DiplomaticClearanceAbridged {
  DiplomaticClearanceAbridged._(this._bc, this._bcOffset);
  factory DiplomaticClearanceAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DiplomaticClearanceAbridged> reader = _DiplomaticClearanceAbridgedReader();
  ...
  DiplomaticClearanceAbridgedDataModeEnum get dataMode => DiplomaticClearanceAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 40, 0));

  @override
  String toString() {
    return 'DiplomaticClearanceAbridged{id: ${id}, classificationMarking: ${classificationMarking}, idMission: ${idMission}, externalWorksheetId: ${externalWorksheetId}, dipWorksheetName: ${dipWorksheetName}, firstDepDate: ${firstDepDate}, docDeadline: ${docDeadline}, apacsId: ${apacsId}, diplomaticClearanceDetails: ${diplomaticClearanceDetails}, diplomaticClearanceRemarks: ${diplomaticClearanceRemarks}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, sourceDl: ${sourceDl}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _DiplomaticClearanceAbridgedReader extends fb.TableReader<DiplomaticClearanceAbridged> {
  const _DiplomaticClearanceAbridgedReader();

  @override
  DiplomaticClearanceAbridged createObject(fb.BufferContext bc, int offset) => 
    DiplomaticClearanceAbridged._(bc, offset);
}

class DiplomaticClearanceAbridgedBuilder {
  DiplomaticClearanceAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(DiplomaticClearanceAbridgedDataModeEnum? dataMode) {
...
class DiplomaticClearanceAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final DiplomaticClearanceAbridgedDataModeEnum? _dataMode;

  DiplomaticClearanceAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    DiplomaticClearanceAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
