...
class MissionAssignmentFullDataModeEnum {
  final int value;
  const MissionAssignmentFullDataModeEnum._(this.value);

  factory MissionAssignmentFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum MissionAssignmentFullDataModeEnum');
    }
    return result;
  }

  static MissionAssignmentFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : MissionAssignmentFullDataModeEnum.fromValue(value);
  ...
  static const MissionAssignmentFullDataModeEnum REAL = MissionAssignmentFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const MissionAssignmentFullDataModeEnum TEST = MissionAssignmentFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const MissionAssignmentFullDataModeEnum SIMULATED = MissionAssignmentFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const MissionAssignmentFullDataModeEnum EXERCISE = MissionAssignmentFullDataModeEnum._(3);
  static const Map<int, MissionAssignmentFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<MissionAssignmentFullDataModeEnum> reader = _MissionAssignmentFullDataModeEnumReader();

  @override
  String toString() {
    return 'MissionAssignmentFullDataModeEnum{value: $value}';
  }
}

class _MissionAssignmentFullDataModeEnumReader extends fb.Reader<MissionAssignmentFullDataModeEnum> {
  const _MissionAssignmentFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  MissionAssignmentFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      MissionAssignmentFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Platform mission assignment data.
class MissionAssignmentFull {
  MissionAssignmentFull._(this._bc, this._bcOffset);
  factory MissionAssignmentFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MissionAssignmentFull> reader = _MissionAssignmentFullReader();
  ...
  ///  Example: /// Example: 2018-01-01T16:00:00.123Z
  ///  Constraints: No constraints specified.
  String? get updatedAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 128);
  ///  Application user who updated the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 1, Maximum length = 64
  String? get updatedBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 130);
  ///  Source of the data.
  ...
  MissionAssignmentFullDataModeEnum get dataMode => MissionAssignmentFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 136, 0));
...
class MissionAssignmentFullBuilder {
  ...
  int addDataMode(MissionAssignmentFullDataModeEnum? dataMode) {
...
class MissionAssignmentFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final MissionAssignmentFullDataModeEnum? _dataMode;
  final String? _origNetwork;

  MissionAssignmentFullObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    MissionAssignmentFullDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(62, updatedAtOffset);
    fbBuilder.addOffset(63, updatedByOffset);
