...
class PortFullDataModeEnum {
  final int value;
  const PortFullDataModeEnum._(this.value);

  factory PortFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum PortFullDataModeEnum');
    }
    return result;
  }

  static PortFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : PortFullDataModeEnum.fromValue(value);
  ...
  static const PortFullDataModeEnum REAL = PortFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const PortFullDataModeEnum TEST = PortFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const PortFullDataModeEnum SIMULATED = PortFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const PortFullDataModeEnum EXERCISE = PortFullDataModeEnum._(3);
  static const Map<int, PortFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<PortFullDataModeEnum> reader = _PortFullDataModeEnumReader();

  @override
  String toString() {
    return 'PortFullDataModeEnum{value: $value}';
  }
}

class _PortFullDataModeEnumReader extends fb.Reader<PortFullDataModeEnum> {
  const _PortFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  PortFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      PortFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Properties and characteristics of a maritime port, which includes location, port identifiers, and remarks.
class PortFull {
  PortFull._(this._bc, this._bcOffset);
  factory PortFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PortFull> reader = _PortFullReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 64
  PortFullDataModeEnum get dataMode => PortFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 50, 0));
  ...
  @override
  String toString() {
    return 'PortFull{id: ${id}, classificationMarking: ${classificationMarking}, idSite: ${idSite}, externalId: ${externalId}, locode: ${locode}, portName: ${portName}, harborType: ${harborType}, harborSize: ${harborSize}, maxDraught: ${maxDraught}, avgDuration: ${avgDuration}, tideRange: ${tideRange}, shelter: ${shelter}, pilotReqd: ${pilotReqd}, lat: ${lat}, lon: ${lon}, countryCode: ${countryCode}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, sourceDl: ${sourceDl}, origin: ${origin}, dataMode: ${dataMode}, origNetwork: ${origNetwork}}';
  }
}

class _PortFullReader extends fb.TableReader<PortFull> {
  const _PortFullReader();

  @override
  PortFull createObject(fb.BufferContext bc, int offset) => 
    PortFull._(bc, offset);
}

class PortFullBuilder {
  PortFullBuilder(this.fbBuilder);
  ...
  int addDataMode(PortFullDataModeEnum? dataMode) {
...
class PortFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final PortFullDataModeEnum? _dataMode;
  final String? _origNetwork;

  PortFullObjectBuilder({
    String? id,
