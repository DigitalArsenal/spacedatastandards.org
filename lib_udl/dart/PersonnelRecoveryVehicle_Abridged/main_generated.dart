...
class PersonnelRecoveryVehicleAbridged {
  PersonnelRecoveryVehicleAbridged._(this._bc, this._bcOffset);
  factory PersonnelRecoveryVehicleAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PersonnelRecoveryVehicleAbridged> reader = _PersonnelRecoveryVehicleAbridgedReader();
  ...
  @override
  String toString() {
    return 'PersonnelRecoveryVehicleAbridged{callSign: ${callSign}, type: ${type}, primaryFreq: ${primaryFreq}, strength: ${strength}}';
  }
}

class _PersonnelRecoveryVehicleAbridgedReader extends fb.TableReader<PersonnelRecoveryVehicleAbridged> {
  const _PersonnelRecoveryVehicleAbridgedReader();

  @override
  PersonnelRecoveryVehicleAbridged createObject(fb.BufferContext bc, int offset) => 
    PersonnelRecoveryVehicleAbridged._(bc, offset);
}

class PersonnelRecoveryVehicleAbridgedBuilder {
  PersonnelRecoveryVehicleAbridgedBuilder(this.fbBuilder);
...
class PersonnelRecoveryVehicleAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _callSign;
  final String? _type;
  final double? _primaryFreq;
  final int? _strength;

  PersonnelRecoveryVehicleAbridgedObjectBuilder({
    String? callSign,
    String? type,
    double? primaryFreq,
    int? strength,
