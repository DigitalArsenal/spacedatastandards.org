...
class AirEventIngestDataModeEnum {
  final int value;
  const AirEventIngestDataModeEnum._(this.value);

  factory AirEventIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirEventIngestDataModeEnum');
    }
    return result;
  }

  static AirEventIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AirEventIngestDataModeEnum.fromValue(value);
  ...
  static const AirEventIngestDataModeEnum REAL = AirEventIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AirEventIngestDataModeEnum TEST = AirEventIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AirEventIngestDataModeEnum SIMULATED = AirEventIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AirEventIngestDataModeEnum EXERCISE = AirEventIngestDataModeEnum._(3);
  static const Map<int, AirEventIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AirEventIngestDataModeEnum> reader = _AirEventIngestDataModeEnumReader();

  @override
  String toString() {
    return 'AirEventIngestDataModeEnum{value: $value}';
  }
}

class _AirEventIngestDataModeEnumReader extends fb.Reader<AirEventIngestDataModeEnum> {
  const _AirEventIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AirEventIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      AirEventIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Information related to an air event (e.g. FUEL TRANSFER, AIR DROP) and the associated aircraft.
class AirEventIngest {
  AirEventIngest._(this._bc, this._bcOffset);
  factory AirEventIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirEventIngest> reader = _AirEventIngestReader();
...
class AirEventIngestBuilder {
  ...
  int addDataMode(AirEventIngestDataModeEnum? dataMode) {
...
class AirEventIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AirEventIngestDataModeEnum? _dataMode;

  AirEventIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    AirEventIngestDataModeEnum? dataMode,
  })
      : _id = id,
