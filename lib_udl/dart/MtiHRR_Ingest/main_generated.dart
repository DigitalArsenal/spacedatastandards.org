...
class MtiHrrIngest {
  MtiHrrIngest._(this._bc, this._bcOffset);
  factory MtiHrrIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MtiHrrIngest> reader = _MtiHrrIngestReader();
  ...
  @override
  String toString() {
    return 'MtiHrrIngest{h2: ${h2}, h3: ${h3}, h4: ${h4}, h5: ${h5}, h6: ${h6}, h7: ${h7}, h8: ${h8}, h9: ${h9}, h10: ${h10}, h11: ${h11}, h12: ${h12}, h13: ${h13}, h14: ${h14}, h15: ${h15}, h16: ${h16}, h17: ${h17}, h18: ${h18}, h19: ${h19}, h20: ${h20}, h21: ${h21}, h22: ${h22}, h23: ${h23}, h24: ${h24}, h27: ${h27}, h28: ${h28}, h29: ${h29}, h30: ${h30}, h31: ${h31}, h32: ${h32}}';
  }
}

class _MtiHrrIngestReader extends fb.TableReader<MtiHrrIngest> {
  const _MtiHrrIngestReader();

  @override
  MtiHrrIngest createObject(fb.BufferContext bc, int offset) => 
    MtiHrrIngest._(bc, offset);
}

class MtiHrrIngestBuilder {
  MtiHrrIngestBuilder(this.fbBuilder);
...
class MtiHrrIngestObjectBuilder extends fb.ObjectBuilder {
  final int? _h2;
  final int? _h3;
  final bool? _h4;
  final int? _h5;
