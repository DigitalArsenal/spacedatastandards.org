...
class ConjunctionFullDataModeEnum {
  final int value;
  const ConjunctionFullDataModeEnum._(this.value);

  factory ConjunctionFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ConjunctionFullDataModeEnum');
    }
    return result;
  }

  static ConjunctionFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : ConjunctionFullDataModeEnum.fromValue(value);
  ...
  static const ConjunctionFullDataModeEnum REAL = ConjunctionFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const ConjunctionFullDataModeEnum TEST = ConjunctionFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const ConjunctionFullDataModeEnum SIMULATED = ConjunctionFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const ConjunctionFullDataModeEnum EXERCISE = ConjunctionFullDataModeEnum._(3);
  static const Map<int, ConjunctionFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<ConjunctionFullDataModeEnum> reader = _ConjunctionFullDataModeEnumReader();

  @override
  String toString() {
    return 'ConjunctionFullDataModeEnum{value: $value}';
  }
}

class _ConjunctionFullDataModeEnumReader extends fb.Reader<ConjunctionFullDataModeEnum> {
  const _ConjunctionFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  ConjunctionFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      ConjunctionFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Stores the results of a particular Conjunction Assessment (CA) run.
class ConjunctionFull {
  ConjunctionFull._(this._bc, this._bcOffset);
  factory ConjunctionFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<ConjunctionFull> reader = _ConjunctionFullReader();
  ...
  ///  Constraints: No constraints specified.
  List<String>? get tags => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 120);
  ...
  ConjunctionFullDataModeEnum get dataMode => ConjunctionFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 122, 0));
  ...
  ///  Constraints: No constraints specified.
  String? get stateVector1 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 128);
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  String? get stateVector2 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 130);
  ///  Satellite/catalog number of the target on-orbit primary object.
  ///  Example: /// Example: 1
  ///  Constraints: No constraints specified.
  int get satNo1 => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 132, 0);
  ///  Satellite/catalog number of the target on-orbit secondary object.
  ///  Example: /// Example: 2
  ///  Constraints: No constraints specified.
  int get satNo2 => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 134, 0);
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  String? get onOrbit1 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 136);
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  String? get onOrbit2 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 138);
  ///  Optional place holder for an OnOrbit ID that does not exist in UDL.
  ///  Example: /// Example: ORIGONORBIT1-ID
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get origIdOnOrbit1 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 140);
  ///  Optional place holder for an OnOrbit ID that does not exist in UDL.
  ///  Example: /// Example: ORIGONORBIT2-ID
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get origIdOnOrbit2 => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 142);
...
class ConjunctionFullBuilder {
  ...
  int addDataMode(ConjunctionFullDataModeEnum? dataMode) {
    fbBuilder.addInt8(59, dataMode?.value);
    return fbBuilder.offset;
  }
  ...
  int addSatNo1(int? satNo1) {
    fbBuilder.addInt32(64, satNo1);
    return fbBuilder.offset;
  }
  int addSatNo2(int? satNo2) {
    fbBuilder.addInt32(65, satNo2);
    return fbBuilder.offset;
  }
  int addOnOrbit1Offset(int? offset) {
    fbBuilder.addOffset(66, offset);
    return fbBuilder.offset;
  }
  int addOnOrbit2Offset(int? offset) {
...
class ConjunctionFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final ConjunctionFullDataModeEnum? _dataMode;
  ...
  final int? _satNo1;
  final int? _satNo2;
  final String? _onOrbit1;
  final String? _onOrbit2;
  final String? _origIdOnOrbit1;
  final String? _origIdOnOrbit2;
  final String? _origNetwork;

  ConjunctionFullObjectBuilder({
    String? id,
    ...
    String? descriptor,
    List<String>? tags,
    ConjunctionFullDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? stateVector1,
    String? stateVector2,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    final int? onOrbit1Offset = _onOrbit1 == null ? null
        : fbBuilder.writeString(_onOrbit1!);
    final int? onOrbit2Offset = _onOrbit2 == null ? null
        : fbBuilder.writeString(_onOrbit2!);
    ...
    fbBuilder.addOffset(58, tagsOffset);
    fbBuilder.addInt8(59, _dataMode?.value);
    fbBuilder.addOffset(60, createdAtOffset);
    fbBuilder.addOffset(61, createdByOffset);
    fbBuilder.addOffset(62, stateVector1Offset);
    fbBuilder.addOffset(63, stateVector2Offset);
    fbBuilder.addInt32(64, _satNo1);
    fbBuilder.addInt32(65, _satNo2);
    fbBuilder.addOffset(66, onOrbit1Offset);
    fbBuilder.addOffset(67, onOrbit2Offset);
    fbBuilder.addOffset(68, origIdOnOrbit1Offset);
    fbBuilder.addOffset(69, origIdOnOrbit2Offset);
