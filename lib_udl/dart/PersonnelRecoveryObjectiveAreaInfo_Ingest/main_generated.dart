...
class PersonnelRecoveryObjectiveAreaInfoIngest {
  PersonnelRecoveryObjectiveAreaInfoIngest._(this._bc, this._bcOffset);
  factory PersonnelRecoveryObjectiveAreaInfoIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PersonnelRecoveryObjectiveAreaInfoIngest> reader = _PersonnelRecoveryObjectiveAreaInfoIngestReader();
  ...
  @override
  String toString() {
    return 'PersonnelRecoveryObjectiveAreaInfoIngest{pzLocation: ${pzLocation}, pzDesc: ${pzDesc}, oscCallSign: ${oscCallSign}, oscFreq: ${oscFreq}, enemyData: ${enemyData}}';
  }
}

class _PersonnelRecoveryObjectiveAreaInfoIngestReader extends fb.TableReader<PersonnelRecoveryObjectiveAreaInfoIngest> {
  const _PersonnelRecoveryObjectiveAreaInfoIngestReader();

  @override
  PersonnelRecoveryObjectiveAreaInfoIngest createObject(fb.BufferContext bc, int offset) => 
    PersonnelRecoveryObjectiveAreaInfoIngest._(bc, offset);
}

class PersonnelRecoveryObjectiveAreaInfoIngestBuilder {
  PersonnelRecoveryObjectiveAreaInfoIngestBuilder(this.fbBuilder);
...
class PersonnelRecoveryObjectiveAreaInfoIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  PersonnelRecoveryObjectiveAreaInfoIngestObjectBuilder({
