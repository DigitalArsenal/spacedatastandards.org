...
class IonoObservationDensityProfileIriAbridged {
  IonoObservationDensityProfileIriAbridged._(this._bc, this._bcOffset);
  factory IonoObservationDensityProfileIriAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationDensityProfileIriAbridged> reader = _IonoObservationDensityProfileIriAbridgedReader();
  ...
  @override
  String toString() {
    return 'IonoObservationDensityProfileIriAbridged{description: ${description}, nmF2: ${nmF2}, hmF2: ${hmF2}, b0: ${b0}, b1: ${b1}, nmF1: ${nmF1}, hmF1: ${hmF1}, d1: ${d1}, hz: ${hz}, hValTop: ${hValTop}, nValB: ${nValB}, nmE: ${nmE}, hmE: ${hmE}, hdx: ${hdx}, nmD: ${nmD}, hmD: ${hmD}, ha: ${ha}, fp1: ${fp1}, fp2: ${fp2}, fp30: ${fp30}, fp3U: ${fp3U}, chi: ${chi}}';
  }
}

class _IonoObservationDensityProfileIriAbridgedReader extends fb.TableReader<IonoObservationDensityProfileIriAbridged> {
  const _IonoObservationDensityProfileIriAbridgedReader();

  @override
  IonoObservationDensityProfileIriAbridged createObject(fb.BufferContext bc, int offset) => 
    IonoObservationDensityProfileIriAbridged._(bc, offset);
}

class IonoObservationDensityProfileIriAbridgedBuilder {
  IonoObservationDensityProfileIriAbridgedBuilder(this.fbBuilder);
...
class IonoObservationDensityProfileIriAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  IonoObservationDensityProfileIriAbridgedObjectBuilder({
    String? description,
    double? nmF2,
    double? hmF2,
    double? b0,
