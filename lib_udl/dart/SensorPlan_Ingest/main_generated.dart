...
class SensorPlanIngestDataModeEnum {
  final int value;
  const SensorPlanIngestDataModeEnum._(this.value);

  factory SensorPlanIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SensorPlanIngestDataModeEnum');
    }
    return result;
  }

  static SensorPlanIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SensorPlanIngestDataModeEnum.fromValue(value);
  ...
  static const SensorPlanIngestDataModeEnum REAL = SensorPlanIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SensorPlanIngestDataModeEnum TEST = SensorPlanIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SensorPlanIngestDataModeEnum SIMULATED = SensorPlanIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SensorPlanIngestDataModeEnum EXERCISE = SensorPlanIngestDataModeEnum._(3);
  static const Map<int, SensorPlanIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SensorPlanIngestDataModeEnum> reader = _SensorPlanIngestDataModeEnumReader();

  @override
  String toString() {
    return 'SensorPlanIngestDataModeEnum{value: $value}';
  }
}

class _SensorPlanIngestDataModeEnumReader extends fb.Reader<SensorPlanIngestDataModeEnum> {
  const _SensorPlanIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SensorPlanIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      SensorPlanIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
