...
class AirEventReceiversIngest {
  AirEventReceiversIngest._(this._bc, this._bcOffset);
  factory AirEventReceiversIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirEventReceiversIngest> reader = _AirEventReceiversIngestReader();
...
class AirEventReceiversIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  AirEventReceiversIngestObjectBuilder({
