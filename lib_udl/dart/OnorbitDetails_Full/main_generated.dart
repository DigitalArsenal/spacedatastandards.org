...
class OnorbitDetailsFullDataModeEnum {
  final int value;
  const OnorbitDetailsFullDataModeEnum._(this.value);

  factory OnorbitDetailsFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OnorbitDetailsFullDataModeEnum');
    }
    return result;
  }

  static OnorbitDetailsFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OnorbitDetailsFullDataModeEnum.fromValue(value);
  ...
  static const OnorbitDetailsFullDataModeEnum REAL = OnorbitDetailsFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OnorbitDetailsFullDataModeEnum TEST = OnorbitDetailsFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OnorbitDetailsFullDataModeEnum SIMULATED = OnorbitDetailsFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OnorbitDetailsFullDataModeEnum EXERCISE = OnorbitDetailsFullDataModeEnum._(3);
  static const Map<int, OnorbitDetailsFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OnorbitDetailsFullDataModeEnum> reader = _OnorbitDetailsFullDataModeEnumReader();

  @override
  String toString() {
    return 'OnorbitDetailsFullDataModeEnum{value: $value}';
  }
}

class _OnorbitDetailsFullDataModeEnumReader extends fb.Reader<OnorbitDetailsFullDataModeEnum> {
  const _OnorbitDetailsFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OnorbitDetailsFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      OnorbitDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Contains details of the OnOrbit object.
class OnorbitDetailsFull {
  OnorbitDetailsFull._(this._bc, this._bcOffset);
  factory OnorbitDetailsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OnorbitDetailsFull> reader = _OnorbitDetailsFullReader();
  ...
  OnorbitDetailsFullDataModeEnum get dataMode => OnorbitDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 92, 0));
...
class OnorbitDetailsFullBuilder {
  ...
  int addDataMode(OnorbitDetailsFullDataModeEnum? dataMode) {
...
class OnorbitDetailsFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final OnorbitDetailsFullDataModeEnum? _dataMode;
  ...
  OnorbitDetailsFullObjectBuilder({
    String? id,
    String? idOnOrbit,
    ...
    String? origin,
    String? lastObSource,
    OnorbitDetailsFullDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? updatedAt,
    String? updatedBy,
