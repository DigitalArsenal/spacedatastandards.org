...
class AirspaceControlOrderReferenceAbridged {
  AirspaceControlOrderReferenceAbridged._(this._bc, this._bcOffset);
  factory AirspaceControlOrderReferenceAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirspaceControlOrderReferenceAbridged> reader = _AirspaceControlOrderReferenceAbridgedReader();
  ...
  String? get refSid => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 4);
  ...
  @override
  String toString() {
    return 'AirspaceControlOrderReferenceAbridged{refSid: ${refSid}, refType: ${refType}, refOriginator: ${refOriginator}, refTs: ${refTs}, refSerialNum: ${refSerialNum}, refSpecialNotation: ${refSpecialNotation}, refSics: ${refSics}}';
  }
}

class _AirspaceControlOrderReferenceAbridgedReader extends fb.TableReader<AirspaceControlOrderReferenceAbridged> {
  const _AirspaceControlOrderReferenceAbridgedReader();

  @override
  AirspaceControlOrderReferenceAbridged createObject(fb.BufferContext bc, int offset) => 
    AirspaceControlOrderReferenceAbridged._(bc, offset);
}

class AirspaceControlOrderReferenceAbridgedBuilder {
  AirspaceControlOrderReferenceAbridgedBuilder(this.fbBuilder);
  ...
  int addRefSidOffset(int? offset) {
...
class AirspaceControlOrderReferenceAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _refSid;
  ...
  AirspaceControlOrderReferenceAbridgedObjectBuilder({
    String? refSid,
    String? refType,
  ...
  int finish(fb.Builder fbBuilder) {
    final int? refSidOffset = _refSid == null ? null
        : fbBuilder.writeString(_refSid!);
    ...
    fbBuilder.startTable(7);
    fbBuilder.addOffset(0, refSidOffset);
