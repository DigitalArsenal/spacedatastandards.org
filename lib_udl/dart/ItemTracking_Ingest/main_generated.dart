...
class ItemTrackingIngestDataModeEnum {
  final int value;
  const ItemTrackingIngestDataModeEnum._(this.value);

  factory ItemTrackingIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ItemTrackingIngestDataModeEnum');
    }
    return result;
  }

  static ItemTrackingIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : ItemTrackingIngestDataModeEnum.fromValue(value);
  ...
  static const ItemTrackingIngestDataModeEnum REAL = ItemTrackingIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const ItemTrackingIngestDataModeEnum TEST = ItemTrackingIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const ItemTrackingIngestDataModeEnum SIMULATED = ItemTrackingIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const ItemTrackingIngestDataModeEnum EXERCISE = ItemTrackingIngestDataModeEnum._(3);
  static const Map<int, ItemTrackingIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<ItemTrackingIngestDataModeEnum> reader = _ItemTrackingIngestDataModeEnumReader();

  @override
  String toString() {
    return 'ItemTrackingIngestDataModeEnum{value: $value}';
  }
}

class _ItemTrackingIngestDataModeEnumReader extends fb.Reader<ItemTrackingIngestDataModeEnum> {
  const _ItemTrackingIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  ItemTrackingIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      ItemTrackingIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// No description available.
class ItemTrackingIngest {
  ItemTrackingIngest._(this._bc, this._bcOffset);
  factory ItemTrackingIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<ItemTrackingIngest> reader = _ItemTrackingIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  ItemTrackingIngestDataModeEnum get dataMode => ItemTrackingIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 46, 0));
...
class _ItemTrackingIngestReader extends fb.TableReader<ItemTrackingIngest> {
  const _ItemTrackingIngestReader();

  @override
  ItemTrackingIngest createObject(fb.BufferContext bc, int offset) => 
    ItemTrackingIngest._(bc, offset);
}

class ItemTrackingIngestBuilder {
  ItemTrackingIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(ItemTrackingIngestDataModeEnum? dataMode) {
...
class ItemTrackingIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final ItemTrackingIngestDataModeEnum? _dataMode;

  ItemTrackingIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    ItemTrackingIngestDataModeEnum? dataMode,
  })
      : _id = id,
