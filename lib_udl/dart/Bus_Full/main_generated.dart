...
class BusFullDataModeEnum {
  final int value;
  const BusFullDataModeEnum._(this.value);

  factory BusFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum BusFullDataModeEnum');
    }
    return result;
  }

  static BusFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : BusFullDataModeEnum.fromValue(value);
  ...
  static const BusFullDataModeEnum REAL = BusFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const BusFullDataModeEnum TEST = BusFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const BusFullDataModeEnum SIMULATED = BusFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const BusFullDataModeEnum EXERCISE = BusFullDataModeEnum._(3);
  static const Map<int, BusFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<BusFullDataModeEnum> reader = _BusFullDataModeEnumReader();

  @override
  String toString() {
    return 'BusFullDataModeEnum{value: $value}';
  }
}

class _BusFullDataModeEnumReader extends fb.Reader<BusFullDataModeEnum> {
  const _BusFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  BusFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      BusFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class BusFull {
  BusFull._(this._bc, this._bcOffset);
  factory BusFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<BusFull> reader = _BusFullReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  BusFullDataModeEnum get dataMode => BusFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 110, 0));
...
class BusFullBuilder {
  ...
  int addDataMode(BusFullDataModeEnum? dataMode) {
...
class BusFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _name;
  ...
  final BusFullDataModeEnum? _dataMode;
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(56, updatedAtOffset);
    fbBuilder.addOffset(57, updatedByOffset);
    fbBuilder.addOffset(58, entityOffset);
    return fbBuilder.endTable();
  }
