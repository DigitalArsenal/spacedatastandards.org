...
class AircraftSortieFullPaperStatusEnum {
  final int value;
  const AircraftSortieFullPaperStatusEnum._(this.value);

  factory AircraftSortieFullPaperStatusEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AircraftSortieFullPaperStatusEnum');
    }
    return result;
  }

  static AircraftSortieFullPaperStatusEnum? _createOrNull(int? value) => 
      value == null ? null : AircraftSortieFullPaperStatusEnum.fromValue(value);
  ...
  static const AircraftSortieFullPaperStatusEnum PUBLISHED = AircraftSortieFullPaperStatusEnum._(0);

  ///  No description available.
  static const AircraftSortieFullPaperStatusEnum DELETED = AircraftSortieFullPaperStatusEnum._(1);

  ///  No description available.
  static const AircraftSortieFullPaperStatusEnum UPDATED = AircraftSortieFullPaperStatusEnum._(2);

  ///  No description available.
  static const AircraftSortieFullPaperStatusEnum READ = AircraftSortieFullPaperStatusEnum._(3);
  static const Map<int, AircraftSortieFullPaperStatusEnum> values = {
    0: PUBLISHED,
    1: DELETED,
    2: UPDATED,
    3: READ};

  static const fb.Reader<AircraftSortieFullPaperStatusEnum> reader = _AircraftSortieFullPaperStatusEnumReader();

  @override
  String toString() {
    return 'AircraftSortieFullPaperStatusEnum{value: $value}';
  }
}

class _AircraftSortieFullPaperStatusEnumReader extends fb.Reader<AircraftSortieFullPaperStatusEnum> {
  const _AircraftSortieFullPaperStatusEnumReader();

  @override
  int get size => 1;

  @override
  AircraftSortieFullPaperStatusEnum read(fb.BufferContext bc, int offset) =>
      AircraftSortieFullPaperStatusEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class AircraftSortieFullPprStatusEnum {
  final int value;
  const AircraftSortieFullPprStatusEnum._(this.value);

  factory AircraftSortieFullPprStatusEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AircraftSortieFullPprStatusEnum');
    }
    return result;
  }

  static AircraftSortieFullPprStatusEnum? _createOrNull(int? value) => 
      value == null ? null : AircraftSortieFullPprStatusEnum.fromValue(value);
  ...
  ///  No description available.
  static const AircraftSortieFullPprStatusEnum NOT_REQUIRED = AircraftSortieFullPprStatusEnum._(0);

  ///  No description available.
  static const AircraftSortieFullPprStatusEnum REQUIRED_NOT_REQUESTED = AircraftSortieFullPprStatusEnum._(1);

  ///  No description available.
  static const AircraftSortieFullPprStatusEnum GRANTED = AircraftSortieFullPprStatusEnum._(2);

  ///  No description available.
  static const AircraftSortieFullPprStatusEnum PENDING = AircraftSortieFullPprStatusEnum._(3);
  static const Map<int, AircraftSortieFullPprStatusEnum> values = {
    0: NOT_REQUIRED,
    1: REQUIRED_NOT_REQUESTED,
    2: GRANTED,
    3: PENDING};

  static const fb.Reader<AircraftSortieFullPprStatusEnum> reader = _AircraftSortieFullPprStatusEnumReader();

  @override
  String toString() {
    return 'AircraftSortieFullPprStatusEnum{value: $value}';
  }
}

class _AircraftSortieFullPprStatusEnumReader extends fb.Reader<AircraftSortieFullPprStatusEnum> {
  const _AircraftSortieFullPprStatusEnumReader();

  @override
  int get size => 1;

  @override
  AircraftSortieFullPprStatusEnum read(fb.BufferContext bc, int offset) =>
      AircraftSortieFullPprStatusEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class AircraftSortieFullRvnReqEnum {
  final int value;
  const AircraftSortieFullRvnReqEnum._(this.value);

  factory AircraftSortieFullRvnReqEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AircraftSortieFullRvnReqEnum');
    }
    return result;
  }

  static AircraftSortieFullRvnReqEnum? _createOrNull(int? value) => 
      value == null ? null : AircraftSortieFullRvnReqEnum.fromValue(value);
  ...
  ///  No description available.
  static const AircraftSortieFullRvnReqEnum N = AircraftSortieFullRvnReqEnum._(0);

  ///  No description available.
  static const AircraftSortieFullRvnReqEnum R = AircraftSortieFullRvnReqEnum._(1);

  ///  No description available.
  static const AircraftSortieFullRvnReqEnum C6 = AircraftSortieFullRvnReqEnum._(2);

  ///  No description available.
  static const AircraftSortieFullRvnReqEnum R6 = AircraftSortieFullRvnReqEnum._(3);
  static const Map<int, AircraftSortieFullRvnReqEnum> values = {
    0: N,
    1: R,
    2: C6,
    3: R6};

  static const fb.Reader<AircraftSortieFullRvnReqEnum> reader = _AircraftSortieFullRvnReqEnumReader();

  @override
  String toString() {
    return 'AircraftSortieFullRvnReqEnum{value: $value}';
  }
}

class _AircraftSortieFullRvnReqEnumReader extends fb.Reader<AircraftSortieFullRvnReqEnum> {
  const _AircraftSortieFullRvnReqEnumReader();

  @override
  int get size => 1;

  @override
  AircraftSortieFullRvnReqEnum read(fb.BufferContext bc, int offset) =>
      AircraftSortieFullRvnReqEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class AircraftSortieFullDataModeEnum {
  final int value;
  const AircraftSortieFullDataModeEnum._(this.value);

  factory AircraftSortieFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AircraftSortieFullDataModeEnum');
    }
    return result;
  }

  static AircraftSortieFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AircraftSortieFullDataModeEnum.fromValue(value);
  ...
  static const AircraftSortieFullDataModeEnum REAL = AircraftSortieFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AircraftSortieFullDataModeEnum TEST = AircraftSortieFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AircraftSortieFullDataModeEnum SIMULATED = AircraftSortieFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AircraftSortieFullDataModeEnum EXERCISE = AircraftSortieFullDataModeEnum._(3);
  static const Map<int, AircraftSortieFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AircraftSortieFullDataModeEnum> reader = _AircraftSortieFullDataModeEnumReader();

  @override
  String toString() {
    return 'AircraftSortieFullDataModeEnum{value: $value}';
  }
}

class _AircraftSortieFullDataModeEnumReader extends fb.Reader<AircraftSortieFullDataModeEnum> {
  const _AircraftSortieFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AircraftSortieFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      AircraftSortieFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Information related to the planning, load, status, and deployment or dispatch of one aircraft to carry out a mission.
class AircraftSortieFull {
  AircraftSortieFull._(this._bc, this._bcOffset);
  factory AircraftSortieFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AircraftSortieFull> reader = _AircraftSortieFullReader();
  ...
  AircraftSortieFullPaperStatusEnum get paperStatus => AircraftSortieFullPaperStatusEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 122, 0));
  ///  The prior permission required (PPR) status.
  ///  Example: /// Example: PENDING
  ///  Constraints: Minimum length = 0, Maximum length = 22
  AircraftSortieFullPprStatusEnum get pprStatus => AircraftSortieFullPprStatusEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 124, 0));
  ...
  AircraftSortieFullRvnReqEnum get rvnReq => AircraftSortieFullRvnReqEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 136, 0));
  ...
  ///  Constraints: No constraints specified.
  String? get updatedAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 154);
  ///  Application user who updated the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 1, Maximum length = 64
  String? get updatedBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 156);
  ///  The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
  ///  Example: /// Example: AXE
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get sourceDl => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 158);
  ///  Source of the data.
  ...
  AircraftSortieFullDataModeEnum get dataMode => AircraftSortieFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 164, 0));
...
class AircraftSortieFullBuilder {
  ...
  int addPaperStatus(AircraftSortieFullPaperStatusEnum? paperStatus) {
    fbBuilder.addInt8(59, paperStatus?.value);
    return fbBuilder.offset;
  }
  int addPprStatus(AircraftSortieFullPprStatusEnum? pprStatus) {
  ...
  int addRvnReq(AircraftSortieFullRvnReqEnum? rvnReq) {
  ...
  int addDataMode(AircraftSortieFullDataModeEnum? dataMode) {
  ...
  int addCrewOffset(int? offset) {
    fbBuilder.addOffset(82, offset);
    return fbBuilder.offset;
  }
  int addSortiePprOffset(int? offset) {
...
class AircraftSortieFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final int? _filesize;
  final AircraftSortieFullPaperStatusEnum? _paperStatus;
  final AircraftSortieFullPprStatusEnum? _pprStatus;
  final String? _missionUpdate;
  final String? _delayCode;
  final String? _commanderName;
  final String? _fmDeskNum;
  final String? _fmName;
  final AircraftSortieFullRvnReqEnum? _rvnReq;
  ...
  final AircraftSortieFullDataModeEnum? _dataMode;
  final String? _origNetwork;
  final String? _crew;
  final List<String>? _sortiePpr;

  AircraftSortieFullObjectBuilder({
    String? id,
    ...
    String? filename,
    int? filesize,
    AircraftSortieFullPaperStatusEnum? paperStatus,
    AircraftSortieFullPprStatusEnum? pprStatus,
    String? missionUpdate,
    String? delayCode,
    String? commanderName,
    String? fmDeskNum,
    String? fmName,
    AircraftSortieFullRvnReqEnum? rvnReq,
    int? passengers,
    String? parkingLoc,
    ...
    String? source,
    String? origin,
    AircraftSortieFullDataModeEnum? dataMode,
    String? origNetwork,
    String? crew,
    List<String>? sortiePpr,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    final int? crewOffset = _crew == null ? null
        : fbBuilder.writeString(_crew!);
    final int? sortiePprOffset = _sortiePpr == null ? null
        : fbBuilder.writeList(_sortiePpr!.map(fbBuilder.writeString).toList());
    fbBuilder.startTable(84);
    ...
    fbBuilder.addOffset(75, updatedAtOffset);
    fbBuilder.addOffset(76, updatedByOffset);
    fbBuilder.addOffset(77, sourceDlOffset);
    ...
    fbBuilder.addOffset(82, crewOffset);
    fbBuilder.addOffset(83, sortiePprOffset);
    return fbBuilder.endTable();
  }
