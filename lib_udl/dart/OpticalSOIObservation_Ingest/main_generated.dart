...
class OpticalSoiobservationIngest {
  OpticalSoiobservationIngest._(this._bc, this._bcOffset);
  factory OpticalSoiobservationIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OpticalSoiobservationIngest> reader = _OpticalSoiobservationIngestReader();
  ...
  @override
  String toString() {
    return 'OpticalSoiobservationIngest{obStartTime: ${obStartTime}, intensityTimes: ${intensityTimes}, currentSpectralFilterNum: ${currentSpectralFilterNum}, expDuration: ${expDuration}, intensities: ${intensities}, extinctionCoeffs: ${extinctionCoeffs}, extinctionCoeffsUnc: ${extinctionCoeffsUnc}, skyBgs: ${skyBgs}, localSkyBgs: ${localSkyBgs}, localSkyBgsUnc: ${localSkyBgsUnc}, numDetectedStars: ${numDetectedStars}, numCorrelatedStars: ${numCorrelatedStars}, zeroPoints: ${zeroPoints}, ras: ${ras}, declinations: ${declinations}, raRates: ${raRates}, percentSats: ${percentSats}}';
  }
}

class _OpticalSoiobservationIngestReader extends fb.TableReader<OpticalSoiobservationIngest> {
  const _OpticalSoiobservationIngestReader();

  @override
  OpticalSoiobservationIngest createObject(fb.BufferContext bc, int offset) => 
    OpticalSoiobservationIngest._(bc, offset);
}

class OpticalSoiobservationIngestBuilder {
  OpticalSoiobservationIngestBuilder(this.fbBuilder);
...
class OpticalSoiobservationIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  OpticalSoiobservationIngestObjectBuilder({
    String? obStartTime,
