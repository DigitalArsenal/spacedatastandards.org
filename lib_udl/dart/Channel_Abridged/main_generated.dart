...
class ChannelAbridgedDataModeEnum {
  final int value;
  const ChannelAbridgedDataModeEnum._(this.value);

  factory ChannelAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ChannelAbridgedDataModeEnum');
    }
    return result;
  }

  static ChannelAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : ChannelAbridgedDataModeEnum.fromValue(value);
  ...
  static const ChannelAbridgedDataModeEnum REAL = ChannelAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const ChannelAbridgedDataModeEnum TEST = ChannelAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const ChannelAbridgedDataModeEnum SIMULATED = ChannelAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const ChannelAbridgedDataModeEnum EXERCISE = ChannelAbridgedDataModeEnum._(3);
  static const Map<int, ChannelAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<ChannelAbridgedDataModeEnum> reader = _ChannelAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'ChannelAbridgedDataModeEnum{value: $value}';
  }
}

class _ChannelAbridgedDataModeEnumReader extends fb.Reader<ChannelAbridgedDataModeEnum> {
  const _ChannelAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  ChannelAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      ChannelAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Channel information on a particular transponder.
class ChannelAbridged {
  ChannelAbridged._(this._bc, this._bcOffset);
  factory ChannelAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<ChannelAbridged> reader = _ChannelAbridgedReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  ChannelAbridgedDataModeEnum get dataMode => ChannelAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 42, 0));
...
class _ChannelAbridgedReader extends fb.TableReader<ChannelAbridged> {
  const _ChannelAbridgedReader();

  @override
  ChannelAbridged createObject(fb.BufferContext bc, int offset) => 
    ChannelAbridged._(bc, offset);
}

class ChannelAbridgedBuilder {
  ChannelAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(ChannelAbridgedDataModeEnum? dataMode) {
...
class ChannelAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final ChannelAbridgedDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;

  ChannelAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    ChannelAbridgedDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
  })
      : _id = id,
