...
class AircraftMissionTaskingAbridged {
  AircraftMissionTaskingAbridged._(this._bc, this._bcOffset);
  factory AircraftMissionTaskingAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AircraftMissionTaskingAbridged> reader = _AircraftMissionTaskingAbridgedReader();
  ...
  @override
  String toString() {
    return 'AircraftMissionTaskingAbridged{countryCode: ${countryCode}, taskedService: ${taskedService}, unitDesignator: ${unitDesignator}, unitLocName: ${unitLocName}, resMsnInd: ${resMsnInd}, amcMsnNum: ${amcMsnNum}, pkgId: ${pkgId}, msnCommander: ${msnCommander}, msnNum: ${msnNum}, priMsnType: ${priMsnType}, secMsnType: ${secMsnType}, alertStatus: ${alertStatus}, depLocName: ${depLocName}, depLocUtm: ${depLocUtm}, depLocLat: ${depLocLat}, depLocLon: ${depLocLon}, depTime: ${depTime}, rcvyLocName: ${rcvyLocName}, rcvyLocUtm: ${rcvyLocUtm}, rcvyLocLat: ${rcvyLocLat}, rcvyLocLon: ${rcvyLocLon}, rcvyTime: ${rcvyTime}, indActasking: ${indActasking}, acMsnLocSeg: ${acMsnLocSeg}}';
  }
}

class _AircraftMissionTaskingAbridgedReader extends fb.TableReader<AircraftMissionTaskingAbridged> {
  const _AircraftMissionTaskingAbridgedReader();

  @override
  AircraftMissionTaskingAbridged createObject(fb.BufferContext bc, int offset) => 
    AircraftMissionTaskingAbridged._(bc, offset);
}

class AircraftMissionTaskingAbridgedBuilder {
  AircraftMissionTaskingAbridgedBuilder(this.fbBuilder);
...
class AircraftMissionTaskingAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  AircraftMissionTaskingAbridgedObjectBuilder({
    String? countryCode,
