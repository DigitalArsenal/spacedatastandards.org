...
class EcpsdrAbridgedDataModeEnum {
  final int value;
  const EcpsdrAbridgedDataModeEnum._(this.value);

  factory EcpsdrAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EcpsdrAbridgedDataModeEnum');
    }
    return result;
  }

  static EcpsdrAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EcpsdrAbridgedDataModeEnum.fromValue(value);
  ...
  static const EcpsdrAbridgedDataModeEnum REAL = EcpsdrAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EcpsdrAbridgedDataModeEnum TEST = EcpsdrAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EcpsdrAbridgedDataModeEnum SIMULATED = EcpsdrAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EcpsdrAbridgedDataModeEnum EXERCISE = EcpsdrAbridgedDataModeEnum._(3);
  static const Map<int, EcpsdrAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EcpsdrAbridgedDataModeEnum> reader = _EcpsdrAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'EcpsdrAbridgedDataModeEnum{value: $value}';
  }
}

class _EcpsdrAbridgedDataModeEnumReader extends fb.Reader<EcpsdrAbridgedDataModeEnum> {
  const _EcpsdrAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EcpsdrAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      EcpsdrAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class EcpsdrAbridged {
  EcpsdrAbridged._(this._bc, this._bcOffset);
  factory EcpsdrAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EcpsdrAbridged> reader = _EcpsdrAbridgedReader();
  ...
  ///  Example: /// Example: TEST
  ///  Constraints: Minimum length = 1, Maximum length = 32
  EcpsdrAbridgedDataModeEnum get dataMode => EcpsdrAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 106, 0));

  @override
  String toString() {
    return 'EcpsdrAbridged{id: ${id}, classificationMarking: ${classificationMarking}, idOnOrbit: ${idOnOrbit}, satNo: ${satNo}, origObjectId: ${origObjectId}, idSensor: ${idSensor}, origSensorId: ${origSensorId}, type: ${type}, msgTime: ${msgTime}, obTime: ${obTime}, retransmit: ${retransmit}, senMode: ${senMode}, dosBias: ${dosBias}, asl5VcurrMon: ${asl5VcurrMon}, dsl5VcurrMon: ${dsl5VcurrMon}, psTempMon: ${psTempMon}, cdsPlateVmon: ${cdsPlateVmon}, cdsRefVmon: ${cdsRefVmon}, mpTemp: ${mpTemp}, vRef: ${vRef}, pd1SigLev: ${pd1SigLev}, pd2SigLev: ${pd2SigLev}, esdTrigCountL: ${esdTrigCountL}, esdTrigCountH: ${esdTrigCountH}, lowLetL: ${lowLetL}, lowLetM: ${lowLetM}, medLet1L: ${medLet1L}, medLet1M: ${medLet1M}, medLet2L: ${medLet2L}, medLet2M: ${medLet2M}, medLet3L: ${medLet3L}, medLet3M: ${medLet3M}, medLet4L: ${medLet4L}, medLet4M: ${medLet4M}, hiLetL: ${hiLetL}, hiLetM: ${hiLetM}, surfDosL: ${surfDosL}, surfDosM: ${surfDosM}, surfDosH: ${surfDosH}, surfDosChargeL: ${surfDosChargeL}, surfDosChargeH: ${surfDosChargeH}, surfDosStat: ${surfDosStat}, cdsThrottle: ${cdsThrottle}, cdsThreshold: ${cdsThreshold}, checksum: ${checksum}, transientData: ${transientData}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _EcpsdrAbridgedReader extends fb.TableReader<EcpsdrAbridged> {
  const _EcpsdrAbridgedReader();

  @override
  EcpsdrAbridged createObject(fb.BufferContext bc, int offset) => 
    EcpsdrAbridged._(bc, offset);
}

class EcpsdrAbridgedBuilder {
  EcpsdrAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(EcpsdrAbridgedDataModeEnum? dataMode) {
...
class EcpsdrAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EcpsdrAbridgedDataModeEnum? _dataMode;

  EcpsdrAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    EcpsdrAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
