...
class DiplomaticClearanceRemarksAbridged {
  DiplomaticClearanceRemarksAbridged._(this._bc, this._bcOffset);
  factory DiplomaticClearanceRemarksAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DiplomaticClearanceRemarksAbridged> reader = _DiplomaticClearanceRemarksAbridgedReader();
  ...
  @override
  String toString() {
    return 'DiplomaticClearanceRemarksAbridged{gdssRemarkId: ${gdssRemarkId}, text: ${text}, date: ${date}, user: ${user}}';
  }
}

class _DiplomaticClearanceRemarksAbridgedReader extends fb.TableReader<DiplomaticClearanceRemarksAbridged> {
  const _DiplomaticClearanceRemarksAbridgedReader();

  @override
  DiplomaticClearanceRemarksAbridged createObject(fb.BufferContext bc, int offset) => 
    DiplomaticClearanceRemarksAbridged._(bc, offset);
}

class DiplomaticClearanceRemarksAbridgedBuilder {
  DiplomaticClearanceRemarksAbridgedBuilder(this.fbBuilder);
...
class DiplomaticClearanceRemarksAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _gdssRemarkId;
  final String? _text;
  final String? _date;
  final String? _user;

  DiplomaticClearanceRemarksAbridgedObjectBuilder({
    String? gdssRemarkId,
    String? text,
    String? date,
    String? user,
