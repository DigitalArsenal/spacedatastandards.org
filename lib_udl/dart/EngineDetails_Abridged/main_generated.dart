...
class EngineDetailsAbridgedDataModeEnum {
  final int value;
  const EngineDetailsAbridgedDataModeEnum._(this.value);

  factory EngineDetailsAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EngineDetailsAbridgedDataModeEnum');
    }
    return result;
  }

  static EngineDetailsAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EngineDetailsAbridgedDataModeEnum.fromValue(value);
  ...
  static const EngineDetailsAbridgedDataModeEnum REAL = EngineDetailsAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EngineDetailsAbridgedDataModeEnum TEST = EngineDetailsAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EngineDetailsAbridgedDataModeEnum SIMULATED = EngineDetailsAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EngineDetailsAbridgedDataModeEnum EXERCISE = EngineDetailsAbridgedDataModeEnum._(3);
  static const Map<int, EngineDetailsAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EngineDetailsAbridgedDataModeEnum> reader = _EngineDetailsAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'EngineDetailsAbridgedDataModeEnum{value: $value}';
  }
}

class _EngineDetailsAbridgedDataModeEnumReader extends fb.Reader<EngineDetailsAbridgedDataModeEnum> {
  const _EngineDetailsAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EngineDetailsAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      EngineDetailsAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class EngineDetailsAbridged {
  EngineDetailsAbridged._(this._bc, this._bcOffset);
  factory EngineDetailsAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EngineDetailsAbridged> reader = _EngineDetailsAbridgedReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  EngineDetailsAbridgedDataModeEnum get dataMode => EngineDetailsAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 48, 0));

  @override
  String toString() {
    return 'EngineDetailsAbridged{id: ${id}, idEngine: ${idEngine}, classificationMarking: ${classificationMarking}, family: ${family}, cycleType: ${cycleType}, characteristicType: ${characteristicType}, manufacturerOrgId: ${manufacturerOrgId}, specificImpulse: ${specificImpulse}, burnTime: ${burnTime}, seaLevelThrust: ${seaLevelThrust}, vacuumThrust: ${vacuumThrust}, chamberPressure: ${chamberPressure}, nozzleExpansionRatio: ${nozzleExpansionRatio}, maxFirings: ${maxFirings}, propellant: ${propellant}, oxidizer: ${oxidizer}, notes: ${notes}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _EngineDetailsAbridgedReader extends fb.TableReader<EngineDetailsAbridged> {
  const _EngineDetailsAbridgedReader();

  @override
  EngineDetailsAbridged createObject(fb.BufferContext bc, int offset) => 
    EngineDetailsAbridged._(bc, offset);
}

class EngineDetailsAbridgedBuilder {
  EngineDetailsAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(EngineDetailsAbridgedDataModeEnum? dataMode) {
...
class EngineDetailsAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EngineDetailsAbridgedDataModeEnum? _dataMode;

  EngineDetailsAbridgedObjectBuilder({
    String? id,
    String? idEngine,
    ...
    String? origin,
    String? origNetwork,
    EngineDetailsAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
        _idEngine = idEngine,
