...
class AirfieldStatusAbridgedDataModeEnum {
  final int value;
  const AirfieldStatusAbridgedDataModeEnum._(this.value);

  factory AirfieldStatusAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirfieldStatusAbridgedDataModeEnum');
    }
    return result;
  }

  static AirfieldStatusAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AirfieldStatusAbridgedDataModeEnum.fromValue(value);
  ...
  static const AirfieldStatusAbridgedDataModeEnum REAL = AirfieldStatusAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AirfieldStatusAbridgedDataModeEnum TEST = AirfieldStatusAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AirfieldStatusAbridgedDataModeEnum SIMULATED = AirfieldStatusAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AirfieldStatusAbridgedDataModeEnum EXERCISE = AirfieldStatusAbridgedDataModeEnum._(3);
  static const Map<int, AirfieldStatusAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AirfieldStatusAbridgedDataModeEnum> reader = _AirfieldStatusAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'AirfieldStatusAbridgedDataModeEnum{value: $value}';
  }
}

class _AirfieldStatusAbridgedDataModeEnumReader extends fb.Reader<AirfieldStatusAbridgedDataModeEnum> {
  const _AirfieldStatusAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AirfieldStatusAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      AirfieldStatusAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// The airfield status contains dynamic data of an airfield's capabilities.
class AirfieldStatusAbridged {
  AirfieldStatusAbridged._(this._bc, this._bcOffset);
  factory AirfieldStatusAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirfieldStatusAbridged> reader = _AirfieldStatusAbridgedReader();
...
class AirfieldStatusAbridgedBuilder {
  ...
  int addDataMode(AirfieldStatusAbridgedDataModeEnum? dataMode) {
...
class AirfieldStatusAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AirfieldStatusAbridgedDataModeEnum? _dataMode;

  AirfieldStatusAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    AirfieldStatusAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
