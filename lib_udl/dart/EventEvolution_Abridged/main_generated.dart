...
class EventEvolutionAbridgedDataModeEnum {
  final int value;
  const EventEvolutionAbridgedDataModeEnum._(this.value);

  factory EventEvolutionAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EventEvolutionAbridgedDataModeEnum');
    }
    return result;
  }

  static EventEvolutionAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EventEvolutionAbridgedDataModeEnum.fromValue(value);
  ...
  static const EventEvolutionAbridgedDataModeEnum REAL = EventEvolutionAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EventEvolutionAbridgedDataModeEnum TEST = EventEvolutionAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EventEvolutionAbridgedDataModeEnum SIMULATED = EventEvolutionAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EventEvolutionAbridgedDataModeEnum EXERCISE = EventEvolutionAbridgedDataModeEnum._(3);
  static const Map<int, EventEvolutionAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EventEvolutionAbridgedDataModeEnum> reader = _EventEvolutionAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'EventEvolutionAbridgedDataModeEnum{value: $value}';
  }
}

class _EventEvolutionAbridgedDataModeEnumReader extends fb.Reader<EventEvolutionAbridgedDataModeEnum> {
  const _EventEvolutionAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EventEvolutionAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      EventEvolutionAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class EventEvolutionAbridged {
  EventEvolutionAbridged._(this._bc, this._bcOffset);
  factory EventEvolutionAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EventEvolutionAbridged> reader = _EventEvolutionAbridgedReader();
  ...
  ///  Constraints: No constraints specified.
  String? get atext => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 36);
  ///  Geographical region or polygon (lat/lon pairs), as depicted by the GeoJSON representation of the geometry/geography, of the image as projected on the ground. GeoJSON Reference: https://geojson.org/. Ignored if included with a POST or PUT request that also specifies a valid 'area' or 'atext' field.
  ///  Example: /// Example: {"type":"Polygon","coordinates":[[[67.3291113966927,26.156175339112],[67.2580009640721,26.091022064271],[67.1795862381682,26.6637992964562],[67.2501237475598,26.730115808233],[67.3291113966927,26.156175339112]]]}
  ///  Constraints: No constraints specified.
  String? get agjson => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 38);
  ///  Type of region as projected on the ground.
  ///  Example: /// Example: POLYGON
  ///  Constraints: Minimum length = 0, Maximum length = 128
  String? get atype => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 40);
  ///  Number of dimensions of the geometry depicted by region.
  ///  Example: /// Example: 2
  ///  Constraints: No constraints specified.
  int get andims => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 42, 0);
  ///  Geographical spatial_ref_sys for region.
  ///  Example: /// Example: 4326
  ///  Constraints: No constraints specified.
  int get asrid => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 44, 0);
  ///  List of URLs to before/after images of this point of interest entity.
  ///  Example: /// Example: ['URL1', 'URL2']
  ///  Constraints: No constraints specified.
  List<String>? get url => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 46);
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  EventEvolutionAbridgedDataModeEnum get dataMode => EventEvolutionAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 60, 0));

  @override
  String toString() {
    return 'EventEvolutionAbridged{id: ${id}, classificationMarking: ${classificationMarking}, eventId: ${eventId}, category: ${category}, summary: ${summary}, startTime: ${startTime}, endTime: ${endTime}, status: ${status}, countryCode: ${countryCode}, geoAdminLevel1: ${geoAdminLevel1}, geoAdminLevel2: ${geoAdminLevel2}, geoAdminLevel3: ${geoAdminLevel3}, redact: ${redact}, srcTyps: ${srcTyps}, srcIds: ${srcIds}, dataDescription: ${dataDescription}, atext: ${atext}, agjson: ${agjson}, atype: ${atype}, andims: ${andims}, asrid: ${asrid}, url: ${url}, tags: ${tags}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _EventEvolutionAbridgedReader extends fb.TableReader<EventEvolutionAbridged> {
  const _EventEvolutionAbridgedReader();

  @override
  EventEvolutionAbridged createObject(fb.BufferContext bc, int offset) => 
    EventEvolutionAbridged._(bc, offset);
}

class EventEvolutionAbridgedBuilder {
  EventEvolutionAbridgedBuilder(this.fbBuilder);
  ...
  int addAndims(int? andims) {
    fbBuilder.addInt32(19, andims);
    return fbBuilder.offset;
  }
  int addAsrid(int? asrid) {
    fbBuilder.addInt32(20, asrid);
    return fbBuilder.offset;
  }
  ...
  int addDataMode(EventEvolutionAbridgedDataModeEnum? dataMode) {
...
class EventEvolutionAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EventEvolutionAbridgedDataModeEnum? _dataMode;

  EventEvolutionAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    EventEvolutionAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(16, atextOffset);
    fbBuilder.addOffset(17, agjsonOffset);
    fbBuilder.addOffset(18, atypeOffset);
    fbBuilder.addInt32(19, _andims);
    fbBuilder.addInt32(20, _asrid);
    fbBuilder.addOffset(21, urlOffset);
