...
class IonoObservationProfileDensityShiftedChebyshevEntryAbridged {
  IonoObservationProfileDensityShiftedChebyshevEntryAbridged._(this._bc, this._bcOffset);
  factory IonoObservationProfileDensityShiftedChebyshevEntryAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationProfileDensityShiftedChebyshevEntryAbridged> reader = _IonoObservationProfileDensityShiftedChebyshevEntryAbridgedReader();
  ...
  @override
  String toString() {
    return 'IonoObservationProfileDensityShiftedChebyshevEntryAbridged{layer: ${layer}, fstart: ${fstart}, fstop: ${fstop}, peakheight: ${peakheight}, zhalfNm: ${zhalfNm}, n: ${n}, coeffs: ${coeffs}, error: ${error}}';
  }
}

class _IonoObservationProfileDensityShiftedChebyshevEntryAbridgedReader extends fb.TableReader<IonoObservationProfileDensityShiftedChebyshevEntryAbridged> {
  const _IonoObservationProfileDensityShiftedChebyshevEntryAbridgedReader();

  @override
  IonoObservationProfileDensityShiftedChebyshevEntryAbridged createObject(fb.BufferContext bc, int offset) => 
    IonoObservationProfileDensityShiftedChebyshevEntryAbridged._(bc, offset);
}

class IonoObservationProfileDensityShiftedChebyshevEntryAbridgedBuilder {
  IonoObservationProfileDensityShiftedChebyshevEntryAbridgedBuilder(this.fbBuilder);
...
class IonoObservationProfileDensityShiftedChebyshevEntryAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _layer;
  ...
  IonoObservationProfileDensityShiftedChebyshevEntryAbridgedObjectBuilder({
    String? layer,
    double? fstart,
    double? fstop,
    double? peakheight,
