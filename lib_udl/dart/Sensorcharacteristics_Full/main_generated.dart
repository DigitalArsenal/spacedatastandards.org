...
class SensorcharacteristicsFullDataModeEnum {
  final int value;
  const SensorcharacteristicsFullDataModeEnum._(this.value);

  factory SensorcharacteristicsFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SensorcharacteristicsFullDataModeEnum');
    }
    return result;
  }

  static SensorcharacteristicsFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SensorcharacteristicsFullDataModeEnum.fromValue(value);
  ...
  static const SensorcharacteristicsFullDataModeEnum REAL = SensorcharacteristicsFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SensorcharacteristicsFullDataModeEnum TEST = SensorcharacteristicsFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SensorcharacteristicsFullDataModeEnum SIMULATED = SensorcharacteristicsFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SensorcharacteristicsFullDataModeEnum EXERCISE = SensorcharacteristicsFullDataModeEnum._(3);
  static const Map<int, SensorcharacteristicsFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SensorcharacteristicsFullDataModeEnum> reader = _SensorcharacteristicsFullDataModeEnumReader();

  @override
  String toString() {
    return 'SensorcharacteristicsFullDataModeEnum{value: $value}';
  }
}

class _SensorcharacteristicsFullDataModeEnumReader extends fb.Reader<SensorcharacteristicsFullDataModeEnum> {
  const _SensorcharacteristicsFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SensorcharacteristicsFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      SensorcharacteristicsFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Model representation of characteristics and capabilities of a sensor.
class SensorcharacteristicsFull {
  SensorcharacteristicsFull._(this._bc, this._bcOffset);
  factory SensorcharacteristicsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SensorcharacteristicsFull> reader = _SensorcharacteristicsFullReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SensorcharacteristicsFullDataModeEnum get dataMode => SensorcharacteristicsFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 106, 0));
...
class SensorcharacteristicsFullBuilder {
  ...
  int addDataMode(SensorcharacteristicsFullDataModeEnum? dataMode) {
...
class SensorcharacteristicsFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SensorcharacteristicsFullDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final String? _updatedAt;
  final String? _updatedBy;

  SensorcharacteristicsFullObjectBuilder({
    String? id,
    String? idSensor,
    ...
    String? source,
    SensorcharacteristicsFullDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? updatedAt,
    String? updatedBy,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(54, updatedAtOffset);
    fbBuilder.addOffset(55, updatedByOffset);
    return fbBuilder.endTable();
  }
