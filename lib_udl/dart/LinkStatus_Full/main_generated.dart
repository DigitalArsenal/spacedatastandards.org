...
class LinkStatusFullDataModeEnum {
  final int value;
  const LinkStatusFullDataModeEnum._(this.value);

  factory LinkStatusFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum LinkStatusFullDataModeEnum');
    }
    return result;
  }

  static LinkStatusFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : LinkStatusFullDataModeEnum.fromValue(value);
  ...
  static const LinkStatusFullDataModeEnum REAL = LinkStatusFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const LinkStatusFullDataModeEnum TEST = LinkStatusFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const LinkStatusFullDataModeEnum SIMULATED = LinkStatusFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const LinkStatusFullDataModeEnum EXERCISE = LinkStatusFullDataModeEnum._(3);
  static const Map<int, LinkStatusFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<LinkStatusFullDataModeEnum> reader = _LinkStatusFullDataModeEnumReader();

  @override
  String toString() {
    return 'LinkStatusFullDataModeEnum{value: $value}';
  }
}

class _LinkStatusFullDataModeEnumReader extends fb.Reader<LinkStatusFullDataModeEnum> {
  const _LinkStatusFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  LinkStatusFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      LinkStatusFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Captures link status.
class LinkStatusFull {
  LinkStatusFull._(this._bc, this._bcOffset);
  factory LinkStatusFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LinkStatusFull> reader = _LinkStatusFullReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  LinkStatusFullDataModeEnum get dataMode => LinkStatusFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 60, 0));
...
class LinkStatusFullBuilder {
  ...
  int addDataMode(LinkStatusFullDataModeEnum? dataMode) {
...
class LinkStatusFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final LinkStatusFullDataModeEnum? _dataMode;
  final int? _satNo1;
  final int? _satNo2;

  LinkStatusFullObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    LinkStatusFullDataModeEnum? dataMode,
    int? satNo1,
    int? satNo2,
  })
      : _id = id,
