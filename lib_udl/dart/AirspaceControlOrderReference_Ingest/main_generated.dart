...
class AirspaceControlOrderReferenceIngest {
  AirspaceControlOrderReferenceIngest._(this._bc, this._bcOffset);
  factory AirspaceControlOrderReferenceIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirspaceControlOrderReferenceIngest> reader = _AirspaceControlOrderReferenceIngestReader();
  ...
  @override
  String toString() {
    return 'AirspaceControlOrderReferenceIngest{refSid: ${refSid}, refType: ${refType}, refOriginator: ${refOriginator}, refTs: ${refTs}, refSerialNum: ${refSerialNum}, refSpecialNotation: ${refSpecialNotation}, refSics: ${refSics}}';
  }
}

class _AirspaceControlOrderReferenceIngestReader extends fb.TableReader<AirspaceControlOrderReferenceIngest> {
  const _AirspaceControlOrderReferenceIngestReader();

  @override
  AirspaceControlOrderReferenceIngest createObject(fb.BufferContext bc, int offset) => 
    AirspaceControlOrderReferenceIngest._(bc, offset);
}

class AirspaceControlOrderReferenceIngestBuilder {
  AirspaceControlOrderReferenceIngestBuilder(this.fbBuilder);
...
class AirspaceControlOrderReferenceIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  AirspaceControlOrderReferenceIngestObjectBuilder({
    String? refSid,
    String? refType,
