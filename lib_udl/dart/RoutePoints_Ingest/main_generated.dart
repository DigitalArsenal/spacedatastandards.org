...
class RoutePointsIngest {
  RoutePointsIngest._(this._bc, this._bcOffset);
  factory RoutePointsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<RoutePointsIngest> reader = _RoutePointsIngestReader();
  ...
  @override
  String toString() {
    return 'RoutePointsIngest{ptSequenceId: ${ptSequenceId}, ptTypeCode: ${ptTypeCode}, ptTypeName: ${ptTypeName}, waypointName: ${waypointName}, dafifPt: ${dafifPt}, ptLat: ${ptLat}, ptLon: ${ptLon}, magDec: ${magDec}, navaidLength: ${navaidLength}, navaid: ${navaid}, countryCode: ${countryCode}, altCountryCode: ${altCountryCode}, navaidType: ${navaidType}}';
  }
}

class _RoutePointsIngestReader extends fb.TableReader<RoutePointsIngest> {
  const _RoutePointsIngestReader();

  @override
  RoutePointsIngest createObject(fb.BufferContext bc, int offset) => 
    RoutePointsIngest._(bc, offset);
}

class RoutePointsIngestBuilder {
  RoutePointsIngestBuilder(this.fbBuilder);
...
class RoutePointsIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  RoutePointsIngestObjectBuilder({
    int? ptSequenceId,
    String? ptTypeCode,
    String? ptTypeName,
    String? waypointName,
