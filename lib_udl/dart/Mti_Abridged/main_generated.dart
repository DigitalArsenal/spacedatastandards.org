...
class MtiAbridgedDataModeEnum {
  final int value;
  const MtiAbridgedDataModeEnum._(this.value);

  factory MtiAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum MtiAbridgedDataModeEnum');
    }
    return result;
  }

  static MtiAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : MtiAbridgedDataModeEnum.fromValue(value);
  ...
  static const MtiAbridgedDataModeEnum REAL = MtiAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const MtiAbridgedDataModeEnum TEST = MtiAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const MtiAbridgedDataModeEnum SIMULATED = MtiAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const MtiAbridgedDataModeEnum EXERCISE = MtiAbridgedDataModeEnum._(3);
  static const Map<int, MtiAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<MtiAbridgedDataModeEnum> reader = _MtiAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'MtiAbridgedDataModeEnum{value: $value}';
  }
}

class _MtiAbridgedDataModeEnumReader extends fb.Reader<MtiAbridgedDataModeEnum> {
  const _MtiAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  MtiAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      MtiAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Information on the mission and flight plans, the type and configuration of the platform, and the reference time.
class MtiAbridged {
  MtiAbridged._(this._bc, this._bcOffset);
  factory MtiAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MtiAbridged> reader = _MtiAbridgedReader();
  ...
  MtiAbridgedDataModeEnum get dataMode => MtiAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 12, 0));
  ...
  @override
  String toString() {
    return 'MtiAbridged{classificationMarking: ${classificationMarking}, source: ${source}, origin: ${origin}, id: ${id}, dataMode: ${dataMode}, createdBy: ${createdBy}, createdAt: ${createdAt}, p3: ${p3}, p6: ${p6}, p7: ${p7}, p8: ${p8}, p9: ${p9}, p10: ${p10}, missions: ${missions}, dwells: ${dwells}, hrrs: ${hrrs}, jobDefs: ${jobDefs}, freeTexts: ${freeTexts}, platformLocs: ${platformLocs}, jobRequests: ${jobRequests}, origNetwork: ${origNetwork}}';
  }
}

class _MtiAbridgedReader extends fb.TableReader<MtiAbridged> {
  const _MtiAbridgedReader();

  @override
  MtiAbridged createObject(fb.BufferContext bc, int offset) => 
    MtiAbridged._(bc, offset);
}

class MtiAbridgedBuilder {
  MtiAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(MtiAbridgedDataModeEnum? dataMode) {
...
class MtiAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _classificationMarking;
  final String? _source;
  final String? _origin;
  final String? _id;
  final MtiAbridgedDataModeEnum? _dataMode;
  ...
  MtiAbridgedObjectBuilder({
    String? classificationMarking,
    String? source,
    String? origin,
    String? id,
    MtiAbridgedDataModeEnum? dataMode,
    String? createdBy,
    String? createdAt,
    String? p3,
    String? p6,
