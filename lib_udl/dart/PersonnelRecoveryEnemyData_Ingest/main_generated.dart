...
class PersonnelRecoveryEnemyDataIngest {
  PersonnelRecoveryEnemyDataIngest._(this._bc, this._bcOffset);
  factory PersonnelRecoveryEnemyDataIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PersonnelRecoveryEnemyDataIngest> reader = _PersonnelRecoveryEnemyDataIngestReader();
  ...
  @override
  String toString() {
    return 'PersonnelRecoveryEnemyDataIngest{dirToEnemy: ${dirToEnemy}, hostileFireType: ${hostileFireType}, friendliesRemarks: ${friendliesRemarks}, hlzRemarks: ${hlzRemarks}}';
  }
}

class _PersonnelRecoveryEnemyDataIngestReader extends fb.TableReader<PersonnelRecoveryEnemyDataIngest> {
  const _PersonnelRecoveryEnemyDataIngestReader();

  @override
  PersonnelRecoveryEnemyDataIngest createObject(fb.BufferContext bc, int offset) => 
    PersonnelRecoveryEnemyDataIngest._(bc, offset);
}

class PersonnelRecoveryEnemyDataIngestBuilder {
  PersonnelRecoveryEnemyDataIngestBuilder(this.fbBuilder);
...
class PersonnelRecoveryEnemyDataIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _dirToEnemy;
  final String? _hostileFireType;
  final String? _friendliesRemarks;
  final String? _hlzRemarks;

  PersonnelRecoveryEnemyDataIngestObjectBuilder({
    String? dirToEnemy,
