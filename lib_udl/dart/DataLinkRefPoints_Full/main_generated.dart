...
class DataLinkRefPointsFull {
  DataLinkRefPointsFull._(this._bc, this._bcOffset);
  factory DataLinkRefPointsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DataLinkRefPointsFull> reader = _DataLinkRefPointsFullReader();
  ...
  @override
  String toString() {
    return 'DataLinkRefPointsFull{refPointType: ${refPointType}, refDes: ${refDes}, refLocName: ${refLocName}, refLat: ${refLat}, refLon: ${refLon}, effEventTime: ${effEventTime}}';
  }
}

class _DataLinkRefPointsFullReader extends fb.TableReader<DataLinkRefPointsFull> {
  const _DataLinkRefPointsFullReader();

  @override
  DataLinkRefPointsFull createObject(fb.BufferContext bc, int offset) => 
    DataLinkRefPointsFull._(bc, offset);
}

class DataLinkRefPointsFullBuilder {
  DataLinkRefPointsFullBuilder(this.fbBuilder);
...
class DataLinkRefPointsFullObjectBuilder extends fb.ObjectBuilder {
  ...
  DataLinkRefPointsFullObjectBuilder({
    String? refPointType,
    String? refDes,
    String? refLocName,
    double? refLat,
