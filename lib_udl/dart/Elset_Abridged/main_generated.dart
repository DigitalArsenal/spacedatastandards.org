...
class ElsetAbridgedDataModeEnum {
  final int value;
  const ElsetAbridgedDataModeEnum._(this.value);

  factory ElsetAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ElsetAbridgedDataModeEnum');
    }
    return result;
  }

  static ElsetAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : ElsetAbridgedDataModeEnum.fromValue(value);
  ...
  static const ElsetAbridgedDataModeEnum REAL = ElsetAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const ElsetAbridgedDataModeEnum TEST = ElsetAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const ElsetAbridgedDataModeEnum SIMULATED = ElsetAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const ElsetAbridgedDataModeEnum EXERCISE = ElsetAbridgedDataModeEnum._(3);
  static const Map<int, ElsetAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<ElsetAbridgedDataModeEnum> reader = _ElsetAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'ElsetAbridgedDataModeEnum{value: $value}';
  }
}

class _ElsetAbridgedDataModeEnumReader extends fb.Reader<ElsetAbridgedDataModeEnum> {
  const _ElsetAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  ElsetAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      ElsetAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class ElsetAbridged {
  ElsetAbridged._(this._bc, this._bcOffset);
  factory ElsetAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<ElsetAbridged> reader = _ElsetAbridgedReader();
  ...
  ElsetAbridgedDataModeEnum get dataMode => ElsetAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 68, 0));
  ///  Optional algorithm used to produce this record.
  ///  Example: /// Example: Example algorithm
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get algorithm => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 70);
  ///  Optional identifier to track a commercial or marketplace transaction executed to produce this data.
  ///  Example: /// Example: TRANSACTION-ID
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get transactionId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 72);
  ...
  ///  Example: /// Example: 1
  ///  Constraints: No constraints specified.
  int get ephemType => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 74, 0);
  ...
  @override
  String toString() {
    return 'ElsetAbridged{idElset: ${idElset}, classificationMarking: ${classificationMarking}, satNo: ${satNo}, epoch: ${epoch}, meanMotion: ${meanMotion}, idOnOrbit: ${idOnOrbit}, uct: ${uct}, eccentricity: ${eccentricity}, inclination: ${inclination}, raan: ${raan}, argOfPerigee: ${argOfPerigee}, meanAnomaly: ${meanAnomaly}, revNo: ${revNo}, bStar: ${bStar}, agom: ${agom}, ballisticCoeff: ${ballisticCoeff}, meanMotionDot: ${meanMotionDot}, meanMotionDdot: ${meanMotionDdot}, semiMajorAxis: ${semiMajorAxis}, period: ${period}, apogee: ${apogee}, perigee: ${perigee}, origObjectId: ${origObjectId}, idOrbitDetermination: ${idOrbitDetermination}, line1: ${line1}, line2: ${line2}, descriptor: ${descriptor}, createdAt: ${createdAt}, createdBy: ${createdBy}, origin: ${origin}, sourceDl: ${sourceDl}, source: ${source}, dataMode: ${dataMode}, algorithm: ${algorithm}, transactionId: ${transactionId}, ephemType: ${ephemType}, origNetwork: ${origNetwork}}';
  }
}

class _ElsetAbridgedReader extends fb.TableReader<ElsetAbridged> {
  const _ElsetAbridgedReader();

  @override
  ElsetAbridged createObject(fb.BufferContext bc, int offset) => 
    ElsetAbridged._(bc, offset);
}

class ElsetAbridgedBuilder {
  ElsetAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(ElsetAbridgedDataModeEnum? dataMode) {
  ...
  int addEphemType(int? ephemType) {
    fbBuilder.addInt32(35, ephemType);
    return fbBuilder.offset;
  }
...
class ElsetAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  final ElsetAbridgedDataModeEnum? _dataMode;
  final String? _algorithm;
  final String? _transactionId;
  final int? _ephemType;
  final String? _origNetwork;

  ElsetAbridgedObjectBuilder({
    String? idElset,
    ...
    String? sourceDl,
    String? source,
    ElsetAbridgedDataModeEnum? dataMode,
    String? algorithm,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(33, algorithmOffset);
    fbBuilder.addOffset(34, transactionIdOffset);
    fbBuilder.addInt32(35, _ephemType);
