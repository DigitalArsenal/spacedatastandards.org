...
class AirspaceControlMeansAbridgedCmShapeEnum {
  final int value;
  const AirspaceControlMeansAbridgedCmShapeEnum._(this.value);

  factory AirspaceControlMeansAbridgedCmShapeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirspaceControlMeansAbridgedCmShapeEnum');
    }
    return result;
  }

  static AirspaceControlMeansAbridgedCmShapeEnum? _createOrNull(int? value) => 
      value == null ? null : AirspaceControlMeansAbridgedCmShapeEnum.fromValue(value);
  ...
  static const AirspaceControlMeansAbridgedCmShapeEnum POLYARC = AirspaceControlMeansAbridgedCmShapeEnum._(0);

  ///  No description available.
  static const AirspaceControlMeansAbridgedCmShapeEnum E1TRACK = AirspaceControlMeansAbridgedCmShapeEnum._(1);

  ///  No description available.
  static const AirspaceControlMeansAbridgedCmShapeEnum POLYGON = AirspaceControlMeansAbridgedCmShapeEnum._(2);

  ///  No description available.
  static const AirspaceControlMeansAbridgedCmShapeEnum CIRCLE = AirspaceControlMeansAbridgedCmShapeEnum._(3);

  ///  No description available.
  static const AirspaceControlMeansAbridgedCmShapeEnum CORRIDOR = AirspaceControlMeansAbridgedCmShapeEnum._(4);

  ///  No description available.
  static const AirspaceControlMeansAbridgedCmShapeEnum APOINT = AirspaceControlMeansAbridgedCmShapeEnum._(5);

  ///  No description available.
  static const AirspaceControlMeansAbridgedCmShapeEnum AORBIT = AirspaceControlMeansAbridgedCmShapeEnum._(6);

  ///  No description available.
  static const AirspaceControlMeansAbridgedCmShapeEnum GEOLINE = AirspaceControlMeansAbridgedCmShapeEnum._(7);
  static const Map<int, AirspaceControlMeansAbridgedCmShapeEnum> values = {
    0: POLYARC,
    1: E1TRACK,
    2: POLYGON,
    3: CIRCLE,
  ...
  static const fb.Reader<AirspaceControlMeansAbridgedCmShapeEnum> reader = _AirspaceControlMeansAbridgedCmShapeEnumReader();

  @override
  String toString() {
    return 'AirspaceControlMeansAbridgedCmShapeEnum{value: $value}';
  }
}

class _AirspaceControlMeansAbridgedCmShapeEnumReader extends fb.Reader<AirspaceControlMeansAbridgedCmShapeEnum> {
  const _AirspaceControlMeansAbridgedCmShapeEnumReader();

  @override
  int get size => 1;

  @override
  AirspaceControlMeansAbridgedCmShapeEnum read(fb.BufferContext bc, int offset) =>
      AirspaceControlMeansAbridgedCmShapeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// A conditional nested segment to report multiple airspace control means within a particular airspace control means status.
class AirspaceControlMeansAbridged {
  AirspaceControlMeansAbridged._(this._bc, this._bcOffset);
  factory AirspaceControlMeansAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirspaceControlMeansAbridged> reader = _AirspaceControlMeansAbridgedReader();
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 8
  AirspaceControlMeansAbridgedCmShapeEnum get cmShape => AirspaceControlMeansAbridgedCmShapeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 8, 0));
...
class AirspaceControlMeansAbridgedBuilder {
  ...
  int addCmShape(AirspaceControlMeansAbridgedCmShapeEnum? cmShape) {
...
class AirspaceControlMeansAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _cmType;
  final String? _cmId;
  final AirspaceControlMeansAbridgedCmShapeEnum? _cmShape;
  final String? _usage;
  ...
  AirspaceControlMeansAbridgedObjectBuilder({
    String? cmType,
    String? cmId,
    AirspaceControlMeansAbridgedCmShapeEnum? cmShape,
    String? usage,
    String? link16Id,
