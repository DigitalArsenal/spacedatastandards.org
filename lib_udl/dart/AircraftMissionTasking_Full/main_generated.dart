...
class AircraftMissionTaskingFull {
  AircraftMissionTaskingFull._(this._bc, this._bcOffset);
  factory AircraftMissionTaskingFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AircraftMissionTaskingFull> reader = _AircraftMissionTaskingFullReader();
  ...
  @override
  String toString() {
    return 'AircraftMissionTaskingFull{countryCode: ${countryCode}, taskedService: ${taskedService}, unitDesignator: ${unitDesignator}, unitLocName: ${unitLocName}, resMsnInd: ${resMsnInd}, amcMsnNum: ${amcMsnNum}, pkgId: ${pkgId}, msnCommander: ${msnCommander}, msnNum: ${msnNum}, priMsnType: ${priMsnType}, secMsnType: ${secMsnType}, alertStatus: ${alertStatus}, depLocName: ${depLocName}, depLocUtm: ${depLocUtm}, depLocLat: ${depLocLat}, depLocLon: ${depLocLon}, depTime: ${depTime}, rcvyLocName: ${rcvyLocName}, rcvyLocUtm: ${rcvyLocUtm}, rcvyLocLat: ${rcvyLocLat}, rcvyLocLon: ${rcvyLocLon}, rcvyTime: ${rcvyTime}, indActasking: ${indActasking}, acMsnLocSeg: ${acMsnLocSeg}}';
  }
}

class _AircraftMissionTaskingFullReader extends fb.TableReader<AircraftMissionTaskingFull> {
  const _AircraftMissionTaskingFullReader();

  @override
  AircraftMissionTaskingFull createObject(fb.BufferContext bc, int offset) => 
    AircraftMissionTaskingFull._(bc, offset);
}

class AircraftMissionTaskingFullBuilder {
  AircraftMissionTaskingFullBuilder(this.fbBuilder);
...
class AircraftMissionTaskingFullObjectBuilder extends fb.ObjectBuilder {
  ...
  AircraftMissionTaskingFullObjectBuilder({
    String? countryCode,
