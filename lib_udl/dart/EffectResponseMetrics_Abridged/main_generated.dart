...
class EffectResponseMetricsAbridged {
  EffectResponseMetricsAbridged._(this._bc, this._bcOffset);
  factory EffectResponseMetricsAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EffectResponseMetricsAbridged> reader = _EffectResponseMetricsAbridgedReader();
  ...
  @override
  String toString() {
    return 'EffectResponseMetricsAbridged{metricType: ${metricType}, domainValue: ${domainValue}, relativeValue: ${relativeValue}, provenance: ${provenance}}';
  }
}

class _EffectResponseMetricsAbridgedReader extends fb.TableReader<EffectResponseMetricsAbridged> {
  const _EffectResponseMetricsAbridgedReader();

  @override
  EffectResponseMetricsAbridged createObject(fb.BufferContext bc, int offset) => 
    EffectResponseMetricsAbridged._(bc, offset);
}

class EffectResponseMetricsAbridgedBuilder {
  EffectResponseMetricsAbridgedBuilder(this.fbBuilder);
...
class EffectResponseMetricsAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _metricType;
  final double? _domainValue;
  final double? _relativeValue;
  final String? _provenance;

  EffectResponseMetricsAbridgedObjectBuilder({
    String? metricType,
    double? domainValue,
