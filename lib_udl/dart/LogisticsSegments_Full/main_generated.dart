...
class LogisticsSegmentsFull {
  LogisticsSegmentsFull._(this._bc, this._bcOffset);
  factory LogisticsSegmentsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LogisticsSegmentsFull> reader = _LogisticsSegmentsFullReader();
  ...
  @override
  String toString() {
    return 'LogisticsSegmentsFull{segmentNumber: ${segmentNumber}, modeCode: ${modeCode}, missionType: ${missionType}, idMission: ${idMission}, extMissionId: ${extMissionId}, missionNumber: ${missionNumber}, itin: ${itin}, segTailNumber: ${segTailNumber}, segAircraftMds: ${segAircraftMds}, departureIcao: ${departureIcao}, segActDepTime: ${segActDepTime}, arrivalIcao: ${arrivalIcao}, segActArrTime: ${segActArrTime}, segEstDepTime: ${segEstDepTime}, segEstArrTime: ${segEstArrTime}}';
  }
}

class _LogisticsSegmentsFullReader extends fb.TableReader<LogisticsSegmentsFull> {
  const _LogisticsSegmentsFullReader();

  @override
  LogisticsSegmentsFull createObject(fb.BufferContext bc, int offset) => 
    LogisticsSegmentsFull._(bc, offset);
}

class LogisticsSegmentsFullBuilder {
  LogisticsSegmentsFullBuilder(this.fbBuilder);
...
class LogisticsSegmentsFullObjectBuilder extends fb.ObjectBuilder {
  ...
  LogisticsSegmentsFullObjectBuilder({
    int? segmentNumber,
    String? modeCode,
    String? missionType,
    String? idMission,
