...
class DiplomaticClearanceDetailsFull {
  DiplomaticClearanceDetailsFull._(this._bc, this._bcOffset);
  factory DiplomaticClearanceDetailsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DiplomaticClearanceDetailsFull> reader = _DiplomaticClearanceDetailsFullReader();
  ...
  @override
  String toString() {
    return 'DiplomaticClearanceDetailsFull{idSortie: ${idSortie}, legNum: ${legNum}, routeString: ${routeString}, validStartTime: ${validStartTime}, validEndTime: ${validEndTime}, clearanceId: ${clearanceId}, externalClearanceId: ${externalClearanceId}, clearedCallSign: ${clearedCallSign}, sequenceNum: ${sequenceNum}, countryCode: ${countryCode}, altCountryCode: ${altCountryCode}, countryName: ${countryName}, validDesc: ${validDesc}, windowRemark: ${windowRemark}, entryPoint: ${entryPoint}, entryNet: ${entryNet}, exitPoint: ${exitPoint}, exitNlt: ${exitNlt}, reqIcao: ${reqIcao}, action: ${action}, status: ${status}, profile: ${profile}, reqPoint: ${reqPoint}, clearanceRemark: ${clearanceRemark}}';
  }
}

class _DiplomaticClearanceDetailsFullReader extends fb.TableReader<DiplomaticClearanceDetailsFull> {
  const _DiplomaticClearanceDetailsFullReader();

  @override
  DiplomaticClearanceDetailsFull createObject(fb.BufferContext bc, int offset) => 
    DiplomaticClearanceDetailsFull._(bc, offset);
}

class DiplomaticClearanceDetailsFullBuilder {
  DiplomaticClearanceDetailsFullBuilder(this.fbBuilder);
...
class DiplomaticClearanceDetailsFullObjectBuilder extends fb.ObjectBuilder {
  ...
  DiplomaticClearanceDetailsFullObjectBuilder({
    String? idSortie,
    int? legNum,
    String? routeString,
