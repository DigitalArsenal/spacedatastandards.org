...
class IonoObservationAzimuthFull {
  IonoObservationAzimuthFull._(this._bc, this._bcOffset);
  factory IonoObservationAzimuthFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationAzimuthFull> reader = _IonoObservationAzimuthFullReader();
  ...
  @override
  String toString() {
    return 'IonoObservationAzimuthFull{notes: ${notes}, dimensions: ${dimensions}, dimensionName: ${dimensionName}, data: ${data}}';
  }
}

class _IonoObservationAzimuthFullReader extends fb.TableReader<IonoObservationAzimuthFull> {
  const _IonoObservationAzimuthFullReader();

  @override
  IonoObservationAzimuthFull createObject(fb.BufferContext bc, int offset) => 
    IonoObservationAzimuthFull._(bc, offset);
}

class IonoObservationAzimuthFullBuilder {
  IonoObservationAzimuthFullBuilder(this.fbBuilder);
...
class IonoObservationAzimuthFullObjectBuilder extends fb.ObjectBuilder {
  final String? _notes;
  final List<String>? _dimensions;
  final List<String>? _dimensionName;
  final List<String>? _data;

  IonoObservationAzimuthFullObjectBuilder({
    String? notes,
