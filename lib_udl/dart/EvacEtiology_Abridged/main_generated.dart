...
class EvacEtiologyAbridged {
  EvacEtiologyAbridged._(this._bc, this._bcOffset);
  factory EvacEtiologyAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EvacEtiologyAbridged> reader = _EvacEtiologyAbridgedReader();
  ...
  @override
  String toString() {
    return 'EvacEtiologyAbridged{type: ${type}, bodyPart: ${bodyPart}, time: ${time}, comments: ${comments}}';
  }
}

class _EvacEtiologyAbridgedReader extends fb.TableReader<EvacEtiologyAbridged> {
  const _EvacEtiologyAbridgedReader();

  @override
  EvacEtiologyAbridged createObject(fb.BufferContext bc, int offset) => 
    EvacEtiologyAbridged._(bc, offset);
}

class EvacEtiologyAbridgedBuilder {
  EvacEtiologyAbridgedBuilder(this.fbBuilder);
...
class EvacEtiologyAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _type;
  final String? _bodyPart;
  final String? _time;
  final String? _comments;

  EvacEtiologyAbridgedObjectBuilder({
    String? type,
    String? bodyPart,
    String? time,
    String? comments,
