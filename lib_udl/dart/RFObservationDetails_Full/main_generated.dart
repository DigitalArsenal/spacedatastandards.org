...
class RfobservationDetailsFullPolarityTypeEnum {
  final int value;
  const RfobservationDetailsFullPolarityTypeEnum._(this.value);

  factory RfobservationDetailsFullPolarityTypeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum RfobservationDetailsFullPolarityTypeEnum');
    }
    return result;
  }

  static RfobservationDetailsFullPolarityTypeEnum? _createOrNull(int? value) => 
      value == null ? null : RfobservationDetailsFullPolarityTypeEnum.fromValue(value);
  ...
  static const RfobservationDetailsFullPolarityTypeEnum H = RfobservationDetailsFullPolarityTypeEnum._(0);

  ///  No description available.
  static const RfobservationDetailsFullPolarityTypeEnum V = RfobservationDetailsFullPolarityTypeEnum._(1);

  ///  No description available.
  static const RfobservationDetailsFullPolarityTypeEnum R = RfobservationDetailsFullPolarityTypeEnum._(2);

  ///  No description available.
  static const RfobservationDetailsFullPolarityTypeEnum L = RfobservationDetailsFullPolarityTypeEnum._(3);
  static const Map<int, RfobservationDetailsFullPolarityTypeEnum> values = {
    0: H,
    1: V,
    2: R,
    3: L};

  static const fb.Reader<RfobservationDetailsFullPolarityTypeEnum> reader = _RfobservationDetailsFullPolarityTypeEnumReader();

  @override
  String toString() {
    return 'RfobservationDetailsFullPolarityTypeEnum{value: $value}';
  }
}

class _RfobservationDetailsFullPolarityTypeEnumReader extends fb.Reader<RfobservationDetailsFullPolarityTypeEnum> {
  const _RfobservationDetailsFullPolarityTypeEnumReader();

  @override
  int get size => 1;

  @override
  RfobservationDetailsFullPolarityTypeEnum read(fb.BufferContext bc, int offset) =>
      RfobservationDetailsFullPolarityTypeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class RfobservationDetailsFullDataModeEnum {
  final int value;
  const RfobservationDetailsFullDataModeEnum._(this.value);

  factory RfobservationDetailsFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum RfobservationDetailsFullDataModeEnum');
    }
    return result;
  }

  static RfobservationDetailsFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : RfobservationDetailsFullDataModeEnum.fromValue(value);
  ...
  static const RfobservationDetailsFullDataModeEnum REAL = RfobservationDetailsFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const RfobservationDetailsFullDataModeEnum TEST = RfobservationDetailsFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const RfobservationDetailsFullDataModeEnum SIMULATED = RfobservationDetailsFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const RfobservationDetailsFullDataModeEnum EXERCISE = RfobservationDetailsFullDataModeEnum._(3);
  static const Map<int, RfobservationDetailsFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<RfobservationDetailsFullDataModeEnum> reader = _RfobservationDetailsFullDataModeEnumReader();

  @override
  String toString() {
    return 'RfobservationDetailsFullDataModeEnum{value: $value}';
  }
}

class _RfobservationDetailsFullDataModeEnumReader extends fb.Reader<RfobservationDetailsFullDataModeEnum> {
  const _RfobservationDetailsFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  RfobservationDetailsFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      RfobservationDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class RfobservationDetailsFull {
  RfobservationDetailsFull._(this._bc, this._bcOffset);
  factory RfobservationDetailsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<RfobservationDetailsFull> reader = _RfobservationDetailsFullReader();
  ...
  RfobservationDetailsFullPolarityTypeEnum get polarityType => RfobservationDetailsFullPolarityTypeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 94, 0));
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  RfobservationDetailsFullDataModeEnum get dataMode => RfobservationDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 134, 0));
  ///  Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
  ///  Example: /// Example: ['PROVIDER_TAG1', 'PROVIDER_TAG2']
  ///  Constraints: No constraints specified.
  List<String>? get tags => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 136);
  ///  Time the row was created in the database, auto-populated by the system.
  ///  Example: /// Example: 2018-01-01T16:00:00.123Z
  ///  Constraints: No constraints specified.
  String? get createdAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 138);
  ///  Application user who created the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 1, Maximum length = 64
  String? get createdBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 140);
  ///  Noise power density, in dBW-Hz.
  ///  Example: /// Example: 10.1
  ///  Constraints: No constraints specified.
  double get noisePwrDensity => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 142, 0.0);
  ///  Carrier standard (e.g. DVB-S2, 802.11g, etc.).
  ///  Example: /// Example: DVB-S2
  ///  Constraints: Minimum length = 0, Maximum length = 10
  String? get carrierStandard => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 144);
  ///  Transponder modulation (e.g. Auto, QPSK, 8PSK, etc).
  ///  Example: /// Example: Auto
  ///  Constraints: Minimum length = 0, Maximum length = 10
  String? get modulation => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 146);
  ///  Inner forward error correction rate:  0 = Auto, 1 = 1/2, 2 = 2/3, 3 = 3/4, 4 = 5/6, 5 = 7/8, 6 = 8/9, 7 = 3/5, 8 = 4/5, 9 = 9/10, 15 = None.
  ///  Example: /// Example: 7
  ///  Constraints: No constraints specified.
  int get innerCodingRate => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 148, 0);
  ///  Outer forward error correction rate:  0 = Auto, 1 = 1/2, 2 = 2/3, 3 = 3/4, 4 = 5/6, 5 = 7/8, 6 = 8/9, 7 = 3/5, 8 = 4/5, 9 = 9/10, 15 = None.
  ///  Example: /// Example: 4
  ///  Constraints: No constraints specified.
  int get outerCodingRate => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 150, 0);
  ///  Transmit pulse shaping filter typ (e.g. RRC).
  ///  Example: /// Example: RRC
  ///  Constraints: Minimum length = 0, Maximum length = 10
  String? get transmitFilterType => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 152);
  ///  Transmit pulse shaping filter roll-off value.
  ///  Example: /// Example: 10.1
  ///  Constraints: No constraints specified.
  double get transmitFilterRollOff => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 154, 0.0);
  ///  Symbol to noise ratio, in dB.
  ///  Example: /// Example: 10.1
  ///  Constraints: No constraints specified.
  double get symbolToNoiseRatio => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 156, 0.0);
  ///  The ratio of bit errors per number of received bits.
  ///  Example: /// Example: 10.1
  ///  Constraints: No constraints specified.
  double get bitErrorRate => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 158, 0.0);
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  String? get origNetwork => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 160);
  ///  The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
  ///  Example: /// Example: AXE
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get sourceDl => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 162);
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  String? get onOrbit => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 164);
  ///  Optional source-provided and searchable metadata or descriptor of the data.
  ///  Example: /// Example: descriptor
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get descriptor => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 166);
  ...
  String? get url => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 168);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get frequencies => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 170);
  ...
  ///  Example: /// Example: [1.1, 2.2]
  ///  Constraints: No constraints specified.
  List<String>? get powers => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 172);
  ///  Array of signal to noise ratios of the signals, in dB.
  ///  Example: /// Example: [1.1, 2.2]
  ///  Constraints: No constraints specified.
  List<String>? get snrs => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 174);
  ///  Array of measurement confidences.
  ///  Example: /// Example: [1.1, 2.2]
  ///  Constraints: No constraints specified.
  List<String>? get confidences => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 176);
  ///  Array of detection statuses (e.g. DETECTED, CARRIER_DETECTED, NOT_DETECTED) for each measured signal.
  ///  Example: /// Example: ['DETECTED']
  ///  Constraints: No constraints specified.
  List<String>? get detectionStatuses => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 178);
  ///  Array of chipRates.
  ///  Example: /// Example: [1.1, 2.2]
  ///  Constraints: No constraints specified.
  List<String>? get chipRates => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 180);
  ///  Array of code taps.
  ///  Example: /// Example: ['TAG1', 'TAG2']
  ///  Constraints: No constraints specified.
  List<String>? get codeTaps => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 182);
  ///  Array of code fills.
  ///  Example: /// Example: ['TAG1', 'TAG2']
  ///  Constraints: No constraints specified.
  List<String>? get codeFills => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 184);
  ///  Array of code lengths.
  ///  Example: /// Example: [1.1, 2.2]
  ///  Constraints: No constraints specified.
  List<String>? get codeLengths => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 186);
  ///  Array of pnOrder.
  ///  Example: /// Example: [1, 2]
  ///  Constraints: No constraints specified.
  List<String>? get pnOrders => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 188);
  ///  Array of optional source provided identifiers of the measurements/signals.
  ///  Example: /// Example: ['ID1', 'ID2']
  ///  Constraints: No constraints specified.
  List<String>? get signalIds => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 190);
  ///  Array of measured signal baud rates.
  ///  Example: /// Example: [1.1, 2.2]
  ///  Constraints: No constraints specified.
  List<String>? get baudRates => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 192);
  ///  Array of optional source provided telemetry identifiers of the measurements/signals.
  ///  Example: /// Example: ['ID1', 'ID2']
  ///  Constraints: No constraints specified.
  List<String>? get telemetryIds => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 194);
  ...
  ///  Example: /// Example: [1.1, 2.2]
  ///  Constraints: No constraints specified.
  List<String>? get constellationXpoints => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 196);
  ...
  ///  Example: /// Example: [1.1, 2.2]
  ///  Constraints: No constraints specified.
  List<String>? get constellationYpoints => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 198);

  @override
  String toString() {
    return 'RfobservationDetailsFull{id: ${id}, classificationMarking: ${classificationMarking}, obTime: ${obTime}, idOnOrbit: ${idOnOrbit}, idSensor: ${idSensor}, type: ${type}, satNo: ${satNo}, taskId: ${taskId}, transactionId: ${transactionId}, trackId: ${trackId}, origObjectId: ${origObjectId}, origSensorId: ${origSensorId}, uct: ${uct}, transponder: ${transponder}, azimuth: ${azimuth}, azimuthUnc: ${azimuthUnc}, azimuthRate: ${azimuthRate}, elevation: ${elevation}, elevationUnc: ${elevationUnc}, elevationRate: ${elevationRate}, range: ${range}, rangeUnc: ${rangeUnc}, rangeRate: ${rangeRate}, rangeRateUnc: ${rangeRateUnc}, trackRange: ${trackRange}, senlat: ${senlat}, senlon: ${senlon}, senalt: ${senalt}, elnot: ${elnot}, frequency: ${frequency}, nominalFrequency: ${nominalFrequency}, startFrequency: ${startFrequency}, endFrequency: ${endFrequency}, relativeCarrierPower: ${relativeCarrierPower}, spectrumAnalyzerPower: ${spectrumAnalyzerPower}, relativeNoiseFloor: ${relativeNoiseFloor}, referenceLevel: ${referenceLevel}, pgri: ${pgri}, confidence: ${confidence}, incoming: ${incoming}, switchPoint: ${switchPoint}, baudRate: ${baudRate}, snr: ${snr}, nominalSnr: ${nominalSnr}, polarity: ${polarity}, polarityType: ${polarityType}, channel: ${channel}, powerOverNoise: ${powerOverNoise}, nominalPowerOverNoise: ${nominalPowerOverNoise}, bandwidth: ${bandwidth}, nominalBandwidth: ${nominalBandwidth}, resolutionBandwidth: ${resolutionBandwidth}, videoBandwidth: ${videoBandwidth}, eirp: ${eirp}, nominalEirp: ${nominalEirp}, minPsd: ${minPsd}, maxPsd: ${maxPsd}, frequencyShift: ${frequencyShift}, peak: ${peak}, antennaName: ${antennaName}, detectionStatus: ${detectionStatus}, collectionMode: ${collectionMode}, rawFileUri: ${rawFileUri}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, tags: ${tags}, createdAt: ${createdAt}, createdBy: ${createdBy}, noisePwrDensity: ${noisePwrDensity}, carrierStandard: ${carrierStandard}, modulation: ${modulation}, innerCodingRate: ${innerCodingRate}, outerCodingRate: ${outerCodingRate}, transmitFilterType: ${transmitFilterType}, transmitFilterRollOff: ${transmitFilterRollOff}, symbolToNoiseRatio: ${symbolToNoiseRatio}, bitErrorRate: ${bitErrorRate}, origNetwork: ${origNetwork}, sourceDl: ${sourceDl}, onOrbit: ${onOrbit}, descriptor: ${descriptor}, url: ${url}, frequencies: ${frequencies}, powers: ${powers}, snrs: ${snrs}, confidences: ${confidences}, detectionStatuses: ${detectionStatuses}, chipRates: ${chipRates}, codeTaps: ${codeTaps}, codeFills: ${codeFills}, codeLengths: ${codeLengths}, pnOrders: ${pnOrders}, signalIds: ${signalIds}, baudRates: ${baudRates}, telemetryIds: ${telemetryIds}, constellationXpoints: ${constellationXpoints}, constellationYpoints: ${constellationYpoints}}';
  }
}

class _RfobservationDetailsFullReader extends fb.TableReader<RfobservationDetailsFull> {
  const _RfobservationDetailsFullReader();

  @override
  RfobservationDetailsFull createObject(fb.BufferContext bc, int offset) => 
    RfobservationDetailsFull._(bc, offset);
}

class RfobservationDetailsFullBuilder {
  RfobservationDetailsFullBuilder(this.fbBuilder);

  final fb.Builder fbBuilder;

  void begin() {
    fbBuilder.startTable(98);
  }
  ...
  int addPolarityType(RfobservationDetailsFullPolarityTypeEnum? polarityType) {
  ...
  int addDataMode(RfobservationDetailsFullDataModeEnum? dataMode) {
  ...
  int addNoisePwrDensity(double? noisePwrDensity) {
    fbBuilder.addFloat64(69, noisePwrDensity);
    return fbBuilder.offset;
  }
  ...
  int addInnerCodingRate(int? innerCodingRate) {
    fbBuilder.addInt32(72, innerCodingRate);
    return fbBuilder.offset;
  }
  int addOuterCodingRate(int? outerCodingRate) {
    fbBuilder.addInt32(73, outerCodingRate);
    return fbBuilder.offset;
  }
  ...
  int addTransmitFilterRollOff(double? transmitFilterRollOff) {
    fbBuilder.addFloat64(75, transmitFilterRollOff);
    return fbBuilder.offset;
  }
  int addSymbolToNoiseRatio(double? symbolToNoiseRatio) {
    fbBuilder.addFloat64(76, symbolToNoiseRatio);
    return fbBuilder.offset;
  }
  int addBitErrorRate(double? bitErrorRate) {
    fbBuilder.addFloat64(77, bitErrorRate);
    return fbBuilder.offset;
  }
  ...
  int addConfidencesOffset(int? offset) {
    fbBuilder.addOffset(86, offset);
    return fbBuilder.offset;
  }
  int addDetectionStatusesOffset(int? offset) {
    fbBuilder.addOffset(87, offset);
    return fbBuilder.offset;
  }
  int addChipRatesOffset(int? offset) {
    fbBuilder.addOffset(88, offset);
    return fbBuilder.offset;
  }
  int addCodeTapsOffset(int? offset) {
    fbBuilder.addOffset(89, offset);
    return fbBuilder.offset;
  }
  int addCodeFillsOffset(int? offset) {
    fbBuilder.addOffset(90, offset);
    return fbBuilder.offset;
  }
  int addCodeLengthsOffset(int? offset) {
    fbBuilder.addOffset(91, offset);
    return fbBuilder.offset;
  }
  int addPnOrdersOffset(int? offset) {
    fbBuilder.addOffset(92, offset);
    return fbBuilder.offset;
  }
  int addSignalIdsOffset(int? offset) {
    fbBuilder.addOffset(93, offset);
    return fbBuilder.offset;
  }
  int addBaudRatesOffset(int? offset) {
    fbBuilder.addOffset(94, offset);
    return fbBuilder.offset;
  }
  int addTelemetryIdsOffset(int? offset) {
    fbBuilder.addOffset(95, offset);
    return fbBuilder.offset;
  }
  int addConstellationXpointsOffset(int? offset) {
    fbBuilder.addOffset(96, offset);
    return fbBuilder.offset;
  }
  int addConstellationYpointsOffset(int? offset) {
...
class RfobservationDetailsFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final RfobservationDetailsFullPolarityTypeEnum? _polarityType;
  final int? _channel;
  ...
  final RfobservationDetailsFullDataModeEnum? _dataMode;
  ...
  final List<String>? _confidences;
  final List<String>? _detectionStatuses;
  final List<String>? _chipRates;
  final List<String>? _codeTaps;
  final List<String>? _codeFills;
  final List<String>? _codeLengths;
  final List<String>? _pnOrders;
  final List<String>? _signalIds;
  final List<String>? _baudRates;
  final List<String>? _telemetryIds;
  final List<String>? _constellationXpoints;
  final List<String>? _constellationYpoints;

  RfobservationDetailsFullObjectBuilder({
    String? id,
    ...
    double? nominalSnr,
    double? polarity,
    RfobservationDetailsFullPolarityTypeEnum? polarityType,
    int? channel,
    ...
    String? source,
    String? origin,
    RfobservationDetailsFullDataModeEnum? dataMode,
    List<String>? tags,
    String? createdAt,
    String? createdBy,
    ...
    List<String>? detectionStatuses,
    List<String>? chipRates,
    List<String>? codeTaps,
    List<String>? codeFills,
    List<String>? codeLengths,
    List<String>? pnOrders,
    List<String>? signalIds,
    List<String>? baudRates,
    List<String>? telemetryIds,
    List<String>? constellationXpoints,
    List<String>? constellationYpoints,
  })
      : _id = id,
        ...
        _detectionStatuses = detectionStatuses,
        _chipRates = chipRates,
        _codeTaps = codeTaps,
        _codeFills = codeFills,
        _codeLengths = codeLengths,
        _pnOrders = pnOrders,
        _signalIds = signalIds,
        _baudRates = baudRates,
        _telemetryIds = telemetryIds,
        _constellationXpoints = constellationXpoints,
        _constellationYpoints = constellationYpoints;
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    final int? confidencesOffset = _confidences == null ? null
        : fbBuilder.writeList(_confidences!.map(fbBuilder.writeString).toList());
    final int? detectionStatusesOffset = _detectionStatuses == null ? null
        : fbBuilder.writeList(_detectionStatuses!.map(fbBuilder.writeString).toList());
    final int? chipRatesOffset = _chipRates == null ? null
        : fbBuilder.writeList(_chipRates!.map(fbBuilder.writeString).toList());
    final int? codeTapsOffset = _codeTaps == null ? null
        : fbBuilder.writeList(_codeTaps!.map(fbBuilder.writeString).toList());
    final int? codeFillsOffset = _codeFills == null ? null
        : fbBuilder.writeList(_codeFills!.map(fbBuilder.writeString).toList());
    final int? codeLengthsOffset = _codeLengths == null ? null
        : fbBuilder.writeList(_codeLengths!.map(fbBuilder.writeString).toList());
    final int? pnOrdersOffset = _pnOrders == null ? null
        : fbBuilder.writeList(_pnOrders!.map(fbBuilder.writeString).toList());
    final int? signalIdsOffset = _signalIds == null ? null
        : fbBuilder.writeList(_signalIds!.map(fbBuilder.writeString).toList());
    final int? baudRatesOffset = _baudRates == null ? null
        : fbBuilder.writeList(_baudRates!.map(fbBuilder.writeString).toList());
    final int? telemetryIdsOffset = _telemetryIds == null ? null
        : fbBuilder.writeList(_telemetryIds!.map(fbBuilder.writeString).toList());
    final int? constellationXpointsOffset = _constellationXpoints == null ? null
        : fbBuilder.writeList(_constellationXpoints!.map(fbBuilder.writeString).toList());
    final int? constellationYpointsOffset = _constellationYpoints == null ? null
        : fbBuilder.writeList(_constellationYpoints!.map(fbBuilder.writeString).toList());
    fbBuilder.startTable(98);
    ...
    fbBuilder.addOffset(66, tagsOffset);
    fbBuilder.addOffset(67, createdAtOffset);
    fbBuilder.addOffset(68, createdByOffset);
    fbBuilder.addFloat64(69, _noisePwrDensity);
    fbBuilder.addOffset(70, carrierStandardOffset);
    fbBuilder.addOffset(71, modulationOffset);
    fbBuilder.addInt32(72, _innerCodingRate);
    fbBuilder.addInt32(73, _outerCodingRate);
    fbBuilder.addOffset(74, transmitFilterTypeOffset);
    fbBuilder.addFloat64(75, _transmitFilterRollOff);
    fbBuilder.addFloat64(76, _symbolToNoiseRatio);
    fbBuilder.addFloat64(77, _bitErrorRate);
    fbBuilder.addOffset(78, origNetworkOffset);
    fbBuilder.addOffset(79, sourceDlOffset);
    fbBuilder.addOffset(80, onOrbitOffset);
    fbBuilder.addOffset(81, descriptorOffset);
    fbBuilder.addOffset(82, urlOffset);
    fbBuilder.addOffset(83, frequenciesOffset);
    fbBuilder.addOffset(84, powersOffset);
    fbBuilder.addOffset(85, snrsOffset);
    fbBuilder.addOffset(86, confidencesOffset);
    fbBuilder.addOffset(87, detectionStatusesOffset);
    fbBuilder.addOffset(88, chipRatesOffset);
    fbBuilder.addOffset(89, codeTapsOffset);
    fbBuilder.addOffset(90, codeFillsOffset);
    fbBuilder.addOffset(91, codeLengthsOffset);
    fbBuilder.addOffset(92, pnOrdersOffset);
    fbBuilder.addOffset(93, signalIdsOffset);
    fbBuilder.addOffset(94, baudRatesOffset);
    fbBuilder.addOffset(95, telemetryIdsOffset);
    fbBuilder.addOffset(96, constellationXpointsOffset);
    fbBuilder.addOffset(97, constellationYpointsOffset);
    return fbBuilder.endTable();
  }
