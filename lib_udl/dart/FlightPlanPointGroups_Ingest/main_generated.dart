...
class FlightPlanPointGroupsIngest {
  FlightPlanPointGroupsIngest._(this._bc, this._bcOffset);
  factory FlightPlanPointGroupsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<FlightPlanPointGroupsIngest> reader = _FlightPlanPointGroupsIngestReader();
...
class FlightPlanPointGroupsIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  FlightPlanPointGroupsIngestObjectBuilder({
