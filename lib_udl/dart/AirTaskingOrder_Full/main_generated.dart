...
class AirTaskingOrderFullDataModeEnum {
  final int value;
  const AirTaskingOrderFullDataModeEnum._(this.value);

  factory AirTaskingOrderFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirTaskingOrderFullDataModeEnum');
    }
    return result;
  }

  static AirTaskingOrderFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AirTaskingOrderFullDataModeEnum.fromValue(value);
  ...
  static const AirTaskingOrderFullDataModeEnum REAL = AirTaskingOrderFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AirTaskingOrderFullDataModeEnum TEST = AirTaskingOrderFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AirTaskingOrderFullDataModeEnum SIMULATED = AirTaskingOrderFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AirTaskingOrderFullDataModeEnum EXERCISE = AirTaskingOrderFullDataModeEnum._(3);
  static const Map<int, AirTaskingOrderFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AirTaskingOrderFullDataModeEnum> reader = _AirTaskingOrderFullDataModeEnumReader();

  @override
  String toString() {
    return 'AirTaskingOrderFullDataModeEnum{value: $value}';
  }
}

class _AirTaskingOrderFullDataModeEnumReader extends fb.Reader<AirTaskingOrderFullDataModeEnum> {
  const _AirTaskingOrderFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AirTaskingOrderFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      AirTaskingOrderFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AirTaskingOrderFull {
  AirTaskingOrderFull._(this._bc, this._bcOffset);
  factory AirTaskingOrderFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirTaskingOrderFull> reader = _AirTaskingOrderFullReader();
  ...
  AirTaskingOrderFullDataModeEnum get dataMode => AirTaskingOrderFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 46, 0));

  @override
  String toString() {
    return 'AirTaskingOrderFull{id: ${id}, classificationMarking: ${classificationMarking}, rawFileUri: ${rawFileUri}, opExerName: ${opExerName}, msgOriginator: ${msgOriginator}, msgSn: ${msgSn}, msgMonth: ${msgMonth}, msgQualifier: ${msgQualifier}, ackReqInd: ${ackReqInd}, ackUnitInstructions: ${ackUnitInstructions}, beginTs: ${beginTs}, endTs: ${endTs}, genText: ${genText}, acMsnTasking: ${acMsnTasking}, navalFltOps: ${navalFltOps}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, sourceDl: ${sourceDl}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _AirTaskingOrderFullReader extends fb.TableReader<AirTaskingOrderFull> {
  const _AirTaskingOrderFullReader();

  @override
  AirTaskingOrderFull createObject(fb.BufferContext bc, int offset) => 
    AirTaskingOrderFull._(bc, offset);
}

class AirTaskingOrderFullBuilder {
  AirTaskingOrderFullBuilder(this.fbBuilder);
  ...
  int addDataMode(AirTaskingOrderFullDataModeEnum? dataMode) {
...
class AirTaskingOrderFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AirTaskingOrderFullDataModeEnum? _dataMode;

  AirTaskingOrderFullObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    AirTaskingOrderFullDataModeEnum? dataMode,
  })
      : _id = id,
