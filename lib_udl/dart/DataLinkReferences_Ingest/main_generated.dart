...
class DataLinkReferencesIngest {
  DataLinkReferencesIngest._(this._bc, this._bcOffset);
  factory DataLinkReferencesIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DataLinkReferencesIngest> reader = _DataLinkReferencesIngestReader();
  ...
  @override
  String toString() {
    return 'DataLinkReferencesIngest{refSerialId: ${refSerialId}, refType: ${refType}, refOriginator: ${refOriginator}, refTs: ${refTs}, refSerialNum: ${refSerialNum}, refSpecialNotation: ${refSpecialNotation}, refSics: ${refSics}}';
  }
}

class _DataLinkReferencesIngestReader extends fb.TableReader<DataLinkReferencesIngest> {
  const _DataLinkReferencesIngestReader();

  @override
  DataLinkReferencesIngest createObject(fb.BufferContext bc, int offset) => 
    DataLinkReferencesIngest._(bc, offset);
}

class DataLinkReferencesIngestBuilder {
  DataLinkReferencesIngestBuilder(this.fbBuilder);
...
class DataLinkReferencesIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  DataLinkReferencesIngestObjectBuilder({
    String? refSerialId,
    String? refType,
