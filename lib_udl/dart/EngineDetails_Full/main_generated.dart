...
class EngineDetailsFullDataModeEnum {
  final int value;
  const EngineDetailsFullDataModeEnum._(this.value);

  factory EngineDetailsFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EngineDetailsFullDataModeEnum');
    }
    return result;
  }

  static EngineDetailsFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EngineDetailsFullDataModeEnum.fromValue(value);
  ...
  static const EngineDetailsFullDataModeEnum REAL = EngineDetailsFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EngineDetailsFullDataModeEnum TEST = EngineDetailsFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EngineDetailsFullDataModeEnum SIMULATED = EngineDetailsFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EngineDetailsFullDataModeEnum EXERCISE = EngineDetailsFullDataModeEnum._(3);
  static const Map<int, EngineDetailsFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EngineDetailsFullDataModeEnum> reader = _EngineDetailsFullDataModeEnumReader();

  @override
  String toString() {
    return 'EngineDetailsFullDataModeEnum{value: $value}';
  }
}

class _EngineDetailsFullDataModeEnumReader extends fb.Reader<EngineDetailsFullDataModeEnum> {
  const _EngineDetailsFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EngineDetailsFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      EngineDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class EngineDetailsFull {
  EngineDetailsFull._(this._bc, this._bcOffset);
  factory EngineDetailsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EngineDetailsFull> reader = _EngineDetailsFullReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  EngineDetailsFullDataModeEnum get dataMode => EngineDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 52, 0));
  ///  Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
  ///  Example: /// Example: ['PROVIDER_TAG1', 'PROVIDER_TAG2']
  ///  Constraints: No constraints specified.
  List<String>? get tags => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 54);

  @override
  String toString() {
    return 'EngineDetailsFull{id: ${id}, idEngine: ${idEngine}, classificationMarking: ${classificationMarking}, family: ${family}, cycleType: ${cycleType}, characteristicType: ${characteristicType}, manufacturerOrgId: ${manufacturerOrgId}, specificImpulse: ${specificImpulse}, burnTime: ${burnTime}, seaLevelThrust: ${seaLevelThrust}, vacuumThrust: ${vacuumThrust}, chamberPressure: ${chamberPressure}, nozzleExpansionRatio: ${nozzleExpansionRatio}, maxFirings: ${maxFirings}, propellant: ${propellant}, oxidizer: ${oxidizer}, notes: ${notes}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, tags: ${tags}}';
  }
}

class _EngineDetailsFullReader extends fb.TableReader<EngineDetailsFull> {
  const _EngineDetailsFullReader();

  @override
  EngineDetailsFull createObject(fb.BufferContext bc, int offset) => 
    EngineDetailsFull._(bc, offset);
}

class EngineDetailsFullBuilder {
  EngineDetailsFullBuilder(this.fbBuilder);
  ...
  int addDataMode(EngineDetailsFullDataModeEnum? dataMode) {
...
class EngineDetailsFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EngineDetailsFullDataModeEnum? _dataMode;
  final List<String>? _tags;

  EngineDetailsFullObjectBuilder({
    String? id,
    String? idEngine,
    ...
    String? origin,
    String? origNetwork,
    EngineDetailsFullDataModeEnum? dataMode,
    List<String>? tags,
  })
      : _id = id,
        _idEngine = idEngine,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(25, tagsOffset);
    return fbBuilder.endTable();
  }
