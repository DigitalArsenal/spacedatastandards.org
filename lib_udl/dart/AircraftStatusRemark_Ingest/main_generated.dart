...
class AircraftStatusRemarkIngestDataModeEnum {
  final int value;
  const AircraftStatusRemarkIngestDataModeEnum._(this.value);

  factory AircraftStatusRemarkIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AircraftStatusRemarkIngestDataModeEnum');
    }
    return result;
  }

  static AircraftStatusRemarkIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AircraftStatusRemarkIngestDataModeEnum.fromValue(value);
  ...
  static const AircraftStatusRemarkIngestDataModeEnum REAL = AircraftStatusRemarkIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AircraftStatusRemarkIngestDataModeEnum TEST = AircraftStatusRemarkIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AircraftStatusRemarkIngestDataModeEnum SIMULATED = AircraftStatusRemarkIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AircraftStatusRemarkIngestDataModeEnum EXERCISE = AircraftStatusRemarkIngestDataModeEnum._(3);
  static const Map<int, AircraftStatusRemarkIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AircraftStatusRemarkIngestDataModeEnum> reader = _AircraftStatusRemarkIngestDataModeEnumReader();

  @override
  String toString() {
    return 'AircraftStatusRemarkIngestDataModeEnum{value: $value}';
  }
}

class _AircraftStatusRemarkIngestDataModeEnumReader extends fb.Reader<AircraftStatusRemarkIngestDataModeEnum> {
  const _AircraftStatusRemarkIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AircraftStatusRemarkIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      AircraftStatusRemarkIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Properties and characteristics of a remark that is associated with an aircraft status.
class AircraftStatusRemarkIngest {
  AircraftStatusRemarkIngest._(this._bc, this._bcOffset);
  factory AircraftStatusRemarkIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AircraftStatusRemarkIngest> reader = _AircraftStatusRemarkIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  AircraftStatusRemarkIngestDataModeEnum get dataMode => AircraftStatusRemarkIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 34, 0));

  @override
  String toString() {
    return 'AircraftStatusRemarkIngest{id: ${id}, classificationMarking: ${classificationMarking}, idAircraftStatus: ${idAircraftStatus}, altRmkId: ${altRmkId}, name: ${name}, text: ${text}, timestamp: ${timestamp}, lastUpdatedBy: ${lastUpdatedBy}, lastUpdatedAt: ${lastUpdatedAt}, createdAt: ${createdAt}, createdBy: ${createdBy}, sourceDl: ${sourceDl}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _AircraftStatusRemarkIngestReader extends fb.TableReader<AircraftStatusRemarkIngest> {
  const _AircraftStatusRemarkIngestReader();

  @override
  AircraftStatusRemarkIngest createObject(fb.BufferContext bc, int offset) => 
    AircraftStatusRemarkIngest._(bc, offset);
}

class AircraftStatusRemarkIngestBuilder {
  AircraftStatusRemarkIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(AircraftStatusRemarkIngestDataModeEnum? dataMode) {
...
class AircraftStatusRemarkIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AircraftStatusRemarkIngestDataModeEnum? _dataMode;

  AircraftStatusRemarkIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    AircraftStatusRemarkIngestDataModeEnum? dataMode,
  })
      : _id = id,
