...
class LaunchSiteDetailsIngestDataModeEnum {
  final int value;
  const LaunchSiteDetailsIngestDataModeEnum._(this.value);

  factory LaunchSiteDetailsIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum LaunchSiteDetailsIngestDataModeEnum');
    }
    return result;
  }

  static LaunchSiteDetailsIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : LaunchSiteDetailsIngestDataModeEnum.fromValue(value);
  ...
  static const LaunchSiteDetailsIngestDataModeEnum REAL = LaunchSiteDetailsIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const LaunchSiteDetailsIngestDataModeEnum TEST = LaunchSiteDetailsIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const LaunchSiteDetailsIngestDataModeEnum SIMULATED = LaunchSiteDetailsIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const LaunchSiteDetailsIngestDataModeEnum EXERCISE = LaunchSiteDetailsIngestDataModeEnum._(3);
  static const Map<int, LaunchSiteDetailsIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<LaunchSiteDetailsIngestDataModeEnum> reader = _LaunchSiteDetailsIngestDataModeEnumReader();

  @override
  String toString() {
    return 'LaunchSiteDetailsIngestDataModeEnum{value: $value}';
  }
}

class _LaunchSiteDetailsIngestDataModeEnumReader extends fb.Reader<LaunchSiteDetailsIngestDataModeEnum> {
  const _LaunchSiteDetailsIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  LaunchSiteDetailsIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      LaunchSiteDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class LaunchSiteDetailsIngest {
  LaunchSiteDetailsIngest._(this._bc, this._bcOffset);
  factory LaunchSiteDetailsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LaunchSiteDetailsIngest> reader = _LaunchSiteDetailsIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  LaunchSiteDetailsIngestDataModeEnum get dataMode => LaunchSiteDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 28, 0));
  ...
  @override
  String toString() {
    return 'LaunchSiteDetailsIngest{id: ${id}, idLaunchSite: ${idLaunchSite}, classificationMarking: ${classificationMarking}, idLocation: ${idLocation}, launchGroup: ${launchGroup}, availableInclinations: ${availableInclinations}, description: ${description}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, location: ${location}}';
  }
}

class _LaunchSiteDetailsIngestReader extends fb.TableReader<LaunchSiteDetailsIngest> {
  const _LaunchSiteDetailsIngestReader();

  @override
  LaunchSiteDetailsIngest createObject(fb.BufferContext bc, int offset) => 
    LaunchSiteDetailsIngest._(bc, offset);
}

class LaunchSiteDetailsIngestBuilder {
  LaunchSiteDetailsIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(LaunchSiteDetailsIngestDataModeEnum? dataMode) {
...
class LaunchSiteDetailsIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final LaunchSiteDetailsIngestDataModeEnum? _dataMode;
  final String? _location;

  LaunchSiteDetailsIngestObjectBuilder({
    String? id,
    String? idLaunchSite,
    ...
    String? origin,
    String? origNetwork,
    LaunchSiteDetailsIngestDataModeEnum? dataMode,
    String? location,
  })
      : _id = id,
