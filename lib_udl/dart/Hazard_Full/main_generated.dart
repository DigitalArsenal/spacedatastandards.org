...
class HazardFullDataModeEnum {
  final int value;
  const HazardFullDataModeEnum._(this.value);

  factory HazardFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum HazardFullDataModeEnum');
    }
    return result;
  }

  static HazardFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : HazardFullDataModeEnum.fromValue(value);
  ...
  static const HazardFullDataModeEnum REAL = HazardFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const HazardFullDataModeEnum TEST = HazardFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const HazardFullDataModeEnum SIMULATED = HazardFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const HazardFullDataModeEnum EXERCISE = HazardFullDataModeEnum._(3);
  static const Map<int, HazardFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<HazardFullDataModeEnum> reader = _HazardFullDataModeEnumReader();

  @override
  String toString() {
    return 'HazardFullDataModeEnum{value: $value}';
  }
}

class _HazardFullDataModeEnumReader extends fb.Reader<HazardFullDataModeEnum> {
  const _HazardFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  HazardFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      HazardFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class HazardFull {
  HazardFull._(this._bc, this._bcOffset);
  factory HazardFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<HazardFull> reader = _HazardFullReader();
...
class HazardFullBuilder {
  ...
  int addDataMode(HazardFullDataModeEnum? dataMode) {
...
class HazardFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final HazardFullDataModeEnum? _dataMode;

  HazardFullObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    HazardFullDataModeEnum? dataMode,
  })
      : _id = id,
