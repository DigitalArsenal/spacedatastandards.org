...
class LaunchEventFullDataModeEnum {
  final int value;
  const LaunchEventFullDataModeEnum._(this.value);

  factory LaunchEventFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum LaunchEventFullDataModeEnum');
    }
    return result;
  }

  static LaunchEventFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : LaunchEventFullDataModeEnum.fromValue(value);
  ...
  static const LaunchEventFullDataModeEnum REAL = LaunchEventFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const LaunchEventFullDataModeEnum TEST = LaunchEventFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const LaunchEventFullDataModeEnum SIMULATED = LaunchEventFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const LaunchEventFullDataModeEnum EXERCISE = LaunchEventFullDataModeEnum._(3);
  static const Map<int, LaunchEventFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<LaunchEventFullDataModeEnum> reader = _LaunchEventFullDataModeEnumReader();

  @override
  String toString() {
    return 'LaunchEventFullDataModeEnum{value: $value}';
  }
}

class _LaunchEventFullDataModeEnumReader extends fb.Reader<LaunchEventFullDataModeEnum> {
  const _LaunchEventFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  LaunchEventFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      LaunchEventFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Information on known launch events.
class LaunchEventFull {
  LaunchEventFull._(this._bc, this._bcOffset);
  factory LaunchEventFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LaunchEventFull> reader = _LaunchEventFullReader();
  ...
  LaunchEventFullDataModeEnum get dataMode => LaunchEventFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 38, 0));
  ...
  ///  Constraints: No constraints specified.
  String? get onOrbit => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 42);
  ///  Satellite/catalog number of the target on-orbit object.
  ///  Example: /// Example: 12
  ///  Constraints: No constraints specified.
  int get satNo => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 44, 0);

  @override
  String toString() {
    return 'LaunchEventFull{id: ${id}, idOnOrbit: ${idOnOrbit}, origObjectId: ${origObjectId}, classificationMarking: ${classificationMarking}, derivedFrom: ${derivedFrom}, declassificationDate: ${declassificationDate}, declassificationString: ${declassificationString}, msgCreateDate: ${msgCreateDate}, launchFailureCode: ${launchFailureCode}, launchDate: ${launchDate}, beNumber: ${beNumber}, oSuffix: ${oSuffix}, launchFacilityName: ${launchFacilityName}, createdAt: ${createdAt}, createdBy: ${createdBy}, origin: ${origin}, source: ${source}, dataMode: ${dataMode}, origNetwork: ${origNetwork}, onOrbit: ${onOrbit}, satNo: ${satNo}}';
  }
}

class _LaunchEventFullReader extends fb.TableReader<LaunchEventFull> {
  const _LaunchEventFullReader();

  @override
  LaunchEventFull createObject(fb.BufferContext bc, int offset) => 
    LaunchEventFull._(bc, offset);
}

class LaunchEventFullBuilder {
  LaunchEventFullBuilder(this.fbBuilder);
  ...
  int addDataMode(LaunchEventFullDataModeEnum? dataMode) {
...
class LaunchEventFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final LaunchEventFullDataModeEnum? _dataMode;
  final String? _origNetwork;
  final String? _onOrbit;
  final int? _satNo;

  LaunchEventFullObjectBuilder({
    String? id,
    String? idOnOrbit,
    String? origObjectId,
    ...
    String? origin,
    String? source,
    LaunchEventFullDataModeEnum? dataMode,
    String? origNetwork,
    String? onOrbit,
    int? satNo,
  })
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(19, onOrbitOffset);
    fbBuilder.addInt32(20, _satNo);
    return fbBuilder.endTable();
  }
