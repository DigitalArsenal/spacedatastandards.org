...
class SigActIngestDataModeEnum {
  final int value;
  const SigActIngestDataModeEnum._(this.value);

  factory SigActIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SigActIngestDataModeEnum');
    }
    return result;
  }

  static SigActIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SigActIngestDataModeEnum.fromValue(value);
  ...
  static const SigActIngestDataModeEnum REAL = SigActIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SigActIngestDataModeEnum TEST = SigActIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SigActIngestDataModeEnum SIMULATED = SigActIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SigActIngestDataModeEnum EXERCISE = SigActIngestDataModeEnum._(3);
  static const Map<int, SigActIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SigActIngestDataModeEnum> reader = _SigActIngestDataModeEnumReader();

  @override
  String toString() {
    return 'SigActIngestDataModeEnum{value: $value}';
  }
}

class _SigActIngestDataModeEnumReader extends fb.Reader<SigActIngestDataModeEnum> {
  const _SigActIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SigActIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      SigActIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class SigActIngest {
  SigActIngest._(this._bc, this._bcOffset);
  factory SigActIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SigActIngest> reader = _SigActIngestReader();
  ...
  SigActIngestDataModeEnum get dataMode => SigActIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 166, 0));
...
class SigActIngestBuilder {
  ...
  int addDataMode(SigActIngestDataModeEnum? dataMode) {
...
class SigActIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SigActIngestDataModeEnum? _dataMode;
  final String? _origNetwork;

  SigActIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    SigActIngestDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
