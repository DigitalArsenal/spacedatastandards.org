...
class EvacTreatmentAbridged {
  EvacTreatmentAbridged._(this._bc, this._bcOffset);
  factory EvacTreatmentAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EvacTreatmentAbridged> reader = _EvacTreatmentAbridgedReader();
  ...
  @override
  String toString() {
    return 'EvacTreatmentAbridged{type: ${type}, bodyPart: ${bodyPart}, time: ${time}, comments: ${comments}}';
  }
}

class _EvacTreatmentAbridgedReader extends fb.TableReader<EvacTreatmentAbridged> {
  const _EvacTreatmentAbridgedReader();

  @override
  EvacTreatmentAbridged createObject(fb.BufferContext bc, int offset) => 
    EvacTreatmentAbridged._(bc, offset);
}

class EvacTreatmentAbridgedBuilder {
  EvacTreatmentAbridgedBuilder(this.fbBuilder);
...
class EvacTreatmentAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _type;
  final String? _bodyPart;
  final String? _time;
  final String? _comments;

  EvacTreatmentAbridgedObjectBuilder({
    String? type,
    String? bodyPart,
    String? time,
    String? comments,
