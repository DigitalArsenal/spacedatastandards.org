...
class AirfieldStatusFullDataModeEnum {
  final int value;
  const AirfieldStatusFullDataModeEnum._(this.value);

  factory AirfieldStatusFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirfieldStatusFullDataModeEnum');
    }
    return result;
  }

  static AirfieldStatusFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AirfieldStatusFullDataModeEnum.fromValue(value);
  ...
  static const AirfieldStatusFullDataModeEnum REAL = AirfieldStatusFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AirfieldStatusFullDataModeEnum TEST = AirfieldStatusFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AirfieldStatusFullDataModeEnum SIMULATED = AirfieldStatusFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AirfieldStatusFullDataModeEnum EXERCISE = AirfieldStatusFullDataModeEnum._(3);
  static const Map<int, AirfieldStatusFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AirfieldStatusFullDataModeEnum> reader = _AirfieldStatusFullDataModeEnumReader();

  @override
  String toString() {
    return 'AirfieldStatusFullDataModeEnum{value: $value}';
  }
}

class _AirfieldStatusFullDataModeEnumReader extends fb.Reader<AirfieldStatusFullDataModeEnum> {
  const _AirfieldStatusFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AirfieldStatusFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      AirfieldStatusFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// The airfield status contains dynamic data of an airfield's capabilities.
class AirfieldStatusFull {
  AirfieldStatusFull._(this._bc, this._bcOffset);
  factory AirfieldStatusFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirfieldStatusFull> reader = _AirfieldStatusFullReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  AirfieldStatusFullDataModeEnum get dataMode => AirfieldStatusFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 78, 0));

  @override
  String toString() {
    return 'AirfieldStatusFull{id: ${id}, classificationMarking: ${classificationMarking}, idAirfield: ${idAirfield}, altAirfieldId: ${altAirfieldId}, passengerServiceMog: ${passengerServiceMog}, fleetServiceMog: ${fleetServiceMog}, cargoMog: ${cargoMog}, fuelMog: ${fuelMog}, fuelTypes: ${fuelTypes}, fuelQtys: ${fuelQtys}, mxMog: ${mxMog}, operatingMog: ${operatingMog}, numCog: ${numCog}, wideWorkingMog: ${wideWorkingMog}, wideParkingMog: ${wideParkingMog}, narrowWorkingMog: ${narrowWorkingMog}, narrowParkingMog: ${narrowParkingMog}, mheTypes: ${mheTypes}, mheQtys: ${mheQtys}, medCap: ${medCap}, arffCat: ${arffCat}, gseTime: ${gseTime}, priRwyNum: ${priRwyNum}, rwyCondReading: ${rwyCondReading}, rwyFrictionFactor: ${rwyFrictionFactor}, rwyMarkings: ${rwyMarkings}, message: ${message}, priFreq: ${priFreq}, slotTypesReq: ${slotTypesReq}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, sourceDl: ${sourceDl}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _AirfieldStatusFullReader extends fb.TableReader<AirfieldStatusFull> {
  const _AirfieldStatusFullReader();

  @override
  AirfieldStatusFull createObject(fb.BufferContext bc, int offset) => 
    AirfieldStatusFull._(bc, offset);
}

class AirfieldStatusFullBuilder {
  AirfieldStatusFullBuilder(this.fbBuilder);
  ...
  int addDataMode(AirfieldStatusFullDataModeEnum? dataMode) {
...
class AirfieldStatusFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AirfieldStatusFullDataModeEnum? _dataMode;

  AirfieldStatusFullObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    AirfieldStatusFullDataModeEnum? dataMode,
  })
      : _id = id,
