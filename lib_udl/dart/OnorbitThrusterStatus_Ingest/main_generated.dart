...
class OnorbitThrusterStatusIngestDataModeEnum {
  final int value;
  const OnorbitThrusterStatusIngestDataModeEnum._(this.value);

  factory OnorbitThrusterStatusIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OnorbitThrusterStatusIngestDataModeEnum');
    }
    return result;
  }

  static OnorbitThrusterStatusIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OnorbitThrusterStatusIngestDataModeEnum.fromValue(value);
  ...
  static const OnorbitThrusterStatusIngestDataModeEnum REAL = OnorbitThrusterStatusIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OnorbitThrusterStatusIngestDataModeEnum TEST = OnorbitThrusterStatusIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OnorbitThrusterStatusIngestDataModeEnum SIMULATED = OnorbitThrusterStatusIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OnorbitThrusterStatusIngestDataModeEnum EXERCISE = OnorbitThrusterStatusIngestDataModeEnum._(3);
  static const Map<int, OnorbitThrusterStatusIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OnorbitThrusterStatusIngestDataModeEnum> reader = _OnorbitThrusterStatusIngestDataModeEnumReader();

  @override
  String toString() {
    return 'OnorbitThrusterStatusIngestDataModeEnum{value: $value}';
  }
}

class _OnorbitThrusterStatusIngestDataModeEnumReader extends fb.Reader<OnorbitThrusterStatusIngestDataModeEnum> {
  const _OnorbitThrusterStatusIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OnorbitThrusterStatusIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      OnorbitThrusterStatusIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Status information for OnorbitThruster objects.
class OnorbitThrusterStatusIngest {
  OnorbitThrusterStatusIngest._(this._bc, this._bcOffset);
  factory OnorbitThrusterStatusIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OnorbitThrusterStatusIngest> reader = _OnorbitThrusterStatusIngestReader();
  ...
  OnorbitThrusterStatusIngestDataModeEnum get dataMode => OnorbitThrusterStatusIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 50, 0));

  @override
  String toString() {
    return 'OnorbitThrusterStatusIngest{id: ${id}, classificationMarking: ${classificationMarking}, idOnorbitThruster: ${idOnorbitThruster}, name: ${name}, statusTime: ${statusTime}, propMassMin: ${propMassMin}, propMassAvg: ${propMassAvg}, propMassMedian: ${propMassMedian}, propMassMax: ${propMassMax}, fuelMass: ${fuelMass}, fuelMassUnc: ${fuelMassUnc}, totalDeltaV: ${totalDeltaV}, minDeltaV: ${minDeltaV}, estDeltaV: ${estDeltaV}, maxDeltaV: ${maxDeltaV}, thrustMax: ${thrustMax}, isp: ${isp}, operational: ${operational}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _OnorbitThrusterStatusIngestReader extends fb.TableReader<OnorbitThrusterStatusIngest> {
  const _OnorbitThrusterStatusIngestReader();

  @override
  OnorbitThrusterStatusIngest createObject(fb.BufferContext bc, int offset) => 
    OnorbitThrusterStatusIngest._(bc, offset);
}

class OnorbitThrusterStatusIngestBuilder {
  OnorbitThrusterStatusIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(OnorbitThrusterStatusIngestDataModeEnum? dataMode) {
...
class OnorbitThrusterStatusIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final OnorbitThrusterStatusIngestDataModeEnum? _dataMode;

  OnorbitThrusterStatusIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    OnorbitThrusterStatusIngestDataModeEnum? dataMode,
  })
      : _id = id,
