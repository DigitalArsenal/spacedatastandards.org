...
class OrbitDeterminationIngestDataModeEnum {
  final int value;
  const OrbitDeterminationIngestDataModeEnum._(this.value);

  factory OrbitDeterminationIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OrbitDeterminationIngestDataModeEnum');
    }
    return result;
  }

  static OrbitDeterminationIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OrbitDeterminationIngestDataModeEnum.fromValue(value);
  ...
  static const OrbitDeterminationIngestDataModeEnum REAL = OrbitDeterminationIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OrbitDeterminationIngestDataModeEnum TEST = OrbitDeterminationIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OrbitDeterminationIngestDataModeEnum SIMULATED = OrbitDeterminationIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OrbitDeterminationIngestDataModeEnum EXERCISE = OrbitDeterminationIngestDataModeEnum._(3);
  static const Map<int, OrbitDeterminationIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OrbitDeterminationIngestDataModeEnum> reader = _OrbitDeterminationIngestDataModeEnumReader();

  @override
  String toString() {
    return 'OrbitDeterminationIngestDataModeEnum{value: $value}';
  }
}

class _OrbitDeterminationIngestDataModeEnumReader extends fb.Reader<OrbitDeterminationIngestDataModeEnum> {
  const _OrbitDeterminationIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OrbitDeterminationIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      OrbitDeterminationIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class OrbitDeterminationIngest {
  OrbitDeterminationIngest._(this._bc, this._bcOffset);
  factory OrbitDeterminationIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OrbitDeterminationIngest> reader = _OrbitDeterminationIngestReader();
...
class OrbitDeterminationIngestBuilder {
  ...
  int addDataMode(OrbitDeterminationIngestDataModeEnum? dataMode) {
...
class OrbitDeterminationIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final OrbitDeterminationIngestDataModeEnum? _dataMode;

  OrbitDeterminationIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    OrbitDeterminationIngestDataModeEnum? dataMode,
  })
      : _id = id,
