...
class AttitudeSetFullDataModeEnum {
  final int value;
  const AttitudeSetFullDataModeEnum._(this.value);

  factory AttitudeSetFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AttitudeSetFullDataModeEnum');
    }
    return result;
  }

  static AttitudeSetFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AttitudeSetFullDataModeEnum.fromValue(value);
  ...
  static const AttitudeSetFullDataModeEnum REAL = AttitudeSetFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AttitudeSetFullDataModeEnum TEST = AttitudeSetFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AttitudeSetFullDataModeEnum SIMULATED = AttitudeSetFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AttitudeSetFullDataModeEnum EXERCISE = AttitudeSetFullDataModeEnum._(3);
  static const Map<int, AttitudeSetFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AttitudeSetFullDataModeEnum> reader = _AttitudeSetFullDataModeEnumReader();

  @override
  String toString() {
    return 'AttitudeSetFullDataModeEnum{value: $value}';
  }
}

class _AttitudeSetFullDataModeEnumReader extends fb.Reader<AttitudeSetFullDataModeEnum> {
  const _AttitudeSetFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AttitudeSetFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      AttitudeSetFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AttitudeSetFull {
  AttitudeSetFull._(this._bc, this._bcOffset);
  factory AttitudeSetFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AttitudeSetFull> reader = _AttitudeSetFullReader();
  ...
  AttitudeSetFullDataModeEnum get dataMode => AttitudeSetFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 58, 0));
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  String? get onOrbit => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 62);

  @override
  String toString() {
    return 'AttitudeSetFull{id: ${id}, classificationMarking: ${classificationMarking}, idOnOrbit: ${idOnOrbit}, satNo: ${satNo}, origObjectId: ${origObjectId}, type: ${type}, esId: ${esId}, asRef: ${asRef}, idSensor: ${idSensor}, origSensorId: ${origSensorId}, startTime: ${startTime}, endTime: ${endTime}, frame1: ${frame1}, frame2: ${frame2}, numPoints: ${numPoints}, stepSize: ${stepSize}, precAngleInit: ${precAngleInit}, spinAngleInit: ${spinAngleInit}, eulerRotSeq: ${eulerRotSeq}, attitudeList: ${attitudeList}, interpolator: ${interpolator}, interpolatorDegree: ${interpolatorDegree}, notes: ${notes}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, origNetwork: ${origNetwork}, onOrbit: ${onOrbit}}';
  }
}

class _AttitudeSetFullReader extends fb.TableReader<AttitudeSetFull> {
  const _AttitudeSetFullReader();

  @override
  AttitudeSetFull createObject(fb.BufferContext bc, int offset) => 
    AttitudeSetFull._(bc, offset);
}

class AttitudeSetFullBuilder {
  AttitudeSetFullBuilder(this.fbBuilder);
  ...
  int addDataMode(AttitudeSetFullDataModeEnum? dataMode) {
...
class AttitudeSetFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AttitudeSetFullDataModeEnum? _dataMode;
  final String? _origNetwork;
  final String? _onOrbit;

  AttitudeSetFullObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    AttitudeSetFullDataModeEnum? dataMode,
    String? origNetwork,
    String? onOrbit,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(29, onOrbitOffset);
    return fbBuilder.endTable();
  }
