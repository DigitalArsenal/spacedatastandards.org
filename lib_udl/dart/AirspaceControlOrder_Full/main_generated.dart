...
class AirspaceControlOrderFullDataModeEnum {
  final int value;
  const AirspaceControlOrderFullDataModeEnum._(this.value);

  factory AirspaceControlOrderFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirspaceControlOrderFullDataModeEnum');
    }
    return result;
  }

  static AirspaceControlOrderFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AirspaceControlOrderFullDataModeEnum.fromValue(value);
  ...
  static const AirspaceControlOrderFullDataModeEnum REAL = AirspaceControlOrderFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AirspaceControlOrderFullDataModeEnum TEST = AirspaceControlOrderFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AirspaceControlOrderFullDataModeEnum SIMULATED = AirspaceControlOrderFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AirspaceControlOrderFullDataModeEnum EXERCISE = AirspaceControlOrderFullDataModeEnum._(3);
  static const Map<int, AirspaceControlOrderFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AirspaceControlOrderFullDataModeEnum> reader = _AirspaceControlOrderFullDataModeEnumReader();

  @override
  String toString() {
    return 'AirspaceControlOrderFullDataModeEnum{value: $value}';
  }
}

class _AirspaceControlOrderFullDataModeEnumReader extends fb.Reader<AirspaceControlOrderFullDataModeEnum> {
  const _AirspaceControlOrderFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AirspaceControlOrderFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      AirspaceControlOrderFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AirspaceControlOrderFull {
  AirspaceControlOrderFull._(this._bc, this._bcOffset);
  factory AirspaceControlOrderFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirspaceControlOrderFull> reader = _AirspaceControlOrderFullReader();
...
class AirspaceControlOrderFullBuilder {
  ...
  int addDataMode(AirspaceControlOrderFullDataModeEnum? dataMode) {
...
class AirspaceControlOrderFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AirspaceControlOrderFullDataModeEnum? _dataMode;

  AirspaceControlOrderFullObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    AirspaceControlOrderFullDataModeEnum? dataMode,
  })
      : _id = id,
