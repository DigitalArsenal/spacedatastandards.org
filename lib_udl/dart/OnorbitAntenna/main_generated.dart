...
class OnorbitAntennaDataModeEnum {
  final int value;
  const OnorbitAntennaDataModeEnum._(this.value);

  factory OnorbitAntennaDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OnorbitAntennaDataModeEnum');
    }
    return result;
  }

  static OnorbitAntennaDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OnorbitAntennaDataModeEnum.fromValue(value);
  ...
  static const OnorbitAntennaDataModeEnum REAL = OnorbitAntennaDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OnorbitAntennaDataModeEnum TEST = OnorbitAntennaDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OnorbitAntennaDataModeEnum SIMULATED = OnorbitAntennaDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OnorbitAntennaDataModeEnum EXERCISE = OnorbitAntennaDataModeEnum._(3);
  static const Map<int, OnorbitAntennaDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OnorbitAntennaDataModeEnum> reader = _OnorbitAntennaDataModeEnumReader();

  @override
  String toString() {
    return 'OnorbitAntennaDataModeEnum{value: $value}';
  }
}

class _OnorbitAntennaDataModeEnumReader extends fb.Reader<OnorbitAntennaDataModeEnum> {
  const _OnorbitAntennaDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OnorbitAntennaDataModeEnum read(fb.BufferContext bc, int offset) =>
      OnorbitAntennaDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Read-only collection of antennas on this on-orbit object.
class OnorbitAntenna {
  OnorbitAntenna._(this._bc, this._bcOffset);
  factory OnorbitAntenna(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OnorbitAntenna> reader = _OnorbitAntennaReader();
  ...
  OnorbitAntennaDataModeEnum get dataMode => OnorbitAntennaDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 24, 0));
  ...
  @override
  String toString() {
    return 'OnorbitAntenna{id: ${id}, idOnOrbit: ${idOnOrbit}, idAntenna: ${idAntenna}, classificationMarking: ${classificationMarking}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, antenna: ${antenna}, origNetwork: ${origNetwork}}';
  }
}

class _OnorbitAntennaReader extends fb.TableReader<OnorbitAntenna> {
  const _OnorbitAntennaReader();

  @override
  OnorbitAntenna createObject(fb.BufferContext bc, int offset) => 
    OnorbitAntenna._(bc, offset);
}

class OnorbitAntennaBuilder {
  OnorbitAntennaBuilder(this.fbBuilder);
  ...
  int addDataMode(OnorbitAntennaDataModeEnum? dataMode) {
...
class OnorbitAntennaObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final OnorbitAntennaDataModeEnum? _dataMode;
  final String? _antenna;
  final String? _origNetwork;

  OnorbitAntennaObjectBuilder({
    String? id,
    String? idOnOrbit,
    String? idAntenna,
    ...
    String? source,
    String? origin,
    OnorbitAntennaDataModeEnum? dataMode,
    String? antenna,
    String? origNetwork,
  })
      : _id = id,
