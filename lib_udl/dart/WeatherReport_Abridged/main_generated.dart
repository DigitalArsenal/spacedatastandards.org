...
class WeatherReportAbridgedDataModeEnum {
  final int value;
  const WeatherReportAbridgedDataModeEnum._(this.value);

  factory WeatherReportAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum WeatherReportAbridgedDataModeEnum');
    }
    return result;
  }

  static WeatherReportAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : WeatherReportAbridgedDataModeEnum.fromValue(value);
  ...
  static const WeatherReportAbridgedDataModeEnum REAL = WeatherReportAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const WeatherReportAbridgedDataModeEnum TEST = WeatherReportAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const WeatherReportAbridgedDataModeEnum SIMULATED = WeatherReportAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const WeatherReportAbridgedDataModeEnum EXERCISE = WeatherReportAbridgedDataModeEnum._(3);
  static const Map<int, WeatherReportAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<WeatherReportAbridgedDataModeEnum> reader = _WeatherReportAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'WeatherReportAbridgedDataModeEnum{value: $value}';
  }
}

class _WeatherReportAbridgedDataModeEnumReader extends fb.Reader<WeatherReportAbridgedDataModeEnum> {
  const _WeatherReportAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  WeatherReportAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      WeatherReportAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class WeatherReportAbridged {
  WeatherReportAbridged._(this._bc, this._bcOffset);
  factory WeatherReportAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<WeatherReportAbridged> reader = _WeatherReportAbridgedReader();
  ...
  ///  Constraints: No constraints specified.
  String? get atext => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 44);
  ///  Geographical region or polygon (lat/lon pairs), as depicted by the GeoJSON representation of the geometry/geography, of the image as projected on the ground. GeoJSON Reference: https://geojson.org/. Ignored if included with a POST or PUT request that also specifies a valid 'area' or 'atext' field.
  ///  Example: /// Example: {"type":"Polygon","coordinates":[[[67.3291113966927,26.156175339112],[67.2580009640721,26.091022064271],[67.1795862381682,26.6637992964562],[67.2501237475598,26.730115808233],[67.3291113966927,26.156175339112]]]}
  ///  Constraints: No constraints specified.
  String? get agjson => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 46);
  ///  Type of region as projected on the ground.
  ///  Example: /// Example: ST_Polygon
  ///  Constraints: Minimum length = 0, Maximum length = 128
  String? get atype => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 48);
  ///  Number of dimensions of the geometry depicted by region.
  ///  Example: /// Example: 2
  ///  Constraints: No constraints specified.
  int get andims => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 50, 0);
  ///  Geographical spatial_ref_sys for region.
  ///  Example: /// Example: 4326
  ///  Constraints: No constraints specified.
  int get asrid => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 52, 0);
  ///  Expresses the speed of the wind in meters/second.
  ///  Example: /// Example: 1.23
  ///  Constraints: No constraints specified.
  double get windSpd => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 54, 0.0);
  ///  Average wind speed over a 1 minute period, in meters/second.
  ///  Example: /// Example: 12.1
  ///  Constraints: No constraints specified.
  double get windSpdAvg => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 56, 0.0);
  ///  Expresses the max gust speed of the wind, in meters/second.
  ///  Example: /// Example: 10.23
  ///  Constraints: No constraints specified.
  double get windGust => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 58, 0.0);
  ///  Expresses the max gust speed of the wind recorded in a 10 minute period, in meters/second.
  ///  Example: /// Example: 13.2
  ///  Constraints: No constraints specified.
  double get windGust10 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 60, 0.0);
  ///  The change in wind speed between two different altitudes divided by the vertical distance between them, in units of 1/sec.
  ///  Example: /// Example: 3.8
  ///  Constraints: No constraints specified.
  double get vshear => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 62, 0.0);
  ...
  ///  Example: /// Example: 3.8
  ///  Constraints: No constraints specified.
  double get hshear => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 64, 0.0);
  ...
  ///  Constraints: No constraints specified.
  double get radVel => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 66, 0.0);
  ...
  ///  Example: /// Example: 4.4
  ///  Constraints: No constraints specified.
  double get radVelBeam1 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 68, 0.0);
  ...
  ///  Example: /// Example: -0.2
  ///  Constraints: No constraints specified.
  double get radVelBeam2 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 70, 0.0);
  ...
  ///  Example: /// Example: -0.2
  ///  Constraints: No constraints specified.
  double get radVelBeam3 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 72, 0.0);
  ...
  ///  Constraints: No constraints specified.
  double get radVelBeam4 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 74, 0.0);
  ...
  ///  Example: /// Example: 4.1
  ///  Constraints: No constraints specified.
  double get radVelBeam5 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 76, 0.0);
  ///  Direction the wind is blowing, in degrees clockwise from true north.
  ///  Example: /// Example: 75.1234
  ///  Constraints: No constraints specified.
  double get windDir => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 78, 0.0);
  ///  Average wind direction over a 1 minute period, in degrees clockwise from true north.
  ///  Example: /// Example: 57.1
  ///  Constraints: No constraints specified.
  double get windDirAvg => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 80, 0.0);
  ...
  ///  Constraints: No constraints specified.
  double get windDirPeak => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 82, 0.0);
  ...
  ///  Constraints: No constraints specified.
  double get windDirPeak10 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 84, 0.0);
  ///  The perceived temperature in degrees C.
  ///  Example: /// Example: 15.6
  ///  Constraints: No constraints specified.
  double get windChill => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 86, 0.0);
  ///  The difference in wind direction recorded over a period of time, in degrees.
  ///  Example: /// Example: 9.1
  ///  Constraints: No constraints specified.
  double get dirDev => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 88, 0.0);
  ///  Boolean describing whether or not the wind direction and/or speed is variable.
  ///  Example: /// Example: False
  ///  Constraints: No constraints specified.
  bool get windVar => const fb.BoolReader().vTableGet(_bc, _bcOffset, 90, false);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get windCov => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 92);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get cloudCover => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 94);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get cloudHght => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 96);
  ...
  String? get actWeather => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 98);
  ...
  ///  Example: /// Example: NO STATEMENT
  ///  Constraints: Minimum length = 0, Maximum length = 32
  String? get weatherDesc => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 100);
  ...
  ///  Example: /// Example: NO STATEMENT
  ///  Constraints: Minimum length = 0, Maximum length = 32
  String? get weatherInt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 102);
  ...
  String? get rawMetar => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 104);
  ...
  String? get rawTaf => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 106);
  ///  Altimeter set to read zero at mean sea level in kilopascals.
  ///  Example: /// Example: 1234.456
  ///  Constraints: No constraints specified.
  double get qnh => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 108, 0.0);
  ///  Visual distance in meters.
  ///  Example: /// Example: 1234.456
  ///  Constraints: No constraints specified.
  double get visibility => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 110, 0.0);
  ///  The measurement of air temperature in degrees C.
  ///  Example: /// Example: 23.45
  ///  Constraints: No constraints specified.
  double get temperature => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 112, 0.0);
  ///  The measurement of soil temperature in degrees C.
  ///  Example: /// Example: 22.4
  ///  Constraints: No constraints specified.
  double get soilTemp => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 114, 0.0);
  ///  The measurement of air pressure in the atmosphere in kilopascals.
  ///  Example: /// Example: 101.2
  ///  Constraints: No constraints specified.
  double get barPress => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 116, 0.0);
  ///  The speed at which water is being applied to a specific area in millimeters per hour.
  ///  Example: /// Example: 3.4
  ///  Constraints: No constraints specified.
  double get precipRate => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 118, 0.0);
  ///  The amount of rain that has fallen in the past hour, in centimeters.
  ///  Example: /// Example: 1.2
  ///  Constraints: No constraints specified.
  double get rainHour => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 120, 0.0);
  ...
  ///  Example: /// Example: 1234.456
  ///  Constraints: No constraints specified.
  double get solarRad => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 122, 0.0);
  ...
  ///  Constraints: No constraints specified.
  double get difRad => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 124, 0.0);
  ...
  ///  Constraints: No constraints specified.
  double get refRad => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 126, 0.0);
  ...
  ///  Constraints: No constraints specified.
  double get senlat => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 128, 0.0);
  ...
  ///  Constraints: No constraints specified.
  double get senlon => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 130, 0.0);
  ///  Sensor altitude at obTime in km. This includes pilot reports or other means of weather observation.
  ///  Example: /// Example: 1.23
  ///  Constraints: No constraints specified.
  double get senalt => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 132, 0.0);
  ///  The temperature at which air is saturated with water vapor, in degrees C.
  ///  Example: /// Example: 15.6
  ///  Constraints: No constraints specified.
  double get dewPoint => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 134, 0.0);
  ///  The percentage of water vapor in the atmosphere.
  ///  Example: /// Example: 34.456
  ///  Constraints: No constraints specified.
  double get relHumidity => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 136, 0.0);
  ///  An indication of how much the atmosphere refracts light.
  ///  Example: /// Example: 1.1
  ///  Constraints: No constraints specified.
  double get indexRefraction => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 138, 0.0);
  ///  The volumetric percentage of soil water contained in a given volume of soil.
  ///  Example: /// Example: 3.5
  ///  Constraints: No constraints specified.
  double get soilMoisture => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 140, 0.0);
  ...
  ///  Example: /// Example: NO STATEMENT
  ///  Constraints: Minimum length = 0, Maximum length = 32
  String? get surroundingWeather => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 142);
  ...
  ///  Example: /// Example: NO STATEMENT
  ///  Constraints: Minimum length = 0, Maximum length = 32
  String? get weatherAmp => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 144);
  ///  Reports the lowest altitude at which contrails are occurring, in meters.
  ///  Example: /// Example: 123.123
  ///  Constraints: No constraints specified.
  double get contrailHghtLower => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 146, 0.0);
  ///  Reports the highest altitude at which contrails are occurring, in meters.
  ///  Example: /// Example: 123.123
  ///  Constraints: No constraints specified.
  double get contrailHghtUpper => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 148, 0.0);
  ///  Reports the highest altitude at which icing or freezing rain is occurring, in meters.
  ///  Example: /// Example: 123.123
  ///  Constraints: No constraints specified.
  double get icingUpperLimit => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 150, 0.0);
  ///  Reports the lowest altitude at which icing or freezing rain is occurring, in meters.
  ///  Example: /// Example: 123.123
  ///  Constraints: No constraints specified.
  double get icingLowerLimit => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 152, 0.0);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 32
  String? get enRouteWeather => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 154);
  ///  Flag indicating detection of a cloud-to-cloud lightning event.
  ///  Example: /// Example: True
  ///  Constraints: No constraints specified.
  bool get ccEvent => const fb.BoolReader().vTableGet(_bc, _bcOffset, 156, false);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get srcTyps => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 158);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get srcIds => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 160);
  ...
  ///  Constraints: No constraints specified.
  String? get createdAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 164);
  ///  Application user who created the row in the database.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 1, Maximum length = 64
  String? get createdBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 166);
  ///  Source of the data.
  ///  Example: /// Example: Bluestaq
  ///  Constraints: Minimum length = 1, Maximum length = 36
  String? get source => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 168);
  ///  Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
  ///  Example: /// Example: THIRD_PARTY_DATASOURCE
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get origin => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 170);
...
class WeatherReportAbridgedBuilder {
  ...
  int addAndims(int? andims) {
    fbBuilder.addInt32(23, andims);
    return fbBuilder.offset;
  }
  int addAsrid(int? asrid) {
    fbBuilder.addInt32(24, asrid);
    return fbBuilder.offset;
  }
  int addWindSpd(double? windSpd) {
    fbBuilder.addFloat64(25, windSpd);
    return fbBuilder.offset;
  }
  int addWindSpdAvg(double? windSpdAvg) {
    fbBuilder.addFloat64(26, windSpdAvg);
    return fbBuilder.offset;
  }
  int addWindGust(double? windGust) {
    fbBuilder.addFloat64(27, windGust);
    return fbBuilder.offset;
  }
  int addWindGust10(double? windGust10) {
    fbBuilder.addFloat64(28, windGust10);
    return fbBuilder.offset;
  }
  int addVshear(double? vshear) {
    fbBuilder.addFloat64(29, vshear);
    return fbBuilder.offset;
  }
  int addHshear(double? hshear) {
    fbBuilder.addFloat64(30, hshear);
    return fbBuilder.offset;
  }
  int addRadVel(double? radVel) {
    fbBuilder.addFloat64(31, radVel);
    return fbBuilder.offset;
  }
  int addRadVelBeam1(double? radVelBeam1) {
    fbBuilder.addFloat64(32, radVelBeam1);
    return fbBuilder.offset;
  }
  int addRadVelBeam2(double? radVelBeam2) {
    fbBuilder.addFloat64(33, radVelBeam2);
    return fbBuilder.offset;
  }
  int addRadVelBeam3(double? radVelBeam3) {
    fbBuilder.addFloat64(34, radVelBeam3);
    return fbBuilder.offset;
  }
  int addRadVelBeam4(double? radVelBeam4) {
    fbBuilder.addFloat64(35, radVelBeam4);
    return fbBuilder.offset;
  }
  int addRadVelBeam5(double? radVelBeam5) {
    fbBuilder.addFloat64(36, radVelBeam5);
    return fbBuilder.offset;
  }
  int addWindDir(double? windDir) {
    fbBuilder.addFloat64(37, windDir);
    return fbBuilder.offset;
  }
  int addWindDirAvg(double? windDirAvg) {
    fbBuilder.addFloat64(38, windDirAvg);
    return fbBuilder.offset;
  }
  int addWindDirPeak(double? windDirPeak) {
    fbBuilder.addFloat64(39, windDirPeak);
    return fbBuilder.offset;
  }
  int addWindDirPeak10(double? windDirPeak10) {
    fbBuilder.addFloat64(40, windDirPeak10);
    return fbBuilder.offset;
  }
  int addWindChill(double? windChill) {
    fbBuilder.addFloat64(41, windChill);
    return fbBuilder.offset;
  }
  int addDirDev(double? dirDev) {
    fbBuilder.addFloat64(42, dirDev);
    return fbBuilder.offset;
  }
  int addWindVar(bool? windVar) {
    fbBuilder.addBool(43, windVar);
    return fbBuilder.offset;
  }
  ...
  int addQnh(double? qnh) {
    fbBuilder.addFloat64(52, qnh);
    return fbBuilder.offset;
  }
  int addVisibility(double? visibility) {
    fbBuilder.addFloat64(53, visibility);
    return fbBuilder.offset;
  }
  int addTemperature(double? temperature) {
    fbBuilder.addFloat64(54, temperature);
    return fbBuilder.offset;
  }
  int addSoilTemp(double? soilTemp) {
    fbBuilder.addFloat64(55, soilTemp);
    return fbBuilder.offset;
  }
  int addBarPress(double? barPress) {
    fbBuilder.addFloat64(56, barPress);
    return fbBuilder.offset;
  }
  int addPrecipRate(double? precipRate) {
    fbBuilder.addFloat64(57, precipRate);
    return fbBuilder.offset;
  }
  int addRainHour(double? rainHour) {
    fbBuilder.addFloat64(58, rainHour);
    return fbBuilder.offset;
  }
  int addSolarRad(double? solarRad) {
    fbBuilder.addFloat64(59, solarRad);
    return fbBuilder.offset;
  }
  int addDifRad(double? difRad) {
    fbBuilder.addFloat64(60, difRad);
    return fbBuilder.offset;
  }
  int addRefRad(double? refRad) {
    fbBuilder.addFloat64(61, refRad);
    return fbBuilder.offset;
  }
  int addSenlat(double? senlat) {
    fbBuilder.addFloat64(62, senlat);
    return fbBuilder.offset;
  }
  int addSenlon(double? senlon) {
    fbBuilder.addFloat64(63, senlon);
    return fbBuilder.offset;
  }
  int addSenalt(double? senalt) {
    fbBuilder.addFloat64(64, senalt);
    return fbBuilder.offset;
  }
  int addDewPoint(double? dewPoint) {
    fbBuilder.addFloat64(65, dewPoint);
    return fbBuilder.offset;
  }
  int addRelHumidity(double? relHumidity) {
    fbBuilder.addFloat64(66, relHumidity);
    return fbBuilder.offset;
  }
  int addIndexRefraction(double? indexRefraction) {
    fbBuilder.addFloat64(67, indexRefraction);
    return fbBuilder.offset;
  }
  int addSoilMoisture(double? soilMoisture) {
    fbBuilder.addFloat64(68, soilMoisture);
    return fbBuilder.offset;
  }
  ...
  int addContrailHghtLower(double? contrailHghtLower) {
    fbBuilder.addFloat64(71, contrailHghtLower);
    return fbBuilder.offset;
  }
  int addContrailHghtUpper(double? contrailHghtUpper) {
    fbBuilder.addFloat64(72, contrailHghtUpper);
    return fbBuilder.offset;
  }
  int addIcingUpperLimit(double? icingUpperLimit) {
    fbBuilder.addFloat64(73, icingUpperLimit);
    return fbBuilder.offset;
  }
  int addIcingLowerLimit(double? icingLowerLimit) {
    fbBuilder.addFloat64(74, icingLowerLimit);
    return fbBuilder.offset;
  }
  ...
  int addDataMode(WeatherReportAbridgedDataModeEnum? dataMode) {
...
class WeatherReportAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final WeatherReportAbridgedDataModeEnum? _dataMode;

  WeatherReportAbridgedObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    WeatherReportAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(20, atextOffset);
    fbBuilder.addOffset(21, agjsonOffset);
    fbBuilder.addOffset(22, atypeOffset);
    fbBuilder.addInt32(23, _andims);
    fbBuilder.addInt32(24, _asrid);
    fbBuilder.addFloat64(25, _windSpd);
    fbBuilder.addFloat64(26, _windSpdAvg);
    fbBuilder.addFloat64(27, _windGust);
    fbBuilder.addFloat64(28, _windGust10);
    fbBuilder.addFloat64(29, _vshear);
    fbBuilder.addFloat64(30, _hshear);
    fbBuilder.addFloat64(31, _radVel);
    fbBuilder.addFloat64(32, _radVelBeam1);
    fbBuilder.addFloat64(33, _radVelBeam2);
    fbBuilder.addFloat64(34, _radVelBeam3);
    fbBuilder.addFloat64(35, _radVelBeam4);
    fbBuilder.addFloat64(36, _radVelBeam5);
    fbBuilder.addFloat64(37, _windDir);
    fbBuilder.addFloat64(38, _windDirAvg);
    fbBuilder.addFloat64(39, _windDirPeak);
    fbBuilder.addFloat64(40, _windDirPeak10);
    fbBuilder.addFloat64(41, _windChill);
    fbBuilder.addFloat64(42, _dirDev);
    fbBuilder.addBool(43, _windVar);
    fbBuilder.addOffset(44, windCovOffset);
    fbBuilder.addOffset(45, cloudCoverOffset);
    fbBuilder.addOffset(46, cloudHghtOffset);
    fbBuilder.addOffset(47, actWeatherOffset);
    fbBuilder.addOffset(48, weatherDescOffset);
    fbBuilder.addOffset(49, weatherIntOffset);
    fbBuilder.addOffset(50, rawMetarOffset);
    fbBuilder.addOffset(51, rawTafOffset);
    fbBuilder.addFloat64(52, _qnh);
    fbBuilder.addFloat64(53, _visibility);
    fbBuilder.addFloat64(54, _temperature);
    fbBuilder.addFloat64(55, _soilTemp);
    fbBuilder.addFloat64(56, _barPress);
    fbBuilder.addFloat64(57, _precipRate);
    fbBuilder.addFloat64(58, _rainHour);
    fbBuilder.addFloat64(59, _solarRad);
    fbBuilder.addFloat64(60, _difRad);
    fbBuilder.addFloat64(61, _refRad);
    fbBuilder.addFloat64(62, _senlat);
    fbBuilder.addFloat64(63, _senlon);
    fbBuilder.addFloat64(64, _senalt);
    fbBuilder.addFloat64(65, _dewPoint);
    fbBuilder.addFloat64(66, _relHumidity);
    fbBuilder.addFloat64(67, _indexRefraction);
    fbBuilder.addFloat64(68, _soilMoisture);
    fbBuilder.addOffset(69, surroundingWeatherOffset);
    fbBuilder.addOffset(70, weatherAmpOffset);
    fbBuilder.addFloat64(71, _contrailHghtLower);
    fbBuilder.addFloat64(72, _contrailHghtUpper);
    fbBuilder.addFloat64(73, _icingUpperLimit);
    fbBuilder.addFloat64(74, _icingLowerLimit);
    fbBuilder.addOffset(75, enRouteWeatherOffset);
    fbBuilder.addBool(76, _ccEvent);
    fbBuilder.addOffset(77, srcTypsOffset);
    fbBuilder.addOffset(78, srcIdsOffset);
    fbBuilder.addOffset(79, origNetworkOffset);
    fbBuilder.addOffset(80, createdAtOffset);
    fbBuilder.addOffset(81, createdByOffset);
    fbBuilder.addOffset(82, sourceOffset);
    fbBuilder.addOffset(83, originOffset);
