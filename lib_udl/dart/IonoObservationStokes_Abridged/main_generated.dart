...
class IonoObservationStokesAbridged {
  IonoObservationStokesAbridged._(this._bc, this._bcOffset);
  factory IonoObservationStokesAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationStokesAbridged> reader = _IonoObservationStokesAbridgedReader();
  ...
  @override
  String toString() {
    return 'IonoObservationStokesAbridged{notes: ${notes}, dimensions: ${dimensions}, dimensionName: ${dimensionName}, data: ${data}, s: ${s}}';
  }
}

class _IonoObservationStokesAbridgedReader extends fb.TableReader<IonoObservationStokesAbridged> {
  const _IonoObservationStokesAbridgedReader();

  @override
  IonoObservationStokesAbridged createObject(fb.BufferContext bc, int offset) => 
    IonoObservationStokesAbridged._(bc, offset);
}

class IonoObservationStokesAbridgedBuilder {
  IonoObservationStokesAbridgedBuilder(this.fbBuilder);
...
class IonoObservationStokesAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _notes;
  ...
  IonoObservationStokesAbridgedObjectBuilder({
    String? notes,
