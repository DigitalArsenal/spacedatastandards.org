...
///  /// Array of Doppler.
class IonoObservationDopplerAbridged {
  IonoObservationDopplerAbridged._(this._bc, this._bcOffset);
  factory IonoObservationDopplerAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationDopplerAbridged> reader = _IonoObservationDopplerAbridgedReader();
  ...
  @override
  String toString() {
    return 'IonoObservationDopplerAbridged{notes: ${notes}, dimensions: ${dimensions}, dimensionName: ${dimensionName}, data: ${data}}';
  }
}

class _IonoObservationDopplerAbridgedReader extends fb.TableReader<IonoObservationDopplerAbridged> {
  const _IonoObservationDopplerAbridgedReader();

  @override
  IonoObservationDopplerAbridged createObject(fb.BufferContext bc, int offset) => 
    IonoObservationDopplerAbridged._(bc, offset);
}

class IonoObservationDopplerAbridgedBuilder {
  IonoObservationDopplerAbridgedBuilder(this.fbBuilder);
...
class IonoObservationDopplerAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _notes;
  final List<String>? _dimensions;
  final List<String>? _dimensionName;
  final List<String>? _data;

  IonoObservationDopplerAbridgedObjectBuilder({
    String? notes,
