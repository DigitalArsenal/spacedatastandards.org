...
class GroundImageryAbridgedDataModeEnum {
  final int value;
  const GroundImageryAbridgedDataModeEnum._(this.value);

  factory GroundImageryAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum GroundImageryAbridgedDataModeEnum');
    }
    return result;
  }

  static GroundImageryAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : GroundImageryAbridgedDataModeEnum.fromValue(value);
  ...
  static const GroundImageryAbridgedDataModeEnum REAL = GroundImageryAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const GroundImageryAbridgedDataModeEnum TEST = GroundImageryAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const GroundImageryAbridgedDataModeEnum SIMULATED = GroundImageryAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const GroundImageryAbridgedDataModeEnum EXERCISE = GroundImageryAbridgedDataModeEnum._(3);
  static const Map<int, GroundImageryAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<GroundImageryAbridgedDataModeEnum> reader = _GroundImageryAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'GroundImageryAbridgedDataModeEnum{value: $value}';
  }
}

class _GroundImageryAbridgedDataModeEnumReader extends fb.Reader<GroundImageryAbridgedDataModeEnum> {
  const _GroundImageryAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  GroundImageryAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      GroundImageryAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Imagery of terrestrial regions from on-orbit, air, and other sensors.
class GroundImageryAbridged {
  GroundImageryAbridged._(this._bc, this._bcOffset);
  factory GroundImageryAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<GroundImageryAbridged> reader = _GroundImageryAbridgedReader();
  ...
  String? get regionText => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 14);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 65535
  String? get regionGeoJson => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 16);
  ///  Type of region as projected on the ground.
  ///  Example: /// Example: Polygon
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get regionType => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 18);
  ///  Number of dimensions of the geometry depicted by region.
  ///  Example: /// Example: 2
  ///  Constraints: No constraints specified.
  int get regionNdims => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 20, 0);
  ///  Geographical spatial_ref_sys for region.
  ///  Example: /// Example: 4326
  ///  Constraints: No constraints specified.
  int get regionSrid => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 22, 0);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get origSensorId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 24);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get subjectId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 26);
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  GroundImageryAbridgedDataModeEnum get dataMode => GroundImageryAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 38, 0));
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get transactionId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 44);
  ///  Description and notes of the image.
  ///  Example: /// Example: Example notes
  ///  Constraints: Minimum length = 0, Maximum length = 1024
  String? get notes => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 46);
  ///  Optional, field indicating type of image, NITF, PNG, etc.
  ///  Example: /// Example: PNG
  ///  Constraints: Minimum length = 1, Maximum length = 16
  String? get format => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 48);
  ///  Size of the image file. Units in bytes. If filesize is provided without an associated file, it defaults to 0.
  ///  Example: /// Example: 0
  ///  Constraints: No constraints specified.
  int get filesize => const fb.Int64Reader().vTableGet(_bc, _bcOffset, 50, 0);
  ...
  String? get checksumValue => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 52);

  @override
  String toString() {
    return 'GroundImageryAbridged{id: ${id}, idSensor: ${idSensor}, classificationMarking: ${classificationMarking}, imageTime: ${imageTime}, filename: ${filename}, regionText: ${regionText}, regionGeoJson: ${regionGeoJson}, regionType: ${regionType}, regionNdims: ${regionNdims}, regionSrid: ${regionSrid}, origSensorId: ${origSensorId}, subjectId: ${subjectId}, name: ${name}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, sourceDl: ${sourceDl}, dataMode: ${dataMode}, createdAt: ${createdAt}, createdBy: ${createdBy}, transactionId: ${transactionId}, notes: ${notes}, format: ${format}, filesize: ${filesize}, checksumValue: ${checksumValue}}';
  }
}

class _GroundImageryAbridgedReader extends fb.TableReader<GroundImageryAbridged> {
  const _GroundImageryAbridgedReader();

  @override
  GroundImageryAbridged createObject(fb.BufferContext bc, int offset) => 
    GroundImageryAbridged._(bc, offset);
}

class GroundImageryAbridgedBuilder {
  GroundImageryAbridgedBuilder(this.fbBuilder);
  ...
  int addRegionNdims(int? regionNdims) {
    fbBuilder.addInt32(8, regionNdims);
    return fbBuilder.offset;
  }
  int addRegionSrid(int? regionSrid) {
    fbBuilder.addInt32(9, regionSrid);
    return fbBuilder.offset;
  }
  ...
  int addDataMode(GroundImageryAbridgedDataModeEnum? dataMode) {
  ...
  int addFilesize(int? filesize) {
    fbBuilder.addInt64(23, filesize);
    return fbBuilder.offset;
  }
...
class GroundImageryAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final GroundImageryAbridgedDataModeEnum? _dataMode;
  ...
  GroundImageryAbridgedObjectBuilder({
    String? id,
    String? idSensor,
    ...
    String? origNetwork,
    String? sourceDl,
    GroundImageryAbridgedDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(5, regionTextOffset);
    fbBuilder.addOffset(6, regionGeoJsonOffset);
    fbBuilder.addOffset(7, regionTypeOffset);
    fbBuilder.addInt32(8, _regionNdims);
    fbBuilder.addInt32(9, _regionSrid);
    fbBuilder.addOffset(10, origSensorIdOffset);
    fbBuilder.addOffset(11, subjectIdOffset);
    ...
    fbBuilder.addOffset(20, transactionIdOffset);
    fbBuilder.addOffset(21, notesOffset);
    fbBuilder.addOffset(22, formatOffset);
    fbBuilder.addInt64(23, _filesize);
    fbBuilder.addOffset(24, checksumValueOffset);
    return fbBuilder.endTable();
  }
