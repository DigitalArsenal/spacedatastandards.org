...
class SolarArrayDetailsDataModeEnum {
  final int value;
  const SolarArrayDetailsDataModeEnum._(this.value);

  factory SolarArrayDetailsDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SolarArrayDetailsDataModeEnum');
    }
    return result;
  }

  static SolarArrayDetailsDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SolarArrayDetailsDataModeEnum.fromValue(value);
  ...
  static const SolarArrayDetailsDataModeEnum REAL = SolarArrayDetailsDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SolarArrayDetailsDataModeEnum TEST = SolarArrayDetailsDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SolarArrayDetailsDataModeEnum SIMULATED = SolarArrayDetailsDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SolarArrayDetailsDataModeEnum EXERCISE = SolarArrayDetailsDataModeEnum._(3);
  static const Map<int, SolarArrayDetailsDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SolarArrayDetailsDataModeEnum> reader = _SolarArrayDetailsDataModeEnumReader();

  @override
  String toString() {
    return 'SolarArrayDetailsDataModeEnum{value: $value}';
  }
}

class _SolarArrayDetailsDataModeEnumReader extends fb.Reader<SolarArrayDetailsDataModeEnum> {
  const _SolarArrayDetailsDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SolarArrayDetailsDataModeEnum read(fb.BufferContext bc, int offset) =>
      SolarArrayDetailsDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class SolarArrayDetails {
  SolarArrayDetails._(this._bc, this._bcOffset);
  factory SolarArrayDetails(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SolarArrayDetails> reader = _SolarArrayDetailsReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SolarArrayDetailsDataModeEnum get dataMode => SolarArrayDetailsDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 38, 0));
  ...
  @override
  String toString() {
    return 'SolarArrayDetails{id: ${id}, idSolarArray: ${idSolarArray}, classificationMarking: ${classificationMarking}, type: ${type}, technology: ${technology}, junctionTechnology: ${junctionTechnology}, manufacturerOrgId: ${manufacturerOrgId}, span: ${span}, area: ${area}, description: ${description}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, tags: ${tags}, manufacturerOrg: ${manufacturerOrg}}';
  }
}

class _SolarArrayDetailsReader extends fb.TableReader<SolarArrayDetails> {
  const _SolarArrayDetailsReader();

  @override
  SolarArrayDetails createObject(fb.BufferContext bc, int offset) => 
    SolarArrayDetails._(bc, offset);
}

class SolarArrayDetailsBuilder {
  SolarArrayDetailsBuilder(this.fbBuilder);
  ...
  int addDataMode(SolarArrayDetailsDataModeEnum? dataMode) {
...
class SolarArrayDetailsObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SolarArrayDetailsDataModeEnum? _dataMode;
  final List<String>? _tags;
  final String? _manufacturerOrg;

  SolarArrayDetailsObjectBuilder({
    String? id,
    String? idSolarArray,
    ...
    String? origin,
    String? origNetwork,
    SolarArrayDetailsDataModeEnum? dataMode,
    List<String>? tags,
