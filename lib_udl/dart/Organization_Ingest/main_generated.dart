...
class OrganizationIngestDataModeEnum {
  final int value;
  const OrganizationIngestDataModeEnum._(this.value);

  factory OrganizationIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OrganizationIngestDataModeEnum');
    }
    return result;
  }

  static OrganizationIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OrganizationIngestDataModeEnum.fromValue(value);
  ...
  static const OrganizationIngestDataModeEnum REAL = OrganizationIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OrganizationIngestDataModeEnum TEST = OrganizationIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OrganizationIngestDataModeEnum SIMULATED = OrganizationIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OrganizationIngestDataModeEnum EXERCISE = OrganizationIngestDataModeEnum._(3);
  static const Map<int, OrganizationIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OrganizationIngestDataModeEnum> reader = _OrganizationIngestDataModeEnumReader();

  @override
  String toString() {
    return 'OrganizationIngestDataModeEnum{value: $value}';
  }
}

class _OrganizationIngestDataModeEnumReader extends fb.Reader<OrganizationIngestDataModeEnum> {
  const _OrganizationIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OrganizationIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      OrganizationIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class OrganizationIngest {
  OrganizationIngest._(this._bc, this._bcOffset);
  factory OrganizationIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OrganizationIngest> reader = _OrganizationIngestReader();
  ...
  OrganizationIngestDataModeEnum get dataMode => OrganizationIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 28, 0));
  ...
  @override
  String toString() {
    return 'OrganizationIngest{id: ${id}, classificationMarking: ${classificationMarking}, name: ${name}, type: ${type}, category: ${category}, externalId: ${externalId}, description: ${description}, countryCode: ${countryCode}, nationality: ${nationality}, active: ${active}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, createdAt: ${createdAt}, createdBy: ${createdBy}, origNetwork: ${origNetwork}}';
  }
}

class _OrganizationIngestReader extends fb.TableReader<OrganizationIngest> {
  const _OrganizationIngestReader();

  @override
  OrganizationIngest createObject(fb.BufferContext bc, int offset) => 
    OrganizationIngest._(bc, offset);
}

class OrganizationIngestBuilder {
  OrganizationIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(OrganizationIngestDataModeEnum? dataMode) {
...
class OrganizationIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final OrganizationIngestDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final String? _origNetwork;

  OrganizationIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    OrganizationIngestDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? origNetwork,
  })
