...
class ObjectOfInterestIngestDataModeEnum {
  final int value;
  const ObjectOfInterestIngestDataModeEnum._(this.value);

  factory ObjectOfInterestIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ObjectOfInterestIngestDataModeEnum');
    }
    return result;
  }

  static ObjectOfInterestIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : ObjectOfInterestIngestDataModeEnum.fromValue(value);
  ...
  static const ObjectOfInterestIngestDataModeEnum REAL = ObjectOfInterestIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const ObjectOfInterestIngestDataModeEnum TEST = ObjectOfInterestIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const ObjectOfInterestIngestDataModeEnum SIMULATED = ObjectOfInterestIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const ObjectOfInterestIngestDataModeEnum EXERCISE = ObjectOfInterestIngestDataModeEnum._(3);
  static const Map<int, ObjectOfInterestIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<ObjectOfInterestIngestDataModeEnum> reader = _ObjectOfInterestIngestDataModeEnumReader();

  @override
  String toString() {
    return 'ObjectOfInterestIngestDataModeEnum{value: $value}';
  }
}

class _ObjectOfInterestIngestDataModeEnumReader extends fb.Reader<ObjectOfInterestIngestDataModeEnum> {
  const _ObjectOfInterestIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  ObjectOfInterestIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      ObjectOfInterestIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// OnOrbit objects of interest, which include information about the last known state of the object.
class ObjectOfInterestIngest {
  ObjectOfInterestIngest._(this._bc, this._bcOffset);
  factory ObjectOfInterestIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<ObjectOfInterestIngest> reader = _ObjectOfInterestIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  ObjectOfInterestIngestDataModeEnum get dataMode => ObjectOfInterestIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 90, 0));

  @override
  String toString() {
    return 'ObjectOfInterestIngest{id: ${id}, classificationMarking: ${classificationMarking}, idOnOrbit: ${idOnOrbit}, satNo: ${satNo}, name: ${name}, sensorTaskingStartTime: ${sensorTaskingStartTime}, sensorTaskingStopTime: ${sensorTaskingStopTime}, priority: ${priority}, status: ${status}, statusDate: ${statusDate}, description: ${description}, lastObTime: ${lastObTime}, missedObTime: ${missedObTime}, deltaVs: ${deltaVs}, deltaTs: ${deltaTs}, svEpoch: ${svEpoch}, x: ${x}, y: ${y}, z: ${z}, xvel: ${xvel}, yvel: ${yvel}, zvel: ${zvel}, elsetEpoch: ${elsetEpoch}, meanMotion: ${meanMotion}, eccentricity: ${eccentricity}, inclination: ${inclination}, raan: ${raan}, argOfPerigee: ${argOfPerigee}, meanAnomaly: ${meanAnomaly}, revNo: ${revNo}, bStar: ${bStar}, meanMotionDot: ${meanMotionDot}, meanMotionDdot: ${meanMotionDdot}, semiMajorAxis: ${semiMajorAxis}, period: ${period}, apogee: ${apogee}, perigee: ${perigee}, affectedObjects: ${affectedObjects}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _ObjectOfInterestIngestReader extends fb.TableReader<ObjectOfInterestIngest> {
  const _ObjectOfInterestIngestReader();

  @override
  ObjectOfInterestIngest createObject(fb.BufferContext bc, int offset) => 
    ObjectOfInterestIngest._(bc, offset);
}

class ObjectOfInterestIngestBuilder {
  ObjectOfInterestIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(ObjectOfInterestIngestDataModeEnum? dataMode) {
...
class ObjectOfInterestIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final ObjectOfInterestIngestDataModeEnum? _dataMode;

  ObjectOfInterestIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    ObjectOfInterestIngestDataModeEnum? dataMode,
  })
      : _id = id,
