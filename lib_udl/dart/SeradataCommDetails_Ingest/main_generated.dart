...
class SeradataCommDetailsIngestDataModeEnum {
  final int value;
  const SeradataCommDetailsIngestDataModeEnum._(this.value);

  factory SeradataCommDetailsIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SeradataCommDetailsIngestDataModeEnum');
    }
    return result;
  }

  static SeradataCommDetailsIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SeradataCommDetailsIngestDataModeEnum.fromValue(value);
  ...
  static const SeradataCommDetailsIngestDataModeEnum REAL = SeradataCommDetailsIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SeradataCommDetailsIngestDataModeEnum TEST = SeradataCommDetailsIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SeradataCommDetailsIngestDataModeEnum SIMULATED = SeradataCommDetailsIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SeradataCommDetailsIngestDataModeEnum EXERCISE = SeradataCommDetailsIngestDataModeEnum._(3);
  static const Map<int, SeradataCommDetailsIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SeradataCommDetailsIngestDataModeEnum> reader = _SeradataCommDetailsIngestDataModeEnumReader();

  @override
  String toString() {
    return 'SeradataCommDetailsIngestDataModeEnum{value: $value}';
  }
}

class _SeradataCommDetailsIngestDataModeEnumReader extends fb.Reader<SeradataCommDetailsIngestDataModeEnum> {
  const _SeradataCommDetailsIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SeradataCommDetailsIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      SeradataCommDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Seradata-compiled information on communications payloads.
class SeradataCommDetailsIngest {
  SeradataCommDetailsIngest._(this._bc, this._bcOffset);
  factory SeradataCommDetailsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SeradataCommDetailsIngest> reader = _SeradataCommDetailsIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SeradataCommDetailsIngestDataModeEnum get dataMode => SeradataCommDetailsIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 72, 0));
...
class SeradataCommDetailsIngestBuilder {
  ...
  int addDataMode(SeradataCommDetailsIngestDataModeEnum? dataMode) {
...
class SeradataCommDetailsIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SeradataCommDetailsIngestDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;

  SeradataCommDetailsIngestObjectBuilder({
    String? id,
    String? idComm,
    ...
    String? origin,
    String? origNetwork,
    SeradataCommDetailsIngestDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
  })
      : _id = id,
