...
class SgiFullStateEnum {
  final int value;
  const SgiFullStateEnum._(this.value);

  factory SgiFullStateEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SgiFullStateEnum');
    }
    return result;
  }

  static SgiFullStateEnum? _createOrNull(int? value) => 
      value == null ? null : SgiFullStateEnum.fromValue(value);
  ...
  static const SgiFullStateEnum I = SgiFullStateEnum._(0);

  ///  No description available.
  static const SgiFullStateEnum N = SgiFullStateEnum._(1);

  ///  No description available.
  static const SgiFullStateEnum P = SgiFullStateEnum._(2);
  static const Map<int, SgiFullStateEnum> values = {
    0: I,
    1: N,
    2: P};

  static const fb.Reader<SgiFullStateEnum> reader = _SgiFullStateEnumReader();

  @override
  String toString() {
    return 'SgiFullStateEnum{value: $value}';
  }
}

class _SgiFullStateEnumReader extends fb.Reader<SgiFullStateEnum> {
  const _SgiFullStateEnumReader();

  @override
  int get size => 1;

  @override
  SgiFullStateEnum read(fb.BufferContext bc, int offset) =>
      SgiFullStateEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class SgiFullPrecedenceEnum {
  final int value;
  const SgiFullPrecedenceEnum._(this.value);

  factory SgiFullPrecedenceEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SgiFullPrecedenceEnum');
    }
    return result;
  }

  static SgiFullPrecedenceEnum? _createOrNull(int? value) => 
      value == null ? null : SgiFullPrecedenceEnum.fromValue(value);
  ...
  ///  No description available.
  static const SgiFullPrecedenceEnum O = SgiFullPrecedenceEnum._(0);

  ///  No description available.
  static const SgiFullPrecedenceEnum P = SgiFullPrecedenceEnum._(1);

  ///  No description available.
  static const SgiFullPrecedenceEnum R = SgiFullPrecedenceEnum._(2);

  ///  No description available.
  static const SgiFullPrecedenceEnum Y = SgiFullPrecedenceEnum._(3);

  ///  No description available.
  static const SgiFullPrecedenceEnum Z = SgiFullPrecedenceEnum._(4);
  static const Map<int, SgiFullPrecedenceEnum> values = {
    0: O,
    1: P,
    2: R,
    3: Y,
  ...
  static const fb.Reader<SgiFullPrecedenceEnum> reader = _SgiFullPrecedenceEnumReader();

  @override
  String toString() {
    return 'SgiFullPrecedenceEnum{value: $value}';
  }
}

class _SgiFullPrecedenceEnumReader extends fb.Reader<SgiFullPrecedenceEnum> {
  const _SgiFullPrecedenceEnumReader();

  @override
  int get size => 1;

  @override
  SgiFullPrecedenceEnum read(fb.BufferContext bc, int offset) =>
      SgiFullPrecedenceEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class SgiFullDataModeEnum {
  final int value;
  const SgiFullDataModeEnum._(this.value);

  factory SgiFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SgiFullDataModeEnum');
    }
    return result;
  }

  static SgiFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SgiFullDataModeEnum.fromValue(value);
  ...
  static const SgiFullDataModeEnum REAL = SgiFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SgiFullDataModeEnum TEST = SgiFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SgiFullDataModeEnum SIMULATED = SgiFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SgiFullDataModeEnum EXERCISE = SgiFullDataModeEnum._(3);
  static const Map<int, SgiFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SgiFullDataModeEnum> reader = _SgiFullDataModeEnumReader();

  @override
  String toString() {
    return 'SgiFullDataModeEnum{value: $value}';
  }
}

class _SgiFullDataModeEnumReader extends fb.Reader<SgiFullDataModeEnum> {
  const _SgiFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SgiFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      SgiFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Model representation of space weather/solar, geomagnetic, and radiation belt indices.
class SgiFull {
  SgiFull._(this._bc, this._bcOffset);
  factory SgiFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SgiFull> reader = _SgiFullReader();
  ...
  SgiFullStateEnum get state => SgiFullStateEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 14, 0));
  ...
  ///  Example: /// Example: R
  ///  Constraints: Minimum length = 0, Maximum length = 1
  SgiFullPrecedenceEnum get precedence => SgiFullPrecedenceEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 24, 0));
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SgiFullDataModeEnum get dataMode => SgiFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 104, 0));
  ...
  ///  Example: /// Example: 2018-01-01T16:00:00.123Z
  ///  Constraints: No constraints specified.
  String? get updatedAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 110);
  ///  Application user who updated the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get updatedBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 112);

  @override
  String toString() {
    return 'SgiFull{id: ${id}, classificationMarking: ${classificationMarking}, effectiveDate: ${effectiveDate}, sgiDate: ${sgiDate}, type: ${type}, state: ${state}, stationName: ${stationName}, idSensor: ${idSensor}, origSensorId: ${origSensorId}, mode: ${mode}, precedence: ${precedence}, coeffDegree: ${coeffDegree}, coeffOrder: ${coeffOrder}, ctce: ${ctce}, stce: ${stce}, ctci: ${ctci}, stci: ${stci}, e10: ${e10}, e54: ${e54}, s10: ${s10}, s54: ${s54}, m10: ${m10}, m54: ${m54}, y10: ${y10}, y54: ${y54}, f10: ${f10}, f54: ${f54}, f81: ${f81}, ap: ${ap}, apDuration: ${apDuration}, kIndex: ${kIndex}, kp: ${kp}, kpDuration: ${kpDuration}, gamma: ${gamma}, dst: ${dst}, dtc: ${dtc}, rbRegionCode: ${rbRegionCode}, rbIndex: ${rbIndex}, normFactor: ${normFactor}, rbDuration: ${rbDuration}, analyzerAttenuation: ${analyzerAttenuation}, observedBaseline: ${observedBaseline}, frequencies: ${frequencies}, powers: ${powers}, rawFileUri: ${rawFileUri}, transactionId: ${transactionId}, tags: ${tags}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}}';
  }
}

class _SgiFullReader extends fb.TableReader<SgiFull> {
  const _SgiFullReader();

  @override
  SgiFull createObject(fb.BufferContext bc, int offset) => 
    SgiFull._(bc, offset);
}

class SgiFullBuilder {
  SgiFullBuilder(this.fbBuilder);
  ...
  int addState(SgiFullStateEnum? state) {
  ...
  int addPrecedence(SgiFullPrecedenceEnum? precedence) {
  ...
  int addDataMode(SgiFullDataModeEnum? dataMode) {
...
class SgiFullObjectBuilder extends fb.ObjectBuilder {
  ...
  final SgiFullDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final String? _updatedAt;
  final String? _updatedBy;

  SgiFullObjectBuilder({
    String? id,
    String? classificationMarking,
    String? effectiveDate,
    String? sgiDate,
    String? type,
    SgiFullStateEnum? state,
    String? stationName,
    String? idSensor,
    String? origSensorId,
    int? mode,
    SgiFullPrecedenceEnum? precedence,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(53, updatedAtOffset);
    fbBuilder.addOffset(54, updatedByOffset);
    return fbBuilder.endTable();
  }
