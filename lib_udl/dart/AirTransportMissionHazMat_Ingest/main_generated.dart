...
class AirTransportMissionHazMatIngest {
  AirTransportMissionHazMatIngest._(this._bc, this._bcOffset);
  factory AirTransportMissionHazMatIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirTransportMissionHazMatIngest> reader = _AirTransportMissionHazMatIngestReader();
  ...
  @override
  String toString() {
    return 'AirTransportMissionHazMatIngest{extHazMatId: ${extHazMatId}, itemName: ${itemName}, unNum: ${unNum}, pieces: ${pieces}, weight: ${weight}, netExpWt: ${netExpWt}, classDiv: ${classDiv}, cgc: ${cgc}, cgn: ${cgn}, applicableNotes: ${applicableNotes}, onItin: ${onItin}, onIcao: ${onIcao}, offItin: ${offItin}, offIcao: ${offIcao}, planned: ${planned}}';
  }
}

class _AirTransportMissionHazMatIngestReader extends fb.TableReader<AirTransportMissionHazMatIngest> {
  const _AirTransportMissionHazMatIngestReader();

  @override
  AirTransportMissionHazMatIngest createObject(fb.BufferContext bc, int offset) => 
    AirTransportMissionHazMatIngest._(bc, offset);
}

class AirTransportMissionHazMatIngestBuilder {
  AirTransportMissionHazMatIngestBuilder(this.fbBuilder);
...
class AirTransportMissionHazMatIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  AirTransportMissionHazMatIngestObjectBuilder({
    String? extHazMatId,
    String? itemName,
    String? unNum,
    int? pieces,
