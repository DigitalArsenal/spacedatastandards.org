...
class IonoObservationDensityProfileQuasiParabolicAbridged {
  IonoObservationDensityProfileQuasiParabolicAbridged._(this._bc, this._bcOffset);
  factory IonoObservationDensityProfileQuasiParabolicAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationDensityProfileQuasiParabolicAbridged> reader = _IonoObservationDensityProfileQuasiParabolicAbridgedReader();
  ...
  @override
  String toString() {
    return 'IonoObservationDensityProfileQuasiParabolicAbridged{description: ${description}, earthRadius: ${earthRadius}, quasiParabolicSegments: ${quasiParabolicSegments}}';
  }
}

class _IonoObservationDensityProfileQuasiParabolicAbridgedReader extends fb.TableReader<IonoObservationDensityProfileQuasiParabolicAbridged> {
  const _IonoObservationDensityProfileQuasiParabolicAbridgedReader();

  @override
  IonoObservationDensityProfileQuasiParabolicAbridged createObject(fb.BufferContext bc, int offset) => 
    IonoObservationDensityProfileQuasiParabolicAbridged._(bc, offset);
}

class IonoObservationDensityProfileQuasiParabolicAbridgedBuilder {
  IonoObservationDensityProfileQuasiParabolicAbridgedBuilder(this.fbBuilder);
...
class IonoObservationDensityProfileQuasiParabolicAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _description;
  final double? _earthRadius;
  final List<String>? _quasiParabolicSegments;

  IonoObservationDensityProfileQuasiParabolicAbridgedObjectBuilder({
    String? description,
    double? earthRadius,
