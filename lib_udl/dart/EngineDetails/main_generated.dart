...
class EngineDetailsDataModeEnum {
  final int value;
  const EngineDetailsDataModeEnum._(this.value);

  factory EngineDetailsDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EngineDetailsDataModeEnum');
    }
    return result;
  }

  static EngineDetailsDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EngineDetailsDataModeEnum.fromValue(value);
  ...
  static const EngineDetailsDataModeEnum REAL = EngineDetailsDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EngineDetailsDataModeEnum TEST = EngineDetailsDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EngineDetailsDataModeEnum SIMULATED = EngineDetailsDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EngineDetailsDataModeEnum EXERCISE = EngineDetailsDataModeEnum._(3);
  static const Map<int, EngineDetailsDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EngineDetailsDataModeEnum> reader = _EngineDetailsDataModeEnumReader();

  @override
  String toString() {
    return 'EngineDetailsDataModeEnum{value: $value}';
  }
}

class _EngineDetailsDataModeEnumReader extends fb.Reader<EngineDetailsDataModeEnum> {
  const _EngineDetailsDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EngineDetailsDataModeEnum read(fb.BufferContext bc, int offset) =>
      EngineDetailsDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class EngineDetails {
  EngineDetails._(this._bc, this._bcOffset);
  factory EngineDetails(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EngineDetails> reader = _EngineDetailsReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  EngineDetailsDataModeEnum get dataMode => EngineDetailsDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 52, 0));
...
class EngineDetailsBuilder {
  ...
  int addDataMode(EngineDetailsDataModeEnum? dataMode) {
...
class EngineDetailsObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EngineDetailsDataModeEnum? _dataMode;
  final List<String>? _tags;

  EngineDetailsObjectBuilder({
    String? id,
    String? idEngine,
    ...
    String? origin,
    String? origNetwork,
    EngineDetailsDataModeEnum? dataMode,
    List<String>? tags,
  })
      : _id = id,
        _idEngine = idEngine,
