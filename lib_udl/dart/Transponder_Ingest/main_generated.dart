...
class TransponderIngestDataModeEnum {
  final int value;
  const TransponderIngestDataModeEnum._(this.value);

  factory TransponderIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum TransponderIngestDataModeEnum');
    }
    return result;
  }

  static TransponderIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : TransponderIngestDataModeEnum.fromValue(value);
  ...
  static const TransponderIngestDataModeEnum REAL = TransponderIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const TransponderIngestDataModeEnum TEST = TransponderIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const TransponderIngestDataModeEnum SIMULATED = TransponderIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const TransponderIngestDataModeEnum EXERCISE = TransponderIngestDataModeEnum._(3);
  static const Map<int, TransponderIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<TransponderIngestDataModeEnum> reader = _TransponderIngestDataModeEnumReader();

  @override
  String toString() {
    return 'TransponderIngestDataModeEnum{value: $value}';
  }
}

class _TransponderIngestDataModeEnumReader extends fb.Reader<TransponderIngestDataModeEnum> {
  const _TransponderIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  TransponderIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      TransponderIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class TransponderIngest {
  TransponderIngest._(this._bc, this._bcOffset);
  factory TransponderIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<TransponderIngest> reader = _TransponderIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  TransponderIngestDataModeEnum get dataMode => TransponderIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 34, 0));
  ...
  @override
  String toString() {
    return 'TransponderIngest{id: ${id}, idComm: ${idComm}, name: ${name}, classificationMarking: ${classificationMarking}, nid: ${nid}, tid: ${tid}, ttf: ${ttf}, symbolRate: ${symbolRate}, fec: ${fec}, modulation: ${modulation}, format: ${format}, system: ${system}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, createdAt: ${createdAt}, createdBy: ${createdBy}}';
  }
}

class _TransponderIngestReader extends fb.TableReader<TransponderIngest> {
  const _TransponderIngestReader();

  @override
  TransponderIngest createObject(fb.BufferContext bc, int offset) => 
    TransponderIngest._(bc, offset);
}

class TransponderIngestBuilder {
  TransponderIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(TransponderIngestDataModeEnum? dataMode) {
...
class TransponderIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final TransponderIngestDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;

  TransponderIngestObjectBuilder({
    String? id,
    String? idComm,
    String? name,
    ...
    String? origin,
    String? origNetwork,
    TransponderIngestDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
  })
      : _id = id,
