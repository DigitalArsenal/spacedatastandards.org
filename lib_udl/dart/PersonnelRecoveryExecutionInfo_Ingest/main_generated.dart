...
class PersonnelRecoveryExecutionInfoIngest {
  PersonnelRecoveryExecutionInfoIngest._(this._bc, this._bcOffset);
  factory PersonnelRecoveryExecutionInfoIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PersonnelRecoveryExecutionInfoIngest> reader = _PersonnelRecoveryExecutionInfoIngestReader();
  ...
  @override
  String toString() {
    return 'PersonnelRecoveryExecutionInfoIngest{initialPoint: ${initialPoint}, ingress: ${ingress}, objStrategy: ${objStrategy}, egressPoint: ${egressPoint}, egress: ${egress}, recoveryVehicle: ${recoveryVehicle}, escortVehicle: ${escortVehicle}}';
  }
}

class _PersonnelRecoveryExecutionInfoIngestReader extends fb.TableReader<PersonnelRecoveryExecutionInfoIngest> {
  const _PersonnelRecoveryExecutionInfoIngestReader();

  @override
  PersonnelRecoveryExecutionInfoIngest createObject(fb.BufferContext bc, int offset) => 
    PersonnelRecoveryExecutionInfoIngest._(bc, offset);
}

class PersonnelRecoveryExecutionInfoIngestBuilder {
  PersonnelRecoveryExecutionInfoIngestBuilder(this.fbBuilder);
...
class PersonnelRecoveryExecutionInfoIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  PersonnelRecoveryExecutionInfoIngestObjectBuilder({
