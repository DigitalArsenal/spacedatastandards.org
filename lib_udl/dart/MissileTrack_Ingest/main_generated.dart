...
class MissileTrackIngestEnvEnum {
  final int value;
  const MissileTrackIngestEnvEnum._(this.value);

  factory MissileTrackIngestEnvEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum MissileTrackIngestEnvEnum');
    }
    return result;
  }

  static MissileTrackIngestEnvEnum? _createOrNull(int? value) => 
      value == null ? null : MissileTrackIngestEnvEnum.fromValue(value);
  ...
  static const MissileTrackIngestEnvEnum AIR = MissileTrackIngestEnvEnum._(0);

  ///  On the surface of dry land.
  static const MissileTrackIngestEnvEnum LAND = MissileTrackIngestEnvEnum._(1);

  ///  Above the Kármán line, which has an altitude of 100 kilometers (62 miles).
  static const MissileTrackIngestEnvEnum SPACE = MissileTrackIngestEnvEnum._(2);

  ///  On the surface of a body of water.
  static const MissileTrackIngestEnvEnum SURFACE = MissileTrackIngestEnvEnum._(3);

  ///  Below the surface of a body of water.
  static const MissileTrackIngestEnvEnum SUBSURFACE = MissileTrackIngestEnvEnum._(4);

  ///  Environment is not known.
  static const MissileTrackIngestEnvEnum UNKNOWN = MissileTrackIngestEnvEnum._(5);
  static const Map<int, MissileTrackIngestEnvEnum> values = {
    0: AIR,
    1: LAND,
    2: SPACE,
    3: SURFACE,
  ...
  static const fb.Reader<MissileTrackIngestEnvEnum> reader = _MissileTrackIngestEnvEnumReader();

  @override
  String toString() {
    return 'MissileTrackIngestEnvEnum{value: $value}';
  }
}

class _MissileTrackIngestEnvEnumReader extends fb.Reader<MissileTrackIngestEnvEnum> {
  const _MissileTrackIngestEnvEnumReader();

  @override
  int get size => 1;

  @override
  MissileTrackIngestEnvEnum read(fb.BufferContext bc, int offset) =>
      MissileTrackIngestEnvEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class MissileTrackIngestObjIdentEnum {
  final int value;
  const MissileTrackIngestObjIdentEnum._(this.value);

  factory MissileTrackIngestObjIdentEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum MissileTrackIngestObjIdentEnum');
    }
    return result;
  }

  static MissileTrackIngestObjIdentEnum? _createOrNull(int? value) => 
      value == null ? null : MissileTrackIngestObjIdentEnum.fromValue(value);
  ...
  static const MissileTrackIngestObjIdentEnum ASSUMED_FRIEND = MissileTrackIngestObjIdentEnum._(0);

  ///  Track object supporting friendly forces and belonging to a declared friendly nation or entity.
  static const MissileTrackIngestObjIdentEnum FRIEND = MissileTrackIngestObjIdentEnum._(1);
  ...
  static const MissileTrackIngestObjIdentEnum HOSTILE = MissileTrackIngestObjIdentEnum._(2);
  ...
  static const MissileTrackIngestObjIdentEnum NEUTRAL = MissileTrackIngestObjIdentEnum._(3);

  ///  Track object which has not been evaluated.
  static const MissileTrackIngestObjIdentEnum PENDING = MissileTrackIngestObjIdentEnum._(4);

  ///  Track object deemed potentially hostile due to the object characteristics, behavior, nationality, and/or origin.
  static const MissileTrackIngestObjIdentEnum SUSPECT = MissileTrackIngestObjIdentEnum._(5);

  ///  Track object which has been evaluated and does not meet criteria for any standard identity.
  static const MissileTrackIngestObjIdentEnum UNKNOWN = MissileTrackIngestObjIdentEnum._(6);
  static const Map<int, MissileTrackIngestObjIdentEnum> values = {
    0: ASSUMED_FRIEND,
    1: FRIEND,
    2: HOSTILE,
    3: NEUTRAL,
  ...
  static const fb.Reader<MissileTrackIngestObjIdentEnum> reader = _MissileTrackIngestObjIdentEnumReader();

  @override
  String toString() {
    return 'MissileTrackIngestObjIdentEnum{value: $value}';
  }
}

class _MissileTrackIngestObjIdentEnumReader extends fb.Reader<MissileTrackIngestObjIdentEnum> {
  const _MissileTrackIngestObjIdentEnumReader();

  @override
  int get size => 1;

  @override
  MissileTrackIngestObjIdentEnum read(fb.BufferContext bc, int offset) =>
      MissileTrackIngestObjIdentEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class MissileTrackIngestDataModeEnum {
  final int value;
  const MissileTrackIngestDataModeEnum._(this.value);

  factory MissileTrackIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum MissileTrackIngestDataModeEnum');
    }
    return result;
  }

  static MissileTrackIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : MissileTrackIngestDataModeEnum.fromValue(value);
  ...
  static const MissileTrackIngestDataModeEnum REAL = MissileTrackIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const MissileTrackIngestDataModeEnum TEST = MissileTrackIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const MissileTrackIngestDataModeEnum SIMULATED = MissileTrackIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const MissileTrackIngestDataModeEnum EXERCISE = MissileTrackIngestDataModeEnum._(3);
  static const Map<int, MissileTrackIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<MissileTrackIngestDataModeEnum> reader = _MissileTrackIngestDataModeEnumReader();

  @override
  String toString() {
    return 'MissileTrackIngestDataModeEnum{value: $value}';
  }
}

class _MissileTrackIngestDataModeEnumReader extends fb.Reader<MissileTrackIngestDataModeEnum> {
  const _MissileTrackIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  MissileTrackIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      MissileTrackIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class MissileTrackIngest {
  MissileTrackIngest._(this._bc, this._bcOffset);
  factory MissileTrackIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MissileTrackIngest> reader = _MissileTrackIngestReader();
  ...
  ///  Example: /// Example: AIR
  ///  Constraints: Minimum length = 0, Maximum length = 16
  MissileTrackIngestEnvEnum get env => MissileTrackIngestEnvEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 14, 0));
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 32
  MissileTrackIngestObjIdentEnum get objIdent => MissileTrackIngestObjIdentEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 22, 0));
  ...
  MissileTrackIngestDataModeEnum get dataMode => MissileTrackIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 116, 0));

  @override
  String toString() {
    return 'MissileTrackIngest{id: ${id}, classificationMarking: ${classificationMarking}, msgType: ${msgType}, msgSubType: ${msgSubType}, msgCreateDate: ${msgCreateDate}, env: ${env}, objType: ${objType}, objTypeConf: ${objTypeConf}, objPlat: ${objPlat}, objIdent: ${objIdent}, spaceAmp: ${spaceAmp}, objAct: ${objAct}, spaceSpecType: ${spaceSpecType}, acftSubType: ${acftSubType}, name: ${name}, callSign: ${callSign}, lostTrkInd: ${lostTrkInd}, trackId: ${trackId}, parentTrackId: ${parentTrackId}, muidSrcTrk: ${muidSrcTrk}, muidSrc: ${muidSrc}, alert: ${alert}, mslStatus: ${mslStatus}, ts: ${ts}, aouRptType: ${aouRptType}, aouRptData: ${aouRptData}, containment: ${containment}, trkConf: ${trkConf}, trkQual: ${trkQual}, angElev: ${angElev}, senMode: ${senMode}, infoSource: ${infoSource}, boosting: ${boosting}, polarSingLocLat: ${polarSingLocLat}, polarSingLocLon: ${polarSingLocLon}, emgInd: ${emgInd}, dropPtInd: ${dropPtInd}, spaceAmpConf: ${spaceAmpConf}, launchTime: ${launchTime}, launchLat: ${launchLat}, launchLon: ${launchLon}, azCorr: ${azCorr}, burnoutAlt: ${burnoutAlt}, launchAouType: ${launchAouType}, launchAouData: ${launchAouData}, impactTime: ${impactTime}, impactLat: ${impactLat}, impactLon: ${impactLon}, impactAouType: ${impactAouType}, impactAouData: ${impactAouData}, vectors: ${vectors}, origNetwork: ${origNetwork}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}}';
  }
}

class _MissileTrackIngestReader extends fb.TableReader<MissileTrackIngest> {
  const _MissileTrackIngestReader();

  @override
  MissileTrackIngest createObject(fb.BufferContext bc, int offset) => 
    MissileTrackIngest._(bc, offset);
}

class MissileTrackIngestBuilder {
  MissileTrackIngestBuilder(this.fbBuilder);
  ...
  int addEnv(MissileTrackIngestEnvEnum? env) {
  ...
  int addObjIdent(MissileTrackIngestObjIdentEnum? objIdent) {
  ...
  int addDataMode(MissileTrackIngestDataModeEnum? dataMode) {
...
class MissileTrackIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _classificationMarking;
  final String? _msgType;
  final String? _msgSubType;
  final String? _msgCreateDate;
  final MissileTrackIngestEnvEnum? _env;
  final String? _objType;
  final int? _objTypeConf;
  final String? _objPlat;
  final MissileTrackIngestObjIdentEnum? _objIdent;
  ...
  final MissileTrackIngestDataModeEnum? _dataMode;

  MissileTrackIngestObjectBuilder({
    String? id,
    String? classificationMarking,
    String? msgType,
    String? msgSubType,
    String? msgCreateDate,
    MissileTrackIngestEnvEnum? env,
    String? objType,
    int? objTypeConf,
    String? objPlat,
    MissileTrackIngestObjIdentEnum? objIdent,
    String? spaceAmp,
    String? objAct,
    ...
    String? source,
    String? origin,
    MissileTrackIngestDataModeEnum? dataMode,
  })
      : _id = id,
