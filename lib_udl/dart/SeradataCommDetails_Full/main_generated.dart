...
class SeradataCommDetailsFullDataModeEnum {
  final int value;
  const SeradataCommDetailsFullDataModeEnum._(this.value);

  factory SeradataCommDetailsFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SeradataCommDetailsFullDataModeEnum');
    }
    return result;
  }

  static SeradataCommDetailsFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SeradataCommDetailsFullDataModeEnum.fromValue(value);
  ...
  static const SeradataCommDetailsFullDataModeEnum REAL = SeradataCommDetailsFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SeradataCommDetailsFullDataModeEnum TEST = SeradataCommDetailsFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SeradataCommDetailsFullDataModeEnum SIMULATED = SeradataCommDetailsFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SeradataCommDetailsFullDataModeEnum EXERCISE = SeradataCommDetailsFullDataModeEnum._(3);
  static const Map<int, SeradataCommDetailsFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SeradataCommDetailsFullDataModeEnum> reader = _SeradataCommDetailsFullDataModeEnumReader();

  @override
  String toString() {
    return 'SeradataCommDetailsFullDataModeEnum{value: $value}';
  }
}

class _SeradataCommDetailsFullDataModeEnumReader extends fb.Reader<SeradataCommDetailsFullDataModeEnum> {
  const _SeradataCommDetailsFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SeradataCommDetailsFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      SeradataCommDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Seradata-compiled information on communications payloads.
class SeradataCommDetailsFull {
  SeradataCommDetailsFull._(this._bc, this._bcOffset);
  factory SeradataCommDetailsFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SeradataCommDetailsFull> reader = _SeradataCommDetailsFullReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SeradataCommDetailsFullDataModeEnum get dataMode => SeradataCommDetailsFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 72, 0));
...
class SeradataCommDetailsFullBuilder {
  ...
  int addDataMode(SeradataCommDetailsFullDataModeEnum? dataMode) {
...
class SeradataCommDetailsFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SeradataCommDetailsFullDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final String? _updatedAt;
  final String? _updatedBy;

  SeradataCommDetailsFullObjectBuilder({
    String? id,
    String? idComm,
    ...
    String? origin,
    String? origNetwork,
    SeradataCommDetailsFullDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? updatedAt,
    String? updatedBy,
