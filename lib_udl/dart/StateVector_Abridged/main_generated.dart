...
class StateVectorAbridgedReferenceFrameEnum {
  final int value;
  const StateVectorAbridgedReferenceFrameEnum._(this.value);

  factory StateVectorAbridgedReferenceFrameEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum StateVectorAbridgedReferenceFrameEnum');
    }
    return result;
  }

  static StateVectorAbridgedReferenceFrameEnum? _createOrNull(int? value) => 
      value == null ? null : StateVectorAbridgedReferenceFrameEnum.fromValue(value);
  ...
  static const StateVectorAbridgedReferenceFrameEnum J2000 = StateVectorAbridgedReferenceFrameEnum._(0);

  ///  No description available.
  static const StateVectorAbridgedReferenceFrameEnum EFG_TDR = StateVectorAbridgedReferenceFrameEnum._(1);

  ///  No description available.
  static const StateVectorAbridgedReferenceFrameEnum ECR_ECEF = StateVectorAbridgedReferenceFrameEnum._(2);

  ///  No description available.
  static const StateVectorAbridgedReferenceFrameEnum TEME = StateVectorAbridgedReferenceFrameEnum._(3);

  ///  No description available.
  static const StateVectorAbridgedReferenceFrameEnum ITRF = StateVectorAbridgedReferenceFrameEnum._(4);

  ///  No description available.
  static const StateVectorAbridgedReferenceFrameEnum GCRF = StateVectorAbridgedReferenceFrameEnum._(5);
  static const Map<int, StateVectorAbridgedReferenceFrameEnum> values = {
    0: J2000,
    1: EFG_TDR,
    2: ECR_ECEF,
    3: TEME,
  ...
  static const fb.Reader<StateVectorAbridgedReferenceFrameEnum> reader = _StateVectorAbridgedReferenceFrameEnumReader();

  @override
  String toString() {
    return 'StateVectorAbridgedReferenceFrameEnum{value: $value}';
  }
}

class _StateVectorAbridgedReferenceFrameEnumReader extends fb.Reader<StateVectorAbridgedReferenceFrameEnum> {
  const _StateVectorAbridgedReferenceFrameEnumReader();

  @override
  int get size => 1;

  @override
  StateVectorAbridgedReferenceFrameEnum read(fb.BufferContext bc, int offset) =>
      StateVectorAbridgedReferenceFrameEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class StateVectorAbridgedCovReferenceFrameEnum {
  final int value;
  const StateVectorAbridgedCovReferenceFrameEnum._(this.value);

  factory StateVectorAbridgedCovReferenceFrameEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum StateVectorAbridgedCovReferenceFrameEnum');
    }
    return result;
  }

  static StateVectorAbridgedCovReferenceFrameEnum? _createOrNull(int? value) => 
      value == null ? null : StateVectorAbridgedCovReferenceFrameEnum.fromValue(value);
  ...
  ///  No description available.
  static const StateVectorAbridgedCovReferenceFrameEnum J2000 = StateVectorAbridgedCovReferenceFrameEnum._(0);

  ///  No description available.
  static const StateVectorAbridgedCovReferenceFrameEnum UVW = StateVectorAbridgedCovReferenceFrameEnum._(1);
  static const Map<int, StateVectorAbridgedCovReferenceFrameEnum> values = {
    0: J2000,
    1: UVW};

  static const fb.Reader<StateVectorAbridgedCovReferenceFrameEnum> reader = _StateVectorAbridgedCovReferenceFrameEnumReader();

  @override
  String toString() {
    return 'StateVectorAbridgedCovReferenceFrameEnum{value: $value}';
  }
}

class _StateVectorAbridgedCovReferenceFrameEnumReader extends fb.Reader<StateVectorAbridgedCovReferenceFrameEnum> {
  const _StateVectorAbridgedCovReferenceFrameEnumReader();

  @override
  int get size => 1;

  @override
  StateVectorAbridgedCovReferenceFrameEnum read(fb.BufferContext bc, int offset) =>
      StateVectorAbridgedCovReferenceFrameEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class StateVectorAbridgedDataModeEnum {
  final int value;
  const StateVectorAbridgedDataModeEnum._(this.value);

  factory StateVectorAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum StateVectorAbridgedDataModeEnum');
    }
    return result;
  }

  static StateVectorAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : StateVectorAbridgedDataModeEnum.fromValue(value);
  ...
  static const StateVectorAbridgedDataModeEnum REAL = StateVectorAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const StateVectorAbridgedDataModeEnum TEST = StateVectorAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const StateVectorAbridgedDataModeEnum SIMULATED = StateVectorAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const StateVectorAbridgedDataModeEnum EXERCISE = StateVectorAbridgedDataModeEnum._(3);
  static const Map<int, StateVectorAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<StateVectorAbridgedDataModeEnum> reader = _StateVectorAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'StateVectorAbridgedDataModeEnum{value: $value}';
  }
}

class _StateVectorAbridgedDataModeEnumReader extends fb.Reader<StateVectorAbridgedDataModeEnum> {
  const _StateVectorAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  StateVectorAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      StateVectorAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class StateVectorAbridged {
  StateVectorAbridged._(this._bc, this._bcOffset);
  factory StateVectorAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<StateVectorAbridged> reader = _StateVectorAbridgedReader();
  ...
  StateVectorAbridgedReferenceFrameEnum get referenceFrame => StateVectorAbridgedReferenceFrameEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 34, 0));
  ...
  ///  Example: /// Example: J2000
  ///  Constraints: Minimum length = 0, Maximum length = 24
  StateVectorAbridgedCovReferenceFrameEnum get covReferenceFrame => StateVectorAbridgedCovReferenceFrameEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 38, 0));
  ...
  StateVectorAbridgedDataModeEnum get dataMode => StateVectorAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 172, 0));
  ///  Optional algorithm used to produce this record.
  ///  Example: /// Example: SAMPLE_ALGORITHM
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get algorithm => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 174);
  ///  Time the row was created in the database, auto-populated by the system.
  ///  Example: /// Example: 2018-01-01T16:00:00.123Z
  ///  Constraints: No constraints specified.
  String? get createdAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 176);
  ///  Application user who created the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 1, Maximum length = 64
  String? get createdBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 178);
  ///  Optional source-provided and searchable metadata or descriptor of the data.
  ///  Example: /// Example: descriptor
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get descriptor => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 180);
  ///  Optional identifier to track a commercial or marketplace transaction executed to produce this data.
  ///  Example: /// Example: transactionId
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get transactionId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 182);
...
class StateVectorAbridgedBuilder {
  ...
  int addReferenceFrame(StateVectorAbridgedReferenceFrameEnum? referenceFrame) {
  ...
  int addCovReferenceFrame(StateVectorAbridgedCovReferenceFrameEnum? covReferenceFrame) {
  ...
  int addDataMode(StateVectorAbridgedDataModeEnum? dataMode) {
...
class StateVectorAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  final double? _yvel;
  final double? _zvel;
  final StateVectorAbridgedReferenceFrameEnum? _referenceFrame;
  final List<String>? _cov;
  final StateVectorAbridgedCovReferenceFrameEnum? _covReferenceFrame;
  ...
  final StateVectorAbridgedDataModeEnum? _dataMode;
  ...
  StateVectorAbridgedObjectBuilder({
    ...
    double? yvel,
    double? zvel,
    StateVectorAbridgedReferenceFrameEnum? referenceFrame,
    List<String>? cov,
    StateVectorAbridgedCovReferenceFrameEnum? covReferenceFrame,
    String? covMethod,
    List<String>? eqCov,
    double? xposAlt1,
    double? yposAlt1,
    ...
    String? source,
    String? origin,
    StateVectorAbridgedDataModeEnum? dataMode,
    String? algorithm,
    String? createdAt,
    String? createdBy,
    String? descriptor,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(85, algorithmOffset);
    fbBuilder.addOffset(86, createdAtOffset);
    fbBuilder.addOffset(87, createdByOffset);
    fbBuilder.addOffset(88, descriptorOffset);
    fbBuilder.addOffset(89, transactionIdOffset);
