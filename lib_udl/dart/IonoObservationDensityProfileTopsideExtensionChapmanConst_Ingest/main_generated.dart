...
class IonoObservationDensityProfileTopsideExtensionChapmanConstIngest {
  IonoObservationDensityProfileTopsideExtensionChapmanConstIngest._(this._bc, this._bcOffset);
  factory IonoObservationDensityProfileTopsideExtensionChapmanConstIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationDensityProfileTopsideExtensionChapmanConstIngest> reader = _IonoObservationDensityProfileTopsideExtensionChapmanConstIngestReader();
  ...
  @override
  String toString() {
    return 'IonoObservationDensityProfileTopsideExtensionChapmanConstIngest{description: ${description}, nmF2: ${nmF2}, hmF2: ${hmF2}, scaleF2: ${scaleF2}, chi: ${chi}}';
  }
}

class _IonoObservationDensityProfileTopsideExtensionChapmanConstIngestReader extends fb.TableReader<IonoObservationDensityProfileTopsideExtensionChapmanConstIngest> {
  const _IonoObservationDensityProfileTopsideExtensionChapmanConstIngestReader();

  @override
  IonoObservationDensityProfileTopsideExtensionChapmanConstIngest createObject(fb.BufferContext bc, int offset) => 
    IonoObservationDensityProfileTopsideExtensionChapmanConstIngest._(bc, offset);
}

class IonoObservationDensityProfileTopsideExtensionChapmanConstIngestBuilder {
  IonoObservationDensityProfileTopsideExtensionChapmanConstIngestBuilder(this.fbBuilder);
...
class IonoObservationDensityProfileTopsideExtensionChapmanConstIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  IonoObservationDensityProfileTopsideExtensionChapmanConstIngestObjectBuilder({
    String? description,
    double? nmF2,
    double? hmF2,
    double? scaleF2,
