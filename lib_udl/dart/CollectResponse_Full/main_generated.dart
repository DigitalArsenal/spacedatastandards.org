...
class CollectResponseFullDataModeEnum {
  final int value;
  const CollectResponseFullDataModeEnum._(this.value);

  factory CollectResponseFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum CollectResponseFullDataModeEnum');
    }
    return result;
  }

  static CollectResponseFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : CollectResponseFullDataModeEnum.fromValue(value);
  ...
  static const CollectResponseFullDataModeEnum REAL = CollectResponseFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const CollectResponseFullDataModeEnum TEST = CollectResponseFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const CollectResponseFullDataModeEnum SIMULATED = CollectResponseFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const CollectResponseFullDataModeEnum EXERCISE = CollectResponseFullDataModeEnum._(3);
  static const Map<int, CollectResponseFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<CollectResponseFullDataModeEnum> reader = _CollectResponseFullDataModeEnumReader();

  @override
  String toString() {
    return 'CollectResponseFullDataModeEnum{value: $value}';
  }
}

class _CollectResponseFullDataModeEnumReader extends fb.Reader<CollectResponseFullDataModeEnum> {
  const _CollectResponseFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  CollectResponseFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      CollectResponseFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class CollectResponseFull {
  CollectResponseFull._(this._bc, this._bcOffset);
  factory CollectResponseFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<CollectResponseFull> reader = _CollectResponseFullReader();
  ...
  ///  Constraints: No constraints specified.
  String? get onOrbit => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 16);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get idPlan => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 20);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get status => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 24);
  ///  The actual start time of the collect or contact, in ISO 8601 UTC format.
  ///  Example: /// Example: 2018-01-01T16:00:00.123456Z
  ///  Constraints: No constraints specified.
  String? get actualStartTime => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 26);
  ///  The actual end time of the collect or contact, in ISO 8601 UTC format.
  ///  Example: /// Example: 2018-01-01T18:00:00.123456Z
  ///  Constraints: No constraints specified.
  String? get actualEndTime => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 28);
  ///  Proposed alternative start time, in ISO 8601 UTC format.
  ///  Example: /// Example: 2018-01-01T16:00:00.123456Z
  ///  Constraints: No constraints specified.
  String? get altStartTime => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 30);
  ///  Proposed alternative end time, in ISO 8601 UTC format.
  ///  Example: /// Example: 2018-01-01T18:00:00.123456Z
  ///  Constraints: No constraints specified.
  String? get altEndTime => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 32);
  ///  Error code associated with this request/response.
  ///  Example: /// Example: ERROR CODE
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get errCode => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 34);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get srcTyps => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 36);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get srcIds => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 38);
  ///  Notes or comments associated with this response.
  ///  Example: /// Example: Example notes
  ///  Constraints: Minimum length = 0, Maximum length = 1024
  String? get notes => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 40);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 36
  String? get idSensor => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 52);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get origSensorId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 54);
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  CollectResponseFullDataModeEnum get dataMode => CollectResponseFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 56, 0));
  ...
  @override
  String toString() {
    return 'CollectResponseFull{id: ${id}, classificationMarking: ${classificationMarking}, idRequest: ${idRequest}, idOnOrbit: ${idOnOrbit}, origObjectId: ${origObjectId}, satNo: ${satNo}, onOrbit: ${onOrbit}, taskId: ${taskId}, idPlan: ${idPlan}, externalId: ${externalId}, status: ${status}, actualStartTime: ${actualStartTime}, actualEndTime: ${actualEndTime}, altStartTime: ${altStartTime}, altEndTime: ${altEndTime}, errCode: ${errCode}, srcTyps: ${srcTyps}, srcIds: ${srcIds}, notes: ${notes}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, idSensor: ${idSensor}, origSensorId: ${origSensorId}, dataMode: ${dataMode}, tags: ${tags}}';
  }
}

class _CollectResponseFullReader extends fb.TableReader<CollectResponseFull> {
  const _CollectResponseFullReader();

  @override
  CollectResponseFull createObject(fb.BufferContext bc, int offset) => 
    CollectResponseFull._(bc, offset);
}

class CollectResponseFullBuilder {
  CollectResponseFullBuilder(this.fbBuilder);
  ...
  int addDataMode(CollectResponseFullDataModeEnum? dataMode) {
    fbBuilder.addInt8(26, dataMode?.value);
    return fbBuilder.offset;
  }
...
class CollectResponseFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final CollectResponseFullDataModeEnum? _dataMode;
  final List<String>? _tags;

  CollectResponseFullObjectBuilder({
    String? id,
    ...
    String? idSensor,
    String? origSensorId,
    CollectResponseFullDataModeEnum? dataMode,
    List<String>? tags,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(6, onOrbitOffset);
    fbBuilder.addOffset(7, taskIdOffset);
    fbBuilder.addOffset(8, idPlanOffset);
    fbBuilder.addOffset(9, externalIdOffset);
    fbBuilder.addOffset(10, statusOffset);
    fbBuilder.addOffset(11, actualStartTimeOffset);
    fbBuilder.addOffset(12, actualEndTimeOffset);
    fbBuilder.addOffset(13, altStartTimeOffset);
    fbBuilder.addOffset(14, altEndTimeOffset);
    fbBuilder.addOffset(15, errCodeOffset);
    fbBuilder.addOffset(16, srcTypsOffset);
    fbBuilder.addOffset(17, srcIdsOffset);
    fbBuilder.addOffset(18, notesOffset);
    ...
    fbBuilder.addOffset(24, idSensorOffset);
    fbBuilder.addOffset(25, origSensorIdOffset);
    fbBuilder.addInt8(26, _dataMode?.value);
