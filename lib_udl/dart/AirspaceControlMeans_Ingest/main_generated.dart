...
class AirspaceControlMeansIngestCmShapeEnum {
  final int value;
  const AirspaceControlMeansIngestCmShapeEnum._(this.value);

  factory AirspaceControlMeansIngestCmShapeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirspaceControlMeansIngestCmShapeEnum');
    }
    return result;
  }

  static AirspaceControlMeansIngestCmShapeEnum? _createOrNull(int? value) => 
      value == null ? null : AirspaceControlMeansIngestCmShapeEnum.fromValue(value);
  ...
  static const AirspaceControlMeansIngestCmShapeEnum POLYARC = AirspaceControlMeansIngestCmShapeEnum._(0);

  ///  No description available.
  static const AirspaceControlMeansIngestCmShapeEnum E1TRACK = AirspaceControlMeansIngestCmShapeEnum._(1);

  ///  No description available.
  static const AirspaceControlMeansIngestCmShapeEnum POLYGON = AirspaceControlMeansIngestCmShapeEnum._(2);

  ///  No description available.
  static const AirspaceControlMeansIngestCmShapeEnum CIRCLE = AirspaceControlMeansIngestCmShapeEnum._(3);

  ///  No description available.
  static const AirspaceControlMeansIngestCmShapeEnum CORRIDOR = AirspaceControlMeansIngestCmShapeEnum._(4);

  ///  No description available.
  static const AirspaceControlMeansIngestCmShapeEnum APOINT = AirspaceControlMeansIngestCmShapeEnum._(5);

  ///  No description available.
  static const AirspaceControlMeansIngestCmShapeEnum AORBIT = AirspaceControlMeansIngestCmShapeEnum._(6);

  ///  No description available.
  static const AirspaceControlMeansIngestCmShapeEnum GEOLINE = AirspaceControlMeansIngestCmShapeEnum._(7);
  static const Map<int, AirspaceControlMeansIngestCmShapeEnum> values = {
    0: POLYARC,
    1: E1TRACK,
    2: POLYGON,
    3: CIRCLE,
  ...
  static const fb.Reader<AirspaceControlMeansIngestCmShapeEnum> reader = _AirspaceControlMeansIngestCmShapeEnumReader();

  @override
  String toString() {
    return 'AirspaceControlMeansIngestCmShapeEnum{value: $value}';
  }
}

class _AirspaceControlMeansIngestCmShapeEnumReader extends fb.Reader<AirspaceControlMeansIngestCmShapeEnum> {
  const _AirspaceControlMeansIngestCmShapeEnumReader();

  @override
  int get size => 1;

  @override
  AirspaceControlMeansIngestCmShapeEnum read(fb.BufferContext bc, int offset) =>
      AirspaceControlMeansIngestCmShapeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// A conditional nested segment to report multiple airspace control means within a particular airspace control means status.
class AirspaceControlMeansIngest {
  AirspaceControlMeansIngest._(this._bc, this._bcOffset);
  factory AirspaceControlMeansIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirspaceControlMeansIngest> reader = _AirspaceControlMeansIngestReader();
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 8
  AirspaceControlMeansIngestCmShapeEnum get cmShape => AirspaceControlMeansIngestCmShapeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 8, 0));
...
class AirspaceControlMeansIngestBuilder {
  ...
  int addCmShape(AirspaceControlMeansIngestCmShapeEnum? cmShape) {
...
class AirspaceControlMeansIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _cmType;
  final String? _cmId;
  final AirspaceControlMeansIngestCmShapeEnum? _cmShape;
  final String? _usage;
  ...
  AirspaceControlMeansIngestObjectBuilder({
    String? cmType,
    String? cmId,
    AirspaceControlMeansIngestCmShapeEnum? cmShape,
    String? usage,
    String? link16Id,
