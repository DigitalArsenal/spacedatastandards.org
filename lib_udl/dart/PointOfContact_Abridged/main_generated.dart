...
class PointOfContactAbridged {
  PointOfContactAbridged._(this._bc, this._bcOffset);
  factory PointOfContactAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PointOfContactAbridged> reader = _PointOfContactAbridgedReader();
  ...
  @override
  String toString() {
    return 'PointOfContactAbridged{pocSequenceId: ${pocSequenceId}, pocTypeName: ${pocTypeName}, pocName: ${pocName}, office: ${office}, username: ${username}, rank: ${rank}, pocOrg: ${pocOrg}, phone: ${phone}, remark: ${remark}}';
  }
}

class _PointOfContactAbridgedReader extends fb.TableReader<PointOfContactAbridged> {
  const _PointOfContactAbridgedReader();

  @override
  PointOfContactAbridged createObject(fb.BufferContext bc, int offset) => 
    PointOfContactAbridged._(bc, offset);
}

class PointOfContactAbridgedBuilder {
  PointOfContactAbridgedBuilder(this.fbBuilder);
...
class PointOfContactAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  PointOfContactAbridgedObjectBuilder({
    int? pocSequenceId,
    String? pocTypeName,
    String? pocName,
    String? office,
