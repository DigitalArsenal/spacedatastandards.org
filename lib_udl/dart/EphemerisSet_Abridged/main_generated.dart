...
class EphemerisSetAbridgedReferenceFrameEnum {
  final int value;
  const EphemerisSetAbridgedReferenceFrameEnum._(this.value);

  factory EphemerisSetAbridgedReferenceFrameEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EphemerisSetAbridgedReferenceFrameEnum');
    }
    return result;
  }

  static EphemerisSetAbridgedReferenceFrameEnum? _createOrNull(int? value) => 
      value == null ? null : EphemerisSetAbridgedReferenceFrameEnum.fromValue(value);
  ...
  static const EphemerisSetAbridgedReferenceFrameEnum J2000 = EphemerisSetAbridgedReferenceFrameEnum._(0);

  ///  No description available.
  static const EphemerisSetAbridgedReferenceFrameEnum EFG_TDR = EphemerisSetAbridgedReferenceFrameEnum._(1);

  ///  No description available.
  static const EphemerisSetAbridgedReferenceFrameEnum ECR_ECEF = EphemerisSetAbridgedReferenceFrameEnum._(2);

  ///  No description available.
  static const EphemerisSetAbridgedReferenceFrameEnum TEME = EphemerisSetAbridgedReferenceFrameEnum._(3);

  ///  No description available.
  static const EphemerisSetAbridgedReferenceFrameEnum ITRF = EphemerisSetAbridgedReferenceFrameEnum._(4);

  ///  No description available.
  static const EphemerisSetAbridgedReferenceFrameEnum GCRF = EphemerisSetAbridgedReferenceFrameEnum._(5);
  static const Map<int, EphemerisSetAbridgedReferenceFrameEnum> values = {
    0: J2000,
    1: EFG_TDR,
    2: ECR_ECEF,
    3: TEME,
  ...
  static const fb.Reader<EphemerisSetAbridgedReferenceFrameEnum> reader = _EphemerisSetAbridgedReferenceFrameEnumReader();

  @override
  String toString() {
    return 'EphemerisSetAbridgedReferenceFrameEnum{value: $value}';
  }
}

class _EphemerisSetAbridgedReferenceFrameEnumReader extends fb.Reader<EphemerisSetAbridgedReferenceFrameEnum> {
  const _EphemerisSetAbridgedReferenceFrameEnumReader();

  @override
  int get size => 1;

  @override
  EphemerisSetAbridgedReferenceFrameEnum read(fb.BufferContext bc, int offset) =>
      EphemerisSetAbridgedReferenceFrameEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class EphemerisSetAbridgedCovReferenceFrameEnum {
  final int value;
  const EphemerisSetAbridgedCovReferenceFrameEnum._(this.value);

  factory EphemerisSetAbridgedCovReferenceFrameEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EphemerisSetAbridgedCovReferenceFrameEnum');
    }
    return result;
  }

  static EphemerisSetAbridgedCovReferenceFrameEnum? _createOrNull(int? value) => 
      value == null ? null : EphemerisSetAbridgedCovReferenceFrameEnum.fromValue(value);
  ...
  ///  No description available.
  static const EphemerisSetAbridgedCovReferenceFrameEnum J2000 = EphemerisSetAbridgedCovReferenceFrameEnum._(0);

  ///  No description available.
  static const EphemerisSetAbridgedCovReferenceFrameEnum UVW = EphemerisSetAbridgedCovReferenceFrameEnum._(1);
  static const Map<int, EphemerisSetAbridgedCovReferenceFrameEnum> values = {
    0: J2000,
    1: UVW};

  static const fb.Reader<EphemerisSetAbridgedCovReferenceFrameEnum> reader = _EphemerisSetAbridgedCovReferenceFrameEnumReader();

  @override
  String toString() {
    return 'EphemerisSetAbridgedCovReferenceFrameEnum{value: $value}';
  }
}

class _EphemerisSetAbridgedCovReferenceFrameEnumReader extends fb.Reader<EphemerisSetAbridgedCovReferenceFrameEnum> {
  const _EphemerisSetAbridgedCovReferenceFrameEnumReader();

  @override
  int get size => 1;

  @override
  EphemerisSetAbridgedCovReferenceFrameEnum read(fb.BufferContext bc, int offset) =>
      EphemerisSetAbridgedCovReferenceFrameEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class EphemerisSetAbridgedDataModeEnum {
  final int value;
  const EphemerisSetAbridgedDataModeEnum._(this.value);

  factory EphemerisSetAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EphemerisSetAbridgedDataModeEnum');
    }
    return result;
  }

  static EphemerisSetAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EphemerisSetAbridgedDataModeEnum.fromValue(value);
  ...
  static const EphemerisSetAbridgedDataModeEnum REAL = EphemerisSetAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EphemerisSetAbridgedDataModeEnum TEST = EphemerisSetAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EphemerisSetAbridgedDataModeEnum SIMULATED = EphemerisSetAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EphemerisSetAbridgedDataModeEnum EXERCISE = EphemerisSetAbridgedDataModeEnum._(3);
  static const Map<int, EphemerisSetAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EphemerisSetAbridgedDataModeEnum> reader = _EphemerisSetAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'EphemerisSetAbridgedDataModeEnum{value: $value}';
  }
}

class _EphemerisSetAbridgedDataModeEnumReader extends fb.Reader<EphemerisSetAbridgedDataModeEnum> {
  const _EphemerisSetAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EphemerisSetAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      EphemerisSetAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class EphemerisSetAbridged {
  EphemerisSetAbridged._(this._bc, this._bcOffset);
  factory EphemerisSetAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EphemerisSetAbridged> reader = _EphemerisSetAbridgedReader();
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 24
  EphemerisSetAbridgedReferenceFrameEnum get referenceFrame => EphemerisSetAbridgedReferenceFrameEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 68, 0));
  ///  The reference frame of the covariance matrix elements. If the covReferenceFrame is null it is assumed to be J2000.
  ///  Example: /// Example: J2000
  ///  Constraints: Minimum length = 0, Maximum length = 24
  EphemerisSetAbridgedCovReferenceFrameEnum get covReferenceFrame => EphemerisSetAbridgedCovReferenceFrameEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 70, 0));
  ...
  EphemerisSetAbridgedDataModeEnum get dataMode => EphemerisSetAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 80, 0));
...
class EphemerisSetAbridgedBuilder {
  ...
  int addReferenceFrame(EphemerisSetAbridgedReferenceFrameEnum? referenceFrame) {
    fbBuilder.addInt8(32, referenceFrame?.value);
    return fbBuilder.offset;
  }
  int addCovReferenceFrame(EphemerisSetAbridgedCovReferenceFrameEnum? covReferenceFrame) {
  ...
  int addDataMode(EphemerisSetAbridgedDataModeEnum? dataMode) {
...
class EphemerisSetAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EphemerisSetAbridgedReferenceFrameEnum? _referenceFrame;
  final EphemerisSetAbridgedCovReferenceFrameEnum? _covReferenceFrame;
  final String? _createdAt;
  final String? _createdBy;
  final String? _source;
  final String? _origin;
  final EphemerisSetAbridgedDataModeEnum? _dataMode;
  final int? _satNo;
  final String? _transactionId;
  final String? _origNetwork;

  EphemerisSetAbridgedObjectBuilder({
    String? id,
    ...
    String? description,
    String? descriptor,
    EphemerisSetAbridgedReferenceFrameEnum? referenceFrame,
    EphemerisSetAbridgedCovReferenceFrameEnum? covReferenceFrame,
    String? createdAt,
    String? createdBy,
    String? source,
    String? origin,
    EphemerisSetAbridgedDataModeEnum? dataMode,
    int? satNo,
