...
class EphemerisAbridgedDataModeEnum {
  final int value;
  const EphemerisAbridgedDataModeEnum._(this.value);

  factory EphemerisAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EphemerisAbridgedDataModeEnum');
    }
    return result;
  }

  static EphemerisAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EphemerisAbridgedDataModeEnum.fromValue(value);
  ...
  static const EphemerisAbridgedDataModeEnum REAL = EphemerisAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EphemerisAbridgedDataModeEnum TEST = EphemerisAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EphemerisAbridgedDataModeEnum SIMULATED = EphemerisAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EphemerisAbridgedDataModeEnum EXERCISE = EphemerisAbridgedDataModeEnum._(3);
  static const Map<int, EphemerisAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EphemerisAbridgedDataModeEnum> reader = _EphemerisAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'EphemerisAbridgedDataModeEnum{value: $value}';
  }
}

class _EphemerisAbridgedDataModeEnumReader extends fb.Reader<EphemerisAbridgedDataModeEnum> {
  const _EphemerisAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EphemerisAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      EphemerisAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class EphemerisAbridged {
  EphemerisAbridged._(this._bc, this._bcOffset);
  factory EphemerisAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EphemerisAbridged> reader = _EphemerisAbridgedReader();
  ...
  EphemerisAbridgedDataModeEnum get dataMode => EphemerisAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 38, 0));
  ...
  @override
  String toString() {
    return 'EphemerisAbridged{id: ${id}, classificationMarking: ${classificationMarking}, esId: ${esId}, ts: ${ts}, xpos: ${xpos}, ypos: ${ypos}, zpos: ${zpos}, xvel: ${xvel}, yvel: ${yvel}, zvel: ${zvel}, xaccel: ${xaccel}, yaccel: ${yaccel}, zaccel: ${zaccel}, cov: ${cov}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, dataMode: ${dataMode}, idOnOrbit: ${idOnOrbit}, origObjectId: ${origObjectId}, origin: ${origin}}';
  }
}

class _EphemerisAbridgedReader extends fb.TableReader<EphemerisAbridged> {
  const _EphemerisAbridgedReader();

  @override
  EphemerisAbridged createObject(fb.BufferContext bc, int offset) => 
    EphemerisAbridged._(bc, offset);
}

class EphemerisAbridgedBuilder {
  EphemerisAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(EphemerisAbridgedDataModeEnum? dataMode) {
...
class EphemerisAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EphemerisAbridgedDataModeEnum? _dataMode;
  final String? _idOnOrbit;
  final String? _origObjectId;
  final String? _origin;

  EphemerisAbridgedObjectBuilder({
    String? id,
    ...
    String? createdBy,
    String? source,
    EphemerisAbridgedDataModeEnum? dataMode,
    String? idOnOrbit,
    String? origObjectId,
    String? origin,
  })
