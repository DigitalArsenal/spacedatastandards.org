...
class SensorAbridgedDataModeEnum {
  final int value;
  const SensorAbridgedDataModeEnum._(this.value);

  factory SensorAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SensorAbridgedDataModeEnum');
    }
    return result;
  }

  static SensorAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SensorAbridgedDataModeEnum.fromValue(value);
  ...
  static const SensorAbridgedDataModeEnum REAL = SensorAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SensorAbridgedDataModeEnum TEST = SensorAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SensorAbridgedDataModeEnum SIMULATED = SensorAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SensorAbridgedDataModeEnum EXERCISE = SensorAbridgedDataModeEnum._(3);
  static const Map<int, SensorAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SensorAbridgedDataModeEnum> reader = _SensorAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'SensorAbridgedDataModeEnum{value: $value}';
  }
}

class _SensorAbridgedDataModeEnumReader extends fb.Reader<SensorAbridgedDataModeEnum> {
  const _SensorAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SensorAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      SensorAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Model representation of observation data for electro-optical based sensor phenomenologies.
class SensorAbridged {
  SensorAbridged._(this._bc, this._bcOffset);
  factory SensorAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SensorAbridged> reader = _SensorAbridgedReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SensorAbridgedDataModeEnum get dataMode => SensorAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 26, 0));
  ...
  ///  Constraints: No constraints specified.
  List<String>? get sensorcharacteristics => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 34);
  ///  Collection of SensorStats which contain statistics of a sensor.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  List<String>? get sensorStats => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 36);
  ///  Sensorlimits define 0 to many limits of a particular sensor in terms of observation coverage of on-orbit objects.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  List<String>? get sensorlimitsCollection => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 38);
  ...
  String? get idEntity => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 42);
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  String? get sensorObservationType => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 44);
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  String? get sensorType => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 46);

  @override
  String toString() {
    return 'SensorAbridged{idSensor: ${idSensor}, sensorName: ${sensorName}, classificationMarking: ${classificationMarking}, sensorNumber: ${sensorNumber}, shortName: ${shortName}, dataControl: ${dataControl}, afId: ${afId}, asrType: ${asrType}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}, createdAt: ${createdAt}, createdBy: ${createdBy}, active: ${active}, sensorcharacteristics: ${sensorcharacteristics}, sensorStats: ${sensorStats}, sensorlimitsCollection: ${sensorlimitsCollection}, entity: ${entity}, idEntity: ${idEntity}, sensorObservationType: ${sensorObservationType}, sensorType: ${sensorType}}';
  }
}

class _SensorAbridgedReader extends fb.TableReader<SensorAbridged> {
  const _SensorAbridgedReader();

  @override
  SensorAbridged createObject(fb.BufferContext bc, int offset) => 
    SensorAbridged._(bc, offset);
}

class SensorAbridgedBuilder {
  SensorAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(SensorAbridgedDataModeEnum? dataMode) {
...
class SensorAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  final SensorAbridgedDataModeEnum? _dataMode;
  ...
  SensorAbridgedObjectBuilder({
    ...
    String? origin,
    String? origNetwork,
    SensorAbridgedDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    bool? active,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(15, sensorcharacteristicsOffset);
    fbBuilder.addOffset(16, sensorStatsOffset);
    fbBuilder.addOffset(17, sensorlimitsCollectionOffset);
    fbBuilder.addOffset(18, entityOffset);
    fbBuilder.addOffset(19, idEntityOffset);
    fbBuilder.addOffset(20, sensorObservationTypeOffset);
    fbBuilder.addOffset(21, sensorTypeOffset);
    return fbBuilder.endTable();
  }
