...
class SkyImageryAbridgedDataModeEnum {
  final int value;
  const SkyImageryAbridgedDataModeEnum._(this.value);

  factory SkyImageryAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SkyImageryAbridgedDataModeEnum');
    }
    return result;
  }

  static SkyImageryAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SkyImageryAbridgedDataModeEnum.fromValue(value);
  ...
  static const SkyImageryAbridgedDataModeEnum REAL = SkyImageryAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SkyImageryAbridgedDataModeEnum TEST = SkyImageryAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SkyImageryAbridgedDataModeEnum SIMULATED = SkyImageryAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SkyImageryAbridgedDataModeEnum EXERCISE = SkyImageryAbridgedDataModeEnum._(3);
  static const Map<int, SkyImageryAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SkyImageryAbridgedDataModeEnum> reader = _SkyImageryAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'SkyImageryAbridgedDataModeEnum{value: $value}';
  }
}

class _SkyImageryAbridgedDataModeEnumReader extends fb.Reader<SkyImageryAbridgedDataModeEnum> {
  const _SkyImageryAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SkyImageryAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      SkyImageryAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class SkyImageryAbridged {
  SkyImageryAbridged._(this._bc, this._bcOffset);
  factory SkyImageryAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SkyImageryAbridged> reader = _SkyImageryAbridgedReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SkyImageryAbridgedDataModeEnum get dataMode => SkyImageryAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 96, 0));
...
class SkyImageryAbridgedBuilder {
  ...
  int addDataMode(SkyImageryAbridgedDataModeEnum? dataMode) {
...
class SkyImageryAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SkyImageryAbridgedDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;

  SkyImageryAbridgedObjectBuilder({
    String? id,
    ...
    String? sourceDl,
    String? description,
    SkyImageryAbridgedDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
  })
      : _id = id,
