...
class StarCatalogAbridgedAstrometryOriginEnum {
  final int value;
  const StarCatalogAbridgedAstrometryOriginEnum._(this.value);

  factory StarCatalogAbridgedAstrometryOriginEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum StarCatalogAbridgedAstrometryOriginEnum');
    }
    return result;
  }

  static StarCatalogAbridgedAstrometryOriginEnum? _createOrNull(int? value) => 
      value == null ? null : StarCatalogAbridgedAstrometryOriginEnum.fromValue(value);
  ...
  static const StarCatalogAbridgedAstrometryOriginEnum GAIADR3 = StarCatalogAbridgedAstrometryOriginEnum._(0);

  ///  No description available.
  static const StarCatalogAbridgedAstrometryOriginEnum HIPPARCOS = StarCatalogAbridgedAstrometryOriginEnum._(1);

  ///  No description available.
  static const StarCatalogAbridgedAstrometryOriginEnum USNOBSC = StarCatalogAbridgedAstrometryOriginEnum._(2);
  static const Map<int, StarCatalogAbridgedAstrometryOriginEnum> values = {
    0: GAIADR3,
    1: HIPPARCOS,
    2: USNOBSC};

  static const fb.Reader<StarCatalogAbridgedAstrometryOriginEnum> reader = _StarCatalogAbridgedAstrometryOriginEnumReader();

  @override
  String toString() {
    return 'StarCatalogAbridgedAstrometryOriginEnum{value: $value}';
  }
}

class _StarCatalogAbridgedAstrometryOriginEnumReader extends fb.Reader<StarCatalogAbridgedAstrometryOriginEnum> {
  const _StarCatalogAbridgedAstrometryOriginEnumReader();

  @override
  int get size => 1;

  @override
  StarCatalogAbridgedAstrometryOriginEnum read(fb.BufferContext bc, int offset) =>
      StarCatalogAbridgedAstrometryOriginEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class StarCatalogAbridgedDataModeEnum {
  final int value;
  const StarCatalogAbridgedDataModeEnum._(this.value);

  factory StarCatalogAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum StarCatalogAbridgedDataModeEnum');
    }
    return result;
  }

  static StarCatalogAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : StarCatalogAbridgedDataModeEnum.fromValue(value);
  ...
  static const StarCatalogAbridgedDataModeEnum REAL = StarCatalogAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const StarCatalogAbridgedDataModeEnum TEST = StarCatalogAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const StarCatalogAbridgedDataModeEnum SIMULATED = StarCatalogAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const StarCatalogAbridgedDataModeEnum EXERCISE = StarCatalogAbridgedDataModeEnum._(3);
  static const Map<int, StarCatalogAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<StarCatalogAbridgedDataModeEnum> reader = _StarCatalogAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'StarCatalogAbridgedDataModeEnum{value: $value}';
  }
}

class _StarCatalogAbridgedDataModeEnumReader extends fb.Reader<StarCatalogAbridgedDataModeEnum> {
  const _StarCatalogAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  StarCatalogAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      StarCatalogAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// The star catalog provides the position, proper motion, parallax, and photometric magnitudes at various bandpasses of a star.
class StarCatalogAbridged {
  StarCatalogAbridged._(this._bc, this._bcOffset);
  factory StarCatalogAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<StarCatalogAbridged> reader = _StarCatalogAbridgedReader();
  ...
  StarCatalogAbridgedAstrometryOriginEnum get astrometryOrigin => StarCatalogAbridgedAstrometryOriginEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 42, 0));
...
class StarCatalogAbridgedBuilder {
  ...
  int addAstrometryOrigin(StarCatalogAbridgedAstrometryOriginEnum? astrometryOrigin) {
  ...
  int addDataMode(StarCatalogAbridgedDataModeEnum? dataMode) {
...
class StarCatalogAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final StarCatalogAbridgedAstrometryOriginEnum? _astrometryOrigin;
  ...
  final StarCatalogAbridgedDataModeEnum? _dataMode;

  StarCatalogAbridgedObjectBuilder({
    String? id,
    ...
    double? pmdecUnc,
    bool? pmUncFlag,
    StarCatalogAbridgedAstrometryOriginEnum? astrometryOrigin,
    double? starEpoch,
    double? gmag,
    double? gmagUnc,
    double? bpmag,
    ...
    String? origin,
    String? origNetwork,
    StarCatalogAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
