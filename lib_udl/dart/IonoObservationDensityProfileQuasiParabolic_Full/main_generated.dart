...
class IonoObservationDensityProfileQuasiParabolicFull {
  IonoObservationDensityProfileQuasiParabolicFull._(this._bc, this._bcOffset);
  factory IonoObservationDensityProfileQuasiParabolicFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationDensityProfileQuasiParabolicFull> reader = _IonoObservationDensityProfileQuasiParabolicFullReader();
  ...
  @override
  String toString() {
    return 'IonoObservationDensityProfileQuasiParabolicFull{description: ${description}, earthRadius: ${earthRadius}, quasiParabolicSegments: ${quasiParabolicSegments}}';
  }
}

class _IonoObservationDensityProfileQuasiParabolicFullReader extends fb.TableReader<IonoObservationDensityProfileQuasiParabolicFull> {
  const _IonoObservationDensityProfileQuasiParabolicFullReader();

  @override
  IonoObservationDensityProfileQuasiParabolicFull createObject(fb.BufferContext bc, int offset) => 
    IonoObservationDensityProfileQuasiParabolicFull._(bc, offset);
}

class IonoObservationDensityProfileQuasiParabolicFullBuilder {
  IonoObservationDensityProfileQuasiParabolicFullBuilder(this.fbBuilder);
...
class IonoObservationDensityProfileQuasiParabolicFullObjectBuilder extends fb.ObjectBuilder {
  final String? _description;
  final double? _earthRadius;
  final List<String>? _quasiParabolicSegments;

  IonoObservationDensityProfileQuasiParabolicFullObjectBuilder({
    String? description,
    double? earthRadius,
