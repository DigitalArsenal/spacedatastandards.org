...
class AttitudeDataAbridgedDataModeEnum {
  final int value;
  const AttitudeDataAbridgedDataModeEnum._(this.value);

  factory AttitudeDataAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AttitudeDataAbridgedDataModeEnum');
    }
    return result;
  }

  static AttitudeDataAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AttitudeDataAbridgedDataModeEnum.fromValue(value);
  ...
  static const AttitudeDataAbridgedDataModeEnum REAL = AttitudeDataAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AttitudeDataAbridgedDataModeEnum TEST = AttitudeDataAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AttitudeDataAbridgedDataModeEnum SIMULATED = AttitudeDataAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AttitudeDataAbridgedDataModeEnum EXERCISE = AttitudeDataAbridgedDataModeEnum._(3);
  static const Map<int, AttitudeDataAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AttitudeDataAbridgedDataModeEnum> reader = _AttitudeDataAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'AttitudeDataAbridgedDataModeEnum{value: $value}';
  }
}

class _AttitudeDataAbridgedDataModeEnumReader extends fb.Reader<AttitudeDataAbridgedDataModeEnum> {
  const _AttitudeDataAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AttitudeDataAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      AttitudeDataAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AttitudeDataAbridged {
  AttitudeDataAbridged._(this._bc, this._bcOffset);
  factory AttitudeDataAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AttitudeDataAbridged> reader = _AttitudeDataAbridgedReader();
  ...
  AttitudeDataAbridgedDataModeEnum get dataMode => AttitudeDataAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 66, 0));
  ...
  @override
  String toString() {
    return 'AttitudeDataAbridged{id: ${id}, classificationMarking: ${classificationMarking}, asId: ${asId}, idOnOrbit: ${idOnOrbit}, satNo: ${satNo}, origObjectId: ${origObjectId}, ts: ${ts}, motionType: ${motionType}, q1: ${q1}, q2: ${q2}, q3: ${q3}, qc: ${qc}, q1Dot: ${q1Dot}, q2Dot: ${q2Dot}, q3Dot: ${q3Dot}, qcDot: ${qcDot}, xAngle: ${xAngle}, yAngle: ${yAngle}, zAngle: ${zAngle}, xRate: ${xRate}, yRate: ${yRate}, zRate: ${zRate}, ra: ${ra}, declination: ${declination}, coningAngle: ${coningAngle}, precPeriod: ${precPeriod}, spinPeriod: ${spinPeriod}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, origNetwork: ${origNetwork}}';
  }
}

class _AttitudeDataAbridgedReader extends fb.TableReader<AttitudeDataAbridged> {
  const _AttitudeDataAbridgedReader();

  @override
  AttitudeDataAbridged createObject(fb.BufferContext bc, int offset) => 
    AttitudeDataAbridged._(bc, offset);
}

class AttitudeDataAbridgedBuilder {
  AttitudeDataAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(AttitudeDataAbridgedDataModeEnum? dataMode) {
...
class AttitudeDataAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AttitudeDataAbridgedDataModeEnum? _dataMode;
  final String? _origNetwork;

  AttitudeDataAbridgedObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    AttitudeDataAbridgedDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
