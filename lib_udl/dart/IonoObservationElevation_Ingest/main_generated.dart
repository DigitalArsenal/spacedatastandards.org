...
class IonoObservationElevationIngest {
  IonoObservationElevationIngest._(this._bc, this._bcOffset);
  factory IonoObservationElevationIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationElevationIngest> reader = _IonoObservationElevationIngestReader();
  ...
  @override
  String toString() {
    return 'IonoObservationElevationIngest{notes: ${notes}, dimensions: ${dimensions}, dimensionName: ${dimensionName}, data: ${data}}';
  }
}

class _IonoObservationElevationIngestReader extends fb.TableReader<IonoObservationElevationIngest> {
  const _IonoObservationElevationIngestReader();

  @override
  IonoObservationElevationIngest createObject(fb.BufferContext bc, int offset) => 
    IonoObservationElevationIngest._(bc, offset);
}

class IonoObservationElevationIngestBuilder {
  IonoObservationElevationIngestBuilder(this.fbBuilder);
...
class IonoObservationElevationIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _notes;
  final List<String>? _dimensions;
  final List<String>? _dimensionName;
  final List<String>? _data;

  IonoObservationElevationIngestObjectBuilder({
    String? notes,
