...
class SensorlimitsIngestDataModeEnum {
  final int value;
  const SensorlimitsIngestDataModeEnum._(this.value);

  factory SensorlimitsIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SensorlimitsIngestDataModeEnum');
    }
    return result;
  }

  static SensorlimitsIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SensorlimitsIngestDataModeEnum.fromValue(value);
  ...
  static const SensorlimitsIngestDataModeEnum REAL = SensorlimitsIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SensorlimitsIngestDataModeEnum TEST = SensorlimitsIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SensorlimitsIngestDataModeEnum SIMULATED = SensorlimitsIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SensorlimitsIngestDataModeEnum EXERCISE = SensorlimitsIngestDataModeEnum._(3);
  static const Map<int, SensorlimitsIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SensorlimitsIngestDataModeEnum> reader = _SensorlimitsIngestDataModeEnumReader();

  @override
  String toString() {
    return 'SensorlimitsIngestDataModeEnum{value: $value}';
  }
}

class _SensorlimitsIngestDataModeEnumReader extends fb.Reader<SensorlimitsIngestDataModeEnum> {
  const _SensorlimitsIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SensorlimitsIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      SensorlimitsIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Sensorlimits define 0 to many limits of a particular sensor in terms of observation coverage of on-orbit objects.
class SensorlimitsIngest {
  SensorlimitsIngest._(this._bc, this._bcOffset);
  factory SensorlimitsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SensorlimitsIngest> reader = _SensorlimitsIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SensorlimitsIngestDataModeEnum get dataMode => SensorlimitsIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 28, 0));
...
class SensorlimitsIngestBuilder {
  ...
  int addDataMode(SensorlimitsIngestDataModeEnum? dataMode) {
...
class SensorlimitsIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  final SensorlimitsIngestDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final String? _idSensor;

  SensorlimitsIngestObjectBuilder({
    ...
    String? source,
    SensorlimitsIngestDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? idSensor,
  })
