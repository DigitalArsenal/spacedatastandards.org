...
class AircraftMissionRemarksIngest {
  AircraftMissionRemarksIngest._(this._bc, this._bcOffset);
  factory AircraftMissionRemarksIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AircraftMissionRemarksIngest> reader = _AircraftMissionRemarksIngestReader();
  ...
  @override
  String toString() {
    return 'AircraftMissionRemarksIngest{gdssRemarkId: ${gdssRemarkId}, type: ${type}, text: ${text}, date: ${date}, user: ${user}, itineraryNum: ${itineraryNum}}';
  }
}

class _AircraftMissionRemarksIngestReader extends fb.TableReader<AircraftMissionRemarksIngest> {
  const _AircraftMissionRemarksIngestReader();

  @override
  AircraftMissionRemarksIngest createObject(fb.BufferContext bc, int offset) => 
    AircraftMissionRemarksIngest._(bc, offset);
}

class AircraftMissionRemarksIngestBuilder {
  AircraftMissionRemarksIngestBuilder(this.fbBuilder);
...
class AircraftMissionRemarksIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  AircraftMissionRemarksIngestObjectBuilder({
    String? gdssRemarkId,
    String? type,
    String? text,
    String? date,
