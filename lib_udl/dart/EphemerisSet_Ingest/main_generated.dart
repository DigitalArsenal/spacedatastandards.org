...
class EphemerisSetIngestReferenceFrameEnum {
  final int value;
  const EphemerisSetIngestReferenceFrameEnum._(this.value);

  factory EphemerisSetIngestReferenceFrameEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EphemerisSetIngestReferenceFrameEnum');
    }
    return result;
  }

  static EphemerisSetIngestReferenceFrameEnum? _createOrNull(int? value) => 
      value == null ? null : EphemerisSetIngestReferenceFrameEnum.fromValue(value);
  ...
  static const EphemerisSetIngestReferenceFrameEnum J2000 = EphemerisSetIngestReferenceFrameEnum._(0);

  ///  No description available.
  static const EphemerisSetIngestReferenceFrameEnum EFG_TDR = EphemerisSetIngestReferenceFrameEnum._(1);

  ///  No description available.
  static const EphemerisSetIngestReferenceFrameEnum ECR_ECEF = EphemerisSetIngestReferenceFrameEnum._(2);

  ///  No description available.
  static const EphemerisSetIngestReferenceFrameEnum TEME = EphemerisSetIngestReferenceFrameEnum._(3);

  ///  No description available.
  static const EphemerisSetIngestReferenceFrameEnum ITRF = EphemerisSetIngestReferenceFrameEnum._(4);

  ///  No description available.
  static const EphemerisSetIngestReferenceFrameEnum GCRF = EphemerisSetIngestReferenceFrameEnum._(5);
  static const Map<int, EphemerisSetIngestReferenceFrameEnum> values = {
    0: J2000,
    1: EFG_TDR,
    2: ECR_ECEF,
    3: TEME,
  ...
  static const fb.Reader<EphemerisSetIngestReferenceFrameEnum> reader = _EphemerisSetIngestReferenceFrameEnumReader();

  @override
  String toString() {
    return 'EphemerisSetIngestReferenceFrameEnum{value: $value}';
  }
}

class _EphemerisSetIngestReferenceFrameEnumReader extends fb.Reader<EphemerisSetIngestReferenceFrameEnum> {
  const _EphemerisSetIngestReferenceFrameEnumReader();

  @override
  int get size => 1;

  @override
  EphemerisSetIngestReferenceFrameEnum read(fb.BufferContext bc, int offset) =>
      EphemerisSetIngestReferenceFrameEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class EphemerisSetIngestCovReferenceFrameEnum {
  final int value;
  const EphemerisSetIngestCovReferenceFrameEnum._(this.value);

  factory EphemerisSetIngestCovReferenceFrameEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EphemerisSetIngestCovReferenceFrameEnum');
    }
    return result;
  }

  static EphemerisSetIngestCovReferenceFrameEnum? _createOrNull(int? value) => 
      value == null ? null : EphemerisSetIngestCovReferenceFrameEnum.fromValue(value);
  ...
  ///  No description available.
  static const EphemerisSetIngestCovReferenceFrameEnum J2000 = EphemerisSetIngestCovReferenceFrameEnum._(0);

  ///  No description available.
  static const EphemerisSetIngestCovReferenceFrameEnum UVW = EphemerisSetIngestCovReferenceFrameEnum._(1);
  static const Map<int, EphemerisSetIngestCovReferenceFrameEnum> values = {
    0: J2000,
    1: UVW};

  static const fb.Reader<EphemerisSetIngestCovReferenceFrameEnum> reader = _EphemerisSetIngestCovReferenceFrameEnumReader();

  @override
  String toString() {
    return 'EphemerisSetIngestCovReferenceFrameEnum{value: $value}';
  }
}

class _EphemerisSetIngestCovReferenceFrameEnumReader extends fb.Reader<EphemerisSetIngestCovReferenceFrameEnum> {
  const _EphemerisSetIngestCovReferenceFrameEnumReader();

  @override
  int get size => 1;

  @override
  EphemerisSetIngestCovReferenceFrameEnum read(fb.BufferContext bc, int offset) =>
      EphemerisSetIngestCovReferenceFrameEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class EphemerisSetIngestDataModeEnum {
  final int value;
  const EphemerisSetIngestDataModeEnum._(this.value);

  factory EphemerisSetIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EphemerisSetIngestDataModeEnum');
    }
    return result;
  }

  static EphemerisSetIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EphemerisSetIngestDataModeEnum.fromValue(value);
  ...
  static const EphemerisSetIngestDataModeEnum REAL = EphemerisSetIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EphemerisSetIngestDataModeEnum TEST = EphemerisSetIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EphemerisSetIngestDataModeEnum SIMULATED = EphemerisSetIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EphemerisSetIngestDataModeEnum EXERCISE = EphemerisSetIngestDataModeEnum._(3);
  static const Map<int, EphemerisSetIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EphemerisSetIngestDataModeEnum> reader = _EphemerisSetIngestDataModeEnumReader();

  @override
  String toString() {
    return 'EphemerisSetIngestDataModeEnum{value: $value}';
  }
}

class _EphemerisSetIngestDataModeEnumReader extends fb.Reader<EphemerisSetIngestDataModeEnum> {
  const _EphemerisSetIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EphemerisSetIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      EphemerisSetIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class EphemerisSetIngest {
  EphemerisSetIngest._(this._bc, this._bcOffset);
  factory EphemerisSetIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EphemerisSetIngest> reader = _EphemerisSetIngestReader();
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 24
  EphemerisSetIngestReferenceFrameEnum get referenceFrame => EphemerisSetIngestReferenceFrameEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 68, 0));
  ///  The reference frame of the covariance matrix elements. If the covReferenceFrame is null it is assumed to be J2000.
  ///  Example: /// Example: J2000
  ///  Constraints: Minimum length = 0, Maximum length = 24
  EphemerisSetIngestCovReferenceFrameEnum get covReferenceFrame => EphemerisSetIngestCovReferenceFrameEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 70, 0));
  ...
  EphemerisSetIngestDataModeEnum get dataMode => EphemerisSetIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 80, 0));
  ///  Satellite/catalog number of the target on-orbit object.
  ///  Example: /// Example: 2
  ///  Constraints: No constraints specified.
  int get satNo => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 82, 0);
  ...
  ///  Constraints: No constraints specified.
  List<String>? get ephemerisList => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 84);
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get transactionId => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 88);
...
class EphemerisSetIngestBuilder {
  ...
  int addReferenceFrame(EphemerisSetIngestReferenceFrameEnum? referenceFrame) {
    fbBuilder.addInt8(32, referenceFrame?.value);
    return fbBuilder.offset;
  }
  int addCovReferenceFrame(EphemerisSetIngestCovReferenceFrameEnum? covReferenceFrame) {
  ...
  int addDataMode(EphemerisSetIngestDataModeEnum? dataMode) {
    fbBuilder.addInt8(38, dataMode?.value);
    return fbBuilder.offset;
  }
  int addSatNo(int? satNo) {
    fbBuilder.addInt32(39, satNo);
    return fbBuilder.offset;
  }
...
class EphemerisSetIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final EphemerisSetIngestReferenceFrameEnum? _referenceFrame;
  final EphemerisSetIngestCovReferenceFrameEnum? _covReferenceFrame;
  final String? _createdAt;
  final String? _createdBy;
  final String? _source;
  final String? _origin;
  final EphemerisSetIngestDataModeEnum? _dataMode;
  final int? _satNo;
  ...
  EphemerisSetIngestObjectBuilder({
    String? id,
    ...
    String? description,
    String? descriptor,
    EphemerisSetIngestReferenceFrameEnum? referenceFrame,
    EphemerisSetIngestCovReferenceFrameEnum? covReferenceFrame,
    String? createdAt,
    String? createdBy,
    String? source,
    String? origin,
    EphemerisSetIngestDataModeEnum? dataMode,
    int? satNo,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addInt32(39, _satNo);
    fbBuilder.addOffset(40, ephemerisListOffset);
    fbBuilder.addOffset(41, tagsOffset);
    fbBuilder.addOffset(42, transactionIdOffset);
