...
class LaunchVehicleDetailsAbridgedDataModeEnum {
  final int value;
  const LaunchVehicleDetailsAbridgedDataModeEnum._(this.value);

  factory LaunchVehicleDetailsAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum LaunchVehicleDetailsAbridgedDataModeEnum');
    }
    return result;
  }

  static LaunchVehicleDetailsAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : LaunchVehicleDetailsAbridgedDataModeEnum.fromValue(value);
  ...
  static const LaunchVehicleDetailsAbridgedDataModeEnum REAL = LaunchVehicleDetailsAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const LaunchVehicleDetailsAbridgedDataModeEnum TEST = LaunchVehicleDetailsAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const LaunchVehicleDetailsAbridgedDataModeEnum SIMULATED = LaunchVehicleDetailsAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const LaunchVehicleDetailsAbridgedDataModeEnum EXERCISE = LaunchVehicleDetailsAbridgedDataModeEnum._(3);
  static const Map<int, LaunchVehicleDetailsAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<LaunchVehicleDetailsAbridgedDataModeEnum> reader = _LaunchVehicleDetailsAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'LaunchVehicleDetailsAbridgedDataModeEnum{value: $value}';
  }
}

class _LaunchVehicleDetailsAbridgedDataModeEnumReader extends fb.Reader<LaunchVehicleDetailsAbridgedDataModeEnum> {
  const _LaunchVehicleDetailsAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  LaunchVehicleDetailsAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      LaunchVehicleDetailsAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class LaunchVehicleDetailsAbridged {
  LaunchVehicleDetailsAbridged._(this._bc, this._bcOffset);
  factory LaunchVehicleDetailsAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LaunchVehicleDetailsAbridged> reader = _LaunchVehicleDetailsAbridgedReader();
...
class LaunchVehicleDetailsAbridgedBuilder {
  ...
  int addDataMode(LaunchVehicleDetailsAbridgedDataModeEnum? dataMode) {
...
class LaunchVehicleDetailsAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final LaunchVehicleDetailsAbridgedDataModeEnum? _dataMode;

  LaunchVehicleDetailsAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    LaunchVehicleDetailsAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
