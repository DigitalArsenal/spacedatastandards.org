...
class CollectRequestFullDataModeEnum {
  final int value;
  const CollectRequestFullDataModeEnum._(this.value);

  factory CollectRequestFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum CollectRequestFullDataModeEnum');
    }
    return result;
  }

  static CollectRequestFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : CollectRequestFullDataModeEnum.fromValue(value);
  ...
  static const CollectRequestFullDataModeEnum REAL = CollectRequestFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const CollectRequestFullDataModeEnum TEST = CollectRequestFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const CollectRequestFullDataModeEnum SIMULATED = CollectRequestFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const CollectRequestFullDataModeEnum EXERCISE = CollectRequestFullDataModeEnum._(3);
  static const Map<int, CollectRequestFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<CollectRequestFullDataModeEnum> reader = _CollectRequestFullDataModeEnumReader();

  @override
  String toString() {
    return 'CollectRequestFullDataModeEnum{value: $value}';
  }
}

class _CollectRequestFullDataModeEnumReader extends fb.Reader<CollectRequestFullDataModeEnum> {
  const _CollectRequestFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  CollectRequestFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      CollectRequestFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class CollectRequestFull {
  CollectRequestFull._(this._bc, this._bcOffset);
  factory CollectRequestFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<CollectRequestFull> reader = _CollectRequestFullReader();
  ...
  ///  Constraints: No constraints specified.
  String? get updatedAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 162);
  ///  Application user who updated the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get updatedBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 164);
  ...
  String? get origNetwork => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 174);
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  CollectRequestFullDataModeEnum get dataMode => CollectRequestFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 176, 0));
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  String? get stateVector => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 178);
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  String? get elset => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 180);
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  String? get onOrbit => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 182);
  ///  Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
  ///  Example: /// Example: ['PROVIDER_TAG1', 'PROVIDER_TAG2']
  ///  Constraints: No constraints specified.
  List<String>? get tags => const fb.ListReader<String>(fb.StringReader()).vTableGetNullable(_bc, _bcOffset, 184);
...
class CollectRequestFullBuilder {
  ...
  int addDataMode(CollectRequestFullDataModeEnum? dataMode) {
    fbBuilder.addInt8(86, dataMode?.value);
    return fbBuilder.offset;
  }
  ...
  int addCollectResponseOffset(int? offset) {
...
class CollectRequestFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final CollectRequestFullDataModeEnum? _dataMode;
  final String? _stateVector;
  final String? _elset;
  final String? _onOrbit;
  final List<String>? _tags;
  final List<String>? _collectResponse;

  CollectRequestFullObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    CollectRequestFullDataModeEnum? dataMode,
    String? stateVector,
    String? elset,
    String? onOrbit,
    List<String>? tags,
    List<String>? collectResponse,
  })
      : _id = id,
        ...
        _onOrbit = onOrbit,
        _tags = tags,
        _collectResponse = collectResponse;
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    final int? collectResponseOffset = _collectResponse == null ? null
        : fbBuilder.writeList(_collectResponse!.map(fbBuilder.writeString).toList());
    fbBuilder.startTable(92);
    ...
    fbBuilder.addOffset(79, updatedAtOffset);
    fbBuilder.addOffset(80, updatedByOffset);
    ...
    fbBuilder.addOffset(85, origNetworkOffset);
    fbBuilder.addInt8(86, _dataMode?.value);
    fbBuilder.addOffset(87, stateVectorOffset);
    fbBuilder.addOffset(88, elsetOffset);
    fbBuilder.addOffset(89, onOrbitOffset);
    fbBuilder.addOffset(90, tagsOffset);
    fbBuilder.addOffset(91, collectResponseOffset);
    return fbBuilder.endTable();
  }
