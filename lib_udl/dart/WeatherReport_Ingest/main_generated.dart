...
class WeatherReportIngestDataModeEnum {
  final int value;
  const WeatherReportIngestDataModeEnum._(this.value);

  factory WeatherReportIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum WeatherReportIngestDataModeEnum');
    }
    return result;
  }

  static WeatherReportIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : WeatherReportIngestDataModeEnum.fromValue(value);
  ...
  static const WeatherReportIngestDataModeEnum REAL = WeatherReportIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const WeatherReportIngestDataModeEnum TEST = WeatherReportIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const WeatherReportIngestDataModeEnum SIMULATED = WeatherReportIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const WeatherReportIngestDataModeEnum EXERCISE = WeatherReportIngestDataModeEnum._(3);
  static const Map<int, WeatherReportIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<WeatherReportIngestDataModeEnum> reader = _WeatherReportIngestDataModeEnumReader();

  @override
  String toString() {
    return 'WeatherReportIngestDataModeEnum{value: $value}';
  }
}

class _WeatherReportIngestDataModeEnumReader extends fb.Reader<WeatherReportIngestDataModeEnum> {
  const _WeatherReportIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  WeatherReportIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      WeatherReportIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class WeatherReportIngest {
  WeatherReportIngest._(this._bc, this._bcOffset);
  factory WeatherReportIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<WeatherReportIngest> reader = _WeatherReportIngestReader();
...
class WeatherReportIngestBuilder {
  ...
  int addDataMode(WeatherReportIngestDataModeEnum? dataMode) {
...
class WeatherReportIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final WeatherReportIngestDataModeEnum? _dataMode;

  WeatherReportIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    WeatherReportIngestDataModeEnum? dataMode,
  })
      : _id = id,
