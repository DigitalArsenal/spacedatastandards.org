...
class IsrcollectionIngestDataModeEnum {
  final int value;
  const IsrcollectionIngestDataModeEnum._(this.value);

  factory IsrcollectionIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum IsrcollectionIngestDataModeEnum');
    }
    return result;
  }

  static IsrcollectionIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : IsrcollectionIngestDataModeEnum.fromValue(value);
  ...
  static const IsrcollectionIngestDataModeEnum REAL = IsrcollectionIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const IsrcollectionIngestDataModeEnum TEST = IsrcollectionIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const IsrcollectionIngestDataModeEnum SIMULATED = IsrcollectionIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const IsrcollectionIngestDataModeEnum EXERCISE = IsrcollectionIngestDataModeEnum._(3);
  static const Map<int, IsrcollectionIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<IsrcollectionIngestDataModeEnum> reader = _IsrcollectionIngestDataModeEnumReader();

  @override
  String toString() {
    return 'IsrcollectionIngestDataModeEnum{value: $value}';
  }
}

class _IsrcollectionIngestDataModeEnumReader extends fb.Reader<IsrcollectionIngestDataModeEnum> {
  const _IsrcollectionIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  IsrcollectionIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      IsrcollectionIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// ISR Collection data.
class IsrcollectionIngest {
  IsrcollectionIngest._(this._bc, this._bcOffset);
  factory IsrcollectionIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IsrcollectionIngest> reader = _IsrcollectionIngestReader();
  ...
  IsrcollectionIngestDataModeEnum get dataMode => IsrcollectionIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 68, 0));
...
class IsrcollectionIngestBuilder {
  ...
  int addDataMode(IsrcollectionIngestDataModeEnum? dataMode) {
...
class IsrcollectionIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final IsrcollectionIngestDataModeEnum? _dataMode;
  final String? _origNetwork;

  IsrcollectionIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    IsrcollectionIngestDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
