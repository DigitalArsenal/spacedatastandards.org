...
class PersonnelRecoveryIngestDataModeEnum {
  final int value;
  const PersonnelRecoveryIngestDataModeEnum._(this.value);

  factory PersonnelRecoveryIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum PersonnelRecoveryIngestDataModeEnum');
    }
    return result;
  }

  static PersonnelRecoveryIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : PersonnelRecoveryIngestDataModeEnum.fromValue(value);
  ...
  static const PersonnelRecoveryIngestDataModeEnum REAL = PersonnelRecoveryIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const PersonnelRecoveryIngestDataModeEnum TEST = PersonnelRecoveryIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const PersonnelRecoveryIngestDataModeEnum SIMULATED = PersonnelRecoveryIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const PersonnelRecoveryIngestDataModeEnum EXERCISE = PersonnelRecoveryIngestDataModeEnum._(3);
  static const Map<int, PersonnelRecoveryIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<PersonnelRecoveryIngestDataModeEnum> reader = _PersonnelRecoveryIngestDataModeEnumReader();

  @override
  String toString() {
    return 'PersonnelRecoveryIngestDataModeEnum{value: $value}';
  }
}

class _PersonnelRecoveryIngestDataModeEnumReader extends fb.Reader<PersonnelRecoveryIngestDataModeEnum> {
  const _PersonnelRecoveryIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  PersonnelRecoveryIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      PersonnelRecoveryIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Provides information concerning search and rescue operations and other situations involving personnel recovery.
class PersonnelRecoveryIngest {
  PersonnelRecoveryIngest._(this._bc, this._bcOffset);
  factory PersonnelRecoveryIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<PersonnelRecoveryIngest> reader = _PersonnelRecoveryIngestReader();
...
class PersonnelRecoveryIngestBuilder {
  ...
  int addDataMode(PersonnelRecoveryIngestDataModeEnum? dataMode) {
...
class PersonnelRecoveryIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final PersonnelRecoveryIngestDataModeEnum? _dataMode;

  PersonnelRecoveryIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    PersonnelRecoveryIngestDataModeEnum? dataMode,
  })
      : _id = id,
