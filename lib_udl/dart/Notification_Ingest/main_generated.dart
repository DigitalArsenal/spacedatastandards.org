...
class NotificationIngestDataModeEnum {
  final int value;
  const NotificationIngestDataModeEnum._(this.value);

  factory NotificationIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum NotificationIngestDataModeEnum');
    }
    return result;
  }

  static NotificationIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : NotificationIngestDataModeEnum.fromValue(value);
  ...
  static const NotificationIngestDataModeEnum REAL = NotificationIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const NotificationIngestDataModeEnum TEST = NotificationIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const NotificationIngestDataModeEnum SIMULATED = NotificationIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const NotificationIngestDataModeEnum EXERCISE = NotificationIngestDataModeEnum._(3);
  static const Map<int, NotificationIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<NotificationIngestDataModeEnum> reader = _NotificationIngestDataModeEnumReader();

  @override
  String toString() {
    return 'NotificationIngestDataModeEnum{value: $value}';
  }
}

class _NotificationIngestDataModeEnumReader extends fb.Reader<NotificationIngestDataModeEnum> {
  const _NotificationIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  NotificationIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      NotificationIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class NotificationIngest {
  NotificationIngest._(this._bc, this._bcOffset);
  factory NotificationIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<NotificationIngest> reader = _NotificationIngestReader();
  ...
  NotificationIngestDataModeEnum get dataMode => NotificationIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 12, 0));
  ...
  @override
  String toString() {
    return 'NotificationIngest{id: ${id}, classificationMarking: ${classificationMarking}, msgType: ${msgType}, msgBody: ${msgBody}, dataMode: ${dataMode}, sourceDl: ${sourceDl}, source: ${source}, origin: ${origin}, tags: ${tags}, createdAt: ${createdAt}, createdBy: ${createdBy}, origNetwork: ${origNetwork}}';
  }
}

class _NotificationIngestReader extends fb.TableReader<NotificationIngest> {
  const _NotificationIngestReader();

  @override
  NotificationIngest createObject(fb.BufferContext bc, int offset) => 
    NotificationIngest._(bc, offset);
}

class NotificationIngestBuilder {
  NotificationIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(NotificationIngestDataModeEnum? dataMode) {
...
class NotificationIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  final String? _classificationMarking;
  final String? _msgType;
  final String? _msgBody;
  final NotificationIngestDataModeEnum? _dataMode;
  ...
  NotificationIngestObjectBuilder({
    String? id,
    String? classificationMarking,
    String? msgType,
    String? msgBody,
    NotificationIngestDataModeEnum? dataMode,
    String? sourceDl,
    String? source,
    String? origin,
    List<String>? tags,
