...
class CollectResponseIngestDataModeEnum {
  final int value;
  const CollectResponseIngestDataModeEnum._(this.value);

  factory CollectResponseIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum CollectResponseIngestDataModeEnum');
    }
    return result;
  }

  static CollectResponseIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : CollectResponseIngestDataModeEnum.fromValue(value);
  ...
  static const CollectResponseIngestDataModeEnum REAL = CollectResponseIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const CollectResponseIngestDataModeEnum TEST = CollectResponseIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const CollectResponseIngestDataModeEnum SIMULATED = CollectResponseIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const CollectResponseIngestDataModeEnum EXERCISE = CollectResponseIngestDataModeEnum._(3);
  static const Map<int, CollectResponseIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<CollectResponseIngestDataModeEnum> reader = _CollectResponseIngestDataModeEnumReader();

  @override
  String toString() {
    return 'CollectResponseIngestDataModeEnum{value: $value}';
  }
}

class _CollectResponseIngestDataModeEnumReader extends fb.Reader<CollectResponseIngestDataModeEnum> {
  const _CollectResponseIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  CollectResponseIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      CollectResponseIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class CollectResponseIngest {
  CollectResponseIngest._(this._bc, this._bcOffset);
  factory CollectResponseIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<CollectResponseIngest> reader = _CollectResponseIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  CollectResponseIngestDataModeEnum get dataMode => CollectResponseIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 54, 0));
  ...
  @override
  String toString() {
    return 'CollectResponseIngest{id: ${id}, classificationMarking: ${classificationMarking}, idRequest: ${idRequest}, idOnOrbit: ${idOnOrbit}, origObjectId: ${origObjectId}, satNo: ${satNo}, taskId: ${taskId}, idPlan: ${idPlan}, externalId: ${externalId}, status: ${status}, actualStartTime: ${actualStartTime}, actualEndTime: ${actualEndTime}, altStartTime: ${altStartTime}, altEndTime: ${altEndTime}, errCode: ${errCode}, srcTyps: ${srcTyps}, srcIds: ${srcIds}, notes: ${notes}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, idSensor: ${idSensor}, origSensorId: ${origSensorId}, dataMode: ${dataMode}, tags: ${tags}}';
  }
}

class _CollectResponseIngestReader extends fb.TableReader<CollectResponseIngest> {
  const _CollectResponseIngestReader();

  @override
  CollectResponseIngest createObject(fb.BufferContext bc, int offset) => 
    CollectResponseIngest._(bc, offset);
}

class CollectResponseIngestBuilder {
  CollectResponseIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(CollectResponseIngestDataModeEnum? dataMode) {
...
class CollectResponseIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final CollectResponseIngestDataModeEnum? _dataMode;
  final List<String>? _tags;

  CollectResponseIngestObjectBuilder({
    String? id,
    ...
    String? idSensor,
    String? origSensorId,
    CollectResponseIngestDataModeEnum? dataMode,
    List<String>? tags,
  })
      : _id = id,
