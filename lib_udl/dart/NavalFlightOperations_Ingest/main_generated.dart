...
class NavalFlightOperationsIngest {
  NavalFlightOperationsIngest._(this._bc, this._bcOffset);
  factory NavalFlightOperationsIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<NavalFlightOperationsIngest> reader = _NavalFlightOperationsIngestReader();
  ...
  @override
  String toString() {
    return 'NavalFlightOperationsIngest{shipName: ${shipName}, fltOpStart: ${fltOpStart}, fltOpStop: ${fltOpStop}, schdLaunchRcvyTime: ${schdLaunchRcvyTime}}';
  }
}

class _NavalFlightOperationsIngestReader extends fb.TableReader<NavalFlightOperationsIngest> {
  const _NavalFlightOperationsIngestReader();

  @override
  NavalFlightOperationsIngest createObject(fb.BufferContext bc, int offset) => 
    NavalFlightOperationsIngest._(bc, offset);
}

class NavalFlightOperationsIngestBuilder {
  NavalFlightOperationsIngestBuilder(this.fbBuilder);
...
class NavalFlightOperationsIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _shipName;
  final String? _fltOpStart;
  final String? _fltOpStop;
  final List<String>? _schdLaunchRcvyTime;

  NavalFlightOperationsIngestObjectBuilder({
    String? shipName,
    String? fltOpStart,
    String? fltOpStop,
