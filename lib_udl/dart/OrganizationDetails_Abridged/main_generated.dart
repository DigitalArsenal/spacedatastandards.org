...
class OrganizationDetailsAbridgedDataModeEnum {
  final int value;
  const OrganizationDetailsAbridgedDataModeEnum._(this.value);

  factory OrganizationDetailsAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum OrganizationDetailsAbridgedDataModeEnum');
    }
    return result;
  }

  static OrganizationDetailsAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : OrganizationDetailsAbridgedDataModeEnum.fromValue(value);
  ...
  static const OrganizationDetailsAbridgedDataModeEnum REAL = OrganizationDetailsAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const OrganizationDetailsAbridgedDataModeEnum TEST = OrganizationDetailsAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const OrganizationDetailsAbridgedDataModeEnum SIMULATED = OrganizationDetailsAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const OrganizationDetailsAbridgedDataModeEnum EXERCISE = OrganizationDetailsAbridgedDataModeEnum._(3);
  static const Map<int, OrganizationDetailsAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<OrganizationDetailsAbridgedDataModeEnum> reader = _OrganizationDetailsAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'OrganizationDetailsAbridgedDataModeEnum{value: $value}';
  }
}

class _OrganizationDetailsAbridgedDataModeEnumReader extends fb.Reader<OrganizationDetailsAbridgedDataModeEnum> {
  const _OrganizationDetailsAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  OrganizationDetailsAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      OrganizationDetailsAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Model representation of additional detailed organization data as collected by a particular source.
class OrganizationDetailsAbridged {
  OrganizationDetailsAbridged._(this._bc, this._bcOffset);
  factory OrganizationDetailsAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<OrganizationDetailsAbridged> reader = _OrganizationDetailsAbridgedReader();
  ...
  OrganizationDetailsAbridgedDataModeEnum get dataMode => OrganizationDetailsAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 68, 0));
...
class OrganizationDetailsAbridgedBuilder {
  ...
  int addDataMode(OrganizationDetailsAbridgedDataModeEnum? dataMode) {
...
class OrganizationDetailsAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final OrganizationDetailsAbridgedDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final String? _origNetwork;

  OrganizationDetailsAbridgedObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    OrganizationDetailsAbridgedDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? origNetwork,
  })
