...
class IonoObservationFrequencyIngest {
  IonoObservationFrequencyIngest._(this._bc, this._bcOffset);
  factory IonoObservationFrequencyIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationFrequencyIngest> reader = _IonoObservationFrequencyIngestReader();
  ...
  @override
  String toString() {
    return 'IonoObservationFrequencyIngest{notes: ${notes}, dimensions: ${dimensions}, dimensionName: ${dimensionName}, data: ${data}}';
  }
}

class _IonoObservationFrequencyIngestReader extends fb.TableReader<IonoObservationFrequencyIngest> {
  const _IonoObservationFrequencyIngestReader();

  @override
  IonoObservationFrequencyIngest createObject(fb.BufferContext bc, int offset) => 
    IonoObservationFrequencyIngest._(bc, offset);
}

class IonoObservationFrequencyIngestBuilder {
  IonoObservationFrequencyIngestBuilder(this.fbBuilder);
...
class IonoObservationFrequencyIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _notes;
  final List<String>? _dimensions;
  final List<String>? _dimensionName;
  final List<String>? _data;

  IonoObservationFrequencyIngestObjectBuilder({
    String? notes,
