...
class AirfieldIngestDataModeEnum {
  final int value;
  const AirfieldIngestDataModeEnum._(this.value);

  factory AirfieldIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirfieldIngestDataModeEnum');
    }
    return result;
  }

  static AirfieldIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AirfieldIngestDataModeEnum.fromValue(value);
  ...
  static const AirfieldIngestDataModeEnum REAL = AirfieldIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AirfieldIngestDataModeEnum TEST = AirfieldIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AirfieldIngestDataModeEnum SIMULATED = AirfieldIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AirfieldIngestDataModeEnum EXERCISE = AirfieldIngestDataModeEnum._(3);
  static const Map<int, AirfieldIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AirfieldIngestDataModeEnum> reader = _AirfieldIngestDataModeEnumReader();

  @override
  String toString() {
    return 'AirfieldIngestDataModeEnum{value: $value}';
  }
}

class _AirfieldIngestDataModeEnumReader extends fb.Reader<AirfieldIngestDataModeEnum> {
  const _AirfieldIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AirfieldIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      AirfieldIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Properties and characteristics of an airfield, which includes location, airfield codes, suitability codes, and remarks.
class AirfieldIngest {
  AirfieldIngest._(this._bc, this._bcOffset);
  factory AirfieldIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirfieldIngest> reader = _AirfieldIngestReader();
...
class AirfieldIngestBuilder {
  ...
  int addDataMode(AirfieldIngestDataModeEnum? dataMode) {
...
class AirfieldIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AirfieldIngestDataModeEnum? _dataMode;

  AirfieldIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    AirfieldIngestDataModeEnum? dataMode,
  })
      : _id = id,
