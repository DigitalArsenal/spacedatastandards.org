...
class DataLinkMultiDutyIngest {
  DataLinkMultiDutyIngest._(this._bc, this._bcOffset);
  factory DataLinkMultiDutyIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<DataLinkMultiDutyIngest> reader = _DataLinkMultiDutyIngestReader();
  ...
  @override
  String toString() {
    return 'DataLinkMultiDutyIngest{unitDes: ${unitDes}, name: ${name}, rank: ${rank}, duty: ${duty}, dutyTeleFreqNums: ${dutyTeleFreqNums}, multiDutyVoiceCoord: ${multiDutyVoiceCoord}}';
  }
}

class _DataLinkMultiDutyIngestReader extends fb.TableReader<DataLinkMultiDutyIngest> {
  const _DataLinkMultiDutyIngestReader();

  @override
  DataLinkMultiDutyIngest createObject(fb.BufferContext bc, int offset) => 
    DataLinkMultiDutyIngest._(bc, offset);
}

class DataLinkMultiDutyIngestBuilder {
  DataLinkMultiDutyIngestBuilder(this.fbBuilder);
...
class DataLinkMultiDutyIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  DataLinkMultiDutyIngestObjectBuilder({
    String? unitDes,
    String? name,
    String? rank,
    String? duty,
