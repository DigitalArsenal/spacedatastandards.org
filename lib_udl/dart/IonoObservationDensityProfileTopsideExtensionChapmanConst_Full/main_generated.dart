...
class IonoObservationDensityProfileTopsideExtensionChapmanConstFull {
  IonoObservationDensityProfileTopsideExtensionChapmanConstFull._(this._bc, this._bcOffset);
  factory IonoObservationDensityProfileTopsideExtensionChapmanConstFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationDensityProfileTopsideExtensionChapmanConstFull> reader = _IonoObservationDensityProfileTopsideExtensionChapmanConstFullReader();
  ...
  @override
  String toString() {
    return 'IonoObservationDensityProfileTopsideExtensionChapmanConstFull{description: ${description}, nmF2: ${nmF2}, hmF2: ${hmF2}, scaleF2: ${scaleF2}, chi: ${chi}}';
  }
}

class _IonoObservationDensityProfileTopsideExtensionChapmanConstFullReader extends fb.TableReader<IonoObservationDensityProfileTopsideExtensionChapmanConstFull> {
  const _IonoObservationDensityProfileTopsideExtensionChapmanConstFullReader();

  @override
  IonoObservationDensityProfileTopsideExtensionChapmanConstFull createObject(fb.BufferContext bc, int offset) => 
    IonoObservationDensityProfileTopsideExtensionChapmanConstFull._(bc, offset);
}

class IonoObservationDensityProfileTopsideExtensionChapmanConstFullBuilder {
  IonoObservationDensityProfileTopsideExtensionChapmanConstFullBuilder(this.fbBuilder);
...
class IonoObservationDensityProfileTopsideExtensionChapmanConstFullObjectBuilder extends fb.ObjectBuilder {
  ...
  IonoObservationDensityProfileTopsideExtensionChapmanConstFullObjectBuilder({
    String? description,
    double? nmF2,
    double? hmF2,
    double? scaleF2,
