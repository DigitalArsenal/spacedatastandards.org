...
class MtiHrrscattererIngest {
  MtiHrrscattererIngest._(this._bc, this._bcOffset);
  factory MtiHrrscattererIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MtiHrrscattererIngest> reader = _MtiHrrscattererIngestReader();
  ...
  @override
  String toString() {
    return 'MtiHrrscattererIngest{h321: ${h321}, h322: ${h322}, h323: ${h323}, h324: ${h324}}';
  }
}

class _MtiHrrscattererIngestReader extends fb.TableReader<MtiHrrscattererIngest> {
  const _MtiHrrscattererIngestReader();

  @override
  MtiHrrscattererIngest createObject(fb.BufferContext bc, int offset) => 
    MtiHrrscattererIngest._(bc, offset);
}

class MtiHrrscattererIngestBuilder {
  MtiHrrscattererIngestBuilder(this.fbBuilder);
...
class MtiHrrscattererIngestObjectBuilder extends fb.ObjectBuilder {
  final int? _h321;
  final int? _h322;
  final int? _h323;
  final int? _h324;

  MtiHrrscattererIngestObjectBuilder({
    int? h321,
    int? h322,
    int? h323,
    int? h324,
