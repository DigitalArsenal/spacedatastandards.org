...
class CrewMembersFull {
  CrewMembersFull._(this._bc, this._bcOffset);
  factory CrewMembersFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<CrewMembersFull> reader = _CrewMembersFullReader();
  ...
  @override
  String toString() {
    return 'CrewMembersFull{lastName: ${lastName}, firstName: ${firstName}, middleInitial: ${middleInitial}, memberId: ${memberId}, civilian: ${civilian}, commander: ${commander}, last4Ssn: ${last4Ssn}, dodId: ${dodId}, dutyPosition: ${dutyPosition}, crewPosition: ${crewPosition}, memberType: ${memberType}, branch: ${branch}, rank: ${rank}, wing: ${wing}, squadron: ${squadron}, memberRemarks: ${memberRemarks}, username: ${username}}';
  }
}

class _CrewMembersFullReader extends fb.TableReader<CrewMembersFull> {
  const _CrewMembersFullReader();

  @override
  CrewMembersFull createObject(fb.BufferContext bc, int offset) => 
    CrewMembersFull._(bc, offset);
}

class CrewMembersFullBuilder {
  CrewMembersFullBuilder(this.fbBuilder);
...
class CrewMembersFullObjectBuilder extends fb.ObjectBuilder {
