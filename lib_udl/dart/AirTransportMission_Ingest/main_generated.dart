...
class AirTransportMissionIngestDataModeEnum {
  final int value;
  const AirTransportMissionIngestDataModeEnum._(this.value);

  factory AirTransportMissionIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AirTransportMissionIngestDataModeEnum');
    }
    return result;
  }

  static AirTransportMissionIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AirTransportMissionIngestDataModeEnum.fromValue(value);
  ...
  static const AirTransportMissionIngestDataModeEnum REAL = AirTransportMissionIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AirTransportMissionIngestDataModeEnum TEST = AirTransportMissionIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AirTransportMissionIngestDataModeEnum SIMULATED = AirTransportMissionIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AirTransportMissionIngestDataModeEnum EXERCISE = AirTransportMissionIngestDataModeEnum._(3);
  static const Map<int, AirTransportMissionIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AirTransportMissionIngestDataModeEnum> reader = _AirTransportMissionIngestDataModeEnumReader();

  @override
  String toString() {
    return 'AirTransportMissionIngestDataModeEnum{value: $value}';
  }
}

class _AirTransportMissionIngestDataModeEnumReader extends fb.Reader<AirTransportMissionIngestDataModeEnum> {
  const _AirTransportMissionIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AirTransportMissionIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      AirTransportMissionIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class AirTransportMissionIngest {
  AirTransportMissionIngest._(this._bc, this._bcOffset);
  factory AirTransportMissionIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirTransportMissionIngest> reader = _AirTransportMissionIngestReader();
  ...
  AirTransportMissionIngestDataModeEnum get dataMode => AirTransportMissionIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 70, 0));
...
class AirTransportMissionIngestBuilder {
  ...
  int addDataMode(AirTransportMissionIngestDataModeEnum? dataMode) {
...
class AirTransportMissionIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final AirTransportMissionIngestDataModeEnum? _dataMode;
  final String? _origNetwork;
  final List<String>? _requirements;
  final List<String>? _remarks;
  final List<String>? _hazMat;

  AirTransportMissionIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    AirTransportMissionIngestDataModeEnum? dataMode,
    String? origNetwork,
