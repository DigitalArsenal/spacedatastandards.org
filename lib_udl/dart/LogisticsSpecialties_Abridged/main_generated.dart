...
class LogisticsSpecialtiesAbridged {
  LogisticsSpecialtiesAbridged._(this._bc, this._bcOffset);
  factory LogisticsSpecialtiesAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LogisticsSpecialtiesAbridged> reader = _LogisticsSpecialtiesAbridgedReader();
  ...
  @override
  String toString() {
    return 'LogisticsSpecialtiesAbridged{specialty: ${specialty}, skillLevel: ${skillLevel}, firstName: ${firstName}, lastName: ${lastName}, rankCode: ${rankCode}, last4Ssn: ${last4Ssn}, roleTypeCode: ${roleTypeCode}}';
  }
}

class _LogisticsSpecialtiesAbridgedReader extends fb.TableReader<LogisticsSpecialtiesAbridged> {
  const _LogisticsSpecialtiesAbridgedReader();

  @override
  LogisticsSpecialtiesAbridged createObject(fb.BufferContext bc, int offset) => 
    LogisticsSpecialtiesAbridged._(bc, offset);
}

class LogisticsSpecialtiesAbridgedBuilder {
  LogisticsSpecialtiesAbridgedBuilder(this.fbBuilder);
...
class LogisticsSpecialtiesAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  LogisticsSpecialtiesAbridgedObjectBuilder({
    String? specialty,
    int? skillLevel,
    String? firstName,
    String? lastName,
