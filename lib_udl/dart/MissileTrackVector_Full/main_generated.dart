...
class MissileTrackVectorFull {
  MissileTrackVectorFull._(this._bc, this._bcOffset);
  factory MissileTrackVectorFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MissileTrackVectorFull> reader = _MissileTrackVectorFullReader();
  ...
  @override
  String toString() {
    return 'MissileTrackVectorFull{type: ${type}, object: ${object}, epoch: ${epoch}, idSensor: ${idSensor}, origSensorId: ${origSensorId}, pos: ${pos}, vel: ${vel}, accel: ${accel}, course: ${course}, spd: ${spd}, referenceFrame: ${referenceFrame}, cov: ${cov}, covReferenceFrame: ${covReferenceFrame}, vectorLat: ${vectorLat}, vectorLon: ${vectorLon}, vectorAlt: ${vectorAlt}, confidence: ${confidence}, status: ${status}, timeSource: ${timeSource}, quat: ${quat}, flightAz: ${flightAz}}';
  }
}

class _MissileTrackVectorFullReader extends fb.TableReader<MissileTrackVectorFull> {
  const _MissileTrackVectorFullReader();

  @override
  MissileTrackVectorFull createObject(fb.BufferContext bc, int offset) => 
    MissileTrackVectorFull._(bc, offset);
}

class MissileTrackVectorFullBuilder {
  MissileTrackVectorFullBuilder(this.fbBuilder);
...
class MissileTrackVectorFullObjectBuilder extends fb.ObjectBuilder {
  final String? _type;
  ...
  MissileTrackVectorFullObjectBuilder({
    String? type,
    String? object,
    String? epoch,
    String? idSensor,
