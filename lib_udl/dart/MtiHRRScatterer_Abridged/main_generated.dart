...
class MtiHrrscattererAbridged {
  MtiHrrscattererAbridged._(this._bc, this._bcOffset);
  factory MtiHrrscattererAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MtiHrrscattererAbridged> reader = _MtiHrrscattererAbridgedReader();
  ...
  @override
  String toString() {
    return 'MtiHrrscattererAbridged{h321: ${h321}, h322: ${h322}, h323: ${h323}, h324: ${h324}}';
  }
}

class _MtiHrrscattererAbridgedReader extends fb.TableReader<MtiHrrscattererAbridged> {
  const _MtiHrrscattererAbridgedReader();

  @override
  MtiHrrscattererAbridged createObject(fb.BufferContext bc, int offset) => 
    MtiHrrscattererAbridged._(bc, offset);
}

class MtiHrrscattererAbridgedBuilder {
  MtiHrrscattererAbridgedBuilder(this.fbBuilder);
...
class MtiHrrscattererAbridgedObjectBuilder extends fb.ObjectBuilder {
  final int? _h321;
  final int? _h322;
  final int? _h323;
  final int? _h324;

  MtiHrrscattererAbridgedObjectBuilder({
    int? h321,
    int? h322,
    int? h323,
    int? h324,
