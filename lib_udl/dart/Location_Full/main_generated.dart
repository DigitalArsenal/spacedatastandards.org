...
class LocationFullDataModeEnum {
  final int value;
  const LocationFullDataModeEnum._(this.value);

  factory LocationFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum LocationFullDataModeEnum');
    }
    return result;
  }

  static LocationFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : LocationFullDataModeEnum.fromValue(value);
  ...
  static const LocationFullDataModeEnum REAL = LocationFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const LocationFullDataModeEnum TEST = LocationFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const LocationFullDataModeEnum SIMULATED = LocationFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const LocationFullDataModeEnum EXERCISE = LocationFullDataModeEnum._(3);
  static const Map<int, LocationFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<LocationFullDataModeEnum> reader = _LocationFullDataModeEnumReader();

  @override
  String toString() {
    return 'LocationFullDataModeEnum{value: $value}';
  }
}

class _LocationFullDataModeEnumReader extends fb.Reader<LocationFullDataModeEnum> {
  const _LocationFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  LocationFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      LocationFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class LocationFull {
  LocationFull._(this._bc, this._bcOffset);
  factory LocationFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LocationFull> reader = _LocationFullReader();
  ...
  LocationFullDataModeEnum get dataMode => LocationFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 30, 0));
  ...
  @override
  String toString() {
    return 'LocationFull{idLocation: ${idLocation}, classificationMarking: ${classificationMarking}, name: ${name}, countryCode: ${countryCode}, lat: ${lat}, lon: ${lon}, altitude: ${altitude}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}, origNetwork: ${origNetwork}}';
  }
}

class _LocationFullReader extends fb.TableReader<LocationFull> {
  const _LocationFullReader();

  @override
  LocationFull createObject(fb.BufferContext bc, int offset) => 
    LocationFull._(bc, offset);
}

class LocationFullBuilder {
  LocationFullBuilder(this.fbBuilder);
  ...
  int addDataMode(LocationFullDataModeEnum? dataMode) {
...
class LocationFullObjectBuilder extends fb.ObjectBuilder {
  ...
  final LocationFullDataModeEnum? _dataMode;
  final String? _origNetwork;

  LocationFullObjectBuilder({
    String? idLocation,
    ...
    String? source,
    String? origin,
    LocationFullDataModeEnum? dataMode,
    String? origNetwork,
  })
