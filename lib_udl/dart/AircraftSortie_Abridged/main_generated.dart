...
class AircraftSortieAbridgedPaperStatusEnum {
  final int value;
  const AircraftSortieAbridgedPaperStatusEnum._(this.value);

  factory AircraftSortieAbridgedPaperStatusEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AircraftSortieAbridgedPaperStatusEnum');
    }
    return result;
  }

  static AircraftSortieAbridgedPaperStatusEnum? _createOrNull(int? value) => 
      value == null ? null : AircraftSortieAbridgedPaperStatusEnum.fromValue(value);
  ...
  static const AircraftSortieAbridgedPaperStatusEnum PUBLISHED = AircraftSortieAbridgedPaperStatusEnum._(0);

  ///  No description available.
  static const AircraftSortieAbridgedPaperStatusEnum DELETED = AircraftSortieAbridgedPaperStatusEnum._(1);

  ///  No description available.
  static const AircraftSortieAbridgedPaperStatusEnum UPDATED = AircraftSortieAbridgedPaperStatusEnum._(2);

  ///  No description available.
  static const AircraftSortieAbridgedPaperStatusEnum READ = AircraftSortieAbridgedPaperStatusEnum._(3);
  static const Map<int, AircraftSortieAbridgedPaperStatusEnum> values = {
    0: PUBLISHED,
    1: DELETED,
    2: UPDATED,
    3: READ};

  static const fb.Reader<AircraftSortieAbridgedPaperStatusEnum> reader = _AircraftSortieAbridgedPaperStatusEnumReader();

  @override
  String toString() {
    return 'AircraftSortieAbridgedPaperStatusEnum{value: $value}';
  }
}

class _AircraftSortieAbridgedPaperStatusEnumReader extends fb.Reader<AircraftSortieAbridgedPaperStatusEnum> {
  const _AircraftSortieAbridgedPaperStatusEnumReader();

  @override
  int get size => 1;

  @override
  AircraftSortieAbridgedPaperStatusEnum read(fb.BufferContext bc, int offset) =>
      AircraftSortieAbridgedPaperStatusEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class AircraftSortieAbridgedPprStatusEnum {
  final int value;
  const AircraftSortieAbridgedPprStatusEnum._(this.value);

  factory AircraftSortieAbridgedPprStatusEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AircraftSortieAbridgedPprStatusEnum');
    }
    return result;
  }

  static AircraftSortieAbridgedPprStatusEnum? _createOrNull(int? value) => 
      value == null ? null : AircraftSortieAbridgedPprStatusEnum.fromValue(value);
  ...
  ///  No description available.
  static const AircraftSortieAbridgedPprStatusEnum NOT_REQUIRED = AircraftSortieAbridgedPprStatusEnum._(0);

  ///  No description available.
  static const AircraftSortieAbridgedPprStatusEnum REQUIRED_NOT_REQUESTED = AircraftSortieAbridgedPprStatusEnum._(1);

  ///  No description available.
  static const AircraftSortieAbridgedPprStatusEnum GRANTED = AircraftSortieAbridgedPprStatusEnum._(2);

  ///  No description available.
  static const AircraftSortieAbridgedPprStatusEnum PENDING = AircraftSortieAbridgedPprStatusEnum._(3);
  static const Map<int, AircraftSortieAbridgedPprStatusEnum> values = {
    0: NOT_REQUIRED,
    1: REQUIRED_NOT_REQUESTED,
    2: GRANTED,
    3: PENDING};

  static const fb.Reader<AircraftSortieAbridgedPprStatusEnum> reader = _AircraftSortieAbridgedPprStatusEnumReader();

  @override
  String toString() {
    return 'AircraftSortieAbridgedPprStatusEnum{value: $value}';
  }
}

class _AircraftSortieAbridgedPprStatusEnumReader extends fb.Reader<AircraftSortieAbridgedPprStatusEnum> {
  const _AircraftSortieAbridgedPprStatusEnumReader();

  @override
  int get size => 1;

  @override
  AircraftSortieAbridgedPprStatusEnum read(fb.BufferContext bc, int offset) =>
      AircraftSortieAbridgedPprStatusEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class AircraftSortieAbridgedRvnReqEnum {
  final int value;
  const AircraftSortieAbridgedRvnReqEnum._(this.value);

  factory AircraftSortieAbridgedRvnReqEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AircraftSortieAbridgedRvnReqEnum');
    }
    return result;
  }

  static AircraftSortieAbridgedRvnReqEnum? _createOrNull(int? value) => 
      value == null ? null : AircraftSortieAbridgedRvnReqEnum.fromValue(value);
  ...
  ///  No description available.
  static const AircraftSortieAbridgedRvnReqEnum N = AircraftSortieAbridgedRvnReqEnum._(0);

  ///  No description available.
  static const AircraftSortieAbridgedRvnReqEnum R = AircraftSortieAbridgedRvnReqEnum._(1);

  ///  No description available.
  static const AircraftSortieAbridgedRvnReqEnum C6 = AircraftSortieAbridgedRvnReqEnum._(2);

  ///  No description available.
  static const AircraftSortieAbridgedRvnReqEnum R6 = AircraftSortieAbridgedRvnReqEnum._(3);
  static const Map<int, AircraftSortieAbridgedRvnReqEnum> values = {
    0: N,
    1: R,
    2: C6,
    3: R6};

  static const fb.Reader<AircraftSortieAbridgedRvnReqEnum> reader = _AircraftSortieAbridgedRvnReqEnumReader();

  @override
  String toString() {
    return 'AircraftSortieAbridgedRvnReqEnum{value: $value}';
  }
}

class _AircraftSortieAbridgedRvnReqEnumReader extends fb.Reader<AircraftSortieAbridgedRvnReqEnum> {
  const _AircraftSortieAbridgedRvnReqEnumReader();

  @override
  int get size => 1;

  @override
  AircraftSortieAbridgedRvnReqEnum read(fb.BufferContext bc, int offset) =>
      AircraftSortieAbridgedRvnReqEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class AircraftSortieAbridgedDataModeEnum {
  final int value;
  const AircraftSortieAbridgedDataModeEnum._(this.value);

  factory AircraftSortieAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum AircraftSortieAbridgedDataModeEnum');
    }
    return result;
  }

  static AircraftSortieAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : AircraftSortieAbridgedDataModeEnum.fromValue(value);
  ...
  static const AircraftSortieAbridgedDataModeEnum REAL = AircraftSortieAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const AircraftSortieAbridgedDataModeEnum TEST = AircraftSortieAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const AircraftSortieAbridgedDataModeEnum SIMULATED = AircraftSortieAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const AircraftSortieAbridgedDataModeEnum EXERCISE = AircraftSortieAbridgedDataModeEnum._(3);
  static const Map<int, AircraftSortieAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<AircraftSortieAbridgedDataModeEnum> reader = _AircraftSortieAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'AircraftSortieAbridgedDataModeEnum{value: $value}';
  }
}

class _AircraftSortieAbridgedDataModeEnumReader extends fb.Reader<AircraftSortieAbridgedDataModeEnum> {
  const _AircraftSortieAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  AircraftSortieAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      AircraftSortieAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Information related to the planning, load, status, and deployment or dispatch of one aircraft to carry out a mission.
class AircraftSortieAbridged {
  AircraftSortieAbridged._(this._bc, this._bcOffset);
  factory AircraftSortieAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AircraftSortieAbridged> reader = _AircraftSortieAbridgedReader();
  ...
  AircraftSortieAbridgedPaperStatusEnum get paperStatus => AircraftSortieAbridgedPaperStatusEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 122, 0));
  ///  The prior permission required (PPR) status.
  ///  Example: /// Example: PENDING
  ///  Constraints: Minimum length = 0, Maximum length = 22
  AircraftSortieAbridgedPprStatusEnum get pprStatus => AircraftSortieAbridgedPprStatusEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 124, 0));
  ...
  AircraftSortieAbridgedRvnReqEnum get rvnReq => AircraftSortieAbridgedRvnReqEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 136, 0));
  ...
  AircraftSortieAbridgedDataModeEnum get dataMode => AircraftSortieAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 160, 0));
...
class AircraftSortieAbridgedBuilder {
  ...
  int addPaperStatus(AircraftSortieAbridgedPaperStatusEnum? paperStatus) {
    fbBuilder.addInt8(59, paperStatus?.value);
    return fbBuilder.offset;
  }
  int addPprStatus(AircraftSortieAbridgedPprStatusEnum? pprStatus) {
  ...
  int addRvnReq(AircraftSortieAbridgedRvnReqEnum? rvnReq) {
  ...
  int addDataMode(AircraftSortieAbridgedDataModeEnum? dataMode) {
...
class AircraftSortieAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final int? _filesize;
  final AircraftSortieAbridgedPaperStatusEnum? _paperStatus;
  final AircraftSortieAbridgedPprStatusEnum? _pprStatus;
  final String? _missionUpdate;
  final String? _delayCode;
  final String? _commanderName;
  final String? _fmDeskNum;
  final String? _fmName;
  final AircraftSortieAbridgedRvnReqEnum? _rvnReq;
  ...
  final AircraftSortieAbridgedDataModeEnum? _dataMode;
  final String? _origNetwork;

  AircraftSortieAbridgedObjectBuilder({
    String? id,
    ...
    String? filename,
    int? filesize,
    AircraftSortieAbridgedPaperStatusEnum? paperStatus,
    AircraftSortieAbridgedPprStatusEnum? pprStatus,
    String? missionUpdate,
    String? delayCode,
    String? commanderName,
    String? fmDeskNum,
    String? fmName,
    AircraftSortieAbridgedRvnReqEnum? rvnReq,
    int? passengers,
    String? parkingLoc,
    ...
    String? source,
    String? origin,
    AircraftSortieAbridgedDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
