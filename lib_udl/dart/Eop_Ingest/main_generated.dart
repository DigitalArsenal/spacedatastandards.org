...
class EopIngestPolarMotionStateEnum {
  final int value;
  const EopIngestPolarMotionStateEnum._(this.value);

  factory EopIngestPolarMotionStateEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EopIngestPolarMotionStateEnum');
    }
    return result;
  }

  static EopIngestPolarMotionStateEnum? _createOrNull(int? value) => 
      value == null ? null : EopIngestPolarMotionStateEnum.fromValue(value);
  ...
  static const EopIngestPolarMotionStateEnum I = EopIngestPolarMotionStateEnum._(0);

  ///  No description available.
  static const EopIngestPolarMotionStateEnum P = EopIngestPolarMotionStateEnum._(1);
  static const Map<int, EopIngestPolarMotionStateEnum> values = {
    0: I,
    1: P};

  static const fb.Reader<EopIngestPolarMotionStateEnum> reader = _EopIngestPolarMotionStateEnumReader();

  @override
  String toString() {
    return 'EopIngestPolarMotionStateEnum{value: $value}';
  }
}

class _EopIngestPolarMotionStateEnumReader extends fb.Reader<EopIngestPolarMotionStateEnum> {
  const _EopIngestPolarMotionStateEnumReader();

  @override
  int get size => 1;

  @override
  EopIngestPolarMotionStateEnum read(fb.BufferContext bc, int offset) =>
      EopIngestPolarMotionStateEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class EopIngestUt1UtcstateEnum {
  final int value;
  const EopIngestUt1UtcstateEnum._(this.value);

  factory EopIngestUt1UtcstateEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EopIngestUt1UtcstateEnum');
    }
    return result;
  }

  static EopIngestUt1UtcstateEnum? _createOrNull(int? value) => 
      value == null ? null : EopIngestUt1UtcstateEnum.fromValue(value);
  ...
  ///  No description available.
  static const EopIngestUt1UtcstateEnum I = EopIngestUt1UtcstateEnum._(0);

  ///  No description available.
  static const EopIngestUt1UtcstateEnum P = EopIngestUt1UtcstateEnum._(1);
  static const Map<int, EopIngestUt1UtcstateEnum> values = {
    0: I,
    1: P};

  static const fb.Reader<EopIngestUt1UtcstateEnum> reader = _EopIngestUt1UtcstateEnumReader();

  @override
  String toString() {
    return 'EopIngestUt1UtcstateEnum{value: $value}';
  }
}

class _EopIngestUt1UtcstateEnumReader extends fb.Reader<EopIngestUt1UtcstateEnum> {
  const _EopIngestUt1UtcstateEnumReader();

  @override
  int get size => 1;

  @override
  EopIngestUt1UtcstateEnum read(fb.BufferContext bc, int offset) =>
      EopIngestUt1UtcstateEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class EopIngestNutationStateEnum {
  final int value;
  const EopIngestNutationStateEnum._(this.value);

  factory EopIngestNutationStateEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EopIngestNutationStateEnum');
    }
    return result;
  }

  static EopIngestNutationStateEnum? _createOrNull(int? value) => 
      value == null ? null : EopIngestNutationStateEnum.fromValue(value);
  ...
  ///  No description available.
  static const EopIngestNutationStateEnum I = EopIngestNutationStateEnum._(0);

  ///  No description available.
  static const EopIngestNutationStateEnum P = EopIngestNutationStateEnum._(1);
  static const Map<int, EopIngestNutationStateEnum> values = {
    0: I,
    1: P};

  static const fb.Reader<EopIngestNutationStateEnum> reader = _EopIngestNutationStateEnumReader();

  @override
  String toString() {
    return 'EopIngestNutationStateEnum{value: $value}';
  }
}

class _EopIngestNutationStateEnumReader extends fb.Reader<EopIngestNutationStateEnum> {
  const _EopIngestNutationStateEnumReader();

  @override
  int get size => 1;

  @override
  EopIngestNutationStateEnum read(fb.BufferContext bc, int offset) =>
      EopIngestNutationStateEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class EopIngestDataModeEnum {
  final int value;
  const EopIngestDataModeEnum._(this.value);

  factory EopIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EopIngestDataModeEnum');
    }
    return result;
  }

  static EopIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EopIngestDataModeEnum.fromValue(value);
  ...
  static const EopIngestDataModeEnum REAL = EopIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EopIngestDataModeEnum TEST = EopIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EopIngestDataModeEnum SIMULATED = EopIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EopIngestDataModeEnum EXERCISE = EopIngestDataModeEnum._(3);
  static const Map<int, EopIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EopIngestDataModeEnum> reader = _EopIngestDataModeEnumReader();

  @override
  String toString() {
    return 'EopIngestDataModeEnum{value: $value}';
  }
}

class _EopIngestDataModeEnumReader extends fb.Reader<EopIngestDataModeEnum> {
  const _EopIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EopIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      EopIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class EopIngest {
  EopIngest._(this._bc, this._bcOffset);
  factory EopIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EopIngest> reader = _EopIngestReader();
  ...
  EopIngestPolarMotionStateEnum get polarMotionState => EopIngestPolarMotionStateEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 10, 0));
  ...
  ///  Example: /// Example: I
  ///  Constraints: Minimum length = 0, Maximum length = 1
  EopIngestUt1UtcstateEnum get ut1Utcstate => EopIngestUt1UtcstateEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 20, 0));
  ...
  ///  Example: /// Example: I
  ///  Constraints: Minimum length = 0, Maximum length = 1
  EopIngestNutationStateEnum get nutationState => EopIngestNutationStateEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 30, 0));
  ...
  EopIngestDataModeEnum get dataMode => EopIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 70, 0));
...
class EopIngestBuilder {
  ...
  int addPolarMotionState(EopIngestPolarMotionStateEnum? polarMotionState) {
  ...
  int addUt1Utcstate(EopIngestUt1UtcstateEnum? ut1Utcstate) {
  ...
  int addNutationState(EopIngestNutationStateEnum? nutationState) {
  ...
  int addDataMode(EopIngestDataModeEnum? dataMode) {
...
class EopIngestObjectBuilder extends fb.ObjectBuilder {
  ...
  final EopIngestDataModeEnum? _dataMode;
  final String? _createdAt;
  final String? _createdBy;
  final String? _origNetwork;

  EopIngestObjectBuilder({
    String? id,
    String? classificationMarking,
    String? eopDate,
    EopIngestPolarMotionStateEnum? polarMotionState,
    double? polarMotionX,
    double? polarMotionXunc,
    double? polarMotionY,
    double? polarMotionYunc,
    EopIngestUt1UtcstateEnum? ut1Utcstate,
    double? ut1Utc,
    double? ut1Utcunc,
    double? lod,
    double? lodUnc,
    EopIngestNutationStateEnum? nutationState,
    double? dPsi,
    double? dPsiunc,
    double? dEpsilon,
    double? dEpsilonUnc,
    ...
    String? source,
    String? origin,
    EopIngestDataModeEnum? dataMode,
    String? createdAt,
    String? createdBy,
    String? origNetwork,
  })
