...
class TrackFullDataModeEnum {
  final int value;
  const TrackFullDataModeEnum._(this.value);

  factory TrackFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum TrackFullDataModeEnum');
    }
    return result;
  }

  static TrackFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : TrackFullDataModeEnum.fromValue(value);
  ...
  static const TrackFullDataModeEnum REAL = TrackFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const TrackFullDataModeEnum TEST = TrackFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const TrackFullDataModeEnum SIMULATED = TrackFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const TrackFullDataModeEnum EXERCISE = TrackFullDataModeEnum._(3);
  static const Map<int, TrackFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<TrackFullDataModeEnum> reader = _TrackFullDataModeEnumReader();

  @override
  String toString() {
    return 'TrackFullDataModeEnum{value: $value}';
  }
}

class _TrackFullDataModeEnumReader extends fb.Reader<TrackFullDataModeEnum> {
  const _TrackFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  TrackFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      TrackFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class TrackFull {
  TrackFull._(this._bc, this._bcOffset);
  factory TrackFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<TrackFull> reader = _TrackFullReader();
  ...
  TrackFullDataModeEnum get dataMode => TrackFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 136, 0));
...
class TrackFullBuilder {
  ...
  int addDataMode(TrackFullDataModeEnum? dataMode) {
...
class TrackFullObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final TrackFullDataModeEnum? _dataMode;
  final String? _origNetwork;

  TrackFullObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    TrackFullDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
