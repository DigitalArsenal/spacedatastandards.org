...
class AirspaceControlOrderReferenceFull {
  AirspaceControlOrderReferenceFull._(this._bc, this._bcOffset);
  factory AirspaceControlOrderReferenceFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirspaceControlOrderReferenceFull> reader = _AirspaceControlOrderReferenceFullReader();
  ...
  @override
  String toString() {
    return 'AirspaceControlOrderReferenceFull{refSid: ${refSid}, refType: ${refType}, refOriginator: ${refOriginator}, refTs: ${refTs}, refSerialNum: ${refSerialNum}, refSpecialNotation: ${refSpecialNotation}, refSics: ${refSics}}';
  }
}

class _AirspaceControlOrderReferenceFullReader extends fb.TableReader<AirspaceControlOrderReferenceFull> {
  const _AirspaceControlOrderReferenceFullReader();

  @override
  AirspaceControlOrderReferenceFull createObject(fb.BufferContext bc, int offset) => 
    AirspaceControlOrderReferenceFull._(bc, offset);
}

class AirspaceControlOrderReferenceFullBuilder {
  AirspaceControlOrderReferenceFullBuilder(this.fbBuilder);
...
class AirspaceControlOrderReferenceFullObjectBuilder extends fb.ObjectBuilder {
  ...
  AirspaceControlOrderReferenceFullObjectBuilder({
    String? refSid,
    String? refType,
