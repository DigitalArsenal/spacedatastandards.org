...
class IonoObservationFrequencyFull {
  IonoObservationFrequencyFull._(this._bc, this._bcOffset);
  factory IonoObservationFrequencyFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<IonoObservationFrequencyFull> reader = _IonoObservationFrequencyFullReader();
  ...
  @override
  String toString() {
    return 'IonoObservationFrequencyFull{notes: ${notes}, dimensions: ${dimensions}, dimensionName: ${dimensionName}, data: ${data}}';
  }
}

class _IonoObservationFrequencyFullReader extends fb.TableReader<IonoObservationFrequencyFull> {
  const _IonoObservationFrequencyFullReader();

  @override
  IonoObservationFrequencyFull createObject(fb.BufferContext bc, int offset) => 
    IonoObservationFrequencyFull._(bc, offset);
}

class IonoObservationFrequencyFullBuilder {
  IonoObservationFrequencyFullBuilder(this.fbBuilder);
...
class IonoObservationFrequencyFullObjectBuilder extends fb.ObjectBuilder {
  final String? _notes;
  final List<String>? _dimensions;
  final List<String>? _dimensionName;
  final List<String>? _data;

  IonoObservationFrequencyFullObjectBuilder({
    String? notes,
