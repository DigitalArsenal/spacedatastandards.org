...
class SoicalibrationAbridged {
  SoicalibrationAbridged._(this._bc, this._bcOffset);
  factory SoicalibrationAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SoicalibrationAbridged> reader = _SoicalibrationAbridgedReader();
  ...
  @override
  String toString() {
    return 'SoicalibrationAbridged{calExtinctionCoeff: ${calExtinctionCoeff}, calSkyBg: ${calSkyBg}, calBgIntensity: ${calBgIntensity}, calSpectralFilterSolarMag: ${calSpectralFilterSolarMag}, calZeroPoint: ${calZeroPoint}, calNumDetectedStars: ${calNumDetectedStars}, calNumCorrelatedStars: ${calNumCorrelatedStars}, calExtinctionCoeffUnc: ${calExtinctionCoeffUnc}, calExtinctionCoeffMaxUnc: ${calExtinctionCoeffMaxUnc}, calTime: ${calTime}, calType: ${calType}}';
  }
}

class _SoicalibrationAbridgedReader extends fb.TableReader<SoicalibrationAbridged> {
  const _SoicalibrationAbridgedReader();

  @override
  SoicalibrationAbridged createObject(fb.BufferContext bc, int offset) => 
    SoicalibrationAbridged._(bc, offset);
}

class SoicalibrationAbridgedBuilder {
  SoicalibrationAbridgedBuilder(this.fbBuilder);
...
class SoicalibrationAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  SoicalibrationAbridgedObjectBuilder({
