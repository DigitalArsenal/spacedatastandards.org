...
class SeradataRadarPayloadAbridgedDataModeEnum {
  final int value;
  const SeradataRadarPayloadAbridgedDataModeEnum._(this.value);

  factory SeradataRadarPayloadAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SeradataRadarPayloadAbridgedDataModeEnum');
    }
    return result;
  }

  static SeradataRadarPayloadAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SeradataRadarPayloadAbridgedDataModeEnum.fromValue(value);
  ...
  static const SeradataRadarPayloadAbridgedDataModeEnum REAL = SeradataRadarPayloadAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SeradataRadarPayloadAbridgedDataModeEnum TEST = SeradataRadarPayloadAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SeradataRadarPayloadAbridgedDataModeEnum SIMULATED = SeradataRadarPayloadAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SeradataRadarPayloadAbridgedDataModeEnum EXERCISE = SeradataRadarPayloadAbridgedDataModeEnum._(3);
  static const Map<int, SeradataRadarPayloadAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SeradataRadarPayloadAbridgedDataModeEnum> reader = _SeradataRadarPayloadAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'SeradataRadarPayloadAbridgedDataModeEnum{value: $value}';
  }
}

class _SeradataRadarPayloadAbridgedDataModeEnumReader extends fb.Reader<SeradataRadarPayloadAbridgedDataModeEnum> {
  const _SeradataRadarPayloadAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SeradataRadarPayloadAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      SeradataRadarPayloadAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Details for an radar payload from  Seradata.
class SeradataRadarPayloadAbridged {
  SeradataRadarPayloadAbridged._(this._bc, this._bcOffset);
  factory SeradataRadarPayloadAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SeradataRadarPayloadAbridged> reader = _SeradataRadarPayloadAbridgedReader();
...
class SeradataRadarPayloadAbridgedBuilder {
  ...
  int addDataMode(SeradataRadarPayloadAbridgedDataModeEnum? dataMode) {
...
class SeradataRadarPayloadAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SeradataRadarPayloadAbridgedDataModeEnum? _dataMode;

  SeradataRadarPayloadAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    SeradataRadarPayloadAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
