...
class WeatherDataAbridgedDataModeEnum {
  final int value;
  const WeatherDataAbridgedDataModeEnum._(this.value);

  factory WeatherDataAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum WeatherDataAbridgedDataModeEnum');
    }
    return result;
  }

  static WeatherDataAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : WeatherDataAbridgedDataModeEnum.fromValue(value);
  ...
  static const WeatherDataAbridgedDataModeEnum REAL = WeatherDataAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const WeatherDataAbridgedDataModeEnum TEST = WeatherDataAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const WeatherDataAbridgedDataModeEnum SIMULATED = WeatherDataAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const WeatherDataAbridgedDataModeEnum EXERCISE = WeatherDataAbridgedDataModeEnum._(3);
  static const Map<int, WeatherDataAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<WeatherDataAbridgedDataModeEnum> reader = _WeatherDataAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'WeatherDataAbridgedDataModeEnum{value: $value}';
  }
}

class _WeatherDataAbridgedDataModeEnumReader extends fb.Reader<WeatherDataAbridgedDataModeEnum> {
  const _WeatherDataAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  WeatherDataAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      WeatherDataAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class WeatherDataAbridged {
  WeatherDataAbridged._(this._bc, this._bcOffset);
  factory WeatherDataAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<WeatherDataAbridged> reader = _WeatherDataAbridgedReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  WeatherDataAbridgedDataModeEnum get dataMode => WeatherDataAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 80, 0));
...
class _WeatherDataAbridgedReader extends fb.TableReader<WeatherDataAbridged> {
  const _WeatherDataAbridgedReader();

  @override
  WeatherDataAbridged createObject(fb.BufferContext bc, int offset) => 
    WeatherDataAbridged._(bc, offset);
}

class WeatherDataAbridgedBuilder {
  WeatherDataAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(WeatherDataAbridgedDataModeEnum? dataMode) {
...
class WeatherDataAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final WeatherDataAbridgedDataModeEnum? _dataMode;

  WeatherDataAbridgedObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    WeatherDataAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
