...
class ItemIngestDataModeEnum {
  final int value;
  const ItemIngestDataModeEnum._(this.value);

  factory ItemIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum ItemIngestDataModeEnum');
    }
    return result;
  }

  static ItemIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : ItemIngestDataModeEnum.fromValue(value);
  ...
  static const ItemIngestDataModeEnum REAL = ItemIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const ItemIngestDataModeEnum TEST = ItemIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const ItemIngestDataModeEnum SIMULATED = ItemIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const ItemIngestDataModeEnum EXERCISE = ItemIngestDataModeEnum._(3);
  static const Map<int, ItemIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<ItemIngestDataModeEnum> reader = _ItemIngestDataModeEnumReader();

  @override
  String toString() {
    return 'ItemIngestDataModeEnum{value: $value}';
  }
}

class _ItemIngestDataModeEnumReader extends fb.Reader<ItemIngestDataModeEnum> {
  const _ItemIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  ItemIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      ItemIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// No description available.
class ItemIngest {
  ItemIngest._(this._bc, this._bcOffset);
  factory ItemIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<ItemIngest> reader = _ItemIngestReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  ItemIngestDataModeEnum get dataMode => ItemIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 104, 0));

  @override
  String toString() {
    return 'ItemIngest{id: ${id}, classificationMarking: ${classificationMarking}, idAirLoadPlan: ${idAirLoadPlan}, scanCode: ${scanCode}, scGenTool: ${scGenTool}, type: ${type}, cargoType: ${cargoType}, name: ${name}, destination: ${destination}, departure: ${departure}, receivingUnit: ${receivingUnit}, receivingBranch: ${receivingBranch}, lastArrDate: ${lastArrDate}, uln: ${uln}, weight: ${weight}, weightTs: ${weightTs}, commodityCode: ${commodityCode}, commoditySys: ${commoditySys}, productCode: ${productCode}, productSys: ${productSys}, width: ${width}, length: ${length}, height: ${height}, volume: ${volume}, cg: ${cg}, fs: ${fs}, centerlineOffset: ${centerlineOffset}, moment: ${moment}, airdrop: ${airdrop}, tcn: ${tcn}, hazCodes: ${hazCodes}, netExpWt: ${netExpWt}, container: ${container}, itemContains: ${itemContains}, numPalletPos: ${numPalletPos}, dvCode: ${dvCode}, notes: ${notes}, keys: ${keys}, values: ${values}, altDataFormat: ${altDataFormat}, accSystem: ${accSystem}, accSysNotes: ${accSysNotes}, accSysKeys: ${accSysKeys}, accSysValues: ${accSysValues}, createdAt: ${createdAt}, createdBy: ${createdBy}, sourceDl: ${sourceDl}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _ItemIngestReader extends fb.TableReader<ItemIngest> {
  const _ItemIngestReader();

  @override
  ItemIngest createObject(fb.BufferContext bc, int offset) => 
    ItemIngest._(bc, offset);
}

class ItemIngestBuilder {
  ItemIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(ItemIngestDataModeEnum? dataMode) {
...
class ItemIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final ItemIngestDataModeEnum? _dataMode;

  ItemIngestObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    ItemIngestDataModeEnum? dataMode,
  })
      : _id = id,
