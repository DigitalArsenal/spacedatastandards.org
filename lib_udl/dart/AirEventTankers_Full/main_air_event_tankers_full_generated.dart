...
library air_event_tankers_full;
...
class AirEventTankersFull {
  AirEventTankersFull._(this._bc, this._bcOffset);
  factory AirEventTankersFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AirEventTankersFull> reader = _AirEventTankersFullReader();
  ...
  @override
  String toString() {
    return 'AirEventTankersFull{idTankerSortie: ${idTankerSortie}, idTankerMission: ${idTankerMission}, idTankerAirfield: ${idTankerAirfield}, externalTankerId: ${externalTankerId}, tankerCoord: ${tankerCoord}, tankerMDS: ${tankerMDS}, amcTankerMissionId: ${amcTankerMissionId}, altTankerMissionId: ${altTankerMissionId}, tankerCallSign: ${tankerCallSign}, tankerOwner: ${tankerOwner}, tankerPOC: ${tankerPOC}, tankerLegNum: ${tankerLegNum}, tankerDeployedICAO: ${tankerDeployedICAO}, tankerDeliveryMethod: ${tankerDeliveryMethod}, fuelOff: ${fuelOff}, tankerCellPosition: ${tankerCellPosition}, tankerFuelType: ${tankerFuelType}, dualRole: ${dualRole}}';
  }
}

class _AirEventTankersFullReader extends fb.TableReader<AirEventTankersFull> {
  const _AirEventTankersFullReader();

  @override
  AirEventTankersFull createObject(fb.BufferContext bc, int offset) => 
    AirEventTankersFull._(bc, offset);
}

class AirEventTankersFullBuilder {
  AirEventTankersFullBuilder(this.fbBuilder);
...
class AirEventTankersFullObjectBuilder extends fb.ObjectBuilder {
  ...
  AirEventTankersFullObjectBuilder({
