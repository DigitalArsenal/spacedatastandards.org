...
class SurfaceAbridgedDataModeEnum {
  final int value;
  const SurfaceAbridgedDataModeEnum._(this.value);

  factory SurfaceAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SurfaceAbridgedDataModeEnum');
    }
    return result;
  }

  static SurfaceAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SurfaceAbridgedDataModeEnum.fromValue(value);
  ...
  static const SurfaceAbridgedDataModeEnum REAL = SurfaceAbridgedDataModeEnum._(0);

  ///  No description available.
  static const SurfaceAbridgedDataModeEnum TEST = SurfaceAbridgedDataModeEnum._(1);

  ///  No description available.
  static const SurfaceAbridgedDataModeEnum SIMULATED = SurfaceAbridgedDataModeEnum._(2);

  ///  No description available.
  static const SurfaceAbridgedDataModeEnum EXERCISE = SurfaceAbridgedDataModeEnum._(3);
  static const Map<int, SurfaceAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SurfaceAbridgedDataModeEnum> reader = _SurfaceAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'SurfaceAbridgedDataModeEnum{value: $value}';
  }
}

class _SurfaceAbridgedDataModeEnumReader extends fb.Reader<SurfaceAbridgedDataModeEnum> {
  const _SurfaceAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SurfaceAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      SurfaceAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class SurfaceAbridged {
  SurfaceAbridged._(this._bc, this._bcOffset);
  factory SurfaceAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SurfaceAbridged> reader = _SurfaceAbridgedReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  SurfaceAbridgedDataModeEnum get dataMode => SurfaceAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 106, 0));

  @override
  String toString() {
    return 'SurfaceAbridged{id: ${id}, classificationMarking: ${classificationMarking}, name: ${name}, type: ${type}, idSite: ${idSite}, altSiteId: ${altSiteId}, primary: ${primary}, lengthFt: ${lengthFt}, ldaFt: ${ldaFt}, widthFt: ${widthFt}, lengthM: ${lengthM}, ldaM: ${ldaM}, widthM: ${widthM}, material: ${material}, condition: ${condition}, rawWbc: ${rawWbc}, pcn: ${pcn}, lcn: ${lcn}, sWtKip: ${sWtKip}, tWtKip: ${tWtKip}, stWtKip: ${stWtKip}, ttWtKip: ${ttWtKip}, ddWtKip: ${ddWtKip}, sbttWtKip: ${sbttWtKip}, tdtWtkip: ${tdtWtkip}, trtWtKip: ${trtWtKip}, ddtWtKip: ${ddtWtKip}, sWtKn: ${sWtKn}, tWtKn: ${tWtKn}, stWtKn: ${stWtKn}, ttWtKn: ${ttWtKn}, ddWtKn: ${ddWtKn}, sbttWtKn: ${sbttWtKn}, tdtWtKn: ${tdtWtKn}, trtWtKn: ${trtWtKn}, ddtWtKn: ${ddtWtKn}, lighting: ${lighting}, lightsUnkn: ${lightsUnkn}, lightsAprch: ${lightsAprch}, lightsVasi: ${lightsVasi}, lightsPapi: ${lightsPapi}, lightsOls: ${lightsOls}, lightsReil: ${lightsReil}, lightsTdzl: ${lightsTdzl}, lightsCl: ${lightsCl}, obstacle: ${obstacle}, createdAt: ${createdAt}, createdBy: ${createdBy}, source: ${source}, origin: ${origin}, origNetwork: ${origNetwork}, dataMode: ${dataMode}}';
  }
}

class _SurfaceAbridgedReader extends fb.TableReader<SurfaceAbridged> {
  const _SurfaceAbridgedReader();

  @override
  SurfaceAbridged createObject(fb.BufferContext bc, int offset) => 
    SurfaceAbridged._(bc, offset);
}

class SurfaceAbridgedBuilder {
  SurfaceAbridgedBuilder(this.fbBuilder);
  ...
  int addDataMode(SurfaceAbridgedDataModeEnum? dataMode) {
...
class SurfaceAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SurfaceAbridgedDataModeEnum? _dataMode;

  SurfaceAbridgedObjectBuilder({
    String? id,
    ...
    String? origin,
    String? origNetwork,
    SurfaceAbridgedDataModeEnum? dataMode,
  })
      : _id = id,
