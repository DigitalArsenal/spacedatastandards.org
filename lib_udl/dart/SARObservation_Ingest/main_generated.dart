...
class SarobservationIngestDataModeEnum {
  final int value;
  const SarobservationIngestDataModeEnum._(this.value);

  factory SarobservationIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum SarobservationIngestDataModeEnum');
    }
    return result;
  }

  static SarobservationIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : SarobservationIngestDataModeEnum.fromValue(value);
  ...
  static const SarobservationIngestDataModeEnum REAL = SarobservationIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const SarobservationIngestDataModeEnum TEST = SarobservationIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const SarobservationIngestDataModeEnum SIMULATED = SarobservationIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const SarobservationIngestDataModeEnum EXERCISE = SarobservationIngestDataModeEnum._(3);
  static const Map<int, SarobservationIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<SarobservationIngestDataModeEnum> reader = _SarobservationIngestDataModeEnumReader();

  @override
  String toString() {
    return 'SarobservationIngestDataModeEnum{value: $value}';
  }
}

class _SarobservationIngestDataModeEnumReader extends fb.Reader<SarobservationIngestDataModeEnum> {
  const _SarobservationIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  SarobservationIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      SarobservationIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class SarobservationIngest {
  SarobservationIngest._(this._bc, this._bcOffset);
  factory SarobservationIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<SarobservationIngest> reader = _SarobservationIngestReader();
  ...
  ///  Constraints: No constraints specified.
  String? get createdAt => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 128);
  ///  Application user who created the row in the database, auto-populated by the system.
  ///  Example: /// Example: some.user
  ///  Constraints: Minimum length = 1, Maximum length = 64
  String? get createdBy => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 130);
  ///  Source of the data.
  ...
  String? get origNetwork => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 136);
  ///  The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
  ///  Example: /// Example: AXE
  ///  Constraints: Minimum length = 0, Maximum length = 64
  String? get sourceDl => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 138);
...
class SarobservationIngestBuilder {
  ...
  int addDataMode(SarobservationIngestDataModeEnum? dataMode) {
    fbBuilder.addInt8(68, dataMode?.value);
    return fbBuilder.offset;
  }
...
class SarobservationIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final SarobservationIngestDataModeEnum? _dataMode;

  SarobservationIngestObjectBuilder({
    String? id,
    ...
    String? origNetwork,
    String? sourceDl,
    SarobservationIngestDataModeEnum? dataMode,
  })
      : _id = id,
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(62, createdAtOffset);
    fbBuilder.addOffset(63, createdByOffset);
    fbBuilder.addOffset(64, sourceOffset);
    fbBuilder.addOffset(65, originOffset);
    fbBuilder.addOffset(66, origNetworkOffset);
    fbBuilder.addOffset(67, sourceDlOffset);
    fbBuilder.addInt8(68, _dataMode?.value);
    return fbBuilder.endTable();
  }
