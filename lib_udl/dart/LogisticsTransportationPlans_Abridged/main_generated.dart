...
class LogisticsTransportationPlansAbridged {
  LogisticsTransportationPlansAbridged._(this._bc, this._bcOffset);
  factory LogisticsTransportationPlansAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LogisticsTransportationPlansAbridged> reader = _LogisticsTransportationPlansAbridgedReader();
  ...
  @override
  String toString() {
    return 'LogisticsTransportationPlansAbridged{plansNumber: ${plansNumber}, missionChange: ${missionChange}, planDefinition: ${planDefinition}, statusCode: ${statusCode}, coordinator: ${coordinator}, coordinatorUnit: ${coordinatorUnit}, originIcao: ${originIcao}, estDepTime: ${estDepTime}, estArrTime: ${estArrTime}, destinationIcao: ${destinationIcao}, logisticMasterRecordId: ${logisticMasterRecordId}, tpTailNumber: ${tpTailNumber}, tpAircraftMds: ${tpAircraftMds}, majcom: ${majcom}, approxArrTime: ${approxArrTime}, duration: ${duration}, actDepTime: ${actDepTime}, closedDate: ${closedDate}, cancelledDate: ${cancelledDate}, aircraftStatus: ${aircraftStatus}, numEnrouteStops: ${numEnrouteStops}, serialNumber: ${serialNumber}, numTransLoads: ${numTransLoads}, lastChangedDate: ${lastChangedDate}, logisticsSegments: ${logisticsSegments}, logisticsTransportationPlansRemarks: ${logisticsTransportationPlansRemarks}}';
  }
}

class _LogisticsTransportationPlansAbridgedReader extends fb.TableReader<LogisticsTransportationPlansAbridged> {
  const _LogisticsTransportationPlansAbridgedReader();

  @override
  LogisticsTransportationPlansAbridged createObject(fb.BufferContext bc, int offset) => 
    LogisticsTransportationPlansAbridged._(bc, offset);
}

class LogisticsTransportationPlansAbridgedBuilder {
  LogisticsTransportationPlansAbridgedBuilder(this.fbBuilder);
...
class LogisticsTransportationPlansAbridgedObjectBuilder extends fb.ObjectBuilder {
  ...
  LogisticsTransportationPlansAbridgedObjectBuilder({
    String? plansNumber,
    bool? missionChange,
