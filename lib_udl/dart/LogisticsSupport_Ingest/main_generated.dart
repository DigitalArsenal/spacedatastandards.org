...
class LogisticsSupportIngestDataModeEnum {
  final int value;
  const LogisticsSupportIngestDataModeEnum._(this.value);

  factory LogisticsSupportIngestDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum LogisticsSupportIngestDataModeEnum');
    }
    return result;
  }

  static LogisticsSupportIngestDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : LogisticsSupportIngestDataModeEnum.fromValue(value);
  ...
  static const LogisticsSupportIngestDataModeEnum REAL = LogisticsSupportIngestDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const LogisticsSupportIngestDataModeEnum TEST = LogisticsSupportIngestDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const LogisticsSupportIngestDataModeEnum SIMULATED = LogisticsSupportIngestDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const LogisticsSupportIngestDataModeEnum EXERCISE = LogisticsSupportIngestDataModeEnum._(3);
  static const Map<int, LogisticsSupportIngestDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<LogisticsSupportIngestDataModeEnum> reader = _LogisticsSupportIngestDataModeEnumReader();

  @override
  String toString() {
    return 'LogisticsSupportIngestDataModeEnum{value: $value}';
  }
}

class _LogisticsSupportIngestDataModeEnumReader extends fb.Reader<LogisticsSupportIngestDataModeEnum> {
  const _LogisticsSupportIngestDataModeEnumReader();

  @override
  int get size => 1;

  @override
  LogisticsSupportIngestDataModeEnum read(fb.BufferContext bc, int offset) =>
      LogisticsSupportIngestDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class LogisticsSupportIngest {
  LogisticsSupportIngest._(this._bc, this._bcOffset);
  factory LogisticsSupportIngest(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<LogisticsSupportIngest> reader = _LogisticsSupportIngestReader();
  ...
  LogisticsSupportIngestDataModeEnum get dataMode => LogisticsSupportIngestDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 62, 0));

  @override
  String toString() {
    return 'LogisticsSupportIngest{id: ${id}, classificationMarking: ${classificationMarking}, extSystemId: ${extSystemId}, tailNumber: ${tailNumber}, aircraftMds: ${aircraftMds}, currIcao: ${currIcao}, suppIcao: ${suppIcao}, rptCreatedTime: ${rptCreatedTime}, rptClosedTime: ${rptClosedTime}, meTime: ${meTime}, mcTime: ${mcTime}, logisticAction: ${logisticAction}, logisticsRecordId: ${logisticsRecordId}, etic: ${etic}, etmc: ${etmc}, maintStatusCode: ${maintStatusCode}, reopenFlag: ${reopenFlag}, owner: ${owner}, logisticsRemarks: ${logisticsRemarks}, logisticsDiscrepancyInfos: ${logisticsDiscrepancyInfos}, logisticsTransportationPlans: ${logisticsTransportationPlans}, logisticsSupportItems: ${logisticsSupportItems}, origNetwork: ${origNetwork}, createdAt: ${createdAt}, createdBy: ${createdBy}, updatedAt: ${updatedAt}, updatedBy: ${updatedBy}, source: ${source}, origin: ${origin}, dataMode: ${dataMode}}';
  }
}

class _LogisticsSupportIngestReader extends fb.TableReader<LogisticsSupportIngest> {
  const _LogisticsSupportIngestReader();

  @override
  LogisticsSupportIngest createObject(fb.BufferContext bc, int offset) => 
    LogisticsSupportIngest._(bc, offset);
}

class LogisticsSupportIngestBuilder {
  LogisticsSupportIngestBuilder(this.fbBuilder);
  ...
  int addDataMode(LogisticsSupportIngestDataModeEnum? dataMode) {
...
class LogisticsSupportIngestObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final LogisticsSupportIngestDataModeEnum? _dataMode;

  LogisticsSupportIngestObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    LogisticsSupportIngestDataModeEnum? dataMode,
  })
      : _id = id,
