...
class EopFullPolarMotionStateEnum {
  final int value;
  const EopFullPolarMotionStateEnum._(this.value);

  factory EopFullPolarMotionStateEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EopFullPolarMotionStateEnum');
    }
    return result;
  }

  static EopFullPolarMotionStateEnum? _createOrNull(int? value) => 
      value == null ? null : EopFullPolarMotionStateEnum.fromValue(value);
  ...
  static const EopFullPolarMotionStateEnum I = EopFullPolarMotionStateEnum._(0);

  ///  No description available.
  static const EopFullPolarMotionStateEnum P = EopFullPolarMotionStateEnum._(1);
  static const Map<int, EopFullPolarMotionStateEnum> values = {
    0: I,
    1: P};

  static const fb.Reader<EopFullPolarMotionStateEnum> reader = _EopFullPolarMotionStateEnumReader();

  @override
  String toString() {
    return 'EopFullPolarMotionStateEnum{value: $value}';
  }
}

class _EopFullPolarMotionStateEnumReader extends fb.Reader<EopFullPolarMotionStateEnum> {
  const _EopFullPolarMotionStateEnumReader();

  @override
  int get size => 1;

  @override
  EopFullPolarMotionStateEnum read(fb.BufferContext bc, int offset) =>
      EopFullPolarMotionStateEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class EopFullUt1UtcstateEnum {
  final int value;
  const EopFullUt1UtcstateEnum._(this.value);

  factory EopFullUt1UtcstateEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EopFullUt1UtcstateEnum');
    }
    return result;
  }

  static EopFullUt1UtcstateEnum? _createOrNull(int? value) => 
      value == null ? null : EopFullUt1UtcstateEnum.fromValue(value);
  ...
  ///  No description available.
  static const EopFullUt1UtcstateEnum I = EopFullUt1UtcstateEnum._(0);

  ///  No description available.
  static const EopFullUt1UtcstateEnum P = EopFullUt1UtcstateEnum._(1);
  static const Map<int, EopFullUt1UtcstateEnum> values = {
    0: I,
    1: P};

  static const fb.Reader<EopFullUt1UtcstateEnum> reader = _EopFullUt1UtcstateEnumReader();

  @override
  String toString() {
    return 'EopFullUt1UtcstateEnum{value: $value}';
  }
}

class _EopFullUt1UtcstateEnumReader extends fb.Reader<EopFullUt1UtcstateEnum> {
  const _EopFullUt1UtcstateEnumReader();

  @override
  int get size => 1;

  @override
  EopFullUt1UtcstateEnum read(fb.BufferContext bc, int offset) =>
      EopFullUt1UtcstateEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class EopFullNutationStateEnum {
  final int value;
  const EopFullNutationStateEnum._(this.value);

  factory EopFullNutationStateEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EopFullNutationStateEnum');
    }
    return result;
  }

  static EopFullNutationStateEnum? _createOrNull(int? value) => 
      value == null ? null : EopFullNutationStateEnum.fromValue(value);
  ...
  ///  No description available.
  static const EopFullNutationStateEnum I = EopFullNutationStateEnum._(0);

  ///  No description available.
  static const EopFullNutationStateEnum P = EopFullNutationStateEnum._(1);
  static const Map<int, EopFullNutationStateEnum> values = {
    0: I,
    1: P};

  static const fb.Reader<EopFullNutationStateEnum> reader = _EopFullNutationStateEnumReader();

  @override
  String toString() {
    return 'EopFullNutationStateEnum{value: $value}';
  }
}

class _EopFullNutationStateEnumReader extends fb.Reader<EopFullNutationStateEnum> {
  const _EopFullNutationStateEnumReader();

  @override
  int get size => 1;

  @override
  EopFullNutationStateEnum read(fb.BufferContext bc, int offset) =>
      EopFullNutationStateEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

class EopFullDataModeEnum {
  final int value;
  const EopFullDataModeEnum._(this.value);

  factory EopFullDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum EopFullDataModeEnum');
    }
    return result;
  }

  static EopFullDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : EopFullDataModeEnum.fromValue(value);
  ...
  static const EopFullDataModeEnum REAL = EopFullDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const EopFullDataModeEnum TEST = EopFullDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const EopFullDataModeEnum SIMULATED = EopFullDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const EopFullDataModeEnum EXERCISE = EopFullDataModeEnum._(3);
  static const Map<int, EopFullDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<EopFullDataModeEnum> reader = _EopFullDataModeEnumReader();

  @override
  String toString() {
    return 'EopFullDataModeEnum{value: $value}';
  }
}

class _EopFullDataModeEnumReader extends fb.Reader<EopFullDataModeEnum> {
  const _EopFullDataModeEnumReader();

  @override
  int get size => 1;

  @override
  EopFullDataModeEnum read(fb.BufferContext bc, int offset) =>
      EopFullDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class EopFull {
  EopFull._(this._bc, this._bcOffset);
  factory EopFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<EopFull> reader = _EopFullReader();
  ...
  EopFullPolarMotionStateEnum get polarMotionState => EopFullPolarMotionStateEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 10, 0));
  ...
  ///  Example: /// Example: I
  ///  Constraints: Minimum length = 0, Maximum length = 1
  EopFullUt1UtcstateEnum get ut1Utcstate => EopFullUt1UtcstateEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 20, 0));
  ...
  ///  Example: /// Example: I
  ///  Constraints: Minimum length = 0, Maximum length = 1
  EopFullNutationStateEnum get nutationState => EopFullNutationStateEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 30, 0));
  ...
  EopFullDataModeEnum get dataMode => EopFullDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 70, 0));
...
class EopFullBuilder {
  ...
  int addPolarMotionState(EopFullPolarMotionStateEnum? polarMotionState) {
  ...
  int addUt1Utcstate(EopFullUt1UtcstateEnum? ut1Utcstate) {
  ...
  int addNutationState(EopFullNutationStateEnum? nutationState) {
  ...
  int addDataMode(EopFullDataModeEnum? dataMode) {
...
class EopFullObjectBuilder extends fb.ObjectBuilder {
  ...
  final EopFullDataModeEnum? _dataMode;
  ...
  EopFullObjectBuilder({
    String? id,
    String? classificationMarking,
    String? eopDate,
    EopFullPolarMotionStateEnum? polarMotionState,
    double? polarMotionX,
    double? polarMotionXunc,
    double? polarMotionY,
    double? polarMotionYunc,
    EopFullUt1UtcstateEnum? ut1Utcstate,
    double? ut1Utc,
    double? ut1Utcunc,
    double? lod,
    double? lodUnc,
    EopFullNutationStateEnum? nutationState,
    double? dPsi,
    double? dPsiunc,
    double? dEpsilon,
    double? dEpsilonUnc,
