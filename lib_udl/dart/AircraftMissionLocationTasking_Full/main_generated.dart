...
class AircraftMissionLocationTaskingFull {
  AircraftMissionLocationTaskingFull._(this._bc, this._bcOffset);
  factory AircraftMissionLocationTaskingFull(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<AircraftMissionLocationTaskingFull> reader = _AircraftMissionLocationTaskingFullReader();
  ...
  @override
  String toString() {
    return 'AircraftMissionLocationTaskingFull{startTime: ${startTime}, endTime: ${endTime}, msnLocName: ${msnLocName}, alt: ${alt}, airMsnPri: ${airMsnPri}, areaGeoRad: ${areaGeoRad}, msnLocPtName: ${msnLocPtName}, msnLocPtLat: ${msnLocPtLat}, msnLocPtLon: ${msnLocPtLon}, msnLocPtBarT: ${msnLocPtBarT}}';
  }
}

class _AircraftMissionLocationTaskingFullReader extends fb.TableReader<AircraftMissionLocationTaskingFull> {
  const _AircraftMissionLocationTaskingFullReader();

  @override
  AircraftMissionLocationTaskingFull createObject(fb.BufferContext bc, int offset) => 
    AircraftMissionLocationTaskingFull._(bc, offset);
}

class AircraftMissionLocationTaskingFullBuilder {
  AircraftMissionLocationTaskingFullBuilder(this.fbBuilder);
...
class AircraftMissionLocationTaskingFullObjectBuilder extends fb.ObjectBuilder {
  ...
  AircraftMissionLocationTaskingFullObjectBuilder({
    String? startTime,
    String? endTime,
    String? msnLocName,
    int? alt,
