...
class MissionAssignmentAbridgedDataModeEnum {
  final int value;
  const MissionAssignmentAbridgedDataModeEnum._(this.value);

  factory MissionAssignmentAbridgedDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum MissionAssignmentAbridgedDataModeEnum');
    }
    return result;
  }

  static MissionAssignmentAbridgedDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : MissionAssignmentAbridgedDataModeEnum.fromValue(value);
  ...
  static const MissionAssignmentAbridgedDataModeEnum REAL = MissionAssignmentAbridgedDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const MissionAssignmentAbridgedDataModeEnum TEST = MissionAssignmentAbridgedDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const MissionAssignmentAbridgedDataModeEnum SIMULATED = MissionAssignmentAbridgedDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const MissionAssignmentAbridgedDataModeEnum EXERCISE = MissionAssignmentAbridgedDataModeEnum._(3);
  static const Map<int, MissionAssignmentAbridgedDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<MissionAssignmentAbridgedDataModeEnum> reader = _MissionAssignmentAbridgedDataModeEnumReader();

  @override
  String toString() {
    return 'MissionAssignmentAbridgedDataModeEnum{value: $value}';
  }
}

class _MissionAssignmentAbridgedDataModeEnumReader extends fb.Reader<MissionAssignmentAbridgedDataModeEnum> {
  const _MissionAssignmentAbridgedDataModeEnumReader();

  @override
  int get size => 1;

  @override
  MissionAssignmentAbridgedDataModeEnum read(fb.BufferContext bc, int offset) =>
      MissionAssignmentAbridgedDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}

///  /// Platform mission assignment data.
class MissionAssignmentAbridged {
  MissionAssignmentAbridged._(this._bc, this._bcOffset);
  factory MissionAssignmentAbridged(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<MissionAssignmentAbridged> reader = _MissionAssignmentAbridgedReader();
  ...
  MissionAssignmentAbridgedDataModeEnum get dataMode => MissionAssignmentAbridgedDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 132, 0));
...
class MissionAssignmentAbridgedBuilder {
  ...
  int addDataMode(MissionAssignmentAbridgedDataModeEnum? dataMode) {
...
class MissionAssignmentAbridgedObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final MissionAssignmentAbridgedDataModeEnum? _dataMode;
  final String? _origNetwork;

  MissionAssignmentAbridgedObjectBuilder({
    String? id,
    ...
    String? source,
    String? origin,
    MissionAssignmentAbridgedDataModeEnum? dataMode,
    String? origNetwork,
  })
      : _id = id,
