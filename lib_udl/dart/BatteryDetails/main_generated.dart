...
class BatteryDetailsDataModeEnum {
  final int value;
  const BatteryDetailsDataModeEnum._(this.value);

  factory BatteryDetailsDataModeEnum.fromValue(int value) {
    final result = values[value];
    if (result == null) {
        throw StateError('Invalid value $value for bit flag enum BatteryDetailsDataModeEnum');
    }
    return result;
  }

  static BatteryDetailsDataModeEnum? _createOrNull(int? value) => 
      value == null ? null : BatteryDetailsDataModeEnum.fromValue(value);
  ...
  static const BatteryDetailsDataModeEnum REAL = BatteryDetailsDataModeEnum._(0);

  ///  Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  static const BatteryDetailsDataModeEnum TEST = BatteryDetailsDataModeEnum._(1);

  ///  Synthetic data generated by a model to mimic real-world datasets.
  static const BatteryDetailsDataModeEnum SIMULATED = BatteryDetailsDataModeEnum._(2);

  ///  Data pertaining to a government or military exercise. The data may include both real and simulated data.
  static const BatteryDetailsDataModeEnum EXERCISE = BatteryDetailsDataModeEnum._(3);
  static const Map<int, BatteryDetailsDataModeEnum> values = {
    0: REAL,
    1: TEST,
    2: SIMULATED,
    3: EXERCISE};

  static const fb.Reader<BatteryDetailsDataModeEnum> reader = _BatteryDetailsDataModeEnumReader();

  @override
  String toString() {
    return 'BatteryDetailsDataModeEnum{value: $value}';
  }
}

class _BatteryDetailsDataModeEnumReader extends fb.Reader<BatteryDetailsDataModeEnum> {
  const _BatteryDetailsDataModeEnumReader();

  @override
  int get size => 1;

  @override
  BatteryDetailsDataModeEnum read(fb.BufferContext bc, int offset) =>
      BatteryDetailsDataModeEnum.fromValue(const fb.Int8Reader().read(bc, offset));
}
...
class BatteryDetails {
  BatteryDetails._(this._bc, this._bcOffset);
  factory BatteryDetails(List<int> bytes) {
    final rootRef = fb.BufferContext.fromBytes(bytes);
    return reader.read(rootRef, 0);
  }

  static const fb.Reader<BatteryDetails> reader = _BatteryDetailsReader();
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  BatteryDetailsDataModeEnum get dataMode => BatteryDetailsDataModeEnum.fromValue(const fb.Int8Reader().vTableGet(_bc, _bcOffset, 36, 0));
...
class BatteryDetailsBuilder {
  ...
  int addDataMode(BatteryDetailsDataModeEnum? dataMode) {
...
class BatteryDetailsObjectBuilder extends fb.ObjectBuilder {
  final String? _id;
  ...
  final BatteryDetailsDataModeEnum? _dataMode;
  final List<String>? _tags;
  final String? _manufacturerOrg;

  BatteryDetailsObjectBuilder({
    String? id,
    String? idBattery,
    ...
    String? origin,
    String? origNetwork,
    BatteryDetailsDataModeEnum? dataMode,
    List<String>? tags,
