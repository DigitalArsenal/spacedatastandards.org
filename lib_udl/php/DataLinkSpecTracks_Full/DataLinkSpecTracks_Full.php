...
class DataLinkSpecTracks_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DataLinkSpecTracks_Full
     */
    public static function getRootAsDataLinkSpecTracks_Full(ByteBuffer $bb)
    {
        $obj = new DataLinkSpecTracks_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DataLinkSpecTracks_FullIdentifier()
    {
        return "DATA";
    }

    public static function DataLinkSpecTracks_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DataLinkSpecTracks_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startDataLinkSpecTracks_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return DataLinkSpecTracks_Full
     */
    public static function createDataLinkSpecTracks_Full(FlatBufferBuilder $builder, $specTrackNum, $specTrackNumDesc)
    {
        $builder->startObject(2);
     ...
     */
    public static function endDataLinkSpecTracks_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDataLinkSpecTracks_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
