...
class Location_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Location_Abridged
     */
    public static function getRootAsLocation_Abridged(ByteBuffer $bb)
    {
        $obj = new Location_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Location_AbridgedIdentifier()
    {
        return "LOCA";
    }

    public static function Location_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Location_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(26);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Location_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startLocation_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return Location_Abridged
     */
    public static function createLocation_Abridged(FlatBufferBuilder $builder, $idLocation, $classificationMarking, $name, $countryCode, $lat, $lon, $altitude, $createdAt, $createdBy, $source, $origin, $dataMode, $origNetwork)
    {
        $builder->startObject(13);
     ...
     */
    public static function endLocation_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLocation_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
