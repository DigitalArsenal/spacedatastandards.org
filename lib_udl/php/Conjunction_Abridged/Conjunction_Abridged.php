...
class Conjunction_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Conjunction_Abridged
     */
    public static function getRootAsConjunction_Abridged(ByteBuffer $bb)
    {
        $obj = new Conjunction_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Conjunction_AbridgedIdentifier()
    {
        return "CONJ";
    }

    public static function Conjunction_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Conjunction_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(120);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Conjunction_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startConjunction_Abridged(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addSbyteX(58, $dataMode, 0);
    }
    ...
    {
        $builder->addOffsetX(61, $stateVector1, 0);
    }
    ...
    {
        $builder->addOffsetX(62, $stateVector2, 0);
    }
    ...
    {
        $builder->addOffsetX(65, $origIdOnOrbit1, 0);
    }
    ...
    {
        $builder->addOffsetX(66, $origIdOnOrbit2, 0);
    }
     ...
     */
    public static function endConjunction_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishConjunction_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
