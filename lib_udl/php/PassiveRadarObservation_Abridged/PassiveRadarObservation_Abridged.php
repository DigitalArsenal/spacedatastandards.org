...
class PassiveRadarObservation_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return PassiveRadarObservation_Abridged
     */
    public static function getRootAsPassiveRadarObservation_Abridged(ByteBuffer $bb)
    {
        $obj = new PassiveRadarObservation_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function PassiveRadarObservation_AbridgedIdentifier()
    {
        return "PASS";
    }

    public static function PassiveRadarObservation_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::PassiveRadarObservation_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(132);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \PassiveRadarObservation_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startPassiveRadarObservation_Abridged(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(56, $transactionId, 0);
    }
    ...
    {
        $builder->addOffsetX(58, $createdAt, 0);
    }
    ...
    {
        $builder->addOffsetX(59, $createdBy, 0);
    }
    ...
    {
        $builder->addOffsetX(62, $origNetwork, 0);
    }
     ...
     */
    public static function endPassiveRadarObservation_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPassiveRadarObservation_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
