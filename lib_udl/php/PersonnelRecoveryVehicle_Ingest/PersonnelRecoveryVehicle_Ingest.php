...
class PersonnelRecoveryVehicle_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return PersonnelRecoveryVehicle_Ingest
     */
    public static function getRootAsPersonnelRecoveryVehicle_Ingest(ByteBuffer $bb)
    {
        $obj = new PersonnelRecoveryVehicle_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function PersonnelRecoveryVehicle_IngestIdentifier()
    {
        return "PERS";
    }

    public static function PersonnelRecoveryVehicle_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::PersonnelRecoveryVehicle_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startPersonnelRecoveryVehicle_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return PersonnelRecoveryVehicle_Ingest
     */
    public static function createPersonnelRecoveryVehicle_Ingest(FlatBufferBuilder $builder, $callSign, $type, $primaryFreq, $strength)
    {
        $builder->startObject(4);
     ...
     */
    public static function endPersonnelRecoveryVehicle_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPersonnelRecoveryVehicle_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
