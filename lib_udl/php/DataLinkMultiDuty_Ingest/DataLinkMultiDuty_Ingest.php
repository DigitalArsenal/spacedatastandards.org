...
class DataLinkMultiDuty_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DataLinkMultiDuty_Ingest
     */
    public static function getRootAsDataLinkMultiDuty_Ingest(ByteBuffer $bb)
    {
        $obj = new DataLinkMultiDuty_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DataLinkMultiDuty_IngestIdentifier()
    {
        return "DATA";
    }

    public static function DataLinkMultiDuty_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DataLinkMultiDuty_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startDataLinkMultiDuty_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return DataLinkMultiDuty_Ingest
     */
    public static function createDataLinkMultiDuty_Ingest(FlatBufferBuilder $builder, $unitDes, $name, $rank, $duty, $dutyTeleFreqNums, $multiDutyVoiceCoord)
    {
        $builder->startObject(6);
     ...
     */
    public static function endDataLinkMultiDuty_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDataLinkMultiDuty_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
