...
class AirLoadPlan_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirLoadPlan_Ingest
     */
    public static function getRootAsAirLoadPlan_Ingest(ByteBuffer $bb)
    {
        $obj = new AirLoadPlan_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirLoadPlan_IngestIdentifier()
    {
        return "AIRL";
    }

    public static function AirLoadPlan_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirLoadPlan_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(100);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirLoadPlan_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAirLoadPlan_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAirLoadPlan_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirLoadPlan_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
