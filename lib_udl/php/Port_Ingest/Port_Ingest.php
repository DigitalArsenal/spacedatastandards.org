...
class Port_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Port_Ingest
     */
    public static function getRootAsPort_Ingest(ByteBuffer $bb)
    {
        $obj = new Port_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Port_IngestIdentifier()
    {
        return "PORT";
    }

    public static function Port_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Port_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(44);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Port_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startPort_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return Port_Ingest
     */
    public static function createPort_Ingest(FlatBufferBuilder $builder, $id, $classificationMarking, $idSite, $externalId, $locode, $portName, $harborType, $harborSize, $maxDraught, $avgDuration, $tideRange, $shelter, $pilotReqd, $lat, $lon, $countryCode, $createdAt, $createdBy, $source, $origin, $dataMode, $origNetwork)
    {
        $builder->startObject(22);
     ...
     */
    public static function endPort_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPort_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
