...
class GNSSObservation_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GNSSObservation_Abridged
     */
    public static function getRootAsGNSSObservation_Abridged(ByteBuffer $bb)
    {
        $obj = new GNSSObservation_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function GNSSObservation_AbridgedIdentifier()
    {
        return "GNSS";
    }

    public static function GNSSObservation_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::GNSSObservation_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startGNSSObservation_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return GNSSObservation_Abridged
     */
    public static function createGNSSObservation_Abridged(FlatBufferBuilder $builder, $gnssSatId, $trackingStatus, $agcState, $obsCodeSet, $ob)
    {
        $builder->startObject(5);
     ...
     */
    public static function endGNSSObservation_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishGNSSObservation_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
