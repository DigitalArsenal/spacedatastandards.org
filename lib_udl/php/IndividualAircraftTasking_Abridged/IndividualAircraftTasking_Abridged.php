...
class IndividualAircraftTasking_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IndividualAircraftTasking_Abridged
     */
    public static function getRootAsIndividualAircraftTasking_Abridged(ByteBuffer $bb)
    {
        $obj = new IndividualAircraftTasking_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IndividualAircraftTasking_AbridgedIdentifier()
    {
        return "INDI";
    }

    public static function IndividualAircraftTasking_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IndividualAircraftTasking_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startIndividualAircraftTasking_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return IndividualAircraftTasking_Abridged
     */
    public static function createIndividualAircraftTasking_Abridged(FlatBufferBuilder $builder, $numAcft, $acftType, $callSign, $priConfigCode, $secConfigCode, $link16CallSign, $tacanChan, $juAddress, $iffSifMode1Code, $iffSifMode2Code, $iffSifMode3Code)
    {
        $builder->startObject(11);
     ...
     */
    public static function endIndividualAircraftTasking_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIndividualAircraftTasking_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
