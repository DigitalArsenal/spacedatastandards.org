...
class LogisticsSegments_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LogisticsSegments_Full
     */
    public static function getRootAsLogisticsSegments_Full(ByteBuffer $bb)
    {
        $obj = new LogisticsSegments_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LogisticsSegments_FullIdentifier()
    {
        return "LOGI";
    }

    public static function LogisticsSegments_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LogisticsSegments_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startLogisticsSegments_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return LogisticsSegments_Full
     */
    public static function createLogisticsSegments_Full(FlatBufferBuilder $builder, $segmentNumber, $modeCode, $missionType, $idMission, $extMissionId, $missionNumber, $itin, $segTailNumber, $segAircraftMDS, $departureICAO, $segActDepTime, $arrivalICAO, $segActArrTime, $segEstDepTime, $segEstArrTime)
    {
        $builder->startObject(15);
     ...
     */
    public static function endLogisticsSegments_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLogisticsSegments_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
