...
class Site_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Site_Abridged
     */
    public static function getRootAsSite_Abridged(ByteBuffer $bb)
    {
        $obj = new Site_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Site_AbridgedIdentifier()
    {
        return "SITE";
    }

    public static function Site_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Site_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(132);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Site_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSite_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return Site_Abridged
     */
    public static function createSite_Abridged(FlatBufferBuilder $builder, $id, $idEntity, $idParentSite, $classificationMarking, $origSiteID, $origLzId, $pin, $type, $usage, $lzUsage, $name, $coordDatum, $coord, $coordDerivAcc, $osuffix, $iata, $icao, $faa, $airDefArea, $utm, $milGridSys, $milGrid, $catCode, $catText, $wac, $polSubdiv, $geoArea, $geoidalMslSep, $allegiance, $altAllegiance, $classRating, $fpa, $beNumber, $runways, $maxRunwayLength, $condition, $conditionAvail, $operStatus, $grade, $activity, $functPrimary, $msnPrimary, $msnPrimarySpec, $nucCap, $ident, $elevMsl, $elevMslConfLvl, $elevMslDerivAcc, $vegHt, $vegType, $popArea, $popAreaProx, $notes, $resProd, $eval, $reviewDate, $recStatus, $symCode, $referenceDoc, $createdAt, $createdBy, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(65);
    ...
    {
        $builder->addOffsetX(2, $idParentSite, 0);
    }
    ...
    {
        $builder->addOffsetX(4, $origSiteID, 0);
    }
    ...
    {
        $builder->addOffsetX(5, $origLzId, 0);
    }
    ...
    {
        $builder->addOffsetX(9, $lzUsage, 0);
    }
    ...
    {
        $builder->addOffsetX(11, $coordDatum, 0);
    }
    ...
    {
        $builder->addDoubleX(13, $coordDerivAcc, 0.0);
    }
    ...
    {
        $builder->addOffsetX(14, $osuffix, 0);
    }
    ...
    {
        $builder->addOffsetX(18, $airDefArea, 0);
    }
    ...
    {
        $builder->addOffsetX(20, $milGridSys, 0);
    }
    ...
    {
        $builder->addOffsetX(21, $milGrid, 0);
    }
    ...
    {
        $builder->addOffsetX(22, $catCode, 0);
    }
    ...
    {
        $builder->addOffsetX(23, $catText, 0);
    }
    ...
    {
        $builder->addOffsetX(25, $polSubdiv, 0);
    }
    ...
    {
        $builder->addOffsetX(26, $geoArea, 0);
    }
    ...
    {
        $builder->addDoubleX(27, $geoidalMslSep, 0.0);
    }
    ...
    {
        $builder->addOffsetX(28, $allegiance, 0);
    }
    ...
    {
        $builder->addOffsetX(29, $altAllegiance, 0);
    }
    ...
    {
        $builder->addOffsetX(30, $classRating, 0);
    }
    ...
    {
        $builder->addOffsetX(32, $beNumber, 0);
    }
    ...
    {
        $builder->addIntX(34, $maxRunwayLength, 0);
    }
    ...
    {
        $builder->addOffsetX(35, $condition, 0);
    }
    ...
    {
        $builder->addOffsetX(36, $conditionAvail, 0);
    }
    ...
    {
        $builder->addOffsetX(37, $operStatus, 0);
    }
    ...
    {
        $builder->addOffsetX(39, $activity, 0);
    }
    ...
    {
        $builder->addOffsetX(40, $functPrimary, 0);
    }
    ...
    {
        $builder->addOffsetX(41, $msnPrimary, 0);
    }
    ...
    {
        $builder->addOffsetX(42, $msnPrimarySpec, 0);
    }
    ...
    {
        $builder->addOffsetX(43, $nucCap, 0);
    }
    ...
    {
        $builder->addDoubleX(45, $elevMsl, 0.0);
    }
    ...
    {
        $builder->addIntX(46, $elevMslConfLvl, 0);
    }
    ...
    {
        $builder->addDoubleX(47, $elevMslDerivAcc, 0.0);
    }
    ...
    {
        $builder->addDoubleX(48, $vegHt, 0.0);
    }
    ...
    {
        $builder->addOffsetX(49, $vegType, 0);
    }
    ...
    {
        $builder->addBoolX(50, $popArea, false);
    }
    ...
    {
        $builder->addDoubleX(51, $popAreaProx, 0.0);
    }
    ...
    {
        $builder->addOffsetX(55, $reviewDate, 0);
    }
    ...
    {
        $builder->addOffsetX(56, $recStatus, 0);
    }
    ...
    {
        $builder->addOffsetX(57, $symCode, 0);
    }
    ...
    {
        $builder->addOffsetX(58, $referenceDoc, 0);
    }
    ...
    {
        $builder->addSbyteX(64, $dataMode, 0);
    }
     ...
     */
    public static function endSite_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSite_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
