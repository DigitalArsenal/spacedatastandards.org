...
class ECPSDR_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ECPSDR_Ingest
     */
    public static function getRootAsECPSDR_Ingest(ByteBuffer $bb)
    {
        $obj = new ECPSDR_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function ECPSDR_IngestIdentifier()
    {
        return "ECPS";
    }

    public static function ECPSDR_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::ECPSDR_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(106);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \ECPSDR_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startECPSDR_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endECPSDR_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishECPSDR_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
