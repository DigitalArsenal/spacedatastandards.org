...
class Comm_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Comm_Ingest
     */
    public static function getRootAsComm_Ingest(ByteBuffer $bb)
    {
        $obj = new Comm_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Comm_IngestIdentifier()
    {
        return "COMM";
    }

    public static function Comm_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Comm_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(20);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Comm_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startComm_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return Comm_Ingest
     */
    public static function createComm_Ingest(FlatBufferBuilder $builder, $id, $idEntity, $name, $classificationMarking, $description, $source, $origin, $origNetwork, $dataMode, $createdAt, $createdBy, $entity)
    {
        $builder->startObject(12);
     ...
     */
    public static function endComm_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishComm_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
