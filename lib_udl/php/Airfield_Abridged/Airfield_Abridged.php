...
class Airfield_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Airfield_Abridged
     */
    public static function getRootAsAirfield_Abridged(ByteBuffer $bb)
    {
        $obj = new Airfield_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Airfield_AbridgedIdentifier()
    {
        return "AIRF";
    }

    public static function Airfield_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Airfield_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(72);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Airfield_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAirfield_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAirfield_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirfield_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
