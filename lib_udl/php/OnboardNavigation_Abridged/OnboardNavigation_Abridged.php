...
class OnboardNavigation_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OnboardNavigation_Abridged
     */
    public static function getRootAsOnboardNavigation_Abridged(ByteBuffer $bb)
    {
        $obj = new OnboardNavigation_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OnboardNavigation_AbridgedIdentifier()
    {
        return "ONBO";
    }

    public static function OnboardNavigation_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OnboardNavigation_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(28);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OnboardNavigation_Abridged_referenceFrame_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(48);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OnboardNavigation_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOnboardNavigation_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endOnboardNavigation_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOnboardNavigation_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
