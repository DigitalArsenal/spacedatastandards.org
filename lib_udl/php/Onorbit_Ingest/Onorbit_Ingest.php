...
class Onorbit_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Onorbit_Ingest
     */
    public static function getRootAsOnorbit_Ingest(ByteBuffer $bb)
    {
        $obj = new Onorbit_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Onorbit_IngestIdentifier()
    {
        return "ONOR";
    }

    public static function Onorbit_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Onorbit_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(20);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Onorbit_Ingest_objectType_Enum::ROCKET_BODY;
    }
    ...
    {
        $o = $this->__offset(26);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Onorbit_Ingest_category_Enum::UNKNOWN;
    }
    ...
    {
        $o = $this->__offset(38);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Onorbit_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOnorbit_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return Onorbit_Ingest
     */
    public static function createOnorbit_Ingest(FlatBufferBuilder $builder, $idOnOrbit, $classificationMarking, $satNo, $commonName, $constellation, $intlDes, $launchDate, $decayDate, $objectType, $origin, $missionNumber, $category, $lifetimeYears, $altName, $createdAt, $createdBy, $source, $dataMode, $launchSiteId, $countryCode, $origNetwork)
    {
        $builder->startObject(21);
     ...
     */
    public static function endOnorbit_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOnorbit_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
