...
class SeradataEarlyWarning_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SeradataEarlyWarning_Full
     */
    public static function getRootAsSeradataEarlyWarning_Full(ByteBuffer $bb)
    {
        $obj = new SeradataEarlyWarning_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SeradataEarlyWarning_FullIdentifier()
    {
        return "SERA";
    }

    public static function SeradataEarlyWarning_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SeradataEarlyWarning_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(50);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SeradataEarlyWarning_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSeradataEarlyWarning_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return SeradataEarlyWarning_Full
     */
    public static function createSeradataEarlyWarning_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $idIR, $spacecraftId, $hostedForCompanyOrgId, $manufacturerOrgId, $name, $spectralBands, $frequencyLimits, $bestResolution, $groundStations, $groundStationLocations, $missileLaunchPhaseDetectionAbility, $earthPointing, $partnerSpacecraftId, $payloadNotes, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(24);
     ...
     */
    public static function endSeradataEarlyWarning_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSeradataEarlyWarning_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
