...
class Track_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Track_Ingest
     */
    public static function getRootAsTrack_Ingest(ByteBuffer $bb)
    {
        $obj = new Track_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Track_IngestIdentifier()
    {
        return "TRAC";
    }

    public static function Track_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Track_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(136);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Track_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startTrack_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endTrack_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishTrack_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
