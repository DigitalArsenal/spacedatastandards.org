...
class FlightPlanPoints_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return FlightPlanPoints_Ingest
     */
    public static function getRootAsFlightPlanPoints_Ingest(ByteBuffer $bb)
    {
        $obj = new FlightPlanPoints_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function FlightPlanPoints_IngestIdentifier()
    {
        return "FLIG";
    }

    public static function FlightPlanPoints_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::FlightPlanPoints_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startFlightPlanPoints_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return FlightPlanPoints_Ingest
     */
    public static function createFlightPlanPoints_Ingest(FlatBufferBuilder $builder, $pointName, $fppLat, $fppLon, $fppEta, $fppReqFuel)
    {
        $builder->startObject(5);
     ...
     */
    public static function endFlightPlanPoints_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishFlightPlanPoints_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
