...
class LogisticsSupportItems_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LogisticsSupportItems_Abridged
     */
    public static function getRootAsLogisticsSupportItems_Abridged(ByteBuffer $bb)
    {
        $obj = new LogisticsSupportItems_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LogisticsSupportItems_AbridgedIdentifier()
    {
        return "LOGI";
    }

    public static function LogisticsSupportItems_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LogisticsSupportItems_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startLogisticsSupportItems_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endLogisticsSupportItems_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLogisticsSupportItems_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
