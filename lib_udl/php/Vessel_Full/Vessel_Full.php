...
class Vessel_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Vessel_Full
     */
    public static function getRootAsVessel_Full(ByteBuffer $bb)
    {
        $obj = new Vessel_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Vessel_FullIdentifier()
    {
        return "VESS";
    }

    public static function Vessel_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Vessel_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(76);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Vessel_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startVessel_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endVessel_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishVessel_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
