...
class SGI_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SGI_Abridged
     */
    public static function getRootAsSGI_Abridged(ByteBuffer $bb)
    {
        $obj = new SGI_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SGI_AbridgedIdentifier()
    {
        return "SGIA";
    }

    public static function SGI_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SGI_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(14);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SGI_Abridged_state_Enum::I;
    }
    ...
    {
        $o = $this->__offset(24);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SGI_Abridged_precedence_Enum::O;
    }
    ...
    {
        $o = $this->__offset(96);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SGI_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSGI_Abridged(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(41, $rawFileURI, 0);
    }
    ...
    {
        $builder->addOffsetX(43, $source, 0);
    }
    ...
    {
        $builder->addOffsetX(44, $origin, 0);
    }
     ...
     */
    public static function endSGI_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSGI_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
