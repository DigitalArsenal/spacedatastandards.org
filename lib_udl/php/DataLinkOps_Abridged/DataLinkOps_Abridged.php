...
class DataLinkOps_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DataLinkOps_Abridged
     */
    public static function getRootAsDataLinkOps_Abridged(ByteBuffer $bb)
    {
        $obj = new DataLinkOps_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DataLinkOps_AbridgedIdentifier()
    {
        return "DATA";
    }

    public static function DataLinkOps_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DataLinkOps_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startDataLinkOps_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return DataLinkOps_Abridged
     */
    public static function createDataLinkOps_Abridged(FlatBufferBuilder $builder, $linkName, $linkStartTime, $linkStopTime, $linkStopTimeMod, $linkDetails)
    {
        $builder->startObject(5);
     ...
     */
    public static function endDataLinkOps_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDataLinkOps_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
