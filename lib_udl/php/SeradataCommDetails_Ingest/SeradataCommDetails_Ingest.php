...
class SeradataCommDetails_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SeradataCommDetails_Ingest
     */
    public static function getRootAsSeradataCommDetails_Ingest(ByteBuffer $bb)
    {
        $obj = new SeradataCommDetails_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SeradataCommDetails_IngestIdentifier()
    {
        return "SERA";
    }

    public static function SeradataCommDetails_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SeradataCommDetails_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(72);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SeradataCommDetails_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSeradataCommDetails_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSeradataCommDetails_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSeradataCommDetails_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
