...
class Bus_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Bus_Full
     */
    public static function getRootAsBus_Full(ByteBuffer $bb)
    {
        $obj = new Bus_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Bus_FullIdentifier()
    {
        return "BUSF";
    }

    public static function Bus_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Bus_FullIdentifier());
    }
     ...
     * @return string
     */
    public function getOrbitTypes($j)
    {
        $o = $this->__offset(82);
     ...
     * @return int
     */
    public function getOrbitTypesLength()
    {
        $o = $this->__offset(82);
    ...
    {
        $o = $this->__offset(110);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Bus_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startBus_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return Bus_Full
     */
    public static function createBus_Full(FlatBufferBuilder $builder, $id, $name, $classificationMarking, $idEntity, $type, $maxLaunchMassLower, $maxLaunchMassUpper, $maxBOLStationMass, $avgPayloadMass, $maxPayloadMass, $minDryMass, $avgDryMass, $medianDryMass, $maxDryMass, $minWetMass, $avgWetMass, $medianWetMass, $maxWetMass, $maxBOLPowerLower, $maxBOLPowerUpper, $maxEOLPowerLower, $maxEOLPowerUpper, $avgSpacecraftPower, $maxSpacecraftPower, $oapSpacecraftPower, $avgPayloadPower, $maxPayloadPower, $oapPayloadPower, $bodyDimensionX, $bodyDimensionY, $bodyDimensionZ, $payloadDimensionX, $payloadDimensionY, $payloadDimensionZ, $payloadVolume, $launchEnvelopeDimensionX, $launchEnvelopeDimensionY, $launchEnvelopeDimensionZ, $numOrbitType, $orbitTypes, $telemetryTrackingManufacturerOrgId, $mainComputerManufacturerOrgId, $manufacturerOrgId, $busKitDesignerOrgId, $countryCode, $massCategory, $powerCategory, $generic, $description, $aocsNotes, $source, $origin, $origNetwork, $dataMode, $createdAt, $createdBy, $updatedAt, $updatedBy, $entity)
    {
        $builder->startObject(59);
        ...
        self::addOrbitTypes($builder, $orbitTypes);
     ...
     * @return void
     */
    public static function addOrbitTypes(FlatBufferBuilder $builder, $orbitTypes)
    {
        $builder->addOffsetX(39, $orbitTypes, 0);
    }
     ...
     */
    public static function createOrbitTypesVector(FlatBufferBuilder $builder, array $data)
    {
     ...
     * @return void
     */
    public static function startOrbitTypesVector(FlatBufferBuilder $builder, $numElems)
    {
    ...
    {
        $builder->addOffsetX(40, $telemetryTrackingManufacturerOrgId, 0);
    }
    ...
    {
        $builder->addOffsetX(41, $mainComputerManufacturerOrgId, 0);
    }
    ...
    {
        $builder->addOffsetX(42, $manufacturerOrgId, 0);
    }
    ...
    {
        $builder->addOffsetX(43, $busKitDesignerOrgId, 0);
    }
    ...
    {
        $builder->addOffsetX(44, $countryCode, 0);
    }
    ...
    {
        $builder->addOffsetX(45, $massCategory, 0);
    }
    ...
    {
        $builder->addOffsetX(46, $powerCategory, 0);
    }
    ...
    {
        $builder->addBoolX(47, $generic, false);
    }
    ...
    {
        $builder->addOffsetX(48, $description, 0);
    }
    ...
    {
        $builder->addOffsetX(49, $aocsNotes, 0);
    }
    ...
    {
        $builder->addOffsetX(54, $createdAt, 0);
    }
    ...
    {
        $builder->addOffsetX(55, $createdBy, 0);
    }
    ...
    {
        $builder->addOffsetX(56, $updatedAt, 0);
    }
    ...
    {
        $builder->addOffsetX(57, $updatedBy, 0);
    }
    ...
    {
        $builder->addOffsetX(58, $entity, 0);
    }
     ...
     */
    public static function endBus_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishBus_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
