...
class AirspaceControlOrder_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirspaceControlOrder_Ingest
     */
    public static function getRootAsAirspaceControlOrder_Ingest(ByteBuffer $bb)
    {
        $obj = new AirspaceControlOrder_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirspaceControlOrder_IngestIdentifier()
    {
        return "AIRS";
    }

    public static function AirspaceControlOrder_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirspaceControlOrder_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(68);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirspaceControlOrder_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAirspaceControlOrder_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAirspaceControlOrder_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirspaceControlOrder_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
