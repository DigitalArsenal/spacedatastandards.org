...
class Evac_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Evac_Abridged
     */
    public static function getRootAsEvac_Abridged(ByteBuffer $bb)
    {
        $obj = new Evac_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Evac_AbridgedIdentifier()
    {
        return "EVAC";
    }

    public static function Evac_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Evac_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(10);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Evac_Abridged_type_Enum::REQUEST;
    }
    ...
    {
        $o = $this->__offset(82);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Evac_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEvac_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endEvac_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvac_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
