...
class SWIR_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SWIR_Ingest
     */
    public static function getRootAsSWIR_Ingest(ByteBuffer $bb)
    {
        $obj = new SWIR_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SWIR_IngestIdentifier()
    {
        return "SWIR";
    }

    public static function SWIR_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SWIR_IngestIdentifier());
    }
     ...
     * @return string
     */
    public function getAbsFluxes($j)
    {
        $o = $this->__offset(24);
        return $o != 0 ? $this->__string($this->__vector($o) + $j * 4) : 0;
    }
     ...
     * @return int
     */
    public function getAbsFluxesLength()
    {
        $o = $this->__offset(24);
        return $o != 0 ? $this->__vector_len($o) : 0;
    }
     ...
     * @return string
     */
    public function getRatioWavelengths($j)
    {
        $o = $this->__offset(26);
        return $o != 0 ? $this->__string($this->__vector($o) + $j * 4) : 0;
    }
     ...
     * @return int
     */
    public function getRatioWavelengthsLength()
    {
        $o = $this->__offset(26);
        return $o != 0 ? $this->__vector_len($o) : 0;
    }
     ...
     * @return string
     */
    public function getFluxRatios($j)
    {
        $o = $this->__offset(28);
        return $o != 0 ? $this->__string($this->__vector($o) + $j * 4) : 0;
    }
     ...
     * @return int
     */
    public function getFluxRatiosLength()
    {
        $o = $this->__offset(28);
        return $o != 0 ? $this->__vector_len($o) : 0;
    }
    ...
    {
        $o = $this->__offset(38);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SWIR_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSWIR_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return SWIR_Ingest
     */
    public static function createSWIR_Ingest(FlatBufferBuilder $builder, $id, $classificationMarking, $idOnOrbit, $ts, $solarPhaseAngle, $lat, $lon, $locationName, $badWave, $wavelengths, $absFluxes, $ratioWavelengths, $fluxRatios, $origObjectId, $source, $origin, $satNo, $dataMode, $createdAt, $createdBy, $origNetwork)
    {
        $builder->startObject(21);
        ...
        self::addAbsFluxes($builder, $absFluxes);
        self::addRatioWavelengths($builder, $ratioWavelengths);
        self::addFluxRatios($builder, $fluxRatios);
    ...
    {
        $builder->addOffsetX(9, $wavelengths, 0);
    }
     ...
     * @return void
     */
    public static function addAbsFluxes(FlatBufferBuilder $builder, $absFluxes)
    {
        $builder->addOffsetX(10, $absFluxes, 0);
    }
     ...
     * @return int vector offset
     */
    public static function createAbsFluxesVector(FlatBufferBuilder $builder, array $data)
    {
        $builder->startVector(4, count($data), 4);
        for ($i = count($data) - 1; $i >= 0; $i--) {
            $builder->putOffset($data[$i]);
     ...
     * @return void
     */
    public static function startAbsFluxesVector(FlatBufferBuilder $builder, $numElems)
    {
        $builder->startVector(4, $numElems, 4);
    }
     ...
     * @return void
     */
    public static function addRatioWavelengths(FlatBufferBuilder $builder, $ratioWavelengths)
    {
        $builder->addOffsetX(11, $ratioWavelengths, 0);
    }
     ...
     * @return int vector offset
     */
    public static function createRatioWavelengthsVector(FlatBufferBuilder $builder, array $data)
    {
        $builder->startVector(4, count($data), 4);
        for ($i = count($data) - 1; $i >= 0; $i--) {
            $builder->putOffset($data[$i]);
     ...
     * @return void
     */
    public static function startRatioWavelengthsVector(FlatBufferBuilder $builder, $numElems)
    {
        $builder->startVector(4, $numElems, 4);
    }
     ...
     * @return void
     */
    public static function addFluxRatios(FlatBufferBuilder $builder, $fluxRatios)
    {
        $builder->addOffsetX(12, $fluxRatios, 0);
    }
     ...
     * @return int vector offset
     */
    public static function createFluxRatiosVector(FlatBufferBuilder $builder, array $data)
    {
        $builder->startVector(4, count($data), 4);
        for ($i = count($data) - 1; $i >= 0; $i--) {
            $builder->putOffset($data[$i]);
     ...
     * @return void
     */
    public static function startFluxRatiosVector(FlatBufferBuilder $builder, $numElems)
    {
        $builder->startVector(4, $numElems, 4);
    }
     ...
     */
    public static function endSWIR_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSWIR_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
