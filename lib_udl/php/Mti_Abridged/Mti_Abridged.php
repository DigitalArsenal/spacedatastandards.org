...
class Mti_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Mti_Abridged
     */
    public static function getRootAsMti_Abridged(ByteBuffer $bb)
    {
        $obj = new Mti_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Mti_AbridgedIdentifier()
    {
        return "MTIA";
    }

    public static function Mti_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Mti_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(12);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Mti_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startMti_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return Mti_Abridged
     */
    public static function createMti_Abridged(FlatBufferBuilder $builder, $classificationMarking, $source, $origin, $id, $dataMode, $createdBy, $createdAt, $p3, $p6, $p7, $p8, $p9, $p10, $missions, $dwells, $hrrs, $jobDefs, $freeTexts, $platformLocs, $jobRequests, $origNetwork)
    {
        $builder->startObject(21);
     ...
     */
    public static function endMti_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMti_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
