...
class CollectResponse_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return CollectResponse_Full
     */
    public static function getRootAsCollectResponse_Full(ByteBuffer $bb)
    {
        $obj = new CollectResponse_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function CollectResponse_FullIdentifier()
    {
        return "COLL";
    }

    public static function CollectResponse_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::CollectResponse_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(56);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \CollectResponse_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startCollectResponse_Full(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(6, $onOrbit, 0);
    }
    ...
    {
        $builder->addOffsetX(10, $status, 0);
    }
    ...
    {
        $builder->addOffsetX(11, $actualStartTime, 0);
    }
    ...
    {
        $builder->addOffsetX(12, $actualEndTime, 0);
    }
    ...
    {
        $builder->addOffsetX(13, $altStartTime, 0);
    }
    ...
    {
        $builder->addOffsetX(14, $altEndTime, 0);
    }
    ...
    {
        $builder->addOffsetX(15, $errCode, 0);
    }
    ...
    {
        $builder->addOffsetX(16, $srcTyps, 0);
    }
    ...
    {
        $builder->addOffsetX(17, $srcIds, 0);
    }
    ...
    {
        $builder->addOffsetX(23, $origNetwork, 0);
    }
    ...
    {
        $builder->addOffsetX(24, $idSensor, 0);
    }
    ...
    {
        $builder->addOffsetX(25, $origSensorId, 0);
    }
    ...
    {
        $builder->addSbyteX(26, $dataMode, 0);
    }
     ...
     */
    public static function endCollectResponse_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishCollectResponse_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
