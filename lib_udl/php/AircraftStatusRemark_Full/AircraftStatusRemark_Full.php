...
class AircraftStatusRemark_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AircraftStatusRemark_Full
     */
    public static function getRootAsAircraftStatusRemark_Full(ByteBuffer $bb)
    {
        $obj = new AircraftStatusRemark_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AircraftStatusRemark_FullIdentifier()
    {
        return "AIRC";
    }

    public static function AircraftStatusRemark_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AircraftStatusRemark_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(38);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AircraftStatusRemark_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAircraftStatusRemark_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return AircraftStatusRemark_Full
     */
    public static function createAircraftStatusRemark_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $idAircraftStatus, $altRmkId, $name, $text, $timestamp, $lastUpdatedBy, $lastUpdatedAt, $createdAt, $createdBy, $updatedAt, $updatedBy, $sourceDL, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(18);
    ...
    {
        $builder->addOffsetX(13, $sourceDL, 0);
    }
     ...
     */
    public static function endAircraftStatusRemark_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAircraftStatusRemark_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
