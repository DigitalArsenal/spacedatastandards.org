...
class Elset_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Elset_Ingest
     */
    public static function getRootAsElset_Ingest(ByteBuffer $bb)
    {
        $obj = new Elset_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Elset_IngestIdentifier()
    {
        return "ELSE";
    }

    public static function Elset_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Elset_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(70);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Elset_Ingest_dataMode_Enum::REAL;
    }
    ...
    {
        $o = $this->__offset(78);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Elset_Ingest_sourcedDataTypes_Enum::EO;
    }
     ...
     * @return void
     */
    public static function startElset_Ingest(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(26, $descriptor, 0);
    }
    ...
    {
        $builder->addOffsetX(29, $rawFileURI, 0);
    }
    ...
    {
        $builder->addOffsetX(31, $sourceDL, 0);
    }
    ...
    {
        $builder->addOffsetX(35, $algorithm, 0);
    }
    ...
    {
        $builder->addOffsetX(36, $sourcedData, 0);
    }
    ...
    {
        $builder->addSbyteX(37, $sourcedDataTypes, 0);
    }
    ...
    {
        $builder->addIntX(39, $ephemType, 0);
    }
     ...
     */
    public static function endElset_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishElset_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
