...
class TrackSensor_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return TrackSensor_Abridged
     */
    public static function getRootAsTrackSensor_Abridged(ByteBuffer $bb)
    {
        $obj = new TrackSensor_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function TrackSensor_AbridgedIdentifier()
    {
        return "TRAC";
    }

    public static function TrackSensor_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::TrackSensor_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(16);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \TrackSensor_Abridged_sensorFOVType_Enum::BUTTERFLY;
    }
     ...
     * @return void
     */
    public static function startTrackSensor_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return TrackSensor_Abridged
     */
    public static function createTrackSensor_Abridged(FlatBufferBuilder $builder, $range, $az, $sensorNumber, $sensorName, $missionNumber, $minRangeLimit, $sensorFOVType)
    {
        $builder->startObject(7);
     ...
     */
    public static function endTrackSensor_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishTrackSensor_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
