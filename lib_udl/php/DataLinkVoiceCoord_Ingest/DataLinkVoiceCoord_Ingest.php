...
class DataLinkVoiceCoord_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DataLinkVoiceCoord_Ingest
     */
    public static function getRootAsDataLinkVoiceCoord_Ingest(ByteBuffer $bb)
    {
        $obj = new DataLinkVoiceCoord_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DataLinkVoiceCoord_IngestIdentifier()
    {
        return "DATA";
    }

    public static function DataLinkVoiceCoord_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DataLinkVoiceCoord_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startDataLinkVoiceCoord_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return DataLinkVoiceCoord_Ingest
     */
    public static function createDataLinkVoiceCoord_Ingest(FlatBufferBuilder $builder, $voiceNetDes, $freqDes, $commPri, $teleFreqNums)
    {
        $builder->startObject(4);
     ...
     */
    public static function endDataLinkVoiceCoord_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDataLinkVoiceCoord_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
