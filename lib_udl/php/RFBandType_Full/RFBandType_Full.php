...
class RFBandType_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return RFBandType_Full
     */
    public static function getRootAsRFBandType_Full(ByteBuffer $bb)
    {
        $obj = new RFBandType_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function RFBandType_FullIdentifier()
    {
        return "RFBA";
    }

    public static function RFBandType_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RFBandType_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(18);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFBandType_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startRFBandType_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return RFBandType_Full
     */
    public static function createRFBandType_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $description, $startFreq, $endFreq, $source, $origin, $dataMode, $createdAt, $createdBy, $updatedAt, $updatedBy)
    {
        $builder->startObject(12);
     ...
     */
    public static function endRFBandType_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRFBandType_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
