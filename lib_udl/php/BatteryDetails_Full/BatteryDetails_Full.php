...
class BatteryDetails_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return BatteryDetails_Full
     */
    public static function getRootAsBatteryDetails_Full(ByteBuffer $bb)
    {
        $obj = new BatteryDetails_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function BatteryDetails_FullIdentifier()
    {
        return "BATT";
    }

    public static function BatteryDetails_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::BatteryDetails_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(36);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \BatteryDetails_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startBatteryDetails_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return BatteryDetails_Full
     */
    public static function createBatteryDetails_Full(FlatBufferBuilder $builder, $id, $idBattery, $classificationMarking, $technology, $capacity, $dischargeDepth, $model, $description, $manufacturerOrgId, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $origNetwork, $dataMode, $tags, $manufacturerOrg)
    {
        $builder->startObject(19);
    ...
    {
        $builder->addSbyteX(16, $dataMode, 0);
    }
    ...
    {
        $builder->addOffsetX(18, $manufacturerOrg, 0);
    }
     ...
     */
    public static function endBatteryDetails_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishBatteryDetails_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
