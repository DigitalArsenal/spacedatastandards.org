...
class MtiPlatformLocation_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MtiPlatformLocation_Full
     */
    public static function getRootAsMtiPlatformLocation_Full(ByteBuffer $bb)
    {
        $obj = new MtiPlatformLocation_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MtiPlatformLocation_FullIdentifier()
    {
        return "MTIP";
    }

    public static function MtiPlatformLocation_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MtiPlatformLocation_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startMtiPlatformLocation_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return MtiPlatformLocation_Full
     */
    public static function createMtiPlatformLocation_Full(FlatBufferBuilder $builder, $l1, $l2, $l3, $l4, $l5, $l6, $l7, $platlocts)
    {
        $builder->startObject(8);
     ...
     */
    public static function endMtiPlatformLocation_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMtiPlatformLocation_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
