...
class MissileTrack_Abridged_objIdent_Enum
{
    ...
    private static $names = array(
        MissileTrack_Abridged_objIdent_Enum::ASSUMED_FRIEND=>"ASSUMED_FRIEND",
        MissileTrack_Abridged_objIdent_Enum::FRIEND=>"FRIEND",
        MissileTrack_Abridged_objIdent_Enum::HOSTILE=>"HOSTILE",
        MissileTrack_Abridged_objIdent_Enum::NEUTRAL=>"NEUTRAL",
        MissileTrack_Abridged_objIdent_Enum::PENDING=>"PENDING",
        MissileTrack_Abridged_objIdent_Enum::SUSPECT=>"SUSPECT",
        MissileTrack_Abridged_objIdent_Enum::UNKNOWN=>"UNKNOWN",
    );
