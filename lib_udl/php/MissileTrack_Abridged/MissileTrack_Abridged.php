...
class MissileTrack_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MissileTrack_Abridged
     */
    public static function getRootAsMissileTrack_Abridged(ByteBuffer $bb)
    {
        $obj = new MissileTrack_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MissileTrack_AbridgedIdentifier()
    {
        return "MISS";
    }

    public static function MissileTrack_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MissileTrack_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(14);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \MissileTrack_Abridged_env_Enum::AIR;
    }
    ...
    {
        $o = $this->__offset(22);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \MissileTrack_Abridged_objIdent_Enum::ASSUMED_FRIEND;
    }
    ...
    {
        $o = $this->__offset(116);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \MissileTrack_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startMissileTrack_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endMissileTrack_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMissileTrack_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
