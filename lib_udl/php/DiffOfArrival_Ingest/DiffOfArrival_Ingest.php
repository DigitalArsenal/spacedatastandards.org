...
class DiffOfArrival_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DiffOfArrival_Ingest
     */
    public static function getRootAsDiffOfArrival_Ingest(ByteBuffer $bb)
    {
        $obj = new DiffOfArrival_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DiffOfArrival_IngestIdentifier()
    {
        return "DIFF";
    }

    public static function DiffOfArrival_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DiffOfArrival_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(72);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \DiffOfArrival_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startDiffOfArrival_Ingest(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(42, $sourceDL, 0);
    }
     ...
     */
    public static function endDiffOfArrival_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDiffOfArrival_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
