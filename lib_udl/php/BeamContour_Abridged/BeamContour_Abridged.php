...
class BeamContour_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return BeamContour_Abridged
     */
    public static function getRootAsBeamContour_Abridged(ByteBuffer $bb)
    {
        $obj = new BeamContour_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function BeamContour_AbridgedIdentifier()
    {
        return "BEAM";
    }

    public static function BeamContour_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::BeamContour_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(10);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \BeamContour_Abridged_type_Enum::BORESIGHT;
    }
    ...
    {
        $o = $this->__offset(38);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \BeamContour_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startBeamContour_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return BeamContour_Abridged
     */
    public static function createBeamContour_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $idBeam, $type, $contourIdx, $gain, $regionName, $geographyText, $geographyJson, $geographyType, $geographyNdims, $geographySrid, $createdAt, $createdBy, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(18);
    ...
    {
        $builder->addOffsetX(7, $geographyText, 0);
    }
    ...
    {
        $builder->addOffsetX(8, $geographyJson, 0);
    }
    ...
    {
        $builder->addOffsetX(9, $geographyType, 0);
    }
    ...
    {
        $builder->addIntX(10, $geographyNdims, 0);
    }
    ...
    {
        $builder->addIntX(11, $geographySrid, 0);
    }
     ...
     */
    public static function endBeamContour_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishBeamContour_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
