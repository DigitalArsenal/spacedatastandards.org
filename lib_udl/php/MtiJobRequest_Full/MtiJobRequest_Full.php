...
class MtiJobRequest_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MtiJobRequest_Full
     */
    public static function getRootAsMtiJobRequest_Full(ByteBuffer $bb)
    {
        $obj = new MtiJobRequest_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MtiJobRequest_FullIdentifier()
    {
        return "MTIJ";
    }

    public static function MtiJobRequest_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MtiJobRequest_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startMtiJobRequest_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return MtiJobRequest_Full
     */
    public static function createMtiJobRequest_Full(FlatBufferBuilder $builder, $r1, $r2, $r3, $r4, $r5, $r6, $r7, $r8, $r9, $r10, $r11, $r12, $r13, $r14, $jobReqEst, $r21, $r22, $r23, $r24, $r25, $r26)
    {
        $builder->startObject(21);
     ...
     */
    public static function endMtiJobRequest_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMtiJobRequest_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
