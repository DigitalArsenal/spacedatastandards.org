...
class AttitudeData_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AttitudeData_Abridged
     */
    public static function getRootAsAttitudeData_Abridged(ByteBuffer $bb)
    {
        $obj = new AttitudeData_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AttitudeData_AbridgedIdentifier()
    {
        return "ATTI";
    }

    public static function AttitudeData_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AttitudeData_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(66);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AttitudeData_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAttitudeData_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAttitudeData_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAttitudeData_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
