...
class SiteRemark_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SiteRemark_Full
     */
    public static function getRootAsSiteRemark_Full(ByteBuffer $bb)
    {
        $obj = new SiteRemark_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SiteRemark_FullIdentifier()
    {
        return "SITE";
    }

    public static function SiteRemark_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SiteRemark_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(30);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SiteRemark_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSiteRemark_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return SiteRemark_Full
     */
    public static function createSiteRemark_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $idSite, $origRmkId, $name, $type, $text, $code, $createdAt, $createdBy, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(14);
     ...
     */
    public static function endSiteRemark_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSiteRemark_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
