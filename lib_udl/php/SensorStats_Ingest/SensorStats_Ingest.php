...
class SensorStats_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SensorStats_Ingest
     */
    public static function getRootAsSensorStats_Ingest(ByteBuffer $bb)
    {
        $obj = new SensorStats_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SensorStats_IngestIdentifier()
    {
        return "SENS";
    }

    public static function SensorStats_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SensorStats_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(22);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SensorStats_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSensorStats_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return SensorStats_Ingest
     */
    public static function createSensorStats_Ingest(FlatBufferBuilder $builder, $id, $idSensor, $classificationMarking, $lastObTime, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $dataMode)
    {
        $builder->startObject(10);
     ...
     */
    public static function endSensorStats_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSensorStats_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
