...
class ISRCollectionTaskings_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ISRCollectionTaskings_Ingest
     */
    public static function getRootAsISRCollectionTaskings_Ingest(ByteBuffer $bb)
    {
        $obj = new ISRCollectionTaskings_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function ISRCollectionTaskings_IngestIdentifier()
    {
        return "ISRC";
    }

    public static function ISRCollectionTaskings_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::ISRCollectionTaskings_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(6);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \ISRCollectionTaskings_Ingest_type_Enum::DELIBERATE;
    }
    ...
    {
        $o = $this->__offset(8);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \ISRCollectionTaskings_Ingest_collectionType_Enum::SIMULTANEOUS;
    }
     ...
     * @return void
     */
    public static function startISRCollectionTaskings_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endISRCollectionTaskings_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishISRCollectionTaskings_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
