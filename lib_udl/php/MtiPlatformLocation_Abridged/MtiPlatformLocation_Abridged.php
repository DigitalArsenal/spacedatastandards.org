...
class MtiPlatformLocation_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MtiPlatformLocation_Abridged
     */
    public static function getRootAsMtiPlatformLocation_Abridged(ByteBuffer $bb)
    {
        $obj = new MtiPlatformLocation_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MtiPlatformLocation_AbridgedIdentifier()
    {
        return "MTIP";
    }

    public static function MtiPlatformLocation_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MtiPlatformLocation_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startMtiPlatformLocation_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return MtiPlatformLocation_Abridged
     */
    public static function createMtiPlatformLocation_Abridged(FlatBufferBuilder $builder, $l1, $l2, $l3, $l4, $l5, $l6, $l7, $platlocts)
    {
        $builder->startObject(8);
     ...
     */
    public static function endMtiPlatformLocation_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMtiPlatformLocation_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
