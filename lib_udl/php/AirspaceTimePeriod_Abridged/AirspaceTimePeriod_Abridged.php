...
class AirspaceTimePeriod_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirspaceTimePeriod_Abridged
     */
    public static function getRootAsAirspaceTimePeriod_Abridged(ByteBuffer $bb)
    {
        $obj = new AirspaceTimePeriod_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirspaceTimePeriod_AbridgedIdentifier()
    {
        return "AIRS";
    }

    public static function AirspaceTimePeriod_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirspaceTimePeriod_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startAirspaceTimePeriod_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return AirspaceTimePeriod_Abridged
     */
    public static function createAirspaceTimePeriod_Abridged(FlatBufferBuilder $builder, $timeMode, $timeStart, $timeEnd, $intFreq, $intDur)
    {
        $builder->startObject(5);
     ...
     */
    public static function endAirspaceTimePeriod_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirspaceTimePeriod_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
