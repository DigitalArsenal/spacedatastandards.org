...
class SensorPlan_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SensorPlan_Full
     */
    public static function getRootAsSensorPlan_Full(ByteBuffer $bb)
    {
        $obj = new SensorPlan_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SensorPlan_FullIdentifier()
    {
        return "SENS";
    }

    public static function SensorPlan_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SensorPlan_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(44);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SensorPlan_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSensorPlan_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return SensorPlan_Full
     */
    public static function createSensorPlan_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $type, $recType, $startTime, $endTime, $name, $idSensor, $origSensorId, $purpose, $senNetwork, $reqTotal, $customer, $status, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $dataMode, $origNetwork, $collectRequests, $tags)
    {
        $builder->startObject(24);
    ...
    {
        $builder->addOffsetX(22, $collectRequests, 0);
    }
     ...
     */
    public static function endSensorPlan_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSensorPlan_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
