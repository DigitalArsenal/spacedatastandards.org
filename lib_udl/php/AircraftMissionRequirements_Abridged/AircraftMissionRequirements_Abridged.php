...
class AircraftMissionRequirements_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AircraftMissionRequirements_Abridged
     */
    public static function getRootAsAircraftMissionRequirements_Abridged(ByteBuffer $bb)
    {
        $obj = new AircraftMissionRequirements_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AircraftMissionRequirements_AbridgedIdentifier()
    {
        return "AIRC";
    }

    public static function AircraftMissionRequirements_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AircraftMissionRequirements_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startAircraftMissionRequirements_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return AircraftMissionRequirements_Abridged
     */
    public static function createAircraftMissionRequirements_Abridged(FlatBufferBuilder $builder, $gdssReqId, $onloadId, $onloadLOCode, $offloadId, $offloadLOCode, $uln, $transReqNum, $projName, $oplan, $numPax, $numLitter, $numAmbulatory, $numAttendant, $bulkWeight, $oversizeWeight, $outsizeWeight, $ead, $lad)
    {
        $builder->startObject(18);
     ...
     */
    public static function endAircraftMissionRequirements_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAircraftMissionRequirements_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
