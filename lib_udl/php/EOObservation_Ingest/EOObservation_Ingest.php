...
class EOObservation_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EOObservation_Ingest
     */
    public static function getRootAsEOObservation_Ingest(ByteBuffer $bb)
    {
        $obj = new EOObservation_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EOObservation_IngestIdentifier()
    {
        return "EOOB";
    }

    public static function EOObservation_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EOObservation_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(164);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EOObservation_Ingest_dataMode_Enum::REAL;
    }
    ...
    {
        $o = $this->__offset(176);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EOObservation_Ingest_referenceFrame_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(178);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EOObservation_Ingest_senReferenceFrame_Enum::J2000;
    }
     ...
     * @return void
     */
    public static function startEOObservation_Ingest(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addSbyteX(86, $referenceFrame, 0);
    }
    ...
    {
        $builder->addSbyteX(87, $senReferenceFrame, 0);
    }
    ...
    {
        $builder->addBoolX(88, $umbra, false);
    }
    ...
    {
        $builder->addBoolX(89, $penumbra, false);
    }
    ...
    {
        $builder->addOffsetX(91, $sourceDL, 0);
    }
     ...
     */
    public static function endEOObservation_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEOObservation_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
