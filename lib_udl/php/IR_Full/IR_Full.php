...
class IR_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IR_Full
     */
    public static function getRootAsIR_Full(ByteBuffer $bb)
    {
        $obj = new IR_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IR_FullIdentifier()
    {
        return "IRFU";
    }

    public static function IR_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IR_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(28);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \IR_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startIR_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return IR_Full
     */
    public static function createIR_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $idEntity, $name, $description, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $origNetwork, $dataMode, $entity)
    {
        $builder->startObject(14);
     ...
     */
    public static function endIR_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIR_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
