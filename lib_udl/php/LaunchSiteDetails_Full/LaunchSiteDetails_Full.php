...
class LaunchSiteDetails_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LaunchSiteDetails_Full
     */
    public static function getRootAsLaunchSiteDetails_Full(ByteBuffer $bb)
    {
        $obj = new LaunchSiteDetails_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LaunchSiteDetails_FullIdentifier()
    {
        return "LAUN";
    }

    public static function LaunchSiteDetails_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LaunchSiteDetails_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(32);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \LaunchSiteDetails_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startLaunchSiteDetails_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return LaunchSiteDetails_Full
     */
    public static function createLaunchSiteDetails_Full(FlatBufferBuilder $builder, $id, $idLaunchSite, $classificationMarking, $idLocation, $launchGroup, $availableInclinations, $description, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $origNetwork, $dataMode, $tags, $location)
    {
        $builder->startObject(17);
     ...
     */
    public static function endLaunchSiteDetails_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLaunchSiteDetails_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
