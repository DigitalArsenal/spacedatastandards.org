...
class DataLinkReferences_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DataLinkReferences_Full
     */
    public static function getRootAsDataLinkReferences_Full(ByteBuffer $bb)
    {
        $obj = new DataLinkReferences_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DataLinkReferences_FullIdentifier()
    {
        return "DATA";
    }

    public static function DataLinkReferences_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DataLinkReferences_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startDataLinkReferences_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return DataLinkReferences_Full
     */
    public static function createDataLinkReferences_Full(FlatBufferBuilder $builder, $refSerialId, $refType, $refOriginator, $refTs, $refSerialNum, $refSpecialNotation, $refSICs)
    {
        $builder->startObject(7);
     ...
     */
    public static function endDataLinkReferences_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDataLinkReferences_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
