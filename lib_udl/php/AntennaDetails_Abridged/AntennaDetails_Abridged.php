...
class AntennaDetails_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AntennaDetails_Abridged
     */
    public static function getRootAsAntennaDetails_Abridged(ByteBuffer $bb)
    {
        $obj = new AntennaDetails_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AntennaDetails_AbridgedIdentifier()
    {
        return "ANTE";
    }

    public static function AntennaDetails_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AntennaDetails_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(14);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AntennaDetails_Abridged_mode_Enum::TX;
    }
    ...
    {
        $o = $this->__offset(50);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AntennaDetails_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAntennaDetails_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return AntennaDetails_Abridged
     */
    public static function createAntennaDetails_Abridged(FlatBufferBuilder $builder, $id, $idAntenna, $classificationMarking, $type, $position, $mode, $steerable, $beamForming, $manufacturerOrgId, $diameter, $size, $startFrequency, $endFrequency, $beamwidth, $gain, $gainTolerance, $polarization, $description, $createdAt, $createdBy, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(24);
     ...
     */
    public static function endAntennaDetails_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAntennaDetails_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
