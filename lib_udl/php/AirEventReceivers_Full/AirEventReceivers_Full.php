...
class AirEventReceivers_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirEventReceivers_Full
     */
    public static function getRootAsAirEventReceivers_Full(ByteBuffer $bb)
    {
        $obj = new AirEventReceivers_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirEventReceivers_FullIdentifier()
    {
        return "AIRE";
    }

    public static function AirEventReceivers_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirEventReceivers_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startAirEventReceivers_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAirEventReceivers_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirEventReceivers_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
