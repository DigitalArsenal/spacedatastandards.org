...
class FlightPlanWaypoints_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return FlightPlanWaypoints_Abridged
     */
    public static function getRootAsFlightPlanWaypoints_Abridged(ByteBuffer $bb)
    {
        $obj = new FlightPlanWaypoints_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function FlightPlanWaypoints_AbridgedIdentifier()
    {
        return "FLIG";
    }

    public static function FlightPlanWaypoints_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::FlightPlanWaypoints_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startFlightPlanWaypoints_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endFlightPlanWaypoints_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishFlightPlanWaypoints_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
