...
class RadarObservation_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return RadarObservation_Full
     */
    public static function getRootAsRadarObservation_Full(ByteBuffer $bb)
    {
        $obj = new RadarObservation_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function RadarObservation_FullIdentifier()
    {
        return "RADA";
    }

    public static function RadarObservation_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RadarObservation_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(106);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RadarObservation_Full_dataMode_Enum::REAL;
    }
    ...
    {
        $o = $this->__offset(116);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RadarObservation_Full_senReferenceFrame_Enum::J2000;
    }
     ...
     * @return void
     */
    public static function startRadarObservation_Full(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addSbyteX(56, $senReferenceFrame, 0);
    }
    ...
    {
        $builder->addOffsetX(58, $origNetwork, 0);
    }
    ...
    {
        $builder->addOffsetX(59, $sourceDL, 0);
    }
     ...
     */
    public static function endRadarObservation_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRadarObservation_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
