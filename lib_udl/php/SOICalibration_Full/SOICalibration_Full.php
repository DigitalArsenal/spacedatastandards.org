...
class SOICalibration_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SOICalibration_Full
     */
    public static function getRootAsSOICalibration_Full(ByteBuffer $bb)
    {
        $obj = new SOICalibration_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SOICalibration_FullIdentifier()
    {
        return "SOIC";
    }

    public static function SOICalibration_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SOICalibration_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startSOICalibration_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return SOICalibration_Full
     */
    public static function createSOICalibration_Full(FlatBufferBuilder $builder, $calExtinctionCoeff, $calSkyBg, $calBgIntensity, $calSpectralFilterSolarMag, $calZeroPoint, $calNumDetectedStars, $calNumCorrelatedStars, $calExtinctionCoeffUnc, $calExtinctionCoeffMaxUnc, $calTime, $calType)
    {
        $builder->startObject(11);
     ...
     */
    public static function endSOICalibration_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSOICalibration_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
