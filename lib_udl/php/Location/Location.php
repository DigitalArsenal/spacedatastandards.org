...
class Location extends Table
{
     ...
     * @return Location
     */
    public static function getRootAsLocation(ByteBuffer $bb)
    {
        $obj = new Location();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LocationIdentifier()
    {
        return "LOCA";
    }

    public static function LocationBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LocationIdentifier());
    }
    ...
    {
        $o = $this->__offset(30);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Location_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startLocation(FlatBufferBuilder $builder)
    {
     ...
     * @return Location
     */
    public static function createLocation(FlatBufferBuilder $builder, $idLocation, $classificationMarking, $name, $countryCode, $lat, $lon, $altitude, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $dataMode, $origNetwork)
    {
        $builder->startObject(15);
     ...
     */
    public static function endLocation(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLocationBuffer(FlatBufferBuilder $builder, $offset)
    {
