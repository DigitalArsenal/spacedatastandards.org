...
class OrbitDetermination_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OrbitDetermination_Ingest
     */
    public static function getRootAsOrbitDetermination_Ingest(ByteBuffer $bb)
    {
        $obj = new OrbitDetermination_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OrbitDetermination_IngestIdentifier()
    {
        return "ORBI";
    }

    public static function OrbitDetermination_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OrbitDetermination_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(90);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OrbitDetermination_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOrbitDetermination_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endOrbitDetermination_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOrbitDetermination_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
