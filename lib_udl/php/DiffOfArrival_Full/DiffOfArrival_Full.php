...
class DiffOfArrival_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DiffOfArrival_Full
     */
    public static function getRootAsDiffOfArrival_Full(ByteBuffer $bb)
    {
        $obj = new DiffOfArrival_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DiffOfArrival_FullIdentifier()
    {
        return "DIFF";
    }

    public static function DiffOfArrival_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DiffOfArrival_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(72);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \DiffOfArrival_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startDiffOfArrival_Full(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(32, $rawFileURI, 0);
    }
    ...
    {
        $builder->addOffsetX(39, $onOrbit, 0);
    }
    ...
    {
        $builder->addOffsetX(40, $descriptor, 0);
    }
    ...
    {
        $builder->addOffsetX(41, $transactionId, 0);
    }
    ...
    {
        $builder->addOffsetX(43, $sourceDL, 0);
    }
     ...
     */
    public static function endDiffOfArrival_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDiffOfArrival_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
