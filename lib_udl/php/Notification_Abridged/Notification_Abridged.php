...
class Notification_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Notification_Abridged
     */
    public static function getRootAsNotification_Abridged(ByteBuffer $bb)
    {
        $obj = new Notification_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Notification_AbridgedIdentifier()
    {
        return "NOTI";
    }

    public static function Notification_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Notification_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(12);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Notification_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startNotification_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return Notification_Abridged
     */
    public static function createNotification_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $msgType, $msgBody, $dataMode, $sourceDL, $source, $origin, $tags, $createdAt, $createdBy, $origNetwork)
    {
        $builder->startObject(12);
     ...
     */
    public static function endNotification_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishNotification_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
