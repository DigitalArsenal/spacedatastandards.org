...
class OrbitTrack_Ingest_objIdent_Enum
{
    ...
    private static $names = array(
        OrbitTrack_Ingest_objIdent_Enum::ASSUMED_FRIEND=>"ASSUMED_FRIEND",
        OrbitTrack_Ingest_objIdent_Enum::FRIEND=>"FRIEND",
        OrbitTrack_Ingest_objIdent_Enum::HOSTILE=>"HOSTILE",
        OrbitTrack_Ingest_objIdent_Enum::NEUTRAL=>"NEUTRAL",
        OrbitTrack_Ingest_objIdent_Enum::PENDING=>"PENDING",
        OrbitTrack_Ingest_objIdent_Enum::SUSPECT=>"SUSPECT",
        OrbitTrack_Ingest_objIdent_Enum::UNKNOWN=>"UNKNOWN",
    );
