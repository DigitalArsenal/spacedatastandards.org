...
class OrbitTrack_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OrbitTrack_Ingest
     */
    public static function getRootAsOrbitTrack_Ingest(ByteBuffer $bb)
    {
        $obj = new OrbitTrack_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OrbitTrack_IngestIdentifier()
    {
        return "ORBI";
    }

    public static function OrbitTrack_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OrbitTrack_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(30);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OrbitTrack_Ingest_objIdent_Enum::ASSUMED_FRIEND;
    }
    ...
    {
        $o = $this->__offset(36);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OrbitTrack_Ingest_objectType_Enum::DEBRIS;
    }
    ...
    {
        $o = $this->__offset(90);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OrbitTrack_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOrbitTrack_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endOrbitTrack_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOrbitTrack_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
