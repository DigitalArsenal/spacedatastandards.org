...
class EphemerisSet_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EphemerisSet_Abridged
     */
    public static function getRootAsEphemerisSet_Abridged(ByteBuffer $bb)
    {
        $obj = new EphemerisSet_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EphemerisSet_AbridgedIdentifier()
    {
        return "EPHE";
    }

    public static function EphemerisSet_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EphemerisSet_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(68);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EphemerisSet_Abridged_referenceFrame_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(70);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EphemerisSet_Abridged_covReferenceFrame_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(80);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EphemerisSet_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEphemerisSet_Abridged(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(41, $origNetwork, 0);
    }
     ...
     */
    public static function endEphemerisSet_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEphemerisSet_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
