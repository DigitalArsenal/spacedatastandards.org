...
class SOIObservationSet_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SOIObservationSet_Abridged
     */
    public static function getRootAsSOIObservationSet_Abridged(ByteBuffer $bb)
    {
        $obj = new SOIObservationSet_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SOIObservationSet_AbridgedIdentifier()
    {
        return "SOIO";
    }

    public static function SOIObservationSet_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SOIObservationSet_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(48);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SOIObservationSet_Abridged_type_Enum::OPTICAL;
    }
    ...
    {
        $o = $this->__offset(54);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SOIObservationSet_Abridged_referenceFrame_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(56);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SOIObservationSet_Abridged_senReferenceFrame_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(144);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SOIObservationSet_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSOIObservationSet_Abridged(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(64, $createdAt, 0);
    }
    ...
    {
        $builder->addOffsetX(65, $createdBy, 0);
    }
    ...
    {
        $builder->addOffsetX(66, $source, 0);
    }
    ...
    {
        $builder->addOffsetX(67, $origin, 0);
    }
    ...
    {
        $builder->addOffsetX(68, $origNetwork, 0);
    }
    ...
    {
        $builder->addSbyteX(70, $dataMode, 0);
    }
     ...
     */
    public static function endSOIObservationSet_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSOIObservationSet_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
