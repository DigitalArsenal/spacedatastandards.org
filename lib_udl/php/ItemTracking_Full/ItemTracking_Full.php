...
class ItemTracking_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ItemTracking_Full
     */
    public static function getRootAsItemTracking_Full(ByteBuffer $bb)
    {
        $obj = new ItemTracking_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function ItemTracking_FullIdentifier()
    {
        return "ITEM";
    }

    public static function ItemTracking_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::ItemTracking_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(46);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \ItemTracking_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startItemTracking_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return ItemTracking_Full
     */
    public static function createItemTracking_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $scanCode, $scGenTool, $scannerId, $ts, $idItem, $type, $lat, $lon, $scanType, $dvCode, $notes, $keys, $values, $createdAt, $createdBy, $sourceDL, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(22);
     ...
     */
    public static function endItemTracking_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishItemTracking_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
