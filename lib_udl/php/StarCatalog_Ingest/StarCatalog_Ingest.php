...
class StarCatalog_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return StarCatalog_Ingest
     */
    public static function getRootAsStarCatalog_Ingest(ByteBuffer $bb)
    {
        $obj = new StarCatalog_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function StarCatalog_IngestIdentifier()
    {
        return "STAR";
    }

    public static function StarCatalog_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::StarCatalog_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(42);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \StarCatalog_Ingest_astrometryOrigin_Enum::GAIADR3;
    }
    ...
    {
        $o = $this->__offset(98);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \StarCatalog_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startStarCatalog_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endStarCatalog_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishStarCatalog_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
