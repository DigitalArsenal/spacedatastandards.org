...
class Sensorlimits_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Sensorlimits_Ingest
     */
    public static function getRootAsSensorlimits_Ingest(ByteBuffer $bb)
    {
        $obj = new Sensorlimits_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Sensorlimits_IngestIdentifier()
    {
        return "SENS";
    }

    public static function Sensorlimits_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Sensorlimits_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(28);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Sensorlimits_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSensorlimits_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSensorlimits_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSensorlimits_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
