...
class IonoObservation_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IonoObservation_Abridged
     */
    public static function getRootAsIonoObservation_Abridged(ByteBuffer $bb)
    {
        $obj = new IonoObservation_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IonoObservation_AbridgedIdentifier()
    {
        return "IONO";
    }

    public static function IonoObservation_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IonoObservation_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(32);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \IonoObservation_Abridged_transmitSensorType_Enum::MOBILE;
    }
    ...
    {
        $o = $this->__offset(36);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \IonoObservation_Abridged_receiveSensorType_Enum::MOBILE;
    }
    ...
    {
        $o = $this->__offset(40);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(216);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \IonoObservation_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startIonoObservation_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endIonoObservation_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIonoObservation_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
