...
class Status_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Status_Ingest
     */
    public static function getRootAsStatus_Ingest(ByteBuffer $bb)
    {
        $obj = new Status_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Status_IngestIdentifier()
    {
        return "STAT";
    }

    public static function Status_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Status_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(16);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Status_Ingest_state_Enum::UNKNOWN;
    }
    ...
    {
        $o = $this->__offset(18);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Status_Ingest_sysCap_Enum::FMC;
    }
    ...
    {
        $o = $this->__offset(20);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Status_Ingest_opsCap_Enum::FMC;
    }
    ...
    {
        $o = $this->__offset(26);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Status_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startStatus_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return Status_Ingest
     */
    public static function createStatus_Ingest(FlatBufferBuilder $builder, $id, $classificationMarking, $derivedFrom, $declassificationDate, $declassificationString, $idEntity, $state, $sysCap, $opsCap, $source, $subStatusCollection, $dataMode, $notes, $createdAt, $createdBy, $origin, $origNetwork)
    {
        $builder->startObject(17);
     ...
     */
    public static function endStatus_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishStatus_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
