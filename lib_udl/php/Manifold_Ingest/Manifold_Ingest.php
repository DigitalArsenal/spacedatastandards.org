...
class Manifold_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Manifold_Ingest
     */
    public static function getRootAsManifold_Ingest(ByteBuffer $bb)
    {
        $obj = new Manifold_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Manifold_IngestIdentifier()
    {
        return "MANI";
    }

    public static function Manifold_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Manifold_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(26);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Manifold_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startManifold_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return Manifold_Ingest
     */
    public static function createManifold_Ingest(FlatBufferBuilder $builder, $id, $idObjectOfInterest, $classificationMarking, $status, $weight, $deltaV, $deltaT, $createdAt, $createdBy, $source, $origin, $dataMode, $origNetwork)
    {
        $builder->startObject(13);
     ...
     */
    public static function endManifold_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishManifold_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
