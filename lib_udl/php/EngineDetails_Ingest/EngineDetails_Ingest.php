...
class EngineDetails_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EngineDetails_Ingest
     */
    public static function getRootAsEngineDetails_Ingest(ByteBuffer $bb)
    {
        $obj = new EngineDetails_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EngineDetails_IngestIdentifier()
    {
        return "ENGI";
    }

    public static function EngineDetails_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EngineDetails_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(48);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EngineDetails_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEngineDetails_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return EngineDetails_Ingest
     */
    public static function createEngineDetails_Ingest(FlatBufferBuilder $builder, $id, $idEngine, $classificationMarking, $family, $cycleType, $characteristicType, $manufacturerOrgId, $specificImpulse, $burnTime, $seaLevelThrust, $vacuumThrust, $chamberPressure, $nozzleExpansionRatio, $maxFirings, $propellant, $oxidizer, $notes, $createdAt, $createdBy, $source, $origin, $origNetwork, $dataMode, $tags)
    {
        $builder->startObject(24);
     ...
     */
    public static function endEngineDetails_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEngineDetails_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
