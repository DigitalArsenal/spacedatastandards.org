...
class LaunchDetection_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LaunchDetection_Full
     */
    public static function getRootAsLaunchDetection_Full(ByteBuffer $bb)
    {
        $obj = new LaunchDetection_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LaunchDetection_FullIdentifier()
    {
        return "LAUN";
    }

    public static function LaunchDetection_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LaunchDetection_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(48);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \LaunchDetection_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startLaunchDetection_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endLaunchDetection_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLaunchDetection_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
