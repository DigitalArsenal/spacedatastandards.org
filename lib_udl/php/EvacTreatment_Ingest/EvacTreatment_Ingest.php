...
class EvacTreatment_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacTreatment_Ingest
     */
    public static function getRootAsEvacTreatment_Ingest(ByteBuffer $bb)
    {
        $obj = new EvacTreatment_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacTreatment_IngestIdentifier()
    {
        return "EVAC";
    }

    public static function EvacTreatment_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacTreatment_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacTreatment_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return EvacTreatment_Ingest
     */
    public static function createEvacTreatment_Ingest(FlatBufferBuilder $builder, $type, $bodyPart, $time, $comments)
    {
        $builder->startObject(4);
     ...
     */
    public static function endEvacTreatment_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacTreatment_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
