...
class WeatherReport_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return WeatherReport_Full
     */
    public static function getRootAsWeatherReport_Full(ByteBuffer $bb)
    {
        $obj = new WeatherReport_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function WeatherReport_FullIdentifier()
    {
        return "WEAT";
    }

    public static function WeatherReport_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::WeatherReport_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(174);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \WeatherReport_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startWeatherReport_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endWeatherReport_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishWeatherReport_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
