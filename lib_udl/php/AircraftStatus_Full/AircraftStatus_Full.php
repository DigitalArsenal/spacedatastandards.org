...
class AircraftStatus_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AircraftStatus_Full
     */
    public static function getRootAsAircraftStatus_Full(ByteBuffer $bb)
    {
        $obj = new AircraftStatus_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AircraftStatus_FullIdentifier()
    {
        return "AIRC";
    }

    public static function AircraftStatus_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AircraftStatus_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(44);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AircraftStatus_Full_airToAirStatus_Enum::OPERATIONAL;
    }
    ...
    {
        $o = $this->__offset(46);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AircraftStatus_Full_airToGroundStatus_Enum::OPERATIONAL;
    }
    ...
    {
        $o = $this->__offset(108);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AircraftStatus_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAircraftStatus_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return AircraftStatus_Full
     */
    public static function createAircraftStatus_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $idAircraft, $altAircraftId, $currentState, $idAirfield, $geoLoc, $previousICAO, $currentICAO, $nextICAO, $flightPhase, $taStartTime, $earliestTAEndTime, $missionReadiness, $fuel, $fuelFunction, $gunCapable, $gunRdsType, $gunRdsMin, $gunRdsMax, $airToAirStatus, $airToGroundStatus, $inventory, $inventoryMin, $inventoryMax, $unavailableSys, $additionalSys, $notes, $mxRemark, $maintStatus, $maintStatusDriver, $maintPriority, $alphaStatusCode, $maintStatusUpdate, $lastInspectionDate, $maintPoc, $groundStatus, $contaminationStatus, $fuelStatus, $lastUpdatedBy, $troubleshootEtic, $etic, $parkLocation, $parkLocationSystem, $idPOI, $createdAt, $createdBy, $updatedAt, $updatedBy, $sourceDL, $source, $origin, $dataMode, $origNetwork)
    {
        $builder->startObject(54);
    ...
    {
        $builder->addOffsetX(49, $sourceDL, 0);
    }
    ...
    {
        $builder->addOffsetX(53, $origNetwork, 0);
    }
     ...
     */
    public static function endAircraftStatus_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAircraftStatus_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
