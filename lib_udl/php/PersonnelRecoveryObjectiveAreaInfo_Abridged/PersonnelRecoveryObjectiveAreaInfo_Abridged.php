...
class PersonnelRecoveryObjectiveAreaInfo_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return PersonnelRecoveryObjectiveAreaInfo_Abridged
     */
    public static function getRootAsPersonnelRecoveryObjectiveAreaInfo_Abridged(ByteBuffer $bb)
    {
        $obj = new PersonnelRecoveryObjectiveAreaInfo_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function PersonnelRecoveryObjectiveAreaInfo_AbridgedIdentifier()
    {
        return "PERS";
    }

    public static function PersonnelRecoveryObjectiveAreaInfo_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::PersonnelRecoveryObjectiveAreaInfo_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startPersonnelRecoveryObjectiveAreaInfo_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return PersonnelRecoveryObjectiveAreaInfo_Abridged
     */
    public static function createPersonnelRecoveryObjectiveAreaInfo_Abridged(FlatBufferBuilder $builder, $pzLocation, $pzDesc, $oscCallSign, $oscFreq, $enemyData)
    {
        $builder->startObject(5);
     ...
     */
    public static function endPersonnelRecoveryObjectiveAreaInfo_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPersonnelRecoveryObjectiveAreaInfo_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
