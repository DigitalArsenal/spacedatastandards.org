...
class OperatingUnitRemark_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OperatingUnitRemark_Ingest
     */
    public static function getRootAsOperatingUnitRemark_Ingest(ByteBuffer $bb)
    {
        $obj = new OperatingUnitRemark_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OperatingUnitRemark_IngestIdentifier()
    {
        return "OPER";
    }

    public static function OperatingUnitRemark_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OperatingUnitRemark_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(28);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OperatingUnitRemark_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOperatingUnitRemark_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return OperatingUnitRemark_Ingest
     */
    public static function createOperatingUnitRemark_Ingest(FlatBufferBuilder $builder, $id, $classificationMarking, $idOperatingUnit, $altRmkId, $name, $type, $text, $code, $createdAt, $createdBy, $source, $origin, $dataMode)
    {
        $builder->startObject(13);
     ...
     */
    public static function endOperatingUnitRemark_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOperatingUnitRemark_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
