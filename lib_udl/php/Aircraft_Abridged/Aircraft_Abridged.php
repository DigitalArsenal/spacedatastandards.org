...
class Aircraft_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Aircraft_Abridged
     */
    public static function getRootAsAircraft_Abridged(ByteBuffer $bb)
    {
        $obj = new Aircraft_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Aircraft_AbridgedIdentifier()
    {
        return "AIRC";
    }

    public static function Aircraft_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Aircraft_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(46);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Aircraft_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAircraft_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return Aircraft_Abridged
     */
    public static function createAircraft_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $idEntity, $aircraftMDS, $tailNumber, $serialNumber, $owner, $command, $category, $dtd, $cruiseSpeed, $maxSpeed, $minReqRunwayM, $minReqRunwayFt, $nominalTATime, $notes, $createdAt, $createdBy, $sourceDL, $source, $origin, $dataMode, $origNetwork)
    {
        $builder->startObject(23);
    ...
    {
        $builder->addOffsetX(3, $aircraftMDS, 0);
    }
    ...
    {
        $builder->addOffsetX(4, $tailNumber, 0);
    }
    ...
    {
        $builder->addOffsetX(5, $serialNumber, 0);
    }
    ...
    {
        $builder->addOffsetX(7, $command, 0);
    }
    ...
    {
        $builder->addDoubleX(10, $cruiseSpeed, 0.0);
    }
    ...
    {
        $builder->addDoubleX(11, $maxSpeed, 0.0);
    }
    ...
    {
        $builder->addIntX(12, $minReqRunwayM, 0);
    }
    ...
    {
        $builder->addIntX(13, $minReqRunwayFt, 0);
    }
    ...
    {
        $builder->addIntX(14, $nominalTATime, 0);
    }
     ...
     */
    public static function endAircraft_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAircraft_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
