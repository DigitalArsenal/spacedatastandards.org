...
class OnorbitThruster_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OnorbitThruster_Full
     */
    public static function getRootAsOnorbitThruster_Full(ByteBuffer $bb)
    {
        $obj = new OnorbitThruster_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OnorbitThruster_FullIdentifier()
    {
        return "ONOR";
    }

    public static function OnorbitThruster_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OnorbitThruster_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(28);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OnorbitThruster_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOnorbitThruster_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return OnorbitThruster_Full
     */
    public static function createOnorbitThruster_Full(FlatBufferBuilder $builder, $id, $idOnOrbit, $idEngine, $classificationMarking, $type, $quantity, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $dataMode, $engine, $origNetwork)
    {
        $builder->startObject(15);
     ...
     */
    public static function endOnorbitThruster_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOnorbitThruster_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
