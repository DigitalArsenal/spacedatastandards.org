...
class OperatingUnitRemark_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OperatingUnitRemark_Abridged
     */
    public static function getRootAsOperatingUnitRemark_Abridged(ByteBuffer $bb)
    {
        $obj = new OperatingUnitRemark_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OperatingUnitRemark_AbridgedIdentifier()
    {
        return "OPER";
    }

    public static function OperatingUnitRemark_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OperatingUnitRemark_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(28);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OperatingUnitRemark_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOperatingUnitRemark_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return OperatingUnitRemark_Abridged
     */
    public static function createOperatingUnitRemark_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $idOperatingUnit, $altRmkId, $name, $type, $text, $code, $createdAt, $createdBy, $source, $origin, $dataMode)
    {
        $builder->startObject(13);
     ...
     */
    public static function endOperatingUnitRemark_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOperatingUnitRemark_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
