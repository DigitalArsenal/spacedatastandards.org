...
class Operatingunit_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Operatingunit_Full
     */
    public static function getRootAsOperatingunit_Full(ByteBuffer $bb)
    {
        $obj = new Operatingunit_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Operatingunit_FullIdentifier()
    {
        return "OPER";
    }

    public static function Operatingunit_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Operatingunit_FullIdentifier());
    }
     ...
     * @return string
     */
    public function getOperatingUnitRemarks($j)
    {
        $o = $this->__offset(114);
     ...
     * @return int
     */
    public function getOperatingUnitRemarksLength()
    {
        $o = $this->__offset(114);
    ...
    {
        $o = $this->__offset(128);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Operatingunit_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOperatingunit_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return Operatingunit_Full
     */
    public static function createOperatingunit_Full(FlatBufferBuilder $builder, $idOperatingUnit, $classificationMarking, $altOperatingUnitId, $name, $description, $idLocation, $idContact, $idOrganization, $unitIdentifier, $countryCode, $altCountryCode, $wac, $operStatus, $condition, $conditionAvail, $eval, $fpa, $ident, $allegiance, $altAllegiance, $locName, $locReason, $force, $forceName, $functRole, $msnPrimary, $msnPrimarySpecialty, $masterUnit, $stylizedUnit, $divCat, $echelon, $echelonTier, $fleetId, $deployStatus, $flagFlown, $coordDatum, $coord, $coordDerivAcc, $lat, $lon, $elevMsl, $elevMslConfLvl, $elevMslDerivAcc, $geoidalMslSep, $milGridSys, $milGrid, $utm, $airDefArea, $polSubdiv, $symCode, $classRating, $recStatus, $reviewDate, $resProd, $referenceDoc, $operatingUnitRemarks, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $dataMode, $organization, $location)
    {
        $builder->startObject(65);
        ...
        self::addOperatingUnitRemarks($builder, $operatingUnitRemarks);
     ...
     * @return void
     */
    public static function addOperatingUnitRemarks(FlatBufferBuilder $builder, $operatingUnitRemarks)
    {
        $builder->addOffsetX(55, $operatingUnitRemarks, 0);
    }
     ...
     */
    public static function createOperatingUnitRemarksVector(FlatBufferBuilder $builder, array $data)
    {
     ...
     * @return void
     */
    public static function startOperatingUnitRemarksVector(FlatBufferBuilder $builder, $numElems)
    {
    ...
    {
        $builder->addOffsetX(56, $createdAt, 0);
    }
    ...
    {
        $builder->addOffsetX(57, $createdBy, 0);
    }
    ...
    {
        $builder->addOffsetX(58, $updatedAt, 0);
    }
    ...
    {
        $builder->addOffsetX(59, $updatedBy, 0);
    }
    ...
    {
        $builder->addOffsetX(60, $source, 0);
    }
    ...
    {
        $builder->addOffsetX(61, $origin, 0);
    }
    ...
    {
        $builder->addSbyteX(62, $dataMode, 0);
    }
    ...
    {
        $builder->addOffsetX(63, $organization, 0);
    }
    ...
    {
        $builder->addOffsetX(64, $location, 0);
    }
     ...
     */
    public static function endOperatingunit_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOperatingunit_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
