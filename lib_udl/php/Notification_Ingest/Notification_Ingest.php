...
class Notification_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Notification_Ingest
     */
    public static function getRootAsNotification_Ingest(ByteBuffer $bb)
    {
        $obj = new Notification_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Notification_IngestIdentifier()
    {
        return "NOTI";
    }

    public static function Notification_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Notification_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(12);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Notification_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startNotification_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return Notification_Ingest
     */
    public static function createNotification_Ingest(FlatBufferBuilder $builder, $id, $classificationMarking, $msgType, $msgBody, $dataMode, $sourceDL, $source, $origin, $tags, $createdAt, $createdBy, $origNetwork)
    {
        $builder->startObject(12);
     ...
     */
    public static function endNotification_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishNotification_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
