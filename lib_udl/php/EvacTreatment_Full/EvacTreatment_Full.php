...
class EvacTreatment_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacTreatment_Full
     */
    public static function getRootAsEvacTreatment_Full(ByteBuffer $bb)
    {
        $obj = new EvacTreatment_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacTreatment_FullIdentifier()
    {
        return "EVAC";
    }

    public static function EvacTreatment_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacTreatment_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacTreatment_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return EvacTreatment_Full
     */
    public static function createEvacTreatment_Full(FlatBufferBuilder $builder, $type, $bodyPart, $time, $comments)
    {
        $builder->startObject(4);
     ...
     */
    public static function endEvacTreatment_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacTreatment_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
