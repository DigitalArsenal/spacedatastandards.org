...
class DriftHistory_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DriftHistory_Full
     */
    public static function getRootAsDriftHistory_Full(ByteBuffer $bb)
    {
        $obj = new DriftHistory_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DriftHistory_FullIdentifier()
    {
        return "DRIF";
    }

    public static function DriftHistory_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DriftHistory_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(20);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \DriftHistory_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startDriftHistory_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return DriftHistory_Full
     */
    public static function createDriftHistory_Full(FlatBufferBuilder $builder, $id, $idOnOrbit, $classificationMarking, $effectiveUntil, $driftRate, $createdBy, $source, $origin, $dataMode)
    {
        $builder->startObject(9);
     ...
     */
    public static function endDriftHistory_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDriftHistory_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
