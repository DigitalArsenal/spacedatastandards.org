...
class IonoObservationProfileDensityShiftedChebyshevEntry_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IonoObservationProfileDensityShiftedChebyshevEntry_Abridged
     */
    public static function getRootAsIonoObservationProfileDensityShiftedChebyshevEntry_Abridged(ByteBuffer $bb)
    {
        $obj = new IonoObservationProfileDensityShiftedChebyshevEntry_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IonoObservationProfileDensityShiftedChebyshevEntry_AbridgedIdentifier()
    {
        return "IONO";
    }

    public static function IonoObservationProfileDensityShiftedChebyshevEntry_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IonoObservationProfileDensityShiftedChebyshevEntry_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startIonoObservationProfileDensityShiftedChebyshevEntry_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return IonoObservationProfileDensityShiftedChebyshevEntry_Abridged
     */
    public static function createIonoObservationProfileDensityShiftedChebyshevEntry_Abridged(FlatBufferBuilder $builder, $layer, $fstart, $fstop, $peakheight, $zhalfNm, $n, $coeffs, $error)
    {
        $builder->startObject(8);
     ...
     */
    public static function endIonoObservationProfileDensityShiftedChebyshevEntry_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIonoObservationProfileDensityShiftedChebyshevEntry_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
