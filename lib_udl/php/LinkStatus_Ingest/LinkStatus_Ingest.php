...
class LinkStatus_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LinkStatus_Ingest
     */
    public static function getRootAsLinkStatus_Ingest(ByteBuffer $bb)
    {
        $obj = new LinkStatus_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LinkStatus_IngestIdentifier()
    {
        return "LINK";
    }

    public static function LinkStatus_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LinkStatus_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(60);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \LinkStatus_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startLinkStatus_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endLinkStatus_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLinkStatus_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
