...
class FlightPlanPoints_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return FlightPlanPoints_Full
     */
    public static function getRootAsFlightPlanPoints_Full(ByteBuffer $bb)
    {
        $obj = new FlightPlanPoints_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function FlightPlanPoints_FullIdentifier()
    {
        return "FLIG";
    }

    public static function FlightPlanPoints_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::FlightPlanPoints_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startFlightPlanPoints_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return FlightPlanPoints_Full
     */
    public static function createFlightPlanPoints_Full(FlatBufferBuilder $builder, $pointName, $fppLat, $fppLon, $fppEta, $fppReqFuel)
    {
        $builder->startObject(5);
     ...
     */
    public static function endFlightPlanPoints_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishFlightPlanPoints_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
