...
class RFBand_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return RFBand_Full
     */
    public static function getRootAsRFBand_Full(ByteBuffer $bb)
    {
        $obj = new RFBand_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function RFBand_FullIdentifier()
    {
        return "RFBA";
    }

    public static function RFBand_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RFBand_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(14);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFBand_Full_mode_Enum::TX;
    }
    ...
    {
        $o = $this->__offset(16);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFBand_Full_purpose_Enum::COMM;
    }
    ...
    {
        $o = $this->__offset(32);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFBand_Full_polarization_Enum::H;
    }
    ...
    {
        $o = $this->__offset(42);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFBand_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startRFBand_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return RFBand_Full
     */
    public static function createRFBand_Full(FlatBufferBuilder $builder, $id, $idEntity, $classificationMarking, $name, $band, $mode, $purpose, $freqMin, $freqMax, $centerFreq, $peakGain, $edgeGain, $bandwidth, $beamwidth, $polarization, $erp, $eirp, $source, $origin, $dataMode, $createdAt, $createdBy, $updatedAt, $updatedBy, $origNetwork)
    {
        $builder->startObject(25);
     ...
     */
    public static function endRFBand_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRFBand_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
