...
class Status extends Table
{
     ...
     * @return Status
     */
    public static function getRootAsStatus(ByteBuffer $bb)
    {
        $obj = new Status();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function StatusIdentifier()
    {
        return "STAT";
    }

    public static function StatusBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::StatusIdentifier());
    }
    ...
    {
        $o = $this->__offset(16);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Status_state_Enum::UNKNOWN;
    }
    ...
    {
        $o = $this->__offset(18);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Status_sysCap_Enum::FMC;
    }
    ...
    {
        $o = $this->__offset(20);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Status_opsCap_Enum::FMC;
    }
    ...
    {
        $o = $this->__offset(26);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Status_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startStatus(FlatBufferBuilder $builder)
    {
     ...
     * @return Status
     */
    public static function createStatus(FlatBufferBuilder $builder, $id, $classificationMarking, $derivedFrom, $declassificationDate, $declassificationString, $idEntity, $state, $sysCap, $opsCap, $source, $subStatusCollection, $dataMode, $notes, $createdAt, $createdBy, $updatedAt, $updatedBy, $origin, $origNetwork)
    {
        $builder->startObject(19);
     ...
     */
    public static function endStatus(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishStatusBuffer(FlatBufferBuilder $builder, $offset)
    {
