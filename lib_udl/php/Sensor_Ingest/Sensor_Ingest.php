...
class Sensor_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Sensor_Ingest
     */
    public static function getRootAsSensor_Ingest(ByteBuffer $bb)
    {
        $obj = new Sensor_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Sensor_IngestIdentifier()
    {
        return "SENS";
    }

    public static function Sensor_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Sensor_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(26);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Sensor_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSensor_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSensor_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSensor_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
