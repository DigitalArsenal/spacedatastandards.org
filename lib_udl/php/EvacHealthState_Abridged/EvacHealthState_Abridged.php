...
class EvacHealthState_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacHealthState_Abridged
     */
    public static function getRootAsEvacHealthState_Abridged(ByteBuffer $bb)
    {
        $obj = new EvacHealthState_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacHealthState_AbridgedIdentifier()
    {
        return "EVAC";
    }

    public static function EvacHealthState_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacHealthState_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacHealthState_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return EvacHealthState_Abridged
     */
    public static function createEvacHealthState_Abridged(FlatBufferBuilder $builder, $type, $healthStateCode, $medConfFactor, $time)
    {
        $builder->startObject(4);
     ...
     */
    public static function endEvacHealthState_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacHealthState_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
