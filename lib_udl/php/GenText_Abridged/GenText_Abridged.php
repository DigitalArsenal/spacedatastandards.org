...
class GenText_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GenText_Abridged
     */
    public static function getRootAsGenText_Abridged(ByteBuffer $bb)
    {
        $obj = new GenText_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function GenText_AbridgedIdentifier()
    {
        return "GENT";
    }

    public static function GenText_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::GenText_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startGenText_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return GenText_Abridged
     */
    public static function createGenText_Abridged(FlatBufferBuilder $builder, $textInd, $text)
    {
        $builder->startObject(2);
     ...
     */
    public static function endGenText_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishGenText_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
