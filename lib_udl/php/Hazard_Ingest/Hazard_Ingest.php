...
class Hazard_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Hazard_Ingest
     */
    public static function getRootAsHazard_Ingest(ByteBuffer $bb)
    {
        $obj = new Hazard_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Hazard_IngestIdentifier()
    {
        return "HAZA";
    }

    public static function Hazard_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Hazard_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(82);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Hazard_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startHazard_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endHazard_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishHazard_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
