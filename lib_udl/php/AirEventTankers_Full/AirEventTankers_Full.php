...
class AirEventTankers_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirEventTankers_Full
     */
    public static function getRootAsAirEventTankers_Full(ByteBuffer $bb)
    {
        $obj = new AirEventTankers_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirEventTankers_FullIdentifier()
    {
        return "AIRE";
    }

    public static function AirEventTankers_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirEventTankers_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startAirEventTankers_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAirEventTankers_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirEventTankers_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
