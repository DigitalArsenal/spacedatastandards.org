...
class ISRCollectionPOC_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ISRCollectionPOC_Ingest
     */
    public static function getRootAsISRCollectionPOC_Ingest(ByteBuffer $bb)
    {
        $obj = new ISRCollectionPOC_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function ISRCollectionPOC_IngestIdentifier()
    {
        return "ISRC";
    }

    public static function ISRCollectionPOC_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::ISRCollectionPOC_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startISRCollectionPOC_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return ISRCollectionPOC_Ingest
     */
    public static function createISRCollectionPOC_Ingest(FlatBufferBuilder $builder, $id, $name, $callsign, $unit, $email, $phone, $radioFrequency, $chatSystem, $chatName, $notes)
    {
        $builder->startObject(10);
     ...
     */
    public static function endISRCollectionPOC_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishISRCollectionPOC_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
