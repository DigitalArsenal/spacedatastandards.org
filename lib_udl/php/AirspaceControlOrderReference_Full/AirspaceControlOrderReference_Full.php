...
class AirspaceControlOrderReference_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirspaceControlOrderReference_Full
     */
    public static function getRootAsAirspaceControlOrderReference_Full(ByteBuffer $bb)
    {
        $obj = new AirspaceControlOrderReference_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirspaceControlOrderReference_FullIdentifier()
    {
        return "AIRS";
    }

    public static function AirspaceControlOrderReference_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirspaceControlOrderReference_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startAirspaceControlOrderReference_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return AirspaceControlOrderReference_Full
     */
    public static function createAirspaceControlOrderReference_Full(FlatBufferBuilder $builder, $refSId, $refType, $refOriginator, $refTs, $refSerialNum, $refSpecialNotation, $refSICs)
    {
        $builder->startObject(7);
     ...
     */
    public static function endAirspaceControlOrderReference_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirspaceControlOrderReference_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
