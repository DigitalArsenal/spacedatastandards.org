...
class GNSSRawIF_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GNSSRawIF_Abridged
     */
    public static function getRootAsGNSSRawIF_Abridged(ByteBuffer $bb)
    {
        $obj = new GNSSRawIF_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function GNSSRawIF_AbridgedIdentifier()
    {
        return "GNSS";
    }

    public static function GNSSRawIF_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::GNSSRawIF_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(80);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \GNSSRawIF_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startGNSSRawIF_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endGNSSRawIF_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishGNSSRawIF_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
