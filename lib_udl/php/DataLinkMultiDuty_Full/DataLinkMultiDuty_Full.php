...
class DataLinkMultiDuty_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DataLinkMultiDuty_Full
     */
    public static function getRootAsDataLinkMultiDuty_Full(ByteBuffer $bb)
    {
        $obj = new DataLinkMultiDuty_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DataLinkMultiDuty_FullIdentifier()
    {
        return "DATA";
    }

    public static function DataLinkMultiDuty_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DataLinkMultiDuty_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startDataLinkMultiDuty_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return DataLinkMultiDuty_Full
     */
    public static function createDataLinkMultiDuty_Full(FlatBufferBuilder $builder, $unitDes, $name, $rank, $duty, $dutyTeleFreqNums, $multiDutyVoiceCoord)
    {
        $builder->startObject(6);
     ...
     */
    public static function endDataLinkMultiDuty_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDataLinkMultiDuty_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
