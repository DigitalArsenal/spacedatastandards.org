...
class ManifoldElset_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ManifoldElset_Full
     */
    public static function getRootAsManifoldElset_Full(ByteBuffer $bb)
    {
        $obj = new ManifoldElset_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function ManifoldElset_FullIdentifier()
    {
        return "MANI";
    }

    public static function ManifoldElset_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::ManifoldElset_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(58);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \ManifoldElset_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startManifoldElset_Full(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(23, $updatedAt, 0);
    }
    ...
    {
        $builder->addOffsetX(24, $updatedBy, 0);
    }
     ...
     */
    public static function endManifoldElset_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishManifoldElset_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
