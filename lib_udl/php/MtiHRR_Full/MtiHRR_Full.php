...
class MtiHRR_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MtiHRR_Full
     */
    public static function getRootAsMtiHRR_Full(ByteBuffer $bb)
    {
        $obj = new MtiHRR_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MtiHRR_FullIdentifier()
    {
        return "MTIH";
    }

    public static function MtiHRR_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MtiHRR_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startMtiHRR_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return MtiHRR_Full
     */
    public static function createMtiHRR_Full(FlatBufferBuilder $builder, $h2, $h3, $h4, $h5, $h6, $h7, $h8, $h9, $h10, $h11, $h12, $h13, $h14, $h15, $h16, $h17, $h18, $h19, $h20, $h21, $h22, $h23, $h24, $h27, $h28, $h29, $h30, $h31, $h32)
    {
        $builder->startObject(29);
     ...
     */
    public static function endMtiHRR_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMtiHRR_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
