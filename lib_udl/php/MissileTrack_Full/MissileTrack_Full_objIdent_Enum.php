...
class MissileTrack_Full_objIdent_Enum
{
    ...
    private static $names = array(
        MissileTrack_Full_objIdent_Enum::ASSUMED_FRIEND=>"ASSUMED_FRIEND",
        MissileTrack_Full_objIdent_Enum::FRIEND=>"FRIEND",
        MissileTrack_Full_objIdent_Enum::HOSTILE=>"HOSTILE",
        MissileTrack_Full_objIdent_Enum::NEUTRAL=>"NEUTRAL",
        MissileTrack_Full_objIdent_Enum::PENDING=>"PENDING",
        MissileTrack_Full_objIdent_Enum::SUSPECT=>"SUSPECT",
        MissileTrack_Full_objIdent_Enum::UNKNOWN=>"UNKNOWN",
    );
