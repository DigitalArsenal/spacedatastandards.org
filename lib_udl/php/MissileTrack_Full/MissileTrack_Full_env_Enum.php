...
class MissileTrack_Full_env_Enum
{
    ...
    private static $names = array(
        MissileTrack_Full_env_Enum::AIR=>"AIR",
        MissileTrack_Full_env_Enum::LAND=>"LAND",
        MissileTrack_Full_env_Enum::SPACE=>"SPACE",
        MissileTrack_Full_env_Enum::SURFACE=>"SURFACE",
        MissileTrack_Full_env_Enum::SUBSURFACE=>"SUBSURFACE",
        MissileTrack_Full_env_Enum::UNKNOWN=>"UNKNOWN",
    );
