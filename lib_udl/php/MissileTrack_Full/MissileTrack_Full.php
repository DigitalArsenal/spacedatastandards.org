...
class MissileTrack_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MissileTrack_Full
     */
    public static function getRootAsMissileTrack_Full(ByteBuffer $bb)
    {
        $obj = new MissileTrack_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MissileTrack_FullIdentifier()
    {
        return "MISS";
    }

    public static function MissileTrack_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MissileTrack_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(14);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \MissileTrack_Full_env_Enum::AIR;
    }
    ...
    {
        $o = $this->__offset(22);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \MissileTrack_Full_objIdent_Enum::ASSUMED_FRIEND;
    }
    ...
    {
        $o = $this->__offset(116);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \MissileTrack_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startMissileTrack_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endMissileTrack_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMissileTrack_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
