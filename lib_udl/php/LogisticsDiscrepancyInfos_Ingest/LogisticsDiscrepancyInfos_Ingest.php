...
class LogisticsDiscrepancyInfos_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LogisticsDiscrepancyInfos_Ingest
     */
    public static function getRootAsLogisticsDiscrepancyInfos_Ingest(ByteBuffer $bb)
    {
        $obj = new LogisticsDiscrepancyInfos_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LogisticsDiscrepancyInfos_IngestIdentifier()
    {
        return "LOGI";
    }

    public static function LogisticsDiscrepancyInfos_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LogisticsDiscrepancyInfos_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startLogisticsDiscrepancyInfos_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return LogisticsDiscrepancyInfos_Ingest
     */
    public static function createLogisticsDiscrepancyInfos_Ingest(FlatBufferBuilder $builder, $jcn, $discrepancyInfo, $jobStTime, $closureTime)
    {
        $builder->startObject(4);
     ...
     */
    public static function endLogisticsDiscrepancyInfos_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLogisticsDiscrepancyInfos_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
