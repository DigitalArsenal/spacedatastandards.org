...
class MissileTrackVector_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MissileTrackVector_Full
     */
    public static function getRootAsMissileTrackVector_Full(ByteBuffer $bb)
    {
        $obj = new MissileTrackVector_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MissileTrackVector_FullIdentifier()
    {
        return "MISS";
    }

    public static function MissileTrackVector_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MissileTrackVector_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startMissileTrackVector_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return MissileTrackVector_Full
     */
    public static function createMissileTrackVector_Full(FlatBufferBuilder $builder, $type, $object, $epoch, $idSensor, $origSensorId, $pos, $vel, $accel, $course, $spd, $referenceFrame, $cov, $covReferenceFrame, $vectorLat, $vectorLon, $vectorAlt, $confidence, $status, $timeSource, $quat, $flightAz)
    {
        $builder->startObject(21);
     ...
     */
    public static function endMissileTrackVector_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMissileTrackVector_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
