...
class LogisticsStocks_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LogisticsStocks_Ingest
     */
    public static function getRootAsLogisticsStocks_Ingest(ByteBuffer $bb)
    {
        $obj = new LogisticsStocks_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LogisticsStocks_IngestIdentifier()
    {
        return "LOGI";
    }

    public static function LogisticsStocks_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LogisticsStocks_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startLogisticsStocks_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return LogisticsStocks_Ingest
     */
    public static function createLogisticsStocks_Ingest(FlatBufferBuilder $builder, $sourceICAO, $quantity, $stockCheckTime, $stockPOC)
    {
        $builder->startObject(4);
     ...
     */
    public static function endLogisticsStocks_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLogisticsStocks_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
