...
class IonoObservationDensityProfileIRI_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IonoObservationDensityProfileIRI_Ingest
     */
    public static function getRootAsIonoObservationDensityProfileIRI_Ingest(ByteBuffer $bb)
    {
        $obj = new IonoObservationDensityProfileIRI_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IonoObservationDensityProfileIRI_IngestIdentifier()
    {
        return "IONO";
    }

    public static function IonoObservationDensityProfileIRI_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IonoObservationDensityProfileIRI_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startIonoObservationDensityProfileIRI_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return IonoObservationDensityProfileIRI_Ingest
     */
    public static function createIonoObservationDensityProfileIRI_Ingest(FlatBufferBuilder $builder, $description, $nmF2, $hmF2, $b0, $b1, $nmF1, $hmF1, $d1, $hz, $hValTop, $nValB, $nmE, $hmE, $hdx, $nmD, $hmD, $ha, $fp1, $fp2, $fp30, $fp3U, $chi)
    {
        $builder->startObject(22);
     ...
     */
    public static function endIonoObservationDensityProfileIRI_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIonoObservationDensityProfileIRI_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
