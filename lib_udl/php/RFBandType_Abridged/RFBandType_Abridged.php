...
class RFBandType_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return RFBandType_Abridged
     */
    public static function getRootAsRFBandType_Abridged(ByteBuffer $bb)
    {
        $obj = new RFBandType_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function RFBandType_AbridgedIdentifier()
    {
        return "RFBA";
    }

    public static function RFBandType_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RFBandType_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(18);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFBandType_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startRFBandType_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return RFBandType_Abridged
     */
    public static function createRFBandType_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $description, $startFreq, $endFreq, $source, $origin, $dataMode, $createdAt, $createdBy)
    {
        $builder->startObject(10);
     ...
     */
    public static function endRFBandType_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRFBandType_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
