...
class Elset_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Elset_Abridged
     */
    public static function getRootAsElset_Abridged(ByteBuffer $bb)
    {
        $obj = new Elset_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Elset_AbridgedIdentifier()
    {
        return "ELSE";
    }

    public static function Elset_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Elset_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(68);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Elset_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startElset_Abridged(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(33, $algorithm, 0);
    }
    ...
    {
        $builder->addOffsetX(34, $transactionId, 0);
    }
    ...
    {
        $builder->addIntX(35, $ephemType, 0);
    }
     ...
     */
    public static function endElset_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishElset_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
