...
/// /// ISR Collection data.
class ISRCollection_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ISRCollection_Full
     */
    public static function getRootAsISRCollection_Full(ByteBuffer $bb)
    {
        $obj = new ISRCollection_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function ISRCollection_FullIdentifier()
    {
        return "ISRC";
    }

    public static function ISRCollection_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::ISRCollection_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(68);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \ISRCollection_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startISRCollection_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endISRCollection_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishISRCollection_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
