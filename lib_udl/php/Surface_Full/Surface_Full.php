...
class Surface_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Surface_Full
     */
    public static function getRootAsSurface_Full(ByteBuffer $bb)
    {
        $obj = new Surface_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Surface_FullIdentifier()
    {
        return "SURF";
    }

    public static function Surface_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Surface_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(110);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Surface_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSurface_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSurface_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSurface_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
