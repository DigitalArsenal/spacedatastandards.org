...
class AttitudeData_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AttitudeData_Full
     */
    public static function getRootAsAttitudeData_Full(ByteBuffer $bb)
    {
        $obj = new AttitudeData_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AttitudeData_FullIdentifier()
    {
        return "ATTI";
    }

    public static function AttitudeData_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AttitudeData_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(66);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AttitudeData_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAttitudeData_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAttitudeData_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAttitudeData_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
