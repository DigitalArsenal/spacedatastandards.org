...
class EffectRequest_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EffectRequest_Abridged
     */
    public static function getRootAsEffectRequest_Abridged(ByteBuffer $bb)
    {
        $obj = new EffectRequest_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EffectRequest_AbridgedIdentifier()
    {
        return "EFFE";
    }

    public static function EffectRequest_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EffectRequest_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(42);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EffectRequest_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEffectRequest_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return EffectRequest_Abridged
     */
    public static function createEffectRequest_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $externalRequestId, $effectList, $state, $context, $startTime, $endTime, $deadlineType, $targetSrcType, $targetSrcId, $priority, $modelClass, $metricTypes, $metricWeights, $createdAt, $createdBy, $source, $origin, $dataMode, $origNetwork)
    {
        $builder->startObject(21);
     ...
     */
    public static function endEffectRequest_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEffectRequest_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
