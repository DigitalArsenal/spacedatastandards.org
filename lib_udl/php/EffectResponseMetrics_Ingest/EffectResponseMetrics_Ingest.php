...
class EffectResponseMetrics_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EffectResponseMetrics_Ingest
     */
    public static function getRootAsEffectResponseMetrics_Ingest(ByteBuffer $bb)
    {
        $obj = new EffectResponseMetrics_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EffectResponseMetrics_IngestIdentifier()
    {
        return "EFFE";
    }

    public static function EffectResponseMetrics_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EffectResponseMetrics_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startEffectResponseMetrics_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return EffectResponseMetrics_Ingest
     */
    public static function createEffectResponseMetrics_Ingest(FlatBufferBuilder $builder, $metricType, $domainValue, $relativeValue, $provenance)
    {
        $builder->startObject(4);
     ...
     */
    public static function endEffectResponseMetrics_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEffectResponseMetrics_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
