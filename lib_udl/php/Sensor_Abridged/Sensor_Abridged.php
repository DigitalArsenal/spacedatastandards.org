...
class Sensor_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Sensor_Abridged
     */
    public static function getRootAsSensor_Abridged(ByteBuffer $bb)
    {
        $obj = new Sensor_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Sensor_AbridgedIdentifier()
    {
        return "SENS";
    }

    public static function Sensor_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Sensor_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(26);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Sensor_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSensor_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return Sensor_Abridged
     */
    public static function createSensor_Abridged(FlatBufferBuilder $builder, $idSensor, $sensorName, $classificationMarking, $sensorNumber, $shortName, $dataControl, $afId, $asrType, $source, $origin, $origNetwork, $dataMode, $createdAt, $createdBy, $active, $sensorcharacteristics, $sensorStats, $sensorlimitsCollection, $entity, $idEntity, $sensorObservationType, $sensorType)
    {
        $builder->startObject(22);
    ...
    {
        $builder->addOffsetX(15, $sensorcharacteristics, 0);
    }
    ...
    {
        $builder->addOffsetX(16, $sensorStats, 0);
    }
    ...
    {
        $builder->addOffsetX(17, $sensorlimitsCollection, 0);
    }
    ...
    {
        $builder->addOffsetX(19, $idEntity, 0);
    }
    ...
    {
        $builder->addOffsetX(20, $sensorObservationType, 0);
    }
    ...
    {
        $builder->addOffsetX(21, $sensorType, 0);
    }
     ...
     */
    public static function endSensor_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSensor_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
