...
class IonoObservationDensityProfileTopsideExtensionChapmanConst_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IonoObservationDensityProfileTopsideExtensionChapmanConst_Ingest
     */
    public static function getRootAsIonoObservationDensityProfileTopsideExtensionChapmanConst_Ingest(ByteBuffer $bb)
    {
        $obj = new IonoObservationDensityProfileTopsideExtensionChapmanConst_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IonoObservationDensityProfileTopsideExtensionChapmanConst_IngestIdentifier()
    {
        return "IONO";
    }

    public static function IonoObservationDensityProfileTopsideExtensionChapmanConst_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IonoObservationDensityProfileTopsideExtensionChapmanConst_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startIonoObservationDensityProfileTopsideExtensionChapmanConst_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return IonoObservationDensityProfileTopsideExtensionChapmanConst_Ingest
     */
    public static function createIonoObservationDensityProfileTopsideExtensionChapmanConst_Ingest(FlatBufferBuilder $builder, $description, $nmF2, $hmF2, $scaleF2, $chi)
    {
        $builder->startObject(5);
     ...
     */
    public static function endIonoObservationDensityProfileTopsideExtensionChapmanConst_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIonoObservationDensityProfileTopsideExtensionChapmanConst_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
