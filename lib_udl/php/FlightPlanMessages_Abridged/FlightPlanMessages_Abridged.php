...
class FlightPlanMessages_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return FlightPlanMessages_Abridged
     */
    public static function getRootAsFlightPlanMessages_Abridged(ByteBuffer $bb)
    {
        $obj = new FlightPlanMessages_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function FlightPlanMessages_AbridgedIdentifier()
    {
        return "FLIG";
    }

    public static function FlightPlanMessages_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::FlightPlanMessages_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startFlightPlanMessages_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return FlightPlanMessages_Abridged
     */
    public static function createFlightPlanMessages_Abridged(FlatBufferBuilder $builder, $severity, $wpNum, $routePath, $msgText)
    {
        $builder->startObject(4);
     ...
     */
    public static function endFlightPlanMessages_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishFlightPlanMessages_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
