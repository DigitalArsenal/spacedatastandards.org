...
class OperatingUnitRemark extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OperatingUnitRemark
     */
    public static function getRootAsOperatingUnitRemark(ByteBuffer $bb)
    {
        $obj = new OperatingUnitRemark();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OperatingUnitRemarkIdentifier()
    {
        return "OPER";
    }

    public static function OperatingUnitRemarkBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OperatingUnitRemarkIdentifier());
    }
    ...
    {
        $o = $this->__offset(32);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OperatingUnitRemark_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOperatingUnitRemark(FlatBufferBuilder $builder)
    {
     ...
     * @return OperatingUnitRemark
     */
    public static function createOperatingUnitRemark(FlatBufferBuilder $builder, $id, $classificationMarking, $idOperatingUnit, $altRmkId, $name, $type, $text, $code, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $dataMode)
    {
        $builder->startObject(15);
     ...
     */
    public static function endOperatingUnitRemark(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOperatingUnitRemarkBuffer(FlatBufferBuilder $builder, $offset)
    {
