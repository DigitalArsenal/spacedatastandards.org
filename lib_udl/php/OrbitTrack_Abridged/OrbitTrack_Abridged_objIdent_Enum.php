...
class OrbitTrack_Abridged_objIdent_Enum
{
    ...
    private static $names = array(
        OrbitTrack_Abridged_objIdent_Enum::ASSUMED_FRIEND=>"ASSUMED_FRIEND",
        OrbitTrack_Abridged_objIdent_Enum::FRIEND=>"FRIEND",
        OrbitTrack_Abridged_objIdent_Enum::HOSTILE=>"HOSTILE",
        OrbitTrack_Abridged_objIdent_Enum::NEUTRAL=>"NEUTRAL",
        OrbitTrack_Abridged_objIdent_Enum::PENDING=>"PENDING",
        OrbitTrack_Abridged_objIdent_Enum::SUSPECT=>"SUSPECT",
        OrbitTrack_Abridged_objIdent_Enum::UNKNOWN=>"UNKNOWN",
    );
