...
class ISRCollectionRequirements_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ISRCollectionRequirements_Abridged
     */
    public static function getRootAsISRCollectionRequirements_Abridged(ByteBuffer $bb)
    {
        $obj = new ISRCollectionRequirements_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function ISRCollectionRequirements_AbridgedIdentifier()
    {
        return "ISRC";
    }

    public static function ISRCollectionRequirements_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::ISRCollectionRequirements_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startISRCollectionRequirements_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endISRCollectionRequirements_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishISRCollectionRequirements_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
