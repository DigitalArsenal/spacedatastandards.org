...
class OrganizationDetails extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OrganizationDetails
     */
    public static function getRootAsOrganizationDetails(ByteBuffer $bb)
    {
        $obj = new OrganizationDetails();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OrganizationDetailsIdentifier()
    {
        return "ORGA";
    }

    public static function OrganizationDetailsBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OrganizationDetailsIdentifier());
    }
    ...
    {
        $o = $this->__offset(68);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OrganizationDetails_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOrganizationDetails(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endOrganizationDetails(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOrganizationDetailsBuffer(FlatBufferBuilder $builder, $offset)
    {
