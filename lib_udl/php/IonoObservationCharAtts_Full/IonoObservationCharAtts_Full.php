...
class IonoObservationCharAtts_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IonoObservationCharAtts_Full
     */
    public static function getRootAsIonoObservationCharAtts_Full(ByteBuffer $bb)
    {
        $obj = new IonoObservationCharAtts_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IonoObservationCharAtts_FullIdentifier()
    {
        return "IONO";
    }

    public static function IonoObservationCharAtts_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IonoObservationCharAtts_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startIonoObservationCharAtts_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return IonoObservationCharAtts_Full
     */
    public static function createIonoObservationCharAtts_Full(FlatBufferBuilder $builder, $ursiID, $charName, $lowerBound, $upperBound, $q, $d, $climateModelName, $climateModelOptions, $climateModelInputParams, $uncertaintyBoundType)
    {
        $builder->startObject(10);
     ...
     */
    public static function endIonoObservationCharAtts_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIonoObservationCharAtts_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
