...
class LaunchSiteDetails_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LaunchSiteDetails_Ingest
     */
    public static function getRootAsLaunchSiteDetails_Ingest(ByteBuffer $bb)
    {
        $obj = new LaunchSiteDetails_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LaunchSiteDetails_IngestIdentifier()
    {
        return "LAUN";
    }

    public static function LaunchSiteDetails_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LaunchSiteDetails_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(28);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \LaunchSiteDetails_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startLaunchSiteDetails_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return LaunchSiteDetails_Ingest
     */
    public static function createLaunchSiteDetails_Ingest(FlatBufferBuilder $builder, $id, $idLaunchSite, $classificationMarking, $idLocation, $launchGroup, $availableInclinations, $description, $createdAt, $createdBy, $source, $origin, $origNetwork, $dataMode, $location)
    {
        $builder->startObject(14);
     ...
     */
    public static function endLaunchSiteDetails_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLaunchSiteDetails_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
