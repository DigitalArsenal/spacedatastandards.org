...
class OnorbitDetails_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OnorbitDetails_Ingest
     */
    public static function getRootAsOnorbitDetails_Ingest(ByteBuffer $bb)
    {
        $obj = new OnorbitDetails_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OnorbitDetails_IngestIdentifier()
    {
        return "ONOR";
    }

    public static function OnorbitDetails_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OnorbitDetails_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(92);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OnorbitDetails_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOnorbitDetails_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endOnorbitDetails_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOnorbitDetails_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
