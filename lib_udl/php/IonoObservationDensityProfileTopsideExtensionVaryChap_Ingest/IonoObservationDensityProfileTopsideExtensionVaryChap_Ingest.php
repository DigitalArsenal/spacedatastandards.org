...
class IonoObservationDensityProfileTopsideExtensionVaryChap_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IonoObservationDensityProfileTopsideExtensionVaryChap_Ingest
     */
    public static function getRootAsIonoObservationDensityProfileTopsideExtensionVaryChap_Ingest(ByteBuffer $bb)
    {
        $obj = new IonoObservationDensityProfileTopsideExtensionVaryChap_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IonoObservationDensityProfileTopsideExtensionVaryChap_IngestIdentifier()
    {
        return "IONO";
    }

    public static function IonoObservationDensityProfileTopsideExtensionVaryChap_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IonoObservationDensityProfileTopsideExtensionVaryChap_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startIonoObservationDensityProfileTopsideExtensionVaryChap_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return IonoObservationDensityProfileTopsideExtensionVaryChap_Ingest
     */
    public static function createIonoObservationDensityProfileTopsideExtensionVaryChap_Ingest(FlatBufferBuilder $builder, $description, $nmF2, $hmF2, $scaleF2, $alpha, $beta, $ht, $chi)
    {
        $builder->startObject(8);
     ...
     */
    public static function endIonoObservationDensityProfileTopsideExtensionVaryChap_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIonoObservationDensityProfileTopsideExtensionVaryChap_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
