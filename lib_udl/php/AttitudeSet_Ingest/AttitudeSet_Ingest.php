...
class AttitudeSet_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AttitudeSet_Ingest
     */
    public static function getRootAsAttitudeSet_Ingest(ByteBuffer $bb)
    {
        $obj = new AttitudeSet_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AttitudeSet_IngestIdentifier()
    {
        return "ATTI";
    }

    public static function AttitudeSet_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AttitudeSet_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(58);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AttitudeSet_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAttitudeSet_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAttitudeSet_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAttitudeSet_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
