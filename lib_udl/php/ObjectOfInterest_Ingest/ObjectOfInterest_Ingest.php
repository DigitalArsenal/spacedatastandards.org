...
class ObjectOfInterest_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ObjectOfInterest_Ingest
     */
    public static function getRootAsObjectOfInterest_Ingest(ByteBuffer $bb)
    {
        $obj = new ObjectOfInterest_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function ObjectOfInterest_IngestIdentifier()
    {
        return "OBJE";
    }

    public static function ObjectOfInterest_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::ObjectOfInterest_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(90);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \ObjectOfInterest_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startObjectOfInterest_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endObjectOfInterest_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishObjectOfInterest_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
