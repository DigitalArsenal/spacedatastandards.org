...
class FlightPlanAirRefuelEvents_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return FlightPlanAirRefuelEvents_Ingest
     */
    public static function getRootAsFlightPlanAirRefuelEvents_Ingest(ByteBuffer $bb)
    {
        $obj = new FlightPlanAirRefuelEvents_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function FlightPlanAirRefuelEvents_IngestIdentifier()
    {
        return "FLIG";
    }

    public static function FlightPlanAirRefuelEvents_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::FlightPlanAirRefuelEvents_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startFlightPlanAirRefuelEvents_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return FlightPlanAirRefuelEvents_Ingest
     */
    public static function createFlightPlanAirRefuelEvents_Ingest(FlatBufferBuilder $builder, $arDegrade, $arNum, $arExchangedFuel, $divertFuel, $exitFuel)
    {
        $builder->startObject(5);
     ...
     */
    public static function endFlightPlanAirRefuelEvents_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishFlightPlanAirRefuelEvents_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
