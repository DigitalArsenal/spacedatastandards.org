...
class AirfieldSlot_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirfieldSlot_Abridged
     */
    public static function getRootAsAirfieldSlot_Abridged(ByteBuffer $bb)
    {
        $obj = new AirfieldSlot_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirfieldSlot_AbridgedIdentifier()
    {
        return "AIRF";
    }

    public static function AirfieldSlot_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirfieldSlot_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(18);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirfieldSlot_Abridged_type_Enum::WORKING;
    }
    ...
    {
        $o = $this->__offset(20);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirfieldSlot_Abridged_acSlotCat_Enum::WIDE;
    }
    ...
    {
        $o = $this->__offset(44);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirfieldSlot_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAirfieldSlot_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return AirfieldSlot_Abridged
     */
    public static function createAirfieldSlot_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $airfieldName, $icao, $idAirfield, $altAirfieldId, $name, $type, $acSlotCat, $capacity, $startTime, $endTime, $minSeparation, $notes, $createdAt, $createdBy, $sourceDL, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(21);
     ...
     */
    public static function endAirfieldSlot_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirfieldSlot_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
