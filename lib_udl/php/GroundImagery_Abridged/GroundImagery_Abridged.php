...
class GroundImagery_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GroundImagery_Abridged
     */
    public static function getRootAsGroundImagery_Abridged(ByteBuffer $bb)
    {
        $obj = new GroundImagery_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function GroundImagery_AbridgedIdentifier()
    {
        return "GROU";
    }

    public static function GroundImagery_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::GroundImagery_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(38);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \GroundImagery_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startGroundImagery_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return GroundImagery_Abridged
     */
    public static function createGroundImagery_Abridged(FlatBufferBuilder $builder, $id, $idSensor, $classificationMarking, $imageTime, $filename, $regionText, $regionGeoJSON, $regionType, $regionNDims, $regionSRid, $origSensorId, $subjectId, $name, $source, $origin, $origNetwork, $sourceDL, $dataMode, $createdAt, $createdBy, $transactionId, $notes, $format, $filesize, $checksumValue)
    {
        $builder->startObject(25);
    ...
    {
        $builder->addOffsetX(5, $regionText, 0);
    }
    ...
    {
        $builder->addOffsetX(6, $regionGeoJSON, 0);
    }
    ...
    {
        $builder->addOffsetX(7, $regionType, 0);
    }
    ...
    {
        $builder->addIntX(8, $regionNDims, 0);
    }
    ...
    {
        $builder->addIntX(9, $regionSRid, 0);
    }
    ...
    {
        $builder->addOffsetX(10, $origSensorId, 0);
    }
    ...
    {
        $builder->addOffsetX(11, $subjectId, 0);
    }
    ...
    {
        $builder->addOffsetX(16, $sourceDL, 0);
    }
    ...
    {
        $builder->addOffsetX(20, $transactionId, 0);
    }
    ...
    {
        $builder->addOffsetX(22, $format, 0);
    }
    ...
    {
        $builder->addLongX(23, $filesize, 0);
    }
    ...
    {
        $builder->addOffsetX(24, $checksumValue, 0);
    }
     ...
     */
    public static function endGroundImagery_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishGroundImagery_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
