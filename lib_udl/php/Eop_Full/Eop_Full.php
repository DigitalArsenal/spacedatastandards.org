...
class Eop_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Eop_Full
     */
    public static function getRootAsEop_Full(ByteBuffer $bb)
    {
        $obj = new Eop_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Eop_FullIdentifier()
    {
        return "EOPF";
    }

    public static function Eop_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Eop_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(10);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Eop_Full_polarMotionState_Enum::I;
    }
    ...
    {
        $o = $this->__offset(20);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Eop_Full_ut1UTCState_Enum::I;
    }
    ...
    {
        $o = $this->__offset(30);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Eop_Full_nutationState_Enum::I;
    }
    ...
    {
        $o = $this->__offset(70);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Eop_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEop_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endEop_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEop_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
