...
class AircraftMissionLocationTasking_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AircraftMissionLocationTasking_Ingest
     */
    public static function getRootAsAircraftMissionLocationTasking_Ingest(ByteBuffer $bb)
    {
        $obj = new AircraftMissionLocationTasking_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AircraftMissionLocationTasking_IngestIdentifier()
    {
        return "AIRC";
    }

    public static function AircraftMissionLocationTasking_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AircraftMissionLocationTasking_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startAircraftMissionLocationTasking_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return AircraftMissionLocationTasking_Ingest
     */
    public static function createAircraftMissionLocationTasking_Ingest(FlatBufferBuilder $builder, $startTime, $endTime, $msnLocName, $alt, $airMsnPri, $areaGeoRad, $msnLocPtName, $msnLocPtLat, $msnLocPtLon, $msnLocPtBarT)
    {
        $builder->startObject(10);
     ...
     */
    public static function endAircraftMissionLocationTasking_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAircraftMissionLocationTasking_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
