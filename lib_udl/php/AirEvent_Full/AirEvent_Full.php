...
class AirEvent_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirEvent_Full
     */
    public static function getRootAsAirEvent_Full(ByteBuffer $bb)
    {
        $obj = new AirEvent_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirEvent_FullIdentifier()
    {
        return "AIRE";
    }

    public static function AirEvent_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirEvent_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(90);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirEvent_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAirEvent_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAirEvent_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirEvent_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
