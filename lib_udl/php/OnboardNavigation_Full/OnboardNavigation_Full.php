...
class OnboardNavigation_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OnboardNavigation_Full
     */
    public static function getRootAsOnboardNavigation_Full(ByteBuffer $bb)
    {
        $obj = new OnboardNavigation_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OnboardNavigation_FullIdentifier()
    {
        return "ONBO";
    }

    public static function OnboardNavigation_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OnboardNavigation_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(30);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OnboardNavigation_Full_referenceFrame_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(50);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OnboardNavigation_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOnboardNavigation_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return OnboardNavigation_Full
     */
    public static function createOnboardNavigation_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $idOnOrbit, $satNo, $onOrbit, $origObjectId, $startTime, $endTime, $esId, $starCatName, $starCatLoadTime, $idStateVector, $ts, $referenceFrame, $sunSensor, $mag, $starTracker, $deltaPos, $createdAt, $createdBy, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(24);
    ...
    {
        $builder->addOffsetX(9, $starCatName, 0);
    }
    ...
    {
        $builder->addOffsetX(10, $starCatLoadTime, 0);
    }
    ...
    {
        $builder->addOffsetX(11, $idStateVector, 0);
    }
    ...
    {
        $builder->addSbyteX(13, $referenceFrame, 0);
    }
    ...
    {
        $builder->addOffsetX(14, $sunSensor, 0);
    }
    ...
    {
        $builder->addOffsetX(16, $starTracker, 0);
    }
    ...
    {
        $builder->addOffsetX(17, $deltaPos, 0);
    }
     ...
     */
    public static function endOnboardNavigation_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOnboardNavigation_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
