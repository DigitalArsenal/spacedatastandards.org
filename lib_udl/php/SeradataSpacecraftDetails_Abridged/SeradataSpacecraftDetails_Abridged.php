...
class SeradataSpacecraftDetails_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SeradataSpacecraftDetails_Abridged
     */
    public static function getRootAsSeradataSpacecraftDetails_Abridged(ByteBuffer $bb)
    {
        $obj = new SeradataSpacecraftDetails_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SeradataSpacecraftDetails_AbridgedIdentifier()
    {
        return "SERA";
    }

    public static function SeradataSpacecraftDetails_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SeradataSpacecraftDetails_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(188);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SeradataSpacecraftDetails_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSeradataSpacecraftDetails_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSeradataSpacecraftDetails_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSeradataSpacecraftDetails_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
