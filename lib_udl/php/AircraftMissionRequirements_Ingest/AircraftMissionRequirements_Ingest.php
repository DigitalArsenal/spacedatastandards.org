...
class AircraftMissionRequirements_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AircraftMissionRequirements_Ingest
     */
    public static function getRootAsAircraftMissionRequirements_Ingest(ByteBuffer $bb)
    {
        $obj = new AircraftMissionRequirements_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AircraftMissionRequirements_IngestIdentifier()
    {
        return "AIRC";
    }

    public static function AircraftMissionRequirements_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AircraftMissionRequirements_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startAircraftMissionRequirements_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return AircraftMissionRequirements_Ingest
     */
    public static function createAircraftMissionRequirements_Ingest(FlatBufferBuilder $builder, $gdssReqId, $onloadId, $onloadLOCode, $offloadId, $offloadLOCode, $uln, $transReqNum, $projName, $oplan, $numPax, $numLitter, $numAmbulatory, $numAttendant, $bulkWeight, $oversizeWeight, $outsizeWeight, $ead, $lad)
    {
        $builder->startObject(18);
     ...
     */
    public static function endAircraftMissionRequirements_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAircraftMissionRequirements_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
