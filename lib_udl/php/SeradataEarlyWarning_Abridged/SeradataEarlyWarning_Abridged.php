...
class SeradataEarlyWarning_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SeradataEarlyWarning_Abridged
     */
    public static function getRootAsSeradataEarlyWarning_Abridged(ByteBuffer $bb)
    {
        $obj = new SeradataEarlyWarning_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SeradataEarlyWarning_AbridgedIdentifier()
    {
        return "SERA";
    }

    public static function SeradataEarlyWarning_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SeradataEarlyWarning_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(46);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SeradataEarlyWarning_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSeradataEarlyWarning_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSeradataEarlyWarning_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSeradataEarlyWarning_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
