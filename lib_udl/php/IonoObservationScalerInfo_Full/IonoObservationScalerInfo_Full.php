...
class IonoObservationScalerInfo_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IonoObservationScalerInfo_Full
     */
    public static function getRootAsIonoObservationScalerInfo_Full(ByteBuffer $bb)
    {
        $obj = new IonoObservationScalerInfo_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IonoObservationScalerInfo_FullIdentifier()
    {
        return "IONO";
    }

    public static function IonoObservationScalerInfo_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IonoObservationScalerInfo_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startIonoObservationScalerInfo_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return IonoObservationScalerInfo_Full
     */
    public static function createIonoObservationScalerInfo_Full(FlatBufferBuilder $builder, $type, $name, $organization, $version, $confidenceScore, $confidenceLevel)
    {
        $builder->startObject(6);
     ...
     */
    public static function endIonoObservationScalerInfo_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIonoObservationScalerInfo_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
