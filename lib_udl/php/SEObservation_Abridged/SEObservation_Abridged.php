...
class SEObservation_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SEObservation_Abridged
     */
    public static function getRootAsSEObservation_Abridged(ByteBuffer $bb)
    {
        $obj = new SEObservation_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SEObservation_AbridgedIdentifier()
    {
        return "SEOB";
    }

    public static function SEObservation_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SEObservation_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startSEObservation_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return SEObservation_Abridged
     */
    public static function createSEObservation_Abridged(FlatBufferBuilder $builder, $obType, $obUoM, $obValue, $obString, $obArray, $obBool, $obQuality, $obDescription)
    {
        $builder->startObject(8);
     ...
     */
    public static function endSEObservation_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSEObservation_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
