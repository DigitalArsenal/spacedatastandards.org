...
class EquipmentRemark_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EquipmentRemark_Abridged
     */
    public static function getRootAsEquipmentRemark_Abridged(ByteBuffer $bb)
    {
        $obj = new EquipmentRemark_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EquipmentRemark_AbridgedIdentifier()
    {
        return "EQUI";
    }

    public static function EquipmentRemark_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EquipmentRemark_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(28);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EquipmentRemark_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEquipmentRemark_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return EquipmentRemark_Abridged
     */
    public static function createEquipmentRemark_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $idEquipment, $altRmkId, $name, $type, $text, $code, $createdAt, $createdBy, $source, $origin, $dataMode)
    {
        $builder->startObject(13);
     ...
     */
    public static function endEquipmentRemark_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEquipmentRemark_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
