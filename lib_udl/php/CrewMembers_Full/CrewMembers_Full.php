...
class CrewMembers_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return CrewMembers_Full
     */
    public static function getRootAsCrewMembers_Full(ByteBuffer $bb)
    {
        $obj = new CrewMembers_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function CrewMembers_FullIdentifier()
    {
        return "CREW";
    }

    public static function CrewMembers_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::CrewMembers_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startCrewMembers_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return CrewMembers_Full
     */
    public static function createCrewMembers_Full(FlatBufferBuilder $builder, $lastName, $firstName, $middleInitial, $memberId, $civilian, $commander, $last4SSN, $dodID, $dutyPosition, $crewPosition, $memberType, $branch, $rank, $wing, $squadron, $memberRemarks, $username)
    {
        $builder->startObject(17);
     ...
     */
    public static function endCrewMembers_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishCrewMembers_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
