...
class AirLoadPlan_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirLoadPlan_Abridged
     */
    public static function getRootAsAirLoadPlan_Abridged(ByteBuffer $bb)
    {
        $obj = new AirLoadPlan_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirLoadPlan_AbridgedIdentifier()
    {
        return "AIRL";
    }

    public static function AirLoadPlan_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirLoadPlan_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(100);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirLoadPlan_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAirLoadPlan_Abridged(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(45, $source, 0);
    }
    ...
    {
        $builder->addOffsetX(46, $origin, 0);
    }
    ...
    {
        $builder->addOffsetX(47, $origNetwork, 0);
    }
    ...
    {
        $builder->addSbyteX(48, $dataMode, 0);
    }
     ...
     */
    public static function endAirLoadPlan_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirLoadPlan_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
