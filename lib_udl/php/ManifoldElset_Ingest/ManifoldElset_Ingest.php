...
class ManifoldElset_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ManifoldElset_Ingest
     */
    public static function getRootAsManifoldElset_Ingest(ByteBuffer $bb)
    {
        $obj = new ManifoldElset_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function ManifoldElset_IngestIdentifier()
    {
        return "MANI";
    }

    public static function ManifoldElset_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::ManifoldElset_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(54);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \ManifoldElset_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startManifoldElset_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endManifoldElset_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishManifoldElset_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
