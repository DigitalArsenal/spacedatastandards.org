...
class Organization_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Organization_Abridged
     */
    public static function getRootAsOrganization_Abridged(ByteBuffer $bb)
    {
        $obj = new Organization_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Organization_AbridgedIdentifier()
    {
        return "ORGA";
    }

    public static function Organization_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Organization_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(28);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Organization_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOrganization_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return Organization_Abridged
     */
    public static function createOrganization_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $name, $type, $category, $externalId, $description, $countryCode, $nationality, $active, $source, $origin, $dataMode, $createdAt, $createdBy, $origNetwork)
    {
        $builder->startObject(16);
     ...
     */
    public static function endOrganization_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOrganization_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
