...
class EvacCasualtyInfo_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacCasualtyInfo_Full
     */
    public static function getRootAsEvacCasualtyInfo_Full(ByteBuffer $bb)
    {
        $obj = new EvacCasualtyInfo_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacCasualtyInfo_FullIdentifier()
    {
        return "EVAC";
    }

    public static function EvacCasualtyInfo_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacCasualtyInfo_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacCasualtyInfo_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endEvacCasualtyInfo_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacCasualtyInfo_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
