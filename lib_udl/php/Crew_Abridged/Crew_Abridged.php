...
/// /// Crew Services.
class Crew_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Crew_Abridged
     */
    public static function getRootAsCrew_Abridged(ByteBuffer $bb)
    {
        $obj = new Crew_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Crew_AbridgedIdentifier()
    {
        return "CREW";
    }

    public static function Crew_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Crew_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(48);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Crew_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startCrew_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endCrew_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishCrew_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
