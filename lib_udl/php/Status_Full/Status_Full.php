...
class Status_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Status_Full
     */
    public static function getRootAsStatus_Full(ByteBuffer $bb)
    {
        $obj = new Status_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Status_FullIdentifier()
    {
        return "STAT";
    }

    public static function Status_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Status_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(16);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Status_Full_state_Enum::UNKNOWN;
    }
    ...
    {
        $o = $this->__offset(18);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Status_Full_sysCap_Enum::FMC;
    }
    ...
    {
        $o = $this->__offset(20);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Status_Full_opsCap_Enum::FMC;
    }
    ...
    {
        $o = $this->__offset(26);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Status_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startStatus_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return Status_Full
     */
    public static function createStatus_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $derivedFrom, $declassificationDate, $declassificationString, $idEntity, $state, $sysCap, $opsCap, $source, $subStatusCollection, $dataMode, $notes, $createdAt, $createdBy, $updatedAt, $updatedBy, $origin, $origNetwork)
    {
        $builder->startObject(19);
     ...
     */
    public static function endStatus_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishStatus_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
