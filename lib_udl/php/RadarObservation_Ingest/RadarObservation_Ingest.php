...
class RadarObservation_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return RadarObservation_Ingest
     */
    public static function getRootAsRadarObservation_Ingest(ByteBuffer $bb)
    {
        $obj = new RadarObservation_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function RadarObservation_IngestIdentifier()
    {
        return "RADA";
    }

    public static function RadarObservation_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RadarObservation_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(106);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RadarObservation_Ingest_dataMode_Enum::REAL;
    }
    ...
    {
        $o = $this->__offset(114);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RadarObservation_Ingest_senReferenceFrame_Enum::J2000;
    }
     ...
     * @return void
     */
    public static function startRadarObservation_Ingest(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addSbyteX(55, $senReferenceFrame, 0);
    }
    ...
    {
        $builder->addOffsetX(56, $descriptor, 0);
    }
    ...
    {
        $builder->addOffsetX(57, $origNetwork, 0);
    }
    ...
    {
        $builder->addOffsetX(58, $sourceDL, 0);
    }
     ...
     */
    public static function endRadarObservation_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRadarObservation_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
