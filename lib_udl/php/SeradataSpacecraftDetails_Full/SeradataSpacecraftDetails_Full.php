...
class SeradataSpacecraftDetails_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SeradataSpacecraftDetails_Full
     */
    public static function getRootAsSeradataSpacecraftDetails_Full(ByteBuffer $bb)
    {
        $obj = new SeradataSpacecraftDetails_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SeradataSpacecraftDetails_FullIdentifier()
    {
        return "SERA";
    }

    public static function SeradataSpacecraftDetails_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SeradataSpacecraftDetails_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(188);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SeradataSpacecraftDetails_Full_dataMode_Enum::REAL;
    }
     ...
     * @return string
     */
    public function getSeradataSigIntPayload($j)
    {
        $o = $this->__offset(198);
     ...
     * @return int
     */
    public function getSeradataSigIntPayloadLength()
    {
        $o = $this->__offset(198);
     ...
     * @return string
     */
    public function getSeradataRadarPayload($j)
    {
        $o = $this->__offset(200);
        return $o != 0 ? $this->__string($this->__vector($o) + $j * 4) : 0;
    }
     ...
     * @return int
     */
    public function getSeradataRadarPayloadLength()
    {
        $o = $this->__offset(200);
        return $o != 0 ? $this->__vector_len($o) : 0;
    }
     ...
     * @return string
     */
    public function getSeradataNavigation($j)
    {
        $o = $this->__offset(202);
        return $o != 0 ? $this->__string($this->__vector($o) + $j * 4) : 0;
    }
     ...
     * @return int
     */
    public function getSeradataNavigationLength()
    {
        $o = $this->__offset(202);
        return $o != 0 ? $this->__vector_len($o) : 0;
    }
     ...
     * @return string
     */
    public function getSeradataOpticalPayload($j)
    {
        $o = $this->__offset(204);
        return $o != 0 ? $this->__string($this->__vector($o) + $j * 4) : 0;
    }
     ...
     * @return int
     */
    public function getSeradataOpticalPayloadLength()
    {
        $o = $this->__offset(204);
        return $o != 0 ? $this->__vector_len($o) : 0;
    }
     ...
     * @return string
     */
    public function getSeradataEarlyWarning($j)
    {
        $o = $this->__offset(206);
        return $o != 0 ? $this->__string($this->__vector($o) + $j * 4) : 0;
    }
     ...
     * @return int
     */
    public function getSeradataEarlyWarningLength()
    {
        $o = $this->__offset(206);
        return $o != 0 ? $this->__vector_len($o) : 0;
    }
     ...
     * @return string
     */
    public function getScientific($j)
    {
        $o = $this->__offset(208);
        return $o != 0 ? $this->__string($this->__vector($o) + $j * 4) : 0;
    }
     ...
     * @return int
     */
    public function getScientificLength()
    {
        $o = $this->__offset(208);
        return $o != 0 ? $this->__vector_len($o) : 0;
    }
     ...
     * @return string
     */
    public function getSeradataCommDetails($j)
    {
        $o = $this->__offset(210);
        return $o != 0 ? $this->__string($this->__vector($o) + $j * 4) : 0;
    }
     ...
     * @return int
     */
    public function getSeradataCommDetailsLength()
    {
        $o = $this->__offset(210);
        return $o != 0 ? $this->__vector_len($o) : 0;
    }
     ...
     * @return void
     */
    public static function startSeradataSpacecraftDetails_Full(FlatBufferBuilder $builder)
    {
    ...
    public static function createSeradataSpacecraftDetails_Full(FlatBufferBuilder $builder, $id, $idOnOrbit, $classificationMarking, $name, $description, $intlNumber, $sector, $apogee, $perigee, $period, $inclination, $primeManufacturerOrgId, $stabilizer, $designLife, $expectedLife, $insuredAtLaunch, $launchMass, $dryMass, $catalogNumber, $totalPayloadPower, $constellation, $orbitCategory, $orbitSubCategory, $launchCost, $launchCostEstimated, $costEstimated, $newCost, $combinedNewCost, $combinedCostEstimated, $insuredValueAtLaunch, $insuredValueLaunchEstimated, $annualInsuredDepreciationFactor, $annualInsuredDepreciationFactorEstimated, $insurancePremiumAtLaunch, $insurancePremiumAtLaunchEstimated, $numHumans, $cubesatDispenserType, $massCategory, $launchId, $launchVehicleId, $launchProviderFlightNumber, $launchSiteName, $launchSiteId, $launchCountry, $launchProvider, $launchProviderCountry, $commercialLaunch, $launchType, $launchCharacteristic, $launchNumber, $launchDate, $launchDateRemarks, $youtubeLaunchLink, $status, $owner, $ownerCountry, $operator, $operatorCountry, $leased, $orderDate, $capabilityLost, $capacityLost, $primaryMissionGroup, $additionalMissionsGroups, $totalClaims, $totalInjuries, $totalFatalities, $nameAtLaunch, $busId, $currentAge, $lifeLost, $geoPosition, $insuranceLossesTotal, $launchArranger, $launchArrangerCountry, $serialNumber, $programName, $reusedHullName, $dateOfObservation, $lat, $lon, $altitude, $collisionRiskMM, $collisionRiskCM, $quantity, $reusableFlights, $notes, $insuranceNotes, $launchNotes, $source, $origin, $origNetwork, $dataMode, $createdAt, $createdBy, $updatedAt, $updatedBy, $seradataSigIntPayload, $seradataRadarPayload, $seradataNavigation, $seradataOpticalPayload, $seradataEarlyWarning, $scientific, $seradataCommDetails, $onOrbit)
    {
        ...
        self::addSeradataSigIntPayload($builder, $seradataSigIntPayload);
        self::addSeradataRadarPayload($builder, $seradataRadarPayload);
        self::addSeradataNavigation($builder, $seradataNavigation);
        self::addSeradataOpticalPayload($builder, $seradataOpticalPayload);
        self::addSeradataEarlyWarning($builder, $seradataEarlyWarning);
        self::addScientific($builder, $scientific);
        self::addSeradataCommDetails($builder, $seradataCommDetails);
    ...
    {
        $builder->addOffsetX(95, $updatedAt, 0);
    }
    ...
    {
        $builder->addOffsetX(96, $updatedBy, 0);
    }
     ...
     * @return void
     */
    public static function addSeradataSigIntPayload(FlatBufferBuilder $builder, $seradataSigIntPayload)
    {
        $builder->addOffsetX(97, $seradataSigIntPayload, 0);
    }
     ...
     */
    public static function createSeradataSigIntPayloadVector(FlatBufferBuilder $builder, array $data)
    {
     ...
     * @return void
     */
    public static function startSeradataSigIntPayloadVector(FlatBufferBuilder $builder, $numElems)
    {
     ...
     * @return void
     */
    public static function addSeradataRadarPayload(FlatBufferBuilder $builder, $seradataRadarPayload)
    {
        $builder->addOffsetX(98, $seradataRadarPayload, 0);
    }
     ...
     * @return int vector offset
     */
    public static function createSeradataRadarPayloadVector(FlatBufferBuilder $builder, array $data)
    {
        $builder->startVector(4, count($data), 4);
        for ($i = count($data) - 1; $i >= 0; $i--) {
            $builder->putOffset($data[$i]);
     ...
     * @return void
     */
    public static function startSeradataRadarPayloadVector(FlatBufferBuilder $builder, $numElems)
    {
        $builder->startVector(4, $numElems, 4);
    }
     ...
     * @return void
     */
    public static function addSeradataNavigation(FlatBufferBuilder $builder, $seradataNavigation)
    {
        $builder->addOffsetX(99, $seradataNavigation, 0);
    }
     ...
     * @return int vector offset
     */
    public static function createSeradataNavigationVector(FlatBufferBuilder $builder, array $data)
    {
        $builder->startVector(4, count($data), 4);
        for ($i = count($data) - 1; $i >= 0; $i--) {
            $builder->putOffset($data[$i]);
     ...
     * @return void
     */
    public static function startSeradataNavigationVector(FlatBufferBuilder $builder, $numElems)
    {
        $builder->startVector(4, $numElems, 4);
    }
     ...
     * @return void
     */
    public static function addSeradataOpticalPayload(FlatBufferBuilder $builder, $seradataOpticalPayload)
    {
        $builder->addOffsetX(100, $seradataOpticalPayload, 0);
    }
     ...
     * @return int vector offset
     */
    public static function createSeradataOpticalPayloadVector(FlatBufferBuilder $builder, array $data)
    {
        $builder->startVector(4, count($data), 4);
        for ($i = count($data) - 1; $i >= 0; $i--) {
            $builder->putOffset($data[$i]);
     ...
     * @return void
     */
    public static function startSeradataOpticalPayloadVector(FlatBufferBuilder $builder, $numElems)
    {
        $builder->startVector(4, $numElems, 4);
    }
     ...
     * @return void
     */
    public static function addSeradataEarlyWarning(FlatBufferBuilder $builder, $seradataEarlyWarning)
    {
        $builder->addOffsetX(101, $seradataEarlyWarning, 0);
    }
     ...
     * @return int vector offset
     */
    public static function createSeradataEarlyWarningVector(FlatBufferBuilder $builder, array $data)
    {
        $builder->startVector(4, count($data), 4);
        for ($i = count($data) - 1; $i >= 0; $i--) {
            $builder->putOffset($data[$i]);
     ...
     * @return void
     */
    public static function startSeradataEarlyWarningVector(FlatBufferBuilder $builder, $numElems)
    {
        $builder->startVector(4, $numElems, 4);
    }
     ...
     * @return void
     */
    public static function addScientific(FlatBufferBuilder $builder, $scientific)
    {
        $builder->addOffsetX(102, $scientific, 0);
    }
     ...
     * @return int vector offset
     */
    public static function createScientificVector(FlatBufferBuilder $builder, array $data)
    {
        $builder->startVector(4, count($data), 4);
        for ($i = count($data) - 1; $i >= 0; $i--) {
            $builder->putOffset($data[$i]);
     ...
     * @return void
     */
    public static function startScientificVector(FlatBufferBuilder $builder, $numElems)
    {
        $builder->startVector(4, $numElems, 4);
    }
     ...
     * @return void
     */
    public static function addSeradataCommDetails(FlatBufferBuilder $builder, $seradataCommDetails)
    {
        $builder->addOffsetX(103, $seradataCommDetails, 0);
    }
     ...
     * @return int vector offset
     */
    public static function createSeradataCommDetailsVector(FlatBufferBuilder $builder, array $data)
    {
        $builder->startVector(4, count($data), 4);
        for ($i = count($data) - 1; $i >= 0; $i--) {
            $builder->putOffset($data[$i]);
     ...
     * @return void
     */
    public static function startSeradataCommDetailsVector(FlatBufferBuilder $builder, $numElems)
    {
        $builder->startVector(4, $numElems, 4);
    }
    ...
    {
        $builder->addOffsetX(104, $onOrbit, 0);
    }
     ...
     */
    public static function endSeradataSpacecraftDetails_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSeradataSpacecraftDetails_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
