...
class Ephemeris_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Ephemeris_Abridged
     */
    public static function getRootAsEphemeris_Abridged(ByteBuffer $bb)
    {
        $obj = new Ephemeris_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Ephemeris_AbridgedIdentifier()
    {
        return "EPHE";
    }

    public static function Ephemeris_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Ephemeris_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(38);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Ephemeris_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEphemeris_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return Ephemeris_Abridged
     */
    public static function createEphemeris_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $esId, $ts, $xpos, $ypos, $zpos, $xvel, $yvel, $zvel, $xaccel, $yaccel, $zaccel, $cov, $createdAt, $createdBy, $source, $dataMode, $idOnOrbit, $origObjectId, $origin)
    {
        $builder->startObject(21);
     ...
     */
    public static function endEphemeris_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEphemeris_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
