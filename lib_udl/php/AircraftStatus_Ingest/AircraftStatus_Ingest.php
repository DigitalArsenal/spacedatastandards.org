...
class AircraftStatus_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AircraftStatus_Ingest
     */
    public static function getRootAsAircraftStatus_Ingest(ByteBuffer $bb)
    {
        $obj = new AircraftStatus_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AircraftStatus_IngestIdentifier()
    {
        return "AIRC";
    }

    public static function AircraftStatus_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AircraftStatus_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(44);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AircraftStatus_Ingest_airToAirStatus_Enum::OPERATIONAL;
    }
    ...
    {
        $o = $this->__offset(46);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AircraftStatus_Ingest_airToGroundStatus_Enum::OPERATIONAL;
    }
    ...
    {
        $o = $this->__offset(104);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AircraftStatus_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAircraftStatus_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAircraftStatus_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAircraftStatus_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
