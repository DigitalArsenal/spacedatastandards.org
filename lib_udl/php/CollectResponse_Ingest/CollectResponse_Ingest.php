...
class CollectResponse_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return CollectResponse_Ingest
     */
    public static function getRootAsCollectResponse_Ingest(ByteBuffer $bb)
    {
        $obj = new CollectResponse_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function CollectResponse_IngestIdentifier()
    {
        return "COLL";
    }

    public static function CollectResponse_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::CollectResponse_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(54);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \CollectResponse_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startCollectResponse_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endCollectResponse_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishCollectResponse_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
