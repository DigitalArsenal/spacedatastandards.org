...
class DataLinkOps_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DataLinkOps_Ingest
     */
    public static function getRootAsDataLinkOps_Ingest(ByteBuffer $bb)
    {
        $obj = new DataLinkOps_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DataLinkOps_IngestIdentifier()
    {
        return "DATA";
    }

    public static function DataLinkOps_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DataLinkOps_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startDataLinkOps_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return DataLinkOps_Ingest
     */
    public static function createDataLinkOps_Ingest(FlatBufferBuilder $builder, $linkName, $linkStartTime, $linkStopTime, $linkStopTimeMod, $linkDetails)
    {
        $builder->startObject(5);
     ...
     */
    public static function endDataLinkOps_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDataLinkOps_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
