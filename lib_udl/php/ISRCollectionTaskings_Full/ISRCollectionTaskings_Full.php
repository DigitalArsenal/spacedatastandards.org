...
class ISRCollectionTaskings_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ISRCollectionTaskings_Full
     */
    public static function getRootAsISRCollectionTaskings_Full(ByteBuffer $bb)
    {
        $obj = new ISRCollectionTaskings_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function ISRCollectionTaskings_FullIdentifier()
    {
        return "ISRC";
    }

    public static function ISRCollectionTaskings_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::ISRCollectionTaskings_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(6);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \ISRCollectionTaskings_Full_type_Enum::DELIBERATE;
    }
    ...
    {
        $o = $this->__offset(8);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \ISRCollectionTaskings_Full_collectionType_Enum::SIMULTANEOUS;
    }
     ...
     * @return void
     */
    public static function startISRCollectionTaskings_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endISRCollectionTaskings_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishISRCollectionTaskings_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
