...
class WeatherData_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return WeatherData_Abridged
     */
    public static function getRootAsWeatherData_Abridged(ByteBuffer $bb)
    {
        $obj = new WeatherData_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function WeatherData_AbridgedIdentifier()
    {
        return "WEAT";
    }

    public static function WeatherData_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::WeatherData_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(80);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \WeatherData_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startWeatherData_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endWeatherData_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishWeatherData_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
