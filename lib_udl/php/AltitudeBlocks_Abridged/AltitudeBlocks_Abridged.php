...
class AltitudeBlocks_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AltitudeBlocks_Abridged
     */
    public static function getRootAsAltitudeBlocks_Abridged(ByteBuffer $bb)
    {
        $obj = new AltitudeBlocks_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AltitudeBlocks_AbridgedIdentifier()
    {
        return "ALTI";
    }

    public static function AltitudeBlocks_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AltitudeBlocks_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startAltitudeBlocks_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return AltitudeBlocks_Abridged
     */
    public static function createAltitudeBlocks_Abridged(FlatBufferBuilder $builder, $altitudeSequenceId, $lowerAltitude, $upperAltitude)
    {
        $builder->startObject(3);
     ...
     */
    public static function endAltitudeBlocks_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAltitudeBlocks_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
