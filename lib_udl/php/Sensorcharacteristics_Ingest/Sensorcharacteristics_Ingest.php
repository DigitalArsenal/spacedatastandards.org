...
class Sensorcharacteristics_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Sensorcharacteristics_Ingest
     */
    public static function getRootAsSensorcharacteristics_Ingest(ByteBuffer $bb)
    {
        $obj = new Sensorcharacteristics_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Sensorcharacteristics_IngestIdentifier()
    {
        return "SENS";
    }

    public static function Sensorcharacteristics_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Sensorcharacteristics_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(106);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Sensorcharacteristics_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSensorcharacteristics_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSensorcharacteristics_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSensorcharacteristics_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
