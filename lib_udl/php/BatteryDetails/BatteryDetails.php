...
class BatteryDetails extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return BatteryDetails
     */
    public static function getRootAsBatteryDetails(ByteBuffer $bb)
    {
        $obj = new BatteryDetails();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function BatteryDetailsIdentifier()
    {
        return "BATT";
    }

    public static function BatteryDetailsBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::BatteryDetailsIdentifier());
    }
    ...
    {
        $o = $this->__offset(36);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \BatteryDetails_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startBatteryDetails(FlatBufferBuilder $builder)
    {
     ...
     * @return BatteryDetails
     */
    public static function createBatteryDetails(FlatBufferBuilder $builder, $id, $idBattery, $classificationMarking, $technology, $capacity, $dischargeDepth, $model, $description, $manufacturerOrgId, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $origNetwork, $dataMode, $tags, $manufacturerOrg)
    {
        $builder->startObject(19);
     ...
     */
    public static function endBatteryDetails(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishBatteryDetailsBuffer(FlatBufferBuilder $builder, $offset)
    {
