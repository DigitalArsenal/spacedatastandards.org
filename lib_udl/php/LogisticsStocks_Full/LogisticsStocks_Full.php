...
class LogisticsStocks_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LogisticsStocks_Full
     */
    public static function getRootAsLogisticsStocks_Full(ByteBuffer $bb)
    {
        $obj = new LogisticsStocks_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LogisticsStocks_FullIdentifier()
    {
        return "LOGI";
    }

    public static function LogisticsStocks_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LogisticsStocks_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startLogisticsStocks_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return LogisticsStocks_Full
     */
    public static function createLogisticsStocks_Full(FlatBufferBuilder $builder, $sourceICAO, $quantity, $stockCheckTime, $stockPOC)
    {
        $builder->startObject(4);
     ...
     */
    public static function endLogisticsStocks_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLogisticsStocks_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
