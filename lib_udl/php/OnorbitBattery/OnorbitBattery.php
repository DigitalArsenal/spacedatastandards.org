...
class OnorbitBattery extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OnorbitBattery
     */
    public static function getRootAsOnorbitBattery(ByteBuffer $bb)
    {
        $obj = new OnorbitBattery();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OnorbitBatteryIdentifier()
    {
        return "ONOR";
    }

    public static function OnorbitBatteryBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OnorbitBatteryIdentifier());
    }
    ...
    {
        $o = $this->__offset(26);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OnorbitBattery_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOnorbitBattery(FlatBufferBuilder $builder)
    {
     ...
     * @return OnorbitBattery
     */
    public static function createOnorbitBattery(FlatBufferBuilder $builder, $id, $idOnOrbit, $idBattery, $classificationMarking, $quantity, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $dataMode, $origNetwork, $battery)
    {
        $builder->startObject(14);
     ...
     */
    public static function endOnorbitBattery(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOnorbitBatteryBuffer(FlatBufferBuilder $builder, $offset)
    {
