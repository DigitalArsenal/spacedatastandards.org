...
class TAIUTC_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return TAIUTC_Ingest
     */
    public static function getRootAsTAIUTC_Ingest(ByteBuffer $bb)
    {
        $obj = new TAIUTC_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function TAIUTC_IngestIdentifier()
    {
        return "TAIU";
    }

    public static function TAIUTC_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::TAIUTC_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(22);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \TAIUTC_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startTAIUTC_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return TAIUTC_Ingest
     */
    public static function createTAIUTC_Ingest(FlatBufferBuilder $builder, $id, $classificationMarking, $adjustmentDate, $taiUTC, $multiplicationFactor, $rawFileURI, $source, $origin, $origNetwork, $dataMode, $createdAt, $createdBy)
    {
        $builder->startObject(12);
     ...
     */
    public static function endTAIUTC_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishTAIUTC_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
