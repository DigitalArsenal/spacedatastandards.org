...
class MissileTrack_Ingest_objIdent_Enum
{
    ...
    private static $names = array(
        MissileTrack_Ingest_objIdent_Enum::ASSUMED_FRIEND=>"ASSUMED_FRIEND",
        MissileTrack_Ingest_objIdent_Enum::FRIEND=>"FRIEND",
        MissileTrack_Ingest_objIdent_Enum::HOSTILE=>"HOSTILE",
        MissileTrack_Ingest_objIdent_Enum::NEUTRAL=>"NEUTRAL",
        MissileTrack_Ingest_objIdent_Enum::PENDING=>"PENDING",
        MissileTrack_Ingest_objIdent_Enum::SUSPECT=>"SUSPECT",
        MissileTrack_Ingest_objIdent_Enum::UNKNOWN=>"UNKNOWN",
    );
