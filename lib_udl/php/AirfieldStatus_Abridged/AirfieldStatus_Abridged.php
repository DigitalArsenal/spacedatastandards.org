...
class AirfieldStatus_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirfieldStatus_Abridged
     */
    public static function getRootAsAirfieldStatus_Abridged(ByteBuffer $bb)
    {
        $obj = new AirfieldStatus_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirfieldStatus_AbridgedIdentifier()
    {
        return "AIRF";
    }

    public static function AirfieldStatus_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirfieldStatus_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(74);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirfieldStatus_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAirfieldStatus_Abridged(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(33, $origin, 0);
    }
     ...
     */
    public static function endAirfieldStatus_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirfieldStatus_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
