...
class OperatingUnitRemark_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OperatingUnitRemark_Full
     */
    public static function getRootAsOperatingUnitRemark_Full(ByteBuffer $bb)
    {
        $obj = new OperatingUnitRemark_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OperatingUnitRemark_FullIdentifier()
    {
        return "OPER";
    }

    public static function OperatingUnitRemark_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OperatingUnitRemark_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(32);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OperatingUnitRemark_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOperatingUnitRemark_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return OperatingUnitRemark_Full
     */
    public static function createOperatingUnitRemark_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $idOperatingUnit, $altRmkId, $name, $type, $text, $code, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $dataMode)
    {
        $builder->startObject(15);
    ...
    {
        $builder->addOffsetX(2, $idOperatingUnit, 0);
    }
     ...
     */
    public static function endOperatingUnitRemark_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOperatingUnitRemark_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
