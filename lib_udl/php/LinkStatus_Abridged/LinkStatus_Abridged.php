...
class LinkStatus_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LinkStatus_Abridged
     */
    public static function getRootAsLinkStatus_Abridged(ByteBuffer $bb)
    {
        $obj = new LinkStatus_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LinkStatus_AbridgedIdentifier()
    {
        return "LINK";
    }

    public static function LinkStatus_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LinkStatus_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(60);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \LinkStatus_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startLinkStatus_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endLinkStatus_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLinkStatus_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
