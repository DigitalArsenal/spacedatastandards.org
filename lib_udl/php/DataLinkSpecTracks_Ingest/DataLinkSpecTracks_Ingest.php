...
class DataLinkSpecTracks_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DataLinkSpecTracks_Ingest
     */
    public static function getRootAsDataLinkSpecTracks_Ingest(ByteBuffer $bb)
    {
        $obj = new DataLinkSpecTracks_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DataLinkSpecTracks_IngestIdentifier()
    {
        return "DATA";
    }

    public static function DataLinkSpecTracks_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DataLinkSpecTracks_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startDataLinkSpecTracks_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return DataLinkSpecTracks_Ingest
     */
    public static function createDataLinkSpecTracks_Ingest(FlatBufferBuilder $builder, $specTrackNum, $specTrackNumDesc)
    {
        $builder->startObject(2);
     ...
     */
    public static function endDataLinkSpecTracks_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDataLinkSpecTracks_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
