...
class ObjectOfInterest_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ObjectOfInterest_Abridged
     */
    public static function getRootAsObjectOfInterest_Abridged(ByteBuffer $bb)
    {
        $obj = new ObjectOfInterest_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function ObjectOfInterest_AbridgedIdentifier()
    {
        return "OBJE";
    }

    public static function ObjectOfInterest_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::ObjectOfInterest_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(88);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \ObjectOfInterest_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startObjectOfInterest_Abridged(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(40, $origin, 0);
    }
    ...
    {
        $builder->addSbyteX(42, $dataMode, 0);
    }
     ...
     */
    public static function endObjectOfInterest_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishObjectOfInterest_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
