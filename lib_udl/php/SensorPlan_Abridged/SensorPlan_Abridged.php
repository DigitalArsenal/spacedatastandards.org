...
class SensorPlan_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SensorPlan_Abridged
     */
    public static function getRootAsSensorPlan_Abridged(ByteBuffer $bb)
    {
        $obj = new SensorPlan_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SensorPlan_AbridgedIdentifier()
    {
        return "SENS";
    }

    public static function SensorPlan_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SensorPlan_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(40);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SensorPlan_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSensorPlan_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return SensorPlan_Abridged
     */
    public static function createSensorPlan_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $type, $recType, $startTime, $endTime, $name, $idSensor, $origSensorId, $purpose, $senNetwork, $reqTotal, $customer, $status, $createdAt, $createdBy, $source, $origin, $dataMode, $origNetwork)
    {
        $builder->startObject(20);
     ...
     */
    public static function endSensorPlan_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSensorPlan_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
