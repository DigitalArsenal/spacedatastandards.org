...
class MtiMission_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MtiMission_Full
     */
    public static function getRootAsMtiMission_Full(ByteBuffer $bb)
    {
        $obj = new MtiMission_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MtiMission_FullIdentifier()
    {
        return "MTIM";
    }

    public static function MtiMission_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MtiMission_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startMtiMission_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return MtiMission_Full
     */
    public static function createMtiMission_Full(FlatBufferBuilder $builder, $m1, $m2, $m3, $m4, $msnRefTs)
    {
        $builder->startObject(5);
     ...
     */
    public static function endMtiMission_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMtiMission_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
