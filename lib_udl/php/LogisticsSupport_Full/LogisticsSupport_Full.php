...
class LogisticsSupport_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LogisticsSupport_Full
     */
    public static function getRootAsLogisticsSupport_Full(ByteBuffer $bb)
    {
        $obj = new LogisticsSupport_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LogisticsSupport_FullIdentifier()
    {
        return "LOGI";
    }

    public static function LogisticsSupport_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LogisticsSupport_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(62);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \LogisticsSupport_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startLogisticsSupport_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endLogisticsSupport_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLogisticsSupport_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
