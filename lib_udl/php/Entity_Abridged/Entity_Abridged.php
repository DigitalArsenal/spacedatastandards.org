...
class Entity_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Entity_Abridged
     */
    public static function getRootAsEntity_Abridged(ByteBuffer $bb)
    {
        $obj = new Entity_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Entity_AbridgedIdentifier()
    {
        return "ENTI";
    }

    public static function Entity_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Entity_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(10);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Entity_Abridged_type_Enum::AIRCRAFT;
    }
    ...
    {
        $o = $this->__offset(16);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Entity_Abridged_ownerType_Enum::COMMERCIAL;
    }
    ...
    {
        $o = $this->__offset(28);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Entity_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEntity_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return Entity_Abridged
     */
    public static function createEntity_Abridged(FlatBufferBuilder $builder, $idEntity, $name, $classificationMarking, $type, $idLocation, $countryCode, $ownerType, $taskable, $createdAt, $createdBy, $source, $origin, $dataMode, $location, $onOrbit, $idOnOrbit, $idOperatingUnit, $origNetwork)
    {
        $builder->startObject(18);
    ...
    {
        $builder->addOffsetX(14, $onOrbit, 0);
    }
    ...
    {
        $builder->addOffsetX(15, $idOnOrbit, 0);
    }
    ...
    {
        $builder->addOffsetX(16, $idOperatingUnit, 0);
    }
     ...
     */
    public static function endEntity_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEntity_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
