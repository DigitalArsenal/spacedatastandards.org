...
class Scientific_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Scientific_Full
     */
    public static function getRootAsScientific_Full(ByteBuffer $bb)
    {
        $obj = new Scientific_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Scientific_FullIdentifier()
    {
        return "SCIE";
    }

    public static function Scientific_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Scientific_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(36);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Scientific_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startScientific_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return Scientific_Full
     */
    public static function createScientific_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $spacecraftId, $hostedForCompanyOrgId, $manufacturerOrgId, $payloadCategory, $name, $frequencyBand, $notes, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $origNetwork, $dataMode, $idEntity, $entity)
    {
        $builder->startObject(19);
    ...
    {
        $builder->addOffsetX(17, $idEntity, 0);
    }
    ...
    {
        $builder->addOffsetX(18, $entity, 0);
    }
     ...
     */
    public static function endScientific_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishScientific_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
