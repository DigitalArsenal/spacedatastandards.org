...
class PersonnelRecoveryObjectiveAreaInfo_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return PersonnelRecoveryObjectiveAreaInfo_Ingest
     */
    public static function getRootAsPersonnelRecoveryObjectiveAreaInfo_Ingest(ByteBuffer $bb)
    {
        $obj = new PersonnelRecoveryObjectiveAreaInfo_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function PersonnelRecoveryObjectiveAreaInfo_IngestIdentifier()
    {
        return "PERS";
    }

    public static function PersonnelRecoveryObjectiveAreaInfo_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::PersonnelRecoveryObjectiveAreaInfo_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startPersonnelRecoveryObjectiveAreaInfo_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return PersonnelRecoveryObjectiveAreaInfo_Ingest
     */
    public static function createPersonnelRecoveryObjectiveAreaInfo_Ingest(FlatBufferBuilder $builder, $pzLocation, $pzDesc, $oscCallSign, $oscFreq, $enemyData)
    {
        $builder->startObject(5);
     ...
     */
    public static function endPersonnelRecoveryObjectiveAreaInfo_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPersonnelRecoveryObjectiveAreaInfo_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
