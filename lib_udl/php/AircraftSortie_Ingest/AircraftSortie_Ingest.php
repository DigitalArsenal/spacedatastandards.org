...
class AircraftSortie_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AircraftSortie_Ingest
     */
    public static function getRootAsAircraftSortie_Ingest(ByteBuffer $bb)
    {
        $obj = new AircraftSortie_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AircraftSortie_IngestIdentifier()
    {
        return "AIRC";
    }

    public static function AircraftSortie_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AircraftSortie_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(122);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AircraftSortie_Ingest_paperStatus_Enum::PUBLISHED;
    }
    ...
    {
        $o = $this->__offset(124);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AircraftSortie_Ingest_pprStatus_Enum::NOT_REQUIRED;
    }
    ...
    {
        $o = $this->__offset(136);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AircraftSortie_Ingest_rvnReq_Enum::N;
    }
    ...
    {
        $o = $this->__offset(160);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AircraftSortie_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAircraftSortie_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAircraftSortie_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAircraftSortie_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
