...
class RFEmitterDetails_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return RFEmitterDetails_Ingest
     */
    public static function getRootAsRFEmitterDetails_Ingest(ByteBuffer $bb)
    {
        $obj = new RFEmitterDetails_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function RFEmitterDetails_IngestIdentifier()
    {
        return "RFEM";
    }

    public static function RFEmitterDetails_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RFEmitterDetails_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(68);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFEmitterDetails_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startRFEmitterDetails_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endRFEmitterDetails_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRFEmitterDetails_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
