...
class SOIObservationSet_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SOIObservationSet_Full
     */
    public static function getRootAsSOIObservationSet_Full(ByteBuffer $bb)
    {
        $obj = new SOIObservationSet_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SOIObservationSet_FullIdentifier()
    {
        return "SOIO";
    }

    public static function SOIObservationSet_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SOIObservationSet_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(48);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SOIObservationSet_Full_type_Enum::OPTICAL;
    }
    ...
    {
        $o = $this->__offset(54);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SOIObservationSet_Full_referenceFrame_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(56);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SOIObservationSet_Full_senReferenceFrame_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(148);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SOIObservationSet_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSOIObservationSet_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSOIObservationSet_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSOIObservationSet_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
