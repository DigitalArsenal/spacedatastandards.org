...
class RoutePoints_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return RoutePoints_Abridged
     */
    public static function getRootAsRoutePoints_Abridged(ByteBuffer $bb)
    {
        $obj = new RoutePoints_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function RoutePoints_AbridgedIdentifier()
    {
        return "ROUT";
    }

    public static function RoutePoints_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RoutePoints_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startRoutePoints_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return RoutePoints_Abridged
     */
    public static function createRoutePoints_Abridged(FlatBufferBuilder $builder, $ptSequenceId, $ptTypeCode, $ptTypeName, $waypointName, $dafifPt, $ptLat, $ptLon, $magDec, $navaidLength, $navaid, $countryCode, $altCountryCode, $navaidType)
    {
        $builder->startObject(13);
     ...
     */
    public static function endRoutePoints_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRoutePoints_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
