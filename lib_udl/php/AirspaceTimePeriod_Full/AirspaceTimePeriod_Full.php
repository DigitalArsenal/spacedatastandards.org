...
class AirspaceTimePeriod_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirspaceTimePeriod_Full
     */
    public static function getRootAsAirspaceTimePeriod_Full(ByteBuffer $bb)
    {
        $obj = new AirspaceTimePeriod_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirspaceTimePeriod_FullIdentifier()
    {
        return "AIRS";
    }

    public static function AirspaceTimePeriod_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirspaceTimePeriod_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startAirspaceTimePeriod_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return AirspaceTimePeriod_Full
     */
    public static function createAirspaceTimePeriod_Full(FlatBufferBuilder $builder, $timeMode, $timeStart, $timeEnd, $intFreq, $intDur)
    {
        $builder->startObject(5);
     ...
     */
    public static function endAirspaceTimePeriod_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirspaceTimePeriod_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
