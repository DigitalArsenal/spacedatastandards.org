...
class SeradataSigIntPayload_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SeradataSigIntPayload_Full
     */
    public static function getRootAsSeradataSigIntPayload_Full(ByteBuffer $bb)
    {
        $obj = new SeradataSigIntPayload_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SeradataSigIntPayload_FullIdentifier()
    {
        return "SERA";
    }

    public static function SeradataSigIntPayload_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SeradataSigIntPayload_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(48);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SeradataSigIntPayload_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSeradataSigIntPayload_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSeradataSigIntPayload_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSeradataSigIntPayload_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
