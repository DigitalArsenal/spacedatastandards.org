...
class LaunchVehicleDetails_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LaunchVehicleDetails_Abridged
     */
    public static function getRootAsLaunchVehicleDetails_Abridged(ByteBuffer $bb)
    {
        $obj = new LaunchVehicleDetails_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LaunchVehicleDetails_AbridgedIdentifier()
    {
        return "LAUN";
    }

    public static function LaunchVehicleDetails_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LaunchVehicleDetails_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(110);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \LaunchVehicleDetails_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startLaunchVehicleDetails_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endLaunchVehicleDetails_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLaunchVehicleDetails_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
