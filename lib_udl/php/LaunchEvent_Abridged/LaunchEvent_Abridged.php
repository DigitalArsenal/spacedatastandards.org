...
class LaunchEvent_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LaunchEvent_Abridged
     */
    public static function getRootAsLaunchEvent_Abridged(ByteBuffer $bb)
    {
        $obj = new LaunchEvent_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LaunchEvent_AbridgedIdentifier()
    {
        return "LAUN";
    }

    public static function LaunchEvent_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LaunchEvent_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(38);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \LaunchEvent_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startLaunchEvent_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return LaunchEvent_Abridged
     */
    public static function createLaunchEvent_Abridged(FlatBufferBuilder $builder, $id, $idOnOrbit, $origObjectId, $classificationMarking, $derivedFrom, $declassificationDate, $declassificationString, $msgCreateDate, $launchFailureCode, $launchDate, $beNumber, $oSuffix, $launchFacilityName, $createdAt, $createdBy, $origin, $source, $dataMode, $origNetwork, $satNo)
    {
        $builder->startObject(20);
     ...
     */
    public static function endLaunchEvent_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLaunchEvent_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
