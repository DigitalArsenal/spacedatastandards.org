...
class DataLinkRefPoints_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DataLinkRefPoints_Abridged
     */
    public static function getRootAsDataLinkRefPoints_Abridged(ByteBuffer $bb)
    {
        $obj = new DataLinkRefPoints_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DataLinkRefPoints_AbridgedIdentifier()
    {
        return "DATA";
    }

    public static function DataLinkRefPoints_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DataLinkRefPoints_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startDataLinkRefPoints_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return DataLinkRefPoints_Abridged
     */
    public static function createDataLinkRefPoints_Abridged(FlatBufferBuilder $builder, $refPointType, $refDes, $refLocName, $refLat, $refLon, $effEventTime)
    {
        $builder->startObject(6);
     ...
     */
    public static function endDataLinkRefPoints_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDataLinkRefPoints_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
