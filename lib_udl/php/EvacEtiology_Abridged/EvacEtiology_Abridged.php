...
class EvacEtiology_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacEtiology_Abridged
     */
    public static function getRootAsEvacEtiology_Abridged(ByteBuffer $bb)
    {
        $obj = new EvacEtiology_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacEtiology_AbridgedIdentifier()
    {
        return "EVAC";
    }

    public static function EvacEtiology_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacEtiology_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacEtiology_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return EvacEtiology_Abridged
     */
    public static function createEvacEtiology_Abridged(FlatBufferBuilder $builder, $type, $bodyPart, $time, $comments)
    {
        $builder->startObject(4);
     ...
     */
    public static function endEvacEtiology_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacEtiology_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
