...
class EquipmentRemark_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EquipmentRemark_Full
     */
    public static function getRootAsEquipmentRemark_Full(ByteBuffer $bb)
    {
        $obj = new EquipmentRemark_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EquipmentRemark_FullIdentifier()
    {
        return "EQUI";
    }

    public static function EquipmentRemark_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EquipmentRemark_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(32);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EquipmentRemark_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEquipmentRemark_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return EquipmentRemark_Full
     */
    public static function createEquipmentRemark_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $idEquipment, $altRmkId, $name, $type, $text, $code, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $dataMode)
    {
        $builder->startObject(15);
     ...
     */
    public static function endEquipmentRemark_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEquipmentRemark_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
