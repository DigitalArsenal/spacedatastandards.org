...
class AircraftMissionLocationTasking_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AircraftMissionLocationTasking_Full
     */
    public static function getRootAsAircraftMissionLocationTasking_Full(ByteBuffer $bb)
    {
        $obj = new AircraftMissionLocationTasking_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AircraftMissionLocationTasking_FullIdentifier()
    {
        return "AIRC";
    }

    public static function AircraftMissionLocationTasking_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AircraftMissionLocationTasking_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startAircraftMissionLocationTasking_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return AircraftMissionLocationTasking_Full
     */
    public static function createAircraftMissionLocationTasking_Full(FlatBufferBuilder $builder, $startTime, $endTime, $msnLocName, $alt, $airMsnPri, $areaGeoRad, $msnLocPtName, $msnLocPtLat, $msnLocPtLon, $msnLocPtBarT)
    {
        $builder->startObject(10);
     ...
     */
    public static function endAircraftMissionLocationTasking_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAircraftMissionLocationTasking_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
