...
class EvacVitalSignData_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacVitalSignData_Ingest
     */
    public static function getRootAsEvacVitalSignData_Ingest(ByteBuffer $bb)
    {
        $obj = new EvacVitalSignData_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacVitalSignData_IngestIdentifier()
    {
        return "EVAC";
    }

    public static function EvacVitalSignData_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacVitalSignData_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacVitalSignData_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return EvacVitalSignData_Ingest
     */
    public static function createEvacVitalSignData_Ingest(FlatBufferBuilder $builder, $vitalSign, $vitalSign1, $vitalSign2, $medConfFactor, $time)
    {
        $builder->startObject(5);
     ...
     */
    public static function endEvacVitalSignData_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacVitalSignData_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
