...
class GEOStatus_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GEOStatus_Abridged
     */
    public static function getRootAsGEOStatus_Abridged(ByteBuffer $bb)
    {
        $obj = new GEOStatus_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function GEOStatus_AbridgedIdentifier()
    {
        return "GEOS";
    }

    public static function GEOStatus_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::GEOStatus_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(46);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \GEOStatus_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startGEOStatus_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endGEOStatus_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishGEOStatus_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
