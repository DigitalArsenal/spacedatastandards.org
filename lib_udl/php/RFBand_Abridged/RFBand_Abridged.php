...
class RFBand_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return RFBand_Abridged
     */
    public static function getRootAsRFBand_Abridged(ByteBuffer $bb)
    {
        $obj = new RFBand_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function RFBand_AbridgedIdentifier()
    {
        return "RFBA";
    }

    public static function RFBand_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RFBand_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(14);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFBand_Abridged_mode_Enum::TX;
    }
    ...
    {
        $o = $this->__offset(16);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFBand_Abridged_purpose_Enum::COMM;
    }
    ...
    {
        $o = $this->__offset(32);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFBand_Abridged_polarization_Enum::H;
    }
    ...
    {
        $o = $this->__offset(42);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFBand_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startRFBand_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return RFBand_Abridged
     */
    public static function createRFBand_Abridged(FlatBufferBuilder $builder, $id, $idEntity, $classificationMarking, $name, $band, $mode, $purpose, $freqMin, $freqMax, $centerFreq, $peakGain, $edgeGain, $bandwidth, $beamwidth, $polarization, $erp, $eirp, $source, $origin, $dataMode, $createdAt, $createdBy, $origNetwork)
    {
        $builder->startObject(23);
     ...
     */
    public static function endRFBand_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRFBand_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
