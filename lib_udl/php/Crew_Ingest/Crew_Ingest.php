...
/// /// Crew Services.
class Crew_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Crew_Ingest
     */
    public static function getRootAsCrew_Ingest(ByteBuffer $bb)
    {
        $obj = new Crew_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Crew_IngestIdentifier()
    {
        return "CREW";
    }

    public static function Crew_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Crew_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(48);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Crew_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startCrew_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endCrew_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishCrew_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
