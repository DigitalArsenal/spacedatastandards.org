...
class IndividualAircraftTasking_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IndividualAircraftTasking_Ingest
     */
    public static function getRootAsIndividualAircraftTasking_Ingest(ByteBuffer $bb)
    {
        $obj = new IndividualAircraftTasking_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IndividualAircraftTasking_IngestIdentifier()
    {
        return "INDI";
    }

    public static function IndividualAircraftTasking_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IndividualAircraftTasking_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startIndividualAircraftTasking_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return IndividualAircraftTasking_Ingest
     */
    public static function createIndividualAircraftTasking_Ingest(FlatBufferBuilder $builder, $numAcft, $acftType, $callSign, $priConfigCode, $secConfigCode, $link16CallSign, $tacanChan, $juAddress, $iffSifMode1Code, $iffSifMode2Code, $iffSifMode3Code)
    {
        $builder->startObject(11);
     ...
     */
    public static function endIndividualAircraftTasking_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIndividualAircraftTasking_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
