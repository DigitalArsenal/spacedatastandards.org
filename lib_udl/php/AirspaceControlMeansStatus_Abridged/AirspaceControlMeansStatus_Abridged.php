...
class AirspaceControlMeansStatus_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirspaceControlMeansStatus_Abridged
     */
    public static function getRootAsAirspaceControlMeansStatus_Abridged(ByteBuffer $bb)
    {
        $obj = new AirspaceControlMeansStatus_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirspaceControlMeansStatus_AbridgedIdentifier()
    {
        return "AIRS";
    }

    public static function AirspaceControlMeansStatus_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirspaceControlMeansStatus_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startAirspaceControlMeansStatus_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return AirspaceControlMeansStatus_Abridged
     */
    public static function createAirspaceControlMeansStatus_Abridged(FlatBufferBuilder $builder, $cmStat, $cmStatId, $airspaceControlMeans)
    {
        $builder->startObject(3);
     ...
     */
    public static function endAirspaceControlMeansStatus_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirspaceControlMeansStatus_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
