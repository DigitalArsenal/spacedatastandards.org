...
class Track_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Track_Abridged
     */
    public static function getRootAsTrack_Abridged(ByteBuffer $bb)
    {
        $obj = new Track_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Track_AbridgedIdentifier()
    {
        return "TRAC";
    }

    public static function Track_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Track_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(136);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Track_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startTrack_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endTrack_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishTrack_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
