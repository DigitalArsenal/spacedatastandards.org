...
class LogisticsParts_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LogisticsParts_Ingest
     */
    public static function getRootAsLogisticsParts_Ingest(ByteBuffer $bb)
    {
        $obj = new LogisticsParts_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LogisticsParts_IngestIdentifier()
    {
        return "LOGI";
    }

    public static function LogisticsParts_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LogisticsParts_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startLogisticsParts_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return LogisticsParts_Ingest
     */
    public static function createLogisticsParts_Ingest(FlatBufferBuilder $builder, $partNumber, $nationalStockNumber, $measurementUnitCode, $workUnitCode, $technicalOrderText, $figureNumber, $indexNumber, $requestVerifier, $locationVerifier, $supplyDocumentNumber, $logisticsStocks)
    {
        $builder->startObject(11);
     ...
     */
    public static function endLogisticsParts_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLogisticsParts_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
