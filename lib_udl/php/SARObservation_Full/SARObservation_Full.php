...
class SARObservation_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SARObservation_Full
     */
    public static function getRootAsSARObservation_Full(ByteBuffer $bb)
    {
        $obj = new SARObservation_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SARObservation_FullIdentifier()
    {
        return "SARO";
    }

    public static function SARObservation_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SARObservation_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(142);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SARObservation_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSARObservation_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return SARObservation_Full
     */
    public static function createSARObservation_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $idOnOrbit, $satNo, $origObjectId, $idSensor, $origSensorId, $externalId, $collectionId, $detectionId, $collectionStart, $collectionEnd, $centerTime, $detectionStart, $detectionEnd, $dwellTime, $orbitState, $sarMode, $operatingBand, $operatingFreq, $snr, $txPolarization, $rxPolarization, $grazeAngle, $incidenceAngle, $squintAngle, $pulseBandwidth, $pulseDuration, $continuousSpotAngle, $slantRange, $nearRange, $farRange, $swathLength, $area, $atext, $agjson, $atype, $andims, $asrid, $spacingRange, $spacingAzimuth, $looksAzimuth, $looksRange, $resolutionRange, $resolutionAzimuth, $obDirection, $coordSys, $targetposx, $targetposy, $targetposz, $senalt, $senvelx, $senvely, $senvelz, $senlatStart, $senlonStart, $senlatEnd, $senlonEnd, $transactionId, $tags, $srcTyps, $srcIds, $onOrbit, $createdAt, $createdBy, $source, $origin, $origNetwork, $sourceDL, $dataMode)
    {
        $builder->startObject(70);
    ...
    {
        $builder->addOffsetX(35, $agjson, 0);
    }
    ...
    {
        $builder->addDoubleX(39, $spacingRange, 0.0);
    }
    ...
    {
        $builder->addDoubleX(40, $spacingAzimuth, 0.0);
    }
    ...
    {
        $builder->addIntX(41, $looksAzimuth, 0);
    }
    ...
    {
        $builder->addIntX(42, $looksRange, 0);
    }
    ...
    {
        $builder->addDoubleX(43, $resolutionRange, 0.0);
    }
    ...
    {
        $builder->addDoubleX(44, $resolutionAzimuth, 0.0);
    }
    ...
    {
        $builder->addOffsetX(45, $obDirection, 0);
    }
    ...
    {
        $builder->addOffsetX(46, $coordSys, 0);
    }
    ...
    {
        $builder->addDoubleX(47, $targetposx, 0.0);
    }
    ...
    {
        $builder->addDoubleX(48, $targetposy, 0.0);
    }
    ...
    {
        $builder->addDoubleX(49, $targetposz, 0.0);
    }
    ...
    {
        $builder->addDoubleX(50, $senalt, 0.0);
    }
    ...
    {
        $builder->addDoubleX(51, $senvelx, 0.0);
    }
    ...
    {
        $builder->addDoubleX(52, $senvely, 0.0);
    }
    ...
    {
        $builder->addDoubleX(53, $senvelz, 0.0);
    }
    ...
    {
        $builder->addDoubleX(54, $senlatStart, 0.0);
    }
    ...
    {
        $builder->addDoubleX(55, $senlonStart, 0.0);
    }
    ...
    {
        $builder->addDoubleX(56, $senlatEnd, 0.0);
    }
    ...
    {
        $builder->addDoubleX(57, $senlonEnd, 0.0);
    }
    ...
    {
        $builder->addOffsetX(58, $transactionId, 0);
    }
    ...
    {
        $builder->addOffsetX(60, $srcTyps, 0);
    }
    ...
    {
        $builder->addOffsetX(61, $srcIds, 0);
    }
    ...
    {
        $builder->addOffsetX(62, $onOrbit, 0);
    }
    ...
    {
        $builder->addOffsetX(63, $createdAt, 0);
    }
    ...
    {
        $builder->addOffsetX(64, $createdBy, 0);
    }
    ...
    {
        $builder->addOffsetX(68, $sourceDL, 0);
    }
     ...
     */
    public static function endSARObservation_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSARObservation_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
