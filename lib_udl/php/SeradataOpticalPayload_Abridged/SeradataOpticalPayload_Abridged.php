...
class SeradataOpticalPayload_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SeradataOpticalPayload_Abridged
     */
    public static function getRootAsSeradataOpticalPayload_Abridged(ByteBuffer $bb)
    {
        $obj = new SeradataOpticalPayload_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SeradataOpticalPayload_AbridgedIdentifier()
    {
        return "SERA";
    }

    public static function SeradataOpticalPayload_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SeradataOpticalPayload_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(54);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SeradataOpticalPayload_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSeradataOpticalPayload_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSeradataOpticalPayload_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSeradataOpticalPayload_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
