...
class LogisticsSpecialties_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LogisticsSpecialties_Full
     */
    public static function getRootAsLogisticsSpecialties_Full(ByteBuffer $bb)
    {
        $obj = new LogisticsSpecialties_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LogisticsSpecialties_FullIdentifier()
    {
        return "LOGI";
    }

    public static function LogisticsSpecialties_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LogisticsSpecialties_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startLogisticsSpecialties_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return LogisticsSpecialties_Full
     */
    public static function createLogisticsSpecialties_Full(FlatBufferBuilder $builder, $specialty, $skillLevel, $firstName, $lastName, $rankCode, $last4Ssn, $roleTypeCode)
    {
        $builder->startObject(7);
     ...
     */
    public static function endLogisticsSpecialties_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLogisticsSpecialties_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
