...
class POI_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return POI_Full
     */
    public static function getRootAsPOI_Full(ByteBuffer $bb)
    {
        $obj = new POI_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function POI_FullIdentifier()
    {
        return "POIF";
    }

    public static function POI_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::POI_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(86);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \POI_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startPOI_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endPOI_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPOI_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
