...
class CrewMembers_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return CrewMembers_Abridged
     */
    public static function getRootAsCrewMembers_Abridged(ByteBuffer $bb)
    {
        $obj = new CrewMembers_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function CrewMembers_AbridgedIdentifier()
    {
        return "CREW";
    }

    public static function CrewMembers_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::CrewMembers_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startCrewMembers_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return CrewMembers_Abridged
     */
    public static function createCrewMembers_Abridged(FlatBufferBuilder $builder, $lastName, $firstName, $middleInitial, $memberId, $civilian, $commander, $last4SSN, $dodID, $dutyPosition, $crewPosition, $memberType, $branch, $rank, $wing, $squadron, $memberRemarks, $username)
    {
        $builder->startObject(17);
     ...
     */
    public static function endCrewMembers_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishCrewMembers_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
