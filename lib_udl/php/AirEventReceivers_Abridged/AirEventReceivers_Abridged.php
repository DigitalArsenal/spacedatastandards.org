...
class AirEventReceivers_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirEventReceivers_Abridged
     */
    public static function getRootAsAirEventReceivers_Abridged(ByteBuffer $bb)
    {
        $obj = new AirEventReceivers_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirEventReceivers_AbridgedIdentifier()
    {
        return "AIRE";
    }

    public static function AirEventReceivers_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirEventReceivers_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startAirEventReceivers_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAirEventReceivers_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirEventReceivers_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
