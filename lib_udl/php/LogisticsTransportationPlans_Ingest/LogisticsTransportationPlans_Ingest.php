...
class LogisticsTransportationPlans_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LogisticsTransportationPlans_Ingest
     */
    public static function getRootAsLogisticsTransportationPlans_Ingest(ByteBuffer $bb)
    {
        $obj = new LogisticsTransportationPlans_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LogisticsTransportationPlans_IngestIdentifier()
    {
        return "LOGI";
    }

    public static function LogisticsTransportationPlans_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LogisticsTransportationPlans_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startLogisticsTransportationPlans_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endLogisticsTransportationPlans_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLogisticsTransportationPlans_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
