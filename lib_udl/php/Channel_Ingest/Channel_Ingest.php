...
class Channel_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Channel_Ingest
     */
    public static function getRootAsChannel_Ingest(ByteBuffer $bb)
    {
        $obj = new Channel_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Channel_IngestIdentifier()
    {
        return "CHAN";
    }

    public static function Channel_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Channel_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(42);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Channel_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startChannel_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return Channel_Ingest
     */
    public static function createChannel_Ingest(FlatBufferBuilder $builder, $id, $idTransponder, $name, $classificationMarking, $type, $idBeam, $beamName, $idRFBand, $encryption, $pkg, $res, $compression, $vpid, $apid, $sid, $owner, $source, $origin, $origNetwork, $dataMode, $createdAt, $createdBy)
    {
        $builder->startObject(22);
     ...
     */
    public static function endChannel_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishChannel_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
