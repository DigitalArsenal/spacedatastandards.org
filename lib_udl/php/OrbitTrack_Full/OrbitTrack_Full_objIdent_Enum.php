...
class OrbitTrack_Full_objIdent_Enum
{
    ...
    private static $names = array(
        OrbitTrack_Full_objIdent_Enum::ASSUMED_FRIEND=>"ASSUMED_FRIEND",
        OrbitTrack_Full_objIdent_Enum::FRIEND=>"FRIEND",
        OrbitTrack_Full_objIdent_Enum::HOSTILE=>"HOSTILE",
        OrbitTrack_Full_objIdent_Enum::NEUTRAL=>"NEUTRAL",
        OrbitTrack_Full_objIdent_Enum::PENDING=>"PENDING",
        OrbitTrack_Full_objIdent_Enum::SUSPECT=>"SUSPECT",
        OrbitTrack_Full_objIdent_Enum::UNKNOWN=>"UNKNOWN",
    );
