...
class OrbitTrack_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OrbitTrack_Full
     */
    public static function getRootAsOrbitTrack_Full(ByteBuffer $bb)
    {
        $obj = new OrbitTrack_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OrbitTrack_FullIdentifier()
    {
        return "ORBI";
    }

    public static function OrbitTrack_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OrbitTrack_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(32);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OrbitTrack_Full_objIdent_Enum::ASSUMED_FRIEND;
    }
    ...
    {
        $o = $this->__offset(38);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OrbitTrack_Full_objectType_Enum::DEBRIS;
    }
    ...
    {
        $o = $this->__offset(92);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OrbitTrack_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOrbitTrack_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return OrbitTrack_Full
     */
    public static function createOrbitTrack_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $idOnOrbit, $satNo, $onOrbit, $origObjectId, $idElset, $ts, $lat, $lon, $alt, $rdfRF, $callSign, $rptNum, $objIdent, $identAmp, $satStatus, $objectType, $countryCode, $decay, $charlieLine, $aouType, $aouData, $spd, $angElev, $cntnmnt, $xref, $chXRef, $amplification, $iff, $reinforced, $reduced, $hq, $dummy, $taskForce, $feint, $installation, $vehType, $trkId, $trackSensors, $createdAt, $createdBy, $source, $origin, $dataMode, $origNetwork)
    {
        $builder->startObject(46);
    ...
    {
        $builder->addOffsetX(4, $onOrbit, 0);
    }
    ...
    {
        $builder->addOffsetX(6, $idElset, 0);
    }
    ...
    {
        $builder->addDoubleX(11, $rdfRF, 0.0);
    }
    ...
    {
        $builder->addOffsetX(13, $rptNum, 0);
    }
    ...
    {
        $builder->addSbyteX(14, $objIdent, 0);
    }
    ...
    {
        $builder->addOffsetX(15, $identAmp, 0);
    }
    ...
    {
        $builder->addOffsetX(16, $satStatus, 0);
    }
    ...
    {
        $builder->addSbyteX(17, $objectType, 0);
    }
    ...
    {
        $builder->addOffsetX(20, $charlieLine, 0);
    }
    ...
    {
        $builder->addOffsetX(21, $aouType, 0);
    }
    ...
    {
        $builder->addOffsetX(22, $aouData, 0);
    }
    ...
    {
        $builder->addDoubleX(24, $angElev, 0.0);
    }
    ...
    {
        $builder->addDoubleX(25, $cntnmnt, 0.0);
    }
    ...
    {
        $builder->addOffsetX(27, $chXRef, 0);
    }
    ...
    {
        $builder->addOffsetX(28, $amplification, 0);
    }
    ...
    {
        $builder->addBoolX(30, $reinforced, false);
    }
    ...
    {
        $builder->addBoolX(31, $reduced, false);
    }
    ...
    {
        $builder->addBoolX(33, $dummy, false);
    }
    ...
    {
        $builder->addBoolX(34, $taskForce, false);
    }
    ...
    {
        $builder->addBoolX(35, $feint, false);
    }
    ...
    {
        $builder->addBoolX(36, $installation, false);
    }
    ...
    {
        $builder->addOffsetX(37, $vehType, 0);
    }
    ...
    {
        $builder->addOffsetX(39, $trackSensors, 0);
    }
    ...
    {
        $builder->addOffsetX(45, $origNetwork, 0);
    }
     ...
     */
    public static function endOrbitTrack_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOrbitTrack_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
