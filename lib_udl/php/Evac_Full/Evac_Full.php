...
class Evac_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Evac_Full
     */
    public static function getRootAsEvac_Full(ByteBuffer $bb)
    {
        $obj = new Evac_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Evac_FullIdentifier()
    {
        return "EVAC";
    }

    public static function Evac_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Evac_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(10);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Evac_Full_type_Enum::REQUEST;
    }
    ...
    {
        $o = $this->__offset(84);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Evac_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEvac_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return Evac_Full
     */
    public static function createEvac_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $medevacId, $type, $missionType, $idWeatherReport, $numKIA, $numWIA, $numLitter, $numAmbulatory, $medicReq, $reqNum, $reqTime, $reqCallSign, $pickupTime, $pickupLat, $pickupLon, $pickupAlt, $ce, $le, $terrain, $obstaclesRemarks, $terrainRemarks, $zoneName, $zoneMarking, $zoneSecurity, $zoneMarkingColor, $zoneHot, $cntctFreq, $zoneContrCallSign, $numCasualties, $comments, $casualtyInfo, $enemyData, $relatedDocs, $origNetwork, $createdAt, $createdBy, $source, $origin, $dataMode)
    {
        $builder->startObject(41);
    ...
    {
        $builder->addOffsetX(34, $relatedDocs, 0);
    }
     ...
     */
    public static function endEvac_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvac_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
