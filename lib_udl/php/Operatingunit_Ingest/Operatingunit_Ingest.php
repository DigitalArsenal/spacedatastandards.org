...
class Operatingunit_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Operatingunit_Ingest
     */
    public static function getRootAsOperatingunit_Ingest(ByteBuffer $bb)
    {
        $obj = new Operatingunit_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Operatingunit_IngestIdentifier()
    {
        return "OPER";
    }

    public static function Operatingunit_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Operatingunit_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(122);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Operatingunit_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOperatingunit_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endOperatingunit_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOperatingunit_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
