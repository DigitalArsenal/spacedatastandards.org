...
class AirspaceControlOrder_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirspaceControlOrder_Full
     */
    public static function getRootAsAirspaceControlOrder_Full(ByteBuffer $bb)
    {
        $obj = new AirspaceControlOrder_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirspaceControlOrder_FullIdentifier()
    {
        return "AIRS";
    }

    public static function AirspaceControlOrder_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirspaceControlOrder_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(68);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirspaceControlOrder_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAirspaceControlOrder_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAirspaceControlOrder_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirspaceControlOrder_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
