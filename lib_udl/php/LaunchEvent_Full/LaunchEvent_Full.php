...
class LaunchEvent_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LaunchEvent_Full
     */
    public static function getRootAsLaunchEvent_Full(ByteBuffer $bb)
    {
        $obj = new LaunchEvent_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LaunchEvent_FullIdentifier()
    {
        return "LAUN";
    }

    public static function LaunchEvent_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LaunchEvent_FullIdentifier());
    }
    ...
    public function getLaunchFailureCode()
    {
        $o = $this->__offset(20);
        return $o != 0 ? $this->__string($o + $this->bb_pos) : null;
    }
    ...
    /// Constraints: Minimum length = 0, Maximum length = 100
    public function getLaunchFacilityName()
    {
        $o = $this->__offset(28);
        return $o != 0 ? $this->__string($o + $this->bb_pos) : null;
    }
    ...
    {
        $o = $this->__offset(38);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \LaunchEvent_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startLaunchEvent_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return LaunchEvent_Full
     */
    public static function createLaunchEvent_Full(FlatBufferBuilder $builder, $id, $idOnOrbit, $origObjectId, $classificationMarking, $derivedFrom, $declassificationDate, $declassificationString, $msgCreateDate, $launchFailureCode, $launchDate, $beNumber, $oSuffix, $launchFacilityName, $createdAt, $createdBy, $origin, $source, $dataMode, $origNetwork, $onOrbit, $satNo)
    {
        $builder->startObject(21);
        ...
        self::addLaunchFailureCode($builder, $launchFailureCode);
        self::addLaunchDate($builder, $launchDate);
        self::addBeNumber($builder, $beNumber);
        self::addOSuffix($builder, $oSuffix);
        self::addLaunchFacilityName($builder, $launchFacilityName);
    ...
    {
        $builder->addOffsetX(2, $origObjectId, 0);
    }
    ...
    {
        $builder->addOffsetX(4, $derivedFrom, 0);
    }
    ...
    {
        $builder->addOffsetX(5, $declassificationDate, 0);
    }
    ...
    {
        $builder->addOffsetX(6, $declassificationString, 0);
    }
    ...
    {
        $builder->addOffsetX(7, $msgCreateDate, 0);
    }
     ...
     * @return void
     */
    public static function addLaunchFailureCode(FlatBufferBuilder $builder, $launchFailureCode)
    {
        $builder->addOffsetX(8, $launchFailureCode, 0);
    }
    ...
    {
        $builder->addOffsetX(9, $launchDate, 0);
    }
     ...
     * @return void
     */
    public static function addLaunchFacilityName(FlatBufferBuilder $builder, $launchFacilityName)
    {
        $builder->addOffsetX(12, $launchFacilityName, 0);
    }
    ...
    {
        $builder->addOffsetX(19, $onOrbit, 0);
    }
     ...
     */
    public static function endLaunchEvent_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLaunchEvent_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
