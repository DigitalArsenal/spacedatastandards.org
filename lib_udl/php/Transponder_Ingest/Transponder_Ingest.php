...
class Transponder_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Transponder_Ingest
     */
    public static function getRootAsTransponder_Ingest(ByteBuffer $bb)
    {
        $obj = new Transponder_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Transponder_IngestIdentifier()
    {
        return "TRAN";
    }

    public static function Transponder_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Transponder_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(34);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Transponder_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startTransponder_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return Transponder_Ingest
     */
    public static function createTransponder_Ingest(FlatBufferBuilder $builder, $id, $idComm, $name, $classificationMarking, $nid, $tid, $ttf, $symbolRate, $fec, $modulation, $format, $system, $source, $origin, $origNetwork, $dataMode, $createdAt, $createdBy)
    {
        $builder->startObject(18);
     ...
     */
    public static function endTransponder_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishTransponder_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
