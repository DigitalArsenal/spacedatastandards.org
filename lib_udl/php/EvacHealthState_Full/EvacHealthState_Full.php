...
class EvacHealthState_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacHealthState_Full
     */
    public static function getRootAsEvacHealthState_Full(ByteBuffer $bb)
    {
        $obj = new EvacHealthState_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacHealthState_FullIdentifier()
    {
        return "EVAC";
    }

    public static function EvacHealthState_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacHealthState_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacHealthState_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return EvacHealthState_Full
     */
    public static function createEvacHealthState_Full(FlatBufferBuilder $builder, $type, $healthStateCode, $medConfFactor, $time)
    {
        $builder->startObject(4);
     ...
     */
    public static function endEvacHealthState_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacHealthState_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
