...
class AirfieldSlot_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirfieldSlot_Ingest
     */
    public static function getRootAsAirfieldSlot_Ingest(ByteBuffer $bb)
    {
        $obj = new AirfieldSlot_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirfieldSlot_IngestIdentifier()
    {
        return "AIRF";
    }

    public static function AirfieldSlot_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirfieldSlot_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(18);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirfieldSlot_Ingest_type_Enum::WORKING;
    }
    ...
    {
        $o = $this->__offset(20);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirfieldSlot_Ingest_acSlotCat_Enum::WIDE;
    }
    ...
    {
        $o = $this->__offset(44);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirfieldSlot_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAirfieldSlot_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return AirfieldSlot_Ingest
     */
    public static function createAirfieldSlot_Ingest(FlatBufferBuilder $builder, $id, $classificationMarking, $airfieldName, $icao, $idAirfield, $altAirfieldId, $name, $type, $acSlotCat, $capacity, $startTime, $endTime, $minSeparation, $notes, $createdAt, $createdBy, $sourceDL, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(21);
     ...
     */
    public static function endAirfieldSlot_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirfieldSlot_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
