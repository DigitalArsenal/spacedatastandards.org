...
class Item_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Item_Ingest
     */
    public static function getRootAsItem_Ingest(ByteBuffer $bb)
    {
        $obj = new Item_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Item_IngestIdentifier()
    {
        return "ITEM";
    }

    public static function Item_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Item_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(104);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Item_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startItem_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endItem_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishItem_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
