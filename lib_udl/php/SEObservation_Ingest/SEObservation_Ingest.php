...
class SEObservation_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SEObservation_Ingest
     */
    public static function getRootAsSEObservation_Ingest(ByteBuffer $bb)
    {
        $obj = new SEObservation_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SEObservation_IngestIdentifier()
    {
        return "SEOB";
    }

    public static function SEObservation_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SEObservation_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startSEObservation_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return SEObservation_Ingest
     */
    public static function createSEObservation_Ingest(FlatBufferBuilder $builder, $obType, $obUoM, $obValue, $obString, $obArray, $obBool, $obQuality, $obDescription)
    {
        $builder->startObject(8);
     ...
     */
    public static function endSEObservation_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSEObservation_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
