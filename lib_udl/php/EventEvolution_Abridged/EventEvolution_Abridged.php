...
class EventEvolution_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EventEvolution_Abridged
     */
    public static function getRootAsEventEvolution_Abridged(ByteBuffer $bb)
    {
        $obj = new EventEvolution_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EventEvolution_AbridgedIdentifier()
    {
        return "EVEN";
    }

    public static function EventEvolution_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EventEvolution_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(60);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EventEvolution_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEventEvolution_Abridged(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(17, $agjson, 0);
    }
     ...
     */
    public static function endEventEvolution_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEventEvolution_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
