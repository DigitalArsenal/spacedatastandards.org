...
class AirspaceControlOrderReference_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirspaceControlOrderReference_Ingest
     */
    public static function getRootAsAirspaceControlOrderReference_Ingest(ByteBuffer $bb)
    {
        $obj = new AirspaceControlOrderReference_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirspaceControlOrderReference_IngestIdentifier()
    {
        return "AIRS";
    }

    public static function AirspaceControlOrderReference_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirspaceControlOrderReference_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startAirspaceControlOrderReference_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return AirspaceControlOrderReference_Ingest
     */
    public static function createAirspaceControlOrderReference_Ingest(FlatBufferBuilder $builder, $refSId, $refType, $refOriginator, $refTs, $refSerialNum, $refSpecialNotation, $refSICs)
    {
        $builder->startObject(7);
     ...
     */
    public static function endAirspaceControlOrderReference_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirspaceControlOrderReference_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
