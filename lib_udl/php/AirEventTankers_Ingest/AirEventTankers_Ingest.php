...
class AirEventTankers_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirEventTankers_Ingest
     */
    public static function getRootAsAirEventTankers_Ingest(ByteBuffer $bb)
    {
        $obj = new AirEventTankers_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirEventTankers_IngestIdentifier()
    {
        return "AIRE";
    }

    public static function AirEventTankers_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirEventTankers_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startAirEventTankers_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAirEventTankers_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirEventTankers_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
