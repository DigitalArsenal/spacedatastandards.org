...
class PersonnelRecoveryVehicle_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return PersonnelRecoveryVehicle_Abridged
     */
    public static function getRootAsPersonnelRecoveryVehicle_Abridged(ByteBuffer $bb)
    {
        $obj = new PersonnelRecoveryVehicle_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function PersonnelRecoveryVehicle_AbridgedIdentifier()
    {
        return "PERS";
    }

    public static function PersonnelRecoveryVehicle_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::PersonnelRecoveryVehicle_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startPersonnelRecoveryVehicle_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return PersonnelRecoveryVehicle_Abridged
     */
    public static function createPersonnelRecoveryVehicle_Abridged(FlatBufferBuilder $builder, $callSign, $type, $primaryFreq, $strength)
    {
        $builder->startObject(4);
     ...
     */
    public static function endPersonnelRecoveryVehicle_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPersonnelRecoveryVehicle_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
