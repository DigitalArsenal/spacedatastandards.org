...
class SensorMaintenance_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SensorMaintenance_Full
     */
    public static function getRootAsSensorMaintenance_Full(ByteBuffer $bb)
    {
        $obj = new SensorMaintenance_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SensorMaintenance_FullIdentifier()
    {
        return "SENS";
    }

    public static function SensorMaintenance_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SensorMaintenance_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(62);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SensorMaintenance_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSensorMaintenance_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSensorMaintenance_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSensorMaintenance_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
