...
class AircraftStatusRemark_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AircraftStatusRemark_Abridged
     */
    public static function getRootAsAircraftStatusRemark_Abridged(ByteBuffer $bb)
    {
        $obj = new AircraftStatusRemark_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AircraftStatusRemark_AbridgedIdentifier()
    {
        return "AIRC";
    }

    public static function AircraftStatusRemark_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AircraftStatusRemark_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(34);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AircraftStatusRemark_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAircraftStatusRemark_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return AircraftStatusRemark_Abridged
     */
    public static function createAircraftStatusRemark_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $idAircraftStatus, $altRmkId, $name, $text, $timestamp, $lastUpdatedBy, $lastUpdatedAt, $createdAt, $createdBy, $sourceDL, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(16);
     ...
     */
    public static function endAircraftStatusRemark_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAircraftStatusRemark_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
