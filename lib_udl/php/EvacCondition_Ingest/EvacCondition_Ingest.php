...
class EvacCondition_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacCondition_Ingest
     */
    public static function getRootAsEvacCondition_Ingest(ByteBuffer $bb)
    {
        $obj = new EvacCondition_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacCondition_IngestIdentifier()
    {
        return "EVAC";
    }

    public static function EvacCondition_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacCondition_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacCondition_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return EvacCondition_Ingest
     */
    public static function createEvacCondition_Ingest(FlatBufferBuilder $builder, $type, $bodyPart, $time, $comments)
    {
        $builder->startObject(4);
     ...
     */
    public static function endEvacCondition_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacCondition_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
