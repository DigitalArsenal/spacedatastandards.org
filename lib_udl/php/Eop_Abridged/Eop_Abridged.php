...
class Eop_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Eop_Abridged
     */
    public static function getRootAsEop_Abridged(ByteBuffer $bb)
    {
        $obj = new Eop_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Eop_AbridgedIdentifier()
    {
        return "EOPA";
    }

    public static function Eop_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Eop_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(10);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Eop_Abridged_polarMotionState_Enum::I;
    }
    ...
    {
        $o = $this->__offset(20);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Eop_Abridged_ut1UTCState_Enum::I;
    }
    ...
    {
        $o = $this->__offset(30);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Eop_Abridged_nutationState_Enum::I;
    }
    ...
    {
        $o = $this->__offset(70);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Eop_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEop_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endEop_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEop_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
