...
class SolarArrayDetails extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SolarArrayDetails
     */
    public static function getRootAsSolarArrayDetails(ByteBuffer $bb)
    {
        $obj = new SolarArrayDetails();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SolarArrayDetailsIdentifier()
    {
        return "SOLA";
    }

    public static function SolarArrayDetailsBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SolarArrayDetailsIdentifier());
    }
    ...
    {
        $o = $this->__offset(38);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SolarArrayDetails_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSolarArrayDetails(FlatBufferBuilder $builder)
    {
     ...
     * @return SolarArrayDetails
     */
    public static function createSolarArrayDetails(FlatBufferBuilder $builder, $id, $idSolarArray, $classificationMarking, $type, $technology, $junctionTechnology, $manufacturerOrgId, $span, $area, $description, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $origNetwork, $dataMode, $tags, $manufacturerOrg)
    {
        $builder->startObject(20);
     ...
     */
    public static function endSolarArrayDetails(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSolarArrayDetailsBuffer(FlatBufferBuilder $builder, $offset)
    {
