...
class DataLinkMultiDutyVoiceCoord_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DataLinkMultiDutyVoiceCoord_Ingest
     */
    public static function getRootAsDataLinkMultiDutyVoiceCoord_Ingest(ByteBuffer $bb)
    {
        $obj = new DataLinkMultiDutyVoiceCoord_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DataLinkMultiDutyVoiceCoord_IngestIdentifier()
    {
        return "DATA";
    }

    public static function DataLinkMultiDutyVoiceCoord_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DataLinkMultiDutyVoiceCoord_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startDataLinkMultiDutyVoiceCoord_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return DataLinkMultiDutyVoiceCoord_Ingest
     */
    public static function createDataLinkMultiDutyVoiceCoord_Ingest(FlatBufferBuilder $builder, $multiVoiceNetDes, $multiFreqDes, $multiCommPri, $multiTeleFreqNums)
    {
        $builder->startObject(4);
     ...
     */
    public static function endDataLinkMultiDutyVoiceCoord_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDataLinkMultiDutyVoiceCoord_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
