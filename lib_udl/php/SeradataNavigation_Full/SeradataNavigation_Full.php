...
class SeradataNavigation_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SeradataNavigation_Full
     */
    public static function getRootAsSeradataNavigation_Full(ByteBuffer $bb)
    {
        $obj = new SeradataNavigation_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SeradataNavigation_FullIdentifier()
    {
        return "SERA";
    }

    public static function SeradataNavigation_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SeradataNavigation_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(48);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SeradataNavigation_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSeradataNavigation_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSeradataNavigation_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSeradataNavigation_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
