...
class SigAct_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SigAct_Ingest
     */
    public static function getRootAsSigAct_Ingest(ByteBuffer $bb)
    {
        $obj = new SigAct_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SigAct_IngestIdentifier()
    {
        return "SIGA";
    }

    public static function SigAct_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SigAct_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(166);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SigAct_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSigAct_Ingest(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(13, $agjson, 0);
    }
    ...
    {
        $builder->addOffsetX(17, $eventStart, 0);
    }
    ...
    {
        $builder->addOffsetX(18, $eventEnd, 0);
    }
    ...
    {
        $builder->addOffsetX(19, $reportDate, 0);
    }
    ...
    {
        $builder->addOffsetX(20, $actors, 0);
    }
    ...
    {
        $builder->addIntX(28, $coalWound, 0);
    }
    ...
    {
        $builder->addIntX(32, $friendlyAbd, 0);
    }
    ...
    {
        $builder->addIntX(33, $friendlyDet, 0);
    }
    ...
    {
        $builder->addIntX(34, $friendlyKIA, 0);
    }
    ...
    {
        $builder->addIntX(35, $friendlyWound, 0);
    }
    ...
    {
        $builder->addIntX(36, $hostNatAbd, 0);
    }
    ...
    {
        $builder->addIntX(37, $hostNatDet, 0);
    }
    ...
    {
        $builder->addIntX(38, $hostNatKIA, 0);
    }
    ...
    {
        $builder->addIntX(39, $hostNatWound, 0);
    }
    ...
    {
        $builder->addIntX(43, $sideAWound, 0);
    }
    ...
    {
        $builder->addIntX(47, $sideBWound, 0);
    }
    ...
    {
        $builder->addOffsetX(48, $target, 0);
    }
    ...
    {
        $builder->addOffsetX(49, $eventDescription, 0);
    }
    ...
    {
        $builder->addOffsetX(50, $eventType, 0);
    }
    ...
    {
        $builder->addOffsetX(51, $typeOfAttack, 0);
    }
    ...
    {
        $builder->addBoolX(52, $complexAttack, false);
    }
    ...
    {
        $builder->addOffsetX(53, $idNumber, 0);
    }
    ...
    {
        $builder->addIntX(54, $confidence, 0);
    }
    ...
    {
        $builder->addOffsetX(57, $cameoCode, 0);
    }
    ...
    {
        $builder->addOffsetX(58, $cameoBaseCode, 0);
    }
    ...
    {
        $builder->addOffsetX(59, $cameoRootCode, 0);
    }
    ...
    {
        $builder->addDoubleX(60, $goldstein, 0.0);
    }
    ...
    {
        $builder->addOffsetX(61, $documentSource, 0);
    }
    ...
    {
        $builder->addOffsetX(62, $documentFilename, 0);
    }
    ...
    {
        $builder->addBoolX(63, $hasAttachment, false);
    }
    ...
    {
        $builder->addLongX(64, $filesize, 0);
    }
    ...
    {
        $builder->addOffsetX(65, $checksumValue, 0);
    }
    ...
    {
        $builder->addOffsetX(66, $repUnit, 0);
    }
    ...
    {
        $builder->addOffsetX(67, $repUnitType, 0);
    }
    ...
    {
        $builder->addOffsetX(68, $repUnitActivity, 0);
    }
    ...
    {
        $builder->addIntX(69, $numMentions, 0);
    }
    ...
    {
        $builder->addIntX(70, $numSources, 0);
    }
    ...
    {
        $builder->addIntX(71, $numArticles, 0);
    }
    ...
    {
        $builder->addDoubleX(72, $avgTone, 0.0);
    }
    ...
    {
        $builder->addOffsetX(73, $sourceUrl, 0);
    }
    ...
    {
        $builder->addOffsetX(74, $relatedDocs, 0);
    }
    ...
    {
        $builder->addOffsetX(75, $summary, 0);
    }
    ...
    {
        $builder->addOffsetX(77, $createdAt, 0);
    }
    ...
    {
        $builder->addOffsetX(78, $createdBy, 0);
    }
    ...
    {
        $builder->addOffsetX(80, $origin, 0);
    }
    ...
    {
        $builder->addSbyteX(81, $dataMode, 0);
    }
    ...
    {
        $builder->addOffsetX(82, $origNetwork, 0);
    }
     ...
     */
    public static function endSigAct_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSigAct_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
