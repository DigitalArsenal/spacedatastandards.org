...
class LogisticsSupport_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LogisticsSupport_Abridged
     */
    public static function getRootAsLogisticsSupport_Abridged(ByteBuffer $bb)
    {
        $obj = new LogisticsSupport_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LogisticsSupport_AbridgedIdentifier()
    {
        return "LOGI";
    }

    public static function LogisticsSupport_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LogisticsSupport_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(62);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \LogisticsSupport_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startLogisticsSupport_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endLogisticsSupport_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLogisticsSupport_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
