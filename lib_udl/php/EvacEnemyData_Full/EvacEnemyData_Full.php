...
class EvacEnemyData_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacEnemyData_Full
     */
    public static function getRootAsEvacEnemyData_Full(ByteBuffer $bb)
    {
        $obj = new EvacEnemyData_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacEnemyData_FullIdentifier()
    {
        return "EVAC";
    }

    public static function EvacEnemyData_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacEnemyData_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacEnemyData_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return EvacEnemyData_Full
     */
    public static function createEvacEnemyData_Full(FlatBufferBuilder $builder, $dirToEnemy, $hostileFireType, $friendliesRemarks, $hlzRemarks)
    {
        $builder->startObject(4);
     ...
     */
    public static function endEvacEnemyData_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacEnemyData_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
