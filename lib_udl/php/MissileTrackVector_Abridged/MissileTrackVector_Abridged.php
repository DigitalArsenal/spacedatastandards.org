...
class MissileTrackVector_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MissileTrackVector_Abridged
     */
    public static function getRootAsMissileTrackVector_Abridged(ByteBuffer $bb)
    {
        $obj = new MissileTrackVector_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MissileTrackVector_AbridgedIdentifier()
    {
        return "MISS";
    }

    public static function MissileTrackVector_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MissileTrackVector_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startMissileTrackVector_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return MissileTrackVector_Abridged
     */
    public static function createMissileTrackVector_Abridged(FlatBufferBuilder $builder, $type, $object, $epoch, $idSensor, $origSensorId, $pos, $vel, $accel, $course, $spd, $referenceFrame, $cov, $covReferenceFrame, $vectorLat, $vectorLon, $vectorAlt, $confidence, $status, $timeSource, $quat, $flightAz)
    {
        $builder->startObject(21);
     ...
     */
    public static function endMissileTrackVector_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMissileTrackVector_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
