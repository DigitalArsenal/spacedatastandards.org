...
class Channel_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Channel_Full
     */
    public static function getRootAsChannel_Full(ByteBuffer $bb)
    {
        $obj = new Channel_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Channel_FullIdentifier()
    {
        return "CHAN";
    }

    public static function Channel_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Channel_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(42);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Channel_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startChannel_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return Channel_Full
     */
    public static function createChannel_Full(FlatBufferBuilder $builder, $id, $idTransponder, $name, $classificationMarking, $type, $idBeam, $beamName, $idRFBand, $encryption, $pkg, $res, $compression, $vpid, $apid, $sid, $owner, $source, $origin, $origNetwork, $dataMode, $createdAt, $createdBy, $updatedAt, $updatedBy)
    {
        $builder->startObject(24);
     ...
     */
    public static function endChannel_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishChannel_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
