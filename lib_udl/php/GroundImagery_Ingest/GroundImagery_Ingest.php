...
class GroundImagery_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GroundImagery_Ingest
     */
    public static function getRootAsGroundImagery_Ingest(ByteBuffer $bb)
    {
        $obj = new GroundImagery_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function GroundImagery_IngestIdentifier()
    {
        return "GROU";
    }

    public static function GroundImagery_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::GroundImagery_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(40);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \GroundImagery_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startGroundImagery_Ingest(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(21, $transactionId, 0);
    }
    ...
    {
        $builder->addOffsetX(23, $keywords, 0);
    }
    ...
    {
        $builder->addOffsetX(25, $format, 0);
    }
    ...
    {
        $builder->addLongX(26, $filesize, 0);
    }
    ...
    {
        $builder->addOffsetX(27, $checksumValue, 0);
    }
     ...
     */
    public static function endGroundImagery_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishGroundImagery_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
