...
class AirTaskingOrder_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirTaskingOrder_Ingest
     */
    public static function getRootAsAirTaskingOrder_Ingest(ByteBuffer $bb)
    {
        $obj = new AirTaskingOrder_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirTaskingOrder_IngestIdentifier()
    {
        return "AIRT";
    }

    public static function AirTaskingOrder_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirTaskingOrder_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(46);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirTaskingOrder_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAirTaskingOrder_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAirTaskingOrder_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirTaskingOrder_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
