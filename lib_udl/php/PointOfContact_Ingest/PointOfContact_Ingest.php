...
class PointOfContact_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return PointOfContact_Ingest
     */
    public static function getRootAsPointOfContact_Ingest(ByteBuffer $bb)
    {
        $obj = new PointOfContact_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function PointOfContact_IngestIdentifier()
    {
        return "POIN";
    }

    public static function PointOfContact_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::PointOfContact_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startPointOfContact_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return PointOfContact_Ingest
     */
    public static function createPointOfContact_Ingest(FlatBufferBuilder $builder, $pocSequenceId, $pocTypeName, $pocName, $office, $username, $rank, $pocOrg, $phone, $remark)
    {
        $builder->startObject(9);
     ...
     */
    public static function endPointOfContact_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPointOfContact_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
