...
class Maneuver_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Maneuver_Full
     */
    public static function getRootAsManeuver_Full(ByteBuffer $bb)
    {
        $obj = new Maneuver_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Maneuver_FullIdentifier()
    {
        return "MANE";
    }

    public static function Maneuver_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Maneuver_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(182);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Maneuver_Full_dataMode_Enum::REAL;
    }
    ...
    {
        $o = $this->__offset(194);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Maneuver_Full_sourcedDataTypes_Enum::EO;
    }
     ...
     * @return void
     */
    public static function startManeuver_Full(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(93, $algorithm, 0);
    }
    ...
    {
        $builder->addOffsetX(94, $sourcedData, 0);
    }
    ...
    {
        $builder->addSbyteX(95, $sourcedDataTypes, 0);
    }
    ...
    {
        $builder->addOffsetX(96, $onOrbit, 0);
    }
    ...
    {
        $builder->addOffsetX(97, $transactionId, 0);
    }
    ...
    {
        $builder->addOffsetX(98, $origNetwork, 0);
    }
     ...
     */
    public static function endManeuver_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishManeuver_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
