...
class AirEventRemarks_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirEventRemarks_Ingest
     */
    public static function getRootAsAirEventRemarks_Ingest(ByteBuffer $bb)
    {
        $obj = new AirEventRemarks_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirEventRemarks_IngestIdentifier()
    {
        return "AIRE";
    }

    public static function AirEventRemarks_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirEventRemarks_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startAirEventRemarks_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return AirEventRemarks_Ingest
     */
    public static function createAirEventRemarks_Ingest(FlatBufferBuilder $builder, $externalRemarkId, $text, $date, $user)
    {
        $builder->startObject(4);
     ...
     */
    public static function endAirEventRemarks_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirEventRemarks_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
