...
class OnorbitThrusterStatus_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OnorbitThrusterStatus_Abridged
     */
    public static function getRootAsOnorbitThrusterStatus_Abridged(ByteBuffer $bb)
    {
        $obj = new OnorbitThrusterStatus_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OnorbitThrusterStatus_AbridgedIdentifier()
    {
        return "ONOR";
    }

    public static function OnorbitThrusterStatus_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OnorbitThrusterStatus_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(50);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OnorbitThrusterStatus_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOnorbitThrusterStatus_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endOnorbitThrusterStatus_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOnorbitThrusterStatus_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
