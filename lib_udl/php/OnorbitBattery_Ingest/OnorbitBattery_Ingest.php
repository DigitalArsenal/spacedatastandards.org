...
class OnorbitBattery_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OnorbitBattery_Ingest
     */
    public static function getRootAsOnorbitBattery_Ingest(ByteBuffer $bb)
    {
        $obj = new OnorbitBattery_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OnorbitBattery_IngestIdentifier()
    {
        return "ONOR";
    }

    public static function OnorbitBattery_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OnorbitBattery_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(22);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OnorbitBattery_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOnorbitBattery_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return OnorbitBattery_Ingest
     */
    public static function createOnorbitBattery_Ingest(FlatBufferBuilder $builder, $id, $idOnOrbit, $idBattery, $classificationMarking, $quantity, $createdAt, $createdBy, $source, $origin, $dataMode, $origNetwork, $battery)
    {
        $builder->startObject(12);
     ...
     */
    public static function endOnorbitBattery_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOnorbitBattery_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
