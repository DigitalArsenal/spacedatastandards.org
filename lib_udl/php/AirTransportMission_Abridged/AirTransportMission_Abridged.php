...
class AirTransportMission_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirTransportMission_Abridged
     */
    public static function getRootAsAirTransportMission_Abridged(ByteBuffer $bb)
    {
        $obj = new AirTransportMission_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirTransportMission_AbridgedIdentifier()
    {
        return "AIRT";
    }

    public static function AirTransportMission_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirTransportMission_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(70);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirTransportMission_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAirTransportMission_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAirTransportMission_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirTransportMission_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
