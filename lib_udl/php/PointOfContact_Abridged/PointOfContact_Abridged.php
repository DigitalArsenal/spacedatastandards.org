...
class PointOfContact_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return PointOfContact_Abridged
     */
    public static function getRootAsPointOfContact_Abridged(ByteBuffer $bb)
    {
        $obj = new PointOfContact_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function PointOfContact_AbridgedIdentifier()
    {
        return "POIN";
    }

    public static function PointOfContact_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::PointOfContact_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startPointOfContact_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return PointOfContact_Abridged
     */
    public static function createPointOfContact_Abridged(FlatBufferBuilder $builder, $pocSequenceId, $pocTypeName, $pocName, $office, $username, $rank, $pocOrg, $phone, $remark)
    {
        $builder->startObject(9);
     ...
     */
    public static function endPointOfContact_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPointOfContact_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
