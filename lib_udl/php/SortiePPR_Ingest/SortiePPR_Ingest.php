...
class SortiePPR_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SortiePPR_Ingest
     */
    public static function getRootAsSortiePPR_Ingest(ByteBuffer $bb)
    {
        $obj = new SortiePPR_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SortiePPR_IngestIdentifier()
    {
        return "SORT";
    }

    public static function SortiePPR_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SortiePPR_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(22);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SortiePPR_Ingest_type_Enum::M;
    }
    ...
    {
        $o = $this->__offset(38);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SortiePPR_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSortiePPR_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return SortiePPR_Ingest
     */
    public static function createSortiePPR_Ingest(FlatBufferBuilder $builder, $id, $classificationMarking, $idSortie, $externalId, $number, $startTime, $endTime, $requestor, $grantor, $type, $remarks, $createdAt, $createdBy, $sourceDL, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(18);
     ...
     */
    public static function endSortiePPR_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSortiePPR_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
