...
class PersonnelRecoveryEnemyData_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return PersonnelRecoveryEnemyData_Abridged
     */
    public static function getRootAsPersonnelRecoveryEnemyData_Abridged(ByteBuffer $bb)
    {
        $obj = new PersonnelRecoveryEnemyData_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function PersonnelRecoveryEnemyData_AbridgedIdentifier()
    {
        return "PERS";
    }

    public static function PersonnelRecoveryEnemyData_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::PersonnelRecoveryEnemyData_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startPersonnelRecoveryEnemyData_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return PersonnelRecoveryEnemyData_Abridged
     */
    public static function createPersonnelRecoveryEnemyData_Abridged(FlatBufferBuilder $builder, $dirToEnemy, $hostileFireType, $friendliesRemarks, $hlzRemarks)
    {
        $builder->startObject(4);
     ...
     */
    public static function endPersonnelRecoveryEnemyData_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPersonnelRecoveryEnemyData_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
