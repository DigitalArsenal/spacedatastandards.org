...
class StarCatalog_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return StarCatalog_Abridged
     */
    public static function getRootAsStarCatalog_Abridged(ByteBuffer $bb)
    {
        $obj = new StarCatalog_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function StarCatalog_AbridgedIdentifier()
    {
        return "STAR";
    }

    public static function StarCatalog_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::StarCatalog_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(42);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \StarCatalog_Abridged_astrometryOrigin_Enum::GAIADR3;
    }
    ...
    {
        $o = $this->__offset(98);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \StarCatalog_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startStarCatalog_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endStarCatalog_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishStarCatalog_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
