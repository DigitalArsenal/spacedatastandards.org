...
class GNSSObservation_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GNSSObservation_Ingest
     */
    public static function getRootAsGNSSObservation_Ingest(ByteBuffer $bb)
    {
        $obj = new GNSSObservation_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function GNSSObservation_IngestIdentifier()
    {
        return "GNSS";
    }

    public static function GNSSObservation_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::GNSSObservation_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startGNSSObservation_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return GNSSObservation_Ingest
     */
    public static function createGNSSObservation_Ingest(FlatBufferBuilder $builder, $gnssSatId, $trackingStatus, $agcState, $obsCodeSet, $ob)
    {
        $builder->startObject(5);
     ...
     */
    public static function endGNSSObservation_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishGNSSObservation_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
