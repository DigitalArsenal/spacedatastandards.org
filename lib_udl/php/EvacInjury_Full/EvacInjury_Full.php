...
/// /// Injury specifics.
class EvacInjury_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacInjury_Full
     */
    public static function getRootAsEvacInjury_Full(ByteBuffer $bb)
    {
        $obj = new EvacInjury_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacInjury_FullIdentifier()
    {
        return "EVAC";
    }

    public static function EvacInjury_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacInjury_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacInjury_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return EvacInjury_Full
     */
    public static function createEvacInjury_Full(FlatBufferBuilder $builder, $type, $bodyPart, $time, $comments)
    {
        $builder->startObject(4);
     ...
     */
    public static function endEvacInjury_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacInjury_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
