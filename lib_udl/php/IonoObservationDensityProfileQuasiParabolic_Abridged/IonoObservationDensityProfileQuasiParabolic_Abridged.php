...
class IonoObservationDensityProfileQuasiParabolic_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IonoObservationDensityProfileQuasiParabolic_Abridged
     */
    public static function getRootAsIonoObservationDensityProfileQuasiParabolic_Abridged(ByteBuffer $bb)
    {
        $obj = new IonoObservationDensityProfileQuasiParabolic_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IonoObservationDensityProfileQuasiParabolic_AbridgedIdentifier()
    {
        return "IONO";
    }

    public static function IonoObservationDensityProfileQuasiParabolic_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IonoObservationDensityProfileQuasiParabolic_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startIonoObservationDensityProfileQuasiParabolic_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return IonoObservationDensityProfileQuasiParabolic_Abridged
     */
    public static function createIonoObservationDensityProfileQuasiParabolic_Abridged(FlatBufferBuilder $builder, $description, $earthRadius, $quasiParabolicSegments)
    {
        $builder->startObject(3);
     ...
     */
    public static function endIonoObservationDensityProfileQuasiParabolic_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIonoObservationDensityProfileQuasiParabolic_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
