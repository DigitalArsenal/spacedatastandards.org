...
class GNSSObservationSet_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GNSSObservationSet_Ingest
     */
    public static function getRootAsGNSSObservationSet_Ingest(ByteBuffer $bb)
    {
        $obj = new GNSSObservationSet_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function GNSSObservationSet_IngestIdentifier()
    {
        return "GNSS";
    }

    public static function GNSSObservationSet_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::GNSSObservationSet_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(70);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \GNSSObservationSet_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startGNSSObservationSet_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endGNSSObservationSet_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishGNSSObservationSet_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
