...
class Surface_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Surface_Ingest
     */
    public static function getRootAsSurface_Ingest(ByteBuffer $bb)
    {
        $obj = new Surface_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Surface_IngestIdentifier()
    {
        return "SURF";
    }

    public static function Surface_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Surface_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(106);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Surface_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSurface_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSurface_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSurface_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
