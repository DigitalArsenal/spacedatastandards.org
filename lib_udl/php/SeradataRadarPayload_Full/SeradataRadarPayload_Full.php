...
class SeradataRadarPayload_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SeradataRadarPayload_Full
     */
    public static function getRootAsSeradataRadarPayload_Full(ByteBuffer $bb)
    {
        $obj = new SeradataRadarPayload_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SeradataRadarPayload_FullIdentifier()
    {
        return "SERA";
    }

    public static function SeradataRadarPayload_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SeradataRadarPayload_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(70);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SeradataRadarPayload_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSeradataRadarPayload_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return SeradataRadarPayload_Full
     */
    public static function createSeradataRadarPayload_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $spacecraftId, $idSensor, $hostedForCompanyOrgId, $manufacturerOrgId, $category, $name, $frequencyBand, $frequency, $waveLength, $bestResolution, $swathWidth, $recorderSize, $fieldOfView, $fieldOfRegard, $pointingMethod, $groundStations, $groundStationLocations, $transmitPolarization, $receivePolarization, $dutyCycle, $partnerSpacecraft, $constellationInterferometricCapability, $notes, $bandwidth, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(34);
     ...
     */
    public static function endSeradataRadarPayload_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSeradataRadarPayload_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
