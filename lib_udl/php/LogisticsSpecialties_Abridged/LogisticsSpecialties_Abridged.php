...
class LogisticsSpecialties_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LogisticsSpecialties_Abridged
     */
    public static function getRootAsLogisticsSpecialties_Abridged(ByteBuffer $bb)
    {
        $obj = new LogisticsSpecialties_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LogisticsSpecialties_AbridgedIdentifier()
    {
        return "LOGI";
    }

    public static function LogisticsSpecialties_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LogisticsSpecialties_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startLogisticsSpecialties_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return LogisticsSpecialties_Abridged
     */
    public static function createLogisticsSpecialties_Abridged(FlatBufferBuilder $builder, $specialty, $skillLevel, $firstName, $lastName, $rankCode, $last4Ssn, $roleTypeCode)
    {
        $builder->startObject(7);
     ...
     */
    public static function endLogisticsSpecialties_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLogisticsSpecialties_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
