...
class Hazard_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Hazard_Abridged
     */
    public static function getRootAsHazard_Abridged(ByteBuffer $bb)
    {
        $obj = new Hazard_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Hazard_AbridgedIdentifier()
    {
        return "HAZA";
    }

    public static function Hazard_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Hazard_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(82);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Hazard_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startHazard_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endHazard_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishHazard_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
