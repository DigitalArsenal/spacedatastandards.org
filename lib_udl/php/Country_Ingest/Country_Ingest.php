...
class Country_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Country_Ingest
     */
    public static function getRootAsCountry_Ingest(ByteBuffer $bb)
    {
        $obj = new Country_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Country_IngestIdentifier()
    {
        return "COUN";
    }

    public static function Country_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Country_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(22);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Country_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startCountry_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return Country_Ingest
     */
    public static function createCountry_Ingest(FlatBufferBuilder $builder, $code, $name, $fipsCode, $iso3Code, $codeAlt, $createdAt, $createdBy, $source, $origNetwork, $dataMode)
    {
        $builder->startObject(10);
     ...
     */
    public static function endCountry_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishCountry_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
