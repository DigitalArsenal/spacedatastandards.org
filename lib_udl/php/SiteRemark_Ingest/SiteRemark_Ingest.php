...
class SiteRemark_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SiteRemark_Ingest
     */
    public static function getRootAsSiteRemark_Ingest(ByteBuffer $bb)
    {
        $obj = new SiteRemark_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SiteRemark_IngestIdentifier()
    {
        return "SITE";
    }

    public static function SiteRemark_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SiteRemark_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(30);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SiteRemark_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSiteRemark_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return SiteRemark_Ingest
     */
    public static function createSiteRemark_Ingest(FlatBufferBuilder $builder, $id, $classificationMarking, $idSite, $origRmkId, $name, $type, $text, $code, $createdAt, $createdBy, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(14);
     ...
     */
    public static function endSiteRemark_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSiteRemark_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
