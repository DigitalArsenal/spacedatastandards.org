...
class POI_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return POI_Ingest
     */
    public static function getRootAsPOI_Ingest(ByteBuffer $bb)
    {
        $obj = new POI_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function POI_IngestIdentifier()
    {
        return "POII";
    }

    public static function POI_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::POI_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(86);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \POI_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startPOI_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return POI_Ingest
     */
    public static function createPOI_Ingest(FlatBufferBuilder $builder, $id, $classificationMarking, $pps, $msnid, $pri, $trkid, $idWeatherReport, $poiid, $name, $desc, $spec, $ident, $env, $plat, $activity, $ts, $start, $stale, $how, $type, $lat, $lon, $alt, $az, $el, $le, $ce, $elle, $cntct, $conf, $urls, $area, $atext, $agjson, $atype, $andims, $asrid, $createdAt, $createdBy, $sourceDL, $source, $dataMode, $origin, $groups, $asset, $tags, $srcTyps, $srcIds, $beNumber, $orientation, $origNetwork, $transactionId)
    {
        $builder->startObject(52);
    ...
    {
        $builder->addOffsetX(43, $groups, 0);
    }
    ...
    {
        $builder->addOffsetX(48, $beNumber, 0);
    }
    ...
    {
        $builder->addDoubleX(49, $orientation, 0.0);
    }
    ...
    {
        $builder->addOffsetX(51, $transactionId, 0);
    }
     ...
     */
    public static function endPOI_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPOI_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
