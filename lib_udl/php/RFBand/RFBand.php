...
class RFBand extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return RFBand
     */
    public static function getRootAsRFBand(ByteBuffer $bb)
    {
        $obj = new RFBand();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function RFBandIdentifier()
    {
        return "RFBA";
    }

    public static function RFBandBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RFBandIdentifier());
    }
    ...
    {
        $o = $this->__offset(14);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFBand_mode_Enum::TX;
    }
    ...
    {
        $o = $this->__offset(16);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFBand_purpose_Enum::COMM;
    }
    ...
    {
        $o = $this->__offset(32);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFBand_polarization_Enum::H;
    }
    ...
    {
        $o = $this->__offset(42);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFBand_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startRFBand(FlatBufferBuilder $builder)
    {
     ...
     * @return RFBand
     */
    public static function createRFBand(FlatBufferBuilder $builder, $id, $idEntity, $classificationMarking, $name, $band, $mode, $purpose, $freqMin, $freqMax, $centerFreq, $peakGain, $edgeGain, $bandwidth, $beamwidth, $polarization, $erp, $eirp, $source, $origin, $dataMode, $createdAt, $createdBy, $updatedAt, $updatedBy, $origNetwork)
    {
        $builder->startObject(25);
     ...
     */
    public static function endRFBand(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRFBandBuffer(FlatBufferBuilder $builder, $offset)
    {
