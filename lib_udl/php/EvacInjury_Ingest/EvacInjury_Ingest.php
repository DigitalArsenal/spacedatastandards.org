...
/// /// Injury specifics.
class EvacInjury_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacInjury_Ingest
     */
    public static function getRootAsEvacInjury_Ingest(ByteBuffer $bb)
    {
        $obj = new EvacInjury_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacInjury_IngestIdentifier()
    {
        return "EVAC";
    }

    public static function EvacInjury_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacInjury_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacInjury_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return EvacInjury_Ingest
     */
    public static function createEvacInjury_Ingest(FlatBufferBuilder $builder, $type, $bodyPart, $time, $comments)
    {
        $builder->startObject(4);
     ...
     */
    public static function endEvacInjury_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacInjury_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
