...
class SWIR_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SWIR_Full
     */
    public static function getRootAsSWIR_Full(ByteBuffer $bb)
    {
        $obj = new SWIR_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SWIR_FullIdentifier()
    {
        return "SWIR";
    }

    public static function SWIR_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SWIR_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(40);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SWIR_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSWIR_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return SWIR_Full
     */
    public static function createSWIR_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $idOnOrbit, $onOrbit, $ts, $solarPhaseAngle, $lat, $lon, $locationName, $badWave, $wavelengths, $absFluxes, $ratioWavelengths, $fluxRatios, $origObjectId, $source, $origin, $satNo, $dataMode, $createdAt, $createdBy, $origNetwork)
    {
        $builder->startObject(22);
    ...
    {
        $builder->addDoubleX(5, $solarPhaseAngle, 0.0);
    }
    ...
    {
        $builder->addOffsetX(8, $locationName, 0);
    }
    ...
    {
        $builder->addOffsetX(9, $badWave, 0);
    }
    ...
    {
        $builder->addOffsetX(11, $absFluxes, 0);
    }
    ...
    {
        $builder->addOffsetX(12, $ratioWavelengths, 0);
    }
    ...
    {
        $builder->addOffsetX(13, $fluxRatios, 0);
    }
    ...
    {
        $builder->addOffsetX(14, $origObjectId, 0);
    }
     ...
     */
    public static function endSWIR_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSWIR_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
