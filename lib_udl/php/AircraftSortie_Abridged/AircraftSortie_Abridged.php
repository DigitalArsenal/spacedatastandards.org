...
class AircraftSortie_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AircraftSortie_Abridged
     */
    public static function getRootAsAircraftSortie_Abridged(ByteBuffer $bb)
    {
        $obj = new AircraftSortie_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AircraftSortie_AbridgedIdentifier()
    {
        return "AIRC";
    }

    public static function AircraftSortie_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AircraftSortie_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(122);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AircraftSortie_Abridged_paperStatus_Enum::PUBLISHED;
    }
    ...
    {
        $o = $this->__offset(124);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AircraftSortie_Abridged_pprStatus_Enum::NOT_REQUIRED;
    }
    ...
    {
        $o = $this->__offset(136);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AircraftSortie_Abridged_rvnReq_Enum::N;
    }
    ...
    {
        $o = $this->__offset(160);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AircraftSortie_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAircraftSortie_Abridged(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(75, $sourceDL, 0);
    }
    ...
    {
        $builder->addSbyteX(78, $dataMode, 0);
    }
     ...
     */
    public static function endAircraftSortie_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAircraftSortie_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
