...
class PersonnelRecoveryExecutionInfo_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return PersonnelRecoveryExecutionInfo_Abridged
     */
    public static function getRootAsPersonnelRecoveryExecutionInfo_Abridged(ByteBuffer $bb)
    {
        $obj = new PersonnelRecoveryExecutionInfo_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function PersonnelRecoveryExecutionInfo_AbridgedIdentifier()
    {
        return "PERS";
    }

    public static function PersonnelRecoveryExecutionInfo_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::PersonnelRecoveryExecutionInfo_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startPersonnelRecoveryExecutionInfo_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return PersonnelRecoveryExecutionInfo_Abridged
     */
    public static function createPersonnelRecoveryExecutionInfo_Abridged(FlatBufferBuilder $builder, $initialPoint, $ingress, $objStrategy, $egressPoint, $egress, $recoveryVehicle, $escortVehicle)
    {
        $builder->startObject(7);
     ...
     */
    public static function endPersonnelRecoveryExecutionInfo_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPersonnelRecoveryExecutionInfo_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
