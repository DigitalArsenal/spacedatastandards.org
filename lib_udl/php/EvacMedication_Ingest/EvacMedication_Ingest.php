...
class EvacMedication_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacMedication_Ingest
     */
    public static function getRootAsEvacMedication_Ingest(ByteBuffer $bb)
    {
        $obj = new EvacMedication_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacMedication_IngestIdentifier()
    {
        return "EVAC";
    }

    public static function EvacMedication_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacMedication_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacMedication_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return EvacMedication_Ingest
     */
    public static function createEvacMedication_Ingest(FlatBufferBuilder $builder, $type, $bodyPart, $dose, $adminRoute, $time, $comments)
    {
        $builder->startObject(6);
     ...
     */
    public static function endEvacMedication_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacMedication_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
