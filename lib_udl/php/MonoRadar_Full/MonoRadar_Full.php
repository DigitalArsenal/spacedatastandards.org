...
class MonoRadar_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MonoRadar_Full
     */
    public static function getRootAsMonoRadar_Full(ByteBuffer $bb)
    {
        $obj = new MonoRadar_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MonoRadar_FullIdentifier()
    {
        return "MONO";
    }

    public static function MonoRadar_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MonoRadar_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(142);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \MonoRadar_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startMonoRadar_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endMonoRadar_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMonoRadar_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
