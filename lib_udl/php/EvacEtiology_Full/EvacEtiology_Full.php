...
class EvacEtiology_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacEtiology_Full
     */
    public static function getRootAsEvacEtiology_Full(ByteBuffer $bb)
    {
        $obj = new EvacEtiology_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacEtiology_FullIdentifier()
    {
        return "EVAC";
    }

    public static function EvacEtiology_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacEtiology_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacEtiology_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return EvacEtiology_Full
     */
    public static function createEvacEtiology_Full(FlatBufferBuilder $builder, $type, $bodyPart, $time, $comments)
    {
        $builder->startObject(4);
     ...
     */
    public static function endEvacEtiology_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacEtiology_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
