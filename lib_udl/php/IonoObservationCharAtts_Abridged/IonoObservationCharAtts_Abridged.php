...
class IonoObservationCharAtts_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IonoObservationCharAtts_Abridged
     */
    public static function getRootAsIonoObservationCharAtts_Abridged(ByteBuffer $bb)
    {
        $obj = new IonoObservationCharAtts_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IonoObservationCharAtts_AbridgedIdentifier()
    {
        return "IONO";
    }

    public static function IonoObservationCharAtts_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IonoObservationCharAtts_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startIonoObservationCharAtts_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return IonoObservationCharAtts_Abridged
     */
    public static function createIonoObservationCharAtts_Abridged(FlatBufferBuilder $builder, $ursiID, $charName, $lowerBound, $upperBound, $q, $d, $climateModelName, $climateModelOptions, $climateModelInputParams, $uncertaintyBoundType)
    {
        $builder->startObject(10);
     ...
     */
    public static function endIonoObservationCharAtts_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIonoObservationCharAtts_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
