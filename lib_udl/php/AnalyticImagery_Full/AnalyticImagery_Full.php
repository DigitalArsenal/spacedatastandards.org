...
class AnalyticImagery_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AnalyticImagery_Full
     */
    public static function getRootAsAnalyticImagery_Full(ByteBuffer $bb)
    {
        $obj = new AnalyticImagery_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AnalyticImagery_FullIdentifier()
    {
        return "ANAL";
    }

    public static function AnalyticImagery_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AnalyticImagery_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(84);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AnalyticImagery_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAnalyticImagery_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAnalyticImagery_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAnalyticImagery_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
