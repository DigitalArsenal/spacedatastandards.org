...
class TrackRoute_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return TrackRoute_Ingest
     */
    public static function getRootAsTrackRoute_Ingest(ByteBuffer $bb)
    {
        $obj = new TrackRoute_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function TrackRoute_IngestIdentifier()
    {
        return "TRAC";
    }

    public static function TrackRoute_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::TrackRoute_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(78);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \TrackRoute_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startTrackRoute_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endTrackRoute_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishTrackRoute_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
