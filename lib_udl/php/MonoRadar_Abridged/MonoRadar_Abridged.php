...
class MonoRadar_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MonoRadar_Abridged
     */
    public static function getRootAsMonoRadar_Abridged(ByteBuffer $bb)
    {
        $obj = new MonoRadar_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MonoRadar_AbridgedIdentifier()
    {
        return "MONO";
    }

    public static function MonoRadar_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MonoRadar_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(142);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \MonoRadar_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startMonoRadar_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endMonoRadar_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMonoRadar_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
