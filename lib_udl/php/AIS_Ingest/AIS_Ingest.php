...
class AIS_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AIS_Ingest
     */
    public static function getRootAsAIS_Ingest(ByteBuffer $bb)
    {
        $obj = new AIS_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AIS_IngestIdentifier()
    {
        return "AISI";
    }

    public static function AIS_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AIS_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(102);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AIS_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAIS_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAIS_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAIS_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
