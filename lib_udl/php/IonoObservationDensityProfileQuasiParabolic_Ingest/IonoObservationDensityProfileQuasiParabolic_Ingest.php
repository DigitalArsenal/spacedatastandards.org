...
class IonoObservationDensityProfileQuasiParabolic_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IonoObservationDensityProfileQuasiParabolic_Ingest
     */
    public static function getRootAsIonoObservationDensityProfileQuasiParabolic_Ingest(ByteBuffer $bb)
    {
        $obj = new IonoObservationDensityProfileQuasiParabolic_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IonoObservationDensityProfileQuasiParabolic_IngestIdentifier()
    {
        return "IONO";
    }

    public static function IonoObservationDensityProfileQuasiParabolic_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IonoObservationDensityProfileQuasiParabolic_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startIonoObservationDensityProfileQuasiParabolic_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return IonoObservationDensityProfileQuasiParabolic_Ingest
     */
    public static function createIonoObservationDensityProfileQuasiParabolic_Ingest(FlatBufferBuilder $builder, $description, $earthRadius, $quasiParabolicSegments)
    {
        $builder->startObject(3);
     ...
     */
    public static function endIonoObservationDensityProfileQuasiParabolic_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIonoObservationDensityProfileQuasiParabolic_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
