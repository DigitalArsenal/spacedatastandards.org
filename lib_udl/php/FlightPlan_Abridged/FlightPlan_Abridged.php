...
class FlightPlan_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return FlightPlan_Abridged
     */
    public static function getRootAsFlightPlan_Abridged(ByteBuffer $bb)
    {
        $obj = new FlightPlan_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function FlightPlan_AbridgedIdentifier()
    {
        return "FLIG";
    }

    public static function FlightPlan_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::FlightPlan_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(186);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \FlightPlan_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startFlightPlan_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endFlightPlan_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishFlightPlan_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
