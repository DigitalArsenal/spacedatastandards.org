...
class AntennaDetails_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AntennaDetails_Ingest
     */
    public static function getRootAsAntennaDetails_Ingest(ByteBuffer $bb)
    {
        $obj = new AntennaDetails_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AntennaDetails_IngestIdentifier()
    {
        return "ANTE";
    }

    public static function AntennaDetails_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AntennaDetails_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(14);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AntennaDetails_Ingest_mode_Enum::TX;
    }
    ...
    {
        $o = $this->__offset(50);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AntennaDetails_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAntennaDetails_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return AntennaDetails_Ingest
     */
    public static function createAntennaDetails_Ingest(FlatBufferBuilder $builder, $id, $idAntenna, $classificationMarking, $type, $position, $mode, $steerable, $beamForming, $manufacturerOrgId, $diameter, $size, $startFrequency, $endFrequency, $beamwidth, $gain, $gainTolerance, $polarization, $description, $createdAt, $createdBy, $source, $origin, $origNetwork, $dataMode, $tags)
    {
        $builder->startObject(25);
     ...
     */
    public static function endAntennaDetails_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAntennaDetails_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
