...
class Onorbit extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Onorbit
     */
    public static function getRootAsOnorbit(ByteBuffer $bb)
    {
        $obj = new Onorbit();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OnorbitIdentifier()
    {
        return "ONOR";
    }

    public static function OnorbitBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OnorbitIdentifier());
    }
    ...
    {
        $o = $this->__offset(20);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Onorbit_objectType_Enum::ROCKET_BODY;
    }
    ...
    {
        $o = $this->__offset(26);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Onorbit_category_Enum::UNKNOWN;
    }
    ...
    {
        $o = $this->__offset(42);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Onorbit_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOnorbit(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endOnorbit(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOnorbitBuffer(FlatBufferBuilder $builder, $offset)
    {
