...
class SpaceEnvObservation_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SpaceEnvObservation_Full
     */
    public static function getRootAsSpaceEnvObservation_Full(ByteBuffer $bb)
    {
        $obj = new SpaceEnvObservation_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SpaceEnvObservation_FullIdentifier()
    {
        return "SPAC";
    }

    public static function SpaceEnvObservation_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SpaceEnvObservation_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(46);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SpaceEnvObservation_Full_senReferenceFrame_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(82);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SpaceEnvObservation_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSpaceEnvObservation_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSpaceEnvObservation_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSpaceEnvObservation_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
