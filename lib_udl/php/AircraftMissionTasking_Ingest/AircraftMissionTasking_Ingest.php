...
class AircraftMissionTasking_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AircraftMissionTasking_Ingest
     */
    public static function getRootAsAircraftMissionTasking_Ingest(ByteBuffer $bb)
    {
        $obj = new AircraftMissionTasking_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AircraftMissionTasking_IngestIdentifier()
    {
        return "AIRC";
    }

    public static function AircraftMissionTasking_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AircraftMissionTasking_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startAircraftMissionTasking_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAircraftMissionTasking_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAircraftMissionTasking_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
