...
class LaunchDetection_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LaunchDetection_Ingest
     */
    public static function getRootAsLaunchDetection_Ingest(ByteBuffer $bb)
    {
        $obj = new LaunchDetection_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LaunchDetection_IngestIdentifier()
    {
        return "LAUN";
    }

    public static function LaunchDetection_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LaunchDetection_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(48);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \LaunchDetection_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startLaunchDetection_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return LaunchDetection_Ingest
     */
    public static function createLaunchDetection_Ingest(FlatBufferBuilder $builder, $id, $classificationMarking, $launchTime, $messageType, $launchLatitude, $launchLongitude, $launchAzimuth, $raan, $inclination, $observationTime, $observationLatitude, $observationLongitude, $observationAltitude, $stereoFlag, $highZenithAzimuth, $sequenceNumber, $eventId, $source, $origin, $descriptor, $tags, $origNetwork, $dataMode, $createdAt, $createdBy, $updatedAt, $updatedBy)
    {
        $builder->startObject(27);
     ...
     */
    public static function endLaunchDetection_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLaunchDetection_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
