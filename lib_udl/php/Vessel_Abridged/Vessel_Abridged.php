...
class Vessel_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Vessel_Abridged
     */
    public static function getRootAsVessel_Abridged(ByteBuffer $bb)
    {
        $obj = new Vessel_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Vessel_AbridgedIdentifier()
    {
        return "VESS";
    }

    public static function Vessel_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Vessel_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(68);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Vessel_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startVessel_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return Vessel_Abridged
     */
    public static function createVessel_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $idEntity, $altVesselId, $idOrganization, $vesselName, $vesselType, $vesselClass, $vesselDescription, $sconum, $imon, $mmsi, $callsign, $vesselFlag, $yearBuilt, $vesselBuilder, $status, $firstSeen, $length, $width, $maxDraught, $vslWt, $maxSpeed, $sternType, $numBlades, $numShafts, $propType, $hullNum, $createdAt, $createdBy, $source, $origin, $dataMode, $origNetwork)
    {
        $builder->startObject(34);
    ...
    {
        $builder->addOffsetX(3, $altVesselId, 0);
    }
    ...
    {
        $builder->addOffsetX(4, $idOrganization, 0);
    }
    ...
    {
        $builder->addOffsetX(5, $vesselName, 0);
    }
    ...
    {
        $builder->addOffsetX(6, $vesselType, 0);
    }
    ...
    {
        $builder->addOffsetX(7, $vesselClass, 0);
    }
    ...
    {
        $builder->addOffsetX(8, $vesselDescription, 0);
    }
    ...
    {
        $builder->addOffsetX(14, $yearBuilt, 0);
    }
    ...
    {
        $builder->addOffsetX(15, $vesselBuilder, 0);
    }
    ...
    {
        $builder->addOffsetX(16, $status, 0);
    }
    ...
    {
        $builder->addOffsetX(17, $firstSeen, 0);
    }
    ...
    {
        $builder->addDoubleX(18, $length, 0.0);
    }
    ...
    {
        $builder->addDoubleX(19, $width, 0.0);
    }
    ...
    {
        $builder->addDoubleX(20, $maxDraught, 0.0);
    }
    ...
    {
        $builder->addDoubleX(21, $vslWt, 0.0);
    }
    ...
    {
        $builder->addDoubleX(22, $maxSpeed, 0.0);
    }
    ...
    {
        $builder->addOffsetX(23, $sternType, 0);
    }
    ...
    {
        $builder->addIntX(24, $numBlades, 0);
    }
    ...
    {
        $builder->addIntX(25, $numShafts, 0);
    }
    ...
    {
        $builder->addOffsetX(26, $propType, 0);
    }
    ...
    {
        $builder->addOffsetX(27, $hullNum, 0);
    }
     ...
     */
    public static function endVessel_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishVessel_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
