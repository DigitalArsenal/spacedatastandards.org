...
class MtiMission_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MtiMission_Ingest
     */
    public static function getRootAsMtiMission_Ingest(ByteBuffer $bb)
    {
        $obj = new MtiMission_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MtiMission_IngestIdentifier()
    {
        return "MTIM";
    }

    public static function MtiMission_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MtiMission_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startMtiMission_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return MtiMission_Ingest
     */
    public static function createMtiMission_Ingest(FlatBufferBuilder $builder, $m1, $m2, $m3, $m4, $msnRefTs)
    {
        $builder->startObject(5);
     ...
     */
    public static function endMtiMission_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMtiMission_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
