...
class Stage_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Stage_Full
     */
    public static function getRootAsStage_Full(ByteBuffer $bb)
    {
        $obj = new Stage_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Stage_FullIdentifier()
    {
        return "STAG";
    }

    public static function Stage_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Stage_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(86);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Stage_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startStage_Full(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(36, $updatedAt, 0);
    }
    ...
    {
        $builder->addOffsetX(37, $updatedBy, 0);
    }
    ...
    {
        $builder->addOffsetX(38, $source, 0);
    }
    ...
    {
        $builder->addOffsetX(39, $origin, 0);
    }
    ...
    {
        $builder->addOffsetX(42, $engine, 0);
    }
     ...
     */
    public static function endStage_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishStage_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
