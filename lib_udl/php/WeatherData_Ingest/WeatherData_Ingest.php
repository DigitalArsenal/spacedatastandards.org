...
class WeatherData_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return WeatherData_Ingest
     */
    public static function getRootAsWeatherData_Ingest(ByteBuffer $bb)
    {
        $obj = new WeatherData_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function WeatherData_IngestIdentifier()
    {
        return "WEAT";
    }

    public static function WeatherData_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::WeatherData_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(80);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \WeatherData_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startWeatherData_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endWeatherData_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishWeatherData_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
