...
class MtiJobRequest_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MtiJobRequest_Abridged
     */
    public static function getRootAsMtiJobRequest_Abridged(ByteBuffer $bb)
    {
        $obj = new MtiJobRequest_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MtiJobRequest_AbridgedIdentifier()
    {
        return "MTIJ";
    }

    public static function MtiJobRequest_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MtiJobRequest_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startMtiJobRequest_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return MtiJobRequest_Abridged
     */
    public static function createMtiJobRequest_Abridged(FlatBufferBuilder $builder, $r1, $r2, $r3, $r4, $r5, $r6, $r7, $r8, $r9, $r10, $r11, $r12, $r13, $r14, $jobReqEst, $r21, $r22, $r23, $r24, $r25, $r26)
    {
        $builder->startObject(21);
     ...
     */
    public static function endMtiJobRequest_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMtiJobRequest_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
