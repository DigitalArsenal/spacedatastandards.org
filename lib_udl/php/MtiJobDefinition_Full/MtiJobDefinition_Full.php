...
class MtiJobDefinition_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MtiJobDefinition_Full
     */
    public static function getRootAsMtiJobDefinition_Full(ByteBuffer $bb)
    {
        $obj = new MtiJobDefinition_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MtiJobDefinition_FullIdentifier()
    {
        return "MTIJ";
    }

    public static function MtiJobDefinition_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MtiJobDefinition_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startMtiJobDefinition_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return MtiJobDefinition_Full
     */
    public static function createMtiJobDefinition_Full(FlatBufferBuilder $builder, $j1, $j2, $j3, $j4, $j5, $j6, $j7, $j8, $j9, $j10, $j11, $j12, $j13, $j14, $j15, $j16, $j17, $j18, $j19, $j20, $j21, $j22, $j23, $j24, $j25, $j26, $j27, $j28)
    {
        $builder->startObject(28);
     ...
     */
    public static function endMtiJobDefinition_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMtiJobDefinition_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
