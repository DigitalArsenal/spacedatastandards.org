...
class EvacMedication_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacMedication_Abridged
     */
    public static function getRootAsEvacMedication_Abridged(ByteBuffer $bb)
    {
        $obj = new EvacMedication_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacMedication_AbridgedIdentifier()
    {
        return "EVAC";
    }

    public static function EvacMedication_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacMedication_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacMedication_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return EvacMedication_Abridged
     */
    public static function createEvacMedication_Abridged(FlatBufferBuilder $builder, $type, $bodyPart, $dose, $adminRoute, $time, $comments)
    {
        $builder->startObject(6);
     ...
     */
    public static function endEvacMedication_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacMedication_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
