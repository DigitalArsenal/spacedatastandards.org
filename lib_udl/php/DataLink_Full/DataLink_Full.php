...
class DataLink_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DataLink_Full
     */
    public static function getRootAsDataLink_Full(ByteBuffer $bb)
    {
        $obj = new DataLink_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DataLink_FullIdentifier()
    {
        return "DATA";
    }

    public static function DataLink_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DataLink_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(150);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \DataLink_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startDataLink_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endDataLink_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDataLink_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
