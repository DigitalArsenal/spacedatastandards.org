...
class ISRCollectionRequirements_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ISRCollectionRequirements_Full
     */
    public static function getRootAsISRCollectionRequirements_Full(ByteBuffer $bb)
    {
        $obj = new ISRCollectionRequirements_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function ISRCollectionRequirements_FullIdentifier()
    {
        return "ISRC";
    }

    public static function ISRCollectionRequirements_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::ISRCollectionRequirements_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startISRCollectionRequirements_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endISRCollectionRequirements_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishISRCollectionRequirements_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
