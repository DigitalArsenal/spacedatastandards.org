...
class RoutePoints_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return RoutePoints_Ingest
     */
    public static function getRootAsRoutePoints_Ingest(ByteBuffer $bb)
    {
        $obj = new RoutePoints_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function RoutePoints_IngestIdentifier()
    {
        return "ROUT";
    }

    public static function RoutePoints_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RoutePoints_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startRoutePoints_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return RoutePoints_Ingest
     */
    public static function createRoutePoints_Ingest(FlatBufferBuilder $builder, $ptSequenceId, $ptTypeCode, $ptTypeName, $waypointName, $dafifPt, $ptLat, $ptLon, $magDec, $navaidLength, $navaid, $countryCode, $altCountryCode, $navaidType)
    {
        $builder->startObject(13);
     ...
     */
    public static function endRoutePoints_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRoutePoints_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
