...
class AirspaceControlPoint_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirspaceControlPoint_Ingest
     */
    public static function getRootAsAirspaceControlPoint_Ingest(ByteBuffer $bb)
    {
        $obj = new AirspaceControlPoint_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirspaceControlPoint_IngestIdentifier()
    {
        return "AIRS";
    }

    public static function AirspaceControlPoint_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirspaceControlPoint_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startAirspaceControlPoint_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return AirspaceControlPoint_Ingest
     */
    public static function createAirspaceControlPoint_Ingest(FlatBufferBuilder $builder, $ctrlPtType, $ctrlPtName, $ctrlPtLocation, $ctrlPtAltitude)
    {
        $builder->startObject(4);
     ...
     */
    public static function endAirspaceControlPoint_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirspaceControlPoint_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
