...
class TrackSensor_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return TrackSensor_Ingest
     */
    public static function getRootAsTrackSensor_Ingest(ByteBuffer $bb)
    {
        $obj = new TrackSensor_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function TrackSensor_IngestIdentifier()
    {
        return "TRAC";
    }

    public static function TrackSensor_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::TrackSensor_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(16);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \TrackSensor_Ingest_sensorFOVType_Enum::BUTTERFLY;
    }
     ...
     * @return void
     */
    public static function startTrackSensor_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return TrackSensor_Ingest
     */
    public static function createTrackSensor_Ingest(FlatBufferBuilder $builder, $range, $az, $sensorNumber, $sensorName, $missionNumber, $minRangeLimit, $sensorFOVType)
    {
        $builder->startObject(7);
     ...
     */
    public static function endTrackSensor_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishTrackSensor_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
