...
class OnorbitEvent_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OnorbitEvent_Ingest
     */
    public static function getRootAsOnorbitEvent_Ingest(ByteBuffer $bb)
    {
        $obj = new OnorbitEvent_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OnorbitEvent_IngestIdentifier()
    {
        return "ONOR";
    }

    public static function OnorbitEvent_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OnorbitEvent_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(104);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OnorbitEvent_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOnorbitEvent_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endOnorbitEvent_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOnorbitEvent_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
