...
class AirTransportMission_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirTransportMission_Full
     */
    public static function getRootAsAirTransportMission_Full(ByteBuffer $bb)
    {
        $obj = new AirTransportMission_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirTransportMission_FullIdentifier()
    {
        return "AIRT";
    }

    public static function AirTransportMission_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirTransportMission_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(70);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirTransportMission_Full_dataMode_Enum::REAL;
    }
     ...
     * @return string
     */
    public function getAircraftSorties($j)
    {
        $o = $this->__offset(80);
        return $o != 0 ? $this->__string($this->__vector($o) + $j * 4) : 0;
    }
     ...
     * @return int
     */
    public function getAircraftSortiesLength()
    {
        $o = $this->__offset(80);
        return $o != 0 ? $this->__vector_len($o) : 0;
    }
     ...
     * @return void
     */
    public static function startAirTransportMission_Full(FlatBufferBuilder $builder)
    {
    ...
    public static function createAirTransportMission_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $origMissionId, $amcMissionId, $gdssMissionId, $prevMissionId, $prevAMCMissionId, $nextMissionId, $nextAMCMissionId, $objective, $purpose, $jcsPriority, $cw, $type, $firstPickUp, $lastDropOff, $alias, $callSign, $operation, $naf, $allocatedUnit, $loadCategoryType, $state, $sourceSysDeviation, $apacsId, $dipWorksheetName, $createdAt, $createdBy, $updatedAt, $updatedBy, $sourceDL, $source, $origin, $dataMode, $origNetwork, $requirements, $remarks, $hazMat, $aircraftSorties)
    {
        ...
        self::addAircraftSorties($builder, $aircraftSorties);
        $o = $builder->endObject();
        return $o;
    }
     ...
     * @return void
     */
    public static function addAircraftSorties(FlatBufferBuilder $builder, $aircraftSorties)
    {
        $builder->addOffsetX(38, $aircraftSorties, 0);
    }
     ...
     * @return int vector offset
     */
    public static function createAircraftSortiesVector(FlatBufferBuilder $builder, array $data)
    {
        $builder->startVector(4, count($data), 4);
        for ($i = count($data) - 1; $i >= 0; $i--) {
            $builder->putOffset($data[$i]);
     ...
     * @return void
     */
    public static function startAircraftSortiesVector(FlatBufferBuilder $builder, $numElems)
    {
        $builder->startVector(4, $numElems, 4);
    }
     ...
     */
    public static function endAirTransportMission_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirTransportMission_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
