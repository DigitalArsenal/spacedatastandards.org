...
class WeatherReport_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return WeatherReport_Abridged
     */
    public static function getRootAsWeatherReport_Abridged(ByteBuffer $bb)
    {
        $obj = new WeatherReport_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function WeatherReport_AbridgedIdentifier()
    {
        return "WEAT";
    }

    public static function WeatherReport_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::WeatherReport_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(172);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \WeatherReport_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startWeatherReport_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return WeatherReport_Abridged
     */
    public static function createWeatherReport_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $idSensor, $origSensorId, $weatherId, $idGroundImagery, $idSite, $idAirfield, $icao, $externalId, $externalLocationId, $reportType, $obTime, $forecastStartTime, $forecastEndTime, $lat, $lon, $alt, $geoPotentialAlt, $dataLevel, $atext, $agjson, $atype, $andims, $asrid, $windSpd, $windSpdAvg, $windGust, $windGust10, $vshear, $hshear, $radVel, $radVelBeam1, $radVelBeam2, $radVelBeam3, $radVelBeam4, $radVelBeam5, $windDir, $windDirAvg, $windDirPeak, $windDirPeak10, $windChill, $dirDev, $windVar, $windCov, $cloudCover, $cloudHght, $actWeather, $weatherDesc, $weatherInt, $rawMETAR, $rawTAF, $qnh, $visibility, $temperature, $soilTemp, $barPress, $precipRate, $rainHour, $solarRad, $difRad, $refRad, $senlat, $senlon, $senalt, $dewPoint, $relHumidity, $indexRefraction, $soilMoisture, $surroundingWeather, $weatherAmp, $contrailHghtLower, $contrailHghtUpper, $icingUpperLimit, $icingLowerLimit, $enRouteWeather, $ccEvent, $srcTyps, $srcIds, $origNetwork, $createdAt, $createdBy, $source, $origin, $dataMode)
    {
        $builder->startObject(85);
    ...
    {
        $builder->addOffsetX(21, $agjson, 0);
    }
    ...
    {
        $builder->addDoubleX(25, $windSpd, 0.0);
    }
    ...
    {
        $builder->addDoubleX(26, $windSpdAvg, 0.0);
    }
    ...
    {
        $builder->addDoubleX(27, $windGust, 0.0);
    }
    ...
    {
        $builder->addDoubleX(28, $windGust10, 0.0);
    }
    ...
    {
        $builder->addDoubleX(29, $vshear, 0.0);
    }
    ...
    {
        $builder->addDoubleX(30, $hshear, 0.0);
    }
    ...
    {
        $builder->addDoubleX(31, $radVel, 0.0);
    }
    ...
    {
        $builder->addDoubleX(32, $radVelBeam1, 0.0);
    }
    ...
    {
        $builder->addDoubleX(33, $radVelBeam2, 0.0);
    }
    ...
    {
        $builder->addDoubleX(34, $radVelBeam3, 0.0);
    }
    ...
    {
        $builder->addDoubleX(35, $radVelBeam4, 0.0);
    }
    ...
    {
        $builder->addDoubleX(36, $radVelBeam5, 0.0);
    }
    ...
    {
        $builder->addDoubleX(37, $windDir, 0.0);
    }
    ...
    {
        $builder->addDoubleX(38, $windDirAvg, 0.0);
    }
    ...
    {
        $builder->addDoubleX(39, $windDirPeak, 0.0);
    }
    ...
    {
        $builder->addDoubleX(40, $windDirPeak10, 0.0);
    }
    ...
    {
        $builder->addDoubleX(41, $windChill, 0.0);
    }
    ...
    {
        $builder->addDoubleX(42, $dirDev, 0.0);
    }
    ...
    {
        $builder->addBoolX(43, $windVar, false);
    }
    ...
    {
        $builder->addOffsetX(44, $windCov, 0);
    }
    ...
    {
        $builder->addOffsetX(45, $cloudCover, 0);
    }
    ...
    {
        $builder->addOffsetX(46, $cloudHght, 0);
    }
    ...
    {
        $builder->addOffsetX(47, $actWeather, 0);
    }
    ...
    {
        $builder->addOffsetX(48, $weatherDesc, 0);
    }
    ...
    {
        $builder->addOffsetX(49, $weatherInt, 0);
    }
    ...
    {
        $builder->addOffsetX(50, $rawMETAR, 0);
    }
    ...
    {
        $builder->addOffsetX(51, $rawTAF, 0);
    }
    ...
    {
        $builder->addDoubleX(53, $visibility, 0.0);
    }
    ...
    {
        $builder->addDoubleX(54, $temperature, 0.0);
    }
    ...
    {
        $builder->addDoubleX(55, $soilTemp, 0.0);
    }
    ...
    {
        $builder->addDoubleX(56, $barPress, 0.0);
    }
    ...
    {
        $builder->addDoubleX(57, $precipRate, 0.0);
    }
    ...
    {
        $builder->addDoubleX(58, $rainHour, 0.0);
    }
    ...
    {
        $builder->addDoubleX(59, $solarRad, 0.0);
    }
    ...
    {
        $builder->addDoubleX(60, $difRad, 0.0);
    }
    ...
    {
        $builder->addDoubleX(61, $refRad, 0.0);
    }
    ...
    {
        $builder->addDoubleX(62, $senlat, 0.0);
    }
    ...
    {
        $builder->addDoubleX(63, $senlon, 0.0);
    }
    ...
    {
        $builder->addDoubleX(64, $senalt, 0.0);
    }
    ...
    {
        $builder->addDoubleX(65, $dewPoint, 0.0);
    }
    ...
    {
        $builder->addDoubleX(66, $relHumidity, 0.0);
    }
    ...
    {
        $builder->addDoubleX(67, $indexRefraction, 0.0);
    }
    ...
    {
        $builder->addDoubleX(68, $soilMoisture, 0.0);
    }
    ...
    {
        $builder->addOffsetX(69, $surroundingWeather, 0);
    }
    ...
    {
        $builder->addOffsetX(70, $weatherAmp, 0);
    }
    ...
    {
        $builder->addDoubleX(71, $contrailHghtLower, 0.0);
    }
    ...
    {
        $builder->addDoubleX(72, $contrailHghtUpper, 0.0);
    }
    ...
    {
        $builder->addDoubleX(73, $icingUpperLimit, 0.0);
    }
    ...
    {
        $builder->addDoubleX(74, $icingLowerLimit, 0.0);
    }
    ...
    {
        $builder->addOffsetX(75, $enRouteWeather, 0);
    }
    ...
    {
        $builder->addBoolX(76, $ccEvent, false);
    }
    ...
    {
        $builder->addOffsetX(77, $srcTyps, 0);
    }
    ...
    {
        $builder->addOffsetX(78, $srcIds, 0);
    }
    ...
    {
        $builder->addOffsetX(79, $origNetwork, 0);
    }
    ...
    {
        $builder->addOffsetX(80, $createdAt, 0);
    }
    ...
    {
        $builder->addOffsetX(81, $createdBy, 0);
    }
    ...
    {
        $builder->addOffsetX(82, $source, 0);
    }
    ...
    {
        $builder->addOffsetX(83, $origin, 0);
    }
     ...
     */
    public static function endWeatherReport_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishWeatherReport_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
