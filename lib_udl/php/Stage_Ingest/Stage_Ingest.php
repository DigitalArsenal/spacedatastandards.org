...
class Stage_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Stage_Ingest
     */
    public static function getRootAsStage_Ingest(ByteBuffer $bb)
    {
        $obj = new Stage_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Stage_IngestIdentifier()
    {
        return "STAG";
    }

    public static function Stage_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Stage_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(82);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Stage_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startStage_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endStage_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishStage_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
