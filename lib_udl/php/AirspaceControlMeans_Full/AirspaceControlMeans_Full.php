...
class AirspaceControlMeans_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirspaceControlMeans_Full
     */
    public static function getRootAsAirspaceControlMeans_Full(ByteBuffer $bb)
    {
        $obj = new AirspaceControlMeans_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirspaceControlMeans_FullIdentifier()
    {
        return "AIRS";
    }

    public static function AirspaceControlMeans_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirspaceControlMeans_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(8);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirspaceControlMeans_Full_cmShape_Enum::POLYARC;
    }
     ...
     * @return void
     */
    public static function startAirspaceControlMeans_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAirspaceControlMeans_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirspaceControlMeans_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
