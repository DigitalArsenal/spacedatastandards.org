...
class EngineDetails extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EngineDetails
     */
    public static function getRootAsEngineDetails(ByteBuffer $bb)
    {
        $obj = new EngineDetails();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EngineDetailsIdentifier()
    {
        return "ENGI";
    }

    public static function EngineDetailsBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EngineDetailsIdentifier());
    }
    ...
    {
        $o = $this->__offset(52);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EngineDetails_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEngineDetails(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endEngineDetails(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEngineDetailsBuffer(FlatBufferBuilder $builder, $offset)
    {
