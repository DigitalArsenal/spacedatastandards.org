...
class DataLinkVoiceCoord_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DataLinkVoiceCoord_Abridged
     */
    public static function getRootAsDataLinkVoiceCoord_Abridged(ByteBuffer $bb)
    {
        $obj = new DataLinkVoiceCoord_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DataLinkVoiceCoord_AbridgedIdentifier()
    {
        return "DATA";
    }

    public static function DataLinkVoiceCoord_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DataLinkVoiceCoord_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startDataLinkVoiceCoord_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return DataLinkVoiceCoord_Abridged
     */
    public static function createDataLinkVoiceCoord_Abridged(FlatBufferBuilder $builder, $voiceNetDes, $freqDes, $commPri, $teleFreqNums)
    {
        $builder->startObject(4);
     ...
     */
    public static function endDataLinkVoiceCoord_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDataLinkVoiceCoord_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
