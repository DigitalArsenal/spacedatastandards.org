...
class IonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged
     */
    public static function getRootAsIonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged(ByteBuffer $bb)
    {
        $obj = new IonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IonoObservationDensityProfileTopsideExtensionChapmanConst_AbridgedIdentifier()
    {
        return "IONO";
    }

    public static function IonoObservationDensityProfileTopsideExtensionChapmanConst_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IonoObservationDensityProfileTopsideExtensionChapmanConst_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startIonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return IonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged
     */
    public static function createIonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged(FlatBufferBuilder $builder, $description, $nmF2, $hmF2, $scaleF2, $chi)
    {
        $builder->startObject(5);
     ...
     */
    public static function endIonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIonoObservationDensityProfileTopsideExtensionChapmanConst_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
