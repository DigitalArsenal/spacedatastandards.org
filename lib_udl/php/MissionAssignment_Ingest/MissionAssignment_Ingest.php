...
class MissionAssignment_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MissionAssignment_Ingest
     */
    public static function getRootAsMissionAssignment_Ingest(ByteBuffer $bb)
    {
        $obj = new MissionAssignment_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MissionAssignment_IngestIdentifier()
    {
        return "MISS";
    }

    public static function MissionAssignment_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MissionAssignment_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(132);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \MissionAssignment_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startMissionAssignment_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endMissionAssignment_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMissionAssignment_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
