...
class DiplomaticClearance_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DiplomaticClearance_Abridged
     */
    public static function getRootAsDiplomaticClearance_Abridged(ByteBuffer $bb)
    {
        $obj = new DiplomaticClearance_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DiplomaticClearance_AbridgedIdentifier()
    {
        return "DIPL";
    }

    public static function DiplomaticClearance_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DiplomaticClearance_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(40);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \DiplomaticClearance_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startDiplomaticClearance_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endDiplomaticClearance_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDiplomaticClearance_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
