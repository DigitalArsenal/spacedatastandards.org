...
class PersonnelRecovery_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return PersonnelRecovery_Full
     */
    public static function getRootAsPersonnelRecovery_Full(ByteBuffer $bb)
    {
        $obj = new PersonnelRecovery_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function PersonnelRecovery_FullIdentifier()
    {
        return "PERS";
    }

    public static function PersonnelRecovery_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::PersonnelRecovery_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(78);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \PersonnelRecovery_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startPersonnelRecovery_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endPersonnelRecovery_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPersonnelRecovery_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
