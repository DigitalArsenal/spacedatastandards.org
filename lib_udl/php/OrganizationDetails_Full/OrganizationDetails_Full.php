...
class OrganizationDetails_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OrganizationDetails_Full
     */
    public static function getRootAsOrganizationDetails_Full(ByteBuffer $bb)
    {
        $obj = new OrganizationDetails_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OrganizationDetails_FullIdentifier()
    {
        return "ORGA";
    }

    public static function OrganizationDetails_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OrganizationDetails_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(68);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OrganizationDetails_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOrganizationDetails_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endOrganizationDetails_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOrganizationDetails_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
