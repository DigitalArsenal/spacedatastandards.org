...
class MissionAssignment_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MissionAssignment_Abridged
     */
    public static function getRootAsMissionAssignment_Abridged(ByteBuffer $bb)
    {
        $obj = new MissionAssignment_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MissionAssignment_AbridgedIdentifier()
    {
        return "MISS";
    }

    public static function MissionAssignment_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MissionAssignment_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(132);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \MissionAssignment_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startMissionAssignment_Abridged(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(65, $origNetwork, 0);
    }
     ...
     */
    public static function endMissionAssignment_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMissionAssignment_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
