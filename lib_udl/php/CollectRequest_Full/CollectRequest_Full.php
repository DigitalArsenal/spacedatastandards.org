...
class CollectRequest_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return CollectRequest_Full
     */
    public static function getRootAsCollectRequest_Full(ByteBuffer $bb)
    {
        $obj = new CollectRequest_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function CollectRequest_FullIdentifier()
    {
        return "COLL";
    }

    public static function CollectRequest_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::CollectRequest_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(176);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \CollectRequest_Full_dataMode_Enum::REAL;
    }
     ...
     * @return string
     */
    public function getCollectResponse($j)
    {
        $o = $this->__offset(186);
        return $o != 0 ? $this->__string($this->__vector($o) + $j * 4) : 0;
    }
     ...
     * @return int
     */
    public function getCollectResponseLength()
    {
        $o = $this->__offset(186);
        return $o != 0 ? $this->__vector_len($o) : 0;
    }
     ...
     * @return void
     */
    public static function startCollectRequest_Full(FlatBufferBuilder $builder)
    {
    ...
    public static function createCollectRequest_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $idParentReq, $msgType, $msgCreateDate, $type, $idPlan, $planIndex, $taskId, $dwellId, $externalId, $idSensor, $origSensorId, $obType, $priority, $taskCategory, $suffix, $uctFollowUp, $startTime, $endTime, $idOnOrbit, $satNo, $origObjectId, $taskGroup, $iron, $orbitRegime, $targetSize, $rcsMin, $rcs, $rcsMax, $freqMin, $freq, $freqMax, $polarization, $visMagMin, $visMag, $visMagMax, $spectralModel, $reflectance, $irradiance, $numFrames, $frameRate, $integrationTime, $numTracks, $numObs, $duration, $srchPattern, $scenario, $idElset, $idManifold, $idStateVector, $esId, $epoch, $semiMajorAxis, $eccentricity, $inclination, $raan, $argOfPerigee, $trueAnomoly, $ra, $dec, $az, $el, $range, $extentAz, $extentEl, $extentRange, $lat, $lon, $alt, $stopLat, $stopLon, $stopAlt, $srchInc, $xAngle, $yAngle, $orientAngle, $customer, $notes, $updatedAt, $updatedBy, $createdAt, $createdBy, $source, $origin, $origNetwork, $dataMode, $stateVector, $elset, $onOrbit, $tags, $collectResponse)
    {
        ...
        self::addCollectResponse($builder, $collectResponse);
        $o = $builder->endObject();
        return $o;
    }
    ...
    {
        $builder->addOffsetX(79, $updatedAt, 0);
    }
    ...
    {
        $builder->addOffsetX(80, $updatedBy, 0);
    }
    ...
    {
        $builder->addOffsetX(85, $origNetwork, 0);
    }
    ...
    {
        $builder->addSbyteX(86, $dataMode, 0);
    }
    ...
    {
        $builder->addOffsetX(87, $stateVector, 0);
    }
    ...
    {
        $builder->addOffsetX(89, $onOrbit, 0);
    }
     ...
     * @return void
     */
    public static function addCollectResponse(FlatBufferBuilder $builder, $collectResponse)
    {
        $builder->addOffsetX(91, $collectResponse, 0);
    }
     ...
     * @return int vector offset
     */
    public static function createCollectResponseVector(FlatBufferBuilder $builder, array $data)
    {
        $builder->startVector(4, count($data), 4);
        for ($i = count($data) - 1; $i >= 0; $i--) {
            $builder->putOffset($data[$i]);
     ...
     * @return void
     */
    public static function startCollectResponseVector(FlatBufferBuilder $builder, $numElems)
    {
        $builder->startVector(4, $numElems, 4);
    }
     ...
     */
    public static function endCollectRequest_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishCollectRequest_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
