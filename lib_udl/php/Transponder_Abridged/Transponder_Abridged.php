...
class Transponder_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Transponder_Abridged
     */
    public static function getRootAsTransponder_Abridged(ByteBuffer $bb)
    {
        $obj = new Transponder_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Transponder_AbridgedIdentifier()
    {
        return "TRAN";
    }

    public static function Transponder_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Transponder_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(34);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Transponder_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startTransponder_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return Transponder_Abridged
     */
    public static function createTransponder_Abridged(FlatBufferBuilder $builder, $id, $idComm, $name, $classificationMarking, $nid, $tid, $ttf, $symbolRate, $fec, $modulation, $format, $system, $source, $origin, $origNetwork, $dataMode, $createdAt, $createdBy)
    {
        $builder->startObject(18);
     ...
     */
    public static function endTransponder_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishTransponder_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
