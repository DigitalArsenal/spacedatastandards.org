...
class SeradataOpticalPayload_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SeradataOpticalPayload_Ingest
     */
    public static function getRootAsSeradataOpticalPayload_Ingest(ByteBuffer $bb)
    {
        $obj = new SeradataOpticalPayload_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SeradataOpticalPayload_IngestIdentifier()
    {
        return "SERA";
    }

    public static function SeradataOpticalPayload_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SeradataOpticalPayload_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(54);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SeradataOpticalPayload_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSeradataOpticalPayload_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSeradataOpticalPayload_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSeradataOpticalPayload_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
