...
class DataLink_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DataLink_Ingest
     */
    public static function getRootAsDataLink_Ingest(ByteBuffer $bb)
    {
        $obj = new DataLink_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DataLink_IngestIdentifier()
    {
        return "DATA";
    }

    public static function DataLink_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DataLink_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(150);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \DataLink_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startDataLink_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endDataLink_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDataLink_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
