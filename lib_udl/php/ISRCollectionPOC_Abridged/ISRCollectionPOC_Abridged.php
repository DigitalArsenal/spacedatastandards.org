...
class ISRCollectionPOC_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ISRCollectionPOC_Abridged
     */
    public static function getRootAsISRCollectionPOC_Abridged(ByteBuffer $bb)
    {
        $obj = new ISRCollectionPOC_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function ISRCollectionPOC_AbridgedIdentifier()
    {
        return "ISRC";
    }

    public static function ISRCollectionPOC_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::ISRCollectionPOC_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startISRCollectionPOC_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return ISRCollectionPOC_Abridged
     */
    public static function createISRCollectionPOC_Abridged(FlatBufferBuilder $builder, $id, $name, $callsign, $unit, $email, $phone, $radioFrequency, $chatSystem, $chatName, $notes)
    {
        $builder->startObject(10);
     ...
     */
    public static function endISRCollectionPOC_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishISRCollectionPOC_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
