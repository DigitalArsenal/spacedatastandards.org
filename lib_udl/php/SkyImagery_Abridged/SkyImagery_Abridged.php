...
class SkyImagery_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SkyImagery_Abridged
     */
    public static function getRootAsSkyImagery_Abridged(ByteBuffer $bb)
    {
        $obj = new SkyImagery_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SkyImagery_AbridgedIdentifier()
    {
        return "SKYI";
    }

    public static function SkyImagery_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SkyImagery_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(96);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SkyImagery_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSkyImagery_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return SkyImagery_Abridged
     */
    public static function createSkyImagery_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $idOnOrbit, $origObjectId, $idAttitudeSet, $idSensor, $satNo, $origSensorId, $senlat, $senlon, $senalt, $senx, $seny, $senz, $senQuat, $senQuatDot, $imageType, $expStartTime, $expEndTime, $imageSourceInfo, $topLeftStartAz, $topLeftStartEl, $topLeftStopAz, $topLeftStopEl, $imageSetId, $imageSetLength, $sequenceId, $frameFOVWidth, $frameFOVHeight, $pixelFOVWidth, $pixelFOVHeight, $frameWidthPixels, $frameHeightPixels, $pixelBitDepth, $annotationKey, $calibrationKey, $filename, $filesize, $checksumValue, $transactionId, $tags, $source, $origin, $origNetwork, $sourceDL, $description, $dataMode, $createdAt, $createdBy)
    {
        $builder->startObject(49);
    ...
    {
        $builder->addOffsetX(4, $idAttitudeSet, 0);
    }
    ...
    {
        $builder->addDoubleX(8, $senlat, 0.0);
    }
    ...
    {
        $builder->addDoubleX(9, $senlon, 0.0);
    }
    ...
    {
        $builder->addDoubleX(10, $senalt, 0.0);
    }
    ...
    {
        $builder->addDoubleX(11, $senx, 0.0);
    }
    ...
    {
        $builder->addDoubleX(12, $seny, 0.0);
    }
    ...
    {
        $builder->addDoubleX(13, $senz, 0.0);
    }
    ...
    {
        $builder->addOffsetX(14, $senQuat, 0);
    }
    ...
    {
        $builder->addOffsetX(15, $senQuatDot, 0);
    }
    ...
    {
        $builder->addOffsetX(16, $imageType, 0);
    }
    ...
    {
        $builder->addOffsetX(17, $expStartTime, 0);
    }
    ...
    {
        $builder->addOffsetX(18, $expEndTime, 0);
    }
    ...
    {
        $builder->addOffsetX(19, $imageSourceInfo, 0);
    }
    ...
    {
        $builder->addDoubleX(20, $topLeftStartAz, 0.0);
    }
    ...
    {
        $builder->addDoubleX(21, $topLeftStartEl, 0.0);
    }
    ...
    {
        $builder->addDoubleX(22, $topLeftStopAz, 0.0);
    }
    ...
    {
        $builder->addDoubleX(23, $topLeftStopEl, 0.0);
    }
    ...
    {
        $builder->addOffsetX(24, $imageSetId, 0);
    }
    ...
    {
        $builder->addIntX(25, $imageSetLength, 0);
    }
    ...
    {
        $builder->addIntX(26, $sequenceId, 0);
    }
    ...
    {
        $builder->addDoubleX(27, $frameFOVWidth, 0.0);
    }
    ...
    {
        $builder->addDoubleX(28, $frameFOVHeight, 0.0);
    }
    ...
    {
        $builder->addDoubleX(29, $pixelFOVWidth, 0.0);
    }
    ...
    {
        $builder->addDoubleX(30, $pixelFOVHeight, 0.0);
    }
    ...
    {
        $builder->addIntX(31, $frameWidthPixels, 0);
    }
    ...
    {
        $builder->addIntX(32, $frameHeightPixels, 0);
    }
    ...
    {
        $builder->addIntX(33, $pixelBitDepth, 0);
    }
    ...
    {
        $builder->addOffsetX(34, $annotationKey, 0);
    }
    ...
    {
        $builder->addOffsetX(35, $calibrationKey, 0);
    }
    ...
    {
        $builder->addOffsetX(36, $filename, 0);
    }
    ...
    {
        $builder->addLongX(37, $filesize, 0);
    }
    ...
    {
        $builder->addOffsetX(38, $checksumValue, 0);
    }
    ...
    {
        $builder->addOffsetX(39, $transactionId, 0);
    }
    ...
    {
        $builder->addOffsetX(44, $sourceDL, 0);
    }
    ...
    {
        $builder->addOffsetX(45, $description, 0);
    }
    ...
    {
        $builder->addSbyteX(46, $dataMode, 0);
    }
    ...
    {
        $builder->addOffsetX(47, $createdAt, 0);
    }
    ...
    {
        $builder->addOffsetX(48, $createdBy, 0);
    }
     ...
     */
    public static function endSkyImagery_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSkyImagery_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
