...
class ItemTracking_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ItemTracking_Abridged
     */
    public static function getRootAsItemTracking_Abridged(ByteBuffer $bb)
    {
        $obj = new ItemTracking_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function ItemTracking_AbridgedIdentifier()
    {
        return "ITEM";
    }

    public static function ItemTracking_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::ItemTracking_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(46);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \ItemTracking_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startItemTracking_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return ItemTracking_Abridged
     */
    public static function createItemTracking_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $scanCode, $scGenTool, $scannerId, $ts, $idItem, $type, $lat, $lon, $scanType, $dvCode, $notes, $keys, $values, $createdAt, $createdBy, $sourceDL, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(22);
     ...
     */
    public static function endItemTracking_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishItemTracking_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
