...
class OrbitDetermination_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OrbitDetermination_Full
     */
    public static function getRootAsOrbitDetermination_Full(ByteBuffer $bb)
    {
        $obj = new OrbitDetermination_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OrbitDetermination_FullIdentifier()
    {
        return "ORBI";
    }

    public static function OrbitDetermination_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OrbitDetermination_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(90);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OrbitDetermination_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOrbitDetermination_Full(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(44, $onOrbit, 0);
    }
     ...
     */
    public static function endOrbitDetermination_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOrbitDetermination_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
