...
class Equipment_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Equipment_Ingest
     */
    public static function getRootAsEquipment_Ingest(ByteBuffer $bb)
    {
        $obj = new Equipment_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Equipment_IngestIdentifier()
    {
        return "EQUI";
    }

    public static function Equipment_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Equipment_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(108);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Equipment_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEquipment_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endEquipment_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEquipment_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
