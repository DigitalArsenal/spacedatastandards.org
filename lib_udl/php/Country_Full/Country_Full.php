...
class Country_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Country_Full
     */
    public static function getRootAsCountry_Full(ByteBuffer $bb)
    {
        $obj = new Country_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Country_FullIdentifier()
    {
        return "COUN";
    }

    public static function Country_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Country_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(26);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Country_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startCountry_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return Country_Full
     */
    public static function createCountry_Full(FlatBufferBuilder $builder, $code, $name, $fipsCode, $iso3Code, $codeAlt, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origNetwork, $dataMode)
    {
        $builder->startObject(12);
     ...
     */
    public static function endCountry_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishCountry_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
