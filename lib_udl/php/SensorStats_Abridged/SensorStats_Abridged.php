...
class SensorStats_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SensorStats_Abridged
     */
    public static function getRootAsSensorStats_Abridged(ByteBuffer $bb)
    {
        $obj = new SensorStats_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SensorStats_AbridgedIdentifier()
    {
        return "SENS";
    }

    public static function SensorStats_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SensorStats_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(22);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SensorStats_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSensorStats_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return SensorStats_Abridged
     */
    public static function createSensorStats_Abridged(FlatBufferBuilder $builder, $id, $idSensor, $classificationMarking, $lastObTime, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $dataMode)
    {
        $builder->startObject(10);
     ...
     */
    public static function endSensorStats_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSensorStats_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
