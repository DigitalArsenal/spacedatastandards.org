...
class TrackDetails_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return TrackDetails_Full
     */
    public static function getRootAsTrackDetails_Full(ByteBuffer $bb)
    {
        $obj = new TrackDetails_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function TrackDetails_FullIdentifier()
    {
        return "TRAC";
    }

    public static function TrackDetails_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::TrackDetails_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(8);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \TrackDetails_Full_env_Enum::AIR;
    }
    ...
    {
        $o = $this->__offset(50);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \TrackDetails_Full_objIdent_Enum::ASSUMED_FRIEND;
    }
    ...
    {
        $o = $this->__offset(316);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \TrackDetails_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startTrackDetails_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endTrackDetails_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishTrackDetails_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
