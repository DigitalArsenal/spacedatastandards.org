...
class TrackDetails_Full_env_Enum
{
    ...
    private static $names = array(
        TrackDetails_Full_env_Enum::AIR=>"AIR",
        TrackDetails_Full_env_Enum::LAND=>"LAND",
        TrackDetails_Full_env_Enum::SPACE=>"SPACE",
        TrackDetails_Full_env_Enum::SURFACE=>"SURFACE",
        TrackDetails_Full_env_Enum::SUBSURFACE=>"SUBSURFACE",
        TrackDetails_Full_env_Enum::UNKNOWN=>"UNKNOWN",
    );
