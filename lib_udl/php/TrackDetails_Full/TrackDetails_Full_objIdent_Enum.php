...
class TrackDetails_Full_objIdent_Enum
{
    ...
    private static $names = array(
        TrackDetails_Full_objIdent_Enum::ASSUMED_FRIEND=>"ASSUMED_FRIEND",
        TrackDetails_Full_objIdent_Enum::FRIEND=>"FRIEND",
        TrackDetails_Full_objIdent_Enum::HOSTILE=>"HOSTILE",
        TrackDetails_Full_objIdent_Enum::NEUTRAL=>"NEUTRAL",
        TrackDetails_Full_objIdent_Enum::PENDING=>"PENDING",
        TrackDetails_Full_objIdent_Enum::SUSPECT=>"SUSPECT",
        TrackDetails_Full_objIdent_Enum::UNKNOWN=>"UNKNOWN",
    );
