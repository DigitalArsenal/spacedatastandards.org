...
class AirspaceControlMeans_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirspaceControlMeans_Ingest
     */
    public static function getRootAsAirspaceControlMeans_Ingest(ByteBuffer $bb)
    {
        $obj = new AirspaceControlMeans_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirspaceControlMeans_IngestIdentifier()
    {
        return "AIRS";
    }

    public static function AirspaceControlMeans_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirspaceControlMeans_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(8);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirspaceControlMeans_Ingest_cmShape_Enum::POLYARC;
    }
     ...
     * @return void
     */
    public static function startAirspaceControlMeans_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAirspaceControlMeans_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirspaceControlMeans_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
