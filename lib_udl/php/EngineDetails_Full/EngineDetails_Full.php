...
class EngineDetails_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EngineDetails_Full
     */
    public static function getRootAsEngineDetails_Full(ByteBuffer $bb)
    {
        $obj = new EngineDetails_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EngineDetails_FullIdentifier()
    {
        return "ENGI";
    }

    public static function EngineDetails_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EngineDetails_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(52);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EngineDetails_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEngineDetails_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return EngineDetails_Full
     */
    public static function createEngineDetails_Full(FlatBufferBuilder $builder, $id, $idEngine, $classificationMarking, $family, $cycleType, $characteristicType, $manufacturerOrgId, $specificImpulse, $burnTime, $seaLevelThrust, $vacuumThrust, $chamberPressure, $nozzleExpansionRatio, $maxFirings, $propellant, $oxidizer, $notes, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $origNetwork, $dataMode, $tags)
    {
        $builder->startObject(26);
     ...
     */
    public static function endEngineDetails_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEngineDetails_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
