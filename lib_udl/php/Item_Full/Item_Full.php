...
class Item_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Item_Full
     */
    public static function getRootAsItem_Full(ByteBuffer $bb)
    {
        $obj = new Item_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Item_FullIdentifier()
    {
        return "ITEM";
    }

    public static function Item_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Item_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(108);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Item_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startItem_Full(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(46, $updatedAt, 0);
    }
    ...
    {
        $builder->addOffsetX(47, $updatedBy, 0);
    }
    ...
    {
        $builder->addOffsetX(48, $sourceDL, 0);
    }
     ...
     */
    public static function endItem_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishItem_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
