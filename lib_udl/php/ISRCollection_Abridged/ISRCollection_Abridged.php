...
/// /// ISR Collection data.
class ISRCollection_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ISRCollection_Abridged
     */
    public static function getRootAsISRCollection_Abridged(ByteBuffer $bb)
    {
        $obj = new ISRCollection_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function ISRCollection_AbridgedIdentifier()
    {
        return "ISRC";
    }

    public static function ISRCollection_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::ISRCollection_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(68);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \ISRCollection_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startISRCollection_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endISRCollection_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishISRCollection_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
