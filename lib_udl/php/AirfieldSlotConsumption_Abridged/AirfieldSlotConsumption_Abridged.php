...
class AirfieldSlotConsumption_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirfieldSlotConsumption_Abridged
     */
    public static function getRootAsAirfieldSlotConsumption_Abridged(ByteBuffer $bb)
    {
        $obj = new AirfieldSlotConsumption_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirfieldSlotConsumption_AbridgedIdentifier()
    {
        return "AIRF";
    }

    public static function AirfieldSlotConsumption_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirfieldSlotConsumption_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(10);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirfieldSlotConsumption_Abridged_status_Enum::REQUESTED;
    }
    ...
    {
        $o = $this->__offset(76);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirfieldSlotConsumption_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAirfieldSlotConsumption_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAirfieldSlotConsumption_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirfieldSlotConsumption_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
