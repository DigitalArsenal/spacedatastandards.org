...
class OnorbitEvent_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OnorbitEvent_Abridged
     */
    public static function getRootAsOnorbitEvent_Abridged(ByteBuffer $bb)
    {
        $obj = new OnorbitEvent_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OnorbitEvent_AbridgedIdentifier()
    {
        return "ONOR";
    }

    public static function OnorbitEvent_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OnorbitEvent_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(104);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OnorbitEvent_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOnorbitEvent_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endOnorbitEvent_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOnorbitEvent_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
