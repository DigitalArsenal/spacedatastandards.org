...
class Bus_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Bus_Ingest
     */
    public static function getRootAsBus_Ingest(ByteBuffer $bb)
    {
        $obj = new Bus_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Bus_IngestIdentifier()
    {
        return "BUSI";
    }

    public static function Bus_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Bus_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(110);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Bus_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startBus_Ingest(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(56, $entity, 0);
    }
     ...
     */
    public static function endBus_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishBus_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
