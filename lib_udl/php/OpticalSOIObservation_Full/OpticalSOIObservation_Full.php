...
class OpticalSOIObservation_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OpticalSOIObservation_Full
     */
    public static function getRootAsOpticalSOIObservation_Full(ByteBuffer $bb)
    {
        $obj = new OpticalSOIObservation_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OpticalSOIObservation_FullIdentifier()
    {
        return "OPTI";
    }

    public static function OpticalSOIObservation_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OpticalSOIObservation_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startOpticalSOIObservation_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endOpticalSOIObservation_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOpticalSOIObservation_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
