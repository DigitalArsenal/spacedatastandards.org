...
class RadarSOIObservation_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return RadarSOIObservation_Full
     */
    public static function getRootAsRadarSOIObservation_Full(ByteBuffer $bb)
    {
        $obj = new RadarSOIObservation_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function RadarSOIObservation_FullIdentifier()
    {
        return "RADA";
    }

    public static function RadarSOIObservation_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RadarSOIObservation_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startRadarSOIObservation_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endRadarSOIObservation_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRadarSOIObservation_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
