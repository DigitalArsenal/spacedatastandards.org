...
class CollectRequest_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return CollectRequest_Abridged
     */
    public static function getRootAsCollectRequest_Abridged(ByteBuffer $bb)
    {
        $obj = new CollectRequest_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function CollectRequest_AbridgedIdentifier()
    {
        return "COLL";
    }

    public static function CollectRequest_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::CollectRequest_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(172);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \CollectRequest_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startCollectRequest_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endCollectRequest_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishCollectRequest_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
