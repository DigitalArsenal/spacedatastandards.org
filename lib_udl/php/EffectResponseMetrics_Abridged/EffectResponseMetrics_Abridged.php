...
class EffectResponseMetrics_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EffectResponseMetrics_Abridged
     */
    public static function getRootAsEffectResponseMetrics_Abridged(ByteBuffer $bb)
    {
        $obj = new EffectResponseMetrics_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EffectResponseMetrics_AbridgedIdentifier()
    {
        return "EFFE";
    }

    public static function EffectResponseMetrics_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EffectResponseMetrics_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startEffectResponseMetrics_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return EffectResponseMetrics_Abridged
     */
    public static function createEffectResponseMetrics_Abridged(FlatBufferBuilder $builder, $metricType, $domainValue, $relativeValue, $provenance)
    {
        $builder->startObject(4);
     ...
     */
    public static function endEffectResponseMetrics_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEffectResponseMetrics_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
