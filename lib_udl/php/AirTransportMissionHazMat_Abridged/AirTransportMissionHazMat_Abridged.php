...
class AirTransportMissionHazMat_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirTransportMissionHazMat_Abridged
     */
    public static function getRootAsAirTransportMissionHazMat_Abridged(ByteBuffer $bb)
    {
        $obj = new AirTransportMissionHazMat_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirTransportMissionHazMat_AbridgedIdentifier()
    {
        return "AIRT";
    }

    public static function AirTransportMissionHazMat_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirTransportMissionHazMat_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startAirTransportMissionHazMat_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return AirTransportMissionHazMat_Abridged
     */
    public static function createAirTransportMissionHazMat_Abridged(FlatBufferBuilder $builder, $extHazMatId, $itemName, $unNum, $pieces, $weight, $netExpWt, $classDiv, $cgc, $cgn, $applicableNotes, $onItin, $onICAO, $offItin, $offICAO, $planned)
    {
        $builder->startObject(15);
     ...
     */
    public static function endAirTransportMissionHazMat_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirTransportMissionHazMat_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
