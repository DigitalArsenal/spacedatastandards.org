...
class LogisticsSupportItems_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LogisticsSupportItems_Full
     */
    public static function getRootAsLogisticsSupportItems_Full(ByteBuffer $bb)
    {
        $obj = new LogisticsSupportItems_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LogisticsSupportItems_FullIdentifier()
    {
        return "LOGI";
    }

    public static function LogisticsSupportItems_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LogisticsSupportItems_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startLogisticsSupportItems_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endLogisticsSupportItems_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLogisticsSupportItems_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
