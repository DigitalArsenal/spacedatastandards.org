...
class DataLinkReferences_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DataLinkReferences_Abridged
     */
    public static function getRootAsDataLinkReferences_Abridged(ByteBuffer $bb)
    {
        $obj = new DataLinkReferences_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DataLinkReferences_AbridgedIdentifier()
    {
        return "DATA";
    }

    public static function DataLinkReferences_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DataLinkReferences_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startDataLinkReferences_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return DataLinkReferences_Abridged
     */
    public static function createDataLinkReferences_Abridged(FlatBufferBuilder $builder, $refSerialId, $refType, $refOriginator, $refTs, $refSerialNum, $refSpecialNotation, $refSICs)
    {
        $builder->startObject(7);
     ...
     */
    public static function endDataLinkReferences_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDataLinkReferences_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
