...
class NavalFlightOperations_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return NavalFlightOperations_Ingest
     */
    public static function getRootAsNavalFlightOperations_Ingest(ByteBuffer $bb)
    {
        $obj = new NavalFlightOperations_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function NavalFlightOperations_IngestIdentifier()
    {
        return "NAVA";
    }

    public static function NavalFlightOperations_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::NavalFlightOperations_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startNavalFlightOperations_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return NavalFlightOperations_Ingest
     */
    public static function createNavalFlightOperations_Ingest(FlatBufferBuilder $builder, $shipName, $fltOpStart, $fltOpStop, $schdLaunchRcvyTime)
    {
        $builder->startObject(4);
     ...
     */
    public static function endNavalFlightOperations_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishNavalFlightOperations_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
