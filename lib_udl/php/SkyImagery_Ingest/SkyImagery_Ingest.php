...
class SkyImagery_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SkyImagery_Ingest
     */
    public static function getRootAsSkyImagery_Ingest(ByteBuffer $bb)
    {
        $obj = new SkyImagery_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SkyImagery_IngestIdentifier()
    {
        return "SKYI";
    }

    public static function SkyImagery_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SkyImagery_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(96);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SkyImagery_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSkyImagery_Ingest(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(49, $eoObservations, 0);
    }
     ...
     */
    public static function endSkyImagery_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSkyImagery_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
