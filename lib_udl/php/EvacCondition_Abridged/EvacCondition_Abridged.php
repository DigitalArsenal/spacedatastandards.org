...
class EvacCondition_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacCondition_Abridged
     */
    public static function getRootAsEvacCondition_Abridged(ByteBuffer $bb)
    {
        $obj = new EvacCondition_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacCondition_AbridgedIdentifier()
    {
        return "EVAC";
    }

    public static function EvacCondition_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacCondition_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacCondition_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return EvacCondition_Abridged
     */
    public static function createEvacCondition_Abridged(FlatBufferBuilder $builder, $type, $bodyPart, $time, $comments)
    {
        $builder->startObject(4);
     ...
     */
    public static function endEvacCondition_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacCondition_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
