...
class EOObservationDetails_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EOObservationDetails_Ingest
     */
    public static function getRootAsEOObservationDetails_Ingest(ByteBuffer $bb)
    {
        $obj = new EOObservationDetails_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EOObservationDetails_IngestIdentifier()
    {
        return "EOOB";
    }

    public static function EOObservationDetails_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EOObservationDetails_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(164);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EOObservationDetails_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEOObservationDetails_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endEOObservationDetails_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEOObservationDetails_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
