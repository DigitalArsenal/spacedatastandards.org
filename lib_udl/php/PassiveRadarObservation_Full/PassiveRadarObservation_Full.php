...
class PassiveRadarObservation_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return PassiveRadarObservation_Full
     */
    public static function getRootAsPassiveRadarObservation_Full(ByteBuffer $bb)
    {
        $obj = new PassiveRadarObservation_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function PassiveRadarObservation_FullIdentifier()
    {
        return "PASS";
    }

    public static function PassiveRadarObservation_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::PassiveRadarObservation_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(134);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \PassiveRadarObservation_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startPassiveRadarObservation_Full(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(66, $onOrbit, 0);
    }
     ...
     */
    public static function endPassiveRadarObservation_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPassiveRadarObservation_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
