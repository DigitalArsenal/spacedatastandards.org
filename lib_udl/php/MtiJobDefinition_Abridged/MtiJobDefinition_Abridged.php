...
class MtiJobDefinition_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MtiJobDefinition_Abridged
     */
    public static function getRootAsMtiJobDefinition_Abridged(ByteBuffer $bb)
    {
        $obj = new MtiJobDefinition_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MtiJobDefinition_AbridgedIdentifier()
    {
        return "MTIJ";
    }

    public static function MtiJobDefinition_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MtiJobDefinition_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startMtiJobDefinition_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return MtiJobDefinition_Abridged
     */
    public static function createMtiJobDefinition_Abridged(FlatBufferBuilder $builder, $j2, $j3, $j4, $j5, $j6, $j7, $j8, $j9, $j10, $j11, $j12, $j13, $j14, $j15, $j16, $j17, $j18, $j19, $j20, $j21, $j22, $j23, $j24, $j25, $j26, $j27, $j28)
    {
        $builder->startObject(27);
     ...
     */
    public static function endMtiJobDefinition_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMtiJobDefinition_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
