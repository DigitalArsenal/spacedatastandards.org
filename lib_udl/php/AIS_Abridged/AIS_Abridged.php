...
class AIS_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AIS_Abridged
     */
    public static function getRootAsAIS_Abridged(ByteBuffer $bb)
    {
        $obj = new AIS_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AIS_AbridgedIdentifier()
    {
        return "AISA";
    }

    public static function AIS_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AIS_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(102);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AIS_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAIS_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAIS_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAIS_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
