...
class GenText_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GenText_Full
     */
    public static function getRootAsGenText_Full(ByteBuffer $bb)
    {
        $obj = new GenText_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function GenText_FullIdentifier()
    {
        return "GENT";
    }

    public static function GenText_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::GenText_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startGenText_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return GenText_Full
     */
    public static function createGenText_Full(FlatBufferBuilder $builder, $textInd, $text)
    {
        $builder->startObject(2);
     ...
     */
    public static function endGenText_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishGenText_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
