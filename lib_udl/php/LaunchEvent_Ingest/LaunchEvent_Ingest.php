...
class LaunchEvent_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LaunchEvent_Ingest
     */
    public static function getRootAsLaunchEvent_Ingest(ByteBuffer $bb)
    {
        $obj = new LaunchEvent_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LaunchEvent_IngestIdentifier()
    {
        return "LAUN";
    }

    public static function LaunchEvent_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LaunchEvent_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(38);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \LaunchEvent_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startLaunchEvent_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endLaunchEvent_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLaunchEvent_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
