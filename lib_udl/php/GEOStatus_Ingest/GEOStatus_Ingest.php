...
class GEOStatus_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GEOStatus_Ingest
     */
    public static function getRootAsGEOStatus_Ingest(ByteBuffer $bb)
    {
        $obj = new GEOStatus_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function GEOStatus_IngestIdentifier()
    {
        return "GEOS";
    }

    public static function GEOStatus_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::GEOStatus_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(46);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \GEOStatus_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startGEOStatus_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endGEOStatus_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishGEOStatus_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
