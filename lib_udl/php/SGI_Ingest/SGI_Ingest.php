...
class SGI_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SGI_Ingest
     */
    public static function getRootAsSGI_Ingest(ByteBuffer $bb)
    {
        $obj = new SGI_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SGI_IngestIdentifier()
    {
        return "SGII";
    }

    public static function SGI_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SGI_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(14);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SGI_Ingest_state_Enum::I;
    }
    ...
    {
        $o = $this->__offset(24);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SGI_Ingest_precedence_Enum::O;
    }
    ...
    {
        $o = $this->__offset(104);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SGI_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSGI_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSGI_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSGI_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
