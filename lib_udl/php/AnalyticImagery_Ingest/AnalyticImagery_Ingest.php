...
class AnalyticImagery_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AnalyticImagery_Ingest
     */
    public static function getRootAsAnalyticImagery_Ingest(ByteBuffer $bb)
    {
        $obj = new AnalyticImagery_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AnalyticImagery_IngestIdentifier()
    {
        return "ANAL";
    }

    public static function AnalyticImagery_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AnalyticImagery_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(84);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AnalyticImagery_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAnalyticImagery_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return AnalyticImagery_Ingest
     */
    public static function createAnalyticImagery_Ingest(FlatBufferBuilder $builder, $id, $classificationMarking, $content, $msgTime, $imageType, $filename, $filesize, $imgWidth, $imgHeight, $xUnits, $yUnits, $zUnits, $imageSetId, $imageSetLength, $sequenceId, $description, $dataStart, $dataStop, $annLims, $annText, $keywords, $area, $atext, $agjson, $atype, $andims, $asrid, $satId, $satIdConf, $srcTyps, $srcIds, $tags, $checksumValue, $transactionId, $createdAt, $createdBy, $source, $origin, $origNetwork, $sourceDL, $dataMode)
    {
        $builder->startObject(41);
    ...
    {
        $builder->addOffsetX(23, $agjson, 0);
    }
    ...
    {
        $builder->addOffsetX(28, $satIdConf, 0);
    }
    ...
    {
        $builder->addOffsetX(29, $srcTyps, 0);
    }
    ...
    {
        $builder->addOffsetX(30, $srcIds, 0);
    }
    ...
    {
        $builder->addOffsetX(32, $checksumValue, 0);
    }
    ...
    {
        $builder->addOffsetX(33, $transactionId, 0);
    }
     ...
     */
    public static function endAnalyticImagery_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAnalyticImagery_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
