...
class PersonnelRecovery_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return PersonnelRecovery_Ingest
     */
    public static function getRootAsPersonnelRecovery_Ingest(ByteBuffer $bb)
    {
        $obj = new PersonnelRecovery_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function PersonnelRecovery_IngestIdentifier()
    {
        return "PERS";
    }

    public static function PersonnelRecovery_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::PersonnelRecovery_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(78);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \PersonnelRecovery_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startPersonnelRecovery_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endPersonnelRecovery_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPersonnelRecovery_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
