...
class SortiePPR_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SortiePPR_Full
     */
    public static function getRootAsSortiePPR_Full(ByteBuffer $bb)
    {
        $obj = new SortiePPR_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SortiePPR_FullIdentifier()
    {
        return "SORT";
    }

    public static function SortiePPR_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SortiePPR_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(22);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SortiePPR_Full_type_Enum::M;
    }
    ...
    {
        $o = $this->__offset(42);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SortiePPR_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSortiePPR_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return SortiePPR_Full
     */
    public static function createSortiePPR_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $idSortie, $externalId, $number, $startTime, $endTime, $requestor, $grantor, $type, $remarks, $createdAt, $createdBy, $updatedAt, $updatedBy, $sourceDL, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(20);
        ...
        self::addGrantor($builder, $grantor);
    ...
    {
        $builder->addOffsetX(2, $idSortie, 0);
    }
    ...
    {
        $builder->addOffsetX(7, $requestor, 0);
    }
     ...
     * @return void
     */
    public static function addGrantor(FlatBufferBuilder $builder, $grantor)
    {
        $builder->addOffsetX(8, $grantor, 0);
    }
    ...
    {
        $builder->addOffsetX(10, $remarks, 0);
    }
    ...
    {
        $builder->addOffsetX(11, $createdAt, 0);
    }
    ...
    {
        $builder->addOffsetX(12, $createdBy, 0);
    }
    ...
    {
        $builder->addOffsetX(13, $updatedAt, 0);
    }
    ...
    {
        $builder->addOffsetX(14, $updatedBy, 0);
    }
    ...
    {
        $builder->addOffsetX(15, $sourceDL, 0);
    }
     ...
     */
    public static function endSortiePPR_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSortiePPR_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
