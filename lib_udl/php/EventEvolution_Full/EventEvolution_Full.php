...
class EventEvolution_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EventEvolution_Full
     */
    public static function getRootAsEventEvolution_Full(ByteBuffer $bb)
    {
        $obj = new EventEvolution_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EventEvolution_FullIdentifier()
    {
        return "EVEN";
    }

    public static function EventEvolution_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EventEvolution_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(62);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EventEvolution_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEventEvolution_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endEventEvolution_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEventEvolution_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
