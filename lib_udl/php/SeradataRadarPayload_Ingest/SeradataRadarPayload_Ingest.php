...
class SeradataRadarPayload_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SeradataRadarPayload_Ingest
     */
    public static function getRootAsSeradataRadarPayload_Ingest(ByteBuffer $bb)
    {
        $obj = new SeradataRadarPayload_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SeradataRadarPayload_IngestIdentifier()
    {
        return "SERA";
    }

    public static function SeradataRadarPayload_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SeradataRadarPayload_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(66);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SeradataRadarPayload_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSeradataRadarPayload_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSeradataRadarPayload_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSeradataRadarPayload_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
