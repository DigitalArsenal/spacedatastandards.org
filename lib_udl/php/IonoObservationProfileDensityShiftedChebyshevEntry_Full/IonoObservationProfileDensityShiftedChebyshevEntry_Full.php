...
class IonoObservationProfileDensityShiftedChebyshevEntry_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IonoObservationProfileDensityShiftedChebyshevEntry_Full
     */
    public static function getRootAsIonoObservationProfileDensityShiftedChebyshevEntry_Full(ByteBuffer $bb)
    {
        $obj = new IonoObservationProfileDensityShiftedChebyshevEntry_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IonoObservationProfileDensityShiftedChebyshevEntry_FullIdentifier()
    {
        return "IONO";
    }

    public static function IonoObservationProfileDensityShiftedChebyshevEntry_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IonoObservationProfileDensityShiftedChebyshevEntry_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startIonoObservationProfileDensityShiftedChebyshevEntry_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return IonoObservationProfileDensityShiftedChebyshevEntry_Full
     */
    public static function createIonoObservationProfileDensityShiftedChebyshevEntry_Full(FlatBufferBuilder $builder, $layer, $fstart, $fstop, $peakheight, $zhalfNm, $n, $coeffs, $error)
    {
        $builder->startObject(8);
     ...
     */
    public static function endIonoObservationProfileDensityShiftedChebyshevEntry_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIonoObservationProfileDensityShiftedChebyshevEntry_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
