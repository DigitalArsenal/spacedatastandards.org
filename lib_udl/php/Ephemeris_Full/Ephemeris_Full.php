...
class Ephemeris_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Ephemeris_Full
     */
    public static function getRootAsEphemeris_Full(ByteBuffer $bb)
    {
        $obj = new Ephemeris_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Ephemeris_FullIdentifier()
    {
        return "EPHE";
    }

    public static function Ephemeris_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Ephemeris_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(38);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Ephemeris_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEphemeris_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return Ephemeris_Full
     */
    public static function createEphemeris_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $esId, $ts, $xpos, $ypos, $zpos, $xvel, $yvel, $zvel, $xaccel, $yaccel, $zaccel, $cov, $createdAt, $createdBy, $source, $dataMode, $idOnOrbit, $origObjectId, $origin)
    {
        $builder->startObject(21);
     ...
     */
    public static function endEphemeris_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEphemeris_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
