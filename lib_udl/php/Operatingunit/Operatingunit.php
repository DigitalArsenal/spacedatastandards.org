...
class Operatingunit extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Operatingunit
     */
    public static function getRootAsOperatingunit(ByteBuffer $bb)
    {
        $obj = new Operatingunit();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OperatingunitIdentifier()
    {
        return "OPER";
    }

    public static function OperatingunitBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OperatingunitIdentifier());
    }
    ...
    {
        $o = $this->__offset(128);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Operatingunit_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOperatingunit(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endOperatingunit(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOperatingunitBuffer(FlatBufferBuilder $builder, $offset)
    {
