...
class FlightPlan_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return FlightPlan_Full
     */
    public static function getRootAsFlightPlan_Full(ByteBuffer $bb)
    {
        $obj = new FlightPlan_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function FlightPlan_FullIdentifier()
    {
        return "FLIG";
    }

    public static function FlightPlan_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::FlightPlan_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(186);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \FlightPlan_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startFlightPlan_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endFlightPlan_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishFlightPlan_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
