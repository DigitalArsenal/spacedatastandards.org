...
class GNSSObservationSet_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GNSSObservationSet_Full
     */
    public static function getRootAsGNSSObservationSet_Full(ByteBuffer $bb)
    {
        $obj = new GNSSObservationSet_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function GNSSObservationSet_FullIdentifier()
    {
        return "GNSS";
    }

    public static function GNSSObservationSet_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::GNSSObservationSet_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(70);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \GNSSObservationSet_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startGNSSObservationSet_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endGNSSObservationSet_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishGNSSObservationSet_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
