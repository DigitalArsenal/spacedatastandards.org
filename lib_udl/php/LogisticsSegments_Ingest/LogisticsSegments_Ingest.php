...
class LogisticsSegments_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LogisticsSegments_Ingest
     */
    public static function getRootAsLogisticsSegments_Ingest(ByteBuffer $bb)
    {
        $obj = new LogisticsSegments_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LogisticsSegments_IngestIdentifier()
    {
        return "LOGI";
    }

    public static function LogisticsSegments_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LogisticsSegments_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startLogisticsSegments_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return LogisticsSegments_Ingest
     */
    public static function createLogisticsSegments_Ingest(FlatBufferBuilder $builder, $segmentNumber, $modeCode, $missionType, $idMission, $extMissionId, $missionNumber, $itin, $segTailNumber, $segAircraftMDS, $departureICAO, $segActDepTime, $arrivalICAO, $segActArrTime, $segEstDepTime, $segEstArrTime)
    {
        $builder->startObject(15);
     ...
     */
    public static function endLogisticsSegments_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLogisticsSegments_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
