...
class DataLinkMultiDutyVoiceCoord_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DataLinkMultiDutyVoiceCoord_Abridged
     */
    public static function getRootAsDataLinkMultiDutyVoiceCoord_Abridged(ByteBuffer $bb)
    {
        $obj = new DataLinkMultiDutyVoiceCoord_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DataLinkMultiDutyVoiceCoord_AbridgedIdentifier()
    {
        return "DATA";
    }

    public static function DataLinkMultiDutyVoiceCoord_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DataLinkMultiDutyVoiceCoord_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startDataLinkMultiDutyVoiceCoord_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return DataLinkMultiDutyVoiceCoord_Abridged
     */
    public static function createDataLinkMultiDutyVoiceCoord_Abridged(FlatBufferBuilder $builder, $multiVoiceNetDes, $multiFreqDes, $multiCommPri, $multiTeleFreqNums)
    {
        $builder->startObject(4);
     ...
     */
    public static function endDataLinkMultiDutyVoiceCoord_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDataLinkMultiDutyVoiceCoord_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
