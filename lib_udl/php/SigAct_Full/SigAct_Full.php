...
class SigAct_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SigAct_Full
     */
    public static function getRootAsSigAct_Full(ByteBuffer $bb)
    {
        $obj = new SigAct_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SigAct_FullIdentifier()
    {
        return "SIGA";
    }

    public static function SigAct_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SigAct_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(166);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SigAct_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSigAct_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSigAct_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSigAct_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
