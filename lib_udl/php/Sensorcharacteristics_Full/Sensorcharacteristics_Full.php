...
class Sensorcharacteristics_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Sensorcharacteristics_Full
     */
    public static function getRootAsSensorcharacteristics_Full(ByteBuffer $bb)
    {
        $obj = new Sensorcharacteristics_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Sensorcharacteristics_FullIdentifier()
    {
        return "SENS";
    }

    public static function Sensorcharacteristics_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Sensorcharacteristics_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(106);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Sensorcharacteristics_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSensorcharacteristics_Full(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(54, $updatedAt, 0);
    }
    ...
    {
        $builder->addOffsetX(55, $updatedBy, 0);
    }
     ...
     */
    public static function endSensorcharacteristics_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSensorcharacteristics_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
