...
class SeradataEarlyWarning_Ingest extends Table
{
    ...
    public static function SeradataEarlyWarning_IngestIdentifier()
    {
        return "SERA";
    }

    public static function SeradataEarlyWarning_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SeradataEarlyWarning_IngestIdentifier());
    }
    ...
    public static function finishSeradataEarlyWarning_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
