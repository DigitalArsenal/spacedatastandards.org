...
class Location_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Location_Full
     */
    public static function getRootAsLocation_Full(ByteBuffer $bb)
    {
        $obj = new Location_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Location_FullIdentifier()
    {
        return "LOCA";
    }

    public static function Location_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Location_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(30);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Location_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startLocation_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return Location_Full
     */
    public static function createLocation_Full(FlatBufferBuilder $builder, $idLocation, $classificationMarking, $name, $countryCode, $lat, $lon, $altitude, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $dataMode, $origNetwork)
    {
        $builder->startObject(15);
     ...
     */
    public static function endLocation_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLocation_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
