...
class LaunchVehicleDetails_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LaunchVehicleDetails_Ingest
     */
    public static function getRootAsLaunchVehicleDetails_Ingest(ByteBuffer $bb)
    {
        $obj = new LaunchVehicleDetails_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LaunchVehicleDetails_IngestIdentifier()
    {
        return "LAUN";
    }

    public static function LaunchVehicleDetails_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LaunchVehicleDetails_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(110);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \LaunchVehicleDetails_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startLaunchVehicleDetails_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endLaunchVehicleDetails_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLaunchVehicleDetails_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
