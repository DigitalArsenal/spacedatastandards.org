...
class BatteryDetails_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return BatteryDetails_Ingest
     */
    public static function getRootAsBatteryDetails_Ingest(ByteBuffer $bb)
    {
        $obj = new BatteryDetails_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function BatteryDetails_IngestIdentifier()
    {
        return "BATT";
    }

    public static function BatteryDetails_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::BatteryDetails_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(32);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \BatteryDetails_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startBatteryDetails_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return BatteryDetails_Ingest
     */
    public static function createBatteryDetails_Ingest(FlatBufferBuilder $builder, $id, $idBattery, $classificationMarking, $technology, $capacity, $dischargeDepth, $model, $description, $manufacturerOrgId, $createdAt, $createdBy, $source, $origin, $origNetwork, $dataMode, $tags)
    {
        $builder->startObject(16);
     ...
     */
    public static function endBatteryDetails_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishBatteryDetails_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
