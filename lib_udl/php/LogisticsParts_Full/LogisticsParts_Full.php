...
class LogisticsParts_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LogisticsParts_Full
     */
    public static function getRootAsLogisticsParts_Full(ByteBuffer $bb)
    {
        $obj = new LogisticsParts_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LogisticsParts_FullIdentifier()
    {
        return "LOGI";
    }

    public static function LogisticsParts_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LogisticsParts_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startLogisticsParts_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return LogisticsParts_Full
     */
    public static function createLogisticsParts_Full(FlatBufferBuilder $builder, $partNumber, $nationalStockNumber, $measurementUnitCode, $workUnitCode, $technicalOrderText, $figureNumber, $indexNumber, $requestVerifier, $locationVerifier, $supplyDocumentNumber, $logisticsStocks)
    {
        $builder->startObject(11);
     ...
     */
    public static function endLogisticsParts_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLogisticsParts_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
