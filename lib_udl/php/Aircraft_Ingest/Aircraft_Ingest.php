...
class Aircraft_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Aircraft_Ingest
     */
    public static function getRootAsAircraft_Ingest(ByteBuffer $bb)
    {
        $obj = new Aircraft_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Aircraft_IngestIdentifier()
    {
        return "AIRC";
    }

    public static function Aircraft_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Aircraft_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(48);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Aircraft_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAircraft_Ingest(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(19, $sourceDL, 0);
    }
     ...
     */
    public static function endAircraft_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAircraft_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
