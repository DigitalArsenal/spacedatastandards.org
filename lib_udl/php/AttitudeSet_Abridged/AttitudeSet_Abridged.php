...
class AttitudeSet_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AttitudeSet_Abridged
     */
    public static function getRootAsAttitudeSet_Abridged(ByteBuffer $bb)
    {
        $obj = new AttitudeSet_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AttitudeSet_AbridgedIdentifier()
    {
        return "ATTI";
    }

    public static function AttitudeSet_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AttitudeSet_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(54);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AttitudeSet_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAttitudeSet_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return AttitudeSet_Abridged
     */
    public static function createAttitudeSet_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $idOnOrbit, $satNo, $origObjectId, $type, $esId, $idSensor, $origSensorId, $startTime, $endTime, $frame1, $frame2, $numPoints, $stepSize, $precAngleInit, $spinAngleInit, $eulerRotSeq, $interpolator, $interpolatorDegree, $notes, $createdAt, $createdBy, $source, $origin, $dataMode, $origNetwork)
    {
        $builder->startObject(27);
    ...
    {
        $builder->addOffsetX(9, $startTime, 0);
    }
    ...
    {
        $builder->addOffsetX(10, $endTime, 0);
    }
    ...
    {
        $builder->addOffsetX(11, $frame1, 0);
    }
    ...
    {
        $builder->addOffsetX(12, $frame2, 0);
    }
    ...
    {
        $builder->addIntX(13, $numPoints, 0);
    }
    ...
    {
        $builder->addDoubleX(15, $precAngleInit, 0.0);
    }
    ...
    {
        $builder->addDoubleX(16, $spinAngleInit, 0.0);
    }
    ...
    {
        $builder->addOffsetX(17, $eulerRotSeq, 0);
    }
    ...
    {
        $builder->addOffsetX(18, $interpolator, 0);
    }
    ...
    {
        $builder->addIntX(19, $interpolatorDegree, 0);
    }
     ...
     */
    public static function endAttitudeSet_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAttitudeSet_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
