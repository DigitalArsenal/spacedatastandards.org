...
class EvacCasualtyInfo_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacCasualtyInfo_Ingest
     */
    public static function getRootAsEvacCasualtyInfo_Ingest(ByteBuffer $bb)
    {
        $obj = new EvacCasualtyInfo_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacCasualtyInfo_IngestIdentifier()
    {
        return "EVAC";
    }

    public static function EvacCasualtyInfo_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacCasualtyInfo_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacCasualtyInfo_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endEvacCasualtyInfo_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacCasualtyInfo_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
