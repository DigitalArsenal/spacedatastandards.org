...
class SensorMaintenance_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SensorMaintenance_Abridged
     */
    public static function getRootAsSensorMaintenance_Abridged(ByteBuffer $bb)
    {
        $obj = new SensorMaintenance_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SensorMaintenance_AbridgedIdentifier()
    {
        return "SENS";
    }

    public static function SensorMaintenance_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SensorMaintenance_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(62);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SensorMaintenance_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSensorMaintenance_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSensorMaintenance_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSensorMaintenance_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
