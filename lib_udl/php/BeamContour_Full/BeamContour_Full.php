...
class BeamContour_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return BeamContour_Full
     */
    public static function getRootAsBeamContour_Full(ByteBuffer $bb)
    {
        $obj = new BeamContour_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function BeamContour_FullIdentifier()
    {
        return "BEAM";
    }

    public static function BeamContour_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::BeamContour_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(10);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \BeamContour_Full_type_Enum::BORESIGHT;
    }
    ...
    {
        $o = $this->__offset(44);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \BeamContour_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startBeamContour_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return BeamContour_Full
     */
    public static function createBeamContour_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $idBeam, $type, $contourIdx, $gain, $regionName, $geography, $geographyText, $geographyJson, $geographyType, $geographyNdims, $geographySrid, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(21);
     ...
     */
    public static function endBeamContour_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishBeamContour_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
