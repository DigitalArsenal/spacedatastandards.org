...
class Mti_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Mti_Full
     */
    public static function getRootAsMti_Full(ByteBuffer $bb)
    {
        $obj = new Mti_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Mti_FullIdentifier()
    {
        return "MTIF";
    }

    public static function Mti_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Mti_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(12);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Mti_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startMti_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return Mti_Full
     */
    public static function createMti_Full(FlatBufferBuilder $builder, $classificationMarking, $source, $origin, $id, $dataMode, $createdBy, $createdAt, $p3, $p6, $p7, $p8, $p9, $p10, $missions, $dwells, $hrrs, $jobDefs, $freeTexts, $platformLocs, $jobRequests, $origNetwork)
    {
        $builder->startObject(21);
     ...
     */
    public static function endMti_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMti_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
