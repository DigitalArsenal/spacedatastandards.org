...
class SeradataSigIntPayload_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SeradataSigIntPayload_Ingest
     */
    public static function getRootAsSeradataSigIntPayload_Ingest(ByteBuffer $bb)
    {
        $obj = new SeradataSigIntPayload_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SeradataSigIntPayload_IngestIdentifier()
    {
        return "SERA";
    }

    public static function SeradataSigIntPayload_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SeradataSigIntPayload_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(44);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SeradataSigIntPayload_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSeradataSigIntPayload_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSeradataSigIntPayload_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSeradataSigIntPayload_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
