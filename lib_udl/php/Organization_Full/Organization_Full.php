...
class Organization_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Organization_Full
     */
    public static function getRootAsOrganization_Full(ByteBuffer $bb)
    {
        $obj = new Organization_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Organization_FullIdentifier()
    {
        return "ORGA";
    }

    public static function Organization_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Organization_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(28);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Organization_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOrganization_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return Organization_Full
     */
    public static function createOrganization_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $name, $type, $category, $externalId, $description, $countryCode, $nationality, $active, $source, $origin, $dataMode, $createdAt, $createdBy, $updatedAt, $updatedBy, $organizationDetails, $origNetwork)
    {
        $builder->startObject(19);
     ...
     */
    public static function endOrganization_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOrganization_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
