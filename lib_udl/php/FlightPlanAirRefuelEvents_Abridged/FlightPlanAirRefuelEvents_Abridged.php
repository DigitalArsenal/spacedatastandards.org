...
class FlightPlanAirRefuelEvents_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return FlightPlanAirRefuelEvents_Abridged
     */
    public static function getRootAsFlightPlanAirRefuelEvents_Abridged(ByteBuffer $bb)
    {
        $obj = new FlightPlanAirRefuelEvents_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function FlightPlanAirRefuelEvents_AbridgedIdentifier()
    {
        return "FLIG";
    }

    public static function FlightPlanAirRefuelEvents_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::FlightPlanAirRefuelEvents_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startFlightPlanAirRefuelEvents_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return FlightPlanAirRefuelEvents_Abridged
     */
    public static function createFlightPlanAirRefuelEvents_Abridged(FlatBufferBuilder $builder, $arDegrade, $arNum, $arExchangedFuel, $divertFuel, $exitFuel)
    {
        $builder->startObject(5);
     ...
     */
    public static function endFlightPlanAirRefuelEvents_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishFlightPlanAirRefuelEvents_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
