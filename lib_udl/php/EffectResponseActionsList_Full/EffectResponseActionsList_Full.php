...
class EffectResponseActionsList_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EffectResponseActionsList_Full
     */
    public static function getRootAsEffectResponseActionsList_Full(ByteBuffer $bb)
    {
        $obj = new EffectResponseActionsList_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EffectResponseActionsList_FullIdentifier()
    {
        return "EFFE";
    }

    public static function EffectResponseActionsList_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EffectResponseActionsList_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startEffectResponseActionsList_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endEffectResponseActionsList_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEffectResponseActionsList_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
