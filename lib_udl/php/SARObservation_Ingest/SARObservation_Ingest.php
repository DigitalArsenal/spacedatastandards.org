...
class SARObservation_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SARObservation_Ingest
     */
    public static function getRootAsSARObservation_Ingest(ByteBuffer $bb)
    {
        $obj = new SARObservation_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SARObservation_IngestIdentifier()
    {
        return "SARO";
    }

    public static function SARObservation_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SARObservation_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(140);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SARObservation_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSARObservation_Ingest(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(62, $createdAt, 0);
    }
    ...
    {
        $builder->addOffsetX(63, $createdBy, 0);
    }
    ...
    {
        $builder->addOffsetX(66, $origNetwork, 0);
    }
    ...
    {
        $builder->addOffsetX(67, $sourceDL, 0);
    }
     ...
     */
    public static function endSARObservation_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSARObservation_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
