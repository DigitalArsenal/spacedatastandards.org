...
class MtiHRR_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MtiHRR_Abridged
     */
    public static function getRootAsMtiHRR_Abridged(ByteBuffer $bb)
    {
        $obj = new MtiHRR_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MtiHRR_AbridgedIdentifier()
    {
        return "MTIH";
    }

    public static function MtiHRR_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MtiHRR_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startMtiHRR_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return MtiHRR_Abridged
     */
    public static function createMtiHRR_Abridged(FlatBufferBuilder $builder, $h2, $h3, $h4, $h5, $h6, $h7, $h8, $h9, $h10, $h11, $h12, $h13, $h14, $h15, $h16, $h17, $h18, $h19, $h20, $h21, $h22, $h23, $h24, $h27, $h28, $h29, $h30, $h31, $h32)
    {
        $builder->startObject(29);
     ...
     */
    public static function endMtiHRR_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMtiHRR_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
