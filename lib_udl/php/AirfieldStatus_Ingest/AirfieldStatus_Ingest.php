...
class AirfieldStatus_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirfieldStatus_Ingest
     */
    public static function getRootAsAirfieldStatus_Ingest(ByteBuffer $bb)
    {
        $obj = new AirfieldStatus_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirfieldStatus_IngestIdentifier()
    {
        return "AIRF";
    }

    public static function AirfieldStatus_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirfieldStatus_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(74);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirfieldStatus_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAirfieldStatus_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAirfieldStatus_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirfieldStatus_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
