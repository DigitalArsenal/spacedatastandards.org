...
class SubStatus_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SubStatus_Full
     */
    public static function getRootAsSubStatus_Full(ByteBuffer $bb)
    {
        $obj = new SubStatus_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SubStatus_FullIdentifier()
    {
        return "SUBS";
    }

    public static function SubStatus_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SubStatus_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(6);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SubStatus_Full_type_Enum::MWCAP;
    }
    ...
    {
        $o = $this->__offset(12);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SubStatus_Full_status_Enum::FMC;
    }
    ...
    {
        $o = $this->__offset(22);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SubStatus_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSubStatus_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return SubStatus_Full
     */
    public static function createSubStatus_Full(FlatBufferBuilder $builder, $id, $type, $classificationMarking, $statusId, $status, $notes, $source, $origin, $origNetwork, $dataMode, $createdAt, $createdBy, $updatedAt, $updatedBy)
    {
        $builder->startObject(14);
     ...
     */
    public static function endSubStatus_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSubStatus_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
