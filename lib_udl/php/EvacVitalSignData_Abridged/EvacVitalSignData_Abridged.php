...
class EvacVitalSignData_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EvacVitalSignData_Abridged
     */
    public static function getRootAsEvacVitalSignData_Abridged(ByteBuffer $bb)
    {
        $obj = new EvacVitalSignData_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EvacVitalSignData_AbridgedIdentifier()
    {
        return "EVAC";
    }

    public static function EvacVitalSignData_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EvacVitalSignData_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startEvacVitalSignData_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return EvacVitalSignData_Abridged
     */
    public static function createEvacVitalSignData_Abridged(FlatBufferBuilder $builder, $vitalSign, $vitalSign1, $vitalSign2, $medConfFactor, $time)
    {
        $builder->startObject(5);
     ...
     */
    public static function endEvacVitalSignData_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEvacVitalSignData_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
