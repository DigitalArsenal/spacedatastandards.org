...
class MtiHRRScatterer_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MtiHRRScatterer_Abridged
     */
    public static function getRootAsMtiHRRScatterer_Abridged(ByteBuffer $bb)
    {
        $obj = new MtiHRRScatterer_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MtiHRRScatterer_AbridgedIdentifier()
    {
        return "MTIH";
    }

    public static function MtiHRRScatterer_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MtiHRRScatterer_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startMtiHRRScatterer_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return MtiHRRScatterer_Abridged
     */
    public static function createMtiHRRScatterer_Abridged(FlatBufferBuilder $builder, $h32_1, $h32_2, $h32_3, $h32_4)
    {
        $builder->startObject(4);
     ...
     */
    public static function endMtiHRRScatterer_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMtiHRRScatterer_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
