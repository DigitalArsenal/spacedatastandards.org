...
class EOObservation_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EOObservation_Abridged
     */
    public static function getRootAsEOObservation_Abridged(ByteBuffer $bb)
    {
        $obj = new EOObservation_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EOObservation_AbridgedIdentifier()
    {
        return "EOOB";
    }

    public static function EOObservation_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EOObservation_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(164);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EOObservation_Abridged_dataMode_Enum::REAL;
    }
    ...
    {
        $o = $this->__offset(170);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EOObservation_Abridged_referenceFrame_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(172);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EOObservation_Abridged_senReferenceFrame_Enum::J2000;
    }
     ...
     * @return void
     */
    public static function startEOObservation_Abridged(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addSbyteX(83, $referenceFrame, 0);
    }
    ...
    {
        $builder->addSbyteX(84, $senReferenceFrame, 0);
    }
    ...
    {
        $builder->addBoolX(85, $umbra, false);
    }
    ...
    {
        $builder->addBoolX(86, $penumbra, false);
    }
    ...
    {
        $builder->addOffsetX(87, $origNetwork, 0);
    }
    ...
    {
        $builder->addOffsetX(88, $sourceDL, 0);
    }
     ...
     */
    public static function endEOObservation_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEOObservation_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
