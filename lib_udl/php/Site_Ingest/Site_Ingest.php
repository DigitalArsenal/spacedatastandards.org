...
class Site_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Site_Ingest
     */
    public static function getRootAsSite_Ingest(ByteBuffer $bb)
    {
        $obj = new Site_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Site_IngestIdentifier()
    {
        return "SITE";
    }

    public static function Site_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Site_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(134);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Site_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSite_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSite_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSite_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
