...
class Scientific_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Scientific_Ingest
     */
    public static function getRootAsScientific_Ingest(ByteBuffer $bb)
    {
        $obj = new Scientific_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Scientific_IngestIdentifier()
    {
        return "SCIE";
    }

    public static function Scientific_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Scientific_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(32);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Scientific_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startScientific_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return Scientific_Ingest
     */
    public static function createScientific_Ingest(FlatBufferBuilder $builder, $id, $classificationMarking, $spacecraftId, $hostedForCompanyOrgId, $manufacturerOrgId, $payloadCategory, $name, $frequencyBand, $notes, $createdAt, $createdBy, $source, $origin, $origNetwork, $dataMode, $idEntity, $entity)
    {
        $builder->startObject(17);
    ...
    {
        $builder->addOffsetX(16, $entity, 0);
    }
     ...
     */
    public static function endScientific_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishScientific_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
