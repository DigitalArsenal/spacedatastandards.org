...
class FlightPlanPointGroups_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return FlightPlanPointGroups_Abridged
     */
    public static function getRootAsFlightPlanPointGroups_Abridged(ByteBuffer $bb)
    {
        $obj = new FlightPlanPointGroups_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function FlightPlanPointGroups_AbridgedIdentifier()
    {
        return "FLIG";
    }

    public static function FlightPlanPointGroups_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::FlightPlanPointGroups_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startFlightPlanPointGroups_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endFlightPlanPointGroups_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishFlightPlanPointGroups_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
