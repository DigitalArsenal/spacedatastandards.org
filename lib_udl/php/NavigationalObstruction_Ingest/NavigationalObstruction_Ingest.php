...
class NavigationalObstruction_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return NavigationalObstruction_Ingest
     */
    public static function getRootAsNavigationalObstruction_Ingest(ByteBuffer $bb)
    {
        $obj = new NavigationalObstruction_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function NavigationalObstruction_IngestIdentifier()
    {
        return "NAVI";
    }

    public static function NavigationalObstruction_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::NavigationalObstruction_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(156);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \NavigationalObstruction_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startNavigationalObstruction_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endNavigationalObstruction_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishNavigationalObstruction_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
