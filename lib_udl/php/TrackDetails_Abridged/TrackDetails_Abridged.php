...
class TrackDetails_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return TrackDetails_Abridged
     */
    public static function getRootAsTrackDetails_Abridged(ByteBuffer $bb)
    {
        $obj = new TrackDetails_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function TrackDetails_AbridgedIdentifier()
    {
        return "TRAC";
    }

    public static function TrackDetails_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::TrackDetails_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(8);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \TrackDetails_Abridged_env_Enum::AIR;
    }
    ...
    {
        $o = $this->__offset(50);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \TrackDetails_Abridged_objIdent_Enum::ASSUMED_FRIEND;
    }
    ...
    {
        $o = $this->__offset(316);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \TrackDetails_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startTrackDetails_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endTrackDetails_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishTrackDetails_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
