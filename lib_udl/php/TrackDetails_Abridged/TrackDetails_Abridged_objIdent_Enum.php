...
class TrackDetails_Abridged_objIdent_Enum
{
    ...
    private static $names = array(
        TrackDetails_Abridged_objIdent_Enum::ASSUMED_FRIEND=>"ASSUMED_FRIEND",
        TrackDetails_Abridged_objIdent_Enum::FRIEND=>"FRIEND",
        TrackDetails_Abridged_objIdent_Enum::HOSTILE=>"HOSTILE",
        TrackDetails_Abridged_objIdent_Enum::NEUTRAL=>"NEUTRAL",
        TrackDetails_Abridged_objIdent_Enum::PENDING=>"PENDING",
        TrackDetails_Abridged_objIdent_Enum::SUSPECT=>"SUSPECT",
        TrackDetails_Abridged_objIdent_Enum::UNKNOWN=>"UNKNOWN",
    );
