...
class OnorbitDetails extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OnorbitDetails
     */
    public static function getRootAsOnorbitDetails(ByteBuffer $bb)
    {
        $obj = new OnorbitDetails();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OnorbitDetailsIdentifier()
    {
        return "ONOR";
    }

    public static function OnorbitDetailsBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OnorbitDetailsIdentifier());
    }
    ...
    {
        $o = $this->__offset(92);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OnorbitDetails_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOnorbitDetails(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endOnorbitDetails(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOnorbitDetailsBuffer(FlatBufferBuilder $builder, $offset)
    {
