...
class SpaceEnvObservation_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SpaceEnvObservation_Abridged
     */
    public static function getRootAsSpaceEnvObservation_Abridged(ByteBuffer $bb)
    {
        $obj = new SpaceEnvObservation_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SpaceEnvObservation_AbridgedIdentifier()
    {
        return "SPAC";
    }

    public static function SpaceEnvObservation_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SpaceEnvObservation_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(46);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SpaceEnvObservation_Abridged_senReferenceFrame_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(82);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SpaceEnvObservation_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSpaceEnvObservation_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSpaceEnvObservation_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSpaceEnvObservation_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
