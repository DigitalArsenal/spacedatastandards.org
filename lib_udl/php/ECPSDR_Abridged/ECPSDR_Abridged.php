...
class ECPSDR_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return ECPSDR_Abridged
     */
    public static function getRootAsECPSDR_Abridged(ByteBuffer $bb)
    {
        $obj = new ECPSDR_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function ECPSDR_AbridgedIdentifier()
    {
        return "ECPS";
    }

    public static function ECPSDR_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::ECPSDR_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(106);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \ECPSDR_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startECPSDR_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return ECPSDR_Abridged
     */
    public static function createECPSDR_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $idOnOrbit, $satNo, $origObjectId, $idSensor, $origSensorId, $type, $msgTime, $obTime, $retransmit, $senMode, $dosBias, $asl5VCurrMon, $dsl5VCurrMon, $psTempMon, $cdsPlateVMon, $cdsRefVMon, $mpTemp, $vRef, $pd1SigLev, $pd2SigLev, $esdTrigCountL, $esdTrigCountH, $lowLetL, $lowLetM, $medLet1L, $medLet1M, $medLet2L, $medLet2M, $medLet3L, $medLet3M, $medLet4L, $medLet4M, $hiLetL, $hiLetM, $surfDosL, $surfDosM, $surfDosH, $surfDosChargeL, $surfDosChargeH, $surfDosStat, $cdsThrottle, $cdsThreshold, $checksum, $transientData, $createdAt, $createdBy, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(52);
     ...
     */
    public static function endECPSDR_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishECPSDR_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
