...
class IonoObservationDensityProfileTopsideExtensionVaryChap_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IonoObservationDensityProfileTopsideExtensionVaryChap_Full
     */
    public static function getRootAsIonoObservationDensityProfileTopsideExtensionVaryChap_Full(ByteBuffer $bb)
    {
        $obj = new IonoObservationDensityProfileTopsideExtensionVaryChap_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IonoObservationDensityProfileTopsideExtensionVaryChap_FullIdentifier()
    {
        return "IONO";
    }

    public static function IonoObservationDensityProfileTopsideExtensionVaryChap_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IonoObservationDensityProfileTopsideExtensionVaryChap_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startIonoObservationDensityProfileTopsideExtensionVaryChap_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return IonoObservationDensityProfileTopsideExtensionVaryChap_Full
     */
    public static function createIonoObservationDensityProfileTopsideExtensionVaryChap_Full(FlatBufferBuilder $builder, $description, $nmF2, $hmF2, $scaleF2, $alpha, $beta, $ht, $chi)
    {
        $builder->startObject(8);
     ...
     */
    public static function endIonoObservationDensityProfileTopsideExtensionVaryChap_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIonoObservationDensityProfileTopsideExtensionVaryChap_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
