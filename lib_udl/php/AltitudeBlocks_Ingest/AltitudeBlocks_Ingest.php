...
class AltitudeBlocks_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AltitudeBlocks_Ingest
     */
    public static function getRootAsAltitudeBlocks_Ingest(ByteBuffer $bb)
    {
        $obj = new AltitudeBlocks_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AltitudeBlocks_IngestIdentifier()
    {
        return "ALTI";
    }

    public static function AltitudeBlocks_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AltitudeBlocks_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startAltitudeBlocks_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return AltitudeBlocks_Ingest
     */
    public static function createAltitudeBlocks_Ingest(FlatBufferBuilder $builder, $altitudeSequenceId, $lowerAltitude, $upperAltitude)
    {
        $builder->startObject(3);
     ...
     */
    public static function endAltitudeBlocks_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAltitudeBlocks_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
