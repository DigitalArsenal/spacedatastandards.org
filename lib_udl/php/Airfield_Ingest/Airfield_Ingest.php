...
class Airfield_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Airfield_Ingest
     */
    public static function getRootAsAirfield_Ingest(ByteBuffer $bb)
    {
        $obj = new Airfield_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Airfield_IngestIdentifier()
    {
        return "AIRF";
    }

    public static function Airfield_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Airfield_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(72);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Airfield_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAirfield_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return Airfield_Ingest
     */
    public static function createAirfield_Ingest(FlatBufferBuilder $builder, $id, $classificationMarking, $idSite, $altAirfieldId, $wacINNR, $zarId, $icao, $iata, $faa, $hostNatCode, $name, $type, $lat, $lon, $elevFt, $elevM, $magDec, $regionName, $countryCode, $city, $state, $geoloc, $gmtOffset, $suitabilityCodes, $miscCodes, $runways, $maxRunwayLength, $infoURL, $createdAt, $createdBy, $sourceDL, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(35);
     ...
     */
    public static function endAirfield_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirfield_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
