...
class RFEmitterDetails_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return RFEmitterDetails_Full
     */
    public static function getRootAsRFEmitterDetails_Full(ByteBuffer $bb)
    {
        $obj = new RFEmitterDetails_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function RFEmitterDetails_FullIdentifier()
    {
        return "RFEM";
    }

    public static function RFEmitterDetails_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RFEmitterDetails_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(68);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFEmitterDetails_Full_dataMode_Enum::REAL;
    }
    ...
    /// Constraints: No constraints specified.
    public function getProductionFacilityLocation()
    {
        $o = $this->__offset(78);
        return $o != 0 ? $this->__string($o + $this->bb_pos) : null;
    }
     ...
     * @return void
     */
    public static function startRFEmitterDetails_Full(FlatBufferBuilder $builder)
    {
    ...
    public static function createRFEmitterDetails_Full(FlatBufferBuilder $builder, $id, $idRFEmitter, $classificationMarking, $designator, $altName, $family, $productionFacilityName, $alternateFacilityName, $manufacturerOrgId, $productionFacilityLocationId, $systemSensitivityStart, $systemSensitivityEnd, $receiverType, $receiverSensitivity, $receiverBandwidth, $transmitterFrequency, $transmitterBandwidth, $transmitPower, $barrageNoiseBandwidth, $dopplerNoise, $drfmInstantaneousBandwidth, $numChannels, $numBits, $antennaSize, $antennaDiameter, $notes, $secondaryNotes, $description, $urls, $source, $origin, $origNetwork, $dataMode, $createdAt, $createdBy, $updatedAt, $updatedBy, $productionFacilityLocation, $manufacturerOrg)
    {
        ...
        self::addProductionFacilityLocation($builder, $productionFacilityLocation);
    ...
    {
        $builder->addOffsetX(35, $updatedAt, 0);
    }
    ...
    {
        $builder->addOffsetX(36, $updatedBy, 0);
    }
     ...
     * @return void
     */
    public static function addProductionFacilityLocation(FlatBufferBuilder $builder, $productionFacilityLocation)
    {
        $builder->addOffsetX(37, $productionFacilityLocation, 0);
    }
    ...
    {
        $builder->addOffsetX(38, $manufacturerOrg, 0);
    }
     ...
     */
    public static function endRFEmitterDetails_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRFEmitterDetails_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
