...
class Entity_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Entity_Full
     */
    public static function getRootAsEntity_Full(ByteBuffer $bb)
    {
        $obj = new Entity_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Entity_FullIdentifier()
    {
        return "ENTI";
    }

    public static function Entity_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Entity_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(10);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Entity_Full_type_Enum::AIRCRAFT;
    }
    ...
    {
        $o = $this->__offset(16);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Entity_Full_ownerType_Enum::COMMERCIAL;
    }
    ...
    {
        $o = $this->__offset(34);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Entity_Full_dataMode_Enum::REAL;
    }
     ...
     * @return string
     */
    public function getStatusCollection($j)
    {
        $o = $this->__offset(48);
        return $o != 0 ? $this->__string($this->__vector($o) + $j * 4) : 0;
    }
     ...
     * @return int
     */
    public function getStatusCollectionLength()
    {
        $o = $this->__offset(48);
        return $o != 0 ? $this->__vector_len($o) : 0;
    }
     ...
     * @return int
     */
    public function getRfBandsLength()
    {
        $o = $this->__offset(50);
        return $o != 0 ? $this->__vector_len($o) : 0;
    }
     ...
     * @return void
     */
    public static function startEntity_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return Entity_Full
     */
    public static function createEntity_Full(FlatBufferBuilder $builder, $idEntity, $name, $classificationMarking, $type, $idLocation, $countryCode, $ownerType, $taskable, $urls, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $origin, $dataMode, $location, $onOrbit, $idOnOrbit, $operatingUnit, $idOperatingUnit, $origNetwork, $statusCollection, $rfBands)
    {
        $builder->startObject(24);
        ...
        self::addOperatingUnit($builder, $operatingUnit);
        self::addIdOperatingUnit($builder, $idOperatingUnit);
        self::addOrigNetwork($builder, $origNetwork);
        self::addStatusCollection($builder, $statusCollection);
        self::addRfBands($builder, $rfBands);
        $o = $builder->endObject();
        return $o;
    }
    ...
    {
        $builder->addOffsetX(13, $source, 0);
    }
    ...
    {
        $builder->addOffsetX(14, $origin, 0);
    }
    ...
    {
        $builder->addOffsetX(16, $location, 0);
    }
    ...
    {
        $builder->addOffsetX(17, $onOrbit, 0);
    }
     ...
     * @return void
     */
    public static function addOperatingUnit(FlatBufferBuilder $builder, $operatingUnit)
    {
        $builder->addOffsetX(19, $operatingUnit, 0);
    }
    ...
    {
        $builder->addOffsetX(20, $idOperatingUnit, 0);
    }
     ...
     * @return void
     */
    public static function addStatusCollection(FlatBufferBuilder $builder, $statusCollection)
    {
        $builder->addOffsetX(22, $statusCollection, 0);
    }
     ...
     * @return int vector offset
     */
    public static function createStatusCollectionVector(FlatBufferBuilder $builder, array $data)
    {
        $builder->startVector(4, count($data), 4);
        for ($i = count($data) - 1; $i >= 0; $i--) {
            $builder->putOffset($data[$i]);
     ...
     * @return void
     */
    public static function startStatusCollectionVector(FlatBufferBuilder $builder, $numElems)
    {
        $builder->startVector(4, $numElems, 4);
    }
     ...
     * @return void
     */
    public static function addRfBands(FlatBufferBuilder $builder, $rfBands)
    {
        $builder->addOffsetX(23, $rfBands, 0);
    }
     ...
     * @return int vector offset
     */
    public static function createRfBandsVector(FlatBufferBuilder $builder, array $data)
    {
        $builder->startVector(4, count($data), 4);
        for ($i = count($data) - 1; $i >= 0; $i--) {
            $builder->putOffset($data[$i]);
     ...
     * @return void
     */
    public static function startRfBandsVector(FlatBufferBuilder $builder, $numElems)
    {
        $builder->startVector(4, $numElems, 4);
    }
     ...
     */
    public static function endEntity_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEntity_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
