...
class DiplomaticClearance_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DiplomaticClearance_Ingest
     */
    public static function getRootAsDiplomaticClearance_Ingest(ByteBuffer $bb)
    {
        $obj = new DiplomaticClearance_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DiplomaticClearance_IngestIdentifier()
    {
        return "DIPL";
    }

    public static function DiplomaticClearance_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DiplomaticClearance_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(40);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \DiplomaticClearance_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startDiplomaticClearance_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endDiplomaticClearance_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDiplomaticClearance_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
