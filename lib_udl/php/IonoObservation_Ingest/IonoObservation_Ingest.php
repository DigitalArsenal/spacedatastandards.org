...
class IonoObservation_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IonoObservation_Ingest
     */
    public static function getRootAsIonoObservation_Ingest(ByteBuffer $bb)
    {
        $obj = new IonoObservation_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IonoObservation_IngestIdentifier()
    {
        return "IONO";
    }

    public static function IonoObservation_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IonoObservation_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(32);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \IonoObservation_Ingest_transmitSensorType_Enum::MOBILE;
    }
    ...
    {
        $o = $this->__offset(36);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \IonoObservation_Ingest_receiveSensorType_Enum::MOBILE;
    }
    ...
    {
        $o = $this->__offset(40);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \IonoObservation_Ingest_antennaElementPositionCoordinateSystem_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(216);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \IonoObservation_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startIonoObservation_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endIonoObservation_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIonoObservation_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
