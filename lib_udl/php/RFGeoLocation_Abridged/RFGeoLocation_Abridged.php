...
class RFGeoLocation_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return RFGeoLocation_Abridged
     */
    public static function getRootAsRFGeoLocation_Abridged(ByteBuffer $bb)
    {
        $obj = new RFGeoLocation_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function RFGeoLocation_AbridgedIdentifier()
    {
        return "RFGE";
    }

    public static function RFGeoLocation_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RFGeoLocation_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(84);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFGeoLocation_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startRFGeoLocation_Abridged(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(30, $passGroupId, 0);
    }
    ...
    {
        $builder->addOffsetX(31, $algVersion, 0);
    }
    ...
    {
        $builder->addOffsetX(32, $externalId, 0);
    }
     ...
     */
    public static function endRFGeoLocation_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRFGeoLocation_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
