...
class AirspaceControlPoint_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirspaceControlPoint_Abridged
     */
    public static function getRootAsAirspaceControlPoint_Abridged(ByteBuffer $bb)
    {
        $obj = new AirspaceControlPoint_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirspaceControlPoint_AbridgedIdentifier()
    {
        return "AIRS";
    }

    public static function AirspaceControlPoint_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirspaceControlPoint_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startAirspaceControlPoint_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return AirspaceControlPoint_Abridged
     */
    public static function createAirspaceControlPoint_Abridged(FlatBufferBuilder $builder, $ctrlPtType, $ctrlPtName, $ctrlPtLocation, $ctrlPtAltitude)
    {
        $builder->startObject(4);
     ...
     */
    public static function endAirspaceControlPoint_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirspaceControlPoint_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
