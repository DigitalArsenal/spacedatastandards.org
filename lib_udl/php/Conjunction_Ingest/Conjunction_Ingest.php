...
class Conjunction_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Conjunction_Ingest
     */
    public static function getRootAsConjunction_Ingest(ByteBuffer $bb)
    {
        $obj = new Conjunction_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Conjunction_IngestIdentifier()
    {
        return "CONJ";
    }

    public static function Conjunction_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Conjunction_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(122);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Conjunction_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startConjunction_Ingest(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(66, $origIdOnOrbit1, 0);
    }
    ...
    {
        $builder->addOffsetX(67, $origIdOnOrbit2, 0);
    }
     ...
     */
    public static function endConjunction_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishConjunction_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
