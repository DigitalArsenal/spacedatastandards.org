...
class Manifold_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Manifold_Abridged
     */
    public static function getRootAsManifold_Abridged(ByteBuffer $bb)
    {
        $obj = new Manifold_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Manifold_AbridgedIdentifier()
    {
        return "MANI";
    }

    public static function Manifold_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Manifold_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(26);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Manifold_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startManifold_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return Manifold_Abridged
     */
    public static function createManifold_Abridged(FlatBufferBuilder $builder, $id, $idObjectOfInterest, $classificationMarking, $status, $weight, $deltaV, $deltaT, $createdAt, $createdBy, $source, $origin, $dataMode, $origNetwork)
    {
        $builder->startObject(13);
     ...
     */
    public static function endManifold_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishManifold_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
