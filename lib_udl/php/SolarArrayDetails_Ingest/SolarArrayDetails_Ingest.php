...
class SolarArrayDetails_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SolarArrayDetails_Ingest
     */
    public static function getRootAsSolarArrayDetails_Ingest(ByteBuffer $bb)
    {
        $obj = new SolarArrayDetails_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SolarArrayDetails_IngestIdentifier()
    {
        return "SOLA";
    }

    public static function SolarArrayDetails_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SolarArrayDetails_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(34);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SolarArrayDetails_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSolarArrayDetails_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return SolarArrayDetails_Ingest
     */
    public static function createSolarArrayDetails_Ingest(FlatBufferBuilder $builder, $id, $idSolarArray, $classificationMarking, $type, $technology, $junctionTechnology, $manufacturerOrgId, $span, $area, $description, $createdAt, $createdBy, $source, $origin, $origNetwork, $dataMode, $tags)
    {
        $builder->startObject(17);
     ...
     */
    public static function endSolarArrayDetails_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSolarArrayDetails_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
