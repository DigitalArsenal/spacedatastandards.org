...
class IonoObservationDensityProfileIRI_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IonoObservationDensityProfileIRI_Abridged
     */
    public static function getRootAsIonoObservationDensityProfileIRI_Abridged(ByteBuffer $bb)
    {
        $obj = new IonoObservationDensityProfileIRI_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IonoObservationDensityProfileIRI_AbridgedIdentifier()
    {
        return "IONO";
    }

    public static function IonoObservationDensityProfileIRI_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IonoObservationDensityProfileIRI_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startIonoObservationDensityProfileIRI_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return IonoObservationDensityProfileIRI_Abridged
     */
    public static function createIonoObservationDensityProfileIRI_Abridged(FlatBufferBuilder $builder, $description, $nmF2, $hmF2, $b0, $b1, $nmF1, $hmF1, $d1, $hz, $hValTop, $nValB, $nmE, $hmE, $hdx, $nmD, $hmD, $ha, $fp1, $fp2, $fp30, $fp3U, $chi)
    {
        $builder->startObject(22);
     ...
     */
    public static function endIonoObservationDensityProfileIRI_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIonoObservationDensityProfileIRI_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
