...
class Port_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Port_Full
     */
    public static function getRootAsPort_Full(ByteBuffer $bb)
    {
        $obj = new Port_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Port_FullIdentifier()
    {
        return "PORT";
    }

    public static function Port_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Port_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(50);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Port_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startPort_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return Port_Full
     */
    public static function createPort_Full(FlatBufferBuilder $builder, $id, $classificationMarking, $idSite, $externalId, $locode, $portName, $harborType, $harborSize, $maxDraught, $avgDuration, $tideRange, $shelter, $pilotReqd, $lat, $lon, $countryCode, $createdAt, $createdBy, $updatedAt, $updatedBy, $source, $sourceDL, $origin, $dataMode, $origNetwork)
    {
        $builder->startObject(25);
     ...
     */
    public static function endPort_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPort_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
