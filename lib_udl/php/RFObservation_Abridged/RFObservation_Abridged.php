...
class RFObservation_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return RFObservation_Abridged
     */
    public static function getRootAsRFObservation_Abridged(ByteBuffer $bb)
    {
        $obj = new RFObservation_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function RFObservation_AbridgedIdentifier()
    {
        return "RFOB";
    }

    public static function RFObservation_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RFObservation_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(94);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFObservation_Abridged_polarityType_Enum::H;
    }
    ...
    {
        $o = $this->__offset(134);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFObservation_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startRFObservation_Abridged(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addDoubleX(68, $noisePwrDensity, 0.0);
    }
    ...
    {
        $builder->addOffsetX(69, $carrierStandard, 0);
    }
    ...
    {
        $builder->addOffsetX(70, $modulation, 0);
    }
    ...
    {
        $builder->addIntX(71, $innerCodingRate, 0);
    }
    ...
    {
        $builder->addIntX(72, $outerCodingRate, 0);
    }
    ...
    {
        $builder->addOffsetX(73, $transmitFilterType, 0);
    }
    ...
    {
        $builder->addDoubleX(74, $transmitFilterRollOff, 0.0);
    }
    ...
    {
        $builder->addDoubleX(75, $symbolToNoiseRatio, 0.0);
    }
    ...
    {
        $builder->addDoubleX(76, $bitErrorRate, 0.0);
    }
    ...
    {
        $builder->addOffsetX(77, $origNetwork, 0);
    }
    ...
    {
        $builder->addOffsetX(78, $sourceDL, 0);
    }
    ...
    {
        $builder->addOffsetX(79, $descriptor, 0);
    }
     ...
     */
    public static function endRFObservation_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRFObservation_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
