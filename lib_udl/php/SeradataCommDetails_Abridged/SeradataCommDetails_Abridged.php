...
class SeradataCommDetails_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SeradataCommDetails_Abridged
     */
    public static function getRootAsSeradataCommDetails_Abridged(ByteBuffer $bb)
    {
        $obj = new SeradataCommDetails_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SeradataCommDetails_AbridgedIdentifier()
    {
        return "SERA";
    }

    public static function SeradataCommDetails_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SeradataCommDetails_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(72);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SeradataCommDetails_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSeradataCommDetails_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endSeradataCommDetails_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSeradataCommDetails_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
