...
class MtiTargetReport_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return MtiTargetReport_Abridged
     */
    public static function getRootAsMtiTargetReport_Abridged(ByteBuffer $bb)
    {
        $obj = new MtiTargetReport_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function MtiTargetReport_AbridgedIdentifier()
    {
        return "MTIT";
    }

    public static function MtiTargetReport_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::MtiTargetReport_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startMtiTargetReport_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return MtiTargetReport_Abridged
     */
    public static function createMtiTargetReport_Abridged(FlatBufferBuilder $builder, $d32_1, $d32_2, $d32_3, $d32_4, $d32_5, $d32_6, $d32_7, $d32_8, $d32_9, $d32_10, $d32_11, $d32_12, $d32_13, $d32_14, $d32_15, $d32_16, $d32_17, $d32_18)
    {
        $builder->startObject(18);
     ...
     */
    public static function endMtiTargetReport_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishMtiTargetReport_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
