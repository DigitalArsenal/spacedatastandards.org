...
class PersonnelRecoveryExecutionInfo_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return PersonnelRecoveryExecutionInfo_Full
     */
    public static function getRootAsPersonnelRecoveryExecutionInfo_Full(ByteBuffer $bb)
    {
        $obj = new PersonnelRecoveryExecutionInfo_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function PersonnelRecoveryExecutionInfo_FullIdentifier()
    {
        return "PERS";
    }

    public static function PersonnelRecoveryExecutionInfo_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::PersonnelRecoveryExecutionInfo_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startPersonnelRecoveryExecutionInfo_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return PersonnelRecoveryExecutionInfo_Full
     */
    public static function createPersonnelRecoveryExecutionInfo_Full(FlatBufferBuilder $builder, $initialPoint, $ingress, $objStrategy, $egressPoint, $egress, $recoveryVehicle, $escortVehicle)
    {
        $builder->startObject(7);
     ...
     */
    public static function endPersonnelRecoveryExecutionInfo_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishPersonnelRecoveryExecutionInfo_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
