...
class AircraftMissionTasking_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AircraftMissionTasking_Full
     */
    public static function getRootAsAircraftMissionTasking_Full(ByteBuffer $bb)
    {
        $obj = new AircraftMissionTasking_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AircraftMissionTasking_FullIdentifier()
    {
        return "AIRC";
    }

    public static function AircraftMissionTasking_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AircraftMissionTasking_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startAircraftMissionTasking_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAircraftMissionTasking_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAircraftMissionTasking_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
