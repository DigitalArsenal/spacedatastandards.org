...
class OnorbitThrusterStatus_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OnorbitThrusterStatus_Ingest
     */
    public static function getRootAsOnorbitThrusterStatus_Ingest(ByteBuffer $bb)
    {
        $obj = new OnorbitThrusterStatus_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OnorbitThrusterStatus_IngestIdentifier()
    {
        return "ONOR";
    }

    public static function OnorbitThrusterStatus_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OnorbitThrusterStatus_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(50);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OnorbitThrusterStatus_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOnorbitThrusterStatus_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endOnorbitThrusterStatus_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOnorbitThrusterStatus_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
