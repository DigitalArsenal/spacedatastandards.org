...
class IonoObservationScalerInfo_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return IonoObservationScalerInfo_Abridged
     */
    public static function getRootAsIonoObservationScalerInfo_Abridged(ByteBuffer $bb)
    {
        $obj = new IonoObservationScalerInfo_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function IonoObservationScalerInfo_AbridgedIdentifier()
    {
        return "IONO";
    }

    public static function IonoObservationScalerInfo_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::IonoObservationScalerInfo_AbridgedIdentifier());
    }
     ...
     * @return void
     */
    public static function startIonoObservationScalerInfo_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return IonoObservationScalerInfo_Abridged
     */
    public static function createIonoObservationScalerInfo_Abridged(FlatBufferBuilder $builder, $type, $name, $organization, $version, $confidenceScore, $confidenceLevel)
    {
        $builder->startObject(6);
     ...
     */
    public static function endIonoObservationScalerInfo_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishIonoObservationScalerInfo_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
