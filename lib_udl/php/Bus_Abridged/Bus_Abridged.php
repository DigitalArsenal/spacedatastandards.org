...
class Bus_Abridged extends Table
{
    ...
    public static function Bus_AbridgedIdentifier()
    {
        return "BUSA";
    }

    public static function Bus_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Bus_AbridgedIdentifier());
    }
    ...
    public static function finishBus_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
