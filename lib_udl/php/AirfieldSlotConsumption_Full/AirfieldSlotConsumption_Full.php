...
class AirfieldSlotConsumption_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirfieldSlotConsumption_Full
     */
    public static function getRootAsAirfieldSlotConsumption_Full(ByteBuffer $bb)
    {
        $obj = new AirfieldSlotConsumption_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirfieldSlotConsumption_FullIdentifier()
    {
        return "AIRF";
    }

    public static function AirfieldSlotConsumption_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirfieldSlotConsumption_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(10);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirfieldSlotConsumption_Full_status_Enum::REQUESTED;
    }
    ...
    {
        $o = $this->__offset(80);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirfieldSlotConsumption_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAirfieldSlotConsumption_Full(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(32, $updatedAt, 0);
    }
    ...
    {
        $builder->addOffsetX(33, $updatedBy, 0);
    }
    ...
    {
        $builder->addOffsetX(34, $sourceDL, 0);
    }
     ...
     */
    public static function endAirfieldSlotConsumption_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirfieldSlotConsumption_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
