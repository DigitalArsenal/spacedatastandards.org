...
class FlightPlanPointGroups_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return FlightPlanPointGroups_Ingest
     */
    public static function getRootAsFlightPlanPointGroups_Ingest(ByteBuffer $bb)
    {
        $obj = new FlightPlanPointGroups_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function FlightPlanPointGroups_IngestIdentifier()
    {
        return "FLIG";
    }

    public static function FlightPlanPointGroups_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::FlightPlanPointGroups_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startFlightPlanPointGroups_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endFlightPlanPointGroups_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishFlightPlanPointGroups_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
