...
class EffectResponse_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EffectResponse_Ingest
     */
    public static function getRootAsEffectResponse_Ingest(ByteBuffer $bb)
    {
        $obj = new EffectResponse_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EffectResponse_IngestIdentifier()
    {
        return "EFFE";
    }

    public static function EffectResponse_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EffectResponse_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(50);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EffectResponse_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEffectResponse_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endEffectResponse_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEffectResponse_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
