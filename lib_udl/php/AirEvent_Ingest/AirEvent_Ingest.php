...
class AirEvent_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirEvent_Ingest
     */
    public static function getRootAsAirEvent_Ingest(ByteBuffer $bb)
    {
        $obj = new AirEvent_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirEvent_IngestIdentifier()
    {
        return "AIRE";
    }

    public static function AirEvent_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirEvent_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(90);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AirEvent_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAirEvent_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAirEvent_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirEvent_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
