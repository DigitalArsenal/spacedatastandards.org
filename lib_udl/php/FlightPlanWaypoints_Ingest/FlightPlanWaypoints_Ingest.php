...
class FlightPlanWaypoints_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return FlightPlanWaypoints_Ingest
     */
    public static function getRootAsFlightPlanWaypoints_Ingest(ByteBuffer $bb)
    {
        $obj = new FlightPlanWaypoints_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function FlightPlanWaypoints_IngestIdentifier()
    {
        return "FLIG";
    }

    public static function FlightPlanWaypoints_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::FlightPlanWaypoints_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startFlightPlanWaypoints_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endFlightPlanWaypoints_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishFlightPlanWaypoints_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
