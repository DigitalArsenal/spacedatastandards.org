...
class SortiePPR_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SortiePPR_Abridged
     */
    public static function getRootAsSortiePPR_Abridged(ByteBuffer $bb)
    {
        $obj = new SortiePPR_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SortiePPR_AbridgedIdentifier()
    {
        return "SORT";
    }

    public static function SortiePPR_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SortiePPR_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(22);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SortiePPR_Abridged_type_Enum::M;
    }
    ...
    {
        $o = $this->__offset(38);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \SortiePPR_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSortiePPR_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return SortiePPR_Abridged
     */
    public static function createSortiePPR_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $idSortie, $externalId, $number, $startTime, $endTime, $requestor, $grantor, $type, $remarks, $createdAt, $createdBy, $sourceDL, $source, $origin, $origNetwork, $dataMode)
    {
        $builder->startObject(18);
     ...
     */
    public static function endSortiePPR_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSortiePPR_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
