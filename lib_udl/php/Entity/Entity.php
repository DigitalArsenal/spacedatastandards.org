...
class Entity extends Table
{
     ...
     * @return Entity
     */
    public static function getRootAsEntity(ByteBuffer $bb)
    {
        $obj = new Entity();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EntityIdentifier()
    {
        return "ENTI";
    }

    public static function EntityBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EntityIdentifier());
    }
    ...
    {
        $o = $this->__offset(10);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Entity_type_Enum::AIRCRAFT;
    }
    ...
    {
        $o = $this->__offset(16);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Entity_ownerType_Enum::COMMERCIAL;
    }
    ...
    {
        $o = $this->__offset(34);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Entity_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEntity(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endEntity(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEntityBuffer(FlatBufferBuilder $builder, $offset)
    {
