...
class RFObservationDetails_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return RFObservationDetails_Ingest
     */
    public static function getRootAsRFObservationDetails_Ingest(ByteBuffer $bb)
    {
        $obj = new RFObservationDetails_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function RFObservationDetails_IngestIdentifier()
    {
        return "RFOB";
    }

    public static function RFObservationDetails_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RFObservationDetails_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(94);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFObservationDetails_Ingest_polarityType_Enum::H;
    }
    ...
    {
        $o = $this->__offset(134);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFObservationDetails_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startRFObservationDetails_Ingest(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(82, $frequencies, 0);
    }
    ...
    {
        $builder->addOffsetX(83, $powers, 0);
    }
    ...
    {
        $builder->addOffsetX(85, $confidences, 0);
    }
    ...
    {
        $builder->addOffsetX(86, $detectionStatuses, 0);
    }
    ...
    {
        $builder->addOffsetX(87, $chipRates, 0);
    }
    ...
    {
        $builder->addOffsetX(88, $codeTaps, 0);
    }
    ...
    {
        $builder->addOffsetX(89, $codeFills, 0);
    }
    ...
    {
        $builder->addOffsetX(90, $codeLengths, 0);
    }
    ...
    {
        $builder->addOffsetX(91, $pnOrders, 0);
    }
    ...
    {
        $builder->addOffsetX(92, $signalIds, 0);
    }
    ...
    {
        $builder->addOffsetX(93, $baudRates, 0);
    }
    ...
    {
        $builder->addOffsetX(94, $telemetryIds, 0);
    }
    ...
    {
        $builder->addOffsetX(95, $constellationXPoints, 0);
    }
    ...
    {
        $builder->addOffsetX(96, $constellationYPoints, 0);
    }
     ...
     */
    public static function endRFObservationDetails_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRFObservationDetails_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
