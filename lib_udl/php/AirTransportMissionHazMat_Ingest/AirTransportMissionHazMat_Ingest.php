...
class AirTransportMissionHazMat_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AirTransportMissionHazMat_Ingest
     */
    public static function getRootAsAirTransportMissionHazMat_Ingest(ByteBuffer $bb)
    {
        $obj = new AirTransportMissionHazMat_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AirTransportMissionHazMat_IngestIdentifier()
    {
        return "AIRT";
    }

    public static function AirTransportMissionHazMat_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AirTransportMissionHazMat_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startAirTransportMissionHazMat_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return AirTransportMissionHazMat_Ingest
     */
    public static function createAirTransportMissionHazMat_Ingest(FlatBufferBuilder $builder, $extHazMatId, $itemName, $unNum, $pieces, $weight, $netExpWt, $classDiv, $cgc, $cgn, $applicableNotes, $onItin, $onICAO, $offItin, $offICAO, $planned)
    {
        $builder->startObject(15);
     ...
     */
    public static function endAirTransportMissionHazMat_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAirTransportMissionHazMat_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
