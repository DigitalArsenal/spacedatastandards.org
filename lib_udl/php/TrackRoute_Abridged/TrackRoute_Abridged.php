...
class TrackRoute_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return TrackRoute_Abridged
     */
    public static function getRootAsTrackRoute_Abridged(ByteBuffer $bb)
    {
        $obj = new TrackRoute_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function TrackRoute_AbridgedIdentifier()
    {
        return "TRAC";
    }

    public static function TrackRoute_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::TrackRoute_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(78);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \TrackRoute_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startTrackRoute_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endTrackRoute_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishTrackRoute_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
