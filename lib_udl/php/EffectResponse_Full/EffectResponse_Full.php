...
class EffectResponse_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EffectResponse_Full
     */
    public static function getRootAsEffectResponse_Full(ByteBuffer $bb)
    {
        $obj = new EffectResponse_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EffectResponse_FullIdentifier()
    {
        return "EFFE";
    }

    public static function EffectResponse_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EffectResponse_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(50);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EffectResponse_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEffectResponse_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endEffectResponse_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEffectResponse_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
