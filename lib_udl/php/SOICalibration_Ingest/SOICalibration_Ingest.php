...
class SOICalibration_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SOICalibration_Ingest
     */
    public static function getRootAsSOICalibration_Ingest(ByteBuffer $bb)
    {
        $obj = new SOICalibration_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SOICalibration_IngestIdentifier()
    {
        return "SOIC";
    }

    public static function SOICalibration_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SOICalibration_IngestIdentifier());
    }
     ...
     * @return void
     */
    public static function startSOICalibration_Ingest(FlatBufferBuilder $builder)
    {
     ...
     * @return SOICalibration_Ingest
     */
    public static function createSOICalibration_Ingest(FlatBufferBuilder $builder, $calExtinctionCoeff, $calSkyBg, $calBgIntensity, $calSpectralFilterSolarMag, $calZeroPoint, $calNumDetectedStars, $calNumCorrelatedStars, $calExtinctionCoeffUnc, $calExtinctionCoeffMaxUnc, $calTime, $calType)
    {
        $builder->startObject(11);
     ...
     */
    public static function endSOICalibration_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSOICalibration_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
