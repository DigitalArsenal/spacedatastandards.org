...
class GNSSRawIF_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GNSSRawIF_Full
     */
    public static function getRootAsGNSSRawIF_Full(ByteBuffer $bb)
    {
        $obj = new GNSSRawIF_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function GNSSRawIF_FullIdentifier()
    {
        return "GNSS";
    }

    public static function GNSSRawIF_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::GNSSRawIF_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(80);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \GNSSRawIF_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startGNSSRawIF_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endGNSSRawIF_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishGNSSRawIF_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
