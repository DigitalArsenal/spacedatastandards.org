...
class DataLinkRefPoints_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return DataLinkRefPoints_Full
     */
    public static function getRootAsDataLinkRefPoints_Full(ByteBuffer $bb)
    {
        $obj = new DataLinkRefPoints_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function DataLinkRefPoints_FullIdentifier()
    {
        return "DATA";
    }

    public static function DataLinkRefPoints_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::DataLinkRefPoints_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startDataLinkRefPoints_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return DataLinkRefPoints_Full
     */
    public static function createDataLinkRefPoints_Full(FlatBufferBuilder $builder, $refPointType, $refDes, $refLocName, $refLat, $refLon, $effEventTime)
    {
        $builder->startObject(6);
     ...
     */
    public static function endDataLinkRefPoints_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishDataLinkRefPoints_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
