...
class LogisticsDiscrepancyInfos_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return LogisticsDiscrepancyInfos_Full
     */
    public static function getRootAsLogisticsDiscrepancyInfos_Full(ByteBuffer $bb)
    {
        $obj = new LogisticsDiscrepancyInfos_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function LogisticsDiscrepancyInfos_FullIdentifier()
    {
        return "LOGI";
    }

    public static function LogisticsDiscrepancyInfos_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::LogisticsDiscrepancyInfos_FullIdentifier());
    }
     ...
     * @return void
     */
    public static function startLogisticsDiscrepancyInfos_Full(FlatBufferBuilder $builder)
    {
     ...
     * @return LogisticsDiscrepancyInfos_Full
     */
    public static function createLogisticsDiscrepancyInfos_Full(FlatBufferBuilder $builder, $jcn, $discrepancyInfo, $jobStTime, $closureTime)
    {
        $builder->startObject(4);
     ...
     */
    public static function endLogisticsDiscrepancyInfos_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishLogisticsDiscrepancyInfos_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
