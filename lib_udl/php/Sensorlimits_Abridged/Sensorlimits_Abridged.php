...
class Sensorlimits_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Sensorlimits_Abridged
     */
    public static function getRootAsSensorlimits_Abridged(ByteBuffer $bb)
    {
        $obj = new Sensorlimits_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Sensorlimits_AbridgedIdentifier()
    {
        return "SENS";
    }

    public static function Sensorlimits_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Sensorlimits_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(28);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Sensorlimits_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startSensorlimits_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return Sensorlimits_Abridged
     */
    public static function createSensorlimits_Abridged(FlatBufferBuilder $builder, $idSensorLimits, $classificationMarking, $origNetwork, $upperLeftAzimuthLimit, $upperRightAzimuthLimit, $lowerRightAzimuthLimit, $lowerLeftAzimuthLimit, $lowerLeftElevationLimit, $upperLeftElevationLimit, $lowerRightElevationLimit, $upperRightElevationLimit, $source, $dataMode, $createdAt, $createdBy, $idSensor)
    {
        $builder->startObject(16);
    ...
    {
        $builder->addOffsetX(15, $idSensor, 0);
    }
     ...
     */
    public static function endSensorlimits_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSensorlimits_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
