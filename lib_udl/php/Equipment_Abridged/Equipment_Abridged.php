...
class Equipment_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Equipment_Abridged
     */
    public static function getRootAsEquipment_Abridged(ByteBuffer $bb)
    {
        $obj = new Equipment_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Equipment_AbridgedIdentifier()
    {
        return "EQUI";
    }

    public static function Equipment_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Equipment_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(108);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Equipment_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEquipment_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return Equipment_Abridged
     */
    public static function createEquipment_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $idParentEquipment, $idSite, $idOperatingUnit, $altEqpId, $eqpCode, $eqpIdNum, $countryCode, $altCountryCode, $wac, $seqNum, $nomen, $operStatus, $condition, $conditionAvail, $eval, $fpa, $function, $ident, $allegiance, $altAllegiance, $locReason, $operAreaPrimary, $functPrimary, $coordDatum, $coord, $coordDerivAcc, $lat, $lon, $elevMsl, $elevMslConfLvl, $elevMslDerivAcc, $geoidalMslSep, $milGridSys, $milGrid, $utm, $airDefArea, $polSubdiv, $qtyOH, $symCode, $classRating, $recStatus, $reviewDate, $resProd, $referenceDoc, $srcTyps, $srcIds, $createdAt, $createdBy, $source, $origin, $dataMode)
    {
        $builder->startObject(53);
     ...
     */
    public static function endEquipment_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEquipment_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
