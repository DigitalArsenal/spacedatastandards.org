...
class EffectRequest_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EffectRequest_Ingest
     */
    public static function getRootAsEffectRequest_Ingest(ByteBuffer $bb)
    {
        $obj = new EffectRequest_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EffectRequest_IngestIdentifier()
    {
        return "EFFE";
    }

    public static function EffectRequest_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EffectRequest_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(42);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EffectRequest_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEffectRequest_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endEffectRequest_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEffectRequest_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
