...
class OrganizationDetails_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return OrganizationDetails_Abridged
     */
    public static function getRootAsOrganizationDetails_Abridged(ByteBuffer $bb)
    {
        $obj = new OrganizationDetails_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function OrganizationDetails_AbridgedIdentifier()
    {
        return "ORGA";
    }

    public static function OrganizationDetails_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::OrganizationDetails_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(68);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \OrganizationDetails_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startOrganizationDetails_Abridged(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endOrganizationDetails_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishOrganizationDetails_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
