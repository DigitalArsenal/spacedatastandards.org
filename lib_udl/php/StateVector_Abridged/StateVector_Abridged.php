...
class StateVector_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return StateVector_Abridged
     */
    public static function getRootAsStateVector_Abridged(ByteBuffer $bb)
    {
        $obj = new StateVector_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function StateVector_AbridgedIdentifier()
    {
        return "STAT";
    }

    public static function StateVector_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::StateVector_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(34);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \StateVector_Abridged_referenceFrame_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(38);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \StateVector_Abridged_covReferenceFrame_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(172);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \StateVector_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startStateVector_Abridged(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(85, $algorithm, 0);
    }
    ...
    {
        $builder->addOffsetX(86, $createdAt, 0);
    }
    ...
    {
        $builder->addOffsetX(87, $createdBy, 0);
    }
    ...
    {
        $builder->addOffsetX(88, $descriptor, 0);
    }
    ...
    {
        $builder->addOffsetX(89, $transactionId, 0);
    }
     ...
     */
    public static function endStateVector_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishStateVector_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
