...
class TAIUTC_Abridged extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return TAIUTC_Abridged
     */
    public static function getRootAsTAIUTC_Abridged(ByteBuffer $bb)
    {
        $obj = new TAIUTC_Abridged();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function TAIUTC_AbridgedIdentifier()
    {
        return "TAIU";
    }

    public static function TAIUTC_AbridgedBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::TAIUTC_AbridgedIdentifier());
    }
    ...
    {
        $o = $this->__offset(22);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \TAIUTC_Abridged_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startTAIUTC_Abridged(FlatBufferBuilder $builder)
    {
     ...
     * @return TAIUTC_Abridged
     */
    public static function createTAIUTC_Abridged(FlatBufferBuilder $builder, $id, $classificationMarking, $adjustmentDate, $taiUTC, $multiplicationFactor, $rawFileURI, $source, $origin, $origNetwork, $dataMode, $createdAt, $createdBy)
    {
        $builder->startObject(12);
     ...
     */
    public static function endTAIUTC_Abridged(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishTAIUTC_AbridgedBuffer(FlatBufferBuilder $builder, $offset)
    {
