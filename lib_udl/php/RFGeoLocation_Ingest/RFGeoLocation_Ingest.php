...
class RFGeoLocation_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return RFGeoLocation_Ingest
     */
    public static function getRootAsRFGeoLocation_Ingest(ByteBuffer $bb)
    {
        $obj = new RFGeoLocation_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function RFGeoLocation_IngestIdentifier()
    {
        return "RFGE";
    }

    public static function RFGeoLocation_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RFGeoLocation_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(86);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \RFGeoLocation_Ingest_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startRFGeoLocation_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endRFGeoLocation_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRFGeoLocation_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
