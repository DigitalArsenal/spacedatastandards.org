...
class Maneuver_Ingest extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return Maneuver_Ingest
     */
    public static function getRootAsManeuver_Ingest(ByteBuffer $bb)
    {
        $obj = new Maneuver_Ingest();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function Maneuver_IngestIdentifier()
    {
        return "MANE";
    }

    public static function Maneuver_IngestBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::Maneuver_IngestIdentifier());
    }
    ...
    {
        $o = $this->__offset(182);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Maneuver_Ingest_dataMode_Enum::REAL;
    }
    ...
    {
        $o = $this->__offset(194);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \Maneuver_Ingest_sourcedDataTypes_Enum::EO;
    }
     ...
     * @return void
     */
    public static function startManeuver_Ingest(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endManeuver_Ingest(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishManeuver_IngestBuffer(FlatBufferBuilder $builder, $offset)
    {
