...
class AntennaDetails_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return AntennaDetails_Full
     */
    public static function getRootAsAntennaDetails_Full(ByteBuffer $bb)
    {
        $obj = new AntennaDetails_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function AntennaDetails_FullIdentifier()
    {
        return "ANTE";
    }

    public static function AntennaDetails_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::AntennaDetails_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(14);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AntennaDetails_Full_mode_Enum::TX;
    }
    ...
    {
        $o = $this->__offset(54);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \AntennaDetails_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startAntennaDetails_Full(FlatBufferBuilder $builder)
    {
     ...
     */
    public static function endAntennaDetails_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishAntennaDetails_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
