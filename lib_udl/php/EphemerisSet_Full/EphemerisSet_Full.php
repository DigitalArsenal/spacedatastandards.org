...
class EphemerisSet_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return EphemerisSet_Full
     */
    public static function getRootAsEphemerisSet_Full(ByteBuffer $bb)
    {
        $obj = new EphemerisSet_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function EphemerisSet_FullIdentifier()
    {
        return "EPHE";
    }

    public static function EphemerisSet_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::EphemerisSet_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(68);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EphemerisSet_Full_referenceFrame_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(70);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EphemerisSet_Full_covReferenceFrame_Enum::J2000;
    }
    ...
    {
        $o = $this->__offset(80);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \EphemerisSet_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startEphemerisSet_Full(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(39, $stateVector, 0);
    }
    ...
    {
        $builder->addOffsetX(41, $ephemerisList, 0);
    }
    ...
    {
        $builder->addOffsetX(44, $transactionId, 0);
    }
     ...
     */
    public static function endEphemerisSet_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishEphemerisSet_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
