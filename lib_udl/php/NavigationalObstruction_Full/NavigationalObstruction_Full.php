...
class NavigationalObstruction_Full extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return NavigationalObstruction_Full
     */
    public static function getRootAsNavigationalObstruction_Full(ByteBuffer $bb)
    {
        $obj = new NavigationalObstruction_Full();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function NavigationalObstruction_FullIdentifier()
    {
        return "NAVI";
    }

    public static function NavigationalObstruction_FullBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::NavigationalObstruction_FullIdentifier());
    }
    ...
    {
        $o = $this->__offset(160);
        return $o != 0 ? $this->bb->getSbyte($o + $this->bb_pos) : \NavigationalObstruction_Full_dataMode_Enum::REAL;
    }
     ...
     * @return void
     */
    public static function startNavigationalObstruction_Full(FlatBufferBuilder $builder)
    {
    ...
    {
        $builder->addOffsetX(72, $updatedAt, 0);
    }
    ...
    {
        $builder->addOffsetX(73, $updatedBy, 0);
    }
    ...
    {
        $builder->addOffsetX(74, $sourceDL, 0);
    }
     ...
     */
    public static function endNavigationalObstruction_Full(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishNavigationalObstruction_FullBuffer(FlatBufferBuilder $builder, $offset)
    {
