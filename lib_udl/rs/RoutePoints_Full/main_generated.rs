...
pub enum RoutePoints_FullOffset {}
#[derive(Copy, Clone, PartialEq)]

/// /// Points identified within the route.
pub struct RoutePoints_Full<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for RoutePoints_Full<'a> {
  type Inner = RoutePoints_Full<'a>;
  #[inline]
...
impl<'a> RoutePoints_Full<'a> {
  ...
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    RoutePoints_Full { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args RoutePoints_FullArgs<'args>
  ) -> flatbuffers::WIPOffset<RoutePoints_Full<'bldr>> {
    let mut builder = RoutePoints_FullBuilder::new(_fbb);
  ...
  pub fn unpack(&self) -> RoutePoints_FullT {
  ...
  pub fn ptSequenceId(&self) -> i32 {
    ...
    unsafe { self._tab.get::<i32>(RoutePoints_Full::VT_PTSEQUENCEID, Some(0)).unwrap()}
  }
  ...
  pub fn ptTypeCode(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(RoutePoints_Full::VT_PTTYPECODE, None)}
  }
  ...
  pub fn ptTypeName(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(RoutePoints_Full::VT_PTTYPENAME, None)}
  }
  ...
  pub fn waypointName(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(RoutePoints_Full::VT_WAYPOINTNAME, None)}
  }
  ...
  pub fn dafifPt(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(RoutePoints_Full::VT_DAFIFPT, Some(false)).unwrap()}
  }
  ...
  pub fn ptLat(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(RoutePoints_Full::VT_PTLAT, Some(0.0)).unwrap()}
  }
  ...
  pub fn ptLon(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(RoutePoints_Full::VT_PTLON, Some(0.0)).unwrap()}
  }
  ...
  pub fn magDec(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(RoutePoints_Full::VT_MAGDEC, Some(0.0)).unwrap()}
  }
  ...
  pub fn navaidLength(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(RoutePoints_Full::VT_NAVAIDLENGTH, Some(0.0)).unwrap()}
  }
  ...
  pub fn navaid(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(RoutePoints_Full::VT_NAVAID, None)}
  }
  ...
  pub fn countryCode(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(RoutePoints_Full::VT_COUNTRYCODE, None)}
  }
  ...
  pub fn altCountryCode(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(RoutePoints_Full::VT_ALTCOUNTRYCODE, None)}
  }
  ...
  pub fn navaidType(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(RoutePoints_Full::VT_NAVAIDTYPE, None)}
  }
}

impl flatbuffers::Verifiable for RoutePoints_Full<'_> {
  #[inline]
  fn run_verifier(
...
pub struct RoutePoints_FullArgs<'a> {
...
impl<'a> Default for RoutePoints_FullArgs<'a> {
  #[inline]
  fn default() -> Self {
    RoutePoints_FullArgs {
      ptSequenceId: 0,
      ptTypeCode: None,
      ptTypeName: None,
      waypointName: None,
...
pub struct RoutePoints_FullBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RoutePoints_FullBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_ptSequenceId(&mut self, ptSequenceId: i32) {
    self.fbb_.push_slot::<i32>(RoutePoints_Full::VT_PTSEQUENCEID, ptSequenceId, 0);
  }
  #[inline]
  pub fn add_ptTypeCode(&mut self, ptTypeCode: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RoutePoints_Full::VT_PTTYPECODE, ptTypeCode);
  }
  #[inline]
  pub fn add_ptTypeName(&mut self, ptTypeName: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RoutePoints_Full::VT_PTTYPENAME, ptTypeName);
  }
  #[inline]
  pub fn add_waypointName(&mut self, waypointName: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RoutePoints_Full::VT_WAYPOINTNAME, waypointName);
  }
  #[inline]
  pub fn add_dafifPt(&mut self, dafifPt: bool) {
    self.fbb_.push_slot::<bool>(RoutePoints_Full::VT_DAFIFPT, dafifPt, false);
  }
  #[inline]
  pub fn add_ptLat(&mut self, ptLat: f64) {
    self.fbb_.push_slot::<f64>(RoutePoints_Full::VT_PTLAT, ptLat, 0.0);
  }
  #[inline]
  pub fn add_ptLon(&mut self, ptLon: f64) {
    self.fbb_.push_slot::<f64>(RoutePoints_Full::VT_PTLON, ptLon, 0.0);
  }
  #[inline]
  pub fn add_magDec(&mut self, magDec: f64) {
    self.fbb_.push_slot::<f64>(RoutePoints_Full::VT_MAGDEC, magDec, 0.0);
  }
  #[inline]
  pub fn add_navaidLength(&mut self, navaidLength: f64) {
    self.fbb_.push_slot::<f64>(RoutePoints_Full::VT_NAVAIDLENGTH, navaidLength, 0.0);
  }
  #[inline]
  pub fn add_navaid(&mut self, navaid: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RoutePoints_Full::VT_NAVAID, navaid);
  }
  #[inline]
  pub fn add_countryCode(&mut self, countryCode: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RoutePoints_Full::VT_COUNTRYCODE, countryCode);
  }
  #[inline]
  pub fn add_altCountryCode(&mut self, altCountryCode: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RoutePoints_Full::VT_ALTCOUNTRYCODE, altCountryCode);
  }
  #[inline]
  pub fn add_navaidType(&mut self, navaidType: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RoutePoints_Full::VT_NAVAIDTYPE, navaidType);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> RoutePoints_FullBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    RoutePoints_FullBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<RoutePoints_Full<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for RoutePoints_Full<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("RoutePoints_Full");
...
impl Default for RoutePoints_FullT {
  fn default() -> Self {
    Self {
      ptSequenceId: 0,
      ptTypeCode: None,
...
impl RoutePoints_FullT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>
  ) -> flatbuffers::WIPOffset<RoutePoints_Full<'b>> {
    let ptSequenceId = self.ptSequenceId;
    ...
    RoutePoints_Full::create(_fbb, &RoutePoints_FullArgs{
      ptSequenceId,
      ptTypeCode,
      ptTypeName,
      waypointName,
...
#[inline]
/// Verifies that a buffer of bytes contains a `RoutePoints_Full`
/// and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_route_points_full_unchecked`.
pub fn root_as_route_points_full(buf: &[u8]) -> Result<RoutePoints_Full, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root::<RoutePoints_Full>(buf)
}
#[inline]
/// Verifies that a buffer of bytes contains a size prefixed
/// `RoutePoints_Full` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `size_prefixed_root_as_route_points_full_unchecked`.
pub fn size_prefixed_root_as_route_points_full(buf: &[u8]) -> Result<RoutePoints_Full, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root::<RoutePoints_Full>(buf)
}
#[inline]
/// Verifies, with the given options, that a buffer of bytes
/// contains a `RoutePoints_Full` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_route_points_full_unchecked`.
pub fn root_as_route_points_full_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<RoutePoints_Full<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root_with_opts::<RoutePoints_Full<'b>>(opts, buf)
}
#[inline]
/// Verifies, with the given verifier options, that a buffer of
/// bytes contains a size prefixed `RoutePoints_Full` and returns
/// it. Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_route_points_full_unchecked`.
pub fn size_prefixed_root_as_route_points_full_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<RoutePoints_Full<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root_with_opts::<RoutePoints_Full<'b>>(opts, buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a RoutePoints_Full and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid `RoutePoints_Full`.
pub unsafe fn root_as_route_points_full_unchecked(buf: &[u8]) -> RoutePoints_Full {
  flatbuffers::root_unchecked::<RoutePoints_Full>(buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed RoutePoints_Full and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid size prefixed `RoutePoints_Full`.
pub unsafe fn size_prefixed_root_as_route_points_full_unchecked(buf: &[u8]) -> RoutePoints_Full {
  flatbuffers::size_prefixed_root_unchecked::<RoutePoints_Full>(buf)
}
pub const ROUTE_POINTS_FULL_IDENTIFIER: &str = "ROUT";

#[inline]
pub fn route_points_full_buffer_has_identifier(buf: &[u8]) -> bool {
  flatbuffers::buffer_has_identifier(buf, ROUTE_POINTS_FULL_IDENTIFIER, false)
}

#[inline]
pub fn route_points_full_size_prefixed_buffer_has_identifier(buf: &[u8]) -> bool {
  flatbuffers::buffer_has_identifier(buf, ROUTE_POINTS_FULL_IDENTIFIER, true)
}

#[inline]
pub fn finish_route_points_full_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    root: flatbuffers::WIPOffset<RoutePoints_Full<'a>>) {
  fbb.finish(root, Some(ROUTE_POINTS_FULL_IDENTIFIER));
}

#[inline]
pub fn finish_size_prefixed_route_points_full_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<RoutePoints_Full<'a>>) {
  fbb.finish_size_prefixed(root, Some(ROUTE_POINTS_FULL_IDENTIFIER));
}
