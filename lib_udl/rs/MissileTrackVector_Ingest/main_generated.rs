...
pub enum MissileTrackVector_IngestOffset {}
#[derive(Copy, Clone, PartialEq)]

/// /// Schema for Missile Track Vector data.
pub struct MissileTrackVector_Ingest<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for MissileTrackVector_Ingest<'a> {
  type Inner = MissileTrackVector_Ingest<'a>;
  #[inline]
...
impl<'a> MissileTrackVector_Ingest<'a> {
  ...
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    MissileTrackVector_Ingest { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args MissileTrackVector_IngestArgs<'args>
  ) -> flatbuffers::WIPOffset<MissileTrackVector_Ingest<'bldr>> {
    let mut builder = MissileTrackVector_IngestBuilder::new(_fbb);
  ...
  pub fn unpack(&self) -> MissileTrackVector_IngestT {
  ...
  pub fn type_(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MissileTrackVector_Ingest::VT_TYPE_, None)}
  }
  ...
  pub fn object(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MissileTrackVector_Ingest::VT_OBJECT, None)}
  }
  ...
  pub fn epoch(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MissileTrackVector_Ingest::VT_EPOCH, None)}
  }
  ...
  pub fn idSensor(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MissileTrackVector_Ingest::VT_IDSENSOR, None)}
  }
  ...
  pub fn origSensorId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MissileTrackVector_Ingest::VT_ORIGSENSORID, None)}
  }
  ...
  pub fn pos(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(MissileTrackVector_Ingest::VT_POS, None)}
  }
  ...
  pub fn vel(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(MissileTrackVector_Ingest::VT_VEL, None)}
  }
  ...
  pub fn accel(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(MissileTrackVector_Ingest::VT_ACCEL, None)}
  }
  ...
  pub fn course(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(MissileTrackVector_Ingest::VT_COURSE, Some(0.0)).unwrap()}
  }
  ...
  pub fn spd(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(MissileTrackVector_Ingest::VT_SPD, Some(0.0)).unwrap()}
  }
  ...
  pub fn referenceFrame(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MissileTrackVector_Ingest::VT_REFERENCEFRAME, None)}
  }
  ...
  pub fn cov(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(MissileTrackVector_Ingest::VT_COV, None)}
  }
  ...
  pub fn covReferenceFrame(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MissileTrackVector_Ingest::VT_COVREFERENCEFRAME, None)}
  }
  ...
  pub fn vectorLat(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(MissileTrackVector_Ingest::VT_VECTORLAT, Some(0.0)).unwrap()}
  }
  ...
  pub fn vectorLon(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(MissileTrackVector_Ingest::VT_VECTORLON, Some(0.0)).unwrap()}
  }
  ...
  pub fn vectorAlt(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(MissileTrackVector_Ingest::VT_VECTORALT, Some(0.0)).unwrap()}
  }
  ...
  pub fn confidence(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(MissileTrackVector_Ingest::VT_CONFIDENCE, Some(0)).unwrap()}
  }
  ...
  pub fn status(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MissileTrackVector_Ingest::VT_STATUS, None)}
  }
  ...
  pub fn timeSource(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(MissileTrackVector_Ingest::VT_TIMESOURCE, None)}
  }
  ...
  pub fn quat(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(MissileTrackVector_Ingest::VT_QUAT, None)}
  }
  ...
  pub fn flightAz(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(MissileTrackVector_Ingest::VT_FLIGHTAZ, Some(0.0)).unwrap()}
  }
}

impl flatbuffers::Verifiable for MissileTrackVector_Ingest<'_> {
  #[inline]
  fn run_verifier(
...
pub struct MissileTrackVector_IngestArgs<'a> {
...
impl<'a> Default for MissileTrackVector_IngestArgs<'a> {
  #[inline]
  fn default() -> Self {
    MissileTrackVector_IngestArgs {
      type_: None,
      object: None,
      epoch: None,
      idSensor: None,
...
pub struct MissileTrackVector_IngestBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MissileTrackVector_IngestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_type_(&mut self, type_: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MissileTrackVector_Ingest::VT_TYPE_, type_);
  }
  #[inline]
  pub fn add_object(&mut self, object: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MissileTrackVector_Ingest::VT_OBJECT, object);
  }
  #[inline]
  pub fn add_epoch(&mut self, epoch: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MissileTrackVector_Ingest::VT_EPOCH, epoch);
  }
  #[inline]
  pub fn add_idSensor(&mut self, idSensor: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MissileTrackVector_Ingest::VT_IDSENSOR, idSensor);
  }
  #[inline]
  pub fn add_origSensorId(&mut self, origSensorId: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MissileTrackVector_Ingest::VT_ORIGSENSORID, origSensorId);
  }
  #[inline]
  pub fn add_pos(&mut self, pos: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MissileTrackVector_Ingest::VT_POS, pos);
  }
  #[inline]
  pub fn add_vel(&mut self, vel: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MissileTrackVector_Ingest::VT_VEL, vel);
  }
  #[inline]
  pub fn add_accel(&mut self, accel: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MissileTrackVector_Ingest::VT_ACCEL, accel);
  }
  #[inline]
  pub fn add_course(&mut self, course: f64) {
    self.fbb_.push_slot::<f64>(MissileTrackVector_Ingest::VT_COURSE, course, 0.0);
  }
  #[inline]
  pub fn add_spd(&mut self, spd: f64) {
    self.fbb_.push_slot::<f64>(MissileTrackVector_Ingest::VT_SPD, spd, 0.0);
  }
  #[inline]
  pub fn add_referenceFrame(&mut self, referenceFrame: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MissileTrackVector_Ingest::VT_REFERENCEFRAME, referenceFrame);
  }
  #[inline]
  pub fn add_cov(&mut self, cov: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MissileTrackVector_Ingest::VT_COV, cov);
  }
  #[inline]
  pub fn add_covReferenceFrame(&mut self, covReferenceFrame: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MissileTrackVector_Ingest::VT_COVREFERENCEFRAME, covReferenceFrame);
  }
  #[inline]
  pub fn add_vectorLat(&mut self, vectorLat: f64) {
    self.fbb_.push_slot::<f64>(MissileTrackVector_Ingest::VT_VECTORLAT, vectorLat, 0.0);
  }
  #[inline]
  pub fn add_vectorLon(&mut self, vectorLon: f64) {
    self.fbb_.push_slot::<f64>(MissileTrackVector_Ingest::VT_VECTORLON, vectorLon, 0.0);
  }
  #[inline]
  pub fn add_vectorAlt(&mut self, vectorAlt: f64) {
    self.fbb_.push_slot::<f64>(MissileTrackVector_Ingest::VT_VECTORALT, vectorAlt, 0.0);
  }
  #[inline]
  pub fn add_confidence(&mut self, confidence: i32) {
    self.fbb_.push_slot::<i32>(MissileTrackVector_Ingest::VT_CONFIDENCE, confidence, 0);
  }
  #[inline]
  pub fn add_status(&mut self, status: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MissileTrackVector_Ingest::VT_STATUS, status);
  }
  #[inline]
  pub fn add_timeSource(&mut self, timeSource: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MissileTrackVector_Ingest::VT_TIMESOURCE, timeSource);
  }
  #[inline]
  pub fn add_quat(&mut self, quat: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MissileTrackVector_Ingest::VT_QUAT, quat);
  }
  #[inline]
  pub fn add_flightAz(&mut self, flightAz: f64) {
    self.fbb_.push_slot::<f64>(MissileTrackVector_Ingest::VT_FLIGHTAZ, flightAz, 0.0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> MissileTrackVector_IngestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    MissileTrackVector_IngestBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<MissileTrackVector_Ingest<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for MissileTrackVector_Ingest<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("MissileTrackVector_Ingest");
...
pub struct MissileTrackVector_IngestT {
...
impl Default for MissileTrackVector_IngestT {
  fn default() -> Self {
    Self {
      type_: None,
      object: None,
...
impl MissileTrackVector_IngestT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>
  ) -> flatbuffers::WIPOffset<MissileTrackVector_Ingest<'b>> {
    ...
    let flightAz = self.flightAz;
    MissileTrackVector_Ingest::create(_fbb, &MissileTrackVector_IngestArgs{
      type_,
      object,
      epoch,
      idSensor,
...
#[inline]
/// Verifies that a buffer of bytes contains a `MissileTrackVector_Ingest`
/// and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_missile_track_vector_ingest_unchecked`.
pub fn root_as_missile_track_vector_ingest(buf: &[u8]) -> Result<MissileTrackVector_Ingest, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root::<MissileTrackVector_Ingest>(buf)
}
#[inline]
/// Verifies that a buffer of bytes contains a size prefixed
/// `MissileTrackVector_Ingest` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `size_prefixed_root_as_missile_track_vector_ingest_unchecked`.
pub fn size_prefixed_root_as_missile_track_vector_ingest(buf: &[u8]) -> Result<MissileTrackVector_Ingest, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root::<MissileTrackVector_Ingest>(buf)
}
#[inline]
/// Verifies, with the given options, that a buffer of bytes
/// contains a `MissileTrackVector_Ingest` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_missile_track_vector_ingest_unchecked`.
pub fn root_as_missile_track_vector_ingest_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<MissileTrackVector_Ingest<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root_with_opts::<MissileTrackVector_Ingest<'b>>(opts, buf)
}
#[inline]
/// Verifies, with the given verifier options, that a buffer of
/// bytes contains a size prefixed `MissileTrackVector_Ingest` and returns
/// it. Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_missile_track_vector_ingest_unchecked`.
pub fn size_prefixed_root_as_missile_track_vector_ingest_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<MissileTrackVector_Ingest<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root_with_opts::<MissileTrackVector_Ingest<'b>>(opts, buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a MissileTrackVector_Ingest and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid `MissileTrackVector_Ingest`.
pub unsafe fn root_as_missile_track_vector_ingest_unchecked(buf: &[u8]) -> MissileTrackVector_Ingest {
  flatbuffers::root_unchecked::<MissileTrackVector_Ingest>(buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed MissileTrackVector_Ingest and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid size prefixed `MissileTrackVector_Ingest`.
pub unsafe fn size_prefixed_root_as_missile_track_vector_ingest_unchecked(buf: &[u8]) -> MissileTrackVector_Ingest {
  flatbuffers::size_prefixed_root_unchecked::<MissileTrackVector_Ingest>(buf)
}
pub const MISSILE_TRACK_VECTOR_INGEST_IDENTIFIER: &str = "MISS";

#[inline]
pub fn missile_track_vector_ingest_buffer_has_identifier(buf: &[u8]) -> bool {
  flatbuffers::buffer_has_identifier(buf, MISSILE_TRACK_VECTOR_INGEST_IDENTIFIER, false)
}

#[inline]
pub fn missile_track_vector_ingest_size_prefixed_buffer_has_identifier(buf: &[u8]) -> bool {
  flatbuffers::buffer_has_identifier(buf, MISSILE_TRACK_VECTOR_INGEST_IDENTIFIER, true)
}

#[inline]
pub fn finish_missile_track_vector_ingest_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    root: flatbuffers::WIPOffset<MissileTrackVector_Ingest<'a>>) {
  fbb.finish(root, Some(MISSILE_TRACK_VECTOR_INGEST_IDENTIFIER));
}

#[inline]
pub fn finish_size_prefixed_missile_track_vector_ingest_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<MissileTrackVector_Ingest<'a>>) {
  fbb.finish_size_prefixed(root, Some(MISSILE_TRACK_VECTOR_INGEST_IDENTIFIER));
}
