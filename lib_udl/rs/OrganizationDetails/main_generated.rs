...
pub const ENUM_MIN_ORGANIZATION_DETAILS_DATA_MODE_ENUM: i8 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_ORGANIZATION_DETAILS_DATA_MODE_ENUM: i8 = 3;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ORGANIZATION_DETAILS_DATA_MODE_ENUM: [OrganizationDetails_dataMode_Enum; 4] = [
  OrganizationDetails_dataMode_Enum::REAL,
  OrganizationDetails_dataMode_Enum::TEST,
  OrganizationDetails_dataMode_Enum::SIMULATED,
  OrganizationDetails_dataMode_Enum::EXERCISE,
];

#[derive(Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Default)]
#[repr(transparent)]
pub struct OrganizationDetails_dataMode_Enum(pub i8);
#[allow(non_upper_case_globals)]
impl OrganizationDetails_dataMode_Enum {
...
impl core::fmt::Debug for OrganizationDetails_dataMode_Enum {
...
impl<'a> flatbuffers::Follow<'a> for OrganizationDetails_dataMode_Enum {
  type Inner = Self;
  #[inline]
...
impl flatbuffers::Push for OrganizationDetails_dataMode_Enum {
    type Output = OrganizationDetails_dataMode_Enum;
    #[inline]
...
impl flatbuffers::EndianScalar for OrganizationDetails_dataMode_Enum {
  type Scalar = i8;
  #[inline]
...
impl<'a> flatbuffers::Verifiable for OrganizationDetails_dataMode_Enum {
  #[inline]
  fn run_verifier(
...
impl flatbuffers::SimpleToVerifyInSlice for OrganizationDetails_dataMode_Enum {}
pub enum OrganizationDetailsOffset {}
#[derive(Copy, Clone, PartialEq)]

/// /// Model representation of additional detailed organization data as collected by a particular source.
pub struct OrganizationDetails<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for OrganizationDetails<'a> {
  type Inner = OrganizationDetails<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
...
impl<'a> OrganizationDetails<'a> {
  ...
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    OrganizationDetails { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args OrganizationDetailsArgs<'args>
  ) -> flatbuffers::WIPOffset<OrganizationDetails<'bldr>> {
    let mut builder = OrganizationDetailsBuilder::new(_fbb);
  ...
  pub fn unpack(&self) -> OrganizationDetailsT {
  ...
  pub fn id(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_ID, None)}
  }
  ...
  pub fn idOrganization(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_IDORGANIZATION, None)}
  }
  ...
  pub fn classificationMarking(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_CLASSIFICATIONMARKING, None)}
  }
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_NAME, None)}
  }
  ...
  pub fn email(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_EMAIL, None)}
  }
  ...
  pub fn address1(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_ADDRESS1, None)}
  }
  ...
  pub fn address2(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_ADDRESS2, None)}
  }
  ...
  pub fn address3(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_ADDRESS3, None)}
  }
  ...
  pub fn geoAdminLevel1(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_GEOADMINLEVEL1, None)}
  }
  ...
  pub fn geoAdminLevel2(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_GEOADMINLEVEL2, None)}
  }
  ...
  pub fn geoAdminLevel3(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_GEOADMINLEVEL3, None)}
  }
  ...
  pub fn postalCode(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_POSTALCODE, None)}
  }
  ...
  pub fn description(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_DESCRIPTION, None)}
  }
  ...
  pub fn formerOrgId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_FORMERORGID, None)}
  }
  ...
  pub fn parentOrgId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_PARENTORGID, None)}
  }
  ...
  pub fn financialYearEndDate(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_FINANCIALYEARENDDATE, None)}
  }
  ...
  pub fn revenue(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(OrganizationDetails::VT_REVENUE, Some(0.0)).unwrap()}
  }
  ...
  pub fn profit(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(OrganizationDetails::VT_PROFIT, Some(0.0)).unwrap()}
  }
  ...
  pub fn ebitda(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(OrganizationDetails::VT_EBITDA, Some(0.0)).unwrap()}
  }
  ...
  pub fn ftes(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(OrganizationDetails::VT_FTES, Some(0)).unwrap()}
  }
  ...
  pub fn broker(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_BROKER, None)}
  }
  ...
  pub fn ceo(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_CEO, None)}
  }
  ...
  pub fn cfo(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_CFO, None)}
  }
  ...
  pub fn cto(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_CTO, None)}
  }
  ...
  pub fn riskManager(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_RISKMANAGER, None)}
  }
  ...
  pub fn massRanking(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(OrganizationDetails::VT_MASSRANKING, Some(0)).unwrap()}
  }
  ...
  pub fn revenueRanking(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(OrganizationDetails::VT_REVENUERANKING, Some(0)).unwrap()}
  }
  ...
  pub fn financialNotes(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_FINANCIALNOTES, None)}
  }
  ...
  pub fn servicesNotes(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_SERVICESNOTES, None)}
  }
  ...
  pub fn fleetPlanNotes(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_FLEETPLANNOTES, None)}
  }
  /// Source of the data.
  /// Example: /// Example: some.user
  ...
  pub fn source(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_SOURCE, None)}
  }
  ...
  pub fn origin(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_ORIGIN, None)}
  }
  ...
  #[inline]
  pub fn dataMode(&self) -> OrganizationDetails_dataMode_Enum {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<OrganizationDetails_dataMode_Enum>(OrganizationDetails::VT_DATAMODE, Some(OrganizationDetails_dataMode_Enum::REAL)).unwrap()}
  }
  ...
  pub fn tags(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(OrganizationDetails::VT_TAGS, None)}
  }
  ...
  pub fn createdAt(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_CREATEDAT, None)}
  }
  ...
  pub fn createdBy(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_CREATEDBY, None)}
  }
  ...
  pub fn updatedAt(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_UPDATEDAT, None)}
  }
  ...
  pub fn updatedBy(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_UPDATEDBY, None)}
  }
  ...
  pub fn origNetwork(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OrganizationDetails::VT_ORIGNETWORK, None)}
  }
}

impl flatbuffers::Verifiable for OrganizationDetails<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<OrganizationDetails_dataMode_Enum>("dataMode", Self::VT_DATAMODE, false)?
...
pub struct OrganizationDetailsArgs<'a> {
    ...
    pub dataMode: OrganizationDetails_dataMode_Enum,
...
impl<'a> Default for OrganizationDetailsArgs<'a> {
  #[inline]
  fn default() -> Self {
    OrganizationDetailsArgs {
      id: None,
      idOrganization: None,
      ...
      source: None,
      origin: None,
      dataMode: OrganizationDetails_dataMode_Enum::REAL,
      tags: None,
      createdAt: None,
      createdBy: None,
      updatedAt: None,
...
pub struct OrganizationDetailsBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> OrganizationDetailsBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_id(&mut self, id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_ID, id);
  }
  #[inline]
  pub fn add_idOrganization(&mut self, idOrganization: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_IDORGANIZATION, idOrganization);
  }
  #[inline]
  pub fn add_classificationMarking(&mut self, classificationMarking: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  #[inline]
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_NAME, name);
  }
  #[inline]
  pub fn add_email(&mut self, email: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_EMAIL, email);
  }
  #[inline]
  pub fn add_address1(&mut self, address1: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_ADDRESS1, address1);
  }
  #[inline]
  pub fn add_address2(&mut self, address2: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_ADDRESS2, address2);
  }
  #[inline]
  pub fn add_address3(&mut self, address3: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_ADDRESS3, address3);
  }
  #[inline]
  pub fn add_geoAdminLevel1(&mut self, geoAdminLevel1: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_GEOADMINLEVEL1, geoAdminLevel1);
  }
  #[inline]
  pub fn add_geoAdminLevel2(&mut self, geoAdminLevel2: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_GEOADMINLEVEL2, geoAdminLevel2);
  }
  #[inline]
  pub fn add_geoAdminLevel3(&mut self, geoAdminLevel3: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_GEOADMINLEVEL3, geoAdminLevel3);
  }
  #[inline]
  pub fn add_postalCode(&mut self, postalCode: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_POSTALCODE, postalCode);
  }
  #[inline]
  pub fn add_description(&mut self, description: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_DESCRIPTION, description);
  }
  #[inline]
  pub fn add_formerOrgId(&mut self, formerOrgId: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_FORMERORGID, formerOrgId);
  }
  #[inline]
  pub fn add_parentOrgId(&mut self, parentOrgId: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_PARENTORGID, parentOrgId);
  }
  #[inline]
  pub fn add_financialYearEndDate(&mut self, financialYearEndDate: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_FINANCIALYEARENDDATE, financialYearEndDate);
  }
  #[inline]
  pub fn add_revenue(&mut self, revenue: f64) {
    self.fbb_.push_slot::<f64>(OrganizationDetails::VT_REVENUE, revenue, 0.0);
  }
  #[inline]
  pub fn add_profit(&mut self, profit: f64) {
    self.fbb_.push_slot::<f64>(OrganizationDetails::VT_PROFIT, profit, 0.0);
  }
  #[inline]
  pub fn add_ebitda(&mut self, ebitda: f64) {
    self.fbb_.push_slot::<f64>(OrganizationDetails::VT_EBITDA, ebitda, 0.0);
  }
  #[inline]
  pub fn add_ftes(&mut self, ftes: i32) {
    self.fbb_.push_slot::<i32>(OrganizationDetails::VT_FTES, ftes, 0);
  }
  #[inline]
  pub fn add_broker(&mut self, broker: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_BROKER, broker);
  }
  #[inline]
  pub fn add_ceo(&mut self, ceo: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_CEO, ceo);
  }
  #[inline]
  pub fn add_cfo(&mut self, cfo: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_CFO, cfo);
  }
  #[inline]
  pub fn add_cto(&mut self, cto: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_CTO, cto);
  }
  #[inline]
  pub fn add_riskManager(&mut self, riskManager: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_RISKMANAGER, riskManager);
  }
  #[inline]
  pub fn add_massRanking(&mut self, massRanking: i32) {
    self.fbb_.push_slot::<i32>(OrganizationDetails::VT_MASSRANKING, massRanking, 0);
  }
  #[inline]
  pub fn add_revenueRanking(&mut self, revenueRanking: i32) {
    self.fbb_.push_slot::<i32>(OrganizationDetails::VT_REVENUERANKING, revenueRanking, 0);
  }
  #[inline]
  pub fn add_financialNotes(&mut self, financialNotes: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_FINANCIALNOTES, financialNotes);
  }
  #[inline]
  pub fn add_servicesNotes(&mut self, servicesNotes: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_SERVICESNOTES, servicesNotes);
  }
  #[inline]
  pub fn add_fleetPlanNotes(&mut self, fleetPlanNotes: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_FLEETPLANNOTES, fleetPlanNotes);
  }
  #[inline]
  pub fn add_source(&mut self, source: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_SOURCE, source);
  }
  #[inline]
  pub fn add_origin(&mut self, origin: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_ORIGIN, origin);
  }
  #[inline]
  pub fn add_dataMode(&mut self, dataMode: OrganizationDetails_dataMode_Enum) {
    self.fbb_.push_slot::<OrganizationDetails_dataMode_Enum>(OrganizationDetails::VT_DATAMODE, dataMode, OrganizationDetails_dataMode_Enum::REAL);
  }
  #[inline]
  pub fn add_tags(&mut self, tags: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_TAGS, tags);
  }
  #[inline]
  pub fn add_createdAt(&mut self, createdAt: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_CREATEDAT, createdAt);
  }
  #[inline]
  pub fn add_createdBy(&mut self, createdBy: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_CREATEDBY, createdBy);
  }
  #[inline]
  pub fn add_updatedAt(&mut self, updatedAt: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_UPDATEDAT, updatedAt);
  }
  #[inline]
  pub fn add_updatedBy(&mut self, updatedBy: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_UPDATEDBY, updatedBy);
  }
  #[inline]
  pub fn add_origNetwork(&mut self, origNetwork: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OrganizationDetails::VT_ORIGNETWORK, origNetwork);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> OrganizationDetailsBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<OrganizationDetails<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for OrganizationDetails<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("OrganizationDetails");
      ds.field("id", &self.id());
...
pub struct OrganizationDetailsT {
...
impl Default for OrganizationDetailsT {
  fn default() -> Self {
    Self {
      id: None,
      idOrganization: None,
...
impl OrganizationDetailsT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>
  ) -> flatbuffers::WIPOffset<OrganizationDetails<'b>> {
    ...
    OrganizationDetails::create(_fbb, &OrganizationDetailsArgs{
      id,
      idOrganization,
      classificationMarking,
      name,
...
#[inline]
/// Verifies that a buffer of bytes contains a `OrganizationDetails`
/// and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_organization_details_unchecked`.
pub fn root_as_organization_details(buf: &[u8]) -> Result<OrganizationDetails, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root::<OrganizationDetails>(buf)
}
#[inline]
/// Verifies that a buffer of bytes contains a size prefixed
/// `OrganizationDetails` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `size_prefixed_root_as_organization_details_unchecked`.
pub fn size_prefixed_root_as_organization_details(buf: &[u8]) -> Result<OrganizationDetails, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root::<OrganizationDetails>(buf)
}
#[inline]
/// Verifies, with the given options, that a buffer of bytes
/// contains a `OrganizationDetails` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_organization_details_unchecked`.
pub fn root_as_organization_details_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<OrganizationDetails<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root_with_opts::<OrganizationDetails<'b>>(opts, buf)
}
#[inline]
/// Verifies, with the given verifier options, that a buffer of
/// bytes contains a size prefixed `OrganizationDetails` and returns
/// it. Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_organization_details_unchecked`.
pub fn size_prefixed_root_as_organization_details_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<OrganizationDetails<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root_with_opts::<OrganizationDetails<'b>>(opts, buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a OrganizationDetails and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid `OrganizationDetails`.
pub unsafe fn root_as_organization_details_unchecked(buf: &[u8]) -> OrganizationDetails {
  flatbuffers::root_unchecked::<OrganizationDetails>(buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed OrganizationDetails and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid size prefixed `OrganizationDetails`.
pub unsafe fn size_prefixed_root_as_organization_details_unchecked(buf: &[u8]) -> OrganizationDetails {
  flatbuffers::size_prefixed_root_unchecked::<OrganizationDetails>(buf)
}
pub const ORGANIZATION_DETAILS_IDENTIFIER: &str = "ORGA";

#[inline]
pub fn organization_details_buffer_has_identifier(buf: &[u8]) -> bool {
  flatbuffers::buffer_has_identifier(buf, ORGANIZATION_DETAILS_IDENTIFIER, false)
}

#[inline]
pub fn organization_details_size_prefixed_buffer_has_identifier(buf: &[u8]) -> bool {
  flatbuffers::buffer_has_identifier(buf, ORGANIZATION_DETAILS_IDENTIFIER, true)
}

#[inline]
pub fn finish_organization_details_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    root: flatbuffers::WIPOffset<OrganizationDetails<'a>>) {
  fbb.finish(root, Some(ORGANIZATION_DETAILS_IDENTIFIER));
}

#[inline]
pub fn finish_size_prefixed_organization_details_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<OrganizationDetails<'a>>) {
  fbb.finish_size_prefixed(root, Some(ORGANIZATION_DETAILS_IDENTIFIER));
}
