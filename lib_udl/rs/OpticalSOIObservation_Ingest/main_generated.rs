...
pub enum OpticalSOIObservation_IngestOffset {}
#[derive(Copy, Clone, PartialEq)]

/// /// An Optical SOI record contains observation information taken from a sensor about a Space Object.
pub struct OpticalSOIObservation_Ingest<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for OpticalSOIObservation_Ingest<'a> {
  type Inner = OpticalSOIObservation_Ingest<'a>;
  #[inline]
...
impl<'a> OpticalSOIObservation_Ingest<'a> {
  ...
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    OpticalSOIObservation_Ingest { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args OpticalSOIObservation_IngestArgs<'args>
  ) -> flatbuffers::WIPOffset<OpticalSOIObservation_Ingest<'bldr>> {
    let mut builder = OpticalSOIObservation_IngestBuilder::new(_fbb);
  ...
  pub fn unpack(&self) -> OpticalSOIObservation_IngestT {
  ...
  pub fn obStartTime(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(OpticalSOIObservation_Ingest::VT_OBSTARTTIME, None)}
  }
  ...
  pub fn intensityTimes(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(OpticalSOIObservation_Ingest::VT_INTENSITYTIMES, None)}
  }
  ...
  pub fn currentSpectralFilterNum(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(OpticalSOIObservation_Ingest::VT_CURRENTSPECTRALFILTERNUM, Some(0)).unwrap()}
  }
  ...
  pub fn expDuration(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(OpticalSOIObservation_Ingest::VT_EXPDURATION, Some(0.0)).unwrap()}
  }
  ...
  pub fn intensities(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(OpticalSOIObservation_Ingest::VT_INTENSITIES, None)}
  }
  ...
  pub fn extinctionCoeffs(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(OpticalSOIObservation_Ingest::VT_EXTINCTIONCOEFFS, None)}
  }
  ...
  pub fn extinctionCoeffsUnc(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(OpticalSOIObservation_Ingest::VT_EXTINCTIONCOEFFSUNC, None)}
  }
  ...
  pub fn skyBgs(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(OpticalSOIObservation_Ingest::VT_SKYBGS, None)}
  }
  ...
  pub fn localSkyBgs(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(OpticalSOIObservation_Ingest::VT_LOCALSKYBGS, None)}
  }
  ...
  pub fn localSkyBgsUnc(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(OpticalSOIObservation_Ingest::VT_LOCALSKYBGSUNC, None)}
  }
  ...
  pub fn numDetectedStars(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(OpticalSOIObservation_Ingest::VT_NUMDETECTEDSTARS, None)}
  }
  ...
  pub fn numCorrelatedStars(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(OpticalSOIObservation_Ingest::VT_NUMCORRELATEDSTARS, None)}
  }
  ...
  pub fn zeroPoints(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(OpticalSOIObservation_Ingest::VT_ZEROPOINTS, None)}
  }
  ...
  pub fn ras(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(OpticalSOIObservation_Ingest::VT_RAS, None)}
  }
  ...
  pub fn declinations(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(OpticalSOIObservation_Ingest::VT_DECLINATIONS, None)}
  }
  ...
  pub fn raRates(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(OpticalSOIObservation_Ingest::VT_RARATES, None)}
  }
  ...
  pub fn percentSats(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(OpticalSOIObservation_Ingest::VT_PERCENTSATS, None)}
  }
}

impl flatbuffers::Verifiable for OpticalSOIObservation_Ingest<'_> {
  #[inline]
  fn run_verifier(
...
pub struct OpticalSOIObservation_IngestArgs<'a> {
...
impl<'a> Default for OpticalSOIObservation_IngestArgs<'a> {
  #[inline]
  fn default() -> Self {
    OpticalSOIObservation_IngestArgs {
      obStartTime: None,
      intensityTimes: None,
...
pub struct OpticalSOIObservation_IngestBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> OpticalSOIObservation_IngestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_obStartTime(&mut self, obStartTime: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpticalSOIObservation_Ingest::VT_OBSTARTTIME, obStartTime);
  }
  #[inline]
  pub fn add_intensityTimes(&mut self, intensityTimes: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpticalSOIObservation_Ingest::VT_INTENSITYTIMES, intensityTimes);
  }
  #[inline]
  pub fn add_currentSpectralFilterNum(&mut self, currentSpectralFilterNum: i32) {
    self.fbb_.push_slot::<i32>(OpticalSOIObservation_Ingest::VT_CURRENTSPECTRALFILTERNUM, currentSpectralFilterNum, 0);
  }
  #[inline]
  pub fn add_expDuration(&mut self, expDuration: f64) {
    self.fbb_.push_slot::<f64>(OpticalSOIObservation_Ingest::VT_EXPDURATION, expDuration, 0.0);
  }
  #[inline]
  pub fn add_intensities(&mut self, intensities: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpticalSOIObservation_Ingest::VT_INTENSITIES, intensities);
  }
  #[inline]
  pub fn add_extinctionCoeffs(&mut self, extinctionCoeffs: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpticalSOIObservation_Ingest::VT_EXTINCTIONCOEFFS, extinctionCoeffs);
  }
  #[inline]
  pub fn add_extinctionCoeffsUnc(&mut self, extinctionCoeffsUnc: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpticalSOIObservation_Ingest::VT_EXTINCTIONCOEFFSUNC, extinctionCoeffsUnc);
  }
  #[inline]
  pub fn add_skyBgs(&mut self, skyBgs: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpticalSOIObservation_Ingest::VT_SKYBGS, skyBgs);
  }
  #[inline]
  pub fn add_localSkyBgs(&mut self, localSkyBgs: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpticalSOIObservation_Ingest::VT_LOCALSKYBGS, localSkyBgs);
  }
  #[inline]
  pub fn add_localSkyBgsUnc(&mut self, localSkyBgsUnc: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpticalSOIObservation_Ingest::VT_LOCALSKYBGSUNC, localSkyBgsUnc);
  }
  #[inline]
  pub fn add_numDetectedStars(&mut self, numDetectedStars: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpticalSOIObservation_Ingest::VT_NUMDETECTEDSTARS, numDetectedStars);
  }
  #[inline]
  pub fn add_numCorrelatedStars(&mut self, numCorrelatedStars: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpticalSOIObservation_Ingest::VT_NUMCORRELATEDSTARS, numCorrelatedStars);
  }
  #[inline]
  pub fn add_zeroPoints(&mut self, zeroPoints: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpticalSOIObservation_Ingest::VT_ZEROPOINTS, zeroPoints);
  }
  #[inline]
  pub fn add_ras(&mut self, ras: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpticalSOIObservation_Ingest::VT_RAS, ras);
  }
  #[inline]
  pub fn add_declinations(&mut self, declinations: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpticalSOIObservation_Ingest::VT_DECLINATIONS, declinations);
  }
  #[inline]
  pub fn add_raRates(&mut self, raRates: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpticalSOIObservation_Ingest::VT_RARATES, raRates);
  }
  #[inline]
  pub fn add_percentSats(&mut self, percentSats: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(OpticalSOIObservation_Ingest::VT_PERCENTSATS, percentSats);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> OpticalSOIObservation_IngestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    OpticalSOIObservation_IngestBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<OpticalSOIObservation_Ingest<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for OpticalSOIObservation_Ingest<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("OpticalSOIObservation_Ingest");
...
pub struct OpticalSOIObservation_IngestT {
...
impl Default for OpticalSOIObservation_IngestT {
  fn default() -> Self {
    Self {
      obStartTime: None,
      intensityTimes: None,
...
impl OpticalSOIObservation_IngestT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>
  ) -> flatbuffers::WIPOffset<OpticalSOIObservation_Ingest<'b>> {
    ...
    OpticalSOIObservation_Ingest::create(_fbb, &OpticalSOIObservation_IngestArgs{
      obStartTime,
      intensityTimes,
      currentSpectralFilterNum,
      expDuration,
...
#[inline]
/// Verifies that a buffer of bytes contains a `OpticalSOIObservation_Ingest`
/// and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_optical_soiobservation_ingest_unchecked`.
pub fn root_as_optical_soiobservation_ingest(buf: &[u8]) -> Result<OpticalSOIObservation_Ingest, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root::<OpticalSOIObservation_Ingest>(buf)
}
#[inline]
/// Verifies that a buffer of bytes contains a size prefixed
/// `OpticalSOIObservation_Ingest` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `size_prefixed_root_as_optical_soiobservation_ingest_unchecked`.
pub fn size_prefixed_root_as_optical_soiobservation_ingest(buf: &[u8]) -> Result<OpticalSOIObservation_Ingest, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root::<OpticalSOIObservation_Ingest>(buf)
}
#[inline]
/// Verifies, with the given options, that a buffer of bytes
/// contains a `OpticalSOIObservation_Ingest` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_optical_soiobservation_ingest_unchecked`.
pub fn root_as_optical_soiobservation_ingest_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<OpticalSOIObservation_Ingest<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root_with_opts::<OpticalSOIObservation_Ingest<'b>>(opts, buf)
}
#[inline]
/// Verifies, with the given verifier options, that a buffer of
/// bytes contains a size prefixed `OpticalSOIObservation_Ingest` and returns
/// it. Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_optical_soiobservation_ingest_unchecked`.
pub fn size_prefixed_root_as_optical_soiobservation_ingest_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<OpticalSOIObservation_Ingest<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root_with_opts::<OpticalSOIObservation_Ingest<'b>>(opts, buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a OpticalSOIObservation_Ingest and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid `OpticalSOIObservation_Ingest`.
pub unsafe fn root_as_optical_soiobservation_ingest_unchecked(buf: &[u8]) -> OpticalSOIObservation_Ingest {
  flatbuffers::root_unchecked::<OpticalSOIObservation_Ingest>(buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed OpticalSOIObservation_Ingest and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid size prefixed `OpticalSOIObservation_Ingest`.
pub unsafe fn size_prefixed_root_as_optical_soiobservation_ingest_unchecked(buf: &[u8]) -> OpticalSOIObservation_Ingest {
  flatbuffers::size_prefixed_root_unchecked::<OpticalSOIObservation_Ingest>(buf)
}
pub const OPTICAL_SOIOBSERVATION_INGEST_IDENTIFIER: &str = "OPTI";

#[inline]
pub fn optical_soiobservation_ingest_buffer_has_identifier(buf: &[u8]) -> bool {
  flatbuffers::buffer_has_identifier(buf, OPTICAL_SOIOBSERVATION_INGEST_IDENTIFIER, false)
}

#[inline]
pub fn optical_soiobservation_ingest_size_prefixed_buffer_has_identifier(buf: &[u8]) -> bool {
  flatbuffers::buffer_has_identifier(buf, OPTICAL_SOIOBSERVATION_INGEST_IDENTIFIER, true)
}

#[inline]
pub fn finish_optical_soiobservation_ingest_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    root: flatbuffers::WIPOffset<OpticalSOIObservation_Ingest<'a>>) {
  fbb.finish(root, Some(OPTICAL_SOIOBSERVATION_INGEST_IDENTIFIER));
}

#[inline]
pub fn finish_size_prefixed_optical_soiobservation_ingest_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<OpticalSOIObservation_Ingest<'a>>) {
  fbb.finish_size_prefixed(root, Some(OPTICAL_SOIOBSERVATION_INGEST_IDENTIFIER));
}
