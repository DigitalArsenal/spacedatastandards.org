...
pub enum LogisticsParts_AbridgedOffset {}
#[derive(Copy, Clone, PartialEq)]

/// /// The parts associated with this support item.
pub struct LogisticsParts_Abridged<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for LogisticsParts_Abridged<'a> {
  type Inner = LogisticsParts_Abridged<'a>;
  #[inline]
...
impl<'a> LogisticsParts_Abridged<'a> {
  ...
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    LogisticsParts_Abridged { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args LogisticsParts_AbridgedArgs<'args>
  ) -> flatbuffers::WIPOffset<LogisticsParts_Abridged<'bldr>> {
    let mut builder = LogisticsParts_AbridgedBuilder::new(_fbb);
  ...
  pub fn unpack(&self) -> LogisticsParts_AbridgedT {
  ...
  pub fn partNumber(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsParts_Abridged::VT_PARTNUMBER, None)}
  }
  ...
  pub fn nationalStockNumber(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsParts_Abridged::VT_NATIONALSTOCKNUMBER, None)}
  }
  ...
  pub fn measurementUnitCode(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsParts_Abridged::VT_MEASUREMENTUNITCODE, None)}
  }
  ...
  pub fn workUnitCode(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsParts_Abridged::VT_WORKUNITCODE, None)}
  }
  ...
  pub fn technicalOrderText(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsParts_Abridged::VT_TECHNICALORDERTEXT, None)}
  }
  ...
  pub fn figureNumber(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsParts_Abridged::VT_FIGURENUMBER, None)}
  }
  ...
  pub fn indexNumber(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsParts_Abridged::VT_INDEXNUMBER, None)}
  }
  ...
  pub fn requestVerifier(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsParts_Abridged::VT_REQUESTVERIFIER, None)}
  }
  ...
  pub fn locationVerifier(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsParts_Abridged::VT_LOCATIONVERIFIER, None)}
  }
  ...
  pub fn supplyDocumentNumber(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsParts_Abridged::VT_SUPPLYDOCUMENTNUMBER, None)}
  }
  ...
  pub fn logisticsStocks(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(LogisticsParts_Abridged::VT_LOGISTICSSTOCKS, None)}
  }
}

impl flatbuffers::Verifiable for LogisticsParts_Abridged<'_> {
  #[inline]
  fn run_verifier(
...
pub struct LogisticsParts_AbridgedArgs<'a> {
...
impl<'a> Default for LogisticsParts_AbridgedArgs<'a> {
  #[inline]
  fn default() -> Self {
    LogisticsParts_AbridgedArgs {
      partNumber: None,
...
pub struct LogisticsParts_AbridgedBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> LogisticsParts_AbridgedBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_partNumber(&mut self, partNumber: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsParts_Abridged::VT_PARTNUMBER, partNumber);
  }
  #[inline]
  pub fn add_nationalStockNumber(&mut self, nationalStockNumber: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsParts_Abridged::VT_NATIONALSTOCKNUMBER, nationalStockNumber);
  }
  #[inline]
  pub fn add_measurementUnitCode(&mut self, measurementUnitCode: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsParts_Abridged::VT_MEASUREMENTUNITCODE, measurementUnitCode);
  }
  #[inline]
  pub fn add_workUnitCode(&mut self, workUnitCode: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsParts_Abridged::VT_WORKUNITCODE, workUnitCode);
  }
  #[inline]
  pub fn add_technicalOrderText(&mut self, technicalOrderText: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsParts_Abridged::VT_TECHNICALORDERTEXT, technicalOrderText);
  }
  #[inline]
  pub fn add_figureNumber(&mut self, figureNumber: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsParts_Abridged::VT_FIGURENUMBER, figureNumber);
  }
  #[inline]
  pub fn add_indexNumber(&mut self, indexNumber: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsParts_Abridged::VT_INDEXNUMBER, indexNumber);
  }
  #[inline]
  pub fn add_requestVerifier(&mut self, requestVerifier: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsParts_Abridged::VT_REQUESTVERIFIER, requestVerifier);
  }
  #[inline]
  pub fn add_locationVerifier(&mut self, locationVerifier: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsParts_Abridged::VT_LOCATIONVERIFIER, locationVerifier);
  }
  #[inline]
  pub fn add_supplyDocumentNumber(&mut self, supplyDocumentNumber: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsParts_Abridged::VT_SUPPLYDOCUMENTNUMBER, supplyDocumentNumber);
  }
  #[inline]
  pub fn add_logisticsStocks(&mut self, logisticsStocks: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsParts_Abridged::VT_LOGISTICSSTOCKS, logisticsStocks);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> LogisticsParts_AbridgedBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    LogisticsParts_AbridgedBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<LogisticsParts_Abridged<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for LogisticsParts_Abridged<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("LogisticsParts_Abridged");
...
pub struct LogisticsParts_AbridgedT {
...
impl Default for LogisticsParts_AbridgedT {
  fn default() -> Self {
    Self {
      partNumber: None,
      nationalStockNumber: None,
...
impl LogisticsParts_AbridgedT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>
  ) -> flatbuffers::WIPOffset<LogisticsParts_Abridged<'b>> {
    ...
    LogisticsParts_Abridged::create(_fbb, &LogisticsParts_AbridgedArgs{
      partNumber,
      nationalStockNumber,
      measurementUnitCode,
      workUnitCode,
...
#[inline]
/// Verifies that a buffer of bytes contains a `LogisticsParts_Abridged`
/// and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_logistics_parts_abridged_unchecked`.
pub fn root_as_logistics_parts_abridged(buf: &[u8]) -> Result<LogisticsParts_Abridged, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root::<LogisticsParts_Abridged>(buf)
}
#[inline]
/// Verifies that a buffer of bytes contains a size prefixed
/// `LogisticsParts_Abridged` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `size_prefixed_root_as_logistics_parts_abridged_unchecked`.
pub fn size_prefixed_root_as_logistics_parts_abridged(buf: &[u8]) -> Result<LogisticsParts_Abridged, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root::<LogisticsParts_Abridged>(buf)
}
#[inline]
/// Verifies, with the given options, that a buffer of bytes
/// contains a `LogisticsParts_Abridged` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_logistics_parts_abridged_unchecked`.
pub fn root_as_logistics_parts_abridged_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<LogisticsParts_Abridged<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root_with_opts::<LogisticsParts_Abridged<'b>>(opts, buf)
}
#[inline]
/// Verifies, with the given verifier options, that a buffer of
/// bytes contains a size prefixed `LogisticsParts_Abridged` and returns
/// it. Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_logistics_parts_abridged_unchecked`.
pub fn size_prefixed_root_as_logistics_parts_abridged_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<LogisticsParts_Abridged<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root_with_opts::<LogisticsParts_Abridged<'b>>(opts, buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a LogisticsParts_Abridged and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid `LogisticsParts_Abridged`.
pub unsafe fn root_as_logistics_parts_abridged_unchecked(buf: &[u8]) -> LogisticsParts_Abridged {
  flatbuffers::root_unchecked::<LogisticsParts_Abridged>(buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed LogisticsParts_Abridged and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid size prefixed `LogisticsParts_Abridged`.
pub unsafe fn size_prefixed_root_as_logistics_parts_abridged_unchecked(buf: &[u8]) -> LogisticsParts_Abridged {
  flatbuffers::size_prefixed_root_unchecked::<LogisticsParts_Abridged>(buf)
}
pub const LOGISTICS_PARTS_ABRIDGED_IDENTIFIER: &str = "LOGI";

#[inline]
pub fn logistics_parts_abridged_buffer_has_identifier(buf: &[u8]) -> bool {
  flatbuffers::buffer_has_identifier(buf, LOGISTICS_PARTS_ABRIDGED_IDENTIFIER, false)
}

#[inline]
pub fn logistics_parts_abridged_size_prefixed_buffer_has_identifier(buf: &[u8]) -> bool {
  flatbuffers::buffer_has_identifier(buf, LOGISTICS_PARTS_ABRIDGED_IDENTIFIER, true)
}

#[inline]
pub fn finish_logistics_parts_abridged_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    root: flatbuffers::WIPOffset<LogisticsParts_Abridged<'a>>) {
  fbb.finish(root, Some(LOGISTICS_PARTS_ABRIDGED_IDENTIFIER));
}

#[inline]
pub fn finish_size_prefixed_logistics_parts_abridged_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<LogisticsParts_Abridged<'a>>) {
  fbb.finish_size_prefixed(root, Some(LOGISTICS_PARTS_ABRIDGED_IDENTIFIER));
}
