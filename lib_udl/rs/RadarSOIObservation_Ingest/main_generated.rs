...
pub enum RadarSOIObservation_IngestOffset {}
#[derive(Copy, Clone, PartialEq)]

/// /// A Radar SOI record contains observation information taken from a sensor about a Space Object.
pub struct RadarSOIObservation_Ingest<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for RadarSOIObservation_Ingest<'a> {
  type Inner = RadarSOIObservation_Ingest<'a>;
  #[inline]
...
impl<'a> RadarSOIObservation_Ingest<'a> {
  ...
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    RadarSOIObservation_Ingest { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args RadarSOIObservation_IngestArgs<'args>
  ) -> flatbuffers::WIPOffset<RadarSOIObservation_Ingest<'bldr>> {
    let mut builder = RadarSOIObservation_IngestBuilder::new(_fbb);
  ...
  pub fn unpack(&self) -> RadarSOIObservation_IngestT {
  ...
  pub fn obStartTime(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(RadarSOIObservation_Ingest::VT_OBSTARTTIME, None)}
  }
  ...
  pub fn tovs(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_TOVS, None)}
  }
  ...
  pub fn rspaces(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_RSPACES, None)}
  }
  ...
  pub fn xspaces(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_XSPACES, None)}
  }
  ...
  pub fn doppler2XRs(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_DOPPLER2XRS, None)}
  }
  ...
  pub fn deltaTimes(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_DELTATIMES, None)}
  }
  ...
  pub fn aspectAngles(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_ASPECTANGLES, None)}
  }
  ...
  pub fn projAngVels(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_PROJANGVELS, None)}
  }
  ...
  pub fn idStateVector(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(RadarSOIObservation_Ingest::VT_IDSTATEVECTOR, None)}
  }
  ...
  pub fn idAttitudeSet(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(RadarSOIObservation_Ingest::VT_IDATTITUDESET, None)}
  }
  ...
  pub fn ranges(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_RANGES, None)}
  }
  ...
  pub fn azimuths(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_AZIMUTHS, None)}
  }
  ...
  pub fn elevations(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_ELEVATIONS, None)}
  }
  ...
  pub fn rangeRates(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_RANGERATES, None)}
  }
  ...
  pub fn azimuthRates(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_AZIMUTHRATES, None)}
  }
  ...
  pub fn elevationRates(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_ELEVATIONRATES, None)}
  }
  ...
  pub fn azimuthBiases(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_AZIMUTHBIASES, None)}
  }
  ...
  pub fn elevationBiases(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_ELEVATIONBIASES, None)}
  }
  ...
  pub fn rangeBiases(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_RANGEBIASES, None)}
  }
  ...
  pub fn integrationAngles(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_INTEGRATIONANGLES, None)}
  }
  ...
  pub fn crossRangeRes(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_CROSSRANGERES, None)}
  }
  ...
  pub fn beta(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(RadarSOIObservation_Ingest::VT_BETA, Some(0.0)).unwrap()}
  }
  ...
  pub fn kappa(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(RadarSOIObservation_Ingest::VT_KAPPA, Some(0.0)).unwrap()}
  }
  ...
  pub fn peakAmplitudes(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_PEAKAMPLITUDES, None)}
  }
  ...
  pub fn centerFrequency(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(RadarSOIObservation_Ingest::VT_CENTERFREQUENCY, Some(0.0)).unwrap()}
  }
  ...
  pub fn pulseBandwidth(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(RadarSOIObservation_Ingest::VT_PULSEBANDWIDTH, Some(0.0)).unwrap()}
  }
  ...
  pub fn xpos(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_XPOS, None)}
  }
  ...
  pub fn ypos(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_YPOS, None)}
  }
  ...
  pub fn zpos(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_ZPOS, None)}
  }
  ...
  pub fn xvel(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_XVEL, None)}
  }
  ...
  pub fn yvel(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_YVEL, None)}
  }
  ...
  pub fn zvel(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(RadarSOIObservation_Ingest::VT_ZVEL, None)}
  }
}

impl flatbuffers::Verifiable for RadarSOIObservation_Ingest<'_> {
  #[inline]
  fn run_verifier(
...
pub struct RadarSOIObservation_IngestArgs<'a> {
...
impl<'a> Default for RadarSOIObservation_IngestArgs<'a> {
  #[inline]
  fn default() -> Self {
    RadarSOIObservation_IngestArgs {
      obStartTime: None,
      tovs: None,
      rspaces: None,
      xspaces: None,
...
pub struct RadarSOIObservation_IngestBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RadarSOIObservation_IngestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_obStartTime(&mut self, obStartTime: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_OBSTARTTIME, obStartTime);
  }
  #[inline]
  pub fn add_tovs(&mut self, tovs: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_TOVS, tovs);
  }
  #[inline]
  pub fn add_rspaces(&mut self, rspaces: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_RSPACES, rspaces);
  }
  #[inline]
  pub fn add_xspaces(&mut self, xspaces: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_XSPACES, xspaces);
  }
  #[inline]
  pub fn add_doppler2XRs(&mut self, doppler2XRs: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_DOPPLER2XRS, doppler2XRs);
  }
  #[inline]
  pub fn add_deltaTimes(&mut self, deltaTimes: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_DELTATIMES, deltaTimes);
  }
  #[inline]
  pub fn add_aspectAngles(&mut self, aspectAngles: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_ASPECTANGLES, aspectAngles);
  }
  #[inline]
  pub fn add_projAngVels(&mut self, projAngVels: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_PROJANGVELS, projAngVels);
  }
  #[inline]
  pub fn add_idStateVector(&mut self, idStateVector: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_IDSTATEVECTOR, idStateVector);
  }
  #[inline]
  pub fn add_idAttitudeSet(&mut self, idAttitudeSet: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_IDATTITUDESET, idAttitudeSet);
  }
  #[inline]
  pub fn add_ranges(&mut self, ranges: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_RANGES, ranges);
  }
  #[inline]
  pub fn add_azimuths(&mut self, azimuths: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_AZIMUTHS, azimuths);
  }
  #[inline]
  pub fn add_elevations(&mut self, elevations: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_ELEVATIONS, elevations);
  }
  #[inline]
  pub fn add_rangeRates(&mut self, rangeRates: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_RANGERATES, rangeRates);
  }
  #[inline]
  pub fn add_azimuthRates(&mut self, azimuthRates: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_AZIMUTHRATES, azimuthRates);
  }
  #[inline]
  pub fn add_elevationRates(&mut self, elevationRates: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_ELEVATIONRATES, elevationRates);
  }
  #[inline]
  pub fn add_azimuthBiases(&mut self, azimuthBiases: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_AZIMUTHBIASES, azimuthBiases);
  }
  #[inline]
  pub fn add_elevationBiases(&mut self, elevationBiases: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_ELEVATIONBIASES, elevationBiases);
  }
  #[inline]
  pub fn add_rangeBiases(&mut self, rangeBiases: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_RANGEBIASES, rangeBiases);
  }
  #[inline]
  pub fn add_integrationAngles(&mut self, integrationAngles: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_INTEGRATIONANGLES, integrationAngles);
  }
  #[inline]
  pub fn add_crossRangeRes(&mut self, crossRangeRes: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_CROSSRANGERES, crossRangeRes);
  }
  #[inline]
  pub fn add_beta(&mut self, beta: f64) {
    self.fbb_.push_slot::<f64>(RadarSOIObservation_Ingest::VT_BETA, beta, 0.0);
  }
  #[inline]
  pub fn add_kappa(&mut self, kappa: f64) {
    self.fbb_.push_slot::<f64>(RadarSOIObservation_Ingest::VT_KAPPA, kappa, 0.0);
  }
  #[inline]
  pub fn add_peakAmplitudes(&mut self, peakAmplitudes: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_PEAKAMPLITUDES, peakAmplitudes);
  }
  #[inline]
  pub fn add_centerFrequency(&mut self, centerFrequency: f64) {
    self.fbb_.push_slot::<f64>(RadarSOIObservation_Ingest::VT_CENTERFREQUENCY, centerFrequency, 0.0);
  }
  #[inline]
  pub fn add_pulseBandwidth(&mut self, pulseBandwidth: f64) {
    self.fbb_.push_slot::<f64>(RadarSOIObservation_Ingest::VT_PULSEBANDWIDTH, pulseBandwidth, 0.0);
  }
  #[inline]
  pub fn add_xpos(&mut self, xpos: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_XPOS, xpos);
  }
  #[inline]
  pub fn add_ypos(&mut self, ypos: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_YPOS, ypos);
  }
  #[inline]
  pub fn add_zpos(&mut self, zpos: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_ZPOS, zpos);
  }
  #[inline]
  pub fn add_xvel(&mut self, xvel: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_XVEL, xvel);
  }
  #[inline]
  pub fn add_yvel(&mut self, yvel: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_YVEL, yvel);
  }
  #[inline]
  pub fn add_zvel(&mut self, zvel: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RadarSOIObservation_Ingest::VT_ZVEL, zvel);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> RadarSOIObservation_IngestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    RadarSOIObservation_IngestBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<RadarSOIObservation_Ingest<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for RadarSOIObservation_Ingest<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("RadarSOIObservation_Ingest");
...
pub struct RadarSOIObservation_IngestT {
...
impl Default for RadarSOIObservation_IngestT {
  fn default() -> Self {
    Self {
      obStartTime: None,
      tovs: None,
...
impl RadarSOIObservation_IngestT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>
  ) -> flatbuffers::WIPOffset<RadarSOIObservation_Ingest<'b>> {
    ...
    RadarSOIObservation_Ingest::create(_fbb, &RadarSOIObservation_IngestArgs{
      obStartTime,
      tovs,
      rspaces,
      xspaces,
...
#[inline]
/// Verifies that a buffer of bytes contains a `RadarSOIObservation_Ingest`
/// and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_radar_soiobservation_ingest_unchecked`.
pub fn root_as_radar_soiobservation_ingest(buf: &[u8]) -> Result<RadarSOIObservation_Ingest, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root::<RadarSOIObservation_Ingest>(buf)
}
#[inline]
/// Verifies that a buffer of bytes contains a size prefixed
/// `RadarSOIObservation_Ingest` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `size_prefixed_root_as_radar_soiobservation_ingest_unchecked`.
pub fn size_prefixed_root_as_radar_soiobservation_ingest(buf: &[u8]) -> Result<RadarSOIObservation_Ingest, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root::<RadarSOIObservation_Ingest>(buf)
}
#[inline]
/// Verifies, with the given options, that a buffer of bytes
/// contains a `RadarSOIObservation_Ingest` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_radar_soiobservation_ingest_unchecked`.
pub fn root_as_radar_soiobservation_ingest_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<RadarSOIObservation_Ingest<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root_with_opts::<RadarSOIObservation_Ingest<'b>>(opts, buf)
}
#[inline]
/// Verifies, with the given verifier options, that a buffer of
/// bytes contains a size prefixed `RadarSOIObservation_Ingest` and returns
/// it. Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_radar_soiobservation_ingest_unchecked`.
pub fn size_prefixed_root_as_radar_soiobservation_ingest_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<RadarSOIObservation_Ingest<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root_with_opts::<RadarSOIObservation_Ingest<'b>>(opts, buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a RadarSOIObservation_Ingest and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid `RadarSOIObservation_Ingest`.
pub unsafe fn root_as_radar_soiobservation_ingest_unchecked(buf: &[u8]) -> RadarSOIObservation_Ingest {
  flatbuffers::root_unchecked::<RadarSOIObservation_Ingest>(buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed RadarSOIObservation_Ingest and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid size prefixed `RadarSOIObservation_Ingest`.
pub unsafe fn size_prefixed_root_as_radar_soiobservation_ingest_unchecked(buf: &[u8]) -> RadarSOIObservation_Ingest {
  flatbuffers::size_prefixed_root_unchecked::<RadarSOIObservation_Ingest>(buf)
}
pub const RADAR_SOIOBSERVATION_INGEST_IDENTIFIER: &str = "RADA";

#[inline]
pub fn radar_soiobservation_ingest_buffer_has_identifier(buf: &[u8]) -> bool {
  flatbuffers::buffer_has_identifier(buf, RADAR_SOIOBSERVATION_INGEST_IDENTIFIER, false)
}

#[inline]
pub fn radar_soiobservation_ingest_size_prefixed_buffer_has_identifier(buf: &[u8]) -> bool {
  flatbuffers::buffer_has_identifier(buf, RADAR_SOIOBSERVATION_INGEST_IDENTIFIER, true)
}

#[inline]
pub fn finish_radar_soiobservation_ingest_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    root: flatbuffers::WIPOffset<RadarSOIObservation_Ingest<'a>>) {
  fbb.finish(root, Some(RADAR_SOIOBSERVATION_INGEST_IDENTIFIER));
}

#[inline]
pub fn finish_size_prefixed_radar_soiobservation_ingest_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<RadarSOIObservation_Ingest<'a>>) {
  fbb.finish_size_prefixed(root, Some(RADAR_SOIOBSERVATION_INGEST_IDENTIFIER));
}
