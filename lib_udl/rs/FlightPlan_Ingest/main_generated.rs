...
pub const ENUM_MIN_FLIGHT_PLAN_INGEST_DATA_MODE_ENUM: i8 = 0;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_FLIGHT_PLAN_INGEST_DATA_MODE_ENUM: i8 = 3;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_FLIGHT_PLAN_INGEST_DATA_MODE_ENUM: [FlightPlan_Ingest_dataMode_Enum; 4] = [
  FlightPlan_Ingest_dataMode_Enum::REAL,
  FlightPlan_Ingest_dataMode_Enum::TEST,
  FlightPlan_Ingest_dataMode_Enum::SIMULATED,
  FlightPlan_Ingest_dataMode_Enum::EXERCISE,
];

#[derive(Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Hash, Default)]
#[repr(transparent)]
pub struct FlightPlan_Ingest_dataMode_Enum(pub i8);
#[allow(non_upper_case_globals)]
impl FlightPlan_Ingest_dataMode_Enum {
...
impl core::fmt::Debug for FlightPlan_Ingest_dataMode_Enum {
...
impl<'a> flatbuffers::Follow<'a> for FlightPlan_Ingest_dataMode_Enum {
  type Inner = Self;
  #[inline]
...
impl flatbuffers::Push for FlightPlan_Ingest_dataMode_Enum {
    type Output = FlightPlan_Ingest_dataMode_Enum;
    #[inline]
...
impl flatbuffers::EndianScalar for FlightPlan_Ingest_dataMode_Enum {
  type Scalar = i8;
  #[inline]
...
impl<'a> flatbuffers::Verifiable for FlightPlan_Ingest_dataMode_Enum {
  #[inline]
  fn run_verifier(
...
impl flatbuffers::SimpleToVerifyInSlice for FlightPlan_Ingest_dataMode_Enum {}
pub enum FlightPlan_IngestOffset {}
#[derive(Copy, Clone, PartialEq)]

/// /// Flight Plan contains data specifying the details of an intended flight including schedule and expected route.
pub struct FlightPlan_Ingest<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for FlightPlan_Ingest<'a> {
  type Inner = FlightPlan_Ingest<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
...
impl<'a> FlightPlan_Ingest<'a> {
  ...
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    FlightPlan_Ingest { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args FlightPlan_IngestArgs<'args>
  ) -> flatbuffers::WIPOffset<FlightPlan_Ingest<'bldr>> {
    let mut builder = FlightPlan_IngestBuilder::new(_fbb);
  ...
  pub fn unpack(&self) -> FlightPlan_IngestT {
  ...
  pub fn id(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_ID, None)}
  }
  ...
  pub fn classificationMarking(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_CLASSIFICATIONMARKING, None)}
  }
  ...
  pub fn amcMissionId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_AMCMISSIONID, None)}
  }
  ...
  pub fn idSortie(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_IDSORTIE, None)}
  }
  ...
  pub fn idAircraft(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_IDAIRCRAFT, None)}
  }
  ...
  pub fn legNum(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(FlightPlan_Ingest::VT_LEGNUM, Some(0)).unwrap()}
  }
  ...
  pub fn idDepAirfield(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_IDDEPAIRFIELD, None)}
  }
  ...
  pub fn depAirfield(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_DEPAIRFIELD, None)}
  }
  ...
  pub fn idArrAirfield(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_IDARRAIRFIELD, None)}
  }
  ...
  pub fn arrAirfield(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_ARRAIRFIELD, None)}
  }
  ...
  pub fn externalId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_EXTERNALID, None)}
  }
  ...
  pub fn genTS(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_GENTS, None)}
  }
  ...
  pub fn aircraftMDS(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_AIRCRAFTMDS, None)}
  }
  ...
  pub fn tailNumber(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_TAILNUMBER, None)}
  }
  ...
  pub fn callSign(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_CALLSIGN, None)}
  }
  ...
  pub fn wxValidStart(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_WXVALIDSTART, None)}
  }
  ...
  pub fn wxValidEnd(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_WXVALIDEND, None)}
  }
  ...
  pub fn estDepTime(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_ESTDEPTIME, None)}
  }
  ...
  pub fn dragIndex(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_DRAGINDEX, Some(0.0)).unwrap()}
  }
  ...
  pub fn fuelDegrade(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_FUELDEGRADE, Some(0.0)).unwrap()}
  }
  ...
  pub fn opWeight(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_OPWEIGHT, Some(0.0)).unwrap()}
  }
  ...
  pub fn msnIndex(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_MSNINDEX, Some(0.0)).unwrap()}
  }
  ...
  pub fn rampFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_RAMPFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn taxiFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_TAXIFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn takeoffFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_TAKEOFFFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn climbFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_CLIMBFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn climbTime(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_CLIMBTIME, None)}
  }
  ...
  pub fn holdDownFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_HOLDDOWNFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn tocIceFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_TOCICEFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn tocFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_TOCFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn enrouteFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_ENROUTEFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn enrouteTime(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_ENROUTETIME, None)}
  }
  ...
  pub fn thunderAvoidFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_THUNDERAVOIDFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn todIceFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_TODICEFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn opConditionFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_OPCONDITIONFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn todFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_TODFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn earlyDescentFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_EARLYDESCENTFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn arrIceFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_ARRICEFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn holdFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_HOLDFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn holdTime(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_HOLDTIME, None)}
  }
  ...
  pub fn appLandingFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_APPLANDINGFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn burnedFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_BURNEDFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn landingFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_LANDINGFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn minDivertFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_MINDIVERTFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn arrAlternate1Fuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_ARRALTERNATE1FUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn arrAlternate2Fuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_ARRALTERNATE2FUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn contingencyFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_CONTINGENCYFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn reserveFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_RESERVEFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn depressFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_DEPRESSFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn unusableFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_UNUSABLEFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn unidentExtraFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_UNIDENTEXTRAFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn identExtraFuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_IDENTEXTRAFUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn remAlternate1Fuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_REMALTERNATE1FUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn remAlternate2Fuel(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_REMALTERNATE2FUEL, Some(0.0)).unwrap()}
  }
  ...
  pub fn enduranceTime(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_ENDURANCETIME, None)}
  }
  ...
  pub fn sid(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_SID, None)}
  }
  ...
  pub fn star(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_STAR, None)}
  }
  ...
  pub fn gpsRAIM(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_GPSRAIM, None)}
  }
  ...
  pub fn depRunway(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_DEPRUNWAY, None)}
  }
  ...
  pub fn arrRunway(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_ARRRUNWAY, None)}
  }
  ...
  pub fn routeString(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_ROUTESTRING, None)}
  }
  ...
  pub fn countryCodes(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(FlightPlan_Ingest::VT_COUNTRYCODES, None)}
  }
  ...
  pub fn etopsRating(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_ETOPSRATING, None)}
  }
  ...
  pub fn etopsAirfields(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(FlightPlan_Ingest::VT_ETOPSAIRFIELDS, None)}
  }
  ...
  pub fn etopsAltAirfields(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(FlightPlan_Ingest::VT_ETOPSALTAIRFIELDS, None)}
  }
  ...
  pub fn etopsValWindow(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_ETOPSVALWINDOW, None)}
  }
  ...
  pub fn plannerRemark(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_PLANNERREMARK, None)}
  }
  ...
  pub fn cargoRemark(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_CARGOREMARK, None)}
  }
  ...
  pub fn windFac1(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_WINDFAC1, Some(0.0)).unwrap()}
  }
  ...
  pub fn windFac2(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_WINDFAC2, Some(0.0)).unwrap()}
  }
  ...
  pub fn windFacAvg(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_WINDFACAVG, Some(0.0)).unwrap()}
  }
  ...
  pub fn avgTempDev(&self) -> f64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f64>(FlightPlan_Ingest::VT_AVGTEMPDEV, Some(0.0)).unwrap()}
  }
  ...
  pub fn atcAddresses(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(FlightPlan_Ingest::VT_ATCADDRESSES, None)}
  }
  ...
  pub fn originator(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_ORIGINATOR, None)}
  }
  ...
  pub fn numAircraft(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(FlightPlan_Ingest::VT_NUMAIRCRAFT, Some(0)).unwrap()}
  }
  ...
  pub fn flightRules(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_FLIGHTRULES, None)}
  }
  ...
  pub fn flightType(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_FLIGHTTYPE, None)}
  }
  ...
  pub fn initialCruiseSpeed(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_INITIALCRUISESPEED, None)}
  }
  ...
  pub fn initialFlightLevel(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_INITIALFLIGHTLEVEL, None)}
  }
  ...
  pub fn arrAlternate1(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_ARRALTERNATE1, None)}
  }
  ...
  pub fn arrAlternate2(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_ARRALTERNATE2, None)}
  }
  ...
  pub fn depAlternate(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_DEPALTERNATE, None)}
  }
  ...
  pub fn wakeTurbCat(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_WAKETURBCAT, None)}
  }
  ...
  pub fn equipment(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_EQUIPMENT, None)}
  }
  ...
  pub fn notes(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_NOTES, None)}
  }
  ...
  pub fn createdAt(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_CREATEDAT, None)}
  }
  ...
  pub fn createdBy(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_CREATEDBY, None)}
  }
  ...
  pub fn sourceDL(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_SOURCEDL, None)}
  }
  /// Source of the data.
  ...
  pub fn source(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_SOURCE, None)}
  }
  ...
  pub fn origin(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_ORIGIN, None)}
  }
  ...
  pub fn origNetwork(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(FlightPlan_Ingest::VT_ORIGNETWORK, None)}
  }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  #[inline]
  pub fn dataMode(&self) -> FlightPlan_Ingest_dataMode_Enum {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<FlightPlan_Ingest_dataMode_Enum>(FlightPlan_Ingest::VT_DATAMODE, Some(FlightPlan_Ingest_dataMode_Enum::REAL)).unwrap()}
  }
  ...
  pub fn airRefuelEvents(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(FlightPlan_Ingest::VT_AIRREFUELEVENTS, None)}
  }
  ...
  pub fn flightPlanMessages(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(FlightPlan_Ingest::VT_FLIGHTPLANMESSAGES, None)}
  }
  ...
  pub fn flightPlanWaypoints(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(FlightPlan_Ingest::VT_FLIGHTPLANWAYPOINTS, None)}
  }
  ...
  pub fn flightPlanPointGroups(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(FlightPlan_Ingest::VT_FLIGHTPLANPOINTGROUPS, None)}
  }
}

impl flatbuffers::Verifiable for FlightPlan_Ingest<'_> {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<FlightPlan_Ingest_dataMode_Enum>("dataMode", Self::VT_DATAMODE, false)?
...
pub struct FlightPlan_IngestArgs<'a> {
    ...
    pub dataMode: FlightPlan_Ingest_dataMode_Enum,
...
impl<'a> Default for FlightPlan_IngestArgs<'a> {
  #[inline]
  fn default() -> Self {
    FlightPlan_IngestArgs {
      id: None,
      ...
      origin: None,
      origNetwork: None,
      dataMode: FlightPlan_Ingest_dataMode_Enum::REAL,
...
pub struct FlightPlan_IngestBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> FlightPlan_IngestBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_id(&mut self, id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ID, id);
  }
  #[inline]
  pub fn add_classificationMarking(&mut self, classificationMarking: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  #[inline]
  pub fn add_amcMissionId(&mut self, amcMissionId: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_AMCMISSIONID, amcMissionId);
  }
  #[inline]
  pub fn add_idSortie(&mut self, idSortie: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_IDSORTIE, idSortie);
  }
  #[inline]
  pub fn add_idAircraft(&mut self, idAircraft: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_IDAIRCRAFT, idAircraft);
  }
  #[inline]
  pub fn add_legNum(&mut self, legNum: i32) {
    self.fbb_.push_slot::<i32>(FlightPlan_Ingest::VT_LEGNUM, legNum, 0);
  }
  #[inline]
  pub fn add_idDepAirfield(&mut self, idDepAirfield: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_IDDEPAIRFIELD, idDepAirfield);
  }
  #[inline]
  pub fn add_depAirfield(&mut self, depAirfield: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_DEPAIRFIELD, depAirfield);
  }
  #[inline]
  pub fn add_idArrAirfield(&mut self, idArrAirfield: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_IDARRAIRFIELD, idArrAirfield);
  }
  #[inline]
  pub fn add_arrAirfield(&mut self, arrAirfield: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ARRAIRFIELD, arrAirfield);
  }
  #[inline]
  pub fn add_externalId(&mut self, externalId: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_EXTERNALID, externalId);
  }
  #[inline]
  pub fn add_genTS(&mut self, genTS: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_GENTS, genTS);
  }
  #[inline]
  pub fn add_aircraftMDS(&mut self, aircraftMDS: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_AIRCRAFTMDS, aircraftMDS);
  }
  #[inline]
  pub fn add_tailNumber(&mut self, tailNumber: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_TAILNUMBER, tailNumber);
  }
  #[inline]
  pub fn add_callSign(&mut self, callSign: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_CALLSIGN, callSign);
  }
  #[inline]
  pub fn add_wxValidStart(&mut self, wxValidStart: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_WXVALIDSTART, wxValidStart);
  }
  #[inline]
  pub fn add_wxValidEnd(&mut self, wxValidEnd: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_WXVALIDEND, wxValidEnd);
  }
  #[inline]
  pub fn add_estDepTime(&mut self, estDepTime: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ESTDEPTIME, estDepTime);
  }
  #[inline]
  pub fn add_dragIndex(&mut self, dragIndex: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_DRAGINDEX, dragIndex, 0.0);
  }
  #[inline]
  pub fn add_fuelDegrade(&mut self, fuelDegrade: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_FUELDEGRADE, fuelDegrade, 0.0);
  }
  #[inline]
  pub fn add_opWeight(&mut self, opWeight: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_OPWEIGHT, opWeight, 0.0);
  }
  #[inline]
  pub fn add_msnIndex(&mut self, msnIndex: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_MSNINDEX, msnIndex, 0.0);
  }
  #[inline]
  pub fn add_rampFuel(&mut self, rampFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_RAMPFUEL, rampFuel, 0.0);
  }
  #[inline]
  pub fn add_taxiFuel(&mut self, taxiFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_TAXIFUEL, taxiFuel, 0.0);
  }
  #[inline]
  pub fn add_takeoffFuel(&mut self, takeoffFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_TAKEOFFFUEL, takeoffFuel, 0.0);
  }
  #[inline]
  pub fn add_climbFuel(&mut self, climbFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_CLIMBFUEL, climbFuel, 0.0);
  }
  #[inline]
  pub fn add_climbTime(&mut self, climbTime: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_CLIMBTIME, climbTime);
  }
  #[inline]
  pub fn add_holdDownFuel(&mut self, holdDownFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_HOLDDOWNFUEL, holdDownFuel, 0.0);
  }
  #[inline]
  pub fn add_tocIceFuel(&mut self, tocIceFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_TOCICEFUEL, tocIceFuel, 0.0);
  }
  #[inline]
  pub fn add_tocFuel(&mut self, tocFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_TOCFUEL, tocFuel, 0.0);
  }
  #[inline]
  pub fn add_enrouteFuel(&mut self, enrouteFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_ENROUTEFUEL, enrouteFuel, 0.0);
  }
  #[inline]
  pub fn add_enrouteTime(&mut self, enrouteTime: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ENROUTETIME, enrouteTime);
  }
  #[inline]
  pub fn add_thunderAvoidFuel(&mut self, thunderAvoidFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_THUNDERAVOIDFUEL, thunderAvoidFuel, 0.0);
  }
  #[inline]
  pub fn add_todIceFuel(&mut self, todIceFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_TODICEFUEL, todIceFuel, 0.0);
  }
  #[inline]
  pub fn add_opConditionFuel(&mut self, opConditionFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_OPCONDITIONFUEL, opConditionFuel, 0.0);
  }
  #[inline]
  pub fn add_todFuel(&mut self, todFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_TODFUEL, todFuel, 0.0);
  }
  #[inline]
  pub fn add_earlyDescentFuel(&mut self, earlyDescentFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_EARLYDESCENTFUEL, earlyDescentFuel, 0.0);
  }
  #[inline]
  pub fn add_arrIceFuel(&mut self, arrIceFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_ARRICEFUEL, arrIceFuel, 0.0);
  }
  #[inline]
  pub fn add_holdFuel(&mut self, holdFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_HOLDFUEL, holdFuel, 0.0);
  }
  #[inline]
  pub fn add_holdTime(&mut self, holdTime: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_HOLDTIME, holdTime);
  }
  #[inline]
  pub fn add_appLandingFuel(&mut self, appLandingFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_APPLANDINGFUEL, appLandingFuel, 0.0);
  }
  #[inline]
  pub fn add_burnedFuel(&mut self, burnedFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_BURNEDFUEL, burnedFuel, 0.0);
  }
  #[inline]
  pub fn add_landingFuel(&mut self, landingFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_LANDINGFUEL, landingFuel, 0.0);
  }
  #[inline]
  pub fn add_minDivertFuel(&mut self, minDivertFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_MINDIVERTFUEL, minDivertFuel, 0.0);
  }
  #[inline]
  pub fn add_arrAlternate1Fuel(&mut self, arrAlternate1Fuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_ARRALTERNATE1FUEL, arrAlternate1Fuel, 0.0);
  }
  #[inline]
  pub fn add_arrAlternate2Fuel(&mut self, arrAlternate2Fuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_ARRALTERNATE2FUEL, arrAlternate2Fuel, 0.0);
  }
  #[inline]
  pub fn add_contingencyFuel(&mut self, contingencyFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_CONTINGENCYFUEL, contingencyFuel, 0.0);
  }
  #[inline]
  pub fn add_reserveFuel(&mut self, reserveFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_RESERVEFUEL, reserveFuel, 0.0);
  }
  #[inline]
  pub fn add_depressFuel(&mut self, depressFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_DEPRESSFUEL, depressFuel, 0.0);
  }
  #[inline]
  pub fn add_unusableFuel(&mut self, unusableFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_UNUSABLEFUEL, unusableFuel, 0.0);
  }
  #[inline]
  pub fn add_unidentExtraFuel(&mut self, unidentExtraFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_UNIDENTEXTRAFUEL, unidentExtraFuel, 0.0);
  }
  #[inline]
  pub fn add_identExtraFuel(&mut self, identExtraFuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_IDENTEXTRAFUEL, identExtraFuel, 0.0);
  }
  #[inline]
  pub fn add_remAlternate1Fuel(&mut self, remAlternate1Fuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_REMALTERNATE1FUEL, remAlternate1Fuel, 0.0);
  }
  #[inline]
  pub fn add_remAlternate2Fuel(&mut self, remAlternate2Fuel: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_REMALTERNATE2FUEL, remAlternate2Fuel, 0.0);
  }
  #[inline]
  pub fn add_enduranceTime(&mut self, enduranceTime: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ENDURANCETIME, enduranceTime);
  }
  #[inline]
  pub fn add_sid(&mut self, sid: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_SID, sid);
  }
  #[inline]
  pub fn add_star(&mut self, star: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_STAR, star);
  }
  #[inline]
  pub fn add_gpsRAIM(&mut self, gpsRAIM: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_GPSRAIM, gpsRAIM);
  }
  #[inline]
  pub fn add_depRunway(&mut self, depRunway: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_DEPRUNWAY, depRunway);
  }
  #[inline]
  pub fn add_arrRunway(&mut self, arrRunway: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ARRRUNWAY, arrRunway);
  }
  #[inline]
  pub fn add_routeString(&mut self, routeString: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ROUTESTRING, routeString);
  }
  #[inline]
  pub fn add_countryCodes(&mut self, countryCodes: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_COUNTRYCODES, countryCodes);
  }
  #[inline]
  pub fn add_etopsRating(&mut self, etopsRating: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ETOPSRATING, etopsRating);
  }
  #[inline]
  pub fn add_etopsAirfields(&mut self, etopsAirfields: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ETOPSAIRFIELDS, etopsAirfields);
  }
  #[inline]
  pub fn add_etopsAltAirfields(&mut self, etopsAltAirfields: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ETOPSALTAIRFIELDS, etopsAltAirfields);
  }
  #[inline]
  pub fn add_etopsValWindow(&mut self, etopsValWindow: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ETOPSVALWINDOW, etopsValWindow);
  }
  #[inline]
  pub fn add_plannerRemark(&mut self, plannerRemark: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_PLANNERREMARK, plannerRemark);
  }
  #[inline]
  pub fn add_cargoRemark(&mut self, cargoRemark: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_CARGOREMARK, cargoRemark);
  }
  #[inline]
  pub fn add_windFac1(&mut self, windFac1: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_WINDFAC1, windFac1, 0.0);
  }
  #[inline]
  pub fn add_windFac2(&mut self, windFac2: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_WINDFAC2, windFac2, 0.0);
  }
  #[inline]
  pub fn add_windFacAvg(&mut self, windFacAvg: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_WINDFACAVG, windFacAvg, 0.0);
  }
  #[inline]
  pub fn add_avgTempDev(&mut self, avgTempDev: f64) {
    self.fbb_.push_slot::<f64>(FlightPlan_Ingest::VT_AVGTEMPDEV, avgTempDev, 0.0);
  }
  #[inline]
  pub fn add_atcAddresses(&mut self, atcAddresses: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ATCADDRESSES, atcAddresses);
  }
  #[inline]
  pub fn add_originator(&mut self, originator: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ORIGINATOR, originator);
  }
  #[inline]
  pub fn add_numAircraft(&mut self, numAircraft: i32) {
    self.fbb_.push_slot::<i32>(FlightPlan_Ingest::VT_NUMAIRCRAFT, numAircraft, 0);
  }
  #[inline]
  pub fn add_flightRules(&mut self, flightRules: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_FLIGHTRULES, flightRules);
  }
  #[inline]
  pub fn add_flightType(&mut self, flightType: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_FLIGHTTYPE, flightType);
  }
  #[inline]
  pub fn add_initialCruiseSpeed(&mut self, initialCruiseSpeed: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_INITIALCRUISESPEED, initialCruiseSpeed);
  }
  #[inline]
  pub fn add_initialFlightLevel(&mut self, initialFlightLevel: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_INITIALFLIGHTLEVEL, initialFlightLevel);
  }
  #[inline]
  pub fn add_arrAlternate1(&mut self, arrAlternate1: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ARRALTERNATE1, arrAlternate1);
  }
  #[inline]
  pub fn add_arrAlternate2(&mut self, arrAlternate2: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ARRALTERNATE2, arrAlternate2);
  }
  #[inline]
  pub fn add_depAlternate(&mut self, depAlternate: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_DEPALTERNATE, depAlternate);
  }
  #[inline]
  pub fn add_wakeTurbCat(&mut self, wakeTurbCat: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_WAKETURBCAT, wakeTurbCat);
  }
  #[inline]
  pub fn add_equipment(&mut self, equipment: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_EQUIPMENT, equipment);
  }
  #[inline]
  pub fn add_notes(&mut self, notes: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_NOTES, notes);
  }
  #[inline]
  pub fn add_createdAt(&mut self, createdAt: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_CREATEDAT, createdAt);
  }
  #[inline]
  pub fn add_createdBy(&mut self, createdBy: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_CREATEDBY, createdBy);
  }
  #[inline]
  pub fn add_sourceDL(&mut self, sourceDL: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_SOURCEDL, sourceDL);
  }
  #[inline]
  pub fn add_source(&mut self, source: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_SOURCE, source);
  }
  #[inline]
  pub fn add_origin(&mut self, origin: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ORIGIN, origin);
  }
  #[inline]
  pub fn add_origNetwork(&mut self, origNetwork: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  #[inline]
  pub fn add_dataMode(&mut self, dataMode: FlightPlan_Ingest_dataMode_Enum) {
    self.fbb_.push_slot::<FlightPlan_Ingest_dataMode_Enum>(FlightPlan_Ingest::VT_DATAMODE, dataMode, FlightPlan_Ingest_dataMode_Enum::REAL);
  }
  #[inline]
  pub fn add_airRefuelEvents(&mut self, airRefuelEvents: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_AIRREFUELEVENTS, airRefuelEvents);
  }
  #[inline]
  pub fn add_flightPlanMessages(&mut self, flightPlanMessages: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_FLIGHTPLANMESSAGES, flightPlanMessages);
  }
  #[inline]
  pub fn add_flightPlanWaypoints(&mut self, flightPlanWaypoints: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_FLIGHTPLANWAYPOINTS, flightPlanWaypoints);
  }
  #[inline]
  pub fn add_flightPlanPointGroups(&mut self, flightPlanPointGroups: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(FlightPlan_Ingest::VT_FLIGHTPLANPOINTGROUPS, flightPlanPointGroups);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> FlightPlan_IngestBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    FlightPlan_IngestBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<FlightPlan_Ingest<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for FlightPlan_Ingest<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("FlightPlan_Ingest");
      ds.field("id", &self.id());
...
impl Default for FlightPlan_IngestT {
  fn default() -> Self {
    Self {
      id: None,
      classificationMarking: None,
...
impl FlightPlan_IngestT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>
  ) -> flatbuffers::WIPOffset<FlightPlan_Ingest<'b>> {
    ...
    FlightPlan_Ingest::create(_fbb, &FlightPlan_IngestArgs{
      id,
      classificationMarking,
      amcMissionId,
      idSortie,
...
#[inline]
/// Verifies that a buffer of bytes contains a `FlightPlan_Ingest`
/// and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_flight_plan_ingest_unchecked`.
pub fn root_as_flight_plan_ingest(buf: &[u8]) -> Result<FlightPlan_Ingest, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root::<FlightPlan_Ingest>(buf)
}
#[inline]
/// Verifies that a buffer of bytes contains a size prefixed
/// `FlightPlan_Ingest` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `size_prefixed_root_as_flight_plan_ingest_unchecked`.
pub fn size_prefixed_root_as_flight_plan_ingest(buf: &[u8]) -> Result<FlightPlan_Ingest, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root::<FlightPlan_Ingest>(buf)
}
#[inline]
/// Verifies, with the given options, that a buffer of bytes
/// contains a `FlightPlan_Ingest` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_flight_plan_ingest_unchecked`.
pub fn root_as_flight_plan_ingest_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<FlightPlan_Ingest<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root_with_opts::<FlightPlan_Ingest<'b>>(opts, buf)
}
#[inline]
/// Verifies, with the given verifier options, that a buffer of
/// bytes contains a size prefixed `FlightPlan_Ingest` and returns
/// it. Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_flight_plan_ingest_unchecked`.
pub fn size_prefixed_root_as_flight_plan_ingest_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<FlightPlan_Ingest<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root_with_opts::<FlightPlan_Ingest<'b>>(opts, buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a FlightPlan_Ingest and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid `FlightPlan_Ingest`.
pub unsafe fn root_as_flight_plan_ingest_unchecked(buf: &[u8]) -> FlightPlan_Ingest {
  flatbuffers::root_unchecked::<FlightPlan_Ingest>(buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed FlightPlan_Ingest and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid size prefixed `FlightPlan_Ingest`.
pub unsafe fn size_prefixed_root_as_flight_plan_ingest_unchecked(buf: &[u8]) -> FlightPlan_Ingest {
  flatbuffers::size_prefixed_root_unchecked::<FlightPlan_Ingest>(buf)
}
pub const FLIGHT_PLAN_INGEST_IDENTIFIER: &str = "FLIG";

#[inline]
pub fn flight_plan_ingest_buffer_has_identifier(buf: &[u8]) -> bool {
  flatbuffers::buffer_has_identifier(buf, FLIGHT_PLAN_INGEST_IDENTIFIER, false)
}

#[inline]
pub fn flight_plan_ingest_size_prefixed_buffer_has_identifier(buf: &[u8]) -> bool {
  flatbuffers::buffer_has_identifier(buf, FLIGHT_PLAN_INGEST_IDENTIFIER, true)
}

#[inline]
pub fn finish_flight_plan_ingest_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    root: flatbuffers::WIPOffset<FlightPlan_Ingest<'a>>) {
  fbb.finish(root, Some(FLIGHT_PLAN_INGEST_IDENTIFIER));
}

#[inline]
pub fn finish_size_prefixed_flight_plan_ingest_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<FlightPlan_Ingest<'a>>) {
  fbb.finish_size_prefixed(root, Some(FLIGHT_PLAN_INGEST_IDENTIFIER));
}
