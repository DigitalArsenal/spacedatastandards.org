...
pub enum LogisticsTransportationPlans_AbridgedOffset {}
#[derive(Copy, Clone, PartialEq)]

/// /// Transportation plans associated with this LogisticsSupport record, used to coordinate maintenance efforts.
pub struct LogisticsTransportationPlans_Abridged<'a> {
  pub _tab: flatbuffers::Table<'a>,
}

impl<'a> flatbuffers::Follow<'a> for LogisticsTransportationPlans_Abridged<'a> {
  type Inner = LogisticsTransportationPlans_Abridged<'a>;
  #[inline]
...
impl<'a> LogisticsTransportationPlans_Abridged<'a> {
  ...
  pub unsafe fn init_from_table(table: flatbuffers::Table<'a>) -> Self {
    LogisticsTransportationPlans_Abridged { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args LogisticsTransportationPlans_AbridgedArgs<'args>
  ) -> flatbuffers::WIPOffset<LogisticsTransportationPlans_Abridged<'bldr>> {
    let mut builder = LogisticsTransportationPlans_AbridgedBuilder::new(_fbb);
  ...
  pub fn unpack(&self) -> LogisticsTransportationPlans_AbridgedT {
  ...
  pub fn plansNumber(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_PLANSNUMBER, None)}
  }
  ...
  pub fn missionChange(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(LogisticsTransportationPlans_Abridged::VT_MISSIONCHANGE, Some(false)).unwrap()}
  }
  ...
  pub fn planDefinition(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_PLANDEFINITION, None)}
  }
  ...
  pub fn statusCode(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_STATUSCODE, None)}
  }
  ...
  pub fn coordinator(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_COORDINATOR, None)}
  }
  ...
  pub fn coordinatorUnit(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_COORDINATORUNIT, None)}
  }
  /// The origin location.
  ...
  pub fn originICAO(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_ORIGINICAO, None)}
  }
  ...
  pub fn estDepTime(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_ESTDEPTIME, None)}
  }
  ...
  pub fn estArrTime(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_ESTARRTIME, None)}
  }
  ...
  pub fn destinationICAO(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_DESTINATIONICAO, None)}
  }
  ...
  pub fn logisticMasterRecordId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_LOGISTICMASTERRECORDID, None)}
  }
  ...
  pub fn tpTailNumber(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_TPTAILNUMBER, None)}
  }
  ...
  pub fn tpAircraftMDS(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_TPAIRCRAFTMDS, None)}
  }
  ...
  pub fn majcom(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_MAJCOM, None)}
  }
  ...
  pub fn approxArrTime(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_APPROXARRTIME, None)}
  }
  ...
  pub fn duration(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_DURATION, None)}
  }
  ...
  pub fn actDepTime(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_ACTDEPTIME, None)}
  }
  ...
  pub fn closedDate(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_CLOSEDDATE, None)}
  }
  ...
  pub fn cancelledDate(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_CANCELLEDDATE, None)}
  }
  ...
  pub fn aircraftStatus(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_AIRCRAFTSTATUS, None)}
  }
  ...
  pub fn numEnrouteStops(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(LogisticsTransportationPlans_Abridged::VT_NUMENROUTESTOPS, Some(0)).unwrap()}
  }
  ...
  pub fn serialNumber(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_SERIALNUMBER, None)}
  }
  ...
  pub fn numTransLoads(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(LogisticsTransportationPlans_Abridged::VT_NUMTRANSLOADS, Some(0)).unwrap()}
  }
  ...
  pub fn lastChangedDate(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(LogisticsTransportationPlans_Abridged::VT_LASTCHANGEDDATE, None)}
  }
  ...
  pub fn logisticsSegments(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(LogisticsTransportationPlans_Abridged::VT_LOGISTICSSEGMENTS, None)}
  }
  ...
  pub fn logisticsTransportationPlansRemarks(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(LogisticsTransportationPlans_Abridged::VT_LOGISTICSTRANSPORTATIONPLANSREMARKS, None)}
  }
}

impl flatbuffers::Verifiable for LogisticsTransportationPlans_Abridged<'_> {
  #[inline]
  fn run_verifier(
...
pub struct LogisticsTransportationPlans_AbridgedArgs<'a> {
...
impl<'a> Default for LogisticsTransportationPlans_AbridgedArgs<'a> {
  #[inline]
  fn default() -> Self {
    LogisticsTransportationPlans_AbridgedArgs {
      plansNumber: None,
      missionChange: false,
      planDefinition: None,
      statusCode: None,
...
pub struct LogisticsTransportationPlans_AbridgedBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> LogisticsTransportationPlans_AbridgedBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_plansNumber(&mut self, plansNumber: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_PLANSNUMBER, plansNumber);
  }
  #[inline]
  pub fn add_missionChange(&mut self, missionChange: bool) {
    self.fbb_.push_slot::<bool>(LogisticsTransportationPlans_Abridged::VT_MISSIONCHANGE, missionChange, false);
  }
  #[inline]
  pub fn add_planDefinition(&mut self, planDefinition: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_PLANDEFINITION, planDefinition);
  }
  #[inline]
  pub fn add_statusCode(&mut self, statusCode: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_STATUSCODE, statusCode);
  }
  #[inline]
  pub fn add_coordinator(&mut self, coordinator: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_COORDINATOR, coordinator);
  }
  #[inline]
  pub fn add_coordinatorUnit(&mut self, coordinatorUnit: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_COORDINATORUNIT, coordinatorUnit);
  }
  #[inline]
  pub fn add_originICAO(&mut self, originICAO: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_ORIGINICAO, originICAO);
  }
  #[inline]
  pub fn add_estDepTime(&mut self, estDepTime: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_ESTDEPTIME, estDepTime);
  }
  #[inline]
  pub fn add_estArrTime(&mut self, estArrTime: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_ESTARRTIME, estArrTime);
  }
  #[inline]
  pub fn add_destinationICAO(&mut self, destinationICAO: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_DESTINATIONICAO, destinationICAO);
  }
  #[inline]
  pub fn add_logisticMasterRecordId(&mut self, logisticMasterRecordId: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_LOGISTICMASTERRECORDID, logisticMasterRecordId);
  }
  #[inline]
  pub fn add_tpTailNumber(&mut self, tpTailNumber: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_TPTAILNUMBER, tpTailNumber);
  }
  #[inline]
  pub fn add_tpAircraftMDS(&mut self, tpAircraftMDS: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_TPAIRCRAFTMDS, tpAircraftMDS);
  }
  #[inline]
  pub fn add_majcom(&mut self, majcom: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_MAJCOM, majcom);
  }
  #[inline]
  pub fn add_approxArrTime(&mut self, approxArrTime: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_APPROXARRTIME, approxArrTime);
  }
  #[inline]
  pub fn add_duration(&mut self, duration: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_DURATION, duration);
  }
  #[inline]
  pub fn add_actDepTime(&mut self, actDepTime: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_ACTDEPTIME, actDepTime);
  }
  #[inline]
  pub fn add_closedDate(&mut self, closedDate: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_CLOSEDDATE, closedDate);
  }
  #[inline]
  pub fn add_cancelledDate(&mut self, cancelledDate: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_CANCELLEDDATE, cancelledDate);
  }
  #[inline]
  pub fn add_aircraftStatus(&mut self, aircraftStatus: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_AIRCRAFTSTATUS, aircraftStatus);
  }
  #[inline]
  pub fn add_numEnrouteStops(&mut self, numEnrouteStops: i32) {
    self.fbb_.push_slot::<i32>(LogisticsTransportationPlans_Abridged::VT_NUMENROUTESTOPS, numEnrouteStops, 0);
  }
  #[inline]
  pub fn add_serialNumber(&mut self, serialNumber: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_SERIALNUMBER, serialNumber);
  }
  #[inline]
  pub fn add_numTransLoads(&mut self, numTransLoads: i32) {
    self.fbb_.push_slot::<i32>(LogisticsTransportationPlans_Abridged::VT_NUMTRANSLOADS, numTransLoads, 0);
  }
  #[inline]
  pub fn add_lastChangedDate(&mut self, lastChangedDate: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_LASTCHANGEDDATE, lastChangedDate);
  }
  #[inline]
  pub fn add_logisticsSegments(&mut self, logisticsSegments: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_LOGISTICSSEGMENTS, logisticsSegments);
  }
  #[inline]
  pub fn add_logisticsTransportationPlansRemarks(&mut self, logisticsTransportationPlansRemarks: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(LogisticsTransportationPlans_Abridged::VT_LOGISTICSTRANSPORTATIONPLANSREMARKS, logisticsTransportationPlansRemarks);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> LogisticsTransportationPlans_AbridgedBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    LogisticsTransportationPlans_AbridgedBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
  #[inline]
  pub fn finish(self) -> flatbuffers::WIPOffset<LogisticsTransportationPlans_Abridged<'a>> {
    let o = self.fbb_.end_table(self.start_);
    flatbuffers::WIPOffset::new(o.value())
  }
}

impl core::fmt::Debug for LogisticsTransportationPlans_Abridged<'_> {
  fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
    let mut ds = f.debug_struct("LogisticsTransportationPlans_Abridged");
...
pub struct LogisticsTransportationPlans_AbridgedT {
...
impl Default for LogisticsTransportationPlans_AbridgedT {
  fn default() -> Self {
    Self {
      plansNumber: None,
      missionChange: false,
...
impl LogisticsTransportationPlans_AbridgedT {
  pub fn pack<'b, A: flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut flatbuffers::FlatBufferBuilder<'b, A>
  ) -> flatbuffers::WIPOffset<LogisticsTransportationPlans_Abridged<'b>> {
    ...
    LogisticsTransportationPlans_Abridged::create(_fbb, &LogisticsTransportationPlans_AbridgedArgs{
      plansNumber,
      missionChange,
      planDefinition,
      statusCode,
...
#[inline]
/// Verifies that a buffer of bytes contains a `LogisticsTransportationPlans_Abridged`
/// and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_logistics_transportation_plans_abridged_unchecked`.
pub fn root_as_logistics_transportation_plans_abridged(buf: &[u8]) -> Result<LogisticsTransportationPlans_Abridged, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root::<LogisticsTransportationPlans_Abridged>(buf)
}
#[inline]
/// Verifies that a buffer of bytes contains a size prefixed
/// `LogisticsTransportationPlans_Abridged` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `size_prefixed_root_as_logistics_transportation_plans_abridged_unchecked`.
pub fn size_prefixed_root_as_logistics_transportation_plans_abridged(buf: &[u8]) -> Result<LogisticsTransportationPlans_Abridged, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root::<LogisticsTransportationPlans_Abridged>(buf)
}
#[inline]
/// Verifies, with the given options, that a buffer of bytes
/// contains a `LogisticsTransportationPlans_Abridged` and returns it.
/// Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_logistics_transportation_plans_abridged_unchecked`.
pub fn root_as_logistics_transportation_plans_abridged_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<LogisticsTransportationPlans_Abridged<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::root_with_opts::<LogisticsTransportationPlans_Abridged<'b>>(opts, buf)
}
#[inline]
/// Verifies, with the given verifier options, that a buffer of
/// bytes contains a size prefixed `LogisticsTransportationPlans_Abridged` and returns
/// it. Note that verification is still experimental and may not
/// catch every error, or be maximally performant. For the
/// previous, unchecked, behavior use
/// `root_as_logistics_transportation_plans_abridged_unchecked`.
pub fn size_prefixed_root_as_logistics_transportation_plans_abridged_with_opts<'b, 'o>(
  opts: &'o flatbuffers::VerifierOptions,
  buf: &'b [u8],
) -> Result<LogisticsTransportationPlans_Abridged<'b>, flatbuffers::InvalidFlatbuffer> {
  flatbuffers::size_prefixed_root_with_opts::<LogisticsTransportationPlans_Abridged<'b>>(opts, buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a LogisticsTransportationPlans_Abridged and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid `LogisticsTransportationPlans_Abridged`.
pub unsafe fn root_as_logistics_transportation_plans_abridged_unchecked(buf: &[u8]) -> LogisticsTransportationPlans_Abridged {
  flatbuffers::root_unchecked::<LogisticsTransportationPlans_Abridged>(buf)
}
#[inline]
/// Assumes, without verification, that a buffer of bytes contains a size prefixed LogisticsTransportationPlans_Abridged and returns it.
/// # Safety
/// Callers must trust the given bytes do indeed contain a valid size prefixed `LogisticsTransportationPlans_Abridged`.
pub unsafe fn size_prefixed_root_as_logistics_transportation_plans_abridged_unchecked(buf: &[u8]) -> LogisticsTransportationPlans_Abridged {
  flatbuffers::size_prefixed_root_unchecked::<LogisticsTransportationPlans_Abridged>(buf)
}
pub const LOGISTICS_TRANSPORTATION_PLANS_ABRIDGED_IDENTIFIER: &str = "LOGI";

#[inline]
pub fn logistics_transportation_plans_abridged_buffer_has_identifier(buf: &[u8]) -> bool {
  flatbuffers::buffer_has_identifier(buf, LOGISTICS_TRANSPORTATION_PLANS_ABRIDGED_IDENTIFIER, false)
}

#[inline]
pub fn logistics_transportation_plans_abridged_size_prefixed_buffer_has_identifier(buf: &[u8]) -> bool {
  flatbuffers::buffer_has_identifier(buf, LOGISTICS_TRANSPORTATION_PLANS_ABRIDGED_IDENTIFIER, true)
}

#[inline]
pub fn finish_logistics_transportation_plans_abridged_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    root: flatbuffers::WIPOffset<LogisticsTransportationPlans_Abridged<'a>>) {
  fbb.finish(root, Some(LOGISTICS_TRANSPORTATION_PLANS_ABRIDGED_IDENTIFIER));
}

#[inline]
pub fn finish_size_prefixed_logistics_transportation_plans_abridged_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>, root: flatbuffers::WIPOffset<LogisticsTransportationPlans_Abridged<'a>>) {
  fbb.finish_size_prefixed(root, Some(LOGISTICS_TRANSPORTATION_PLANS_ABRIDGED_IDENTIFIER));
}
