...
import (
	...
	SeradataEarlyWarning_Ingest_dataMode_Enum "SeradataEarlyWarning_Ingest_dataMode_Enum"
)
...
func (rcv *SeradataEarlyWarning_Ingest) DataMode() SeradataEarlyWarning_Ingest_dataMode_Enum.SeradataEarlyWarning_Ingest_dataMode_Enum {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(46))
	if o != 0 {
		return SeradataEarlyWarning_Ingest_dataMode_Enum.SeradataEarlyWarning_Ingest_dataMode_Enum(rcv._tab.GetInt8(o + rcv._tab.Pos))
	}
	return 0
}
...
/// Example: TEST
/// Constraints: Minimum length = 1, Maximum length = 32
func (rcv *SeradataEarlyWarning_Ingest) MutateDataMode(n SeradataEarlyWarning_Ingest_dataMode_Enum.SeradataEarlyWarning_Ingest_dataMode_Enum) bool {
...
func SeradataEarlyWarning_IngestAddDataMode(builder *flatbuffers.Builder, dataMode SeradataEarlyWarning_Ingest_dataMode_Enum.SeradataEarlyWarning_Ingest_dataMode_Enum) {
