...
type Hazard_Ingest struct {
	_tab flatbuffers.Table
}

const Hazard_IngestIdentifier = "HAZA"

func GetRootAsHazard_Ingest(buf []byte, offset flatbuffers.UOffsetT) *Hazard_Ingest {
...
func FinishHazard_IngestBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
	identifierBytes := []byte(Hazard_IngestIdentifier)
	builder.FinishWithFileIdentifier(offset, identifierBytes)
}

func Hazard_IngestBufferHasIdentifier(buf []byte) bool {
	return flatbuffers.BufferHasIdentifier(buf, Hazard_IngestIdentifier)
}

func GetSizePrefixedRootAsHazard_Ingest(buf []byte, offset flatbuffers.UOffsetT) *Hazard_Ingest {
...
func FinishSizePrefixedHazard_IngestBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
	identifierBytes := []byte(Hazard_IngestIdentifier)
	builder.FinishSizePrefixedWithFileIdentifier(offset, identifierBytes)
}

func SizePrefixedHazard_IngestBufferHasIdentifier(buf []byte) bool {
	return flatbuffers.SizePrefixedBufferHasIdentifier(buf, Hazard_IngestIdentifier)
}

func (rcv *Hazard_Ingest) Init(buf []byte, i flatbuffers.UOffsetT) {
	rcv._tab.Bytes = buf
	rcv._tab.Pos = i
}

func (rcv *Hazard_Ingest) Table() flatbuffers.Table {
	return rcv._tab
}
...
func (rcv *Hazard_Ingest) Id() []byte {
...
func (rcv *Hazard_Ingest) ClassificationMarking() []byte {
...
func (rcv *Hazard_Ingest) DetectType() []byte {
...
func (rcv *Hazard_Ingest) DetectTime() []byte {
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) Harmful() bool {
...
/// Example: /// Example: False
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutateHarmful(n bool) bool {
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) Alarms(j int) []byte {
...
func (rcv *Hazard_Ingest) AlarmsLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(14))
	if o != 0 {
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) AlarmValues(j int) []byte {
...
func (rcv *Hazard_Ingest) AlarmValuesLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(16))
	if o != 0 {
		return rcv._tab.VectorLen(o)
	}
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) Readings(j int) []byte {
...
func (rcv *Hazard_Ingest) ReadingsLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(18))
	if o != 0 {
		return rcv._tab.VectorLen(o)
	}
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) ReadingUnits(j int) []byte {
...
func (rcv *Hazard_Ingest) ReadingUnitsLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(20))
	if o != 0 {
		return rcv._tab.VectorLen(o)
	}
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) ReadingValues(j int) []byte {
...
func (rcv *Hazard_Ingest) ReadingValuesLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(22))
	if o != 0 {
		return rcv._tab.VectorLen(o)
	}
...
func (rcv *Hazard_Ingest) MatType() []byte {
...
func (rcv *Hazard_Ingest) MatClass() []byte {
...
/// Example: /// Example: VX
/// Constraints: Minimum length = 0, Maximum length = 64
func (rcv *Hazard_Ingest) MatName() []byte {
...
/// Example: /// Example: 3
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MatCat() int32 {
...
/// Example: /// Example: 3
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutateMatCat(n int32) bool {
...
func (rcv *Hazard_Ingest) CasRn() []byte {
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) Ppm() int32 {
...
/// Example: /// Example: 27129
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutatePpm(n int32) bool {
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) Density() float64 {
...
/// Example: /// Example: 18900.2
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutateDensity(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) RadCtrn() float64 {
...
/// Example: /// Example: 1.31
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutateRadCtrn(n float64) bool {
...
/// Example: /// Example: 2.5
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) GBar() float64 {
...
/// Example: /// Example: 2.5
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutateGBar(n float64) bool {
...
/// Example: /// Example: 3.1
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) HBar() float64 {
...
/// Example: /// Example: 3.1
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutateHBar(n float64) bool {
...
/// Example: /// Example: 92
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) Z() int32 {
...
/// Example: /// Example: 92
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutateZ(n int32) bool {
...
/// Example: /// Example: 238
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) A() int32 {
...
/// Example: /// Example: 238
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutateA(n int32) bool {
...
func (rcv *Hazard_Ingest) BottleId() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 64
func (rcv *Hazard_Ingest) Channel() []byte {
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) Duration() int32 {
...
/// Example: /// Example: 14400
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutateDuration(n int32) bool {
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) Activity() float64 {
...
/// Example: /// Example: 120.1
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutateActivity(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) Dep() float64 {
...
/// Example: /// Example: 1.084
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutateDep(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) DepCtrn() float64 {
...
/// Example: /// Example: 86.1
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutateDepCtrn(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MassFrac() float64 {
...
/// Example: /// Example: 0.029
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutateMassFrac(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) Dose() float64 {
...
/// Example: /// Example: 1.12
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutateDose(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) CtrnTime() float64 {
...
/// Example: /// Example: 1.077
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutateCtrnTime(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) DoseRate() float64 {
...
/// Example: /// Example: 1.0000001865
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) MutateDoseRate(n float64) bool {
...
func (rcv *Hazard_Ingest) IdPoi() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 36
func (rcv *Hazard_Ingest) IdTrack() []byte {
...
/// Constraints: No constraints specified.
func (rcv *Hazard_Ingest) CreatedAt() []byte {
...
func (rcv *Hazard_Ingest) CreatedBy() []byte {
...
/// Constraints: Minimum length = 1, Maximum length = 36
func (rcv *Hazard_Ingest) Source() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 64
func (rcv *Hazard_Ingest) Origin() []byte {
...
/// Constraints: Minimum length = 1, Maximum length = 32
func (rcv *Hazard_Ingest) OrigNetwork() []byte {
...
/// Constraints: Minimum length = 1, Maximum length = 32
func (rcv *Hazard_Ingest) DataMode() Hazard_Ingest_dataMode_Enum {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(82))
	if o != 0 {
		return Hazard_Ingest_dataMode_Enum(rcv._tab.GetInt8(o + rcv._tab.Pos))
	}
	return 0
}
...
/// Example: /// Example: TEST
/// Constraints: Minimum length = 1, Maximum length = 32
func (rcv *Hazard_Ingest) MutateDataMode(n Hazard_Ingest_dataMode_Enum) bool {
	return rcv._tab.MutateInt8Slot(82, int8(n))
}

func Hazard_IngestStart(builder *flatbuffers.Builder) {
	builder.StartObject(40)
}
func Hazard_IngestAddId(builder *flatbuffers.Builder, id flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(0, flatbuffers.UOffsetT(id), 0)
}
func Hazard_IngestAddClassificationMarking(builder *flatbuffers.Builder, classificationMarking flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(classificationMarking), 0)
}
func Hazard_IngestAddDetectType(builder *flatbuffers.Builder, detectType flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(2, flatbuffers.UOffsetT(detectType), 0)
}
func Hazard_IngestAddDetectTime(builder *flatbuffers.Builder, detectTime flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(3, flatbuffers.UOffsetT(detectTime), 0)
}
func Hazard_IngestAddHarmful(builder *flatbuffers.Builder, harmful bool) {
	builder.PrependBoolSlot(4, harmful, false)
}
func Hazard_IngestAddAlarms(builder *flatbuffers.Builder, alarms flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(5, flatbuffers.UOffsetT(alarms), 0)
}
func Hazard_IngestStartAlarmsVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
func Hazard_IngestAddAlarmValues(builder *flatbuffers.Builder, alarmValues flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(6, flatbuffers.UOffsetT(alarmValues), 0)
}
func Hazard_IngestStartAlarmValuesVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
func Hazard_IngestAddReadings(builder *flatbuffers.Builder, readings flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(7, flatbuffers.UOffsetT(readings), 0)
}
func Hazard_IngestStartReadingsVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
func Hazard_IngestAddReadingUnits(builder *flatbuffers.Builder, readingUnits flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(8, flatbuffers.UOffsetT(readingUnits), 0)
}
func Hazard_IngestStartReadingUnitsVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
func Hazard_IngestAddReadingValues(builder *flatbuffers.Builder, readingValues flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(9, flatbuffers.UOffsetT(readingValues), 0)
}
func Hazard_IngestStartReadingValuesVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
func Hazard_IngestAddMatType(builder *flatbuffers.Builder, matType flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(10, flatbuffers.UOffsetT(matType), 0)
}
func Hazard_IngestAddMatClass(builder *flatbuffers.Builder, matClass flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(11, flatbuffers.UOffsetT(matClass), 0)
}
func Hazard_IngestAddMatName(builder *flatbuffers.Builder, matName flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(12, flatbuffers.UOffsetT(matName), 0)
}
func Hazard_IngestAddMatCat(builder *flatbuffers.Builder, matCat int32) {
	builder.PrependInt32Slot(13, matCat, 0)
}
func Hazard_IngestAddCasRn(builder *flatbuffers.Builder, casRn flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(14, flatbuffers.UOffsetT(casRn), 0)
}
func Hazard_IngestAddPpm(builder *flatbuffers.Builder, ppm int32) {
	builder.PrependInt32Slot(15, ppm, 0)
}
func Hazard_IngestAddDensity(builder *flatbuffers.Builder, density float64) {
	builder.PrependFloat64Slot(16, density, 0.0)
}
func Hazard_IngestAddRadCtrn(builder *flatbuffers.Builder, radCtrn float64) {
	builder.PrependFloat64Slot(17, radCtrn, 0.0)
}
func Hazard_IngestAddGBar(builder *flatbuffers.Builder, gBar float64) {
	builder.PrependFloat64Slot(18, gBar, 0.0)
}
func Hazard_IngestAddHBar(builder *flatbuffers.Builder, hBar float64) {
	builder.PrependFloat64Slot(19, hBar, 0.0)
}
func Hazard_IngestAddZ(builder *flatbuffers.Builder, z int32) {
	builder.PrependInt32Slot(20, z, 0)
}
func Hazard_IngestAddA(builder *flatbuffers.Builder, a int32) {
	builder.PrependInt32Slot(21, a, 0)
}
func Hazard_IngestAddBottleId(builder *flatbuffers.Builder, bottleId flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(22, flatbuffers.UOffsetT(bottleId), 0)
}
func Hazard_IngestAddChannel(builder *flatbuffers.Builder, channel flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(23, flatbuffers.UOffsetT(channel), 0)
}
func Hazard_IngestAddDuration(builder *flatbuffers.Builder, duration int32) {
	builder.PrependInt32Slot(24, duration, 0)
}
func Hazard_IngestAddActivity(builder *flatbuffers.Builder, activity float64) {
	builder.PrependFloat64Slot(25, activity, 0.0)
}
func Hazard_IngestAddDep(builder *flatbuffers.Builder, dep float64) {
	builder.PrependFloat64Slot(26, dep, 0.0)
}
func Hazard_IngestAddDepCtrn(builder *flatbuffers.Builder, depCtrn float64) {
	builder.PrependFloat64Slot(27, depCtrn, 0.0)
}
func Hazard_IngestAddMassFrac(builder *flatbuffers.Builder, massFrac float64) {
	builder.PrependFloat64Slot(28, massFrac, 0.0)
}
func Hazard_IngestAddDose(builder *flatbuffers.Builder, dose float64) {
	builder.PrependFloat64Slot(29, dose, 0.0)
}
func Hazard_IngestAddCtrnTime(builder *flatbuffers.Builder, ctrnTime float64) {
	builder.PrependFloat64Slot(30, ctrnTime, 0.0)
}
func Hazard_IngestAddDoseRate(builder *flatbuffers.Builder, doseRate float64) {
	builder.PrependFloat64Slot(31, doseRate, 0.0)
}
func Hazard_IngestAddIdPoi(builder *flatbuffers.Builder, idPoi flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(32, flatbuffers.UOffsetT(idPoi), 0)
}
func Hazard_IngestAddIdTrack(builder *flatbuffers.Builder, idTrack flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(33, flatbuffers.UOffsetT(idTrack), 0)
}
func Hazard_IngestAddCreatedAt(builder *flatbuffers.Builder, createdAt flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(34, flatbuffers.UOffsetT(createdAt), 0)
}
func Hazard_IngestAddCreatedBy(builder *flatbuffers.Builder, createdBy flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(35, flatbuffers.UOffsetT(createdBy), 0)
}
func Hazard_IngestAddSource(builder *flatbuffers.Builder, source flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(36, flatbuffers.UOffsetT(source), 0)
}
func Hazard_IngestAddOrigin(builder *flatbuffers.Builder, origin flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(37, flatbuffers.UOffsetT(origin), 0)
}
func Hazard_IngestAddOrigNetwork(builder *flatbuffers.Builder, origNetwork flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(38, flatbuffers.UOffsetT(origNetwork), 0)
}
func Hazard_IngestAddDataMode(builder *flatbuffers.Builder, dataMode Hazard_Ingest_dataMode_Enum) {
	builder.PrependInt8Slot(39, int8(dataMode), 0)
}
func Hazard_IngestEnd(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
