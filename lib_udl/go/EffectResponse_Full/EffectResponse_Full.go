...
const EffectResponse_FullIdentifier = "EFFE"
...
func FinishEffectResponse_FullBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
	identifierBytes := []byte(EffectResponse_FullIdentifier)
	builder.FinishWithFileIdentifier(offset, identifierBytes)
}

func EffectResponse_FullBufferHasIdentifier(buf []byte) bool {
	return flatbuffers.BufferHasIdentifier(buf, EffectResponse_FullIdentifier)
}
...
func SizePrefixedEffectResponse_FullBufferHasIdentifier(buf []byte) bool {
	return flatbuffers.SizePrefixedBufferHasIdentifier(buf, EffectResponse_FullIdentifier)
}
...
func (rcv *EffectResponse_Full) DataMode() EffectResponse_Full_dataMode_Enum {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(50))
	if o != 0 {
		return EffectResponse_Full_dataMode_Enum(rcv._tab.GetInt8(o + rcv._tab.Pos))
	}
	return 0
}
...
/// Example: /// Example: TEST
/// Constraints: Minimum length = 1, Maximum length = 32
func (rcv *EffectResponse_Full) MutateDataMode(n EffectResponse_Full_dataMode_Enum) bool {
...
func EffectResponse_FullAddDataMode(builder *flatbuffers.Builder, dataMode EffectResponse_Full_dataMode_Enum) {
