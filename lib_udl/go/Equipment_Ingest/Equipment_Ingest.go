...
type Equipment_Ingest struct {
	_tab flatbuffers.Table
}

const Equipment_IngestIdentifier = "EQUI"

func GetRootAsEquipment_Ingest(buf []byte, offset flatbuffers.UOffsetT) *Equipment_Ingest {
...
func FinishEquipment_IngestBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
	identifierBytes := []byte(Equipment_IngestIdentifier)
	builder.FinishWithFileIdentifier(offset, identifierBytes)
}

func Equipment_IngestBufferHasIdentifier(buf []byte) bool {
	return flatbuffers.BufferHasIdentifier(buf, Equipment_IngestIdentifier)
}

func GetSizePrefixedRootAsEquipment_Ingest(buf []byte, offset flatbuffers.UOffsetT) *Equipment_Ingest {
...
func FinishSizePrefixedEquipment_IngestBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
	identifierBytes := []byte(Equipment_IngestIdentifier)
	builder.FinishSizePrefixedWithFileIdentifier(offset, identifierBytes)
}

func SizePrefixedEquipment_IngestBufferHasIdentifier(buf []byte) bool {
	return flatbuffers.SizePrefixedBufferHasIdentifier(buf, Equipment_IngestIdentifier)
}

func (rcv *Equipment_Ingest) Init(buf []byte, i flatbuffers.UOffsetT) {
	rcv._tab.Bytes = buf
	rcv._tab.Pos = i
}

func (rcv *Equipment_Ingest) Table() flatbuffers.Table {
	return rcv._tab
}
...
func (rcv *Equipment_Ingest) Id() []byte {
...
func (rcv *Equipment_Ingest) ClassificationMarking() []byte {
...
func (rcv *Equipment_Ingest) IdParentEquipment() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 36
func (rcv *Equipment_Ingest) IdSite() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 36
func (rcv *Equipment_Ingest) IdOperatingUnit() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 36
func (rcv *Equipment_Ingest) AltEqpId() []byte {
...
func (rcv *Equipment_Ingest) EqpCode() []byte {
...
func (rcv *Equipment_Ingest) EqpIdNum() []byte {
...
func (rcv *Equipment_Ingest) CountryCode() []byte {
...
func (rcv *Equipment_Ingest) AltCountryCode() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 4
func (rcv *Equipment_Ingest) Wac() []byte {
...
func (rcv *Equipment_Ingest) SeqNum() int32 {
...
/// Example: /// Example: 5
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) MutateSeqNum(n int32) bool {
...
func (rcv *Equipment_Ingest) Nomen() []byte {
...
/// Example: /// Example: OPR
/// Constraints: Minimum length = 0, Maximum length = 3
func (rcv *Equipment_Ingest) OperStatus() []byte {
...
/// Example: /// Example: RDY
/// Constraints: Minimum length = 0, Maximum length = 4
func (rcv *Equipment_Ingest) Condition() []byte {
...
/// Example: /// Example: A
/// Constraints: Minimum length = 0, Maximum length = 4
func (rcv *Equipment_Ingest) ConditionAvail() []byte {
...
/// Example: /// Example: 7
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) Eval() int32 {
...
/// Example: /// Example: 7
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) MutateEval(n int32) bool {
...
func (rcv *Equipment_Ingest) Fpa() []byte {
...
/// Example: /// Example: OCC
/// Constraints: Minimum length = 0, Maximum length = 3
func (rcv *Equipment_Ingest) Function() []byte {
...
func (rcv *Equipment_Ingest) Ident() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 4
func (rcv *Equipment_Ingest) Allegiance() []byte {
...
/// Example: /// Example: HL
/// Constraints: Minimum length = 0, Maximum length = 4
func (rcv *Equipment_Ingest) AltAllegiance() []byte {
...
func (rcv *Equipment_Ingest) LocReason() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 32
func (rcv *Equipment_Ingest) OperAreaPrimary() []byte {
...
/// Example: /// Example: JG
/// Constraints: Minimum length = 0, Maximum length = 4
func (rcv *Equipment_Ingest) FunctPrimary() []byte {
...
func (rcv *Equipment_Ingest) CoordDatum() []byte {
...
func (rcv *Equipment_Ingest) Coord() []byte {
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) CoordDerivAcc() float64 {
...
/// Example: /// Example: 12.345
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) MutateCoordDerivAcc(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) Lat() float64 {
...
/// Example: /// Example: 39.019242
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) MutateLat(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) Lon() float64 {
...
/// Example: /// Example: -104.251659
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) MutateLon(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) ElevMsl() float64 {
...
/// Example: /// Example: 123.45
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) MutateElevMsl(n float64) bool {
...
/// Example: /// Example: 50
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) ElevMslConfLvl() int32 {
...
/// Example: /// Example: 50
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) MutateElevMslConfLvl(n int32) bool {
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) ElevMslDerivAcc() float64 {
...
/// Example: /// Example: 12.34
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) MutateElevMslDerivAcc(n float64) bool {
...
/// Example: /// Example: 12.34
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) GeoidalMslSep() float64 {
...
/// Example: /// Example: 12.34
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) MutateGeoidalMslSep(n float64) bool {
...
/// Example: /// Example: UTM
/// Constraints: Minimum length = 0, Maximum length = 3
func (rcv *Equipment_Ingest) MilGridSys() []byte {
...
func (rcv *Equipment_Ingest) MilGrid() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 16
func (rcv *Equipment_Ingest) Utm() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 5
func (rcv *Equipment_Ingest) AirDefArea() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 7
func (rcv *Equipment_Ingest) PolSubdiv() []byte {
...
/// Example: /// Example: 7
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) QtyOh() int32 {
...
/// Example: /// Example: 7
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) MutateQtyOh(n int32) bool {
...
/// Constraints: Minimum length = 0, Maximum length = 15
func (rcv *Equipment_Ingest) SymCode() []byte {
...
func (rcv *Equipment_Ingest) ClassRating() []byte {
...
/// Example: /// Example: A
/// Constraints: Minimum length = 0, Maximum length = 1
func (rcv *Equipment_Ingest) RecStatus() []byte {
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) ReviewDate() []byte {
...
/// Example: /// Example: RT
/// Constraints: Minimum length = 0, Maximum length = 4
func (rcv *Equipment_Ingest) ResProd() []byte {
...
func (rcv *Equipment_Ingest) ReferenceDoc() []byte {
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) SrcTyps(j int) []byte {
...
func (rcv *Equipment_Ingest) SrcTypsLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(96))
	if o != 0 {
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) SrcIds(j int) []byte {
...
func (rcv *Equipment_Ingest) SrcIdsLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(98))
	if o != 0 {
		return rcv._tab.VectorLen(o)
	}
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Ingest) CreatedAt() []byte {
...
func (rcv *Equipment_Ingest) CreatedBy() []byte {
...
/// Constraints: Minimum length = 1, Maximum length = 64
func (rcv *Equipment_Ingest) Source() []byte {
...
func (rcv *Equipment_Ingest) Origin() []byte {
...
func (rcv *Equipment_Ingest) DataMode() Equipment_Ingest_dataMode_Enum {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(108))
	if o != 0 {
		return Equipment_Ingest_dataMode_Enum(rcv._tab.GetInt8(o + rcv._tab.Pos))
	}
	return 0
}
...
/// Example: /// Example: TEST
/// Constraints: Minimum length = 1, Maximum length = 32
func (rcv *Equipment_Ingest) MutateDataMode(n Equipment_Ingest_dataMode_Enum) bool {
	return rcv._tab.MutateInt8Slot(108, int8(n))
}

func Equipment_IngestStart(builder *flatbuffers.Builder) {
	builder.StartObject(53)
}
func Equipment_IngestAddId(builder *flatbuffers.Builder, id flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(0, flatbuffers.UOffsetT(id), 0)
}
func Equipment_IngestAddClassificationMarking(builder *flatbuffers.Builder, classificationMarking flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(classificationMarking), 0)
}
func Equipment_IngestAddIdParentEquipment(builder *flatbuffers.Builder, idParentEquipment flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(2, flatbuffers.UOffsetT(idParentEquipment), 0)
}
func Equipment_IngestAddIdSite(builder *flatbuffers.Builder, idSite flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(3, flatbuffers.UOffsetT(idSite), 0)
}
func Equipment_IngestAddIdOperatingUnit(builder *flatbuffers.Builder, idOperatingUnit flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(4, flatbuffers.UOffsetT(idOperatingUnit), 0)
}
func Equipment_IngestAddAltEqpId(builder *flatbuffers.Builder, altEqpId flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(5, flatbuffers.UOffsetT(altEqpId), 0)
}
func Equipment_IngestAddEqpCode(builder *flatbuffers.Builder, eqpCode flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(6, flatbuffers.UOffsetT(eqpCode), 0)
}
func Equipment_IngestAddEqpIdNum(builder *flatbuffers.Builder, eqpIdNum flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(7, flatbuffers.UOffsetT(eqpIdNum), 0)
}
func Equipment_IngestAddCountryCode(builder *flatbuffers.Builder, countryCode flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(8, flatbuffers.UOffsetT(countryCode), 0)
}
func Equipment_IngestAddAltCountryCode(builder *flatbuffers.Builder, altCountryCode flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(9, flatbuffers.UOffsetT(altCountryCode), 0)
}
func Equipment_IngestAddWac(builder *flatbuffers.Builder, wac flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(10, flatbuffers.UOffsetT(wac), 0)
}
func Equipment_IngestAddSeqNum(builder *flatbuffers.Builder, seqNum int32) {
	builder.PrependInt32Slot(11, seqNum, 0)
}
func Equipment_IngestAddNomen(builder *flatbuffers.Builder, nomen flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(12, flatbuffers.UOffsetT(nomen), 0)
}
func Equipment_IngestAddOperStatus(builder *flatbuffers.Builder, operStatus flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(13, flatbuffers.UOffsetT(operStatus), 0)
}
func Equipment_IngestAddCondition(builder *flatbuffers.Builder, condition flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(14, flatbuffers.UOffsetT(condition), 0)
}
func Equipment_IngestAddConditionAvail(builder *flatbuffers.Builder, conditionAvail flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(15, flatbuffers.UOffsetT(conditionAvail), 0)
}
func Equipment_IngestAddEval(builder *flatbuffers.Builder, eval int32) {
	builder.PrependInt32Slot(16, eval, 0)
}
func Equipment_IngestAddFpa(builder *flatbuffers.Builder, fpa flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(17, flatbuffers.UOffsetT(fpa), 0)
}
func Equipment_IngestAddFunction(builder *flatbuffers.Builder, function flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(18, flatbuffers.UOffsetT(function), 0)
}
func Equipment_IngestAddIdent(builder *flatbuffers.Builder, ident flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(19, flatbuffers.UOffsetT(ident), 0)
}
func Equipment_IngestAddAllegiance(builder *flatbuffers.Builder, allegiance flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(20, flatbuffers.UOffsetT(allegiance), 0)
}
func Equipment_IngestAddAltAllegiance(builder *flatbuffers.Builder, altAllegiance flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(21, flatbuffers.UOffsetT(altAllegiance), 0)
}
func Equipment_IngestAddLocReason(builder *flatbuffers.Builder, locReason flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(22, flatbuffers.UOffsetT(locReason), 0)
}
func Equipment_IngestAddOperAreaPrimary(builder *flatbuffers.Builder, operAreaPrimary flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(23, flatbuffers.UOffsetT(operAreaPrimary), 0)
}
func Equipment_IngestAddFunctPrimary(builder *flatbuffers.Builder, functPrimary flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(24, flatbuffers.UOffsetT(functPrimary), 0)
}
func Equipment_IngestAddCoordDatum(builder *flatbuffers.Builder, coordDatum flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(25, flatbuffers.UOffsetT(coordDatum), 0)
}
func Equipment_IngestAddCoord(builder *flatbuffers.Builder, coord flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(26, flatbuffers.UOffsetT(coord), 0)
}
func Equipment_IngestAddCoordDerivAcc(builder *flatbuffers.Builder, coordDerivAcc float64) {
	builder.PrependFloat64Slot(27, coordDerivAcc, 0.0)
}
func Equipment_IngestAddLat(builder *flatbuffers.Builder, lat float64) {
	builder.PrependFloat64Slot(28, lat, 0.0)
}
func Equipment_IngestAddLon(builder *flatbuffers.Builder, lon float64) {
	builder.PrependFloat64Slot(29, lon, 0.0)
}
func Equipment_IngestAddElevMsl(builder *flatbuffers.Builder, elevMsl float64) {
	builder.PrependFloat64Slot(30, elevMsl, 0.0)
}
func Equipment_IngestAddElevMslConfLvl(builder *flatbuffers.Builder, elevMslConfLvl int32) {
	builder.PrependInt32Slot(31, elevMslConfLvl, 0)
}
func Equipment_IngestAddElevMslDerivAcc(builder *flatbuffers.Builder, elevMslDerivAcc float64) {
	builder.PrependFloat64Slot(32, elevMslDerivAcc, 0.0)
}
func Equipment_IngestAddGeoidalMslSep(builder *flatbuffers.Builder, geoidalMslSep float64) {
	builder.PrependFloat64Slot(33, geoidalMslSep, 0.0)
}
func Equipment_IngestAddMilGridSys(builder *flatbuffers.Builder, milGridSys flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(34, flatbuffers.UOffsetT(milGridSys), 0)
}
func Equipment_IngestAddMilGrid(builder *flatbuffers.Builder, milGrid flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(35, flatbuffers.UOffsetT(milGrid), 0)
}
func Equipment_IngestAddUtm(builder *flatbuffers.Builder, utm flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(36, flatbuffers.UOffsetT(utm), 0)
}
func Equipment_IngestAddAirDefArea(builder *flatbuffers.Builder, airDefArea flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(37, flatbuffers.UOffsetT(airDefArea), 0)
}
func Equipment_IngestAddPolSubdiv(builder *flatbuffers.Builder, polSubdiv flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(38, flatbuffers.UOffsetT(polSubdiv), 0)
}
func Equipment_IngestAddQtyOh(builder *flatbuffers.Builder, qtyOh int32) {
	builder.PrependInt32Slot(39, qtyOh, 0)
}
func Equipment_IngestAddSymCode(builder *flatbuffers.Builder, symCode flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(40, flatbuffers.UOffsetT(symCode), 0)
}
func Equipment_IngestAddClassRating(builder *flatbuffers.Builder, classRating flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(41, flatbuffers.UOffsetT(classRating), 0)
}
func Equipment_IngestAddRecStatus(builder *flatbuffers.Builder, recStatus flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(42, flatbuffers.UOffsetT(recStatus), 0)
}
func Equipment_IngestAddReviewDate(builder *flatbuffers.Builder, reviewDate flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(43, flatbuffers.UOffsetT(reviewDate), 0)
}
func Equipment_IngestAddResProd(builder *flatbuffers.Builder, resProd flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(44, flatbuffers.UOffsetT(resProd), 0)
}
func Equipment_IngestAddReferenceDoc(builder *flatbuffers.Builder, referenceDoc flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(45, flatbuffers.UOffsetT(referenceDoc), 0)
}
func Equipment_IngestAddSrcTyps(builder *flatbuffers.Builder, srcTyps flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(46, flatbuffers.UOffsetT(srcTyps), 0)
}
func Equipment_IngestStartSrcTypsVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
func Equipment_IngestAddSrcIds(builder *flatbuffers.Builder, srcIds flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(47, flatbuffers.UOffsetT(srcIds), 0)
}
func Equipment_IngestStartSrcIdsVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
func Equipment_IngestAddCreatedAt(builder *flatbuffers.Builder, createdAt flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(48, flatbuffers.UOffsetT(createdAt), 0)
}
func Equipment_IngestAddCreatedBy(builder *flatbuffers.Builder, createdBy flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(49, flatbuffers.UOffsetT(createdBy), 0)
}
func Equipment_IngestAddSource(builder *flatbuffers.Builder, source flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(50, flatbuffers.UOffsetT(source), 0)
}
func Equipment_IngestAddOrigin(builder *flatbuffers.Builder, origin flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(51, flatbuffers.UOffsetT(origin), 0)
}
func Equipment_IngestAddDataMode(builder *flatbuffers.Builder, dataMode Equipment_Ingest_dataMode_Enum) {
	builder.PrependInt8Slot(52, int8(dataMode), 0)
}
func Equipment_IngestEnd(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
