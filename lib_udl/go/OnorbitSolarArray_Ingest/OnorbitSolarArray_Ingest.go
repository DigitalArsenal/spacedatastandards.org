...
const OnorbitSolarArray_IngestIdentifier = "ONOR"
...
func FinishOnorbitSolarArray_IngestBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
	identifierBytes := []byte(OnorbitSolarArray_IngestIdentifier)
	builder.FinishWithFileIdentifier(offset, identifierBytes)
}

func OnorbitSolarArray_IngestBufferHasIdentifier(buf []byte) bool {
	return flatbuffers.BufferHasIdentifier(buf, OnorbitSolarArray_IngestIdentifier)
}
...
func SizePrefixedOnorbitSolarArray_IngestBufferHasIdentifier(buf []byte) bool {
	return flatbuffers.SizePrefixedBufferHasIdentifier(buf, OnorbitSolarArray_IngestIdentifier)
}
...
func (rcv *OnorbitSolarArray_Ingest) DataMode() OnorbitSolarArray_Ingest_dataMode_Enum {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(22))
	if o != 0 {
		return OnorbitSolarArray_Ingest_dataMode_Enum(rcv._tab.GetInt8(o + rcv._tab.Pos))
	}
	return 0
}
...
/// Example: /// Example: TEST
/// Constraints: Minimum length = 1, Maximum length = 32
func (rcv *OnorbitSolarArray_Ingest) MutateDataMode(n OnorbitSolarArray_Ingest_dataMode_Enum) bool {
...
func OnorbitSolarArray_IngestAddDataMode(builder *flatbuffers.Builder, dataMode OnorbitSolarArray_Ingest_dataMode_Enum) {
