...
type Equipment_Full struct {
	_tab flatbuffers.Table
}

const Equipment_FullIdentifier = "EQUI"

func GetRootAsEquipment_Full(buf []byte, offset flatbuffers.UOffsetT) *Equipment_Full {
...
func FinishEquipment_FullBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
	identifierBytes := []byte(Equipment_FullIdentifier)
	builder.FinishWithFileIdentifier(offset, identifierBytes)
}

func Equipment_FullBufferHasIdentifier(buf []byte) bool {
	return flatbuffers.BufferHasIdentifier(buf, Equipment_FullIdentifier)
}

func GetSizePrefixedRootAsEquipment_Full(buf []byte, offset flatbuffers.UOffsetT) *Equipment_Full {
...
func FinishSizePrefixedEquipment_FullBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
	identifierBytes := []byte(Equipment_FullIdentifier)
	builder.FinishSizePrefixedWithFileIdentifier(offset, identifierBytes)
}

func SizePrefixedEquipment_FullBufferHasIdentifier(buf []byte) bool {
	return flatbuffers.SizePrefixedBufferHasIdentifier(buf, Equipment_FullIdentifier)
}

func (rcv *Equipment_Full) Init(buf []byte, i flatbuffers.UOffsetT) {
	rcv._tab.Bytes = buf
	rcv._tab.Pos = i
}

func (rcv *Equipment_Full) Table() flatbuffers.Table {
	return rcv._tab
}
...
func (rcv *Equipment_Full) Id() []byte {
...
func (rcv *Equipment_Full) ClassificationMarking() []byte {
...
func (rcv *Equipment_Full) IdParentEquipment() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 36
func (rcv *Equipment_Full) IdSite() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 36
func (rcv *Equipment_Full) IdOperatingUnit() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 36
func (rcv *Equipment_Full) AltEqpId() []byte {
...
func (rcv *Equipment_Full) EqpCode() []byte {
...
func (rcv *Equipment_Full) EqpIdNum() []byte {
...
func (rcv *Equipment_Full) CountryCode() []byte {
...
func (rcv *Equipment_Full) AltCountryCode() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 4
func (rcv *Equipment_Full) Wac() []byte {
...
func (rcv *Equipment_Full) SeqNum() int32 {
...
/// Example: /// Example: 5
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) MutateSeqNum(n int32) bool {
...
func (rcv *Equipment_Full) Nomen() []byte {
...
/// Example: /// Example: OPR
/// Constraints: Minimum length = 0, Maximum length = 3
func (rcv *Equipment_Full) OperStatus() []byte {
...
/// Example: /// Example: RDY
/// Constraints: Minimum length = 0, Maximum length = 4
func (rcv *Equipment_Full) Condition() []byte {
...
/// Example: /// Example: A
/// Constraints: Minimum length = 0, Maximum length = 4
func (rcv *Equipment_Full) ConditionAvail() []byte {
...
/// Example: /// Example: 7
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) Eval() int32 {
...
/// Example: /// Example: 7
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) MutateEval(n int32) bool {
...
func (rcv *Equipment_Full) Fpa() []byte {
...
/// Example: /// Example: OCC
/// Constraints: Minimum length = 0, Maximum length = 3
func (rcv *Equipment_Full) Function() []byte {
...
func (rcv *Equipment_Full) Ident() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 4
func (rcv *Equipment_Full) Allegiance() []byte {
...
/// Example: /// Example: HL
/// Constraints: Minimum length = 0, Maximum length = 4
func (rcv *Equipment_Full) AltAllegiance() []byte {
...
func (rcv *Equipment_Full) LocReason() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 32
func (rcv *Equipment_Full) OperAreaPrimary() []byte {
...
/// Example: /// Example: JG
/// Constraints: Minimum length = 0, Maximum length = 4
func (rcv *Equipment_Full) FunctPrimary() []byte {
...
func (rcv *Equipment_Full) CoordDatum() []byte {
...
func (rcv *Equipment_Full) Coord() []byte {
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) CoordDerivAcc() float64 {
...
/// Example: /// Example: 12.345
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) MutateCoordDerivAcc(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) Lat() float64 {
...
/// Example: /// Example: 39.019242
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) MutateLat(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) Lon() float64 {
...
/// Example: /// Example: -104.251659
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) MutateLon(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) ElevMsl() float64 {
...
/// Example: /// Example: 123.45
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) MutateElevMsl(n float64) bool {
...
/// Example: /// Example: 50
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) ElevMslConfLvl() int32 {
...
/// Example: /// Example: 50
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) MutateElevMslConfLvl(n int32) bool {
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) ElevMslDerivAcc() float64 {
...
/// Example: /// Example: 12.34
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) MutateElevMslDerivAcc(n float64) bool {
...
/// Example: /// Example: 12.34
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) GeoidalMslSep() float64 {
...
/// Example: /// Example: 12.34
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) MutateGeoidalMslSep(n float64) bool {
...
/// Example: /// Example: UTM
/// Constraints: Minimum length = 0, Maximum length = 3
func (rcv *Equipment_Full) MilGridSys() []byte {
...
func (rcv *Equipment_Full) MilGrid() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 16
func (rcv *Equipment_Full) Utm() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 5
func (rcv *Equipment_Full) AirDefArea() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 7
func (rcv *Equipment_Full) PolSubdiv() []byte {
...
/// Example: /// Example: 7
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) QtyOh() int32 {
...
/// Example: /// Example: 7
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) MutateQtyOh(n int32) bool {
...
/// Constraints: Minimum length = 0, Maximum length = 15
func (rcv *Equipment_Full) SymCode() []byte {
...
func (rcv *Equipment_Full) ClassRating() []byte {
...
/// Example: /// Example: A
/// Constraints: Minimum length = 0, Maximum length = 1
func (rcv *Equipment_Full) RecStatus() []byte {
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) ReviewDate() []byte {
...
/// Example: /// Example: RT
/// Constraints: Minimum length = 0, Maximum length = 4
func (rcv *Equipment_Full) ResProd() []byte {
...
func (rcv *Equipment_Full) ReferenceDoc() []byte {
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) SrcTyps(j int) []byte {
...
func (rcv *Equipment_Full) SrcTypsLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(96))
	if o != 0 {
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) SrcIds(j int) []byte {
...
func (rcv *Equipment_Full) SrcIdsLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(98))
	if o != 0 {
		return rcv._tab.VectorLen(o)
	}
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) EquipmentRemarks(j int) []byte {
...
func (rcv *Equipment_Full) EquipmentRemarksLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(100))
	if o != 0 {
		return rcv._tab.VectorLen(o)
	}
...
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) CreatedAt() []byte {
...
func (rcv *Equipment_Full) CreatedBy() []byte {
...
/// Example: /// Example: 2018-01-01T16:00:00.123Z
/// Constraints: No constraints specified.
func (rcv *Equipment_Full) UpdatedAt() []byte {
...
func (rcv *Equipment_Full) UpdatedBy() []byte {
...
/// Constraints: Minimum length = 1, Maximum length = 64
func (rcv *Equipment_Full) Source() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 64
func (rcv *Equipment_Full) Origin() []byte {
...
func (rcv *Equipment_Full) DataMode() Equipment_Full_dataMode_Enum {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(114))
	if o != 0 {
		return Equipment_Full_dataMode_Enum(rcv._tab.GetInt8(o + rcv._tab.Pos))
	}
	return 0
}
...
/// Example: /// Example: TEST
/// Constraints: Minimum length = 1, Maximum length = 32
func (rcv *Equipment_Full) MutateDataMode(n Equipment_Full_dataMode_Enum) bool {
	return rcv._tab.MutateInt8Slot(114, int8(n))
}

func Equipment_FullStart(builder *flatbuffers.Builder) {
	builder.StartObject(56)
}
func Equipment_FullAddId(builder *flatbuffers.Builder, id flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(0, flatbuffers.UOffsetT(id), 0)
}
func Equipment_FullAddClassificationMarking(builder *flatbuffers.Builder, classificationMarking flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(classificationMarking), 0)
}
func Equipment_FullAddIdParentEquipment(builder *flatbuffers.Builder, idParentEquipment flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(2, flatbuffers.UOffsetT(idParentEquipment), 0)
}
func Equipment_FullAddIdSite(builder *flatbuffers.Builder, idSite flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(3, flatbuffers.UOffsetT(idSite), 0)
}
func Equipment_FullAddIdOperatingUnit(builder *flatbuffers.Builder, idOperatingUnit flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(4, flatbuffers.UOffsetT(idOperatingUnit), 0)
}
func Equipment_FullAddAltEqpId(builder *flatbuffers.Builder, altEqpId flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(5, flatbuffers.UOffsetT(altEqpId), 0)
}
func Equipment_FullAddEqpCode(builder *flatbuffers.Builder, eqpCode flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(6, flatbuffers.UOffsetT(eqpCode), 0)
}
func Equipment_FullAddEqpIdNum(builder *flatbuffers.Builder, eqpIdNum flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(7, flatbuffers.UOffsetT(eqpIdNum), 0)
}
func Equipment_FullAddCountryCode(builder *flatbuffers.Builder, countryCode flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(8, flatbuffers.UOffsetT(countryCode), 0)
}
func Equipment_FullAddAltCountryCode(builder *flatbuffers.Builder, altCountryCode flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(9, flatbuffers.UOffsetT(altCountryCode), 0)
}
func Equipment_FullAddWac(builder *flatbuffers.Builder, wac flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(10, flatbuffers.UOffsetT(wac), 0)
}
func Equipment_FullAddSeqNum(builder *flatbuffers.Builder, seqNum int32) {
	builder.PrependInt32Slot(11, seqNum, 0)
}
func Equipment_FullAddNomen(builder *flatbuffers.Builder, nomen flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(12, flatbuffers.UOffsetT(nomen), 0)
}
func Equipment_FullAddOperStatus(builder *flatbuffers.Builder, operStatus flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(13, flatbuffers.UOffsetT(operStatus), 0)
}
func Equipment_FullAddCondition(builder *flatbuffers.Builder, condition flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(14, flatbuffers.UOffsetT(condition), 0)
}
func Equipment_FullAddConditionAvail(builder *flatbuffers.Builder, conditionAvail flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(15, flatbuffers.UOffsetT(conditionAvail), 0)
}
func Equipment_FullAddEval(builder *flatbuffers.Builder, eval int32) {
	builder.PrependInt32Slot(16, eval, 0)
}
func Equipment_FullAddFpa(builder *flatbuffers.Builder, fpa flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(17, flatbuffers.UOffsetT(fpa), 0)
}
func Equipment_FullAddFunction(builder *flatbuffers.Builder, function flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(18, flatbuffers.UOffsetT(function), 0)
}
func Equipment_FullAddIdent(builder *flatbuffers.Builder, ident flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(19, flatbuffers.UOffsetT(ident), 0)
}
func Equipment_FullAddAllegiance(builder *flatbuffers.Builder, allegiance flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(20, flatbuffers.UOffsetT(allegiance), 0)
}
func Equipment_FullAddAltAllegiance(builder *flatbuffers.Builder, altAllegiance flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(21, flatbuffers.UOffsetT(altAllegiance), 0)
}
func Equipment_FullAddLocReason(builder *flatbuffers.Builder, locReason flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(22, flatbuffers.UOffsetT(locReason), 0)
}
func Equipment_FullAddOperAreaPrimary(builder *flatbuffers.Builder, operAreaPrimary flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(23, flatbuffers.UOffsetT(operAreaPrimary), 0)
}
func Equipment_FullAddFunctPrimary(builder *flatbuffers.Builder, functPrimary flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(24, flatbuffers.UOffsetT(functPrimary), 0)
}
func Equipment_FullAddCoordDatum(builder *flatbuffers.Builder, coordDatum flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(25, flatbuffers.UOffsetT(coordDatum), 0)
}
func Equipment_FullAddCoord(builder *flatbuffers.Builder, coord flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(26, flatbuffers.UOffsetT(coord), 0)
}
func Equipment_FullAddCoordDerivAcc(builder *flatbuffers.Builder, coordDerivAcc float64) {
	builder.PrependFloat64Slot(27, coordDerivAcc, 0.0)
}
func Equipment_FullAddLat(builder *flatbuffers.Builder, lat float64) {
	builder.PrependFloat64Slot(28, lat, 0.0)
}
func Equipment_FullAddLon(builder *flatbuffers.Builder, lon float64) {
	builder.PrependFloat64Slot(29, lon, 0.0)
}
func Equipment_FullAddElevMsl(builder *flatbuffers.Builder, elevMsl float64) {
	builder.PrependFloat64Slot(30, elevMsl, 0.0)
}
func Equipment_FullAddElevMslConfLvl(builder *flatbuffers.Builder, elevMslConfLvl int32) {
	builder.PrependInt32Slot(31, elevMslConfLvl, 0)
}
func Equipment_FullAddElevMslDerivAcc(builder *flatbuffers.Builder, elevMslDerivAcc float64) {
	builder.PrependFloat64Slot(32, elevMslDerivAcc, 0.0)
}
func Equipment_FullAddGeoidalMslSep(builder *flatbuffers.Builder, geoidalMslSep float64) {
	builder.PrependFloat64Slot(33, geoidalMslSep, 0.0)
}
func Equipment_FullAddMilGridSys(builder *flatbuffers.Builder, milGridSys flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(34, flatbuffers.UOffsetT(milGridSys), 0)
}
func Equipment_FullAddMilGrid(builder *flatbuffers.Builder, milGrid flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(35, flatbuffers.UOffsetT(milGrid), 0)
}
func Equipment_FullAddUtm(builder *flatbuffers.Builder, utm flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(36, flatbuffers.UOffsetT(utm), 0)
}
func Equipment_FullAddAirDefArea(builder *flatbuffers.Builder, airDefArea flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(37, flatbuffers.UOffsetT(airDefArea), 0)
}
func Equipment_FullAddPolSubdiv(builder *flatbuffers.Builder, polSubdiv flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(38, flatbuffers.UOffsetT(polSubdiv), 0)
}
func Equipment_FullAddQtyOh(builder *flatbuffers.Builder, qtyOh int32) {
	builder.PrependInt32Slot(39, qtyOh, 0)
}
func Equipment_FullAddSymCode(builder *flatbuffers.Builder, symCode flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(40, flatbuffers.UOffsetT(symCode), 0)
}
func Equipment_FullAddClassRating(builder *flatbuffers.Builder, classRating flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(41, flatbuffers.UOffsetT(classRating), 0)
}
func Equipment_FullAddRecStatus(builder *flatbuffers.Builder, recStatus flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(42, flatbuffers.UOffsetT(recStatus), 0)
}
func Equipment_FullAddReviewDate(builder *flatbuffers.Builder, reviewDate flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(43, flatbuffers.UOffsetT(reviewDate), 0)
}
func Equipment_FullAddResProd(builder *flatbuffers.Builder, resProd flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(44, flatbuffers.UOffsetT(resProd), 0)
}
func Equipment_FullAddReferenceDoc(builder *flatbuffers.Builder, referenceDoc flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(45, flatbuffers.UOffsetT(referenceDoc), 0)
}
func Equipment_FullAddSrcTyps(builder *flatbuffers.Builder, srcTyps flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(46, flatbuffers.UOffsetT(srcTyps), 0)
}
func Equipment_FullStartSrcTypsVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
func Equipment_FullAddSrcIds(builder *flatbuffers.Builder, srcIds flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(47, flatbuffers.UOffsetT(srcIds), 0)
}
func Equipment_FullStartSrcIdsVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
func Equipment_FullAddEquipmentRemarks(builder *flatbuffers.Builder, equipmentRemarks flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(48, flatbuffers.UOffsetT(equipmentRemarks), 0)
}
func Equipment_FullStartEquipmentRemarksVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
func Equipment_FullAddCreatedAt(builder *flatbuffers.Builder, createdAt flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(49, flatbuffers.UOffsetT(createdAt), 0)
}
func Equipment_FullAddCreatedBy(builder *flatbuffers.Builder, createdBy flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(50, flatbuffers.UOffsetT(createdBy), 0)
}
func Equipment_FullAddUpdatedAt(builder *flatbuffers.Builder, updatedAt flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(51, flatbuffers.UOffsetT(updatedAt), 0)
}
func Equipment_FullAddUpdatedBy(builder *flatbuffers.Builder, updatedBy flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(52, flatbuffers.UOffsetT(updatedBy), 0)
}
func Equipment_FullAddSource(builder *flatbuffers.Builder, source flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(53, flatbuffers.UOffsetT(source), 0)
}
func Equipment_FullAddOrigin(builder *flatbuffers.Builder, origin flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(54, flatbuffers.UOffsetT(origin), 0)
}
func Equipment_FullAddDataMode(builder *flatbuffers.Builder, dataMode Equipment_Full_dataMode_Enum) {
	builder.PrependInt8Slot(55, int8(dataMode), 0)
}
func Equipment_FullEnd(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
