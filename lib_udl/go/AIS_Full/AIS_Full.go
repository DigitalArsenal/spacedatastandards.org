...
type AIS_Full struct {
	_tab flatbuffers.Table
}

const AIS_FullIdentifier = "AISF"

func GetRootAsAIS_Full(buf []byte, offset flatbuffers.UOffsetT) *AIS_Full {
...
func FinishAIS_FullBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
	identifierBytes := []byte(AIS_FullIdentifier)
	builder.FinishWithFileIdentifier(offset, identifierBytes)
}

func AIS_FullBufferHasIdentifier(buf []byte) bool {
	return flatbuffers.BufferHasIdentifier(buf, AIS_FullIdentifier)
}

func GetSizePrefixedRootAsAIS_Full(buf []byte, offset flatbuffers.UOffsetT) *AIS_Full {
...
func FinishSizePrefixedAIS_FullBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
	identifierBytes := []byte(AIS_FullIdentifier)
	builder.FinishSizePrefixedWithFileIdentifier(offset, identifierBytes)
}

func SizePrefixedAIS_FullBufferHasIdentifier(buf []byte) bool {
	return flatbuffers.SizePrefixedBufferHasIdentifier(buf, AIS_FullIdentifier)
}

func (rcv *AIS_Full) Init(buf []byte, i flatbuffers.UOffsetT) {
	rcv._tab.Bytes = buf
	rcv._tab.Pos = i
}

func (rcv *AIS_Full) Table() flatbuffers.Table {
	return rcv._tab
}
...
func (rcv *AIS_Full) ClassificationMarking() []byte {
...
func (rcv *AIS_Full) IdTrack() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 36
func (rcv *AIS_Full) IdVessel() []byte {
...
/// Example: /// Example: 304010417
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutateMmsi(n int64) bool {
...
/// Example: /// Example: 9015462
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutateImon(n int64) bool {
...
func (rcv *AIS_Full) ShipName() []byte {
...
func (rcv *AIS_Full) ShipType() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 48
func (rcv *AIS_Full) EngagedIn() []byte {
...
/// Example: /// Example: Tug
/// Constraints: Minimum length = 0, Maximum length = 48
func (rcv *AIS_Full) SpecialCraft() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 48
func (rcv *AIS_Full) CargoType() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 24
func (rcv *AIS_Full) CallSign() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 36
func (rcv *AIS_Full) VesselFlag() []byte {
...
/// Example: /// Example: 47.758499
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutateLat(n float64) bool {
...
/// Example: /// Example: -5.154223
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutateLon(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *AIS_Full) PosHiAccuracy() bool {
...
/// Example: /// Example: True
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutatePosHiAccuracy(n bool) bool {
...
/// Example: /// Example: True
/// Constraints: No constraints specified.
func (rcv *AIS_Full) PosHiLatency() bool {
...
/// Example: /// Example: True
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutatePosHiLatency(n bool) bool {
...
/// Constraints: No constraints specified.
func (rcv *AIS_Full) Speed() float64 {
...
/// Example: /// Example: 10.5
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutateSpeed(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *AIS_Full) TrueHeading() float64 {
...
/// Example: /// Example: 329.1
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutateTrueHeading(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *AIS_Full) Course() float64 {
...
/// Example: /// Example: 157.1
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutateCourse(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *AIS_Full) RateOfTurn() float64 {
...
/// Example: /// Example: 22.1
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutateRateOfTurn(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *AIS_Full) SpecialManeuver() bool {
...
/// Example: /// Example: False
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutateSpecialManeuver(n bool) bool {
...
func (rcv *AIS_Full) NavStatus() []byte {
...
/// Example: /// Example: GPS
/// Constraints: Minimum length = 0, Maximum length = 24
func (rcv *AIS_Full) PosDeviceType() []byte {
...
/// Constraints: No constraints specified.
func (rcv *AIS_Full) AntennaRefDimensions(j int) []byte {
...
func (rcv *AIS_Full) AntennaRefDimensionsLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(54))
	if o != 0 {
...
/// Constraints: No constraints specified.
func (rcv *AIS_Full) Length() float64 {
...
/// Example: /// Example: 511.1
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutateLength(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *AIS_Full) Width() float64 {
...
/// Example: /// Example: 24.1
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutateWidth(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *AIS_Full) Draught() float64 {
...
/// Example: /// Example: 21.1
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutateDraught(n float64) bool {
...
func (rcv *AIS_Full) ShipDescription() []byte {
...
func (rcv *AIS_Full) Destination() []byte {
...
/// Example: /// Example: 2021-02-25T12:00:00.123456Z
/// Constraints: No constraints specified.
func (rcv *AIS_Full) DestinationEta() []byte {
...
func (rcv *AIS_Full) CurrentPortGuid() []byte {
...
func (rcv *AIS_Full) CurrentPortLocode() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 4
func (rcv *AIS_Full) LastPortGuid() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 5
func (rcv *AIS_Full) LastPortLocode() []byte {
...
/// Constraints: Minimum length = 0, Maximum length = 4
func (rcv *AIS_Full) NextPortGuid() []byte {
...
/// Example: /// Example: USCLE
/// Constraints: Minimum length = 0, Maximum length = 5
func (rcv *AIS_Full) NextPortLocode() []byte {
...
/// Example: /// Example: 2021-02-25T12:00:00.123456Z
/// Constraints: No constraints specified.
func (rcv *AIS_Full) EtaCalculated() []byte {
...
/// Example: /// Example: 2021-02-25T12:00:00.123456Z
/// Constraints: No constraints specified.
func (rcv *AIS_Full) EtaUpdated() []byte {
...
/// Constraints: No constraints specified.
func (rcv *AIS_Full) DistanceToGo() float64 {
...
/// Example: /// Example: 150.5
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutateDistanceToGo(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *AIS_Full) DistanceTravelled() float64 {
...
/// Example: /// Example: 200.3
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutateDistanceTravelled(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *AIS_Full) AvgSpeed() float64 {
...
/// Example: /// Example: 12.1
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutateAvgSpeed(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MaxSpeed() float64 {
...
/// Example: /// Example: 13.3
/// Constraints: No constraints specified.
func (rcv *AIS_Full) MutateMaxSpeed(n float64) bool {
...
/// Constraints: No constraints specified.
func (rcv *AIS_Full) CreatedAt() []byte {
...
func (rcv *AIS_Full) CreatedBy() []byte {
...
/// Example: /// Example: AXE
/// Constraints: Minimum length = 0, Maximum length = 64
func (rcv *AIS_Full) SourceDl() []byte {
...
func (rcv *AIS_Full) DataMode() AIS_Full_dataMode_Enum {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(102))
	if o != 0 {
		return AIS_Full_dataMode_Enum(rcv._tab.GetInt8(o + rcv._tab.Pos))
	}
	return 0
}
...
/// Example: /// Example: TEST
/// Constraints: Minimum length = 1, Maximum length = 32
func (rcv *AIS_Full) MutateDataMode(n AIS_Full_dataMode_Enum) bool {
...
/// Constraints: Minimum length = 1, Maximum length = 32
func (rcv *AIS_Full) OrigNetwork() []byte {
...
/// Example: /// Example: ORIG
/// Constraints: Minimum length = 1, Maximum length = 32
func AIS_FullStart(builder *flatbuffers.Builder) {
	builder.StartObject(51)
}
func AIS_FullAddId(builder *flatbuffers.Builder, id flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(0, flatbuffers.UOffsetT(id), 0)
}
func AIS_FullAddClassificationMarking(builder *flatbuffers.Builder, classificationMarking flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(classificationMarking), 0)
}
func AIS_FullAddIdTrack(builder *flatbuffers.Builder, idTrack flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(2, flatbuffers.UOffsetT(idTrack), 0)
}
func AIS_FullAddIdVessel(builder *flatbuffers.Builder, idVessel flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(3, flatbuffers.UOffsetT(idVessel), 0)
}
func AIS_FullAddMmsi(builder *flatbuffers.Builder, mmsi int64) {
	builder.PrependInt64Slot(4, mmsi, 0)
}
func AIS_FullAddImon(builder *flatbuffers.Builder, imon int64) {
	builder.PrependInt64Slot(5, imon, 0)
}
func AIS_FullAddTs(builder *flatbuffers.Builder, ts flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(6, flatbuffers.UOffsetT(ts), 0)
}
func AIS_FullAddShipName(builder *flatbuffers.Builder, shipName flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(7, flatbuffers.UOffsetT(shipName), 0)
}
func AIS_FullAddShipType(builder *flatbuffers.Builder, shipType flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(8, flatbuffers.UOffsetT(shipType), 0)
}
func AIS_FullAddEngagedIn(builder *flatbuffers.Builder, engagedIn flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(9, flatbuffers.UOffsetT(engagedIn), 0)
}
func AIS_FullAddSpecialCraft(builder *flatbuffers.Builder, specialCraft flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(10, flatbuffers.UOffsetT(specialCraft), 0)
}
func AIS_FullAddCargoType(builder *flatbuffers.Builder, cargoType flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(11, flatbuffers.UOffsetT(cargoType), 0)
}
func AIS_FullAddCallSign(builder *flatbuffers.Builder, callSign flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(12, flatbuffers.UOffsetT(callSign), 0)
}
func AIS_FullAddVesselFlag(builder *flatbuffers.Builder, vesselFlag flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(13, flatbuffers.UOffsetT(vesselFlag), 0)
}
func AIS_FullAddLat(builder *flatbuffers.Builder, lat float64) {
	builder.PrependFloat64Slot(14, lat, 0.0)
}
func AIS_FullAddLon(builder *flatbuffers.Builder, lon float64) {
	builder.PrependFloat64Slot(15, lon, 0.0)
}
func AIS_FullAddPosHiAccuracy(builder *flatbuffers.Builder, posHiAccuracy bool) {
	builder.PrependBoolSlot(16, posHiAccuracy, false)
}
func AIS_FullAddPosHiLatency(builder *flatbuffers.Builder, posHiLatency bool) {
	builder.PrependBoolSlot(17, posHiLatency, false)
}
func AIS_FullAddSpeed(builder *flatbuffers.Builder, speed float64) {
	builder.PrependFloat64Slot(18, speed, 0.0)
}
func AIS_FullAddTrueHeading(builder *flatbuffers.Builder, trueHeading float64) {
	builder.PrependFloat64Slot(19, trueHeading, 0.0)
}
func AIS_FullAddCourse(builder *flatbuffers.Builder, course float64) {
	builder.PrependFloat64Slot(20, course, 0.0)
}
func AIS_FullAddRateOfTurn(builder *flatbuffers.Builder, rateOfTurn float64) {
	builder.PrependFloat64Slot(21, rateOfTurn, 0.0)
}
func AIS_FullAddSpecialManeuver(builder *flatbuffers.Builder, specialManeuver bool) {
	builder.PrependBoolSlot(22, specialManeuver, false)
}
func AIS_FullAddNavStatus(builder *flatbuffers.Builder, navStatus flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(23, flatbuffers.UOffsetT(navStatus), 0)
}
func AIS_FullAddPosDeviceType(builder *flatbuffers.Builder, posDeviceType flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(24, flatbuffers.UOffsetT(posDeviceType), 0)
}
func AIS_FullAddAntennaRefDimensions(builder *flatbuffers.Builder, antennaRefDimensions flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(25, flatbuffers.UOffsetT(antennaRefDimensions), 0)
}
func AIS_FullStartAntennaRefDimensionsVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT {
	return builder.StartVector(4, numElems, 4)
}
func AIS_FullAddLength(builder *flatbuffers.Builder, length float64) {
	builder.PrependFloat64Slot(26, length, 0.0)
}
func AIS_FullAddWidth(builder *flatbuffers.Builder, width float64) {
	builder.PrependFloat64Slot(27, width, 0.0)
}
func AIS_FullAddDraught(builder *flatbuffers.Builder, draught float64) {
	builder.PrependFloat64Slot(28, draught, 0.0)
}
func AIS_FullAddShipDescription(builder *flatbuffers.Builder, shipDescription flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(29, flatbuffers.UOffsetT(shipDescription), 0)
}
func AIS_FullAddDestination(builder *flatbuffers.Builder, destination flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(30, flatbuffers.UOffsetT(destination), 0)
}
func AIS_FullAddDestinationEta(builder *flatbuffers.Builder, destinationEta flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(31, flatbuffers.UOffsetT(destinationEta), 0)
}
func AIS_FullAddCurrentPortGuid(builder *flatbuffers.Builder, currentPortGuid flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(32, flatbuffers.UOffsetT(currentPortGuid), 0)
}
func AIS_FullAddCurrentPortLocode(builder *flatbuffers.Builder, currentPortLocode flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(33, flatbuffers.UOffsetT(currentPortLocode), 0)
}
func AIS_FullAddLastPortGuid(builder *flatbuffers.Builder, lastPortGuid flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(34, flatbuffers.UOffsetT(lastPortGuid), 0)
}
func AIS_FullAddLastPortLocode(builder *flatbuffers.Builder, lastPortLocode flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(35, flatbuffers.UOffsetT(lastPortLocode), 0)
}
func AIS_FullAddNextPortGuid(builder *flatbuffers.Builder, nextPortGuid flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(36, flatbuffers.UOffsetT(nextPortGuid), 0)
}
func AIS_FullAddNextPortLocode(builder *flatbuffers.Builder, nextPortLocode flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(37, flatbuffers.UOffsetT(nextPortLocode), 0)
}
func AIS_FullAddEtaCalculated(builder *flatbuffers.Builder, etaCalculated flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(38, flatbuffers.UOffsetT(etaCalculated), 0)
}
func AIS_FullAddEtaUpdated(builder *flatbuffers.Builder, etaUpdated flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(39, flatbuffers.UOffsetT(etaUpdated), 0)
}
func AIS_FullAddDistanceToGo(builder *flatbuffers.Builder, distanceToGo float64) {
	builder.PrependFloat64Slot(40, distanceToGo, 0.0)
}
func AIS_FullAddDistanceTravelled(builder *flatbuffers.Builder, distanceTravelled float64) {
	builder.PrependFloat64Slot(41, distanceTravelled, 0.0)
}
func AIS_FullAddAvgSpeed(builder *flatbuffers.Builder, avgSpeed float64) {
	builder.PrependFloat64Slot(42, avgSpeed, 0.0)
}
func AIS_FullAddMaxSpeed(builder *flatbuffers.Builder, maxSpeed float64) {
	builder.PrependFloat64Slot(43, maxSpeed, 0.0)
}
func AIS_FullAddCreatedAt(builder *flatbuffers.Builder, createdAt flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(44, flatbuffers.UOffsetT(createdAt), 0)
}
func AIS_FullAddCreatedBy(builder *flatbuffers.Builder, createdBy flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(45, flatbuffers.UOffsetT(createdBy), 0)
}
func AIS_FullAddSource(builder *flatbuffers.Builder, source flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(46, flatbuffers.UOffsetT(source), 0)
}
func AIS_FullAddSourceDl(builder *flatbuffers.Builder, sourceDl flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(47, flatbuffers.UOffsetT(sourceDl), 0)
}
func AIS_FullAddOrigin(builder *flatbuffers.Builder, origin flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(48, flatbuffers.UOffsetT(origin), 0)
}
func AIS_FullAddDataMode(builder *flatbuffers.Builder, dataMode AIS_Full_dataMode_Enum) {
	builder.PrependInt8Slot(49, int8(dataMode), 0)
}
func AIS_FullAddOrigNetwork(builder *flatbuffers.Builder, origNetwork flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(50, flatbuffers.UOffsetT(origNetwork), 0)
}
func AIS_FullEnd(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
