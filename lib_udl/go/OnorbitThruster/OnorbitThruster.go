...
const OnorbitThrusterIdentifier = "ONOR"
...
func FinishOnorbitThrusterBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
	identifierBytes := []byte(OnorbitThrusterIdentifier)
	builder.FinishWithFileIdentifier(offset, identifierBytes)
}

func OnorbitThrusterBufferHasIdentifier(buf []byte) bool {
	return flatbuffers.BufferHasIdentifier(buf, OnorbitThrusterIdentifier)
}
...
func SizePrefixedOnorbitThrusterBufferHasIdentifier(buf []byte) bool {
	return flatbuffers.SizePrefixedBufferHasIdentifier(buf, OnorbitThrusterIdentifier)
}
...
func (rcv *OnorbitThruster) DataMode() OnorbitThruster_dataMode_Enum {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(28))
	if o != 0 {
		return OnorbitThruster_dataMode_Enum(rcv._tab.GetInt8(o + rcv._tab.Pos))
	}
	return 0
}
...
/// Example: /// Example: TEST
/// Constraints: Minimum length = 1, Maximum length = 32
func (rcv *OnorbitThruster) MutateDataMode(n OnorbitThruster_dataMode_Enum) bool {
...
func OnorbitThrusterAddDataMode(builder *flatbuffers.Builder, dataMode OnorbitThruster_dataMode_Enum) {
