...
const EvacTreatment_FullIdentifier = "EVAC"
...
func FinishEvacTreatment_FullBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
	identifierBytes := []byte(EvacTreatment_FullIdentifier)
	builder.FinishWithFileIdentifier(offset, identifierBytes)
}

func EvacTreatment_FullBufferHasIdentifier(buf []byte) bool {
	return flatbuffers.BufferHasIdentifier(buf, EvacTreatment_FullIdentifier)
}
...
func SizePrefixedEvacTreatment_FullBufferHasIdentifier(buf []byte) bool {
	return flatbuffers.SizePrefixedBufferHasIdentifier(buf, EvacTreatment_FullIdentifier)
}
