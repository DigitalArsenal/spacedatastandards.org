...
import { ItemTracking_Ingest_dataMode_Enum } from './item-tracking-ingest-data-mode-enum.js';


/**
 * /// No description available.
 */
export class ItemTracking_Ingest implements flatbuffers.IUnpackableObject<ItemTracking_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ItemTracking_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsItemTracking_Ingest(bb:flatbuffers.ByteBuffer, obj?:ItemTracking_Ingest):ItemTracking_Ingest {
  return (obj || new ItemTracking_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsItemTracking_Ingest(bb:flatbuffers.ByteBuffer, obj?:ItemTracking_Ingest):ItemTracking_Ingest {
...
dataMode():ItemTracking_Ingest_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : ItemTracking_Ingest_dataMode_Enum.REAL;
}

static startItemTracking_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:ItemTracking_Ingest_dataMode_Enum) {
  builder.addFieldInt8(21, dataMode, ItemTracking_Ingest_dataMode_Enum.REAL);
}

static endItemTracking_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishItemTracking_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ITEM');
}

static finishSizePrefixedItemTracking_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ITEM', true);
}

static createItemTracking_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, scanCodeOffset:flatbuffers.Offset, scGenToolOffset:flatbuffers.Offset, scannerIdOffset:flatbuffers.Offset, tsOffset:flatbuffers.Offset, idItemOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, lat:number, lon:number, scanTypeOffset:flatbuffers.Offset, dvCodeOffset:flatbuffers.Offset, notesOffset:flatbuffers.Offset, keysOffset:flatbuffers.Offset, valuesOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:ItemTracking_Ingest_dataMode_Enum):flatbuffers.Offset {
  ItemTracking_Ingest.startItemTracking_Ingest(builder);
...
unpack(): ItemTracking_IngestT {
  return new ItemTracking_IngestT(
    this.id(),
...
unpackTo(_o: ItemTracking_IngestT): void {
  _o.id = this.id();
...
export class ItemTracking_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: ItemTracking_Ingest_dataMode_Enum = ItemTracking_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const keys = ItemTracking_Ingest.createKeysVector(builder, builder.createObjectOffsetList(this.keys));
  const values = ItemTracking_Ingest.createValuesVector(builder, builder.createObjectOffsetList(this.values));
  ...
  return ItemTracking_Ingest.createItemTracking_Ingest(builder,
    id,
