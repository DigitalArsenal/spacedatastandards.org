 ...
 */
export class EvacMedication_Abridged implements flatbuffers.IUnpackableObject<EvacMedication_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EvacMedication_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEvacMedication_Abridged(bb:flatbuffers.ByteBuffer, obj?:EvacMedication_Abridged):EvacMedication_Abridged {
  return (obj || new EvacMedication_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEvacMedication_Abridged(bb:flatbuffers.ByteBuffer, obj?:EvacMedication_Abridged):EvacMedication_Abridged {
...
static startEvacMedication_Abridged(builder:flatbuffers.Builder) {
...
static endEvacMedication_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEvacMedication_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC');
}

static finishSizePrefixedEvacMedication_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC', true);
}

static createEvacMedication_Abridged(builder:flatbuffers.Builder, typeOffset:flatbuffers.Offset, bodyPartOffset:flatbuffers.Offset, doseOffset:flatbuffers.Offset, adminRouteOffset:flatbuffers.Offset, timeOffset:flatbuffers.Offset, commentsOffset:flatbuffers.Offset):flatbuffers.Offset {
  EvacMedication_Abridged.startEvacMedication_Abridged(builder);
...
unpack(): EvacMedication_AbridgedT {
  return new EvacMedication_AbridgedT(
    this.type(),
    this.bodyPart(),
    this.dose(),
    this.adminRoute(),
...
unpackTo(_o: EvacMedication_AbridgedT): void {
  _o.type = this.type();
...
export class EvacMedication_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return EvacMedication_Abridged.createEvacMedication_Abridged(builder,
    type,
    bodyPart,
    dose,
    adminRoute,
