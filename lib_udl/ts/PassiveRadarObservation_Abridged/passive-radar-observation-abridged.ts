...
import { PassiveRadarObservation_Abridged_dataMode_Enum } from './passive-radar-observation-abridged-data-mode-enum.js';
 ...
 */
export class PassiveRadarObservation_Abridged implements flatbuffers.IUnpackableObject<PassiveRadarObservation_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):PassiveRadarObservation_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsPassiveRadarObservation_Abridged(bb:flatbuffers.ByteBuffer, obj?:PassiveRadarObservation_Abridged):PassiveRadarObservation_Abridged {
  return (obj || new PassiveRadarObservation_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsPassiveRadarObservation_Abridged(bb:flatbuffers.ByteBuffer, obj?:PassiveRadarObservation_Abridged):PassiveRadarObservation_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():PassiveRadarObservation_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 132);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : PassiveRadarObservation_Abridged_dataMode_Enum.REAL;
}
...
static startPassiveRadarObservation_Abridged(builder:flatbuffers.Builder) {
...
static addTransactionId(builder:flatbuffers.Builder, transactionIdOffset:flatbuffers.Offset) {
  builder.addFieldOffset(56, transactionIdOffset, 0);
}
...
static addCreatedAt(builder:flatbuffers.Builder, createdAtOffset:flatbuffers.Offset) {
  builder.addFieldOffset(58, createdAtOffset, 0);
}

static addCreatedBy(builder:flatbuffers.Builder, createdByOffset:flatbuffers.Offset) {
  builder.addFieldOffset(59, createdByOffset, 0);
}
...
static addOrigNetwork(builder:flatbuffers.Builder, origNetworkOffset:flatbuffers.Offset) {
  builder.addFieldOffset(62, origNetworkOffset, 0);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:PassiveRadarObservation_Abridged_dataMode_Enum) {
  builder.addFieldInt8(64, dataMode, PassiveRadarObservation_Abridged_dataMode_Enum.REAL);
}

static addType(builder:flatbuffers.Builder, typeOffset:flatbuffers.Offset) {
  builder.addFieldOffset(65, typeOffset, 0);
}

static endPassiveRadarObservation_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishPassiveRadarObservation_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'PASS');
}

static finishSizePrefixedPassiveRadarObservation_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'PASS', true);
}

static createPassiveRadarObservation_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, obTimeOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, satNo:number, origObjectIdOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, origSensorIdOffset:flatbuffers.Offset, idRfemitterOffset:flatbuffers.Offset, idSensorRefReceiverOffset:flatbuffers.Offset, extObservationIdOffset:flatbuffers.Offset, taskIdOffset:flatbuffers.Offset, trackIdOffset:flatbuffers.Offset, obPositionOffset:flatbuffers.Offset, uct:boolean, azimuth:number, azimuthUnc:number, azimuthBias:number, azimuthRate:number, elevation:number, elevationUnc:number, elevationBias:number, elevationRate:number, delay:number, delayUnc:number, delayBias:number, bistaticRange:number, bistaticRangeUnc:number, bistaticRangeBias:number, bistaticRangeRate:number, bistaticRangeRateUnc:number, bistaticRangeAccel:number, bistaticRangeAccelUnc:number, doppler:number, dopplerUnc:number, coning:number, coningUnc:number, tof:number, tofUnc:number, tofBias:number, accel:number, accelUnc:number, ra:number, declination:number, lat:number, lon:number, alt:number, xvel:number, yvel:number, zvel:number, rcs:number, rcsUnc:number, orthogonalRcs:number, orthogonalRcsUnc:number, snr:number, timingBias:number, transactionIdOffset:flatbuffers.Offset, descriptorOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, dataMode:PassiveRadarObservation_Abridged_dataMode_Enum, typeOffset:flatbuffers.Offset):flatbuffers.Offset {
  PassiveRadarObservation_Abridged.startPassiveRadarObservation_Abridged(builder);
...
unpack(): PassiveRadarObservation_AbridgedT {
  return new PassiveRadarObservation_AbridgedT(
    this.id(),
...
unpackTo(_o: PassiveRadarObservation_AbridgedT): void {
  _o.id = this.id();
...
export class PassiveRadarObservation_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: PassiveRadarObservation_Abridged_dataMode_Enum = PassiveRadarObservation_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return PassiveRadarObservation_Abridged.createPassiveRadarObservation_Abridged(builder,
    id,
