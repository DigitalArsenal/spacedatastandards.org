 ...
 */
export class LogisticsTransportationPlans_Full implements flatbuffers.IUnpackableObject<LogisticsTransportationPlans_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LogisticsTransportationPlans_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLogisticsTransportationPlans_Full(bb:flatbuffers.ByteBuffer, obj?:LogisticsTransportationPlans_Full):LogisticsTransportationPlans_Full {
  return (obj || new LogisticsTransportationPlans_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLogisticsTransportationPlans_Full(bb:flatbuffers.ByteBuffer, obj?:LogisticsTransportationPlans_Full):LogisticsTransportationPlans_Full {
...
static startLogisticsTransportationPlans_Full(builder:flatbuffers.Builder) {
...
unpack(): LogisticsTransportationPlans_FullT {
  return new LogisticsTransportationPlans_FullT(
    this.plansNumber(),
    this.missionChange(),
    this.planDefinition(),
    this.statusCode(),
...
unpackTo(_o: LogisticsTransportationPlans_FullT): void {
...
export class LogisticsTransportationPlans_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const logisticsSegments = LogisticsTransportationPlans_Full.createLogisticsSegmentsVector(builder, builder.createObjectOffsetList(this.logisticsSegments));
  const logisticsTransportationPlansRemarks = LogisticsTransportationPlans_Full.createLogisticsTransportationPlansRemarksVector(builder, builder.createObjectOffsetList(this.logisticsTransportationPlansRemarks));

  return LogisticsTransportationPlans_Full.createLogisticsTransportationPlans_Full(builder,
    plansNumber,
    this.missionChange,
    planDefinition,
    statusCode,
