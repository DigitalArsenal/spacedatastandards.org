 ...
 */
export class MtiJobDefinition_Ingest implements flatbuffers.IUnpackableObject<MtiJobDefinition_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MtiJobDefinition_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMtiJobDefinition_Ingest(bb:flatbuffers.ByteBuffer, obj?:MtiJobDefinition_Ingest):MtiJobDefinition_Ingest {
  return (obj || new MtiJobDefinition_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMtiJobDefinition_Ingest(bb:flatbuffers.ByteBuffer, obj?:MtiJobDefinition_Ingest):MtiJobDefinition_Ingest {
...
static startMtiJobDefinition_Ingest(builder:flatbuffers.Builder) {
...
static endMtiJobDefinition_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishMtiJobDefinition_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIJ');
}

static finishSizePrefixedMtiJobDefinition_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIJ', true);
}

static createMtiJobDefinition_Ingest(builder:flatbuffers.Builder, j1:bigint, j2Offset:flatbuffers.Offset, j3Offset:flatbuffers.Offset, j4:number, j5:number, j6:number, j7:number, j8:number, j9:number, j10:number, j11:number, j12:number, j13:number, j14Offset:flatbuffers.Offset, j15:number, j16:number, j17:number, j18:number, j19:number, j20:number, j21:number, j22:number, j23:number, j24:number, j25:number, j26:number, j27Offset:flatbuffers.Offset, j28Offset:flatbuffers.Offset):flatbuffers.Offset {
  MtiJobDefinition_Ingest.startMtiJobDefinition_Ingest(builder);
...
unpack(): MtiJobDefinition_IngestT {
  return new MtiJobDefinition_IngestT(
    this.j1(),
    this.j2(),
    this.j3(),
    this.j4(),
...
unpackTo(_o: MtiJobDefinition_IngestT): void {
  _o.j1 = this.j1();
  _o.j2 = this.j2();
  _o.j3 = this.j3();
  _o.j4 = this.j4();
...
export class MtiJobDefinition_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return MtiJobDefinition_Ingest.createMtiJobDefinition_Ingest(builder,
    this.j1,
    j2,
    j3,
    this.j4,
