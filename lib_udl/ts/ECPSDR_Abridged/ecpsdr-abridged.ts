...
import { ECPSDR_Abridged_dataMode_Enum } from './ecpsdr-abridged-data-mode-enum.js';
 ...
 */
export class ECPSDR_Abridged implements flatbuffers.IUnpackableObject<ECPSDR_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ECPSDR_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsECPSDR_Abridged(bb:flatbuffers.ByteBuffer, obj?:ECPSDR_Abridged):ECPSDR_Abridged {
  return (obj || new ECPSDR_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsECPSDR_Abridged(bb:flatbuffers.ByteBuffer, obj?:ECPSDR_Abridged):ECPSDR_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():ECPSDR_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 106);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : ECPSDR_Abridged_dataMode_Enum.REAL;
}

static startECPSDR_Abridged(builder:flatbuffers.Builder) {
...
unpack(): ECPSDR_AbridgedT {
  return new ECPSDR_AbridgedT(
    this.id(),
...
unpackTo(_o: ECPSDR_AbridgedT): void {
  _o.id = this.id();
...
export class ECPSDR_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: ECPSDR_Abridged_dataMode_Enum = ECPSDR_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const transientData = ECPSDR_Abridged.createTransientDataVector(builder, builder.createObjectOffsetList(this.transientData));
  ...
  return ECPSDR_Abridged.createECPSDR_Abridged(builder,
    id,
