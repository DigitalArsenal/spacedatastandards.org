 ...
 */
export class EvacVitalSignData_Ingest implements flatbuffers.IUnpackableObject<EvacVitalSignData_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EvacVitalSignData_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEvacVitalSignData_Ingest(bb:flatbuffers.ByteBuffer, obj?:EvacVitalSignData_Ingest):EvacVitalSignData_Ingest {
  return (obj || new EvacVitalSignData_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEvacVitalSignData_Ingest(bb:flatbuffers.ByteBuffer, obj?:EvacVitalSignData_Ingest):EvacVitalSignData_Ingest {
...
static startEvacVitalSignData_Ingest(builder:flatbuffers.Builder) {
...
static endEvacVitalSignData_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEvacVitalSignData_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC');
}

static finishSizePrefixedEvacVitalSignData_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC', true);
}

static createEvacVitalSignData_Ingest(builder:flatbuffers.Builder, vitalSignOffset:flatbuffers.Offset, vitalSign1:number, vitalSign2:number, medConfFactor:number, timeOffset:flatbuffers.Offset):flatbuffers.Offset {
  EvacVitalSignData_Ingest.startEvacVitalSignData_Ingest(builder);
...
unpack(): EvacVitalSignData_IngestT {
  return new EvacVitalSignData_IngestT(
    this.vitalSign(),
    this.vitalSign1(),
    this.vitalSign2(),
    this.medConfFactor(),
...
unpackTo(_o: EvacVitalSignData_IngestT): void {
...
export class EvacVitalSignData_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return EvacVitalSignData_Ingest.createEvacVitalSignData_Ingest(builder,
    vitalSign,
    this.vitalSign1,
    this.vitalSign2,
    this.medConfFactor,
