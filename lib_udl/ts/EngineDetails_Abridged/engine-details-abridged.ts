...
import { EngineDetails_Abridged_dataMode_Enum } from './engine-details-abridged-data-mode-enum.js';
 ...
 */
export class EngineDetails_Abridged implements flatbuffers.IUnpackableObject<EngineDetails_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EngineDetails_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEngineDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:EngineDetails_Abridged):EngineDetails_Abridged {
  return (obj || new EngineDetails_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEngineDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:EngineDetails_Abridged):EngineDetails_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():EngineDetails_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 48);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : EngineDetails_Abridged_dataMode_Enum.REAL;
}

static startEngineDetails_Abridged(builder:flatbuffers.Builder) {
...
unpack(): EngineDetails_AbridgedT {
  return new EngineDetails_AbridgedT(
    this.id(),
    this.idEngine(),
...
unpackTo(_o: EngineDetails_AbridgedT): void {
  _o.id = this.id();
...
export class EngineDetails_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: EngineDetails_Abridged_dataMode_Enum = EngineDetails_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return EngineDetails_Abridged.createEngineDetails_Abridged(builder,
    id,
    idEngine,
