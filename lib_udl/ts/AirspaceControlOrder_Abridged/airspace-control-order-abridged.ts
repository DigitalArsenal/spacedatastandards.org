...
import { AirspaceControlOrder_Abridged_dataMode_Enum } from './airspace-control-order-abridged-data-mode-enum.js';
 ...
 */
export class AirspaceControlOrder_Abridged implements flatbuffers.IUnpackableObject<AirspaceControlOrder_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirspaceControlOrder_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirspaceControlOrder_Abridged(bb:flatbuffers.ByteBuffer, obj?:AirspaceControlOrder_Abridged):AirspaceControlOrder_Abridged {
  return (obj || new AirspaceControlOrder_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirspaceControlOrder_Abridged(bb:flatbuffers.ByteBuffer, obj?:AirspaceControlOrder_Abridged):AirspaceControlOrder_Abridged {
 ...
 */
dataMode():AirspaceControlOrder_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 68);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirspaceControlOrder_Abridged_dataMode_Enum.REAL;
}

static startAirspaceControlOrder_Abridged(builder:flatbuffers.Builder) {
...
unpack(): AirspaceControlOrder_AbridgedT {
  return new AirspaceControlOrder_AbridgedT(
    this.id(),
...
unpackTo(_o: AirspaceControlOrder_AbridgedT): void {
  _o.id = this.id();
...
export class AirspaceControlOrder_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AirspaceControlOrder_Abridged_dataMode_Enum = AirspaceControlOrder_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const airspaceControlOrderReferences = AirspaceControlOrder_Abridged.createAirspaceControlOrderReferencesVector(builder, builder.createObjectOffsetList(this.airspaceControlOrderReferences));
  const airspaceControlMeansStatus = AirspaceControlOrder_Abridged.createAirspaceControlMeansStatusVector(builder, builder.createObjectOffsetList(this.airspaceControlMeansStatus));
  const undLnkTrk = AirspaceControlOrder_Abridged.createUndLnkTrkVector(builder, builder.createObjectOffsetList(this.undLnkTrk));
  const classSource = (this.classSource !== null ? builder.createString(this.classSource!) : 0);
  const classReason = AirspaceControlOrder_Abridged.createClassReasonVector(builder, builder.createObjectOffsetList(this.classReason));
  const downgradeInsDate = AirspaceControlOrder_Abridged.createDowngradeInsDateVector(builder, builder.createObjectOffsetList(this.downgradeInsDate));
  const declassExemptionCode = AirspaceControlOrder_Abridged.createDeclassExemptionCodeVector(builder, builder.createObjectOffsetList(this.declassExemptionCode));
  ...
  return AirspaceControlOrder_Abridged.createAirspaceControlOrder_Abridged(builder,
    id,
