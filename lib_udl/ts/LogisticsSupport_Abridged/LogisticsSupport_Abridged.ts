...
import { LogisticsSupport_Abridged_dataMode_Enum } from './LogisticsSupport_Abridged_dataMode_Enum.js';
 ...
 */
export class LogisticsSupport_Abridged implements flatbuffers.IUnpackableObject<LogisticsSupport_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LogisticsSupport_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLogisticsSupport_Abridged(bb:flatbuffers.ByteBuffer, obj?:LogisticsSupport_Abridged):LogisticsSupport_Abridged {
  return (obj || new LogisticsSupport_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLogisticsSupport_Abridged(bb:flatbuffers.ByteBuffer, obj?:LogisticsSupport_Abridged):LogisticsSupport_Abridged {
 ...
 */
dataMode():LogisticsSupport_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 62);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : LogisticsSupport_Abridged_dataMode_Enum.REAL;
}

static startLogisticsSupport_Abridged(builder:flatbuffers.Builder) {
...
unpack(): LogisticsSupport_AbridgedT {
  return new LogisticsSupport_AbridgedT(
    this.id(),
    ...
    this.bb!.createScalarList<string>(this.logisticsDiscrepancyInfos.bind(this), this.logisticsDiscrepancyInfosLength()),
    this.bb!.createScalarList<string>(this.logisticsTransportationPlans.bind(this), this.logisticsTransportationPlansLength()),
    this.bb!.createScalarList<string>(this.logisticsSupportItems.bind(this), this.logisticsSupportItemsLength()),
    this.origNetwork(),
    this.createdAt(),
    this.createdBy(),
    this.updatedAt(),
...
unpackTo(_o: LogisticsSupport_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.logisticsDiscrepancyInfos = this.bb!.createScalarList<string>(this.logisticsDiscrepancyInfos.bind(this), this.logisticsDiscrepancyInfosLength());
  _o.logisticsTransportationPlans = this.bb!.createScalarList<string>(this.logisticsTransportationPlans.bind(this), this.logisticsTransportationPlansLength());
  _o.logisticsSupportItems = this.bb!.createScalarList<string>(this.logisticsSupportItems.bind(this), this.logisticsSupportItemsLength());
...
export class LogisticsSupport_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: LogisticsSupport_Abridged_dataMode_Enum = LogisticsSupport_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const logisticsRemarks = LogisticsSupport_Abridged.createLogisticsRemarksVector(builder, builder.createObjectOffsetList(this.logisticsRemarks));
  const logisticsDiscrepancyInfos = LogisticsSupport_Abridged.createLogisticsDiscrepancyInfosVector(builder, builder.createObjectOffsetList(this.logisticsDiscrepancyInfos));
  const logisticsTransportationPlans = LogisticsSupport_Abridged.createLogisticsTransportationPlansVector(builder, builder.createObjectOffsetList(this.logisticsTransportationPlans));
  const logisticsSupportItems = LogisticsSupport_Abridged.createLogisticsSupportItemsVector(builder, builder.createObjectOffsetList(this.logisticsSupportItems));
  ...
  return LogisticsSupport_Abridged.createLogisticsSupport_Abridged(builder,
    id,
