 ...
 */
export class AirspaceControlOrderReference_Ingest implements flatbuffers.IUnpackableObject<AirspaceControlOrderReference_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirspaceControlOrderReference_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirspaceControlOrderReference_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirspaceControlOrderReference_Ingest):AirspaceControlOrderReference_Ingest {
  return (obj || new AirspaceControlOrderReference_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirspaceControlOrderReference_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirspaceControlOrderReference_Ingest):AirspaceControlOrderReference_Ingest {
...
static startAirspaceControlOrderReference_Ingest(builder:flatbuffers.Builder) {
...
static endAirspaceControlOrderReference_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirspaceControlOrderReference_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRS');
}

static finishSizePrefixedAirspaceControlOrderReference_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRS', true);
}

static createAirspaceControlOrderReference_Ingest(builder:flatbuffers.Builder, refSidOffset:flatbuffers.Offset, refTypeOffset:flatbuffers.Offset, refOriginatorOffset:flatbuffers.Offset, refTsOffset:flatbuffers.Offset, refSerialNumOffset:flatbuffers.Offset, refSpecialNotationOffset:flatbuffers.Offset, refSicsOffset:flatbuffers.Offset):flatbuffers.Offset {
  AirspaceControlOrderReference_Ingest.startAirspaceControlOrderReference_Ingest(builder);
...
unpack(): AirspaceControlOrderReference_IngestT {
  return new AirspaceControlOrderReference_IngestT(
    this.refSid(),
    this.refType(),
    this.refOriginator(),
    this.refTs(),
...
unpackTo(_o: AirspaceControlOrderReference_IngestT): void {
...
export class AirspaceControlOrderReference_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const refSics = AirspaceControlOrderReference_Ingest.createRefSicsVector(builder, builder.createObjectOffsetList(this.refSics));

  return AirspaceControlOrderReference_Ingest.createAirspaceControlOrderReference_Ingest(builder,
    refSid,
    refType,
    refOriginator,
    refTs,
