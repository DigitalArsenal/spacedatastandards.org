...
import { GEOStatus_Abridged_dataMode_Enum } from './geostatus-abridged-data-mode-enum.js';


/**
 * /// Information for the specified on-orbit GEO spacecraft, including status, expected longitude limits, and drift rates.
 */
export class GEOStatus_Abridged implements flatbuffers.IUnpackableObject<GEOStatus_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):GEOStatus_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsGEOStatus_Abridged(bb:flatbuffers.ByteBuffer, obj?:GEOStatus_Abridged):GEOStatus_Abridged {
  return (obj || new GEOStatus_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsGEOStatus_Abridged(bb:flatbuffers.ByteBuffer, obj?:GEOStatus_Abridged):GEOStatus_Abridged {
 ...
 */
dataMode():GEOStatus_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 46);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : GEOStatus_Abridged_dataMode_Enum.REAL;
}
...
static startGEOStatus_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:GEOStatus_Abridged_dataMode_Enum) {
  builder.addFieldInt8(21, dataMode, GEOStatus_Abridged_dataMode_Enum.REAL);
}
...
static endGEOStatus_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishGEOStatus_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'GEOS');
}

static finishSizePrefixedGEOStatus_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'GEOS', true);
}

static createGEOStatus_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, origObjectIdOffset:flatbuffers.Offset, ss:number, sc:number, relativeEnergy:number, longitudeRate:number, longitudeMin:number, longitudeMax:number, confidenceLevelOffset:flatbuffers.Offset, planeChangeStatusOffset:flatbuffers.Offset, troughTypeOffset:flatbuffers.Offset, lostFlag:boolean, semiAnnualCorrFlag:boolean, objectStatusOffset:flatbuffers.Offset, rawFileUriOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:GEOStatus_Abridged_dataMode_Enum, satNo:number, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  GEOStatus_Abridged.startGEOStatus_Abridged(builder);
...
unpack(): GEOStatus_AbridgedT {
  return new GEOStatus_AbridgedT(
    this.id(),
...
unpackTo(_o: GEOStatus_AbridgedT): void {
  _o.id = this.id();
...
export class GEOStatus_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: GEOStatus_Abridged_dataMode_Enum = GEOStatus_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return GEOStatus_Abridged.createGEOStatus_Abridged(builder,
    id,
