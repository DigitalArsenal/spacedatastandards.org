 ...
 */
export class EvacEtiology_Abridged implements flatbuffers.IUnpackableObject<EvacEtiology_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EvacEtiology_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEvacEtiology_Abridged(bb:flatbuffers.ByteBuffer, obj?:EvacEtiology_Abridged):EvacEtiology_Abridged {
  return (obj || new EvacEtiology_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEvacEtiology_Abridged(bb:flatbuffers.ByteBuffer, obj?:EvacEtiology_Abridged):EvacEtiology_Abridged {
...
static startEvacEtiology_Abridged(builder:flatbuffers.Builder) {
...
static endEvacEtiology_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEvacEtiology_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC');
}

static finishSizePrefixedEvacEtiology_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC', true);
}

static createEvacEtiology_Abridged(builder:flatbuffers.Builder, typeOffset:flatbuffers.Offset, bodyPartOffset:flatbuffers.Offset, timeOffset:flatbuffers.Offset, commentsOffset:flatbuffers.Offset):flatbuffers.Offset {
  EvacEtiology_Abridged.startEvacEtiology_Abridged(builder);
...
unpack(): EvacEtiology_AbridgedT {
  return new EvacEtiology_AbridgedT(
    this.type(),
    this.bodyPart(),
    this.time(),
    this.comments()
...
unpackTo(_o: EvacEtiology_AbridgedT): void {
  _o.type = this.type();
...
export class EvacEtiology_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return EvacEtiology_Abridged.createEvacEtiology_Abridged(builder,
    type,
    bodyPart,
    time,
    comments
