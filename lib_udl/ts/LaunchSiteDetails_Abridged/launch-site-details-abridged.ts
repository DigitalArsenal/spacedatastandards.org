...
import { LaunchSiteDetails_Abridged_dataMode_Enum } from './launch-site-details-abridged-data-mode-enum.js';
 ...
 */
export class LaunchSiteDetails_Abridged implements flatbuffers.IUnpackableObject<LaunchSiteDetails_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LaunchSiteDetails_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLaunchSiteDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:LaunchSiteDetails_Abridged):LaunchSiteDetails_Abridged {
  return (obj || new LaunchSiteDetails_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLaunchSiteDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:LaunchSiteDetails_Abridged):LaunchSiteDetails_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():LaunchSiteDetails_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 28);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : LaunchSiteDetails_Abridged_dataMode_Enum.REAL;
}
...
static startLaunchSiteDetails_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:LaunchSiteDetails_Abridged_dataMode_Enum) {
  builder.addFieldInt8(12, dataMode, LaunchSiteDetails_Abridged_dataMode_Enum.REAL);
}
...
static endLaunchSiteDetails_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishLaunchSiteDetails_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'LAUN');
}

static finishSizePrefixedLaunchSiteDetails_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'LAUN', true);
}

static createLaunchSiteDetails_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idLaunchSiteOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idLocationOffset:flatbuffers.Offset, launchGroupOffset:flatbuffers.Offset, availableInclinationsOffset:flatbuffers.Offset, descriptionOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:LaunchSiteDetails_Abridged_dataMode_Enum, locationOffset:flatbuffers.Offset):flatbuffers.Offset {
  LaunchSiteDetails_Abridged.startLaunchSiteDetails_Abridged(builder);
...
unpack(): LaunchSiteDetails_AbridgedT {
  return new LaunchSiteDetails_AbridgedT(
    this.id(),
    this.idLaunchSite(),
    this.classificationMarking(),
    this.idLocation(),
    this.launchGroup(),
    this.bb!.createScalarList<string>(this.availableInclinations.bind(this), this.availableInclinations_Length()),
    this.description(),
    this.createdAt(),
    this.createdBy(),
    this.source(),
...
unpackTo(_o: LaunchSiteDetails_AbridgedT): void {
  _o.id = this.id();
  _o.idLaunchSite = this.idLaunchSite();
  _o.classificationMarking = this.classificationMarking();
  _o.idLocation = this.idLocation();
  _o.launchGroup = this.launchGroup();
  _o.availableInclinations = this.bb!.createScalarList<string>(this.availableInclinations.bind(this), this.availableInclinations_Length());
...
export class LaunchSiteDetails_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: LaunchSiteDetails_Abridged_dataMode_Enum = LaunchSiteDetails_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const availableInclinations = LaunchSiteDetails_Abridged.createAvailableInclinationsVector(builder, builder.createObjectOffsetList(this.availableInclinations));
  ...
  return LaunchSiteDetails_Abridged.createLaunchSiteDetails_Abridged(builder,
    id,
    idLaunchSite,
