 ...
 */
export class MtiDwell_Ingest implements flatbuffers.IUnpackableObject<MtiDwell_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MtiDwell_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMtiDwell_Ingest(bb:flatbuffers.ByteBuffer, obj?:MtiDwell_Ingest):MtiDwell_Ingest {
  return (obj || new MtiDwell_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMtiDwell_Ingest(bb:flatbuffers.ByteBuffer, obj?:MtiDwell_Ingest):MtiDwell_Ingest {
...
static startMtiDwell_Ingest(builder:flatbuffers.Builder) {
...
unpack(): MtiDwell_IngestT {
  return new MtiDwell_IngestT(
    this.d2(),
    this.d3(),
    this.d4(),
    this.d5(),
...
unpackTo(_o: MtiDwell_IngestT): void {
  _o.d2 = this.d2();
  _o.d3 = this.d3();
  _o.d4 = this.d4();
  _o.d5 = this.d5();
...
export class MtiDwell_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  public d2: number = 0,
  public d3: number = 0,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  const d32 = MtiDwell_Ingest.createD32Vector(builder, builder.createObjectOffsetList(this.d32));
  const dwellts = (this.dwellts !== null ? builder.createString(this.dwellts!) : 0);

  return MtiDwell_Ingest.createMtiDwell_Ingest(builder,
    this.d2,
    this.d3,
    this.d4,
    this.d5,
