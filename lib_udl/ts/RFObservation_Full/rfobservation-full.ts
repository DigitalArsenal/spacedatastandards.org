...
import { RFObservation_Full_dataMode_Enum } from './rfobservation-full-data-mode-enum.js';
import { RFObservation_Full_polarityType_Enum } from './rfobservation-full-polarity-type-enum.js';
 ...
 */
export class RFObservation_Full implements flatbuffers.IUnpackableObject<RFObservation_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):RFObservation_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsRFObservation_Full(bb:flatbuffers.ByteBuffer, obj?:RFObservation_Full):RFObservation_Full {
  return (obj || new RFObservation_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRFObservation_Full(bb:flatbuffers.ByteBuffer, obj?:RFObservation_Full):RFObservation_Full {
 ...
 */
polarityType():RFObservation_Full_polarityType_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 94);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFObservation_Full_polarityType_Enum.H;
}
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():RFObservation_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 134);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFObservation_Full_dataMode_Enum.REAL;
}
...
static startRFObservation_Full(builder:flatbuffers.Builder) {
...
static addPolarityType(builder:flatbuffers.Builder, polarityType:RFObservation_Full_polarityType_Enum) {
  builder.addFieldInt8(45, polarityType, RFObservation_Full_polarityType_Enum.H);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:RFObservation_Full_dataMode_Enum) {
  builder.addFieldInt8(65, dataMode, RFObservation_Full_dataMode_Enum.REAL);
}
...
unpack(): RFObservation_FullT {
  return new RFObservation_FullT(
    this.id(),
...
unpackTo(_o: RFObservation_FullT): void {
  _o.id = this.id();
...
export class RFObservation_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public polarityType: RFObservation_Full_polarityType_Enum = RFObservation_Full_polarityType_Enum.H,
  ...
  public dataMode: RFObservation_Full_dataMode_Enum = RFObservation_Full_dataMode_Enum.REAL,
  public tags: (string)[] = [],
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = RFObservation_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return RFObservation_Full.createRFObservation_Full(builder,
    id,
