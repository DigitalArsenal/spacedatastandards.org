...
import { Location_Full_dataMode_Enum } from './location-full-data-mode-enum.js';
 ...
 */
export class Location_Full implements flatbuffers.IUnpackableObject<Location_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Location_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLocation_Full(bb:flatbuffers.ByteBuffer, obj?:Location_Full):Location_Full {
  return (obj || new Location_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLocation_Full(bb:flatbuffers.ByteBuffer, obj?:Location_Full):Location_Full {
 ...
 */
dataMode():Location_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 30);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Location_Full_dataMode_Enum.REAL;
}
...
static startLocation_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Location_Full_dataMode_Enum) {
  builder.addFieldInt8(13, dataMode, Location_Full_dataMode_Enum.REAL);
}
...
static endLocation_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishLocation_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'LOCA');
}

static finishSizePrefixedLocation_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'LOCA', true);
}

static createLocation_Full(builder:flatbuffers.Builder, idLocationOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, countryCodeOffset:flatbuffers.Offset, lat:number, lon:number, altitude:number, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:Location_Full_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  Location_Full.startLocation_Full(builder);
...
unpack(): Location_FullT {
  return new Location_FullT(
    this.idLocation(),
...
unpackTo(_o: Location_FullT): void {
...
export class Location_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Location_Full_dataMode_Enum = Location_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Location_Full.createLocation_Full(builder,
    idLocation,
