...
import { Organization_dataMode_Enum } from './Organization_dataMode_Enum.js';
 ...
 */
dataMode():Organization_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 28);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Organization_dataMode_Enum.REAL;
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Organization_dataMode_Enum) {
  builder.addFieldInt8(12, dataMode, Organization_dataMode_Enum.REAL);
}
...
static finishOrganizationBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ORGA');
}

static finishSizePrefixedOrganizationBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ORGA', true);
}

static createOrganization(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, categoryOffset:flatbuffers.Offset, externalIdOffset:flatbuffers.Offset, descriptionOffset:flatbuffers.Offset, countryCodeOffset:flatbuffers.Offset, nationalityOffset:flatbuffers.Offset, active:boolean, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:Organization_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, organizationDetailsOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
...
unpack(): OrganizationT {
  return new OrganizationT(
    ...
    this.updatedAt(),
    this.updatedBy(),
    this.bb!.createScalarList<string>(this.organizationDetails.bind(this), this.organizationDetailsLength()),
    this.origNetwork()
  );
}
...
unpackTo(_o: OrganizationT): void {
  ...
  _o.organizationDetails = this.bb!.createScalarList<string>(this.organizationDetails.bind(this), this.organizationDetailsLength());
...
constructor(
  ...
  public dataMode: Organization_dataMode_Enum = Organization_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const organizationDetails = Organization.createOrganizationDetailsVector(builder, builder.createObjectOffsetList(this.organizationDetails));
