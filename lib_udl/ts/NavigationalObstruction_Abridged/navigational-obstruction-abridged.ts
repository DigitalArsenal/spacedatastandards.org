...
import { NavigationalObstruction_Abridged_dataMode_Enum } from './navigational-obstruction-abridged-data-mode-enum.js';
 ...
 */
export class NavigationalObstruction_Abridged implements flatbuffers.IUnpackableObject<NavigationalObstruction_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):NavigationalObstruction_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsNavigationalObstruction_Abridged(bb:flatbuffers.ByteBuffer, obj?:NavigationalObstruction_Abridged):NavigationalObstruction_Abridged {
  return (obj || new NavigationalObstruction_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsNavigationalObstruction_Abridged(bb:flatbuffers.ByteBuffer, obj?:NavigationalObstruction_Abridged):NavigationalObstruction_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():NavigationalObstruction_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 156);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : NavigationalObstruction_Abridged_dataMode_Enum.REAL;
}

static startNavigationalObstruction_Abridged(builder:flatbuffers.Builder) {
...
unpack(): NavigationalObstruction_AbridgedT {
  return new NavigationalObstruction_AbridgedT(
    this.id(),
...
unpackTo(_o: NavigationalObstruction_AbridgedT): void {
  _o.id = this.id();
...
export class NavigationalObstruction_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: NavigationalObstruction_Abridged_dataMode_Enum = NavigationalObstruction_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const keys = NavigationalObstruction_Abridged.createKeysVector(builder, builder.createObjectOffsetList(this.keys));
  const values = NavigationalObstruction_Abridged.createValuesVector(builder, builder.createObjectOffsetList(this.values));
  ...
  return NavigationalObstruction_Abridged.createNavigationalObstruction_Abridged(builder,
    id,
