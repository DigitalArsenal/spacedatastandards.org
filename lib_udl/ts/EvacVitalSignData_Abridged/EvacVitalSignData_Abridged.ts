...
static finishEvacVitalSignData_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC');
}

static finishSizePrefixedEvacVitalSignData_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
