...
import { POI_Ingest_dataMode_Enum } from './POI_Ingest_dataMode_Enum.js';
 ...
 */
export class POI_Ingest implements flatbuffers.IUnpackableObject<POI_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):POI_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsPOI_Ingest(bb:flatbuffers.ByteBuffer, obj?:POI_Ingest):POI_Ingest {
  return (obj || new POI_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsPOI_Ingest(bb:flatbuffers.ByteBuffer, obj?:POI_Ingest):POI_Ingest {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new POI_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static bufferHasIdentifier(bb:flatbuffers.ByteBuffer):boolean {
  return bb.__has_identifier('POII');
}
 ...
 */
dataMode():POI_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 86);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : POI_Ingest_dataMode_Enum.REAL;
}
...
static startPOI_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:POI_Ingest_dataMode_Enum) {
  builder.addFieldInt8(41, dataMode, POI_Ingest_dataMode_Enum.REAL);
}
...
export class POI_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: POI_Ingest_dataMode_Enum = POI_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const idWeatherReport = POI_Ingest.createIdWeatherReportVector(builder, builder.createObjectOffsetList(this.idWeatherReport));
  ...
  const elle = POI_Ingest.createElleVector(builder, builder.createObjectOffsetList(this.elle));
  const cntct = (this.cntct !== null ? builder.createString(this.cntct!) : 0);
  const urls = POI_Ingest.createUrlsVector(builder, builder.createObjectOffsetList(this.urls));
  ...
  const groups = POI_Ingest.createGroupsVector(builder, builder.createObjectOffsetList(this.groups));
  const asset = (this.asset !== null ? builder.createString(this.asset!) : 0);
  const tags = POI_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  const srcTyps = POI_Ingest.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = POI_Ingest.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  ...
  return POI_Ingest.createPOI_Ingest(builder,
    id,
