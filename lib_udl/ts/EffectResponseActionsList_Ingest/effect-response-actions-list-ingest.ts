 ...
 */
export class EffectResponseActionsList_Ingest implements flatbuffers.IUnpackableObject<EffectResponseActionsList_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EffectResponseActionsList_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEffectResponseActionsList_Ingest(bb:flatbuffers.ByteBuffer, obj?:EffectResponseActionsList_Ingest):EffectResponseActionsList_Ingest {
  return (obj || new EffectResponseActionsList_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEffectResponseActionsList_Ingest(bb:flatbuffers.ByteBuffer, obj?:EffectResponseActionsList_Ingest):EffectResponseActionsList_Ingest {
...
static startEffectResponseActionsList_Ingest(builder:flatbuffers.Builder) {
...
unpack(): EffectResponseActionsList_IngestT {
  return new EffectResponseActionsList_IngestT(
    this.summary(),
    this.actionId(),
...
unpackTo(_o: EffectResponseActionsList_IngestT): void {
...
export class EffectResponseActionsList_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const actionMetrics = EffectResponseActionsList_Ingest.createActionMetricsVector(builder, builder.createObjectOffsetList(this.actionMetrics));

  return EffectResponseActionsList_Ingest.createEffectResponseActionsList_Ingest(builder,
    summary,
    actionId,
    actionStartTime,
    actionEndTime,
