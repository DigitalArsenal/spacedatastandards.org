...
import { AirLoadPlan_Full_dataMode_Enum } from './air-load-plan-full-data-mode-enum.js';


/**
 * /// Information related to how an aircraft is loaded with cargo, equipment, and passengers.
 */
export class AirLoadPlan_Full implements flatbuffers.IUnpackableObject<AirLoadPlan_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirLoadPlan_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirLoadPlan_Full(bb:flatbuffers.ByteBuffer, obj?:AirLoadPlan_Full):AirLoadPlan_Full {
  return (obj || new AirLoadPlan_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirLoadPlan_Full(bb:flatbuffers.ByteBuffer, obj?:AirLoadPlan_Full):AirLoadPlan_Full {
 ...
 */
dataMode():AirLoadPlan_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 104);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirLoadPlan_Full_dataMode_Enum.REAL;
}

static startAirLoadPlan_Full(builder:flatbuffers.Builder) {
...
static addUpdatedAt(builder:flatbuffers.Builder, updatedAtOffset:flatbuffers.Offset) {
  builder.addFieldOffset(44, updatedAtOffset, 0);
}

static addUpdatedBy(builder:flatbuffers.Builder, updatedByOffset:flatbuffers.Offset) {
  builder.addFieldOffset(45, updatedByOffset, 0);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AirLoadPlan_Full_dataMode_Enum) {
  builder.addFieldInt8(50, dataMode, AirLoadPlan_Full_dataMode_Enum.REAL);
}

static endAirLoadPlan_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirLoadPlan_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRL');
}

static finishSizePrefixedAirLoadPlan_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRL', true);
}

static createAirLoadPlan_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, externalIdOffset:flatbuffers.Offset, idMissionOffset:flatbuffers.Offset, missionNumberOffset:flatbuffers.Offset, idSortieOffset:flatbuffers.Offset, legNum:number, callSignOffset:flatbuffers.Offset, tailNumberOffset:flatbuffers.Offset, aircraftMdsOffset:flatbuffers.Offset, depIcaoOffset:flatbuffers.Offset, depAirfieldOffset:flatbuffers.Offset, estDepTimeOffset:flatbuffers.Offset, arrIcaoOffset:flatbuffers.Offset, arrAirfieldOffset:flatbuffers.Offset, estArrTimeOffset:flatbuffers.Offset, crewSize:number, cargoConfigOffset:flatbuffers.Offset, equipConfigOffset:flatbuffers.Offset, tankConfigOffset:flatbuffers.Offset, basicWeight:number, basicMoment:number, fuelWeight:number, fuelMoment:number, estLandingFuelWeight:number, estLandingFuelMoment:number, operatingWeight:number, operatingMoment:number, cargoWeight:number, cargoMoment:number, zeroFuelWeight:number, zeroFuelMoment:number, zeroFuelCg:number, grossWeight:number, grossMoment:number, grossCg:number, landingWeight:number, landingMoment:number, landingCg:number, cargoBayFsmin:number, cargoBayFsmax:number, cargoBayWidth:number, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:AirLoadPlan_Full_dataMode_Enum):flatbuffers.Offset {
  AirLoadPlan_Full.startAirLoadPlan_Full(builder);
...
unpack(): AirLoadPlan_FullT {
  return new AirLoadPlan_FullT(
    this.id(),
...
unpackTo(_o: AirLoadPlan_FullT): void {
  _o.id = this.id();
...
export class AirLoadPlan_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AirLoadPlan_Full_dataMode_Enum = AirLoadPlan_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AirLoadPlan_Full.createAirLoadPlan_Full(builder,
    id,
