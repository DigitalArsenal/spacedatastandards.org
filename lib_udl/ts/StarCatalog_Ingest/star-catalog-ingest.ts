...
import { StarCatalog_Ingest_astrometryOrigin_Enum } from './star-catalog-ingest-astrometry-origin-enum.js';
import { StarCatalog_Ingest_dataMode_Enum } from './star-catalog-ingest-data-mode-enum.js';


/**
 * /// The star catalog provides the position, proper motion, parallax, and photometric magnitudes at various bandpasses of a star.
 */
export class StarCatalog_Ingest implements flatbuffers.IUnpackableObject<StarCatalog_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):StarCatalog_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsStarCatalog_Ingest(bb:flatbuffers.ByteBuffer, obj?:StarCatalog_Ingest):StarCatalog_Ingest {
  return (obj || new StarCatalog_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsStarCatalog_Ingest(bb:flatbuffers.ByteBuffer, obj?:StarCatalog_Ingest):StarCatalog_Ingest {
 ...
 */
astrometryOrigin():StarCatalog_Ingest_astrometryOrigin_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 42);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : StarCatalog_Ingest_astrometryOrigin_Enum.GAIADR3;
}
 ...
 */
dataMode():StarCatalog_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 98);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : StarCatalog_Ingest_dataMode_Enum.REAL;
}

static startStarCatalog_Ingest(builder:flatbuffers.Builder) {
...
static addAstrometryOrigin(builder:flatbuffers.Builder, astrometryOrigin:StarCatalog_Ingest_astrometryOrigin_Enum) {
  builder.addFieldInt8(19, astrometryOrigin, StarCatalog_Ingest_astrometryOrigin_Enum.GAIADR3);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:StarCatalog_Ingest_dataMode_Enum) {
  builder.addFieldInt8(47, dataMode, StarCatalog_Ingest_dataMode_Enum.REAL);
}

static endStarCatalog_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishStarCatalog_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'STAR');
}

static finishSizePrefixedStarCatalog_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'STAR', true);
}

static createStarCatalog_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, csId:bigint, gncCatId:number, gaiadr3CatId:bigint, hipCatId:number, catVersionOffset:flatbuffers.Offset, ra:number, raUnc:number, dec:number, decUnc:number, posUncFlag:boolean, parallax:number, parallaxUnc:number, pmra:number, pmraUnc:number, pmdec:number, pmdecUnc:number, pmUncFlag:boolean, astrometryOrigin:StarCatalog_Ingest_astrometryOrigin_Enum, starEpoch:number, gmag:number, gmagUnc:number, bpmag:number, bpmagUnc:number, rpmag:number, rpmagUnc:number, jmag:number, jmagUnc:number, kmag:number, kmagUnc:number, hmag:number, hmagUnc:number, varFlag:boolean, multFlag:boolean, neighborId:number, neighborFlag:boolean, neighborDistance:number, shiftFlag:boolean, shift:number, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:StarCatalog_Ingest_dataMode_Enum):flatbuffers.Offset {
  StarCatalog_Ingest.startStarCatalog_Ingest(builder);
...
unpack(): StarCatalog_IngestT {
  return new StarCatalog_IngestT(
    this.id(),
...
unpackTo(_o: StarCatalog_IngestT): void {
  _o.id = this.id();
...
export class StarCatalog_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public astrometryOrigin: StarCatalog_Ingest_astrometryOrigin_Enum = StarCatalog_Ingest_astrometryOrigin_Enum.GAIADR3,
  ...
  public dataMode: StarCatalog_Ingest_dataMode_Enum = StarCatalog_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return StarCatalog_Ingest.createStarCatalog_Ingest(builder,
    id,
