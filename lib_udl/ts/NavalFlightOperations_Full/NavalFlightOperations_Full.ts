 ...
 */
export class NavalFlightOperations_Full implements flatbuffers.IUnpackableObject<NavalFlightOperations_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):NavalFlightOperations_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsNavalFlightOperations_Full(bb:flatbuffers.ByteBuffer, obj?:NavalFlightOperations_Full):NavalFlightOperations_Full {
  return (obj || new NavalFlightOperations_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsNavalFlightOperations_Full(bb:flatbuffers.ByteBuffer, obj?:NavalFlightOperations_Full):NavalFlightOperations_Full {
...
static startNavalFlightOperations_Full(builder:flatbuffers.Builder) {
...
static endNavalFlightOperations_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishNavalFlightOperations_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'NAVA');
}

static finishSizePrefixedNavalFlightOperations_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'NAVA', true);
}

static createNavalFlightOperations_Full(builder:flatbuffers.Builder, shipNameOffset:flatbuffers.Offset, fltOpStartOffset:flatbuffers.Offset, fltOpStopOffset:flatbuffers.Offset, schdLaunchRcvyTimeOffset:flatbuffers.Offset):flatbuffers.Offset {
  NavalFlightOperations_Full.startNavalFlightOperations_Full(builder);
...
unpack(): NavalFlightOperations_FullT {
  return new NavalFlightOperations_FullT(
    this.shipName(),
    this.fltOpStart(),
    this.fltOpStop(),
    this.bb!.createScalarList<string>(this.schdLaunchRcvyTime.bind(this), this.schdLaunchRcvyTimeLength())
  );
}


unpackTo(_o: NavalFlightOperations_FullT): void {
  _o.shipName = this.shipName();
  _o.fltOpStart = this.fltOpStart();
  _o.fltOpStop = this.fltOpStop();
  _o.schdLaunchRcvyTime = this.bb!.createScalarList<string>(this.schdLaunchRcvyTime.bind(this), this.schdLaunchRcvyTimeLength());
}
}

export class NavalFlightOperations_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const schdLaunchRcvyTime = NavalFlightOperations_Full.createSchdLaunchRcvyTimeVector(builder, builder.createObjectOffsetList(this.schdLaunchRcvyTime));

  return NavalFlightOperations_Full.createNavalFlightOperations_Full(builder,
    shipName,
    fltOpStart,
    fltOpStop,
    schdLaunchRcvyTime
