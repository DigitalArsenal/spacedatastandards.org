 ...
 */
export class FlightPlanWaypoints_Abridged implements flatbuffers.IUnpackableObject<FlightPlanWaypoints_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):FlightPlanWaypoints_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsFlightPlanWaypoints_Abridged(bb:flatbuffers.ByteBuffer, obj?:FlightPlanWaypoints_Abridged):FlightPlanWaypoints_Abridged {
  return (obj || new FlightPlanWaypoints_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsFlightPlanWaypoints_Abridged(bb:flatbuffers.ByteBuffer, obj?:FlightPlanWaypoints_Abridged):FlightPlanWaypoints_Abridged {
...
static startFlightPlanWaypoints_Abridged(builder:flatbuffers.Builder) {
...
unpack(): FlightPlanWaypoints_AbridgedT {
  return new FlightPlanWaypoints_AbridgedT(
    this.type(),
    this.waypointName(),
    this.waypointNum(),
    this.airway(),
...
unpackTo(_o: FlightPlanWaypoints_AbridgedT): void {
  _o.type = this.type();
...
export class FlightPlanWaypoints_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return FlightPlanWaypoints_Abridged.createFlightPlanWaypoints_Abridged(builder,
    type,
    waypointName,
    this.waypointNum,
    airway,
