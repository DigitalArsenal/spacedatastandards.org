...
import { ECPSDR_Ingest_dataMode_Enum } from './ecpsdr-ingest-data-mode-enum.js';
 ...
 */
export class ECPSDR_Ingest implements flatbuffers.IUnpackableObject<ECPSDR_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ECPSDR_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsECPSDR_Ingest(bb:flatbuffers.ByteBuffer, obj?:ECPSDR_Ingest):ECPSDR_Ingest {
  return (obj || new ECPSDR_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsECPSDR_Ingest(bb:flatbuffers.ByteBuffer, obj?:ECPSDR_Ingest):ECPSDR_Ingest {
...
dataMode():ECPSDR_Ingest_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : ECPSDR_Ingest_dataMode_Enum.REAL;
}

static startECPSDR_Ingest(builder:flatbuffers.Builder) {
...
unpack(): ECPSDR_IngestT {
  return new ECPSDR_IngestT(
    this.id(),
    ...
    this.cdsThreshold(),
    this.checksum(),
    this.bb!.createScalarList<string>(this.transientData.bind(this), this.transientData_Length()),
    this.createdAt(),
    this.createdBy(),
    this.source(),
    this.origin(),
...
unpackTo(_o: ECPSDR_IngestT): void {
  _o.id = this.id();
  ...
  _o.transientData = this.bb!.createScalarList<string>(this.transientData.bind(this), this.transientData_Length());
...
export class ECPSDR_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: ECPSDR_Ingest_dataMode_Enum = ECPSDR_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const transientData = ECPSDR_Ingest.createTransientDataVector(builder, builder.createObjectOffsetList(this.transientData));
  ...
  return ECPSDR_Ingest.createECPSDR_Ingest(builder,
    id,
