...
import { GroundImagery_Abridged_dataMode_Enum } from './ground-imagery-abridged-data-mode-enum.js';


/**
 * /// Imagery of terrestrial regions from on-orbit, air, and other sensors.
 */
export class GroundImagery_Abridged implements flatbuffers.IUnpackableObject<GroundImagery_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):GroundImagery_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsGroundImagery_Abridged(bb:flatbuffers.ByteBuffer, obj?:GroundImagery_Abridged):GroundImagery_Abridged {
  return (obj || new GroundImagery_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsGroundImagery_Abridged(bb:flatbuffers.ByteBuffer, obj?:GroundImagery_Abridged):GroundImagery_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():GroundImagery_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 38);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : GroundImagery_Abridged_dataMode_Enum.REAL;
}
...
static startGroundImagery_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:GroundImagery_Abridged_dataMode_Enum) {
  builder.addFieldInt8(17, dataMode, GroundImagery_Abridged_dataMode_Enum.REAL);
}
...
static addTransactionId(builder:flatbuffers.Builder, transactionIdOffset:flatbuffers.Offset) {
  builder.addFieldOffset(20, transactionIdOffset, 0);
}

static addNotes(builder:flatbuffers.Builder, notesOffset:flatbuffers.Offset) {
  builder.addFieldOffset(21, notesOffset, 0);
}

static addFormat(builder:flatbuffers.Builder, formatOffset:flatbuffers.Offset) {
  builder.addFieldOffset(22, formatOffset, 0);
}

static addFilesize(builder:flatbuffers.Builder, filesize:bigint) {
  builder.addFieldInt64(23, filesize, BigInt('0'));
}

static addChecksumValue(builder:flatbuffers.Builder, checksumValueOffset:flatbuffers.Offset) {
  builder.addFieldOffset(24, checksumValueOffset, 0);
}

static endGroundImagery_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishGroundImagery_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'GROU');
}

static finishSizePrefixedGroundImagery_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'GROU', true);
}

static createGroundImagery_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, imageTimeOffset:flatbuffers.Offset, filenameOffset:flatbuffers.Offset, regionTextOffset:flatbuffers.Offset, regionGeoJsonOffset:flatbuffers.Offset, regionTypeOffset:flatbuffers.Offset, regionNdims:number, regionSrid:number, origSensorIdOffset:flatbuffers.Offset, subjectIdOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, dataMode:GroundImagery_Abridged_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, transactionIdOffset:flatbuffers.Offset, notesOffset:flatbuffers.Offset, formatOffset:flatbuffers.Offset, filesize:bigint, checksumValueOffset:flatbuffers.Offset):flatbuffers.Offset {
  GroundImagery_Abridged.startGroundImagery_Abridged(builder);
...
unpack(): GroundImagery_AbridgedT {
  return new GroundImagery_AbridgedT(
    this.id(),
    this.idSensor(),
...
unpackTo(_o: GroundImagery_AbridgedT): void {
  _o.id = this.id();
...
export class GroundImagery_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: GroundImagery_Abridged_dataMode_Enum = GroundImagery_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return GroundImagery_Abridged.createGroundImagery_Abridged(builder,
    id,
    idSensor,
