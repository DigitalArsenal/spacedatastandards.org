 ...
 */
export class IonoObservationDensityProfileIRI_Abridged implements flatbuffers.IUnpackableObject<IonoObservationDensityProfileIRI_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):IonoObservationDensityProfileIRI_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsIonoObservationDensityProfileIRI_Abridged(bb:flatbuffers.ByteBuffer, obj?:IonoObservationDensityProfileIRI_Abridged):IonoObservationDensityProfileIRI_Abridged {
  return (obj || new IonoObservationDensityProfileIRI_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIonoObservationDensityProfileIRI_Abridged(bb:flatbuffers.ByteBuffer, obj?:IonoObservationDensityProfileIRI_Abridged):IonoObservationDensityProfileIRI_Abridged {
...
static startIonoObservationDensityProfileIRI_Abridged(builder:flatbuffers.Builder) {
...
static endIonoObservationDensityProfileIRI_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishIonoObservationDensityProfileIRI_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO');
}

static finishSizePrefixedIonoObservationDensityProfileIRI_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO', true);
}

static createIonoObservationDensityProfileIRI_Abridged(builder:flatbuffers.Builder, descriptionOffset:flatbuffers.Offset, nmF2:number, hmF2:number, b0:number, b1:number, nmF1:number, hmF1:number, d1:number, hz:number, hValTop:number, nValB:number, nmE:number, hmE:number, hdx:number, nmD:number, hmD:number, ha:number, fp1:number, fp2:number, fp30:number, fp3U:number, chi:number):flatbuffers.Offset {
  IonoObservationDensityProfileIRI_Abridged.startIonoObservationDensityProfileIRI_Abridged(builder);
...
unpack(): IonoObservationDensityProfileIRI_AbridgedT {
  return new IonoObservationDensityProfileIRI_AbridgedT(
    this.description(),
    this.nmF2(),
    this.hmF2(),
    this.b0(),
...
unpackTo(_o: IonoObservationDensityProfileIRI_AbridgedT): void {
...
export class IonoObservationDensityProfileIRI_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return IonoObservationDensityProfileIRI_Abridged.createIonoObservationDensityProfileIRI_Abridged(builder,
    description,
    this.nmF2,
    this.hmF2,
    this.b0,
