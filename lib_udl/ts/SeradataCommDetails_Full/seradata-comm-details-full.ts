...
import { SeradataCommDetails_Full_dataMode_Enum } from './seradata-comm-details-full-data-mode-enum.js';


/**
 * /// Seradata-compiled information on communications payloads.
 */
export class SeradataCommDetails_Full implements flatbuffers.IUnpackableObject<SeradataCommDetails_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SeradataCommDetails_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSeradataCommDetails_Full(bb:flatbuffers.ByteBuffer, obj?:SeradataCommDetails_Full):SeradataCommDetails_Full {
  return (obj || new SeradataCommDetails_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSeradataCommDetails_Full(bb:flatbuffers.ByteBuffer, obj?:SeradataCommDetails_Full):SeradataCommDetails_Full {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SeradataCommDetails_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 72);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SeradataCommDetails_Full_dataMode_Enum.REAL;
}
...
static startSeradataCommDetails_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SeradataCommDetails_Full_dataMode_Enum) {
  builder.addFieldInt8(34, dataMode, SeradataCommDetails_Full_dataMode_Enum.REAL);
}
...
static endSeradataCommDetails_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSeradataCommDetails_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA');
}

static finishSizePrefixedSeradataCommDetails_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA', true);
}

static createSeradataCommDetails_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idCommOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, spacecraftIdOffset:flatbuffers.Offset, bandOffset:flatbuffers.Offset, solidStatePowerAmp:number, travelingWaveTubeAmplifier:number, gatewayUplinkFrom:number, gatewayUplinkTo:number, gatewayDownlinkFrom:number, gatewayDownlinkTo:number, polarizationOffset:flatbuffers.Offset, eirp:number, bandwidth:number, numOperationalTransponders:number, numSpareTransponders:number, hostedForCompanyOrgIdOffset:flatbuffers.Offset, manufacturerOrgIdOffset:flatbuffers.Offset, tradeLeaseOrgIdOffset:flatbuffers.Offset, num36MhzEquivalentTransponders:number, htsNumUserSpotBeams:number, htsUserDownlinkBandwidthPerBeam:number, htsUserUplinkBandwidthPerBeam:number, estHtsTotalUserDownlinkBandwidthPerBeam:number, estHtsTotalUserUplinkBandwidthPerBeam:number, estHtsTotalCapacity:number, userDownlinkFrom:number, userDownlinkTo:number, userUplinkFrom:number, userUplinkTo:number, payloadNotesOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:SeradataCommDetails_Full_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset):flatbuffers.Offset {
  SeradataCommDetails_Full.startSeradataCommDetails_Full(builder);
...
unpack(): SeradataCommDetails_FullT {
  return new SeradataCommDetails_FullT(
    this.id(),
    this.idComm(),
...
unpackTo(_o: SeradataCommDetails_FullT): void {
  _o.id = this.id();
...
export class SeradataCommDetails_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SeradataCommDetails_Full_dataMode_Enum = SeradataCommDetails_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SeradataCommDetails_Full.createSeradataCommDetails_Full(builder,
    id,
    idComm,
