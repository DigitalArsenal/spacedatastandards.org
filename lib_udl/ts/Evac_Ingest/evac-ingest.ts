...
import { Evac_Ingest_dataMode_Enum } from './evac-ingest-data-mode-enum.js';
import { Evac_Ingest_type_Enum } from './evac-ingest-type-enum.js';


/**
 * /// Casualty report and evacuation request. Used to report and request support to evacuate friendly and enemy casualties.
 */
export class Evac_Ingest implements flatbuffers.IUnpackableObject<Evac_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Evac_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEvac_Ingest(bb:flatbuffers.ByteBuffer, obj?:Evac_Ingest):Evac_Ingest {
  return (obj || new Evac_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEvac_Ingest(bb:flatbuffers.ByteBuffer, obj?:Evac_Ingest):Evac_Ingest {
 ...
 */
type():Evac_Ingest_type_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 10);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Evac_Ingest_type_Enum.REQUEST;
}
 ...
 */
dataMode():Evac_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 82);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Evac_Ingest_dataMode_Enum.REAL;
}

static startEvac_Ingest(builder:flatbuffers.Builder) {
...
static addType(builder:flatbuffers.Builder, type:Evac_Ingest_type_Enum) {
  builder.addFieldInt8(3, type, Evac_Ingest_type_Enum.REQUEST);
}
...
export class Evac_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  public id: string|Uint8Array|null = null,
  public classificationMarking: string|Uint8Array|null = null,
  public medevacId: string|Uint8Array|null = null,
  public type: Evac_Ingest_type_Enum = Evac_Ingest_type_Enum.REQUEST,
  ...
  public dataMode: Evac_Ingest_dataMode_Enum = Evac_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const casualtyInfo = Evac_Ingest.createCasualtyInfoVector(builder, builder.createObjectOffsetList(this.casualtyInfo));
  const enemyData = Evac_Ingest.createEnemyDataVector(builder, builder.createObjectOffsetList(this.enemyData));
  ...
  return Evac_Ingest.createEvac_Ingest(builder,
    id,
