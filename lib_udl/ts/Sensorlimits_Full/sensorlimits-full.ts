...
import { Sensorlimits_Full_dataMode_Enum } from './sensorlimits-full-data-mode-enum.js';


/**
 * /// Sensorlimits define 0 to many limits of a particular sensor in terms of observation coverage of on-orbit objects.
 */
export class Sensorlimits_Full implements flatbuffers.IUnpackableObject<Sensorlimits_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Sensorlimits_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSensorlimits_Full(bb:flatbuffers.ByteBuffer, obj?:Sensorlimits_Full):Sensorlimits_Full {
  return (obj || new Sensorlimits_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSensorlimits_Full(bb:flatbuffers.ByteBuffer, obj?:Sensorlimits_Full):Sensorlimits_Full {
...
dataMode():Sensorlimits_Full_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Sensorlimits_Full_dataMode_Enum.REAL;
}
...
static startSensorlimits_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Sensorlimits_Full_dataMode_Enum) {
  builder.addFieldInt8(12, dataMode, Sensorlimits_Full_dataMode_Enum.REAL);
}
...
static addIdSensor(builder:flatbuffers.Builder, idSensorOffset:flatbuffers.Offset) {
  builder.addFieldOffset(17, idSensorOffset, 0);
}

static endSensorlimits_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSensorlimits_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SENS');
}

static finishSizePrefixedSensorlimits_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SENS', true);
}

static createSensorlimits_Full(builder:flatbuffers.Builder, idSensorLimitsOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, upperLeftAzimuthLimit:number, upperRightAzimuthLimit:number, lowerRightAzimuthLimit:number, lowerLeftAzimuthLimit:number, lowerLeftElevationLimit:number, upperLeftElevationLimit:number, lowerRightElevationLimit:number, upperRightElevationLimit:number, sourceOffset:flatbuffers.Offset, dataMode:Sensorlimits_Full_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset):flatbuffers.Offset {
  Sensorlimits_Full.startSensorlimits_Full(builder);
...
unpack(): Sensorlimits_FullT {
  return new Sensorlimits_FullT(
    this.idSensorLimits(),
...
unpackTo(_o: Sensorlimits_FullT): void {
...
export class Sensorlimits_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Sensorlimits_Full_dataMode_Enum = Sensorlimits_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Sensorlimits_Full.createSensorlimits_Full(builder,
    idSensorLimits,
