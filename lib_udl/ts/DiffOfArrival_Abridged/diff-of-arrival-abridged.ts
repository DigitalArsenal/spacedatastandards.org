...
import { DiffOfArrival_Abridged_dataMode_Enum } from './diff-of-arrival-abridged-data-mode-enum.js';
 ...
 */
export class DiffOfArrival_Abridged implements flatbuffers.IUnpackableObject<DiffOfArrival_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):DiffOfArrival_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsDiffOfArrival_Abridged(bb:flatbuffers.ByteBuffer, obj?:DiffOfArrival_Abridged):DiffOfArrival_Abridged {
  return (obj || new DiffOfArrival_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsDiffOfArrival_Abridged(bb:flatbuffers.ByteBuffer, obj?:DiffOfArrival_Abridged):DiffOfArrival_Abridged {
 ...
 */
dataMode():DiffOfArrival_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 70);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : DiffOfArrival_Abridged_dataMode_Enum.REAL;
}
...
static startDiffOfArrival_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:DiffOfArrival_Abridged_dataMode_Enum) {
  builder.addFieldInt8(33, dataMode, DiffOfArrival_Abridged_dataMode_Enum.REAL);
}
...
static addDescriptor(builder:flatbuffers.Builder, descriptorOffset:flatbuffers.Offset) {
  builder.addFieldOffset(37, descriptorOffset, 0);
}
...
static endDiffOfArrival_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishDiffOfArrival_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DIFF');
}

static finishSizePrefixedDiffOfArrival_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DIFF', true);
}

static createDiffOfArrival_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, obTimeOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, idSensor1Offset:flatbuffers.Offset, idSensor2Offset:flatbuffers.Offset, satNo:number, taskIdOffset:flatbuffers.Offset, origObjectIdOffset:flatbuffers.Offset, origSensorId1Offset:flatbuffers.Offset, origSensorId2Offset:flatbuffers.Offset, uct:boolean, sensor1Delay:number, sensor2Delay:number, senlat:number, senlon:number, senalt:number, sen2lat:number, sen2lon:number, sen2alt:number, frequency:number, bandwidth:number, deltaRange:number, deltaRangeUnc:number, deltaRangeRate:number, deltaRangeRateUnc:number, snr:number, tdoa:number, tdoaUnc:number, fdoa:number, fdoaUnc:number, collectionModeOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, dataMode:DiffOfArrival_Abridged_dataMode_Enum, originOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, descriptorOffset:flatbuffers.Offset, transactionIdOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset):flatbuffers.Offset {
  DiffOfArrival_Abridged.startDiffOfArrival_Abridged(builder);
...
unpack(): DiffOfArrival_AbridgedT {
  return new DiffOfArrival_AbridgedT(
    this.id(),
...
unpackTo(_o: DiffOfArrival_AbridgedT): void {
  _o.id = this.id();
...
export class DiffOfArrival_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: DiffOfArrival_Abridged_dataMode_Enum = DiffOfArrival_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return DiffOfArrival_Abridged.createDiffOfArrival_Abridged(builder,
    id,
