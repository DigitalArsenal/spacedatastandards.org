...
import { AttitudeData_Full_dataMode_Enum } from './AttitudeData_Full_dataMode_Enum.js';
 ...
 */
export class AttitudeData_Full implements flatbuffers.IUnpackableObject<AttitudeData_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AttitudeData_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAttitudeData_Full(bb:flatbuffers.ByteBuffer, obj?:AttitudeData_Full):AttitudeData_Full {
  return (obj || new AttitudeData_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAttitudeData_Full(bb:flatbuffers.ByteBuffer, obj?:AttitudeData_Full):AttitudeData_Full {
 ...
 */
dataMode():AttitudeData_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 66);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AttitudeData_Full_dataMode_Enum.REAL;
}
...
static startAttitudeData_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AttitudeData_Full_dataMode_Enum) {
  builder.addFieldInt8(31, dataMode, AttitudeData_Full_dataMode_Enum.REAL);
}
...
static endAttitudeData_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAttitudeData_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ATTI');
}

static finishSizePrefixedAttitudeData_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ATTI', true);
}

static createAttitudeData_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, asIdOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, satNo:number, origObjectIdOffset:flatbuffers.Offset, tsOffset:flatbuffers.Offset, motionTypeOffset:flatbuffers.Offset, q1:number, q2:number, q3:number, qc:number, q1Dot:number, q2Dot:number, q3Dot:number, qcDot:number, xAngleOffset:flatbuffers.Offset, yAngleOffset:flatbuffers.Offset, zAngleOffset:flatbuffers.Offset, xRateOffset:flatbuffers.Offset, yRateOffset:flatbuffers.Offset, zRateOffset:flatbuffers.Offset, ra:number, declination:number, coningAngle:number, precPeriod:number, spinPeriod:number, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:AttitudeData_Full_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  AttitudeData_Full.startAttitudeData_Full(builder);
...
unpack(): AttitudeData_FullT {
  return new AttitudeData_FullT(
    this.id(),
...
unpackTo(_o: AttitudeData_FullT): void {
  _o.id = this.id();
...
export class AttitudeData_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AttitudeData_Full_dataMode_Enum = AttitudeData_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const xAngle = AttitudeData_Full.createXAngleVector(builder, builder.createObjectOffsetList(this.xAngle));
  const yAngle = AttitudeData_Full.createYAngleVector(builder, builder.createObjectOffsetList(this.yAngle));
  const zAngle = AttitudeData_Full.createZAngleVector(builder, builder.createObjectOffsetList(this.zAngle));
  const xRate = AttitudeData_Full.createXRateVector(builder, builder.createObjectOffsetList(this.xRate));
  const yRate = AttitudeData_Full.createYRateVector(builder, builder.createObjectOffsetList(this.yRate));
  const zRate = AttitudeData_Full.createZRateVector(builder, builder.createObjectOffsetList(this.zRate));
  ...
  return AttitudeData_Full.createAttitudeData_Full(builder,
    id,
