...
import { ISRCollectionTaskings_Abridged_collectionType_Enum } from './isrcollection-taskings-abridged-collection-type-enum.js';
import { ISRCollectionTaskings_Abridged_type_Enum } from './isrcollection-taskings-abridged-type-enum.js';


/**
 * /// Individual taskings to complete the mission.
 */
export class ISRCollectionTaskings_Abridged implements flatbuffers.IUnpackableObject<ISRCollectionTaskings_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ISRCollectionTaskings_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsISRCollectionTaskings_Abridged(bb:flatbuffers.ByteBuffer, obj?:ISRCollectionTaskings_Abridged):ISRCollectionTaskings_Abridged {
  return (obj || new ISRCollectionTaskings_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsISRCollectionTaskings_Abridged(bb:flatbuffers.ByteBuffer, obj?:ISRCollectionTaskings_Abridged):ISRCollectionTaskings_Abridged {
 ...
 */
type():ISRCollectionTaskings_Abridged_type_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : ISRCollectionTaskings_Abridged_type_Enum.DELIBERATE;
}
 ...
 * Constraints: Minimum length = 1, Maximum length = 16
 */
collectionType():ISRCollectionTaskings_Abridged_collectionType_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : ISRCollectionTaskings_Abridged_collectionType_Enum.SIMULTANEOUS;
}
...
static startISRCollectionTaskings_Abridged(builder:flatbuffers.Builder) {
...
static addType(builder:flatbuffers.Builder, type:ISRCollectionTaskings_Abridged_type_Enum) {
  builder.addFieldInt8(1, type, ISRCollectionTaskings_Abridged_type_Enum.DELIBERATE);
}

static addCollectionType(builder:flatbuffers.Builder, collectionType:ISRCollectionTaskings_Abridged_collectionType_Enum) {
  builder.addFieldInt8(2, collectionType, ISRCollectionTaskings_Abridged_collectionType_Enum.SIMULTANEOUS);
}
...
unpack(): ISRCollectionTaskings_AbridgedT {
  return new ISRCollectionTaskings_AbridgedT(
    this.id(),
    this.type(),
    this.collectionType(),
    this.taskingAor(),
...
unpackTo(_o: ISRCollectionTaskings_AbridgedT): void {
  _o.id = this.id();
  _o.type = this.type();
...
export class ISRCollectionTaskings_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  public id: string|Uint8Array|null = null,
  public type: ISRCollectionTaskings_Abridged_type_Enum = ISRCollectionTaskings_Abridged_type_Enum.DELIBERATE,
  public collectionType: ISRCollectionTaskings_Abridged_collectionType_Enum = ISRCollectionTaskings_Abridged_collectionType_Enum.SIMULTANEOUS,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const taskingCollectionRequirements = ISRCollectionTaskings_Abridged.createTaskingCollectionRequirementsVector(builder, builder.createObjectOffsetList(this.taskingCollectionRequirements));

  return ISRCollectionTaskings_Abridged.createISRCollectionTaskings_Abridged(builder,
    id,
    this.type,
    this.collectionType,
    taskingAOR,
