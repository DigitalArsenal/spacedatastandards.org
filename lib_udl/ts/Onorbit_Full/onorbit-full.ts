...
import { Onorbit_Full_category_Enum } from './onorbit-full-category-enum.js';
import { Onorbit_Full_dataMode_Enum } from './onorbit-full-data-mode-enum.js';
import { Onorbit_Full_objectType_Enum } from './onorbit-full-object-type-enum.js';
...
unpack(): Onorbit_FullT {
  return new Onorbit_FullT(
    ...
    this.countryCode(),
    this.origNetwork(),
    this.bb!.createScalarList<string>(this.entityCollection.bind(this), this.entityCollection_Length())
  );
}
...
unpackTo(_o: Onorbit_FullT): void {
  ...
  _o.entityCollection = this.bb!.createScalarList<string>(this.entityCollection.bind(this), this.entityCollection_Length());
}
}
