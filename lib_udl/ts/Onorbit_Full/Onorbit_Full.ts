...
import { Onorbit_Full_category_Enum } from './Onorbit_Full_category_Enum.js';
import { Onorbit_Full_dataMode_Enum } from './Onorbit_Full_dataMode_Enum.js';
import { Onorbit_Full_objectType_Enum } from './Onorbit_Full_objectType_Enum.js';


/**
 * /// Model object representing on-orbit objects or satellites in the system.
 */
export class Onorbit_Full implements flatbuffers.IUnpackableObject<Onorbit_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Onorbit_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOnorbit_Full(bb:flatbuffers.ByteBuffer, obj?:Onorbit_Full):Onorbit_Full {
  return (obj || new Onorbit_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOnorbit_Full(bb:flatbuffers.ByteBuffer, obj?:Onorbit_Full):Onorbit_Full {
 ...
 */
objectType():Onorbit_Full_objectType_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 20);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Onorbit_Full_objectType_Enum.ROCKET_BODY;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 45
 */
category():Onorbit_Full_category_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 26);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Onorbit_Full_category_Enum.UNKNOWN;
}
 ...
 */
dataMode():Onorbit_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 42);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Onorbit_Full_dataMode_Enum.REAL;
}
 ...
 * Constraints: No constraints specified.
 */
entityCollection(index: number):string
entityCollection(index: number,optionalEncoding:flatbuffers.Encoding):string|Uint8Array
entityCollection(index: number,optionalEncoding?:any):string|Uint8Array|null {
...
static startOnorbit_Full(builder:flatbuffers.Builder) {
...
static addObjectType(builder:flatbuffers.Builder, objectType:Onorbit_Full_objectType_Enum) {
  builder.addFieldInt8(8, objectType, Onorbit_Full_objectType_Enum.ROCKET_BODY);
}
...
static addCategory(builder:flatbuffers.Builder, category:Onorbit_Full_category_Enum) {
  builder.addFieldInt8(11, category, Onorbit_Full_category_Enum.UNKNOWN);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Onorbit_Full_dataMode_Enum) {
  builder.addFieldInt8(19, dataMode, Onorbit_Full_dataMode_Enum.REAL);
}
...
static addEntityCollection(builder:flatbuffers.Builder, entityCollectionOffset:flatbuffers.Offset) {
  builder.addFieldOffset(28, entityCollectionOffset, 0);
}
...
static endOnorbit_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishOnorbit_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ONOR');
}

static finishSizePrefixedOnorbit_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ONOR', true);
}

static createOnorbit_Full(builder:flatbuffers.Builder, idOnOrbitOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, satNo:number, commonNameOffset:flatbuffers.Offset, constellationOffset:flatbuffers.Offset, intlDesOffset:flatbuffers.Offset, launchDateOffset:flatbuffers.Offset, decayDateOffset:flatbuffers.Offset, objectType:Onorbit_Full_objectType_Enum, originOffset:flatbuffers.Offset, missionNumberOffset:flatbuffers.Offset, category:Onorbit_Full_category_Enum, lifetimeYears:number, altNameOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, dataMode:Onorbit_Full_dataMode_Enum, launchSiteIdOffset:flatbuffers.Offset, antennasOffset:flatbuffers.Offset, batteriesOffset:flatbuffers.Offset, solarArraysOffset:flatbuffers.Offset, thrustersOffset:flatbuffers.Offset, onorbitDetailsOffset:flatbuffers.Offset, countryCodeOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, entityCollectionOffset:flatbuffers.Offset):flatbuffers.Offset {
  Onorbit_Full.startOnorbit_Full(builder);
...
unpack(): Onorbit_FullT {
  return new Onorbit_FullT(
    this.idOnOrbit(),
    ...
    this.bb!.createScalarList<string>(this.solarArrays.bind(this), this.solarArraysLength()),
    this.bb!.createScalarList<string>(this.thrusters.bind(this), this.thrustersLength()),
    this.bb!.createScalarList<string>(this.onorbitDetails.bind(this), this.onorbitDetailsLength()),
    this.countryCode(),
    this.origNetwork(),
    this.bb!.createScalarList<string>(this.entityCollection.bind(this), this.entityCollectionLength())
  );
}


unpackTo(_o: Onorbit_FullT): void {
  ...
  _o.solarArrays = this.bb!.createScalarList<string>(this.solarArrays.bind(this), this.solarArraysLength());
  _o.thrusters = this.bb!.createScalarList<string>(this.thrusters.bind(this), this.thrustersLength());
  _o.onorbitDetails = this.bb!.createScalarList<string>(this.onorbitDetails.bind(this), this.onorbitDetailsLength());
  _o.countryCode = this.countryCode();
  _o.origNetwork = this.origNetwork();
  _o.entityCollection = this.bb!.createScalarList<string>(this.entityCollection.bind(this), this.entityCollectionLength());
}
}

export class Onorbit_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public objectType: Onorbit_Full_objectType_Enum = Onorbit_Full_objectType_Enum.ROCKET_BODY,
  public origin: string|Uint8Array|null = null,
  public missionNumber: string|Uint8Array|null = null,
  public category: Onorbit_Full_category_Enum = Onorbit_Full_category_Enum.UNKNOWN,
  ...
  public dataMode: Onorbit_Full_dataMode_Enum = Onorbit_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const antennas = Onorbit_Full.createAntennasVector(builder, builder.createObjectOffsetList(this.antennas));
  const batteries = Onorbit_Full.createBatteriesVector(builder, builder.createObjectOffsetList(this.batteries));
  const solarArrays = Onorbit_Full.createSolarArraysVector(builder, builder.createObjectOffsetList(this.solarArrays));
  const thrusters = Onorbit_Full.createThrustersVector(builder, builder.createObjectOffsetList(this.thrusters));
  const onorbitDetails = Onorbit_Full.createOnorbitDetailsVector(builder, builder.createObjectOffsetList(this.onorbitDetails));
  const countryCode = (this.countryCode !== null ? builder.createString(this.countryCode!) : 0);
  const origNetwork = (this.origNetwork !== null ? builder.createString(this.origNetwork!) : 0);
  const entityCollection = Onorbit_Full.createEntityCollectionVector(builder, builder.createObjectOffsetList(this.entityCollection));

  return Onorbit_Full.createOnorbit_Full(builder,
    idOnOrbit,
