 ...
 */
export class LogisticsSpecialties_Full implements flatbuffers.IUnpackableObject<LogisticsSpecialties_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LogisticsSpecialties_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLogisticsSpecialties_Full(bb:flatbuffers.ByteBuffer, obj?:LogisticsSpecialties_Full):LogisticsSpecialties_Full {
  return (obj || new LogisticsSpecialties_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLogisticsSpecialties_Full(bb:flatbuffers.ByteBuffer, obj?:LogisticsSpecialties_Full):LogisticsSpecialties_Full {
...
static startLogisticsSpecialties_Full(builder:flatbuffers.Builder) {
...
static endLogisticsSpecialties_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishLogisticsSpecialties_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'LOGI');
}

static finishSizePrefixedLogisticsSpecialties_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'LOGI', true);
}

static createLogisticsSpecialties_Full(builder:flatbuffers.Builder, specialtyOffset:flatbuffers.Offset, skillLevel:number, firstNameOffset:flatbuffers.Offset, lastNameOffset:flatbuffers.Offset, rankCodeOffset:flatbuffers.Offset, last4SsnOffset:flatbuffers.Offset, roleTypeCodeOffset:flatbuffers.Offset):flatbuffers.Offset {
  LogisticsSpecialties_Full.startLogisticsSpecialties_Full(builder);
...
unpack(): LogisticsSpecialties_FullT {
  return new LogisticsSpecialties_FullT(
    this.specialty(),
    this.skillLevel(),
    this.firstName(),
    this.lastName(),
...
unpackTo(_o: LogisticsSpecialties_FullT): void {
...
export class LogisticsSpecialties_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return LogisticsSpecialties_Full.createLogisticsSpecialties_Full(builder,
    specialty,
    this.skillLevel,
    firstName,
    lastName,
