...
import { SpaceEnvObservation_Abridged_dataMode_Enum } from './space-env-observation-abridged-data-mode-enum.js';
import { SpaceEnvObservation_Abridged_senReferenceFrame_Enum } from './space-env-observation-abridged-sen-reference-frame-enum.js';


/**
 * /// SpaceEnvObservation data.
 */
export class SpaceEnvObservation_Abridged implements flatbuffers.IUnpackableObject<SpaceEnvObservation_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SpaceEnvObservation_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSpaceEnvObservation_Abridged(bb:flatbuffers.ByteBuffer, obj?:SpaceEnvObservation_Abridged):SpaceEnvObservation_Abridged {
  return (obj || new SpaceEnvObservation_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSpaceEnvObservation_Abridged(bb:flatbuffers.ByteBuffer, obj?:SpaceEnvObservation_Abridged):SpaceEnvObservation_Abridged {
 ...
 */
senReferenceFrame():SpaceEnvObservation_Abridged_senReferenceFrame_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 46);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SpaceEnvObservation_Abridged_senReferenceFrame_Enum.J2000;
}
 ...
 */
dataMode():SpaceEnvObservation_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 82);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SpaceEnvObservation_Abridged_dataMode_Enum.REAL;
}
...
static startSpaceEnvObservation_Abridged(builder:flatbuffers.Builder) {
...
static addSenReferenceFrame(builder:flatbuffers.Builder, senReferenceFrame:SpaceEnvObservation_Abridged_senReferenceFrame_Enum) {
  builder.addFieldInt8(21, senReferenceFrame, SpaceEnvObservation_Abridged_senReferenceFrame_Enum.J2000);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SpaceEnvObservation_Abridged_dataMode_Enum) {
  builder.addFieldInt8(39, dataMode, SpaceEnvObservation_Abridged_dataMode_Enum.REAL);
}
...
static endSpaceEnvObservation_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSpaceEnvObservation_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SPAC');
}

static finishSizePrefixedSpaceEnvObservation_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SPAC', true);
}

static createSpaceEnvObservation_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, msgTypeOffset:flatbuffers.Offset, genSystemOffset:flatbuffers.Offset, externalIdOffset:flatbuffers.Offset, dataTypeOffset:flatbuffers.Offset, genTimeOffset:flatbuffers.Offset, forecast:boolean, derived:boolean, idOnOrbitOffset:flatbuffers.Offset, satNo:number, origObjectIdOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, origSensorIdOffset:flatbuffers.Offset, observatoryTypeOffset:flatbuffers.Offset, observatoryNameOffset:flatbuffers.Offset, observatoryNotesOffset:flatbuffers.Offset, instrumentTypeOffset:flatbuffers.Offset, lat:number, lon:number, alt:number, senReferenceFrame:SpaceEnvObservation_Abridged_senReferenceFrame_Enum, senPosOffset:flatbuffers.Offset, senVelOffset:flatbuffers.Offset, measTypeOffset:flatbuffers.Offset, senEnergyLevelOffset:flatbuffers.Offset, obSetIdOffset:flatbuffers.Offset, particleTypeOffset:flatbuffers.Offset, obTimeOffset:flatbuffers.Offset, seoListOffset:flatbuffers.Offset, qualityOffset:flatbuffers.Offset, descriptionOffset:flatbuffers.Offset, descriptorOffset:flatbuffers.Offset, srcTypsOffset:flatbuffers.Offset, srcIdsOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:SpaceEnvObservation_Abridged_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  SpaceEnvObservation_Abridged.startSpaceEnvObservation_Abridged(builder);
  SpaceEnvObservation_Abridged.addId(builder, idOffset);
  SpaceEnvObservation_Abridged.addClassificationMarking(builder, classificationMarkingOffset);
  SpaceEnvObservation_Abridged.addMsgType(builder, msgTypeOffset);
  SpaceEnvObservation_Abridged.addGenSystem(builder, genSystemOffset);
  SpaceEnvObservation_Abridged.addExternalId(builder, externalIdOffset);
  SpaceEnvObservation_Abridged.addDataType(builder, dataTypeOffset);
  SpaceEnvObservation_Abridged.addGenTime(builder, genTimeOffset);
  SpaceEnvObservation_Abridged.addForecast(builder, forecast);
  SpaceEnvObservation_Abridged.addDerived(builder, derived);
  SpaceEnvObservation_Abridged.addIdOnOrbit(builder, idOnOrbitOffset);
  SpaceEnvObservation_Abridged.addSatNo(builder, satNo);
  SpaceEnvObservation_Abridged.addOrigObjectId(builder, origObjectIdOffset);
  SpaceEnvObservation_Abridged.addIdSensor(builder, idSensorOffset);
  SpaceEnvObservation_Abridged.addOrigSensorId(builder, origSensorIdOffset);
  SpaceEnvObservation_Abridged.addObservatoryType(builder, observatoryTypeOffset);
  SpaceEnvObservation_Abridged.addObservatoryName(builder, observatoryNameOffset);
  SpaceEnvObservation_Abridged.addObservatoryNotes(builder, observatoryNotesOffset);
  SpaceEnvObservation_Abridged.addInstrumentType(builder, instrumentTypeOffset);
  SpaceEnvObservation_Abridged.addLat(builder, lat);
  SpaceEnvObservation_Abridged.addLon(builder, lon);
  SpaceEnvObservation_Abridged.addAlt(builder, alt);
  SpaceEnvObservation_Abridged.addSenReferenceFrame(builder, senReferenceFrame);
  SpaceEnvObservation_Abridged.addSenPos(builder, senPosOffset);
  SpaceEnvObservation_Abridged.addSenVel(builder, senVelOffset);
  SpaceEnvObservation_Abridged.addMeasType(builder, measTypeOffset);
  SpaceEnvObservation_Abridged.addSenEnergyLevel(builder, senEnergyLevelOffset);
  SpaceEnvObservation_Abridged.addObSetId(builder, obSetIdOffset);
  SpaceEnvObservation_Abridged.addParticleType(builder, particleTypeOffset);
  SpaceEnvObservation_Abridged.addObTime(builder, obTimeOffset);
  SpaceEnvObservation_Abridged.addSeoList(builder, seoListOffset);
  SpaceEnvObservation_Abridged.addQuality(builder, qualityOffset);
  SpaceEnvObservation_Abridged.addDescription(builder, descriptionOffset);
  SpaceEnvObservation_Abridged.addDescriptor(builder, descriptorOffset);
  SpaceEnvObservation_Abridged.addSrcTyps(builder, srcTypsOffset);
  SpaceEnvObservation_Abridged.addSrcIds(builder, srcIdsOffset);
  SpaceEnvObservation_Abridged.addCreatedAt(builder, createdAtOffset);
  SpaceEnvObservation_Abridged.addCreatedBy(builder, createdByOffset);
  SpaceEnvObservation_Abridged.addSource(builder, sourceOffset);
  SpaceEnvObservation_Abridged.addOrigin(builder, originOffset);
  SpaceEnvObservation_Abridged.addDataMode(builder, dataMode);
  SpaceEnvObservation_Abridged.addOrigNetwork(builder, origNetworkOffset);
  return SpaceEnvObservation_Abridged.endSpaceEnvObservation_Abridged(builder);
}

unpack(): SpaceEnvObservation_AbridgedT {
  return new SpaceEnvObservation_AbridgedT(
    this.id(),
    ...
    this.bb!.createScalarList<string>(this.senPos.bind(this), this.senPos_Length()),
    this.bb!.createScalarList<string>(this.senVel.bind(this), this.senVel_Length()),
    this.measType(),
    this.senEnergyLevel(),
    this.obSetId(),
    this.particleType(),
    this.obTime(),
    this.bb!.createScalarList<string>(this.seoList.bind(this), this.seoList_Length()),
    this.quality(),
    this.description(),
    this.descriptor(),
...
unpackTo(_o: SpaceEnvObservation_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.senPos = this.bb!.createScalarList<string>(this.senPos.bind(this), this.senPos_Length());
  _o.senVel = this.bb!.createScalarList<string>(this.senVel.bind(this), this.senVel_Length());
  ...
  _o.seoList = this.bb!.createScalarList<string>(this.seoList.bind(this), this.seoList_Length());
...
export class SpaceEnvObservation_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public senReferenceFrame: SpaceEnvObservation_Abridged_senReferenceFrame_Enum = SpaceEnvObservation_Abridged_senReferenceFrame_Enum.J2000,
  ...
  public dataMode: SpaceEnvObservation_Abridged_dataMode_Enum = SpaceEnvObservation_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const senPos = SpaceEnvObservation_Abridged.createSenPosVector(builder, builder.createObjectOffsetList(this.senPos));
  const senVel = SpaceEnvObservation_Abridged.createSenVelVector(builder, builder.createObjectOffsetList(this.senVel));
  ...
  const seoList = SpaceEnvObservation_Abridged.createSeoListVector(builder, builder.createObjectOffsetList(this.seoList));
  ...
  const srcTyps = SpaceEnvObservation_Abridged.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = SpaceEnvObservation_Abridged.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  ...
  return SpaceEnvObservation_Abridged.createSpaceEnvObservation_Abridged(builder,
    id,
