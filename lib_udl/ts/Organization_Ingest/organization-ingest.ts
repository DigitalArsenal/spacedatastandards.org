...
import { Organization_Ingest_dataMode_Enum } from './organization-ingest-data-mode-enum.js';
 ...
 */
export class Organization_Ingest implements flatbuffers.IUnpackableObject<Organization_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Organization_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOrganization_Ingest(bb:flatbuffers.ByteBuffer, obj?:Organization_Ingest):Organization_Ingest {
  return (obj || new Organization_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOrganization_Ingest(bb:flatbuffers.ByteBuffer, obj?:Organization_Ingest):Organization_Ingest {
 ...
 */
dataMode():Organization_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 28);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Organization_Ingest_dataMode_Enum.REAL;
}
...
static startOrganization_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Organization_Ingest_dataMode_Enum) {
  builder.addFieldInt8(12, dataMode, Organization_Ingest_dataMode_Enum.REAL);
}
...
unpack(): Organization_IngestT {
  return new Organization_IngestT(
    this.id(),
...
unpackTo(_o: Organization_IngestT): void {
  _o.id = this.id();
...
export class Organization_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Organization_Ingest_dataMode_Enum = Organization_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Organization_Ingest.createOrganization_Ingest(builder,
    id,
