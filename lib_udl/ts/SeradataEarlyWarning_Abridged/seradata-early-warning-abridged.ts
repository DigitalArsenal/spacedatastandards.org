...
import { SeradataEarlyWarning_Abridged_dataMode_Enum } from './seradata-early-warning-abridged-data-mode-enum.js';


/**
 * /// Details for an early warning payload from  Seradata.
 */
export class SeradataEarlyWarning_Abridged implements flatbuffers.IUnpackableObject<SeradataEarlyWarning_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SeradataEarlyWarning_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSeradataEarlyWarning_Abridged(bb:flatbuffers.ByteBuffer, obj?:SeradataEarlyWarning_Abridged):SeradataEarlyWarning_Abridged {
  return (obj || new SeradataEarlyWarning_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSeradataEarlyWarning_Abridged(bb:flatbuffers.ByteBuffer, obj?:SeradataEarlyWarning_Abridged):SeradataEarlyWarning_Abridged {
 ...
 */
dataMode():SeradataEarlyWarning_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 46);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SeradataEarlyWarning_Abridged_dataMode_Enum.REAL;
}

static startSeradataEarlyWarning_Abridged(builder:flatbuffers.Builder) {
...
unpack(): SeradataEarlyWarning_AbridgedT {
  return new SeradataEarlyWarning_AbridgedT(
    this.id(),
...
unpackTo(_o: SeradataEarlyWarning_AbridgedT): void {
  _o.id = this.id();
...
export class SeradataEarlyWarning_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SeradataEarlyWarning_Abridged_dataMode_Enum = SeradataEarlyWarning_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SeradataEarlyWarning_Abridged.createSeradataEarlyWarning_Abridged(builder,
    id,
