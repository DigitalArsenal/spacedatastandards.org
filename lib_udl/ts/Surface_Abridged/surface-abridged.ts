...
import { Surface_Abridged_dataMode_Enum } from './surface-abridged-data-mode-enum.js';
 ...
 */
export class Surface_Abridged implements flatbuffers.IUnpackableObject<Surface_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Surface_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSurface_Abridged(bb:flatbuffers.ByteBuffer, obj?:Surface_Abridged):Surface_Abridged {
  return (obj || new Surface_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSurface_Abridged(bb:flatbuffers.ByteBuffer, obj?:Surface_Abridged):Surface_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Surface_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 106);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Surface_Abridged_dataMode_Enum.REAL;
}

static startSurface_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Surface_Abridged_dataMode_Enum) {
  builder.addFieldInt8(51, dataMode, Surface_Abridged_dataMode_Enum.REAL);
}

static endSurface_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSurface_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SURF');
}

static finishSizePrefixedSurface_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SURF', true);
}

static createSurface_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, idSiteOffset:flatbuffers.Offset, altSiteIdOffset:flatbuffers.Offset, primary:boolean, lengthFt:number, ldaFt:number, widthFt:number, lengthM:number, ldaM:number, widthM:number, materialOffset:flatbuffers.Offset, conditionOffset:flatbuffers.Offset, rawWbcOffset:flatbuffers.Offset, pcnOffset:flatbuffers.Offset, lcn:number, sWtKip:number, tWtKip:number, stWtKip:number, ttWtKip:number, ddWtKip:number, sbttWtKip:number, tdtWtkip:number, trtWtKip:number, ddtWtKip:number, sWtKn:number, tWtKn:number, stWtKn:number, ttWtKn:number, ddWtKn:number, sbttWtKn:number, tdtWtKn:number, trtWtKn:number, ddtWtKn:number, lighting:boolean, lightsUnkn:boolean, lightsAprch:boolean, lightsVasi:boolean, lightsPapi:boolean, lightsOls:boolean, lightsReil:boolean, lightsTdzl:boolean, lightsCl:boolean, obstacle:boolean, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:Surface_Abridged_dataMode_Enum):flatbuffers.Offset {
  Surface_Abridged.startSurface_Abridged(builder);
...
unpack(): Surface_AbridgedT {
  return new Surface_AbridgedT(
    this.id(),
...
unpackTo(_o: Surface_AbridgedT): void {
  _o.id = this.id();
...
export class Surface_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Surface_Abridged_dataMode_Enum = Surface_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Surface_Abridged.createSurface_Abridged(builder,
    id,
