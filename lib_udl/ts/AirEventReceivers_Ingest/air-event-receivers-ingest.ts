 ...
 */
export class AirEventReceivers_Ingest implements flatbuffers.IUnpackableObject<AirEventReceivers_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirEventReceivers_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirEventReceivers_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirEventReceivers_Ingest):AirEventReceivers_Ingest {
  return (obj || new AirEventReceivers_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirEventReceivers_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirEventReceivers_Ingest):AirEventReceivers_Ingest {
...
static startAirEventReceivers_Ingest(builder:flatbuffers.Builder) {
...
unpack(): AirEventReceivers_IngestT {
  return new AirEventReceivers_IngestT(
...
unpackTo(_o: AirEventReceivers_IngestT): void {
...
export class AirEventReceivers_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AirEventReceivers_Ingest.createAirEventReceivers_Ingest(builder,
    idReceiverSortie,
    idReceiverMission,
    idReceiverAirfield,
    externalReceiverId,
