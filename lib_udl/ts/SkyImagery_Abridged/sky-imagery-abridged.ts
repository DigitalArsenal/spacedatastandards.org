...
import { SkyImagery_Abridged_dataMode_Enum } from './sky-imagery-abridged-data-mode-enum.js';
 ...
 */
export class SkyImagery_Abridged implements flatbuffers.IUnpackableObject<SkyImagery_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SkyImagery_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSkyImagery_Abridged(bb:flatbuffers.ByteBuffer, obj?:SkyImagery_Abridged):SkyImagery_Abridged {
  return (obj || new SkyImagery_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSkyImagery_Abridged(bb:flatbuffers.ByteBuffer, obj?:SkyImagery_Abridged):SkyImagery_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SkyImagery_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 96);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SkyImagery_Abridged_dataMode_Enum.REAL;
}
...
static startSkyImagery_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SkyImagery_Abridged_dataMode_Enum) {
  builder.addFieldInt8(46, dataMode, SkyImagery_Abridged_dataMode_Enum.REAL);
}
...
unpack(): SkyImagery_AbridgedT {
  return new SkyImagery_AbridgedT(
    this.id(),
...
unpackTo(_o: SkyImagery_AbridgedT): void {
  _o.id = this.id();
...
export class SkyImagery_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SkyImagery_Abridged_dataMode_Enum = SkyImagery_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const senQuat = SkyImagery_Abridged.createSenQuatVector(builder, builder.createObjectOffsetList(this.senQuat));
  const senQuatDot = SkyImagery_Abridged.createSenQuatDotVector(builder, builder.createObjectOffsetList(this.senQuatDot));
  ...
  const tags = SkyImagery_Abridged.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return SkyImagery_Abridged.createSkyImagery_Abridged(builder,
    id,
