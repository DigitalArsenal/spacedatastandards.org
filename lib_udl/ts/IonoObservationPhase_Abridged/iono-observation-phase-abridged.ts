 ...
 */
export class IonoObservationPhase_Abridged implements flatbuffers.IUnpackableObject<IonoObservationPhase_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):IonoObservationPhase_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsIonoObservationPhase_Abridged(bb:flatbuffers.ByteBuffer, obj?:IonoObservationPhase_Abridged):IonoObservationPhase_Abridged {
  return (obj || new IonoObservationPhase_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIonoObservationPhase_Abridged(bb:flatbuffers.ByteBuffer, obj?:IonoObservationPhase_Abridged):IonoObservationPhase_Abridged {
...
static startIonoObservationPhase_Abridged(builder:flatbuffers.Builder) {
...
static endIonoObservationPhase_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishIonoObservationPhase_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO');
}

static finishSizePrefixedIonoObservationPhase_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO', true);
}

static createIonoObservationPhase_Abridged(builder:flatbuffers.Builder, notesOffset:flatbuffers.Offset, dimensionsOffset:flatbuffers.Offset, dimensionNameOffset:flatbuffers.Offset, dataOffset:flatbuffers.Offset):flatbuffers.Offset {
  IonoObservationPhase_Abridged.startIonoObservationPhase_Abridged(builder);
...
unpack(): IonoObservationPhase_AbridgedT {
  return new IonoObservationPhase_AbridgedT(
    this.notes(),
...
unpackTo(_o: IonoObservationPhase_AbridgedT): void {
  _o.notes = this.notes();
...
export class IonoObservationPhase_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const dimensions = IonoObservationPhase_Abridged.createDimensionsVector(builder, builder.createObjectOffsetList(this.dimensions));
  const dimensionName = IonoObservationPhase_Abridged.createDimensionNameVector(builder, builder.createObjectOffsetList(this.dimensionName));
  const data = IonoObservationPhase_Abridged.createDataVector(builder, builder.createObjectOffsetList(this.data));

  return IonoObservationPhase_Abridged.createIonoObservationPhase_Abridged(builder,
    notes,
    dimensions,
    dimensionName,
    data
