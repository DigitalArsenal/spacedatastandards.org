...
import { Conjunction_Ingest_dataMode_Enum } from './conjunction-ingest-data-mode-enum.js';


/**
 * /// Stores the results of a particular Conjunction Assessment (CA) run.
 */
export class Conjunction_Ingest implements flatbuffers.IUnpackableObject<Conjunction_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Conjunction_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsConjunction_Ingest(bb:flatbuffers.ByteBuffer, obj?:Conjunction_Ingest):Conjunction_Ingest {
  return (obj || new Conjunction_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsConjunction_Ingest(bb:flatbuffers.ByteBuffer, obj?:Conjunction_Ingest):Conjunction_Ingest {
 ...
 */
dataMode():Conjunction_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 122);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Conjunction_Ingest_dataMode_Enum.REAL;
}
...
static startConjunction_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Conjunction_Ingest_dataMode_Enum) {
  builder.addFieldInt8(59, dataMode, Conjunction_Ingest_dataMode_Enum.REAL);
}
...
static addOrigIdOnOrbit1(builder:flatbuffers.Builder, origIdOnOrbit1Offset:flatbuffers.Offset) {
  builder.addFieldOffset(66, origIdOnOrbit1Offset, 0);
}

static addOrigIdOnOrbit2(builder:flatbuffers.Builder, origIdOnOrbit2Offset:flatbuffers.Offset) {
  builder.addFieldOffset(67, origIdOnOrbit2Offset, 0);
}
...
unpack(): Conjunction_IngestT {
  return new Conjunction_IngestT(
    this.id(),
...
unpackTo(_o: Conjunction_IngestT): void {
  _o.id = this.id();
...
export class Conjunction_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public tags: (string)[] = [],
  public dataMode: Conjunction_Ingest_dataMode_Enum = Conjunction_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = Conjunction_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return Conjunction_Ingest.createConjunction_Ingest(builder,
    id,
