...
import { LinkStatus_Full_dataMode_Enum } from './link-status-full-data-mode-enum.js';


/**
 * /// Captures link status.
 */
export class LinkStatus_Full implements flatbuffers.IUnpackableObject<LinkStatus_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LinkStatus_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLinkStatus_Full(bb:flatbuffers.ByteBuffer, obj?:LinkStatus_Full):LinkStatus_Full {
  return (obj || new LinkStatus_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLinkStatus_Full(bb:flatbuffers.ByteBuffer, obj?:LinkStatus_Full):LinkStatus_Full {
...
dataMode():LinkStatus_Full_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : LinkStatus_Full_dataMode_Enum.REAL;
}
...
static startLinkStatus_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:LinkStatus_Full_dataMode_Enum) {
  builder.addFieldInt8(28, dataMode, LinkStatus_Full_dataMode_Enum.REAL);
}
...
unpack(): LinkStatus_FullT {
  return new LinkStatus_FullT(
    this.id(),
...
unpackTo(_o: LinkStatus_FullT): void {
  _o.id = this.id();
...
export class LinkStatus_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: LinkStatus_Full_dataMode_Enum = LinkStatus_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return LinkStatus_Full.createLinkStatus_Full(builder,
    id,
