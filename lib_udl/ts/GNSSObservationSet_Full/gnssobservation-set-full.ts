...
import { GNSSObservationSet_Full_dataMode_Enum } from './gnssobservation-set-full-data-mode-enum.js';


/**
 * /// Set of GNSSObservation data.
 */
export class GNSSObservationSet_Full implements flatbuffers.IUnpackableObject<GNSSObservationSet_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):GNSSObservationSet_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsGNSSObservationSet_Full(bb:flatbuffers.ByteBuffer, obj?:GNSSObservationSet_Full):GNSSObservationSet_Full {
  return (obj || new GNSSObservationSet_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsGNSSObservationSet_Full(bb:flatbuffers.ByteBuffer, obj?:GNSSObservationSet_Full):GNSSObservationSet_Full {
 ...
 */
dataMode():GNSSObservationSet_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 70);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : GNSSObservationSet_Full_dataMode_Enum.REAL;
}
...
static startGNSSObservationSet_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:GNSSObservationSet_Full_dataMode_Enum) {
  builder.addFieldInt8(33, dataMode, GNSSObservationSet_Full_dataMode_Enum.REAL);
}
...
unpack(): GNSSObservationSet_FullT {
  return new GNSSObservationSet_FullT(
    this.id(),
...
unpackTo(_o: GNSSObservationSet_FullT): void {
  _o.id = this.id();
...
export class GNSSObservationSet_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: GNSSObservationSet_Full_dataMode_Enum = GNSSObservationSet_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const boresight = GNSSObservationSet_Full.createBoresightVector(builder, builder.createObjectOffsetList(this.boresight));
  const quat = GNSSObservationSet_Full.createQuatVector(builder, builder.createObjectOffsetList(this.quat));
  const satVelocity = GNSSObservationSet_Full.createSatVelocityVector(builder, builder.createObjectOffsetList(this.satVelocity));
  const obsCodes = GNSSObservationSet_Full.createObsCodesVector(builder, builder.createObjectOffsetList(this.obsCodes));
  const navigationStatus = (this.navigationStatus !== null ? builder.createString(this.navigationStatus!) : 0);
  const srcTyps = GNSSObservationSet_Full.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = GNSSObservationSet_Full.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  const tags = GNSSObservationSet_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  const gnssObservationList = GNSSObservationSet_Full.createGnssObservationListVector(builder, builder.createObjectOffsetList(this.gnssObservationList));

  return GNSSObservationSet_Full.createGNSSObservationSet_Full(builder,
    id,
