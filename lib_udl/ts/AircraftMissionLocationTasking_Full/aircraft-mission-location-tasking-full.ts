 ...
 */
export class AircraftMissionLocationTasking_Full implements flatbuffers.IUnpackableObject<AircraftMissionLocationTasking_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AircraftMissionLocationTasking_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAircraftMissionLocationTasking_Full(bb:flatbuffers.ByteBuffer, obj?:AircraftMissionLocationTasking_Full):AircraftMissionLocationTasking_Full {
  return (obj || new AircraftMissionLocationTasking_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAircraftMissionLocationTasking_Full(bb:flatbuffers.ByteBuffer, obj?:AircraftMissionLocationTasking_Full):AircraftMissionLocationTasking_Full {
...
static startAircraftMissionLocationTasking_Full(builder:flatbuffers.Builder) {
...
static endAircraftMissionLocationTasking_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAircraftMissionLocationTasking_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRC');
}

static finishSizePrefixedAircraftMissionLocationTasking_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRC', true);
}

static createAircraftMissionLocationTasking_Full(builder:flatbuffers.Builder, startTimeOffset:flatbuffers.Offset, endTimeOffset:flatbuffers.Offset, msnLocNameOffset:flatbuffers.Offset, alt:number, airMsnPriOffset:flatbuffers.Offset, areaGeoRad:number, msnLocPtNameOffset:flatbuffers.Offset, msnLocPtLat:number, msnLocPtLon:number, msnLocPtBarTOffset:flatbuffers.Offset):flatbuffers.Offset {
  AircraftMissionLocationTasking_Full.startAircraftMissionLocationTasking_Full(builder);
...
unpack(): AircraftMissionLocationTasking_FullT {
  return new AircraftMissionLocationTasking_FullT(
    this.startTime(),
    this.endTime(),
    this.msnLocName(),
    this.alt(),
...
unpackTo(_o: AircraftMissionLocationTasking_FullT): void {
...
export class AircraftMissionLocationTasking_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AircraftMissionLocationTasking_Full.createAircraftMissionLocationTasking_Full(builder,
    startTime,
    endTime,
    msnLocName,
    this.alt,
