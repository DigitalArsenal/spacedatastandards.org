...
import { Item_Full_dataMode_Enum } from './Item_Full_dataMode_Enum.js';


/**
 * /// No description available.
 */
export class Item_Full implements flatbuffers.IUnpackableObject<Item_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Item_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsItem_Full(bb:flatbuffers.ByteBuffer, obj?:Item_Full):Item_Full {
  return (obj || new Item_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsItem_Full(bb:flatbuffers.ByteBuffer, obj?:Item_Full):Item_Full {
...
dataMode():Item_Full_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Item_Full_dataMode_Enum.REAL;
}

static startItem_Full(builder:flatbuffers.Builder) {
...
unpack(): Item_FullT {
  return new Item_FullT(
    ...
    this.airdrop(),
    this.tcn(),
    this.bb!.createScalarList<string>(this.hazCodes.bind(this), this.hazCodesLength()),
    this.netExpWt(),
    this.container(),
    this.bb!.createScalarList<string>(this.itemContains.bind(this), this.itemContainsLength()),
    this.numPalletPos(),
    this.dvCode(),
    this.notes(),
    ...
    this.accSystem(),
    this.accSysNotes(),
    this.bb!.createScalarList<string>(this.accSysKeys.bind(this), this.accSysKeysLength()),
    this.bb!.createScalarList<string>(this.accSysValues.bind(this), this.accSysValuesLength()),
    this.createdAt(),
    this.createdBy(),
    this.updatedAt(),
    this.updatedBy(),
...
unpackTo(_o: Item_FullT): void {
  ...
  _o.tcn = this.tcn();
  _o.hazCodes = this.bb!.createScalarList<string>(this.hazCodes.bind(this), this.hazCodesLength());
  _o.netExpWt = this.netExpWt();
  _o.container = this.container();
  _o.itemContains = this.bb!.createScalarList<string>(this.itemContains.bind(this), this.itemContainsLength());
  ...
  _o.accSysKeys = this.bb!.createScalarList<string>(this.accSysKeys.bind(this), this.accSysKeysLength());
  _o.accSysValues = this.bb!.createScalarList<string>(this.accSysValues.bind(this), this.accSysValuesLength());
...
export class Item_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Item_Full_dataMode_Enum = Item_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const hazCodes = Item_Full.createHazCodesVector(builder, builder.createObjectOffsetList(this.hazCodes));
  const itemContains = Item_Full.createItemContainsVector(builder, builder.createObjectOffsetList(this.itemContains));
  ...
  const keys = Item_Full.createKeysVector(builder, builder.createObjectOffsetList(this.keys));
  const values = Item_Full.createValuesVector(builder, builder.createObjectOffsetList(this.values));
  ...
  const accSysKeys = Item_Full.createAccSysKeysVector(builder, builder.createObjectOffsetList(this.accSysKeys));
  const accSysValues = Item_Full.createAccSysValuesVector(builder, builder.createObjectOffsetList(this.accSysValues));
  ...
  return Item_Full.createItem_Full(builder,
    id,
