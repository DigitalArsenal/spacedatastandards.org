...
import { Port_Ingest_dataMode_Enum } from './port-ingest-data-mode-enum.js';


/**
 * /// Properties and characteristics of a maritime port, which includes location, port identifiers, and remarks.
 */
export class Port_Ingest implements flatbuffers.IUnpackableObject<Port_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Port_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsPort_Ingest(bb:flatbuffers.ByteBuffer, obj?:Port_Ingest):Port_Ingest {
  return (obj || new Port_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsPort_Ingest(bb:flatbuffers.ByteBuffer, obj?:Port_Ingest):Port_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 64
 */
dataMode():Port_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 44);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Port_Ingest_dataMode_Enum.REAL;
}
...
static startPort_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Port_Ingest_dataMode_Enum) {
  builder.addFieldInt8(20, dataMode, Port_Ingest_dataMode_Enum.REAL);
}
...
export class Port_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Port_Ingest_dataMode_Enum = Port_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Port_Ingest.createPort_Ingest(builder,
    id,
