...
import { Hazard_Ingest_dataMode_Enum } from './Hazard_Ingest_dataMode_Enum.js';
 ...
 */
export class Hazard_Ingest implements flatbuffers.IUnpackableObject<Hazard_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Hazard_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsHazard_Ingest(bb:flatbuffers.ByteBuffer, obj?:Hazard_Ingest):Hazard_Ingest {
  return (obj || new Hazard_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsHazard_Ingest(bb:flatbuffers.ByteBuffer, obj?:Hazard_Ingest):Hazard_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Hazard_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 82);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Hazard_Ingest_dataMode_Enum.REAL;
}

static startHazard_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Hazard_Ingest_dataMode_Enum) {
  builder.addFieldInt8(39, dataMode, Hazard_Ingest_dataMode_Enum.REAL);
}

static endHazard_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishHazard_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'HAZA');
}

static finishSizePrefixedHazard_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'HAZA', true);
}

static createHazard_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, detectTypeOffset:flatbuffers.Offset, detectTimeOffset:flatbuffers.Offset, harmful:boolean, alarmsOffset:flatbuffers.Offset, alarmValuesOffset:flatbuffers.Offset, readingsOffset:flatbuffers.Offset, readingUnitsOffset:flatbuffers.Offset, readingValuesOffset:flatbuffers.Offset, matTypeOffset:flatbuffers.Offset, matClassOffset:flatbuffers.Offset, matNameOffset:flatbuffers.Offset, matCat:number, casRnOffset:flatbuffers.Offset, ppm:number, density:number, radCtrn:number, gBar:number, hBar:number, z:number, a:number, bottleIdOffset:flatbuffers.Offset, channelOffset:flatbuffers.Offset, duration:number, activity:number, dep:number, depCtrn:number, massFrac:number, dose:number, ctrnTime:number, doseRate:number, idPoiOffset:flatbuffers.Offset, idTrackOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:Hazard_Ingest_dataMode_Enum):flatbuffers.Offset {
  Hazard_Ingest.startHazard_Ingest(builder);
  Hazard_Ingest.addId(builder, idOffset);
  Hazard_Ingest.addClassificationMarking(builder, classificationMarkingOffset);
  Hazard_Ingest.addDetectType(builder, detectTypeOffset);
  Hazard_Ingest.addDetectTime(builder, detectTimeOffset);
  Hazard_Ingest.addHarmful(builder, harmful);
  Hazard_Ingest.addAlarms(builder, alarmsOffset);
  Hazard_Ingest.addAlarmValues(builder, alarmValuesOffset);
  Hazard_Ingest.addReadings(builder, readingsOffset);
  Hazard_Ingest.addReadingUnits(builder, readingUnitsOffset);
  Hazard_Ingest.addReadingValues(builder, readingValuesOffset);
  Hazard_Ingest.addMatType(builder, matTypeOffset);
  Hazard_Ingest.addMatClass(builder, matClassOffset);
  Hazard_Ingest.addMatName(builder, matNameOffset);
  Hazard_Ingest.addMatCat(builder, matCat);
  Hazard_Ingest.addCasRn(builder, casRnOffset);
  Hazard_Ingest.addPpm(builder, ppm);
  Hazard_Ingest.addDensity(builder, density);
  Hazard_Ingest.addRadCtrn(builder, radCtrn);
  Hazard_Ingest.addGBar(builder, gBar);
  Hazard_Ingest.addHBar(builder, hBar);
  Hazard_Ingest.addZ(builder, z);
  Hazard_Ingest.addA(builder, a);
  Hazard_Ingest.addBottleId(builder, bottleIdOffset);
  Hazard_Ingest.addChannel(builder, channelOffset);
  Hazard_Ingest.addDuration(builder, duration);
  Hazard_Ingest.addActivity(builder, activity);
  Hazard_Ingest.addDep(builder, dep);
  Hazard_Ingest.addDepCtrn(builder, depCtrn);
  Hazard_Ingest.addMassFrac(builder, massFrac);
  Hazard_Ingest.addDose(builder, dose);
  Hazard_Ingest.addCtrnTime(builder, ctrnTime);
  Hazard_Ingest.addDoseRate(builder, doseRate);
  Hazard_Ingest.addIdPoi(builder, idPoiOffset);
  Hazard_Ingest.addIdTrack(builder, idTrackOffset);
  Hazard_Ingest.addCreatedAt(builder, createdAtOffset);
  Hazard_Ingest.addCreatedBy(builder, createdByOffset);
  Hazard_Ingest.addSource(builder, sourceOffset);
  Hazard_Ingest.addOrigin(builder, originOffset);
  Hazard_Ingest.addOrigNetwork(builder, origNetworkOffset);
  Hazard_Ingest.addDataMode(builder, dataMode);
  return Hazard_Ingest.endHazard_Ingest(builder);
}

unpack(): Hazard_IngestT {
  return new Hazard_IngestT(
    this.id(),
    this.classificationMarking(),
    this.detectType(),
    this.detectTime(),
    this.harmful(),
    this.bb!.createScalarList<string>(this.alarms.bind(this), this.alarmsLength()),
    this.bb!.createScalarList<string>(this.alarmValues.bind(this), this.alarmValuesLength()),
    this.bb!.createScalarList<string>(this.readings.bind(this), this.readingsLength()),
    this.bb!.createScalarList<string>(this.readingUnits.bind(this), this.readingUnitsLength()),
    this.bb!.createScalarList<string>(this.readingValues.bind(this), this.readingValuesLength()),
    this.matType(),
    this.matClass(),
    this.matName(),
    this.matCat(),
...
unpackTo(_o: Hazard_IngestT): void {
  _o.id = this.id();
  _o.classificationMarking = this.classificationMarking();
  _o.detectType = this.detectType();
  _o.detectTime = this.detectTime();
  _o.harmful = this.harmful();
  _o.alarms = this.bb!.createScalarList<string>(this.alarms.bind(this), this.alarmsLength());
  _o.alarmValues = this.bb!.createScalarList<string>(this.alarmValues.bind(this), this.alarmValuesLength());
  _o.readings = this.bb!.createScalarList<string>(this.readings.bind(this), this.readingsLength());
  _o.readingUnits = this.bb!.createScalarList<string>(this.readingUnits.bind(this), this.readingUnitsLength());
  _o.readingValues = this.bb!.createScalarList<string>(this.readingValues.bind(this), this.readingValuesLength());
...
export class Hazard_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Hazard_Ingest_dataMode_Enum = Hazard_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const alarms = Hazard_Ingest.createAlarmsVector(builder, builder.createObjectOffsetList(this.alarms));
  const alarmValues = Hazard_Ingest.createAlarmValuesVector(builder, builder.createObjectOffsetList(this.alarmValues));
  const readings = Hazard_Ingest.createReadingsVector(builder, builder.createObjectOffsetList(this.readings));
  const readingUnits = Hazard_Ingest.createReadingUnitsVector(builder, builder.createObjectOffsetList(this.readingUnits));
  const readingValues = Hazard_Ingest.createReadingValuesVector(builder, builder.createObjectOffsetList(this.readingValues));
  ...
  return Hazard_Ingest.createHazard_Ingest(builder,
    id,
