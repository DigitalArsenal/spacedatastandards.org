...
import { ISRCollectionTaskings_Full_collectionType_Enum } from './isrcollection-taskings-full-collection-type-enum.js';
import { ISRCollectionTaskings_Full_type_Enum } from './isrcollection-taskings-full-type-enum.js';


/**
 * /// Individual taskings to complete the mission.
 */
export class ISRCollectionTaskings_Full implements flatbuffers.IUnpackableObject<ISRCollectionTaskings_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ISRCollectionTaskings_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsISRCollectionTaskings_Full(bb:flatbuffers.ByteBuffer, obj?:ISRCollectionTaskings_Full):ISRCollectionTaskings_Full {
  return (obj || new ISRCollectionTaskings_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsISRCollectionTaskings_Full(bb:flatbuffers.ByteBuffer, obj?:ISRCollectionTaskings_Full):ISRCollectionTaskings_Full {
 ...
 */
type():ISRCollectionTaskings_Full_type_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 6);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : ISRCollectionTaskings_Full_type_Enum.DELIBERATE;
}
 ...
 * Constraints: Minimum length = 1, Maximum length = 16
 */
collectionType():ISRCollectionTaskings_Full_collectionType_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : ISRCollectionTaskings_Full_collectionType_Enum.SIMULTANEOUS;
}
...
static startISRCollectionTaskings_Full(builder:flatbuffers.Builder) {
...
static addType(builder:flatbuffers.Builder, type:ISRCollectionTaskings_Full_type_Enum) {
  builder.addFieldInt8(1, type, ISRCollectionTaskings_Full_type_Enum.DELIBERATE);
}

static addCollectionType(builder:flatbuffers.Builder, collectionType:ISRCollectionTaskings_Full_collectionType_Enum) {
  builder.addFieldInt8(2, collectionType, ISRCollectionTaskings_Full_collectionType_Enum.SIMULTANEOUS);
}
...
unpack(): ISRCollectionTaskings_FullT {
  return new ISRCollectionTaskings_FullT(
    this.id(),
    this.type(),
    this.collectionType(),
    this.taskingAor(),
    ...
    this.bb!.createScalarList<string>(this.taskingCollectionRequirements.bind(this), this.taskingCollectionRequirements_Length())
  );
}


unpackTo(_o: ISRCollectionTaskings_FullT): void {
  _o.id = this.id();
  _o.type = this.type();
  ...
  _o.taskingCollectionRequirements = this.bb!.createScalarList<string>(this.taskingCollectionRequirements.bind(this), this.taskingCollectionRequirements_Length());
}
}

export class ISRCollectionTaskings_FullT implements flatbuffers.IGeneratedObject {
constructor(
  public id: string|Uint8Array|null = null,
  public type: ISRCollectionTaskings_Full_type_Enum = ISRCollectionTaskings_Full_type_Enum.DELIBERATE,
  public collectionType: ISRCollectionTaskings_Full_collectionType_Enum = ISRCollectionTaskings_Full_collectionType_Enum.SIMULTANEOUS,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const taskingCollectionRequirements = ISRCollectionTaskings_Full.createTaskingCollectionRequirementsVector(builder, builder.createObjectOffsetList(this.taskingCollectionRequirements));

  return ISRCollectionTaskings_Full.createISRCollectionTaskings_Full(builder,
    id,
    this.type,
    this.collectionType,
    taskingAOR,
