...
import { Airfield_Full_dataMode_Enum } from './airfield-full-data-mode-enum.js';


/**
 * /// Properties and characteristics of an airfield, which includes location, airfield codes, suitability codes, and remarks.
 */
export class Airfield_Full implements flatbuffers.IUnpackableObject<Airfield_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Airfield_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirfield_Full(bb:flatbuffers.ByteBuffer, obj?:Airfield_Full):Airfield_Full {
  return (obj || new Airfield_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirfield_Full(bb:flatbuffers.ByteBuffer, obj?:Airfield_Full):Airfield_Full {
...
dataMode():Airfield_Full_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Airfield_Full_dataMode_Enum.REAL;
}

static startAirfield_Full(builder:flatbuffers.Builder) {
...
static addUpdatedAt(builder:flatbuffers.Builder, updatedAtOffset:flatbuffers.Offset) {
  builder.addFieldOffset(30, updatedAtOffset, 0);
}

static addUpdatedBy(builder:flatbuffers.Builder, updatedByOffset:flatbuffers.Offset) {
  builder.addFieldOffset(31, updatedByOffset, 0);
}
...
unpack(): Airfield_FullT {
  return new Airfield_FullT(
    this.id(),
...
unpackTo(_o: Airfield_FullT): void {
  _o.id = this.id();
...
export class Airfield_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Airfield_Full_dataMode_Enum = Airfield_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Airfield_Full.createAirfield_Full(builder,
    id,
