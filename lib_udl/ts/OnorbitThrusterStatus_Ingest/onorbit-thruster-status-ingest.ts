...
import { OnorbitThrusterStatus_Ingest_dataMode_Enum } from './onorbit-thruster-status-ingest-data-mode-enum.js';


/**
 * /// Status information for OnorbitThruster objects.
 */
export class OnorbitThrusterStatus_Ingest implements flatbuffers.IUnpackableObject<OnorbitThrusterStatus_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OnorbitThrusterStatus_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOnorbitThrusterStatus_Ingest(bb:flatbuffers.ByteBuffer, obj?:OnorbitThrusterStatus_Ingest):OnorbitThrusterStatus_Ingest {
  return (obj || new OnorbitThrusterStatus_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOnorbitThrusterStatus_Ingest(bb:flatbuffers.ByteBuffer, obj?:OnorbitThrusterStatus_Ingest):OnorbitThrusterStatus_Ingest {
 ...
 */
dataMode():OnorbitThrusterStatus_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 50);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OnorbitThrusterStatus_Ingest_dataMode_Enum.REAL;
}

static startOnorbitThrusterStatus_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:OnorbitThrusterStatus_Ingest_dataMode_Enum) {
  builder.addFieldInt8(23, dataMode, OnorbitThrusterStatus_Ingest_dataMode_Enum.REAL);
}

static endOnorbitThrusterStatus_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishOnorbitThrusterStatus_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ONOR');
}

static finishSizePrefixedOnorbitThrusterStatus_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ONOR', true);
}

static createOnorbitThrusterStatus_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idOnorbitThrusterOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, statusTimeOffset:flatbuffers.Offset, propMassMin:number, propMassAvg:number, propMassMedian:number, propMassMax:number, fuelMass:number, fuelMassUnc:number, totalDeltaV:number, minDeltaV:number, estDeltaV:number, maxDeltaV:number, thrustMax:number, isp:number, operational:boolean, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:OnorbitThrusterStatus_Ingest_dataMode_Enum):flatbuffers.Offset {
  OnorbitThrusterStatus_Ingest.startOnorbitThrusterStatus_Ingest(builder);
...
unpack(): OnorbitThrusterStatus_IngestT {
  return new OnorbitThrusterStatus_IngestT(
    this.id(),
...
unpackTo(_o: OnorbitThrusterStatus_IngestT): void {
  _o.id = this.id();
...
export class OnorbitThrusterStatus_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: OnorbitThrusterStatus_Ingest_dataMode_Enum = OnorbitThrusterStatus_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return OnorbitThrusterStatus_Ingest.createOnorbitThrusterStatus_Ingest(builder,
    id,
