...
import { PassiveRadarObservation_Ingest_dataMode_Enum } from './passive-radar-observation-ingest-data-mode-enum.js';
 ...
 */
export class PassiveRadarObservation_Ingest implements flatbuffers.IUnpackableObject<PassiveRadarObservation_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):PassiveRadarObservation_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsPassiveRadarObservation_Ingest(bb:flatbuffers.ByteBuffer, obj?:PassiveRadarObservation_Ingest):PassiveRadarObservation_Ingest {
  return (obj || new PassiveRadarObservation_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsPassiveRadarObservation_Ingest(bb:flatbuffers.ByteBuffer, obj?:PassiveRadarObservation_Ingest):PassiveRadarObservation_Ingest {
...
dataMode():PassiveRadarObservation_Ingest_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : PassiveRadarObservation_Ingest_dataMode_Enum.REAL;
}
...
static startPassiveRadarObservation_Ingest(builder:flatbuffers.Builder) {
...
unpack(): PassiveRadarObservation_IngestT {
  return new PassiveRadarObservation_IngestT(
    this.id(),
...
unpackTo(_o: PassiveRadarObservation_IngestT): void {
  _o.id = this.id();
...
export class PassiveRadarObservation_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: PassiveRadarObservation_Ingest_dataMode_Enum = PassiveRadarObservation_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = PassiveRadarObservation_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return PassiveRadarObservation_Ingest.createPassiveRadarObservation_Ingest(builder,
    id,
