...
import { EngineDetails_Ingest_dataMode_Enum } from './engine-details-ingest-data-mode-enum.js';
 ...
 */
export class EngineDetails_Ingest implements flatbuffers.IUnpackableObject<EngineDetails_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EngineDetails_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEngineDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:EngineDetails_Ingest):EngineDetails_Ingest {
  return (obj || new EngineDetails_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEngineDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:EngineDetails_Ingest):EngineDetails_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():EngineDetails_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 48);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : EngineDetails_Ingest_dataMode_Enum.REAL;
}
...
static startEngineDetails_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:EngineDetails_Ingest_dataMode_Enum) {
  builder.addFieldInt8(22, dataMode, EngineDetails_Ingest_dataMode_Enum.REAL);
}
...
unpack(): EngineDetails_IngestT {
  return new EngineDetails_IngestT(
    this.id(),
    this.idEngine(),
...
unpackTo(_o: EngineDetails_IngestT): void {
  _o.id = this.id();
...
export class EngineDetails_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: EngineDetails_Ingest_dataMode_Enum = EngineDetails_Ingest_dataMode_Enum.REAL,
  public tags: (string)[] = []
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = EngineDetails_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));

  return EngineDetails_Ingest.createEngineDetails_Ingest(builder,
    id,
    idEngine,
