...
import { AirspaceControlMeans_Full_cmShape_Enum } from './AirspaceControlMeans_Full_cmShape_Enum.js';


/**
 * /// A conditional nested segment to report multiple airspace control means within a particular airspace control means status.
 */
export class AirspaceControlMeans_Full implements flatbuffers.IUnpackableObject<AirspaceControlMeans_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirspaceControlMeans_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirspaceControlMeans_Full(bb:flatbuffers.ByteBuffer, obj?:AirspaceControlMeans_Full):AirspaceControlMeans_Full {
  return (obj || new AirspaceControlMeans_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirspaceControlMeans_Full(bb:flatbuffers.ByteBuffer, obj?:AirspaceControlMeans_Full):AirspaceControlMeans_Full {
 ...
 * Constraints: Minimum length = 0, Maximum length = 8
 */
cmShape():AirspaceControlMeans_Full_cmShape_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirspaceControlMeans_Full_cmShape_Enum.POLYARC;
}
...
static startAirspaceControlMeans_Full(builder:flatbuffers.Builder) {
...
static addCmShape(builder:flatbuffers.Builder, cmShape:AirspaceControlMeans_Full_cmShape_Enum) {
  builder.addFieldInt8(2, cmShape, AirspaceControlMeans_Full_cmShape_Enum.POLYARC);
}
...
static endAirspaceControlMeans_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirspaceControlMeans_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRS');
}

static finishSizePrefixedAirspaceControlMeans_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRS', true);
}

static createAirspaceControlMeans_Full(builder:flatbuffers.Builder, cmTypeOffset:flatbuffers.Offset, cmIdOffset:flatbuffers.Offset, cmShape:AirspaceControlMeans_Full_cmShape_Enum, usageOffset:flatbuffers.Offset, link16IdOffset:flatbuffers.Offset, transAltitudeOffset:flatbuffers.Offset, geoDatumAltOffset:flatbuffers.Offset, coord0Offset:flatbuffers.Offset, coord1Offset:flatbuffers.Offset, bearing0:number, bearing1:number, radMag0:number, radMag1:number, radMagUnitOffset:flatbuffers.Offset, polyCoordOffset:flatbuffers.Offset, trackLeg:number, widthLeft:number, widthRight:number, width:number, widthUnitOffset:flatbuffers.Offset, corrWayPointsOffset:flatbuffers.Offset, orbitAlignmentOffset:flatbuffers.Offset, effVdimOffset:flatbuffers.Offset, airspaceTimePeriodOffset:flatbuffers.Offset, airspaceControlPointOffset:flatbuffers.Offset, ctrlAuthOffset:flatbuffers.Offset, ctrlAuthFreqsOffset:flatbuffers.Offset, genTextIndOffset:flatbuffers.Offset, freeTextOffset:flatbuffers.Offset):flatbuffers.Offset {
  AirspaceControlMeans_Full.startAirspaceControlMeans_Full(builder);
...
unpack(): AirspaceControlMeans_FullT {
  return new AirspaceControlMeans_FullT(
    this.cmType(),
    this.cmId(),
    this.cmShape(),
    this.usage(),
...
unpackTo(_o: AirspaceControlMeans_FullT): void {
...
export class AirspaceControlMeans_FullT implements flatbuffers.IGeneratedObject {
constructor(
  public cmType: string|Uint8Array|null = null,
  public cmId: string|Uint8Array|null = null,
  public cmShape: AirspaceControlMeans_Full_cmShape_Enum = AirspaceControlMeans_Full_cmShape_Enum.POLYARC,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const polyCoord = AirspaceControlMeans_Full.createPolyCoordVector(builder, builder.createObjectOffsetList(this.polyCoord));
  const widthUnit = (this.widthUnit !== null ? builder.createString(this.widthUnit!) : 0);
  const corrWayPoints = AirspaceControlMeans_Full.createCorrWayPointsVector(builder, builder.createObjectOffsetList(this.corrWayPoints));
  ...
  const airspaceTimePeriod = AirspaceControlMeans_Full.createAirspaceTimePeriodVector(builder, builder.createObjectOffsetList(this.airspaceTimePeriod));
  const airspaceControlPoint = AirspaceControlMeans_Full.createAirspaceControlPointVector(builder, builder.createObjectOffsetList(this.airspaceControlPoint));
  const ctrlAuth = (this.ctrlAuth !== null ? builder.createString(this.ctrlAuth!) : 0);
  const ctrlAuthFreqs = AirspaceControlMeans_Full.createCtrlAuthFreqsVector(builder, builder.createObjectOffsetList(this.ctrlAuthFreqs));
  ...
  return AirspaceControlMeans_Full.createAirspaceControlMeans_Full(builder,
    cmType,
    cmId,
    this.cmShape,
    usage,
