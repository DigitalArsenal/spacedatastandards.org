 ...
 */
export class AirEventTankers_Ingest implements flatbuffers.IUnpackableObject<AirEventTankers_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirEventTankers_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirEventTankers_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirEventTankers_Ingest):AirEventTankers_Ingest {
  return (obj || new AirEventTankers_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirEventTankers_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirEventTankers_Ingest):AirEventTankers_Ingest {
...
static startAirEventTankers_Ingest(builder:flatbuffers.Builder) {
...
unpack(): AirEventTankers_IngestT {
  return new AirEventTankers_IngestT(
    this.idTankerSortie(),
...
unpackTo(_o: AirEventTankers_IngestT): void {
...
export class AirEventTankers_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AirEventTankers_Ingest.createAirEventTankers_Ingest(builder,
    idTankerSortie,
    idTankerMission,
    idTankerAirfield,
    externalTankerId,
