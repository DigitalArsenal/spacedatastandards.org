 ...
 */
export class AircraftMissionTasking_Full implements flatbuffers.IUnpackableObject<AircraftMissionTasking_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AircraftMissionTasking_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAircraftMissionTasking_Full(bb:flatbuffers.ByteBuffer, obj?:AircraftMissionTasking_Full):AircraftMissionTasking_Full {
  return (obj || new AircraftMissionTasking_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAircraftMissionTasking_Full(bb:flatbuffers.ByteBuffer, obj?:AircraftMissionTasking_Full):AircraftMissionTasking_Full {
...
static startAircraftMissionTasking_Full(builder:flatbuffers.Builder) {
...
unpack(): AircraftMissionTasking_FullT {
  return new AircraftMissionTasking_FullT(
    this.countryCode(),
    this.taskedService(),
    this.unitDesignator(),
    this.unitLocName(),
...
unpackTo(_o: AircraftMissionTasking_FullT): void {
...
export class AircraftMissionTasking_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const rcvyLocName = AircraftMissionTasking_Full.createRcvyLocNameVector(builder, builder.createObjectOffsetList(this.rcvyLocName));
  const rcvyLocUtm = AircraftMissionTasking_Full.createRcvyLocUtmVector(builder, builder.createObjectOffsetList(this.rcvyLocUtm));
  const rcvyLocLat = AircraftMissionTasking_Full.createRcvyLocLatVector(builder, builder.createObjectOffsetList(this.rcvyLocLat));
  const rcvyLocLon = AircraftMissionTasking_Full.createRcvyLocLonVector(builder, builder.createObjectOffsetList(this.rcvyLocLon));
  const rcvyTime = AircraftMissionTasking_Full.createRcvyTimeVector(builder, builder.createObjectOffsetList(this.rcvyTime));
  const indActasking = AircraftMissionTasking_Full.createIndActaskingVector(builder, builder.createObjectOffsetList(this.indActasking));
  const acMsnLocSeg = AircraftMissionTasking_Full.createAcMsnLocSegVector(builder, builder.createObjectOffsetList(this.acMsnLocSeg));

  return AircraftMissionTasking_Full.createAircraftMissionTasking_Full(builder,
    countryCode,
    taskedService,
    unitDesignator,
    unitLocName,
