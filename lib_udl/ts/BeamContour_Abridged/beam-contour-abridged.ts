...
import { BeamContour_Abridged_dataMode_Enum } from './beam-contour-abridged-data-mode-enum.js';
import { BeamContour_Abridged_type_Enum } from './beam-contour-abridged-type-enum.js';
 ...
 */
export class BeamContour_Abridged implements flatbuffers.IUnpackableObject<BeamContour_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):BeamContour_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsBeamContour_Abridged(bb:flatbuffers.ByteBuffer, obj?:BeamContour_Abridged):BeamContour_Abridged {
  return (obj || new BeamContour_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsBeamContour_Abridged(bb:flatbuffers.ByteBuffer, obj?:BeamContour_Abridged):BeamContour_Abridged {
 ...
 */
type():BeamContour_Abridged_type_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 10);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : BeamContour_Abridged_type_Enum.BORESIGHT;
}
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():BeamContour_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 38);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : BeamContour_Abridged_dataMode_Enum.REAL;
}

static startBeamContour_Abridged(builder:flatbuffers.Builder) {
...
static addType(builder:flatbuffers.Builder, type:BeamContour_Abridged_type_Enum) {
  builder.addFieldInt8(3, type, BeamContour_Abridged_type_Enum.BORESIGHT);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:BeamContour_Abridged_dataMode_Enum) {
  builder.addFieldInt8(17, dataMode, BeamContour_Abridged_dataMode_Enum.REAL);
}

static endBeamContour_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishBeamContour_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'BEAM');
}

static finishSizePrefixedBeamContour_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'BEAM', true);
}

static createBeamContour_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idBeamOffset:flatbuffers.Offset, type:BeamContour_Abridged_type_Enum, contourIdx:number, gain:number, regionNameOffset:flatbuffers.Offset, geographyTextOffset:flatbuffers.Offset, geographyJsonOffset:flatbuffers.Offset, geographyTypeOffset:flatbuffers.Offset, geographyNdims:number, geographySrid:number, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:BeamContour_Abridged_dataMode_Enum):flatbuffers.Offset {
  BeamContour_Abridged.startBeamContour_Abridged(builder);
...
unpack(): BeamContour_AbridgedT {
  return new BeamContour_AbridgedT(
    this.id(),
...
unpackTo(_o: BeamContour_AbridgedT): void {
  _o.id = this.id();
...
export class BeamContour_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  public id: string|Uint8Array|null = null,
  public classificationMarking: string|Uint8Array|null = null,
  public idBeam: string|Uint8Array|null = null,
  public type: BeamContour_Abridged_type_Enum = BeamContour_Abridged_type_Enum.BORESIGHT,
  ...
  public dataMode: BeamContour_Abridged_dataMode_Enum = BeamContour_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return BeamContour_Abridged.createBeamContour_Abridged(builder,
    id,
