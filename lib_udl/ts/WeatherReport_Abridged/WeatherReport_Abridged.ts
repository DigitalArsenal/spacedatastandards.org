...
import { WeatherReport_Abridged_dataMode_Enum } from './WeatherReport_Abridged_dataMode_Enum.js';
 ...
 */
export class WeatherReport_Abridged implements flatbuffers.IUnpackableObject<WeatherReport_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):WeatherReport_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsWeatherReport_Abridged(bb:flatbuffers.ByteBuffer, obj?:WeatherReport_Abridged):WeatherReport_Abridged {
  return (obj || new WeatherReport_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsWeatherReport_Abridged(bb:flatbuffers.ByteBuffer, obj?:WeatherReport_Abridged):WeatherReport_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():WeatherReport_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 172);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : WeatherReport_Abridged_dataMode_Enum.REAL;
}

static startWeatherReport_Abridged(builder:flatbuffers.Builder) {
...
static addCloudCover(builder:flatbuffers.Builder, cloudCoverOffset:flatbuffers.Offset) {
  builder.addFieldOffset(45, cloudCoverOffset, 0);
}
...
static addCloudHght(builder:flatbuffers.Builder, cloudHghtOffset:flatbuffers.Offset) {
  builder.addFieldOffset(46, cloudHghtOffset, 0);
}
...
static addSrcIds(builder:flatbuffers.Builder, srcIdsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(78, srcIdsOffset, 0);
}
...
unpack(): WeatherReport_AbridgedT {
  return new WeatherReport_AbridgedT(
    this.id(),
...
unpackTo(_o: WeatherReport_AbridgedT): void {
  _o.id = this.id();
...
export class WeatherReport_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: WeatherReport_Abridged_dataMode_Enum = WeatherReport_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const windCov = WeatherReport_Abridged.createWindCovVector(builder, builder.createObjectOffsetList(this.windCov));
  const cloudCover = WeatherReport_Abridged.createCloudCoverVector(builder, builder.createObjectOffsetList(this.cloudCover));
  const cloudHght = WeatherReport_Abridged.createCloudHghtVector(builder, builder.createObjectOffsetList(this.cloudHght));
  ...
  const srcTyps = WeatherReport_Abridged.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = WeatherReport_Abridged.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  ...
  return WeatherReport_Abridged.createWeatherReport_Abridged(builder,
    id,
