 ...
 */
export class ISRCollectionPOC_Full implements flatbuffers.IUnpackableObject<ISRCollectionPOC_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ISRCollectionPOC_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsISRCollectionPOC_Full(bb:flatbuffers.ByteBuffer, obj?:ISRCollectionPOC_Full):ISRCollectionPOC_Full {
  return (obj || new ISRCollectionPOC_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsISRCollectionPOC_Full(bb:flatbuffers.ByteBuffer, obj?:ISRCollectionPOC_Full):ISRCollectionPOC_Full {
...
static startISRCollectionPOC_Full(builder:flatbuffers.Builder) {
...
static endISRCollectionPOC_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishISRCollectionPOC_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ISRC');
}

static finishSizePrefixedISRCollectionPOC_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ISRC', true);
}

static createISRCollectionPOC_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, callsignOffset:flatbuffers.Offset, unitOffset:flatbuffers.Offset, emailOffset:flatbuffers.Offset, phoneOffset:flatbuffers.Offset, radioFrequency:number, chatSystemOffset:flatbuffers.Offset, chatNameOffset:flatbuffers.Offset, notesOffset:flatbuffers.Offset):flatbuffers.Offset {
  ISRCollectionPOC_Full.startISRCollectionPOC_Full(builder);
...
unpack(): ISRCollectionPOC_FullT {
  return new ISRCollectionPOC_FullT(
    this.id(),
    this.name(),
    this.callsign(),
    this.unit(),
...
unpackTo(_o: ISRCollectionPOC_FullT): void {
  _o.id = this.id();
  _o.name = this.name();
...
export class ISRCollectionPOC_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return ISRCollectionPOC_Full.createISRCollectionPOC_Full(builder,
    id,
    name,
    callsign,
    unit,
