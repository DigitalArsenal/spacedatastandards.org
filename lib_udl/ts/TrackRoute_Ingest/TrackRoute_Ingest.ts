...
import { TrackRoute_Ingest_dataMode_Enum } from './TrackRoute_Ingest_dataMode_Enum.js';


/**
 * /// A track route is a prescribed route for performing training events or operations such as air refueling.
 */
export class TrackRoute_Ingest implements flatbuffers.IUnpackableObject<TrackRoute_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):TrackRoute_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsTrackRoute_Ingest(bb:flatbuffers.ByteBuffer, obj?:TrackRoute_Ingest):TrackRoute_Ingest {
  return (obj || new TrackRoute_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTrackRoute_Ingest(bb:flatbuffers.ByteBuffer, obj?:TrackRoute_Ingest):TrackRoute_Ingest {
 ...
 */
dataMode():TrackRoute_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 78);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : TrackRoute_Ingest_dataMode_Enum.REAL;
}

static startTrackRoute_Ingest(builder:flatbuffers.Builder) {
...
unpack(): TrackRoute_IngestT {
  return new TrackRoute_IngestT(
    this.id(),
...
unpackTo(_o: TrackRoute_IngestT): void {
  _o.id = this.id();
...
export class TrackRoute_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: TrackRoute_Ingest_dataMode_Enum = TrackRoute_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const routePoints = TrackRoute_Ingest.createRoutePointsVector(builder, builder.createObjectOffsetList(this.routePoints));
  const altitudeBlocks = TrackRoute_Ingest.createAltitudeBlocksVector(builder, builder.createObjectOffsetList(this.altitudeBlocks));
  const poc = TrackRoute_Ingest.createPocVector(builder, builder.createObjectOffsetList(this.poc));
  ...
  return TrackRoute_Ingest.createTrackRoute_Ingest(builder,
    id,
