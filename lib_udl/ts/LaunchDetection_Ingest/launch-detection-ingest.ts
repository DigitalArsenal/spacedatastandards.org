...
import { LaunchDetection_Ingest_dataMode_Enum } from './launch-detection-ingest-data-mode-enum.js';


/**
 * /// Data to analyze launch detections.
 */
export class LaunchDetection_Ingest implements flatbuffers.IUnpackableObject<LaunchDetection_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LaunchDetection_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLaunchDetection_Ingest(bb:flatbuffers.ByteBuffer, obj?:LaunchDetection_Ingest):LaunchDetection_Ingest {
  return (obj || new LaunchDetection_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLaunchDetection_Ingest(bb:flatbuffers.ByteBuffer, obj?:LaunchDetection_Ingest):LaunchDetection_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():LaunchDetection_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 48);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : LaunchDetection_Ingest_dataMode_Enum.REAL;
}
...
static startLaunchDetection_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:LaunchDetection_Ingest_dataMode_Enum) {
  builder.addFieldInt8(22, dataMode, LaunchDetection_Ingest_dataMode_Enum.REAL);
}
...
static endLaunchDetection_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishLaunchDetection_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'LAUN');
}

static finishSizePrefixedLaunchDetection_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'LAUN', true);
}

static createLaunchDetection_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, launchTimeOffset:flatbuffers.Offset, messageTypeOffset:flatbuffers.Offset, launchLatitude:number, launchLongitude:number, launchAzimuth:number, raan:number, inclination:number, observationTimeOffset:flatbuffers.Offset, observationLatitude:number, observationLongitude:number, observationAltitude:number, stereoFlag:boolean, highZenithAzimuth:boolean, sequenceNumber:number, eventIdOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, descriptorOffset:flatbuffers.Offset, tagsOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:LaunchDetection_Ingest_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset):flatbuffers.Offset {
  LaunchDetection_Ingest.startLaunchDetection_Ingest(builder);
...
unpack(): LaunchDetection_IngestT {
  return new LaunchDetection_IngestT(
    this.id(),
...
unpackTo(_o: LaunchDetection_IngestT): void {
  _o.id = this.id();
...
export class LaunchDetection_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: LaunchDetection_Ingest_dataMode_Enum = LaunchDetection_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = LaunchDetection_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return LaunchDetection_Ingest.createLaunchDetection_Ingest(builder,
    id,
