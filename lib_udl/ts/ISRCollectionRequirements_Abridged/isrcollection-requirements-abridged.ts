 ...
 */
export class ISRCollectionRequirements_Abridged implements flatbuffers.IUnpackableObject<ISRCollectionRequirements_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ISRCollectionRequirements_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsISRCollectionRequirements_Abridged(bb:flatbuffers.ByteBuffer, obj?:ISRCollectionRequirements_Abridged):ISRCollectionRequirements_Abridged {
  return (obj || new ISRCollectionRequirements_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsISRCollectionRequirements_Abridged(bb:flatbuffers.ByteBuffer, obj?:ISRCollectionRequirements_Abridged):ISRCollectionRequirements_Abridged {
...
static startISRCollectionRequirements_Abridged(builder:flatbuffers.Builder) {
...
static endISRCollectionRequirements_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishISRCollectionRequirements_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ISRC');
}

static finishSizePrefixedISRCollectionRequirements_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ISRC', true);
}

static createISRCollectionRequirements_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, hashOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, cridNumbersOffset:flatbuffers.Offset, priority:number, recordIdOffset:flatbuffers.Offset, reconSurveyOffset:flatbuffers.Offset, intelDisciplineOffset:flatbuffers.Offset, secondary:boolean, emphasized:boolean, isPrismCr:boolean, startOffset:flatbuffers.Offset, stopOffset:flatbuffers.Offset, operationOffset:flatbuffers.Offset, supportedUnitOffset:flatbuffers.Offset, countryOffset:flatbuffers.Offset, regionOffset:flatbuffers.Offset, subregionOffset:flatbuffers.Offset, specialComGuidanceOffset:flatbuffers.Offset, criticalTimesOffset:flatbuffers.Offset, exploitationRequirementOffset:flatbuffers.Offset, targetListOffset:flatbuffers.Offset):flatbuffers.Offset {
  ISRCollectionRequirements_Abridged.startISRCollectionRequirements_Abridged(builder);
...
unpack(): ISRCollectionRequirements_AbridgedT {
  return new ISRCollectionRequirements_AbridgedT(
    this.id(),
    this.hash(),
    this.type(),
    this.cridNumbers(),
    ...
    this.bb!.createScalarList<string>(this.targetList.bind(this), this.targetList_Length())
  );
}


unpackTo(_o: ISRCollectionRequirements_AbridgedT): void {
  _o.id = this.id();
  _o.hash = this.hash();
  _o.type = this.type();
  ...
  _o.targetList = this.bb!.createScalarList<string>(this.targetList.bind(this), this.targetList_Length());
}
}

export class ISRCollectionRequirements_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const targetList = ISRCollectionRequirements_Abridged.createTargetListVector(builder, builder.createObjectOffsetList(this.targetList));

  return ISRCollectionRequirements_Abridged.createISRCollectionRequirements_Abridged(builder,
    id,
    hash,
    type,
    cridNumbers,
