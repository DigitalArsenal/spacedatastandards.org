...
import { VideoStreams_Ingest_dataMode_Enum } from './video-streams-ingest-data-mode-enum.js';


/**
 * /// The table captures metadata associated with the published videos in UDL.
 */
export class VideoStreams_Ingest implements flatbuffers.IUnpackableObject<VideoStreams_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):VideoStreams_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsVideoStreams_Ingest(bb:flatbuffers.ByteBuffer, obj?:VideoStreams_Ingest):VideoStreams_Ingest {
  return (obj || new VideoStreams_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsVideoStreams_Ingest(bb:flatbuffers.ByteBuffer, obj?:VideoStreams_Ingest):VideoStreams_Ingest {
 ...
 */
dataMode():VideoStreams_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 22);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : VideoStreams_Ingest_dataMode_Enum.REAL;
}
...
static startVideoStreams_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:VideoStreams_Ingest_dataMode_Enum) {
  builder.addFieldInt8(9, dataMode, VideoStreams_Ingest_dataMode_Enum.REAL);
}
...
static endVideoStreams_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishVideoStreams_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'VIDE');
}

static finishSizePrefixedVideoStreams_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'VIDE', true);
}

static createVideoStreams_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, descriptionOffset:flatbuffers.Offset, startTimeOffset:flatbuffers.Offset, stopTimeOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, tokenValueOffset:flatbuffers.Offset, videoUrlsOffset:flatbuffers.Offset, dataMode:VideoStreams_Ingest_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset):flatbuffers.Offset {
  VideoStreams_Ingest.startVideoStreams_Ingest(builder);
...
unpack(): VideoStreams_IngestT {
  return new VideoStreams_IngestT(
    this.id(),
...
unpackTo(_o: VideoStreams_IngestT): void {
  _o.id = this.id();
...
export class VideoStreams_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: VideoStreams_Ingest_dataMode_Enum = VideoStreams_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const videoUrls = VideoStreams_Ingest.createVideoUrlsVector(builder, builder.createObjectOffsetList(this.videoUrls));
  const createdAt = (this.createdAt !== null ? builder.createString(this.createdAt!) : 0);
  const createdBy = (this.createdBy !== null ? builder.createString(this.createdBy!) : 0);
  const origNetwork = (this.origNetwork !== null ? builder.createString(this.origNetwork!) : 0);
  const origin = (this.origin !== null ? builder.createString(this.origin!) : 0);

  return VideoStreams_Ingest.createVideoStreams_Ingest(builder,
    id,
