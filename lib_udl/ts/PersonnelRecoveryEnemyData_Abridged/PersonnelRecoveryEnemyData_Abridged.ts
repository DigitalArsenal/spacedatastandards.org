 ...
 */
export class PersonnelRecoveryEnemyData_Abridged implements flatbuffers.IUnpackableObject<PersonnelRecoveryEnemyData_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):PersonnelRecoveryEnemyData_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsPersonnelRecoveryEnemyData_Abridged(bb:flatbuffers.ByteBuffer, obj?:PersonnelRecoveryEnemyData_Abridged):PersonnelRecoveryEnemyData_Abridged {
  return (obj || new PersonnelRecoveryEnemyData_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsPersonnelRecoveryEnemyData_Abridged(bb:flatbuffers.ByteBuffer, obj?:PersonnelRecoveryEnemyData_Abridged):PersonnelRecoveryEnemyData_Abridged {
...
static startPersonnelRecoveryEnemyData_Abridged(builder:flatbuffers.Builder) {
...
static endPersonnelRecoveryEnemyData_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishPersonnelRecoveryEnemyData_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'PERS');
}

static finishSizePrefixedPersonnelRecoveryEnemyData_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'PERS', true);
}

static createPersonnelRecoveryEnemyData_Abridged(builder:flatbuffers.Builder, dirToEnemyOffset:flatbuffers.Offset, hostileFireTypeOffset:flatbuffers.Offset, friendliesRemarksOffset:flatbuffers.Offset, hlzRemarksOffset:flatbuffers.Offset):flatbuffers.Offset {
  PersonnelRecoveryEnemyData_Abridged.startPersonnelRecoveryEnemyData_Abridged(builder);
...
unpack(): PersonnelRecoveryEnemyData_AbridgedT {
  return new PersonnelRecoveryEnemyData_AbridgedT(
    this.dirToEnemy(),
...
unpackTo(_o: PersonnelRecoveryEnemyData_AbridgedT): void {
...
export class PersonnelRecoveryEnemyData_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return PersonnelRecoveryEnemyData_Abridged.createPersonnelRecoveryEnemyData_Abridged(builder,
    dirToEnemy,
    hostileFireType,
    friendliesRemarks,
    hlzRemarks
