...
import { ObjectOfInterest_Abridged_dataMode_Enum } from './ObjectOfInterest_Abridged_dataMode_Enum.js';


/**
 * /// OnOrbit objects of interest, which include information about the last known state of the object.
 */
export class ObjectOfInterest_Abridged implements flatbuffers.IUnpackableObject<ObjectOfInterest_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ObjectOfInterest_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsObjectOfInterest_Abridged(bb:flatbuffers.ByteBuffer, obj?:ObjectOfInterest_Abridged):ObjectOfInterest_Abridged {
  return (obj || new ObjectOfInterest_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsObjectOfInterest_Abridged(bb:flatbuffers.ByteBuffer, obj?:ObjectOfInterest_Abridged):ObjectOfInterest_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():ObjectOfInterest_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 88);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : ObjectOfInterest_Abridged_dataMode_Enum.REAL;
}

static startObjectOfInterest_Abridged(builder:flatbuffers.Builder) {
...
static addOrigin(builder:flatbuffers.Builder, originOffset:flatbuffers.Offset) {
  builder.addFieldOffset(40, originOffset, 0);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:ObjectOfInterest_Abridged_dataMode_Enum) {
  builder.addFieldInt8(42, dataMode, ObjectOfInterest_Abridged_dataMode_Enum.REAL);
}

static endObjectOfInterest_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishObjectOfInterest_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'OBJE');
}

static finishSizePrefixedObjectOfInterest_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'OBJE', true);
}

static createObjectOfInterest_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, satNo:number, nameOffset:flatbuffers.Offset, sensorTaskingStartTimeOffset:flatbuffers.Offset, sensorTaskingStopTimeOffset:flatbuffers.Offset, priority:number, statusOffset:flatbuffers.Offset, statusDateOffset:flatbuffers.Offset, descriptionOffset:flatbuffers.Offset, lastObTimeOffset:flatbuffers.Offset, missedObTimeOffset:flatbuffers.Offset, deltaVsOffset:flatbuffers.Offset, deltaTsOffset:flatbuffers.Offset, svEpochOffset:flatbuffers.Offset, x:number, y:number, z:number, xvel:number, yvel:number, zvel:number, elsetEpochOffset:flatbuffers.Offset, meanMotion:number, eccentricity:number, inclination:number, raan:number, argOfPerigee:number, meanAnomaly:number, revNo:number, bStar:number, meanMotionDot:number, meanMotionDdot:number, semiMajorAxis:number, period:number, apogee:number, perigee:number, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:ObjectOfInterest_Abridged_dataMode_Enum):flatbuffers.Offset {
  ObjectOfInterest_Abridged.startObjectOfInterest_Abridged(builder);
...
unpack(): ObjectOfInterest_AbridgedT {
  return new ObjectOfInterest_AbridgedT(
    this.id(),
...
unpackTo(_o: ObjectOfInterest_AbridgedT): void {
  _o.id = this.id();
...
export class ObjectOfInterest_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: ObjectOfInterest_Abridged_dataMode_Enum = ObjectOfInterest_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const deltaVs = ObjectOfInterest_Abridged.createDeltaVsVector(builder, builder.createObjectOffsetList(this.deltaVs));
  const deltaTs = ObjectOfInterest_Abridged.createDeltaTsVector(builder, builder.createObjectOffsetList(this.deltaTs));
  ...
  return ObjectOfInterest_Abridged.createObjectOfInterest_Abridged(builder,
    id,
