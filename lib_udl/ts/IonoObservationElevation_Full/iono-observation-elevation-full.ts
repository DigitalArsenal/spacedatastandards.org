 ...
 */
export class IonoObservationElevation_Full implements flatbuffers.IUnpackableObject<IonoObservationElevation_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):IonoObservationElevation_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsIonoObservationElevation_Full(bb:flatbuffers.ByteBuffer, obj?:IonoObservationElevation_Full):IonoObservationElevation_Full {
  return (obj || new IonoObservationElevation_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIonoObservationElevation_Full(bb:flatbuffers.ByteBuffer, obj?:IonoObservationElevation_Full):IonoObservationElevation_Full {
...
static startIonoObservationElevation_Full(builder:flatbuffers.Builder) {
...
static endIonoObservationElevation_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishIonoObservationElevation_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO');
}

static finishSizePrefixedIonoObservationElevation_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO', true);
}

static createIonoObservationElevation_Full(builder:flatbuffers.Builder, notesOffset:flatbuffers.Offset, dimensionsOffset:flatbuffers.Offset, dimensionNameOffset:flatbuffers.Offset, dataOffset:flatbuffers.Offset):flatbuffers.Offset {
  IonoObservationElevation_Full.startIonoObservationElevation_Full(builder);
...
unpack(): IonoObservationElevation_FullT {
  return new IonoObservationElevation_FullT(
    this.notes(),
...
unpackTo(_o: IonoObservationElevation_FullT): void {
  _o.notes = this.notes();
...
export class IonoObservationElevation_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const dimensions = IonoObservationElevation_Full.createDimensionsVector(builder, builder.createObjectOffsetList(this.dimensions));
  const dimensionName = IonoObservationElevation_Full.createDimensionNameVector(builder, builder.createObjectOffsetList(this.dimensionName));
  const data = IonoObservationElevation_Full.createDataVector(builder, builder.createObjectOffsetList(this.data));

  return IonoObservationElevation_Full.createIonoObservationElevation_Full(builder,
    notes,
    dimensions,
    dimensionName,
    data
