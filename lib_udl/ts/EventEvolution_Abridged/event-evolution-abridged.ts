...
import { EventEvolution_Abridged_dataMode_Enum } from './event-evolution-abridged-data-mode-enum.js';
 ...
 */
export class EventEvolution_Abridged implements flatbuffers.IUnpackableObject<EventEvolution_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EventEvolution_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEventEvolution_Abridged(bb:flatbuffers.ByteBuffer, obj?:EventEvolution_Abridged):EventEvolution_Abridged {
  return (obj || new EventEvolution_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEventEvolution_Abridged(bb:flatbuffers.ByteBuffer, obj?:EventEvolution_Abridged):EventEvolution_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():EventEvolution_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 60);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : EventEvolution_Abridged_dataMode_Enum.REAL;
}

static startEventEvolution_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:EventEvolution_Abridged_dataMode_Enum) {
  builder.addFieldInt8(28, dataMode, EventEvolution_Abridged_dataMode_Enum.REAL);
}

static endEventEvolution_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEventEvolution_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVEN');
}

static finishSizePrefixedEventEvolution_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVEN', true);
}

static createEventEvolution_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, eventIdOffset:flatbuffers.Offset, categoryOffset:flatbuffers.Offset, summaryOffset:flatbuffers.Offset, startTimeOffset:flatbuffers.Offset, endTimeOffset:flatbuffers.Offset, statusOffset:flatbuffers.Offset, countryCodeOffset:flatbuffers.Offset, geoAdminLevel1Offset:flatbuffers.Offset, geoAdminLevel2Offset:flatbuffers.Offset, geoAdminLevel3Offset:flatbuffers.Offset, redact:boolean, srcTypsOffset:flatbuffers.Offset, srcIdsOffset:flatbuffers.Offset, dataDescriptionOffset:flatbuffers.Offset, atextOffset:flatbuffers.Offset, agjsonOffset:flatbuffers.Offset, atypeOffset:flatbuffers.Offset, andims:number, asrid:number, urlOffset:flatbuffers.Offset, tagsOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:EventEvolution_Abridged_dataMode_Enum):flatbuffers.Offset {
  EventEvolution_Abridged.startEventEvolution_Abridged(builder);
...
unpack(): EventEvolution_AbridgedT {
  return new EventEvolution_AbridgedT(
    this.id(),
...
unpackTo(_o: EventEvolution_AbridgedT): void {
  _o.id = this.id();
...
export class EventEvolution_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: EventEvolution_Abridged_dataMode_Enum = EventEvolution_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const srcTyps = EventEvolution_Abridged.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = EventEvolution_Abridged.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  ...
  const url = EventEvolution_Abridged.createUrlVector(builder, builder.createObjectOffsetList(this.url));
  const tags = EventEvolution_Abridged.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return EventEvolution_Abridged.createEventEvolution_Abridged(builder,
    id,
