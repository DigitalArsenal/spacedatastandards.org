...
import { WeatherReport_Ingest_dataMode_Enum } from './WeatherReport_Ingest_dataMode_Enum.js';
 ...
 */
export class WeatherReport_Ingest implements flatbuffers.IUnpackableObject<WeatherReport_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):WeatherReport_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsWeatherReport_Ingest(bb:flatbuffers.ByteBuffer, obj?:WeatherReport_Ingest):WeatherReport_Ingest {
  return (obj || new WeatherReport_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsWeatherReport_Ingest(bb:flatbuffers.ByteBuffer, obj?:WeatherReport_Ingest):WeatherReport_Ingest {
...
dataMode():WeatherReport_Ingest_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : WeatherReport_Ingest_dataMode_Enum.REAL;
}

static startWeatherReport_Ingest(builder:flatbuffers.Builder) {
...
unpack(): WeatherReport_IngestT {
  return new WeatherReport_IngestT(
    this.id(),
    ...
    this.dirDev(),
    this.windVar(),
    this.bb!.createScalarList<string>(this.windCov.bind(this), this.windCovLength()),
    this.bb!.createScalarList<string>(this.cloudCover.bind(this), this.cloudCoverLength()),
    this.bb!.createScalarList<string>(this.cloudHght.bind(this), this.cloudHghtLength()),
    this.actWeather(),
    this.weatherDesc(),
    this.weatherInt(),
    this.rawMetar(),
...
unpackTo(_o: WeatherReport_IngestT): void {
  _o.id = this.id();
  ...
  _o.windCov = this.bb!.createScalarList<string>(this.windCov.bind(this), this.windCovLength());
  _o.cloudCover = this.bb!.createScalarList<string>(this.cloudCover.bind(this), this.cloudCoverLength());
  _o.cloudHght = this.bb!.createScalarList<string>(this.cloudHght.bind(this), this.cloudHghtLength());
...
export class WeatherReport_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: WeatherReport_Ingest_dataMode_Enum = WeatherReport_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const windCov = WeatherReport_Ingest.createWindCovVector(builder, builder.createObjectOffsetList(this.windCov));
  const cloudCover = WeatherReport_Ingest.createCloudCoverVector(builder, builder.createObjectOffsetList(this.cloudCover));
  const cloudHght = WeatherReport_Ingest.createCloudHghtVector(builder, builder.createObjectOffsetList(this.cloudHght));
  ...
  const srcTyps = WeatherReport_Ingest.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = WeatherReport_Ingest.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  ...
  return WeatherReport_Ingest.createWeatherReport_Ingest(builder,
    id,
