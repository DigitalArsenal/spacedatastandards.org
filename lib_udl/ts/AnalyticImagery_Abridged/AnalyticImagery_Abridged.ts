...
import { AnalyticImagery_Abridged_dataMode_Enum } from './AnalyticImagery_Abridged_dataMode_Enum.js';
 ...
 */
export class AnalyticImagery_Abridged implements flatbuffers.IUnpackableObject<AnalyticImagery_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AnalyticImagery_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAnalyticImagery_Abridged(bb:flatbuffers.ByteBuffer, obj?:AnalyticImagery_Abridged):AnalyticImagery_Abridged {
  return (obj || new AnalyticImagery_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAnalyticImagery_Abridged(bb:flatbuffers.ByteBuffer, obj?:AnalyticImagery_Abridged):AnalyticImagery_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():AnalyticImagery_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 82);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AnalyticImagery_Abridged_dataMode_Enum.REAL;
}

static startAnalyticImagery_Abridged(builder:flatbuffers.Builder) {
...
static addSatId(builder:flatbuffers.Builder, satIdOffset:flatbuffers.Offset) {
  builder.addFieldOffset(26, satIdOffset, 0);
}
...
static addSatIdConf(builder:flatbuffers.Builder, satIdConfOffset:flatbuffers.Offset) {
  builder.addFieldOffset(27, satIdConfOffset, 0);
}
...
static addSrcTyps(builder:flatbuffers.Builder, srcTypsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(28, srcTypsOffset, 0);
}
...
static addSrcIds(builder:flatbuffers.Builder, srcIdsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(29, srcIdsOffset, 0);
}
...
static addTags(builder:flatbuffers.Builder, tagsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(30, tagsOffset, 0);
}
...
static addChecksumValue(builder:flatbuffers.Builder, checksumValueOffset:flatbuffers.Offset) {
  builder.addFieldOffset(31, checksumValueOffset, 0);
}

static addTransactionId(builder:flatbuffers.Builder, transactionIdOffset:flatbuffers.Offset) {
  builder.addFieldOffset(32, transactionIdOffset, 0);
}
...
static addSourceDl(builder:flatbuffers.Builder, sourceDlOffset:flatbuffers.Offset) {
  builder.addFieldOffset(38, sourceDlOffset, 0);
}

static addDataMode(builder:flatbuffers.Builder, dataMode:AnalyticImagery_Abridged_dataMode_Enum) {
  builder.addFieldInt8(39, dataMode, AnalyticImagery_Abridged_dataMode_Enum.REAL);
}

static endAnalyticImagery_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAnalyticImagery_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ANAL');
}

static finishSizePrefixedAnalyticImagery_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ANAL', true);
}

static createAnalyticImagery_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, contentOffset:flatbuffers.Offset, msgTimeOffset:flatbuffers.Offset, imageTypeOffset:flatbuffers.Offset, filenameOffset:flatbuffers.Offset, filesize:bigint, imgWidth:number, imgHeight:number, xUnitsOffset:flatbuffers.Offset, yUnitsOffset:flatbuffers.Offset, zUnitsOffset:flatbuffers.Offset, imageSetIdOffset:flatbuffers.Offset, imageSetLength:number, sequenceId:number, descriptionOffset:flatbuffers.Offset, dataStartOffset:flatbuffers.Offset, dataStopOffset:flatbuffers.Offset, annLimsOffset:flatbuffers.Offset, annTextOffset:flatbuffers.Offset, keywordsOffset:flatbuffers.Offset, atextOffset:flatbuffers.Offset, agjsonOffset:flatbuffers.Offset, atypeOffset:flatbuffers.Offset, andims:number, asrid:number, satIdOffset:flatbuffers.Offset, satIdConfOffset:flatbuffers.Offset, srcTypsOffset:flatbuffers.Offset, srcIdsOffset:flatbuffers.Offset, tagsOffset:flatbuffers.Offset, checksumValueOffset:flatbuffers.Offset, transactionIdOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, dataMode:AnalyticImagery_Abridged_dataMode_Enum):flatbuffers.Offset {
  AnalyticImagery_Abridged.startAnalyticImagery_Abridged(builder);
...
unpack(): AnalyticImagery_AbridgedT {
  return new AnalyticImagery_AbridgedT(
    this.id(),
    ...
    this.dataStart(),
    this.dataStop(),
    this.bb!.createScalarList<string>(this.annLims.bind(this), this.annLimsLength()),
    this.bb!.createScalarList<string>(this.annText.bind(this), this.annTextLength()),
    ...
    this.andims(),
    this.asrid(),
    this.bb!.createScalarList<string>(this.satId.bind(this), this.satIdLength()),
    this.bb!.createScalarList<string>(this.satIdConf.bind(this), this.satIdConfLength()),
...
unpackTo(_o: AnalyticImagery_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.annLims = this.bb!.createScalarList<string>(this.annLims.bind(this), this.annLimsLength());
  _o.annText = this.bb!.createScalarList<string>(this.annText.bind(this), this.annTextLength());
  ...
  _o.asrid = this.asrid();
  _o.satId = this.bb!.createScalarList<string>(this.satId.bind(this), this.satIdLength());
  _o.satIdConf = this.bb!.createScalarList<string>(this.satIdConf.bind(this), this.satIdConfLength());
...
export class AnalyticImagery_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AnalyticImagery_Abridged_dataMode_Enum = AnalyticImagery_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const annLims = AnalyticImagery_Abridged.createAnnLimsVector(builder, builder.createObjectOffsetList(this.annLims));
  const annText = AnalyticImagery_Abridged.createAnnTextVector(builder, builder.createObjectOffsetList(this.annText));
  const keywords = AnalyticImagery_Abridged.createKeywordsVector(builder, builder.createObjectOffsetList(this.keywords));
  ...
  const satId = AnalyticImagery_Abridged.createSatIdVector(builder, builder.createObjectOffsetList(this.satId));
  const satIdConf = AnalyticImagery_Abridged.createSatIdConfVector(builder, builder.createObjectOffsetList(this.satIdConf));
  const srcTyps = AnalyticImagery_Abridged.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = AnalyticImagery_Abridged.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  const tags = AnalyticImagery_Abridged.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return AnalyticImagery_Abridged.createAnalyticImagery_Abridged(builder,
    id,
