 ...
 */
export class MtiTargetReport_Ingest implements flatbuffers.IUnpackableObject<MtiTargetReport_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MtiTargetReport_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMtiTargetReport_Ingest(bb:flatbuffers.ByteBuffer, obj?:MtiTargetReport_Ingest):MtiTargetReport_Ingest {
  return (obj || new MtiTargetReport_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMtiTargetReport_Ingest(bb:flatbuffers.ByteBuffer, obj?:MtiTargetReport_Ingest):MtiTargetReport_Ingest {
...
static startMtiTargetReport_Ingest(builder:flatbuffers.Builder) {
...
static endMtiTargetReport_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishMtiTargetReport_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIT');
}

static finishSizePrefixedMtiTargetReport_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIT', true);
}

static createMtiTargetReport_Ingest(builder:flatbuffers.Builder, d321:number, d322:number, d323:number, d324:number, d325:number, d326:number, d327:number, d328:number, d329:number, d3210Offset:flatbuffers.Offset, d3211:number, d3212:number, d3213:number, d3214:number, d3215:number, d3216:number, d3217:bigint, d3218:number):flatbuffers.Offset {
  MtiTargetReport_Ingest.startMtiTargetReport_Ingest(builder);
  MtiTargetReport_Ingest.addD321(builder, d321);
  MtiTargetReport_Ingest.addD322(builder, d322);
  MtiTargetReport_Ingest.addD323(builder, d323);
  MtiTargetReport_Ingest.addD324(builder, d324);
  MtiTargetReport_Ingest.addD325(builder, d325);
  MtiTargetReport_Ingest.addD326(builder, d326);
  MtiTargetReport_Ingest.addD327(builder, d327);
  MtiTargetReport_Ingest.addD328(builder, d328);
  MtiTargetReport_Ingest.addD329(builder, d329);
  MtiTargetReport_Ingest.addD3210(builder, d3210Offset);
  MtiTargetReport_Ingest.addD3211(builder, d3211);
  MtiTargetReport_Ingest.addD3212(builder, d3212);
  MtiTargetReport_Ingest.addD3213(builder, d3213);
  MtiTargetReport_Ingest.addD3214(builder, d3214);
  MtiTargetReport_Ingest.addD3215(builder, d3215);
  MtiTargetReport_Ingest.addD3216(builder, d3216);
  MtiTargetReport_Ingest.addD3217(builder, d3217);
  MtiTargetReport_Ingest.addD3218(builder, d3218);
  return MtiTargetReport_Ingest.endMtiTargetReport_Ingest(builder);
}

unpack(): MtiTargetReport_IngestT {
  return new MtiTargetReport_IngestT(
    this.d321(),
    this.d322(),
    this.d323(),
    this.d324(),
...
unpackTo(_o: MtiTargetReport_IngestT): void {
  _o.d32_1 = this.d321();
  _o.d32_2 = this.d322();
  _o.d32_3 = this.d323();
  _o.d32_4 = this.d324();
  ...
  _o.d32_8 = this.d328();
  _o.d32_9 = this.d329();
  _o.d32_10 = this.d3210();
  _o.d32_11 = this.d3211();
  _o.d32_12 = this.d3212();
  _o.d32_13 = this.d3213();
  _o.d32_14 = this.d3214();
  _o.d32_15 = this.d3215();
  _o.d32_16 = this.d3216();
  _o.d32_17 = this.d3217();
  _o.d32_18 = this.d3218();
}
}

export class MtiTargetReport_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  public d32_1: number = 0,
  public d32_2: number = 0.0,
  public d32_3: number = 0.0,
  public d32_4: number = 0,
  public d32_5: number = 0,
  public d32_6: number = 0,
  public d32_7: number = 0,
  public d32_8: number = 0,
  public d32_9: number = 0,
  public d32_10: string|Uint8Array|null = null,
  public d32_11: number = 0,
  public d32_12: number = 0,
  public d32_13: number = 0,
  public d32_14: number = 0,
  public d32_15: number = 0,
  public d32_16: number = 0,
  public d32_17: bigint = BigInt('0'),
  public d32_18: number = 0
){}


pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  const d32_10 = (this.d32_10 !== null ? builder.createString(this.d32_10!) : 0);

  return MtiTargetReport_Ingest.createMtiTargetReport_Ingest(builder,
    this.d32_1,
    this.d32_2,
    this.d32_3,
    this.d32_4,
