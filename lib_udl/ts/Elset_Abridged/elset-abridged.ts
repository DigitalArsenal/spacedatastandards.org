...
import { Elset_Abridged_dataMode_Enum } from './elset-abridged-data-mode-enum.js';
 ...
 */
export class Elset_Abridged implements flatbuffers.IUnpackableObject<Elset_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Elset_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsElset_Abridged(bb:flatbuffers.ByteBuffer, obj?:Elset_Abridged):Elset_Abridged {
  return (obj || new Elset_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsElset_Abridged(bb:flatbuffers.ByteBuffer, obj?:Elset_Abridged):Elset_Abridged {
 ...
 */
dataMode():Elset_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 68);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Elset_Abridged_dataMode_Enum.REAL;
}
...
static startElset_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Elset_Abridged_dataMode_Enum) {
  builder.addFieldInt8(32, dataMode, Elset_Abridged_dataMode_Enum.REAL);
}

static addAlgorithm(builder:flatbuffers.Builder, algorithmOffset:flatbuffers.Offset) {
  builder.addFieldOffset(33, algorithmOffset, 0);
}

static addTransactionId(builder:flatbuffers.Builder, transactionIdOffset:flatbuffers.Offset) {
  builder.addFieldOffset(34, transactionIdOffset, 0);
}

static addEphemType(builder:flatbuffers.Builder, ephemType:number) {
  builder.addFieldInt32(35, ephemType, 0);
}
...
static endElset_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishElset_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ELSE');
}

static finishSizePrefixedElset_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ELSE', true);
}

static createElset_Abridged(builder:flatbuffers.Builder, idElsetOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, satNo:number, epochOffset:flatbuffers.Offset, meanMotion:number, idOnOrbitOffset:flatbuffers.Offset, uct:boolean, eccentricity:number, inclination:number, raan:number, argOfPerigee:number, meanAnomaly:number, revNo:number, bStar:number, agom:number, ballisticCoeff:number, meanMotionDot:number, meanMotionDdot:number, semiMajorAxis:number, period:number, apogee:number, perigee:number, origObjectIdOffset:flatbuffers.Offset, idOrbitDeterminationOffset:flatbuffers.Offset, line1Offset:flatbuffers.Offset, line2Offset:flatbuffers.Offset, descriptorOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, dataMode:Elset_Abridged_dataMode_Enum, algorithmOffset:flatbuffers.Offset, transactionIdOffset:flatbuffers.Offset, ephemType:number, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  Elset_Abridged.startElset_Abridged(builder);
...
unpack(): Elset_AbridgedT {
  return new Elset_AbridgedT(
    this.idElset(),
...
unpackTo(_o: Elset_AbridgedT): void {
...
export class Elset_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Elset_Abridged_dataMode_Enum = Elset_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Elset_Abridged.createElset_Abridged(builder,
    idElset,
