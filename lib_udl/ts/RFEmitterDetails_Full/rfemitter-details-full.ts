...
import { RFEmitterDetails_Full_dataMode_Enum } from './rfemitter-details-full-data-mode-enum.js';
 ...
 */
export class RFEmitterDetails_Full implements flatbuffers.IUnpackableObject<RFEmitterDetails_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):RFEmitterDetails_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsRFEmitterDetails_Full(bb:flatbuffers.ByteBuffer, obj?:RFEmitterDetails_Full):RFEmitterDetails_Full {
  return (obj || new RFEmitterDetails_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRFEmitterDetails_Full(bb:flatbuffers.ByteBuffer, obj?:RFEmitterDetails_Full):RFEmitterDetails_Full {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():RFEmitterDetails_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 68);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFEmitterDetails_Full_dataMode_Enum.REAL;
}
 ...
 * Constraints: No constraints specified.
 */
productionFacilityLocation():string|null
productionFacilityLocation(optionalEncoding:flatbuffers.Encoding):string|Uint8Array|null
productionFacilityLocation(optionalEncoding?:any):string|Uint8Array|null {
...
static startRFEmitterDetails_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:RFEmitterDetails_Full_dataMode_Enum) {
  builder.addFieldInt8(32, dataMode, RFEmitterDetails_Full_dataMode_Enum.REAL);
}
...
unpack(): RFEmitterDetails_FullT {
  return new RFEmitterDetails_FullT(
    this.id(),
    this.idRfemitter(),
    ...
    this.updatedAt(),
    this.updatedBy(),
    this.productionFacilityLocation(),
    this.manufacturerOrg()
  );
}


unpackTo(_o: RFEmitterDetails_FullT): void {
  _o.id = this.id();
...
export class RFEmitterDetails_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: RFEmitterDetails_Full_dataMode_Enum = RFEmitterDetails_Full_dataMode_Enum.REAL,
  public createdAt: string|Uint8Array|null = null,
  public createdBy: string|Uint8Array|null = null,
  public updatedAt: string|Uint8Array|null = null,
  public updatedBy: string|Uint8Array|null = null,
  public productionFacilityLocation: string|Uint8Array|null = null,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const antennaSize = RFEmitterDetails_Full.createAntennaSizeVector(builder, builder.createObjectOffsetList(this.antennaSize));
  ...
  const urls = RFEmitterDetails_Full.createUrlsVector(builder, builder.createObjectOffsetList(this.urls));
  ...
  const productionFacilityLocation = (this.productionFacilityLocation !== null ? builder.createString(this.productionFacilityLocation!) : 0);
  const manufacturerOrg = (this.manufacturerOrg !== null ? builder.createString(this.manufacturerOrg!) : 0);

  return RFEmitterDetails_Full.createRFEmitterDetails_Full(builder,
    id,
    idRFEmitter,
