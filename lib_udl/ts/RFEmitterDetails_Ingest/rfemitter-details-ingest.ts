...
import { RFEmitterDetails_Ingest_dataMode_Enum } from './rfemitter-details-ingest-data-mode-enum.js';
 ...
 */
export class RFEmitterDetails_Ingest implements flatbuffers.IUnpackableObject<RFEmitterDetails_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):RFEmitterDetails_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsRFEmitterDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:RFEmitterDetails_Ingest):RFEmitterDetails_Ingest {
  return (obj || new RFEmitterDetails_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRFEmitterDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:RFEmitterDetails_Ingest):RFEmitterDetails_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():RFEmitterDetails_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 68);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFEmitterDetails_Ingest_dataMode_Enum.REAL;
}
...
static startRFEmitterDetails_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:RFEmitterDetails_Ingest_dataMode_Enum) {
  builder.addFieldInt8(32, dataMode, RFEmitterDetails_Ingest_dataMode_Enum.REAL);
}
...
unpack(): RFEmitterDetails_IngestT {
  return new RFEmitterDetails_IngestT(
    this.id(),
    this.idRfemitter(),
    ...
    this.numChannels(),
    this.numBits(),
    this.bb!.createScalarList<string>(this.antennaSize.bind(this), this.antennaSize_Length()),
...
unpackTo(_o: RFEmitterDetails_IngestT): void {
  _o.id = this.id();
  ...
  _o.antennaSize = this.bb!.createScalarList<string>(this.antennaSize.bind(this), this.antennaSize_Length());
...
export class RFEmitterDetails_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: RFEmitterDetails_Ingest_dataMode_Enum = RFEmitterDetails_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const antennaSize = RFEmitterDetails_Ingest.createAntennaSizeVector(builder, builder.createObjectOffsetList(this.antennaSize));
  ...
  const urls = RFEmitterDetails_Ingest.createUrlsVector(builder, builder.createObjectOffsetList(this.urls));
  ...
  return RFEmitterDetails_Ingest.createRFEmitterDetails_Ingest(builder,
    id,
    idRFEmitter,
