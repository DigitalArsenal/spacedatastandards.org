...
import { ISRCollection_Full_dataMode_Enum } from './ISRCollection_Full_dataMode_Enum.js';


/**
 * /// ISR Collection data.
 */
export class ISRCollection_Full implements flatbuffers.IUnpackableObject<ISRCollection_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ISRCollection_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsISRCollection_Full(bb:flatbuffers.ByteBuffer, obj?:ISRCollection_Full):ISRCollection_Full {
  return (obj || new ISRCollection_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsISRCollection_Full(bb:flatbuffers.ByteBuffer, obj?:ISRCollection_Full):ISRCollection_Full {
 ...
 */
dataMode():ISRCollection_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 68);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : ISRCollection_Full_dataMode_Enum.REAL;
}
...
static startISRCollection_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:ISRCollection_Full_dataMode_Enum) {
  builder.addFieldInt8(32, dataMode, ISRCollection_Full_dataMode_Enum.REAL);
}
...
unpack(): ISRCollection_FullT {
  return new ISRCollection_FullT(
    this.id(),
    ...
    this.bb!.createScalarList<string>(this.collectionRequirements.bind(this), this.collectionRequirementsLength()),
    this.bb!.createScalarList<string>(this.transit.bind(this), this.transitLength()),
    this.bb!.createScalarList<string>(this.taskings.bind(this), this.taskingsLength()),
    this.createdAt(),
    this.createdBy(),
    this.updatedAt(),
    this.updatedBy(),
...
unpackTo(_o: ISRCollection_FullT): void {
  _o.id = this.id();
  ...
  _o.collectionRequirements = this.bb!.createScalarList<string>(this.collectionRequirements.bind(this), this.collectionRequirementsLength());
  _o.transit = this.bb!.createScalarList<string>(this.transit.bind(this), this.transitLength());
  _o.taskings = this.bb!.createScalarList<string>(this.taskings.bind(this), this.taskingsLength());
...
export class ISRCollection_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: ISRCollection_Full_dataMode_Enum = ISRCollection_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const collectionRequirements = ISRCollection_Full.createCollectionRequirementsVector(builder, builder.createObjectOffsetList(this.collectionRequirements));
  const transit = ISRCollection_Full.createTransitVector(builder, builder.createObjectOffsetList(this.transit));
  const taskings = ISRCollection_Full.createTaskingsVector(builder, builder.createObjectOffsetList(this.taskings));
  ...
  return ISRCollection_Full.createISRCollection_Full(builder,
    id,
