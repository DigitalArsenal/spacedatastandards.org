...
import { Scientific_Ingest_dataMode_Enum } from './scientific-ingest-data-mode-enum.js';


/**
 * /// Scientific or other data from Seradata.
 */
export class Scientific_Ingest implements flatbuffers.IUnpackableObject<Scientific_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Scientific_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsScientific_Ingest(bb:flatbuffers.ByteBuffer, obj?:Scientific_Ingest):Scientific_Ingest {
  return (obj || new Scientific_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsScientific_Ingest(bb:flatbuffers.ByteBuffer, obj?:Scientific_Ingest):Scientific_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Scientific_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 32);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Scientific_Ingest_dataMode_Enum.REAL;
}
...
static startScientific_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Scientific_Ingest_dataMode_Enum) {
  builder.addFieldInt8(14, dataMode, Scientific_Ingest_dataMode_Enum.REAL);
}
...
static addEntity(builder:flatbuffers.Builder, entityOffset:flatbuffers.Offset) {
  builder.addFieldOffset(16, entityOffset, 0);
}

static endScientific_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishScientific_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SCIE');
}

static finishSizePrefixedScientific_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SCIE', true);
}

static createScientific_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, spacecraftIdOffset:flatbuffers.Offset, hostedForCompanyOrgIdOffset:flatbuffers.Offset, manufacturerOrgIdOffset:flatbuffers.Offset, payloadCategoryOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, frequencyBandOffset:flatbuffers.Offset, notesOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:Scientific_Ingest_dataMode_Enum, idEntityOffset:flatbuffers.Offset, entityOffset:flatbuffers.Offset):flatbuffers.Offset {
  Scientific_Ingest.startScientific_Ingest(builder);
...
unpack(): Scientific_IngestT {
  return new Scientific_IngestT(
    this.id(),
...
unpackTo(_o: Scientific_IngestT): void {
  _o.id = this.id();
...
export class Scientific_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Scientific_Ingest_dataMode_Enum = Scientific_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Scientific_Ingest.createScientific_Ingest(builder,
    id,
