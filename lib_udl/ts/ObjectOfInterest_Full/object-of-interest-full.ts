...
import { ObjectOfInterest_Full_dataMode_Enum } from './object-of-interest-full-data-mode-enum.js';
...
unpack(): ObjectOfInterest_FullT {
  return new ObjectOfInterest_FullT(
    ...
    this.dataMode(),
    this.onOrbit(),
    this.bb!.createScalarList<string>(this.manifolds.bind(this), this.manifolds_Length())
  );
}
...
unpackTo(_o: ObjectOfInterest_FullT): void {
  ...
  _o.manifolds = this.bb!.createScalarList<string>(this.manifolds.bind(this), this.manifolds_Length());
}
}
