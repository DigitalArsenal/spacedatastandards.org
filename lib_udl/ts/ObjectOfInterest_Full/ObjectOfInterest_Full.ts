...
import { ObjectOfInterest_Full_dataMode_Enum } from './ObjectOfInterest_Full_dataMode_Enum.js';


/**
 * /// OnOrbit objects of interest, which include information about the last known state of the object.
 */
export class ObjectOfInterest_Full implements flatbuffers.IUnpackableObject<ObjectOfInterest_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ObjectOfInterest_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsObjectOfInterest_Full(bb:flatbuffers.ByteBuffer, obj?:ObjectOfInterest_Full):ObjectOfInterest_Full {
  return (obj || new ObjectOfInterest_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsObjectOfInterest_Full(bb:flatbuffers.ByteBuffer, obj?:ObjectOfInterest_Full):ObjectOfInterest_Full {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():ObjectOfInterest_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 94);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : ObjectOfInterest_Full_dataMode_Enum.REAL;
}
...
static startObjectOfInterest_Full(builder:flatbuffers.Builder) {
...
static addUpdatedAt(builder:flatbuffers.Builder, updatedAtOffset:flatbuffers.Offset) {
  builder.addFieldOffset(40, updatedAtOffset, 0);
}

static addUpdatedBy(builder:flatbuffers.Builder, updatedByOffset:flatbuffers.Offset) {
  builder.addFieldOffset(41, updatedByOffset, 0);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:ObjectOfInterest_Full_dataMode_Enum) {
  builder.addFieldInt8(45, dataMode, ObjectOfInterest_Full_dataMode_Enum.REAL);
}

static addOnOrbit(builder:flatbuffers.Builder, onOrbitOffset:flatbuffers.Offset) {
  builder.addFieldOffset(46, onOrbitOffset, 0);
}

static addManifolds(builder:flatbuffers.Builder, manifoldsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(47, manifoldsOffset, 0);
}
...
unpack(): ObjectOfInterest_FullT {
  return new ObjectOfInterest_FullT(
    this.id(),
    ...
    this.lastObTime(),
    this.missedObTime(),
    this.bb!.createScalarList<string>(this.deltaVs.bind(this), this.deltaVsLength()),
    this.bb!.createScalarList<string>(this.deltaTs.bind(this), this.deltaTsLength()),
    this.svEpoch(),
    this.x(),
    this.y(),
    this.z(),
    ...
    this.apogee(),
    this.perigee(),
    this.bb!.createScalarList<string>(this.affectedObjects.bind(this), this.affectedObjectsLength()),
    this.createdAt(),
    this.createdBy(),
    this.updatedAt(),
    this.updatedBy(),
...
unpackTo(_o: ObjectOfInterest_FullT): void {
  _o.id = this.id();
  ...
  _o.deltaVs = this.bb!.createScalarList<string>(this.deltaVs.bind(this), this.deltaVsLength());
  _o.deltaTs = this.bb!.createScalarList<string>(this.deltaTs.bind(this), this.deltaTsLength());
  ...
  _o.affectedObjects = this.bb!.createScalarList<string>(this.affectedObjects.bind(this), this.affectedObjectsLength());
...
export class ObjectOfInterest_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: ObjectOfInterest_Full_dataMode_Enum = ObjectOfInterest_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const deltaVs = ObjectOfInterest_Full.createDeltaVsVector(builder, builder.createObjectOffsetList(this.deltaVs));
  const deltaTs = ObjectOfInterest_Full.createDeltaTsVector(builder, builder.createObjectOffsetList(this.deltaTs));
  ...
  const affectedObjects = ObjectOfInterest_Full.createAffectedObjectsVector(builder, builder.createObjectOffsetList(this.affectedObjects));
  ...
  const manifolds = ObjectOfInterest_Full.createManifoldsVector(builder, builder.createObjectOffsetList(this.manifolds));

  return ObjectOfInterest_Full.createObjectOfInterest_Full(builder,
    id,
