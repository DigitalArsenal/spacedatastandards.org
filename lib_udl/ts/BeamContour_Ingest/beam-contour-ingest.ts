...
import { BeamContour_Ingest_dataMode_Enum } from './beam-contour-ingest-data-mode-enum.js';
import { BeamContour_Ingest_type_Enum } from './beam-contour-ingest-type-enum.js';
 ...
 */
export class BeamContour_Ingest implements flatbuffers.IUnpackableObject<BeamContour_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):BeamContour_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsBeamContour_Ingest(bb:flatbuffers.ByteBuffer, obj?:BeamContour_Ingest):BeamContour_Ingest {
  return (obj || new BeamContour_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsBeamContour_Ingest(bb:flatbuffers.ByteBuffer, obj?:BeamContour_Ingest):BeamContour_Ingest {
 ...
 */
type():BeamContour_Ingest_type_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 10);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : BeamContour_Ingest_type_Enum.BORESIGHT;
}
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():BeamContour_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 40);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : BeamContour_Ingest_dataMode_Enum.REAL;
}

static startBeamContour_Ingest(builder:flatbuffers.Builder) {
...
static addType(builder:flatbuffers.Builder, type:BeamContour_Ingest_type_Enum) {
  builder.addFieldInt8(3, type, BeamContour_Ingest_type_Enum.BORESIGHT);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:BeamContour_Ingest_dataMode_Enum) {
  builder.addFieldInt8(18, dataMode, BeamContour_Ingest_dataMode_Enum.REAL);
}

static endBeamContour_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishBeamContour_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'BEAM');
}

static finishSizePrefixedBeamContour_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'BEAM', true);
}

static createBeamContour_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idBeamOffset:flatbuffers.Offset, type:BeamContour_Ingest_type_Enum, contourIdx:number, gain:number, regionNameOffset:flatbuffers.Offset, geographyOffset:flatbuffers.Offset, geographyTextOffset:flatbuffers.Offset, geographyJsonOffset:flatbuffers.Offset, geographyTypeOffset:flatbuffers.Offset, geographyNdims:number, geographySrid:number, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:BeamContour_Ingest_dataMode_Enum):flatbuffers.Offset {
  BeamContour_Ingest.startBeamContour_Ingest(builder);
...
unpack(): BeamContour_IngestT {
  return new BeamContour_IngestT(
    this.id(),
...
unpackTo(_o: BeamContour_IngestT): void {
  _o.id = this.id();
...
export class BeamContour_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  public id: string|Uint8Array|null = null,
  public classificationMarking: string|Uint8Array|null = null,
  public idBeam: string|Uint8Array|null = null,
  public type: BeamContour_Ingest_type_Enum = BeamContour_Ingest_type_Enum.BORESIGHT,
  ...
  public dataMode: BeamContour_Ingest_dataMode_Enum = BeamContour_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return BeamContour_Ingest.createBeamContour_Ingest(builder,
    id,
