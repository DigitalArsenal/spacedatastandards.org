 ...
 */
export class DataLinkOps_Full implements flatbuffers.IUnpackableObject<DataLinkOps_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):DataLinkOps_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsDataLinkOps_Full(bb:flatbuffers.ByteBuffer, obj?:DataLinkOps_Full):DataLinkOps_Full {
  return (obj || new DataLinkOps_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsDataLinkOps_Full(bb:flatbuffers.ByteBuffer, obj?:DataLinkOps_Full):DataLinkOps_Full {
...
static startDataLinkOps_Full(builder:flatbuffers.Builder) {
...
static endDataLinkOps_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishDataLinkOps_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DATA');
}

static finishSizePrefixedDataLinkOps_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DATA', true);
}

static createDataLinkOps_Full(builder:flatbuffers.Builder, linkNameOffset:flatbuffers.Offset, linkStartTimeOffset:flatbuffers.Offset, linkStopTimeOffset:flatbuffers.Offset, linkStopTimeModOffset:flatbuffers.Offset, linkDetailsOffset:flatbuffers.Offset):flatbuffers.Offset {
  DataLinkOps_Full.startDataLinkOps_Full(builder);
...
unpack(): DataLinkOps_FullT {
  return new DataLinkOps_FullT(
    this.linkName(),
    this.linkStartTime(),
    this.linkStopTime(),
...
unpackTo(_o: DataLinkOps_FullT): void {
...
export class DataLinkOps_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return DataLinkOps_Full.createDataLinkOps_Full(builder,
    linkName,
    linkStartTime,
    linkStopTime,
    linkStopTimeMod,
