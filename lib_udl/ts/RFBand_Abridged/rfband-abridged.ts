...
import { RFBand_Abridged_dataMode_Enum } from './rfband-abridged-data-mode-enum.js';
import { RFBand_Abridged_mode_Enum } from './rfband-abridged-mode-enum.js';
import { RFBand_Abridged_polarization_Enum } from './rfband-abridged-polarization-enum.js';
import { RFBand_Abridged_purpose_Enum } from './rfband-abridged-purpose-enum.js';
 ...
 */
export class RFBand_Abridged implements flatbuffers.IUnpackableObject<RFBand_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):RFBand_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsRFBand_Abridged(bb:flatbuffers.ByteBuffer, obj?:RFBand_Abridged):RFBand_Abridged {
  return (obj || new RFBand_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRFBand_Abridged(bb:flatbuffers.ByteBuffer, obj?:RFBand_Abridged):RFBand_Abridged {
 ...
 */
mode():RFBand_Abridged_mode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 14);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFBand_Abridged_mode_Enum.TX;
}
 ...
 */
purpose():RFBand_Abridged_purpose_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 16);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFBand_Abridged_purpose_Enum.COMM;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 4
 */
polarization():RFBand_Abridged_polarization_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 32);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFBand_Abridged_polarization_Enum.H;
}
 ...
 */
dataMode():RFBand_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 42);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFBand_Abridged_dataMode_Enum.REAL;
}
...
static startRFBand_Abridged(builder:flatbuffers.Builder) {
...
static addMode(builder:flatbuffers.Builder, mode:RFBand_Abridged_mode_Enum) {
  builder.addFieldInt8(5, mode, RFBand_Abridged_mode_Enum.TX);
}

static addPurpose(builder:flatbuffers.Builder, purpose:RFBand_Abridged_purpose_Enum) {
  builder.addFieldInt8(6, purpose, RFBand_Abridged_purpose_Enum.COMM);
}
...
static addPolarization(builder:flatbuffers.Builder, polarization:RFBand_Abridged_polarization_Enum) {
  builder.addFieldInt8(14, polarization, RFBand_Abridged_polarization_Enum.H);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:RFBand_Abridged_dataMode_Enum) {
  builder.addFieldInt8(19, dataMode, RFBand_Abridged_dataMode_Enum.REAL);
}
...
static endRFBand_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishRFBand_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'RFBA');
}

static finishSizePrefixedRFBand_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'RFBA', true);
}

static createRFBand_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idEntityOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, bandOffset:flatbuffers.Offset, mode:RFBand_Abridged_mode_Enum, purpose:RFBand_Abridged_purpose_Enum, freqMin:number, freqMax:number, centerFreq:number, peakGain:number, edgeGain:number, bandwidth:number, beamwidth:number, polarization:RFBand_Abridged_polarization_Enum, erp:number, eirp:number, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:RFBand_Abridged_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  RFBand_Abridged.startRFBand_Abridged(builder);
...
unpack(): RFBand_AbridgedT {
  return new RFBand_AbridgedT(
    this.id(),
    this.idEntity(),
...
unpackTo(_o: RFBand_AbridgedT): void {
  _o.id = this.id();
...
export class RFBand_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public mode: RFBand_Abridged_mode_Enum = RFBand_Abridged_mode_Enum.TX,
  public purpose: RFBand_Abridged_purpose_Enum = RFBand_Abridged_purpose_Enum.COMM,
  ...
  public polarization: RFBand_Abridged_polarization_Enum = RFBand_Abridged_polarization_Enum.H,
  public erp: number = 0.0,
  public eirp: number = 0.0,
  public source: string|Uint8Array|null = null,
  public origin: string|Uint8Array|null = null,
  public dataMode: RFBand_Abridged_dataMode_Enum = RFBand_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return RFBand_Abridged.createRFBand_Abridged(builder,
    id,
    idEntity,
