 ...
 */
export class DataLinkMultiDuty_Abridged implements flatbuffers.IUnpackableObject<DataLinkMultiDuty_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):DataLinkMultiDuty_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsDataLinkMultiDuty_Abridged(bb:flatbuffers.ByteBuffer, obj?:DataLinkMultiDuty_Abridged):DataLinkMultiDuty_Abridged {
  return (obj || new DataLinkMultiDuty_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsDataLinkMultiDuty_Abridged(bb:flatbuffers.ByteBuffer, obj?:DataLinkMultiDuty_Abridged):DataLinkMultiDuty_Abridged {
...
static startDataLinkMultiDuty_Abridged(builder:flatbuffers.Builder) {
...
static endDataLinkMultiDuty_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishDataLinkMultiDuty_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DATA');
}

static finishSizePrefixedDataLinkMultiDuty_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DATA', true);
}

static createDataLinkMultiDuty_Abridged(builder:flatbuffers.Builder, unitDesOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, rankOffset:flatbuffers.Offset, dutyOffset:flatbuffers.Offset, dutyTeleFreqNumsOffset:flatbuffers.Offset, multiDutyVoiceCoordOffset:flatbuffers.Offset):flatbuffers.Offset {
  DataLinkMultiDuty_Abridged.startDataLinkMultiDuty_Abridged(builder);
...
unpack(): DataLinkMultiDuty_AbridgedT {
  return new DataLinkMultiDuty_AbridgedT(
    this.unitDes(),
    this.name(),
    this.rank(),
    this.duty(),
    this.bb!.createScalarList<string>(this.dutyTeleFreqNums.bind(this), this.dutyTeleFreqNumsLength()),
    this.bb!.createScalarList<string>(this.multiDutyVoiceCoord.bind(this), this.multiDutyVoiceCoordLength())
  );
}


unpackTo(_o: DataLinkMultiDuty_AbridgedT): void {
  _o.unitDes = this.unitDes();
  _o.name = this.name();
  _o.rank = this.rank();
  _o.duty = this.duty();
  _o.dutyTeleFreqNums = this.bb!.createScalarList<string>(this.dutyTeleFreqNums.bind(this), this.dutyTeleFreqNumsLength());
  _o.multiDutyVoiceCoord = this.bb!.createScalarList<string>(this.multiDutyVoiceCoord.bind(this), this.multiDutyVoiceCoordLength());
}
}

export class DataLinkMultiDuty_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const dutyTeleFreqNums = DataLinkMultiDuty_Abridged.createDutyTeleFreqNumsVector(builder, builder.createObjectOffsetList(this.dutyTeleFreqNums));
  const multiDutyVoiceCoord = DataLinkMultiDuty_Abridged.createMultiDutyVoiceCoordVector(builder, builder.createObjectOffsetList(this.multiDutyVoiceCoord));

  return DataLinkMultiDuty_Abridged.createDataLinkMultiDuty_Abridged(builder,
    unitDes,
    name,
    rank,
    duty,
