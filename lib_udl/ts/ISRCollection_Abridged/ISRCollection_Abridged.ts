...
import { ISRCollection_Abridged_dataMode_Enum } from './ISRCollection_Abridged_dataMode_Enum.js';


/**
 * /// ISR Collection data.
 */
export class ISRCollection_Abridged implements flatbuffers.IUnpackableObject<ISRCollection_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ISRCollection_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsISRCollection_Abridged(bb:flatbuffers.ByteBuffer, obj?:ISRCollection_Abridged):ISRCollection_Abridged {
  return (obj || new ISRCollection_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsISRCollection_Abridged(bb:flatbuffers.ByteBuffer, obj?:ISRCollection_Abridged):ISRCollection_Abridged {
...
dataMode():ISRCollection_Abridged_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : ISRCollection_Abridged_dataMode_Enum.REAL;
}
...
static startISRCollection_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:ISRCollection_Abridged_dataMode_Enum) {
  builder.addFieldInt8(32, dataMode, ISRCollection_Abridged_dataMode_Enum.REAL);
}
...
unpack(): ISRCollection_AbridgedT {
  return new ISRCollection_AbridgedT(
    this.id(),
...
unpackTo(_o: ISRCollection_AbridgedT): void {
  _o.id = this.id();
...
export class ISRCollection_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: ISRCollection_Abridged_dataMode_Enum = ISRCollection_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const collectionRequirements = ISRCollection_Abridged.createCollectionRequirementsVector(builder, builder.createObjectOffsetList(this.collectionRequirements));
  const transit = ISRCollection_Abridged.createTransitVector(builder, builder.createObjectOffsetList(this.transit));
  const taskings = ISRCollection_Abridged.createTaskingsVector(builder, builder.createObjectOffsetList(this.taskings));
  ...
  return ISRCollection_Abridged.createISRCollection_Abridged(builder,
    id,
