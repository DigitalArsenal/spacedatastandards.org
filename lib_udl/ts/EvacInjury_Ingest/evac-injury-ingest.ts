 ...
 * /// Injury specifics.
 */
export class EvacInjury_Ingest implements flatbuffers.IUnpackableObject<EvacInjury_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EvacInjury_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEvacInjury_Ingest(bb:flatbuffers.ByteBuffer, obj?:EvacInjury_Ingest):EvacInjury_Ingest {
  return (obj || new EvacInjury_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEvacInjury_Ingest(bb:flatbuffers.ByteBuffer, obj?:EvacInjury_Ingest):EvacInjury_Ingest {
...
static startEvacInjury_Ingest(builder:flatbuffers.Builder) {
...
static endEvacInjury_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEvacInjury_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC');
}

static finishSizePrefixedEvacInjury_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC', true);
}

static createEvacInjury_Ingest(builder:flatbuffers.Builder, typeOffset:flatbuffers.Offset, bodyPartOffset:flatbuffers.Offset, timeOffset:flatbuffers.Offset, commentsOffset:flatbuffers.Offset):flatbuffers.Offset {
  EvacInjury_Ingest.startEvacInjury_Ingest(builder);
...
unpack(): EvacInjury_IngestT {
  return new EvacInjury_IngestT(
    this.type(),
    this.bodyPart(),
    this.time(),
    this.comments()
...
unpackTo(_o: EvacInjury_IngestT): void {
  _o.type = this.type();
...
export class EvacInjury_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return EvacInjury_Ingest.createEvacInjury_Ingest(builder,
    type,
    bodyPart,
    time,
    comments
