 ...
 */
export class IonoObservationPhase_Full implements flatbuffers.IUnpackableObject<IonoObservationPhase_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):IonoObservationPhase_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsIonoObservationPhase_Full(bb:flatbuffers.ByteBuffer, obj?:IonoObservationPhase_Full):IonoObservationPhase_Full {
  return (obj || new IonoObservationPhase_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIonoObservationPhase_Full(bb:flatbuffers.ByteBuffer, obj?:IonoObservationPhase_Full):IonoObservationPhase_Full {
...
static startIonoObservationPhase_Full(builder:flatbuffers.Builder) {
...
static endIonoObservationPhase_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishIonoObservationPhase_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO');
}

static finishSizePrefixedIonoObservationPhase_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO', true);
}

static createIonoObservationPhase_Full(builder:flatbuffers.Builder, notesOffset:flatbuffers.Offset, dimensionsOffset:flatbuffers.Offset, dimensionNameOffset:flatbuffers.Offset, dataOffset:flatbuffers.Offset):flatbuffers.Offset {
  IonoObservationPhase_Full.startIonoObservationPhase_Full(builder);
...
unpack(): IonoObservationPhase_FullT {
  return new IonoObservationPhase_FullT(
    this.notes(),
...
unpackTo(_o: IonoObservationPhase_FullT): void {
  _o.notes = this.notes();
...
export class IonoObservationPhase_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const dimensions = IonoObservationPhase_Full.createDimensionsVector(builder, builder.createObjectOffsetList(this.dimensions));
  const dimensionName = IonoObservationPhase_Full.createDimensionNameVector(builder, builder.createObjectOffsetList(this.dimensionName));
  const data = IonoObservationPhase_Full.createDataVector(builder, builder.createObjectOffsetList(this.data));

  return IonoObservationPhase_Full.createIonoObservationPhase_Full(builder,
    notes,
    dimensions,
    dimensionName,
    data
