 ...
 */
export class IonoObservationRange_Ingest implements flatbuffers.IUnpackableObject<IonoObservationRange_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):IonoObservationRange_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsIonoObservationRange_Ingest(bb:flatbuffers.ByteBuffer, obj?:IonoObservationRange_Ingest):IonoObservationRange_Ingest {
  return (obj || new IonoObservationRange_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIonoObservationRange_Ingest(bb:flatbuffers.ByteBuffer, obj?:IonoObservationRange_Ingest):IonoObservationRange_Ingest {
...
static startIonoObservationRange_Ingest(builder:flatbuffers.Builder) {
...
static endIonoObservationRange_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishIonoObservationRange_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO');
}

static finishSizePrefixedIonoObservationRange_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO', true);
}

static createIonoObservationRange_Ingest(builder:flatbuffers.Builder, notesOffset:flatbuffers.Offset, dimensionsOffset:flatbuffers.Offset, dimensionNameOffset:flatbuffers.Offset, dataOffset:flatbuffers.Offset):flatbuffers.Offset {
  IonoObservationRange_Ingest.startIonoObservationRange_Ingest(builder);
...
unpack(): IonoObservationRange_IngestT {
  return new IonoObservationRange_IngestT(
    this.notes(),
...
unpackTo(_o: IonoObservationRange_IngestT): void {
  _o.notes = this.notes();
...
export class IonoObservationRange_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const dimensions = IonoObservationRange_Ingest.createDimensionsVector(builder, builder.createObjectOffsetList(this.dimensions));
  const dimensionName = IonoObservationRange_Ingest.createDimensionNameVector(builder, builder.createObjectOffsetList(this.dimensionName));
  const data = IonoObservationRange_Ingest.createDataVector(builder, builder.createObjectOffsetList(this.data));

  return IonoObservationRange_Ingest.createIonoObservationRange_Ingest(builder,
    notes,
    dimensions,
    dimensionName,
    data
