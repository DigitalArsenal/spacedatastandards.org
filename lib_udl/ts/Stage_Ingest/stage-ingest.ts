...
import { Stage_Ingest_dataMode_Enum } from './stage-ingest-data-mode-enum.js';
 ...
 */
export class Stage_Ingest implements flatbuffers.IUnpackableObject<Stage_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Stage_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsStage_Ingest(bb:flatbuffers.ByteBuffer, obj?:Stage_Ingest):Stage_Ingest {
  return (obj || new Stage_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsStage_Ingest(bb:flatbuffers.ByteBuffer, obj?:Stage_Ingest):Stage_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Stage_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 82);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Stage_Ingest_dataMode_Enum.REAL;
}

static startStage_Ingest(builder:flatbuffers.Builder) {
...
unpack(): Stage_IngestT {
  return new Stage_IngestT(
    this.id(),
...
unpackTo(_o: Stage_IngestT): void {
  _o.id = this.id();
...
export class Stage_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Stage_Ingest_dataMode_Enum = Stage_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const photoURLs = Stage_Ingest.createPhotoUrlsVector(builder, builder.createObjectOffsetList(this.photoURLs));
  ...
  const tags = Stage_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return Stage_Ingest.createStage_Ingest(builder,
    id,
    idLaunchVehicle,
    idEngine,
