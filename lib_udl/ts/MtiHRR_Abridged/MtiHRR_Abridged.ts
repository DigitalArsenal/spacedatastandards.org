 ...
 */
export class MtiHRR_Abridged implements flatbuffers.IUnpackableObject<MtiHRR_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MtiHRR_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMtiHRR_Abridged(bb:flatbuffers.ByteBuffer, obj?:MtiHRR_Abridged):MtiHRR_Abridged {
  return (obj || new MtiHRR_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMtiHRR_Abridged(bb:flatbuffers.ByteBuffer, obj?:MtiHRR_Abridged):MtiHRR_Abridged {
...
static startMtiHRR_Abridged(builder:flatbuffers.Builder) {
...
static endMtiHRR_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishMtiHRR_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIH');
}

static finishSizePrefixedMtiHRR_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIH', true);
}

static createMtiHRR_Abridged(builder:flatbuffers.Builder, h2:number, h3:number, h4:boolean, h5:number, h6:number, h7:number, h8:number, h9:number, h10:number, h11:number, h12:number, h13:number, h14:number, h15:number, h16Offset:flatbuffers.Offset, h17Offset:flatbuffers.Offset, h18Offset:flatbuffers.Offset, h19:number, h20:number, h21:number, h22:number, h23Offset:flatbuffers.Offset, h24Offset:flatbuffers.Offset, h27:number, h28:bigint, h29:number, h30:number, h31:number, h32Offset:flatbuffers.Offset):flatbuffers.Offset {
  MtiHRR_Abridged.startMtiHRR_Abridged(builder);
...
unpack(): MtiHRR_AbridgedT {
  return new MtiHRR_AbridgedT(
    this.h2(),
    this.h3(),
    this.h4(),
    this.h5(),
...
unpackTo(_o: MtiHRR_AbridgedT): void {
  _o.h2 = this.h2();
  _o.h3 = this.h3();
  _o.h4 = this.h4();
  _o.h5 = this.h5();
...
export class MtiHRR_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  public h2: number = 0,
  public h3: number = 0,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const h32 = MtiHRR_Abridged.createH32Vector(builder, builder.createObjectOffsetList(this.h32));

  return MtiHRR_Abridged.createMtiHRR_Abridged(builder,
    this.h2,
    this.h3,
    this.h4,
    this.h5,
