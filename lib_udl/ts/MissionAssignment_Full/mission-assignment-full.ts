...
import { MissionAssignment_Full_dataMode_Enum } from './mission-assignment-full-data-mode-enum.js';


/**
 * /// Platform mission assignment data.
 */
export class MissionAssignment_Full implements flatbuffers.IUnpackableObject<MissionAssignment_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MissionAssignment_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMissionAssignment_Full(bb:flatbuffers.ByteBuffer, obj?:MissionAssignment_Full):MissionAssignment_Full {
  return (obj || new MissionAssignment_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMissionAssignment_Full(bb:flatbuffers.ByteBuffer, obj?:MissionAssignment_Full):MissionAssignment_Full {
...
dataMode():MissionAssignment_Full_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : MissionAssignment_Full_dataMode_Enum.REAL;
}
...
static startMissionAssignment_Full(builder:flatbuffers.Builder) {
...
static addUpdatedAt(builder:flatbuffers.Builder, updatedAtOffset:flatbuffers.Offset) {
  builder.addFieldOffset(62, updatedAtOffset, 0);
}

static addUpdatedBy(builder:flatbuffers.Builder, updatedByOffset:flatbuffers.Offset) {
  builder.addFieldOffset(63, updatedByOffset, 0);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:MissionAssignment_Full_dataMode_Enum) {
  builder.addFieldInt8(66, dataMode, MissionAssignment_Full_dataMode_Enum.REAL);
}
...
unpack(): MissionAssignment_FullT {
  return new MissionAssignment_FullT(
    this.id(),
...
unpackTo(_o: MissionAssignment_FullT): void {
  _o.id = this.id();
...
export class MissionAssignment_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: MissionAssignment_Full_dataMode_Enum = MissionAssignment_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return MissionAssignment_Full.createMissionAssignment_Full(builder,
    id,
