...
import { SGI_Full_dataMode_Enum } from './SGI_Full_dataMode_Enum.js';
import { SGI_Full_precedence_Enum } from './SGI_Full_precedence_Enum.js';
import { SGI_Full_state_Enum } from './SGI_Full_state_Enum.js';


/**
 * /// Model representation of space weather/solar, geomagnetic, and radiation belt indices.
 */
export class SGI_Full implements flatbuffers.IUnpackableObject<SGI_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SGI_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSGI_Full(bb:flatbuffers.ByteBuffer, obj?:SGI_Full):SGI_Full {
  return (obj || new SGI_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSGI_Full(bb:flatbuffers.ByteBuffer, obj?:SGI_Full):SGI_Full {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new SGI_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static bufferHasIdentifier(bb:flatbuffers.ByteBuffer):boolean {
  return bb.__has_identifier('SGIF');
}
...
state():SGI_Full_state_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SGI_Full_state_Enum.I;
}
...
precedence():SGI_Full_precedence_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SGI_Full_precedence_Enum.O;
}
...
dataMode():SGI_Full_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SGI_Full_dataMode_Enum.REAL;
}
...
static startSGI_Full(builder:flatbuffers.Builder) {
...
static addState(builder:flatbuffers.Builder, state:SGI_Full_state_Enum) {
  builder.addFieldInt8(5, state, SGI_Full_state_Enum.I);
}
...
static addPrecedence(builder:flatbuffers.Builder, precedence:SGI_Full_precedence_Enum) {
  builder.addFieldInt8(10, precedence, SGI_Full_precedence_Enum.O);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SGI_Full_dataMode_Enum) {
  builder.addFieldInt8(50, dataMode, SGI_Full_dataMode_Enum.REAL);
}
...
static addUpdatedAt(builder:flatbuffers.Builder, updatedAtOffset:flatbuffers.Offset) {
  builder.addFieldOffset(53, updatedAtOffset, 0);
}

static addUpdatedBy(builder:flatbuffers.Builder, updatedByOffset:flatbuffers.Offset) {
  builder.addFieldOffset(54, updatedByOffset, 0);
}

static endSGI_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSGI_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SGIF');
}

static finishSizePrefixedSGI_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SGIF', true);
}

static createSGI_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, effectiveDateOffset:flatbuffers.Offset, sgiDateOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, state:SGI_Full_state_Enum, stationNameOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, origSensorIdOffset:flatbuffers.Offset, mode:number, precedence:SGI_Full_precedence_Enum, coeffDegreeOffset:flatbuffers.Offset, coeffOrderOffset:flatbuffers.Offset, ctceOffset:flatbuffers.Offset, stceOffset:flatbuffers.Offset, ctciOffset:flatbuffers.Offset, stciOffset:flatbuffers.Offset, e10:number, e54:number, s10:number, s54:number, m10:number, m54:number, y10:number, y54:number, f10:number, f54:number, f81:number, ap:number, apDuration:number, kIndex:number, kp:number, kpDuration:number, gamma:number, dst:number, dtc:number, rbRegionCode:number, rbIndex:number, normFactor:number, rbDuration:number, analyzerAttenuation:number, observedBaselineOffset:flatbuffers.Offset, frequenciesOffset:flatbuffers.Offset, powersOffset:flatbuffers.Offset, rawFileUriOffset:flatbuffers.Offset, transactionIdOffset:flatbuffers.Offset, tagsOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:SGI_Full_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset):flatbuffers.Offset {
  SGI_Full.startSGI_Full(builder);
  SGI_Full.addId(builder, idOffset);
  SGI_Full.addClassificationMarking(builder, classificationMarkingOffset);
  SGI_Full.addEffectiveDate(builder, effectiveDateOffset);
  SGI_Full.addSgiDate(builder, sgiDateOffset);
  SGI_Full.addType(builder, typeOffset);
  SGI_Full.addState(builder, state);
  SGI_Full.addStationName(builder, stationNameOffset);
  SGI_Full.addIdSensor(builder, idSensorOffset);
  SGI_Full.addOrigSensorId(builder, origSensorIdOffset);
  SGI_Full.addMode(builder, mode);
  SGI_Full.addPrecedence(builder, precedence);
  SGI_Full.addCoeffDegree(builder, coeffDegreeOffset);
  SGI_Full.addCoeffOrder(builder, coeffOrderOffset);
  SGI_Full.addCtce(builder, ctceOffset);
  SGI_Full.addStce(builder, stceOffset);
  SGI_Full.addCtci(builder, ctciOffset);
  SGI_Full.addStci(builder, stciOffset);
  SGI_Full.addE10(builder, e10);
  SGI_Full.addE54(builder, e54);
  SGI_Full.addS10(builder, s10);
  SGI_Full.addS54(builder, s54);
  SGI_Full.addM10(builder, m10);
  SGI_Full.addM54(builder, m54);
  SGI_Full.addY10(builder, y10);
  SGI_Full.addY54(builder, y54);
  SGI_Full.addF10(builder, f10);
  SGI_Full.addF54(builder, f54);
  SGI_Full.addF81(builder, f81);
  SGI_Full.addAp(builder, ap);
  SGI_Full.addApDuration(builder, apDuration);
  SGI_Full.addKIndex(builder, kIndex);
  SGI_Full.addKp(builder, kp);
  SGI_Full.addKpDuration(builder, kpDuration);
  SGI_Full.addGamma(builder, gamma);
  SGI_Full.addDst(builder, dst);
  SGI_Full.addDtc(builder, dtc);
  SGI_Full.addRbRegionCode(builder, rbRegionCode);
  SGI_Full.addRbIndex(builder, rbIndex);
  SGI_Full.addNormFactor(builder, normFactor);
  SGI_Full.addRbDuration(builder, rbDuration);
  SGI_Full.addAnalyzerAttenuation(builder, analyzerAttenuation);
  SGI_Full.addObservedBaseline(builder, observedBaselineOffset);
  SGI_Full.addFrequencies(builder, frequenciesOffset);
  SGI_Full.addPowers(builder, powersOffset);
  SGI_Full.addRawFileUri(builder, rawFileUriOffset);
  SGI_Full.addTransactionId(builder, transactionIdOffset);
  SGI_Full.addTags(builder, tagsOffset);
  SGI_Full.addSource(builder, sourceOffset);
  SGI_Full.addOrigin(builder, originOffset);
  SGI_Full.addOrigNetwork(builder, origNetworkOffset);
  SGI_Full.addDataMode(builder, dataMode);
  SGI_Full.addCreatedAt(builder, createdAtOffset);
  SGI_Full.addCreatedBy(builder, createdByOffset);
  SGI_Full.addUpdatedAt(builder, updatedAtOffset);
  SGI_Full.addUpdatedBy(builder, updatedByOffset);
  return SGI_Full.endSGI_Full(builder);
}

unpack(): SGI_FullT {
  return new SGI_FullT(
    this.id(),
    ...
    this.bb!.createScalarList<string>(this.observedBaseline.bind(this), this.observedBaselineLength()),
...
unpackTo(_o: SGI_FullT): void {
  ...
  _o.observedBaseline = this.bb!.createScalarList<string>(this.observedBaseline.bind(this), this.observedBaselineLength());
...
export class SGI_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public state: SGI_Full_state_Enum = SGI_Full_state_Enum.I,
  ...
  public precedence: SGI_Full_precedence_Enum = SGI_Full_precedence_Enum.O,
  ...
  public dataMode: SGI_Full_dataMode_Enum = SGI_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const coeffDegree = SGI_Full.createCoeffDegreeVector(builder, builder.createObjectOffsetList(this.coeffDegree));
  const coeffOrder = SGI_Full.createCoeffOrderVector(builder, builder.createObjectOffsetList(this.coeffOrder));
  const ctce = SGI_Full.createCtceVector(builder, builder.createObjectOffsetList(this.ctce));
  const stce = SGI_Full.createStceVector(builder, builder.createObjectOffsetList(this.stce));
  const ctci = SGI_Full.createCtciVector(builder, builder.createObjectOffsetList(this.ctci));
  const stci = SGI_Full.createStciVector(builder, builder.createObjectOffsetList(this.stci));
  const observedBaseline = SGI_Full.createObservedBaselineVector(builder, builder.createObjectOffsetList(this.observedBaseline));
  const frequencies = SGI_Full.createFrequenciesVector(builder, builder.createObjectOffsetList(this.frequencies));
  const powers = SGI_Full.createPowersVector(builder, builder.createObjectOffsetList(this.powers));
  ...
  const tags = SGI_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return SGI_Full.createSGI_Full(builder,
    id,
