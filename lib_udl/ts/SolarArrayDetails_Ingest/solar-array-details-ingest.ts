...
import { SolarArrayDetails_Ingest_dataMode_Enum } from './solar-array-details-ingest-data-mode-enum.js';
 ...
 */
export class SolarArrayDetails_Ingest implements flatbuffers.IUnpackableObject<SolarArrayDetails_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SolarArrayDetails_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSolarArrayDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:SolarArrayDetails_Ingest):SolarArrayDetails_Ingest {
  return (obj || new SolarArrayDetails_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSolarArrayDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:SolarArrayDetails_Ingest):SolarArrayDetails_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SolarArrayDetails_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 34);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SolarArrayDetails_Ingest_dataMode_Enum.REAL;
}
...
static startSolarArrayDetails_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SolarArrayDetails_Ingest_dataMode_Enum) {
  builder.addFieldInt8(15, dataMode, SolarArrayDetails_Ingest_dataMode_Enum.REAL);
}

static addTags(builder:flatbuffers.Builder, tagsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(16, tagsOffset, 0);
}
...
static endSolarArrayDetails_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSolarArrayDetails_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SOLA');
}

static finishSizePrefixedSolarArrayDetails_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SOLA', true);
}

static createSolarArrayDetails_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idSolarArrayOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, technologyOffset:flatbuffers.Offset, junctionTechnologyOffset:flatbuffers.Offset, manufacturerOrgIdOffset:flatbuffers.Offset, span:number, area:number, descriptionOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:SolarArrayDetails_Ingest_dataMode_Enum, tagsOffset:flatbuffers.Offset):flatbuffers.Offset {
  SolarArrayDetails_Ingest.startSolarArrayDetails_Ingest(builder);
...
unpack(): SolarArrayDetails_IngestT {
  return new SolarArrayDetails_IngestT(
    this.id(),
    this.idSolarArray(),
...
unpackTo(_o: SolarArrayDetails_IngestT): void {
  _o.id = this.id();
...
export class SolarArrayDetails_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SolarArrayDetails_Ingest_dataMode_Enum = SolarArrayDetails_Ingest_dataMode_Enum.REAL,
  public tags: (string)[] = []
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = SolarArrayDetails_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));

  return SolarArrayDetails_Ingest.createSolarArrayDetails_Ingest(builder,
    id,
    idSolarArray,
