 ...
 */
export class DataLinkOps_Ingest implements flatbuffers.IUnpackableObject<DataLinkOps_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):DataLinkOps_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsDataLinkOps_Ingest(bb:flatbuffers.ByteBuffer, obj?:DataLinkOps_Ingest):DataLinkOps_Ingest {
  return (obj || new DataLinkOps_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsDataLinkOps_Ingest(bb:flatbuffers.ByteBuffer, obj?:DataLinkOps_Ingest):DataLinkOps_Ingest {
...
static startDataLinkOps_Ingest(builder:flatbuffers.Builder) {
...
static endDataLinkOps_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishDataLinkOps_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DATA');
}

static finishSizePrefixedDataLinkOps_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DATA', true);
}

static createDataLinkOps_Ingest(builder:flatbuffers.Builder, linkNameOffset:flatbuffers.Offset, linkStartTimeOffset:flatbuffers.Offset, linkStopTimeOffset:flatbuffers.Offset, linkStopTimeModOffset:flatbuffers.Offset, linkDetailsOffset:flatbuffers.Offset):flatbuffers.Offset {
  DataLinkOps_Ingest.startDataLinkOps_Ingest(builder);
...
unpack(): DataLinkOps_IngestT {
  return new DataLinkOps_IngestT(
    this.linkName(),
    this.linkStartTime(),
    this.linkStopTime(),
...
unpackTo(_o: DataLinkOps_IngestT): void {
...
export class DataLinkOps_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return DataLinkOps_Ingest.createDataLinkOps_Ingest(builder,
    linkName,
    linkStartTime,
    linkStopTime,
    linkStopTimeMod,
