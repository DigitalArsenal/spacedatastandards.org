...
import { SeradataSpacecraftDetails_Full_dataMode_Enum } from './SeradataSpacecraftDetails_Full_dataMode_Enum.js';
...
unpack(): SeradataSpacecraftDetails_FullT {
  return new SeradataSpacecraftDetails_FullT(
    ...
    this.updatedAt(),
    this.updatedBy(),
    this.bb!.createScalarList<string>(this.seradataSigIntPayload.bind(this), this.seradataSigIntPayloadLength()),
    this.bb!.createScalarList<string>(this.seradataRadarPayload.bind(this), this.seradataRadarPayloadLength()),
    this.bb!.createScalarList<string>(this.seradataNavigation.bind(this), this.seradataNavigationLength()),
    this.bb!.createScalarList<string>(this.seradataOpticalPayload.bind(this), this.seradataOpticalPayloadLength()),
    this.bb!.createScalarList<string>(this.seradataEarlyWarning.bind(this), this.seradataEarlyWarningLength()),
    this.bb!.createScalarList<string>(this.scientific.bind(this), this.scientificLength()),
    this.bb!.createScalarList<string>(this.seradataCommDetails.bind(this), this.seradataCommDetailsLength()),
    this.onOrbit()
  );
}
...
unpackTo(_o: SeradataSpacecraftDetails_FullT): void {
  ...
  _o.seradataSigIntPayload = this.bb!.createScalarList<string>(this.seradataSigIntPayload.bind(this), this.seradataSigIntPayloadLength());
  _o.seradataRadarPayload = this.bb!.createScalarList<string>(this.seradataRadarPayload.bind(this), this.seradataRadarPayloadLength());
  _o.seradataNavigation = this.bb!.createScalarList<string>(this.seradataNavigation.bind(this), this.seradataNavigationLength());
  _o.seradataOpticalPayload = this.bb!.createScalarList<string>(this.seradataOpticalPayload.bind(this), this.seradataOpticalPayloadLength());
  _o.seradataEarlyWarning = this.bb!.createScalarList<string>(this.seradataEarlyWarning.bind(this), this.seradataEarlyWarningLength());
  _o.scientific = this.bb!.createScalarList<string>(this.scientific.bind(this), this.scientificLength());
  _o.seradataCommDetails = this.bb!.createScalarList<string>(this.seradataCommDetails.bind(this), this.seradataCommDetailsLength());
