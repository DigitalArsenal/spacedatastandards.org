 ...
 */
export class MtiHRR_Full implements flatbuffers.IUnpackableObject<MtiHRR_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MtiHRR_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMtiHRR_Full(bb:flatbuffers.ByteBuffer, obj?:MtiHRR_Full):MtiHRR_Full {
  return (obj || new MtiHRR_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMtiHRR_Full(bb:flatbuffers.ByteBuffer, obj?:MtiHRR_Full):MtiHRR_Full {
...
static startMtiHRR_Full(builder:flatbuffers.Builder) {
...
static endMtiHRR_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishMtiHRR_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIH');
}

static finishSizePrefixedMtiHRR_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIH', true);
}

static createMtiHRR_Full(builder:flatbuffers.Builder, h2:number, h3:number, h4:boolean, h5:number, h6:number, h7:number, h8:number, h9:number, h10:number, h11:number, h12:number, h13:number, h14:number, h15:number, h16Offset:flatbuffers.Offset, h17Offset:flatbuffers.Offset, h18Offset:flatbuffers.Offset, h19:number, h20:number, h21:number, h22:number, h23Offset:flatbuffers.Offset, h24Offset:flatbuffers.Offset, h27:number, h28:bigint, h29:number, h30:number, h31:number, h32Offset:flatbuffers.Offset):flatbuffers.Offset {
  MtiHRR_Full.startMtiHRR_Full(builder);
...
unpack(): MtiHRR_FullT {
  return new MtiHRR_FullT(
    ...
    this.h30(),
    this.h31(),
    this.bb!.createScalarList<string>(this.h32.bind(this), this.h32Length())
  );
}


unpackTo(_o: MtiHRR_FullT): void {
  _o.h2 = this.h2();
  _o.h3 = this.h3();
  _o.h4 = this.h4();
  _o.h5 = this.h5();
  ...
  _o.h30 = this.h30();
  _o.h31 = this.h31();
  _o.h32 = this.bb!.createScalarList<string>(this.h32.bind(this), this.h32Length());
}
}

export class MtiHRR_FullT implements flatbuffers.IGeneratedObject {
constructor(
  public h2: number = 0,
  public h3: number = 0,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const h32 = MtiHRR_Full.createH32Vector(builder, builder.createObjectOffsetList(this.h32));

  return MtiHRR_Full.createMtiHRR_Full(builder,
    this.h2,
    this.h3,
    this.h4,
    this.h5,
