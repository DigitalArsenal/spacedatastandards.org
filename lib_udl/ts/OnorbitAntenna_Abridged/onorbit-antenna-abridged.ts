...
import { OnorbitAntenna_Abridged_dataMode_Enum } from './onorbit-antenna-abridged-data-mode-enum.js';


/**
 * /// No description available.
 */
export class OnorbitAntenna_Abridged implements flatbuffers.IUnpackableObject<OnorbitAntenna_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OnorbitAntenna_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOnorbitAntenna_Abridged(bb:flatbuffers.ByteBuffer, obj?:OnorbitAntenna_Abridged):OnorbitAntenna_Abridged {
  return (obj || new OnorbitAntenna_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOnorbitAntenna_Abridged(bb:flatbuffers.ByteBuffer, obj?:OnorbitAntenna_Abridged):OnorbitAntenna_Abridged {
 ...
 */
dataMode():OnorbitAntenna_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 20);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OnorbitAntenna_Abridged_dataMode_Enum.REAL;
}
...
static startOnorbitAntenna_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:OnorbitAntenna_Abridged_dataMode_Enum) {
  builder.addFieldInt8(8, dataMode, OnorbitAntenna_Abridged_dataMode_Enum.REAL);
}
...
static endOnorbitAntenna_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishOnorbitAntenna_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ONOR');
}

static finishSizePrefixedOnorbitAntenna_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ONOR', true);
}

static createOnorbitAntenna_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, idAntennaOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:OnorbitAntenna_Abridged_dataMode_Enum, antennaOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  OnorbitAntenna_Abridged.startOnorbitAntenna_Abridged(builder);
...
unpack(): OnorbitAntenna_AbridgedT {
  return new OnorbitAntenna_AbridgedT(
    this.id(),
    this.idOnOrbit(),
    this.idAntenna(),
...
unpackTo(_o: OnorbitAntenna_AbridgedT): void {
  _o.id = this.id();
...
export class OnorbitAntenna_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: OnorbitAntenna_Abridged_dataMode_Enum = OnorbitAntenna_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return OnorbitAntenna_Abridged.createOnorbitAntenna_Abridged(builder,
    id,
    idOnOrbit,
    idAntenna,
