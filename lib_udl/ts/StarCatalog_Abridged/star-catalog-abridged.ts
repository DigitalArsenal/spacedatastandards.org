...
import { StarCatalog_Abridged_astrometryOrigin_Enum } from './star-catalog-abridged-astrometry-origin-enum.js';
import { StarCatalog_Abridged_dataMode_Enum } from './star-catalog-abridged-data-mode-enum.js';


/**
 * /// The star catalog provides the position, proper motion, parallax, and photometric magnitudes at various bandpasses of a star.
 */
export class StarCatalog_Abridged implements flatbuffers.IUnpackableObject<StarCatalog_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):StarCatalog_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsStarCatalog_Abridged(bb:flatbuffers.ByteBuffer, obj?:StarCatalog_Abridged):StarCatalog_Abridged {
  return (obj || new StarCatalog_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsStarCatalog_Abridged(bb:flatbuffers.ByteBuffer, obj?:StarCatalog_Abridged):StarCatalog_Abridged {
 ...
 */
astrometryOrigin():StarCatalog_Abridged_astrometryOrigin_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 42);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : StarCatalog_Abridged_astrometryOrigin_Enum.GAIADR3;
}
 ...
 */
dataMode():StarCatalog_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 98);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : StarCatalog_Abridged_dataMode_Enum.REAL;
}

static startStarCatalog_Abridged(builder:flatbuffers.Builder) {
...
static addAstrometryOrigin(builder:flatbuffers.Builder, astrometryOrigin:StarCatalog_Abridged_astrometryOrigin_Enum) {
  builder.addFieldInt8(19, astrometryOrigin, StarCatalog_Abridged_astrometryOrigin_Enum.GAIADR3);
}
...
unpack(): StarCatalog_AbridgedT {
  return new StarCatalog_AbridgedT(
    this.id(),
...
unpackTo(_o: StarCatalog_AbridgedT): void {
  _o.id = this.id();
...
export class StarCatalog_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public astrometryOrigin: StarCatalog_Abridged_astrometryOrigin_Enum = StarCatalog_Abridged_astrometryOrigin_Enum.GAIADR3,
  ...
  public dataMode: StarCatalog_Abridged_dataMode_Enum = StarCatalog_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return StarCatalog_Abridged.createStarCatalog_Abridged(builder,
    id,
