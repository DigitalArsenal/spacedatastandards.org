...
import { Aircraft_Ingest_dataMode_Enum } from './aircraft-ingest-data-mode-enum.js';
 ...
 */
export class Aircraft_Ingest implements flatbuffers.IUnpackableObject<Aircraft_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Aircraft_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAircraft_Ingest(bb:flatbuffers.ByteBuffer, obj?:Aircraft_Ingest):Aircraft_Ingest {
  return (obj || new Aircraft_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAircraft_Ingest(bb:flatbuffers.ByteBuffer, obj?:Aircraft_Ingest):Aircraft_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 64
 */
dataMode():Aircraft_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 48);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Aircraft_Ingest_dataMode_Enum.REAL;
}
...
static startAircraft_Ingest(builder:flatbuffers.Builder) {
...
static addSourceDl(builder:flatbuffers.Builder, sourceDlOffset:flatbuffers.Offset) {
  builder.addFieldOffset(19, sourceDlOffset, 0);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Aircraft_Ingest_dataMode_Enum) {
  builder.addFieldInt8(22, dataMode, Aircraft_Ingest_dataMode_Enum.REAL);
}
...
static endAircraft_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAircraft_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRC');
}

static finishSizePrefixedAircraft_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRC', true);
}

static createAircraft_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, entityOffset:flatbuffers.Offset, idEntityOffset:flatbuffers.Offset, aircraftMdsOffset:flatbuffers.Offset, tailNumberOffset:flatbuffers.Offset, serialNumberOffset:flatbuffers.Offset, ownerOffset:flatbuffers.Offset, commandOffset:flatbuffers.Offset, categoryOffset:flatbuffers.Offset, dtdOffset:flatbuffers.Offset, cruiseSpeed:number, maxSpeed:number, minReqRunwayM:number, minReqRunwayFt:number, nominalTatime:number, notesOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:Aircraft_Ingest_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  Aircraft_Ingest.startAircraft_Ingest(builder);
...
unpack(): Aircraft_IngestT {
  return new Aircraft_IngestT(
    this.id(),
...
unpackTo(_o: Aircraft_IngestT): void {
  _o.id = this.id();
...
export class Aircraft_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Aircraft_Ingest_dataMode_Enum = Aircraft_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Aircraft_Ingest.createAircraft_Ingest(builder,
    id,
