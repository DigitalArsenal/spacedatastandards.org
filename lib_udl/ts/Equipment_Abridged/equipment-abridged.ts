...
import { Equipment_Abridged_dataMode_Enum } from './equipment-abridged-data-mode-enum.js';


/**
 * /// Properties and characteristics of equipment that can be associated with a site or other entity.
 */
export class Equipment_Abridged implements flatbuffers.IUnpackableObject<Equipment_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Equipment_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEquipment_Abridged(bb:flatbuffers.ByteBuffer, obj?:Equipment_Abridged):Equipment_Abridged {
  return (obj || new Equipment_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEquipment_Abridged(bb:flatbuffers.ByteBuffer, obj?:Equipment_Abridged):Equipment_Abridged {
 ...
 */
dataMode():Equipment_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 108);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Equipment_Abridged_dataMode_Enum.REAL;
}

static startEquipment_Abridged(builder:flatbuffers.Builder) {
...
static createEquipment_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idParentEquipmentOffset:flatbuffers.Offset, idSiteOffset:flatbuffers.Offset, idOperatingUnitOffset:flatbuffers.Offset, altEqpIdOffset:flatbuffers.Offset, eqpCodeOffset:flatbuffers.Offset, eqpIdNumOffset:flatbuffers.Offset, countryCodeOffset:flatbuffers.Offset, altCountryCodeOffset:flatbuffers.Offset, wacOffset:flatbuffers.Offset, seqNum:number, nomenOffset:flatbuffers.Offset, operStatusOffset:flatbuffers.Offset, conditionOffset:flatbuffers.Offset, conditionAvailOffset:flatbuffers.Offset, eval:number, fpaOffset:flatbuffers.Offset, function_Offset:flatbuffers.Offset, identOffset:flatbuffers.Offset, allegianceOffset:flatbuffers.Offset, altAllegianceOffset:flatbuffers.Offset, locReasonOffset:flatbuffers.Offset, operAreaPrimaryOffset:flatbuffers.Offset, functPrimaryOffset:flatbuffers.Offset, coordDatumOffset:flatbuffers.Offset, coordOffset:flatbuffers.Offset, coordDerivAcc:number, lat:number, lon:number, elevMsl:number, elevMslConfLvl:number, elevMslDerivAcc:number, geoidalMslSep:number, milGridSysOffset:flatbuffers.Offset, milGridOffset:flatbuffers.Offset, utmOffset:flatbuffers.Offset, airDefAreaOffset:flatbuffers.Offset, polSubdivOffset:flatbuffers.Offset, qtyOh:number, symCodeOffset:flatbuffers.Offset, classRatingOffset:flatbuffers.Offset, recStatusOffset:flatbuffers.Offset, reviewDateOffset:flatbuffers.Offset, resProdOffset:flatbuffers.Offset, referenceDocOffset:flatbuffers.Offset, srcTypsOffset:flatbuffers.Offset, srcIdsOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:Equipment_Abridged_dataMode_Enum):flatbuffers.Offset {
  ...
  Equipment_Abridged.addFunction(builder, function_Offset);
...
unpack(): Equipment_AbridgedT {
  return new Equipment_AbridgedT(
    this.id(),
...
unpackTo(_o: Equipment_AbridgedT): void {
  _o.id = this.id();
...
export class Equipment_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Equipment_Abridged_dataMode_Enum = Equipment_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const srcTyps = Equipment_Abridged.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = Equipment_Abridged.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  const createdAt = (this.createdAt !== null ? builder.createString(this.createdAt!) : 0);
  const createdBy = (this.createdBy !== null ? builder.createString(this.createdBy!) : 0);
  const source = (this.source !== null ? builder.createString(this.source!) : 0);
  const origin = (this.origin !== null ? builder.createString(this.origin!) : 0);

  return Equipment_Abridged.createEquipment_Abridged(builder,
    id,
