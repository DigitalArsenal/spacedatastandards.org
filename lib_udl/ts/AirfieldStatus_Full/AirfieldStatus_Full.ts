...
import { AirfieldStatus_Full_dataMode_Enum } from './AirfieldStatus_Full_dataMode_Enum.js';


/**
 * /// The airfield status contains dynamic data of an airfield's capabilities.
 */
export class AirfieldStatus_Full implements flatbuffers.IUnpackableObject<AirfieldStatus_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirfieldStatus_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirfieldStatus_Full(bb:flatbuffers.ByteBuffer, obj?:AirfieldStatus_Full):AirfieldStatus_Full {
  return (obj || new AirfieldStatus_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirfieldStatus_Full(bb:flatbuffers.ByteBuffer, obj?:AirfieldStatus_Full):AirfieldStatus_Full {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():AirfieldStatus_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 78);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirfieldStatus_Full_dataMode_Enum.REAL;
}

static startAirfieldStatus_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AirfieldStatus_Full_dataMode_Enum) {
  builder.addFieldInt8(37, dataMode, AirfieldStatus_Full_dataMode_Enum.REAL);
}

static endAirfieldStatus_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirfieldStatus_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRF');
}

static finishSizePrefixedAirfieldStatus_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRF', true);
}

static createAirfieldStatus_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idAirfieldOffset:flatbuffers.Offset, altAirfieldIdOffset:flatbuffers.Offset, passengerServiceMog:number, fleetServiceMog:number, cargoMog:number, fuelMog:number, fuelTypesOffset:flatbuffers.Offset, fuelQtysOffset:flatbuffers.Offset, mxMog:number, operatingMog:number, numCog:number, wideWorkingMog:number, wideParkingMog:number, narrowWorkingMog:number, narrowParkingMog:number, mheTypesOffset:flatbuffers.Offset, mheQtysOffset:flatbuffers.Offset, medCapOffset:flatbuffers.Offset, arffCatOffset:flatbuffers.Offset, gseTime:number, priRwyNumOffset:flatbuffers.Offset, rwyCondReading:number, rwyFrictionFactor:number, rwyMarkingsOffset:flatbuffers.Offset, messageOffset:flatbuffers.Offset, priFreq:number, slotTypesReqOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:AirfieldStatus_Full_dataMode_Enum):flatbuffers.Offset {
  AirfieldStatus_Full.startAirfieldStatus_Full(builder);
  AirfieldStatus_Full.addId(builder, idOffset);
  AirfieldStatus_Full.addClassificationMarking(builder, classificationMarkingOffset);
  AirfieldStatus_Full.addIdAirfield(builder, idAirfieldOffset);
  AirfieldStatus_Full.addAltAirfieldId(builder, altAirfieldIdOffset);
  AirfieldStatus_Full.addPassengerServiceMog(builder, passengerServiceMog);
  AirfieldStatus_Full.addFleetServiceMog(builder, fleetServiceMog);
  AirfieldStatus_Full.addCargoMog(builder, cargoMog);
  AirfieldStatus_Full.addFuelMog(builder, fuelMog);
  AirfieldStatus_Full.addFuelTypes(builder, fuelTypesOffset);
  AirfieldStatus_Full.addFuelQtys(builder, fuelQtysOffset);
  AirfieldStatus_Full.addMxMog(builder, mxMog);
  AirfieldStatus_Full.addOperatingMog(builder, operatingMog);
  AirfieldStatus_Full.addNumCog(builder, numCog);
  AirfieldStatus_Full.addWideWorkingMog(builder, wideWorkingMog);
  AirfieldStatus_Full.addWideParkingMog(builder, wideParkingMog);
  AirfieldStatus_Full.addNarrowWorkingMog(builder, narrowWorkingMog);
  AirfieldStatus_Full.addNarrowParkingMog(builder, narrowParkingMog);
  AirfieldStatus_Full.addMheTypes(builder, mheTypesOffset);
  AirfieldStatus_Full.addMheQtys(builder, mheQtysOffset);
  AirfieldStatus_Full.addMedCap(builder, medCapOffset);
  AirfieldStatus_Full.addArffCat(builder, arffCatOffset);
  AirfieldStatus_Full.addGseTime(builder, gseTime);
  AirfieldStatus_Full.addPriRwyNum(builder, priRwyNumOffset);
  AirfieldStatus_Full.addRwyCondReading(builder, rwyCondReading);
  AirfieldStatus_Full.addRwyFrictionFactor(builder, rwyFrictionFactor);
  AirfieldStatus_Full.addRwyMarkings(builder, rwyMarkingsOffset);
  AirfieldStatus_Full.addMessage(builder, messageOffset);
  AirfieldStatus_Full.addPriFreq(builder, priFreq);
  AirfieldStatus_Full.addSlotTypesReq(builder, slotTypesReqOffset);
  AirfieldStatus_Full.addCreatedAt(builder, createdAtOffset);
  AirfieldStatus_Full.addCreatedBy(builder, createdByOffset);
  AirfieldStatus_Full.addUpdatedAt(builder, updatedAtOffset);
  AirfieldStatus_Full.addUpdatedBy(builder, updatedByOffset);
  AirfieldStatus_Full.addSourceDl(builder, sourceDlOffset);
  AirfieldStatus_Full.addSource(builder, sourceOffset);
  AirfieldStatus_Full.addOrigin(builder, originOffset);
  AirfieldStatus_Full.addOrigNetwork(builder, origNetworkOffset);
  AirfieldStatus_Full.addDataMode(builder, dataMode);
  return AirfieldStatus_Full.endAirfieldStatus_Full(builder);
}

unpack(): AirfieldStatus_FullT {
  return new AirfieldStatus_FullT(
    this.id(),
...
unpackTo(_o: AirfieldStatus_FullT): void {
  _o.id = this.id();
...
export class AirfieldStatus_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AirfieldStatus_Full_dataMode_Enum = AirfieldStatus_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const fuelTypes = AirfieldStatus_Full.createFuelTypesVector(builder, builder.createObjectOffsetList(this.fuelTypes));
  const fuelQtys = AirfieldStatus_Full.createFuelQtysVector(builder, builder.createObjectOffsetList(this.fuelQtys));
  const mheTypes = AirfieldStatus_Full.createMheTypesVector(builder, builder.createObjectOffsetList(this.mheTypes));
  const mheQtys = AirfieldStatus_Full.createMheQtysVector(builder, builder.createObjectOffsetList(this.mheQtys));
  ...
  const rwyMarkings = AirfieldStatus_Full.createRwyMarkingsVector(builder, builder.createObjectOffsetList(this.rwyMarkings));
  const message = (this.message !== null ? builder.createString(this.message!) : 0);
  const slotTypesReq = AirfieldStatus_Full.createSlotTypesReqVector(builder, builder.createObjectOffsetList(this.slotTypesReq));
  ...
  return AirfieldStatus_Full.createAirfieldStatus_Full(builder,
    id,
