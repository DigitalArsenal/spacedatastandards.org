...
import { SeradataOpticalPayload_Abridged_dataMode_Enum } from './seradata-optical-payload-abridged-data-mode-enum.js';


/**
 * /// Details for an optical payload from  Seradata.
 */
export class SeradataOpticalPayload_Abridged implements flatbuffers.IUnpackableObject<SeradataOpticalPayload_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SeradataOpticalPayload_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSeradataOpticalPayload_Abridged(bb:flatbuffers.ByteBuffer, obj?:SeradataOpticalPayload_Abridged):SeradataOpticalPayload_Abridged {
  return (obj || new SeradataOpticalPayload_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSeradataOpticalPayload_Abridged(bb:flatbuffers.ByteBuffer, obj?:SeradataOpticalPayload_Abridged):SeradataOpticalPayload_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SeradataOpticalPayload_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 54);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SeradataOpticalPayload_Abridged_dataMode_Enum.REAL;
}

static startSeradataOpticalPayload_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SeradataOpticalPayload_Abridged_dataMode_Enum) {
  builder.addFieldInt8(25, dataMode, SeradataOpticalPayload_Abridged_dataMode_Enum.REAL);
}

static endSeradataOpticalPayload_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSeradataOpticalPayload_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA');
}

static finishSizePrefixedSeradataOpticalPayload_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA', true);
}

static createSeradataOpticalPayload_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, spacecraftIdOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, hostedForCompanyOrgIdOffset:flatbuffers.Offset, manufacturerOrgIdOffset:flatbuffers.Offset, imagingPayloadCategoryOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, spectralBandOffset:flatbuffers.Offset, spectralFrequencyLimitsOffset:flatbuffers.Offset, numberOfFilmReturnCanisters:number, bestResolution:number, swathWidth:number, recorderSizeOffset:flatbuffers.Offset, fieldOfView:number, fieldOfRegard:number, pointingMethodOffset:flatbuffers.Offset, groundStationsOffset:flatbuffers.Offset, groundStationLocationsOffset:flatbuffers.Offset, notesOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:SeradataOpticalPayload_Abridged_dataMode_Enum):flatbuffers.Offset {
  SeradataOpticalPayload_Abridged.startSeradataOpticalPayload_Abridged(builder);
...
unpack(): SeradataOpticalPayload_AbridgedT {
  return new SeradataOpticalPayload_AbridgedT(
    this.id(),
...
unpackTo(_o: SeradataOpticalPayload_AbridgedT): void {
  _o.id = this.id();
...
export class SeradataOpticalPayload_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SeradataOpticalPayload_Abridged_dataMode_Enum = SeradataOpticalPayload_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SeradataOpticalPayload_Abridged.createSeradataOpticalPayload_Abridged(builder,
    id,
