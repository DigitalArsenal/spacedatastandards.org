...
import { Country_Ingest_dataMode_Enum } from './country-ingest-data-mode-enum.js';


/**
 * /// A Country may represent countries, multi-national consortiums, and international organizations.
 */
export class Country_Ingest implements flatbuffers.IUnpackableObject<Country_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Country_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsCountry_Ingest(bb:flatbuffers.ByteBuffer, obj?:Country_Ingest):Country_Ingest {
  return (obj || new Country_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsCountry_Ingest(bb:flatbuffers.ByteBuffer, obj?:Country_Ingest):Country_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Country_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 22);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Country_Ingest_dataMode_Enum.REAL;
}

static startCountry_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Country_Ingest_dataMode_Enum) {
  builder.addFieldInt8(9, dataMode, Country_Ingest_dataMode_Enum.REAL);
}

static endCountry_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishCountry_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'COUN');
}

static finishSizePrefixedCountry_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'COUN', true);
}

static createCountry_Ingest(builder:flatbuffers.Builder, codeOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, fipsCodeOffset:flatbuffers.Offset, iso3CodeOffset:flatbuffers.Offset, codeAltOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:Country_Ingest_dataMode_Enum):flatbuffers.Offset {
  Country_Ingest.startCountry_Ingest(builder);
...
unpack(): Country_IngestT {
  return new Country_IngestT(
    this.code(),
    this.name(),
    this.fipsCode(),
    this.iso3Code(),
...
unpackTo(_o: Country_IngestT): void {
  _o.code = this.code();
  _o.name = this.name();
...
export class Country_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Country_Ingest_dataMode_Enum = Country_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Country_Ingest.createCountry_Ingest(builder,
    code,
    name,
    fipsCode,
    iso3Code,
