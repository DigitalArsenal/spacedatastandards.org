...
import { Manifold_Full_dataMode_Enum } from './manifold-full-data-mode-enum.js';


/**
 * /// A manifold represents a set of possible/theoretical orbits for an object of interest based on a delta V and delta T.
 */
export class Manifold_Full implements flatbuffers.IUnpackableObject<Manifold_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Manifold_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsManifold_Full(bb:flatbuffers.ByteBuffer, obj?:Manifold_Full):Manifold_Full {
  return (obj || new Manifold_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsManifold_Full(bb:flatbuffers.ByteBuffer, obj?:Manifold_Full):Manifold_Full {
 ...
 */
dataMode():Manifold_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 30);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Manifold_Full_dataMode_Enum.REAL;
}
...
static startManifold_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Manifold_Full_dataMode_Enum) {
  builder.addFieldInt8(13, dataMode, Manifold_Full_dataMode_Enum.REAL);
}
...
static endManifold_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishManifold_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MANI');
}

static finishSizePrefixedManifold_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MANI', true);
}

static createManifold_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idObjectOfInterestOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, statusOffset:flatbuffers.Offset, weight:number, deltaV:number, deltaT:number, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:Manifold_Full_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  Manifold_Full.startManifold_Full(builder);
...
unpack(): Manifold_FullT {
  return new Manifold_FullT(
    this.id(),
...
unpackTo(_o: Manifold_FullT): void {
  _o.id = this.id();
...
export class Manifold_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Manifold_Full_dataMode_Enum = Manifold_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Manifold_Full.createManifold_Full(builder,
    id,
    idObjectOfInterest,
