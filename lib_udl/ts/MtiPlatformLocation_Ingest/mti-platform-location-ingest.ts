 ...
 */
export class MtiPlatformLocation_Ingest implements flatbuffers.IUnpackableObject<MtiPlatformLocation_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MtiPlatformLocation_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMtiPlatformLocation_Ingest(bb:flatbuffers.ByteBuffer, obj?:MtiPlatformLocation_Ingest):MtiPlatformLocation_Ingest {
  return (obj || new MtiPlatformLocation_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMtiPlatformLocation_Ingest(bb:flatbuffers.ByteBuffer, obj?:MtiPlatformLocation_Ingest):MtiPlatformLocation_Ingest {
...
static startMtiPlatformLocation_Ingest(builder:flatbuffers.Builder) {
...
static endMtiPlatformLocation_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishMtiPlatformLocation_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIP');
}

static finishSizePrefixedMtiPlatformLocation_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIP', true);
}

static createMtiPlatformLocation_Ingest(builder:flatbuffers.Builder, l1:bigint, l2:number, l3:number, l4:number, l5:number, l6:number, l7:number, platloctsOffset:flatbuffers.Offset):flatbuffers.Offset {
  MtiPlatformLocation_Ingest.startMtiPlatformLocation_Ingest(builder);
...
unpack(): MtiPlatformLocation_IngestT {
  return new MtiPlatformLocation_IngestT(
    this.l1(),
    this.l2(),
    this.l3(),
    this.l4(),
...
unpackTo(_o: MtiPlatformLocation_IngestT): void {
  _o.l1 = this.l1();
  _o.l2 = this.l2();
  _o.l3 = this.l3();
  _o.l4 = this.l4();
...
export class MtiPlatformLocation_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return MtiPlatformLocation_Ingest.createMtiPlatformLocation_Ingest(builder,
    this.l1,
    this.l2,
    this.l3,
    this.l4,
