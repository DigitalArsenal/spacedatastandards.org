...
import { OrbitDetermination_Ingest_dataMode_Enum } from './orbit-determination-ingest-data-mode-enum.js';
 ...
 */
export class OrbitDetermination_Ingest implements flatbuffers.IUnpackableObject<OrbitDetermination_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OrbitDetermination_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOrbitDetermination_Ingest(bb:flatbuffers.ByteBuffer, obj?:OrbitDetermination_Ingest):OrbitDetermination_Ingest {
  return (obj || new OrbitDetermination_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOrbitDetermination_Ingest(bb:flatbuffers.ByteBuffer, obj?:OrbitDetermination_Ingest):OrbitDetermination_Ingest {
 ...
 */
dataMode():OrbitDetermination_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 90);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OrbitDetermination_Ingest_dataMode_Enum.REAL;
}

static startOrbitDetermination_Ingest(builder:flatbuffers.Builder) {
...
unpack(): OrbitDetermination_IngestT {
  return new OrbitDetermination_IngestT(
    this.id(),
...
unpackTo(_o: OrbitDetermination_IngestT): void {
  _o.id = this.id();
...
export class OrbitDetermination_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: OrbitDetermination_Ingest_dataMode_Enum = OrbitDetermination_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const acceptedObTyps = OrbitDetermination_Ingest.createAcceptedObTypsVector(builder, builder.createObjectOffsetList(this.acceptedObTyps));
  const acceptedObIds = OrbitDetermination_Ingest.createAcceptedObIdsVector(builder, builder.createObjectOffsetList(this.acceptedObIds));
  const rejectedObTyps = OrbitDetermination_Ingest.createRejectedObTypsVector(builder, builder.createObjectOffsetList(this.rejectedObTyps));
  const rejectedObIds = OrbitDetermination_Ingest.createRejectedObIdsVector(builder, builder.createObjectOffsetList(this.rejectedObIds));
  const sensorIds = OrbitDetermination_Ingest.createSensorIdsVector(builder, builder.createObjectOffsetList(this.sensorIds));
  ...
  return OrbitDetermination_Ingest.createOrbitDetermination_Ingest(builder,
    id,
