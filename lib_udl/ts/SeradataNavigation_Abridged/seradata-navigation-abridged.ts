...
import { SeradataNavigation_Abridged_dataMode_Enum } from './seradata-navigation-abridged-data-mode-enum.js';


/**
 * /// Details for a navigation payload from  Seradata.
 */
export class SeradataNavigation_Abridged implements flatbuffers.IUnpackableObject<SeradataNavigation_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SeradataNavigation_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSeradataNavigation_Abridged(bb:flatbuffers.ByteBuffer, obj?:SeradataNavigation_Abridged):SeradataNavigation_Abridged {
  return (obj || new SeradataNavigation_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSeradataNavigation_Abridged(bb:flatbuffers.ByteBuffer, obj?:SeradataNavigation_Abridged):SeradataNavigation_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SeradataNavigation_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 44);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SeradataNavigation_Abridged_dataMode_Enum.REAL;
}

static startSeradataNavigation_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SeradataNavigation_Abridged_dataMode_Enum) {
  builder.addFieldInt8(20, dataMode, SeradataNavigation_Abridged_dataMode_Enum.REAL);
}

static endSeradataNavigation_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSeradataNavigation_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA');
}

static finishSizePrefixedSeradataNavigation_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA', true);
}

static createSeradataNavigation_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idNavigationOffset:flatbuffers.Offset, spacecraftIdOffset:flatbuffers.Offset, hostedForCompanyOrgIdOffset:flatbuffers.Offset, manufacturerOrgIdOffset:flatbuffers.Offset, payloadTypeOffset:flatbuffers.Offset, modesOffset:flatbuffers.Offset, modeFrequencyOffset:flatbuffers.Offset, locationAccuracy:number, partnerSpacecraftIdOffset:flatbuffers.Offset, areaCoverageOffset:flatbuffers.Offset, notesOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, clockTypeOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:SeradataNavigation_Abridged_dataMode_Enum):flatbuffers.Offset {
  SeradataNavigation_Abridged.startSeradataNavigation_Abridged(builder);
...
unpack(): SeradataNavigation_AbridgedT {
  return new SeradataNavigation_AbridgedT(
    this.id(),
...
unpackTo(_o: SeradataNavigation_AbridgedT): void {
  _o.id = this.id();
...
export class SeradataNavigation_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SeradataNavigation_Abridged_dataMode_Enum = SeradataNavigation_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SeradataNavigation_Abridged.createSeradataNavigation_Abridged(builder,
    id,
