 ...
 */
export class IonoObservationAmplitude_Abridged implements flatbuffers.IUnpackableObject<IonoObservationAmplitude_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):IonoObservationAmplitude_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsIonoObservationAmplitude_Abridged(bb:flatbuffers.ByteBuffer, obj?:IonoObservationAmplitude_Abridged):IonoObservationAmplitude_Abridged {
  return (obj || new IonoObservationAmplitude_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIonoObservationAmplitude_Abridged(bb:flatbuffers.ByteBuffer, obj?:IonoObservationAmplitude_Abridged):IonoObservationAmplitude_Abridged {
...
static startIonoObservationAmplitude_Abridged(builder:flatbuffers.Builder) {
...
static endIonoObservationAmplitude_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishIonoObservationAmplitude_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO');
}

static finishSizePrefixedIonoObservationAmplitude_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO', true);
}

static createIonoObservationAmplitude_Abridged(builder:flatbuffers.Builder, notesOffset:flatbuffers.Offset, dimensionsOffset:flatbuffers.Offset, dimensionNameOffset:flatbuffers.Offset, dataOffset:flatbuffers.Offset):flatbuffers.Offset {
  IonoObservationAmplitude_Abridged.startIonoObservationAmplitude_Abridged(builder);
...
unpack(): IonoObservationAmplitude_AbridgedT {
  return new IonoObservationAmplitude_AbridgedT(
    this.notes(),
...
unpackTo(_o: IonoObservationAmplitude_AbridgedT): void {
  _o.notes = this.notes();
...
export class IonoObservationAmplitude_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const dimensions = IonoObservationAmplitude_Abridged.createDimensionsVector(builder, builder.createObjectOffsetList(this.dimensions));
  const dimensionName = IonoObservationAmplitude_Abridged.createDimensionNameVector(builder, builder.createObjectOffsetList(this.dimensionName));
  const data = IonoObservationAmplitude_Abridged.createDataVector(builder, builder.createObjectOffsetList(this.data));

  return IonoObservationAmplitude_Abridged.createIonoObservationAmplitude_Abridged(builder,
    notes,
    dimensions,
    dimensionName,
    data
