...
import { Status_Full_dataMode_Enum } from './Status_Full_dataMode_Enum.js';
import { Status_Full_opsCap_Enum } from './Status_Full_opsCap_Enum.js';
import { Status_Full_state_Enum } from './Status_Full_state_Enum.js';
import { Status_Full_sysCap_Enum } from './Status_Full_sysCap_Enum.js';


/**
 * /// Status for a particular Entity. An entity may have multiple status records collected by various sources.
 */
export class Status_Full implements flatbuffers.IUnpackableObject<Status_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Status_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsStatus_Full(bb:flatbuffers.ByteBuffer, obj?:Status_Full):Status_Full {
  return (obj || new Status_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsStatus_Full(bb:flatbuffers.ByteBuffer, obj?:Status_Full):Status_Full {
 ...
 */
state():Status_Full_state_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 16);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Status_Full_state_Enum.UNKNOWN;
}
 ...
 */
sysCap():Status_Full_sysCap_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 18);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Status_Full_sysCap_Enum.FMC;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 3
 */
opsCap():Status_Full_opsCap_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 20);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Status_Full_opsCap_Enum.FMC;
}
 ...
 */
dataMode():Status_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 26);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Status_Full_dataMode_Enum.REAL;
}
...
static startStatus_Full(builder:flatbuffers.Builder) {
...
static addState(builder:flatbuffers.Builder, state:Status_Full_state_Enum) {
  builder.addFieldInt8(6, state, Status_Full_state_Enum.UNKNOWN);
}

static addSysCap(builder:flatbuffers.Builder, sysCap:Status_Full_sysCap_Enum) {
  builder.addFieldInt8(7, sysCap, Status_Full_sysCap_Enum.FMC);
}

static addOpsCap(builder:flatbuffers.Builder, opsCap:Status_Full_opsCap_Enum) {
  builder.addFieldInt8(8, opsCap, Status_Full_opsCap_Enum.FMC);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Status_Full_dataMode_Enum) {
  builder.addFieldInt8(11, dataMode, Status_Full_dataMode_Enum.REAL);
}
...
static endStatus_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishStatus_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'STAT');
}

static finishSizePrefixedStatus_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'STAT', true);
}

static createStatus_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, derivedFromOffset:flatbuffers.Offset, declassificationDateOffset:flatbuffers.Offset, declassificationStringOffset:flatbuffers.Offset, idEntityOffset:flatbuffers.Offset, state:Status_Full_state_Enum, sysCap:Status_Full_sysCap_Enum, opsCap:Status_Full_opsCap_Enum, sourceOffset:flatbuffers.Offset, subStatusCollectionOffset:flatbuffers.Offset, dataMode:Status_Full_dataMode_Enum, notesOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  Status_Full.startStatus_Full(builder);
...
export class Status_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public state: Status_Full_state_Enum = Status_Full_state_Enum.UNKNOWN,
  public sysCap: Status_Full_sysCap_Enum = Status_Full_sysCap_Enum.FMC,
  public opsCap: Status_Full_opsCap_Enum = Status_Full_opsCap_Enum.FMC,
  public source: string|Uint8Array|null = null,
  public subStatusCollection: (string)[] = [],
  public dataMode: Status_Full_dataMode_Enum = Status_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const subStatusCollection = Status_Full.createSubStatusCollectionVector(builder, builder.createObjectOffsetList(this.subStatusCollection));
  ...
  return Status_Full.createStatus_Full(builder,
    id,
