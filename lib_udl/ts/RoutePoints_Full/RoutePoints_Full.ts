 ...
 */
export class RoutePoints_Full implements flatbuffers.IUnpackableObject<RoutePoints_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):RoutePoints_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsRoutePoints_Full(bb:flatbuffers.ByteBuffer, obj?:RoutePoints_Full):RoutePoints_Full {
  return (obj || new RoutePoints_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRoutePoints_Full(bb:flatbuffers.ByteBuffer, obj?:RoutePoints_Full):RoutePoints_Full {
...
static startRoutePoints_Full(builder:flatbuffers.Builder) {
...
static endRoutePoints_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishRoutePoints_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ROUT');
}

static finishSizePrefixedRoutePoints_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ROUT', true);
}

static createRoutePoints_Full(builder:flatbuffers.Builder, ptSequenceId:number, ptTypeCodeOffset:flatbuffers.Offset, ptTypeNameOffset:flatbuffers.Offset, waypointNameOffset:flatbuffers.Offset, dafifPt:boolean, ptLat:number, ptLon:number, magDec:number, navaidLength:number, navaidOffset:flatbuffers.Offset, countryCodeOffset:flatbuffers.Offset, altCountryCodeOffset:flatbuffers.Offset, navaidTypeOffset:flatbuffers.Offset):flatbuffers.Offset {
  RoutePoints_Full.startRoutePoints_Full(builder);
...
unpack(): RoutePoints_FullT {
  return new RoutePoints_FullT(
    this.ptSequenceId(),
    this.ptTypeCode(),
    this.ptTypeName(),
    this.waypointName(),
...
unpackTo(_o: RoutePoints_FullT): void {
...
export class RoutePoints_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return RoutePoints_Full.createRoutePoints_Full(builder,
    this.ptSequenceId,
    ptTypeCode,
    ptTypeName,
    waypointName,
