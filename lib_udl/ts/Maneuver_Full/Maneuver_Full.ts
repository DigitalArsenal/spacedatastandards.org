...
import { Maneuver_Full_dataMode_Enum } from './Maneuver_Full_dataMode_Enum.js';
import { Maneuver_Full_sourcedDataTypes_Enum } from './Maneuver_Full_sourcedDataTypes_Enum.js';


/**
 * /// Model representation of on-orbit object maneuver information for detected, possible, and confirmed maneuvers.
 */
export class Maneuver_Full implements flatbuffers.IUnpackableObject<Maneuver_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Maneuver_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsManeuver_Full(bb:flatbuffers.ByteBuffer, obj?:Maneuver_Full):Maneuver_Full {
  return (obj || new Maneuver_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsManeuver_Full(bb:flatbuffers.ByteBuffer, obj?:Maneuver_Full):Maneuver_Full {
...
dataMode():Maneuver_Full_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Maneuver_Full_dataMode_Enum.REAL;
}
...
sourcedDataTypes():Maneuver_Full_sourcedDataTypes_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Maneuver_Full_sourcedDataTypes_Enum.EO;
}
...
static startManeuver_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Maneuver_Full_dataMode_Enum) {
  builder.addFieldInt8(89, dataMode, Maneuver_Full_dataMode_Enum.REAL);
}
...
unpack(): Maneuver_FullT {
  return new Maneuver_FullT(
    this.id(),
...
unpackTo(_o: Maneuver_FullT): void {
  _o.id = this.id();
...
export class Maneuver_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Maneuver_Full_dataMode_Enum = Maneuver_Full_dataMode_Enum.REAL,
  public createdAt: string|Uint8Array|null = null,
  public createdBy: string|Uint8Array|null = null,
  public tags: (string)[] = [],
  public algorithm: string|Uint8Array|null = null,
  public sourcedData: (string)[] = [],
  public sourcedDataTypes: Maneuver_Full_sourcedDataTypes_Enum = Maneuver_Full_sourcedDataTypes_Enum.EO,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const cov = Maneuver_Full.createCovVector(builder, builder.createObjectOffsetList(this.cov));
  ...
  const mnvrAccelTimes = Maneuver_Full.createMnvrAccelTimesVector(builder, builder.createObjectOffsetList(this.mnvrAccelTimes));
  const mnvrAccels = Maneuver_Full.createMnvrAccelsVector(builder, builder.createObjectOffsetList(this.mnvrAccels));
  const mnvrAccelUncs = Maneuver_Full.createMnvrAccelUncsVector(builder, builder.createObjectOffsetList(this.mnvrAccelUncs));
  const source = (this.source !== null ? builder.createString(this.source!) : 0);
  const origin = (this.origin !== null ? builder.createString(this.origin!) : 0);
  const createdAt = (this.createdAt !== null ? builder.createString(this.createdAt!) : 0);
  const createdBy = (this.createdBy !== null ? builder.createString(this.createdBy!) : 0);
  const tags = Maneuver_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  const algorithm = (this.algorithm !== null ? builder.createString(this.algorithm!) : 0);
  const sourcedData = Maneuver_Full.createSourcedDataVector(builder, builder.createObjectOffsetList(this.sourcedData));
  ...
  return Maneuver_Full.createManeuver_Full(builder,
    id,
