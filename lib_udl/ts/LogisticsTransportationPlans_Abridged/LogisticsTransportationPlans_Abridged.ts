 ...
 */
export class LogisticsTransportationPlans_Abridged implements flatbuffers.IUnpackableObject<LogisticsTransportationPlans_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LogisticsTransportationPlans_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLogisticsTransportationPlans_Abridged(bb:flatbuffers.ByteBuffer, obj?:LogisticsTransportationPlans_Abridged):LogisticsTransportationPlans_Abridged {
  return (obj || new LogisticsTransportationPlans_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLogisticsTransportationPlans_Abridged(bb:flatbuffers.ByteBuffer, obj?:LogisticsTransportationPlans_Abridged):LogisticsTransportationPlans_Abridged {
...
static startLogisticsTransportationPlans_Abridged(builder:flatbuffers.Builder) {
...
unpack(): LogisticsTransportationPlans_AbridgedT {
  return new LogisticsTransportationPlans_AbridgedT(
    this.plansNumber(),
    this.missionChange(),
    this.planDefinition(),
    this.statusCode(),
    ...
    this.bb!.createScalarList<string>(this.logisticsSegments.bind(this), this.logisticsSegmentsLength()),
    this.bb!.createScalarList<string>(this.logisticsTransportationPlansRemarks.bind(this), this.logisticsTransportationPlansRemarksLength())
  );
}


unpackTo(_o: LogisticsTransportationPlans_AbridgedT): void {
  ...
  _o.logisticsSegments = this.bb!.createScalarList<string>(this.logisticsSegments.bind(this), this.logisticsSegmentsLength());
  _o.logisticsTransportationPlansRemarks = this.bb!.createScalarList<string>(this.logisticsTransportationPlansRemarks.bind(this), this.logisticsTransportationPlansRemarksLength());
}
}

export class LogisticsTransportationPlans_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const logisticsSegments = LogisticsTransportationPlans_Abridged.createLogisticsSegmentsVector(builder, builder.createObjectOffsetList(this.logisticsSegments));
  const logisticsTransportationPlansRemarks = LogisticsTransportationPlans_Abridged.createLogisticsTransportationPlansRemarksVector(builder, builder.createObjectOffsetList(this.logisticsTransportationPlansRemarks));

  return LogisticsTransportationPlans_Abridged.createLogisticsTransportationPlans_Abridged(builder,
    plansNumber,
    this.missionChange,
    planDefinition,
    statusCode,
