...
import { MissionAssignment_Abridged_dataMode_Enum } from './mission-assignment-abridged-data-mode-enum.js';


/**
 * /// Platform mission assignment data.
 */
export class MissionAssignment_Abridged implements flatbuffers.IUnpackableObject<MissionAssignment_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MissionAssignment_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMissionAssignment_Abridged(bb:flatbuffers.ByteBuffer, obj?:MissionAssignment_Abridged):MissionAssignment_Abridged {
  return (obj || new MissionAssignment_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMissionAssignment_Abridged(bb:flatbuffers.ByteBuffer, obj?:MissionAssignment_Abridged):MissionAssignment_Abridged {
 ...
 */
dataMode():MissionAssignment_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 132);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : MissionAssignment_Abridged_dataMode_Enum.REAL;
}
...
static startMissionAssignment_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:MissionAssignment_Abridged_dataMode_Enum) {
  builder.addFieldInt8(64, dataMode, MissionAssignment_Abridged_dataMode_Enum.REAL);
}
...
unpack(): MissionAssignment_AbridgedT {
  return new MissionAssignment_AbridgedT(
    this.id(),
...
unpackTo(_o: MissionAssignment_AbridgedT): void {
  _o.id = this.id();
...
export class MissionAssignment_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: MissionAssignment_Abridged_dataMode_Enum = MissionAssignment_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return MissionAssignment_Abridged.createMissionAssignment_Abridged(builder,
    id,
