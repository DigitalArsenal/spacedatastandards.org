 ...
 */
export class FlightPlanPointGroups_Abridged implements flatbuffers.IUnpackableObject<FlightPlanPointGroups_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):FlightPlanPointGroups_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsFlightPlanPointGroups_Abridged(bb:flatbuffers.ByteBuffer, obj?:FlightPlanPointGroups_Abridged):FlightPlanPointGroups_Abridged {
  return (obj || new FlightPlanPointGroups_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsFlightPlanPointGroups_Abridged(bb:flatbuffers.ByteBuffer, obj?:FlightPlanPointGroups_Abridged):FlightPlanPointGroups_Abridged {
...
static startFlightPlanPointGroups_Abridged(builder:flatbuffers.Builder) {
...
static endFlightPlanPointGroups_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishFlightPlanPointGroups_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'FLIG');
}

static finishSizePrefixedFlightPlanPointGroups_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'FLIG', true);
}

static createFlightPlanPointGroups_Abridged(builder:flatbuffers.Builder, pointGroupNameOffset:flatbuffers.Offset, worstFuelCaseOffset:flatbuffers.Offset, lsafNameOffset:flatbuffers.Offset, lsafDistance:number, fsafDistance:number, etopsDistance:number, lsafTimeOffset:flatbuffers.Offset, fsafTimeOffset:flatbuffers.Offset, etopsTimeOffset:flatbuffers.Offset, lsafAvgWindFactor:number, fsafAvgWindFactor:number, etopsAvgWindFactor:number, lsafTempDev:number, fsafTempDev:number, etopsTempDev:number, lsafReqFuel:number, fsafReqFuel:number, etopsReqFuel:number, fromTakeoffTimeOffset:flatbuffers.Offset, plannedFuel:number, fuelCalcAlt:number, fuelCalcSpd:number, avgFuelFlow:number, flightPlanPointsOffset:flatbuffers.Offset):flatbuffers.Offset {
  FlightPlanPointGroups_Abridged.startFlightPlanPointGroups_Abridged(builder);
...
unpack(): FlightPlanPointGroups_AbridgedT {
  return new FlightPlanPointGroups_AbridgedT(
    this.pointGroupName(),
    this.worstFuelCase(),
    this.lsafName(),
    this.lsafDistance(),
...
unpackTo(_o: FlightPlanPointGroups_AbridgedT): void {
...
export class FlightPlanPointGroups_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const flightPlanPoints = FlightPlanPointGroups_Abridged.createFlightPlanPointsVector(builder, builder.createObjectOffsetList(this.flightPlanPoints));

  return FlightPlanPointGroups_Abridged.createFlightPlanPointGroups_Abridged(builder,
    pointGroupName,
    worstFuelCase,
    lsafName,
    this.lsafDistance,
