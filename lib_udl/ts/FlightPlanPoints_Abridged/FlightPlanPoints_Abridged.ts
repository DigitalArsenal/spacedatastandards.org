 ...
 */
export class FlightPlanPoints_Abridged implements flatbuffers.IUnpackableObject<FlightPlanPoints_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):FlightPlanPoints_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsFlightPlanPoints_Abridged(bb:flatbuffers.ByteBuffer, obj?:FlightPlanPoints_Abridged):FlightPlanPoints_Abridged {
  return (obj || new FlightPlanPoints_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsFlightPlanPoints_Abridged(bb:flatbuffers.ByteBuffer, obj?:FlightPlanPoints_Abridged):FlightPlanPoints_Abridged {
...
static startFlightPlanPoints_Abridged(builder:flatbuffers.Builder) {
...
static endFlightPlanPoints_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishFlightPlanPoints_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'FLIG');
}

static finishSizePrefixedFlightPlanPoints_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'FLIG', true);
}

static createFlightPlanPoints_Abridged(builder:flatbuffers.Builder, pointNameOffset:flatbuffers.Offset, fppLat:number, fppLon:number, fppEtaOffset:flatbuffers.Offset, fppReqFuel:number):flatbuffers.Offset {
  FlightPlanPoints_Abridged.startFlightPlanPoints_Abridged(builder);
...
unpack(): FlightPlanPoints_AbridgedT {
  return new FlightPlanPoints_AbridgedT(
    this.pointName(),
    this.fppLat(),
    this.fppLon(),
    this.fppEta(),
...
unpackTo(_o: FlightPlanPoints_AbridgedT): void {
...
export class FlightPlanPoints_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return FlightPlanPoints_Abridged.createFlightPlanPoints_Abridged(builder,
    pointName,
    this.fppLat,
    this.fppLon,
    fppEta,
