...
import { SigAct_Ingest_dataMode_Enum } from './sig-act-ingest-data-mode-enum.js';
 ...
 */
export class SigAct_Ingest implements flatbuffers.IUnpackableObject<SigAct_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SigAct_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSigAct_Ingest(bb:flatbuffers.ByteBuffer, obj?:SigAct_Ingest):SigAct_Ingest {
  return (obj || new SigAct_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSigAct_Ingest(bb:flatbuffers.ByteBuffer, obj?:SigAct_Ingest):SigAct_Ingest {
 ...
 */
dataMode():SigAct_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 166);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SigAct_Ingest_dataMode_Enum.REAL;
}
...
static startSigAct_Ingest(builder:flatbuffers.Builder) {
...
static addSummary(builder:flatbuffers.Builder, summaryOffset:flatbuffers.Offset) {
  builder.addFieldOffset(75, summaryOffset, 0);
}

static addNotes(builder:flatbuffers.Builder, notesOffset:flatbuffers.Offset) {
  builder.addFieldOffset(76, notesOffset, 0);
}

static addCreatedAt(builder:flatbuffers.Builder, createdAtOffset:flatbuffers.Offset) {
  builder.addFieldOffset(77, createdAtOffset, 0);
}

static addCreatedBy(builder:flatbuffers.Builder, createdByOffset:flatbuffers.Offset) {
  builder.addFieldOffset(78, createdByOffset, 0);
}
...
static addOrigin(builder:flatbuffers.Builder, originOffset:flatbuffers.Offset) {
  builder.addFieldOffset(80, originOffset, 0);
}

static addDataMode(builder:flatbuffers.Builder, dataMode:SigAct_Ingest_dataMode_Enum) {
  builder.addFieldInt8(81, dataMode, SigAct_Ingest_dataMode_Enum.REAL);
}
...
unpack(): SigAct_IngestT {
  return new SigAct_IngestT(
    this.id(),
    ...
    this.eventEnd(),
    this.reportDate(),
    this.bb!.createScalarList<string>(this.actors.bind(this), this.actors_Length()),
    this.civAbd(),
    this.civDet(),
    this.civKia(),
    this.civWound(),
    ...
    this.avgTone(),
    this.sourceUrl(),
    this.bb!.createScalarList<string>(this.relatedDocs.bind(this), this.relatedDocs_Length()),
    this.summary(),
    this.notes(),
    this.createdAt(),
    this.createdBy(),
...
unpackTo(_o: SigAct_IngestT): void {
  _o.id = this.id();
  ...
  _o.actors = this.bb!.createScalarList<string>(this.actors.bind(this), this.actors_Length());
  ...
  _o.relatedDocs = this.bb!.createScalarList<string>(this.relatedDocs.bind(this), this.relatedDocs_Length());
...
export class SigAct_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SigAct_Ingest_dataMode_Enum = SigAct_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const actors = SigAct_Ingest.createActorsVector(builder, builder.createObjectOffsetList(this.actors));
  ...
  const relatedDocs = SigAct_Ingest.createRelatedDocsVector(builder, builder.createObjectOffsetList(this.relatedDocs));
  ...
  return SigAct_Ingest.createSigAct_Ingest(builder,
    id,
