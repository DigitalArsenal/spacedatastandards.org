...
import { Maneuver_Ingest_dataMode_Enum } from './Maneuver_Ingest_dataMode_Enum.js';
import { Maneuver_Ingest_sourcedDataTypes_Enum } from './Maneuver_Ingest_sourcedDataTypes_Enum.js';


/**
 * /// Model representation of on-orbit object maneuver information for detected, possible, and confirmed maneuvers.
 */
export class Maneuver_Ingest implements flatbuffers.IUnpackableObject<Maneuver_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Maneuver_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsManeuver_Ingest(bb:flatbuffers.ByteBuffer, obj?:Maneuver_Ingest):Maneuver_Ingest {
  return (obj || new Maneuver_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsManeuver_Ingest(bb:flatbuffers.ByteBuffer, obj?:Maneuver_Ingest):Maneuver_Ingest {
 ...
 */
dataMode():Maneuver_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 182);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Maneuver_Ingest_dataMode_Enum.REAL;
}
 ...
 * Constraints: No constraints specified.
 */
sourcedDataTypes():Maneuver_Ingest_sourcedDataTypes_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 194);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Maneuver_Ingest_sourcedDataTypes_Enum.EO;
}
...
static startManeuver_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Maneuver_Ingest_dataMode_Enum) {
  builder.addFieldInt8(89, dataMode, Maneuver_Ingest_dataMode_Enum.REAL);
}
...
static addTags(builder:flatbuffers.Builder, tagsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(92, tagsOffset, 0);
}
...
static addAlgorithm(builder:flatbuffers.Builder, algorithmOffset:flatbuffers.Offset) {
  builder.addFieldOffset(93, algorithmOffset, 0);
}

static addSourcedData(builder:flatbuffers.Builder, sourcedDataOffset:flatbuffers.Offset) {
  builder.addFieldOffset(94, sourcedDataOffset, 0);
}
...
static addSourcedDataTypes(builder:flatbuffers.Builder, sourcedDataTypes:Maneuver_Ingest_sourcedDataTypes_Enum) {
  builder.addFieldInt8(95, sourcedDataTypes, Maneuver_Ingest_sourcedDataTypes_Enum.EO);
}
...
unpack(): Maneuver_IngestT {
  return new Maneuver_IngestT(
    this.id(),
    ...
    this.numAccelPoints(),
    this.bb!.createScalarList<string>(this.mnvrAccelTimes.bind(this), this.mnvrAccelTimesLength()),
    this.bb!.createScalarList<string>(this.mnvrAccels.bind(this), this.mnvrAccelsLength()),
    this.bb!.createScalarList<string>(this.mnvrAccelUncs.bind(this), this.mnvrAccelUncsLength()),
    this.source(),
    this.origin(),
    this.dataMode(),
    this.createdAt(),
...
unpackTo(_o: Maneuver_IngestT): void {
  _o.id = this.id();
  ...
  _o.mnvrAccelTimes = this.bb!.createScalarList<string>(this.mnvrAccelTimes.bind(this), this.mnvrAccelTimesLength());
  _o.mnvrAccels = this.bb!.createScalarList<string>(this.mnvrAccels.bind(this), this.mnvrAccelsLength());
  _o.mnvrAccelUncs = this.bb!.createScalarList<string>(this.mnvrAccelUncs.bind(this), this.mnvrAccelUncsLength());
...
export class Maneuver_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Maneuver_Ingest_dataMode_Enum = Maneuver_Ingest_dataMode_Enum.REAL,
  public createdAt: string|Uint8Array|null = null,
  public createdBy: string|Uint8Array|null = null,
  public tags: (string)[] = [],
  public algorithm: string|Uint8Array|null = null,
  public sourcedData: (string)[] = [],
  public sourcedDataTypes: Maneuver_Ingest_sourcedDataTypes_Enum = Maneuver_Ingest_sourcedDataTypes_Enum.EO,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const cov = Maneuver_Ingest.createCovVector(builder, builder.createObjectOffsetList(this.cov));
  ...
  const mnvrAccelTimes = Maneuver_Ingest.createMnvrAccelTimesVector(builder, builder.createObjectOffsetList(this.mnvrAccelTimes));
  const mnvrAccels = Maneuver_Ingest.createMnvrAccelsVector(builder, builder.createObjectOffsetList(this.mnvrAccels));
  const mnvrAccelUncs = Maneuver_Ingest.createMnvrAccelUncsVector(builder, builder.createObjectOffsetList(this.mnvrAccelUncs));
  const source = (this.source !== null ? builder.createString(this.source!) : 0);
  const origin = (this.origin !== null ? builder.createString(this.origin!) : 0);
  const createdAt = (this.createdAt !== null ? builder.createString(this.createdAt!) : 0);
  const createdBy = (this.createdBy !== null ? builder.createString(this.createdBy!) : 0);
  const tags = Maneuver_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  const algorithm = (this.algorithm !== null ? builder.createString(this.algorithm!) : 0);
  const sourcedData = Maneuver_Ingest.createSourcedDataVector(builder, builder.createObjectOffsetList(this.sourcedData));
  const transactionId = (this.transactionId !== null ? builder.createString(this.transactionId!) : 0);
  const origNetwork = (this.origNetwork !== null ? builder.createString(this.origNetwork!) : 0);

  return Maneuver_Ingest.createManeuver_Ingest(builder,
    id,
