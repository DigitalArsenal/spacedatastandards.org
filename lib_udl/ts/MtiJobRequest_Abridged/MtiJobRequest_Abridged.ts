 ...
 */
export class MtiJobRequest_Abridged implements flatbuffers.IUnpackableObject<MtiJobRequest_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MtiJobRequest_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMtiJobRequest_Abridged(bb:flatbuffers.ByteBuffer, obj?:MtiJobRequest_Abridged):MtiJobRequest_Abridged {
  return (obj || new MtiJobRequest_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMtiJobRequest_Abridged(bb:flatbuffers.ByteBuffer, obj?:MtiJobRequest_Abridged):MtiJobRequest_Abridged {
...
static startMtiJobRequest_Abridged(builder:flatbuffers.Builder) {
...
static endMtiJobRequest_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishMtiJobRequest_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIJ');
}

static finishSizePrefixedMtiJobRequest_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIJ', true);
}

static createMtiJobRequest_Abridged(builder:flatbuffers.Builder, r1Offset:flatbuffers.Offset, r2Offset:flatbuffers.Offset, r3:number, r4:number, r5:number, r6:number, r7:number, r8:number, r9:number, r10:number, r11:number, r12Offset:flatbuffers.Offset, r13:number, r14:number, jobReqEstOffset:flatbuffers.Offset, r21:number, r22:number, r23:number, r24Offset:flatbuffers.Offset, r25Offset:flatbuffers.Offset, r26:boolean):flatbuffers.Offset {
  MtiJobRequest_Abridged.startMtiJobRequest_Abridged(builder);
...
unpack(): MtiJobRequest_AbridgedT {
  return new MtiJobRequest_AbridgedT(
    this.r1(),
    this.r2(),
    this.r3(),
    this.r4(),
...
unpackTo(_o: MtiJobRequest_AbridgedT): void {
  _o.r1 = this.r1();
  _o.r2 = this.r2();
  _o.r3 = this.r3();
  _o.r4 = this.r4();
...
export class MtiJobRequest_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return MtiJobRequest_Abridged.createMtiJobRequest_Abridged(builder,
    r1,
    r2,
    this.r3,
    this.r4,
