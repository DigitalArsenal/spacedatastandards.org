...
import { NavigationalObstruction_Full_dataMode_Enum } from './navigational-obstruction-full-data-mode-enum.js';
 ...
 */
export class NavigationalObstruction_Full implements flatbuffers.IUnpackableObject<NavigationalObstruction_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):NavigationalObstruction_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsNavigationalObstruction_Full(bb:flatbuffers.ByteBuffer, obj?:NavigationalObstruction_Full):NavigationalObstruction_Full {
  return (obj || new NavigationalObstruction_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsNavigationalObstruction_Full(bb:flatbuffers.ByteBuffer, obj?:NavigationalObstruction_Full):NavigationalObstruction_Full {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():NavigationalObstruction_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 160);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : NavigationalObstruction_Full_dataMode_Enum.REAL;
}

static startNavigationalObstruction_Full(builder:flatbuffers.Builder) {
...
unpack(): NavigationalObstruction_FullT {
  return new NavigationalObstruction_FullT(
    this.id(),
...
unpackTo(_o: NavigationalObstruction_FullT): void {
  _o.id = this.id();
...
export class NavigationalObstruction_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: NavigationalObstruction_Full_dataMode_Enum = NavigationalObstruction_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const keys = NavigationalObstruction_Full.createKeysVector(builder, builder.createObjectOffsetList(this.keys));
  const values = NavigationalObstruction_Full.createValuesVector(builder, builder.createObjectOffsetList(this.values));
  ...
  return NavigationalObstruction_Full.createNavigationalObstruction_Full(builder,
    id,
