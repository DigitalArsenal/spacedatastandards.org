...
import { GEOStatus_Full_dataMode_Enum } from './geostatus-full-data-mode-enum.js';


/**
 * /// Information for the specified on-orbit GEO spacecraft, including status, expected longitude limits, and drift rates.
 */
export class GEOStatus_Full implements flatbuffers.IUnpackableObject<GEOStatus_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):GEOStatus_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsGEOStatus_Full(bb:flatbuffers.ByteBuffer, obj?:GEOStatus_Full):GEOStatus_Full {
  return (obj || new GEOStatus_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsGEOStatus_Full(bb:flatbuffers.ByteBuffer, obj?:GEOStatus_Full):GEOStatus_Full {
 ...
 */
dataMode():GEOStatus_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 50);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : GEOStatus_Full_dataMode_Enum.REAL;
}
...
static startGEOStatus_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:GEOStatus_Full_dataMode_Enum) {
  builder.addFieldInt8(23, dataMode, GEOStatus_Full_dataMode_Enum.REAL);
}

static addOnOrbit(builder:flatbuffers.Builder, onOrbitOffset:flatbuffers.Offset) {
  builder.addFieldOffset(24, onOrbitOffset, 0);
}

static addSatNo(builder:flatbuffers.Builder, satNo:number) {
  builder.addFieldInt32(25, satNo, 0);
}
...
static endGEOStatus_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishGEOStatus_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'GEOS');
}

static finishSizePrefixedGEOStatus_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'GEOS', true);
}

static createGEOStatus_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, origObjectIdOffset:flatbuffers.Offset, ss:number, sc:number, relativeEnergy:number, longitudeRate:number, longitudeMin:number, longitudeMax:number, confidenceLevelOffset:flatbuffers.Offset, planeChangeStatusOffset:flatbuffers.Offset, troughTypeOffset:flatbuffers.Offset, lostFlag:boolean, semiAnnualCorrFlag:boolean, objectStatusOffset:flatbuffers.Offset, rawFileUriOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:GEOStatus_Full_dataMode_Enum, onOrbitOffset:flatbuffers.Offset, satNo:number, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  GEOStatus_Full.startGEOStatus_Full(builder);
...
unpack(): GEOStatus_FullT {
  return new GEOStatus_FullT(
    this.id(),
...
unpackTo(_o: GEOStatus_FullT): void {
  _o.id = this.id();
...
export class GEOStatus_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: GEOStatus_Full_dataMode_Enum = GEOStatus_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return GEOStatus_Full.createGEOStatus_Full(builder,
    id,
