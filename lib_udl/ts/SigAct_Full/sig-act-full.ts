...
import { SigAct_Full_dataMode_Enum } from './sig-act-full-data-mode-enum.js';
 ...
 */
export class SigAct_Full implements flatbuffers.IUnpackableObject<SigAct_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SigAct_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSigAct_Full(bb:flatbuffers.ByteBuffer, obj?:SigAct_Full):SigAct_Full {
  return (obj || new SigAct_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSigAct_Full(bb:flatbuffers.ByteBuffer, obj?:SigAct_Full):SigAct_Full {
 ...
 */
dataMode():SigAct_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 166);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SigAct_Full_dataMode_Enum.REAL;
}
...
static startSigAct_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SigAct_Full_dataMode_Enum) {
  builder.addFieldInt8(81, dataMode, SigAct_Full_dataMode_Enum.REAL);
}
...
export class SigAct_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SigAct_Full_dataMode_Enum = SigAct_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const actors = SigAct_Full.createActorsVector(builder, builder.createObjectOffsetList(this.actors));
  ...
  const relatedDocs = SigAct_Full.createRelatedDocsVector(builder, builder.createObjectOffsetList(this.relatedDocs));
  ...
  return SigAct_Full.createSigAct_Full(builder,
    id,
