...
import { MonoRadar_Abridged_dataMode_Enum } from './MonoRadar_Abridged_dataMode_Enum.js';
 ...
 */
export class MonoRadar_Abridged implements flatbuffers.IUnpackableObject<MonoRadar_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MonoRadar_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMonoRadar_Abridged(bb:flatbuffers.ByteBuffer, obj?:MonoRadar_Abridged):MonoRadar_Abridged {
  return (obj || new MonoRadar_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMonoRadar_Abridged(bb:flatbuffers.ByteBuffer, obj?:MonoRadar_Abridged):MonoRadar_Abridged {
 ...
 */
dataMode():MonoRadar_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 142);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : MonoRadar_Abridged_dataMode_Enum.REAL;
}
...
static startMonoRadar_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:MonoRadar_Abridged_dataMode_Enum) {
  builder.addFieldInt8(69, dataMode, MonoRadar_Abridged_dataMode_Enum.REAL);
}
...
unpack(): MonoRadar_AbridgedT {
  return new MonoRadar_AbridgedT(
    this.id(),
    ...
    this.mah(),
    this.cdm(),
    this.bb!.createScalarList<string>(this.cartpos.bind(this), this.cartposLength()),
    this.psrrl(),
    this.ssrl(),
    this.rngdelt(),
    this.azdelt(),
    this.bb!.createScalarList<string>(this.wectc.bind(this), this.wectcLength()),
    this.mrgrpt(),
    this.artsqual(),
    this.trkelig(),
    this.tgtconf(),
...
unpackTo(_o: MonoRadar_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.mah = this.mah();
  _o.cdm = this.cdm();
  _o.cartpos = this.bb!.createScalarList<string>(this.cartpos.bind(this), this.cartposLength());
  _o.psrrl = this.psrrl();
  _o.ssrl = this.ssrl();
  _o.rngdelt = this.rngdelt();
  _o.azdelt = this.azdelt();
  _o.wectc = this.bb!.createScalarList<string>(this.wectc.bind(this), this.wectcLength());
...
export class MonoRadar_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: MonoRadar_Abridged_dataMode_Enum = MonoRadar_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const cartpos = MonoRadar_Abridged.createCartposVector(builder, builder.createObjectOffsetList(this.cartpos));
  const wectc = MonoRadar_Abridged.createWectcVector(builder, builder.createObjectOffsetList(this.wectc));
  ...
  const tags = MonoRadar_Abridged.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return MonoRadar_Abridged.createMonoRadar_Abridged(builder,
    id,
