...
import { DiplomaticClearance_Abridged_dataMode_Enum } from './DiplomaticClearance_Abridged_dataMode_Enum.js';


/**
 * /// A diplomatic clearance is an authorization for an aircraft to traverse or land within a specified country.
 */
export class DiplomaticClearance_Abridged implements flatbuffers.IUnpackableObject<DiplomaticClearance_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):DiplomaticClearance_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsDiplomaticClearance_Abridged(bb:flatbuffers.ByteBuffer, obj?:DiplomaticClearance_Abridged):DiplomaticClearance_Abridged {
  return (obj || new DiplomaticClearance_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsDiplomaticClearance_Abridged(bb:flatbuffers.ByteBuffer, obj?:DiplomaticClearance_Abridged):DiplomaticClearance_Abridged {
 ...
 */
dataMode():DiplomaticClearance_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 40);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : DiplomaticClearance_Abridged_dataMode_Enum.REAL;
}

static startDiplomaticClearance_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:DiplomaticClearance_Abridged_dataMode_Enum) {
  builder.addFieldInt8(18, dataMode, DiplomaticClearance_Abridged_dataMode_Enum.REAL);
}

static endDiplomaticClearance_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishDiplomaticClearance_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DIPL');
}

static finishSizePrefixedDiplomaticClearance_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DIPL', true);
}

static createDiplomaticClearance_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idMissionOffset:flatbuffers.Offset, externalWorksheetIdOffset:flatbuffers.Offset, dipWorksheetNameOffset:flatbuffers.Offset, firstDepDateOffset:flatbuffers.Offset, docDeadlineOffset:flatbuffers.Offset, apacsIdOffset:flatbuffers.Offset, diplomaticClearanceDetailsOffset:flatbuffers.Offset, diplomaticClearanceRemarksOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:DiplomaticClearance_Abridged_dataMode_Enum):flatbuffers.Offset {
  DiplomaticClearance_Abridged.startDiplomaticClearance_Abridged(builder);
  DiplomaticClearance_Abridged.addId(builder, idOffset);
  DiplomaticClearance_Abridged.addClassificationMarking(builder, classificationMarkingOffset);
  DiplomaticClearance_Abridged.addIdMission(builder, idMissionOffset);
  DiplomaticClearance_Abridged.addExternalWorksheetId(builder, externalWorksheetIdOffset);
  DiplomaticClearance_Abridged.addDipWorksheetName(builder, dipWorksheetNameOffset);
  DiplomaticClearance_Abridged.addFirstDepDate(builder, firstDepDateOffset);
  DiplomaticClearance_Abridged.addDocDeadline(builder, docDeadlineOffset);
  DiplomaticClearance_Abridged.addApacsId(builder, apacsIdOffset);
  DiplomaticClearance_Abridged.addDiplomaticClearanceDetails(builder, diplomaticClearanceDetailsOffset);
  DiplomaticClearance_Abridged.addDiplomaticClearanceRemarks(builder, diplomaticClearanceRemarksOffset);
  DiplomaticClearance_Abridged.addCreatedAt(builder, createdAtOffset);
  DiplomaticClearance_Abridged.addCreatedBy(builder, createdByOffset);
  DiplomaticClearance_Abridged.addUpdatedAt(builder, updatedAtOffset);
  DiplomaticClearance_Abridged.addUpdatedBy(builder, updatedByOffset);
  DiplomaticClearance_Abridged.addSourceDl(builder, sourceDlOffset);
  DiplomaticClearance_Abridged.addSource(builder, sourceOffset);
  DiplomaticClearance_Abridged.addOrigin(builder, originOffset);
  DiplomaticClearance_Abridged.addOrigNetwork(builder, origNetworkOffset);
  DiplomaticClearance_Abridged.addDataMode(builder, dataMode);
  return DiplomaticClearance_Abridged.endDiplomaticClearance_Abridged(builder);
}

unpack(): DiplomaticClearance_AbridgedT {
  return new DiplomaticClearance_AbridgedT(
    this.id(),
    ...
    this.docDeadline(),
    this.apacsId(),
    this.bb!.createScalarList<string>(this.diplomaticClearanceDetails.bind(this), this.diplomaticClearanceDetailsLength()),
    this.bb!.createScalarList<string>(this.diplomaticClearanceRemarks.bind(this), this.diplomaticClearanceRemarksLength()),
    this.createdAt(),
    this.createdBy(),
    this.updatedAt(),
    this.updatedBy(),
...
unpackTo(_o: DiplomaticClearance_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.diplomaticClearanceDetails = this.bb!.createScalarList<string>(this.diplomaticClearanceDetails.bind(this), this.diplomaticClearanceDetailsLength());
  _o.diplomaticClearanceRemarks = this.bb!.createScalarList<string>(this.diplomaticClearanceRemarks.bind(this), this.diplomaticClearanceRemarksLength());
...
export class DiplomaticClearance_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: DiplomaticClearance_Abridged_dataMode_Enum = DiplomaticClearance_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const diplomaticClearanceDetails = DiplomaticClearance_Abridged.createDiplomaticClearanceDetailsVector(builder, builder.createObjectOffsetList(this.diplomaticClearanceDetails));
  const diplomaticClearanceRemarks = DiplomaticClearance_Abridged.createDiplomaticClearanceRemarksVector(builder, builder.createObjectOffsetList(this.diplomaticClearanceRemarks));
  ...
  return DiplomaticClearance_Abridged.createDiplomaticClearance_Abridged(builder,
    id,
