...
import { BatteryDetails_Full_dataMode_Enum } from './battery-details-full-data-mode-enum.js';
 ...
 */
export class BatteryDetails_Full implements flatbuffers.IUnpackableObject<BatteryDetails_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):BatteryDetails_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsBatteryDetails_Full(bb:flatbuffers.ByteBuffer, obj?:BatteryDetails_Full):BatteryDetails_Full {
  return (obj || new BatteryDetails_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsBatteryDetails_Full(bb:flatbuffers.ByteBuffer, obj?:BatteryDetails_Full):BatteryDetails_Full {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():BatteryDetails_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 36);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : BatteryDetails_Full_dataMode_Enum.REAL;
}
...
static startBatteryDetails_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:BatteryDetails_Full_dataMode_Enum) {
  builder.addFieldInt8(16, dataMode, BatteryDetails_Full_dataMode_Enum.REAL);
}
...
static endBatteryDetails_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishBatteryDetails_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'BATT');
}

static finishSizePrefixedBatteryDetails_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'BATT', true);
}

static createBatteryDetails_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idBatteryOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, technologyOffset:flatbuffers.Offset, capacity:number, dischargeDepth:number, modelOffset:flatbuffers.Offset, descriptionOffset:flatbuffers.Offset, manufacturerOrgIdOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:BatteryDetails_Full_dataMode_Enum, tagsOffset:flatbuffers.Offset, manufacturerOrgOffset:flatbuffers.Offset):flatbuffers.Offset {
  BatteryDetails_Full.startBatteryDetails_Full(builder);
...
unpack(): BatteryDetails_FullT {
  return new BatteryDetails_FullT(
    this.id(),
    this.idBattery(),
...
unpackTo(_o: BatteryDetails_FullT): void {
  _o.id = this.id();
...
export class BatteryDetails_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: BatteryDetails_Full_dataMode_Enum = BatteryDetails_Full_dataMode_Enum.REAL,
  public tags: (string)[] = [],
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = BatteryDetails_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  const manufacturerOrg = (this.manufacturerOrg !== null ? builder.createString(this.manufacturerOrg!) : 0);

  return BatteryDetails_Full.createBatteryDetails_Full(builder,
    id,
    idBattery,
