 ...
 */
export class IndividualAircraftTasking_Full implements flatbuffers.IUnpackableObject<IndividualAircraftTasking_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):IndividualAircraftTasking_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsIndividualAircraftTasking_Full(bb:flatbuffers.ByteBuffer, obj?:IndividualAircraftTasking_Full):IndividualAircraftTasking_Full {
  return (obj || new IndividualAircraftTasking_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIndividualAircraftTasking_Full(bb:flatbuffers.ByteBuffer, obj?:IndividualAircraftTasking_Full):IndividualAircraftTasking_Full {
...
static startIndividualAircraftTasking_Full(builder:flatbuffers.Builder) {
...
static endIndividualAircraftTasking_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishIndividualAircraftTasking_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'INDI');
}

static finishSizePrefixedIndividualAircraftTasking_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'INDI', true);
}

static createIndividualAircraftTasking_Full(builder:flatbuffers.Builder, numAcft:number, acftTypeOffset:flatbuffers.Offset, callSignOffset:flatbuffers.Offset, priConfigCodeOffset:flatbuffers.Offset, secConfigCodeOffset:flatbuffers.Offset, link16CallSignOffset:flatbuffers.Offset, tacanChan:number, juAddressOffset:flatbuffers.Offset, iffSifMode1CodeOffset:flatbuffers.Offset, iffSifMode2CodeOffset:flatbuffers.Offset, iffSifMode3CodeOffset:flatbuffers.Offset):flatbuffers.Offset {
  IndividualAircraftTasking_Full.startIndividualAircraftTasking_Full(builder);
...
unpack(): IndividualAircraftTasking_FullT {
  return new IndividualAircraftTasking_FullT(
    this.numAcft(),
    this.acftType(),
    this.callSign(),
    this.priConfigCode(),
...
unpackTo(_o: IndividualAircraftTasking_FullT): void {
...
export class IndividualAircraftTasking_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const juAddress = IndividualAircraftTasking_Full.createJuAddressVector(builder, builder.createObjectOffsetList(this.juAddress));
  ...
  return IndividualAircraftTasking_Full.createIndividualAircraftTasking_Full(builder,
    this.numAcft,
    acftType,
    callSign,
    priConfigCode,
