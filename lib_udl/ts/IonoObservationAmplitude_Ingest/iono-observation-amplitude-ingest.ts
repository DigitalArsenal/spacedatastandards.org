 ...
 */
export class IonoObservationAmplitude_Ingest implements flatbuffers.IUnpackableObject<IonoObservationAmplitude_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):IonoObservationAmplitude_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsIonoObservationAmplitude_Ingest(bb:flatbuffers.ByteBuffer, obj?:IonoObservationAmplitude_Ingest):IonoObservationAmplitude_Ingest {
  return (obj || new IonoObservationAmplitude_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIonoObservationAmplitude_Ingest(bb:flatbuffers.ByteBuffer, obj?:IonoObservationAmplitude_Ingest):IonoObservationAmplitude_Ingest {
...
static startIonoObservationAmplitude_Ingest(builder:flatbuffers.Builder) {
...
static endIonoObservationAmplitude_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishIonoObservationAmplitude_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO');
}

static finishSizePrefixedIonoObservationAmplitude_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO', true);
}

static createIonoObservationAmplitude_Ingest(builder:flatbuffers.Builder, notesOffset:flatbuffers.Offset, dimensionsOffset:flatbuffers.Offset, dimensionNameOffset:flatbuffers.Offset, dataOffset:flatbuffers.Offset):flatbuffers.Offset {
  IonoObservationAmplitude_Ingest.startIonoObservationAmplitude_Ingest(builder);
...
unpack(): IonoObservationAmplitude_IngestT {
  return new IonoObservationAmplitude_IngestT(
    this.notes(),
...
unpackTo(_o: IonoObservationAmplitude_IngestT): void {
  _o.notes = this.notes();
...
export class IonoObservationAmplitude_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const dimensions = IonoObservationAmplitude_Ingest.createDimensionsVector(builder, builder.createObjectOffsetList(this.dimensions));
  const dimensionName = IonoObservationAmplitude_Ingest.createDimensionNameVector(builder, builder.createObjectOffsetList(this.dimensionName));
  const data = IonoObservationAmplitude_Ingest.createDataVector(builder, builder.createObjectOffsetList(this.data));

  return IonoObservationAmplitude_Ingest.createIonoObservationAmplitude_Ingest(builder,
    notes,
    dimensions,
    dimensionName,
    data
