...
import { SensorPlan_Ingest_dataMode_Enum } from './sensor-plan-ingest-data-mode-enum.js';
...
unpack(): SensorPlan_IngestT {
  return new SensorPlan_IngestT(
    ...
    this.dataMode(),
    this.origNetwork(),
    this.bb!.createScalarList<string>(this.collectRequests.bind(this), this.collectRequests_Length()),
...
unpackTo(_o: SensorPlan_IngestT): void {
  ...
  _o.collectRequests = this.bb!.createScalarList<string>(this.collectRequests.bind(this), this.collectRequests_Length());
