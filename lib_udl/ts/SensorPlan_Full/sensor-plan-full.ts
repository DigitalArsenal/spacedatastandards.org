...
import { SensorPlan_Full_dataMode_Enum } from './sensor-plan-full-data-mode-enum.js';
 ...
 */
export class SensorPlan_Full implements flatbuffers.IUnpackableObject<SensorPlan_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SensorPlan_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSensorPlan_Full(bb:flatbuffers.ByteBuffer, obj?:SensorPlan_Full):SensorPlan_Full {
  return (obj || new SensorPlan_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSensorPlan_Full(bb:flatbuffers.ByteBuffer, obj?:SensorPlan_Full):SensorPlan_Full {
...
dataMode():SensorPlan_Full_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SensorPlan_Full_dataMode_Enum.REAL;
}
...
static startSensorPlan_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SensorPlan_Full_dataMode_Enum) {
  builder.addFieldInt8(20, dataMode, SensorPlan_Full_dataMode_Enum.REAL);
}
...
static addCollectRequests(builder:flatbuffers.Builder, collectRequestsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(22, collectRequestsOffset, 0);
}
...
static endSensorPlan_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSensorPlan_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SENS');
}

static finishSizePrefixedSensorPlan_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SENS', true);
}

static createSensorPlan_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, recTypeOffset:flatbuffers.Offset, startTimeOffset:flatbuffers.Offset, endTimeOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, origSensorIdOffset:flatbuffers.Offset, purposeOffset:flatbuffers.Offset, senNetworkOffset:flatbuffers.Offset, reqTotal:number, customerOffset:flatbuffers.Offset, statusOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:SensorPlan_Full_dataMode_Enum, origNetworkOffset:flatbuffers.Offset, collectRequestsOffset:flatbuffers.Offset, tagsOffset:flatbuffers.Offset):flatbuffers.Offset {
  SensorPlan_Full.startSensorPlan_Full(builder);
...
unpack(): SensorPlan_FullT {
  return new SensorPlan_FullT(
    this.id(),
...
unpackTo(_o: SensorPlan_FullT): void {
  _o.id = this.id();
...
export class SensorPlan_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SensorPlan_Full_dataMode_Enum = SensorPlan_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const collectRequests = SensorPlan_Full.createCollectRequestsVector(builder, builder.createObjectOffsetList(this.collectRequests));
  const tags = SensorPlan_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));

  return SensorPlan_Full.createSensorPlan_Full(builder,
    id,
