...
import { Transponder_Abridged_dataMode_Enum } from './transponder-abridged-data-mode-enum.js';
 ...
 */
export class Transponder_Abridged implements flatbuffers.IUnpackableObject<Transponder_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Transponder_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsTransponder_Abridged(bb:flatbuffers.ByteBuffer, obj?:Transponder_Abridged):Transponder_Abridged {
  return (obj || new Transponder_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTransponder_Abridged(bb:flatbuffers.ByteBuffer, obj?:Transponder_Abridged):Transponder_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Transponder_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 34);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Transponder_Abridged_dataMode_Enum.REAL;
}
...
static startTransponder_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Transponder_Abridged_dataMode_Enum) {
  builder.addFieldInt8(15, dataMode, Transponder_Abridged_dataMode_Enum.REAL);
}
...
static endTransponder_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishTransponder_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TRAN');
}

static finishSizePrefixedTransponder_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TRAN', true);
}

static createTransponder_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idCommOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, nidOffset:flatbuffers.Offset, tidOffset:flatbuffers.Offset, ttf:number, symbolRate:number, fec:number, modulationOffset:flatbuffers.Offset, formatOffset:flatbuffers.Offset, systemOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:Transponder_Abridged_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset):flatbuffers.Offset {
  Transponder_Abridged.startTransponder_Abridged(builder);
...
unpack(): Transponder_AbridgedT {
  return new Transponder_AbridgedT(
    this.id(),
    this.idComm(),
    this.name(),
...
unpackTo(_o: Transponder_AbridgedT): void {
  _o.id = this.id();
...
export class Transponder_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Transponder_Abridged_dataMode_Enum = Transponder_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Transponder_Abridged.createTransponder_Abridged(builder,
    id,
    idComm,
    name,
