 ...
 */
export class MtiDwell_Abridged implements flatbuffers.IUnpackableObject<MtiDwell_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MtiDwell_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMtiDwell_Abridged(bb:flatbuffers.ByteBuffer, obj?:MtiDwell_Abridged):MtiDwell_Abridged {
  return (obj || new MtiDwell_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMtiDwell_Abridged(bb:flatbuffers.ByteBuffer, obj?:MtiDwell_Abridged):MtiDwell_Abridged {
...
static startMtiDwell_Abridged(builder:flatbuffers.Builder) {
...
unpack(): MtiDwell_AbridgedT {
  return new MtiDwell_AbridgedT(
    this.d2(),
    this.d3(),
    this.d4(),
    this.d5(),
    ...
    this.d30(),
    this.d31(),
    this.bb!.createScalarList<string>(this.d32.bind(this), this.d32_Length()),
    this.dwellts()
  );
}


unpackTo(_o: MtiDwell_AbridgedT): void {
  _o.d2 = this.d2();
  _o.d3 = this.d3();
  _o.d4 = this.d4();
  _o.d5 = this.d5();
  ...
  _o.d30 = this.d30();
  _o.d31 = this.d31();
  _o.d32 = this.bb!.createScalarList<string>(this.d32.bind(this), this.d32_Length());
  _o.dwellts = this.dwellts();
}
}

export class MtiDwell_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  public d2: number = 0,
  public d3: number = 0,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  const d32 = MtiDwell_Abridged.createD32Vector(builder, builder.createObjectOffsetList(this.d32));
  const dwellts = (this.dwellts !== null ? builder.createString(this.dwellts!) : 0);

  return MtiDwell_Abridged.createMtiDwell_Abridged(builder,
    this.d2,
    this.d3,
    this.d4,
    this.d5,
