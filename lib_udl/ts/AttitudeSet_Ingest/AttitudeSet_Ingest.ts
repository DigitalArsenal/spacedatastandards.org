...
import { AttitudeSet_Ingest_dataMode_Enum } from './AttitudeSet_Ingest_dataMode_Enum.js';
...
unpack(): AttitudeSet_IngestT {
  return new AttitudeSet_IngestT(
    ...
    this.type(),
    this.esId(),
    this.bb!.createScalarList<string>(this.asRef.bind(this), this.asRefLength()),
    this.idSensor(),
    this.origSensorId(),
    this.startTime(),
    this.endTime(),
    ...
    this.spinAngleInit(),
    this.eulerRotSeq(),
    this.bb!.createScalarList<string>(this.attitudeList.bind(this), this.attitudeListLength()),
    this.interpolator(),
...
unpackTo(_o: AttitudeSet_IngestT): void {
  ...
  _o.type = this.type();
  _o.esId = this.esId();
  _o.asRef = this.bb!.createScalarList<string>(this.asRef.bind(this), this.asRefLength());
  ...
  _o.attitudeList = this.bb!.createScalarList<string>(this.attitudeList.bind(this), this.attitudeListLength());
