...
import { AttitudeSet_Ingest_dataMode_Enum } from './attitude-set-ingest-data-mode-enum.js';
 ...
 */
export class AttitudeSet_Ingest implements flatbuffers.IUnpackableObject<AttitudeSet_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AttitudeSet_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAttitudeSet_Ingest(bb:flatbuffers.ByteBuffer, obj?:AttitudeSet_Ingest):AttitudeSet_Ingest {
  return (obj || new AttitudeSet_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAttitudeSet_Ingest(bb:flatbuffers.ByteBuffer, obj?:AttitudeSet_Ingest):AttitudeSet_Ingest {
 ...
 * Constraints: No constraints specified.
 */
asRef(index: number):string
asRef(index: number,optionalEncoding:flatbuffers.Encoding):string|Uint8Array
asRef(index: number,optionalEncoding?:any):string|Uint8Array|null {
 ...
 * Constraints: No constraints specified.
 */
attitudeList(index: number):string
attitudeList(index: number,optionalEncoding:flatbuffers.Encoding):string|Uint8Array
attitudeList(index: number,optionalEncoding?:any):string|Uint8Array|null {
  const offset = this.bb!.__offset(this.bb_pos, 42);
  return offset ? this.bb!.__string(this.bb!.__vector(this.bb_pos + offset) + index * 4, optionalEncoding) : null;
}

attitudeListLength():number {
  const offset = this.bb!.__offset(this.bb_pos, 42);
  return offset ? this.bb!.__vector_len(this.bb_pos + offset) : 0;
}
 ...
 */
dataMode():AttitudeSet_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 58);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AttitudeSet_Ingest_dataMode_Enum.REAL;
}
...
static startAttitudeSet_Ingest(builder:flatbuffers.Builder) {
...
static addAsRef(builder:flatbuffers.Builder, asRefOffset:flatbuffers.Offset) {
  builder.addFieldOffset(7, asRefOffset, 0);
}

static createAsRefVector(builder:flatbuffers.Builder, data:flatbuffers.Offset[]):flatbuffers.Offset {
...
static startAsRefVector(builder:flatbuffers.Builder, numElems:number) {
...
static addFrame1(builder:flatbuffers.Builder, frame1Offset:flatbuffers.Offset) {
  builder.addFieldOffset(12, frame1Offset, 0);
}

static addFrame2(builder:flatbuffers.Builder, frame2Offset:flatbuffers.Offset) {
  builder.addFieldOffset(13, frame2Offset, 0);
}

static addNumPoints(builder:flatbuffers.Builder, numPoints:number) {
  builder.addFieldInt32(14, numPoints, 0);
}

static addStepSize(builder:flatbuffers.Builder, stepSize:number) {
  builder.addFieldInt32(15, stepSize, 0);
}

static addPrecAngleInit(builder:flatbuffers.Builder, precAngleInit:number) {
  builder.addFieldFloat64(16, precAngleInit, 0.0);
}

static addSpinAngleInit(builder:flatbuffers.Builder, spinAngleInit:number) {
  builder.addFieldFloat64(17, spinAngleInit, 0.0);
}

static addEulerRotSeq(builder:flatbuffers.Builder, eulerRotSeqOffset:flatbuffers.Offset) {
  builder.addFieldOffset(18, eulerRotSeqOffset, 0);
}

static addAttitudeList(builder:flatbuffers.Builder, attitudeListOffset:flatbuffers.Offset) {
  builder.addFieldOffset(19, attitudeListOffset, 0);
}

static createAttitudeListVector(builder:flatbuffers.Builder, data:flatbuffers.Offset[]):flatbuffers.Offset {
  builder.startVector(4, data.length, 4);
  for (let i = data.length - 1; i >= 0; i--) {
    builder.addOffset(data[i]!);
  }
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AttitudeSet_Ingest_dataMode_Enum) {
  builder.addFieldInt8(27, dataMode, AttitudeSet_Ingest_dataMode_Enum.REAL);
}
...
static endAttitudeSet_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAttitudeSet_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ATTI');
}

static finishSizePrefixedAttitudeSet_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ATTI', true);
}

static createAttitudeSet_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, satNo:number, origObjectIdOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, esIdOffset:flatbuffers.Offset, asRefOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, origSensorIdOffset:flatbuffers.Offset, startTimeOffset:flatbuffers.Offset, endTimeOffset:flatbuffers.Offset, frame1Offset:flatbuffers.Offset, frame2Offset:flatbuffers.Offset, numPoints:number, stepSize:number, precAngleInit:number, spinAngleInit:number, eulerRotSeqOffset:flatbuffers.Offset, attitudeListOffset:flatbuffers.Offset, interpolatorOffset:flatbuffers.Offset, interpolatorDegree:number, notesOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:AttitudeSet_Ingest_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  AttitudeSet_Ingest.startAttitudeSet_Ingest(builder);
  AttitudeSet_Ingest.addId(builder, idOffset);
  AttitudeSet_Ingest.addClassificationMarking(builder, classificationMarkingOffset);
  AttitudeSet_Ingest.addIdOnOrbit(builder, idOnOrbitOffset);
  AttitudeSet_Ingest.addSatNo(builder, satNo);
  AttitudeSet_Ingest.addOrigObjectId(builder, origObjectIdOffset);
  AttitudeSet_Ingest.addType(builder, typeOffset);
  AttitudeSet_Ingest.addEsId(builder, esIdOffset);
  AttitudeSet_Ingest.addAsRef(builder, asRefOffset);
  AttitudeSet_Ingest.addIdSensor(builder, idSensorOffset);
  AttitudeSet_Ingest.addOrigSensorId(builder, origSensorIdOffset);
  AttitudeSet_Ingest.addStartTime(builder, startTimeOffset);
  AttitudeSet_Ingest.addEndTime(builder, endTimeOffset);
  AttitudeSet_Ingest.addFrame1(builder, frame1Offset);
  AttitudeSet_Ingest.addFrame2(builder, frame2Offset);
  AttitudeSet_Ingest.addNumPoints(builder, numPoints);
  AttitudeSet_Ingest.addStepSize(builder, stepSize);
  AttitudeSet_Ingest.addPrecAngleInit(builder, precAngleInit);
  AttitudeSet_Ingest.addSpinAngleInit(builder, spinAngleInit);
  AttitudeSet_Ingest.addEulerRotSeq(builder, eulerRotSeqOffset);
  AttitudeSet_Ingest.addAttitudeList(builder, attitudeListOffset);
  AttitudeSet_Ingest.addInterpolator(builder, interpolatorOffset);
  AttitudeSet_Ingest.addInterpolatorDegree(builder, interpolatorDegree);
  AttitudeSet_Ingest.addNotes(builder, notesOffset);
  AttitudeSet_Ingest.addCreatedAt(builder, createdAtOffset);
  AttitudeSet_Ingest.addCreatedBy(builder, createdByOffset);
  AttitudeSet_Ingest.addSource(builder, sourceOffset);
  AttitudeSet_Ingest.addOrigin(builder, originOffset);
  AttitudeSet_Ingest.addDataMode(builder, dataMode);
  AttitudeSet_Ingest.addOrigNetwork(builder, origNetworkOffset);
  return AttitudeSet_Ingest.endAttitudeSet_Ingest(builder);
}

unpack(): AttitudeSet_IngestT {
  return new AttitudeSet_IngestT(
    this.id(),
    ...
    this.type(),
    this.esId(),
    this.bb!.createScalarList<string>(this.asRef.bind(this), this.asRef_Length()),
    this.idSensor(),
    this.origSensorId(),
    this.startTime(),
    this.endTime(),
    ...
    this.spinAngleInit(),
    this.eulerRotSeq(),
    this.bb!.createScalarList<string>(this.attitudeList.bind(this), this.attitudeList_Length()),
    this.interpolator(),
...
unpackTo(_o: AttitudeSet_IngestT): void {
  _o.id = this.id();
  ...
  _o.type = this.type();
  _o.esId = this.esId();
  _o.asRef = this.bb!.createScalarList<string>(this.asRef.bind(this), this.asRef_Length());
  ...
  _o.attitudeList = this.bb!.createScalarList<string>(this.attitudeList.bind(this), this.attitudeList_Length());
...
export class AttitudeSet_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AttitudeSet_Ingest_dataMode_Enum = AttitudeSet_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const asRef = AttitudeSet_Ingest.createAsRefVector(builder, builder.createObjectOffsetList(this.asRef));
  ...
  const attitudeList = AttitudeSet_Ingest.createAttitudeListVector(builder, builder.createObjectOffsetList(this.attitudeList));
  ...
  return AttitudeSet_Ingest.createAttitudeSet_Ingest(builder,
    id,
