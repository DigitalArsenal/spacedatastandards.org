...
import { LaunchVehicleDetails_Abridged_dataMode_Enum } from './launch-vehicle-details-abridged-data-mode-enum.js';
 ...
 */
export class LaunchVehicleDetails_Abridged implements flatbuffers.IUnpackableObject<LaunchVehicleDetails_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LaunchVehicleDetails_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLaunchVehicleDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:LaunchVehicleDetails_Abridged):LaunchVehicleDetails_Abridged {
  return (obj || new LaunchVehicleDetails_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLaunchVehicleDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:LaunchVehicleDetails_Abridged):LaunchVehicleDetails_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():LaunchVehicleDetails_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 110);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : LaunchVehicleDetails_Abridged_dataMode_Enum.REAL;
}

static startLaunchVehicleDetails_Abridged(builder:flatbuffers.Builder) {
...
unpack(): LaunchVehicleDetails_AbridgedT {
  return new LaunchVehicleDetails_AbridgedT(
    this.id(),
...
unpackTo(_o: LaunchVehicleDetails_AbridgedT): void {
  _o.id = this.id();
...
export class LaunchVehicleDetails_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: LaunchVehicleDetails_Abridged_dataMode_Enum = LaunchVehicleDetails_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return LaunchVehicleDetails_Abridged.createLaunchVehicleDetails_Abridged(builder,
    id,
    idLaunchVehicle,
