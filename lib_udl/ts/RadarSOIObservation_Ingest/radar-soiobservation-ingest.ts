 ...
 */
export class RadarSOIObservation_Ingest implements flatbuffers.IUnpackableObject<RadarSOIObservation_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):RadarSOIObservation_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsRadarSOIObservation_Ingest(bb:flatbuffers.ByteBuffer, obj?:RadarSOIObservation_Ingest):RadarSOIObservation_Ingest {
  return (obj || new RadarSOIObservation_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRadarSOIObservation_Ingest(bb:flatbuffers.ByteBuffer, obj?:RadarSOIObservation_Ingest):RadarSOIObservation_Ingest {
...
static startRadarSOIObservation_Ingest(builder:flatbuffers.Builder) {
...
unpack(): RadarSOIObservation_IngestT {
  return new RadarSOIObservation_IngestT(
    this.obStartTime(),
    this.bb!.createScalarList<string>(this.tovs.bind(this), this.tovs_Length()),
    this.bb!.createScalarList<string>(this.rspaces.bind(this), this.rspaces_Length()),
    this.bb!.createScalarList<string>(this.xspaces.bind(this), this.xspaces_Length()),
    this.bb!.createScalarList<string>(this.doppler2Xrs.bind(this), this.doppler2XRs_Length()),
    this.bb!.createScalarList<string>(this.deltaTimes.bind(this), this.deltaTimes_Length()),
    this.bb!.createScalarList<string>(this.aspectAngles.bind(this), this.aspectAngles_Length()),
    this.bb!.createScalarList<string>(this.projAngVels.bind(this), this.projAngVels_Length()),
    this.idStateVector(),
    this.idAttitudeSet(),
    this.bb!.createScalarList<string>(this.ranges.bind(this), this.ranges_Length()),
    this.bb!.createScalarList<string>(this.azimuths.bind(this), this.azimuths_Length()),
    this.bb!.createScalarList<string>(this.elevations.bind(this), this.elevations_Length()),
    this.bb!.createScalarList<string>(this.rangeRates.bind(this), this.rangeRates_Length()),
    this.bb!.createScalarList<string>(this.azimuthRates.bind(this), this.azimuthRates_Length()),
    this.bb!.createScalarList<string>(this.elevationRates.bind(this), this.elevationRates_Length()),
    this.bb!.createScalarList<string>(this.azimuthBiases.bind(this), this.azimuthBiases_Length()),
    this.bb!.createScalarList<string>(this.elevationBiases.bind(this), this.elevationBiases_Length()),
    this.bb!.createScalarList<string>(this.rangeBiases.bind(this), this.rangeBiases_Length()),
    this.bb!.createScalarList<string>(this.integrationAngles.bind(this), this.integrationAngles_Length()),
    this.bb!.createScalarList<string>(this.crossRangeRes.bind(this), this.crossRangeRes_Length()),
    this.beta(),
    this.kappa(),
    this.bb!.createScalarList<string>(this.peakAmplitudes.bind(this), this.peakAmplitudes_Length()),
    this.centerFrequency(),
    this.pulseBandwidth(),
    this.bb!.createScalarList<string>(this.xpos.bind(this), this.xpos_Length()),
    this.bb!.createScalarList<string>(this.ypos.bind(this), this.ypos_Length()),
    this.bb!.createScalarList<string>(this.zpos.bind(this), this.zpos_Length()),
    this.bb!.createScalarList<string>(this.xvel.bind(this), this.xvel_Length()),
    this.bb!.createScalarList<string>(this.yvel.bind(this), this.yvel_Length()),
    this.bb!.createScalarList<string>(this.zvel.bind(this), this.zvel_Length())
  );
}


unpackTo(_o: RadarSOIObservation_IngestT): void {
  _o.obStartTime = this.obStartTime();
  _o.tovs = this.bb!.createScalarList<string>(this.tovs.bind(this), this.tovs_Length());
  _o.rspaces = this.bb!.createScalarList<string>(this.rspaces.bind(this), this.rspaces_Length());
  _o.xspaces = this.bb!.createScalarList<string>(this.xspaces.bind(this), this.xspaces_Length());
  _o.doppler2XRs = this.bb!.createScalarList<string>(this.doppler2Xrs.bind(this), this.doppler2XRs_Length());
  _o.deltaTimes = this.bb!.createScalarList<string>(this.deltaTimes.bind(this), this.deltaTimes_Length());
  _o.aspectAngles = this.bb!.createScalarList<string>(this.aspectAngles.bind(this), this.aspectAngles_Length());
  _o.projAngVels = this.bb!.createScalarList<string>(this.projAngVels.bind(this), this.projAngVels_Length());
  _o.idStateVector = this.idStateVector();
  _o.idAttitudeSet = this.idAttitudeSet();
  _o.ranges = this.bb!.createScalarList<string>(this.ranges.bind(this), this.ranges_Length());
  _o.azimuths = this.bb!.createScalarList<string>(this.azimuths.bind(this), this.azimuths_Length());
  _o.elevations = this.bb!.createScalarList<string>(this.elevations.bind(this), this.elevations_Length());
  _o.rangeRates = this.bb!.createScalarList<string>(this.rangeRates.bind(this), this.rangeRates_Length());
  _o.azimuthRates = this.bb!.createScalarList<string>(this.azimuthRates.bind(this), this.azimuthRates_Length());
  _o.elevationRates = this.bb!.createScalarList<string>(this.elevationRates.bind(this), this.elevationRates_Length());
  _o.azimuthBiases = this.bb!.createScalarList<string>(this.azimuthBiases.bind(this), this.azimuthBiases_Length());
  _o.elevationBiases = this.bb!.createScalarList<string>(this.elevationBiases.bind(this), this.elevationBiases_Length());
  _o.rangeBiases = this.bb!.createScalarList<string>(this.rangeBiases.bind(this), this.rangeBiases_Length());
  _o.integrationAngles = this.bb!.createScalarList<string>(this.integrationAngles.bind(this), this.integrationAngles_Length());
  _o.crossRangeRes = this.bb!.createScalarList<string>(this.crossRangeRes.bind(this), this.crossRangeRes_Length());
  _o.beta = this.beta();
  _o.kappa = this.kappa();
  _o.peakAmplitudes = this.bb!.createScalarList<string>(this.peakAmplitudes.bind(this), this.peakAmplitudes_Length());
  _o.centerFrequency = this.centerFrequency();
  _o.pulseBandwidth = this.pulseBandwidth();
  _o.xpos = this.bb!.createScalarList<string>(this.xpos.bind(this), this.xpos_Length());
  _o.ypos = this.bb!.createScalarList<string>(this.ypos.bind(this), this.ypos_Length());
  _o.zpos = this.bb!.createScalarList<string>(this.zpos.bind(this), this.zpos_Length());
  _o.xvel = this.bb!.createScalarList<string>(this.xvel.bind(this), this.xvel_Length());
  _o.yvel = this.bb!.createScalarList<string>(this.yvel.bind(this), this.yvel_Length());
  _o.zvel = this.bb!.createScalarList<string>(this.zvel.bind(this), this.zvel_Length());
}
}

export class RadarSOIObservation_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tovs = RadarSOIObservation_Ingest.createTovsVector(builder, builder.createObjectOffsetList(this.tovs));
  const rspaces = RadarSOIObservation_Ingest.createRspacesVector(builder, builder.createObjectOffsetList(this.rspaces));
  const xspaces = RadarSOIObservation_Ingest.createXspacesVector(builder, builder.createObjectOffsetList(this.xspaces));
  const doppler2XRs = RadarSOIObservation_Ingest.createDoppler2XrsVector(builder, builder.createObjectOffsetList(this.doppler2XRs));
  const deltaTimes = RadarSOIObservation_Ingest.createDeltaTimesVector(builder, builder.createObjectOffsetList(this.deltaTimes));
  const aspectAngles = RadarSOIObservation_Ingest.createAspectAnglesVector(builder, builder.createObjectOffsetList(this.aspectAngles));
  const projAngVels = RadarSOIObservation_Ingest.createProjAngVelsVector(builder, builder.createObjectOffsetList(this.projAngVels));
  ...
  const ranges = RadarSOIObservation_Ingest.createRangesVector(builder, builder.createObjectOffsetList(this.ranges));
  const azimuths = RadarSOIObservation_Ingest.createAzimuthsVector(builder, builder.createObjectOffsetList(this.azimuths));
  const elevations = RadarSOIObservation_Ingest.createElevationsVector(builder, builder.createObjectOffsetList(this.elevations));
  const rangeRates = RadarSOIObservation_Ingest.createRangeRatesVector(builder, builder.createObjectOffsetList(this.rangeRates));
  const azimuthRates = RadarSOIObservation_Ingest.createAzimuthRatesVector(builder, builder.createObjectOffsetList(this.azimuthRates));
  const elevationRates = RadarSOIObservation_Ingest.createElevationRatesVector(builder, builder.createObjectOffsetList(this.elevationRates));
  const azimuthBiases = RadarSOIObservation_Ingest.createAzimuthBiasesVector(builder, builder.createObjectOffsetList(this.azimuthBiases));
  const elevationBiases = RadarSOIObservation_Ingest.createElevationBiasesVector(builder, builder.createObjectOffsetList(this.elevationBiases));
  const rangeBiases = RadarSOIObservation_Ingest.createRangeBiasesVector(builder, builder.createObjectOffsetList(this.rangeBiases));
  const integrationAngles = RadarSOIObservation_Ingest.createIntegrationAnglesVector(builder, builder.createObjectOffsetList(this.integrationAngles));
  const crossRangeRes = RadarSOIObservation_Ingest.createCrossRangeResVector(builder, builder.createObjectOffsetList(this.crossRangeRes));
  const peakAmplitudes = RadarSOIObservation_Ingest.createPeakAmplitudesVector(builder, builder.createObjectOffsetList(this.peakAmplitudes));
  const xpos = RadarSOIObservation_Ingest.createXposVector(builder, builder.createObjectOffsetList(this.xpos));
  const ypos = RadarSOIObservation_Ingest.createYposVector(builder, builder.createObjectOffsetList(this.ypos));
  const zpos = RadarSOIObservation_Ingest.createZposVector(builder, builder.createObjectOffsetList(this.zpos));
  const xvel = RadarSOIObservation_Ingest.createXvelVector(builder, builder.createObjectOffsetList(this.xvel));
  const yvel = RadarSOIObservation_Ingest.createYvelVector(builder, builder.createObjectOffsetList(this.yvel));
  const zvel = RadarSOIObservation_Ingest.createZvelVector(builder, builder.createObjectOffsetList(this.zvel));

  return RadarSOIObservation_Ingest.createRadarSOIObservation_Ingest(builder,
    obStartTime,
    tovs,
    rspaces,
    xspaces,
