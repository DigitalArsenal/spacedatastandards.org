...
import { EffectRequest_Abridged_dataMode_Enum } from './effect-request-abridged-data-mode-enum.js';


/**
 * /// A request for various effects on a target.
 */
export class EffectRequest_Abridged implements flatbuffers.IUnpackableObject<EffectRequest_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EffectRequest_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEffectRequest_Abridged(bb:flatbuffers.ByteBuffer, obj?:EffectRequest_Abridged):EffectRequest_Abridged {
  return (obj || new EffectRequest_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEffectRequest_Abridged(bb:flatbuffers.ByteBuffer, obj?:EffectRequest_Abridged):EffectRequest_Abridged {
 ...
 */
dataMode():EffectRequest_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 42);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : EffectRequest_Abridged_dataMode_Enum.REAL;
}
...
static startEffectRequest_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:EffectRequest_Abridged_dataMode_Enum) {
  builder.addFieldInt8(19, dataMode, EffectRequest_Abridged_dataMode_Enum.REAL);
}
...
static endEffectRequest_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEffectRequest_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EFFE');
}

static finishSizePrefixedEffectRequest_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EFFE', true);
}

static createEffectRequest_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, externalRequestIdOffset:flatbuffers.Offset, effectListOffset:flatbuffers.Offset, stateOffset:flatbuffers.Offset, contextOffset:flatbuffers.Offset, startTimeOffset:flatbuffers.Offset, endTimeOffset:flatbuffers.Offset, deadlineTypeOffset:flatbuffers.Offset, targetSrcTypeOffset:flatbuffers.Offset, targetSrcIdOffset:flatbuffers.Offset, priorityOffset:flatbuffers.Offset, modelClassOffset:flatbuffers.Offset, metricTypesOffset:flatbuffers.Offset, metricWeightsOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:EffectRequest_Abridged_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  EffectRequest_Abridged.startEffectRequest_Abridged(builder);
  EffectRequest_Abridged.addId(builder, idOffset);
  EffectRequest_Abridged.addClassificationMarking(builder, classificationMarkingOffset);
  EffectRequest_Abridged.addExternalRequestId(builder, externalRequestIdOffset);
  EffectRequest_Abridged.addEffectList(builder, effectListOffset);
  EffectRequest_Abridged.addState(builder, stateOffset);
  EffectRequest_Abridged.addContext(builder, contextOffset);
  EffectRequest_Abridged.addStartTime(builder, startTimeOffset);
  EffectRequest_Abridged.addEndTime(builder, endTimeOffset);
  EffectRequest_Abridged.addDeadlineType(builder, deadlineTypeOffset);
  EffectRequest_Abridged.addTargetSrcType(builder, targetSrcTypeOffset);
  EffectRequest_Abridged.addTargetSrcId(builder, targetSrcIdOffset);
  EffectRequest_Abridged.addPriority(builder, priorityOffset);
  EffectRequest_Abridged.addModelClass(builder, modelClassOffset);
  EffectRequest_Abridged.addMetricTypes(builder, metricTypesOffset);
  EffectRequest_Abridged.addMetricWeights(builder, metricWeightsOffset);
  EffectRequest_Abridged.addCreatedAt(builder, createdAtOffset);
  EffectRequest_Abridged.addCreatedBy(builder, createdByOffset);
  EffectRequest_Abridged.addSource(builder, sourceOffset);
  EffectRequest_Abridged.addOrigin(builder, originOffset);
  EffectRequest_Abridged.addDataMode(builder, dataMode);
  EffectRequest_Abridged.addOrigNetwork(builder, origNetworkOffset);
  return EffectRequest_Abridged.endEffectRequest_Abridged(builder);
}

unpack(): EffectRequest_AbridgedT {
  return new EffectRequest_AbridgedT(
    this.id(),
    this.classificationMarking(),
    this.externalRequestId(),
    this.bb!.createScalarList<string>(this.effectList.bind(this), this.effectList_Length()),
    this.state(),
    this.context(),
    this.startTime(),
    this.endTime(),
    ...
    this.priority(),
    this.modelClass(),
    this.bb!.createScalarList<string>(this.metricTypes.bind(this), this.metricTypes_Length()),
    this.bb!.createScalarList<string>(this.metricWeights.bind(this), this.metricWeights_Length()),
    this.createdAt(),
    this.createdBy(),
    this.source(),
    this.origin(),
...
unpackTo(_o: EffectRequest_AbridgedT): void {
  _o.id = this.id();
  _o.classificationMarking = this.classificationMarking();
  _o.externalRequestId = this.externalRequestId();
  _o.effectList = this.bb!.createScalarList<string>(this.effectList.bind(this), this.effectList_Length());
  _o.state = this.state();
  ...
  _o.metricTypes = this.bb!.createScalarList<string>(this.metricTypes.bind(this), this.metricTypes_Length());
  _o.metricWeights = this.bb!.createScalarList<string>(this.metricWeights.bind(this), this.metricWeights_Length());
...
export class EffectRequest_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: EffectRequest_Abridged_dataMode_Enum = EffectRequest_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const effectList = EffectRequest_Abridged.createEffectListVector(builder, builder.createObjectOffsetList(this.effectList));
  ...
  const metricTypes = EffectRequest_Abridged.createMetricTypesVector(builder, builder.createObjectOffsetList(this.metricTypes));
  const metricWeights = EffectRequest_Abridged.createMetricWeightsVector(builder, builder.createObjectOffsetList(this.metricWeights));
  ...
  return EffectRequest_Abridged.createEffectRequest_Abridged(builder,
    id,
