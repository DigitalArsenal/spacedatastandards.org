...
import { AirTaskingOrder_Full_dataMode_Enum } from './air-tasking-order-full-data-mode-enum.js';
 ...
 */
export class AirTaskingOrder_Full implements flatbuffers.IUnpackableObject<AirTaskingOrder_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirTaskingOrder_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirTaskingOrder_Full(bb:flatbuffers.ByteBuffer, obj?:AirTaskingOrder_Full):AirTaskingOrder_Full {
  return (obj || new AirTaskingOrder_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirTaskingOrder_Full(bb:flatbuffers.ByteBuffer, obj?:AirTaskingOrder_Full):AirTaskingOrder_Full {
 ...
 */
dataMode():AirTaskingOrder_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 46);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirTaskingOrder_Full_dataMode_Enum.REAL;
}

static startAirTaskingOrder_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AirTaskingOrder_Full_dataMode_Enum) {
  builder.addFieldInt8(21, dataMode, AirTaskingOrder_Full_dataMode_Enum.REAL);
}

static endAirTaskingOrder_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirTaskingOrder_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRT');
}

static finishSizePrefixedAirTaskingOrder_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRT', true);
}

static createAirTaskingOrder_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, rawFileUriOffset:flatbuffers.Offset, opExerNameOffset:flatbuffers.Offset, msgOriginatorOffset:flatbuffers.Offset, msgSnOffset:flatbuffers.Offset, msgMonthOffset:flatbuffers.Offset, msgQualifierOffset:flatbuffers.Offset, ackReqIndOffset:flatbuffers.Offset, ackUnitInstructionsOffset:flatbuffers.Offset, beginTsOffset:flatbuffers.Offset, endTsOffset:flatbuffers.Offset, genTextOffset:flatbuffers.Offset, acMsnTaskingOffset:flatbuffers.Offset, navalFltOpsOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:AirTaskingOrder_Full_dataMode_Enum):flatbuffers.Offset {
  AirTaskingOrder_Full.startAirTaskingOrder_Full(builder);
...
unpack(): AirTaskingOrder_FullT {
  return new AirTaskingOrder_FullT(
    this.id(),
...
unpackTo(_o: AirTaskingOrder_FullT): void {
  _o.id = this.id();
...
export class AirTaskingOrder_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AirTaskingOrder_Full_dataMode_Enum = AirTaskingOrder_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const genText = AirTaskingOrder_Full.createGenTextVector(builder, builder.createObjectOffsetList(this.genText));
  const acMsnTasking = AirTaskingOrder_Full.createAcMsnTaskingVector(builder, builder.createObjectOffsetList(this.acMsnTasking));
  const navalFltOps = AirTaskingOrder_Full.createNavalFltOpsVector(builder, builder.createObjectOffsetList(this.navalFltOps));
  ...
  return AirTaskingOrder_Full.createAirTaskingOrder_Full(builder,
    id,
