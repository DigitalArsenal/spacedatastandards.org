 ...
 */
export class EvacEtiology_Full implements flatbuffers.IUnpackableObject<EvacEtiology_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EvacEtiology_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEvacEtiology_Full(bb:flatbuffers.ByteBuffer, obj?:EvacEtiology_Full):EvacEtiology_Full {
  return (obj || new EvacEtiology_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEvacEtiology_Full(bb:flatbuffers.ByteBuffer, obj?:EvacEtiology_Full):EvacEtiology_Full {
...
static startEvacEtiology_Full(builder:flatbuffers.Builder) {
...
static endEvacEtiology_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEvacEtiology_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC');
}

static finishSizePrefixedEvacEtiology_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC', true);
}

static createEvacEtiology_Full(builder:flatbuffers.Builder, typeOffset:flatbuffers.Offset, bodyPartOffset:flatbuffers.Offset, timeOffset:flatbuffers.Offset, commentsOffset:flatbuffers.Offset):flatbuffers.Offset {
  EvacEtiology_Full.startEvacEtiology_Full(builder);
...
unpack(): EvacEtiology_FullT {
  return new EvacEtiology_FullT(
    this.type(),
    this.bodyPart(),
    this.time(),
    this.comments()
...
unpackTo(_o: EvacEtiology_FullT): void {
  _o.type = this.type();
...
export class EvacEtiology_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return EvacEtiology_Full.createEvacEtiology_Full(builder,
    type,
    bodyPart,
    time,
    comments
