...
import { TrackSensor_Ingest_sensorFOVType_Enum } from './track-sensor-ingest-sensor-fovtype-enum.js';


/**
 * /// Schema for Track Sensor data.
 */
export class TrackSensor_Ingest implements flatbuffers.IUnpackableObject<TrackSensor_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):TrackSensor_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsTrackSensor_Ingest(bb:flatbuffers.ByteBuffer, obj?:TrackSensor_Ingest):TrackSensor_Ingest {
  return (obj || new TrackSensor_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTrackSensor_Ingest(bb:flatbuffers.ByteBuffer, obj?:TrackSensor_Ingest):TrackSensor_Ingest {
 ...
 */
sensorFovtype():TrackSensor_Ingest_sensorFOVType_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 16);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : TrackSensor_Ingest_sensorFOVType_Enum.BUTTERFLY;
}

static startTrackSensor_Ingest(builder:flatbuffers.Builder) {
...
static addSensorFovtype(builder:flatbuffers.Builder, sensorFovtype:TrackSensor_Ingest_sensorFOVType_Enum) {
  builder.addFieldInt8(6, sensorFovtype, TrackSensor_Ingest_sensorFOVType_Enum.BUTTERFLY);
}

static endTrackSensor_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishTrackSensor_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TRAC');
}

static finishSizePrefixedTrackSensor_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TRAC', true);
}

static createTrackSensor_Ingest(builder:flatbuffers.Builder, range:number, az:number, sensorNumber:number, sensorNameOffset:flatbuffers.Offset, missionNumberOffset:flatbuffers.Offset, minRangeLimit:number, sensorFovtype:TrackSensor_Ingest_sensorFOVType_Enum):flatbuffers.Offset {
  TrackSensor_Ingest.startTrackSensor_Ingest(builder);
...
unpack(): TrackSensor_IngestT {
  return new TrackSensor_IngestT(
    this.range(),
    this.az(),
    this.sensorNumber(),
    this.sensorName(),
...
unpackTo(_o: TrackSensor_IngestT): void {
  _o.range = this.range();
  _o.az = this.az();
...
export class TrackSensor_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public sensorFOVType: TrackSensor_Ingest_sensorFOVType_Enum = TrackSensor_Ingest_sensorFOVType_Enum.BUTTERFLY
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return TrackSensor_Ingest.createTrackSensor_Ingest(builder,
    this.range,
    this.az,
    this.sensorNumber,
    sensorName,
