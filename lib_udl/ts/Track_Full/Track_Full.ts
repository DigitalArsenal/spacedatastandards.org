...
import { Track_Full_dataMode_Enum } from './Track_Full_dataMode_Enum.js';
 ...
 */
export class Track_Full implements flatbuffers.IUnpackableObject<Track_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Track_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsTrack_Full(bb:flatbuffers.ByteBuffer, obj?:Track_Full):Track_Full {
  return (obj || new Track_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTrack_Full(bb:flatbuffers.ByteBuffer, obj?:Track_Full):Track_Full {
 ...
 */
dataMode():Track_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 136);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Track_Full_dataMode_Enum.REAL;
}
...
static startTrack_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Track_Full_dataMode_Enum) {
  builder.addFieldInt8(66, dataMode, Track_Full_dataMode_Enum.REAL);
}
...
static endTrack_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishTrack_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TRAC');
}

static finishSizePrefixedTrack_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TRAC', true);
}

static createTrack_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, cntctOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, msgTsOffset:flatbuffers.Offset, msnIdOffset:flatbuffers.Offset, assetNatOffset:flatbuffers.Offset, assetOffset:flatbuffers.Offset, senOffset:flatbuffers.Offset, senQualOffset:flatbuffers.Offset, trkIdOffset:flatbuffers.Offset, trkNumOffset:flatbuffers.Offset, trkStatOffset:flatbuffers.Offset, objNatOffset:flatbuffers.Offset, objIdOffset:flatbuffers.Offset, objTypeOffset:flatbuffers.Offset, objSpecOffset:flatbuffers.Offset, objPlatOffset:flatbuffers.Offset, objActOffset:flatbuffers.Offset, modTypeOffset:flatbuffers.Offset, trkItmIdOffset:flatbuffers.Offset, tsOffset:flatbuffers.Offset, trkQual:number, trkPtTypeOffset:flatbuffers.Offset, objIdentOffset:flatbuffers.Offset, identCred:number, identRel:number, identAmpOffset:flatbuffers.Offset, envOffset:flatbuffers.Offset, envConf:number, trkConf:number, ecefPosOffset:flatbuffers.Offset, ecefVelOffset:flatbuffers.Offset, ecefAccOffset:flatbuffers.Offset, lat:number, lon:number, alt:number, spd:number, hdng:number, course:number, lcoOffset:flatbuffers.Offset, lcsOffset:flatbuffers.Offset, lcPosOffset:flatbuffers.Offset, lcVelOffset:flatbuffers.Offset, lcAccOffset:flatbuffers.Offset, eNuvelOffset:flatbuffers.Offset, eNuposOffset:flatbuffers.Offset, covOffset:flatbuffers.Offset, errEllpOffset:flatbuffers.Offset, srcTypsOffset:flatbuffers.Offset, srcIdsOffset:flatbuffers.Offset, callSignOffset:flatbuffers.Offset, multiSource:boolean, jSeriesOffset:flatbuffers.Offset, strength:number, m1:number, m1v:number, m2:number, m2v:number, m3a:number, m3av:number, tagsOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:Track_Full_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  Track_Full.startTrack_Full(builder);
  Track_Full.addId(builder, idOffset);
  Track_Full.addClassificationMarking(builder, classificationMarkingOffset);
  Track_Full.addCntct(builder, cntctOffset);
  Track_Full.addCreatedAt(builder, createdAtOffset);
  Track_Full.addCreatedBy(builder, createdByOffset);
  Track_Full.addMsgTs(builder, msgTsOffset);
  Track_Full.addMsnId(builder, msnIdOffset);
  Track_Full.addAssetNat(builder, assetNatOffset);
  Track_Full.addAsset(builder, assetOffset);
  Track_Full.addSen(builder, senOffset);
  Track_Full.addSenQual(builder, senQualOffset);
  Track_Full.addTrkId(builder, trkIdOffset);
  Track_Full.addTrkNum(builder, trkNumOffset);
  Track_Full.addTrkStat(builder, trkStatOffset);
  Track_Full.addObjNat(builder, objNatOffset);
  Track_Full.addObjId(builder, objIdOffset);
  Track_Full.addObjType(builder, objTypeOffset);
  Track_Full.addObjSpec(builder, objSpecOffset);
  Track_Full.addObjPlat(builder, objPlatOffset);
  Track_Full.addObjAct(builder, objActOffset);
  Track_Full.addModType(builder, modTypeOffset);
  Track_Full.addTrkItmId(builder, trkItmIdOffset);
  Track_Full.addTs(builder, tsOffset);
  Track_Full.addTrkQual(builder, trkQual);
  Track_Full.addTrkPtType(builder, trkPtTypeOffset);
  Track_Full.addObjIdent(builder, objIdentOffset);
  Track_Full.addIdentCred(builder, identCred);
  Track_Full.addIdentRel(builder, identRel);
  Track_Full.addIdentAmp(builder, identAmpOffset);
  Track_Full.addEnv(builder, envOffset);
  Track_Full.addEnvConf(builder, envConf);
  Track_Full.addTrkConf(builder, trkConf);
  Track_Full.addEcefPos(builder, ecefPosOffset);
  Track_Full.addEcefVel(builder, ecefVelOffset);
  Track_Full.addEcefAcc(builder, ecefAccOffset);
  Track_Full.addLat(builder, lat);
  Track_Full.addLon(builder, lon);
  Track_Full.addAlt(builder, alt);
  Track_Full.addSpd(builder, spd);
  Track_Full.addHdng(builder, hdng);
  Track_Full.addCourse(builder, course);
  Track_Full.addLco(builder, lcoOffset);
  Track_Full.addLcs(builder, lcsOffset);
  Track_Full.addLcPos(builder, lcPosOffset);
  Track_Full.addLcVel(builder, lcVelOffset);
  Track_Full.addLcAcc(builder, lcAccOffset);
  Track_Full.addENuvel(builder, eNuvelOffset);
  Track_Full.addENupos(builder, eNuposOffset);
  Track_Full.addCov(builder, covOffset);
  Track_Full.addErrEllp(builder, errEllpOffset);
  Track_Full.addSrcTyps(builder, srcTypsOffset);
  Track_Full.addSrcIds(builder, srcIdsOffset);
  Track_Full.addCallSign(builder, callSignOffset);
  Track_Full.addMultiSource(builder, multiSource);
  Track_Full.addJSeries(builder, jSeriesOffset);
  Track_Full.addStrength(builder, strength);
  Track_Full.addM1(builder, m1);
  Track_Full.addM1v(builder, m1v);
  Track_Full.addM2(builder, m2);
  Track_Full.addM2v(builder, m2v);
  Track_Full.addM3a(builder, m3a);
  Track_Full.addM3av(builder, m3av);
  Track_Full.addTags(builder, tagsOffset);
  Track_Full.addSourceDl(builder, sourceDlOffset);
  Track_Full.addSource(builder, sourceOffset);
  Track_Full.addOrigin(builder, originOffset);
  Track_Full.addDataMode(builder, dataMode);
  Track_Full.addOrigNetwork(builder, origNetworkOffset);
  return Track_Full.endTrack_Full(builder);
}

unpack(): Track_FullT {
  return new Track_FullT(
    this.id(),
    ...
    this.bb!.createScalarList<string>(this.ecefAcc.bind(this), this.ecefAccLength()),
    this.lat(),
    this.lon(),
    this.alt(),
    this.spd(),
    ...
    this.bb!.createScalarList<string>(this.lcPos.bind(this), this.lcPosLength()),
    this.bb!.createScalarList<string>(this.lcVel.bind(this), this.lcVelLength()),
    this.bb!.createScalarList<string>(this.lcAcc.bind(this), this.lcAccLength()),
    this.bb!.createScalarList<string>(this.eNuvel.bind(this), this.eNuvelLength()),
    this.bb!.createScalarList<string>(this.eNupos.bind(this), this.eNuposLength()),
    this.bb!.createScalarList<string>(this.cov.bind(this), this.covLength()),
    this.bb!.createScalarList<string>(this.errEllp.bind(this), this.errEllpLength()),
...
unpackTo(_o: Track_FullT): void {
  ...
  _o.ecefAcc = this.bb!.createScalarList<string>(this.ecefAcc.bind(this), this.ecefAccLength());
  _o.lat = this.lat();
  _o.lon = this.lon();
  _o.alt = this.alt();
  _o.spd = this.spd();
  ...
  _o.lcPos = this.bb!.createScalarList<string>(this.lcPos.bind(this), this.lcPosLength());
  _o.lcVel = this.bb!.createScalarList<string>(this.lcVel.bind(this), this.lcVelLength());
  _o.lcAcc = this.bb!.createScalarList<string>(this.lcAcc.bind(this), this.lcAccLength());
  _o.eNuvel = this.bb!.createScalarList<string>(this.eNuvel.bind(this), this.eNuvelLength());
  _o.eNupos = this.bb!.createScalarList<string>(this.eNupos.bind(this), this.eNuposLength());
  _o.cov = this.bb!.createScalarList<string>(this.cov.bind(this), this.covLength());
  _o.errEllp = this.bb!.createScalarList<string>(this.errEllp.bind(this), this.errEllpLength());
...
export class Track_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Track_Full_dataMode_Enum = Track_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const ecefPos = Track_Full.createEcefPosVector(builder, builder.createObjectOffsetList(this.ecefPos));
  const ecefVel = Track_Full.createEcefVelVector(builder, builder.createObjectOffsetList(this.ecefVel));
  const ecefAcc = Track_Full.createEcefAccVector(builder, builder.createObjectOffsetList(this.ecefAcc));
  const lco = Track_Full.createLcoVector(builder, builder.createObjectOffsetList(this.lco));
  const lcs = Track_Full.createLcsVector(builder, builder.createObjectOffsetList(this.lcs));
  const lcPos = Track_Full.createLcPosVector(builder, builder.createObjectOffsetList(this.lcPos));
  const lcVel = Track_Full.createLcVelVector(builder, builder.createObjectOffsetList(this.lcVel));
  const lcAcc = Track_Full.createLcAccVector(builder, builder.createObjectOffsetList(this.lcAcc));
  const eNuvel = Track_Full.createENuvelVector(builder, builder.createObjectOffsetList(this.eNuvel));
  const eNupos = Track_Full.createENuposVector(builder, builder.createObjectOffsetList(this.eNupos));
  const cov = Track_Full.createCovVector(builder, builder.createObjectOffsetList(this.cov));
  const errEllp = Track_Full.createErrEllpVector(builder, builder.createObjectOffsetList(this.errEllp));
  const srcTyps = Track_Full.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = Track_Full.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  ...
  const tags = Track_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  const sourceDl = (this.sourceDl !== null ? builder.createString(this.sourceDl!) : 0);
  const source = (this.source !== null ? builder.createString(this.source!) : 0);
  const origin = (this.origin !== null ? builder.createString(this.origin!) : 0);
  const origNetwork = (this.origNetwork !== null ? builder.createString(this.origNetwork!) : 0);

  return Track_Full.createTrack_Full(builder,
    id,
