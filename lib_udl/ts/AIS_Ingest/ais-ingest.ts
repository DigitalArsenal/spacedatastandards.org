...
import { AIS_Ingest_dataMode_Enum } from './ais-ingest-data-mode-enum.js';
 ...
 */
export class AIS_Ingest implements flatbuffers.IUnpackableObject<AIS_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AIS_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAIS_Ingest(bb:flatbuffers.ByteBuffer, obj?:AIS_Ingest):AIS_Ingest {
  return (obj || new AIS_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAIS_Ingest(bb:flatbuffers.ByteBuffer, obj?:AIS_Ingest):AIS_Ingest {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new AIS_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static bufferHasIdentifier(bb:flatbuffers.ByteBuffer):boolean {
  return bb.__has_identifier('AISI');
}
 ...
 */
dataMode():AIS_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 102);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AIS_Ingest_dataMode_Enum.REAL;
}
...
static startAIS_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AIS_Ingest_dataMode_Enum) {
  builder.addFieldInt8(49, dataMode, AIS_Ingest_dataMode_Enum.REAL);
}
...
export class AIS_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AIS_Ingest_dataMode_Enum = AIS_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const antennaRefDimensions = AIS_Ingest.createAntennaRefDimensionsVector(builder, builder.createObjectOffsetList(this.antennaRefDimensions));
  ...
  return AIS_Ingest.createAIS_Ingest(builder,
    id,
