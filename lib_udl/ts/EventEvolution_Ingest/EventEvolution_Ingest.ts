...
import { EventEvolution_Ingest_dataMode_Enum } from './EventEvolution_Ingest_dataMode_Enum.js';
...
unpack(): EventEvolution_IngestT {
  return new EventEvolution_IngestT(
    ...
    this.andims(),
    this.asrid(),
    this.bb!.createScalarList<string>(this.url.bind(this), this.urlLength()),
...
unpackTo(_o: EventEvolution_IngestT): void {
  ...
  _o.asrid = this.asrid();
  _o.url = this.bb!.createScalarList<string>(this.url.bind(this), this.urlLength());
