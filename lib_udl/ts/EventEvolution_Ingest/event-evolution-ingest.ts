...
import { EventEvolution_Ingest_dataMode_Enum } from './event-evolution-ingest-data-mode-enum.js';
 ...
 */
export class EventEvolution_Ingest implements flatbuffers.IUnpackableObject<EventEvolution_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EventEvolution_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEventEvolution_Ingest(bb:flatbuffers.ByteBuffer, obj?:EventEvolution_Ingest):EventEvolution_Ingest {
  return (obj || new EventEvolution_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEventEvolution_Ingest(bb:flatbuffers.ByteBuffer, obj?:EventEvolution_Ingest):EventEvolution_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():EventEvolution_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 62);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : EventEvolution_Ingest_dataMode_Enum.REAL;
}

static startEventEvolution_Ingest(builder:flatbuffers.Builder) {
...
unpack(): EventEvolution_IngestT {
  return new EventEvolution_IngestT(
    this.id(),
...
unpackTo(_o: EventEvolution_IngestT): void {
  _o.id = this.id();
...
export class EventEvolution_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: EventEvolution_Ingest_dataMode_Enum = EventEvolution_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const srcTyps = EventEvolution_Ingest.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = EventEvolution_Ingest.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  ...
  const url = EventEvolution_Ingest.createUrlVector(builder, builder.createObjectOffsetList(this.url));
  const tags = EventEvolution_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return EventEvolution_Ingest.createEventEvolution_Ingest(builder,
    id,
