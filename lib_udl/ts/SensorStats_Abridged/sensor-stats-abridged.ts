...
import { SensorStats_Abridged_dataMode_Enum } from './sensor-stats-abridged-data-mode-enum.js';


/**
 * /// SensorStats contain statistics on sensors related to observation production such as last reported observation time.
 */
export class SensorStats_Abridged implements flatbuffers.IUnpackableObject<SensorStats_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SensorStats_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSensorStats_Abridged(bb:flatbuffers.ByteBuffer, obj?:SensorStats_Abridged):SensorStats_Abridged {
  return (obj || new SensorStats_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSensorStats_Abridged(bb:flatbuffers.ByteBuffer, obj?:SensorStats_Abridged):SensorStats_Abridged {
 ...
 */
dataMode():SensorStats_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 22);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SensorStats_Abridged_dataMode_Enum.REAL;
}

static startSensorStats_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SensorStats_Abridged_dataMode_Enum) {
  builder.addFieldInt8(9, dataMode, SensorStats_Abridged_dataMode_Enum.REAL);
}

static endSensorStats_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSensorStats_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SENS');
}

static finishSizePrefixedSensorStats_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SENS', true);
}

static createSensorStats_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, lastObTimeOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, dataMode:SensorStats_Abridged_dataMode_Enum):flatbuffers.Offset {
  SensorStats_Abridged.startSensorStats_Abridged(builder);
...
unpack(): SensorStats_AbridgedT {
  return new SensorStats_AbridgedT(
    this.id(),
    this.idSensor(),
...
unpackTo(_o: SensorStats_AbridgedT): void {
  _o.id = this.id();
...
export class SensorStats_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SensorStats_Abridged_dataMode_Enum = SensorStats_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SensorStats_Abridged.createSensorStats_Abridged(builder,
    id,
    idSensor,
