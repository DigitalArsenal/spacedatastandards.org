 ...
 */
export class LogisticsParts_Abridged implements flatbuffers.IUnpackableObject<LogisticsParts_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LogisticsParts_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLogisticsParts_Abridged(bb:flatbuffers.ByteBuffer, obj?:LogisticsParts_Abridged):LogisticsParts_Abridged {
  return (obj || new LogisticsParts_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLogisticsParts_Abridged(bb:flatbuffers.ByteBuffer, obj?:LogisticsParts_Abridged):LogisticsParts_Abridged {
...
static startLogisticsParts_Abridged(builder:flatbuffers.Builder) {
...
unpack(): LogisticsParts_AbridgedT {
  return new LogisticsParts_AbridgedT(
    this.partNumber(),
    ...
    this.bb!.createScalarList<string>(this.logisticsStocks.bind(this), this.logisticsStocks_Length())
  );
}


unpackTo(_o: LogisticsParts_AbridgedT): void {
  ...
  _o.logisticsStocks = this.bb!.createScalarList<string>(this.logisticsStocks.bind(this), this.logisticsStocks_Length());
}
}

export class LogisticsParts_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const logisticsStocks = LogisticsParts_Abridged.createLogisticsStocksVector(builder, builder.createObjectOffsetList(this.logisticsStocks));

  return LogisticsParts_Abridged.createLogisticsParts_Abridged(builder,
    partNumber,
    nationalStockNumber,
    measurementUnitCode,
    workUnitCode,
