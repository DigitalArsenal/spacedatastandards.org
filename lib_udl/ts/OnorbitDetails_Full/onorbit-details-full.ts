...
import { OnorbitDetails_Full_dataMode_Enum } from './onorbit-details-full-data-mode-enum.js';


/**
 * /// Contains details of the OnOrbit object.
 */
export class OnorbitDetails_Full implements flatbuffers.IUnpackableObject<OnorbitDetails_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OnorbitDetails_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOnorbitDetails_Full(bb:flatbuffers.ByteBuffer, obj?:OnorbitDetails_Full):OnorbitDetails_Full {
  return (obj || new OnorbitDetails_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOnorbitDetails_Full(bb:flatbuffers.ByteBuffer, obj?:OnorbitDetails_Full):OnorbitDetails_Full {
 ...
 */
dataMode():OnorbitDetails_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 92);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OnorbitDetails_Full_dataMode_Enum.REAL;
}
...
static startOnorbitDetails_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:OnorbitDetails_Full_dataMode_Enum) {
  builder.addFieldInt8(44, dataMode, OnorbitDetails_Full_dataMode_Enum.REAL);
}
...
unpack(): OnorbitDetails_FullT {
  return new OnorbitDetails_FullT(
    this.id(),
    this.idOnOrbit(),
...
unpackTo(_o: OnorbitDetails_FullT): void {
  _o.id = this.id();
...
export class OnorbitDetails_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: OnorbitDetails_Full_dataMode_Enum = OnorbitDetails_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const missionTypes = OnorbitDetails_Full.createMissionTypesVector(builder, builder.createObjectOffsetList(this.missionTypes));
  const busType = (this.busType !== null ? builder.createString(this.busType!) : 0);
  const depNames = OnorbitDetails_Full.createDepNamesVector(builder, builder.createObjectOffsetList(this.depNames));
  const depEstMasses = OnorbitDetails_Full.createDepEstMassesVector(builder, builder.createObjectOffsetList(this.depEstMasses));
  const depMassUncs = OnorbitDetails_Full.createDepMassUncsVector(builder, builder.createObjectOffsetList(this.depMassUncs));
  ...
  return OnorbitDetails_Full.createOnorbitDetails_Full(builder,
    id,
    idOnOrbit,
