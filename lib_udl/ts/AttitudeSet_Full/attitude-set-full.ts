...
import { AttitudeSet_Full_dataMode_Enum } from './attitude-set-full-data-mode-enum.js';
 ...
 */
export class AttitudeSet_Full implements flatbuffers.IUnpackableObject<AttitudeSet_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AttitudeSet_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAttitudeSet_Full(bb:flatbuffers.ByteBuffer, obj?:AttitudeSet_Full):AttitudeSet_Full {
  return (obj || new AttitudeSet_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAttitudeSet_Full(bb:flatbuffers.ByteBuffer, obj?:AttitudeSet_Full):AttitudeSet_Full {
 ...
 */
dataMode():AttitudeSet_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 58);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AttitudeSet_Full_dataMode_Enum.REAL;
}
...
static startAttitudeSet_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AttitudeSet_Full_dataMode_Enum) {
  builder.addFieldInt8(27, dataMode, AttitudeSet_Full_dataMode_Enum.REAL);
}
...
unpack(): AttitudeSet_FullT {
  return new AttitudeSet_FullT(
    this.id(),
...
unpackTo(_o: AttitudeSet_FullT): void {
  _o.id = this.id();
...
export class AttitudeSet_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AttitudeSet_Full_dataMode_Enum = AttitudeSet_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const asRef = AttitudeSet_Full.createAsRefVector(builder, builder.createObjectOffsetList(this.asRef));
  ...
  const attitudeList = AttitudeSet_Full.createAttitudeListVector(builder, builder.createObjectOffsetList(this.attitudeList));
  ...
  return AttitudeSet_Full.createAttitudeSet_Full(builder,
    id,
