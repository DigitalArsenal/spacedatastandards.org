...
static finishEvacEnemyData_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC');
}

static finishSizePrefixedEvacEnemyData_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
