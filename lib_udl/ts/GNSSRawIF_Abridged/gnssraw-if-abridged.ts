...
import { GNSSRawIF_Abridged_dataMode_Enum } from './gnssraw-if-abridged-data-mode-enum.js';
 ...
 */
export class GNSSRawIF_Abridged implements flatbuffers.IUnpackableObject<GNSSRawIF_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):GNSSRawIF_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsGNSSRawIF_Abridged(bb:flatbuffers.ByteBuffer, obj?:GNSSRawIF_Abridged):GNSSRawIF_Abridged {
  return (obj || new GNSSRawIF_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsGNSSRawIF_Abridged(bb:flatbuffers.ByteBuffer, obj?:GNSSRawIF_Abridged):GNSSRawIF_Abridged {
 ...
 */
dataMode():GNSSRawIF_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 80);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : GNSSRawIF_Abridged_dataMode_Enum.REAL;
}
...
static startGNSSRawIF_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:GNSSRawIF_Abridged_dataMode_Enum) {
  builder.addFieldInt8(38, dataMode, GNSSRawIF_Abridged_dataMode_Enum.REAL);
}
...
static endGNSSRawIF_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishGNSSRawIF_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'GNSS');
}

static finishSizePrefixedGNSSRawIF_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'GNSS', true);
}

static createGNSSRawIF_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, satNo:number, origObjectIdOffset:flatbuffers.Offset, esIdOffset:flatbuffers.Offset, receiverOffset:flatbuffers.Offset, boresightOffset:flatbuffers.Offset, quatOffset:flatbuffers.Offset, startIndex:number, startTimeOffset:flatbuffers.Offset, endTimeOffset:flatbuffers.Offset, startLat:number, startLon:number, startAlt:number, endLat:number, endLon:number, endAlt:number, centerFreqOffset:flatbuffers.Offset, ifFreqOffset:flatbuffers.Offset, sampleRateOffset:flatbuffers.Offset, postFourierOffset:flatbuffers.Offset, sampleTypeOffset:flatbuffers.Offset, bitDepth:number, diffCodeBiasOffset:flatbuffers.Offset, dataRate:number, setIdOffset:flatbuffers.Offset, setLength:number, sequenceId:number, fileNameOffset:flatbuffers.Offset, srcTypsOffset:flatbuffers.Offset, srcIdsOffset:flatbuffers.Offset, fileSize:bigint, tagsOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:GNSSRawIF_Abridged_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  GNSSRawIF_Abridged.startGNSSRawIF_Abridged(builder);
  GNSSRawIF_Abridged.addId(builder, idOffset);
  GNSSRawIF_Abridged.addClassificationMarking(builder, classificationMarkingOffset);
  GNSSRawIF_Abridged.addIdOnOrbit(builder, idOnOrbitOffset);
  GNSSRawIF_Abridged.addSatNo(builder, satNo);
  GNSSRawIF_Abridged.addOrigObjectId(builder, origObjectIdOffset);
  GNSSRawIF_Abridged.addEsId(builder, esIdOffset);
  GNSSRawIF_Abridged.addReceiver(builder, receiverOffset);
  GNSSRawIF_Abridged.addBoresight(builder, boresightOffset);
  GNSSRawIF_Abridged.addQuat(builder, quatOffset);
  GNSSRawIF_Abridged.addStartIndex(builder, startIndex);
  GNSSRawIF_Abridged.addStartTime(builder, startTimeOffset);
  GNSSRawIF_Abridged.addEndTime(builder, endTimeOffset);
  GNSSRawIF_Abridged.addStartLat(builder, startLat);
  GNSSRawIF_Abridged.addStartLon(builder, startLon);
  GNSSRawIF_Abridged.addStartAlt(builder, startAlt);
  GNSSRawIF_Abridged.addEndLat(builder, endLat);
  GNSSRawIF_Abridged.addEndLon(builder, endLon);
  GNSSRawIF_Abridged.addEndAlt(builder, endAlt);
  GNSSRawIF_Abridged.addCenterFreq(builder, centerFreqOffset);
  GNSSRawIF_Abridged.addIfFreq(builder, ifFreqOffset);
  GNSSRawIF_Abridged.addSampleRate(builder, sampleRateOffset);
  GNSSRawIF_Abridged.addPostFourier(builder, postFourierOffset);
  GNSSRawIF_Abridged.addSampleType(builder, sampleTypeOffset);
  GNSSRawIF_Abridged.addBitDepth(builder, bitDepth);
  GNSSRawIF_Abridged.addDiffCodeBias(builder, diffCodeBiasOffset);
  GNSSRawIF_Abridged.addDataRate(builder, dataRate);
  GNSSRawIF_Abridged.addSetId(builder, setIdOffset);
  GNSSRawIF_Abridged.addSetLength(builder, setLength);
  GNSSRawIF_Abridged.addSequenceId(builder, sequenceId);
  GNSSRawIF_Abridged.addFileName(builder, fileNameOffset);
  GNSSRawIF_Abridged.addSrcTyps(builder, srcTypsOffset);
  GNSSRawIF_Abridged.addSrcIds(builder, srcIdsOffset);
  GNSSRawIF_Abridged.addFileSize(builder, fileSize);
  GNSSRawIF_Abridged.addTags(builder, tagsOffset);
  GNSSRawIF_Abridged.addCreatedAt(builder, createdAtOffset);
  GNSSRawIF_Abridged.addCreatedBy(builder, createdByOffset);
  GNSSRawIF_Abridged.addSource(builder, sourceOffset);
  GNSSRawIF_Abridged.addOrigin(builder, originOffset);
  GNSSRawIF_Abridged.addDataMode(builder, dataMode);
  GNSSRawIF_Abridged.addOrigNetwork(builder, origNetworkOffset);
  return GNSSRawIF_Abridged.endGNSSRawIF_Abridged(builder);
}

unpack(): GNSSRawIF_AbridgedT {
  return new GNSSRawIF_AbridgedT(
    this.id(),
    ...
    this.esId(),
    this.receiver(),
    this.bb!.createScalarList<string>(this.boresight.bind(this), this.boresight_Length()),
    this.bb!.createScalarList<string>(this.quat.bind(this), this.quat_Length()),
    this.startIndex(),
    this.startTime(),
    this.endTime(),
    this.startLat(),
    ...
    this.endLon(),
    this.endAlt(),
    this.bb!.createScalarList<string>(this.centerFreq.bind(this), this.centerFreq_Length()),
    this.bb!.createScalarList<string>(this.ifFreq.bind(this), this.ifFreq_Length()),
    this.bb!.createScalarList<string>(this.sampleRate.bind(this), this.sampleRate_Length()),
    this.bb!.createScalarList<string>(this.postFourier.bind(this), this.postFourier_Length()),
    this.sampleType(),
    this.bitDepth(),
    this.bb!.createScalarList<string>(this.diffCodeBias.bind(this), this.diffCodeBias_Length()),
    this.dataRate(),
    this.setId(),
    this.setLength(),
    this.sequenceId(),
...
unpackTo(_o: GNSSRawIF_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.boresight = this.bb!.createScalarList<string>(this.boresight.bind(this), this.boresight_Length());
  _o.quat = this.bb!.createScalarList<string>(this.quat.bind(this), this.quat_Length());
  ...
  _o.centerFreq = this.bb!.createScalarList<string>(this.centerFreq.bind(this), this.centerFreq_Length());
  _o.ifFreq = this.bb!.createScalarList<string>(this.ifFreq.bind(this), this.ifFreq_Length());
  _o.sampleRate = this.bb!.createScalarList<string>(this.sampleRate.bind(this), this.sampleRate_Length());
  _o.postFourier = this.bb!.createScalarList<string>(this.postFourier.bind(this), this.postFourier_Length());
  _o.sampleType = this.sampleType();
  _o.bitDepth = this.bitDepth();
  _o.diffCodeBias = this.bb!.createScalarList<string>(this.diffCodeBias.bind(this), this.diffCodeBias_Length());
...
export class GNSSRawIF_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: GNSSRawIF_Abridged_dataMode_Enum = GNSSRawIF_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const boresight = GNSSRawIF_Abridged.createBoresightVector(builder, builder.createObjectOffsetList(this.boresight));
  const quat = GNSSRawIF_Abridged.createQuatVector(builder, builder.createObjectOffsetList(this.quat));
  ...
  const centerFreq = GNSSRawIF_Abridged.createCenterFreqVector(builder, builder.createObjectOffsetList(this.centerFreq));
  const ifFreq = GNSSRawIF_Abridged.createIfFreqVector(builder, builder.createObjectOffsetList(this.ifFreq));
  const sampleRate = GNSSRawIF_Abridged.createSampleRateVector(builder, builder.createObjectOffsetList(this.sampleRate));
  const postFourier = GNSSRawIF_Abridged.createPostFourierVector(builder, builder.createObjectOffsetList(this.postFourier));
  const sampleType = (this.sampleType !== null ? builder.createString(this.sampleType!) : 0);
  const diffCodeBias = GNSSRawIF_Abridged.createDiffCodeBiasVector(builder, builder.createObjectOffsetList(this.diffCodeBias));
  ...
  const srcTyps = GNSSRawIF_Abridged.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = GNSSRawIF_Abridged.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  const tags = GNSSRawIF_Abridged.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return GNSSRawIF_Abridged.createGNSSRawIF_Abridged(builder,
    id,
