 ...
 */
export class AircraftMissionRequirements_Ingest implements flatbuffers.IUnpackableObject<AircraftMissionRequirements_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AircraftMissionRequirements_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAircraftMissionRequirements_Ingest(bb:flatbuffers.ByteBuffer, obj?:AircraftMissionRequirements_Ingest):AircraftMissionRequirements_Ingest {
  return (obj || new AircraftMissionRequirements_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAircraftMissionRequirements_Ingest(bb:flatbuffers.ByteBuffer, obj?:AircraftMissionRequirements_Ingest):AircraftMissionRequirements_Ingest {
...
static startAircraftMissionRequirements_Ingest(builder:flatbuffers.Builder) {
...
static endAircraftMissionRequirements_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAircraftMissionRequirements_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRC');
}

static finishSizePrefixedAircraftMissionRequirements_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRC', true);
}

static createAircraftMissionRequirements_Ingest(builder:flatbuffers.Builder, gdssReqIdOffset:flatbuffers.Offset, onloadId:number, onloadLocodeOffset:flatbuffers.Offset, offloadId:number, offloadLocodeOffset:flatbuffers.Offset, ulnOffset:flatbuffers.Offset, transReqNumOffset:flatbuffers.Offset, projNameOffset:flatbuffers.Offset, oplanOffset:flatbuffers.Offset, numPax:number, numLitter:number, numAmbulatory:number, numAttendant:number, bulkWeight:number, oversizeWeight:number, outsizeWeight:number, eadOffset:flatbuffers.Offset, ladOffset:flatbuffers.Offset):flatbuffers.Offset {
  AircraftMissionRequirements_Ingest.startAircraftMissionRequirements_Ingest(builder);
...
unpack(): AircraftMissionRequirements_IngestT {
  return new AircraftMissionRequirements_IngestT(
    this.gdssReqId(),
    this.onloadId(),
    this.onloadLocode(),
    this.offloadId(),
...
unpackTo(_o: AircraftMissionRequirements_IngestT): void {
...
export class AircraftMissionRequirements_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AircraftMissionRequirements_Ingest.createAircraftMissionRequirements_Ingest(builder,
    gdssReqId,
    this.onloadId,
    onloadLOCode,
    this.offloadId,
