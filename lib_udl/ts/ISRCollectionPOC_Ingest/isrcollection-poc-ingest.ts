 ...
 */
export class ISRCollectionPOC_Ingest implements flatbuffers.IUnpackableObject<ISRCollectionPOC_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ISRCollectionPOC_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsISRCollectionPOC_Ingest(bb:flatbuffers.ByteBuffer, obj?:ISRCollectionPOC_Ingest):ISRCollectionPOC_Ingest {
  return (obj || new ISRCollectionPOC_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsISRCollectionPOC_Ingest(bb:flatbuffers.ByteBuffer, obj?:ISRCollectionPOC_Ingest):ISRCollectionPOC_Ingest {
...
static startISRCollectionPOC_Ingest(builder:flatbuffers.Builder) {
...
static endISRCollectionPOC_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishISRCollectionPOC_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ISRC');
}

static finishSizePrefixedISRCollectionPOC_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ISRC', true);
}

static createISRCollectionPOC_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, callsignOffset:flatbuffers.Offset, unitOffset:flatbuffers.Offset, emailOffset:flatbuffers.Offset, phoneOffset:flatbuffers.Offset, radioFrequency:number, chatSystemOffset:flatbuffers.Offset, chatNameOffset:flatbuffers.Offset, notesOffset:flatbuffers.Offset):flatbuffers.Offset {
  ISRCollectionPOC_Ingest.startISRCollectionPOC_Ingest(builder);
...
unpack(): ISRCollectionPOC_IngestT {
  return new ISRCollectionPOC_IngestT(
    this.id(),
    this.name(),
    this.callsign(),
    this.unit(),
...
unpackTo(_o: ISRCollectionPOC_IngestT): void {
  _o.id = this.id();
  _o.name = this.name();
...
export class ISRCollectionPOC_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return ISRCollectionPOC_Ingest.createISRCollectionPOC_Ingest(builder,
    id,
    name,
    callsign,
    unit,
