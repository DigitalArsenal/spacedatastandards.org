...
import { TrackRoute_Abridged_dataMode_Enum } from './TrackRoute_Abridged_dataMode_Enum.js';


/**
 * /// A track route is a prescribed route for performing training events or operations such as air refueling.
 */
export class TrackRoute_Abridged implements flatbuffers.IUnpackableObject<TrackRoute_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):TrackRoute_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsTrackRoute_Abridged(bb:flatbuffers.ByteBuffer, obj?:TrackRoute_Abridged):TrackRoute_Abridged {
  return (obj || new TrackRoute_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTrackRoute_Abridged(bb:flatbuffers.ByteBuffer, obj?:TrackRoute_Abridged):TrackRoute_Abridged {
 ...
 */
dataMode():TrackRoute_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 78);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : TrackRoute_Abridged_dataMode_Enum.REAL;
}

static startTrackRoute_Abridged(builder:flatbuffers.Builder) {
...
unpack(): TrackRoute_AbridgedT {
  return new TrackRoute_AbridgedT(
    this.id(),
    ...
    this.effectiveDate(),
    this.bb!.createScalarList<string>(this.routePoints.bind(this), this.routePointsLength()),
    this.bb!.createScalarList<string>(this.altitudeBlocks.bind(this), this.altitudeBlocksLength()),
    this.bb!.createScalarList<string>(this.poc.bind(this), this.pocLength()),
    this.createdAt(),
    this.createdBy(),
    this.updatedAt(),
    this.updatedBy(),
...
unpackTo(_o: TrackRoute_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.routePoints = this.bb!.createScalarList<string>(this.routePoints.bind(this), this.routePointsLength());
  _o.altitudeBlocks = this.bb!.createScalarList<string>(this.altitudeBlocks.bind(this), this.altitudeBlocksLength());
  _o.poc = this.bb!.createScalarList<string>(this.poc.bind(this), this.pocLength());
...
export class TrackRoute_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: TrackRoute_Abridged_dataMode_Enum = TrackRoute_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const routePoints = TrackRoute_Abridged.createRoutePointsVector(builder, builder.createObjectOffsetList(this.routePoints));
  const altitudeBlocks = TrackRoute_Abridged.createAltitudeBlocksVector(builder, builder.createObjectOffsetList(this.altitudeBlocks));
  const poc = TrackRoute_Abridged.createPocVector(builder, builder.createObjectOffsetList(this.poc));
  ...
  return TrackRoute_Abridged.createTrackRoute_Abridged(builder,
    id,
