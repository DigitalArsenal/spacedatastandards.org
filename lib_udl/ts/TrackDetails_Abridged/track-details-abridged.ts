...
import { TrackDetails_Abridged_dataMode_Enum } from './track-details-abridged-data-mode-enum.js';
import { TrackDetails_Abridged_env_Enum } from './track-details-abridged-env-enum.js';
import { TrackDetails_Abridged_objIdent_Enum } from './track-details-abridged-obj-ident-enum.js';
 ...
 */
export class TrackDetails_Abridged implements flatbuffers.IUnpackableObject<TrackDetails_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):TrackDetails_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsTrackDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:TrackDetails_Abridged):TrackDetails_Abridged {
  return (obj || new TrackDetails_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTrackDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:TrackDetails_Abridged):TrackDetails_Abridged {
 ...
 */
env():TrackDetails_Abridged_env_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : TrackDetails_Abridged_env_Enum.AIR;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 32
 */
objIdent():TrackDetails_Abridged_objIdent_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 50);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : TrackDetails_Abridged_objIdent_Enum.ASSUMED_FRIEND;
}
 ...
 */
dataMode():TrackDetails_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 316);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : TrackDetails_Abridged_dataMode_Enum.REAL;
}
...
static startTrackDetails_Abridged(builder:flatbuffers.Builder) {
...
static addEnv(builder:flatbuffers.Builder, env:TrackDetails_Abridged_env_Enum) {
  builder.addFieldInt8(2, env, TrackDetails_Abridged_env_Enum.AIR);
}
...
static addObjIdent(builder:flatbuffers.Builder, objIdent:TrackDetails_Abridged_objIdent_Enum) {
  builder.addFieldInt8(23, objIdent, TrackDetails_Abridged_objIdent_Enum.ASSUMED_FRIEND);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:TrackDetails_Abridged_dataMode_Enum) {
  builder.addFieldInt8(156, dataMode, TrackDetails_Abridged_dataMode_Enum.REAL);
}
...
static endTrackDetails_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishTrackDetails_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TRAC');
}

static finishSizePrefixedTrackDetails_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TRAC', true);
}

static createTrackDetails_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, env:TrackDetails_Abridged_env_Enum, msgTypeOffset:flatbuffers.Offset, hullNumOffset:flatbuffers.Offset, pifOffset:flatbuffers.Offset, sconumOffset:flatbuffers.Offset, ntdsOffset:flatbuffers.Offset, disIdOffset:flatbuffers.Offset, midbCatOffset:flatbuffers.Offset, beNumberOffset:flatbuffers.Offset, oSuffixOffset:flatbuffers.Offset, pinOffset:flatbuffers.Offset, lostTrkInd:boolean, muidSrcTrkOffset:flatbuffers.Offset, muidSrcOffset:flatbuffers.Offset, mslStatusOffset:flatbuffers.Offset, trkConf:number, trkQual:number, alertOffset:flatbuffers.Offset, origXrefOffset:flatbuffers.Offset, elnot1Offset:flatbuffers.Offset, elnot2Offset:flatbuffers.Offset, objIdent:TrackDetails_Abridged_objIdent_Enum, objTypeOffset:flatbuffers.Offset, objPlatOffset:flatbuffers.Offset, objActOffset:flatbuffers.Offset, objNatOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, shortNameOffset:flatbuffers.Offset, trkIdOffset:flatbuffers.Offset, trkNumOffset:flatbuffers.Offset, trkScopeOffset:flatbuffers.Offset, sourceUidOffset:flatbuffers.Offset, callSignOffset:flatbuffers.Offset, identAmpOffset:flatbuffers.Offset, spaceAmpOffset:flatbuffers.Offset, spaceAmpConf:number, spaceSpecTypeOffset:flatbuffers.Offset, acftSubTypeOffset:flatbuffers.Offset, tsOffset:flatbuffers.Offset, launchTimeOffset:flatbuffers.Offset, impactTimeOffset:flatbuffers.Offset, ftnMsgTsOffset:flatbuffers.Offset, ftnOffset:flatbuffers.Offset, ftnCmdOffset:flatbuffers.Offset, rtnMsgTsOffset:flatbuffers.Offset, rtnOffset:flatbuffers.Offset, rtnTrkStateOffset:flatbuffers.Offset, rtnCmdOffset:flatbuffers.Offset, senOffset:flatbuffers.Offset, rptChxrefOffset:flatbuffers.Offset, rptArchived:boolean, selfReport:boolean, mil2525BstrOffset:flatbuffers.Offset, trnspdrIdOffset:flatbuffers.Offset, trnspdrTypeOffset:flatbuffers.Offset, emitterNameOffset:flatbuffers.Offset, infoSourceOffset:flatbuffers.Offset, boosting:boolean, freq:number, maxFreq:number, harmonicsOffset:flatbuffers.Offset, pri:number, prf:number, pw:number, scanTypeOffset:flatbuffers.Offset, scanRate:number, scn:number, cIOffset:flatbuffers.Offset, angElev:number, lat:number, lon:number, launchLat:number, launchLon:number, impactLat:number, impactLon:number, polarSingLocLat:number, polarSingLocLon:number, azCorrCenterLine:number, azCorrArcWidth:number, errSemiIntAxis:number, errAreaOrient:number, errSemiMajElev:number, errGeoAreaSwitchOffset:flatbuffers.Offset, burnoutAlt:number, tesEventIdOffset:flatbuffers.Offset, spd:number, avgSpd:number, tol:number, alt:number, hdng:number, course:number, propRpm:number, tpk:number, coopLocIndOffset:flatbuffers.Offset, maneuverIndOffset:flatbuffers.Offset, launchAouTypeOffset:flatbuffers.Offset, launchAouDataOffset:flatbuffers.Offset, impactAouTypeOffset:flatbuffers.Offset, impactAouDataOffset:flatbuffers.Offset, aouRptTypeOffset:flatbuffers.Offset, aouRptDataOffset:flatbuffers.Offset, ecefPosOffset:flatbuffers.Offset, ecefVelOffset:flatbuffers.Offset, containment:number, cpa:number, tcpaOffset:flatbuffers.Offset, navStatusOffset:flatbuffers.Offset, posDeviceTypeOffset:flatbuffers.Offset, atonOffset:flatbuffers.Offset, offPosIndOffset:flatbuffers.Offset, antennaRefDimensionsOffset:flatbuffers.Offset, shipClassOffset:flatbuffers.Offset, imon:number, mmsi:number, draught:number, length:number, width:number, cargoTypeOffset:flatbuffers.Offset, appGrpOffset:flatbuffers.Offset, hullProfOffset:flatbuffers.Offset, propTypeOffset:flatbuffers.Offset, numBlades:number, numShafts:number, sternTypeOffset:flatbuffers.Offset, vslWt:number, arrTimeOffset:flatbuffers.Offset, arrFlagOffset:flatbuffers.Offset, arrCargoOffset:flatbuffers.Offset, arrPortOffset:flatbuffers.Offset, depPortOffset:flatbuffers.Offset, depFlagOffset:flatbuffers.Offset, depCargoOffset:flatbuffers.Offset, desFlagOffset:flatbuffers.Offset, desCargoOffset:flatbuffers.Offset, destinationOffset:flatbuffers.Offset, etaOffset:flatbuffers.Offset, etdOffset:flatbuffers.Offset, iffOffset:flatbuffers.Offset, emgInd:boolean, dropPtInd:boolean, reinforced:boolean, reduced:boolean, hq:boolean, dummy:boolean, taskForce:boolean, feint:boolean, installation:boolean, staffCmtsOffset:flatbuffers.Offset, addInfoOffset:flatbuffers.Offset, evalRatingOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:TrackDetails_Abridged_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  TrackDetails_Abridged.startTrackDetails_Abridged(builder);
  TrackDetails_Abridged.addId(builder, idOffset);
  TrackDetails_Abridged.addClassificationMarking(builder, classificationMarkingOffset);
  TrackDetails_Abridged.addEnv(builder, env);
  TrackDetails_Abridged.addMsgType(builder, msgTypeOffset);
  TrackDetails_Abridged.addHullNum(builder, hullNumOffset);
  TrackDetails_Abridged.addPif(builder, pifOffset);
  TrackDetails_Abridged.addSconum(builder, sconumOffset);
  TrackDetails_Abridged.addNtds(builder, ntdsOffset);
  TrackDetails_Abridged.addDisId(builder, disIdOffset);
  TrackDetails_Abridged.addMidbCat(builder, midbCatOffset);
  TrackDetails_Abridged.addBeNumber(builder, beNumberOffset);
  TrackDetails_Abridged.addOSuffix(builder, oSuffixOffset);
  TrackDetails_Abridged.addPin(builder, pinOffset);
  TrackDetails_Abridged.addLostTrkInd(builder, lostTrkInd);
  TrackDetails_Abridged.addMuidSrcTrk(builder, muidSrcTrkOffset);
  TrackDetails_Abridged.addMuidSrc(builder, muidSrcOffset);
  TrackDetails_Abridged.addMslStatus(builder, mslStatusOffset);
  TrackDetails_Abridged.addTrkConf(builder, trkConf);
  TrackDetails_Abridged.addTrkQual(builder, trkQual);
  TrackDetails_Abridged.addAlert(builder, alertOffset);
  TrackDetails_Abridged.addOrigXref(builder, origXrefOffset);
  TrackDetails_Abridged.addElnot1(builder, elnot1Offset);
  TrackDetails_Abridged.addElnot2(builder, elnot2Offset);
  TrackDetails_Abridged.addObjIdent(builder, objIdent);
  TrackDetails_Abridged.addObjType(builder, objTypeOffset);
  TrackDetails_Abridged.addObjPlat(builder, objPlatOffset);
  TrackDetails_Abridged.addObjAct(builder, objActOffset);
  TrackDetails_Abridged.addObjNat(builder, objNatOffset);
  TrackDetails_Abridged.addName(builder, nameOffset);
  TrackDetails_Abridged.addShortName(builder, shortNameOffset);
  TrackDetails_Abridged.addTrkId(builder, trkIdOffset);
  TrackDetails_Abridged.addTrkNum(builder, trkNumOffset);
  TrackDetails_Abridged.addTrkScope(builder, trkScopeOffset);
  TrackDetails_Abridged.addSourceUid(builder, sourceUidOffset);
  TrackDetails_Abridged.addCallSign(builder, callSignOffset);
  TrackDetails_Abridged.addIdentAmp(builder, identAmpOffset);
  TrackDetails_Abridged.addSpaceAmp(builder, spaceAmpOffset);
  TrackDetails_Abridged.addSpaceAmpConf(builder, spaceAmpConf);
  TrackDetails_Abridged.addSpaceSpecType(builder, spaceSpecTypeOffset);
  TrackDetails_Abridged.addAcftSubType(builder, acftSubTypeOffset);
  TrackDetails_Abridged.addTs(builder, tsOffset);
  TrackDetails_Abridged.addLaunchTime(builder, launchTimeOffset);
  TrackDetails_Abridged.addImpactTime(builder, impactTimeOffset);
  TrackDetails_Abridged.addFtnMsgTs(builder, ftnMsgTsOffset);
  TrackDetails_Abridged.addFtn(builder, ftnOffset);
  TrackDetails_Abridged.addFtnCmd(builder, ftnCmdOffset);
  TrackDetails_Abridged.addRtnMsgTs(builder, rtnMsgTsOffset);
  TrackDetails_Abridged.addRtn(builder, rtnOffset);
  TrackDetails_Abridged.addRtnTrkState(builder, rtnTrkStateOffset);
  TrackDetails_Abridged.addRtnCmd(builder, rtnCmdOffset);
  TrackDetails_Abridged.addSen(builder, senOffset);
  TrackDetails_Abridged.addRptChxref(builder, rptChxrefOffset);
  TrackDetails_Abridged.addRptArchived(builder, rptArchived);
  TrackDetails_Abridged.addSelfReport(builder, selfReport);
  TrackDetails_Abridged.addMil2525Bstr(builder, mil2525BstrOffset);
  TrackDetails_Abridged.addTrnspdrId(builder, trnspdrIdOffset);
  TrackDetails_Abridged.addTrnspdrType(builder, trnspdrTypeOffset);
  TrackDetails_Abridged.addEmitterName(builder, emitterNameOffset);
  TrackDetails_Abridged.addInfoSource(builder, infoSourceOffset);
  TrackDetails_Abridged.addBoosting(builder, boosting);
  TrackDetails_Abridged.addFreq(builder, freq);
  TrackDetails_Abridged.addMaxFreq(builder, maxFreq);
  TrackDetails_Abridged.addHarmonics(builder, harmonicsOffset);
  TrackDetails_Abridged.addPri(builder, pri);
  TrackDetails_Abridged.addPrf(builder, prf);
  TrackDetails_Abridged.addPw(builder, pw);
  TrackDetails_Abridged.addScanType(builder, scanTypeOffset);
  TrackDetails_Abridged.addScanRate(builder, scanRate);
  TrackDetails_Abridged.addScn(builder, scn);
  TrackDetails_Abridged.addCI(builder, cIOffset);
  TrackDetails_Abridged.addAngElev(builder, angElev);
  TrackDetails_Abridged.addLat(builder, lat);
  TrackDetails_Abridged.addLon(builder, lon);
  TrackDetails_Abridged.addLaunchLat(builder, launchLat);
  TrackDetails_Abridged.addLaunchLon(builder, launchLon);
  TrackDetails_Abridged.addImpactLat(builder, impactLat);
  TrackDetails_Abridged.addImpactLon(builder, impactLon);
  TrackDetails_Abridged.addPolarSingLocLat(builder, polarSingLocLat);
  TrackDetails_Abridged.addPolarSingLocLon(builder, polarSingLocLon);
  TrackDetails_Abridged.addAzCorrCenterLine(builder, azCorrCenterLine);
  TrackDetails_Abridged.addAzCorrArcWidth(builder, azCorrArcWidth);
  TrackDetails_Abridged.addErrSemiIntAxis(builder, errSemiIntAxis);
  TrackDetails_Abridged.addErrAreaOrient(builder, errAreaOrient);
  TrackDetails_Abridged.addErrSemiMajElev(builder, errSemiMajElev);
  TrackDetails_Abridged.addErrGeoAreaSwitch(builder, errGeoAreaSwitchOffset);
  TrackDetails_Abridged.addBurnoutAlt(builder, burnoutAlt);
  TrackDetails_Abridged.addTesEventId(builder, tesEventIdOffset);
  TrackDetails_Abridged.addSpd(builder, spd);
  TrackDetails_Abridged.addAvgSpd(builder, avgSpd);
  TrackDetails_Abridged.addTol(builder, tol);
  TrackDetails_Abridged.addAlt(builder, alt);
  TrackDetails_Abridged.addHdng(builder, hdng);
  TrackDetails_Abridged.addCourse(builder, course);
  TrackDetails_Abridged.addPropRpm(builder, propRpm);
  TrackDetails_Abridged.addTpk(builder, tpk);
  TrackDetails_Abridged.addCoopLocInd(builder, coopLocIndOffset);
  TrackDetails_Abridged.addManeuverInd(builder, maneuverIndOffset);
  TrackDetails_Abridged.addLaunchAouType(builder, launchAouTypeOffset);
  TrackDetails_Abridged.addLaunchAouData(builder, launchAouDataOffset);
  TrackDetails_Abridged.addImpactAouType(builder, impactAouTypeOffset);
  TrackDetails_Abridged.addImpactAouData(builder, impactAouDataOffset);
  TrackDetails_Abridged.addAouRptType(builder, aouRptTypeOffset);
  TrackDetails_Abridged.addAouRptData(builder, aouRptDataOffset);
  TrackDetails_Abridged.addEcefPos(builder, ecefPosOffset);
  TrackDetails_Abridged.addEcefVel(builder, ecefVelOffset);
  TrackDetails_Abridged.addContainment(builder, containment);
  TrackDetails_Abridged.addCpa(builder, cpa);
  TrackDetails_Abridged.addTcpa(builder, tcpaOffset);
  TrackDetails_Abridged.addNavStatus(builder, navStatusOffset);
  TrackDetails_Abridged.addPosDeviceType(builder, posDeviceTypeOffset);
  TrackDetails_Abridged.addAton(builder, atonOffset);
  TrackDetails_Abridged.addOffPosInd(builder, offPosIndOffset);
  TrackDetails_Abridged.addAntennaRefDimensions(builder, antennaRefDimensionsOffset);
  TrackDetails_Abridged.addShipClass(builder, shipClassOffset);
  TrackDetails_Abridged.addImon(builder, imon);
  TrackDetails_Abridged.addMmsi(builder, mmsi);
  TrackDetails_Abridged.addDraught(builder, draught);
  TrackDetails_Abridged.addLength(builder, length);
  TrackDetails_Abridged.addWidth(builder, width);
  TrackDetails_Abridged.addCargoType(builder, cargoTypeOffset);
  TrackDetails_Abridged.addAppGrp(builder, appGrpOffset);
  TrackDetails_Abridged.addHullProf(builder, hullProfOffset);
  TrackDetails_Abridged.addPropType(builder, propTypeOffset);
  TrackDetails_Abridged.addNumBlades(builder, numBlades);
  TrackDetails_Abridged.addNumShafts(builder, numShafts);
  TrackDetails_Abridged.addSternType(builder, sternTypeOffset);
  TrackDetails_Abridged.addVslWt(builder, vslWt);
  TrackDetails_Abridged.addArrTime(builder, arrTimeOffset);
  TrackDetails_Abridged.addArrFlag(builder, arrFlagOffset);
  TrackDetails_Abridged.addArrCargo(builder, arrCargoOffset);
  TrackDetails_Abridged.addArrPort(builder, arrPortOffset);
  TrackDetails_Abridged.addDepPort(builder, depPortOffset);
  TrackDetails_Abridged.addDepFlag(builder, depFlagOffset);
  TrackDetails_Abridged.addDepCargo(builder, depCargoOffset);
  TrackDetails_Abridged.addDesFlag(builder, desFlagOffset);
  TrackDetails_Abridged.addDesCargo(builder, desCargoOffset);
  TrackDetails_Abridged.addDestination(builder, destinationOffset);
  TrackDetails_Abridged.addEta(builder, etaOffset);
  TrackDetails_Abridged.addEtd(builder, etdOffset);
  TrackDetails_Abridged.addIff(builder, iffOffset);
  TrackDetails_Abridged.addEmgInd(builder, emgInd);
  TrackDetails_Abridged.addDropPtInd(builder, dropPtInd);
  TrackDetails_Abridged.addReinforced(builder, reinforced);
  TrackDetails_Abridged.addReduced(builder, reduced);
  TrackDetails_Abridged.addHq(builder, hq);
  TrackDetails_Abridged.addDummy(builder, dummy);
  TrackDetails_Abridged.addTaskForce(builder, taskForce);
  TrackDetails_Abridged.addFeint(builder, feint);
  TrackDetails_Abridged.addInstallation(builder, installation);
  TrackDetails_Abridged.addStaffCmts(builder, staffCmtsOffset);
  TrackDetails_Abridged.addAddInfo(builder, addInfoOffset);
  TrackDetails_Abridged.addEvalRating(builder, evalRatingOffset);
  TrackDetails_Abridged.addCreatedAt(builder, createdAtOffset);
  TrackDetails_Abridged.addCreatedBy(builder, createdByOffset);
  TrackDetails_Abridged.addSource(builder, sourceOffset);
  TrackDetails_Abridged.addOrigin(builder, originOffset);
  TrackDetails_Abridged.addDataMode(builder, dataMode);
  TrackDetails_Abridged.addOrigNetwork(builder, origNetworkOffset);
  return TrackDetails_Abridged.endTrackDetails_Abridged(builder);
}

unpack(): TrackDetails_AbridgedT {
  return new TrackDetails_AbridgedT(
    this.id(),
    ...
    this.ftn(),
    this.ftnCmd(),
    this.bb!.createScalarList<string>(this.rtnMsgTs.bind(this), this.rtnMsgTs_Length()),
    this.bb!.createScalarList<string>(this.rtn.bind(this), this.rtn_Length()),
    this.rtnTrkState(),
    this.rtnCmd(),
    this.sen(),
    this.rptChxref(),
    ...
    this.maneuverInd(),
    this.launchAouType(),
    this.bb!.createScalarList<string>(this.launchAouData.bind(this), this.launchAouData_Length()),
    this.impactAouType(),
    this.bb!.createScalarList<string>(this.impactAouData.bind(this), this.impactAouData_Length()),
    this.aouRptType(),
    this.bb!.createScalarList<string>(this.aouRptData.bind(this), this.aouRptData_Length()),
    ...
    this.aton(),
    this.offPosInd(),
    this.bb!.createScalarList<string>(this.antennaRefDimensions.bind(this), this.antennaRefDimensions_Length()),
    this.shipClass(),
    this.imon(),
    this.mmsi(),
    this.draught(),
...
unpackTo(_o: TrackDetails_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.rtnMsgTs = this.bb!.createScalarList<string>(this.rtnMsgTs.bind(this), this.rtnMsgTs_Length());
  _o.rtn = this.bb!.createScalarList<string>(this.rtn.bind(this), this.rtn_Length());
  ...
  _o.launchAouData = this.bb!.createScalarList<string>(this.launchAouData.bind(this), this.launchAouData_Length());
  _o.impactAouType = this.impactAouType();
  _o.impactAouData = this.bb!.createScalarList<string>(this.impactAouData.bind(this), this.impactAouData_Length());
  _o.aouRptType = this.aouRptType();
  _o.aouRptData = this.bb!.createScalarList<string>(this.aouRptData.bind(this), this.aouRptData_Length());
  ...
  _o.antennaRefDimensions = this.bb!.createScalarList<string>(this.antennaRefDimensions.bind(this), this.antennaRefDimensions_Length());
...
export class TrackDetails_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  public id: string|Uint8Array|null = null,
  public classificationMarking: string|Uint8Array|null = null,
  public env: TrackDetails_Abridged_env_Enum = TrackDetails_Abridged_env_Enum.AIR,
  ...
  public objIdent: TrackDetails_Abridged_objIdent_Enum = TrackDetails_Abridged_objIdent_Enum.ASSUMED_FRIEND,
  ...
  public dataMode: TrackDetails_Abridged_dataMode_Enum = TrackDetails_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const rtnMsgTs = TrackDetails_Abridged.createRtnMsgTsVector(builder, builder.createObjectOffsetList(this.rtnMsgTs));
  const rtn = TrackDetails_Abridged.createRtnVector(builder, builder.createObjectOffsetList(this.rtn));
  ...
  const launchAouData = TrackDetails_Abridged.createLaunchAouDataVector(builder, builder.createObjectOffsetList(this.launchAouData));
  const impactAouType = (this.impactAouType !== null ? builder.createString(this.impactAouType!) : 0);
  const impactAouData = TrackDetails_Abridged.createImpactAouDataVector(builder, builder.createObjectOffsetList(this.impactAouData));
  const aouRptType = (this.aouRptType !== null ? builder.createString(this.aouRptType!) : 0);
  const aouRptData = TrackDetails_Abridged.createAouRptDataVector(builder, builder.createObjectOffsetList(this.aouRptData));
  const ecefPos = TrackDetails_Abridged.createEcefPosVector(builder, builder.createObjectOffsetList(this.ecefPos));
  const ecefVel = TrackDetails_Abridged.createEcefVelVector(builder, builder.createObjectOffsetList(this.ecefVel));
  ...
  const antennaRefDimensions = TrackDetails_Abridged.createAntennaRefDimensionsVector(builder, builder.createObjectOffsetList(this.antennaRefDimensions));
  ...
  return TrackDetails_Abridged.createTrackDetails_Abridged(builder,
    id,
