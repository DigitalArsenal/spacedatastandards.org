...
import { AirLoadPlan_Ingest_dataMode_Enum } from './air-load-plan-ingest-data-mode-enum.js';


/**
 * /// Information related to how an aircraft is loaded with cargo, equipment, and passengers.
 */
export class AirLoadPlan_Ingest implements flatbuffers.IUnpackableObject<AirLoadPlan_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirLoadPlan_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirLoadPlan_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirLoadPlan_Ingest):AirLoadPlan_Ingest {
  return (obj || new AirLoadPlan_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirLoadPlan_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirLoadPlan_Ingest):AirLoadPlan_Ingest {
...
dataMode():AirLoadPlan_Ingest_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirLoadPlan_Ingest_dataMode_Enum.REAL;
}

static startAirLoadPlan_Ingest(builder:flatbuffers.Builder) {
...
unpack(): AirLoadPlan_IngestT {
  return new AirLoadPlan_IngestT(
    this.id(),
...
unpackTo(_o: AirLoadPlan_IngestT): void {
  _o.id = this.id();
...
export class AirLoadPlan_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AirLoadPlan_Ingest_dataMode_Enum = AirLoadPlan_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AirLoadPlan_Ingest.createAirLoadPlan_Ingest(builder,
    id,
