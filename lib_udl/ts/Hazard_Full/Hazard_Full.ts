...
import { Hazard_Full_dataMode_Enum } from './Hazard_Full_dataMode_Enum.js';
 ...
 */
export class Hazard_Full implements flatbuffers.IUnpackableObject<Hazard_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Hazard_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsHazard_Full(bb:flatbuffers.ByteBuffer, obj?:Hazard_Full):Hazard_Full {
  return (obj || new Hazard_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsHazard_Full(bb:flatbuffers.ByteBuffer, obj?:Hazard_Full):Hazard_Full {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Hazard_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 82);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Hazard_Full_dataMode_Enum.REAL;
}

static startHazard_Full(builder:flatbuffers.Builder) {
...
export class Hazard_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Hazard_Full_dataMode_Enum = Hazard_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const alarms = Hazard_Full.createAlarmsVector(builder, builder.createObjectOffsetList(this.alarms));
  const alarmValues = Hazard_Full.createAlarmValuesVector(builder, builder.createObjectOffsetList(this.alarmValues));
  const readings = Hazard_Full.createReadingsVector(builder, builder.createObjectOffsetList(this.readings));
  const readingUnits = Hazard_Full.createReadingUnitsVector(builder, builder.createObjectOffsetList(this.readingUnits));
  const readingValues = Hazard_Full.createReadingValuesVector(builder, builder.createObjectOffsetList(this.readingValues));
  ...
  return Hazard_Full.createHazard_Full(builder,
    id,
