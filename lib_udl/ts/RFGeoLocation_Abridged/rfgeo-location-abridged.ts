...
import { RFGeoLocation_Abridged_dataMode_Enum } from './rfgeo-location-abridged-data-mode-enum.js';


/**
 * /// Model representation of geolocation data for a radio frequency (RF) signal or emitter.
 */
export class RFGeoLocation_Abridged implements flatbuffers.IUnpackableObject<RFGeoLocation_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):RFGeoLocation_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsRFGeoLocation_Abridged(bb:flatbuffers.ByteBuffer, obj?:RFGeoLocation_Abridged):RFGeoLocation_Abridged {
  return (obj || new RFGeoLocation_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRFGeoLocation_Abridged(bb:flatbuffers.ByteBuffer, obj?:RFGeoLocation_Abridged):RFGeoLocation_Abridged {
 ...
 */
dataMode():RFGeoLocation_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 84);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFGeoLocation_Abridged_dataMode_Enum.REAL;
}

static startRFGeoLocation_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:RFGeoLocation_Abridged_dataMode_Enum) {
  builder.addFieldInt8(40, dataMode, RFGeoLocation_Abridged_dataMode_Enum.REAL);
}

static endRFGeoLocation_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishRFGeoLocation_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'RFGE');
}

static finishSizePrefixedRFGeoLocation_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'RFGE', true);
}

static createRFGeoLocation_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, orderIdOffset:flatbuffers.Offset, createdTsOffset:flatbuffers.Offset, receivedTsOffset:flatbuffers.Offset, startTimeOffset:flatbuffers.Offset, endTimeOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, satNo:number, origObjectIdOffset:flatbuffers.Offset, constellationOffset:flatbuffers.Offset, signalOfInterestOffset:flatbuffers.Offset, idRfemitterOffset:flatbuffers.Offset, origRfemitterIdOffset:flatbuffers.Offset, numBursts:number, minFreq:number, maxFreq:number, centerFreq:number, detectLat:number, detectLon:number, detectAlt:number, confSemiMajor:number, confSemiMinor:number, confOrientation:number, confArea:number, atypeOffset:flatbuffers.Offset, agjsonOffset:flatbuffers.Offset, atextOffset:flatbuffers.Offset, andims:number, asrid:number, passGroupIdOffset:flatbuffers.Offset, algVersionOffset:flatbuffers.Offset, externalIdOffset:flatbuffers.Offset, tagsOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, dataMode:RFGeoLocation_Abridged_dataMode_Enum):flatbuffers.Offset {
  RFGeoLocation_Abridged.startRFGeoLocation_Abridged(builder);
...
unpack(): RFGeoLocation_AbridgedT {
  return new RFGeoLocation_AbridgedT(
    this.id(),
...
unpackTo(_o: RFGeoLocation_AbridgedT): void {
  _o.id = this.id();
...
export class RFGeoLocation_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: RFGeoLocation_Abridged_dataMode_Enum = RFGeoLocation_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = RFGeoLocation_Abridged.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return RFGeoLocation_Abridged.createRFGeoLocation_Abridged(builder,
    id,
