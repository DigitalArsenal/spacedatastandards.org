...
import { IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum } from './iono-observation-abridged-antenna-element-position-coordinate-system-enum.js';
import { IonoObservation_Abridged_dataMode_Enum } from './iono-observation-abridged-data-mode-enum.js';
import { IonoObservation_Abridged_receiveSensorType_Enum } from './iono-observation-abridged-receive-sensor-type-enum.js';
import { IonoObservation_Abridged_transmitSensorType_Enum } from './iono-observation-abridged-transmit-sensor-type-enum.js';
 ...
 */
export class IonoObservation_Abridged implements flatbuffers.IUnpackableObject<IonoObservation_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):IonoObservation_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsIonoObservation_Abridged(bb:flatbuffers.ByteBuffer, obj?:IonoObservation_Abridged):IonoObservation_Abridged {
  return (obj || new IonoObservation_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIonoObservation_Abridged(bb:flatbuffers.ByteBuffer, obj?:IonoObservation_Abridged):IonoObservation_Abridged {
 ...
 */
transmitSensorType():IonoObservation_Abridged_transmitSensorType_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 32);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : IonoObservation_Abridged_transmitSensorType_Enum.MOBILE;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 16
 */
receiveSensorType():IonoObservation_Abridged_receiveSensorType_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 36);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : IonoObservation_Abridged_receiveSensorType_Enum.MOBILE;
}
 ...
 */
antennaElementPositionCoordinateSystem():IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 40);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum.J2000;
}
 ...
 */
dataMode():IonoObservation_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 216);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : IonoObservation_Abridged_dataMode_Enum.REAL;
}
...
static startIonoObservation_Abridged(builder:flatbuffers.Builder) {
...
static addTransmitSensorType(builder:flatbuffers.Builder, transmitSensorType:IonoObservation_Abridged_transmitSensorType_Enum) {
  builder.addFieldInt8(14, transmitSensorType, IonoObservation_Abridged_transmitSensorType_Enum.MOBILE);
}
...
static addReceiveSensorType(builder:flatbuffers.Builder, receiveSensorType:IonoObservation_Abridged_receiveSensorType_Enum) {
  builder.addFieldInt8(16, receiveSensorType, IonoObservation_Abridged_receiveSensorType_Enum.MOBILE);
}
...
static addAntennaElementPositionCoordinateSystem(builder:flatbuffers.Builder, antennaElementPositionCoordinateSystem:IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum) {
  builder.addFieldInt8(18, antennaElementPositionCoordinateSystem, IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum.J2000);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:IonoObservation_Abridged_dataMode_Enum) {
  builder.addFieldInt8(106, dataMode, IonoObservation_Abridged_dataMode_Enum.REAL);
}
...
unpack(): IonoObservation_AbridgedT {
  return new IonoObservation_AbridgedT(
    this.id(),
    ...
    this.systemInfo(),
    this.systemNotes(),
    this.bb!.createScalarList<string>(this.transmitCoordinates.bind(this), this.transmitCoordinates_Length()),
    this.transmitSensorType(),
    this.bb!.createScalarList<string>(this.receiveCoordinates.bind(this), this.receiveCoordinates_Length()),
    ...
    this.azimuth(),
    this.elevation(),
    this.bb!.createScalarList<string>(this.restrictedFrequency.bind(this), this.restrictedFrequency_Length()),
    ...
    this.fbEs(),
    this.typeEs(),
    this.bb!.createScalarList<string>(this.charAtts.bind(this), this.charAtts_Length()),
    this.bb!.createScalarList<string>(this.height.bind(this), this.height_Length()),
    this.bb!.createScalarList<string>(this.plasmaFrequency.bind(this), this.plasmaFrequency_Length()),
    this.bb!.createScalarList<string>(this.plasmaFrequencyUncertainty.bind(this), this.plasmaFrequencyUncertainty_Length()),
    this.bb!.createScalarList<string>(this.electronDensity.bind(this), this.electronDensity_Length()),
    this.bb!.createScalarList<string>(this.electronDensityUncertainty.bind(this), this.electronDensityUncertainty_Length()),
    this.bb!.createScalarList<string>(this.artistFlags.bind(this), this.artistFlags_Length()),
    this.traceGeneric(),
    this.bb!.createScalarList<string>(this.tidPhaseSpeeds.bind(this), this.tidPhaseSpeeds_Length()),
    this.bb!.createScalarList<string>(this.tidAzimuth.bind(this), this.tidAzimuth_Length()),
    this.bb!.createScalarList<string>(this.tidPeriods.bind(this), this.tidPeriods_Length()),
    this.datum(),
    this.platformName(),
    this.createdAt(),
    this.createdBy(),
...
unpackTo(_o: IonoObservation_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.transmitCoordinates = this.bb!.createScalarList<string>(this.transmitCoordinates.bind(this), this.transmitCoordinates_Length());
  _o.transmitSensorType = this.transmitSensorType();
  _o.receiveCoordinates = this.bb!.createScalarList<string>(this.receiveCoordinates.bind(this), this.receiveCoordinates_Length());
  ...
  _o.restrictedFrequency = this.bb!.createScalarList<string>(this.restrictedFrequency.bind(this), this.restrictedFrequency_Length());
  ...
  _o.charAtts = this.bb!.createScalarList<string>(this.charAtts.bind(this), this.charAtts_Length());
  _o.height = this.bb!.createScalarList<string>(this.height.bind(this), this.height_Length());
  _o.plasmaFrequency = this.bb!.createScalarList<string>(this.plasmaFrequency.bind(this), this.plasmaFrequency_Length());
  _o.plasmaFrequencyUncertainty = this.bb!.createScalarList<string>(this.plasmaFrequencyUncertainty.bind(this), this.plasmaFrequencyUncertainty_Length());
  _o.electronDensity = this.bb!.createScalarList<string>(this.electronDensity.bind(this), this.electronDensity_Length());
  _o.electronDensityUncertainty = this.bb!.createScalarList<string>(this.electronDensityUncertainty.bind(this), this.electronDensityUncertainty_Length());
  _o.artistFlags = this.bb!.createScalarList<string>(this.artistFlags.bind(this), this.artistFlags_Length());
  _o.traceGeneric = this.traceGeneric();
  _o.tidPhaseSpeeds = this.bb!.createScalarList<string>(this.tidPhaseSpeeds.bind(this), this.tidPhaseSpeeds_Length());
  _o.tidAzimuth = this.bb!.createScalarList<string>(this.tidAzimuth.bind(this), this.tidAzimuth_Length());
  _o.tidPeriods = this.bb!.createScalarList<string>(this.tidPeriods.bind(this), this.tidPeriods_Length());
  _o.datum = this.datum();
...
export class IonoObservation_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public transmitSensorType: IonoObservation_Abridged_transmitSensorType_Enum = IonoObservation_Abridged_transmitSensorType_Enum.MOBILE,
  public receiveCoordinates: (string)[] = [],
  public receiveSensorType: IonoObservation_Abridged_receiveSensorType_Enum = IonoObservation_Abridged_receiveSensorType_Enum.MOBILE,
  public antennaElementPosition: string|Uint8Array|null = null,
  public antennaElementPositionCoordinateSystem: IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum = IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum.J2000,
  ...
  public dataMode: IonoObservation_Abridged_dataMode_Enum = IonoObservation_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const transmitCoordinates = IonoObservation_Abridged.createTransmitCoordinatesVector(builder, builder.createObjectOffsetList(this.transmitCoordinates));
  const receiveCoordinates = IonoObservation_Abridged.createReceiveCoordinatesVector(builder, builder.createObjectOffsetList(this.receiveCoordinates));
  ...
  const restrictedFrequency = IonoObservation_Abridged.createRestrictedFrequencyVector(builder, builder.createObjectOffsetList(this.restrictedFrequency));
  ...
  const charAtts = IonoObservation_Abridged.createCharAttsVector(builder, builder.createObjectOffsetList(this.charAtts));
  const height = IonoObservation_Abridged.createHeightVector(builder, builder.createObjectOffsetList(this.height));
  const plasmaFrequency = IonoObservation_Abridged.createPlasmaFrequencyVector(builder, builder.createObjectOffsetList(this.plasmaFrequency));
  const plasmaFrequencyUncertainty = IonoObservation_Abridged.createPlasmaFrequencyUncertaintyVector(builder, builder.createObjectOffsetList(this.plasmaFrequencyUncertainty));
  const electronDensity = IonoObservation_Abridged.createElectronDensityVector(builder, builder.createObjectOffsetList(this.electronDensity));
  const electronDensityUncertainty = IonoObservation_Abridged.createElectronDensityUncertaintyVector(builder, builder.createObjectOffsetList(this.electronDensityUncertainty));
  const artistFlags = IonoObservation_Abridged.createArtistFlagsVector(builder, builder.createObjectOffsetList(this.artistFlags));
  const traceGeneric = (this.traceGeneric !== null ? builder.createString(this.traceGeneric!) : 0);
  const tidPhaseSpeeds = IonoObservation_Abridged.createTidPhaseSpeedsVector(builder, builder.createObjectOffsetList(this.tidPhaseSpeeds));
  const tidAzimuth = IonoObservation_Abridged.createTidAzimuthVector(builder, builder.createObjectOffsetList(this.tidAzimuth));
  const tidPeriods = IonoObservation_Abridged.createTidPeriodsVector(builder, builder.createObjectOffsetList(this.tidPeriods));
  ...
  return IonoObservation_Abridged.createIonoObservation_Abridged(builder,
    id,
