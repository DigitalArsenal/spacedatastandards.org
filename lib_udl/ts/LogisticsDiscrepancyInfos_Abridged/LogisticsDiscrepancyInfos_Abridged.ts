 ...
 */
export class LogisticsDiscrepancyInfos_Abridged implements flatbuffers.IUnpackableObject<LogisticsDiscrepancyInfos_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LogisticsDiscrepancyInfos_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLogisticsDiscrepancyInfos_Abridged(bb:flatbuffers.ByteBuffer, obj?:LogisticsDiscrepancyInfos_Abridged):LogisticsDiscrepancyInfos_Abridged {
  return (obj || new LogisticsDiscrepancyInfos_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLogisticsDiscrepancyInfos_Abridged(bb:flatbuffers.ByteBuffer, obj?:LogisticsDiscrepancyInfos_Abridged):LogisticsDiscrepancyInfos_Abridged {
...
static startLogisticsDiscrepancyInfos_Abridged(builder:flatbuffers.Builder) {
...
static endLogisticsDiscrepancyInfos_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishLogisticsDiscrepancyInfos_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'LOGI');
}

static finishSizePrefixedLogisticsDiscrepancyInfos_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'LOGI', true);
}

static createLogisticsDiscrepancyInfos_Abridged(builder:flatbuffers.Builder, jcnOffset:flatbuffers.Offset, discrepancyInfoOffset:flatbuffers.Offset, jobStTimeOffset:flatbuffers.Offset, closureTimeOffset:flatbuffers.Offset):flatbuffers.Offset {
  LogisticsDiscrepancyInfos_Abridged.startLogisticsDiscrepancyInfos_Abridged(builder);
...
unpack(): LogisticsDiscrepancyInfos_AbridgedT {
  return new LogisticsDiscrepancyInfos_AbridgedT(
    this.jcn(),
...
unpackTo(_o: LogisticsDiscrepancyInfos_AbridgedT): void {
  _o.jcn = this.jcn();
...
export class LogisticsDiscrepancyInfos_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return LogisticsDiscrepancyInfos_Abridged.createLogisticsDiscrepancyInfos_Abridged(builder,
    jcn,
    discrepancyInfo,
    jobStTime,
    closureTime
