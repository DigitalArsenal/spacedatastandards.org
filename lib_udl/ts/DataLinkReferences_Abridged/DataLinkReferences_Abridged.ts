 ...
 */
export class DataLinkReferences_Abridged implements flatbuffers.IUnpackableObject<DataLinkReferences_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):DataLinkReferences_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsDataLinkReferences_Abridged(bb:flatbuffers.ByteBuffer, obj?:DataLinkReferences_Abridged):DataLinkReferences_Abridged {
  return (obj || new DataLinkReferences_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsDataLinkReferences_Abridged(bb:flatbuffers.ByteBuffer, obj?:DataLinkReferences_Abridged):DataLinkReferences_Abridged {
...
static startDataLinkReferences_Abridged(builder:flatbuffers.Builder) {
...
static endDataLinkReferences_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishDataLinkReferences_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DATA');
}

static finishSizePrefixedDataLinkReferences_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DATA', true);
}

static createDataLinkReferences_Abridged(builder:flatbuffers.Builder, refSerialIdOffset:flatbuffers.Offset, refTypeOffset:flatbuffers.Offset, refOriginatorOffset:flatbuffers.Offset, refTsOffset:flatbuffers.Offset, refSerialNumOffset:flatbuffers.Offset, refSpecialNotationOffset:flatbuffers.Offset, refSicsOffset:flatbuffers.Offset):flatbuffers.Offset {
  DataLinkReferences_Abridged.startDataLinkReferences_Abridged(builder);
...
unpack(): DataLinkReferences_AbridgedT {
  return new DataLinkReferences_AbridgedT(
    this.refSerialId(),
    this.refType(),
    this.refOriginator(),
    this.refTs(),
...
unpackTo(_o: DataLinkReferences_AbridgedT): void {
...
export class DataLinkReferences_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const refSics = DataLinkReferences_Abridged.createRefSicsVector(builder, builder.createObjectOffsetList(this.refSics));

  return DataLinkReferences_Abridged.createDataLinkReferences_Abridged(builder,
    refSerialId,
    refType,
    refOriginator,
    refTs,
