...
import { ManifoldElset_Ingest_dataMode_Enum } from './manifold-elset-ingest-data-mode-enum.js';
 ...
 */
export class ManifoldElset_Ingest implements flatbuffers.IUnpackableObject<ManifoldElset_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ManifoldElset_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsManifoldElset_Ingest(bb:flatbuffers.ByteBuffer, obj?:ManifoldElset_Ingest):ManifoldElset_Ingest {
  return (obj || new ManifoldElset_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsManifoldElset_Ingest(bb:flatbuffers.ByteBuffer, obj?:ManifoldElset_Ingest):ManifoldElset_Ingest {
 ...
 */
dataMode():ManifoldElset_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 54);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : ManifoldElset_Ingest_dataMode_Enum.REAL;
}
...
static startManifoldElset_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:ManifoldElset_Ingest_dataMode_Enum) {
  builder.addFieldInt8(25, dataMode, ManifoldElset_Ingest_dataMode_Enum.REAL);
}
...
unpack(): ManifoldElset_IngestT {
  return new ManifoldElset_IngestT(
    this.id(),
    this.idManifold(),
...
unpackTo(_o: ManifoldElset_IngestT): void {
  _o.id = this.id();
...
export class ManifoldElset_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: ManifoldElset_Ingest_dataMode_Enum = ManifoldElset_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return ManifoldElset_Ingest.createManifoldElset_Ingest(builder,
    id,
    idManifold,
