...
import { WeatherData_Abridged_dataMode_Enum } from './weather-data-abridged-data-mode-enum.js';
 ...
 */
export class WeatherData_Abridged implements flatbuffers.IUnpackableObject<WeatherData_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):WeatherData_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsWeatherData_Abridged(bb:flatbuffers.ByteBuffer, obj?:WeatherData_Abridged):WeatherData_Abridged {
  return (obj || new WeatherData_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsWeatherData_Abridged(bb:flatbuffers.ByteBuffer, obj?:WeatherData_Abridged):WeatherData_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():WeatherData_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 80);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : WeatherData_Abridged_dataMode_Enum.REAL;
}

static startWeatherData_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:WeatherData_Abridged_dataMode_Enum) {
  builder.addFieldInt8(38, dataMode, WeatherData_Abridged_dataMode_Enum.REAL);
}

static endWeatherData_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishWeatherData_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'WEAT');
}

static finishSizePrefixedWeatherData_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'WEAT', true);
}

static createWeatherData_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, origSensorIdOffset:flatbuffers.Offset, obTimeOffset:flatbuffers.Offset, sigPwrsOffset:flatbuffers.Offset, noiseLvlsOffset:flatbuffers.Offset, specWidthsOffset:flatbuffers.Offset, firstGuessAvgsOffset:flatbuffers.Offset, qcValue:number, fileCreationOffset:flatbuffers.Offset, termAlt:number, avgTxPwr:number, avgRefPwr:number, sectorNum:number, numElements:number, tdAvgSampleNumsOffset:flatbuffers.Offset, checksum:number, coIntegsOffset:flatbuffers.Offset, specAvgsOffset:flatbuffers.Offset, interpulsePeriodsOffset:flatbuffers.Offset, doppVelsOffset:flatbuffers.Offset, consRecsOffset:flatbuffers.Offset, snrsOffset:flatbuffers.Offset, sigStrength:number, semiMajorAxis:number, semiMinorAxis:number, angleOrientation:number, lightEventNum:number, lightDetSensorsOffset:flatbuffers.Offset, posConfidence:number, srcTypsOffset:flatbuffers.Offset, srcIdsOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:WeatherData_Abridged_dataMode_Enum):flatbuffers.Offset {
  WeatherData_Abridged.startWeatherData_Abridged(builder);
  WeatherData_Abridged.addId(builder, idOffset);
  WeatherData_Abridged.addClassificationMarking(builder, classificationMarkingOffset);
  WeatherData_Abridged.addIdSensor(builder, idSensorOffset);
  WeatherData_Abridged.addOrigSensorId(builder, origSensorIdOffset);
  WeatherData_Abridged.addObTime(builder, obTimeOffset);
  WeatherData_Abridged.addSigPwrs(builder, sigPwrsOffset);
  WeatherData_Abridged.addNoiseLvls(builder, noiseLvlsOffset);
  WeatherData_Abridged.addSpecWidths(builder, specWidthsOffset);
  WeatherData_Abridged.addFirstGuessAvgs(builder, firstGuessAvgsOffset);
  WeatherData_Abridged.addQcValue(builder, qcValue);
  WeatherData_Abridged.addFileCreation(builder, fileCreationOffset);
  WeatherData_Abridged.addTermAlt(builder, termAlt);
  WeatherData_Abridged.addAvgTxPwr(builder, avgTxPwr);
  WeatherData_Abridged.addAvgRefPwr(builder, avgRefPwr);
  WeatherData_Abridged.addSectorNum(builder, sectorNum);
  WeatherData_Abridged.addNumElements(builder, numElements);
  WeatherData_Abridged.addTdAvgSampleNums(builder, tdAvgSampleNumsOffset);
  WeatherData_Abridged.addChecksum(builder, checksum);
  WeatherData_Abridged.addCoIntegs(builder, coIntegsOffset);
  WeatherData_Abridged.addSpecAvgs(builder, specAvgsOffset);
  WeatherData_Abridged.addInterpulsePeriods(builder, interpulsePeriodsOffset);
  WeatherData_Abridged.addDoppVels(builder, doppVelsOffset);
  WeatherData_Abridged.addConsRecs(builder, consRecsOffset);
  WeatherData_Abridged.addSnrs(builder, snrsOffset);
  WeatherData_Abridged.addSigStrength(builder, sigStrength);
  WeatherData_Abridged.addSemiMajorAxis(builder, semiMajorAxis);
  WeatherData_Abridged.addSemiMinorAxis(builder, semiMinorAxis);
  WeatherData_Abridged.addAngleOrientation(builder, angleOrientation);
  WeatherData_Abridged.addLightEventNum(builder, lightEventNum);
  WeatherData_Abridged.addLightDetSensors(builder, lightDetSensorsOffset);
  WeatherData_Abridged.addPosConfidence(builder, posConfidence);
  WeatherData_Abridged.addSrcTyps(builder, srcTypsOffset);
  WeatherData_Abridged.addSrcIds(builder, srcIdsOffset);
  WeatherData_Abridged.addOrigNetwork(builder, origNetworkOffset);
  WeatherData_Abridged.addCreatedAt(builder, createdAtOffset);
  WeatherData_Abridged.addCreatedBy(builder, createdByOffset);
  WeatherData_Abridged.addSource(builder, sourceOffset);
  WeatherData_Abridged.addOrigin(builder, originOffset);
  WeatherData_Abridged.addDataMode(builder, dataMode);
  return WeatherData_Abridged.endWeatherData_Abridged(builder);
}

unpack(): WeatherData_AbridgedT {
  return new WeatherData_AbridgedT(
    this.id(),
    this.classificationMarking(),
    this.idSensor(),
    this.origSensorId(),
    this.obTime(),
    this.bb!.createScalarList<string>(this.sigPwrs.bind(this), this.sigPwrs_Length()),
    this.bb!.createScalarList<string>(this.noiseLvls.bind(this), this.noiseLvls_Length()),
    this.bb!.createScalarList<string>(this.specWidths.bind(this), this.specWidths_Length()),
    this.bb!.createScalarList<string>(this.firstGuessAvgs.bind(this), this.firstGuessAvgs_Length()),
    this.qcValue(),
    this.fileCreation(),
    this.termAlt(),
    this.avgTxPwr(),
    ...
    this.sectorNum(),
    this.numElements(),
    this.bb!.createScalarList<string>(this.tdAvgSampleNums.bind(this), this.tdAvgSampleNums_Length()),
    this.checksum(),
    this.bb!.createScalarList<string>(this.coIntegs.bind(this), this.coIntegs_Length()),
    this.bb!.createScalarList<string>(this.specAvgs.bind(this), this.specAvgs_Length()),
    this.bb!.createScalarList<string>(this.interpulsePeriods.bind(this), this.interpulsePeriods_Length()),
    this.bb!.createScalarList<string>(this.doppVels.bind(this), this.doppVels_Length()),
    this.bb!.createScalarList<string>(this.consRecs.bind(this), this.consRecs_Length()),
    ...
    this.lightEventNum(),
    this.bb!.createScalarList<string>(this.lightDetSensors.bind(this), this.lightDetSensors_Length()),
    this.posConfidence(),
...
unpackTo(_o: WeatherData_AbridgedT): void {
  _o.id = this.id();
  _o.classificationMarking = this.classificationMarking();
  _o.idSensor = this.idSensor();
  _o.origSensorId = this.origSensorId();
  _o.obTime = this.obTime();
  _o.sigPwrs = this.bb!.createScalarList<string>(this.sigPwrs.bind(this), this.sigPwrs_Length());
  _o.noiseLvls = this.bb!.createScalarList<string>(this.noiseLvls.bind(this), this.noiseLvls_Length());
  _o.specWidths = this.bb!.createScalarList<string>(this.specWidths.bind(this), this.specWidths_Length());
  _o.firstGuessAvgs = this.bb!.createScalarList<string>(this.firstGuessAvgs.bind(this), this.firstGuessAvgs_Length());
  ...
  _o.tdAvgSampleNums = this.bb!.createScalarList<string>(this.tdAvgSampleNums.bind(this), this.tdAvgSampleNums_Length());
  _o.checksum = this.checksum();
  _o.coIntegs = this.bb!.createScalarList<string>(this.coIntegs.bind(this), this.coIntegs_Length());
  _o.specAvgs = this.bb!.createScalarList<string>(this.specAvgs.bind(this), this.specAvgs_Length());
  _o.interpulsePeriods = this.bb!.createScalarList<string>(this.interpulsePeriods.bind(this), this.interpulsePeriods_Length());
  _o.doppVels = this.bb!.createScalarList<string>(this.doppVels.bind(this), this.doppVels_Length());
  _o.consRecs = this.bb!.createScalarList<string>(this.consRecs.bind(this), this.consRecs_Length());
  ...
  _o.lightDetSensors = this.bb!.createScalarList<string>(this.lightDetSensors.bind(this), this.lightDetSensors_Length());
...
export class WeatherData_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: WeatherData_Abridged_dataMode_Enum = WeatherData_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const sigPwrs = WeatherData_Abridged.createSigPwrsVector(builder, builder.createObjectOffsetList(this.sigPwrs));
  const noiseLvls = WeatherData_Abridged.createNoiseLvlsVector(builder, builder.createObjectOffsetList(this.noiseLvls));
  const specWidths = WeatherData_Abridged.createSpecWidthsVector(builder, builder.createObjectOffsetList(this.specWidths));
  const firstGuessAvgs = WeatherData_Abridged.createFirstGuessAvgsVector(builder, builder.createObjectOffsetList(this.firstGuessAvgs));
  const fileCreation = (this.fileCreation !== null ? builder.createString(this.fileCreation!) : 0);
  const tdAvgSampleNums = WeatherData_Abridged.createTdAvgSampleNumsVector(builder, builder.createObjectOffsetList(this.tdAvgSampleNums));
  const coIntegs = WeatherData_Abridged.createCoIntegsVector(builder, builder.createObjectOffsetList(this.coIntegs));
  const specAvgs = WeatherData_Abridged.createSpecAvgsVector(builder, builder.createObjectOffsetList(this.specAvgs));
  const interpulsePeriods = WeatherData_Abridged.createInterpulsePeriodsVector(builder, builder.createObjectOffsetList(this.interpulsePeriods));
  const doppVels = WeatherData_Abridged.createDoppVelsVector(builder, builder.createObjectOffsetList(this.doppVels));
  const consRecs = WeatherData_Abridged.createConsRecsVector(builder, builder.createObjectOffsetList(this.consRecs));
  const snrs = WeatherData_Abridged.createSnrsVector(builder, builder.createObjectOffsetList(this.snrs));
  const lightDetSensors = WeatherData_Abridged.createLightDetSensorsVector(builder, builder.createObjectOffsetList(this.lightDetSensors));
  const srcTyps = WeatherData_Abridged.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = WeatherData_Abridged.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  ...
  return WeatherData_Abridged.createWeatherData_Abridged(builder,
    id,
