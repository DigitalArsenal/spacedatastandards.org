 ...
 */
export class CrewMembers_Ingest implements flatbuffers.IUnpackableObject<CrewMembers_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):CrewMembers_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsCrewMembers_Ingest(bb:flatbuffers.ByteBuffer, obj?:CrewMembers_Ingest):CrewMembers_Ingest {
  return (obj || new CrewMembers_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsCrewMembers_Ingest(bb:flatbuffers.ByteBuffer, obj?:CrewMembers_Ingest):CrewMembers_Ingest {
...
static startCrewMembers_Ingest(builder:flatbuffers.Builder) {
...
unpack(): CrewMembers_IngestT {
  return new CrewMembers_IngestT(
    this.lastName(),
    this.firstName(),
    this.middleInitial(),
    this.memberId(),
...
unpackTo(_o: CrewMembers_IngestT): void {
...
export class CrewMembers_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return CrewMembers_Ingest.createCrewMembers_Ingest(builder,
    lastName,
    firstName,
    middleInitial,
    memberId,
