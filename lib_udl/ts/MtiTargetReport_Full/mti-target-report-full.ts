 ...
 */
export class MtiTargetReport_Full implements flatbuffers.IUnpackableObject<MtiTargetReport_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MtiTargetReport_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMtiTargetReport_Full(bb:flatbuffers.ByteBuffer, obj?:MtiTargetReport_Full):MtiTargetReport_Full {
  return (obj || new MtiTargetReport_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMtiTargetReport_Full(bb:flatbuffers.ByteBuffer, obj?:MtiTargetReport_Full):MtiTargetReport_Full {
...
static startMtiTargetReport_Full(builder:flatbuffers.Builder) {
...
static endMtiTargetReport_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishMtiTargetReport_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIT');
}

static finishSizePrefixedMtiTargetReport_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIT', true);
}

static createMtiTargetReport_Full(builder:flatbuffers.Builder, d321:number, d322:number, d323:number, d324:number, d325:number, d326:number, d327:number, d328:number, d329:number, d3210Offset:flatbuffers.Offset, d3211:number, d3212:number, d3213:number, d3214:number, d3215:number, d3216:number, d3217:bigint, d3218:number):flatbuffers.Offset {
  MtiTargetReport_Full.startMtiTargetReport_Full(builder);
...
unpack(): MtiTargetReport_FullT {
  return new MtiTargetReport_FullT(
    this.d321(),
    this.d322(),
    this.d323(),
    this.d324(),
...
unpackTo(_o: MtiTargetReport_FullT): void {
  _o.d32_1 = this.d321();
  _o.d32_2 = this.d322();
  _o.d32_3 = this.d323();
  _o.d32_4 = this.d324();
...
export class MtiTargetReport_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return MtiTargetReport_Full.createMtiTargetReport_Full(builder,
    this.d32_1,
    this.d32_2,
    this.d32_3,
    this.d32_4,
