...
import { Surface_Ingest_dataMode_Enum } from './surface-ingest-data-mode-enum.js';
 ...
 */
export class Surface_Ingest implements flatbuffers.IUnpackableObject<Surface_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Surface_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSurface_Ingest(bb:flatbuffers.ByteBuffer, obj?:Surface_Ingest):Surface_Ingest {
  return (obj || new Surface_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSurface_Ingest(bb:flatbuffers.ByteBuffer, obj?:Surface_Ingest):Surface_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Surface_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 106);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Surface_Ingest_dataMode_Enum.REAL;
}

static startSurface_Ingest(builder:flatbuffers.Builder) {
...
unpack(): Surface_IngestT {
  return new Surface_IngestT(
    this.id(),
...
unpackTo(_o: Surface_IngestT): void {
  _o.id = this.id();
...
export class Surface_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Surface_Ingest_dataMode_Enum = Surface_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Surface_Ingest.createSurface_Ingest(builder,
    id,
