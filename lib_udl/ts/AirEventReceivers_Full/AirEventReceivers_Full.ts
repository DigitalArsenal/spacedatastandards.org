 ...
 */
export class AirEventReceivers_Full implements flatbuffers.IUnpackableObject<AirEventReceivers_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirEventReceivers_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirEventReceivers_Full(bb:flatbuffers.ByteBuffer, obj?:AirEventReceivers_Full):AirEventReceivers_Full {
  return (obj || new AirEventReceivers_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirEventReceivers_Full(bb:flatbuffers.ByteBuffer, obj?:AirEventReceivers_Full):AirEventReceivers_Full {
...
static startAirEventReceivers_Full(builder:flatbuffers.Builder) {
...
unpack(): AirEventReceivers_FullT {
  return new AirEventReceivers_FullT(
...
unpackTo(_o: AirEventReceivers_FullT): void {
...
export class AirEventReceivers_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AirEventReceivers_Full.createAirEventReceivers_Full(builder,
    idReceiverSortie,
    idReceiverMission,
    idReceiverAirfield,
    externalReceiverId,
