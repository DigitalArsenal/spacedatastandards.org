 ...
 */
export class PersonnelRecoveryExecutionInfo_Abridged implements flatbuffers.IUnpackableObject<PersonnelRecoveryExecutionInfo_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):PersonnelRecoveryExecutionInfo_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsPersonnelRecoveryExecutionInfo_Abridged(bb:flatbuffers.ByteBuffer, obj?:PersonnelRecoveryExecutionInfo_Abridged):PersonnelRecoveryExecutionInfo_Abridged {
  return (obj || new PersonnelRecoveryExecutionInfo_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsPersonnelRecoveryExecutionInfo_Abridged(bb:flatbuffers.ByteBuffer, obj?:PersonnelRecoveryExecutionInfo_Abridged):PersonnelRecoveryExecutionInfo_Abridged {
...
static startPersonnelRecoveryExecutionInfo_Abridged(builder:flatbuffers.Builder) {
...
static endPersonnelRecoveryExecutionInfo_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishPersonnelRecoveryExecutionInfo_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'PERS');
}

static finishSizePrefixedPersonnelRecoveryExecutionInfo_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'PERS', true);
}

static createPersonnelRecoveryExecutionInfo_Abridged(builder:flatbuffers.Builder, initialPointOffset:flatbuffers.Offset, ingress:number, objStrategyOffset:flatbuffers.Offset, egressPointOffset:flatbuffers.Offset, egress:number, recoveryVehicleOffset:flatbuffers.Offset, escortVehicleOffset:flatbuffers.Offset):flatbuffers.Offset {
  PersonnelRecoveryExecutionInfo_Abridged.startPersonnelRecoveryExecutionInfo_Abridged(builder);
...
unpack(): PersonnelRecoveryExecutionInfo_AbridgedT {
  return new PersonnelRecoveryExecutionInfo_AbridgedT(
    this.bb!.createScalarList<string>(this.initialPoint.bind(this), this.initialPointLength()),
    this.ingress(),
    this.objStrategy(),
    this.bb!.createScalarList<string>(this.egressPoint.bind(this), this.egressPointLength()),
    this.egress(),
...
unpackTo(_o: PersonnelRecoveryExecutionInfo_AbridgedT): void {
  _o.initialPoint = this.bb!.createScalarList<string>(this.initialPoint.bind(this), this.initialPointLength());
  _o.ingress = this.ingress();
  _o.objStrategy = this.objStrategy();
  _o.egressPoint = this.bb!.createScalarList<string>(this.egressPoint.bind(this), this.egressPointLength());
...
export class PersonnelRecoveryExecutionInfo_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  const initialPoint = PersonnelRecoveryExecutionInfo_Abridged.createInitialPointVector(builder, builder.createObjectOffsetList(this.initialPoint));
  const objStrategy = (this.objStrategy !== null ? builder.createString(this.objStrategy!) : 0);
  const egressPoint = PersonnelRecoveryExecutionInfo_Abridged.createEgressPointVector(builder, builder.createObjectOffsetList(this.egressPoint));
  ...
  return PersonnelRecoveryExecutionInfo_Abridged.createPersonnelRecoveryExecutionInfo_Abridged(builder,
    initialPoint,
    this.ingress,
    objStrategy,
    egressPoint,
