 ...
 */
export class AirTransportMissionHazMat_Full implements flatbuffers.IUnpackableObject<AirTransportMissionHazMat_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirTransportMissionHazMat_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirTransportMissionHazMat_Full(bb:flatbuffers.ByteBuffer, obj?:AirTransportMissionHazMat_Full):AirTransportMissionHazMat_Full {
  return (obj || new AirTransportMissionHazMat_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirTransportMissionHazMat_Full(bb:flatbuffers.ByteBuffer, obj?:AirTransportMissionHazMat_Full):AirTransportMissionHazMat_Full {
...
static startAirTransportMissionHazMat_Full(builder:flatbuffers.Builder) {
...
static endAirTransportMissionHazMat_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirTransportMissionHazMat_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRT');
}

static finishSizePrefixedAirTransportMissionHazMat_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRT', true);
}

static createAirTransportMissionHazMat_Full(builder:flatbuffers.Builder, extHazMatIdOffset:flatbuffers.Offset, itemNameOffset:flatbuffers.Offset, unNumOffset:flatbuffers.Offset, pieces:number, weight:number, netExpWt:number, classDiv:number, cgcOffset:flatbuffers.Offset, cgnOffset:flatbuffers.Offset, applicableNotesOffset:flatbuffers.Offset, onItin:number, onIcaoOffset:flatbuffers.Offset, offItin:number, offIcaoOffset:flatbuffers.Offset, plannedOffset:flatbuffers.Offset):flatbuffers.Offset {
  AirTransportMissionHazMat_Full.startAirTransportMissionHazMat_Full(builder);
...
unpack(): AirTransportMissionHazMat_FullT {
  return new AirTransportMissionHazMat_FullT(
    this.extHazMatId(),
    this.itemName(),
    this.unNum(),
    this.pieces(),
...
unpackTo(_o: AirTransportMissionHazMat_FullT): void {
...
export class AirTransportMissionHazMat_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AirTransportMissionHazMat_Full.createAirTransportMissionHazMat_Full(builder,
    extHazMatId,
    itemName,
    unNum,
    this.pieces,
