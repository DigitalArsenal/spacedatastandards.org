...
import { EngineDetails_dataMode_Enum } from './engine-details-data-mode-enum.js';
 ...
 */
export class EngineDetails implements flatbuffers.IUnpackableObject<EngineDetailsT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EngineDetails {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEngineDetails(bb:flatbuffers.ByteBuffer, obj?:EngineDetails):EngineDetails {
  return (obj || new EngineDetails()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEngineDetails(bb:flatbuffers.ByteBuffer, obj?:EngineDetails):EngineDetails {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():EngineDetails_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 52);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : EngineDetails_dataMode_Enum.REAL;
}
...
static startEngineDetails(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:EngineDetails_dataMode_Enum) {
  builder.addFieldInt8(24, dataMode, EngineDetails_dataMode_Enum.REAL);
}
...
unpack(): EngineDetailsT {
  return new EngineDetailsT(
    this.id(),
    this.idEngine(),
...
unpackTo(_o: EngineDetailsT): void {
  _o.id = this.id();
...
export class EngineDetailsT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: EngineDetails_dataMode_Enum = EngineDetails_dataMode_Enum.REAL,
  public tags: (string)[] = []
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = EngineDetails.createTagsVector(builder, builder.createObjectOffsetList(this.tags));

  return EngineDetails.createEngineDetails(builder,
    id,
    idEngine,
