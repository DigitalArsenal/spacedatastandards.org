...
import { SeradataNavigation_Full_dataMode_Enum } from './seradata-navigation-full-data-mode-enum.js';


/**
 * /// Details for a navigation payload from  Seradata.
 */
export class SeradataNavigation_Full implements flatbuffers.IUnpackableObject<SeradataNavigation_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SeradataNavigation_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSeradataNavigation_Full(bb:flatbuffers.ByteBuffer, obj?:SeradataNavigation_Full):SeradataNavigation_Full {
  return (obj || new SeradataNavigation_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSeradataNavigation_Full(bb:flatbuffers.ByteBuffer, obj?:SeradataNavigation_Full):SeradataNavigation_Full {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SeradataNavigation_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 48);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SeradataNavigation_Full_dataMode_Enum.REAL;
}

static startSeradataNavigation_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SeradataNavigation_Full_dataMode_Enum) {
  builder.addFieldInt8(22, dataMode, SeradataNavigation_Full_dataMode_Enum.REAL);
}

static endSeradataNavigation_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSeradataNavigation_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA');
}

static finishSizePrefixedSeradataNavigation_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA', true);
}

static createSeradataNavigation_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idNavigationOffset:flatbuffers.Offset, spacecraftIdOffset:flatbuffers.Offset, hostedForCompanyOrgIdOffset:flatbuffers.Offset, manufacturerOrgIdOffset:flatbuffers.Offset, payloadTypeOffset:flatbuffers.Offset, modesOffset:flatbuffers.Offset, modeFrequencyOffset:flatbuffers.Offset, locationAccuracy:number, partnerSpacecraftIdOffset:flatbuffers.Offset, areaCoverageOffset:flatbuffers.Offset, notesOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, clockTypeOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:SeradataNavigation_Full_dataMode_Enum):flatbuffers.Offset {
  SeradataNavigation_Full.startSeradataNavigation_Full(builder);
...
unpack(): SeradataNavigation_FullT {
  return new SeradataNavigation_FullT(
    this.id(),
...
unpackTo(_o: SeradataNavigation_FullT): void {
  _o.id = this.id();
...
export class SeradataNavigation_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SeradataNavigation_Full_dataMode_Enum = SeradataNavigation_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SeradataNavigation_Full.createSeradataNavigation_Full(builder,
    id,
