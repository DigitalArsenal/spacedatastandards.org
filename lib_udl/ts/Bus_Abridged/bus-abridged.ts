...
import { Bus_Abridged_dataMode_Enum } from './bus-abridged-data-mode-enum.js';
 ...
 */
export class Bus_Abridged implements flatbuffers.IUnpackableObject<Bus_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Bus_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsBus_Abridged(bb:flatbuffers.ByteBuffer, obj?:Bus_Abridged):Bus_Abridged {
  return (obj || new Bus_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsBus_Abridged(bb:flatbuffers.ByteBuffer, obj?:Bus_Abridged):Bus_Abridged {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new Bus_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static bufferHasIdentifier(bb:flatbuffers.ByteBuffer):boolean {
  return bb.__has_identifier('BUSA');
}
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Bus_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 108);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Bus_Abridged_dataMode_Enum.REAL;
}
...
static startBus_Abridged(builder:flatbuffers.Builder) {
...
static addTelemetryTrackingManufacturerOrgId(builder:flatbuffers.Builder, telemetryTrackingManufacturerOrgIdOffset:flatbuffers.Offset) {
  builder.addFieldOffset(39, telemetryTrackingManufacturerOrgIdOffset, 0);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Bus_Abridged_dataMode_Enum) {
  builder.addFieldInt8(52, dataMode, Bus_Abridged_dataMode_Enum.REAL);
}
...
unpack(): Bus_AbridgedT {
  return new Bus_AbridgedT(
    this.id(),
    this.name(),
...
unpackTo(_o: Bus_AbridgedT): void {
  _o.id = this.id();
  _o.name = this.name();
...
export class Bus_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Bus_Abridged_dataMode_Enum = Bus_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Bus_Abridged.createBus_Abridged(builder,
    id,
    name,
