...
import { AttitudeData_Abridged_dataMode_Enum } from './AttitudeData_Abridged_dataMode_Enum.js';
 ...
 */
export class AttitudeData_Abridged implements flatbuffers.IUnpackableObject<AttitudeData_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AttitudeData_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAttitudeData_Abridged(bb:flatbuffers.ByteBuffer, obj?:AttitudeData_Abridged):AttitudeData_Abridged {
  return (obj || new AttitudeData_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAttitudeData_Abridged(bb:flatbuffers.ByteBuffer, obj?:AttitudeData_Abridged):AttitudeData_Abridged {
 ...
 */
dataMode():AttitudeData_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 66);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AttitudeData_Abridged_dataMode_Enum.REAL;
}
...
static startAttitudeData_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AttitudeData_Abridged_dataMode_Enum) {
  builder.addFieldInt8(31, dataMode, AttitudeData_Abridged_dataMode_Enum.REAL);
}
...
static endAttitudeData_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAttitudeData_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ATTI');
}

static finishSizePrefixedAttitudeData_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ATTI', true);
}

static createAttitudeData_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, asIdOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, satNo:number, origObjectIdOffset:flatbuffers.Offset, tsOffset:flatbuffers.Offset, motionTypeOffset:flatbuffers.Offset, q1:number, q2:number, q3:number, qc:number, q1Dot:number, q2Dot:number, q3Dot:number, qcDot:number, xAngleOffset:flatbuffers.Offset, yAngleOffset:flatbuffers.Offset, zAngleOffset:flatbuffers.Offset, xRateOffset:flatbuffers.Offset, yRateOffset:flatbuffers.Offset, zRateOffset:flatbuffers.Offset, ra:number, declination:number, coningAngle:number, precPeriod:number, spinPeriod:number, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:AttitudeData_Abridged_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  AttitudeData_Abridged.startAttitudeData_Abridged(builder);
...
unpack(): AttitudeData_AbridgedT {
  return new AttitudeData_AbridgedT(
    this.id(),
    ...
    this.q3Dot(),
    this.qcDot(),
    this.bb!.createScalarList<string>(this.xAngle.bind(this), this.xAngleLength()),
    this.bb!.createScalarList<string>(this.yAngle.bind(this), this.yAngleLength()),
    this.bb!.createScalarList<string>(this.zAngle.bind(this), this.zAngleLength()),
    this.bb!.createScalarList<string>(this.xRate.bind(this), this.xRateLength()),
    this.bb!.createScalarList<string>(this.yRate.bind(this), this.yRateLength()),
    this.bb!.createScalarList<string>(this.zRate.bind(this), this.zRateLength()),
    this.ra(),
    this.declination(),
    this.coningAngle(),
    this.precPeriod(),
...
unpackTo(_o: AttitudeData_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.q3Dot = this.q3Dot();
  _o.qcDot = this.qcDot();
  _o.xAngle = this.bb!.createScalarList<string>(this.xAngle.bind(this), this.xAngleLength());
  _o.yAngle = this.bb!.createScalarList<string>(this.yAngle.bind(this), this.yAngleLength());
  _o.zAngle = this.bb!.createScalarList<string>(this.zAngle.bind(this), this.zAngleLength());
  _o.xRate = this.bb!.createScalarList<string>(this.xRate.bind(this), this.xRateLength());
  _o.yRate = this.bb!.createScalarList<string>(this.yRate.bind(this), this.yRateLength());
  _o.zRate = this.bb!.createScalarList<string>(this.zRate.bind(this), this.zRateLength());
  _o.ra = this.ra();
...
export class AttitudeData_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AttitudeData_Abridged_dataMode_Enum = AttitudeData_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const xAngle = AttitudeData_Abridged.createXAngleVector(builder, builder.createObjectOffsetList(this.xAngle));
  const yAngle = AttitudeData_Abridged.createYAngleVector(builder, builder.createObjectOffsetList(this.yAngle));
  const zAngle = AttitudeData_Abridged.createZAngleVector(builder, builder.createObjectOffsetList(this.zAngle));
  const xRate = AttitudeData_Abridged.createXRateVector(builder, builder.createObjectOffsetList(this.xRate));
  const yRate = AttitudeData_Abridged.createYRateVector(builder, builder.createObjectOffsetList(this.yRate));
  const zRate = AttitudeData_Abridged.createZRateVector(builder, builder.createObjectOffsetList(this.zRate));
  ...
  return AttitudeData_Abridged.createAttitudeData_Abridged(builder,
    id,
