...
import { SeradataSigIntPayload_Full_dataMode_Enum } from './seradata-sig-int-payload-full-data-mode-enum.js';


/**
 * /// Details for an sigint payload from  Seradata.
 */
export class SeradataSigIntPayload_Full implements flatbuffers.IUnpackableObject<SeradataSigIntPayload_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SeradataSigIntPayload_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSeradataSigIntPayload_Full(bb:flatbuffers.ByteBuffer, obj?:SeradataSigIntPayload_Full):SeradataSigIntPayload_Full {
  return (obj || new SeradataSigIntPayload_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSeradataSigIntPayload_Full(bb:flatbuffers.ByteBuffer, obj?:SeradataSigIntPayload_Full):SeradataSigIntPayload_Full {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SeradataSigIntPayload_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 48);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SeradataSigIntPayload_Full_dataMode_Enum.REAL;
}

static startSeradataSigIntPayload_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SeradataSigIntPayload_Full_dataMode_Enum) {
  builder.addFieldInt8(22, dataMode, SeradataSigIntPayload_Full_dataMode_Enum.REAL);
}

static endSeradataSigIntPayload_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSeradataSigIntPayload_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA');
}

static finishSizePrefixedSeradataSigIntPayload_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA', true);
}

static createSeradataSigIntPayload_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, spacecraftIdOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, hostedForCompanyOrgIdOffset:flatbuffers.Offset, manufacturerOrgIdOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, swathWidth:number, groundStationsOffset:flatbuffers.Offset, groundStationLocationsOffset:flatbuffers.Offset, frequencyCoverageOffset:flatbuffers.Offset, positionalAccuracyOffset:flatbuffers.Offset, interceptParametersOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, notesOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:SeradataSigIntPayload_Full_dataMode_Enum):flatbuffers.Offset {
  SeradataSigIntPayload_Full.startSeradataSigIntPayload_Full(builder);
...
unpack(): SeradataSigIntPayload_FullT {
  return new SeradataSigIntPayload_FullT(
    this.id(),
...
unpackTo(_o: SeradataSigIntPayload_FullT): void {
  _o.id = this.id();
...
export class SeradataSigIntPayload_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SeradataSigIntPayload_Full_dataMode_Enum = SeradataSigIntPayload_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SeradataSigIntPayload_Full.createSeradataSigIntPayload_Full(builder,
    id,
