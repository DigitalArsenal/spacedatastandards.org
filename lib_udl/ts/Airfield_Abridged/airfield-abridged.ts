...
import { Airfield_Abridged_dataMode_Enum } from './airfield-abridged-data-mode-enum.js';


/**
 * /// Properties and characteristics of an airfield, which includes location, airfield codes, suitability codes, and remarks.
 */
export class Airfield_Abridged implements flatbuffers.IUnpackableObject<Airfield_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Airfield_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirfield_Abridged(bb:flatbuffers.ByteBuffer, obj?:Airfield_Abridged):Airfield_Abridged {
  return (obj || new Airfield_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirfield_Abridged(bb:flatbuffers.ByteBuffer, obj?:Airfield_Abridged):Airfield_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Airfield_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 72);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Airfield_Abridged_dataMode_Enum.REAL;
}

static startAirfield_Abridged(builder:flatbuffers.Builder) {
...
unpack(): Airfield_AbridgedT {
  return new Airfield_AbridgedT(
    this.id(),
...
unpackTo(_o: Airfield_AbridgedT): void {
  _o.id = this.id();
...
export class Airfield_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Airfield_Abridged_dataMode_Enum = Airfield_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Airfield_Abridged.createAirfield_Abridged(builder,
    id,
