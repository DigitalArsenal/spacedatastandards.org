...
import { OrbitTrack_Ingest_dataMode_Enum } from './orbit-track-ingest-data-mode-enum.js';
import { OrbitTrack_Ingest_objIdent_Enum } from './orbit-track-ingest-obj-ident-enum.js';
import { OrbitTrack_Ingest_objectType_Enum } from './orbit-track-ingest-object-type-enum.js';
 ...
 */
export class OrbitTrack_Ingest implements flatbuffers.IUnpackableObject<OrbitTrack_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OrbitTrack_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOrbitTrack_Ingest(bb:flatbuffers.ByteBuffer, obj?:OrbitTrack_Ingest):OrbitTrack_Ingest {
  return (obj || new OrbitTrack_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOrbitTrack_Ingest(bb:flatbuffers.ByteBuffer, obj?:OrbitTrack_Ingest):OrbitTrack_Ingest {
 ...
 * Constraints: Minimum length = 0, Maximum length = 32
 */
objIdent():OrbitTrack_Ingest_objIdent_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 30);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OrbitTrack_Ingest_objIdent_Enum.ASSUMED_FRIEND;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 32
 */
objectType():OrbitTrack_Ingest_objectType_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 36);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OrbitTrack_Ingest_objectType_Enum.DEBRIS;
}
 ...
 */
dataMode():OrbitTrack_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 90);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OrbitTrack_Ingest_dataMode_Enum.REAL;
}
...
static startOrbitTrack_Ingest(builder:flatbuffers.Builder) {
...
static addObjIdent(builder:flatbuffers.Builder, objIdent:OrbitTrack_Ingest_objIdent_Enum) {
  builder.addFieldInt8(13, objIdent, OrbitTrack_Ingest_objIdent_Enum.ASSUMED_FRIEND);
}
...
static addObjectType(builder:flatbuffers.Builder, objectType:OrbitTrack_Ingest_objectType_Enum) {
  builder.addFieldInt8(16, objectType, OrbitTrack_Ingest_objectType_Enum.DEBRIS);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:OrbitTrack_Ingest_dataMode_Enum) {
  builder.addFieldInt8(43, dataMode, OrbitTrack_Ingest_dataMode_Enum.REAL);
}
...
static endOrbitTrack_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishOrbitTrack_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ORBI');
}

static finishSizePrefixedOrbitTrack_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ORBI', true);
}

static createOrbitTrack_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, satNo:number, origObjectIdOffset:flatbuffers.Offset, idElsetOffset:flatbuffers.Offset, tsOffset:flatbuffers.Offset, lat:number, lon:number, alt:number, rdfRf:number, callSignOffset:flatbuffers.Offset, rptNumOffset:flatbuffers.Offset, objIdent:OrbitTrack_Ingest_objIdent_Enum, identAmpOffset:flatbuffers.Offset, satStatusOffset:flatbuffers.Offset, objectType:OrbitTrack_Ingest_objectType_Enum, countryCodeOffset:flatbuffers.Offset, decay:number, charlieLineOffset:flatbuffers.Offset, aouTypeOffset:flatbuffers.Offset, aouDataOffset:flatbuffers.Offset, spd:number, angElev:number, cntnmnt:number, xrefOffset:flatbuffers.Offset, chXrefOffset:flatbuffers.Offset, amplificationOffset:flatbuffers.Offset, iffOffset:flatbuffers.Offset, reinforced:boolean, reduced:boolean, hq:boolean, dummy:boolean, taskForce:boolean, feint:boolean, installation:boolean, vehTypeOffset:flatbuffers.Offset, trkIdOffset:flatbuffers.Offset, trackSensorsOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:OrbitTrack_Ingest_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  OrbitTrack_Ingest.startOrbitTrack_Ingest(builder);
...
unpack(): OrbitTrack_IngestT {
  return new OrbitTrack_IngestT(
    this.id(),
    ...
    this.charlieLine(),
    this.aouType(),
    this.bb!.createScalarList<string>(this.aouData.bind(this), this.aouData_Length()),
    this.spd(),
    this.angElev(),
    this.cntnmnt(),
    this.xref(),
    ...
    this.vehType(),
    this.trkId(),
    this.bb!.createScalarList<string>(this.trackSensors.bind(this), this.trackSensors_Length()),
    this.createdAt(),
    this.createdBy(),
    this.source(),
    this.origin(),
...
unpackTo(_o: OrbitTrack_IngestT): void {
  _o.id = this.id();
  ...
  _o.aouData = this.bb!.createScalarList<string>(this.aouData.bind(this), this.aouData_Length());
  _o.spd = this.spd();
  ...
  _o.trkId = this.trkId();
  _o.trackSensors = this.bb!.createScalarList<string>(this.trackSensors.bind(this), this.trackSensors_Length());
...
export class OrbitTrack_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public objIdent: OrbitTrack_Ingest_objIdent_Enum = OrbitTrack_Ingest_objIdent_Enum.ASSUMED_FRIEND,
  public identAmp: string|Uint8Array|null = null,
  public satStatus: string|Uint8Array|null = null,
  public objectType: OrbitTrack_Ingest_objectType_Enum = OrbitTrack_Ingest_objectType_Enum.DEBRIS,
  ...
  public dataMode: OrbitTrack_Ingest_dataMode_Enum = OrbitTrack_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const aouData = OrbitTrack_Ingest.createAouDataVector(builder, builder.createObjectOffsetList(this.aouData));
  ...
  const trackSensors = OrbitTrack_Ingest.createTrackSensorsVector(builder, builder.createObjectOffsetList(this.trackSensors));
  ...
  return OrbitTrack_Ingest.createOrbitTrack_Ingest(builder,
    id,
