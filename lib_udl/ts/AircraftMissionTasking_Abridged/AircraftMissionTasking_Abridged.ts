 ...
 */
export class AircraftMissionTasking_Abridged implements flatbuffers.IUnpackableObject<AircraftMissionTasking_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AircraftMissionTasking_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAircraftMissionTasking_Abridged(bb:flatbuffers.ByteBuffer, obj?:AircraftMissionTasking_Abridged):AircraftMissionTasking_Abridged {
  return (obj || new AircraftMissionTasking_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAircraftMissionTasking_Abridged(bb:flatbuffers.ByteBuffer, obj?:AircraftMissionTasking_Abridged):AircraftMissionTasking_Abridged {
...
static startAircraftMissionTasking_Abridged(builder:flatbuffers.Builder) {
...
static endAircraftMissionTasking_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAircraftMissionTasking_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRC');
}

static finishSizePrefixedAircraftMissionTasking_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRC', true);
}

static createAircraftMissionTasking_Abridged(builder:flatbuffers.Builder, countryCodeOffset:flatbuffers.Offset, taskedServiceOffset:flatbuffers.Offset, unitDesignatorOffset:flatbuffers.Offset, unitLocNameOffset:flatbuffers.Offset, resMsnIndOffset:flatbuffers.Offset, amcMsnNumOffset:flatbuffers.Offset, pkgIdOffset:flatbuffers.Offset, msnCommanderOffset:flatbuffers.Offset, msnNumOffset:flatbuffers.Offset, priMsnTypeOffset:flatbuffers.Offset, secMsnTypeOffset:flatbuffers.Offset, alertStatus:number, depLocNameOffset:flatbuffers.Offset, depLocUtmOffset:flatbuffers.Offset, depLocLat:number, depLocLon:number, depTimeOffset:flatbuffers.Offset, rcvyLocNameOffset:flatbuffers.Offset, rcvyLocUtmOffset:flatbuffers.Offset, rcvyLocLatOffset:flatbuffers.Offset, rcvyLocLonOffset:flatbuffers.Offset, rcvyTimeOffset:flatbuffers.Offset, indActaskingOffset:flatbuffers.Offset, acMsnLocSegOffset:flatbuffers.Offset):flatbuffers.Offset {
  AircraftMissionTasking_Abridged.startAircraftMissionTasking_Abridged(builder);
  AircraftMissionTasking_Abridged.addCountryCode(builder, countryCodeOffset);
  AircraftMissionTasking_Abridged.addTaskedService(builder, taskedServiceOffset);
  AircraftMissionTasking_Abridged.addUnitDesignator(builder, unitDesignatorOffset);
  AircraftMissionTasking_Abridged.addUnitLocName(builder, unitLocNameOffset);
  AircraftMissionTasking_Abridged.addResMsnInd(builder, resMsnIndOffset);
  AircraftMissionTasking_Abridged.addAmcMsnNum(builder, amcMsnNumOffset);
  AircraftMissionTasking_Abridged.addPkgId(builder, pkgIdOffset);
  AircraftMissionTasking_Abridged.addMsnCommander(builder, msnCommanderOffset);
  AircraftMissionTasking_Abridged.addMsnNum(builder, msnNumOffset);
  AircraftMissionTasking_Abridged.addPriMsnType(builder, priMsnTypeOffset);
  AircraftMissionTasking_Abridged.addSecMsnType(builder, secMsnTypeOffset);
  AircraftMissionTasking_Abridged.addAlertStatus(builder, alertStatus);
  AircraftMissionTasking_Abridged.addDepLocName(builder, depLocNameOffset);
  AircraftMissionTasking_Abridged.addDepLocUtm(builder, depLocUtmOffset);
  AircraftMissionTasking_Abridged.addDepLocLat(builder, depLocLat);
  AircraftMissionTasking_Abridged.addDepLocLon(builder, depLocLon);
  AircraftMissionTasking_Abridged.addDepTime(builder, depTimeOffset);
  AircraftMissionTasking_Abridged.addRcvyLocName(builder, rcvyLocNameOffset);
  AircraftMissionTasking_Abridged.addRcvyLocUtm(builder, rcvyLocUtmOffset);
  AircraftMissionTasking_Abridged.addRcvyLocLat(builder, rcvyLocLatOffset);
  AircraftMissionTasking_Abridged.addRcvyLocLon(builder, rcvyLocLonOffset);
  AircraftMissionTasking_Abridged.addRcvyTime(builder, rcvyTimeOffset);
  AircraftMissionTasking_Abridged.addIndActasking(builder, indActaskingOffset);
  AircraftMissionTasking_Abridged.addAcMsnLocSeg(builder, acMsnLocSegOffset);
  return AircraftMissionTasking_Abridged.endAircraftMissionTasking_Abridged(builder);
}

unpack(): AircraftMissionTasking_AbridgedT {
  return new AircraftMissionTasking_AbridgedT(
    this.countryCode(),
    this.taskedService(),
    this.unitDesignator(),
    this.unitLocName(),
    ...
    this.depLocLon(),
    this.depTime(),
    this.bb!.createScalarList<string>(this.rcvyLocName.bind(this), this.rcvyLocNameLength()),
    this.bb!.createScalarList<string>(this.rcvyLocUtm.bind(this), this.rcvyLocUtmLength()),
    this.bb!.createScalarList<string>(this.rcvyLocLat.bind(this), this.rcvyLocLatLength()),
    this.bb!.createScalarList<string>(this.rcvyLocLon.bind(this), this.rcvyLocLonLength()),
    this.bb!.createScalarList<string>(this.rcvyTime.bind(this), this.rcvyTimeLength()),
    this.bb!.createScalarList<string>(this.indActasking.bind(this), this.indActaskingLength()),
    this.bb!.createScalarList<string>(this.acMsnLocSeg.bind(this), this.acMsnLocSegLength())
  );
}


unpackTo(_o: AircraftMissionTasking_AbridgedT): void {
  ...
  _o.rcvyLocName = this.bb!.createScalarList<string>(this.rcvyLocName.bind(this), this.rcvyLocNameLength());
  _o.rcvyLocUtm = this.bb!.createScalarList<string>(this.rcvyLocUtm.bind(this), this.rcvyLocUtmLength());
  _o.rcvyLocLat = this.bb!.createScalarList<string>(this.rcvyLocLat.bind(this), this.rcvyLocLatLength());
  _o.rcvyLocLon = this.bb!.createScalarList<string>(this.rcvyLocLon.bind(this), this.rcvyLocLonLength());
  _o.rcvyTime = this.bb!.createScalarList<string>(this.rcvyTime.bind(this), this.rcvyTimeLength());
  _o.indActasking = this.bb!.createScalarList<string>(this.indActasking.bind(this), this.indActaskingLength());
  _o.acMsnLocSeg = this.bb!.createScalarList<string>(this.acMsnLocSeg.bind(this), this.acMsnLocSegLength());
}
}

export class AircraftMissionTasking_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const rcvyLocName = AircraftMissionTasking_Abridged.createRcvyLocNameVector(builder, builder.createObjectOffsetList(this.rcvyLocName));
  const rcvyLocUtm = AircraftMissionTasking_Abridged.createRcvyLocUtmVector(builder, builder.createObjectOffsetList(this.rcvyLocUtm));
  const rcvyLocLat = AircraftMissionTasking_Abridged.createRcvyLocLatVector(builder, builder.createObjectOffsetList(this.rcvyLocLat));
  const rcvyLocLon = AircraftMissionTasking_Abridged.createRcvyLocLonVector(builder, builder.createObjectOffsetList(this.rcvyLocLon));
  const rcvyTime = AircraftMissionTasking_Abridged.createRcvyTimeVector(builder, builder.createObjectOffsetList(this.rcvyTime));
  const indActasking = AircraftMissionTasking_Abridged.createIndActaskingVector(builder, builder.createObjectOffsetList(this.indActasking));
  const acMsnLocSeg = AircraftMissionTasking_Abridged.createAcMsnLocSegVector(builder, builder.createObjectOffsetList(this.acMsnLocSeg));

  return AircraftMissionTasking_Abridged.createAircraftMissionTasking_Abridged(builder,
    countryCode,
    taskedService,
    unitDesignator,
    unitLocName,
