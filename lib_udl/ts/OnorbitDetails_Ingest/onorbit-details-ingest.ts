...
import { OnorbitDetails_Ingest_dataMode_Enum } from './onorbit-details-ingest-data-mode-enum.js';


/**
 * /// Contains details of the OnOrbit object.
 */
export class OnorbitDetails_Ingest implements flatbuffers.IUnpackableObject<OnorbitDetails_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OnorbitDetails_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOnorbitDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:OnorbitDetails_Ingest):OnorbitDetails_Ingest {
  return (obj || new OnorbitDetails_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOnorbitDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:OnorbitDetails_Ingest):OnorbitDetails_Ingest {
 ...
 */
dataMode():OnorbitDetails_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 92);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OnorbitDetails_Ingest_dataMode_Enum.REAL;
}
...
static startOnorbitDetails_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:OnorbitDetails_Ingest_dataMode_Enum) {
  builder.addFieldInt8(44, dataMode, OnorbitDetails_Ingest_dataMode_Enum.REAL);
}
...
unpack(): OnorbitDetails_IngestT {
  return new OnorbitDetails_IngestT(
    this.id(),
    this.idOnOrbit(),
...
unpackTo(_o: OnorbitDetails_IngestT): void {
  _o.id = this.id();
...
export class OnorbitDetails_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: OnorbitDetails_Ingest_dataMode_Enum = OnorbitDetails_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const missionTypes = OnorbitDetails_Ingest.createMissionTypesVector(builder, builder.createObjectOffsetList(this.missionTypes));
  const busType = (this.busType !== null ? builder.createString(this.busType!) : 0);
  const depNames = OnorbitDetails_Ingest.createDepNamesVector(builder, builder.createObjectOffsetList(this.depNames));
  const depEstMasses = OnorbitDetails_Ingest.createDepEstMassesVector(builder, builder.createObjectOffsetList(this.depEstMasses));
  const depMassUncs = OnorbitDetails_Ingest.createDepMassUncsVector(builder, builder.createObjectOffsetList(this.depMassUncs));
  ...
  return OnorbitDetails_Ingest.createOnorbitDetails_Ingest(builder,
    id,
    idOnOrbit,
