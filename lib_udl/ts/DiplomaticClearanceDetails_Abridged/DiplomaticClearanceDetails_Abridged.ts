 ...
 */
export class DiplomaticClearanceDetails_Abridged implements flatbuffers.IUnpackableObject<DiplomaticClearanceDetails_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):DiplomaticClearanceDetails_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsDiplomaticClearanceDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:DiplomaticClearanceDetails_Abridged):DiplomaticClearanceDetails_Abridged {
  return (obj || new DiplomaticClearanceDetails_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsDiplomaticClearanceDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:DiplomaticClearanceDetails_Abridged):DiplomaticClearanceDetails_Abridged {
...
static startDiplomaticClearanceDetails_Abridged(builder:flatbuffers.Builder) {
...
unpack(): DiplomaticClearanceDetails_AbridgedT {
  return new DiplomaticClearanceDetails_AbridgedT(
    this.idSortie(),
    this.legNum(),
    this.routeString(),
    this.validStartTime(),
...
unpackTo(_o: DiplomaticClearanceDetails_AbridgedT): void {
...
export class DiplomaticClearanceDetails_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return DiplomaticClearanceDetails_Abridged.createDiplomaticClearanceDetails_Abridged(builder,
    idSortie,
    this.legNum,
    routeString,
    validStartTime,
