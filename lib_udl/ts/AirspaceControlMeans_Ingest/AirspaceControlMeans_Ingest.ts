...
import { AirspaceControlMeans_Ingest_cmShape_Enum } from './AirspaceControlMeans_Ingest_cmShape_Enum.js';


/**
 * /// A conditional nested segment to report multiple airspace control means within a particular airspace control means status.
 */
export class AirspaceControlMeans_Ingest implements flatbuffers.IUnpackableObject<AirspaceControlMeans_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirspaceControlMeans_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirspaceControlMeans_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirspaceControlMeans_Ingest):AirspaceControlMeans_Ingest {
  return (obj || new AirspaceControlMeans_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirspaceControlMeans_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirspaceControlMeans_Ingest):AirspaceControlMeans_Ingest {
 ...
 * Constraints: Minimum length = 0, Maximum length = 8
 */
cmShape():AirspaceControlMeans_Ingest_cmShape_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirspaceControlMeans_Ingest_cmShape_Enum.POLYARC;
}
...
static startAirspaceControlMeans_Ingest(builder:flatbuffers.Builder) {
...
static addCmShape(builder:flatbuffers.Builder, cmShape:AirspaceControlMeans_Ingest_cmShape_Enum) {
  builder.addFieldInt8(2, cmShape, AirspaceControlMeans_Ingest_cmShape_Enum.POLYARC);
}
...
static endAirspaceControlMeans_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirspaceControlMeans_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRS');
}

static finishSizePrefixedAirspaceControlMeans_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRS', true);
}

static createAirspaceControlMeans_Ingest(builder:flatbuffers.Builder, cmTypeOffset:flatbuffers.Offset, cmIdOffset:flatbuffers.Offset, cmShape:AirspaceControlMeans_Ingest_cmShape_Enum, usageOffset:flatbuffers.Offset, link16IdOffset:flatbuffers.Offset, transAltitudeOffset:flatbuffers.Offset, geoDatumAltOffset:flatbuffers.Offset, coord0Offset:flatbuffers.Offset, coord1Offset:flatbuffers.Offset, bearing0:number, bearing1:number, radMag0:number, radMag1:number, radMagUnitOffset:flatbuffers.Offset, polyCoordOffset:flatbuffers.Offset, trackLeg:number, widthLeft:number, widthRight:number, width:number, widthUnitOffset:flatbuffers.Offset, corrWayPointsOffset:flatbuffers.Offset, orbitAlignmentOffset:flatbuffers.Offset, effVdimOffset:flatbuffers.Offset, airspaceTimePeriodOffset:flatbuffers.Offset, airspaceControlPointOffset:flatbuffers.Offset, ctrlAuthOffset:flatbuffers.Offset, ctrlAuthFreqsOffset:flatbuffers.Offset, genTextIndOffset:flatbuffers.Offset, freeTextOffset:flatbuffers.Offset):flatbuffers.Offset {
  AirspaceControlMeans_Ingest.startAirspaceControlMeans_Ingest(builder);
  AirspaceControlMeans_Ingest.addCmType(builder, cmTypeOffset);
  AirspaceControlMeans_Ingest.addCmId(builder, cmIdOffset);
  AirspaceControlMeans_Ingest.addCmShape(builder, cmShape);
  AirspaceControlMeans_Ingest.addUsage(builder, usageOffset);
  AirspaceControlMeans_Ingest.addLink16Id(builder, link16IdOffset);
  AirspaceControlMeans_Ingest.addTransAltitude(builder, transAltitudeOffset);
  AirspaceControlMeans_Ingest.addGeoDatumAlt(builder, geoDatumAltOffset);
  AirspaceControlMeans_Ingest.addCoord0(builder, coord0Offset);
  AirspaceControlMeans_Ingest.addCoord1(builder, coord1Offset);
  AirspaceControlMeans_Ingest.addBearing0(builder, bearing0);
  AirspaceControlMeans_Ingest.addBearing1(builder, bearing1);
  AirspaceControlMeans_Ingest.addRadMag0(builder, radMag0);
  AirspaceControlMeans_Ingest.addRadMag1(builder, radMag1);
  AirspaceControlMeans_Ingest.addRadMagUnit(builder, radMagUnitOffset);
  AirspaceControlMeans_Ingest.addPolyCoord(builder, polyCoordOffset);
  AirspaceControlMeans_Ingest.addTrackLeg(builder, trackLeg);
  AirspaceControlMeans_Ingest.addWidthLeft(builder, widthLeft);
  AirspaceControlMeans_Ingest.addWidthRight(builder, widthRight);
  AirspaceControlMeans_Ingest.addWidth(builder, width);
  AirspaceControlMeans_Ingest.addWidthUnit(builder, widthUnitOffset);
  AirspaceControlMeans_Ingest.addCorrWayPoints(builder, corrWayPointsOffset);
  AirspaceControlMeans_Ingest.addOrbitAlignment(builder, orbitAlignmentOffset);
  AirspaceControlMeans_Ingest.addEffVdim(builder, effVdimOffset);
  AirspaceControlMeans_Ingest.addAirspaceTimePeriod(builder, airspaceTimePeriodOffset);
  AirspaceControlMeans_Ingest.addAirspaceControlPoint(builder, airspaceControlPointOffset);
  AirspaceControlMeans_Ingest.addCtrlAuth(builder, ctrlAuthOffset);
  AirspaceControlMeans_Ingest.addCtrlAuthFreqs(builder, ctrlAuthFreqsOffset);
  AirspaceControlMeans_Ingest.addGenTextInd(builder, genTextIndOffset);
  AirspaceControlMeans_Ingest.addFreeText(builder, freeTextOffset);
  return AirspaceControlMeans_Ingest.endAirspaceControlMeans_Ingest(builder);
}

unpack(): AirspaceControlMeans_IngestT {
  return new AirspaceControlMeans_IngestT(
    this.cmType(),
    this.cmId(),
    this.cmShape(),
    this.usage(),
    ...
    this.radMag1(),
    this.radMagUnit(),
    this.bb!.createScalarList<string>(this.polyCoord.bind(this), this.polyCoordLength()),
    this.trackLeg(),
    this.widthLeft(),
    this.widthRight(),
    this.width(),
    this.widthUnit(),
    this.bb!.createScalarList<string>(this.corrWayPoints.bind(this), this.corrWayPointsLength()),
    this.orbitAlignment(),
    this.effVdim(),
    this.bb!.createScalarList<string>(this.airspaceTimePeriod.bind(this), this.airspaceTimePeriodLength()),
    this.bb!.createScalarList<string>(this.airspaceControlPoint.bind(this), this.airspaceControlPointLength()),
    this.ctrlAuth(),
    this.bb!.createScalarList<string>(this.ctrlAuthFreqs.bind(this), this.ctrlAuthFreqsLength()),
    this.genTextInd(),
    this.freeText()
  );
}
...
unpackTo(_o: AirspaceControlMeans_IngestT): void {
  ...
  _o.polyCoord = this.bb!.createScalarList<string>(this.polyCoord.bind(this), this.polyCoordLength());
  _o.trackLeg = this.trackLeg();
  _o.widthLeft = this.widthLeft();
  _o.widthRight = this.widthRight();
  _o.width = this.width();
  _o.widthUnit = this.widthUnit();
  _o.corrWayPoints = this.bb!.createScalarList<string>(this.corrWayPoints.bind(this), this.corrWayPointsLength());
  _o.orbitAlignment = this.orbitAlignment();
  _o.effVdim = this.effVdim();
  _o.airspaceTimePeriod = this.bb!.createScalarList<string>(this.airspaceTimePeriod.bind(this), this.airspaceTimePeriodLength());
  _o.airspaceControlPoint = this.bb!.createScalarList<string>(this.airspaceControlPoint.bind(this), this.airspaceControlPointLength());
  _o.ctrlAuth = this.ctrlAuth();
  _o.ctrlAuthFreqs = this.bb!.createScalarList<string>(this.ctrlAuthFreqs.bind(this), this.ctrlAuthFreqsLength());
  _o.genTextInd = this.genTextInd();
  _o.freeText = this.freeText();
}
}

export class AirspaceControlMeans_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  public cmType: string|Uint8Array|null = null,
  public cmId: string|Uint8Array|null = null,
  public cmShape: AirspaceControlMeans_Ingest_cmShape_Enum = AirspaceControlMeans_Ingest_cmShape_Enum.POLYARC,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const polyCoord = AirspaceControlMeans_Ingest.createPolyCoordVector(builder, builder.createObjectOffsetList(this.polyCoord));
  const widthUnit = (this.widthUnit !== null ? builder.createString(this.widthUnit!) : 0);
  const corrWayPoints = AirspaceControlMeans_Ingest.createCorrWayPointsVector(builder, builder.createObjectOffsetList(this.corrWayPoints));
  ...
  const airspaceTimePeriod = AirspaceControlMeans_Ingest.createAirspaceTimePeriodVector(builder, builder.createObjectOffsetList(this.airspaceTimePeriod));
  const airspaceControlPoint = AirspaceControlMeans_Ingest.createAirspaceControlPointVector(builder, builder.createObjectOffsetList(this.airspaceControlPoint));
  const ctrlAuth = (this.ctrlAuth !== null ? builder.createString(this.ctrlAuth!) : 0);
  const ctrlAuthFreqs = AirspaceControlMeans_Ingest.createCtrlAuthFreqsVector(builder, builder.createObjectOffsetList(this.ctrlAuthFreqs));
  ...
  return AirspaceControlMeans_Ingest.createAirspaceControlMeans_Ingest(builder,
    cmType,
    cmId,
    this.cmShape,
    usage,
