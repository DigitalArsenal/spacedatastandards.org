 ...
 */
export class LogisticsSupportItems_Abridged implements flatbuffers.IUnpackableObject<LogisticsSupportItems_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LogisticsSupportItems_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLogisticsSupportItems_Abridged(bb:flatbuffers.ByteBuffer, obj?:LogisticsSupportItems_Abridged):LogisticsSupportItems_Abridged {
  return (obj || new LogisticsSupportItems_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLogisticsSupportItems_Abridged(bb:flatbuffers.ByteBuffer, obj?:LogisticsSupportItems_Abridged):LogisticsSupportItems_Abridged {
...
static startLogisticsSupportItems_Abridged(builder:flatbuffers.Builder) {
...
unpack(): LogisticsSupportItems_AbridgedT {
  return new LogisticsSupportItems_AbridgedT(
    ...
    this.bb!.createScalarList<string>(this.logisticsParts.bind(this), this.logisticsPartsLength()),
    this.bb!.createScalarList<string>(this.logisticsSpecialties.bind(this), this.logisticsSpecialtiesLength()),
    this.bb!.createScalarList<string>(this.logisticsRemarks.bind(this), this.logisticsRemarksLength())
  );
}


unpackTo(_o: LogisticsSupportItems_AbridgedT): void {
  ...
  _o.logisticsParts = this.bb!.createScalarList<string>(this.logisticsParts.bind(this), this.logisticsPartsLength());
  _o.logisticsSpecialties = this.bb!.createScalarList<string>(this.logisticsSpecialties.bind(this), this.logisticsSpecialtiesLength());
  _o.logisticsRemarks = this.bb!.createScalarList<string>(this.logisticsRemarks.bind(this), this.logisticsRemarksLength());
}
}

export class LogisticsSupportItems_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const logisticsParts = LogisticsSupportItems_Abridged.createLogisticsPartsVector(builder, builder.createObjectOffsetList(this.logisticsParts));
  const logisticsSpecialties = LogisticsSupportItems_Abridged.createLogisticsSpecialtiesVector(builder, builder.createObjectOffsetList(this.logisticsSpecialties));
  const logisticsRemarks = LogisticsSupportItems_Abridged.createLogisticsRemarksVector(builder, builder.createObjectOffsetList(this.logisticsRemarks));

  return LogisticsSupportItems_Abridged.createLogisticsSupportItems_Abridged(builder,
