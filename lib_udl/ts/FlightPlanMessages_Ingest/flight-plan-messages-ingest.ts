 ...
 */
export class FlightPlanMessages_Ingest implements flatbuffers.IUnpackableObject<FlightPlanMessages_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):FlightPlanMessages_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsFlightPlanMessages_Ingest(bb:flatbuffers.ByteBuffer, obj?:FlightPlanMessages_Ingest):FlightPlanMessages_Ingest {
  return (obj || new FlightPlanMessages_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsFlightPlanMessages_Ingest(bb:flatbuffers.ByteBuffer, obj?:FlightPlanMessages_Ingest):FlightPlanMessages_Ingest {
...
static startFlightPlanMessages_Ingest(builder:flatbuffers.Builder) {
...
static endFlightPlanMessages_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishFlightPlanMessages_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'FLIG');
}

static finishSizePrefixedFlightPlanMessages_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'FLIG', true);
}

static createFlightPlanMessages_Ingest(builder:flatbuffers.Builder, severityOffset:flatbuffers.Offset, wpNumOffset:flatbuffers.Offset, routePathOffset:flatbuffers.Offset, msgTextOffset:flatbuffers.Offset):flatbuffers.Offset {
  FlightPlanMessages_Ingest.startFlightPlanMessages_Ingest(builder);
...
unpack(): FlightPlanMessages_IngestT {
  return new FlightPlanMessages_IngestT(
    this.severity(),
    this.wpNum(),
    this.routePath(),
    this.msgText()
...
unpackTo(_o: FlightPlanMessages_IngestT): void {
...
export class FlightPlanMessages_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return FlightPlanMessages_Ingest.createFlightPlanMessages_Ingest(builder,
    severity,
    wpNum,
    routePath,
    msgText
