...
import { Transponder_Ingest_dataMode_Enum } from './transponder-ingest-data-mode-enum.js';
 ...
 */
export class Transponder_Ingest implements flatbuffers.IUnpackableObject<Transponder_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Transponder_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsTransponder_Ingest(bb:flatbuffers.ByteBuffer, obj?:Transponder_Ingest):Transponder_Ingest {
  return (obj || new Transponder_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTransponder_Ingest(bb:flatbuffers.ByteBuffer, obj?:Transponder_Ingest):Transponder_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Transponder_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 34);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Transponder_Ingest_dataMode_Enum.REAL;
}
...
static startTransponder_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Transponder_Ingest_dataMode_Enum) {
  builder.addFieldInt8(15, dataMode, Transponder_Ingest_dataMode_Enum.REAL);
}
...
static endTransponder_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishTransponder_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TRAN');
}

static finishSizePrefixedTransponder_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TRAN', true);
}

static createTransponder_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idCommOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, nidOffset:flatbuffers.Offset, tidOffset:flatbuffers.Offset, ttf:number, symbolRate:number, fec:number, modulationOffset:flatbuffers.Offset, formatOffset:flatbuffers.Offset, systemOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:Transponder_Ingest_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset):flatbuffers.Offset {
  Transponder_Ingest.startTransponder_Ingest(builder);
...
unpack(): Transponder_IngestT {
  return new Transponder_IngestT(
    this.id(),
    this.idComm(),
    this.name(),
...
unpackTo(_o: Transponder_IngestT): void {
  _o.id = this.id();
...
export class Transponder_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Transponder_Ingest_dataMode_Enum = Transponder_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Transponder_Ingest.createTransponder_Ingest(builder,
    id,
    idComm,
    name,
