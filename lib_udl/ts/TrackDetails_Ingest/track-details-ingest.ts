...
import { TrackDetails_Ingest_dataMode_Enum } from './track-details-ingest-data-mode-enum.js';
import { TrackDetails_Ingest_env_Enum } from './track-details-ingest-env-enum.js';
import { TrackDetails_Ingest_objIdent_Enum } from './track-details-ingest-obj-ident-enum.js';
 ...
 */
export class TrackDetails_Ingest implements flatbuffers.IUnpackableObject<TrackDetails_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):TrackDetails_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsTrackDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:TrackDetails_Ingest):TrackDetails_Ingest {
  return (obj || new TrackDetails_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTrackDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:TrackDetails_Ingest):TrackDetails_Ingest {
 ...
 */
env():TrackDetails_Ingest_env_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 8);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : TrackDetails_Ingest_env_Enum.AIR;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 32
 */
objIdent():TrackDetails_Ingest_objIdent_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 50);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : TrackDetails_Ingest_objIdent_Enum.ASSUMED_FRIEND;
}
 ...
 */
dataMode():TrackDetails_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 316);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : TrackDetails_Ingest_dataMode_Enum.REAL;
}
...
static startTrackDetails_Ingest(builder:flatbuffers.Builder) {
...
static addEnv(builder:flatbuffers.Builder, env:TrackDetails_Ingest_env_Enum) {
  builder.addFieldInt8(2, env, TrackDetails_Ingest_env_Enum.AIR);
}
...
static addObjIdent(builder:flatbuffers.Builder, objIdent:TrackDetails_Ingest_objIdent_Enum) {
  builder.addFieldInt8(23, objIdent, TrackDetails_Ingest_objIdent_Enum.ASSUMED_FRIEND);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:TrackDetails_Ingest_dataMode_Enum) {
  builder.addFieldInt8(156, dataMode, TrackDetails_Ingest_dataMode_Enum.REAL);
}
...
static endTrackDetails_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishTrackDetails_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TRAC');
}

static finishSizePrefixedTrackDetails_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TRAC', true);
}

static createTrackDetails_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, env:TrackDetails_Ingest_env_Enum, msgTypeOffset:flatbuffers.Offset, hullNumOffset:flatbuffers.Offset, pifOffset:flatbuffers.Offset, sconumOffset:flatbuffers.Offset, ntdsOffset:flatbuffers.Offset, disIdOffset:flatbuffers.Offset, midbCatOffset:flatbuffers.Offset, beNumberOffset:flatbuffers.Offset, oSuffixOffset:flatbuffers.Offset, pinOffset:flatbuffers.Offset, lostTrkInd:boolean, muidSrcTrkOffset:flatbuffers.Offset, muidSrcOffset:flatbuffers.Offset, mslStatusOffset:flatbuffers.Offset, trkConf:number, trkQual:number, alertOffset:flatbuffers.Offset, origXrefOffset:flatbuffers.Offset, elnot1Offset:flatbuffers.Offset, elnot2Offset:flatbuffers.Offset, objIdent:TrackDetails_Ingest_objIdent_Enum, objTypeOffset:flatbuffers.Offset, objPlatOffset:flatbuffers.Offset, objActOffset:flatbuffers.Offset, objNatOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, shortNameOffset:flatbuffers.Offset, trkIdOffset:flatbuffers.Offset, trkNumOffset:flatbuffers.Offset, trkScopeOffset:flatbuffers.Offset, sourceUidOffset:flatbuffers.Offset, callSignOffset:flatbuffers.Offset, identAmpOffset:flatbuffers.Offset, spaceAmpOffset:flatbuffers.Offset, spaceAmpConf:number, spaceSpecTypeOffset:flatbuffers.Offset, acftSubTypeOffset:flatbuffers.Offset, tsOffset:flatbuffers.Offset, launchTimeOffset:flatbuffers.Offset, impactTimeOffset:flatbuffers.Offset, ftnMsgTsOffset:flatbuffers.Offset, ftnOffset:flatbuffers.Offset, ftnCmdOffset:flatbuffers.Offset, rtnMsgTsOffset:flatbuffers.Offset, rtnOffset:flatbuffers.Offset, rtnTrkStateOffset:flatbuffers.Offset, rtnCmdOffset:flatbuffers.Offset, senOffset:flatbuffers.Offset, rptChxrefOffset:flatbuffers.Offset, rptArchived:boolean, selfReport:boolean, mil2525BstrOffset:flatbuffers.Offset, trnspdrIdOffset:flatbuffers.Offset, trnspdrTypeOffset:flatbuffers.Offset, emitterNameOffset:flatbuffers.Offset, infoSourceOffset:flatbuffers.Offset, boosting:boolean, freq:number, maxFreq:number, harmonicsOffset:flatbuffers.Offset, pri:number, prf:number, pw:number, scanTypeOffset:flatbuffers.Offset, scanRate:number, scn:number, cIOffset:flatbuffers.Offset, angElev:number, lat:number, lon:number, launchLat:number, launchLon:number, impactLat:number, impactLon:number, polarSingLocLat:number, polarSingLocLon:number, azCorrCenterLine:number, azCorrArcWidth:number, errSemiIntAxis:number, errAreaOrient:number, errSemiMajElev:number, errGeoAreaSwitchOffset:flatbuffers.Offset, burnoutAlt:number, tesEventIdOffset:flatbuffers.Offset, spd:number, avgSpd:number, tol:number, alt:number, hdng:number, course:number, propRpm:number, tpk:number, coopLocIndOffset:flatbuffers.Offset, maneuverIndOffset:flatbuffers.Offset, launchAouTypeOffset:flatbuffers.Offset, launchAouDataOffset:flatbuffers.Offset, impactAouTypeOffset:flatbuffers.Offset, impactAouDataOffset:flatbuffers.Offset, aouRptTypeOffset:flatbuffers.Offset, aouRptDataOffset:flatbuffers.Offset, ecefPosOffset:flatbuffers.Offset, ecefVelOffset:flatbuffers.Offset, containment:number, cpa:number, tcpaOffset:flatbuffers.Offset, navStatusOffset:flatbuffers.Offset, posDeviceTypeOffset:flatbuffers.Offset, atonOffset:flatbuffers.Offset, offPosIndOffset:flatbuffers.Offset, antennaRefDimensionsOffset:flatbuffers.Offset, shipClassOffset:flatbuffers.Offset, imon:number, mmsi:number, draught:number, length:number, width:number, cargoTypeOffset:flatbuffers.Offset, appGrpOffset:flatbuffers.Offset, hullProfOffset:flatbuffers.Offset, propTypeOffset:flatbuffers.Offset, numBlades:number, numShafts:number, sternTypeOffset:flatbuffers.Offset, vslWt:number, arrTimeOffset:flatbuffers.Offset, arrFlagOffset:flatbuffers.Offset, arrCargoOffset:flatbuffers.Offset, arrPortOffset:flatbuffers.Offset, depPortOffset:flatbuffers.Offset, depFlagOffset:flatbuffers.Offset, depCargoOffset:flatbuffers.Offset, desFlagOffset:flatbuffers.Offset, desCargoOffset:flatbuffers.Offset, destinationOffset:flatbuffers.Offset, etaOffset:flatbuffers.Offset, etdOffset:flatbuffers.Offset, iffOffset:flatbuffers.Offset, emgInd:boolean, dropPtInd:boolean, reinforced:boolean, reduced:boolean, hq:boolean, dummy:boolean, taskForce:boolean, feint:boolean, installation:boolean, staffCmtsOffset:flatbuffers.Offset, addInfoOffset:flatbuffers.Offset, evalRatingOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:TrackDetails_Ingest_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  TrackDetails_Ingest.startTrackDetails_Ingest(builder);
  TrackDetails_Ingest.addId(builder, idOffset);
  TrackDetails_Ingest.addClassificationMarking(builder, classificationMarkingOffset);
  TrackDetails_Ingest.addEnv(builder, env);
  TrackDetails_Ingest.addMsgType(builder, msgTypeOffset);
  TrackDetails_Ingest.addHullNum(builder, hullNumOffset);
  TrackDetails_Ingest.addPif(builder, pifOffset);
  TrackDetails_Ingest.addSconum(builder, sconumOffset);
  TrackDetails_Ingest.addNtds(builder, ntdsOffset);
  TrackDetails_Ingest.addDisId(builder, disIdOffset);
  TrackDetails_Ingest.addMidbCat(builder, midbCatOffset);
  TrackDetails_Ingest.addBeNumber(builder, beNumberOffset);
  TrackDetails_Ingest.addOSuffix(builder, oSuffixOffset);
  TrackDetails_Ingest.addPin(builder, pinOffset);
  TrackDetails_Ingest.addLostTrkInd(builder, lostTrkInd);
  TrackDetails_Ingest.addMuidSrcTrk(builder, muidSrcTrkOffset);
  TrackDetails_Ingest.addMuidSrc(builder, muidSrcOffset);
  TrackDetails_Ingest.addMslStatus(builder, mslStatusOffset);
  TrackDetails_Ingest.addTrkConf(builder, trkConf);
  TrackDetails_Ingest.addTrkQual(builder, trkQual);
  TrackDetails_Ingest.addAlert(builder, alertOffset);
  TrackDetails_Ingest.addOrigXref(builder, origXrefOffset);
  TrackDetails_Ingest.addElnot1(builder, elnot1Offset);
  TrackDetails_Ingest.addElnot2(builder, elnot2Offset);
  TrackDetails_Ingest.addObjIdent(builder, objIdent);
  TrackDetails_Ingest.addObjType(builder, objTypeOffset);
  TrackDetails_Ingest.addObjPlat(builder, objPlatOffset);
  TrackDetails_Ingest.addObjAct(builder, objActOffset);
  TrackDetails_Ingest.addObjNat(builder, objNatOffset);
  TrackDetails_Ingest.addName(builder, nameOffset);
  TrackDetails_Ingest.addShortName(builder, shortNameOffset);
  TrackDetails_Ingest.addTrkId(builder, trkIdOffset);
  TrackDetails_Ingest.addTrkNum(builder, trkNumOffset);
  TrackDetails_Ingest.addTrkScope(builder, trkScopeOffset);
  TrackDetails_Ingest.addSourceUid(builder, sourceUidOffset);
  TrackDetails_Ingest.addCallSign(builder, callSignOffset);
  TrackDetails_Ingest.addIdentAmp(builder, identAmpOffset);
  TrackDetails_Ingest.addSpaceAmp(builder, spaceAmpOffset);
  TrackDetails_Ingest.addSpaceAmpConf(builder, spaceAmpConf);
  TrackDetails_Ingest.addSpaceSpecType(builder, spaceSpecTypeOffset);
  TrackDetails_Ingest.addAcftSubType(builder, acftSubTypeOffset);
  TrackDetails_Ingest.addTs(builder, tsOffset);
  TrackDetails_Ingest.addLaunchTime(builder, launchTimeOffset);
  TrackDetails_Ingest.addImpactTime(builder, impactTimeOffset);
  TrackDetails_Ingest.addFtnMsgTs(builder, ftnMsgTsOffset);
  TrackDetails_Ingest.addFtn(builder, ftnOffset);
  TrackDetails_Ingest.addFtnCmd(builder, ftnCmdOffset);
  TrackDetails_Ingest.addRtnMsgTs(builder, rtnMsgTsOffset);
  TrackDetails_Ingest.addRtn(builder, rtnOffset);
  TrackDetails_Ingest.addRtnTrkState(builder, rtnTrkStateOffset);
  TrackDetails_Ingest.addRtnCmd(builder, rtnCmdOffset);
  TrackDetails_Ingest.addSen(builder, senOffset);
  TrackDetails_Ingest.addRptChxref(builder, rptChxrefOffset);
  TrackDetails_Ingest.addRptArchived(builder, rptArchived);
  TrackDetails_Ingest.addSelfReport(builder, selfReport);
  TrackDetails_Ingest.addMil2525Bstr(builder, mil2525BstrOffset);
  TrackDetails_Ingest.addTrnspdrId(builder, trnspdrIdOffset);
  TrackDetails_Ingest.addTrnspdrType(builder, trnspdrTypeOffset);
  TrackDetails_Ingest.addEmitterName(builder, emitterNameOffset);
  TrackDetails_Ingest.addInfoSource(builder, infoSourceOffset);
  TrackDetails_Ingest.addBoosting(builder, boosting);
  TrackDetails_Ingest.addFreq(builder, freq);
  TrackDetails_Ingest.addMaxFreq(builder, maxFreq);
  TrackDetails_Ingest.addHarmonics(builder, harmonicsOffset);
  TrackDetails_Ingest.addPri(builder, pri);
  TrackDetails_Ingest.addPrf(builder, prf);
  TrackDetails_Ingest.addPw(builder, pw);
  TrackDetails_Ingest.addScanType(builder, scanTypeOffset);
  TrackDetails_Ingest.addScanRate(builder, scanRate);
  TrackDetails_Ingest.addScn(builder, scn);
  TrackDetails_Ingest.addCI(builder, cIOffset);
  TrackDetails_Ingest.addAngElev(builder, angElev);
  TrackDetails_Ingest.addLat(builder, lat);
  TrackDetails_Ingest.addLon(builder, lon);
  TrackDetails_Ingest.addLaunchLat(builder, launchLat);
  TrackDetails_Ingest.addLaunchLon(builder, launchLon);
  TrackDetails_Ingest.addImpactLat(builder, impactLat);
  TrackDetails_Ingest.addImpactLon(builder, impactLon);
  TrackDetails_Ingest.addPolarSingLocLat(builder, polarSingLocLat);
  TrackDetails_Ingest.addPolarSingLocLon(builder, polarSingLocLon);
  TrackDetails_Ingest.addAzCorrCenterLine(builder, azCorrCenterLine);
  TrackDetails_Ingest.addAzCorrArcWidth(builder, azCorrArcWidth);
  TrackDetails_Ingest.addErrSemiIntAxis(builder, errSemiIntAxis);
  TrackDetails_Ingest.addErrAreaOrient(builder, errAreaOrient);
  TrackDetails_Ingest.addErrSemiMajElev(builder, errSemiMajElev);
  TrackDetails_Ingest.addErrGeoAreaSwitch(builder, errGeoAreaSwitchOffset);
  TrackDetails_Ingest.addBurnoutAlt(builder, burnoutAlt);
  TrackDetails_Ingest.addTesEventId(builder, tesEventIdOffset);
  TrackDetails_Ingest.addSpd(builder, spd);
  TrackDetails_Ingest.addAvgSpd(builder, avgSpd);
  TrackDetails_Ingest.addTol(builder, tol);
  TrackDetails_Ingest.addAlt(builder, alt);
  TrackDetails_Ingest.addHdng(builder, hdng);
  TrackDetails_Ingest.addCourse(builder, course);
  TrackDetails_Ingest.addPropRpm(builder, propRpm);
  TrackDetails_Ingest.addTpk(builder, tpk);
  TrackDetails_Ingest.addCoopLocInd(builder, coopLocIndOffset);
  TrackDetails_Ingest.addManeuverInd(builder, maneuverIndOffset);
  TrackDetails_Ingest.addLaunchAouType(builder, launchAouTypeOffset);
  TrackDetails_Ingest.addLaunchAouData(builder, launchAouDataOffset);
  TrackDetails_Ingest.addImpactAouType(builder, impactAouTypeOffset);
  TrackDetails_Ingest.addImpactAouData(builder, impactAouDataOffset);
  TrackDetails_Ingest.addAouRptType(builder, aouRptTypeOffset);
  TrackDetails_Ingest.addAouRptData(builder, aouRptDataOffset);
  TrackDetails_Ingest.addEcefPos(builder, ecefPosOffset);
  TrackDetails_Ingest.addEcefVel(builder, ecefVelOffset);
  TrackDetails_Ingest.addContainment(builder, containment);
  TrackDetails_Ingest.addCpa(builder, cpa);
  TrackDetails_Ingest.addTcpa(builder, tcpaOffset);
  TrackDetails_Ingest.addNavStatus(builder, navStatusOffset);
  TrackDetails_Ingest.addPosDeviceType(builder, posDeviceTypeOffset);
  TrackDetails_Ingest.addAton(builder, atonOffset);
  TrackDetails_Ingest.addOffPosInd(builder, offPosIndOffset);
  TrackDetails_Ingest.addAntennaRefDimensions(builder, antennaRefDimensionsOffset);
  TrackDetails_Ingest.addShipClass(builder, shipClassOffset);
  TrackDetails_Ingest.addImon(builder, imon);
  TrackDetails_Ingest.addMmsi(builder, mmsi);
  TrackDetails_Ingest.addDraught(builder, draught);
  TrackDetails_Ingest.addLength(builder, length);
  TrackDetails_Ingest.addWidth(builder, width);
  TrackDetails_Ingest.addCargoType(builder, cargoTypeOffset);
  TrackDetails_Ingest.addAppGrp(builder, appGrpOffset);
  TrackDetails_Ingest.addHullProf(builder, hullProfOffset);
  TrackDetails_Ingest.addPropType(builder, propTypeOffset);
  TrackDetails_Ingest.addNumBlades(builder, numBlades);
  TrackDetails_Ingest.addNumShafts(builder, numShafts);
  TrackDetails_Ingest.addSternType(builder, sternTypeOffset);
  TrackDetails_Ingest.addVslWt(builder, vslWt);
  TrackDetails_Ingest.addArrTime(builder, arrTimeOffset);
  TrackDetails_Ingest.addArrFlag(builder, arrFlagOffset);
  TrackDetails_Ingest.addArrCargo(builder, arrCargoOffset);
  TrackDetails_Ingest.addArrPort(builder, arrPortOffset);
  TrackDetails_Ingest.addDepPort(builder, depPortOffset);
  TrackDetails_Ingest.addDepFlag(builder, depFlagOffset);
  TrackDetails_Ingest.addDepCargo(builder, depCargoOffset);
  TrackDetails_Ingest.addDesFlag(builder, desFlagOffset);
  TrackDetails_Ingest.addDesCargo(builder, desCargoOffset);
  TrackDetails_Ingest.addDestination(builder, destinationOffset);
  TrackDetails_Ingest.addEta(builder, etaOffset);
  TrackDetails_Ingest.addEtd(builder, etdOffset);
  TrackDetails_Ingest.addIff(builder, iffOffset);
  TrackDetails_Ingest.addEmgInd(builder, emgInd);
  TrackDetails_Ingest.addDropPtInd(builder, dropPtInd);
  TrackDetails_Ingest.addReinforced(builder, reinforced);
  TrackDetails_Ingest.addReduced(builder, reduced);
  TrackDetails_Ingest.addHq(builder, hq);
  TrackDetails_Ingest.addDummy(builder, dummy);
  TrackDetails_Ingest.addTaskForce(builder, taskForce);
  TrackDetails_Ingest.addFeint(builder, feint);
  TrackDetails_Ingest.addInstallation(builder, installation);
  TrackDetails_Ingest.addStaffCmts(builder, staffCmtsOffset);
  TrackDetails_Ingest.addAddInfo(builder, addInfoOffset);
  TrackDetails_Ingest.addEvalRating(builder, evalRatingOffset);
  TrackDetails_Ingest.addCreatedAt(builder, createdAtOffset);
  TrackDetails_Ingest.addCreatedBy(builder, createdByOffset);
  TrackDetails_Ingest.addSource(builder, sourceOffset);
  TrackDetails_Ingest.addOrigin(builder, originOffset);
  TrackDetails_Ingest.addDataMode(builder, dataMode);
  TrackDetails_Ingest.addOrigNetwork(builder, origNetworkOffset);
  return TrackDetails_Ingest.endTrackDetails_Ingest(builder);
}

unpack(): TrackDetails_IngestT {
  return new TrackDetails_IngestT(
    this.id(),
...
unpackTo(_o: TrackDetails_IngestT): void {
  _o.id = this.id();
...
export class TrackDetails_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  public id: string|Uint8Array|null = null,
  public classificationMarking: string|Uint8Array|null = null,
  public env: TrackDetails_Ingest_env_Enum = TrackDetails_Ingest_env_Enum.AIR,
  ...
  public objIdent: TrackDetails_Ingest_objIdent_Enum = TrackDetails_Ingest_objIdent_Enum.ASSUMED_FRIEND,
  ...
  public dataMode: TrackDetails_Ingest_dataMode_Enum = TrackDetails_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const rtnMsgTs = TrackDetails_Ingest.createRtnMsgTsVector(builder, builder.createObjectOffsetList(this.rtnMsgTs));
  const rtn = TrackDetails_Ingest.createRtnVector(builder, builder.createObjectOffsetList(this.rtn));
  ...
  const launchAouData = TrackDetails_Ingest.createLaunchAouDataVector(builder, builder.createObjectOffsetList(this.launchAouData));
  const impactAouType = (this.impactAouType !== null ? builder.createString(this.impactAouType!) : 0);
  const impactAouData = TrackDetails_Ingest.createImpactAouDataVector(builder, builder.createObjectOffsetList(this.impactAouData));
  const aouRptType = (this.aouRptType !== null ? builder.createString(this.aouRptType!) : 0);
  const aouRptData = TrackDetails_Ingest.createAouRptDataVector(builder, builder.createObjectOffsetList(this.aouRptData));
  const ecefPos = TrackDetails_Ingest.createEcefPosVector(builder, builder.createObjectOffsetList(this.ecefPos));
  const ecefVel = TrackDetails_Ingest.createEcefVelVector(builder, builder.createObjectOffsetList(this.ecefVel));
  ...
  const antennaRefDimensions = TrackDetails_Ingest.createAntennaRefDimensionsVector(builder, builder.createObjectOffsetList(this.antennaRefDimensions));
  ...
  return TrackDetails_Ingest.createTrackDetails_Ingest(builder,
    id,
