...
import { RFBandType_Ingest_dataMode_Enum } from './rfband-type-ingest-data-mode-enum.js';


/**
 * /// This table contains descriptions for common satellite RF bands.
 */
export class RFBandType_Ingest implements flatbuffers.IUnpackableObject<RFBandType_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):RFBandType_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsRFBandType_Ingest(bb:flatbuffers.ByteBuffer, obj?:RFBandType_Ingest):RFBandType_Ingest {
  return (obj || new RFBandType_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRFBandType_Ingest(bb:flatbuffers.ByteBuffer, obj?:RFBandType_Ingest):RFBandType_Ingest {
 ...
 */
dataMode():RFBandType_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 18);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFBandType_Ingest_dataMode_Enum.REAL;
}
...
static startRFBandType_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:RFBandType_Ingest_dataMode_Enum) {
  builder.addFieldInt8(7, dataMode, RFBandType_Ingest_dataMode_Enum.REAL);
}
...
static endRFBandType_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishRFBandType_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'RFBA');
}

static finishSizePrefixedRFBandType_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'RFBA', true);
}

static createRFBandType_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, descriptionOffset:flatbuffers.Offset, startFreq:number, endFreq:number, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:RFBandType_Ingest_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset):flatbuffers.Offset {
  RFBandType_Ingest.startRFBandType_Ingest(builder);
...
unpack(): RFBandType_IngestT {
  return new RFBandType_IngestT(
    this.id(),
...
unpackTo(_o: RFBandType_IngestT): void {
  _o.id = this.id();
...
export class RFBandType_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: RFBandType_Ingest_dataMode_Enum = RFBandType_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return RFBandType_Ingest.createRFBandType_Ingest(builder,
    id,
