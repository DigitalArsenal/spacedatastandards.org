 ...
 */
export class ISRCollectionRequirements_Ingest implements flatbuffers.IUnpackableObject<ISRCollectionRequirements_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ISRCollectionRequirements_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsISRCollectionRequirements_Ingest(bb:flatbuffers.ByteBuffer, obj?:ISRCollectionRequirements_Ingest):ISRCollectionRequirements_Ingest {
  return (obj || new ISRCollectionRequirements_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsISRCollectionRequirements_Ingest(bb:flatbuffers.ByteBuffer, obj?:ISRCollectionRequirements_Ingest):ISRCollectionRequirements_Ingest {
...
static startISRCollectionRequirements_Ingest(builder:flatbuffers.Builder) {
...
static endISRCollectionRequirements_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishISRCollectionRequirements_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ISRC');
}

static finishSizePrefixedISRCollectionRequirements_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ISRC', true);
}

static createISRCollectionRequirements_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, hashOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, cridNumbersOffset:flatbuffers.Offset, priority:number, recordIdOffset:flatbuffers.Offset, reconSurveyOffset:flatbuffers.Offset, intelDisciplineOffset:flatbuffers.Offset, secondary:boolean, emphasized:boolean, isPrismCr:boolean, startOffset:flatbuffers.Offset, stopOffset:flatbuffers.Offset, operationOffset:flatbuffers.Offset, supportedUnitOffset:flatbuffers.Offset, countryOffset:flatbuffers.Offset, regionOffset:flatbuffers.Offset, subregionOffset:flatbuffers.Offset, specialComGuidanceOffset:flatbuffers.Offset, criticalTimesOffset:flatbuffers.Offset, exploitationRequirementOffset:flatbuffers.Offset, targetListOffset:flatbuffers.Offset):flatbuffers.Offset {
  ISRCollectionRequirements_Ingest.startISRCollectionRequirements_Ingest(builder);
...
unpack(): ISRCollectionRequirements_IngestT {
  return new ISRCollectionRequirements_IngestT(
    this.id(),
    this.hash(),
    this.type(),
    this.cridNumbers(),
...
unpackTo(_o: ISRCollectionRequirements_IngestT): void {
  _o.id = this.id();
  _o.hash = this.hash();
  _o.type = this.type();
...
export class ISRCollectionRequirements_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const targetList = ISRCollectionRequirements_Ingest.createTargetListVector(builder, builder.createObjectOffsetList(this.targetList));

  return ISRCollectionRequirements_Ingest.createISRCollectionRequirements_Ingest(builder,
    id,
    hash,
    type,
    cridNumbers,
