...
import { OnorbitDetails_Abridged_dataMode_Enum } from './onorbit-details-abridged-data-mode-enum.js';


/**
 * /// Contains details of the OnOrbit object.
 */
export class OnorbitDetails_Abridged implements flatbuffers.IUnpackableObject<OnorbitDetails_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OnorbitDetails_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOnorbitDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:OnorbitDetails_Abridged):OnorbitDetails_Abridged {
  return (obj || new OnorbitDetails_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOnorbitDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:OnorbitDetails_Abridged):OnorbitDetails_Abridged {
 ...
 */
dataMode():OnorbitDetails_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 92);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OnorbitDetails_Abridged_dataMode_Enum.REAL;
}
...
static startOnorbitDetails_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:OnorbitDetails_Abridged_dataMode_Enum) {
  builder.addFieldInt8(44, dataMode, OnorbitDetails_Abridged_dataMode_Enum.REAL);
}
...
unpack(): OnorbitDetails_AbridgedT {
  return new OnorbitDetails_AbridgedT(
    this.id(),
    this.idOnOrbit(),
    ...
    this.numMission(),
    this.bb!.createScalarList<string>(this.missionTypes.bind(this), this.missionTypes_Length()),
    this.busType(),
    this.geoSlot(),
    this.driftRate(),
    this.dryMass(),
    ...
    this.adeptRadius(),
    this.numDeployable(),
    this.bb!.createScalarList<string>(this.depNames.bind(this), this.depNames_Length()),
    this.bb!.createScalarList<string>(this.depEstMasses.bind(this), this.depEstMasses_Length()),
    this.bb!.createScalarList<string>(this.depMassUncs.bind(this), this.depMassUncs_Length()),
    this.source(),
    this.origin(),
    this.lastObSource(),
    this.dataMode(),
...
unpackTo(_o: OnorbitDetails_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.missionTypes = this.bb!.createScalarList<string>(this.missionTypes.bind(this), this.missionTypes_Length());
  ...
  _o.depNames = this.bb!.createScalarList<string>(this.depNames.bind(this), this.depNames_Length());
  _o.depEstMasses = this.bb!.createScalarList<string>(this.depEstMasses.bind(this), this.depEstMasses_Length());
  _o.depMassUncs = this.bb!.createScalarList<string>(this.depMassUncs.bind(this), this.depMassUncs_Length());
...
export class OnorbitDetails_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: OnorbitDetails_Abridged_dataMode_Enum = OnorbitDetails_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const missionTypes = OnorbitDetails_Abridged.createMissionTypesVector(builder, builder.createObjectOffsetList(this.missionTypes));
  const busType = (this.busType !== null ? builder.createString(this.busType!) : 0);
  const depNames = OnorbitDetails_Abridged.createDepNamesVector(builder, builder.createObjectOffsetList(this.depNames));
  const depEstMasses = OnorbitDetails_Abridged.createDepEstMassesVector(builder, builder.createObjectOffsetList(this.depEstMasses));
  const depMassUncs = OnorbitDetails_Abridged.createDepMassUncsVector(builder, builder.createObjectOffsetList(this.depMassUncs));
  ...
  return OnorbitDetails_Abridged.createOnorbitDetails_Abridged(builder,
    id,
    idOnOrbit,
