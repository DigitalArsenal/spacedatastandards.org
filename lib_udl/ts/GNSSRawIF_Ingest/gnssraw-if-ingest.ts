...
import { GNSSRawIF_Ingest_dataMode_Enum } from './gnssraw-if-ingest-data-mode-enum.js';
 ...
 */
export class GNSSRawIF_Ingest implements flatbuffers.IUnpackableObject<GNSSRawIF_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):GNSSRawIF_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsGNSSRawIF_Ingest(bb:flatbuffers.ByteBuffer, obj?:GNSSRawIF_Ingest):GNSSRawIF_Ingest {
  return (obj || new GNSSRawIF_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsGNSSRawIF_Ingest(bb:flatbuffers.ByteBuffer, obj?:GNSSRawIF_Ingest):GNSSRawIF_Ingest {
 ...
 */
dataMode():GNSSRawIF_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 80);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : GNSSRawIF_Ingest_dataMode_Enum.REAL;
}
...
static startGNSSRawIF_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:GNSSRawIF_Ingest_dataMode_Enum) {
  builder.addFieldInt8(38, dataMode, GNSSRawIF_Ingest_dataMode_Enum.REAL);
}
...
unpack(): GNSSRawIF_IngestT {
  return new GNSSRawIF_IngestT(
    this.id(),
...
unpackTo(_o: GNSSRawIF_IngestT): void {
  _o.id = this.id();
...
export class GNSSRawIF_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: GNSSRawIF_Ingest_dataMode_Enum = GNSSRawIF_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const boresight = GNSSRawIF_Ingest.createBoresightVector(builder, builder.createObjectOffsetList(this.boresight));
  const quat = GNSSRawIF_Ingest.createQuatVector(builder, builder.createObjectOffsetList(this.quat));
  ...
  const centerFreq = GNSSRawIF_Ingest.createCenterFreqVector(builder, builder.createObjectOffsetList(this.centerFreq));
  const ifFreq = GNSSRawIF_Ingest.createIfFreqVector(builder, builder.createObjectOffsetList(this.ifFreq));
  const sampleRate = GNSSRawIF_Ingest.createSampleRateVector(builder, builder.createObjectOffsetList(this.sampleRate));
  const postFourier = GNSSRawIF_Ingest.createPostFourierVector(builder, builder.createObjectOffsetList(this.postFourier));
  const sampleType = (this.sampleType !== null ? builder.createString(this.sampleType!) : 0);
  const diffCodeBias = GNSSRawIF_Ingest.createDiffCodeBiasVector(builder, builder.createObjectOffsetList(this.diffCodeBias));
  ...
  const srcTyps = GNSSRawIF_Ingest.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = GNSSRawIF_Ingest.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  const tags = GNSSRawIF_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return GNSSRawIF_Ingest.createGNSSRawIF_Ingest(builder,
    id,
