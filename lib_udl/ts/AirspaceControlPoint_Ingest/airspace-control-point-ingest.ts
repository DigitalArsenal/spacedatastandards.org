 ...
 */
export class AirspaceControlPoint_Ingest implements flatbuffers.IUnpackableObject<AirspaceControlPoint_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirspaceControlPoint_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirspaceControlPoint_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirspaceControlPoint_Ingest):AirspaceControlPoint_Ingest {
  return (obj || new AirspaceControlPoint_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirspaceControlPoint_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirspaceControlPoint_Ingest):AirspaceControlPoint_Ingest {
...
static startAirspaceControlPoint_Ingest(builder:flatbuffers.Builder) {
...
static endAirspaceControlPoint_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirspaceControlPoint_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRS');
}

static finishSizePrefixedAirspaceControlPoint_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRS', true);
}

static createAirspaceControlPoint_Ingest(builder:flatbuffers.Builder, ctrlPtTypeOffset:flatbuffers.Offset, ctrlPtNameOffset:flatbuffers.Offset, ctrlPtLocationOffset:flatbuffers.Offset, ctrlPtAltitudeOffset:flatbuffers.Offset):flatbuffers.Offset {
  AirspaceControlPoint_Ingest.startAirspaceControlPoint_Ingest(builder);
...
unpack(): AirspaceControlPoint_IngestT {
  return new AirspaceControlPoint_IngestT(
    this.ctrlPtType(),
    this.ctrlPtName(),
    this.ctrlPtLocation(),
    this.ctrlPtAltitude()
...
unpackTo(_o: AirspaceControlPoint_IngestT): void {
...
export class AirspaceControlPoint_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AirspaceControlPoint_Ingest.createAirspaceControlPoint_Ingest(builder,
    ctrlPtType,
    ctrlPtName,
    ctrlPtLocation,
    ctrlPtAltitude
