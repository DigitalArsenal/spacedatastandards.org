...
import { RFGeoLocation_Ingest_dataMode_Enum } from './rfgeo-location-ingest-data-mode-enum.js';


/**
 * /// Model representation of geolocation data for a radio frequency (RF) signal or emitter.
 */
export class RFGeoLocation_Ingest implements flatbuffers.IUnpackableObject<RFGeoLocation_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):RFGeoLocation_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsRFGeoLocation_Ingest(bb:flatbuffers.ByteBuffer, obj?:RFGeoLocation_Ingest):RFGeoLocation_Ingest {
  return (obj || new RFGeoLocation_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRFGeoLocation_Ingest(bb:flatbuffers.ByteBuffer, obj?:RFGeoLocation_Ingest):RFGeoLocation_Ingest {
 ...
 */
dataMode():RFGeoLocation_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 86);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFGeoLocation_Ingest_dataMode_Enum.REAL;
}

static startRFGeoLocation_Ingest(builder:flatbuffers.Builder) {
...
unpack(): RFGeoLocation_IngestT {
  return new RFGeoLocation_IngestT(
    this.id(),
...
unpackTo(_o: RFGeoLocation_IngestT): void {
  _o.id = this.id();
...
export class RFGeoLocation_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: RFGeoLocation_Ingest_dataMode_Enum = RFGeoLocation_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = RFGeoLocation_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return RFGeoLocation_Ingest.createRFGeoLocation_Ingest(builder,
    id,
