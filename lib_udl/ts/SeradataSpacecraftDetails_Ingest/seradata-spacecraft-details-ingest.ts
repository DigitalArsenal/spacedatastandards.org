...
import { SeradataSpacecraftDetails_Ingest_dataMode_Enum } from './seradata-spacecraft-details-ingest-data-mode-enum.js';


/**
 * /// On-orbit spacecraft details compiled by Seradata for a particular satellite.
 */
export class SeradataSpacecraftDetails_Ingest implements flatbuffers.IUnpackableObject<SeradataSpacecraftDetails_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SeradataSpacecraftDetails_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSeradataSpacecraftDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:SeradataSpacecraftDetails_Ingest):SeradataSpacecraftDetails_Ingest {
  return (obj || new SeradataSpacecraftDetails_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSeradataSpacecraftDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:SeradataSpacecraftDetails_Ingest):SeradataSpacecraftDetails_Ingest {
...
dataMode():SeradataSpacecraftDetails_Ingest_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SeradataSpacecraftDetails_Ingest_dataMode_Enum.REAL;
}
...
static startSeradataSpacecraftDetails_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SeradataSpacecraftDetails_Ingest_dataMode_Enum) {
  builder.addFieldInt8(92, dataMode, SeradataSpacecraftDetails_Ingest_dataMode_Enum.REAL);
}
...
unpack(): SeradataSpacecraftDetails_IngestT {
  return new SeradataSpacecraftDetails_IngestT(
    this.id(),
    this.idOnOrbit(),
...
unpackTo(_o: SeradataSpacecraftDetails_IngestT): void {
  _o.id = this.id();
...
export class SeradataSpacecraftDetails_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SeradataSpacecraftDetails_Ingest_dataMode_Enum = SeradataSpacecraftDetails_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SeradataSpacecraftDetails_Ingest.createSeradataSpacecraftDetails_Ingest(builder,
    id,
    idOnOrbit,
