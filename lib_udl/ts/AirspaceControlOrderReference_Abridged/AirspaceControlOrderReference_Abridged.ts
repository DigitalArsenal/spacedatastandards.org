 ...
 */
export class AirspaceControlOrderReference_Abridged implements flatbuffers.IUnpackableObject<AirspaceControlOrderReference_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirspaceControlOrderReference_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirspaceControlOrderReference_Abridged(bb:flatbuffers.ByteBuffer, obj?:AirspaceControlOrderReference_Abridged):AirspaceControlOrderReference_Abridged {
  return (obj || new AirspaceControlOrderReference_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirspaceControlOrderReference_Abridged(bb:flatbuffers.ByteBuffer, obj?:AirspaceControlOrderReference_Abridged):AirspaceControlOrderReference_Abridged {
...
static startAirspaceControlOrderReference_Abridged(builder:flatbuffers.Builder) {
...
static endAirspaceControlOrderReference_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirspaceControlOrderReference_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRS');
}

static finishSizePrefixedAirspaceControlOrderReference_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRS', true);
}

static createAirspaceControlOrderReference_Abridged(builder:flatbuffers.Builder, refSidOffset:flatbuffers.Offset, refTypeOffset:flatbuffers.Offset, refOriginatorOffset:flatbuffers.Offset, refTsOffset:flatbuffers.Offset, refSerialNumOffset:flatbuffers.Offset, refSpecialNotationOffset:flatbuffers.Offset, refSicsOffset:flatbuffers.Offset):flatbuffers.Offset {
  AirspaceControlOrderReference_Abridged.startAirspaceControlOrderReference_Abridged(builder);
...
unpack(): AirspaceControlOrderReference_AbridgedT {
  return new AirspaceControlOrderReference_AbridgedT(
    this.refSid(),
    this.refType(),
    this.refOriginator(),
    this.refTs(),
...
unpackTo(_o: AirspaceControlOrderReference_AbridgedT): void {
...
export class AirspaceControlOrderReference_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const refSics = AirspaceControlOrderReference_Abridged.createRefSicsVector(builder, builder.createObjectOffsetList(this.refSics));

  return AirspaceControlOrderReference_Abridged.createAirspaceControlOrderReference_Abridged(builder,
    refSid,
    refType,
    refOriginator,
    refTs,
