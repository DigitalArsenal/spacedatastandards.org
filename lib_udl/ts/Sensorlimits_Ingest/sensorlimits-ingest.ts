...
import { Sensorlimits_Ingest_dataMode_Enum } from './sensorlimits-ingest-data-mode-enum.js';


/**
 * /// Sensorlimits define 0 to many limits of a particular sensor in terms of observation coverage of on-orbit objects.
 */
export class Sensorlimits_Ingest implements flatbuffers.IUnpackableObject<Sensorlimits_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Sensorlimits_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSensorlimits_Ingest(bb:flatbuffers.ByteBuffer, obj?:Sensorlimits_Ingest):Sensorlimits_Ingest {
  return (obj || new Sensorlimits_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSensorlimits_Ingest(bb:flatbuffers.ByteBuffer, obj?:Sensorlimits_Ingest):Sensorlimits_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Sensorlimits_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 28);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Sensorlimits_Ingest_dataMode_Enum.REAL;
}
...
static startSensorlimits_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Sensorlimits_Ingest_dataMode_Enum) {
  builder.addFieldInt8(12, dataMode, Sensorlimits_Ingest_dataMode_Enum.REAL);
}
...
static endSensorlimits_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSensorlimits_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SENS');
}

static finishSizePrefixedSensorlimits_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SENS', true);
}

static createSensorlimits_Ingest(builder:flatbuffers.Builder, idSensorLimitsOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, upperLeftAzimuthLimit:number, upperRightAzimuthLimit:number, lowerRightAzimuthLimit:number, lowerLeftAzimuthLimit:number, lowerLeftElevationLimit:number, upperLeftElevationLimit:number, lowerRightElevationLimit:number, upperRightElevationLimit:number, sourceOffset:flatbuffers.Offset, dataMode:Sensorlimits_Ingest_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset):flatbuffers.Offset {
  Sensorlimits_Ingest.startSensorlimits_Ingest(builder);
...
unpack(): Sensorlimits_IngestT {
  return new Sensorlimits_IngestT(
    this.idSensorLimits(),
...
unpackTo(_o: Sensorlimits_IngestT): void {
...
export class Sensorlimits_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Sensorlimits_Ingest_dataMode_Enum = Sensorlimits_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Sensorlimits_Ingest.createSensorlimits_Ingest(builder,
    idSensorLimits,
