...
import { LaunchEvent_Abridged_dataMode_Enum } from './launch-event-abridged-data-mode-enum.js';


/**
 * /// Information on known launch events.
 */
export class LaunchEvent_Abridged implements flatbuffers.IUnpackableObject<LaunchEvent_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LaunchEvent_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLaunchEvent_Abridged(bb:flatbuffers.ByteBuffer, obj?:LaunchEvent_Abridged):LaunchEvent_Abridged {
  return (obj || new LaunchEvent_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLaunchEvent_Abridged(bb:flatbuffers.ByteBuffer, obj?:LaunchEvent_Abridged):LaunchEvent_Abridged {
 ...
 */
dataMode():LaunchEvent_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 38);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : LaunchEvent_Abridged_dataMode_Enum.REAL;
}
...
static startLaunchEvent_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:LaunchEvent_Abridged_dataMode_Enum) {
  builder.addFieldInt8(17, dataMode, LaunchEvent_Abridged_dataMode_Enum.REAL);
}
...
static endLaunchEvent_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishLaunchEvent_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'LAUN');
}

static finishSizePrefixedLaunchEvent_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'LAUN', true);
}

static createLaunchEvent_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, origObjectIdOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, derivedFromOffset:flatbuffers.Offset, declassificationDateOffset:flatbuffers.Offset, declassificationStringOffset:flatbuffers.Offset, msgCreateDateOffset:flatbuffers.Offset, launchFailureCodeOffset:flatbuffers.Offset, launchDateOffset:flatbuffers.Offset, beNumberOffset:flatbuffers.Offset, oSuffixOffset:flatbuffers.Offset, launchFacilityNameOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, dataMode:LaunchEvent_Abridged_dataMode_Enum, origNetworkOffset:flatbuffers.Offset, satNo:number):flatbuffers.Offset {
  LaunchEvent_Abridged.startLaunchEvent_Abridged(builder);
...
unpack(): LaunchEvent_AbridgedT {
  return new LaunchEvent_AbridgedT(
    this.id(),
    this.idOnOrbit(),
    this.origObjectId(),
...
unpackTo(_o: LaunchEvent_AbridgedT): void {
  _o.id = this.id();
...
export class LaunchEvent_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: LaunchEvent_Abridged_dataMode_Enum = LaunchEvent_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return LaunchEvent_Abridged.createLaunchEvent_Abridged(builder,
    id,
    idOnOrbit,
    origObjectId,
