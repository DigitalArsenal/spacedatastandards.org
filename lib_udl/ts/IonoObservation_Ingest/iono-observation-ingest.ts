...
import { IonoObservation_Ingest_antennaElementPositionCoordinateSystem_Enum } from './iono-observation-ingest-antenna-element-position-coordinate-system-enum.js';
import { IonoObservation_Ingest_dataMode_Enum } from './iono-observation-ingest-data-mode-enum.js';
import { IonoObservation_Ingest_receiveSensorType_Enum } from './iono-observation-ingest-receive-sensor-type-enum.js';
import { IonoObservation_Ingest_transmitSensorType_Enum } from './iono-observation-ingest-transmit-sensor-type-enum.js';
 ...
 */
export class IonoObservation_Ingest implements flatbuffers.IUnpackableObject<IonoObservation_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):IonoObservation_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsIonoObservation_Ingest(bb:flatbuffers.ByteBuffer, obj?:IonoObservation_Ingest):IonoObservation_Ingest {
  return (obj || new IonoObservation_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIonoObservation_Ingest(bb:flatbuffers.ByteBuffer, obj?:IonoObservation_Ingest):IonoObservation_Ingest {
...
transmitSensorType():IonoObservation_Ingest_transmitSensorType_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : IonoObservation_Ingest_transmitSensorType_Enum.MOBILE;
}
...
receiveSensorType():IonoObservation_Ingest_receiveSensorType_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : IonoObservation_Ingest_receiveSensorType_Enum.MOBILE;
}
...
antennaElementPositionCoordinateSystem():IonoObservation_Ingest_antennaElementPositionCoordinateSystem_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : IonoObservation_Ingest_antennaElementPositionCoordinateSystem_Enum.J2000;
}
...
dataMode():IonoObservation_Ingest_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : IonoObservation_Ingest_dataMode_Enum.REAL;
}
...
static startIonoObservation_Ingest(builder:flatbuffers.Builder) {
...
static addTransmitSensorType(builder:flatbuffers.Builder, transmitSensorType:IonoObservation_Ingest_transmitSensorType_Enum) {
  builder.addFieldInt8(14, transmitSensorType, IonoObservation_Ingest_transmitSensorType_Enum.MOBILE);
}
...
static addReceiveSensorType(builder:flatbuffers.Builder, receiveSensorType:IonoObservation_Ingest_receiveSensorType_Enum) {
  builder.addFieldInt8(16, receiveSensorType, IonoObservation_Ingest_receiveSensorType_Enum.MOBILE);
}
...
static addAntennaElementPositionCoordinateSystem(builder:flatbuffers.Builder, antennaElementPositionCoordinateSystem:IonoObservation_Ingest_antennaElementPositionCoordinateSystem_Enum) {
  builder.addFieldInt8(18, antennaElementPositionCoordinateSystem, IonoObservation_Ingest_antennaElementPositionCoordinateSystem_Enum.J2000);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:IonoObservation_Ingest_dataMode_Enum) {
  builder.addFieldInt8(106, dataMode, IonoObservation_Ingest_dataMode_Enum.REAL);
}
...
unpack(): IonoObservation_IngestT {
  return new IonoObservation_IngestT(
    this.id(),
...
unpackTo(_o: IonoObservation_IngestT): void {
  _o.id = this.id();
...
export class IonoObservation_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public transmitSensorType: IonoObservation_Ingest_transmitSensorType_Enum = IonoObservation_Ingest_transmitSensorType_Enum.MOBILE,
  public receiveCoordinates: (string)[] = [],
  public receiveSensorType: IonoObservation_Ingest_receiveSensorType_Enum = IonoObservation_Ingest_receiveSensorType_Enum.MOBILE,
  public antennaElementPosition: string|Uint8Array|null = null,
  public antennaElementPositionCoordinateSystem: IonoObservation_Ingest_antennaElementPositionCoordinateSystem_Enum = IonoObservation_Ingest_antennaElementPositionCoordinateSystem_Enum.J2000,
  ...
  public dataMode: IonoObservation_Ingest_dataMode_Enum = IonoObservation_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const transmitCoordinates = IonoObservation_Ingest.createTransmitCoordinatesVector(builder, builder.createObjectOffsetList(this.transmitCoordinates));
  const receiveCoordinates = IonoObservation_Ingest.createReceiveCoordinatesVector(builder, builder.createObjectOffsetList(this.receiveCoordinates));
  ...
  const restrictedFrequency = IonoObservation_Ingest.createRestrictedFrequencyVector(builder, builder.createObjectOffsetList(this.restrictedFrequency));
  ...
  const charAtts = IonoObservation_Ingest.createCharAttsVector(builder, builder.createObjectOffsetList(this.charAtts));
  const height = IonoObservation_Ingest.createHeightVector(builder, builder.createObjectOffsetList(this.height));
  const plasmaFrequency = IonoObservation_Ingest.createPlasmaFrequencyVector(builder, builder.createObjectOffsetList(this.plasmaFrequency));
  const plasmaFrequencyUncertainty = IonoObservation_Ingest.createPlasmaFrequencyUncertaintyVector(builder, builder.createObjectOffsetList(this.plasmaFrequencyUncertainty));
  const electronDensity = IonoObservation_Ingest.createElectronDensityVector(builder, builder.createObjectOffsetList(this.electronDensity));
  const electronDensityUncertainty = IonoObservation_Ingest.createElectronDensityUncertaintyVector(builder, builder.createObjectOffsetList(this.electronDensityUncertainty));
  const artistFlags = IonoObservation_Ingest.createArtistFlagsVector(builder, builder.createObjectOffsetList(this.artistFlags));
  const traceGeneric = (this.traceGeneric !== null ? builder.createString(this.traceGeneric!) : 0);
  const tidPhaseSpeeds = IonoObservation_Ingest.createTidPhaseSpeedsVector(builder, builder.createObjectOffsetList(this.tidPhaseSpeeds));
  const tidAzimuth = IonoObservation_Ingest.createTidAzimuthVector(builder, builder.createObjectOffsetList(this.tidAzimuth));
  const tidPeriods = IonoObservation_Ingest.createTidPeriodsVector(builder, builder.createObjectOffsetList(this.tidPeriods));
  ...
  return IonoObservation_Ingest.createIonoObservation_Ingest(builder,
    id,
