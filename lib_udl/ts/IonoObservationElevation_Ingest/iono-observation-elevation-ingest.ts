 ...
 */
export class IonoObservationElevation_Ingest implements flatbuffers.IUnpackableObject<IonoObservationElevation_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):IonoObservationElevation_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsIonoObservationElevation_Ingest(bb:flatbuffers.ByteBuffer, obj?:IonoObservationElevation_Ingest):IonoObservationElevation_Ingest {
  return (obj || new IonoObservationElevation_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIonoObservationElevation_Ingest(bb:flatbuffers.ByteBuffer, obj?:IonoObservationElevation_Ingest):IonoObservationElevation_Ingest {
...
static startIonoObservationElevation_Ingest(builder:flatbuffers.Builder) {
...
static endIonoObservationElevation_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishIonoObservationElevation_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO');
}

static finishSizePrefixedIonoObservationElevation_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO', true);
}

static createIonoObservationElevation_Ingest(builder:flatbuffers.Builder, notesOffset:flatbuffers.Offset, dimensionsOffset:flatbuffers.Offset, dimensionNameOffset:flatbuffers.Offset, dataOffset:flatbuffers.Offset):flatbuffers.Offset {
  IonoObservationElevation_Ingest.startIonoObservationElevation_Ingest(builder);
...
unpack(): IonoObservationElevation_IngestT {
  return new IonoObservationElevation_IngestT(
    this.notes(),
...
unpackTo(_o: IonoObservationElevation_IngestT): void {
  _o.notes = this.notes();
...
export class IonoObservationElevation_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const dimensions = IonoObservationElevation_Ingest.createDimensionsVector(builder, builder.createObjectOffsetList(this.dimensions));
  const dimensionName = IonoObservationElevation_Ingest.createDimensionNameVector(builder, builder.createObjectOffsetList(this.dimensionName));
  const data = IonoObservationElevation_Ingest.createDataVector(builder, builder.createObjectOffsetList(this.data));

  return IonoObservationElevation_Ingest.createIonoObservationElevation_Ingest(builder,
    notes,
    dimensions,
    dimensionName,
    data
