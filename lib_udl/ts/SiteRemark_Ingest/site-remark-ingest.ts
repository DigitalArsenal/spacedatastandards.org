...
import { SiteRemark_Ingest_dataMode_Enum } from './site-remark-ingest-data-mode-enum.js';
 ...
 */
export class SiteRemark_Ingest implements flatbuffers.IUnpackableObject<SiteRemark_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SiteRemark_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSiteRemark_Ingest(bb:flatbuffers.ByteBuffer, obj?:SiteRemark_Ingest):SiteRemark_Ingest {
  return (obj || new SiteRemark_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSiteRemark_Ingest(bb:flatbuffers.ByteBuffer, obj?:SiteRemark_Ingest):SiteRemark_Ingest {
 ...
 */
dataMode():SiteRemark_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 30);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SiteRemark_Ingest_dataMode_Enum.REAL;
}

static startSiteRemark_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SiteRemark_Ingest_dataMode_Enum) {
  builder.addFieldInt8(13, dataMode, SiteRemark_Ingest_dataMode_Enum.REAL);
}

static endSiteRemark_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSiteRemark_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SITE');
}

static finishSizePrefixedSiteRemark_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SITE', true);
}

static createSiteRemark_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idSiteOffset:flatbuffers.Offset, origRmkIdOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, textOffset:flatbuffers.Offset, codeOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:SiteRemark_Ingest_dataMode_Enum):flatbuffers.Offset {
  SiteRemark_Ingest.startSiteRemark_Ingest(builder);
...
unpack(): SiteRemark_IngestT {
  return new SiteRemark_IngestT(
    this.id(),
...
unpackTo(_o: SiteRemark_IngestT): void {
  _o.id = this.id();
...
export class SiteRemark_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SiteRemark_Ingest_dataMode_Enum = SiteRemark_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SiteRemark_Ingest.createSiteRemark_Ingest(builder,
    id,
