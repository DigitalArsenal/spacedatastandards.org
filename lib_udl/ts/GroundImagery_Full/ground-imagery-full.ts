...
import { GroundImagery_Full_dataMode_Enum } from './ground-imagery-full-data-mode-enum.js';


/**
 * /// Imagery of terrestrial regions from on-orbit, air, and other sensors.
 */
export class GroundImagery_Full implements flatbuffers.IUnpackableObject<GroundImagery_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):GroundImagery_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsGroundImagery_Full(bb:flatbuffers.ByteBuffer, obj?:GroundImagery_Full):GroundImagery_Full {
  return (obj || new GroundImagery_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsGroundImagery_Full(bb:flatbuffers.ByteBuffer, obj?:GroundImagery_Full):GroundImagery_Full {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():GroundImagery_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 40);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : GroundImagery_Full_dataMode_Enum.REAL;
}
...
static startGroundImagery_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:GroundImagery_Full_dataMode_Enum) {
  builder.addFieldInt8(18, dataMode, GroundImagery_Full_dataMode_Enum.REAL);
}
...
static addKeywords(builder:flatbuffers.Builder, keywordsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(25, keywordsOffset, 0);
}
...
unpack(): GroundImagery_FullT {
  return new GroundImagery_FullT(
    this.id(),
    this.idSensor(),
...
unpackTo(_o: GroundImagery_FullT): void {
  _o.id = this.id();
...
export class GroundImagery_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: GroundImagery_Full_dataMode_Enum = GroundImagery_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = GroundImagery_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  const keywords = GroundImagery_Full.createKeywordsVector(builder, builder.createObjectOffsetList(this.keywords));
  ...
  return GroundImagery_Full.createGroundImagery_Full(builder,
    id,
    idSensor,
