...
import { ItemTracking_Abridged_dataMode_Enum } from './item-tracking-abridged-data-mode-enum.js';


/**
 * /// No description available.
 */
export class ItemTracking_Abridged implements flatbuffers.IUnpackableObject<ItemTracking_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ItemTracking_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsItemTracking_Abridged(bb:flatbuffers.ByteBuffer, obj?:ItemTracking_Abridged):ItemTracking_Abridged {
  return (obj || new ItemTracking_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsItemTracking_Abridged(bb:flatbuffers.ByteBuffer, obj?:ItemTracking_Abridged):ItemTracking_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():ItemTracking_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 46);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : ItemTracking_Abridged_dataMode_Enum.REAL;
}

static startItemTracking_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:ItemTracking_Abridged_dataMode_Enum) {
  builder.addFieldInt8(21, dataMode, ItemTracking_Abridged_dataMode_Enum.REAL);
}

static endItemTracking_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishItemTracking_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ITEM');
}

static finishSizePrefixedItemTracking_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ITEM', true);
}

static createItemTracking_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, scanCodeOffset:flatbuffers.Offset, scGenToolOffset:flatbuffers.Offset, scannerIdOffset:flatbuffers.Offset, tsOffset:flatbuffers.Offset, idItemOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, lat:number, lon:number, scanTypeOffset:flatbuffers.Offset, dvCodeOffset:flatbuffers.Offset, notesOffset:flatbuffers.Offset, keysOffset:flatbuffers.Offset, valuesOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:ItemTracking_Abridged_dataMode_Enum):flatbuffers.Offset {
  ItemTracking_Abridged.startItemTracking_Abridged(builder);
...
unpack(): ItemTracking_AbridgedT {
  return new ItemTracking_AbridgedT(
    this.id(),
...
unpackTo(_o: ItemTracking_AbridgedT): void {
  _o.id = this.id();
...
export class ItemTracking_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: ItemTracking_Abridged_dataMode_Enum = ItemTracking_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const keys = ItemTracking_Abridged.createKeysVector(builder, builder.createObjectOffsetList(this.keys));
  const values = ItemTracking_Abridged.createValuesVector(builder, builder.createObjectOffsetList(this.values));
  ...
  return ItemTracking_Abridged.createItemTracking_Abridged(builder,
    id,
