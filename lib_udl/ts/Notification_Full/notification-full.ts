...
import { Notification_Full_dataMode_Enum } from './notification-full-data-mode-enum.js';
 ...
 */
export class Notification_Full implements flatbuffers.IUnpackableObject<Notification_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Notification_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsNotification_Full(bb:flatbuffers.ByteBuffer, obj?:Notification_Full):Notification_Full {
  return (obj || new Notification_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsNotification_Full(bb:flatbuffers.ByteBuffer, obj?:Notification_Full):Notification_Full {
 ...
 */
dataMode():Notification_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 12);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Notification_Full_dataMode_Enum.REAL;
}
...
static startNotification_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Notification_Full_dataMode_Enum) {
  builder.addFieldInt8(4, dataMode, Notification_Full_dataMode_Enum.REAL);
}
...
static endNotification_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishNotification_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'NOTI');
}

static finishSizePrefixedNotification_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'NOTI', true);
}

static createNotification_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, msgTypeOffset:flatbuffers.Offset, msgBodyOffset:flatbuffers.Offset, dataMode:Notification_Full_dataMode_Enum, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, tagsOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  Notification_Full.startNotification_Full(builder);
...
unpack(): Notification_FullT {
  return new Notification_FullT(
    this.id(),
...
unpackTo(_o: Notification_FullT): void {
  _o.id = this.id();
...
export class Notification_FullT implements flatbuffers.IGeneratedObject {
constructor(
  public id: string|Uint8Array|null = null,
  public classificationMarking: string|Uint8Array|null = null,
  public msgType: string|Uint8Array|null = null,
  public msgBody: string|Uint8Array|null = null,
  public dataMode: Notification_Full_dataMode_Enum = Notification_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = Notification_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  const createdAt = (this.createdAt !== null ? builder.createString(this.createdAt!) : 0);
  const createdBy = (this.createdBy !== null ? builder.createString(this.createdBy!) : 0);
  const origNetwork = (this.origNetwork !== null ? builder.createString(this.origNetwork!) : 0);

  return Notification_Full.createNotification_Full(builder,
    id,
