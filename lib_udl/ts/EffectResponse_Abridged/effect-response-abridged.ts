...
import { EffectResponse_Abridged_dataMode_Enum } from './effect-response-abridged-data-mode-enum.js';


/**
 * /// A response for various effects on a target.
 */
export class EffectResponse_Abridged implements flatbuffers.IUnpackableObject<EffectResponse_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EffectResponse_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEffectResponse_Abridged(bb:flatbuffers.ByteBuffer, obj?:EffectResponse_Abridged):EffectResponse_Abridged {
  return (obj || new EffectResponse_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEffectResponse_Abridged(bb:flatbuffers.ByteBuffer, obj?:EffectResponse_Abridged):EffectResponse_Abridged {
 ...
 */
dataMode():EffectResponse_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 50);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : EffectResponse_Abridged_dataMode_Enum.REAL;
}
...
static startEffectResponse_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:EffectResponse_Abridged_dataMode_Enum) {
  builder.addFieldInt8(23, dataMode, EffectResponse_Abridged_dataMode_Enum.REAL);
}
...
static endEffectResponse_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEffectResponse_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EFFE');
}

static finishSizePrefixedEffectResponse_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EFFE', true);
}

static createEffectResponse_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idEffectRequestOffset:flatbuffers.Offset, externalRequestIdOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, actorSrcTypeOffset:flatbuffers.Offset, actorSrcIdOffset:flatbuffers.Offset, munitionTypeOffset:flatbuffers.Offset, munitionIdOffset:flatbuffers.Offset, shotsRequired:number, probabilityOfKill:number, collateralDamageEst:number, actionsListOffset:flatbuffers.Offset, externalActionsOffset:flatbuffers.Offset, coaMetricsOffset:flatbuffers.Offset, redTimeToOverheadOffset:flatbuffers.Offset, decisionDeadlineOffset:flatbuffers.Offset, redTargetSrcTypeOffset:flatbuffers.Offset, redTargetSrcIdOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:EffectResponse_Abridged_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  EffectResponse_Abridged.startEffectResponse_Abridged(builder);
...
unpack(): EffectResponse_AbridgedT {
  return new EffectResponse_AbridgedT(
    this.id(),
...
unpackTo(_o: EffectResponse_AbridgedT): void {
  _o.id = this.id();
...
export class EffectResponse_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: EffectResponse_Abridged_dataMode_Enum = EffectResponse_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const actionsList = EffectResponse_Abridged.createActionsListVector(builder, builder.createObjectOffsetList(this.actionsList));
  const externalActions = EffectResponse_Abridged.createExternalActionsVector(builder, builder.createObjectOffsetList(this.externalActions));
  const coaMetrics = EffectResponse_Abridged.createCoaMetricsVector(builder, builder.createObjectOffsetList(this.coaMetrics));
  ...
  return EffectResponse_Abridged.createEffectResponse_Abridged(builder,
    id,
