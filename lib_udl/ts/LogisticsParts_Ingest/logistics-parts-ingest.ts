 ...
 */
export class LogisticsParts_Ingest implements flatbuffers.IUnpackableObject<LogisticsParts_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LogisticsParts_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLogisticsParts_Ingest(bb:flatbuffers.ByteBuffer, obj?:LogisticsParts_Ingest):LogisticsParts_Ingest {
  return (obj || new LogisticsParts_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLogisticsParts_Ingest(bb:flatbuffers.ByteBuffer, obj?:LogisticsParts_Ingest):LogisticsParts_Ingest {
...
static startLogisticsParts_Ingest(builder:flatbuffers.Builder) {
...
unpack(): LogisticsParts_IngestT {
  return new LogisticsParts_IngestT(
    this.partNumber(),
...
unpackTo(_o: LogisticsParts_IngestT): void {
...
export class LogisticsParts_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const logisticsStocks = LogisticsParts_Ingest.createLogisticsStocksVector(builder, builder.createObjectOffsetList(this.logisticsStocks));

  return LogisticsParts_Ingest.createLogisticsParts_Ingest(builder,
    partNumber,
    nationalStockNumber,
    measurementUnitCode,
    workUnitCode,
