...
import { AirEvent_Abridged_dataMode_Enum } from './AirEvent_Abridged_dataMode_Enum.js';


/**
 * /// Information related to an air event (e.g. FUEL TRANSFER, AIR DROP) and the associated aircraft.
 */
export class AirEvent_Abridged implements flatbuffers.IUnpackableObject<AirEvent_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirEvent_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirEvent_Abridged(bb:flatbuffers.ByteBuffer, obj?:AirEvent_Abridged):AirEvent_Abridged {
  return (obj || new AirEvent_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirEvent_Abridged(bb:flatbuffers.ByteBuffer, obj?:AirEvent_Abridged):AirEvent_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():AirEvent_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 90);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirEvent_Abridged_dataMode_Enum.REAL;
}

static startAirEvent_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AirEvent_Abridged_dataMode_Enum) {
  builder.addFieldInt8(43, dataMode, AirEvent_Abridged_dataMode_Enum.REAL);
}

static endAirEvent_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirEvent_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRE');
}

static finishSizePrefixedAirEvent_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRE', true);
}

static createAirEvent_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, idSortieOffset:flatbuffers.Offset, idMissionOffset:flatbuffers.Offset, externalAirEventIdOffset:flatbuffers.Offset, legNum:number, locationOffset:flatbuffers.Offset, arrPurposeOffset:flatbuffers.Offset, plannedArrTimeOffset:flatbuffers.Offset, estArrTimeOffset:flatbuffers.Offset, actualArrTimeOffset:flatbuffers.Offset, depPurposeOffset:flatbuffers.Offset, plannedDepTimeOffset:flatbuffers.Offset, estDepTimeOffset:flatbuffers.Offset, actualDepTimeOffset:flatbuffers.Offset, externalArtrackIdOffset:flatbuffers.Offset, arTrackIdOffset:flatbuffers.Offset, arTrackNameOffset:flatbuffers.Offset, rzctOffset:flatbuffers.Offset, arctOffset:flatbuffers.Offset, baseAlt:number, priorityOffset:flatbuffers.Offset, trackTime:number, statusCodeOffset:flatbuffers.Offset, rzPointOffset:flatbuffers.Offset, rzTypeOffset:flatbuffers.Offset, arEventTypeOffset:flatbuffers.Offset, numTankers:number, revTrack:boolean, shortTrack:boolean, cancelled:boolean, tankersOffset:flatbuffers.Offset, receiversOffset:flatbuffers.Offset, remarksOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:AirEvent_Abridged_dataMode_Enum):flatbuffers.Offset {
  AirEvent_Abridged.startAirEvent_Abridged(builder);
...
unpack(): AirEvent_AbridgedT {
  return new AirEvent_AbridgedT(
    this.id(),
    ...
    this.shortTrack(),
    this.cancelled(),
    this.bb!.createScalarList<string>(this.tankers.bind(this), this.tankersLength()),
    this.bb!.createScalarList<string>(this.receivers.bind(this), this.receiversLength()),
...
unpackTo(_o: AirEvent_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.tankers = this.bb!.createScalarList<string>(this.tankers.bind(this), this.tankersLength());
  _o.receivers = this.bb!.createScalarList<string>(this.receivers.bind(this), this.receiversLength());
...
export class AirEvent_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AirEvent_Abridged_dataMode_Enum = AirEvent_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tankers = AirEvent_Abridged.createTankersVector(builder, builder.createObjectOffsetList(this.tankers));
  const receivers = AirEvent_Abridged.createReceiversVector(builder, builder.createObjectOffsetList(this.receivers));
  const remarks = AirEvent_Abridged.createRemarksVector(builder, builder.createObjectOffsetList(this.remarks));
  ...
  return AirEvent_Abridged.createAirEvent_Abridged(builder,
    id,
