...
import { AirfieldSlot_Full_acSlotCat_Enum } from './airfield-slot-full-ac-slot-cat-enum.js';
import { AirfieldSlot_Full_dataMode_Enum } from './airfield-slot-full-data-mode-enum.js';
import { AirfieldSlot_Full_type_Enum } from './airfield-slot-full-type-enum.js';
 ...
 */
export class AirfieldSlot_Full implements flatbuffers.IUnpackableObject<AirfieldSlot_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirfieldSlot_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirfieldSlot_Full(bb:flatbuffers.ByteBuffer, obj?:AirfieldSlot_Full):AirfieldSlot_Full {
  return (obj || new AirfieldSlot_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirfieldSlot_Full(bb:flatbuffers.ByteBuffer, obj?:AirfieldSlot_Full):AirfieldSlot_Full {
 ...
 */
type():AirfieldSlot_Full_type_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 18);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirfieldSlot_Full_type_Enum.WORKING;
}
 ...
 */
acSlotCat():AirfieldSlot_Full_acSlotCat_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 20);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirfieldSlot_Full_acSlotCat_Enum.WIDE;
}
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():AirfieldSlot_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 48);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirfieldSlot_Full_dataMode_Enum.REAL;
}

static startAirfieldSlot_Full(builder:flatbuffers.Builder) {
...
static addType(builder:flatbuffers.Builder, type:AirfieldSlot_Full_type_Enum) {
  builder.addFieldInt8(7, type, AirfieldSlot_Full_type_Enum.WORKING);
}

static addAcSlotCat(builder:flatbuffers.Builder, acSlotCat:AirfieldSlot_Full_acSlotCat_Enum) {
  builder.addFieldInt8(8, acSlotCat, AirfieldSlot_Full_acSlotCat_Enum.WIDE);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AirfieldSlot_Full_dataMode_Enum) {
  builder.addFieldInt8(22, dataMode, AirfieldSlot_Full_dataMode_Enum.REAL);
}

static endAirfieldSlot_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirfieldSlot_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRF');
}

static finishSizePrefixedAirfieldSlot_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRF', true);
}

static createAirfieldSlot_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, airfieldNameOffset:flatbuffers.Offset, icaoOffset:flatbuffers.Offset, idAirfieldOffset:flatbuffers.Offset, altAirfieldIdOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, type:AirfieldSlot_Full_type_Enum, acSlotCat:AirfieldSlot_Full_acSlotCat_Enum, capacity:number, startTimeOffset:flatbuffers.Offset, endTimeOffset:flatbuffers.Offset, minSeparation:number, notesOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:AirfieldSlot_Full_dataMode_Enum):flatbuffers.Offset {
  AirfieldSlot_Full.startAirfieldSlot_Full(builder);
...
unpack(): AirfieldSlot_FullT {
  return new AirfieldSlot_FullT(
    this.id(),
...
unpackTo(_o: AirfieldSlot_FullT): void {
  _o.id = this.id();
...
export class AirfieldSlot_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public type: AirfieldSlot_Full_type_Enum = AirfieldSlot_Full_type_Enum.WORKING,
  public acSlotCat: AirfieldSlot_Full_acSlotCat_Enum = AirfieldSlot_Full_acSlotCat_Enum.WIDE,
  ...
  public dataMode: AirfieldSlot_Full_dataMode_Enum = AirfieldSlot_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AirfieldSlot_Full.createAirfieldSlot_Full(builder,
    id,
