...
import { EOObservationDetails_Full_dataMode_Enum } from './EOObservationDetails_Full_dataMode_Enum.js';


/**
 * /// Model representation of additional detailed observation data for electro-optical based sensor phenomenologies.
 */
export class EOObservationDetails_Full implements flatbuffers.IUnpackableObject<EOObservationDetails_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EOObservationDetails_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEOObservationDetails_Full(bb:flatbuffers.ByteBuffer, obj?:EOObservationDetails_Full):EOObservationDetails_Full {
  return (obj || new EOObservationDetails_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEOObservationDetails_Full(bb:flatbuffers.ByteBuffer, obj?:EOObservationDetails_Full):EOObservationDetails_Full {
 ...
 */
dataMode():EOObservationDetails_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 164);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : EOObservationDetails_Full_dataMode_Enum.REAL;
}
...
static startEOObservationDetails_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:EOObservationDetails_Full_dataMode_Enum) {
  builder.addFieldInt8(80, dataMode, EOObservationDetails_Full_dataMode_Enum.REAL);
}
...
unpack(): EOObservationDetails_FullT {
  return new EOObservationDetails_FullT(
    ...
    this.bb!.createScalarList<string>(this.spectralZmfl.bind(this), this.spectralZmflLength()),
    this.bb!.createScalarList<string>(this.spectralFilterSolarMag.bind(this), this.spectralFilterSolarMagLength()),
    this.bb!.createScalarList<string>(this.zeroPoints.bind(this), this.zeroPointsLength()),
    this.bb!.createScalarList<string>(this.zeroPointsUnc.bind(this), this.zeroPointsUncLength()),
    this.bb!.createScalarList<string>(this.extinctionCoeffs.bind(this), this.extinctionCoeffsLength()),
    this.bb!.createScalarList<string>(this.extinctionCoeffsUnc.bind(this), this.extinctionCoeffsUncLength()),
    this.bb!.createScalarList<string>(this.colorCoeffs.bind(this), this.colorCoeffsLength()),
    this.numNeutralDensityFilters(),
    this.bb!.createScalarList<string>(this.neutralDensityFilterNames.bind(this), this.neutralDensityFilterNamesLength()),
    this.bb!.createScalarList<string>(this.neutralDensityFilterTransmissions.bind(this), this.neutralDensityFilterTransmissionsLength()),
    this.bb!.createScalarList<string>(this.neutralDensityFilterTransmissionsUnc.bind(this), this.neutralDensityFilterTransmissionsUncLength()),
    this.gain(),
    this.ifov(),
    ...
    this.columnVariance(),
    this.rowColCov(),
    this.bb!.createScalarList<string>(this.distFromStreakCenter.bind(this), this.distFromStreakCenterLength()),
    this.bb!.createScalarList<string>(this.surfBrightness.bind(this), this.surfBrightnessLength()),
    this.bb!.createScalarList<string>(this.surfBrightnessUnc.bind(this), this.surfBrightnessUncLength()),
    this.timesUnc(),
    this.ccdTemp(),
...
unpackTo(_o: EOObservationDetails_FullT): void {
  ...
  _o.spectralZmfl = this.bb!.createScalarList<string>(this.spectralZmfl.bind(this), this.spectralZmflLength());
  _o.spectralFilterSolarMag = this.bb!.createScalarList<string>(this.spectralFilterSolarMag.bind(this), this.spectralFilterSolarMagLength());
  _o.zeroPoints = this.bb!.createScalarList<string>(this.zeroPoints.bind(this), this.zeroPointsLength());
  _o.zeroPointsUnc = this.bb!.createScalarList<string>(this.zeroPointsUnc.bind(this), this.zeroPointsUncLength());
  _o.extinctionCoeffs = this.bb!.createScalarList<string>(this.extinctionCoeffs.bind(this), this.extinctionCoeffsLength());
  _o.extinctionCoeffsUnc = this.bb!.createScalarList<string>(this.extinctionCoeffsUnc.bind(this), this.extinctionCoeffsUncLength());
  _o.colorCoeffs = this.bb!.createScalarList<string>(this.colorCoeffs.bind(this), this.colorCoeffsLength());
  _o.numNeutralDensityFilters = this.numNeutralDensityFilters();
  _o.neutralDensityFilterNames = this.bb!.createScalarList<string>(this.neutralDensityFilterNames.bind(this), this.neutralDensityFilterNamesLength());
  _o.neutralDensityFilterTransmissions = this.bb!.createScalarList<string>(this.neutralDensityFilterTransmissions.bind(this), this.neutralDensityFilterTransmissionsLength());
  _o.neutralDensityFilterTransmissionsUnc = this.bb!.createScalarList<string>(this.neutralDensityFilterTransmissionsUnc.bind(this), this.neutralDensityFilterTransmissionsUncLength());
  _o.gain = this.gain();
  _o.ifov = this.ifov();
  ...
  _o.distFromStreakCenter = this.bb!.createScalarList<string>(this.distFromStreakCenter.bind(this), this.distFromStreakCenterLength());
  _o.surfBrightness = this.bb!.createScalarList<string>(this.surfBrightness.bind(this), this.surfBrightnessLength());
  _o.surfBrightnessUnc = this.bb!.createScalarList<string>(this.surfBrightnessUnc.bind(this), this.surfBrightnessUncLength());
...
export class EOObservationDetails_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: EOObservationDetails_Full_dataMode_Enum = EOObservationDetails_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const spectralFilters = EOObservationDetails_Full.createSpectralFiltersVector(builder, builder.createObjectOffsetList(this.spectralFilters));
  const spectralZmfl = EOObservationDetails_Full.createSpectralZmflVector(builder, builder.createObjectOffsetList(this.spectralZmfl));
  const spectralFilterSolarMag = EOObservationDetails_Full.createSpectralFilterSolarMagVector(builder, builder.createObjectOffsetList(this.spectralFilterSolarMag));
  const zeroPoints = EOObservationDetails_Full.createZeroPointsVector(builder, builder.createObjectOffsetList(this.zeroPoints));
  const zeroPointsUnc = EOObservationDetails_Full.createZeroPointsUncVector(builder, builder.createObjectOffsetList(this.zeroPointsUnc));
  const extinctionCoeffs = EOObservationDetails_Full.createExtinctionCoeffsVector(builder, builder.createObjectOffsetList(this.extinctionCoeffs));
  const extinctionCoeffsUnc = EOObservationDetails_Full.createExtinctionCoeffsUncVector(builder, builder.createObjectOffsetList(this.extinctionCoeffsUnc));
  const colorCoeffs = EOObservationDetails_Full.createColorCoeffsVector(builder, builder.createObjectOffsetList(this.colorCoeffs));
  const neutralDensityFilterNames = EOObservationDetails_Full.createNeutralDensityFilterNamesVector(builder, builder.createObjectOffsetList(this.neutralDensityFilterNames));
  const neutralDensityFilterTransmissions = EOObservationDetails_Full.createNeutralDensityFilterTransmissionsVector(builder, builder.createObjectOffsetList(this.neutralDensityFilterTransmissions));
  const neutralDensityFilterTransmissionsUnc = EOObservationDetails_Full.createNeutralDensityFilterTransmissionsUncVector(builder, builder.createObjectOffsetList(this.neutralDensityFilterTransmissionsUnc));
  const distFromStreakCenter = EOObservationDetails_Full.createDistFromStreakCenterVector(builder, builder.createObjectOffsetList(this.distFromStreakCenter));
  const surfBrightness = EOObservationDetails_Full.createSurfBrightnessVector(builder, builder.createObjectOffsetList(this.surfBrightness));
  const surfBrightnessUnc = EOObservationDetails_Full.createSurfBrightnessUncVector(builder, builder.createObjectOffsetList(this.surfBrightnessUnc));
  const source = (this.source !== null ? builder.createString(this.source!) : 0);
  const createdAt = (this.createdAt !== null ? builder.createString(this.createdAt!) : 0);
  const createdBy = (this.createdBy !== null ? builder.createString(this.createdBy!) : 0);

  return EOObservationDetails_Full.createEOObservationDetails_Full(builder,
    idEoobservation,
