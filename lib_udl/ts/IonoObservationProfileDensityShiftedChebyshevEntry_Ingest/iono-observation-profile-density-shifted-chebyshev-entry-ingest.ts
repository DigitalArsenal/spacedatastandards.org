 ...
 */
export class IonoObservationProfileDensityShiftedChebyshevEntry_Ingest implements flatbuffers.IUnpackableObject<IonoObservationProfileDensityShiftedChebyshevEntry_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):IonoObservationProfileDensityShiftedChebyshevEntry_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsIonoObservationProfileDensityShiftedChebyshevEntry_Ingest(bb:flatbuffers.ByteBuffer, obj?:IonoObservationProfileDensityShiftedChebyshevEntry_Ingest):IonoObservationProfileDensityShiftedChebyshevEntry_Ingest {
  return (obj || new IonoObservationProfileDensityShiftedChebyshevEntry_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIonoObservationProfileDensityShiftedChebyshevEntry_Ingest(bb:flatbuffers.ByteBuffer, obj?:IonoObservationProfileDensityShiftedChebyshevEntry_Ingest):IonoObservationProfileDensityShiftedChebyshevEntry_Ingest {
...
static startIonoObservationProfileDensityShiftedChebyshevEntry_Ingest(builder:flatbuffers.Builder) {
...
static endIonoObservationProfileDensityShiftedChebyshevEntry_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishIonoObservationProfileDensityShiftedChebyshevEntry_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO');
}

static finishSizePrefixedIonoObservationProfileDensityShiftedChebyshevEntry_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO', true);
}

static createIonoObservationProfileDensityShiftedChebyshevEntry_Ingest(builder:flatbuffers.Builder, layerOffset:flatbuffers.Offset, fstart:number, fstop:number, peakheight:number, zhalfNm:number, n:number, coeffsOffset:flatbuffers.Offset, error:number):flatbuffers.Offset {
  IonoObservationProfileDensityShiftedChebyshevEntry_Ingest.startIonoObservationProfileDensityShiftedChebyshevEntry_Ingest(builder);
...
unpack(): IonoObservationProfileDensityShiftedChebyshevEntry_IngestT {
  return new IonoObservationProfileDensityShiftedChebyshevEntry_IngestT(
    this.layer(),
    this.fstart(),
    this.fstop(),
    this.peakheight(),
...
unpackTo(_o: IonoObservationProfileDensityShiftedChebyshevEntry_IngestT): void {
  _o.layer = this.layer();
...
export class IonoObservationProfileDensityShiftedChebyshevEntry_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const coeffs = IonoObservationProfileDensityShiftedChebyshevEntry_Ingest.createCoeffsVector(builder, builder.createObjectOffsetList(this.coeffs));

  return IonoObservationProfileDensityShiftedChebyshevEntry_Ingest.createIonoObservationProfileDensityShiftedChebyshevEntry_Ingest(builder,
    layer,
    this.fstart,
    this.fstop,
    this.peakheight,
