...
import { CollectRequest_Full_dataMode_Enum } from './collect-request-full-data-mode-enum.js';
 ...
 */
export class CollectRequest_Full implements flatbuffers.IUnpackableObject<CollectRequest_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):CollectRequest_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsCollectRequest_Full(bb:flatbuffers.ByteBuffer, obj?:CollectRequest_Full):CollectRequest_Full {
  return (obj || new CollectRequest_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsCollectRequest_Full(bb:flatbuffers.ByteBuffer, obj?:CollectRequest_Full):CollectRequest_Full {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():CollectRequest_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 176);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : CollectRequest_Full_dataMode_Enum.REAL;
}
 ...
 * Constraints: No constraints specified.
 */
collectResponse(index: number):string
collectResponse(index: number,optionalEncoding:flatbuffers.Encoding):string|Uint8Array
collectResponse(index: number,optionalEncoding?:any):string|Uint8Array|null {
  const offset = this.bb!.__offset(this.bb_pos, 186);
  return offset ? this.bb!.__string(this.bb!.__vector(this.bb_pos + offset) + index * 4, optionalEncoding) : null;
}

collectResponseLength():number {
  const offset = this.bb!.__offset(this.bb_pos, 186);
  return offset ? this.bb!.__vector_len(this.bb_pos + offset) : 0;
}

static startCollectRequest_Full(builder:flatbuffers.Builder) {
...
static addUpdatedAt(builder:flatbuffers.Builder, updatedAtOffset:flatbuffers.Offset) {
  builder.addFieldOffset(79, updatedAtOffset, 0);
}

static addUpdatedBy(builder:flatbuffers.Builder, updatedByOffset:flatbuffers.Offset) {
  builder.addFieldOffset(80, updatedByOffset, 0);
}
...
static addOrigNetwork(builder:flatbuffers.Builder, origNetworkOffset:flatbuffers.Offset) {
  builder.addFieldOffset(85, origNetworkOffset, 0);
}

static addDataMode(builder:flatbuffers.Builder, dataMode:CollectRequest_Full_dataMode_Enum) {
  builder.addFieldInt8(86, dataMode, CollectRequest_Full_dataMode_Enum.REAL);
}

static addStateVector(builder:flatbuffers.Builder, stateVectorOffset:flatbuffers.Offset) {
  builder.addFieldOffset(87, stateVectorOffset, 0);
}

static addElset(builder:flatbuffers.Builder, elsetOffset:flatbuffers.Offset) {
  builder.addFieldOffset(88, elsetOffset, 0);
}

static addOnOrbit(builder:flatbuffers.Builder, onOrbitOffset:flatbuffers.Offset) {
  builder.addFieldOffset(89, onOrbitOffset, 0);
}

static addTags(builder:flatbuffers.Builder, tagsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(90, tagsOffset, 0);
}
...
static addCollectResponse(builder:flatbuffers.Builder, collectResponseOffset:flatbuffers.Offset) {
  builder.addFieldOffset(91, collectResponseOffset, 0);
}

static createCollectResponseVector(builder:flatbuffers.Builder, data:flatbuffers.Offset[]):flatbuffers.Offset {
  builder.startVector(4, data.length, 4);
  for (let i = data.length - 1; i >= 0; i--) {
    builder.addOffset(data[i]!);
  }
...
unpack(): CollectRequest_FullT {
  return new CollectRequest_FullT(
    this.id(),
    ...
    this.bb!.createScalarList<string>(this.collectResponse.bind(this), this.collectResponse_Length())
  );
}


unpackTo(_o: CollectRequest_FullT): void {
  _o.id = this.id();
  ...
  _o.collectResponse = this.bb!.createScalarList<string>(this.collectResponse.bind(this), this.collectResponse_Length());
}
}

export class CollectRequest_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: CollectRequest_Full_dataMode_Enum = CollectRequest_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = CollectRequest_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  const collectResponse = CollectRequest_Full.createCollectResponseVector(builder, builder.createObjectOffsetList(this.collectResponse));

  return CollectRequest_Full.createCollectRequest_Full(builder,
    id,
