...
import { CollectRequest_Full_dataMode_Enum } from './CollectRequest_Full_dataMode_Enum.js';
...
unpack(): CollectRequest_FullT {
  return new CollectRequest_FullT(
    ...
    this.bb!.createScalarList<string>(this.collectResponse.bind(this), this.collectResponseLength())
  );
}
...
unpackTo(_o: CollectRequest_FullT): void {
  ...
  _o.collectResponse = this.bb!.createScalarList<string>(this.collectResponse.bind(this), this.collectResponseLength());
}
}
