 ...
 */
export class RoutePoints_Ingest implements flatbuffers.IUnpackableObject<RoutePoints_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):RoutePoints_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsRoutePoints_Ingest(bb:flatbuffers.ByteBuffer, obj?:RoutePoints_Ingest):RoutePoints_Ingest {
  return (obj || new RoutePoints_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRoutePoints_Ingest(bb:flatbuffers.ByteBuffer, obj?:RoutePoints_Ingest):RoutePoints_Ingest {
...
static startRoutePoints_Ingest(builder:flatbuffers.Builder) {
...
static endRoutePoints_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishRoutePoints_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ROUT');
}

static finishSizePrefixedRoutePoints_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ROUT', true);
}

static createRoutePoints_Ingest(builder:flatbuffers.Builder, ptSequenceId:number, ptTypeCodeOffset:flatbuffers.Offset, ptTypeNameOffset:flatbuffers.Offset, waypointNameOffset:flatbuffers.Offset, dafifPt:boolean, ptLat:number, ptLon:number, magDec:number, navaidLength:number, navaidOffset:flatbuffers.Offset, countryCodeOffset:flatbuffers.Offset, altCountryCodeOffset:flatbuffers.Offset, navaidTypeOffset:flatbuffers.Offset):flatbuffers.Offset {
  RoutePoints_Ingest.startRoutePoints_Ingest(builder);
...
unpack(): RoutePoints_IngestT {
  return new RoutePoints_IngestT(
    this.ptSequenceId(),
    this.ptTypeCode(),
    this.ptTypeName(),
    this.waypointName(),
...
unpackTo(_o: RoutePoints_IngestT): void {
...
export class RoutePoints_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return RoutePoints_Ingest.createRoutePoints_Ingest(builder,
    this.ptSequenceId,
    ptTypeCode,
    ptTypeName,
    waypointName,
