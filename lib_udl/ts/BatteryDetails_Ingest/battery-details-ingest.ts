...
import { BatteryDetails_Ingest_dataMode_Enum } from './battery-details-ingest-data-mode-enum.js';
 ...
 */
export class BatteryDetails_Ingest implements flatbuffers.IUnpackableObject<BatteryDetails_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):BatteryDetails_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsBatteryDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:BatteryDetails_Ingest):BatteryDetails_Ingest {
  return (obj || new BatteryDetails_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsBatteryDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:BatteryDetails_Ingest):BatteryDetails_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():BatteryDetails_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 32);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : BatteryDetails_Ingest_dataMode_Enum.REAL;
}
...
static startBatteryDetails_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:BatteryDetails_Ingest_dataMode_Enum) {
  builder.addFieldInt8(14, dataMode, BatteryDetails_Ingest_dataMode_Enum.REAL);
}
...
static endBatteryDetails_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishBatteryDetails_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'BATT');
}

static finishSizePrefixedBatteryDetails_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'BATT', true);
}

static createBatteryDetails_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idBatteryOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, technologyOffset:flatbuffers.Offset, capacity:number, dischargeDepth:number, modelOffset:flatbuffers.Offset, descriptionOffset:flatbuffers.Offset, manufacturerOrgIdOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:BatteryDetails_Ingest_dataMode_Enum, tagsOffset:flatbuffers.Offset):flatbuffers.Offset {
  BatteryDetails_Ingest.startBatteryDetails_Ingest(builder);
...
unpack(): BatteryDetails_IngestT {
  return new BatteryDetails_IngestT(
    this.id(),
    this.idBattery(),
...
unpackTo(_o: BatteryDetails_IngestT): void {
  _o.id = this.id();
...
export class BatteryDetails_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: BatteryDetails_Ingest_dataMode_Enum = BatteryDetails_Ingest_dataMode_Enum.REAL,
  public tags: (string)[] = []
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = BatteryDetails_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));

  return BatteryDetails_Ingest.createBatteryDetails_Ingest(builder,
    id,
    idBattery,
