...
import { AirTransportMission_Full_dataMode_Enum } from './AirTransportMission_Full_dataMode_Enum.js';
...
unpack(): AirTransportMission_FullT {
  return new AirTransportMission_FullT(
    ...
    this.bb!.createScalarList<string>(this.aircraftSorties.bind(this), this.aircraftSortiesLength())
  );
}
...
unpackTo(_o: AirTransportMission_FullT): void {
  ...
  _o.aircraftSorties = this.bb!.createScalarList<string>(this.aircraftSorties.bind(this), this.aircraftSortiesLength());
}
}
