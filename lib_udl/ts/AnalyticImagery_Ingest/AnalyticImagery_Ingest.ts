...
import { AnalyticImagery_Ingest_dataMode_Enum } from './AnalyticImagery_Ingest_dataMode_Enum.js';
 ...
 */
export class AnalyticImagery_Ingest implements flatbuffers.IUnpackableObject<AnalyticImagery_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AnalyticImagery_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAnalyticImagery_Ingest(bb:flatbuffers.ByteBuffer, obj?:AnalyticImagery_Ingest):AnalyticImagery_Ingest {
  return (obj || new AnalyticImagery_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAnalyticImagery_Ingest(bb:flatbuffers.ByteBuffer, obj?:AnalyticImagery_Ingest):AnalyticImagery_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():AnalyticImagery_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 84);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AnalyticImagery_Ingest_dataMode_Enum.REAL;
}

static startAnalyticImagery_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AnalyticImagery_Ingest_dataMode_Enum) {
  builder.addFieldInt8(40, dataMode, AnalyticImagery_Ingest_dataMode_Enum.REAL);
}

static endAnalyticImagery_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAnalyticImagery_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ANAL');
}

static finishSizePrefixedAnalyticImagery_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ANAL', true);
}

static createAnalyticImagery_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, contentOffset:flatbuffers.Offset, msgTimeOffset:flatbuffers.Offset, imageTypeOffset:flatbuffers.Offset, filenameOffset:flatbuffers.Offset, filesize:bigint, imgWidth:number, imgHeight:number, xUnitsOffset:flatbuffers.Offset, yUnitsOffset:flatbuffers.Offset, zUnitsOffset:flatbuffers.Offset, imageSetIdOffset:flatbuffers.Offset, imageSetLength:number, sequenceId:number, descriptionOffset:flatbuffers.Offset, dataStartOffset:flatbuffers.Offset, dataStopOffset:flatbuffers.Offset, annLimsOffset:flatbuffers.Offset, annTextOffset:flatbuffers.Offset, keywordsOffset:flatbuffers.Offset, areaOffset:flatbuffers.Offset, atextOffset:flatbuffers.Offset, agjsonOffset:flatbuffers.Offset, atypeOffset:flatbuffers.Offset, andims:number, asrid:number, satIdOffset:flatbuffers.Offset, satIdConfOffset:flatbuffers.Offset, srcTypsOffset:flatbuffers.Offset, srcIdsOffset:flatbuffers.Offset, tagsOffset:flatbuffers.Offset, checksumValueOffset:flatbuffers.Offset, transactionIdOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, dataMode:AnalyticImagery_Ingest_dataMode_Enum):flatbuffers.Offset {
  AnalyticImagery_Ingest.startAnalyticImagery_Ingest(builder);
  AnalyticImagery_Ingest.addId(builder, idOffset);
  AnalyticImagery_Ingest.addClassificationMarking(builder, classificationMarkingOffset);
  AnalyticImagery_Ingest.addContent(builder, contentOffset);
  AnalyticImagery_Ingest.addMsgTime(builder, msgTimeOffset);
  AnalyticImagery_Ingest.addImageType(builder, imageTypeOffset);
  AnalyticImagery_Ingest.addFilename(builder, filenameOffset);
  AnalyticImagery_Ingest.addFilesize(builder, filesize);
  AnalyticImagery_Ingest.addImgWidth(builder, imgWidth);
  AnalyticImagery_Ingest.addImgHeight(builder, imgHeight);
  AnalyticImagery_Ingest.addXUnits(builder, xUnitsOffset);
  AnalyticImagery_Ingest.addYUnits(builder, yUnitsOffset);
  AnalyticImagery_Ingest.addZUnits(builder, zUnitsOffset);
  AnalyticImagery_Ingest.addImageSetId(builder, imageSetIdOffset);
  AnalyticImagery_Ingest.addImageSetLength(builder, imageSetLength);
  AnalyticImagery_Ingest.addSequenceId(builder, sequenceId);
  AnalyticImagery_Ingest.addDescription(builder, descriptionOffset);
  AnalyticImagery_Ingest.addDataStart(builder, dataStartOffset);
  AnalyticImagery_Ingest.addDataStop(builder, dataStopOffset);
  AnalyticImagery_Ingest.addAnnLims(builder, annLimsOffset);
  AnalyticImagery_Ingest.addAnnText(builder, annTextOffset);
  AnalyticImagery_Ingest.addKeywords(builder, keywordsOffset);
  AnalyticImagery_Ingest.addArea(builder, areaOffset);
  AnalyticImagery_Ingest.addAtext(builder, atextOffset);
  AnalyticImagery_Ingest.addAgjson(builder, agjsonOffset);
  AnalyticImagery_Ingest.addAtype(builder, atypeOffset);
  AnalyticImagery_Ingest.addAndims(builder, andims);
  AnalyticImagery_Ingest.addAsrid(builder, asrid);
  AnalyticImagery_Ingest.addSatId(builder, satIdOffset);
  AnalyticImagery_Ingest.addSatIdConf(builder, satIdConfOffset);
  AnalyticImagery_Ingest.addSrcTyps(builder, srcTypsOffset);
  AnalyticImagery_Ingest.addSrcIds(builder, srcIdsOffset);
  AnalyticImagery_Ingest.addTags(builder, tagsOffset);
  AnalyticImagery_Ingest.addChecksumValue(builder, checksumValueOffset);
  AnalyticImagery_Ingest.addTransactionId(builder, transactionIdOffset);
  AnalyticImagery_Ingest.addCreatedAt(builder, createdAtOffset);
  AnalyticImagery_Ingest.addCreatedBy(builder, createdByOffset);
  AnalyticImagery_Ingest.addSource(builder, sourceOffset);
  AnalyticImagery_Ingest.addOrigin(builder, originOffset);
  AnalyticImagery_Ingest.addOrigNetwork(builder, origNetworkOffset);
  AnalyticImagery_Ingest.addSourceDl(builder, sourceDlOffset);
  AnalyticImagery_Ingest.addDataMode(builder, dataMode);
  return AnalyticImagery_Ingest.endAnalyticImagery_Ingest(builder);
}

unpack(): AnalyticImagery_IngestT {
  return new AnalyticImagery_IngestT(
    this.id(),
...
unpackTo(_o: AnalyticImagery_IngestT): void {
  _o.id = this.id();
...
export class AnalyticImagery_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AnalyticImagery_Ingest_dataMode_Enum = AnalyticImagery_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const annLims = AnalyticImagery_Ingest.createAnnLimsVector(builder, builder.createObjectOffsetList(this.annLims));
  const annText = AnalyticImagery_Ingest.createAnnTextVector(builder, builder.createObjectOffsetList(this.annText));
  const keywords = AnalyticImagery_Ingest.createKeywordsVector(builder, builder.createObjectOffsetList(this.keywords));
  ...
  const satId = AnalyticImagery_Ingest.createSatIdVector(builder, builder.createObjectOffsetList(this.satId));
  const satIdConf = AnalyticImagery_Ingest.createSatIdConfVector(builder, builder.createObjectOffsetList(this.satIdConf));
  const srcTyps = AnalyticImagery_Ingest.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = AnalyticImagery_Ingest.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  const tags = AnalyticImagery_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return AnalyticImagery_Ingest.createAnalyticImagery_Ingest(builder,
    id,
