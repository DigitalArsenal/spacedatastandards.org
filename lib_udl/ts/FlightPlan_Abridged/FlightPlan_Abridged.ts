...
import { FlightPlan_Abridged_dataMode_Enum } from './FlightPlan_Abridged_dataMode_Enum.js';


/**
 * /// Flight Plan contains data specifying the details of an intended flight including schedule and expected route.
 */
export class FlightPlan_Abridged implements flatbuffers.IUnpackableObject<FlightPlan_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):FlightPlan_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsFlightPlan_Abridged(bb:flatbuffers.ByteBuffer, obj?:FlightPlan_Abridged):FlightPlan_Abridged {
  return (obj || new FlightPlan_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsFlightPlan_Abridged(bb:flatbuffers.ByteBuffer, obj?:FlightPlan_Abridged):FlightPlan_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():FlightPlan_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 186);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : FlightPlan_Abridged_dataMode_Enum.REAL;
}
...
static startFlightPlan_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:FlightPlan_Abridged_dataMode_Enum) {
  builder.addFieldInt8(91, dataMode, FlightPlan_Abridged_dataMode_Enum.REAL);
}
...
static endFlightPlan_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishFlightPlan_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'FLIG');
}

static finishSizePrefixedFlightPlan_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'FLIG', true);
}

static createFlightPlan_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, amcMissionIdOffset:flatbuffers.Offset, idSortieOffset:flatbuffers.Offset, idAircraftOffset:flatbuffers.Offset, legNum:number, idDepAirfieldOffset:flatbuffers.Offset, depAirfieldOffset:flatbuffers.Offset, idArrAirfieldOffset:flatbuffers.Offset, arrAirfieldOffset:flatbuffers.Offset, externalIdOffset:flatbuffers.Offset, genTsOffset:flatbuffers.Offset, aircraftMdsOffset:flatbuffers.Offset, tailNumberOffset:flatbuffers.Offset, callSignOffset:flatbuffers.Offset, wxValidStartOffset:flatbuffers.Offset, wxValidEndOffset:flatbuffers.Offset, estDepTimeOffset:flatbuffers.Offset, dragIndex:number, fuelDegrade:number, opWeight:number, msnIndex:number, rampFuel:number, taxiFuel:number, takeoffFuel:number, climbFuel:number, climbTimeOffset:flatbuffers.Offset, holdDownFuel:number, tocIceFuel:number, tocFuel:number, enrouteFuel:number, enrouteTimeOffset:flatbuffers.Offset, thunderAvoidFuel:number, todIceFuel:number, opConditionFuel:number, todFuel:number, earlyDescentFuel:number, arrIceFuel:number, holdFuel:number, holdTimeOffset:flatbuffers.Offset, appLandingFuel:number, burnedFuel:number, landingFuel:number, minDivertFuel:number, arrAlternate1Fuel:number, arrAlternate2Fuel:number, contingencyFuel:number, reserveFuel:number, depressFuel:number, unusableFuel:number, unidentExtraFuel:number, identExtraFuel:number, remAlternate1Fuel:number, remAlternate2Fuel:number, enduranceTimeOffset:flatbuffers.Offset, sidOffset:flatbuffers.Offset, starOffset:flatbuffers.Offset, gpsRaimOffset:flatbuffers.Offset, depRunwayOffset:flatbuffers.Offset, arrRunwayOffset:flatbuffers.Offset, routeStringOffset:flatbuffers.Offset, countryCodesOffset:flatbuffers.Offset, etopsRatingOffset:flatbuffers.Offset, etopsAirfieldsOffset:flatbuffers.Offset, etopsAltAirfieldsOffset:flatbuffers.Offset, etopsValWindowOffset:flatbuffers.Offset, plannerRemarkOffset:flatbuffers.Offset, cargoRemarkOffset:flatbuffers.Offset, windFac1:number, windFac2:number, windFacAvg:number, avgTempDev:number, atcAddressesOffset:flatbuffers.Offset, originatorOffset:flatbuffers.Offset, numAircraft:number, flightRulesOffset:flatbuffers.Offset, flightTypeOffset:flatbuffers.Offset, initialCruiseSpeedOffset:flatbuffers.Offset, initialFlightLevelOffset:flatbuffers.Offset, arrAlternate1Offset:flatbuffers.Offset, arrAlternate2Offset:flatbuffers.Offset, depAlternateOffset:flatbuffers.Offset, wakeTurbCatOffset:flatbuffers.Offset, equipmentOffset:flatbuffers.Offset, notesOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:FlightPlan_Abridged_dataMode_Enum, airRefuelEventsOffset:flatbuffers.Offset, flightPlanMessagesOffset:flatbuffers.Offset, flightPlanWaypointsOffset:flatbuffers.Offset, flightPlanPointGroupsOffset:flatbuffers.Offset):flatbuffers.Offset {
  FlightPlan_Abridged.startFlightPlan_Abridged(builder);
  FlightPlan_Abridged.addId(builder, idOffset);
  FlightPlan_Abridged.addClassificationMarking(builder, classificationMarkingOffset);
  FlightPlan_Abridged.addAmcMissionId(builder, amcMissionIdOffset);
  FlightPlan_Abridged.addIdSortie(builder, idSortieOffset);
  FlightPlan_Abridged.addIdAircraft(builder, idAircraftOffset);
  FlightPlan_Abridged.addLegNum(builder, legNum);
  FlightPlan_Abridged.addIdDepAirfield(builder, idDepAirfieldOffset);
  FlightPlan_Abridged.addDepAirfield(builder, depAirfieldOffset);
  FlightPlan_Abridged.addIdArrAirfield(builder, idArrAirfieldOffset);
  FlightPlan_Abridged.addArrAirfield(builder, arrAirfieldOffset);
  FlightPlan_Abridged.addExternalId(builder, externalIdOffset);
  FlightPlan_Abridged.addGenTs(builder, genTsOffset);
  FlightPlan_Abridged.addAircraftMds(builder, aircraftMdsOffset);
  FlightPlan_Abridged.addTailNumber(builder, tailNumberOffset);
  FlightPlan_Abridged.addCallSign(builder, callSignOffset);
  FlightPlan_Abridged.addWxValidStart(builder, wxValidStartOffset);
  FlightPlan_Abridged.addWxValidEnd(builder, wxValidEndOffset);
  FlightPlan_Abridged.addEstDepTime(builder, estDepTimeOffset);
  FlightPlan_Abridged.addDragIndex(builder, dragIndex);
  FlightPlan_Abridged.addFuelDegrade(builder, fuelDegrade);
  FlightPlan_Abridged.addOpWeight(builder, opWeight);
  FlightPlan_Abridged.addMsnIndex(builder, msnIndex);
  FlightPlan_Abridged.addRampFuel(builder, rampFuel);
  FlightPlan_Abridged.addTaxiFuel(builder, taxiFuel);
  FlightPlan_Abridged.addTakeoffFuel(builder, takeoffFuel);
  FlightPlan_Abridged.addClimbFuel(builder, climbFuel);
  FlightPlan_Abridged.addClimbTime(builder, climbTimeOffset);
  FlightPlan_Abridged.addHoldDownFuel(builder, holdDownFuel);
  FlightPlan_Abridged.addTocIceFuel(builder, tocIceFuel);
  FlightPlan_Abridged.addTocFuel(builder, tocFuel);
  FlightPlan_Abridged.addEnrouteFuel(builder, enrouteFuel);
  FlightPlan_Abridged.addEnrouteTime(builder, enrouteTimeOffset);
  FlightPlan_Abridged.addThunderAvoidFuel(builder, thunderAvoidFuel);
  FlightPlan_Abridged.addTodIceFuel(builder, todIceFuel);
  FlightPlan_Abridged.addOpConditionFuel(builder, opConditionFuel);
  FlightPlan_Abridged.addTodFuel(builder, todFuel);
  FlightPlan_Abridged.addEarlyDescentFuel(builder, earlyDescentFuel);
  FlightPlan_Abridged.addArrIceFuel(builder, arrIceFuel);
  FlightPlan_Abridged.addHoldFuel(builder, holdFuel);
  FlightPlan_Abridged.addHoldTime(builder, holdTimeOffset);
  FlightPlan_Abridged.addAppLandingFuel(builder, appLandingFuel);
  FlightPlan_Abridged.addBurnedFuel(builder, burnedFuel);
  FlightPlan_Abridged.addLandingFuel(builder, landingFuel);
  FlightPlan_Abridged.addMinDivertFuel(builder, minDivertFuel);
  FlightPlan_Abridged.addArrAlternate1Fuel(builder, arrAlternate1Fuel);
  FlightPlan_Abridged.addArrAlternate2Fuel(builder, arrAlternate2Fuel);
  FlightPlan_Abridged.addContingencyFuel(builder, contingencyFuel);
  FlightPlan_Abridged.addReserveFuel(builder, reserveFuel);
  FlightPlan_Abridged.addDepressFuel(builder, depressFuel);
  FlightPlan_Abridged.addUnusableFuel(builder, unusableFuel);
  FlightPlan_Abridged.addUnidentExtraFuel(builder, unidentExtraFuel);
  FlightPlan_Abridged.addIdentExtraFuel(builder, identExtraFuel);
  FlightPlan_Abridged.addRemAlternate1Fuel(builder, remAlternate1Fuel);
  FlightPlan_Abridged.addRemAlternate2Fuel(builder, remAlternate2Fuel);
  FlightPlan_Abridged.addEnduranceTime(builder, enduranceTimeOffset);
  FlightPlan_Abridged.addSid(builder, sidOffset);
  FlightPlan_Abridged.addStar(builder, starOffset);
  FlightPlan_Abridged.addGpsRaim(builder, gpsRaimOffset);
  FlightPlan_Abridged.addDepRunway(builder, depRunwayOffset);
  FlightPlan_Abridged.addArrRunway(builder, arrRunwayOffset);
  FlightPlan_Abridged.addRouteString(builder, routeStringOffset);
  FlightPlan_Abridged.addCountryCodes(builder, countryCodesOffset);
  FlightPlan_Abridged.addEtopsRating(builder, etopsRatingOffset);
  FlightPlan_Abridged.addEtopsAirfields(builder, etopsAirfieldsOffset);
  FlightPlan_Abridged.addEtopsAltAirfields(builder, etopsAltAirfieldsOffset);
  FlightPlan_Abridged.addEtopsValWindow(builder, etopsValWindowOffset);
  FlightPlan_Abridged.addPlannerRemark(builder, plannerRemarkOffset);
  FlightPlan_Abridged.addCargoRemark(builder, cargoRemarkOffset);
  FlightPlan_Abridged.addWindFac1(builder, windFac1);
  FlightPlan_Abridged.addWindFac2(builder, windFac2);
  FlightPlan_Abridged.addWindFacAvg(builder, windFacAvg);
  FlightPlan_Abridged.addAvgTempDev(builder, avgTempDev);
  FlightPlan_Abridged.addAtcAddresses(builder, atcAddressesOffset);
  FlightPlan_Abridged.addOriginator(builder, originatorOffset);
  FlightPlan_Abridged.addNumAircraft(builder, numAircraft);
  FlightPlan_Abridged.addFlightRules(builder, flightRulesOffset);
  FlightPlan_Abridged.addFlightType(builder, flightTypeOffset);
  FlightPlan_Abridged.addInitialCruiseSpeed(builder, initialCruiseSpeedOffset);
  FlightPlan_Abridged.addInitialFlightLevel(builder, initialFlightLevelOffset);
  FlightPlan_Abridged.addArrAlternate1(builder, arrAlternate1Offset);
  FlightPlan_Abridged.addArrAlternate2(builder, arrAlternate2Offset);
  FlightPlan_Abridged.addDepAlternate(builder, depAlternateOffset);
  FlightPlan_Abridged.addWakeTurbCat(builder, wakeTurbCatOffset);
  FlightPlan_Abridged.addEquipment(builder, equipmentOffset);
  FlightPlan_Abridged.addNotes(builder, notesOffset);
  FlightPlan_Abridged.addCreatedAt(builder, createdAtOffset);
  FlightPlan_Abridged.addCreatedBy(builder, createdByOffset);
  FlightPlan_Abridged.addSourceDl(builder, sourceDlOffset);
  FlightPlan_Abridged.addSource(builder, sourceOffset);
  FlightPlan_Abridged.addOrigin(builder, originOffset);
  FlightPlan_Abridged.addOrigNetwork(builder, origNetworkOffset);
  FlightPlan_Abridged.addDataMode(builder, dataMode);
  FlightPlan_Abridged.addAirRefuelEvents(builder, airRefuelEventsOffset);
  FlightPlan_Abridged.addFlightPlanMessages(builder, flightPlanMessagesOffset);
  FlightPlan_Abridged.addFlightPlanWaypoints(builder, flightPlanWaypointsOffset);
  FlightPlan_Abridged.addFlightPlanPointGroups(builder, flightPlanPointGroupsOffset);
  return FlightPlan_Abridged.endFlightPlan_Abridged(builder);
}

unpack(): FlightPlan_AbridgedT {
  return new FlightPlan_AbridgedT(
    this.id(),
    ...
    this.arrRunway(),
    this.routeString(),
    this.bb!.createScalarList<string>(this.countryCodes.bind(this), this.countryCodesLength()),
    this.etopsRating(),
    this.bb!.createScalarList<string>(this.etopsAirfields.bind(this), this.etopsAirfieldsLength()),
    this.bb!.createScalarList<string>(this.etopsAltAirfields.bind(this), this.etopsAltAirfieldsLength()),
    this.etopsValWindow(),
    this.plannerRemark(),
    this.cargoRemark(),
    this.windFac1(),
    ...
    this.windFacAvg(),
    this.avgTempDev(),
    this.bb!.createScalarList<string>(this.atcAddresses.bind(this), this.atcAddressesLength()),
    this.originator(),
    this.numAircraft(),
    this.flightRules(),
    this.flightType(),
    ...
    this.origNetwork(),
    this.dataMode(),
    this.bb!.createScalarList<string>(this.airRefuelEvents.bind(this), this.airRefuelEventsLength()),
    this.bb!.createScalarList<string>(this.flightPlanMessages.bind(this), this.flightPlanMessagesLength()),
    this.bb!.createScalarList<string>(this.flightPlanWaypoints.bind(this), this.flightPlanWaypointsLength()),
    this.bb!.createScalarList<string>(this.flightPlanPointGroups.bind(this), this.flightPlanPointGroupsLength())
  );
}


unpackTo(_o: FlightPlan_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.countryCodes = this.bb!.createScalarList<string>(this.countryCodes.bind(this), this.countryCodesLength());
  _o.etopsRating = this.etopsRating();
  _o.etopsAirfields = this.bb!.createScalarList<string>(this.etopsAirfields.bind(this), this.etopsAirfieldsLength());
  _o.etopsAltAirfields = this.bb!.createScalarList<string>(this.etopsAltAirfields.bind(this), this.etopsAltAirfieldsLength());
  ...
  _o.atcAddresses = this.bb!.createScalarList<string>(this.atcAddresses.bind(this), this.atcAddressesLength());
  ...
  _o.airRefuelEvents = this.bb!.createScalarList<string>(this.airRefuelEvents.bind(this), this.airRefuelEventsLength());
  _o.flightPlanMessages = this.bb!.createScalarList<string>(this.flightPlanMessages.bind(this), this.flightPlanMessagesLength());
  _o.flightPlanWaypoints = this.bb!.createScalarList<string>(this.flightPlanWaypoints.bind(this), this.flightPlanWaypointsLength());
  _o.flightPlanPointGroups = this.bb!.createScalarList<string>(this.flightPlanPointGroups.bind(this), this.flightPlanPointGroupsLength());
}
}

export class FlightPlan_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: FlightPlan_Abridged_dataMode_Enum = FlightPlan_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const countryCodes = FlightPlan_Abridged.createCountryCodesVector(builder, builder.createObjectOffsetList(this.countryCodes));
  const etopsRating = (this.etopsRating !== null ? builder.createString(this.etopsRating!) : 0);
  const etopsAirfields = FlightPlan_Abridged.createEtopsAirfieldsVector(builder, builder.createObjectOffsetList(this.etopsAirfields));
  const etopsAltAirfields = FlightPlan_Abridged.createEtopsAltAirfieldsVector(builder, builder.createObjectOffsetList(this.etopsAltAirfields));
  ...
  const atcAddresses = FlightPlan_Abridged.createAtcAddressesVector(builder, builder.createObjectOffsetList(this.atcAddresses));
  ...
  const airRefuelEvents = FlightPlan_Abridged.createAirRefuelEventsVector(builder, builder.createObjectOffsetList(this.airRefuelEvents));
  const flightPlanMessages = FlightPlan_Abridged.createFlightPlanMessagesVector(builder, builder.createObjectOffsetList(this.flightPlanMessages));
  const flightPlanWaypoints = FlightPlan_Abridged.createFlightPlanWaypointsVector(builder, builder.createObjectOffsetList(this.flightPlanWaypoints));
  const flightPlanPointGroups = FlightPlan_Abridged.createFlightPlanPointGroupsVector(builder, builder.createObjectOffsetList(this.flightPlanPointGroups));

  return FlightPlan_Abridged.createFlightPlan_Abridged(builder,
    id,
