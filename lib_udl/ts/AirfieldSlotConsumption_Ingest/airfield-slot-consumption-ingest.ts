...
import { AirfieldSlotConsumption_Ingest_dataMode_Enum } from './airfield-slot-consumption-ingest-data-mode-enum.js';
import { AirfieldSlotConsumption_Ingest_status_Enum } from './airfield-slot-consumption-ingest-status-enum.js';


/**
 * /// Airfield slot use data. Contains the dynamic data associated with the status and use of specific airfield slots.
 */
export class AirfieldSlotConsumption_Ingest implements flatbuffers.IUnpackableObject<AirfieldSlotConsumption_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirfieldSlotConsumption_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirfieldSlotConsumption_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirfieldSlotConsumption_Ingest):AirfieldSlotConsumption_Ingest {
  return (obj || new AirfieldSlotConsumption_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirfieldSlotConsumption_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirfieldSlotConsumption_Ingest):AirfieldSlotConsumption_Ingest {
 ...
 */
status():AirfieldSlotConsumption_Ingest_status_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 10);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirfieldSlotConsumption_Ingest_status_Enum.REQUESTED;
}
 ...
 */
dataMode():AirfieldSlotConsumption_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 76);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirfieldSlotConsumption_Ingest_dataMode_Enum.REAL;
}

static startAirfieldSlotConsumption_Ingest(builder:flatbuffers.Builder) {
...
static addStatus(builder:flatbuffers.Builder, status:AirfieldSlotConsumption_Ingest_status_Enum) {
  builder.addFieldInt8(3, status, AirfieldSlotConsumption_Ingest_status_Enum.REQUESTED);
}
...
unpack(): AirfieldSlotConsumption_IngestT {
  return new AirfieldSlotConsumption_IngestT(
    this.id(),
...
unpackTo(_o: AirfieldSlotConsumption_IngestT): void {
  _o.id = this.id();
...
export class AirfieldSlotConsumption_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  public id: string|Uint8Array|null = null,
  public classificationMarking: string|Uint8Array|null = null,
  public idAirfieldSlot: string|Uint8Array|null = null,
  public status: AirfieldSlotConsumption_Ingest_status_Enum = AirfieldSlotConsumption_Ingest_status_Enum.REQUESTED,
  ...
  public dataMode: AirfieldSlotConsumption_Ingest_dataMode_Enum = AirfieldSlotConsumption_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const callSigns = AirfieldSlotConsumption_Ingest.createCallSignsVector(builder, builder.createObjectOffsetList(this.callSigns));
  ...
  return AirfieldSlotConsumption_Ingest.createAirfieldSlotConsumption_Ingest(builder,
    id,
