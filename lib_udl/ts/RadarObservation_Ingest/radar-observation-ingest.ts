...
import { RadarObservation_Ingest_dataMode_Enum } from './radar-observation-ingest-data-mode-enum.js';
import { RadarObservation_Ingest_senReferenceFrame_Enum } from './radar-observation-ingest-sen-reference-frame-enum.js';
 ...
 */
export class RadarObservation_Ingest implements flatbuffers.IUnpackableObject<RadarObservation_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):RadarObservation_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsRadarObservation_Ingest(bb:flatbuffers.ByteBuffer, obj?:RadarObservation_Ingest):RadarObservation_Ingest {
  return (obj || new RadarObservation_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRadarObservation_Ingest(bb:flatbuffers.ByteBuffer, obj?:RadarObservation_Ingest):RadarObservation_Ingest {
...
dataMode():RadarObservation_Ingest_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RadarObservation_Ingest_dataMode_Enum.REAL;
}
...
senReferenceFrame():RadarObservation_Ingest_senReferenceFrame_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RadarObservation_Ingest_senReferenceFrame_Enum.J2000;
}
...
static startRadarObservation_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:RadarObservation_Ingest_dataMode_Enum) {
  builder.addFieldInt8(51, dataMode, RadarObservation_Ingest_dataMode_Enum.REAL);
}
...
static addSenReferenceFrame(builder:flatbuffers.Builder, senReferenceFrame:RadarObservation_Ingest_senReferenceFrame_Enum) {
  builder.addFieldInt8(55, senReferenceFrame, RadarObservation_Ingest_senReferenceFrame_Enum.J2000);
}

static addDescriptor(builder:flatbuffers.Builder, descriptorOffset:flatbuffers.Offset) {
  builder.addFieldOffset(56, descriptorOffset, 0);
}

static addOrigNetwork(builder:flatbuffers.Builder, origNetworkOffset:flatbuffers.Offset) {
  builder.addFieldOffset(57, origNetworkOffset, 0);
}

static addSourceDl(builder:flatbuffers.Builder, sourceDlOffset:flatbuffers.Offset) {
  builder.addFieldOffset(58, sourceDlOffset, 0);
}

static addType(builder:flatbuffers.Builder, typeOffset:flatbuffers.Offset) {
  builder.addFieldOffset(59, typeOffset, 0);
}

static endRadarObservation_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishRadarObservation_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'RADA');
}

static finishSizePrefixedRadarObservation_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'RADA', true);
}

static createRadarObservation_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, obTimeOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, satNo:number, taskIdOffset:flatbuffers.Offset, transactionIdOffset:flatbuffers.Offset, trackIdOffset:flatbuffers.Offset, obPositionOffset:flatbuffers.Offset, origObjectIdOffset:flatbuffers.Offset, origSensorIdOffset:flatbuffers.Offset, uct:boolean, azimuth:number, azimuthUnc:number, azimuthBias:number, azimuthRate:number, elevation:number, elevationUnc:number, elevationBias:number, elevationRate:number, range:number, rangeAccel:number, rangeAccelUnc:number, rangeUnc:number, rangeBias:number, rangeRate:number, rangeRateUnc:number, doppler:number, dopplerUnc:number, ra:number, declination:number, x:number, y:number, z:number, xvel:number, yvel:number, zvel:number, senx:number, seny:number, senz:number, rcs:number, rcsUnc:number, orthogonalRcs:number, orthogonalRcsUnc:number, snr:number, beam:number, timingBias:number, rawFileUriOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:RadarObservation_Ingest_dataMode_Enum, tagsOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, senReferenceFrame:RadarObservation_Ingest_senReferenceFrame_Enum, descriptorOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset):flatbuffers.Offset {
  RadarObservation_Ingest.startRadarObservation_Ingest(builder);
...
unpack(): RadarObservation_IngestT {
  return new RadarObservation_IngestT(
    this.id(),
...
unpackTo(_o: RadarObservation_IngestT): void {
  _o.id = this.id();
...
export class RadarObservation_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: RadarObservation_Ingest_dataMode_Enum = RadarObservation_Ingest_dataMode_Enum.REAL,
  public tags: (string)[] = [],
  public createdAt: string|Uint8Array|null = null,
  public createdBy: string|Uint8Array|null = null,
  public senReferenceFrame: RadarObservation_Ingest_senReferenceFrame_Enum = RadarObservation_Ingest_senReferenceFrame_Enum.J2000,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = RadarObservation_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return RadarObservation_Ingest.createRadarObservation_Ingest(builder,
    id,
