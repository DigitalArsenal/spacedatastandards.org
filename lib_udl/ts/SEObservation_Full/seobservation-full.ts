 ...
 */
export class SEObservation_Full implements flatbuffers.IUnpackableObject<SEObservation_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SEObservation_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSEObservation_Full(bb:flatbuffers.ByteBuffer, obj?:SEObservation_Full):SEObservation_Full {
  return (obj || new SEObservation_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSEObservation_Full(bb:flatbuffers.ByteBuffer, obj?:SEObservation_Full):SEObservation_Full {
...
static startSEObservation_Full(builder:flatbuffers.Builder) {
...
static endSEObservation_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSEObservation_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SEOB');
}

static finishSizePrefixedSEObservation_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SEOB', true);
}

static createSEObservation_Full(builder:flatbuffers.Builder, obTypeOffset:flatbuffers.Offset, obUoMOffset:flatbuffers.Offset, obValue:number, obStringOffset:flatbuffers.Offset, obArrayOffset:flatbuffers.Offset, obBool:boolean, obQualityOffset:flatbuffers.Offset, obDescriptionOffset:flatbuffers.Offset):flatbuffers.Offset {
  SEObservation_Full.startSEObservation_Full(builder);
...
unpack(): SEObservation_FullT {
  return new SEObservation_FullT(
    this.obType(),
    this.obUoM(),
    this.obValue(),
    this.obString(),
    this.bb!.createScalarList<string>(this.obArray.bind(this), this.obArray_Length()),
    this.obBool(),
    this.obQuality(),
    this.obDescription()
  );
...
unpackTo(_o: SEObservation_FullT): void {
  _o.obType = this.obType();
  _o.obUoM = this.obUoM();
  _o.obValue = this.obValue();
  _o.obString = this.obString();
  _o.obArray = this.bb!.createScalarList<string>(this.obArray.bind(this), this.obArray_Length());
...
export class SEObservation_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const obArray = SEObservation_Full.createObArrayVector(builder, builder.createObjectOffsetList(this.obArray));
  ...
  return SEObservation_Full.createSEObservation_Full(builder,
    obType,
    obUoM,
    this.obValue,
    obString,
