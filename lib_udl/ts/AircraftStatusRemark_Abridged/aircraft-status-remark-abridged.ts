...
import { AircraftStatusRemark_Abridged_dataMode_Enum } from './aircraft-status-remark-abridged-data-mode-enum.js';


/**
 * /// Properties and characteristics of a remark that is associated with an aircraft status.
 */
export class AircraftStatusRemark_Abridged implements flatbuffers.IUnpackableObject<AircraftStatusRemark_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AircraftStatusRemark_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAircraftStatusRemark_Abridged(bb:flatbuffers.ByteBuffer, obj?:AircraftStatusRemark_Abridged):AircraftStatusRemark_Abridged {
  return (obj || new AircraftStatusRemark_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAircraftStatusRemark_Abridged(bb:flatbuffers.ByteBuffer, obj?:AircraftStatusRemark_Abridged):AircraftStatusRemark_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():AircraftStatusRemark_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 34);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AircraftStatusRemark_Abridged_dataMode_Enum.REAL;
}

static startAircraftStatusRemark_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AircraftStatusRemark_Abridged_dataMode_Enum) {
  builder.addFieldInt8(15, dataMode, AircraftStatusRemark_Abridged_dataMode_Enum.REAL);
}

static endAircraftStatusRemark_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAircraftStatusRemark_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRC');
}

static finishSizePrefixedAircraftStatusRemark_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRC', true);
}

static createAircraftStatusRemark_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idAircraftStatusOffset:flatbuffers.Offset, altRmkIdOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, textOffset:flatbuffers.Offset, timestampOffset:flatbuffers.Offset, lastUpdatedByOffset:flatbuffers.Offset, lastUpdatedAtOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:AircraftStatusRemark_Abridged_dataMode_Enum):flatbuffers.Offset {
  AircraftStatusRemark_Abridged.startAircraftStatusRemark_Abridged(builder);
...
unpack(): AircraftStatusRemark_AbridgedT {
  return new AircraftStatusRemark_AbridgedT(
    this.id(),
...
unpackTo(_o: AircraftStatusRemark_AbridgedT): void {
  _o.id = this.id();
...
export class AircraftStatusRemark_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AircraftStatusRemark_Abridged_dataMode_Enum = AircraftStatusRemark_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AircraftStatusRemark_Abridged.createAircraftStatusRemark_Abridged(builder,
    id,
