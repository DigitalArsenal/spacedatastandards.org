...
import { OnorbitEvent_Ingest_dataMode_Enum } from './onorbit-event-ingest-data-mode-enum.js';


/**
 * /// No description available.
 */
export class OnorbitEvent_Ingest implements flatbuffers.IUnpackableObject<OnorbitEvent_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OnorbitEvent_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOnorbitEvent_Ingest(bb:flatbuffers.ByteBuffer, obj?:OnorbitEvent_Ingest):OnorbitEvent_Ingest {
  return (obj || new OnorbitEvent_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOnorbitEvent_Ingest(bb:flatbuffers.ByteBuffer, obj?:OnorbitEvent_Ingest):OnorbitEvent_Ingest {
 ...
 */
dataMode():OnorbitEvent_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 104);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OnorbitEvent_Ingest_dataMode_Enum.REAL;
}
...
static startOnorbitEvent_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:OnorbitEvent_Ingest_dataMode_Enum) {
  builder.addFieldInt8(50, dataMode, OnorbitEvent_Ingest_dataMode_Enum.REAL);
}
...
unpack(): OnorbitEvent_IngestT {
  return new OnorbitEvent_IngestT(
    this.id(),
...
unpackTo(_o: OnorbitEvent_IngestT): void {
  _o.id = this.id();
...
export class OnorbitEvent_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: OnorbitEvent_Ingest_dataMode_Enum = OnorbitEvent_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return OnorbitEvent_Ingest.createOnorbitEvent_Ingest(builder,
    id,
