...
import { AirTransportMission_Ingest_dataMode_Enum } from './AirTransportMission_Ingest_dataMode_Enum.js';
 ...
 */
export class AirTransportMission_Ingest implements flatbuffers.IUnpackableObject<AirTransportMission_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirTransportMission_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirTransportMission_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirTransportMission_Ingest):AirTransportMission_Ingest {
  return (obj || new AirTransportMission_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirTransportMission_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirTransportMission_Ingest):AirTransportMission_Ingest {
 ...
 */
dataMode():AirTransportMission_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 70);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirTransportMission_Ingest_dataMode_Enum.REAL;
}
...
static startAirTransportMission_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AirTransportMission_Ingest_dataMode_Enum) {
  builder.addFieldInt8(33, dataMode, AirTransportMission_Ingest_dataMode_Enum.REAL);
}
...
static endAirTransportMission_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirTransportMission_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRT');
}

static finishSizePrefixedAirTransportMission_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRT', true);
}

static createAirTransportMission_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, origMissionIdOffset:flatbuffers.Offset, amcMissionIdOffset:flatbuffers.Offset, gdssMissionIdOffset:flatbuffers.Offset, prevMissionIdOffset:flatbuffers.Offset, prevAmcmissionIdOffset:flatbuffers.Offset, nextMissionIdOffset:flatbuffers.Offset, nextAmcmissionIdOffset:flatbuffers.Offset, objectiveOffset:flatbuffers.Offset, purposeOffset:flatbuffers.Offset, jcsPriorityOffset:flatbuffers.Offset, cw:boolean, typeOffset:flatbuffers.Offset, firstPickUpOffset:flatbuffers.Offset, lastDropOffOffset:flatbuffers.Offset, aliasOffset:flatbuffers.Offset, callSignOffset:flatbuffers.Offset, operationOffset:flatbuffers.Offset, nafOffset:flatbuffers.Offset, allocatedUnitOffset:flatbuffers.Offset, loadCategoryTypeOffset:flatbuffers.Offset, stateOffset:flatbuffers.Offset, sourceSysDeviation:number, apacsIdOffset:flatbuffers.Offset, dipWorksheetNameOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:AirTransportMission_Ingest_dataMode_Enum, origNetworkOffset:flatbuffers.Offset, requirementsOffset:flatbuffers.Offset, remarksOffset:flatbuffers.Offset, hazMatOffset:flatbuffers.Offset):flatbuffers.Offset {
  AirTransportMission_Ingest.startAirTransportMission_Ingest(builder);
  AirTransportMission_Ingest.addId(builder, idOffset);
  AirTransportMission_Ingest.addClassificationMarking(builder, classificationMarkingOffset);
  AirTransportMission_Ingest.addOrigMissionId(builder, origMissionIdOffset);
  AirTransportMission_Ingest.addAmcMissionId(builder, amcMissionIdOffset);
  AirTransportMission_Ingest.addGdssMissionId(builder, gdssMissionIdOffset);
  AirTransportMission_Ingest.addPrevMissionId(builder, prevMissionIdOffset);
  AirTransportMission_Ingest.addPrevAmcmissionId(builder, prevAmcmissionIdOffset);
  AirTransportMission_Ingest.addNextMissionId(builder, nextMissionIdOffset);
  AirTransportMission_Ingest.addNextAmcmissionId(builder, nextAmcmissionIdOffset);
  AirTransportMission_Ingest.addObjective(builder, objectiveOffset);
  AirTransportMission_Ingest.addPurpose(builder, purposeOffset);
  AirTransportMission_Ingest.addJcsPriority(builder, jcsPriorityOffset);
  AirTransportMission_Ingest.addCw(builder, cw);
  AirTransportMission_Ingest.addType(builder, typeOffset);
  AirTransportMission_Ingest.addFirstPickUp(builder, firstPickUpOffset);
  AirTransportMission_Ingest.addLastDropOff(builder, lastDropOffOffset);
  AirTransportMission_Ingest.addAlias(builder, aliasOffset);
  AirTransportMission_Ingest.addCallSign(builder, callSignOffset);
  AirTransportMission_Ingest.addOperation(builder, operationOffset);
  AirTransportMission_Ingest.addNaf(builder, nafOffset);
  AirTransportMission_Ingest.addAllocatedUnit(builder, allocatedUnitOffset);
  AirTransportMission_Ingest.addLoadCategoryType(builder, loadCategoryTypeOffset);
  AirTransportMission_Ingest.addState(builder, stateOffset);
  AirTransportMission_Ingest.addSourceSysDeviation(builder, sourceSysDeviation);
  AirTransportMission_Ingest.addApacsId(builder, apacsIdOffset);
  AirTransportMission_Ingest.addDipWorksheetName(builder, dipWorksheetNameOffset);
  AirTransportMission_Ingest.addCreatedAt(builder, createdAtOffset);
  AirTransportMission_Ingest.addCreatedBy(builder, createdByOffset);
  AirTransportMission_Ingest.addUpdatedAt(builder, updatedAtOffset);
  AirTransportMission_Ingest.addUpdatedBy(builder, updatedByOffset);
  AirTransportMission_Ingest.addSourceDl(builder, sourceDlOffset);
  AirTransportMission_Ingest.addSource(builder, sourceOffset);
  AirTransportMission_Ingest.addOrigin(builder, originOffset);
  AirTransportMission_Ingest.addDataMode(builder, dataMode);
  AirTransportMission_Ingest.addOrigNetwork(builder, origNetworkOffset);
  AirTransportMission_Ingest.addRequirements(builder, requirementsOffset);
  AirTransportMission_Ingest.addRemarks(builder, remarksOffset);
  AirTransportMission_Ingest.addHazMat(builder, hazMatOffset);
  return AirTransportMission_Ingest.endAirTransportMission_Ingest(builder);
}

unpack(): AirTransportMission_IngestT {
  return new AirTransportMission_IngestT(
    this.id(),
    ...
    this.dataMode(),
    this.origNetwork(),
    this.bb!.createScalarList<string>(this.requirements.bind(this), this.requirementsLength()),
    this.bb!.createScalarList<string>(this.remarks.bind(this), this.remarksLength()),
    this.bb!.createScalarList<string>(this.hazMat.bind(this), this.hazMatLength())
  );
}


unpackTo(_o: AirTransportMission_IngestT): void {
  _o.id = this.id();
  ...
  _o.requirements = this.bb!.createScalarList<string>(this.requirements.bind(this), this.requirementsLength());
  _o.remarks = this.bb!.createScalarList<string>(this.remarks.bind(this), this.remarksLength());
  _o.hazMat = this.bb!.createScalarList<string>(this.hazMat.bind(this), this.hazMatLength());
}
}

export class AirTransportMission_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AirTransportMission_Ingest_dataMode_Enum = AirTransportMission_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const requirements = AirTransportMission_Ingest.createRequirementsVector(builder, builder.createObjectOffsetList(this.requirements));
  const remarks = AirTransportMission_Ingest.createRemarksVector(builder, builder.createObjectOffsetList(this.remarks));
  const hazMat = AirTransportMission_Ingest.createHazMatVector(builder, builder.createObjectOffsetList(this.hazMat));

  return AirTransportMission_Ingest.createAirTransportMission_Ingest(builder,
    id,
