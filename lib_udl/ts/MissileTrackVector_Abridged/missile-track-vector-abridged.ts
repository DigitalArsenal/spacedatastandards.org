 ...
 */
export class MissileTrackVector_Abridged implements flatbuffers.IUnpackableObject<MissileTrackVector_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MissileTrackVector_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMissileTrackVector_Abridged(bb:flatbuffers.ByteBuffer, obj?:MissileTrackVector_Abridged):MissileTrackVector_Abridged {
  return (obj || new MissileTrackVector_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMissileTrackVector_Abridged(bb:flatbuffers.ByteBuffer, obj?:MissileTrackVector_Abridged):MissileTrackVector_Abridged {
...
static startMissileTrackVector_Abridged(builder:flatbuffers.Builder) {
...
static endMissileTrackVector_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishMissileTrackVector_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MISS');
}

static finishSizePrefixedMissileTrackVector_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MISS', true);
}

static createMissileTrackVector_Abridged(builder:flatbuffers.Builder, typeOffset:flatbuffers.Offset, objectOffset:flatbuffers.Offset, epochOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, origSensorIdOffset:flatbuffers.Offset, posOffset:flatbuffers.Offset, velOffset:flatbuffers.Offset, accelOffset:flatbuffers.Offset, course:number, spd:number, referenceFrameOffset:flatbuffers.Offset, covOffset:flatbuffers.Offset, covReferenceFrameOffset:flatbuffers.Offset, vectorLat:number, vectorLon:number, vectorAlt:number, confidence:number, statusOffset:flatbuffers.Offset, timeSourceOffset:flatbuffers.Offset, quatOffset:flatbuffers.Offset, flightAz:number):flatbuffers.Offset {
  MissileTrackVector_Abridged.startMissileTrackVector_Abridged(builder);
  MissileTrackVector_Abridged.addType(builder, typeOffset);
  MissileTrackVector_Abridged.addObject(builder, objectOffset);
  MissileTrackVector_Abridged.addEpoch(builder, epochOffset);
  MissileTrackVector_Abridged.addIdSensor(builder, idSensorOffset);
  MissileTrackVector_Abridged.addOrigSensorId(builder, origSensorIdOffset);
  MissileTrackVector_Abridged.addPos(builder, posOffset);
  MissileTrackVector_Abridged.addVel(builder, velOffset);
  MissileTrackVector_Abridged.addAccel(builder, accelOffset);
  MissileTrackVector_Abridged.addCourse(builder, course);
  MissileTrackVector_Abridged.addSpd(builder, spd);
  MissileTrackVector_Abridged.addReferenceFrame(builder, referenceFrameOffset);
  MissileTrackVector_Abridged.addCov(builder, covOffset);
  MissileTrackVector_Abridged.addCovReferenceFrame(builder, covReferenceFrameOffset);
  MissileTrackVector_Abridged.addVectorLat(builder, vectorLat);
  MissileTrackVector_Abridged.addVectorLon(builder, vectorLon);
  MissileTrackVector_Abridged.addVectorAlt(builder, vectorAlt);
  MissileTrackVector_Abridged.addConfidence(builder, confidence);
  MissileTrackVector_Abridged.addStatus(builder, statusOffset);
  MissileTrackVector_Abridged.addTimeSource(builder, timeSourceOffset);
  MissileTrackVector_Abridged.addQuat(builder, quatOffset);
  MissileTrackVector_Abridged.addFlightAz(builder, flightAz);
  return MissileTrackVector_Abridged.endMissileTrackVector_Abridged(builder);
}

unpack(): MissileTrackVector_AbridgedT {
  return new MissileTrackVector_AbridgedT(
    this.type(),
    this.object(),
    this.epoch(),
    this.idSensor(),
    this.origSensorId(),
    this.bb!.createScalarList<string>(this.pos.bind(this), this.pos_Length()),
    this.bb!.createScalarList<string>(this.vel.bind(this), this.vel_Length()),
    this.bb!.createScalarList<string>(this.accel.bind(this), this.accel_Length()),
    this.course(),
    this.spd(),
    this.referenceFrame(),
...
unpackTo(_o: MissileTrackVector_AbridgedT): void {
  _o.type = this.type();
  _o.object = this.object();
  _o.epoch = this.epoch();
  _o.idSensor = this.idSensor();
  _o.origSensorId = this.origSensorId();
  _o.pos = this.bb!.createScalarList<string>(this.pos.bind(this), this.pos_Length());
  _o.vel = this.bb!.createScalarList<string>(this.vel.bind(this), this.vel_Length());
  _o.accel = this.bb!.createScalarList<string>(this.accel.bind(this), this.accel_Length());
...
export class MissileTrackVector_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const pos = MissileTrackVector_Abridged.createPosVector(builder, builder.createObjectOffsetList(this.pos));
  const vel = MissileTrackVector_Abridged.createVelVector(builder, builder.createObjectOffsetList(this.vel));
  const accel = MissileTrackVector_Abridged.createAccelVector(builder, builder.createObjectOffsetList(this.accel));
  const referenceFrame = (this.referenceFrame !== null ? builder.createString(this.referenceFrame!) : 0);
  const cov = MissileTrackVector_Abridged.createCovVector(builder, builder.createObjectOffsetList(this.cov));
  ...
  const quat = MissileTrackVector_Abridged.createQuatVector(builder, builder.createObjectOffsetList(this.quat));

  return MissileTrackVector_Abridged.createMissileTrackVector_Abridged(builder,
    type,
    object,
    epoch,
    idSensor,
