...
import { DataLink_Ingest_dataMode_Enum } from './data-link-ingest-data-mode-enum.js';


/**
 * /// Beta Version DataLink: Detailed instructions regarding the operations of data links.
 */
export class DataLink_Ingest implements flatbuffers.IUnpackableObject<DataLink_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):DataLink_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsDataLink_Ingest(bb:flatbuffers.ByteBuffer, obj?:DataLink_Ingest):DataLink_Ingest {
  return (obj || new DataLink_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsDataLink_Ingest(bb:flatbuffers.ByteBuffer, obj?:DataLink_Ingest):DataLink_Ingest {
 ...
 */
dataMode():DataLink_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 150);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : DataLink_Ingest_dataMode_Enum.REAL;
}

static startDataLink_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:DataLink_Ingest_dataMode_Enum) {
  builder.addFieldInt8(73, dataMode, DataLink_Ingest_dataMode_Enum.REAL);
}

static endDataLink_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishDataLink_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DATA');
}

static finishSizePrefixedDataLink_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DATA', true);
}

static createDataLink_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, opExNameOffset:flatbuffers.Offset, originatorOffset:flatbuffers.Offset, startTimeOffset:flatbuffers.Offset, stopTimeOffset:flatbuffers.Offset, stopTimeModOffset:flatbuffers.Offset, planOrigNumOffset:flatbuffers.Offset, opExInfoOffset:flatbuffers.Offset, opExInfoAltOffset:flatbuffers.Offset, serialNumOffset:flatbuffers.Offset, monthOffset:flatbuffers.Offset, qualifierOffset:flatbuffers.Offset, qualSn:number, referencesOffset:flatbuffers.Offset, canxIdOffset:flatbuffers.Offset, canxOriginatorOffset:flatbuffers.Offset, canxTsOffset:flatbuffers.Offset, canxSerialNumOffset:flatbuffers.Offset, canxSpecialNotationOffset:flatbuffers.Offset, canxSicsOffset:flatbuffers.Offset, pocNameOffset:flatbuffers.Offset, pocRankOffset:flatbuffers.Offset, pocCallSignOffset:flatbuffers.Offset, pocLocNameOffset:flatbuffers.Offset, pocLat:number, pocLon:number, pocNumsOffset:flatbuffers.Offset, geoDatumOffset:flatbuffers.Offset, refPointsOffset:flatbuffers.Offset, voiceCoordOffset:flatbuffers.Offset, sysDefaultCodeOffset:flatbuffers.Offset, winSizeMult:number, winSizeMin:number, minTrackQual:number, maxTrackQual:number, resTrackQual:number, courseDiff:number, speedDiff:number, altDiff:number, minGeoPosQual:number, maxGeoPosQual:number, decorrWinMult:number, consecDecorr:number, multiDutyOffset:flatbuffers.Offset, opsOffset:flatbuffers.Offset, jreUnitDesOffset:flatbuffers.Offset, jreCallSignOffset:flatbuffers.Offset, jrePriAdd:number, jreSecAdd:number, jreDetailsOffset:flatbuffers.Offset, specTracksOffset:flatbuffers.Offset, nonLinkUnitDesOffset:flatbuffers.Offset, trackNumBlockLlsOffset:flatbuffers.Offset, trackNumBlocksOffset:flatbuffers.Offset, mgmtCodeOffset:flatbuffers.Offset, mgmtCodeMeaningOffset:flatbuffers.Offset, ackReq:boolean, ackInstUnitsOffset:flatbuffers.Offset, classSourceOffset:flatbuffers.Offset, classReasonsOffset:flatbuffers.Offset, decInstDatesOffset:flatbuffers.Offset, decExemptCodesOffset:flatbuffers.Offset, remarksOffset:flatbuffers.Offset, rawFileUriOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:DataLink_Ingest_dataMode_Enum):flatbuffers.Offset {
  DataLink_Ingest.startDataLink_Ingest(builder);
  DataLink_Ingest.addId(builder, idOffset);
  DataLink_Ingest.addClassificationMarking(builder, classificationMarkingOffset);
  DataLink_Ingest.addOpExName(builder, opExNameOffset);
  DataLink_Ingest.addOriginator(builder, originatorOffset);
  DataLink_Ingest.addStartTime(builder, startTimeOffset);
  DataLink_Ingest.addStopTime(builder, stopTimeOffset);
  DataLink_Ingest.addStopTimeMod(builder, stopTimeModOffset);
  DataLink_Ingest.addPlanOrigNum(builder, planOrigNumOffset);
  DataLink_Ingest.addOpExInfo(builder, opExInfoOffset);
  DataLink_Ingest.addOpExInfoAlt(builder, opExInfoAltOffset);
  DataLink_Ingest.addSerialNum(builder, serialNumOffset);
  DataLink_Ingest.addMonth(builder, monthOffset);
  DataLink_Ingest.addQualifier(builder, qualifierOffset);
  DataLink_Ingest.addQualSn(builder, qualSn);
  DataLink_Ingest.addReferences(builder, referencesOffset);
  DataLink_Ingest.addCanxId(builder, canxIdOffset);
  DataLink_Ingest.addCanxOriginator(builder, canxOriginatorOffset);
  DataLink_Ingest.addCanxTs(builder, canxTsOffset);
  DataLink_Ingest.addCanxSerialNum(builder, canxSerialNumOffset);
  DataLink_Ingest.addCanxSpecialNotation(builder, canxSpecialNotationOffset);
  DataLink_Ingest.addCanxSics(builder, canxSicsOffset);
  DataLink_Ingest.addPocName(builder, pocNameOffset);
  DataLink_Ingest.addPocRank(builder, pocRankOffset);
  DataLink_Ingest.addPocCallSign(builder, pocCallSignOffset);
  DataLink_Ingest.addPocLocName(builder, pocLocNameOffset);
  DataLink_Ingest.addPocLat(builder, pocLat);
  DataLink_Ingest.addPocLon(builder, pocLon);
  DataLink_Ingest.addPocNums(builder, pocNumsOffset);
  DataLink_Ingest.addGeoDatum(builder, geoDatumOffset);
  DataLink_Ingest.addRefPoints(builder, refPointsOffset);
  DataLink_Ingest.addVoiceCoord(builder, voiceCoordOffset);
  DataLink_Ingest.addSysDefaultCode(builder, sysDefaultCodeOffset);
  DataLink_Ingest.addWinSizeMult(builder, winSizeMult);
  DataLink_Ingest.addWinSizeMin(builder, winSizeMin);
  DataLink_Ingest.addMinTrackQual(builder, minTrackQual);
  DataLink_Ingest.addMaxTrackQual(builder, maxTrackQual);
  DataLink_Ingest.addResTrackQual(builder, resTrackQual);
  DataLink_Ingest.addCourseDiff(builder, courseDiff);
  DataLink_Ingest.addSpeedDiff(builder, speedDiff);
  DataLink_Ingest.addAltDiff(builder, altDiff);
  DataLink_Ingest.addMinGeoPosQual(builder, minGeoPosQual);
  DataLink_Ingest.addMaxGeoPosQual(builder, maxGeoPosQual);
  DataLink_Ingest.addDecorrWinMult(builder, decorrWinMult);
  DataLink_Ingest.addConsecDecorr(builder, consecDecorr);
  DataLink_Ingest.addMultiDuty(builder, multiDutyOffset);
  DataLink_Ingest.addOps(builder, opsOffset);
  DataLink_Ingest.addJreUnitDes(builder, jreUnitDesOffset);
  DataLink_Ingest.addJreCallSign(builder, jreCallSignOffset);
  DataLink_Ingest.addJrePriAdd(builder, jrePriAdd);
  DataLink_Ingest.addJreSecAdd(builder, jreSecAdd);
  DataLink_Ingest.addJreDetails(builder, jreDetailsOffset);
  DataLink_Ingest.addSpecTracks(builder, specTracksOffset);
  DataLink_Ingest.addNonLinkUnitDes(builder, nonLinkUnitDesOffset);
  DataLink_Ingest.addTrackNumBlockLls(builder, trackNumBlockLlsOffset);
  DataLink_Ingest.addTrackNumBlocks(builder, trackNumBlocksOffset);
  DataLink_Ingest.addMgmtCode(builder, mgmtCodeOffset);
  DataLink_Ingest.addMgmtCodeMeaning(builder, mgmtCodeMeaningOffset);
  DataLink_Ingest.addAckReq(builder, ackReq);
  DataLink_Ingest.addAckInstUnits(builder, ackInstUnitsOffset);
  DataLink_Ingest.addClassSource(builder, classSourceOffset);
  DataLink_Ingest.addClassReasons(builder, classReasonsOffset);
  DataLink_Ingest.addDecInstDates(builder, decInstDatesOffset);
  DataLink_Ingest.addDecExemptCodes(builder, decExemptCodesOffset);
  DataLink_Ingest.addRemarks(builder, remarksOffset);
  DataLink_Ingest.addRawFileUri(builder, rawFileUriOffset);
  DataLink_Ingest.addCreatedAt(builder, createdAtOffset);
  DataLink_Ingest.addCreatedBy(builder, createdByOffset);
  DataLink_Ingest.addUpdatedAt(builder, updatedAtOffset);
  DataLink_Ingest.addUpdatedBy(builder, updatedByOffset);
  DataLink_Ingest.addSourceDl(builder, sourceDlOffset);
  DataLink_Ingest.addSource(builder, sourceOffset);
  DataLink_Ingest.addOrigin(builder, originOffset);
  DataLink_Ingest.addOrigNetwork(builder, origNetworkOffset);
  DataLink_Ingest.addDataMode(builder, dataMode);
  return DataLink_Ingest.endDataLink_Ingest(builder);
}

unpack(): DataLink_IngestT {
  return new DataLink_IngestT(
    this.id(),
    ...
    this.qualifier(),
    this.qualSn(),
    this.bb!.createScalarList<string>(this.references.bind(this), this.references_Length()),
    this.canxId(),
    this.canxOriginator(),
    this.canxTs(),
    this.canxSerialNum(),
    this.canxSpecialNotation(),
    this.bb!.createScalarList<string>(this.canxSics.bind(this), this.canxSICs_Length()),
    this.pocName(),
    this.pocRank(),
    this.pocCallSign(),
    this.pocLocName(),
    this.pocLat(),
    this.pocLon(),
    this.bb!.createScalarList<string>(this.pocNums.bind(this), this.pocNums_Length()),
    this.geoDatum(),
    this.bb!.createScalarList<string>(this.refPoints.bind(this), this.refPoints_Length()),
    this.bb!.createScalarList<string>(this.voiceCoord.bind(this), this.voiceCoord_Length()),
    this.sysDefaultCode(),
    this.winSizeMult(),
    this.winSizeMin(),
    this.minTrackQual(),
    ...
    this.decorrWinMult(),
    this.consecDecorr(),
    this.bb!.createScalarList<string>(this.multiDuty.bind(this), this.multiDuty_Length()),
    this.bb!.createScalarList<string>(this.ops.bind(this), this.ops_Length()),
    this.jreUnitDes(),
    this.jreCallSign(),
    this.jrePriAdd(),
    this.jreSecAdd(),
    this.jreDetails(),
    this.bb!.createScalarList<string>(this.specTracks.bind(this), this.specTracks_Length()),
    this.bb!.createScalarList<string>(this.nonLinkUnitDes.bind(this), this.nonLinkUnitDes_Length()),
    this.bb!.createScalarList<string>(this.trackNumBlockLls.bind(this), this.trackNumBlockLLs_Length()),
    this.bb!.createScalarList<string>(this.trackNumBlocks.bind(this), this.trackNumBlocks_Length()),
    this.mgmtCode(),
    this.mgmtCodeMeaning(),
    this.ackReq(),
    this.bb!.createScalarList<string>(this.ackInstUnits.bind(this), this.ackInstUnits_Length()),
    this.classSource(),
    this.bb!.createScalarList<string>(this.classReasons.bind(this), this.classReasons_Length()),
    this.bb!.createScalarList<string>(this.decInstDates.bind(this), this.decInstDates_Length()),
    this.bb!.createScalarList<string>(this.decExemptCodes.bind(this), this.decExemptCodes_Length()),
...
unpackTo(_o: DataLink_IngestT): void {
  _o.id = this.id();
  ...
  _o.references = this.bb!.createScalarList<string>(this.references.bind(this), this.references_Length());
  ...
  _o.canxSICs = this.bb!.createScalarList<string>(this.canxSics.bind(this), this.canxSICs_Length());
  ...
  _o.pocNums = this.bb!.createScalarList<string>(this.pocNums.bind(this), this.pocNums_Length());
  _o.geoDatum = this.geoDatum();
  _o.refPoints = this.bb!.createScalarList<string>(this.refPoints.bind(this), this.refPoints_Length());
  _o.voiceCoord = this.bb!.createScalarList<string>(this.voiceCoord.bind(this), this.voiceCoord_Length());
  ...
  _o.multiDuty = this.bb!.createScalarList<string>(this.multiDuty.bind(this), this.multiDuty_Length());
  _o.ops = this.bb!.createScalarList<string>(this.ops.bind(this), this.ops_Length());
  ...
  _o.specTracks = this.bb!.createScalarList<string>(this.specTracks.bind(this), this.specTracks_Length());
  _o.nonLinkUnitDes = this.bb!.createScalarList<string>(this.nonLinkUnitDes.bind(this), this.nonLinkUnitDes_Length());
  _o.trackNumBlockLLs = this.bb!.createScalarList<string>(this.trackNumBlockLls.bind(this), this.trackNumBlockLLs_Length());
  _o.trackNumBlocks = this.bb!.createScalarList<string>(this.trackNumBlocks.bind(this), this.trackNumBlocks_Length());
  _o.mgmtCode = this.mgmtCode();
  _o.mgmtCodeMeaning = this.mgmtCodeMeaning();
  _o.ackReq = this.ackReq();
  _o.ackInstUnits = this.bb!.createScalarList<string>(this.ackInstUnits.bind(this), this.ackInstUnits_Length());
  _o.classSource = this.classSource();
  _o.classReasons = this.bb!.createScalarList<string>(this.classReasons.bind(this), this.classReasons_Length());
  _o.decInstDates = this.bb!.createScalarList<string>(this.decInstDates.bind(this), this.decInstDates_Length());
  _o.decExemptCodes = this.bb!.createScalarList<string>(this.decExemptCodes.bind(this), this.decExemptCodes_Length());
...
export class DataLink_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: DataLink_Ingest_dataMode_Enum = DataLink_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const references = DataLink_Ingest.createReferencesVector(builder, builder.createObjectOffsetList(this.references));
  ...
  const canxSICs = DataLink_Ingest.createCanxSicsVector(builder, builder.createObjectOffsetList(this.canxSICs));
  ...
  const pocNums = DataLink_Ingest.createPocNumsVector(builder, builder.createObjectOffsetList(this.pocNums));
  const geoDatum = (this.geoDatum !== null ? builder.createString(this.geoDatum!) : 0);
  const refPoints = DataLink_Ingest.createRefPointsVector(builder, builder.createObjectOffsetList(this.refPoints));
  const voiceCoord = DataLink_Ingest.createVoiceCoordVector(builder, builder.createObjectOffsetList(this.voiceCoord));
  const sysDefaultCode = (this.sysDefaultCode !== null ? builder.createString(this.sysDefaultCode!) : 0);
  const multiDuty = DataLink_Ingest.createMultiDutyVector(builder, builder.createObjectOffsetList(this.multiDuty));
  const ops = DataLink_Ingest.createOpsVector(builder, builder.createObjectOffsetList(this.ops));
  ...
  const specTracks = DataLink_Ingest.createSpecTracksVector(builder, builder.createObjectOffsetList(this.specTracks));
  const nonLinkUnitDes = DataLink_Ingest.createNonLinkUnitDesVector(builder, builder.createObjectOffsetList(this.nonLinkUnitDes));
  const trackNumBlockLLs = DataLink_Ingest.createTrackNumBlockLlsVector(builder, builder.createObjectOffsetList(this.trackNumBlockLLs));
  const trackNumBlocks = DataLink_Ingest.createTrackNumBlocksVector(builder, builder.createObjectOffsetList(this.trackNumBlocks));
  ...
  const ackInstUnits = DataLink_Ingest.createAckInstUnitsVector(builder, builder.createObjectOffsetList(this.ackInstUnits));
  const classSource = (this.classSource !== null ? builder.createString(this.classSource!) : 0);
  const classReasons = DataLink_Ingest.createClassReasonsVector(builder, builder.createObjectOffsetList(this.classReasons));
  const decInstDates = DataLink_Ingest.createDecInstDatesVector(builder, builder.createObjectOffsetList(this.decInstDates));
  const decExemptCodes = DataLink_Ingest.createDecExemptCodesVector(builder, builder.createObjectOffsetList(this.decExemptCodes));
  const remarks = DataLink_Ingest.createRemarksVector(builder, builder.createObjectOffsetList(this.remarks));
  ...
  return DataLink_Ingest.createDataLink_Ingest(builder,
    id,
