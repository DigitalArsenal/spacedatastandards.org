...
import { AircraftStatus_Ingest_airToAirStatus_Enum } from './aircraft-status-ingest-air-to-air-status-enum.js';
import { AircraftStatus_Ingest_airToGroundStatus_Enum } from './aircraft-status-ingest-air-to-ground-status-enum.js';
import { AircraftStatus_Ingest_dataMode_Enum } from './aircraft-status-ingest-data-mode-enum.js';
