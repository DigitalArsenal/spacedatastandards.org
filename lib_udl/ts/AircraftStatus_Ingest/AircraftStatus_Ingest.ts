...
import { AircraftStatus_Ingest_airToAirStatus_Enum } from './AircraftStatus_Ingest_airToAirStatus_Enum.js';
import { AircraftStatus_Ingest_airToGroundStatus_Enum } from './AircraftStatus_Ingest_airToGroundStatus_Enum.js';
import { AircraftStatus_Ingest_dataMode_Enum } from './AircraftStatus_Ingest_dataMode_Enum.js';
 ...
 */
export class AircraftStatus_Ingest implements flatbuffers.IUnpackableObject<AircraftStatus_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AircraftStatus_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAircraftStatus_Ingest(bb:flatbuffers.ByteBuffer, obj?:AircraftStatus_Ingest):AircraftStatus_Ingest {
  return (obj || new AircraftStatus_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAircraftStatus_Ingest(bb:flatbuffers.ByteBuffer, obj?:AircraftStatus_Ingest):AircraftStatus_Ingest {
...
airToAirStatus():AircraftStatus_Ingest_airToAirStatus_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AircraftStatus_Ingest_airToAirStatus_Enum.OPERATIONAL;
}
...
airToGroundStatus():AircraftStatus_Ingest_airToGroundStatus_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AircraftStatus_Ingest_airToGroundStatus_Enum.OPERATIONAL;
}
...
dataMode():AircraftStatus_Ingest_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AircraftStatus_Ingest_dataMode_Enum.REAL;
}
...
static startAircraftStatus_Ingest(builder:flatbuffers.Builder) {
...
static addAirToAirStatus(builder:flatbuffers.Builder, airToAirStatus:AircraftStatus_Ingest_airToAirStatus_Enum) {
  builder.addFieldInt8(20, airToAirStatus, AircraftStatus_Ingest_airToAirStatus_Enum.OPERATIONAL);
}

static addAirToGroundStatus(builder:flatbuffers.Builder, airToGroundStatus:AircraftStatus_Ingest_airToGroundStatus_Enum) {
  builder.addFieldInt8(21, airToGroundStatus, AircraftStatus_Ingest_airToGroundStatus_Enum.OPERATIONAL);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AircraftStatus_Ingest_dataMode_Enum) {
  builder.addFieldInt8(50, dataMode, AircraftStatus_Ingest_dataMode_Enum.REAL);
}
...
unpack(): AircraftStatus_IngestT {
  return new AircraftStatus_IngestT(
    this.id(),
...
unpackTo(_o: AircraftStatus_IngestT): void {
  _o.id = this.id();
...
export class AircraftStatus_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public airToAirStatus: AircraftStatus_Ingest_airToAirStatus_Enum = AircraftStatus_Ingest_airToAirStatus_Enum.OPERATIONAL,
  public airToGroundStatus: AircraftStatus_Ingest_airToGroundStatus_Enum = AircraftStatus_Ingest_airToGroundStatus_Enum.OPERATIONAL,
  ...
  public dataMode: AircraftStatus_Ingest_dataMode_Enum = AircraftStatus_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const inventory = AircraftStatus_Ingest.createInventoryVector(builder, builder.createObjectOffsetList(this.inventory));
  const inventoryMin = AircraftStatus_Ingest.createInventoryMinVector(builder, builder.createObjectOffsetList(this.inventoryMin));
  const inventoryMax = AircraftStatus_Ingest.createInventoryMaxVector(builder, builder.createObjectOffsetList(this.inventoryMax));
  const unavailableSys = AircraftStatus_Ingest.createUnavailableSysVector(builder, builder.createObjectOffsetList(this.unavailableSys));
  const additionalSys = AircraftStatus_Ingest.createAdditionalSysVector(builder, builder.createObjectOffsetList(this.additionalSys));
  ...
  return AircraftStatus_Ingest.createAircraftStatus_Ingest(builder,
    id,
