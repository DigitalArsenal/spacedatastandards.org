...
import { LinkStatus_Abridged_dataMode_Enum } from './link-status-abridged-data-mode-enum.js';


/**
 * /// Captures link status.
 */
export class LinkStatus_Abridged implements flatbuffers.IUnpackableObject<LinkStatus_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LinkStatus_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLinkStatus_Abridged(bb:flatbuffers.ByteBuffer, obj?:LinkStatus_Abridged):LinkStatus_Abridged {
  return (obj || new LinkStatus_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLinkStatus_Abridged(bb:flatbuffers.ByteBuffer, obj?:LinkStatus_Abridged):LinkStatus_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():LinkStatus_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 60);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : LinkStatus_Abridged_dataMode_Enum.REAL;
}
...
static startLinkStatus_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:LinkStatus_Abridged_dataMode_Enum) {
  builder.addFieldInt8(28, dataMode, LinkStatus_Abridged_dataMode_Enum.REAL);
}
...
unpack(): LinkStatus_AbridgedT {
  return new LinkStatus_AbridgedT(
    this.id(),
...
unpackTo(_o: LinkStatus_AbridgedT): void {
  _o.id = this.id();
...
export class LinkStatus_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: LinkStatus_Abridged_dataMode_Enum = LinkStatus_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return LinkStatus_Abridged.createLinkStatus_Abridged(builder,
    id,
