...
import { EOObservation_Ingest_dataMode_Enum } from './eoobservation-ingest-data-mode-enum.js';
import { EOObservation_Ingest_referenceFrame_Enum } from './eoobservation-ingest-reference-frame-enum.js';
import { EOObservation_Ingest_senReferenceFrame_Enum } from './eoobservation-ingest-sen-reference-frame-enum.js';
 ...
 */
export class EOObservation_Ingest implements flatbuffers.IUnpackableObject<EOObservation_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EOObservation_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEOObservation_Ingest(bb:flatbuffers.ByteBuffer, obj?:EOObservation_Ingest):EOObservation_Ingest {
  return (obj || new EOObservation_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEOObservation_Ingest(bb:flatbuffers.ByteBuffer, obj?:EOObservation_Ingest):EOObservation_Ingest {
 ...
 */
dataMode():EOObservation_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 164);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : EOObservation_Ingest_dataMode_Enum.REAL;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 24
 */
referenceFrame():EOObservation_Ingest_referenceFrame_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 176);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : EOObservation_Ingest_referenceFrame_Enum.J2000;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 24
 */
senReferenceFrame():EOObservation_Ingest_senReferenceFrame_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 178);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : EOObservation_Ingest_senReferenceFrame_Enum.J2000;
}
...
static startEOObservation_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:EOObservation_Ingest_dataMode_Enum) {
  builder.addFieldInt8(80, dataMode, EOObservation_Ingest_dataMode_Enum.REAL);
}
...
static addReferenceFrame(builder:flatbuffers.Builder, referenceFrame:EOObservation_Ingest_referenceFrame_Enum) {
  builder.addFieldInt8(86, referenceFrame, EOObservation_Ingest_referenceFrame_Enum.J2000);
}

static addSenReferenceFrame(builder:flatbuffers.Builder, senReferenceFrame:EOObservation_Ingest_senReferenceFrame_Enum) {
  builder.addFieldInt8(87, senReferenceFrame, EOObservation_Ingest_senReferenceFrame_Enum.J2000);
}

static addUmbra(builder:flatbuffers.Builder, umbra:boolean) {
  builder.addFieldInt8(88, +umbra, +false);
}

static addPenumbra(builder:flatbuffers.Builder, penumbra:boolean) {
  builder.addFieldInt8(89, +penumbra, +false);
}
...
unpack(): EOObservation_IngestT {
  return new EOObservation_IngestT(
    this.id(),
...
unpackTo(_o: EOObservation_IngestT): void {
  _o.id = this.id();
...
export class EOObservation_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: EOObservation_Ingest_dataMode_Enum = EOObservation_Ingest_dataMode_Enum.REAL,
  public tags: (string)[] = [],
  public createdAt: string|Uint8Array|null = null,
  public createdBy: string|Uint8Array|null = null,
  public zeroPtdUnc: number = 0.0,
  public eoobservationDetails: string|Uint8Array|null = null,
  public referenceFrame: EOObservation_Ingest_referenceFrame_Enum = EOObservation_Ingest_referenceFrame_Enum.J2000,
  public senReferenceFrame: EOObservation_Ingest_senReferenceFrame_Enum = EOObservation_Ingest_senReferenceFrame_Enum.J2000,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const senQuat = EOObservation_Ingest.createSenQuatVector(builder, builder.createObjectOffsetList(this.senQuat));
  ...
  const tags = EOObservation_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return EOObservation_Ingest.createEOObservation_Ingest(builder,
    id,
