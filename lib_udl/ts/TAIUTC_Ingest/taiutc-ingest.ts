...
import { TAIUTC_Ingest_dataMode_Enum } from './taiutc-ingest-data-mode-enum.js';
 ...
 */
export class TAIUTC_Ingest implements flatbuffers.IUnpackableObject<TAIUTC_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):TAIUTC_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsTAIUTC_Ingest(bb:flatbuffers.ByteBuffer, obj?:TAIUTC_Ingest):TAIUTC_Ingest {
  return (obj || new TAIUTC_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTAIUTC_Ingest(bb:flatbuffers.ByteBuffer, obj?:TAIUTC_Ingest):TAIUTC_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():TAIUTC_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 22);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : TAIUTC_Ingest_dataMode_Enum.REAL;
}
...
static startTAIUTC_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:TAIUTC_Ingest_dataMode_Enum) {
  builder.addFieldInt8(9, dataMode, TAIUTC_Ingest_dataMode_Enum.REAL);
}
...
static endTAIUTC_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishTAIUTC_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TAIU');
}

static finishSizePrefixedTAIUTC_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TAIU', true);
}

static createTAIUTC_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, adjustmentDateOffset:flatbuffers.Offset, taiUtc:number, multiplicationFactor:number, rawFileUriOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:TAIUTC_Ingest_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset):flatbuffers.Offset {
  TAIUTC_Ingest.startTAIUTC_Ingest(builder);
...
unpack(): TAIUTC_IngestT {
  return new TAIUTC_IngestT(
    this.id(),
...
unpackTo(_o: TAIUTC_IngestT): void {
  _o.id = this.id();
...
export class TAIUTC_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: TAIUTC_Ingest_dataMode_Enum = TAIUTC_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return TAIUTC_Ingest.createTAIUTC_Ingest(builder,
    id,
