...
import { StateVector_Abridged_covReferenceFrame_Enum } from './StateVector_Abridged_covReferenceFrame_Enum.js';
import { StateVector_Abridged_dataMode_Enum } from './StateVector_Abridged_dataMode_Enum.js';
import { StateVector_Abridged_referenceFrame_Enum } from './StateVector_Abridged_referenceFrame_Enum.js';
 ...
 */
export class StateVector_Abridged implements flatbuffers.IUnpackableObject<StateVector_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):StateVector_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsStateVector_Abridged(bb:flatbuffers.ByteBuffer, obj?:StateVector_Abridged):StateVector_Abridged {
  return (obj || new StateVector_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsStateVector_Abridged(bb:flatbuffers.ByteBuffer, obj?:StateVector_Abridged):StateVector_Abridged {
 ...
 */
referenceFrame():StateVector_Abridged_referenceFrame_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 34);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : StateVector_Abridged_referenceFrame_Enum.J2000;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 24
 */
covReferenceFrame():StateVector_Abridged_covReferenceFrame_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 38);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : StateVector_Abridged_covReferenceFrame_Enum.J2000;
}
 ...
 */
dataMode():StateVector_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 172);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : StateVector_Abridged_dataMode_Enum.REAL;
}
...
static startStateVector_Abridged(builder:flatbuffers.Builder) {
...
static addReferenceFrame(builder:flatbuffers.Builder, referenceFrame:StateVector_Abridged_referenceFrame_Enum) {
  builder.addFieldInt8(15, referenceFrame, StateVector_Abridged_referenceFrame_Enum.J2000);
}
...
static addCovReferenceFrame(builder:flatbuffers.Builder, covReferenceFrame:StateVector_Abridged_covReferenceFrame_Enum) {
  builder.addFieldInt8(17, covReferenceFrame, StateVector_Abridged_covReferenceFrame_Enum.J2000);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:StateVector_Abridged_dataMode_Enum) {
  builder.addFieldInt8(84, dataMode, StateVector_Abridged_dataMode_Enum.REAL);
}

static addAlgorithm(builder:flatbuffers.Builder, algorithmOffset:flatbuffers.Offset) {
  builder.addFieldOffset(85, algorithmOffset, 0);
}

static addCreatedAt(builder:flatbuffers.Builder, createdAtOffset:flatbuffers.Offset) {
  builder.addFieldOffset(86, createdAtOffset, 0);
}

static addCreatedBy(builder:flatbuffers.Builder, createdByOffset:flatbuffers.Offset) {
  builder.addFieldOffset(87, createdByOffset, 0);
}

static addDescriptor(builder:flatbuffers.Builder, descriptorOffset:flatbuffers.Offset) {
  builder.addFieldOffset(88, descriptorOffset, 0);
}

static addTransactionId(builder:flatbuffers.Builder, transactionIdOffset:flatbuffers.Offset) {
  builder.addFieldOffset(89, transactionIdOffset, 0);
}
...
unpack(): StateVector_AbridgedT {
  return new StateVector_AbridgedT(
    this.idStateVector(),
...
unpackTo(_o: StateVector_AbridgedT): void {
...
export class StateVector_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public referenceFrame: StateVector_Abridged_referenceFrame_Enum = StateVector_Abridged_referenceFrame_Enum.J2000,
  public cov: (string)[] = [],
  public covReferenceFrame: StateVector_Abridged_covReferenceFrame_Enum = StateVector_Abridged_covReferenceFrame_Enum.J2000,
  ...
  public dataMode: StateVector_Abridged_dataMode_Enum = StateVector_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const cov = StateVector_Abridged.createCovVector(builder, builder.createObjectOffsetList(this.cov));
  const covMethod = (this.covMethod !== null ? builder.createString(this.covMethod!) : 0);
  const eqCov = StateVector_Abridged.createEqCovVector(builder, builder.createObjectOffsetList(this.eqCov));
  ...
  const sigmaPosUvw = StateVector_Abridged.createSigmaPosUvwVector(builder, builder.createObjectOffsetList(this.sigmaPosUvw));
  const sigmaVelUvw = StateVector_Abridged.createSigmaVelUvwVector(builder, builder.createObjectOffsetList(this.sigmaVelUvw));
  ...
  return StateVector_Abridged.createStateVector_Abridged(builder,
    idStateVector,
