...
import { ManifoldElset_Abridged_dataMode_Enum } from './manifold-elset-abridged-data-mode-enum.js';
 ...
 */
export class ManifoldElset_Abridged implements flatbuffers.IUnpackableObject<ManifoldElset_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):ManifoldElset_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsManifoldElset_Abridged(bb:flatbuffers.ByteBuffer, obj?:ManifoldElset_Abridged):ManifoldElset_Abridged {
  return (obj || new ManifoldElset_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsManifoldElset_Abridged(bb:flatbuffers.ByteBuffer, obj?:ManifoldElset_Abridged):ManifoldElset_Abridged {
 ...
 */
dataMode():ManifoldElset_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 54);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : ManifoldElset_Abridged_dataMode_Enum.REAL;
}
...
static startManifoldElset_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:ManifoldElset_Abridged_dataMode_Enum) {
  builder.addFieldInt8(25, dataMode, ManifoldElset_Abridged_dataMode_Enum.REAL);
}
...
unpack(): ManifoldElset_AbridgedT {
  return new ManifoldElset_AbridgedT(
    this.id(),
    this.idManifold(),
...
unpackTo(_o: ManifoldElset_AbridgedT): void {
  _o.id = this.id();
...
export class ManifoldElset_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: ManifoldElset_Abridged_dataMode_Enum = ManifoldElset_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return ManifoldElset_Abridged.createManifoldElset_Abridged(builder,
    id,
    idManifold,
