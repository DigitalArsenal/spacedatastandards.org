 ...
 */
export class LogisticsSupportItems_Full implements flatbuffers.IUnpackableObject<LogisticsSupportItems_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LogisticsSupportItems_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLogisticsSupportItems_Full(bb:flatbuffers.ByteBuffer, obj?:LogisticsSupportItems_Full):LogisticsSupportItems_Full {
  return (obj || new LogisticsSupportItems_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLogisticsSupportItems_Full(bb:flatbuffers.ByteBuffer, obj?:LogisticsSupportItems_Full):LogisticsSupportItems_Full {
...
static startLogisticsSupportItems_Full(builder:flatbuffers.Builder) {
...
unpack(): LogisticsSupportItems_FullT {
  return new LogisticsSupportItems_FullT(
...
unpackTo(_o: LogisticsSupportItems_FullT): void {
...
export class LogisticsSupportItems_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const logisticsParts = LogisticsSupportItems_Full.createLogisticsPartsVector(builder, builder.createObjectOffsetList(this.logisticsParts));
  const logisticsSpecialties = LogisticsSupportItems_Full.createLogisticsSpecialtiesVector(builder, builder.createObjectOffsetList(this.logisticsSpecialties));
  const logisticsRemarks = LogisticsSupportItems_Full.createLogisticsRemarksVector(builder, builder.createObjectOffsetList(this.logisticsRemarks));

  return LogisticsSupportItems_Full.createLogisticsSupportItems_Full(builder,
