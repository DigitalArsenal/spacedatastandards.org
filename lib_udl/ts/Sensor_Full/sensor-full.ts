...
import { Sensor_Full_dataMode_Enum } from './sensor-full-data-mode-enum.js';


/**
 * /// Model representation of observation data for electro-optical based sensor phenomenologies.
 */
export class Sensor_Full implements flatbuffers.IUnpackableObject<Sensor_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Sensor_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSensor_Full(bb:flatbuffers.ByteBuffer, obj?:Sensor_Full):Sensor_Full {
  return (obj || new Sensor_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSensor_Full(bb:flatbuffers.ByteBuffer, obj?:Sensor_Full):Sensor_Full {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Sensor_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 26);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Sensor_Full_dataMode_Enum.REAL;
}
...
static startSensor_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Sensor_Full_dataMode_Enum) {
  builder.addFieldInt8(11, dataMode, Sensor_Full_dataMode_Enum.REAL);
}
...
static addSensorStats(builder:flatbuffers.Builder, sensorStatsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(18, sensorStatsOffset, 0);
}
...
static addSensorlimitsCollection(builder:flatbuffers.Builder, sensorlimitsCollectionOffset:flatbuffers.Offset) {
  builder.addFieldOffset(19, sensorlimitsCollectionOffset, 0);
}
...
static addEntity(builder:flatbuffers.Builder, entityOffset:flatbuffers.Offset) {
  builder.addFieldOffset(20, entityOffset, 0);
}

static addIdEntity(builder:flatbuffers.Builder, idEntityOffset:flatbuffers.Offset) {
  builder.addFieldOffset(21, idEntityOffset, 0);
}

static addSensorObservationType(builder:flatbuffers.Builder, sensorObservationTypeOffset:flatbuffers.Offset) {
  builder.addFieldOffset(22, sensorObservationTypeOffset, 0);
}

static addSensorType(builder:flatbuffers.Builder, sensorTypeOffset:flatbuffers.Offset) {
  builder.addFieldOffset(23, sensorTypeOffset, 0);
}

static endSensor_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSensor_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SENS');
}

static finishSizePrefixedSensor_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SENS', true);
}

static createSensor_Full(builder:flatbuffers.Builder, idSensorOffset:flatbuffers.Offset, sensorNameOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, sensorNumber:number, shortNameOffset:flatbuffers.Offset, dataControlOffset:flatbuffers.Offset, afIdOffset:flatbuffers.Offset, asrTypeOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:Sensor_Full_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, active:boolean, sensorcharacteristicsOffset:flatbuffers.Offset, sensorStatsOffset:flatbuffers.Offset, sensorlimitsCollectionOffset:flatbuffers.Offset, entityOffset:flatbuffers.Offset, idEntityOffset:flatbuffers.Offset, sensorObservationTypeOffset:flatbuffers.Offset, sensorTypeOffset:flatbuffers.Offset):flatbuffers.Offset {
  Sensor_Full.startSensor_Full(builder);
...
unpack(): Sensor_FullT {
  return new Sensor_FullT(
    ...
    this.updatedBy(),
    this.active(),
    this.bb!.createScalarList<string>(this.sensorcharacteristics.bind(this), this.sensorcharacteristics_Length()),
    this.bb!.createScalarList<string>(this.sensorStats.bind(this), this.sensorStats_Length()),
    this.bb!.createScalarList<string>(this.sensorlimitsCollection.bind(this), this.sensorlimitsCollection_Length()),
    this.entity(),
    this.idEntity(),
...
unpackTo(_o: Sensor_FullT): void {
  ...
  _o.sensorcharacteristics = this.bb!.createScalarList<string>(this.sensorcharacteristics.bind(this), this.sensorcharacteristics_Length());
  _o.sensorStats = this.bb!.createScalarList<string>(this.sensorStats.bind(this), this.sensorStats_Length());
  _o.sensorlimitsCollection = this.bb!.createScalarList<string>(this.sensorlimitsCollection.bind(this), this.sensorlimitsCollection_Length());
...
export class Sensor_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Sensor_Full_dataMode_Enum = Sensor_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const sensorcharacteristics = Sensor_Full.createSensorcharacteristicsVector(builder, builder.createObjectOffsetList(this.sensorcharacteristics));
  const sensorStats = Sensor_Full.createSensorStatsVector(builder, builder.createObjectOffsetList(this.sensorStats));
  const sensorlimitsCollection = Sensor_Full.createSensorlimitsCollectionVector(builder, builder.createObjectOffsetList(this.sensorlimitsCollection));
  ...
  return Sensor_Full.createSensor_Full(builder,
    idSensor,
    sensorName,
