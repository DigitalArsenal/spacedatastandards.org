...
import { AntennaDetails_Abridged_dataMode_Enum } from './antenna-details-abridged-data-mode-enum.js';
import { AntennaDetails_Abridged_mode_Enum } from './antenna-details-abridged-mode-enum.js';
 ...
 */
export class AntennaDetails_Abridged implements flatbuffers.IUnpackableObject<AntennaDetails_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AntennaDetails_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAntennaDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:AntennaDetails_Abridged):AntennaDetails_Abridged {
  return (obj || new AntennaDetails_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAntennaDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:AntennaDetails_Abridged):AntennaDetails_Abridged {
 ...
 */
mode():AntennaDetails_Abridged_mode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 14);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AntennaDetails_Abridged_mode_Enum.TX;
}
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():AntennaDetails_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 50);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AntennaDetails_Abridged_dataMode_Enum.REAL;
}

static startAntennaDetails_Abridged(builder:flatbuffers.Builder) {
...
static addMode(builder:flatbuffers.Builder, mode:AntennaDetails_Abridged_mode_Enum) {
  builder.addFieldInt8(5, mode, AntennaDetails_Abridged_mode_Enum.TX);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AntennaDetails_Abridged_dataMode_Enum) {
  builder.addFieldInt8(23, dataMode, AntennaDetails_Abridged_dataMode_Enum.REAL);
}

static endAntennaDetails_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAntennaDetails_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ANTE');
}

static finishSizePrefixedAntennaDetails_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ANTE', true);
}

static createAntennaDetails_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idAntennaOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, positionOffset:flatbuffers.Offset, mode:AntennaDetails_Abridged_mode_Enum, steerable:boolean, beamForming:boolean, manufacturerOrgIdOffset:flatbuffers.Offset, diameter:number, sizeOffset:flatbuffers.Offset, startFrequency:number, endFrequency:number, beamwidth:number, gain:number, gainTolerance:number, polarization:number, descriptionOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:AntennaDetails_Abridged_dataMode_Enum):flatbuffers.Offset {
  AntennaDetails_Abridged.startAntennaDetails_Abridged(builder);
...
unpack(): AntennaDetails_AbridgedT {
  return new AntennaDetails_AbridgedT(
    this.id(),
    this.idAntenna(),
...
unpackTo(_o: AntennaDetails_AbridgedT): void {
  _o.id = this.id();
...
export class AntennaDetails_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public mode: AntennaDetails_Abridged_mode_Enum = AntennaDetails_Abridged_mode_Enum.TX,
  ...
  public dataMode: AntennaDetails_Abridged_dataMode_Enum = AntennaDetails_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const size = AntennaDetails_Abridged.createSizeVector(builder, builder.createObjectOffsetList(this.size));
  ...
  return AntennaDetails_Abridged.createAntennaDetails_Abridged(builder,
    id,
    idAntenna,
