...
import { SARObservation_Ingest_dataMode_Enum } from './sarobservation-ingest-data-mode-enum.js';
 ...
 */
export class SARObservation_Ingest implements flatbuffers.IUnpackableObject<SARObservation_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SARObservation_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSARObservation_Ingest(bb:flatbuffers.ByteBuffer, obj?:SARObservation_Ingest):SARObservation_Ingest {
  return (obj || new SARObservation_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSARObservation_Ingest(bb:flatbuffers.ByteBuffer, obj?:SARObservation_Ingest):SARObservation_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SARObservation_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 140);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SARObservation_Ingest_dataMode_Enum.REAL;
}

static startSARObservation_Ingest(builder:flatbuffers.Builder) {
...
static addCreatedAt(builder:flatbuffers.Builder, createdAtOffset:flatbuffers.Offset) {
  builder.addFieldOffset(62, createdAtOffset, 0);
}

static addCreatedBy(builder:flatbuffers.Builder, createdByOffset:flatbuffers.Offset) {
  builder.addFieldOffset(63, createdByOffset, 0);
}
...
unpack(): SARObservation_IngestT {
  return new SARObservation_IngestT(
    this.id(),
...
unpackTo(_o: SARObservation_IngestT): void {
  _o.id = this.id();
...
export class SARObservation_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SARObservation_Ingest_dataMode_Enum = SARObservation_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = SARObservation_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  const srcTyps = SARObservation_Ingest.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = SARObservation_Ingest.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  ...
  return SARObservation_Ingest.createSARObservation_Ingest(builder,
    id,
