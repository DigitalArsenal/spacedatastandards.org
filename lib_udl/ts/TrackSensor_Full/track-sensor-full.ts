...
import { TrackSensor_Full_sensorFOVType_Enum } from './track-sensor-full-sensor-fovtype-enum.js';


/**
 * /// Schema for Track Sensor data.
 */
export class TrackSensor_Full implements flatbuffers.IUnpackableObject<TrackSensor_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):TrackSensor_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsTrackSensor_Full(bb:flatbuffers.ByteBuffer, obj?:TrackSensor_Full):TrackSensor_Full {
  return (obj || new TrackSensor_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTrackSensor_Full(bb:flatbuffers.ByteBuffer, obj?:TrackSensor_Full):TrackSensor_Full {
...
sensorFovtype():TrackSensor_Full_sensorFOVType_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : TrackSensor_Full_sensorFOVType_Enum.BUTTERFLY;
}

static startTrackSensor_Full(builder:flatbuffers.Builder) {
...
static addSensorFovtype(builder:flatbuffers.Builder, sensorFovtype:TrackSensor_Full_sensorFOVType_Enum) {
  builder.addFieldInt8(6, sensorFovtype, TrackSensor_Full_sensorFOVType_Enum.BUTTERFLY);
}

static endTrackSensor_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishTrackSensor_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TRAC');
}

static finishSizePrefixedTrackSensor_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TRAC', true);
}

static createTrackSensor_Full(builder:flatbuffers.Builder, range:number, az:number, sensorNumber:number, sensorNameOffset:flatbuffers.Offset, missionNumberOffset:flatbuffers.Offset, minRangeLimit:number, sensorFovtype:TrackSensor_Full_sensorFOVType_Enum):flatbuffers.Offset {
  TrackSensor_Full.startTrackSensor_Full(builder);
...
unpack(): TrackSensor_FullT {
  return new TrackSensor_FullT(
    this.range(),
    this.az(),
    this.sensorNumber(),
    this.sensorName(),
...
unpackTo(_o: TrackSensor_FullT): void {
  _o.range = this.range();
  _o.az = this.az();
...
export class TrackSensor_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public sensorFOVType: TrackSensor_Full_sensorFOVType_Enum = TrackSensor_Full_sensorFOVType_Enum.BUTTERFLY
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return TrackSensor_Full.createTrackSensor_Full(builder,
    this.range,
    this.az,
    this.sensorNumber,
    sensorName,
