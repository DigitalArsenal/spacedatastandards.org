...
import { Track_Abridged_dataMode_Enum } from './Track_Abridged_dataMode_Enum.js';
 ...
 */
export class Track_Abridged implements flatbuffers.IUnpackableObject<Track_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Track_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsTrack_Abridged(bb:flatbuffers.ByteBuffer, obj?:Track_Abridged):Track_Abridged {
  return (obj || new Track_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTrack_Abridged(bb:flatbuffers.ByteBuffer, obj?:Track_Abridged):Track_Abridged {
 ...
 */
dataMode():Track_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 136);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Track_Abridged_dataMode_Enum.REAL;
}
...
static startTrack_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Track_Abridged_dataMode_Enum) {
  builder.addFieldInt8(66, dataMode, Track_Abridged_dataMode_Enum.REAL);
}
...
unpack(): Track_AbridgedT {
  return new Track_AbridgedT(
    this.id(),
...
unpackTo(_o: Track_AbridgedT): void {
  _o.id = this.id();
...
export class Track_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Track_Abridged_dataMode_Enum = Track_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const ecefPos = Track_Abridged.createEcefPosVector(builder, builder.createObjectOffsetList(this.ecefPos));
  const ecefVel = Track_Abridged.createEcefVelVector(builder, builder.createObjectOffsetList(this.ecefVel));
  const ecefAcc = Track_Abridged.createEcefAccVector(builder, builder.createObjectOffsetList(this.ecefAcc));
  const lco = Track_Abridged.createLcoVector(builder, builder.createObjectOffsetList(this.lco));
  const lcs = Track_Abridged.createLcsVector(builder, builder.createObjectOffsetList(this.lcs));
  const lcPos = Track_Abridged.createLcPosVector(builder, builder.createObjectOffsetList(this.lcPos));
  const lcVel = Track_Abridged.createLcVelVector(builder, builder.createObjectOffsetList(this.lcVel));
  const lcAcc = Track_Abridged.createLcAccVector(builder, builder.createObjectOffsetList(this.lcAcc));
  const eNuvel = Track_Abridged.createENuvelVector(builder, builder.createObjectOffsetList(this.eNuvel));
  const eNupos = Track_Abridged.createENuposVector(builder, builder.createObjectOffsetList(this.eNupos));
  const cov = Track_Abridged.createCovVector(builder, builder.createObjectOffsetList(this.cov));
  const errEllp = Track_Abridged.createErrEllpVector(builder, builder.createObjectOffsetList(this.errEllp));
  const srcTyps = Track_Abridged.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = Track_Abridged.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  ...
  const tags = Track_Abridged.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  const sourceDl = (this.sourceDl !== null ? builder.createString(this.sourceDl!) : 0);
  const source = (this.source !== null ? builder.createString(this.source!) : 0);
  const origin = (this.origin !== null ? builder.createString(this.origin!) : 0);
  const origNetwork = (this.origNetwork !== null ? builder.createString(this.origNetwork!) : 0);

  return Track_Abridged.createTrack_Abridged(builder,
    id,
