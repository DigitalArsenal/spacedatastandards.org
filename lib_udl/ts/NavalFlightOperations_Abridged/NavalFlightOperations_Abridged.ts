 ...
 */
export class NavalFlightOperations_Abridged implements flatbuffers.IUnpackableObject<NavalFlightOperations_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):NavalFlightOperations_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsNavalFlightOperations_Abridged(bb:flatbuffers.ByteBuffer, obj?:NavalFlightOperations_Abridged):NavalFlightOperations_Abridged {
  return (obj || new NavalFlightOperations_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsNavalFlightOperations_Abridged(bb:flatbuffers.ByteBuffer, obj?:NavalFlightOperations_Abridged):NavalFlightOperations_Abridged {
...
static startNavalFlightOperations_Abridged(builder:flatbuffers.Builder) {
...
static endNavalFlightOperations_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishNavalFlightOperations_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'NAVA');
}

static finishSizePrefixedNavalFlightOperations_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'NAVA', true);
}

static createNavalFlightOperations_Abridged(builder:flatbuffers.Builder, shipNameOffset:flatbuffers.Offset, fltOpStartOffset:flatbuffers.Offset, fltOpStopOffset:flatbuffers.Offset, schdLaunchRcvyTimeOffset:flatbuffers.Offset):flatbuffers.Offset {
  NavalFlightOperations_Abridged.startNavalFlightOperations_Abridged(builder);
...
unpack(): NavalFlightOperations_AbridgedT {
  return new NavalFlightOperations_AbridgedT(
    this.shipName(),
    this.fltOpStart(),
    this.fltOpStop(),
...
unpackTo(_o: NavalFlightOperations_AbridgedT): void {
...
export class NavalFlightOperations_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const schdLaunchRcvyTime = NavalFlightOperations_Abridged.createSchdLaunchRcvyTimeVector(builder, builder.createObjectOffsetList(this.schdLaunchRcvyTime));

  return NavalFlightOperations_Abridged.createNavalFlightOperations_Abridged(builder,
    shipName,
    fltOpStart,
    fltOpStop,
    schdLaunchRcvyTime
