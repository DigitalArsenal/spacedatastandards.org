...
import { RFBand_Full_dataMode_Enum } from './rfband-full-data-mode-enum.js';
import { RFBand_Full_mode_Enum } from './rfband-full-mode-enum.js';
import { RFBand_Full_polarization_Enum } from './rfband-full-polarization-enum.js';
import { RFBand_Full_purpose_Enum } from './rfband-full-purpose-enum.js';
 ...
 */
export class RFBand_Full implements flatbuffers.IUnpackableObject<RFBand_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):RFBand_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsRFBand_Full(bb:flatbuffers.ByteBuffer, obj?:RFBand_Full):RFBand_Full {
  return (obj || new RFBand_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRFBand_Full(bb:flatbuffers.ByteBuffer, obj?:RFBand_Full):RFBand_Full {
 ...
 */
mode():RFBand_Full_mode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 14);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFBand_Full_mode_Enum.TX;
}
 ...
 */
purpose():RFBand_Full_purpose_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 16);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFBand_Full_purpose_Enum.COMM;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 4
 */
polarization():RFBand_Full_polarization_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 32);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFBand_Full_polarization_Enum.H;
}
 ...
 */
dataMode():RFBand_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 42);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFBand_Full_dataMode_Enum.REAL;
}
...
static startRFBand_Full(builder:flatbuffers.Builder) {
...
static addMode(builder:flatbuffers.Builder, mode:RFBand_Full_mode_Enum) {
  builder.addFieldInt8(5, mode, RFBand_Full_mode_Enum.TX);
}

static addPurpose(builder:flatbuffers.Builder, purpose:RFBand_Full_purpose_Enum) {
  builder.addFieldInt8(6, purpose, RFBand_Full_purpose_Enum.COMM);
}
...
static addPolarization(builder:flatbuffers.Builder, polarization:RFBand_Full_polarization_Enum) {
  builder.addFieldInt8(14, polarization, RFBand_Full_polarization_Enum.H);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:RFBand_Full_dataMode_Enum) {
  builder.addFieldInt8(19, dataMode, RFBand_Full_dataMode_Enum.REAL);
}
...
static endRFBand_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishRFBand_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'RFBA');
}

static finishSizePrefixedRFBand_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'RFBA', true);
}

static createRFBand_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idEntityOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, bandOffset:flatbuffers.Offset, mode:RFBand_Full_mode_Enum, purpose:RFBand_Full_purpose_Enum, freqMin:number, freqMax:number, centerFreq:number, peakGain:number, edgeGain:number, bandwidth:number, beamwidth:number, polarization:RFBand_Full_polarization_Enum, erp:number, eirp:number, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:RFBand_Full_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  RFBand_Full.startRFBand_Full(builder);
...
export class RFBand_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public mode: RFBand_Full_mode_Enum = RFBand_Full_mode_Enum.TX,
  public purpose: RFBand_Full_purpose_Enum = RFBand_Full_purpose_Enum.COMM,
  ...
  public polarization: RFBand_Full_polarization_Enum = RFBand_Full_polarization_Enum.H,
  public erp: number = 0.0,
  public eirp: number = 0.0,
  public source: string|Uint8Array|null = null,
  public origin: string|Uint8Array|null = null,
  public dataMode: RFBand_Full_dataMode_Enum = RFBand_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return RFBand_Full.createRFBand_Full(builder,
    id,
    idEntity,
