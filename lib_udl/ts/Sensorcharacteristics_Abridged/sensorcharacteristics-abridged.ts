...
import { Sensorcharacteristics_Abridged_dataMode_Enum } from './sensorcharacteristics-abridged-data-mode-enum.js';


/**
 * /// Model representation of characteristics and capabilities of a sensor.
 */
export class Sensorcharacteristics_Abridged implements flatbuffers.IUnpackableObject<Sensorcharacteristics_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Sensorcharacteristics_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSensorcharacteristics_Abridged(bb:flatbuffers.ByteBuffer, obj?:Sensorcharacteristics_Abridged):Sensorcharacteristics_Abridged {
  return (obj || new Sensorcharacteristics_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSensorcharacteristics_Abridged(bb:flatbuffers.ByteBuffer, obj?:Sensorcharacteristics_Abridged):Sensorcharacteristics_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Sensorcharacteristics_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 106);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Sensorcharacteristics_Abridged_dataMode_Enum.REAL;
}
...
static startSensorcharacteristics_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Sensorcharacteristics_Abridged_dataMode_Enum) {
  builder.addFieldInt8(51, dataMode, Sensorcharacteristics_Abridged_dataMode_Enum.REAL);
}
...
unpack(): Sensorcharacteristics_AbridgedT {
  return new Sensorcharacteristics_AbridgedT(
    this.id(),
    this.idSensor(),
...
unpackTo(_o: Sensorcharacteristics_AbridgedT): void {
  _o.id = this.id();
...
export class Sensorcharacteristics_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Sensorcharacteristics_Abridged_dataMode_Enum = Sensorcharacteristics_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Sensorcharacteristics_Abridged.createSensorcharacteristics_Abridged(builder,
    id,
    idSensor,
