...
import { MissileTrack_Full_dataMode_Enum } from './missile-track-full-data-mode-enum.js';
import { MissileTrack_Full_env_Enum } from './missile-track-full-env-enum.js';
import { MissileTrack_Full_objIdent_Enum } from './missile-track-full-obj-ident-enum.js';
 ...
 */
export class MissileTrack_Full implements flatbuffers.IUnpackableObject<MissileTrack_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MissileTrack_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMissileTrack_Full(bb:flatbuffers.ByteBuffer, obj?:MissileTrack_Full):MissileTrack_Full {
  return (obj || new MissileTrack_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMissileTrack_Full(bb:flatbuffers.ByteBuffer, obj?:MissileTrack_Full):MissileTrack_Full {
 ...
 * Constraints: Minimum length = 0, Maximum length = 16
 */
env():MissileTrack_Full_env_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 14);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : MissileTrack_Full_env_Enum.AIR;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 32
 */
objIdent():MissileTrack_Full_objIdent_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 22);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : MissileTrack_Full_objIdent_Enum.ASSUMED_FRIEND;
}
 ...
 */
dataMode():MissileTrack_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 116);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : MissileTrack_Full_dataMode_Enum.REAL;
}

static startMissileTrack_Full(builder:flatbuffers.Builder) {
...
static addEnv(builder:flatbuffers.Builder, env:MissileTrack_Full_env_Enum) {
  builder.addFieldInt8(5, env, MissileTrack_Full_env_Enum.AIR);
}
...
static addObjIdent(builder:flatbuffers.Builder, objIdent:MissileTrack_Full_objIdent_Enum) {
  builder.addFieldInt8(9, objIdent, MissileTrack_Full_objIdent_Enum.ASSUMED_FRIEND);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:MissileTrack_Full_dataMode_Enum) {
  builder.addFieldInt8(56, dataMode, MissileTrack_Full_dataMode_Enum.REAL);
}

static endMissileTrack_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishMissileTrack_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MISS');
}

static finishSizePrefixedMissileTrack_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MISS', true);
}

static createMissileTrack_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, msgTypeOffset:flatbuffers.Offset, msgSubTypeOffset:flatbuffers.Offset, msgCreateDateOffset:flatbuffers.Offset, env:MissileTrack_Full_env_Enum, objTypeOffset:flatbuffers.Offset, objTypeConf:number, objPlatOffset:flatbuffers.Offset, objIdent:MissileTrack_Full_objIdent_Enum, spaceAmpOffset:flatbuffers.Offset, objActOffset:flatbuffers.Offset, spaceSpecTypeOffset:flatbuffers.Offset, acftSubTypeOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, callSignOffset:flatbuffers.Offset, lostTrkInd:boolean, trackIdOffset:flatbuffers.Offset, parentTrackIdOffset:flatbuffers.Offset, muidSrcTrkOffset:flatbuffers.Offset, muidSrcOffset:flatbuffers.Offset, alertOffset:flatbuffers.Offset, mslStatusOffset:flatbuffers.Offset, tsOffset:flatbuffers.Offset, aouRptTypeOffset:flatbuffers.Offset, aouRptDataOffset:flatbuffers.Offset, containment:number, trkConf:number, trkQual:number, angElev:number, senModeOffset:flatbuffers.Offset, infoSourceOffset:flatbuffers.Offset, boosting:boolean, polarSingLocLat:number, polarSingLocLon:number, emgInd:boolean, dropPtInd:boolean, spaceAmpConf:number, launchTimeOffset:flatbuffers.Offset, launchLat:number, launchLon:number, azCorr:number, burnoutAlt:number, launchAouTypeOffset:flatbuffers.Offset, launchAouDataOffset:flatbuffers.Offset, impactTimeOffset:flatbuffers.Offset, impactLat:number, impactLon:number, impactAouTypeOffset:flatbuffers.Offset, impactAouDataOffset:flatbuffers.Offset, vectorsOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:MissileTrack_Full_dataMode_Enum):flatbuffers.Offset {
  MissileTrack_Full.startMissileTrack_Full(builder);
  MissileTrack_Full.addId(builder, idOffset);
  MissileTrack_Full.addClassificationMarking(builder, classificationMarkingOffset);
  MissileTrack_Full.addMsgType(builder, msgTypeOffset);
  MissileTrack_Full.addMsgSubType(builder, msgSubTypeOffset);
  MissileTrack_Full.addMsgCreateDate(builder, msgCreateDateOffset);
  MissileTrack_Full.addEnv(builder, env);
  MissileTrack_Full.addObjType(builder, objTypeOffset);
  MissileTrack_Full.addObjTypeConf(builder, objTypeConf);
  MissileTrack_Full.addObjPlat(builder, objPlatOffset);
  MissileTrack_Full.addObjIdent(builder, objIdent);
  MissileTrack_Full.addSpaceAmp(builder, spaceAmpOffset);
  MissileTrack_Full.addObjAct(builder, objActOffset);
  MissileTrack_Full.addSpaceSpecType(builder, spaceSpecTypeOffset);
  MissileTrack_Full.addAcftSubType(builder, acftSubTypeOffset);
  MissileTrack_Full.addName(builder, nameOffset);
  MissileTrack_Full.addCallSign(builder, callSignOffset);
  MissileTrack_Full.addLostTrkInd(builder, lostTrkInd);
  MissileTrack_Full.addTrackId(builder, trackIdOffset);
  MissileTrack_Full.addParentTrackId(builder, parentTrackIdOffset);
  MissileTrack_Full.addMuidSrcTrk(builder, muidSrcTrkOffset);
  MissileTrack_Full.addMuidSrc(builder, muidSrcOffset);
  MissileTrack_Full.addAlert(builder, alertOffset);
  MissileTrack_Full.addMslStatus(builder, mslStatusOffset);
  MissileTrack_Full.addTs(builder, tsOffset);
  MissileTrack_Full.addAouRptType(builder, aouRptTypeOffset);
  MissileTrack_Full.addAouRptData(builder, aouRptDataOffset);
  MissileTrack_Full.addContainment(builder, containment);
  MissileTrack_Full.addTrkConf(builder, trkConf);
  MissileTrack_Full.addTrkQual(builder, trkQual);
  MissileTrack_Full.addAngElev(builder, angElev);
  MissileTrack_Full.addSenMode(builder, senModeOffset);
  MissileTrack_Full.addInfoSource(builder, infoSourceOffset);
  MissileTrack_Full.addBoosting(builder, boosting);
  MissileTrack_Full.addPolarSingLocLat(builder, polarSingLocLat);
  MissileTrack_Full.addPolarSingLocLon(builder, polarSingLocLon);
  MissileTrack_Full.addEmgInd(builder, emgInd);
  MissileTrack_Full.addDropPtInd(builder, dropPtInd);
  MissileTrack_Full.addSpaceAmpConf(builder, spaceAmpConf);
  MissileTrack_Full.addLaunchTime(builder, launchTimeOffset);
  MissileTrack_Full.addLaunchLat(builder, launchLat);
  MissileTrack_Full.addLaunchLon(builder, launchLon);
  MissileTrack_Full.addAzCorr(builder, azCorr);
  MissileTrack_Full.addBurnoutAlt(builder, burnoutAlt);
  MissileTrack_Full.addLaunchAouType(builder, launchAouTypeOffset);
  MissileTrack_Full.addLaunchAouData(builder, launchAouDataOffset);
  MissileTrack_Full.addImpactTime(builder, impactTimeOffset);
  MissileTrack_Full.addImpactLat(builder, impactLat);
  MissileTrack_Full.addImpactLon(builder, impactLon);
  MissileTrack_Full.addImpactAouType(builder, impactAouTypeOffset);
  MissileTrack_Full.addImpactAouData(builder, impactAouDataOffset);
  MissileTrack_Full.addVectors(builder, vectorsOffset);
  MissileTrack_Full.addOrigNetwork(builder, origNetworkOffset);
  MissileTrack_Full.addCreatedAt(builder, createdAtOffset);
  MissileTrack_Full.addCreatedBy(builder, createdByOffset);
  MissileTrack_Full.addSource(builder, sourceOffset);
  MissileTrack_Full.addOrigin(builder, originOffset);
  MissileTrack_Full.addDataMode(builder, dataMode);
  return MissileTrack_Full.endMissileTrack_Full(builder);
}

unpack(): MissileTrack_FullT {
  return new MissileTrack_FullT(
    this.id(),
...
unpackTo(_o: MissileTrack_FullT): void {
  _o.id = this.id();
...
export class MissileTrack_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public env: MissileTrack_Full_env_Enum = MissileTrack_Full_env_Enum.AIR,
  public objType: string|Uint8Array|null = null,
  public objTypeConf: number = 0,
  public objPlat: string|Uint8Array|null = null,
  public objIdent: MissileTrack_Full_objIdent_Enum = MissileTrack_Full_objIdent_Enum.ASSUMED_FRIEND,
  ...
  public dataMode: MissileTrack_Full_dataMode_Enum = MissileTrack_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const aouRptData = MissileTrack_Full.createAouRptDataVector(builder, builder.createObjectOffsetList(this.aouRptData));
  ...
  const launchAouData = MissileTrack_Full.createLaunchAouDataVector(builder, builder.createObjectOffsetList(this.launchAouData));
  ...
  const impactAouData = MissileTrack_Full.createImpactAouDataVector(builder, builder.createObjectOffsetList(this.impactAouData));
  const vectors = MissileTrack_Full.createVectorsVector(builder, builder.createObjectOffsetList(this.vectors));
  ...
  return MissileTrack_Full.createMissileTrack_Full(builder,
    id,
