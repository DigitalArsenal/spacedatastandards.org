...
import { SeradataSpacecraftDetails_Abridged_dataMode_Enum } from './seradata-spacecraft-details-abridged-data-mode-enum.js';


/**
 * /// On-orbit spacecraft details compiled by Seradata for a particular satellite.
 */
export class SeradataSpacecraftDetails_Abridged implements flatbuffers.IUnpackableObject<SeradataSpacecraftDetails_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SeradataSpacecraftDetails_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSeradataSpacecraftDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:SeradataSpacecraftDetails_Abridged):SeradataSpacecraftDetails_Abridged {
  return (obj || new SeradataSpacecraftDetails_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSeradataSpacecraftDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:SeradataSpacecraftDetails_Abridged):SeradataSpacecraftDetails_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SeradataSpacecraftDetails_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 188);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SeradataSpacecraftDetails_Abridged_dataMode_Enum.REAL;
}
...
static startSeradataSpacecraftDetails_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SeradataSpacecraftDetails_Abridged_dataMode_Enum) {
  builder.addFieldInt8(92, dataMode, SeradataSpacecraftDetails_Abridged_dataMode_Enum.REAL);
}
...
unpack(): SeradataSpacecraftDetails_AbridgedT {
  return new SeradataSpacecraftDetails_AbridgedT(
    this.id(),
    this.idOnOrbit(),
...
unpackTo(_o: SeradataSpacecraftDetails_AbridgedT): void {
  _o.id = this.id();
...
export class SeradataSpacecraftDetails_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SeradataSpacecraftDetails_Abridged_dataMode_Enum = SeradataSpacecraftDetails_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SeradataSpacecraftDetails_Abridged.createSeradataSpacecraftDetails_Abridged(builder,
    id,
    idOnOrbit,
