 ...
 */
export class LogisticsSegments_Full implements flatbuffers.IUnpackableObject<LogisticsSegments_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LogisticsSegments_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLogisticsSegments_Full(bb:flatbuffers.ByteBuffer, obj?:LogisticsSegments_Full):LogisticsSegments_Full {
  return (obj || new LogisticsSegments_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLogisticsSegments_Full(bb:flatbuffers.ByteBuffer, obj?:LogisticsSegments_Full):LogisticsSegments_Full {
...
static startLogisticsSegments_Full(builder:flatbuffers.Builder) {
...
unpack(): LogisticsSegments_FullT {
  return new LogisticsSegments_FullT(
    this.segmentNumber(),
    this.modeCode(),
    this.missionType(),
    this.idMission(),
...
unpackTo(_o: LogisticsSegments_FullT): void {
...
export class LogisticsSegments_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return LogisticsSegments_Full.createLogisticsSegments_Full(builder,
    this.segmentNumber,
    modeCode,
    missionType,
    idMission,
