 ...
 */
export class EvacCondition_Abridged implements flatbuffers.IUnpackableObject<EvacCondition_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EvacCondition_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEvacCondition_Abridged(bb:flatbuffers.ByteBuffer, obj?:EvacCondition_Abridged):EvacCondition_Abridged {
  return (obj || new EvacCondition_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEvacCondition_Abridged(bb:flatbuffers.ByteBuffer, obj?:EvacCondition_Abridged):EvacCondition_Abridged {
...
static startEvacCondition_Abridged(builder:flatbuffers.Builder) {
...
static endEvacCondition_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEvacCondition_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC');
}

static finishSizePrefixedEvacCondition_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC', true);
}

static createEvacCondition_Abridged(builder:flatbuffers.Builder, typeOffset:flatbuffers.Offset, bodyPartOffset:flatbuffers.Offset, timeOffset:flatbuffers.Offset, commentsOffset:flatbuffers.Offset):flatbuffers.Offset {
  EvacCondition_Abridged.startEvacCondition_Abridged(builder);
...
unpack(): EvacCondition_AbridgedT {
  return new EvacCondition_AbridgedT(
    this.type(),
    this.bodyPart(),
    this.time(),
    this.comments()
...
unpackTo(_o: EvacCondition_AbridgedT): void {
  _o.type = this.type();
...
export class EvacCondition_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return EvacCondition_Abridged.createEvacCondition_Abridged(builder,
    type,
    bodyPart,
    time,
    comments
