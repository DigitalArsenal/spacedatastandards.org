...
import { TAIUTC_Full_dataMode_Enum } from './taiutc-full-data-mode-enum.js';
 ...
 */
export class TAIUTC_Full implements flatbuffers.IUnpackableObject<TAIUTC_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):TAIUTC_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsTAIUTC_Full(bb:flatbuffers.ByteBuffer, obj?:TAIUTC_Full):TAIUTC_Full {
  return (obj || new TAIUTC_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsTAIUTC_Full(bb:flatbuffers.ByteBuffer, obj?:TAIUTC_Full):TAIUTC_Full {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():TAIUTC_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 22);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : TAIUTC_Full_dataMode_Enum.REAL;
}
...
static startTAIUTC_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:TAIUTC_Full_dataMode_Enum) {
  builder.addFieldInt8(9, dataMode, TAIUTC_Full_dataMode_Enum.REAL);
}
...
static endTAIUTC_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishTAIUTC_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TAIU');
}

static finishSizePrefixedTAIUTC_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'TAIU', true);
}

static createTAIUTC_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, adjustmentDateOffset:flatbuffers.Offset, taiUtc:number, multiplicationFactor:number, rawFileUriOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:TAIUTC_Full_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset):flatbuffers.Offset {
  TAIUTC_Full.startTAIUTC_Full(builder);
...
export class TAIUTC_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: TAIUTC_Full_dataMode_Enum = TAIUTC_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return TAIUTC_Full.createTAIUTC_Full(builder,
    id,
