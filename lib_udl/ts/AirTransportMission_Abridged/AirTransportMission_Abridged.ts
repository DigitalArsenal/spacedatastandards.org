...
import { AirTransportMission_Abridged_dataMode_Enum } from './AirTransportMission_Abridged_dataMode_Enum.js';
 ...
 */
export class AirTransportMission_Abridged implements flatbuffers.IUnpackableObject<AirTransportMission_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirTransportMission_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirTransportMission_Abridged(bb:flatbuffers.ByteBuffer, obj?:AirTransportMission_Abridged):AirTransportMission_Abridged {
  return (obj || new AirTransportMission_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirTransportMission_Abridged(bb:flatbuffers.ByteBuffer, obj?:AirTransportMission_Abridged):AirTransportMission_Abridged {
 ...
 */
dataMode():AirTransportMission_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 70);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirTransportMission_Abridged_dataMode_Enum.REAL;
}
...
static startAirTransportMission_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AirTransportMission_Abridged_dataMode_Enum) {
  builder.addFieldInt8(33, dataMode, AirTransportMission_Abridged_dataMode_Enum.REAL);
}
...
static endAirTransportMission_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirTransportMission_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRT');
}

static finishSizePrefixedAirTransportMission_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRT', true);
}

static createAirTransportMission_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, origMissionIdOffset:flatbuffers.Offset, amcMissionIdOffset:flatbuffers.Offset, gdssMissionIdOffset:flatbuffers.Offset, prevMissionIdOffset:flatbuffers.Offset, prevAmcmissionIdOffset:flatbuffers.Offset, nextMissionIdOffset:flatbuffers.Offset, nextAmcmissionIdOffset:flatbuffers.Offset, objectiveOffset:flatbuffers.Offset, purposeOffset:flatbuffers.Offset, jcsPriorityOffset:flatbuffers.Offset, cw:boolean, typeOffset:flatbuffers.Offset, firstPickUpOffset:flatbuffers.Offset, lastDropOffOffset:flatbuffers.Offset, aliasOffset:flatbuffers.Offset, callSignOffset:flatbuffers.Offset, operationOffset:flatbuffers.Offset, nafOffset:flatbuffers.Offset, allocatedUnitOffset:flatbuffers.Offset, loadCategoryTypeOffset:flatbuffers.Offset, stateOffset:flatbuffers.Offset, sourceSysDeviation:number, apacsIdOffset:flatbuffers.Offset, dipWorksheetNameOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:AirTransportMission_Abridged_dataMode_Enum, origNetworkOffset:flatbuffers.Offset, requirementsOffset:flatbuffers.Offset, remarksOffset:flatbuffers.Offset, hazMatOffset:flatbuffers.Offset):flatbuffers.Offset {
  AirTransportMission_Abridged.startAirTransportMission_Abridged(builder);
...
unpack(): AirTransportMission_AbridgedT {
  return new AirTransportMission_AbridgedT(
    this.id(),
...
unpackTo(_o: AirTransportMission_AbridgedT): void {
  _o.id = this.id();
...
export class AirTransportMission_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AirTransportMission_Abridged_dataMode_Enum = AirTransportMission_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const requirements = AirTransportMission_Abridged.createRequirementsVector(builder, builder.createObjectOffsetList(this.requirements));
  const remarks = AirTransportMission_Abridged.createRemarksVector(builder, builder.createObjectOffsetList(this.remarks));
  const hazMat = AirTransportMission_Abridged.createHazMatVector(builder, builder.createObjectOffsetList(this.hazMat));

  return AirTransportMission_Abridged.createAirTransportMission_Abridged(builder,
    id,
