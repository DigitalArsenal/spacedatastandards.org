...
import { LaunchSite_Full_dataMode_Enum } from './LaunchSite_Full_dataMode_Enum.js';
...
unpack(): LaunchSite_FullT {
  return new LaunchSite_FullT(
    ...
    this.origNetwork(),
    this.dataMode(),
    this.bb!.createScalarList<string>(this.launchSiteDetails.bind(this), this.launchSiteDetailsLength())
  );
}
...
unpackTo(_o: LaunchSite_FullT): void {
  ...
  _o.launchSiteDetails = this.bb!.createScalarList<string>(this.launchSiteDetails.bind(this), this.launchSiteDetailsLength());
}
}
