...
import { PersonnelRecovery_Full_dataMode_Enum } from './personnel-recovery-full-data-mode-enum.js';


/**
 * /// Provides information concerning search and rescue operations and other situations involving personnel recovery.
 */
export class PersonnelRecovery_Full implements flatbuffers.IUnpackableObject<PersonnelRecovery_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):PersonnelRecovery_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsPersonnelRecovery_Full(bb:flatbuffers.ByteBuffer, obj?:PersonnelRecovery_Full):PersonnelRecovery_Full {
  return (obj || new PersonnelRecovery_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsPersonnelRecovery_Full(bb:flatbuffers.ByteBuffer, obj?:PersonnelRecovery_Full):PersonnelRecovery_Full {
 ...
 */
dataMode():PersonnelRecovery_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 78);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : PersonnelRecovery_Full_dataMode_Enum.REAL;
}

static startPersonnelRecovery_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:PersonnelRecovery_Full_dataMode_Enum) {
  builder.addFieldInt8(37, dataMode, PersonnelRecovery_Full_dataMode_Enum.REAL);
}

static endPersonnelRecovery_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishPersonnelRecovery_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'PERS');
}

static finishSizePrefixedPersonnelRecovery_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'PERS', true);
}

static createPersonnelRecovery_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, msgTimeOffset:flatbuffers.Offset, recovIdOffset:flatbuffers.Offset, idWeatherReportOffset:flatbuffers.Offset, pickupLat:number, pickupLon:number, pickupAlt:number, termInd:boolean, authStatusOffset:flatbuffers.Offset, numPersons:number, milClassOffset:flatbuffers.Offset, natAlliance:number, natAlliance1:number, identityOffset:flatbuffers.Offset, commEq1Offset:flatbuffers.Offset, commEq2Offset:flatbuffers.Offset, commEq3Offset:flatbuffers.Offset, txFreq:number, rxFreq:number, numNonAmbulatory:number, numAmbulatory:number, numAmbulatoryInjured:number, survivorRadioOffset:flatbuffers.Offset, survivorMessagesOffset:flatbuffers.Offset, beaconInd:boolean, callSignOffset:flatbuffers.Offset, textMsgOffset:flatbuffers.Offset, authMethodOffset:flatbuffers.Offset, objectiveAreaInfoOffset:flatbuffers.Offset, executionInfoOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:PersonnelRecovery_Full_dataMode_Enum):flatbuffers.Offset {
  PersonnelRecovery_Full.startPersonnelRecovery_Full(builder);
...
unpack(): PersonnelRecovery_FullT {
  return new PersonnelRecovery_FullT(
    this.id(),
...
unpackTo(_o: PersonnelRecovery_FullT): void {
  _o.id = this.id();
...
export class PersonnelRecovery_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: PersonnelRecovery_Full_dataMode_Enum = PersonnelRecovery_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return PersonnelRecovery_Full.createPersonnelRecovery_Full(builder,
    id,
