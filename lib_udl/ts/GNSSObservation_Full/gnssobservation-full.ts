 ...
 */
export class GNSSObservation_Full implements flatbuffers.IUnpackableObject<GNSSObservation_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):GNSSObservation_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsGNSSObservation_Full(bb:flatbuffers.ByteBuffer, obj?:GNSSObservation_Full):GNSSObservation_Full {
  return (obj || new GNSSObservation_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsGNSSObservation_Full(bb:flatbuffers.ByteBuffer, obj?:GNSSObservation_Full):GNSSObservation_Full {
...
static startGNSSObservation_Full(builder:flatbuffers.Builder) {
...
static endGNSSObservation_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishGNSSObservation_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'GNSS');
}

static finishSizePrefixedGNSSObservation_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'GNSS', true);
}

static createGNSSObservation_Full(builder:flatbuffers.Builder, gnssSatIdOffset:flatbuffers.Offset, trackingStatus:number, agcState:number, obsCodeSetOffset:flatbuffers.Offset, obOffset:flatbuffers.Offset):flatbuffers.Offset {
  GNSSObservation_Full.startGNSSObservation_Full(builder);
...
unpack(): GNSSObservation_FullT {
  return new GNSSObservation_FullT(
    this.gnssSatId(),
    this.trackingStatus(),
    this.agcState(),
...
unpackTo(_o: GNSSObservation_FullT): void {
...
export class GNSSObservation_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const obsCodeSet = GNSSObservation_Full.createObsCodeSetVector(builder, builder.createObjectOffsetList(this.obsCodeSet));
  const ob = GNSSObservation_Full.createObVector(builder, builder.createObjectOffsetList(this.ob));

  return GNSSObservation_Full.createGNSSObservation_Full(builder,
    gnssSatId,
    this.trackingStatus,
    this.agcState,
    obsCodeSet,
