...
import { Site_Full_dataMode_Enum } from './site-full-data-mode-enum.js';


/**
 * /// Properties and characteristics of a site entity, such as an airbase, airfield, naval station, etc.
 */
export class Site_Full implements flatbuffers.IUnpackableObject<Site_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Site_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSite_Full(bb:flatbuffers.ByteBuffer, obj?:Site_Full):Site_Full {
  return (obj || new Site_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSite_Full(bb:flatbuffers.ByteBuffer, obj?:Site_Full):Site_Full {
 ...
 * Constraints: No constraints specified.
 */
siteRemarks(index: number):string
siteRemarks(index: number,optionalEncoding:flatbuffers.Encoding):string|Uint8Array
siteRemarks(index: number,optionalEncoding?:any):string|Uint8Array|null {
  const offset = this.bb!.__offset(this.bb_pos, 124);
  return offset ? this.bb!.__string(this.bb!.__vector(this.bb_pos + offset) + index * 4, optionalEncoding) : null;
}

siteRemarksLength():number {
  const offset = this.bb!.__offset(this.bb_pos, 124);
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Site_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 140);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Site_Full_dataMode_Enum.REAL;
}

static startSite_Full(builder:flatbuffers.Builder) {
...
static addSiteRemarks(builder:flatbuffers.Builder, siteRemarksOffset:flatbuffers.Offset) {
  builder.addFieldOffset(60, siteRemarksOffset, 0);
}

static createSiteRemarksVector(builder:flatbuffers.Builder, data:flatbuffers.Offset[]):flatbuffers.Offset {
...
static startSiteRemarksVector(builder:flatbuffers.Builder, numElems:number) {
  builder.startVector(4, numElems, 4);
}

static addCreatedAt(builder:flatbuffers.Builder, createdAtOffset:flatbuffers.Offset) {
  builder.addFieldOffset(61, createdAtOffset, 0);
}

static addCreatedBy(builder:flatbuffers.Builder, createdByOffset:flatbuffers.Offset) {
  builder.addFieldOffset(62, createdByOffset, 0);
}

static addUpdatedAt(builder:flatbuffers.Builder, updatedAtOffset:flatbuffers.Offset) {
  builder.addFieldOffset(63, updatedAtOffset, 0);
}

static addUpdatedBy(builder:flatbuffers.Builder, updatedByOffset:flatbuffers.Offset) {
  builder.addFieldOffset(64, updatedByOffset, 0);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Site_Full_dataMode_Enum) {
  builder.addFieldInt8(68, dataMode, Site_Full_dataMode_Enum.REAL);
}

static endSite_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSite_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SITE');
}

static finishSizePrefixedSite_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SITE', true);
}

static createSite_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, entityOffset:flatbuffers.Offset, idEntityOffset:flatbuffers.Offset, idParentSiteOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, origSiteIdOffset:flatbuffers.Offset, origLzIdOffset:flatbuffers.Offset, pinOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, usageOffset:flatbuffers.Offset, lzUsageOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, coordDatumOffset:flatbuffers.Offset, coordOffset:flatbuffers.Offset, coordDerivAcc:number, osuffixOffset:flatbuffers.Offset, iataOffset:flatbuffers.Offset, icaoOffset:flatbuffers.Offset, faaOffset:flatbuffers.Offset, airDefAreaOffset:flatbuffers.Offset, utmOffset:flatbuffers.Offset, milGridSysOffset:flatbuffers.Offset, milGridOffset:flatbuffers.Offset, catCodeOffset:flatbuffers.Offset, catTextOffset:flatbuffers.Offset, wacOffset:flatbuffers.Offset, polSubdivOffset:flatbuffers.Offset, geoAreaOffset:flatbuffers.Offset, geoidalMslSep:number, allegianceOffset:flatbuffers.Offset, altAllegianceOffset:flatbuffers.Offset, classRatingOffset:flatbuffers.Offset, fpaOffset:flatbuffers.Offset, beNumberOffset:flatbuffers.Offset, runways:number, maxRunwayLength:number, conditionOffset:flatbuffers.Offset, conditionAvailOffset:flatbuffers.Offset, operStatusOffset:flatbuffers.Offset, grade:number, activityOffset:flatbuffers.Offset, functPrimaryOffset:flatbuffers.Offset, msnPrimaryOffset:flatbuffers.Offset, msnPrimarySpecOffset:flatbuffers.Offset, nucCapOffset:flatbuffers.Offset, identOffset:flatbuffers.Offset, elevMsl:number, elevMslConfLvl:number, elevMslDerivAcc:number, vegHt:number, vegTypeOffset:flatbuffers.Offset, popArea:boolean, popAreaProx:number, notesOffset:flatbuffers.Offset, resProdOffset:flatbuffers.Offset, eval:number, reviewDateOffset:flatbuffers.Offset, recStatusOffset:flatbuffers.Offset, symCodeOffset:flatbuffers.Offset, referenceDocOffset:flatbuffers.Offset, siteRemarksOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:Site_Full_dataMode_Enum):flatbuffers.Offset {
  Site_Full.startSite_Full(builder);
...
unpack(): Site_FullT {
  return new Site_FullT(
    ...
    this.symCode(),
    this.referenceDoc(),
    this.bb!.createScalarList<string>(this.siteRemarks.bind(this), this.siteRemarks_Length()),
    this.createdAt(),
    this.createdBy(),
    this.updatedAt(),
    this.updatedBy(),
...
unpackTo(_o: Site_FullT): void {
  ...
  _o.siteRemarks = this.bb!.createScalarList<string>(this.siteRemarks.bind(this), this.siteRemarks_Length());
...
export class Site_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Site_Full_dataMode_Enum = Site_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const siteRemarks = Site_Full.createSiteRemarksVector(builder, builder.createObjectOffsetList(this.siteRemarks));
  ...
  return Site_Full.createSite_Full(builder,
    id,
    entity,
    idEntity,
    idParentSite,
