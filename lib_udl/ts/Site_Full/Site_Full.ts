...
import { Site_Full_dataMode_Enum } from './Site_Full_dataMode_Enum.js';
...
unpack(): Site_FullT {
  return new Site_FullT(
    ...
    this.symCode(),
    this.referenceDoc(),
    this.bb!.createScalarList<string>(this.siteRemarks.bind(this), this.siteRemarksLength()),
    this.createdAt(),
    this.createdBy(),
    this.updatedAt(),
    this.updatedBy(),
...
unpackTo(_o: Site_FullT): void {
  ...
  _o.siteRemarks = this.bb!.createScalarList<string>(this.siteRemarks.bind(this), this.siteRemarksLength());
