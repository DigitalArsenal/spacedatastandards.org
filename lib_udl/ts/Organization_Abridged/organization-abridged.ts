...
static finishOrganization_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ORGA');
}

static finishSizePrefixedOrganization_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
