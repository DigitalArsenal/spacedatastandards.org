...
import { OperatingUnitRemark_Full_dataMode_Enum } from './operating-unit-remark-full-data-mode-enum.js';
 ...
 */
export class OperatingUnitRemark_Full implements flatbuffers.IUnpackableObject<OperatingUnitRemark_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OperatingUnitRemark_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOperatingUnitRemark_Full(bb:flatbuffers.ByteBuffer, obj?:OperatingUnitRemark_Full):OperatingUnitRemark_Full {
  return (obj || new OperatingUnitRemark_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOperatingUnitRemark_Full(bb:flatbuffers.ByteBuffer, obj?:OperatingUnitRemark_Full):OperatingUnitRemark_Full {
 ...
 */
dataMode():OperatingUnitRemark_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 32);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OperatingUnitRemark_Full_dataMode_Enum.REAL;
}

static startOperatingUnitRemark_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:OperatingUnitRemark_Full_dataMode_Enum) {
  builder.addFieldInt8(14, dataMode, OperatingUnitRemark_Full_dataMode_Enum.REAL);
}

static endOperatingUnitRemark_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishOperatingUnitRemark_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'OPER');
}

static finishSizePrefixedOperatingUnitRemark_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'OPER', true);
}

static createOperatingUnitRemark_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idOperatingUnitOffset:flatbuffers.Offset, altRmkIdOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, textOffset:flatbuffers.Offset, codeOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:OperatingUnitRemark_Full_dataMode_Enum):flatbuffers.Offset {
  OperatingUnitRemark_Full.startOperatingUnitRemark_Full(builder);
...
unpack(): OperatingUnitRemark_FullT {
  return new OperatingUnitRemark_FullT(
    this.id(),
...
unpackTo(_o: OperatingUnitRemark_FullT): void {
  _o.id = this.id();
...
export class OperatingUnitRemark_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: OperatingUnitRemark_Full_dataMode_Enum = OperatingUnitRemark_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return OperatingUnitRemark_Full.createOperatingUnitRemark_Full(builder,
    id,
