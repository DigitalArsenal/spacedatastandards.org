 ...
 */
export class PointOfContact_Ingest implements flatbuffers.IUnpackableObject<PointOfContact_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):PointOfContact_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsPointOfContact_Ingest(bb:flatbuffers.ByteBuffer, obj?:PointOfContact_Ingest):PointOfContact_Ingest {
  return (obj || new PointOfContact_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsPointOfContact_Ingest(bb:flatbuffers.ByteBuffer, obj?:PointOfContact_Ingest):PointOfContact_Ingest {
...
static startPointOfContact_Ingest(builder:flatbuffers.Builder) {
...
static endPointOfContact_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishPointOfContact_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'POIN');
}

static finishSizePrefixedPointOfContact_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'POIN', true);
}

static createPointOfContact_Ingest(builder:flatbuffers.Builder, pocSequenceId:number, pocTypeNameOffset:flatbuffers.Offset, pocNameOffset:flatbuffers.Offset, officeOffset:flatbuffers.Offset, usernameOffset:flatbuffers.Offset, rankOffset:flatbuffers.Offset, pocOrgOffset:flatbuffers.Offset, phoneOffset:flatbuffers.Offset, remarkOffset:flatbuffers.Offset):flatbuffers.Offset {
  PointOfContact_Ingest.startPointOfContact_Ingest(builder);
...
unpack(): PointOfContact_IngestT {
  return new PointOfContact_IngestT(
    this.pocSequenceId(),
    this.pocTypeName(),
    this.pocName(),
    this.office(),
...
unpackTo(_o: PointOfContact_IngestT): void {
...
export class PointOfContact_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return PointOfContact_Ingest.createPointOfContact_Ingest(builder,
    this.pocSequenceId,
    pocTypeName,
    pocName,
    office,
