...
import { SensorStats_Full_dataMode_Enum } from './sensor-stats-full-data-mode-enum.js';


/**
 * /// SensorStats contain statistics on sensors related to observation production such as last reported observation time.
 */
export class SensorStats_Full implements flatbuffers.IUnpackableObject<SensorStats_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SensorStats_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSensorStats_Full(bb:flatbuffers.ByteBuffer, obj?:SensorStats_Full):SensorStats_Full {
  return (obj || new SensorStats_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSensorStats_Full(bb:flatbuffers.ByteBuffer, obj?:SensorStats_Full):SensorStats_Full {
 ...
 */
dataMode():SensorStats_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 22);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SensorStats_Full_dataMode_Enum.REAL;
}

static startSensorStats_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SensorStats_Full_dataMode_Enum) {
  builder.addFieldInt8(9, dataMode, SensorStats_Full_dataMode_Enum.REAL);
}

static endSensorStats_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSensorStats_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SENS');
}

static finishSizePrefixedSensorStats_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SENS', true);
}

static createSensorStats_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, lastObTimeOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, dataMode:SensorStats_Full_dataMode_Enum):flatbuffers.Offset {
  SensorStats_Full.startSensorStats_Full(builder);
...
unpack(): SensorStats_FullT {
  return new SensorStats_FullT(
    this.id(),
    this.idSensor(),
...
unpackTo(_o: SensorStats_FullT): void {
  _o.id = this.id();
...
export class SensorStats_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SensorStats_Full_dataMode_Enum = SensorStats_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SensorStats_Full.createSensorStats_Full(builder,
    id,
    idSensor,
