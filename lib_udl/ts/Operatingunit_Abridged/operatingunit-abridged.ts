...
import { Operatingunit_Abridged_dataMode_Enum } from './operatingunit-abridged-data-mode-enum.js';
 ...
 */
export class Operatingunit_Abridged implements flatbuffers.IUnpackableObject<Operatingunit_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Operatingunit_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOperatingunit_Abridged(bb:flatbuffers.ByteBuffer, obj?:Operatingunit_Abridged):Operatingunit_Abridged {
  return (obj || new Operatingunit_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOperatingunit_Abridged(bb:flatbuffers.ByteBuffer, obj?:Operatingunit_Abridged):Operatingunit_Abridged {
 ...
 */
dataMode():Operatingunit_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 122);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Operatingunit_Abridged_dataMode_Enum.REAL;
}

static startOperatingunit_Abridged(builder:flatbuffers.Builder) {
...
unpack(): Operatingunit_AbridgedT {
  return new Operatingunit_AbridgedT(
...
unpackTo(_o: Operatingunit_AbridgedT): void {
...
export class Operatingunit_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Operatingunit_Abridged_dataMode_Enum = Operatingunit_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Operatingunit_Abridged.createOperatingunit_Abridged(builder,
    idOperatingUnit,
