 ...
 */
export class EvacVitalSignData_Full implements flatbuffers.IUnpackableObject<EvacVitalSignData_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EvacVitalSignData_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEvacVitalSignData_Full(bb:flatbuffers.ByteBuffer, obj?:EvacVitalSignData_Full):EvacVitalSignData_Full {
  return (obj || new EvacVitalSignData_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEvacVitalSignData_Full(bb:flatbuffers.ByteBuffer, obj?:EvacVitalSignData_Full):EvacVitalSignData_Full {
...
static startEvacVitalSignData_Full(builder:flatbuffers.Builder) {
...
static endEvacVitalSignData_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEvacVitalSignData_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC');
}

static finishSizePrefixedEvacVitalSignData_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC', true);
}

static createEvacVitalSignData_Full(builder:flatbuffers.Builder, vitalSignOffset:flatbuffers.Offset, vitalSign1:number, vitalSign2:number, medConfFactor:number, timeOffset:flatbuffers.Offset):flatbuffers.Offset {
  EvacVitalSignData_Full.startEvacVitalSignData_Full(builder);
...
unpack(): EvacVitalSignData_FullT {
  return new EvacVitalSignData_FullT(
    this.vitalSign(),
    this.vitalSign1(),
    this.vitalSign2(),
    this.medConfFactor(),
...
unpackTo(_o: EvacVitalSignData_FullT): void {
...
export class EvacVitalSignData_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return EvacVitalSignData_Full.createEvacVitalSignData_Full(builder,
    vitalSign,
    this.vitalSign1,
    this.vitalSign2,
    this.medConfFactor,
