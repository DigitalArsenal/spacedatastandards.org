 ...
 */
export class SEObservation_Abridged implements flatbuffers.IUnpackableObject<SEObservation_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SEObservation_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSEObservation_Abridged(bb:flatbuffers.ByteBuffer, obj?:SEObservation_Abridged):SEObservation_Abridged {
  return (obj || new SEObservation_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSEObservation_Abridged(bb:flatbuffers.ByteBuffer, obj?:SEObservation_Abridged):SEObservation_Abridged {
...
static startSEObservation_Abridged(builder:flatbuffers.Builder) {
...
static endSEObservation_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSEObservation_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SEOB');
}

static finishSizePrefixedSEObservation_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SEOB', true);
}

static createSEObservation_Abridged(builder:flatbuffers.Builder, obTypeOffset:flatbuffers.Offset, obUoMOffset:flatbuffers.Offset, obValue:number, obStringOffset:flatbuffers.Offset, obArrayOffset:flatbuffers.Offset, obBool:boolean, obQualityOffset:flatbuffers.Offset, obDescriptionOffset:flatbuffers.Offset):flatbuffers.Offset {
  SEObservation_Abridged.startSEObservation_Abridged(builder);
...
unpack(): SEObservation_AbridgedT {
  return new SEObservation_AbridgedT(
    this.obType(),
    this.obUoM(),
    this.obValue(),
    this.obString(),
...
unpackTo(_o: SEObservation_AbridgedT): void {
...
export class SEObservation_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const obArray = SEObservation_Abridged.createObArrayVector(builder, builder.createObjectOffsetList(this.obArray));
  ...
  return SEObservation_Abridged.createSEObservation_Abridged(builder,
    obType,
    obUoM,
    this.obValue,
    obString,
