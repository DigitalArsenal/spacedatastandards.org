...
import { EphemerisSet_Abridged_covReferenceFrame_Enum } from './EphemerisSet_Abridged_covReferenceFrame_Enum.js';
import { EphemerisSet_Abridged_dataMode_Enum } from './EphemerisSet_Abridged_dataMode_Enum.js';
import { EphemerisSet_Abridged_referenceFrame_Enum } from './EphemerisSet_Abridged_referenceFrame_Enum.js';
 ...
 */
export class EphemerisSet_Abridged implements flatbuffers.IUnpackableObject<EphemerisSet_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EphemerisSet_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEphemerisSet_Abridged(bb:flatbuffers.ByteBuffer, obj?:EphemerisSet_Abridged):EphemerisSet_Abridged {
  return (obj || new EphemerisSet_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEphemerisSet_Abridged(bb:flatbuffers.ByteBuffer, obj?:EphemerisSet_Abridged):EphemerisSet_Abridged {
 ...
 * Constraints: Minimum length = 0, Maximum length = 24
 */
referenceFrame():EphemerisSet_Abridged_referenceFrame_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 68);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : EphemerisSet_Abridged_referenceFrame_Enum.J2000;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 24
 */
covReferenceFrame():EphemerisSet_Abridged_covReferenceFrame_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 70);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : EphemerisSet_Abridged_covReferenceFrame_Enum.J2000;
}
 ...
 */
dataMode():EphemerisSet_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 80);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : EphemerisSet_Abridged_dataMode_Enum.REAL;
}
...
static startEphemerisSet_Abridged(builder:flatbuffers.Builder) {
...
static addReferenceFrame(builder:flatbuffers.Builder, referenceFrame:EphemerisSet_Abridged_referenceFrame_Enum) {
  builder.addFieldInt8(32, referenceFrame, EphemerisSet_Abridged_referenceFrame_Enum.J2000);
}

static addCovReferenceFrame(builder:flatbuffers.Builder, covReferenceFrame:EphemerisSet_Abridged_covReferenceFrame_Enum) {
  builder.addFieldInt8(33, covReferenceFrame, EphemerisSet_Abridged_covReferenceFrame_Enum.J2000);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:EphemerisSet_Abridged_dataMode_Enum) {
  builder.addFieldInt8(38, dataMode, EphemerisSet_Abridged_dataMode_Enum.REAL);
}
...
static endEphemerisSet_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEphemerisSet_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EPHE');
}

static finishSizePrefixedEphemerisSet_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EPHE', true);
}

static createEphemerisSet_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, origObjectIdOffset:flatbuffers.Offset, pointStartTimeOffset:flatbuffers.Offset, usableStartTimeOffset:flatbuffers.Offset, pointEndTimeOffset:flatbuffers.Offset, usableEndTimeOffset:flatbuffers.Offset, stepSize:number, numPoints:number, typeOffset:flatbuffers.Offset, pedigreeOffset:flatbuffers.Offset, categoryOffset:flatbuffers.Offset, idStateVectorOffset:flatbuffers.Offset, hasMnvr:boolean, idManeuversOffset:flatbuffers.Offset, hasCov:boolean, hasAccel:boolean, centBodyOffset:flatbuffers.Offset, integratorOffset:flatbuffers.Offset, geopotentialModelOffset:flatbuffers.Offset, dragModelOffset:flatbuffers.Offset, lunarSolar:boolean, solidEarthTides:boolean, bDot:number, edr:number, interpolationOffset:flatbuffers.Offset, interpolationDegree:number, filenameOffset:flatbuffers.Offset, commentsOffset:flatbuffers.Offset, descriptionOffset:flatbuffers.Offset, descriptorOffset:flatbuffers.Offset, referenceFrame:EphemerisSet_Abridged_referenceFrame_Enum, covReferenceFrame:EphemerisSet_Abridged_covReferenceFrame_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:EphemerisSet_Abridged_dataMode_Enum, satNo:number, transactionIdOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  EphemerisSet_Abridged.startEphemerisSet_Abridged(builder);
...
unpack(): EphemerisSet_AbridgedT {
  return new EphemerisSet_AbridgedT(
    this.id(),
...
unpackTo(_o: EphemerisSet_AbridgedT): void {
  _o.id = this.id();
...
export class EphemerisSet_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public referenceFrame: EphemerisSet_Abridged_referenceFrame_Enum = EphemerisSet_Abridged_referenceFrame_Enum.J2000,
  public covReferenceFrame: EphemerisSet_Abridged_covReferenceFrame_Enum = EphemerisSet_Abridged_covReferenceFrame_Enum.J2000,
  public createdAt: string|Uint8Array|null = null,
  public createdBy: string|Uint8Array|null = null,
  public source: string|Uint8Array|null = null,
  public origin: string|Uint8Array|null = null,
  public dataMode: EphemerisSet_Abridged_dataMode_Enum = EphemerisSet_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const idManeuvers = EphemerisSet_Abridged.createIdManeuversVector(builder, builder.createObjectOffsetList(this.idManeuvers));
  ...
  return EphemerisSet_Abridged.createEphemerisSet_Abridged(builder,
    id,
