 ...
 */
export class CrewMembers_Full implements flatbuffers.IUnpackableObject<CrewMembers_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):CrewMembers_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsCrewMembers_Full(bb:flatbuffers.ByteBuffer, obj?:CrewMembers_Full):CrewMembers_Full {
  return (obj || new CrewMembers_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsCrewMembers_Full(bb:flatbuffers.ByteBuffer, obj?:CrewMembers_Full):CrewMembers_Full {
...
static startCrewMembers_Full(builder:flatbuffers.Builder) {
...
unpack(): CrewMembers_FullT {
  return new CrewMembers_FullT(
    this.lastName(),
    this.firstName(),
    this.middleInitial(),
    this.memberId(),
...
unpackTo(_o: CrewMembers_FullT): void {
...
export class CrewMembers_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return CrewMembers_Full.createCrewMembers_Full(builder,
    lastName,
    firstName,
    middleInitial,
    memberId,
