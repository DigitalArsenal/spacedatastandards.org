...
import { Mti_Abridged_dataMode_Enum } from './Mti_Abridged_dataMode_Enum.js';


/**
 * /// Information on the mission and flight plans, the type and configuration of the platform, and the reference time.
 */
export class Mti_Abridged implements flatbuffers.IUnpackableObject<Mti_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Mti_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMti_Abridged(bb:flatbuffers.ByteBuffer, obj?:Mti_Abridged):Mti_Abridged {
  return (obj || new Mti_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMti_Abridged(bb:flatbuffers.ByteBuffer, obj?:Mti_Abridged):Mti_Abridged {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new Mti_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static bufferHasIdentifier(bb:flatbuffers.ByteBuffer):boolean {
  return bb.__has_identifier('MTIA');
}
 ...
 */
dataMode():Mti_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 12);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Mti_Abridged_dataMode_Enum.REAL;
}
...
static startMti_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Mti_Abridged_dataMode_Enum) {
  builder.addFieldInt8(4, dataMode, Mti_Abridged_dataMode_Enum.REAL);
}
...
static endMti_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishMti_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIA');
}

static finishSizePrefixedMti_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIA', true);
}

static createMti_Abridged(builder:flatbuffers.Builder, classificationMarkingOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, idOffset:flatbuffers.Offset, dataMode:Mti_Abridged_dataMode_Enum, createdByOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, p3Offset:flatbuffers.Offset, p6Offset:flatbuffers.Offset, p7Offset:flatbuffers.Offset, p8Offset:flatbuffers.Offset, p9:number, p10:number, missionsOffset:flatbuffers.Offset, dwellsOffset:flatbuffers.Offset, hrrsOffset:flatbuffers.Offset, jobDefsOffset:flatbuffers.Offset, freeTextsOffset:flatbuffers.Offset, platformLocsOffset:flatbuffers.Offset, jobRequestsOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  Mti_Abridged.startMti_Abridged(builder);
...
unpack(): Mti_AbridgedT {
  return new Mti_AbridgedT(
...
unpackTo(_o: Mti_AbridgedT): void {
...
export class Mti_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  public classificationMarking: string|Uint8Array|null = null,
  public source: string|Uint8Array|null = null,
  public origin: string|Uint8Array|null = null,
  public id: string|Uint8Array|null = null,
  public dataMode: Mti_Abridged_dataMode_Enum = Mti_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const missions = Mti_Abridged.createMissionsVector(builder, builder.createObjectOffsetList(this.missions));
  const dwells = Mti_Abridged.createDwellsVector(builder, builder.createObjectOffsetList(this.dwells));
  const hrrs = Mti_Abridged.createHrrsVector(builder, builder.createObjectOffsetList(this.hrrs));
  const jobDefs = Mti_Abridged.createJobDefsVector(builder, builder.createObjectOffsetList(this.jobDefs));
  const freeTexts = Mti_Abridged.createFreeTextsVector(builder, builder.createObjectOffsetList(this.freeTexts));
  const platformLocs = Mti_Abridged.createPlatformLocsVector(builder, builder.createObjectOffsetList(this.platformLocs));
  const jobRequests = Mti_Abridged.createJobRequestsVector(builder, builder.createObjectOffsetList(this.jobRequests));
  const origNetwork = (this.origNetwork !== null ? builder.createString(this.origNetwork!) : 0);

  return Mti_Abridged.createMti_Abridged(builder,
