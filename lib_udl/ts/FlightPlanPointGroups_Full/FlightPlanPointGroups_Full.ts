 ...
 */
export class FlightPlanPointGroups_Full implements flatbuffers.IUnpackableObject<FlightPlanPointGroups_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):FlightPlanPointGroups_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsFlightPlanPointGroups_Full(bb:flatbuffers.ByteBuffer, obj?:FlightPlanPointGroups_Full):FlightPlanPointGroups_Full {
  return (obj || new FlightPlanPointGroups_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsFlightPlanPointGroups_Full(bb:flatbuffers.ByteBuffer, obj?:FlightPlanPointGroups_Full):FlightPlanPointGroups_Full {
...
static startFlightPlanPointGroups_Full(builder:flatbuffers.Builder) {
...
static endFlightPlanPointGroups_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishFlightPlanPointGroups_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'FLIG');
}

static finishSizePrefixedFlightPlanPointGroups_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'FLIG', true);
}

static createFlightPlanPointGroups_Full(builder:flatbuffers.Builder, pointGroupNameOffset:flatbuffers.Offset, worstFuelCaseOffset:flatbuffers.Offset, lsafNameOffset:flatbuffers.Offset, lsafDistance:number, fsafDistance:number, etopsDistance:number, lsafTimeOffset:flatbuffers.Offset, fsafTimeOffset:flatbuffers.Offset, etopsTimeOffset:flatbuffers.Offset, lsafAvgWindFactor:number, fsafAvgWindFactor:number, etopsAvgWindFactor:number, lsafTempDev:number, fsafTempDev:number, etopsTempDev:number, lsafReqFuel:number, fsafReqFuel:number, etopsReqFuel:number, fromTakeoffTimeOffset:flatbuffers.Offset, plannedFuel:number, fuelCalcAlt:number, fuelCalcSpd:number, avgFuelFlow:number, flightPlanPointsOffset:flatbuffers.Offset):flatbuffers.Offset {
  FlightPlanPointGroups_Full.startFlightPlanPointGroups_Full(builder);
...
unpack(): FlightPlanPointGroups_FullT {
  return new FlightPlanPointGroups_FullT(
    this.pointGroupName(),
    this.worstFuelCase(),
    this.lsafName(),
    this.lsafDistance(),
    ...
    this.fuelCalcSpd(),
    this.avgFuelFlow(),
    this.bb!.createScalarList<string>(this.flightPlanPoints.bind(this), this.flightPlanPointsLength())
  );
}


unpackTo(_o: FlightPlanPointGroups_FullT): void {
  ...
  _o.flightPlanPoints = this.bb!.createScalarList<string>(this.flightPlanPoints.bind(this), this.flightPlanPointsLength());
}
}

export class FlightPlanPointGroups_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const flightPlanPoints = FlightPlanPointGroups_Full.createFlightPlanPointsVector(builder, builder.createObjectOffsetList(this.flightPlanPoints));

  return FlightPlanPointGroups_Full.createFlightPlanPointGroups_Full(builder,
    pointGroupName,
    worstFuelCase,
    lsafName,
    this.lsafDistance,
