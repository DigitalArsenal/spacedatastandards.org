 ...
 */
export class MtiJobRequest_Ingest implements flatbuffers.IUnpackableObject<MtiJobRequest_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MtiJobRequest_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMtiJobRequest_Ingest(bb:flatbuffers.ByteBuffer, obj?:MtiJobRequest_Ingest):MtiJobRequest_Ingest {
  return (obj || new MtiJobRequest_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMtiJobRequest_Ingest(bb:flatbuffers.ByteBuffer, obj?:MtiJobRequest_Ingest):MtiJobRequest_Ingest {
...
static startMtiJobRequest_Ingest(builder:flatbuffers.Builder) {
...
static endMtiJobRequest_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishMtiJobRequest_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIJ');
}

static finishSizePrefixedMtiJobRequest_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIJ', true);
}

static createMtiJobRequest_Ingest(builder:flatbuffers.Builder, r1Offset:flatbuffers.Offset, r2Offset:flatbuffers.Offset, r3:number, r4:number, r5:number, r6:number, r7:number, r8:number, r9:number, r10:number, r11:number, r12Offset:flatbuffers.Offset, r13:number, r14:number, jobReqEstOffset:flatbuffers.Offset, r21:number, r22:number, r23:number, r24Offset:flatbuffers.Offset, r25Offset:flatbuffers.Offset, r26:boolean):flatbuffers.Offset {
  MtiJobRequest_Ingest.startMtiJobRequest_Ingest(builder);
...
unpack(): MtiJobRequest_IngestT {
  return new MtiJobRequest_IngestT(
    this.r1(),
    this.r2(),
    this.r3(),
    this.r4(),
...
unpackTo(_o: MtiJobRequest_IngestT): void {
  _o.r1 = this.r1();
  _o.r2 = this.r2();
  _o.r3 = this.r3();
  _o.r4 = this.r4();
...
export class MtiJobRequest_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return MtiJobRequest_Ingest.createMtiJobRequest_Ingest(builder,
    r1,
    r2,
    this.r3,
    this.r4,
