 ...
 */
export class EvacMedication_Full implements flatbuffers.IUnpackableObject<EvacMedication_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EvacMedication_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEvacMedication_Full(bb:flatbuffers.ByteBuffer, obj?:EvacMedication_Full):EvacMedication_Full {
  return (obj || new EvacMedication_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEvacMedication_Full(bb:flatbuffers.ByteBuffer, obj?:EvacMedication_Full):EvacMedication_Full {
...
static startEvacMedication_Full(builder:flatbuffers.Builder) {
...
static endEvacMedication_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEvacMedication_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC');
}

static finishSizePrefixedEvacMedication_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC', true);
}

static createEvacMedication_Full(builder:flatbuffers.Builder, typeOffset:flatbuffers.Offset, bodyPartOffset:flatbuffers.Offset, doseOffset:flatbuffers.Offset, adminRouteOffset:flatbuffers.Offset, timeOffset:flatbuffers.Offset, commentsOffset:flatbuffers.Offset):flatbuffers.Offset {
  EvacMedication_Full.startEvacMedication_Full(builder);
...
unpack(): EvacMedication_FullT {
  return new EvacMedication_FullT(
    this.type(),
    this.bodyPart(),
    this.dose(),
    this.adminRoute(),
...
unpackTo(_o: EvacMedication_FullT): void {
  _o.type = this.type();
...
export class EvacMedication_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return EvacMedication_Full.createEvacMedication_Full(builder,
    type,
    bodyPart,
    dose,
    adminRoute,
