...
import { Operatingunit_dataMode_Enum } from './Operatingunit_dataMode_Enum.js';
 ...
 */
export class Operatingunit implements flatbuffers.IUnpackableObject<OperatingunitT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Operatingunit {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOperatingunit(bb:flatbuffers.ByteBuffer, obj?:Operatingunit):Operatingunit {
  return (obj || new Operatingunit()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOperatingunit(bb:flatbuffers.ByteBuffer, obj?:Operatingunit):Operatingunit {
 ...
 */
dataMode():Operatingunit_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 128);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Operatingunit_dataMode_Enum.REAL;
}
...
static startOperatingunit(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Operatingunit_dataMode_Enum) {
  builder.addFieldInt8(62, dataMode, Operatingunit_dataMode_Enum.REAL);
}
...
unpack(): OperatingunitT {
  return new OperatingunitT(
    ...
    this.resProd(),
    this.referenceDoc(),
    this.bb!.createScalarList<string>(this.operatingUnitRemarks.bind(this), this.operatingUnitRemarksLength()),
    this.createdAt(),
    this.createdBy(),
    this.updatedAt(),
    this.updatedBy(),
...
unpackTo(_o: OperatingunitT): void {
  ...
  _o.operatingUnitRemarks = this.bb!.createScalarList<string>(this.operatingUnitRemarks.bind(this), this.operatingUnitRemarksLength());
...
export class OperatingunitT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Operatingunit_dataMode_Enum = Operatingunit_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const operatingUnitRemarks = Operatingunit.createOperatingUnitRemarksVector(builder, builder.createObjectOffsetList(this.operatingUnitRemarks));
  ...
  return Operatingunit.createOperatingunit(builder,
    idOperatingUnit,
