...
import { Location_Abridged_dataMode_Enum } from './location-abridged-data-mode-enum.js';
 ...
 */
export class Location_Abridged implements flatbuffers.IUnpackableObject<Location_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Location_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLocation_Abridged(bb:flatbuffers.ByteBuffer, obj?:Location_Abridged):Location_Abridged {
  return (obj || new Location_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLocation_Abridged(bb:flatbuffers.ByteBuffer, obj?:Location_Abridged):Location_Abridged {
 ...
 */
dataMode():Location_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 26);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Location_Abridged_dataMode_Enum.REAL;
}
...
static startLocation_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Location_Abridged_dataMode_Enum) {
  builder.addFieldInt8(11, dataMode, Location_Abridged_dataMode_Enum.REAL);
}
...
static endLocation_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishLocation_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'LOCA');
}

static finishSizePrefixedLocation_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'LOCA', true);
}

static createLocation_Abridged(builder:flatbuffers.Builder, idLocationOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, countryCodeOffset:flatbuffers.Offset, lat:number, lon:number, altitude:number, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:Location_Abridged_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  Location_Abridged.startLocation_Abridged(builder);
...
unpack(): Location_AbridgedT {
  return new Location_AbridgedT(
    this.idLocation(),
...
unpackTo(_o: Location_AbridgedT): void {
...
export class Location_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Location_Abridged_dataMode_Enum = Location_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Location_Abridged.createLocation_Abridged(builder,
    idLocation,
