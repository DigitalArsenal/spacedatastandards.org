 ...
 */
export class EffectResponseActionsList_Abridged implements flatbuffers.IUnpackableObject<EffectResponseActionsList_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EffectResponseActionsList_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEffectResponseActionsList_Abridged(bb:flatbuffers.ByteBuffer, obj?:EffectResponseActionsList_Abridged):EffectResponseActionsList_Abridged {
  return (obj || new EffectResponseActionsList_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEffectResponseActionsList_Abridged(bb:flatbuffers.ByteBuffer, obj?:EffectResponseActionsList_Abridged):EffectResponseActionsList_Abridged {
...
static startEffectResponseActionsList_Abridged(builder:flatbuffers.Builder) {
...
unpack(): EffectResponseActionsList_AbridgedT {
  return new EffectResponseActionsList_AbridgedT(
    this.summary(),
    this.actionId(),
    ...
    this.bb!.createScalarList<string>(this.actionMetrics.bind(this), this.actionMetrics_Length())
  );
}


unpackTo(_o: EffectResponseActionsList_AbridgedT): void {
  ...
  _o.actionMetrics = this.bb!.createScalarList<string>(this.actionMetrics.bind(this), this.actionMetrics_Length());
}
}

export class EffectResponseActionsList_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const actionMetrics = EffectResponseActionsList_Abridged.createActionMetricsVector(builder, builder.createObjectOffsetList(this.actionMetrics));

  return EffectResponseActionsList_Abridged.createEffectResponseActionsList_Abridged(builder,
    summary,
    actionId,
    actionStartTime,
    actionEndTime,
