 ...
 */
export class FlightPlanWaypoints_Ingest implements flatbuffers.IUnpackableObject<FlightPlanWaypoints_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):FlightPlanWaypoints_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsFlightPlanWaypoints_Ingest(bb:flatbuffers.ByteBuffer, obj?:FlightPlanWaypoints_Ingest):FlightPlanWaypoints_Ingest {
  return (obj || new FlightPlanWaypoints_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsFlightPlanWaypoints_Ingest(bb:flatbuffers.ByteBuffer, obj?:FlightPlanWaypoints_Ingest):FlightPlanWaypoints_Ingest {
...
static startFlightPlanWaypoints_Ingest(builder:flatbuffers.Builder) {
...
unpack(): FlightPlanWaypoints_IngestT {
  return new FlightPlanWaypoints_IngestT(
    this.type(),
    this.waypointName(),
    this.waypointNum(),
    this.airway(),
...
unpackTo(_o: FlightPlanWaypoints_IngestT): void {
  _o.type = this.type();
...
export class FlightPlanWaypoints_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return FlightPlanWaypoints_Ingest.createFlightPlanWaypoints_Ingest(builder,
    type,
    waypointName,
    this.waypointNum,
    airway,
