 ...
 */
export class MtiFreeText_Ingest implements flatbuffers.IUnpackableObject<MtiFreeText_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MtiFreeText_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMtiFreeText_Ingest(bb:flatbuffers.ByteBuffer, obj?:MtiFreeText_Ingest):MtiFreeText_Ingest {
  return (obj || new MtiFreeText_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMtiFreeText_Ingest(bb:flatbuffers.ByteBuffer, obj?:MtiFreeText_Ingest):MtiFreeText_Ingest {
...
static startMtiFreeText_Ingest(builder:flatbuffers.Builder) {
...
static endMtiFreeText_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishMtiFreeText_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIF');
}

static finishSizePrefixedMtiFreeText_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTIF', true);
}

static createMtiFreeText_Ingest(builder:flatbuffers.Builder, f1Offset:flatbuffers.Offset, f2Offset:flatbuffers.Offset, f3Offset:flatbuffers.Offset):flatbuffers.Offset {
  MtiFreeText_Ingest.startMtiFreeText_Ingest(builder);
...
unpack(): MtiFreeText_IngestT {
  return new MtiFreeText_IngestT(
    this.f1(),
    this.f2(),
    this.f3()
  );
...
unpackTo(_o: MtiFreeText_IngestT): void {
  _o.f1 = this.f1();
  _o.f2 = this.f2();
  _o.f3 = this.f3();
}
...
export class MtiFreeText_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return MtiFreeText_Ingest.createMtiFreeText_Ingest(builder,
    f1,
    f2,
    f3
  );
