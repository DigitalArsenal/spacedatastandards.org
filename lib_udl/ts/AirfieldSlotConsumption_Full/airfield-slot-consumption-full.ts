...
import { AirfieldSlotConsumption_Full_dataMode_Enum } from './airfield-slot-consumption-full-data-mode-enum.js';
import { AirfieldSlotConsumption_Full_status_Enum } from './airfield-slot-consumption-full-status-enum.js';


/**
 * /// Airfield slot use data. Contains the dynamic data associated with the status and use of specific airfield slots.
 */
export class AirfieldSlotConsumption_Full implements flatbuffers.IUnpackableObject<AirfieldSlotConsumption_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirfieldSlotConsumption_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirfieldSlotConsumption_Full(bb:flatbuffers.ByteBuffer, obj?:AirfieldSlotConsumption_Full):AirfieldSlotConsumption_Full {
  return (obj || new AirfieldSlotConsumption_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirfieldSlotConsumption_Full(bb:flatbuffers.ByteBuffer, obj?:AirfieldSlotConsumption_Full):AirfieldSlotConsumption_Full {
 ...
 */
status():AirfieldSlotConsumption_Full_status_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 10);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirfieldSlotConsumption_Full_status_Enum.REQUESTED;
}
 ...
 */
dataMode():AirfieldSlotConsumption_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 80);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirfieldSlotConsumption_Full_dataMode_Enum.REAL;
}

static startAirfieldSlotConsumption_Full(builder:flatbuffers.Builder) {
...
static addStatus(builder:flatbuffers.Builder, status:AirfieldSlotConsumption_Full_status_Enum) {
  builder.addFieldInt8(3, status, AirfieldSlotConsumption_Full_status_Enum.REQUESTED);
}
...
unpack(): AirfieldSlotConsumption_FullT {
  return new AirfieldSlotConsumption_FullT(
    this.id(),
...
unpackTo(_o: AirfieldSlotConsumption_FullT): void {
  _o.id = this.id();
...
export class AirfieldSlotConsumption_FullT implements flatbuffers.IGeneratedObject {
constructor(
  public id: string|Uint8Array|null = null,
  public classificationMarking: string|Uint8Array|null = null,
  public idAirfieldSlot: string|Uint8Array|null = null,
  public status: AirfieldSlotConsumption_Full_status_Enum = AirfieldSlotConsumption_Full_status_Enum.REQUESTED,
  ...
  public dataMode: AirfieldSlotConsumption_Full_dataMode_Enum = AirfieldSlotConsumption_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const callSigns = AirfieldSlotConsumption_Full.createCallSignsVector(builder, builder.createObjectOffsetList(this.callSigns));
  ...
  return AirfieldSlotConsumption_Full.createAirfieldSlotConsumption_Full(builder,
    id,
