 ...
 */
export class DataLinkMultiDuty_Full implements flatbuffers.IUnpackableObject<DataLinkMultiDuty_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):DataLinkMultiDuty_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsDataLinkMultiDuty_Full(bb:flatbuffers.ByteBuffer, obj?:DataLinkMultiDuty_Full):DataLinkMultiDuty_Full {
  return (obj || new DataLinkMultiDuty_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsDataLinkMultiDuty_Full(bb:flatbuffers.ByteBuffer, obj?:DataLinkMultiDuty_Full):DataLinkMultiDuty_Full {
...
static startDataLinkMultiDuty_Full(builder:flatbuffers.Builder) {
...
static endDataLinkMultiDuty_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishDataLinkMultiDuty_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DATA');
}

static finishSizePrefixedDataLinkMultiDuty_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DATA', true);
}

static createDataLinkMultiDuty_Full(builder:flatbuffers.Builder, unitDesOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, rankOffset:flatbuffers.Offset, dutyOffset:flatbuffers.Offset, dutyTeleFreqNumsOffset:flatbuffers.Offset, multiDutyVoiceCoordOffset:flatbuffers.Offset):flatbuffers.Offset {
  DataLinkMultiDuty_Full.startDataLinkMultiDuty_Full(builder);
  DataLinkMultiDuty_Full.addUnitDes(builder, unitDesOffset);
  DataLinkMultiDuty_Full.addName(builder, nameOffset);
  DataLinkMultiDuty_Full.addRank(builder, rankOffset);
  DataLinkMultiDuty_Full.addDuty(builder, dutyOffset);
  DataLinkMultiDuty_Full.addDutyTeleFreqNums(builder, dutyTeleFreqNumsOffset);
  DataLinkMultiDuty_Full.addMultiDutyVoiceCoord(builder, multiDutyVoiceCoordOffset);
  return DataLinkMultiDuty_Full.endDataLinkMultiDuty_Full(builder);
}

unpack(): DataLinkMultiDuty_FullT {
  return new DataLinkMultiDuty_FullT(
    this.unitDes(),
    this.name(),
    this.rank(),
    this.duty(),
...
unpackTo(_o: DataLinkMultiDuty_FullT): void {
...
export class DataLinkMultiDuty_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const dutyTeleFreqNums = DataLinkMultiDuty_Full.createDutyTeleFreqNumsVector(builder, builder.createObjectOffsetList(this.dutyTeleFreqNums));
  const multiDutyVoiceCoord = DataLinkMultiDuty_Full.createMultiDutyVoiceCoordVector(builder, builder.createObjectOffsetList(this.multiDutyVoiceCoord));

  return DataLinkMultiDuty_Full.createDataLinkMultiDuty_Full(builder,
    unitDes,
    name,
    rank,
    duty,
