...
import { Crew_Abridged_dataMode_Enum } from './crew-abridged-data-mode-enum.js';


/**
 * /// Crew Services.
 */
export class Crew_Abridged implements flatbuffers.IUnpackableObject<Crew_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Crew_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsCrew_Abridged(bb:flatbuffers.ByteBuffer, obj?:Crew_Abridged):Crew_Abridged {
  return (obj || new Crew_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsCrew_Abridged(bb:flatbuffers.ByteBuffer, obj?:Crew_Abridged):Crew_Abridged {
 ...
 */
dataMode():Crew_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 48);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Crew_Abridged_dataMode_Enum.REAL;
}

static startCrew_Abridged(builder:flatbuffers.Builder) {
...
unpack(): Crew_AbridgedT {
  return new Crew_AbridgedT(
    this.id(),
...
unpackTo(_o: Crew_AbridgedT): void {
  _o.id = this.id();
...
export class Crew_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Crew_Abridged_dataMode_Enum = Crew_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const crewMembers = Crew_Abridged.createCrewMembersVector(builder, builder.createObjectOffsetList(this.crewMembers));
  ...
  return Crew_Abridged.createCrew_Abridged(builder,
    id,
