 ...
 */
export class LogisticsSegments_Abridged implements flatbuffers.IUnpackableObject<LogisticsSegments_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LogisticsSegments_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLogisticsSegments_Abridged(bb:flatbuffers.ByteBuffer, obj?:LogisticsSegments_Abridged):LogisticsSegments_Abridged {
  return (obj || new LogisticsSegments_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLogisticsSegments_Abridged(bb:flatbuffers.ByteBuffer, obj?:LogisticsSegments_Abridged):LogisticsSegments_Abridged {
...
static startLogisticsSegments_Abridged(builder:flatbuffers.Builder) {
...
unpack(): LogisticsSegments_AbridgedT {
  return new LogisticsSegments_AbridgedT(
    this.segmentNumber(),
    this.modeCode(),
    this.missionType(),
    this.idMission(),
...
unpackTo(_o: LogisticsSegments_AbridgedT): void {
...
export class LogisticsSegments_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return LogisticsSegments_Abridged.createLogisticsSegments_Abridged(builder,
    this.segmentNumber,
    modeCode,
    missionType,
    idMission,
