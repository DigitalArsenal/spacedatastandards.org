...
import { SensorMaintenance_Full_dataMode_Enum } from './sensor-maintenance-full-data-mode-enum.js';


/**
 * /// Maintenance schedule and operational status of Sensor.
 */
export class SensorMaintenance_Full implements flatbuffers.IUnpackableObject<SensorMaintenance_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SensorMaintenance_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSensorMaintenance_Full(bb:flatbuffers.ByteBuffer, obj?:SensorMaintenance_Full):SensorMaintenance_Full {
  return (obj || new SensorMaintenance_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSensorMaintenance_Full(bb:flatbuffers.ByteBuffer, obj?:SensorMaintenance_Full):SensorMaintenance_Full {
 ...
 */
dataMode():SensorMaintenance_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 62);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SensorMaintenance_Full_dataMode_Enum.REAL;
}
...
static startSensorMaintenance_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SensorMaintenance_Full_dataMode_Enum) {
  builder.addFieldInt8(29, dataMode, SensorMaintenance_Full_dataMode_Enum.REAL);
}
...
unpack(): SensorMaintenance_FullT {
  return new SensorMaintenance_FullT(
    this.id(),
...
unpackTo(_o: SensorMaintenance_FullT): void {
  _o.id = this.id();
...
export class SensorMaintenance_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SensorMaintenance_Full_dataMode_Enum = SensorMaintenance_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SensorMaintenance_Full.createSensorMaintenance_Full(builder,
    id,
