...
import { OrganizationDetails_dataMode_Enum } from './organization-details-data-mode-enum.js';


/**
 * /// Model representation of additional detailed organization data as collected by a particular source.
 */
export class OrganizationDetails implements flatbuffers.IUnpackableObject<OrganizationDetailsT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OrganizationDetails {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOrganizationDetails(bb:flatbuffers.ByteBuffer, obj?:OrganizationDetails):OrganizationDetails {
  return (obj || new OrganizationDetails()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOrganizationDetails(bb:flatbuffers.ByteBuffer, obj?:OrganizationDetails):OrganizationDetails {
 ...
 */
dataMode():OrganizationDetails_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 68);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OrganizationDetails_dataMode_Enum.REAL;
}
...
static startOrganizationDetails(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:OrganizationDetails_dataMode_Enum) {
  builder.addFieldInt8(32, dataMode, OrganizationDetails_dataMode_Enum.REAL);
}
...
static endOrganizationDetails(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishOrganizationDetailsBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ORGA');
}

static finishSizePrefixedOrganizationDetailsBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ORGA', true);
}

static createOrganizationDetails(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idOrganizationOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, emailOffset:flatbuffers.Offset, address1Offset:flatbuffers.Offset, address2Offset:flatbuffers.Offset, address3Offset:flatbuffers.Offset, geoAdminLevel1Offset:flatbuffers.Offset, geoAdminLevel2Offset:flatbuffers.Offset, geoAdminLevel3Offset:flatbuffers.Offset, postalCodeOffset:flatbuffers.Offset, descriptionOffset:flatbuffers.Offset, formerOrgIdOffset:flatbuffers.Offset, parentOrgIdOffset:flatbuffers.Offset, financialYearEndDateOffset:flatbuffers.Offset, revenue:number, profit:number, ebitda:number, ftes:number, brokerOffset:flatbuffers.Offset, ceoOffset:flatbuffers.Offset, cfoOffset:flatbuffers.Offset, ctoOffset:flatbuffers.Offset, riskManagerOffset:flatbuffers.Offset, massRanking:number, revenueRanking:number, financialNotesOffset:flatbuffers.Offset, servicesNotesOffset:flatbuffers.Offset, fleetPlanNotesOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:OrganizationDetails_dataMode_Enum, tagsOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  OrganizationDetails.startOrganizationDetails(builder);
...
unpack(): OrganizationDetailsT {
  return new OrganizationDetailsT(
    this.id(),
    this.idOrganization(),
...
unpackTo(_o: OrganizationDetailsT): void {
  _o.id = this.id();
...
export class OrganizationDetailsT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: OrganizationDetails_dataMode_Enum = OrganizationDetails_dataMode_Enum.REAL,
  public tags: (string)[] = [],
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = OrganizationDetails.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return OrganizationDetails.createOrganizationDetails(builder,
    id,
    idOrganization,
