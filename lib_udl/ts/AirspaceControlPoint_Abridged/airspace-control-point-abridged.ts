 ...
 */
export class AirspaceControlPoint_Abridged implements flatbuffers.IUnpackableObject<AirspaceControlPoint_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirspaceControlPoint_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirspaceControlPoint_Abridged(bb:flatbuffers.ByteBuffer, obj?:AirspaceControlPoint_Abridged):AirspaceControlPoint_Abridged {
  return (obj || new AirspaceControlPoint_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirspaceControlPoint_Abridged(bb:flatbuffers.ByteBuffer, obj?:AirspaceControlPoint_Abridged):AirspaceControlPoint_Abridged {
...
static startAirspaceControlPoint_Abridged(builder:flatbuffers.Builder) {
...
static endAirspaceControlPoint_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirspaceControlPoint_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRS');
}

static finishSizePrefixedAirspaceControlPoint_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRS', true);
}

static createAirspaceControlPoint_Abridged(builder:flatbuffers.Builder, ctrlPtTypeOffset:flatbuffers.Offset, ctrlPtNameOffset:flatbuffers.Offset, ctrlPtLocationOffset:flatbuffers.Offset, ctrlPtAltitudeOffset:flatbuffers.Offset):flatbuffers.Offset {
  AirspaceControlPoint_Abridged.startAirspaceControlPoint_Abridged(builder);
...
unpack(): AirspaceControlPoint_AbridgedT {
  return new AirspaceControlPoint_AbridgedT(
    this.ctrlPtType(),
    this.ctrlPtName(),
    this.ctrlPtLocation(),
    this.ctrlPtAltitude()
...
unpackTo(_o: AirspaceControlPoint_AbridgedT): void {
...
export class AirspaceControlPoint_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AirspaceControlPoint_Abridged.createAirspaceControlPoint_Abridged(builder,
    ctrlPtType,
    ctrlPtName,
    ctrlPtLocation,
    ctrlPtAltitude
