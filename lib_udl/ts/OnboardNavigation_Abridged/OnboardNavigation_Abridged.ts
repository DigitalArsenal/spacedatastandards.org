...
import { OnboardNavigation_Abridged_dataMode_Enum } from './OnboardNavigation_Abridged_dataMode_Enum.js';
import { OnboardNavigation_Abridged_referenceFrame_Enum } from './OnboardNavigation_Abridged_referenceFrame_Enum.js';
 ...
 */
export class OnboardNavigation_Abridged implements flatbuffers.IUnpackableObject<OnboardNavigation_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OnboardNavigation_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOnboardNavigation_Abridged(bb:flatbuffers.ByteBuffer, obj?:OnboardNavigation_Abridged):OnboardNavigation_Abridged {
  return (obj || new OnboardNavigation_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOnboardNavigation_Abridged(bb:flatbuffers.ByteBuffer, obj?:OnboardNavigation_Abridged):OnboardNavigation_Abridged {
 ...
 * Constraints: Minimum length = 0, Maximum length = 24
 */
referenceFrame():OnboardNavigation_Abridged_referenceFrame_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 28);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OnboardNavigation_Abridged_referenceFrame_Enum.J2000;
}
 ...
 * Constraints: Minimum length = 1, Maximum length = 36
 */
dataMode():OnboardNavigation_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 48);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OnboardNavigation_Abridged_dataMode_Enum.REAL;
}

static startOnboardNavigation_Abridged(builder:flatbuffers.Builder) {
...
static addReferenceFrame(builder:flatbuffers.Builder, referenceFrame:OnboardNavigation_Abridged_referenceFrame_Enum) {
  builder.addFieldInt8(12, referenceFrame, OnboardNavigation_Abridged_referenceFrame_Enum.J2000);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:OnboardNavigation_Abridged_dataMode_Enum) {
  builder.addFieldInt8(22, dataMode, OnboardNavigation_Abridged_dataMode_Enum.REAL);
}

static endOnboardNavigation_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishOnboardNavigation_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ONBO');
}

static finishSizePrefixedOnboardNavigation_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ONBO', true);
}

static createOnboardNavigation_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, satNo:number, origObjectIdOffset:flatbuffers.Offset, startTimeOffset:flatbuffers.Offset, endTimeOffset:flatbuffers.Offset, esIdOffset:flatbuffers.Offset, starCatNameOffset:flatbuffers.Offset, starCatLoadTimeOffset:flatbuffers.Offset, idStateVectorOffset:flatbuffers.Offset, tsOffset:flatbuffers.Offset, referenceFrame:OnboardNavigation_Abridged_referenceFrame_Enum, sunSensorOffset:flatbuffers.Offset, magOffset:flatbuffers.Offset, starTrackerOffset:flatbuffers.Offset, deltaPosOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:OnboardNavigation_Abridged_dataMode_Enum):flatbuffers.Offset {
  OnboardNavigation_Abridged.startOnboardNavigation_Abridged(builder);
...
unpack(): OnboardNavigation_AbridgedT {
  return new OnboardNavigation_AbridgedT(
    this.id(),
    ...
    this.idStateVector(),
    this.bb!.createScalarList<string>(this.ts.bind(this), this.tsLength()),
    this.referenceFrame(),
    this.bb!.createScalarList<string>(this.sunSensor.bind(this), this.sunSensorLength()),
    this.bb!.createScalarList<string>(this.mag.bind(this), this.magLength()),
    this.bb!.createScalarList<string>(this.starTracker.bind(this), this.starTrackerLength()),
    this.bb!.createScalarList<string>(this.deltaPos.bind(this), this.deltaPosLength()),
    this.createdAt(),
    this.createdBy(),
    this.source(),
    this.origin(),
...
unpackTo(_o: OnboardNavigation_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.ts = this.bb!.createScalarList<string>(this.ts.bind(this), this.tsLength());
  _o.referenceFrame = this.referenceFrame();
  _o.sunSensor = this.bb!.createScalarList<string>(this.sunSensor.bind(this), this.sunSensorLength());
  _o.mag = this.bb!.createScalarList<string>(this.mag.bind(this), this.magLength());
  _o.starTracker = this.bb!.createScalarList<string>(this.starTracker.bind(this), this.starTrackerLength());
  _o.deltaPos = this.bb!.createScalarList<string>(this.deltaPos.bind(this), this.deltaPosLength());
...
export class OnboardNavigation_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public ts: (string)[] = [],
  public referenceFrame: OnboardNavigation_Abridged_referenceFrame_Enum = OnboardNavigation_Abridged_referenceFrame_Enum.J2000,
  ...
  public dataMode: OnboardNavigation_Abridged_dataMode_Enum = OnboardNavigation_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const ts = OnboardNavigation_Abridged.createTsVector(builder, builder.createObjectOffsetList(this.ts));
  const sunSensor = OnboardNavigation_Abridged.createSunSensorVector(builder, builder.createObjectOffsetList(this.sunSensor));
  const mag = OnboardNavigation_Abridged.createMagVector(builder, builder.createObjectOffsetList(this.mag));
  const starTracker = OnboardNavigation_Abridged.createStarTrackerVector(builder, builder.createObjectOffsetList(this.starTracker));
  const deltaPos = OnboardNavigation_Abridged.createDeltaPosVector(builder, builder.createObjectOffsetList(this.deltaPos));
  ...
  return OnboardNavigation_Abridged.createOnboardNavigation_Abridged(builder,
    id,
