...
import { Sensorcharacteristics_Ingest_dataMode_Enum } from './sensorcharacteristics-ingest-data-mode-enum.js';


/**
 * /// Model representation of characteristics and capabilities of a sensor.
 */
export class Sensorcharacteristics_Ingest implements flatbuffers.IUnpackableObject<Sensorcharacteristics_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Sensorcharacteristics_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSensorcharacteristics_Ingest(bb:flatbuffers.ByteBuffer, obj?:Sensorcharacteristics_Ingest):Sensorcharacteristics_Ingest {
  return (obj || new Sensorcharacteristics_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSensorcharacteristics_Ingest(bb:flatbuffers.ByteBuffer, obj?:Sensorcharacteristics_Ingest):Sensorcharacteristics_Ingest {
...
dataMode():Sensorcharacteristics_Ingest_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Sensorcharacteristics_Ingest_dataMode_Enum.REAL;
}
...
static startSensorcharacteristics_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Sensorcharacteristics_Ingest_dataMode_Enum) {
  builder.addFieldInt8(51, dataMode, Sensorcharacteristics_Ingest_dataMode_Enum.REAL);
}
...
unpack(): Sensorcharacteristics_IngestT {
  return new Sensorcharacteristics_IngestT(
    this.id(),
    this.idSensor(),
...
unpackTo(_o: Sensorcharacteristics_IngestT): void {
  _o.id = this.id();
...
export class Sensorcharacteristics_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Sensorcharacteristics_Ingest_dataMode_Enum = Sensorcharacteristics_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Sensorcharacteristics_Ingest.createSensorcharacteristics_Ingest(builder,
    id,
    idSensor,
