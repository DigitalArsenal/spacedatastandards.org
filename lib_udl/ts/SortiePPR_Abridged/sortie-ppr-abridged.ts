...
import { SortiePPR_Abridged_dataMode_Enum } from './sortie-ppr-abridged-data-mode-enum.js';
import { SortiePPR_Abridged_type_Enum } from './sortie-ppr-abridged-type-enum.js';
 ...
 */
export class SortiePPR_Abridged implements flatbuffers.IUnpackableObject<SortiePPR_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SortiePPR_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSortiePPR_Abridged(bb:flatbuffers.ByteBuffer, obj?:SortiePPR_Abridged):SortiePPR_Abridged {
  return (obj || new SortiePPR_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSortiePPR_Abridged(bb:flatbuffers.ByteBuffer, obj?:SortiePPR_Abridged):SortiePPR_Abridged {
 ...
 */
type():SortiePPR_Abridged_type_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 22);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SortiePPR_Abridged_type_Enum.M;
}
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SortiePPR_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 38);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SortiePPR_Abridged_dataMode_Enum.REAL;
}

static startSortiePPR_Abridged(builder:flatbuffers.Builder) {
...
static addType(builder:flatbuffers.Builder, type:SortiePPR_Abridged_type_Enum) {
  builder.addFieldInt8(9, type, SortiePPR_Abridged_type_Enum.M);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SortiePPR_Abridged_dataMode_Enum) {
  builder.addFieldInt8(17, dataMode, SortiePPR_Abridged_dataMode_Enum.REAL);
}

static endSortiePPR_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSortiePPR_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SORT');
}

static finishSizePrefixedSortiePPR_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SORT', true);
}

static createSortiePPR_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idSortieOffset:flatbuffers.Offset, externalIdOffset:flatbuffers.Offset, numberOffset:flatbuffers.Offset, startTimeOffset:flatbuffers.Offset, endTimeOffset:flatbuffers.Offset, requestorOffset:flatbuffers.Offset, grantorOffset:flatbuffers.Offset, type:SortiePPR_Abridged_type_Enum, remarksOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:SortiePPR_Abridged_dataMode_Enum):flatbuffers.Offset {
  SortiePPR_Abridged.startSortiePPR_Abridged(builder);
...
unpack(): SortiePPR_AbridgedT {
  return new SortiePPR_AbridgedT(
    this.id(),
...
unpackTo(_o: SortiePPR_AbridgedT): void {
  _o.id = this.id();
...
export class SortiePPR_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public type: SortiePPR_Abridged_type_Enum = SortiePPR_Abridged_type_Enum.M,
  ...
  public dataMode: SortiePPR_Abridged_dataMode_Enum = SortiePPR_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SortiePPR_Abridged.createSortiePPR_Abridged(builder,
    id,
