...
import { OrganizationDetails_Full_dataMode_Enum } from './organization-details-full-data-mode-enum.js';


/**
 * /// Model representation of additional detailed organization data as collected by a particular source.
 */
export class OrganizationDetails_Full implements flatbuffers.IUnpackableObject<OrganizationDetails_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OrganizationDetails_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOrganizationDetails_Full(bb:flatbuffers.ByteBuffer, obj?:OrganizationDetails_Full):OrganizationDetails_Full {
  return (obj || new OrganizationDetails_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOrganizationDetails_Full(bb:flatbuffers.ByteBuffer, obj?:OrganizationDetails_Full):OrganizationDetails_Full {
 ...
 */
dataMode():OrganizationDetails_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 68);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OrganizationDetails_Full_dataMode_Enum.REAL;
}
...
static startOrganizationDetails_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:OrganizationDetails_Full_dataMode_Enum) {
  builder.addFieldInt8(32, dataMode, OrganizationDetails_Full_dataMode_Enum.REAL);
}
...
static endOrganizationDetails_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishOrganizationDetails_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ORGA');
}

static finishSizePrefixedOrganizationDetails_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ORGA', true);
}

static createOrganizationDetails_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idOrganizationOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, emailOffset:flatbuffers.Offset, address1Offset:flatbuffers.Offset, address2Offset:flatbuffers.Offset, address3Offset:flatbuffers.Offset, geoAdminLevel1Offset:flatbuffers.Offset, geoAdminLevel2Offset:flatbuffers.Offset, geoAdminLevel3Offset:flatbuffers.Offset, postalCodeOffset:flatbuffers.Offset, descriptionOffset:flatbuffers.Offset, formerOrgIdOffset:flatbuffers.Offset, parentOrgIdOffset:flatbuffers.Offset, financialYearEndDateOffset:flatbuffers.Offset, revenue:number, profit:number, ebitda:number, ftes:number, brokerOffset:flatbuffers.Offset, ceoOffset:flatbuffers.Offset, cfoOffset:flatbuffers.Offset, ctoOffset:flatbuffers.Offset, riskManagerOffset:flatbuffers.Offset, massRanking:number, revenueRanking:number, financialNotesOffset:flatbuffers.Offset, servicesNotesOffset:flatbuffers.Offset, fleetPlanNotesOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:OrganizationDetails_Full_dataMode_Enum, tagsOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  OrganizationDetails_Full.startOrganizationDetails_Full(builder);
...
unpack(): OrganizationDetails_FullT {
  return new OrganizationDetails_FullT(
    this.id(),
    this.idOrganization(),
...
unpackTo(_o: OrganizationDetails_FullT): void {
  _o.id = this.id();
...
export class OrganizationDetails_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: OrganizationDetails_Full_dataMode_Enum = OrganizationDetails_Full_dataMode_Enum.REAL,
  public tags: (string)[] = [],
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = OrganizationDetails_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return OrganizationDetails_Full.createOrganizationDetails_Full(builder,
    id,
    idOrganization,
