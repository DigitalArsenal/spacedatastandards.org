...
import { RFObservationDetails_Ingest_dataMode_Enum } from './RFObservationDetails_Ingest_dataMode_Enum.js';
import { RFObservationDetails_Ingest_polarityType_Enum } from './RFObservationDetails_Ingest_polarityType_Enum.js';
 ...
 */
export class RFObservationDetails_Ingest implements flatbuffers.IUnpackableObject<RFObservationDetails_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):RFObservationDetails_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsRFObservationDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:RFObservationDetails_Ingest):RFObservationDetails_Ingest {
  return (obj || new RFObservationDetails_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsRFObservationDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:RFObservationDetails_Ingest):RFObservationDetails_Ingest {
 ...
 */
polarityType():RFObservationDetails_Ingest_polarityType_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 94);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFObservationDetails_Ingest_polarityType_Enum.H;
}
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():RFObservationDetails_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 134);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : RFObservationDetails_Ingest_dataMode_Enum.REAL;
}
...
static startRFObservationDetails_Ingest(builder:flatbuffers.Builder) {
...
static addPolarityType(builder:flatbuffers.Builder, polarityType:RFObservationDetails_Ingest_polarityType_Enum) {
  builder.addFieldInt8(45, polarityType, RFObservationDetails_Ingest_polarityType_Enum.H);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:RFObservationDetails_Ingest_dataMode_Enum) {
  builder.addFieldInt8(65, dataMode, RFObservationDetails_Ingest_dataMode_Enum.REAL);
}
...
static addPowers(builder:flatbuffers.Builder, powersOffset:flatbuffers.Offset) {
  builder.addFieldOffset(83, powersOffset, 0);
}
...
static addSnrs(builder:flatbuffers.Builder, snrsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(84, snrsOffset, 0);
}
...
static addConfidences(builder:flatbuffers.Builder, confidencesOffset:flatbuffers.Offset) {
  builder.addFieldOffset(85, confidencesOffset, 0);
}
...
static addDetectionStatuses(builder:flatbuffers.Builder, detectionStatusesOffset:flatbuffers.Offset) {
  builder.addFieldOffset(86, detectionStatusesOffset, 0);
}
...
static addChipRates(builder:flatbuffers.Builder, chipRatesOffset:flatbuffers.Offset) {
  builder.addFieldOffset(87, chipRatesOffset, 0);
}
...
static addCodeTaps(builder:flatbuffers.Builder, codeTapsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(88, codeTapsOffset, 0);
}
...
static addCodeFills(builder:flatbuffers.Builder, codeFillsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(89, codeFillsOffset, 0);
}
...
static addCodeLengths(builder:flatbuffers.Builder, codeLengthsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(90, codeLengthsOffset, 0);
}
...
static addPnOrders(builder:flatbuffers.Builder, pnOrdersOffset:flatbuffers.Offset) {
  builder.addFieldOffset(91, pnOrdersOffset, 0);
}
...
static addSignalIds(builder:flatbuffers.Builder, signalIdsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(92, signalIdsOffset, 0);
}
...
static addBaudRates(builder:flatbuffers.Builder, baudRatesOffset:flatbuffers.Offset) {
  builder.addFieldOffset(93, baudRatesOffset, 0);
}
...
static addTelemetryIds(builder:flatbuffers.Builder, telemetryIdsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(94, telemetryIdsOffset, 0);
}
...
static addConstellationXpoints(builder:flatbuffers.Builder, constellationXpointsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(95, constellationXpointsOffset, 0);
}
...
static addConstellationYpoints(builder:flatbuffers.Builder, constellationYpointsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(96, constellationYpointsOffset, 0);
}
...
static endRFObservationDetails_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishRFObservationDetails_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'RFOB');
}

static finishSizePrefixedRFObservationDetails_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'RFOB', true);
}

static createRFObservationDetails_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, obTimeOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, satNo:number, taskIdOffset:flatbuffers.Offset, transactionIdOffset:flatbuffers.Offset, trackIdOffset:flatbuffers.Offset, origObjectIdOffset:flatbuffers.Offset, origSensorIdOffset:flatbuffers.Offset, uct:boolean, transponderOffset:flatbuffers.Offset, azimuth:number, azimuthUnc:number, azimuthRate:number, elevation:number, elevationUnc:number, elevationRate:number, range:number, rangeUnc:number, rangeRate:number, rangeRateUnc:number, trackRange:number, senlat:number, senlon:number, senalt:number, elnotOffset:flatbuffers.Offset, frequency:number, nominalFrequency:number, startFrequency:number, endFrequency:number, relativeCarrierPower:number, spectrumAnalyzerPower:number, relativeNoiseFloor:number, referenceLevel:number, pgri:number, confidence:number, incoming:boolean, switchPoint:number, baudRate:number, snr:number, nominalSnr:number, polarity:number, polarityType:RFObservationDetails_Ingest_polarityType_Enum, channel:number, powerOverNoise:number, nominalPowerOverNoise:number, bandwidth:number, nominalBandwidth:number, resolutionBandwidth:number, videoBandwidth:number, eirp:number, nominalEirp:number, minPsd:number, maxPsd:number, frequencyShift:number, peak:boolean, antennaNameOffset:flatbuffers.Offset, detectionStatusOffset:flatbuffers.Offset, collectionModeOffset:flatbuffers.Offset, rawFileUriOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:RFObservationDetails_Ingest_dataMode_Enum, tagsOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, noisePwrDensity:number, carrierStandardOffset:flatbuffers.Offset, modulationOffset:flatbuffers.Offset, innerCodingRate:number, outerCodingRate:number, transmitFilterTypeOffset:flatbuffers.Offset, transmitFilterRollOff:number, symbolToNoiseRatio:number, bitErrorRate:number, origNetworkOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, descriptorOffset:flatbuffers.Offset, urlOffset:flatbuffers.Offset, frequenciesOffset:flatbuffers.Offset, powersOffset:flatbuffers.Offset, snrsOffset:flatbuffers.Offset, confidencesOffset:flatbuffers.Offset, detectionStatusesOffset:flatbuffers.Offset, chipRatesOffset:flatbuffers.Offset, codeTapsOffset:flatbuffers.Offset, codeFillsOffset:flatbuffers.Offset, codeLengthsOffset:flatbuffers.Offset, pnOrdersOffset:flatbuffers.Offset, signalIdsOffset:flatbuffers.Offset, baudRatesOffset:flatbuffers.Offset, telemetryIdsOffset:flatbuffers.Offset, constellationXpointsOffset:flatbuffers.Offset, constellationYpointsOffset:flatbuffers.Offset):flatbuffers.Offset {
  RFObservationDetails_Ingest.startRFObservationDetails_Ingest(builder);
  RFObservationDetails_Ingest.addId(builder, idOffset);
  RFObservationDetails_Ingest.addClassificationMarking(builder, classificationMarkingOffset);
  RFObservationDetails_Ingest.addObTime(builder, obTimeOffset);
  RFObservationDetails_Ingest.addIdOnOrbit(builder, idOnOrbitOffset);
  RFObservationDetails_Ingest.addIdSensor(builder, idSensorOffset);
  RFObservationDetails_Ingest.addType(builder, typeOffset);
  RFObservationDetails_Ingest.addSatNo(builder, satNo);
  RFObservationDetails_Ingest.addTaskId(builder, taskIdOffset);
  RFObservationDetails_Ingest.addTransactionId(builder, transactionIdOffset);
  RFObservationDetails_Ingest.addTrackId(builder, trackIdOffset);
  RFObservationDetails_Ingest.addOrigObjectId(builder, origObjectIdOffset);
  RFObservationDetails_Ingest.addOrigSensorId(builder, origSensorIdOffset);
  RFObservationDetails_Ingest.addUct(builder, uct);
  RFObservationDetails_Ingest.addTransponder(builder, transponderOffset);
  RFObservationDetails_Ingest.addAzimuth(builder, azimuth);
  RFObservationDetails_Ingest.addAzimuthUnc(builder, azimuthUnc);
  RFObservationDetails_Ingest.addAzimuthRate(builder, azimuthRate);
  RFObservationDetails_Ingest.addElevation(builder, elevation);
  RFObservationDetails_Ingest.addElevationUnc(builder, elevationUnc);
  RFObservationDetails_Ingest.addElevationRate(builder, elevationRate);
  RFObservationDetails_Ingest.addRange(builder, range);
  RFObservationDetails_Ingest.addRangeUnc(builder, rangeUnc);
  RFObservationDetails_Ingest.addRangeRate(builder, rangeRate);
  RFObservationDetails_Ingest.addRangeRateUnc(builder, rangeRateUnc);
  RFObservationDetails_Ingest.addTrackRange(builder, trackRange);
  RFObservationDetails_Ingest.addSenlat(builder, senlat);
  RFObservationDetails_Ingest.addSenlon(builder, senlon);
  RFObservationDetails_Ingest.addSenalt(builder, senalt);
  RFObservationDetails_Ingest.addElnot(builder, elnotOffset);
  RFObservationDetails_Ingest.addFrequency(builder, frequency);
  RFObservationDetails_Ingest.addNominalFrequency(builder, nominalFrequency);
  RFObservationDetails_Ingest.addStartFrequency(builder, startFrequency);
  RFObservationDetails_Ingest.addEndFrequency(builder, endFrequency);
  RFObservationDetails_Ingest.addRelativeCarrierPower(builder, relativeCarrierPower);
  RFObservationDetails_Ingest.addSpectrumAnalyzerPower(builder, spectrumAnalyzerPower);
  RFObservationDetails_Ingest.addRelativeNoiseFloor(builder, relativeNoiseFloor);
  RFObservationDetails_Ingest.addReferenceLevel(builder, referenceLevel);
  RFObservationDetails_Ingest.addPgri(builder, pgri);
  RFObservationDetails_Ingest.addConfidence(builder, confidence);
  RFObservationDetails_Ingest.addIncoming(builder, incoming);
  RFObservationDetails_Ingest.addSwitchPoint(builder, switchPoint);
  RFObservationDetails_Ingest.addBaudRate(builder, baudRate);
  RFObservationDetails_Ingest.addSnr(builder, snr);
  RFObservationDetails_Ingest.addNominalSnr(builder, nominalSnr);
  RFObservationDetails_Ingest.addPolarity(builder, polarity);
  RFObservationDetails_Ingest.addPolarityType(builder, polarityType);
  RFObservationDetails_Ingest.addChannel(builder, channel);
  RFObservationDetails_Ingest.addPowerOverNoise(builder, powerOverNoise);
  RFObservationDetails_Ingest.addNominalPowerOverNoise(builder, nominalPowerOverNoise);
  RFObservationDetails_Ingest.addBandwidth(builder, bandwidth);
  RFObservationDetails_Ingest.addNominalBandwidth(builder, nominalBandwidth);
  RFObservationDetails_Ingest.addResolutionBandwidth(builder, resolutionBandwidth);
  RFObservationDetails_Ingest.addVideoBandwidth(builder, videoBandwidth);
  RFObservationDetails_Ingest.addEirp(builder, eirp);
  RFObservationDetails_Ingest.addNominalEirp(builder, nominalEirp);
  RFObservationDetails_Ingest.addMinPsd(builder, minPsd);
  RFObservationDetails_Ingest.addMaxPsd(builder, maxPsd);
  RFObservationDetails_Ingest.addFrequencyShift(builder, frequencyShift);
  RFObservationDetails_Ingest.addPeak(builder, peak);
  RFObservationDetails_Ingest.addAntennaName(builder, antennaNameOffset);
  RFObservationDetails_Ingest.addDetectionStatus(builder, detectionStatusOffset);
  RFObservationDetails_Ingest.addCollectionMode(builder, collectionModeOffset);
  RFObservationDetails_Ingest.addRawFileUri(builder, rawFileUriOffset);
  RFObservationDetails_Ingest.addSource(builder, sourceOffset);
  RFObservationDetails_Ingest.addOrigin(builder, originOffset);
  RFObservationDetails_Ingest.addDataMode(builder, dataMode);
  RFObservationDetails_Ingest.addTags(builder, tagsOffset);
  RFObservationDetails_Ingest.addCreatedAt(builder, createdAtOffset);
  RFObservationDetails_Ingest.addCreatedBy(builder, createdByOffset);
  RFObservationDetails_Ingest.addNoisePwrDensity(builder, noisePwrDensity);
  RFObservationDetails_Ingest.addCarrierStandard(builder, carrierStandardOffset);
  RFObservationDetails_Ingest.addModulation(builder, modulationOffset);
  RFObservationDetails_Ingest.addInnerCodingRate(builder, innerCodingRate);
  RFObservationDetails_Ingest.addOuterCodingRate(builder, outerCodingRate);
  RFObservationDetails_Ingest.addTransmitFilterType(builder, transmitFilterTypeOffset);
  RFObservationDetails_Ingest.addTransmitFilterRollOff(builder, transmitFilterRollOff);
  RFObservationDetails_Ingest.addSymbolToNoiseRatio(builder, symbolToNoiseRatio);
  RFObservationDetails_Ingest.addBitErrorRate(builder, bitErrorRate);
  RFObservationDetails_Ingest.addOrigNetwork(builder, origNetworkOffset);
  RFObservationDetails_Ingest.addSourceDl(builder, sourceDlOffset);
  RFObservationDetails_Ingest.addDescriptor(builder, descriptorOffset);
  RFObservationDetails_Ingest.addUrl(builder, urlOffset);
  RFObservationDetails_Ingest.addFrequencies(builder, frequenciesOffset);
  RFObservationDetails_Ingest.addPowers(builder, powersOffset);
  RFObservationDetails_Ingest.addSnrs(builder, snrsOffset);
  RFObservationDetails_Ingest.addConfidences(builder, confidencesOffset);
  RFObservationDetails_Ingest.addDetectionStatuses(builder, detectionStatusesOffset);
  RFObservationDetails_Ingest.addChipRates(builder, chipRatesOffset);
  RFObservationDetails_Ingest.addCodeTaps(builder, codeTapsOffset);
  RFObservationDetails_Ingest.addCodeFills(builder, codeFillsOffset);
  RFObservationDetails_Ingest.addCodeLengths(builder, codeLengthsOffset);
  RFObservationDetails_Ingest.addPnOrders(builder, pnOrdersOffset);
  RFObservationDetails_Ingest.addSignalIds(builder, signalIdsOffset);
  RFObservationDetails_Ingest.addBaudRates(builder, baudRatesOffset);
  RFObservationDetails_Ingest.addTelemetryIds(builder, telemetryIdsOffset);
  RFObservationDetails_Ingest.addConstellationXpoints(builder, constellationXpointsOffset);
  RFObservationDetails_Ingest.addConstellationYpoints(builder, constellationYpointsOffset);
  return RFObservationDetails_Ingest.endRFObservationDetails_Ingest(builder);
}

unpack(): RFObservationDetails_IngestT {
  return new RFObservationDetails_IngestT(
    this.id(),
    ...
    this.descriptor(),
    this.url(),
    this.bb!.createScalarList<string>(this.frequencies.bind(this), this.frequenciesLength()),
    this.bb!.createScalarList<string>(this.powers.bind(this), this.powersLength()),
    this.bb!.createScalarList<string>(this.snrs.bind(this), this.snrsLength()),
    this.bb!.createScalarList<string>(this.confidences.bind(this), this.confidencesLength()),
    this.bb!.createScalarList<string>(this.detectionStatuses.bind(this), this.detectionStatusesLength()),
    this.bb!.createScalarList<string>(this.chipRates.bind(this), this.chipRatesLength()),
    this.bb!.createScalarList<string>(this.codeTaps.bind(this), this.codeTapsLength()),
    this.bb!.createScalarList<string>(this.codeFills.bind(this), this.codeFillsLength()),
    this.bb!.createScalarList<string>(this.codeLengths.bind(this), this.codeLengthsLength()),
    this.bb!.createScalarList<string>(this.pnOrders.bind(this), this.pnOrdersLength()),
    this.bb!.createScalarList<string>(this.signalIds.bind(this), this.signalIdsLength()),
    this.bb!.createScalarList<string>(this.baudRates.bind(this), this.baudRatesLength()),
    this.bb!.createScalarList<string>(this.telemetryIds.bind(this), this.telemetryIdsLength()),
    this.bb!.createScalarList<string>(this.constellationXpoints.bind(this), this.constellationXpointsLength()),
    this.bb!.createScalarList<string>(this.constellationYpoints.bind(this), this.constellationYpointsLength())
  );
}


unpackTo(_o: RFObservationDetails_IngestT): void {
  _o.id = this.id();
  ...
  _o.url = this.url();
  _o.frequencies = this.bb!.createScalarList<string>(this.frequencies.bind(this), this.frequenciesLength());
  _o.powers = this.bb!.createScalarList<string>(this.powers.bind(this), this.powersLength());
  _o.snrs = this.bb!.createScalarList<string>(this.snrs.bind(this), this.snrsLength());
  _o.confidences = this.bb!.createScalarList<string>(this.confidences.bind(this), this.confidencesLength());
  _o.detectionStatuses = this.bb!.createScalarList<string>(this.detectionStatuses.bind(this), this.detectionStatusesLength());
  _o.chipRates = this.bb!.createScalarList<string>(this.chipRates.bind(this), this.chipRatesLength());
  _o.codeTaps = this.bb!.createScalarList<string>(this.codeTaps.bind(this), this.codeTapsLength());
  _o.codeFills = this.bb!.createScalarList<string>(this.codeFills.bind(this), this.codeFillsLength());
  _o.codeLengths = this.bb!.createScalarList<string>(this.codeLengths.bind(this), this.codeLengthsLength());
  _o.pnOrders = this.bb!.createScalarList<string>(this.pnOrders.bind(this), this.pnOrdersLength());
  _o.signalIds = this.bb!.createScalarList<string>(this.signalIds.bind(this), this.signalIdsLength());
  _o.baudRates = this.bb!.createScalarList<string>(this.baudRates.bind(this), this.baudRatesLength());
  _o.telemetryIds = this.bb!.createScalarList<string>(this.telemetryIds.bind(this), this.telemetryIdsLength());
  _o.constellationXpoints = this.bb!.createScalarList<string>(this.constellationXpoints.bind(this), this.constellationXpointsLength());
  _o.constellationYpoints = this.bb!.createScalarList<string>(this.constellationYpoints.bind(this), this.constellationYpointsLength());
}
}

export class RFObservationDetails_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public polarityType: RFObservationDetails_Ingest_polarityType_Enum = RFObservationDetails_Ingest_polarityType_Enum.H,
  ...
  public dataMode: RFObservationDetails_Ingest_dataMode_Enum = RFObservationDetails_Ingest_dataMode_Enum.REAL,
  public tags: (string)[] = [],
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = RFObservationDetails_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  const frequencies = RFObservationDetails_Ingest.createFrequenciesVector(builder, builder.createObjectOffsetList(this.frequencies));
  const powers = RFObservationDetails_Ingest.createPowersVector(builder, builder.createObjectOffsetList(this.powers));
  const snrs = RFObservationDetails_Ingest.createSnrsVector(builder, builder.createObjectOffsetList(this.snrs));
  const confidences = RFObservationDetails_Ingest.createConfidencesVector(builder, builder.createObjectOffsetList(this.confidences));
  const detectionStatuses = RFObservationDetails_Ingest.createDetectionStatusesVector(builder, builder.createObjectOffsetList(this.detectionStatuses));
  const chipRates = RFObservationDetails_Ingest.createChipRatesVector(builder, builder.createObjectOffsetList(this.chipRates));
  const codeTaps = RFObservationDetails_Ingest.createCodeTapsVector(builder, builder.createObjectOffsetList(this.codeTaps));
  const codeFills = RFObservationDetails_Ingest.createCodeFillsVector(builder, builder.createObjectOffsetList(this.codeFills));
  const codeLengths = RFObservationDetails_Ingest.createCodeLengthsVector(builder, builder.createObjectOffsetList(this.codeLengths));
  const pnOrders = RFObservationDetails_Ingest.createPnOrdersVector(builder, builder.createObjectOffsetList(this.pnOrders));
  const signalIds = RFObservationDetails_Ingest.createSignalIdsVector(builder, builder.createObjectOffsetList(this.signalIds));
  const baudRates = RFObservationDetails_Ingest.createBaudRatesVector(builder, builder.createObjectOffsetList(this.baudRates));
  const telemetryIds = RFObservationDetails_Ingest.createTelemetryIdsVector(builder, builder.createObjectOffsetList(this.telemetryIds));
  const constellationXpoints = RFObservationDetails_Ingest.createConstellationXpointsVector(builder, builder.createObjectOffsetList(this.constellationXpoints));
  const constellationYpoints = RFObservationDetails_Ingest.createConstellationYpointsVector(builder, builder.createObjectOffsetList(this.constellationYpoints));

  return RFObservationDetails_Ingest.createRFObservationDetails_Ingest(builder,
    id,
