...
import { MissileTrack_Abridged_dataMode_Enum } from './missile-track-abridged-data-mode-enum.js';
import { MissileTrack_Abridged_env_Enum } from './missile-track-abridged-env-enum.js';
import { MissileTrack_Abridged_objIdent_Enum } from './missile-track-abridged-obj-ident-enum.js';
 ...
 */
export class MissileTrack_Abridged implements flatbuffers.IUnpackableObject<MissileTrack_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MissileTrack_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMissileTrack_Abridged(bb:flatbuffers.ByteBuffer, obj?:MissileTrack_Abridged):MissileTrack_Abridged {
  return (obj || new MissileTrack_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMissileTrack_Abridged(bb:flatbuffers.ByteBuffer, obj?:MissileTrack_Abridged):MissileTrack_Abridged {
 ...
 * Constraints: Minimum length = 0, Maximum length = 16
 */
env():MissileTrack_Abridged_env_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 14);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : MissileTrack_Abridged_env_Enum.AIR;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 32
 */
objIdent():MissileTrack_Abridged_objIdent_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 22);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : MissileTrack_Abridged_objIdent_Enum.ASSUMED_FRIEND;
}
 ...
 */
dataMode():MissileTrack_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 116);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : MissileTrack_Abridged_dataMode_Enum.REAL;
}

static startMissileTrack_Abridged(builder:flatbuffers.Builder) {
...
static addEnv(builder:flatbuffers.Builder, env:MissileTrack_Abridged_env_Enum) {
  builder.addFieldInt8(5, env, MissileTrack_Abridged_env_Enum.AIR);
}
...
static addObjIdent(builder:flatbuffers.Builder, objIdent:MissileTrack_Abridged_objIdent_Enum) {
  builder.addFieldInt8(9, objIdent, MissileTrack_Abridged_objIdent_Enum.ASSUMED_FRIEND);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:MissileTrack_Abridged_dataMode_Enum) {
  builder.addFieldInt8(56, dataMode, MissileTrack_Abridged_dataMode_Enum.REAL);
}

static endMissileTrack_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishMissileTrack_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MISS');
}

static finishSizePrefixedMissileTrack_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MISS', true);
}

static createMissileTrack_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, msgTypeOffset:flatbuffers.Offset, msgSubTypeOffset:flatbuffers.Offset, msgCreateDateOffset:flatbuffers.Offset, env:MissileTrack_Abridged_env_Enum, objTypeOffset:flatbuffers.Offset, objTypeConf:number, objPlatOffset:flatbuffers.Offset, objIdent:MissileTrack_Abridged_objIdent_Enum, spaceAmpOffset:flatbuffers.Offset, objActOffset:flatbuffers.Offset, spaceSpecTypeOffset:flatbuffers.Offset, acftSubTypeOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, callSignOffset:flatbuffers.Offset, lostTrkInd:boolean, trackIdOffset:flatbuffers.Offset, parentTrackIdOffset:flatbuffers.Offset, muidSrcTrkOffset:flatbuffers.Offset, muidSrcOffset:flatbuffers.Offset, alertOffset:flatbuffers.Offset, mslStatusOffset:flatbuffers.Offset, tsOffset:flatbuffers.Offset, aouRptTypeOffset:flatbuffers.Offset, aouRptDataOffset:flatbuffers.Offset, containment:number, trkConf:number, trkQual:number, angElev:number, senModeOffset:flatbuffers.Offset, infoSourceOffset:flatbuffers.Offset, boosting:boolean, polarSingLocLat:number, polarSingLocLon:number, emgInd:boolean, dropPtInd:boolean, spaceAmpConf:number, launchTimeOffset:flatbuffers.Offset, launchLat:number, launchLon:number, azCorr:number, burnoutAlt:number, launchAouTypeOffset:flatbuffers.Offset, launchAouDataOffset:flatbuffers.Offset, impactTimeOffset:flatbuffers.Offset, impactLat:number, impactLon:number, impactAouTypeOffset:flatbuffers.Offset, impactAouDataOffset:flatbuffers.Offset, vectorsOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:MissileTrack_Abridged_dataMode_Enum):flatbuffers.Offset {
  MissileTrack_Abridged.startMissileTrack_Abridged(builder);
  MissileTrack_Abridged.addId(builder, idOffset);
  MissileTrack_Abridged.addClassificationMarking(builder, classificationMarkingOffset);
  MissileTrack_Abridged.addMsgType(builder, msgTypeOffset);
  MissileTrack_Abridged.addMsgSubType(builder, msgSubTypeOffset);
  MissileTrack_Abridged.addMsgCreateDate(builder, msgCreateDateOffset);
  MissileTrack_Abridged.addEnv(builder, env);
  MissileTrack_Abridged.addObjType(builder, objTypeOffset);
  MissileTrack_Abridged.addObjTypeConf(builder, objTypeConf);
  MissileTrack_Abridged.addObjPlat(builder, objPlatOffset);
  MissileTrack_Abridged.addObjIdent(builder, objIdent);
  MissileTrack_Abridged.addSpaceAmp(builder, spaceAmpOffset);
  MissileTrack_Abridged.addObjAct(builder, objActOffset);
  MissileTrack_Abridged.addSpaceSpecType(builder, spaceSpecTypeOffset);
  MissileTrack_Abridged.addAcftSubType(builder, acftSubTypeOffset);
  MissileTrack_Abridged.addName(builder, nameOffset);
  MissileTrack_Abridged.addCallSign(builder, callSignOffset);
  MissileTrack_Abridged.addLostTrkInd(builder, lostTrkInd);
  MissileTrack_Abridged.addTrackId(builder, trackIdOffset);
  MissileTrack_Abridged.addParentTrackId(builder, parentTrackIdOffset);
  MissileTrack_Abridged.addMuidSrcTrk(builder, muidSrcTrkOffset);
  MissileTrack_Abridged.addMuidSrc(builder, muidSrcOffset);
  MissileTrack_Abridged.addAlert(builder, alertOffset);
  MissileTrack_Abridged.addMslStatus(builder, mslStatusOffset);
  MissileTrack_Abridged.addTs(builder, tsOffset);
  MissileTrack_Abridged.addAouRptType(builder, aouRptTypeOffset);
  MissileTrack_Abridged.addAouRptData(builder, aouRptDataOffset);
  MissileTrack_Abridged.addContainment(builder, containment);
  MissileTrack_Abridged.addTrkConf(builder, trkConf);
  MissileTrack_Abridged.addTrkQual(builder, trkQual);
  MissileTrack_Abridged.addAngElev(builder, angElev);
  MissileTrack_Abridged.addSenMode(builder, senModeOffset);
  MissileTrack_Abridged.addInfoSource(builder, infoSourceOffset);
  MissileTrack_Abridged.addBoosting(builder, boosting);
  MissileTrack_Abridged.addPolarSingLocLat(builder, polarSingLocLat);
  MissileTrack_Abridged.addPolarSingLocLon(builder, polarSingLocLon);
  MissileTrack_Abridged.addEmgInd(builder, emgInd);
  MissileTrack_Abridged.addDropPtInd(builder, dropPtInd);
  MissileTrack_Abridged.addSpaceAmpConf(builder, spaceAmpConf);
  MissileTrack_Abridged.addLaunchTime(builder, launchTimeOffset);
  MissileTrack_Abridged.addLaunchLat(builder, launchLat);
  MissileTrack_Abridged.addLaunchLon(builder, launchLon);
  MissileTrack_Abridged.addAzCorr(builder, azCorr);
  MissileTrack_Abridged.addBurnoutAlt(builder, burnoutAlt);
  MissileTrack_Abridged.addLaunchAouType(builder, launchAouTypeOffset);
  MissileTrack_Abridged.addLaunchAouData(builder, launchAouDataOffset);
  MissileTrack_Abridged.addImpactTime(builder, impactTimeOffset);
  MissileTrack_Abridged.addImpactLat(builder, impactLat);
  MissileTrack_Abridged.addImpactLon(builder, impactLon);
  MissileTrack_Abridged.addImpactAouType(builder, impactAouTypeOffset);
  MissileTrack_Abridged.addImpactAouData(builder, impactAouDataOffset);
  MissileTrack_Abridged.addVectors(builder, vectorsOffset);
  MissileTrack_Abridged.addOrigNetwork(builder, origNetworkOffset);
  MissileTrack_Abridged.addCreatedAt(builder, createdAtOffset);
  MissileTrack_Abridged.addCreatedBy(builder, createdByOffset);
  MissileTrack_Abridged.addSource(builder, sourceOffset);
  MissileTrack_Abridged.addOrigin(builder, originOffset);
  MissileTrack_Abridged.addDataMode(builder, dataMode);
  return MissileTrack_Abridged.endMissileTrack_Abridged(builder);
}

unpack(): MissileTrack_AbridgedT {
  return new MissileTrack_AbridgedT(
    this.id(),
    ...
    this.bb!.createScalarList<string>(this.vectors.bind(this), this.vectors_Length()),
    this.origNetwork(),
    this.createdAt(),
    this.createdBy(),
    this.source(),
...
unpackTo(_o: MissileTrack_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.vectors = this.bb!.createScalarList<string>(this.vectors.bind(this), this.vectors_Length());
...
export class MissileTrack_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public env: MissileTrack_Abridged_env_Enum = MissileTrack_Abridged_env_Enum.AIR,
  public objType: string|Uint8Array|null = null,
  public objTypeConf: number = 0,
  public objPlat: string|Uint8Array|null = null,
  public objIdent: MissileTrack_Abridged_objIdent_Enum = MissileTrack_Abridged_objIdent_Enum.ASSUMED_FRIEND,
  ...
  public dataMode: MissileTrack_Abridged_dataMode_Enum = MissileTrack_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const aouRptData = MissileTrack_Abridged.createAouRptDataVector(builder, builder.createObjectOffsetList(this.aouRptData));
  ...
  const launchAouData = MissileTrack_Abridged.createLaunchAouDataVector(builder, builder.createObjectOffsetList(this.launchAouData));
  ...
  const impactAouData = MissileTrack_Abridged.createImpactAouDataVector(builder, builder.createObjectOffsetList(this.impactAouData));
  const vectors = MissileTrack_Abridged.createVectorsVector(builder, builder.createObjectOffsetList(this.vectors));
  ...
  return MissileTrack_Abridged.createMissileTrack_Abridged(builder,
    id,
