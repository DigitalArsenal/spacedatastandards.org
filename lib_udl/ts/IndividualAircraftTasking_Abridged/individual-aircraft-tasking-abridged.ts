 ...
 */
export class IndividualAircraftTasking_Abridged implements flatbuffers.IUnpackableObject<IndividualAircraftTasking_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):IndividualAircraftTasking_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsIndividualAircraftTasking_Abridged(bb:flatbuffers.ByteBuffer, obj?:IndividualAircraftTasking_Abridged):IndividualAircraftTasking_Abridged {
  return (obj || new IndividualAircraftTasking_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIndividualAircraftTasking_Abridged(bb:flatbuffers.ByteBuffer, obj?:IndividualAircraftTasking_Abridged):IndividualAircraftTasking_Abridged {
...
static startIndividualAircraftTasking_Abridged(builder:flatbuffers.Builder) {
...
static endIndividualAircraftTasking_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishIndividualAircraftTasking_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'INDI');
}

static finishSizePrefixedIndividualAircraftTasking_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'INDI', true);
}

static createIndividualAircraftTasking_Abridged(builder:flatbuffers.Builder, numAcft:number, acftTypeOffset:flatbuffers.Offset, callSignOffset:flatbuffers.Offset, priConfigCodeOffset:flatbuffers.Offset, secConfigCodeOffset:flatbuffers.Offset, link16CallSignOffset:flatbuffers.Offset, tacanChan:number, juAddressOffset:flatbuffers.Offset, iffSifMode1CodeOffset:flatbuffers.Offset, iffSifMode2CodeOffset:flatbuffers.Offset, iffSifMode3CodeOffset:flatbuffers.Offset):flatbuffers.Offset {
  IndividualAircraftTasking_Abridged.startIndividualAircraftTasking_Abridged(builder);
...
unpack(): IndividualAircraftTasking_AbridgedT {
  return new IndividualAircraftTasking_AbridgedT(
    this.numAcft(),
    this.acftType(),
    this.callSign(),
    this.priConfigCode(),
    ...
    this.link16CallSign(),
    this.tacanChan(),
    this.bb!.createScalarList<string>(this.juAddress.bind(this), this.juAddress_Length()),
...
unpackTo(_o: IndividualAircraftTasking_AbridgedT): void {
  ...
  _o.juAddress = this.bb!.createScalarList<string>(this.juAddress.bind(this), this.juAddress_Length());
...
export class IndividualAircraftTasking_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const juAddress = IndividualAircraftTasking_Abridged.createJuAddressVector(builder, builder.createObjectOffsetList(this.juAddress));
  ...
  return IndividualAircraftTasking_Abridged.createIndividualAircraftTasking_Abridged(builder,
    this.numAcft,
    acftType,
    callSign,
    priConfigCode,
