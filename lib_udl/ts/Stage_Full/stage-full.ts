...
import { Stage_Full_dataMode_Enum } from './stage-full-data-mode-enum.js';
 ...
 */
export class Stage_Full implements flatbuffers.IUnpackableObject<Stage_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Stage_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsStage_Full(bb:flatbuffers.ByteBuffer, obj?:Stage_Full):Stage_Full {
  return (obj || new Stage_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsStage_Full(bb:flatbuffers.ByteBuffer, obj?:Stage_Full):Stage_Full {
...
dataMode():Stage_Full_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Stage_Full_dataMode_Enum.REAL;
}
...
static startStage_Full(builder:flatbuffers.Builder) {
...
unpack(): Stage_FullT {
  return new Stage_FullT(
    ...
    this.bb!.createScalarList<string>(this.photoUrls.bind(this), this.photoURLs_Length()),
    this.notes(),
    this.avionicsNotes(),
...
unpackTo(_o: Stage_FullT): void {
  ...
  _o.photoURLs = this.bb!.createScalarList<string>(this.photoUrls.bind(this), this.photoURLs_Length());
  _o.notes = this.notes();
...
export class Stage_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Stage_Full_dataMode_Enum = Stage_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const photoURLs = Stage_Full.createPhotoUrlsVector(builder, builder.createObjectOffsetList(this.photoURLs));
  ...
  const tags = Stage_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return Stage_Full.createStage_Full(builder,
    id,
    idLaunchVehicle,
    idEngine,
