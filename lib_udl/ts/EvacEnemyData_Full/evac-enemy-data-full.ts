 ...
 */
export class EvacEnemyData_Full implements flatbuffers.IUnpackableObject<EvacEnemyData_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EvacEnemyData_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEvacEnemyData_Full(bb:flatbuffers.ByteBuffer, obj?:EvacEnemyData_Full):EvacEnemyData_Full {
  return (obj || new EvacEnemyData_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEvacEnemyData_Full(bb:flatbuffers.ByteBuffer, obj?:EvacEnemyData_Full):EvacEnemyData_Full {
...
static startEvacEnemyData_Full(builder:flatbuffers.Builder) {
...
static endEvacEnemyData_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEvacEnemyData_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC');
}

static finishSizePrefixedEvacEnemyData_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC', true);
}

static createEvacEnemyData_Full(builder:flatbuffers.Builder, dirToEnemyOffset:flatbuffers.Offset, hostileFireTypeOffset:flatbuffers.Offset, friendliesRemarksOffset:flatbuffers.Offset, hlzRemarksOffset:flatbuffers.Offset):flatbuffers.Offset {
  EvacEnemyData_Full.startEvacEnemyData_Full(builder);
...
unpack(): EvacEnemyData_FullT {
  return new EvacEnemyData_FullT(
    this.dirToEnemy(),
...
unpackTo(_o: EvacEnemyData_FullT): void {
...
export class EvacEnemyData_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return EvacEnemyData_Full.createEvacEnemyData_Full(builder,
    dirToEnemy,
    hostileFireType,
    friendliesRemarks,
    hlzRemarks
