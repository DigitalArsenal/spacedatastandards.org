...
import { CollectResponse_Abridged_dataMode_Enum } from './collect-response-abridged-data-mode-enum.js';
 ...
 */
export class CollectResponse_Abridged implements flatbuffers.IUnpackableObject<CollectResponse_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):CollectResponse_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsCollectResponse_Abridged(bb:flatbuffers.ByteBuffer, obj?:CollectResponse_Abridged):CollectResponse_Abridged {
  return (obj || new CollectResponse_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsCollectResponse_Abridged(bb:flatbuffers.ByteBuffer, obj?:CollectResponse_Abridged):CollectResponse_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():CollectResponse_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 54);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : CollectResponse_Abridged_dataMode_Enum.REAL;
}

static startCollectResponse_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:CollectResponse_Abridged_dataMode_Enum) {
  builder.addFieldInt8(25, dataMode, CollectResponse_Abridged_dataMode_Enum.REAL);
}

static endCollectResponse_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishCollectResponse_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'COLL');
}

static finishSizePrefixedCollectResponse_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'COLL', true);
}

static createCollectResponse_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idRequestOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, origObjectIdOffset:flatbuffers.Offset, satNo:number, taskIdOffset:flatbuffers.Offset, idPlanOffset:flatbuffers.Offset, externalIdOffset:flatbuffers.Offset, statusOffset:flatbuffers.Offset, actualStartTimeOffset:flatbuffers.Offset, actualEndTimeOffset:flatbuffers.Offset, altStartTimeOffset:flatbuffers.Offset, altEndTimeOffset:flatbuffers.Offset, errCodeOffset:flatbuffers.Offset, srcTypsOffset:flatbuffers.Offset, srcIdsOffset:flatbuffers.Offset, notesOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, origSensorIdOffset:flatbuffers.Offset, dataMode:CollectResponse_Abridged_dataMode_Enum):flatbuffers.Offset {
  CollectResponse_Abridged.startCollectResponse_Abridged(builder);
...
unpack(): CollectResponse_AbridgedT {
  return new CollectResponse_AbridgedT(
    this.id(),
...
unpackTo(_o: CollectResponse_AbridgedT): void {
  _o.id = this.id();
...
export class CollectResponse_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: CollectResponse_Abridged_dataMode_Enum = CollectResponse_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const srcTyps = CollectResponse_Abridged.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = CollectResponse_Abridged.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  ...
  return CollectResponse_Abridged.createCollectResponse_Abridged(builder,
    id,
