...
import { EffectResponse_Ingest_dataMode_Enum } from './effect-response-ingest-data-mode-enum.js';


/**
 * /// A response for various effects on a target.
 */
export class EffectResponse_Ingest implements flatbuffers.IUnpackableObject<EffectResponse_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EffectResponse_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEffectResponse_Ingest(bb:flatbuffers.ByteBuffer, obj?:EffectResponse_Ingest):EffectResponse_Ingest {
  return (obj || new EffectResponse_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEffectResponse_Ingest(bb:flatbuffers.ByteBuffer, obj?:EffectResponse_Ingest):EffectResponse_Ingest {
 ...
 */
dataMode():EffectResponse_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 50);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : EffectResponse_Ingest_dataMode_Enum.REAL;
}
...
static startEffectResponse_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:EffectResponse_Ingest_dataMode_Enum) {
  builder.addFieldInt8(23, dataMode, EffectResponse_Ingest_dataMode_Enum.REAL);
}
...
static endEffectResponse_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEffectResponse_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EFFE');
}

static finishSizePrefixedEffectResponse_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EFFE', true);
}

static createEffectResponse_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idEffectRequestOffset:flatbuffers.Offset, externalRequestIdOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, actorSrcTypeOffset:flatbuffers.Offset, actorSrcIdOffset:flatbuffers.Offset, munitionTypeOffset:flatbuffers.Offset, munitionIdOffset:flatbuffers.Offset, shotsRequired:number, probabilityOfKill:number, collateralDamageEst:number, actionsListOffset:flatbuffers.Offset, externalActionsOffset:flatbuffers.Offset, coaMetricsOffset:flatbuffers.Offset, redTimeToOverheadOffset:flatbuffers.Offset, decisionDeadlineOffset:flatbuffers.Offset, redTargetSrcTypeOffset:flatbuffers.Offset, redTargetSrcIdOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:EffectResponse_Ingest_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  EffectResponse_Ingest.startEffectResponse_Ingest(builder);
  EffectResponse_Ingest.addId(builder, idOffset);
  EffectResponse_Ingest.addClassificationMarking(builder, classificationMarkingOffset);
  EffectResponse_Ingest.addIdEffectRequest(builder, idEffectRequestOffset);
  EffectResponse_Ingest.addExternalRequestId(builder, externalRequestIdOffset);
  EffectResponse_Ingest.addType(builder, typeOffset);
  EffectResponse_Ingest.addActorSrcType(builder, actorSrcTypeOffset);
  EffectResponse_Ingest.addActorSrcId(builder, actorSrcIdOffset);
  EffectResponse_Ingest.addMunitionType(builder, munitionTypeOffset);
  EffectResponse_Ingest.addMunitionId(builder, munitionIdOffset);
  EffectResponse_Ingest.addShotsRequired(builder, shotsRequired);
  EffectResponse_Ingest.addProbabilityOfKill(builder, probabilityOfKill);
  EffectResponse_Ingest.addCollateralDamageEst(builder, collateralDamageEst);
  EffectResponse_Ingest.addActionsList(builder, actionsListOffset);
  EffectResponse_Ingest.addExternalActions(builder, externalActionsOffset);
  EffectResponse_Ingest.addCoaMetrics(builder, coaMetricsOffset);
  EffectResponse_Ingest.addRedTimeToOverhead(builder, redTimeToOverheadOffset);
  EffectResponse_Ingest.addDecisionDeadline(builder, decisionDeadlineOffset);
  EffectResponse_Ingest.addRedTargetSrcType(builder, redTargetSrcTypeOffset);
  EffectResponse_Ingest.addRedTargetSrcId(builder, redTargetSrcIdOffset);
  EffectResponse_Ingest.addCreatedAt(builder, createdAtOffset);
  EffectResponse_Ingest.addCreatedBy(builder, createdByOffset);
  EffectResponse_Ingest.addSource(builder, sourceOffset);
  EffectResponse_Ingest.addOrigin(builder, originOffset);
  EffectResponse_Ingest.addDataMode(builder, dataMode);
  EffectResponse_Ingest.addOrigNetwork(builder, origNetworkOffset);
  return EffectResponse_Ingest.endEffectResponse_Ingest(builder);
}

unpack(): EffectResponse_IngestT {
  return new EffectResponse_IngestT(
    this.id(),
    ...
    this.bb!.createScalarList<string>(this.actionsList.bind(this), this.actionsList_Length()),
    this.bb!.createScalarList<string>(this.externalActions.bind(this), this.externalActions_Length()),
    this.bb!.createScalarList<string>(this.coaMetrics.bind(this), this.coaMetrics_Length()),
...
unpackTo(_o: EffectResponse_IngestT): void {
  _o.id = this.id();
  ...
  _o.actionsList = this.bb!.createScalarList<string>(this.actionsList.bind(this), this.actionsList_Length());
  _o.externalActions = this.bb!.createScalarList<string>(this.externalActions.bind(this), this.externalActions_Length());
  _o.coaMetrics = this.bb!.createScalarList<string>(this.coaMetrics.bind(this), this.coaMetrics_Length());
...
export class EffectResponse_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: EffectResponse_Ingest_dataMode_Enum = EffectResponse_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const actionsList = EffectResponse_Ingest.createActionsListVector(builder, builder.createObjectOffsetList(this.actionsList));
  const externalActions = EffectResponse_Ingest.createExternalActionsVector(builder, builder.createObjectOffsetList(this.externalActions));
  const coaMetrics = EffectResponse_Ingest.createCoaMetricsVector(builder, builder.createObjectOffsetList(this.coaMetrics));
  ...
  return EffectResponse_Ingest.createEffectResponse_Ingest(builder,
    id,
