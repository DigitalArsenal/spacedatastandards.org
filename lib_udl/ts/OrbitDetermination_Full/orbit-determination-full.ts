...
import { OrbitDetermination_Full_dataMode_Enum } from './orbit-determination-full-data-mode-enum.js';
 ...
 */
export class OrbitDetermination_Full implements flatbuffers.IUnpackableObject<OrbitDetermination_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OrbitDetermination_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOrbitDetermination_Full(bb:flatbuffers.ByteBuffer, obj?:OrbitDetermination_Full):OrbitDetermination_Full {
  return (obj || new OrbitDetermination_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOrbitDetermination_Full(bb:flatbuffers.ByteBuffer, obj?:OrbitDetermination_Full):OrbitDetermination_Full {
 ...
 */
dataMode():OrbitDetermination_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 90);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OrbitDetermination_Full_dataMode_Enum.REAL;
}
...
static startOrbitDetermination_Full(builder:flatbuffers.Builder) {
...
unpack(): OrbitDetermination_FullT {
  return new OrbitDetermination_FullT(
    this.id(),
    ...
    this.numIterations(),
    this.bb!.createScalarList<string>(this.acceptedObTyps.bind(this), this.acceptedObTyps_Length()),
    this.bb!.createScalarList<string>(this.acceptedObIds.bind(this), this.acceptedObIds_Length()),
    this.bb!.createScalarList<string>(this.rejectedObTyps.bind(this), this.rejectedObTyps_Length()),
    this.bb!.createScalarList<string>(this.rejectedObIds.bind(this), this.rejectedObIds_Length()),
    this.bb!.createScalarList<string>(this.sensorIds.bind(this), this.sensorIds_Length()),
    this.createdAt(),
    this.createdBy(),
    this.sourceDl(),
    this.source(),
...
unpackTo(_o: OrbitDetermination_FullT): void {
  _o.id = this.id();
  ...
  _o.acceptedObTyps = this.bb!.createScalarList<string>(this.acceptedObTyps.bind(this), this.acceptedObTyps_Length());
  _o.acceptedObIds = this.bb!.createScalarList<string>(this.acceptedObIds.bind(this), this.acceptedObIds_Length());
  _o.rejectedObTyps = this.bb!.createScalarList<string>(this.rejectedObTyps.bind(this), this.rejectedObTyps_Length());
  _o.rejectedObIds = this.bb!.createScalarList<string>(this.rejectedObIds.bind(this), this.rejectedObIds_Length());
  _o.sensorIds = this.bb!.createScalarList<string>(this.sensorIds.bind(this), this.sensorIds_Length());
...
export class OrbitDetermination_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: OrbitDetermination_Full_dataMode_Enum = OrbitDetermination_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const acceptedObTyps = OrbitDetermination_Full.createAcceptedObTypsVector(builder, builder.createObjectOffsetList(this.acceptedObTyps));
  const acceptedObIds = OrbitDetermination_Full.createAcceptedObIdsVector(builder, builder.createObjectOffsetList(this.acceptedObIds));
  const rejectedObTyps = OrbitDetermination_Full.createRejectedObTypsVector(builder, builder.createObjectOffsetList(this.rejectedObTyps));
  const rejectedObIds = OrbitDetermination_Full.createRejectedObIdsVector(builder, builder.createObjectOffsetList(this.rejectedObIds));
  const sensorIds = OrbitDetermination_Full.createSensorIdsVector(builder, builder.createObjectOffsetList(this.sensorIds));
  ...
  return OrbitDetermination_Full.createOrbitDetermination_Full(builder,
    id,
