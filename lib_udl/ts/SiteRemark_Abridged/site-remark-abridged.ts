...
import { SiteRemark_Abridged_dataMode_Enum } from './site-remark-abridged-data-mode-enum.js';
 ...
 */
export class SiteRemark_Abridged implements flatbuffers.IUnpackableObject<SiteRemark_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SiteRemark_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSiteRemark_Abridged(bb:flatbuffers.ByteBuffer, obj?:SiteRemark_Abridged):SiteRemark_Abridged {
  return (obj || new SiteRemark_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSiteRemark_Abridged(bb:flatbuffers.ByteBuffer, obj?:SiteRemark_Abridged):SiteRemark_Abridged {
 ...
 */
dataMode():SiteRemark_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 30);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SiteRemark_Abridged_dataMode_Enum.REAL;
}

static startSiteRemark_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SiteRemark_Abridged_dataMode_Enum) {
  builder.addFieldInt8(13, dataMode, SiteRemark_Abridged_dataMode_Enum.REAL);
}

static endSiteRemark_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSiteRemark_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SITE');
}

static finishSizePrefixedSiteRemark_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SITE', true);
}

static createSiteRemark_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idSiteOffset:flatbuffers.Offset, origRmkIdOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, textOffset:flatbuffers.Offset, codeOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:SiteRemark_Abridged_dataMode_Enum):flatbuffers.Offset {
  SiteRemark_Abridged.startSiteRemark_Abridged(builder);
...
unpack(): SiteRemark_AbridgedT {
  return new SiteRemark_AbridgedT(
    this.id(),
...
unpackTo(_o: SiteRemark_AbridgedT): void {
  _o.id = this.id();
...
export class SiteRemark_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SiteRemark_Abridged_dataMode_Enum = SiteRemark_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SiteRemark_Abridged.createSiteRemark_Abridged(builder,
    id,
