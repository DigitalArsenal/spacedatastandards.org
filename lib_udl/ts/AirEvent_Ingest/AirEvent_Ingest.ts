...
import { AirEvent_Ingest_dataMode_Enum } from './AirEvent_Ingest_dataMode_Enum.js';


/**
 * /// Information related to an air event (e.g. FUEL TRANSFER, AIR DROP) and the associated aircraft.
 */
export class AirEvent_Ingest implements flatbuffers.IUnpackableObject<AirEvent_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirEvent_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirEvent_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirEvent_Ingest):AirEvent_Ingest {
  return (obj || new AirEvent_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirEvent_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirEvent_Ingest):AirEvent_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():AirEvent_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 90);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirEvent_Ingest_dataMode_Enum.REAL;
}

static startAirEvent_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AirEvent_Ingest_dataMode_Enum) {
  builder.addFieldInt8(43, dataMode, AirEvent_Ingest_dataMode_Enum.REAL);
}

static endAirEvent_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirEvent_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRE');
}

static finishSizePrefixedAirEvent_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRE', true);
}

static createAirEvent_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, idSortieOffset:flatbuffers.Offset, idMissionOffset:flatbuffers.Offset, externalAirEventIdOffset:flatbuffers.Offset, legNum:number, locationOffset:flatbuffers.Offset, arrPurposeOffset:flatbuffers.Offset, plannedArrTimeOffset:flatbuffers.Offset, estArrTimeOffset:flatbuffers.Offset, actualArrTimeOffset:flatbuffers.Offset, depPurposeOffset:flatbuffers.Offset, plannedDepTimeOffset:flatbuffers.Offset, estDepTimeOffset:flatbuffers.Offset, actualDepTimeOffset:flatbuffers.Offset, externalArtrackIdOffset:flatbuffers.Offset, arTrackIdOffset:flatbuffers.Offset, arTrackNameOffset:flatbuffers.Offset, rzctOffset:flatbuffers.Offset, arctOffset:flatbuffers.Offset, baseAlt:number, priorityOffset:flatbuffers.Offset, trackTime:number, statusCodeOffset:flatbuffers.Offset, rzPointOffset:flatbuffers.Offset, rzTypeOffset:flatbuffers.Offset, arEventTypeOffset:flatbuffers.Offset, numTankers:number, revTrack:boolean, shortTrack:boolean, cancelled:boolean, tankersOffset:flatbuffers.Offset, receiversOffset:flatbuffers.Offset, remarksOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:AirEvent_Ingest_dataMode_Enum):flatbuffers.Offset {
  AirEvent_Ingest.startAirEvent_Ingest(builder);
...
unpack(): AirEvent_IngestT {
  return new AirEvent_IngestT(
    this.id(),
...
unpackTo(_o: AirEvent_IngestT): void {
  _o.id = this.id();
...
export class AirEvent_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AirEvent_Ingest_dataMode_Enum = AirEvent_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tankers = AirEvent_Ingest.createTankersVector(builder, builder.createObjectOffsetList(this.tankers));
  const receivers = AirEvent_Ingest.createReceiversVector(builder, builder.createObjectOffsetList(this.receivers));
  const remarks = AirEvent_Ingest.createRemarksVector(builder, builder.createObjectOffsetList(this.remarks));
  ...
  return AirEvent_Ingest.createAirEvent_Ingest(builder,
    id,
