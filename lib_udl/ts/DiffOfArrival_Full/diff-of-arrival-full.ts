...
import { DiffOfArrival_Full_dataMode_Enum } from './diff-of-arrival-full-data-mode-enum.js';
 ...
 */
export class DiffOfArrival_Full implements flatbuffers.IUnpackableObject<DiffOfArrival_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):DiffOfArrival_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsDiffOfArrival_Full(bb:flatbuffers.ByteBuffer, obj?:DiffOfArrival_Full):DiffOfArrival_Full {
  return (obj || new DiffOfArrival_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsDiffOfArrival_Full(bb:flatbuffers.ByteBuffer, obj?:DiffOfArrival_Full):DiffOfArrival_Full {
 ...
 */
dataMode():DiffOfArrival_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 72);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : DiffOfArrival_Full_dataMode_Enum.REAL;
}
...
static startDiffOfArrival_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:DiffOfArrival_Full_dataMode_Enum) {
  builder.addFieldInt8(34, dataMode, DiffOfArrival_Full_dataMode_Enum.REAL);
}
...
static addSourceDl(builder:flatbuffers.Builder, sourceDlOffset:flatbuffers.Offset) {
  builder.addFieldOffset(43, sourceDlOffset, 0);
}

static endDiffOfArrival_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishDiffOfArrival_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DIFF');
}

static finishSizePrefixedDiffOfArrival_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DIFF', true);
}

static createDiffOfArrival_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, obTimeOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, idSensor1Offset:flatbuffers.Offset, idSensor2Offset:flatbuffers.Offset, satNo:number, taskIdOffset:flatbuffers.Offset, origObjectIdOffset:flatbuffers.Offset, origSensorId1Offset:flatbuffers.Offset, origSensorId2Offset:flatbuffers.Offset, uct:boolean, sensor1Delay:number, sensor2Delay:number, senlat:number, senlon:number, senalt:number, sen2lat:number, sen2lon:number, sen2alt:number, frequency:number, bandwidth:number, deltaRange:number, deltaRangeUnc:number, deltaRangeRate:number, deltaRangeRateUnc:number, snr:number, tdoa:number, tdoaUnc:number, fdoa:number, fdoaUnc:number, collectionModeOffset:flatbuffers.Offset, rawFileUriOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, dataMode:DiffOfArrival_Full_dataMode_Enum, tagsOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, onOrbitOffset:flatbuffers.Offset, descriptorOffset:flatbuffers.Offset, transactionIdOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset):flatbuffers.Offset {
  DiffOfArrival_Full.startDiffOfArrival_Full(builder);
...
unpack(): DiffOfArrival_FullT {
  return new DiffOfArrival_FullT(
    this.id(),
...
unpackTo(_o: DiffOfArrival_FullT): void {
  _o.id = this.id();
...
export class DiffOfArrival_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: DiffOfArrival_Full_dataMode_Enum = DiffOfArrival_Full_dataMode_Enum.REAL,
  public tags: (string)[] = [],
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = DiffOfArrival_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return DiffOfArrival_Full.createDiffOfArrival_Full(builder,
    id,
