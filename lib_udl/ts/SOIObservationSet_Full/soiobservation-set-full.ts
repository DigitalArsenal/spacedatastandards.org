...
import { SOIObservationSet_Full_dataMode_Enum } from './soiobservation-set-full-data-mode-enum.js';
import { SOIObservationSet_Full_referenceFrame_Enum } from './soiobservation-set-full-reference-frame-enum.js';
import { SOIObservationSet_Full_senReferenceFrame_Enum } from './soiobservation-set-full-sen-reference-frame-enum.js';
import { SOIObservationSet_Full_type_Enum } from './soiobservation-set-full-type-enum.js';


/**
 * /// These services provide operations for posting space object idenfification observation sets.
 */
export class SOIObservationSet_Full implements flatbuffers.IUnpackableObject<SOIObservationSet_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SOIObservationSet_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSOIObservationSet_Full(bb:flatbuffers.ByteBuffer, obj?:SOIObservationSet_Full):SOIObservationSet_Full {
  return (obj || new SOIObservationSet_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSOIObservationSet_Full(bb:flatbuffers.ByteBuffer, obj?:SOIObservationSet_Full):SOIObservationSet_Full {
 ...
 */
type():SOIObservationSet_Full_type_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 48);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SOIObservationSet_Full_type_Enum.OPTICAL;
}
 ...
 */
referenceFrame():SOIObservationSet_Full_referenceFrame_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 54);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SOIObservationSet_Full_referenceFrame_Enum.J2000;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 24
 */
senReferenceFrame():SOIObservationSet_Full_senReferenceFrame_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 56);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SOIObservationSet_Full_senReferenceFrame_Enum.J2000;
}
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SOIObservationSet_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 148);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SOIObservationSet_Full_dataMode_Enum.REAL;
}

static startSOIObservationSet_Full(builder:flatbuffers.Builder) {
...
static addType(builder:flatbuffers.Builder, type:SOIObservationSet_Full_type_Enum) {
  builder.addFieldInt8(22, type, SOIObservationSet_Full_type_Enum.OPTICAL);
}
...
static addReferenceFrame(builder:flatbuffers.Builder, referenceFrame:SOIObservationSet_Full_referenceFrame_Enum) {
  builder.addFieldInt8(25, referenceFrame, SOIObservationSet_Full_referenceFrame_Enum.J2000);
}

static addSenReferenceFrame(builder:flatbuffers.Builder, senReferenceFrame:SOIObservationSet_Full_senReferenceFrame_Enum) {
  builder.addFieldInt8(26, senReferenceFrame, SOIObservationSet_Full_senReferenceFrame_Enum.J2000);
}
...
unpack(): SOIObservationSet_FullT {
  return new SOIObservationSet_FullT(
    this.id(),
...
unpackTo(_o: SOIObservationSet_FullT): void {
  _o.id = this.id();
...
export class SOIObservationSet_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public type: SOIObservationSet_Full_type_Enum = SOIObservationSet_Full_type_Enum.OPTICAL,
  public polarAngleStart: number = 0.0,
  public polarAngleEnd: number = 0.0,
  public referenceFrame: SOIObservationSet_Full_referenceFrame_Enum = SOIObservationSet_Full_referenceFrame_Enum.J2000,
  public senReferenceFrame: SOIObservationSet_Full_senReferenceFrame_Enum = SOIObservationSet_Full_senReferenceFrame_Enum.J2000,
  ...
  public dataMode: SOIObservationSet_Full_dataMode_Enum = SOIObservationSet_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const spectralFilters = SOIObservationSet_Full.createSpectralFiltersVector(builder, builder.createObjectOffsetList(this.spectralFilters));
  ...
  const calibrations = SOIObservationSet_Full.createCalibrationsVector(builder, builder.createObjectOffsetList(this.calibrations));
  const tags = SOIObservationSet_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  const transactionId = (this.transactionId !== null ? builder.createString(this.transactionId!) : 0);
  const opticalSOIObservationList = SOIObservationSet_Full.createOpticalSoiobservationListVector(builder, builder.createObjectOffsetList(this.opticalSOIObservationList));
  const radarSOIObservationList = SOIObservationSet_Full.createRadarSoiobservationListVector(builder, builder.createObjectOffsetList(this.radarSOIObservationList));
  ...
  return SOIObservationSet_Full.createSOIObservationSet_Full(builder,
    id,
