 ...
 */
export class OpticalSOIObservation_Ingest implements flatbuffers.IUnpackableObject<OpticalSOIObservation_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OpticalSOIObservation_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOpticalSOIObservation_Ingest(bb:flatbuffers.ByteBuffer, obj?:OpticalSOIObservation_Ingest):OpticalSOIObservation_Ingest {
  return (obj || new OpticalSOIObservation_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOpticalSOIObservation_Ingest(bb:flatbuffers.ByteBuffer, obj?:OpticalSOIObservation_Ingest):OpticalSOIObservation_Ingest {
...
static startOpticalSOIObservation_Ingest(builder:flatbuffers.Builder) {
...
unpack(): OpticalSOIObservation_IngestT {
  return new OpticalSOIObservation_IngestT(
    this.obStartTime(),
    this.bb!.createScalarList<string>(this.intensityTimes.bind(this), this.intensityTimesLength()),
    this.currentSpectralFilterNum(),
    this.expDuration(),
    this.bb!.createScalarList<string>(this.intensities.bind(this), this.intensitiesLength()),
    ...
    this.bb!.createScalarList<string>(this.skyBgs.bind(this), this.skyBgsLength()),
    this.bb!.createScalarList<string>(this.localSkyBgs.bind(this), this.localSkyBgsLength()),
    this.bb!.createScalarList<string>(this.localSkyBgsUnc.bind(this), this.localSkyBgsUncLength()),
    this.bb!.createScalarList<string>(this.numDetectedStars.bind(this), this.numDetectedStarsLength()),
    this.bb!.createScalarList<string>(this.numCorrelatedStars.bind(this), this.numCorrelatedStarsLength()),
    this.bb!.createScalarList<string>(this.zeroPoints.bind(this), this.zeroPointsLength()),
    this.bb!.createScalarList<string>(this.ras.bind(this), this.rasLength()),
    this.bb!.createScalarList<string>(this.declinations.bind(this), this.declinationsLength()),
    this.bb!.createScalarList<string>(this.raRates.bind(this), this.raRatesLength()),
    this.bb!.createScalarList<string>(this.percentSats.bind(this), this.percentSatsLength())
  );
}


unpackTo(_o: OpticalSOIObservation_IngestT): void {
  _o.obStartTime = this.obStartTime();
  _o.intensityTimes = this.bb!.createScalarList<string>(this.intensityTimes.bind(this), this.intensityTimesLength());
  _o.currentSpectralFilterNum = this.currentSpectralFilterNum();
  _o.expDuration = this.expDuration();
  _o.intensities = this.bb!.createScalarList<string>(this.intensities.bind(this), this.intensitiesLength());
  ...
  _o.skyBgs = this.bb!.createScalarList<string>(this.skyBgs.bind(this), this.skyBgsLength());
  _o.localSkyBgs = this.bb!.createScalarList<string>(this.localSkyBgs.bind(this), this.localSkyBgsLength());
  _o.localSkyBgsUnc = this.bb!.createScalarList<string>(this.localSkyBgsUnc.bind(this), this.localSkyBgsUncLength());
  _o.numDetectedStars = this.bb!.createScalarList<string>(this.numDetectedStars.bind(this), this.numDetectedStarsLength());
  _o.numCorrelatedStars = this.bb!.createScalarList<string>(this.numCorrelatedStars.bind(this), this.numCorrelatedStarsLength());
  _o.zeroPoints = this.bb!.createScalarList<string>(this.zeroPoints.bind(this), this.zeroPointsLength());
  _o.ras = this.bb!.createScalarList<string>(this.ras.bind(this), this.rasLength());
  _o.declinations = this.bb!.createScalarList<string>(this.declinations.bind(this), this.declinationsLength());
  _o.raRates = this.bb!.createScalarList<string>(this.raRates.bind(this), this.raRatesLength());
  _o.percentSats = this.bb!.createScalarList<string>(this.percentSats.bind(this), this.percentSatsLength());
}
}

export class OpticalSOIObservation_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const intensityTimes = OpticalSOIObservation_Ingest.createIntensityTimesVector(builder, builder.createObjectOffsetList(this.intensityTimes));
  const intensities = OpticalSOIObservation_Ingest.createIntensitiesVector(builder, builder.createObjectOffsetList(this.intensities));
  const extinctionCoeffs = OpticalSOIObservation_Ingest.createExtinctionCoeffsVector(builder, builder.createObjectOffsetList(this.extinctionCoeffs));
  const extinctionCoeffsUnc = OpticalSOIObservation_Ingest.createExtinctionCoeffsUncVector(builder, builder.createObjectOffsetList(this.extinctionCoeffsUnc));
  const skyBgs = OpticalSOIObservation_Ingest.createSkyBgsVector(builder, builder.createObjectOffsetList(this.skyBgs));
  const localSkyBgs = OpticalSOIObservation_Ingest.createLocalSkyBgsVector(builder, builder.createObjectOffsetList(this.localSkyBgs));
  const localSkyBgsUnc = OpticalSOIObservation_Ingest.createLocalSkyBgsUncVector(builder, builder.createObjectOffsetList(this.localSkyBgsUnc));
  const numDetectedStars = OpticalSOIObservation_Ingest.createNumDetectedStarsVector(builder, builder.createObjectOffsetList(this.numDetectedStars));
  const numCorrelatedStars = OpticalSOIObservation_Ingest.createNumCorrelatedStarsVector(builder, builder.createObjectOffsetList(this.numCorrelatedStars));
  const zeroPoints = OpticalSOIObservation_Ingest.createZeroPointsVector(builder, builder.createObjectOffsetList(this.zeroPoints));
  const ras = OpticalSOIObservation_Ingest.createRasVector(builder, builder.createObjectOffsetList(this.ras));
  const declinations = OpticalSOIObservation_Ingest.createDeclinationsVector(builder, builder.createObjectOffsetList(this.declinations));
  const raRates = OpticalSOIObservation_Ingest.createRaRatesVector(builder, builder.createObjectOffsetList(this.raRates));
  const percentSats = OpticalSOIObservation_Ingest.createPercentSatsVector(builder, builder.createObjectOffsetList(this.percentSats));

  return OpticalSOIObservation_Ingest.createOpticalSOIObservation_Ingest(builder,
    obStartTime,
    intensityTimes,
    this.currentSpectralFilterNum,
    this.expDuration,
