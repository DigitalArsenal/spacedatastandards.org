...
import { SpaceEnvObservation_Full_dataMode_Enum } from './space-env-observation-full-data-mode-enum.js';
import { SpaceEnvObservation_Full_senReferenceFrame_Enum } from './space-env-observation-full-sen-reference-frame-enum.js';


/**
 * /// SpaceEnvObservation data.
 */
export class SpaceEnvObservation_Full implements flatbuffers.IUnpackableObject<SpaceEnvObservation_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SpaceEnvObservation_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSpaceEnvObservation_Full(bb:flatbuffers.ByteBuffer, obj?:SpaceEnvObservation_Full):SpaceEnvObservation_Full {
  return (obj || new SpaceEnvObservation_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSpaceEnvObservation_Full(bb:flatbuffers.ByteBuffer, obj?:SpaceEnvObservation_Full):SpaceEnvObservation_Full {
 ...
 */
senReferenceFrame():SpaceEnvObservation_Full_senReferenceFrame_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 46);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SpaceEnvObservation_Full_senReferenceFrame_Enum.J2000;
}
 ...
 */
dataMode():SpaceEnvObservation_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 82);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SpaceEnvObservation_Full_dataMode_Enum.REAL;
}
...
static startSpaceEnvObservation_Full(builder:flatbuffers.Builder) {
...
static addSenReferenceFrame(builder:flatbuffers.Builder, senReferenceFrame:SpaceEnvObservation_Full_senReferenceFrame_Enum) {
  builder.addFieldInt8(21, senReferenceFrame, SpaceEnvObservation_Full_senReferenceFrame_Enum.J2000);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SpaceEnvObservation_Full_dataMode_Enum) {
  builder.addFieldInt8(39, dataMode, SpaceEnvObservation_Full_dataMode_Enum.REAL);
}
...
unpack(): SpaceEnvObservation_FullT {
  return new SpaceEnvObservation_FullT(
    this.id(),
...
unpackTo(_o: SpaceEnvObservation_FullT): void {
  _o.id = this.id();
...
export class SpaceEnvObservation_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public senReferenceFrame: SpaceEnvObservation_Full_senReferenceFrame_Enum = SpaceEnvObservation_Full_senReferenceFrame_Enum.J2000,
  ...
  public dataMode: SpaceEnvObservation_Full_dataMode_Enum = SpaceEnvObservation_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const senPos = SpaceEnvObservation_Full.createSenPosVector(builder, builder.createObjectOffsetList(this.senPos));
  const senVel = SpaceEnvObservation_Full.createSenVelVector(builder, builder.createObjectOffsetList(this.senVel));
  ...
  const seoList = SpaceEnvObservation_Full.createSeoListVector(builder, builder.createObjectOffsetList(this.seoList));
  ...
  const srcTyps = SpaceEnvObservation_Full.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = SpaceEnvObservation_Full.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  ...
  return SpaceEnvObservation_Full.createSpaceEnvObservation_Full(builder,
    id,
