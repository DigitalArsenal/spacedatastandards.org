 ...
 */
export class EvacTreatment_Ingest implements flatbuffers.IUnpackableObject<EvacTreatment_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EvacTreatment_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEvacTreatment_Ingest(bb:flatbuffers.ByteBuffer, obj?:EvacTreatment_Ingest):EvacTreatment_Ingest {
  return (obj || new EvacTreatment_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEvacTreatment_Ingest(bb:flatbuffers.ByteBuffer, obj?:EvacTreatment_Ingest):EvacTreatment_Ingest {
...
static startEvacTreatment_Ingest(builder:flatbuffers.Builder) {
...
static endEvacTreatment_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEvacTreatment_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC');
}

static finishSizePrefixedEvacTreatment_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC', true);
}

static createEvacTreatment_Ingest(builder:flatbuffers.Builder, typeOffset:flatbuffers.Offset, bodyPartOffset:flatbuffers.Offset, timeOffset:flatbuffers.Offset, commentsOffset:flatbuffers.Offset):flatbuffers.Offset {
  EvacTreatment_Ingest.startEvacTreatment_Ingest(builder);
...
unpack(): EvacTreatment_IngestT {
  return new EvacTreatment_IngestT(
    this.type(),
    this.bodyPart(),
    this.time(),
    this.comments()
...
unpackTo(_o: EvacTreatment_IngestT): void {
  _o.type = this.type();
...
export class EvacTreatment_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return EvacTreatment_Ingest.createEvacTreatment_Ingest(builder,
    type,
    bodyPart,
    time,
    comments
