...
import { SOIObservationSet_Ingest_dataMode_Enum } from './soiobservation-set-ingest-data-mode-enum.js';
import { SOIObservationSet_Ingest_referenceFrame_Enum } from './soiobservation-set-ingest-reference-frame-enum.js';
import { SOIObservationSet_Ingest_senReferenceFrame_Enum } from './soiobservation-set-ingest-sen-reference-frame-enum.js';
import { SOIObservationSet_Ingest_type_Enum } from './soiobservation-set-ingest-type-enum.js';


/**
 * /// These services provide operations for posting space object idenfification observation sets.
 */
export class SOIObservationSet_Ingest implements flatbuffers.IUnpackableObject<SOIObservationSet_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SOIObservationSet_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSOIObservationSet_Ingest(bb:flatbuffers.ByteBuffer, obj?:SOIObservationSet_Ingest):SOIObservationSet_Ingest {
  return (obj || new SOIObservationSet_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSOIObservationSet_Ingest(bb:flatbuffers.ByteBuffer, obj?:SOIObservationSet_Ingest):SOIObservationSet_Ingest {
 ...
 */
type():SOIObservationSet_Ingest_type_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 48);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SOIObservationSet_Ingest_type_Enum.OPTICAL;
}
 ...
 */
referenceFrame():SOIObservationSet_Ingest_referenceFrame_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 54);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SOIObservationSet_Ingest_referenceFrame_Enum.J2000;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 24
 */
senReferenceFrame():SOIObservationSet_Ingest_senReferenceFrame_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 56);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SOIObservationSet_Ingest_senReferenceFrame_Enum.J2000;
}
 ...
 * Constraints: No constraints specified.
 */
opticalSoiobservationList(index: number):string
opticalSoiobservationList(index: number,optionalEncoding:flatbuffers.Encoding):string|Uint8Array
opticalSoiobservationList(index: number,optionalEncoding?:any):string|Uint8Array|null {
 ...
 * Constraints: No constraints specified.
 */
radarSoiobservationList(index: number):string
radarSoiobservationList(index: number,optionalEncoding:flatbuffers.Encoding):string|Uint8Array
radarSoiobservationList(index: number,optionalEncoding?:any):string|Uint8Array|null {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SOIObservationSet_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 148);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SOIObservationSet_Ingest_dataMode_Enum.REAL;
}

static startSOIObservationSet_Ingest(builder:flatbuffers.Builder) {
...
static addType(builder:flatbuffers.Builder, type:SOIObservationSet_Ingest_type_Enum) {
  builder.addFieldInt8(22, type, SOIObservationSet_Ingest_type_Enum.OPTICAL);
}
...
static addReferenceFrame(builder:flatbuffers.Builder, referenceFrame:SOIObservationSet_Ingest_referenceFrame_Enum) {
  builder.addFieldInt8(25, referenceFrame, SOIObservationSet_Ingest_referenceFrame_Enum.J2000);
}

static addSenReferenceFrame(builder:flatbuffers.Builder, senReferenceFrame:SOIObservationSet_Ingest_senReferenceFrame_Enum) {
  builder.addFieldInt8(26, senReferenceFrame, SOIObservationSet_Ingest_senReferenceFrame_Enum.J2000);
}
...
static addOpticalSoiobservationList(builder:flatbuffers.Builder, opticalSoiobservationListOffset:flatbuffers.Offset) {
  builder.addFieldOffset(64, opticalSoiobservationListOffset, 0);
}
...
static addRadarSoiobservationList(builder:flatbuffers.Builder, radarSoiobservationListOffset:flatbuffers.Offset) {
  builder.addFieldOffset(65, radarSoiobservationListOffset, 0);
}
...
static addSource(builder:flatbuffers.Builder, sourceOffset:flatbuffers.Offset) {
  builder.addFieldOffset(68, sourceOffset, 0);
}

static addOrigin(builder:flatbuffers.Builder, originOffset:flatbuffers.Offset) {
  builder.addFieldOffset(69, originOffset, 0);
}
...
static addSourceDl(builder:flatbuffers.Builder, sourceDlOffset:flatbuffers.Offset) {
  builder.addFieldOffset(71, sourceDlOffset, 0);
}

static addDataMode(builder:flatbuffers.Builder, dataMode:SOIObservationSet_Ingest_dataMode_Enum) {
  builder.addFieldInt8(72, dataMode, SOIObservationSet_Ingest_dataMode_Enum.REAL);
}

static endSOIObservationSet_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSOIObservationSet_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SOIO');
}

static finishSizePrefixedSOIObservationSet_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SOIO', true);
}

static createSOIObservationSet_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, msgCreateDateOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, origSensorIdOffset:flatbuffers.Offset, sensorAsIdOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, satNo:number, origObjectIdOffset:flatbuffers.Offset, senlat:number, senlon:number, senalt:number, senx:number, seny:number, senz:number, senvelx:number, senvely:number, senvelz:number, idElsetOffset:flatbuffers.Offset, startTimeOffset:flatbuffers.Offset, endTimeOffset:flatbuffers.Offset, numObs:number, type:SOIObservationSet_Ingest_type_Enum, polarAngleStart:number, polarAngleEnd:number, referenceFrame:SOIObservationSet_Ingest_referenceFrame_Enum, senReferenceFrame:SOIObservationSet_Ingest_senReferenceFrame_Enum, losDeclinationStart:number, losDeclinationEnd:number, pointingAngleAzStart:number, pointingAngleAzEnd:number, pointingAngleElStart:number, pointingAngleElEnd:number, pixelArrayWidth:number, pixelArrayHeight:number, numSpectralFilters:number, spectralFiltersOffset:flatbuffers.Offset, collectionModeOffset:flatbuffers.Offset, gain:number, binningHoriz:number, binningVert:number, solarMag:number, pixelMin:number, pixelMax:number, softwareVersionOffset:flatbuffers.Offset, satelliteNameOffset:flatbuffers.Offset, starCatNameOffset:flatbuffers.Offset, corrQuality:number, uct:boolean, validCalibrationsOffset:flatbuffers.Offset, calibrationTypeOffset:flatbuffers.Offset, percentSatThreshold:number, changeDetected:boolean, periodicityChangeDetected:boolean, brightnessVarianceChangeDetected:boolean, solarPhaseAngleBrightnessChangeDetected:boolean, changeConfOffset:flatbuffers.Offset, collectionDensityConfOffset:flatbuffers.Offset, periodicitySamplingConfOffset:flatbuffers.Offset, periodicityDetectionConfOffset:flatbuffers.Offset, collectionIdOffset:flatbuffers.Offset, calibrationsOffset:flatbuffers.Offset, tagsOffset:flatbuffers.Offset, transactionIdOffset:flatbuffers.Offset, opticalSoiobservationListOffset:flatbuffers.Offset, radarSoiobservationListOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, dataMode:SOIObservationSet_Ingest_dataMode_Enum):flatbuffers.Offset {
  SOIObservationSet_Ingest.startSOIObservationSet_Ingest(builder);
...
unpack(): SOIObservationSet_IngestT {
  return new SOIObservationSet_IngestT(
    this.id(),
    ...
    this.collectionId(),
    this.bb!.createScalarList<string>(this.calibrations.bind(this), this.calibrations_Length()),
    this.bb!.createScalarList<string>(this.tags.bind(this), this.tags_Length()),
    this.transactionId(),
    this.bb!.createScalarList<string>(this.opticalSoiobservationList.bind(this), this.opticalSOIObservationList_Length()),
    this.bb!.createScalarList<string>(this.radarSoiobservationList.bind(this), this.radarSOIObservationList_Length()),
    this.createdAt(),
    this.createdBy(),
    this.source(),
    this.origin(),
...
unpackTo(_o: SOIObservationSet_IngestT): void {
  _o.id = this.id();
  ...
  _o.calibrations = this.bb!.createScalarList<string>(this.calibrations.bind(this), this.calibrations_Length());
  _o.tags = this.bb!.createScalarList<string>(this.tags.bind(this), this.tags_Length());
  _o.transactionId = this.transactionId();
  _o.opticalSOIObservationList = this.bb!.createScalarList<string>(this.opticalSoiobservationList.bind(this), this.opticalSOIObservationList_Length());
  _o.radarSOIObservationList = this.bb!.createScalarList<string>(this.radarSoiobservationList.bind(this), this.radarSOIObservationList_Length());
...
export class SOIObservationSet_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public type: SOIObservationSet_Ingest_type_Enum = SOIObservationSet_Ingest_type_Enum.OPTICAL,
  public polarAngleStart: number = 0.0,
  public polarAngleEnd: number = 0.0,
  public referenceFrame: SOIObservationSet_Ingest_referenceFrame_Enum = SOIObservationSet_Ingest_referenceFrame_Enum.J2000,
  public senReferenceFrame: SOIObservationSet_Ingest_senReferenceFrame_Enum = SOIObservationSet_Ingest_senReferenceFrame_Enum.J2000,
  ...
  public opticalSOIObservationList: (string)[] = [],
  public radarSOIObservationList: (string)[] = [],
  ...
  public dataMode: SOIObservationSet_Ingest_dataMode_Enum = SOIObservationSet_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const spectralFilters = SOIObservationSet_Ingest.createSpectralFiltersVector(builder, builder.createObjectOffsetList(this.spectralFilters));
  ...
  const calibrations = SOIObservationSet_Ingest.createCalibrationsVector(builder, builder.createObjectOffsetList(this.calibrations));
  const tags = SOIObservationSet_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  const transactionId = (this.transactionId !== null ? builder.createString(this.transactionId!) : 0);
  const opticalSOIObservationList = SOIObservationSet_Ingest.createOpticalSoiobservationListVector(builder, builder.createObjectOffsetList(this.opticalSOIObservationList));
  const radarSOIObservationList = SOIObservationSet_Ingest.createRadarSoiobservationListVector(builder, builder.createObjectOffsetList(this.radarSOIObservationList));
  ...
  return SOIObservationSet_Ingest.createSOIObservationSet_Ingest(builder,
    id,
