...
import { SOIObservationSet_Ingest_dataMode_Enum } from './SOIObservationSet_Ingest_dataMode_Enum.js';
import { SOIObservationSet_Ingest_referenceFrame_Enum } from './SOIObservationSet_Ingest_referenceFrame_Enum.js';
import { SOIObservationSet_Ingest_senReferenceFrame_Enum } from './SOIObservationSet_Ingest_senReferenceFrame_Enum.js';
import { SOIObservationSet_Ingest_type_Enum } from './SOIObservationSet_Ingest_type_Enum.js';
...
unpack(): SOIObservationSet_IngestT {
  return new SOIObservationSet_IngestT(
    ...
    this.transactionId(),
    this.bb!.createScalarList<string>(this.opticalSoiobservationList.bind(this), this.opticalSoiobservationListLength()),
    this.bb!.createScalarList<string>(this.radarSoiobservationList.bind(this), this.radarSoiobservationListLength()),
    this.createdAt(),
    this.createdBy(),
    this.source(),
    this.origin(),
...
unpackTo(_o: SOIObservationSet_IngestT): void {
  ...
  _o.opticalSoiobservationList = this.bb!.createScalarList<string>(this.opticalSoiobservationList.bind(this), this.opticalSoiobservationListLength());
  _o.radarSoiobservationList = this.bb!.createScalarList<string>(this.radarSoiobservationList.bind(this), this.radarSoiobservationListLength());
