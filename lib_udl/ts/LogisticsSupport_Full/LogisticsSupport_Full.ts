...
import { LogisticsSupport_Full_dataMode_Enum } from './LogisticsSupport_Full_dataMode_Enum.js';
 ...
 */
export class LogisticsSupport_Full implements flatbuffers.IUnpackableObject<LogisticsSupport_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LogisticsSupport_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLogisticsSupport_Full(bb:flatbuffers.ByteBuffer, obj?:LogisticsSupport_Full):LogisticsSupport_Full {
  return (obj || new LogisticsSupport_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLogisticsSupport_Full(bb:flatbuffers.ByteBuffer, obj?:LogisticsSupport_Full):LogisticsSupport_Full {
 ...
 */
dataMode():LogisticsSupport_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 62);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : LogisticsSupport_Full_dataMode_Enum.REAL;
}

static startLogisticsSupport_Full(builder:flatbuffers.Builder) {
...
unpack(): LogisticsSupport_FullT {
  return new LogisticsSupport_FullT(
    this.id(),
...
unpackTo(_o: LogisticsSupport_FullT): void {
  _o.id = this.id();
...
export class LogisticsSupport_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: LogisticsSupport_Full_dataMode_Enum = LogisticsSupport_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const logisticsRemarks = LogisticsSupport_Full.createLogisticsRemarksVector(builder, builder.createObjectOffsetList(this.logisticsRemarks));
  const logisticsDiscrepancyInfos = LogisticsSupport_Full.createLogisticsDiscrepancyInfosVector(builder, builder.createObjectOffsetList(this.logisticsDiscrepancyInfos));
  const logisticsTransportationPlans = LogisticsSupport_Full.createLogisticsTransportationPlansVector(builder, builder.createObjectOffsetList(this.logisticsTransportationPlans));
  const logisticsSupportItems = LogisticsSupport_Full.createLogisticsSupportItemsVector(builder, builder.createObjectOffsetList(this.logisticsSupportItems));
  ...
  return LogisticsSupport_Full.createLogisticsSupport_Full(builder,
    id,
