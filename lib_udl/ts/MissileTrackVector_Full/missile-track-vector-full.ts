 ...
 */
export class MissileTrackVector_Full implements flatbuffers.IUnpackableObject<MissileTrackVector_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MissileTrackVector_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMissileTrackVector_Full(bb:flatbuffers.ByteBuffer, obj?:MissileTrackVector_Full):MissileTrackVector_Full {
  return (obj || new MissileTrackVector_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMissileTrackVector_Full(bb:flatbuffers.ByteBuffer, obj?:MissileTrackVector_Full):MissileTrackVector_Full {
...
static startMissileTrackVector_Full(builder:flatbuffers.Builder) {
...
static endMissileTrackVector_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishMissileTrackVector_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MISS');
}

static finishSizePrefixedMissileTrackVector_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MISS', true);
}

static createMissileTrackVector_Full(builder:flatbuffers.Builder, typeOffset:flatbuffers.Offset, objectOffset:flatbuffers.Offset, epochOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, origSensorIdOffset:flatbuffers.Offset, posOffset:flatbuffers.Offset, velOffset:flatbuffers.Offset, accelOffset:flatbuffers.Offset, course:number, spd:number, referenceFrameOffset:flatbuffers.Offset, covOffset:flatbuffers.Offset, covReferenceFrameOffset:flatbuffers.Offset, vectorLat:number, vectorLon:number, vectorAlt:number, confidence:number, statusOffset:flatbuffers.Offset, timeSourceOffset:flatbuffers.Offset, quatOffset:flatbuffers.Offset, flightAz:number):flatbuffers.Offset {
  MissileTrackVector_Full.startMissileTrackVector_Full(builder);
...
unpack(): MissileTrackVector_FullT {
  return new MissileTrackVector_FullT(
    this.type(),
    this.object(),
    this.epoch(),
    this.idSensor(),
...
unpackTo(_o: MissileTrackVector_FullT): void {
  _o.type = this.type();
...
export class MissileTrackVector_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const pos = MissileTrackVector_Full.createPosVector(builder, builder.createObjectOffsetList(this.pos));
  const vel = MissileTrackVector_Full.createVelVector(builder, builder.createObjectOffsetList(this.vel));
  const accel = MissileTrackVector_Full.createAccelVector(builder, builder.createObjectOffsetList(this.accel));
  const referenceFrame = (this.referenceFrame !== null ? builder.createString(this.referenceFrame!) : 0);
  const cov = MissileTrackVector_Full.createCovVector(builder, builder.createObjectOffsetList(this.cov));
  ...
  const quat = MissileTrackVector_Full.createQuatVector(builder, builder.createObjectOffsetList(this.quat));

  return MissileTrackVector_Full.createMissileTrackVector_Full(builder,
    type,
    object,
    epoch,
    idSensor,
