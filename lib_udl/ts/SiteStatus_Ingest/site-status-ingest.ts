...
import { SiteStatus_Ingest_cat_Enum } from './site-status-ingest-cat-enum.js';
import { SiteStatus_Ingest_cpcon_Enum } from './site-status-ingest-cpcon-enum.js';
import { SiteStatus_Ingest_dataMode_Enum } from './site-status-ingest-data-mode-enum.js';
import { SiteStatus_Ingest_eoc_Enum } from './site-status-ingest-eoc-enum.js';
import { SiteStatus_Ingest_fpcon_Enum } from './site-status-ingest-fpcon-enum.js';
import { SiteStatus_Ingest_hpcon_Enum } from './site-status-ingest-hpcon-enum.js';
import { SiteStatus_Ingest_instStatus_Enum } from './site-status-ingest-inst-status-enum.js';


/**
 * /// No description available.
 */
export class SiteStatus_Ingest implements flatbuffers.IUnpackableObject<SiteStatus_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SiteStatus_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSiteStatus_Ingest(bb:flatbuffers.ByteBuffer, obj?:SiteStatus_Ingest):SiteStatus_Ingest {
  return (obj || new SiteStatus_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSiteStatus_Ingest(bb:flatbuffers.ByteBuffer, obj?:SiteStatus_Ingest):SiteStatus_Ingest {
 ...
 */
instStatus():SiteStatus_Ingest_instStatus_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 22);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SiteStatus_Ingest_instStatus_Enum.FMC;
}
 ...
 */
fpcon():SiteStatus_Ingest_fpcon_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 24);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SiteStatus_Ingest_fpcon_Enum.NORMAL;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 7
 */
hpcon():SiteStatus_Ingest_hpcon_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 26);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SiteStatus_Ingest_hpcon_Enum.E0;
}
 ...
 */
cpcon():SiteStatus_Ingest_cpcon_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 28);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SiteStatus_Ingest_cpcon_Enum.E1;
}
 ...
 */
cat():SiteStatus_Ingest_cat_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 50);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SiteStatus_Ingest_cat_Enum.COLD;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 4
 */
eoc():SiteStatus_Ingest_eoc_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 52);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SiteStatus_Ingest_eoc_Enum.COLD;
}
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SiteStatus_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 76);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SiteStatus_Ingest_dataMode_Enum.REAL;
}

static startSiteStatus_Ingest(builder:flatbuffers.Builder) {
...
static addInstStatus(builder:flatbuffers.Builder, instStatus:SiteStatus_Ingest_instStatus_Enum) {
  builder.addFieldInt8(9, instStatus, SiteStatus_Ingest_instStatus_Enum.FMC);
}

static addFpcon(builder:flatbuffers.Builder, fpcon:SiteStatus_Ingest_fpcon_Enum) {
  builder.addFieldInt8(10, fpcon, SiteStatus_Ingest_fpcon_Enum.NORMAL);
}

static addHpcon(builder:flatbuffers.Builder, hpcon:SiteStatus_Ingest_hpcon_Enum) {
  builder.addFieldInt8(11, hpcon, SiteStatus_Ingest_hpcon_Enum.E0);
}

static addCpcon(builder:flatbuffers.Builder, cpcon:SiteStatus_Ingest_cpcon_Enum) {
  builder.addFieldInt8(12, cpcon, SiteStatus_Ingest_cpcon_Enum.E1);
}
...
static addCat(builder:flatbuffers.Builder, cat:SiteStatus_Ingest_cat_Enum) {
  builder.addFieldInt8(23, cat, SiteStatus_Ingest_cat_Enum.COLD);
}

static addEoc(builder:flatbuffers.Builder, eoc:SiteStatus_Ingest_eoc_Enum) {
  builder.addFieldInt8(24, eoc, SiteStatus_Ingest_eoc_Enum.COLD);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SiteStatus_Ingest_dataMode_Enum) {
  builder.addFieldInt8(36, dataMode, SiteStatus_Ingest_dataMode_Enum.REAL);
}

static endSiteStatus_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSiteStatus_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SITE');
}

static finishSizePrefixedSiteStatus_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SITE', true);
}

static createSiteStatus_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idSiteOffset:flatbuffers.Offset, siteTypeOffset:flatbuffers.Offset, mobileAltIdOffset:flatbuffers.Offset, poiidOffset:flatbuffers.Offset, trackIdOffset:flatbuffers.Offset, trackRefL16Offset:flatbuffers.Offset, opsCapabilityOffset:flatbuffers.Offset, instStatus:SiteStatus_Ingest_instStatus_Enum, fpcon:SiteStatus_Ingest_fpcon_Enum, hpcon:SiteStatus_Ingest_hpcon_Enum, cpcon:SiteStatus_Ingest_cpcon_Enum, reportTimeOffset:flatbuffers.Offset, timeFunctionOffset:flatbuffers.Offset, weatherMessageOffset:flatbuffers.Offset, pes:boolean, hotInventory:number, coldInventory:number, samModeOffset:flatbuffers.Offset, radiateModeOffset:flatbuffers.Offset, opsImpairmentOffset:flatbuffers.Offset, commImpairmentOffset:flatbuffers.Offset, cat:SiteStatus_Ingest_cat_Enum, eoc:SiteStatus_Ingest_eoc_Enum, linkOffset:flatbuffers.Offset, linkStatusOffset:flatbuffers.Offset, radarSystemOffset:flatbuffers.Offset, radarStatusOffset:flatbuffers.Offset, missileOffset:flatbuffers.Offset, missileInventoryOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:SiteStatus_Ingest_dataMode_Enum):flatbuffers.Offset {
  SiteStatus_Ingest.startSiteStatus_Ingest(builder);
...
unpack(): SiteStatus_IngestT {
  return new SiteStatus_IngestT(
    this.id(),
...
unpackTo(_o: SiteStatus_IngestT): void {
  _o.id = this.id();
...
export class SiteStatus_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public instStatus: SiteStatus_Ingest_instStatus_Enum = SiteStatus_Ingest_instStatus_Enum.FMC,
  public fpcon: SiteStatus_Ingest_fpcon_Enum = SiteStatus_Ingest_fpcon_Enum.NORMAL,
  public hpcon: SiteStatus_Ingest_hpcon_Enum = SiteStatus_Ingest_hpcon_Enum.E0,
  public cpcon: SiteStatus_Ingest_cpcon_Enum = SiteStatus_Ingest_cpcon_Enum.E1,
  ...
  public cat: SiteStatus_Ingest_cat_Enum = SiteStatus_Ingest_cat_Enum.COLD,
  public eoc: SiteStatus_Ingest_eoc_Enum = SiteStatus_Ingest_eoc_Enum.COLD,
  public link: (string)[] = [],
  ...
  public dataMode: SiteStatus_Ingest_dataMode_Enum = SiteStatus_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const link = SiteStatus_Ingest.createLinkVector(builder, builder.createObjectOffsetList(this.link));
  const linkStatus = SiteStatus_Ingest.createLinkStatusVector(builder, builder.createObjectOffsetList(this.linkStatus));
  const radarSystem = SiteStatus_Ingest.createRadarSystemVector(builder, builder.createObjectOffsetList(this.radarSystem));
  const radarStatus = SiteStatus_Ingest.createRadarStatusVector(builder, builder.createObjectOffsetList(this.radarStatus));
  const missile = SiteStatus_Ingest.createMissileVector(builder, builder.createObjectOffsetList(this.missile));
  const missileInventory = SiteStatus_Ingest.createMissileInventoryVector(builder, builder.createObjectOffsetList(this.missileInventory));
  ...
  return SiteStatus_Ingest.createSiteStatus_Ingest(builder,
    id,
