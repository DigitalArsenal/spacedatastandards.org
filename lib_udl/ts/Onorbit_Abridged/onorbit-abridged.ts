...
import { Onorbit_Abridged_category_Enum } from './onorbit-abridged-category-enum.js';
import { Onorbit_Abridged_dataMode_Enum } from './onorbit-abridged-data-mode-enum.js';
import { Onorbit_Abridged_objectType_Enum } from './onorbit-abridged-object-type-enum.js';


/**
 * /// Model object representing on-orbit objects or satellites in the system.
 */
export class Onorbit_Abridged implements flatbuffers.IUnpackableObject<Onorbit_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Onorbit_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOnorbit_Abridged(bb:flatbuffers.ByteBuffer, obj?:Onorbit_Abridged):Onorbit_Abridged {
  return (obj || new Onorbit_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOnorbit_Abridged(bb:flatbuffers.ByteBuffer, obj?:Onorbit_Abridged):Onorbit_Abridged {
 ...
 */
objectType():Onorbit_Abridged_objectType_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 20);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Onorbit_Abridged_objectType_Enum.ROCKET_BODY;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 45
 */
category():Onorbit_Abridged_category_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 26);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Onorbit_Abridged_category_Enum.UNKNOWN;
}
 ...
 */
dataMode():Onorbit_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 38);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Onorbit_Abridged_dataMode_Enum.REAL;
}
...
static startOnorbit_Abridged(builder:flatbuffers.Builder) {
...
static addObjectType(builder:flatbuffers.Builder, objectType:Onorbit_Abridged_objectType_Enum) {
  builder.addFieldInt8(8, objectType, Onorbit_Abridged_objectType_Enum.ROCKET_BODY);
}
...
static addCategory(builder:flatbuffers.Builder, category:Onorbit_Abridged_category_Enum) {
  builder.addFieldInt8(11, category, Onorbit_Abridged_category_Enum.UNKNOWN);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Onorbit_Abridged_dataMode_Enum) {
  builder.addFieldInt8(17, dataMode, Onorbit_Abridged_dataMode_Enum.REAL);
}
...
static endOnorbit_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishOnorbit_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ONOR');
}

static finishSizePrefixedOnorbit_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ONOR', true);
}

static createOnorbit_Abridged(builder:flatbuffers.Builder, idOnOrbitOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, satNo:number, commonNameOffset:flatbuffers.Offset, constellationOffset:flatbuffers.Offset, intlDesOffset:flatbuffers.Offset, launchDateOffset:flatbuffers.Offset, decayDateOffset:flatbuffers.Offset, objectType:Onorbit_Abridged_objectType_Enum, originOffset:flatbuffers.Offset, missionNumberOffset:flatbuffers.Offset, category:Onorbit_Abridged_category_Enum, lifetimeYears:number, altNameOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, dataMode:Onorbit_Abridged_dataMode_Enum, launchSiteIdOffset:flatbuffers.Offset, countryCodeOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  Onorbit_Abridged.startOnorbit_Abridged(builder);
...
unpack(): Onorbit_AbridgedT {
  return new Onorbit_AbridgedT(
    this.idOnOrbit(),
...
unpackTo(_o: Onorbit_AbridgedT): void {
...
export class Onorbit_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public objectType: Onorbit_Abridged_objectType_Enum = Onorbit_Abridged_objectType_Enum.ROCKET_BODY,
  public origin: string|Uint8Array|null = null,
  public missionNumber: string|Uint8Array|null = null,
  public category: Onorbit_Abridged_category_Enum = Onorbit_Abridged_category_Enum.UNKNOWN,
  public lifetimeYears: number = 0,
  public altName: string|Uint8Array|null = null,
  public createdAt: string|Uint8Array|null = null,
  public createdBy: string|Uint8Array|null = null,
  public source: string|Uint8Array|null = null,
  public dataMode: Onorbit_Abridged_dataMode_Enum = Onorbit_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Onorbit_Abridged.createOnorbit_Abridged(builder,
    idOnOrbit,
