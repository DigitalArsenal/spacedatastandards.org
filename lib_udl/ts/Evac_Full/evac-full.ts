...
import { Evac_Full_dataMode_Enum } from './evac-full-data-mode-enum.js';
import { Evac_Full_type_Enum } from './evac-full-type-enum.js';


/**
 * /// Casualty report and evacuation request. Used to report and request support to evacuate friendly and enemy casualties.
 */
export class Evac_Full implements flatbuffers.IUnpackableObject<Evac_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Evac_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEvac_Full(bb:flatbuffers.ByteBuffer, obj?:Evac_Full):Evac_Full {
  return (obj || new Evac_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEvac_Full(bb:flatbuffers.ByteBuffer, obj?:Evac_Full):Evac_Full {
 ...
 */
type():Evac_Full_type_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 10);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Evac_Full_type_Enum.REQUEST;
}
 ...
 */
dataMode():Evac_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 84);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Evac_Full_dataMode_Enum.REAL;
}

static startEvac_Full(builder:flatbuffers.Builder) {
...
static addType(builder:flatbuffers.Builder, type:Evac_Full_type_Enum) {
  builder.addFieldInt8(3, type, Evac_Full_type_Enum.REQUEST);
}
...
static addRelatedDocs(builder:flatbuffers.Builder, relatedDocsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(34, relatedDocsOffset, 0);
}
...
static addSource(builder:flatbuffers.Builder, sourceOffset:flatbuffers.Offset) {
  builder.addFieldOffset(38, sourceOffset, 0);
}

static addOrigin(builder:flatbuffers.Builder, originOffset:flatbuffers.Offset) {
  builder.addFieldOffset(39, originOffset, 0);
}

static addDataMode(builder:flatbuffers.Builder, dataMode:Evac_Full_dataMode_Enum) {
  builder.addFieldInt8(40, dataMode, Evac_Full_dataMode_Enum.REAL);
}

static endEvac_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEvac_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC');
}

static finishSizePrefixedEvac_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC', true);
}

static createEvac_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, medevacIdOffset:flatbuffers.Offset, type:Evac_Full_type_Enum, missionTypeOffset:flatbuffers.Offset, idWeatherReportOffset:flatbuffers.Offset, numKia:number, numWia:number, numLitter:number, numAmbulatory:number, medicReq:boolean, reqNumOffset:flatbuffers.Offset, reqTimeOffset:flatbuffers.Offset, reqCallSignOffset:flatbuffers.Offset, pickupTimeOffset:flatbuffers.Offset, pickupLat:number, pickupLon:number, pickupAlt:number, ce:number, le:number, terrainOffset:flatbuffers.Offset, obstaclesRemarksOffset:flatbuffers.Offset, terrainRemarksOffset:flatbuffers.Offset, zoneNameOffset:flatbuffers.Offset, zoneMarkingOffset:flatbuffers.Offset, zoneSecurityOffset:flatbuffers.Offset, zoneMarkingColorOffset:flatbuffers.Offset, zoneHot:boolean, cntctFreq:number, zoneContrCallSignOffset:flatbuffers.Offset, numCasualties:number, commentsOffset:flatbuffers.Offset, casualtyInfoOffset:flatbuffers.Offset, enemyDataOffset:flatbuffers.Offset, relatedDocsOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:Evac_Full_dataMode_Enum):flatbuffers.Offset {
  Evac_Full.startEvac_Full(builder);
...
unpack(): Evac_FullT {
  return new Evac_FullT(
    ...
    this.numCasualties(),
    this.comments(),
    this.bb!.createScalarList<string>(this.casualtyInfo.bind(this), this.casualtyInfo_Length()),
...
unpackTo(_o: Evac_FullT): void {
  ...
  _o.casualtyInfo = this.bb!.createScalarList<string>(this.casualtyInfo.bind(this), this.casualtyInfo_Length());
...
export class Evac_FullT implements flatbuffers.IGeneratedObject {
constructor(
  public id: string|Uint8Array|null = null,
  public classificationMarking: string|Uint8Array|null = null,
  public medevacId: string|Uint8Array|null = null,
  public type: Evac_Full_type_Enum = Evac_Full_type_Enum.REQUEST,
  ...
  public dataMode: Evac_Full_dataMode_Enum = Evac_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const casualtyInfo = Evac_Full.createCasualtyInfoVector(builder, builder.createObjectOffsetList(this.casualtyInfo));
  const enemyData = Evac_Full.createEnemyDataVector(builder, builder.createObjectOffsetList(this.enemyData));
  const relatedDocs = Evac_Full.createRelatedDocsVector(builder, builder.createObjectOffsetList(this.relatedDocs));
  ...
  return Evac_Full.createEvac_Full(builder,
    id,
