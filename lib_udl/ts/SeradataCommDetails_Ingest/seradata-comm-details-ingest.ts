...
import { SeradataCommDetails_Ingest_dataMode_Enum } from './seradata-comm-details-ingest-data-mode-enum.js';


/**
 * /// Seradata-compiled information on communications payloads.
 */
export class SeradataCommDetails_Ingest implements flatbuffers.IUnpackableObject<SeradataCommDetails_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SeradataCommDetails_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSeradataCommDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:SeradataCommDetails_Ingest):SeradataCommDetails_Ingest {
  return (obj || new SeradataCommDetails_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSeradataCommDetails_Ingest(bb:flatbuffers.ByteBuffer, obj?:SeradataCommDetails_Ingest):SeradataCommDetails_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SeradataCommDetails_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 72);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SeradataCommDetails_Ingest_dataMode_Enum.REAL;
}
...
static startSeradataCommDetails_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SeradataCommDetails_Ingest_dataMode_Enum) {
  builder.addFieldInt8(34, dataMode, SeradataCommDetails_Ingest_dataMode_Enum.REAL);
}
...
static endSeradataCommDetails_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSeradataCommDetails_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA');
}

static finishSizePrefixedSeradataCommDetails_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA', true);
}

static createSeradataCommDetails_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idCommOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, spacecraftIdOffset:flatbuffers.Offset, bandOffset:flatbuffers.Offset, solidStatePowerAmp:number, travelingWaveTubeAmplifier:number, gatewayUplinkFrom:number, gatewayUplinkTo:number, gatewayDownlinkFrom:number, gatewayDownlinkTo:number, polarizationOffset:flatbuffers.Offset, eirp:number, bandwidth:number, numOperationalTransponders:number, numSpareTransponders:number, hostedForCompanyOrgIdOffset:flatbuffers.Offset, manufacturerOrgIdOffset:flatbuffers.Offset, tradeLeaseOrgIdOffset:flatbuffers.Offset, num36MhzEquivalentTransponders:number, htsNumUserSpotBeams:number, htsUserDownlinkBandwidthPerBeam:number, htsUserUplinkBandwidthPerBeam:number, estHtsTotalUserDownlinkBandwidthPerBeam:number, estHtsTotalUserUplinkBandwidthPerBeam:number, estHtsTotalCapacity:number, userDownlinkFrom:number, userDownlinkTo:number, userUplinkFrom:number, userUplinkTo:number, payloadNotesOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:SeradataCommDetails_Ingest_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset):flatbuffers.Offset {
  SeradataCommDetails_Ingest.startSeradataCommDetails_Ingest(builder);
...
unpack(): SeradataCommDetails_IngestT {
  return new SeradataCommDetails_IngestT(
    this.id(),
    this.idComm(),
...
unpackTo(_o: SeradataCommDetails_IngestT): void {
  _o.id = this.id();
...
export class SeradataCommDetails_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SeradataCommDetails_Ingest_dataMode_Enum = SeradataCommDetails_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SeradataCommDetails_Ingest.createSeradataCommDetails_Ingest(builder,
    id,
    idComm,
