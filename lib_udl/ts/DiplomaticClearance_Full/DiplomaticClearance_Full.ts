...
import { DiplomaticClearance_Full_dataMode_Enum } from './DiplomaticClearance_Full_dataMode_Enum.js';


/**
 * /// A diplomatic clearance is an authorization for an aircraft to traverse or land within a specified country.
 */
export class DiplomaticClearance_Full implements flatbuffers.IUnpackableObject<DiplomaticClearance_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):DiplomaticClearance_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsDiplomaticClearance_Full(bb:flatbuffers.ByteBuffer, obj?:DiplomaticClearance_Full):DiplomaticClearance_Full {
  return (obj || new DiplomaticClearance_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsDiplomaticClearance_Full(bb:flatbuffers.ByteBuffer, obj?:DiplomaticClearance_Full):DiplomaticClearance_Full {
 ...
 */
dataMode():DiplomaticClearance_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 40);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : DiplomaticClearance_Full_dataMode_Enum.REAL;
}

static startDiplomaticClearance_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:DiplomaticClearance_Full_dataMode_Enum) {
  builder.addFieldInt8(18, dataMode, DiplomaticClearance_Full_dataMode_Enum.REAL);
}

static endDiplomaticClearance_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishDiplomaticClearance_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DIPL');
}

static finishSizePrefixedDiplomaticClearance_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'DIPL', true);
}

static createDiplomaticClearance_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idMissionOffset:flatbuffers.Offset, externalWorksheetIdOffset:flatbuffers.Offset, dipWorksheetNameOffset:flatbuffers.Offset, firstDepDateOffset:flatbuffers.Offset, docDeadlineOffset:flatbuffers.Offset, apacsIdOffset:flatbuffers.Offset, diplomaticClearanceDetailsOffset:flatbuffers.Offset, diplomaticClearanceRemarksOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:DiplomaticClearance_Full_dataMode_Enum):flatbuffers.Offset {
  DiplomaticClearance_Full.startDiplomaticClearance_Full(builder);
...
unpack(): DiplomaticClearance_FullT {
  return new DiplomaticClearance_FullT(
    this.id(),
...
unpackTo(_o: DiplomaticClearance_FullT): void {
  _o.id = this.id();
...
export class DiplomaticClearance_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: DiplomaticClearance_Full_dataMode_Enum = DiplomaticClearance_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const diplomaticClearanceDetails = DiplomaticClearance_Full.createDiplomaticClearanceDetailsVector(builder, builder.createObjectOffsetList(this.diplomaticClearanceDetails));
  const diplomaticClearanceRemarks = DiplomaticClearance_Full.createDiplomaticClearanceRemarksVector(builder, builder.createObjectOffsetList(this.diplomaticClearanceRemarks));
  ...
  return DiplomaticClearance_Full.createDiplomaticClearance_Full(builder,
    id,
