 ...
 */
export class AircraftMissionRequirements_Full implements flatbuffers.IUnpackableObject<AircraftMissionRequirements_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AircraftMissionRequirements_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAircraftMissionRequirements_Full(bb:flatbuffers.ByteBuffer, obj?:AircraftMissionRequirements_Full):AircraftMissionRequirements_Full {
  return (obj || new AircraftMissionRequirements_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAircraftMissionRequirements_Full(bb:flatbuffers.ByteBuffer, obj?:AircraftMissionRequirements_Full):AircraftMissionRequirements_Full {
...
static startAircraftMissionRequirements_Full(builder:flatbuffers.Builder) {
...
static endAircraftMissionRequirements_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAircraftMissionRequirements_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRC');
}

static finishSizePrefixedAircraftMissionRequirements_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRC', true);
}

static createAircraftMissionRequirements_Full(builder:flatbuffers.Builder, gdssReqIdOffset:flatbuffers.Offset, onloadId:number, onloadLocodeOffset:flatbuffers.Offset, offloadId:number, offloadLocodeOffset:flatbuffers.Offset, ulnOffset:flatbuffers.Offset, transReqNumOffset:flatbuffers.Offset, projNameOffset:flatbuffers.Offset, oplanOffset:flatbuffers.Offset, numPax:number, numLitter:number, numAmbulatory:number, numAttendant:number, bulkWeight:number, oversizeWeight:number, outsizeWeight:number, eadOffset:flatbuffers.Offset, ladOffset:flatbuffers.Offset):flatbuffers.Offset {
  AircraftMissionRequirements_Full.startAircraftMissionRequirements_Full(builder);
...
unpack(): AircraftMissionRequirements_FullT {
  return new AircraftMissionRequirements_FullT(
    this.gdssReqId(),
    this.onloadId(),
    this.onloadLocode(),
    this.offloadId(),
...
unpackTo(_o: AircraftMissionRequirements_FullT): void {
...
export class AircraftMissionRequirements_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AircraftMissionRequirements_Full.createAircraftMissionRequirements_Full(builder,
    gdssReqId,
    this.onloadId,
    onloadLOCode,
    this.offloadId,
