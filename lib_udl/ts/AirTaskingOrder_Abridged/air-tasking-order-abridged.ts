...
import { AirTaskingOrder_Abridged_dataMode_Enum } from './air-tasking-order-abridged-data-mode-enum.js';
 ...
 */
export class AirTaskingOrder_Abridged implements flatbuffers.IUnpackableObject<AirTaskingOrder_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirTaskingOrder_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirTaskingOrder_Abridged(bb:flatbuffers.ByteBuffer, obj?:AirTaskingOrder_Abridged):AirTaskingOrder_Abridged {
  return (obj || new AirTaskingOrder_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirTaskingOrder_Abridged(bb:flatbuffers.ByteBuffer, obj?:AirTaskingOrder_Abridged):AirTaskingOrder_Abridged {
 ...
 */
dataMode():AirTaskingOrder_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 46);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirTaskingOrder_Abridged_dataMode_Enum.REAL;
}

static startAirTaskingOrder_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AirTaskingOrder_Abridged_dataMode_Enum) {
  builder.addFieldInt8(21, dataMode, AirTaskingOrder_Abridged_dataMode_Enum.REAL);
}

static endAirTaskingOrder_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirTaskingOrder_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRT');
}

static finishSizePrefixedAirTaskingOrder_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRT', true);
}

static createAirTaskingOrder_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, rawFileUriOffset:flatbuffers.Offset, opExerNameOffset:flatbuffers.Offset, msgOriginatorOffset:flatbuffers.Offset, msgSnOffset:flatbuffers.Offset, msgMonthOffset:flatbuffers.Offset, msgQualifierOffset:flatbuffers.Offset, ackReqIndOffset:flatbuffers.Offset, ackUnitInstructionsOffset:flatbuffers.Offset, beginTsOffset:flatbuffers.Offset, endTsOffset:flatbuffers.Offset, genTextOffset:flatbuffers.Offset, acMsnTaskingOffset:flatbuffers.Offset, navalFltOpsOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:AirTaskingOrder_Abridged_dataMode_Enum):flatbuffers.Offset {
  AirTaskingOrder_Abridged.startAirTaskingOrder_Abridged(builder);
  AirTaskingOrder_Abridged.addId(builder, idOffset);
  AirTaskingOrder_Abridged.addClassificationMarking(builder, classificationMarkingOffset);
  AirTaskingOrder_Abridged.addRawFileUri(builder, rawFileUriOffset);
  AirTaskingOrder_Abridged.addOpExerName(builder, opExerNameOffset);
  AirTaskingOrder_Abridged.addMsgOriginator(builder, msgOriginatorOffset);
  AirTaskingOrder_Abridged.addMsgSn(builder, msgSnOffset);
  AirTaskingOrder_Abridged.addMsgMonth(builder, msgMonthOffset);
  AirTaskingOrder_Abridged.addMsgQualifier(builder, msgQualifierOffset);
  AirTaskingOrder_Abridged.addAckReqInd(builder, ackReqIndOffset);
  AirTaskingOrder_Abridged.addAckUnitInstructions(builder, ackUnitInstructionsOffset);
  AirTaskingOrder_Abridged.addBeginTs(builder, beginTsOffset);
  AirTaskingOrder_Abridged.addEndTs(builder, endTsOffset);
  AirTaskingOrder_Abridged.addGenText(builder, genTextOffset);
  AirTaskingOrder_Abridged.addAcMsnTasking(builder, acMsnTaskingOffset);
  AirTaskingOrder_Abridged.addNavalFltOps(builder, navalFltOpsOffset);
  AirTaskingOrder_Abridged.addCreatedAt(builder, createdAtOffset);
  AirTaskingOrder_Abridged.addCreatedBy(builder, createdByOffset);
  AirTaskingOrder_Abridged.addSource(builder, sourceOffset);
  AirTaskingOrder_Abridged.addSourceDl(builder, sourceDlOffset);
  AirTaskingOrder_Abridged.addOrigin(builder, originOffset);
  AirTaskingOrder_Abridged.addOrigNetwork(builder, origNetworkOffset);
  AirTaskingOrder_Abridged.addDataMode(builder, dataMode);
  return AirTaskingOrder_Abridged.endAirTaskingOrder_Abridged(builder);
}

unpack(): AirTaskingOrder_AbridgedT {
  return new AirTaskingOrder_AbridgedT(
    this.id(),
    ...
    this.beginTs(),
    this.endTs(),
    this.bb!.createScalarList<string>(this.genText.bind(this), this.genText_Length()),
    this.bb!.createScalarList<string>(this.acMsnTasking.bind(this), this.acMsnTasking_Length()),
    this.bb!.createScalarList<string>(this.navalFltOps.bind(this), this.navalFltOps_Length()),
    this.createdAt(),
    this.createdBy(),
    this.source(),
    this.sourceDl(),
...
unpackTo(_o: AirTaskingOrder_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.endTs = this.endTs();
  _o.genText = this.bb!.createScalarList<string>(this.genText.bind(this), this.genText_Length());
  _o.acMsnTasking = this.bb!.createScalarList<string>(this.acMsnTasking.bind(this), this.acMsnTasking_Length());
  _o.navalFltOps = this.bb!.createScalarList<string>(this.navalFltOps.bind(this), this.navalFltOps_Length());
...
export class AirTaskingOrder_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AirTaskingOrder_Abridged_dataMode_Enum = AirTaskingOrder_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const genText = AirTaskingOrder_Abridged.createGenTextVector(builder, builder.createObjectOffsetList(this.genText));
  const acMsnTasking = AirTaskingOrder_Abridged.createAcMsnTaskingVector(builder, builder.createObjectOffsetList(this.acMsnTasking));
  const navalFltOps = AirTaskingOrder_Abridged.createNavalFltOpsVector(builder, builder.createObjectOffsetList(this.navalFltOps));
  ...
  return AirTaskingOrder_Abridged.createAirTaskingOrder_Abridged(builder,
    id,
