...
import { Channel_Abridged_dataMode_Enum } from './channel-abridged-data-mode-enum.js';


/**
 * /// Channel information on a particular transponder.
 */
export class Channel_Abridged implements flatbuffers.IUnpackableObject<Channel_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Channel_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsChannel_Abridged(bb:flatbuffers.ByteBuffer, obj?:Channel_Abridged):Channel_Abridged {
  return (obj || new Channel_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsChannel_Abridged(bb:flatbuffers.ByteBuffer, obj?:Channel_Abridged):Channel_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Channel_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 42);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Channel_Abridged_dataMode_Enum.REAL;
}
...
static startChannel_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Channel_Abridged_dataMode_Enum) {
  builder.addFieldInt8(19, dataMode, Channel_Abridged_dataMode_Enum.REAL);
}
...
static endChannel_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishChannel_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'CHAN');
}

static finishSizePrefixedChannel_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'CHAN', true);
}

static createChannel_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idTransponderOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, idBeamOffset:flatbuffers.Offset, beamNameOffset:flatbuffers.Offset, idRfbandOffset:flatbuffers.Offset, encryptionOffset:flatbuffers.Offset, pkgOffset:flatbuffers.Offset, resOffset:flatbuffers.Offset, compressionOffset:flatbuffers.Offset, vpidOffset:flatbuffers.Offset, apidOffset:flatbuffers.Offset, sidOffset:flatbuffers.Offset, ownerOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:Channel_Abridged_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset):flatbuffers.Offset {
  Channel_Abridged.startChannel_Abridged(builder);
...
unpack(): Channel_AbridgedT {
  return new Channel_AbridgedT(
    this.id(),
    this.idTransponder(),
    this.name(),
...
unpackTo(_o: Channel_AbridgedT): void {
  _o.id = this.id();
...
export class Channel_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Channel_Abridged_dataMode_Enum = Channel_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Channel_Abridged.createChannel_Abridged(builder,
    id,
    idTransponder,
    name,
