...
import { Item_Abridged_dataMode_Enum } from './Item_Abridged_dataMode_Enum.js';


/**
 * /// No description available.
 */
export class Item_Abridged implements flatbuffers.IUnpackableObject<Item_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Item_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsItem_Abridged(bb:flatbuffers.ByteBuffer, obj?:Item_Abridged):Item_Abridged {
  return (obj || new Item_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsItem_Abridged(bb:flatbuffers.ByteBuffer, obj?:Item_Abridged):Item_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Item_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 104);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Item_Abridged_dataMode_Enum.REAL;
}

static startItem_Abridged(builder:flatbuffers.Builder) {
...
unpack(): Item_AbridgedT {
  return new Item_AbridgedT(
    this.id(),
...
unpackTo(_o: Item_AbridgedT): void {
  _o.id = this.id();
...
export class Item_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Item_Abridged_dataMode_Enum = Item_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const hazCodes = Item_Abridged.createHazCodesVector(builder, builder.createObjectOffsetList(this.hazCodes));
  const itemContains = Item_Abridged.createItemContainsVector(builder, builder.createObjectOffsetList(this.itemContains));
  ...
  const keys = Item_Abridged.createKeysVector(builder, builder.createObjectOffsetList(this.keys));
  const values = Item_Abridged.createValuesVector(builder, builder.createObjectOffsetList(this.values));
  ...
  const accSysKeys = Item_Abridged.createAccSysKeysVector(builder, builder.createObjectOffsetList(this.accSysKeys));
  const accSysValues = Item_Abridged.createAccSysValuesVector(builder, builder.createObjectOffsetList(this.accSysValues));
  ...
  return Item_Abridged.createItem_Abridged(builder,
    id,
