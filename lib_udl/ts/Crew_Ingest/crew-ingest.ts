...
import { Crew_Ingest_dataMode_Enum } from './crew-ingest-data-mode-enum.js';


/**
 * /// Crew Services.
 */
export class Crew_Ingest implements flatbuffers.IUnpackableObject<Crew_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Crew_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsCrew_Ingest(bb:flatbuffers.ByteBuffer, obj?:Crew_Ingest):Crew_Ingest {
  return (obj || new Crew_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsCrew_Ingest(bb:flatbuffers.ByteBuffer, obj?:Crew_Ingest):Crew_Ingest {
...
dataMode():Crew_Ingest_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Crew_Ingest_dataMode_Enum.REAL;
}

static startCrew_Ingest(builder:flatbuffers.Builder) {
...
unpack(): Crew_IngestT {
  return new Crew_IngestT(
    ...
    this.crewType(),
    this.armsCrewUnit(),
    this.bb!.createScalarList<string>(this.crewMembers.bind(this), this.crewMembers_Length()),
    this.createdAt(),
    this.createdBy(),
    this.updatedAt(),
    this.updatedBy(),
...
unpackTo(_o: Crew_IngestT): void {
  ...
  _o.crewMembers = this.bb!.createScalarList<string>(this.crewMembers.bind(this), this.crewMembers_Length());
...
export class Crew_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Crew_Ingest_dataMode_Enum = Crew_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const crewMembers = Crew_Ingest.createCrewMembersVector(builder, builder.createObjectOffsetList(this.crewMembers));
  ...
  return Crew_Ingest.createCrew_Ingest(builder,
    id,
