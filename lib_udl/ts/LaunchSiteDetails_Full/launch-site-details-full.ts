...
import { LaunchSiteDetails_Full_dataMode_Enum } from './launch-site-details-full-data-mode-enum.js';
 ...
 */
export class LaunchSiteDetails_Full implements flatbuffers.IUnpackableObject<LaunchSiteDetails_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LaunchSiteDetails_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLaunchSiteDetails_Full(bb:flatbuffers.ByteBuffer, obj?:LaunchSiteDetails_Full):LaunchSiteDetails_Full {
  return (obj || new LaunchSiteDetails_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLaunchSiteDetails_Full(bb:flatbuffers.ByteBuffer, obj?:LaunchSiteDetails_Full):LaunchSiteDetails_Full {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():LaunchSiteDetails_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 32);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : LaunchSiteDetails_Full_dataMode_Enum.REAL;
}
...
static startLaunchSiteDetails_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:LaunchSiteDetails_Full_dataMode_Enum) {
  builder.addFieldInt8(14, dataMode, LaunchSiteDetails_Full_dataMode_Enum.REAL);
}
...
unpack(): LaunchSiteDetails_FullT {
  return new LaunchSiteDetails_FullT(
    this.id(),
    this.idLaunchSite(),
...
unpackTo(_o: LaunchSiteDetails_FullT): void {
  _o.id = this.id();
...
export class LaunchSiteDetails_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: LaunchSiteDetails_Full_dataMode_Enum = LaunchSiteDetails_Full_dataMode_Enum.REAL,
  public tags: (string)[] = [],
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const availableInclinations = LaunchSiteDetails_Full.createAvailableInclinationsVector(builder, builder.createObjectOffsetList(this.availableInclinations));
  ...
  const tags = LaunchSiteDetails_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  const location = (this.location !== null ? builder.createString(this.location!) : 0);

  return LaunchSiteDetails_Full.createLaunchSiteDetails_Full(builder,
    id,
    idLaunchSite,
