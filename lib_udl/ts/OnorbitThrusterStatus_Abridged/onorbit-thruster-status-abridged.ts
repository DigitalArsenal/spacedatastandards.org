...
import { OnorbitThrusterStatus_Abridged_dataMode_Enum } from './onorbit-thruster-status-abridged-data-mode-enum.js';


/**
 * /// Status information for OnorbitThruster objects.
 */
export class OnorbitThrusterStatus_Abridged implements flatbuffers.IUnpackableObject<OnorbitThrusterStatus_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OnorbitThrusterStatus_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOnorbitThrusterStatus_Abridged(bb:flatbuffers.ByteBuffer, obj?:OnorbitThrusterStatus_Abridged):OnorbitThrusterStatus_Abridged {
  return (obj || new OnorbitThrusterStatus_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOnorbitThrusterStatus_Abridged(bb:flatbuffers.ByteBuffer, obj?:OnorbitThrusterStatus_Abridged):OnorbitThrusterStatus_Abridged {
 ...
 */
dataMode():OnorbitThrusterStatus_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 50);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OnorbitThrusterStatus_Abridged_dataMode_Enum.REAL;
}

static startOnorbitThrusterStatus_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:OnorbitThrusterStatus_Abridged_dataMode_Enum) {
  builder.addFieldInt8(23, dataMode, OnorbitThrusterStatus_Abridged_dataMode_Enum.REAL);
}

static endOnorbitThrusterStatus_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishOnorbitThrusterStatus_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ONOR');
}

static finishSizePrefixedOnorbitThrusterStatus_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ONOR', true);
}

static createOnorbitThrusterStatus_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idOnorbitThrusterOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, statusTimeOffset:flatbuffers.Offset, propMassMin:number, propMassAvg:number, propMassMedian:number, propMassMax:number, fuelMass:number, fuelMassUnc:number, totalDeltaV:number, minDeltaV:number, estDeltaV:number, maxDeltaV:number, thrustMax:number, isp:number, operational:boolean, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:OnorbitThrusterStatus_Abridged_dataMode_Enum):flatbuffers.Offset {
  OnorbitThrusterStatus_Abridged.startOnorbitThrusterStatus_Abridged(builder);
...
unpack(): OnorbitThrusterStatus_AbridgedT {
  return new OnorbitThrusterStatus_AbridgedT(
    this.id(),
...
unpackTo(_o: OnorbitThrusterStatus_AbridgedT): void {
  _o.id = this.id();
...
export class OnorbitThrusterStatus_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: OnorbitThrusterStatus_Abridged_dataMode_Enum = OnorbitThrusterStatus_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return OnorbitThrusterStatus_Abridged.createOnorbitThrusterStatus_Abridged(builder,
    id,
