...
import { SortiePPR_Full_dataMode_Enum } from './sortie-ppr-full-data-mode-enum.js';
import { SortiePPR_Full_type_Enum } from './sortie-ppr-full-type-enum.js';
 ...
 */
export class SortiePPR_Full implements flatbuffers.IUnpackableObject<SortiePPR_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SortiePPR_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSortiePPR_Full(bb:flatbuffers.ByteBuffer, obj?:SortiePPR_Full):SortiePPR_Full {
  return (obj || new SortiePPR_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSortiePPR_Full(bb:flatbuffers.ByteBuffer, obj?:SortiePPR_Full):SortiePPR_Full {
 ...
 */
type():SortiePPR_Full_type_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 22);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SortiePPR_Full_type_Enum.M;
}
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SortiePPR_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 42);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SortiePPR_Full_dataMode_Enum.REAL;
}

static startSortiePPR_Full(builder:flatbuffers.Builder) {
...
static addType(builder:flatbuffers.Builder, type:SortiePPR_Full_type_Enum) {
  builder.addFieldInt8(9, type, SortiePPR_Full_type_Enum.M);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SortiePPR_Full_dataMode_Enum) {
  builder.addFieldInt8(19, dataMode, SortiePPR_Full_dataMode_Enum.REAL);
}

static endSortiePPR_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSortiePPR_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SORT');
}

static finishSizePrefixedSortiePPR_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SORT', true);
}

static createSortiePPR_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idSortieOffset:flatbuffers.Offset, externalIdOffset:flatbuffers.Offset, numberOffset:flatbuffers.Offset, startTimeOffset:flatbuffers.Offset, endTimeOffset:flatbuffers.Offset, requestorOffset:flatbuffers.Offset, grantorOffset:flatbuffers.Offset, type:SortiePPR_Full_type_Enum, remarksOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:SortiePPR_Full_dataMode_Enum):flatbuffers.Offset {
  SortiePPR_Full.startSortiePPR_Full(builder);
...
unpack(): SortiePPR_FullT {
  return new SortiePPR_FullT(
    this.id(),
...
unpackTo(_o: SortiePPR_FullT): void {
  _o.id = this.id();
...
export class SortiePPR_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public type: SortiePPR_Full_type_Enum = SortiePPR_Full_type_Enum.M,
  ...
  public dataMode: SortiePPR_Full_dataMode_Enum = SortiePPR_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SortiePPR_Full.createSortiePPR_Full(builder,
    id,
