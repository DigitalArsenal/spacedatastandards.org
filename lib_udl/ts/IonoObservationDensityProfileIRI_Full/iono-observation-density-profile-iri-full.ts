 ...
 */
export class IonoObservationDensityProfileIRI_Full implements flatbuffers.IUnpackableObject<IonoObservationDensityProfileIRI_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):IonoObservationDensityProfileIRI_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsIonoObservationDensityProfileIRI_Full(bb:flatbuffers.ByteBuffer, obj?:IonoObservationDensityProfileIRI_Full):IonoObservationDensityProfileIRI_Full {
  return (obj || new IonoObservationDensityProfileIRI_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIonoObservationDensityProfileIRI_Full(bb:flatbuffers.ByteBuffer, obj?:IonoObservationDensityProfileIRI_Full):IonoObservationDensityProfileIRI_Full {
...
static startIonoObservationDensityProfileIRI_Full(builder:flatbuffers.Builder) {
...
static endIonoObservationDensityProfileIRI_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishIonoObservationDensityProfileIRI_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO');
}

static finishSizePrefixedIonoObservationDensityProfileIRI_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO', true);
}

static createIonoObservationDensityProfileIRI_Full(builder:flatbuffers.Builder, descriptionOffset:flatbuffers.Offset, nmF2:number, hmF2:number, b0:number, b1:number, nmF1:number, hmF1:number, d1:number, hz:number, hValTop:number, nValB:number, nmE:number, hmE:number, hdx:number, nmD:number, hmD:number, ha:number, fp1:number, fp2:number, fp30:number, fp3U:number, chi:number):flatbuffers.Offset {
  IonoObservationDensityProfileIRI_Full.startIonoObservationDensityProfileIRI_Full(builder);
...
unpack(): IonoObservationDensityProfileIRI_FullT {
  return new IonoObservationDensityProfileIRI_FullT(
    this.description(),
    this.nmF2(),
    this.hmF2(),
    this.b0(),
...
unpackTo(_o: IonoObservationDensityProfileIRI_FullT): void {
...
export class IonoObservationDensityProfileIRI_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return IonoObservationDensityProfileIRI_Full.createIonoObservationDensityProfileIRI_Full(builder,
    description,
    this.nmF2,
    this.hmF2,
    this.b0,
