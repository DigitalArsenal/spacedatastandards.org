 ...
 */
export class IonoObservationCharAtts_Full implements flatbuffers.IUnpackableObject<IonoObservationCharAtts_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):IonoObservationCharAtts_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsIonoObservationCharAtts_Full(bb:flatbuffers.ByteBuffer, obj?:IonoObservationCharAtts_Full):IonoObservationCharAtts_Full {
  return (obj || new IonoObservationCharAtts_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIonoObservationCharAtts_Full(bb:flatbuffers.ByteBuffer, obj?:IonoObservationCharAtts_Full):IonoObservationCharAtts_Full {
...
static startIonoObservationCharAtts_Full(builder:flatbuffers.Builder) {
...
static endIonoObservationCharAtts_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishIonoObservationCharAtts_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO');
}

static finishSizePrefixedIonoObservationCharAtts_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO', true);
}

static createIonoObservationCharAtts_Full(builder:flatbuffers.Builder, ursiIdOffset:flatbuffers.Offset, charNameOffset:flatbuffers.Offset, lowerBound:number, upperBound:number, qOffset:flatbuffers.Offset, dOffset:flatbuffers.Offset, climateModelNameOffset:flatbuffers.Offset, climateModelOptionsOffset:flatbuffers.Offset, climateModelInputParamsOffset:flatbuffers.Offset, uncertaintyBoundTypeOffset:flatbuffers.Offset):flatbuffers.Offset {
  IonoObservationCharAtts_Full.startIonoObservationCharAtts_Full(builder);
...
unpack(): IonoObservationCharAtts_FullT {
  return new IonoObservationCharAtts_FullT(
    this.ursiId(),
    this.charName(),
    this.lowerBound(),
    this.upperBound(),
...
unpackTo(_o: IonoObservationCharAtts_FullT): void {
...
export class IonoObservationCharAtts_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const climateModelOptions = IonoObservationCharAtts_Full.createClimateModelOptionsVector(builder, builder.createObjectOffsetList(this.climateModelOptions));
  const climateModelInputParams = IonoObservationCharAtts_Full.createClimateModelInputParamsVector(builder, builder.createObjectOffsetList(this.climateModelInputParams));
  const uncertaintyBoundType = (this.uncertaintyBoundType !== null ? builder.createString(this.uncertaintyBoundType!) : 0);

  return IonoObservationCharAtts_Full.createIonoObservationCharAtts_Full(builder,
    ursiId,
    charName,
    this.lowerBound,
    this.upperBound,
