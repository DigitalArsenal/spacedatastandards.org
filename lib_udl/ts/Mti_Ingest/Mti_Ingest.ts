...
import { Mti_Ingest_dataMode_Enum } from './Mti_Ingest_dataMode_Enum.js';


/**
 * /// Information on the mission and flight plans, the type and configuration of the platform, and the reference time.
 */
export class Mti_Ingest implements flatbuffers.IUnpackableObject<Mti_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Mti_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMti_Ingest(bb:flatbuffers.ByteBuffer, obj?:Mti_Ingest):Mti_Ingest {
  return (obj || new Mti_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMti_Ingest(bb:flatbuffers.ByteBuffer, obj?:Mti_Ingest):Mti_Ingest {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new Mti_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static bufferHasIdentifier(bb:flatbuffers.ByteBuffer):boolean {
  return bb.__has_identifier('MTII');
}
 ...
 */
dataMode():Mti_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 12);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Mti_Ingest_dataMode_Enum.REAL;
}
...
static startMti_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Mti_Ingest_dataMode_Enum) {
  builder.addFieldInt8(4, dataMode, Mti_Ingest_dataMode_Enum.REAL);
}
...
static endMti_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishMti_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTII');
}

static finishSizePrefixedMti_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'MTII', true);
}

static createMti_Ingest(builder:flatbuffers.Builder, classificationMarkingOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, idOffset:flatbuffers.Offset, dataMode:Mti_Ingest_dataMode_Enum, createdByOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, p3Offset:flatbuffers.Offset, p6Offset:flatbuffers.Offset, p7Offset:flatbuffers.Offset, p8Offset:flatbuffers.Offset, p9:number, p10:number, missionsOffset:flatbuffers.Offset, dwellsOffset:flatbuffers.Offset, hrrsOffset:flatbuffers.Offset, jobDefsOffset:flatbuffers.Offset, freeTextsOffset:flatbuffers.Offset, platformLocsOffset:flatbuffers.Offset, jobRequestsOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  Mti_Ingest.startMti_Ingest(builder);
...
unpack(): Mti_IngestT {
  return new Mti_IngestT(
    ...
    this.bb!.createScalarList<string>(this.jobDefs.bind(this), this.jobDefsLength()),
    this.bb!.createScalarList<string>(this.freeTexts.bind(this), this.freeTextsLength()),
    this.bb!.createScalarList<string>(this.platformLocs.bind(this), this.platformLocsLength()),
    this.bb!.createScalarList<string>(this.jobRequests.bind(this), this.jobRequestsLength()),
    this.origNetwork()
  );
}


unpackTo(_o: Mti_IngestT): void {
  ...
  _o.jobDefs = this.bb!.createScalarList<string>(this.jobDefs.bind(this), this.jobDefsLength());
  _o.freeTexts = this.bb!.createScalarList<string>(this.freeTexts.bind(this), this.freeTextsLength());
  _o.platformLocs = this.bb!.createScalarList<string>(this.platformLocs.bind(this), this.platformLocsLength());
  _o.jobRequests = this.bb!.createScalarList<string>(this.jobRequests.bind(this), this.jobRequestsLength());
  _o.origNetwork = this.origNetwork();
}
}

export class Mti_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  public classificationMarking: string|Uint8Array|null = null,
  public source: string|Uint8Array|null = null,
  public origin: string|Uint8Array|null = null,
  public id: string|Uint8Array|null = null,
  public dataMode: Mti_Ingest_dataMode_Enum = Mti_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const missions = Mti_Ingest.createMissionsVector(builder, builder.createObjectOffsetList(this.missions));
  const dwells = Mti_Ingest.createDwellsVector(builder, builder.createObjectOffsetList(this.dwells));
  const hrrs = Mti_Ingest.createHrrsVector(builder, builder.createObjectOffsetList(this.hrrs));
  const jobDefs = Mti_Ingest.createJobDefsVector(builder, builder.createObjectOffsetList(this.jobDefs));
  const freeTexts = Mti_Ingest.createFreeTextsVector(builder, builder.createObjectOffsetList(this.freeTexts));
  const platformLocs = Mti_Ingest.createPlatformLocsVector(builder, builder.createObjectOffsetList(this.platformLocs));
  const jobRequests = Mti_Ingest.createJobRequestsVector(builder, builder.createObjectOffsetList(this.jobRequests));
  const origNetwork = (this.origNetwork !== null ? builder.createString(this.origNetwork!) : 0);

  return Mti_Ingest.createMti_Ingest(builder,
