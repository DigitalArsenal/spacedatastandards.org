 ...
 */
export class EvacHealthState_Full implements flatbuffers.IUnpackableObject<EvacHealthState_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EvacHealthState_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEvacHealthState_Full(bb:flatbuffers.ByteBuffer, obj?:EvacHealthState_Full):EvacHealthState_Full {
  return (obj || new EvacHealthState_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEvacHealthState_Full(bb:flatbuffers.ByteBuffer, obj?:EvacHealthState_Full):EvacHealthState_Full {
...
static startEvacHealthState_Full(builder:flatbuffers.Builder) {
...
static endEvacHealthState_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEvacHealthState_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC');
}

static finishSizePrefixedEvacHealthState_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC', true);
}

static createEvacHealthState_Full(builder:flatbuffers.Builder, typeOffset:flatbuffers.Offset, healthStateCodeOffset:flatbuffers.Offset, medConfFactor:number, timeOffset:flatbuffers.Offset):flatbuffers.Offset {
  EvacHealthState_Full.startEvacHealthState_Full(builder);
...
unpack(): EvacHealthState_FullT {
  return new EvacHealthState_FullT(
    this.type(),
...
unpackTo(_o: EvacHealthState_FullT): void {
  _o.type = this.type();
...
export class EvacHealthState_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return EvacHealthState_Full.createEvacHealthState_Full(builder,
    type,
    healthStateCode,
    this.medConfFactor,
    time
