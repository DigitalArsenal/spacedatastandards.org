...
import { Equipment_Full_dataMode_Enum } from './Equipment_Full_dataMode_Enum.js';
...
unpack(): Equipment_FullT {
  return new Equipment_FullT(
    ...
    this.bb!.createScalarList<string>(this.equipmentRemarks.bind(this), this.equipmentRemarksLength()),
    this.createdAt(),
    this.createdBy(),
    this.updatedAt(),
    this.updatedBy(),
...
unpackTo(_o: Equipment_FullT): void {
  ...
  _o.equipmentRemarks = this.bb!.createScalarList<string>(this.equipmentRemarks.bind(this), this.equipmentRemarksLength());
