...
import { Equipment_Full_dataMode_Enum } from './equipment-full-data-mode-enum.js';


/**
 * /// Properties and characteristics of equipment that can be associated with a site or other entity.
 */
export class Equipment_Full implements flatbuffers.IUnpackableObject<Equipment_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Equipment_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEquipment_Full(bb:flatbuffers.ByteBuffer, obj?:Equipment_Full):Equipment_Full {
  return (obj || new Equipment_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEquipment_Full(bb:flatbuffers.ByteBuffer, obj?:Equipment_Full):Equipment_Full {
 ...
 * Constraints: No constraints specified.
 */
equipmentRemarks(index: number):string
equipmentRemarks(index: number,optionalEncoding:flatbuffers.Encoding):string|Uint8Array
equipmentRemarks(index: number,optionalEncoding?:any):string|Uint8Array|null {
  const offset = this.bb!.__offset(this.bb_pos, 100);
  return offset ? this.bb!.__string(this.bb!.__vector(this.bb_pos + offset) + index * 4, optionalEncoding) : null;
}

equipmentRemarksLength():number {
  const offset = this.bb!.__offset(this.bb_pos, 100);
  return offset ? this.bb!.__vector_len(this.bb_pos + offset) : 0;
}
 ...
 */
dataMode():Equipment_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 114);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Equipment_Full_dataMode_Enum.REAL;
}

static startEquipment_Full(builder:flatbuffers.Builder) {
...
static addEquipmentRemarks(builder:flatbuffers.Builder, equipmentRemarksOffset:flatbuffers.Offset) {
  builder.addFieldOffset(48, equipmentRemarksOffset, 0);
}

static createEquipmentRemarksVector(builder:flatbuffers.Builder, data:flatbuffers.Offset[]):flatbuffers.Offset {
  builder.startVector(4, data.length, 4);
  for (let i = data.length - 1; i >= 0; i--) {
    builder.addOffset(data[i]!);
  }
...
static startEquipmentRemarksVector(builder:flatbuffers.Builder, numElems:number) {
  builder.startVector(4, numElems, 4);
}

static addCreatedAt(builder:flatbuffers.Builder, createdAtOffset:flatbuffers.Offset) {
  builder.addFieldOffset(49, createdAtOffset, 0);
}

static addCreatedBy(builder:flatbuffers.Builder, createdByOffset:flatbuffers.Offset) {
  builder.addFieldOffset(50, createdByOffset, 0);
}

static addUpdatedAt(builder:flatbuffers.Builder, updatedAtOffset:flatbuffers.Offset) {
  builder.addFieldOffset(51, updatedAtOffset, 0);
}

static addUpdatedBy(builder:flatbuffers.Builder, updatedByOffset:flatbuffers.Offset) {
  builder.addFieldOffset(52, updatedByOffset, 0);
}
...
static createEquipment_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idParentEquipmentOffset:flatbuffers.Offset, idSiteOffset:flatbuffers.Offset, idOperatingUnitOffset:flatbuffers.Offset, altEqpIdOffset:flatbuffers.Offset, eqpCodeOffset:flatbuffers.Offset, eqpIdNumOffset:flatbuffers.Offset, countryCodeOffset:flatbuffers.Offset, altCountryCodeOffset:flatbuffers.Offset, wacOffset:flatbuffers.Offset, seqNum:number, nomenOffset:flatbuffers.Offset, operStatusOffset:flatbuffers.Offset, conditionOffset:flatbuffers.Offset, conditionAvailOffset:flatbuffers.Offset, eval:number, fpaOffset:flatbuffers.Offset, function_Offset:flatbuffers.Offset, identOffset:flatbuffers.Offset, allegianceOffset:flatbuffers.Offset, altAllegianceOffset:flatbuffers.Offset, locReasonOffset:flatbuffers.Offset, operAreaPrimaryOffset:flatbuffers.Offset, functPrimaryOffset:flatbuffers.Offset, coordDatumOffset:flatbuffers.Offset, coordOffset:flatbuffers.Offset, coordDerivAcc:number, lat:number, lon:number, elevMsl:number, elevMslConfLvl:number, elevMslDerivAcc:number, geoidalMslSep:number, milGridSysOffset:flatbuffers.Offset, milGridOffset:flatbuffers.Offset, utmOffset:flatbuffers.Offset, airDefAreaOffset:flatbuffers.Offset, polSubdivOffset:flatbuffers.Offset, qtyOh:number, symCodeOffset:flatbuffers.Offset, classRatingOffset:flatbuffers.Offset, recStatusOffset:flatbuffers.Offset, reviewDateOffset:flatbuffers.Offset, resProdOffset:flatbuffers.Offset, referenceDocOffset:flatbuffers.Offset, srcTypsOffset:flatbuffers.Offset, srcIdsOffset:flatbuffers.Offset, equipmentRemarksOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:Equipment_Full_dataMode_Enum):flatbuffers.Offset {
  ...
  Equipment_Full.addFunction(builder, function_Offset);
...
unpack(): Equipment_FullT {
  return new Equipment_FullT(
    this.id(),
    ...
    this.bb!.createScalarList<string>(this.equipmentRemarks.bind(this), this.equipmentRemarks_Length()),
    this.createdAt(),
    this.createdBy(),
    this.updatedAt(),
    this.updatedBy(),
...
unpackTo(_o: Equipment_FullT): void {
  _o.id = this.id();
  ...
  _o.equipmentRemarks = this.bb!.createScalarList<string>(this.equipmentRemarks.bind(this), this.equipmentRemarks_Length());
...
export class Equipment_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Equipment_Full_dataMode_Enum = Equipment_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const srcTyps = Equipment_Full.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = Equipment_Full.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  const equipmentRemarks = Equipment_Full.createEquipmentRemarksVector(builder, builder.createObjectOffsetList(this.equipmentRemarks));
  ...
  return Equipment_Full.createEquipment_Full(builder,
    id,
