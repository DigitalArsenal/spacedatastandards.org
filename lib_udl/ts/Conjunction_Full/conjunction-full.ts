...
import { Conjunction_Full_dataMode_Enum } from './conjunction-full-data-mode-enum.js';


/**
 * /// Stores the results of a particular Conjunction Assessment (CA) run.
 */
export class Conjunction_Full implements flatbuffers.IUnpackableObject<Conjunction_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Conjunction_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsConjunction_Full(bb:flatbuffers.ByteBuffer, obj?:Conjunction_Full):Conjunction_Full {
  return (obj || new Conjunction_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsConjunction_Full(bb:flatbuffers.ByteBuffer, obj?:Conjunction_Full):Conjunction_Full {
...
dataMode():Conjunction_Full_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Conjunction_Full_dataMode_Enum.REAL;
}
 ...
 * Constraints: No constraints specified.
 */
onOrbit1():string|null
onOrbit1(optionalEncoding:flatbuffers.Encoding):string|Uint8Array|null
onOrbit1(optionalEncoding?:any):string|Uint8Array|null {
 ...
 * Constraints: No constraints specified.
 */
onOrbit2():string|null
onOrbit2(optionalEncoding:flatbuffers.Encoding):string|Uint8Array|null
onOrbit2(optionalEncoding?:any):string|Uint8Array|null {
...
static startConjunction_Full(builder:flatbuffers.Builder) {
...
static addTags(builder:flatbuffers.Builder, tagsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(58, tagsOffset, 0);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Conjunction_Full_dataMode_Enum) {
  builder.addFieldInt8(59, dataMode, Conjunction_Full_dataMode_Enum.REAL);
}
...
unpack(): Conjunction_FullT {
  return new Conjunction_FullT(
    this.id(),
...
unpackTo(_o: Conjunction_FullT): void {
  _o.id = this.id();
...
export class Conjunction_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public tags: (string)[] = [],
  public dataMode: Conjunction_Full_dataMode_Enum = Conjunction_Full_dataMode_Enum.REAL,
  ...
  public onOrbit1: string|Uint8Array|null = null,
  public onOrbit2: string|Uint8Array|null = null,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = Conjunction_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  const onOrbit1 = (this.onOrbit1 !== null ? builder.createString(this.onOrbit1!) : 0);
  const onOrbit2 = (this.onOrbit2 !== null ? builder.createString(this.onOrbit2!) : 0);
  ...
  return Conjunction_Full.createConjunction_Full(builder,
    id,
