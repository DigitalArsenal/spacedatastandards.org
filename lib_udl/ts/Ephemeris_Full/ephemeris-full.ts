...
import { Ephemeris_Full_dataMode_Enum } from './ephemeris-full-data-mode-enum.js';
 ...
 */
export class Ephemeris_Full implements flatbuffers.IUnpackableObject<Ephemeris_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Ephemeris_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEphemeris_Full(bb:flatbuffers.ByteBuffer, obj?:Ephemeris_Full):Ephemeris_Full {
  return (obj || new Ephemeris_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEphemeris_Full(bb:flatbuffers.ByteBuffer, obj?:Ephemeris_Full):Ephemeris_Full {
 ...
 */
dataMode():Ephemeris_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 38);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Ephemeris_Full_dataMode_Enum.REAL;
}
...
static startEphemeris_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Ephemeris_Full_dataMode_Enum) {
  builder.addFieldInt8(17, dataMode, Ephemeris_Full_dataMode_Enum.REAL);
}
...
static endEphemeris_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEphemeris_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EPHE');
}

static finishSizePrefixedEphemeris_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EPHE', true);
}

static createEphemeris_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, esIdOffset:flatbuffers.Offset, tsOffset:flatbuffers.Offset, xpos:number, ypos:number, zpos:number, xvel:number, yvel:number, zvel:number, xaccel:number, yaccel:number, zaccel:number, covOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, dataMode:Ephemeris_Full_dataMode_Enum, idOnOrbitOffset:flatbuffers.Offset, origObjectIdOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset):flatbuffers.Offset {
  Ephemeris_Full.startEphemeris_Full(builder);
...
unpack(): Ephemeris_FullT {
  return new Ephemeris_FullT(
    this.id(),
...
unpackTo(_o: Ephemeris_FullT): void {
  _o.id = this.id();
...
export class Ephemeris_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Ephemeris_Full_dataMode_Enum = Ephemeris_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const cov = Ephemeris_Full.createCovVector(builder, builder.createObjectOffsetList(this.cov));
  ...
  return Ephemeris_Full.createEphemeris_Full(builder,
    id,
