 ...
 */
export class FlightPlanAirRefuelEvents_Ingest implements flatbuffers.IUnpackableObject<FlightPlanAirRefuelEvents_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):FlightPlanAirRefuelEvents_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsFlightPlanAirRefuelEvents_Ingest(bb:flatbuffers.ByteBuffer, obj?:FlightPlanAirRefuelEvents_Ingest):FlightPlanAirRefuelEvents_Ingest {
  return (obj || new FlightPlanAirRefuelEvents_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsFlightPlanAirRefuelEvents_Ingest(bb:flatbuffers.ByteBuffer, obj?:FlightPlanAirRefuelEvents_Ingest):FlightPlanAirRefuelEvents_Ingest {
...
static startFlightPlanAirRefuelEvents_Ingest(builder:flatbuffers.Builder) {
...
static endFlightPlanAirRefuelEvents_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishFlightPlanAirRefuelEvents_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'FLIG');
}

static finishSizePrefixedFlightPlanAirRefuelEvents_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'FLIG', true);
}

static createFlightPlanAirRefuelEvents_Ingest(builder:flatbuffers.Builder, arDegrade:number, arNum:number, arExchangedFuel:number, divertFuel:number, exitFuel:number):flatbuffers.Offset {
  FlightPlanAirRefuelEvents_Ingest.startFlightPlanAirRefuelEvents_Ingest(builder);
...
unpack(): FlightPlanAirRefuelEvents_IngestT {
  return new FlightPlanAirRefuelEvents_IngestT(
    this.arDegrade(),
    this.arNum(),
...
unpackTo(_o: FlightPlanAirRefuelEvents_IngestT): void {
...
export class FlightPlanAirRefuelEvents_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return FlightPlanAirRefuelEvents_Ingest.createFlightPlanAirRefuelEvents_Ingest(builder,
    this.arDegrade,
    this.arNum,
    this.arExchangedFuel,
    this.divertFuel,
