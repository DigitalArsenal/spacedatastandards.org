...
import { SeradataRadarPayload_Ingest_dataMode_Enum } from './seradata-radar-payload-ingest-data-mode-enum.js';


/**
 * /// Details for an radar payload from  Seradata.
 */
export class SeradataRadarPayload_Ingest implements flatbuffers.IUnpackableObject<SeradataRadarPayload_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SeradataRadarPayload_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSeradataRadarPayload_Ingest(bb:flatbuffers.ByteBuffer, obj?:SeradataRadarPayload_Ingest):SeradataRadarPayload_Ingest {
  return (obj || new SeradataRadarPayload_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSeradataRadarPayload_Ingest(bb:flatbuffers.ByteBuffer, obj?:SeradataRadarPayload_Ingest):SeradataRadarPayload_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SeradataRadarPayload_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 66);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SeradataRadarPayload_Ingest_dataMode_Enum.REAL;
}

static startSeradataRadarPayload_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SeradataRadarPayload_Ingest_dataMode_Enum) {
  builder.addFieldInt8(31, dataMode, SeradataRadarPayload_Ingest_dataMode_Enum.REAL);
}

static endSeradataRadarPayload_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSeradataRadarPayload_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA');
}

static finishSizePrefixedSeradataRadarPayload_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA', true);
}

static createSeradataRadarPayload_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, spacecraftIdOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, hostedForCompanyOrgIdOffset:flatbuffers.Offset, manufacturerOrgIdOffset:flatbuffers.Offset, categoryOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, frequencyBandOffset:flatbuffers.Offset, frequency:number, waveLength:number, bestResolution:number, swathWidth:number, recorderSizeOffset:flatbuffers.Offset, fieldOfView:number, fieldOfRegard:number, pointingMethodOffset:flatbuffers.Offset, groundStationsOffset:flatbuffers.Offset, groundStationLocationsOffset:flatbuffers.Offset, transmitPolarizationOffset:flatbuffers.Offset, receivePolarizationOffset:flatbuffers.Offset, dutyCycleOffset:flatbuffers.Offset, partnerSpacecraftOffset:flatbuffers.Offset, constellationInterferometricCapabilityOffset:flatbuffers.Offset, notesOffset:flatbuffers.Offset, bandwidth:number, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:SeradataRadarPayload_Ingest_dataMode_Enum):flatbuffers.Offset {
  SeradataRadarPayload_Ingest.startSeradataRadarPayload_Ingest(builder);
  SeradataRadarPayload_Ingest.addId(builder, idOffset);
  SeradataRadarPayload_Ingest.addClassificationMarking(builder, classificationMarkingOffset);
  SeradataRadarPayload_Ingest.addSpacecraftId(builder, spacecraftIdOffset);
  SeradataRadarPayload_Ingest.addIdSensor(builder, idSensorOffset);
  SeradataRadarPayload_Ingest.addHostedForCompanyOrgId(builder, hostedForCompanyOrgIdOffset);
  SeradataRadarPayload_Ingest.addManufacturerOrgId(builder, manufacturerOrgIdOffset);
  SeradataRadarPayload_Ingest.addCategory(builder, categoryOffset);
  SeradataRadarPayload_Ingest.addName(builder, nameOffset);
  SeradataRadarPayload_Ingest.addFrequencyBand(builder, frequencyBandOffset);
  SeradataRadarPayload_Ingest.addFrequency(builder, frequency);
  SeradataRadarPayload_Ingest.addWaveLength(builder, waveLength);
  SeradataRadarPayload_Ingest.addBestResolution(builder, bestResolution);
  SeradataRadarPayload_Ingest.addSwathWidth(builder, swathWidth);
  SeradataRadarPayload_Ingest.addRecorderSize(builder, recorderSizeOffset);
  SeradataRadarPayload_Ingest.addFieldOfView(builder, fieldOfView);
  SeradataRadarPayload_Ingest.addFieldOfRegard(builder, fieldOfRegard);
  SeradataRadarPayload_Ingest.addPointingMethod(builder, pointingMethodOffset);
  SeradataRadarPayload_Ingest.addGroundStations(builder, groundStationsOffset);
  SeradataRadarPayload_Ingest.addGroundStationLocations(builder, groundStationLocationsOffset);
  SeradataRadarPayload_Ingest.addTransmitPolarization(builder, transmitPolarizationOffset);
  SeradataRadarPayload_Ingest.addReceivePolarization(builder, receivePolarizationOffset);
  SeradataRadarPayload_Ingest.addDutyCycle(builder, dutyCycleOffset);
  SeradataRadarPayload_Ingest.addPartnerSpacecraft(builder, partnerSpacecraftOffset);
  SeradataRadarPayload_Ingest.addConstellationInterferometricCapability(builder, constellationInterferometricCapabilityOffset);
  SeradataRadarPayload_Ingest.addNotes(builder, notesOffset);
  SeradataRadarPayload_Ingest.addBandwidth(builder, bandwidth);
  SeradataRadarPayload_Ingest.addCreatedAt(builder, createdAtOffset);
  SeradataRadarPayload_Ingest.addCreatedBy(builder, createdByOffset);
  SeradataRadarPayload_Ingest.addSource(builder, sourceOffset);
  SeradataRadarPayload_Ingest.addOrigin(builder, originOffset);
  SeradataRadarPayload_Ingest.addOrigNetwork(builder, origNetworkOffset);
  SeradataRadarPayload_Ingest.addDataMode(builder, dataMode);
  return SeradataRadarPayload_Ingest.endSeradataRadarPayload_Ingest(builder);
}

unpack(): SeradataRadarPayload_IngestT {
  return new SeradataRadarPayload_IngestT(
    this.id(),
...
unpackTo(_o: SeradataRadarPayload_IngestT): void {
  _o.id = this.id();
...
export class SeradataRadarPayload_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SeradataRadarPayload_Ingest_dataMode_Enum = SeradataRadarPayload_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SeradataRadarPayload_Ingest.createSeradataRadarPayload_Ingest(builder,
    id,
