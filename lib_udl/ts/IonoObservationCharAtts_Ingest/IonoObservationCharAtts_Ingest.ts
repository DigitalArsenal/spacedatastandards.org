 ...
 */
export class IonoObservationCharAtts_Ingest implements flatbuffers.IUnpackableObject<IonoObservationCharAtts_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):IonoObservationCharAtts_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsIonoObservationCharAtts_Ingest(bb:flatbuffers.ByteBuffer, obj?:IonoObservationCharAtts_Ingest):IonoObservationCharAtts_Ingest {
  return (obj || new IonoObservationCharAtts_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsIonoObservationCharAtts_Ingest(bb:flatbuffers.ByteBuffer, obj?:IonoObservationCharAtts_Ingest):IonoObservationCharAtts_Ingest {
...
static startIonoObservationCharAtts_Ingest(builder:flatbuffers.Builder) {
...
static endIonoObservationCharAtts_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishIonoObservationCharAtts_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO');
}

static finishSizePrefixedIonoObservationCharAtts_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'IONO', true);
}

static createIonoObservationCharAtts_Ingest(builder:flatbuffers.Builder, ursiIdOffset:flatbuffers.Offset, charNameOffset:flatbuffers.Offset, lowerBound:number, upperBound:number, qOffset:flatbuffers.Offset, dOffset:flatbuffers.Offset, climateModelNameOffset:flatbuffers.Offset, climateModelOptionsOffset:flatbuffers.Offset, climateModelInputParamsOffset:flatbuffers.Offset, uncertaintyBoundTypeOffset:flatbuffers.Offset):flatbuffers.Offset {
  IonoObservationCharAtts_Ingest.startIonoObservationCharAtts_Ingest(builder);
...
unpack(): IonoObservationCharAtts_IngestT {
  return new IonoObservationCharAtts_IngestT(
    this.ursiId(),
    this.charName(),
    this.lowerBound(),
    this.upperBound(),
    ...
    this.bb!.createScalarList<string>(this.climateModelOptions.bind(this), this.climateModelOptionsLength()),
    this.bb!.createScalarList<string>(this.climateModelInputParams.bind(this), this.climateModelInputParamsLength()),
    this.uncertaintyBoundType()
  );
}


unpackTo(_o: IonoObservationCharAtts_IngestT): void {
  ...
  _o.climateModelOptions = this.bb!.createScalarList<string>(this.climateModelOptions.bind(this), this.climateModelOptionsLength());
  _o.climateModelInputParams = this.bb!.createScalarList<string>(this.climateModelInputParams.bind(this), this.climateModelInputParamsLength());
  _o.uncertaintyBoundType = this.uncertaintyBoundType();
}
}

export class IonoObservationCharAtts_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const climateModelOptions = IonoObservationCharAtts_Ingest.createClimateModelOptionsVector(builder, builder.createObjectOffsetList(this.climateModelOptions));
  const climateModelInputParams = IonoObservationCharAtts_Ingest.createClimateModelInputParamsVector(builder, builder.createObjectOffsetList(this.climateModelInputParams));
  const uncertaintyBoundType = (this.uncertaintyBoundType !== null ? builder.createString(this.uncertaintyBoundType!) : 0);

  return IonoObservationCharAtts_Ingest.createIonoObservationCharAtts_Ingest(builder,
    ursiId,
    charName,
    this.lowerBound,
    this.upperBound,
