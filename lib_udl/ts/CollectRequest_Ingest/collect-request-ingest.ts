...
import { CollectRequest_Ingest_dataMode_Enum } from './collect-request-ingest-data-mode-enum.js';
 ...
 */
export class CollectRequest_Ingest implements flatbuffers.IUnpackableObject<CollectRequest_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):CollectRequest_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsCollectRequest_Ingest(bb:flatbuffers.ByteBuffer, obj?:CollectRequest_Ingest):CollectRequest_Ingest {
  return (obj || new CollectRequest_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsCollectRequest_Ingest(bb:flatbuffers.ByteBuffer, obj?:CollectRequest_Ingest):CollectRequest_Ingest {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():CollectRequest_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 172);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : CollectRequest_Ingest_dataMode_Enum.REAL;
}
...
static startCollectRequest_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:CollectRequest_Ingest_dataMode_Enum) {
  builder.addFieldInt8(84, dataMode, CollectRequest_Ingest_dataMode_Enum.REAL);
}
...
static addTags(builder:flatbuffers.Builder, tagsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(87, tagsOffset, 0);
}
...
unpack(): CollectRequest_IngestT {
  return new CollectRequest_IngestT(
    this.id(),
...
unpackTo(_o: CollectRequest_IngestT): void {
  _o.id = this.id();
...
export class CollectRequest_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: CollectRequest_Ingest_dataMode_Enum = CollectRequest_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const tags = CollectRequest_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));

  return CollectRequest_Ingest.createCollectRequest_Ingest(builder,
    id,
