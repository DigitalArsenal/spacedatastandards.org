 ...
 */
export class EvacCasualtyInfo_Ingest implements flatbuffers.IUnpackableObject<EvacCasualtyInfo_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EvacCasualtyInfo_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEvacCasualtyInfo_Ingest(bb:flatbuffers.ByteBuffer, obj?:EvacCasualtyInfo_Ingest):EvacCasualtyInfo_Ingest {
  return (obj || new EvacCasualtyInfo_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEvacCasualtyInfo_Ingest(bb:flatbuffers.ByteBuffer, obj?:EvacCasualtyInfo_Ingest):EvacCasualtyInfo_Ingest {
...
static startEvacCasualtyInfo_Ingest(builder:flatbuffers.Builder) {
...
static endEvacCasualtyInfo_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEvacCasualtyInfo_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC');
}

static finishSizePrefixedEvacCasualtyInfo_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC', true);
}

static createEvacCasualtyInfo_Ingest(builder:flatbuffers.Builder, priorityOffset:flatbuffers.Offset, evacTypeOffset:flatbuffers.Offset, casualtyTypeOffset:flatbuffers.Offset, bodyPartOffset:flatbuffers.Offset, contamTypeOffset:flatbuffers.Offset, specMedEquipOffset:flatbuffers.Offset, casualtyKeyOffset:flatbuffers.Offset, patientStatusOffset:flatbuffers.Offset, patientIdentityOffset:flatbuffers.Offset, nationalityOffset:flatbuffers.Offset, payGradeOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, age:number, genderOffset:flatbuffers.Offset, last4SsnOffset:flatbuffers.Offset, bloodTypeOffset:flatbuffers.Offset, serviceOffset:flatbuffers.Offset, callSignOffset:flatbuffers.Offset, occSpecialityOffset:flatbuffers.Offset, burialLocationOffset:flatbuffers.Offset, collectionPointOffset:flatbuffers.Offset, careProviderUrnOffset:flatbuffers.Offset, dispositionTypeOffset:flatbuffers.Offset, dispositionOffset:flatbuffers.Offset, reportGenOffset:flatbuffers.Offset, reportTimeOffset:flatbuffers.Offset, commentsOffset:flatbuffers.Offset, etiologyOffset:flatbuffers.Offset, treatmentOffset:flatbuffers.Offset, vitalSignDataOffset:flatbuffers.Offset, healthStateOffset:flatbuffers.Offset, conditionOffset:flatbuffers.Offset, medicationOffset:flatbuffers.Offset, injuryOffset:flatbuffers.Offset, allergyOffset:flatbuffers.Offset):flatbuffers.Offset {
  EvacCasualtyInfo_Ingest.startEvacCasualtyInfo_Ingest(builder);
  EvacCasualtyInfo_Ingest.addPriority(builder, priorityOffset);
  EvacCasualtyInfo_Ingest.addEvacType(builder, evacTypeOffset);
  EvacCasualtyInfo_Ingest.addCasualtyType(builder, casualtyTypeOffset);
  EvacCasualtyInfo_Ingest.addBodyPart(builder, bodyPartOffset);
  EvacCasualtyInfo_Ingest.addContamType(builder, contamTypeOffset);
  EvacCasualtyInfo_Ingest.addSpecMedEquip(builder, specMedEquipOffset);
  EvacCasualtyInfo_Ingest.addCasualtyKey(builder, casualtyKeyOffset);
  EvacCasualtyInfo_Ingest.addPatientStatus(builder, patientStatusOffset);
  EvacCasualtyInfo_Ingest.addPatientIdentity(builder, patientIdentityOffset);
  EvacCasualtyInfo_Ingest.addNationality(builder, nationalityOffset);
  EvacCasualtyInfo_Ingest.addPayGrade(builder, payGradeOffset);
  EvacCasualtyInfo_Ingest.addName(builder, nameOffset);
  EvacCasualtyInfo_Ingest.addAge(builder, age);
  EvacCasualtyInfo_Ingest.addGender(builder, genderOffset);
  EvacCasualtyInfo_Ingest.addLast4Ssn(builder, last4SsnOffset);
  EvacCasualtyInfo_Ingest.addBloodType(builder, bloodTypeOffset);
  EvacCasualtyInfo_Ingest.addService(builder, serviceOffset);
  EvacCasualtyInfo_Ingest.addCallSign(builder, callSignOffset);
  EvacCasualtyInfo_Ingest.addOccSpeciality(builder, occSpecialityOffset);
  EvacCasualtyInfo_Ingest.addBurialLocation(builder, burialLocationOffset);
  EvacCasualtyInfo_Ingest.addCollectionPoint(builder, collectionPointOffset);
  EvacCasualtyInfo_Ingest.addCareProviderUrn(builder, careProviderUrnOffset);
  EvacCasualtyInfo_Ingest.addDispositionType(builder, dispositionTypeOffset);
  EvacCasualtyInfo_Ingest.addDisposition(builder, dispositionOffset);
  EvacCasualtyInfo_Ingest.addReportGen(builder, reportGenOffset);
  EvacCasualtyInfo_Ingest.addReportTime(builder, reportTimeOffset);
  EvacCasualtyInfo_Ingest.addComments(builder, commentsOffset);
  EvacCasualtyInfo_Ingest.addEtiology(builder, etiologyOffset);
  EvacCasualtyInfo_Ingest.addTreatment(builder, treatmentOffset);
  EvacCasualtyInfo_Ingest.addVitalSignData(builder, vitalSignDataOffset);
  EvacCasualtyInfo_Ingest.addHealthState(builder, healthStateOffset);
  EvacCasualtyInfo_Ingest.addCondition(builder, conditionOffset);
  EvacCasualtyInfo_Ingest.addMedication(builder, medicationOffset);
  EvacCasualtyInfo_Ingest.addInjury(builder, injuryOffset);
  EvacCasualtyInfo_Ingest.addAllergy(builder, allergyOffset);
  return EvacCasualtyInfo_Ingest.endEvacCasualtyInfo_Ingest(builder);
}

unpack(): EvacCasualtyInfo_IngestT {
  return new EvacCasualtyInfo_IngestT(
    this.priority(),
    this.evacType(),
    this.casualtyType(),
    this.bodyPart(),
    this.contamType(),
    this.bb!.createScalarList<string>(this.specMedEquip.bind(this), this.specMedEquip_Length()),
    this.casualtyKey(),
    this.patientStatus(),
    ...
    this.callSign(),
    this.occSpeciality(),
    this.bb!.createScalarList<string>(this.burialLocation.bind(this), this.burialLocation_Length()),
    this.bb!.createScalarList<string>(this.collectionPoint.bind(this), this.collectionPoint_Length()),
    ...
    this.reportTime(),
    this.comments(),
    this.bb!.createScalarList<string>(this.etiology.bind(this), this.etiology_Length()),
    this.bb!.createScalarList<string>(this.treatment.bind(this), this.treatment_Length()),
    this.bb!.createScalarList<string>(this.vitalSignData.bind(this), this.vitalSignData_Length()),
    this.bb!.createScalarList<string>(this.healthState.bind(this), this.healthState_Length()),
    this.bb!.createScalarList<string>(this.condition.bind(this), this.condition_Length()),
    this.bb!.createScalarList<string>(this.medication.bind(this), this.medication_Length()),
    this.bb!.createScalarList<string>(this.injury.bind(this), this.injury_Length()),
    this.bb!.createScalarList<string>(this.allergy.bind(this), this.allergy_Length())
  );
}


unpackTo(_o: EvacCasualtyInfo_IngestT): void {
  _o.priority = this.priority();
  _o.evacType = this.evacType();
  _o.casualtyType = this.casualtyType();
  _o.bodyPart = this.bodyPart();
  _o.contamType = this.contamType();
  _o.specMedEquip = this.bb!.createScalarList<string>(this.specMedEquip.bind(this), this.specMedEquip_Length());
  ...
  _o.burialLocation = this.bb!.createScalarList<string>(this.burialLocation.bind(this), this.burialLocation_Length());
  _o.collectionPoint = this.bb!.createScalarList<string>(this.collectionPoint.bind(this), this.collectionPoint_Length());
  ...
  _o.etiology = this.bb!.createScalarList<string>(this.etiology.bind(this), this.etiology_Length());
  _o.treatment = this.bb!.createScalarList<string>(this.treatment.bind(this), this.treatment_Length());
  _o.vitalSignData = this.bb!.createScalarList<string>(this.vitalSignData.bind(this), this.vitalSignData_Length());
  _o.healthState = this.bb!.createScalarList<string>(this.healthState.bind(this), this.healthState_Length());
  _o.condition = this.bb!.createScalarList<string>(this.condition.bind(this), this.condition_Length());
  _o.medication = this.bb!.createScalarList<string>(this.medication.bind(this), this.medication_Length());
  _o.injury = this.bb!.createScalarList<string>(this.injury.bind(this), this.injury_Length());
  _o.allergy = this.bb!.createScalarList<string>(this.allergy.bind(this), this.allergy_Length());
}
}

export class EvacCasualtyInfo_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const specMedEquip = EvacCasualtyInfo_Ingest.createSpecMedEquipVector(builder, builder.createObjectOffsetList(this.specMedEquip));
  ...
  const burialLocation = EvacCasualtyInfo_Ingest.createBurialLocationVector(builder, builder.createObjectOffsetList(this.burialLocation));
  const collectionPoint = EvacCasualtyInfo_Ingest.createCollectionPointVector(builder, builder.createObjectOffsetList(this.collectionPoint));
  ...
  const etiology = EvacCasualtyInfo_Ingest.createEtiologyVector(builder, builder.createObjectOffsetList(this.etiology));
  const treatment = EvacCasualtyInfo_Ingest.createTreatmentVector(builder, builder.createObjectOffsetList(this.treatment));
  const vitalSignData = EvacCasualtyInfo_Ingest.createVitalSignDataVector(builder, builder.createObjectOffsetList(this.vitalSignData));
  const healthState = EvacCasualtyInfo_Ingest.createHealthStateVector(builder, builder.createObjectOffsetList(this.healthState));
  const condition = EvacCasualtyInfo_Ingest.createConditionVector(builder, builder.createObjectOffsetList(this.condition));
  const medication = EvacCasualtyInfo_Ingest.createMedicationVector(builder, builder.createObjectOffsetList(this.medication));
  const injury = EvacCasualtyInfo_Ingest.createInjuryVector(builder, builder.createObjectOffsetList(this.injury));
  const allergy = EvacCasualtyInfo_Ingest.createAllergyVector(builder, builder.createObjectOffsetList(this.allergy));

  return EvacCasualtyInfo_Ingest.createEvacCasualtyInfo_Ingest(builder,
    priority,
    evacType,
    casualtyType,
    bodyPart,
