...
import { SARObservation_Abridged_dataMode_Enum } from './sarobservation-abridged-data-mode-enum.js';
 ...
 */
export class SARObservation_Abridged implements flatbuffers.IUnpackableObject<SARObservation_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SARObservation_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSARObservation_Abridged(bb:flatbuffers.ByteBuffer, obj?:SARObservation_Abridged):SARObservation_Abridged {
  return (obj || new SARObservation_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSARObservation_Abridged(bb:flatbuffers.ByteBuffer, obj?:SARObservation_Abridged):SARObservation_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SARObservation_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 136);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SARObservation_Abridged_dataMode_Enum.REAL;
}

static startSARObservation_Abridged(builder:flatbuffers.Builder) {
...
static addSrcTyps(builder:flatbuffers.Builder, srcTypsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(58, srcTypsOffset, 0);
}
...
static addSrcIds(builder:flatbuffers.Builder, srcIdsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(59, srcIdsOffset, 0);
}
...
static addSourceDl(builder:flatbuffers.Builder, sourceDlOffset:flatbuffers.Offset) {
  builder.addFieldOffset(65, sourceDlOffset, 0);
}

static addDataMode(builder:flatbuffers.Builder, dataMode:SARObservation_Abridged_dataMode_Enum) {
  builder.addFieldInt8(66, dataMode, SARObservation_Abridged_dataMode_Enum.REAL);
}

static endSARObservation_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSARObservation_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SARO');
}

static finishSizePrefixedSARObservation_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SARO', true);
}

static createSARObservation_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, satNo:number, origObjectIdOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, origSensorIdOffset:flatbuffers.Offset, externalIdOffset:flatbuffers.Offset, collectionIdOffset:flatbuffers.Offset, detectionIdOffset:flatbuffers.Offset, collectionStartOffset:flatbuffers.Offset, collectionEndOffset:flatbuffers.Offset, centerTimeOffset:flatbuffers.Offset, detectionStartOffset:flatbuffers.Offset, detectionEndOffset:flatbuffers.Offset, dwellTime:number, orbitStateOffset:flatbuffers.Offset, sarModeOffset:flatbuffers.Offset, operatingBandOffset:flatbuffers.Offset, operatingFreq:number, snr:number, txPolarizationOffset:flatbuffers.Offset, rxPolarizationOffset:flatbuffers.Offset, grazeAngle:number, incidenceAngle:number, squintAngle:number, pulseBandwidth:number, pulseDuration:number, continuousSpotAngle:number, slantRange:number, nearRange:number, farRange:number, swathLength:number, atextOffset:flatbuffers.Offset, agjsonOffset:flatbuffers.Offset, atypeOffset:flatbuffers.Offset, andims:number, asrid:number, spacingRange:number, spacingAzimuth:number, looksAzimuth:number, looksRange:number, resolutionRange:number, resolutionAzimuth:number, obDirectionOffset:flatbuffers.Offset, coordSysOffset:flatbuffers.Offset, targetposx:number, targetposy:number, targetposz:number, senalt:number, senvelx:number, senvely:number, senvelz:number, senlatStart:number, senlonStart:number, senlatEnd:number, senlonEnd:number, transactionIdOffset:flatbuffers.Offset, srcTypsOffset:flatbuffers.Offset, srcIdsOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, dataMode:SARObservation_Abridged_dataMode_Enum):flatbuffers.Offset {
  SARObservation_Abridged.startSARObservation_Abridged(builder);
...
unpack(): SARObservation_AbridgedT {
  return new SARObservation_AbridgedT(
    this.id(),
...
unpackTo(_o: SARObservation_AbridgedT): void {
  _o.id = this.id();
...
export class SARObservation_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SARObservation_Abridged_dataMode_Enum = SARObservation_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const srcTyps = SARObservation_Abridged.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = SARObservation_Abridged.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  ...
  return SARObservation_Abridged.createSARObservation_Abridged(builder,
    id,
