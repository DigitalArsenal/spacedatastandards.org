...
import { AntennaDetails_dataMode_Enum } from './antenna-details-data-mode-enum.js';
import { AntennaDetails_mode_Enum } from './antenna-details-mode-enum.js';
 ...
 */
export class AntennaDetails implements flatbuffers.IUnpackableObject<AntennaDetailsT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AntennaDetails {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAntennaDetails(bb:flatbuffers.ByteBuffer, obj?:AntennaDetails):AntennaDetails {
  return (obj || new AntennaDetails()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAntennaDetails(bb:flatbuffers.ByteBuffer, obj?:AntennaDetails):AntennaDetails {
 ...
 */
mode():AntennaDetails_mode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 14);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AntennaDetails_mode_Enum.TX;
}
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():AntennaDetails_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 54);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AntennaDetails_dataMode_Enum.REAL;
}
...
static startAntennaDetails(builder:flatbuffers.Builder) {
...
static addMode(builder:flatbuffers.Builder, mode:AntennaDetails_mode_Enum) {
  builder.addFieldInt8(5, mode, AntennaDetails_mode_Enum.TX);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AntennaDetails_dataMode_Enum) {
  builder.addFieldInt8(25, dataMode, AntennaDetails_dataMode_Enum.REAL);
}
...
static endAntennaDetails(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAntennaDetailsBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ANTE');
}

static finishSizePrefixedAntennaDetailsBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ANTE', true);
}

static createAntennaDetails(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idAntennaOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, positionOffset:flatbuffers.Offset, mode:AntennaDetails_mode_Enum, steerable:boolean, beamForming:boolean, manufacturerOrgIdOffset:flatbuffers.Offset, diameter:number, sizeOffset:flatbuffers.Offset, startFrequency:number, endFrequency:number, beamwidth:number, gain:number, gainTolerance:number, polarization:number, descriptionOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:AntennaDetails_dataMode_Enum, tagsOffset:flatbuffers.Offset, manufacturerOrgOffset:flatbuffers.Offset):flatbuffers.Offset {
  AntennaDetails.startAntennaDetails(builder);
...
unpack(): AntennaDetailsT {
  return new AntennaDetailsT(
    this.id(),
    this.idAntenna(),
...
unpackTo(_o: AntennaDetailsT): void {
  _o.id = this.id();
...
export class AntennaDetailsT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public mode: AntennaDetails_mode_Enum = AntennaDetails_mode_Enum.TX,
  ...
  public dataMode: AntennaDetails_dataMode_Enum = AntennaDetails_dataMode_Enum.REAL,
  public tags: (string)[] = [],
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const size = AntennaDetails.createSizeVector(builder, builder.createObjectOffsetList(this.size));
  ...
  const tags = AntennaDetails.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  const manufacturerOrg = (this.manufacturerOrg !== null ? builder.createString(this.manufacturerOrg!) : 0);

  return AntennaDetails.createAntennaDetails(builder,
    id,
    idAntenna,
