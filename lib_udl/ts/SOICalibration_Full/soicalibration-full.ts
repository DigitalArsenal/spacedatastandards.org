 ...
 */
export class SOICalibration_Full implements flatbuffers.IUnpackableObject<SOICalibration_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SOICalibration_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSOICalibration_Full(bb:flatbuffers.ByteBuffer, obj?:SOICalibration_Full):SOICalibration_Full {
  return (obj || new SOICalibration_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSOICalibration_Full(bb:flatbuffers.ByteBuffer, obj?:SOICalibration_Full):SOICalibration_Full {
...
static startSOICalibration_Full(builder:flatbuffers.Builder) {
...
unpack(): SOICalibration_FullT {
  return new SOICalibration_FullT(
...
unpackTo(_o: SOICalibration_FullT): void {
...
export class SOICalibration_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SOICalibration_Full.createSOICalibration_Full(builder,
    this.calExtinctionCoeff,
    this.calSkyBg,
    this.calBgIntensity,
    this.calSpectralFilterSolarMag,
