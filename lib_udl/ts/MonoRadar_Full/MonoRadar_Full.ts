...
import { MonoRadar_Full_dataMode_Enum } from './MonoRadar_Full_dataMode_Enum.js';
 ...
 */
export class MonoRadar_Full implements flatbuffers.IUnpackableObject<MonoRadar_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):MonoRadar_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsMonoRadar_Full(bb:flatbuffers.ByteBuffer, obj?:MonoRadar_Full):MonoRadar_Full {
  return (obj || new MonoRadar_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsMonoRadar_Full(bb:flatbuffers.ByteBuffer, obj?:MonoRadar_Full):MonoRadar_Full {
 ...
 */
dataMode():MonoRadar_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 142);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : MonoRadar_Full_dataMode_Enum.REAL;
}
...
static startMonoRadar_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:MonoRadar_Full_dataMode_Enum) {
  builder.addFieldInt8(69, dataMode, MonoRadar_Full_dataMode_Enum.REAL);
}
...
unpack(): MonoRadar_FullT {
  return new MonoRadar_FullT(
    this.id(),
...
unpackTo(_o: MonoRadar_FullT): void {
  _o.id = this.id();
...
export class MonoRadar_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: MonoRadar_Full_dataMode_Enum = MonoRadar_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const cartpos = MonoRadar_Full.createCartposVector(builder, builder.createObjectOffsetList(this.cartpos));
  const wectc = MonoRadar_Full.createWectcVector(builder, builder.createObjectOffsetList(this.wectc));
  ...
  const tags = MonoRadar_Full.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  return MonoRadar_Full.createMonoRadar_Full(builder,
    id,
