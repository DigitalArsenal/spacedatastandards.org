...
import { OnorbitEvent_Full_dataMode_Enum } from './onorbit-event-full-data-mode-enum.js';


/**
 * /// No description available.
 */
export class OnorbitEvent_Full implements flatbuffers.IUnpackableObject<OnorbitEvent_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OnorbitEvent_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOnorbitEvent_Full(bb:flatbuffers.ByteBuffer, obj?:OnorbitEvent_Full):OnorbitEvent_Full {
  return (obj || new OnorbitEvent_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOnorbitEvent_Full(bb:flatbuffers.ByteBuffer, obj?:OnorbitEvent_Full):OnorbitEvent_Full {
...
dataMode():OnorbitEvent_Full_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OnorbitEvent_Full_dataMode_Enum.REAL;
}
...
static startOnorbitEvent_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:OnorbitEvent_Full_dataMode_Enum) {
  builder.addFieldInt8(50, dataMode, OnorbitEvent_Full_dataMode_Enum.REAL);
}
...
unpack(): OnorbitEvent_FullT {
  return new OnorbitEvent_FullT(
    this.id(),
...
unpackTo(_o: OnorbitEvent_FullT): void {
  _o.id = this.id();
...
export class OnorbitEvent_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: OnorbitEvent_Full_dataMode_Enum = OnorbitEvent_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return OnorbitEvent_Full.createOnorbitEvent_Full(builder,
    id,
