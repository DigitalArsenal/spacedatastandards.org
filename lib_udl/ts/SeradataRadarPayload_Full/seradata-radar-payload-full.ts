...
import { SeradataRadarPayload_Full_dataMode_Enum } from './seradata-radar-payload-full-data-mode-enum.js';


/**
 * /// Details for an radar payload from  Seradata.
 */
export class SeradataRadarPayload_Full implements flatbuffers.IUnpackableObject<SeradataRadarPayload_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SeradataRadarPayload_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSeradataRadarPayload_Full(bb:flatbuffers.ByteBuffer, obj?:SeradataRadarPayload_Full):SeradataRadarPayload_Full {
  return (obj || new SeradataRadarPayload_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSeradataRadarPayload_Full(bb:flatbuffers.ByteBuffer, obj?:SeradataRadarPayload_Full):SeradataRadarPayload_Full {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SeradataRadarPayload_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 70);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SeradataRadarPayload_Full_dataMode_Enum.REAL;
}

static startSeradataRadarPayload_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SeradataRadarPayload_Full_dataMode_Enum) {
  builder.addFieldInt8(33, dataMode, SeradataRadarPayload_Full_dataMode_Enum.REAL);
}

static endSeradataRadarPayload_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSeradataRadarPayload_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA');
}

static finishSizePrefixedSeradataRadarPayload_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA', true);
}

static createSeradataRadarPayload_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, spacecraftIdOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, hostedForCompanyOrgIdOffset:flatbuffers.Offset, manufacturerOrgIdOffset:flatbuffers.Offset, categoryOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, frequencyBandOffset:flatbuffers.Offset, frequency:number, waveLength:number, bestResolution:number, swathWidth:number, recorderSizeOffset:flatbuffers.Offset, fieldOfView:number, fieldOfRegard:number, pointingMethodOffset:flatbuffers.Offset, groundStationsOffset:flatbuffers.Offset, groundStationLocationsOffset:flatbuffers.Offset, transmitPolarizationOffset:flatbuffers.Offset, receivePolarizationOffset:flatbuffers.Offset, dutyCycleOffset:flatbuffers.Offset, partnerSpacecraftOffset:flatbuffers.Offset, constellationInterferometricCapabilityOffset:flatbuffers.Offset, notesOffset:flatbuffers.Offset, bandwidth:number, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, updatedAtOffset:flatbuffers.Offset, updatedByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:SeradataRadarPayload_Full_dataMode_Enum):flatbuffers.Offset {
  SeradataRadarPayload_Full.startSeradataRadarPayload_Full(builder);
...
unpack(): SeradataRadarPayload_FullT {
  return new SeradataRadarPayload_FullT(
    this.id(),
...
unpackTo(_o: SeradataRadarPayload_FullT): void {
  _o.id = this.id();
...
export class SeradataRadarPayload_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SeradataRadarPayload_Full_dataMode_Enum = SeradataRadarPayload_Full_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SeradataRadarPayload_Full.createSeradataRadarPayload_Full(builder,
    id,
