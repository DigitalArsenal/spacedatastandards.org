...
import { OrganizationDetails_Abridged_dataMode_Enum } from './organization-details-abridged-data-mode-enum.js';


/**
 * /// Model representation of additional detailed organization data as collected by a particular source.
 */
export class OrganizationDetails_Abridged implements flatbuffers.IUnpackableObject<OrganizationDetails_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OrganizationDetails_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOrganizationDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:OrganizationDetails_Abridged):OrganizationDetails_Abridged {
  return (obj || new OrganizationDetails_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOrganizationDetails_Abridged(bb:flatbuffers.ByteBuffer, obj?:OrganizationDetails_Abridged):OrganizationDetails_Abridged {
 ...
 */
dataMode():OrganizationDetails_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 68);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OrganizationDetails_Abridged_dataMode_Enum.REAL;
}
...
static startOrganizationDetails_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:OrganizationDetails_Abridged_dataMode_Enum) {
  builder.addFieldInt8(32, dataMode, OrganizationDetails_Abridged_dataMode_Enum.REAL);
}
...
static endOrganizationDetails_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishOrganizationDetails_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ORGA');
}

static finishSizePrefixedOrganizationDetails_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ORGA', true);
}

static createOrganizationDetails_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, idOrganizationOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, emailOffset:flatbuffers.Offset, address1Offset:flatbuffers.Offset, address2Offset:flatbuffers.Offset, address3Offset:flatbuffers.Offset, geoAdminLevel1Offset:flatbuffers.Offset, geoAdminLevel2Offset:flatbuffers.Offset, geoAdminLevel3Offset:flatbuffers.Offset, postalCodeOffset:flatbuffers.Offset, descriptionOffset:flatbuffers.Offset, formerOrgIdOffset:flatbuffers.Offset, parentOrgIdOffset:flatbuffers.Offset, financialYearEndDateOffset:flatbuffers.Offset, revenue:number, profit:number, ebitda:number, ftes:number, brokerOffset:flatbuffers.Offset, ceoOffset:flatbuffers.Offset, cfoOffset:flatbuffers.Offset, ctoOffset:flatbuffers.Offset, riskManagerOffset:flatbuffers.Offset, massRanking:number, revenueRanking:number, financialNotesOffset:flatbuffers.Offset, servicesNotesOffset:flatbuffers.Offset, fleetPlanNotesOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:OrganizationDetails_Abridged_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  OrganizationDetails_Abridged.startOrganizationDetails_Abridged(builder);
...
unpack(): OrganizationDetails_AbridgedT {
  return new OrganizationDetails_AbridgedT(
    this.id(),
    this.idOrganization(),
...
unpackTo(_o: OrganizationDetails_AbridgedT): void {
  _o.id = this.id();
...
export class OrganizationDetails_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: OrganizationDetails_Abridged_dataMode_Enum = OrganizationDetails_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return OrganizationDetails_Abridged.createOrganizationDetails_Abridged(builder,
    id,
    idOrganization,
