...
import { Operatingunit_Ingest_dataMode_Enum } from './operatingunit-ingest-data-mode-enum.js';
 ...
 */
export class Operatingunit_Ingest implements flatbuffers.IUnpackableObject<Operatingunit_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Operatingunit_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOperatingunit_Ingest(bb:flatbuffers.ByteBuffer, obj?:Operatingunit_Ingest):Operatingunit_Ingest {
  return (obj || new Operatingunit_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOperatingunit_Ingest(bb:flatbuffers.ByteBuffer, obj?:Operatingunit_Ingest):Operatingunit_Ingest {
 ...
 */
dataMode():Operatingunit_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 122);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Operatingunit_Ingest_dataMode_Enum.REAL;
}

static startOperatingunit_Ingest(builder:flatbuffers.Builder) {
...
unpack(): Operatingunit_IngestT {
  return new Operatingunit_IngestT(
...
unpackTo(_o: Operatingunit_IngestT): void {
...
export class Operatingunit_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Operatingunit_Ingest_dataMode_Enum = Operatingunit_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Operatingunit_Ingest.createOperatingunit_Ingest(builder,
    idOperatingUnit,
