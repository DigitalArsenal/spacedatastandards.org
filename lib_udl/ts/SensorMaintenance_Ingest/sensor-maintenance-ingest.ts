...
import { SensorMaintenance_Ingest_dataMode_Enum } from './sensor-maintenance-ingest-data-mode-enum.js';


/**
 * /// Maintenance schedule and operational status of Sensor.
 */
export class SensorMaintenance_Ingest implements flatbuffers.IUnpackableObject<SensorMaintenance_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SensorMaintenance_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSensorMaintenance_Ingest(bb:flatbuffers.ByteBuffer, obj?:SensorMaintenance_Ingest):SensorMaintenance_Ingest {
  return (obj || new SensorMaintenance_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSensorMaintenance_Ingest(bb:flatbuffers.ByteBuffer, obj?:SensorMaintenance_Ingest):SensorMaintenance_Ingest {
 ...
 */
dataMode():SensorMaintenance_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 62);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SensorMaintenance_Ingest_dataMode_Enum.REAL;
}
...
static startSensorMaintenance_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SensorMaintenance_Ingest_dataMode_Enum) {
  builder.addFieldInt8(29, dataMode, SensorMaintenance_Ingest_dataMode_Enum.REAL);
}
...
unpack(): SensorMaintenance_IngestT {
  return new SensorMaintenance_IngestT(
    this.id(),
...
unpackTo(_o: SensorMaintenance_IngestT): void {
  _o.id = this.id();
...
export class SensorMaintenance_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SensorMaintenance_Ingest_dataMode_Enum = SensorMaintenance_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SensorMaintenance_Ingest.createSensorMaintenance_Ingest(builder,
    id,
