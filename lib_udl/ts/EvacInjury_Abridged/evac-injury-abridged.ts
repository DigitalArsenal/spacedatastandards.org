 ...
 * /// Injury specifics.
 */
export class EvacInjury_Abridged implements flatbuffers.IUnpackableObject<EvacInjury_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EvacInjury_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEvacInjury_Abridged(bb:flatbuffers.ByteBuffer, obj?:EvacInjury_Abridged):EvacInjury_Abridged {
  return (obj || new EvacInjury_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEvacInjury_Abridged(bb:flatbuffers.ByteBuffer, obj?:EvacInjury_Abridged):EvacInjury_Abridged {
...
static startEvacInjury_Abridged(builder:flatbuffers.Builder) {
...
static endEvacInjury_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishEvacInjury_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC');
}

static finishSizePrefixedEvacInjury_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'EVAC', true);
}

static createEvacInjury_Abridged(builder:flatbuffers.Builder, typeOffset:flatbuffers.Offset, bodyPartOffset:flatbuffers.Offset, timeOffset:flatbuffers.Offset, commentsOffset:flatbuffers.Offset):flatbuffers.Offset {
  EvacInjury_Abridged.startEvacInjury_Abridged(builder);
...
unpack(): EvacInjury_AbridgedT {
  return new EvacInjury_AbridgedT(
    this.type(),
    this.bodyPart(),
    this.time(),
    this.comments()
...
unpackTo(_o: EvacInjury_AbridgedT): void {
  _o.type = this.type();
...
export class EvacInjury_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return EvacInjury_Abridged.createEvacInjury_Abridged(builder,
    type,
    bodyPart,
    time,
    comments
