...
import { Sensor_Abridged_dataMode_Enum } from './sensor-abridged-data-mode-enum.js';


/**
 * /// Model representation of observation data for electro-optical based sensor phenomenologies.
 */
export class Sensor_Abridged implements flatbuffers.IUnpackableObject<Sensor_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Sensor_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSensor_Abridged(bb:flatbuffers.ByteBuffer, obj?:Sensor_Abridged):Sensor_Abridged {
  return (obj || new Sensor_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSensor_Abridged(bb:flatbuffers.ByteBuffer, obj?:Sensor_Abridged):Sensor_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Sensor_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 26);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Sensor_Abridged_dataMode_Enum.REAL;
}
...
static startSensor_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Sensor_Abridged_dataMode_Enum) {
  builder.addFieldInt8(11, dataMode, Sensor_Abridged_dataMode_Enum.REAL);
}
...
static endSensor_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSensor_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SENS');
}

static finishSizePrefixedSensor_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SENS', true);
}

static createSensor_Abridged(builder:flatbuffers.Builder, idSensorOffset:flatbuffers.Offset, sensorNameOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, sensorNumber:number, shortNameOffset:flatbuffers.Offset, dataControlOffset:flatbuffers.Offset, afIdOffset:flatbuffers.Offset, asrTypeOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:Sensor_Abridged_dataMode_Enum, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, active:boolean, sensorcharacteristicsOffset:flatbuffers.Offset, sensorStatsOffset:flatbuffers.Offset, sensorlimitsCollectionOffset:flatbuffers.Offset, entityOffset:flatbuffers.Offset, idEntityOffset:flatbuffers.Offset, sensorObservationTypeOffset:flatbuffers.Offset, sensorTypeOffset:flatbuffers.Offset):flatbuffers.Offset {
  Sensor_Abridged.startSensor_Abridged(builder);
...
unpack(): Sensor_AbridgedT {
  return new Sensor_AbridgedT(
    this.idSensor(),
    this.sensorName(),
...
unpackTo(_o: Sensor_AbridgedT): void {
...
export class Sensor_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Sensor_Abridged_dataMode_Enum = Sensor_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const sensorcharacteristics = Sensor_Abridged.createSensorcharacteristicsVector(builder, builder.createObjectOffsetList(this.sensorcharacteristics));
  const sensorStats = Sensor_Abridged.createSensorStatsVector(builder, builder.createObjectOffsetList(this.sensorStats));
  const sensorlimitsCollection = Sensor_Abridged.createSensorlimitsCollectionVector(builder, builder.createObjectOffsetList(this.sensorlimitsCollection));
  ...
  return Sensor_Abridged.createSensor_Abridged(builder,
    idSensor,
    sensorName,
