 ...
 */
export class EvacCasualtyInfo_Abridged implements flatbuffers.IUnpackableObject<EvacCasualtyInfo_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EvacCasualtyInfo_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEvacCasualtyInfo_Abridged(bb:flatbuffers.ByteBuffer, obj?:EvacCasualtyInfo_Abridged):EvacCasualtyInfo_Abridged {
  return (obj || new EvacCasualtyInfo_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEvacCasualtyInfo_Abridged(bb:flatbuffers.ByteBuffer, obj?:EvacCasualtyInfo_Abridged):EvacCasualtyInfo_Abridged {
...
static startEvacCasualtyInfo_Abridged(builder:flatbuffers.Builder) {
...
unpack(): EvacCasualtyInfo_AbridgedT {
  return new EvacCasualtyInfo_AbridgedT(
    this.priority(),
    this.evacType(),
    this.casualtyType(),
    this.bodyPart(),
...
unpackTo(_o: EvacCasualtyInfo_AbridgedT): void {
...
export class EvacCasualtyInfo_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const specMedEquip = EvacCasualtyInfo_Abridged.createSpecMedEquipVector(builder, builder.createObjectOffsetList(this.specMedEquip));
  ...
  const burialLocation = EvacCasualtyInfo_Abridged.createBurialLocationVector(builder, builder.createObjectOffsetList(this.burialLocation));
  const collectionPoint = EvacCasualtyInfo_Abridged.createCollectionPointVector(builder, builder.createObjectOffsetList(this.collectionPoint));
  ...
  const etiology = EvacCasualtyInfo_Abridged.createEtiologyVector(builder, builder.createObjectOffsetList(this.etiology));
  const treatment = EvacCasualtyInfo_Abridged.createTreatmentVector(builder, builder.createObjectOffsetList(this.treatment));
  const vitalSignData = EvacCasualtyInfo_Abridged.createVitalSignDataVector(builder, builder.createObjectOffsetList(this.vitalSignData));
  const healthState = EvacCasualtyInfo_Abridged.createHealthStateVector(builder, builder.createObjectOffsetList(this.healthState));
  const condition = EvacCasualtyInfo_Abridged.createConditionVector(builder, builder.createObjectOffsetList(this.condition));
  const medication = EvacCasualtyInfo_Abridged.createMedicationVector(builder, builder.createObjectOffsetList(this.medication));
  const injury = EvacCasualtyInfo_Abridged.createInjuryVector(builder, builder.createObjectOffsetList(this.injury));
  const allergy = EvacCasualtyInfo_Abridged.createAllergyVector(builder, builder.createObjectOffsetList(this.allergy));

  return EvacCasualtyInfo_Abridged.createEvacCasualtyInfo_Abridged(builder,
    priority,
    evacType,
    casualtyType,
    bodyPart,
