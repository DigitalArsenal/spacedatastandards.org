...
import { EffectRequest_Ingest_dataMode_Enum } from './effect-request-ingest-data-mode-enum.js';


/**
 * /// A request for various effects on a target.
 */
export class EffectRequest_Ingest implements flatbuffers.IUnpackableObject<EffectRequest_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):EffectRequest_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsEffectRequest_Ingest(bb:flatbuffers.ByteBuffer, obj?:EffectRequest_Ingest):EffectRequest_Ingest {
  return (obj || new EffectRequest_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsEffectRequest_Ingest(bb:flatbuffers.ByteBuffer, obj?:EffectRequest_Ingest):EffectRequest_Ingest {
...
dataMode():EffectRequest_Ingest_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : EffectRequest_Ingest_dataMode_Enum.REAL;
}
...
static startEffectRequest_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:EffectRequest_Ingest_dataMode_Enum) {
  builder.addFieldInt8(19, dataMode, EffectRequest_Ingest_dataMode_Enum.REAL);
}
...
unpack(): EffectRequest_IngestT {
  return new EffectRequest_IngestT(
    this.id(),
...
unpackTo(_o: EffectRequest_IngestT): void {
  _o.id = this.id();
...
export class EffectRequest_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: EffectRequest_Ingest_dataMode_Enum = EffectRequest_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const effectList = EffectRequest_Ingest.createEffectListVector(builder, builder.createObjectOffsetList(this.effectList));
  ...
  const metricTypes = EffectRequest_Ingest.createMetricTypesVector(builder, builder.createObjectOffsetList(this.metricTypes));
  const metricWeights = EffectRequest_Ingest.createMetricWeightsVector(builder, builder.createObjectOffsetList(this.metricWeights));
  ...
  return EffectRequest_Ingest.createEffectRequest_Ingest(builder,
    id,
