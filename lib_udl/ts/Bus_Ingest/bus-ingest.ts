...
import { Bus_Ingest_dataMode_Enum } from './bus-ingest-data-mode-enum.js';
 ...
 */
export class Bus_Ingest implements flatbuffers.IUnpackableObject<Bus_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Bus_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsBus_Ingest(bb:flatbuffers.ByteBuffer, obj?:Bus_Ingest):Bus_Ingest {
  return (obj || new Bus_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsBus_Ingest(bb:flatbuffers.ByteBuffer, obj?:Bus_Ingest):Bus_Ingest {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new Bus_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static bufferHasIdentifier(bb:flatbuffers.ByteBuffer):boolean {
  return bb.__has_identifier('BUSI');
}
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Bus_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 110);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Bus_Ingest_dataMode_Enum.REAL;
}
...
static startBus_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Bus_Ingest_dataMode_Enum) {
  builder.addFieldInt8(53, dataMode, Bus_Ingest_dataMode_Enum.REAL);
}
...
unpack(): Bus_IngestT {
  return new Bus_IngestT(
    ...
    this.numOrbitType(),
    this.bb!.createScalarList<string>(this.orbitTypes.bind(this), this.orbitTypes_Length()),
...
unpackTo(_o: Bus_IngestT): void {
  ...
  _o.orbitTypes = this.bb!.createScalarList<string>(this.orbitTypes.bind(this), this.orbitTypes_Length());
...
export class Bus_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Bus_Ingest_dataMode_Enum = Bus_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const orbitTypes = Bus_Ingest.createOrbitTypesVector(builder, builder.createObjectOffsetList(this.orbitTypes));
  ...
  return Bus_Ingest.createBus_Ingest(builder,
    id,
    name,
