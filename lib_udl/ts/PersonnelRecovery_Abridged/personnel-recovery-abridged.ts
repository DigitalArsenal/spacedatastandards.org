...
import { PersonnelRecovery_Abridged_dataMode_Enum } from './personnel-recovery-abridged-data-mode-enum.js';


/**
 * /// Provides information concerning search and rescue operations and other situations involving personnel recovery.
 */
export class PersonnelRecovery_Abridged implements flatbuffers.IUnpackableObject<PersonnelRecovery_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):PersonnelRecovery_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsPersonnelRecovery_Abridged(bb:flatbuffers.ByteBuffer, obj?:PersonnelRecovery_Abridged):PersonnelRecovery_Abridged {
  return (obj || new PersonnelRecovery_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsPersonnelRecovery_Abridged(bb:flatbuffers.ByteBuffer, obj?:PersonnelRecovery_Abridged):PersonnelRecovery_Abridged {
 ...
 */
dataMode():PersonnelRecovery_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 78);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : PersonnelRecovery_Abridged_dataMode_Enum.REAL;
}

static startPersonnelRecovery_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:PersonnelRecovery_Abridged_dataMode_Enum) {
  builder.addFieldInt8(37, dataMode, PersonnelRecovery_Abridged_dataMode_Enum.REAL);
}

static endPersonnelRecovery_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishPersonnelRecovery_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'PERS');
}

static finishSizePrefixedPersonnelRecovery_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'PERS', true);
}

static createPersonnelRecovery_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, msgTimeOffset:flatbuffers.Offset, recovIdOffset:flatbuffers.Offset, idWeatherReportOffset:flatbuffers.Offset, pickupLat:number, pickupLon:number, pickupAlt:number, termInd:boolean, authStatusOffset:flatbuffers.Offset, numPersons:number, milClassOffset:flatbuffers.Offset, natAlliance:number, natAlliance1:number, identityOffset:flatbuffers.Offset, commEq1Offset:flatbuffers.Offset, commEq2Offset:flatbuffers.Offset, commEq3Offset:flatbuffers.Offset, txFreq:number, rxFreq:number, numNonAmbulatory:number, numAmbulatory:number, numAmbulatoryInjured:number, survivorRadioOffset:flatbuffers.Offset, survivorMessagesOffset:flatbuffers.Offset, beaconInd:boolean, callSignOffset:flatbuffers.Offset, textMsgOffset:flatbuffers.Offset, authMethodOffset:flatbuffers.Offset, objectiveAreaInfoOffset:flatbuffers.Offset, executionInfoOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:PersonnelRecovery_Abridged_dataMode_Enum):flatbuffers.Offset {
  PersonnelRecovery_Abridged.startPersonnelRecovery_Abridged(builder);
...
unpack(): PersonnelRecovery_AbridgedT {
  return new PersonnelRecovery_AbridgedT(
    this.id(),
...
unpackTo(_o: PersonnelRecovery_AbridgedT): void {
  _o.id = this.id();
...
export class PersonnelRecovery_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: PersonnelRecovery_Abridged_dataMode_Enum = PersonnelRecovery_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return PersonnelRecovery_Abridged.createPersonnelRecovery_Abridged(builder,
    id,
