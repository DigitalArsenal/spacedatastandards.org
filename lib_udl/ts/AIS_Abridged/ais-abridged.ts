...
import { AIS_Abridged_dataMode_Enum } from './ais-abridged-data-mode-enum.js';
 ...
 */
export class AIS_Abridged implements flatbuffers.IUnpackableObject<AIS_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AIS_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAIS_Abridged(bb:flatbuffers.ByteBuffer, obj?:AIS_Abridged):AIS_Abridged {
  return (obj || new AIS_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAIS_Abridged(bb:flatbuffers.ByteBuffer, obj?:AIS_Abridged):AIS_Abridged {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new AIS_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static bufferHasIdentifier(bb:flatbuffers.ByteBuffer):boolean {
  return bb.__has_identifier('AISA');
}
 ...
 */
dataMode():AIS_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 102);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AIS_Abridged_dataMode_Enum.REAL;
}
...
static startAIS_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AIS_Abridged_dataMode_Enum) {
  builder.addFieldInt8(49, dataMode, AIS_Abridged_dataMode_Enum.REAL);
}
...
unpack(): AIS_AbridgedT {
  return new AIS_AbridgedT(
    this.id(),
...
unpackTo(_o: AIS_AbridgedT): void {
  _o.id = this.id();
...
export class AIS_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AIS_Abridged_dataMode_Enum = AIS_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const antennaRefDimensions = AIS_Abridged.createAntennaRefDimensionsVector(builder, builder.createObjectOffsetList(this.antennaRefDimensions));
  ...
  return AIS_Abridged.createAIS_Abridged(builder,
    id,
