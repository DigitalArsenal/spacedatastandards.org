...
import { GNSSObservationSet_Ingest_dataMode_Enum } from './gnssobservation-set-ingest-data-mode-enum.js';


/**
 * /// Set of GNSSObservation data.
 */
export class GNSSObservationSet_Ingest implements flatbuffers.IUnpackableObject<GNSSObservationSet_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):GNSSObservationSet_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsGNSSObservationSet_Ingest(bb:flatbuffers.ByteBuffer, obj?:GNSSObservationSet_Ingest):GNSSObservationSet_Ingest {
  return (obj || new GNSSObservationSet_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsGNSSObservationSet_Ingest(bb:flatbuffers.ByteBuffer, obj?:GNSSObservationSet_Ingest):GNSSObservationSet_Ingest {
 ...
 */
dataMode():GNSSObservationSet_Ingest_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 70);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : GNSSObservationSet_Ingest_dataMode_Enum.REAL;
}
...
static startGNSSObservationSet_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:GNSSObservationSet_Ingest_dataMode_Enum) {
  builder.addFieldInt8(33, dataMode, GNSSObservationSet_Ingest_dataMode_Enum.REAL);
}
...
static endGNSSObservationSet_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishGNSSObservationSet_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'GNSS');
}

static finishSizePrefixedGNSSObservationSet_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'GNSS', true);
}

static createGNSSObservationSet_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, markerTypeOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, satNo:number, origObjectIdOffset:flatbuffers.Offset, tsOffset:flatbuffers.Offset, outage:number, gDop:number, hDop:number, pDop:number, tDop:number, vDop:number, esIdOffset:flatbuffers.Offset, receiverOffset:flatbuffers.Offset, boresightOffset:flatbuffers.Offset, quatOffset:flatbuffers.Offset, lat:number, lon:number, alt:number, satVelocityOffset:flatbuffers.Offset, obsCodesOffset:flatbuffers.Offset, trackingStatus:number, navigationStatusOffset:flatbuffers.Offset, agcState:number, srcTypsOffset:flatbuffers.Offset, srcIdsOffset:flatbuffers.Offset, tagsOffset:flatbuffers.Offset, transactionIdOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:GNSSObservationSet_Ingest_dataMode_Enum, origNetworkOffset:flatbuffers.Offset, gnssObservationListOffset:flatbuffers.Offset):flatbuffers.Offset {
  GNSSObservationSet_Ingest.startGNSSObservationSet_Ingest(builder);
...
unpack(): GNSSObservationSet_IngestT {
  return new GNSSObservationSet_IngestT(
    this.id(),
    ...
    this.lon(),
    this.alt(),
    this.bb!.createScalarList<string>(this.satVelocity.bind(this), this.satVelocity_Length()),
    this.bb!.createScalarList<string>(this.obsCodes.bind(this), this.obsCodes_Length()),
    this.trackingStatus(),
    ...
    this.dataMode(),
    this.origNetwork(),
    this.bb!.createScalarList<string>(this.gnssObservationList.bind(this), this.gnssObservationList_Length())
  );
}


unpackTo(_o: GNSSObservationSet_IngestT): void {
  _o.id = this.id();
  ...
  _o.lon = this.lon();
  _o.alt = this.alt();
  _o.satVelocity = this.bb!.createScalarList<string>(this.satVelocity.bind(this), this.satVelocity_Length());
  _o.obsCodes = this.bb!.createScalarList<string>(this.obsCodes.bind(this), this.obsCodes_Length());
  ...
  _o.gnssObservationList = this.bb!.createScalarList<string>(this.gnssObservationList.bind(this), this.gnssObservationList_Length());
}
}

export class GNSSObservationSet_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: GNSSObservationSet_Ingest_dataMode_Enum = GNSSObservationSet_Ingest_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const boresight = GNSSObservationSet_Ingest.createBoresightVector(builder, builder.createObjectOffsetList(this.boresight));
  const quat = GNSSObservationSet_Ingest.createQuatVector(builder, builder.createObjectOffsetList(this.quat));
  const satVelocity = GNSSObservationSet_Ingest.createSatVelocityVector(builder, builder.createObjectOffsetList(this.satVelocity));
  const obsCodes = GNSSObservationSet_Ingest.createObsCodesVector(builder, builder.createObjectOffsetList(this.obsCodes));
  const navigationStatus = (this.navigationStatus !== null ? builder.createString(this.navigationStatus!) : 0);
  const srcTyps = GNSSObservationSet_Ingest.createSrcTypsVector(builder, builder.createObjectOffsetList(this.srcTyps));
  const srcIds = GNSSObservationSet_Ingest.createSrcIdsVector(builder, builder.createObjectOffsetList(this.srcIds));
  const tags = GNSSObservationSet_Ingest.createTagsVector(builder, builder.createObjectOffsetList(this.tags));
  ...
  const gnssObservationList = GNSSObservationSet_Ingest.createGnssObservationListVector(builder, builder.createObjectOffsetList(this.gnssObservationList));

  return GNSSObservationSet_Ingest.createGNSSObservationSet_Ingest(builder,
    id,
