...
import { Vessel_Abridged_dataMode_Enum } from './vessel-abridged-data-mode-enum.js';
 ...
 */
export class Vessel_Abridged implements flatbuffers.IUnpackableObject<Vessel_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Vessel_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsVessel_Abridged(bb:flatbuffers.ByteBuffer, obj?:Vessel_Abridged):Vessel_Abridged {
  return (obj || new Vessel_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsVessel_Abridged(bb:flatbuffers.ByteBuffer, obj?:Vessel_Abridged):Vessel_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 64
 */
dataMode():Vessel_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 68);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Vessel_Abridged_dataMode_Enum.REAL;
}
...
static startVessel_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Vessel_Abridged_dataMode_Enum) {
  builder.addFieldInt8(32, dataMode, Vessel_Abridged_dataMode_Enum.REAL);
}
...
unpack(): Vessel_AbridgedT {
  return new Vessel_AbridgedT(
    this.id(),
...
unpackTo(_o: Vessel_AbridgedT): void {
  _o.id = this.id();
...
export class Vessel_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Vessel_Abridged_dataMode_Enum = Vessel_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Vessel_Abridged.createVessel_Abridged(builder,
    id,
