...
import { Site_Abridged_dataMode_Enum } from './site-abridged-data-mode-enum.js';


/**
 * /// Properties and characteristics of a site entity, such as an airbase, airfield, naval station, etc.
 */
export class Site_Abridged implements flatbuffers.IUnpackableObject<Site_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Site_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSite_Abridged(bb:flatbuffers.ByteBuffer, obj?:Site_Abridged):Site_Abridged {
  return (obj || new Site_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSite_Abridged(bb:flatbuffers.ByteBuffer, obj?:Site_Abridged):Site_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Site_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 132);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Site_Abridged_dataMode_Enum.REAL;
}

static startSite_Abridged(builder:flatbuffers.Builder) {
...
static addIdParentSite(builder:flatbuffers.Builder, idParentSiteOffset:flatbuffers.Offset) {
  builder.addFieldOffset(2, idParentSiteOffset, 0);
}
...
static addLzUsage(builder:flatbuffers.Builder, lzUsageOffset:flatbuffers.Offset) {
  builder.addFieldOffset(9, lzUsageOffset, 0);
}
...
unpack(): Site_AbridgedT {
  return new Site_AbridgedT(
    this.id(),
    this.idEntity(),
    this.idParentSite(),
...
unpackTo(_o: Site_AbridgedT): void {
  _o.id = this.id();
...
export class Site_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Site_Abridged_dataMode_Enum = Site_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Site_Abridged.createSite_Abridged(builder,
    id,
    idEntity,
    idParentSite,
