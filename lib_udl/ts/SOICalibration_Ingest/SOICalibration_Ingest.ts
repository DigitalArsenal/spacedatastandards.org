 ...
 */
export class SOICalibration_Ingest implements flatbuffers.IUnpackableObject<SOICalibration_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SOICalibration_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSOICalibration_Ingest(bb:flatbuffers.ByteBuffer, obj?:SOICalibration_Ingest):SOICalibration_Ingest {
  return (obj || new SOICalibration_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSOICalibration_Ingest(bb:flatbuffers.ByteBuffer, obj?:SOICalibration_Ingest):SOICalibration_Ingest {
...
static startSOICalibration_Ingest(builder:flatbuffers.Builder) {
...
unpack(): SOICalibration_IngestT {
  return new SOICalibration_IngestT(
...
unpackTo(_o: SOICalibration_IngestT): void {
...
export class SOICalibration_IngestT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SOICalibration_Ingest.createSOICalibration_Ingest(builder,
    this.calExtinctionCoeff,
    this.calSkyBg,
    this.calBgIntensity,
    this.calSpectralFilterSolarMag,
