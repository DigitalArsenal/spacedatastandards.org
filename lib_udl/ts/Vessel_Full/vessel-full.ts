...
import { Vessel_Full_dataMode_Enum } from './vessel-full-data-mode-enum.js';
 ...
 */
export class Vessel_Full implements flatbuffers.IUnpackableObject<Vessel_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Vessel_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsVessel_Full(bb:flatbuffers.ByteBuffer, obj?:Vessel_Full):Vessel_Full {
  return (obj || new Vessel_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsVessel_Full(bb:flatbuffers.ByteBuffer, obj?:Vessel_Full):Vessel_Full {
 ...
 * Constraints: Minimum length = 1, Maximum length = 64
 */
dataMode():Vessel_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 76);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Vessel_Full_dataMode_Enum.REAL;
}
...
static startVessel_Full(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Vessel_Full_dataMode_Enum) {
  builder.addFieldInt8(36, dataMode, Vessel_Full_dataMode_Enum.REAL);
}
...
export class Vessel_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Vessel_Full_dataMode_Enum = Vessel_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Vessel_Full.createVessel_Full(builder,
    id,
