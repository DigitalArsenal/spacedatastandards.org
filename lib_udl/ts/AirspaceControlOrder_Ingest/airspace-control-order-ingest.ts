...
import { AirspaceControlOrder_Ingest_dataMode_Enum } from './airspace-control-order-ingest-data-mode-enum.js';
 ...
 */
export class AirspaceControlOrder_Ingest implements flatbuffers.IUnpackableObject<AirspaceControlOrder_IngestT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirspaceControlOrder_Ingest {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirspaceControlOrder_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirspaceControlOrder_Ingest):AirspaceControlOrder_Ingest {
  return (obj || new AirspaceControlOrder_Ingest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirspaceControlOrder_Ingest(bb:flatbuffers.ByteBuffer, obj?:AirspaceControlOrder_Ingest):AirspaceControlOrder_Ingest {
...
dataMode():AirspaceControlOrder_Ingest_dataMode_Enum {
  ...
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AirspaceControlOrder_Ingest_dataMode_Enum.REAL;
}

static startAirspaceControlOrder_Ingest(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AirspaceControlOrder_Ingest_dataMode_Enum) {
  builder.addFieldInt8(32, dataMode, AirspaceControlOrder_Ingest_dataMode_Enum.REAL);
}

static endAirspaceControlOrder_Ingest(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAirspaceControlOrder_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRS');
}

static finishSizePrefixedAirspaceControlOrder_IngestBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRS', true);
}

static createAirspaceControlOrder_Ingest(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, rawFileUriOffset:flatbuffers.Offset, opExNameOffset:flatbuffers.Offset, originatorOffset:flatbuffers.Offset, startTimeOffset:flatbuffers.Offset, stopTimeOffset:flatbuffers.Offset, stopQualifierOffset:flatbuffers.Offset, opExInfoOffset:flatbuffers.Offset, opExInfoAltOffset:flatbuffers.Offset, planOrigNumOffset:flatbuffers.Offset, serialNumOffset:flatbuffers.Offset, monthOffset:flatbuffers.Offset, qualifierOffset:flatbuffers.Offset, qualSn:number, areaOfValidityOffset:flatbuffers.Offset, acoSerialNumOffset:flatbuffers.Offset, geoDatumOffset:flatbuffers.Offset, acoCommentsOffset:flatbuffers.Offset, airspaceControlOrderReferencesOffset:flatbuffers.Offset, airspaceControlMeansStatusOffset:flatbuffers.Offset, undLnkTrkOffset:flatbuffers.Offset, classSourceOffset:flatbuffers.Offset, classReasonOffset:flatbuffers.Offset, downgradeInsDateOffset:flatbuffers.Offset, declassExemptionCodeOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceDlOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:AirspaceControlOrder_Ingest_dataMode_Enum):flatbuffers.Offset {
  AirspaceControlOrder_Ingest.startAirspaceControlOrder_Ingest(builder);
  AirspaceControlOrder_Ingest.addId(builder, idOffset);
  AirspaceControlOrder_Ingest.addClassificationMarking(builder, classificationMarkingOffset);
  AirspaceControlOrder_Ingest.addRawFileUri(builder, rawFileUriOffset);
  AirspaceControlOrder_Ingest.addOpExName(builder, opExNameOffset);
  AirspaceControlOrder_Ingest.addOriginator(builder, originatorOffset);
  AirspaceControlOrder_Ingest.addStartTime(builder, startTimeOffset);
  AirspaceControlOrder_Ingest.addStopTime(builder, stopTimeOffset);
  AirspaceControlOrder_Ingest.addStopQualifier(builder, stopQualifierOffset);
  AirspaceControlOrder_Ingest.addOpExInfo(builder, opExInfoOffset);
  AirspaceControlOrder_Ingest.addOpExInfoAlt(builder, opExInfoAltOffset);
  AirspaceControlOrder_Ingest.addPlanOrigNum(builder, planOrigNumOffset);
  AirspaceControlOrder_Ingest.addSerialNum(builder, serialNumOffset);
  AirspaceControlOrder_Ingest.addMonth(builder, monthOffset);
  AirspaceControlOrder_Ingest.addQualifier(builder, qualifierOffset);
  AirspaceControlOrder_Ingest.addQualSn(builder, qualSn);
  AirspaceControlOrder_Ingest.addAreaOfValidity(builder, areaOfValidityOffset);
  AirspaceControlOrder_Ingest.addAcoSerialNum(builder, acoSerialNumOffset);
  AirspaceControlOrder_Ingest.addGeoDatum(builder, geoDatumOffset);
  AirspaceControlOrder_Ingest.addAcoComments(builder, acoCommentsOffset);
  AirspaceControlOrder_Ingest.addAirspaceControlOrderReferences(builder, airspaceControlOrderReferencesOffset);
  AirspaceControlOrder_Ingest.addAirspaceControlMeansStatus(builder, airspaceControlMeansStatusOffset);
  AirspaceControlOrder_Ingest.addUndLnkTrk(builder, undLnkTrkOffset);
  AirspaceControlOrder_Ingest.addClassSource(builder, classSourceOffset);
  AirspaceControlOrder_Ingest.addClassReason(builder, classReasonOffset);
  AirspaceControlOrder_Ingest.addDowngradeInsDate(builder, downgradeInsDateOffset);
  AirspaceControlOrder_Ingest.addDeclassExemptionCode(builder, declassExemptionCodeOffset);
  AirspaceControlOrder_Ingest.addCreatedAt(builder, createdAtOffset);
  AirspaceControlOrder_Ingest.addCreatedBy(builder, createdByOffset);
  AirspaceControlOrder_Ingest.addSourceDl(builder, sourceDlOffset);
  AirspaceControlOrder_Ingest.addSource(builder, sourceOffset);
  AirspaceControlOrder_Ingest.addOrigin(builder, originOffset);
  AirspaceControlOrder_Ingest.addOrigNetwork(builder, origNetworkOffset);
  AirspaceControlOrder_Ingest.addDataMode(builder, dataMode);
  return AirspaceControlOrder_Ingest.endAirspaceControlOrder_Ingest(builder);
}

unpack(): AirspaceControlOrder_IngestT {
  return new AirspaceControlOrder_IngestT(
    this.id(),
    ...
    this.geoDatum(),
    this.acoComments(),
    this.bb!.createScalarList<string>(this.airspaceControlOrderReferences.bind(this), this.airspaceControlOrderReferences_Length()),
    this.bb!.createScalarList<string>(this.airspaceControlMeansStatus.bind(this), this.airspaceControlMeansStatus_Length()),
    this.bb!.createScalarList<string>(this.undLnkTrk.bind(this), this.undLnkTrk_Length()),
    this.classSource(),
    this.bb!.createScalarList<string>(this.classReason.bind(this), this.classReason_Length()),
    this.bb!.createScalarList<string>(this.downgradeInsDate.bind(this), this.downgradeInsDate_Length()),
    this.bb!.createScalarList<string>(this.declassExemptionCode.bind(this), this.declassExemptionCode_Length()),
    this.createdAt(),
    this.createdBy(),
    this.sourceDl(),
    this.source(),
...
unpackTo(_o: AirspaceControlOrder_IngestT): void {
  _o.id = this.id();
  ...
  _o.airspaceControlOrderReferences = this.bb!.createScalarList<string>(this.airspaceControlOrderReferences.bind(this), this.airspaceControlOrderReferences_Length());
  _o.airspaceControlMeansStatus = this.bb!.createScalarList<string>(this.airspaceControlMeansStatus.bind(this), this.airspaceControlMeansStatus_Length());
  _o.undLnkTrk = this.bb!.createScalarList<string>(this.undLnkTrk.bind(this), this.undLnkTrk_Length());
  _o.classSource = this.classSource();
  _o.classReason = this.bb!.createScalarList<string>(this.classReason.bind(this), this.classReason_Length());
  _o.downgradeInsDate = this.bb!.createScalarList<string>(this.downgradeInsDate.bind(this), this.downgradeInsDate_Length());
  _o.declassExemptionCode = this.bb!.createScalarList<string>(this.declassExemptionCode.bind(this), this.declassExemptionCode_Length());
...
export class AirspaceControlOrder_IngestT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: AirspaceControlOrder_Ingest_dataMode_Enum = AirspaceControlOrder_Ingest_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const airspaceControlOrderReferences = AirspaceControlOrder_Ingest.createAirspaceControlOrderReferencesVector(builder, builder.createObjectOffsetList(this.airspaceControlOrderReferences));
  const airspaceControlMeansStatus = AirspaceControlOrder_Ingest.createAirspaceControlMeansStatusVector(builder, builder.createObjectOffsetList(this.airspaceControlMeansStatus));
  const undLnkTrk = AirspaceControlOrder_Ingest.createUndLnkTrkVector(builder, builder.createObjectOffsetList(this.undLnkTrk));
  const classSource = (this.classSource !== null ? builder.createString(this.classSource!) : 0);
  const classReason = AirspaceControlOrder_Ingest.createClassReasonVector(builder, builder.createObjectOffsetList(this.classReason));
  const downgradeInsDate = AirspaceControlOrder_Ingest.createDowngradeInsDateVector(builder, builder.createObjectOffsetList(this.downgradeInsDate));
  const declassExemptionCode = AirspaceControlOrder_Ingest.createDeclassExemptionCodeVector(builder, builder.createObjectOffsetList(this.declassExemptionCode));
  ...
  return AirspaceControlOrder_Ingest.createAirspaceControlOrder_Ingest(builder,
    id,
