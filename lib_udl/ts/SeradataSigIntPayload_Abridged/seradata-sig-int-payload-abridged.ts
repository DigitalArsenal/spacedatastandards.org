...
import { SeradataSigIntPayload_Abridged_dataMode_Enum } from './seradata-sig-int-payload-abridged-data-mode-enum.js';


/**
 * /// Details for an sigint payload from  Seradata.
 */
export class SeradataSigIntPayload_Abridged implements flatbuffers.IUnpackableObject<SeradataSigIntPayload_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):SeradataSigIntPayload_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsSeradataSigIntPayload_Abridged(bb:flatbuffers.ByteBuffer, obj?:SeradataSigIntPayload_Abridged):SeradataSigIntPayload_Abridged {
  return (obj || new SeradataSigIntPayload_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSeradataSigIntPayload_Abridged(bb:flatbuffers.ByteBuffer, obj?:SeradataSigIntPayload_Abridged):SeradataSigIntPayload_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():SeradataSigIntPayload_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 44);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : SeradataSigIntPayload_Abridged_dataMode_Enum.REAL;
}

static startSeradataSigIntPayload_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:SeradataSigIntPayload_Abridged_dataMode_Enum) {
  builder.addFieldInt8(20, dataMode, SeradataSigIntPayload_Abridged_dataMode_Enum.REAL);
}

static endSeradataSigIntPayload_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishSeradataSigIntPayload_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA');
}

static finishSizePrefixedSeradataSigIntPayload_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SERA', true);
}

static createSeradataSigIntPayload_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, spacecraftIdOffset:flatbuffers.Offset, idSensorOffset:flatbuffers.Offset, hostedForCompanyOrgIdOffset:flatbuffers.Offset, manufacturerOrgIdOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset, swathWidth:number, groundStationsOffset:flatbuffers.Offset, groundStationLocationsOffset:flatbuffers.Offset, frequencyCoverageOffset:flatbuffers.Offset, positionalAccuracyOffset:flatbuffers.Offset, interceptParametersOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, notesOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:SeradataSigIntPayload_Abridged_dataMode_Enum):flatbuffers.Offset {
  SeradataSigIntPayload_Abridged.startSeradataSigIntPayload_Abridged(builder);
...
unpack(): SeradataSigIntPayload_AbridgedT {
  return new SeradataSigIntPayload_AbridgedT(
    this.id(),
...
unpackTo(_o: SeradataSigIntPayload_AbridgedT): void {
  _o.id = this.id();
...
export class SeradataSigIntPayload_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: SeradataSigIntPayload_Abridged_dataMode_Enum = SeradataSigIntPayload_Abridged_dataMode_Enum.REAL
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SeradataSigIntPayload_Abridged.createSeradataSigIntPayload_Abridged(builder,
    id,
