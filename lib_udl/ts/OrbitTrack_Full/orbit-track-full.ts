...
import { OrbitTrack_Full_dataMode_Enum } from './orbit-track-full-data-mode-enum.js';
import { OrbitTrack_Full_objIdent_Enum } from './orbit-track-full-obj-ident-enum.js';
import { OrbitTrack_Full_objectType_Enum } from './orbit-track-full-object-type-enum.js';
 ...
 */
export class OrbitTrack_Full implements flatbuffers.IUnpackableObject<OrbitTrack_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):OrbitTrack_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsOrbitTrack_Full(bb:flatbuffers.ByteBuffer, obj?:OrbitTrack_Full):OrbitTrack_Full {
  return (obj || new OrbitTrack_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsOrbitTrack_Full(bb:flatbuffers.ByteBuffer, obj?:OrbitTrack_Full):OrbitTrack_Full {
 ...
 * Constraints: Minimum length = 0, Maximum length = 32
 */
objIdent():OrbitTrack_Full_objIdent_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 32);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OrbitTrack_Full_objIdent_Enum.ASSUMED_FRIEND;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 32
 */
objectType():OrbitTrack_Full_objectType_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 38);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OrbitTrack_Full_objectType_Enum.DEBRIS;
}
 ...
 */
dataMode():OrbitTrack_Full_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 92);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : OrbitTrack_Full_dataMode_Enum.REAL;
}
...
static startOrbitTrack_Full(builder:flatbuffers.Builder) {
...
static addOnOrbit(builder:flatbuffers.Builder, onOrbitOffset:flatbuffers.Offset) {
  builder.addFieldOffset(4, onOrbitOffset, 0);
}
...
static addIdElset(builder:flatbuffers.Builder, idElsetOffset:flatbuffers.Offset) {
  builder.addFieldOffset(6, idElsetOffset, 0);
}

static addTs(builder:flatbuffers.Builder, tsOffset:flatbuffers.Offset) {
  builder.addFieldOffset(7, tsOffset, 0);
}
...
static addAlt(builder:flatbuffers.Builder, alt:number) {
  builder.addFieldFloat64(10, alt, 0.0);
}

static addRdfRf(builder:flatbuffers.Builder, rdfRf:number) {
  builder.addFieldFloat64(11, rdfRf, 0.0);
}
...
static addRptNum(builder:flatbuffers.Builder, rptNumOffset:flatbuffers.Offset) {
  builder.addFieldOffset(13, rptNumOffset, 0);
}

static addObjIdent(builder:flatbuffers.Builder, objIdent:OrbitTrack_Full_objIdent_Enum) {
  builder.addFieldInt8(14, objIdent, OrbitTrack_Full_objIdent_Enum.ASSUMED_FRIEND);
}

static addIdentAmp(builder:flatbuffers.Builder, identAmpOffset:flatbuffers.Offset) {
  builder.addFieldOffset(15, identAmpOffset, 0);
}

static addSatStatus(builder:flatbuffers.Builder, satStatusOffset:flatbuffers.Offset) {
  builder.addFieldOffset(16, satStatusOffset, 0);
}

static addObjectType(builder:flatbuffers.Builder, objectType:OrbitTrack_Full_objectType_Enum) {
  builder.addFieldInt8(17, objectType, OrbitTrack_Full_objectType_Enum.DEBRIS);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:OrbitTrack_Full_dataMode_Enum) {
  builder.addFieldInt8(44, dataMode, OrbitTrack_Full_dataMode_Enum.REAL);
}
...
static endOrbitTrack_Full(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishOrbitTrack_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ORBI');
}

static finishSizePrefixedOrbitTrack_FullBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'ORBI', true);
}

static createOrbitTrack_Full(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, idOnOrbitOffset:flatbuffers.Offset, satNo:number, onOrbitOffset:flatbuffers.Offset, origObjectIdOffset:flatbuffers.Offset, idElsetOffset:flatbuffers.Offset, tsOffset:flatbuffers.Offset, lat:number, lon:number, alt:number, rdfRf:number, callSignOffset:flatbuffers.Offset, rptNumOffset:flatbuffers.Offset, objIdent:OrbitTrack_Full_objIdent_Enum, identAmpOffset:flatbuffers.Offset, satStatusOffset:flatbuffers.Offset, objectType:OrbitTrack_Full_objectType_Enum, countryCodeOffset:flatbuffers.Offset, decay:number, charlieLineOffset:flatbuffers.Offset, aouTypeOffset:flatbuffers.Offset, aouDataOffset:flatbuffers.Offset, spd:number, angElev:number, cntnmnt:number, xrefOffset:flatbuffers.Offset, chXrefOffset:flatbuffers.Offset, amplificationOffset:flatbuffers.Offset, iffOffset:flatbuffers.Offset, reinforced:boolean, reduced:boolean, hq:boolean, dummy:boolean, taskForce:boolean, feint:boolean, installation:boolean, vehTypeOffset:flatbuffers.Offset, trkIdOffset:flatbuffers.Offset, trackSensorsOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, dataMode:OrbitTrack_Full_dataMode_Enum, origNetworkOffset:flatbuffers.Offset):flatbuffers.Offset {
  OrbitTrack_Full.startOrbitTrack_Full(builder);
...
unpack(): OrbitTrack_FullT {
  return new OrbitTrack_FullT(
    this.id(),
...
unpackTo(_o: OrbitTrack_FullT): void {
  _o.id = this.id();
...
export class OrbitTrack_FullT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public objIdent: OrbitTrack_Full_objIdent_Enum = OrbitTrack_Full_objIdent_Enum.ASSUMED_FRIEND,
  public identAmp: string|Uint8Array|null = null,
  public satStatus: string|Uint8Array|null = null,
  public objectType: OrbitTrack_Full_objectType_Enum = OrbitTrack_Full_objectType_Enum.DEBRIS,
  ...
  public dataMode: OrbitTrack_Full_dataMode_Enum = OrbitTrack_Full_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const aouData = OrbitTrack_Full.createAouDataVector(builder, builder.createObjectOffsetList(this.aouData));
  ...
  const trackSensors = OrbitTrack_Full.createTrackSensorsVector(builder, builder.createObjectOffsetList(this.trackSensors));
  ...
  return OrbitTrack_Full.createOrbitTrack_Full(builder,
    id,
