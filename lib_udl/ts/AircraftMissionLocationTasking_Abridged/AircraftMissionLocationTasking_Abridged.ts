 ...
 */
export class AircraftMissionLocationTasking_Abridged implements flatbuffers.IUnpackableObject<AircraftMissionLocationTasking_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AircraftMissionLocationTasking_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAircraftMissionLocationTasking_Abridged(bb:flatbuffers.ByteBuffer, obj?:AircraftMissionLocationTasking_Abridged):AircraftMissionLocationTasking_Abridged {
  return (obj || new AircraftMissionLocationTasking_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAircraftMissionLocationTasking_Abridged(bb:flatbuffers.ByteBuffer, obj?:AircraftMissionLocationTasking_Abridged):AircraftMissionLocationTasking_Abridged {
...
static startAircraftMissionLocationTasking_Abridged(builder:flatbuffers.Builder) {
...
static endAircraftMissionLocationTasking_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishAircraftMissionLocationTasking_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRC');
}

static finishSizePrefixedAircraftMissionLocationTasking_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'AIRC', true);
}

static createAircraftMissionLocationTasking_Abridged(builder:flatbuffers.Builder, startTimeOffset:flatbuffers.Offset, endTimeOffset:flatbuffers.Offset, msnLocNameOffset:flatbuffers.Offset, alt:number, airMsnPriOffset:flatbuffers.Offset, areaGeoRad:number, msnLocPtNameOffset:flatbuffers.Offset, msnLocPtLat:number, msnLocPtLon:number, msnLocPtBarTOffset:flatbuffers.Offset):flatbuffers.Offset {
  AircraftMissionLocationTasking_Abridged.startAircraftMissionLocationTasking_Abridged(builder);
...
unpack(): AircraftMissionLocationTasking_AbridgedT {
  return new AircraftMissionLocationTasking_AbridgedT(
    this.startTime(),
    this.endTime(),
    this.msnLocName(),
    this.alt(),
...
unpackTo(_o: AircraftMissionLocationTasking_AbridgedT): void {
...
export class AircraftMissionLocationTasking_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AircraftMissionLocationTasking_Abridged.createAircraftMissionLocationTasking_Abridged(builder,
    startTime,
    endTime,
    msnLocName,
    this.alt,
