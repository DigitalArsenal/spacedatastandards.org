...
import { Scientific_Abridged_dataMode_Enum } from './scientific-abridged-data-mode-enum.js';


/**
 * /// Scientific or other data from Seradata.
 */
export class Scientific_Abridged implements flatbuffers.IUnpackableObject<Scientific_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):Scientific_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsScientific_Abridged(bb:flatbuffers.ByteBuffer, obj?:Scientific_Abridged):Scientific_Abridged {
  return (obj || new Scientific_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsScientific_Abridged(bb:flatbuffers.ByteBuffer, obj?:Scientific_Abridged):Scientific_Abridged {
 ...
 * Constraints: Minimum length = 1, Maximum length = 32
 */
dataMode():Scientific_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 32);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : Scientific_Abridged_dataMode_Enum.REAL;
}
...
static startScientific_Abridged(builder:flatbuffers.Builder) {
...
static addDataMode(builder:flatbuffers.Builder, dataMode:Scientific_Abridged_dataMode_Enum) {
  builder.addFieldInt8(14, dataMode, Scientific_Abridged_dataMode_Enum.REAL);
}
...
static endScientific_Abridged(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  return offset;
}

static finishScientific_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SCIE');
}

static finishSizePrefixedScientific_AbridgedBuffer(builder:flatbuffers.Builder, offset:flatbuffers.Offset) {
  builder.finish(offset, 'SCIE', true);
}

static createScientific_Abridged(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, classificationMarkingOffset:flatbuffers.Offset, spacecraftIdOffset:flatbuffers.Offset, hostedForCompanyOrgIdOffset:flatbuffers.Offset, manufacturerOrgIdOffset:flatbuffers.Offset, payloadCategoryOffset:flatbuffers.Offset, nameOffset:flatbuffers.Offset, frequencyBandOffset:flatbuffers.Offset, notesOffset:flatbuffers.Offset, createdAtOffset:flatbuffers.Offset, createdByOffset:flatbuffers.Offset, sourceOffset:flatbuffers.Offset, originOffset:flatbuffers.Offset, origNetworkOffset:flatbuffers.Offset, dataMode:Scientific_Abridged_dataMode_Enum, idEntityOffset:flatbuffers.Offset):flatbuffers.Offset {
  Scientific_Abridged.startScientific_Abridged(builder);
...
unpack(): Scientific_AbridgedT {
  return new Scientific_AbridgedT(
    this.id(),
...
unpackTo(_o: Scientific_AbridgedT): void {
  _o.id = this.id();
...
export class Scientific_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public dataMode: Scientific_Abridged_dataMode_Enum = Scientific_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Scientific_Abridged.createScientific_Abridged(builder,
    id,
