 ...
 */
export class AirEventTankers_Full implements flatbuffers.IUnpackableObject<AirEventTankers_FullT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AirEventTankers_Full {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAirEventTankers_Full(bb:flatbuffers.ByteBuffer, obj?:AirEventTankers_Full):AirEventTankers_Full {
  return (obj || new AirEventTankers_Full()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAirEventTankers_Full(bb:flatbuffers.ByteBuffer, obj?:AirEventTankers_Full):AirEventTankers_Full {
...
static startAirEventTankers_Full(builder:flatbuffers.Builder) {
...
unpack(): AirEventTankers_FullT {
  return new AirEventTankers_FullT(
    this.idTankerSortie(),
...
unpackTo(_o: AirEventTankers_FullT): void {
...
export class AirEventTankers_FullT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AirEventTankers_Full.createAirEventTankers_Full(builder,
    idTankerSortie,
    idTankerMission,
    idTankerAirfield,
    externalTankerId,
