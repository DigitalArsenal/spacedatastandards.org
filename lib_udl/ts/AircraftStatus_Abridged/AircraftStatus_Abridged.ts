...
import { AircraftStatus_Abridged_airToAirStatus_Enum } from './AircraftStatus_Abridged_airToAirStatus_Enum.js';
import { AircraftStatus_Abridged_airToGroundStatus_Enum } from './AircraftStatus_Abridged_airToGroundStatus_Enum.js';
import { AircraftStatus_Abridged_dataMode_Enum } from './AircraftStatus_Abridged_dataMode_Enum.js';
 ...
 */
export class AircraftStatus_Abridged implements flatbuffers.IUnpackableObject<AircraftStatus_AbridgedT> {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):AircraftStatus_Abridged {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsAircraftStatus_Abridged(bb:flatbuffers.ByteBuffer, obj?:AircraftStatus_Abridged):AircraftStatus_Abridged {
  return (obj || new AircraftStatus_Abridged()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsAircraftStatus_Abridged(bb:flatbuffers.ByteBuffer, obj?:AircraftStatus_Abridged):AircraftStatus_Abridged {
 ...
 * Constraints: Minimum length = 0, Maximum length = 16
 */
airToAirStatus():AircraftStatus_Abridged_airToAirStatus_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 44);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AircraftStatus_Abridged_airToAirStatus_Enum.OPERATIONAL;
}
 ...
 * Constraints: Minimum length = 0, Maximum length = 16
 */
airToGroundStatus():AircraftStatus_Abridged_airToGroundStatus_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 46);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AircraftStatus_Abridged_airToGroundStatus_Enum.OPERATIONAL;
}
 ...
 */
dataMode():AircraftStatus_Abridged_dataMode_Enum {
  const offset = this.bb!.__offset(this.bb_pos, 104);
  return offset ? this.bb!.readInt8(this.bb_pos + offset) : AircraftStatus_Abridged_dataMode_Enum.REAL;
}
...
static startAircraftStatus_Abridged(builder:flatbuffers.Builder) {
...
static addAirToAirStatus(builder:flatbuffers.Builder, airToAirStatus:AircraftStatus_Abridged_airToAirStatus_Enum) {
  builder.addFieldInt8(20, airToAirStatus, AircraftStatus_Abridged_airToAirStatus_Enum.OPERATIONAL);
}

static addAirToGroundStatus(builder:flatbuffers.Builder, airToGroundStatus:AircraftStatus_Abridged_airToGroundStatus_Enum) {
  builder.addFieldInt8(21, airToGroundStatus, AircraftStatus_Abridged_airToGroundStatus_Enum.OPERATIONAL);
}
...
static addDataMode(builder:flatbuffers.Builder, dataMode:AircraftStatus_Abridged_dataMode_Enum) {
  builder.addFieldInt8(50, dataMode, AircraftStatus_Abridged_dataMode_Enum.REAL);
}
...
unpack(): AircraftStatus_AbridgedT {
  return new AircraftStatus_AbridgedT(
    this.id(),
    ...
    this.bb!.createScalarList<string>(this.inventory.bind(this), this.inventoryLength()),
    this.bb!.createScalarList<string>(this.inventoryMin.bind(this), this.inventoryMinLength()),
    this.bb!.createScalarList<string>(this.inventoryMax.bind(this), this.inventoryMaxLength()),
    this.bb!.createScalarList<string>(this.unavailableSys.bind(this), this.unavailableSysLength()),
    this.bb!.createScalarList<string>(this.additionalSys.bind(this), this.additionalSysLength()),
    this.notes(),
    this.mxRemark(),
    this.maintStatus(),
...
unpackTo(_o: AircraftStatus_AbridgedT): void {
  _o.id = this.id();
  ...
  _o.inventory = this.bb!.createScalarList<string>(this.inventory.bind(this), this.inventoryLength());
  _o.inventoryMin = this.bb!.createScalarList<string>(this.inventoryMin.bind(this), this.inventoryMinLength());
  _o.inventoryMax = this.bb!.createScalarList<string>(this.inventoryMax.bind(this), this.inventoryMaxLength());
  _o.unavailableSys = this.bb!.createScalarList<string>(this.unavailableSys.bind(this), this.unavailableSysLength());
  _o.additionalSys = this.bb!.createScalarList<string>(this.additionalSys.bind(this), this.additionalSysLength());
  _o.notes = this.notes();
...
export class AircraftStatus_AbridgedT implements flatbuffers.IGeneratedObject {
constructor(
  ...
  public airToAirStatus: AircraftStatus_Abridged_airToAirStatus_Enum = AircraftStatus_Abridged_airToAirStatus_Enum.OPERATIONAL,
  public airToGroundStatus: AircraftStatus_Abridged_airToGroundStatus_Enum = AircraftStatus_Abridged_airToGroundStatus_Enum.OPERATIONAL,
  ...
  public dataMode: AircraftStatus_Abridged_dataMode_Enum = AircraftStatus_Abridged_dataMode_Enum.REAL,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const inventory = AircraftStatus_Abridged.createInventoryVector(builder, builder.createObjectOffsetList(this.inventory));
  const inventoryMin = AircraftStatus_Abridged.createInventoryMinVector(builder, builder.createObjectOffsetList(this.inventoryMin));
  const inventoryMax = AircraftStatus_Abridged.createInventoryMaxVector(builder, builder.createObjectOffsetList(this.inventoryMax));
  const unavailableSys = AircraftStatus_Abridged.createUnavailableSysVector(builder, builder.createObjectOffsetList(this.unavailableSys));
  const additionalSys = AircraftStatus_Abridged.createAdditionalSysVector(builder, builder.createObjectOffsetList(this.additionalSys));
  ...
  return AircraftStatus_Abridged.createAircraftStatus_Abridged(builder,
    id,
