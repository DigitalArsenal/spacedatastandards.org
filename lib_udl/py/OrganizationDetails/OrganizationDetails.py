...
class OrganizationDetails(object):
    ...
    @classmethod
    def GetRootAsOrganizationDetails(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def OrganizationDetailsBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def OrganizationDetailsStart(builder):
    builder.StartObject(39)

def Start(builder):
    OrganizationDetailsStart(builder)

def OrganizationDetailsAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    OrganizationDetailsAddId(builder, id)

def OrganizationDetailsAddIdOrganization(builder, idOrganization):
...
def AddIdOrganization(builder, idOrganization):
    OrganizationDetailsAddIdOrganization(builder, idOrganization)

def OrganizationDetailsAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    OrganizationDetailsAddClassificationMarking(builder, classificationMarking)

def OrganizationDetailsAddName(builder, name):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)

def AddName(builder, name):
    OrganizationDetailsAddName(builder, name)

def OrganizationDetailsAddEmail(builder, email):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(email), 0)

def AddEmail(builder, email):
    OrganizationDetailsAddEmail(builder, email)

def OrganizationDetailsAddAddress1(builder, address1):
...
def AddAddress1(builder, address1):
    OrganizationDetailsAddAddress1(builder, address1)

def OrganizationDetailsAddAddress2(builder, address2):
...
def AddAddress2(builder, address2):
    OrganizationDetailsAddAddress2(builder, address2)

def OrganizationDetailsAddAddress3(builder, address3):
...
def AddAddress3(builder, address3):
    OrganizationDetailsAddAddress3(builder, address3)

def OrganizationDetailsAddGeoAdminLevel1(builder, geoAdminLevel1):
...
def AddGeoAdminLevel1(builder, geoAdminLevel1):
    OrganizationDetailsAddGeoAdminLevel1(builder, geoAdminLevel1)

def OrganizationDetailsAddGeoAdminLevel2(builder, geoAdminLevel2):
...
def AddGeoAdminLevel2(builder, geoAdminLevel2):
    OrganizationDetailsAddGeoAdminLevel2(builder, geoAdminLevel2)

def OrganizationDetailsAddGeoAdminLevel3(builder, geoAdminLevel3):
...
def AddGeoAdminLevel3(builder, geoAdminLevel3):
    OrganizationDetailsAddGeoAdminLevel3(builder, geoAdminLevel3)

def OrganizationDetailsAddPostalCode(builder, postalCode):
...
def AddPostalCode(builder, postalCode):
    OrganizationDetailsAddPostalCode(builder, postalCode)

def OrganizationDetailsAddDescription(builder, description):
    builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(description), 0)

def AddDescription(builder, description):
    OrganizationDetailsAddDescription(builder, description)

def OrganizationDetailsAddFormerOrgId(builder, formerOrgId):
...
def AddFormerOrgId(builder, formerOrgId):
    OrganizationDetailsAddFormerOrgId(builder, formerOrgId)

def OrganizationDetailsAddParentOrgId(builder, parentOrgId):
...
def AddParentOrgId(builder, parentOrgId):
    OrganizationDetailsAddParentOrgId(builder, parentOrgId)

def OrganizationDetailsAddFinancialYearEndDate(builder, financialYearEndDate):
...
def AddFinancialYearEndDate(builder, financialYearEndDate):
    OrganizationDetailsAddFinancialYearEndDate(builder, financialYearEndDate)

def OrganizationDetailsAddRevenue(builder, revenue):
    builder.PrependFloat64Slot(16, revenue, 0.0)

def AddRevenue(builder, revenue):
    OrganizationDetailsAddRevenue(builder, revenue)

def OrganizationDetailsAddProfit(builder, profit):
    builder.PrependFloat64Slot(17, profit, 0.0)

def AddProfit(builder, profit):
    OrganizationDetailsAddProfit(builder, profit)

def OrganizationDetailsAddEbitda(builder, ebitda):
    builder.PrependFloat64Slot(18, ebitda, 0.0)

def AddEbitda(builder, ebitda):
    OrganizationDetailsAddEbitda(builder, ebitda)

def OrganizationDetailsAddFtes(builder, ftes):
    builder.PrependInt32Slot(19, ftes, 0)

def AddFtes(builder, ftes):
    OrganizationDetailsAddFtes(builder, ftes)

def OrganizationDetailsAddBroker(builder, broker):
...
def AddRiskManager(builder, riskManager):
    OrganizationDetailsAddRiskManager(builder, riskManager)

def OrganizationDetailsAddMassRanking(builder, massRanking):
    builder.PrependInt32Slot(25, massRanking, 0)

def AddMassRanking(builder, massRanking):
    OrganizationDetailsAddMassRanking(builder, massRanking)

def OrganizationDetailsAddRevenueRanking(builder, revenueRanking):
    builder.PrependInt32Slot(26, revenueRanking, 0)

def AddRevenueRanking(builder, revenueRanking):
    OrganizationDetailsAddRevenueRanking(builder, revenueRanking)

def OrganizationDetailsAddFinancialNotes(builder, financialNotes):
...
def AddFinancialNotes(builder, financialNotes):
    OrganizationDetailsAddFinancialNotes(builder, financialNotes)

def OrganizationDetailsAddServicesNotes(builder, servicesNotes):
...
def AddServicesNotes(builder, servicesNotes):
    OrganizationDetailsAddServicesNotes(builder, servicesNotes)

def OrganizationDetailsAddFleetPlanNotes(builder, fleetPlanNotes):
...
def AddFleetPlanNotes(builder, fleetPlanNotes):
    OrganizationDetailsAddFleetPlanNotes(builder, fleetPlanNotes)

def OrganizationDetailsAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    OrganizationDetailsAddSource(builder, source)

def OrganizationDetailsAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(31, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    OrganizationDetailsAddOrigin(builder, origin)

def OrganizationDetailsAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(32, dataMode, 0)

def AddDataMode(builder, dataMode):
    OrganizationDetailsAddDataMode(builder, dataMode)

def OrganizationDetailsAddTags(builder, tags):
    builder.PrependUOffsetTRelativeSlot(33, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)

def AddTags(builder, tags):
    OrganizationDetailsAddTags(builder, tags)

def OrganizationDetailsStartTagsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartTagsVector(builder, numElems):
    return OrganizationDetailsStartTagsVector(builder, numElems)

def OrganizationDetailsAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(34, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    OrganizationDetailsAddCreatedAt(builder, createdAt)

def OrganizationDetailsAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(35, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    OrganizationDetailsAddCreatedBy(builder, createdBy)

def OrganizationDetailsAddUpdatedAt(builder, updatedAt):
    builder.PrependUOffsetTRelativeSlot(36, flatbuffers.number_types.UOffsetTFlags.py_type(updatedAt), 0)

def AddUpdatedAt(builder, updatedAt):
    OrganizationDetailsAddUpdatedAt(builder, updatedAt)

def OrganizationDetailsAddUpdatedBy(builder, updatedBy):
...
def AddUpdatedBy(builder, updatedBy):
    OrganizationDetailsAddUpdatedBy(builder, updatedBy)

def OrganizationDetailsAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(38, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    OrganizationDetailsAddOrigNetwork(builder, origNetwork)

def OrganizationDetailsEnd(builder):
    return builder.EndObject()

def End(builder):
    return OrganizationDetailsEnd(builder)
...
class OrganizationDetailsT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        ...
        organizationDetails.Init(buf, pos)
        return cls.InitFromObj(organizationDetails)
    ...
    @classmethod
    def InitFromObj(cls, organizationDetails):
        x = OrganizationDetailsT()
        x._UnPack(organizationDetails)
        return x

    # OrganizationDetailsT
    def _UnPack(self, organizationDetails):
        if organizationDetails is None:
            return
        self.id = organizationDetails.Id()
        self.idOrganization = organizationDetails.IdOrganization()
        self.classificationMarking = organizationDetails.ClassificationMarking()
        self.name = organizationDetails.Name()
        self.email = organizationDetails.Email()
        self.address1 = organizationDetails.Address1()
        self.address2 = organizationDetails.Address2()
        self.address3 = organizationDetails.Address3()
        self.geoAdminLevel1 = organizationDetails.GeoAdminLevel1()
        self.geoAdminLevel2 = organizationDetails.GeoAdminLevel2()
        self.geoAdminLevel3 = organizationDetails.GeoAdminLevel3()
        self.postalCode = organizationDetails.PostalCode()
        self.description = organizationDetails.Description()
        self.formerOrgId = organizationDetails.FormerOrgId()
        self.parentOrgId = organizationDetails.ParentOrgId()
        self.financialYearEndDate = organizationDetails.FinancialYearEndDate()
        self.revenue = organizationDetails.Revenue()
        self.profit = organizationDetails.Profit()
        self.ebitda = organizationDetails.Ebitda()
        self.ftes = organizationDetails.Ftes()
        self.broker = organizationDetails.Broker()
        self.ceo = organizationDetails.Ceo()
        self.cfo = organizationDetails.Cfo()
        self.cto = organizationDetails.Cto()
        self.riskManager = organizationDetails.RiskManager()
        self.massRanking = organizationDetails.MassRanking()
        self.revenueRanking = organizationDetails.RevenueRanking()
        self.financialNotes = organizationDetails.FinancialNotes()
        self.servicesNotes = organizationDetails.ServicesNotes()
        self.fleetPlanNotes = organizationDetails.FleetPlanNotes()
        self.source = organizationDetails.Source()
        self.origin = organizationDetails.Origin()
        self.dataMode = organizationDetails.DataMode()
        if not organizationDetails.TagsIsNone():
            self.tags = []
            for i in range(organizationDetails.TagsLength()):
                self.tags.append(organizationDetails.Tags(i))
        self.createdAt = organizationDetails.CreatedAt()
        self.createdBy = organizationDetails.CreatedBy()
        self.updatedAt = organizationDetails.UpdatedAt()
        self.updatedBy = organizationDetails.UpdatedBy()
        self.origNetwork = organizationDetails.OrigNetwork()
    ...
    def Pack(self, builder):
        ...
        if self.tags is not None:
            ...
            OrganizationDetailsStartTagsVector(builder, len(self.tags))
        ...
        if self.financialYearEndDate is not None:
            OrganizationDetailsAddFinancialYearEndDate(builder, financialYearEndDate)
        OrganizationDetailsAddRevenue(builder, self.revenue)
        OrganizationDetailsAddProfit(builder, self.profit)
        OrganizationDetailsAddEbitda(builder, self.ebitda)
        OrganizationDetailsAddFtes(builder, self.ftes)
        if self.broker is not None:
            OrganizationDetailsAddBroker(builder, broker)
        if self.ceo is not None:
            OrganizationDetailsAddCeo(builder, ceo)
        ...
        if self.riskManager is not None:
            OrganizationDetailsAddRiskManager(builder, riskManager)
        OrganizationDetailsAddMassRanking(builder, self.massRanking)
        OrganizationDetailsAddRevenueRanking(builder, self.revenueRanking)
        if self.financialNotes is not None:
            OrganizationDetailsAddFinancialNotes(builder, financialNotes)
        if self.servicesNotes is not None:
            OrganizationDetailsAddServicesNotes(builder, servicesNotes)
        ...
        if self.origin is not None:
            OrganizationDetailsAddOrigin(builder, origin)
        OrganizationDetailsAddDataMode(builder, self.dataMode)
        if self.tags is not None:
            OrganizationDetailsAddTags(builder, tags)
        if self.createdAt is not None:
            OrganizationDetailsAddCreatedAt(builder, createdAt)
        ...
        if self.origNetwork is not None:
            OrganizationDetailsAddOrigNetwork(builder, origNetwork)
        organizationDetails = OrganizationDetailsEnd(builder)
