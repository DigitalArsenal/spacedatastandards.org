...
class Eop_Full(object):
    ...
    @classmethod
    def GetRootAsEop_Full(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def Eop_FullBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf, offset, b"\x45\x4F\x50\x46", size_prefixed=size_prefixed)
...
def Eop_FullStart(builder):
    builder.StartObject(39)

def Start(builder):
    Eop_FullStart(builder)

def Eop_FullAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    Eop_FullAddId(builder, id)

def Eop_FullAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    Eop_FullAddClassificationMarking(builder, classificationMarking)

def Eop_FullAddEopDate(builder, eopDate):
...
def AddEopDate(builder, eopDate):
    Eop_FullAddEopDate(builder, eopDate)

def Eop_FullAddPolarMotionState(builder, polarMotionState):
    builder.PrependInt8Slot(3, polarMotionState, 0)

def AddPolarMotionState(builder, polarMotionState):
    Eop_FullAddPolarMotionState(builder, polarMotionState)

def Eop_FullAddPolarMotionX(builder, polarMotionX):
    builder.PrependFloat64Slot(4, polarMotionX, 0.0)

def AddPolarMotionX(builder, polarMotionX):
    Eop_FullAddPolarMotionX(builder, polarMotionX)

def Eop_FullAddPolarMotionXunc(builder, polarMotionXunc):
    builder.PrependFloat64Slot(5, polarMotionXunc, 0.0)

def AddPolarMotionXunc(builder, polarMotionXunc):
    Eop_FullAddPolarMotionXunc(builder, polarMotionXunc)

def Eop_FullAddPolarMotionY(builder, polarMotionY):
    builder.PrependFloat64Slot(6, polarMotionY, 0.0)

def AddPolarMotionY(builder, polarMotionY):
    Eop_FullAddPolarMotionY(builder, polarMotionY)

def Eop_FullAddPolarMotionYunc(builder, polarMotionYunc):
    builder.PrependFloat64Slot(7, polarMotionYunc, 0.0)

def AddPolarMotionYunc(builder, polarMotionYunc):
    Eop_FullAddPolarMotionYunc(builder, polarMotionYunc)

def Eop_FullAddUt1Utcstate(builder, ut1Utcstate):
    builder.PrependInt8Slot(8, ut1Utcstate, 0)

def AddUt1Utcstate(builder, ut1Utcstate):
    Eop_FullAddUt1Utcstate(builder, ut1Utcstate)

def Eop_FullAddUt1Utc(builder, ut1Utc):
    builder.PrependFloat64Slot(9, ut1Utc, 0.0)

def AddUt1Utc(builder, ut1Utc):
    Eop_FullAddUt1Utc(builder, ut1Utc)

def Eop_FullAddUt1Utcunc(builder, ut1Utcunc):
    builder.PrependFloat64Slot(10, ut1Utcunc, 0.0)

def AddUt1Utcunc(builder, ut1Utcunc):
    Eop_FullAddUt1Utcunc(builder, ut1Utcunc)

def Eop_FullAddLod(builder, lod):
    builder.PrependFloat64Slot(11, lod, 0.0)

def AddLod(builder, lod):
    Eop_FullAddLod(builder, lod)

def Eop_FullAddLodUnc(builder, lodUnc):
    builder.PrependFloat64Slot(12, lodUnc, 0.0)

def AddLodUnc(builder, lodUnc):
    Eop_FullAddLodUnc(builder, lodUnc)

def Eop_FullAddNutationState(builder, nutationState):
    builder.PrependInt8Slot(13, nutationState, 0)

def AddNutationState(builder, nutationState):
    Eop_FullAddNutationState(builder, nutationState)

def Eop_FullAddDPsi(builder, dPsi):
    builder.PrependFloat64Slot(14, dPsi, 0.0)

def AddDPsi(builder, dPsi):
    Eop_FullAddDPsi(builder, dPsi)

def Eop_FullAddDPsiunc(builder, dPsiunc):
    builder.PrependFloat64Slot(15, dPsiunc, 0.0)

def AddDPsiunc(builder, dPsiunc):
    Eop_FullAddDPsiunc(builder, dPsiunc)

def Eop_FullAddDEpsilon(builder, dEpsilon):
    builder.PrependFloat64Slot(16, dEpsilon, 0.0)

def AddDEpsilon(builder, dEpsilon):
    Eop_FullAddDEpsilon(builder, dEpsilon)

def Eop_FullAddDEpsilonUnc(builder, dEpsilonUnc):
    builder.PrependFloat64Slot(17, dEpsilonUnc, 0.0)

def AddDEpsilonUnc(builder, dEpsilonUnc):
    Eop_FullAddDEpsilonUnc(builder, dEpsilonUnc)

def Eop_FullAddDX(builder, dX):
    builder.PrependFloat64Slot(18, dX, 0.0)

def AddDX(builder, dX):
    Eop_FullAddDX(builder, dX)

def Eop_FullAddDXunc(builder, dXunc):
    builder.PrependFloat64Slot(19, dXunc, 0.0)

def AddDXunc(builder, dXunc):
    Eop_FullAddDXunc(builder, dXunc)

def Eop_FullAddDY(builder, dY):
    builder.PrependFloat64Slot(20, dY, 0.0)

def AddDY(builder, dY):
    Eop_FullAddDY(builder, dY)

def Eop_FullAddDYunc(builder, dYunc):
    builder.PrependFloat64Slot(21, dYunc, 0.0)

def AddDYunc(builder, dYunc):
    Eop_FullAddDYunc(builder, dYunc)

def Eop_FullAddPolarMotionXb(builder, polarMotionXb):
    builder.PrependFloat64Slot(22, polarMotionXb, 0.0)

def AddPolarMotionXb(builder, polarMotionXb):
    Eop_FullAddPolarMotionXb(builder, polarMotionXb)

def Eop_FullAddPolarMotionYb(builder, polarMotionYb):
    builder.PrependFloat64Slot(23, polarMotionYb, 0.0)

def AddPolarMotionYb(builder, polarMotionYb):
    Eop_FullAddPolarMotionYb(builder, polarMotionYb)

def Eop_FullAddUt1Utcb(builder, ut1Utcb):
    builder.PrependFloat64Slot(24, ut1Utcb, 0.0)

def AddUt1Utcb(builder, ut1Utcb):
    Eop_FullAddUt1Utcb(builder, ut1Utcb)

def Eop_FullAddDPsib(builder, dPsib):
    builder.PrependFloat64Slot(25, dPsib, 0.0)

def AddDPsib(builder, dPsib):
    Eop_FullAddDPsib(builder, dPsib)

def Eop_FullAddDEpsilonB(builder, dEpsilonB):
    builder.PrependFloat64Slot(26, dEpsilonB, 0.0)

def AddDEpsilonB(builder, dEpsilonB):
    Eop_FullAddDEpsilonB(builder, dEpsilonB)

def Eop_FullAddDXb(builder, dXb):
    builder.PrependFloat64Slot(27, dXb, 0.0)

def AddDXb(builder, dXb):
    Eop_FullAddDXb(builder, dXb)

def Eop_FullAddDYb(builder, dYb):
    builder.PrependFloat64Slot(28, dYb, 0.0)

def AddDYb(builder, dYb):
    Eop_FullAddDYb(builder, dYb)

def Eop_FullAddPrecessionNutationStd(builder, precessionNutationStd):
...
def AddPrecessionNutationStd(builder, precessionNutationStd):
    Eop_FullAddPrecessionNutationStd(builder, precessionNutationStd)

def Eop_FullAddRawFileUri(builder, rawFileUri):
...
def AddUpdatedBy(builder, updatedBy):
    Eop_FullAddUpdatedBy(builder, updatedBy)

def Eop_FullAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(38, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    Eop_FullAddOrigNetwork(builder, origNetwork)

def Eop_FullEnd(builder):
    return builder.EndObject()

def End(builder):
    return Eop_FullEnd(builder)


class Eop_FullT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        eopFull = Eop_Full()
        eopFull.Init(buf, pos)
        return cls.InitFromObj(eopFull)
    ...
    @classmethod
    def InitFromObj(cls, eopFull):
        x = Eop_FullT()
        x._UnPack(eopFull)
        return x

    # Eop_FullT
    def _UnPack(self, eopFull):
        if eopFull is None:
            return
        self.id = eopFull.Id()
        self.classificationMarking = eopFull.ClassificationMarking()
        self.eopDate = eopFull.EopDate()
        self.polarMotionState = eopFull.PolarMotionState()
        self.polarMotionX = eopFull.PolarMotionX()
        self.polarMotionXunc = eopFull.PolarMotionXunc()
        self.polarMotionY = eopFull.PolarMotionY()
        self.polarMotionYunc = eopFull.PolarMotionYunc()
        self.ut1Utcstate = eopFull.Ut1Utcstate()
        self.ut1Utc = eopFull.Ut1Utc()
        self.ut1Utcunc = eopFull.Ut1Utcunc()
        self.lod = eopFull.Lod()
        self.lodUnc = eopFull.LodUnc()
        self.nutationState = eopFull.NutationState()
        self.dPsi = eopFull.DPsi()
        self.dPsiunc = eopFull.DPsiunc()
        self.dEpsilon = eopFull.DEpsilon()
        self.dEpsilonUnc = eopFull.DEpsilonUnc()
        self.dX = eopFull.DX()
        self.dXunc = eopFull.DXunc()
        self.dY = eopFull.DY()
        self.dYunc = eopFull.DYunc()
        self.polarMotionXb = eopFull.PolarMotionXb()
        self.polarMotionYb = eopFull.PolarMotionYb()
        self.ut1Utcb = eopFull.Ut1Utcb()
        self.dPsib = eopFull.DPsib()
        self.dEpsilonB = eopFull.DEpsilonB()
        self.dXb = eopFull.DXb()
        self.dYb = eopFull.DYb()
        self.precessionNutationStd = eopFull.PrecessionNutationStd()
        self.rawFileUri = eopFull.RawFileUri()
        self.source = eopFull.Source()
        self.origin = eopFull.Origin()
        self.dataMode = eopFull.DataMode()
        self.createdAt = eopFull.CreatedAt()
        self.createdBy = eopFull.CreatedBy()
        self.updatedAt = eopFull.UpdatedAt()
        self.updatedBy = eopFull.UpdatedBy()
        self.origNetwork = eopFull.OrigNetwork()
    ...
    def Pack(self, builder):
        ...
        if self.eopDate is not None:
            Eop_FullAddEopDate(builder, eopDate)
        Eop_FullAddPolarMotionState(builder, self.polarMotionState)
        Eop_FullAddPolarMotionX(builder, self.polarMotionX)
        Eop_FullAddPolarMotionXunc(builder, self.polarMotionXunc)
        Eop_FullAddPolarMotionY(builder, self.polarMotionY)
        Eop_FullAddPolarMotionYunc(builder, self.polarMotionYunc)
        Eop_FullAddUt1Utcstate(builder, self.ut1Utcstate)
        Eop_FullAddUt1Utc(builder, self.ut1Utc)
        Eop_FullAddUt1Utcunc(builder, self.ut1Utcunc)
        Eop_FullAddLod(builder, self.lod)
        Eop_FullAddLodUnc(builder, self.lodUnc)
        Eop_FullAddNutationState(builder, self.nutationState)
        Eop_FullAddDPsi(builder, self.dPsi)
        Eop_FullAddDPsiunc(builder, self.dPsiunc)
        Eop_FullAddDEpsilon(builder, self.dEpsilon)
        Eop_FullAddDEpsilonUnc(builder, self.dEpsilonUnc)
        Eop_FullAddDX(builder, self.dX)
        Eop_FullAddDXunc(builder, self.dXunc)
        Eop_FullAddDY(builder, self.dY)
        Eop_FullAddDYunc(builder, self.dYunc)
        Eop_FullAddPolarMotionXb(builder, self.polarMotionXb)
        Eop_FullAddPolarMotionYb(builder, self.polarMotionYb)
        Eop_FullAddUt1Utcb(builder, self.ut1Utcb)
        Eop_FullAddDPsib(builder, self.dPsib)
        Eop_FullAddDEpsilonB(builder, self.dEpsilonB)
        Eop_FullAddDXb(builder, self.dXb)
        Eop_FullAddDYb(builder, self.dYb)
        if self.precessionNutationStd is not None:
            Eop_FullAddPrecessionNutationStd(builder, precessionNutationStd)
        if self.rawFileUri is not None:
            Eop_FullAddRawFileUri(builder, rawFileUri)
        ...
        if self.origin is not None:
            Eop_FullAddOrigin(builder, origin)
        Eop_FullAddDataMode(builder, self.dataMode)
        if self.createdAt is not None:
            Eop_FullAddCreatedAt(builder, createdAt)
        if self.createdBy is not None:
            Eop_FullAddCreatedBy(builder, createdBy)
