...
class BeamContour_Ingest(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsBeamContour_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def BeamContour_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def BeamContour_IngestStart(builder):
    builder.StartObject(19)

def Start(builder):
    BeamContour_IngestStart(builder)

def BeamContour_IngestAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    BeamContour_IngestAddId(builder, id)

def BeamContour_IngestAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    BeamContour_IngestAddClassificationMarking(builder, classificationMarking)

def BeamContour_IngestAddIdBeam(builder, idBeam):
...
def AddIdBeam(builder, idBeam):
    BeamContour_IngestAddIdBeam(builder, idBeam)

def BeamContour_IngestAddType(builder, type):
    builder.PrependInt8Slot(3, type, 0)

def AddType(builder, type):
    BeamContour_IngestAddType(builder, type)

def BeamContour_IngestAddContourIdx(builder, contourIdx):
    builder.PrependInt32Slot(4, contourIdx, 0)

def AddContourIdx(builder, contourIdx):
    BeamContour_IngestAddContourIdx(builder, contourIdx)

def BeamContour_IngestAddGain(builder, gain):
    builder.PrependFloat64Slot(5, gain, 0.0)

def AddGain(builder, gain):
    BeamContour_IngestAddGain(builder, gain)

def BeamContour_IngestAddRegionName(builder, regionName):
...
def AddRegionName(builder, regionName):
    BeamContour_IngestAddRegionName(builder, regionName)

def BeamContour_IngestAddGeography(builder, geography):
...
def AddGeography(builder, geography):
    BeamContour_IngestAddGeography(builder, geography)

def BeamContour_IngestAddGeographyText(builder, geographyText):
...
def AddGeographyText(builder, geographyText):
    BeamContour_IngestAddGeographyText(builder, geographyText)

def BeamContour_IngestAddGeographyJson(builder, geographyJson):
...
def AddGeographyJson(builder, geographyJson):
    BeamContour_IngestAddGeographyJson(builder, geographyJson)

def BeamContour_IngestAddGeographyType(builder, geographyType):
...
def AddGeographyType(builder, geographyType):
    BeamContour_IngestAddGeographyType(builder, geographyType)

def BeamContour_IngestAddGeographyNdims(builder, geographyNdims):
    builder.PrependInt32Slot(11, geographyNdims, 0)

def AddGeographyNdims(builder, geographyNdims):
    BeamContour_IngestAddGeographyNdims(builder, geographyNdims)

def BeamContour_IngestAddGeographySrid(builder, geographySrid):
    builder.PrependInt32Slot(12, geographySrid, 0)

def AddGeographySrid(builder, geographySrid):
    BeamContour_IngestAddGeographySrid(builder, geographySrid)

def BeamContour_IngestAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    BeamContour_IngestAddCreatedAt(builder, createdAt)

def BeamContour_IngestAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    BeamContour_IngestAddCreatedBy(builder, createdBy)

def BeamContour_IngestAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    BeamContour_IngestAddSource(builder, source)

def BeamContour_IngestAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    BeamContour_IngestAddOrigin(builder, origin)

def BeamContour_IngestAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    BeamContour_IngestAddOrigNetwork(builder, origNetwork)

def BeamContour_IngestAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(18, dataMode, 0)

def AddDataMode(builder, dataMode):
    BeamContour_IngestAddDataMode(builder, dataMode)

def BeamContour_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return BeamContour_IngestEnd(builder)


class BeamContour_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        beamContourIngest = BeamContour_Ingest()
        beamContourIngest.Init(buf, pos)
        return cls.InitFromObj(beamContourIngest)
    ...
    @classmethod
    def InitFromObj(cls, beamContourIngest):
        x = BeamContour_IngestT()
        x._UnPack(beamContourIngest)
        return x

    # BeamContour_IngestT
    def _UnPack(self, beamContourIngest):
        if beamContourIngest is None:
            return
        self.id = beamContourIngest.Id()
        self.classificationMarking = beamContourIngest.ClassificationMarking()
        self.idBeam = beamContourIngest.IdBeam()
        self.type = beamContourIngest.Type()
        self.contourIdx = beamContourIngest.ContourIdx()
        self.gain = beamContourIngest.Gain()
        self.regionName = beamContourIngest.RegionName()
        self.geography = beamContourIngest.Geography()
        self.geographyText = beamContourIngest.GeographyText()
        self.geographyJson = beamContourIngest.GeographyJson()
        self.geographyType = beamContourIngest.GeographyType()
        self.geographyNdims = beamContourIngest.GeographyNdims()
        self.geographySrid = beamContourIngest.GeographySrid()
        self.createdAt = beamContourIngest.CreatedAt()
        self.createdBy = beamContourIngest.CreatedBy()
        self.source = beamContourIngest.Source()
        self.origin = beamContourIngest.Origin()
        self.origNetwork = beamContourIngest.OrigNetwork()
        self.dataMode = beamContourIngest.DataMode()
    ...
    def Pack(self, builder):
        ...
        if self.idBeam is not None:
            BeamContour_IngestAddIdBeam(builder, idBeam)
        BeamContour_IngestAddType(builder, self.type)
        BeamContour_IngestAddContourIdx(builder, self.contourIdx)
        BeamContour_IngestAddGain(builder, self.gain)
        if self.regionName is not None:
            BeamContour_IngestAddRegionName(builder, regionName)
        if self.geography is not None:
            BeamContour_IngestAddGeography(builder, geography)
        ...
        if self.geographyType is not None:
            BeamContour_IngestAddGeographyType(builder, geographyType)
        BeamContour_IngestAddGeographyNdims(builder, self.geographyNdims)
        BeamContour_IngestAddGeographySrid(builder, self.geographySrid)
        if self.createdAt is not None:
            BeamContour_IngestAddCreatedAt(builder, createdAt)
        if self.createdBy is not None:
            BeamContour_IngestAddCreatedBy(builder, createdBy)
        ...
        if self.origNetwork is not None:
            BeamContour_IngestAddOrigNetwork(builder, origNetwork)
        BeamContour_IngestAddDataMode(builder, self.dataMode)
        beamContourIngest = BeamContour_IngestEnd(builder)
        return beamContourIngest
