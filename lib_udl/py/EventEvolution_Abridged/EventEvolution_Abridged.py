...
class EventEvolution_Abridged(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsEventEvolution_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def EventEvolution_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def EventEvolution_AbridgedStart(builder):
    builder.StartObject(29)

def Start(builder):
    EventEvolution_AbridgedStart(builder)

def EventEvolution_AbridgedAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    EventEvolution_AbridgedAddId(builder, id)

def EventEvolution_AbridgedAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    EventEvolution_AbridgedAddClassificationMarking(builder, classificationMarking)

def EventEvolution_AbridgedAddEventId(builder, eventId):
...
def AddEventId(builder, eventId):
    EventEvolution_AbridgedAddEventId(builder, eventId)

def EventEvolution_AbridgedAddCategory(builder, category):
...
def AddCategory(builder, category):
    EventEvolution_AbridgedAddCategory(builder, category)

def EventEvolution_AbridgedAddSummary(builder, summary):
...
def AddSummary(builder, summary):
    EventEvolution_AbridgedAddSummary(builder, summary)

def EventEvolution_AbridgedAddStartTime(builder, startTime):
...
def AddStartTime(builder, startTime):
    EventEvolution_AbridgedAddStartTime(builder, startTime)

def EventEvolution_AbridgedAddEndTime(builder, endTime):
...
def AddEndTime(builder, endTime):
    EventEvolution_AbridgedAddEndTime(builder, endTime)

def EventEvolution_AbridgedAddStatus(builder, status):
    builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(status), 0)

def AddStatus(builder, status):
    EventEvolution_AbridgedAddStatus(builder, status)

def EventEvolution_AbridgedAddCountryCode(builder, countryCode):
...
def AddCountryCode(builder, countryCode):
    EventEvolution_AbridgedAddCountryCode(builder, countryCode)

def EventEvolution_AbridgedAddGeoAdminLevel1(builder, geoAdminLevel1):
...
def AddGeoAdminLevel1(builder, geoAdminLevel1):
    EventEvolution_AbridgedAddGeoAdminLevel1(builder, geoAdminLevel1)

def EventEvolution_AbridgedAddGeoAdminLevel2(builder, geoAdminLevel2):
...
def AddGeoAdminLevel2(builder, geoAdminLevel2):
    EventEvolution_AbridgedAddGeoAdminLevel2(builder, geoAdminLevel2)

def EventEvolution_AbridgedAddGeoAdminLevel3(builder, geoAdminLevel3):
...
def AddGeoAdminLevel3(builder, geoAdminLevel3):
    EventEvolution_AbridgedAddGeoAdminLevel3(builder, geoAdminLevel3)

def EventEvolution_AbridgedAddRedact(builder, redact):
    builder.PrependBoolSlot(12, redact, 0)

def AddRedact(builder, redact):
    EventEvolution_AbridgedAddRedact(builder, redact)

def EventEvolution_AbridgedAddSrcTyps(builder, srcTyps):
...
def AddSrcTyps(builder, srcTyps):
    EventEvolution_AbridgedAddSrcTyps(builder, srcTyps)

def EventEvolution_AbridgedStartSrcTypsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartSrcTypsVector(builder, numElems):
    return EventEvolution_AbridgedStartSrcTypsVector(builder, numElems)

def EventEvolution_AbridgedAddSrcIds(builder, srcIds):
...
def AddSrcIds(builder, srcIds):
    EventEvolution_AbridgedAddSrcIds(builder, srcIds)

def EventEvolution_AbridgedStartSrcIdsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartSrcIdsVector(builder, numElems):
    return EventEvolution_AbridgedStartSrcIdsVector(builder, numElems)

def EventEvolution_AbridgedAddDataDescription(builder, dataDescription):
...
def AddDataDescription(builder, dataDescription):
    EventEvolution_AbridgedAddDataDescription(builder, dataDescription)

def EventEvolution_AbridgedAddAtext(builder, atext):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(atext), 0)

def AddAtext(builder, atext):
    EventEvolution_AbridgedAddAtext(builder, atext)

def EventEvolution_AbridgedAddAgjson(builder, agjson):
    builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(agjson), 0)

def AddAgjson(builder, agjson):
    EventEvolution_AbridgedAddAgjson(builder, agjson)

def EventEvolution_AbridgedAddAtype(builder, atype):
    builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(atype), 0)

def AddAtype(builder, atype):
    EventEvolution_AbridgedAddAtype(builder, atype)

def EventEvolution_AbridgedAddAndims(builder, andims):
    builder.PrependInt32Slot(19, andims, 0)

def AddAndims(builder, andims):
    EventEvolution_AbridgedAddAndims(builder, andims)

def EventEvolution_AbridgedAddAsrid(builder, asrid):
    builder.PrependInt32Slot(20, asrid, 0)

def AddAsrid(builder, asrid):
    EventEvolution_AbridgedAddAsrid(builder, asrid)

def EventEvolution_AbridgedAddUrl(builder, url):
    builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(url), 0)

def AddUrl(builder, url):
    EventEvolution_AbridgedAddUrl(builder, url)

def EventEvolution_AbridgedStartUrlVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartUrlVector(builder, numElems):
    return EventEvolution_AbridgedStartUrlVector(builder, numElems)

def EventEvolution_AbridgedAddTags(builder, tags):
    builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)

def AddTags(builder, tags):
    EventEvolution_AbridgedAddTags(builder, tags)

def EventEvolution_AbridgedStartTagsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartTagsVector(builder, numElems):
    return EventEvolution_AbridgedStartTagsVector(builder, numElems)

def EventEvolution_AbridgedAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    EventEvolution_AbridgedAddCreatedAt(builder, createdAt)

def EventEvolution_AbridgedAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    EventEvolution_AbridgedAddCreatedBy(builder, createdBy)

def EventEvolution_AbridgedAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(25, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    EventEvolution_AbridgedAddSource(builder, source)

def EventEvolution_AbridgedAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(26, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    EventEvolution_AbridgedAddOrigin(builder, origin)

def EventEvolution_AbridgedAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    EventEvolution_AbridgedAddOrigNetwork(builder, origNetwork)

def EventEvolution_AbridgedAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(28, dataMode, 0)

def AddDataMode(builder, dataMode):
    EventEvolution_AbridgedAddDataMode(builder, dataMode)

def EventEvolution_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return EventEvolution_AbridgedEnd(builder)
...
class EventEvolution_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        eventEvolutionAbridged = EventEvolution_Abridged()
        eventEvolutionAbridged.Init(buf, pos)
        return cls.InitFromObj(eventEvolutionAbridged)
    ...
    @classmethod
    def InitFromObj(cls, eventEvolutionAbridged):
        x = EventEvolution_AbridgedT()
        x._UnPack(eventEvolutionAbridged)
        return x

    # EventEvolution_AbridgedT
    def _UnPack(self, eventEvolutionAbridged):
        if eventEvolutionAbridged is None:
            return
        self.id = eventEvolutionAbridged.Id()
        self.classificationMarking = eventEvolutionAbridged.ClassificationMarking()
        self.eventId = eventEvolutionAbridged.EventId()
        self.category = eventEvolutionAbridged.Category()
        self.summary = eventEvolutionAbridged.Summary()
        self.startTime = eventEvolutionAbridged.StartTime()
        self.endTime = eventEvolutionAbridged.EndTime()
        self.status = eventEvolutionAbridged.Status()
        self.countryCode = eventEvolutionAbridged.CountryCode()
        self.geoAdminLevel1 = eventEvolutionAbridged.GeoAdminLevel1()
        self.geoAdminLevel2 = eventEvolutionAbridged.GeoAdminLevel2()
        self.geoAdminLevel3 = eventEvolutionAbridged.GeoAdminLevel3()
        self.redact = eventEvolutionAbridged.Redact()
        if not eventEvolutionAbridged.SrcTypsIsNone():
            self.srcTyps = []
            for i in range(eventEvolutionAbridged.SrcTypsLength()):
                self.srcTyps.append(eventEvolutionAbridged.SrcTyps(i))
        if not eventEvolutionAbridged.SrcIdsIsNone():
            self.srcIds = []
            for i in range(eventEvolutionAbridged.SrcIdsLength()):
                self.srcIds.append(eventEvolutionAbridged.SrcIds(i))
        self.dataDescription = eventEvolutionAbridged.DataDescription()
        self.atext = eventEvolutionAbridged.Atext()
        self.agjson = eventEvolutionAbridged.Agjson()
        self.atype = eventEvolutionAbridged.Atype()
        self.andims = eventEvolutionAbridged.Andims()
        self.asrid = eventEvolutionAbridged.Asrid()
        if not eventEvolutionAbridged.UrlIsNone():
            self.url = []
            for i in range(eventEvolutionAbridged.UrlLength()):
                self.url.append(eventEvolutionAbridged.Url(i))
        if not eventEvolutionAbridged.TagsIsNone():
            self.tags = []
            for i in range(eventEvolutionAbridged.TagsLength()):
                self.tags.append(eventEvolutionAbridged.Tags(i))
        self.createdAt = eventEvolutionAbridged.CreatedAt()
        self.createdBy = eventEvolutionAbridged.CreatedBy()
        self.source = eventEvolutionAbridged.Source()
        self.origin = eventEvolutionAbridged.Origin()
        self.origNetwork = eventEvolutionAbridged.OrigNetwork()
        self.dataMode = eventEvolutionAbridged.DataMode()
    ...
    def Pack(self, builder):
        ...
        if self.srcTyps is not None:
            ...
            EventEvolution_AbridgedStartSrcTypsVector(builder, len(self.srcTyps))
        ...
        if self.srcIds is not None:
            ...
            EventEvolution_AbridgedStartSrcIdsVector(builder, len(self.srcIds))
        ...
        if self.url is not None:
            ...
            EventEvolution_AbridgedStartUrlVector(builder, len(self.url))
        ...
        if self.tags is not None:
            ...
            EventEvolution_AbridgedStartTagsVector(builder, len(self.tags))
        ...
        if self.geoAdminLevel3 is not None:
            EventEvolution_AbridgedAddGeoAdminLevel3(builder, geoAdminLevel3)
        EventEvolution_AbridgedAddRedact(builder, self.redact)
        if self.srcTyps is not None:
            EventEvolution_AbridgedAddSrcTyps(builder, srcTyps)
        if self.srcIds is not None:
            EventEvolution_AbridgedAddSrcIds(builder, srcIds)
        ...
        if self.atype is not None:
            EventEvolution_AbridgedAddAtype(builder, atype)
        EventEvolution_AbridgedAddAndims(builder, self.andims)
        EventEvolution_AbridgedAddAsrid(builder, self.asrid)
        if self.url is not None:
            EventEvolution_AbridgedAddUrl(builder, url)
        if self.tags is not None:
            EventEvolution_AbridgedAddTags(builder, tags)
        ...
        if self.origNetwork is not None:
            EventEvolution_AbridgedAddOrigNetwork(builder, origNetwork)
        EventEvolution_AbridgedAddDataMode(builder, self.dataMode)
        eventEvolutionAbridged = EventEvolution_AbridgedEnd(builder)
        return eventEvolutionAbridged
