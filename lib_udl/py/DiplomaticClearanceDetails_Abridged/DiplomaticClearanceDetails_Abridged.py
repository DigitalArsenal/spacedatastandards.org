...
class DiplomaticClearanceDetails_Abridged(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = DiplomaticClearanceDetails_Abridged()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsDiplomaticClearanceDetails_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def DiplomaticClearanceDetails_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def DiplomaticClearanceDetails_AbridgedStart(builder):
    builder.StartObject(24)

def Start(builder):
    DiplomaticClearanceDetails_AbridgedStart(builder)

def DiplomaticClearanceDetails_AbridgedAddIdSortie(builder, idSortie):
...
def AddIdSortie(builder, idSortie):
    DiplomaticClearanceDetails_AbridgedAddIdSortie(builder, idSortie)

def DiplomaticClearanceDetails_AbridgedAddLegNum(builder, legNum):
    builder.PrependInt32Slot(1, legNum, 0)

def AddLegNum(builder, legNum):
    DiplomaticClearanceDetails_AbridgedAddLegNum(builder, legNum)

def DiplomaticClearanceDetails_AbridgedAddRouteString(builder, routeString):
...
def AddRouteString(builder, routeString):
    DiplomaticClearanceDetails_AbridgedAddRouteString(builder, routeString)

def DiplomaticClearanceDetails_AbridgedAddValidStartTime(builder, validStartTime):
...
def AddValidStartTime(builder, validStartTime):
    DiplomaticClearanceDetails_AbridgedAddValidStartTime(builder, validStartTime)

def DiplomaticClearanceDetails_AbridgedAddValidEndTime(builder, validEndTime):
...
def AddValidEndTime(builder, validEndTime):
    DiplomaticClearanceDetails_AbridgedAddValidEndTime(builder, validEndTime)

def DiplomaticClearanceDetails_AbridgedAddClearanceId(builder, clearanceId):
...
def AddClearanceId(builder, clearanceId):
    DiplomaticClearanceDetails_AbridgedAddClearanceId(builder, clearanceId)

def DiplomaticClearanceDetails_AbridgedAddExternalClearanceId(builder, externalClearanceId):
...
def AddExternalClearanceId(builder, externalClearanceId):
    DiplomaticClearanceDetails_AbridgedAddExternalClearanceId(builder, externalClearanceId)

def DiplomaticClearanceDetails_AbridgedAddClearedCallSign(builder, clearedCallSign):
...
def AddClearedCallSign(builder, clearedCallSign):
    DiplomaticClearanceDetails_AbridgedAddClearedCallSign(builder, clearedCallSign)

def DiplomaticClearanceDetails_AbridgedAddSequenceNum(builder, sequenceNum):
    builder.PrependInt32Slot(8, sequenceNum, 0)

def AddSequenceNum(builder, sequenceNum):
    DiplomaticClearanceDetails_AbridgedAddSequenceNum(builder, sequenceNum)

def DiplomaticClearanceDetails_AbridgedAddCountryCode(builder, countryCode):
...
def AddCountryCode(builder, countryCode):
    DiplomaticClearanceDetails_AbridgedAddCountryCode(builder, countryCode)

def DiplomaticClearanceDetails_AbridgedAddAltCountryCode(builder, altCountryCode):
...
def AddAltCountryCode(builder, altCountryCode):
    DiplomaticClearanceDetails_AbridgedAddAltCountryCode(builder, altCountryCode)

def DiplomaticClearanceDetails_AbridgedAddCountryName(builder, countryName):
...
def AddCountryName(builder, countryName):
    DiplomaticClearanceDetails_AbridgedAddCountryName(builder, countryName)

def DiplomaticClearanceDetails_AbridgedAddValidDesc(builder, validDesc):
...
def AddValidDesc(builder, validDesc):
    DiplomaticClearanceDetails_AbridgedAddValidDesc(builder, validDesc)

def DiplomaticClearanceDetails_AbridgedAddWindowRemark(builder, windowRemark):
...
def AddWindowRemark(builder, windowRemark):
    DiplomaticClearanceDetails_AbridgedAddWindowRemark(builder, windowRemark)

def DiplomaticClearanceDetails_AbridgedAddEntryPoint(builder, entryPoint):
...
def AddEntryPoint(builder, entryPoint):
    DiplomaticClearanceDetails_AbridgedAddEntryPoint(builder, entryPoint)

def DiplomaticClearanceDetails_AbridgedAddEntryNet(builder, entryNet):
...
def AddEntryNet(builder, entryNet):
    DiplomaticClearanceDetails_AbridgedAddEntryNet(builder, entryNet)

def DiplomaticClearanceDetails_AbridgedAddExitPoint(builder, exitPoint):
...
def AddExitPoint(builder, exitPoint):
    DiplomaticClearanceDetails_AbridgedAddExitPoint(builder, exitPoint)

def DiplomaticClearanceDetails_AbridgedAddExitNlt(builder, exitNlt):
...
def AddExitNlt(builder, exitNlt):
    DiplomaticClearanceDetails_AbridgedAddExitNlt(builder, exitNlt)

def DiplomaticClearanceDetails_AbridgedAddReqIcao(builder, reqIcao):
    builder.PrependBoolSlot(18, reqIcao, 0)

def AddReqIcao(builder, reqIcao):
    DiplomaticClearanceDetails_AbridgedAddReqIcao(builder, reqIcao)

def DiplomaticClearanceDetails_AbridgedAddAction(builder, action):
...
def AddAction(builder, action):
    DiplomaticClearanceDetails_AbridgedAddAction(builder, action)

def DiplomaticClearanceDetails_AbridgedAddStatus(builder, status):
    builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(status), 0)

def AddStatus(builder, status):
    DiplomaticClearanceDetails_AbridgedAddStatus(builder, status)

def DiplomaticClearanceDetails_AbridgedAddProfile(builder, profile):
...
def AddProfile(builder, profile):
    DiplomaticClearanceDetails_AbridgedAddProfile(builder, profile)

def DiplomaticClearanceDetails_AbridgedAddReqPoint(builder, reqPoint):
    builder.PrependBoolSlot(22, reqPoint, 0)

def AddReqPoint(builder, reqPoint):
    DiplomaticClearanceDetails_AbridgedAddReqPoint(builder, reqPoint)

def DiplomaticClearanceDetails_AbridgedAddClearanceRemark(builder, clearanceRemark):
...
def AddClearanceRemark(builder, clearanceRemark):
    DiplomaticClearanceDetails_AbridgedAddClearanceRemark(builder, clearanceRemark)

def DiplomaticClearanceDetails_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return DiplomaticClearanceDetails_AbridgedEnd(builder)


class DiplomaticClearanceDetails_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        diplomaticClearanceDetailsAbridged = DiplomaticClearanceDetails_Abridged()
        diplomaticClearanceDetailsAbridged.Init(buf, pos)
        return cls.InitFromObj(diplomaticClearanceDetailsAbridged)
    ...
    @classmethod
    def InitFromObj(cls, diplomaticClearanceDetailsAbridged):
        x = DiplomaticClearanceDetails_AbridgedT()
        x._UnPack(diplomaticClearanceDetailsAbridged)
        return x

    # DiplomaticClearanceDetails_AbridgedT
    def _UnPack(self, diplomaticClearanceDetailsAbridged):
        if diplomaticClearanceDetailsAbridged is None:
            return
        self.idSortie = diplomaticClearanceDetailsAbridged.IdSortie()
        self.legNum = diplomaticClearanceDetailsAbridged.LegNum()
        self.routeString = diplomaticClearanceDetailsAbridged.RouteString()
        self.validStartTime = diplomaticClearanceDetailsAbridged.ValidStartTime()
        self.validEndTime = diplomaticClearanceDetailsAbridged.ValidEndTime()
        self.clearanceId = diplomaticClearanceDetailsAbridged.ClearanceId()
        self.externalClearanceId = diplomaticClearanceDetailsAbridged.ExternalClearanceId()
        self.clearedCallSign = diplomaticClearanceDetailsAbridged.ClearedCallSign()
        self.sequenceNum = diplomaticClearanceDetailsAbridged.SequenceNum()
        self.countryCode = diplomaticClearanceDetailsAbridged.CountryCode()
        self.altCountryCode = diplomaticClearanceDetailsAbridged.AltCountryCode()
        self.countryName = diplomaticClearanceDetailsAbridged.CountryName()
        self.validDesc = diplomaticClearanceDetailsAbridged.ValidDesc()
        self.windowRemark = diplomaticClearanceDetailsAbridged.WindowRemark()
        self.entryPoint = diplomaticClearanceDetailsAbridged.EntryPoint()
        self.entryNet = diplomaticClearanceDetailsAbridged.EntryNet()
        self.exitPoint = diplomaticClearanceDetailsAbridged.ExitPoint()
        self.exitNlt = diplomaticClearanceDetailsAbridged.ExitNlt()
        self.reqIcao = diplomaticClearanceDetailsAbridged.ReqIcao()
        self.action = diplomaticClearanceDetailsAbridged.Action()
        self.status = diplomaticClearanceDetailsAbridged.Status()
        self.profile = diplomaticClearanceDetailsAbridged.Profile()
        self.reqPoint = diplomaticClearanceDetailsAbridged.ReqPoint()
        self.clearanceRemark = diplomaticClearanceDetailsAbridged.ClearanceRemark()
    ...
    def Pack(self, builder):
        ...
        if self.idSortie is not None:
            DiplomaticClearanceDetails_AbridgedAddIdSortie(builder, idSortie)
        DiplomaticClearanceDetails_AbridgedAddLegNum(builder, self.legNum)
        if self.routeString is not None:
            DiplomaticClearanceDetails_AbridgedAddRouteString(builder, routeString)
        if self.validStartTime is not None:
            DiplomaticClearanceDetails_AbridgedAddValidStartTime(builder, validStartTime)
        ...
        if self.clearedCallSign is not None:
            DiplomaticClearanceDetails_AbridgedAddClearedCallSign(builder, clearedCallSign)
        DiplomaticClearanceDetails_AbridgedAddSequenceNum(builder, self.sequenceNum)
        if self.countryCode is not None:
            DiplomaticClearanceDetails_AbridgedAddCountryCode(builder, countryCode)
        if self.altCountryCode is not None:
            DiplomaticClearanceDetails_AbridgedAddAltCountryCode(builder, altCountryCode)
        ...
        if self.exitNlt is not None:
            DiplomaticClearanceDetails_AbridgedAddExitNlt(builder, exitNlt)
        DiplomaticClearanceDetails_AbridgedAddReqIcao(builder, self.reqIcao)
        if self.action is not None:
            DiplomaticClearanceDetails_AbridgedAddAction(builder, action)
        if self.status is not None:
            DiplomaticClearanceDetails_AbridgedAddStatus(builder, status)
        if self.profile is not None:
            DiplomaticClearanceDetails_AbridgedAddProfile(builder, profile)
        DiplomaticClearanceDetails_AbridgedAddReqPoint(builder, self.reqPoint)
        if self.clearanceRemark is not None:
            DiplomaticClearanceDetails_AbridgedAddClearanceRemark(builder, clearanceRemark)
        diplomaticClearanceDetailsAbridged = DiplomaticClearanceDetails_AbridgedEnd(builder)
        return diplomaticClearanceDetailsAbridged
