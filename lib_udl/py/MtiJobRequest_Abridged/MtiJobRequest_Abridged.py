...
class MtiJobRequest_Abridged(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsMtiJobRequest_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def MtiJobRequest_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf, offset, b"\x4D\x54\x49\x4A", size_prefixed=size_prefixed)

    # MtiJobRequest_Abridged
...
def MtiJobRequest_AbridgedStart(builder):
    builder.StartObject(21)

def Start(builder):
    MtiJobRequest_AbridgedStart(builder)

def MtiJobRequest_AbridgedAddR1(builder, r1):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(r1), 0)

def AddR1(builder, r1):
    MtiJobRequest_AbridgedAddR1(builder, r1)

def MtiJobRequest_AbridgedAddR2(builder, r2):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(r2), 0)

def AddR2(builder, r2):
    MtiJobRequest_AbridgedAddR2(builder, r2)

def MtiJobRequest_AbridgedAddR3(builder, r3):
    builder.PrependInt32Slot(2, r3, 0)

def AddR3(builder, r3):
    MtiJobRequest_AbridgedAddR3(builder, r3)

def MtiJobRequest_AbridgedAddR4(builder, r4):
    builder.PrependFloat64Slot(3, r4, 0.0)

def AddR4(builder, r4):
    MtiJobRequest_AbridgedAddR4(builder, r4)

def MtiJobRequest_AbridgedAddR5(builder, r5):
    builder.PrependFloat64Slot(4, r5, 0.0)

def AddR5(builder, r5):
    MtiJobRequest_AbridgedAddR5(builder, r5)

def MtiJobRequest_AbridgedAddR6(builder, r6):
    builder.PrependFloat64Slot(5, r6, 0.0)

def AddR6(builder, r6):
    MtiJobRequest_AbridgedAddR6(builder, r6)

def MtiJobRequest_AbridgedAddR7(builder, r7):
    builder.PrependFloat64Slot(6, r7, 0.0)

def AddR7(builder, r7):
    MtiJobRequest_AbridgedAddR7(builder, r7)

def MtiJobRequest_AbridgedAddR8(builder, r8):
    builder.PrependFloat64Slot(7, r8, 0.0)

def AddR8(builder, r8):
    MtiJobRequest_AbridgedAddR8(builder, r8)

def MtiJobRequest_AbridgedAddR9(builder, r9):
    builder.PrependFloat64Slot(8, r9, 0.0)

def AddR9(builder, r9):
    MtiJobRequest_AbridgedAddR9(builder, r9)

def MtiJobRequest_AbridgedAddR10(builder, r10):
    builder.PrependFloat64Slot(9, r10, 0.0)

def AddR10(builder, r10):
    MtiJobRequest_AbridgedAddR10(builder, r10)

def MtiJobRequest_AbridgedAddR11(builder, r11):
    builder.PrependFloat64Slot(10, r11, 0.0)

def AddR11(builder, r11):
    MtiJobRequest_AbridgedAddR11(builder, r11)

def MtiJobRequest_AbridgedAddR12(builder, r12):
    builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(r12), 0)

def AddR12(builder, r12):
    MtiJobRequest_AbridgedAddR12(builder, r12)

def MtiJobRequest_AbridgedAddR13(builder, r13):
    builder.PrependInt32Slot(12, r13, 0)

def AddR13(builder, r13):
    MtiJobRequest_AbridgedAddR13(builder, r13)

def MtiJobRequest_AbridgedAddR14(builder, r14):
    builder.PrependInt32Slot(13, r14, 0)

def AddR14(builder, r14):
    MtiJobRequest_AbridgedAddR14(builder, r14)

def MtiJobRequest_AbridgedAddJobReqEst(builder, jobReqEst):
...
def AddJobReqEst(builder, jobReqEst):
    MtiJobRequest_AbridgedAddJobReqEst(builder, jobReqEst)

def MtiJobRequest_AbridgedAddR21(builder, r21):
    builder.PrependInt32Slot(15, r21, 0)

def AddR21(builder, r21):
    MtiJobRequest_AbridgedAddR21(builder, r21)

def MtiJobRequest_AbridgedAddR22(builder, r22):
    builder.PrependInt32Slot(16, r22, 0)

def AddR22(builder, r22):
    MtiJobRequest_AbridgedAddR22(builder, r22)

def MtiJobRequest_AbridgedAddR23(builder, r23):
    builder.PrependInt32Slot(17, r23, 0)

def AddR23(builder, r23):
    MtiJobRequest_AbridgedAddR23(builder, r23)

def MtiJobRequest_AbridgedAddR24(builder, r24):
    builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(r24), 0)

def AddR24(builder, r24):
    MtiJobRequest_AbridgedAddR24(builder, r24)

def MtiJobRequest_AbridgedAddR25(builder, r25):
    builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(r25), 0)

def AddR25(builder, r25):
    MtiJobRequest_AbridgedAddR25(builder, r25)

def MtiJobRequest_AbridgedAddR26(builder, r26):
    builder.PrependBoolSlot(20, r26, 0)

def AddR26(builder, r26):
    MtiJobRequest_AbridgedAddR26(builder, r26)

def MtiJobRequest_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return MtiJobRequest_AbridgedEnd(builder)


class MtiJobRequest_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        mtiJobRequestAbridged = MtiJobRequest_Abridged()
        mtiJobRequestAbridged.Init(buf, pos)
        return cls.InitFromObj(mtiJobRequestAbridged)
    ...
    @classmethod
    def InitFromObj(cls, mtiJobRequestAbridged):
        x = MtiJobRequest_AbridgedT()
        x._UnPack(mtiJobRequestAbridged)
        return x

    # MtiJobRequest_AbridgedT
    def _UnPack(self, mtiJobRequestAbridged):
        if mtiJobRequestAbridged is None:
            return
        self.r1 = mtiJobRequestAbridged.R1()
        self.r2 = mtiJobRequestAbridged.R2()
        self.r3 = mtiJobRequestAbridged.R3()
        self.r4 = mtiJobRequestAbridged.R4()
        self.r5 = mtiJobRequestAbridged.R5()
        self.r6 = mtiJobRequestAbridged.R6()
        self.r7 = mtiJobRequestAbridged.R7()
        self.r8 = mtiJobRequestAbridged.R8()
        self.r9 = mtiJobRequestAbridged.R9()
        self.r10 = mtiJobRequestAbridged.R10()
        self.r11 = mtiJobRequestAbridged.R11()
        self.r12 = mtiJobRequestAbridged.R12()
        self.r13 = mtiJobRequestAbridged.R13()
        self.r14 = mtiJobRequestAbridged.R14()
        self.jobReqEst = mtiJobRequestAbridged.JobReqEst()
        self.r21 = mtiJobRequestAbridged.R21()
        self.r22 = mtiJobRequestAbridged.R22()
        self.r23 = mtiJobRequestAbridged.R23()
        self.r24 = mtiJobRequestAbridged.R24()
        self.r25 = mtiJobRequestAbridged.R25()
        self.r26 = mtiJobRequestAbridged.R26()
    ...
    def Pack(self, builder):
        ...
        if self.r2 is not None:
            MtiJobRequest_AbridgedAddR2(builder, r2)
        MtiJobRequest_AbridgedAddR3(builder, self.r3)
        MtiJobRequest_AbridgedAddR4(builder, self.r4)
        MtiJobRequest_AbridgedAddR5(builder, self.r5)
        MtiJobRequest_AbridgedAddR6(builder, self.r6)
        MtiJobRequest_AbridgedAddR7(builder, self.r7)
        MtiJobRequest_AbridgedAddR8(builder, self.r8)
        MtiJobRequest_AbridgedAddR9(builder, self.r9)
        MtiJobRequest_AbridgedAddR10(builder, self.r10)
        MtiJobRequest_AbridgedAddR11(builder, self.r11)
        if self.r12 is not None:
            MtiJobRequest_AbridgedAddR12(builder, r12)
        MtiJobRequest_AbridgedAddR13(builder, self.r13)
        MtiJobRequest_AbridgedAddR14(builder, self.r14)
        if self.jobReqEst is not None:
            MtiJobRequest_AbridgedAddJobReqEst(builder, jobReqEst)
        MtiJobRequest_AbridgedAddR21(builder, self.r21)
        MtiJobRequest_AbridgedAddR22(builder, self.r22)
        MtiJobRequest_AbridgedAddR23(builder, self.r23)
        if self.r24 is not None:
            MtiJobRequest_AbridgedAddR24(builder, r24)
        if self.r25 is not None:
            MtiJobRequest_AbridgedAddR25(builder, r25)
        MtiJobRequest_AbridgedAddR26(builder, self.r26)
        mtiJobRequestAbridged = MtiJobRequest_AbridgedEnd(builder)
        return mtiJobRequestAbridged
