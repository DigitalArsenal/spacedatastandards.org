...
class Track_Full(object):
    ...
    @classmethod
    def GetRootAsTrack_Full(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def Track_FullBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def Track_FullStart(builder):
    builder.StartObject(68)

def Start(builder):
    Track_FullStart(builder)

def Track_FullAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    Track_FullAddId(builder, id)

def Track_FullAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    Track_FullAddClassificationMarking(builder, classificationMarking)

def Track_FullAddCntct(builder, cntct):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(cntct), 0)

def AddCntct(builder, cntct):
    Track_FullAddCntct(builder, cntct)

def Track_FullAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    Track_FullAddCreatedAt(builder, createdAt)

def Track_FullAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    Track_FullAddCreatedBy(builder, createdBy)

def Track_FullAddMsgTs(builder, msgTs):
    builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(msgTs), 0)

def AddMsgTs(builder, msgTs):
    Track_FullAddMsgTs(builder, msgTs)

def Track_FullAddMsnId(builder, msnId):
    builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(msnId), 0)

def AddMsnId(builder, msnId):
    Track_FullAddMsnId(builder, msnId)

def Track_FullAddAssetNat(builder, assetNat):
...
def AddSenQual(builder, senQual):
    Track_FullAddSenQual(builder, senQual)

def Track_FullAddTrkId(builder, trkId):
    builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(trkId), 0)

def AddTrkId(builder, trkId):
    Track_FullAddTrkId(builder, trkId)

def Track_FullAddTrkNum(builder, trkNum):
...
def AddTrkNum(builder, trkNum):
    Track_FullAddTrkNum(builder, trkNum)

def Track_FullAddTrkStat(builder, trkStat):
...
def AddTrkStat(builder, trkStat):
    Track_FullAddTrkStat(builder, trkStat)

def Track_FullAddObjNat(builder, objNat):
...
def AddObjNat(builder, objNat):
    Track_FullAddObjNat(builder, objNat)

def Track_FullAddObjId(builder, objId):
    builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(objId), 0)

def AddObjId(builder, objId):
    Track_FullAddObjId(builder, objId)

def Track_FullAddObjType(builder, objType):
...
def AddObjType(builder, objType):
    Track_FullAddObjType(builder, objType)

def Track_FullAddObjSpec(builder, objSpec):
...
def AddObjSpec(builder, objSpec):
    Track_FullAddObjSpec(builder, objSpec)

def Track_FullAddObjPlat(builder, objPlat):
...
def AddObjPlat(builder, objPlat):
    Track_FullAddObjPlat(builder, objPlat)

def Track_FullAddObjAct(builder, objAct):
...
def AddObjAct(builder, objAct):
    Track_FullAddObjAct(builder, objAct)

def Track_FullAddModType(builder, modType):
...
def AddModType(builder, modType):
    Track_FullAddModType(builder, modType)

def Track_FullAddTrkItmId(builder, trkItmId):
...
def AddTrkItmId(builder, trkItmId):
    Track_FullAddTrkItmId(builder, trkItmId)

def Track_FullAddTs(builder, ts):
    builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(ts), 0)

def AddTs(builder, ts):
    Track_FullAddTs(builder, ts)

def Track_FullAddTrkQual(builder, trkQual):
    builder.PrependInt32Slot(23, trkQual, 0)

def AddTrkQual(builder, trkQual):
    Track_FullAddTrkQual(builder, trkQual)

def Track_FullAddTrkPtType(builder, trkPtType):
...
def AddTrkPtType(builder, trkPtType):
    Track_FullAddTrkPtType(builder, trkPtType)

def Track_FullAddObjIdent(builder, objIdent):
...
def AddObjIdent(builder, objIdent):
    Track_FullAddObjIdent(builder, objIdent)

def Track_FullAddIdentCred(builder, identCred):
    builder.PrependInt32Slot(26, identCred, 0)

def AddIdentCred(builder, identCred):
    Track_FullAddIdentCred(builder, identCred)

def Track_FullAddIdentRel(builder, identRel):
    builder.PrependInt32Slot(27, identRel, 0)

def AddIdentRel(builder, identRel):
    Track_FullAddIdentRel(builder, identRel)

def Track_FullAddIdentAmp(builder, identAmp):
...
def AddIdentAmp(builder, identAmp):
    Track_FullAddIdentAmp(builder, identAmp)

def Track_FullAddEnv(builder, env):
    builder.PrependUOffsetTRelativeSlot(29, flatbuffers.number_types.UOffsetTFlags.py_type(env), 0)

def AddEnv(builder, env):
    Track_FullAddEnv(builder, env)

def Track_FullAddEnvConf(builder, envConf):
    builder.PrependFloat64Slot(30, envConf, 0.0)

def AddEnvConf(builder, envConf):
    Track_FullAddEnvConf(builder, envConf)

def Track_FullAddTrkConf(builder, trkConf):
    builder.PrependFloat64Slot(31, trkConf, 0.0)

def AddTrkConf(builder, trkConf):
    Track_FullAddTrkConf(builder, trkConf)

def Track_FullAddEcefPos(builder, ecefPos):
...
def AddEcefPos(builder, ecefPos):
    Track_FullAddEcefPos(builder, ecefPos)

def Track_FullStartEcefPosVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartEcefPosVector(builder, numElems):
    return Track_FullStartEcefPosVector(builder, numElems)

def Track_FullAddEcefVel(builder, ecefVel):
...
def AddEcefVel(builder, ecefVel):
    Track_FullAddEcefVel(builder, ecefVel)

def Track_FullStartEcefVelVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartEcefVelVector(builder, numElems):
    return Track_FullStartEcefVelVector(builder, numElems)

def Track_FullAddEcefAcc(builder, ecefAcc):
...
def AddEcefAcc(builder, ecefAcc):
    Track_FullAddEcefAcc(builder, ecefAcc)

def Track_FullStartEcefAccVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartEcefAccVector(builder, numElems):
    return Track_FullStartEcefAccVector(builder, numElems)

def Track_FullAddLat(builder, lat):
    builder.PrependFloat64Slot(35, lat, 0.0)

def AddLat(builder, lat):
    Track_FullAddLat(builder, lat)

def Track_FullAddLon(builder, lon):
    builder.PrependFloat64Slot(36, lon, 0.0)

def AddLon(builder, lon):
    Track_FullAddLon(builder, lon)

def Track_FullAddAlt(builder, alt):
    builder.PrependFloat64Slot(37, alt, 0.0)

def AddAlt(builder, alt):
    Track_FullAddAlt(builder, alt)

def Track_FullAddSpd(builder, spd):
    builder.PrependFloat64Slot(38, spd, 0.0)

def AddSpd(builder, spd):
    Track_FullAddSpd(builder, spd)

def Track_FullAddHdng(builder, hdng):
    builder.PrependFloat64Slot(39, hdng, 0.0)

def AddHdng(builder, hdng):
    Track_FullAddHdng(builder, hdng)

def Track_FullAddCourse(builder, course):
    builder.PrependFloat64Slot(40, course, 0.0)

def AddCourse(builder, course):
    Track_FullAddCourse(builder, course)

def Track_FullAddLco(builder, lco):
    builder.PrependUOffsetTRelativeSlot(41, flatbuffers.number_types.UOffsetTFlags.py_type(lco), 0)

def AddLco(builder, lco):
    Track_FullAddLco(builder, lco)

def Track_FullStartLcoVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartLcoVector(builder, numElems):
    return Track_FullStartLcoVector(builder, numElems)

def Track_FullAddLcs(builder, lcs):
    builder.PrependUOffsetTRelativeSlot(42, flatbuffers.number_types.UOffsetTFlags.py_type(lcs), 0)

def AddLcs(builder, lcs):
    Track_FullAddLcs(builder, lcs)

def Track_FullStartLcsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartLcsVector(builder, numElems):
    return Track_FullStartLcsVector(builder, numElems)

def Track_FullAddLcPos(builder, lcPos):
    builder.PrependUOffsetTRelativeSlot(43, flatbuffers.number_types.UOffsetTFlags.py_type(lcPos), 0)

def AddLcPos(builder, lcPos):
    Track_FullAddLcPos(builder, lcPos)

def Track_FullStartLcPosVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartLcPosVector(builder, numElems):
    return Track_FullStartLcPosVector(builder, numElems)

def Track_FullAddLcVel(builder, lcVel):
    builder.PrependUOffsetTRelativeSlot(44, flatbuffers.number_types.UOffsetTFlags.py_type(lcVel), 0)

def AddLcVel(builder, lcVel):
    Track_FullAddLcVel(builder, lcVel)

def Track_FullStartLcVelVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartLcVelVector(builder, numElems):
    return Track_FullStartLcVelVector(builder, numElems)

def Track_FullAddLcAcc(builder, lcAcc):
    builder.PrependUOffsetTRelativeSlot(45, flatbuffers.number_types.UOffsetTFlags.py_type(lcAcc), 0)

def AddLcAcc(builder, lcAcc):
    Track_FullAddLcAcc(builder, lcAcc)

def Track_FullStartLcAccVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartLcAccVector(builder, numElems):
    return Track_FullStartLcAccVector(builder, numElems)

def Track_FullAddENuvel(builder, eNuvel):
...
def AddENuvel(builder, eNuvel):
    Track_FullAddENuvel(builder, eNuvel)

def Track_FullStartENuvelVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartENuvelVector(builder, numElems):
    return Track_FullStartENuvelVector(builder, numElems)

def Track_FullAddENupos(builder, eNupos):
...
def AddENupos(builder, eNupos):
    Track_FullAddENupos(builder, eNupos)

def Track_FullStartENuposVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartENuposVector(builder, numElems):
    return Track_FullStartENuposVector(builder, numElems)

def Track_FullAddCov(builder, cov):
    builder.PrependUOffsetTRelativeSlot(48, flatbuffers.number_types.UOffsetTFlags.py_type(cov), 0)

def AddCov(builder, cov):
    Track_FullAddCov(builder, cov)

def Track_FullStartCovVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartCovVector(builder, numElems):
    return Track_FullStartCovVector(builder, numElems)

def Track_FullAddErrEllp(builder, errEllp):
...
def AddErrEllp(builder, errEllp):
    Track_FullAddErrEllp(builder, errEllp)

def Track_FullStartErrEllpVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartErrEllpVector(builder, numElems):
    return Track_FullStartErrEllpVector(builder, numElems)

def Track_FullAddSrcTyps(builder, srcTyps):
...
def AddSrcTyps(builder, srcTyps):
    Track_FullAddSrcTyps(builder, srcTyps)

def Track_FullStartSrcTypsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartSrcTypsVector(builder, numElems):
    return Track_FullStartSrcTypsVector(builder, numElems)

def Track_FullAddSrcIds(builder, srcIds):
...
def AddSrcIds(builder, srcIds):
    Track_FullAddSrcIds(builder, srcIds)

def Track_FullStartSrcIdsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartSrcIdsVector(builder, numElems):
    return Track_FullStartSrcIdsVector(builder, numElems)

def Track_FullAddCallSign(builder, callSign):
...
def AddCallSign(builder, callSign):
    Track_FullAddCallSign(builder, callSign)

def Track_FullAddMultiSource(builder, multiSource):
    builder.PrependBoolSlot(53, multiSource, 0)

def AddMultiSource(builder, multiSource):
    Track_FullAddMultiSource(builder, multiSource)

def Track_FullAddJSeries(builder, jSeries):
...
def AddJSeries(builder, jSeries):
    Track_FullAddJSeries(builder, jSeries)

def Track_FullAddStrength(builder, strength):
    builder.PrependInt32Slot(55, strength, 0)

def AddStrength(builder, strength):
    Track_FullAddStrength(builder, strength)

def Track_FullAddM1(builder, m1):
    builder.PrependInt32Slot(56, m1, 0)

def AddM1(builder, m1):
    Track_FullAddM1(builder, m1)

def Track_FullAddM1v(builder, m1v):
    builder.PrependInt32Slot(57, m1v, 0)

def AddM1v(builder, m1v):
    Track_FullAddM1v(builder, m1v)

def Track_FullAddM2(builder, m2):
    builder.PrependInt32Slot(58, m2, 0)

def AddM2(builder, m2):
    Track_FullAddM2(builder, m2)

def Track_FullAddM2v(builder, m2v):
    builder.PrependInt32Slot(59, m2v, 0)

def AddM2v(builder, m2v):
    Track_FullAddM2v(builder, m2v)

def Track_FullAddM3a(builder, m3a):
    builder.PrependInt32Slot(60, m3a, 0)

def AddM3a(builder, m3a):
    Track_FullAddM3a(builder, m3a)

def Track_FullAddM3av(builder, m3av):
    builder.PrependInt32Slot(61, m3av, 0)

def AddM3av(builder, m3av):
    Track_FullAddM3av(builder, m3av)

def Track_FullAddTags(builder, tags):
    builder.PrependUOffsetTRelativeSlot(62, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)

def AddTags(builder, tags):
    Track_FullAddTags(builder, tags)

def Track_FullStartTagsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartTagsVector(builder, numElems):
    return Track_FullStartTagsVector(builder, numElems)

def Track_FullAddSourceDl(builder, sourceDl):
...
def AddSourceDl(builder, sourceDl):
    Track_FullAddSourceDl(builder, sourceDl)

def Track_FullAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(64, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    Track_FullAddSource(builder, source)

def Track_FullAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(65, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    Track_FullAddOrigin(builder, origin)

def Track_FullAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(66, dataMode, 0)

def AddDataMode(builder, dataMode):
    Track_FullAddDataMode(builder, dataMode)

def Track_FullAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(67, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    Track_FullAddOrigNetwork(builder, origNetwork)

def Track_FullEnd(builder):
    return builder.EndObject()

def End(builder):
    return Track_FullEnd(builder)
...
class Track_FullT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        trackFull = Track_Full()
        trackFull.Init(buf, pos)
        return cls.InitFromObj(trackFull)
    ...
    @classmethod
    def InitFromObj(cls, trackFull):
        x = Track_FullT()
        x._UnPack(trackFull)
        return x

    # Track_FullT
    def _UnPack(self, trackFull):
        if trackFull is None:
            return
        self.id = trackFull.Id()
        self.classificationMarking = trackFull.ClassificationMarking()
        self.cntct = trackFull.Cntct()
        self.createdAt = trackFull.CreatedAt()
        self.createdBy = trackFull.CreatedBy()
        self.msgTs = trackFull.MsgTs()
        self.msnId = trackFull.MsnId()
        self.assetNat = trackFull.AssetNat()
        self.asset = trackFull.Asset()
        self.sen = trackFull.Sen()
        self.senQual = trackFull.SenQual()
        self.trkId = trackFull.TrkId()
        self.trkNum = trackFull.TrkNum()
        self.trkStat = trackFull.TrkStat()
        self.objNat = trackFull.ObjNat()
        self.objId = trackFull.ObjId()
        self.objType = trackFull.ObjType()
        self.objSpec = trackFull.ObjSpec()
        self.objPlat = trackFull.ObjPlat()
        self.objAct = trackFull.ObjAct()
        self.modType = trackFull.ModType()
        self.trkItmId = trackFull.TrkItmId()
        self.ts = trackFull.Ts()
        self.trkQual = trackFull.TrkQual()
        self.trkPtType = trackFull.TrkPtType()
        self.objIdent = trackFull.ObjIdent()
        self.identCred = trackFull.IdentCred()
        self.identRel = trackFull.IdentRel()
        self.identAmp = trackFull.IdentAmp()
        self.env = trackFull.Env()
        self.envConf = trackFull.EnvConf()
        self.trkConf = trackFull.TrkConf()
        if not trackFull.EcefPosIsNone():
            self.ecefPos = []
            for i in range(trackFull.EcefPosLength()):
                self.ecefPos.append(trackFull.EcefPos(i))
        if not trackFull.EcefVelIsNone():
            self.ecefVel = []
            for i in range(trackFull.EcefVelLength()):
                self.ecefVel.append(trackFull.EcefVel(i))
        if not trackFull.EcefAccIsNone():
            self.ecefAcc = []
            for i in range(trackFull.EcefAccLength()):
                self.ecefAcc.append(trackFull.EcefAcc(i))
        self.lat = trackFull.Lat()
        self.lon = trackFull.Lon()
        self.alt = trackFull.Alt()
        self.spd = trackFull.Spd()
        self.hdng = trackFull.Hdng()
        self.course = trackFull.Course()
        if not trackFull.LcoIsNone():
            self.lco = []
            for i in range(trackFull.LcoLength()):
                self.lco.append(trackFull.Lco(i))
        if not trackFull.LcsIsNone():
            self.lcs = []
            for i in range(trackFull.LcsLength()):
                self.lcs.append(trackFull.Lcs(i))
        if not trackFull.LcPosIsNone():
            self.lcPos = []
            for i in range(trackFull.LcPosLength()):
                self.lcPos.append(trackFull.LcPos(i))
        if not trackFull.LcVelIsNone():
            self.lcVel = []
            for i in range(trackFull.LcVelLength()):
                self.lcVel.append(trackFull.LcVel(i))
        if not trackFull.LcAccIsNone():
            self.lcAcc = []
            for i in range(trackFull.LcAccLength()):
                self.lcAcc.append(trackFull.LcAcc(i))
        if not trackFull.ENuvelIsNone():
            self.eNuvel = []
            for i in range(trackFull.ENuvelLength()):
                self.eNuvel.append(trackFull.ENuvel(i))
        if not trackFull.ENuposIsNone():
            self.eNupos = []
            for i in range(trackFull.ENuposLength()):
                self.eNupos.append(trackFull.ENupos(i))
        if not trackFull.CovIsNone():
            self.cov = []
            for i in range(trackFull.CovLength()):
                self.cov.append(trackFull.Cov(i))
        if not trackFull.ErrEllpIsNone():
            self.errEllp = []
            for i in range(trackFull.ErrEllpLength()):
                self.errEllp.append(trackFull.ErrEllp(i))
        if not trackFull.SrcTypsIsNone():
            self.srcTyps = []
            for i in range(trackFull.SrcTypsLength()):
                self.srcTyps.append(trackFull.SrcTyps(i))
        if not trackFull.SrcIdsIsNone():
            self.srcIds = []
            for i in range(trackFull.SrcIdsLength()):
                self.srcIds.append(trackFull.SrcIds(i))
        self.callSign = trackFull.CallSign()
        self.multiSource = trackFull.MultiSource()
        self.jSeries = trackFull.JSeries()
        self.strength = trackFull.Strength()
        self.m1 = trackFull.M1()
        self.m1v = trackFull.M1v()
        self.m2 = trackFull.M2()
        self.m2v = trackFull.M2v()
        self.m3a = trackFull.M3a()
        self.m3av = trackFull.M3av()
        if not trackFull.TagsIsNone():
            self.tags = []
            for i in range(trackFull.TagsLength()):
                self.tags.append(trackFull.Tags(i))
        self.sourceDl = trackFull.SourceDl()
        self.source = trackFull.Source()
        self.origin = trackFull.Origin()
        self.dataMode = trackFull.DataMode()
        self.origNetwork = trackFull.OrigNetwork()
    ...
    def Pack(self, builder):
        ...
        if self.ecefPos is not None:
            ...
            Track_FullStartEcefPosVector(builder, len(self.ecefPos))
        ...
        if self.ecefVel is not None:
            ...
            Track_FullStartEcefVelVector(builder, len(self.ecefVel))
        ...
        if self.ecefAcc is not None:
            ...
            Track_FullStartEcefAccVector(builder, len(self.ecefAcc))
        ...
        if self.lco is not None:
            ...
            Track_FullStartLcoVector(builder, len(self.lco))
        ...
        if self.lcs is not None:
            ...
            Track_FullStartLcsVector(builder, len(self.lcs))
        ...
        if self.lcPos is not None:
            ...
            Track_FullStartLcPosVector(builder, len(self.lcPos))
        ...
        if self.lcVel is not None:
            ...
            Track_FullStartLcVelVector(builder, len(self.lcVel))
        ...
        if self.lcAcc is not None:
            ...
            Track_FullStartLcAccVector(builder, len(self.lcAcc))
        ...
        if self.eNuvel is not None:
            ...
            Track_FullStartENuvelVector(builder, len(self.eNuvel))
        ...
        if self.eNupos is not None:
            ...
            Track_FullStartENuposVector(builder, len(self.eNupos))
        ...
        if self.cov is not None:
            ...
            Track_FullStartCovVector(builder, len(self.cov))
        ...
        if self.errEllp is not None:
            ...
            Track_FullStartErrEllpVector(builder, len(self.errEllp))
        ...
        if self.srcTyps is not None:
            ...
            Track_FullStartSrcTypsVector(builder, len(self.srcTyps))
        ...
        if self.srcIds is not None:
            ...
            Track_FullStartSrcIdsVector(builder, len(self.srcIds))
        ...
        if self.tags is not None:
            ...
            Track_FullStartTagsVector(builder, len(self.tags))
        ...
        if self.ts is not None:
            Track_FullAddTs(builder, ts)
        Track_FullAddTrkQual(builder, self.trkQual)
        if self.trkPtType is not None:
            Track_FullAddTrkPtType(builder, trkPtType)
        if self.objIdent is not None:
            Track_FullAddObjIdent(builder, objIdent)
        Track_FullAddIdentCred(builder, self.identCred)
        Track_FullAddIdentRel(builder, self.identRel)
        if self.identAmp is not None:
            Track_FullAddIdentAmp(builder, identAmp)
        if self.env is not None:
            Track_FullAddEnv(builder, env)
        Track_FullAddEnvConf(builder, self.envConf)
        Track_FullAddTrkConf(builder, self.trkConf)
        if self.ecefPos is not None:
            Track_FullAddEcefPos(builder, ecefPos)
        if self.ecefVel is not None:
            Track_FullAddEcefVel(builder, ecefVel)
        if self.ecefAcc is not None:
            Track_FullAddEcefAcc(builder, ecefAcc)
        Track_FullAddLat(builder, self.lat)
        Track_FullAddLon(builder, self.lon)
        Track_FullAddAlt(builder, self.alt)
        Track_FullAddSpd(builder, self.spd)
        Track_FullAddHdng(builder, self.hdng)
        Track_FullAddCourse(builder, self.course)
        if self.lco is not None:
            Track_FullAddLco(builder, lco)
        if self.lcs is not None:
            Track_FullAddLcs(builder, lcs)
        ...
        if self.callSign is not None:
            Track_FullAddCallSign(builder, callSign)
        Track_FullAddMultiSource(builder, self.multiSource)
        if self.jSeries is not None:
            Track_FullAddJSeries(builder, jSeries)
        Track_FullAddStrength(builder, self.strength)
        Track_FullAddM1(builder, self.m1)
        Track_FullAddM1v(builder, self.m1v)
        Track_FullAddM2(builder, self.m2)
        Track_FullAddM2v(builder, self.m2v)
        Track_FullAddM3a(builder, self.m3a)
        Track_FullAddM3av(builder, self.m3av)
        if self.tags is not None:
            Track_FullAddTags(builder, tags)
        if self.sourceDl is not None:
            Track_FullAddSourceDl(builder, sourceDl)
        ...
        if self.origin is not None:
            Track_FullAddOrigin(builder, origin)
        Track_FullAddDataMode(builder, self.dataMode)
        if self.origNetwork is not None:
            Track_FullAddOrigNetwork(builder, origNetwork)
        trackFull = Track_FullEnd(builder)
        return trackFull
