...
class LinkStatus_Ingest(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsLinkStatus_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def LinkStatus_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def LinkStatus_IngestStart(builder):
    builder.StartObject(31)

def Start(builder):
    LinkStatus_IngestStart(builder)

def LinkStatus_IngestAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    LinkStatus_IngestAddId(builder, id)

def LinkStatus_IngestAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    LinkStatus_IngestAddClassificationMarking(builder, classificationMarking)

def LinkStatus_IngestAddIdOnOrbit1(builder, idOnOrbit1):
...
def AddIdOnOrbit1(builder, idOnOrbit1):
    LinkStatus_IngestAddIdOnOrbit1(builder, idOnOrbit1)

def LinkStatus_IngestAddIdOnOrbit2(builder, idOnOrbit2):
...
def AddIdOnOrbit2(builder, idOnOrbit2):
    LinkStatus_IngestAddIdOnOrbit2(builder, idOnOrbit2)

def LinkStatus_IngestAddLinkStartTime(builder, linkStartTime):
...
def AddLinkStartTime(builder, linkStartTime):
    LinkStatus_IngestAddLinkStartTime(builder, linkStartTime)

def LinkStatus_IngestAddLinkStopTime(builder, linkStopTime):
...
def AddLinkStopTime(builder, linkStopTime):
    LinkStatus_IngestAddLinkStopTime(builder, linkStopTime)

def LinkStatus_IngestAddConstellation(builder, constellation):
...
def AddConstellation(builder, constellation):
    LinkStatus_IngestAddConstellation(builder, constellation)

def LinkStatus_IngestAddLinkName(builder, linkName):
...
def AddLinkName(builder, linkName):
    LinkStatus_IngestAddLinkName(builder, linkName)

def LinkStatus_IngestAddLinkType(builder, linkType):
...
def AddLinkType(builder, linkType):
    LinkStatus_IngestAddLinkType(builder, linkType)

def LinkStatus_IngestAddBand(builder, band):
    builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(band), 0)

def AddBand(builder, band):
    LinkStatus_IngestAddBand(builder, band)

def LinkStatus_IngestAddIdBeam1(builder, idBeam1):
...
def AddIdBeam1(builder, idBeam1):
    LinkStatus_IngestAddIdBeam1(builder, idBeam1)

def LinkStatus_IngestAddEndPoint1Name(builder, endPoint1Name):
...
def AddEndPoint1Name(builder, endPoint1Name):
    LinkStatus_IngestAddEndPoint1Name(builder, endPoint1Name)

def LinkStatus_IngestAddEndPoint1Lat(builder, endPoint1Lat):
    builder.PrependFloat64Slot(12, endPoint1Lat, 0.0)

def AddEndPoint1Lat(builder, endPoint1Lat):
    LinkStatus_IngestAddEndPoint1Lat(builder, endPoint1Lat)

def LinkStatus_IngestAddEndPoint1Lon(builder, endPoint1Lon):
    builder.PrependFloat64Slot(13, endPoint1Lon, 0.0)

def AddEndPoint1Lon(builder, endPoint1Lon):
    LinkStatus_IngestAddEndPoint1Lon(builder, endPoint1Lon)

def LinkStatus_IngestAddIdBeam2(builder, idBeam2):
...
def AddIdBeam2(builder, idBeam2):
    LinkStatus_IngestAddIdBeam2(builder, idBeam2)

def LinkStatus_IngestAddEndPoint2Name(builder, endPoint2Name):
...
def AddEndPoint2Name(builder, endPoint2Name):
    LinkStatus_IngestAddEndPoint2Name(builder, endPoint2Name)

def LinkStatus_IngestAddEndPoint2Lat(builder, endPoint2Lat):
    builder.PrependFloat64Slot(16, endPoint2Lat, 0.0)

def AddEndPoint2Lat(builder, endPoint2Lat):
    LinkStatus_IngestAddEndPoint2Lat(builder, endPoint2Lat)

def LinkStatus_IngestAddEndPoint2Lon(builder, endPoint2Lon):
    builder.PrependFloat64Slot(17, endPoint2Lon, 0.0)

def AddEndPoint2Lon(builder, endPoint2Lon):
    LinkStatus_IngestAddEndPoint2Lon(builder, endPoint2Lon)

def LinkStatus_IngestAddDataRate1To2(builder, dataRate1To2):
    builder.PrependFloat64Slot(18, dataRate1To2, 0.0)

def AddDataRate1To2(builder, dataRate1To2):
    LinkStatus_IngestAddDataRate1To2(builder, dataRate1To2)

def LinkStatus_IngestAddDataRate2To1(builder, dataRate2To1):
    builder.PrependFloat64Slot(19, dataRate2To1, 0.0)

def AddDataRate2To1(builder, dataRate2To1):
    LinkStatus_IngestAddDataRate2To1(builder, dataRate2To1)

def LinkStatus_IngestAddLinkState(builder, linkState):
...
def AddLinkState(builder, linkState):
    LinkStatus_IngestAddLinkState(builder, linkState)

def LinkStatus_IngestAddSysCap(builder, sysCap):
...
def AddSysCap(builder, sysCap):
    LinkStatus_IngestAddSysCap(builder, sysCap)

def LinkStatus_IngestAddOpsCap(builder, opsCap):
...
def AddOpsCap(builder, opsCap):
    LinkStatus_IngestAddOpsCap(builder, opsCap)

def LinkStatus_IngestAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    LinkStatus_IngestAddCreatedAt(builder, createdAt)

def LinkStatus_IngestAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    LinkStatus_IngestAddCreatedBy(builder, createdBy)

def LinkStatus_IngestAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(25, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    LinkStatus_IngestAddSource(builder, source)

def LinkStatus_IngestAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(26, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    LinkStatus_IngestAddOrigin(builder, origin)

def LinkStatus_IngestAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    LinkStatus_IngestAddOrigNetwork(builder, origNetwork)

def LinkStatus_IngestAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(28, dataMode, 0)

def AddDataMode(builder, dataMode):
    LinkStatus_IngestAddDataMode(builder, dataMode)

def LinkStatus_IngestAddSatNo1(builder, satNo1):
    builder.PrependInt32Slot(29, satNo1, 0)

def AddSatNo1(builder, satNo1):
    LinkStatus_IngestAddSatNo1(builder, satNo1)

def LinkStatus_IngestAddSatNo2(builder, satNo2):
    builder.PrependInt32Slot(30, satNo2, 0)

def AddSatNo2(builder, satNo2):
    LinkStatus_IngestAddSatNo2(builder, satNo2)

def LinkStatus_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return LinkStatus_IngestEnd(builder)


class LinkStatus_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        linkStatusIngest = LinkStatus_Ingest()
        linkStatusIngest.Init(buf, pos)
        return cls.InitFromObj(linkStatusIngest)
    ...
    @classmethod
    def InitFromObj(cls, linkStatusIngest):
        x = LinkStatus_IngestT()
        x._UnPack(linkStatusIngest)
        return x

    # LinkStatus_IngestT
    def _UnPack(self, linkStatusIngest):
        if linkStatusIngest is None:
            return
        self.id = linkStatusIngest.Id()
        self.classificationMarking = linkStatusIngest.ClassificationMarking()
        self.idOnOrbit1 = linkStatusIngest.IdOnOrbit1()
        self.idOnOrbit2 = linkStatusIngest.IdOnOrbit2()
        self.linkStartTime = linkStatusIngest.LinkStartTime()
        self.linkStopTime = linkStatusIngest.LinkStopTime()
        self.constellation = linkStatusIngest.Constellation()
        self.linkName = linkStatusIngest.LinkName()
        self.linkType = linkStatusIngest.LinkType()
        self.band = linkStatusIngest.Band()
        self.idBeam1 = linkStatusIngest.IdBeam1()
        self.endPoint1Name = linkStatusIngest.EndPoint1Name()
        self.endPoint1Lat = linkStatusIngest.EndPoint1Lat()
        self.endPoint1Lon = linkStatusIngest.EndPoint1Lon()
        self.idBeam2 = linkStatusIngest.IdBeam2()
        self.endPoint2Name = linkStatusIngest.EndPoint2Name()
        self.endPoint2Lat = linkStatusIngest.EndPoint2Lat()
        self.endPoint2Lon = linkStatusIngest.EndPoint2Lon()
        self.dataRate1To2 = linkStatusIngest.DataRate1To2()
        self.dataRate2To1 = linkStatusIngest.DataRate2To1()
        self.linkState = linkStatusIngest.LinkState()
        self.sysCap = linkStatusIngest.SysCap()
        self.opsCap = linkStatusIngest.OpsCap()
        self.createdAt = linkStatusIngest.CreatedAt()
        self.createdBy = linkStatusIngest.CreatedBy()
        self.source = linkStatusIngest.Source()
        self.origin = linkStatusIngest.Origin()
        self.origNetwork = linkStatusIngest.OrigNetwork()
        self.dataMode = linkStatusIngest.DataMode()
        self.satNo1 = linkStatusIngest.SatNo1()
        self.satNo2 = linkStatusIngest.SatNo2()
    ...
    def Pack(self, builder):
        ...
        if self.endPoint1Name is not None:
            LinkStatus_IngestAddEndPoint1Name(builder, endPoint1Name)
        LinkStatus_IngestAddEndPoint1Lat(builder, self.endPoint1Lat)
        LinkStatus_IngestAddEndPoint1Lon(builder, self.endPoint1Lon)
        if self.idBeam2 is not None:
            LinkStatus_IngestAddIdBeam2(builder, idBeam2)
        if self.endPoint2Name is not None:
            LinkStatus_IngestAddEndPoint2Name(builder, endPoint2Name)
        LinkStatus_IngestAddEndPoint2Lat(builder, self.endPoint2Lat)
        LinkStatus_IngestAddEndPoint2Lon(builder, self.endPoint2Lon)
        LinkStatus_IngestAddDataRate1To2(builder, self.dataRate1To2)
        LinkStatus_IngestAddDataRate2To1(builder, self.dataRate2To1)
        if self.linkState is not None:
            LinkStatus_IngestAddLinkState(builder, linkState)
        if self.sysCap is not None:
            LinkStatus_IngestAddSysCap(builder, sysCap)
        ...
        if self.origNetwork is not None:
            LinkStatus_IngestAddOrigNetwork(builder, origNetwork)
        LinkStatus_IngestAddDataMode(builder, self.dataMode)
        LinkStatus_IngestAddSatNo1(builder, self.satNo1)
        LinkStatus_IngestAddSatNo2(builder, self.satNo2)
        linkStatusIngest = LinkStatus_IngestEnd(builder)
        return linkStatusIngest
