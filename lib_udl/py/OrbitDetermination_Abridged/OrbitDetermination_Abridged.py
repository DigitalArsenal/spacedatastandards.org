...
class OrbitDetermination_Abridged(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsOrbitDetermination_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def OrbitDetermination_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf, offset, b"\x4F\x52\x42\x49", size_prefixed=size_prefixed)

    # OrbitDetermination_Abridged
...
def OrbitDetermination_AbridgedStart(builder):
    builder.StartObject(44)

def Start(builder):
    OrbitDetermination_AbridgedStart(builder)

def OrbitDetermination_AbridgedAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    OrbitDetermination_AbridgedAddId(builder, id)

def OrbitDetermination_AbridgedAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    OrbitDetermination_AbridgedAddClassificationMarking(builder, classificationMarking)

def OrbitDetermination_AbridgedAddStartTime(builder, startTime):
...
def AddStartTime(builder, startTime):
    OrbitDetermination_AbridgedAddStartTime(builder, startTime)

def OrbitDetermination_AbridgedAddEndTime(builder, endTime):
...
def AddEndTime(builder, endTime):
    OrbitDetermination_AbridgedAddEndTime(builder, endTime)

def OrbitDetermination_AbridgedAddIdOnOrbit(builder, idOnOrbit):
...
def AddIdOnOrbit(builder, idOnOrbit):
    OrbitDetermination_AbridgedAddIdOnOrbit(builder, idOnOrbit)

def OrbitDetermination_AbridgedAddOrigObjectId(builder, origObjectId):
...
def AddOrigObjectId(builder, origObjectId):
    OrbitDetermination_AbridgedAddOrigObjectId(builder, origObjectId)

def OrbitDetermination_AbridgedAddSatNo(builder, satNo):
    builder.PrependInt32Slot(6, satNo, 0)

def AddSatNo(builder, satNo):
    OrbitDetermination_AbridgedAddSatNo(builder, satNo)

def OrbitDetermination_AbridgedAddAprioriIdElset(builder, aprioriIdElset):
...
def AddAprioriIdElset(builder, aprioriIdElset):
    OrbitDetermination_AbridgedAddAprioriIdElset(builder, aprioriIdElset)

def OrbitDetermination_AbridgedAddAprioriElset(builder, aprioriElset):
...
def AddAprioriElset(builder, aprioriElset):
    OrbitDetermination_AbridgedAddAprioriElset(builder, aprioriElset)

def OrbitDetermination_AbridgedAddAprioriIdStateVector(builder, aprioriIdStateVector):
...
def AddAprioriIdStateVector(builder, aprioriIdStateVector):
    OrbitDetermination_AbridgedAddAprioriIdStateVector(builder, aprioriIdStateVector)

def OrbitDetermination_AbridgedAddAprioriStateVector(builder, aprioriStateVector):
...
def AddAprioriStateVector(builder, aprioriStateVector):
    OrbitDetermination_AbridgedAddAprioriStateVector(builder, aprioriStateVector)

def OrbitDetermination_AbridgedAddInitialOd(builder, initialOd):
    builder.PrependBoolSlot(11, initialOd, 0)

def AddInitialOd(builder, initialOd):
    OrbitDetermination_AbridgedAddInitialOd(builder, initialOd)

def OrbitDetermination_AbridgedAddLastObStart(builder, lastObStart):
...
def AddLastObStart(builder, lastObStart):
    OrbitDetermination_AbridgedAddLastObStart(builder, lastObStart)

def OrbitDetermination_AbridgedAddLastObEnd(builder, lastObEnd):
...
def AddLastObEnd(builder, lastObEnd):
    OrbitDetermination_AbridgedAddLastObEnd(builder, lastObEnd)

def OrbitDetermination_AbridgedAddTimeSpan(builder, timeSpan):
    builder.PrependFloat64Slot(14, timeSpan, 0.0)

def AddTimeSpan(builder, timeSpan):
    OrbitDetermination_AbridgedAddTimeSpan(builder, timeSpan)

def OrbitDetermination_AbridgedAddEffectiveFrom(builder, effectiveFrom):
...
def AddEffectiveFrom(builder, effectiveFrom):
    OrbitDetermination_AbridgedAddEffectiveFrom(builder, effectiveFrom)

def OrbitDetermination_AbridgedAddEffectiveUntil(builder, effectiveUntil):
...
def AddEffectiveUntil(builder, effectiveUntil):
    OrbitDetermination_AbridgedAddEffectiveUntil(builder, effectiveUntil)

def OrbitDetermination_AbridgedAddWrms(builder, wrms):
    builder.PrependFloat64Slot(17, wrms, 0.0)

def AddWrms(builder, wrms):
    OrbitDetermination_AbridgedAddWrms(builder, wrms)

def OrbitDetermination_AbridgedAddPreviousWrms(builder, previousWrms):
    builder.PrependFloat64Slot(18, previousWrms, 0.0)

def AddPreviousWrms(builder, previousWrms):
    OrbitDetermination_AbridgedAddPreviousWrms(builder, previousWrms)

def OrbitDetermination_AbridgedAddFirstPassWrms(builder, firstPassWrms):
    builder.PrependFloat64Slot(19, firstPassWrms, 0.0)

def AddFirstPassWrms(builder, firstPassWrms):
    OrbitDetermination_AbridgedAddFirstPassWrms(builder, firstPassWrms)

def OrbitDetermination_AbridgedAddBestPassWrms(builder, bestPassWrms):
    builder.PrependFloat64Slot(20, bestPassWrms, 0.0)

def AddBestPassWrms(builder, bestPassWrms):
    OrbitDetermination_AbridgedAddBestPassWrms(builder, bestPassWrms)

def OrbitDetermination_AbridgedAddErrorGrowthRate(builder, errorGrowthRate):
    builder.PrependFloat64Slot(21, errorGrowthRate, 0.0)

def AddErrorGrowthRate(builder, errorGrowthRate):
    OrbitDetermination_AbridgedAddErrorGrowthRate(builder, errorGrowthRate)

def OrbitDetermination_AbridgedAddEdr(builder, edr):
    builder.PrependFloat64Slot(22, edr, 0.0)

def AddEdr(builder, edr):
    OrbitDetermination_AbridgedAddEdr(builder, edr)

def OrbitDetermination_AbridgedAddMethod(builder, method):
...
def AddMethod(builder, method):
    OrbitDetermination_AbridgedAddMethod(builder, method)

def OrbitDetermination_AbridgedAddMethodSource(builder, methodSource):
...
def AddMethodSource(builder, methodSource):
    OrbitDetermination_AbridgedAddMethodSource(builder, methodSource)

def OrbitDetermination_AbridgedAddFitSpan(builder, fitSpan):
    builder.PrependFloat64Slot(25, fitSpan, 0.0)

def AddFitSpan(builder, fitSpan):
    OrbitDetermination_AbridgedAddFitSpan(builder, fitSpan)

def OrbitDetermination_AbridgedAddBallisticCoeffEst(builder, ballisticCoeffEst):
    builder.PrependBoolSlot(26, ballisticCoeffEst, 0)

def AddBallisticCoeffEst(builder, ballisticCoeffEst):
    OrbitDetermination_AbridgedAddBallisticCoeffEst(builder, ballisticCoeffEst)

def OrbitDetermination_AbridgedAddBallisticCoeffModel(builder, ballisticCoeffModel):
...
def AddBallisticCoeffModel(builder, ballisticCoeffModel):
    OrbitDetermination_AbridgedAddBallisticCoeffModel(builder, ballisticCoeffModel)

def OrbitDetermination_AbridgedAddAgomEst(builder, agomEst):
    builder.PrependBoolSlot(28, agomEst, 0)

def AddAgomEst(builder, agomEst):
    OrbitDetermination_AbridgedAddAgomEst(builder, agomEst)

def OrbitDetermination_AbridgedAddAgomModel(builder, agomModel):
...
def AddAgomModel(builder, agomModel):
    OrbitDetermination_AbridgedAddAgomModel(builder, agomModel)

def OrbitDetermination_AbridgedAddRmsConvergenceCriteria(builder, rmsConvergenceCriteria):
    builder.PrependFloat64Slot(30, rmsConvergenceCriteria, 0.0)

def AddRmsConvergenceCriteria(builder, rmsConvergenceCriteria):
    OrbitDetermination_AbridgedAddRmsConvergenceCriteria(builder, rmsConvergenceCriteria)

def OrbitDetermination_AbridgedAddNumIterations(builder, numIterations):
    builder.PrependInt32Slot(31, numIterations, 0)

def AddNumIterations(builder, numIterations):
    OrbitDetermination_AbridgedAddNumIterations(builder, numIterations)

def OrbitDetermination_AbridgedAddAcceptedObTyps(builder, acceptedObTyps):
...
def AddAcceptedObTyps(builder, acceptedObTyps):
    OrbitDetermination_AbridgedAddAcceptedObTyps(builder, acceptedObTyps)

def OrbitDetermination_AbridgedStartAcceptedObTypsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartAcceptedObTypsVector(builder, numElems):
    return OrbitDetermination_AbridgedStartAcceptedObTypsVector(builder, numElems)

def OrbitDetermination_AbridgedAddAcceptedObIds(builder, acceptedObIds):
...
def AddAcceptedObIds(builder, acceptedObIds):
    OrbitDetermination_AbridgedAddAcceptedObIds(builder, acceptedObIds)

def OrbitDetermination_AbridgedStartAcceptedObIdsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartAcceptedObIdsVector(builder, numElems):
    return OrbitDetermination_AbridgedStartAcceptedObIdsVector(builder, numElems)

def OrbitDetermination_AbridgedAddRejectedObTyps(builder, rejectedObTyps):
...
def AddRejectedObTyps(builder, rejectedObTyps):
    OrbitDetermination_AbridgedAddRejectedObTyps(builder, rejectedObTyps)

def OrbitDetermination_AbridgedStartRejectedObTypsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartRejectedObTypsVector(builder, numElems):
    return OrbitDetermination_AbridgedStartRejectedObTypsVector(builder, numElems)

def OrbitDetermination_AbridgedAddRejectedObIds(builder, rejectedObIds):
...
def AddRejectedObIds(builder, rejectedObIds):
    OrbitDetermination_AbridgedAddRejectedObIds(builder, rejectedObIds)

def OrbitDetermination_AbridgedStartRejectedObIdsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartRejectedObIdsVector(builder, numElems):
    return OrbitDetermination_AbridgedStartRejectedObIdsVector(builder, numElems)

def OrbitDetermination_AbridgedAddSensorIds(builder, sensorIds):
...
def AddSensorIds(builder, sensorIds):
    OrbitDetermination_AbridgedAddSensorIds(builder, sensorIds)

def OrbitDetermination_AbridgedStartSensorIdsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartSensorIdsVector(builder, numElems):
    return OrbitDetermination_AbridgedStartSensorIdsVector(builder, numElems)

def OrbitDetermination_AbridgedAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(37, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    OrbitDetermination_AbridgedAddCreatedAt(builder, createdAt)

def OrbitDetermination_AbridgedAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(38, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    OrbitDetermination_AbridgedAddCreatedBy(builder, createdBy)

def OrbitDetermination_AbridgedAddSourceDl(builder, sourceDl):
...
def AddSourceDl(builder, sourceDl):
    OrbitDetermination_AbridgedAddSourceDl(builder, sourceDl)

def OrbitDetermination_AbridgedAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(40, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    OrbitDetermination_AbridgedAddSource(builder, source)

def OrbitDetermination_AbridgedAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(41, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    OrbitDetermination_AbridgedAddOrigin(builder, origin)

def OrbitDetermination_AbridgedAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(42, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    OrbitDetermination_AbridgedAddOrigNetwork(builder, origNetwork)

def OrbitDetermination_AbridgedAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(43, dataMode, 0)

def AddDataMode(builder, dataMode):
    OrbitDetermination_AbridgedAddDataMode(builder, dataMode)

def OrbitDetermination_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return OrbitDetermination_AbridgedEnd(builder)
...
class OrbitDetermination_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        orbitDeterminationAbridged = OrbitDetermination_Abridged()
        orbitDeterminationAbridged.Init(buf, pos)
        return cls.InitFromObj(orbitDeterminationAbridged)
    ...
    @classmethod
    def InitFromObj(cls, orbitDeterminationAbridged):
        x = OrbitDetermination_AbridgedT()
        x._UnPack(orbitDeterminationAbridged)
        return x

    # OrbitDetermination_AbridgedT
    def _UnPack(self, orbitDeterminationAbridged):
        if orbitDeterminationAbridged is None:
            return
        self.id = orbitDeterminationAbridged.Id()
        self.classificationMarking = orbitDeterminationAbridged.ClassificationMarking()
        self.startTime = orbitDeterminationAbridged.StartTime()
        self.endTime = orbitDeterminationAbridged.EndTime()
        self.idOnOrbit = orbitDeterminationAbridged.IdOnOrbit()
        self.origObjectId = orbitDeterminationAbridged.OrigObjectId()
        self.satNo = orbitDeterminationAbridged.SatNo()
        self.aprioriIdElset = orbitDeterminationAbridged.AprioriIdElset()
        self.aprioriElset = orbitDeterminationAbridged.AprioriElset()
        self.aprioriIdStateVector = orbitDeterminationAbridged.AprioriIdStateVector()
        self.aprioriStateVector = orbitDeterminationAbridged.AprioriStateVector()
        self.initialOd = orbitDeterminationAbridged.InitialOd()
        self.lastObStart = orbitDeterminationAbridged.LastObStart()
        self.lastObEnd = orbitDeterminationAbridged.LastObEnd()
        self.timeSpan = orbitDeterminationAbridged.TimeSpan()
        self.effectiveFrom = orbitDeterminationAbridged.EffectiveFrom()
        self.effectiveUntil = orbitDeterminationAbridged.EffectiveUntil()
        self.wrms = orbitDeterminationAbridged.Wrms()
        self.previousWrms = orbitDeterminationAbridged.PreviousWrms()
        self.firstPassWrms = orbitDeterminationAbridged.FirstPassWrms()
        self.bestPassWrms = orbitDeterminationAbridged.BestPassWrms()
        self.errorGrowthRate = orbitDeterminationAbridged.ErrorGrowthRate()
        self.edr = orbitDeterminationAbridged.Edr()
        self.method = orbitDeterminationAbridged.Method()
        self.methodSource = orbitDeterminationAbridged.MethodSource()
        self.fitSpan = orbitDeterminationAbridged.FitSpan()
        self.ballisticCoeffEst = orbitDeterminationAbridged.BallisticCoeffEst()
        self.ballisticCoeffModel = orbitDeterminationAbridged.BallisticCoeffModel()
        self.agomEst = orbitDeterminationAbridged.AgomEst()
        self.agomModel = orbitDeterminationAbridged.AgomModel()
        self.rmsConvergenceCriteria = orbitDeterminationAbridged.RmsConvergenceCriteria()
        self.numIterations = orbitDeterminationAbridged.NumIterations()
        if not orbitDeterminationAbridged.AcceptedObTypsIsNone():
            self.acceptedObTyps = []
            for i in range(orbitDeterminationAbridged.AcceptedObTypsLength()):
                self.acceptedObTyps.append(orbitDeterminationAbridged.AcceptedObTyps(i))
        if not orbitDeterminationAbridged.AcceptedObIdsIsNone():
            self.acceptedObIds = []
            for i in range(orbitDeterminationAbridged.AcceptedObIdsLength()):
                self.acceptedObIds.append(orbitDeterminationAbridged.AcceptedObIds(i))
        if not orbitDeterminationAbridged.RejectedObTypsIsNone():
            self.rejectedObTyps = []
            for i in range(orbitDeterminationAbridged.RejectedObTypsLength()):
                self.rejectedObTyps.append(orbitDeterminationAbridged.RejectedObTyps(i))
        if not orbitDeterminationAbridged.RejectedObIdsIsNone():
            self.rejectedObIds = []
            for i in range(orbitDeterminationAbridged.RejectedObIdsLength()):
                self.rejectedObIds.append(orbitDeterminationAbridged.RejectedObIds(i))
        if not orbitDeterminationAbridged.SensorIdsIsNone():
            self.sensorIds = []
            for i in range(orbitDeterminationAbridged.SensorIdsLength()):
                self.sensorIds.append(orbitDeterminationAbridged.SensorIds(i))
        self.createdAt = orbitDeterminationAbridged.CreatedAt()
        self.createdBy = orbitDeterminationAbridged.CreatedBy()
        self.sourceDl = orbitDeterminationAbridged.SourceDl()
        self.source = orbitDeterminationAbridged.Source()
        self.origin = orbitDeterminationAbridged.Origin()
        self.origNetwork = orbitDeterminationAbridged.OrigNetwork()
        self.dataMode = orbitDeterminationAbridged.DataMode()
    ...
    def Pack(self, builder):
        ...
        if self.acceptedObTyps is not None:
            ...
            OrbitDetermination_AbridgedStartAcceptedObTypsVector(builder, len(self.acceptedObTyps))
        ...
        if self.acceptedObIds is not None:
            ...
            OrbitDetermination_AbridgedStartAcceptedObIdsVector(builder, len(self.acceptedObIds))
        ...
        if self.rejectedObTyps is not None:
            ...
            OrbitDetermination_AbridgedStartRejectedObTypsVector(builder, len(self.rejectedObTyps))
        ...
        if self.rejectedObIds is not None:
            ...
            OrbitDetermination_AbridgedStartRejectedObIdsVector(builder, len(self.rejectedObIds))
        ...
        if self.sensorIds is not None:
            ...
            OrbitDetermination_AbridgedStartSensorIdsVector(builder, len(self.sensorIds))
        ...
        if self.origObjectId is not None:
            OrbitDetermination_AbridgedAddOrigObjectId(builder, origObjectId)
        OrbitDetermination_AbridgedAddSatNo(builder, self.satNo)
        if self.aprioriIdElset is not None:
            OrbitDetermination_AbridgedAddAprioriIdElset(builder, aprioriIdElset)
        if self.aprioriElset is not None:
            OrbitDetermination_AbridgedAddAprioriElset(builder, aprioriElset)
        ...
        if self.aprioriStateVector is not None:
            OrbitDetermination_AbridgedAddAprioriStateVector(builder, aprioriStateVector)
        OrbitDetermination_AbridgedAddInitialOd(builder, self.initialOd)
        if self.lastObStart is not None:
            OrbitDetermination_AbridgedAddLastObStart(builder, lastObStart)
        if self.lastObEnd is not None:
            OrbitDetermination_AbridgedAddLastObEnd(builder, lastObEnd)
        OrbitDetermination_AbridgedAddTimeSpan(builder, self.timeSpan)
        if self.effectiveFrom is not None:
            OrbitDetermination_AbridgedAddEffectiveFrom(builder, effectiveFrom)
        if self.effectiveUntil is not None:
            OrbitDetermination_AbridgedAddEffectiveUntil(builder, effectiveUntil)
        OrbitDetermination_AbridgedAddWrms(builder, self.wrms)
        OrbitDetermination_AbridgedAddPreviousWrms(builder, self.previousWrms)
        OrbitDetermination_AbridgedAddFirstPassWrms(builder, self.firstPassWrms)
        OrbitDetermination_AbridgedAddBestPassWrms(builder, self.bestPassWrms)
        OrbitDetermination_AbridgedAddErrorGrowthRate(builder, self.errorGrowthRate)
        OrbitDetermination_AbridgedAddEdr(builder, self.edr)
        if self.method is not None:
            OrbitDetermination_AbridgedAddMethod(builder, method)
        if self.methodSource is not None:
            OrbitDetermination_AbridgedAddMethodSource(builder, methodSource)
        OrbitDetermination_AbridgedAddFitSpan(builder, self.fitSpan)
        OrbitDetermination_AbridgedAddBallisticCoeffEst(builder, self.ballisticCoeffEst)
        if self.ballisticCoeffModel is not None:
            OrbitDetermination_AbridgedAddBallisticCoeffModel(builder, ballisticCoeffModel)
        OrbitDetermination_AbridgedAddAgomEst(builder, self.agomEst)
        if self.agomModel is not None:
            OrbitDetermination_AbridgedAddAgomModel(builder, agomModel)
        OrbitDetermination_AbridgedAddRmsConvergenceCriteria(builder, self.rmsConvergenceCriteria)
        OrbitDetermination_AbridgedAddNumIterations(builder, self.numIterations)
        if self.acceptedObTyps is not None:
            OrbitDetermination_AbridgedAddAcceptedObTyps(builder, acceptedObTyps)
        if self.acceptedObIds is not None:
            OrbitDetermination_AbridgedAddAcceptedObIds(builder, acceptedObIds)
        ...
        if self.origNetwork is not None:
            OrbitDetermination_AbridgedAddOrigNetwork(builder, origNetwork)
        OrbitDetermination_AbridgedAddDataMode(builder, self.dataMode)
        orbitDeterminationAbridged = OrbitDetermination_AbridgedEnd(builder)
        return orbitDeterminationAbridged
