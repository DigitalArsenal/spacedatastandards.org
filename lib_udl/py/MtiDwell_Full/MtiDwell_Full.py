...
class MtiDwell_Full(object):
    ...
    @classmethod
    def GetRootAsMtiDwell_Full(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def MtiDwell_FullBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def MtiDwell_FullStart(builder):
    builder.StartObject(32)

def Start(builder):
    MtiDwell_FullStart(builder)

def MtiDwell_FullAddD2(builder, d2):
    builder.PrependInt32Slot(0, d2, 0)

def AddD2(builder, d2):
    MtiDwell_FullAddD2(builder, d2)

def MtiDwell_FullAddD3(builder, d3):
    builder.PrependInt32Slot(1, d3, 0)

def AddD3(builder, d3):
    MtiDwell_FullAddD3(builder, d3)

def MtiDwell_FullAddD4(builder, d4):
    builder.PrependBoolSlot(2, d4, 0)

def AddD4(builder, d4):
    MtiDwell_FullAddD4(builder, d4)

def MtiDwell_FullAddD5(builder, d5):
    builder.PrependInt32Slot(3, d5, 0)

def AddD5(builder, d5):
    MtiDwell_FullAddD5(builder, d5)

def MtiDwell_FullAddD6(builder, d6):
    builder.PrependInt64Slot(4, d6, 0)

def AddD6(builder, d6):
    MtiDwell_FullAddD6(builder, d6)

def MtiDwell_FullAddD7(builder, d7):
    builder.PrependFloat64Slot(5, d7, 0.0)

def AddD7(builder, d7):
    MtiDwell_FullAddD7(builder, d7)

def MtiDwell_FullAddD8(builder, d8):
    builder.PrependFloat64Slot(6, d8, 0.0)

def AddD8(builder, d8):
    MtiDwell_FullAddD8(builder, d8)

def MtiDwell_FullAddD9(builder, d9):
    builder.PrependInt32Slot(7, d9, 0)

def AddD9(builder, d9):
    MtiDwell_FullAddD9(builder, d9)

def MtiDwell_FullAddD10(builder, d10):
    builder.PrependFloat64Slot(8, d10, 0.0)

def AddD10(builder, d10):
    MtiDwell_FullAddD10(builder, d10)

def MtiDwell_FullAddD11(builder, d11):
    builder.PrependFloat64Slot(9, d11, 0.0)

def AddD11(builder, d11):
    MtiDwell_FullAddD11(builder, d11)

def MtiDwell_FullAddD12(builder, d12):
    builder.PrependInt32Slot(10, d12, 0)

def AddD12(builder, d12):
    MtiDwell_FullAddD12(builder, d12)

def MtiDwell_FullAddD13(builder, d13):
    builder.PrependInt32Slot(11, d13, 0)

def AddD13(builder, d13):
    MtiDwell_FullAddD13(builder, d13)

def MtiDwell_FullAddD14(builder, d14):
    builder.PrependInt32Slot(12, d14, 0)

def AddD14(builder, d14):
    MtiDwell_FullAddD14(builder, d14)

def MtiDwell_FullAddD15(builder, d15):
    builder.PrependFloat64Slot(13, d15, 0.0)

def AddD15(builder, d15):
    MtiDwell_FullAddD15(builder, d15)

def MtiDwell_FullAddD16(builder, d16):
    builder.PrependInt32Slot(14, d16, 0)

def AddD16(builder, d16):
    MtiDwell_FullAddD16(builder, d16)

def MtiDwell_FullAddD17(builder, d17):
    builder.PrependInt32Slot(15, d17, 0)

def AddD17(builder, d17):
    MtiDwell_FullAddD17(builder, d17)

def MtiDwell_FullAddD18(builder, d18):
    builder.PrependInt32Slot(16, d18, 0)

def AddD18(builder, d18):
    MtiDwell_FullAddD18(builder, d18)

def MtiDwell_FullAddD19(builder, d19):
    builder.PrependInt32Slot(17, d19, 0)

def AddD19(builder, d19):
    MtiDwell_FullAddD19(builder, d19)

def MtiDwell_FullAddD20(builder, d20):
    builder.PrependInt32Slot(18, d20, 0)

def AddD20(builder, d20):
    MtiDwell_FullAddD20(builder, d20)

def MtiDwell_FullAddD21(builder, d21):
    builder.PrependFloat64Slot(19, d21, 0.0)

def AddD21(builder, d21):
    MtiDwell_FullAddD21(builder, d21)

def MtiDwell_FullAddD22(builder, d22):
    builder.PrependFloat64Slot(20, d22, 0.0)

def AddD22(builder, d22):
    MtiDwell_FullAddD22(builder, d22)

def MtiDwell_FullAddD23(builder, d23):
    builder.PrependFloat64Slot(21, d23, 0.0)

def AddD23(builder, d23):
    MtiDwell_FullAddD23(builder, d23)

def MtiDwell_FullAddD24(builder, d24):
    builder.PrependFloat64Slot(22, d24, 0.0)

def AddD24(builder, d24):
    MtiDwell_FullAddD24(builder, d24)

def MtiDwell_FullAddD25(builder, d25):
    builder.PrependFloat64Slot(23, d25, 0.0)

def AddD25(builder, d25):
    MtiDwell_FullAddD25(builder, d25)

def MtiDwell_FullAddD26(builder, d26):
    builder.PrependFloat64Slot(24, d26, 0.0)

def AddD26(builder, d26):
    MtiDwell_FullAddD26(builder, d26)

def MtiDwell_FullAddD27(builder, d27):
    builder.PrependFloat64Slot(25, d27, 0.0)

def AddD27(builder, d27):
    MtiDwell_FullAddD27(builder, d27)

def MtiDwell_FullAddD28(builder, d28):
    builder.PrependFloat64Slot(26, d28, 0.0)

def AddD28(builder, d28):
    MtiDwell_FullAddD28(builder, d28)

def MtiDwell_FullAddD29(builder, d29):
    builder.PrependFloat64Slot(27, d29, 0.0)

def AddD29(builder, d29):
    MtiDwell_FullAddD29(builder, d29)

def MtiDwell_FullAddD30(builder, d30):
    builder.PrependFloat64Slot(28, d30, 0.0)

def AddD30(builder, d30):
    MtiDwell_FullAddD30(builder, d30)

def MtiDwell_FullAddD31(builder, d31):
    builder.PrependInt32Slot(29, d31, 0)

def AddD31(builder, d31):
    MtiDwell_FullAddD31(builder, d31)

def MtiDwell_FullAddD32(builder, d32):
    builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(d32), 0)

def AddD32(builder, d32):
    MtiDwell_FullAddD32(builder, d32)

def MtiDwell_FullStartD32Vector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartD32Vector(builder, numElems):
    return MtiDwell_FullStartD32Vector(builder, numElems)

def MtiDwell_FullAddDwellts(builder, dwellts):
...
def AddDwellts(builder, dwellts):
    MtiDwell_FullAddDwellts(builder, dwellts)

def MtiDwell_FullEnd(builder):
    return builder.EndObject()

def End(builder):
    return MtiDwell_FullEnd(builder)
...
class MtiDwell_FullT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        mtiDwellFull = MtiDwell_Full()
        mtiDwellFull.Init(buf, pos)
        return cls.InitFromObj(mtiDwellFull)
    ...
    @classmethod
    def InitFromObj(cls, mtiDwellFull):
        x = MtiDwell_FullT()
        x._UnPack(mtiDwellFull)
        return x

    # MtiDwell_FullT
    def _UnPack(self, mtiDwellFull):
        if mtiDwellFull is None:
            return
        self.d2 = mtiDwellFull.D2()
        self.d3 = mtiDwellFull.D3()
        self.d4 = mtiDwellFull.D4()
        self.d5 = mtiDwellFull.D5()
        self.d6 = mtiDwellFull.D6()
        self.d7 = mtiDwellFull.D7()
        self.d8 = mtiDwellFull.D8()
        self.d9 = mtiDwellFull.D9()
        self.d10 = mtiDwellFull.D10()
        self.d11 = mtiDwellFull.D11()
        self.d12 = mtiDwellFull.D12()
        self.d13 = mtiDwellFull.D13()
        self.d14 = mtiDwellFull.D14()
        self.d15 = mtiDwellFull.D15()
        self.d16 = mtiDwellFull.D16()
        self.d17 = mtiDwellFull.D17()
        self.d18 = mtiDwellFull.D18()
        self.d19 = mtiDwellFull.D19()
        self.d20 = mtiDwellFull.D20()
        self.d21 = mtiDwellFull.D21()
        self.d22 = mtiDwellFull.D22()
        self.d23 = mtiDwellFull.D23()
        self.d24 = mtiDwellFull.D24()
        self.d25 = mtiDwellFull.D25()
        self.d26 = mtiDwellFull.D26()
        self.d27 = mtiDwellFull.D27()
        self.d28 = mtiDwellFull.D28()
        self.d29 = mtiDwellFull.D29()
        self.d30 = mtiDwellFull.D30()
        self.d31 = mtiDwellFull.D31()
        if not mtiDwellFull.D32IsNone():
            self.d32 = []
            for i in range(mtiDwellFull.D32Length()):
                self.d32.append(mtiDwellFull.D32(i))
        self.dwellts = mtiDwellFull.Dwellts()
    ...
    def Pack(self, builder):
        if self.d32 is not None:
            ...
            MtiDwell_FullStartD32Vector(builder, len(self.d32))
        ...
        MtiDwell_FullStart(builder)
        MtiDwell_FullAddD2(builder, self.d2)
        MtiDwell_FullAddD3(builder, self.d3)
        MtiDwell_FullAddD4(builder, self.d4)
        MtiDwell_FullAddD5(builder, self.d5)
        MtiDwell_FullAddD6(builder, self.d6)
        MtiDwell_FullAddD7(builder, self.d7)
        MtiDwell_FullAddD8(builder, self.d8)
        MtiDwell_FullAddD9(builder, self.d9)
        MtiDwell_FullAddD10(builder, self.d10)
        MtiDwell_FullAddD11(builder, self.d11)
        MtiDwell_FullAddD12(builder, self.d12)
        MtiDwell_FullAddD13(builder, self.d13)
        MtiDwell_FullAddD14(builder, self.d14)
        MtiDwell_FullAddD15(builder, self.d15)
        MtiDwell_FullAddD16(builder, self.d16)
        MtiDwell_FullAddD17(builder, self.d17)
        MtiDwell_FullAddD18(builder, self.d18)
        MtiDwell_FullAddD19(builder, self.d19)
        MtiDwell_FullAddD20(builder, self.d20)
        MtiDwell_FullAddD21(builder, self.d21)
        MtiDwell_FullAddD22(builder, self.d22)
        MtiDwell_FullAddD23(builder, self.d23)
        MtiDwell_FullAddD24(builder, self.d24)
        MtiDwell_FullAddD25(builder, self.d25)
        MtiDwell_FullAddD26(builder, self.d26)
        MtiDwell_FullAddD27(builder, self.d27)
        MtiDwell_FullAddD28(builder, self.d28)
        MtiDwell_FullAddD29(builder, self.d29)
        MtiDwell_FullAddD30(builder, self.d30)
        MtiDwell_FullAddD31(builder, self.d31)
        if self.d32 is not None:
            MtiDwell_FullAddD32(builder, d32)
        if self.dwellts is not None:
            MtiDwell_FullAddDwellts(builder, dwellts)
        mtiDwellFull = MtiDwell_FullEnd(builder)
        return mtiDwellFull
