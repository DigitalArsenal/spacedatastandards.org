...
class OrbitTrack_Ingest(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsOrbitTrack_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def OrbitTrack_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def OrbitTrack_IngestStart(builder):
    builder.StartObject(45)

def Start(builder):
    OrbitTrack_IngestStart(builder)

def OrbitTrack_IngestAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    OrbitTrack_IngestAddId(builder, id)

def OrbitTrack_IngestAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    OrbitTrack_IngestAddClassificationMarking(builder, classificationMarking)

def OrbitTrack_IngestAddIdOnOrbit(builder, idOnOrbit):
...
def AddIdOnOrbit(builder, idOnOrbit):
    OrbitTrack_IngestAddIdOnOrbit(builder, idOnOrbit)

def OrbitTrack_IngestAddSatNo(builder, satNo):
    builder.PrependInt32Slot(3, satNo, 0)

def AddSatNo(builder, satNo):
    OrbitTrack_IngestAddSatNo(builder, satNo)

def OrbitTrack_IngestAddOrigObjectId(builder, origObjectId):
...
def AddOrigObjectId(builder, origObjectId):
    OrbitTrack_IngestAddOrigObjectId(builder, origObjectId)

def OrbitTrack_IngestAddIdElset(builder, idElset):
...
def AddIdElset(builder, idElset):
    OrbitTrack_IngestAddIdElset(builder, idElset)

def OrbitTrack_IngestAddTs(builder, ts):
    builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(ts), 0)

def AddTs(builder, ts):
    OrbitTrack_IngestAddTs(builder, ts)

def OrbitTrack_IngestAddLat(builder, lat):
    builder.PrependFloat64Slot(7, lat, 0.0)

def AddLat(builder, lat):
    OrbitTrack_IngestAddLat(builder, lat)

def OrbitTrack_IngestAddLon(builder, lon):
    builder.PrependFloat64Slot(8, lon, 0.0)

def AddLon(builder, lon):
    OrbitTrack_IngestAddLon(builder, lon)

def OrbitTrack_IngestAddAlt(builder, alt):
    builder.PrependFloat64Slot(9, alt, 0.0)

def AddAlt(builder, alt):
    OrbitTrack_IngestAddAlt(builder, alt)

def OrbitTrack_IngestAddRdfRf(builder, rdfRf):
    builder.PrependFloat64Slot(10, rdfRf, 0.0)

def AddRdfRf(builder, rdfRf):
    OrbitTrack_IngestAddRdfRf(builder, rdfRf)

def OrbitTrack_IngestAddCallSign(builder, callSign):
...
def AddCallSign(builder, callSign):
    OrbitTrack_IngestAddCallSign(builder, callSign)

def OrbitTrack_IngestAddRptNum(builder, rptNum):
...
def AddRptNum(builder, rptNum):
    OrbitTrack_IngestAddRptNum(builder, rptNum)

def OrbitTrack_IngestAddObjIdent(builder, objIdent):
    builder.PrependInt8Slot(13, objIdent, 0)

def AddObjIdent(builder, objIdent):
    OrbitTrack_IngestAddObjIdent(builder, objIdent)

def OrbitTrack_IngestAddIdentAmp(builder, identAmp):
...
def AddIdentAmp(builder, identAmp):
    OrbitTrack_IngestAddIdentAmp(builder, identAmp)

def OrbitTrack_IngestAddSatStatus(builder, satStatus):
...
def AddSatStatus(builder, satStatus):
    OrbitTrack_IngestAddSatStatus(builder, satStatus)

def OrbitTrack_IngestAddObjectType(builder, objectType):
    builder.PrependInt8Slot(16, objectType, 0)

def AddObjectType(builder, objectType):
    OrbitTrack_IngestAddObjectType(builder, objectType)

def OrbitTrack_IngestAddCountryCode(builder, countryCode):
...
def AddCountryCode(builder, countryCode):
    OrbitTrack_IngestAddCountryCode(builder, countryCode)

def OrbitTrack_IngestAddDecay(builder, decay):
    builder.PrependFloat64Slot(18, decay, 0.0)

def AddDecay(builder, decay):
    OrbitTrack_IngestAddDecay(builder, decay)

def OrbitTrack_IngestAddCharlieLine(builder, charlieLine):
...
def AddCharlieLine(builder, charlieLine):
    OrbitTrack_IngestAddCharlieLine(builder, charlieLine)

def OrbitTrack_IngestAddAouType(builder, aouType):
...
def AddAouType(builder, aouType):
    OrbitTrack_IngestAddAouType(builder, aouType)

def OrbitTrack_IngestAddAouData(builder, aouData):
...
def AddAouData(builder, aouData):
    OrbitTrack_IngestAddAouData(builder, aouData)

def OrbitTrack_IngestStartAouDataVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartAouDataVector(builder, numElems):
    return OrbitTrack_IngestStartAouDataVector(builder, numElems)

def OrbitTrack_IngestAddSpd(builder, spd):
    builder.PrependFloat64Slot(22, spd, 0.0)

def AddSpd(builder, spd):
    OrbitTrack_IngestAddSpd(builder, spd)

def OrbitTrack_IngestAddAngElev(builder, angElev):
    builder.PrependFloat64Slot(23, angElev, 0.0)

def AddAngElev(builder, angElev):
    OrbitTrack_IngestAddAngElev(builder, angElev)

def OrbitTrack_IngestAddCntnmnt(builder, cntnmnt):
    builder.PrependFloat64Slot(24, cntnmnt, 0.0)

def AddCntnmnt(builder, cntnmnt):
    OrbitTrack_IngestAddCntnmnt(builder, cntnmnt)

def OrbitTrack_IngestAddXref(builder, xref):
    builder.PrependUOffsetTRelativeSlot(25, flatbuffers.number_types.UOffsetTFlags.py_type(xref), 0)

def AddXref(builder, xref):
    OrbitTrack_IngestAddXref(builder, xref)

def OrbitTrack_IngestAddChXref(builder, chXref):
...
def AddChXref(builder, chXref):
    OrbitTrack_IngestAddChXref(builder, chXref)

def OrbitTrack_IngestAddAmplification(builder, amplification):
...
def AddAmplification(builder, amplification):
    OrbitTrack_IngestAddAmplification(builder, amplification)

def OrbitTrack_IngestAddIff(builder, iff):
    builder.PrependUOffsetTRelativeSlot(28, flatbuffers.number_types.UOffsetTFlags.py_type(iff), 0)

def AddIff(builder, iff):
    OrbitTrack_IngestAddIff(builder, iff)

def OrbitTrack_IngestAddReinforced(builder, reinforced):
    builder.PrependBoolSlot(29, reinforced, 0)

def AddReinforced(builder, reinforced):
    OrbitTrack_IngestAddReinforced(builder, reinforced)

def OrbitTrack_IngestAddReduced(builder, reduced):
    builder.PrependBoolSlot(30, reduced, 0)

def AddReduced(builder, reduced):
    OrbitTrack_IngestAddReduced(builder, reduced)

def OrbitTrack_IngestAddHq(builder, hq):
    builder.PrependBoolSlot(31, hq, 0)

def AddHq(builder, hq):
    OrbitTrack_IngestAddHq(builder, hq)

def OrbitTrack_IngestAddDummy(builder, dummy):
    builder.PrependBoolSlot(32, dummy, 0)

def AddDummy(builder, dummy):
    OrbitTrack_IngestAddDummy(builder, dummy)

def OrbitTrack_IngestAddTaskForce(builder, taskForce):
    builder.PrependBoolSlot(33, taskForce, 0)

def AddTaskForce(builder, taskForce):
    OrbitTrack_IngestAddTaskForce(builder, taskForce)

def OrbitTrack_IngestAddFeint(builder, feint):
    builder.PrependBoolSlot(34, feint, 0)

def AddFeint(builder, feint):
    OrbitTrack_IngestAddFeint(builder, feint)

def OrbitTrack_IngestAddInstallation(builder, installation):
    builder.PrependBoolSlot(35, installation, 0)

def AddInstallation(builder, installation):
    OrbitTrack_IngestAddInstallation(builder, installation)

def OrbitTrack_IngestAddVehType(builder, vehType):
...
def AddVehType(builder, vehType):
    OrbitTrack_IngestAddVehType(builder, vehType)

def OrbitTrack_IngestAddTrkId(builder, trkId):
    builder.PrependUOffsetTRelativeSlot(37, flatbuffers.number_types.UOffsetTFlags.py_type(trkId), 0)

def AddTrkId(builder, trkId):
    OrbitTrack_IngestAddTrkId(builder, trkId)

def OrbitTrack_IngestAddTrackSensors(builder, trackSensors):
...
def AddTrackSensors(builder, trackSensors):
    OrbitTrack_IngestAddTrackSensors(builder, trackSensors)

def OrbitTrack_IngestStartTrackSensorsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartTrackSensorsVector(builder, numElems):
    return OrbitTrack_IngestStartTrackSensorsVector(builder, numElems)

def OrbitTrack_IngestAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(39, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    OrbitTrack_IngestAddCreatedAt(builder, createdAt)

def OrbitTrack_IngestAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(40, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    OrbitTrack_IngestAddCreatedBy(builder, createdBy)

def OrbitTrack_IngestAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(41, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    OrbitTrack_IngestAddSource(builder, source)

def OrbitTrack_IngestAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(42, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    OrbitTrack_IngestAddOrigin(builder, origin)

def OrbitTrack_IngestAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(43, dataMode, 0)

def AddDataMode(builder, dataMode):
    OrbitTrack_IngestAddDataMode(builder, dataMode)

def OrbitTrack_IngestAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(44, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    OrbitTrack_IngestAddOrigNetwork(builder, origNetwork)

def OrbitTrack_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return OrbitTrack_IngestEnd(builder)
...
class OrbitTrack_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        orbitTrackIngest = OrbitTrack_Ingest()
        orbitTrackIngest.Init(buf, pos)
        return cls.InitFromObj(orbitTrackIngest)
    ...
    @classmethod
    def InitFromObj(cls, orbitTrackIngest):
        x = OrbitTrack_IngestT()
        x._UnPack(orbitTrackIngest)
        return x

    # OrbitTrack_IngestT
    def _UnPack(self, orbitTrackIngest):
        if orbitTrackIngest is None:
            return
        self.id = orbitTrackIngest.Id()
        self.classificationMarking = orbitTrackIngest.ClassificationMarking()
        self.idOnOrbit = orbitTrackIngest.IdOnOrbit()
        self.satNo = orbitTrackIngest.SatNo()
        self.origObjectId = orbitTrackIngest.OrigObjectId()
        self.idElset = orbitTrackIngest.IdElset()
        self.ts = orbitTrackIngest.Ts()
        self.lat = orbitTrackIngest.Lat()
        self.lon = orbitTrackIngest.Lon()
        self.alt = orbitTrackIngest.Alt()
        self.rdfRf = orbitTrackIngest.RdfRf()
        self.callSign = orbitTrackIngest.CallSign()
        self.rptNum = orbitTrackIngest.RptNum()
        self.objIdent = orbitTrackIngest.ObjIdent()
        self.identAmp = orbitTrackIngest.IdentAmp()
        self.satStatus = orbitTrackIngest.SatStatus()
        self.objectType = orbitTrackIngest.ObjectType()
        self.countryCode = orbitTrackIngest.CountryCode()
        self.decay = orbitTrackIngest.Decay()
        self.charlieLine = orbitTrackIngest.CharlieLine()
        self.aouType = orbitTrackIngest.AouType()
        if not orbitTrackIngest.AouDataIsNone():
            self.aouData = []
            for i in range(orbitTrackIngest.AouDataLength()):
                self.aouData.append(orbitTrackIngest.AouData(i))
        self.spd = orbitTrackIngest.Spd()
        self.angElev = orbitTrackIngest.AngElev()
        self.cntnmnt = orbitTrackIngest.Cntnmnt()
        self.xref = orbitTrackIngest.Xref()
        self.chXref = orbitTrackIngest.ChXref()
        self.amplification = orbitTrackIngest.Amplification()
        self.iff = orbitTrackIngest.Iff()
        self.reinforced = orbitTrackIngest.Reinforced()
        self.reduced = orbitTrackIngest.Reduced()
        self.hq = orbitTrackIngest.Hq()
        self.dummy = orbitTrackIngest.Dummy()
        self.taskForce = orbitTrackIngest.TaskForce()
        self.feint = orbitTrackIngest.Feint()
        self.installation = orbitTrackIngest.Installation()
        self.vehType = orbitTrackIngest.VehType()
        self.trkId = orbitTrackIngest.TrkId()
        if not orbitTrackIngest.TrackSensorsIsNone():
            self.trackSensors = []
            for i in range(orbitTrackIngest.TrackSensorsLength()):
                self.trackSensors.append(orbitTrackIngest.TrackSensors(i))
        self.createdAt = orbitTrackIngest.CreatedAt()
        self.createdBy = orbitTrackIngest.CreatedBy()
        self.source = orbitTrackIngest.Source()
        self.origin = orbitTrackIngest.Origin()
        self.dataMode = orbitTrackIngest.DataMode()
        self.origNetwork = orbitTrackIngest.OrigNetwork()
    ...
    def Pack(self, builder):
        ...
        if self.aouData is not None:
            ...
            OrbitTrack_IngestStartAouDataVector(builder, len(self.aouData))
        ...
        if self.trackSensors is not None:
            ...
            OrbitTrack_IngestStartTrackSensorsVector(builder, len(self.trackSensors))
        ...
        if self.idOnOrbit is not None:
            OrbitTrack_IngestAddIdOnOrbit(builder, idOnOrbit)
        OrbitTrack_IngestAddSatNo(builder, self.satNo)
        if self.origObjectId is not None:
            OrbitTrack_IngestAddOrigObjectId(builder, origObjectId)
        if self.idElset is not None:
            OrbitTrack_IngestAddIdElset(builder, idElset)
        if self.ts is not None:
            OrbitTrack_IngestAddTs(builder, ts)
        OrbitTrack_IngestAddLat(builder, self.lat)
        OrbitTrack_IngestAddLon(builder, self.lon)
        OrbitTrack_IngestAddAlt(builder, self.alt)
        OrbitTrack_IngestAddRdfRf(builder, self.rdfRf)
        if self.callSign is not None:
            OrbitTrack_IngestAddCallSign(builder, callSign)
        if self.rptNum is not None:
            OrbitTrack_IngestAddRptNum(builder, rptNum)
        OrbitTrack_IngestAddObjIdent(builder, self.objIdent)
        if self.identAmp is not None:
            OrbitTrack_IngestAddIdentAmp(builder, identAmp)
        if self.satStatus is not None:
            OrbitTrack_IngestAddSatStatus(builder, satStatus)
        OrbitTrack_IngestAddObjectType(builder, self.objectType)
        if self.countryCode is not None:
            OrbitTrack_IngestAddCountryCode(builder, countryCode)
        OrbitTrack_IngestAddDecay(builder, self.decay)
        if self.charlieLine is not None:
            OrbitTrack_IngestAddCharlieLine(builder, charlieLine)
        if self.aouType is not None:
            OrbitTrack_IngestAddAouType(builder, aouType)
        if self.aouData is not None:
            OrbitTrack_IngestAddAouData(builder, aouData)
        OrbitTrack_IngestAddSpd(builder, self.spd)
        OrbitTrack_IngestAddAngElev(builder, self.angElev)
        OrbitTrack_IngestAddCntnmnt(builder, self.cntnmnt)
        if self.xref is not None:
            OrbitTrack_IngestAddXref(builder, xref)
        if self.chXref is not None:
            OrbitTrack_IngestAddChXref(builder, chXref)
        ...
        if self.iff is not None:
            OrbitTrack_IngestAddIff(builder, iff)
        OrbitTrack_IngestAddReinforced(builder, self.reinforced)
        OrbitTrack_IngestAddReduced(builder, self.reduced)
        OrbitTrack_IngestAddHq(builder, self.hq)
        OrbitTrack_IngestAddDummy(builder, self.dummy)
        OrbitTrack_IngestAddTaskForce(builder, self.taskForce)
        OrbitTrack_IngestAddFeint(builder, self.feint)
        OrbitTrack_IngestAddInstallation(builder, self.installation)
        if self.vehType is not None:
            OrbitTrack_IngestAddVehType(builder, vehType)
        if self.trkId is not None:
            OrbitTrack_IngestAddTrkId(builder, trkId)
        ...
        if self.origin is not None:
            OrbitTrack_IngestAddOrigin(builder, origin)
        OrbitTrack_IngestAddDataMode(builder, self.dataMode)
        if self.origNetwork is not None:
            OrbitTrack_IngestAddOrigNetwork(builder, origNetwork)
        orbitTrackIngest = OrbitTrack_IngestEnd(builder)
        return orbitTrackIngest
