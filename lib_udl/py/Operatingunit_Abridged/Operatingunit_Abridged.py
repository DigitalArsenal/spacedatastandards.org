...
class Operatingunit_Abridged(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = Operatingunit_Abridged()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsOperatingunit_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def Operatingunit_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf, offset, b"\x4F\x50\x45\x52", size_prefixed=size_prefixed)

    # Operatingunit_Abridged
...
def Operatingunit_AbridgedStart(builder):
    builder.StartObject(60)

def Start(builder):
    Operatingunit_AbridgedStart(builder)

def Operatingunit_AbridgedAddIdOperatingUnit(builder, idOperatingUnit):
...
def AddIdOperatingUnit(builder, idOperatingUnit):
    Operatingunit_AbridgedAddIdOperatingUnit(builder, idOperatingUnit)

def Operatingunit_AbridgedAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    Operatingunit_AbridgedAddClassificationMarking(builder, classificationMarking)

def Operatingunit_AbridgedAddAltOperatingUnitId(builder, altOperatingUnitId):
...
def AddAltOperatingUnitId(builder, altOperatingUnitId):
    Operatingunit_AbridgedAddAltOperatingUnitId(builder, altOperatingUnitId)

def Operatingunit_AbridgedAddName(builder, name):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)

def AddName(builder, name):
    Operatingunit_AbridgedAddName(builder, name)

def Operatingunit_AbridgedAddDescription(builder, description):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(description), 0)

def AddDescription(builder, description):
    Operatingunit_AbridgedAddDescription(builder, description)

def Operatingunit_AbridgedAddIdLocation(builder, idLocation):
...
def AddIdLocation(builder, idLocation):
    Operatingunit_AbridgedAddIdLocation(builder, idLocation)

def Operatingunit_AbridgedAddIdContact(builder, idContact):
...
def AddIdContact(builder, idContact):
    Operatingunit_AbridgedAddIdContact(builder, idContact)

def Operatingunit_AbridgedAddIdOrganization(builder, idOrganization):
...
def AddIdOrganization(builder, idOrganization):
    Operatingunit_AbridgedAddIdOrganization(builder, idOrganization)

def Operatingunit_AbridgedAddUnitIdentifier(builder, unitIdentifier):
...
def AddUnitIdentifier(builder, unitIdentifier):
    Operatingunit_AbridgedAddUnitIdentifier(builder, unitIdentifier)

def Operatingunit_AbridgedAddCountryCode(builder, countryCode):
...
def AddCountryCode(builder, countryCode):
    Operatingunit_AbridgedAddCountryCode(builder, countryCode)

def Operatingunit_AbridgedAddAltCountryCode(builder, altCountryCode):
...
def AddAltCountryCode(builder, altCountryCode):
    Operatingunit_AbridgedAddAltCountryCode(builder, altCountryCode)

def Operatingunit_AbridgedAddWac(builder, wac):
    builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(wac), 0)

def AddWac(builder, wac):
    Operatingunit_AbridgedAddWac(builder, wac)

def Operatingunit_AbridgedAddOperStatus(builder, operStatus):
...
def AddOperStatus(builder, operStatus):
    Operatingunit_AbridgedAddOperStatus(builder, operStatus)

def Operatingunit_AbridgedAddCondition(builder, condition):
...
def AddCondition(builder, condition):
    Operatingunit_AbridgedAddCondition(builder, condition)

def Operatingunit_AbridgedAddConditionAvail(builder, conditionAvail):
...
def AddConditionAvail(builder, conditionAvail):
    Operatingunit_AbridgedAddConditionAvail(builder, conditionAvail)

def Operatingunit_AbridgedAddEval(builder, eval):
    builder.PrependInt32Slot(15, eval, 0)

def AddEval(builder, eval):
    Operatingunit_AbridgedAddEval(builder, eval)

def Operatingunit_AbridgedAddFpa(builder, fpa):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(fpa), 0)

def AddFpa(builder, fpa):
    Operatingunit_AbridgedAddFpa(builder, fpa)

def Operatingunit_AbridgedAddIdent(builder, ident):
    builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(ident), 0)

def AddIdent(builder, ident):
    Operatingunit_AbridgedAddIdent(builder, ident)

def Operatingunit_AbridgedAddAllegiance(builder, allegiance):
...
def AddAllegiance(builder, allegiance):
    Operatingunit_AbridgedAddAllegiance(builder, allegiance)

def Operatingunit_AbridgedAddAltAllegiance(builder, altAllegiance):
...
def AddAltAllegiance(builder, altAllegiance):
    Operatingunit_AbridgedAddAltAllegiance(builder, altAllegiance)

def Operatingunit_AbridgedAddLocName(builder, locName):
...
def AddLocName(builder, locName):
    Operatingunit_AbridgedAddLocName(builder, locName)

def Operatingunit_AbridgedAddLocReason(builder, locReason):
...
def AddLocReason(builder, locReason):
    Operatingunit_AbridgedAddLocReason(builder, locReason)

def Operatingunit_AbridgedAddForce(builder, force):
    builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(force), 0)

def AddForce(builder, force):
    Operatingunit_AbridgedAddForce(builder, force)

def Operatingunit_AbridgedAddForceName(builder, forceName):
...
def AddForceName(builder, forceName):
    Operatingunit_AbridgedAddForceName(builder, forceName)

def Operatingunit_AbridgedAddFunctRole(builder, functRole):
...
def AddFunctRole(builder, functRole):
    Operatingunit_AbridgedAddFunctRole(builder, functRole)

def Operatingunit_AbridgedAddMsnPrimary(builder, msnPrimary):
...
def AddMsnPrimary(builder, msnPrimary):
    Operatingunit_AbridgedAddMsnPrimary(builder, msnPrimary)

def Operatingunit_AbridgedAddMsnPrimarySpecialty(builder, msnPrimarySpecialty):
...
def AddMsnPrimarySpecialty(builder, msnPrimarySpecialty):
    Operatingunit_AbridgedAddMsnPrimarySpecialty(builder, msnPrimarySpecialty)

def Operatingunit_AbridgedAddMasterUnit(builder, masterUnit):
    builder.PrependBoolSlot(27, masterUnit, 0)

def AddMasterUnit(builder, masterUnit):
    Operatingunit_AbridgedAddMasterUnit(builder, masterUnit)

def Operatingunit_AbridgedAddStylizedUnit(builder, stylizedUnit):
    builder.PrependBoolSlot(28, stylizedUnit, 0)

def AddStylizedUnit(builder, stylizedUnit):
    Operatingunit_AbridgedAddStylizedUnit(builder, stylizedUnit)

def Operatingunit_AbridgedAddDivCat(builder, divCat):
...
def AddDivCat(builder, divCat):
    Operatingunit_AbridgedAddDivCat(builder, divCat)

def Operatingunit_AbridgedAddEchelon(builder, echelon):
...
def AddEchelon(builder, echelon):
    Operatingunit_AbridgedAddEchelon(builder, echelon)

def Operatingunit_AbridgedAddEchelonTier(builder, echelonTier):
...
def AddEchelonTier(builder, echelonTier):
    Operatingunit_AbridgedAddEchelonTier(builder, echelonTier)

def Operatingunit_AbridgedAddFleetId(builder, fleetId):
...
def AddFleetId(builder, fleetId):
    Operatingunit_AbridgedAddFleetId(builder, fleetId)

def Operatingunit_AbridgedAddDeployStatus(builder, deployStatus):
...
def AddDeployStatus(builder, deployStatus):
    Operatingunit_AbridgedAddDeployStatus(builder, deployStatus)

def Operatingunit_AbridgedAddFlagFlown(builder, flagFlown):
...
def AddFlagFlown(builder, flagFlown):
    Operatingunit_AbridgedAddFlagFlown(builder, flagFlown)

def Operatingunit_AbridgedAddCoordDatum(builder, coordDatum):
...
def AddCoordDatum(builder, coordDatum):
    Operatingunit_AbridgedAddCoordDatum(builder, coordDatum)

def Operatingunit_AbridgedAddCoord(builder, coord):
    builder.PrependUOffsetTRelativeSlot(36, flatbuffers.number_types.UOffsetTFlags.py_type(coord), 0)

def AddCoord(builder, coord):
    Operatingunit_AbridgedAddCoord(builder, coord)

def Operatingunit_AbridgedAddCoordDerivAcc(builder, coordDerivAcc):
    builder.PrependFloat64Slot(37, coordDerivAcc, 0.0)

def AddCoordDerivAcc(builder, coordDerivAcc):
    Operatingunit_AbridgedAddCoordDerivAcc(builder, coordDerivAcc)

def Operatingunit_AbridgedAddLat(builder, lat):
    builder.PrependFloat64Slot(38, lat, 0.0)

def AddLat(builder, lat):
    Operatingunit_AbridgedAddLat(builder, lat)

def Operatingunit_AbridgedAddLon(builder, lon):
    builder.PrependFloat64Slot(39, lon, 0.0)

def AddLon(builder, lon):
    Operatingunit_AbridgedAddLon(builder, lon)

def Operatingunit_AbridgedAddElevMsl(builder, elevMsl):
    builder.PrependFloat64Slot(40, elevMsl, 0.0)

def AddElevMsl(builder, elevMsl):
    Operatingunit_AbridgedAddElevMsl(builder, elevMsl)

def Operatingunit_AbridgedAddElevMslConfLvl(builder, elevMslConfLvl):
    builder.PrependInt32Slot(41, elevMslConfLvl, 0)

def AddElevMslConfLvl(builder, elevMslConfLvl):
    Operatingunit_AbridgedAddElevMslConfLvl(builder, elevMslConfLvl)

def Operatingunit_AbridgedAddElevMslDerivAcc(builder, elevMslDerivAcc):
    builder.PrependFloat64Slot(42, elevMslDerivAcc, 0.0)

def AddElevMslDerivAcc(builder, elevMslDerivAcc):
    Operatingunit_AbridgedAddElevMslDerivAcc(builder, elevMslDerivAcc)

def Operatingunit_AbridgedAddGeoidalMslSep(builder, geoidalMslSep):
    builder.PrependFloat64Slot(43, geoidalMslSep, 0.0)

def AddGeoidalMslSep(builder, geoidalMslSep):
    Operatingunit_AbridgedAddGeoidalMslSep(builder, geoidalMslSep)

def Operatingunit_AbridgedAddMilGridSys(builder, milGridSys):
...
def AddMilGridSys(builder, milGridSys):
    Operatingunit_AbridgedAddMilGridSys(builder, milGridSys)

def Operatingunit_AbridgedAddMilGrid(builder, milGrid):
...
def AddMilGrid(builder, milGrid):
    Operatingunit_AbridgedAddMilGrid(builder, milGrid)

def Operatingunit_AbridgedAddUtm(builder, utm):
    builder.PrependUOffsetTRelativeSlot(46, flatbuffers.number_types.UOffsetTFlags.py_type(utm), 0)

def AddUtm(builder, utm):
    Operatingunit_AbridgedAddUtm(builder, utm)

def Operatingunit_AbridgedAddAirDefArea(builder, airDefArea):
...
def AddAirDefArea(builder, airDefArea):
    Operatingunit_AbridgedAddAirDefArea(builder, airDefArea)

def Operatingunit_AbridgedAddPolSubdiv(builder, polSubdiv):
...
def AddPolSubdiv(builder, polSubdiv):
    Operatingunit_AbridgedAddPolSubdiv(builder, polSubdiv)

def Operatingunit_AbridgedAddSymCode(builder, symCode):
...
def AddSymCode(builder, symCode):
    Operatingunit_AbridgedAddSymCode(builder, symCode)

def Operatingunit_AbridgedAddClassRating(builder, classRating):
...
def AddClassRating(builder, classRating):
    Operatingunit_AbridgedAddClassRating(builder, classRating)

def Operatingunit_AbridgedAddRecStatus(builder, recStatus):
...
def AddRecStatus(builder, recStatus):
    Operatingunit_AbridgedAddRecStatus(builder, recStatus)

def Operatingunit_AbridgedAddReviewDate(builder, reviewDate):
...
def AddReviewDate(builder, reviewDate):
    Operatingunit_AbridgedAddReviewDate(builder, reviewDate)

def Operatingunit_AbridgedAddResProd(builder, resProd):
...
def AddResProd(builder, resProd):
    Operatingunit_AbridgedAddResProd(builder, resProd)

def Operatingunit_AbridgedAddReferenceDoc(builder, referenceDoc):
...
def AddReferenceDoc(builder, referenceDoc):
    Operatingunit_AbridgedAddReferenceDoc(builder, referenceDoc)

def Operatingunit_AbridgedAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(55, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    Operatingunit_AbridgedAddCreatedAt(builder, createdAt)

def Operatingunit_AbridgedAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(56, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    Operatingunit_AbridgedAddCreatedBy(builder, createdBy)

def Operatingunit_AbridgedAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(57, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    Operatingunit_AbridgedAddSource(builder, source)

def Operatingunit_AbridgedAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(58, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    Operatingunit_AbridgedAddOrigin(builder, origin)

def Operatingunit_AbridgedAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(59, dataMode, 0)

def AddDataMode(builder, dataMode):
    Operatingunit_AbridgedAddDataMode(builder, dataMode)

def Operatingunit_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return Operatingunit_AbridgedEnd(builder)


class Operatingunit_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        operatingunitAbridged = Operatingunit_Abridged()
        operatingunitAbridged.Init(buf, pos)
        return cls.InitFromObj(operatingunitAbridged)
    ...
    @classmethod
    def InitFromObj(cls, operatingunitAbridged):
        x = Operatingunit_AbridgedT()
        x._UnPack(operatingunitAbridged)
        return x

    # Operatingunit_AbridgedT
    def _UnPack(self, operatingunitAbridged):
        if operatingunitAbridged is None:
            return
        self.idOperatingUnit = operatingunitAbridged.IdOperatingUnit()
        self.classificationMarking = operatingunitAbridged.ClassificationMarking()
        self.altOperatingUnitId = operatingunitAbridged.AltOperatingUnitId()
        self.name = operatingunitAbridged.Name()
        self.description = operatingunitAbridged.Description()
        self.idLocation = operatingunitAbridged.IdLocation()
        self.idContact = operatingunitAbridged.IdContact()
        self.idOrganization = operatingunitAbridged.IdOrganization()
        self.unitIdentifier = operatingunitAbridged.UnitIdentifier()
        self.countryCode = operatingunitAbridged.CountryCode()
        self.altCountryCode = operatingunitAbridged.AltCountryCode()
        self.wac = operatingunitAbridged.Wac()
        self.operStatus = operatingunitAbridged.OperStatus()
        self.condition = operatingunitAbridged.Condition()
        self.conditionAvail = operatingunitAbridged.ConditionAvail()
        self.eval = operatingunitAbridged.Eval()
        self.fpa = operatingunitAbridged.Fpa()
        self.ident = operatingunitAbridged.Ident()
        self.allegiance = operatingunitAbridged.Allegiance()
        self.altAllegiance = operatingunitAbridged.AltAllegiance()
        self.locName = operatingunitAbridged.LocName()
        self.locReason = operatingunitAbridged.LocReason()
        self.force = operatingunitAbridged.Force()
        self.forceName = operatingunitAbridged.ForceName()
        self.functRole = operatingunitAbridged.FunctRole()
        self.msnPrimary = operatingunitAbridged.MsnPrimary()
        self.msnPrimarySpecialty = operatingunitAbridged.MsnPrimarySpecialty()
        self.masterUnit = operatingunitAbridged.MasterUnit()
        self.stylizedUnit = operatingunitAbridged.StylizedUnit()
        self.divCat = operatingunitAbridged.DivCat()
        self.echelon = operatingunitAbridged.Echelon()
        self.echelonTier = operatingunitAbridged.EchelonTier()
        self.fleetId = operatingunitAbridged.FleetId()
        self.deployStatus = operatingunitAbridged.DeployStatus()
        self.flagFlown = operatingunitAbridged.FlagFlown()
        self.coordDatum = operatingunitAbridged.CoordDatum()
        self.coord = operatingunitAbridged.Coord()
        self.coordDerivAcc = operatingunitAbridged.CoordDerivAcc()
        self.lat = operatingunitAbridged.Lat()
        self.lon = operatingunitAbridged.Lon()
        self.elevMsl = operatingunitAbridged.ElevMsl()
        self.elevMslConfLvl = operatingunitAbridged.ElevMslConfLvl()
        self.elevMslDerivAcc = operatingunitAbridged.ElevMslDerivAcc()
        self.geoidalMslSep = operatingunitAbridged.GeoidalMslSep()
        self.milGridSys = operatingunitAbridged.MilGridSys()
        self.milGrid = operatingunitAbridged.MilGrid()
        self.utm = operatingunitAbridged.Utm()
        self.airDefArea = operatingunitAbridged.AirDefArea()
        self.polSubdiv = operatingunitAbridged.PolSubdiv()
        self.symCode = operatingunitAbridged.SymCode()
        self.classRating = operatingunitAbridged.ClassRating()
        self.recStatus = operatingunitAbridged.RecStatus()
        self.reviewDate = operatingunitAbridged.ReviewDate()
        self.resProd = operatingunitAbridged.ResProd()
        self.referenceDoc = operatingunitAbridged.ReferenceDoc()
        self.createdAt = operatingunitAbridged.CreatedAt()
        self.createdBy = operatingunitAbridged.CreatedBy()
        self.source = operatingunitAbridged.Source()
        self.origin = operatingunitAbridged.Origin()
        self.dataMode = operatingunitAbridged.DataMode()
    ...
    def Pack(self, builder):
        ...
        if self.conditionAvail is not None:
            Operatingunit_AbridgedAddConditionAvail(builder, conditionAvail)
        Operatingunit_AbridgedAddEval(builder, self.eval)
        if self.fpa is not None:
            Operatingunit_AbridgedAddFpa(builder, fpa)
        if self.ident is not None:
            Operatingunit_AbridgedAddIdent(builder, ident)
        ...
        if self.msnPrimarySpecialty is not None:
            Operatingunit_AbridgedAddMsnPrimarySpecialty(builder, msnPrimarySpecialty)
        Operatingunit_AbridgedAddMasterUnit(builder, self.masterUnit)
        Operatingunit_AbridgedAddStylizedUnit(builder, self.stylizedUnit)
        if self.divCat is not None:
            Operatingunit_AbridgedAddDivCat(builder, divCat)
        if self.echelon is not None:
            Operatingunit_AbridgedAddEchelon(builder, echelon)
        ...
        if self.coord is not None:
            Operatingunit_AbridgedAddCoord(builder, coord)
        Operatingunit_AbridgedAddCoordDerivAcc(builder, self.coordDerivAcc)
        Operatingunit_AbridgedAddLat(builder, self.lat)
        Operatingunit_AbridgedAddLon(builder, self.lon)
        Operatingunit_AbridgedAddElevMsl(builder, self.elevMsl)
        Operatingunit_AbridgedAddElevMslConfLvl(builder, self.elevMslConfLvl)
        Operatingunit_AbridgedAddElevMslDerivAcc(builder, self.elevMslDerivAcc)
        Operatingunit_AbridgedAddGeoidalMslSep(builder, self.geoidalMslSep)
        if self.milGridSys is not None:
            Operatingunit_AbridgedAddMilGridSys(builder, milGridSys)
        if self.milGrid is not None:
            Operatingunit_AbridgedAddMilGrid(builder, milGrid)
        ...
        if self.origin is not None:
            Operatingunit_AbridgedAddOrigin(builder, origin)
        Operatingunit_AbridgedAddDataMode(builder, self.dataMode)
        operatingunitAbridged = Operatingunit_AbridgedEnd(builder)
        return operatingunitAbridged
