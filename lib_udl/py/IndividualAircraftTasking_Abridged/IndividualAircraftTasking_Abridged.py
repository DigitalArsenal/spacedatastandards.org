...
class IndividualAircraftTasking_Abridged(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsIndividualAircraftTasking_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def IndividualAircraftTasking_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def IndividualAircraftTasking_AbridgedStart(builder):
    builder.StartObject(11)

def Start(builder):
    IndividualAircraftTasking_AbridgedStart(builder)

def IndividualAircraftTasking_AbridgedAddNumAcft(builder, numAcft):
    builder.PrependInt32Slot(0, numAcft, 0)

def AddNumAcft(builder, numAcft):
    IndividualAircraftTasking_AbridgedAddNumAcft(builder, numAcft)

def IndividualAircraftTasking_AbridgedAddAcftType(builder, acftType):
...
def AddAcftType(builder, acftType):
    IndividualAircraftTasking_AbridgedAddAcftType(builder, acftType)

def IndividualAircraftTasking_AbridgedAddCallSign(builder, callSign):
...
def AddCallSign(builder, callSign):
    IndividualAircraftTasking_AbridgedAddCallSign(builder, callSign)

def IndividualAircraftTasking_AbridgedAddPriConfigCode(builder, priConfigCode):
...
def AddPriConfigCode(builder, priConfigCode):
    IndividualAircraftTasking_AbridgedAddPriConfigCode(builder, priConfigCode)

def IndividualAircraftTasking_AbridgedAddSecConfigCode(builder, secConfigCode):
...
def AddSecConfigCode(builder, secConfigCode):
    IndividualAircraftTasking_AbridgedAddSecConfigCode(builder, secConfigCode)

def IndividualAircraftTasking_AbridgedAddLink16CallSign(builder, link16CallSign):
...
def AddLink16CallSign(builder, link16CallSign):
    IndividualAircraftTasking_AbridgedAddLink16CallSign(builder, link16CallSign)

def IndividualAircraftTasking_AbridgedAddTacanChan(builder, tacanChan):
    builder.PrependInt32Slot(6, tacanChan, 0)

def AddTacanChan(builder, tacanChan):
    IndividualAircraftTasking_AbridgedAddTacanChan(builder, tacanChan)

def IndividualAircraftTasking_AbridgedAddJuAddress(builder, juAddress):
...
def AddJuAddress(builder, juAddress):
    IndividualAircraftTasking_AbridgedAddJuAddress(builder, juAddress)

def IndividualAircraftTasking_AbridgedStartJuAddressVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartJuAddressVector(builder, numElems):
    return IndividualAircraftTasking_AbridgedStartJuAddressVector(builder, numElems)

def IndividualAircraftTasking_AbridgedAddIffSifMode1Code(builder, iffSifMode1Code):
...
def AddIffSifMode1Code(builder, iffSifMode1Code):
    IndividualAircraftTasking_AbridgedAddIffSifMode1Code(builder, iffSifMode1Code)

def IndividualAircraftTasking_AbridgedAddIffSifMode2Code(builder, iffSifMode2Code):
...
def AddIffSifMode2Code(builder, iffSifMode2Code):
    IndividualAircraftTasking_AbridgedAddIffSifMode2Code(builder, iffSifMode2Code)

def IndividualAircraftTasking_AbridgedAddIffSifMode3Code(builder, iffSifMode3Code):
...
def AddIffSifMode3Code(builder, iffSifMode3Code):
    IndividualAircraftTasking_AbridgedAddIffSifMode3Code(builder, iffSifMode3Code)

def IndividualAircraftTasking_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return IndividualAircraftTasking_AbridgedEnd(builder)
...
class IndividualAircraftTasking_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        individualAircraftTaskingAbridged = IndividualAircraftTasking_Abridged()
        individualAircraftTaskingAbridged.Init(buf, pos)
        return cls.InitFromObj(individualAircraftTaskingAbridged)
    ...
    @classmethod
    def InitFromObj(cls, individualAircraftTaskingAbridged):
        x = IndividualAircraftTasking_AbridgedT()
        x._UnPack(individualAircraftTaskingAbridged)
        return x

    # IndividualAircraftTasking_AbridgedT
    def _UnPack(self, individualAircraftTaskingAbridged):
        if individualAircraftTaskingAbridged is None:
            return
        self.numAcft = individualAircraftTaskingAbridged.NumAcft()
        self.acftType = individualAircraftTaskingAbridged.AcftType()
        self.callSign = individualAircraftTaskingAbridged.CallSign()
        self.priConfigCode = individualAircraftTaskingAbridged.PriConfigCode()
        self.secConfigCode = individualAircraftTaskingAbridged.SecConfigCode()
        self.link16CallSign = individualAircraftTaskingAbridged.Link16CallSign()
        self.tacanChan = individualAircraftTaskingAbridged.TacanChan()
        if not individualAircraftTaskingAbridged.JuAddressIsNone():
            self.juAddress = []
            for i in range(individualAircraftTaskingAbridged.JuAddressLength()):
                self.juAddress.append(individualAircraftTaskingAbridged.JuAddress(i))
        self.iffSifMode1Code = individualAircraftTaskingAbridged.IffSifMode1Code()
        self.iffSifMode2Code = individualAircraftTaskingAbridged.IffSifMode2Code()
        self.iffSifMode3Code = individualAircraftTaskingAbridged.IffSifMode3Code()
    ...
    def Pack(self, builder):
        ...
        if self.juAddress is not None:
            ...
            IndividualAircraftTasking_AbridgedStartJuAddressVector(builder, len(self.juAddress))
        ...
        IndividualAircraftTasking_AbridgedStart(builder)
        IndividualAircraftTasking_AbridgedAddNumAcft(builder, self.numAcft)
        if self.acftType is not None:
            IndividualAircraftTasking_AbridgedAddAcftType(builder, acftType)
        if self.callSign is not None:
            IndividualAircraftTasking_AbridgedAddCallSign(builder, callSign)
        ...
        if self.link16CallSign is not None:
            IndividualAircraftTasking_AbridgedAddLink16CallSign(builder, link16CallSign)
        IndividualAircraftTasking_AbridgedAddTacanChan(builder, self.tacanChan)
        if self.juAddress is not None:
            IndividualAircraftTasking_AbridgedAddJuAddress(builder, juAddress)
        if self.iffSifMode1Code is not None:
            IndividualAircraftTasking_AbridgedAddIffSifMode1Code(builder, iffSifMode1Code)
        ...
        if self.iffSifMode3Code is not None:
            IndividualAircraftTasking_AbridgedAddIffSifMode3Code(builder, iffSifMode3Code)
        individualAircraftTaskingAbridged = IndividualAircraftTasking_AbridgedEnd(builder)
        return individualAircraftTaskingAbridged
