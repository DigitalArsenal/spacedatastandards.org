...
class EphemerisSet_Ingest(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsEphemerisSet_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def EphemerisSet_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def EphemerisSet_IngestStart(builder):
    builder.StartObject(44)

def Start(builder):
    EphemerisSet_IngestStart(builder)

def EphemerisSet_IngestAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    EphemerisSet_IngestAddId(builder, id)

def EphemerisSet_IngestAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    EphemerisSet_IngestAddClassificationMarking(builder, classificationMarking)

def EphemerisSet_IngestAddIdOnOrbit(builder, idOnOrbit):
...
def AddIdOnOrbit(builder, idOnOrbit):
    EphemerisSet_IngestAddIdOnOrbit(builder, idOnOrbit)

def EphemerisSet_IngestAddOrigObjectId(builder, origObjectId):
...
def AddOrigObjectId(builder, origObjectId):
    EphemerisSet_IngestAddOrigObjectId(builder, origObjectId)

def EphemerisSet_IngestAddPointStartTime(builder, pointStartTime):
...
def AddPointStartTime(builder, pointStartTime):
    EphemerisSet_IngestAddPointStartTime(builder, pointStartTime)

def EphemerisSet_IngestAddUsableStartTime(builder, usableStartTime):
...
def AddUsableStartTime(builder, usableStartTime):
    EphemerisSet_IngestAddUsableStartTime(builder, usableStartTime)

def EphemerisSet_IngestAddPointEndTime(builder, pointEndTime):
...
def AddPointEndTime(builder, pointEndTime):
    EphemerisSet_IngestAddPointEndTime(builder, pointEndTime)

def EphemerisSet_IngestAddUsableEndTime(builder, usableEndTime):
...
def AddUsableEndTime(builder, usableEndTime):
    EphemerisSet_IngestAddUsableEndTime(builder, usableEndTime)

def EphemerisSet_IngestAddStepSize(builder, stepSize):
    builder.PrependInt32Slot(8, stepSize, 0)

def AddStepSize(builder, stepSize):
    EphemerisSet_IngestAddStepSize(builder, stepSize)

def EphemerisSet_IngestAddNumPoints(builder, numPoints):
    builder.PrependInt32Slot(9, numPoints, 0)

def AddNumPoints(builder, numPoints):
    EphemerisSet_IngestAddNumPoints(builder, numPoints)

def EphemerisSet_IngestAddType(builder, type):
    builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(type), 0)

def AddType(builder, type):
    EphemerisSet_IngestAddType(builder, type)

def EphemerisSet_IngestAddPedigree(builder, pedigree):
...
def AddPedigree(builder, pedigree):
    EphemerisSet_IngestAddPedigree(builder, pedigree)

def EphemerisSet_IngestAddCategory(builder, category):
...
def AddCategory(builder, category):
    EphemerisSet_IngestAddCategory(builder, category)

def EphemerisSet_IngestAddIdStateVector(builder, idStateVector):
...
def AddIdStateVector(builder, idStateVector):
    EphemerisSet_IngestAddIdStateVector(builder, idStateVector)

def EphemerisSet_IngestAddHasMnvr(builder, hasMnvr):
    builder.PrependBoolSlot(14, hasMnvr, 0)

def AddHasMnvr(builder, hasMnvr):
    EphemerisSet_IngestAddHasMnvr(builder, hasMnvr)

def EphemerisSet_IngestAddIdManeuvers(builder, idManeuvers):
...
def AddIdManeuvers(builder, idManeuvers):
    EphemerisSet_IngestAddIdManeuvers(builder, idManeuvers)

def EphemerisSet_IngestStartIdManeuversVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartIdManeuversVector(builder, numElems):
    return EphemerisSet_IngestStartIdManeuversVector(builder, numElems)

def EphemerisSet_IngestAddHasCov(builder, hasCov):
    builder.PrependBoolSlot(16, hasCov, 0)

def AddHasCov(builder, hasCov):
    EphemerisSet_IngestAddHasCov(builder, hasCov)

def EphemerisSet_IngestAddHasAccel(builder, hasAccel):
    builder.PrependBoolSlot(17, hasAccel, 0)

def AddHasAccel(builder, hasAccel):
    EphemerisSet_IngestAddHasAccel(builder, hasAccel)

def EphemerisSet_IngestAddCentBody(builder, centBody):
...
def AddCentBody(builder, centBody):
    EphemerisSet_IngestAddCentBody(builder, centBody)

def EphemerisSet_IngestAddIntegrator(builder, integrator):
...
def AddIntegrator(builder, integrator):
    EphemerisSet_IngestAddIntegrator(builder, integrator)

def EphemerisSet_IngestAddGeopotentialModel(builder, geopotentialModel):
...
def AddGeopotentialModel(builder, geopotentialModel):
    EphemerisSet_IngestAddGeopotentialModel(builder, geopotentialModel)

def EphemerisSet_IngestAddDragModel(builder, dragModel):
...
def AddDragModel(builder, dragModel):
    EphemerisSet_IngestAddDragModel(builder, dragModel)

def EphemerisSet_IngestAddLunarSolar(builder, lunarSolar):
    builder.PrependBoolSlot(22, lunarSolar, 0)

def AddLunarSolar(builder, lunarSolar):
    EphemerisSet_IngestAddLunarSolar(builder, lunarSolar)

def EphemerisSet_IngestAddSolidEarthTides(builder, solidEarthTides):
    builder.PrependBoolSlot(23, solidEarthTides, 0)

def AddSolidEarthTides(builder, solidEarthTides):
    EphemerisSet_IngestAddSolidEarthTides(builder, solidEarthTides)

def EphemerisSet_IngestAddBDot(builder, bDot):
    builder.PrependFloat64Slot(24, bDot, 0.0)

def AddBDot(builder, bDot):
    EphemerisSet_IngestAddBDot(builder, bDot)

def EphemerisSet_IngestAddEdr(builder, edr):
    builder.PrependFloat64Slot(25, edr, 0.0)

def AddEdr(builder, edr):
    EphemerisSet_IngestAddEdr(builder, edr)

def EphemerisSet_IngestAddInterpolation(builder, interpolation):
...
def AddInterpolation(builder, interpolation):
    EphemerisSet_IngestAddInterpolation(builder, interpolation)

def EphemerisSet_IngestAddInterpolationDegree(builder, interpolationDegree):
    builder.PrependInt32Slot(27, interpolationDegree, 0)

def AddInterpolationDegree(builder, interpolationDegree):
    EphemerisSet_IngestAddInterpolationDegree(builder, interpolationDegree)

def EphemerisSet_IngestAddFilename(builder, filename):
...
def AddFilename(builder, filename):
    EphemerisSet_IngestAddFilename(builder, filename)

def EphemerisSet_IngestAddComments(builder, comments):
...
def AddComments(builder, comments):
    EphemerisSet_IngestAddComments(builder, comments)

def EphemerisSet_IngestAddDescription(builder, description):
    builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(description), 0)

def AddDescription(builder, description):
    EphemerisSet_IngestAddDescription(builder, description)

def EphemerisSet_IngestAddDescriptor(builder, descriptor):
...
def AddDescriptor(builder, descriptor):
    EphemerisSet_IngestAddDescriptor(builder, descriptor)

def EphemerisSet_IngestAddReferenceFrame(builder, referenceFrame):
    builder.PrependInt8Slot(32, referenceFrame, 0)

def AddReferenceFrame(builder, referenceFrame):
    EphemerisSet_IngestAddReferenceFrame(builder, referenceFrame)

def EphemerisSet_IngestAddCovReferenceFrame(builder, covReferenceFrame):
    builder.PrependInt8Slot(33, covReferenceFrame, 0)

def AddCovReferenceFrame(builder, covReferenceFrame):
    EphemerisSet_IngestAddCovReferenceFrame(builder, covReferenceFrame)

def EphemerisSet_IngestAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(34, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    EphemerisSet_IngestAddCreatedAt(builder, createdAt)

def EphemerisSet_IngestAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(35, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    EphemerisSet_IngestAddCreatedBy(builder, createdBy)

def EphemerisSet_IngestAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(36, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    EphemerisSet_IngestAddSource(builder, source)

def EphemerisSet_IngestAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(37, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    EphemerisSet_IngestAddOrigin(builder, origin)

def EphemerisSet_IngestAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(38, dataMode, 0)

def AddDataMode(builder, dataMode):
    EphemerisSet_IngestAddDataMode(builder, dataMode)

def EphemerisSet_IngestAddSatNo(builder, satNo):
    builder.PrependInt32Slot(39, satNo, 0)

def AddSatNo(builder, satNo):
    EphemerisSet_IngestAddSatNo(builder, satNo)

def EphemerisSet_IngestAddEphemerisList(builder, ephemerisList):
    builder.PrependUOffsetTRelativeSlot(40, flatbuffers.number_types.UOffsetTFlags.py_type(ephemerisList), 0)

def AddEphemerisList(builder, ephemerisList):
    EphemerisSet_IngestAddEphemerisList(builder, ephemerisList)

def EphemerisSet_IngestStartEphemerisListVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartEphemerisListVector(builder, numElems):
    return EphemerisSet_IngestStartEphemerisListVector(builder, numElems)

def EphemerisSet_IngestAddTags(builder, tags):
    builder.PrependUOffsetTRelativeSlot(41, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)

def AddTags(builder, tags):
    EphemerisSet_IngestAddTags(builder, tags)

def EphemerisSet_IngestStartTagsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartTagsVector(builder, numElems):
    return EphemerisSet_IngestStartTagsVector(builder, numElems)

def EphemerisSet_IngestAddTransactionId(builder, transactionId):
    builder.PrependUOffsetTRelativeSlot(42, flatbuffers.number_types.UOffsetTFlags.py_type(transactionId), 0)

def AddTransactionId(builder, transactionId):
    EphemerisSet_IngestAddTransactionId(builder, transactionId)

def EphemerisSet_IngestAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(43, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    EphemerisSet_IngestAddOrigNetwork(builder, origNetwork)

def EphemerisSet_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return EphemerisSet_IngestEnd(builder)
...
class EphemerisSet_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        ephemerisSetIngest = EphemerisSet_Ingest()
        ephemerisSetIngest.Init(buf, pos)
        return cls.InitFromObj(ephemerisSetIngest)
    ...
    @classmethod
    def InitFromObj(cls, ephemerisSetIngest):
        x = EphemerisSet_IngestT()
        x._UnPack(ephemerisSetIngest)
        return x

    # EphemerisSet_IngestT
    def _UnPack(self, ephemerisSetIngest):
        if ephemerisSetIngest is None:
            return
        self.id = ephemerisSetIngest.Id()
        self.classificationMarking = ephemerisSetIngest.ClassificationMarking()
        self.idOnOrbit = ephemerisSetIngest.IdOnOrbit()
        self.origObjectId = ephemerisSetIngest.OrigObjectId()
        self.pointStartTime = ephemerisSetIngest.PointStartTime()
        self.usableStartTime = ephemerisSetIngest.UsableStartTime()
        self.pointEndTime = ephemerisSetIngest.PointEndTime()
        self.usableEndTime = ephemerisSetIngest.UsableEndTime()
        self.stepSize = ephemerisSetIngest.StepSize()
        self.numPoints = ephemerisSetIngest.NumPoints()
        self.type = ephemerisSetIngest.Type()
        self.pedigree = ephemerisSetIngest.Pedigree()
        self.category = ephemerisSetIngest.Category()
        self.idStateVector = ephemerisSetIngest.IdStateVector()
        self.hasMnvr = ephemerisSetIngest.HasMnvr()
        if not ephemerisSetIngest.IdManeuversIsNone():
            self.idManeuvers = []
            for i in range(ephemerisSetIngest.IdManeuversLength()):
                self.idManeuvers.append(ephemerisSetIngest.IdManeuvers(i))
        self.hasCov = ephemerisSetIngest.HasCov()
        self.hasAccel = ephemerisSetIngest.HasAccel()
        self.centBody = ephemerisSetIngest.CentBody()
        self.integrator = ephemerisSetIngest.Integrator()
        self.geopotentialModel = ephemerisSetIngest.GeopotentialModel()
        self.dragModel = ephemerisSetIngest.DragModel()
        self.lunarSolar = ephemerisSetIngest.LunarSolar()
        self.solidEarthTides = ephemerisSetIngest.SolidEarthTides()
        self.bDot = ephemerisSetIngest.BDot()
        self.edr = ephemerisSetIngest.Edr()
        self.interpolation = ephemerisSetIngest.Interpolation()
        self.interpolationDegree = ephemerisSetIngest.InterpolationDegree()
        self.filename = ephemerisSetIngest.Filename()
        self.comments = ephemerisSetIngest.Comments()
        self.description = ephemerisSetIngest.Description()
        self.descriptor = ephemerisSetIngest.Descriptor()
        self.referenceFrame = ephemerisSetIngest.ReferenceFrame()
        self.covReferenceFrame = ephemerisSetIngest.CovReferenceFrame()
        self.createdAt = ephemerisSetIngest.CreatedAt()
        self.createdBy = ephemerisSetIngest.CreatedBy()
        self.source = ephemerisSetIngest.Source()
        self.origin = ephemerisSetIngest.Origin()
        self.dataMode = ephemerisSetIngest.DataMode()
        self.satNo = ephemerisSetIngest.SatNo()
        if not ephemerisSetIngest.EphemerisListIsNone():
            self.ephemerisList = []
            for i in range(ephemerisSetIngest.EphemerisListLength()):
                self.ephemerisList.append(ephemerisSetIngest.EphemerisList(i))
        if not ephemerisSetIngest.TagsIsNone():
            self.tags = []
            for i in range(ephemerisSetIngest.TagsLength()):
                self.tags.append(ephemerisSetIngest.Tags(i))
        self.transactionId = ephemerisSetIngest.TransactionId()
        self.origNetwork = ephemerisSetIngest.OrigNetwork()
    ...
    def Pack(self, builder):
        ...
        if self.idManeuvers is not None:
            ...
            EphemerisSet_IngestStartIdManeuversVector(builder, len(self.idManeuvers))
        ...
        if self.ephemerisList is not None:
            ...
            EphemerisSet_IngestStartEphemerisListVector(builder, len(self.ephemerisList))
        ...
        if self.tags is not None:
            ...
            EphemerisSet_IngestStartTagsVector(builder, len(self.tags))
        ...
        if self.usableEndTime is not None:
            EphemerisSet_IngestAddUsableEndTime(builder, usableEndTime)
        EphemerisSet_IngestAddStepSize(builder, self.stepSize)
        EphemerisSet_IngestAddNumPoints(builder, self.numPoints)
        if self.type is not None:
            EphemerisSet_IngestAddType(builder, type)
        if self.pedigree is not None:
            EphemerisSet_IngestAddPedigree(builder, pedigree)
        ...
        if self.idStateVector is not None:
            EphemerisSet_IngestAddIdStateVector(builder, idStateVector)
        EphemerisSet_IngestAddHasMnvr(builder, self.hasMnvr)
        if self.idManeuvers is not None:
            EphemerisSet_IngestAddIdManeuvers(builder, idManeuvers)
        EphemerisSet_IngestAddHasCov(builder, self.hasCov)
        EphemerisSet_IngestAddHasAccel(builder, self.hasAccel)
        if self.centBody is not None:
            EphemerisSet_IngestAddCentBody(builder, centBody)
        if self.integrator is not None:
            EphemerisSet_IngestAddIntegrator(builder, integrator)
        ...
        if self.dragModel is not None:
            EphemerisSet_IngestAddDragModel(builder, dragModel)
        EphemerisSet_IngestAddLunarSolar(builder, self.lunarSolar)
        EphemerisSet_IngestAddSolidEarthTides(builder, self.solidEarthTides)
        EphemerisSet_IngestAddBDot(builder, self.bDot)
        EphemerisSet_IngestAddEdr(builder, self.edr)
        if self.interpolation is not None:
            EphemerisSet_IngestAddInterpolation(builder, interpolation)
        EphemerisSet_IngestAddInterpolationDegree(builder, self.interpolationDegree)
        if self.filename is not None:
            EphemerisSet_IngestAddFilename(builder, filename)
        if self.comments is not None:
            EphemerisSet_IngestAddComments(builder, comments)
        ...
        if self.descriptor is not None:
            EphemerisSet_IngestAddDescriptor(builder, descriptor)
        EphemerisSet_IngestAddReferenceFrame(builder, self.referenceFrame)
        EphemerisSet_IngestAddCovReferenceFrame(builder, self.covReferenceFrame)
        if self.createdAt is not None:
            EphemerisSet_IngestAddCreatedAt(builder, createdAt)
        if self.createdBy is not None:
            EphemerisSet_IngestAddCreatedBy(builder, createdBy)
        ...
        if self.origin is not None:
            EphemerisSet_IngestAddOrigin(builder, origin)
        EphemerisSet_IngestAddDataMode(builder, self.dataMode)
        EphemerisSet_IngestAddSatNo(builder, self.satNo)
        if self.ephemerisList is not None:
            EphemerisSet_IngestAddEphemerisList(builder, ephemerisList)
        if self.tags is not None:
            EphemerisSet_IngestAddTags(builder, tags)
        ...
        if self.origNetwork is not None:
            EphemerisSet_IngestAddOrigNetwork(builder, origNetwork)
        ephemerisSetIngest = EphemerisSet_IngestEnd(builder)
        return ephemerisSetIngest
