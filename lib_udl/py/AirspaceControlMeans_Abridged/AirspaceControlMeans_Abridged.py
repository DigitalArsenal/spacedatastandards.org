...
class AirspaceControlMeans_Abridged(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsAirspaceControlMeans_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def AirspaceControlMeans_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def AirspaceControlMeans_AbridgedStart(builder):
    builder.StartObject(29)

def Start(builder):
    AirspaceControlMeans_AbridgedStart(builder)

def AirspaceControlMeans_AbridgedAddCmType(builder, cmType):
...
def AddCmType(builder, cmType):
    AirspaceControlMeans_AbridgedAddCmType(builder, cmType)

def AirspaceControlMeans_AbridgedAddCmId(builder, cmId):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(cmId), 0)

def AddCmId(builder, cmId):
    AirspaceControlMeans_AbridgedAddCmId(builder, cmId)

def AirspaceControlMeans_AbridgedAddCmShape(builder, cmShape):
    builder.PrependInt8Slot(2, cmShape, 0)

def AddCmShape(builder, cmShape):
    AirspaceControlMeans_AbridgedAddCmShape(builder, cmShape)

def AirspaceControlMeans_AbridgedAddUsage(builder, usage):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(usage), 0)

def AddUsage(builder, usage):
    AirspaceControlMeans_AbridgedAddUsage(builder, usage)

def AirspaceControlMeans_AbridgedAddLink16Id(builder, link16Id):
...
def AddLink16Id(builder, link16Id):
    AirspaceControlMeans_AbridgedAddLink16Id(builder, link16Id)

def AirspaceControlMeans_AbridgedAddTransAltitude(builder, transAltitude):
...
def AddTransAltitude(builder, transAltitude):
    AirspaceControlMeans_AbridgedAddTransAltitude(builder, transAltitude)

def AirspaceControlMeans_AbridgedAddGeoDatumAlt(builder, geoDatumAlt):
...
def AddGeoDatumAlt(builder, geoDatumAlt):
    AirspaceControlMeans_AbridgedAddGeoDatumAlt(builder, geoDatumAlt)

def AirspaceControlMeans_AbridgedAddCoord0(builder, coord0):
...
def AddCoord0(builder, coord0):
    AirspaceControlMeans_AbridgedAddCoord0(builder, coord0)

def AirspaceControlMeans_AbridgedAddCoord1(builder, coord1):
...
def AddCoord1(builder, coord1):
    AirspaceControlMeans_AbridgedAddCoord1(builder, coord1)

def AirspaceControlMeans_AbridgedAddBearing0(builder, bearing0):
    builder.PrependFloat64Slot(9, bearing0, 0.0)

def AddBearing0(builder, bearing0):
    AirspaceControlMeans_AbridgedAddBearing0(builder, bearing0)

def AirspaceControlMeans_AbridgedAddBearing1(builder, bearing1):
    builder.PrependFloat64Slot(10, bearing1, 0.0)

def AddBearing1(builder, bearing1):
    AirspaceControlMeans_AbridgedAddBearing1(builder, bearing1)

def AirspaceControlMeans_AbridgedAddRadMag0(builder, radMag0):
    builder.PrependFloat64Slot(11, radMag0, 0.0)

def AddRadMag0(builder, radMag0):
    AirspaceControlMeans_AbridgedAddRadMag0(builder, radMag0)

def AirspaceControlMeans_AbridgedAddRadMag1(builder, radMag1):
    builder.PrependFloat64Slot(12, radMag1, 0.0)

def AddRadMag1(builder, radMag1):
    AirspaceControlMeans_AbridgedAddRadMag1(builder, radMag1)

def AirspaceControlMeans_AbridgedAddRadMagUnit(builder, radMagUnit):
...
def AddRadMagUnit(builder, radMagUnit):
    AirspaceControlMeans_AbridgedAddRadMagUnit(builder, radMagUnit)

def AirspaceControlMeans_AbridgedAddPolyCoord(builder, polyCoord):
...
def AddPolyCoord(builder, polyCoord):
    AirspaceControlMeans_AbridgedAddPolyCoord(builder, polyCoord)

def AirspaceControlMeans_AbridgedStartPolyCoordVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartPolyCoordVector(builder, numElems):
    return AirspaceControlMeans_AbridgedStartPolyCoordVector(builder, numElems)

def AirspaceControlMeans_AbridgedAddTrackLeg(builder, trackLeg):
    builder.PrependInt32Slot(15, trackLeg, 0)

def AddTrackLeg(builder, trackLeg):
    AirspaceControlMeans_AbridgedAddTrackLeg(builder, trackLeg)

def AirspaceControlMeans_AbridgedAddWidthLeft(builder, widthLeft):
    builder.PrependFloat64Slot(16, widthLeft, 0.0)

def AddWidthLeft(builder, widthLeft):
    AirspaceControlMeans_AbridgedAddWidthLeft(builder, widthLeft)

def AirspaceControlMeans_AbridgedAddWidthRight(builder, widthRight):
    builder.PrependFloat64Slot(17, widthRight, 0.0)

def AddWidthRight(builder, widthRight):
    AirspaceControlMeans_AbridgedAddWidthRight(builder, widthRight)

def AirspaceControlMeans_AbridgedAddWidth(builder, width):
    builder.PrependFloat64Slot(18, width, 0.0)

def AddWidth(builder, width):
    AirspaceControlMeans_AbridgedAddWidth(builder, width)

def AirspaceControlMeans_AbridgedAddWidthUnit(builder, widthUnit):
...
def AddWidthUnit(builder, widthUnit):
    AirspaceControlMeans_AbridgedAddWidthUnit(builder, widthUnit)

def AirspaceControlMeans_AbridgedAddCorrWayPoints(builder, corrWayPoints):
...
def AddCorrWayPoints(builder, corrWayPoints):
    AirspaceControlMeans_AbridgedAddCorrWayPoints(builder, corrWayPoints)

def AirspaceControlMeans_AbridgedStartCorrWayPointsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartCorrWayPointsVector(builder, numElems):
    return AirspaceControlMeans_AbridgedStartCorrWayPointsVector(builder, numElems)

def AirspaceControlMeans_AbridgedAddOrbitAlignment(builder, orbitAlignment):
...
def AddOrbitAlignment(builder, orbitAlignment):
    AirspaceControlMeans_AbridgedAddOrbitAlignment(builder, orbitAlignment)

def AirspaceControlMeans_AbridgedAddEffVdim(builder, effVdim):
...
def AddEffVdim(builder, effVdim):
    AirspaceControlMeans_AbridgedAddEffVdim(builder, effVdim)

def AirspaceControlMeans_AbridgedAddAirspaceTimePeriod(builder, airspaceTimePeriod):
...
def AddAirspaceTimePeriod(builder, airspaceTimePeriod):
    AirspaceControlMeans_AbridgedAddAirspaceTimePeriod(builder, airspaceTimePeriod)

def AirspaceControlMeans_AbridgedStartAirspaceTimePeriodVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartAirspaceTimePeriodVector(builder, numElems):
    return AirspaceControlMeans_AbridgedStartAirspaceTimePeriodVector(builder, numElems)

def AirspaceControlMeans_AbridgedAddAirspaceControlPoint(builder, airspaceControlPoint):
...
def AddAirspaceControlPoint(builder, airspaceControlPoint):
    AirspaceControlMeans_AbridgedAddAirspaceControlPoint(builder, airspaceControlPoint)

def AirspaceControlMeans_AbridgedStartAirspaceControlPointVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartAirspaceControlPointVector(builder, numElems):
    return AirspaceControlMeans_AbridgedStartAirspaceControlPointVector(builder, numElems)

def AirspaceControlMeans_AbridgedAddCtrlAuth(builder, ctrlAuth):
...
def AddCtrlAuth(builder, ctrlAuth):
    AirspaceControlMeans_AbridgedAddCtrlAuth(builder, ctrlAuth)

def AirspaceControlMeans_AbridgedAddCtrlAuthFreqs(builder, ctrlAuthFreqs):
...
def AddCtrlAuthFreqs(builder, ctrlAuthFreqs):
    AirspaceControlMeans_AbridgedAddCtrlAuthFreqs(builder, ctrlAuthFreqs)

def AirspaceControlMeans_AbridgedStartCtrlAuthFreqsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartCtrlAuthFreqsVector(builder, numElems):
    return AirspaceControlMeans_AbridgedStartCtrlAuthFreqsVector(builder, numElems)

def AirspaceControlMeans_AbridgedAddGenTextInd(builder, genTextInd):
...
def AddGenTextInd(builder, genTextInd):
    AirspaceControlMeans_AbridgedAddGenTextInd(builder, genTextInd)

def AirspaceControlMeans_AbridgedAddFreeText(builder, freeText):
...
def AddFreeText(builder, freeText):
    AirspaceControlMeans_AbridgedAddFreeText(builder, freeText)

def AirspaceControlMeans_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return AirspaceControlMeans_AbridgedEnd(builder)
...
class AirspaceControlMeans_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        airspaceControlMeansAbridged = AirspaceControlMeans_Abridged()
        airspaceControlMeansAbridged.Init(buf, pos)
        return cls.InitFromObj(airspaceControlMeansAbridged)
    ...
    @classmethod
    def InitFromObj(cls, airspaceControlMeansAbridged):
        x = AirspaceControlMeans_AbridgedT()
        x._UnPack(airspaceControlMeansAbridged)
        return x

    # AirspaceControlMeans_AbridgedT
    def _UnPack(self, airspaceControlMeansAbridged):
        if airspaceControlMeansAbridged is None:
            return
        self.cmType = airspaceControlMeansAbridged.CmType()
        self.cmId = airspaceControlMeansAbridged.CmId()
        self.cmShape = airspaceControlMeansAbridged.CmShape()
        self.usage = airspaceControlMeansAbridged.Usage()
        self.link16Id = airspaceControlMeansAbridged.Link16Id()
        self.transAltitude = airspaceControlMeansAbridged.TransAltitude()
        self.geoDatumAlt = airspaceControlMeansAbridged.GeoDatumAlt()
        self.coord0 = airspaceControlMeansAbridged.Coord0()
        self.coord1 = airspaceControlMeansAbridged.Coord1()
        self.bearing0 = airspaceControlMeansAbridged.Bearing0()
        self.bearing1 = airspaceControlMeansAbridged.Bearing1()
        self.radMag0 = airspaceControlMeansAbridged.RadMag0()
        self.radMag1 = airspaceControlMeansAbridged.RadMag1()
        self.radMagUnit = airspaceControlMeansAbridged.RadMagUnit()
        if not airspaceControlMeansAbridged.PolyCoordIsNone():
            self.polyCoord = []
            for i in range(airspaceControlMeansAbridged.PolyCoordLength()):
                self.polyCoord.append(airspaceControlMeansAbridged.PolyCoord(i))
        self.trackLeg = airspaceControlMeansAbridged.TrackLeg()
        self.widthLeft = airspaceControlMeansAbridged.WidthLeft()
        self.widthRight = airspaceControlMeansAbridged.WidthRight()
        self.width = airspaceControlMeansAbridged.Width()
        self.widthUnit = airspaceControlMeansAbridged.WidthUnit()
        if not airspaceControlMeansAbridged.CorrWayPointsIsNone():
            self.corrWayPoints = []
            for i in range(airspaceControlMeansAbridged.CorrWayPointsLength()):
                self.corrWayPoints.append(airspaceControlMeansAbridged.CorrWayPoints(i))
        self.orbitAlignment = airspaceControlMeansAbridged.OrbitAlignment()
        self.effVdim = airspaceControlMeansAbridged.EffVdim()
        if not airspaceControlMeansAbridged.AirspaceTimePeriodIsNone():
            self.airspaceTimePeriod = []
            for i in range(airspaceControlMeansAbridged.AirspaceTimePeriodLength()):
                self.airspaceTimePeriod.append(airspaceControlMeansAbridged.AirspaceTimePeriod(i))
        if not airspaceControlMeansAbridged.AirspaceControlPointIsNone():
            self.airspaceControlPoint = []
            for i in range(airspaceControlMeansAbridged.AirspaceControlPointLength()):
                self.airspaceControlPoint.append(airspaceControlMeansAbridged.AirspaceControlPoint(i))
        self.ctrlAuth = airspaceControlMeansAbridged.CtrlAuth()
        if not airspaceControlMeansAbridged.CtrlAuthFreqsIsNone():
            self.ctrlAuthFreqs = []
            for i in range(airspaceControlMeansAbridged.CtrlAuthFreqsLength()):
                self.ctrlAuthFreqs.append(airspaceControlMeansAbridged.CtrlAuthFreqs(i))
        self.genTextInd = airspaceControlMeansAbridged.GenTextInd()
        self.freeText = airspaceControlMeansAbridged.FreeText()
    ...
    def Pack(self, builder):
        ...
        if self.polyCoord is not None:
            ...
            AirspaceControlMeans_AbridgedStartPolyCoordVector(builder, len(self.polyCoord))
        ...
        if self.corrWayPoints is not None:
            ...
            AirspaceControlMeans_AbridgedStartCorrWayPointsVector(builder, len(self.corrWayPoints))
        ...
        if self.airspaceTimePeriod is not None:
            ...
            AirspaceControlMeans_AbridgedStartAirspaceTimePeriodVector(builder, len(self.airspaceTimePeriod))
        ...
        if self.airspaceControlPoint is not None:
            ...
            AirspaceControlMeans_AbridgedStartAirspaceControlPointVector(builder, len(self.airspaceControlPoint))
        ...
        if self.ctrlAuthFreqs is not None:
            ...
            AirspaceControlMeans_AbridgedStartCtrlAuthFreqsVector(builder, len(self.ctrlAuthFreqs))
        ...
        if self.cmId is not None:
            AirspaceControlMeans_AbridgedAddCmId(builder, cmId)
        AirspaceControlMeans_AbridgedAddCmShape(builder, self.cmShape)
        if self.usage is not None:
            AirspaceControlMeans_AbridgedAddUsage(builder, usage)
        if self.link16Id is not None:
            AirspaceControlMeans_AbridgedAddLink16Id(builder, link16Id)
        ...
        if self.coord1 is not None:
            AirspaceControlMeans_AbridgedAddCoord1(builder, coord1)
        AirspaceControlMeans_AbridgedAddBearing0(builder, self.bearing0)
        AirspaceControlMeans_AbridgedAddBearing1(builder, self.bearing1)
        AirspaceControlMeans_AbridgedAddRadMag0(builder, self.radMag0)
        AirspaceControlMeans_AbridgedAddRadMag1(builder, self.radMag1)
        if self.radMagUnit is not None:
            AirspaceControlMeans_AbridgedAddRadMagUnit(builder, radMagUnit)
        if self.polyCoord is not None:
            AirspaceControlMeans_AbridgedAddPolyCoord(builder, polyCoord)
        AirspaceControlMeans_AbridgedAddTrackLeg(builder, self.trackLeg)
        AirspaceControlMeans_AbridgedAddWidthLeft(builder, self.widthLeft)
        AirspaceControlMeans_AbridgedAddWidthRight(builder, self.widthRight)
        AirspaceControlMeans_AbridgedAddWidth(builder, self.width)
        if self.widthUnit is not None:
            AirspaceControlMeans_AbridgedAddWidthUnit(builder, widthUnit)
        if self.corrWayPoints is not None:
            AirspaceControlMeans_AbridgedAddCorrWayPoints(builder, corrWayPoints)
        ...
        if self.freeText is not None:
            AirspaceControlMeans_AbridgedAddFreeText(builder, freeText)
        airspaceControlMeansAbridged = AirspaceControlMeans_AbridgedEnd(builder)
        return airspaceControlMeansAbridged
