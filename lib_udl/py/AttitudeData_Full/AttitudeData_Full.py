...
class AttitudeData_Full(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsAttitudeData_Full(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def AttitudeData_FullBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def AttitudeData_FullStart(builder):
    builder.StartObject(33)

def Start(builder):
    AttitudeData_FullStart(builder)

def AttitudeData_FullAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    AttitudeData_FullAddId(builder, id)

def AttitudeData_FullAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    AttitudeData_FullAddClassificationMarking(builder, classificationMarking)

def AttitudeData_FullAddAsId(builder, asId):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(asId), 0)

def AddAsId(builder, asId):
    AttitudeData_FullAddAsId(builder, asId)

def AttitudeData_FullAddIdOnOrbit(builder, idOnOrbit):
...
def AddIdOnOrbit(builder, idOnOrbit):
    AttitudeData_FullAddIdOnOrbit(builder, idOnOrbit)

def AttitudeData_FullAddSatNo(builder, satNo):
    builder.PrependInt32Slot(4, satNo, 0)

def AddSatNo(builder, satNo):
    AttitudeData_FullAddSatNo(builder, satNo)

def AttitudeData_FullAddOrigObjectId(builder, origObjectId):
...
def AddOrigObjectId(builder, origObjectId):
    AttitudeData_FullAddOrigObjectId(builder, origObjectId)

def AttitudeData_FullAddTs(builder, ts):
    builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(ts), 0)

def AddTs(builder, ts):
    AttitudeData_FullAddTs(builder, ts)

def AttitudeData_FullAddMotionType(builder, motionType):
...
def AddMotionType(builder, motionType):
    AttitudeData_FullAddMotionType(builder, motionType)

def AttitudeData_FullAddQ1(builder, q1):
    builder.PrependFloat64Slot(8, q1, 0.0)

def AddQ1(builder, q1):
    AttitudeData_FullAddQ1(builder, q1)

def AttitudeData_FullAddQ2(builder, q2):
    builder.PrependFloat64Slot(9, q2, 0.0)

def AddQ2(builder, q2):
    AttitudeData_FullAddQ2(builder, q2)

def AttitudeData_FullAddQ3(builder, q3):
    builder.PrependFloat64Slot(10, q3, 0.0)

def AddQ3(builder, q3):
    AttitudeData_FullAddQ3(builder, q3)

def AttitudeData_FullAddQc(builder, qc):
    builder.PrependFloat64Slot(11, qc, 0.0)

def AddQc(builder, qc):
    AttitudeData_FullAddQc(builder, qc)

def AttitudeData_FullAddQ1Dot(builder, q1Dot):
    builder.PrependFloat64Slot(12, q1Dot, 0.0)

def AddQ1Dot(builder, q1Dot):
    AttitudeData_FullAddQ1Dot(builder, q1Dot)

def AttitudeData_FullAddQ2Dot(builder, q2Dot):
    builder.PrependFloat64Slot(13, q2Dot, 0.0)

def AddQ2Dot(builder, q2Dot):
    AttitudeData_FullAddQ2Dot(builder, q2Dot)

def AttitudeData_FullAddQ3Dot(builder, q3Dot):
    builder.PrependFloat64Slot(14, q3Dot, 0.0)

def AddQ3Dot(builder, q3Dot):
    AttitudeData_FullAddQ3Dot(builder, q3Dot)

def AttitudeData_FullAddQcDot(builder, qcDot):
    builder.PrependFloat64Slot(15, qcDot, 0.0)

def AddQcDot(builder, qcDot):
    AttitudeData_FullAddQcDot(builder, qcDot)

def AttitudeData_FullAddXAngle(builder, xAngle):
...
def AddXAngle(builder, xAngle):
    AttitudeData_FullAddXAngle(builder, xAngle)

def AttitudeData_FullStartXAngleVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartXAngleVector(builder, numElems):
    return AttitudeData_FullStartXAngleVector(builder, numElems)

def AttitudeData_FullAddYAngle(builder, yAngle):
...
def AddYAngle(builder, yAngle):
    AttitudeData_FullAddYAngle(builder, yAngle)

def AttitudeData_FullStartYAngleVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartYAngleVector(builder, numElems):
    return AttitudeData_FullStartYAngleVector(builder, numElems)

def AttitudeData_FullAddZAngle(builder, zAngle):
...
def AddZAngle(builder, zAngle):
    AttitudeData_FullAddZAngle(builder, zAngle)

def AttitudeData_FullStartZAngleVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartZAngleVector(builder, numElems):
    return AttitudeData_FullStartZAngleVector(builder, numElems)

def AttitudeData_FullAddXRate(builder, xRate):
    builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(xRate), 0)

def AddXRate(builder, xRate):
    AttitudeData_FullAddXRate(builder, xRate)

def AttitudeData_FullStartXRateVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartXRateVector(builder, numElems):
    return AttitudeData_FullStartXRateVector(builder, numElems)

def AttitudeData_FullAddYRate(builder, yRate):
    builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(yRate), 0)

def AddYRate(builder, yRate):
    AttitudeData_FullAddYRate(builder, yRate)

def AttitudeData_FullStartYRateVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartYRateVector(builder, numElems):
    return AttitudeData_FullStartYRateVector(builder, numElems)

def AttitudeData_FullAddZRate(builder, zRate):
    builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(zRate), 0)

def AddZRate(builder, zRate):
    AttitudeData_FullAddZRate(builder, zRate)

def AttitudeData_FullStartZRateVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartZRateVector(builder, numElems):
    return AttitudeData_FullStartZRateVector(builder, numElems)

def AttitudeData_FullAddRa(builder, ra):
    builder.PrependFloat64Slot(22, ra, 0.0)

def AddRa(builder, ra):
    AttitudeData_FullAddRa(builder, ra)

def AttitudeData_FullAddDeclination(builder, declination):
    builder.PrependFloat64Slot(23, declination, 0.0)

def AddDeclination(builder, declination):
    AttitudeData_FullAddDeclination(builder, declination)

def AttitudeData_FullAddConingAngle(builder, coningAngle):
    builder.PrependFloat64Slot(24, coningAngle, 0.0)

def AddConingAngle(builder, coningAngle):
    AttitudeData_FullAddConingAngle(builder, coningAngle)

def AttitudeData_FullAddPrecPeriod(builder, precPeriod):
    builder.PrependFloat64Slot(25, precPeriod, 0.0)

def AddPrecPeriod(builder, precPeriod):
    AttitudeData_FullAddPrecPeriod(builder, precPeriod)

def AttitudeData_FullAddSpinPeriod(builder, spinPeriod):
    builder.PrependFloat64Slot(26, spinPeriod, 0.0)

def AddSpinPeriod(builder, spinPeriod):
    AttitudeData_FullAddSpinPeriod(builder, spinPeriod)

def AttitudeData_FullAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    AttitudeData_FullAddCreatedAt(builder, createdAt)

def AttitudeData_FullAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(28, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    AttitudeData_FullAddCreatedBy(builder, createdBy)

def AttitudeData_FullAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(29, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    AttitudeData_FullAddSource(builder, source)

def AttitudeData_FullAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    AttitudeData_FullAddOrigin(builder, origin)

def AttitudeData_FullAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(31, dataMode, 0)

def AddDataMode(builder, dataMode):
    AttitudeData_FullAddDataMode(builder, dataMode)

def AttitudeData_FullAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(32, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    AttitudeData_FullAddOrigNetwork(builder, origNetwork)

def AttitudeData_FullEnd(builder):
    return builder.EndObject()

def End(builder):
    return AttitudeData_FullEnd(builder)
...
class AttitudeData_FullT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        attitudeDataFull = AttitudeData_Full()
        attitudeDataFull.Init(buf, pos)
        return cls.InitFromObj(attitudeDataFull)
    ...
    @classmethod
    def InitFromObj(cls, attitudeDataFull):
        x = AttitudeData_FullT()
        x._UnPack(attitudeDataFull)
        return x

    # AttitudeData_FullT
    def _UnPack(self, attitudeDataFull):
        if attitudeDataFull is None:
            return
        self.id = attitudeDataFull.Id()
        self.classificationMarking = attitudeDataFull.ClassificationMarking()
        self.asId = attitudeDataFull.AsId()
        self.idOnOrbit = attitudeDataFull.IdOnOrbit()
        self.satNo = attitudeDataFull.SatNo()
        self.origObjectId = attitudeDataFull.OrigObjectId()
        self.ts = attitudeDataFull.Ts()
        self.motionType = attitudeDataFull.MotionType()
        self.q1 = attitudeDataFull.Q1()
        self.q2 = attitudeDataFull.Q2()
        self.q3 = attitudeDataFull.Q3()
        self.qc = attitudeDataFull.Qc()
        self.q1Dot = attitudeDataFull.Q1Dot()
        self.q2Dot = attitudeDataFull.Q2Dot()
        self.q3Dot = attitudeDataFull.Q3Dot()
        self.qcDot = attitudeDataFull.QcDot()
        if not attitudeDataFull.XAngleIsNone():
            self.xAngle = []
            for i in range(attitudeDataFull.XAngleLength()):
                self.xAngle.append(attitudeDataFull.XAngle(i))
        if not attitudeDataFull.YAngleIsNone():
            self.yAngle = []
            for i in range(attitudeDataFull.YAngleLength()):
                self.yAngle.append(attitudeDataFull.YAngle(i))
        if not attitudeDataFull.ZAngleIsNone():
            self.zAngle = []
            for i in range(attitudeDataFull.ZAngleLength()):
                self.zAngle.append(attitudeDataFull.ZAngle(i))
        if not attitudeDataFull.XRateIsNone():
            self.xRate = []
            for i in range(attitudeDataFull.XRateLength()):
                self.xRate.append(attitudeDataFull.XRate(i))
        if not attitudeDataFull.YRateIsNone():
            self.yRate = []
            for i in range(attitudeDataFull.YRateLength()):
                self.yRate.append(attitudeDataFull.YRate(i))
        if not attitudeDataFull.ZRateIsNone():
            self.zRate = []
            for i in range(attitudeDataFull.ZRateLength()):
                self.zRate.append(attitudeDataFull.ZRate(i))
        self.ra = attitudeDataFull.Ra()
        self.declination = attitudeDataFull.Declination()
        self.coningAngle = attitudeDataFull.ConingAngle()
        self.precPeriod = attitudeDataFull.PrecPeriod()
        self.spinPeriod = attitudeDataFull.SpinPeriod()
        self.createdAt = attitudeDataFull.CreatedAt()
        self.createdBy = attitudeDataFull.CreatedBy()
        self.source = attitudeDataFull.Source()
        self.origin = attitudeDataFull.Origin()
        self.dataMode = attitudeDataFull.DataMode()
        self.origNetwork = attitudeDataFull.OrigNetwork()
    ...
    def Pack(self, builder):
        ...
        if self.xAngle is not None:
            ...
            AttitudeData_FullStartXAngleVector(builder, len(self.xAngle))
        ...
        if self.yAngle is not None:
            ...
            AttitudeData_FullStartYAngleVector(builder, len(self.yAngle))
        ...
        if self.zAngle is not None:
            ...
            AttitudeData_FullStartZAngleVector(builder, len(self.zAngle))
        ...
        if self.xRate is not None:
            ...
            AttitudeData_FullStartXRateVector(builder, len(self.xRate))
        ...
        if self.yRate is not None:
            ...
            AttitudeData_FullStartYRateVector(builder, len(self.yRate))
        ...
        if self.zRate is not None:
            ...
            AttitudeData_FullStartZRateVector(builder, len(self.zRate))
        ...
        if self.idOnOrbit is not None:
            AttitudeData_FullAddIdOnOrbit(builder, idOnOrbit)
        AttitudeData_FullAddSatNo(builder, self.satNo)
        if self.origObjectId is not None:
            AttitudeData_FullAddOrigObjectId(builder, origObjectId)
        if self.ts is not None:
            AttitudeData_FullAddTs(builder, ts)
        if self.motionType is not None:
            AttitudeData_FullAddMotionType(builder, motionType)
        AttitudeData_FullAddQ1(builder, self.q1)
        AttitudeData_FullAddQ2(builder, self.q2)
        AttitudeData_FullAddQ3(builder, self.q3)
        AttitudeData_FullAddQc(builder, self.qc)
        AttitudeData_FullAddQ1Dot(builder, self.q1Dot)
        AttitudeData_FullAddQ2Dot(builder, self.q2Dot)
        AttitudeData_FullAddQ3Dot(builder, self.q3Dot)
        AttitudeData_FullAddQcDot(builder, self.qcDot)
        if self.xAngle is not None:
            AttitudeData_FullAddXAngle(builder, xAngle)
        if self.yAngle is not None:
            AttitudeData_FullAddYAngle(builder, yAngle)
        ...
        if self.zRate is not None:
            AttitudeData_FullAddZRate(builder, zRate)
        AttitudeData_FullAddRa(builder, self.ra)
        AttitudeData_FullAddDeclination(builder, self.declination)
        AttitudeData_FullAddConingAngle(builder, self.coningAngle)
        AttitudeData_FullAddPrecPeriod(builder, self.precPeriod)
        AttitudeData_FullAddSpinPeriod(builder, self.spinPeriod)
        if self.createdAt is not None:
            AttitudeData_FullAddCreatedAt(builder, createdAt)
        if self.createdBy is not None:
            AttitudeData_FullAddCreatedBy(builder, createdBy)
        ...
        if self.origin is not None:
            AttitudeData_FullAddOrigin(builder, origin)
        AttitudeData_FullAddDataMode(builder, self.dataMode)
        if self.origNetwork is not None:
            AttitudeData_FullAddOrigNetwork(builder, origNetwork)
        attitudeDataFull = AttitudeData_FullEnd(builder)
        return attitudeDataFull
