...
class DataLinkReferences_Ingest(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsDataLinkReferences_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def DataLinkReferences_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf, offset, b"\x44\x41\x54\x41", size_prefixed=size_prefixed)

    # DataLinkReferences_Ingest
...
def DataLinkReferences_IngestStart(builder):
    builder.StartObject(7)

def Start(builder):
    DataLinkReferences_IngestStart(builder)

def DataLinkReferences_IngestAddRefSerialId(builder, refSerialId):
...
def AddRefSerialId(builder, refSerialId):
    DataLinkReferences_IngestAddRefSerialId(builder, refSerialId)

def DataLinkReferences_IngestAddRefType(builder, refType):
...
def AddRefType(builder, refType):
    DataLinkReferences_IngestAddRefType(builder, refType)

def DataLinkReferences_IngestAddRefOriginator(builder, refOriginator):
...
def AddRefOriginator(builder, refOriginator):
    DataLinkReferences_IngestAddRefOriginator(builder, refOriginator)

def DataLinkReferences_IngestAddRefTs(builder, refTs):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(refTs), 0)

def AddRefTs(builder, refTs):
    DataLinkReferences_IngestAddRefTs(builder, refTs)

def DataLinkReferences_IngestAddRefSerialNum(builder, refSerialNum):
...
def AddRefSerialNum(builder, refSerialNum):
    DataLinkReferences_IngestAddRefSerialNum(builder, refSerialNum)

def DataLinkReferences_IngestAddRefSpecialNotation(builder, refSpecialNotation):
...
def AddRefSpecialNotation(builder, refSpecialNotation):
    DataLinkReferences_IngestAddRefSpecialNotation(builder, refSpecialNotation)

def DataLinkReferences_IngestAddRefSics(builder, refSics):
...
def AddRefSics(builder, refSics):
    DataLinkReferences_IngestAddRefSics(builder, refSics)

def DataLinkReferences_IngestStartRefSicsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartRefSicsVector(builder, numElems):
    return DataLinkReferences_IngestStartRefSicsVector(builder, numElems)

def DataLinkReferences_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return DataLinkReferences_IngestEnd(builder)
...
class DataLinkReferences_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        dataLinkReferencesIngest = DataLinkReferences_Ingest()
        dataLinkReferencesIngest.Init(buf, pos)
        return cls.InitFromObj(dataLinkReferencesIngest)
    ...
    @classmethod
    def InitFromObj(cls, dataLinkReferencesIngest):
        x = DataLinkReferences_IngestT()
        x._UnPack(dataLinkReferencesIngest)
        return x

    # DataLinkReferences_IngestT
    def _UnPack(self, dataLinkReferencesIngest):
        if dataLinkReferencesIngest is None:
            return
        self.refSerialId = dataLinkReferencesIngest.RefSerialId()
        self.refType = dataLinkReferencesIngest.RefType()
        self.refOriginator = dataLinkReferencesIngest.RefOriginator()
        self.refTs = dataLinkReferencesIngest.RefTs()
        self.refSerialNum = dataLinkReferencesIngest.RefSerialNum()
        self.refSpecialNotation = dataLinkReferencesIngest.RefSpecialNotation()
        if not dataLinkReferencesIngest.RefSicsIsNone():
            self.refSics = []
            for i in range(dataLinkReferencesIngest.RefSicsLength()):
                self.refSics.append(dataLinkReferencesIngest.RefSics(i))
    ...
    def Pack(self, builder):
        ...
        if self.refSics is not None:
            ...
            DataLinkReferences_IngestStartRefSicsVector(builder, len(self.refSics))
        ...
        if self.refSics is not None:
            DataLinkReferences_IngestAddRefSics(builder, refSics)
        dataLinkReferencesIngest = DataLinkReferences_IngestEnd(builder)
        return dataLinkReferencesIngest
