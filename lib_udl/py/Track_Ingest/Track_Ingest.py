...
class Track_Ingest(object):
    ...
    @classmethod
    def GetRootAsTrack_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def Track_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def Track_IngestStart(builder):
    builder.StartObject(68)

def Start(builder):
    Track_IngestStart(builder)

def Track_IngestAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    Track_IngestAddId(builder, id)

def Track_IngestAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    Track_IngestAddClassificationMarking(builder, classificationMarking)

def Track_IngestAddCntct(builder, cntct):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(cntct), 0)

def AddCntct(builder, cntct):
    Track_IngestAddCntct(builder, cntct)

def Track_IngestAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    Track_IngestAddCreatedAt(builder, createdAt)

def Track_IngestAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    Track_IngestAddCreatedBy(builder, createdBy)

def Track_IngestAddMsgTs(builder, msgTs):
    builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(msgTs), 0)

def AddMsgTs(builder, msgTs):
    Track_IngestAddMsgTs(builder, msgTs)

def Track_IngestAddMsnId(builder, msnId):
    builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(msnId), 0)

def AddMsnId(builder, msnId):
    Track_IngestAddMsnId(builder, msnId)

def Track_IngestAddAssetNat(builder, assetNat):
...
def AddSenQual(builder, senQual):
    Track_IngestAddSenQual(builder, senQual)

def Track_IngestAddTrkId(builder, trkId):
    builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(trkId), 0)

def AddTrkId(builder, trkId):
    Track_IngestAddTrkId(builder, trkId)

def Track_IngestAddTrkNum(builder, trkNum):
...
def AddTrkNum(builder, trkNum):
    Track_IngestAddTrkNum(builder, trkNum)

def Track_IngestAddTrkStat(builder, trkStat):
...
def AddTrkStat(builder, trkStat):
    Track_IngestAddTrkStat(builder, trkStat)

def Track_IngestAddObjNat(builder, objNat):
...
def AddObjNat(builder, objNat):
    Track_IngestAddObjNat(builder, objNat)

def Track_IngestAddObjId(builder, objId):
    builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(objId), 0)

def AddObjId(builder, objId):
    Track_IngestAddObjId(builder, objId)

def Track_IngestAddObjType(builder, objType):
...
def AddObjType(builder, objType):
    Track_IngestAddObjType(builder, objType)

def Track_IngestAddObjSpec(builder, objSpec):
...
def AddObjSpec(builder, objSpec):
    Track_IngestAddObjSpec(builder, objSpec)

def Track_IngestAddObjPlat(builder, objPlat):
...
def AddObjPlat(builder, objPlat):
    Track_IngestAddObjPlat(builder, objPlat)

def Track_IngestAddObjAct(builder, objAct):
...
def AddObjAct(builder, objAct):
    Track_IngestAddObjAct(builder, objAct)

def Track_IngestAddModType(builder, modType):
...
def AddModType(builder, modType):
    Track_IngestAddModType(builder, modType)

def Track_IngestAddTrkItmId(builder, trkItmId):
...
def AddTrkItmId(builder, trkItmId):
    Track_IngestAddTrkItmId(builder, trkItmId)

def Track_IngestAddTs(builder, ts):
    builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(ts), 0)

def AddTs(builder, ts):
    Track_IngestAddTs(builder, ts)

def Track_IngestAddTrkQual(builder, trkQual):
    builder.PrependInt32Slot(23, trkQual, 0)

def AddTrkQual(builder, trkQual):
    Track_IngestAddTrkQual(builder, trkQual)

def Track_IngestAddTrkPtType(builder, trkPtType):
...
def AddTrkPtType(builder, trkPtType):
    Track_IngestAddTrkPtType(builder, trkPtType)

def Track_IngestAddObjIdent(builder, objIdent):
...
def AddObjIdent(builder, objIdent):
    Track_IngestAddObjIdent(builder, objIdent)

def Track_IngestAddIdentCred(builder, identCred):
    builder.PrependInt32Slot(26, identCred, 0)

def AddIdentCred(builder, identCred):
    Track_IngestAddIdentCred(builder, identCred)

def Track_IngestAddIdentRel(builder, identRel):
    builder.PrependInt32Slot(27, identRel, 0)

def AddIdentRel(builder, identRel):
    Track_IngestAddIdentRel(builder, identRel)

def Track_IngestAddIdentAmp(builder, identAmp):
...
def AddIdentAmp(builder, identAmp):
    Track_IngestAddIdentAmp(builder, identAmp)

def Track_IngestAddEnv(builder, env):
    builder.PrependUOffsetTRelativeSlot(29, flatbuffers.number_types.UOffsetTFlags.py_type(env), 0)

def AddEnv(builder, env):
    Track_IngestAddEnv(builder, env)

def Track_IngestAddEnvConf(builder, envConf):
    builder.PrependFloat64Slot(30, envConf, 0.0)

def AddEnvConf(builder, envConf):
    Track_IngestAddEnvConf(builder, envConf)

def Track_IngestAddTrkConf(builder, trkConf):
    builder.PrependFloat64Slot(31, trkConf, 0.0)

def AddTrkConf(builder, trkConf):
    Track_IngestAddTrkConf(builder, trkConf)

def Track_IngestAddEcefPos(builder, ecefPos):
...
def AddEcefPos(builder, ecefPos):
    Track_IngestAddEcefPos(builder, ecefPos)

def Track_IngestStartEcefPosVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartEcefPosVector(builder, numElems):
    return Track_IngestStartEcefPosVector(builder, numElems)

def Track_IngestAddEcefVel(builder, ecefVel):
...
def AddEcefVel(builder, ecefVel):
    Track_IngestAddEcefVel(builder, ecefVel)

def Track_IngestStartEcefVelVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartEcefVelVector(builder, numElems):
    return Track_IngestStartEcefVelVector(builder, numElems)

def Track_IngestAddEcefAcc(builder, ecefAcc):
...
def AddEcefAcc(builder, ecefAcc):
    Track_IngestAddEcefAcc(builder, ecefAcc)

def Track_IngestStartEcefAccVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartEcefAccVector(builder, numElems):
    return Track_IngestStartEcefAccVector(builder, numElems)

def Track_IngestAddLat(builder, lat):
    builder.PrependFloat64Slot(35, lat, 0.0)

def AddLat(builder, lat):
    Track_IngestAddLat(builder, lat)

def Track_IngestAddLon(builder, lon):
    builder.PrependFloat64Slot(36, lon, 0.0)

def AddLon(builder, lon):
    Track_IngestAddLon(builder, lon)

def Track_IngestAddAlt(builder, alt):
    builder.PrependFloat64Slot(37, alt, 0.0)

def AddAlt(builder, alt):
    Track_IngestAddAlt(builder, alt)

def Track_IngestAddSpd(builder, spd):
    builder.PrependFloat64Slot(38, spd, 0.0)

def AddSpd(builder, spd):
    Track_IngestAddSpd(builder, spd)

def Track_IngestAddHdng(builder, hdng):
    builder.PrependFloat64Slot(39, hdng, 0.0)

def AddHdng(builder, hdng):
    Track_IngestAddHdng(builder, hdng)

def Track_IngestAddCourse(builder, course):
    builder.PrependFloat64Slot(40, course, 0.0)

def AddCourse(builder, course):
    Track_IngestAddCourse(builder, course)

def Track_IngestAddLco(builder, lco):
    builder.PrependUOffsetTRelativeSlot(41, flatbuffers.number_types.UOffsetTFlags.py_type(lco), 0)

def AddLco(builder, lco):
    Track_IngestAddLco(builder, lco)

def Track_IngestStartLcoVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartLcoVector(builder, numElems):
    return Track_IngestStartLcoVector(builder, numElems)

def Track_IngestAddLcs(builder, lcs):
    builder.PrependUOffsetTRelativeSlot(42, flatbuffers.number_types.UOffsetTFlags.py_type(lcs), 0)

def AddLcs(builder, lcs):
    Track_IngestAddLcs(builder, lcs)

def Track_IngestStartLcsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartLcsVector(builder, numElems):
    return Track_IngestStartLcsVector(builder, numElems)

def Track_IngestAddLcPos(builder, lcPos):
    builder.PrependUOffsetTRelativeSlot(43, flatbuffers.number_types.UOffsetTFlags.py_type(lcPos), 0)

def AddLcPos(builder, lcPos):
    Track_IngestAddLcPos(builder, lcPos)

def Track_IngestStartLcPosVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartLcPosVector(builder, numElems):
    return Track_IngestStartLcPosVector(builder, numElems)

def Track_IngestAddLcVel(builder, lcVel):
    builder.PrependUOffsetTRelativeSlot(44, flatbuffers.number_types.UOffsetTFlags.py_type(lcVel), 0)

def AddLcVel(builder, lcVel):
    Track_IngestAddLcVel(builder, lcVel)

def Track_IngestStartLcVelVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartLcVelVector(builder, numElems):
    return Track_IngestStartLcVelVector(builder, numElems)

def Track_IngestAddLcAcc(builder, lcAcc):
    builder.PrependUOffsetTRelativeSlot(45, flatbuffers.number_types.UOffsetTFlags.py_type(lcAcc), 0)

def AddLcAcc(builder, lcAcc):
    Track_IngestAddLcAcc(builder, lcAcc)

def Track_IngestStartLcAccVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartLcAccVector(builder, numElems):
    return Track_IngestStartLcAccVector(builder, numElems)

def Track_IngestAddENuvel(builder, eNuvel):
...
def AddENuvel(builder, eNuvel):
    Track_IngestAddENuvel(builder, eNuvel)

def Track_IngestStartENuvelVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartENuvelVector(builder, numElems):
    return Track_IngestStartENuvelVector(builder, numElems)

def Track_IngestAddENupos(builder, eNupos):
...
def AddENupos(builder, eNupos):
    Track_IngestAddENupos(builder, eNupos)

def Track_IngestStartENuposVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartENuposVector(builder, numElems):
    return Track_IngestStartENuposVector(builder, numElems)

def Track_IngestAddCov(builder, cov):
    builder.PrependUOffsetTRelativeSlot(48, flatbuffers.number_types.UOffsetTFlags.py_type(cov), 0)

def AddCov(builder, cov):
    Track_IngestAddCov(builder, cov)

def Track_IngestStartCovVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartCovVector(builder, numElems):
    return Track_IngestStartCovVector(builder, numElems)

def Track_IngestAddErrEllp(builder, errEllp):
...
def AddErrEllp(builder, errEllp):
    Track_IngestAddErrEllp(builder, errEllp)

def Track_IngestStartErrEllpVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartErrEllpVector(builder, numElems):
    return Track_IngestStartErrEllpVector(builder, numElems)

def Track_IngestAddSrcTyps(builder, srcTyps):
...
def AddSrcTyps(builder, srcTyps):
    Track_IngestAddSrcTyps(builder, srcTyps)

def Track_IngestStartSrcTypsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartSrcTypsVector(builder, numElems):
    return Track_IngestStartSrcTypsVector(builder, numElems)

def Track_IngestAddSrcIds(builder, srcIds):
...
def AddSrcIds(builder, srcIds):
    Track_IngestAddSrcIds(builder, srcIds)

def Track_IngestStartSrcIdsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartSrcIdsVector(builder, numElems):
    return Track_IngestStartSrcIdsVector(builder, numElems)

def Track_IngestAddCallSign(builder, callSign):
...
def AddCallSign(builder, callSign):
    Track_IngestAddCallSign(builder, callSign)

def Track_IngestAddMultiSource(builder, multiSource):
    builder.PrependBoolSlot(53, multiSource, 0)

def AddMultiSource(builder, multiSource):
    Track_IngestAddMultiSource(builder, multiSource)

def Track_IngestAddJSeries(builder, jSeries):
...
def AddJSeries(builder, jSeries):
    Track_IngestAddJSeries(builder, jSeries)

def Track_IngestAddStrength(builder, strength):
    builder.PrependInt32Slot(55, strength, 0)

def AddStrength(builder, strength):
    Track_IngestAddStrength(builder, strength)

def Track_IngestAddM1(builder, m1):
    builder.PrependInt32Slot(56, m1, 0)

def AddM1(builder, m1):
    Track_IngestAddM1(builder, m1)

def Track_IngestAddM1v(builder, m1v):
    builder.PrependInt32Slot(57, m1v, 0)

def AddM1v(builder, m1v):
    Track_IngestAddM1v(builder, m1v)

def Track_IngestAddM2(builder, m2):
    builder.PrependInt32Slot(58, m2, 0)

def AddM2(builder, m2):
    Track_IngestAddM2(builder, m2)

def Track_IngestAddM2v(builder, m2v):
    builder.PrependInt32Slot(59, m2v, 0)

def AddM2v(builder, m2v):
    Track_IngestAddM2v(builder, m2v)

def Track_IngestAddM3a(builder, m3a):
    builder.PrependInt32Slot(60, m3a, 0)

def AddM3a(builder, m3a):
    Track_IngestAddM3a(builder, m3a)

def Track_IngestAddM3av(builder, m3av):
    builder.PrependInt32Slot(61, m3av, 0)

def AddM3av(builder, m3av):
    Track_IngestAddM3av(builder, m3av)

def Track_IngestAddTags(builder, tags):
    builder.PrependUOffsetTRelativeSlot(62, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)

def AddTags(builder, tags):
    Track_IngestAddTags(builder, tags)

def Track_IngestStartTagsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartTagsVector(builder, numElems):
    return Track_IngestStartTagsVector(builder, numElems)

def Track_IngestAddSourceDl(builder, sourceDl):
...
def AddSourceDl(builder, sourceDl):
    Track_IngestAddSourceDl(builder, sourceDl)

def Track_IngestAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(64, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    Track_IngestAddSource(builder, source)

def Track_IngestAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(65, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    Track_IngestAddOrigin(builder, origin)

def Track_IngestAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(66, dataMode, 0)

def AddDataMode(builder, dataMode):
    Track_IngestAddDataMode(builder, dataMode)

def Track_IngestAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(67, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    Track_IngestAddOrigNetwork(builder, origNetwork)

def Track_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return Track_IngestEnd(builder)
...
class Track_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        trackIngest = Track_Ingest()
        trackIngest.Init(buf, pos)
        return cls.InitFromObj(trackIngest)
    ...
    @classmethod
    def InitFromObj(cls, trackIngest):
        x = Track_IngestT()
        x._UnPack(trackIngest)
        return x

    # Track_IngestT
    def _UnPack(self, trackIngest):
        if trackIngest is None:
            return
        self.id = trackIngest.Id()
        self.classificationMarking = trackIngest.ClassificationMarking()
        self.cntct = trackIngest.Cntct()
        self.createdAt = trackIngest.CreatedAt()
        self.createdBy = trackIngest.CreatedBy()
        self.msgTs = trackIngest.MsgTs()
        self.msnId = trackIngest.MsnId()
        self.assetNat = trackIngest.AssetNat()
        self.asset = trackIngest.Asset()
        self.sen = trackIngest.Sen()
        self.senQual = trackIngest.SenQual()
        self.trkId = trackIngest.TrkId()
        self.trkNum = trackIngest.TrkNum()
        self.trkStat = trackIngest.TrkStat()
        self.objNat = trackIngest.ObjNat()
        self.objId = trackIngest.ObjId()
        self.objType = trackIngest.ObjType()
        self.objSpec = trackIngest.ObjSpec()
        self.objPlat = trackIngest.ObjPlat()
        self.objAct = trackIngest.ObjAct()
        self.modType = trackIngest.ModType()
        self.trkItmId = trackIngest.TrkItmId()
        self.ts = trackIngest.Ts()
        self.trkQual = trackIngest.TrkQual()
        self.trkPtType = trackIngest.TrkPtType()
        self.objIdent = trackIngest.ObjIdent()
        self.identCred = trackIngest.IdentCred()
        self.identRel = trackIngest.IdentRel()
        self.identAmp = trackIngest.IdentAmp()
        self.env = trackIngest.Env()
        self.envConf = trackIngest.EnvConf()
        self.trkConf = trackIngest.TrkConf()
        if not trackIngest.EcefPosIsNone():
            self.ecefPos = []
            for i in range(trackIngest.EcefPosLength()):
                self.ecefPos.append(trackIngest.EcefPos(i))
        if not trackIngest.EcefVelIsNone():
            self.ecefVel = []
            for i in range(trackIngest.EcefVelLength()):
                self.ecefVel.append(trackIngest.EcefVel(i))
        if not trackIngest.EcefAccIsNone():
            self.ecefAcc = []
            for i in range(trackIngest.EcefAccLength()):
                self.ecefAcc.append(trackIngest.EcefAcc(i))
        self.lat = trackIngest.Lat()
        self.lon = trackIngest.Lon()
        self.alt = trackIngest.Alt()
        self.spd = trackIngest.Spd()
        self.hdng = trackIngest.Hdng()
        self.course = trackIngest.Course()
        if not trackIngest.LcoIsNone():
            self.lco = []
            for i in range(trackIngest.LcoLength()):
                self.lco.append(trackIngest.Lco(i))
        if not trackIngest.LcsIsNone():
            self.lcs = []
            for i in range(trackIngest.LcsLength()):
                self.lcs.append(trackIngest.Lcs(i))
        if not trackIngest.LcPosIsNone():
            self.lcPos = []
            for i in range(trackIngest.LcPosLength()):
                self.lcPos.append(trackIngest.LcPos(i))
        if not trackIngest.LcVelIsNone():
            self.lcVel = []
            for i in range(trackIngest.LcVelLength()):
                self.lcVel.append(trackIngest.LcVel(i))
        if not trackIngest.LcAccIsNone():
            self.lcAcc = []
            for i in range(trackIngest.LcAccLength()):
                self.lcAcc.append(trackIngest.LcAcc(i))
        if not trackIngest.ENuvelIsNone():
            self.eNuvel = []
            for i in range(trackIngest.ENuvelLength()):
                self.eNuvel.append(trackIngest.ENuvel(i))
        if not trackIngest.ENuposIsNone():
            self.eNupos = []
            for i in range(trackIngest.ENuposLength()):
                self.eNupos.append(trackIngest.ENupos(i))
        if not trackIngest.CovIsNone():
            self.cov = []
            for i in range(trackIngest.CovLength()):
                self.cov.append(trackIngest.Cov(i))
        if not trackIngest.ErrEllpIsNone():
            self.errEllp = []
            for i in range(trackIngest.ErrEllpLength()):
                self.errEllp.append(trackIngest.ErrEllp(i))
        if not trackIngest.SrcTypsIsNone():
            self.srcTyps = []
            for i in range(trackIngest.SrcTypsLength()):
                self.srcTyps.append(trackIngest.SrcTyps(i))
        if not trackIngest.SrcIdsIsNone():
            self.srcIds = []
            for i in range(trackIngest.SrcIdsLength()):
                self.srcIds.append(trackIngest.SrcIds(i))
        self.callSign = trackIngest.CallSign()
        self.multiSource = trackIngest.MultiSource()
        self.jSeries = trackIngest.JSeries()
        self.strength = trackIngest.Strength()
        self.m1 = trackIngest.M1()
        self.m1v = trackIngest.M1v()
        self.m2 = trackIngest.M2()
        self.m2v = trackIngest.M2v()
        self.m3a = trackIngest.M3a()
        self.m3av = trackIngest.M3av()
        if not trackIngest.TagsIsNone():
            self.tags = []
            for i in range(trackIngest.TagsLength()):
                self.tags.append(trackIngest.Tags(i))
        self.sourceDl = trackIngest.SourceDl()
        self.source = trackIngest.Source()
        self.origin = trackIngest.Origin()
        self.dataMode = trackIngest.DataMode()
        self.origNetwork = trackIngest.OrigNetwork()
    ...
    def Pack(self, builder):
        ...
        if self.ecefPos is not None:
            ...
            Track_IngestStartEcefPosVector(builder, len(self.ecefPos))
        ...
        if self.ecefVel is not None:
            ...
            Track_IngestStartEcefVelVector(builder, len(self.ecefVel))
        ...
        if self.ecefAcc is not None:
            ...
            Track_IngestStartEcefAccVector(builder, len(self.ecefAcc))
        ...
        if self.lco is not None:
            ...
            Track_IngestStartLcoVector(builder, len(self.lco))
        ...
        if self.lcs is not None:
            ...
            Track_IngestStartLcsVector(builder, len(self.lcs))
        ...
        if self.lcPos is not None:
            ...
            Track_IngestStartLcPosVector(builder, len(self.lcPos))
        ...
        if self.lcVel is not None:
            ...
            Track_IngestStartLcVelVector(builder, len(self.lcVel))
        ...
        if self.lcAcc is not None:
            ...
            Track_IngestStartLcAccVector(builder, len(self.lcAcc))
        ...
        if self.eNuvel is not None:
            ...
            Track_IngestStartENuvelVector(builder, len(self.eNuvel))
        ...
        if self.eNupos is not None:
            ...
            Track_IngestStartENuposVector(builder, len(self.eNupos))
        ...
        if self.cov is not None:
            ...
            Track_IngestStartCovVector(builder, len(self.cov))
        ...
        if self.errEllp is not None:
            ...
            Track_IngestStartErrEllpVector(builder, len(self.errEllp))
        ...
        if self.srcTyps is not None:
            ...
            Track_IngestStartSrcTypsVector(builder, len(self.srcTyps))
        ...
        if self.srcIds is not None:
            ...
            Track_IngestStartSrcIdsVector(builder, len(self.srcIds))
        ...
        if self.tags is not None:
            ...
            Track_IngestStartTagsVector(builder, len(self.tags))
        ...
        if self.ts is not None:
            Track_IngestAddTs(builder, ts)
        Track_IngestAddTrkQual(builder, self.trkQual)
        if self.trkPtType is not None:
            Track_IngestAddTrkPtType(builder, trkPtType)
        if self.objIdent is not None:
            Track_IngestAddObjIdent(builder, objIdent)
        Track_IngestAddIdentCred(builder, self.identCred)
        Track_IngestAddIdentRel(builder, self.identRel)
        if self.identAmp is not None:
            Track_IngestAddIdentAmp(builder, identAmp)
        if self.env is not None:
            Track_IngestAddEnv(builder, env)
        Track_IngestAddEnvConf(builder, self.envConf)
        Track_IngestAddTrkConf(builder, self.trkConf)
        if self.ecefPos is not None:
            Track_IngestAddEcefPos(builder, ecefPos)
        if self.ecefVel is not None:
            Track_IngestAddEcefVel(builder, ecefVel)
        if self.ecefAcc is not None:
            Track_IngestAddEcefAcc(builder, ecefAcc)
        Track_IngestAddLat(builder, self.lat)
        Track_IngestAddLon(builder, self.lon)
        Track_IngestAddAlt(builder, self.alt)
        Track_IngestAddSpd(builder, self.spd)
        Track_IngestAddHdng(builder, self.hdng)
        Track_IngestAddCourse(builder, self.course)
        if self.lco is not None:
            Track_IngestAddLco(builder, lco)
        if self.lcs is not None:
            Track_IngestAddLcs(builder, lcs)
        ...
        if self.callSign is not None:
            Track_IngestAddCallSign(builder, callSign)
        Track_IngestAddMultiSource(builder, self.multiSource)
        if self.jSeries is not None:
            Track_IngestAddJSeries(builder, jSeries)
        Track_IngestAddStrength(builder, self.strength)
        Track_IngestAddM1(builder, self.m1)
        Track_IngestAddM1v(builder, self.m1v)
        Track_IngestAddM2(builder, self.m2)
        Track_IngestAddM2v(builder, self.m2v)
        Track_IngestAddM3a(builder, self.m3a)
        Track_IngestAddM3av(builder, self.m3av)
        if self.tags is not None:
            Track_IngestAddTags(builder, tags)
        if self.sourceDl is not None:
            Track_IngestAddSourceDl(builder, sourceDl)
        ...
        if self.origin is not None:
            Track_IngestAddOrigin(builder, origin)
        Track_IngestAddDataMode(builder, self.dataMode)
        if self.origNetwork is not None:
            Track_IngestAddOrigNetwork(builder, origNetwork)
        trackIngest = Track_IngestEnd(builder)
        return trackIngest
