...
class CollectResponse_Ingest(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsCollectResponse_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def CollectResponse_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def CollectResponse_IngestStart(builder):
    builder.StartObject(27)

def Start(builder):
    CollectResponse_IngestStart(builder)

def CollectResponse_IngestAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    CollectResponse_IngestAddId(builder, id)

def CollectResponse_IngestAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    CollectResponse_IngestAddClassificationMarking(builder, classificationMarking)

def CollectResponse_IngestAddIdRequest(builder, idRequest):
...
def AddIdRequest(builder, idRequest):
    CollectResponse_IngestAddIdRequest(builder, idRequest)

def CollectResponse_IngestAddIdOnOrbit(builder, idOnOrbit):
...
def AddIdOnOrbit(builder, idOnOrbit):
    CollectResponse_IngestAddIdOnOrbit(builder, idOnOrbit)

def CollectResponse_IngestAddOrigObjectId(builder, origObjectId):
...
def AddOrigObjectId(builder, origObjectId):
    CollectResponse_IngestAddOrigObjectId(builder, origObjectId)

def CollectResponse_IngestAddSatNo(builder, satNo):
    builder.PrependInt32Slot(5, satNo, 0)

def AddSatNo(builder, satNo):
    CollectResponse_IngestAddSatNo(builder, satNo)

def CollectResponse_IngestAddTaskId(builder, taskId):
...
def AddTaskId(builder, taskId):
    CollectResponse_IngestAddTaskId(builder, taskId)

def CollectResponse_IngestAddIdPlan(builder, idPlan):
...
def AddIdPlan(builder, idPlan):
    CollectResponse_IngestAddIdPlan(builder, idPlan)

def CollectResponse_IngestAddExternalId(builder, externalId):
...
def AddExternalId(builder, externalId):
    CollectResponse_IngestAddExternalId(builder, externalId)

def CollectResponse_IngestAddStatus(builder, status):
    builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(status), 0)

def AddStatus(builder, status):
    CollectResponse_IngestAddStatus(builder, status)

def CollectResponse_IngestAddActualStartTime(builder, actualStartTime):
...
def AddActualStartTime(builder, actualStartTime):
    CollectResponse_IngestAddActualStartTime(builder, actualStartTime)

def CollectResponse_IngestAddActualEndTime(builder, actualEndTime):
...
def AddActualEndTime(builder, actualEndTime):
    CollectResponse_IngestAddActualEndTime(builder, actualEndTime)

def CollectResponse_IngestAddAltStartTime(builder, altStartTime):
...
def AddAltStartTime(builder, altStartTime):
    CollectResponse_IngestAddAltStartTime(builder, altStartTime)

def CollectResponse_IngestAddAltEndTime(builder, altEndTime):
...
def AddAltEndTime(builder, altEndTime):
    CollectResponse_IngestAddAltEndTime(builder, altEndTime)

def CollectResponse_IngestAddErrCode(builder, errCode):
...
def AddErrCode(builder, errCode):
    CollectResponse_IngestAddErrCode(builder, errCode)

def CollectResponse_IngestAddSrcTyps(builder, srcTyps):
...
def AddSrcTyps(builder, srcTyps):
    CollectResponse_IngestAddSrcTyps(builder, srcTyps)

def CollectResponse_IngestStartSrcTypsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartSrcTypsVector(builder, numElems):
    return CollectResponse_IngestStartSrcTypsVector(builder, numElems)

def CollectResponse_IngestAddSrcIds(builder, srcIds):
...
def AddSrcIds(builder, srcIds):
    CollectResponse_IngestAddSrcIds(builder, srcIds)

def CollectResponse_IngestStartSrcIdsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartSrcIdsVector(builder, numElems):
    return CollectResponse_IngestStartSrcIdsVector(builder, numElems)

def CollectResponse_IngestAddNotes(builder, notes):
    builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(notes), 0)

def AddNotes(builder, notes):
    CollectResponse_IngestAddNotes(builder, notes)

def CollectResponse_IngestAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    CollectResponse_IngestAddCreatedAt(builder, createdAt)

def CollectResponse_IngestAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    CollectResponse_IngestAddCreatedBy(builder, createdBy)

def CollectResponse_IngestAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    CollectResponse_IngestAddSource(builder, source)

def CollectResponse_IngestAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    CollectResponse_IngestAddOrigin(builder, origin)

def CollectResponse_IngestAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    CollectResponse_IngestAddOrigNetwork(builder, origNetwork)

def CollectResponse_IngestAddIdSensor(builder, idSensor):
...
def AddIdSensor(builder, idSensor):
    CollectResponse_IngestAddIdSensor(builder, idSensor)

def CollectResponse_IngestAddOrigSensorId(builder, origSensorId):
...
def AddOrigSensorId(builder, origSensorId):
    CollectResponse_IngestAddOrigSensorId(builder, origSensorId)

def CollectResponse_IngestAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(25, dataMode, 0)

def AddDataMode(builder, dataMode):
    CollectResponse_IngestAddDataMode(builder, dataMode)

def CollectResponse_IngestAddTags(builder, tags):
    builder.PrependUOffsetTRelativeSlot(26, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)

def AddTags(builder, tags):
    CollectResponse_IngestAddTags(builder, tags)

def CollectResponse_IngestStartTagsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartTagsVector(builder, numElems):
    return CollectResponse_IngestStartTagsVector(builder, numElems)

def CollectResponse_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return CollectResponse_IngestEnd(builder)
...
class CollectResponse_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        collectResponseIngest = CollectResponse_Ingest()
        collectResponseIngest.Init(buf, pos)
        return cls.InitFromObj(collectResponseIngest)
    ...
    @classmethod
    def InitFromObj(cls, collectResponseIngest):
        x = CollectResponse_IngestT()
        x._UnPack(collectResponseIngest)
        return x

    # CollectResponse_IngestT
    def _UnPack(self, collectResponseIngest):
        if collectResponseIngest is None:
            return
        self.id = collectResponseIngest.Id()
        self.classificationMarking = collectResponseIngest.ClassificationMarking()
        self.idRequest = collectResponseIngest.IdRequest()
        self.idOnOrbit = collectResponseIngest.IdOnOrbit()
        self.origObjectId = collectResponseIngest.OrigObjectId()
        self.satNo = collectResponseIngest.SatNo()
        self.taskId = collectResponseIngest.TaskId()
        self.idPlan = collectResponseIngest.IdPlan()
        self.externalId = collectResponseIngest.ExternalId()
        self.status = collectResponseIngest.Status()
        self.actualStartTime = collectResponseIngest.ActualStartTime()
        self.actualEndTime = collectResponseIngest.ActualEndTime()
        self.altStartTime = collectResponseIngest.AltStartTime()
        self.altEndTime = collectResponseIngest.AltEndTime()
        self.errCode = collectResponseIngest.ErrCode()
        if not collectResponseIngest.SrcTypsIsNone():
            self.srcTyps = []
            for i in range(collectResponseIngest.SrcTypsLength()):
                self.srcTyps.append(collectResponseIngest.SrcTyps(i))
        if not collectResponseIngest.SrcIdsIsNone():
            self.srcIds = []
            for i in range(collectResponseIngest.SrcIdsLength()):
                self.srcIds.append(collectResponseIngest.SrcIds(i))
        self.notes = collectResponseIngest.Notes()
        self.createdAt = collectResponseIngest.CreatedAt()
        self.createdBy = collectResponseIngest.CreatedBy()
        self.source = collectResponseIngest.Source()
        self.origin = collectResponseIngest.Origin()
        self.origNetwork = collectResponseIngest.OrigNetwork()
        self.idSensor = collectResponseIngest.IdSensor()
        self.origSensorId = collectResponseIngest.OrigSensorId()
        self.dataMode = collectResponseIngest.DataMode()
        if not collectResponseIngest.TagsIsNone():
            self.tags = []
            for i in range(collectResponseIngest.TagsLength()):
                self.tags.append(collectResponseIngest.Tags(i))
    ...
    def Pack(self, builder):
        ...
        if self.srcTyps is not None:
            ...
            CollectResponse_IngestStartSrcTypsVector(builder, len(self.srcTyps))
        ...
        if self.srcIds is not None:
            ...
            CollectResponse_IngestStartSrcIdsVector(builder, len(self.srcIds))
        ...
        if self.tags is not None:
            ...
            CollectResponse_IngestStartTagsVector(builder, len(self.tags))
        ...
        if self.origObjectId is not None:
            CollectResponse_IngestAddOrigObjectId(builder, origObjectId)
        CollectResponse_IngestAddSatNo(builder, self.satNo)
        if self.taskId is not None:
            CollectResponse_IngestAddTaskId(builder, taskId)
        if self.idPlan is not None:
            CollectResponse_IngestAddIdPlan(builder, idPlan)
        ...
        if self.origSensorId is not None:
            CollectResponse_IngestAddOrigSensorId(builder, origSensorId)
        CollectResponse_IngestAddDataMode(builder, self.dataMode)
        if self.tags is not None:
            CollectResponse_IngestAddTags(builder, tags)
        collectResponseIngest = CollectResponse_IngestEnd(builder)
        return collectResponseIngest
