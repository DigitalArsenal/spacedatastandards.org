...
class EvacMedication_Abridged(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsEvacMedication_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def EvacMedication_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def EvacMedication_AbridgedStart(builder):
    builder.StartObject(6)

def Start(builder):
    EvacMedication_AbridgedStart(builder)

def EvacMedication_AbridgedAddType(builder, type):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(type), 0)

def AddType(builder, type):
    EvacMedication_AbridgedAddType(builder, type)

def EvacMedication_AbridgedAddBodyPart(builder, bodyPart):
...
def AddBodyPart(builder, bodyPart):
    EvacMedication_AbridgedAddBodyPart(builder, bodyPart)

def EvacMedication_AbridgedAddDose(builder, dose):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(dose), 0)

def AddDose(builder, dose):
    EvacMedication_AbridgedAddDose(builder, dose)

def EvacMedication_AbridgedAddAdminRoute(builder, adminRoute):
...
def AddAdminRoute(builder, adminRoute):
    EvacMedication_AbridgedAddAdminRoute(builder, adminRoute)

def EvacMedication_AbridgedAddTime(builder, time):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(time), 0)

def AddTime(builder, time):
    EvacMedication_AbridgedAddTime(builder, time)

def EvacMedication_AbridgedAddComments(builder, comments):
...
def AddComments(builder, comments):
    EvacMedication_AbridgedAddComments(builder, comments)

def EvacMedication_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return EvacMedication_AbridgedEnd(builder)


class EvacMedication_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        evacMedicationAbridged = EvacMedication_Abridged()
        evacMedicationAbridged.Init(buf, pos)
        return cls.InitFromObj(evacMedicationAbridged)
    ...
    @classmethod
    def InitFromObj(cls, evacMedicationAbridged):
        x = EvacMedication_AbridgedT()
        x._UnPack(evacMedicationAbridged)
        return x

    # EvacMedication_AbridgedT
    def _UnPack(self, evacMedicationAbridged):
        if evacMedicationAbridged is None:
            return
        self.type = evacMedicationAbridged.Type()
        self.bodyPart = evacMedicationAbridged.BodyPart()
        self.dose = evacMedicationAbridged.Dose()
        self.adminRoute = evacMedicationAbridged.AdminRoute()
        self.time = evacMedicationAbridged.Time()
        self.comments = evacMedicationAbridged.Comments()
    ...
    def Pack(self, builder):
        ...
        if self.comments is not None:
            EvacMedication_AbridgedAddComments(builder, comments)
        evacMedicationAbridged = EvacMedication_AbridgedEnd(builder)
        return evacMedicationAbridged
