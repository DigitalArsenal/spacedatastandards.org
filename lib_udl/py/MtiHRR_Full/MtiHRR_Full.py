...
class MtiHRR_Full(object):
    ...
    @classmethod
    def GetRootAsMtiHRR_Full(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def MtiHRR_FullBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
class MtiHRR_FullT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        mtiHrrFull = MtiHRR_Full()
        mtiHrrFull.Init(buf, pos)
        return cls.InitFromObj(mtiHrrFull)
    ...
    @classmethod
    def InitFromObj(cls, mtiHrrFull):
        x = MtiHRR_FullT()
        x._UnPack(mtiHrrFull)
        return x

    # MtiHRR_FullT
    def _UnPack(self, mtiHrrFull):
        if mtiHrrFull is None:
            return
        self.h2 = mtiHrrFull.H2()
        self.h3 = mtiHrrFull.H3()
        self.h4 = mtiHrrFull.H4()
        self.h5 = mtiHrrFull.H5()
        self.h6 = mtiHrrFull.H6()
        self.h7 = mtiHrrFull.H7()
        self.h8 = mtiHrrFull.H8()
        self.h9 = mtiHrrFull.H9()
        self.h10 = mtiHrrFull.H10()
        self.h11 = mtiHrrFull.H11()
        self.h12 = mtiHrrFull.H12()
        self.h13 = mtiHrrFull.H13()
        self.h14 = mtiHrrFull.H14()
        self.h15 = mtiHrrFull.H15()
        self.h16 = mtiHrrFull.H16()
        self.h17 = mtiHrrFull.H17()
        self.h18 = mtiHrrFull.H18()
        self.h19 = mtiHrrFull.H19()
        self.h20 = mtiHrrFull.H20()
        self.h21 = mtiHrrFull.H21()
        self.h22 = mtiHrrFull.H22()
        self.h23 = mtiHrrFull.H23()
        self.h24 = mtiHrrFull.H24()
        self.h27 = mtiHrrFull.H27()
        self.h28 = mtiHrrFull.H28()
        self.h29 = mtiHrrFull.H29()
        self.h30 = mtiHrrFull.H30()
        self.h31 = mtiHrrFull.H31()
        if not mtiHrrFull.H32IsNone():
            self.h32 = []
            for i in range(mtiHrrFull.H32Length()):
                self.h32.append(mtiHrrFull.H32(i))
    ...
    def Pack(self, builder):
        ...
        if self.h32 is not None:
            ...
            MtiHRR_FullStartH32Vector(builder, len(self.h32))
            for i in reversed(range(len(self.h32))):
                builder.PrependUOffsetTRelative(h32list[i])
            h32 = builder.EndVector()
        MtiHRR_FullStart(builder)
        MtiHRR_FullAddH2(builder, self.h2)
        MtiHRR_FullAddH3(builder, self.h3)
        MtiHRR_FullAddH4(builder, self.h4)
        MtiHRR_FullAddH5(builder, self.h5)
        MtiHRR_FullAddH6(builder, self.h6)
        MtiHRR_FullAddH7(builder, self.h7)
        MtiHRR_FullAddH8(builder, self.h8)
        MtiHRR_FullAddH9(builder, self.h9)
        MtiHRR_FullAddH10(builder, self.h10)
        MtiHRR_FullAddH11(builder, self.h11)
        MtiHRR_FullAddH12(builder, self.h12)
        MtiHRR_FullAddH13(builder, self.h13)
        MtiHRR_FullAddH14(builder, self.h14)
        MtiHRR_FullAddH15(builder, self.h15)
        if self.h16 is not None:
            MtiHRR_FullAddH16(builder, h16)
        if self.h17 is not None:
            MtiHRR_FullAddH17(builder, h17)
        if self.h18 is not None:
            MtiHRR_FullAddH18(builder, h18)
        MtiHRR_FullAddH19(builder, self.h19)
        MtiHRR_FullAddH20(builder, self.h20)
        MtiHRR_FullAddH21(builder, self.h21)
        MtiHRR_FullAddH22(builder, self.h22)
        if self.h23 is not None:
            MtiHRR_FullAddH23(builder, h23)
        if self.h24 is not None:
            MtiHRR_FullAddH24(builder, h24)
        MtiHRR_FullAddH27(builder, self.h27)
        MtiHRR_FullAddH28(builder, self.h28)
        MtiHRR_FullAddH29(builder, self.h29)
        MtiHRR_FullAddH30(builder, self.h30)
        MtiHRR_FullAddH31(builder, self.h31)
        if self.h32 is not None:
            MtiHRR_FullAddH32(builder, h32)
        mtiHrrFull = MtiHRR_FullEnd(builder)
        return mtiHrrFull
