...
class ItemTracking_Abridged(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsItemTracking_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def ItemTracking_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def ItemTracking_AbridgedStart(builder):
    builder.StartObject(22)

def Start(builder):
    ItemTracking_AbridgedStart(builder)

def ItemTracking_AbridgedAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    ItemTracking_AbridgedAddId(builder, id)

def ItemTracking_AbridgedAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    ItemTracking_AbridgedAddClassificationMarking(builder, classificationMarking)

def ItemTracking_AbridgedAddScanCode(builder, scanCode):
...
def AddScanCode(builder, scanCode):
    ItemTracking_AbridgedAddScanCode(builder, scanCode)

def ItemTracking_AbridgedAddScGenTool(builder, scGenTool):
...
def AddScGenTool(builder, scGenTool):
    ItemTracking_AbridgedAddScGenTool(builder, scGenTool)

def ItemTracking_AbridgedAddScannerId(builder, scannerId):
...
def AddScannerId(builder, scannerId):
    ItemTracking_AbridgedAddScannerId(builder, scannerId)

def ItemTracking_AbridgedAddTs(builder, ts):
    builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(ts), 0)

def AddTs(builder, ts):
    ItemTracking_AbridgedAddTs(builder, ts)

def ItemTracking_AbridgedAddIdItem(builder, idItem):
...
def AddIdItem(builder, idItem):
    ItemTracking_AbridgedAddIdItem(builder, idItem)

def ItemTracking_AbridgedAddType(builder, type):
    builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(type), 0)

def AddType(builder, type):
    ItemTracking_AbridgedAddType(builder, type)

def ItemTracking_AbridgedAddLat(builder, lat):
    builder.PrependFloat64Slot(8, lat, 0.0)

def AddLat(builder, lat):
    ItemTracking_AbridgedAddLat(builder, lat)

def ItemTracking_AbridgedAddLon(builder, lon):
    builder.PrependFloat64Slot(9, lon, 0.0)

def AddLon(builder, lon):
    ItemTracking_AbridgedAddLon(builder, lon)

def ItemTracking_AbridgedAddScanType(builder, scanType):
...
def AddScanType(builder, scanType):
    ItemTracking_AbridgedAddScanType(builder, scanType)

def ItemTracking_AbridgedAddDvCode(builder, dvCode):
...
def AddDvCode(builder, dvCode):
    ItemTracking_AbridgedAddDvCode(builder, dvCode)

def ItemTracking_AbridgedAddNotes(builder, notes):
    builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(notes), 0)

def AddNotes(builder, notes):
    ItemTracking_AbridgedAddNotes(builder, notes)

def ItemTracking_AbridgedAddKeys(builder, keys):
    builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(keys), 0)

def AddKeys(builder, keys):
    ItemTracking_AbridgedAddKeys(builder, keys)

def ItemTracking_AbridgedStartKeysVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartKeysVector(builder, numElems):
    return ItemTracking_AbridgedStartKeysVector(builder, numElems)

def ItemTracking_AbridgedAddValues(builder, values):
    builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(values), 0)

def AddValues(builder, values):
    ItemTracking_AbridgedAddValues(builder, values)

def ItemTracking_AbridgedStartValuesVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartValuesVector(builder, numElems):
    return ItemTracking_AbridgedStartValuesVector(builder, numElems)

def ItemTracking_AbridgedAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    ItemTracking_AbridgedAddCreatedAt(builder, createdAt)

def ItemTracking_AbridgedAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    ItemTracking_AbridgedAddCreatedBy(builder, createdBy)

def ItemTracking_AbridgedAddSourceDl(builder, sourceDl):
...
def AddSourceDl(builder, sourceDl):
    ItemTracking_AbridgedAddSourceDl(builder, sourceDl)

def ItemTracking_AbridgedAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    ItemTracking_AbridgedAddSource(builder, source)

def ItemTracking_AbridgedAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    ItemTracking_AbridgedAddOrigin(builder, origin)

def ItemTracking_AbridgedAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    ItemTracking_AbridgedAddOrigNetwork(builder, origNetwork)

def ItemTracking_AbridgedAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(21, dataMode, 0)

def AddDataMode(builder, dataMode):
    ItemTracking_AbridgedAddDataMode(builder, dataMode)

def ItemTracking_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return ItemTracking_AbridgedEnd(builder)
...
class ItemTracking_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        itemTrackingAbridged = ItemTracking_Abridged()
        itemTrackingAbridged.Init(buf, pos)
        return cls.InitFromObj(itemTrackingAbridged)
    ...
    @classmethod
    def InitFromObj(cls, itemTrackingAbridged):
        x = ItemTracking_AbridgedT()
        x._UnPack(itemTrackingAbridged)
        return x

    # ItemTracking_AbridgedT
    def _UnPack(self, itemTrackingAbridged):
        if itemTrackingAbridged is None:
            return
        self.id = itemTrackingAbridged.Id()
        self.classificationMarking = itemTrackingAbridged.ClassificationMarking()
        self.scanCode = itemTrackingAbridged.ScanCode()
        self.scGenTool = itemTrackingAbridged.ScGenTool()
        self.scannerId = itemTrackingAbridged.ScannerId()
        self.ts = itemTrackingAbridged.Ts()
        self.idItem = itemTrackingAbridged.IdItem()
        self.type = itemTrackingAbridged.Type()
        self.lat = itemTrackingAbridged.Lat()
        self.lon = itemTrackingAbridged.Lon()
        self.scanType = itemTrackingAbridged.ScanType()
        self.dvCode = itemTrackingAbridged.DvCode()
        self.notes = itemTrackingAbridged.Notes()
        if not itemTrackingAbridged.KeysIsNone():
            self.keys = []
            for i in range(itemTrackingAbridged.KeysLength()):
                self.keys.append(itemTrackingAbridged.Keys(i))
        if not itemTrackingAbridged.ValuesIsNone():
            self.values = []
            for i in range(itemTrackingAbridged.ValuesLength()):
                self.values.append(itemTrackingAbridged.Values(i))
        self.createdAt = itemTrackingAbridged.CreatedAt()
        self.createdBy = itemTrackingAbridged.CreatedBy()
        self.sourceDl = itemTrackingAbridged.SourceDl()
        self.source = itemTrackingAbridged.Source()
        self.origin = itemTrackingAbridged.Origin()
        self.origNetwork = itemTrackingAbridged.OrigNetwork()
        self.dataMode = itemTrackingAbridged.DataMode()
    ...
    def Pack(self, builder):
        ...
        if self.keys is not None:
            ...
            ItemTracking_AbridgedStartKeysVector(builder, len(self.keys))
        ...
        if self.values is not None:
            ...
            ItemTracking_AbridgedStartValuesVector(builder, len(self.values))
        ...
        if self.type is not None:
            ItemTracking_AbridgedAddType(builder, type)
        ItemTracking_AbridgedAddLat(builder, self.lat)
        ItemTracking_AbridgedAddLon(builder, self.lon)
        if self.scanType is not None:
            ItemTracking_AbridgedAddScanType(builder, scanType)
        if self.dvCode is not None:
            ItemTracking_AbridgedAddDvCode(builder, dvCode)
        ...
        if self.origNetwork is not None:
            ItemTracking_AbridgedAddOrigNetwork(builder, origNetwork)
        ItemTracking_AbridgedAddDataMode(builder, self.dataMode)
        itemTrackingAbridged = ItemTracking_AbridgedEnd(builder)
