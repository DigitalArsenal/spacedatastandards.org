...
class EffectRequest_Abridged(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = EffectRequest_Abridged()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsEffectRequest_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def EffectRequest_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def EffectRequest_AbridgedStart(builder):
    builder.StartObject(21)

def Start(builder):
    EffectRequest_AbridgedStart(builder)

def EffectRequest_AbridgedAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    EffectRequest_AbridgedAddId(builder, id)

def EffectRequest_AbridgedAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    EffectRequest_AbridgedAddClassificationMarking(builder, classificationMarking)

def EffectRequest_AbridgedAddExternalRequestId(builder, externalRequestId):
...
def AddExternalRequestId(builder, externalRequestId):
    EffectRequest_AbridgedAddExternalRequestId(builder, externalRequestId)

def EffectRequest_AbridgedAddEffectList(builder, effectList):
...
def AddEffectList(builder, effectList):
    EffectRequest_AbridgedAddEffectList(builder, effectList)

def EffectRequest_AbridgedStartEffectListVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartEffectListVector(builder, numElems):
    return EffectRequest_AbridgedStartEffectListVector(builder, numElems)

def EffectRequest_AbridgedAddState(builder, state):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(state), 0)

def AddState(builder, state):
    EffectRequest_AbridgedAddState(builder, state)

def EffectRequest_AbridgedAddContext(builder, context):
...
def AddContext(builder, context):
    EffectRequest_AbridgedAddContext(builder, context)

def EffectRequest_AbridgedAddStartTime(builder, startTime):
...
def AddStartTime(builder, startTime):
    EffectRequest_AbridgedAddStartTime(builder, startTime)

def EffectRequest_AbridgedAddEndTime(builder, endTime):
...
def AddEndTime(builder, endTime):
    EffectRequest_AbridgedAddEndTime(builder, endTime)

def EffectRequest_AbridgedAddDeadlineType(builder, deadlineType):
...
def AddDeadlineType(builder, deadlineType):
    EffectRequest_AbridgedAddDeadlineType(builder, deadlineType)

def EffectRequest_AbridgedAddTargetSrcType(builder, targetSrcType):
...
def AddTargetSrcType(builder, targetSrcType):
    EffectRequest_AbridgedAddTargetSrcType(builder, targetSrcType)

def EffectRequest_AbridgedAddTargetSrcId(builder, targetSrcId):
...
def AddTargetSrcId(builder, targetSrcId):
    EffectRequest_AbridgedAddTargetSrcId(builder, targetSrcId)

def EffectRequest_AbridgedAddPriority(builder, priority):
...
def AddPriority(builder, priority):
    EffectRequest_AbridgedAddPriority(builder, priority)

def EffectRequest_AbridgedAddModelClass(builder, modelClass):
...
def AddModelClass(builder, modelClass):
    EffectRequest_AbridgedAddModelClass(builder, modelClass)

def EffectRequest_AbridgedAddMetricTypes(builder, metricTypes):
...
def AddMetricTypes(builder, metricTypes):
    EffectRequest_AbridgedAddMetricTypes(builder, metricTypes)

def EffectRequest_AbridgedStartMetricTypesVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartMetricTypesVector(builder, numElems):
    return EffectRequest_AbridgedStartMetricTypesVector(builder, numElems)

def EffectRequest_AbridgedAddMetricWeights(builder, metricWeights):
...
def AddMetricWeights(builder, metricWeights):
    EffectRequest_AbridgedAddMetricWeights(builder, metricWeights)

def EffectRequest_AbridgedStartMetricWeightsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartMetricWeightsVector(builder, numElems):
    return EffectRequest_AbridgedStartMetricWeightsVector(builder, numElems)

def EffectRequest_AbridgedAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    EffectRequest_AbridgedAddCreatedAt(builder, createdAt)

def EffectRequest_AbridgedAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    EffectRequest_AbridgedAddCreatedBy(builder, createdBy)

def EffectRequest_AbridgedAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    EffectRequest_AbridgedAddSource(builder, source)

def EffectRequest_AbridgedAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    EffectRequest_AbridgedAddOrigin(builder, origin)

def EffectRequest_AbridgedAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(19, dataMode, 0)

def AddDataMode(builder, dataMode):
    EffectRequest_AbridgedAddDataMode(builder, dataMode)

def EffectRequest_AbridgedAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    EffectRequest_AbridgedAddOrigNetwork(builder, origNetwork)

def EffectRequest_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return EffectRequest_AbridgedEnd(builder)
...
class EffectRequest_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        effectRequestAbridged = EffectRequest_Abridged()
        effectRequestAbridged.Init(buf, pos)
        return cls.InitFromObj(effectRequestAbridged)
    ...
    @classmethod
    def InitFromObj(cls, effectRequestAbridged):
        x = EffectRequest_AbridgedT()
        x._UnPack(effectRequestAbridged)
        return x

    # EffectRequest_AbridgedT
    def _UnPack(self, effectRequestAbridged):
        if effectRequestAbridged is None:
            return
        self.id = effectRequestAbridged.Id()
        self.classificationMarking = effectRequestAbridged.ClassificationMarking()
        self.externalRequestId = effectRequestAbridged.ExternalRequestId()
        if not effectRequestAbridged.EffectListIsNone():
            self.effectList = []
            for i in range(effectRequestAbridged.EffectListLength()):
                self.effectList.append(effectRequestAbridged.EffectList(i))
        self.state = effectRequestAbridged.State()
        self.context = effectRequestAbridged.Context()
        self.startTime = effectRequestAbridged.StartTime()
        self.endTime = effectRequestAbridged.EndTime()
        self.deadlineType = effectRequestAbridged.DeadlineType()
        self.targetSrcType = effectRequestAbridged.TargetSrcType()
        self.targetSrcId = effectRequestAbridged.TargetSrcId()
        self.priority = effectRequestAbridged.Priority()
        self.modelClass = effectRequestAbridged.ModelClass()
        if not effectRequestAbridged.MetricTypesIsNone():
            self.metricTypes = []
            for i in range(effectRequestAbridged.MetricTypesLength()):
                self.metricTypes.append(effectRequestAbridged.MetricTypes(i))
        if not effectRequestAbridged.MetricWeightsIsNone():
            self.metricWeights = []
            for i in range(effectRequestAbridged.MetricWeightsLength()):
                self.metricWeights.append(effectRequestAbridged.MetricWeights(i))
        self.createdAt = effectRequestAbridged.CreatedAt()
        self.createdBy = effectRequestAbridged.CreatedBy()
        self.source = effectRequestAbridged.Source()
        self.origin = effectRequestAbridged.Origin()
        self.dataMode = effectRequestAbridged.DataMode()
        self.origNetwork = effectRequestAbridged.OrigNetwork()
    ...
    def Pack(self, builder):
        ...
        if self.effectList is not None:
            ...
            EffectRequest_AbridgedStartEffectListVector(builder, len(self.effectList))
        ...
        if self.metricTypes is not None:
            ...
            EffectRequest_AbridgedStartMetricTypesVector(builder, len(self.metricTypes))
        ...
        if self.metricWeights is not None:
            ...
            EffectRequest_AbridgedStartMetricWeightsVector(builder, len(self.metricWeights))
        ...
        if self.origin is not None:
            EffectRequest_AbridgedAddOrigin(builder, origin)
        EffectRequest_AbridgedAddDataMode(builder, self.dataMode)
        if self.origNetwork is not None:
            EffectRequest_AbridgedAddOrigNetwork(builder, origNetwork)
        effectRequestAbridged = EffectRequest_AbridgedEnd(builder)
        return effectRequestAbridged
