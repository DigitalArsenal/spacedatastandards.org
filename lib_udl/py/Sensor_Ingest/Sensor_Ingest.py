...
class Sensor_Ingest(object):
    ...
    @classmethod
    def GetRootAsSensor_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def Sensor_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def Sensor_IngestStart(builder):
    builder.StartObject(22)

def Start(builder):
    Sensor_IngestStart(builder)

def Sensor_IngestAddIdSensor(builder, idSensor):
...
def AddIdSensor(builder, idSensor):
    Sensor_IngestAddIdSensor(builder, idSensor)

def Sensor_IngestAddSensorName(builder, sensorName):
...
def AddSensorName(builder, sensorName):
    Sensor_IngestAddSensorName(builder, sensorName)

def Sensor_IngestAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    Sensor_IngestAddClassificationMarking(builder, classificationMarking)

def Sensor_IngestAddSensorNumber(builder, sensorNumber):
    builder.PrependInt32Slot(3, sensorNumber, 0)

def AddSensorNumber(builder, sensorNumber):
    Sensor_IngestAddSensorNumber(builder, sensorNumber)

def Sensor_IngestAddShortName(builder, shortName):
...
def AddShortName(builder, shortName):
    Sensor_IngestAddShortName(builder, shortName)

def Sensor_IngestAddDataControl(builder, dataControl):
...
def AddDataControl(builder, dataControl):
    Sensor_IngestAddDataControl(builder, dataControl)

def Sensor_IngestAddAfId(builder, afId):
    builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(afId), 0)

def AddAfId(builder, afId):
    Sensor_IngestAddAfId(builder, afId)

def Sensor_IngestAddAsrType(builder, asrType):
...
def AddAsrType(builder, asrType):
    Sensor_IngestAddAsrType(builder, asrType)

def Sensor_IngestAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    Sensor_IngestAddSource(builder, source)

def Sensor_IngestAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    Sensor_IngestAddOrigin(builder, origin)

def Sensor_IngestAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    Sensor_IngestAddOrigNetwork(builder, origNetwork)

def Sensor_IngestAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(11, dataMode, 0)

def AddDataMode(builder, dataMode):
    Sensor_IngestAddDataMode(builder, dataMode)

def Sensor_IngestAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    Sensor_IngestAddCreatedAt(builder, createdAt)

def Sensor_IngestAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    Sensor_IngestAddCreatedBy(builder, createdBy)

def Sensor_IngestAddActive(builder, active):
    builder.PrependBoolSlot(14, active, 0)

def AddActive(builder, active):
    Sensor_IngestAddActive(builder, active)

def Sensor_IngestAddSensorcharacteristics(builder, sensorcharacteristics):
...
def AddSensorcharacteristics(builder, sensorcharacteristics):
    Sensor_IngestAddSensorcharacteristics(builder, sensorcharacteristics)

def Sensor_IngestStartSensorcharacteristicsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartSensorcharacteristicsVector(builder, numElems):
    return Sensor_IngestStartSensorcharacteristicsVector(builder, numElems)

def Sensor_IngestAddSensorStats(builder, sensorStats):
...
def AddSensorStats(builder, sensorStats):
    Sensor_IngestAddSensorStats(builder, sensorStats)

def Sensor_IngestStartSensorStatsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartSensorStatsVector(builder, numElems):
    return Sensor_IngestStartSensorStatsVector(builder, numElems)

def Sensor_IngestAddSensorlimitsCollection(builder, sensorlimitsCollection):
...
def AddSensorlimitsCollection(builder, sensorlimitsCollection):
    Sensor_IngestAddSensorlimitsCollection(builder, sensorlimitsCollection)

def Sensor_IngestStartSensorlimitsCollectionVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartSensorlimitsCollectionVector(builder, numElems):
    return Sensor_IngestStartSensorlimitsCollectionVector(builder, numElems)

def Sensor_IngestAddEntity(builder, entity):
...
def AddEntity(builder, entity):
    Sensor_IngestAddEntity(builder, entity)

def Sensor_IngestAddIdEntity(builder, idEntity):
...
def AddIdEntity(builder, idEntity):
    Sensor_IngestAddIdEntity(builder, idEntity)

def Sensor_IngestAddSensorObservationType(builder, sensorObservationType):
...
def AddSensorObservationType(builder, sensorObservationType):
    Sensor_IngestAddSensorObservationType(builder, sensorObservationType)

def Sensor_IngestAddSensorType(builder, sensorType):
...
def AddSensorType(builder, sensorType):
    Sensor_IngestAddSensorType(builder, sensorType)

def Sensor_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return Sensor_IngestEnd(builder)
...
class Sensor_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        sensorIngest = Sensor_Ingest()
        sensorIngest.Init(buf, pos)
        return cls.InitFromObj(sensorIngest)
    ...
    @classmethod
    def InitFromObj(cls, sensorIngest):
        x = Sensor_IngestT()
        x._UnPack(sensorIngest)
        return x

    # Sensor_IngestT
    def _UnPack(self, sensorIngest):
        if sensorIngest is None:
            return
        self.idSensor = sensorIngest.IdSensor()
        self.sensorName = sensorIngest.SensorName()
        self.classificationMarking = sensorIngest.ClassificationMarking()
        self.sensorNumber = sensorIngest.SensorNumber()
        self.shortName = sensorIngest.ShortName()
        self.dataControl = sensorIngest.DataControl()
        self.afId = sensorIngest.AfId()
        self.asrType = sensorIngest.AsrType()
        self.source = sensorIngest.Source()
        self.origin = sensorIngest.Origin()
        self.origNetwork = sensorIngest.OrigNetwork()
        self.dataMode = sensorIngest.DataMode()
        self.createdAt = sensorIngest.CreatedAt()
        self.createdBy = sensorIngest.CreatedBy()
        self.active = sensorIngest.Active()
        if not sensorIngest.SensorcharacteristicsIsNone():
            self.sensorcharacteristics = []
            for i in range(sensorIngest.SensorcharacteristicsLength()):
                self.sensorcharacteristics.append(sensorIngest.Sensorcharacteristics(i))
        if not sensorIngest.SensorStatsIsNone():
            self.sensorStats = []
            for i in range(sensorIngest.SensorStatsLength()):
                self.sensorStats.append(sensorIngest.SensorStats(i))
        if not sensorIngest.SensorlimitsCollectionIsNone():
            self.sensorlimitsCollection = []
            for i in range(sensorIngest.SensorlimitsCollectionLength()):
                self.sensorlimitsCollection.append(sensorIngest.SensorlimitsCollection(i))
        self.entity = sensorIngest.Entity()
        self.idEntity = sensorIngest.IdEntity()
        self.sensorObservationType = sensorIngest.SensorObservationType()
        self.sensorType = sensorIngest.SensorType()
    ...
    def Pack(self, builder):
        ...
        if self.sensorcharacteristics is not None:
            ...
            Sensor_IngestStartSensorcharacteristicsVector(builder, len(self.sensorcharacteristics))
        ...
        if self.sensorStats is not None:
            ...
            Sensor_IngestStartSensorStatsVector(builder, len(self.sensorStats))
        ...
        if self.sensorlimitsCollection is not None:
            ...
            Sensor_IngestStartSensorlimitsCollectionVector(builder, len(self.sensorlimitsCollection))
        ...
        if self.classificationMarking is not None:
            Sensor_IngestAddClassificationMarking(builder, classificationMarking)
        Sensor_IngestAddSensorNumber(builder, self.sensorNumber)
        if self.shortName is not None:
            Sensor_IngestAddShortName(builder, shortName)
        if self.dataControl is not None:
            Sensor_IngestAddDataControl(builder, dataControl)
        ...
        if self.origNetwork is not None:
            Sensor_IngestAddOrigNetwork(builder, origNetwork)
        Sensor_IngestAddDataMode(builder, self.dataMode)
        if self.createdAt is not None:
            Sensor_IngestAddCreatedAt(builder, createdAt)
        if self.createdBy is not None:
            Sensor_IngestAddCreatedBy(builder, createdBy)
        Sensor_IngestAddActive(builder, self.active)
        if self.sensorcharacteristics is not None:
            Sensor_IngestAddSensorcharacteristics(builder, sensorcharacteristics)
        if self.sensorStats is not None:
            Sensor_IngestAddSensorStats(builder, sensorStats)
        ...
        if self.sensorType is not None:
            Sensor_IngestAddSensorType(builder, sensorType)
        sensorIngest = Sensor_IngestEnd(builder)
        return sensorIngest
