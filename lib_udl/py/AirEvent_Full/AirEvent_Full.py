...
class AirEvent_Full(object):
    ...
    @classmethod
    def GetRootAsAirEvent_Full(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def AirEvent_FullBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def AirEvent_FullStart(builder):
    builder.StartObject(44)

def Start(builder):
    AirEvent_FullStart(builder)

def AirEvent_FullAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    AirEvent_FullAddId(builder, id)

def AirEvent_FullAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    AirEvent_FullAddClassificationMarking(builder, classificationMarking)

def AirEvent_FullAddType(builder, type):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(type), 0)

def AddType(builder, type):
    AirEvent_FullAddType(builder, type)

def AirEvent_FullAddIdSortie(builder, idSortie):
...
def AddIdSortie(builder, idSortie):
    AirEvent_FullAddIdSortie(builder, idSortie)

def AirEvent_FullAddIdMission(builder, idMission):
...
def AddIdMission(builder, idMission):
    AirEvent_FullAddIdMission(builder, idMission)

def AirEvent_FullAddExternalAirEventId(builder, externalAirEventId):
...
def AddExternalAirEventId(builder, externalAirEventId):
    AirEvent_FullAddExternalAirEventId(builder, externalAirEventId)

def AirEvent_FullAddLegNum(builder, legNum):
    builder.PrependInt32Slot(6, legNum, 0)

def AddLegNum(builder, legNum):
    AirEvent_FullAddLegNum(builder, legNum)

def AirEvent_FullAddLocation(builder, location):
...
def AddLocation(builder, location):
    AirEvent_FullAddLocation(builder, location)

def AirEvent_FullAddArrPurpose(builder, arrPurpose):
...
def AddArrPurpose(builder, arrPurpose):
    AirEvent_FullAddArrPurpose(builder, arrPurpose)

def AirEvent_FullAddPlannedArrTime(builder, plannedArrTime):
...
def AddPlannedArrTime(builder, plannedArrTime):
    AirEvent_FullAddPlannedArrTime(builder, plannedArrTime)

def AirEvent_FullAddEstArrTime(builder, estArrTime):
...
def AddEstArrTime(builder, estArrTime):
    AirEvent_FullAddEstArrTime(builder, estArrTime)

def AirEvent_FullAddActualArrTime(builder, actualArrTime):
...
def AddActualArrTime(builder, actualArrTime):
    AirEvent_FullAddActualArrTime(builder, actualArrTime)

def AirEvent_FullAddDepPurpose(builder, depPurpose):
...
def AddDepPurpose(builder, depPurpose):
    AirEvent_FullAddDepPurpose(builder, depPurpose)

def AirEvent_FullAddPlannedDepTime(builder, plannedDepTime):
...
def AddPlannedDepTime(builder, plannedDepTime):
    AirEvent_FullAddPlannedDepTime(builder, plannedDepTime)

def AirEvent_FullAddEstDepTime(builder, estDepTime):
...
def AddEstDepTime(builder, estDepTime):
    AirEvent_FullAddEstDepTime(builder, estDepTime)

def AirEvent_FullAddActualDepTime(builder, actualDepTime):
...
def AddActualDepTime(builder, actualDepTime):
    AirEvent_FullAddActualDepTime(builder, actualDepTime)

def AirEvent_FullAddExternalArtrackId(builder, externalArtrackId):
...
def AddExternalArtrackId(builder, externalArtrackId):
    AirEvent_FullAddExternalArtrackId(builder, externalArtrackId)

def AirEvent_FullAddArTrackId(builder, arTrackId):
...
def AddArTrackId(builder, arTrackId):
    AirEvent_FullAddArTrackId(builder, arTrackId)

def AirEvent_FullAddArTrackName(builder, arTrackName):
...
def AddArTrackName(builder, arTrackName):
    AirEvent_FullAddArTrackName(builder, arTrackName)

def AirEvent_FullAddRzct(builder, rzct):
    builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(rzct), 0)

def AddRzct(builder, rzct):
    AirEvent_FullAddRzct(builder, rzct)

def AirEvent_FullAddArct(builder, arct):
    builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(arct), 0)

def AddArct(builder, arct):
    AirEvent_FullAddArct(builder, arct)

def AirEvent_FullAddBaseAlt(builder, baseAlt):
    builder.PrependFloat64Slot(21, baseAlt, 0.0)

def AddBaseAlt(builder, baseAlt):
    AirEvent_FullAddBaseAlt(builder, baseAlt)

def AirEvent_FullAddPriority(builder, priority):
...
def AddPriority(builder, priority):
    AirEvent_FullAddPriority(builder, priority)

def AirEvent_FullAddTrackTime(builder, trackTime):
    builder.PrependFloat64Slot(23, trackTime, 0.0)

def AddTrackTime(builder, trackTime):
    AirEvent_FullAddTrackTime(builder, trackTime)

def AirEvent_FullAddStatusCode(builder, statusCode):
...
def AddStatusCode(builder, statusCode):
    AirEvent_FullAddStatusCode(builder, statusCode)

def AirEvent_FullAddRzPoint(builder, rzPoint):
...
def AddRzPoint(builder, rzPoint):
    AirEvent_FullAddRzPoint(builder, rzPoint)

def AirEvent_FullAddRzType(builder, rzType):
...
def AddRzType(builder, rzType):
    AirEvent_FullAddRzType(builder, rzType)

def AirEvent_FullAddArEventType(builder, arEventType):
...
def AddArEventType(builder, arEventType):
    AirEvent_FullAddArEventType(builder, arEventType)

def AirEvent_FullAddNumTankers(builder, numTankers):
    builder.PrependInt32Slot(28, numTankers, 0)

def AddNumTankers(builder, numTankers):
    AirEvent_FullAddNumTankers(builder, numTankers)

def AirEvent_FullAddRevTrack(builder, revTrack):
    builder.PrependBoolSlot(29, revTrack, 0)

def AddRevTrack(builder, revTrack):
    AirEvent_FullAddRevTrack(builder, revTrack)

def AirEvent_FullAddShortTrack(builder, shortTrack):
    builder.PrependBoolSlot(30, shortTrack, 0)

def AddShortTrack(builder, shortTrack):
    AirEvent_FullAddShortTrack(builder, shortTrack)

def AirEvent_FullAddCancelled(builder, cancelled):
    builder.PrependBoolSlot(31, cancelled, 0)

def AddCancelled(builder, cancelled):
    AirEvent_FullAddCancelled(builder, cancelled)

def AirEvent_FullAddTankers(builder, tankers):
...
def AddTankers(builder, tankers):
    AirEvent_FullAddTankers(builder, tankers)

def AirEvent_FullStartTankersVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartTankersVector(builder, numElems):
    return AirEvent_FullStartTankersVector(builder, numElems)

def AirEvent_FullAddReceivers(builder, receivers):
...
def AddReceivers(builder, receivers):
    AirEvent_FullAddReceivers(builder, receivers)

def AirEvent_FullStartReceiversVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartReceiversVector(builder, numElems):
    return AirEvent_FullStartReceiversVector(builder, numElems)

def AirEvent_FullAddRemarks(builder, remarks):
...
def AddRemarks(builder, remarks):
    AirEvent_FullAddRemarks(builder, remarks)

def AirEvent_FullStartRemarksVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartRemarksVector(builder, numElems):
    return AirEvent_FullStartRemarksVector(builder, numElems)

def AirEvent_FullAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(35, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    AirEvent_FullAddCreatedAt(builder, createdAt)

def AirEvent_FullAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(36, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    AirEvent_FullAddCreatedBy(builder, createdBy)

def AirEvent_FullAddUpdatedAt(builder, updatedAt):
    builder.PrependUOffsetTRelativeSlot(37, flatbuffers.number_types.UOffsetTFlags.py_type(updatedAt), 0)

def AddUpdatedAt(builder, updatedAt):
    AirEvent_FullAddUpdatedAt(builder, updatedAt)

def AirEvent_FullAddUpdatedBy(builder, updatedBy):
...
def AddUpdatedBy(builder, updatedBy):
    AirEvent_FullAddUpdatedBy(builder, updatedBy)

def AirEvent_FullAddSourceDl(builder, sourceDl):
...
def AddSourceDl(builder, sourceDl):
    AirEvent_FullAddSourceDl(builder, sourceDl)

def AirEvent_FullAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(40, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    AirEvent_FullAddSource(builder, source)

def AirEvent_FullAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(41, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    AirEvent_FullAddOrigin(builder, origin)

def AirEvent_FullAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(42, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    AirEvent_FullAddOrigNetwork(builder, origNetwork)

def AirEvent_FullAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(43, dataMode, 0)

def AddDataMode(builder, dataMode):
    AirEvent_FullAddDataMode(builder, dataMode)

def AirEvent_FullEnd(builder):
    return builder.EndObject()

def End(builder):
    return AirEvent_FullEnd(builder)
...
class AirEvent_FullT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        airEventFull = AirEvent_Full()
        airEventFull.Init(buf, pos)
        return cls.InitFromObj(airEventFull)
    ...
    @classmethod
    def InitFromObj(cls, airEventFull):
        x = AirEvent_FullT()
        x._UnPack(airEventFull)
        return x

    # AirEvent_FullT
    def _UnPack(self, airEventFull):
        if airEventFull is None:
            return
        self.id = airEventFull.Id()
        self.classificationMarking = airEventFull.ClassificationMarking()
        self.type = airEventFull.Type()
        self.idSortie = airEventFull.IdSortie()
        self.idMission = airEventFull.IdMission()
        self.externalAirEventId = airEventFull.ExternalAirEventId()
        self.legNum = airEventFull.LegNum()
        self.location = airEventFull.Location()
        self.arrPurpose = airEventFull.ArrPurpose()
        self.plannedArrTime = airEventFull.PlannedArrTime()
        self.estArrTime = airEventFull.EstArrTime()
        self.actualArrTime = airEventFull.ActualArrTime()
        self.depPurpose = airEventFull.DepPurpose()
        self.plannedDepTime = airEventFull.PlannedDepTime()
        self.estDepTime = airEventFull.EstDepTime()
        self.actualDepTime = airEventFull.ActualDepTime()
        self.externalArtrackId = airEventFull.ExternalArtrackId()
        self.arTrackId = airEventFull.ArTrackId()
        self.arTrackName = airEventFull.ArTrackName()
        self.rzct = airEventFull.Rzct()
        self.arct = airEventFull.Arct()
        self.baseAlt = airEventFull.BaseAlt()
        self.priority = airEventFull.Priority()
        self.trackTime = airEventFull.TrackTime()
        self.statusCode = airEventFull.StatusCode()
        self.rzPoint = airEventFull.RzPoint()
        self.rzType = airEventFull.RzType()
        self.arEventType = airEventFull.ArEventType()
        self.numTankers = airEventFull.NumTankers()
        self.revTrack = airEventFull.RevTrack()
        self.shortTrack = airEventFull.ShortTrack()
        self.cancelled = airEventFull.Cancelled()
        if not airEventFull.TankersIsNone():
            self.tankers = []
            for i in range(airEventFull.TankersLength()):
                self.tankers.append(airEventFull.Tankers(i))
        if not airEventFull.ReceiversIsNone():
            self.receivers = []
            for i in range(airEventFull.ReceiversLength()):
                self.receivers.append(airEventFull.Receivers(i))
        if not airEventFull.RemarksIsNone():
            self.remarks = []
            for i in range(airEventFull.RemarksLength()):
                self.remarks.append(airEventFull.Remarks(i))
        self.createdAt = airEventFull.CreatedAt()
        self.createdBy = airEventFull.CreatedBy()
        self.updatedAt = airEventFull.UpdatedAt()
        self.updatedBy = airEventFull.UpdatedBy()
        self.sourceDl = airEventFull.SourceDl()
        self.source = airEventFull.Source()
        self.origin = airEventFull.Origin()
        self.origNetwork = airEventFull.OrigNetwork()
        self.dataMode = airEventFull.DataMode()
    ...
    def Pack(self, builder):
        ...
        if self.tankers is not None:
            ...
            AirEvent_FullStartTankersVector(builder, len(self.tankers))
        ...
        if self.receivers is not None:
            ...
            AirEvent_FullStartReceiversVector(builder, len(self.receivers))
        ...
        if self.remarks is not None:
            ...
            AirEvent_FullStartRemarksVector(builder, len(self.remarks))
        ...
        if self.externalAirEventId is not None:
            AirEvent_FullAddExternalAirEventId(builder, externalAirEventId)
        AirEvent_FullAddLegNum(builder, self.legNum)
        if self.location is not None:
            AirEvent_FullAddLocation(builder, location)
        if self.arrPurpose is not None:
            AirEvent_FullAddArrPurpose(builder, arrPurpose)
        ...
        if self.arct is not None:
            AirEvent_FullAddArct(builder, arct)
        AirEvent_FullAddBaseAlt(builder, self.baseAlt)
        if self.priority is not None:
            AirEvent_FullAddPriority(builder, priority)
        AirEvent_FullAddTrackTime(builder, self.trackTime)
        if self.statusCode is not None:
            AirEvent_FullAddStatusCode(builder, statusCode)
        if self.rzPoint is not None:
            AirEvent_FullAddRzPoint(builder, rzPoint)
        ...
        if self.arEventType is not None:
            AirEvent_FullAddArEventType(builder, arEventType)
        AirEvent_FullAddNumTankers(builder, self.numTankers)
        AirEvent_FullAddRevTrack(builder, self.revTrack)
        AirEvent_FullAddShortTrack(builder, self.shortTrack)
        AirEvent_FullAddCancelled(builder, self.cancelled)
        if self.tankers is not None:
            AirEvent_FullAddTankers(builder, tankers)
        if self.receivers is not None:
            AirEvent_FullAddReceivers(builder, receivers)
        ...
        if self.origNetwork is not None:
            AirEvent_FullAddOrigNetwork(builder, origNetwork)
        AirEvent_FullAddDataMode(builder, self.dataMode)
        airEventFull = AirEvent_FullEnd(builder)
        return airEventFull
