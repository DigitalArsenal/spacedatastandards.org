...
class LaunchEvent_Full(object):
    ...
    @classmethod
    def GetRootAsLaunchEvent_Full(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def LaunchEvent_FullBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def LaunchEvent_FullStart(builder):
    builder.StartObject(21)

def Start(builder):
    LaunchEvent_FullStart(builder)

def LaunchEvent_FullAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    LaunchEvent_FullAddId(builder, id)

def LaunchEvent_FullAddIdOnOrbit(builder, idOnOrbit):
...
def AddIdOnOrbit(builder, idOnOrbit):
    LaunchEvent_FullAddIdOnOrbit(builder, idOnOrbit)

def LaunchEvent_FullAddOrigObjectId(builder, origObjectId):
...
def AddOrigObjectId(builder, origObjectId):
    LaunchEvent_FullAddOrigObjectId(builder, origObjectId)

def LaunchEvent_FullAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    LaunchEvent_FullAddClassificationMarking(builder, classificationMarking)

def LaunchEvent_FullAddDerivedFrom(builder, derivedFrom):
...
def AddDerivedFrom(builder, derivedFrom):
    LaunchEvent_FullAddDerivedFrom(builder, derivedFrom)

def LaunchEvent_FullAddDeclassificationDate(builder, declassificationDate):
...
def AddDeclassificationDate(builder, declassificationDate):
    LaunchEvent_FullAddDeclassificationDate(builder, declassificationDate)

def LaunchEvent_FullAddDeclassificationString(builder, declassificationString):
...
def AddDeclassificationString(builder, declassificationString):
    LaunchEvent_FullAddDeclassificationString(builder, declassificationString)

def LaunchEvent_FullAddMsgCreateDate(builder, msgCreateDate):
...
def AddMsgCreateDate(builder, msgCreateDate):
    LaunchEvent_FullAddMsgCreateDate(builder, msgCreateDate)

def LaunchEvent_FullAddLaunchFailureCode(builder, launchFailureCode):
...
def AddLaunchFailureCode(builder, launchFailureCode):
    LaunchEvent_FullAddLaunchFailureCode(builder, launchFailureCode)

def LaunchEvent_FullAddLaunchDate(builder, launchDate):
...
def AddLaunchDate(builder, launchDate):
    LaunchEvent_FullAddLaunchDate(builder, launchDate)

def LaunchEvent_FullAddBeNumber(builder, beNumber):
...
def AddBeNumber(builder, beNumber):
    LaunchEvent_FullAddBeNumber(builder, beNumber)

def LaunchEvent_FullAddOSuffix(builder, oSuffix):
...
def AddOSuffix(builder, oSuffix):
    LaunchEvent_FullAddOSuffix(builder, oSuffix)

def LaunchEvent_FullAddLaunchFacilityName(builder, launchFacilityName):
...
def AddLaunchFacilityName(builder, launchFacilityName):
    LaunchEvent_FullAddLaunchFacilityName(builder, launchFacilityName)

def LaunchEvent_FullAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    LaunchEvent_FullAddCreatedAt(builder, createdAt)

def LaunchEvent_FullAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    LaunchEvent_FullAddCreatedBy(builder, createdBy)

def LaunchEvent_FullAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    LaunchEvent_FullAddOrigin(builder, origin)

def LaunchEvent_FullAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    LaunchEvent_FullAddSource(builder, source)

def LaunchEvent_FullAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(17, dataMode, 0)

def AddDataMode(builder, dataMode):
    LaunchEvent_FullAddDataMode(builder, dataMode)

def LaunchEvent_FullAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    LaunchEvent_FullAddOrigNetwork(builder, origNetwork)

def LaunchEvent_FullAddOnOrbit(builder, onOrbit):
    builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(onOrbit), 0)

def AddOnOrbit(builder, onOrbit):
    LaunchEvent_FullAddOnOrbit(builder, onOrbit)

def LaunchEvent_FullAddSatNo(builder, satNo):
    builder.PrependInt32Slot(20, satNo, 0)

def AddSatNo(builder, satNo):
    LaunchEvent_FullAddSatNo(builder, satNo)

def LaunchEvent_FullEnd(builder):
    return builder.EndObject()

def End(builder):
    return LaunchEvent_FullEnd(builder)


class LaunchEvent_FullT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        launchEventFull = LaunchEvent_Full()
        launchEventFull.Init(buf, pos)
        return cls.InitFromObj(launchEventFull)
    ...
    @classmethod
    def InitFromObj(cls, launchEventFull):
        x = LaunchEvent_FullT()
        x._UnPack(launchEventFull)
        return x

    # LaunchEvent_FullT
    def _UnPack(self, launchEventFull):
        if launchEventFull is None:
            return
        self.id = launchEventFull.Id()
        self.idOnOrbit = launchEventFull.IdOnOrbit()
        self.origObjectId = launchEventFull.OrigObjectId()
        self.classificationMarking = launchEventFull.ClassificationMarking()
        self.derivedFrom = launchEventFull.DerivedFrom()
        self.declassificationDate = launchEventFull.DeclassificationDate()
        self.declassificationString = launchEventFull.DeclassificationString()
        self.msgCreateDate = launchEventFull.MsgCreateDate()
        self.launchFailureCode = launchEventFull.LaunchFailureCode()
        self.launchDate = launchEventFull.LaunchDate()
        self.beNumber = launchEventFull.BeNumber()
        self.oSuffix = launchEventFull.OSuffix()
        self.launchFacilityName = launchEventFull.LaunchFacilityName()
        self.createdAt = launchEventFull.CreatedAt()
        self.createdBy = launchEventFull.CreatedBy()
        self.origin = launchEventFull.Origin()
        self.source = launchEventFull.Source()
        self.dataMode = launchEventFull.DataMode()
        self.origNetwork = launchEventFull.OrigNetwork()
        self.onOrbit = launchEventFull.OnOrbit()
        self.satNo = launchEventFull.SatNo()
    ...
    def Pack(self, builder):
        ...
        if self.source is not None:
            LaunchEvent_FullAddSource(builder, source)
        LaunchEvent_FullAddDataMode(builder, self.dataMode)
        if self.origNetwork is not None:
            LaunchEvent_FullAddOrigNetwork(builder, origNetwork)
        if self.onOrbit is not None:
            LaunchEvent_FullAddOnOrbit(builder, onOrbit)
        LaunchEvent_FullAddSatNo(builder, self.satNo)
        launchEventFull = LaunchEvent_FullEnd(builder)
        return launchEventFull
