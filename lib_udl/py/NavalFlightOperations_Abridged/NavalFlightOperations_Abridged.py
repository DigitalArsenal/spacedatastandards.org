...
class NavalFlightOperations_Abridged(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsNavalFlightOperations_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def NavalFlightOperations_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def NavalFlightOperations_AbridgedStart(builder):
    builder.StartObject(4)

def Start(builder):
    NavalFlightOperations_AbridgedStart(builder)

def NavalFlightOperations_AbridgedAddShipName(builder, shipName):
...
def AddShipName(builder, shipName):
    NavalFlightOperations_AbridgedAddShipName(builder, shipName)

def NavalFlightOperations_AbridgedAddFltOpStart(builder, fltOpStart):
...
def AddFltOpStart(builder, fltOpStart):
    NavalFlightOperations_AbridgedAddFltOpStart(builder, fltOpStart)

def NavalFlightOperations_AbridgedAddFltOpStop(builder, fltOpStop):
...
def AddFltOpStop(builder, fltOpStop):
    NavalFlightOperations_AbridgedAddFltOpStop(builder, fltOpStop)

def NavalFlightOperations_AbridgedAddSchdLaunchRcvyTime(builder, schdLaunchRcvyTime):
...
def AddSchdLaunchRcvyTime(builder, schdLaunchRcvyTime):
    NavalFlightOperations_AbridgedAddSchdLaunchRcvyTime(builder, schdLaunchRcvyTime)

def NavalFlightOperations_AbridgedStartSchdLaunchRcvyTimeVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartSchdLaunchRcvyTimeVector(builder, numElems):
    return NavalFlightOperations_AbridgedStartSchdLaunchRcvyTimeVector(builder, numElems)

def NavalFlightOperations_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return NavalFlightOperations_AbridgedEnd(builder)
...
class NavalFlightOperations_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        navalFlightOperationsAbridged = NavalFlightOperations_Abridged()
        navalFlightOperationsAbridged.Init(buf, pos)
        return cls.InitFromObj(navalFlightOperationsAbridged)
    ...
    @classmethod
    def InitFromObj(cls, navalFlightOperationsAbridged):
        x = NavalFlightOperations_AbridgedT()
        x._UnPack(navalFlightOperationsAbridged)
        return x

    # NavalFlightOperations_AbridgedT
    def _UnPack(self, navalFlightOperationsAbridged):
        if navalFlightOperationsAbridged is None:
            return
        self.shipName = navalFlightOperationsAbridged.ShipName()
        self.fltOpStart = navalFlightOperationsAbridged.FltOpStart()
        self.fltOpStop = navalFlightOperationsAbridged.FltOpStop()
        if not navalFlightOperationsAbridged.SchdLaunchRcvyTimeIsNone():
            self.schdLaunchRcvyTime = []
            for i in range(navalFlightOperationsAbridged.SchdLaunchRcvyTimeLength()):
                self.schdLaunchRcvyTime.append(navalFlightOperationsAbridged.SchdLaunchRcvyTime(i))
    ...
    def Pack(self, builder):
        ...
        if self.schdLaunchRcvyTime is not None:
            ...
            NavalFlightOperations_AbridgedStartSchdLaunchRcvyTimeVector(builder, len(self.schdLaunchRcvyTime))
        ...
        if self.schdLaunchRcvyTime is not None:
            NavalFlightOperations_AbridgedAddSchdLaunchRcvyTime(builder, schdLaunchRcvyTime)
        navalFlightOperationsAbridged = NavalFlightOperations_AbridgedEnd(builder)
        return navalFlightOperationsAbridged
