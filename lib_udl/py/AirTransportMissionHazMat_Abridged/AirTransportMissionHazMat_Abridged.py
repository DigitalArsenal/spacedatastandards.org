...
class AirTransportMissionHazMat_Abridged(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsAirTransportMissionHazMat_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def AirTransportMissionHazMat_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def AirTransportMissionHazMat_AbridgedStart(builder):
    builder.StartObject(15)

def Start(builder):
    AirTransportMissionHazMat_AbridgedStart(builder)

def AirTransportMissionHazMat_AbridgedAddExtHazMatId(builder, extHazMatId):
...
def AddExtHazMatId(builder, extHazMatId):
    AirTransportMissionHazMat_AbridgedAddExtHazMatId(builder, extHazMatId)

def AirTransportMissionHazMat_AbridgedAddItemName(builder, itemName):
...
def AddItemName(builder, itemName):
    AirTransportMissionHazMat_AbridgedAddItemName(builder, itemName)

def AirTransportMissionHazMat_AbridgedAddUnNum(builder, unNum):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(unNum), 0)

def AddUnNum(builder, unNum):
    AirTransportMissionHazMat_AbridgedAddUnNum(builder, unNum)

def AirTransportMissionHazMat_AbridgedAddPieces(builder, pieces):
    builder.PrependInt32Slot(3, pieces, 0)

def AddPieces(builder, pieces):
    AirTransportMissionHazMat_AbridgedAddPieces(builder, pieces)

def AirTransportMissionHazMat_AbridgedAddWeight(builder, weight):
    builder.PrependFloat64Slot(4, weight, 0.0)

def AddWeight(builder, weight):
    AirTransportMissionHazMat_AbridgedAddWeight(builder, weight)

def AirTransportMissionHazMat_AbridgedAddNetExpWt(builder, netExpWt):
    builder.PrependFloat64Slot(5, netExpWt, 0.0)

def AddNetExpWt(builder, netExpWt):
    AirTransportMissionHazMat_AbridgedAddNetExpWt(builder, netExpWt)

def AirTransportMissionHazMat_AbridgedAddClassDiv(builder, classDiv):
    builder.PrependFloat64Slot(6, classDiv, 0.0)

def AddClassDiv(builder, classDiv):
    AirTransportMissionHazMat_AbridgedAddClassDiv(builder, classDiv)

def AirTransportMissionHazMat_AbridgedAddCgc(builder, cgc):
    builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(cgc), 0)

def AddCgc(builder, cgc):
    AirTransportMissionHazMat_AbridgedAddCgc(builder, cgc)

def AirTransportMissionHazMat_AbridgedAddCgn(builder, cgn):
    builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(cgn), 0)

def AddCgn(builder, cgn):
    AirTransportMissionHazMat_AbridgedAddCgn(builder, cgn)

def AirTransportMissionHazMat_AbridgedAddApplicableNotes(builder, applicableNotes):
...
def AddApplicableNotes(builder, applicableNotes):
    AirTransportMissionHazMat_AbridgedAddApplicableNotes(builder, applicableNotes)

def AirTransportMissionHazMat_AbridgedAddOnItin(builder, onItin):
    builder.PrependInt32Slot(10, onItin, 0)

def AddOnItin(builder, onItin):
    AirTransportMissionHazMat_AbridgedAddOnItin(builder, onItin)

def AirTransportMissionHazMat_AbridgedAddOnIcao(builder, onIcao):
...
def AddOnIcao(builder, onIcao):
    AirTransportMissionHazMat_AbridgedAddOnIcao(builder, onIcao)

def AirTransportMissionHazMat_AbridgedAddOffItin(builder, offItin):
    builder.PrependInt32Slot(12, offItin, 0)

def AddOffItin(builder, offItin):
    AirTransportMissionHazMat_AbridgedAddOffItin(builder, offItin)

def AirTransportMissionHazMat_AbridgedAddOffIcao(builder, offIcao):
...
def AddOffIcao(builder, offIcao):
    AirTransportMissionHazMat_AbridgedAddOffIcao(builder, offIcao)

def AirTransportMissionHazMat_AbridgedAddPlanned(builder, planned):
...
def AddPlanned(builder, planned):
    AirTransportMissionHazMat_AbridgedAddPlanned(builder, planned)

def AirTransportMissionHazMat_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return AirTransportMissionHazMat_AbridgedEnd(builder)


class AirTransportMissionHazMat_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        airTransportMissionHazMatAbridged = AirTransportMissionHazMat_Abridged()
        airTransportMissionHazMatAbridged.Init(buf, pos)
        return cls.InitFromObj(airTransportMissionHazMatAbridged)
    ...
    @classmethod
    def InitFromObj(cls, airTransportMissionHazMatAbridged):
        x = AirTransportMissionHazMat_AbridgedT()
        x._UnPack(airTransportMissionHazMatAbridged)
        return x

    # AirTransportMissionHazMat_AbridgedT
    def _UnPack(self, airTransportMissionHazMatAbridged):
        if airTransportMissionHazMatAbridged is None:
            return
        self.extHazMatId = airTransportMissionHazMatAbridged.ExtHazMatId()
        self.itemName = airTransportMissionHazMatAbridged.ItemName()
        self.unNum = airTransportMissionHazMatAbridged.UnNum()
        self.pieces = airTransportMissionHazMatAbridged.Pieces()
        self.weight = airTransportMissionHazMatAbridged.Weight()
        self.netExpWt = airTransportMissionHazMatAbridged.NetExpWt()
        self.classDiv = airTransportMissionHazMatAbridged.ClassDiv()
        self.cgc = airTransportMissionHazMatAbridged.Cgc()
        self.cgn = airTransportMissionHazMatAbridged.Cgn()
        self.applicableNotes = airTransportMissionHazMatAbridged.ApplicableNotes()
        self.onItin = airTransportMissionHazMatAbridged.OnItin()
        self.onIcao = airTransportMissionHazMatAbridged.OnIcao()
        self.offItin = airTransportMissionHazMatAbridged.OffItin()
        self.offIcao = airTransportMissionHazMatAbridged.OffIcao()
        self.planned = airTransportMissionHazMatAbridged.Planned()
    ...
    def Pack(self, builder):
        ...
        if self.unNum is not None:
            AirTransportMissionHazMat_AbridgedAddUnNum(builder, unNum)
        AirTransportMissionHazMat_AbridgedAddPieces(builder, self.pieces)
        AirTransportMissionHazMat_AbridgedAddWeight(builder, self.weight)
        AirTransportMissionHazMat_AbridgedAddNetExpWt(builder, self.netExpWt)
        AirTransportMissionHazMat_AbridgedAddClassDiv(builder, self.classDiv)
        if self.cgc is not None:
            AirTransportMissionHazMat_AbridgedAddCgc(builder, cgc)
        if self.cgn is not None:
            AirTransportMissionHazMat_AbridgedAddCgn(builder, cgn)
        if self.applicableNotes is not None:
            AirTransportMissionHazMat_AbridgedAddApplicableNotes(builder, applicableNotes)
        AirTransportMissionHazMat_AbridgedAddOnItin(builder, self.onItin)
        if self.onIcao is not None:
            AirTransportMissionHazMat_AbridgedAddOnIcao(builder, onIcao)
        AirTransportMissionHazMat_AbridgedAddOffItin(builder, self.offItin)
        if self.offIcao is not None:
            AirTransportMissionHazMat_AbridgedAddOffIcao(builder, offIcao)
        if self.planned is not None:
            AirTransportMissionHazMat_AbridgedAddPlanned(builder, planned)
        airTransportMissionHazMatAbridged = AirTransportMissionHazMat_AbridgedEnd(builder)
        return airTransportMissionHazMatAbridged
