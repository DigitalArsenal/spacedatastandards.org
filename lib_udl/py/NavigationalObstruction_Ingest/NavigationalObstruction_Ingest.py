...
class NavigationalObstruction_Ingest(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsNavigationalObstruction_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def NavigationalObstruction_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def NavigationalObstruction_IngestStart(builder):
    builder.StartObject(77)

def Start(builder):
    NavigationalObstruction_IngestStart(builder)

def NavigationalObstruction_IngestAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    NavigationalObstruction_IngestAddId(builder, id)

def NavigationalObstruction_IngestAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    NavigationalObstruction_IngestAddClassificationMarking(builder, classificationMarking)

def NavigationalObstruction_IngestAddCycleDate(builder, cycleDate):
...
def AddCycleDate(builder, cycleDate):
    NavigationalObstruction_IngestAddCycleDate(builder, cycleDate)

def NavigationalObstruction_IngestAddObstacleType(builder, obstacleType):
...
def AddObstacleType(builder, obstacleType):
    NavigationalObstruction_IngestAddObstacleType(builder, obstacleType)

def NavigationalObstruction_IngestAddObstacleId(builder, obstacleId):
...
def AddObstacleId(builder, obstacleId):
    NavigationalObstruction_IngestAddObstacleId(builder, obstacleId)

def NavigationalObstruction_IngestAddExternalId(builder, externalId):
...
def AddExternalId(builder, externalId):
    NavigationalObstruction_IngestAddExternalId(builder, externalId)

def NavigationalObstruction_IngestAddOrigId(builder, origId):
...
def AddOrigId(builder, origId):
    NavigationalObstruction_IngestAddOrigId(builder, origId)

def NavigationalObstruction_IngestAddCountryCode(builder, countryCode):
...
def AddCountryCode(builder, countryCode):
    NavigationalObstruction_IngestAddCountryCode(builder, countryCode)

def NavigationalObstruction_IngestAddProvinceCode(builder, provinceCode):
...
def AddProvinceCode(builder, provinceCode):
    NavigationalObstruction_IngestAddProvinceCode(builder, provinceCode)

def NavigationalObstruction_IngestAddPointLat(builder, pointLat):
    builder.PrependFloat64Slot(9, pointLat, 0.0)

def AddPointLat(builder, pointLat):
    NavigationalObstruction_IngestAddPointLat(builder, pointLat)

def NavigationalObstruction_IngestAddPointLon(builder, pointLon):
    builder.PrependFloat64Slot(10, pointLon, 0.0)

def AddPointLon(builder, pointLon):
    NavigationalObstruction_IngestAddPointLon(builder, pointLon)

def NavigationalObstruction_IngestAddLineNelon(builder, lineNelon):
    builder.PrependFloat64Slot(11, lineNelon, 0.0)

def AddLineNelon(builder, lineNelon):
    NavigationalObstruction_IngestAddLineNelon(builder, lineNelon)

def NavigationalObstruction_IngestAddLineNelat(builder, lineNelat):
    builder.PrependFloat64Slot(12, lineNelat, 0.0)

def AddLineNelat(builder, lineNelat):
    NavigationalObstruction_IngestAddLineNelat(builder, lineNelat)

def NavigationalObstruction_IngestAddLineSwlon(builder, lineSwlon):
    builder.PrependFloat64Slot(13, lineSwlon, 0.0)

def AddLineSwlon(builder, lineSwlon):
    NavigationalObstruction_IngestAddLineSwlon(builder, lineSwlon)

def NavigationalObstruction_IngestAddLineSwlat(builder, lineSwlat):
    builder.PrependFloat64Slot(14, lineSwlat, 0.0)

def AddLineSwlat(builder, lineSwlat):
    NavigationalObstruction_IngestAddLineSwlat(builder, lineSwlat)

def NavigationalObstruction_IngestAddSegStartPoint(builder, segStartPoint):
    builder.PrependInt32Slot(15, segStartPoint, 0)

def AddSegStartPoint(builder, segStartPoint):
    NavigationalObstruction_IngestAddSegStartPoint(builder, segStartPoint)

def NavigationalObstruction_IngestAddSegEndPoint(builder, segEndPoint):
    builder.PrependInt32Slot(16, segEndPoint, 0)

def AddSegEndPoint(builder, segEndPoint):
    NavigationalObstruction_IngestAddSegEndPoint(builder, segEndPoint)

def NavigationalObstruction_IngestAddSegNum(builder, segNum):
    builder.PrependInt32Slot(17, segNum, 0)

def AddSegNum(builder, segNum):
    NavigationalObstruction_IngestAddSegNum(builder, segNum)

def NavigationalObstruction_IngestAddFacc(builder, facc):
    builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(facc), 0)

def AddFacc(builder, facc):
    NavigationalObstruction_IngestAddFacc(builder, facc)

def NavigationalObstruction_IngestAddFeatureCode(builder, featureCode):
...
def AddFeatureCode(builder, featureCode):
    NavigationalObstruction_IngestAddFeatureCode(builder, featureCode)

def NavigationalObstruction_IngestAddFeatureType(builder, featureType):
...
def AddFeatureType(builder, featureType):
    NavigationalObstruction_IngestAddFeatureType(builder, featureType)

def NavigationalObstruction_IngestAddFeatureName(builder, featureName):
...
def AddFeatureName(builder, featureName):
    NavigationalObstruction_IngestAddFeatureName(builder, featureName)

def NavigationalObstruction_IngestAddFeatureDescription(builder, featureDescription):
...
def AddFeatureDescription(builder, featureDescription):
    NavigationalObstruction_IngestAddFeatureDescription(builder, featureDescription)

def NavigationalObstruction_IngestAddWac(builder, wac):
    builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(wac), 0)

def AddWac(builder, wac):
    NavigationalObstruction_IngestAddWac(builder, wac)

def NavigationalObstruction_IngestAddWacInnr(builder, wacInnr):
...
def AddWacInnr(builder, wacInnr):
    NavigationalObstruction_IngestAddWacInnr(builder, wacInnr)

def NavigationalObstruction_IngestAddMultObs(builder, multObs):
...
def AddMultObs(builder, multObs):
    NavigationalObstruction_IngestAddMultObs(builder, multObs)

def NavigationalObstruction_IngestAddNumObs(builder, numObs):
    builder.PrependInt32Slot(26, numObs, 0)

def AddNumObs(builder, numObs):
    NavigationalObstruction_IngestAddNumObs(builder, numObs)

def NavigationalObstruction_IngestAddHorizDatumCode(builder, horizDatumCode):
...
def AddHorizDatumCode(builder, horizDatumCode):
    NavigationalObstruction_IngestAddHorizDatumCode(builder, horizDatumCode)

def NavigationalObstruction_IngestAddHeightAgl(builder, heightAgl):
    builder.PrependFloat64Slot(28, heightAgl, 0.0)

def AddHeightAgl(builder, heightAgl):
    NavigationalObstruction_IngestAddHeightAgl(builder, heightAgl)

def NavigationalObstruction_IngestAddHeightAglacc(builder, heightAglacc):
    builder.PrependFloat64Slot(29, heightAglacc, 0.0)

def AddHeightAglacc(builder, heightAglacc):
    NavigationalObstruction_IngestAddHeightAglacc(builder, heightAglacc)

def NavigationalObstruction_IngestAddHeightMsl(builder, heightMsl):
    builder.PrependFloat64Slot(30, heightMsl, 0.0)

def AddHeightMsl(builder, heightMsl):
    NavigationalObstruction_IngestAddHeightMsl(builder, heightMsl)

def NavigationalObstruction_IngestAddHeightMslacc(builder, heightMslacc):
    builder.PrependFloat64Slot(31, heightMslacc, 0.0)

def AddHeightMslacc(builder, heightMslacc):
    NavigationalObstruction_IngestAddHeightMslacc(builder, heightMslacc)

def NavigationalObstruction_IngestAddElevation(builder, elevation):
    builder.PrependFloat64Slot(32, elevation, 0.0)

def AddElevation(builder, elevation):
    NavigationalObstruction_IngestAddElevation(builder, elevation)

def NavigationalObstruction_IngestAddElevationAcc(builder, elevationAcc):
    builder.PrependFloat64Slot(33, elevationAcc, 0.0)

def AddElevationAcc(builder, elevationAcc):
    NavigationalObstruction_IngestAddElevationAcc(builder, elevationAcc)

def NavigationalObstruction_IngestAddHorizAcc(builder, horizAcc):
    builder.PrependFloat64Slot(34, horizAcc, 0.0)

def AddHorizAcc(builder, horizAcc):
    NavigationalObstruction_IngestAddHorizAcc(builder, horizAcc)

def NavigationalObstruction_IngestAddQuality(builder, quality):
...
def AddQuality(builder, quality):
    NavigationalObstruction_IngestAddQuality(builder, quality)

def NavigationalObstruction_IngestAddLightingCode(builder, lightingCode):
...
def AddLightingCode(builder, lightingCode):
    NavigationalObstruction_IngestAddLightingCode(builder, lightingCode)

def NavigationalObstruction_IngestAddSurfaceMatCode(builder, surfaceMatCode):
...
def AddSurfaceMatCode(builder, surfaceMatCode):
    NavigationalObstruction_IngestAddSurfaceMatCode(builder, surfaceMatCode)

def NavigationalObstruction_IngestAddDirectivityCode(builder, directivityCode):
    builder.PrependInt32Slot(38, directivityCode, 0)

def AddDirectivityCode(builder, directivityCode):
    NavigationalObstruction_IngestAddDirectivityCode(builder, directivityCode)

def NavigationalObstruction_IngestAddValidationCode(builder, validationCode):
    builder.PrependInt32Slot(39, validationCode, 0)

def AddValidationCode(builder, validationCode):
    NavigationalObstruction_IngestAddValidationCode(builder, validationCode)

def NavigationalObstruction_IngestAddTransactionCode(builder, transactionCode):
...
def AddTransactionCode(builder, transactionCode):
    NavigationalObstruction_IngestAddTransactionCode(builder, transactionCode)

def NavigationalObstruction_IngestAddProcessCode(builder, processCode):
...
def AddProcessCode(builder, processCode):
    NavigationalObstruction_IngestAddProcessCode(builder, processCode)

def NavigationalObstruction_IngestAddActDelCode(builder, actDelCode):
...
def AddActDelCode(builder, actDelCode):
    NavigationalObstruction_IngestAddActDelCode(builder, actDelCode)

def NavigationalObstruction_IngestAddProducer(builder, producer):
...
def AddProducer(builder, producer):
    NavigationalObstruction_IngestAddProducer(builder, producer)

def NavigationalObstruction_IngestAddDerivingOrg(builder, derivingOrg):
...
def AddDerivingOrg(builder, derivingOrg):
    NavigationalObstruction_IngestAddDerivingOrg(builder, derivingOrg)

def NavigationalObstruction_IngestAddDeletingOrg(builder, deletingOrg):
...
def AddDeletingOrg(builder, deletingOrg):
    NavigationalObstruction_IngestAddDeletingOrg(builder, deletingOrg)

def NavigationalObstruction_IngestAddSourceDate(builder, sourceDate):
...
def AddSourceDate(builder, sourceDate):
    NavigationalObstruction_IngestAddSourceDate(builder, sourceDate)

def NavigationalObstruction_IngestAddRevDate(builder, revDate):
...
def AddRevDate(builder, revDate):
    NavigationalObstruction_IngestAddRevDate(builder, revDate)

def NavigationalObstruction_IngestAddInitRecordDate(builder, initRecordDate):
...
def AddInitRecordDate(builder, initRecordDate):
    NavigationalObstruction_IngestAddInitRecordDate(builder, initRecordDate)

def NavigationalObstruction_IngestAddKeys(builder, keys):
    builder.PrependUOffsetTRelativeSlot(49, flatbuffers.number_types.UOffsetTFlags.py_type(keys), 0)

def AddKeys(builder, keys):
    NavigationalObstruction_IngestAddKeys(builder, keys)

def NavigationalObstruction_IngestStartKeysVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartKeysVector(builder, numElems):
    return NavigationalObstruction_IngestStartKeysVector(builder, numElems)

def NavigationalObstruction_IngestAddValues(builder, values):
    builder.PrependUOffsetTRelativeSlot(50, flatbuffers.number_types.UOffsetTFlags.py_type(values), 0)

def AddValues(builder, values):
    NavigationalObstruction_IngestAddValues(builder, values)

def NavigationalObstruction_IngestStartValuesVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartValuesVector(builder, numElems):
    return NavigationalObstruction_IngestStartValuesVector(builder, numElems)

def NavigationalObstruction_IngestAddObstacleRemarks(builder, obstacleRemarks):
...
def AddObstacleRemarks(builder, obstacleRemarks):
    NavigationalObstruction_IngestAddObstacleRemarks(builder, obstacleRemarks)

def NavigationalObstruction_IngestAddNextCycleDate(builder, nextCycleDate):
...
def AddNextCycleDate(builder, nextCycleDate):
    NavigationalObstruction_IngestAddNextCycleDate(builder, nextCycleDate)

def NavigationalObstruction_IngestAddBaselineCutoffDate(builder, baselineCutoffDate):
...
def AddBaselineCutoffDate(builder, baselineCutoffDate):
    NavigationalObstruction_IngestAddBaselineCutoffDate(builder, baselineCutoffDate)

def NavigationalObstruction_IngestAddCutoffDate(builder, cutoffDate):
...
def AddCutoffDate(builder, cutoffDate):
    NavigationalObstruction_IngestAddCutoffDate(builder, cutoffDate)

def NavigationalObstruction_IngestAddAiracCycle(builder, airacCycle):
    builder.PrependInt32Slot(55, airacCycle, 0)

def AddAiracCycle(builder, airacCycle):
    NavigationalObstruction_IngestAddAiracCycle(builder, airacCycle)

def NavigationalObstruction_IngestAddBaseAiracCycle(builder, baseAiracCycle):
    builder.PrependInt32Slot(56, baseAiracCycle, 0)

def AddBaseAiracCycle(builder, baseAiracCycle):
    NavigationalObstruction_IngestAddBaseAiracCycle(builder, baseAiracCycle)

def NavigationalObstruction_IngestAddOwnerCountryCode(builder, ownerCountryCode):
...
def AddOwnerCountryCode(builder, ownerCountryCode):
    NavigationalObstruction_IngestAddOwnerCountryCode(builder, ownerCountryCode)

def NavigationalObstruction_IngestAddBoundNelon(builder, boundNelon):
    builder.PrependFloat64Slot(58, boundNelon, 0.0)

def AddBoundNelon(builder, boundNelon):
    NavigationalObstruction_IngestAddBoundNelon(builder, boundNelon)

def NavigationalObstruction_IngestAddBoundNelat(builder, boundNelat):
    builder.PrependFloat64Slot(59, boundNelat, 0.0)

def AddBoundNelat(builder, boundNelat):
    NavigationalObstruction_IngestAddBoundNelat(builder, boundNelat)

def NavigationalObstruction_IngestAddBoundSwlon(builder, boundSwlon):
    builder.PrependFloat64Slot(60, boundSwlon, 0.0)

def AddBoundSwlon(builder, boundSwlon):
    NavigationalObstruction_IngestAddBoundSwlon(builder, boundSwlon)

def NavigationalObstruction_IngestAddBoundSwlat(builder, boundSwlat):
    builder.PrependFloat64Slot(61, boundSwlat, 0.0)

def AddBoundSwlat(builder, boundSwlat):
    NavigationalObstruction_IngestAddBoundSwlat(builder, boundSwlat)

def NavigationalObstruction_IngestAddMinHeightAgl(builder, minHeightAgl):
    builder.PrependFloat64Slot(62, minHeightAgl, 0.0)

def AddMinHeightAgl(builder, minHeightAgl):
    NavigationalObstruction_IngestAddMinHeightAgl(builder, minHeightAgl)

def NavigationalObstruction_IngestAddNumPoints(builder, numPoints):
    builder.PrependInt32Slot(63, numPoints, 0)

def AddNumPoints(builder, numPoints):
    NavigationalObstruction_IngestAddNumPoints(builder, numPoints)

def NavigationalObstruction_IngestAddNumLines(builder, numLines):
    builder.PrependInt32Slot(64, numLines, 0)

def AddNumLines(builder, numLines):
    NavigationalObstruction_IngestAddNumLines(builder, numLines)

def NavigationalObstruction_IngestAddDataSetRemarks(builder, dataSetRemarks):
...
def AddDataSetRemarks(builder, dataSetRemarks):
    NavigationalObstruction_IngestAddDataSetRemarks(builder, dataSetRemarks)

def NavigationalObstruction_IngestAddPointsFilename(builder, pointsFilename):
...
def AddPointsFilename(builder, pointsFilename):
    NavigationalObstruction_IngestAddPointsFilename(builder, pointsFilename)

def NavigationalObstruction_IngestAddLinesFilename(builder, linesFilename):
...
def AddLinesFilename(builder, linesFilename):
    NavigationalObstruction_IngestAddLinesFilename(builder, linesFilename)

def NavigationalObstruction_IngestAddVectorsFilename(builder, vectorsFilename):
...
def AddVectorsFilename(builder, vectorsFilename):
    NavigationalObstruction_IngestAddVectorsFilename(builder, vectorsFilename)

def NavigationalObstruction_IngestAddRawFileUri(builder, rawFileUri):
...
def AddRawFileUri(builder, rawFileUri):
    NavigationalObstruction_IngestAddRawFileUri(builder, rawFileUri)

def NavigationalObstruction_IngestAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(70, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    NavigationalObstruction_IngestAddCreatedAt(builder, createdAt)

def NavigationalObstruction_IngestAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(71, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    NavigationalObstruction_IngestAddCreatedBy(builder, createdBy)

def NavigationalObstruction_IngestAddSourceDl(builder, sourceDl):
...
def AddSourceDl(builder, sourceDl):
    NavigationalObstruction_IngestAddSourceDl(builder, sourceDl)

def NavigationalObstruction_IngestAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(73, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    NavigationalObstruction_IngestAddSource(builder, source)

def NavigationalObstruction_IngestAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(74, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    NavigationalObstruction_IngestAddOrigin(builder, origin)

def NavigationalObstruction_IngestAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(75, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    NavigationalObstruction_IngestAddOrigNetwork(builder, origNetwork)

def NavigationalObstruction_IngestAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(76, dataMode, 0)

def AddDataMode(builder, dataMode):
    NavigationalObstruction_IngestAddDataMode(builder, dataMode)

def NavigationalObstruction_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return NavigationalObstruction_IngestEnd(builder)
...
class NavigationalObstruction_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        navigationalObstructionIngest = NavigationalObstruction_Ingest()
        navigationalObstructionIngest.Init(buf, pos)
        return cls.InitFromObj(navigationalObstructionIngest)
    ...
    @classmethod
    def InitFromObj(cls, navigationalObstructionIngest):
        x = NavigationalObstruction_IngestT()
        x._UnPack(navigationalObstructionIngest)
        return x

    # NavigationalObstruction_IngestT
    def _UnPack(self, navigationalObstructionIngest):
        if navigationalObstructionIngest is None:
            return
        self.id = navigationalObstructionIngest.Id()
        self.classificationMarking = navigationalObstructionIngest.ClassificationMarking()
        self.cycleDate = navigationalObstructionIngest.CycleDate()
        self.obstacleType = navigationalObstructionIngest.ObstacleType()
        self.obstacleId = navigationalObstructionIngest.ObstacleId()
        self.externalId = navigationalObstructionIngest.ExternalId()
        self.origId = navigationalObstructionIngest.OrigId()
        self.countryCode = navigationalObstructionIngest.CountryCode()
        self.provinceCode = navigationalObstructionIngest.ProvinceCode()
        self.pointLat = navigationalObstructionIngest.PointLat()
        self.pointLon = navigationalObstructionIngest.PointLon()
        self.lineNelon = navigationalObstructionIngest.LineNelon()
        self.lineNelat = navigationalObstructionIngest.LineNelat()
        self.lineSwlon = navigationalObstructionIngest.LineSwlon()
        self.lineSwlat = navigationalObstructionIngest.LineSwlat()
        self.segStartPoint = navigationalObstructionIngest.SegStartPoint()
        self.segEndPoint = navigationalObstructionIngest.SegEndPoint()
        self.segNum = navigationalObstructionIngest.SegNum()
        self.facc = navigationalObstructionIngest.Facc()
        self.featureCode = navigationalObstructionIngest.FeatureCode()
        self.featureType = navigationalObstructionIngest.FeatureType()
        self.featureName = navigationalObstructionIngest.FeatureName()
        self.featureDescription = navigationalObstructionIngest.FeatureDescription()
        self.wac = navigationalObstructionIngest.Wac()
        self.wacInnr = navigationalObstructionIngest.WacInnr()
        self.multObs = navigationalObstructionIngest.MultObs()
        self.numObs = navigationalObstructionIngest.NumObs()
        self.horizDatumCode = navigationalObstructionIngest.HorizDatumCode()
        self.heightAgl = navigationalObstructionIngest.HeightAgl()
        self.heightAglacc = navigationalObstructionIngest.HeightAglacc()
        self.heightMsl = navigationalObstructionIngest.HeightMsl()
        self.heightMslacc = navigationalObstructionIngest.HeightMslacc()
        self.elevation = navigationalObstructionIngest.Elevation()
        self.elevationAcc = navigationalObstructionIngest.ElevationAcc()
        self.horizAcc = navigationalObstructionIngest.HorizAcc()
        self.quality = navigationalObstructionIngest.Quality()
        self.lightingCode = navigationalObstructionIngest.LightingCode()
        self.surfaceMatCode = navigationalObstructionIngest.SurfaceMatCode()
        self.directivityCode = navigationalObstructionIngest.DirectivityCode()
        self.validationCode = navigationalObstructionIngest.ValidationCode()
        self.transactionCode = navigationalObstructionIngest.TransactionCode()
        self.processCode = navigationalObstructionIngest.ProcessCode()
        self.actDelCode = navigationalObstructionIngest.ActDelCode()
        self.producer = navigationalObstructionIngest.Producer()
        self.derivingOrg = navigationalObstructionIngest.DerivingOrg()
        self.deletingOrg = navigationalObstructionIngest.DeletingOrg()
        self.sourceDate = navigationalObstructionIngest.SourceDate()
        self.revDate = navigationalObstructionIngest.RevDate()
        self.initRecordDate = navigationalObstructionIngest.InitRecordDate()
        if not navigationalObstructionIngest.KeysIsNone():
            self.keys = []
            for i in range(navigationalObstructionIngest.KeysLength()):
                self.keys.append(navigationalObstructionIngest.Keys(i))
        if not navigationalObstructionIngest.ValuesIsNone():
            self.values = []
            for i in range(navigationalObstructionIngest.ValuesLength()):
                self.values.append(navigationalObstructionIngest.Values(i))
        self.obstacleRemarks = navigationalObstructionIngest.ObstacleRemarks()
        self.nextCycleDate = navigationalObstructionIngest.NextCycleDate()
        self.baselineCutoffDate = navigationalObstructionIngest.BaselineCutoffDate()
        self.cutoffDate = navigationalObstructionIngest.CutoffDate()
        self.airacCycle = navigationalObstructionIngest.AiracCycle()
        self.baseAiracCycle = navigationalObstructionIngest.BaseAiracCycle()
        self.ownerCountryCode = navigationalObstructionIngest.OwnerCountryCode()
        self.boundNelon = navigationalObstructionIngest.BoundNelon()
        self.boundNelat = navigationalObstructionIngest.BoundNelat()
        self.boundSwlon = navigationalObstructionIngest.BoundSwlon()
        self.boundSwlat = navigationalObstructionIngest.BoundSwlat()
        self.minHeightAgl = navigationalObstructionIngest.MinHeightAgl()
        self.numPoints = navigationalObstructionIngest.NumPoints()
        self.numLines = navigationalObstructionIngest.NumLines()
        self.dataSetRemarks = navigationalObstructionIngest.DataSetRemarks()
        self.pointsFilename = navigationalObstructionIngest.PointsFilename()
        self.linesFilename = navigationalObstructionIngest.LinesFilename()
        self.vectorsFilename = navigationalObstructionIngest.VectorsFilename()
        self.rawFileUri = navigationalObstructionIngest.RawFileUri()
        self.createdAt = navigationalObstructionIngest.CreatedAt()
        self.createdBy = navigationalObstructionIngest.CreatedBy()
        self.sourceDl = navigationalObstructionIngest.SourceDl()
        self.source = navigationalObstructionIngest.Source()
        self.origin = navigationalObstructionIngest.Origin()
        self.origNetwork = navigationalObstructionIngest.OrigNetwork()
        self.dataMode = navigationalObstructionIngest.DataMode()
    ...
    def Pack(self, builder):
        ...
        if self.keys is not None:
            ...
            NavigationalObstruction_IngestStartKeysVector(builder, len(self.keys))
        ...
        if self.values is not None:
            ...
            NavigationalObstruction_IngestStartValuesVector(builder, len(self.values))
        ...
        if self.provinceCode is not None:
            NavigationalObstruction_IngestAddProvinceCode(builder, provinceCode)
        NavigationalObstruction_IngestAddPointLat(builder, self.pointLat)
        NavigationalObstruction_IngestAddPointLon(builder, self.pointLon)
        NavigationalObstruction_IngestAddLineNelon(builder, self.lineNelon)
        NavigationalObstruction_IngestAddLineNelat(builder, self.lineNelat)
        NavigationalObstruction_IngestAddLineSwlon(builder, self.lineSwlon)
        NavigationalObstruction_IngestAddLineSwlat(builder, self.lineSwlat)
        NavigationalObstruction_IngestAddSegStartPoint(builder, self.segStartPoint)
        NavigationalObstruction_IngestAddSegEndPoint(builder, self.segEndPoint)
        NavigationalObstruction_IngestAddSegNum(builder, self.segNum)
        if self.facc is not None:
            NavigationalObstruction_IngestAddFacc(builder, facc)
        if self.featureCode is not None:
            NavigationalObstruction_IngestAddFeatureCode(builder, featureCode)
        ...
        if self.multObs is not None:
            NavigationalObstruction_IngestAddMultObs(builder, multObs)
        NavigationalObstruction_IngestAddNumObs(builder, self.numObs)
        if self.horizDatumCode is not None:
            NavigationalObstruction_IngestAddHorizDatumCode(builder, horizDatumCode)
        NavigationalObstruction_IngestAddHeightAgl(builder, self.heightAgl)
        NavigationalObstruction_IngestAddHeightAglacc(builder, self.heightAglacc)
        NavigationalObstruction_IngestAddHeightMsl(builder, self.heightMsl)
        NavigationalObstruction_IngestAddHeightMslacc(builder, self.heightMslacc)
        NavigationalObstruction_IngestAddElevation(builder, self.elevation)
        NavigationalObstruction_IngestAddElevationAcc(builder, self.elevationAcc)
        NavigationalObstruction_IngestAddHorizAcc(builder, self.horizAcc)
        if self.quality is not None:
            NavigationalObstruction_IngestAddQuality(builder, quality)
        if self.lightingCode is not None:
            NavigationalObstruction_IngestAddLightingCode(builder, lightingCode)
        if self.surfaceMatCode is not None:
            NavigationalObstruction_IngestAddSurfaceMatCode(builder, surfaceMatCode)
        NavigationalObstruction_IngestAddDirectivityCode(builder, self.directivityCode)
        NavigationalObstruction_IngestAddValidationCode(builder, self.validationCode)
        if self.transactionCode is not None:
            NavigationalObstruction_IngestAddTransactionCode(builder, transactionCode)
        if self.processCode is not None:
            NavigationalObstruction_IngestAddProcessCode(builder, processCode)
        ...
        if self.cutoffDate is not None:
            NavigationalObstruction_IngestAddCutoffDate(builder, cutoffDate)
        NavigationalObstruction_IngestAddAiracCycle(builder, self.airacCycle)
        NavigationalObstruction_IngestAddBaseAiracCycle(builder, self.baseAiracCycle)
        if self.ownerCountryCode is not None:
            NavigationalObstruction_IngestAddOwnerCountryCode(builder, ownerCountryCode)
        NavigationalObstruction_IngestAddBoundNelon(builder, self.boundNelon)
        NavigationalObstruction_IngestAddBoundNelat(builder, self.boundNelat)
        NavigationalObstruction_IngestAddBoundSwlon(builder, self.boundSwlon)
        NavigationalObstruction_IngestAddBoundSwlat(builder, self.boundSwlat)
        NavigationalObstruction_IngestAddMinHeightAgl(builder, self.minHeightAgl)
        NavigationalObstruction_IngestAddNumPoints(builder, self.numPoints)
        NavigationalObstruction_IngestAddNumLines(builder, self.numLines)
        if self.dataSetRemarks is not None:
            NavigationalObstruction_IngestAddDataSetRemarks(builder, dataSetRemarks)
        if self.pointsFilename is not None:
            NavigationalObstruction_IngestAddPointsFilename(builder, pointsFilename)
        ...
        if self.origNetwork is not None:
            NavigationalObstruction_IngestAddOrigNetwork(builder, origNetwork)
        NavigationalObstruction_IngestAddDataMode(builder, self.dataMode)
        navigationalObstructionIngest = NavigationalObstruction_IngestEnd(builder)
        return navigationalObstructionIngest
