...
class AircraftStatus_Ingest(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsAircraftStatus_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def AircraftStatus_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf, offset, b"\x41\x49\x52\x43", size_prefixed=size_prefixed)

    # AircraftStatus_Ingest
...
def AircraftStatus_IngestStart(builder):
    builder.StartObject(52)

def Start(builder):
    AircraftStatus_IngestStart(builder)

def AircraftStatus_IngestAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    AircraftStatus_IngestAddId(builder, id)

def AircraftStatus_IngestAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    AircraftStatus_IngestAddClassificationMarking(builder, classificationMarking)

def AircraftStatus_IngestAddIdAircraft(builder, idAircraft):
...
def AddIdAircraft(builder, idAircraft):
    AircraftStatus_IngestAddIdAircraft(builder, idAircraft)

def AircraftStatus_IngestAddAltAircraftId(builder, altAircraftId):
...
def AddAltAircraftId(builder, altAircraftId):
    AircraftStatus_IngestAddAltAircraftId(builder, altAircraftId)

def AircraftStatus_IngestAddCurrentState(builder, currentState):
...
def AddCurrentState(builder, currentState):
    AircraftStatus_IngestAddCurrentState(builder, currentState)

def AircraftStatus_IngestAddIdAirfield(builder, idAirfield):
...
def AddIdAirfield(builder, idAirfield):
    AircraftStatus_IngestAddIdAirfield(builder, idAirfield)

def AircraftStatus_IngestAddGeoLoc(builder, geoLoc):
...
def AddGeoLoc(builder, geoLoc):
    AircraftStatus_IngestAddGeoLoc(builder, geoLoc)

def AircraftStatus_IngestAddPreviousIcao(builder, previousIcao):
...
def AddPreviousIcao(builder, previousIcao):
    AircraftStatus_IngestAddPreviousIcao(builder, previousIcao)

def AircraftStatus_IngestAddCurrentIcao(builder, currentIcao):
...
def AddCurrentIcao(builder, currentIcao):
    AircraftStatus_IngestAddCurrentIcao(builder, currentIcao)

def AircraftStatus_IngestAddNextIcao(builder, nextIcao):
...
def AddNextIcao(builder, nextIcao):
    AircraftStatus_IngestAddNextIcao(builder, nextIcao)

def AircraftStatus_IngestAddFlightPhase(builder, flightPhase):
...
def AddFlightPhase(builder, flightPhase):
    AircraftStatus_IngestAddFlightPhase(builder, flightPhase)

def AircraftStatus_IngestAddTaStartTime(builder, taStartTime):
...
def AddTaStartTime(builder, taStartTime):
    AircraftStatus_IngestAddTaStartTime(builder, taStartTime)

def AircraftStatus_IngestAddEarliestTaendTime(builder, earliestTaendTime):
...
def AddEarliestTaendTime(builder, earliestTaendTime):
    AircraftStatus_IngestAddEarliestTaendTime(builder, earliestTaendTime)

def AircraftStatus_IngestAddMissionReadiness(builder, missionReadiness):
...
def AddMissionReadiness(builder, missionReadiness):
    AircraftStatus_IngestAddMissionReadiness(builder, missionReadiness)

def AircraftStatus_IngestAddFuel(builder, fuel):
    builder.PrependInt32Slot(14, fuel, 0)

def AddFuel(builder, fuel):
    AircraftStatus_IngestAddFuel(builder, fuel)

def AircraftStatus_IngestAddFuelFunction(builder, fuelFunction):
...
def AddFuelFunction(builder, fuelFunction):
    AircraftStatus_IngestAddFuelFunction(builder, fuelFunction)

def AircraftStatus_IngestAddGunCapable(builder, gunCapable):
    builder.PrependBoolSlot(16, gunCapable, 0)

def AddGunCapable(builder, gunCapable):
    AircraftStatus_IngestAddGunCapable(builder, gunCapable)

def AircraftStatus_IngestAddGunRdsType(builder, gunRdsType):
...
def AddGunRdsType(builder, gunRdsType):
    AircraftStatus_IngestAddGunRdsType(builder, gunRdsType)

def AircraftStatus_IngestAddGunRdsMin(builder, gunRdsMin):
    builder.PrependInt32Slot(18, gunRdsMin, 0)

def AddGunRdsMin(builder, gunRdsMin):
    AircraftStatus_IngestAddGunRdsMin(builder, gunRdsMin)

def AircraftStatus_IngestAddGunRdsMax(builder, gunRdsMax):
    builder.PrependInt32Slot(19, gunRdsMax, 0)

def AddGunRdsMax(builder, gunRdsMax):
    AircraftStatus_IngestAddGunRdsMax(builder, gunRdsMax)

def AircraftStatus_IngestAddAirToAirStatus(builder, airToAirStatus):
    builder.PrependInt8Slot(20, airToAirStatus, 0)

def AddAirToAirStatus(builder, airToAirStatus):
    AircraftStatus_IngestAddAirToAirStatus(builder, airToAirStatus)

def AircraftStatus_IngestAddAirToGroundStatus(builder, airToGroundStatus):
    builder.PrependInt8Slot(21, airToGroundStatus, 0)

def AddAirToGroundStatus(builder, airToGroundStatus):
    AircraftStatus_IngestAddAirToGroundStatus(builder, airToGroundStatus)

def AircraftStatus_IngestAddInventory(builder, inventory):
...
def AddInventory(builder, inventory):
    AircraftStatus_IngestAddInventory(builder, inventory)

def AircraftStatus_IngestStartInventoryVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartInventoryVector(builder, numElems):
    return AircraftStatus_IngestStartInventoryVector(builder, numElems)

def AircraftStatus_IngestAddInventoryMin(builder, inventoryMin):
...
def AddInventoryMin(builder, inventoryMin):
    AircraftStatus_IngestAddInventoryMin(builder, inventoryMin)

def AircraftStatus_IngestStartInventoryMinVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartInventoryMinVector(builder, numElems):
    return AircraftStatus_IngestStartInventoryMinVector(builder, numElems)

def AircraftStatus_IngestAddInventoryMax(builder, inventoryMax):
...
def AddInventoryMax(builder, inventoryMax):
    AircraftStatus_IngestAddInventoryMax(builder, inventoryMax)

def AircraftStatus_IngestStartInventoryMaxVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartInventoryMaxVector(builder, numElems):
    return AircraftStatus_IngestStartInventoryMaxVector(builder, numElems)

def AircraftStatus_IngestAddUnavailableSys(builder, unavailableSys):
...
def AddUnavailableSys(builder, unavailableSys):
    AircraftStatus_IngestAddUnavailableSys(builder, unavailableSys)

def AircraftStatus_IngestStartUnavailableSysVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartUnavailableSysVector(builder, numElems):
    return AircraftStatus_IngestStartUnavailableSysVector(builder, numElems)

def AircraftStatus_IngestAddAdditionalSys(builder, additionalSys):
...
def AddAdditionalSys(builder, additionalSys):
    AircraftStatus_IngestAddAdditionalSys(builder, additionalSys)

def AircraftStatus_IngestStartAdditionalSysVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartAdditionalSysVector(builder, numElems):
    return AircraftStatus_IngestStartAdditionalSysVector(builder, numElems)

def AircraftStatus_IngestAddNotes(builder, notes):
    builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(notes), 0)

def AddNotes(builder, notes):
    AircraftStatus_IngestAddNotes(builder, notes)

def AircraftStatus_IngestAddMxRemark(builder, mxRemark):
...
def AddMxRemark(builder, mxRemark):
    AircraftStatus_IngestAddMxRemark(builder, mxRemark)

def AircraftStatus_IngestAddMaintStatus(builder, maintStatus):
...
def AddMaintStatus(builder, maintStatus):
    AircraftStatus_IngestAddMaintStatus(builder, maintStatus)

def AircraftStatus_IngestAddMaintStatusDriver(builder, maintStatusDriver):
...
def AddMaintStatusDriver(builder, maintStatusDriver):
    AircraftStatus_IngestAddMaintStatusDriver(builder, maintStatusDriver)

def AircraftStatus_IngestAddMaintPriority(builder, maintPriority):
...
def AddMaintPriority(builder, maintPriority):
    AircraftStatus_IngestAddMaintPriority(builder, maintPriority)

def AircraftStatus_IngestAddAlphaStatusCode(builder, alphaStatusCode):
...
def AddAlphaStatusCode(builder, alphaStatusCode):
    AircraftStatus_IngestAddAlphaStatusCode(builder, alphaStatusCode)

def AircraftStatus_IngestAddMaintStatusUpdate(builder, maintStatusUpdate):
...
def AddMaintStatusUpdate(builder, maintStatusUpdate):
    AircraftStatus_IngestAddMaintStatusUpdate(builder, maintStatusUpdate)

def AircraftStatus_IngestAddLastInspectionDate(builder, lastInspectionDate):
...
def AddLastInspectionDate(builder, lastInspectionDate):
    AircraftStatus_IngestAddLastInspectionDate(builder, lastInspectionDate)

def AircraftStatus_IngestAddMaintPoc(builder, maintPoc):
...
def AddMaintPoc(builder, maintPoc):
    AircraftStatus_IngestAddMaintPoc(builder, maintPoc)

def AircraftStatus_IngestAddGroundStatus(builder, groundStatus):
...
def AddGroundStatus(builder, groundStatus):
    AircraftStatus_IngestAddGroundStatus(builder, groundStatus)

def AircraftStatus_IngestAddContaminationStatus(builder, contaminationStatus):
...
def AddContaminationStatus(builder, contaminationStatus):
    AircraftStatus_IngestAddContaminationStatus(builder, contaminationStatus)

def AircraftStatus_IngestAddFuelStatus(builder, fuelStatus):
...
def AddFuelStatus(builder, fuelStatus):
    AircraftStatus_IngestAddFuelStatus(builder, fuelStatus)

def AircraftStatus_IngestAddLastUpdatedBy(builder, lastUpdatedBy):
...
def AddLastUpdatedBy(builder, lastUpdatedBy):
    AircraftStatus_IngestAddLastUpdatedBy(builder, lastUpdatedBy)

def AircraftStatus_IngestAddTroubleshootEtic(builder, troubleshootEtic):
...
def AddTroubleshootEtic(builder, troubleshootEtic):
    AircraftStatus_IngestAddTroubleshootEtic(builder, troubleshootEtic)

def AircraftStatus_IngestAddEtic(builder, etic):
    builder.PrependUOffsetTRelativeSlot(41, flatbuffers.number_types.UOffsetTFlags.py_type(etic), 0)

def AddEtic(builder, etic):
    AircraftStatus_IngestAddEtic(builder, etic)

def AircraftStatus_IngestAddParkLocation(builder, parkLocation):
...
def AddParkLocation(builder, parkLocation):
    AircraftStatus_IngestAddParkLocation(builder, parkLocation)

def AircraftStatus_IngestAddParkLocationSystem(builder, parkLocationSystem):
...
def AddParkLocationSystem(builder, parkLocationSystem):
    AircraftStatus_IngestAddParkLocationSystem(builder, parkLocationSystem)

def AircraftStatus_IngestAddIdPoi(builder, idPoi):
    builder.PrependUOffsetTRelativeSlot(44, flatbuffers.number_types.UOffsetTFlags.py_type(idPoi), 0)

def AddIdPoi(builder, idPoi):
    AircraftStatus_IngestAddIdPoi(builder, idPoi)

def AircraftStatus_IngestAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(45, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    AircraftStatus_IngestAddCreatedAt(builder, createdAt)

def AircraftStatus_IngestAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(46, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    AircraftStatus_IngestAddCreatedBy(builder, createdBy)

def AircraftStatus_IngestAddSourceDl(builder, sourceDl):
...
def AddSourceDl(builder, sourceDl):
    AircraftStatus_IngestAddSourceDl(builder, sourceDl)

def AircraftStatus_IngestAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(48, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    AircraftStatus_IngestAddSource(builder, source)

def AircraftStatus_IngestAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(49, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    AircraftStatus_IngestAddOrigin(builder, origin)

def AircraftStatus_IngestAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(50, dataMode, 0)

def AddDataMode(builder, dataMode):
    AircraftStatus_IngestAddDataMode(builder, dataMode)

def AircraftStatus_IngestAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(51, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    AircraftStatus_IngestAddOrigNetwork(builder, origNetwork)

def AircraftStatus_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return AircraftStatus_IngestEnd(builder)
...
class AircraftStatus_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        aircraftStatusIngest = AircraftStatus_Ingest()
        aircraftStatusIngest.Init(buf, pos)
        return cls.InitFromObj(aircraftStatusIngest)
    ...
    @classmethod
    def InitFromObj(cls, aircraftStatusIngest):
        x = AircraftStatus_IngestT()
        x._UnPack(aircraftStatusIngest)
        return x

    # AircraftStatus_IngestT
    def _UnPack(self, aircraftStatusIngest):
        if aircraftStatusIngest is None:
            return
        self.id = aircraftStatusIngest.Id()
        self.classificationMarking = aircraftStatusIngest.ClassificationMarking()
        self.idAircraft = aircraftStatusIngest.IdAircraft()
        self.altAircraftId = aircraftStatusIngest.AltAircraftId()
        self.currentState = aircraftStatusIngest.CurrentState()
        self.idAirfield = aircraftStatusIngest.IdAirfield()
        self.geoLoc = aircraftStatusIngest.GeoLoc()
        self.previousIcao = aircraftStatusIngest.PreviousIcao()
        self.currentIcao = aircraftStatusIngest.CurrentIcao()
        self.nextIcao = aircraftStatusIngest.NextIcao()
        self.flightPhase = aircraftStatusIngest.FlightPhase()
        self.taStartTime = aircraftStatusIngest.TaStartTime()
        self.earliestTaendTime = aircraftStatusIngest.EarliestTaendTime()
        self.missionReadiness = aircraftStatusIngest.MissionReadiness()
        self.fuel = aircraftStatusIngest.Fuel()
        self.fuelFunction = aircraftStatusIngest.FuelFunction()
        self.gunCapable = aircraftStatusIngest.GunCapable()
        self.gunRdsType = aircraftStatusIngest.GunRdsType()
        self.gunRdsMin = aircraftStatusIngest.GunRdsMin()
        self.gunRdsMax = aircraftStatusIngest.GunRdsMax()
        self.airToAirStatus = aircraftStatusIngest.AirToAirStatus()
        self.airToGroundStatus = aircraftStatusIngest.AirToGroundStatus()
        if not aircraftStatusIngest.InventoryIsNone():
            self.inventory = []
            for i in range(aircraftStatusIngest.InventoryLength()):
                self.inventory.append(aircraftStatusIngest.Inventory(i))
        if not aircraftStatusIngest.InventoryMinIsNone():
            self.inventoryMin = []
            for i in range(aircraftStatusIngest.InventoryMinLength()):
                self.inventoryMin.append(aircraftStatusIngest.InventoryMin(i))
        if not aircraftStatusIngest.InventoryMaxIsNone():
            self.inventoryMax = []
            for i in range(aircraftStatusIngest.InventoryMaxLength()):
                self.inventoryMax.append(aircraftStatusIngest.InventoryMax(i))
        if not aircraftStatusIngest.UnavailableSysIsNone():
            self.unavailableSys = []
            for i in range(aircraftStatusIngest.UnavailableSysLength()):
                self.unavailableSys.append(aircraftStatusIngest.UnavailableSys(i))
        if not aircraftStatusIngest.AdditionalSysIsNone():
            self.additionalSys = []
            for i in range(aircraftStatusIngest.AdditionalSysLength()):
                self.additionalSys.append(aircraftStatusIngest.AdditionalSys(i))
        self.notes = aircraftStatusIngest.Notes()
        self.mxRemark = aircraftStatusIngest.MxRemark()
        self.maintStatus = aircraftStatusIngest.MaintStatus()
        self.maintStatusDriver = aircraftStatusIngest.MaintStatusDriver()
        self.maintPriority = aircraftStatusIngest.MaintPriority()
        self.alphaStatusCode = aircraftStatusIngest.AlphaStatusCode()
        self.maintStatusUpdate = aircraftStatusIngest.MaintStatusUpdate()
        self.lastInspectionDate = aircraftStatusIngest.LastInspectionDate()
        self.maintPoc = aircraftStatusIngest.MaintPoc()
        self.groundStatus = aircraftStatusIngest.GroundStatus()
        self.contaminationStatus = aircraftStatusIngest.ContaminationStatus()
        self.fuelStatus = aircraftStatusIngest.FuelStatus()
        self.lastUpdatedBy = aircraftStatusIngest.LastUpdatedBy()
        self.troubleshootEtic = aircraftStatusIngest.TroubleshootEtic()
        self.etic = aircraftStatusIngest.Etic()
        self.parkLocation = aircraftStatusIngest.ParkLocation()
        self.parkLocationSystem = aircraftStatusIngest.ParkLocationSystem()
        self.idPoi = aircraftStatusIngest.IdPoi()
        self.createdAt = aircraftStatusIngest.CreatedAt()
        self.createdBy = aircraftStatusIngest.CreatedBy()
        self.sourceDl = aircraftStatusIngest.SourceDl()
        self.source = aircraftStatusIngest.Source()
        self.origin = aircraftStatusIngest.Origin()
        self.dataMode = aircraftStatusIngest.DataMode()
        self.origNetwork = aircraftStatusIngest.OrigNetwork()
    ...
    def Pack(self, builder):
        ...
        if self.inventory is not None:
            ...
            AircraftStatus_IngestStartInventoryVector(builder, len(self.inventory))
        ...
        if self.inventoryMin is not None:
            ...
            AircraftStatus_IngestStartInventoryMinVector(builder, len(self.inventoryMin))
        ...
        if self.inventoryMax is not None:
            ...
            AircraftStatus_IngestStartInventoryMaxVector(builder, len(self.inventoryMax))
        ...
        if self.unavailableSys is not None:
            ...
            AircraftStatus_IngestStartUnavailableSysVector(builder, len(self.unavailableSys))
        ...
        if self.additionalSys is not None:
            ...
            AircraftStatus_IngestStartAdditionalSysVector(builder, len(self.additionalSys))
        ...
        if self.missionReadiness is not None:
            AircraftStatus_IngestAddMissionReadiness(builder, missionReadiness)
        AircraftStatus_IngestAddFuel(builder, self.fuel)
        if self.fuelFunction is not None:
            AircraftStatus_IngestAddFuelFunction(builder, fuelFunction)
        AircraftStatus_IngestAddGunCapable(builder, self.gunCapable)
        if self.gunRdsType is not None:
            AircraftStatus_IngestAddGunRdsType(builder, gunRdsType)
        AircraftStatus_IngestAddGunRdsMin(builder, self.gunRdsMin)
        AircraftStatus_IngestAddGunRdsMax(builder, self.gunRdsMax)
        AircraftStatus_IngestAddAirToAirStatus(builder, self.airToAirStatus)
        AircraftStatus_IngestAddAirToGroundStatus(builder, self.airToGroundStatus)
        if self.inventory is not None:
            AircraftStatus_IngestAddInventory(builder, inventory)
        if self.inventoryMin is not None:
            AircraftStatus_IngestAddInventoryMin(builder, inventoryMin)
        ...
        if self.origin is not None:
            AircraftStatus_IngestAddOrigin(builder, origin)
        AircraftStatus_IngestAddDataMode(builder, self.dataMode)
        if self.origNetwork is not None:
            AircraftStatus_IngestAddOrigNetwork(builder, origNetwork)
        aircraftStatusIngest = AircraftStatus_IngestEnd(builder)
        return aircraftStatusIngest
