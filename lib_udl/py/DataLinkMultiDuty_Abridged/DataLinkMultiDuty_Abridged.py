...
class DataLinkMultiDuty_Abridged(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsDataLinkMultiDuty_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def DataLinkMultiDuty_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf, offset, b"\x44\x41\x54\x41", size_prefixed=size_prefixed)

    # DataLinkMultiDuty_Abridged
...
def DataLinkMultiDuty_AbridgedStart(builder):
    builder.StartObject(6)

def Start(builder):
    DataLinkMultiDuty_AbridgedStart(builder)

def DataLinkMultiDuty_AbridgedAddUnitDes(builder, unitDes):
...
def AddUnitDes(builder, unitDes):
    DataLinkMultiDuty_AbridgedAddUnitDes(builder, unitDes)

def DataLinkMultiDuty_AbridgedAddName(builder, name):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)

def AddName(builder, name):
    DataLinkMultiDuty_AbridgedAddName(builder, name)

def DataLinkMultiDuty_AbridgedAddRank(builder, rank):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(rank), 0)

def AddRank(builder, rank):
    DataLinkMultiDuty_AbridgedAddRank(builder, rank)

def DataLinkMultiDuty_AbridgedAddDuty(builder, duty):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(duty), 0)

def AddDuty(builder, duty):
    DataLinkMultiDuty_AbridgedAddDuty(builder, duty)

def DataLinkMultiDuty_AbridgedAddDutyTeleFreqNums(builder, dutyTeleFreqNums):
...
def AddDutyTeleFreqNums(builder, dutyTeleFreqNums):
    DataLinkMultiDuty_AbridgedAddDutyTeleFreqNums(builder, dutyTeleFreqNums)

def DataLinkMultiDuty_AbridgedStartDutyTeleFreqNumsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartDutyTeleFreqNumsVector(builder, numElems):
    return DataLinkMultiDuty_AbridgedStartDutyTeleFreqNumsVector(builder, numElems)

def DataLinkMultiDuty_AbridgedAddMultiDutyVoiceCoord(builder, multiDutyVoiceCoord):
...
def AddMultiDutyVoiceCoord(builder, multiDutyVoiceCoord):
    DataLinkMultiDuty_AbridgedAddMultiDutyVoiceCoord(builder, multiDutyVoiceCoord)

def DataLinkMultiDuty_AbridgedStartMultiDutyVoiceCoordVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartMultiDutyVoiceCoordVector(builder, numElems):
    return DataLinkMultiDuty_AbridgedStartMultiDutyVoiceCoordVector(builder, numElems)

def DataLinkMultiDuty_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return DataLinkMultiDuty_AbridgedEnd(builder)
...
class DataLinkMultiDuty_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        dataLinkMultiDutyAbridged = DataLinkMultiDuty_Abridged()
        dataLinkMultiDutyAbridged.Init(buf, pos)
        return cls.InitFromObj(dataLinkMultiDutyAbridged)
    ...
    @classmethod
    def InitFromObj(cls, dataLinkMultiDutyAbridged):
        x = DataLinkMultiDuty_AbridgedT()
        x._UnPack(dataLinkMultiDutyAbridged)
        return x

    # DataLinkMultiDuty_AbridgedT
    def _UnPack(self, dataLinkMultiDutyAbridged):
        if dataLinkMultiDutyAbridged is None:
            return
        self.unitDes = dataLinkMultiDutyAbridged.UnitDes()
        self.name = dataLinkMultiDutyAbridged.Name()
        self.rank = dataLinkMultiDutyAbridged.Rank()
        self.duty = dataLinkMultiDutyAbridged.Duty()
        if not dataLinkMultiDutyAbridged.DutyTeleFreqNumsIsNone():
            self.dutyTeleFreqNums = []
            for i in range(dataLinkMultiDutyAbridged.DutyTeleFreqNumsLength()):
                self.dutyTeleFreqNums.append(dataLinkMultiDutyAbridged.DutyTeleFreqNums(i))
        if not dataLinkMultiDutyAbridged.MultiDutyVoiceCoordIsNone():
            self.multiDutyVoiceCoord = []
            for i in range(dataLinkMultiDutyAbridged.MultiDutyVoiceCoordLength()):
                self.multiDutyVoiceCoord.append(dataLinkMultiDutyAbridged.MultiDutyVoiceCoord(i))
    ...
    def Pack(self, builder):
        ...
        if self.dutyTeleFreqNums is not None:
            ...
            DataLinkMultiDuty_AbridgedStartDutyTeleFreqNumsVector(builder, len(self.dutyTeleFreqNums))
        ...
        if self.multiDutyVoiceCoord is not None:
            ...
            DataLinkMultiDuty_AbridgedStartMultiDutyVoiceCoordVector(builder, len(self.multiDutyVoiceCoord))
        ...
        if self.multiDutyVoiceCoord is not None:
            DataLinkMultiDuty_AbridgedAddMultiDutyVoiceCoord(builder, multiDutyVoiceCoord)
        dataLinkMultiDutyAbridged = DataLinkMultiDuty_AbridgedEnd(builder)
        return dataLinkMultiDutyAbridged
