...
class SGI_Abridged(object):
    ...
    @classmethod
    def GetRootAsSGI_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def SGI_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf, offset, b"\x53\x47\x49\x41", size_prefixed=size_prefixed)
...
def SGI_AbridgedStart(builder):
    builder.StartObject(49)

def Start(builder):
    SGI_AbridgedStart(builder)

def SGI_AbridgedAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    SGI_AbridgedAddId(builder, id)

def SGI_AbridgedAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    SGI_AbridgedAddClassificationMarking(builder, classificationMarking)

def SGI_AbridgedAddEffectiveDate(builder, effectiveDate):
...
def AddEffectiveDate(builder, effectiveDate):
    SGI_AbridgedAddEffectiveDate(builder, effectiveDate)

def SGI_AbridgedAddSgiDate(builder, sgiDate):
...
def AddSgiDate(builder, sgiDate):
    SGI_AbridgedAddSgiDate(builder, sgiDate)

def SGI_AbridgedAddType(builder, type):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(type), 0)

def AddType(builder, type):
    SGI_AbridgedAddType(builder, type)

def SGI_AbridgedAddState(builder, state):
    builder.PrependInt8Slot(5, state, 0)

def AddState(builder, state):
    SGI_AbridgedAddState(builder, state)

def SGI_AbridgedAddStationName(builder, stationName):
...
def AddStationName(builder, stationName):
    SGI_AbridgedAddStationName(builder, stationName)

def SGI_AbridgedAddIdSensor(builder, idSensor):
...
def AddIdSensor(builder, idSensor):
    SGI_AbridgedAddIdSensor(builder, idSensor)

def SGI_AbridgedAddOrigSensorId(builder, origSensorId):
...
def AddOrigSensorId(builder, origSensorId):
    SGI_AbridgedAddOrigSensorId(builder, origSensorId)

def SGI_AbridgedAddMode(builder, mode):
    builder.PrependInt32Slot(9, mode, 0)

def AddMode(builder, mode):
    SGI_AbridgedAddMode(builder, mode)

def SGI_AbridgedAddPrecedence(builder, precedence):
    builder.PrependInt8Slot(10, precedence, 0)

def AddPrecedence(builder, precedence):
    SGI_AbridgedAddPrecedence(builder, precedence)

def SGI_AbridgedAddCoeffDegree(builder, coeffDegree):
...
def AddCoeffDegree(builder, coeffDegree):
    SGI_AbridgedAddCoeffDegree(builder, coeffDegree)

def SGI_AbridgedStartCoeffDegreeVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartCoeffDegreeVector(builder, numElems):
    return SGI_AbridgedStartCoeffDegreeVector(builder, numElems)

def SGI_AbridgedAddCoeffOrder(builder, coeffOrder):
...
def AddCoeffOrder(builder, coeffOrder):
    SGI_AbridgedAddCoeffOrder(builder, coeffOrder)

def SGI_AbridgedStartCoeffOrderVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartCoeffOrderVector(builder, numElems):
    return SGI_AbridgedStartCoeffOrderVector(builder, numElems)

def SGI_AbridgedAddCtce(builder, ctce):
    builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(ctce), 0)

def AddCtce(builder, ctce):
    SGI_AbridgedAddCtce(builder, ctce)

def SGI_AbridgedStartCtceVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartCtceVector(builder, numElems):
    return SGI_AbridgedStartCtceVector(builder, numElems)

def SGI_AbridgedAddStce(builder, stce):
    builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(stce), 0)

def AddStce(builder, stce):
    SGI_AbridgedAddStce(builder, stce)

def SGI_AbridgedStartStceVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartStceVector(builder, numElems):
    return SGI_AbridgedStartStceVector(builder, numElems)

def SGI_AbridgedAddCtci(builder, ctci):
    builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(ctci), 0)

def AddCtci(builder, ctci):
    SGI_AbridgedAddCtci(builder, ctci)

def SGI_AbridgedStartCtciVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartCtciVector(builder, numElems):
    return SGI_AbridgedStartCtciVector(builder, numElems)

def SGI_AbridgedAddStci(builder, stci):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(stci), 0)

def AddStci(builder, stci):
    SGI_AbridgedAddStci(builder, stci)

def SGI_AbridgedStartStciVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartStciVector(builder, numElems):
    return SGI_AbridgedStartStciVector(builder, numElems)

def SGI_AbridgedAddE10(builder, e10):
    builder.PrependFloat64Slot(17, e10, 0.0)

def AddE10(builder, e10):
    SGI_AbridgedAddE10(builder, e10)

def SGI_AbridgedAddE54(builder, e54):
    builder.PrependFloat64Slot(18, e54, 0.0)

def AddE54(builder, e54):
    SGI_AbridgedAddE54(builder, e54)

def SGI_AbridgedAddS10(builder, s10):
    builder.PrependFloat64Slot(19, s10, 0.0)

def AddS10(builder, s10):
    SGI_AbridgedAddS10(builder, s10)

def SGI_AbridgedAddS54(builder, s54):
    builder.PrependFloat64Slot(20, s54, 0.0)

def AddS54(builder, s54):
    SGI_AbridgedAddS54(builder, s54)

def SGI_AbridgedAddM10(builder, m10):
    builder.PrependFloat64Slot(21, m10, 0.0)

def AddM10(builder, m10):
    SGI_AbridgedAddM10(builder, m10)

def SGI_AbridgedAddM54(builder, m54):
    builder.PrependFloat64Slot(22, m54, 0.0)

def AddM54(builder, m54):
    SGI_AbridgedAddM54(builder, m54)

def SGI_AbridgedAddY10(builder, y10):
    builder.PrependFloat64Slot(23, y10, 0.0)

def AddY10(builder, y10):
    SGI_AbridgedAddY10(builder, y10)

def SGI_AbridgedAddY54(builder, y54):
    builder.PrependFloat64Slot(24, y54, 0.0)

def AddY54(builder, y54):
    SGI_AbridgedAddY54(builder, y54)

def SGI_AbridgedAddF10(builder, f10):
    builder.PrependFloat64Slot(25, f10, 0.0)

def AddF10(builder, f10):
    SGI_AbridgedAddF10(builder, f10)

def SGI_AbridgedAddF54(builder, f54):
    builder.PrependFloat64Slot(26, f54, 0.0)

def AddF54(builder, f54):
    SGI_AbridgedAddF54(builder, f54)

def SGI_AbridgedAddF81(builder, f81):
    builder.PrependFloat64Slot(27, f81, 0.0)

def AddF81(builder, f81):
    SGI_AbridgedAddF81(builder, f81)

def SGI_AbridgedAddAp(builder, ap):
    builder.PrependFloat64Slot(28, ap, 0.0)

def AddAp(builder, ap):
    SGI_AbridgedAddAp(builder, ap)

def SGI_AbridgedAddApDuration(builder, apDuration):
    builder.PrependInt32Slot(29, apDuration, 0)

def AddApDuration(builder, apDuration):
    SGI_AbridgedAddApDuration(builder, apDuration)

def SGI_AbridgedAddKIndex(builder, kIndex):
    builder.PrependInt32Slot(30, kIndex, 0)

def AddKIndex(builder, kIndex):
    SGI_AbridgedAddKIndex(builder, kIndex)

def SGI_AbridgedAddKp(builder, kp):
    builder.PrependFloat64Slot(31, kp, 0.0)

def AddKp(builder, kp):
    SGI_AbridgedAddKp(builder, kp)

def SGI_AbridgedAddKpDuration(builder, kpDuration):
    builder.PrependInt32Slot(32, kpDuration, 0)

def AddKpDuration(builder, kpDuration):
    SGI_AbridgedAddKpDuration(builder, kpDuration)

def SGI_AbridgedAddGamma(builder, gamma):
    builder.PrependInt32Slot(33, gamma, 0)

def AddGamma(builder, gamma):
    SGI_AbridgedAddGamma(builder, gamma)

def SGI_AbridgedAddDst(builder, dst):
    builder.PrependFloat64Slot(34, dst, 0.0)

def AddDst(builder, dst):
    SGI_AbridgedAddDst(builder, dst)

def SGI_AbridgedAddDtc(builder, dtc):
    builder.PrependFloat64Slot(35, dtc, 0.0)

def AddDtc(builder, dtc):
    SGI_AbridgedAddDtc(builder, dtc)

def SGI_AbridgedAddRbRegionCode(builder, rbRegionCode):
    builder.PrependInt32Slot(36, rbRegionCode, 0)

def AddRbRegionCode(builder, rbRegionCode):
    SGI_AbridgedAddRbRegionCode(builder, rbRegionCode)

def SGI_AbridgedAddRbIndex(builder, rbIndex):
    builder.PrependFloat64Slot(37, rbIndex, 0.0)

def AddRbIndex(builder, rbIndex):
    SGI_AbridgedAddRbIndex(builder, rbIndex)

def SGI_AbridgedAddNormFactor(builder, normFactor):
    builder.PrependFloat64Slot(38, normFactor, 0.0)

def AddNormFactor(builder, normFactor):
    SGI_AbridgedAddNormFactor(builder, normFactor)

def SGI_AbridgedAddRbDuration(builder, rbDuration):
    builder.PrependInt32Slot(39, rbDuration, 0)

def AddRbDuration(builder, rbDuration):
    SGI_AbridgedAddRbDuration(builder, rbDuration)

def SGI_AbridgedAddAnalyzerAttenuation(builder, analyzerAttenuation):
    builder.PrependFloat64Slot(40, analyzerAttenuation, 0.0)

def AddAnalyzerAttenuation(builder, analyzerAttenuation):
    SGI_AbridgedAddAnalyzerAttenuation(builder, analyzerAttenuation)

def SGI_AbridgedAddRawFileUri(builder, rawFileUri):
    builder.PrependUOffsetTRelativeSlot(41, flatbuffers.number_types.UOffsetTFlags.py_type(rawFileUri), 0)

def AddRawFileUri(builder, rawFileUri):
    SGI_AbridgedAddRawFileUri(builder, rawFileUri)

def SGI_AbridgedAddTransactionId(builder, transactionId):
...
def AddTransactionId(builder, transactionId):
    SGI_AbridgedAddTransactionId(builder, transactionId)

def SGI_AbridgedAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(43, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    SGI_AbridgedAddSource(builder, source)

def SGI_AbridgedAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(44, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    SGI_AbridgedAddOrigin(builder, origin)

def SGI_AbridgedAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(45, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    SGI_AbridgedAddOrigNetwork(builder, origNetwork)

def SGI_AbridgedAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(46, dataMode, 0)

def AddDataMode(builder, dataMode):
    SGI_AbridgedAddDataMode(builder, dataMode)

def SGI_AbridgedAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(47, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    SGI_AbridgedAddCreatedAt(builder, createdAt)

def SGI_AbridgedAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(48, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    SGI_AbridgedAddCreatedBy(builder, createdBy)

def SGI_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return SGI_AbridgedEnd(builder)
...
class SGI_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        sgiAbridged = SGI_Abridged()
        sgiAbridged.Init(buf, pos)
        return cls.InitFromObj(sgiAbridged)
    ...
    @classmethod
    def InitFromObj(cls, sgiAbridged):
        x = SGI_AbridgedT()
        x._UnPack(sgiAbridged)
        return x

    # SGI_AbridgedT
    def _UnPack(self, sgiAbridged):
        if sgiAbridged is None:
            return
        self.id = sgiAbridged.Id()
        self.classificationMarking = sgiAbridged.ClassificationMarking()
        self.effectiveDate = sgiAbridged.EffectiveDate()
        self.sgiDate = sgiAbridged.SgiDate()
        self.type = sgiAbridged.Type()
        self.state = sgiAbridged.State()
        self.stationName = sgiAbridged.StationName()
        self.idSensor = sgiAbridged.IdSensor()
        self.origSensorId = sgiAbridged.OrigSensorId()
        self.mode = sgiAbridged.Mode()
        self.precedence = sgiAbridged.Precedence()
        if not sgiAbridged.CoeffDegreeIsNone():
            self.coeffDegree = []
            for i in range(sgiAbridged.CoeffDegreeLength()):
                self.coeffDegree.append(sgiAbridged.CoeffDegree(i))
        if not sgiAbridged.CoeffOrderIsNone():
            self.coeffOrder = []
            for i in range(sgiAbridged.CoeffOrderLength()):
                self.coeffOrder.append(sgiAbridged.CoeffOrder(i))
        if not sgiAbridged.CtceIsNone():
            self.ctce = []
            for i in range(sgiAbridged.CtceLength()):
                self.ctce.append(sgiAbridged.Ctce(i))
        if not sgiAbridged.StceIsNone():
            self.stce = []
            for i in range(sgiAbridged.StceLength()):
                self.stce.append(sgiAbridged.Stce(i))
        if not sgiAbridged.CtciIsNone():
            self.ctci = []
            for i in range(sgiAbridged.CtciLength()):
                self.ctci.append(sgiAbridged.Ctci(i))
        if not sgiAbridged.StciIsNone():
            self.stci = []
            for i in range(sgiAbridged.StciLength()):
                self.stci.append(sgiAbridged.Stci(i))
        self.e10 = sgiAbridged.E10()
        self.e54 = sgiAbridged.E54()
        self.s10 = sgiAbridged.S10()
        self.s54 = sgiAbridged.S54()
        self.m10 = sgiAbridged.M10()
        self.m54 = sgiAbridged.M54()
        self.y10 = sgiAbridged.Y10()
        self.y54 = sgiAbridged.Y54()
        self.f10 = sgiAbridged.F10()
        self.f54 = sgiAbridged.F54()
        self.f81 = sgiAbridged.F81()
        self.ap = sgiAbridged.Ap()
        self.apDuration = sgiAbridged.ApDuration()
        self.kIndex = sgiAbridged.KIndex()
        self.kp = sgiAbridged.Kp()
        self.kpDuration = sgiAbridged.KpDuration()
        self.gamma = sgiAbridged.Gamma()
        self.dst = sgiAbridged.Dst()
        self.dtc = sgiAbridged.Dtc()
        self.rbRegionCode = sgiAbridged.RbRegionCode()
        self.rbIndex = sgiAbridged.RbIndex()
        self.normFactor = sgiAbridged.NormFactor()
        self.rbDuration = sgiAbridged.RbDuration()
        self.analyzerAttenuation = sgiAbridged.AnalyzerAttenuation()
        self.rawFileUri = sgiAbridged.RawFileUri()
        self.transactionId = sgiAbridged.TransactionId()
        self.source = sgiAbridged.Source()
        self.origin = sgiAbridged.Origin()
        self.origNetwork = sgiAbridged.OrigNetwork()
        self.dataMode = sgiAbridged.DataMode()
        self.createdAt = sgiAbridged.CreatedAt()
        self.createdBy = sgiAbridged.CreatedBy()
    ...
    def Pack(self, builder):
        ...
        if self.coeffDegree is not None:
            ...
            SGI_AbridgedStartCoeffDegreeVector(builder, len(self.coeffDegree))
        ...
        if self.coeffOrder is not None:
            ...
            SGI_AbridgedStartCoeffOrderVector(builder, len(self.coeffOrder))
        ...
        if self.ctce is not None:
            ...
            SGI_AbridgedStartCtceVector(builder, len(self.ctce))
        ...
        if self.stce is not None:
            ...
            SGI_AbridgedStartStceVector(builder, len(self.stce))
        ...
        if self.ctci is not None:
            ...
            SGI_AbridgedStartCtciVector(builder, len(self.ctci))
        ...
        if self.stci is not None:
            ...
            SGI_AbridgedStartStciVector(builder, len(self.stci))
        ...
        if self.type is not None:
            SGI_AbridgedAddType(builder, type)
        SGI_AbridgedAddState(builder, self.state)
        if self.stationName is not None:
            SGI_AbridgedAddStationName(builder, stationName)
        if self.idSensor is not None:
            SGI_AbridgedAddIdSensor(builder, idSensor)
        if self.origSensorId is not None:
            SGI_AbridgedAddOrigSensorId(builder, origSensorId)
        SGI_AbridgedAddMode(builder, self.mode)
        SGI_AbridgedAddPrecedence(builder, self.precedence)
        if self.coeffDegree is not None:
            SGI_AbridgedAddCoeffDegree(builder, coeffDegree)
        if self.coeffOrder is not None:
            SGI_AbridgedAddCoeffOrder(builder, coeffOrder)
        ...
        if self.stci is not None:
            SGI_AbridgedAddStci(builder, stci)
        SGI_AbridgedAddE10(builder, self.e10)
        SGI_AbridgedAddE54(builder, self.e54)
        SGI_AbridgedAddS10(builder, self.s10)
        SGI_AbridgedAddS54(builder, self.s54)
        SGI_AbridgedAddM10(builder, self.m10)
        SGI_AbridgedAddM54(builder, self.m54)
        SGI_AbridgedAddY10(builder, self.y10)
        SGI_AbridgedAddY54(builder, self.y54)
        SGI_AbridgedAddF10(builder, self.f10)
        SGI_AbridgedAddF54(builder, self.f54)
        SGI_AbridgedAddF81(builder, self.f81)
        SGI_AbridgedAddAp(builder, self.ap)
        SGI_AbridgedAddApDuration(builder, self.apDuration)
        SGI_AbridgedAddKIndex(builder, self.kIndex)
        SGI_AbridgedAddKp(builder, self.kp)
        SGI_AbridgedAddKpDuration(builder, self.kpDuration)
        SGI_AbridgedAddGamma(builder, self.gamma)
        SGI_AbridgedAddDst(builder, self.dst)
        SGI_AbridgedAddDtc(builder, self.dtc)
        SGI_AbridgedAddRbRegionCode(builder, self.rbRegionCode)
        SGI_AbridgedAddRbIndex(builder, self.rbIndex)
        SGI_AbridgedAddNormFactor(builder, self.normFactor)
        SGI_AbridgedAddRbDuration(builder, self.rbDuration)
        SGI_AbridgedAddAnalyzerAttenuation(builder, self.analyzerAttenuation)
        if self.rawFileUri is not None:
            SGI_AbridgedAddRawFileUri(builder, rawFileUri)
        if self.transactionId is not None:
            SGI_AbridgedAddTransactionId(builder, transactionId)
        ...
        if self.origNetwork is not None:
            SGI_AbridgedAddOrigNetwork(builder, origNetwork)
        SGI_AbridgedAddDataMode(builder, self.dataMode)
        if self.createdAt is not None:
            SGI_AbridgedAddCreatedAt(builder, createdAt)
        if self.createdBy is not None:
            SGI_AbridgedAddCreatedBy(builder, createdBy)
        sgiAbridged = SGI_AbridgedEnd(builder)
        return sgiAbridged
