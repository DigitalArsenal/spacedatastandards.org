...
class LogisticsSpecialties_Abridged(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsLogisticsSpecialties_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def LogisticsSpecialties_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def LogisticsSpecialties_AbridgedStart(builder):
    builder.StartObject(7)

def Start(builder):
    LogisticsSpecialties_AbridgedStart(builder)

def LogisticsSpecialties_AbridgedAddSpecialty(builder, specialty):
...
def AddSpecialty(builder, specialty):
    LogisticsSpecialties_AbridgedAddSpecialty(builder, specialty)

def LogisticsSpecialties_AbridgedAddSkillLevel(builder, skillLevel):
    builder.PrependInt32Slot(1, skillLevel, 0)

def AddSkillLevel(builder, skillLevel):
    LogisticsSpecialties_AbridgedAddSkillLevel(builder, skillLevel)

def LogisticsSpecialties_AbridgedAddFirstName(builder, firstName):
...
def AddFirstName(builder, firstName):
    LogisticsSpecialties_AbridgedAddFirstName(builder, firstName)

def LogisticsSpecialties_AbridgedAddLastName(builder, lastName):
...
def AddLastName(builder, lastName):
    LogisticsSpecialties_AbridgedAddLastName(builder, lastName)

def LogisticsSpecialties_AbridgedAddRankCode(builder, rankCode):
...
def AddRankCode(builder, rankCode):
    LogisticsSpecialties_AbridgedAddRankCode(builder, rankCode)

def LogisticsSpecialties_AbridgedAddLast4Ssn(builder, last4Ssn):
...
def AddLast4Ssn(builder, last4Ssn):
    LogisticsSpecialties_AbridgedAddLast4Ssn(builder, last4Ssn)

def LogisticsSpecialties_AbridgedAddRoleTypeCode(builder, roleTypeCode):
...
def AddRoleTypeCode(builder, roleTypeCode):
    LogisticsSpecialties_AbridgedAddRoleTypeCode(builder, roleTypeCode)

def LogisticsSpecialties_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return LogisticsSpecialties_AbridgedEnd(builder)


class LogisticsSpecialties_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        logisticsSpecialtiesAbridged = LogisticsSpecialties_Abridged()
        logisticsSpecialtiesAbridged.Init(buf, pos)
        return cls.InitFromObj(logisticsSpecialtiesAbridged)
    ...
    @classmethod
    def InitFromObj(cls, logisticsSpecialtiesAbridged):
        x = LogisticsSpecialties_AbridgedT()
        x._UnPack(logisticsSpecialtiesAbridged)
        return x

    # LogisticsSpecialties_AbridgedT
    def _UnPack(self, logisticsSpecialtiesAbridged):
        if logisticsSpecialtiesAbridged is None:
            return
        self.specialty = logisticsSpecialtiesAbridged.Specialty()
        self.skillLevel = logisticsSpecialtiesAbridged.SkillLevel()
        self.firstName = logisticsSpecialtiesAbridged.FirstName()
        self.lastName = logisticsSpecialtiesAbridged.LastName()
        self.rankCode = logisticsSpecialtiesAbridged.RankCode()
        self.last4Ssn = logisticsSpecialtiesAbridged.Last4Ssn()
        self.roleTypeCode = logisticsSpecialtiesAbridged.RoleTypeCode()
    ...
    def Pack(self, builder):
        ...
        if self.specialty is not None:
            LogisticsSpecialties_AbridgedAddSpecialty(builder, specialty)
        LogisticsSpecialties_AbridgedAddSkillLevel(builder, self.skillLevel)
        if self.firstName is not None:
            LogisticsSpecialties_AbridgedAddFirstName(builder, firstName)
        if self.lastName is not None:
            LogisticsSpecialties_AbridgedAddLastName(builder, lastName)
        ...
        if self.roleTypeCode is not None:
            LogisticsSpecialties_AbridgedAddRoleTypeCode(builder, roleTypeCode)
        logisticsSpecialtiesAbridged = LogisticsSpecialties_AbridgedEnd(builder)
        return logisticsSpecialtiesAbridged
