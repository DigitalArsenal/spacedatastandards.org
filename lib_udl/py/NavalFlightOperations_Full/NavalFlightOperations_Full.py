...
class NavalFlightOperations_Full(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsNavalFlightOperations_Full(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def NavalFlightOperations_FullBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def NavalFlightOperations_FullStart(builder):
    builder.StartObject(4)

def Start(builder):
    NavalFlightOperations_FullStart(builder)

def NavalFlightOperations_FullAddShipName(builder, shipName):
...
def AddShipName(builder, shipName):
    NavalFlightOperations_FullAddShipName(builder, shipName)

def NavalFlightOperations_FullAddFltOpStart(builder, fltOpStart):
...
def AddFltOpStart(builder, fltOpStart):
    NavalFlightOperations_FullAddFltOpStart(builder, fltOpStart)

def NavalFlightOperations_FullAddFltOpStop(builder, fltOpStop):
...
def AddFltOpStop(builder, fltOpStop):
    NavalFlightOperations_FullAddFltOpStop(builder, fltOpStop)

def NavalFlightOperations_FullAddSchdLaunchRcvyTime(builder, schdLaunchRcvyTime):
...
def AddSchdLaunchRcvyTime(builder, schdLaunchRcvyTime):
    NavalFlightOperations_FullAddSchdLaunchRcvyTime(builder, schdLaunchRcvyTime)

def NavalFlightOperations_FullStartSchdLaunchRcvyTimeVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartSchdLaunchRcvyTimeVector(builder, numElems):
    return NavalFlightOperations_FullStartSchdLaunchRcvyTimeVector(builder, numElems)

def NavalFlightOperations_FullEnd(builder):
    return builder.EndObject()

def End(builder):
    return NavalFlightOperations_FullEnd(builder)
...
class NavalFlightOperations_FullT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        navalFlightOperationsFull = NavalFlightOperations_Full()
        navalFlightOperationsFull.Init(buf, pos)
        return cls.InitFromObj(navalFlightOperationsFull)
    ...
    @classmethod
    def InitFromObj(cls, navalFlightOperationsFull):
        x = NavalFlightOperations_FullT()
        x._UnPack(navalFlightOperationsFull)
        return x

    # NavalFlightOperations_FullT
    def _UnPack(self, navalFlightOperationsFull):
        if navalFlightOperationsFull is None:
            return
        self.shipName = navalFlightOperationsFull.ShipName()
        self.fltOpStart = navalFlightOperationsFull.FltOpStart()
        self.fltOpStop = navalFlightOperationsFull.FltOpStop()
        if not navalFlightOperationsFull.SchdLaunchRcvyTimeIsNone():
            self.schdLaunchRcvyTime = []
            for i in range(navalFlightOperationsFull.SchdLaunchRcvyTimeLength()):
                self.schdLaunchRcvyTime.append(navalFlightOperationsFull.SchdLaunchRcvyTime(i))
    ...
    def Pack(self, builder):
        ...
        if self.schdLaunchRcvyTime is not None:
            ...
            NavalFlightOperations_FullStartSchdLaunchRcvyTimeVector(builder, len(self.schdLaunchRcvyTime))
        ...
        if self.schdLaunchRcvyTime is not None:
            NavalFlightOperations_FullAddSchdLaunchRcvyTime(builder, schdLaunchRcvyTime)
        navalFlightOperationsFull = NavalFlightOperations_FullEnd(builder)
        return navalFlightOperationsFull
