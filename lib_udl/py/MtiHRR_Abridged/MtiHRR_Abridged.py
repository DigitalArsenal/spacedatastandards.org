...
class MtiHRR_Abridged(object):
    ...
    @classmethod
    def GetRootAsMtiHRR_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def MtiHRR_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def MtiHRR_AbridgedStart(builder):
    builder.StartObject(29)

def Start(builder):
    MtiHRR_AbridgedStart(builder)

def MtiHRR_AbridgedAddH2(builder, h2):
    builder.PrependInt32Slot(0, h2, 0)

def AddH2(builder, h2):
    MtiHRR_AbridgedAddH2(builder, h2)

def MtiHRR_AbridgedAddH3(builder, h3):
    builder.PrependInt32Slot(1, h3, 0)

def AddH3(builder, h3):
    MtiHRR_AbridgedAddH3(builder, h3)

def MtiHRR_AbridgedAddH4(builder, h4):
    builder.PrependBoolSlot(2, h4, 0)

def AddH4(builder, h4):
    MtiHRR_AbridgedAddH4(builder, h4)

def MtiHRR_AbridgedAddH5(builder, h5):
    builder.PrependInt32Slot(3, h5, 0)

def AddH5(builder, h5):
    MtiHRR_AbridgedAddH5(builder, h5)

def MtiHRR_AbridgedAddH6(builder, h6):
    builder.PrependInt32Slot(4, h6, 0)

def AddH6(builder, h6):
    MtiHRR_AbridgedAddH6(builder, h6)

def MtiHRR_AbridgedAddH7(builder, h7):
    builder.PrependInt32Slot(5, h7, 0)

def AddH7(builder, h7):
    MtiHRR_AbridgedAddH7(builder, h7)

def MtiHRR_AbridgedAddH8(builder, h8):
    builder.PrependInt32Slot(6, h8, 0)

def AddH8(builder, h8):
    MtiHRR_AbridgedAddH8(builder, h8)

def MtiHRR_AbridgedAddH9(builder, h9):
    builder.PrependInt32Slot(7, h9, 0)

def AddH9(builder, h9):
    MtiHRR_AbridgedAddH9(builder, h9)

def MtiHRR_AbridgedAddH10(builder, h10):
    builder.PrependInt32Slot(8, h10, 0)

def AddH10(builder, h10):
    MtiHRR_AbridgedAddH10(builder, h10)

def MtiHRR_AbridgedAddH11(builder, h11):
    builder.PrependFloat64Slot(9, h11, 0.0)

def AddH11(builder, h11):
    MtiHRR_AbridgedAddH11(builder, h11)

def MtiHRR_AbridgedAddH12(builder, h12):
    builder.PrependFloat64Slot(10, h12, 0.0)

def AddH12(builder, h12):
    MtiHRR_AbridgedAddH12(builder, h12)

def MtiHRR_AbridgedAddH13(builder, h13):
    builder.PrependFloat64Slot(11, h13, 0.0)

def AddH13(builder, h13):
    MtiHRR_AbridgedAddH13(builder, h13)

def MtiHRR_AbridgedAddH14(builder, h14):
    builder.PrependFloat64Slot(12, h14, 0.0)

def AddH14(builder, h14):
    MtiHRR_AbridgedAddH14(builder, h14)

def MtiHRR_AbridgedAddH15(builder, h15):
    builder.PrependFloat64Slot(13, h15, 0.0)

def AddH15(builder, h15):
    MtiHRR_AbridgedAddH15(builder, h15)

def MtiHRR_AbridgedAddH16(builder, h16):
    builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(h16), 0)

def AddH16(builder, h16):
    MtiHRR_AbridgedAddH16(builder, h16)

def MtiHRR_AbridgedAddH17(builder, h17):
    builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(h17), 0)

def AddH17(builder, h17):
    MtiHRR_AbridgedAddH17(builder, h17)

def MtiHRR_AbridgedAddH18(builder, h18):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(h18), 0)

def AddH18(builder, h18):
    MtiHRR_AbridgedAddH18(builder, h18)

def MtiHRR_AbridgedAddH19(builder, h19):
    builder.PrependFloat64Slot(17, h19, 0.0)

def AddH19(builder, h19):
    MtiHRR_AbridgedAddH19(builder, h19)

def MtiHRR_AbridgedAddH20(builder, h20):
    builder.PrependInt32Slot(18, h20, 0)

def AddH20(builder, h20):
    MtiHRR_AbridgedAddH20(builder, h20)

def MtiHRR_AbridgedAddH21(builder, h21):
    builder.PrependInt32Slot(19, h21, 0)

def AddH21(builder, h21):
    MtiHRR_AbridgedAddH21(builder, h21)

def MtiHRR_AbridgedAddH22(builder, h22):
    builder.PrependInt32Slot(20, h22, 0)

def AddH22(builder, h22):
    MtiHRR_AbridgedAddH22(builder, h22)

def MtiHRR_AbridgedAddH23(builder, h23):
    builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(h23), 0)

def AddH23(builder, h23):
    MtiHRR_AbridgedAddH23(builder, h23)

def MtiHRR_AbridgedAddH24(builder, h24):
    builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(h24), 0)

def AddH24(builder, h24):
    MtiHRR_AbridgedAddH24(builder, h24)

def MtiHRR_AbridgedAddH27(builder, h27):
    builder.PrependInt32Slot(23, h27, 0)

def AddH27(builder, h27):
    MtiHRR_AbridgedAddH27(builder, h27)

def MtiHRR_AbridgedAddH28(builder, h28):
    builder.PrependInt64Slot(24, h28, 0)

def AddH28(builder, h28):
    MtiHRR_AbridgedAddH28(builder, h28)

def MtiHRR_AbridgedAddH29(builder, h29):
    builder.PrependInt32Slot(25, h29, 0)

def AddH29(builder, h29):
    MtiHRR_AbridgedAddH29(builder, h29)

def MtiHRR_AbridgedAddH30(builder, h30):
    builder.PrependInt32Slot(26, h30, 0)

def AddH30(builder, h30):
    MtiHRR_AbridgedAddH30(builder, h30)

def MtiHRR_AbridgedAddH31(builder, h31):
    builder.PrependInt32Slot(27, h31, 0)

def AddH31(builder, h31):
    MtiHRR_AbridgedAddH31(builder, h31)

def MtiHRR_AbridgedAddH32(builder, h32):
    builder.PrependUOffsetTRelativeSlot(28, flatbuffers.number_types.UOffsetTFlags.py_type(h32), 0)

def AddH32(builder, h32):
    MtiHRR_AbridgedAddH32(builder, h32)

def MtiHRR_AbridgedStartH32Vector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartH32Vector(builder, numElems):
    return MtiHRR_AbridgedStartH32Vector(builder, numElems)

def MtiHRR_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return MtiHRR_AbridgedEnd(builder)
...
class MtiHRR_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        mtiHrrAbridged = MtiHRR_Abridged()
        mtiHrrAbridged.Init(buf, pos)
        return cls.InitFromObj(mtiHrrAbridged)
    ...
    @classmethod
    def InitFromObj(cls, mtiHrrAbridged):
        x = MtiHRR_AbridgedT()
        x._UnPack(mtiHrrAbridged)
        return x

    # MtiHRR_AbridgedT
    def _UnPack(self, mtiHrrAbridged):
        if mtiHrrAbridged is None:
            return
        self.h2 = mtiHrrAbridged.H2()
        self.h3 = mtiHrrAbridged.H3()
        self.h4 = mtiHrrAbridged.H4()
        self.h5 = mtiHrrAbridged.H5()
        self.h6 = mtiHrrAbridged.H6()
        self.h7 = mtiHrrAbridged.H7()
        self.h8 = mtiHrrAbridged.H8()
        self.h9 = mtiHrrAbridged.H9()
        self.h10 = mtiHrrAbridged.H10()
        self.h11 = mtiHrrAbridged.H11()
        self.h12 = mtiHrrAbridged.H12()
        self.h13 = mtiHrrAbridged.H13()
        self.h14 = mtiHrrAbridged.H14()
        self.h15 = mtiHrrAbridged.H15()
        self.h16 = mtiHrrAbridged.H16()
        self.h17 = mtiHrrAbridged.H17()
        self.h18 = mtiHrrAbridged.H18()
        self.h19 = mtiHrrAbridged.H19()
        self.h20 = mtiHrrAbridged.H20()
        self.h21 = mtiHrrAbridged.H21()
        self.h22 = mtiHrrAbridged.H22()
        self.h23 = mtiHrrAbridged.H23()
        self.h24 = mtiHrrAbridged.H24()
        self.h27 = mtiHrrAbridged.H27()
        self.h28 = mtiHrrAbridged.H28()
        self.h29 = mtiHrrAbridged.H29()
        self.h30 = mtiHrrAbridged.H30()
        self.h31 = mtiHrrAbridged.H31()
        if not mtiHrrAbridged.H32IsNone():
            self.h32 = []
            for i in range(mtiHrrAbridged.H32Length()):
                self.h32.append(mtiHrrAbridged.H32(i))
    ...
    def Pack(self, builder):
        ...
        if self.h32 is not None:
            ...
            MtiHRR_AbridgedStartH32Vector(builder, len(self.h32))
            for i in reversed(range(len(self.h32))):
                builder.PrependUOffsetTRelative(h32list[i])
            h32 = builder.EndVector()
        MtiHRR_AbridgedStart(builder)
        MtiHRR_AbridgedAddH2(builder, self.h2)
        MtiHRR_AbridgedAddH3(builder, self.h3)
        MtiHRR_AbridgedAddH4(builder, self.h4)
        MtiHRR_AbridgedAddH5(builder, self.h5)
        MtiHRR_AbridgedAddH6(builder, self.h6)
        MtiHRR_AbridgedAddH7(builder, self.h7)
        MtiHRR_AbridgedAddH8(builder, self.h8)
        MtiHRR_AbridgedAddH9(builder, self.h9)
        MtiHRR_AbridgedAddH10(builder, self.h10)
        MtiHRR_AbridgedAddH11(builder, self.h11)
        MtiHRR_AbridgedAddH12(builder, self.h12)
        MtiHRR_AbridgedAddH13(builder, self.h13)
        MtiHRR_AbridgedAddH14(builder, self.h14)
        MtiHRR_AbridgedAddH15(builder, self.h15)
        if self.h16 is not None:
            MtiHRR_AbridgedAddH16(builder, h16)
        if self.h17 is not None:
            MtiHRR_AbridgedAddH17(builder, h17)
        if self.h18 is not None:
            MtiHRR_AbridgedAddH18(builder, h18)
        MtiHRR_AbridgedAddH19(builder, self.h19)
        MtiHRR_AbridgedAddH20(builder, self.h20)
        MtiHRR_AbridgedAddH21(builder, self.h21)
        MtiHRR_AbridgedAddH22(builder, self.h22)
        if self.h23 is not None:
            MtiHRR_AbridgedAddH23(builder, h23)
        if self.h24 is not None:
            MtiHRR_AbridgedAddH24(builder, h24)
        MtiHRR_AbridgedAddH27(builder, self.h27)
        MtiHRR_AbridgedAddH28(builder, self.h28)
        MtiHRR_AbridgedAddH29(builder, self.h29)
        MtiHRR_AbridgedAddH30(builder, self.h30)
        MtiHRR_AbridgedAddH31(builder, self.h31)
        if self.h32 is not None:
            MtiHRR_AbridgedAddH32(builder, h32)
        mtiHrrAbridged = MtiHRR_AbridgedEnd(builder)
        return mtiHrrAbridged
