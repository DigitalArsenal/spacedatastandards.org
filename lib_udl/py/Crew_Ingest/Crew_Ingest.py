...
class Crew_Ingest(object):
    ...
    @classmethod
    def GetRootAsCrew_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def Crew_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def Crew_IngestStart(builder):
    builder.StartObject(23)

def Start(builder):
    Crew_IngestStart(builder)

def Crew_IngestAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    Crew_IngestAddId(builder, id)

def Crew_IngestAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    Crew_IngestAddClassificationMarking(builder, classificationMarking)

def Crew_IngestAddOrigCrewId(builder, origCrewId):
...
def AddOrigCrewId(builder, origCrewId):
    Crew_IngestAddOrigCrewId(builder, origCrewId)

def Crew_IngestAddCrewName(builder, crewName):
...
def AddCrewName(builder, crewName):
    Crew_IngestAddCrewName(builder, crewName)

def Crew_IngestAddStatus(builder, status):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(status), 0)

def AddStatus(builder, status):
    Crew_IngestAddStatus(builder, status)

def Crew_IngestAddIdSortie(builder, idSortie):
...
def AddIdSortie(builder, idSortie):
    Crew_IngestAddIdSortie(builder, idSortie)

def Crew_IngestAddLegalAlertTime(builder, legalAlertTime):
...
def AddLegalAlertTime(builder, legalAlertTime):
    Crew_IngestAddLegalAlertTime(builder, legalAlertTime)

def Crew_IngestAddLegalBravoTime(builder, legalBravoTime):
...
def AddLegalBravoTime(builder, legalBravoTime):
    Crew_IngestAddLegalBravoTime(builder, legalBravoTime)

def Crew_IngestAddAlertedTime(builder, alertedTime):
...
def AddAlertedTime(builder, alertedTime):
    Crew_IngestAddAlertedTime(builder, alertedTime)

def Crew_IngestAddReturnTime(builder, returnTime):
...
def AddReturnTime(builder, returnTime):
    Crew_IngestAddReturnTime(builder, returnTime)

def Crew_IngestAddFdpEligType(builder, fdpEligType):
...
def AddFdpEligType(builder, fdpEligType):
    Crew_IngestAddFdpEligType(builder, fdpEligType)

def Crew_IngestAddFdpType(builder, fdpType):
...
def AddFdpType(builder, fdpType):
    Crew_IngestAddFdpType(builder, fdpType)

def Crew_IngestAddCrewType(builder, crewType):
...
def AddCrewType(builder, crewType):
    Crew_IngestAddCrewType(builder, crewType)

def Crew_IngestAddArmsCrewUnit(builder, armsCrewUnit):
...
def AddArmsCrewUnit(builder, armsCrewUnit):
    Crew_IngestAddArmsCrewUnit(builder, armsCrewUnit)

def Crew_IngestAddCrewMembers(builder, crewMembers):
...
def AddCrewMembers(builder, crewMembers):
    Crew_IngestAddCrewMembers(builder, crewMembers)

def Crew_IngestStartCrewMembersVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartCrewMembersVector(builder, numElems):
    return Crew_IngestStartCrewMembersVector(builder, numElems)

def Crew_IngestAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    Crew_IngestAddCreatedAt(builder, createdAt)

def Crew_IngestAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    Crew_IngestAddCreatedBy(builder, createdBy)

def Crew_IngestAddUpdatedAt(builder, updatedAt):
    builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(updatedAt), 0)

def AddUpdatedAt(builder, updatedAt):
    Crew_IngestAddUpdatedAt(builder, updatedAt)

def Crew_IngestAddUpdatedBy(builder, updatedBy):
...
def AddUpdatedBy(builder, updatedBy):
    Crew_IngestAddUpdatedBy(builder, updatedBy)

def Crew_IngestAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    Crew_IngestAddSource(builder, source)

def Crew_IngestAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    Crew_IngestAddOrigin(builder, origin)

def Crew_IngestAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    Crew_IngestAddOrigNetwork(builder, origNetwork)

def Crew_IngestAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(22, dataMode, 0)

def AddDataMode(builder, dataMode):
    Crew_IngestAddDataMode(builder, dataMode)

def Crew_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return Crew_IngestEnd(builder)
...
class Crew_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        crewIngest = Crew_Ingest()
        crewIngest.Init(buf, pos)
        return cls.InitFromObj(crewIngest)
    ...
    @classmethod
    def InitFromObj(cls, crewIngest):
        x = Crew_IngestT()
        x._UnPack(crewIngest)
        return x

    # Crew_IngestT
    def _UnPack(self, crewIngest):
        if crewIngest is None:
            return
        self.id = crewIngest.Id()
        self.classificationMarking = crewIngest.ClassificationMarking()
        self.origCrewId = crewIngest.OrigCrewId()
        self.crewName = crewIngest.CrewName()
        self.status = crewIngest.Status()
        self.idSortie = crewIngest.IdSortie()
        self.legalAlertTime = crewIngest.LegalAlertTime()
        self.legalBravoTime = crewIngest.LegalBravoTime()
        self.alertedTime = crewIngest.AlertedTime()
        self.returnTime = crewIngest.ReturnTime()
        self.fdpEligType = crewIngest.FdpEligType()
        self.fdpType = crewIngest.FdpType()
        self.crewType = crewIngest.CrewType()
        self.armsCrewUnit = crewIngest.ArmsCrewUnit()
        if not crewIngest.CrewMembersIsNone():
            self.crewMembers = []
            for i in range(crewIngest.CrewMembersLength()):
                self.crewMembers.append(crewIngest.CrewMembers(i))
        self.createdAt = crewIngest.CreatedAt()
        self.createdBy = crewIngest.CreatedBy()
        self.updatedAt = crewIngest.UpdatedAt()
        self.updatedBy = crewIngest.UpdatedBy()
        self.source = crewIngest.Source()
        self.origin = crewIngest.Origin()
        self.origNetwork = crewIngest.OrigNetwork()
        self.dataMode = crewIngest.DataMode()
    ...
    def Pack(self, builder):
        ...
        if self.crewMembers is not None:
            ...
            Crew_IngestStartCrewMembersVector(builder, len(self.crewMembers))
        ...
        if self.origNetwork is not None:
            Crew_IngestAddOrigNetwork(builder, origNetwork)
        Crew_IngestAddDataMode(builder, self.dataMode)
        crewIngest = Crew_IngestEnd(builder)
        return crewIngest
