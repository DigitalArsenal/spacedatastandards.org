...
class ItemTracking_Ingest(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsItemTracking_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def ItemTracking_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def ItemTracking_IngestStart(builder):
    builder.StartObject(22)

def Start(builder):
    ItemTracking_IngestStart(builder)

def ItemTracking_IngestAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    ItemTracking_IngestAddId(builder, id)

def ItemTracking_IngestAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    ItemTracking_IngestAddClassificationMarking(builder, classificationMarking)

def ItemTracking_IngestAddScanCode(builder, scanCode):
...
def AddScanCode(builder, scanCode):
    ItemTracking_IngestAddScanCode(builder, scanCode)

def ItemTracking_IngestAddScGenTool(builder, scGenTool):
...
def AddScGenTool(builder, scGenTool):
    ItemTracking_IngestAddScGenTool(builder, scGenTool)

def ItemTracking_IngestAddScannerId(builder, scannerId):
...
def AddScannerId(builder, scannerId):
    ItemTracking_IngestAddScannerId(builder, scannerId)

def ItemTracking_IngestAddTs(builder, ts):
    builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(ts), 0)

def AddTs(builder, ts):
    ItemTracking_IngestAddTs(builder, ts)

def ItemTracking_IngestAddIdItem(builder, idItem):
...
def AddIdItem(builder, idItem):
    ItemTracking_IngestAddIdItem(builder, idItem)

def ItemTracking_IngestAddType(builder, type):
    builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(type), 0)

def AddType(builder, type):
    ItemTracking_IngestAddType(builder, type)

def ItemTracking_IngestAddLat(builder, lat):
    builder.PrependFloat64Slot(8, lat, 0.0)

def AddLat(builder, lat):
    ItemTracking_IngestAddLat(builder, lat)

def ItemTracking_IngestAddLon(builder, lon):
    builder.PrependFloat64Slot(9, lon, 0.0)

def AddLon(builder, lon):
    ItemTracking_IngestAddLon(builder, lon)

def ItemTracking_IngestAddScanType(builder, scanType):
...
def AddScanType(builder, scanType):
    ItemTracking_IngestAddScanType(builder, scanType)

def ItemTracking_IngestAddDvCode(builder, dvCode):
...
def AddDvCode(builder, dvCode):
    ItemTracking_IngestAddDvCode(builder, dvCode)

def ItemTracking_IngestAddNotes(builder, notes):
    builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(notes), 0)

def AddNotes(builder, notes):
    ItemTracking_IngestAddNotes(builder, notes)

def ItemTracking_IngestAddKeys(builder, keys):
    builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(keys), 0)

def AddKeys(builder, keys):
    ItemTracking_IngestAddKeys(builder, keys)

def ItemTracking_IngestStartKeysVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartKeysVector(builder, numElems):
    return ItemTracking_IngestStartKeysVector(builder, numElems)

def ItemTracking_IngestAddValues(builder, values):
    builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(values), 0)

def AddValues(builder, values):
    ItemTracking_IngestAddValues(builder, values)

def ItemTracking_IngestStartValuesVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartValuesVector(builder, numElems):
    return ItemTracking_IngestStartValuesVector(builder, numElems)

def ItemTracking_IngestAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    ItemTracking_IngestAddCreatedAt(builder, createdAt)

def ItemTracking_IngestAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    ItemTracking_IngestAddCreatedBy(builder, createdBy)

def ItemTracking_IngestAddSourceDl(builder, sourceDl):
...
def AddSourceDl(builder, sourceDl):
    ItemTracking_IngestAddSourceDl(builder, sourceDl)

def ItemTracking_IngestAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    ItemTracking_IngestAddSource(builder, source)

def ItemTracking_IngestAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    ItemTracking_IngestAddOrigin(builder, origin)

def ItemTracking_IngestAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    ItemTracking_IngestAddOrigNetwork(builder, origNetwork)

def ItemTracking_IngestAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(21, dataMode, 0)

def AddDataMode(builder, dataMode):
    ItemTracking_IngestAddDataMode(builder, dataMode)

def ItemTracking_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return ItemTracking_IngestEnd(builder)
...
class ItemTracking_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        itemTrackingIngest = ItemTracking_Ingest()
        itemTrackingIngest.Init(buf, pos)
        return cls.InitFromObj(itemTrackingIngest)
    ...
    @classmethod
    def InitFromObj(cls, itemTrackingIngest):
        x = ItemTracking_IngestT()
        x._UnPack(itemTrackingIngest)
        return x

    # ItemTracking_IngestT
    def _UnPack(self, itemTrackingIngest):
        if itemTrackingIngest is None:
            return
        self.id = itemTrackingIngest.Id()
        self.classificationMarking = itemTrackingIngest.ClassificationMarking()
        self.scanCode = itemTrackingIngest.ScanCode()
        self.scGenTool = itemTrackingIngest.ScGenTool()
        self.scannerId = itemTrackingIngest.ScannerId()
        self.ts = itemTrackingIngest.Ts()
        self.idItem = itemTrackingIngest.IdItem()
        self.type = itemTrackingIngest.Type()
        self.lat = itemTrackingIngest.Lat()
        self.lon = itemTrackingIngest.Lon()
        self.scanType = itemTrackingIngest.ScanType()
        self.dvCode = itemTrackingIngest.DvCode()
        self.notes = itemTrackingIngest.Notes()
        if not itemTrackingIngest.KeysIsNone():
            self.keys = []
            for i in range(itemTrackingIngest.KeysLength()):
                self.keys.append(itemTrackingIngest.Keys(i))
        if not itemTrackingIngest.ValuesIsNone():
            self.values = []
            for i in range(itemTrackingIngest.ValuesLength()):
                self.values.append(itemTrackingIngest.Values(i))
        self.createdAt = itemTrackingIngest.CreatedAt()
        self.createdBy = itemTrackingIngest.CreatedBy()
        self.sourceDl = itemTrackingIngest.SourceDl()
        self.source = itemTrackingIngest.Source()
        self.origin = itemTrackingIngest.Origin()
        self.origNetwork = itemTrackingIngest.OrigNetwork()
        self.dataMode = itemTrackingIngest.DataMode()
    ...
    def Pack(self, builder):
        ...
        if self.keys is not None:
            ...
            ItemTracking_IngestStartKeysVector(builder, len(self.keys))
        ...
        if self.values is not None:
            ...
            ItemTracking_IngestStartValuesVector(builder, len(self.values))
        ...
        if self.type is not None:
            ItemTracking_IngestAddType(builder, type)
        ItemTracking_IngestAddLat(builder, self.lat)
        ItemTracking_IngestAddLon(builder, self.lon)
        if self.scanType is not None:
            ItemTracking_IngestAddScanType(builder, scanType)
        if self.dvCode is not None:
            ItemTracking_IngestAddDvCode(builder, dvCode)
        ...
        if self.origNetwork is not None:
            ItemTracking_IngestAddOrigNetwork(builder, origNetwork)
        ItemTracking_IngestAddDataMode(builder, self.dataMode)
        itemTrackingIngest = ItemTracking_IngestEnd(builder)
        return itemTrackingIngest
