...
class DataLinkOps_Full(object):
    ...
    @classmethod
    def GetRootAsDataLinkOps_Full(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def DataLinkOps_FullBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def DataLinkOps_FullStart(builder):
    builder.StartObject(5)

def Start(builder):
    DataLinkOps_FullStart(builder)

def DataLinkOps_FullAddLinkName(builder, linkName):
...
def AddLinkName(builder, linkName):
    DataLinkOps_FullAddLinkName(builder, linkName)

def DataLinkOps_FullAddLinkStartTime(builder, linkStartTime):
...
def AddLinkStartTime(builder, linkStartTime):
    DataLinkOps_FullAddLinkStartTime(builder, linkStartTime)

def DataLinkOps_FullAddLinkStopTime(builder, linkStopTime):
...
def AddLinkStopTime(builder, linkStopTime):
    DataLinkOps_FullAddLinkStopTime(builder, linkStopTime)

def DataLinkOps_FullAddLinkStopTimeMod(builder, linkStopTimeMod):
...
def AddLinkStopTimeMod(builder, linkStopTimeMod):
    DataLinkOps_FullAddLinkStopTimeMod(builder, linkStopTimeMod)

def DataLinkOps_FullAddLinkDetails(builder, linkDetails):
...
def AddLinkDetails(builder, linkDetails):
    DataLinkOps_FullAddLinkDetails(builder, linkDetails)

def DataLinkOps_FullEnd(builder):
    return builder.EndObject()

def End(builder):
    return DataLinkOps_FullEnd(builder)


class DataLinkOps_FullT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        dataLinkOpsFull = DataLinkOps_Full()
        dataLinkOpsFull.Init(buf, pos)
        return cls.InitFromObj(dataLinkOpsFull)
    ...
    @classmethod
    def InitFromObj(cls, dataLinkOpsFull):
        x = DataLinkOps_FullT()
        x._UnPack(dataLinkOpsFull)
        return x

    # DataLinkOps_FullT
    def _UnPack(self, dataLinkOpsFull):
        if dataLinkOpsFull is None:
            return
        self.linkName = dataLinkOpsFull.LinkName()
        self.linkStartTime = dataLinkOpsFull.LinkStartTime()
        self.linkStopTime = dataLinkOpsFull.LinkStopTime()
        self.linkStopTimeMod = dataLinkOpsFull.LinkStopTimeMod()
        self.linkDetails = dataLinkOpsFull.LinkDetails()
    ...
    def Pack(self, builder):
        ...
        if self.linkDetails is not None:
            DataLinkOps_FullAddLinkDetails(builder, linkDetails)
        dataLinkOpsFull = DataLinkOps_FullEnd(builder)
        return dataLinkOpsFull
