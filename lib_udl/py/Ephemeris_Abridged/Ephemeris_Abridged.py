...
class Ephemeris_Abridged(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsEphemeris_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def Ephemeris_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def Ephemeris_AbridgedStart(builder):
    builder.StartObject(21)

def Start(builder):
    Ephemeris_AbridgedStart(builder)

def Ephemeris_AbridgedAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    Ephemeris_AbridgedAddId(builder, id)

def Ephemeris_AbridgedAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    Ephemeris_AbridgedAddClassificationMarking(builder, classificationMarking)

def Ephemeris_AbridgedAddEsId(builder, esId):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(esId), 0)

def AddEsId(builder, esId):
    Ephemeris_AbridgedAddEsId(builder, esId)

def Ephemeris_AbridgedAddTs(builder, ts):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(ts), 0)

def AddTs(builder, ts):
    Ephemeris_AbridgedAddTs(builder, ts)

def Ephemeris_AbridgedAddXpos(builder, xpos):
    builder.PrependFloat64Slot(4, xpos, 0.0)

def AddXpos(builder, xpos):
    Ephemeris_AbridgedAddXpos(builder, xpos)

def Ephemeris_AbridgedAddYpos(builder, ypos):
    builder.PrependFloat64Slot(5, ypos, 0.0)

def AddYpos(builder, ypos):
    Ephemeris_AbridgedAddYpos(builder, ypos)

def Ephemeris_AbridgedAddZpos(builder, zpos):
    builder.PrependFloat64Slot(6, zpos, 0.0)

def AddZpos(builder, zpos):
    Ephemeris_AbridgedAddZpos(builder, zpos)

def Ephemeris_AbridgedAddXvel(builder, xvel):
    builder.PrependFloat64Slot(7, xvel, 0.0)

def AddXvel(builder, xvel):
    Ephemeris_AbridgedAddXvel(builder, xvel)

def Ephemeris_AbridgedAddYvel(builder, yvel):
    builder.PrependFloat64Slot(8, yvel, 0.0)

def AddYvel(builder, yvel):
    Ephemeris_AbridgedAddYvel(builder, yvel)

def Ephemeris_AbridgedAddZvel(builder, zvel):
    builder.PrependFloat64Slot(9, zvel, 0.0)

def AddZvel(builder, zvel):
    Ephemeris_AbridgedAddZvel(builder, zvel)

def Ephemeris_AbridgedAddXaccel(builder, xaccel):
    builder.PrependFloat64Slot(10, xaccel, 0.0)

def AddXaccel(builder, xaccel):
    Ephemeris_AbridgedAddXaccel(builder, xaccel)

def Ephemeris_AbridgedAddYaccel(builder, yaccel):
    builder.PrependFloat64Slot(11, yaccel, 0.0)

def AddYaccel(builder, yaccel):
    Ephemeris_AbridgedAddYaccel(builder, yaccel)

def Ephemeris_AbridgedAddZaccel(builder, zaccel):
    builder.PrependFloat64Slot(12, zaccel, 0.0)

def AddZaccel(builder, zaccel):
    Ephemeris_AbridgedAddZaccel(builder, zaccel)

def Ephemeris_AbridgedAddCov(builder, cov):
    builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(cov), 0)

def AddCov(builder, cov):
    Ephemeris_AbridgedAddCov(builder, cov)

def Ephemeris_AbridgedStartCovVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartCovVector(builder, numElems):
    return Ephemeris_AbridgedStartCovVector(builder, numElems)

def Ephemeris_AbridgedAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    Ephemeris_AbridgedAddCreatedAt(builder, createdAt)

def Ephemeris_AbridgedAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    Ephemeris_AbridgedAddCreatedBy(builder, createdBy)

def Ephemeris_AbridgedAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    Ephemeris_AbridgedAddSource(builder, source)

def Ephemeris_AbridgedAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(17, dataMode, 0)

def AddDataMode(builder, dataMode):
    Ephemeris_AbridgedAddDataMode(builder, dataMode)

def Ephemeris_AbridgedAddIdOnOrbit(builder, idOnOrbit):
...
def AddIdOnOrbit(builder, idOnOrbit):
    Ephemeris_AbridgedAddIdOnOrbit(builder, idOnOrbit)

def Ephemeris_AbridgedAddOrigObjectId(builder, origObjectId):
...
def AddOrigObjectId(builder, origObjectId):
    Ephemeris_AbridgedAddOrigObjectId(builder, origObjectId)

def Ephemeris_AbridgedAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    Ephemeris_AbridgedAddOrigin(builder, origin)

def Ephemeris_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return Ephemeris_AbridgedEnd(builder)
...
class Ephemeris_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        ephemerisAbridged = Ephemeris_Abridged()
        ephemerisAbridged.Init(buf, pos)
        return cls.InitFromObj(ephemerisAbridged)
    ...
    @classmethod
    def InitFromObj(cls, ephemerisAbridged):
        x = Ephemeris_AbridgedT()
        x._UnPack(ephemerisAbridged)
        return x

    # Ephemeris_AbridgedT
    def _UnPack(self, ephemerisAbridged):
        if ephemerisAbridged is None:
            return
        self.id = ephemerisAbridged.Id()
        self.classificationMarking = ephemerisAbridged.ClassificationMarking()
        self.esId = ephemerisAbridged.EsId()
        self.ts = ephemerisAbridged.Ts()
        self.xpos = ephemerisAbridged.Xpos()
        self.ypos = ephemerisAbridged.Ypos()
        self.zpos = ephemerisAbridged.Zpos()
        self.xvel = ephemerisAbridged.Xvel()
        self.yvel = ephemerisAbridged.Yvel()
        self.zvel = ephemerisAbridged.Zvel()
        self.xaccel = ephemerisAbridged.Xaccel()
        self.yaccel = ephemerisAbridged.Yaccel()
        self.zaccel = ephemerisAbridged.Zaccel()
        if not ephemerisAbridged.CovIsNone():
            self.cov = []
            for i in range(ephemerisAbridged.CovLength()):
                self.cov.append(ephemerisAbridged.Cov(i))
        self.createdAt = ephemerisAbridged.CreatedAt()
        self.createdBy = ephemerisAbridged.CreatedBy()
        self.source = ephemerisAbridged.Source()
        self.dataMode = ephemerisAbridged.DataMode()
        self.idOnOrbit = ephemerisAbridged.IdOnOrbit()
        self.origObjectId = ephemerisAbridged.OrigObjectId()
        self.origin = ephemerisAbridged.Origin()
    ...
    def Pack(self, builder):
        ...
        if self.cov is not None:
            ...
            Ephemeris_AbridgedStartCovVector(builder, len(self.cov))
        ...
        if self.ts is not None:
            Ephemeris_AbridgedAddTs(builder, ts)
        Ephemeris_AbridgedAddXpos(builder, self.xpos)
        Ephemeris_AbridgedAddYpos(builder, self.ypos)
        Ephemeris_AbridgedAddZpos(builder, self.zpos)
        Ephemeris_AbridgedAddXvel(builder, self.xvel)
        Ephemeris_AbridgedAddYvel(builder, self.yvel)
        Ephemeris_AbridgedAddZvel(builder, self.zvel)
        Ephemeris_AbridgedAddXaccel(builder, self.xaccel)
        Ephemeris_AbridgedAddYaccel(builder, self.yaccel)
        Ephemeris_AbridgedAddZaccel(builder, self.zaccel)
        if self.cov is not None:
            Ephemeris_AbridgedAddCov(builder, cov)
        if self.createdAt is not None:
            Ephemeris_AbridgedAddCreatedAt(builder, createdAt)
        ...
        if self.source is not None:
            Ephemeris_AbridgedAddSource(builder, source)
        Ephemeris_AbridgedAddDataMode(builder, self.dataMode)
        if self.idOnOrbit is not None:
            Ephemeris_AbridgedAddIdOnOrbit(builder, idOnOrbit)
        if self.origObjectId is not None:
            Ephemeris_AbridgedAddOrigObjectId(builder, origObjectId)
        if self.origin is not None:
            Ephemeris_AbridgedAddOrigin(builder, origin)
        ephemerisAbridged = Ephemeris_AbridgedEnd(builder)
        return ephemerisAbridged
