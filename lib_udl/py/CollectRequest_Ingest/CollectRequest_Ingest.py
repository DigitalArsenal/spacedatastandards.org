...
class CollectRequest_Ingest(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsCollectRequest_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def CollectRequest_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def CollectRequest_IngestStart(builder):
    builder.StartObject(88)

def Start(builder):
    CollectRequest_IngestStart(builder)

def CollectRequest_IngestAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    CollectRequest_IngestAddId(builder, id)

def CollectRequest_IngestAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    CollectRequest_IngestAddClassificationMarking(builder, classificationMarking)

def CollectRequest_IngestAddIdParentReq(builder, idParentReq):
...
def AddIdParentReq(builder, idParentReq):
    CollectRequest_IngestAddIdParentReq(builder, idParentReq)

def CollectRequest_IngestAddMsgType(builder, msgType):
...
def AddMsgType(builder, msgType):
    CollectRequest_IngestAddMsgType(builder, msgType)

def CollectRequest_IngestAddMsgCreateDate(builder, msgCreateDate):
...
def AddMsgCreateDate(builder, msgCreateDate):
    CollectRequest_IngestAddMsgCreateDate(builder, msgCreateDate)

def CollectRequest_IngestAddType(builder, type):
    builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(type), 0)

def AddType(builder, type):
    CollectRequest_IngestAddType(builder, type)

def CollectRequest_IngestAddIdPlan(builder, idPlan):
...
def AddIdPlan(builder, idPlan):
    CollectRequest_IngestAddIdPlan(builder, idPlan)

def CollectRequest_IngestAddPlanIndex(builder, planIndex):
    builder.PrependInt32Slot(7, planIndex, 0)

def AddPlanIndex(builder, planIndex):
    CollectRequest_IngestAddPlanIndex(builder, planIndex)

def CollectRequest_IngestAddTaskId(builder, taskId):
...
def AddTaskId(builder, taskId):
    CollectRequest_IngestAddTaskId(builder, taskId)

def CollectRequest_IngestAddDwellId(builder, dwellId):
...
def AddDwellId(builder, dwellId):
    CollectRequest_IngestAddDwellId(builder, dwellId)

def CollectRequest_IngestAddExternalId(builder, externalId):
...
def AddExternalId(builder, externalId):
    CollectRequest_IngestAddExternalId(builder, externalId)

def CollectRequest_IngestAddIdSensor(builder, idSensor):
...
def AddIdSensor(builder, idSensor):
    CollectRequest_IngestAddIdSensor(builder, idSensor)

def CollectRequest_IngestAddOrigSensorId(builder, origSensorId):
...
def AddOrigSensorId(builder, origSensorId):
    CollectRequest_IngestAddOrigSensorId(builder, origSensorId)

def CollectRequest_IngestAddObType(builder, obType):
...
def AddObType(builder, obType):
    CollectRequest_IngestAddObType(builder, obType)

def CollectRequest_IngestAddPriority(builder, priority):
...
def AddPriority(builder, priority):
    CollectRequest_IngestAddPriority(builder, priority)

def CollectRequest_IngestAddTaskCategory(builder, taskCategory):
    builder.PrependInt32Slot(15, taskCategory, 0)

def AddTaskCategory(builder, taskCategory):
    CollectRequest_IngestAddTaskCategory(builder, taskCategory)

def CollectRequest_IngestAddSuffix(builder, suffix):
...
def AddSuffix(builder, suffix):
    CollectRequest_IngestAddSuffix(builder, suffix)

def CollectRequest_IngestAddUctFollowUp(builder, uctFollowUp):
    builder.PrependBoolSlot(17, uctFollowUp, 0)

def AddUctFollowUp(builder, uctFollowUp):
    CollectRequest_IngestAddUctFollowUp(builder, uctFollowUp)

def CollectRequest_IngestAddStartTime(builder, startTime):
...
def AddStartTime(builder, startTime):
    CollectRequest_IngestAddStartTime(builder, startTime)

def CollectRequest_IngestAddEndTime(builder, endTime):
...
def AddEndTime(builder, endTime):
    CollectRequest_IngestAddEndTime(builder, endTime)

def CollectRequest_IngestAddIdOnOrbit(builder, idOnOrbit):
...
def AddIdOnOrbit(builder, idOnOrbit):
    CollectRequest_IngestAddIdOnOrbit(builder, idOnOrbit)

def CollectRequest_IngestAddSatNo(builder, satNo):
    builder.PrependInt32Slot(21, satNo, 0)

def AddSatNo(builder, satNo):
    CollectRequest_IngestAddSatNo(builder, satNo)

def CollectRequest_IngestAddOrigObjectId(builder, origObjectId):
...
def AddOrigObjectId(builder, origObjectId):
    CollectRequest_IngestAddOrigObjectId(builder, origObjectId)

def CollectRequest_IngestAddTaskGroup(builder, taskGroup):
...
def AddTaskGroup(builder, taskGroup):
    CollectRequest_IngestAddTaskGroup(builder, taskGroup)

def CollectRequest_IngestAddIron(builder, iron):
    builder.PrependInt32Slot(24, iron, 0)

def AddIron(builder, iron):
    CollectRequest_IngestAddIron(builder, iron)

def CollectRequest_IngestAddOrbitRegime(builder, orbitRegime):
...
def AddOrbitRegime(builder, orbitRegime):
    CollectRequest_IngestAddOrbitRegime(builder, orbitRegime)

def CollectRequest_IngestAddTargetSize(builder, targetSize):
    builder.PrependFloat64Slot(26, targetSize, 0.0)

def AddTargetSize(builder, targetSize):
    CollectRequest_IngestAddTargetSize(builder, targetSize)

def CollectRequest_IngestAddRcsMin(builder, rcsMin):
    builder.PrependFloat64Slot(27, rcsMin, 0.0)

def AddRcsMin(builder, rcsMin):
    CollectRequest_IngestAddRcsMin(builder, rcsMin)

def CollectRequest_IngestAddRcs(builder, rcs):
    builder.PrependFloat64Slot(28, rcs, 0.0)

def AddRcs(builder, rcs):
    CollectRequest_IngestAddRcs(builder, rcs)

def CollectRequest_IngestAddRcsMax(builder, rcsMax):
    builder.PrependFloat64Slot(29, rcsMax, 0.0)

def AddRcsMax(builder, rcsMax):
    CollectRequest_IngestAddRcsMax(builder, rcsMax)

def CollectRequest_IngestAddFreqMin(builder, freqMin):
    builder.PrependFloat64Slot(30, freqMin, 0.0)

def AddFreqMin(builder, freqMin):
    CollectRequest_IngestAddFreqMin(builder, freqMin)

def CollectRequest_IngestAddFreq(builder, freq):
    builder.PrependFloat64Slot(31, freq, 0.0)

def AddFreq(builder, freq):
    CollectRequest_IngestAddFreq(builder, freq)

def CollectRequest_IngestAddFreqMax(builder, freqMax):
    builder.PrependFloat64Slot(32, freqMax, 0.0)

def AddFreqMax(builder, freqMax):
    CollectRequest_IngestAddFreqMax(builder, freqMax)

def CollectRequest_IngestAddPolarization(builder, polarization):
...
def AddPolarization(builder, polarization):
    CollectRequest_IngestAddPolarization(builder, polarization)

def CollectRequest_IngestAddVisMagMin(builder, visMagMin):
    builder.PrependFloat64Slot(34, visMagMin, 0.0)

def AddVisMagMin(builder, visMagMin):
    CollectRequest_IngestAddVisMagMin(builder, visMagMin)

def CollectRequest_IngestAddVisMag(builder, visMag):
    builder.PrependFloat64Slot(35, visMag, 0.0)

def AddVisMag(builder, visMag):
    CollectRequest_IngestAddVisMag(builder, visMag)

def CollectRequest_IngestAddVisMagMax(builder, visMagMax):
    builder.PrependFloat64Slot(36, visMagMax, 0.0)

def AddVisMagMax(builder, visMagMax):
    CollectRequest_IngestAddVisMagMax(builder, visMagMax)

def CollectRequest_IngestAddSpectralModel(builder, spectralModel):
...
def AddSpectralModel(builder, spectralModel):
    CollectRequest_IngestAddSpectralModel(builder, spectralModel)

def CollectRequest_IngestAddReflectance(builder, reflectance):
    builder.PrependFloat64Slot(38, reflectance, 0.0)

def AddReflectance(builder, reflectance):
    CollectRequest_IngestAddReflectance(builder, reflectance)

def CollectRequest_IngestAddIrradiance(builder, irradiance):
    builder.PrependFloat64Slot(39, irradiance, 0.0)

def AddIrradiance(builder, irradiance):
    CollectRequest_IngestAddIrradiance(builder, irradiance)

def CollectRequest_IngestAddNumFrames(builder, numFrames):
    builder.PrependInt32Slot(40, numFrames, 0)

def AddNumFrames(builder, numFrames):
    CollectRequest_IngestAddNumFrames(builder, numFrames)

def CollectRequest_IngestAddFrameRate(builder, frameRate):
    builder.PrependFloat64Slot(41, frameRate, 0.0)

def AddFrameRate(builder, frameRate):
    CollectRequest_IngestAddFrameRate(builder, frameRate)

def CollectRequest_IngestAddIntegrationTime(builder, integrationTime):
    builder.PrependFloat64Slot(42, integrationTime, 0.0)

def AddIntegrationTime(builder, integrationTime):
    CollectRequest_IngestAddIntegrationTime(builder, integrationTime)

def CollectRequest_IngestAddNumTracks(builder, numTracks):
    builder.PrependInt32Slot(43, numTracks, 0)

def AddNumTracks(builder, numTracks):
    CollectRequest_IngestAddNumTracks(builder, numTracks)

def CollectRequest_IngestAddNumObs(builder, numObs):
    builder.PrependInt32Slot(44, numObs, 0)

def AddNumObs(builder, numObs):
    CollectRequest_IngestAddNumObs(builder, numObs)

def CollectRequest_IngestAddDuration(builder, duration):
    builder.PrependInt32Slot(45, duration, 0)

def AddDuration(builder, duration):
    CollectRequest_IngestAddDuration(builder, duration)

def CollectRequest_IngestAddSrchPattern(builder, srchPattern):
...
def AddSrchPattern(builder, srchPattern):
    CollectRequest_IngestAddSrchPattern(builder, srchPattern)

def CollectRequest_IngestAddScenario(builder, scenario):
...
def AddScenario(builder, scenario):
    CollectRequest_IngestAddScenario(builder, scenario)

def CollectRequest_IngestAddIdElset(builder, idElset):
...
def AddIdElset(builder, idElset):
    CollectRequest_IngestAddIdElset(builder, idElset)

def CollectRequest_IngestAddIdManifold(builder, idManifold):
...
def AddIdManifold(builder, idManifold):
    CollectRequest_IngestAddIdManifold(builder, idManifold)

def CollectRequest_IngestAddIdStateVector(builder, idStateVector):
...
def AddIdStateVector(builder, idStateVector):
    CollectRequest_IngestAddIdStateVector(builder, idStateVector)

def CollectRequest_IngestAddEsId(builder, esId):
    builder.PrependUOffsetTRelativeSlot(51, flatbuffers.number_types.UOffsetTFlags.py_type(esId), 0)

def AddEsId(builder, esId):
    CollectRequest_IngestAddEsId(builder, esId)

def CollectRequest_IngestAddEpoch(builder, epoch):
    builder.PrependUOffsetTRelativeSlot(52, flatbuffers.number_types.UOffsetTFlags.py_type(epoch), 0)

def AddEpoch(builder, epoch):
    CollectRequest_IngestAddEpoch(builder, epoch)

def CollectRequest_IngestAddSemiMajorAxis(builder, semiMajorAxis):
    builder.PrependFloat64Slot(53, semiMajorAxis, 0.0)

def AddSemiMajorAxis(builder, semiMajorAxis):
    CollectRequest_IngestAddSemiMajorAxis(builder, semiMajorAxis)

def CollectRequest_IngestAddEccentricity(builder, eccentricity):
    builder.PrependFloat64Slot(54, eccentricity, 0.0)

def AddEccentricity(builder, eccentricity):
    CollectRequest_IngestAddEccentricity(builder, eccentricity)

def CollectRequest_IngestAddInclination(builder, inclination):
    builder.PrependFloat64Slot(55, inclination, 0.0)

def AddInclination(builder, inclination):
    CollectRequest_IngestAddInclination(builder, inclination)

def CollectRequest_IngestAddRaan(builder, raan):
    builder.PrependFloat64Slot(56, raan, 0.0)

def AddRaan(builder, raan):
    CollectRequest_IngestAddRaan(builder, raan)

def CollectRequest_IngestAddArgOfPerigee(builder, argOfPerigee):
    builder.PrependFloat64Slot(57, argOfPerigee, 0.0)

def AddArgOfPerigee(builder, argOfPerigee):
    CollectRequest_IngestAddArgOfPerigee(builder, argOfPerigee)

def CollectRequest_IngestAddTrueAnomoly(builder, trueAnomoly):
    builder.PrependFloat64Slot(58, trueAnomoly, 0.0)

def AddTrueAnomoly(builder, trueAnomoly):
    CollectRequest_IngestAddTrueAnomoly(builder, trueAnomoly)

def CollectRequest_IngestAddRa(builder, ra):
    builder.PrependFloat64Slot(59, ra, 0.0)

def AddRa(builder, ra):
    CollectRequest_IngestAddRa(builder, ra)

def CollectRequest_IngestAddDec(builder, dec):
    builder.PrependFloat64Slot(60, dec, 0.0)

def AddDec(builder, dec):
    CollectRequest_IngestAddDec(builder, dec)

def CollectRequest_IngestAddAz(builder, az):
    builder.PrependFloat64Slot(61, az, 0.0)

def AddAz(builder, az):
    CollectRequest_IngestAddAz(builder, az)

def CollectRequest_IngestAddEl(builder, el):
    builder.PrependFloat64Slot(62, el, 0.0)

def AddEl(builder, el):
    CollectRequest_IngestAddEl(builder, el)

def CollectRequest_IngestAddRange(builder, range):
    builder.PrependFloat64Slot(63, range, 0.0)

def AddRange(builder, range):
    CollectRequest_IngestAddRange(builder, range)

def CollectRequest_IngestAddExtentAz(builder, extentAz):
    builder.PrependFloat64Slot(64, extentAz, 0.0)

def AddExtentAz(builder, extentAz):
    CollectRequest_IngestAddExtentAz(builder, extentAz)

def CollectRequest_IngestAddExtentEl(builder, extentEl):
    builder.PrependFloat64Slot(65, extentEl, 0.0)

def AddExtentEl(builder, extentEl):
    CollectRequest_IngestAddExtentEl(builder, extentEl)

def CollectRequest_IngestAddExtentRange(builder, extentRange):
    builder.PrependFloat64Slot(66, extentRange, 0.0)

def AddExtentRange(builder, extentRange):
    CollectRequest_IngestAddExtentRange(builder, extentRange)

def CollectRequest_IngestAddLat(builder, lat):
    builder.PrependFloat64Slot(67, lat, 0.0)

def AddLat(builder, lat):
    CollectRequest_IngestAddLat(builder, lat)

def CollectRequest_IngestAddLon(builder, lon):
    builder.PrependFloat64Slot(68, lon, 0.0)

def AddLon(builder, lon):
    CollectRequest_IngestAddLon(builder, lon)

def CollectRequest_IngestAddAlt(builder, alt):
    builder.PrependFloat64Slot(69, alt, 0.0)

def AddAlt(builder, alt):
    CollectRequest_IngestAddAlt(builder, alt)

def CollectRequest_IngestAddStopLat(builder, stopLat):
    builder.PrependFloat64Slot(70, stopLat, 0.0)

def AddStopLat(builder, stopLat):
    CollectRequest_IngestAddStopLat(builder, stopLat)

def CollectRequest_IngestAddStopLon(builder, stopLon):
    builder.PrependFloat64Slot(71, stopLon, 0.0)

def AddStopLon(builder, stopLon):
    CollectRequest_IngestAddStopLon(builder, stopLon)

def CollectRequest_IngestAddStopAlt(builder, stopAlt):
    builder.PrependFloat64Slot(72, stopAlt, 0.0)

def AddStopAlt(builder, stopAlt):
    CollectRequest_IngestAddStopAlt(builder, stopAlt)

def CollectRequest_IngestAddSrchInc(builder, srchInc):
    builder.PrependFloat64Slot(73, srchInc, 0.0)

def AddSrchInc(builder, srchInc):
    CollectRequest_IngestAddSrchInc(builder, srchInc)

def CollectRequest_IngestAddXAngle(builder, xAngle):
    builder.PrependFloat64Slot(74, xAngle, 0.0)

def AddXAngle(builder, xAngle):
    CollectRequest_IngestAddXAngle(builder, xAngle)

def CollectRequest_IngestAddYAngle(builder, yAngle):
    builder.PrependFloat64Slot(75, yAngle, 0.0)

def AddYAngle(builder, yAngle):
    CollectRequest_IngestAddYAngle(builder, yAngle)

def CollectRequest_IngestAddOrientAngle(builder, orientAngle):
    builder.PrependFloat64Slot(76, orientAngle, 0.0)

def AddOrientAngle(builder, orientAngle):
    CollectRequest_IngestAddOrientAngle(builder, orientAngle)

def CollectRequest_IngestAddCustomer(builder, customer):
...
def AddCustomer(builder, customer):
    CollectRequest_IngestAddCustomer(builder, customer)

def CollectRequest_IngestAddNotes(builder, notes):
    builder.PrependUOffsetTRelativeSlot(78, flatbuffers.number_types.UOffsetTFlags.py_type(notes), 0)

def AddNotes(builder, notes):
    CollectRequest_IngestAddNotes(builder, notes)

def CollectRequest_IngestAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(79, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    CollectRequest_IngestAddCreatedAt(builder, createdAt)

def CollectRequest_IngestAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(80, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    CollectRequest_IngestAddCreatedBy(builder, createdBy)

def CollectRequest_IngestAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(81, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    CollectRequest_IngestAddSource(builder, source)

def CollectRequest_IngestAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(82, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    CollectRequest_IngestAddOrigin(builder, origin)

def CollectRequest_IngestAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(83, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    CollectRequest_IngestAddOrigNetwork(builder, origNetwork)

def CollectRequest_IngestAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(84, dataMode, 0)

def AddDataMode(builder, dataMode):
    CollectRequest_IngestAddDataMode(builder, dataMode)

def CollectRequest_IngestAddStateVector(builder, stateVector):
...
def AddStateVector(builder, stateVector):
    CollectRequest_IngestAddStateVector(builder, stateVector)

def CollectRequest_IngestAddElset(builder, elset):
    builder.PrependUOffsetTRelativeSlot(86, flatbuffers.number_types.UOffsetTFlags.py_type(elset), 0)

def AddElset(builder, elset):
    CollectRequest_IngestAddElset(builder, elset)

def CollectRequest_IngestAddTags(builder, tags):
    builder.PrependUOffsetTRelativeSlot(87, flatbuffers.number_types.UOffsetTFlags.py_type(tags), 0)

def AddTags(builder, tags):
    CollectRequest_IngestAddTags(builder, tags)

def CollectRequest_IngestStartTagsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartTagsVector(builder, numElems):
    return CollectRequest_IngestStartTagsVector(builder, numElems)

def CollectRequest_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return CollectRequest_IngestEnd(builder)
...
class CollectRequest_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        collectRequestIngest = CollectRequest_Ingest()
        collectRequestIngest.Init(buf, pos)
        return cls.InitFromObj(collectRequestIngest)
    ...
    @classmethod
    def InitFromObj(cls, collectRequestIngest):
        x = CollectRequest_IngestT()
        x._UnPack(collectRequestIngest)
        return x

    # CollectRequest_IngestT
    def _UnPack(self, collectRequestIngest):
        if collectRequestIngest is None:
            return
        self.id = collectRequestIngest.Id()
        self.classificationMarking = collectRequestIngest.ClassificationMarking()
        self.idParentReq = collectRequestIngest.IdParentReq()
        self.msgType = collectRequestIngest.MsgType()
        self.msgCreateDate = collectRequestIngest.MsgCreateDate()
        self.type = collectRequestIngest.Type()
        self.idPlan = collectRequestIngest.IdPlan()
        self.planIndex = collectRequestIngest.PlanIndex()
        self.taskId = collectRequestIngest.TaskId()
        self.dwellId = collectRequestIngest.DwellId()
        self.externalId = collectRequestIngest.ExternalId()
        self.idSensor = collectRequestIngest.IdSensor()
        self.origSensorId = collectRequestIngest.OrigSensorId()
        self.obType = collectRequestIngest.ObType()
        self.priority = collectRequestIngest.Priority()
        self.taskCategory = collectRequestIngest.TaskCategory()
        self.suffix = collectRequestIngest.Suffix()
        self.uctFollowUp = collectRequestIngest.UctFollowUp()
        self.startTime = collectRequestIngest.StartTime()
        self.endTime = collectRequestIngest.EndTime()
        self.idOnOrbit = collectRequestIngest.IdOnOrbit()
        self.satNo = collectRequestIngest.SatNo()
        self.origObjectId = collectRequestIngest.OrigObjectId()
        self.taskGroup = collectRequestIngest.TaskGroup()
        self.iron = collectRequestIngest.Iron()
        self.orbitRegime = collectRequestIngest.OrbitRegime()
        self.targetSize = collectRequestIngest.TargetSize()
        self.rcsMin = collectRequestIngest.RcsMin()
        self.rcs = collectRequestIngest.Rcs()
        self.rcsMax = collectRequestIngest.RcsMax()
        self.freqMin = collectRequestIngest.FreqMin()
        self.freq = collectRequestIngest.Freq()
        self.freqMax = collectRequestIngest.FreqMax()
        self.polarization = collectRequestIngest.Polarization()
        self.visMagMin = collectRequestIngest.VisMagMin()
        self.visMag = collectRequestIngest.VisMag()
        self.visMagMax = collectRequestIngest.VisMagMax()
        self.spectralModel = collectRequestIngest.SpectralModel()
        self.reflectance = collectRequestIngest.Reflectance()
        self.irradiance = collectRequestIngest.Irradiance()
        self.numFrames = collectRequestIngest.NumFrames()
        self.frameRate = collectRequestIngest.FrameRate()
        self.integrationTime = collectRequestIngest.IntegrationTime()
        self.numTracks = collectRequestIngest.NumTracks()
        self.numObs = collectRequestIngest.NumObs()
        self.duration = collectRequestIngest.Duration()
        self.srchPattern = collectRequestIngest.SrchPattern()
        self.scenario = collectRequestIngest.Scenario()
        self.idElset = collectRequestIngest.IdElset()
        self.idManifold = collectRequestIngest.IdManifold()
        self.idStateVector = collectRequestIngest.IdStateVector()
        self.esId = collectRequestIngest.EsId()
        self.epoch = collectRequestIngest.Epoch()
        self.semiMajorAxis = collectRequestIngest.SemiMajorAxis()
        self.eccentricity = collectRequestIngest.Eccentricity()
        self.inclination = collectRequestIngest.Inclination()
        self.raan = collectRequestIngest.Raan()
        self.argOfPerigee = collectRequestIngest.ArgOfPerigee()
        self.trueAnomoly = collectRequestIngest.TrueAnomoly()
        self.ra = collectRequestIngest.Ra()
        self.dec = collectRequestIngest.Dec()
        self.az = collectRequestIngest.Az()
        self.el = collectRequestIngest.El()
        self.range = collectRequestIngest.Range()
        self.extentAz = collectRequestIngest.ExtentAz()
        self.extentEl = collectRequestIngest.ExtentEl()
        self.extentRange = collectRequestIngest.ExtentRange()
        self.lat = collectRequestIngest.Lat()
        self.lon = collectRequestIngest.Lon()
        self.alt = collectRequestIngest.Alt()
        self.stopLat = collectRequestIngest.StopLat()
        self.stopLon = collectRequestIngest.StopLon()
        self.stopAlt = collectRequestIngest.StopAlt()
        self.srchInc = collectRequestIngest.SrchInc()
        self.xAngle = collectRequestIngest.XAngle()
        self.yAngle = collectRequestIngest.YAngle()
        self.orientAngle = collectRequestIngest.OrientAngle()
        self.customer = collectRequestIngest.Customer()
        self.notes = collectRequestIngest.Notes()
        self.createdAt = collectRequestIngest.CreatedAt()
        self.createdBy = collectRequestIngest.CreatedBy()
        self.source = collectRequestIngest.Source()
        self.origin = collectRequestIngest.Origin()
        self.origNetwork = collectRequestIngest.OrigNetwork()
        self.dataMode = collectRequestIngest.DataMode()
        self.stateVector = collectRequestIngest.StateVector()
        self.elset = collectRequestIngest.Elset()
        if not collectRequestIngest.TagsIsNone():
            self.tags = []
            for i in range(collectRequestIngest.TagsLength()):
                self.tags.append(collectRequestIngest.Tags(i))
    ...
    def Pack(self, builder):
        ...
        if self.tags is not None:
            ...
            CollectRequest_IngestStartTagsVector(builder, len(self.tags))
        ...
        if self.idPlan is not None:
            CollectRequest_IngestAddIdPlan(builder, idPlan)
        CollectRequest_IngestAddPlanIndex(builder, self.planIndex)
        if self.taskId is not None:
            CollectRequest_IngestAddTaskId(builder, taskId)
        if self.dwellId is not None:
            CollectRequest_IngestAddDwellId(builder, dwellId)
        ...
        if self.priority is not None:
            CollectRequest_IngestAddPriority(builder, priority)
        CollectRequest_IngestAddTaskCategory(builder, self.taskCategory)
        if self.suffix is not None:
            CollectRequest_IngestAddSuffix(builder, suffix)
        CollectRequest_IngestAddUctFollowUp(builder, self.uctFollowUp)
        if self.startTime is not None:
            CollectRequest_IngestAddStartTime(builder, startTime)
        if self.endTime is not None:
            CollectRequest_IngestAddEndTime(builder, endTime)
        if self.idOnOrbit is not None:
            CollectRequest_IngestAddIdOnOrbit(builder, idOnOrbit)
        CollectRequest_IngestAddSatNo(builder, self.satNo)
        if self.origObjectId is not None:
            CollectRequest_IngestAddOrigObjectId(builder, origObjectId)
        if self.taskGroup is not None:
            CollectRequest_IngestAddTaskGroup(builder, taskGroup)
        CollectRequest_IngestAddIron(builder, self.iron)
        if self.orbitRegime is not None:
            CollectRequest_IngestAddOrbitRegime(builder, orbitRegime)
        CollectRequest_IngestAddTargetSize(builder, self.targetSize)
        CollectRequest_IngestAddRcsMin(builder, self.rcsMin)
        CollectRequest_IngestAddRcs(builder, self.rcs)
        CollectRequest_IngestAddRcsMax(builder, self.rcsMax)
        CollectRequest_IngestAddFreqMin(builder, self.freqMin)
        CollectRequest_IngestAddFreq(builder, self.freq)
        CollectRequest_IngestAddFreqMax(builder, self.freqMax)
        if self.polarization is not None:
            CollectRequest_IngestAddPolarization(builder, polarization)
        CollectRequest_IngestAddVisMagMin(builder, self.visMagMin)
        CollectRequest_IngestAddVisMag(builder, self.visMag)
        CollectRequest_IngestAddVisMagMax(builder, self.visMagMax)
        if self.spectralModel is not None:
            CollectRequest_IngestAddSpectralModel(builder, spectralModel)
        CollectRequest_IngestAddReflectance(builder, self.reflectance)
        CollectRequest_IngestAddIrradiance(builder, self.irradiance)
        CollectRequest_IngestAddNumFrames(builder, self.numFrames)
        CollectRequest_IngestAddFrameRate(builder, self.frameRate)
        CollectRequest_IngestAddIntegrationTime(builder, self.integrationTime)
        CollectRequest_IngestAddNumTracks(builder, self.numTracks)
        CollectRequest_IngestAddNumObs(builder, self.numObs)
        CollectRequest_IngestAddDuration(builder, self.duration)
        if self.srchPattern is not None:
            CollectRequest_IngestAddSrchPattern(builder, srchPattern)
        if self.scenario is not None:
            CollectRequest_IngestAddScenario(builder, scenario)
        ...
        if self.epoch is not None:
            CollectRequest_IngestAddEpoch(builder, epoch)
        CollectRequest_IngestAddSemiMajorAxis(builder, self.semiMajorAxis)
        CollectRequest_IngestAddEccentricity(builder, self.eccentricity)
        CollectRequest_IngestAddInclination(builder, self.inclination)
        CollectRequest_IngestAddRaan(builder, self.raan)
        CollectRequest_IngestAddArgOfPerigee(builder, self.argOfPerigee)
        CollectRequest_IngestAddTrueAnomoly(builder, self.trueAnomoly)
        CollectRequest_IngestAddRa(builder, self.ra)
        CollectRequest_IngestAddDec(builder, self.dec)
        CollectRequest_IngestAddAz(builder, self.az)
        CollectRequest_IngestAddEl(builder, self.el)
        CollectRequest_IngestAddRange(builder, self.range)
        CollectRequest_IngestAddExtentAz(builder, self.extentAz)
        CollectRequest_IngestAddExtentEl(builder, self.extentEl)
        CollectRequest_IngestAddExtentRange(builder, self.extentRange)
        CollectRequest_IngestAddLat(builder, self.lat)
        CollectRequest_IngestAddLon(builder, self.lon)
        CollectRequest_IngestAddAlt(builder, self.alt)
        CollectRequest_IngestAddStopLat(builder, self.stopLat)
        CollectRequest_IngestAddStopLon(builder, self.stopLon)
        CollectRequest_IngestAddStopAlt(builder, self.stopAlt)
        CollectRequest_IngestAddSrchInc(builder, self.srchInc)
        CollectRequest_IngestAddXAngle(builder, self.xAngle)
        CollectRequest_IngestAddYAngle(builder, self.yAngle)
        CollectRequest_IngestAddOrientAngle(builder, self.orientAngle)
        if self.customer is not None:
            CollectRequest_IngestAddCustomer(builder, customer)
        if self.notes is not None:
            CollectRequest_IngestAddNotes(builder, notes)
        ...
        if self.origNetwork is not None:
            CollectRequest_IngestAddOrigNetwork(builder, origNetwork)
        CollectRequest_IngestAddDataMode(builder, self.dataMode)
        if self.stateVector is not None:
            CollectRequest_IngestAddStateVector(builder, stateVector)
        if self.elset is not None:
            CollectRequest_IngestAddElset(builder, elset)
        if self.tags is not None:
            CollectRequest_IngestAddTags(builder, tags)
        collectRequestIngest = CollectRequest_IngestEnd(builder)
        return collectRequestIngest
