...
class Transponder_Ingest(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsTransponder_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def Transponder_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def Transponder_IngestStart(builder):
    builder.StartObject(18)

def Start(builder):
    Transponder_IngestStart(builder)

def Transponder_IngestAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    Transponder_IngestAddId(builder, id)

def Transponder_IngestAddIdComm(builder, idComm):
...
def AddIdComm(builder, idComm):
    Transponder_IngestAddIdComm(builder, idComm)

def Transponder_IngestAddName(builder, name):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)

def AddName(builder, name):
    Transponder_IngestAddName(builder, name)

def Transponder_IngestAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    Transponder_IngestAddClassificationMarking(builder, classificationMarking)

def Transponder_IngestAddNid(builder, nid):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(nid), 0)

def AddNid(builder, nid):
    Transponder_IngestAddNid(builder, nid)

def Transponder_IngestAddTid(builder, tid):
    builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(tid), 0)

def AddTid(builder, tid):
    Transponder_IngestAddTid(builder, tid)

def Transponder_IngestAddTtf(builder, ttf):
    builder.PrependFloat64Slot(6, ttf, 0.0)

def AddTtf(builder, ttf):
    Transponder_IngestAddTtf(builder, ttf)

def Transponder_IngestAddSymbolRate(builder, symbolRate):
    builder.PrependFloat64Slot(7, symbolRate, 0.0)

def AddSymbolRate(builder, symbolRate):
    Transponder_IngestAddSymbolRate(builder, symbolRate)

def Transponder_IngestAddFec(builder, fec):
    builder.PrependInt32Slot(8, fec, 0)

def AddFec(builder, fec):
    Transponder_IngestAddFec(builder, fec)

def Transponder_IngestAddModulation(builder, modulation):
...
def AddModulation(builder, modulation):
    Transponder_IngestAddModulation(builder, modulation)

def Transponder_IngestAddFormat(builder, format):
...
def AddFormat(builder, format):
    Transponder_IngestAddFormat(builder, format)

def Transponder_IngestAddSystem(builder, system):
...
def AddSystem(builder, system):
    Transponder_IngestAddSystem(builder, system)

def Transponder_IngestAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    Transponder_IngestAddSource(builder, source)

def Transponder_IngestAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(13, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    Transponder_IngestAddOrigin(builder, origin)

def Transponder_IngestAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    Transponder_IngestAddOrigNetwork(builder, origNetwork)

def Transponder_IngestAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(15, dataMode, 0)

def AddDataMode(builder, dataMode):
    Transponder_IngestAddDataMode(builder, dataMode)

def Transponder_IngestAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    Transponder_IngestAddCreatedAt(builder, createdAt)

def Transponder_IngestAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    Transponder_IngestAddCreatedBy(builder, createdBy)

def Transponder_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return Transponder_IngestEnd(builder)


class Transponder_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        transponderIngest = Transponder_Ingest()
        transponderIngest.Init(buf, pos)
        return cls.InitFromObj(transponderIngest)
    ...
    @classmethod
    def InitFromObj(cls, transponderIngest):
        x = Transponder_IngestT()
        x._UnPack(transponderIngest)
        return x

    # Transponder_IngestT
    def _UnPack(self, transponderIngest):
        if transponderIngest is None:
            return
        self.id = transponderIngest.Id()
        self.idComm = transponderIngest.IdComm()
        self.name = transponderIngest.Name()
        self.classificationMarking = transponderIngest.ClassificationMarking()
        self.nid = transponderIngest.Nid()
        self.tid = transponderIngest.Tid()
        self.ttf = transponderIngest.Ttf()
        self.symbolRate = transponderIngest.SymbolRate()
        self.fec = transponderIngest.Fec()
        self.modulation = transponderIngest.Modulation()
        self.format = transponderIngest.Format()
        self.system = transponderIngest.System()
        self.source = transponderIngest.Source()
        self.origin = transponderIngest.Origin()
        self.origNetwork = transponderIngest.OrigNetwork()
        self.dataMode = transponderIngest.DataMode()
        self.createdAt = transponderIngest.CreatedAt()
        self.createdBy = transponderIngest.CreatedBy()
    ...
    def Pack(self, builder):
        ...
        if self.tid is not None:
            Transponder_IngestAddTid(builder, tid)
        Transponder_IngestAddTtf(builder, self.ttf)
        Transponder_IngestAddSymbolRate(builder, self.symbolRate)
        Transponder_IngestAddFec(builder, self.fec)
        if self.modulation is not None:
            Transponder_IngestAddModulation(builder, modulation)
        if self.format is not None:
            Transponder_IngestAddFormat(builder, format)
        ...
        if self.origNetwork is not None:
            Transponder_IngestAddOrigNetwork(builder, origNetwork)
        Transponder_IngestAddDataMode(builder, self.dataMode)
        if self.createdAt is not None:
            Transponder_IngestAddCreatedAt(builder, createdAt)
        if self.createdBy is not None:
            Transponder_IngestAddCreatedBy(builder, createdBy)
        transponderIngest = Transponder_IngestEnd(builder)
        return transponderIngest
