...
class LogisticsSegments_Ingest(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsLogisticsSegments_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def LogisticsSegments_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def LogisticsSegments_IngestStart(builder):
    builder.StartObject(15)

def Start(builder):
    LogisticsSegments_IngestStart(builder)

def LogisticsSegments_IngestAddSegmentNumber(builder, segmentNumber):
    builder.PrependInt32Slot(0, segmentNumber, 0)

def AddSegmentNumber(builder, segmentNumber):
    LogisticsSegments_IngestAddSegmentNumber(builder, segmentNumber)

def LogisticsSegments_IngestAddModeCode(builder, modeCode):
...
def AddModeCode(builder, modeCode):
    LogisticsSegments_IngestAddModeCode(builder, modeCode)

def LogisticsSegments_IngestAddMissionType(builder, missionType):
...
def AddMissionType(builder, missionType):
    LogisticsSegments_IngestAddMissionType(builder, missionType)

def LogisticsSegments_IngestAddIdMission(builder, idMission):
...
def AddIdMission(builder, idMission):
    LogisticsSegments_IngestAddIdMission(builder, idMission)

def LogisticsSegments_IngestAddExtMissionId(builder, extMissionId):
...
def AddExtMissionId(builder, extMissionId):
    LogisticsSegments_IngestAddExtMissionId(builder, extMissionId)

def LogisticsSegments_IngestAddMissionNumber(builder, missionNumber):
...
def AddMissionNumber(builder, missionNumber):
    LogisticsSegments_IngestAddMissionNumber(builder, missionNumber)

def LogisticsSegments_IngestAddItin(builder, itin):
    builder.PrependInt32Slot(6, itin, 0)

def AddItin(builder, itin):
    LogisticsSegments_IngestAddItin(builder, itin)

def LogisticsSegments_IngestAddSegTailNumber(builder, segTailNumber):
...
def AddSegTailNumber(builder, segTailNumber):
    LogisticsSegments_IngestAddSegTailNumber(builder, segTailNumber)

def LogisticsSegments_IngestAddSegAircraftMds(builder, segAircraftMds):
...
def AddSegAircraftMds(builder, segAircraftMds):
    LogisticsSegments_IngestAddSegAircraftMds(builder, segAircraftMds)

def LogisticsSegments_IngestAddDepartureIcao(builder, departureIcao):
...
def AddDepartureIcao(builder, departureIcao):
    LogisticsSegments_IngestAddDepartureIcao(builder, departureIcao)

def LogisticsSegments_IngestAddSegActDepTime(builder, segActDepTime):
...
def AddSegActDepTime(builder, segActDepTime):
    LogisticsSegments_IngestAddSegActDepTime(builder, segActDepTime)

def LogisticsSegments_IngestAddArrivalIcao(builder, arrivalIcao):
...
def AddArrivalIcao(builder, arrivalIcao):
    LogisticsSegments_IngestAddArrivalIcao(builder, arrivalIcao)

def LogisticsSegments_IngestAddSegActArrTime(builder, segActArrTime):
...
def AddSegActArrTime(builder, segActArrTime):
    LogisticsSegments_IngestAddSegActArrTime(builder, segActArrTime)

def LogisticsSegments_IngestAddSegEstDepTime(builder, segEstDepTime):
...
def AddSegEstDepTime(builder, segEstDepTime):
    LogisticsSegments_IngestAddSegEstDepTime(builder, segEstDepTime)

def LogisticsSegments_IngestAddSegEstArrTime(builder, segEstArrTime):
...
def AddSegEstArrTime(builder, segEstArrTime):
    LogisticsSegments_IngestAddSegEstArrTime(builder, segEstArrTime)

def LogisticsSegments_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return LogisticsSegments_IngestEnd(builder)


class LogisticsSegments_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        logisticsSegmentsIngest = LogisticsSegments_Ingest()
        logisticsSegmentsIngest.Init(buf, pos)
        return cls.InitFromObj(logisticsSegmentsIngest)
    ...
    @classmethod
    def InitFromObj(cls, logisticsSegmentsIngest):
        x = LogisticsSegments_IngestT()
        x._UnPack(logisticsSegmentsIngest)
        return x

    # LogisticsSegments_IngestT
    def _UnPack(self, logisticsSegmentsIngest):
        if logisticsSegmentsIngest is None:
            return
        self.segmentNumber = logisticsSegmentsIngest.SegmentNumber()
        self.modeCode = logisticsSegmentsIngest.ModeCode()
        self.missionType = logisticsSegmentsIngest.MissionType()
        self.idMission = logisticsSegmentsIngest.IdMission()
        self.extMissionId = logisticsSegmentsIngest.ExtMissionId()
        self.missionNumber = logisticsSegmentsIngest.MissionNumber()
        self.itin = logisticsSegmentsIngest.Itin()
        self.segTailNumber = logisticsSegmentsIngest.SegTailNumber()
        self.segAircraftMds = logisticsSegmentsIngest.SegAircraftMds()
        self.departureIcao = logisticsSegmentsIngest.DepartureIcao()
        self.segActDepTime = logisticsSegmentsIngest.SegActDepTime()
        self.arrivalIcao = logisticsSegmentsIngest.ArrivalIcao()
        self.segActArrTime = logisticsSegmentsIngest.SegActArrTime()
        self.segEstDepTime = logisticsSegmentsIngest.SegEstDepTime()
        self.segEstArrTime = logisticsSegmentsIngest.SegEstArrTime()
    ...
    def Pack(self, builder):
        ...
        LogisticsSegments_IngestStart(builder)
        LogisticsSegments_IngestAddSegmentNumber(builder, self.segmentNumber)
        if self.modeCode is not None:
            LogisticsSegments_IngestAddModeCode(builder, modeCode)
        if self.missionType is not None:
            LogisticsSegments_IngestAddMissionType(builder, missionType)
        ...
        if self.missionNumber is not None:
            LogisticsSegments_IngestAddMissionNumber(builder, missionNumber)
        LogisticsSegments_IngestAddItin(builder, self.itin)
        if self.segTailNumber is not None:
            LogisticsSegments_IngestAddSegTailNumber(builder, segTailNumber)
        if self.segAircraftMds is not None:
            LogisticsSegments_IngestAddSegAircraftMds(builder, segAircraftMds)
        ...
        if self.segEstArrTime is not None:
            LogisticsSegments_IngestAddSegEstArrTime(builder, segEstArrTime)
        logisticsSegmentsIngest = LogisticsSegments_IngestEnd(builder)
        return logisticsSegmentsIngest
