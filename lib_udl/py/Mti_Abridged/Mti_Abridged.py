...
class Mti_Abridged(object):
    ...
    @classmethod
    def GetRootAsMti_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def Mti_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf, offset, b"\x4D\x54\x49\x41", size_prefixed=size_prefixed)
...
def AddMissions(builder, missions):
    Mti_AbridgedAddMissions(builder, missions)

def Mti_AbridgedStartMissionsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartMissionsVector(builder, numElems):
    return Mti_AbridgedStartMissionsVector(builder, numElems)

def Mti_AbridgedAddDwells(builder, dwells):
...
def AddDwells(builder, dwells):
    Mti_AbridgedAddDwells(builder, dwells)

def Mti_AbridgedStartDwellsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartDwellsVector(builder, numElems):
    return Mti_AbridgedStartDwellsVector(builder, numElems)

def Mti_AbridgedAddHrrs(builder, hrrs):
    builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(hrrs), 0)

def AddHrrs(builder, hrrs):
    Mti_AbridgedAddHrrs(builder, hrrs)

def Mti_AbridgedStartHrrsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartHrrsVector(builder, numElems):
    return Mti_AbridgedStartHrrsVector(builder, numElems)

def Mti_AbridgedAddJobDefs(builder, jobDefs):
...
def AddJobDefs(builder, jobDefs):
    Mti_AbridgedAddJobDefs(builder, jobDefs)

def Mti_AbridgedStartJobDefsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartJobDefsVector(builder, numElems):
    return Mti_AbridgedStartJobDefsVector(builder, numElems)

def Mti_AbridgedAddFreeTexts(builder, freeTexts):
...
def AddFreeTexts(builder, freeTexts):
    Mti_AbridgedAddFreeTexts(builder, freeTexts)

def Mti_AbridgedStartFreeTextsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartFreeTextsVector(builder, numElems):
    return Mti_AbridgedStartFreeTextsVector(builder, numElems)

def Mti_AbridgedAddPlatformLocs(builder, platformLocs):
...
def AddPlatformLocs(builder, platformLocs):
    Mti_AbridgedAddPlatformLocs(builder, platformLocs)

def Mti_AbridgedStartPlatformLocsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartPlatformLocsVector(builder, numElems):
    return Mti_AbridgedStartPlatformLocsVector(builder, numElems)

def Mti_AbridgedAddJobRequests(builder, jobRequests):
...
def AddJobRequests(builder, jobRequests):
    Mti_AbridgedAddJobRequests(builder, jobRequests)

def Mti_AbridgedStartJobRequestsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartJobRequestsVector(builder, numElems):
    return Mti_AbridgedStartJobRequestsVector(builder, numElems)

def Mti_AbridgedAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    Mti_AbridgedAddOrigNetwork(builder, origNetwork)

def Mti_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return Mti_AbridgedEnd(builder)
...
class Mti_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        mtiAbridged = Mti_Abridged()
        mtiAbridged.Init(buf, pos)
        return cls.InitFromObj(mtiAbridged)
    ...
    @classmethod
    def InitFromObj(cls, mtiAbridged):
        x = Mti_AbridgedT()
        x._UnPack(mtiAbridged)
        return x

    # Mti_AbridgedT
    def _UnPack(self, mtiAbridged):
        if mtiAbridged is None:
            return
        self.classificationMarking = mtiAbridged.ClassificationMarking()
        self.source = mtiAbridged.Source()
        self.origin = mtiAbridged.Origin()
        self.id = mtiAbridged.Id()
        self.dataMode = mtiAbridged.DataMode()
        self.createdBy = mtiAbridged.CreatedBy()
        self.createdAt = mtiAbridged.CreatedAt()
        self.p3 = mtiAbridged.P3()
        self.p6 = mtiAbridged.P6()
        self.p7 = mtiAbridged.P7()
        self.p8 = mtiAbridged.P8()
        self.p9 = mtiAbridged.P9()
        self.p10 = mtiAbridged.P10()
        if not mtiAbridged.MissionsIsNone():
            self.missions = []
            for i in range(mtiAbridged.MissionsLength()):
                self.missions.append(mtiAbridged.Missions(i))
        if not mtiAbridged.DwellsIsNone():
            self.dwells = []
            for i in range(mtiAbridged.DwellsLength()):
                self.dwells.append(mtiAbridged.Dwells(i))
        if not mtiAbridged.HrrsIsNone():
            self.hrrs = []
            for i in range(mtiAbridged.HrrsLength()):
                self.hrrs.append(mtiAbridged.Hrrs(i))
        if not mtiAbridged.JobDefsIsNone():
            self.jobDefs = []
            for i in range(mtiAbridged.JobDefsLength()):
                self.jobDefs.append(mtiAbridged.JobDefs(i))
        if not mtiAbridged.FreeTextsIsNone():
            self.freeTexts = []
            for i in range(mtiAbridged.FreeTextsLength()):
                self.freeTexts.append(mtiAbridged.FreeTexts(i))
        if not mtiAbridged.PlatformLocsIsNone():
            self.platformLocs = []
            for i in range(mtiAbridged.PlatformLocsLength()):
                self.platformLocs.append(mtiAbridged.PlatformLocs(i))
        if not mtiAbridged.JobRequestsIsNone():
            self.jobRequests = []
            for i in range(mtiAbridged.JobRequestsLength()):
                self.jobRequests.append(mtiAbridged.JobRequests(i))
        self.origNetwork = mtiAbridged.OrigNetwork()
    ...
    def Pack(self, builder):
        ...
        if self.missions is not None:
            ...
            Mti_AbridgedStartMissionsVector(builder, len(self.missions))
        ...
        if self.dwells is not None:
            ...
            Mti_AbridgedStartDwellsVector(builder, len(self.dwells))
        ...
        if self.hrrs is not None:
            ...
            Mti_AbridgedStartHrrsVector(builder, len(self.hrrs))
        ...
        if self.jobDefs is not None:
            ...
            Mti_AbridgedStartJobDefsVector(builder, len(self.jobDefs))
        ...
        if self.freeTexts is not None:
            ...
            Mti_AbridgedStartFreeTextsVector(builder, len(self.freeTexts))
        ...
        if self.platformLocs is not None:
            ...
            Mti_AbridgedStartPlatformLocsVector(builder, len(self.platformLocs))
        ...
        if self.jobRequests is not None:
            ...
            Mti_AbridgedStartJobRequestsVector(builder, len(self.jobRequests))
        ...
        if self.id is not None:
            Mti_AbridgedAddId(builder, id)
        Mti_AbridgedAddDataMode(builder, self.dataMode)
        if self.createdBy is not None:
            Mti_AbridgedAddCreatedBy(builder, createdBy)
        if self.createdAt is not None:
            Mti_AbridgedAddCreatedAt(builder, createdAt)
        ...
        if self.p8 is not None:
            Mti_AbridgedAddP8(builder, p8)
        Mti_AbridgedAddP9(builder, self.p9)
        Mti_AbridgedAddP10(builder, self.p10)
        if self.missions is not None:
            Mti_AbridgedAddMissions(builder, missions)
        if self.dwells is not None:
            Mti_AbridgedAddDwells(builder, dwells)
        ...
        if self.origNetwork is not None:
            Mti_AbridgedAddOrigNetwork(builder, origNetwork)
        mtiAbridged = Mti_AbridgedEnd(builder)
        return mtiAbridged
