...
class AttitudeData_Abridged(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsAttitudeData_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def AttitudeData_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def AttitudeData_AbridgedStart(builder):
    builder.StartObject(33)

def Start(builder):
    AttitudeData_AbridgedStart(builder)

def AttitudeData_AbridgedAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    AttitudeData_AbridgedAddId(builder, id)

def AttitudeData_AbridgedAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    AttitudeData_AbridgedAddClassificationMarking(builder, classificationMarking)

def AttitudeData_AbridgedAddAsId(builder, asId):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(asId), 0)

def AddAsId(builder, asId):
    AttitudeData_AbridgedAddAsId(builder, asId)

def AttitudeData_AbridgedAddIdOnOrbit(builder, idOnOrbit):
...
def AddIdOnOrbit(builder, idOnOrbit):
    AttitudeData_AbridgedAddIdOnOrbit(builder, idOnOrbit)

def AttitudeData_AbridgedAddSatNo(builder, satNo):
    builder.PrependInt32Slot(4, satNo, 0)

def AddSatNo(builder, satNo):
    AttitudeData_AbridgedAddSatNo(builder, satNo)

def AttitudeData_AbridgedAddOrigObjectId(builder, origObjectId):
...
def AddOrigObjectId(builder, origObjectId):
    AttitudeData_AbridgedAddOrigObjectId(builder, origObjectId)

def AttitudeData_AbridgedAddTs(builder, ts):
    builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(ts), 0)

def AddTs(builder, ts):
    AttitudeData_AbridgedAddTs(builder, ts)

def AttitudeData_AbridgedAddMotionType(builder, motionType):
...
def AddMotionType(builder, motionType):
    AttitudeData_AbridgedAddMotionType(builder, motionType)

def AttitudeData_AbridgedAddQ1(builder, q1):
    builder.PrependFloat64Slot(8, q1, 0.0)

def AddQ1(builder, q1):
    AttitudeData_AbridgedAddQ1(builder, q1)

def AttitudeData_AbridgedAddQ2(builder, q2):
    builder.PrependFloat64Slot(9, q2, 0.0)

def AddQ2(builder, q2):
    AttitudeData_AbridgedAddQ2(builder, q2)

def AttitudeData_AbridgedAddQ3(builder, q3):
    builder.PrependFloat64Slot(10, q3, 0.0)

def AddQ3(builder, q3):
    AttitudeData_AbridgedAddQ3(builder, q3)

def AttitudeData_AbridgedAddQc(builder, qc):
    builder.PrependFloat64Slot(11, qc, 0.0)

def AddQc(builder, qc):
    AttitudeData_AbridgedAddQc(builder, qc)

def AttitudeData_AbridgedAddQ1Dot(builder, q1Dot):
    builder.PrependFloat64Slot(12, q1Dot, 0.0)

def AddQ1Dot(builder, q1Dot):
    AttitudeData_AbridgedAddQ1Dot(builder, q1Dot)

def AttitudeData_AbridgedAddQ2Dot(builder, q2Dot):
    builder.PrependFloat64Slot(13, q2Dot, 0.0)

def AddQ2Dot(builder, q2Dot):
    AttitudeData_AbridgedAddQ2Dot(builder, q2Dot)

def AttitudeData_AbridgedAddQ3Dot(builder, q3Dot):
    builder.PrependFloat64Slot(14, q3Dot, 0.0)

def AddQ3Dot(builder, q3Dot):
    AttitudeData_AbridgedAddQ3Dot(builder, q3Dot)

def AttitudeData_AbridgedAddQcDot(builder, qcDot):
    builder.PrependFloat64Slot(15, qcDot, 0.0)

def AddQcDot(builder, qcDot):
    AttitudeData_AbridgedAddQcDot(builder, qcDot)

def AttitudeData_AbridgedAddXAngle(builder, xAngle):
...
def AddXAngle(builder, xAngle):
    AttitudeData_AbridgedAddXAngle(builder, xAngle)

def AttitudeData_AbridgedStartXAngleVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartXAngleVector(builder, numElems):
    return AttitudeData_AbridgedStartXAngleVector(builder, numElems)

def AttitudeData_AbridgedAddYAngle(builder, yAngle):
...
def AddYAngle(builder, yAngle):
    AttitudeData_AbridgedAddYAngle(builder, yAngle)

def AttitudeData_AbridgedStartYAngleVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartYAngleVector(builder, numElems):
    return AttitudeData_AbridgedStartYAngleVector(builder, numElems)

def AttitudeData_AbridgedAddZAngle(builder, zAngle):
...
def AddZAngle(builder, zAngle):
    AttitudeData_AbridgedAddZAngle(builder, zAngle)

def AttitudeData_AbridgedStartZAngleVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartZAngleVector(builder, numElems):
    return AttitudeData_AbridgedStartZAngleVector(builder, numElems)

def AttitudeData_AbridgedAddXRate(builder, xRate):
    builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(xRate), 0)

def AddXRate(builder, xRate):
    AttitudeData_AbridgedAddXRate(builder, xRate)

def AttitudeData_AbridgedStartXRateVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartXRateVector(builder, numElems):
    return AttitudeData_AbridgedStartXRateVector(builder, numElems)

def AttitudeData_AbridgedAddYRate(builder, yRate):
    builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(yRate), 0)

def AddYRate(builder, yRate):
    AttitudeData_AbridgedAddYRate(builder, yRate)

def AttitudeData_AbridgedStartYRateVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartYRateVector(builder, numElems):
    return AttitudeData_AbridgedStartYRateVector(builder, numElems)

def AttitudeData_AbridgedAddZRate(builder, zRate):
    builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(zRate), 0)

def AddZRate(builder, zRate):
    AttitudeData_AbridgedAddZRate(builder, zRate)

def AttitudeData_AbridgedStartZRateVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartZRateVector(builder, numElems):
    return AttitudeData_AbridgedStartZRateVector(builder, numElems)

def AttitudeData_AbridgedAddRa(builder, ra):
    builder.PrependFloat64Slot(22, ra, 0.0)

def AddRa(builder, ra):
    AttitudeData_AbridgedAddRa(builder, ra)

def AttitudeData_AbridgedAddDeclination(builder, declination):
    builder.PrependFloat64Slot(23, declination, 0.0)

def AddDeclination(builder, declination):
    AttitudeData_AbridgedAddDeclination(builder, declination)

def AttitudeData_AbridgedAddConingAngle(builder, coningAngle):
    builder.PrependFloat64Slot(24, coningAngle, 0.0)

def AddConingAngle(builder, coningAngle):
    AttitudeData_AbridgedAddConingAngle(builder, coningAngle)

def AttitudeData_AbridgedAddPrecPeriod(builder, precPeriod):
    builder.PrependFloat64Slot(25, precPeriod, 0.0)

def AddPrecPeriod(builder, precPeriod):
    AttitudeData_AbridgedAddPrecPeriod(builder, precPeriod)

def AttitudeData_AbridgedAddSpinPeriod(builder, spinPeriod):
    builder.PrependFloat64Slot(26, spinPeriod, 0.0)

def AddSpinPeriod(builder, spinPeriod):
    AttitudeData_AbridgedAddSpinPeriod(builder, spinPeriod)

def AttitudeData_AbridgedAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(27, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    AttitudeData_AbridgedAddCreatedAt(builder, createdAt)

def AttitudeData_AbridgedAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(28, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    AttitudeData_AbridgedAddCreatedBy(builder, createdBy)

def AttitudeData_AbridgedAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(29, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    AttitudeData_AbridgedAddSource(builder, source)

def AttitudeData_AbridgedAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    AttitudeData_AbridgedAddOrigin(builder, origin)

def AttitudeData_AbridgedAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(31, dataMode, 0)

def AddDataMode(builder, dataMode):
    AttitudeData_AbridgedAddDataMode(builder, dataMode)

def AttitudeData_AbridgedAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(32, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    AttitudeData_AbridgedAddOrigNetwork(builder, origNetwork)

def AttitudeData_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return AttitudeData_AbridgedEnd(builder)
...
class AttitudeData_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        attitudeDataAbridged = AttitudeData_Abridged()
        attitudeDataAbridged.Init(buf, pos)
        return cls.InitFromObj(attitudeDataAbridged)
    ...
    @classmethod
    def InitFromObj(cls, attitudeDataAbridged):
        x = AttitudeData_AbridgedT()
        x._UnPack(attitudeDataAbridged)
        return x

    # AttitudeData_AbridgedT
    def _UnPack(self, attitudeDataAbridged):
        if attitudeDataAbridged is None:
            return
        self.id = attitudeDataAbridged.Id()
        self.classificationMarking = attitudeDataAbridged.ClassificationMarking()
        self.asId = attitudeDataAbridged.AsId()
        self.idOnOrbit = attitudeDataAbridged.IdOnOrbit()
        self.satNo = attitudeDataAbridged.SatNo()
        self.origObjectId = attitudeDataAbridged.OrigObjectId()
        self.ts = attitudeDataAbridged.Ts()
        self.motionType = attitudeDataAbridged.MotionType()
        self.q1 = attitudeDataAbridged.Q1()
        self.q2 = attitudeDataAbridged.Q2()
        self.q3 = attitudeDataAbridged.Q3()
        self.qc = attitudeDataAbridged.Qc()
        self.q1Dot = attitudeDataAbridged.Q1Dot()
        self.q2Dot = attitudeDataAbridged.Q2Dot()
        self.q3Dot = attitudeDataAbridged.Q3Dot()
        self.qcDot = attitudeDataAbridged.QcDot()
        if not attitudeDataAbridged.XAngleIsNone():
            self.xAngle = []
            for i in range(attitudeDataAbridged.XAngleLength()):
                self.xAngle.append(attitudeDataAbridged.XAngle(i))
        if not attitudeDataAbridged.YAngleIsNone():
            self.yAngle = []
            for i in range(attitudeDataAbridged.YAngleLength()):
                self.yAngle.append(attitudeDataAbridged.YAngle(i))
        if not attitudeDataAbridged.ZAngleIsNone():
            self.zAngle = []
            for i in range(attitudeDataAbridged.ZAngleLength()):
                self.zAngle.append(attitudeDataAbridged.ZAngle(i))
        if not attitudeDataAbridged.XRateIsNone():
            self.xRate = []
            for i in range(attitudeDataAbridged.XRateLength()):
                self.xRate.append(attitudeDataAbridged.XRate(i))
        if not attitudeDataAbridged.YRateIsNone():
            self.yRate = []
            for i in range(attitudeDataAbridged.YRateLength()):
                self.yRate.append(attitudeDataAbridged.YRate(i))
        if not attitudeDataAbridged.ZRateIsNone():
            self.zRate = []
            for i in range(attitudeDataAbridged.ZRateLength()):
                self.zRate.append(attitudeDataAbridged.ZRate(i))
        self.ra = attitudeDataAbridged.Ra()
        self.declination = attitudeDataAbridged.Declination()
        self.coningAngle = attitudeDataAbridged.ConingAngle()
        self.precPeriod = attitudeDataAbridged.PrecPeriod()
        self.spinPeriod = attitudeDataAbridged.SpinPeriod()
        self.createdAt = attitudeDataAbridged.CreatedAt()
        self.createdBy = attitudeDataAbridged.CreatedBy()
        self.source = attitudeDataAbridged.Source()
        self.origin = attitudeDataAbridged.Origin()
        self.dataMode = attitudeDataAbridged.DataMode()
        self.origNetwork = attitudeDataAbridged.OrigNetwork()
    ...
    def Pack(self, builder):
        ...
        if self.xAngle is not None:
            ...
            AttitudeData_AbridgedStartXAngleVector(builder, len(self.xAngle))
        ...
        if self.yAngle is not None:
            ...
            AttitudeData_AbridgedStartYAngleVector(builder, len(self.yAngle))
        ...
        if self.zAngle is not None:
            ...
            AttitudeData_AbridgedStartZAngleVector(builder, len(self.zAngle))
        ...
        if self.xRate is not None:
            ...
            AttitudeData_AbridgedStartXRateVector(builder, len(self.xRate))
        ...
        if self.yRate is not None:
            ...
            AttitudeData_AbridgedStartYRateVector(builder, len(self.yRate))
        ...
        if self.zRate is not None:
            ...
            AttitudeData_AbridgedStartZRateVector(builder, len(self.zRate))
        ...
        if self.idOnOrbit is not None:
            AttitudeData_AbridgedAddIdOnOrbit(builder, idOnOrbit)
        AttitudeData_AbridgedAddSatNo(builder, self.satNo)
        if self.origObjectId is not None:
            AttitudeData_AbridgedAddOrigObjectId(builder, origObjectId)
        if self.ts is not None:
            AttitudeData_AbridgedAddTs(builder, ts)
        if self.motionType is not None:
            AttitudeData_AbridgedAddMotionType(builder, motionType)
        AttitudeData_AbridgedAddQ1(builder, self.q1)
        AttitudeData_AbridgedAddQ2(builder, self.q2)
        AttitudeData_AbridgedAddQ3(builder, self.q3)
        AttitudeData_AbridgedAddQc(builder, self.qc)
        AttitudeData_AbridgedAddQ1Dot(builder, self.q1Dot)
        AttitudeData_AbridgedAddQ2Dot(builder, self.q2Dot)
        AttitudeData_AbridgedAddQ3Dot(builder, self.q3Dot)
        AttitudeData_AbridgedAddQcDot(builder, self.qcDot)
        if self.xAngle is not None:
            AttitudeData_AbridgedAddXAngle(builder, xAngle)
        if self.yAngle is not None:
            AttitudeData_AbridgedAddYAngle(builder, yAngle)
        ...
        if self.zRate is not None:
            AttitudeData_AbridgedAddZRate(builder, zRate)
        AttitudeData_AbridgedAddRa(builder, self.ra)
        AttitudeData_AbridgedAddDeclination(builder, self.declination)
        AttitudeData_AbridgedAddConingAngle(builder, self.coningAngle)
        AttitudeData_AbridgedAddPrecPeriod(builder, self.precPeriod)
        AttitudeData_AbridgedAddSpinPeriod(builder, self.spinPeriod)
        if self.createdAt is not None:
            AttitudeData_AbridgedAddCreatedAt(builder, createdAt)
        if self.createdBy is not None:
            AttitudeData_AbridgedAddCreatedBy(builder, createdBy)
        ...
        if self.origin is not None:
            AttitudeData_AbridgedAddOrigin(builder, origin)
        AttitudeData_AbridgedAddDataMode(builder, self.dataMode)
        if self.origNetwork is not None:
            AttitudeData_AbridgedAddOrigNetwork(builder, origNetwork)
        attitudeDataAbridged = AttitudeData_AbridgedEnd(builder)
        return attitudeDataAbridged
