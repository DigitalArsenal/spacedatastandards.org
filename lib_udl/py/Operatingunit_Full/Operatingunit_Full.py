...
class Operatingunit_Full(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = Operatingunit_Full()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsOperatingunit_Full(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def Operatingunit_FullBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def Operatingunit_FullStart(builder):
    builder.StartObject(65)

def Start(builder):
    Operatingunit_FullStart(builder)

def Operatingunit_FullAddIdOperatingUnit(builder, idOperatingUnit):
...
def AddIdOperatingUnit(builder, idOperatingUnit):
    Operatingunit_FullAddIdOperatingUnit(builder, idOperatingUnit)

def Operatingunit_FullAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    Operatingunit_FullAddClassificationMarking(builder, classificationMarking)

def Operatingunit_FullAddAltOperatingUnitId(builder, altOperatingUnitId):
...
def AddAltOperatingUnitId(builder, altOperatingUnitId):
    Operatingunit_FullAddAltOperatingUnitId(builder, altOperatingUnitId)

def Operatingunit_FullAddName(builder, name):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)

def AddName(builder, name):
    Operatingunit_FullAddName(builder, name)

def Operatingunit_FullAddDescription(builder, description):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(description), 0)

def AddDescription(builder, description):
    Operatingunit_FullAddDescription(builder, description)

def Operatingunit_FullAddIdLocation(builder, idLocation):
...
def AddIdLocation(builder, idLocation):
    Operatingunit_FullAddIdLocation(builder, idLocation)

def Operatingunit_FullAddIdContact(builder, idContact):
...
def AddIdContact(builder, idContact):
    Operatingunit_FullAddIdContact(builder, idContact)

def Operatingunit_FullAddIdOrganization(builder, idOrganization):
...
def AddIdOrganization(builder, idOrganization):
    Operatingunit_FullAddIdOrganization(builder, idOrganization)

def Operatingunit_FullAddUnitIdentifier(builder, unitIdentifier):
...
def AddUnitIdentifier(builder, unitIdentifier):
    Operatingunit_FullAddUnitIdentifier(builder, unitIdentifier)

def Operatingunit_FullAddCountryCode(builder, countryCode):
...
def AddCountryCode(builder, countryCode):
    Operatingunit_FullAddCountryCode(builder, countryCode)

def Operatingunit_FullAddAltCountryCode(builder, altCountryCode):
...
def AddAltCountryCode(builder, altCountryCode):
    Operatingunit_FullAddAltCountryCode(builder, altCountryCode)

def Operatingunit_FullAddWac(builder, wac):
    builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(wac), 0)

def AddWac(builder, wac):
    Operatingunit_FullAddWac(builder, wac)

def Operatingunit_FullAddOperStatus(builder, operStatus):
...
def AddOperStatus(builder, operStatus):
    Operatingunit_FullAddOperStatus(builder, operStatus)

def Operatingunit_FullAddCondition(builder, condition):
...
def AddCondition(builder, condition):
    Operatingunit_FullAddCondition(builder, condition)

def Operatingunit_FullAddConditionAvail(builder, conditionAvail):
...
def AddConditionAvail(builder, conditionAvail):
    Operatingunit_FullAddConditionAvail(builder, conditionAvail)

def Operatingunit_FullAddEval(builder, eval):
    builder.PrependInt32Slot(15, eval, 0)

def AddEval(builder, eval):
    Operatingunit_FullAddEval(builder, eval)

def Operatingunit_FullAddFpa(builder, fpa):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(fpa), 0)

def AddFpa(builder, fpa):
    Operatingunit_FullAddFpa(builder, fpa)

def Operatingunit_FullAddIdent(builder, ident):
    builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(ident), 0)

def AddIdent(builder, ident):
    Operatingunit_FullAddIdent(builder, ident)

def Operatingunit_FullAddAllegiance(builder, allegiance):
...
def AddAllegiance(builder, allegiance):
    Operatingunit_FullAddAllegiance(builder, allegiance)

def Operatingunit_FullAddAltAllegiance(builder, altAllegiance):
...
def AddAltAllegiance(builder, altAllegiance):
    Operatingunit_FullAddAltAllegiance(builder, altAllegiance)

def Operatingunit_FullAddLocName(builder, locName):
...
def AddLocName(builder, locName):
    Operatingunit_FullAddLocName(builder, locName)

def Operatingunit_FullAddLocReason(builder, locReason):
...
def AddLocReason(builder, locReason):
    Operatingunit_FullAddLocReason(builder, locReason)

def Operatingunit_FullAddForce(builder, force):
    builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(force), 0)

def AddForce(builder, force):
    Operatingunit_FullAddForce(builder, force)

def Operatingunit_FullAddForceName(builder, forceName):
...
def AddForceName(builder, forceName):
    Operatingunit_FullAddForceName(builder, forceName)

def Operatingunit_FullAddFunctRole(builder, functRole):
...
def AddFunctRole(builder, functRole):
    Operatingunit_FullAddFunctRole(builder, functRole)

def Operatingunit_FullAddMsnPrimary(builder, msnPrimary):
...
def AddMsnPrimary(builder, msnPrimary):
    Operatingunit_FullAddMsnPrimary(builder, msnPrimary)

def Operatingunit_FullAddMsnPrimarySpecialty(builder, msnPrimarySpecialty):
...
def AddMsnPrimarySpecialty(builder, msnPrimarySpecialty):
    Operatingunit_FullAddMsnPrimarySpecialty(builder, msnPrimarySpecialty)

def Operatingunit_FullAddMasterUnit(builder, masterUnit):
    builder.PrependBoolSlot(27, masterUnit, 0)

def AddMasterUnit(builder, masterUnit):
    Operatingunit_FullAddMasterUnit(builder, masterUnit)

def Operatingunit_FullAddStylizedUnit(builder, stylizedUnit):
    builder.PrependBoolSlot(28, stylizedUnit, 0)

def AddStylizedUnit(builder, stylizedUnit):
    Operatingunit_FullAddStylizedUnit(builder, stylizedUnit)

def Operatingunit_FullAddDivCat(builder, divCat):
...
def AddDivCat(builder, divCat):
    Operatingunit_FullAddDivCat(builder, divCat)

def Operatingunit_FullAddEchelon(builder, echelon):
...
def AddEchelon(builder, echelon):
    Operatingunit_FullAddEchelon(builder, echelon)

def Operatingunit_FullAddEchelonTier(builder, echelonTier):
...
def AddEchelonTier(builder, echelonTier):
    Operatingunit_FullAddEchelonTier(builder, echelonTier)

def Operatingunit_FullAddFleetId(builder, fleetId):
...
def AddFleetId(builder, fleetId):
    Operatingunit_FullAddFleetId(builder, fleetId)

def Operatingunit_FullAddDeployStatus(builder, deployStatus):
...
def AddDeployStatus(builder, deployStatus):
    Operatingunit_FullAddDeployStatus(builder, deployStatus)

def Operatingunit_FullAddFlagFlown(builder, flagFlown):
...
def AddFlagFlown(builder, flagFlown):
    Operatingunit_FullAddFlagFlown(builder, flagFlown)

def Operatingunit_FullAddCoordDatum(builder, coordDatum):
...
def AddCoordDatum(builder, coordDatum):
    Operatingunit_FullAddCoordDatum(builder, coordDatum)

def Operatingunit_FullAddCoord(builder, coord):
    builder.PrependUOffsetTRelativeSlot(36, flatbuffers.number_types.UOffsetTFlags.py_type(coord), 0)

def AddCoord(builder, coord):
    Operatingunit_FullAddCoord(builder, coord)

def Operatingunit_FullAddCoordDerivAcc(builder, coordDerivAcc):
    builder.PrependFloat64Slot(37, coordDerivAcc, 0.0)

def AddCoordDerivAcc(builder, coordDerivAcc):
    Operatingunit_FullAddCoordDerivAcc(builder, coordDerivAcc)

def Operatingunit_FullAddLat(builder, lat):
    builder.PrependFloat64Slot(38, lat, 0.0)

def AddLat(builder, lat):
    Operatingunit_FullAddLat(builder, lat)

def Operatingunit_FullAddLon(builder, lon):
    builder.PrependFloat64Slot(39, lon, 0.0)

def AddLon(builder, lon):
    Operatingunit_FullAddLon(builder, lon)

def Operatingunit_FullAddElevMsl(builder, elevMsl):
    builder.PrependFloat64Slot(40, elevMsl, 0.0)

def AddElevMsl(builder, elevMsl):
    Operatingunit_FullAddElevMsl(builder, elevMsl)

def Operatingunit_FullAddElevMslConfLvl(builder, elevMslConfLvl):
    builder.PrependInt32Slot(41, elevMslConfLvl, 0)

def AddElevMslConfLvl(builder, elevMslConfLvl):
    Operatingunit_FullAddElevMslConfLvl(builder, elevMslConfLvl)

def Operatingunit_FullAddElevMslDerivAcc(builder, elevMslDerivAcc):
    builder.PrependFloat64Slot(42, elevMslDerivAcc, 0.0)

def AddElevMslDerivAcc(builder, elevMslDerivAcc):
    Operatingunit_FullAddElevMslDerivAcc(builder, elevMslDerivAcc)

def Operatingunit_FullAddGeoidalMslSep(builder, geoidalMslSep):
    builder.PrependFloat64Slot(43, geoidalMslSep, 0.0)

def AddGeoidalMslSep(builder, geoidalMslSep):
    Operatingunit_FullAddGeoidalMslSep(builder, geoidalMslSep)

def Operatingunit_FullAddMilGridSys(builder, milGridSys):
...
def AddMilGridSys(builder, milGridSys):
    Operatingunit_FullAddMilGridSys(builder, milGridSys)

def Operatingunit_FullAddMilGrid(builder, milGrid):
...
def AddMilGrid(builder, milGrid):
    Operatingunit_FullAddMilGrid(builder, milGrid)

def Operatingunit_FullAddUtm(builder, utm):
    builder.PrependUOffsetTRelativeSlot(46, flatbuffers.number_types.UOffsetTFlags.py_type(utm), 0)

def AddUtm(builder, utm):
    Operatingunit_FullAddUtm(builder, utm)

def Operatingunit_FullAddAirDefArea(builder, airDefArea):
...
def AddAirDefArea(builder, airDefArea):
    Operatingunit_FullAddAirDefArea(builder, airDefArea)

def Operatingunit_FullAddPolSubdiv(builder, polSubdiv):
...
def AddPolSubdiv(builder, polSubdiv):
    Operatingunit_FullAddPolSubdiv(builder, polSubdiv)

def Operatingunit_FullAddSymCode(builder, symCode):
...
def AddSymCode(builder, symCode):
    Operatingunit_FullAddSymCode(builder, symCode)

def Operatingunit_FullAddClassRating(builder, classRating):
...
def AddClassRating(builder, classRating):
    Operatingunit_FullAddClassRating(builder, classRating)

def Operatingunit_FullAddRecStatus(builder, recStatus):
...
def AddRecStatus(builder, recStatus):
    Operatingunit_FullAddRecStatus(builder, recStatus)

def Operatingunit_FullAddReviewDate(builder, reviewDate):
...
def AddReviewDate(builder, reviewDate):
    Operatingunit_FullAddReviewDate(builder, reviewDate)

def Operatingunit_FullAddResProd(builder, resProd):
...
def AddResProd(builder, resProd):
    Operatingunit_FullAddResProd(builder, resProd)

def Operatingunit_FullAddReferenceDoc(builder, referenceDoc):
...
def AddReferenceDoc(builder, referenceDoc):
    Operatingunit_FullAddReferenceDoc(builder, referenceDoc)

def Operatingunit_FullAddOperatingUnitRemarks(builder, operatingUnitRemarks):
...
def AddOperatingUnitRemarks(builder, operatingUnitRemarks):
    Operatingunit_FullAddOperatingUnitRemarks(builder, operatingUnitRemarks)

def Operatingunit_FullStartOperatingUnitRemarksVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartOperatingUnitRemarksVector(builder, numElems):
    return Operatingunit_FullStartOperatingUnitRemarksVector(builder, numElems)

def Operatingunit_FullAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(56, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    Operatingunit_FullAddCreatedAt(builder, createdAt)

def Operatingunit_FullAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(57, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    Operatingunit_FullAddCreatedBy(builder, createdBy)

def Operatingunit_FullAddUpdatedAt(builder, updatedAt):
    builder.PrependUOffsetTRelativeSlot(58, flatbuffers.number_types.UOffsetTFlags.py_type(updatedAt), 0)

def AddUpdatedAt(builder, updatedAt):
    Operatingunit_FullAddUpdatedAt(builder, updatedAt)

def Operatingunit_FullAddUpdatedBy(builder, updatedBy):
...
def AddUpdatedBy(builder, updatedBy):
    Operatingunit_FullAddUpdatedBy(builder, updatedBy)

def Operatingunit_FullAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(60, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    Operatingunit_FullAddSource(builder, source)

def Operatingunit_FullAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(61, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    Operatingunit_FullAddOrigin(builder, origin)

def Operatingunit_FullAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(62, dataMode, 0)

def AddDataMode(builder, dataMode):
    Operatingunit_FullAddDataMode(builder, dataMode)

def Operatingunit_FullAddOrganization(builder, organization):
...
def AddOrganization(builder, organization):
    Operatingunit_FullAddOrganization(builder, organization)

def Operatingunit_FullAddLocation(builder, location):
...
def AddLocation(builder, location):
    Operatingunit_FullAddLocation(builder, location)

def Operatingunit_FullEnd(builder):
    return builder.EndObject()

def End(builder):
    return Operatingunit_FullEnd(builder)
...
class Operatingunit_FullT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        operatingunitFull = Operatingunit_Full()
        operatingunitFull.Init(buf, pos)
        return cls.InitFromObj(operatingunitFull)
    ...
    @classmethod
    def InitFromObj(cls, operatingunitFull):
        x = Operatingunit_FullT()
        x._UnPack(operatingunitFull)
        return x

    # Operatingunit_FullT
    def _UnPack(self, operatingunitFull):
        if operatingunitFull is None:
            return
        self.idOperatingUnit = operatingunitFull.IdOperatingUnit()
        self.classificationMarking = operatingunitFull.ClassificationMarking()
        self.altOperatingUnitId = operatingunitFull.AltOperatingUnitId()
        self.name = operatingunitFull.Name()
        self.description = operatingunitFull.Description()
        self.idLocation = operatingunitFull.IdLocation()
        self.idContact = operatingunitFull.IdContact()
        self.idOrganization = operatingunitFull.IdOrganization()
        self.unitIdentifier = operatingunitFull.UnitIdentifier()
        self.countryCode = operatingunitFull.CountryCode()
        self.altCountryCode = operatingunitFull.AltCountryCode()
        self.wac = operatingunitFull.Wac()
        self.operStatus = operatingunitFull.OperStatus()
        self.condition = operatingunitFull.Condition()
        self.conditionAvail = operatingunitFull.ConditionAvail()
        self.eval = operatingunitFull.Eval()
        self.fpa = operatingunitFull.Fpa()
        self.ident = operatingunitFull.Ident()
        self.allegiance = operatingunitFull.Allegiance()
        self.altAllegiance = operatingunitFull.AltAllegiance()
        self.locName = operatingunitFull.LocName()
        self.locReason = operatingunitFull.LocReason()
        self.force = operatingunitFull.Force()
        self.forceName = operatingunitFull.ForceName()
        self.functRole = operatingunitFull.FunctRole()
        self.msnPrimary = operatingunitFull.MsnPrimary()
        self.msnPrimarySpecialty = operatingunitFull.MsnPrimarySpecialty()
        self.masterUnit = operatingunitFull.MasterUnit()
        self.stylizedUnit = operatingunitFull.StylizedUnit()
        self.divCat = operatingunitFull.DivCat()
        self.echelon = operatingunitFull.Echelon()
        self.echelonTier = operatingunitFull.EchelonTier()
        self.fleetId = operatingunitFull.FleetId()
        self.deployStatus = operatingunitFull.DeployStatus()
        self.flagFlown = operatingunitFull.FlagFlown()
        self.coordDatum = operatingunitFull.CoordDatum()
        self.coord = operatingunitFull.Coord()
        self.coordDerivAcc = operatingunitFull.CoordDerivAcc()
        self.lat = operatingunitFull.Lat()
        self.lon = operatingunitFull.Lon()
        self.elevMsl = operatingunitFull.ElevMsl()
        self.elevMslConfLvl = operatingunitFull.ElevMslConfLvl()
        self.elevMslDerivAcc = operatingunitFull.ElevMslDerivAcc()
        self.geoidalMslSep = operatingunitFull.GeoidalMslSep()
        self.milGridSys = operatingunitFull.MilGridSys()
        self.milGrid = operatingunitFull.MilGrid()
        self.utm = operatingunitFull.Utm()
        self.airDefArea = operatingunitFull.AirDefArea()
        self.polSubdiv = operatingunitFull.PolSubdiv()
        self.symCode = operatingunitFull.SymCode()
        self.classRating = operatingunitFull.ClassRating()
        self.recStatus = operatingunitFull.RecStatus()
        self.reviewDate = operatingunitFull.ReviewDate()
        self.resProd = operatingunitFull.ResProd()
        self.referenceDoc = operatingunitFull.ReferenceDoc()
        if not operatingunitFull.OperatingUnitRemarksIsNone():
            self.operatingUnitRemarks = []
            for i in range(operatingunitFull.OperatingUnitRemarksLength()):
                self.operatingUnitRemarks.append(operatingunitFull.OperatingUnitRemarks(i))
        self.createdAt = operatingunitFull.CreatedAt()
        self.createdBy = operatingunitFull.CreatedBy()
        self.updatedAt = operatingunitFull.UpdatedAt()
        self.updatedBy = operatingunitFull.UpdatedBy()
        self.source = operatingunitFull.Source()
        self.origin = operatingunitFull.Origin()
        self.dataMode = operatingunitFull.DataMode()
        self.organization = operatingunitFull.Organization()
        self.location = operatingunitFull.Location()
    ...
    def Pack(self, builder):
        ...
        if self.operatingUnitRemarks is not None:
            ...
            Operatingunit_FullStartOperatingUnitRemarksVector(builder, len(self.operatingUnitRemarks))
        ...
        if self.conditionAvail is not None:
            Operatingunit_FullAddConditionAvail(builder, conditionAvail)
        Operatingunit_FullAddEval(builder, self.eval)
        if self.fpa is not None:
            Operatingunit_FullAddFpa(builder, fpa)
        if self.ident is not None:
            Operatingunit_FullAddIdent(builder, ident)
        ...
        if self.msnPrimarySpecialty is not None:
            Operatingunit_FullAddMsnPrimarySpecialty(builder, msnPrimarySpecialty)
        Operatingunit_FullAddMasterUnit(builder, self.masterUnit)
        Operatingunit_FullAddStylizedUnit(builder, self.stylizedUnit)
        if self.divCat is not None:
            Operatingunit_FullAddDivCat(builder, divCat)
        if self.echelon is not None:
            Operatingunit_FullAddEchelon(builder, echelon)
        ...
        if self.coord is not None:
            Operatingunit_FullAddCoord(builder, coord)
        Operatingunit_FullAddCoordDerivAcc(builder, self.coordDerivAcc)
        Operatingunit_FullAddLat(builder, self.lat)
        Operatingunit_FullAddLon(builder, self.lon)
        Operatingunit_FullAddElevMsl(builder, self.elevMsl)
        Operatingunit_FullAddElevMslConfLvl(builder, self.elevMslConfLvl)
        Operatingunit_FullAddElevMslDerivAcc(builder, self.elevMslDerivAcc)
        Operatingunit_FullAddGeoidalMslSep(builder, self.geoidalMslSep)
        if self.milGridSys is not None:
            Operatingunit_FullAddMilGridSys(builder, milGridSys)
        if self.milGrid is not None:
            Operatingunit_FullAddMilGrid(builder, milGrid)
        ...
        if self.origin is not None:
            Operatingunit_FullAddOrigin(builder, origin)
        Operatingunit_FullAddDataMode(builder, self.dataMode)
        if self.organization is not None:
            Operatingunit_FullAddOrganization(builder, organization)
        if self.location is not None:
            Operatingunit_FullAddLocation(builder, location)
        operatingunitFull = Operatingunit_FullEnd(builder)
        return operatingunitFull
