...
class DataLinkReferences_Abridged(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsDataLinkReferences_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def DataLinkReferences_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
        return flatbuffers.util.BufferHasIdentifier(buf, offset, b"\x44\x41\x54\x41", size_prefixed=size_prefixed)

    # DataLinkReferences_Abridged
...
def DataLinkReferences_AbridgedStart(builder):
    builder.StartObject(7)

def Start(builder):
    DataLinkReferences_AbridgedStart(builder)

def DataLinkReferences_AbridgedAddRefSerialId(builder, refSerialId):
...
def AddRefSerialId(builder, refSerialId):
    DataLinkReferences_AbridgedAddRefSerialId(builder, refSerialId)

def DataLinkReferences_AbridgedAddRefType(builder, refType):
...
def AddRefType(builder, refType):
    DataLinkReferences_AbridgedAddRefType(builder, refType)

def DataLinkReferences_AbridgedAddRefOriginator(builder, refOriginator):
...
def AddRefOriginator(builder, refOriginator):
    DataLinkReferences_AbridgedAddRefOriginator(builder, refOriginator)

def DataLinkReferences_AbridgedAddRefTs(builder, refTs):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(refTs), 0)

def AddRefTs(builder, refTs):
    DataLinkReferences_AbridgedAddRefTs(builder, refTs)

def DataLinkReferences_AbridgedAddRefSerialNum(builder, refSerialNum):
...
def AddRefSerialNum(builder, refSerialNum):
    DataLinkReferences_AbridgedAddRefSerialNum(builder, refSerialNum)

def DataLinkReferences_AbridgedAddRefSpecialNotation(builder, refSpecialNotation):
...
def AddRefSpecialNotation(builder, refSpecialNotation):
    DataLinkReferences_AbridgedAddRefSpecialNotation(builder, refSpecialNotation)

def DataLinkReferences_AbridgedAddRefSics(builder, refSics):
...
def AddRefSics(builder, refSics):
    DataLinkReferences_AbridgedAddRefSics(builder, refSics)

def DataLinkReferences_AbridgedStartRefSicsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartRefSicsVector(builder, numElems):
    return DataLinkReferences_AbridgedStartRefSicsVector(builder, numElems)

def DataLinkReferences_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return DataLinkReferences_AbridgedEnd(builder)
...
class DataLinkReferences_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        dataLinkReferencesAbridged = DataLinkReferences_Abridged()
        dataLinkReferencesAbridged.Init(buf, pos)
        return cls.InitFromObj(dataLinkReferencesAbridged)
    ...
    @classmethod
    def InitFromObj(cls, dataLinkReferencesAbridged):
        x = DataLinkReferences_AbridgedT()
        x._UnPack(dataLinkReferencesAbridged)
        return x

    # DataLinkReferences_AbridgedT
    def _UnPack(self, dataLinkReferencesAbridged):
        if dataLinkReferencesAbridged is None:
            return
        self.refSerialId = dataLinkReferencesAbridged.RefSerialId()
        self.refType = dataLinkReferencesAbridged.RefType()
        self.refOriginator = dataLinkReferencesAbridged.RefOriginator()
        self.refTs = dataLinkReferencesAbridged.RefTs()
        self.refSerialNum = dataLinkReferencesAbridged.RefSerialNum()
        self.refSpecialNotation = dataLinkReferencesAbridged.RefSpecialNotation()
        if not dataLinkReferencesAbridged.RefSicsIsNone():
            self.refSics = []
            for i in range(dataLinkReferencesAbridged.RefSicsLength()):
                self.refSics.append(dataLinkReferencesAbridged.RefSics(i))
    ...
    def Pack(self, builder):
        ...
        if self.refSics is not None:
            ...
            DataLinkReferences_AbridgedStartRefSicsVector(builder, len(self.refSics))
        ...
        if self.refSics is not None:
            DataLinkReferences_AbridgedAddRefSics(builder, refSics)
        dataLinkReferencesAbridged = DataLinkReferences_AbridgedEnd(builder)
        return dataLinkReferencesAbridged
