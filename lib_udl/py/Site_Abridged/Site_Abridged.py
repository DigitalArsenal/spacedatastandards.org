...
class Site_Abridged(object):
    ...
    @classmethod
    def GetRootAsSite_Abridged(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def Site_AbridgedBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def Site_AbridgedStart(builder):
    builder.StartObject(65)

def Start(builder):
    Site_AbridgedStart(builder)

def Site_AbridgedAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    Site_AbridgedAddId(builder, id)

def Site_AbridgedAddIdEntity(builder, idEntity):
...
def AddIdEntity(builder, idEntity):
    Site_AbridgedAddIdEntity(builder, idEntity)

def Site_AbridgedAddIdParentSite(builder, idParentSite):
    builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(idParentSite), 0)

def AddIdParentSite(builder, idParentSite):
    Site_AbridgedAddIdParentSite(builder, idParentSite)

def Site_AbridgedAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    Site_AbridgedAddClassificationMarking(builder, classificationMarking)

def Site_AbridgedAddOrigSiteId(builder, origSiteId):
    builder.PrependUOffsetTRelativeSlot(4, flatbuffers.number_types.UOffsetTFlags.py_type(origSiteId), 0)

def AddOrigSiteId(builder, origSiteId):
    Site_AbridgedAddOrigSiteId(builder, origSiteId)

def Site_AbridgedAddOrigLzId(builder, origLzId):
    builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(origLzId), 0)

def AddOrigLzId(builder, origLzId):
    Site_AbridgedAddOrigLzId(builder, origLzId)

def Site_AbridgedAddPin(builder, pin):
    builder.PrependUOffsetTRelativeSlot(6, flatbuffers.number_types.UOffsetTFlags.py_type(pin), 0)

def AddPin(builder, pin):
    Site_AbridgedAddPin(builder, pin)

def Site_AbridgedAddType(builder, type):
    builder.PrependUOffsetTRelativeSlot(7, flatbuffers.number_types.UOffsetTFlags.py_type(type), 0)

def AddType(builder, type):
    Site_AbridgedAddType(builder, type)

def Site_AbridgedAddUsage(builder, usage):
    builder.PrependUOffsetTRelativeSlot(8, flatbuffers.number_types.UOffsetTFlags.py_type(usage), 0)

def AddUsage(builder, usage):
    Site_AbridgedAddUsage(builder, usage)

def Site_AbridgedAddLzUsage(builder, lzUsage):
    builder.PrependUOffsetTRelativeSlot(9, flatbuffers.number_types.UOffsetTFlags.py_type(lzUsage), 0)

def AddLzUsage(builder, lzUsage):
    Site_AbridgedAddLzUsage(builder, lzUsage)

def Site_AbridgedAddName(builder, name):
    builder.PrependUOffsetTRelativeSlot(10, flatbuffers.number_types.UOffsetTFlags.py_type(name), 0)

def AddName(builder, name):
    Site_AbridgedAddName(builder, name)

def Site_AbridgedAddCoordDatum(builder, coordDatum):
    builder.PrependUOffsetTRelativeSlot(11, flatbuffers.number_types.UOffsetTFlags.py_type(coordDatum), 0)

def AddCoordDatum(builder, coordDatum):
    Site_AbridgedAddCoordDatum(builder, coordDatum)

def Site_AbridgedAddCoord(builder, coord):
    builder.PrependUOffsetTRelativeSlot(12, flatbuffers.number_types.UOffsetTFlags.py_type(coord), 0)

def AddCoord(builder, coord):
    Site_AbridgedAddCoord(builder, coord)

def Site_AbridgedAddCoordDerivAcc(builder, coordDerivAcc):
    builder.PrependFloat64Slot(13, coordDerivAcc, 0.0)

def AddCoordDerivAcc(builder, coordDerivAcc):
    Site_AbridgedAddCoordDerivAcc(builder, coordDerivAcc)

def Site_AbridgedAddOsuffix(builder, osuffix):
    builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(osuffix), 0)

def AddOsuffix(builder, osuffix):
    Site_AbridgedAddOsuffix(builder, osuffix)

def Site_AbridgedAddIata(builder, iata):
    builder.PrependUOffsetTRelativeSlot(15, flatbuffers.number_types.UOffsetTFlags.py_type(iata), 0)

def AddIata(builder, iata):
    Site_AbridgedAddIata(builder, iata)

def Site_AbridgedAddIcao(builder, icao):
    builder.PrependUOffsetTRelativeSlot(16, flatbuffers.number_types.UOffsetTFlags.py_type(icao), 0)

def AddIcao(builder, icao):
    Site_AbridgedAddIcao(builder, icao)

def Site_AbridgedAddFaa(builder, faa):
    builder.PrependUOffsetTRelativeSlot(17, flatbuffers.number_types.UOffsetTFlags.py_type(faa), 0)

def AddFaa(builder, faa):
    Site_AbridgedAddFaa(builder, faa)

def Site_AbridgedAddAirDefArea(builder, airDefArea):
    builder.PrependUOffsetTRelativeSlot(18, flatbuffers.number_types.UOffsetTFlags.py_type(airDefArea), 0)

def AddAirDefArea(builder, airDefArea):
    Site_AbridgedAddAirDefArea(builder, airDefArea)

def Site_AbridgedAddUtm(builder, utm):
    builder.PrependUOffsetTRelativeSlot(19, flatbuffers.number_types.UOffsetTFlags.py_type(utm), 0)

def AddUtm(builder, utm):
    Site_AbridgedAddUtm(builder, utm)

def Site_AbridgedAddMilGridSys(builder, milGridSys):
    builder.PrependUOffsetTRelativeSlot(20, flatbuffers.number_types.UOffsetTFlags.py_type(milGridSys), 0)

def AddMilGridSys(builder, milGridSys):
    Site_AbridgedAddMilGridSys(builder, milGridSys)

def Site_AbridgedAddMilGrid(builder, milGrid):
    builder.PrependUOffsetTRelativeSlot(21, flatbuffers.number_types.UOffsetTFlags.py_type(milGrid), 0)

def AddMilGrid(builder, milGrid):
    Site_AbridgedAddMilGrid(builder, milGrid)

def Site_AbridgedAddCatCode(builder, catCode):
    builder.PrependUOffsetTRelativeSlot(22, flatbuffers.number_types.UOffsetTFlags.py_type(catCode), 0)

def AddCatCode(builder, catCode):
    Site_AbridgedAddCatCode(builder, catCode)

def Site_AbridgedAddCatText(builder, catText):
    builder.PrependUOffsetTRelativeSlot(23, flatbuffers.number_types.UOffsetTFlags.py_type(catText), 0)

def AddCatText(builder, catText):
    Site_AbridgedAddCatText(builder, catText)

def Site_AbridgedAddWac(builder, wac):
    builder.PrependUOffsetTRelativeSlot(24, flatbuffers.number_types.UOffsetTFlags.py_type(wac), 0)

def AddWac(builder, wac):
    Site_AbridgedAddWac(builder, wac)

def Site_AbridgedAddPolSubdiv(builder, polSubdiv):
    builder.PrependUOffsetTRelativeSlot(25, flatbuffers.number_types.UOffsetTFlags.py_type(polSubdiv), 0)

def AddPolSubdiv(builder, polSubdiv):
    Site_AbridgedAddPolSubdiv(builder, polSubdiv)

def Site_AbridgedAddGeoArea(builder, geoArea):
    builder.PrependUOffsetTRelativeSlot(26, flatbuffers.number_types.UOffsetTFlags.py_type(geoArea), 0)

def AddGeoArea(builder, geoArea):
    Site_AbridgedAddGeoArea(builder, geoArea)

def Site_AbridgedAddGeoidalMslSep(builder, geoidalMslSep):
    builder.PrependFloat64Slot(27, geoidalMslSep, 0.0)

def AddGeoidalMslSep(builder, geoidalMslSep):
    Site_AbridgedAddGeoidalMslSep(builder, geoidalMslSep)

def Site_AbridgedAddAllegiance(builder, allegiance):
    builder.PrependUOffsetTRelativeSlot(28, flatbuffers.number_types.UOffsetTFlags.py_type(allegiance), 0)

def AddAllegiance(builder, allegiance):
    Site_AbridgedAddAllegiance(builder, allegiance)

def Site_AbridgedAddAltAllegiance(builder, altAllegiance):
    builder.PrependUOffsetTRelativeSlot(29, flatbuffers.number_types.UOffsetTFlags.py_type(altAllegiance), 0)

def AddAltAllegiance(builder, altAllegiance):
    Site_AbridgedAddAltAllegiance(builder, altAllegiance)

def Site_AbridgedAddClassRating(builder, classRating):
    builder.PrependUOffsetTRelativeSlot(30, flatbuffers.number_types.UOffsetTFlags.py_type(classRating), 0)

def AddClassRating(builder, classRating):
    Site_AbridgedAddClassRating(builder, classRating)

def Site_AbridgedAddFpa(builder, fpa):
    builder.PrependUOffsetTRelativeSlot(31, flatbuffers.number_types.UOffsetTFlags.py_type(fpa), 0)

def AddFpa(builder, fpa):
    Site_AbridgedAddFpa(builder, fpa)

def Site_AbridgedAddBeNumber(builder, beNumber):
    builder.PrependUOffsetTRelativeSlot(32, flatbuffers.number_types.UOffsetTFlags.py_type(beNumber), 0)

def AddBeNumber(builder, beNumber):
    Site_AbridgedAddBeNumber(builder, beNumber)

def Site_AbridgedAddRunways(builder, runways):
    builder.PrependInt32Slot(33, runways, 0)

def AddRunways(builder, runways):
    Site_AbridgedAddRunways(builder, runways)

def Site_AbridgedAddMaxRunwayLength(builder, maxRunwayLength):
    builder.PrependInt32Slot(34, maxRunwayLength, 0)

def AddMaxRunwayLength(builder, maxRunwayLength):
    Site_AbridgedAddMaxRunwayLength(builder, maxRunwayLength)

def Site_AbridgedAddCondition(builder, condition):
    builder.PrependUOffsetTRelativeSlot(35, flatbuffers.number_types.UOffsetTFlags.py_type(condition), 0)

def AddCondition(builder, condition):
    Site_AbridgedAddCondition(builder, condition)

def Site_AbridgedAddConditionAvail(builder, conditionAvail):
    builder.PrependUOffsetTRelativeSlot(36, flatbuffers.number_types.UOffsetTFlags.py_type(conditionAvail), 0)

def AddConditionAvail(builder, conditionAvail):
    Site_AbridgedAddConditionAvail(builder, conditionAvail)

def Site_AbridgedAddOperStatus(builder, operStatus):
    builder.PrependUOffsetTRelativeSlot(37, flatbuffers.number_types.UOffsetTFlags.py_type(operStatus), 0)

def AddOperStatus(builder, operStatus):
    Site_AbridgedAddOperStatus(builder, operStatus)

def Site_AbridgedAddGrade(builder, grade):
    builder.PrependInt32Slot(38, grade, 0)

def AddGrade(builder, grade):
    Site_AbridgedAddGrade(builder, grade)

def Site_AbridgedAddActivity(builder, activity):
    builder.PrependUOffsetTRelativeSlot(39, flatbuffers.number_types.UOffsetTFlags.py_type(activity), 0)

def AddActivity(builder, activity):
    Site_AbridgedAddActivity(builder, activity)

def Site_AbridgedAddFunctPrimary(builder, functPrimary):
    builder.PrependUOffsetTRelativeSlot(40, flatbuffers.number_types.UOffsetTFlags.py_type(functPrimary), 0)

def AddFunctPrimary(builder, functPrimary):
    Site_AbridgedAddFunctPrimary(builder, functPrimary)

def Site_AbridgedAddMsnPrimary(builder, msnPrimary):
    builder.PrependUOffsetTRelativeSlot(41, flatbuffers.number_types.UOffsetTFlags.py_type(msnPrimary), 0)

def AddMsnPrimary(builder, msnPrimary):
    Site_AbridgedAddMsnPrimary(builder, msnPrimary)

def Site_AbridgedAddMsnPrimarySpec(builder, msnPrimarySpec):
    builder.PrependUOffsetTRelativeSlot(42, flatbuffers.number_types.UOffsetTFlags.py_type(msnPrimarySpec), 0)

def AddMsnPrimarySpec(builder, msnPrimarySpec):
    Site_AbridgedAddMsnPrimarySpec(builder, msnPrimarySpec)

def Site_AbridgedAddNucCap(builder, nucCap):
    builder.PrependUOffsetTRelativeSlot(43, flatbuffers.number_types.UOffsetTFlags.py_type(nucCap), 0)

def AddNucCap(builder, nucCap):
    Site_AbridgedAddNucCap(builder, nucCap)

def Site_AbridgedAddIdent(builder, ident):
    builder.PrependUOffsetTRelativeSlot(44, flatbuffers.number_types.UOffsetTFlags.py_type(ident), 0)

def AddIdent(builder, ident):
    Site_AbridgedAddIdent(builder, ident)

def Site_AbridgedAddElevMsl(builder, elevMsl):
    builder.PrependFloat64Slot(45, elevMsl, 0.0)

def AddElevMsl(builder, elevMsl):
    Site_AbridgedAddElevMsl(builder, elevMsl)

def Site_AbridgedAddElevMslConfLvl(builder, elevMslConfLvl):
    builder.PrependInt32Slot(46, elevMslConfLvl, 0)

def AddElevMslConfLvl(builder, elevMslConfLvl):
    Site_AbridgedAddElevMslConfLvl(builder, elevMslConfLvl)

def Site_AbridgedAddElevMslDerivAcc(builder, elevMslDerivAcc):
    builder.PrependFloat64Slot(47, elevMslDerivAcc, 0.0)

def AddElevMslDerivAcc(builder, elevMslDerivAcc):
    Site_AbridgedAddElevMslDerivAcc(builder, elevMslDerivAcc)

def Site_AbridgedAddVegHt(builder, vegHt):
    builder.PrependFloat64Slot(48, vegHt, 0.0)

def AddVegHt(builder, vegHt):
    Site_AbridgedAddVegHt(builder, vegHt)

def Site_AbridgedAddVegType(builder, vegType):
    builder.PrependUOffsetTRelativeSlot(49, flatbuffers.number_types.UOffsetTFlags.py_type(vegType), 0)

def AddVegType(builder, vegType):
    Site_AbridgedAddVegType(builder, vegType)

def Site_AbridgedAddPopArea(builder, popArea):
    builder.PrependBoolSlot(50, popArea, 0)

def AddPopArea(builder, popArea):
    Site_AbridgedAddPopArea(builder, popArea)

def Site_AbridgedAddPopAreaProx(builder, popAreaProx):
    builder.PrependFloat64Slot(51, popAreaProx, 0.0)

def AddPopAreaProx(builder, popAreaProx):
    Site_AbridgedAddPopAreaProx(builder, popAreaProx)

def Site_AbridgedAddNotes(builder, notes):
    builder.PrependUOffsetTRelativeSlot(52, flatbuffers.number_types.UOffsetTFlags.py_type(notes), 0)

def AddNotes(builder, notes):
    Site_AbridgedAddNotes(builder, notes)

def Site_AbridgedAddResProd(builder, resProd):
...
def AddResProd(builder, resProd):
    Site_AbridgedAddResProd(builder, resProd)

def Site_AbridgedAddEval(builder, eval):
    builder.PrependInt32Slot(54, eval, 0)

def AddEval(builder, eval):
    Site_AbridgedAddEval(builder, eval)

def Site_AbridgedAddReviewDate(builder, reviewDate):
    builder.PrependUOffsetTRelativeSlot(55, flatbuffers.number_types.UOffsetTFlags.py_type(reviewDate), 0)

def AddReviewDate(builder, reviewDate):
    Site_AbridgedAddReviewDate(builder, reviewDate)

def Site_AbridgedAddRecStatus(builder, recStatus):
    builder.PrependUOffsetTRelativeSlot(56, flatbuffers.number_types.UOffsetTFlags.py_type(recStatus), 0)

def AddRecStatus(builder, recStatus):
    Site_AbridgedAddRecStatus(builder, recStatus)

def Site_AbridgedAddSymCode(builder, symCode):
    builder.PrependUOffsetTRelativeSlot(57, flatbuffers.number_types.UOffsetTFlags.py_type(symCode), 0)

def AddSymCode(builder, symCode):
    Site_AbridgedAddSymCode(builder, symCode)

def Site_AbridgedAddReferenceDoc(builder, referenceDoc):
    builder.PrependUOffsetTRelativeSlot(58, flatbuffers.number_types.UOffsetTFlags.py_type(referenceDoc), 0)

def AddReferenceDoc(builder, referenceDoc):
    Site_AbridgedAddReferenceDoc(builder, referenceDoc)

def Site_AbridgedAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(59, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    Site_AbridgedAddCreatedAt(builder, createdAt)

def Site_AbridgedAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(60, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    Site_AbridgedAddCreatedBy(builder, createdBy)

def Site_AbridgedAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(61, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    Site_AbridgedAddSource(builder, source)

def Site_AbridgedAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(62, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    Site_AbridgedAddOrigin(builder, origin)

def Site_AbridgedAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(63, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    Site_AbridgedAddOrigNetwork(builder, origNetwork)

def Site_AbridgedAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(64, dataMode, 0)

def AddDataMode(builder, dataMode):
    Site_AbridgedAddDataMode(builder, dataMode)

def Site_AbridgedEnd(builder):
    return builder.EndObject()

def End(builder):
    return Site_AbridgedEnd(builder)


class Site_AbridgedT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        siteAbridged = Site_Abridged()
        siteAbridged.Init(buf, pos)
        return cls.InitFromObj(siteAbridged)
    ...
    @classmethod
    def InitFromObj(cls, siteAbridged):
        x = Site_AbridgedT()
        x._UnPack(siteAbridged)
        return x

    # Site_AbridgedT
    def _UnPack(self, siteAbridged):
        if siteAbridged is None:
            return
        self.id = siteAbridged.Id()
        self.idEntity = siteAbridged.IdEntity()
        self.idParentSite = siteAbridged.IdParentSite()
        self.classificationMarking = siteAbridged.ClassificationMarking()
        self.origSiteId = siteAbridged.OrigSiteId()
        self.origLzId = siteAbridged.OrigLzId()
        self.pin = siteAbridged.Pin()
        self.type = siteAbridged.Type()
        self.usage = siteAbridged.Usage()
        self.lzUsage = siteAbridged.LzUsage()
        self.name = siteAbridged.Name()
        self.coordDatum = siteAbridged.CoordDatum()
        self.coord = siteAbridged.Coord()
        self.coordDerivAcc = siteAbridged.CoordDerivAcc()
        self.osuffix = siteAbridged.Osuffix()
        self.iata = siteAbridged.Iata()
        self.icao = siteAbridged.Icao()
        self.faa = siteAbridged.Faa()
        self.airDefArea = siteAbridged.AirDefArea()
        self.utm = siteAbridged.Utm()
        self.milGridSys = siteAbridged.MilGridSys()
        self.milGrid = siteAbridged.MilGrid()
        self.catCode = siteAbridged.CatCode()
        self.catText = siteAbridged.CatText()
        self.wac = siteAbridged.Wac()
        self.polSubdiv = siteAbridged.PolSubdiv()
        self.geoArea = siteAbridged.GeoArea()
        self.geoidalMslSep = siteAbridged.GeoidalMslSep()
        self.allegiance = siteAbridged.Allegiance()
        self.altAllegiance = siteAbridged.AltAllegiance()
        self.classRating = siteAbridged.ClassRating()
        self.fpa = siteAbridged.Fpa()
        self.beNumber = siteAbridged.BeNumber()
        self.runways = siteAbridged.Runways()
        self.maxRunwayLength = siteAbridged.MaxRunwayLength()
        self.condition = siteAbridged.Condition()
        self.conditionAvail = siteAbridged.ConditionAvail()
        self.operStatus = siteAbridged.OperStatus()
        self.grade = siteAbridged.Grade()
        self.activity = siteAbridged.Activity()
        self.functPrimary = siteAbridged.FunctPrimary()
        self.msnPrimary = siteAbridged.MsnPrimary()
        self.msnPrimarySpec = siteAbridged.MsnPrimarySpec()
        self.nucCap = siteAbridged.NucCap()
        self.ident = siteAbridged.Ident()
        self.elevMsl = siteAbridged.ElevMsl()
        self.elevMslConfLvl = siteAbridged.ElevMslConfLvl()
        self.elevMslDerivAcc = siteAbridged.ElevMslDerivAcc()
        self.vegHt = siteAbridged.VegHt()
        self.vegType = siteAbridged.VegType()
        self.popArea = siteAbridged.PopArea()
        self.popAreaProx = siteAbridged.PopAreaProx()
        self.notes = siteAbridged.Notes()
        self.resProd = siteAbridged.ResProd()
        self.eval = siteAbridged.Eval()
        self.reviewDate = siteAbridged.ReviewDate()
        self.recStatus = siteAbridged.RecStatus()
        self.symCode = siteAbridged.SymCode()
        self.referenceDoc = siteAbridged.ReferenceDoc()
        self.createdAt = siteAbridged.CreatedAt()
        self.createdBy = siteAbridged.CreatedBy()
        self.source = siteAbridged.Source()
        self.origin = siteAbridged.Origin()
        self.origNetwork = siteAbridged.OrigNetwork()
        self.dataMode = siteAbridged.DataMode()
    ...
    def Pack(self, builder):
        ...
        if self.coord is not None:
            Site_AbridgedAddCoord(builder, coord)
        Site_AbridgedAddCoordDerivAcc(builder, self.coordDerivAcc)
        if self.osuffix is not None:
            Site_AbridgedAddOsuffix(builder, osuffix)
        if self.iata is not None:
            Site_AbridgedAddIata(builder, iata)
        ...
        if self.geoArea is not None:
            Site_AbridgedAddGeoArea(builder, geoArea)
        Site_AbridgedAddGeoidalMslSep(builder, self.geoidalMslSep)
        if self.allegiance is not None:
            Site_AbridgedAddAllegiance(builder, allegiance)
        if self.altAllegiance is not None:
            Site_AbridgedAddAltAllegiance(builder, altAllegiance)
        ...
        if self.beNumber is not None:
            Site_AbridgedAddBeNumber(builder, beNumber)
        Site_AbridgedAddRunways(builder, self.runways)
        Site_AbridgedAddMaxRunwayLength(builder, self.maxRunwayLength)
        if self.condition is not None:
            Site_AbridgedAddCondition(builder, condition)
        if self.conditionAvail is not None:
            Site_AbridgedAddConditionAvail(builder, conditionAvail)
        if self.operStatus is not None:
            Site_AbridgedAddOperStatus(builder, operStatus)
        Site_AbridgedAddGrade(builder, self.grade)
        if self.activity is not None:
            Site_AbridgedAddActivity(builder, activity)
        if self.functPrimary is not None:
            Site_AbridgedAddFunctPrimary(builder, functPrimary)
        ...
        if self.ident is not None:
            Site_AbridgedAddIdent(builder, ident)
        Site_AbridgedAddElevMsl(builder, self.elevMsl)
        Site_AbridgedAddElevMslConfLvl(builder, self.elevMslConfLvl)
        Site_AbridgedAddElevMslDerivAcc(builder, self.elevMslDerivAcc)
        Site_AbridgedAddVegHt(builder, self.vegHt)
        if self.vegType is not None:
            Site_AbridgedAddVegType(builder, vegType)
        Site_AbridgedAddPopArea(builder, self.popArea)
        Site_AbridgedAddPopAreaProx(builder, self.popAreaProx)
        if self.notes is not None:
            Site_AbridgedAddNotes(builder, notes)
        if self.resProd is not None:
            Site_AbridgedAddResProd(builder, resProd)
        Site_AbridgedAddEval(builder, self.eval)
        if self.reviewDate is not None:
            Site_AbridgedAddReviewDate(builder, reviewDate)
        if self.recStatus is not None:
            Site_AbridgedAddRecStatus(builder, recStatus)
        ...
        if self.origNetwork is not None:
            Site_AbridgedAddOrigNetwork(builder, origNetwork)
        Site_AbridgedAddDataMode(builder, self.dataMode)
        siteAbridged = Site_AbridgedEnd(builder)
        return siteAbridged
