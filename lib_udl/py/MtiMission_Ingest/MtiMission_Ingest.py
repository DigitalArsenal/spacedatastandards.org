...
class MtiMission_Ingest(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsMtiMission_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def MtiMission_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def AddMsnRefTs(builder, msnRefTs):
    MtiMission_IngestAddMsnRefTs(builder, msnRefTs)

def MtiMission_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return MtiMission_IngestEnd(builder)


class MtiMission_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        mtiMissionIngest = MtiMission_Ingest()
        mtiMissionIngest.Init(buf, pos)
        return cls.InitFromObj(mtiMissionIngest)
    ...
    @classmethod
    def InitFromObj(cls, mtiMissionIngest):
        x = MtiMission_IngestT()
        x._UnPack(mtiMissionIngest)
        return x

    # MtiMission_IngestT
    def _UnPack(self, mtiMissionIngest):
        if mtiMissionIngest is None:
            return
        self.m1 = mtiMissionIngest.M1()
        self.m2 = mtiMissionIngest.M2()
        self.m3 = mtiMissionIngest.M3()
        self.m4 = mtiMissionIngest.M4()
        self.msnRefTs = mtiMissionIngest.MsnRefTs()
    ...
    def Pack(self, builder):
        ...
        if self.msnRefTs is not None:
            MtiMission_IngestAddMsnRefTs(builder, msnRefTs)
        mtiMissionIngest = MtiMission_IngestEnd(builder)
        return mtiMissionIngest
