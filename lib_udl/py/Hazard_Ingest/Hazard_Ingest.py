...
class Hazard_Ingest(object):
    ...
    @classmethod
    def GetRootAsHazard_Ingest(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    @classmethod
    def Hazard_IngestBufferHasIdentifier(cls, buf, offset, size_prefixed=False):
...
def Hazard_IngestStart(builder):
    builder.StartObject(40)

def Start(builder):
    Hazard_IngestStart(builder)

def Hazard_IngestAddId(builder, id):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(id), 0)

def AddId(builder, id):
    Hazard_IngestAddId(builder, id)

def Hazard_IngestAddClassificationMarking(builder, classificationMarking):
    builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(classificationMarking), 0)

def AddClassificationMarking(builder, classificationMarking):
    Hazard_IngestAddClassificationMarking(builder, classificationMarking)

def Hazard_IngestAddDetectType(builder, detectType):
...
def AddDetectType(builder, detectType):
    Hazard_IngestAddDetectType(builder, detectType)

def Hazard_IngestAddDetectTime(builder, detectTime):
...
def AddDetectTime(builder, detectTime):
    Hazard_IngestAddDetectTime(builder, detectTime)

def Hazard_IngestAddHarmful(builder, harmful):
    builder.PrependBoolSlot(4, harmful, 0)

def AddHarmful(builder, harmful):
    Hazard_IngestAddHarmful(builder, harmful)

def Hazard_IngestAddAlarms(builder, alarms):
...
def AddAlarms(builder, alarms):
    Hazard_IngestAddAlarms(builder, alarms)

def Hazard_IngestStartAlarmsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartAlarmsVector(builder, numElems):
    return Hazard_IngestStartAlarmsVector(builder, numElems)

def Hazard_IngestAddAlarmValues(builder, alarmValues):
...
def AddAlarmValues(builder, alarmValues):
    Hazard_IngestAddAlarmValues(builder, alarmValues)

def Hazard_IngestStartAlarmValuesVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartAlarmValuesVector(builder, numElems):
    return Hazard_IngestStartAlarmValuesVector(builder, numElems)

def Hazard_IngestAddReadings(builder, readings):
...
def AddReadings(builder, readings):
    Hazard_IngestAddReadings(builder, readings)

def Hazard_IngestStartReadingsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartReadingsVector(builder, numElems):
    return Hazard_IngestStartReadingsVector(builder, numElems)

def Hazard_IngestAddReadingUnits(builder, readingUnits):
...
def AddReadingUnits(builder, readingUnits):
    Hazard_IngestAddReadingUnits(builder, readingUnits)

def Hazard_IngestStartReadingUnitsVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartReadingUnitsVector(builder, numElems):
    return Hazard_IngestStartReadingUnitsVector(builder, numElems)

def Hazard_IngestAddReadingValues(builder, readingValues):
...
def AddReadingValues(builder, readingValues):
    Hazard_IngestAddReadingValues(builder, readingValues)

def Hazard_IngestStartReadingValuesVector(builder, numElems):
    return builder.StartVector(4, numElems, 4)

def StartReadingValuesVector(builder, numElems):
    return Hazard_IngestStartReadingValuesVector(builder, numElems)

def Hazard_IngestAddMatType(builder, matType):
...
def AddMatType(builder, matType):
    Hazard_IngestAddMatType(builder, matType)

def Hazard_IngestAddMatClass(builder, matClass):
...
def AddMatClass(builder, matClass):
    Hazard_IngestAddMatClass(builder, matClass)

def Hazard_IngestAddMatName(builder, matName):
...
def AddMatName(builder, matName):
    Hazard_IngestAddMatName(builder, matName)

def Hazard_IngestAddMatCat(builder, matCat):
    builder.PrependInt32Slot(13, matCat, 0)

def AddMatCat(builder, matCat):
    Hazard_IngestAddMatCat(builder, matCat)

def Hazard_IngestAddCasRn(builder, casRn):
    builder.PrependUOffsetTRelativeSlot(14, flatbuffers.number_types.UOffsetTFlags.py_type(casRn), 0)

def AddCasRn(builder, casRn):
    Hazard_IngestAddCasRn(builder, casRn)

def Hazard_IngestAddPpm(builder, ppm):
    builder.PrependInt32Slot(15, ppm, 0)

def AddPpm(builder, ppm):
    Hazard_IngestAddPpm(builder, ppm)

def Hazard_IngestAddDensity(builder, density):
    builder.PrependFloat64Slot(16, density, 0.0)

def AddDensity(builder, density):
    Hazard_IngestAddDensity(builder, density)

def Hazard_IngestAddRadCtrn(builder, radCtrn):
    builder.PrependFloat64Slot(17, radCtrn, 0.0)

def AddRadCtrn(builder, radCtrn):
    Hazard_IngestAddRadCtrn(builder, radCtrn)

def Hazard_IngestAddGBar(builder, gBar):
    builder.PrependFloat64Slot(18, gBar, 0.0)

def AddGBar(builder, gBar):
    Hazard_IngestAddGBar(builder, gBar)

def Hazard_IngestAddHBar(builder, hBar):
    builder.PrependFloat64Slot(19, hBar, 0.0)

def AddHBar(builder, hBar):
    Hazard_IngestAddHBar(builder, hBar)

def Hazard_IngestAddZ(builder, z):
    builder.PrependInt32Slot(20, z, 0)

def AddZ(builder, z):
    Hazard_IngestAddZ(builder, z)

def Hazard_IngestAddA(builder, a):
    builder.PrependInt32Slot(21, a, 0)

def AddA(builder, a):
    Hazard_IngestAddA(builder, a)

def Hazard_IngestAddBottleId(builder, bottleId):
...
def AddBottleId(builder, bottleId):
    Hazard_IngestAddBottleId(builder, bottleId)

def Hazard_IngestAddChannel(builder, channel):
...
def AddChannel(builder, channel):
    Hazard_IngestAddChannel(builder, channel)

def Hazard_IngestAddDuration(builder, duration):
    builder.PrependInt32Slot(24, duration, 0)

def AddDuration(builder, duration):
    Hazard_IngestAddDuration(builder, duration)

def Hazard_IngestAddActivity(builder, activity):
    builder.PrependFloat64Slot(25, activity, 0.0)

def AddActivity(builder, activity):
    Hazard_IngestAddActivity(builder, activity)

def Hazard_IngestAddDep(builder, dep):
    builder.PrependFloat64Slot(26, dep, 0.0)

def AddDep(builder, dep):
    Hazard_IngestAddDep(builder, dep)

def Hazard_IngestAddDepCtrn(builder, depCtrn):
    builder.PrependFloat64Slot(27, depCtrn, 0.0)

def AddDepCtrn(builder, depCtrn):
    Hazard_IngestAddDepCtrn(builder, depCtrn)

def Hazard_IngestAddMassFrac(builder, massFrac):
    builder.PrependFloat64Slot(28, massFrac, 0.0)

def AddMassFrac(builder, massFrac):
    Hazard_IngestAddMassFrac(builder, massFrac)

def Hazard_IngestAddDose(builder, dose):
    builder.PrependFloat64Slot(29, dose, 0.0)

def AddDose(builder, dose):
    Hazard_IngestAddDose(builder, dose)

def Hazard_IngestAddCtrnTime(builder, ctrnTime):
    builder.PrependFloat64Slot(30, ctrnTime, 0.0)

def AddCtrnTime(builder, ctrnTime):
    Hazard_IngestAddCtrnTime(builder, ctrnTime)

def Hazard_IngestAddDoseRate(builder, doseRate):
    builder.PrependFloat64Slot(31, doseRate, 0.0)

def AddDoseRate(builder, doseRate):
    Hazard_IngestAddDoseRate(builder, doseRate)

def Hazard_IngestAddIdPoi(builder, idPoi):
    builder.PrependUOffsetTRelativeSlot(32, flatbuffers.number_types.UOffsetTFlags.py_type(idPoi), 0)

def AddIdPoi(builder, idPoi):
    Hazard_IngestAddIdPoi(builder, idPoi)

def Hazard_IngestAddIdTrack(builder, idTrack):
...
def AddIdTrack(builder, idTrack):
    Hazard_IngestAddIdTrack(builder, idTrack)

def Hazard_IngestAddCreatedAt(builder, createdAt):
    builder.PrependUOffsetTRelativeSlot(34, flatbuffers.number_types.UOffsetTFlags.py_type(createdAt), 0)

def AddCreatedAt(builder, createdAt):
    Hazard_IngestAddCreatedAt(builder, createdAt)

def Hazard_IngestAddCreatedBy(builder, createdBy):
    builder.PrependUOffsetTRelativeSlot(35, flatbuffers.number_types.UOffsetTFlags.py_type(createdBy), 0)

def AddCreatedBy(builder, createdBy):
    Hazard_IngestAddCreatedBy(builder, createdBy)

def Hazard_IngestAddSource(builder, source):
    builder.PrependUOffsetTRelativeSlot(36, flatbuffers.number_types.UOffsetTFlags.py_type(source), 0)

def AddSource(builder, source):
    Hazard_IngestAddSource(builder, source)

def Hazard_IngestAddOrigin(builder, origin):
    builder.PrependUOffsetTRelativeSlot(37, flatbuffers.number_types.UOffsetTFlags.py_type(origin), 0)

def AddOrigin(builder, origin):
    Hazard_IngestAddOrigin(builder, origin)

def Hazard_IngestAddOrigNetwork(builder, origNetwork):
    builder.PrependUOffsetTRelativeSlot(38, flatbuffers.number_types.UOffsetTFlags.py_type(origNetwork), 0)

def AddOrigNetwork(builder, origNetwork):
    Hazard_IngestAddOrigNetwork(builder, origNetwork)

def Hazard_IngestAddDataMode(builder, dataMode):
    builder.PrependInt8Slot(39, dataMode, 0)

def AddDataMode(builder, dataMode):
    Hazard_IngestAddDataMode(builder, dataMode)

def Hazard_IngestEnd(builder):
    return builder.EndObject()

def End(builder):
    return Hazard_IngestEnd(builder)
...
class Hazard_IngestT(object):
    ...
    def InitFromBuf(cls, buf, pos):
        hazardIngest = Hazard_Ingest()
        hazardIngest.Init(buf, pos)
        return cls.InitFromObj(hazardIngest)
    ...
    @classmethod
    def InitFromObj(cls, hazardIngest):
        x = Hazard_IngestT()
        x._UnPack(hazardIngest)
        return x

    # Hazard_IngestT
    def _UnPack(self, hazardIngest):
        if hazardIngest is None:
            return
        self.id = hazardIngest.Id()
        self.classificationMarking = hazardIngest.ClassificationMarking()
        self.detectType = hazardIngest.DetectType()
        self.detectTime = hazardIngest.DetectTime()
        self.harmful = hazardIngest.Harmful()
        if not hazardIngest.AlarmsIsNone():
            self.alarms = []
            for i in range(hazardIngest.AlarmsLength()):
                self.alarms.append(hazardIngest.Alarms(i))
        if not hazardIngest.AlarmValuesIsNone():
            self.alarmValues = []
            for i in range(hazardIngest.AlarmValuesLength()):
                self.alarmValues.append(hazardIngest.AlarmValues(i))
        if not hazardIngest.ReadingsIsNone():
            self.readings = []
            for i in range(hazardIngest.ReadingsLength()):
                self.readings.append(hazardIngest.Readings(i))
        if not hazardIngest.ReadingUnitsIsNone():
            self.readingUnits = []
            for i in range(hazardIngest.ReadingUnitsLength()):
                self.readingUnits.append(hazardIngest.ReadingUnits(i))
        if not hazardIngest.ReadingValuesIsNone():
            self.readingValues = []
            for i in range(hazardIngest.ReadingValuesLength()):
                self.readingValues.append(hazardIngest.ReadingValues(i))
        self.matType = hazardIngest.MatType()
        self.matClass = hazardIngest.MatClass()
        self.matName = hazardIngest.MatName()
        self.matCat = hazardIngest.MatCat()
        self.casRn = hazardIngest.CasRn()
        self.ppm = hazardIngest.Ppm()
        self.density = hazardIngest.Density()
        self.radCtrn = hazardIngest.RadCtrn()
        self.gBar = hazardIngest.GBar()
        self.hBar = hazardIngest.HBar()
        self.z = hazardIngest.Z()
        self.a = hazardIngest.A()
        self.bottleId = hazardIngest.BottleId()
        self.channel = hazardIngest.Channel()
        self.duration = hazardIngest.Duration()
        self.activity = hazardIngest.Activity()
        self.dep = hazardIngest.Dep()
        self.depCtrn = hazardIngest.DepCtrn()
        self.massFrac = hazardIngest.MassFrac()
        self.dose = hazardIngest.Dose()
        self.ctrnTime = hazardIngest.CtrnTime()
        self.doseRate = hazardIngest.DoseRate()
        self.idPoi = hazardIngest.IdPoi()
        self.idTrack = hazardIngest.IdTrack()
        self.createdAt = hazardIngest.CreatedAt()
        self.createdBy = hazardIngest.CreatedBy()
        self.source = hazardIngest.Source()
        self.origin = hazardIngest.Origin()
        self.origNetwork = hazardIngest.OrigNetwork()
        self.dataMode = hazardIngest.DataMode()
    ...
    def Pack(self, builder):
        ...
        if self.alarms is not None:
            ...
            Hazard_IngestStartAlarmsVector(builder, len(self.alarms))
        ...
        if self.alarmValues is not None:
            ...
            Hazard_IngestStartAlarmValuesVector(builder, len(self.alarmValues))
        ...
        if self.readings is not None:
            ...
            Hazard_IngestStartReadingsVector(builder, len(self.readings))
        ...
        if self.readingUnits is not None:
            ...
            Hazard_IngestStartReadingUnitsVector(builder, len(self.readingUnits))
        ...
        if self.readingValues is not None:
            ...
            Hazard_IngestStartReadingValuesVector(builder, len(self.readingValues))
        ...
        if self.detectTime is not None:
            Hazard_IngestAddDetectTime(builder, detectTime)
        Hazard_IngestAddHarmful(builder, self.harmful)
        if self.alarms is not None:
            Hazard_IngestAddAlarms(builder, alarms)
        if self.alarmValues is not None:
            Hazard_IngestAddAlarmValues(builder, alarmValues)
        ...
        if self.matName is not None:
            Hazard_IngestAddMatName(builder, matName)
        Hazard_IngestAddMatCat(builder, self.matCat)
        if self.casRn is not None:
            Hazard_IngestAddCasRn(builder, casRn)
        Hazard_IngestAddPpm(builder, self.ppm)
        Hazard_IngestAddDensity(builder, self.density)
        Hazard_IngestAddRadCtrn(builder, self.radCtrn)
        Hazard_IngestAddGBar(builder, self.gBar)
        Hazard_IngestAddHBar(builder, self.hBar)
        Hazard_IngestAddZ(builder, self.z)
        Hazard_IngestAddA(builder, self.a)
        if self.bottleId is not None:
            Hazard_IngestAddBottleId(builder, bottleId)
        if self.channel is not None:
            Hazard_IngestAddChannel(builder, channel)
        Hazard_IngestAddDuration(builder, self.duration)
        Hazard_IngestAddActivity(builder, self.activity)
        Hazard_IngestAddDep(builder, self.dep)
        Hazard_IngestAddDepCtrn(builder, self.depCtrn)
        Hazard_IngestAddMassFrac(builder, self.massFrac)
        Hazard_IngestAddDose(builder, self.dose)
        Hazard_IngestAddCtrnTime(builder, self.ctrnTime)
        Hazard_IngestAddDoseRate(builder, self.doseRate)
        if self.idPoi is not None:
            Hazard_IngestAddIdPoi(builder, idPoi)
        if self.idTrack is not None:
            Hazard_IngestAddIdTrack(builder, idTrack)
        ...
        if self.origNetwork is not None:
            Hazard_IngestAddOrigNetwork(builder, origNetwork)
        Hazard_IngestAddDataMode(builder, self.dataMode)
        hazardIngest = Hazard_IngestEnd(builder)
        return hazardIngest
