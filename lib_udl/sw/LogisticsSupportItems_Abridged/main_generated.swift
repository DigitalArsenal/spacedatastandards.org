...
public struct LogisticsSupportItems_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LogisticsSupportItems_Abridged.id, addPrefix: prefix) }
  ...
  public static func startLogisticsSupportItems_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 19) }
  ...
  public static func endLogisticsSupportItems_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLogisticsSupportItems_Abridged(
    ...
    let __start = LogisticsSupportItems_Abridged.startLogisticsSupportItems_Abridged(&fbb)
    LogisticsSupportItems_Abridged.add(recoveryRequestTypeCode: recoveryRequestTypeCode, &fbb)
    LogisticsSupportItems_Abridged.add(requestNumber: requestNumber, &fbb)
    LogisticsSupportItems_Abridged.add(quantity: quantity, &fbb)
    LogisticsSupportItems_Abridged.add(description: description, &fbb)
    LogisticsSupportItems_Abridged.add(shipmentUnitId: shipmentUnitId, &fbb)
    LogisticsSupportItems_Abridged.add(redeployShipmentUnitId: redeployShipmentUnitId, &fbb)
    LogisticsSupportItems_Abridged.add(jobControlNumber: jobControlNumber, &fbb)
    LogisticsSupportItems_Abridged.add(sourceIcao: sourceIcao, &fbb)
    LogisticsSupportItems_Abridged.add(deployPlanNumber: deployPlanNumber, &fbb)
    LogisticsSupportItems_Abridged.add(redeployPlanNumber: redeployPlanNumber, &fbb)
    LogisticsSupportItems_Abridged.add(cannibalized: cannibalized, &fbb)
    LogisticsSupportItems_Abridged.add(siPoc: siPoc, &fbb)
    LogisticsSupportItems_Abridged.add(readyTime: readyTime, &fbb)
    LogisticsSupportItems_Abridged.add(receivedTime: receivedTime, &fbb)
    LogisticsSupportItems_Abridged.add(resupportFlag: resupportFlag, &fbb)
    LogisticsSupportItems_Abridged.add(itemLastChangedDate: itemLastChangedDate, &fbb)
    LogisticsSupportItems_Abridged.addVectorOf(logisticsParts: logisticsParts, &fbb)
    LogisticsSupportItems_Abridged.addVectorOf(logisticsSpecialties: logisticsSpecialties, &fbb)
    LogisticsSupportItems_Abridged.addVectorOf(logisticsRemarks: logisticsRemarks, &fbb)
    return LogisticsSupportItems_Abridged.endLogisticsSupportItems_Abridged(&fbb, start: __start)
  }
