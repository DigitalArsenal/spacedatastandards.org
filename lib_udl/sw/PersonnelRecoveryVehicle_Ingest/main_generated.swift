...
public struct PersonnelRecoveryVehicle_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: PersonnelRecoveryVehicle_Ingest.id, addPrefix: prefix) }
  ...
  public static func startPersonnelRecoveryVehicle_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endPersonnelRecoveryVehicle_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPersonnelRecoveryVehicle_Ingest(
    ...
    let __start = PersonnelRecoveryVehicle_Ingest.startPersonnelRecoveryVehicle_Ingest(&fbb)
    PersonnelRecoveryVehicle_Ingest.add(callSign: callSign, &fbb)
    PersonnelRecoveryVehicle_Ingest.add(type: type, &fbb)
    PersonnelRecoveryVehicle_Ingest.add(primaryFreq: primaryFreq, &fbb)
    PersonnelRecoveryVehicle_Ingest.add(strength: strength, &fbb)
    return PersonnelRecoveryVehicle_Ingest.endPersonnelRecoveryVehicle_Ingest(&fbb, start: __start)
  }
