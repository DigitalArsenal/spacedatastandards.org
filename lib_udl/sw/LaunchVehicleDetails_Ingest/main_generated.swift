...
public enum LaunchVehicleDetails_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: LaunchVehicleDetails_Ingest_dataMode_Enum { return .exercise }
  public static var min: LaunchVehicleDetails_Ingest_dataMode_Enum { return .real }
}
...
public struct LaunchVehicleDetails_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LaunchVehicleDetails_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: LaunchVehicleDetails_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : LaunchVehicleDetails_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startLaunchVehicleDetails_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 55) }
  ...
  public static func add(dataMode: LaunchVehicleDetails_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func addVectorOf(tags: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: tags, at: VTOFFSET.tags.p) }
  public static func endLaunchVehicleDetails_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLaunchVehicleDetails_Ingest(
    ...
    let __start = LaunchVehicleDetails_Ingest.startLaunchVehicleDetails_Ingest(&fbb)
    LaunchVehicleDetails_Ingest.add(id: id, &fbb)
    LaunchVehicleDetails_Ingest.add(idLaunchVehicle: idLaunchVehicle, &fbb)
    LaunchVehicleDetails_Ingest.add(classificationMarking: classificationMarking, &fbb)
    LaunchVehicleDetails_Ingest.add(variant: variant, &fbb)
    LaunchVehicleDetails_Ingest.add(minorVariant: minorVariant, &fbb)
    LaunchVehicleDetails_Ingest.add(category: category, &fbb)
    LaunchVehicleDetails_Ingest.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    LaunchVehicleDetails_Ingest.add(launchPrefix: launchPrefix, &fbb)
    LaunchVehicleDetails_Ingest.add(family: family, &fbb)
    LaunchVehicleDetails_Ingest.add(propellant: propellant, &fbb)
    LaunchVehicleDetails_Ingest.add(oxidizer: oxidizer, &fbb)
    LaunchVehicleDetails_Ingest.add(length: length, &fbb)
    LaunchVehicleDetails_Ingest.add(diameter: diameter, &fbb)
    LaunchVehicleDetails_Ingest.add(launchMass: launchMass, &fbb)
    LaunchVehicleDetails_Ingest.add(geoPayloadMass: geoPayloadMass, &fbb)
    LaunchVehicleDetails_Ingest.add(gtoPayloadMass: gtoPayloadMass, &fbb)
    LaunchVehicleDetails_Ingest.add(leoPayloadMass: leoPayloadMass, &fbb)
    LaunchVehicleDetails_Ingest.add(ssoPayloadMass: ssoPayloadMass, &fbb)
    LaunchVehicleDetails_Ingest.add(fairingLength: fairingLength, &fbb)
    LaunchVehicleDetails_Ingest.add(fairingName: fairingName, &fbb)
    LaunchVehicleDetails_Ingest.add(fairingExternalDiameter: fairingExternalDiameter, &fbb)
    LaunchVehicleDetails_Ingest.add(fairingInternalDiameter: fairingInternalDiameter, &fbb)
    LaunchVehicleDetails_Ingest.add(fairingMass: fairingMass, &fbb)
    LaunchVehicleDetails_Ingest.add(fairingMaterial: fairingMaterial, &fbb)
    LaunchVehicleDetails_Ingest.add(maxAccelLoad: maxAccelLoad, &fbb)
    LaunchVehicleDetails_Ingest.add(maxPayloadFreqLat: maxPayloadFreqLat, &fbb)
    LaunchVehicleDetails_Ingest.add(maxPayloadFreqLon: maxPayloadFreqLon, &fbb)
    LaunchVehicleDetails_Ingest.add(maxAcousticLevel: maxAcousticLevel, &fbb)
    LaunchVehicleDetails_Ingest.add(maxAcousticLevelRange: maxAcousticLevelRange, &fbb)
    LaunchVehicleDetails_Ingest.add(soundPressureLevel: soundPressureLevel, &fbb)
    LaunchVehicleDetails_Ingest.add(maxFlightShockForce: maxFlightShockForce, &fbb)
    LaunchVehicleDetails_Ingest.add(maxFlightShockFreq: maxFlightShockFreq, &fbb)
    LaunchVehicleDetails_Ingest.add(maxFairingPressureChange: maxFairingPressureChange, &fbb)
    LaunchVehicleDetails_Ingest.add(estLaunchPrice: estLaunchPrice, &fbb)
    LaunchVehicleDetails_Ingest.add(estLaunchPriceTypical: estLaunchPriceTypical, &fbb)
    LaunchVehicleDetails_Ingest.add(gtoInj3SigAccuracyApogeeTarget: gtoInj3SigAccuracyApogeeTarget, &fbb)
    LaunchVehicleDetails_Ingest.add(gtoInj3SigAccuracyApogeeMargin: gtoInj3SigAccuracyApogeeMargin, &fbb)
    LaunchVehicleDetails_Ingest.add(gtoInj3SigAccuracyPerigeeTarget: gtoInj3SigAccuracyPerigeeTarget, &fbb)
    LaunchVehicleDetails_Ingest.add(gtoInj3SigAccuracyPerigeeMargin: gtoInj3SigAccuracyPerigeeMargin, &fbb)
    LaunchVehicleDetails_Ingest.add(gtoInj3SigAccuracyInclinationTarget: gtoInj3SigAccuracyInclinationTarget, &fbb)
    LaunchVehicleDetails_Ingest.add(gtoInj3SigAccuracyInclinationMargin: gtoInj3SigAccuracyInclinationMargin, &fbb)
    LaunchVehicleDetails_Ingest.add(attitudeAccuracy: attitudeAccuracy, &fbb)
    LaunchVehicleDetails_Ingest.add(payloadSeparationRate: payloadSeparationRate, &fbb)
    LaunchVehicleDetails_Ingest.add(deploymentRotationRate: deploymentRotationRate, &fbb)
    LaunchVehicleDetails_Ingest.add(sourceUrl: sourceUrl, &fbb)
    LaunchVehicleDetails_Ingest.add(notes: notes, &fbb)
    LaunchVehicleDetails_Ingest.add(fairingNotes: fairingNotes, &fbb)
    LaunchVehicleDetails_Ingest.add(payloadNotes: payloadNotes, &fbb)
    LaunchVehicleDetails_Ingest.add(createdAt: createdAt, &fbb)
    LaunchVehicleDetails_Ingest.add(createdBy: createdBy, &fbb)
    LaunchVehicleDetails_Ingest.add(source: source, &fbb)
    LaunchVehicleDetails_Ingest.add(origin: origin, &fbb)
    LaunchVehicleDetails_Ingest.add(origNetwork: origNetwork, &fbb)
    LaunchVehicleDetails_Ingest.add(dataMode: dataMode, &fbb)
    LaunchVehicleDetails_Ingest.addVectorOf(tags: tags, &fbb)
    return LaunchVehicleDetails_Ingest.endLaunchVehicleDetails_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: LaunchVehicleDetails_Ingest_dataMode_Enum.self)
