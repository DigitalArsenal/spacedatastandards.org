...
public struct DiplomaticClearanceDetails_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DiplomaticClearanceDetails_Full.id, addPrefix: prefix) }
  ...
  public static func startDiplomaticClearanceDetails_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 24) }
  ...
  public static func endDiplomaticClearanceDetails_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDiplomaticClearanceDetails_Full(
    ...
    let __start = DiplomaticClearanceDetails_Full.startDiplomaticClearanceDetails_Full(&fbb)
    DiplomaticClearanceDetails_Full.add(idSortie: idSortie, &fbb)
    DiplomaticClearanceDetails_Full.add(legNum: legNum, &fbb)
    DiplomaticClearanceDetails_Full.add(routeString: routeString, &fbb)
    DiplomaticClearanceDetails_Full.add(validStartTime: validStartTime, &fbb)
    DiplomaticClearanceDetails_Full.add(validEndTime: validEndTime, &fbb)
    DiplomaticClearanceDetails_Full.add(clearanceId: clearanceId, &fbb)
    DiplomaticClearanceDetails_Full.add(externalClearanceId: externalClearanceId, &fbb)
    DiplomaticClearanceDetails_Full.add(clearedCallSign: clearedCallSign, &fbb)
    DiplomaticClearanceDetails_Full.add(sequenceNum: sequenceNum, &fbb)
    DiplomaticClearanceDetails_Full.add(countryCode: countryCode, &fbb)
    DiplomaticClearanceDetails_Full.add(altCountryCode: altCountryCode, &fbb)
    DiplomaticClearanceDetails_Full.add(countryName: countryName, &fbb)
    DiplomaticClearanceDetails_Full.add(validDesc: validDesc, &fbb)
    DiplomaticClearanceDetails_Full.add(windowRemark: windowRemark, &fbb)
    DiplomaticClearanceDetails_Full.add(entryPoint: entryPoint, &fbb)
    DiplomaticClearanceDetails_Full.add(entryNet: entryNet, &fbb)
    DiplomaticClearanceDetails_Full.add(exitPoint: exitPoint, &fbb)
    DiplomaticClearanceDetails_Full.add(exitNlt: exitNlt, &fbb)
    DiplomaticClearanceDetails_Full.add(reqIcao: reqIcao, &fbb)
    DiplomaticClearanceDetails_Full.add(action: action, &fbb)
    DiplomaticClearanceDetails_Full.add(status: status, &fbb)
    DiplomaticClearanceDetails_Full.add(profile: profile, &fbb)
    DiplomaticClearanceDetails_Full.add(reqPoint: reqPoint, &fbb)
    DiplomaticClearanceDetails_Full.add(clearanceRemark: clearanceRemark, &fbb)
    return DiplomaticClearanceDetails_Full.endDiplomaticClearanceDetails_Full(&fbb, start: __start)
  }
