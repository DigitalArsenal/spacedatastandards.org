...
public enum SeradataSigIntPayload_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SeradataSigIntPayload_Full_dataMode_Enum { return .exercise }
  public static var min: SeradataSigIntPayload_Full_dataMode_Enum { return .real }
}


///  /// Details for an sigint payload from  Seradata.
public struct SeradataSigIntPayload_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SeradataSigIntPayload_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SeradataSigIntPayload_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SeradataSigIntPayload_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSeradataSigIntPayload_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 23) }
  ...
  public static func add(dataMode: SeradataSigIntPayload_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSeradataSigIntPayload_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSeradataSigIntPayload_Full(
    ...
    let __start = SeradataSigIntPayload_Full.startSeradataSigIntPayload_Full(&fbb)
    SeradataSigIntPayload_Full.add(id: id, &fbb)
    SeradataSigIntPayload_Full.add(classificationMarking: classificationMarking, &fbb)
    SeradataSigIntPayload_Full.add(spacecraftId: spacecraftId, &fbb)
    SeradataSigIntPayload_Full.add(idSensor: idSensor, &fbb)
    SeradataSigIntPayload_Full.add(hostedForCompanyOrgId: hostedForCompanyOrgId, &fbb)
    SeradataSigIntPayload_Full.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    SeradataSigIntPayload_Full.add(type: type, &fbb)
    SeradataSigIntPayload_Full.add(swathWidth: swathWidth, &fbb)
    SeradataSigIntPayload_Full.add(groundStations: groundStations, &fbb)
    SeradataSigIntPayload_Full.add(groundStationLocations: groundStationLocations, &fbb)
    SeradataSigIntPayload_Full.add(frequencyCoverage: frequencyCoverage, &fbb)
    SeradataSigIntPayload_Full.add(positionalAccuracy: positionalAccuracy, &fbb)
    SeradataSigIntPayload_Full.add(interceptParameters: interceptParameters, &fbb)
    SeradataSigIntPayload_Full.add(name: name, &fbb)
    SeradataSigIntPayload_Full.add(notes: notes, &fbb)
    SeradataSigIntPayload_Full.add(createdAt: createdAt, &fbb)
    SeradataSigIntPayload_Full.add(createdBy: createdBy, &fbb)
    SeradataSigIntPayload_Full.add(updatedAt: updatedAt, &fbb)
    SeradataSigIntPayload_Full.add(updatedBy: updatedBy, &fbb)
    SeradataSigIntPayload_Full.add(source: source, &fbb)
    SeradataSigIntPayload_Full.add(origin: origin, &fbb)
    SeradataSigIntPayload_Full.add(origNetwork: origNetwork, &fbb)
    SeradataSigIntPayload_Full.add(dataMode: dataMode, &fbb)
    return SeradataSigIntPayload_Full.endSeradataSigIntPayload_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SeradataSigIntPayload_Full_dataMode_Enum.self)
    _v.finish()
  }
}
