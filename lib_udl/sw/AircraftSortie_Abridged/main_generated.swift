...
public enum AircraftSortie_Abridged_paperStatus_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AircraftSortie_Abridged_paperStatus_Enum { return .read }
  public static var min: AircraftSortie_Abridged_paperStatus_Enum { return .published }
}


public enum AircraftSortie_Abridged_pprStatus_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: AircraftSortie_Abridged_pprStatus_Enum { return .pending }
  public static var min: AircraftSortie_Abridged_pprStatus_Enum { return .notRequired }
}


public enum AircraftSortie_Abridged_rvnReq_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: AircraftSortie_Abridged_rvnReq_Enum { return .r6 }
  public static var min: AircraftSortie_Abridged_rvnReq_Enum { return .n }
}


public enum AircraftSortie_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: AircraftSortie_Abridged_dataMode_Enum { return .exercise }
  public static var min: AircraftSortie_Abridged_dataMode_Enum { return .real }
}


///  /// Information related to the planning, load, status, and deployment or dispatch of one aircraft to carry out a mission.
public struct AircraftSortie_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AircraftSortie_Abridged.id, addPrefix: prefix) }
  ...
  public var paperStatus: AircraftSortie_Abridged_paperStatus_Enum { let o = _accessor.offset(VTOFFSET.paperStatus.v); return o == 0 ? .published : AircraftSortie_Abridged_paperStatus_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .published }
  ///  The prior permission required (PPR) status.
  ///  Example: /// Example: PENDING
  ///  Constraints: Minimum length = 0, Maximum length = 22
  public var pprStatus: AircraftSortie_Abridged_pprStatus_Enum { let o = _accessor.offset(VTOFFSET.pprStatus.v); return o == 0 ? .notRequired : AircraftSortie_Abridged_pprStatus_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .notRequired }
  ...
  public var rvnReq: AircraftSortie_Abridged_rvnReq_Enum { let o = _accessor.offset(VTOFFSET.rvnReq.v); return o == 0 ? .n : AircraftSortie_Abridged_rvnReq_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .n }
  ...
  public var dataMode: AircraftSortie_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AircraftSortie_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: OPS1
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startAircraftSortie_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 80) }
  ...
  public static func add(paperStatus: AircraftSortie_Abridged_paperStatus_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: paperStatus.rawValue, def: 0, at: VTOFFSET.paperStatus.p) }
  public static func add(pprStatus: AircraftSortie_Abridged_pprStatus_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: pprStatus.rawValue, def: 0, at: VTOFFSET.pprStatus.p) }
  ...
  public static func add(rvnReq: AircraftSortie_Abridged_rvnReq_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: rvnReq.rawValue, def: 0, at: VTOFFSET.rvnReq.p) }
  ...
  public static func add(dataMode: AircraftSortie_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endAircraftSortie_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAircraftSortie_Abridged(
    ...
    pprStatus: AircraftSortie_Abridged_pprStatus_Enum = .notRequired,
    ...
    let __start = AircraftSortie_Abridged.startAircraftSortie_Abridged(&fbb)
    AircraftSortie_Abridged.add(id: id, &fbb)
    AircraftSortie_Abridged.add(classificationMarking: classificationMarking, &fbb)
    AircraftSortie_Abridged.add(origSortieId: origSortieId, &fbb)
    AircraftSortie_Abridged.add(idAircraft: idAircraft, &fbb)
    AircraftSortie_Abridged.add(aircraftAltId: aircraftAltId, &fbb)
    AircraftSortie_Abridged.add(tailNumber: tailNumber, &fbb)
    AircraftSortie_Abridged.add(aircraftMds: aircraftMds, &fbb)
    AircraftSortie_Abridged.add(aircraftAdsb: aircraftAdsb, &fbb)
    AircraftSortie_Abridged.add(sortieDate: sortieDate, &fbb)
    AircraftSortie_Abridged.add(lineNumber: lineNumber, &fbb)
    AircraftSortie_Abridged.add(idMission: idMission, &fbb)
    AircraftSortie_Abridged.add(missionId: missionId, &fbb)
    AircraftSortie_Abridged.add(amcMsnNum: amcMsnNum, &fbb)
    AircraftSortie_Abridged.add(amcMsnType: amcMsnType, &fbb)
    AircraftSortie_Abridged.add(callSign: callSign, &fbb)
    AircraftSortie_Abridged.add(jcsPriority: jcsPriority, &fbb)
    AircraftSortie_Abridged.add(primaryScl: primaryScl, &fbb)
    AircraftSortie_Abridged.add(secondaryScl: secondaryScl, &fbb)
    AircraftSortie_Abridged.add(reqConfig: reqConfig, &fbb)
    AircraftSortie_Abridged.add(cargoConfig: cargoConfig, &fbb)
    AircraftSortie_Abridged.add(fuelReq: fuelReq, &fbb)
    AircraftSortie_Abridged.add(oxyReqCrew: oxyReqCrew, &fbb)
    AircraftSortie_Abridged.add(oxyOnCrew: oxyOnCrew, &fbb)
    AircraftSortie_Abridged.add(oxyReqPax: oxyReqPax, &fbb)
    AircraftSortie_Abridged.add(oxyOnPax: oxyOnPax, &fbb)
    AircraftSortie_Abridged.add(alertStatusCode: alertStatusCode, &fbb)
    AircraftSortie_Abridged.add(alertStatus: alertStatus, &fbb)
    AircraftSortie_Abridged.add(currentState: currentState, &fbb)
    AircraftSortie_Abridged.add(depItinerary: depItinerary, &fbb)
    AircraftSortie_Abridged.add(depIcao: depIcao, &fbb)
    AircraftSortie_Abridged.add(depIata: depIata, &fbb)
    AircraftSortie_Abridged.add(depFaa: depFaa, &fbb)
    AircraftSortie_Abridged.add(plannedDepTime: plannedDepTime, &fbb)
    AircraftSortie_Abridged.add(estDepTime: estDepTime, &fbb)
    AircraftSortie_Abridged.add(actualDepTime: actualDepTime, &fbb)
    AircraftSortie_Abridged.add(estBlockOutTime: estBlockOutTime, &fbb)
    AircraftSortie_Abridged.add(actualBlockOutTime: actualBlockOutTime, &fbb)
    AircraftSortie_Abridged.add(depPurposeCode: depPurposeCode, &fbb)
    AircraftSortie_Abridged.add(arrItinerary: arrItinerary, &fbb)
    AircraftSortie_Abridged.add(arrIcao: arrIcao, &fbb)
    AircraftSortie_Abridged.add(arrIata: arrIata, &fbb)
    AircraftSortie_Abridged.add(arrFaa: arrFaa, &fbb)
    AircraftSortie_Abridged.add(plannedArrTime: plannedArrTime, &fbb)
    AircraftSortie_Abridged.add(estArrTime: estArrTime, &fbb)
    AircraftSortie_Abridged.add(actualArrTime: actualArrTime, &fbb)
    AircraftSortie_Abridged.add(estBlockInTime: estBlockInTime, &fbb)
    AircraftSortie_Abridged.add(actualBlockInTime: actualBlockInTime, &fbb)
    AircraftSortie_Abridged.add(arrPurposeCode: arrPurposeCode, &fbb)
    AircraftSortie_Abridged.add(dhd: dhd, &fbb)
    AircraftSortie_Abridged.add(dhdReason: dhdReason, &fbb)
    AircraftSortie_Abridged.add(aircraftEvent: aircraftEvent, &fbb)
    AircraftSortie_Abridged.add(soe: soe, &fbb)
    AircraftSortie_Abridged.add(legNum: legNum, &fbb)
    AircraftSortie_Abridged.add(flightTime: flightTime, &fbb)
    AircraftSortie_Abridged.add(gndTime: gndTime, &fbb)
    AircraftSortie_Abridged.add(rawFileUri: rawFileUri, &fbb)
    AircraftSortie_Abridged.add(papersVersion: papersVersion, &fbb)
    AircraftSortie_Abridged.add(filename: filename, &fbb)
    AircraftSortie_Abridged.add(filesize: filesize, &fbb)
    AircraftSortie_Abridged.add(paperStatus: paperStatus, &fbb)
    AircraftSortie_Abridged.add(pprStatus: pprStatus, &fbb)
    AircraftSortie_Abridged.add(missionUpdate: missionUpdate, &fbb)
    AircraftSortie_Abridged.add(delayCode: delayCode, &fbb)
    AircraftSortie_Abridged.add(commanderName: commanderName, &fbb)
    AircraftSortie_Abridged.add(fmDeskNum: fmDeskNum, &fbb)
    AircraftSortie_Abridged.add(fmName: fmName, &fbb)
    AircraftSortie_Abridged.add(rvnReq: rvnReq, &fbb)
    AircraftSortie_Abridged.add(passengers: passengers, &fbb)
    AircraftSortie_Abridged.add(parkingLoc: parkingLoc, &fbb)
    AircraftSortie_Abridged.add(objectiveRemarks: objectiveRemarks, &fbb)
    AircraftSortie_Abridged.add(aircraftRemarks: aircraftRemarks, &fbb)
    AircraftSortie_Abridged.add(scheduleRemarks: scheduleRemarks, &fbb)
    AircraftSortie_Abridged.add(resultRemarks: resultRemarks, &fbb)
    AircraftSortie_Abridged.add(createdAt: createdAt, &fbb)
    AircraftSortie_Abridged.add(createdBy: createdBy, &fbb)
    AircraftSortie_Abridged.add(sourceDl: sourceDl, &fbb)
    AircraftSortie_Abridged.add(source: source, &fbb)
    AircraftSortie_Abridged.add(origin: origin, &fbb)
    AircraftSortie_Abridged.add(dataMode: dataMode, &fbb)
    AircraftSortie_Abridged.add(origNetwork: origNetwork, &fbb)
    return AircraftSortie_Abridged.endAircraftSortie_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.paperStatus.p, fieldName: "paperStatus", required: false, type: AircraftSortie_Abridged_paperStatus_Enum.self)
    try _v.visit(field: VTOFFSET.pprStatus.p, fieldName: "pprStatus", required: false, type: AircraftSortie_Abridged_pprStatus_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.rvnReq.p, fieldName: "rvnReq", required: false, type: AircraftSortie_Abridged_rvnReq_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AircraftSortie_Abridged_dataMode_Enum.self)
