...
public enum SolarArrayDetails_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SolarArrayDetails_Full_dataMode_Enum { return .exercise }
  public static var min: SolarArrayDetails_Full_dataMode_Enum { return .real }
}
...
public struct SolarArrayDetails_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SolarArrayDetails_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SolarArrayDetails_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SolarArrayDetails_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startSolarArrayDetails_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 20) }
  ...
  public static func add(dataMode: SolarArrayDetails_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endSolarArrayDetails_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSolarArrayDetails_Full(
    ...
    let __start = SolarArrayDetails_Full.startSolarArrayDetails_Full(&fbb)
    SolarArrayDetails_Full.add(id: id, &fbb)
    SolarArrayDetails_Full.add(idSolarArray: idSolarArray, &fbb)
    SolarArrayDetails_Full.add(classificationMarking: classificationMarking, &fbb)
    SolarArrayDetails_Full.add(type: type, &fbb)
    SolarArrayDetails_Full.add(technology: technology, &fbb)
    SolarArrayDetails_Full.add(junctionTechnology: junctionTechnology, &fbb)
    SolarArrayDetails_Full.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    SolarArrayDetails_Full.add(span: span, &fbb)
    SolarArrayDetails_Full.add(area: area, &fbb)
    SolarArrayDetails_Full.add(description: description, &fbb)
    SolarArrayDetails_Full.add(createdAt: createdAt, &fbb)
    SolarArrayDetails_Full.add(createdBy: createdBy, &fbb)
    SolarArrayDetails_Full.add(updatedAt: updatedAt, &fbb)
    SolarArrayDetails_Full.add(updatedBy: updatedBy, &fbb)
    SolarArrayDetails_Full.add(source: source, &fbb)
    SolarArrayDetails_Full.add(origin: origin, &fbb)
    SolarArrayDetails_Full.add(origNetwork: origNetwork, &fbb)
    SolarArrayDetails_Full.add(dataMode: dataMode, &fbb)
    SolarArrayDetails_Full.addVectorOf(tags: tags, &fbb)
    SolarArrayDetails_Full.add(manufacturerOrg: manufacturerOrg, &fbb)
    return SolarArrayDetails_Full.endSolarArrayDetails_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SolarArrayDetails_Full_dataMode_Enum.self)
