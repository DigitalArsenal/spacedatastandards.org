...
public enum Hazard_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Hazard_Abridged_dataMode_Enum { return .exercise }
  public static var min: Hazard_Abridged_dataMode_Enum { return .real }
}
...
public struct Hazard_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Hazard_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Hazard_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Hazard_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startHazard_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 40) }
  ...
  public static func add(dataMode: Hazard_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endHazard_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createHazard_Abridged(
    ...
    let __start = Hazard_Abridged.startHazard_Abridged(&fbb)
    Hazard_Abridged.add(id: id, &fbb)
    Hazard_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Hazard_Abridged.add(detectType: detectType, &fbb)
    Hazard_Abridged.add(detectTime: detectTime, &fbb)
    Hazard_Abridged.add(harmful: harmful, &fbb)
    Hazard_Abridged.addVectorOf(alarms: alarms, &fbb)
    Hazard_Abridged.addVectorOf(alarmValues: alarmValues, &fbb)
    Hazard_Abridged.addVectorOf(readings: readings, &fbb)
    Hazard_Abridged.addVectorOf(readingUnits: readingUnits, &fbb)
    Hazard_Abridged.addVectorOf(readingValues: readingValues, &fbb)
    Hazard_Abridged.add(matType: matType, &fbb)
    Hazard_Abridged.add(matClass: matClass, &fbb)
    Hazard_Abridged.add(matName: matName, &fbb)
    Hazard_Abridged.add(matCat: matCat, &fbb)
    Hazard_Abridged.add(casRn: casRn, &fbb)
    Hazard_Abridged.add(ppm: ppm, &fbb)
    Hazard_Abridged.add(density: density, &fbb)
    Hazard_Abridged.add(radCtrn: radCtrn, &fbb)
    Hazard_Abridged.add(gBar: gBar, &fbb)
    Hazard_Abridged.add(hBar: hBar, &fbb)
    Hazard_Abridged.add(z: z, &fbb)
    Hazard_Abridged.add(a: a, &fbb)
    Hazard_Abridged.add(bottleId: bottleId, &fbb)
    Hazard_Abridged.add(channel: channel, &fbb)
    Hazard_Abridged.add(duration: duration, &fbb)
    Hazard_Abridged.add(activity: activity, &fbb)
    Hazard_Abridged.add(dep: dep, &fbb)
    Hazard_Abridged.add(depCtrn: depCtrn, &fbb)
    Hazard_Abridged.add(massFrac: massFrac, &fbb)
    Hazard_Abridged.add(dose: dose, &fbb)
    Hazard_Abridged.add(ctrnTime: ctrnTime, &fbb)
    Hazard_Abridged.add(doseRate: doseRate, &fbb)
    Hazard_Abridged.add(idPoi: idPoi, &fbb)
    Hazard_Abridged.add(idTrack: idTrack, &fbb)
    Hazard_Abridged.add(createdAt: createdAt, &fbb)
    Hazard_Abridged.add(createdBy: createdBy, &fbb)
    Hazard_Abridged.add(source: source, &fbb)
    Hazard_Abridged.add(origin: origin, &fbb)
    Hazard_Abridged.add(origNetwork: origNetwork, &fbb)
    Hazard_Abridged.add(dataMode: dataMode, &fbb)
    return Hazard_Abridged.endHazard_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Hazard_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
