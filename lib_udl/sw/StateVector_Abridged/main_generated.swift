...
public enum StateVector_Abridged_referenceFrame_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: StateVector_Abridged_referenceFrame_Enum { return .gcrf }
  public static var min: StateVector_Abridged_referenceFrame_Enum { return .j2000 }
}


public enum StateVector_Abridged_covReferenceFrame_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: StateVector_Abridged_covReferenceFrame_Enum { return .uvw }
  public static var min: StateVector_Abridged_covReferenceFrame_Enum { return .j2000 }
}


public enum StateVector_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: StateVector_Abridged_dataMode_Enum { return .exercise }
  public static var min: StateVector_Abridged_dataMode_Enum { return .real }
}
...
public struct StateVector_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: StateVector_Abridged.id, addPrefix: prefix) }
  ...
  public var referenceFrame: StateVector_Abridged_referenceFrame_Enum { let o = _accessor.offset(VTOFFSET.referenceFrame.v); return o == 0 ? .j2000 : StateVector_Abridged_referenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ...
  ///  Example: /// Example: J2000
  ///  Constraints: Minimum length = 0, Maximum length = 24
  public var covReferenceFrame: StateVector_Abridged_covReferenceFrame_Enum { let o = _accessor.offset(VTOFFSET.covReferenceFrame.v); return o == 0 ? .j2000 : StateVector_Abridged_covReferenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ...
  public var dataMode: StateVector_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : StateVector_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startStateVector_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 92) }
  ...
  public static func add(referenceFrame: StateVector_Abridged_referenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: referenceFrame.rawValue, def: 0, at: VTOFFSET.referenceFrame.p) }
  public static func addVectorOf(cov: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: cov, at: VTOFFSET.cov.p) }
  public static func add(covReferenceFrame: StateVector_Abridged_covReferenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: covReferenceFrame.rawValue, def: 0, at: VTOFFSET.covReferenceFrame.p) }
  ...
  public static func add(dataMode: StateVector_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endStateVector_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createStateVector_Abridged(
    ...
    let __start = StateVector_Abridged.startStateVector_Abridged(&fbb)
    StateVector_Abridged.add(idStateVector: idStateVector, &fbb)
    StateVector_Abridged.add(classificationMarking: classificationMarking, &fbb)
    StateVector_Abridged.add(epoch: epoch, &fbb)
    StateVector_Abridged.add(pedigree: pedigree, &fbb)
    StateVector_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    StateVector_Abridged.add(satNo: satNo, &fbb)
    StateVector_Abridged.add(origObjectId: origObjectId, &fbb)
    StateVector_Abridged.add(idOrbitDetermination: idOrbitDetermination, &fbb)
    StateVector_Abridged.add(uct: uct, &fbb)
    StateVector_Abridged.add(xpos: xpos, &fbb)
    StateVector_Abridged.add(ypos: ypos, &fbb)
    StateVector_Abridged.add(zpos: zpos, &fbb)
    StateVector_Abridged.add(xvel: xvel, &fbb)
    StateVector_Abridged.add(yvel: yvel, &fbb)
    StateVector_Abridged.add(zvel: zvel, &fbb)
    StateVector_Abridged.add(referenceFrame: referenceFrame, &fbb)
    StateVector_Abridged.addVectorOf(cov: cov, &fbb)
    StateVector_Abridged.add(covReferenceFrame: covReferenceFrame, &fbb)
    StateVector_Abridged.add(covMethod: covMethod, &fbb)
    StateVector_Abridged.addVectorOf(eqCov: eqCov, &fbb)
    StateVector_Abridged.add(xposAlt1: xposAlt1, &fbb)
    StateVector_Abridged.add(yposAlt1: yposAlt1, &fbb)
    StateVector_Abridged.add(zposAlt1: zposAlt1, &fbb)
    StateVector_Abridged.add(xvelAlt1: xvelAlt1, &fbb)
    StateVector_Abridged.add(yvelAlt1: yvelAlt1, &fbb)
    StateVector_Abridged.add(zvelAlt1: zvelAlt1, &fbb)
    StateVector_Abridged.add(alt1ReferenceFrame: alt1ReferenceFrame, &fbb)
    StateVector_Abridged.add(xposAlt2: xposAlt2, &fbb)
    StateVector_Abridged.add(yposAlt2: yposAlt2, &fbb)
    StateVector_Abridged.add(zposAlt2: zposAlt2, &fbb)
    StateVector_Abridged.add(xvelAlt2: xvelAlt2, &fbb)
    StateVector_Abridged.add(yvelAlt2: yvelAlt2, &fbb)
    StateVector_Abridged.add(zvelAlt2: zvelAlt2, &fbb)
    StateVector_Abridged.add(alt2ReferenceFrame: alt2ReferenceFrame, &fbb)
    StateVector_Abridged.add(posUnc: posUnc, &fbb)
    StateVector_Abridged.add(velUnc: velUnc, &fbb)
    StateVector_Abridged.add(mass: mass, &fbb)
    StateVector_Abridged.add(area: area, &fbb)
    StateVector_Abridged.add(solarRadPressCoeff: solarRadPressCoeff, &fbb)
    StateVector_Abridged.add(dragCoeff: dragCoeff, &fbb)
    StateVector_Abridged.add(dragArea: dragArea, &fbb)
    StateVector_Abridged.add(revNo: revNo, &fbb)
    StateVector_Abridged.add(geopotentialModel: geopotentialModel, &fbb)
    StateVector_Abridged.add(dragModel: dragModel, &fbb)
    StateVector_Abridged.add(lunarSolar: lunarSolar, &fbb)
    StateVector_Abridged.add(solarRadPress: solarRadPress, &fbb)
    StateVector_Abridged.add(srpArea: srpArea, &fbb)
    StateVector_Abridged.add(solidEarthTides: solidEarthTides, &fbb)
    StateVector_Abridged.add(inTrackThrust: inTrackThrust, &fbb)
    StateVector_Abridged.add(bDot: bDot, &fbb)
    StateVector_Abridged.add(edr: edr, &fbb)
    StateVector_Abridged.add(thrustAccel: thrustAccel, &fbb)
    StateVector_Abridged.add(cmOffset: cmOffset, &fbb)
    StateVector_Abridged.add(lastObStart: lastObStart, &fbb)
    StateVector_Abridged.add(lastObEnd: lastObEnd, &fbb)
    StateVector_Abridged.add(obsAvailable: obsAvailable, &fbb)
    StateVector_Abridged.add(obsUsed: obsUsed, &fbb)
    StateVector_Abridged.add(tracksAvail: tracksAvail, &fbb)
    StateVector_Abridged.add(tracksUsed: tracksUsed, &fbb)
    StateVector_Abridged.add(recOdspan: recOdspan, &fbb)
    StateVector_Abridged.add(actualOdspan: actualOdspan, &fbb)
    StateVector_Abridged.add(residualsAcc: residualsAcc, &fbb)
    StateVector_Abridged.add(solarFluxF10: solarFluxF10, &fbb)
    StateVector_Abridged.add(solarFluxF10Avg: solarFluxF10Avg, &fbb)
    StateVector_Abridged.add(solarFluxApavg: solarFluxApavg, &fbb)
    StateVector_Abridged.add(taiUtc: taiUtc, &fbb)
    StateVector_Abridged.add(ut1Utc: ut1Utc, &fbb)
    StateVector_Abridged.add(ut1Rate: ut1Rate, &fbb)
    StateVector_Abridged.add(polarMotionX: polarMotionX, &fbb)
    StateVector_Abridged.add(polarMotionY: polarMotionY, &fbb)
    StateVector_Abridged.add(iau1980Terms: iau1980Terms, &fbb)
    StateVector_Abridged.add(leapSecondTime: leapSecondTime, &fbb)
    StateVector_Abridged.add(integratorMode: integratorMode, &fbb)
    StateVector_Abridged.add(partials: partials, &fbb)
    StateVector_Abridged.add(stepMode: stepMode, &fbb)
    StateVector_Abridged.add(fixedStep: fixedStep, &fbb)
    StateVector_Abridged.add(stepSizeSelection: stepSizeSelection, &fbb)
    StateVector_Abridged.add(stepSize: stepSize, &fbb)
    StateVector_Abridged.add(errorControl: errorControl, &fbb)
    StateVector_Abridged.addVectorOf(sigmaPosUvw: sigmaPosUvw, &fbb)
    StateVector_Abridged.addVectorOf(sigmaVelUvw: sigmaVelUvw, &fbb)
    StateVector_Abridged.add(rms: rms, &fbb)
    StateVector_Abridged.add(source: source, &fbb)
    StateVector_Abridged.add(origin: origin, &fbb)
    StateVector_Abridged.add(dataMode: dataMode, &fbb)
    StateVector_Abridged.add(algorithm: algorithm, &fbb)
    StateVector_Abridged.add(createdAt: createdAt, &fbb)
    StateVector_Abridged.add(createdBy: createdBy, &fbb)
    StateVector_Abridged.add(descriptor: descriptor, &fbb)
    StateVector_Abridged.add(transactionId: transactionId, &fbb)
    StateVector_Abridged.add(origNetwork: origNetwork, &fbb)
    StateVector_Abridged.add(sourceDl: sourceDl, &fbb)
    return StateVector_Abridged.endStateVector_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.referenceFrame.p, fieldName: "referenceFrame", required: false, type: StateVector_Abridged_referenceFrame_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.covReferenceFrame.p, fieldName: "covReferenceFrame", required: false, type: StateVector_Abridged_covReferenceFrame_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: StateVector_Abridged_dataMode_Enum.self)
