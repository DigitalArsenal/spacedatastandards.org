...
public struct MtiTargetReport_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiTargetReport_Ingest.id, addPrefix: prefix) }
  ...
  public static func startMtiTargetReport_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 18) }
  ...
  public static func endMtiTargetReport_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiTargetReport_Ingest(
    ...
    let __start = MtiTargetReport_Ingest.startMtiTargetReport_Ingest(&fbb)
    MtiTargetReport_Ingest.add(d321: d321, &fbb)
    MtiTargetReport_Ingest.add(d322: d322, &fbb)
    MtiTargetReport_Ingest.add(d323: d323, &fbb)
    MtiTargetReport_Ingest.add(d324: d324, &fbb)
    MtiTargetReport_Ingest.add(d325: d325, &fbb)
    MtiTargetReport_Ingest.add(d326: d326, &fbb)
    MtiTargetReport_Ingest.add(d327: d327, &fbb)
    MtiTargetReport_Ingest.add(d328: d328, &fbb)
    MtiTargetReport_Ingest.add(d329: d329, &fbb)
    MtiTargetReport_Ingest.add(d3210: d3210, &fbb)
    MtiTargetReport_Ingest.add(d3211: d3211, &fbb)
    MtiTargetReport_Ingest.add(d3212: d3212, &fbb)
    MtiTargetReport_Ingest.add(d3213: d3213, &fbb)
    MtiTargetReport_Ingest.add(d3214: d3214, &fbb)
    MtiTargetReport_Ingest.add(d3215: d3215, &fbb)
    MtiTargetReport_Ingest.add(d3216: d3216, &fbb)
    MtiTargetReport_Ingest.add(d3217: d3217, &fbb)
    MtiTargetReport_Ingest.add(d3218: d3218, &fbb)
    return MtiTargetReport_Ingest.endMtiTargetReport_Ingest(&fbb, start: __start)
  }
