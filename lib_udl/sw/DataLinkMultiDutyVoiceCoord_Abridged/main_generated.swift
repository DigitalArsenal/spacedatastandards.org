...
public struct DataLinkMultiDutyVoiceCoord_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DataLinkMultiDutyVoiceCoord_Abridged.id, addPrefix: prefix) }
  ...
  public static func startDataLinkMultiDutyVoiceCoord_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endDataLinkMultiDutyVoiceCoord_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDataLinkMultiDutyVoiceCoord_Abridged(
    ...
    let __start = DataLinkMultiDutyVoiceCoord_Abridged.startDataLinkMultiDutyVoiceCoord_Abridged(&fbb)
    DataLinkMultiDutyVoiceCoord_Abridged.add(multiVoiceNetDes: multiVoiceNetDes, &fbb)
    DataLinkMultiDutyVoiceCoord_Abridged.add(multiFreqDes: multiFreqDes, &fbb)
    DataLinkMultiDutyVoiceCoord_Abridged.add(multiCommPri: multiCommPri, &fbb)
    DataLinkMultiDutyVoiceCoord_Abridged.addVectorOf(multiTeleFreqNums: multiTeleFreqNums, &fbb)
    return DataLinkMultiDutyVoiceCoord_Abridged.endDataLinkMultiDutyVoiceCoord_Abridged(&fbb, start: __start)
  }
