...
public struct AltitudeBlocks_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AltitudeBlocks_Abridged.id, addPrefix: prefix) }
  ...
  public static func startAltitudeBlocks_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endAltitudeBlocks_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAltitudeBlocks_Abridged(
    _ fbb: inout FlatBufferBuilder,
    altitudeSequenceIdOffset altitudeSequenceId: Offset = Offset(),
    lowerAltitude: Double = 0.0,
    upperAltitude: Double = 0.0
  ) -> Offset {
    let __start = AltitudeBlocks_Abridged.startAltitudeBlocks_Abridged(&fbb)
    AltitudeBlocks_Abridged.add(altitudeSequenceId: altitudeSequenceId, &fbb)
    AltitudeBlocks_Abridged.add(lowerAltitude: lowerAltitude, &fbb)
    AltitudeBlocks_Abridged.add(upperAltitude: upperAltitude, &fbb)
    return AltitudeBlocks_Abridged.endAltitudeBlocks_Abridged(&fbb, start: __start)
  }
