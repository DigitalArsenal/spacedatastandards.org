...
public enum SeradataSpacecraftDetails_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SeradataSpacecraftDetails_Abridged_dataMode_Enum { return .exercise }
  public static var min: SeradataSpacecraftDetails_Abridged_dataMode_Enum { return .real }
}


///  /// On-orbit spacecraft details compiled by Seradata for a particular satellite.
public struct SeradataSpacecraftDetails_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SeradataSpacecraftDetails_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SeradataSpacecraftDetails_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SeradataSpacecraftDetails_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startSeradataSpacecraftDetails_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 95) }
  ...
  public static func add(dataMode: SeradataSpacecraftDetails_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func endSeradataSpacecraftDetails_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSeradataSpacecraftDetails_Abridged(
    ...
    let __start = SeradataSpacecraftDetails_Abridged.startSeradataSpacecraftDetails_Abridged(&fbb)
    SeradataSpacecraftDetails_Abridged.add(id: id, &fbb)
    SeradataSpacecraftDetails_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    SeradataSpacecraftDetails_Abridged.add(classificationMarking: classificationMarking, &fbb)
    SeradataSpacecraftDetails_Abridged.add(name: name, &fbb)
    SeradataSpacecraftDetails_Abridged.add(description: description, &fbb)
    SeradataSpacecraftDetails_Abridged.add(intlNumber: intlNumber, &fbb)
    SeradataSpacecraftDetails_Abridged.add(sector: sector, &fbb)
    SeradataSpacecraftDetails_Abridged.add(apogee: apogee, &fbb)
    SeradataSpacecraftDetails_Abridged.add(perigee: perigee, &fbb)
    SeradataSpacecraftDetails_Abridged.add(period: period, &fbb)
    SeradataSpacecraftDetails_Abridged.add(inclination: inclination, &fbb)
    SeradataSpacecraftDetails_Abridged.add(primeManufacturerOrgId: primeManufacturerOrgId, &fbb)
    SeradataSpacecraftDetails_Abridged.add(stabilizer: stabilizer, &fbb)
    SeradataSpacecraftDetails_Abridged.add(designLife: designLife, &fbb)
    SeradataSpacecraftDetails_Abridged.add(expectedLife: expectedLife, &fbb)
    SeradataSpacecraftDetails_Abridged.add(insuredAtLaunch: insuredAtLaunch, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchMass: launchMass, &fbb)
    SeradataSpacecraftDetails_Abridged.add(dryMass: dryMass, &fbb)
    SeradataSpacecraftDetails_Abridged.add(catalogNumber: catalogNumber, &fbb)
    SeradataSpacecraftDetails_Abridged.add(totalPayloadPower: totalPayloadPower, &fbb)
    SeradataSpacecraftDetails_Abridged.add(constellation: constellation, &fbb)
    SeradataSpacecraftDetails_Abridged.add(orbitCategory: orbitCategory, &fbb)
    SeradataSpacecraftDetails_Abridged.add(orbitSubCategory: orbitSubCategory, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchCost: launchCost, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchCostEstimated: launchCostEstimated, &fbb)
    SeradataSpacecraftDetails_Abridged.add(costEstimated: costEstimated, &fbb)
    SeradataSpacecraftDetails_Abridged.add(newCost: newCost, &fbb)
    SeradataSpacecraftDetails_Abridged.add(combinedNewCost: combinedNewCost, &fbb)
    SeradataSpacecraftDetails_Abridged.add(combinedCostEstimated: combinedCostEstimated, &fbb)
    SeradataSpacecraftDetails_Abridged.add(insuredValueAtLaunch: insuredValueAtLaunch, &fbb)
    SeradataSpacecraftDetails_Abridged.add(insuredValueLaunchEstimated: insuredValueLaunchEstimated, &fbb)
    SeradataSpacecraftDetails_Abridged.add(annualInsuredDepreciationFactor: annualInsuredDepreciationFactor, &fbb)
    SeradataSpacecraftDetails_Abridged.add(annualInsuredDepreciationFactorEstimated: annualInsuredDepreciationFactorEstimated, &fbb)
    SeradataSpacecraftDetails_Abridged.add(insurancePremiumAtLaunch: insurancePremiumAtLaunch, &fbb)
    SeradataSpacecraftDetails_Abridged.add(insurancePremiumAtLaunchEstimated: insurancePremiumAtLaunchEstimated, &fbb)
    SeradataSpacecraftDetails_Abridged.add(numHumans: numHumans, &fbb)
    SeradataSpacecraftDetails_Abridged.add(cubesatDispenserType: cubesatDispenserType, &fbb)
    SeradataSpacecraftDetails_Abridged.add(massCategory: massCategory, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchId: launchId, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchVehicleId: launchVehicleId, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchProviderFlightNumber: launchProviderFlightNumber, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchSiteName: launchSiteName, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchSiteId: launchSiteId, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchCountry: launchCountry, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchProvider: launchProvider, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchProviderCountry: launchProviderCountry, &fbb)
    SeradataSpacecraftDetails_Abridged.add(commercialLaunch: commercialLaunch, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchType: launchType, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchCharacteristic: launchCharacteristic, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchNumber: launchNumber, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchDate: launchDate, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchDateRemarks: launchDateRemarks, &fbb)
    SeradataSpacecraftDetails_Abridged.add(youtubeLaunchLink: youtubeLaunchLink, &fbb)
    SeradataSpacecraftDetails_Abridged.add(status: status, &fbb)
    SeradataSpacecraftDetails_Abridged.add(owner: owner, &fbb)
    SeradataSpacecraftDetails_Abridged.add(ownerCountry: ownerCountry, &fbb)
    SeradataSpacecraftDetails_Abridged.add(operator_: operator_, &fbb)
    SeradataSpacecraftDetails_Abridged.add(operatorCountry: operatorCountry, &fbb)
    SeradataSpacecraftDetails_Abridged.add(leased: leased, &fbb)
    SeradataSpacecraftDetails_Abridged.add(orderDate: orderDate, &fbb)
    SeradataSpacecraftDetails_Abridged.add(capabilityLost: capabilityLost, &fbb)
    SeradataSpacecraftDetails_Abridged.add(capacityLost: capacityLost, &fbb)
    SeradataSpacecraftDetails_Abridged.add(primaryMissionGroup: primaryMissionGroup, &fbb)
    SeradataSpacecraftDetails_Abridged.add(additionalMissionsGroups: additionalMissionsGroups, &fbb)
    SeradataSpacecraftDetails_Abridged.add(totalClaims: totalClaims, &fbb)
    SeradataSpacecraftDetails_Abridged.add(totalInjuries: totalInjuries, &fbb)
    SeradataSpacecraftDetails_Abridged.add(totalFatalities: totalFatalities, &fbb)
    SeradataSpacecraftDetails_Abridged.add(nameAtLaunch: nameAtLaunch, &fbb)
    SeradataSpacecraftDetails_Abridged.add(busId: busId, &fbb)
    SeradataSpacecraftDetails_Abridged.add(currentAge: currentAge, &fbb)
    SeradataSpacecraftDetails_Abridged.add(lifeLost: lifeLost, &fbb)
    SeradataSpacecraftDetails_Abridged.add(geoPosition: geoPosition, &fbb)
    SeradataSpacecraftDetails_Abridged.add(insuranceLossesTotal: insuranceLossesTotal, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchArranger: launchArranger, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchArrangerCountry: launchArrangerCountry, &fbb)
    SeradataSpacecraftDetails_Abridged.add(serialNumber: serialNumber, &fbb)
    SeradataSpacecraftDetails_Abridged.add(programName: programName, &fbb)
    SeradataSpacecraftDetails_Abridged.add(reusedHullName: reusedHullName, &fbb)
    SeradataSpacecraftDetails_Abridged.add(dateOfObservation: dateOfObservation, &fbb)
    SeradataSpacecraftDetails_Abridged.add(lat: lat, &fbb)
    SeradataSpacecraftDetails_Abridged.add(lon: lon, &fbb)
    SeradataSpacecraftDetails_Abridged.add(altitude: altitude, &fbb)
    SeradataSpacecraftDetails_Abridged.add(collisionRiskMm: collisionRiskMm, &fbb)
    SeradataSpacecraftDetails_Abridged.add(collisionRiskCm: collisionRiskCm, &fbb)
    SeradataSpacecraftDetails_Abridged.add(quantity: quantity, &fbb)
    SeradataSpacecraftDetails_Abridged.add(reusableFlights: reusableFlights, &fbb)
    SeradataSpacecraftDetails_Abridged.add(notes: notes, &fbb)
    SeradataSpacecraftDetails_Abridged.add(insuranceNotes: insuranceNotes, &fbb)
    SeradataSpacecraftDetails_Abridged.add(launchNotes: launchNotes, &fbb)
    SeradataSpacecraftDetails_Abridged.add(source: source, &fbb)
    SeradataSpacecraftDetails_Abridged.add(origin: origin, &fbb)
    SeradataSpacecraftDetails_Abridged.add(origNetwork: origNetwork, &fbb)
    SeradataSpacecraftDetails_Abridged.add(dataMode: dataMode, &fbb)
    SeradataSpacecraftDetails_Abridged.add(createdAt: createdAt, &fbb)
    SeradataSpacecraftDetails_Abridged.add(createdBy: createdBy, &fbb)
    return SeradataSpacecraftDetails_Abridged.endSeradataSpacecraftDetails_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SeradataSpacecraftDetails_Abridged_dataMode_Enum.self)
