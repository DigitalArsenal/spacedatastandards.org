...
public enum AircraftSortie_Full_paperStatus_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AircraftSortie_Full_paperStatus_Enum { return .read }
  public static var min: AircraftSortie_Full_paperStatus_Enum { return .published }
}


public enum AircraftSortie_Full_pprStatus_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: AircraftSortie_Full_pprStatus_Enum { return .pending }
  public static var min: AircraftSortie_Full_pprStatus_Enum { return .notRequired }
}


public enum AircraftSortie_Full_rvnReq_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: AircraftSortie_Full_rvnReq_Enum { return .r6 }
  public static var min: AircraftSortie_Full_rvnReq_Enum { return .n }
}


public enum AircraftSortie_Full_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: AircraftSortie_Full_dataMode_Enum { return .exercise }
  public static var min: AircraftSortie_Full_dataMode_Enum { return .real }
}


///  /// Information related to the planning, load, status, and deployment or dispatch of one aircraft to carry out a mission.
public struct AircraftSortie_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AircraftSortie_Full.id, addPrefix: prefix) }
  ...
  public var paperStatus: AircraftSortie_Full_paperStatus_Enum { let o = _accessor.offset(VTOFFSET.paperStatus.v); return o == 0 ? .published : AircraftSortie_Full_paperStatus_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .published }
  ///  The prior permission required (PPR) status.
  ///  Example: /// Example: PENDING
  ///  Constraints: Minimum length = 0, Maximum length = 22
  public var pprStatus: AircraftSortie_Full_pprStatus_Enum { let o = _accessor.offset(VTOFFSET.pprStatus.v); return o == 0 ? .notRequired : AircraftSortie_Full_pprStatus_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .notRequired }
  ...
  public var rvnReq: AircraftSortie_Full_rvnReq_Enum { let o = _accessor.offset(VTOFFSET.rvnReq.v); return o == 0 ? .n : AircraftSortie_Full_rvnReq_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .n }
  ...
  public var dataMode: AircraftSortie_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AircraftSortie_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Constraints: No constraints specified.
  public var crew: String? { let o = _accessor.offset(VTOFFSET.crew.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var crewSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.crew.v) }
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  public var hasSortiePpr: Bool { let o = _accessor.offset(VTOFFSET.sortiePpr.v); return o == 0 ? false : true }
  public var sortiePprCount: Int32 { let o = _accessor.offset(VTOFFSET.sortiePpr.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func sortiePpr(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.sortiePpr.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  public static func startAircraftSortie_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 84) }
  ...
  public static func add(paperStatus: AircraftSortie_Full_paperStatus_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: paperStatus.rawValue, def: 0, at: VTOFFSET.paperStatus.p) }
  public static func add(pprStatus: AircraftSortie_Full_pprStatus_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: pprStatus.rawValue, def: 0, at: VTOFFSET.pprStatus.p) }
  ...
  public static func add(rvnReq: AircraftSortie_Full_rvnReq_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: rvnReq.rawValue, def: 0, at: VTOFFSET.rvnReq.p) }
  ...
  public static func add(dataMode: AircraftSortie_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func add(crew: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: crew, at: VTOFFSET.crew.p) }
  public static func addVectorOf(sortiePpr: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: sortiePpr, at: VTOFFSET.sortiePpr.p) }
  public static func endAircraftSortie_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAircraftSortie_Full(
    ...
    pprStatus: AircraftSortie_Full_pprStatus_Enum = .notRequired,
    ...
    crewOffset crew: Offset = Offset(),
    sortiePprVectorOffset sortiePpr: Offset = Offset()
  ) -> Offset {
    let __start = AircraftSortie_Full.startAircraftSortie_Full(&fbb)
    AircraftSortie_Full.add(id: id, &fbb)
    AircraftSortie_Full.add(classificationMarking: classificationMarking, &fbb)
    AircraftSortie_Full.add(origSortieId: origSortieId, &fbb)
    AircraftSortie_Full.add(idAircraft: idAircraft, &fbb)
    AircraftSortie_Full.add(aircraftAltId: aircraftAltId, &fbb)
    AircraftSortie_Full.add(tailNumber: tailNumber, &fbb)
    AircraftSortie_Full.add(aircraftMds: aircraftMds, &fbb)
    AircraftSortie_Full.add(aircraftAdsb: aircraftAdsb, &fbb)
    AircraftSortie_Full.add(sortieDate: sortieDate, &fbb)
    AircraftSortie_Full.add(lineNumber: lineNumber, &fbb)
    AircraftSortie_Full.add(idMission: idMission, &fbb)
    AircraftSortie_Full.add(missionId: missionId, &fbb)
    AircraftSortie_Full.add(amcMsnNum: amcMsnNum, &fbb)
    AircraftSortie_Full.add(amcMsnType: amcMsnType, &fbb)
    AircraftSortie_Full.add(callSign: callSign, &fbb)
    AircraftSortie_Full.add(jcsPriority: jcsPriority, &fbb)
    AircraftSortie_Full.add(primaryScl: primaryScl, &fbb)
    AircraftSortie_Full.add(secondaryScl: secondaryScl, &fbb)
    AircraftSortie_Full.add(reqConfig: reqConfig, &fbb)
    AircraftSortie_Full.add(cargoConfig: cargoConfig, &fbb)
    AircraftSortie_Full.add(fuelReq: fuelReq, &fbb)
    AircraftSortie_Full.add(oxyReqCrew: oxyReqCrew, &fbb)
    AircraftSortie_Full.add(oxyOnCrew: oxyOnCrew, &fbb)
    AircraftSortie_Full.add(oxyReqPax: oxyReqPax, &fbb)
    AircraftSortie_Full.add(oxyOnPax: oxyOnPax, &fbb)
    AircraftSortie_Full.add(alertStatusCode: alertStatusCode, &fbb)
    AircraftSortie_Full.add(alertStatus: alertStatus, &fbb)
    AircraftSortie_Full.add(currentState: currentState, &fbb)
    AircraftSortie_Full.add(depItinerary: depItinerary, &fbb)
    AircraftSortie_Full.add(depIcao: depIcao, &fbb)
    AircraftSortie_Full.add(depIata: depIata, &fbb)
    AircraftSortie_Full.add(depFaa: depFaa, &fbb)
    AircraftSortie_Full.add(plannedDepTime: plannedDepTime, &fbb)
    AircraftSortie_Full.add(estDepTime: estDepTime, &fbb)
    AircraftSortie_Full.add(actualDepTime: actualDepTime, &fbb)
    AircraftSortie_Full.add(estBlockOutTime: estBlockOutTime, &fbb)
    AircraftSortie_Full.add(actualBlockOutTime: actualBlockOutTime, &fbb)
    AircraftSortie_Full.add(depPurposeCode: depPurposeCode, &fbb)
    AircraftSortie_Full.add(arrItinerary: arrItinerary, &fbb)
    AircraftSortie_Full.add(arrIcao: arrIcao, &fbb)
    AircraftSortie_Full.add(arrIata: arrIata, &fbb)
    AircraftSortie_Full.add(arrFaa: arrFaa, &fbb)
    AircraftSortie_Full.add(plannedArrTime: plannedArrTime, &fbb)
    AircraftSortie_Full.add(estArrTime: estArrTime, &fbb)
    AircraftSortie_Full.add(actualArrTime: actualArrTime, &fbb)
    AircraftSortie_Full.add(estBlockInTime: estBlockInTime, &fbb)
    AircraftSortie_Full.add(actualBlockInTime: actualBlockInTime, &fbb)
    AircraftSortie_Full.add(arrPurposeCode: arrPurposeCode, &fbb)
    AircraftSortie_Full.add(dhd: dhd, &fbb)
    AircraftSortie_Full.add(dhdReason: dhdReason, &fbb)
    AircraftSortie_Full.add(aircraftEvent: aircraftEvent, &fbb)
    AircraftSortie_Full.add(soe: soe, &fbb)
    AircraftSortie_Full.add(legNum: legNum, &fbb)
    AircraftSortie_Full.add(flightTime: flightTime, &fbb)
    AircraftSortie_Full.add(gndTime: gndTime, &fbb)
    AircraftSortie_Full.add(rawFileUri: rawFileUri, &fbb)
    AircraftSortie_Full.add(papersVersion: papersVersion, &fbb)
    AircraftSortie_Full.add(filename: filename, &fbb)
    AircraftSortie_Full.add(filesize: filesize, &fbb)
    AircraftSortie_Full.add(paperStatus: paperStatus, &fbb)
    AircraftSortie_Full.add(pprStatus: pprStatus, &fbb)
    AircraftSortie_Full.add(missionUpdate: missionUpdate, &fbb)
    AircraftSortie_Full.add(delayCode: delayCode, &fbb)
    AircraftSortie_Full.add(commanderName: commanderName, &fbb)
    AircraftSortie_Full.add(fmDeskNum: fmDeskNum, &fbb)
    AircraftSortie_Full.add(fmName: fmName, &fbb)
    AircraftSortie_Full.add(rvnReq: rvnReq, &fbb)
    AircraftSortie_Full.add(passengers: passengers, &fbb)
    AircraftSortie_Full.add(parkingLoc: parkingLoc, &fbb)
    AircraftSortie_Full.add(objectiveRemarks: objectiveRemarks, &fbb)
    AircraftSortie_Full.add(aircraftRemarks: aircraftRemarks, &fbb)
    AircraftSortie_Full.add(scheduleRemarks: scheduleRemarks, &fbb)
    AircraftSortie_Full.add(resultRemarks: resultRemarks, &fbb)
    AircraftSortie_Full.add(createdAt: createdAt, &fbb)
    AircraftSortie_Full.add(createdBy: createdBy, &fbb)
    AircraftSortie_Full.add(updatedAt: updatedAt, &fbb)
    AircraftSortie_Full.add(updatedBy: updatedBy, &fbb)
    AircraftSortie_Full.add(sourceDl: sourceDl, &fbb)
    AircraftSortie_Full.add(source: source, &fbb)
    AircraftSortie_Full.add(origin: origin, &fbb)
    AircraftSortie_Full.add(dataMode: dataMode, &fbb)
    AircraftSortie_Full.add(origNetwork: origNetwork, &fbb)
    AircraftSortie_Full.add(crew: crew, &fbb)
    AircraftSortie_Full.addVectorOf(sortiePpr: sortiePpr, &fbb)
    return AircraftSortie_Full.endAircraftSortie_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.paperStatus.p, fieldName: "paperStatus", required: false, type: AircraftSortie_Full_paperStatus_Enum.self)
    try _v.visit(field: VTOFFSET.pprStatus.p, fieldName: "pprStatus", required: false, type: AircraftSortie_Full_pprStatus_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.rvnReq.p, fieldName: "rvnReq", required: false, type: AircraftSortie_Full_rvnReq_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AircraftSortie_Full_dataMode_Enum.self)
    try _v.visit(field: VTOFFSET.origNetwork.p, fieldName: "origNetwork", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.crew.p, fieldName: "crew", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.sortiePpr.p, fieldName: "sortiePpr", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
    _v.finish()
  }
}
