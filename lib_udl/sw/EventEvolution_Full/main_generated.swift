...
public enum EventEvolution_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: EventEvolution_Full_dataMode_Enum { return .exercise }
  public static var min: EventEvolution_Full_dataMode_Enum { return .real }
}
...
public struct EventEvolution_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EventEvolution_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: EventEvolution_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : EventEvolution_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startEventEvolution_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 30) }
  ...
  public static func add(dataMode: EventEvolution_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endEventEvolution_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEventEvolution_Full(
    ...
    let __start = EventEvolution_Full.startEventEvolution_Full(&fbb)
    EventEvolution_Full.add(id: id, &fbb)
    EventEvolution_Full.add(classificationMarking: classificationMarking, &fbb)
    EventEvolution_Full.add(eventId: eventId, &fbb)
    EventEvolution_Full.add(category: category, &fbb)
    EventEvolution_Full.add(summary: summary, &fbb)
    EventEvolution_Full.add(startTime: startTime, &fbb)
    EventEvolution_Full.add(endTime: endTime, &fbb)
    EventEvolution_Full.add(status: status, &fbb)
    EventEvolution_Full.add(countryCode: countryCode, &fbb)
    EventEvolution_Full.add(geoAdminLevel1: geoAdminLevel1, &fbb)
    EventEvolution_Full.add(geoAdminLevel2: geoAdminLevel2, &fbb)
    EventEvolution_Full.add(geoAdminLevel3: geoAdminLevel3, &fbb)
    EventEvolution_Full.add(redact: redact, &fbb)
    EventEvolution_Full.addVectorOf(srcTyps: srcTyps, &fbb)
    EventEvolution_Full.addVectorOf(srcIds: srcIds, &fbb)
    EventEvolution_Full.add(dataDescription: dataDescription, &fbb)
    EventEvolution_Full.add(area: area, &fbb)
    EventEvolution_Full.add(atext: atext, &fbb)
    EventEvolution_Full.add(agjson: agjson, &fbb)
    EventEvolution_Full.add(atype: atype, &fbb)
    EventEvolution_Full.add(andims: andims, &fbb)
    EventEvolution_Full.add(asrid: asrid, &fbb)
    EventEvolution_Full.addVectorOf(url: url, &fbb)
    EventEvolution_Full.addVectorOf(tags: tags, &fbb)
    EventEvolution_Full.add(createdAt: createdAt, &fbb)
    EventEvolution_Full.add(createdBy: createdBy, &fbb)
    EventEvolution_Full.add(source: source, &fbb)
    EventEvolution_Full.add(origin: origin, &fbb)
    EventEvolution_Full.add(origNetwork: origNetwork, &fbb)
    EventEvolution_Full.add(dataMode: dataMode, &fbb)
    return EventEvolution_Full.endEventEvolution_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: EventEvolution_Full_dataMode_Enum.self)
    _v.finish()
  }
}
