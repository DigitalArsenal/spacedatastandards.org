...
public struct IonoObservationPhase_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationPhase_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationPhase_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationPhase_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationPhase_Ingest(
    ...
    let __start = IonoObservationPhase_Ingest.startIonoObservationPhase_Ingest(&fbb)
    IonoObservationPhase_Ingest.add(notes: notes, &fbb)
    IonoObservationPhase_Ingest.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationPhase_Ingest.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationPhase_Ingest.addVectorOf(data: data, &fbb)
    return IonoObservationPhase_Ingest.endIonoObservationPhase_Ingest(&fbb, start: __start)
  }
