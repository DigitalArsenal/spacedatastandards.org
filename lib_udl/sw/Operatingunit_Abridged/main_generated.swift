...
public enum Operatingunit_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Operatingunit_Abridged_dataMode_Enum { return .exercise }
  public static var min: Operatingunit_Abridged_dataMode_Enum { return .real }
}
...
public struct Operatingunit_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Operatingunit_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: Operatingunit_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Operatingunit_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startOperatingunit_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 60) }
  ...
  public static func add(dataMode: Operatingunit_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endOperatingunit_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOperatingunit_Abridged(
    ...
    let __start = Operatingunit_Abridged.startOperatingunit_Abridged(&fbb)
    Operatingunit_Abridged.add(idOperatingUnit: idOperatingUnit, &fbb)
    Operatingunit_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Operatingunit_Abridged.add(altOperatingUnitId: altOperatingUnitId, &fbb)
    Operatingunit_Abridged.add(name: name, &fbb)
    Operatingunit_Abridged.add(description: description, &fbb)
    Operatingunit_Abridged.add(idLocation: idLocation, &fbb)
    Operatingunit_Abridged.add(idContact: idContact, &fbb)
    Operatingunit_Abridged.add(idOrganization: idOrganization, &fbb)
    Operatingunit_Abridged.add(unitIdentifier: unitIdentifier, &fbb)
    Operatingunit_Abridged.add(countryCode: countryCode, &fbb)
    Operatingunit_Abridged.add(altCountryCode: altCountryCode, &fbb)
    Operatingunit_Abridged.add(wac: wac, &fbb)
    Operatingunit_Abridged.add(operStatus: operStatus, &fbb)
    Operatingunit_Abridged.add(condition: condition, &fbb)
    Operatingunit_Abridged.add(conditionAvail: conditionAvail, &fbb)
    Operatingunit_Abridged.add(eval: eval, &fbb)
    Operatingunit_Abridged.add(fpa: fpa, &fbb)
    Operatingunit_Abridged.add(ident: ident, &fbb)
    Operatingunit_Abridged.add(allegiance: allegiance, &fbb)
    Operatingunit_Abridged.add(altAllegiance: altAllegiance, &fbb)
    Operatingunit_Abridged.add(locName: locName, &fbb)
    Operatingunit_Abridged.add(locReason: locReason, &fbb)
    Operatingunit_Abridged.add(force: force, &fbb)
    Operatingunit_Abridged.add(forceName: forceName, &fbb)
    Operatingunit_Abridged.add(functRole: functRole, &fbb)
    Operatingunit_Abridged.add(msnPrimary: msnPrimary, &fbb)
    Operatingunit_Abridged.add(msnPrimarySpecialty: msnPrimarySpecialty, &fbb)
    Operatingunit_Abridged.add(masterUnit: masterUnit, &fbb)
    Operatingunit_Abridged.add(stylizedUnit: stylizedUnit, &fbb)
    Operatingunit_Abridged.add(divCat: divCat, &fbb)
    Operatingunit_Abridged.add(echelon: echelon, &fbb)
    Operatingunit_Abridged.add(echelonTier: echelonTier, &fbb)
    Operatingunit_Abridged.add(fleetId: fleetId, &fbb)
    Operatingunit_Abridged.add(deployStatus: deployStatus, &fbb)
    Operatingunit_Abridged.add(flagFlown: flagFlown, &fbb)
    Operatingunit_Abridged.add(coordDatum: coordDatum, &fbb)
    Operatingunit_Abridged.add(coord: coord, &fbb)
    Operatingunit_Abridged.add(coordDerivAcc: coordDerivAcc, &fbb)
    Operatingunit_Abridged.add(lat: lat, &fbb)
    Operatingunit_Abridged.add(lon: lon, &fbb)
    Operatingunit_Abridged.add(elevMsl: elevMsl, &fbb)
    Operatingunit_Abridged.add(elevMslConfLvl: elevMslConfLvl, &fbb)
    Operatingunit_Abridged.add(elevMslDerivAcc: elevMslDerivAcc, &fbb)
    Operatingunit_Abridged.add(geoidalMslSep: geoidalMslSep, &fbb)
    Operatingunit_Abridged.add(milGridSys: milGridSys, &fbb)
    Operatingunit_Abridged.add(milGrid: milGrid, &fbb)
    Operatingunit_Abridged.add(utm: utm, &fbb)
    Operatingunit_Abridged.add(airDefArea: airDefArea, &fbb)
    Operatingunit_Abridged.add(polSubdiv: polSubdiv, &fbb)
    Operatingunit_Abridged.add(symCode: symCode, &fbb)
    Operatingunit_Abridged.add(classRating: classRating, &fbb)
    Operatingunit_Abridged.add(recStatus: recStatus, &fbb)
    Operatingunit_Abridged.add(reviewDate: reviewDate, &fbb)
    Operatingunit_Abridged.add(resProd: resProd, &fbb)
    Operatingunit_Abridged.add(referenceDoc: referenceDoc, &fbb)
    Operatingunit_Abridged.add(createdAt: createdAt, &fbb)
    Operatingunit_Abridged.add(createdBy: createdBy, &fbb)
    Operatingunit_Abridged.add(source: source, &fbb)
    Operatingunit_Abridged.add(origin: origin, &fbb)
    Operatingunit_Abridged.add(dataMode: dataMode, &fbb)
    return Operatingunit_Abridged.endOperatingunit_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Operatingunit_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
