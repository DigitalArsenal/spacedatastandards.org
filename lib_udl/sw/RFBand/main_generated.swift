...
public enum RFBand_mode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: RFBand_mode_Enum { return .rx }
  public static var min: RFBand_mode_Enum { return .tx }
}


public enum RFBand_purpose_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: RFBand_purpose_Enum { return .other }
  public static var min: RFBand_purpose_Enum { return .comm }
}


public enum RFBand_polarization_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: RFBand_polarization_Enum { return .l }
  public static var min: RFBand_polarization_Enum { return .h }
}


public enum RFBand_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: RFBand_dataMode_Enum { return .exercise }
  public static var min: RFBand_dataMode_Enum { return .real }
}
...
public struct RFBand: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: RFBand.id, addPrefix: prefix) }
  ...
  public var mode: RFBand_mode_Enum { let o = _accessor.offset(VTOFFSET.mode.v); return o == 0 ? .tx : RFBand_mode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .tx }
  ///  Purpose or use of the RF Band -- COMM = communications, TTC = Telemetry/Tracking/Control, OPS = Operations, OTHER = Other).
  ///  Example: /// Example: TTC
  ///  Constraints: Minimum length = 0, Maximum length = 16
  public var purpose: RFBand_purpose_Enum { let o = _accessor.offset(VTOFFSET.purpose.v); return o == 0 ? .comm : RFBand_purpose_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .comm }
  ...
  ///  Example: /// Example: H
  ///  Constraints: Minimum length = 0, Maximum length = 4
  public var polarization: RFBand_polarization_Enum { let o = _accessor.offset(VTOFFSET.polarization.v); return o == 0 ? .h : RFBand_polarization_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .h }
  ...
  public var dataMode: RFBand_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : RFBand_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startRFBand(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 25) }
  ...
  public static func add(mode: RFBand_mode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: mode.rawValue, def: 0, at: VTOFFSET.mode.p) }
  public static func add(purpose: RFBand_purpose_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: purpose.rawValue, def: 0, at: VTOFFSET.purpose.p) }
  ...
  public static func add(polarization: RFBand_polarization_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: polarization.rawValue, def: 0, at: VTOFFSET.polarization.p) }
  ...
  public static func add(dataMode: RFBand_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endRFBand(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createRFBand(
    ...
    let __start = RFBand.startRFBand(&fbb)
    RFBand.add(id: id, &fbb)
    RFBand.add(idEntity: idEntity, &fbb)
    RFBand.add(classificationMarking: classificationMarking, &fbb)
    RFBand.add(name: name, &fbb)
    RFBand.add(band: band, &fbb)
    RFBand.add(mode: mode, &fbb)
    RFBand.add(purpose: purpose, &fbb)
    RFBand.add(freqMin: freqMin, &fbb)
    RFBand.add(freqMax: freqMax, &fbb)
    RFBand.add(centerFreq: centerFreq, &fbb)
    RFBand.add(peakGain: peakGain, &fbb)
    RFBand.add(edgeGain: edgeGain, &fbb)
    RFBand.add(bandwidth: bandwidth, &fbb)
    RFBand.add(beamwidth: beamwidth, &fbb)
    RFBand.add(polarization: polarization, &fbb)
    RFBand.add(erp: erp, &fbb)
    RFBand.add(eirp: eirp, &fbb)
    RFBand.add(source: source, &fbb)
    RFBand.add(origin: origin, &fbb)
    RFBand.add(dataMode: dataMode, &fbb)
    RFBand.add(createdAt: createdAt, &fbb)
    RFBand.add(createdBy: createdBy, &fbb)
    RFBand.add(updatedAt: updatedAt, &fbb)
    RFBand.add(updatedBy: updatedBy, &fbb)
    RFBand.add(origNetwork: origNetwork, &fbb)
    return RFBand.endRFBand(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.mode.p, fieldName: "mode", required: false, type: RFBand_mode_Enum.self)
    try _v.visit(field: VTOFFSET.purpose.p, fieldName: "purpose", required: false, type: RFBand_purpose_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.polarization.p, fieldName: "polarization", required: false, type: RFBand_polarization_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: RFBand_dataMode_Enum.self)
