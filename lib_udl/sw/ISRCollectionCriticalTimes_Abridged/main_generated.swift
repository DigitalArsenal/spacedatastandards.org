...
public struct ISRCollectionCriticalTimes_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollectionCriticalTimes_Abridged.id, addPrefix: prefix) }
  ...
  public static func startISRCollectionCriticalTimes_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 2) }
  ...
  public static func endISRCollectionCriticalTimes_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollectionCriticalTimes_Abridged(
    _ fbb: inout FlatBufferBuilder,
    earliestImagingTimeOffset earliestImagingTime: Offset = Offset(),
    latestImagingTimeOffset latestImagingTime: Offset = Offset()
  ) -> Offset {
    let __start = ISRCollectionCriticalTimes_Abridged.startISRCollectionCriticalTimes_Abridged(&fbb)
    ISRCollectionCriticalTimes_Abridged.add(earliestImagingTime: earliestImagingTime, &fbb)
    ISRCollectionCriticalTimes_Abridged.add(latestImagingTime: latestImagingTime, &fbb)
    return ISRCollectionCriticalTimes_Abridged.endISRCollectionCriticalTimes_Abridged(&fbb, start: __start)
  }
