...
public enum AirfieldStatus_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AirfieldStatus_Ingest_dataMode_Enum { return .exercise }
  public static var min: AirfieldStatus_Ingest_dataMode_Enum { return .real }
}


///  /// The airfield status contains dynamic data of an airfield's capabilities.
public struct AirfieldStatus_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirfieldStatus_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: AirfieldStatus_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AirfieldStatus_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startAirfieldStatus_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 36) }
  ...
  public static func add(dataMode: AirfieldStatus_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endAirfieldStatus_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirfieldStatus_Ingest(
    ...
    let __start = AirfieldStatus_Ingest.startAirfieldStatus_Ingest(&fbb)
    AirfieldStatus_Ingest.add(id: id, &fbb)
    AirfieldStatus_Ingest.add(classificationMarking: classificationMarking, &fbb)
    AirfieldStatus_Ingest.add(idAirfield: idAirfield, &fbb)
    AirfieldStatus_Ingest.add(altAirfieldId: altAirfieldId, &fbb)
    AirfieldStatus_Ingest.add(passengerServiceMog: passengerServiceMog, &fbb)
    AirfieldStatus_Ingest.add(fleetServiceMog: fleetServiceMog, &fbb)
    AirfieldStatus_Ingest.add(cargoMog: cargoMog, &fbb)
    AirfieldStatus_Ingest.add(fuelMog: fuelMog, &fbb)
    AirfieldStatus_Ingest.addVectorOf(fuelTypes: fuelTypes, &fbb)
    AirfieldStatus_Ingest.addVectorOf(fuelQtys: fuelQtys, &fbb)
    AirfieldStatus_Ingest.add(mxMog: mxMog, &fbb)
    AirfieldStatus_Ingest.add(operatingMog: operatingMog, &fbb)
    AirfieldStatus_Ingest.add(numCog: numCog, &fbb)
    AirfieldStatus_Ingest.add(wideWorkingMog: wideWorkingMog, &fbb)
    AirfieldStatus_Ingest.add(wideParkingMog: wideParkingMog, &fbb)
    AirfieldStatus_Ingest.add(narrowWorkingMog: narrowWorkingMog, &fbb)
    AirfieldStatus_Ingest.add(narrowParkingMog: narrowParkingMog, &fbb)
    AirfieldStatus_Ingest.addVectorOf(mheTypes: mheTypes, &fbb)
    AirfieldStatus_Ingest.addVectorOf(mheQtys: mheQtys, &fbb)
    AirfieldStatus_Ingest.add(medCap: medCap, &fbb)
    AirfieldStatus_Ingest.add(arffCat: arffCat, &fbb)
    AirfieldStatus_Ingest.add(gseTime: gseTime, &fbb)
    AirfieldStatus_Ingest.add(priRwyNum: priRwyNum, &fbb)
    AirfieldStatus_Ingest.add(rwyCondReading: rwyCondReading, &fbb)
    AirfieldStatus_Ingest.add(rwyFrictionFactor: rwyFrictionFactor, &fbb)
    AirfieldStatus_Ingest.addVectorOf(rwyMarkings: rwyMarkings, &fbb)
    AirfieldStatus_Ingest.add(message: message, &fbb)
    AirfieldStatus_Ingest.add(priFreq: priFreq, &fbb)
    AirfieldStatus_Ingest.addVectorOf(slotTypesReq: slotTypesReq, &fbb)
    AirfieldStatus_Ingest.add(createdAt: createdAt, &fbb)
    AirfieldStatus_Ingest.add(createdBy: createdBy, &fbb)
    AirfieldStatus_Ingest.add(sourceDl: sourceDl, &fbb)
    AirfieldStatus_Ingest.add(source: source, &fbb)
    AirfieldStatus_Ingest.add(origin: origin, &fbb)
    AirfieldStatus_Ingest.add(origNetwork: origNetwork, &fbb)
    AirfieldStatus_Ingest.add(dataMode: dataMode, &fbb)
    return AirfieldStatus_Ingest.endAirfieldStatus_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AirfieldStatus_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
