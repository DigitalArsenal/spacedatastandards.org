...
public struct PersonnelRecoveryVehicle_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: PersonnelRecoveryVehicle_Full.id, addPrefix: prefix) }
  ...
  public static func startPersonnelRecoveryVehicle_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endPersonnelRecoveryVehicle_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPersonnelRecoveryVehicle_Full(
    ...
    let __start = PersonnelRecoveryVehicle_Full.startPersonnelRecoveryVehicle_Full(&fbb)
    PersonnelRecoveryVehicle_Full.add(callSign: callSign, &fbb)
    PersonnelRecoveryVehicle_Full.add(type: type, &fbb)
    PersonnelRecoveryVehicle_Full.add(primaryFreq: primaryFreq, &fbb)
    PersonnelRecoveryVehicle_Full.add(strength: strength, &fbb)
    return PersonnelRecoveryVehicle_Full.endPersonnelRecoveryVehicle_Full(&fbb, start: __start)
  }
