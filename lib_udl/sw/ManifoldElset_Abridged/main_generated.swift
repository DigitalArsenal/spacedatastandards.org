...
public enum ManifoldElset_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: ManifoldElset_Abridged_dataMode_Enum { return .exercise }
  public static var min: ManifoldElset_Abridged_dataMode_Enum { return .real }
}
...
public struct ManifoldElset_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ManifoldElset_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: ManifoldElset_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : ManifoldElset_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 0, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startManifoldElset_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 27) }
  ...
  public static func add(dataMode: ManifoldElset_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endManifoldElset_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createManifoldElset_Abridged(
    ...
    let __start = ManifoldElset_Abridged.startManifoldElset_Abridged(&fbb)
    ManifoldElset_Abridged.add(id: id, &fbb)
    ManifoldElset_Abridged.add(idManifold: idManifold, &fbb)
    ManifoldElset_Abridged.add(classificationMarking: classificationMarking, &fbb)
    ManifoldElset_Abridged.add(tmpSatNo: tmpSatNo, &fbb)
    ManifoldElset_Abridged.add(epoch: epoch, &fbb)
    ManifoldElset_Abridged.add(meanMotion: meanMotion, &fbb)
    ManifoldElset_Abridged.add(eccentricity: eccentricity, &fbb)
    ManifoldElset_Abridged.add(inclination: inclination, &fbb)
    ManifoldElset_Abridged.add(raan: raan, &fbb)
    ManifoldElset_Abridged.add(argOfPerigee: argOfPerigee, &fbb)
    ManifoldElset_Abridged.add(meanAnomaly: meanAnomaly, &fbb)
    ManifoldElset_Abridged.add(revNo: revNo, &fbb)
    ManifoldElset_Abridged.add(bStar: bStar, &fbb)
    ManifoldElset_Abridged.add(meanMotionDot: meanMotionDot, &fbb)
    ManifoldElset_Abridged.add(meanMotionDdot: meanMotionDdot, &fbb)
    ManifoldElset_Abridged.add(semiMajorAxis: semiMajorAxis, &fbb)
    ManifoldElset_Abridged.add(period: period, &fbb)
    ManifoldElset_Abridged.add(apogee: apogee, &fbb)
    ManifoldElset_Abridged.add(perigee: perigee, &fbb)
    ManifoldElset_Abridged.add(line1: line1, &fbb)
    ManifoldElset_Abridged.add(line2: line2, &fbb)
    ManifoldElset_Abridged.add(createdAt: createdAt, &fbb)
    ManifoldElset_Abridged.add(createdBy: createdBy, &fbb)
    ManifoldElset_Abridged.add(source: source, &fbb)
    ManifoldElset_Abridged.add(origin: origin, &fbb)
    ManifoldElset_Abridged.add(dataMode: dataMode, &fbb)
    ManifoldElset_Abridged.add(origNetwork: origNetwork, &fbb)
    return ManifoldElset_Abridged.endManifoldElset_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: ManifoldElset_Abridged_dataMode_Enum.self)
