...
public enum ItemTracking_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: ItemTracking_Ingest_dataMode_Enum { return .exercise }
  public static var min: ItemTracking_Ingest_dataMode_Enum { return .real }
}


///  /// No description available.
public struct ItemTracking_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ItemTracking_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: ItemTracking_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : ItemTracking_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startItemTracking_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 22) }
  ...
  public static func add(dataMode: ItemTracking_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endItemTracking_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createItemTracking_Ingest(
    ...
    let __start = ItemTracking_Ingest.startItemTracking_Ingest(&fbb)
    ItemTracking_Ingest.add(id: id, &fbb)
    ItemTracking_Ingest.add(classificationMarking: classificationMarking, &fbb)
    ItemTracking_Ingest.add(scanCode: scanCode, &fbb)
    ItemTracking_Ingest.add(scGenTool: scGenTool, &fbb)
    ItemTracking_Ingest.add(scannerId: scannerId, &fbb)
    ItemTracking_Ingest.add(ts: ts, &fbb)
    ItemTracking_Ingest.add(idItem: idItem, &fbb)
    ItemTracking_Ingest.add(type: type, &fbb)
    ItemTracking_Ingest.add(lat: lat, &fbb)
    ItemTracking_Ingest.add(lon: lon, &fbb)
    ItemTracking_Ingest.add(scanType: scanType, &fbb)
    ItemTracking_Ingest.add(dvCode: dvCode, &fbb)
    ItemTracking_Ingest.add(notes: notes, &fbb)
    ItemTracking_Ingest.addVectorOf(keys: keys, &fbb)
    ItemTracking_Ingest.addVectorOf(values: values, &fbb)
    ItemTracking_Ingest.add(createdAt: createdAt, &fbb)
    ItemTracking_Ingest.add(createdBy: createdBy, &fbb)
    ItemTracking_Ingest.add(sourceDl: sourceDl, &fbb)
    ItemTracking_Ingest.add(source: source, &fbb)
    ItemTracking_Ingest.add(origin: origin, &fbb)
    ItemTracking_Ingest.add(origNetwork: origNetwork, &fbb)
    ItemTracking_Ingest.add(dataMode: dataMode, &fbb)
    return ItemTracking_Ingest.endItemTracking_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: ItemTracking_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
