...
public enum RadarObservation_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: RadarObservation_Abridged_dataMode_Enum { return .exercise }
  public static var min: RadarObservation_Abridged_dataMode_Enum { return .real }
}


public enum RadarObservation_Abridged_senReferenceFrame_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: RadarObservation_Abridged_senReferenceFrame_Enum { return .gcrf }
  public static var min: RadarObservation_Abridged_senReferenceFrame_Enum { return .j2000 }
}
...
public struct RadarObservation_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: RadarObservation_Abridged.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case createdAt = 108
    case createdBy = 110
    case senReferenceFrame = 112
    case descriptor = 114
    case origNetwork = 116
    case sourceDl = 118
    case type = 120
  ...
  public var dataMode: RadarObservation_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : RadarObservation_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public var senReferenceFrame: RadarObservation_Abridged_senReferenceFrame_Enum { let o = _accessor.offset(VTOFFSET.senReferenceFrame.v); return o == 0 ? .j2000 : RadarObservation_Abridged_senReferenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ...
  public static func startRadarObservation_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 59) }
  ...
  public static func add(dataMode: RadarObservation_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func add(senReferenceFrame: RadarObservation_Abridged_senReferenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: senReferenceFrame.rawValue, def: 0, at: VTOFFSET.senReferenceFrame.p) }
  ...
  public static func endRadarObservation_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createRadarObservation_Abridged(
    ...
    let __start = RadarObservation_Abridged.startRadarObservation_Abridged(&fbb)
    RadarObservation_Abridged.add(id: id, &fbb)
    RadarObservation_Abridged.add(classificationMarking: classificationMarking, &fbb)
    RadarObservation_Abridged.add(obTime: obTime, &fbb)
    RadarObservation_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    RadarObservation_Abridged.add(idSensor: idSensor, &fbb)
    RadarObservation_Abridged.add(satNo: satNo, &fbb)
    RadarObservation_Abridged.add(taskId: taskId, &fbb)
    RadarObservation_Abridged.add(transactionId: transactionId, &fbb)
    RadarObservation_Abridged.add(trackId: trackId, &fbb)
    RadarObservation_Abridged.add(obPosition: obPosition, &fbb)
    RadarObservation_Abridged.add(origObjectId: origObjectId, &fbb)
    RadarObservation_Abridged.add(origSensorId: origSensorId, &fbb)
    RadarObservation_Abridged.add(uct: uct, &fbb)
    RadarObservation_Abridged.add(azimuth: azimuth, &fbb)
    RadarObservation_Abridged.add(azimuthUnc: azimuthUnc, &fbb)
    RadarObservation_Abridged.add(azimuthBias: azimuthBias, &fbb)
    RadarObservation_Abridged.add(azimuthRate: azimuthRate, &fbb)
    RadarObservation_Abridged.add(elevation: elevation, &fbb)
    RadarObservation_Abridged.add(elevationUnc: elevationUnc, &fbb)
    RadarObservation_Abridged.add(elevationBias: elevationBias, &fbb)
    RadarObservation_Abridged.add(elevationRate: elevationRate, &fbb)
    RadarObservation_Abridged.add(range: range, &fbb)
    RadarObservation_Abridged.add(rangeAccel: rangeAccel, &fbb)
    RadarObservation_Abridged.add(rangeAccelUnc: rangeAccelUnc, &fbb)
    RadarObservation_Abridged.add(rangeUnc: rangeUnc, &fbb)
    RadarObservation_Abridged.add(rangeBias: rangeBias, &fbb)
    RadarObservation_Abridged.add(rangeRate: rangeRate, &fbb)
    RadarObservation_Abridged.add(rangeRateUnc: rangeRateUnc, &fbb)
    RadarObservation_Abridged.add(doppler: doppler, &fbb)
    RadarObservation_Abridged.add(dopplerUnc: dopplerUnc, &fbb)
    RadarObservation_Abridged.add(ra: ra, &fbb)
    RadarObservation_Abridged.add(declination: declination, &fbb)
    RadarObservation_Abridged.add(x: x, &fbb)
    RadarObservation_Abridged.add(y: y, &fbb)
    RadarObservation_Abridged.add(z: z, &fbb)
    RadarObservation_Abridged.add(xvel: xvel, &fbb)
    RadarObservation_Abridged.add(yvel: yvel, &fbb)
    RadarObservation_Abridged.add(zvel: zvel, &fbb)
    RadarObservation_Abridged.add(senx: senx, &fbb)
    RadarObservation_Abridged.add(seny: seny, &fbb)
    RadarObservation_Abridged.add(senz: senz, &fbb)
    RadarObservation_Abridged.add(rcs: rcs, &fbb)
    RadarObservation_Abridged.add(rcsUnc: rcsUnc, &fbb)
    RadarObservation_Abridged.add(orthogonalRcs: orthogonalRcs, &fbb)
    RadarObservation_Abridged.add(orthogonalRcsUnc: orthogonalRcsUnc, &fbb)
    RadarObservation_Abridged.add(snr: snr, &fbb)
    RadarObservation_Abridged.add(beam: beam, &fbb)
    RadarObservation_Abridged.add(timingBias: timingBias, &fbb)
    RadarObservation_Abridged.add(rawFileUri: rawFileUri, &fbb)
    RadarObservation_Abridged.add(source: source, &fbb)
    RadarObservation_Abridged.add(origin: origin, &fbb)
    RadarObservation_Abridged.add(dataMode: dataMode, &fbb)
    RadarObservation_Abridged.add(createdAt: createdAt, &fbb)
    RadarObservation_Abridged.add(createdBy: createdBy, &fbb)
    RadarObservation_Abridged.add(senReferenceFrame: senReferenceFrame, &fbb)
    RadarObservation_Abridged.add(descriptor: descriptor, &fbb)
    RadarObservation_Abridged.add(origNetwork: origNetwork, &fbb)
    RadarObservation_Abridged.add(sourceDl: sourceDl, &fbb)
    RadarObservation_Abridged.add(type: type, &fbb)
    return RadarObservation_Abridged.endRadarObservation_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: RadarObservation_Abridged_dataMode_Enum.self)
    try _v.visit(field: VTOFFSET.createdAt.p, fieldName: "createdAt", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.createdBy.p, fieldName: "createdBy", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.senReferenceFrame.p, fieldName: "senReferenceFrame", required: false, type: RadarObservation_Abridged_senReferenceFrame_Enum.self)
