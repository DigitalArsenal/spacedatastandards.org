...
public enum FlightPlan_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: FlightPlan_Ingest_dataMode_Enum { return .exercise }
  public static var min: FlightPlan_Ingest_dataMode_Enum { return .real }
}


///  /// Flight Plan contains data specifying the details of an intended flight including schedule and expected route.
public struct FlightPlan_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: FlightPlan_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: FlightPlan_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : FlightPlan_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startFlightPlan_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 96) }
  ...
  public static func add(dataMode: FlightPlan_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endFlightPlan_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createFlightPlan_Ingest(
    ...
    let __start = FlightPlan_Ingest.startFlightPlan_Ingest(&fbb)
    FlightPlan_Ingest.add(id: id, &fbb)
    FlightPlan_Ingest.add(classificationMarking: classificationMarking, &fbb)
    FlightPlan_Ingest.add(amcMissionId: amcMissionId, &fbb)
    FlightPlan_Ingest.add(idSortie: idSortie, &fbb)
    FlightPlan_Ingest.add(idAircraft: idAircraft, &fbb)
    FlightPlan_Ingest.add(legNum: legNum, &fbb)
    FlightPlan_Ingest.add(idDepAirfield: idDepAirfield, &fbb)
    FlightPlan_Ingest.add(depAirfield: depAirfield, &fbb)
    FlightPlan_Ingest.add(idArrAirfield: idArrAirfield, &fbb)
    FlightPlan_Ingest.add(arrAirfield: arrAirfield, &fbb)
    FlightPlan_Ingest.add(externalId: externalId, &fbb)
    FlightPlan_Ingest.add(genTs: genTs, &fbb)
    FlightPlan_Ingest.add(aircraftMds: aircraftMds, &fbb)
    FlightPlan_Ingest.add(tailNumber: tailNumber, &fbb)
    FlightPlan_Ingest.add(callSign: callSign, &fbb)
    FlightPlan_Ingest.add(wxValidStart: wxValidStart, &fbb)
    FlightPlan_Ingest.add(wxValidEnd: wxValidEnd, &fbb)
    FlightPlan_Ingest.add(estDepTime: estDepTime, &fbb)
    FlightPlan_Ingest.add(dragIndex: dragIndex, &fbb)
    FlightPlan_Ingest.add(fuelDegrade: fuelDegrade, &fbb)
    FlightPlan_Ingest.add(opWeight: opWeight, &fbb)
    FlightPlan_Ingest.add(msnIndex: msnIndex, &fbb)
    FlightPlan_Ingest.add(rampFuel: rampFuel, &fbb)
    FlightPlan_Ingest.add(taxiFuel: taxiFuel, &fbb)
    FlightPlan_Ingest.add(takeoffFuel: takeoffFuel, &fbb)
    FlightPlan_Ingest.add(climbFuel: climbFuel, &fbb)
    FlightPlan_Ingest.add(climbTime: climbTime, &fbb)
    FlightPlan_Ingest.add(holdDownFuel: holdDownFuel, &fbb)
    FlightPlan_Ingest.add(tocIceFuel: tocIceFuel, &fbb)
    FlightPlan_Ingest.add(tocFuel: tocFuel, &fbb)
    FlightPlan_Ingest.add(enrouteFuel: enrouteFuel, &fbb)
    FlightPlan_Ingest.add(enrouteTime: enrouteTime, &fbb)
    FlightPlan_Ingest.add(thunderAvoidFuel: thunderAvoidFuel, &fbb)
    FlightPlan_Ingest.add(todIceFuel: todIceFuel, &fbb)
    FlightPlan_Ingest.add(opConditionFuel: opConditionFuel, &fbb)
    FlightPlan_Ingest.add(todFuel: todFuel, &fbb)
    FlightPlan_Ingest.add(earlyDescentFuel: earlyDescentFuel, &fbb)
    FlightPlan_Ingest.add(arrIceFuel: arrIceFuel, &fbb)
    FlightPlan_Ingest.add(holdFuel: holdFuel, &fbb)
    FlightPlan_Ingest.add(holdTime: holdTime, &fbb)
    FlightPlan_Ingest.add(appLandingFuel: appLandingFuel, &fbb)
    FlightPlan_Ingest.add(burnedFuel: burnedFuel, &fbb)
    FlightPlan_Ingest.add(landingFuel: landingFuel, &fbb)
    FlightPlan_Ingest.add(minDivertFuel: minDivertFuel, &fbb)
    FlightPlan_Ingest.add(arrAlternate1Fuel: arrAlternate1Fuel, &fbb)
    FlightPlan_Ingest.add(arrAlternate2Fuel: arrAlternate2Fuel, &fbb)
    FlightPlan_Ingest.add(contingencyFuel: contingencyFuel, &fbb)
    FlightPlan_Ingest.add(reserveFuel: reserveFuel, &fbb)
    FlightPlan_Ingest.add(depressFuel: depressFuel, &fbb)
    FlightPlan_Ingest.add(unusableFuel: unusableFuel, &fbb)
    FlightPlan_Ingest.add(unidentExtraFuel: unidentExtraFuel, &fbb)
    FlightPlan_Ingest.add(identExtraFuel: identExtraFuel, &fbb)
    FlightPlan_Ingest.add(remAlternate1Fuel: remAlternate1Fuel, &fbb)
    FlightPlan_Ingest.add(remAlternate2Fuel: remAlternate2Fuel, &fbb)
    FlightPlan_Ingest.add(enduranceTime: enduranceTime, &fbb)
    FlightPlan_Ingest.add(sid: sid, &fbb)
    FlightPlan_Ingest.add(star: star, &fbb)
    FlightPlan_Ingest.add(gpsRaim: gpsRaim, &fbb)
    FlightPlan_Ingest.add(depRunway: depRunway, &fbb)
    FlightPlan_Ingest.add(arrRunway: arrRunway, &fbb)
    FlightPlan_Ingest.add(routeString: routeString, &fbb)
    FlightPlan_Ingest.addVectorOf(countryCodes: countryCodes, &fbb)
    FlightPlan_Ingest.add(etopsRating: etopsRating, &fbb)
    FlightPlan_Ingest.addVectorOf(etopsAirfields: etopsAirfields, &fbb)
    FlightPlan_Ingest.addVectorOf(etopsAltAirfields: etopsAltAirfields, &fbb)
    FlightPlan_Ingest.add(etopsValWindow: etopsValWindow, &fbb)
    FlightPlan_Ingest.add(plannerRemark: plannerRemark, &fbb)
    FlightPlan_Ingest.add(cargoRemark: cargoRemark, &fbb)
    FlightPlan_Ingest.add(windFac1: windFac1, &fbb)
    FlightPlan_Ingest.add(windFac2: windFac2, &fbb)
    FlightPlan_Ingest.add(windFacAvg: windFacAvg, &fbb)
    FlightPlan_Ingest.add(avgTempDev: avgTempDev, &fbb)
    FlightPlan_Ingest.addVectorOf(atcAddresses: atcAddresses, &fbb)
    FlightPlan_Ingest.add(originator: originator, &fbb)
    FlightPlan_Ingest.add(numAircraft: numAircraft, &fbb)
    FlightPlan_Ingest.add(flightRules: flightRules, &fbb)
    FlightPlan_Ingest.add(flightType: flightType, &fbb)
    FlightPlan_Ingest.add(initialCruiseSpeed: initialCruiseSpeed, &fbb)
    FlightPlan_Ingest.add(initialFlightLevel: initialFlightLevel, &fbb)
    FlightPlan_Ingest.add(arrAlternate1: arrAlternate1, &fbb)
    FlightPlan_Ingest.add(arrAlternate2: arrAlternate2, &fbb)
    FlightPlan_Ingest.add(depAlternate: depAlternate, &fbb)
    FlightPlan_Ingest.add(wakeTurbCat: wakeTurbCat, &fbb)
    FlightPlan_Ingest.add(equipment: equipment, &fbb)
    FlightPlan_Ingest.add(notes: notes, &fbb)
    FlightPlan_Ingest.add(createdAt: createdAt, &fbb)
    FlightPlan_Ingest.add(createdBy: createdBy, &fbb)
    FlightPlan_Ingest.add(sourceDl: sourceDl, &fbb)
    FlightPlan_Ingest.add(source: source, &fbb)
    FlightPlan_Ingest.add(origin: origin, &fbb)
    FlightPlan_Ingest.add(origNetwork: origNetwork, &fbb)
    FlightPlan_Ingest.add(dataMode: dataMode, &fbb)
    FlightPlan_Ingest.addVectorOf(airRefuelEvents: airRefuelEvents, &fbb)
    FlightPlan_Ingest.addVectorOf(flightPlanMessages: flightPlanMessages, &fbb)
    FlightPlan_Ingest.addVectorOf(flightPlanWaypoints: flightPlanWaypoints, &fbb)
    FlightPlan_Ingest.addVectorOf(flightPlanPointGroups: flightPlanPointGroups, &fbb)
    return FlightPlan_Ingest.endFlightPlan_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: FlightPlan_Ingest_dataMode_Enum.self)
