...
public enum DiplomaticClearance_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: DiplomaticClearance_Ingest_dataMode_Enum { return .exercise }
  public static var min: DiplomaticClearance_Ingest_dataMode_Enum { return .real }
}


///  /// A diplomatic clearance is an authorization for an aircraft to traverse or land within a specified country.
public struct DiplomaticClearance_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DiplomaticClearance_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: DiplomaticClearance_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : DiplomaticClearance_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startDiplomaticClearance_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 19) }
  ...
  public static func add(dataMode: DiplomaticClearance_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endDiplomaticClearance_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDiplomaticClearance_Ingest(
    ...
    let __start = DiplomaticClearance_Ingest.startDiplomaticClearance_Ingest(&fbb)
    DiplomaticClearance_Ingest.add(id: id, &fbb)
    DiplomaticClearance_Ingest.add(classificationMarking: classificationMarking, &fbb)
    DiplomaticClearance_Ingest.add(idMission: idMission, &fbb)
    DiplomaticClearance_Ingest.add(externalWorksheetId: externalWorksheetId, &fbb)
    DiplomaticClearance_Ingest.add(dipWorksheetName: dipWorksheetName, &fbb)
    DiplomaticClearance_Ingest.add(firstDepDate: firstDepDate, &fbb)
    DiplomaticClearance_Ingest.add(docDeadline: docDeadline, &fbb)
    DiplomaticClearance_Ingest.add(apacsId: apacsId, &fbb)
    DiplomaticClearance_Ingest.addVectorOf(diplomaticClearanceDetails: diplomaticClearanceDetails, &fbb)
    DiplomaticClearance_Ingest.addVectorOf(diplomaticClearanceRemarks: diplomaticClearanceRemarks, &fbb)
    DiplomaticClearance_Ingest.add(createdAt: createdAt, &fbb)
    DiplomaticClearance_Ingest.add(createdBy: createdBy, &fbb)
    DiplomaticClearance_Ingest.add(updatedAt: updatedAt, &fbb)
    DiplomaticClearance_Ingest.add(updatedBy: updatedBy, &fbb)
    DiplomaticClearance_Ingest.add(sourceDl: sourceDl, &fbb)
    DiplomaticClearance_Ingest.add(source: source, &fbb)
    DiplomaticClearance_Ingest.add(origin: origin, &fbb)
    DiplomaticClearance_Ingest.add(origNetwork: origNetwork, &fbb)
    DiplomaticClearance_Ingest.add(dataMode: dataMode, &fbb)
    return DiplomaticClearance_Ingest.endDiplomaticClearance_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: DiplomaticClearance_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
