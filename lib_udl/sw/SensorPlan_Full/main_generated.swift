...
public enum SensorPlan_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SensorPlan_Full_dataMode_Enum { return .exercise }
  public static var min: SensorPlan_Full_dataMode_Enum { return .real }
}
...
public struct SensorPlan_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SensorPlan_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: SensorPlan_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SensorPlan_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Constraints: No constraints specified.
  public var hasCollectRequests: Bool { let o = _accessor.offset(VTOFFSET.collectRequests.v); return o == 0 ? false : true }
  public var collectRequestsCount: Int32 { let o = _accessor.offset(VTOFFSET.collectRequests.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func collectRequests(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.collectRequests.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  ...
  public static func startSensorPlan_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 24) }
  ...
  public static func add(dataMode: SensorPlan_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func addVectorOf(collectRequests: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: collectRequests, at: VTOFFSET.collectRequests.p) }
  public static func addVectorOf(tags: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: tags, at: VTOFFSET.tags.p) }
  public static func endSensorPlan_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSensorPlan_Full(
    ...
    collectRequestsVectorOffset collectRequests: Offset = Offset(),
    tagsVectorOffset tags: Offset = Offset()
  ) -> Offset {
    let __start = SensorPlan_Full.startSensorPlan_Full(&fbb)
    SensorPlan_Full.add(id: id, &fbb)
    SensorPlan_Full.add(classificationMarking: classificationMarking, &fbb)
    SensorPlan_Full.add(type: type, &fbb)
    SensorPlan_Full.add(recType: recType, &fbb)
    SensorPlan_Full.add(startTime: startTime, &fbb)
    SensorPlan_Full.add(endTime: endTime, &fbb)
    SensorPlan_Full.add(name: name, &fbb)
    SensorPlan_Full.add(idSensor: idSensor, &fbb)
    SensorPlan_Full.add(origSensorId: origSensorId, &fbb)
    SensorPlan_Full.add(purpose: purpose, &fbb)
    SensorPlan_Full.add(senNetwork: senNetwork, &fbb)
    SensorPlan_Full.add(reqTotal: reqTotal, &fbb)
    SensorPlan_Full.add(customer: customer, &fbb)
    SensorPlan_Full.add(status: status, &fbb)
    SensorPlan_Full.add(createdAt: createdAt, &fbb)
    SensorPlan_Full.add(createdBy: createdBy, &fbb)
    SensorPlan_Full.add(updatedAt: updatedAt, &fbb)
    SensorPlan_Full.add(updatedBy: updatedBy, &fbb)
    SensorPlan_Full.add(source: source, &fbb)
    SensorPlan_Full.add(origin: origin, &fbb)
    SensorPlan_Full.add(dataMode: dataMode, &fbb)
    SensorPlan_Full.add(origNetwork: origNetwork, &fbb)
    SensorPlan_Full.addVectorOf(collectRequests: collectRequests, &fbb)
    SensorPlan_Full.addVectorOf(tags: tags, &fbb)
    return SensorPlan_Full.endSensorPlan_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SensorPlan_Full_dataMode_Enum.self)
    try _v.visit(field: VTOFFSET.origNetwork.p, fieldName: "origNetwork", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.collectRequests.p, fieldName: "collectRequests", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
