...
public struct DataLinkMultiDuty_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DataLinkMultiDuty_Full.id, addPrefix: prefix) }
  ...
  public static func startDataLinkMultiDuty_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 6) }
  ...
  public static func endDataLinkMultiDuty_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDataLinkMultiDuty_Full(
    ...
    let __start = DataLinkMultiDuty_Full.startDataLinkMultiDuty_Full(&fbb)
    DataLinkMultiDuty_Full.add(unitDes: unitDes, &fbb)
    DataLinkMultiDuty_Full.add(name: name, &fbb)
    DataLinkMultiDuty_Full.add(rank: rank, &fbb)
    DataLinkMultiDuty_Full.add(duty: duty, &fbb)
    DataLinkMultiDuty_Full.addVectorOf(dutyTeleFreqNums: dutyTeleFreqNums, &fbb)
    DataLinkMultiDuty_Full.addVectorOf(multiDutyVoiceCoord: multiDutyVoiceCoord, &fbb)
    return DataLinkMultiDuty_Full.endDataLinkMultiDuty_Full(&fbb, start: __start)
  }
