...
public enum Onorbit_Ingest_objectType_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Onorbit_Ingest_objectType_Enum { return .unknown }
  public static var min: Onorbit_Ingest_objectType_Enum { return .rocketBody }
}


public enum Onorbit_Ingest_category_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: Onorbit_Ingest_category_Enum { return .docked }
  public static var min: Onorbit_Ingest_category_Enum { return .unknown }
}


public enum Onorbit_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: Onorbit_Ingest_dataMode_Enum { return .exercise }
  public static var min: Onorbit_Ingest_dataMode_Enum { return .real }
}


///  /// Model object representing on-orbit objects or satellites in the system.
public struct Onorbit_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Onorbit_Ingest.id, addPrefix: prefix) }
  ...
  public var objectType: Onorbit_Ingest_objectType_Enum { let o = _accessor.offset(VTOFFSET.objectType.v); return o == 0 ? .rocketBody : Onorbit_Ingest_objectType_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .rocketBody }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 45
  public var category: Onorbit_Ingest_category_Enum { let o = _accessor.offset(VTOFFSET.category.v); return o == 0 ? .unknown : Onorbit_Ingest_category_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .unknown }
  ...
  public var dataMode: Onorbit_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Onorbit_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOnorbit_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 21) }
  ...
  public static func add(objectType: Onorbit_Ingest_objectType_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: objectType.rawValue, def: 0, at: VTOFFSET.objectType.p) }
  ...
  public static func add(category: Onorbit_Ingest_category_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: category.rawValue, def: 0, at: VTOFFSET.category.p) }
  ...
  public static func add(dataMode: Onorbit_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endOnorbit_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnorbit_Ingest(
    ...
    objectType: Onorbit_Ingest_objectType_Enum = .rocketBody,
    ...
    let __start = Onorbit_Ingest.startOnorbit_Ingest(&fbb)
    Onorbit_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    Onorbit_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Onorbit_Ingest.add(satNo: satNo, &fbb)
    Onorbit_Ingest.add(commonName: commonName, &fbb)
    Onorbit_Ingest.add(constellation: constellation, &fbb)
    Onorbit_Ingest.add(intlDes: intlDes, &fbb)
    Onorbit_Ingest.add(launchDate: launchDate, &fbb)
    Onorbit_Ingest.add(decayDate: decayDate, &fbb)
    Onorbit_Ingest.add(objectType: objectType, &fbb)
    Onorbit_Ingest.add(origin: origin, &fbb)
    Onorbit_Ingest.add(missionNumber: missionNumber, &fbb)
    Onorbit_Ingest.add(category: category, &fbb)
    Onorbit_Ingest.add(lifetimeYears: lifetimeYears, &fbb)
    Onorbit_Ingest.add(altName: altName, &fbb)
    Onorbit_Ingest.add(createdAt: createdAt, &fbb)
    Onorbit_Ingest.add(createdBy: createdBy, &fbb)
    Onorbit_Ingest.add(source: source, &fbb)
    Onorbit_Ingest.add(dataMode: dataMode, &fbb)
    Onorbit_Ingest.add(launchSiteId: launchSiteId, &fbb)
    Onorbit_Ingest.add(countryCode: countryCode, &fbb)
    Onorbit_Ingest.add(origNetwork: origNetwork, &fbb)
    return Onorbit_Ingest.endOnorbit_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.objectType.p, fieldName: "objectType", required: false, type: Onorbit_Ingest_objectType_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.category.p, fieldName: "category", required: false, type: Onorbit_Ingest_category_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Onorbit_Ingest_dataMode_Enum.self)
