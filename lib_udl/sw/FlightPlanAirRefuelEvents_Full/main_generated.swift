...
public struct FlightPlanAirRefuelEvents_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: FlightPlanAirRefuelEvents_Full.id, addPrefix: prefix) }
  ...
  public static func startFlightPlanAirRefuelEvents_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endFlightPlanAirRefuelEvents_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createFlightPlanAirRefuelEvents_Full(
    ...
    let __start = FlightPlanAirRefuelEvents_Full.startFlightPlanAirRefuelEvents_Full(&fbb)
    FlightPlanAirRefuelEvents_Full.add(arDegrade: arDegrade, &fbb)
    FlightPlanAirRefuelEvents_Full.add(arNum: arNum, &fbb)
    FlightPlanAirRefuelEvents_Full.add(arExchangedFuel: arExchangedFuel, &fbb)
    FlightPlanAirRefuelEvents_Full.add(divertFuel: divertFuel, &fbb)
    FlightPlanAirRefuelEvents_Full.add(exitFuel: exitFuel, &fbb)
    return FlightPlanAirRefuelEvents_Full.endFlightPlanAirRefuelEvents_Full(&fbb, start: __start)
  }
