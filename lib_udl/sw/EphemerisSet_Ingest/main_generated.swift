...
public enum EphemerisSet_Ingest_referenceFrame_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: EphemerisSet_Ingest_referenceFrame_Enum { return .gcrf }
  public static var min: EphemerisSet_Ingest_referenceFrame_Enum { return .j2000 }
}


public enum EphemerisSet_Ingest_covReferenceFrame_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: EphemerisSet_Ingest_covReferenceFrame_Enum { return .uvw }
  public static var min: EphemerisSet_Ingest_covReferenceFrame_Enum { return .j2000 }
}


public enum EphemerisSet_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: EphemerisSet_Ingest_dataMode_Enum { return .exercise }
  public static var min: EphemerisSet_Ingest_dataMode_Enum { return .real }
}
...
public struct EphemerisSet_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EphemerisSet_Ingest.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case dataMode = 80
    case satNo = 82
    case ephemerisList = 84
    case tags = 86
    case transactionId = 88
    case origNetwork = 90
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 24
  public var referenceFrame: EphemerisSet_Ingest_referenceFrame_Enum { let o = _accessor.offset(VTOFFSET.referenceFrame.v); return o == 0 ? .j2000 : EphemerisSet_Ingest_referenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ///  The reference frame of the covariance matrix elements. If the covReferenceFrame is null it is assumed to be J2000.
  ///  Example: /// Example: J2000
  ///  Constraints: Minimum length = 0, Maximum length = 24
  public var covReferenceFrame: EphemerisSet_Ingest_covReferenceFrame_Enum { let o = _accessor.offset(VTOFFSET.covReferenceFrame.v); return o == 0 ? .j2000 : EphemerisSet_Ingest_covReferenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ...
  public var dataMode: EphemerisSet_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : EphemerisSet_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Constraints: No constraints specified.
  public var hasEphemerisList: Bool { let o = _accessor.offset(VTOFFSET.ephemerisList.v); return o == 0 ? false : true }
  public var ephemerisListCount: Int32 { let o = _accessor.offset(VTOFFSET.ephemerisList.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func ephemerisList(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.ephemerisList.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  ...
  public static func startEphemerisSet_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 44) }
  ...
  public static func add(referenceFrame: EphemerisSet_Ingest_referenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: referenceFrame.rawValue, def: 0, at: VTOFFSET.referenceFrame.p) }
  public static func add(covReferenceFrame: EphemerisSet_Ingest_covReferenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: covReferenceFrame.rawValue, def: 0, at: VTOFFSET.covReferenceFrame.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func add(source: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: source, at: VTOFFSET.source.p) }
  public static func add(origin: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origin, at: VTOFFSET.origin.p) }
  public static func add(dataMode: EphemerisSet_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(satNo: Int32, _ fbb: inout FlatBufferBuilder) { fbb.add(element: satNo, def: 0, at: VTOFFSET.satNo.p) }
  public static func addVectorOf(ephemerisList: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: ephemerisList, at: VTOFFSET.ephemerisList.p) }
  ...
  public static func endEphemerisSet_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEphemerisSet_Ingest(
    ...
    satNo: Int32 = 0,
    ephemerisListVectorOffset ephemerisList: Offset = Offset(),
    tagsVectorOffset tags: Offset = Offset(),
    transactionIdOffset transactionId: Offset = Offset(),
    origNetworkOffset origNetwork: Offset = Offset()
  ) -> Offset {
    let __start = EphemerisSet_Ingest.startEphemerisSet_Ingest(&fbb)
    EphemerisSet_Ingest.add(id: id, &fbb)
    EphemerisSet_Ingest.add(classificationMarking: classificationMarking, &fbb)
    EphemerisSet_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    EphemerisSet_Ingest.add(origObjectId: origObjectId, &fbb)
    EphemerisSet_Ingest.add(pointStartTime: pointStartTime, &fbb)
    EphemerisSet_Ingest.add(usableStartTime: usableStartTime, &fbb)
    EphemerisSet_Ingest.add(pointEndTime: pointEndTime, &fbb)
    EphemerisSet_Ingest.add(usableEndTime: usableEndTime, &fbb)
    EphemerisSet_Ingest.add(stepSize: stepSize, &fbb)
    EphemerisSet_Ingest.add(numPoints: numPoints, &fbb)
    EphemerisSet_Ingest.add(type: type, &fbb)
    EphemerisSet_Ingest.add(pedigree: pedigree, &fbb)
    EphemerisSet_Ingest.add(category: category, &fbb)
    EphemerisSet_Ingest.add(idStateVector: idStateVector, &fbb)
    EphemerisSet_Ingest.add(hasMnvr: hasMnvr, &fbb)
    EphemerisSet_Ingest.addVectorOf(idManeuvers: idManeuvers, &fbb)
    EphemerisSet_Ingest.add(hasCov: hasCov, &fbb)
    EphemerisSet_Ingest.add(hasAccel: hasAccel, &fbb)
    EphemerisSet_Ingest.add(centBody: centBody, &fbb)
    EphemerisSet_Ingest.add(integrator: integrator, &fbb)
    EphemerisSet_Ingest.add(geopotentialModel: geopotentialModel, &fbb)
    EphemerisSet_Ingest.add(dragModel: dragModel, &fbb)
    EphemerisSet_Ingest.add(lunarSolar: lunarSolar, &fbb)
    EphemerisSet_Ingest.add(solidEarthTides: solidEarthTides, &fbb)
    EphemerisSet_Ingest.add(bDot: bDot, &fbb)
    EphemerisSet_Ingest.add(edr: edr, &fbb)
    EphemerisSet_Ingest.add(interpolation: interpolation, &fbb)
    EphemerisSet_Ingest.add(interpolationDegree: interpolationDegree, &fbb)
    EphemerisSet_Ingest.add(filename: filename, &fbb)
    EphemerisSet_Ingest.add(comments: comments, &fbb)
    EphemerisSet_Ingest.add(description: description, &fbb)
    EphemerisSet_Ingest.add(descriptor: descriptor, &fbb)
    EphemerisSet_Ingest.add(referenceFrame: referenceFrame, &fbb)
    EphemerisSet_Ingest.add(covReferenceFrame: covReferenceFrame, &fbb)
    EphemerisSet_Ingest.add(createdAt: createdAt, &fbb)
    EphemerisSet_Ingest.add(createdBy: createdBy, &fbb)
    EphemerisSet_Ingest.add(source: source, &fbb)
    EphemerisSet_Ingest.add(origin: origin, &fbb)
    EphemerisSet_Ingest.add(dataMode: dataMode, &fbb)
    EphemerisSet_Ingest.add(satNo: satNo, &fbb)
    EphemerisSet_Ingest.addVectorOf(ephemerisList: ephemerisList, &fbb)
    EphemerisSet_Ingest.addVectorOf(tags: tags, &fbb)
    EphemerisSet_Ingest.add(transactionId: transactionId, &fbb)
    EphemerisSet_Ingest.add(origNetwork: origNetwork, &fbb)
    return EphemerisSet_Ingest.endEphemerisSet_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.referenceFrame.p, fieldName: "referenceFrame", required: false, type: EphemerisSet_Ingest_referenceFrame_Enum.self)
    try _v.visit(field: VTOFFSET.covReferenceFrame.p, fieldName: "covReferenceFrame", required: false, type: EphemerisSet_Ingest_covReferenceFrame_Enum.self)
    try _v.visit(field: VTOFFSET.createdAt.p, fieldName: "createdAt", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.createdBy.p, fieldName: "createdBy", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.source.p, fieldName: "source", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.origin.p, fieldName: "origin", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: EphemerisSet_Ingest_dataMode_Enum.self)
    try _v.visit(field: VTOFFSET.satNo.p, fieldName: "satNo", required: false, type: Int32.self)
    try _v.visit(field: VTOFFSET.ephemerisList.p, fieldName: "ephemerisList", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
