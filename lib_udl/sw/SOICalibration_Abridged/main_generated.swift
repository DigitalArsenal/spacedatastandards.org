...
public struct SOICalibration_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SOICalibration_Abridged.id, addPrefix: prefix) }
  ...
  public static func startSOICalibration_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 11) }
  ...
  public static func endSOICalibration_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSOICalibration_Abridged(
    ...
    let __start = SOICalibration_Abridged.startSOICalibration_Abridged(&fbb)
    SOICalibration_Abridged.add(calExtinctionCoeff: calExtinctionCoeff, &fbb)
    SOICalibration_Abridged.add(calSkyBg: calSkyBg, &fbb)
    SOICalibration_Abridged.add(calBgIntensity: calBgIntensity, &fbb)
    SOICalibration_Abridged.add(calSpectralFilterSolarMag: calSpectralFilterSolarMag, &fbb)
    SOICalibration_Abridged.add(calZeroPoint: calZeroPoint, &fbb)
    SOICalibration_Abridged.add(calNumDetectedStars: calNumDetectedStars, &fbb)
    SOICalibration_Abridged.add(calNumCorrelatedStars: calNumCorrelatedStars, &fbb)
    SOICalibration_Abridged.add(calExtinctionCoeffUnc: calExtinctionCoeffUnc, &fbb)
    SOICalibration_Abridged.add(calExtinctionCoeffMaxUnc: calExtinctionCoeffMaxUnc, &fbb)
    SOICalibration_Abridged.add(calTime: calTime, &fbb)
    SOICalibration_Abridged.add(calType: calType, &fbb)
    return SOICalibration_Abridged.endSOICalibration_Abridged(&fbb, start: __start)
  }
