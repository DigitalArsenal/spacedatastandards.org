...
public enum AnalyticImagery_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AnalyticImagery_Ingest_dataMode_Enum { return .exercise }
  public static var min: AnalyticImagery_Ingest_dataMode_Enum { return .real }
}
...
public struct AnalyticImagery_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AnalyticImagery_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: AnalyticImagery_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AnalyticImagery_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startAnalyticImagery_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 41) }
  ...
  public static func add(dataMode: AnalyticImagery_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endAnalyticImagery_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAnalyticImagery_Ingest(
    ...
    let __start = AnalyticImagery_Ingest.startAnalyticImagery_Ingest(&fbb)
    AnalyticImagery_Ingest.add(id: id, &fbb)
    AnalyticImagery_Ingest.add(classificationMarking: classificationMarking, &fbb)
    AnalyticImagery_Ingest.add(content: content, &fbb)
    AnalyticImagery_Ingest.add(msgTime: msgTime, &fbb)
    AnalyticImagery_Ingest.add(imageType: imageType, &fbb)
    AnalyticImagery_Ingest.add(filename: filename, &fbb)
    AnalyticImagery_Ingest.add(filesize: filesize, &fbb)
    AnalyticImagery_Ingest.add(imgWidth: imgWidth, &fbb)
    AnalyticImagery_Ingest.add(imgHeight: imgHeight, &fbb)
    AnalyticImagery_Ingest.add(xUnits: xUnits, &fbb)
    AnalyticImagery_Ingest.add(yUnits: yUnits, &fbb)
    AnalyticImagery_Ingest.add(zUnits: zUnits, &fbb)
    AnalyticImagery_Ingest.add(imageSetId: imageSetId, &fbb)
    AnalyticImagery_Ingest.add(imageSetLength: imageSetLength, &fbb)
    AnalyticImagery_Ingest.add(sequenceId: sequenceId, &fbb)
    AnalyticImagery_Ingest.add(description: description, &fbb)
    AnalyticImagery_Ingest.add(dataStart: dataStart, &fbb)
    AnalyticImagery_Ingest.add(dataStop: dataStop, &fbb)
    AnalyticImagery_Ingest.addVectorOf(annLims: annLims, &fbb)
    AnalyticImagery_Ingest.addVectorOf(annText: annText, &fbb)
    AnalyticImagery_Ingest.addVectorOf(keywords: keywords, &fbb)
    AnalyticImagery_Ingest.add(area: area, &fbb)
    AnalyticImagery_Ingest.add(atext: atext, &fbb)
    AnalyticImagery_Ingest.add(agjson: agjson, &fbb)
    AnalyticImagery_Ingest.add(atype: atype, &fbb)
    AnalyticImagery_Ingest.add(andims: andims, &fbb)
    AnalyticImagery_Ingest.add(asrid: asrid, &fbb)
    AnalyticImagery_Ingest.addVectorOf(satId: satId, &fbb)
    AnalyticImagery_Ingest.addVectorOf(satIdConf: satIdConf, &fbb)
    AnalyticImagery_Ingest.addVectorOf(srcTyps: srcTyps, &fbb)
    AnalyticImagery_Ingest.addVectorOf(srcIds: srcIds, &fbb)
    AnalyticImagery_Ingest.addVectorOf(tags: tags, &fbb)
    AnalyticImagery_Ingest.add(checksumValue: checksumValue, &fbb)
    AnalyticImagery_Ingest.add(transactionId: transactionId, &fbb)
    AnalyticImagery_Ingest.add(createdAt: createdAt, &fbb)
    AnalyticImagery_Ingest.add(createdBy: createdBy, &fbb)
    AnalyticImagery_Ingest.add(source: source, &fbb)
    AnalyticImagery_Ingest.add(origin: origin, &fbb)
    AnalyticImagery_Ingest.add(origNetwork: origNetwork, &fbb)
    AnalyticImagery_Ingest.add(sourceDl: sourceDl, &fbb)
    AnalyticImagery_Ingest.add(dataMode: dataMode, &fbb)
    return AnalyticImagery_Ingest.endAnalyticImagery_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AnalyticImagery_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
