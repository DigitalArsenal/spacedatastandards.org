...
public enum Sensor_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Sensor_Abridged_dataMode_Enum { return .exercise }
  public static var min: Sensor_Abridged_dataMode_Enum { return .real }
}


///  /// Model representation of observation data for electro-optical based sensor phenomenologies.
public struct Sensor_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Sensor_Abridged.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case createdBy = 30
    case active = 32
    case sensorcharacteristics = 34
    case sensorStats = 36
    case sensorlimitsCollection = 38
    case entity = 40
    case idEntity = 42
    case sensorObservationType = 44
    case sensorType = 46
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Sensor_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Sensor_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startSensor_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 22) }
  ...
  public static func add(dataMode: Sensor_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endSensor_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSensor_Abridged(
    ...
    let __start = Sensor_Abridged.startSensor_Abridged(&fbb)
    Sensor_Abridged.add(idSensor: idSensor, &fbb)
    Sensor_Abridged.add(sensorName: sensorName, &fbb)
    Sensor_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Sensor_Abridged.add(sensorNumber: sensorNumber, &fbb)
    Sensor_Abridged.add(shortName: shortName, &fbb)
    Sensor_Abridged.add(dataControl: dataControl, &fbb)
    Sensor_Abridged.add(afId: afId, &fbb)
    Sensor_Abridged.add(asrType: asrType, &fbb)
    Sensor_Abridged.add(source: source, &fbb)
    Sensor_Abridged.add(origin: origin, &fbb)
    Sensor_Abridged.add(origNetwork: origNetwork, &fbb)
    Sensor_Abridged.add(dataMode: dataMode, &fbb)
    Sensor_Abridged.add(createdAt: createdAt, &fbb)
    Sensor_Abridged.add(createdBy: createdBy, &fbb)
    Sensor_Abridged.add(active: active, &fbb)
    Sensor_Abridged.addVectorOf(sensorcharacteristics: sensorcharacteristics, &fbb)
    Sensor_Abridged.addVectorOf(sensorStats: sensorStats, &fbb)
    Sensor_Abridged.addVectorOf(sensorlimitsCollection: sensorlimitsCollection, &fbb)
    Sensor_Abridged.add(entity: entity, &fbb)
    Sensor_Abridged.add(idEntity: idEntity, &fbb)
    Sensor_Abridged.add(sensorObservationType: sensorObservationType, &fbb)
    Sensor_Abridged.add(sensorType: sensorType, &fbb)
    return Sensor_Abridged.endSensor_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Sensor_Abridged_dataMode_Enum.self)
