...
public struct IonoObservationPower_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationPower_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationPower_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationPower_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationPower_Full(
    ...
    let __start = IonoObservationPower_Full.startIonoObservationPower_Full(&fbb)
    IonoObservationPower_Full.add(notes: notes, &fbb)
    IonoObservationPower_Full.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationPower_Full.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationPower_Full.addVectorOf(data: data, &fbb)
    return IonoObservationPower_Full.endIonoObservationPower_Full(&fbb, start: __start)
  }
