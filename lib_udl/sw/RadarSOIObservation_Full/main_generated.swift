...
public struct RadarSOIObservation_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: RadarSOIObservation_Full.id, addPrefix: prefix) }
  ...
  public static func startRadarSOIObservation_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 32) }
  ...
  public static func endRadarSOIObservation_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createRadarSOIObservation_Full(
    ...
    let __start = RadarSOIObservation_Full.startRadarSOIObservation_Full(&fbb)
    RadarSOIObservation_Full.add(obStartTime: obStartTime, &fbb)
    RadarSOIObservation_Full.addVectorOf(tovs: tovs, &fbb)
    RadarSOIObservation_Full.addVectorOf(rspaces: rspaces, &fbb)
    RadarSOIObservation_Full.addVectorOf(xspaces: xspaces, &fbb)
    RadarSOIObservation_Full.addVectorOf(doppler2Xrs: doppler2Xrs, &fbb)
    RadarSOIObservation_Full.addVectorOf(deltaTimes: deltaTimes, &fbb)
    RadarSOIObservation_Full.addVectorOf(aspectAngles: aspectAngles, &fbb)
    RadarSOIObservation_Full.addVectorOf(projAngVels: projAngVels, &fbb)
    RadarSOIObservation_Full.add(idStateVector: idStateVector, &fbb)
    RadarSOIObservation_Full.add(idAttitudeSet: idAttitudeSet, &fbb)
    RadarSOIObservation_Full.addVectorOf(ranges: ranges, &fbb)
    RadarSOIObservation_Full.addVectorOf(azimuths: azimuths, &fbb)
    RadarSOIObservation_Full.addVectorOf(elevations: elevations, &fbb)
    RadarSOIObservation_Full.addVectorOf(rangeRates: rangeRates, &fbb)
    RadarSOIObservation_Full.addVectorOf(azimuthRates: azimuthRates, &fbb)
    RadarSOIObservation_Full.addVectorOf(elevationRates: elevationRates, &fbb)
    RadarSOIObservation_Full.addVectorOf(azimuthBiases: azimuthBiases, &fbb)
    RadarSOIObservation_Full.addVectorOf(elevationBiases: elevationBiases, &fbb)
    RadarSOIObservation_Full.addVectorOf(rangeBiases: rangeBiases, &fbb)
    RadarSOIObservation_Full.addVectorOf(integrationAngles: integrationAngles, &fbb)
    RadarSOIObservation_Full.addVectorOf(crossRangeRes: crossRangeRes, &fbb)
    RadarSOIObservation_Full.add(beta: beta, &fbb)
    RadarSOIObservation_Full.add(kappa: kappa, &fbb)
    RadarSOIObservation_Full.addVectorOf(peakAmplitudes: peakAmplitudes, &fbb)
    RadarSOIObservation_Full.add(centerFrequency: centerFrequency, &fbb)
    RadarSOIObservation_Full.add(pulseBandwidth: pulseBandwidth, &fbb)
    RadarSOIObservation_Full.addVectorOf(xpos: xpos, &fbb)
    RadarSOIObservation_Full.addVectorOf(ypos: ypos, &fbb)
    RadarSOIObservation_Full.addVectorOf(zpos: zpos, &fbb)
    RadarSOIObservation_Full.addVectorOf(xvel: xvel, &fbb)
    RadarSOIObservation_Full.addVectorOf(yvel: yvel, &fbb)
    RadarSOIObservation_Full.addVectorOf(zvel: zvel, &fbb)
    return RadarSOIObservation_Full.endRadarSOIObservation_Full(&fbb, start: __start)
  }
