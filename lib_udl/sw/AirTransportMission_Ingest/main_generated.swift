...
public enum AirTransportMission_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AirTransportMission_Ingest_dataMode_Enum { return .exercise }
  public static var min: AirTransportMission_Ingest_dataMode_Enum { return .real }
}
...
public struct AirTransportMission_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirTransportMission_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: AirTransportMission_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AirTransportMission_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startAirTransportMission_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 38) }
  ...
  public static func add(dataMode: AirTransportMission_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endAirTransportMission_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirTransportMission_Ingest(
    ...
    let __start = AirTransportMission_Ingest.startAirTransportMission_Ingest(&fbb)
    AirTransportMission_Ingest.add(id: id, &fbb)
    AirTransportMission_Ingest.add(classificationMarking: classificationMarking, &fbb)
    AirTransportMission_Ingest.add(origMissionId: origMissionId, &fbb)
    AirTransportMission_Ingest.add(amcMissionId: amcMissionId, &fbb)
    AirTransportMission_Ingest.add(gdssMissionId: gdssMissionId, &fbb)
    AirTransportMission_Ingest.add(prevMissionId: prevMissionId, &fbb)
    AirTransportMission_Ingest.add(prevAmcmissionId: prevAmcmissionId, &fbb)
    AirTransportMission_Ingest.add(nextMissionId: nextMissionId, &fbb)
    AirTransportMission_Ingest.add(nextAmcmissionId: nextAmcmissionId, &fbb)
    AirTransportMission_Ingest.add(objective: objective, &fbb)
    AirTransportMission_Ingest.add(purpose: purpose, &fbb)
    AirTransportMission_Ingest.add(jcsPriority: jcsPriority, &fbb)
    AirTransportMission_Ingest.add(cw: cw, &fbb)
    AirTransportMission_Ingest.add(type: type, &fbb)
    AirTransportMission_Ingest.add(firstPickUp: firstPickUp, &fbb)
    AirTransportMission_Ingest.add(lastDropOff: lastDropOff, &fbb)
    AirTransportMission_Ingest.add(alias: alias, &fbb)
    AirTransportMission_Ingest.add(callSign: callSign, &fbb)
    AirTransportMission_Ingest.add(operation: operation, &fbb)
    AirTransportMission_Ingest.add(naf: naf, &fbb)
    AirTransportMission_Ingest.add(allocatedUnit: allocatedUnit, &fbb)
    AirTransportMission_Ingest.add(loadCategoryType: loadCategoryType, &fbb)
    AirTransportMission_Ingest.add(state: state, &fbb)
    AirTransportMission_Ingest.add(sourceSysDeviation: sourceSysDeviation, &fbb)
    AirTransportMission_Ingest.add(apacsId: apacsId, &fbb)
    AirTransportMission_Ingest.add(dipWorksheetName: dipWorksheetName, &fbb)
    AirTransportMission_Ingest.add(createdAt: createdAt, &fbb)
    AirTransportMission_Ingest.add(createdBy: createdBy, &fbb)
    AirTransportMission_Ingest.add(updatedAt: updatedAt, &fbb)
    AirTransportMission_Ingest.add(updatedBy: updatedBy, &fbb)
    AirTransportMission_Ingest.add(sourceDl: sourceDl, &fbb)
    AirTransportMission_Ingest.add(source: source, &fbb)
    AirTransportMission_Ingest.add(origin: origin, &fbb)
    AirTransportMission_Ingest.add(dataMode: dataMode, &fbb)
    AirTransportMission_Ingest.add(origNetwork: origNetwork, &fbb)
    AirTransportMission_Ingest.addVectorOf(requirements: requirements, &fbb)
    AirTransportMission_Ingest.addVectorOf(remarks: remarks, &fbb)
    AirTransportMission_Ingest.addVectorOf(hazMat: hazMat, &fbb)
    return AirTransportMission_Ingest.endAirTransportMission_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AirTransportMission_Ingest_dataMode_Enum.self)
