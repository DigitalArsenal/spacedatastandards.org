...
public struct PersonnelRecoveryObjectiveAreaInfo_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: PersonnelRecoveryObjectiveAreaInfo_Ingest.id, addPrefix: prefix) }
  ...
  public static func startPersonnelRecoveryObjectiveAreaInfo_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endPersonnelRecoveryObjectiveAreaInfo_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPersonnelRecoveryObjectiveAreaInfo_Ingest(
    ...
    let __start = PersonnelRecoveryObjectiveAreaInfo_Ingest.startPersonnelRecoveryObjectiveAreaInfo_Ingest(&fbb)
    PersonnelRecoveryObjectiveAreaInfo_Ingest.addVectorOf(pzLocation: pzLocation, &fbb)
    PersonnelRecoveryObjectiveAreaInfo_Ingest.add(pzDesc: pzDesc, &fbb)
    PersonnelRecoveryObjectiveAreaInfo_Ingest.add(oscCallSign: oscCallSign, &fbb)
    PersonnelRecoveryObjectiveAreaInfo_Ingest.add(oscFreq: oscFreq, &fbb)
    PersonnelRecoveryObjectiveAreaInfo_Ingest.addVectorOf(enemyData: enemyData, &fbb)
    return PersonnelRecoveryObjectiveAreaInfo_Ingest.endPersonnelRecoveryObjectiveAreaInfo_Ingest(&fbb, start: __start)
  }
