...
public enum EngineDetails_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: EngineDetails_Ingest_dataMode_Enum { return .exercise }
  public static var min: EngineDetails_Ingest_dataMode_Enum { return .real }
}
...
public struct EngineDetails_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EngineDetails_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: EngineDetails_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : EngineDetails_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startEngineDetails_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 24) }
  ...
  public static func add(dataMode: EngineDetails_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func addVectorOf(tags: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: tags, at: VTOFFSET.tags.p) }
  public static func endEngineDetails_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEngineDetails_Ingest(
    ...
    let __start = EngineDetails_Ingest.startEngineDetails_Ingest(&fbb)
    EngineDetails_Ingest.add(id: id, &fbb)
    EngineDetails_Ingest.add(idEngine: idEngine, &fbb)
    EngineDetails_Ingest.add(classificationMarking: classificationMarking, &fbb)
    EngineDetails_Ingest.add(family: family, &fbb)
    EngineDetails_Ingest.add(cycleType: cycleType, &fbb)
    EngineDetails_Ingest.add(characteristicType: characteristicType, &fbb)
    EngineDetails_Ingest.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    EngineDetails_Ingest.add(specificImpulse: specificImpulse, &fbb)
    EngineDetails_Ingest.add(burnTime: burnTime, &fbb)
    EngineDetails_Ingest.add(seaLevelThrust: seaLevelThrust, &fbb)
    EngineDetails_Ingest.add(vacuumThrust: vacuumThrust, &fbb)
    EngineDetails_Ingest.add(chamberPressure: chamberPressure, &fbb)
    EngineDetails_Ingest.add(nozzleExpansionRatio: nozzleExpansionRatio, &fbb)
    EngineDetails_Ingest.add(maxFirings: maxFirings, &fbb)
    EngineDetails_Ingest.add(propellant: propellant, &fbb)
    EngineDetails_Ingest.add(oxidizer: oxidizer, &fbb)
    EngineDetails_Ingest.add(notes: notes, &fbb)
    EngineDetails_Ingest.add(createdAt: createdAt, &fbb)
    EngineDetails_Ingest.add(createdBy: createdBy, &fbb)
    EngineDetails_Ingest.add(source: source, &fbb)
    EngineDetails_Ingest.add(origin: origin, &fbb)
    EngineDetails_Ingest.add(origNetwork: origNetwork, &fbb)
    EngineDetails_Ingest.add(dataMode: dataMode, &fbb)
    EngineDetails_Ingest.addVectorOf(tags: tags, &fbb)
    return EngineDetails_Ingest.endEngineDetails_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: EngineDetails_Ingest_dataMode_Enum.self)
