...
public struct EvacCasualtyInfo_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacCasualtyInfo_Full.id, addPrefix: prefix) }
  ...
  public static func startEvacCasualtyInfo_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 35) }
  ...
  public static func endEvacCasualtyInfo_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacCasualtyInfo_Full(
    ...
    let __start = EvacCasualtyInfo_Full.startEvacCasualtyInfo_Full(&fbb)
    EvacCasualtyInfo_Full.add(priority: priority, &fbb)
    EvacCasualtyInfo_Full.add(evacType: evacType, &fbb)
    EvacCasualtyInfo_Full.add(casualtyType: casualtyType, &fbb)
    EvacCasualtyInfo_Full.add(bodyPart: bodyPart, &fbb)
    EvacCasualtyInfo_Full.add(contamType: contamType, &fbb)
    EvacCasualtyInfo_Full.addVectorOf(specMedEquip: specMedEquip, &fbb)
    EvacCasualtyInfo_Full.add(casualtyKey: casualtyKey, &fbb)
    EvacCasualtyInfo_Full.add(patientStatus: patientStatus, &fbb)
    EvacCasualtyInfo_Full.add(patientIdentity: patientIdentity, &fbb)
    EvacCasualtyInfo_Full.add(nationality: nationality, &fbb)
    EvacCasualtyInfo_Full.add(payGrade: payGrade, &fbb)
    EvacCasualtyInfo_Full.add(name: name, &fbb)
    EvacCasualtyInfo_Full.add(age: age, &fbb)
    EvacCasualtyInfo_Full.add(gender: gender, &fbb)
    EvacCasualtyInfo_Full.add(last4Ssn: last4Ssn, &fbb)
    EvacCasualtyInfo_Full.add(bloodType: bloodType, &fbb)
    EvacCasualtyInfo_Full.add(service: service, &fbb)
    EvacCasualtyInfo_Full.add(callSign: callSign, &fbb)
    EvacCasualtyInfo_Full.add(occSpeciality: occSpeciality, &fbb)
    EvacCasualtyInfo_Full.addVectorOf(burialLocation: burialLocation, &fbb)
    EvacCasualtyInfo_Full.addVectorOf(collectionPoint: collectionPoint, &fbb)
    EvacCasualtyInfo_Full.add(careProviderUrn: careProviderUrn, &fbb)
    EvacCasualtyInfo_Full.add(dispositionType: dispositionType, &fbb)
    EvacCasualtyInfo_Full.add(disposition: disposition, &fbb)
    EvacCasualtyInfo_Full.add(reportGen: reportGen, &fbb)
    EvacCasualtyInfo_Full.add(reportTime: reportTime, &fbb)
    EvacCasualtyInfo_Full.add(comments: comments, &fbb)
    EvacCasualtyInfo_Full.addVectorOf(etiology: etiology, &fbb)
    EvacCasualtyInfo_Full.addVectorOf(treatment: treatment, &fbb)
    EvacCasualtyInfo_Full.addVectorOf(vitalSignData: vitalSignData, &fbb)
    EvacCasualtyInfo_Full.addVectorOf(healthState: healthState, &fbb)
    EvacCasualtyInfo_Full.addVectorOf(condition: condition, &fbb)
    EvacCasualtyInfo_Full.addVectorOf(medication: medication, &fbb)
    EvacCasualtyInfo_Full.addVectorOf(injury: injury, &fbb)
    EvacCasualtyInfo_Full.addVectorOf(allergy: allergy, &fbb)
    return EvacCasualtyInfo_Full.endEvacCasualtyInfo_Full(&fbb, start: __start)
  }
