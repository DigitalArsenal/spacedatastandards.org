...
public enum Evac_Ingest_type_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Evac_Ingest_type_Enum { return .response }
  public static var min: Evac_Ingest_type_Enum { return .request }
}


public enum Evac_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: Evac_Ingest_dataMode_Enum { return .exercise }
  public static var min: Evac_Ingest_dataMode_Enum { return .real }
}


///  /// Casualty report and evacuation request. Used to report and request support to evacuate friendly and enemy casualties.
public struct Evac_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Evac_Ingest.id, addPrefix: prefix) }
  ...
  public var type: Evac_Ingest_type_Enum { let o = _accessor.offset(VTOFFSET.type.v); return o == 0 ? .request : Evac_Ingest_type_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .request }
  ...
  public var dataMode: Evac_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Evac_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startEvac_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 40) }
  ...
  public static func add(type: Evac_Ingest_type_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: type.rawValue, def: 0, at: VTOFFSET.type.p) }
  ...
  public static func add(dataMode: Evac_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endEvac_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvac_Ingest(
    _ fbb: inout FlatBufferBuilder,
    idOffset id: Offset = Offset(),
    classificationMarkingOffset classificationMarking: Offset = Offset(),
    medevacIdOffset medevacId: Offset = Offset(),
    type: Evac_Ingest_type_Enum = .request,
    ...
    let __start = Evac_Ingest.startEvac_Ingest(&fbb)
    Evac_Ingest.add(id: id, &fbb)
    Evac_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Evac_Ingest.add(medevacId: medevacId, &fbb)
    Evac_Ingest.add(type: type, &fbb)
    Evac_Ingest.add(missionType: missionType, &fbb)
    Evac_Ingest.add(idWeatherReport: idWeatherReport, &fbb)
    Evac_Ingest.add(numKia: numKia, &fbb)
    Evac_Ingest.add(numWia: numWia, &fbb)
    Evac_Ingest.add(numLitter: numLitter, &fbb)
    Evac_Ingest.add(numAmbulatory: numAmbulatory, &fbb)
    Evac_Ingest.add(medicReq: medicReq, &fbb)
    Evac_Ingest.add(reqNum: reqNum, &fbb)
    Evac_Ingest.add(reqTime: reqTime, &fbb)
    Evac_Ingest.add(reqCallSign: reqCallSign, &fbb)
    Evac_Ingest.add(pickupTime: pickupTime, &fbb)
    Evac_Ingest.add(pickupLat: pickupLat, &fbb)
    Evac_Ingest.add(pickupLon: pickupLon, &fbb)
    Evac_Ingest.add(pickupAlt: pickupAlt, &fbb)
    Evac_Ingest.add(ce: ce, &fbb)
    Evac_Ingest.add(le: le, &fbb)
    Evac_Ingest.add(terrain: terrain, &fbb)
    Evac_Ingest.add(obstaclesRemarks: obstaclesRemarks, &fbb)
    Evac_Ingest.add(terrainRemarks: terrainRemarks, &fbb)
    Evac_Ingest.add(zoneName: zoneName, &fbb)
    Evac_Ingest.add(zoneMarking: zoneMarking, &fbb)
    Evac_Ingest.add(zoneSecurity: zoneSecurity, &fbb)
    Evac_Ingest.add(zoneMarkingColor: zoneMarkingColor, &fbb)
    Evac_Ingest.add(zoneHot: zoneHot, &fbb)
    Evac_Ingest.add(cntctFreq: cntctFreq, &fbb)
    Evac_Ingest.add(zoneContrCallSign: zoneContrCallSign, &fbb)
    Evac_Ingest.add(numCasualties: numCasualties, &fbb)
    Evac_Ingest.add(comments: comments, &fbb)
    Evac_Ingest.addVectorOf(casualtyInfo: casualtyInfo, &fbb)
    Evac_Ingest.addVectorOf(enemyData: enemyData, &fbb)
    Evac_Ingest.add(origNetwork: origNetwork, &fbb)
    Evac_Ingest.add(createdAt: createdAt, &fbb)
    Evac_Ingest.add(createdBy: createdBy, &fbb)
    Evac_Ingest.add(source: source, &fbb)
    Evac_Ingest.add(origin: origin, &fbb)
    Evac_Ingest.add(dataMode: dataMode, &fbb)
    return Evac_Ingest.endEvac_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.type.p, fieldName: "type", required: false, type: Evac_Ingest_type_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Evac_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
