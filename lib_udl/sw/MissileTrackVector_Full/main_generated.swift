...
public struct MissileTrackVector_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MissileTrackVector_Full.id, addPrefix: prefix) }
  ...
  public static func startMissileTrackVector_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 21) }
  ...
  public static func endMissileTrackVector_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMissileTrackVector_Full(
    ...
    let __start = MissileTrackVector_Full.startMissileTrackVector_Full(&fbb)
    MissileTrackVector_Full.add(type: type, &fbb)
    MissileTrackVector_Full.add(object: object, &fbb)
    MissileTrackVector_Full.add(epoch: epoch, &fbb)
    MissileTrackVector_Full.add(idSensor: idSensor, &fbb)
    MissileTrackVector_Full.add(origSensorId: origSensorId, &fbb)
    MissileTrackVector_Full.addVectorOf(pos: pos, &fbb)
    MissileTrackVector_Full.addVectorOf(vel: vel, &fbb)
    MissileTrackVector_Full.addVectorOf(accel: accel, &fbb)
    MissileTrackVector_Full.add(course: course, &fbb)
    MissileTrackVector_Full.add(spd: spd, &fbb)
    MissileTrackVector_Full.add(referenceFrame: referenceFrame, &fbb)
    MissileTrackVector_Full.addVectorOf(cov: cov, &fbb)
    MissileTrackVector_Full.add(covReferenceFrame: covReferenceFrame, &fbb)
    MissileTrackVector_Full.add(vectorLat: vectorLat, &fbb)
    MissileTrackVector_Full.add(vectorLon: vectorLon, &fbb)
    MissileTrackVector_Full.add(vectorAlt: vectorAlt, &fbb)
    MissileTrackVector_Full.add(confidence: confidence, &fbb)
    MissileTrackVector_Full.add(status: status, &fbb)
    MissileTrackVector_Full.add(timeSource: timeSource, &fbb)
    MissileTrackVector_Full.addVectorOf(quat: quat, &fbb)
    MissileTrackVector_Full.add(flightAz: flightAz, &fbb)
    return MissileTrackVector_Full.endMissileTrackVector_Full(&fbb, start: __start)
  }
