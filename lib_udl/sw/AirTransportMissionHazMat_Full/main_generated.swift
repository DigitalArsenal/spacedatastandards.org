...
public struct AirTransportMissionHazMat_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirTransportMissionHazMat_Full.id, addPrefix: prefix) }
  ...
  public static func startAirTransportMissionHazMat_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 15) }
  ...
  public static func endAirTransportMissionHazMat_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirTransportMissionHazMat_Full(
    ...
    let __start = AirTransportMissionHazMat_Full.startAirTransportMissionHazMat_Full(&fbb)
    AirTransportMissionHazMat_Full.add(extHazMatId: extHazMatId, &fbb)
    AirTransportMissionHazMat_Full.add(itemName: itemName, &fbb)
    AirTransportMissionHazMat_Full.add(unNum: unNum, &fbb)
    AirTransportMissionHazMat_Full.add(pieces: pieces, &fbb)
    AirTransportMissionHazMat_Full.add(weight: weight, &fbb)
    AirTransportMissionHazMat_Full.add(netExpWt: netExpWt, &fbb)
    AirTransportMissionHazMat_Full.add(classDiv: classDiv, &fbb)
    AirTransportMissionHazMat_Full.add(cgc: cgc, &fbb)
    AirTransportMissionHazMat_Full.add(cgn: cgn, &fbb)
    AirTransportMissionHazMat_Full.add(applicableNotes: applicableNotes, &fbb)
    AirTransportMissionHazMat_Full.add(onItin: onItin, &fbb)
    AirTransportMissionHazMat_Full.add(onIcao: onIcao, &fbb)
    AirTransportMissionHazMat_Full.add(offItin: offItin, &fbb)
    AirTransportMissionHazMat_Full.add(offIcao: offIcao, &fbb)
    AirTransportMissionHazMat_Full.add(planned: planned, &fbb)
    return AirTransportMissionHazMat_Full.endAirTransportMissionHazMat_Full(&fbb, start: __start)
  }
