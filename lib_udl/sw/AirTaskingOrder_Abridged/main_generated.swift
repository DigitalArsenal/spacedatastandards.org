...
public enum AirTaskingOrder_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AirTaskingOrder_Abridged_dataMode_Enum { return .exercise }
  public static var min: AirTaskingOrder_Abridged_dataMode_Enum { return .real }
}
...
public struct AirTaskingOrder_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirTaskingOrder_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: AirTaskingOrder_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AirTaskingOrder_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startAirTaskingOrder_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 22) }
  ...
  public static func add(dataMode: AirTaskingOrder_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endAirTaskingOrder_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirTaskingOrder_Abridged(
    ...
    let __start = AirTaskingOrder_Abridged.startAirTaskingOrder_Abridged(&fbb)
    AirTaskingOrder_Abridged.add(id: id, &fbb)
    AirTaskingOrder_Abridged.add(classificationMarking: classificationMarking, &fbb)
    AirTaskingOrder_Abridged.add(rawFileUri: rawFileUri, &fbb)
    AirTaskingOrder_Abridged.add(opExerName: opExerName, &fbb)
    AirTaskingOrder_Abridged.add(msgOriginator: msgOriginator, &fbb)
    AirTaskingOrder_Abridged.add(msgSn: msgSn, &fbb)
    AirTaskingOrder_Abridged.add(msgMonth: msgMonth, &fbb)
    AirTaskingOrder_Abridged.add(msgQualifier: msgQualifier, &fbb)
    AirTaskingOrder_Abridged.add(ackReqInd: ackReqInd, &fbb)
    AirTaskingOrder_Abridged.add(ackUnitInstructions: ackUnitInstructions, &fbb)
    AirTaskingOrder_Abridged.add(beginTs: beginTs, &fbb)
    AirTaskingOrder_Abridged.add(endTs: endTs, &fbb)
    AirTaskingOrder_Abridged.addVectorOf(genText: genText, &fbb)
    AirTaskingOrder_Abridged.addVectorOf(acMsnTasking: acMsnTasking, &fbb)
    AirTaskingOrder_Abridged.addVectorOf(navalFltOps: navalFltOps, &fbb)
    AirTaskingOrder_Abridged.add(createdAt: createdAt, &fbb)
    AirTaskingOrder_Abridged.add(createdBy: createdBy, &fbb)
    AirTaskingOrder_Abridged.add(source: source, &fbb)
    AirTaskingOrder_Abridged.add(sourceDl: sourceDl, &fbb)
    AirTaskingOrder_Abridged.add(origin: origin, &fbb)
    AirTaskingOrder_Abridged.add(origNetwork: origNetwork, &fbb)
    AirTaskingOrder_Abridged.add(dataMode: dataMode, &fbb)
    return AirTaskingOrder_Abridged.endAirTaskingOrder_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AirTaskingOrder_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
