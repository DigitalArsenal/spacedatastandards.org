...
public struct AircraftMissionTasking_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AircraftMissionTasking_Full.id, addPrefix: prefix) }
  ...
  public static func startAircraftMissionTasking_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 24) }
  ...
  public static func endAircraftMissionTasking_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAircraftMissionTasking_Full(
    ...
    let __start = AircraftMissionTasking_Full.startAircraftMissionTasking_Full(&fbb)
    AircraftMissionTasking_Full.add(countryCode: countryCode, &fbb)
    AircraftMissionTasking_Full.add(taskedService: taskedService, &fbb)
    AircraftMissionTasking_Full.add(unitDesignator: unitDesignator, &fbb)
    AircraftMissionTasking_Full.add(unitLocName: unitLocName, &fbb)
    AircraftMissionTasking_Full.add(resMsnInd: resMsnInd, &fbb)
    AircraftMissionTasking_Full.add(amcMsnNum: amcMsnNum, &fbb)
    AircraftMissionTasking_Full.add(pkgId: pkgId, &fbb)
    AircraftMissionTasking_Full.add(msnCommander: msnCommander, &fbb)
    AircraftMissionTasking_Full.add(msnNum: msnNum, &fbb)
    AircraftMissionTasking_Full.add(priMsnType: priMsnType, &fbb)
    AircraftMissionTasking_Full.add(secMsnType: secMsnType, &fbb)
    AircraftMissionTasking_Full.add(alertStatus: alertStatus, &fbb)
    AircraftMissionTasking_Full.add(depLocName: depLocName, &fbb)
    AircraftMissionTasking_Full.add(depLocUtm: depLocUtm, &fbb)
    AircraftMissionTasking_Full.add(depLocLat: depLocLat, &fbb)
    AircraftMissionTasking_Full.add(depLocLon: depLocLon, &fbb)
    AircraftMissionTasking_Full.add(depTime: depTime, &fbb)
    AircraftMissionTasking_Full.addVectorOf(rcvyLocName: rcvyLocName, &fbb)
    AircraftMissionTasking_Full.addVectorOf(rcvyLocUtm: rcvyLocUtm, &fbb)
    AircraftMissionTasking_Full.addVectorOf(rcvyLocLat: rcvyLocLat, &fbb)
    AircraftMissionTasking_Full.addVectorOf(rcvyLocLon: rcvyLocLon, &fbb)
    AircraftMissionTasking_Full.addVectorOf(rcvyTime: rcvyTime, &fbb)
    AircraftMissionTasking_Full.addVectorOf(indActasking: indActasking, &fbb)
    AircraftMissionTasking_Full.addVectorOf(acMsnLocSeg: acMsnLocSeg, &fbb)
    return AircraftMissionTasking_Full.endAircraftMissionTasking_Full(&fbb, start: __start)
  }
