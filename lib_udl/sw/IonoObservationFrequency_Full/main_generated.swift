...
public struct IonoObservationFrequency_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationFrequency_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationFrequency_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationFrequency_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationFrequency_Full(
    ...
    let __start = IonoObservationFrequency_Full.startIonoObservationFrequency_Full(&fbb)
    IonoObservationFrequency_Full.add(notes: notes, &fbb)
    IonoObservationFrequency_Full.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationFrequency_Full.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationFrequency_Full.addVectorOf(data: data, &fbb)
    return IonoObservationFrequency_Full.endIonoObservationFrequency_Full(&fbb, start: __start)
  }
