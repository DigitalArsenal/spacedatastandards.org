...
public enum Onorbit_Full_objectType_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Onorbit_Full_objectType_Enum { return .unknown }
  public static var min: Onorbit_Full_objectType_Enum { return .rocketBody }
}


public enum Onorbit_Full_category_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: Onorbit_Full_category_Enum { return .docked }
  public static var min: Onorbit_Full_category_Enum { return .unknown }
}


public enum Onorbit_Full_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: Onorbit_Full_dataMode_Enum { return .exercise }
  public static var min: Onorbit_Full_dataMode_Enum { return .real }
}


///  /// Model object representing on-orbit objects or satellites in the system.
public struct Onorbit_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Onorbit_Full.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case source = 40
    case dataMode = 42
    case launchSiteId = 44
    case antennas = 46
    case batteries = 48
    case solarArrays = 50
    case thrusters = 52
    case onorbitDetails = 54
    case countryCode = 56
    case origNetwork = 58
    case entityCollection = 60
  ...
  public var objectType: Onorbit_Full_objectType_Enum { let o = _accessor.offset(VTOFFSET.objectType.v); return o == 0 ? .rocketBody : Onorbit_Full_objectType_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .rocketBody }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 45
  public var category: Onorbit_Full_category_Enum { let o = _accessor.offset(VTOFFSET.category.v); return o == 0 ? .unknown : Onorbit_Full_category_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .unknown }
  ...
  public var dataMode: Onorbit_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Onorbit_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  public var hasSolarArrays: Bool { let o = _accessor.offset(VTOFFSET.solarArrays.v); return o == 0 ? false : true }
  public var solarArraysCount: Int32 { let o = _accessor.offset(VTOFFSET.solarArrays.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func solarArrays(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.solarArrays.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  public var hasOnorbitDetails: Bool { let o = _accessor.offset(VTOFFSET.onorbitDetails.v); return o == 0 ? false : true }
  public var onorbitDetailsCount: Int32 { let o = _accessor.offset(VTOFFSET.onorbitDetails.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func onorbitDetails(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.onorbitDetails.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  public var hasEntityCollection: Bool { let o = _accessor.offset(VTOFFSET.entityCollection.v); return o == 0 ? false : true }
  public var entityCollectionCount: Int32 { let o = _accessor.offset(VTOFFSET.entityCollection.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func entityCollection(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.entityCollection.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  public static func startOnorbit_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 29) }
  ...
  public static func add(objectType: Onorbit_Full_objectType_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: objectType.rawValue, def: 0, at: VTOFFSET.objectType.p) }
  ...
  public static func add(category: Onorbit_Full_category_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: category.rawValue, def: 0, at: VTOFFSET.category.p) }
  ...
  public static func add(dataMode: Onorbit_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func addVectorOf(solarArrays: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: solarArrays, at: VTOFFSET.solarArrays.p) }
  ...
  public static func addVectorOf(onorbitDetails: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: onorbitDetails, at: VTOFFSET.onorbitDetails.p) }
  ...
  public static func addVectorOf(entityCollection: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: entityCollection, at: VTOFFSET.entityCollection.p) }
  public static func endOnorbit_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnorbit_Full(
    ...
    objectType: Onorbit_Full_objectType_Enum = .rocketBody,
    ...
    solarArraysVectorOffset solarArrays: Offset = Offset(),
    thrustersVectorOffset thrusters: Offset = Offset(),
    onorbitDetailsVectorOffset onorbitDetails: Offset = Offset(),
    countryCodeOffset countryCode: Offset = Offset(),
    origNetworkOffset origNetwork: Offset = Offset(),
    entityCollectionVectorOffset entityCollection: Offset = Offset()
  ) -> Offset {
    let __start = Onorbit_Full.startOnorbit_Full(&fbb)
    Onorbit_Full.add(idOnOrbit: idOnOrbit, &fbb)
    Onorbit_Full.add(classificationMarking: classificationMarking, &fbb)
    Onorbit_Full.add(satNo: satNo, &fbb)
    Onorbit_Full.add(commonName: commonName, &fbb)
    Onorbit_Full.add(constellation: constellation, &fbb)
    Onorbit_Full.add(intlDes: intlDes, &fbb)
    Onorbit_Full.add(launchDate: launchDate, &fbb)
    Onorbit_Full.add(decayDate: decayDate, &fbb)
    Onorbit_Full.add(objectType: objectType, &fbb)
    Onorbit_Full.add(origin: origin, &fbb)
    Onorbit_Full.add(missionNumber: missionNumber, &fbb)
    Onorbit_Full.add(category: category, &fbb)
    Onorbit_Full.add(lifetimeYears: lifetimeYears, &fbb)
    Onorbit_Full.add(altName: altName, &fbb)
    Onorbit_Full.add(createdAt: createdAt, &fbb)
    Onorbit_Full.add(createdBy: createdBy, &fbb)
    Onorbit_Full.add(updatedAt: updatedAt, &fbb)
    Onorbit_Full.add(updatedBy: updatedBy, &fbb)
    Onorbit_Full.add(source: source, &fbb)
    Onorbit_Full.add(dataMode: dataMode, &fbb)
    Onorbit_Full.add(launchSiteId: launchSiteId, &fbb)
    Onorbit_Full.addVectorOf(antennas: antennas, &fbb)
    Onorbit_Full.addVectorOf(batteries: batteries, &fbb)
    Onorbit_Full.addVectorOf(solarArrays: solarArrays, &fbb)
    Onorbit_Full.addVectorOf(thrusters: thrusters, &fbb)
    Onorbit_Full.addVectorOf(onorbitDetails: onorbitDetails, &fbb)
    Onorbit_Full.add(countryCode: countryCode, &fbb)
    Onorbit_Full.add(origNetwork: origNetwork, &fbb)
    Onorbit_Full.addVectorOf(entityCollection: entityCollection, &fbb)
    return Onorbit_Full.endOnorbit_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.objectType.p, fieldName: "objectType", required: false, type: Onorbit_Full_objectType_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.category.p, fieldName: "category", required: false, type: Onorbit_Full_category_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Onorbit_Full_dataMode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.solarArrays.p, fieldName: "solarArrays", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
    ...
    try _v.visit(field: VTOFFSET.onorbitDetails.p, fieldName: "onorbitDetails", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
    ...
    try _v.visit(field: VTOFFSET.entityCollection.p, fieldName: "entityCollection", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
    _v.finish()
  }
}
