...
public enum EquipmentRemark_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: EquipmentRemark_Full_dataMode_Enum { return .exercise }
  public static var min: EquipmentRemark_Full_dataMode_Enum { return .real }
}
...
public struct EquipmentRemark_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EquipmentRemark_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: EquipmentRemark_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : EquipmentRemark_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startEquipmentRemark_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 15) }
  ...
  public static func add(dataMode: EquipmentRemark_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endEquipmentRemark_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEquipmentRemark_Full(
    ...
    let __start = EquipmentRemark_Full.startEquipmentRemark_Full(&fbb)
    EquipmentRemark_Full.add(id: id, &fbb)
    EquipmentRemark_Full.add(classificationMarking: classificationMarking, &fbb)
    EquipmentRemark_Full.add(idEquipment: idEquipment, &fbb)
    EquipmentRemark_Full.add(altRmkId: altRmkId, &fbb)
    EquipmentRemark_Full.add(name: name, &fbb)
    EquipmentRemark_Full.add(type: type, &fbb)
    EquipmentRemark_Full.add(text: text, &fbb)
    EquipmentRemark_Full.add(code: code, &fbb)
    EquipmentRemark_Full.add(createdAt: createdAt, &fbb)
    EquipmentRemark_Full.add(createdBy: createdBy, &fbb)
    EquipmentRemark_Full.add(updatedAt: updatedAt, &fbb)
    EquipmentRemark_Full.add(updatedBy: updatedBy, &fbb)
    EquipmentRemark_Full.add(source: source, &fbb)
    EquipmentRemark_Full.add(origin: origin, &fbb)
    EquipmentRemark_Full.add(dataMode: dataMode, &fbb)
    return EquipmentRemark_Full.endEquipmentRemark_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: EquipmentRemark_Full_dataMode_Enum.self)
    _v.finish()
  }
}
