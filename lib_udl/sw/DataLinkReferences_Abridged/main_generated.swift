...
public struct DataLinkReferences_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DataLinkReferences_Abridged.id, addPrefix: prefix) }
  ...
  public static func startDataLinkReferences_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 7) }
  ...
  public static func endDataLinkReferences_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDataLinkReferences_Abridged(
    ...
    let __start = DataLinkReferences_Abridged.startDataLinkReferences_Abridged(&fbb)
    DataLinkReferences_Abridged.add(refSerialId: refSerialId, &fbb)
    DataLinkReferences_Abridged.add(refType: refType, &fbb)
    DataLinkReferences_Abridged.add(refOriginator: refOriginator, &fbb)
    DataLinkReferences_Abridged.add(refTs: refTs, &fbb)
    DataLinkReferences_Abridged.add(refSerialNum: refSerialNum, &fbb)
    DataLinkReferences_Abridged.add(refSpecialNotation: refSpecialNotation, &fbb)
    DataLinkReferences_Abridged.addVectorOf(refSics: refSics, &fbb)
    return DataLinkReferences_Abridged.endDataLinkReferences_Abridged(&fbb, start: __start)
  }
