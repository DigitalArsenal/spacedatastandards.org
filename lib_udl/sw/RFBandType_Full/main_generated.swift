...
public enum RFBandType_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: RFBandType_Full_dataMode_Enum { return .exercise }
  public static var min: RFBandType_Full_dataMode_Enum { return .real }
}


///  /// This table contains descriptions for common satellite RF bands.
public struct RFBandType_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: RFBandType_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: RFBandType_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : RFBandType_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startRFBandType_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 12) }
  ...
  public static func add(dataMode: RFBandType_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endRFBandType_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createRFBandType_Full(
    ...
    let __start = RFBandType_Full.startRFBandType_Full(&fbb)
    RFBandType_Full.add(id: id, &fbb)
    RFBandType_Full.add(classificationMarking: classificationMarking, &fbb)
    RFBandType_Full.add(description: description, &fbb)
    RFBandType_Full.add(startFreq: startFreq, &fbb)
    RFBandType_Full.add(endFreq: endFreq, &fbb)
    RFBandType_Full.add(source: source, &fbb)
    RFBandType_Full.add(origin: origin, &fbb)
    RFBandType_Full.add(dataMode: dataMode, &fbb)
    RFBandType_Full.add(createdAt: createdAt, &fbb)
    RFBandType_Full.add(createdBy: createdBy, &fbb)
    RFBandType_Full.add(updatedAt: updatedAt, &fbb)
    RFBandType_Full.add(updatedBy: updatedBy, &fbb)
    return RFBandType_Full.endRFBandType_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: RFBandType_Full_dataMode_Enum.self)
