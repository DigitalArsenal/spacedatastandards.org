...
public enum OperatingUnitRemark_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OperatingUnitRemark_Abridged_dataMode_Enum { return .exercise }
  public static var min: OperatingUnitRemark_Abridged_dataMode_Enum { return .real }
}
...
public struct OperatingUnitRemark_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OperatingUnitRemark_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: OperatingUnitRemark_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OperatingUnitRemark_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startOperatingUnitRemark_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 13) }
  ...
  public static func add(dataMode: OperatingUnitRemark_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endOperatingUnitRemark_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOperatingUnitRemark_Abridged(
    ...
    let __start = OperatingUnitRemark_Abridged.startOperatingUnitRemark_Abridged(&fbb)
    OperatingUnitRemark_Abridged.add(id: id, &fbb)
    OperatingUnitRemark_Abridged.add(classificationMarking: classificationMarking, &fbb)
    OperatingUnitRemark_Abridged.add(idOperatingUnit: idOperatingUnit, &fbb)
    OperatingUnitRemark_Abridged.add(altRmkId: altRmkId, &fbb)
    OperatingUnitRemark_Abridged.add(name: name, &fbb)
    OperatingUnitRemark_Abridged.add(type: type, &fbb)
    OperatingUnitRemark_Abridged.add(text: text, &fbb)
    OperatingUnitRemark_Abridged.add(code: code, &fbb)
    OperatingUnitRemark_Abridged.add(createdAt: createdAt, &fbb)
    OperatingUnitRemark_Abridged.add(createdBy: createdBy, &fbb)
    OperatingUnitRemark_Abridged.add(source: source, &fbb)
    OperatingUnitRemark_Abridged.add(origin: origin, &fbb)
    OperatingUnitRemark_Abridged.add(dataMode: dataMode, &fbb)
    return OperatingUnitRemark_Abridged.endOperatingUnitRemark_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OperatingUnitRemark_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
