...
public enum LinkStatus_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: LinkStatus_Full_dataMode_Enum { return .exercise }
  public static var min: LinkStatus_Full_dataMode_Enum { return .real }
}


///  /// Captures link status.
public struct LinkStatus_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LinkStatus_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: LinkStatus_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : LinkStatus_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startLinkStatus_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 31) }
  ...
  public static func add(dataMode: LinkStatus_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endLinkStatus_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLinkStatus_Full(
    ...
    let __start = LinkStatus_Full.startLinkStatus_Full(&fbb)
    LinkStatus_Full.add(id: id, &fbb)
    LinkStatus_Full.add(classificationMarking: classificationMarking, &fbb)
    LinkStatus_Full.add(idOnOrbit1: idOnOrbit1, &fbb)
    LinkStatus_Full.add(idOnOrbit2: idOnOrbit2, &fbb)
    LinkStatus_Full.add(linkStartTime: linkStartTime, &fbb)
    LinkStatus_Full.add(linkStopTime: linkStopTime, &fbb)
    LinkStatus_Full.add(constellation: constellation, &fbb)
    LinkStatus_Full.add(linkName: linkName, &fbb)
    LinkStatus_Full.add(linkType: linkType, &fbb)
    LinkStatus_Full.add(band: band, &fbb)
    LinkStatus_Full.add(idBeam1: idBeam1, &fbb)
    LinkStatus_Full.add(endPoint1Name: endPoint1Name, &fbb)
    LinkStatus_Full.add(endPoint1Lat: endPoint1Lat, &fbb)
    LinkStatus_Full.add(endPoint1Lon: endPoint1Lon, &fbb)
    LinkStatus_Full.add(idBeam2: idBeam2, &fbb)
    LinkStatus_Full.add(endPoint2Name: endPoint2Name, &fbb)
    LinkStatus_Full.add(endPoint2Lat: endPoint2Lat, &fbb)
    LinkStatus_Full.add(endPoint2Lon: endPoint2Lon, &fbb)
    LinkStatus_Full.add(dataRate1To2: dataRate1To2, &fbb)
    LinkStatus_Full.add(dataRate2To1: dataRate2To1, &fbb)
    LinkStatus_Full.add(linkState: linkState, &fbb)
    LinkStatus_Full.add(sysCap: sysCap, &fbb)
    LinkStatus_Full.add(opsCap: opsCap, &fbb)
    LinkStatus_Full.add(createdAt: createdAt, &fbb)
    LinkStatus_Full.add(createdBy: createdBy, &fbb)
    LinkStatus_Full.add(source: source, &fbb)
    LinkStatus_Full.add(origin: origin, &fbb)
    LinkStatus_Full.add(origNetwork: origNetwork, &fbb)
    LinkStatus_Full.add(dataMode: dataMode, &fbb)
    LinkStatus_Full.add(satNo1: satNo1, &fbb)
    LinkStatus_Full.add(satNo2: satNo2, &fbb)
    return LinkStatus_Full.endLinkStatus_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: LinkStatus_Full_dataMode_Enum.self)
