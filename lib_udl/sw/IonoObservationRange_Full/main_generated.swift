...
public struct IonoObservationRange_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationRange_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationRange_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationRange_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationRange_Full(
    ...
    let __start = IonoObservationRange_Full.startIonoObservationRange_Full(&fbb)
    IonoObservationRange_Full.add(notes: notes, &fbb)
    IonoObservationRange_Full.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationRange_Full.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationRange_Full.addVectorOf(data: data, &fbb)
    return IonoObservationRange_Full.endIonoObservationRange_Full(&fbb, start: __start)
  }
