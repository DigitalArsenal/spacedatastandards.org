...
public struct AircraftMissionTasking_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AircraftMissionTasking_Ingest.id, addPrefix: prefix) }
  ...
  public static func startAircraftMissionTasking_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 24) }
  ...
  public static func endAircraftMissionTasking_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAircraftMissionTasking_Ingest(
    ...
    let __start = AircraftMissionTasking_Ingest.startAircraftMissionTasking_Ingest(&fbb)
    AircraftMissionTasking_Ingest.add(countryCode: countryCode, &fbb)
    AircraftMissionTasking_Ingest.add(taskedService: taskedService, &fbb)
    AircraftMissionTasking_Ingest.add(unitDesignator: unitDesignator, &fbb)
    AircraftMissionTasking_Ingest.add(unitLocName: unitLocName, &fbb)
    AircraftMissionTasking_Ingest.add(resMsnInd: resMsnInd, &fbb)
    AircraftMissionTasking_Ingest.add(amcMsnNum: amcMsnNum, &fbb)
    AircraftMissionTasking_Ingest.add(pkgId: pkgId, &fbb)
    AircraftMissionTasking_Ingest.add(msnCommander: msnCommander, &fbb)
    AircraftMissionTasking_Ingest.add(msnNum: msnNum, &fbb)
    AircraftMissionTasking_Ingest.add(priMsnType: priMsnType, &fbb)
    AircraftMissionTasking_Ingest.add(secMsnType: secMsnType, &fbb)
    AircraftMissionTasking_Ingest.add(alertStatus: alertStatus, &fbb)
    AircraftMissionTasking_Ingest.add(depLocName: depLocName, &fbb)
    AircraftMissionTasking_Ingest.add(depLocUtm: depLocUtm, &fbb)
    AircraftMissionTasking_Ingest.add(depLocLat: depLocLat, &fbb)
    AircraftMissionTasking_Ingest.add(depLocLon: depLocLon, &fbb)
    AircraftMissionTasking_Ingest.add(depTime: depTime, &fbb)
    AircraftMissionTasking_Ingest.addVectorOf(rcvyLocName: rcvyLocName, &fbb)
    AircraftMissionTasking_Ingest.addVectorOf(rcvyLocUtm: rcvyLocUtm, &fbb)
    AircraftMissionTasking_Ingest.addVectorOf(rcvyLocLat: rcvyLocLat, &fbb)
    AircraftMissionTasking_Ingest.addVectorOf(rcvyLocLon: rcvyLocLon, &fbb)
    AircraftMissionTasking_Ingest.addVectorOf(rcvyTime: rcvyTime, &fbb)
    AircraftMissionTasking_Ingest.addVectorOf(indActasking: indActasking, &fbb)
    AircraftMissionTasking_Ingest.addVectorOf(acMsnLocSeg: acMsnLocSeg, &fbb)
    return AircraftMissionTasking_Ingest.endAircraftMissionTasking_Ingest(&fbb, start: __start)
  }
