...
public enum AirLoadPlan_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AirLoadPlan_Abridged_dataMode_Enum { return .exercise }
  public static var min: AirLoadPlan_Abridged_dataMode_Enum { return .real }
}


///  /// Information related to how an aircraft is loaded with cargo, equipment, and passengers.
public struct AirLoadPlan_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirLoadPlan_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: AirLoadPlan_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AirLoadPlan_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startAirLoadPlan_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 49) }
  ...
  public static func add(dataMode: AirLoadPlan_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endAirLoadPlan_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirLoadPlan_Abridged(
    ...
    let __start = AirLoadPlan_Abridged.startAirLoadPlan_Abridged(&fbb)
    AirLoadPlan_Abridged.add(id: id, &fbb)
    AirLoadPlan_Abridged.add(classificationMarking: classificationMarking, &fbb)
    AirLoadPlan_Abridged.add(externalId: externalId, &fbb)
    AirLoadPlan_Abridged.add(idMission: idMission, &fbb)
    AirLoadPlan_Abridged.add(missionNumber: missionNumber, &fbb)
    AirLoadPlan_Abridged.add(idSortie: idSortie, &fbb)
    AirLoadPlan_Abridged.add(legNum: legNum, &fbb)
    AirLoadPlan_Abridged.add(callSign: callSign, &fbb)
    AirLoadPlan_Abridged.add(tailNumber: tailNumber, &fbb)
    AirLoadPlan_Abridged.add(aircraftMds: aircraftMds, &fbb)
    AirLoadPlan_Abridged.add(depIcao: depIcao, &fbb)
    AirLoadPlan_Abridged.add(depAirfield: depAirfield, &fbb)
    AirLoadPlan_Abridged.add(estDepTime: estDepTime, &fbb)
    AirLoadPlan_Abridged.add(arrIcao: arrIcao, &fbb)
    AirLoadPlan_Abridged.add(arrAirfield: arrAirfield, &fbb)
    AirLoadPlan_Abridged.add(estArrTime: estArrTime, &fbb)
    AirLoadPlan_Abridged.add(crewSize: crewSize, &fbb)
    AirLoadPlan_Abridged.add(cargoConfig: cargoConfig, &fbb)
    AirLoadPlan_Abridged.add(equipConfig: equipConfig, &fbb)
    AirLoadPlan_Abridged.add(tankConfig: tankConfig, &fbb)
    AirLoadPlan_Abridged.add(basicWeight: basicWeight, &fbb)
    AirLoadPlan_Abridged.add(basicMoment: basicMoment, &fbb)
    AirLoadPlan_Abridged.add(fuelWeight: fuelWeight, &fbb)
    AirLoadPlan_Abridged.add(fuelMoment: fuelMoment, &fbb)
    AirLoadPlan_Abridged.add(estLandingFuelWeight: estLandingFuelWeight, &fbb)
    AirLoadPlan_Abridged.add(estLandingFuelMoment: estLandingFuelMoment, &fbb)
    AirLoadPlan_Abridged.add(operatingWeight: operatingWeight, &fbb)
    AirLoadPlan_Abridged.add(operatingMoment: operatingMoment, &fbb)
    AirLoadPlan_Abridged.add(cargoWeight: cargoWeight, &fbb)
    AirLoadPlan_Abridged.add(cargoMoment: cargoMoment, &fbb)
    AirLoadPlan_Abridged.add(zeroFuelWeight: zeroFuelWeight, &fbb)
    AirLoadPlan_Abridged.add(zeroFuelMoment: zeroFuelMoment, &fbb)
    AirLoadPlan_Abridged.add(zeroFuelCg: zeroFuelCg, &fbb)
    AirLoadPlan_Abridged.add(grossWeight: grossWeight, &fbb)
    AirLoadPlan_Abridged.add(grossMoment: grossMoment, &fbb)
    AirLoadPlan_Abridged.add(grossCg: grossCg, &fbb)
    AirLoadPlan_Abridged.add(landingWeight: landingWeight, &fbb)
    AirLoadPlan_Abridged.add(landingMoment: landingMoment, &fbb)
    AirLoadPlan_Abridged.add(landingCg: landingCg, &fbb)
    AirLoadPlan_Abridged.add(cargoBayFsmin: cargoBayFsmin, &fbb)
    AirLoadPlan_Abridged.add(cargoBayFsmax: cargoBayFsmax, &fbb)
    AirLoadPlan_Abridged.add(cargoBayWidth: cargoBayWidth, &fbb)
    AirLoadPlan_Abridged.add(createdAt: createdAt, &fbb)
    AirLoadPlan_Abridged.add(createdBy: createdBy, &fbb)
    AirLoadPlan_Abridged.add(sourceDl: sourceDl, &fbb)
    AirLoadPlan_Abridged.add(source: source, &fbb)
    AirLoadPlan_Abridged.add(origin: origin, &fbb)
    AirLoadPlan_Abridged.add(origNetwork: origNetwork, &fbb)
    AirLoadPlan_Abridged.add(dataMode: dataMode, &fbb)
    return AirLoadPlan_Abridged.endAirLoadPlan_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AirLoadPlan_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
