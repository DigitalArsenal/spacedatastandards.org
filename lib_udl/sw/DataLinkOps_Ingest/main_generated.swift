...
public struct DataLinkOps_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DataLinkOps_Ingest.id, addPrefix: prefix) }
  ...
  public static func startDataLinkOps_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endDataLinkOps_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDataLinkOps_Ingest(
    ...
    let __start = DataLinkOps_Ingest.startDataLinkOps_Ingest(&fbb)
    DataLinkOps_Ingest.add(linkName: linkName, &fbb)
    DataLinkOps_Ingest.add(linkStartTime: linkStartTime, &fbb)
    DataLinkOps_Ingest.add(linkStopTime: linkStopTime, &fbb)
    DataLinkOps_Ingest.add(linkStopTimeMod: linkStopTimeMod, &fbb)
    DataLinkOps_Ingest.add(linkDetails: linkDetails, &fbb)
    return DataLinkOps_Ingest.endDataLinkOps_Ingest(&fbb, start: __start)
  }
