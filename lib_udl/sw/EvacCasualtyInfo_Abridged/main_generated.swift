...
public struct EvacCasualtyInfo_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacCasualtyInfo_Abridged.id, addPrefix: prefix) }
  ...
  public static func startEvacCasualtyInfo_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 35) }
  ...
  public static func endEvacCasualtyInfo_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacCasualtyInfo_Abridged(
    ...
    let __start = EvacCasualtyInfo_Abridged.startEvacCasualtyInfo_Abridged(&fbb)
    EvacCasualtyInfo_Abridged.add(priority: priority, &fbb)
    EvacCasualtyInfo_Abridged.add(evacType: evacType, &fbb)
    EvacCasualtyInfo_Abridged.add(casualtyType: casualtyType, &fbb)
    EvacCasualtyInfo_Abridged.add(bodyPart: bodyPart, &fbb)
    EvacCasualtyInfo_Abridged.add(contamType: contamType, &fbb)
    EvacCasualtyInfo_Abridged.addVectorOf(specMedEquip: specMedEquip, &fbb)
    EvacCasualtyInfo_Abridged.add(casualtyKey: casualtyKey, &fbb)
    EvacCasualtyInfo_Abridged.add(patientStatus: patientStatus, &fbb)
    EvacCasualtyInfo_Abridged.add(patientIdentity: patientIdentity, &fbb)
    EvacCasualtyInfo_Abridged.add(nationality: nationality, &fbb)
    EvacCasualtyInfo_Abridged.add(payGrade: payGrade, &fbb)
    EvacCasualtyInfo_Abridged.add(name: name, &fbb)
    EvacCasualtyInfo_Abridged.add(age: age, &fbb)
    EvacCasualtyInfo_Abridged.add(gender: gender, &fbb)
    EvacCasualtyInfo_Abridged.add(last4Ssn: last4Ssn, &fbb)
    EvacCasualtyInfo_Abridged.add(bloodType: bloodType, &fbb)
    EvacCasualtyInfo_Abridged.add(service: service, &fbb)
    EvacCasualtyInfo_Abridged.add(callSign: callSign, &fbb)
    EvacCasualtyInfo_Abridged.add(occSpeciality: occSpeciality, &fbb)
    EvacCasualtyInfo_Abridged.addVectorOf(burialLocation: burialLocation, &fbb)
    EvacCasualtyInfo_Abridged.addVectorOf(collectionPoint: collectionPoint, &fbb)
    EvacCasualtyInfo_Abridged.add(careProviderUrn: careProviderUrn, &fbb)
    EvacCasualtyInfo_Abridged.add(dispositionType: dispositionType, &fbb)
    EvacCasualtyInfo_Abridged.add(disposition: disposition, &fbb)
    EvacCasualtyInfo_Abridged.add(reportGen: reportGen, &fbb)
    EvacCasualtyInfo_Abridged.add(reportTime: reportTime, &fbb)
    EvacCasualtyInfo_Abridged.add(comments: comments, &fbb)
    EvacCasualtyInfo_Abridged.addVectorOf(etiology: etiology, &fbb)
    EvacCasualtyInfo_Abridged.addVectorOf(treatment: treatment, &fbb)
    EvacCasualtyInfo_Abridged.addVectorOf(vitalSignData: vitalSignData, &fbb)
    EvacCasualtyInfo_Abridged.addVectorOf(healthState: healthState, &fbb)
    EvacCasualtyInfo_Abridged.addVectorOf(condition: condition, &fbb)
    EvacCasualtyInfo_Abridged.addVectorOf(medication: medication, &fbb)
    EvacCasualtyInfo_Abridged.addVectorOf(injury: injury, &fbb)
    EvacCasualtyInfo_Abridged.addVectorOf(allergy: allergy, &fbb)
    return EvacCasualtyInfo_Abridged.endEvacCasualtyInfo_Abridged(&fbb, start: __start)
  }
