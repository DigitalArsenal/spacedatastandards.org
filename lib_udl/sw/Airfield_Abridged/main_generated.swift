...
public enum Airfield_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Airfield_Abridged_dataMode_Enum { return .exercise }
  public static var min: Airfield_Abridged_dataMode_Enum { return .real }
}


///  /// Properties and characteristics of an airfield, which includes location, airfield codes, suitability codes, and remarks.
public struct Airfield_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Airfield_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Airfield_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Airfield_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startAirfield_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 35) }
  ...
  public static func add(dataMode: Airfield_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endAirfield_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirfield_Abridged(
    ...
    let __start = Airfield_Abridged.startAirfield_Abridged(&fbb)
    Airfield_Abridged.add(id: id, &fbb)
    Airfield_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Airfield_Abridged.add(idSite: idSite, &fbb)
    Airfield_Abridged.add(altAirfieldId: altAirfieldId, &fbb)
    Airfield_Abridged.add(wacInnr: wacInnr, &fbb)
    Airfield_Abridged.add(zarId: zarId, &fbb)
    Airfield_Abridged.add(icao: icao, &fbb)
    Airfield_Abridged.add(iata: iata, &fbb)
    Airfield_Abridged.add(faa: faa, &fbb)
    Airfield_Abridged.add(hostNatCode: hostNatCode, &fbb)
    Airfield_Abridged.add(name: name, &fbb)
    Airfield_Abridged.add(type: type, &fbb)
    Airfield_Abridged.add(lat: lat, &fbb)
    Airfield_Abridged.add(lon: lon, &fbb)
    Airfield_Abridged.add(elevFt: elevFt, &fbb)
    Airfield_Abridged.add(elevM: elevM, &fbb)
    Airfield_Abridged.add(magDec: magDec, &fbb)
    Airfield_Abridged.add(regionName: regionName, &fbb)
    Airfield_Abridged.add(countryCode: countryCode, &fbb)
    Airfield_Abridged.add(city: city, &fbb)
    Airfield_Abridged.add(state: state, &fbb)
    Airfield_Abridged.add(geoloc: geoloc, &fbb)
    Airfield_Abridged.add(gmtOffset: gmtOffset, &fbb)
    Airfield_Abridged.add(suitabilityCodes: suitabilityCodes, &fbb)
    Airfield_Abridged.add(miscCodes: miscCodes, &fbb)
    Airfield_Abridged.add(runways: runways, &fbb)
    Airfield_Abridged.add(maxRunwayLength: maxRunwayLength, &fbb)
    Airfield_Abridged.add(infoUrl: infoUrl, &fbb)
    Airfield_Abridged.add(createdAt: createdAt, &fbb)
    Airfield_Abridged.add(createdBy: createdBy, &fbb)
    Airfield_Abridged.add(sourceDl: sourceDl, &fbb)
    Airfield_Abridged.add(source: source, &fbb)
    Airfield_Abridged.add(origin: origin, &fbb)
    Airfield_Abridged.add(origNetwork: origNetwork, &fbb)
    Airfield_Abridged.add(dataMode: dataMode, &fbb)
    return Airfield_Abridged.endAirfield_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Airfield_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
