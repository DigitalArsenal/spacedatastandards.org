...
public enum LinkStatus_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: LinkStatus_Abridged_dataMode_Enum { return .exercise }
  public static var min: LinkStatus_Abridged_dataMode_Enum { return .real }
}


///  /// Captures link status.
public struct LinkStatus_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LinkStatus_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: LinkStatus_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : LinkStatus_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startLinkStatus_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 31) }
  ...
  public static func add(dataMode: LinkStatus_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endLinkStatus_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLinkStatus_Abridged(
    ...
    let __start = LinkStatus_Abridged.startLinkStatus_Abridged(&fbb)
    LinkStatus_Abridged.add(id: id, &fbb)
    LinkStatus_Abridged.add(classificationMarking: classificationMarking, &fbb)
    LinkStatus_Abridged.add(idOnOrbit1: idOnOrbit1, &fbb)
    LinkStatus_Abridged.add(idOnOrbit2: idOnOrbit2, &fbb)
    LinkStatus_Abridged.add(linkStartTime: linkStartTime, &fbb)
    LinkStatus_Abridged.add(linkStopTime: linkStopTime, &fbb)
    LinkStatus_Abridged.add(constellation: constellation, &fbb)
    LinkStatus_Abridged.add(linkName: linkName, &fbb)
    LinkStatus_Abridged.add(linkType: linkType, &fbb)
    LinkStatus_Abridged.add(band: band, &fbb)
    LinkStatus_Abridged.add(idBeam1: idBeam1, &fbb)
    LinkStatus_Abridged.add(endPoint1Name: endPoint1Name, &fbb)
    LinkStatus_Abridged.add(endPoint1Lat: endPoint1Lat, &fbb)
    LinkStatus_Abridged.add(endPoint1Lon: endPoint1Lon, &fbb)
    LinkStatus_Abridged.add(idBeam2: idBeam2, &fbb)
    LinkStatus_Abridged.add(endPoint2Name: endPoint2Name, &fbb)
    LinkStatus_Abridged.add(endPoint2Lat: endPoint2Lat, &fbb)
    LinkStatus_Abridged.add(endPoint2Lon: endPoint2Lon, &fbb)
    LinkStatus_Abridged.add(dataRate1To2: dataRate1To2, &fbb)
    LinkStatus_Abridged.add(dataRate2To1: dataRate2To1, &fbb)
    LinkStatus_Abridged.add(linkState: linkState, &fbb)
    LinkStatus_Abridged.add(sysCap: sysCap, &fbb)
    LinkStatus_Abridged.add(opsCap: opsCap, &fbb)
    LinkStatus_Abridged.add(createdAt: createdAt, &fbb)
    LinkStatus_Abridged.add(createdBy: createdBy, &fbb)
    LinkStatus_Abridged.add(source: source, &fbb)
    LinkStatus_Abridged.add(origin: origin, &fbb)
    LinkStatus_Abridged.add(origNetwork: origNetwork, &fbb)
    LinkStatus_Abridged.add(dataMode: dataMode, &fbb)
    LinkStatus_Abridged.add(satNo1: satNo1, &fbb)
    LinkStatus_Abridged.add(satNo2: satNo2, &fbb)
    return LinkStatus_Abridged.endLinkStatus_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: LinkStatus_Abridged_dataMode_Enum.self)
