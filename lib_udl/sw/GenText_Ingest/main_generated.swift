...
public struct GenText_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: GenText_Ingest.id, addPrefix: prefix) }
  ...
  public static func startGenText_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 2) }
  ...
  public static func endGenText_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createGenText_Ingest(
    _ fbb: inout FlatBufferBuilder,
    textIndOffset textInd: Offset = Offset(),
    textOffset text: Offset = Offset()
  ) -> Offset {
    let __start = GenText_Ingest.startGenText_Ingest(&fbb)
    GenText_Ingest.add(textInd: textInd, &fbb)
    GenText_Ingest.add(text: text, &fbb)
    return GenText_Ingest.endGenText_Ingest(&fbb, start: __start)
  }
