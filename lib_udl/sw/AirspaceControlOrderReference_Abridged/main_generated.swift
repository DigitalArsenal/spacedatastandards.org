...
public struct AirspaceControlOrderReference_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirspaceControlOrderReference_Abridged.id, addPrefix: prefix) }
  ...
  public static func startAirspaceControlOrderReference_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 7) }
  ...
  public static func endAirspaceControlOrderReference_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirspaceControlOrderReference_Abridged(
    ...
    let __start = AirspaceControlOrderReference_Abridged.startAirspaceControlOrderReference_Abridged(&fbb)
    AirspaceControlOrderReference_Abridged.add(refSid: refSid, &fbb)
    AirspaceControlOrderReference_Abridged.add(refType: refType, &fbb)
    AirspaceControlOrderReference_Abridged.add(refOriginator: refOriginator, &fbb)
    AirspaceControlOrderReference_Abridged.add(refTs: refTs, &fbb)
    AirspaceControlOrderReference_Abridged.add(refSerialNum: refSerialNum, &fbb)
    AirspaceControlOrderReference_Abridged.add(refSpecialNotation: refSpecialNotation, &fbb)
    AirspaceControlOrderReference_Abridged.addVectorOf(refSics: refSics, &fbb)
    return AirspaceControlOrderReference_Abridged.endAirspaceControlOrderReference_Abridged(&fbb, start: __start)
  }
