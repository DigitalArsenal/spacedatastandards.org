...
public struct IonoObservationTime_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationTime_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationTime_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationTime_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationTime_Ingest(
    ...
    let __start = IonoObservationTime_Ingest.startIonoObservationTime_Ingest(&fbb)
    IonoObservationTime_Ingest.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationTime_Ingest.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationTime_Ingest.add(notes: notes, &fbb)
    IonoObservationTime_Ingest.addVectorOf(data: data, &fbb)
    return IonoObservationTime_Ingest.endIonoObservationTime_Ingest(&fbb, start: __start)
  }
