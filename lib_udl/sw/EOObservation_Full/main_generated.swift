...
public enum EOObservation_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: EOObservation_Full_dataMode_Enum { return .exercise }
  public static var min: EOObservation_Full_dataMode_Enum { return .real }
}


public enum EOObservation_Full_referenceFrame_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: EOObservation_Full_referenceFrame_Enum { return .teme }
  public static var min: EOObservation_Full_referenceFrame_Enum { return .j2000 }
}


public enum EOObservation_Full_senReferenceFrame_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: EOObservation_Full_senReferenceFrame_Enum { return .gcrf }
  public static var min: EOObservation_Full_senReferenceFrame_Enum { return .j2000 }
}
...
public struct EOObservation_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EOObservation_Full.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case onOrbit = 176
    case referenceFrame = 178
    case senReferenceFrame = 180
    case umbra = 182
    case penumbra = 184
  ...
  public var dataMode: EOObservation_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : EOObservation_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 24
  public var referenceFrame: EOObservation_Full_referenceFrame_Enum { let o = _accessor.offset(VTOFFSET.referenceFrame.v); return o == 0 ? .j2000 : EOObservation_Full_referenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ///  The reference frame of the observing sensor state. If the senReferenceFrame is null it is assumed to be J2000.
  ///  Example: /// Example: J2000
  ///  Constraints: Minimum length = 0, Maximum length = 24
  public var senReferenceFrame: EOObservation_Full_senReferenceFrame_Enum { let o = _accessor.offset(VTOFFSET.senReferenceFrame.v); return o == 0 ? .j2000 : EOObservation_Full_senReferenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ...
  public static func startEOObservation_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 94) }
  ...
  public static func add(dataMode: EOObservation_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func add(referenceFrame: EOObservation_Full_referenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: referenceFrame.rawValue, def: 0, at: VTOFFSET.referenceFrame.p) }
  public static func add(senReferenceFrame: EOObservation_Full_senReferenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: senReferenceFrame.rawValue, def: 0, at: VTOFFSET.senReferenceFrame.p) }
  ...
  public static func endEOObservation_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEOObservation_Full(
    ...
    let __start = EOObservation_Full.startEOObservation_Full(&fbb)
    EOObservation_Full.add(id: id, &fbb)
    EOObservation_Full.add(classificationMarking: classificationMarking, &fbb)
    EOObservation_Full.add(obTime: obTime, &fbb)
    EOObservation_Full.add(corrQuality: corrQuality, &fbb)
    EOObservation_Full.add(idOnOrbit: idOnOrbit, &fbb)
    EOObservation_Full.add(idSensor: idSensor, &fbb)
    EOObservation_Full.add(idSkyImagery: idSkyImagery, &fbb)
    EOObservation_Full.add(collectMethod: collectMethod, &fbb)
    EOObservation_Full.add(satNo: satNo, &fbb)
    EOObservation_Full.add(taskId: taskId, &fbb)
    EOObservation_Full.add(transactionId: transactionId, &fbb)
    EOObservation_Full.add(trackId: trackId, &fbb)
    EOObservation_Full.add(obPosition: obPosition, &fbb)
    EOObservation_Full.add(origObjectId: origObjectId, &fbb)
    EOObservation_Full.add(origSensorId: origSensorId, &fbb)
    EOObservation_Full.add(uct: uct, &fbb)
    EOObservation_Full.add(azimuth: azimuth, &fbb)
    EOObservation_Full.add(azimuthUnc: azimuthUnc, &fbb)
    EOObservation_Full.add(azimuthBias: azimuthBias, &fbb)
    EOObservation_Full.add(azimuthRate: azimuthRate, &fbb)
    EOObservation_Full.add(elevation: elevation, &fbb)
    EOObservation_Full.add(elevationUnc: elevationUnc, &fbb)
    EOObservation_Full.add(elevationBias: elevationBias, &fbb)
    EOObservation_Full.add(elevationRate: elevationRate, &fbb)
    EOObservation_Full.add(range: range, &fbb)
    EOObservation_Full.add(rangeUnc: rangeUnc, &fbb)
    EOObservation_Full.add(rangeBias: rangeBias, &fbb)
    EOObservation_Full.add(rangeRate: rangeRate, &fbb)
    EOObservation_Full.add(rangeRateUnc: rangeRateUnc, &fbb)
    EOObservation_Full.add(ra: ra, &fbb)
    EOObservation_Full.add(raRate: raRate, &fbb)
    EOObservation_Full.add(raUnc: raUnc, &fbb)
    EOObservation_Full.add(raBias: raBias, &fbb)
    EOObservation_Full.add(declination: declination, &fbb)
    EOObservation_Full.add(declinationRate: declinationRate, &fbb)
    EOObservation_Full.add(declinationUnc: declinationUnc, &fbb)
    EOObservation_Full.add(declinationBias: declinationBias, &fbb)
    EOObservation_Full.add(losx: losx, &fbb)
    EOObservation_Full.add(losy: losy, &fbb)
    EOObservation_Full.add(losz: losz, &fbb)
    EOObservation_Full.add(losUnc: losUnc, &fbb)
    EOObservation_Full.add(losxvel: losxvel, &fbb)
    EOObservation_Full.add(losyvel: losyvel, &fbb)
    EOObservation_Full.add(loszvel: loszvel, &fbb)
    EOObservation_Full.add(senlat: senlat, &fbb)
    EOObservation_Full.add(senlon: senlon, &fbb)
    EOObservation_Full.add(senalt: senalt, &fbb)
    EOObservation_Full.add(senx: senx, &fbb)
    EOObservation_Full.add(seny: seny, &fbb)
    EOObservation_Full.add(senz: senz, &fbb)
    EOObservation_Full.add(senvelx: senvelx, &fbb)
    EOObservation_Full.add(senvely: senvely, &fbb)
    EOObservation_Full.add(senvelz: senvelz, &fbb)
    EOObservation_Full.addVectorOf(senQuat: senQuat, &fbb)
    EOObservation_Full.add(fovCount: fovCount, &fbb)
    EOObservation_Full.add(expDuration: expDuration, &fbb)
    EOObservation_Full.add(zeroptd: zeroptd, &fbb)
    EOObservation_Full.add(netObjSig: netObjSig, &fbb)
    EOObservation_Full.add(netObjSigUnc: netObjSigUnc, &fbb)
    EOObservation_Full.add(mag: mag, &fbb)
    EOObservation_Full.add(magUnc: magUnc, &fbb)
    EOObservation_Full.add(magNormRange: magNormRange, &fbb)
    EOObservation_Full.add(geolat: geolat, &fbb)
    EOObservation_Full.add(geolon: geolon, &fbb)
    EOObservation_Full.add(geoalt: geoalt, &fbb)
    EOObservation_Full.add(georange: georange, &fbb)
    EOObservation_Full.add(skyBkgrnd: skyBkgrnd, &fbb)
    EOObservation_Full.add(primaryExtinction: primaryExtinction, &fbb)
    EOObservation_Full.add(primaryExtinctionUnc: primaryExtinctionUnc, &fbb)
    EOObservation_Full.add(solarPhaseAngle: solarPhaseAngle, &fbb)
    EOObservation_Full.add(solarEqPhaseAngle: solarEqPhaseAngle, &fbb)
    EOObservation_Full.add(solarDecAngle: solarDecAngle, &fbb)
    EOObservation_Full.add(shutterDelay: shutterDelay, &fbb)
    EOObservation_Full.add(timingBias: timingBias, &fbb)
    EOObservation_Full.add(rawFileUri: rawFileUri, &fbb)
    EOObservation_Full.add(intensity: intensity, &fbb)
    EOObservation_Full.add(bgIntensity: bgIntensity, &fbb)
    EOObservation_Full.add(descriptor: descriptor, &fbb)
    EOObservation_Full.add(source: source, &fbb)
    EOObservation_Full.add(origin: origin, &fbb)
    EOObservation_Full.add(dataMode: dataMode, &fbb)
    EOObservation_Full.addVectorOf(tags: tags, &fbb)
    EOObservation_Full.add(createdAt: createdAt, &fbb)
    EOObservation_Full.add(createdBy: createdBy, &fbb)
    EOObservation_Full.add(zeroPtdUnc: zeroPtdUnc, &fbb)
    EOObservation_Full.add(eoobservationDetails: eoobservationDetails, &fbb)
    EOObservation_Full.add(onOrbit: onOrbit, &fbb)
    EOObservation_Full.add(referenceFrame: referenceFrame, &fbb)
    EOObservation_Full.add(senReferenceFrame: senReferenceFrame, &fbb)
    EOObservation_Full.add(umbra: umbra, &fbb)
    EOObservation_Full.add(penumbra: penumbra, &fbb)
    EOObservation_Full.add(origNetwork: origNetwork, &fbb)
    EOObservation_Full.add(sourceDl: sourceDl, &fbb)
    EOObservation_Full.add(type: type, &fbb)
    return EOObservation_Full.endEOObservation_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: EOObservation_Full_dataMode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.referenceFrame.p, fieldName: "referenceFrame", required: false, type: EOObservation_Full_referenceFrame_Enum.self)
    try _v.visit(field: VTOFFSET.senReferenceFrame.p, fieldName: "senReferenceFrame", required: false, type: EOObservation_Full_senReferenceFrame_Enum.self)
