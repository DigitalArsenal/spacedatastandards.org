...
public enum SeradataEarlyWarning_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SeradataEarlyWarning_Abridged_dataMode_Enum { return .exercise }
  public static var min: SeradataEarlyWarning_Abridged_dataMode_Enum { return .real }
}


///  /// Details for an early warning payload from  Seradata.
public struct SeradataEarlyWarning_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SeradataEarlyWarning_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: SeradataEarlyWarning_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SeradataEarlyWarning_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSeradataEarlyWarning_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 22) }
  ...
  public static func add(dataMode: SeradataEarlyWarning_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSeradataEarlyWarning_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSeradataEarlyWarning_Abridged(
    ...
    let __start = SeradataEarlyWarning_Abridged.startSeradataEarlyWarning_Abridged(&fbb)
    SeradataEarlyWarning_Abridged.add(id: id, &fbb)
    SeradataEarlyWarning_Abridged.add(classificationMarking: classificationMarking, &fbb)
    SeradataEarlyWarning_Abridged.add(idIr: idIr, &fbb)
    SeradataEarlyWarning_Abridged.add(spacecraftId: spacecraftId, &fbb)
    SeradataEarlyWarning_Abridged.add(hostedForCompanyOrgId: hostedForCompanyOrgId, &fbb)
    SeradataEarlyWarning_Abridged.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    SeradataEarlyWarning_Abridged.add(name: name, &fbb)
    SeradataEarlyWarning_Abridged.add(spectralBands: spectralBands, &fbb)
    SeradataEarlyWarning_Abridged.add(frequencyLimits: frequencyLimits, &fbb)
    SeradataEarlyWarning_Abridged.add(bestResolution: bestResolution, &fbb)
    SeradataEarlyWarning_Abridged.add(groundStations: groundStations, &fbb)
    SeradataEarlyWarning_Abridged.add(groundStationLocations: groundStationLocations, &fbb)
    SeradataEarlyWarning_Abridged.add(missileLaunchPhaseDetectionAbility: missileLaunchPhaseDetectionAbility, &fbb)
    SeradataEarlyWarning_Abridged.add(earthPointing: earthPointing, &fbb)
    SeradataEarlyWarning_Abridged.add(partnerSpacecraftId: partnerSpacecraftId, &fbb)
    SeradataEarlyWarning_Abridged.add(payloadNotes: payloadNotes, &fbb)
    SeradataEarlyWarning_Abridged.add(createdAt: createdAt, &fbb)
    SeradataEarlyWarning_Abridged.add(createdBy: createdBy, &fbb)
    SeradataEarlyWarning_Abridged.add(source: source, &fbb)
    SeradataEarlyWarning_Abridged.add(origin: origin, &fbb)
    SeradataEarlyWarning_Abridged.add(origNetwork: origNetwork, &fbb)
    SeradataEarlyWarning_Abridged.add(dataMode: dataMode, &fbb)
    return SeradataEarlyWarning_Abridged.endSeradataEarlyWarning_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SeradataEarlyWarning_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
