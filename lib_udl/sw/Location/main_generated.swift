...
public enum Location_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Location_dataMode_Enum { return .exercise }
  public static var min: Location_dataMode_Enum { return .real }
}
...
public struct Location: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Location.id, addPrefix: prefix) }
  ...
  public var dataMode: Location_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Location_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: OPS1
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startLocation(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 15) }
  ...
  public static func add(dataMode: Location_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endLocation(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLocation(
    ...
    let __start = Location.startLocation(&fbb)
    Location.add(idLocation: idLocation, &fbb)
    Location.add(classificationMarking: classificationMarking, &fbb)
    Location.add(name: name, &fbb)
    Location.add(countryCode: countryCode, &fbb)
    Location.add(lat: lat, &fbb)
    Location.add(lon: lon, &fbb)
    Location.add(altitude: altitude, &fbb)
    Location.add(createdAt: createdAt, &fbb)
    Location.add(createdBy: createdBy, &fbb)
    Location.add(updatedAt: updatedAt, &fbb)
    Location.add(updatedBy: updatedBy, &fbb)
    Location.add(source: source, &fbb)
    Location.add(origin: origin, &fbb)
    Location.add(dataMode: dataMode, &fbb)
    Location.add(origNetwork: origNetwork, &fbb)
    return Location.endLocation(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Location_dataMode_Enum.self)
