...
public enum SGI_Ingest_state_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SGI_Ingest_state_Enum { return .p }
  public static var min: SGI_Ingest_state_Enum { return .i }
}


public enum SGI_Ingest_precedence_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: SGI_Ingest_precedence_Enum { return .z }
  public static var min: SGI_Ingest_precedence_Enum { return .o }
}


public enum SGI_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: SGI_Ingest_dataMode_Enum { return .exercise }
  public static var min: SGI_Ingest_dataMode_Enum { return .real }
}


///  /// Model representation of space weather/solar, geomagnetic, and radiation belt indices.
public struct SGI_Ingest: FlatBufferObject, Verifiable {

  static func validateVersion() { FlatBuffersVersion_24_3_25() }
  public var __buffer: ByteBuffer! { return _accessor.bb }
  private var _accessor: Table

  public static var id: String { "SGII" } 
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SGI_Ingest.id, addPrefix: prefix) }
  ...
  public var state: SGI_Ingest_state_Enum { let o = _accessor.offset(VTOFFSET.state.v); return o == 0 ? .i : SGI_Ingest_state_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .i }
  ...
  ///  Example: /// Example: R
  ///  Constraints: Minimum length = 0, Maximum length = 1
  public var precedence_: SGI_Ingest_precedence_Enum { let o = _accessor.offset(VTOFFSET.precedence_.v); return o == 0 ? .o : SGI_Ingest_precedence_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .o }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SGI_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SGI_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startSGI_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 53) }
  ...
  public static func add(state: SGI_Ingest_state_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: state.rawValue, def: 0, at: VTOFFSET.state.p) }
  ...
  public static func add(precedence_: SGI_Ingest_precedence_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: precedence_.rawValue, def: 0, at: VTOFFSET.precedence_.p) }
  ...
  public static func add(dataMode: SGI_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func endSGI_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSGI_Ingest(
    ...
    mode: Int32 = 0,
    precedence_: SGI_Ingest_precedence_Enum = .o,
    ...
    let __start = SGI_Ingest.startSGI_Ingest(&fbb)
    SGI_Ingest.add(id: id, &fbb)
    SGI_Ingest.add(classificationMarking: classificationMarking, &fbb)
    SGI_Ingest.add(effectiveDate: effectiveDate, &fbb)
    SGI_Ingest.add(sgiDate: sgiDate, &fbb)
    SGI_Ingest.add(type: type, &fbb)
    SGI_Ingest.add(state: state, &fbb)
    SGI_Ingest.add(stationName: stationName, &fbb)
    SGI_Ingest.add(idSensor: idSensor, &fbb)
    SGI_Ingest.add(origSensorId: origSensorId, &fbb)
    SGI_Ingest.add(mode: mode, &fbb)
    SGI_Ingest.add(precedence_: precedence_, &fbb)
    SGI_Ingest.addVectorOf(coeffDegree: coeffDegree, &fbb)
    SGI_Ingest.addVectorOf(coeffOrder: coeffOrder, &fbb)
    SGI_Ingest.addVectorOf(ctce: ctce, &fbb)
    SGI_Ingest.addVectorOf(stce: stce, &fbb)
    SGI_Ingest.addVectorOf(ctci: ctci, &fbb)
    SGI_Ingest.addVectorOf(stci: stci, &fbb)
    SGI_Ingest.add(e10: e10, &fbb)
    SGI_Ingest.add(e54: e54, &fbb)
    SGI_Ingest.add(s10: s10, &fbb)
    SGI_Ingest.add(s54: s54, &fbb)
    SGI_Ingest.add(m10: m10, &fbb)
    SGI_Ingest.add(m54: m54, &fbb)
    SGI_Ingest.add(y10: y10, &fbb)
    SGI_Ingest.add(y54: y54, &fbb)
    SGI_Ingest.add(f10: f10, &fbb)
    SGI_Ingest.add(f54: f54, &fbb)
    SGI_Ingest.add(f81: f81, &fbb)
    SGI_Ingest.add(ap: ap, &fbb)
    SGI_Ingest.add(apDuration: apDuration, &fbb)
    SGI_Ingest.add(kIndex: kIndex, &fbb)
    SGI_Ingest.add(kp: kp, &fbb)
    SGI_Ingest.add(kpDuration: kpDuration, &fbb)
    SGI_Ingest.add(gamma: gamma, &fbb)
    SGI_Ingest.add(dst: dst, &fbb)
    SGI_Ingest.add(dtc: dtc, &fbb)
    SGI_Ingest.add(rbRegionCode: rbRegionCode, &fbb)
    SGI_Ingest.add(rbIndex: rbIndex, &fbb)
    SGI_Ingest.add(normFactor: normFactor, &fbb)
    SGI_Ingest.add(rbDuration: rbDuration, &fbb)
    SGI_Ingest.add(analyzerAttenuation: analyzerAttenuation, &fbb)
    SGI_Ingest.addVectorOf(observedBaseline: observedBaseline, &fbb)
    SGI_Ingest.addVectorOf(frequencies: frequencies, &fbb)
    SGI_Ingest.addVectorOf(powers: powers, &fbb)
    SGI_Ingest.add(rawFileUri: rawFileUri, &fbb)
    SGI_Ingest.add(transactionId: transactionId, &fbb)
    SGI_Ingest.addVectorOf(tags: tags, &fbb)
    SGI_Ingest.add(source: source, &fbb)
    SGI_Ingest.add(origin: origin, &fbb)
    SGI_Ingest.add(origNetwork: origNetwork, &fbb)
    SGI_Ingest.add(dataMode: dataMode, &fbb)
    SGI_Ingest.add(createdAt: createdAt, &fbb)
    SGI_Ingest.add(createdBy: createdBy, &fbb)
    return SGI_Ingest.endSGI_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.state.p, fieldName: "state", required: false, type: SGI_Ingest_state_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.precedence_.p, fieldName: "precedence_", required: false, type: SGI_Ingest_precedence_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SGI_Ingest_dataMode_Enum.self)
