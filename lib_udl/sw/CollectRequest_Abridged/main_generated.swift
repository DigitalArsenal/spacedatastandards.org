...
public enum CollectRequest_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: CollectRequest_Abridged_dataMode_Enum { return .exercise }
  public static var min: CollectRequest_Abridged_dataMode_Enum { return .real }
}
...
public struct CollectRequest_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: CollectRequest_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: CollectRequest_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : CollectRequest_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startCollectRequest_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 87) }
  ...
  public static func add(dataMode: CollectRequest_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endCollectRequest_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createCollectRequest_Abridged(
    ...
    let __start = CollectRequest_Abridged.startCollectRequest_Abridged(&fbb)
    CollectRequest_Abridged.add(id: id, &fbb)
    CollectRequest_Abridged.add(classificationMarking: classificationMarking, &fbb)
    CollectRequest_Abridged.add(idParentReq: idParentReq, &fbb)
    CollectRequest_Abridged.add(msgType: msgType, &fbb)
    CollectRequest_Abridged.add(msgCreateDate: msgCreateDate, &fbb)
    CollectRequest_Abridged.add(type: type, &fbb)
    CollectRequest_Abridged.add(idPlan: idPlan, &fbb)
    CollectRequest_Abridged.add(planIndex: planIndex, &fbb)
    CollectRequest_Abridged.add(taskId: taskId, &fbb)
    CollectRequest_Abridged.add(dwellId: dwellId, &fbb)
    CollectRequest_Abridged.add(externalId: externalId, &fbb)
    CollectRequest_Abridged.add(idSensor: idSensor, &fbb)
    CollectRequest_Abridged.add(origSensorId: origSensorId, &fbb)
    CollectRequest_Abridged.add(obType: obType, &fbb)
    CollectRequest_Abridged.add(priority: priority, &fbb)
    CollectRequest_Abridged.add(taskCategory: taskCategory, &fbb)
    CollectRequest_Abridged.add(suffix: suffix, &fbb)
    CollectRequest_Abridged.add(uctFollowUp: uctFollowUp, &fbb)
    CollectRequest_Abridged.add(startTime: startTime, &fbb)
    CollectRequest_Abridged.add(endTime: endTime, &fbb)
    CollectRequest_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    CollectRequest_Abridged.add(satNo: satNo, &fbb)
    CollectRequest_Abridged.add(origObjectId: origObjectId, &fbb)
    CollectRequest_Abridged.add(taskGroup: taskGroup, &fbb)
    CollectRequest_Abridged.add(iron: iron, &fbb)
    CollectRequest_Abridged.add(orbitRegime: orbitRegime, &fbb)
    CollectRequest_Abridged.add(targetSize: targetSize, &fbb)
    CollectRequest_Abridged.add(rcsMin: rcsMin, &fbb)
    CollectRequest_Abridged.add(rcs: rcs, &fbb)
    CollectRequest_Abridged.add(rcsMax: rcsMax, &fbb)
    CollectRequest_Abridged.add(freqMin: freqMin, &fbb)
    CollectRequest_Abridged.add(freq: freq, &fbb)
    CollectRequest_Abridged.add(freqMax: freqMax, &fbb)
    CollectRequest_Abridged.add(polarization: polarization, &fbb)
    CollectRequest_Abridged.add(visMagMin: visMagMin, &fbb)
    CollectRequest_Abridged.add(visMag: visMag, &fbb)
    CollectRequest_Abridged.add(visMagMax: visMagMax, &fbb)
    CollectRequest_Abridged.add(spectralModel: spectralModel, &fbb)
    CollectRequest_Abridged.add(reflectance: reflectance, &fbb)
    CollectRequest_Abridged.add(irradiance: irradiance, &fbb)
    CollectRequest_Abridged.add(numFrames: numFrames, &fbb)
    CollectRequest_Abridged.add(frameRate: frameRate, &fbb)
    CollectRequest_Abridged.add(integrationTime: integrationTime, &fbb)
    CollectRequest_Abridged.add(numTracks: numTracks, &fbb)
    CollectRequest_Abridged.add(numObs: numObs, &fbb)
    CollectRequest_Abridged.add(duration: duration, &fbb)
    CollectRequest_Abridged.add(srchPattern: srchPattern, &fbb)
    CollectRequest_Abridged.add(scenario: scenario, &fbb)
    CollectRequest_Abridged.add(idElset: idElset, &fbb)
    CollectRequest_Abridged.add(idManifold: idManifold, &fbb)
    CollectRequest_Abridged.add(idStateVector: idStateVector, &fbb)
    CollectRequest_Abridged.add(esId: esId, &fbb)
    CollectRequest_Abridged.add(epoch: epoch, &fbb)
    CollectRequest_Abridged.add(semiMajorAxis: semiMajorAxis, &fbb)
    CollectRequest_Abridged.add(eccentricity: eccentricity, &fbb)
    CollectRequest_Abridged.add(inclination: inclination, &fbb)
    CollectRequest_Abridged.add(raan: raan, &fbb)
    CollectRequest_Abridged.add(argOfPerigee: argOfPerigee, &fbb)
    CollectRequest_Abridged.add(trueAnomoly: trueAnomoly, &fbb)
    CollectRequest_Abridged.add(ra: ra, &fbb)
    CollectRequest_Abridged.add(dec: dec, &fbb)
    CollectRequest_Abridged.add(az: az, &fbb)
    CollectRequest_Abridged.add(el: el, &fbb)
    CollectRequest_Abridged.add(range: range, &fbb)
    CollectRequest_Abridged.add(extentAz: extentAz, &fbb)
    CollectRequest_Abridged.add(extentEl: extentEl, &fbb)
    CollectRequest_Abridged.add(extentRange: extentRange, &fbb)
    CollectRequest_Abridged.add(lat: lat, &fbb)
    CollectRequest_Abridged.add(lon: lon, &fbb)
    CollectRequest_Abridged.add(alt: alt, &fbb)
    CollectRequest_Abridged.add(stopLat: stopLat, &fbb)
    CollectRequest_Abridged.add(stopLon: stopLon, &fbb)
    CollectRequest_Abridged.add(stopAlt: stopAlt, &fbb)
    CollectRequest_Abridged.add(srchInc: srchInc, &fbb)
    CollectRequest_Abridged.add(xAngle: xAngle, &fbb)
    CollectRequest_Abridged.add(yAngle: yAngle, &fbb)
    CollectRequest_Abridged.add(orientAngle: orientAngle, &fbb)
    CollectRequest_Abridged.add(customer: customer, &fbb)
    CollectRequest_Abridged.add(notes: notes, &fbb)
    CollectRequest_Abridged.add(createdAt: createdAt, &fbb)
    CollectRequest_Abridged.add(createdBy: createdBy, &fbb)
    CollectRequest_Abridged.add(source: source, &fbb)
    CollectRequest_Abridged.add(origin: origin, &fbb)
    CollectRequest_Abridged.add(origNetwork: origNetwork, &fbb)
    CollectRequest_Abridged.add(dataMode: dataMode, &fbb)
    CollectRequest_Abridged.add(stateVector: stateVector, &fbb)
    CollectRequest_Abridged.add(elset: elset, &fbb)
    return CollectRequest_Abridged.endCollectRequest_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: CollectRequest_Abridged_dataMode_Enum.self)
