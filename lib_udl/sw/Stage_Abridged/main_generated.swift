...
public enum Stage_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Stage_Abridged_dataMode_Enum { return .exercise }
  public static var min: Stage_Abridged_dataMode_Enum { return .real }
}
...
public struct Stage_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Stage_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Stage_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Stage_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startStage_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 39) }
  ...
  public static func add(dataMode: Stage_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endStage_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createStage_Abridged(
    ...
    let __start = Stage_Abridged.startStage_Abridged(&fbb)
    Stage_Abridged.add(id: id, &fbb)
    Stage_Abridged.add(idLaunchVehicle: idLaunchVehicle, &fbb)
    Stage_Abridged.add(idEngine: idEngine, &fbb)
    Stage_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Stage_Abridged.add(stageNumber: stageNumber, &fbb)
    Stage_Abridged.add(type: type, &fbb)
    Stage_Abridged.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    Stage_Abridged.add(numEngines: numEngines, &fbb)
    Stage_Abridged.add(length: length, &fbb)
    Stage_Abridged.add(diameter: diameter, &fbb)
    Stage_Abridged.add(mass: mass, &fbb)
    Stage_Abridged.add(vernier: vernier, &fbb)
    Stage_Abridged.add(numVernier: numVernier, &fbb)
    Stage_Abridged.add(mainEngineThrustSeaLevel: mainEngineThrustSeaLevel, &fbb)
    Stage_Abridged.add(mainEngineThrustVacuum: mainEngineThrustVacuum, &fbb)
    Stage_Abridged.add(thrustSeaLevel: thrustSeaLevel, &fbb)
    Stage_Abridged.add(thrustVacuum: thrustVacuum, &fbb)
    Stage_Abridged.add(burnTime: burnTime, &fbb)
    Stage_Abridged.add(numBurns: numBurns, &fbb)
    Stage_Abridged.add(vernierBurnTime: vernierBurnTime, &fbb)
    Stage_Abridged.add(vernierNumBurns: vernierNumBurns, &fbb)
    Stage_Abridged.add(vernierThrustSeaLevel: vernierThrustSeaLevel, &fbb)
    Stage_Abridged.add(vernierThrustVacuum: vernierThrustVacuum, &fbb)
    Stage_Abridged.add(numStageElements: numStageElements, &fbb)
    Stage_Abridged.add(reusable: reusable, &fbb)
    Stage_Abridged.add(restartable: restartable, &fbb)
    Stage_Abridged.add(controlThruster1: controlThruster1, &fbb)
    Stage_Abridged.add(numControlThruster1: numControlThruster1, &fbb)
    Stage_Abridged.add(controlThruster2: controlThruster2, &fbb)
    Stage_Abridged.add(numControlThruster2: numControlThruster2, &fbb)
    Stage_Abridged.addVectorOf(photoUrls: photoUrls, &fbb)
    Stage_Abridged.add(notes: notes, &fbb)
    Stage_Abridged.add(avionicsNotes: avionicsNotes, &fbb)
    Stage_Abridged.add(createdAt: createdAt, &fbb)
    Stage_Abridged.add(createdBy: createdBy, &fbb)
    Stage_Abridged.add(source: source, &fbb)
    Stage_Abridged.add(origin: origin, &fbb)
    Stage_Abridged.add(origNetwork: origNetwork, &fbb)
    Stage_Abridged.add(dataMode: dataMode, &fbb)
    return Stage_Abridged.endStage_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Stage_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
