...
public struct IonoObservationDensityProfileTopsideExtensionVaryChap_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDensityProfileTopsideExtensionVaryChap_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDensityProfileTopsideExtensionVaryChap_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 8) }
  ...
  public static func endIonoObservationDensityProfileTopsideExtensionVaryChap_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDensityProfileTopsideExtensionVaryChap_Ingest(
    ...
    let __start = IonoObservationDensityProfileTopsideExtensionVaryChap_Ingest.startIonoObservationDensityProfileTopsideExtensionVaryChap_Ingest(&fbb)
    IonoObservationDensityProfileTopsideExtensionVaryChap_Ingest.add(description: description, &fbb)
    IonoObservationDensityProfileTopsideExtensionVaryChap_Ingest.add(nmF2: nmF2, &fbb)
    IonoObservationDensityProfileTopsideExtensionVaryChap_Ingest.add(hmF2: hmF2, &fbb)
    IonoObservationDensityProfileTopsideExtensionVaryChap_Ingest.add(scaleF2: scaleF2, &fbb)
    IonoObservationDensityProfileTopsideExtensionVaryChap_Ingest.add(alpha: alpha, &fbb)
    IonoObservationDensityProfileTopsideExtensionVaryChap_Ingest.add(beta: beta, &fbb)
    IonoObservationDensityProfileTopsideExtensionVaryChap_Ingest.add(ht: ht, &fbb)
    IonoObservationDensityProfileTopsideExtensionVaryChap_Ingest.add(chi: chi, &fbb)
    return IonoObservationDensityProfileTopsideExtensionVaryChap_Ingest.endIonoObservationDensityProfileTopsideExtensionVaryChap_Ingest(&fbb, start: __start)
  }
