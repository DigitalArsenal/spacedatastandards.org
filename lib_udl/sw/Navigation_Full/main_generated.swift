...
public enum Navigation_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Navigation_Full_dataMode_Enum { return .exercise }
  public static var min: Navigation_Full_dataMode_Enum { return .real }
}


///  /// Navigation payload entities within the SSA environment.
public struct Navigation_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Navigation_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Navigation_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Navigation_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startNavigation_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 14) }
  ...
  public static func add(dataMode: Navigation_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(entity: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: entity, at: VTOFFSET.entity.p) }
  public static func endNavigation_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createNavigation_Full(
    ...
    let __start = Navigation_Full.startNavigation_Full(&fbb)
    Navigation_Full.add(id: id, &fbb)
    Navigation_Full.add(classificationMarking: classificationMarking, &fbb)
    Navigation_Full.add(idEntity: idEntity, &fbb)
    Navigation_Full.add(name: name, &fbb)
    Navigation_Full.add(description: description, &fbb)
    Navigation_Full.add(createdAt: createdAt, &fbb)
    Navigation_Full.add(createdBy: createdBy, &fbb)
    Navigation_Full.add(updatedAt: updatedAt, &fbb)
    Navigation_Full.add(updatedBy: updatedBy, &fbb)
    Navigation_Full.add(source: source, &fbb)
    Navigation_Full.add(origin: origin, &fbb)
    Navigation_Full.add(origNetwork: origNetwork, &fbb)
    Navigation_Full.add(dataMode: dataMode, &fbb)
    Navigation_Full.add(entity: entity, &fbb)
    return Navigation_Full.endNavigation_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Navigation_Full_dataMode_Enum.self)
