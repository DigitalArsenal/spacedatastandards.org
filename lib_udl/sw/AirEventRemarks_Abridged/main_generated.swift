...
public struct AirEventRemarks_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirEventRemarks_Abridged.id, addPrefix: prefix) }
  ...
  public static func startAirEventRemarks_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endAirEventRemarks_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirEventRemarks_Abridged(
    ...
    let __start = AirEventRemarks_Abridged.startAirEventRemarks_Abridged(&fbb)
    AirEventRemarks_Abridged.add(externalRemarkId: externalRemarkId, &fbb)
    AirEventRemarks_Abridged.add(text: text, &fbb)
    AirEventRemarks_Abridged.add(date: date, &fbb)
    AirEventRemarks_Abridged.add(user: user, &fbb)
    return AirEventRemarks_Abridged.endAirEventRemarks_Abridged(&fbb, start: __start)
  }
