...
public struct EvacEtiology_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacEtiology_Ingest.id, addPrefix: prefix) }
  ...
  public static func startEvacEtiology_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endEvacEtiology_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacEtiology_Ingest(
    ...
    let __start = EvacEtiology_Ingest.startEvacEtiology_Ingest(&fbb)
    EvacEtiology_Ingest.add(type: type, &fbb)
    EvacEtiology_Ingest.add(bodyPart: bodyPart, &fbb)
    EvacEtiology_Ingest.add(time: time, &fbb)
    EvacEtiology_Ingest.add(comments: comments, &fbb)
    return EvacEtiology_Ingest.endEvacEtiology_Ingest(&fbb, start: __start)
  }
