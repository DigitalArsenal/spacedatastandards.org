...
public enum AttitudeData_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AttitudeData_Abridged_dataMode_Enum { return .exercise }
  public static var min: AttitudeData_Abridged_dataMode_Enum { return .real }
}
...
public struct AttitudeData_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AttitudeData_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: AttitudeData_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AttitudeData_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startAttitudeData_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 33) }
  ...
  public static func add(dataMode: AttitudeData_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endAttitudeData_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAttitudeData_Abridged(
    ...
    let __start = AttitudeData_Abridged.startAttitudeData_Abridged(&fbb)
    AttitudeData_Abridged.add(id: id, &fbb)
    AttitudeData_Abridged.add(classificationMarking: classificationMarking, &fbb)
    AttitudeData_Abridged.add(asId: asId, &fbb)
    AttitudeData_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    AttitudeData_Abridged.add(satNo: satNo, &fbb)
    AttitudeData_Abridged.add(origObjectId: origObjectId, &fbb)
    AttitudeData_Abridged.add(ts: ts, &fbb)
    AttitudeData_Abridged.add(motionType: motionType, &fbb)
    AttitudeData_Abridged.add(q1: q1, &fbb)
    AttitudeData_Abridged.add(q2: q2, &fbb)
    AttitudeData_Abridged.add(q3: q3, &fbb)
    AttitudeData_Abridged.add(qc: qc, &fbb)
    AttitudeData_Abridged.add(q1Dot: q1Dot, &fbb)
    AttitudeData_Abridged.add(q2Dot: q2Dot, &fbb)
    AttitudeData_Abridged.add(q3Dot: q3Dot, &fbb)
    AttitudeData_Abridged.add(qcDot: qcDot, &fbb)
    AttitudeData_Abridged.addVectorOf(xAngle: xAngle, &fbb)
    AttitudeData_Abridged.addVectorOf(yAngle: yAngle, &fbb)
    AttitudeData_Abridged.addVectorOf(zAngle: zAngle, &fbb)
    AttitudeData_Abridged.addVectorOf(xRate: xRate, &fbb)
    AttitudeData_Abridged.addVectorOf(yRate: yRate, &fbb)
    AttitudeData_Abridged.addVectorOf(zRate: zRate, &fbb)
    AttitudeData_Abridged.add(ra: ra, &fbb)
    AttitudeData_Abridged.add(declination: declination, &fbb)
    AttitudeData_Abridged.add(coningAngle: coningAngle, &fbb)
    AttitudeData_Abridged.add(precPeriod: precPeriod, &fbb)
    AttitudeData_Abridged.add(spinPeriod: spinPeriod, &fbb)
    AttitudeData_Abridged.add(createdAt: createdAt, &fbb)
    AttitudeData_Abridged.add(createdBy: createdBy, &fbb)
    AttitudeData_Abridged.add(source: source, &fbb)
    AttitudeData_Abridged.add(origin: origin, &fbb)
    AttitudeData_Abridged.add(dataMode: dataMode, &fbb)
    AttitudeData_Abridged.add(origNetwork: origNetwork, &fbb)
    return AttitudeData_Abridged.endAttitudeData_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AttitudeData_Abridged_dataMode_Enum.self)
