...
public struct MtiMission_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiMission_Abridged.id, addPrefix: prefix) }
  ...
  public static func startMtiMission_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endMtiMission_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiMission_Abridged(
    ...
    let __start = MtiMission_Abridged.startMtiMission_Abridged(&fbb)
    MtiMission_Abridged.add(m1: m1, &fbb)
    MtiMission_Abridged.add(m2: m2, &fbb)
    MtiMission_Abridged.add(m3: m3, &fbb)
    MtiMission_Abridged.add(m4: m4, &fbb)
    MtiMission_Abridged.add(msnRefTs: msnRefTs, &fbb)
    return MtiMission_Abridged.endMtiMission_Abridged(&fbb, start: __start)
  }
