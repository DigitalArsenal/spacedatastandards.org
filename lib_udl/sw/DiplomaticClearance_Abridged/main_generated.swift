...
public enum DiplomaticClearance_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: DiplomaticClearance_Abridged_dataMode_Enum { return .exercise }
  public static var min: DiplomaticClearance_Abridged_dataMode_Enum { return .real }
}


///  /// A diplomatic clearance is an authorization for an aircraft to traverse or land within a specified country.
public struct DiplomaticClearance_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DiplomaticClearance_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: DiplomaticClearance_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : DiplomaticClearance_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startDiplomaticClearance_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 19) }
  ...
  public static func add(dataMode: DiplomaticClearance_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endDiplomaticClearance_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDiplomaticClearance_Abridged(
    ...
    let __start = DiplomaticClearance_Abridged.startDiplomaticClearance_Abridged(&fbb)
    DiplomaticClearance_Abridged.add(id: id, &fbb)
    DiplomaticClearance_Abridged.add(classificationMarking: classificationMarking, &fbb)
    DiplomaticClearance_Abridged.add(idMission: idMission, &fbb)
    DiplomaticClearance_Abridged.add(externalWorksheetId: externalWorksheetId, &fbb)
    DiplomaticClearance_Abridged.add(dipWorksheetName: dipWorksheetName, &fbb)
    DiplomaticClearance_Abridged.add(firstDepDate: firstDepDate, &fbb)
    DiplomaticClearance_Abridged.add(docDeadline: docDeadline, &fbb)
    DiplomaticClearance_Abridged.add(apacsId: apacsId, &fbb)
    DiplomaticClearance_Abridged.addVectorOf(diplomaticClearanceDetails: diplomaticClearanceDetails, &fbb)
    DiplomaticClearance_Abridged.addVectorOf(diplomaticClearanceRemarks: diplomaticClearanceRemarks, &fbb)
    DiplomaticClearance_Abridged.add(createdAt: createdAt, &fbb)
    DiplomaticClearance_Abridged.add(createdBy: createdBy, &fbb)
    DiplomaticClearance_Abridged.add(updatedAt: updatedAt, &fbb)
    DiplomaticClearance_Abridged.add(updatedBy: updatedBy, &fbb)
    DiplomaticClearance_Abridged.add(sourceDl: sourceDl, &fbb)
    DiplomaticClearance_Abridged.add(source: source, &fbb)
    DiplomaticClearance_Abridged.add(origin: origin, &fbb)
    DiplomaticClearance_Abridged.add(origNetwork: origNetwork, &fbb)
    DiplomaticClearance_Abridged.add(dataMode: dataMode, &fbb)
    return DiplomaticClearance_Abridged.endDiplomaticClearance_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: DiplomaticClearance_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
