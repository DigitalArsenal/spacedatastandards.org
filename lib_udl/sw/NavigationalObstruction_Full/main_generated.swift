...
public enum NavigationalObstruction_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: NavigationalObstruction_Full_dataMode_Enum { return .exercise }
  public static var min: NavigationalObstruction_Full_dataMode_Enum { return .real }
}
...
public struct NavigationalObstruction_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: NavigationalObstruction_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: NavigationalObstruction_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : NavigationalObstruction_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startNavigationalObstruction_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 79) }
  ...
  public static func add(dataMode: NavigationalObstruction_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endNavigationalObstruction_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createNavigationalObstruction_Full(
    ...
    let __start = NavigationalObstruction_Full.startNavigationalObstruction_Full(&fbb)
    NavigationalObstruction_Full.add(id: id, &fbb)
    NavigationalObstruction_Full.add(classificationMarking: classificationMarking, &fbb)
    NavigationalObstruction_Full.add(cycleDate: cycleDate, &fbb)
    NavigationalObstruction_Full.add(obstacleType: obstacleType, &fbb)
    NavigationalObstruction_Full.add(obstacleId: obstacleId, &fbb)
    NavigationalObstruction_Full.add(externalId: externalId, &fbb)
    NavigationalObstruction_Full.add(origId: origId, &fbb)
    NavigationalObstruction_Full.add(countryCode: countryCode, &fbb)
    NavigationalObstruction_Full.add(provinceCode: provinceCode, &fbb)
    NavigationalObstruction_Full.add(pointLat: pointLat, &fbb)
    NavigationalObstruction_Full.add(pointLon: pointLon, &fbb)
    NavigationalObstruction_Full.add(lineNelon: lineNelon, &fbb)
    NavigationalObstruction_Full.add(lineNelat: lineNelat, &fbb)
    NavigationalObstruction_Full.add(lineSwlon: lineSwlon, &fbb)
    NavigationalObstruction_Full.add(lineSwlat: lineSwlat, &fbb)
    NavigationalObstruction_Full.add(segStartPoint: segStartPoint, &fbb)
    NavigationalObstruction_Full.add(segEndPoint: segEndPoint, &fbb)
    NavigationalObstruction_Full.add(segNum: segNum, &fbb)
    NavigationalObstruction_Full.add(facc: facc, &fbb)
    NavigationalObstruction_Full.add(featureCode: featureCode, &fbb)
    NavigationalObstruction_Full.add(featureType: featureType, &fbb)
    NavigationalObstruction_Full.add(featureName: featureName, &fbb)
    NavigationalObstruction_Full.add(featureDescription: featureDescription, &fbb)
    NavigationalObstruction_Full.add(wac: wac, &fbb)
    NavigationalObstruction_Full.add(wacInnr: wacInnr, &fbb)
    NavigationalObstruction_Full.add(multObs: multObs, &fbb)
    NavigationalObstruction_Full.add(numObs: numObs, &fbb)
    NavigationalObstruction_Full.add(horizDatumCode: horizDatumCode, &fbb)
    NavigationalObstruction_Full.add(heightAgl: heightAgl, &fbb)
    NavigationalObstruction_Full.add(heightAglacc: heightAglacc, &fbb)
    NavigationalObstruction_Full.add(heightMsl: heightMsl, &fbb)
    NavigationalObstruction_Full.add(heightMslacc: heightMslacc, &fbb)
    NavigationalObstruction_Full.add(elevation: elevation, &fbb)
    NavigationalObstruction_Full.add(elevationAcc: elevationAcc, &fbb)
    NavigationalObstruction_Full.add(horizAcc: horizAcc, &fbb)
    NavigationalObstruction_Full.add(quality: quality, &fbb)
    NavigationalObstruction_Full.add(lightingCode: lightingCode, &fbb)
    NavigationalObstruction_Full.add(surfaceMatCode: surfaceMatCode, &fbb)
    NavigationalObstruction_Full.add(directivityCode: directivityCode, &fbb)
    NavigationalObstruction_Full.add(validationCode: validationCode, &fbb)
    NavigationalObstruction_Full.add(transactionCode: transactionCode, &fbb)
    NavigationalObstruction_Full.add(processCode: processCode, &fbb)
    NavigationalObstruction_Full.add(actDelCode: actDelCode, &fbb)
    NavigationalObstruction_Full.add(producer: producer, &fbb)
    NavigationalObstruction_Full.add(derivingOrg: derivingOrg, &fbb)
    NavigationalObstruction_Full.add(deletingOrg: deletingOrg, &fbb)
    NavigationalObstruction_Full.add(sourceDate: sourceDate, &fbb)
    NavigationalObstruction_Full.add(revDate: revDate, &fbb)
    NavigationalObstruction_Full.add(initRecordDate: initRecordDate, &fbb)
    NavigationalObstruction_Full.addVectorOf(keys: keys, &fbb)
    NavigationalObstruction_Full.addVectorOf(values: values, &fbb)
    NavigationalObstruction_Full.add(obstacleRemarks: obstacleRemarks, &fbb)
    NavigationalObstruction_Full.add(nextCycleDate: nextCycleDate, &fbb)
    NavigationalObstruction_Full.add(baselineCutoffDate: baselineCutoffDate, &fbb)
    NavigationalObstruction_Full.add(cutoffDate: cutoffDate, &fbb)
    NavigationalObstruction_Full.add(airacCycle: airacCycle, &fbb)
    NavigationalObstruction_Full.add(baseAiracCycle: baseAiracCycle, &fbb)
    NavigationalObstruction_Full.add(ownerCountryCode: ownerCountryCode, &fbb)
    NavigationalObstruction_Full.add(boundNelon: boundNelon, &fbb)
    NavigationalObstruction_Full.add(boundNelat: boundNelat, &fbb)
    NavigationalObstruction_Full.add(boundSwlon: boundSwlon, &fbb)
    NavigationalObstruction_Full.add(boundSwlat: boundSwlat, &fbb)
    NavigationalObstruction_Full.add(minHeightAgl: minHeightAgl, &fbb)
    NavigationalObstruction_Full.add(numPoints: numPoints, &fbb)
    NavigationalObstruction_Full.add(numLines: numLines, &fbb)
    NavigationalObstruction_Full.add(dataSetRemarks: dataSetRemarks, &fbb)
    NavigationalObstruction_Full.add(pointsFilename: pointsFilename, &fbb)
    NavigationalObstruction_Full.add(linesFilename: linesFilename, &fbb)
    NavigationalObstruction_Full.add(vectorsFilename: vectorsFilename, &fbb)
    NavigationalObstruction_Full.add(rawFileUri: rawFileUri, &fbb)
    NavigationalObstruction_Full.add(createdAt: createdAt, &fbb)
    NavigationalObstruction_Full.add(createdBy: createdBy, &fbb)
    NavigationalObstruction_Full.add(updatedAt: updatedAt, &fbb)
    NavigationalObstruction_Full.add(updatedBy: updatedBy, &fbb)
    NavigationalObstruction_Full.add(sourceDl: sourceDl, &fbb)
    NavigationalObstruction_Full.add(source: source, &fbb)
    NavigationalObstruction_Full.add(origin: origin, &fbb)
    NavigationalObstruction_Full.add(origNetwork: origNetwork, &fbb)
    NavigationalObstruction_Full.add(dataMode: dataMode, &fbb)
    return NavigationalObstruction_Full.endNavigationalObstruction_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: NavigationalObstruction_Full_dataMode_Enum.self)
    _v.finish()
  }
}
