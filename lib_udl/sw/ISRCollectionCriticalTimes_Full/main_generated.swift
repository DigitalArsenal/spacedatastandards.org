...
public struct ISRCollectionCriticalTimes_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollectionCriticalTimes_Full.id, addPrefix: prefix) }
  ...
  public static func startISRCollectionCriticalTimes_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 2) }
  ...
  public static func endISRCollectionCriticalTimes_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollectionCriticalTimes_Full(
    _ fbb: inout FlatBufferBuilder,
    earliestImagingTimeOffset earliestImagingTime: Offset = Offset(),
    latestImagingTimeOffset latestImagingTime: Offset = Offset()
  ) -> Offset {
    let __start = ISRCollectionCriticalTimes_Full.startISRCollectionCriticalTimes_Full(&fbb)
    ISRCollectionCriticalTimes_Full.add(earliestImagingTime: earliestImagingTime, &fbb)
    ISRCollectionCriticalTimes_Full.add(latestImagingTime: latestImagingTime, &fbb)
    return ISRCollectionCriticalTimes_Full.endISRCollectionCriticalTimes_Full(&fbb, start: __start)
  }
