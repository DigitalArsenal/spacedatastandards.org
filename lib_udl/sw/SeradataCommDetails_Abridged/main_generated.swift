...
public enum SeradataCommDetails_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SeradataCommDetails_Abridged_dataMode_Enum { return .exercise }
  public static var min: SeradataCommDetails_Abridged_dataMode_Enum { return .real }
}


///  /// Seradata-compiled information on communications payloads.
public struct SeradataCommDetails_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SeradataCommDetails_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SeradataCommDetails_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SeradataCommDetails_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startSeradataCommDetails_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 37) }
  ...
  public static func add(dataMode: SeradataCommDetails_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func endSeradataCommDetails_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSeradataCommDetails_Abridged(
    ...
    let __start = SeradataCommDetails_Abridged.startSeradataCommDetails_Abridged(&fbb)
    SeradataCommDetails_Abridged.add(id: id, &fbb)
    SeradataCommDetails_Abridged.add(idComm: idComm, &fbb)
    SeradataCommDetails_Abridged.add(classificationMarking: classificationMarking, &fbb)
    SeradataCommDetails_Abridged.add(spacecraftId: spacecraftId, &fbb)
    SeradataCommDetails_Abridged.add(band: band, &fbb)
    SeradataCommDetails_Abridged.add(solidStatePowerAmp: solidStatePowerAmp, &fbb)
    SeradataCommDetails_Abridged.add(travelingWaveTubeAmplifier: travelingWaveTubeAmplifier, &fbb)
    SeradataCommDetails_Abridged.add(gatewayUplinkFrom: gatewayUplinkFrom, &fbb)
    SeradataCommDetails_Abridged.add(gatewayUplinkTo: gatewayUplinkTo, &fbb)
    SeradataCommDetails_Abridged.add(gatewayDownlinkFrom: gatewayDownlinkFrom, &fbb)
    SeradataCommDetails_Abridged.add(gatewayDownlinkTo: gatewayDownlinkTo, &fbb)
    SeradataCommDetails_Abridged.add(polarization: polarization, &fbb)
    SeradataCommDetails_Abridged.add(eirp: eirp, &fbb)
    SeradataCommDetails_Abridged.add(bandwidth: bandwidth, &fbb)
    SeradataCommDetails_Abridged.add(numOperationalTransponders: numOperationalTransponders, &fbb)
    SeradataCommDetails_Abridged.add(numSpareTransponders: numSpareTransponders, &fbb)
    SeradataCommDetails_Abridged.add(hostedForCompanyOrgId: hostedForCompanyOrgId, &fbb)
    SeradataCommDetails_Abridged.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    SeradataCommDetails_Abridged.add(tradeLeaseOrgId: tradeLeaseOrgId, &fbb)
    SeradataCommDetails_Abridged.add(num36MhzEquivalentTransponders: num36MhzEquivalentTransponders, &fbb)
    SeradataCommDetails_Abridged.add(htsNumUserSpotBeams: htsNumUserSpotBeams, &fbb)
    SeradataCommDetails_Abridged.add(htsUserDownlinkBandwidthPerBeam: htsUserDownlinkBandwidthPerBeam, &fbb)
    SeradataCommDetails_Abridged.add(htsUserUplinkBandwidthPerBeam: htsUserUplinkBandwidthPerBeam, &fbb)
    SeradataCommDetails_Abridged.add(estHtsTotalUserDownlinkBandwidthPerBeam: estHtsTotalUserDownlinkBandwidthPerBeam, &fbb)
    SeradataCommDetails_Abridged.add(estHtsTotalUserUplinkBandwidthPerBeam: estHtsTotalUserUplinkBandwidthPerBeam, &fbb)
    SeradataCommDetails_Abridged.add(estHtsTotalCapacity: estHtsTotalCapacity, &fbb)
    SeradataCommDetails_Abridged.add(userDownlinkFrom: userDownlinkFrom, &fbb)
    SeradataCommDetails_Abridged.add(userDownlinkTo: userDownlinkTo, &fbb)
    SeradataCommDetails_Abridged.add(userUplinkFrom: userUplinkFrom, &fbb)
    SeradataCommDetails_Abridged.add(userUplinkTo: userUplinkTo, &fbb)
    SeradataCommDetails_Abridged.add(payloadNotes: payloadNotes, &fbb)
    SeradataCommDetails_Abridged.add(source: source, &fbb)
    SeradataCommDetails_Abridged.add(origin: origin, &fbb)
    SeradataCommDetails_Abridged.add(origNetwork: origNetwork, &fbb)
    SeradataCommDetails_Abridged.add(dataMode: dataMode, &fbb)
    SeradataCommDetails_Abridged.add(createdAt: createdAt, &fbb)
    SeradataCommDetails_Abridged.add(createdBy: createdBy, &fbb)
    return SeradataCommDetails_Abridged.endSeradataCommDetails_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SeradataCommDetails_Abridged_dataMode_Enum.self)
