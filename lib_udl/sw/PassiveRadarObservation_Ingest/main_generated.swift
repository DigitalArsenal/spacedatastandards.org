...
public enum PassiveRadarObservation_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: PassiveRadarObservation_Ingest_dataMode_Enum { return .exercise }
  public static var min: PassiveRadarObservation_Ingest_dataMode_Enum { return .real }
}
...
public struct PassiveRadarObservation_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: PassiveRadarObservation_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: PassiveRadarObservation_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : PassiveRadarObservation_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startPassiveRadarObservation_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 67) }
  ...
  public static func add(dataMode: PassiveRadarObservation_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(type: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: type, at: VTOFFSET.type.p) }
  public static func endPassiveRadarObservation_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPassiveRadarObservation_Ingest(
    ...
    let __start = PassiveRadarObservation_Ingest.startPassiveRadarObservation_Ingest(&fbb)
    PassiveRadarObservation_Ingest.add(id: id, &fbb)
    PassiveRadarObservation_Ingest.add(classificationMarking: classificationMarking, &fbb)
    PassiveRadarObservation_Ingest.add(obTime: obTime, &fbb)
    PassiveRadarObservation_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    PassiveRadarObservation_Ingest.add(satNo: satNo, &fbb)
    PassiveRadarObservation_Ingest.add(origObjectId: origObjectId, &fbb)
    PassiveRadarObservation_Ingest.add(idSensor: idSensor, &fbb)
    PassiveRadarObservation_Ingest.add(origSensorId: origSensorId, &fbb)
    PassiveRadarObservation_Ingest.add(idRfemitter: idRfemitter, &fbb)
    PassiveRadarObservation_Ingest.add(idSensorRefReceiver: idSensorRefReceiver, &fbb)
    PassiveRadarObservation_Ingest.add(extObservationId: extObservationId, &fbb)
    PassiveRadarObservation_Ingest.add(taskId: taskId, &fbb)
    PassiveRadarObservation_Ingest.add(trackId: trackId, &fbb)
    PassiveRadarObservation_Ingest.add(obPosition: obPosition, &fbb)
    PassiveRadarObservation_Ingest.add(uct: uct, &fbb)
    PassiveRadarObservation_Ingest.add(azimuth: azimuth, &fbb)
    PassiveRadarObservation_Ingest.add(azimuthUnc: azimuthUnc, &fbb)
    PassiveRadarObservation_Ingest.add(azimuthBias: azimuthBias, &fbb)
    PassiveRadarObservation_Ingest.add(azimuthRate: azimuthRate, &fbb)
    PassiveRadarObservation_Ingest.add(elevation: elevation, &fbb)
    PassiveRadarObservation_Ingest.add(elevationUnc: elevationUnc, &fbb)
    PassiveRadarObservation_Ingest.add(elevationBias: elevationBias, &fbb)
    PassiveRadarObservation_Ingest.add(elevationRate: elevationRate, &fbb)
    PassiveRadarObservation_Ingest.add(delay: delay, &fbb)
    PassiveRadarObservation_Ingest.add(delayUnc: delayUnc, &fbb)
    PassiveRadarObservation_Ingest.add(delayBias: delayBias, &fbb)
    PassiveRadarObservation_Ingest.add(bistaticRange: bistaticRange, &fbb)
    PassiveRadarObservation_Ingest.add(bistaticRangeUnc: bistaticRangeUnc, &fbb)
    PassiveRadarObservation_Ingest.add(bistaticRangeBias: bistaticRangeBias, &fbb)
    PassiveRadarObservation_Ingest.add(bistaticRangeRate: bistaticRangeRate, &fbb)
    PassiveRadarObservation_Ingest.add(bistaticRangeRateUnc: bistaticRangeRateUnc, &fbb)
    PassiveRadarObservation_Ingest.add(bistaticRangeAccel: bistaticRangeAccel, &fbb)
    PassiveRadarObservation_Ingest.add(bistaticRangeAccelUnc: bistaticRangeAccelUnc, &fbb)
    PassiveRadarObservation_Ingest.add(doppler: doppler, &fbb)
    PassiveRadarObservation_Ingest.add(dopplerUnc: dopplerUnc, &fbb)
    PassiveRadarObservation_Ingest.add(coning: coning, &fbb)
    PassiveRadarObservation_Ingest.add(coningUnc: coningUnc, &fbb)
    PassiveRadarObservation_Ingest.add(tof: tof, &fbb)
    PassiveRadarObservation_Ingest.add(tofUnc: tofUnc, &fbb)
    PassiveRadarObservation_Ingest.add(tofBias: tofBias, &fbb)
    PassiveRadarObservation_Ingest.add(accel: accel, &fbb)
    PassiveRadarObservation_Ingest.add(accelUnc: accelUnc, &fbb)
    PassiveRadarObservation_Ingest.add(ra: ra, &fbb)
    PassiveRadarObservation_Ingest.add(declination: declination, &fbb)
    PassiveRadarObservation_Ingest.add(lat: lat, &fbb)
    PassiveRadarObservation_Ingest.add(lon: lon, &fbb)
    PassiveRadarObservation_Ingest.add(alt: alt, &fbb)
    PassiveRadarObservation_Ingest.add(xvel: xvel, &fbb)
    PassiveRadarObservation_Ingest.add(yvel: yvel, &fbb)
    PassiveRadarObservation_Ingest.add(zvel: zvel, &fbb)
    PassiveRadarObservation_Ingest.add(rcs: rcs, &fbb)
    PassiveRadarObservation_Ingest.add(rcsUnc: rcsUnc, &fbb)
    PassiveRadarObservation_Ingest.add(orthogonalRcs: orthogonalRcs, &fbb)
    PassiveRadarObservation_Ingest.add(orthogonalRcsUnc: orthogonalRcsUnc, &fbb)
    PassiveRadarObservation_Ingest.add(snr: snr, &fbb)
    PassiveRadarObservation_Ingest.add(timingBias: timingBias, &fbb)
    PassiveRadarObservation_Ingest.addVectorOf(tags: tags, &fbb)
    PassiveRadarObservation_Ingest.add(transactionId: transactionId, &fbb)
    PassiveRadarObservation_Ingest.add(descriptor: descriptor, &fbb)
    PassiveRadarObservation_Ingest.add(createdAt: createdAt, &fbb)
    PassiveRadarObservation_Ingest.add(createdBy: createdBy, &fbb)
    PassiveRadarObservation_Ingest.add(source: source, &fbb)
    PassiveRadarObservation_Ingest.add(origin: origin, &fbb)
    PassiveRadarObservation_Ingest.add(origNetwork: origNetwork, &fbb)
    PassiveRadarObservation_Ingest.add(sourceDl: sourceDl, &fbb)
    PassiveRadarObservation_Ingest.add(dataMode: dataMode, &fbb)
    PassiveRadarObservation_Ingest.add(type: type, &fbb)
    return PassiveRadarObservation_Ingest.endPassiveRadarObservation_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: PassiveRadarObservation_Ingest_dataMode_Enum.self)
