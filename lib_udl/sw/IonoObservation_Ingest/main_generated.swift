...
public enum IonoObservation_Ingest_transmitSensorType_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: IonoObservation_Ingest_transmitSensorType_Enum { return .static_ }
  public static var min: IonoObservation_Ingest_transmitSensorType_Enum { return .mobile }
}


public enum IonoObservation_Ingest_receiveSensorType_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: IonoObservation_Ingest_receiveSensorType_Enum { return .static_ }
  public static var min: IonoObservation_Ingest_receiveSensorType_Enum { return .mobile }
}


public enum IonoObservation_Ingest_antennaElementPositionCoordinateSystem_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: IonoObservation_Ingest_antennaElementPositionCoordinateSystem_Enum { return .geocentric_lat_long_radii_ }
  public static var min: IonoObservation_Ingest_antennaElementPositionCoordinateSystem_Enum { return .j2000 }
}


public enum IonoObservation_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: IonoObservation_Ingest_dataMode_Enum { return .exercise }
  public static var min: IonoObservation_Ingest_dataMode_Enum { return .real }
}
...
public struct IonoObservation_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservation_Ingest.id, addPrefix: prefix) }
  ...
  public var transmitSensorType: IonoObservation_Ingest_transmitSensorType_Enum { let o = _accessor.offset(VTOFFSET.transmitSensorType.v); return o == 0 ? .mobile : IonoObservation_Ingest_transmitSensorType_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .mobile }
  ///  List of Geodetic Latitude, Longitude, and Altitude coordinates in km of the receiver. Coordinates List must always have 3 elements. Valid ranges are -90.0 to 90.0 for Latitude and -180.0 to 180.0 for Longitude. Altitude is in km and its value must be 0 or greater.
  ///  Example: /// Example: [[45.5, 179.3, 35.6], [-80.2, -20.5, 43.2]]
  ///  Constraints: No constraints specified.
  ...
  ///  Example: /// Example: Mobile
  ///  Constraints: Minimum length = 0, Maximum length = 16
  public var receiveSensorType: IonoObservation_Ingest_receiveSensorType_Enum { let o = _accessor.offset(VTOFFSET.receiveSensorType.v); return o == 0 ? .mobile : IonoObservation_Ingest_receiveSensorType_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .mobile }
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  ...
  public var antennaElementPositionCoordinateSystem: IonoObservation_Ingest_antennaElementPositionCoordinateSystem_Enum { let o = _accessor.offset(VTOFFSET.antennaElementPositionCoordinateSystem.v); return o == 0 ? .j2000 : IonoObservation_Ingest_antennaElementPositionCoordinateSystem_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  ...
  public var dataMode: IonoObservation_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : IonoObservation_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startIonoObservation_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 108) }
  ...
  public static func add(transmitSensorType: IonoObservation_Ingest_transmitSensorType_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: transmitSensorType.rawValue, def: 0, at: VTOFFSET.transmitSensorType.p) }
  ...
  public static func add(receiveSensorType: IonoObservation_Ingest_receiveSensorType_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: receiveSensorType.rawValue, def: 0, at: VTOFFSET.receiveSensorType.p) }
  ...
  public static func add(antennaElementPositionCoordinateSystem: IonoObservation_Ingest_antennaElementPositionCoordinateSystem_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: antennaElementPositionCoordinateSystem.rawValue, def: 0, at: VTOFFSET.antennaElementPositionCoordinateSystem.p) }
  ...
  public static func add(dataMode: IonoObservation_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endIonoObservation_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservation_Ingest(
    ...
    let __start = IonoObservation_Ingest.startIonoObservation_Ingest(&fbb)
    IonoObservation_Ingest.add(id: id, &fbb)
    IonoObservation_Ingest.add(classificationMarking: classificationMarking, &fbb)
    IonoObservation_Ingest.add(idSensor: idSensor, &fbb)
    IonoObservation_Ingest.add(origSensorId: origSensorId, &fbb)
    IonoObservation_Ingest.add(system: system, &fbb)
    IonoObservation_Ingest.add(neProfileName: neProfileName, &fbb)
    IonoObservation_Ingest.add(neProfileVersion: neProfileVersion, &fbb)
    IonoObservation_Ingest.add(scalerInfo: scalerInfo, &fbb)
    IonoObservation_Ingest.add(densityProfile: densityProfile, &fbb)
    IonoObservation_Ingest.add(stationId: stationId, &fbb)
    IonoObservation_Ingest.add(startTimeUtc: startTimeUtc, &fbb)
    IonoObservation_Ingest.add(systemInfo: systemInfo, &fbb)
    IonoObservation_Ingest.add(systemNotes: systemNotes, &fbb)
    IonoObservation_Ingest.addVectorOf(transmitCoordinates: transmitCoordinates, &fbb)
    IonoObservation_Ingest.add(transmitSensorType: transmitSensorType, &fbb)
    IonoObservation_Ingest.addVectorOf(receiveCoordinates: receiveCoordinates, &fbb)
    IonoObservation_Ingest.add(receiveSensorType: receiveSensorType, &fbb)
    IonoObservation_Ingest.add(antennaElementPosition: antennaElementPosition, &fbb)
    IonoObservation_Ingest.add(antennaElementPositionCoordinateSystem: antennaElementPositionCoordinateSystem, &fbb)
    IonoObservation_Ingest.add(power: power, &fbb)
    IonoObservation_Ingest.add(range: range, &fbb)
    IonoObservation_Ingest.add(frequency: frequency, &fbb)
    IonoObservation_Ingest.add(polarization: polarization, &fbb)
    IonoObservation_Ingest.add(azimuth: azimuth, &fbb)
    IonoObservation_Ingest.add(elevation: elevation, &fbb)
    IonoObservation_Ingest.addVectorOf(restrictedFrequency: restrictedFrequency, &fbb)
    IonoObservation_Ingest.add(restrictedFrequencyNotes: restrictedFrequencyNotes, &fbb)
    IonoObservation_Ingest.add(doppler: doppler, &fbb)
    IonoObservation_Ingest.add(time: time, &fbb)
    IonoObservation_Ingest.add(stokes: stokes, &fbb)
    IonoObservation_Ingest.add(amplitude: amplitude, &fbb)
    IonoObservation_Ingest.add(phase: phase, &fbb)
    IonoObservation_Ingest.add(foF2: foF2, &fbb)
    IonoObservation_Ingest.add(foF1: foF1, &fbb)
    IonoObservation_Ingest.add(fxF2: fxF2, &fbb)
    IonoObservation_Ingest.add(fxF1: fxF1, &fbb)
    IonoObservation_Ingest.add(md: md, &fbb)
    IonoObservation_Ingest.add(luf: luf, &fbb)
    IonoObservation_Ingest.add(mufd: mufd, &fbb)
    IonoObservation_Ingest.add(fmin: fmin, &fbb)
    IonoObservation_Ingest.add(foEs: foEs, &fbb)
    IonoObservation_Ingest.add(fminF: fminF, &fbb)
    IonoObservation_Ingest.add(fminE: fminE, &fbb)
    IonoObservation_Ingest.add(foE: foE, &fbb)
    IonoObservation_Ingest.add(fxE: fxE, &fbb)
    IonoObservation_Ingest.add(fxI: fxI, &fbb)
    IonoObservation_Ingest.add(hprimeF: hprimeF, &fbb)
    IonoObservation_Ingest.add(hprimeF2: hprimeF2, &fbb)
    IonoObservation_Ingest.add(hprimeF1: hprimeF1, &fbb)
    IonoObservation_Ingest.add(hprimeE: hprimeE, &fbb)
    IonoObservation_Ingest.add(hprimeEs: hprimeEs, &fbb)
    IonoObservation_Ingest.add(zmE: zmE, &fbb)
    IonoObservation_Ingest.add(yE: yE, &fbb)
    IonoObservation_Ingest.add(qf: qf, &fbb)
    IonoObservation_Ingest.add(qe: qe, &fbb)
    IonoObservation_Ingest.add(downF: downF, &fbb)
    IonoObservation_Ingest.add(downE: downE, &fbb)
    IonoObservation_Ingest.add(downEs: downEs, &fbb)
    IonoObservation_Ingest.add(ff: ff, &fbb)
    IonoObservation_Ingest.add(fe: fe, &fbb)
    IonoObservation_Ingest.add(d: d, &fbb)
    IonoObservation_Ingest.add(fmuf: fmuf, &fbb)
    IonoObservation_Ingest.add(hprimefMuf: hprimefMuf, &fbb)
    IonoObservation_Ingest.add(deltafoF2: deltafoF2, &fbb)
    IonoObservation_Ingest.add(foEp: foEp, &fbb)
    IonoObservation_Ingest.add(fhprimeF: fhprimeF, &fbb)
    IonoObservation_Ingest.add(fhprimeF2: fhprimeF2, &fbb)
    IonoObservation_Ingest.add(foF1p: foF1p, &fbb)
    IonoObservation_Ingest.add(foF2p: foF2p, &fbb)
    IonoObservation_Ingest.add(hmF2: hmF2, &fbb)
    IonoObservation_Ingest.add(hmF1: hmF1, &fbb)
    IonoObservation_Ingest.add(hmE: hmE, &fbb)
    IonoObservation_Ingest.add(zhalfNm: zhalfNm, &fbb)
    IonoObservation_Ingest.add(fminEs: fminEs, &fbb)
    IonoObservation_Ingest.add(yF2: yF2, &fbb)
    IonoObservation_Ingest.add(yF1: yF1, &fbb)
    IonoObservation_Ingest.add(tec: tec, &fbb)
    IonoObservation_Ingest.add(scaleHeightF2Peak: scaleHeightF2Peak, &fbb)
    IonoObservation_Ingest.add(b0: b0, &fbb)
    IonoObservation_Ingest.add(b1: b1, &fbb)
    IonoObservation_Ingest.add(d1: d1, &fbb)
    IonoObservation_Ingest.add(foEa: foEa, &fbb)
    IonoObservation_Ingest.add(hprimeEa: hprimeEa, &fbb)
    IonoObservation_Ingest.add(foP: foP, &fbb)
    IonoObservation_Ingest.add(hprimeP: hprimeP, &fbb)
    IonoObservation_Ingest.add(fbEs: fbEs, &fbb)
    IonoObservation_Ingest.add(typeEs: typeEs, &fbb)
    IonoObservation_Ingest.addVectorOf(charAtts: charAtts, &fbb)
    IonoObservation_Ingest.addVectorOf(height: height, &fbb)
    IonoObservation_Ingest.addVectorOf(plasmaFrequency: plasmaFrequency, &fbb)
    IonoObservation_Ingest.addVectorOf(plasmaFrequencyUncertainty: plasmaFrequencyUncertainty, &fbb)
    IonoObservation_Ingest.addVectorOf(electronDensity: electronDensity, &fbb)
    IonoObservation_Ingest.addVectorOf(electronDensityUncertainty: electronDensityUncertainty, &fbb)
    IonoObservation_Ingest.addVectorOf(artistFlags: artistFlags, &fbb)
    IonoObservation_Ingest.add(traceGeneric: traceGeneric, &fbb)
    IonoObservation_Ingest.addVectorOf(tidPhaseSpeeds: tidPhaseSpeeds, &fbb)
    IonoObservation_Ingest.addVectorOf(tidAzimuth: tidAzimuth, &fbb)
    IonoObservation_Ingest.addVectorOf(tidPeriods: tidPeriods, &fbb)
    IonoObservation_Ingest.add(datum: datum, &fbb)
    IonoObservation_Ingest.add(platformName: platformName, &fbb)
    IonoObservation_Ingest.add(createdAt: createdAt, &fbb)
    IonoObservation_Ingest.add(createdBy: createdBy, &fbb)
    IonoObservation_Ingest.add(updatedAt: updatedAt, &fbb)
    IonoObservation_Ingest.add(updatedBy: updatedBy, &fbb)
    IonoObservation_Ingest.add(source: source, &fbb)
    IonoObservation_Ingest.add(origin: origin, &fbb)
    IonoObservation_Ingest.add(dataMode: dataMode, &fbb)
    IonoObservation_Ingest.add(origNetwork: origNetwork, &fbb)
    return IonoObservation_Ingest.endIonoObservation_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.transmitSensorType.p, fieldName: "transmitSensorType", required: false, type: IonoObservation_Ingest_transmitSensorType_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.receiveSensorType.p, fieldName: "receiveSensorType", required: false, type: IonoObservation_Ingest_receiveSensorType_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.antennaElementPositionCoordinateSystem.p, fieldName: "antennaElementPositionCoordinateSystem", required: false, type: IonoObservation_Ingest_antennaElementPositionCoordinateSystem_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: IonoObservation_Ingest_dataMode_Enum.self)
