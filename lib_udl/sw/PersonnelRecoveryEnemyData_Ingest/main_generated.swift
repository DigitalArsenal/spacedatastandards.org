...
public struct PersonnelRecoveryEnemyData_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: PersonnelRecoveryEnemyData_Ingest.id, addPrefix: prefix) }
  ...
  public static func startPersonnelRecoveryEnemyData_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endPersonnelRecoveryEnemyData_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPersonnelRecoveryEnemyData_Ingest(
    ...
    let __start = PersonnelRecoveryEnemyData_Ingest.startPersonnelRecoveryEnemyData_Ingest(&fbb)
    PersonnelRecoveryEnemyData_Ingest.add(dirToEnemy: dirToEnemy, &fbb)
    PersonnelRecoveryEnemyData_Ingest.add(hostileFireType: hostileFireType, &fbb)
    PersonnelRecoveryEnemyData_Ingest.add(friendliesRemarks: friendliesRemarks, &fbb)
    PersonnelRecoveryEnemyData_Ingest.add(hlzRemarks: hlzRemarks, &fbb)
    return PersonnelRecoveryEnemyData_Ingest.endPersonnelRecoveryEnemyData_Ingest(&fbb, start: __start)
  }
