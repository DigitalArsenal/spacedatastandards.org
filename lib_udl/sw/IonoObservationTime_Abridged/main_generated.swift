...
public struct IonoObservationTime_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationTime_Abridged.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationTime_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationTime_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationTime_Abridged(
    ...
    let __start = IonoObservationTime_Abridged.startIonoObservationTime_Abridged(&fbb)
    IonoObservationTime_Abridged.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationTime_Abridged.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationTime_Abridged.add(notes: notes, &fbb)
    IonoObservationTime_Abridged.addVectorOf(data: data, &fbb)
    return IonoObservationTime_Abridged.endIonoObservationTime_Abridged(&fbb, start: __start)
  }
