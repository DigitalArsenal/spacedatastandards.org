...
public struct IonoObservationAzimuth_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationAzimuth_Abridged.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationAzimuth_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationAzimuth_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationAzimuth_Abridged(
    ...
    let __start = IonoObservationAzimuth_Abridged.startIonoObservationAzimuth_Abridged(&fbb)
    IonoObservationAzimuth_Abridged.add(notes: notes, &fbb)
    IonoObservationAzimuth_Abridged.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationAzimuth_Abridged.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationAzimuth_Abridged.addVectorOf(data: data, &fbb)
    return IonoObservationAzimuth_Abridged.endIonoObservationAzimuth_Abridged(&fbb, start: __start)
  }
