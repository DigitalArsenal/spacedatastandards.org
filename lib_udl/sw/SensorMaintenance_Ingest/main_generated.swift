...
public enum SensorMaintenance_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SensorMaintenance_Ingest_dataMode_Enum { return .exercise }
  public static var min: SensorMaintenance_Ingest_dataMode_Enum { return .real }
}


///  /// Maintenance schedule and operational status of Sensor.
public struct SensorMaintenance_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SensorMaintenance_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: SensorMaintenance_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SensorMaintenance_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startSensorMaintenance_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 31) }
  ...
  public static func add(dataMode: SensorMaintenance_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endSensorMaintenance_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSensorMaintenance_Ingest(
    ...
    let __start = SensorMaintenance_Ingest.startSensorMaintenance_Ingest(&fbb)
    SensorMaintenance_Ingest.add(id: id, &fbb)
    SensorMaintenance_Ingest.add(classificationMarking: classificationMarking, &fbb)
    SensorMaintenance_Ingest.add(siteCode: siteCode, &fbb)
    SensorMaintenance_Ingest.add(idSensor: idSensor, &fbb)
    SensorMaintenance_Ingest.add(startTime: startTime, &fbb)
    SensorMaintenance_Ingest.add(endTime: endTime, &fbb)
    SensorMaintenance_Ingest.add(recall: recall, &fbb)
    SensorMaintenance_Ingest.add(duration: duration, &fbb)
    SensorMaintenance_Ingest.add(mwOpsCap: mwOpsCap, &fbb)
    SensorMaintenance_Ingest.add(ssOpsCap: ssOpsCap, &fbb)
    SensorMaintenance_Ingest.add(mdOpsCap: mdOpsCap, &fbb)
    SensorMaintenance_Ingest.add(impactedFaces: impactedFaces, &fbb)
    SensorMaintenance_Ingest.add(equipStatus: equipStatus, &fbb)
    SensorMaintenance_Ingest.add(activity: activity, &fbb)
    SensorMaintenance_Ingest.add(remark: remark, &fbb)
    SensorMaintenance_Ingest.add(requestor: requestor, &fbb)
    SensorMaintenance_Ingest.add(changer: changer, &fbb)
    SensorMaintenance_Ingest.add(approver: approver, &fbb)
    SensorMaintenance_Ingest.add(eowId: eowId, &fbb)
    SensorMaintenance_Ingest.add(rev: rev, &fbb)
    SensorMaintenance_Ingest.add(priority: priority, &fbb)
    SensorMaintenance_Ingest.add(rel: rel, &fbb)
    SensorMaintenance_Ingest.add(lineNumber: lineNumber, &fbb)
    SensorMaintenance_Ingest.add(resource: resource, &fbb)
    SensorMaintenance_Ingest.add(inactiveDate: inactiveDate, &fbb)
    SensorMaintenance_Ingest.add(createdAt: createdAt, &fbb)
    SensorMaintenance_Ingest.add(createdBy: createdBy, &fbb)
    SensorMaintenance_Ingest.add(source: source, &fbb)
    SensorMaintenance_Ingest.add(origin: origin, &fbb)
    SensorMaintenance_Ingest.add(dataMode: dataMode, &fbb)
    SensorMaintenance_Ingest.add(origNetwork: origNetwork, &fbb)
    return SensorMaintenance_Ingest.endSensorMaintenance_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SensorMaintenance_Ingest_dataMode_Enum.self)
