...
public enum AirfieldSlotConsumption_Ingest_status_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AirfieldSlotConsumption_Ingest_status_Enum { return .other }
  public static var min: AirfieldSlotConsumption_Ingest_status_Enum { return .requested }
}


public enum AirfieldSlotConsumption_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: AirfieldSlotConsumption_Ingest_dataMode_Enum { return .exercise }
  public static var min: AirfieldSlotConsumption_Ingest_dataMode_Enum { return .real }
}


///  /// Airfield slot use data. Contains the dynamic data associated with the status and use of specific airfield slots.
public struct AirfieldSlotConsumption_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirfieldSlotConsumption_Ingest.id, addPrefix: prefix) }
  ...
  public var status: AirfieldSlotConsumption_Ingest_status_Enum { let o = _accessor.offset(VTOFFSET.status.v); return o == 0 ? .requested : AirfieldSlotConsumption_Ingest_status_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .requested }
  ...
  public var dataMode: AirfieldSlotConsumption_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AirfieldSlotConsumption_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startAirfieldSlotConsumption_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 37) }
  ...
  public static func add(status: AirfieldSlotConsumption_Ingest_status_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: status.rawValue, def: 0, at: VTOFFSET.status.p) }
  ...
  public static func add(dataMode: AirfieldSlotConsumption_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endAirfieldSlotConsumption_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirfieldSlotConsumption_Ingest(
    ...
    let __start = AirfieldSlotConsumption_Ingest.startAirfieldSlotConsumption_Ingest(&fbb)
    AirfieldSlotConsumption_Ingest.add(id: id, &fbb)
    AirfieldSlotConsumption_Ingest.add(classificationMarking: classificationMarking, &fbb)
    AirfieldSlotConsumption_Ingest.add(idAirfieldSlot: idAirfieldSlot, &fbb)
    AirfieldSlotConsumption_Ingest.add(status: status, &fbb)
    AirfieldSlotConsumption_Ingest.add(occupied: occupied, &fbb)
    AirfieldSlotConsumption_Ingest.add(consumer: consumer, &fbb)
    AirfieldSlotConsumption_Ingest.add(occAircraftMds: occAircraftMds, &fbb)
    AirfieldSlotConsumption_Ingest.add(occTailNumber: occTailNumber, &fbb)
    AirfieldSlotConsumption_Ingest.addVectorOf(callSigns: callSigns, &fbb)
    AirfieldSlotConsumption_Ingest.add(missionId: missionId, &fbb)
    AirfieldSlotConsumption_Ingest.add(numAircraft: numAircraft, &fbb)
    AirfieldSlotConsumption_Ingest.add(occStartTime: occStartTime, &fbb)
    AirfieldSlotConsumption_Ingest.add(resAircraftMds: resAircraftMds, &fbb)
    AirfieldSlotConsumption_Ingest.add(resTailNumber: resTailNumber, &fbb)
    AirfieldSlotConsumption_Ingest.add(resType: resType, &fbb)
    AirfieldSlotConsumption_Ingest.add(resReason: resReason, &fbb)
    AirfieldSlotConsumption_Ingest.add(resMissionId: resMissionId, &fbb)
    AirfieldSlotConsumption_Ingest.add(startTime: startTime, &fbb)
    AirfieldSlotConsumption_Ingest.add(endTime: endTime, &fbb)
    AirfieldSlotConsumption_Ingest.add(targetTime: targetTime, &fbb)
    AirfieldSlotConsumption_Ingest.add(idArrSortie: idArrSortie, &fbb)
    AirfieldSlotConsumption_Ingest.add(idDepSortie: idDepSortie, &fbb)
    AirfieldSlotConsumption_Ingest.add(altArrSortieId: altArrSortieId, &fbb)
    AirfieldSlotConsumption_Ingest.add(altDepSortieId: altDepSortieId, &fbb)
    AirfieldSlotConsumption_Ingest.add(reqComment: reqComment, &fbb)
    AirfieldSlotConsumption_Ingest.add(appComment: appComment, &fbb)
    AirfieldSlotConsumption_Ingest.add(reqOrg: reqOrg, &fbb)
    AirfieldSlotConsumption_Ingest.add(reqInitials: reqInitials, &fbb)
    AirfieldSlotConsumption_Ingest.add(appOrg: appOrg, &fbb)
    AirfieldSlotConsumption_Ingest.add(appInitials: appInitials, &fbb)
    AirfieldSlotConsumption_Ingest.add(createdAt: createdAt, &fbb)
    AirfieldSlotConsumption_Ingest.add(createdBy: createdBy, &fbb)
    AirfieldSlotConsumption_Ingest.add(sourceDl: sourceDl, &fbb)
    AirfieldSlotConsumption_Ingest.add(source: source, &fbb)
    AirfieldSlotConsumption_Ingest.add(origin: origin, &fbb)
    AirfieldSlotConsumption_Ingest.add(origNetwork: origNetwork, &fbb)
    AirfieldSlotConsumption_Ingest.add(dataMode: dataMode, &fbb)
    return AirfieldSlotConsumption_Ingest.endAirfieldSlotConsumption_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.status.p, fieldName: "status", required: false, type: AirfieldSlotConsumption_Ingest_status_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AirfieldSlotConsumption_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
