...
public enum Equipment_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Equipment_Ingest_dataMode_Enum { return .exercise }
  public static var min: Equipment_Ingest_dataMode_Enum { return .real }
}


///  /// Properties and characteristics of equipment that can be associated with a site or other entity.
public struct Equipment_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Equipment_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: Equipment_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Equipment_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startEquipment_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 53) }
  ...
  public static func add(dataMode: Equipment_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endEquipment_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEquipment_Ingest(
    ...
    let __start = Equipment_Ingest.startEquipment_Ingest(&fbb)
    Equipment_Ingest.add(id: id, &fbb)
    Equipment_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Equipment_Ingest.add(idParentEquipment: idParentEquipment, &fbb)
    Equipment_Ingest.add(idSite: idSite, &fbb)
    Equipment_Ingest.add(idOperatingUnit: idOperatingUnit, &fbb)
    Equipment_Ingest.add(altEqpId: altEqpId, &fbb)
    Equipment_Ingest.add(eqpCode: eqpCode, &fbb)
    Equipment_Ingest.add(eqpIdNum: eqpIdNum, &fbb)
    Equipment_Ingest.add(countryCode: countryCode, &fbb)
    Equipment_Ingest.add(altCountryCode: altCountryCode, &fbb)
    Equipment_Ingest.add(wac: wac, &fbb)
    Equipment_Ingest.add(seqNum: seqNum, &fbb)
    Equipment_Ingest.add(nomen: nomen, &fbb)
    Equipment_Ingest.add(operStatus: operStatus, &fbb)
    Equipment_Ingest.add(condition: condition, &fbb)
    Equipment_Ingest.add(conditionAvail: conditionAvail, &fbb)
    Equipment_Ingest.add(eval: eval, &fbb)
    Equipment_Ingest.add(fpa: fpa, &fbb)
    Equipment_Ingest.add(function: function, &fbb)
    Equipment_Ingest.add(ident: ident, &fbb)
    Equipment_Ingest.add(allegiance: allegiance, &fbb)
    Equipment_Ingest.add(altAllegiance: altAllegiance, &fbb)
    Equipment_Ingest.add(locReason: locReason, &fbb)
    Equipment_Ingest.add(operAreaPrimary: operAreaPrimary, &fbb)
    Equipment_Ingest.add(functPrimary: functPrimary, &fbb)
    Equipment_Ingest.add(coordDatum: coordDatum, &fbb)
    Equipment_Ingest.add(coord: coord, &fbb)
    Equipment_Ingest.add(coordDerivAcc: coordDerivAcc, &fbb)
    Equipment_Ingest.add(lat: lat, &fbb)
    Equipment_Ingest.add(lon: lon, &fbb)
    Equipment_Ingest.add(elevMsl: elevMsl, &fbb)
    Equipment_Ingest.add(elevMslConfLvl: elevMslConfLvl, &fbb)
    Equipment_Ingest.add(elevMslDerivAcc: elevMslDerivAcc, &fbb)
    Equipment_Ingest.add(geoidalMslSep: geoidalMslSep, &fbb)
    Equipment_Ingest.add(milGridSys: milGridSys, &fbb)
    Equipment_Ingest.add(milGrid: milGrid, &fbb)
    Equipment_Ingest.add(utm: utm, &fbb)
    Equipment_Ingest.add(airDefArea: airDefArea, &fbb)
    Equipment_Ingest.add(polSubdiv: polSubdiv, &fbb)
    Equipment_Ingest.add(qtyOh: qtyOh, &fbb)
    Equipment_Ingest.add(symCode: symCode, &fbb)
    Equipment_Ingest.add(classRating: classRating, &fbb)
    Equipment_Ingest.add(recStatus: recStatus, &fbb)
    Equipment_Ingest.add(reviewDate: reviewDate, &fbb)
    Equipment_Ingest.add(resProd: resProd, &fbb)
    Equipment_Ingest.add(referenceDoc: referenceDoc, &fbb)
    Equipment_Ingest.addVectorOf(srcTyps: srcTyps, &fbb)
    Equipment_Ingest.addVectorOf(srcIds: srcIds, &fbb)
    Equipment_Ingest.add(createdAt: createdAt, &fbb)
    Equipment_Ingest.add(createdBy: createdBy, &fbb)
    Equipment_Ingest.add(source: source, &fbb)
    Equipment_Ingest.add(origin: origin, &fbb)
    Equipment_Ingest.add(dataMode: dataMode, &fbb)
    return Equipment_Ingest.endEquipment_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Equipment_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
