...
public struct ISRCollectionPOC_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollectionPOC_Abridged.id, addPrefix: prefix) }
  ...
  public static func startISRCollectionPOC_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 10) }
  ...
  public static func endISRCollectionPOC_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollectionPOC_Abridged(
    ...
    let __start = ISRCollectionPOC_Abridged.startISRCollectionPOC_Abridged(&fbb)
    ISRCollectionPOC_Abridged.add(id: id, &fbb)
    ISRCollectionPOC_Abridged.add(name: name, &fbb)
    ISRCollectionPOC_Abridged.add(callsign: callsign, &fbb)
    ISRCollectionPOC_Abridged.add(unit: unit, &fbb)
    ISRCollectionPOC_Abridged.add(email: email, &fbb)
    ISRCollectionPOC_Abridged.add(phone: phone, &fbb)
    ISRCollectionPOC_Abridged.add(radioFrequency: radioFrequency, &fbb)
    ISRCollectionPOC_Abridged.add(chatSystem: chatSystem, &fbb)
    ISRCollectionPOC_Abridged.add(chatName: chatName, &fbb)
    ISRCollectionPOC_Abridged.add(notes: notes, &fbb)
    return ISRCollectionPOC_Abridged.endISRCollectionPOC_Abridged(&fbb, start: __start)
  }
