...
public struct FlightPlanAirRefuelEvents_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: FlightPlanAirRefuelEvents_Abridged.id, addPrefix: prefix) }
  ...
  public static func startFlightPlanAirRefuelEvents_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endFlightPlanAirRefuelEvents_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createFlightPlanAirRefuelEvents_Abridged(
    ...
    let __start = FlightPlanAirRefuelEvents_Abridged.startFlightPlanAirRefuelEvents_Abridged(&fbb)
    FlightPlanAirRefuelEvents_Abridged.add(arDegrade: arDegrade, &fbb)
    FlightPlanAirRefuelEvents_Abridged.add(arNum: arNum, &fbb)
    FlightPlanAirRefuelEvents_Abridged.add(arExchangedFuel: arExchangedFuel, &fbb)
    FlightPlanAirRefuelEvents_Abridged.add(divertFuel: divertFuel, &fbb)
    FlightPlanAirRefuelEvents_Abridged.add(exitFuel: exitFuel, &fbb)
    return FlightPlanAirRefuelEvents_Abridged.endFlightPlanAirRefuelEvents_Abridged(&fbb, start: __start)
  }
