...
public struct EvacCondition_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacCondition_Full.id, addPrefix: prefix) }
  ...
  public static func startEvacCondition_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endEvacCondition_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacCondition_Full(
    ...
    let __start = EvacCondition_Full.startEvacCondition_Full(&fbb)
    EvacCondition_Full.add(type: type, &fbb)
    EvacCondition_Full.add(bodyPart: bodyPart, &fbb)
    EvacCondition_Full.add(time: time, &fbb)
    EvacCondition_Full.add(comments: comments, &fbb)
    return EvacCondition_Full.endEvacCondition_Full(&fbb, start: __start)
  }
