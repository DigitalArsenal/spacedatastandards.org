...
public struct AirEventRemarks_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirEventRemarks_Full.id, addPrefix: prefix) }
  ...
  public static func startAirEventRemarks_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endAirEventRemarks_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirEventRemarks_Full(
    ...
    let __start = AirEventRemarks_Full.startAirEventRemarks_Full(&fbb)
    AirEventRemarks_Full.add(externalRemarkId: externalRemarkId, &fbb)
    AirEventRemarks_Full.add(text: text, &fbb)
    AirEventRemarks_Full.add(date: date, &fbb)
    AirEventRemarks_Full.add(user: user, &fbb)
    return AirEventRemarks_Full.endAirEventRemarks_Full(&fbb, start: __start)
  }
