...
public struct IonoObservationFrequency_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationFrequency_Abridged.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationFrequency_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationFrequency_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationFrequency_Abridged(
    ...
    let __start = IonoObservationFrequency_Abridged.startIonoObservationFrequency_Abridged(&fbb)
    IonoObservationFrequency_Abridged.add(notes: notes, &fbb)
    IonoObservationFrequency_Abridged.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationFrequency_Abridged.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationFrequency_Abridged.addVectorOf(data: data, &fbb)
    return IonoObservationFrequency_Abridged.endIonoObservationFrequency_Abridged(&fbb, start: __start)
  }
