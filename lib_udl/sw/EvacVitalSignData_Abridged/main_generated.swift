...
public struct EvacVitalSignData_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacVitalSignData_Abridged.id, addPrefix: prefix) }
  ...
  public static func startEvacVitalSignData_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endEvacVitalSignData_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacVitalSignData_Abridged(
    ...
    let __start = EvacVitalSignData_Abridged.startEvacVitalSignData_Abridged(&fbb)
    EvacVitalSignData_Abridged.add(vitalSign: vitalSign, &fbb)
    EvacVitalSignData_Abridged.add(vitalSign1: vitalSign1, &fbb)
    EvacVitalSignData_Abridged.add(vitalSign2: vitalSign2, &fbb)
    EvacVitalSignData_Abridged.add(medConfFactor: medConfFactor, &fbb)
    EvacVitalSignData_Abridged.add(time: time, &fbb)
    return EvacVitalSignData_Abridged.endEvacVitalSignData_Abridged(&fbb, start: __start)
  }
