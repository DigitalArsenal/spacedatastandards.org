...
public struct MtiHRR_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiHRR_Ingest.id, addPrefix: prefix) }
  ...
  public static func startMtiHRR_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 29) }
  ...
  public static func endMtiHRR_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiHRR_Ingest(
    ...
    let __start = MtiHRR_Ingest.startMtiHRR_Ingest(&fbb)
    MtiHRR_Ingest.add(h2: h2, &fbb)
    MtiHRR_Ingest.add(h3: h3, &fbb)
    MtiHRR_Ingest.add(h4: h4, &fbb)
    MtiHRR_Ingest.add(h5: h5, &fbb)
    MtiHRR_Ingest.add(h6: h6, &fbb)
    MtiHRR_Ingest.add(h7: h7, &fbb)
    MtiHRR_Ingest.add(h8: h8, &fbb)
    MtiHRR_Ingest.add(h9: h9, &fbb)
    MtiHRR_Ingest.add(h10: h10, &fbb)
    MtiHRR_Ingest.add(h11: h11, &fbb)
    MtiHRR_Ingest.add(h12: h12, &fbb)
    MtiHRR_Ingest.add(h13: h13, &fbb)
    MtiHRR_Ingest.add(h14: h14, &fbb)
    MtiHRR_Ingest.add(h15: h15, &fbb)
    MtiHRR_Ingest.add(h16: h16, &fbb)
    MtiHRR_Ingest.add(h17: h17, &fbb)
    MtiHRR_Ingest.add(h18: h18, &fbb)
    MtiHRR_Ingest.add(h19: h19, &fbb)
    MtiHRR_Ingest.add(h20: h20, &fbb)
    MtiHRR_Ingest.add(h21: h21, &fbb)
    MtiHRR_Ingest.add(h22: h22, &fbb)
    MtiHRR_Ingest.add(h23: h23, &fbb)
    MtiHRR_Ingest.add(h24: h24, &fbb)
    MtiHRR_Ingest.add(h27: h27, &fbb)
    MtiHRR_Ingest.add(h28: h28, &fbb)
    MtiHRR_Ingest.add(h29: h29, &fbb)
    MtiHRR_Ingest.add(h30: h30, &fbb)
    MtiHRR_Ingest.add(h31: h31, &fbb)
    MtiHRR_Ingest.addVectorOf(h32: h32, &fbb)
    return MtiHRR_Ingest.endMtiHRR_Ingest(&fbb, start: __start)
  }
