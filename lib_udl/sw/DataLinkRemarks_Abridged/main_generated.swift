...
public struct DataLinkRemarks_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DataLinkRemarks_Abridged.id, addPrefix: prefix) }
  ...
  public static func startDataLinkRemarks_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 2) }
  ...
  public static func endDataLinkRemarks_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDataLinkRemarks_Abridged(
    _ fbb: inout FlatBufferBuilder,
    typeOffset type: Offset = Offset(),
    textOffset text: Offset = Offset()
  ) -> Offset {
    let __start = DataLinkRemarks_Abridged.startDataLinkRemarks_Abridged(&fbb)
    DataLinkRemarks_Abridged.add(type: type, &fbb)
    DataLinkRemarks_Abridged.add(text: text, &fbb)
    return DataLinkRemarks_Abridged.endDataLinkRemarks_Abridged(&fbb, start: __start)
  }
