...
public struct PointOfContact_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: PointOfContact_Full.id, addPrefix: prefix) }
  ...
  public static func startPointOfContact_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 9) }
  ...
  public static func endPointOfContact_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPointOfContact_Full(
    ...
    let __start = PointOfContact_Full.startPointOfContact_Full(&fbb)
    PointOfContact_Full.add(pocSequenceId: pocSequenceId, &fbb)
    PointOfContact_Full.add(pocTypeName: pocTypeName, &fbb)
    PointOfContact_Full.add(pocName: pocName, &fbb)
    PointOfContact_Full.add(office: office, &fbb)
    PointOfContact_Full.add(username: username, &fbb)
    PointOfContact_Full.add(rank: rank, &fbb)
    PointOfContact_Full.add(pocOrg: pocOrg, &fbb)
    PointOfContact_Full.add(phone: phone, &fbb)
    PointOfContact_Full.add(remark: remark, &fbb)
    return PointOfContact_Full.endPointOfContact_Full(&fbb, start: __start)
  }
