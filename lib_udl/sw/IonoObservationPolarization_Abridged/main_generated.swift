...
public enum IonoObservationPolarization_Abridged_data_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: IonoObservationPolarization_Abridged_data_Enum { return .o }
  public static var min: IonoObservationPolarization_Abridged_data_Enum { return .x }
}
...
public struct IonoObservationPolarization_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationPolarization_Abridged.id, addPrefix: prefix) }
  ...
  ///  Example: /// Example: [[[[[[['X', 'O']]]]]]]
  ///  Constraints: No constraints specified.
  public var data: IonoObservationPolarization_Abridged_data_Enum { let o = _accessor.offset(VTOFFSET.data.v); return o == 0 ? .x : IonoObservationPolarization_Abridged_data_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .x }
  public static func startIonoObservationPolarization_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func add(data: IonoObservationPolarization_Abridged_data_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: data.rawValue, def: 0, at: VTOFFSET.data.p) }
  public static func endIonoObservationPolarization_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationPolarization_Abridged(
    ...
    let __start = IonoObservationPolarization_Abridged.startIonoObservationPolarization_Abridged(&fbb)
    IonoObservationPolarization_Abridged.add(notes: notes, &fbb)
    IonoObservationPolarization_Abridged.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationPolarization_Abridged.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationPolarization_Abridged.add(data: data, &fbb)
    return IonoObservationPolarization_Abridged.endIonoObservationPolarization_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.data.p, fieldName: "data", required: false, type: IonoObservationPolarization_Abridged_data_Enum.self)
    _v.finish()
  }
}
