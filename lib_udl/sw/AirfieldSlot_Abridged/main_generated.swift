...
public enum AirfieldSlot_Abridged_type_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AirfieldSlot_Abridged_type_Enum { return .other }
  public static var min: AirfieldSlot_Abridged_type_Enum { return .working }
}


public enum AirfieldSlot_Abridged_acSlotCat_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: AirfieldSlot_Abridged_acSlotCat_Enum { return .other }
  public static var min: AirfieldSlot_Abridged_acSlotCat_Enum { return .wide }
}


public enum AirfieldSlot_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: AirfieldSlot_Abridged_dataMode_Enum { return .exercise }
  public static var min: AirfieldSlot_Abridged_dataMode_Enum { return .real }
}
...
public struct AirfieldSlot_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirfieldSlot_Abridged.id, addPrefix: prefix) }
  ...
  public var type: AirfieldSlot_Abridged_type_Enum { let o = _accessor.offset(VTOFFSET.type.v); return o == 0 ? .working : AirfieldSlot_Abridged_type_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .working }
  ///  Largest category of aircraft supported in this slot (WIDE, NARROW, HELO, ALL, OTHER).
  ///  Example: /// Example: WIDE
  ///  Constraints: Minimum length = 0, Maximum length = 6
  public var acSlotCat: AirfieldSlot_Abridged_acSlotCat_Enum { let o = _accessor.offset(VTOFFSET.acSlotCat.v); return o == 0 ? .wide : AirfieldSlot_Abridged_acSlotCat_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .wide }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: AirfieldSlot_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AirfieldSlot_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startAirfieldSlot_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 21) }
  ...
  public static func add(type: AirfieldSlot_Abridged_type_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: type.rawValue, def: 0, at: VTOFFSET.type.p) }
  public static func add(acSlotCat: AirfieldSlot_Abridged_acSlotCat_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: acSlotCat.rawValue, def: 0, at: VTOFFSET.acSlotCat.p) }
  ...
  public static func add(dataMode: AirfieldSlot_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endAirfieldSlot_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirfieldSlot_Abridged(
    ...
    type: AirfieldSlot_Abridged_type_Enum = .working,
    ...
    let __start = AirfieldSlot_Abridged.startAirfieldSlot_Abridged(&fbb)
    AirfieldSlot_Abridged.add(id: id, &fbb)
    AirfieldSlot_Abridged.add(classificationMarking: classificationMarking, &fbb)
    AirfieldSlot_Abridged.add(airfieldName: airfieldName, &fbb)
    AirfieldSlot_Abridged.add(icao: icao, &fbb)
    AirfieldSlot_Abridged.add(idAirfield: idAirfield, &fbb)
    AirfieldSlot_Abridged.add(altAirfieldId: altAirfieldId, &fbb)
    AirfieldSlot_Abridged.add(name: name, &fbb)
    AirfieldSlot_Abridged.add(type: type, &fbb)
    AirfieldSlot_Abridged.add(acSlotCat: acSlotCat, &fbb)
    AirfieldSlot_Abridged.add(capacity: capacity, &fbb)
    AirfieldSlot_Abridged.add(startTime: startTime, &fbb)
    AirfieldSlot_Abridged.add(endTime: endTime, &fbb)
    AirfieldSlot_Abridged.add(minSeparation: minSeparation, &fbb)
    AirfieldSlot_Abridged.add(notes: notes, &fbb)
    AirfieldSlot_Abridged.add(createdAt: createdAt, &fbb)
    AirfieldSlot_Abridged.add(createdBy: createdBy, &fbb)
    AirfieldSlot_Abridged.add(sourceDl: sourceDl, &fbb)
    AirfieldSlot_Abridged.add(source: source, &fbb)
    AirfieldSlot_Abridged.add(origin: origin, &fbb)
    AirfieldSlot_Abridged.add(origNetwork: origNetwork, &fbb)
    AirfieldSlot_Abridged.add(dataMode: dataMode, &fbb)
    return AirfieldSlot_Abridged.endAirfieldSlot_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.type.p, fieldName: "type", required: false, type: AirfieldSlot_Abridged_type_Enum.self)
    try _v.visit(field: VTOFFSET.acSlotCat.p, fieldName: "acSlotCat", required: false, type: AirfieldSlot_Abridged_acSlotCat_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AirfieldSlot_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
