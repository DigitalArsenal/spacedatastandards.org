...
public enum AircraftStatus_Full_airToAirStatus_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AircraftStatus_Full_airToAirStatus_Enum { return .off }
  public static var min: AircraftStatus_Full_airToAirStatus_Enum { return .operational }
}


public enum AircraftStatus_Full_airToGroundStatus_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: AircraftStatus_Full_airToGroundStatus_Enum { return .off }
  public static var min: AircraftStatus_Full_airToGroundStatus_Enum { return .operational }
}


public enum AircraftStatus_Full_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: AircraftStatus_Full_dataMode_Enum { return .exercise }
  public static var min: AircraftStatus_Full_dataMode_Enum { return .real }
}
...
public struct AircraftStatus_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AircraftStatus_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 16
  public var airToAirStatus: AircraftStatus_Full_airToAirStatus_Enum { let o = _accessor.offset(VTOFFSET.airToAirStatus.v); return o == 0 ? .operational : AircraftStatus_Full_airToAirStatus_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .operational }
  ///  The status of the air-to-ground weapon release system (OPERATIONAL, NON-OPERATIONAL, OFF).
  ///  Example: /// Example: OPERATIONAL
  ///  Constraints: Minimum length = 0, Maximum length = 16
  public var airToGroundStatus: AircraftStatus_Full_airToGroundStatus_Enum { let o = _accessor.offset(VTOFFSET.airToGroundStatus.v); return o == 0 ? .operational : AircraftStatus_Full_airToGroundStatus_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .operational }
  ...
  public var dataMode: AircraftStatus_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AircraftStatus_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: OPS1
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startAircraftStatus_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 54) }
  ...
  public static func add(airToAirStatus: AircraftStatus_Full_airToAirStatus_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: airToAirStatus.rawValue, def: 0, at: VTOFFSET.airToAirStatus.p) }
  public static func add(airToGroundStatus: AircraftStatus_Full_airToGroundStatus_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: airToGroundStatus.rawValue, def: 0, at: VTOFFSET.airToGroundStatus.p) }
  ...
  public static func add(dataMode: AircraftStatus_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endAircraftStatus_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAircraftStatus_Full(
    ...
    let __start = AircraftStatus_Full.startAircraftStatus_Full(&fbb)
    AircraftStatus_Full.add(id: id, &fbb)
    AircraftStatus_Full.add(classificationMarking: classificationMarking, &fbb)
    AircraftStatus_Full.add(idAircraft: idAircraft, &fbb)
    AircraftStatus_Full.add(altAircraftId: altAircraftId, &fbb)
    AircraftStatus_Full.add(currentState: currentState, &fbb)
    AircraftStatus_Full.add(idAirfield: idAirfield, &fbb)
    AircraftStatus_Full.add(geoLoc: geoLoc, &fbb)
    AircraftStatus_Full.add(previousIcao: previousIcao, &fbb)
    AircraftStatus_Full.add(currentIcao: currentIcao, &fbb)
    AircraftStatus_Full.add(nextIcao: nextIcao, &fbb)
    AircraftStatus_Full.add(flightPhase: flightPhase, &fbb)
    AircraftStatus_Full.add(taStartTime: taStartTime, &fbb)
    AircraftStatus_Full.add(earliestTaendTime: earliestTaendTime, &fbb)
    AircraftStatus_Full.add(missionReadiness: missionReadiness, &fbb)
    AircraftStatus_Full.add(fuel: fuel, &fbb)
    AircraftStatus_Full.add(fuelFunction: fuelFunction, &fbb)
    AircraftStatus_Full.add(gunCapable: gunCapable, &fbb)
    AircraftStatus_Full.add(gunRdsType: gunRdsType, &fbb)
    AircraftStatus_Full.add(gunRdsMin: gunRdsMin, &fbb)
    AircraftStatus_Full.add(gunRdsMax: gunRdsMax, &fbb)
    AircraftStatus_Full.add(airToAirStatus: airToAirStatus, &fbb)
    AircraftStatus_Full.add(airToGroundStatus: airToGroundStatus, &fbb)
    AircraftStatus_Full.addVectorOf(inventory: inventory, &fbb)
    AircraftStatus_Full.addVectorOf(inventoryMin: inventoryMin, &fbb)
    AircraftStatus_Full.addVectorOf(inventoryMax: inventoryMax, &fbb)
    AircraftStatus_Full.addVectorOf(unavailableSys: unavailableSys, &fbb)
    AircraftStatus_Full.addVectorOf(additionalSys: additionalSys, &fbb)
    AircraftStatus_Full.add(notes: notes, &fbb)
    AircraftStatus_Full.add(mxRemark: mxRemark, &fbb)
    AircraftStatus_Full.add(maintStatus: maintStatus, &fbb)
    AircraftStatus_Full.add(maintStatusDriver: maintStatusDriver, &fbb)
    AircraftStatus_Full.add(maintPriority: maintPriority, &fbb)
    AircraftStatus_Full.add(alphaStatusCode: alphaStatusCode, &fbb)
    AircraftStatus_Full.add(maintStatusUpdate: maintStatusUpdate, &fbb)
    AircraftStatus_Full.add(lastInspectionDate: lastInspectionDate, &fbb)
    AircraftStatus_Full.add(maintPoc: maintPoc, &fbb)
    AircraftStatus_Full.add(groundStatus: groundStatus, &fbb)
    AircraftStatus_Full.add(contaminationStatus: contaminationStatus, &fbb)
    AircraftStatus_Full.add(fuelStatus: fuelStatus, &fbb)
    AircraftStatus_Full.add(lastUpdatedBy: lastUpdatedBy, &fbb)
    AircraftStatus_Full.add(troubleshootEtic: troubleshootEtic, &fbb)
    AircraftStatus_Full.add(etic: etic, &fbb)
    AircraftStatus_Full.add(parkLocation: parkLocation, &fbb)
    AircraftStatus_Full.add(parkLocationSystem: parkLocationSystem, &fbb)
    AircraftStatus_Full.add(idPoi: idPoi, &fbb)
    AircraftStatus_Full.add(createdAt: createdAt, &fbb)
    AircraftStatus_Full.add(createdBy: createdBy, &fbb)
    AircraftStatus_Full.add(updatedAt: updatedAt, &fbb)
    AircraftStatus_Full.add(updatedBy: updatedBy, &fbb)
    AircraftStatus_Full.add(sourceDl: sourceDl, &fbb)
    AircraftStatus_Full.add(source: source, &fbb)
    AircraftStatus_Full.add(origin: origin, &fbb)
    AircraftStatus_Full.add(dataMode: dataMode, &fbb)
    AircraftStatus_Full.add(origNetwork: origNetwork, &fbb)
    return AircraftStatus_Full.endAircraftStatus_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.airToAirStatus.p, fieldName: "airToAirStatus", required: false, type: AircraftStatus_Full_airToAirStatus_Enum.self)
    try _v.visit(field: VTOFFSET.airToGroundStatus.p, fieldName: "airToGroundStatus", required: false, type: AircraftStatus_Full_airToGroundStatus_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AircraftStatus_Full_dataMode_Enum.self)
