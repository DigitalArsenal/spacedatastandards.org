...
public enum TAIUTC_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: TAIUTC_Full_dataMode_Enum { return .exercise }
  public static var min: TAIUTC_Full_dataMode_Enum { return .real }
}
...
public struct TAIUTC_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: TAIUTC_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: TAIUTC_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : TAIUTC_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startTAIUTC_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 14) }
  ...
  public static func add(dataMode: TAIUTC_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endTAIUTC_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createTAIUTC_Full(
    ...
    let __start = TAIUTC_Full.startTAIUTC_Full(&fbb)
    TAIUTC_Full.add(id: id, &fbb)
    TAIUTC_Full.add(classificationMarking: classificationMarking, &fbb)
    TAIUTC_Full.add(adjustmentDate: adjustmentDate, &fbb)
    TAIUTC_Full.add(taiUtc: taiUtc, &fbb)
    TAIUTC_Full.add(multiplicationFactor: multiplicationFactor, &fbb)
    TAIUTC_Full.add(rawFileUri: rawFileUri, &fbb)
    TAIUTC_Full.add(source: source, &fbb)
    TAIUTC_Full.add(origin: origin, &fbb)
    TAIUTC_Full.add(origNetwork: origNetwork, &fbb)
    TAIUTC_Full.add(dataMode: dataMode, &fbb)
    TAIUTC_Full.add(createdAt: createdAt, &fbb)
    TAIUTC_Full.add(createdBy: createdBy, &fbb)
    TAIUTC_Full.add(updatedAt: updatedAt, &fbb)
    TAIUTC_Full.add(updatedBy: updatedBy, &fbb)
    return TAIUTC_Full.endTAIUTC_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: TAIUTC_Full_dataMode_Enum.self)
