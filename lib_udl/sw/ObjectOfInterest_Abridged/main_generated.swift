...
public enum ObjectOfInterest_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: ObjectOfInterest_Abridged_dataMode_Enum { return .exercise }
  public static var min: ObjectOfInterest_Abridged_dataMode_Enum { return .real }
}


///  /// OnOrbit objects of interest, which include information about the last known state of the object.
public struct ObjectOfInterest_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ObjectOfInterest_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: ObjectOfInterest_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : ObjectOfInterest_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startObjectOfInterest_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 43) }
  ...
  public static func add(dataMode: ObjectOfInterest_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endObjectOfInterest_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createObjectOfInterest_Abridged(
    ...
    let __start = ObjectOfInterest_Abridged.startObjectOfInterest_Abridged(&fbb)
    ObjectOfInterest_Abridged.add(id: id, &fbb)
    ObjectOfInterest_Abridged.add(classificationMarking: classificationMarking, &fbb)
    ObjectOfInterest_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    ObjectOfInterest_Abridged.add(satNo: satNo, &fbb)
    ObjectOfInterest_Abridged.add(name: name, &fbb)
    ObjectOfInterest_Abridged.add(sensorTaskingStartTime: sensorTaskingStartTime, &fbb)
    ObjectOfInterest_Abridged.add(sensorTaskingStopTime: sensorTaskingStopTime, &fbb)
    ObjectOfInterest_Abridged.add(priority: priority, &fbb)
    ObjectOfInterest_Abridged.add(status: status, &fbb)
    ObjectOfInterest_Abridged.add(statusDate: statusDate, &fbb)
    ObjectOfInterest_Abridged.add(description: description, &fbb)
    ObjectOfInterest_Abridged.add(lastObTime: lastObTime, &fbb)
    ObjectOfInterest_Abridged.add(missedObTime: missedObTime, &fbb)
    ObjectOfInterest_Abridged.addVectorOf(deltaVs: deltaVs, &fbb)
    ObjectOfInterest_Abridged.addVectorOf(deltaTs: deltaTs, &fbb)
    ObjectOfInterest_Abridged.add(svEpoch: svEpoch, &fbb)
    ObjectOfInterest_Abridged.add(x: x, &fbb)
    ObjectOfInterest_Abridged.add(y: y, &fbb)
    ObjectOfInterest_Abridged.add(z: z, &fbb)
    ObjectOfInterest_Abridged.add(xvel: xvel, &fbb)
    ObjectOfInterest_Abridged.add(yvel: yvel, &fbb)
    ObjectOfInterest_Abridged.add(zvel: zvel, &fbb)
    ObjectOfInterest_Abridged.add(elsetEpoch: elsetEpoch, &fbb)
    ObjectOfInterest_Abridged.add(meanMotion: meanMotion, &fbb)
    ObjectOfInterest_Abridged.add(eccentricity: eccentricity, &fbb)
    ObjectOfInterest_Abridged.add(inclination: inclination, &fbb)
    ObjectOfInterest_Abridged.add(raan: raan, &fbb)
    ObjectOfInterest_Abridged.add(argOfPerigee: argOfPerigee, &fbb)
    ObjectOfInterest_Abridged.add(meanAnomaly: meanAnomaly, &fbb)
    ObjectOfInterest_Abridged.add(revNo: revNo, &fbb)
    ObjectOfInterest_Abridged.add(bStar: bStar, &fbb)
    ObjectOfInterest_Abridged.add(meanMotionDot: meanMotionDot, &fbb)
    ObjectOfInterest_Abridged.add(meanMotionDdot: meanMotionDdot, &fbb)
    ObjectOfInterest_Abridged.add(semiMajorAxis: semiMajorAxis, &fbb)
    ObjectOfInterest_Abridged.add(period: period, &fbb)
    ObjectOfInterest_Abridged.add(apogee: apogee, &fbb)
    ObjectOfInterest_Abridged.add(perigee: perigee, &fbb)
    ObjectOfInterest_Abridged.add(createdAt: createdAt, &fbb)
    ObjectOfInterest_Abridged.add(createdBy: createdBy, &fbb)
    ObjectOfInterest_Abridged.add(source: source, &fbb)
    ObjectOfInterest_Abridged.add(origin: origin, &fbb)
    ObjectOfInterest_Abridged.add(origNetwork: origNetwork, &fbb)
    ObjectOfInterest_Abridged.add(dataMode: dataMode, &fbb)
    return ObjectOfInterest_Abridged.endObjectOfInterest_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: ObjectOfInterest_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
