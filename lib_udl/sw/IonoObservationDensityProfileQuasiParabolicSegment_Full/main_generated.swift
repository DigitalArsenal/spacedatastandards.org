...
public struct IonoObservationDensityProfileQuasiParabolicSegment_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDensityProfileQuasiParabolicSegment_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDensityProfileQuasiParabolicSegment_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 7) }
  ...
  public static func endIonoObservationDensityProfileQuasiParabolicSegment_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDensityProfileQuasiParabolicSegment_Full(
    ...
    let __start = IonoObservationDensityProfileQuasiParabolicSegment_Full.startIonoObservationDensityProfileQuasiParabolicSegment_Full(&fbb)
    IonoObservationDensityProfileQuasiParabolicSegment_Full.add(index: index, &fbb)
    IonoObservationDensityProfileQuasiParabolicSegment_Full.add(rb: rb, &fbb)
    IonoObservationDensityProfileQuasiParabolicSegment_Full.add(re: re, &fbb)
    IonoObservationDensityProfileQuasiParabolicSegment_Full.add(a: a, &fbb)
    IonoObservationDensityProfileQuasiParabolicSegment_Full.add(b: b, &fbb)
    IonoObservationDensityProfileQuasiParabolicSegment_Full.add(c: c, &fbb)
    IonoObservationDensityProfileQuasiParabolicSegment_Full.add(error: error, &fbb)
    return IonoObservationDensityProfileQuasiParabolicSegment_Full.endIonoObservationDensityProfileQuasiParabolicSegment_Full(&fbb, start: __start)
  }
