...
public enum ECPSDR_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: ECPSDR_Abridged_dataMode_Enum { return .exercise }
  public static var min: ECPSDR_Abridged_dataMode_Enum { return .real }
}
...
public struct ECPSDR_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ECPSDR_Abridged.id, addPrefix: prefix) }
  ...
  ///  Example: /// Example: TEST
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: ECPSDR_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : ECPSDR_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startECPSDR_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 52) }
  ...
  public static func add(dataMode: ECPSDR_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endECPSDR_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createECPSDR_Abridged(
    ...
    let __start = ECPSDR_Abridged.startECPSDR_Abridged(&fbb)
    ECPSDR_Abridged.add(id: id, &fbb)
    ECPSDR_Abridged.add(classificationMarking: classificationMarking, &fbb)
    ECPSDR_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    ECPSDR_Abridged.add(satNo: satNo, &fbb)
    ECPSDR_Abridged.add(origObjectId: origObjectId, &fbb)
    ECPSDR_Abridged.add(idSensor: idSensor, &fbb)
    ECPSDR_Abridged.add(origSensorId: origSensorId, &fbb)
    ECPSDR_Abridged.add(type: type, &fbb)
    ECPSDR_Abridged.add(msgTime: msgTime, &fbb)
    ECPSDR_Abridged.add(obTime: obTime, &fbb)
    ECPSDR_Abridged.add(retransmit: retransmit, &fbb)
    ECPSDR_Abridged.add(senMode: senMode, &fbb)
    ECPSDR_Abridged.add(dosBias: dosBias, &fbb)
    ECPSDR_Abridged.add(asl5VcurrMon: asl5VcurrMon, &fbb)
    ECPSDR_Abridged.add(dsl5VcurrMon: dsl5VcurrMon, &fbb)
    ECPSDR_Abridged.add(psTempMon: psTempMon, &fbb)
    ECPSDR_Abridged.add(cdsPlateVmon: cdsPlateVmon, &fbb)
    ECPSDR_Abridged.add(cdsRefVmon: cdsRefVmon, &fbb)
    ECPSDR_Abridged.add(mpTemp: mpTemp, &fbb)
    ECPSDR_Abridged.add(vRef: vRef, &fbb)
    ECPSDR_Abridged.add(pd1SigLev: pd1SigLev, &fbb)
    ECPSDR_Abridged.add(pd2SigLev: pd2SigLev, &fbb)
    ECPSDR_Abridged.add(esdTrigCountL: esdTrigCountL, &fbb)
    ECPSDR_Abridged.add(esdTrigCountH: esdTrigCountH, &fbb)
    ECPSDR_Abridged.add(lowLetL: lowLetL, &fbb)
    ECPSDR_Abridged.add(lowLetM: lowLetM, &fbb)
    ECPSDR_Abridged.add(medLet1L: medLet1L, &fbb)
    ECPSDR_Abridged.add(medLet1M: medLet1M, &fbb)
    ECPSDR_Abridged.add(medLet2L: medLet2L, &fbb)
    ECPSDR_Abridged.add(medLet2M: medLet2M, &fbb)
    ECPSDR_Abridged.add(medLet3L: medLet3L, &fbb)
    ECPSDR_Abridged.add(medLet3M: medLet3M, &fbb)
    ECPSDR_Abridged.add(medLet4L: medLet4L, &fbb)
    ECPSDR_Abridged.add(medLet4M: medLet4M, &fbb)
    ECPSDR_Abridged.add(hiLetL: hiLetL, &fbb)
    ECPSDR_Abridged.add(hiLetM: hiLetM, &fbb)
    ECPSDR_Abridged.add(surfDosL: surfDosL, &fbb)
    ECPSDR_Abridged.add(surfDosM: surfDosM, &fbb)
    ECPSDR_Abridged.add(surfDosH: surfDosH, &fbb)
    ECPSDR_Abridged.add(surfDosChargeL: surfDosChargeL, &fbb)
    ECPSDR_Abridged.add(surfDosChargeH: surfDosChargeH, &fbb)
    ECPSDR_Abridged.add(surfDosStat: surfDosStat, &fbb)
    ECPSDR_Abridged.add(cdsThrottle: cdsThrottle, &fbb)
    ECPSDR_Abridged.add(cdsThreshold: cdsThreshold, &fbb)
    ECPSDR_Abridged.add(checksum: checksum, &fbb)
    ECPSDR_Abridged.addVectorOf(transientData: transientData, &fbb)
    ECPSDR_Abridged.add(createdAt: createdAt, &fbb)
    ECPSDR_Abridged.add(createdBy: createdBy, &fbb)
    ECPSDR_Abridged.add(source: source, &fbb)
    ECPSDR_Abridged.add(origin: origin, &fbb)
    ECPSDR_Abridged.add(origNetwork: origNetwork, &fbb)
    ECPSDR_Abridged.add(dataMode: dataMode, &fbb)
    return ECPSDR_Abridged.endECPSDR_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: ECPSDR_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
