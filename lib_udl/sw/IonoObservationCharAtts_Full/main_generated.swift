...
public struct IonoObservationCharAtts_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationCharAtts_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationCharAtts_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 10) }
  ...
  public static func endIonoObservationCharAtts_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationCharAtts_Full(
    ...
    let __start = IonoObservationCharAtts_Full.startIonoObservationCharAtts_Full(&fbb)
    IonoObservationCharAtts_Full.add(ursiId: ursiId, &fbb)
    IonoObservationCharAtts_Full.add(charName: charName, &fbb)
    IonoObservationCharAtts_Full.add(lowerBound: lowerBound, &fbb)
    IonoObservationCharAtts_Full.add(upperBound: upperBound, &fbb)
    IonoObservationCharAtts_Full.add(q: q, &fbb)
    IonoObservationCharAtts_Full.add(d: d, &fbb)
    IonoObservationCharAtts_Full.add(climateModelName: climateModelName, &fbb)
    IonoObservationCharAtts_Full.addVectorOf(climateModelOptions: climateModelOptions, &fbb)
    IonoObservationCharAtts_Full.addVectorOf(climateModelInputParams: climateModelInputParams, &fbb)
    IonoObservationCharAtts_Full.add(uncertaintyBoundType: uncertaintyBoundType, &fbb)
    return IonoObservationCharAtts_Full.endIonoObservationCharAtts_Full(&fbb, start: __start)
  }
