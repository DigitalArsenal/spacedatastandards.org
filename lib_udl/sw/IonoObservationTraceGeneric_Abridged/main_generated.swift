...
public struct IonoObservationTraceGeneric_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationTraceGeneric_Abridged.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationTraceGeneric_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endIonoObservationTraceGeneric_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationTraceGeneric_Abridged(
    ...
    let __start = IonoObservationTraceGeneric_Abridged.startIonoObservationTraceGeneric_Abridged(&fbb)
    IonoObservationTraceGeneric_Abridged.addVectorOf(data: data, &fbb)
    IonoObservationTraceGeneric_Abridged.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationTraceGeneric_Abridged.add(notes: notes, &fbb)
    return IonoObservationTraceGeneric_Abridged.endIonoObservationTraceGeneric_Abridged(&fbb, start: __start)
  }
