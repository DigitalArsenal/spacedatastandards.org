...
public struct FlightPlanWaypoints_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: FlightPlanWaypoints_Full.id, addPrefix: prefix) }
  ...
  public static func startFlightPlanWaypoints_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 56) }
  ...
  public static func endFlightPlanWaypoints_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createFlightPlanWaypoints_Full(
    ...
    let __start = FlightPlanWaypoints_Full.startFlightPlanWaypoints_Full(&fbb)
    FlightPlanWaypoints_Full.add(type: type, &fbb)
    FlightPlanWaypoints_Full.add(waypointName: waypointName, &fbb)
    FlightPlanWaypoints_Full.add(waypointNum: waypointNum, &fbb)
    FlightPlanWaypoints_Full.add(airway: airway, &fbb)
    FlightPlanWaypoints_Full.add(arpt: arpt, &fbb)
    FlightPlanWaypoints_Full.add(lat: lat, &fbb)
    FlightPlanWaypoints_Full.add(lon: lon, &fbb)
    FlightPlanWaypoints_Full.add(arId: arId, &fbb)
    FlightPlanWaypoints_Full.add(navaid: navaid, &fbb)
    FlightPlanWaypoints_Full.add(tacanChannel: tacanChannel, &fbb)
    FlightPlanWaypoints_Full.add(vorFreq: vorFreq, &fbb)
    FlightPlanWaypoints_Full.add(turbCat: turbCat, &fbb)
    FlightPlanWaypoints_Full.add(iceCat: iceCat, &fbb)
    FlightPlanWaypoints_Full.add(thunderCat: thunderCat, &fbb)
    FlightPlanWaypoints_Full.add(alt: alt, &fbb)
    FlightPlanWaypoints_Full.add(tempDev: tempDev, &fbb)
    FlightPlanWaypoints_Full.add(legFuelDegrade: legFuelDegrade, &fbb)
    FlightPlanWaypoints_Full.add(legMach: legMach, &fbb)
    FlightPlanWaypoints_Full.add(legMsnIndex: legMsnIndex, &fbb)
    FlightPlanWaypoints_Full.add(legDragIndex: legDragIndex, &fbb)
    FlightPlanWaypoints_Full.add(avgCalAirspeed: avgCalAirspeed, &fbb)
    FlightPlanWaypoints_Full.add(avgTrueAirspeed: avgTrueAirspeed, &fbb)
    FlightPlanWaypoints_Full.add(avgGroundSpeed: avgGroundSpeed, &fbb)
    FlightPlanWaypoints_Full.add(priFreq: priFreq, &fbb)
    FlightPlanWaypoints_Full.add(pointWindDir: pointWindDir, &fbb)
    FlightPlanWaypoints_Full.add(pointWindSpeed: pointWindSpeed, &fbb)
    FlightPlanWaypoints_Full.add(avgWindDir: avgWindDir, &fbb)
    FlightPlanWaypoints_Full.add(avgWindSpeed: avgWindSpeed, &fbb)
    FlightPlanWaypoints_Full.add(legWindFac: legWindFac, &fbb)
    FlightPlanWaypoints_Full.add(avgDriftAng: avgDriftAng, &fbb)
    FlightPlanWaypoints_Full.add(secFreq: secFreq, &fbb)
    FlightPlanWaypoints_Full.add(magCourse: magCourse, &fbb)
    FlightPlanWaypoints_Full.add(trueCourse: trueCourse, &fbb)
    FlightPlanWaypoints_Full.add(magHeading: magHeading, &fbb)
    FlightPlanWaypoints_Full.add(aaTacanChannel: aaTacanChannel, &fbb)
    FlightPlanWaypoints_Full.add(zoneDistance: zoneDistance, &fbb)
    FlightPlanWaypoints_Full.add(totalFlownDistance: totalFlownDistance, &fbb)
    FlightPlanWaypoints_Full.add(totalRemDistance: totalRemDistance, &fbb)
    FlightPlanWaypoints_Full.add(zoneTime: zoneTime, &fbb)
    FlightPlanWaypoints_Full.add(totalTime: totalTime, &fbb)
    FlightPlanWaypoints_Full.add(totalTimeRem: totalTimeRem, &fbb)
    FlightPlanWaypoints_Full.add(zoneFuel: zoneFuel, &fbb)
    FlightPlanWaypoints_Full.add(totalUsedFuel: totalUsedFuel, &fbb)
    FlightPlanWaypoints_Full.add(totalRemFuel: totalRemFuel, &fbb)
    FlightPlanWaypoints_Full.add(exchangedFuel: exchangedFuel, &fbb)
    FlightPlanWaypoints_Full.add(airDistance: airDistance, &fbb)
    FlightPlanWaypoints_Full.add(totalAirDistance: totalAirDistance, &fbb)
    FlightPlanWaypoints_Full.add(totalWeight: totalWeight, &fbb)
    FlightPlanWaypoints_Full.add(eta: eta, &fbb)
    FlightPlanWaypoints_Full.add(ata: ata, &fbb)
    FlightPlanWaypoints_Full.add(fuelFlow: fuelFlow, &fbb)
    FlightPlanWaypoints_Full.add(legAlternate: legAlternate, &fbb)
    FlightPlanWaypoints_Full.add(magVar: magVar, &fbb)
    FlightPlanWaypoints_Full.add(dayLowAlt: dayLowAlt, &fbb)
    FlightPlanWaypoints_Full.add(nightLowAlt: nightLowAlt, &fbb)
    FlightPlanWaypoints_Full.add(nvgLowAlt: nvgLowAlt, &fbb)
    return FlightPlanWaypoints_Full.endFlightPlanWaypoints_Full(&fbb, start: __start)
  }
