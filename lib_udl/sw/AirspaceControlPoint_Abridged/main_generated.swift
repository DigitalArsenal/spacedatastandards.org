...
public struct AirspaceControlPoint_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirspaceControlPoint_Abridged.id, addPrefix: prefix) }
  ...
  public static func startAirspaceControlPoint_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endAirspaceControlPoint_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirspaceControlPoint_Abridged(
    ...
    let __start = AirspaceControlPoint_Abridged.startAirspaceControlPoint_Abridged(&fbb)
    AirspaceControlPoint_Abridged.add(ctrlPtType: ctrlPtType, &fbb)
    AirspaceControlPoint_Abridged.add(ctrlPtName: ctrlPtName, &fbb)
    AirspaceControlPoint_Abridged.add(ctrlPtLocation: ctrlPtLocation, &fbb)
    AirspaceControlPoint_Abridged.add(ctrlPtAltitude: ctrlPtAltitude, &fbb)
    return AirspaceControlPoint_Abridged.endAirspaceControlPoint_Abridged(&fbb, start: __start)
  }
