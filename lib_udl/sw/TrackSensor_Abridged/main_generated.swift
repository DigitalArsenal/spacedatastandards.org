...
public enum TrackSensor_Abridged_sensorFOVType_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: TrackSensor_Abridged_sensorFOVType_Enum { return .unknown }
  public static var min: TrackSensor_Abridged_sensorFOVType_Enum { return .butterfly }
}


///  /// Schema for Track Sensor data.
public struct TrackSensor_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: TrackSensor_Abridged.id, addPrefix: prefix) }
  ...
  public var sensorFovtype: TrackSensor_Abridged_sensorFOVType_Enum { let o = _accessor.offset(VTOFFSET.sensorFovtype.v); return o == 0 ? .butterfly : TrackSensor_Abridged_sensorFOVType_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .butterfly }
  public static func startTrackSensor_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 7) }
  ...
  public static func add(sensorFovtype: TrackSensor_Abridged_sensorFOVType_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: sensorFovtype.rawValue, def: 0, at: VTOFFSET.sensorFovtype.p) }
  public static func endTrackSensor_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createTrackSensor_Abridged(
    ...
    let __start = TrackSensor_Abridged.startTrackSensor_Abridged(&fbb)
    TrackSensor_Abridged.add(range: range, &fbb)
    TrackSensor_Abridged.add(az: az, &fbb)
    TrackSensor_Abridged.add(sensorNumber: sensorNumber, &fbb)
    TrackSensor_Abridged.add(sensorName: sensorName, &fbb)
    TrackSensor_Abridged.add(missionNumber: missionNumber, &fbb)
    TrackSensor_Abridged.add(minRangeLimit: minRangeLimit, &fbb)
    TrackSensor_Abridged.add(sensorFovtype: sensorFovtype, &fbb)
    return TrackSensor_Abridged.endTrackSensor_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.sensorFovtype.p, fieldName: "sensorFovtype", required: false, type: TrackSensor_Abridged_sensorFOVType_Enum.self)
    _v.finish()
  }
}
