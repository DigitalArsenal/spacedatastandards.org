...
public enum OnorbitThruster_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OnorbitThruster_dataMode_Enum { return .exercise }
  public static var min: OnorbitThruster_dataMode_Enum { return .real }
}


///  /// Read-only collection of thrusters (engines) on this on-orbit object.
public struct OnorbitThruster: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OnorbitThruster.id, addPrefix: prefix) }
  ...
  public var dataMode: OnorbitThruster_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OnorbitThruster_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOnorbitThruster(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 15) }
  ...
  public static func add(dataMode: OnorbitThruster_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endOnorbitThruster(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnorbitThruster(
    ...
    let __start = OnorbitThruster.startOnorbitThruster(&fbb)
    OnorbitThruster.add(id: id, &fbb)
    OnorbitThruster.add(idOnOrbit: idOnOrbit, &fbb)
    OnorbitThruster.add(idEngine: idEngine, &fbb)
    OnorbitThruster.add(classificationMarking: classificationMarking, &fbb)
    OnorbitThruster.add(type: type, &fbb)
    OnorbitThruster.add(quantity: quantity, &fbb)
    OnorbitThruster.add(createdAt: createdAt, &fbb)
    OnorbitThruster.add(createdBy: createdBy, &fbb)
    OnorbitThruster.add(updatedAt: updatedAt, &fbb)
    OnorbitThruster.add(updatedBy: updatedBy, &fbb)
    OnorbitThruster.add(source: source, &fbb)
    OnorbitThruster.add(origin: origin, &fbb)
    OnorbitThruster.add(dataMode: dataMode, &fbb)
    OnorbitThruster.add(engine: engine, &fbb)
    OnorbitThruster.add(origNetwork: origNetwork, &fbb)
    return OnorbitThruster.endOnorbitThruster(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OnorbitThruster_dataMode_Enum.self)
