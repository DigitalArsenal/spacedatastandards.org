...
public enum SeradataEarlyWarning_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SeradataEarlyWarning_Ingest_dataMode_Enum { return .exercise }
  public static var min: SeradataEarlyWarning_Ingest_dataMode_Enum { return .real }
}


///  /// Details for an early warning payload from  Seradata.
public struct SeradataEarlyWarning_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SeradataEarlyWarning_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: SeradataEarlyWarning_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SeradataEarlyWarning_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSeradataEarlyWarning_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 22) }
  ...
  public static func add(dataMode: SeradataEarlyWarning_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSeradataEarlyWarning_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSeradataEarlyWarning_Ingest(
    ...
    let __start = SeradataEarlyWarning_Ingest.startSeradataEarlyWarning_Ingest(&fbb)
    SeradataEarlyWarning_Ingest.add(id: id, &fbb)
    SeradataEarlyWarning_Ingest.add(classificationMarking: classificationMarking, &fbb)
    SeradataEarlyWarning_Ingest.add(idIr: idIr, &fbb)
    SeradataEarlyWarning_Ingest.add(spacecraftId: spacecraftId, &fbb)
    SeradataEarlyWarning_Ingest.add(hostedForCompanyOrgId: hostedForCompanyOrgId, &fbb)
    SeradataEarlyWarning_Ingest.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    SeradataEarlyWarning_Ingest.add(name: name, &fbb)
    SeradataEarlyWarning_Ingest.add(spectralBands: spectralBands, &fbb)
    SeradataEarlyWarning_Ingest.add(frequencyLimits: frequencyLimits, &fbb)
    SeradataEarlyWarning_Ingest.add(bestResolution: bestResolution, &fbb)
    SeradataEarlyWarning_Ingest.add(groundStations: groundStations, &fbb)
    SeradataEarlyWarning_Ingest.add(groundStationLocations: groundStationLocations, &fbb)
    SeradataEarlyWarning_Ingest.add(missileLaunchPhaseDetectionAbility: missileLaunchPhaseDetectionAbility, &fbb)
    SeradataEarlyWarning_Ingest.add(earthPointing: earthPointing, &fbb)
    SeradataEarlyWarning_Ingest.add(partnerSpacecraftId: partnerSpacecraftId, &fbb)
    SeradataEarlyWarning_Ingest.add(payloadNotes: payloadNotes, &fbb)
    SeradataEarlyWarning_Ingest.add(createdAt: createdAt, &fbb)
    SeradataEarlyWarning_Ingest.add(createdBy: createdBy, &fbb)
    SeradataEarlyWarning_Ingest.add(source: source, &fbb)
    SeradataEarlyWarning_Ingest.add(origin: origin, &fbb)
    SeradataEarlyWarning_Ingest.add(origNetwork: origNetwork, &fbb)
    SeradataEarlyWarning_Ingest.add(dataMode: dataMode, &fbb)
    return SeradataEarlyWarning_Ingest.endSeradataEarlyWarning_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SeradataEarlyWarning_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
