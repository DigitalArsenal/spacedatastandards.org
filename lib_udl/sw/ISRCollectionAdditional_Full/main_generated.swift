...
public struct ISRCollectionAdditional_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollectionAdditional_Full.id, addPrefix: prefix) }
  ...
  public static func startISRCollectionAdditional_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endISRCollectionAdditional_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollectionAdditional_Full(
    _ fbb: inout FlatBufferBuilder,
    idOffset id: Offset = Offset(),
    startOffset start: Offset = Offset(),
    stopOffset stop: Offset = Offset()
  ) -> Offset {
    let __start = ISRCollectionAdditional_Full.startISRCollectionAdditional_Full(&fbb)
    ISRCollectionAdditional_Full.add(id: id, &fbb)
    ISRCollectionAdditional_Full.add(start: start, &fbb)
    ISRCollectionAdditional_Full.add(stop: stop, &fbb)
    return ISRCollectionAdditional_Full.endISRCollectionAdditional_Full(&fbb, start: __start)
  }
