...
public enum MonoRadar_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: MonoRadar_Ingest_dataMode_Enum { return .exercise }
  public static var min: MonoRadar_Ingest_dataMode_Enum { return .real }
}
...
public struct MonoRadar_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MonoRadar_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: MonoRadar_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : MonoRadar_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startMonoRadar_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 73) }
  ...
  public static func add(dataMode: MonoRadar_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endMonoRadar_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMonoRadar_Ingest(
    ...
    let __start = MonoRadar_Ingest.startMonoRadar_Ingest(&fbb)
    MonoRadar_Ingest.add(id: id, &fbb)
    MonoRadar_Ingest.add(classificationMarking: classificationMarking, &fbb)
    MonoRadar_Ingest.add(tti: tti, &fbb)
    MonoRadar_Ingest.add(idSensor: idSensor, &fbb)
    MonoRadar_Ingest.add(senlat: senlat, &fbb)
    MonoRadar_Ingest.add(senlon: senlon, &fbb)
    MonoRadar_Ingest.add(senalt: senalt, &fbb)
    MonoRadar_Ingest.add(sac: sac, &fbb)
    MonoRadar_Ingest.add(sic: sic, &fbb)
    MonoRadar_Ingest.add(tgtid: tgtid, &fbb)
    MonoRadar_Ingest.add(addr: addr, &fbb)
    MonoRadar_Ingest.add(msgfmt: msgfmt, &fbb)
    MonoRadar_Ingest.add(msgtyp: msgtyp, &fbb)
    MonoRadar_Ingest.add(af: af, &fbb)
    MonoRadar_Ingest.add(faa: faa, &fbb)
    MonoRadar_Ingest.add(spi: spi, &fbb)
    MonoRadar_Ingest.add(aims: aims, &fbb)
    MonoRadar_Ingest.add(mti: mti, &fbb)
    MonoRadar_Ingest.add(bcnhits: bcnhits, &fbb)
    MonoRadar_Ingest.add(ts: ts, &fbb)
    MonoRadar_Ingest.add(msgts: msgts, &fbb)
    MonoRadar_Ingest.add(rng: rng, &fbb)
    MonoRadar_Ingest.add(az: az, &fbb)
    MonoRadar_Ingest.add(acp: acp, &fbb)
    MonoRadar_Ingest.add(alt3d: alt3d, &fbb)
    MonoRadar_Ingest.add(mc: mc, &fbb)
    MonoRadar_Ingest.add(mcv: mcv, &fbb)
    MonoRadar_Ingest.add(mcg: mcg, &fbb)
    MonoRadar_Ingest.add(m1: m1, &fbb)
    MonoRadar_Ingest.add(m1v: m1v, &fbb)
    MonoRadar_Ingest.add(m1g: m1g, &fbb)
    MonoRadar_Ingest.add(m2: m2, &fbb)
    MonoRadar_Ingest.add(m2v: m2v, &fbb)
    MonoRadar_Ingest.add(m2xv: m2xv, &fbb)
    MonoRadar_Ingest.add(m2g: m2g, &fbb)
    MonoRadar_Ingest.add(m3a: m3a, &fbb)
    MonoRadar_Ingest.add(m3av: m3av, &fbb)
    MonoRadar_Ingest.add(m3ag: m3ag, &fbb)
    MonoRadar_Ingest.add(m3axv: m3axv, &fbb)
    MonoRadar_Ingest.add(m4: m4, &fbb)
    MonoRadar_Ingest.add(m4v: m4v, &fbb)
    MonoRadar_Ingest.add(m4d1d2: m4d1d2, &fbb)
    MonoRadar_Ingest.add(mscommb: mscommb, &fbb)
    MonoRadar_Ingest.add(milemrgcy: milemrgcy, &fbb)
    MonoRadar_Ingest.add(code7500: code7500, &fbb)
    MonoRadar_Ingest.add(code7600: code7600, &fbb)
    MonoRadar_Ingest.add(code7700: code7700, &fbb)
    MonoRadar_Ingest.add(grndspd: grndspd, &fbb)
    MonoRadar_Ingest.add(hdng: hdng, &fbb)
    MonoRadar_Ingest.add(trknum: trknum, &fbb)
    MonoRadar_Ingest.add(rad: rad, &fbb)
    MonoRadar_Ingest.add(mah: mah, &fbb)
    MonoRadar_Ingest.add(cdm: cdm, &fbb)
    MonoRadar_Ingest.addVectorOf(cartpos: cartpos, &fbb)
    MonoRadar_Ingest.add(psrrl: psrrl, &fbb)
    MonoRadar_Ingest.add(ssrl: ssrl, &fbb)
    MonoRadar_Ingest.add(rngdelt: rngdelt, &fbb)
    MonoRadar_Ingest.add(azdelt: azdelt, &fbb)
    MonoRadar_Ingest.addVectorOf(wectc: wectc, &fbb)
    MonoRadar_Ingest.add(mrgrpt: mrgrpt, &fbb)
    MonoRadar_Ingest.add(artsqual: artsqual, &fbb)
    MonoRadar_Ingest.add(trkelig: trkelig, &fbb)
    MonoRadar_Ingest.add(tgtconf: tgtconf, &fbb)
    MonoRadar_Ingest.add(tgtcorr: tgtcorr, &fbb)
    MonoRadar_Ingest.add(tis: tis, &fbb)
    MonoRadar_Ingest.addVectorOf(tags: tags, &fbb)
    MonoRadar_Ingest.add(origSensorId: origSensorId, &fbb)
    MonoRadar_Ingest.add(source: source, &fbb)
    MonoRadar_Ingest.add(origin: origin, &fbb)
    MonoRadar_Ingest.add(dataMode: dataMode, &fbb)
    MonoRadar_Ingest.add(createdAt: createdAt, &fbb)
    MonoRadar_Ingest.add(createdBy: createdBy, &fbb)
    MonoRadar_Ingest.add(origNetwork: origNetwork, &fbb)
    return MonoRadar_Ingest.endMonoRadar_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: MonoRadar_Ingest_dataMode_Enum.self)
