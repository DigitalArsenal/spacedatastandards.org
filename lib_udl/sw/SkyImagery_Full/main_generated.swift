...
public enum SkyImagery_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SkyImagery_Full_dataMode_Enum { return .exercise }
  public static var min: SkyImagery_Full_dataMode_Enum { return .real }
}
...
public struct SkyImagery_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SkyImagery_Full.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case senQuatDot = 36
    case imageType = 38
    case expStartTime = 40
    case expEndTime = 42
    case imageSourceInfo = 44
    case topLeftStartAz = 46
    case topLeftStartEl = 48
    case topLeftStopAz = 50
    case topLeftStopEl = 52
    case imageSetId = 54
    case imageSetLength = 56
    case sequenceId = 58
    case frameFovwidth = 60
    case frameFovheight = 62
    case pixelFovwidth = 64
    case pixelFovheight = 66
    case frameWidthPixels = 68
    case frameHeightPixels = 70
    case pixelBitDepth = 72
    case annotationKey = 74
    case calibrationKey = 76
    case filename = 78
    case filesize = 80
    case checksumValue = 82
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SkyImagery_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SkyImagery_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  public var hasEoObservations: Bool { let o = _accessor.offset(VTOFFSET.eoObservations.v); return o == 0 ? false : true }
  public var eoObservationsCount: Int32 { let o = _accessor.offset(VTOFFSET.eoObservations.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func eoObservations(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.eoObservations.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  public static func startSkyImagery_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 51) }
  ...
  public static func add(dataMode: SkyImagery_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func addVectorOf(eoObservations: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: eoObservations, at: VTOFFSET.eoObservations.p) }
  public static func endSkyImagery_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSkyImagery_Full(
    ...
    eoObservationsVectorOffset eoObservations: Offset = Offset()
  ) -> Offset {
    let __start = SkyImagery_Full.startSkyImagery_Full(&fbb)
    SkyImagery_Full.add(id: id, &fbb)
    SkyImagery_Full.add(classificationMarking: classificationMarking, &fbb)
    SkyImagery_Full.add(idOnOrbit: idOnOrbit, &fbb)
    SkyImagery_Full.add(onOrbit: onOrbit, &fbb)
    SkyImagery_Full.add(origObjectId: origObjectId, &fbb)
    SkyImagery_Full.add(idAttitudeSet: idAttitudeSet, &fbb)
    SkyImagery_Full.add(idSensor: idSensor, &fbb)
    SkyImagery_Full.add(satNo: satNo, &fbb)
    SkyImagery_Full.add(origSensorId: origSensorId, &fbb)
    SkyImagery_Full.add(senlat: senlat, &fbb)
    SkyImagery_Full.add(senlon: senlon, &fbb)
    SkyImagery_Full.add(senalt: senalt, &fbb)
    SkyImagery_Full.add(senx: senx, &fbb)
    SkyImagery_Full.add(seny: seny, &fbb)
    SkyImagery_Full.add(senz: senz, &fbb)
    SkyImagery_Full.addVectorOf(senQuat: senQuat, &fbb)
    SkyImagery_Full.addVectorOf(senQuatDot: senQuatDot, &fbb)
    SkyImagery_Full.add(imageType: imageType, &fbb)
    SkyImagery_Full.add(expStartTime: expStartTime, &fbb)
    SkyImagery_Full.add(expEndTime: expEndTime, &fbb)
    SkyImagery_Full.add(imageSourceInfo: imageSourceInfo, &fbb)
    SkyImagery_Full.add(topLeftStartAz: topLeftStartAz, &fbb)
    SkyImagery_Full.add(topLeftStartEl: topLeftStartEl, &fbb)
    SkyImagery_Full.add(topLeftStopAz: topLeftStopAz, &fbb)
    SkyImagery_Full.add(topLeftStopEl: topLeftStopEl, &fbb)
    SkyImagery_Full.add(imageSetId: imageSetId, &fbb)
    SkyImagery_Full.add(imageSetLength: imageSetLength, &fbb)
    SkyImagery_Full.add(sequenceId: sequenceId, &fbb)
    SkyImagery_Full.add(frameFovwidth: frameFovwidth, &fbb)
    SkyImagery_Full.add(frameFovheight: frameFovheight, &fbb)
    SkyImagery_Full.add(pixelFovwidth: pixelFovwidth, &fbb)
    SkyImagery_Full.add(pixelFovheight: pixelFovheight, &fbb)
    SkyImagery_Full.add(frameWidthPixels: frameWidthPixels, &fbb)
    SkyImagery_Full.add(frameHeightPixels: frameHeightPixels, &fbb)
    SkyImagery_Full.add(pixelBitDepth: pixelBitDepth, &fbb)
    SkyImagery_Full.add(annotationKey: annotationKey, &fbb)
    SkyImagery_Full.add(calibrationKey: calibrationKey, &fbb)
    SkyImagery_Full.add(filename: filename, &fbb)
    SkyImagery_Full.add(filesize: filesize, &fbb)
    SkyImagery_Full.add(checksumValue: checksumValue, &fbb)
    SkyImagery_Full.add(transactionId: transactionId, &fbb)
    SkyImagery_Full.addVectorOf(tags: tags, &fbb)
    SkyImagery_Full.add(source: source, &fbb)
    SkyImagery_Full.add(origin: origin, &fbb)
    SkyImagery_Full.add(origNetwork: origNetwork, &fbb)
    SkyImagery_Full.add(sourceDl: sourceDl, &fbb)
    SkyImagery_Full.add(description: description, &fbb)
    SkyImagery_Full.add(dataMode: dataMode, &fbb)
    SkyImagery_Full.add(createdAt: createdAt, &fbb)
    SkyImagery_Full.add(createdBy: createdBy, &fbb)
    SkyImagery_Full.addVectorOf(eoObservations: eoObservations, &fbb)
    return SkyImagery_Full.endSkyImagery_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SkyImagery_Full_dataMode_Enum.self)
    try _v.visit(field: VTOFFSET.createdAt.p, fieldName: "createdAt", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.createdBy.p, fieldName: "createdBy", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.eoObservations.p, fieldName: "eoObservations", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
    _v.finish()
  }
}
