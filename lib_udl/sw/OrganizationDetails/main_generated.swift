...
public enum OrganizationDetails_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OrganizationDetails_dataMode_Enum { return .exercise }
  public static var min: OrganizationDetails_dataMode_Enum { return .real }
}


///  /// Model representation of additional detailed organization data as collected by a particular source.
public struct OrganizationDetails: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OrganizationDetails.id, addPrefix: prefix) }
  ...
  public var dataMode: OrganizationDetails_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OrganizationDetails_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOrganizationDetails(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 39) }
  ...
  public static func add(dataMode: OrganizationDetails_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endOrganizationDetails(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOrganizationDetails(
    ...
    let __start = OrganizationDetails.startOrganizationDetails(&fbb)
    OrganizationDetails.add(id: id, &fbb)
    OrganizationDetails.add(idOrganization: idOrganization, &fbb)
    OrganizationDetails.add(classificationMarking: classificationMarking, &fbb)
    OrganizationDetails.add(name: name, &fbb)
    OrganizationDetails.add(email: email, &fbb)
    OrganizationDetails.add(address1: address1, &fbb)
    OrganizationDetails.add(address2: address2, &fbb)
    OrganizationDetails.add(address3: address3, &fbb)
    OrganizationDetails.add(geoAdminLevel1: geoAdminLevel1, &fbb)
    OrganizationDetails.add(geoAdminLevel2: geoAdminLevel2, &fbb)
    OrganizationDetails.add(geoAdminLevel3: geoAdminLevel3, &fbb)
    OrganizationDetails.add(postalCode: postalCode, &fbb)
    OrganizationDetails.add(description: description, &fbb)
    OrganizationDetails.add(formerOrgId: formerOrgId, &fbb)
    OrganizationDetails.add(parentOrgId: parentOrgId, &fbb)
    OrganizationDetails.add(financialYearEndDate: financialYearEndDate, &fbb)
    OrganizationDetails.add(revenue: revenue, &fbb)
    OrganizationDetails.add(profit: profit, &fbb)
    OrganizationDetails.add(ebitda: ebitda, &fbb)
    OrganizationDetails.add(ftes: ftes, &fbb)
    OrganizationDetails.add(broker: broker, &fbb)
    OrganizationDetails.add(ceo: ceo, &fbb)
    OrganizationDetails.add(cfo: cfo, &fbb)
    OrganizationDetails.add(cto: cto, &fbb)
    OrganizationDetails.add(riskManager: riskManager, &fbb)
    OrganizationDetails.add(massRanking: massRanking, &fbb)
    OrganizationDetails.add(revenueRanking: revenueRanking, &fbb)
    OrganizationDetails.add(financialNotes: financialNotes, &fbb)
    OrganizationDetails.add(servicesNotes: servicesNotes, &fbb)
    OrganizationDetails.add(fleetPlanNotes: fleetPlanNotes, &fbb)
    OrganizationDetails.add(source: source, &fbb)
    OrganizationDetails.add(origin: origin, &fbb)
    OrganizationDetails.add(dataMode: dataMode, &fbb)
    OrganizationDetails.addVectorOf(tags: tags, &fbb)
    OrganizationDetails.add(createdAt: createdAt, &fbb)
    OrganizationDetails.add(createdBy: createdBy, &fbb)
    OrganizationDetails.add(updatedAt: updatedAt, &fbb)
    OrganizationDetails.add(updatedBy: updatedBy, &fbb)
    OrganizationDetails.add(origNetwork: origNetwork, &fbb)
    return OrganizationDetails.endOrganizationDetails(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OrganizationDetails_dataMode_Enum.self)
