...
public struct RoutePoints_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: RoutePoints_Abridged.id, addPrefix: prefix) }
  ...
  public static func startRoutePoints_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 13) }
  ...
  public static func endRoutePoints_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createRoutePoints_Abridged(
    ...
    let __start = RoutePoints_Abridged.startRoutePoints_Abridged(&fbb)
    RoutePoints_Abridged.add(ptSequenceId: ptSequenceId, &fbb)
    RoutePoints_Abridged.add(ptTypeCode: ptTypeCode, &fbb)
    RoutePoints_Abridged.add(ptTypeName: ptTypeName, &fbb)
    RoutePoints_Abridged.add(waypointName: waypointName, &fbb)
    RoutePoints_Abridged.add(dafifPt: dafifPt, &fbb)
    RoutePoints_Abridged.add(ptLat: ptLat, &fbb)
    RoutePoints_Abridged.add(ptLon: ptLon, &fbb)
    RoutePoints_Abridged.add(magDec: magDec, &fbb)
    RoutePoints_Abridged.add(navaidLength: navaidLength, &fbb)
    RoutePoints_Abridged.add(navaid: navaid, &fbb)
    RoutePoints_Abridged.add(countryCode: countryCode, &fbb)
    RoutePoints_Abridged.add(altCountryCode: altCountryCode, &fbb)
    RoutePoints_Abridged.add(navaidType: navaidType, &fbb)
    return RoutePoints_Abridged.endRoutePoints_Abridged(&fbb, start: __start)
  }
