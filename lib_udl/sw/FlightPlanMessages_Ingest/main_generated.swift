...
public struct FlightPlanMessages_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: FlightPlanMessages_Ingest.id, addPrefix: prefix) }
  ...
  public static func startFlightPlanMessages_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endFlightPlanMessages_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createFlightPlanMessages_Ingest(
    ...
    let __start = FlightPlanMessages_Ingest.startFlightPlanMessages_Ingest(&fbb)
    FlightPlanMessages_Ingest.add(severity: severity, &fbb)
    FlightPlanMessages_Ingest.add(wpNum: wpNum, &fbb)
    FlightPlanMessages_Ingest.add(routePath: routePath, &fbb)
    FlightPlanMessages_Ingest.add(msgText: msgText, &fbb)
    return FlightPlanMessages_Ingest.endFlightPlanMessages_Ingest(&fbb, start: __start)
  }
