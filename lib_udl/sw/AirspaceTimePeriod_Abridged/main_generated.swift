...
public struct AirspaceTimePeriod_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirspaceTimePeriod_Abridged.id, addPrefix: prefix) }
  ...
  public static func startAirspaceTimePeriod_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endAirspaceTimePeriod_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirspaceTimePeriod_Abridged(
    ...
    let __start = AirspaceTimePeriod_Abridged.startAirspaceTimePeriod_Abridged(&fbb)
    AirspaceTimePeriod_Abridged.add(timeMode: timeMode, &fbb)
    AirspaceTimePeriod_Abridged.add(timeStart: timeStart, &fbb)
    AirspaceTimePeriod_Abridged.add(timeEnd: timeEnd, &fbb)
    AirspaceTimePeriod_Abridged.addVectorOf(intFreq: intFreq, &fbb)
    AirspaceTimePeriod_Abridged.addVectorOf(intDur: intDur, &fbb)
    return AirspaceTimePeriod_Abridged.endAirspaceTimePeriod_Abridged(&fbb, start: __start)
  }
