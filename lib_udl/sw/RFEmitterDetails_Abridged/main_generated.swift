...
public enum RFEmitterDetails_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: RFEmitterDetails_Abridged_dataMode_Enum { return .exercise }
  public static var min: RFEmitterDetails_Abridged_dataMode_Enum { return .real }
}
...
public struct RFEmitterDetails_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: RFEmitterDetails_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: RFEmitterDetails_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : RFEmitterDetails_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startRFEmitterDetails_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 35) }
  ...
  public static func add(dataMode: RFEmitterDetails_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func endRFEmitterDetails_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createRFEmitterDetails_Abridged(
    ...
    let __start = RFEmitterDetails_Abridged.startRFEmitterDetails_Abridged(&fbb)
    RFEmitterDetails_Abridged.add(id: id, &fbb)
    RFEmitterDetails_Abridged.add(idRfemitter: idRfemitter, &fbb)
    RFEmitterDetails_Abridged.add(classificationMarking: classificationMarking, &fbb)
    RFEmitterDetails_Abridged.add(designator: designator, &fbb)
    RFEmitterDetails_Abridged.add(altName: altName, &fbb)
    RFEmitterDetails_Abridged.add(family: family, &fbb)
    RFEmitterDetails_Abridged.add(productionFacilityName: productionFacilityName, &fbb)
    RFEmitterDetails_Abridged.add(alternateFacilityName: alternateFacilityName, &fbb)
    RFEmitterDetails_Abridged.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    RFEmitterDetails_Abridged.add(productionFacilityLocationId: productionFacilityLocationId, &fbb)
    RFEmitterDetails_Abridged.add(systemSensitivityStart: systemSensitivityStart, &fbb)
    RFEmitterDetails_Abridged.add(systemSensitivityEnd: systemSensitivityEnd, &fbb)
    RFEmitterDetails_Abridged.add(receiverType: receiverType, &fbb)
    RFEmitterDetails_Abridged.add(receiverSensitivity: receiverSensitivity, &fbb)
    RFEmitterDetails_Abridged.add(receiverBandwidth: receiverBandwidth, &fbb)
    RFEmitterDetails_Abridged.add(transmitterFrequency: transmitterFrequency, &fbb)
    RFEmitterDetails_Abridged.add(transmitterBandwidth: transmitterBandwidth, &fbb)
    RFEmitterDetails_Abridged.add(transmitPower: transmitPower, &fbb)
    RFEmitterDetails_Abridged.add(barrageNoiseBandwidth: barrageNoiseBandwidth, &fbb)
    RFEmitterDetails_Abridged.add(dopplerNoise: dopplerNoise, &fbb)
    RFEmitterDetails_Abridged.add(drfmInstantaneousBandwidth: drfmInstantaneousBandwidth, &fbb)
    RFEmitterDetails_Abridged.add(numChannels: numChannels, &fbb)
    RFEmitterDetails_Abridged.add(numBits: numBits, &fbb)
    RFEmitterDetails_Abridged.addVectorOf(antennaSize: antennaSize, &fbb)
    RFEmitterDetails_Abridged.add(antennaDiameter: antennaDiameter, &fbb)
    RFEmitterDetails_Abridged.add(notes: notes, &fbb)
    RFEmitterDetails_Abridged.add(secondaryNotes: secondaryNotes, &fbb)
    RFEmitterDetails_Abridged.add(description: description, &fbb)
    RFEmitterDetails_Abridged.addVectorOf(urls: urls, &fbb)
    RFEmitterDetails_Abridged.add(source: source, &fbb)
    RFEmitterDetails_Abridged.add(origin: origin, &fbb)
    RFEmitterDetails_Abridged.add(origNetwork: origNetwork, &fbb)
    RFEmitterDetails_Abridged.add(dataMode: dataMode, &fbb)
    RFEmitterDetails_Abridged.add(createdAt: createdAt, &fbb)
    RFEmitterDetails_Abridged.add(createdBy: createdBy, &fbb)
    return RFEmitterDetails_Abridged.endRFEmitterDetails_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: RFEmitterDetails_Abridged_dataMode_Enum.self)
