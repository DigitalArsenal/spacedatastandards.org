...
public enum AirTaskingOrder_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AirTaskingOrder_Ingest_dataMode_Enum { return .exercise }
  public static var min: AirTaskingOrder_Ingest_dataMode_Enum { return .real }
}
...
public struct AirTaskingOrder_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirTaskingOrder_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: AirTaskingOrder_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AirTaskingOrder_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startAirTaskingOrder_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 22) }
  ...
  public static func add(dataMode: AirTaskingOrder_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endAirTaskingOrder_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirTaskingOrder_Ingest(
    ...
    let __start = AirTaskingOrder_Ingest.startAirTaskingOrder_Ingest(&fbb)
    AirTaskingOrder_Ingest.add(id: id, &fbb)
    AirTaskingOrder_Ingest.add(classificationMarking: classificationMarking, &fbb)
    AirTaskingOrder_Ingest.add(rawFileUri: rawFileUri, &fbb)
    AirTaskingOrder_Ingest.add(opExerName: opExerName, &fbb)
    AirTaskingOrder_Ingest.add(msgOriginator: msgOriginator, &fbb)
    AirTaskingOrder_Ingest.add(msgSn: msgSn, &fbb)
    AirTaskingOrder_Ingest.add(msgMonth: msgMonth, &fbb)
    AirTaskingOrder_Ingest.add(msgQualifier: msgQualifier, &fbb)
    AirTaskingOrder_Ingest.add(ackReqInd: ackReqInd, &fbb)
    AirTaskingOrder_Ingest.add(ackUnitInstructions: ackUnitInstructions, &fbb)
    AirTaskingOrder_Ingest.add(beginTs: beginTs, &fbb)
    AirTaskingOrder_Ingest.add(endTs: endTs, &fbb)
    AirTaskingOrder_Ingest.addVectorOf(genText: genText, &fbb)
    AirTaskingOrder_Ingest.addVectorOf(acMsnTasking: acMsnTasking, &fbb)
    AirTaskingOrder_Ingest.addVectorOf(navalFltOps: navalFltOps, &fbb)
    AirTaskingOrder_Ingest.add(createdAt: createdAt, &fbb)
    AirTaskingOrder_Ingest.add(createdBy: createdBy, &fbb)
    AirTaskingOrder_Ingest.add(source: source, &fbb)
    AirTaskingOrder_Ingest.add(sourceDl: sourceDl, &fbb)
    AirTaskingOrder_Ingest.add(origin: origin, &fbb)
    AirTaskingOrder_Ingest.add(origNetwork: origNetwork, &fbb)
    AirTaskingOrder_Ingest.add(dataMode: dataMode, &fbb)
    return AirTaskingOrder_Ingest.endAirTaskingOrder_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AirTaskingOrder_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
