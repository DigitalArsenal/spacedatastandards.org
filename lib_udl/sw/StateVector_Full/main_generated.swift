...
public enum StateVector_Full_referenceFrame_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: StateVector_Full_referenceFrame_Enum { return .gcrf }
  public static var min: StateVector_Full_referenceFrame_Enum { return .j2000 }
}


public enum StateVector_Full_covReferenceFrame_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: StateVector_Full_covReferenceFrame_Enum { return .uvw }
  public static var min: StateVector_Full_covReferenceFrame_Enum { return .j2000 }
}


public enum StateVector_Full_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: StateVector_Full_dataMode_Enum { return .exercise }
  public static var min: StateVector_Full_dataMode_Enum { return .real }
}


public enum StateVector_Full_sourcedDataTypes_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: StateVector_Full_sourcedDataTypes_Enum { return .sv }
  public static var min: StateVector_Full_sourcedDataTypes_Enum { return .eo }
}
...
public struct StateVector_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: StateVector_Full.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case rms = 166
    case effectiveFrom = 168
    case effectiveUntil = 170
    case rawFileUri = 172
    case source = 174
    case origin = 176
    case dataMode = 178
    case tags = 180
    case algorithm = 182
    case sourcedData = 184
    case sourcedDataTypes = 186
    case createdAt = 188
    case createdBy = 190
    case onOrbit = 192
    case descriptor = 194
    case transactionId = 196
    case origNetwork = 198
    case sourceDl = 200
  ...
  public var referenceFrame: StateVector_Full_referenceFrame_Enum { let o = _accessor.offset(VTOFFSET.referenceFrame.v); return o == 0 ? .j2000 : StateVector_Full_referenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ...
  ///  Example: /// Example: J2000
  ///  Constraints: Minimum length = 0, Maximum length = 24
  public var covReferenceFrame: StateVector_Full_covReferenceFrame_Enum { let o = _accessor.offset(VTOFFSET.covReferenceFrame.v); return o == 0 ? .j2000 : StateVector_Full_covReferenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ...
  public var dataMode: StateVector_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : StateVector_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Constraints: No constraints specified.
  public var sourcedDataTypes: StateVector_Full_sourcedDataTypes_Enum { let o = _accessor.offset(VTOFFSET.sourcedDataTypes.v); return o == 0 ? .eo : StateVector_Full_sourcedDataTypes_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .eo }
  ...
  public static func startStateVector_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 99) }
  ...
  public static func add(referenceFrame: StateVector_Full_referenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: referenceFrame.rawValue, def: 0, at: VTOFFSET.referenceFrame.p) }
  public static func addVectorOf(cov: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: cov, at: VTOFFSET.cov.p) }
  public static func add(covReferenceFrame: StateVector_Full_covReferenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: covReferenceFrame.rawValue, def: 0, at: VTOFFSET.covReferenceFrame.p) }
  ...
  public static func add(dataMode: StateVector_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func add(sourcedDataTypes: StateVector_Full_sourcedDataTypes_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: sourcedDataTypes.rawValue, def: 0, at: VTOFFSET.sourcedDataTypes.p) }
  ...
  public static func endStateVector_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createStateVector_Full(
    ...
    let __start = StateVector_Full.startStateVector_Full(&fbb)
    StateVector_Full.add(idStateVector: idStateVector, &fbb)
    StateVector_Full.add(classificationMarking: classificationMarking, &fbb)
    StateVector_Full.add(epoch: epoch, &fbb)
    StateVector_Full.add(pedigree: pedigree, &fbb)
    StateVector_Full.add(idOnOrbit: idOnOrbit, &fbb)
    StateVector_Full.add(satNo: satNo, &fbb)
    StateVector_Full.add(origObjectId: origObjectId, &fbb)
    StateVector_Full.add(idOrbitDetermination: idOrbitDetermination, &fbb)
    StateVector_Full.add(uct: uct, &fbb)
    StateVector_Full.add(xpos: xpos, &fbb)
    StateVector_Full.add(ypos: ypos, &fbb)
    StateVector_Full.add(zpos: zpos, &fbb)
    StateVector_Full.add(xvel: xvel, &fbb)
    StateVector_Full.add(yvel: yvel, &fbb)
    StateVector_Full.add(zvel: zvel, &fbb)
    StateVector_Full.add(referenceFrame: referenceFrame, &fbb)
    StateVector_Full.addVectorOf(cov: cov, &fbb)
    StateVector_Full.add(covReferenceFrame: covReferenceFrame, &fbb)
    StateVector_Full.add(covMethod: covMethod, &fbb)
    StateVector_Full.addVectorOf(eqCov: eqCov, &fbb)
    StateVector_Full.add(xposAlt1: xposAlt1, &fbb)
    StateVector_Full.add(yposAlt1: yposAlt1, &fbb)
    StateVector_Full.add(zposAlt1: zposAlt1, &fbb)
    StateVector_Full.add(xvelAlt1: xvelAlt1, &fbb)
    StateVector_Full.add(yvelAlt1: yvelAlt1, &fbb)
    StateVector_Full.add(zvelAlt1: zvelAlt1, &fbb)
    StateVector_Full.add(alt1ReferenceFrame: alt1ReferenceFrame, &fbb)
    StateVector_Full.add(xposAlt2: xposAlt2, &fbb)
    StateVector_Full.add(yposAlt2: yposAlt2, &fbb)
    StateVector_Full.add(zposAlt2: zposAlt2, &fbb)
    StateVector_Full.add(xvelAlt2: xvelAlt2, &fbb)
    StateVector_Full.add(yvelAlt2: yvelAlt2, &fbb)
    StateVector_Full.add(zvelAlt2: zvelAlt2, &fbb)
    StateVector_Full.add(alt2ReferenceFrame: alt2ReferenceFrame, &fbb)
    StateVector_Full.add(posUnc: posUnc, &fbb)
    StateVector_Full.add(velUnc: velUnc, &fbb)
    StateVector_Full.add(mass: mass, &fbb)
    StateVector_Full.add(area: area, &fbb)
    StateVector_Full.add(solarRadPressCoeff: solarRadPressCoeff, &fbb)
    StateVector_Full.add(dragCoeff: dragCoeff, &fbb)
    StateVector_Full.add(dragArea: dragArea, &fbb)
    StateVector_Full.add(revNo: revNo, &fbb)
    StateVector_Full.add(geopotentialModel: geopotentialModel, &fbb)
    StateVector_Full.add(dragModel: dragModel, &fbb)
    StateVector_Full.add(lunarSolar: lunarSolar, &fbb)
    StateVector_Full.add(solarRadPress: solarRadPress, &fbb)
    StateVector_Full.add(srpArea: srpArea, &fbb)
    StateVector_Full.add(solidEarthTides: solidEarthTides, &fbb)
    StateVector_Full.add(inTrackThrust: inTrackThrust, &fbb)
    StateVector_Full.add(bDot: bDot, &fbb)
    StateVector_Full.add(edr: edr, &fbb)
    StateVector_Full.add(thrustAccel: thrustAccel, &fbb)
    StateVector_Full.add(cmOffset: cmOffset, &fbb)
    StateVector_Full.add(lastObStart: lastObStart, &fbb)
    StateVector_Full.add(lastObEnd: lastObEnd, &fbb)
    StateVector_Full.add(obsAvailable: obsAvailable, &fbb)
    StateVector_Full.add(obsUsed: obsUsed, &fbb)
    StateVector_Full.add(tracksAvail: tracksAvail, &fbb)
    StateVector_Full.add(tracksUsed: tracksUsed, &fbb)
    StateVector_Full.add(recOdspan: recOdspan, &fbb)
    StateVector_Full.add(actualOdspan: actualOdspan, &fbb)
    StateVector_Full.add(residualsAcc: residualsAcc, &fbb)
    StateVector_Full.add(solarFluxF10: solarFluxF10, &fbb)
    StateVector_Full.add(solarFluxF10Avg: solarFluxF10Avg, &fbb)
    StateVector_Full.add(solarFluxApavg: solarFluxApavg, &fbb)
    StateVector_Full.add(taiUtc: taiUtc, &fbb)
    StateVector_Full.add(ut1Utc: ut1Utc, &fbb)
    StateVector_Full.add(ut1Rate: ut1Rate, &fbb)
    StateVector_Full.add(polarMotionX: polarMotionX, &fbb)
    StateVector_Full.add(polarMotionY: polarMotionY, &fbb)
    StateVector_Full.add(iau1980Terms: iau1980Terms, &fbb)
    StateVector_Full.add(leapSecondTime: leapSecondTime, &fbb)
    StateVector_Full.add(integratorMode: integratorMode, &fbb)
    StateVector_Full.add(partials: partials, &fbb)
    StateVector_Full.add(stepMode: stepMode, &fbb)
    StateVector_Full.add(fixedStep: fixedStep, &fbb)
    StateVector_Full.add(stepSizeSelection: stepSizeSelection, &fbb)
    StateVector_Full.add(stepSize: stepSize, &fbb)
    StateVector_Full.add(errorControl: errorControl, &fbb)
    StateVector_Full.addVectorOf(sigmaPosUvw: sigmaPosUvw, &fbb)
    StateVector_Full.addVectorOf(sigmaVelUvw: sigmaVelUvw, &fbb)
    StateVector_Full.add(rms: rms, &fbb)
    StateVector_Full.add(effectiveFrom: effectiveFrom, &fbb)
    StateVector_Full.add(effectiveUntil: effectiveUntil, &fbb)
    StateVector_Full.add(rawFileUri: rawFileUri, &fbb)
    StateVector_Full.add(source: source, &fbb)
    StateVector_Full.add(origin: origin, &fbb)
    StateVector_Full.add(dataMode: dataMode, &fbb)
    StateVector_Full.addVectorOf(tags: tags, &fbb)
    StateVector_Full.add(algorithm: algorithm, &fbb)
    StateVector_Full.addVectorOf(sourcedData: sourcedData, &fbb)
    StateVector_Full.add(sourcedDataTypes: sourcedDataTypes, &fbb)
    StateVector_Full.add(createdAt: createdAt, &fbb)
    StateVector_Full.add(createdBy: createdBy, &fbb)
    StateVector_Full.add(onOrbit: onOrbit, &fbb)
    StateVector_Full.add(descriptor: descriptor, &fbb)
    StateVector_Full.add(transactionId: transactionId, &fbb)
    StateVector_Full.add(origNetwork: origNetwork, &fbb)
    StateVector_Full.add(sourceDl: sourceDl, &fbb)
    return StateVector_Full.endStateVector_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.referenceFrame.p, fieldName: "referenceFrame", required: false, type: StateVector_Full_referenceFrame_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.covReferenceFrame.p, fieldName: "covReferenceFrame", required: false, type: StateVector_Full_covReferenceFrame_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: StateVector_Full_dataMode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.sourcedDataTypes.p, fieldName: "sourcedDataTypes", required: false, type: StateVector_Full_sourcedDataTypes_Enum.self)
