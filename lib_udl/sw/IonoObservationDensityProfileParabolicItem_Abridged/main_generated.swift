...
public struct IonoObservationDensityProfileParabolicItem_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDensityProfileParabolicItem_Abridged.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDensityProfileParabolicItem_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationDensityProfileParabolicItem_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDensityProfileParabolicItem_Abridged(
    ...
    let __start = IonoObservationDensityProfileParabolicItem_Abridged.startIonoObservationDensityProfileParabolicItem_Abridged(&fbb)
    IonoObservationDensityProfileParabolicItem_Abridged.add(layer: layer, &fbb)
    IonoObservationDensityProfileParabolicItem_Abridged.add(f: f, &fbb)
    IonoObservationDensityProfileParabolicItem_Abridged.add(z: z, &fbb)
    IonoObservationDensityProfileParabolicItem_Abridged.add(y: y, &fbb)
    return IonoObservationDensityProfileParabolicItem_Abridged.endIonoObservationDensityProfileParabolicItem_Abridged(&fbb, start: __start)
  }
