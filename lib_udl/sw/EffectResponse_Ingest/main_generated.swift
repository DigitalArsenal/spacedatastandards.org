...
public enum EffectResponse_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: EffectResponse_Ingest_dataMode_Enum { return .exercise }
  public static var min: EffectResponse_Ingest_dataMode_Enum { return .real }
}


///  /// A response for various effects on a target.
public struct EffectResponse_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EffectResponse_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: EffectResponse_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : EffectResponse_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startEffectResponse_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 25) }
  ...
  public static func add(dataMode: EffectResponse_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endEffectResponse_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEffectResponse_Ingest(
    ...
    let __start = EffectResponse_Ingest.startEffectResponse_Ingest(&fbb)
    EffectResponse_Ingest.add(id: id, &fbb)
    EffectResponse_Ingest.add(classificationMarking: classificationMarking, &fbb)
    EffectResponse_Ingest.add(idEffectRequest: idEffectRequest, &fbb)
    EffectResponse_Ingest.add(externalRequestId: externalRequestId, &fbb)
    EffectResponse_Ingest.add(type: type, &fbb)
    EffectResponse_Ingest.add(actorSrcType: actorSrcType, &fbb)
    EffectResponse_Ingest.add(actorSrcId: actorSrcId, &fbb)
    EffectResponse_Ingest.add(munitionType: munitionType, &fbb)
    EffectResponse_Ingest.add(munitionId: munitionId, &fbb)
    EffectResponse_Ingest.add(shotsRequired: shotsRequired, &fbb)
    EffectResponse_Ingest.add(probabilityOfKill: probabilityOfKill, &fbb)
    EffectResponse_Ingest.add(collateralDamageEst: collateralDamageEst, &fbb)
    EffectResponse_Ingest.addVectorOf(actionsList: actionsList, &fbb)
    EffectResponse_Ingest.addVectorOf(externalActions: externalActions, &fbb)
    EffectResponse_Ingest.addVectorOf(coaMetrics: coaMetrics, &fbb)
    EffectResponse_Ingest.add(redTimeToOverhead: redTimeToOverhead, &fbb)
    EffectResponse_Ingest.add(decisionDeadline: decisionDeadline, &fbb)
    EffectResponse_Ingest.add(redTargetSrcType: redTargetSrcType, &fbb)
    EffectResponse_Ingest.add(redTargetSrcId: redTargetSrcId, &fbb)
    EffectResponse_Ingest.add(createdAt: createdAt, &fbb)
    EffectResponse_Ingest.add(createdBy: createdBy, &fbb)
    EffectResponse_Ingest.add(source: source, &fbb)
    EffectResponse_Ingest.add(origin: origin, &fbb)
    EffectResponse_Ingest.add(dataMode: dataMode, &fbb)
    EffectResponse_Ingest.add(origNetwork: origNetwork, &fbb)
    return EffectResponse_Ingest.endEffectResponse_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: EffectResponse_Ingest_dataMode_Enum.self)
