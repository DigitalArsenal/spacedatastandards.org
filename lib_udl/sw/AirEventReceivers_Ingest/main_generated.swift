...
public struct AirEventReceivers_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirEventReceivers_Ingest.id, addPrefix: prefix) }
  ...
  public static func startAirEventReceivers_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 22) }
  ...
  public static func endAirEventReceivers_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirEventReceivers_Ingest(
    ...
    let __start = AirEventReceivers_Ingest.startAirEventReceivers_Ingest(&fbb)
    AirEventReceivers_Ingest.add(idReceiverSortie: idReceiverSortie, &fbb)
    AirEventReceivers_Ingest.add(idReceiverMission: idReceiverMission, &fbb)
    AirEventReceivers_Ingest.add(idReceiverAirfield: idReceiverAirfield, &fbb)
    AirEventReceivers_Ingest.add(externalReceiverId: externalReceiverId, &fbb)
    AirEventReceivers_Ingest.add(receiverCoord: receiverCoord, &fbb)
    AirEventReceivers_Ingest.add(receiverMds: receiverMds, &fbb)
    AirEventReceivers_Ingest.add(amcReceiverMissionId: amcReceiverMissionId, &fbb)
    AirEventReceivers_Ingest.add(altReceiverMissionId: altReceiverMissionId, &fbb)
    AirEventReceivers_Ingest.add(receiverCallSign: receiverCallSign, &fbb)
    AirEventReceivers_Ingest.add(receiverOwner: receiverOwner, &fbb)
    AirEventReceivers_Ingest.add(receiverPoc: receiverPoc, &fbb)
    AirEventReceivers_Ingest.add(receiverLegNum: receiverLegNum, &fbb)
    AirEventReceivers_Ingest.add(receiverDeployedIcao: receiverDeployedIcao, &fbb)
    AirEventReceivers_Ingest.add(receiverDeliveryMethod: receiverDeliveryMethod, &fbb)
    AirEventReceivers_Ingest.add(fuelOn: fuelOn, &fbb)
    AirEventReceivers_Ingest.add(receiverCellPosition: receiverCellPosition, &fbb)
    AirEventReceivers_Ingest.add(sequenceNum: sequenceNum, &fbb)
    AirEventReceivers_Ingest.add(recOrg: recOrg, &fbb)
    AirEventReceivers_Ingest.add(numRecAircraft: numRecAircraft, &fbb)
    AirEventReceivers_Ingest.add(receiverFuelType: receiverFuelType, &fbb)
    AirEventReceivers_Ingest.add(receiverExercise: receiverExercise, &fbb)
    AirEventReceivers_Ingest.add(packageId: packageId, &fbb)
    return AirEventReceivers_Ingest.endAirEventReceivers_Ingest(&fbb, start: __start)
  }
