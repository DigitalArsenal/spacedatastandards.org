...
public enum LaunchDetection_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: LaunchDetection_Ingest_dataMode_Enum { return .exercise }
  public static var min: LaunchDetection_Ingest_dataMode_Enum { return .real }
}


///  /// Data to analyze launch detections.
public struct LaunchDetection_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LaunchDetection_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: LaunchDetection_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : LaunchDetection_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startLaunchDetection_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 27) }
  ...
  public static func add(dataMode: LaunchDetection_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endLaunchDetection_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLaunchDetection_Ingest(
    ...
    let __start = LaunchDetection_Ingest.startLaunchDetection_Ingest(&fbb)
    LaunchDetection_Ingest.add(id: id, &fbb)
    LaunchDetection_Ingest.add(classificationMarking: classificationMarking, &fbb)
    LaunchDetection_Ingest.add(launchTime: launchTime, &fbb)
    LaunchDetection_Ingest.add(messageType: messageType, &fbb)
    LaunchDetection_Ingest.add(launchLatitude: launchLatitude, &fbb)
    LaunchDetection_Ingest.add(launchLongitude: launchLongitude, &fbb)
    LaunchDetection_Ingest.add(launchAzimuth: launchAzimuth, &fbb)
    LaunchDetection_Ingest.add(raan: raan, &fbb)
    LaunchDetection_Ingest.add(inclination: inclination, &fbb)
    LaunchDetection_Ingest.add(observationTime: observationTime, &fbb)
    LaunchDetection_Ingest.add(observationLatitude: observationLatitude, &fbb)
    LaunchDetection_Ingest.add(observationLongitude: observationLongitude, &fbb)
    LaunchDetection_Ingest.add(observationAltitude: observationAltitude, &fbb)
    LaunchDetection_Ingest.add(stereoFlag: stereoFlag, &fbb)
    LaunchDetection_Ingest.add(highZenithAzimuth: highZenithAzimuth, &fbb)
    LaunchDetection_Ingest.add(sequenceNumber: sequenceNumber, &fbb)
    LaunchDetection_Ingest.add(eventId: eventId, &fbb)
    LaunchDetection_Ingest.add(source: source, &fbb)
    LaunchDetection_Ingest.add(origin: origin, &fbb)
    LaunchDetection_Ingest.add(descriptor: descriptor, &fbb)
    LaunchDetection_Ingest.addVectorOf(tags: tags, &fbb)
    LaunchDetection_Ingest.add(origNetwork: origNetwork, &fbb)
    LaunchDetection_Ingest.add(dataMode: dataMode, &fbb)
    LaunchDetection_Ingest.add(createdAt: createdAt, &fbb)
    LaunchDetection_Ingest.add(createdBy: createdBy, &fbb)
    LaunchDetection_Ingest.add(updatedAt: updatedAt, &fbb)
    LaunchDetection_Ingest.add(updatedBy: updatedBy, &fbb)
    return LaunchDetection_Ingest.endLaunchDetection_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: LaunchDetection_Ingest_dataMode_Enum.self)
