...
public struct DataLinkOps_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DataLinkOps_Full.id, addPrefix: prefix) }
  ...
  public static func startDataLinkOps_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endDataLinkOps_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDataLinkOps_Full(
    ...
    let __start = DataLinkOps_Full.startDataLinkOps_Full(&fbb)
    DataLinkOps_Full.add(linkName: linkName, &fbb)
    DataLinkOps_Full.add(linkStartTime: linkStartTime, &fbb)
    DataLinkOps_Full.add(linkStopTime: linkStopTime, &fbb)
    DataLinkOps_Full.add(linkStopTimeMod: linkStopTimeMod, &fbb)
    DataLinkOps_Full.add(linkDetails: linkDetails, &fbb)
    return DataLinkOps_Full.endDataLinkOps_Full(&fbb, start: __start)
  }
