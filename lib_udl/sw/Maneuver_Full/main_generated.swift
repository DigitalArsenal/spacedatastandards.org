...
public enum Maneuver_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Maneuver_Full_dataMode_Enum { return .exercise }
  public static var min: Maneuver_Full_dataMode_Enum { return .real }
}


public enum Maneuver_Full_sourcedDataTypes_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: Maneuver_Full_sourcedDataTypes_Enum { return .sv }
  public static var min: Maneuver_Full_sourcedDataTypes_Enum { return .eo }
}


///  /// Model representation of on-orbit object maneuver information for detected, possible, and confirmed maneuvers.
public struct Maneuver_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Maneuver_Full.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case onOrbit = 196
    case transactionId = 198
    case origNetwork = 200
  ...
  public var dataMode: Maneuver_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Maneuver_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Constraints: No constraints specified.
  public var sourcedDataTypes: Maneuver_Full_sourcedDataTypes_Enum { let o = _accessor.offset(VTOFFSET.sourcedDataTypes.v); return o == 0 ? .eo : Maneuver_Full_sourcedDataTypes_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .eo }
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  ...
  public static func startManeuver_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 99) }
  ...
  public static func add(dataMode: Maneuver_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func add(sourcedDataTypes: Maneuver_Full_sourcedDataTypes_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: sourcedDataTypes.rawValue, def: 0, at: VTOFFSET.sourcedDataTypes.p) }
  ...
  public static func endManeuver_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createManeuver_Full(
    ...
    let __start = Maneuver_Full.startManeuver_Full(&fbb)
    Maneuver_Full.add(id: id, &fbb)
    Maneuver_Full.add(classificationMarking: classificationMarking, &fbb)
    Maneuver_Full.add(satNo: satNo, &fbb)
    Maneuver_Full.add(reportTime: reportTime, &fbb)
    Maneuver_Full.add(eventStartTime: eventStartTime, &fbb)
    Maneuver_Full.add(eventEndTime: eventEndTime, &fbb)
    Maneuver_Full.add(totalBurnTime: totalBurnTime, &fbb)
    Maneuver_Full.add(odFitEndTime: odFitEndTime, &fbb)
    Maneuver_Full.add(idOnOrbit: idOnOrbit, &fbb)
    Maneuver_Full.add(idSensor: idSensor, &fbb)
    Maneuver_Full.add(uct: uct, &fbb)
    Maneuver_Full.add(maneuverUnc: maneuverUnc, &fbb)
    Maneuver_Full.add(characterization: characterization, &fbb)
    Maneuver_Full.add(characterizationUnc: characterizationUnc, &fbb)
    Maneuver_Full.add(eventId: eventId, &fbb)
    Maneuver_Full.add(origObjectId: origObjectId, &fbb)
    Maneuver_Full.add(origSensorId: origSensorId, &fbb)
    Maneuver_Full.add(status: status, &fbb)
    Maneuver_Full.add(deltaPos: deltaPos, &fbb)
    Maneuver_Full.add(deltaPosU: deltaPosU, &fbb)
    Maneuver_Full.add(deltaPosV: deltaPosV, &fbb)
    Maneuver_Full.add(deltaPosW: deltaPosW, &fbb)
    Maneuver_Full.add(deltaVel: deltaVel, &fbb)
    Maneuver_Full.add(deltaVelU: deltaVelU, &fbb)
    Maneuver_Full.add(deltaVelV: deltaVelV, &fbb)
    Maneuver_Full.add(deltaVelW: deltaVelW, &fbb)
    Maneuver_Full.add(deltaMass: deltaMass, &fbb)
    Maneuver_Full.add(preEventIdElset: preEventIdElset, &fbb)
    Maneuver_Full.add(preEventElset: preEventElset, &fbb)
    Maneuver_Full.add(preEventIdStateVector: preEventIdStateVector, &fbb)
    Maneuver_Full.add(preEventStateVector: preEventStateVector, &fbb)
    Maneuver_Full.add(prePosX: prePosX, &fbb)
    Maneuver_Full.add(prePosY: prePosY, &fbb)
    Maneuver_Full.add(prePosZ: prePosZ, &fbb)
    Maneuver_Full.add(preVelX: preVelX, &fbb)
    Maneuver_Full.add(preVelY: preVelY, &fbb)
    Maneuver_Full.add(preVelZ: preVelZ, &fbb)
    Maneuver_Full.add(preRadiationPressCoeff: preRadiationPressCoeff, &fbb)
    Maneuver_Full.add(preBallisticCoeff: preBallisticCoeff, &fbb)
    Maneuver_Full.add(preApogee: preApogee, &fbb)
    Maneuver_Full.add(prePerigee: prePerigee, &fbb)
    Maneuver_Full.add(preInclination: preInclination, &fbb)
    Maneuver_Full.add(preEccentricity: preEccentricity, &fbb)
    Maneuver_Full.add(prePeriod: prePeriod, &fbb)
    Maneuver_Full.add(preRaan: preRaan, &fbb)
    Maneuver_Full.add(preSma: preSma, &fbb)
    Maneuver_Full.add(preGeoLongitude: preGeoLongitude, &fbb)
    Maneuver_Full.add(preDriftRate: preDriftRate, &fbb)
    Maneuver_Full.add(preSigmaU: preSigmaU, &fbb)
    Maneuver_Full.add(preSigmaV: preSigmaV, &fbb)
    Maneuver_Full.add(preSigmaW: preSigmaW, &fbb)
    Maneuver_Full.add(postEventIdElset: postEventIdElset, &fbb)
    Maneuver_Full.add(postEventElset: postEventElset, &fbb)
    Maneuver_Full.add(postEventIdStateVector: postEventIdStateVector, &fbb)
    Maneuver_Full.add(postEventStateVector: postEventStateVector, &fbb)
    Maneuver_Full.add(postPosX: postPosX, &fbb)
    Maneuver_Full.add(postPosY: postPosY, &fbb)
    Maneuver_Full.add(postPosZ: postPosZ, &fbb)
    Maneuver_Full.add(postVelX: postVelX, &fbb)
    Maneuver_Full.add(postVelY: postVelY, &fbb)
    Maneuver_Full.add(postVelZ: postVelZ, &fbb)
    Maneuver_Full.add(postRadiationPressCoeff: postRadiationPressCoeff, &fbb)
    Maneuver_Full.add(postBallisticCoeff: postBallisticCoeff, &fbb)
    Maneuver_Full.add(postApogee: postApogee, &fbb)
    Maneuver_Full.add(postPerigee: postPerigee, &fbb)
    Maneuver_Full.add(postInclination: postInclination, &fbb)
    Maneuver_Full.add(postEccentricity: postEccentricity, &fbb)
    Maneuver_Full.add(postPeriod: postPeriod, &fbb)
    Maneuver_Full.add(postRaan: postRaan, &fbb)
    Maneuver_Full.add(postSma: postSma, &fbb)
    Maneuver_Full.add(postGeoLongitude: postGeoLongitude, &fbb)
    Maneuver_Full.add(postDriftRate: postDriftRate, &fbb)
    Maneuver_Full.add(postSigmaU: postSigmaU, &fbb)
    Maneuver_Full.add(postSigmaV: postSigmaV, &fbb)
    Maneuver_Full.add(postSigmaW: postSigmaW, &fbb)
    Maneuver_Full.addVectorOf(cov: cov, &fbb)
    Maneuver_Full.add(postMass: postMass, &fbb)
    Maneuver_Full.add(postArea: postArea, &fbb)
    Maneuver_Full.add(numObs: numObs, &fbb)
    Maneuver_Full.add(description: description, &fbb)
    Maneuver_Full.add(descriptor: descriptor, &fbb)
    Maneuver_Full.add(stateModel: stateModel, &fbb)
    Maneuver_Full.add(stateModelVersion: stateModelVersion, &fbb)
    Maneuver_Full.add(numAccelPoints: numAccelPoints, &fbb)
    Maneuver_Full.addVectorOf(mnvrAccelTimes: mnvrAccelTimes, &fbb)
    Maneuver_Full.addVectorOf(mnvrAccels: mnvrAccels, &fbb)
    Maneuver_Full.addVectorOf(mnvrAccelUncs: mnvrAccelUncs, &fbb)
    Maneuver_Full.add(source: source, &fbb)
    Maneuver_Full.add(origin: origin, &fbb)
    Maneuver_Full.add(dataMode: dataMode, &fbb)
    Maneuver_Full.add(createdAt: createdAt, &fbb)
    Maneuver_Full.add(createdBy: createdBy, &fbb)
    Maneuver_Full.addVectorOf(tags: tags, &fbb)
    Maneuver_Full.add(algorithm: algorithm, &fbb)
    Maneuver_Full.addVectorOf(sourcedData: sourcedData, &fbb)
    Maneuver_Full.add(sourcedDataTypes: sourcedDataTypes, &fbb)
    Maneuver_Full.add(onOrbit: onOrbit, &fbb)
    Maneuver_Full.add(transactionId: transactionId, &fbb)
    Maneuver_Full.add(origNetwork: origNetwork, &fbb)
    return Maneuver_Full.endManeuver_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Maneuver_Full_dataMode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.sourcedDataTypes.p, fieldName: "sourcedDataTypes", required: false, type: Maneuver_Full_sourcedDataTypes_Enum.self)
