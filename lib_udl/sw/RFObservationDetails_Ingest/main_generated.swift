...
public enum RFObservationDetails_Ingest_polarityType_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: RFObservationDetails_Ingest_polarityType_Enum { return .l }
  public static var min: RFObservationDetails_Ingest_polarityType_Enum { return .h }
}


public enum RFObservationDetails_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: RFObservationDetails_Ingest_dataMode_Enum { return .exercise }
  public static var min: RFObservationDetails_Ingest_dataMode_Enum { return .real }
}
...
public struct RFObservationDetails_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: RFObservationDetails_Ingest.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case descriptor = 164
    case url = 166
    case frequencies = 168
    case powers = 170
    case snrs = 172
    case confidences = 174
    case detectionStatuses = 176
    case chipRates = 178
    case codeTaps = 180
    case codeFills = 182
    case codeLengths = 184
    case pnOrders = 186
    case signalIds = 188
    case baudRates = 190
    case telemetryIds = 192
    case constellationXpoints = 194
    case constellationYpoints = 196
  ...
  public var polarityType: RFObservationDetails_Ingest_polarityType_Enum { let o = _accessor.offset(VTOFFSET.polarityType.v); return o == 0 ? .h : RFObservationDetails_Ingest_polarityType_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .h }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: RFObservationDetails_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : RFObservationDetails_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startRFObservationDetails_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 97) }
  ...
  public static func add(polarityType: RFObservationDetails_Ingest_polarityType_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: polarityType.rawValue, def: 0, at: VTOFFSET.polarityType.p) }
  ...
  public static func add(dataMode: RFObservationDetails_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endRFObservationDetails_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createRFObservationDetails_Ingest(
    ...
    let __start = RFObservationDetails_Ingest.startRFObservationDetails_Ingest(&fbb)
    RFObservationDetails_Ingest.add(id: id, &fbb)
    RFObservationDetails_Ingest.add(classificationMarking: classificationMarking, &fbb)
    RFObservationDetails_Ingest.add(obTime: obTime, &fbb)
    RFObservationDetails_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    RFObservationDetails_Ingest.add(idSensor: idSensor, &fbb)
    RFObservationDetails_Ingest.add(type: type, &fbb)
    RFObservationDetails_Ingest.add(satNo: satNo, &fbb)
    RFObservationDetails_Ingest.add(taskId: taskId, &fbb)
    RFObservationDetails_Ingest.add(transactionId: transactionId, &fbb)
    RFObservationDetails_Ingest.add(trackId: trackId, &fbb)
    RFObservationDetails_Ingest.add(origObjectId: origObjectId, &fbb)
    RFObservationDetails_Ingest.add(origSensorId: origSensorId, &fbb)
    RFObservationDetails_Ingest.add(uct: uct, &fbb)
    RFObservationDetails_Ingest.add(transponder: transponder, &fbb)
    RFObservationDetails_Ingest.add(azimuth: azimuth, &fbb)
    RFObservationDetails_Ingest.add(azimuthUnc: azimuthUnc, &fbb)
    RFObservationDetails_Ingest.add(azimuthRate: azimuthRate, &fbb)
    RFObservationDetails_Ingest.add(elevation: elevation, &fbb)
    RFObservationDetails_Ingest.add(elevationUnc: elevationUnc, &fbb)
    RFObservationDetails_Ingest.add(elevationRate: elevationRate, &fbb)
    RFObservationDetails_Ingest.add(range: range, &fbb)
    RFObservationDetails_Ingest.add(rangeUnc: rangeUnc, &fbb)
    RFObservationDetails_Ingest.add(rangeRate: rangeRate, &fbb)
    RFObservationDetails_Ingest.add(rangeRateUnc: rangeRateUnc, &fbb)
    RFObservationDetails_Ingest.add(trackRange: trackRange, &fbb)
    RFObservationDetails_Ingest.add(senlat: senlat, &fbb)
    RFObservationDetails_Ingest.add(senlon: senlon, &fbb)
    RFObservationDetails_Ingest.add(senalt: senalt, &fbb)
    RFObservationDetails_Ingest.add(elnot: elnot, &fbb)
    RFObservationDetails_Ingest.add(frequency: frequency, &fbb)
    RFObservationDetails_Ingest.add(nominalFrequency: nominalFrequency, &fbb)
    RFObservationDetails_Ingest.add(startFrequency: startFrequency, &fbb)
    RFObservationDetails_Ingest.add(endFrequency: endFrequency, &fbb)
    RFObservationDetails_Ingest.add(relativeCarrierPower: relativeCarrierPower, &fbb)
    RFObservationDetails_Ingest.add(spectrumAnalyzerPower: spectrumAnalyzerPower, &fbb)
    RFObservationDetails_Ingest.add(relativeNoiseFloor: relativeNoiseFloor, &fbb)
    RFObservationDetails_Ingest.add(referenceLevel: referenceLevel, &fbb)
    RFObservationDetails_Ingest.add(pgri: pgri, &fbb)
    RFObservationDetails_Ingest.add(confidence: confidence, &fbb)
    RFObservationDetails_Ingest.add(incoming: incoming, &fbb)
    RFObservationDetails_Ingest.add(switchPoint: switchPoint, &fbb)
    RFObservationDetails_Ingest.add(baudRate: baudRate, &fbb)
    RFObservationDetails_Ingest.add(snr: snr, &fbb)
    RFObservationDetails_Ingest.add(nominalSnr: nominalSnr, &fbb)
    RFObservationDetails_Ingest.add(polarity: polarity, &fbb)
    RFObservationDetails_Ingest.add(polarityType: polarityType, &fbb)
    RFObservationDetails_Ingest.add(channel: channel, &fbb)
    RFObservationDetails_Ingest.add(powerOverNoise: powerOverNoise, &fbb)
    RFObservationDetails_Ingest.add(nominalPowerOverNoise: nominalPowerOverNoise, &fbb)
    RFObservationDetails_Ingest.add(bandwidth: bandwidth, &fbb)
    RFObservationDetails_Ingest.add(nominalBandwidth: nominalBandwidth, &fbb)
    RFObservationDetails_Ingest.add(resolutionBandwidth: resolutionBandwidth, &fbb)
    RFObservationDetails_Ingest.add(videoBandwidth: videoBandwidth, &fbb)
    RFObservationDetails_Ingest.add(eirp: eirp, &fbb)
    RFObservationDetails_Ingest.add(nominalEirp: nominalEirp, &fbb)
    RFObservationDetails_Ingest.add(minPsd: minPsd, &fbb)
    RFObservationDetails_Ingest.add(maxPsd: maxPsd, &fbb)
    RFObservationDetails_Ingest.add(frequencyShift: frequencyShift, &fbb)
    RFObservationDetails_Ingest.add(peak: peak, &fbb)
    RFObservationDetails_Ingest.add(antennaName: antennaName, &fbb)
    RFObservationDetails_Ingest.add(detectionStatus: detectionStatus, &fbb)
    RFObservationDetails_Ingest.add(collectionMode: collectionMode, &fbb)
    RFObservationDetails_Ingest.add(rawFileUri: rawFileUri, &fbb)
    RFObservationDetails_Ingest.add(source: source, &fbb)
    RFObservationDetails_Ingest.add(origin: origin, &fbb)
    RFObservationDetails_Ingest.add(dataMode: dataMode, &fbb)
    RFObservationDetails_Ingest.addVectorOf(tags: tags, &fbb)
    RFObservationDetails_Ingest.add(createdAt: createdAt, &fbb)
    RFObservationDetails_Ingest.add(createdBy: createdBy, &fbb)
    RFObservationDetails_Ingest.add(noisePwrDensity: noisePwrDensity, &fbb)
    RFObservationDetails_Ingest.add(carrierStandard: carrierStandard, &fbb)
    RFObservationDetails_Ingest.add(modulation: modulation, &fbb)
    RFObservationDetails_Ingest.add(innerCodingRate: innerCodingRate, &fbb)
    RFObservationDetails_Ingest.add(outerCodingRate: outerCodingRate, &fbb)
    RFObservationDetails_Ingest.add(transmitFilterType: transmitFilterType, &fbb)
    RFObservationDetails_Ingest.add(transmitFilterRollOff: transmitFilterRollOff, &fbb)
    RFObservationDetails_Ingest.add(symbolToNoiseRatio: symbolToNoiseRatio, &fbb)
    RFObservationDetails_Ingest.add(bitErrorRate: bitErrorRate, &fbb)
    RFObservationDetails_Ingest.add(origNetwork: origNetwork, &fbb)
    RFObservationDetails_Ingest.add(sourceDl: sourceDl, &fbb)
    RFObservationDetails_Ingest.add(descriptor: descriptor, &fbb)
    RFObservationDetails_Ingest.add(url: url, &fbb)
    RFObservationDetails_Ingest.addVectorOf(frequencies: frequencies, &fbb)
    RFObservationDetails_Ingest.addVectorOf(powers: powers, &fbb)
    RFObservationDetails_Ingest.addVectorOf(snrs: snrs, &fbb)
    RFObservationDetails_Ingest.addVectorOf(confidences: confidences, &fbb)
    RFObservationDetails_Ingest.addVectorOf(detectionStatuses: detectionStatuses, &fbb)
    RFObservationDetails_Ingest.addVectorOf(chipRates: chipRates, &fbb)
    RFObservationDetails_Ingest.addVectorOf(codeTaps: codeTaps, &fbb)
    RFObservationDetails_Ingest.addVectorOf(codeFills: codeFills, &fbb)
    RFObservationDetails_Ingest.addVectorOf(codeLengths: codeLengths, &fbb)
    RFObservationDetails_Ingest.addVectorOf(pnOrders: pnOrders, &fbb)
    RFObservationDetails_Ingest.addVectorOf(signalIds: signalIds, &fbb)
    RFObservationDetails_Ingest.addVectorOf(baudRates: baudRates, &fbb)
    RFObservationDetails_Ingest.addVectorOf(telemetryIds: telemetryIds, &fbb)
    RFObservationDetails_Ingest.addVectorOf(constellationXpoints: constellationXpoints, &fbb)
    RFObservationDetails_Ingest.addVectorOf(constellationYpoints: constellationYpoints, &fbb)
    return RFObservationDetails_Ingest.endRFObservationDetails_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.polarityType.p, fieldName: "polarityType", required: false, type: RFObservationDetails_Ingest_polarityType_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: RFObservationDetails_Ingest_dataMode_Enum.self)
