...
public enum ObjectOfInterest_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: ObjectOfInterest_Full_dataMode_Enum { return .exercise }
  public static var min: ObjectOfInterest_Full_dataMode_Enum { return .real }
}


///  /// OnOrbit objects of interest, which include information about the last known state of the object.
public struct ObjectOfInterest_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ObjectOfInterest_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: ObjectOfInterest_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : ObjectOfInterest_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startObjectOfInterest_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 48) }
  ...
  public static func add(dataMode: ObjectOfInterest_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endObjectOfInterest_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createObjectOfInterest_Full(
    ...
    let __start = ObjectOfInterest_Full.startObjectOfInterest_Full(&fbb)
    ObjectOfInterest_Full.add(id: id, &fbb)
    ObjectOfInterest_Full.add(classificationMarking: classificationMarking, &fbb)
    ObjectOfInterest_Full.add(idOnOrbit: idOnOrbit, &fbb)
    ObjectOfInterest_Full.add(satNo: satNo, &fbb)
    ObjectOfInterest_Full.add(name: name, &fbb)
    ObjectOfInterest_Full.add(sensorTaskingStartTime: sensorTaskingStartTime, &fbb)
    ObjectOfInterest_Full.add(sensorTaskingStopTime: sensorTaskingStopTime, &fbb)
    ObjectOfInterest_Full.add(priority: priority, &fbb)
    ObjectOfInterest_Full.add(status: status, &fbb)
    ObjectOfInterest_Full.add(statusDate: statusDate, &fbb)
    ObjectOfInterest_Full.add(description: description, &fbb)
    ObjectOfInterest_Full.add(lastObTime: lastObTime, &fbb)
    ObjectOfInterest_Full.add(missedObTime: missedObTime, &fbb)
    ObjectOfInterest_Full.addVectorOf(deltaVs: deltaVs, &fbb)
    ObjectOfInterest_Full.addVectorOf(deltaTs: deltaTs, &fbb)
    ObjectOfInterest_Full.add(svEpoch: svEpoch, &fbb)
    ObjectOfInterest_Full.add(x: x, &fbb)
    ObjectOfInterest_Full.add(y: y, &fbb)
    ObjectOfInterest_Full.add(z: z, &fbb)
    ObjectOfInterest_Full.add(xvel: xvel, &fbb)
    ObjectOfInterest_Full.add(yvel: yvel, &fbb)
    ObjectOfInterest_Full.add(zvel: zvel, &fbb)
    ObjectOfInterest_Full.add(elsetEpoch: elsetEpoch, &fbb)
    ObjectOfInterest_Full.add(meanMotion: meanMotion, &fbb)
    ObjectOfInterest_Full.add(eccentricity: eccentricity, &fbb)
    ObjectOfInterest_Full.add(inclination: inclination, &fbb)
    ObjectOfInterest_Full.add(raan: raan, &fbb)
    ObjectOfInterest_Full.add(argOfPerigee: argOfPerigee, &fbb)
    ObjectOfInterest_Full.add(meanAnomaly: meanAnomaly, &fbb)
    ObjectOfInterest_Full.add(revNo: revNo, &fbb)
    ObjectOfInterest_Full.add(bStar: bStar, &fbb)
    ObjectOfInterest_Full.add(meanMotionDot: meanMotionDot, &fbb)
    ObjectOfInterest_Full.add(meanMotionDdot: meanMotionDdot, &fbb)
    ObjectOfInterest_Full.add(semiMajorAxis: semiMajorAxis, &fbb)
    ObjectOfInterest_Full.add(period: period, &fbb)
    ObjectOfInterest_Full.add(apogee: apogee, &fbb)
    ObjectOfInterest_Full.add(perigee: perigee, &fbb)
    ObjectOfInterest_Full.addVectorOf(affectedObjects: affectedObjects, &fbb)
    ObjectOfInterest_Full.add(createdAt: createdAt, &fbb)
    ObjectOfInterest_Full.add(createdBy: createdBy, &fbb)
    ObjectOfInterest_Full.add(updatedAt: updatedAt, &fbb)
    ObjectOfInterest_Full.add(updatedBy: updatedBy, &fbb)
    ObjectOfInterest_Full.add(source: source, &fbb)
    ObjectOfInterest_Full.add(origin: origin, &fbb)
    ObjectOfInterest_Full.add(origNetwork: origNetwork, &fbb)
    ObjectOfInterest_Full.add(dataMode: dataMode, &fbb)
    ObjectOfInterest_Full.add(onOrbit: onOrbit, &fbb)
    ObjectOfInterest_Full.addVectorOf(manifolds: manifolds, &fbb)
    return ObjectOfInterest_Full.endObjectOfInterest_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: ObjectOfInterest_Full_dataMode_Enum.self)
