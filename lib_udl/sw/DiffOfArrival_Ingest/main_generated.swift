...
public enum DiffOfArrival_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: DiffOfArrival_Ingest_dataMode_Enum { return .exercise }
  public static var min: DiffOfArrival_Ingest_dataMode_Enum { return .real }
}
...
public struct DiffOfArrival_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DiffOfArrival_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: DiffOfArrival_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : DiffOfArrival_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startDiffOfArrival_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 43) }
  ...
  public static func add(dataMode: DiffOfArrival_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endDiffOfArrival_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDiffOfArrival_Ingest(
    ...
    let __start = DiffOfArrival_Ingest.startDiffOfArrival_Ingest(&fbb)
    DiffOfArrival_Ingest.add(id: id, &fbb)
    DiffOfArrival_Ingest.add(classificationMarking: classificationMarking, &fbb)
    DiffOfArrival_Ingest.add(obTime: obTime, &fbb)
    DiffOfArrival_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    DiffOfArrival_Ingest.add(idSensor1: idSensor1, &fbb)
    DiffOfArrival_Ingest.add(idSensor2: idSensor2, &fbb)
    DiffOfArrival_Ingest.add(satNo: satNo, &fbb)
    DiffOfArrival_Ingest.add(taskId: taskId, &fbb)
    DiffOfArrival_Ingest.add(origObjectId: origObjectId, &fbb)
    DiffOfArrival_Ingest.add(origSensorId1: origSensorId1, &fbb)
    DiffOfArrival_Ingest.add(origSensorId2: origSensorId2, &fbb)
    DiffOfArrival_Ingest.add(uct: uct, &fbb)
    DiffOfArrival_Ingest.add(sensor1Delay: sensor1Delay, &fbb)
    DiffOfArrival_Ingest.add(sensor2Delay: sensor2Delay, &fbb)
    DiffOfArrival_Ingest.add(senlat: senlat, &fbb)
    DiffOfArrival_Ingest.add(senlon: senlon, &fbb)
    DiffOfArrival_Ingest.add(senalt: senalt, &fbb)
    DiffOfArrival_Ingest.add(sen2lat: sen2lat, &fbb)
    DiffOfArrival_Ingest.add(sen2lon: sen2lon, &fbb)
    DiffOfArrival_Ingest.add(sen2alt: sen2alt, &fbb)
    DiffOfArrival_Ingest.add(frequency: frequency, &fbb)
    DiffOfArrival_Ingest.add(bandwidth: bandwidth, &fbb)
    DiffOfArrival_Ingest.add(deltaRange: deltaRange, &fbb)
    DiffOfArrival_Ingest.add(deltaRangeUnc: deltaRangeUnc, &fbb)
    DiffOfArrival_Ingest.add(deltaRangeRate: deltaRangeRate, &fbb)
    DiffOfArrival_Ingest.add(deltaRangeRateUnc: deltaRangeRateUnc, &fbb)
    DiffOfArrival_Ingest.add(snr: snr, &fbb)
    DiffOfArrival_Ingest.add(tdoa: tdoa, &fbb)
    DiffOfArrival_Ingest.add(tdoaUnc: tdoaUnc, &fbb)
    DiffOfArrival_Ingest.add(fdoa: fdoa, &fbb)
    DiffOfArrival_Ingest.add(fdoaUnc: fdoaUnc, &fbb)
    DiffOfArrival_Ingest.add(collectionMode: collectionMode, &fbb)
    DiffOfArrival_Ingest.add(rawFileUri: rawFileUri, &fbb)
    DiffOfArrival_Ingest.add(source: source, &fbb)
    DiffOfArrival_Ingest.add(dataMode: dataMode, &fbb)
    DiffOfArrival_Ingest.addVectorOf(tags: tags, &fbb)
    DiffOfArrival_Ingest.add(origin: origin, &fbb)
    DiffOfArrival_Ingest.add(createdAt: createdAt, &fbb)
    DiffOfArrival_Ingest.add(createdBy: createdBy, &fbb)
    DiffOfArrival_Ingest.add(descriptor: descriptor, &fbb)
    DiffOfArrival_Ingest.add(transactionId: transactionId, &fbb)
    DiffOfArrival_Ingest.add(origNetwork: origNetwork, &fbb)
    DiffOfArrival_Ingest.add(sourceDl: sourceDl, &fbb)
    return DiffOfArrival_Ingest.endDiffOfArrival_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: DiffOfArrival_Ingest_dataMode_Enum.self)
