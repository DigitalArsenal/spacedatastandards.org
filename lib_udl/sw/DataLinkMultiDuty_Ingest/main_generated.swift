...
public struct DataLinkMultiDuty_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DataLinkMultiDuty_Ingest.id, addPrefix: prefix) }
  ...
  public static func startDataLinkMultiDuty_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 6) }
  ...
  public static func endDataLinkMultiDuty_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDataLinkMultiDuty_Ingest(
    ...
    let __start = DataLinkMultiDuty_Ingest.startDataLinkMultiDuty_Ingest(&fbb)
    DataLinkMultiDuty_Ingest.add(unitDes: unitDes, &fbb)
    DataLinkMultiDuty_Ingest.add(name: name, &fbb)
    DataLinkMultiDuty_Ingest.add(rank: rank, &fbb)
    DataLinkMultiDuty_Ingest.add(duty: duty, &fbb)
    DataLinkMultiDuty_Ingest.addVectorOf(dutyTeleFreqNums: dutyTeleFreqNums, &fbb)
    DataLinkMultiDuty_Ingest.addVectorOf(multiDutyVoiceCoord: multiDutyVoiceCoord, &fbb)
    return DataLinkMultiDuty_Ingest.endDataLinkMultiDuty_Ingest(&fbb, start: __start)
  }
