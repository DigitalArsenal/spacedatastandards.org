...
public enum OrganizationDetails_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OrganizationDetails_Full_dataMode_Enum { return .exercise }
  public static var min: OrganizationDetails_Full_dataMode_Enum { return .real }
}


///  /// Model representation of additional detailed organization data as collected by a particular source.
public struct OrganizationDetails_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OrganizationDetails_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: OrganizationDetails_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OrganizationDetails_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOrganizationDetails_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 39) }
  ...
  public static func add(dataMode: OrganizationDetails_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endOrganizationDetails_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOrganizationDetails_Full(
    ...
    let __start = OrganizationDetails_Full.startOrganizationDetails_Full(&fbb)
    OrganizationDetails_Full.add(id: id, &fbb)
    OrganizationDetails_Full.add(idOrganization: idOrganization, &fbb)
    OrganizationDetails_Full.add(classificationMarking: classificationMarking, &fbb)
    OrganizationDetails_Full.add(name: name, &fbb)
    OrganizationDetails_Full.add(email: email, &fbb)
    OrganizationDetails_Full.add(address1: address1, &fbb)
    OrganizationDetails_Full.add(address2: address2, &fbb)
    OrganizationDetails_Full.add(address3: address3, &fbb)
    OrganizationDetails_Full.add(geoAdminLevel1: geoAdminLevel1, &fbb)
    OrganizationDetails_Full.add(geoAdminLevel2: geoAdminLevel2, &fbb)
    OrganizationDetails_Full.add(geoAdminLevel3: geoAdminLevel3, &fbb)
    OrganizationDetails_Full.add(postalCode: postalCode, &fbb)
    OrganizationDetails_Full.add(description: description, &fbb)
    OrganizationDetails_Full.add(formerOrgId: formerOrgId, &fbb)
    OrganizationDetails_Full.add(parentOrgId: parentOrgId, &fbb)
    OrganizationDetails_Full.add(financialYearEndDate: financialYearEndDate, &fbb)
    OrganizationDetails_Full.add(revenue: revenue, &fbb)
    OrganizationDetails_Full.add(profit: profit, &fbb)
    OrganizationDetails_Full.add(ebitda: ebitda, &fbb)
    OrganizationDetails_Full.add(ftes: ftes, &fbb)
    OrganizationDetails_Full.add(broker: broker, &fbb)
    OrganizationDetails_Full.add(ceo: ceo, &fbb)
    OrganizationDetails_Full.add(cfo: cfo, &fbb)
    OrganizationDetails_Full.add(cto: cto, &fbb)
    OrganizationDetails_Full.add(riskManager: riskManager, &fbb)
    OrganizationDetails_Full.add(massRanking: massRanking, &fbb)
    OrganizationDetails_Full.add(revenueRanking: revenueRanking, &fbb)
    OrganizationDetails_Full.add(financialNotes: financialNotes, &fbb)
    OrganizationDetails_Full.add(servicesNotes: servicesNotes, &fbb)
    OrganizationDetails_Full.add(fleetPlanNotes: fleetPlanNotes, &fbb)
    OrganizationDetails_Full.add(source: source, &fbb)
    OrganizationDetails_Full.add(origin: origin, &fbb)
    OrganizationDetails_Full.add(dataMode: dataMode, &fbb)
    OrganizationDetails_Full.addVectorOf(tags: tags, &fbb)
    OrganizationDetails_Full.add(createdAt: createdAt, &fbb)
    OrganizationDetails_Full.add(createdBy: createdBy, &fbb)
    OrganizationDetails_Full.add(updatedAt: updatedAt, &fbb)
    OrganizationDetails_Full.add(updatedBy: updatedBy, &fbb)
    OrganizationDetails_Full.add(origNetwork: origNetwork, &fbb)
    return OrganizationDetails_Full.endOrganizationDetails_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OrganizationDetails_Full_dataMode_Enum.self)
