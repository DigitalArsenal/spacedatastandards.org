...
public struct MtiPlatformLocation_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiPlatformLocation_Abridged.id, addPrefix: prefix) }
  ...
  public static func startMtiPlatformLocation_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 8) }
  ...
  public static func endMtiPlatformLocation_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiPlatformLocation_Abridged(
    ...
    let __start = MtiPlatformLocation_Abridged.startMtiPlatformLocation_Abridged(&fbb)
    MtiPlatformLocation_Abridged.add(l1: l1, &fbb)
    MtiPlatformLocation_Abridged.add(l2: l2, &fbb)
    MtiPlatformLocation_Abridged.add(l3: l3, &fbb)
    MtiPlatformLocation_Abridged.add(l4: l4, &fbb)
    MtiPlatformLocation_Abridged.add(l5: l5, &fbb)
    MtiPlatformLocation_Abridged.add(l6: l6, &fbb)
    MtiPlatformLocation_Abridged.add(l7: l7, &fbb)
    MtiPlatformLocation_Abridged.add(platlocts: platlocts, &fbb)
    return MtiPlatformLocation_Abridged.endMtiPlatformLocation_Abridged(&fbb, start: __start)
  }
