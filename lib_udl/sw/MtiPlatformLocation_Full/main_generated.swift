...
public struct MtiPlatformLocation_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiPlatformLocation_Full.id, addPrefix: prefix) }
  ...
  public static func startMtiPlatformLocation_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 8) }
  ...
  public static func endMtiPlatformLocation_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiPlatformLocation_Full(
    ...
    let __start = MtiPlatformLocation_Full.startMtiPlatformLocation_Full(&fbb)
    MtiPlatformLocation_Full.add(l1: l1, &fbb)
    MtiPlatformLocation_Full.add(l2: l2, &fbb)
    MtiPlatformLocation_Full.add(l3: l3, &fbb)
    MtiPlatformLocation_Full.add(l4: l4, &fbb)
    MtiPlatformLocation_Full.add(l5: l5, &fbb)
    MtiPlatformLocation_Full.add(l6: l6, &fbb)
    MtiPlatformLocation_Full.add(l7: l7, &fbb)
    MtiPlatformLocation_Full.add(platlocts: platlocts, &fbb)
    return MtiPlatformLocation_Full.endMtiPlatformLocation_Full(&fbb, start: __start)
  }
