...
public enum ISRCollection_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: ISRCollection_Full_dataMode_Enum { return .exercise }
  public static var min: ISRCollection_Full_dataMode_Enum { return .real }
}


///  /// ISR Collection data.
public struct ISRCollection_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollection_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: ISRCollection_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : ISRCollection_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startISRCollection_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 34) }
  ...
  public static func add(dataMode: ISRCollection_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endISRCollection_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollection_Full(
    ...
    let __start = ISRCollection_Full.startISRCollection_Full(&fbb)
    ISRCollection_Full.add(id: id, &fbb)
    ISRCollection_Full.add(classificationMarking: classificationMarking, &fbb)
    ISRCollection_Full.add(idexVersion: idexVersion, &fbb)
    ISRCollection_Full.add(name: name, &fbb)
    ISRCollection_Full.add(missionId: missionId, &fbb)
    ISRCollection_Full.add(missionAor: missionAor, &fbb)
    ISRCollection_Full.add(missionPrimaryIntelDiscipline: missionPrimaryIntelDiscipline, &fbb)
    ISRCollection_Full.add(missionPrimarySubCategory: missionPrimarySubCategory, &fbb)
    ISRCollection_Full.add(missionSecondaryIntelDiscipline: missionSecondaryIntelDiscipline, &fbb)
    ISRCollection_Full.add(missionSecondarySubCategory: missionSecondarySubCategory, &fbb)
    ISRCollection_Full.add(missionRole: missionRole, &fbb)
    ISRCollection_Full.add(missionOperation: missionOperation, &fbb)
    ISRCollection_Full.add(missionPriority: missionPriority, &fbb)
    ISRCollection_Full.add(missionSupportedUnit: missionSupportedUnit, &fbb)
    ISRCollection_Full.add(missionEmphasis: missionEmphasis, &fbb)
    ISRCollection_Full.add(missionStartPointLat: missionStartPointLat, &fbb)
    ISRCollection_Full.add(missionStartPointLong: missionStartPointLong, &fbb)
    ISRCollection_Full.add(missionCollectionArea: missionCollectionArea, &fbb)
    ISRCollection_Full.add(missionJoa: missionJoa, &fbb)
    ISRCollection_Full.add(missionSyncMatrixBin: missionSyncMatrixBin, &fbb)
    ISRCollection_Full.add(missionCountry: missionCountry, &fbb)
    ISRCollection_Full.add(missionRegion: missionRegion, &fbb)
    ISRCollection_Full.add(missionSubRegion: missionSubRegion, &fbb)
    ISRCollection_Full.addVectorOf(collectionRequirements: collectionRequirements, &fbb)
    ISRCollection_Full.addVectorOf(transit: transit, &fbb)
    ISRCollection_Full.addVectorOf(taskings: taskings, &fbb)
    ISRCollection_Full.add(createdAt: createdAt, &fbb)
    ISRCollection_Full.add(createdBy: createdBy, &fbb)
    ISRCollection_Full.add(updatedAt: updatedAt, &fbb)
    ISRCollection_Full.add(updatedBy: updatedBy, &fbb)
    ISRCollection_Full.add(source: source, &fbb)
    ISRCollection_Full.add(origin: origin, &fbb)
    ISRCollection_Full.add(dataMode: dataMode, &fbb)
    ISRCollection_Full.add(origNetwork: origNetwork, &fbb)
    return ISRCollection_Full.endISRCollection_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: ISRCollection_Full_dataMode_Enum.self)
