...
public enum AirfieldSlotConsumption_Full_status_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AirfieldSlotConsumption_Full_status_Enum { return .other }
  public static var min: AirfieldSlotConsumption_Full_status_Enum { return .requested }
}


public enum AirfieldSlotConsumption_Full_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: AirfieldSlotConsumption_Full_dataMode_Enum { return .exercise }
  public static var min: AirfieldSlotConsumption_Full_dataMode_Enum { return .real }
}


///  /// Airfield slot use data. Contains the dynamic data associated with the status and use of specific airfield slots.
public struct AirfieldSlotConsumption_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirfieldSlotConsumption_Full.id, addPrefix: prefix) }
  ...
  public var status: AirfieldSlotConsumption_Full_status_Enum { let o = _accessor.offset(VTOFFSET.status.v); return o == 0 ? .requested : AirfieldSlotConsumption_Full_status_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .requested }
  ...
  public var dataMode: AirfieldSlotConsumption_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AirfieldSlotConsumption_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startAirfieldSlotConsumption_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 39) }
  ...
  public static func add(status: AirfieldSlotConsumption_Full_status_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: status.rawValue, def: 0, at: VTOFFSET.status.p) }
  ...
  public static func add(dataMode: AirfieldSlotConsumption_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endAirfieldSlotConsumption_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirfieldSlotConsumption_Full(
    ...
    let __start = AirfieldSlotConsumption_Full.startAirfieldSlotConsumption_Full(&fbb)
    AirfieldSlotConsumption_Full.add(id: id, &fbb)
    AirfieldSlotConsumption_Full.add(classificationMarking: classificationMarking, &fbb)
    AirfieldSlotConsumption_Full.add(idAirfieldSlot: idAirfieldSlot, &fbb)
    AirfieldSlotConsumption_Full.add(status: status, &fbb)
    AirfieldSlotConsumption_Full.add(occupied: occupied, &fbb)
    AirfieldSlotConsumption_Full.add(consumer: consumer, &fbb)
    AirfieldSlotConsumption_Full.add(occAircraftMds: occAircraftMds, &fbb)
    AirfieldSlotConsumption_Full.add(occTailNumber: occTailNumber, &fbb)
    AirfieldSlotConsumption_Full.addVectorOf(callSigns: callSigns, &fbb)
    AirfieldSlotConsumption_Full.add(missionId: missionId, &fbb)
    AirfieldSlotConsumption_Full.add(numAircraft: numAircraft, &fbb)
    AirfieldSlotConsumption_Full.add(occStartTime: occStartTime, &fbb)
    AirfieldSlotConsumption_Full.add(resAircraftMds: resAircraftMds, &fbb)
    AirfieldSlotConsumption_Full.add(resTailNumber: resTailNumber, &fbb)
    AirfieldSlotConsumption_Full.add(resType: resType, &fbb)
    AirfieldSlotConsumption_Full.add(resReason: resReason, &fbb)
    AirfieldSlotConsumption_Full.add(resMissionId: resMissionId, &fbb)
    AirfieldSlotConsumption_Full.add(startTime: startTime, &fbb)
    AirfieldSlotConsumption_Full.add(endTime: endTime, &fbb)
    AirfieldSlotConsumption_Full.add(targetTime: targetTime, &fbb)
    AirfieldSlotConsumption_Full.add(idArrSortie: idArrSortie, &fbb)
    AirfieldSlotConsumption_Full.add(idDepSortie: idDepSortie, &fbb)
    AirfieldSlotConsumption_Full.add(altArrSortieId: altArrSortieId, &fbb)
    AirfieldSlotConsumption_Full.add(altDepSortieId: altDepSortieId, &fbb)
    AirfieldSlotConsumption_Full.add(reqComment: reqComment, &fbb)
    AirfieldSlotConsumption_Full.add(appComment: appComment, &fbb)
    AirfieldSlotConsumption_Full.add(reqOrg: reqOrg, &fbb)
    AirfieldSlotConsumption_Full.add(reqInitials: reqInitials, &fbb)
    AirfieldSlotConsumption_Full.add(appOrg: appOrg, &fbb)
    AirfieldSlotConsumption_Full.add(appInitials: appInitials, &fbb)
    AirfieldSlotConsumption_Full.add(createdAt: createdAt, &fbb)
    AirfieldSlotConsumption_Full.add(createdBy: createdBy, &fbb)
    AirfieldSlotConsumption_Full.add(updatedAt: updatedAt, &fbb)
    AirfieldSlotConsumption_Full.add(updatedBy: updatedBy, &fbb)
    AirfieldSlotConsumption_Full.add(sourceDl: sourceDl, &fbb)
    AirfieldSlotConsumption_Full.add(source: source, &fbb)
    AirfieldSlotConsumption_Full.add(origin: origin, &fbb)
    AirfieldSlotConsumption_Full.add(origNetwork: origNetwork, &fbb)
    AirfieldSlotConsumption_Full.add(dataMode: dataMode, &fbb)
    return AirfieldSlotConsumption_Full.endAirfieldSlotConsumption_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.status.p, fieldName: "status", required: false, type: AirfieldSlotConsumption_Full_status_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AirfieldSlotConsumption_Full_dataMode_Enum.self)
    _v.finish()
  }
}
