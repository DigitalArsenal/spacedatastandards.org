...
public enum Scientific_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Scientific_Abridged_dataMode_Enum { return .exercise }
  public static var min: Scientific_Abridged_dataMode_Enum { return .real }
}


///  /// Scientific or other data from Seradata.
public struct Scientific_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Scientific_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Scientific_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Scientific_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startScientific_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 16) }
  ...
  public static func add(dataMode: Scientific_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(idEntity: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: idEntity, at: VTOFFSET.idEntity.p) }
  public static func endScientific_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createScientific_Abridged(
    ...
    let __start = Scientific_Abridged.startScientific_Abridged(&fbb)
    Scientific_Abridged.add(id: id, &fbb)
    Scientific_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Scientific_Abridged.add(spacecraftId: spacecraftId, &fbb)
    Scientific_Abridged.add(hostedForCompanyOrgId: hostedForCompanyOrgId, &fbb)
    Scientific_Abridged.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    Scientific_Abridged.add(payloadCategory: payloadCategory, &fbb)
    Scientific_Abridged.add(name: name, &fbb)
    Scientific_Abridged.add(frequencyBand: frequencyBand, &fbb)
    Scientific_Abridged.add(notes: notes, &fbb)
    Scientific_Abridged.add(createdAt: createdAt, &fbb)
    Scientific_Abridged.add(createdBy: createdBy, &fbb)
    Scientific_Abridged.add(source: source, &fbb)
    Scientific_Abridged.add(origin: origin, &fbb)
    Scientific_Abridged.add(origNetwork: origNetwork, &fbb)
    Scientific_Abridged.add(dataMode: dataMode, &fbb)
    Scientific_Abridged.add(idEntity: idEntity, &fbb)
    return Scientific_Abridged.endScientific_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Scientific_Abridged_dataMode_Enum.self)
