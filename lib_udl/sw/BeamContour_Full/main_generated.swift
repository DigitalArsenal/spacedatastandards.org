...
public enum BeamContour_Full_type_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: BeamContour_Full_type_Enum { return .svcArea }
  public static var min: BeamContour_Full_type_Enum { return .boresight }
}


public enum BeamContour_Full_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: BeamContour_Full_dataMode_Enum { return .exercise }
  public static var min: BeamContour_Full_dataMode_Enum { return .real }
}
...
public struct BeamContour_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: BeamContour_Full.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case regionName = 16
    case geography = 18
    case geographyText = 20
    case geographyJson = 22
    case geographyType = 24
    case geographyNdims = 26
    case geographySrid = 28
    case createdAt = 30
    case createdBy = 32
    case updatedAt = 34
    case updatedBy = 36
  ...
  public var type: BeamContour_Full_type_Enum { let o = _accessor.offset(VTOFFSET.type.v); return o == 0 ? .boresight : BeamContour_Full_type_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .boresight }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: BeamContour_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : BeamContour_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startBeamContour_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 21) }
  ...
  public static func add(type: BeamContour_Full_type_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: type.rawValue, def: 0, at: VTOFFSET.type.p) }
  ...
  public static func add(dataMode: BeamContour_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endBeamContour_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createBeamContour_Full(
    _ fbb: inout FlatBufferBuilder,
    idOffset id: Offset = Offset(),
    classificationMarkingOffset classificationMarking: Offset = Offset(),
    idBeamOffset idBeam: Offset = Offset(),
    type: BeamContour_Full_type_Enum = .boresight,
    contourIdx: Int32 = 0,
    gain: Double = 0.0,
    ...
    let __start = BeamContour_Full.startBeamContour_Full(&fbb)
    BeamContour_Full.add(id: id, &fbb)
    BeamContour_Full.add(classificationMarking: classificationMarking, &fbb)
    BeamContour_Full.add(idBeam: idBeam, &fbb)
    BeamContour_Full.add(type: type, &fbb)
    BeamContour_Full.add(contourIdx: contourIdx, &fbb)
    BeamContour_Full.add(gain: gain, &fbb)
    BeamContour_Full.add(regionName: regionName, &fbb)
    BeamContour_Full.add(geography: geography, &fbb)
    BeamContour_Full.add(geographyText: geographyText, &fbb)
    BeamContour_Full.add(geographyJson: geographyJson, &fbb)
    BeamContour_Full.add(geographyType: geographyType, &fbb)
    BeamContour_Full.add(geographyNdims: geographyNdims, &fbb)
    BeamContour_Full.add(geographySrid: geographySrid, &fbb)
    BeamContour_Full.add(createdAt: createdAt, &fbb)
    BeamContour_Full.add(createdBy: createdBy, &fbb)
    BeamContour_Full.add(updatedAt: updatedAt, &fbb)
    BeamContour_Full.add(updatedBy: updatedBy, &fbb)
    BeamContour_Full.add(source: source, &fbb)
    BeamContour_Full.add(origin: origin, &fbb)
    BeamContour_Full.add(origNetwork: origNetwork, &fbb)
    BeamContour_Full.add(dataMode: dataMode, &fbb)
    return BeamContour_Full.endBeamContour_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.type.p, fieldName: "type", required: false, type: BeamContour_Full_type_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: BeamContour_Full_dataMode_Enum.self)
    _v.finish()
  }
}
