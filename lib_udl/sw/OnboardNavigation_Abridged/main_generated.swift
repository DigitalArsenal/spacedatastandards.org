...
public enum OnboardNavigation_Abridged_referenceFrame_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OnboardNavigation_Abridged_referenceFrame_Enum { return .gcrf }
  public static var min: OnboardNavigation_Abridged_referenceFrame_Enum { return .j2000 }
}


public enum OnboardNavigation_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: OnboardNavigation_Abridged_dataMode_Enum { return .exercise }
  public static var min: OnboardNavigation_Abridged_dataMode_Enum { return .real }
}
...
public struct OnboardNavigation_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OnboardNavigation_Abridged.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case esId = 18
    case starCatName = 20
    case starCatLoadTime = 22
    case idStateVector = 24
    case ts = 26
    case referenceFrame = 28
    case sunSensor = 30
    case mag = 32
    case starTracker = 34
    case deltaPos = 36
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 24
  public var referenceFrame: OnboardNavigation_Abridged_referenceFrame_Enum { let o = _accessor.offset(VTOFFSET.referenceFrame.v); return o == 0 ? .j2000 : OnboardNavigation_Abridged_referenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 36
  public var dataMode: OnboardNavigation_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OnboardNavigation_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startOnboardNavigation_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 23) }
  ...
  public static func add(referenceFrame: OnboardNavigation_Abridged_referenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: referenceFrame.rawValue, def: 0, at: VTOFFSET.referenceFrame.p) }
  ...
  public static func add(dataMode: OnboardNavigation_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endOnboardNavigation_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnboardNavigation_Abridged(
    ...
    let __start = OnboardNavigation_Abridged.startOnboardNavigation_Abridged(&fbb)
    OnboardNavigation_Abridged.add(id: id, &fbb)
    OnboardNavigation_Abridged.add(classificationMarking: classificationMarking, &fbb)
    OnboardNavigation_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    OnboardNavigation_Abridged.add(satNo: satNo, &fbb)
    OnboardNavigation_Abridged.add(origObjectId: origObjectId, &fbb)
    OnboardNavigation_Abridged.add(startTime: startTime, &fbb)
    OnboardNavigation_Abridged.add(endTime: endTime, &fbb)
    OnboardNavigation_Abridged.add(esId: esId, &fbb)
    OnboardNavigation_Abridged.add(starCatName: starCatName, &fbb)
    OnboardNavigation_Abridged.add(starCatLoadTime: starCatLoadTime, &fbb)
    OnboardNavigation_Abridged.add(idStateVector: idStateVector, &fbb)
    OnboardNavigation_Abridged.addVectorOf(ts: ts, &fbb)
    OnboardNavigation_Abridged.add(referenceFrame: referenceFrame, &fbb)
    OnboardNavigation_Abridged.addVectorOf(sunSensor: sunSensor, &fbb)
    OnboardNavigation_Abridged.addVectorOf(mag: mag, &fbb)
    OnboardNavigation_Abridged.addVectorOf(starTracker: starTracker, &fbb)
    OnboardNavigation_Abridged.addVectorOf(deltaPos: deltaPos, &fbb)
    OnboardNavigation_Abridged.add(createdAt: createdAt, &fbb)
    OnboardNavigation_Abridged.add(createdBy: createdBy, &fbb)
    OnboardNavigation_Abridged.add(source: source, &fbb)
    OnboardNavigation_Abridged.add(origin: origin, &fbb)
    OnboardNavigation_Abridged.add(origNetwork: origNetwork, &fbb)
    OnboardNavigation_Abridged.add(dataMode: dataMode, &fbb)
    return OnboardNavigation_Abridged.endOnboardNavigation_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.referenceFrame.p, fieldName: "referenceFrame", required: false, type: OnboardNavigation_Abridged_referenceFrame_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OnboardNavigation_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
