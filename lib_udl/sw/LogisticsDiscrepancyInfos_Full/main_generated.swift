...
public struct LogisticsDiscrepancyInfos_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LogisticsDiscrepancyInfos_Full.id, addPrefix: prefix) }
  ...
  public static func startLogisticsDiscrepancyInfos_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endLogisticsDiscrepancyInfos_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLogisticsDiscrepancyInfos_Full(
    ...
    let __start = LogisticsDiscrepancyInfos_Full.startLogisticsDiscrepancyInfos_Full(&fbb)
    LogisticsDiscrepancyInfos_Full.add(jcn: jcn, &fbb)
    LogisticsDiscrepancyInfos_Full.add(discrepancyInfo: discrepancyInfo, &fbb)
    LogisticsDiscrepancyInfos_Full.add(jobStTime: jobStTime, &fbb)
    LogisticsDiscrepancyInfos_Full.add(closureTime: closureTime, &fbb)
    return LogisticsDiscrepancyInfos_Full.endLogisticsDiscrepancyInfos_Full(&fbb, start: __start)
  }
