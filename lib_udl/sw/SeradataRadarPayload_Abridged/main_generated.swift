...
public enum SeradataRadarPayload_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SeradataRadarPayload_Abridged_dataMode_Enum { return .exercise }
  public static var min: SeradataRadarPayload_Abridged_dataMode_Enum { return .real }
}


///  /// Details for an radar payload from  Seradata.
public struct SeradataRadarPayload_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SeradataRadarPayload_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SeradataRadarPayload_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SeradataRadarPayload_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSeradataRadarPayload_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 32) }
  ...
  public static func add(dataMode: SeradataRadarPayload_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSeradataRadarPayload_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSeradataRadarPayload_Abridged(
    ...
    let __start = SeradataRadarPayload_Abridged.startSeradataRadarPayload_Abridged(&fbb)
    SeradataRadarPayload_Abridged.add(id: id, &fbb)
    SeradataRadarPayload_Abridged.add(classificationMarking: classificationMarking, &fbb)
    SeradataRadarPayload_Abridged.add(spacecraftId: spacecraftId, &fbb)
    SeradataRadarPayload_Abridged.add(idSensor: idSensor, &fbb)
    SeradataRadarPayload_Abridged.add(hostedForCompanyOrgId: hostedForCompanyOrgId, &fbb)
    SeradataRadarPayload_Abridged.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    SeradataRadarPayload_Abridged.add(category: category, &fbb)
    SeradataRadarPayload_Abridged.add(name: name, &fbb)
    SeradataRadarPayload_Abridged.add(frequencyBand: frequencyBand, &fbb)
    SeradataRadarPayload_Abridged.add(frequency: frequency, &fbb)
    SeradataRadarPayload_Abridged.add(waveLength: waveLength, &fbb)
    SeradataRadarPayload_Abridged.add(bestResolution: bestResolution, &fbb)
    SeradataRadarPayload_Abridged.add(swathWidth: swathWidth, &fbb)
    SeradataRadarPayload_Abridged.add(recorderSize: recorderSize, &fbb)
    SeradataRadarPayload_Abridged.add(fieldOfView: fieldOfView, &fbb)
    SeradataRadarPayload_Abridged.add(fieldOfRegard: fieldOfRegard, &fbb)
    SeradataRadarPayload_Abridged.add(pointingMethod: pointingMethod, &fbb)
    SeradataRadarPayload_Abridged.add(groundStations: groundStations, &fbb)
    SeradataRadarPayload_Abridged.add(groundStationLocations: groundStationLocations, &fbb)
    SeradataRadarPayload_Abridged.add(transmitPolarization: transmitPolarization, &fbb)
    SeradataRadarPayload_Abridged.add(receivePolarization: receivePolarization, &fbb)
    SeradataRadarPayload_Abridged.add(dutyCycle: dutyCycle, &fbb)
    SeradataRadarPayload_Abridged.add(partnerSpacecraft: partnerSpacecraft, &fbb)
    SeradataRadarPayload_Abridged.add(constellationInterferometricCapability: constellationInterferometricCapability, &fbb)
    SeradataRadarPayload_Abridged.add(notes: notes, &fbb)
    SeradataRadarPayload_Abridged.add(bandwidth: bandwidth, &fbb)
    SeradataRadarPayload_Abridged.add(createdAt: createdAt, &fbb)
    SeradataRadarPayload_Abridged.add(createdBy: createdBy, &fbb)
    SeradataRadarPayload_Abridged.add(source: source, &fbb)
    SeradataRadarPayload_Abridged.add(origin: origin, &fbb)
    SeradataRadarPayload_Abridged.add(origNetwork: origNetwork, &fbb)
    SeradataRadarPayload_Abridged.add(dataMode: dataMode, &fbb)
    return SeradataRadarPayload_Abridged.endSeradataRadarPayload_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SeradataRadarPayload_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
