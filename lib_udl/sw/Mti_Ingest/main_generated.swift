...
public enum Mti_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Mti_Ingest_dataMode_Enum { return .exercise }
  public static var min: Mti_Ingest_dataMode_Enum { return .real }
}


///  /// Information on the mission and flight plans, the type and configuration of the platform, and the reference time.
public struct Mti_Ingest: FlatBufferObject, Verifiable {

  static func validateVersion() { FlatBuffersVersion_24_3_25() }
  public var __buffer: ByteBuffer! { return _accessor.bb }
  private var _accessor: Table

  public static var id: String { "MTII" } 
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Mti_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: Mti_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Mti_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startMti_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 21) }
  public static func add(classificationMarking: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: classificationMarking, at: VTOFFSET.classificationMarking.p) }
  public static func add(source: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: source, at: VTOFFSET.source.p) }
  public static func add(origin: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origin, at: VTOFFSET.origin.p) }
  public static func add(id: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: id, at: VTOFFSET.id.p) }
  public static func add(dataMode: Mti_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endMti_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMti_Ingest(
    ...
    let __start = Mti_Ingest.startMti_Ingest(&fbb)
    Mti_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Mti_Ingest.add(source: source, &fbb)
    Mti_Ingest.add(origin: origin, &fbb)
    Mti_Ingest.add(id: id, &fbb)
    Mti_Ingest.add(dataMode: dataMode, &fbb)
    Mti_Ingest.add(createdBy: createdBy, &fbb)
    Mti_Ingest.add(createdAt: createdAt, &fbb)
    Mti_Ingest.add(p3: p3, &fbb)
    Mti_Ingest.add(p6: p6, &fbb)
    Mti_Ingest.add(p7: p7, &fbb)
    Mti_Ingest.add(p8: p8, &fbb)
    Mti_Ingest.add(p9: p9, &fbb)
    Mti_Ingest.add(p10: p10, &fbb)
    Mti_Ingest.addVectorOf(missions: missions, &fbb)
    Mti_Ingest.addVectorOf(dwells: dwells, &fbb)
    Mti_Ingest.addVectorOf(hrrs: hrrs, &fbb)
    Mti_Ingest.addVectorOf(jobDefs: jobDefs, &fbb)
    Mti_Ingest.addVectorOf(freeTexts: freeTexts, &fbb)
    Mti_Ingest.addVectorOf(platformLocs: platformLocs, &fbb)
    Mti_Ingest.addVectorOf(jobRequests: jobRequests, &fbb)
    Mti_Ingest.add(origNetwork: origNetwork, &fbb)
    return Mti_Ingest.endMti_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Mti_Ingest_dataMode_Enum.self)
