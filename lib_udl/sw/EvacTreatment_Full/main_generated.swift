...
public struct EvacTreatment_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacTreatment_Full.id, addPrefix: prefix) }
  ...
  public static func startEvacTreatment_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endEvacTreatment_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacTreatment_Full(
    ...
    let __start = EvacTreatment_Full.startEvacTreatment_Full(&fbb)
    EvacTreatment_Full.add(type: type, &fbb)
    EvacTreatment_Full.add(bodyPart: bodyPart, &fbb)
    EvacTreatment_Full.add(time: time, &fbb)
    EvacTreatment_Full.add(comments: comments, &fbb)
    return EvacTreatment_Full.endEvacTreatment_Full(&fbb, start: __start)
  }
