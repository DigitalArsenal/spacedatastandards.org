...
public enum RFGeoLocation_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: RFGeoLocation_Abridged_dataMode_Enum { return .exercise }
  public static var min: RFGeoLocation_Abridged_dataMode_Enum { return .real }
}


///  /// Model representation of geolocation data for a radio frequency (RF) signal or emitter.
public struct RFGeoLocation_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: RFGeoLocation_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: RFGeoLocation_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : RFGeoLocation_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startRFGeoLocation_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 41) }
  ...
  public static func add(dataMode: RFGeoLocation_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endRFGeoLocation_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createRFGeoLocation_Abridged(
    ...
    let __start = RFGeoLocation_Abridged.startRFGeoLocation_Abridged(&fbb)
    RFGeoLocation_Abridged.add(id: id, &fbb)
    RFGeoLocation_Abridged.add(classificationMarking: classificationMarking, &fbb)
    RFGeoLocation_Abridged.add(orderId: orderId, &fbb)
    RFGeoLocation_Abridged.add(createdTs: createdTs, &fbb)
    RFGeoLocation_Abridged.add(receivedTs: receivedTs, &fbb)
    RFGeoLocation_Abridged.add(startTime: startTime, &fbb)
    RFGeoLocation_Abridged.add(endTime: endTime, &fbb)
    RFGeoLocation_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    RFGeoLocation_Abridged.add(satNo: satNo, &fbb)
    RFGeoLocation_Abridged.add(origObjectId: origObjectId, &fbb)
    RFGeoLocation_Abridged.add(constellation: constellation, &fbb)
    RFGeoLocation_Abridged.add(signalOfInterest: signalOfInterest, &fbb)
    RFGeoLocation_Abridged.add(idRfemitter: idRfemitter, &fbb)
    RFGeoLocation_Abridged.add(origRfemitterId: origRfemitterId, &fbb)
    RFGeoLocation_Abridged.add(numBursts: numBursts, &fbb)
    RFGeoLocation_Abridged.add(minFreq: minFreq, &fbb)
    RFGeoLocation_Abridged.add(maxFreq: maxFreq, &fbb)
    RFGeoLocation_Abridged.add(centerFreq: centerFreq, &fbb)
    RFGeoLocation_Abridged.add(detectLat: detectLat, &fbb)
    RFGeoLocation_Abridged.add(detectLon: detectLon, &fbb)
    RFGeoLocation_Abridged.add(detectAlt: detectAlt, &fbb)
    RFGeoLocation_Abridged.add(confSemiMajor: confSemiMajor, &fbb)
    RFGeoLocation_Abridged.add(confSemiMinor: confSemiMinor, &fbb)
    RFGeoLocation_Abridged.add(confOrientation: confOrientation, &fbb)
    RFGeoLocation_Abridged.add(confArea: confArea, &fbb)
    RFGeoLocation_Abridged.add(atype: atype, &fbb)
    RFGeoLocation_Abridged.add(agjson: agjson, &fbb)
    RFGeoLocation_Abridged.add(atext: atext, &fbb)
    RFGeoLocation_Abridged.add(andims: andims, &fbb)
    RFGeoLocation_Abridged.add(asrid: asrid, &fbb)
    RFGeoLocation_Abridged.add(passGroupId: passGroupId, &fbb)
    RFGeoLocation_Abridged.add(algVersion: algVersion, &fbb)
    RFGeoLocation_Abridged.add(externalId: externalId, &fbb)
    RFGeoLocation_Abridged.addVectorOf(tags: tags, &fbb)
    RFGeoLocation_Abridged.add(createdAt: createdAt, &fbb)
    RFGeoLocation_Abridged.add(createdBy: createdBy, &fbb)
    RFGeoLocation_Abridged.add(source: source, &fbb)
    RFGeoLocation_Abridged.add(origin: origin, &fbb)
    RFGeoLocation_Abridged.add(origNetwork: origNetwork, &fbb)
    RFGeoLocation_Abridged.add(sourceDl: sourceDl, &fbb)
    RFGeoLocation_Abridged.add(dataMode: dataMode, &fbb)
    return RFGeoLocation_Abridged.endRFGeoLocation_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: RFGeoLocation_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
