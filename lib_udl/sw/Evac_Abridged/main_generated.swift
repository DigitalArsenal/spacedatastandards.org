...
public enum Evac_Abridged_type_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Evac_Abridged_type_Enum { return .response }
  public static var min: Evac_Abridged_type_Enum { return .request }
}


public enum Evac_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: Evac_Abridged_dataMode_Enum { return .exercise }
  public static var min: Evac_Abridged_dataMode_Enum { return .real }
}


///  /// Casualty report and evacuation request. Used to report and request support to evacuate friendly and enemy casualties.
public struct Evac_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Evac_Abridged.id, addPrefix: prefix) }
  ...
  public var type: Evac_Abridged_type_Enum { let o = _accessor.offset(VTOFFSET.type.v); return o == 0 ? .request : Evac_Abridged_type_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .request }
  ...
  public var dataMode: Evac_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Evac_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startEvac_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 40) }
  ...
  public static func add(type: Evac_Abridged_type_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: type.rawValue, def: 0, at: VTOFFSET.type.p) }
  ...
  public static func add(dataMode: Evac_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endEvac_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvac_Abridged(
    _ fbb: inout FlatBufferBuilder,
    idOffset id: Offset = Offset(),
    classificationMarkingOffset classificationMarking: Offset = Offset(),
    medevacIdOffset medevacId: Offset = Offset(),
    type: Evac_Abridged_type_Enum = .request,
    ...
    let __start = Evac_Abridged.startEvac_Abridged(&fbb)
    Evac_Abridged.add(id: id, &fbb)
    Evac_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Evac_Abridged.add(medevacId: medevacId, &fbb)
    Evac_Abridged.add(type: type, &fbb)
    Evac_Abridged.add(missionType: missionType, &fbb)
    Evac_Abridged.add(idWeatherReport: idWeatherReport, &fbb)
    Evac_Abridged.add(numKia: numKia, &fbb)
    Evac_Abridged.add(numWia: numWia, &fbb)
    Evac_Abridged.add(numLitter: numLitter, &fbb)
    Evac_Abridged.add(numAmbulatory: numAmbulatory, &fbb)
    Evac_Abridged.add(medicReq: medicReq, &fbb)
    Evac_Abridged.add(reqNum: reqNum, &fbb)
    Evac_Abridged.add(reqTime: reqTime, &fbb)
    Evac_Abridged.add(reqCallSign: reqCallSign, &fbb)
    Evac_Abridged.add(pickupTime: pickupTime, &fbb)
    Evac_Abridged.add(pickupLat: pickupLat, &fbb)
    Evac_Abridged.add(pickupLon: pickupLon, &fbb)
    Evac_Abridged.add(pickupAlt: pickupAlt, &fbb)
    Evac_Abridged.add(ce: ce, &fbb)
    Evac_Abridged.add(le: le, &fbb)
    Evac_Abridged.add(terrain: terrain, &fbb)
    Evac_Abridged.add(obstaclesRemarks: obstaclesRemarks, &fbb)
    Evac_Abridged.add(terrainRemarks: terrainRemarks, &fbb)
    Evac_Abridged.add(zoneName: zoneName, &fbb)
    Evac_Abridged.add(zoneMarking: zoneMarking, &fbb)
    Evac_Abridged.add(zoneSecurity: zoneSecurity, &fbb)
    Evac_Abridged.add(zoneMarkingColor: zoneMarkingColor, &fbb)
    Evac_Abridged.add(zoneHot: zoneHot, &fbb)
    Evac_Abridged.add(cntctFreq: cntctFreq, &fbb)
    Evac_Abridged.add(zoneContrCallSign: zoneContrCallSign, &fbb)
    Evac_Abridged.add(numCasualties: numCasualties, &fbb)
    Evac_Abridged.add(comments: comments, &fbb)
    Evac_Abridged.addVectorOf(casualtyInfo: casualtyInfo, &fbb)
    Evac_Abridged.addVectorOf(enemyData: enemyData, &fbb)
    Evac_Abridged.add(origNetwork: origNetwork, &fbb)
    Evac_Abridged.add(createdAt: createdAt, &fbb)
    Evac_Abridged.add(createdBy: createdBy, &fbb)
    Evac_Abridged.add(source: source, &fbb)
    Evac_Abridged.add(origin: origin, &fbb)
    Evac_Abridged.add(dataMode: dataMode, &fbb)
    return Evac_Abridged.endEvac_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.type.p, fieldName: "type", required: false, type: Evac_Abridged_type_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Evac_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
