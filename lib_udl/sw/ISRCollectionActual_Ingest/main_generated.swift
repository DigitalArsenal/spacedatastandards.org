...
public struct ISRCollectionActual_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollectionActual_Ingest.id, addPrefix: prefix) }
  ...
  public static func startISRCollectionActual_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endISRCollectionActual_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollectionActual_Ingest(
    _ fbb: inout FlatBufferBuilder,
    idOffset id: Offset = Offset(),
    startOffset start: Offset = Offset(),
    stopOffset stop: Offset = Offset()
  ) -> Offset {
    let __start = ISRCollectionActual_Ingest.startISRCollectionActual_Ingest(&fbb)
    ISRCollectionActual_Ingest.add(id: id, &fbb)
    ISRCollectionActual_Ingest.add(start: start, &fbb)
    ISRCollectionActual_Ingest.add(stop: stop, &fbb)
    return ISRCollectionActual_Ingest.endISRCollectionActual_Ingest(&fbb, start: __start)
  }
