...
public enum AircraftStatus_Abridged_airToAirStatus_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AircraftStatus_Abridged_airToAirStatus_Enum { return .off }
  public static var min: AircraftStatus_Abridged_airToAirStatus_Enum { return .operational }
}


public enum AircraftStatus_Abridged_airToGroundStatus_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: AircraftStatus_Abridged_airToGroundStatus_Enum { return .off }
  public static var min: AircraftStatus_Abridged_airToGroundStatus_Enum { return .operational }
}


public enum AircraftStatus_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: AircraftStatus_Abridged_dataMode_Enum { return .exercise }
  public static var min: AircraftStatus_Abridged_dataMode_Enum { return .real }
}
...
public struct AircraftStatus_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AircraftStatus_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 16
  public var airToAirStatus: AircraftStatus_Abridged_airToAirStatus_Enum { let o = _accessor.offset(VTOFFSET.airToAirStatus.v); return o == 0 ? .operational : AircraftStatus_Abridged_airToAirStatus_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .operational }
  ///  The status of the air-to-ground weapon release system (OPERATIONAL, NON-OPERATIONAL, OFF).
  ///  Example: /// Example: OPERATIONAL
  ///  Constraints: Minimum length = 0, Maximum length = 16
  public var airToGroundStatus: AircraftStatus_Abridged_airToGroundStatus_Enum { let o = _accessor.offset(VTOFFSET.airToGroundStatus.v); return o == 0 ? .operational : AircraftStatus_Abridged_airToGroundStatus_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .operational }
  ...
  public var dataMode: AircraftStatus_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AircraftStatus_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: OPS1
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startAircraftStatus_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 52) }
  ...
  public static func add(airToAirStatus: AircraftStatus_Abridged_airToAirStatus_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: airToAirStatus.rawValue, def: 0, at: VTOFFSET.airToAirStatus.p) }
  public static func add(airToGroundStatus: AircraftStatus_Abridged_airToGroundStatus_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: airToGroundStatus.rawValue, def: 0, at: VTOFFSET.airToGroundStatus.p) }
  ...
  public static func add(dataMode: AircraftStatus_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endAircraftStatus_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAircraftStatus_Abridged(
    ...
    let __start = AircraftStatus_Abridged.startAircraftStatus_Abridged(&fbb)
    AircraftStatus_Abridged.add(id: id, &fbb)
    AircraftStatus_Abridged.add(classificationMarking: classificationMarking, &fbb)
    AircraftStatus_Abridged.add(idAircraft: idAircraft, &fbb)
    AircraftStatus_Abridged.add(altAircraftId: altAircraftId, &fbb)
    AircraftStatus_Abridged.add(currentState: currentState, &fbb)
    AircraftStatus_Abridged.add(idAirfield: idAirfield, &fbb)
    AircraftStatus_Abridged.add(geoLoc: geoLoc, &fbb)
    AircraftStatus_Abridged.add(previousIcao: previousIcao, &fbb)
    AircraftStatus_Abridged.add(currentIcao: currentIcao, &fbb)
    AircraftStatus_Abridged.add(nextIcao: nextIcao, &fbb)
    AircraftStatus_Abridged.add(flightPhase: flightPhase, &fbb)
    AircraftStatus_Abridged.add(taStartTime: taStartTime, &fbb)
    AircraftStatus_Abridged.add(earliestTaendTime: earliestTaendTime, &fbb)
    AircraftStatus_Abridged.add(missionReadiness: missionReadiness, &fbb)
    AircraftStatus_Abridged.add(fuel: fuel, &fbb)
    AircraftStatus_Abridged.add(fuelFunction: fuelFunction, &fbb)
    AircraftStatus_Abridged.add(gunCapable: gunCapable, &fbb)
    AircraftStatus_Abridged.add(gunRdsType: gunRdsType, &fbb)
    AircraftStatus_Abridged.add(gunRdsMin: gunRdsMin, &fbb)
    AircraftStatus_Abridged.add(gunRdsMax: gunRdsMax, &fbb)
    AircraftStatus_Abridged.add(airToAirStatus: airToAirStatus, &fbb)
    AircraftStatus_Abridged.add(airToGroundStatus: airToGroundStatus, &fbb)
    AircraftStatus_Abridged.addVectorOf(inventory: inventory, &fbb)
    AircraftStatus_Abridged.addVectorOf(inventoryMin: inventoryMin, &fbb)
    AircraftStatus_Abridged.addVectorOf(inventoryMax: inventoryMax, &fbb)
    AircraftStatus_Abridged.addVectorOf(unavailableSys: unavailableSys, &fbb)
    AircraftStatus_Abridged.addVectorOf(additionalSys: additionalSys, &fbb)
    AircraftStatus_Abridged.add(notes: notes, &fbb)
    AircraftStatus_Abridged.add(mxRemark: mxRemark, &fbb)
    AircraftStatus_Abridged.add(maintStatus: maintStatus, &fbb)
    AircraftStatus_Abridged.add(maintStatusDriver: maintStatusDriver, &fbb)
    AircraftStatus_Abridged.add(maintPriority: maintPriority, &fbb)
    AircraftStatus_Abridged.add(alphaStatusCode: alphaStatusCode, &fbb)
    AircraftStatus_Abridged.add(maintStatusUpdate: maintStatusUpdate, &fbb)
    AircraftStatus_Abridged.add(lastInspectionDate: lastInspectionDate, &fbb)
    AircraftStatus_Abridged.add(maintPoc: maintPoc, &fbb)
    AircraftStatus_Abridged.add(groundStatus: groundStatus, &fbb)
    AircraftStatus_Abridged.add(contaminationStatus: contaminationStatus, &fbb)
    AircraftStatus_Abridged.add(fuelStatus: fuelStatus, &fbb)
    AircraftStatus_Abridged.add(lastUpdatedBy: lastUpdatedBy, &fbb)
    AircraftStatus_Abridged.add(troubleshootEtic: troubleshootEtic, &fbb)
    AircraftStatus_Abridged.add(etic: etic, &fbb)
    AircraftStatus_Abridged.add(parkLocation: parkLocation, &fbb)
    AircraftStatus_Abridged.add(parkLocationSystem: parkLocationSystem, &fbb)
    AircraftStatus_Abridged.add(idPoi: idPoi, &fbb)
    AircraftStatus_Abridged.add(createdAt: createdAt, &fbb)
    AircraftStatus_Abridged.add(createdBy: createdBy, &fbb)
    AircraftStatus_Abridged.add(sourceDl: sourceDl, &fbb)
    AircraftStatus_Abridged.add(source: source, &fbb)
    AircraftStatus_Abridged.add(origin: origin, &fbb)
    AircraftStatus_Abridged.add(dataMode: dataMode, &fbb)
    AircraftStatus_Abridged.add(origNetwork: origNetwork, &fbb)
    return AircraftStatus_Abridged.endAircraftStatus_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.airToAirStatus.p, fieldName: "airToAirStatus", required: false, type: AircraftStatus_Abridged_airToAirStatus_Enum.self)
    try _v.visit(field: VTOFFSET.airToGroundStatus.p, fieldName: "airToGroundStatus", required: false, type: AircraftStatus_Abridged_airToGroundStatus_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AircraftStatus_Abridged_dataMode_Enum.self)
