...
public enum Equipment_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Equipment_Abridged_dataMode_Enum { return .exercise }
  public static var min: Equipment_Abridged_dataMode_Enum { return .real }
}


///  /// Properties and characteristics of equipment that can be associated with a site or other entity.
public struct Equipment_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Equipment_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: Equipment_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Equipment_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startEquipment_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 53) }
  ...
  public static func add(dataMode: Equipment_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endEquipment_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEquipment_Abridged(
    ...
    let __start = Equipment_Abridged.startEquipment_Abridged(&fbb)
    Equipment_Abridged.add(id: id, &fbb)
    Equipment_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Equipment_Abridged.add(idParentEquipment: idParentEquipment, &fbb)
    Equipment_Abridged.add(idSite: idSite, &fbb)
    Equipment_Abridged.add(idOperatingUnit: idOperatingUnit, &fbb)
    Equipment_Abridged.add(altEqpId: altEqpId, &fbb)
    Equipment_Abridged.add(eqpCode: eqpCode, &fbb)
    Equipment_Abridged.add(eqpIdNum: eqpIdNum, &fbb)
    Equipment_Abridged.add(countryCode: countryCode, &fbb)
    Equipment_Abridged.add(altCountryCode: altCountryCode, &fbb)
    Equipment_Abridged.add(wac: wac, &fbb)
    Equipment_Abridged.add(seqNum: seqNum, &fbb)
    Equipment_Abridged.add(nomen: nomen, &fbb)
    Equipment_Abridged.add(operStatus: operStatus, &fbb)
    Equipment_Abridged.add(condition: condition, &fbb)
    Equipment_Abridged.add(conditionAvail: conditionAvail, &fbb)
    Equipment_Abridged.add(eval: eval, &fbb)
    Equipment_Abridged.add(fpa: fpa, &fbb)
    Equipment_Abridged.add(function: function, &fbb)
    Equipment_Abridged.add(ident: ident, &fbb)
    Equipment_Abridged.add(allegiance: allegiance, &fbb)
    Equipment_Abridged.add(altAllegiance: altAllegiance, &fbb)
    Equipment_Abridged.add(locReason: locReason, &fbb)
    Equipment_Abridged.add(operAreaPrimary: operAreaPrimary, &fbb)
    Equipment_Abridged.add(functPrimary: functPrimary, &fbb)
    Equipment_Abridged.add(coordDatum: coordDatum, &fbb)
    Equipment_Abridged.add(coord: coord, &fbb)
    Equipment_Abridged.add(coordDerivAcc: coordDerivAcc, &fbb)
    Equipment_Abridged.add(lat: lat, &fbb)
    Equipment_Abridged.add(lon: lon, &fbb)
    Equipment_Abridged.add(elevMsl: elevMsl, &fbb)
    Equipment_Abridged.add(elevMslConfLvl: elevMslConfLvl, &fbb)
    Equipment_Abridged.add(elevMslDerivAcc: elevMslDerivAcc, &fbb)
    Equipment_Abridged.add(geoidalMslSep: geoidalMslSep, &fbb)
    Equipment_Abridged.add(milGridSys: milGridSys, &fbb)
    Equipment_Abridged.add(milGrid: milGrid, &fbb)
    Equipment_Abridged.add(utm: utm, &fbb)
    Equipment_Abridged.add(airDefArea: airDefArea, &fbb)
    Equipment_Abridged.add(polSubdiv: polSubdiv, &fbb)
    Equipment_Abridged.add(qtyOh: qtyOh, &fbb)
    Equipment_Abridged.add(symCode: symCode, &fbb)
    Equipment_Abridged.add(classRating: classRating, &fbb)
    Equipment_Abridged.add(recStatus: recStatus, &fbb)
    Equipment_Abridged.add(reviewDate: reviewDate, &fbb)
    Equipment_Abridged.add(resProd: resProd, &fbb)
    Equipment_Abridged.add(referenceDoc: referenceDoc, &fbb)
    Equipment_Abridged.addVectorOf(srcTyps: srcTyps, &fbb)
    Equipment_Abridged.addVectorOf(srcIds: srcIds, &fbb)
    Equipment_Abridged.add(createdAt: createdAt, &fbb)
    Equipment_Abridged.add(createdBy: createdBy, &fbb)
    Equipment_Abridged.add(source: source, &fbb)
    Equipment_Abridged.add(origin: origin, &fbb)
    Equipment_Abridged.add(dataMode: dataMode, &fbb)
    return Equipment_Abridged.endEquipment_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Equipment_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
