...
public enum Status_Ingest_state_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Status_Ingest_state_Enum { return .standby }
  public static var min: Status_Ingest_state_Enum { return .unknown }
}


public enum Status_Ingest_sysCap_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: Status_Ingest_sysCap_Enum { return .unk }
  public static var min: Status_Ingest_sysCap_Enum { return .fmc }
}


public enum Status_Ingest_opsCap_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: Status_Ingest_opsCap_Enum { return .unk }
  public static var min: Status_Ingest_opsCap_Enum { return .fmc }
}


public enum Status_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: Status_Ingest_dataMode_Enum { return .exercise }
  public static var min: Status_Ingest_dataMode_Enum { return .real }
}


///  /// Status for a particular Entity. An entity may have multiple status records collected by various sources.
public struct Status_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Status_Ingest.id, addPrefix: prefix) }
  ...
  public var state: Status_Ingest_state_Enum { let o = _accessor.offset(VTOFFSET.state.v); return o == 0 ? .unknown : Status_Ingest_state_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .unknown }
  ///  System capability of the entity, if applicable (e.g. FMC, NMC, PMC, UNK).
  ///  Example: /// Example: FMC
  ///  Constraints: Minimum length = 0, Maximum length = 3
  public var sysCap: Status_Ingest_sysCap_Enum { let o = _accessor.offset(VTOFFSET.sysCap.v); return o == 0 ? .fmc : Status_Ingest_sysCap_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .fmc }
  ///  Operation capability of the entity, if applicable (e.g. FMC, NMC, PMC, UNK).
  ///  Example: /// Example: FMC
  ///  Constraints: Minimum length = 0, Maximum length = 3
  public var opsCap: Status_Ingest_opsCap_Enum { let o = _accessor.offset(VTOFFSET.opsCap.v); return o == 0 ? .fmc : Status_Ingest_opsCap_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .fmc }
  ///  Source of the data.
  ...
  public var dataMode: Status_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Status_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startStatus_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 17) }
  ...
  public static func add(state: Status_Ingest_state_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: state.rawValue, def: 0, at: VTOFFSET.state.p) }
  public static func add(sysCap: Status_Ingest_sysCap_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: sysCap.rawValue, def: 0, at: VTOFFSET.sysCap.p) }
  public static func add(opsCap: Status_Ingest_opsCap_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: opsCap.rawValue, def: 0, at: VTOFFSET.opsCap.p) }
  ...
  public static func add(dataMode: Status_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endStatus_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createStatus_Ingest(
    ...
    let __start = Status_Ingest.startStatus_Ingest(&fbb)
    Status_Ingest.add(id: id, &fbb)
    Status_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Status_Ingest.add(derivedFrom: derivedFrom, &fbb)
    Status_Ingest.add(declassificationDate: declassificationDate, &fbb)
    Status_Ingest.add(declassificationString: declassificationString, &fbb)
    Status_Ingest.add(idEntity: idEntity, &fbb)
    Status_Ingest.add(state: state, &fbb)
    Status_Ingest.add(sysCap: sysCap, &fbb)
    Status_Ingest.add(opsCap: opsCap, &fbb)
    Status_Ingest.add(source: source, &fbb)
    Status_Ingest.addVectorOf(subStatusCollection: subStatusCollection, &fbb)
    Status_Ingest.add(dataMode: dataMode, &fbb)
    Status_Ingest.add(notes: notes, &fbb)
    Status_Ingest.add(createdAt: createdAt, &fbb)
    Status_Ingest.add(createdBy: createdBy, &fbb)
    Status_Ingest.add(origin: origin, &fbb)
    Status_Ingest.add(origNetwork: origNetwork, &fbb)
    return Status_Ingest.endStatus_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.state.p, fieldName: "state", required: false, type: Status_Ingest_state_Enum.self)
    try _v.visit(field: VTOFFSET.sysCap.p, fieldName: "sysCap", required: false, type: Status_Ingest_sysCap_Enum.self)
    try _v.visit(field: VTOFFSET.opsCap.p, fieldName: "opsCap", required: false, type: Status_Ingest_opsCap_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Status_Ingest_dataMode_Enum.self)
