...
public struct NavalFlightOperations_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: NavalFlightOperations_Ingest.id, addPrefix: prefix) }
  ...
  public static func startNavalFlightOperations_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endNavalFlightOperations_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createNavalFlightOperations_Ingest(
    ...
    let __start = NavalFlightOperations_Ingest.startNavalFlightOperations_Ingest(&fbb)
    NavalFlightOperations_Ingest.add(shipName: shipName, &fbb)
    NavalFlightOperations_Ingest.add(fltOpStart: fltOpStart, &fbb)
    NavalFlightOperations_Ingest.add(fltOpStop: fltOpStop, &fbb)
    NavalFlightOperations_Ingest.addVectorOf(schdLaunchRcvyTime: schdLaunchRcvyTime, &fbb)
    return NavalFlightOperations_Ingest.endNavalFlightOperations_Ingest(&fbb, start: __start)
  }
