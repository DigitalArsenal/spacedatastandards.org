...
public enum OnorbitSolarArray_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OnorbitSolarArray_dataMode_Enum { return .exercise }
  public static var min: OnorbitSolarArray_dataMode_Enum { return .real }
}


///  /// Read-only collection of solar arrays on this on-orbit object.
public struct OnorbitSolarArray: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OnorbitSolarArray.id, addPrefix: prefix) }
  ...
  public var dataMode: OnorbitSolarArray_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OnorbitSolarArray_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOnorbitSolarArray(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 14) }
  ...
  public static func add(dataMode: OnorbitSolarArray_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endOnorbitSolarArray(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnorbitSolarArray(
    ...
    let __start = OnorbitSolarArray.startOnorbitSolarArray(&fbb)
    OnorbitSolarArray.add(id: id, &fbb)
    OnorbitSolarArray.add(idOnOrbit: idOnOrbit, &fbb)
    OnorbitSolarArray.add(idSolarArray: idSolarArray, &fbb)
    OnorbitSolarArray.add(classificationMarking: classificationMarking, &fbb)
    OnorbitSolarArray.add(quantity: quantity, &fbb)
    OnorbitSolarArray.add(createdAt: createdAt, &fbb)
    OnorbitSolarArray.add(createdBy: createdBy, &fbb)
    OnorbitSolarArray.add(updatedAt: updatedAt, &fbb)
    OnorbitSolarArray.add(updatedBy: updatedBy, &fbb)
    OnorbitSolarArray.add(source: source, &fbb)
    OnorbitSolarArray.add(origin: origin, &fbb)
    OnorbitSolarArray.add(dataMode: dataMode, &fbb)
    OnorbitSolarArray.add(solarArray: solarArray, &fbb)
    OnorbitSolarArray.add(origNetwork: origNetwork, &fbb)
    return OnorbitSolarArray.endOnorbitSolarArray(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OnorbitSolarArray_dataMode_Enum.self)
