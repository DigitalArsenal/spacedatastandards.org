...
public struct IonoObservationPower_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationPower_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationPower_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationPower_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationPower_Ingest(
    ...
    let __start = IonoObservationPower_Ingest.startIonoObservationPower_Ingest(&fbb)
    IonoObservationPower_Ingest.add(notes: notes, &fbb)
    IonoObservationPower_Ingest.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationPower_Ingest.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationPower_Ingest.addVectorOf(data: data, &fbb)
    return IonoObservationPower_Ingest.endIonoObservationPower_Ingest(&fbb, start: __start)
  }
