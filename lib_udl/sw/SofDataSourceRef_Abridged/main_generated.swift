...
public struct SofDataSourceRef_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SofDataSourceRef_Abridged.id, addPrefix: prefix) }
  ...
  public static func startSofDataSourceRef_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endSofDataSourceRef_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSofDataSourceRef_Abridged(
    ...
    let __start = SofDataSourceRef_Abridged.startSofDataSourceRef_Abridged(&fbb)
    SofDataSourceRef_Abridged.add(dataSourceId: dataSourceId, &fbb)
    SofDataSourceRef_Abridged.add(startPosition: startPosition, &fbb)
    SofDataSourceRef_Abridged.add(endPosition: endPosition, &fbb)
    SofDataSourceRef_Abridged.add(paragraphNumber: paragraphNumber, &fbb)
    SofDataSourceRef_Abridged.add(sentenceNumber: sentenceNumber, &fbb)
    return SofDataSourceRef_Abridged.endSofDataSourceRef_Abridged(&fbb, start: __start)
  }
