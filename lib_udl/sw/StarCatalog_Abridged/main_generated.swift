...
public enum StarCatalog_Abridged_astrometryOrigin_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: StarCatalog_Abridged_astrometryOrigin_Enum { return .usnobsc }
  public static var min: StarCatalog_Abridged_astrometryOrigin_Enum { return .gaiadr3 }
}


public enum StarCatalog_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: StarCatalog_Abridged_dataMode_Enum { return .exercise }
  public static var min: StarCatalog_Abridged_dataMode_Enum { return .real }
}


///  /// The star catalog provides the position, proper motion, parallax, and photometric magnitudes at various bandpasses of a star.
public struct StarCatalog_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: StarCatalog_Abridged.id, addPrefix: prefix) }
  ...
  public var astrometryOrigin: StarCatalog_Abridged_astrometryOrigin_Enum { let o = _accessor.offset(VTOFFSET.astrometryOrigin.v); return o == 0 ? .gaiadr3 : StarCatalog_Abridged_astrometryOrigin_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .gaiadr3 }
  ...
  public var dataMode: StarCatalog_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : StarCatalog_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startStarCatalog_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 48) }
  ...
  public static func add(astrometryOrigin: StarCatalog_Abridged_astrometryOrigin_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: astrometryOrigin.rawValue, def: 0, at: VTOFFSET.astrometryOrigin.p) }
  ...
  public static func add(dataMode: StarCatalog_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endStarCatalog_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createStarCatalog_Abridged(
    ...
    let __start = StarCatalog_Abridged.startStarCatalog_Abridged(&fbb)
    StarCatalog_Abridged.add(id: id, &fbb)
    StarCatalog_Abridged.add(classificationMarking: classificationMarking, &fbb)
    StarCatalog_Abridged.add(csId: csId, &fbb)
    StarCatalog_Abridged.add(gncCatId: gncCatId, &fbb)
    StarCatalog_Abridged.add(gaiadr3CatId: gaiadr3CatId, &fbb)
    StarCatalog_Abridged.add(hipCatId: hipCatId, &fbb)
    StarCatalog_Abridged.add(catVersion: catVersion, &fbb)
    StarCatalog_Abridged.add(ra: ra, &fbb)
    StarCatalog_Abridged.add(raUnc: raUnc, &fbb)
    StarCatalog_Abridged.add(dec: dec, &fbb)
    StarCatalog_Abridged.add(decUnc: decUnc, &fbb)
    StarCatalog_Abridged.add(posUncFlag: posUncFlag, &fbb)
    StarCatalog_Abridged.add(parallax: parallax, &fbb)
    StarCatalog_Abridged.add(parallaxUnc: parallaxUnc, &fbb)
    StarCatalog_Abridged.add(pmra: pmra, &fbb)
    StarCatalog_Abridged.add(pmraUnc: pmraUnc, &fbb)
    StarCatalog_Abridged.add(pmdec: pmdec, &fbb)
    StarCatalog_Abridged.add(pmdecUnc: pmdecUnc, &fbb)
    StarCatalog_Abridged.add(pmUncFlag: pmUncFlag, &fbb)
    StarCatalog_Abridged.add(astrometryOrigin: astrometryOrigin, &fbb)
    StarCatalog_Abridged.add(starEpoch: starEpoch, &fbb)
    StarCatalog_Abridged.add(gmag: gmag, &fbb)
    StarCatalog_Abridged.add(gmagUnc: gmagUnc, &fbb)
    StarCatalog_Abridged.add(bpmag: bpmag, &fbb)
    StarCatalog_Abridged.add(bpmagUnc: bpmagUnc, &fbb)
    StarCatalog_Abridged.add(rpmag: rpmag, &fbb)
    StarCatalog_Abridged.add(rpmagUnc: rpmagUnc, &fbb)
    StarCatalog_Abridged.add(jmag: jmag, &fbb)
    StarCatalog_Abridged.add(jmagUnc: jmagUnc, &fbb)
    StarCatalog_Abridged.add(kmag: kmag, &fbb)
    StarCatalog_Abridged.add(kmagUnc: kmagUnc, &fbb)
    StarCatalog_Abridged.add(hmag: hmag, &fbb)
    StarCatalog_Abridged.add(hmagUnc: hmagUnc, &fbb)
    StarCatalog_Abridged.add(varFlag: varFlag, &fbb)
    StarCatalog_Abridged.add(multFlag: multFlag, &fbb)
    StarCatalog_Abridged.add(neighborId: neighborId, &fbb)
    StarCatalog_Abridged.add(neighborFlag: neighborFlag, &fbb)
    StarCatalog_Abridged.add(neighborDistance: neighborDistance, &fbb)
    StarCatalog_Abridged.add(shiftFlag: shiftFlag, &fbb)
    StarCatalog_Abridged.add(shift: shift, &fbb)
    StarCatalog_Abridged.add(createdAt: createdAt, &fbb)
    StarCatalog_Abridged.add(createdBy: createdBy, &fbb)
    StarCatalog_Abridged.add(updatedAt: updatedAt, &fbb)
    StarCatalog_Abridged.add(updatedBy: updatedBy, &fbb)
    StarCatalog_Abridged.add(source: source, &fbb)
    StarCatalog_Abridged.add(origin: origin, &fbb)
    StarCatalog_Abridged.add(origNetwork: origNetwork, &fbb)
    StarCatalog_Abridged.add(dataMode: dataMode, &fbb)
    return StarCatalog_Abridged.endStarCatalog_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.astrometryOrigin.p, fieldName: "astrometryOrigin", required: false, type: StarCatalog_Abridged_astrometryOrigin_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: StarCatalog_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
