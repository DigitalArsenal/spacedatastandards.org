...
public enum OnorbitEvent_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OnorbitEvent_Full_dataMode_Enum { return .exercise }
  public static var min: OnorbitEvent_Full_dataMode_Enum { return .real }
}


///  /// No description available.
public struct OnorbitEvent_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OnorbitEvent_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: OnorbitEvent_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OnorbitEvent_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOnorbitEvent_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 57) }
  ...
  public static func add(dataMode: OnorbitEvent_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endOnorbitEvent_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnorbitEvent_Full(
    ...
    let __start = OnorbitEvent_Full.startOnorbitEvent_Full(&fbb)
    OnorbitEvent_Full.add(id: id, &fbb)
    OnorbitEvent_Full.add(classificationMarking: classificationMarking, &fbb)
    OnorbitEvent_Full.add(derivedFrom: derivedFrom, &fbb)
    OnorbitEvent_Full.add(declassificationDate: declassificationDate, &fbb)
    OnorbitEvent_Full.add(declassificationString: declassificationString, &fbb)
    OnorbitEvent_Full.add(idOnOrbit: idOnOrbit, &fbb)
    OnorbitEvent_Full.add(satNo: satNo, &fbb)
    OnorbitEvent_Full.add(origObjectId: origObjectId, &fbb)
    OnorbitEvent_Full.add(eventTime: eventTime, &fbb)
    OnorbitEvent_Full.add(eventTimeNotes: eventTimeNotes, &fbb)
    OnorbitEvent_Full.add(operatorOrgId: operatorOrgId, &fbb)
    OnorbitEvent_Full.add(ownerOrgId: ownerOrgId, &fbb)
    OnorbitEvent_Full.add(lesseeOrgId: lesseeOrgId, &fbb)
    OnorbitEvent_Full.add(operatedOnBehalfOfOrgId: operatedOnBehalfOfOrgId, &fbb)
    OnorbitEvent_Full.add(geoPosition: geoPosition, &fbb)
    OnorbitEvent_Full.add(planeSlot: planeSlot, &fbb)
    OnorbitEvent_Full.add(planeNumber: planeNumber, &fbb)
    OnorbitEvent_Full.add(positionStatus: positionStatus, &fbb)
    OnorbitEvent_Full.add(untilTime: untilTime, &fbb)
    OnorbitEvent_Full.add(officialLossDate: officialLossDate, &fbb)
    OnorbitEvent_Full.add(netAmount: netAmount, &fbb)
    OnorbitEvent_Full.add(underlyingCause: underlyingCause, &fbb)
    OnorbitEvent_Full.add(capabilityLoss: capabilityLoss, &fbb)
    OnorbitEvent_Full.add(capacityLoss: capacityLoss, &fbb)
    OnorbitEvent_Full.add(insuranceLoss: insuranceLoss, &fbb)
    OnorbitEvent_Full.add(thirdPartyInsuranceLoss: thirdPartyInsuranceLoss, &fbb)
    OnorbitEvent_Full.add(injured: injured, &fbb)
    OnorbitEvent_Full.add(killed: killed, &fbb)
    OnorbitEvent_Full.add(lifeLost: lifeLost, &fbb)
    OnorbitEvent_Full.add(ageAtEvent: ageAtEvent, &fbb)
    OnorbitEvent_Full.add(achievedFlightPhase: achievedFlightPhase, &fbb)
    OnorbitEvent_Full.add(occurrenceFlightPhase: occurrenceFlightPhase, &fbb)
    OnorbitEvent_Full.add(stageAtFault: stageAtFault, &fbb)
    OnorbitEvent_Full.add(equipmentAtFault: equipmentAtFault, &fbb)
    OnorbitEvent_Full.add(equipmentTypeAtFault: equipmentTypeAtFault, &fbb)
    OnorbitEvent_Full.add(equipmentPartAtFault: equipmentPartAtFault, &fbb)
    OnorbitEvent_Full.add(consequentialEquipmentFailure: consequentialEquipmentFailure, &fbb)
    OnorbitEvent_Full.add(inclined: inclined, &fbb)
    OnorbitEvent_Full.add(description: description, &fbb)
    OnorbitEvent_Full.add(remarks: remarks, &fbb)
    OnorbitEvent_Full.add(insuranceLossNotes: insuranceLossNotes, &fbb)
    OnorbitEvent_Full.add(capabilityLossNotes: capabilityLossNotes, &fbb)
    OnorbitEvent_Full.add(insuranceCarriedNotes: insuranceCarriedNotes, &fbb)
    OnorbitEvent_Full.add(equipmentCausingLossNotes: equipmentCausingLossNotes, &fbb)
    OnorbitEvent_Full.add(eventType: eventType, &fbb)
    OnorbitEvent_Full.add(eventResult: eventResult, &fbb)
    OnorbitEvent_Full.add(objectStatus: objectStatus, &fbb)
    OnorbitEvent_Full.add(satellitePosition: satellitePosition, &fbb)
    OnorbitEvent_Full.add(source: source, &fbb)
    OnorbitEvent_Full.add(origin: origin, &fbb)
    OnorbitEvent_Full.add(dataMode: dataMode, &fbb)
    OnorbitEvent_Full.add(createdAt: createdAt, &fbb)
    OnorbitEvent_Full.add(createdBy: createdBy, &fbb)
    OnorbitEvent_Full.add(updatedAt: updatedAt, &fbb)
    OnorbitEvent_Full.add(updatedBy: updatedBy, &fbb)
    OnorbitEvent_Full.add(onOrbit: onOrbit, &fbb)
    OnorbitEvent_Full.add(origNetwork: origNetwork, &fbb)
    return OnorbitEvent_Full.endOnorbitEvent_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OnorbitEvent_Full_dataMode_Enum.self)
