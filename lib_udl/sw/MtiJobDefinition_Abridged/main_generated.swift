...
public struct MtiJobDefinition_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiJobDefinition_Abridged.id, addPrefix: prefix) }
  ...
  public static func startMtiJobDefinition_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 27) }
  ...
  public static func endMtiJobDefinition_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiJobDefinition_Abridged(
    ...
    let __start = MtiJobDefinition_Abridged.startMtiJobDefinition_Abridged(&fbb)
    MtiJobDefinition_Abridged.add(j2: j2, &fbb)
    MtiJobDefinition_Abridged.add(j3: j3, &fbb)
    MtiJobDefinition_Abridged.add(j4: j4, &fbb)
    MtiJobDefinition_Abridged.add(j5: j5, &fbb)
    MtiJobDefinition_Abridged.add(j6: j6, &fbb)
    MtiJobDefinition_Abridged.add(j7: j7, &fbb)
    MtiJobDefinition_Abridged.add(j8: j8, &fbb)
    MtiJobDefinition_Abridged.add(j9: j9, &fbb)
    MtiJobDefinition_Abridged.add(j10: j10, &fbb)
    MtiJobDefinition_Abridged.add(j11: j11, &fbb)
    MtiJobDefinition_Abridged.add(j12: j12, &fbb)
    MtiJobDefinition_Abridged.add(j13: j13, &fbb)
    MtiJobDefinition_Abridged.add(j14: j14, &fbb)
    MtiJobDefinition_Abridged.add(j15: j15, &fbb)
    MtiJobDefinition_Abridged.add(j16: j16, &fbb)
    MtiJobDefinition_Abridged.add(j17: j17, &fbb)
    MtiJobDefinition_Abridged.add(j18: j18, &fbb)
    MtiJobDefinition_Abridged.add(j19: j19, &fbb)
    MtiJobDefinition_Abridged.add(j20: j20, &fbb)
    MtiJobDefinition_Abridged.add(j21: j21, &fbb)
    MtiJobDefinition_Abridged.add(j22: j22, &fbb)
    MtiJobDefinition_Abridged.add(j23: j23, &fbb)
    MtiJobDefinition_Abridged.add(j24: j24, &fbb)
    MtiJobDefinition_Abridged.add(j25: j25, &fbb)
    MtiJobDefinition_Abridged.add(j26: j26, &fbb)
    MtiJobDefinition_Abridged.add(j27: j27, &fbb)
    MtiJobDefinition_Abridged.add(j28: j28, &fbb)
    return MtiJobDefinition_Abridged.endMtiJobDefinition_Abridged(&fbb, start: __start)
  }
