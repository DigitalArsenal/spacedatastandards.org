...
public struct IonoObservationAmplitude_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationAmplitude_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationAmplitude_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationAmplitude_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationAmplitude_Full(
    ...
    let __start = IonoObservationAmplitude_Full.startIonoObservationAmplitude_Full(&fbb)
    IonoObservationAmplitude_Full.add(notes: notes, &fbb)
    IonoObservationAmplitude_Full.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationAmplitude_Full.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationAmplitude_Full.addVectorOf(data: data, &fbb)
    return IonoObservationAmplitude_Full.endIonoObservationAmplitude_Full(&fbb, start: __start)
  }
