...
public enum NavigationalObstruction_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: NavigationalObstruction_Ingest_dataMode_Enum { return .exercise }
  public static var min: NavigationalObstruction_Ingest_dataMode_Enum { return .real }
}
...
public struct NavigationalObstruction_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: NavigationalObstruction_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: NavigationalObstruction_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : NavigationalObstruction_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startNavigationalObstruction_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 77) }
  ...
  public static func add(dataMode: NavigationalObstruction_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endNavigationalObstruction_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createNavigationalObstruction_Ingest(
    ...
    let __start = NavigationalObstruction_Ingest.startNavigationalObstruction_Ingest(&fbb)
    NavigationalObstruction_Ingest.add(id: id, &fbb)
    NavigationalObstruction_Ingest.add(classificationMarking: classificationMarking, &fbb)
    NavigationalObstruction_Ingest.add(cycleDate: cycleDate, &fbb)
    NavigationalObstruction_Ingest.add(obstacleType: obstacleType, &fbb)
    NavigationalObstruction_Ingest.add(obstacleId: obstacleId, &fbb)
    NavigationalObstruction_Ingest.add(externalId: externalId, &fbb)
    NavigationalObstruction_Ingest.add(origId: origId, &fbb)
    NavigationalObstruction_Ingest.add(countryCode: countryCode, &fbb)
    NavigationalObstruction_Ingest.add(provinceCode: provinceCode, &fbb)
    NavigationalObstruction_Ingest.add(pointLat: pointLat, &fbb)
    NavigationalObstruction_Ingest.add(pointLon: pointLon, &fbb)
    NavigationalObstruction_Ingest.add(lineNelon: lineNelon, &fbb)
    NavigationalObstruction_Ingest.add(lineNelat: lineNelat, &fbb)
    NavigationalObstruction_Ingest.add(lineSwlon: lineSwlon, &fbb)
    NavigationalObstruction_Ingest.add(lineSwlat: lineSwlat, &fbb)
    NavigationalObstruction_Ingest.add(segStartPoint: segStartPoint, &fbb)
    NavigationalObstruction_Ingest.add(segEndPoint: segEndPoint, &fbb)
    NavigationalObstruction_Ingest.add(segNum: segNum, &fbb)
    NavigationalObstruction_Ingest.add(facc: facc, &fbb)
    NavigationalObstruction_Ingest.add(featureCode: featureCode, &fbb)
    NavigationalObstruction_Ingest.add(featureType: featureType, &fbb)
    NavigationalObstruction_Ingest.add(featureName: featureName, &fbb)
    NavigationalObstruction_Ingest.add(featureDescription: featureDescription, &fbb)
    NavigationalObstruction_Ingest.add(wac: wac, &fbb)
    NavigationalObstruction_Ingest.add(wacInnr: wacInnr, &fbb)
    NavigationalObstruction_Ingest.add(multObs: multObs, &fbb)
    NavigationalObstruction_Ingest.add(numObs: numObs, &fbb)
    NavigationalObstruction_Ingest.add(horizDatumCode: horizDatumCode, &fbb)
    NavigationalObstruction_Ingest.add(heightAgl: heightAgl, &fbb)
    NavigationalObstruction_Ingest.add(heightAglacc: heightAglacc, &fbb)
    NavigationalObstruction_Ingest.add(heightMsl: heightMsl, &fbb)
    NavigationalObstruction_Ingest.add(heightMslacc: heightMslacc, &fbb)
    NavigationalObstruction_Ingest.add(elevation: elevation, &fbb)
    NavigationalObstruction_Ingest.add(elevationAcc: elevationAcc, &fbb)
    NavigationalObstruction_Ingest.add(horizAcc: horizAcc, &fbb)
    NavigationalObstruction_Ingest.add(quality: quality, &fbb)
    NavigationalObstruction_Ingest.add(lightingCode: lightingCode, &fbb)
    NavigationalObstruction_Ingest.add(surfaceMatCode: surfaceMatCode, &fbb)
    NavigationalObstruction_Ingest.add(directivityCode: directivityCode, &fbb)
    NavigationalObstruction_Ingest.add(validationCode: validationCode, &fbb)
    NavigationalObstruction_Ingest.add(transactionCode: transactionCode, &fbb)
    NavigationalObstruction_Ingest.add(processCode: processCode, &fbb)
    NavigationalObstruction_Ingest.add(actDelCode: actDelCode, &fbb)
    NavigationalObstruction_Ingest.add(producer: producer, &fbb)
    NavigationalObstruction_Ingest.add(derivingOrg: derivingOrg, &fbb)
    NavigationalObstruction_Ingest.add(deletingOrg: deletingOrg, &fbb)
    NavigationalObstruction_Ingest.add(sourceDate: sourceDate, &fbb)
    NavigationalObstruction_Ingest.add(revDate: revDate, &fbb)
    NavigationalObstruction_Ingest.add(initRecordDate: initRecordDate, &fbb)
    NavigationalObstruction_Ingest.addVectorOf(keys: keys, &fbb)
    NavigationalObstruction_Ingest.addVectorOf(values: values, &fbb)
    NavigationalObstruction_Ingest.add(obstacleRemarks: obstacleRemarks, &fbb)
    NavigationalObstruction_Ingest.add(nextCycleDate: nextCycleDate, &fbb)
    NavigationalObstruction_Ingest.add(baselineCutoffDate: baselineCutoffDate, &fbb)
    NavigationalObstruction_Ingest.add(cutoffDate: cutoffDate, &fbb)
    NavigationalObstruction_Ingest.add(airacCycle: airacCycle, &fbb)
    NavigationalObstruction_Ingest.add(baseAiracCycle: baseAiracCycle, &fbb)
    NavigationalObstruction_Ingest.add(ownerCountryCode: ownerCountryCode, &fbb)
    NavigationalObstruction_Ingest.add(boundNelon: boundNelon, &fbb)
    NavigationalObstruction_Ingest.add(boundNelat: boundNelat, &fbb)
    NavigationalObstruction_Ingest.add(boundSwlon: boundSwlon, &fbb)
    NavigationalObstruction_Ingest.add(boundSwlat: boundSwlat, &fbb)
    NavigationalObstruction_Ingest.add(minHeightAgl: minHeightAgl, &fbb)
    NavigationalObstruction_Ingest.add(numPoints: numPoints, &fbb)
    NavigationalObstruction_Ingest.add(numLines: numLines, &fbb)
    NavigationalObstruction_Ingest.add(dataSetRemarks: dataSetRemarks, &fbb)
    NavigationalObstruction_Ingest.add(pointsFilename: pointsFilename, &fbb)
    NavigationalObstruction_Ingest.add(linesFilename: linesFilename, &fbb)
    NavigationalObstruction_Ingest.add(vectorsFilename: vectorsFilename, &fbb)
    NavigationalObstruction_Ingest.add(rawFileUri: rawFileUri, &fbb)
    NavigationalObstruction_Ingest.add(createdAt: createdAt, &fbb)
    NavigationalObstruction_Ingest.add(createdBy: createdBy, &fbb)
    NavigationalObstruction_Ingest.add(sourceDl: sourceDl, &fbb)
    NavigationalObstruction_Ingest.add(source: source, &fbb)
    NavigationalObstruction_Ingest.add(origin: origin, &fbb)
    NavigationalObstruction_Ingest.add(origNetwork: origNetwork, &fbb)
    NavigationalObstruction_Ingest.add(dataMode: dataMode, &fbb)
    return NavigationalObstruction_Ingest.endNavigationalObstruction_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: NavigationalObstruction_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
