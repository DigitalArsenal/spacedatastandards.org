...
public struct MtiHRR_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiHRR_Abridged.id, addPrefix: prefix) }
  ...
  public static func startMtiHRR_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 29) }
  ...
  public static func endMtiHRR_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiHRR_Abridged(
    ...
    let __start = MtiHRR_Abridged.startMtiHRR_Abridged(&fbb)
    MtiHRR_Abridged.add(h2: h2, &fbb)
    MtiHRR_Abridged.add(h3: h3, &fbb)
    MtiHRR_Abridged.add(h4: h4, &fbb)
    MtiHRR_Abridged.add(h5: h5, &fbb)
    MtiHRR_Abridged.add(h6: h6, &fbb)
    MtiHRR_Abridged.add(h7: h7, &fbb)
    MtiHRR_Abridged.add(h8: h8, &fbb)
    MtiHRR_Abridged.add(h9: h9, &fbb)
    MtiHRR_Abridged.add(h10: h10, &fbb)
    MtiHRR_Abridged.add(h11: h11, &fbb)
    MtiHRR_Abridged.add(h12: h12, &fbb)
    MtiHRR_Abridged.add(h13: h13, &fbb)
    MtiHRR_Abridged.add(h14: h14, &fbb)
    MtiHRR_Abridged.add(h15: h15, &fbb)
    MtiHRR_Abridged.add(h16: h16, &fbb)
    MtiHRR_Abridged.add(h17: h17, &fbb)
    MtiHRR_Abridged.add(h18: h18, &fbb)
    MtiHRR_Abridged.add(h19: h19, &fbb)
    MtiHRR_Abridged.add(h20: h20, &fbb)
    MtiHRR_Abridged.add(h21: h21, &fbb)
    MtiHRR_Abridged.add(h22: h22, &fbb)
    MtiHRR_Abridged.add(h23: h23, &fbb)
    MtiHRR_Abridged.add(h24: h24, &fbb)
    MtiHRR_Abridged.add(h27: h27, &fbb)
    MtiHRR_Abridged.add(h28: h28, &fbb)
    MtiHRR_Abridged.add(h29: h29, &fbb)
    MtiHRR_Abridged.add(h30: h30, &fbb)
    MtiHRR_Abridged.add(h31: h31, &fbb)
    MtiHRR_Abridged.addVectorOf(h32: h32, &fbb)
    return MtiHRR_Abridged.endMtiHRR_Abridged(&fbb, start: __start)
  }
