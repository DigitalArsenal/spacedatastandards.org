...
public enum SpaceEnvObservation_Abridged_senReferenceFrame_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SpaceEnvObservation_Abridged_senReferenceFrame_Enum { return .gcrf }
  public static var min: SpaceEnvObservation_Abridged_senReferenceFrame_Enum { return .j2000 }
}


public enum SpaceEnvObservation_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: SpaceEnvObservation_Abridged_dataMode_Enum { return .exercise }
  public static var min: SpaceEnvObservation_Abridged_dataMode_Enum { return .real }
}


///  /// SpaceEnvObservation data.
public struct SpaceEnvObservation_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SpaceEnvObservation_Abridged.id, addPrefix: prefix) }
  ...
  public var senReferenceFrame: SpaceEnvObservation_Abridged_senReferenceFrame_Enum { let o = _accessor.offset(VTOFFSET.senReferenceFrame.v); return o == 0 ? .j2000 : SpaceEnvObservation_Abridged_senReferenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ...
  public var dataMode: SpaceEnvObservation_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SpaceEnvObservation_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startSpaceEnvObservation_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 41) }
  ...
  public static func add(senReferenceFrame: SpaceEnvObservation_Abridged_senReferenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: senReferenceFrame.rawValue, def: 0, at: VTOFFSET.senReferenceFrame.p) }
  ...
  public static func add(dataMode: SpaceEnvObservation_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endSpaceEnvObservation_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSpaceEnvObservation_Abridged(
    ...
    let __start = SpaceEnvObservation_Abridged.startSpaceEnvObservation_Abridged(&fbb)
    SpaceEnvObservation_Abridged.add(id: id, &fbb)
    SpaceEnvObservation_Abridged.add(classificationMarking: classificationMarking, &fbb)
    SpaceEnvObservation_Abridged.add(msgType: msgType, &fbb)
    SpaceEnvObservation_Abridged.add(genSystem: genSystem, &fbb)
    SpaceEnvObservation_Abridged.add(externalId: externalId, &fbb)
    SpaceEnvObservation_Abridged.add(dataType: dataType, &fbb)
    SpaceEnvObservation_Abridged.add(genTime: genTime, &fbb)
    SpaceEnvObservation_Abridged.add(forecast: forecast, &fbb)
    SpaceEnvObservation_Abridged.add(derived: derived, &fbb)
    SpaceEnvObservation_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    SpaceEnvObservation_Abridged.add(satNo: satNo, &fbb)
    SpaceEnvObservation_Abridged.add(origObjectId: origObjectId, &fbb)
    SpaceEnvObservation_Abridged.add(idSensor: idSensor, &fbb)
    SpaceEnvObservation_Abridged.add(origSensorId: origSensorId, &fbb)
    SpaceEnvObservation_Abridged.add(observatoryType: observatoryType, &fbb)
    SpaceEnvObservation_Abridged.add(observatoryName: observatoryName, &fbb)
    SpaceEnvObservation_Abridged.add(observatoryNotes: observatoryNotes, &fbb)
    SpaceEnvObservation_Abridged.add(instrumentType: instrumentType, &fbb)
    SpaceEnvObservation_Abridged.add(lat: lat, &fbb)
    SpaceEnvObservation_Abridged.add(lon: lon, &fbb)
    SpaceEnvObservation_Abridged.add(alt: alt, &fbb)
    SpaceEnvObservation_Abridged.add(senReferenceFrame: senReferenceFrame, &fbb)
    SpaceEnvObservation_Abridged.addVectorOf(senPos: senPos, &fbb)
    SpaceEnvObservation_Abridged.addVectorOf(senVel: senVel, &fbb)
    SpaceEnvObservation_Abridged.add(measType: measType, &fbb)
    SpaceEnvObservation_Abridged.add(senEnergyLevel: senEnergyLevel, &fbb)
    SpaceEnvObservation_Abridged.add(obSetId: obSetId, &fbb)
    SpaceEnvObservation_Abridged.add(particleType: particleType, &fbb)
    SpaceEnvObservation_Abridged.add(obTime: obTime, &fbb)
    SpaceEnvObservation_Abridged.addVectorOf(seoList: seoList, &fbb)
    SpaceEnvObservation_Abridged.add(quality: quality, &fbb)
    SpaceEnvObservation_Abridged.add(description: description, &fbb)
    SpaceEnvObservation_Abridged.add(descriptor: descriptor, &fbb)
    SpaceEnvObservation_Abridged.addVectorOf(srcTyps: srcTyps, &fbb)
    SpaceEnvObservation_Abridged.addVectorOf(srcIds: srcIds, &fbb)
    SpaceEnvObservation_Abridged.add(createdAt: createdAt, &fbb)
    SpaceEnvObservation_Abridged.add(createdBy: createdBy, &fbb)
    SpaceEnvObservation_Abridged.add(source: source, &fbb)
    SpaceEnvObservation_Abridged.add(origin: origin, &fbb)
    SpaceEnvObservation_Abridged.add(dataMode: dataMode, &fbb)
    SpaceEnvObservation_Abridged.add(origNetwork: origNetwork, &fbb)
    return SpaceEnvObservation_Abridged.endSpaceEnvObservation_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.senReferenceFrame.p, fieldName: "senReferenceFrame", required: false, type: SpaceEnvObservation_Abridged_senReferenceFrame_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SpaceEnvObservation_Abridged_dataMode_Enum.self)
