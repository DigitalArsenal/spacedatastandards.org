...
public enum OnorbitThrusterStatus_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OnorbitThrusterStatus_Ingest_dataMode_Enum { return .exercise }
  public static var min: OnorbitThrusterStatus_Ingest_dataMode_Enum { return .real }
}


///  /// Status information for OnorbitThruster objects.
public struct OnorbitThrusterStatus_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OnorbitThrusterStatus_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: OnorbitThrusterStatus_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OnorbitThrusterStatus_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startOnorbitThrusterStatus_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 24) }
  ...
  public static func add(dataMode: OnorbitThrusterStatus_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endOnorbitThrusterStatus_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnorbitThrusterStatus_Ingest(
    ...
    let __start = OnorbitThrusterStatus_Ingest.startOnorbitThrusterStatus_Ingest(&fbb)
    OnorbitThrusterStatus_Ingest.add(id: id, &fbb)
    OnorbitThrusterStatus_Ingest.add(classificationMarking: classificationMarking, &fbb)
    OnorbitThrusterStatus_Ingest.add(idOnorbitThruster: idOnorbitThruster, &fbb)
    OnorbitThrusterStatus_Ingest.add(name: name, &fbb)
    OnorbitThrusterStatus_Ingest.add(statusTime: statusTime, &fbb)
    OnorbitThrusterStatus_Ingest.add(propMassMin: propMassMin, &fbb)
    OnorbitThrusterStatus_Ingest.add(propMassAvg: propMassAvg, &fbb)
    OnorbitThrusterStatus_Ingest.add(propMassMedian: propMassMedian, &fbb)
    OnorbitThrusterStatus_Ingest.add(propMassMax: propMassMax, &fbb)
    OnorbitThrusterStatus_Ingest.add(fuelMass: fuelMass, &fbb)
    OnorbitThrusterStatus_Ingest.add(fuelMassUnc: fuelMassUnc, &fbb)
    OnorbitThrusterStatus_Ingest.add(totalDeltaV: totalDeltaV, &fbb)
    OnorbitThrusterStatus_Ingest.add(minDeltaV: minDeltaV, &fbb)
    OnorbitThrusterStatus_Ingest.add(estDeltaV: estDeltaV, &fbb)
    OnorbitThrusterStatus_Ingest.add(maxDeltaV: maxDeltaV, &fbb)
    OnorbitThrusterStatus_Ingest.add(thrustMax: thrustMax, &fbb)
    OnorbitThrusterStatus_Ingest.add(isp: isp, &fbb)
    OnorbitThrusterStatus_Ingest.add(operational: operational, &fbb)
    OnorbitThrusterStatus_Ingest.add(createdAt: createdAt, &fbb)
    OnorbitThrusterStatus_Ingest.add(createdBy: createdBy, &fbb)
    OnorbitThrusterStatus_Ingest.add(source: source, &fbb)
    OnorbitThrusterStatus_Ingest.add(origin: origin, &fbb)
    OnorbitThrusterStatus_Ingest.add(origNetwork: origNetwork, &fbb)
    OnorbitThrusterStatus_Ingest.add(dataMode: dataMode, &fbb)
    return OnorbitThrusterStatus_Ingest.endOnorbitThrusterStatus_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OnorbitThrusterStatus_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
