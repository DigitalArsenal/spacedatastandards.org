...
public struct LogisticsParts_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LogisticsParts_Ingest.id, addPrefix: prefix) }
  ...
  public static func startLogisticsParts_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 11) }
  ...
  public static func endLogisticsParts_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLogisticsParts_Ingest(
    ...
    let __start = LogisticsParts_Ingest.startLogisticsParts_Ingest(&fbb)
    LogisticsParts_Ingest.add(partNumber: partNumber, &fbb)
    LogisticsParts_Ingest.add(nationalStockNumber: nationalStockNumber, &fbb)
    LogisticsParts_Ingest.add(measurementUnitCode: measurementUnitCode, &fbb)
    LogisticsParts_Ingest.add(workUnitCode: workUnitCode, &fbb)
    LogisticsParts_Ingest.add(technicalOrderText: technicalOrderText, &fbb)
    LogisticsParts_Ingest.add(figureNumber: figureNumber, &fbb)
    LogisticsParts_Ingest.add(indexNumber: indexNumber, &fbb)
    LogisticsParts_Ingest.add(requestVerifier: requestVerifier, &fbb)
    LogisticsParts_Ingest.add(locationVerifier: locationVerifier, &fbb)
    LogisticsParts_Ingest.add(supplyDocumentNumber: supplyDocumentNumber, &fbb)
    LogisticsParts_Ingest.addVectorOf(logisticsStocks: logisticsStocks, &fbb)
    return LogisticsParts_Ingest.endLogisticsParts_Ingest(&fbb, start: __start)
  }
