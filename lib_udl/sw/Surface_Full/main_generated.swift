...
public enum Surface_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Surface_Full_dataMode_Enum { return .exercise }
  public static var min: Surface_Full_dataMode_Enum { return .real }
}
...
public struct Surface_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Surface_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Surface_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Surface_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSurface_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 54) }
  ...
  public static func add(dataMode: Surface_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSurface_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSurface_Full(
    ...
    let __start = Surface_Full.startSurface_Full(&fbb)
    Surface_Full.add(id: id, &fbb)
    Surface_Full.add(classificationMarking: classificationMarking, &fbb)
    Surface_Full.add(name: name, &fbb)
    Surface_Full.add(type: type, &fbb)
    Surface_Full.add(idSite: idSite, &fbb)
    Surface_Full.add(altSiteId: altSiteId, &fbb)
    Surface_Full.add(primary: primary, &fbb)
    Surface_Full.add(lengthFt: lengthFt, &fbb)
    Surface_Full.add(ldaFt: ldaFt, &fbb)
    Surface_Full.add(widthFt: widthFt, &fbb)
    Surface_Full.add(lengthM: lengthM, &fbb)
    Surface_Full.add(ldaM: ldaM, &fbb)
    Surface_Full.add(widthM: widthM, &fbb)
    Surface_Full.add(material: material, &fbb)
    Surface_Full.add(condition: condition, &fbb)
    Surface_Full.add(rawWbc: rawWbc, &fbb)
    Surface_Full.add(pcn: pcn, &fbb)
    Surface_Full.add(lcn: lcn, &fbb)
    Surface_Full.add(sWtKip: sWtKip, &fbb)
    Surface_Full.add(tWtKip: tWtKip, &fbb)
    Surface_Full.add(stWtKip: stWtKip, &fbb)
    Surface_Full.add(ttWtKip: ttWtKip, &fbb)
    Surface_Full.add(ddWtKip: ddWtKip, &fbb)
    Surface_Full.add(sbttWtKip: sbttWtKip, &fbb)
    Surface_Full.add(tdtWtkip: tdtWtkip, &fbb)
    Surface_Full.add(trtWtKip: trtWtKip, &fbb)
    Surface_Full.add(ddtWtKip: ddtWtKip, &fbb)
    Surface_Full.add(sWtKn: sWtKn, &fbb)
    Surface_Full.add(tWtKn: tWtKn, &fbb)
    Surface_Full.add(stWtKn: stWtKn, &fbb)
    Surface_Full.add(ttWtKn: ttWtKn, &fbb)
    Surface_Full.add(ddWtKn: ddWtKn, &fbb)
    Surface_Full.add(sbttWtKn: sbttWtKn, &fbb)
    Surface_Full.add(tdtWtKn: tdtWtKn, &fbb)
    Surface_Full.add(trtWtKn: trtWtKn, &fbb)
    Surface_Full.add(ddtWtKn: ddtWtKn, &fbb)
    Surface_Full.add(lighting: lighting, &fbb)
    Surface_Full.add(lightsUnkn: lightsUnkn, &fbb)
    Surface_Full.add(lightsAprch: lightsAprch, &fbb)
    Surface_Full.add(lightsVasi: lightsVasi, &fbb)
    Surface_Full.add(lightsPapi: lightsPapi, &fbb)
    Surface_Full.add(lightsOls: lightsOls, &fbb)
    Surface_Full.add(lightsReil: lightsReil, &fbb)
    Surface_Full.add(lightsTdzl: lightsTdzl, &fbb)
    Surface_Full.add(lightsCl: lightsCl, &fbb)
    Surface_Full.add(obstacle: obstacle, &fbb)
    Surface_Full.add(createdAt: createdAt, &fbb)
    Surface_Full.add(createdBy: createdBy, &fbb)
    Surface_Full.add(updatedAt: updatedAt, &fbb)
    Surface_Full.add(updatedBy: updatedBy, &fbb)
    Surface_Full.add(source: source, &fbb)
    Surface_Full.add(origin: origin, &fbb)
    Surface_Full.add(origNetwork: origNetwork, &fbb)
    Surface_Full.add(dataMode: dataMode, &fbb)
    return Surface_Full.endSurface_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Surface_Full_dataMode_Enum.self)
    _v.finish()
  }
}
