...
public enum SeradataSpacecraftDetails_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SeradataSpacecraftDetails_Full_dataMode_Enum { return .exercise }
  public static var min: SeradataSpacecraftDetails_Full_dataMode_Enum { return .real }
}


///  /// On-orbit spacecraft details compiled by Seradata for a particular satellite.
public struct SeradataSpacecraftDetails_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SeradataSpacecraftDetails_Full.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case updatedAt = 194
    case updatedBy = 196
    case seradataSigIntPayload = 198
    case seradataRadarPayload = 200
    case seradataNavigation = 202
    case seradataOpticalPayload = 204
    case seradataEarlyWarning = 206
    case scientific = 208
    case seradataCommDetails = 210
    case onOrbit = 212
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SeradataSpacecraftDetails_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SeradataSpacecraftDetails_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Constraints: No constraints specified.
  public var hasSeradataSigIntPayload: Bool { let o = _accessor.offset(VTOFFSET.seradataSigIntPayload.v); return o == 0 ? false : true }
  public var seradataSigIntPayloadCount: Int32 { let o = _accessor.offset(VTOFFSET.seradataSigIntPayload.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func seradataSigIntPayload(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.seradataSigIntPayload.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  public var hasSeradataRadarPayload: Bool { let o = _accessor.offset(VTOFFSET.seradataRadarPayload.v); return o == 0 ? false : true }
  public var seradataRadarPayloadCount: Int32 { let o = _accessor.offset(VTOFFSET.seradataRadarPayload.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func seradataRadarPayload(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.seradataRadarPayload.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  public var hasSeradataNavigation: Bool { let o = _accessor.offset(VTOFFSET.seradataNavigation.v); return o == 0 ? false : true }
  public var seradataNavigationCount: Int32 { let o = _accessor.offset(VTOFFSET.seradataNavigation.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func seradataNavigation(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.seradataNavigation.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  public var hasSeradataOpticalPayload: Bool { let o = _accessor.offset(VTOFFSET.seradataOpticalPayload.v); return o == 0 ? false : true }
  public var seradataOpticalPayloadCount: Int32 { let o = _accessor.offset(VTOFFSET.seradataOpticalPayload.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func seradataOpticalPayload(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.seradataOpticalPayload.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  public var hasSeradataEarlyWarning: Bool { let o = _accessor.offset(VTOFFSET.seradataEarlyWarning.v); return o == 0 ? false : true }
  public var seradataEarlyWarningCount: Int32 { let o = _accessor.offset(VTOFFSET.seradataEarlyWarning.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func seradataEarlyWarning(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.seradataEarlyWarning.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  public var hasScientific: Bool { let o = _accessor.offset(VTOFFSET.scientific.v); return o == 0 ? false : true }
  public var scientificCount: Int32 { let o = _accessor.offset(VTOFFSET.scientific.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func scientific(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.scientific.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  public var hasSeradataCommDetails: Bool { let o = _accessor.offset(VTOFFSET.seradataCommDetails.v); return o == 0 ? false : true }
  public var seradataCommDetailsCount: Int32 { let o = _accessor.offset(VTOFFSET.seradataCommDetails.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func seradataCommDetails(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.seradataCommDetails.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  ...
  public static func startSeradataSpacecraftDetails_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 105) }
  ...
  public static func add(dataMode: SeradataSpacecraftDetails_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func addVectorOf(seradataSigIntPayload: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: seradataSigIntPayload, at: VTOFFSET.seradataSigIntPayload.p) }
  public static func addVectorOf(seradataRadarPayload: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: seradataRadarPayload, at: VTOFFSET.seradataRadarPayload.p) }
  public static func addVectorOf(seradataNavigation: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: seradataNavigation, at: VTOFFSET.seradataNavigation.p) }
  public static func addVectorOf(seradataOpticalPayload: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: seradataOpticalPayload, at: VTOFFSET.seradataOpticalPayload.p) }
  public static func addVectorOf(seradataEarlyWarning: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: seradataEarlyWarning, at: VTOFFSET.seradataEarlyWarning.p) }
  public static func addVectorOf(scientific: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: scientific, at: VTOFFSET.scientific.p) }
  public static func addVectorOf(seradataCommDetails: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: seradataCommDetails, at: VTOFFSET.seradataCommDetails.p) }
  public static func add(onOrbit: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: onOrbit, at: VTOFFSET.onOrbit.p) }
  public static func endSeradataSpacecraftDetails_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSeradataSpacecraftDetails_Full(
    ...
    seradataSigIntPayloadVectorOffset seradataSigIntPayload: Offset = Offset(),
    seradataRadarPayloadVectorOffset seradataRadarPayload: Offset = Offset(),
    seradataNavigationVectorOffset seradataNavigation: Offset = Offset(),
    seradataOpticalPayloadVectorOffset seradataOpticalPayload: Offset = Offset(),
    seradataEarlyWarningVectorOffset seradataEarlyWarning: Offset = Offset(),
    scientificVectorOffset scientific: Offset = Offset(),
    seradataCommDetailsVectorOffset seradataCommDetails: Offset = Offset(),
    onOrbitOffset onOrbit: Offset = Offset()
  ) -> Offset {
    let __start = SeradataSpacecraftDetails_Full.startSeradataSpacecraftDetails_Full(&fbb)
    SeradataSpacecraftDetails_Full.add(id: id, &fbb)
    SeradataSpacecraftDetails_Full.add(idOnOrbit: idOnOrbit, &fbb)
    SeradataSpacecraftDetails_Full.add(classificationMarking: classificationMarking, &fbb)
    SeradataSpacecraftDetails_Full.add(name: name, &fbb)
    SeradataSpacecraftDetails_Full.add(description: description, &fbb)
    SeradataSpacecraftDetails_Full.add(intlNumber: intlNumber, &fbb)
    SeradataSpacecraftDetails_Full.add(sector: sector, &fbb)
    SeradataSpacecraftDetails_Full.add(apogee: apogee, &fbb)
    SeradataSpacecraftDetails_Full.add(perigee: perigee, &fbb)
    SeradataSpacecraftDetails_Full.add(period: period, &fbb)
    SeradataSpacecraftDetails_Full.add(inclination: inclination, &fbb)
    SeradataSpacecraftDetails_Full.add(primeManufacturerOrgId: primeManufacturerOrgId, &fbb)
    SeradataSpacecraftDetails_Full.add(stabilizer: stabilizer, &fbb)
    SeradataSpacecraftDetails_Full.add(designLife: designLife, &fbb)
    SeradataSpacecraftDetails_Full.add(expectedLife: expectedLife, &fbb)
    SeradataSpacecraftDetails_Full.add(insuredAtLaunch: insuredAtLaunch, &fbb)
    SeradataSpacecraftDetails_Full.add(launchMass: launchMass, &fbb)
    SeradataSpacecraftDetails_Full.add(dryMass: dryMass, &fbb)
    SeradataSpacecraftDetails_Full.add(catalogNumber: catalogNumber, &fbb)
    SeradataSpacecraftDetails_Full.add(totalPayloadPower: totalPayloadPower, &fbb)
    SeradataSpacecraftDetails_Full.add(constellation: constellation, &fbb)
    SeradataSpacecraftDetails_Full.add(orbitCategory: orbitCategory, &fbb)
    SeradataSpacecraftDetails_Full.add(orbitSubCategory: orbitSubCategory, &fbb)
    SeradataSpacecraftDetails_Full.add(launchCost: launchCost, &fbb)
    SeradataSpacecraftDetails_Full.add(launchCostEstimated: launchCostEstimated, &fbb)
    SeradataSpacecraftDetails_Full.add(costEstimated: costEstimated, &fbb)
    SeradataSpacecraftDetails_Full.add(newCost: newCost, &fbb)
    SeradataSpacecraftDetails_Full.add(combinedNewCost: combinedNewCost, &fbb)
    SeradataSpacecraftDetails_Full.add(combinedCostEstimated: combinedCostEstimated, &fbb)
    SeradataSpacecraftDetails_Full.add(insuredValueAtLaunch: insuredValueAtLaunch, &fbb)
    SeradataSpacecraftDetails_Full.add(insuredValueLaunchEstimated: insuredValueLaunchEstimated, &fbb)
    SeradataSpacecraftDetails_Full.add(annualInsuredDepreciationFactor: annualInsuredDepreciationFactor, &fbb)
    SeradataSpacecraftDetails_Full.add(annualInsuredDepreciationFactorEstimated: annualInsuredDepreciationFactorEstimated, &fbb)
    SeradataSpacecraftDetails_Full.add(insurancePremiumAtLaunch: insurancePremiumAtLaunch, &fbb)
    SeradataSpacecraftDetails_Full.add(insurancePremiumAtLaunchEstimated: insurancePremiumAtLaunchEstimated, &fbb)
    SeradataSpacecraftDetails_Full.add(numHumans: numHumans, &fbb)
    SeradataSpacecraftDetails_Full.add(cubesatDispenserType: cubesatDispenserType, &fbb)
    SeradataSpacecraftDetails_Full.add(massCategory: massCategory, &fbb)
    SeradataSpacecraftDetails_Full.add(launchId: launchId, &fbb)
    SeradataSpacecraftDetails_Full.add(launchVehicleId: launchVehicleId, &fbb)
    SeradataSpacecraftDetails_Full.add(launchProviderFlightNumber: launchProviderFlightNumber, &fbb)
    SeradataSpacecraftDetails_Full.add(launchSiteName: launchSiteName, &fbb)
    SeradataSpacecraftDetails_Full.add(launchSiteId: launchSiteId, &fbb)
    SeradataSpacecraftDetails_Full.add(launchCountry: launchCountry, &fbb)
    SeradataSpacecraftDetails_Full.add(launchProvider: launchProvider, &fbb)
    SeradataSpacecraftDetails_Full.add(launchProviderCountry: launchProviderCountry, &fbb)
    SeradataSpacecraftDetails_Full.add(commercialLaunch: commercialLaunch, &fbb)
    SeradataSpacecraftDetails_Full.add(launchType: launchType, &fbb)
    SeradataSpacecraftDetails_Full.add(launchCharacteristic: launchCharacteristic, &fbb)
    SeradataSpacecraftDetails_Full.add(launchNumber: launchNumber, &fbb)
    SeradataSpacecraftDetails_Full.add(launchDate: launchDate, &fbb)
    SeradataSpacecraftDetails_Full.add(launchDateRemarks: launchDateRemarks, &fbb)
    SeradataSpacecraftDetails_Full.add(youtubeLaunchLink: youtubeLaunchLink, &fbb)
    SeradataSpacecraftDetails_Full.add(status: status, &fbb)
    SeradataSpacecraftDetails_Full.add(owner: owner, &fbb)
    SeradataSpacecraftDetails_Full.add(ownerCountry: ownerCountry, &fbb)
    SeradataSpacecraftDetails_Full.add(operator_: operator_, &fbb)
    SeradataSpacecraftDetails_Full.add(operatorCountry: operatorCountry, &fbb)
    SeradataSpacecraftDetails_Full.add(leased: leased, &fbb)
    SeradataSpacecraftDetails_Full.add(orderDate: orderDate, &fbb)
    SeradataSpacecraftDetails_Full.add(capabilityLost: capabilityLost, &fbb)
    SeradataSpacecraftDetails_Full.add(capacityLost: capacityLost, &fbb)
    SeradataSpacecraftDetails_Full.add(primaryMissionGroup: primaryMissionGroup, &fbb)
    SeradataSpacecraftDetails_Full.add(additionalMissionsGroups: additionalMissionsGroups, &fbb)
    SeradataSpacecraftDetails_Full.add(totalClaims: totalClaims, &fbb)
    SeradataSpacecraftDetails_Full.add(totalInjuries: totalInjuries, &fbb)
    SeradataSpacecraftDetails_Full.add(totalFatalities: totalFatalities, &fbb)
    SeradataSpacecraftDetails_Full.add(nameAtLaunch: nameAtLaunch, &fbb)
    SeradataSpacecraftDetails_Full.add(busId: busId, &fbb)
    SeradataSpacecraftDetails_Full.add(currentAge: currentAge, &fbb)
    SeradataSpacecraftDetails_Full.add(lifeLost: lifeLost, &fbb)
    SeradataSpacecraftDetails_Full.add(geoPosition: geoPosition, &fbb)
    SeradataSpacecraftDetails_Full.add(insuranceLossesTotal: insuranceLossesTotal, &fbb)
    SeradataSpacecraftDetails_Full.add(launchArranger: launchArranger, &fbb)
    SeradataSpacecraftDetails_Full.add(launchArrangerCountry: launchArrangerCountry, &fbb)
    SeradataSpacecraftDetails_Full.add(serialNumber: serialNumber, &fbb)
    SeradataSpacecraftDetails_Full.add(programName: programName, &fbb)
    SeradataSpacecraftDetails_Full.add(reusedHullName: reusedHullName, &fbb)
    SeradataSpacecraftDetails_Full.add(dateOfObservation: dateOfObservation, &fbb)
    SeradataSpacecraftDetails_Full.add(lat: lat, &fbb)
    SeradataSpacecraftDetails_Full.add(lon: lon, &fbb)
    SeradataSpacecraftDetails_Full.add(altitude: altitude, &fbb)
    SeradataSpacecraftDetails_Full.add(collisionRiskMm: collisionRiskMm, &fbb)
    SeradataSpacecraftDetails_Full.add(collisionRiskCm: collisionRiskCm, &fbb)
    SeradataSpacecraftDetails_Full.add(quantity: quantity, &fbb)
    SeradataSpacecraftDetails_Full.add(reusableFlights: reusableFlights, &fbb)
    SeradataSpacecraftDetails_Full.add(notes: notes, &fbb)
    SeradataSpacecraftDetails_Full.add(insuranceNotes: insuranceNotes, &fbb)
    SeradataSpacecraftDetails_Full.add(launchNotes: launchNotes, &fbb)
    SeradataSpacecraftDetails_Full.add(source: source, &fbb)
    SeradataSpacecraftDetails_Full.add(origin: origin, &fbb)
    SeradataSpacecraftDetails_Full.add(origNetwork: origNetwork, &fbb)
    SeradataSpacecraftDetails_Full.add(dataMode: dataMode, &fbb)
    SeradataSpacecraftDetails_Full.add(createdAt: createdAt, &fbb)
    SeradataSpacecraftDetails_Full.add(createdBy: createdBy, &fbb)
    SeradataSpacecraftDetails_Full.add(updatedAt: updatedAt, &fbb)
    SeradataSpacecraftDetails_Full.add(updatedBy: updatedBy, &fbb)
    SeradataSpacecraftDetails_Full.addVectorOf(seradataSigIntPayload: seradataSigIntPayload, &fbb)
    SeradataSpacecraftDetails_Full.addVectorOf(seradataRadarPayload: seradataRadarPayload, &fbb)
    SeradataSpacecraftDetails_Full.addVectorOf(seradataNavigation: seradataNavigation, &fbb)
    SeradataSpacecraftDetails_Full.addVectorOf(seradataOpticalPayload: seradataOpticalPayload, &fbb)
    SeradataSpacecraftDetails_Full.addVectorOf(seradataEarlyWarning: seradataEarlyWarning, &fbb)
    SeradataSpacecraftDetails_Full.addVectorOf(scientific: scientific, &fbb)
    SeradataSpacecraftDetails_Full.addVectorOf(seradataCommDetails: seradataCommDetails, &fbb)
    SeradataSpacecraftDetails_Full.add(onOrbit: onOrbit, &fbb)
    return SeradataSpacecraftDetails_Full.endSeradataSpacecraftDetails_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SeradataSpacecraftDetails_Full_dataMode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.seradataSigIntPayload.p, fieldName: "seradataSigIntPayload", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
    try _v.visit(field: VTOFFSET.seradataRadarPayload.p, fieldName: "seradataRadarPayload", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
    try _v.visit(field: VTOFFSET.seradataNavigation.p, fieldName: "seradataNavigation", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
    try _v.visit(field: VTOFFSET.seradataOpticalPayload.p, fieldName: "seradataOpticalPayload", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
    try _v.visit(field: VTOFFSET.seradataEarlyWarning.p, fieldName: "seradataEarlyWarning", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
    try _v.visit(field: VTOFFSET.scientific.p, fieldName: "scientific", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
    try _v.visit(field: VTOFFSET.seradataCommDetails.p, fieldName: "seradataCommDetails", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
