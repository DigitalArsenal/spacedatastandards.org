...
public enum Status_state_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Status_state_Enum { return .standby }
  public static var min: Status_state_Enum { return .unknown }
}


public enum Status_sysCap_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: Status_sysCap_Enum { return .unk }
  public static var min: Status_sysCap_Enum { return .fmc }
}


public enum Status_opsCap_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: Status_opsCap_Enum { return .unk }
  public static var min: Status_opsCap_Enum { return .fmc }
}


public enum Status_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: Status_dataMode_Enum { return .exercise }
  public static var min: Status_dataMode_Enum { return .real }
}


///  /// Status for a particular Entity. An entity may have multiple status records collected by various sources.
public struct Status: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Status.id, addPrefix: prefix) }
  ...
  public var state: Status_state_Enum { let o = _accessor.offset(VTOFFSET.state.v); return o == 0 ? .unknown : Status_state_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .unknown }
  ///  System capability of the entity, if applicable (e.g. FMC, NMC, PMC, UNK).
  ///  Example: /// Example: FMC
  ///  Constraints: Minimum length = 0, Maximum length = 3
  public var sysCap: Status_sysCap_Enum { let o = _accessor.offset(VTOFFSET.sysCap.v); return o == 0 ? .fmc : Status_sysCap_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .fmc }
  ///  Operation capability of the entity, if applicable (e.g. FMC, NMC, PMC, UNK).
  ///  Example: /// Example: FMC
  ///  Constraints: Minimum length = 0, Maximum length = 3
  public var opsCap: Status_opsCap_Enum { let o = _accessor.offset(VTOFFSET.opsCap.v); return o == 0 ? .fmc : Status_opsCap_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .fmc }
  ///  Source of the data.
  ...
  public var dataMode: Status_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Status_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startStatus(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 19) }
  ...
  public static func add(state: Status_state_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: state.rawValue, def: 0, at: VTOFFSET.state.p) }
  public static func add(sysCap: Status_sysCap_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: sysCap.rawValue, def: 0, at: VTOFFSET.sysCap.p) }
  public static func add(opsCap: Status_opsCap_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: opsCap.rawValue, def: 0, at: VTOFFSET.opsCap.p) }
  ...
  public static func add(dataMode: Status_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func createStatus(
    ...
    let __start = Status.startStatus(&fbb)
    Status.add(id: id, &fbb)
    Status.add(classificationMarking: classificationMarking, &fbb)
    Status.add(derivedFrom: derivedFrom, &fbb)
    Status.add(declassificationDate: declassificationDate, &fbb)
    Status.add(declassificationString: declassificationString, &fbb)
    Status.add(idEntity: idEntity, &fbb)
    Status.add(state: state, &fbb)
    Status.add(sysCap: sysCap, &fbb)
    Status.add(opsCap: opsCap, &fbb)
    Status.add(source: source, &fbb)
    Status.addVectorOf(subStatusCollection: subStatusCollection, &fbb)
    Status.add(dataMode: dataMode, &fbb)
    Status.add(notes: notes, &fbb)
    Status.add(createdAt: createdAt, &fbb)
    Status.add(createdBy: createdBy, &fbb)
    Status.add(updatedAt: updatedAt, &fbb)
    Status.add(updatedBy: updatedBy, &fbb)
    Status.add(origin: origin, &fbb)
    Status.add(origNetwork: origNetwork, &fbb)
    return Status.endStatus(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.state.p, fieldName: "state", required: false, type: Status_state_Enum.self)
    try _v.visit(field: VTOFFSET.sysCap.p, fieldName: "sysCap", required: false, type: Status_sysCap_Enum.self)
    try _v.visit(field: VTOFFSET.opsCap.p, fieldName: "opsCap", required: false, type: Status_opsCap_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Status_dataMode_Enum.self)
