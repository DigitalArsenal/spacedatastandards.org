...
public enum Organization_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Organization_Full_dataMode_Enum { return .exercise }
  public static var min: Organization_Full_dataMode_Enum { return .real }
}
...
public struct Organization_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Organization_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: Organization_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Organization_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Constraints: No constraints specified.
  public var hasOrganizationDetails: Bool { let o = _accessor.offset(VTOFFSET.organizationDetails.v); return o == 0 ? false : true }
  public var organizationDetailsCount: Int32 { let o = _accessor.offset(VTOFFSET.organizationDetails.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func organizationDetails(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.organizationDetails.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: OPS1
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startOrganization_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 19) }
  ...
  public static func add(dataMode: Organization_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func addVectorOf(organizationDetails: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: organizationDetails, at: VTOFFSET.organizationDetails.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endOrganization_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOrganization_Full(
    ...
    organizationDetailsVectorOffset organizationDetails: Offset = Offset(),
    origNetworkOffset origNetwork: Offset = Offset()
  ) -> Offset {
    let __start = Organization_Full.startOrganization_Full(&fbb)
    Organization_Full.add(id: id, &fbb)
    Organization_Full.add(classificationMarking: classificationMarking, &fbb)
    Organization_Full.add(name: name, &fbb)
    Organization_Full.add(type: type, &fbb)
    Organization_Full.add(category: category, &fbb)
    Organization_Full.add(externalId: externalId, &fbb)
    Organization_Full.add(description: description, &fbb)
    Organization_Full.add(countryCode: countryCode, &fbb)
    Organization_Full.add(nationality: nationality, &fbb)
    Organization_Full.add(active: active, &fbb)
    Organization_Full.add(source: source, &fbb)
    Organization_Full.add(origin: origin, &fbb)
    Organization_Full.add(dataMode: dataMode, &fbb)
    Organization_Full.add(createdAt: createdAt, &fbb)
    Organization_Full.add(createdBy: createdBy, &fbb)
    Organization_Full.add(updatedAt: updatedAt, &fbb)
    Organization_Full.add(updatedBy: updatedBy, &fbb)
    Organization_Full.addVectorOf(organizationDetails: organizationDetails, &fbb)
    Organization_Full.add(origNetwork: origNetwork, &fbb)
    return Organization_Full.endOrganization_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Organization_Full_dataMode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.organizationDetails.p, fieldName: "organizationDetails", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
