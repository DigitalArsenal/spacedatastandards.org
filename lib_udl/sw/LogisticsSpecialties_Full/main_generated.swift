...
public struct LogisticsSpecialties_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LogisticsSpecialties_Full.id, addPrefix: prefix) }
  ...
  public static func startLogisticsSpecialties_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 7) }
  ...
  public static func endLogisticsSpecialties_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLogisticsSpecialties_Full(
    ...
    let __start = LogisticsSpecialties_Full.startLogisticsSpecialties_Full(&fbb)
    LogisticsSpecialties_Full.add(specialty: specialty, &fbb)
    LogisticsSpecialties_Full.add(skillLevel: skillLevel, &fbb)
    LogisticsSpecialties_Full.add(firstName: firstName, &fbb)
    LogisticsSpecialties_Full.add(lastName: lastName, &fbb)
    LogisticsSpecialties_Full.add(rankCode: rankCode, &fbb)
    LogisticsSpecialties_Full.add(last4Ssn: last4Ssn, &fbb)
    LogisticsSpecialties_Full.add(roleTypeCode: roleTypeCode, &fbb)
    return LogisticsSpecialties_Full.endLogisticsSpecialties_Full(&fbb, start: __start)
  }
