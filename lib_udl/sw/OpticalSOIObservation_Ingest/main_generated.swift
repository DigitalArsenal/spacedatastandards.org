...
public struct OpticalSOIObservation_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OpticalSOIObservation_Ingest.id, addPrefix: prefix) }
  ...
  public static func startOpticalSOIObservation_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 17) }
  ...
  public static func endOpticalSOIObservation_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOpticalSOIObservation_Ingest(
    ...
    let __start = OpticalSOIObservation_Ingest.startOpticalSOIObservation_Ingest(&fbb)
    OpticalSOIObservation_Ingest.add(obStartTime: obStartTime, &fbb)
    OpticalSOIObservation_Ingest.addVectorOf(intensityTimes: intensityTimes, &fbb)
    OpticalSOIObservation_Ingest.add(currentSpectralFilterNum: currentSpectralFilterNum, &fbb)
    OpticalSOIObservation_Ingest.add(expDuration: expDuration, &fbb)
    OpticalSOIObservation_Ingest.addVectorOf(intensities: intensities, &fbb)
    OpticalSOIObservation_Ingest.addVectorOf(extinctionCoeffs: extinctionCoeffs, &fbb)
    OpticalSOIObservation_Ingest.addVectorOf(extinctionCoeffsUnc: extinctionCoeffsUnc, &fbb)
    OpticalSOIObservation_Ingest.addVectorOf(skyBgs: skyBgs, &fbb)
    OpticalSOIObservation_Ingest.addVectorOf(localSkyBgs: localSkyBgs, &fbb)
    OpticalSOIObservation_Ingest.addVectorOf(localSkyBgsUnc: localSkyBgsUnc, &fbb)
    OpticalSOIObservation_Ingest.addVectorOf(numDetectedStars: numDetectedStars, &fbb)
    OpticalSOIObservation_Ingest.addVectorOf(numCorrelatedStars: numCorrelatedStars, &fbb)
    OpticalSOIObservation_Ingest.addVectorOf(zeroPoints: zeroPoints, &fbb)
    OpticalSOIObservation_Ingest.addVectorOf(ras: ras, &fbb)
    OpticalSOIObservation_Ingest.addVectorOf(declinations: declinations, &fbb)
    OpticalSOIObservation_Ingest.addVectorOf(raRates: raRates, &fbb)
    OpticalSOIObservation_Ingest.addVectorOf(percentSats: percentSats, &fbb)
    return OpticalSOIObservation_Ingest.endOpticalSOIObservation_Ingest(&fbb, start: __start)
  }
