...
public enum OnorbitThruster_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OnorbitThruster_Abridged_dataMode_Enum { return .exercise }
  public static var min: OnorbitThruster_Abridged_dataMode_Enum { return .real }
}


///  /// No description available.
public struct OnorbitThruster_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OnorbitThruster_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: OnorbitThruster_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OnorbitThruster_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOnorbitThruster_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 13) }
  ...
  public static func add(dataMode: OnorbitThruster_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endOnorbitThruster_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnorbitThruster_Abridged(
    ...
    let __start = OnorbitThruster_Abridged.startOnorbitThruster_Abridged(&fbb)
    OnorbitThruster_Abridged.add(id: id, &fbb)
    OnorbitThruster_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    OnorbitThruster_Abridged.add(idEngine: idEngine, &fbb)
    OnorbitThruster_Abridged.add(classificationMarking: classificationMarking, &fbb)
    OnorbitThruster_Abridged.add(type: type, &fbb)
    OnorbitThruster_Abridged.add(quantity: quantity, &fbb)
    OnorbitThruster_Abridged.add(createdAt: createdAt, &fbb)
    OnorbitThruster_Abridged.add(createdBy: createdBy, &fbb)
    OnorbitThruster_Abridged.add(source: source, &fbb)
    OnorbitThruster_Abridged.add(origin: origin, &fbb)
    OnorbitThruster_Abridged.add(dataMode: dataMode, &fbb)
    OnorbitThruster_Abridged.add(engine: engine, &fbb)
    OnorbitThruster_Abridged.add(origNetwork: origNetwork, &fbb)
    return OnorbitThruster_Abridged.endOnorbitThruster_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OnorbitThruster_Abridged_dataMode_Enum.self)
