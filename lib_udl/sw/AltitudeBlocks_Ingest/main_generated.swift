...
public struct AltitudeBlocks_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AltitudeBlocks_Ingest.id, addPrefix: prefix) }
  ...
  public static func startAltitudeBlocks_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endAltitudeBlocks_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAltitudeBlocks_Ingest(
    _ fbb: inout FlatBufferBuilder,
    altitudeSequenceIdOffset altitudeSequenceId: Offset = Offset(),
    lowerAltitude: Double = 0.0,
    upperAltitude: Double = 0.0
  ) -> Offset {
    let __start = AltitudeBlocks_Ingest.startAltitudeBlocks_Ingest(&fbb)
    AltitudeBlocks_Ingest.add(altitudeSequenceId: altitudeSequenceId, &fbb)
    AltitudeBlocks_Ingest.add(lowerAltitude: lowerAltitude, &fbb)
    AltitudeBlocks_Ingest.add(upperAltitude: upperAltitude, &fbb)
    return AltitudeBlocks_Ingest.endAltitudeBlocks_Ingest(&fbb, start: __start)
  }
