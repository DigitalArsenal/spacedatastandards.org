...
public enum IonoObservationPolarization_Ingest_data_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: IonoObservationPolarization_Ingest_data_Enum { return .o }
  public static var min: IonoObservationPolarization_Ingest_data_Enum { return .x }
}
...
public struct IonoObservationPolarization_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationPolarization_Ingest.id, addPrefix: prefix) }
  ...
  ///  Example: /// Example: [[[[[[['X', 'O']]]]]]]
  ///  Constraints: No constraints specified.
  public var data: IonoObservationPolarization_Ingest_data_Enum { let o = _accessor.offset(VTOFFSET.data.v); return o == 0 ? .x : IonoObservationPolarization_Ingest_data_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .x }
  public static func startIonoObservationPolarization_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func add(data: IonoObservationPolarization_Ingest_data_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: data.rawValue, def: 0, at: VTOFFSET.data.p) }
  public static func endIonoObservationPolarization_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationPolarization_Ingest(
    ...
    let __start = IonoObservationPolarization_Ingest.startIonoObservationPolarization_Ingest(&fbb)
    IonoObservationPolarization_Ingest.add(notes: notes, &fbb)
    IonoObservationPolarization_Ingest.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationPolarization_Ingest.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationPolarization_Ingest.add(data: data, &fbb)
    return IonoObservationPolarization_Ingest.endIonoObservationPolarization_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.data.p, fieldName: "data", required: false, type: IonoObservationPolarization_Ingest_data_Enum.self)
    _v.finish()
  }
}
