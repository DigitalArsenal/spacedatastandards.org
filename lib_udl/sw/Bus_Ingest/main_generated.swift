...
public enum Bus_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Bus_Ingest_dataMode_Enum { return .exercise }
  public static var min: Bus_Ingest_dataMode_Enum { return .real }
}
...
public struct Bus_Ingest: FlatBufferObject, Verifiable {

  static func validateVersion() { FlatBuffersVersion_24_3_25() }
  public var __buffer: ByteBuffer! { return _accessor.bb }
  private var _accessor: Table

  public static var id: String { "BUSI" } 
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Bus_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Bus_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Bus_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startBus_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 57) }
  ...
  public static func add(dataMode: Bus_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endBus_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createBus_Ingest(
    ...
    let __start = Bus_Ingest.startBus_Ingest(&fbb)
    Bus_Ingest.add(id: id, &fbb)
    Bus_Ingest.add(name: name, &fbb)
    Bus_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Bus_Ingest.add(idEntity: idEntity, &fbb)
    Bus_Ingest.add(type: type, &fbb)
    Bus_Ingest.add(maxLaunchMassLower: maxLaunchMassLower, &fbb)
    Bus_Ingest.add(maxLaunchMassUpper: maxLaunchMassUpper, &fbb)
    Bus_Ingest.add(maxBolstationMass: maxBolstationMass, &fbb)
    Bus_Ingest.add(avgPayloadMass: avgPayloadMass, &fbb)
    Bus_Ingest.add(maxPayloadMass: maxPayloadMass, &fbb)
    Bus_Ingest.add(minDryMass: minDryMass, &fbb)
    Bus_Ingest.add(avgDryMass: avgDryMass, &fbb)
    Bus_Ingest.add(medianDryMass: medianDryMass, &fbb)
    Bus_Ingest.add(maxDryMass: maxDryMass, &fbb)
    Bus_Ingest.add(minWetMass: minWetMass, &fbb)
    Bus_Ingest.add(avgWetMass: avgWetMass, &fbb)
    Bus_Ingest.add(medianWetMass: medianWetMass, &fbb)
    Bus_Ingest.add(maxWetMass: maxWetMass, &fbb)
    Bus_Ingest.add(maxBolpowerLower: maxBolpowerLower, &fbb)
    Bus_Ingest.add(maxBolpowerUpper: maxBolpowerUpper, &fbb)
    Bus_Ingest.add(maxEolpowerLower: maxEolpowerLower, &fbb)
    Bus_Ingest.add(maxEolpowerUpper: maxEolpowerUpper, &fbb)
    Bus_Ingest.add(avgSpacecraftPower: avgSpacecraftPower, &fbb)
    Bus_Ingest.add(maxSpacecraftPower: maxSpacecraftPower, &fbb)
    Bus_Ingest.add(oapSpacecraftPower: oapSpacecraftPower, &fbb)
    Bus_Ingest.add(avgPayloadPower: avgPayloadPower, &fbb)
    Bus_Ingest.add(maxPayloadPower: maxPayloadPower, &fbb)
    Bus_Ingest.add(oapPayloadPower: oapPayloadPower, &fbb)
    Bus_Ingest.add(bodyDimensionX: bodyDimensionX, &fbb)
    Bus_Ingest.add(bodyDimensionY: bodyDimensionY, &fbb)
    Bus_Ingest.add(bodyDimensionZ: bodyDimensionZ, &fbb)
    Bus_Ingest.add(payloadDimensionX: payloadDimensionX, &fbb)
    Bus_Ingest.add(payloadDimensionY: payloadDimensionY, &fbb)
    Bus_Ingest.add(payloadDimensionZ: payloadDimensionZ, &fbb)
    Bus_Ingest.add(payloadVolume: payloadVolume, &fbb)
    Bus_Ingest.add(launchEnvelopeDimensionX: launchEnvelopeDimensionX, &fbb)
    Bus_Ingest.add(launchEnvelopeDimensionY: launchEnvelopeDimensionY, &fbb)
    Bus_Ingest.add(launchEnvelopeDimensionZ: launchEnvelopeDimensionZ, &fbb)
    Bus_Ingest.add(numOrbitType: numOrbitType, &fbb)
    Bus_Ingest.addVectorOf(orbitTypes: orbitTypes, &fbb)
    Bus_Ingest.add(telemetryTrackingManufacturerOrgId: telemetryTrackingManufacturerOrgId, &fbb)
    Bus_Ingest.add(mainComputerManufacturerOrgId: mainComputerManufacturerOrgId, &fbb)
    Bus_Ingest.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    Bus_Ingest.add(busKitDesignerOrgId: busKitDesignerOrgId, &fbb)
    Bus_Ingest.add(countryCode: countryCode, &fbb)
    Bus_Ingest.add(massCategory: massCategory, &fbb)
    Bus_Ingest.add(powerCategory: powerCategory, &fbb)
    Bus_Ingest.add(generic: generic, &fbb)
    Bus_Ingest.add(description: description, &fbb)
    Bus_Ingest.add(aocsNotes: aocsNotes, &fbb)
    Bus_Ingest.add(source: source, &fbb)
    Bus_Ingest.add(origin: origin, &fbb)
    Bus_Ingest.add(origNetwork: origNetwork, &fbb)
    Bus_Ingest.add(dataMode: dataMode, &fbb)
    Bus_Ingest.add(createdAt: createdAt, &fbb)
    Bus_Ingest.add(createdBy: createdBy, &fbb)
    Bus_Ingest.add(entity: entity, &fbb)
    return Bus_Ingest.endBus_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Bus_Ingest_dataMode_Enum.self)
