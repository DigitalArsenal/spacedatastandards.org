...
public enum POI_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: POI_Ingest_dataMode_Enum { return .exercise }
  public static var min: POI_Ingest_dataMode_Enum { return .real }
}
...
public struct POI_Ingest: FlatBufferObject, Verifiable {

  static func validateVersion() { FlatBuffersVersion_24_3_25() }
  public var __buffer: ByteBuffer! { return _accessor.bb }
  private var _accessor: Table

  public static var id: String { "POII" } 
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: POI_Ingest.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case srcIds = 98
    case beNumber = 100
    case orientation = 102
    case origNetwork = 104
    case transactionId = 106
  ...
  public var dataMode: POI_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : POI_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startPOI_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 52) }
  ...
  public static func add(dataMode: POI_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endPOI_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPOI_Ingest(
    ...
    let __start = POI_Ingest.startPOI_Ingest(&fbb)
    POI_Ingest.add(id: id, &fbb)
    POI_Ingest.add(classificationMarking: classificationMarking, &fbb)
    POI_Ingest.add(pps: pps, &fbb)
    POI_Ingest.add(msnid: msnid, &fbb)
    POI_Ingest.add(pri: pri, &fbb)
    POI_Ingest.add(trkid: trkid, &fbb)
    POI_Ingest.addVectorOf(idWeatherReport: idWeatherReport, &fbb)
    POI_Ingest.add(poiid: poiid, &fbb)
    POI_Ingest.add(name: name, &fbb)
    POI_Ingest.add(desc: desc, &fbb)
    POI_Ingest.add(spec: spec, &fbb)
    POI_Ingest.add(ident: ident, &fbb)
    POI_Ingest.add(env: env, &fbb)
    POI_Ingest.add(plat: plat, &fbb)
    POI_Ingest.add(activity: activity, &fbb)
    POI_Ingest.add(ts: ts, &fbb)
    POI_Ingest.add(start: start, &fbb)
    POI_Ingest.add(stale: stale, &fbb)
    POI_Ingest.add(how: how, &fbb)
    POI_Ingest.add(type: type, &fbb)
    POI_Ingest.add(lat: lat, &fbb)
    POI_Ingest.add(lon: lon, &fbb)
    POI_Ingest.add(alt: alt, &fbb)
    POI_Ingest.add(az: az, &fbb)
    POI_Ingest.add(el: el, &fbb)
    POI_Ingest.add(le: le, &fbb)
    POI_Ingest.add(ce: ce, &fbb)
    POI_Ingest.addVectorOf(elle: elle, &fbb)
    POI_Ingest.add(cntct: cntct, &fbb)
    POI_Ingest.add(conf: conf, &fbb)
    POI_Ingest.addVectorOf(urls: urls, &fbb)
    POI_Ingest.add(area: area, &fbb)
    POI_Ingest.add(atext: atext, &fbb)
    POI_Ingest.add(agjson: agjson, &fbb)
    POI_Ingest.add(atype: atype, &fbb)
    POI_Ingest.add(andims: andims, &fbb)
    POI_Ingest.add(asrid: asrid, &fbb)
    POI_Ingest.add(createdAt: createdAt, &fbb)
    POI_Ingest.add(createdBy: createdBy, &fbb)
    POI_Ingest.add(sourceDl: sourceDl, &fbb)
    POI_Ingest.add(source: source, &fbb)
    POI_Ingest.add(dataMode: dataMode, &fbb)
    POI_Ingest.add(origin: origin, &fbb)
    POI_Ingest.addVectorOf(groups: groups, &fbb)
    POI_Ingest.add(asset: asset, &fbb)
    POI_Ingest.addVectorOf(tags: tags, &fbb)
    POI_Ingest.addVectorOf(srcTyps: srcTyps, &fbb)
    POI_Ingest.addVectorOf(srcIds: srcIds, &fbb)
    POI_Ingest.add(beNumber: beNumber, &fbb)
    POI_Ingest.add(orientation: orientation, &fbb)
    POI_Ingest.add(origNetwork: origNetwork, &fbb)
    POI_Ingest.add(transactionId: transactionId, &fbb)
    return POI_Ingest.endPOI_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: POI_Ingest_dataMode_Enum.self)
