...
public enum RFEmitterDetails_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: RFEmitterDetails_Full_dataMode_Enum { return .exercise }
  public static var min: RFEmitterDetails_Full_dataMode_Enum { return .real }
}
...
public struct RFEmitterDetails_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: RFEmitterDetails_Full.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case updatedAt = 74
    case updatedBy = 76
    case productionFacilityLocation = 78
    case manufacturerOrg = 80
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: RFEmitterDetails_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : RFEmitterDetails_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Constraints: No constraints specified.
  public var productionFacilityLocation: String? { let o = _accessor.offset(VTOFFSET.productionFacilityLocation.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var productionFacilityLocationSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.productionFacilityLocation.v) }
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  ...
  public static func startRFEmitterDetails_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 39) }
  ...
  public static func add(dataMode: RFEmitterDetails_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func add(productionFacilityLocation: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: productionFacilityLocation, at: VTOFFSET.productionFacilityLocation.p) }
  ...
  public static func endRFEmitterDetails_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createRFEmitterDetails_Full(
    ...
    productionFacilityLocationOffset productionFacilityLocation: Offset = Offset(),
    manufacturerOrgOffset manufacturerOrg: Offset = Offset()
  ) -> Offset {
    let __start = RFEmitterDetails_Full.startRFEmitterDetails_Full(&fbb)
    RFEmitterDetails_Full.add(id: id, &fbb)
    RFEmitterDetails_Full.add(idRfemitter: idRfemitter, &fbb)
    RFEmitterDetails_Full.add(classificationMarking: classificationMarking, &fbb)
    RFEmitterDetails_Full.add(designator: designator, &fbb)
    RFEmitterDetails_Full.add(altName: altName, &fbb)
    RFEmitterDetails_Full.add(family: family, &fbb)
    RFEmitterDetails_Full.add(productionFacilityName: productionFacilityName, &fbb)
    RFEmitterDetails_Full.add(alternateFacilityName: alternateFacilityName, &fbb)
    RFEmitterDetails_Full.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    RFEmitterDetails_Full.add(productionFacilityLocationId: productionFacilityLocationId, &fbb)
    RFEmitterDetails_Full.add(systemSensitivityStart: systemSensitivityStart, &fbb)
    RFEmitterDetails_Full.add(systemSensitivityEnd: systemSensitivityEnd, &fbb)
    RFEmitterDetails_Full.add(receiverType: receiverType, &fbb)
    RFEmitterDetails_Full.add(receiverSensitivity: receiverSensitivity, &fbb)
    RFEmitterDetails_Full.add(receiverBandwidth: receiverBandwidth, &fbb)
    RFEmitterDetails_Full.add(transmitterFrequency: transmitterFrequency, &fbb)
    RFEmitterDetails_Full.add(transmitterBandwidth: transmitterBandwidth, &fbb)
    RFEmitterDetails_Full.add(transmitPower: transmitPower, &fbb)
    RFEmitterDetails_Full.add(barrageNoiseBandwidth: barrageNoiseBandwidth, &fbb)
    RFEmitterDetails_Full.add(dopplerNoise: dopplerNoise, &fbb)
    RFEmitterDetails_Full.add(drfmInstantaneousBandwidth: drfmInstantaneousBandwidth, &fbb)
    RFEmitterDetails_Full.add(numChannels: numChannels, &fbb)
    RFEmitterDetails_Full.add(numBits: numBits, &fbb)
    RFEmitterDetails_Full.addVectorOf(antennaSize: antennaSize, &fbb)
    RFEmitterDetails_Full.add(antennaDiameter: antennaDiameter, &fbb)
    RFEmitterDetails_Full.add(notes: notes, &fbb)
    RFEmitterDetails_Full.add(secondaryNotes: secondaryNotes, &fbb)
    RFEmitterDetails_Full.add(description: description, &fbb)
    RFEmitterDetails_Full.addVectorOf(urls: urls, &fbb)
    RFEmitterDetails_Full.add(source: source, &fbb)
    RFEmitterDetails_Full.add(origin: origin, &fbb)
    RFEmitterDetails_Full.add(origNetwork: origNetwork, &fbb)
    RFEmitterDetails_Full.add(dataMode: dataMode, &fbb)
    RFEmitterDetails_Full.add(createdAt: createdAt, &fbb)
    RFEmitterDetails_Full.add(createdBy: createdBy, &fbb)
    RFEmitterDetails_Full.add(updatedAt: updatedAt, &fbb)
    RFEmitterDetails_Full.add(updatedBy: updatedBy, &fbb)
    RFEmitterDetails_Full.add(productionFacilityLocation: productionFacilityLocation, &fbb)
    RFEmitterDetails_Full.add(manufacturerOrg: manufacturerOrg, &fbb)
    return RFEmitterDetails_Full.endRFEmitterDetails_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: RFEmitterDetails_Full_dataMode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.productionFacilityLocation.p, fieldName: "productionFacilityLocation", required: false, type: ForwardOffset<String>.self)
