...
///  /// Array of Doppler.
public struct IonoObservationDoppler_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDoppler_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDoppler_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationDoppler_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDoppler_Full(
    ...
    let __start = IonoObservationDoppler_Full.startIonoObservationDoppler_Full(&fbb)
    IonoObservationDoppler_Full.add(notes: notes, &fbb)
    IonoObservationDoppler_Full.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationDoppler_Full.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationDoppler_Full.addVectorOf(data: data, &fbb)
    return IonoObservationDoppler_Full.endIonoObservationDoppler_Full(&fbb, start: __start)
  }
