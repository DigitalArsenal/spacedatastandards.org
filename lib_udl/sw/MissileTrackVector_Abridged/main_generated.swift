...
public struct MissileTrackVector_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MissileTrackVector_Abridged.id, addPrefix: prefix) }
  ...
  public static func startMissileTrackVector_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 21) }
  ...
  public static func endMissileTrackVector_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMissileTrackVector_Abridged(
    ...
    let __start = MissileTrackVector_Abridged.startMissileTrackVector_Abridged(&fbb)
    MissileTrackVector_Abridged.add(type: type, &fbb)
    MissileTrackVector_Abridged.add(object: object, &fbb)
    MissileTrackVector_Abridged.add(epoch: epoch, &fbb)
    MissileTrackVector_Abridged.add(idSensor: idSensor, &fbb)
    MissileTrackVector_Abridged.add(origSensorId: origSensorId, &fbb)
    MissileTrackVector_Abridged.addVectorOf(pos: pos, &fbb)
    MissileTrackVector_Abridged.addVectorOf(vel: vel, &fbb)
    MissileTrackVector_Abridged.addVectorOf(accel: accel, &fbb)
    MissileTrackVector_Abridged.add(course: course, &fbb)
    MissileTrackVector_Abridged.add(spd: spd, &fbb)
    MissileTrackVector_Abridged.add(referenceFrame: referenceFrame, &fbb)
    MissileTrackVector_Abridged.addVectorOf(cov: cov, &fbb)
    MissileTrackVector_Abridged.add(covReferenceFrame: covReferenceFrame, &fbb)
    MissileTrackVector_Abridged.add(vectorLat: vectorLat, &fbb)
    MissileTrackVector_Abridged.add(vectorLon: vectorLon, &fbb)
    MissileTrackVector_Abridged.add(vectorAlt: vectorAlt, &fbb)
    MissileTrackVector_Abridged.add(confidence: confidence, &fbb)
    MissileTrackVector_Abridged.add(status: status, &fbb)
    MissileTrackVector_Abridged.add(timeSource: timeSource, &fbb)
    MissileTrackVector_Abridged.addVectorOf(quat: quat, &fbb)
    MissileTrackVector_Abridged.add(flightAz: flightAz, &fbb)
    return MissileTrackVector_Abridged.endMissileTrackVector_Abridged(&fbb, start: __start)
  }
