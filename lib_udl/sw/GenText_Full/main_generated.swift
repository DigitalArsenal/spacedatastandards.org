...
public struct GenText_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: GenText_Full.id, addPrefix: prefix) }
  ...
  public static func startGenText_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 2) }
  ...
  public static func endGenText_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createGenText_Full(
    _ fbb: inout FlatBufferBuilder,
    textIndOffset textInd: Offset = Offset(),
    textOffset text: Offset = Offset()
  ) -> Offset {
    let __start = GenText_Full.startGenText_Full(&fbb)
    GenText_Full.add(textInd: textInd, &fbb)
    GenText_Full.add(text: text, &fbb)
    return GenText_Full.endGenText_Full(&fbb, start: __start)
  }
