...
public enum RFBand_Ingest_mode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: RFBand_Ingest_mode_Enum { return .rx }
  public static var min: RFBand_Ingest_mode_Enum { return .tx }
}


public enum RFBand_Ingest_purpose_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: RFBand_Ingest_purpose_Enum { return .other }
  public static var min: RFBand_Ingest_purpose_Enum { return .comm }
}


public enum RFBand_Ingest_polarization_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: RFBand_Ingest_polarization_Enum { return .l }
  public static var min: RFBand_Ingest_polarization_Enum { return .h }
}


public enum RFBand_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: RFBand_Ingest_dataMode_Enum { return .exercise }
  public static var min: RFBand_Ingest_dataMode_Enum { return .real }
}
...
public struct RFBand_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: RFBand_Ingest.id, addPrefix: prefix) }
  ...
  public var mode: RFBand_Ingest_mode_Enum { let o = _accessor.offset(VTOFFSET.mode.v); return o == 0 ? .tx : RFBand_Ingest_mode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .tx }
  ///  Purpose or use of the RF Band -- COMM = communications, TTC = Telemetry/Tracking/Control, OPS = Operations, OTHER = Other).
  ///  Example: /// Example: TTC
  ///  Constraints: Minimum length = 0, Maximum length = 16
  public var purpose: RFBand_Ingest_purpose_Enum { let o = _accessor.offset(VTOFFSET.purpose.v); return o == 0 ? .comm : RFBand_Ingest_purpose_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .comm }
  ...
  ///  Example: /// Example: H
  ///  Constraints: Minimum length = 0, Maximum length = 4
  public var polarization: RFBand_Ingest_polarization_Enum { let o = _accessor.offset(VTOFFSET.polarization.v); return o == 0 ? .h : RFBand_Ingest_polarization_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .h }
  ...
  public var dataMode: RFBand_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : RFBand_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startRFBand_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 23) }
  ...
  public static func add(mode: RFBand_Ingest_mode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: mode.rawValue, def: 0, at: VTOFFSET.mode.p) }
  public static func add(purpose: RFBand_Ingest_purpose_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: purpose.rawValue, def: 0, at: VTOFFSET.purpose.p) }
  ...
  public static func add(polarization: RFBand_Ingest_polarization_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: polarization.rawValue, def: 0, at: VTOFFSET.polarization.p) }
  ...
  public static func add(dataMode: RFBand_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endRFBand_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createRFBand_Ingest(
    ...
    let __start = RFBand_Ingest.startRFBand_Ingest(&fbb)
    RFBand_Ingest.add(id: id, &fbb)
    RFBand_Ingest.add(idEntity: idEntity, &fbb)
    RFBand_Ingest.add(classificationMarking: classificationMarking, &fbb)
    RFBand_Ingest.add(name: name, &fbb)
    RFBand_Ingest.add(band: band, &fbb)
    RFBand_Ingest.add(mode: mode, &fbb)
    RFBand_Ingest.add(purpose: purpose, &fbb)
    RFBand_Ingest.add(freqMin: freqMin, &fbb)
    RFBand_Ingest.add(freqMax: freqMax, &fbb)
    RFBand_Ingest.add(centerFreq: centerFreq, &fbb)
    RFBand_Ingest.add(peakGain: peakGain, &fbb)
    RFBand_Ingest.add(edgeGain: edgeGain, &fbb)
    RFBand_Ingest.add(bandwidth: bandwidth, &fbb)
    RFBand_Ingest.add(beamwidth: beamwidth, &fbb)
    RFBand_Ingest.add(polarization: polarization, &fbb)
    RFBand_Ingest.add(erp: erp, &fbb)
    RFBand_Ingest.add(eirp: eirp, &fbb)
    RFBand_Ingest.add(source: source, &fbb)
    RFBand_Ingest.add(origin: origin, &fbb)
    RFBand_Ingest.add(dataMode: dataMode, &fbb)
    RFBand_Ingest.add(createdAt: createdAt, &fbb)
    RFBand_Ingest.add(createdBy: createdBy, &fbb)
    RFBand_Ingest.add(origNetwork: origNetwork, &fbb)
    return RFBand_Ingest.endRFBand_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.mode.p, fieldName: "mode", required: false, type: RFBand_Ingest_mode_Enum.self)
    try _v.visit(field: VTOFFSET.purpose.p, fieldName: "purpose", required: false, type: RFBand_Ingest_purpose_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.polarization.p, fieldName: "polarization", required: false, type: RFBand_Ingest_polarization_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: RFBand_Ingest_dataMode_Enum.self)
