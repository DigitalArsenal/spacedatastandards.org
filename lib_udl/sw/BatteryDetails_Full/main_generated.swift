...
public enum BatteryDetails_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: BatteryDetails_Full_dataMode_Enum { return .exercise }
  public static var min: BatteryDetails_Full_dataMode_Enum { return .real }
}
...
public struct BatteryDetails_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: BatteryDetails_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: BatteryDetails_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : BatteryDetails_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startBatteryDetails_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 19) }
  ...
  public static func add(dataMode: BatteryDetails_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endBatteryDetails_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createBatteryDetails_Full(
    ...
    let __start = BatteryDetails_Full.startBatteryDetails_Full(&fbb)
    BatteryDetails_Full.add(id: id, &fbb)
    BatteryDetails_Full.add(idBattery: idBattery, &fbb)
    BatteryDetails_Full.add(classificationMarking: classificationMarking, &fbb)
    BatteryDetails_Full.add(technology: technology, &fbb)
    BatteryDetails_Full.add(capacity: capacity, &fbb)
    BatteryDetails_Full.add(dischargeDepth: dischargeDepth, &fbb)
    BatteryDetails_Full.add(model: model, &fbb)
    BatteryDetails_Full.add(description: description, &fbb)
    BatteryDetails_Full.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    BatteryDetails_Full.add(createdAt: createdAt, &fbb)
    BatteryDetails_Full.add(createdBy: createdBy, &fbb)
    BatteryDetails_Full.add(updatedAt: updatedAt, &fbb)
    BatteryDetails_Full.add(updatedBy: updatedBy, &fbb)
    BatteryDetails_Full.add(source: source, &fbb)
    BatteryDetails_Full.add(origin: origin, &fbb)
    BatteryDetails_Full.add(origNetwork: origNetwork, &fbb)
    BatteryDetails_Full.add(dataMode: dataMode, &fbb)
    BatteryDetails_Full.addVectorOf(tags: tags, &fbb)
    BatteryDetails_Full.add(manufacturerOrg: manufacturerOrg, &fbb)
    return BatteryDetails_Full.endBatteryDetails_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: BatteryDetails_Full_dataMode_Enum.self)
