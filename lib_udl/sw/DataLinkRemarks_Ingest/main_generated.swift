...
public struct DataLinkRemarks_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DataLinkRemarks_Ingest.id, addPrefix: prefix) }
  ...
  public static func startDataLinkRemarks_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 2) }
  ...
  public static func endDataLinkRemarks_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDataLinkRemarks_Ingest(
    _ fbb: inout FlatBufferBuilder,
    typeOffset type: Offset = Offset(),
    textOffset text: Offset = Offset()
  ) -> Offset {
    let __start = DataLinkRemarks_Ingest.startDataLinkRemarks_Ingest(&fbb)
    DataLinkRemarks_Ingest.add(type: type, &fbb)
    DataLinkRemarks_Ingest.add(text: text, &fbb)
    return DataLinkRemarks_Ingest.endDataLinkRemarks_Ingest(&fbb, start: __start)
  }
