...
public enum IR_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: IR_Full_dataMode_Enum { return .exercise }
  public static var min: IR_Full_dataMode_Enum { return .real }
}


///  /// IR represents Infrared entities within the SSA environment.
public struct IR_Full: FlatBufferObject, Verifiable {

  static func validateVersion() { FlatBuffersVersion_24_3_25() }
  public var __buffer: ByteBuffer! { return _accessor.bb }
  private var _accessor: Table

  public static var id: String { "IRFU" } 
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IR_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: IR_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : IR_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startIR_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 14) }
  ...
  public static func add(dataMode: IR_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(entity: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: entity, at: VTOFFSET.entity.p) }
  public static func endIR_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIR_Full(
    ...
    let __start = IR_Full.startIR_Full(&fbb)
    IR_Full.add(id: id, &fbb)
    IR_Full.add(classificationMarking: classificationMarking, &fbb)
    IR_Full.add(idEntity: idEntity, &fbb)
    IR_Full.add(name: name, &fbb)
    IR_Full.add(description: description, &fbb)
    IR_Full.add(createdAt: createdAt, &fbb)
    IR_Full.add(createdBy: createdBy, &fbb)
    IR_Full.add(updatedAt: updatedAt, &fbb)
    IR_Full.add(updatedBy: updatedBy, &fbb)
    IR_Full.add(source: source, &fbb)
    IR_Full.add(origin: origin, &fbb)
    IR_Full.add(origNetwork: origNetwork, &fbb)
    IR_Full.add(dataMode: dataMode, &fbb)
    IR_Full.add(entity: entity, &fbb)
    return IR_Full.endIR_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: IR_Full_dataMode_Enum.self)
