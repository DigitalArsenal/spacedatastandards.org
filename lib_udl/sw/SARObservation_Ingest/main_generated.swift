...
public enum SARObservation_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SARObservation_Ingest_dataMode_Enum { return .exercise }
  public static var min: SARObservation_Ingest_dataMode_Enum { return .real }
}
...
public struct SARObservation_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SARObservation_Ingest.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case andims = 78
    case asrid = 80
    case spacingRange = 82
    case spacingAzimuth = 84
    case looksAzimuth = 86
    case looksRange = 88
    case resolutionRange = 90
    case resolutionAzimuth = 92
    case obDirection = 94
    case coordSys = 96
    case targetposx = 98
    case targetposy = 100
    ...
    case senvely = 108
    case senvelz = 110
    case senlatStart = 112
    case senlonStart = 114
    case senlatEnd = 116
    case senlonEnd = 118
    case transactionId = 120
    case tags = 122
    case srcTyps = 124
    case srcIds = 126
    case createdAt = 128
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SARObservation_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SARObservation_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSARObservation_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 69) }
  ...
  public static func add(dataMode: SARObservation_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSARObservation_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSARObservation_Ingest(
    ...
    let __start = SARObservation_Ingest.startSARObservation_Ingest(&fbb)
    SARObservation_Ingest.add(id: id, &fbb)
    SARObservation_Ingest.add(classificationMarking: classificationMarking, &fbb)
    SARObservation_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    SARObservation_Ingest.add(satNo: satNo, &fbb)
    SARObservation_Ingest.add(origObjectId: origObjectId, &fbb)
    SARObservation_Ingest.add(idSensor: idSensor, &fbb)
    SARObservation_Ingest.add(origSensorId: origSensorId, &fbb)
    SARObservation_Ingest.add(externalId: externalId, &fbb)
    SARObservation_Ingest.add(collectionId: collectionId, &fbb)
    SARObservation_Ingest.add(detectionId: detectionId, &fbb)
    SARObservation_Ingest.add(collectionStart: collectionStart, &fbb)
    SARObservation_Ingest.add(collectionEnd: collectionEnd, &fbb)
    SARObservation_Ingest.add(centerTime: centerTime, &fbb)
    SARObservation_Ingest.add(detectionStart: detectionStart, &fbb)
    SARObservation_Ingest.add(detectionEnd: detectionEnd, &fbb)
    SARObservation_Ingest.add(dwellTime: dwellTime, &fbb)
    SARObservation_Ingest.add(orbitState: orbitState, &fbb)
    SARObservation_Ingest.add(sarMode: sarMode, &fbb)
    SARObservation_Ingest.add(operatingBand: operatingBand, &fbb)
    SARObservation_Ingest.add(operatingFreq: operatingFreq, &fbb)
    SARObservation_Ingest.add(snr: snr, &fbb)
    SARObservation_Ingest.add(txPolarization: txPolarization, &fbb)
    SARObservation_Ingest.add(rxPolarization: rxPolarization, &fbb)
    SARObservation_Ingest.add(grazeAngle: grazeAngle, &fbb)
    SARObservation_Ingest.add(incidenceAngle: incidenceAngle, &fbb)
    SARObservation_Ingest.add(squintAngle: squintAngle, &fbb)
    SARObservation_Ingest.add(pulseBandwidth: pulseBandwidth, &fbb)
    SARObservation_Ingest.add(pulseDuration: pulseDuration, &fbb)
    SARObservation_Ingest.add(continuousSpotAngle: continuousSpotAngle, &fbb)
    SARObservation_Ingest.add(slantRange: slantRange, &fbb)
    SARObservation_Ingest.add(nearRange: nearRange, &fbb)
    SARObservation_Ingest.add(farRange: farRange, &fbb)
    SARObservation_Ingest.add(swathLength: swathLength, &fbb)
    SARObservation_Ingest.add(area: area, &fbb)
    SARObservation_Ingest.add(atext: atext, &fbb)
    SARObservation_Ingest.add(agjson: agjson, &fbb)
    SARObservation_Ingest.add(atype: atype, &fbb)
    SARObservation_Ingest.add(andims: andims, &fbb)
    SARObservation_Ingest.add(asrid: asrid, &fbb)
    SARObservation_Ingest.add(spacingRange: spacingRange, &fbb)
    SARObservation_Ingest.add(spacingAzimuth: spacingAzimuth, &fbb)
    SARObservation_Ingest.add(looksAzimuth: looksAzimuth, &fbb)
    SARObservation_Ingest.add(looksRange: looksRange, &fbb)
    SARObservation_Ingest.add(resolutionRange: resolutionRange, &fbb)
    SARObservation_Ingest.add(resolutionAzimuth: resolutionAzimuth, &fbb)
    SARObservation_Ingest.add(obDirection: obDirection, &fbb)
    SARObservation_Ingest.add(coordSys: coordSys, &fbb)
    SARObservation_Ingest.add(targetposx: targetposx, &fbb)
    SARObservation_Ingest.add(targetposy: targetposy, &fbb)
    SARObservation_Ingest.add(targetposz: targetposz, &fbb)
    SARObservation_Ingest.add(senalt: senalt, &fbb)
    SARObservation_Ingest.add(senvelx: senvelx, &fbb)
    SARObservation_Ingest.add(senvely: senvely, &fbb)
    SARObservation_Ingest.add(senvelz: senvelz, &fbb)
    SARObservation_Ingest.add(senlatStart: senlatStart, &fbb)
    SARObservation_Ingest.add(senlonStart: senlonStart, &fbb)
    SARObservation_Ingest.add(senlatEnd: senlatEnd, &fbb)
    SARObservation_Ingest.add(senlonEnd: senlonEnd, &fbb)
    SARObservation_Ingest.add(transactionId: transactionId, &fbb)
    SARObservation_Ingest.addVectorOf(tags: tags, &fbb)
    SARObservation_Ingest.addVectorOf(srcTyps: srcTyps, &fbb)
    SARObservation_Ingest.addVectorOf(srcIds: srcIds, &fbb)
    SARObservation_Ingest.add(createdAt: createdAt, &fbb)
    SARObservation_Ingest.add(createdBy: createdBy, &fbb)
    SARObservation_Ingest.add(source: source, &fbb)
    SARObservation_Ingest.add(origin: origin, &fbb)
    SARObservation_Ingest.add(origNetwork: origNetwork, &fbb)
    SARObservation_Ingest.add(sourceDl: sourceDl, &fbb)
    SARObservation_Ingest.add(dataMode: dataMode, &fbb)
    return SARObservation_Ingest.endSARObservation_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SARObservation_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
