...
public struct IonoObservationDensityProfileIRI_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDensityProfileIRI_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDensityProfileIRI_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 22) }
  ...
  public static func endIonoObservationDensityProfileIRI_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDensityProfileIRI_Full(
    ...
    let __start = IonoObservationDensityProfileIRI_Full.startIonoObservationDensityProfileIRI_Full(&fbb)
    IonoObservationDensityProfileIRI_Full.add(description: description, &fbb)
    IonoObservationDensityProfileIRI_Full.add(nmF2: nmF2, &fbb)
    IonoObservationDensityProfileIRI_Full.add(hmF2: hmF2, &fbb)
    IonoObservationDensityProfileIRI_Full.add(b0: b0, &fbb)
    IonoObservationDensityProfileIRI_Full.add(b1: b1, &fbb)
    IonoObservationDensityProfileIRI_Full.add(nmF1: nmF1, &fbb)
    IonoObservationDensityProfileIRI_Full.add(hmF1: hmF1, &fbb)
    IonoObservationDensityProfileIRI_Full.add(d1: d1, &fbb)
    IonoObservationDensityProfileIRI_Full.add(hz: hz, &fbb)
    IonoObservationDensityProfileIRI_Full.add(hValTop: hValTop, &fbb)
    IonoObservationDensityProfileIRI_Full.add(nValB: nValB, &fbb)
    IonoObservationDensityProfileIRI_Full.add(nmE: nmE, &fbb)
    IonoObservationDensityProfileIRI_Full.add(hmE: hmE, &fbb)
    IonoObservationDensityProfileIRI_Full.add(hdx: hdx, &fbb)
    IonoObservationDensityProfileIRI_Full.add(nmD: nmD, &fbb)
    IonoObservationDensityProfileIRI_Full.add(hmD: hmD, &fbb)
    IonoObservationDensityProfileIRI_Full.add(ha: ha, &fbb)
    IonoObservationDensityProfileIRI_Full.add(fp1: fp1, &fbb)
    IonoObservationDensityProfileIRI_Full.add(fp2: fp2, &fbb)
    IonoObservationDensityProfileIRI_Full.add(fp30: fp30, &fbb)
    IonoObservationDensityProfileIRI_Full.add(fp3U: fp3U, &fbb)
    IonoObservationDensityProfileIRI_Full.add(chi: chi, &fbb)
    return IonoObservationDensityProfileIRI_Full.endIonoObservationDensityProfileIRI_Full(&fbb, start: __start)
  }
