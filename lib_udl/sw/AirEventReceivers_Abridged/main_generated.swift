...
public struct AirEventReceivers_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirEventReceivers_Abridged.id, addPrefix: prefix) }
  ...
  public static func startAirEventReceivers_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 22) }
  ...
  public static func endAirEventReceivers_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirEventReceivers_Abridged(
    ...
    let __start = AirEventReceivers_Abridged.startAirEventReceivers_Abridged(&fbb)
    AirEventReceivers_Abridged.add(idReceiverSortie: idReceiverSortie, &fbb)
    AirEventReceivers_Abridged.add(idReceiverMission: idReceiverMission, &fbb)
    AirEventReceivers_Abridged.add(idReceiverAirfield: idReceiverAirfield, &fbb)
    AirEventReceivers_Abridged.add(externalReceiverId: externalReceiverId, &fbb)
    AirEventReceivers_Abridged.add(receiverCoord: receiverCoord, &fbb)
    AirEventReceivers_Abridged.add(receiverMds: receiverMds, &fbb)
    AirEventReceivers_Abridged.add(amcReceiverMissionId: amcReceiverMissionId, &fbb)
    AirEventReceivers_Abridged.add(altReceiverMissionId: altReceiverMissionId, &fbb)
    AirEventReceivers_Abridged.add(receiverCallSign: receiverCallSign, &fbb)
    AirEventReceivers_Abridged.add(receiverOwner: receiverOwner, &fbb)
    AirEventReceivers_Abridged.add(receiverPoc: receiverPoc, &fbb)
    AirEventReceivers_Abridged.add(receiverLegNum: receiverLegNum, &fbb)
    AirEventReceivers_Abridged.add(receiverDeployedIcao: receiverDeployedIcao, &fbb)
    AirEventReceivers_Abridged.add(receiverDeliveryMethod: receiverDeliveryMethod, &fbb)
    AirEventReceivers_Abridged.add(fuelOn: fuelOn, &fbb)
    AirEventReceivers_Abridged.add(receiverCellPosition: receiverCellPosition, &fbb)
    AirEventReceivers_Abridged.add(sequenceNum: sequenceNum, &fbb)
    AirEventReceivers_Abridged.add(recOrg: recOrg, &fbb)
    AirEventReceivers_Abridged.add(numRecAircraft: numRecAircraft, &fbb)
    AirEventReceivers_Abridged.add(receiverFuelType: receiverFuelType, &fbb)
    AirEventReceivers_Abridged.add(receiverExercise: receiverExercise, &fbb)
    AirEventReceivers_Abridged.add(packageId: packageId, &fbb)
    return AirEventReceivers_Abridged.endAirEventReceivers_Abridged(&fbb, start: __start)
  }
