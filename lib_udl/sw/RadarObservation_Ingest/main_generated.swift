...
public enum RadarObservation_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: RadarObservation_Ingest_dataMode_Enum { return .exercise }
  public static var min: RadarObservation_Ingest_dataMode_Enum { return .real }
}


public enum RadarObservation_Ingest_senReferenceFrame_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: RadarObservation_Ingest_senReferenceFrame_Enum { return .gcrf }
  public static var min: RadarObservation_Ingest_senReferenceFrame_Enum { return .j2000 }
}
...
public struct RadarObservation_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: RadarObservation_Ingest.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case createdAt = 110
    case createdBy = 112
    case senReferenceFrame = 114
    case descriptor = 116
    case origNetwork = 118
    case sourceDl = 120
    case type = 122
  ...
  public var dataMode: RadarObservation_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : RadarObservation_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public var senReferenceFrame: RadarObservation_Ingest_senReferenceFrame_Enum { let o = _accessor.offset(VTOFFSET.senReferenceFrame.v); return o == 0 ? .j2000 : RadarObservation_Ingest_senReferenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ...
  public static func startRadarObservation_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 60) }
  ...
  public static func add(dataMode: RadarObservation_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func add(senReferenceFrame: RadarObservation_Ingest_senReferenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: senReferenceFrame.rawValue, def: 0, at: VTOFFSET.senReferenceFrame.p) }
  ...
  public static func endRadarObservation_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createRadarObservation_Ingest(
    ...
    let __start = RadarObservation_Ingest.startRadarObservation_Ingest(&fbb)
    RadarObservation_Ingest.add(id: id, &fbb)
    RadarObservation_Ingest.add(classificationMarking: classificationMarking, &fbb)
    RadarObservation_Ingest.add(obTime: obTime, &fbb)
    RadarObservation_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    RadarObservation_Ingest.add(idSensor: idSensor, &fbb)
    RadarObservation_Ingest.add(satNo: satNo, &fbb)
    RadarObservation_Ingest.add(taskId: taskId, &fbb)
    RadarObservation_Ingest.add(transactionId: transactionId, &fbb)
    RadarObservation_Ingest.add(trackId: trackId, &fbb)
    RadarObservation_Ingest.add(obPosition: obPosition, &fbb)
    RadarObservation_Ingest.add(origObjectId: origObjectId, &fbb)
    RadarObservation_Ingest.add(origSensorId: origSensorId, &fbb)
    RadarObservation_Ingest.add(uct: uct, &fbb)
    RadarObservation_Ingest.add(azimuth: azimuth, &fbb)
    RadarObservation_Ingest.add(azimuthUnc: azimuthUnc, &fbb)
    RadarObservation_Ingest.add(azimuthBias: azimuthBias, &fbb)
    RadarObservation_Ingest.add(azimuthRate: azimuthRate, &fbb)
    RadarObservation_Ingest.add(elevation: elevation, &fbb)
    RadarObservation_Ingest.add(elevationUnc: elevationUnc, &fbb)
    RadarObservation_Ingest.add(elevationBias: elevationBias, &fbb)
    RadarObservation_Ingest.add(elevationRate: elevationRate, &fbb)
    RadarObservation_Ingest.add(range: range, &fbb)
    RadarObservation_Ingest.add(rangeAccel: rangeAccel, &fbb)
    RadarObservation_Ingest.add(rangeAccelUnc: rangeAccelUnc, &fbb)
    RadarObservation_Ingest.add(rangeUnc: rangeUnc, &fbb)
    RadarObservation_Ingest.add(rangeBias: rangeBias, &fbb)
    RadarObservation_Ingest.add(rangeRate: rangeRate, &fbb)
    RadarObservation_Ingest.add(rangeRateUnc: rangeRateUnc, &fbb)
    RadarObservation_Ingest.add(doppler: doppler, &fbb)
    RadarObservation_Ingest.add(dopplerUnc: dopplerUnc, &fbb)
    RadarObservation_Ingest.add(ra: ra, &fbb)
    RadarObservation_Ingest.add(declination: declination, &fbb)
    RadarObservation_Ingest.add(x: x, &fbb)
    RadarObservation_Ingest.add(y: y, &fbb)
    RadarObservation_Ingest.add(z: z, &fbb)
    RadarObservation_Ingest.add(xvel: xvel, &fbb)
    RadarObservation_Ingest.add(yvel: yvel, &fbb)
    RadarObservation_Ingest.add(zvel: zvel, &fbb)
    RadarObservation_Ingest.add(senx: senx, &fbb)
    RadarObservation_Ingest.add(seny: seny, &fbb)
    RadarObservation_Ingest.add(senz: senz, &fbb)
    RadarObservation_Ingest.add(rcs: rcs, &fbb)
    RadarObservation_Ingest.add(rcsUnc: rcsUnc, &fbb)
    RadarObservation_Ingest.add(orthogonalRcs: orthogonalRcs, &fbb)
    RadarObservation_Ingest.add(orthogonalRcsUnc: orthogonalRcsUnc, &fbb)
    RadarObservation_Ingest.add(snr: snr, &fbb)
    RadarObservation_Ingest.add(beam: beam, &fbb)
    RadarObservation_Ingest.add(timingBias: timingBias, &fbb)
    RadarObservation_Ingest.add(rawFileUri: rawFileUri, &fbb)
    RadarObservation_Ingest.add(source: source, &fbb)
    RadarObservation_Ingest.add(origin: origin, &fbb)
    RadarObservation_Ingest.add(dataMode: dataMode, &fbb)
    RadarObservation_Ingest.addVectorOf(tags: tags, &fbb)
    RadarObservation_Ingest.add(createdAt: createdAt, &fbb)
    RadarObservation_Ingest.add(createdBy: createdBy, &fbb)
    RadarObservation_Ingest.add(senReferenceFrame: senReferenceFrame, &fbb)
    RadarObservation_Ingest.add(descriptor: descriptor, &fbb)
    RadarObservation_Ingest.add(origNetwork: origNetwork, &fbb)
    RadarObservation_Ingest.add(sourceDl: sourceDl, &fbb)
    RadarObservation_Ingest.add(type: type, &fbb)
    return RadarObservation_Ingest.endRadarObservation_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: RadarObservation_Ingest_dataMode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.senReferenceFrame.p, fieldName: "senReferenceFrame", required: false, type: RadarObservation_Ingest_senReferenceFrame_Enum.self)
