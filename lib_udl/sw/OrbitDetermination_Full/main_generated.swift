...
public enum OrbitDetermination_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OrbitDetermination_Full_dataMode_Enum { return .exercise }
  public static var min: OrbitDetermination_Full_dataMode_Enum { return .real }
}
...
public struct OrbitDetermination_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OrbitDetermination_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: OrbitDetermination_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OrbitDetermination_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  ...
  public static func startOrbitDetermination_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 45) }
  ...
  public static func add(dataMode: OrbitDetermination_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(onOrbit: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: onOrbit, at: VTOFFSET.onOrbit.p) }
  public static func endOrbitDetermination_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOrbitDetermination_Full(
    ...
    let __start = OrbitDetermination_Full.startOrbitDetermination_Full(&fbb)
    OrbitDetermination_Full.add(id: id, &fbb)
    OrbitDetermination_Full.add(classificationMarking: classificationMarking, &fbb)
    OrbitDetermination_Full.add(startTime: startTime, &fbb)
    OrbitDetermination_Full.add(endTime: endTime, &fbb)
    OrbitDetermination_Full.add(idOnOrbit: idOnOrbit, &fbb)
    OrbitDetermination_Full.add(origObjectId: origObjectId, &fbb)
    OrbitDetermination_Full.add(satNo: satNo, &fbb)
    OrbitDetermination_Full.add(aprioriIdElset: aprioriIdElset, &fbb)
    OrbitDetermination_Full.add(aprioriElset: aprioriElset, &fbb)
    OrbitDetermination_Full.add(aprioriIdStateVector: aprioriIdStateVector, &fbb)
    OrbitDetermination_Full.add(aprioriStateVector: aprioriStateVector, &fbb)
    OrbitDetermination_Full.add(initialOd: initialOd, &fbb)
    OrbitDetermination_Full.add(lastObStart: lastObStart, &fbb)
    OrbitDetermination_Full.add(lastObEnd: lastObEnd, &fbb)
    OrbitDetermination_Full.add(timeSpan: timeSpan, &fbb)
    OrbitDetermination_Full.add(effectiveFrom: effectiveFrom, &fbb)
    OrbitDetermination_Full.add(effectiveUntil: effectiveUntil, &fbb)
    OrbitDetermination_Full.add(wrms: wrms, &fbb)
    OrbitDetermination_Full.add(previousWrms: previousWrms, &fbb)
    OrbitDetermination_Full.add(firstPassWrms: firstPassWrms, &fbb)
    OrbitDetermination_Full.add(bestPassWrms: bestPassWrms, &fbb)
    OrbitDetermination_Full.add(errorGrowthRate: errorGrowthRate, &fbb)
    OrbitDetermination_Full.add(edr: edr, &fbb)
    OrbitDetermination_Full.add(method: method, &fbb)
    OrbitDetermination_Full.add(methodSource: methodSource, &fbb)
    OrbitDetermination_Full.add(fitSpan: fitSpan, &fbb)
    OrbitDetermination_Full.add(ballisticCoeffEst: ballisticCoeffEst, &fbb)
    OrbitDetermination_Full.add(ballisticCoeffModel: ballisticCoeffModel, &fbb)
    OrbitDetermination_Full.add(agomEst: agomEst, &fbb)
    OrbitDetermination_Full.add(agomModel: agomModel, &fbb)
    OrbitDetermination_Full.add(rmsConvergenceCriteria: rmsConvergenceCriteria, &fbb)
    OrbitDetermination_Full.add(numIterations: numIterations, &fbb)
    OrbitDetermination_Full.addVectorOf(acceptedObTyps: acceptedObTyps, &fbb)
    OrbitDetermination_Full.addVectorOf(acceptedObIds: acceptedObIds, &fbb)
    OrbitDetermination_Full.addVectorOf(rejectedObTyps: rejectedObTyps, &fbb)
    OrbitDetermination_Full.addVectorOf(rejectedObIds: rejectedObIds, &fbb)
    OrbitDetermination_Full.addVectorOf(sensorIds: sensorIds, &fbb)
    OrbitDetermination_Full.add(createdAt: createdAt, &fbb)
    OrbitDetermination_Full.add(createdBy: createdBy, &fbb)
    OrbitDetermination_Full.add(sourceDl: sourceDl, &fbb)
    OrbitDetermination_Full.add(source: source, &fbb)
    OrbitDetermination_Full.add(origin: origin, &fbb)
    OrbitDetermination_Full.add(origNetwork: origNetwork, &fbb)
    OrbitDetermination_Full.add(dataMode: dataMode, &fbb)
    OrbitDetermination_Full.add(onOrbit: onOrbit, &fbb)
    return OrbitDetermination_Full.endOrbitDetermination_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OrbitDetermination_Full_dataMode_Enum.self)
