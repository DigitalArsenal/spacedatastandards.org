...
public enum AntennaDetails_Full_mode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AntennaDetails_Full_mode_Enum { return .rx }
  public static var min: AntennaDetails_Full_mode_Enum { return .tx }
}


public enum AntennaDetails_Full_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: AntennaDetails_Full_dataMode_Enum { return .exercise }
  public static var min: AntennaDetails_Full_dataMode_Enum { return .real }
}
...
public struct AntennaDetails_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AntennaDetails_Full.id, addPrefix: prefix) }
  ...
  public var mode: AntennaDetails_Full_mode_Enum { let o = _accessor.offset(VTOFFSET.mode.v); return o == 0 ? .tx : AntennaDetails_Full_mode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .tx }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: AntennaDetails_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AntennaDetails_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startAntennaDetails_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 28) }
  ...
  public static func add(mode: AntennaDetails_Full_mode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: mode.rawValue, def: 0, at: VTOFFSET.mode.p) }
  ...
  public static func add(dataMode: AntennaDetails_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endAntennaDetails_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAntennaDetails_Full(
    ...
    let __start = AntennaDetails_Full.startAntennaDetails_Full(&fbb)
    AntennaDetails_Full.add(id: id, &fbb)
    AntennaDetails_Full.add(idAntenna: idAntenna, &fbb)
    AntennaDetails_Full.add(classificationMarking: classificationMarking, &fbb)
    AntennaDetails_Full.add(type: type, &fbb)
    AntennaDetails_Full.add(position: position, &fbb)
    AntennaDetails_Full.add(mode: mode, &fbb)
    AntennaDetails_Full.add(steerable: steerable, &fbb)
    AntennaDetails_Full.add(beamForming: beamForming, &fbb)
    AntennaDetails_Full.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    AntennaDetails_Full.add(diameter: diameter, &fbb)
    AntennaDetails_Full.addVectorOf(size: size, &fbb)
    AntennaDetails_Full.add(startFrequency: startFrequency, &fbb)
    AntennaDetails_Full.add(endFrequency: endFrequency, &fbb)
    AntennaDetails_Full.add(beamwidth: beamwidth, &fbb)
    AntennaDetails_Full.add(gain: gain, &fbb)
    AntennaDetails_Full.add(gainTolerance: gainTolerance, &fbb)
    AntennaDetails_Full.add(polarization: polarization, &fbb)
    AntennaDetails_Full.add(description: description, &fbb)
    AntennaDetails_Full.add(createdAt: createdAt, &fbb)
    AntennaDetails_Full.add(createdBy: createdBy, &fbb)
    AntennaDetails_Full.add(updatedAt: updatedAt, &fbb)
    AntennaDetails_Full.add(updatedBy: updatedBy, &fbb)
    AntennaDetails_Full.add(source: source, &fbb)
    AntennaDetails_Full.add(origin: origin, &fbb)
    AntennaDetails_Full.add(origNetwork: origNetwork, &fbb)
    AntennaDetails_Full.add(dataMode: dataMode, &fbb)
    AntennaDetails_Full.addVectorOf(tags: tags, &fbb)
    AntennaDetails_Full.add(manufacturerOrg: manufacturerOrg, &fbb)
    return AntennaDetails_Full.endAntennaDetails_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.mode.p, fieldName: "mode", required: false, type: AntennaDetails_Full_mode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AntennaDetails_Full_dataMode_Enum.self)
