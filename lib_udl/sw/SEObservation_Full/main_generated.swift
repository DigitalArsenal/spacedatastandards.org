...
public struct SEObservation_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SEObservation_Full.id, addPrefix: prefix) }
  ...
  public static func startSEObservation_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 8) }
  ...
  public static func endSEObservation_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSEObservation_Full(
    ...
    let __start = SEObservation_Full.startSEObservation_Full(&fbb)
    SEObservation_Full.add(obType: obType, &fbb)
    SEObservation_Full.add(obUoM: obUoM, &fbb)
    SEObservation_Full.add(obValue: obValue, &fbb)
    SEObservation_Full.add(obString: obString, &fbb)
    SEObservation_Full.addVectorOf(obArray: obArray, &fbb)
    SEObservation_Full.add(obBool: obBool, &fbb)
    SEObservation_Full.add(obQuality: obQuality, &fbb)
    SEObservation_Full.add(obDescription: obDescription, &fbb)
    return SEObservation_Full.endSEObservation_Full(&fbb, start: __start)
  }
