...
public struct IonoObservationDensityProfileTopsideExtensionChapmanConst_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDensityProfileTopsideExtensionChapmanConst_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDensityProfileTopsideExtensionChapmanConst_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endIonoObservationDensityProfileTopsideExtensionChapmanConst_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDensityProfileTopsideExtensionChapmanConst_Full(
    ...
    let __start = IonoObservationDensityProfileTopsideExtensionChapmanConst_Full.startIonoObservationDensityProfileTopsideExtensionChapmanConst_Full(&fbb)
    IonoObservationDensityProfileTopsideExtensionChapmanConst_Full.add(description: description, &fbb)
    IonoObservationDensityProfileTopsideExtensionChapmanConst_Full.add(nmF2: nmF2, &fbb)
    IonoObservationDensityProfileTopsideExtensionChapmanConst_Full.add(hmF2: hmF2, &fbb)
    IonoObservationDensityProfileTopsideExtensionChapmanConst_Full.add(scaleF2: scaleF2, &fbb)
    IonoObservationDensityProfileTopsideExtensionChapmanConst_Full.add(chi: chi, &fbb)
    return IonoObservationDensityProfileTopsideExtensionChapmanConst_Full.endIonoObservationDensityProfileTopsideExtensionChapmanConst_Full(&fbb, start: __start)
  }
