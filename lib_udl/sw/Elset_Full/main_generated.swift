...
public enum Elset_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Elset_Full_dataMode_Enum { return .exercise }
  public static var min: Elset_Full_dataMode_Enum { return .real }
}


public enum Elset_Full_sourcedDataTypes_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: Elset_Full_sourcedDataTypes_Enum { return .sv }
  public static var min: Elset_Full_sourcedDataTypes_Enum { return .eo }
}
...
public struct Elset_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Elset_Full.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case effectiveFrom = 52
    case effectiveUntil = 54
    case line1 = 56
    case line2 = 58
    case descriptor = 60
    case createdAt = 62
  ...
  public var dataMode: Elset_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Elset_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Constraints: No constraints specified.
  public var sourcedDataTypes: Elset_Full_sourcedDataTypes_Enum { let o = _accessor.offset(VTOFFSET.sourcedDataTypes.v); return o == 0 ? .eo : Elset_Full_sourcedDataTypes_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .eo }
  ...
  public static func startElset_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 44) }
  ...
  public static func add(dataMode: Elset_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func add(sourcedDataTypes: Elset_Full_sourcedDataTypes_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: sourcedDataTypes.rawValue, def: 0, at: VTOFFSET.sourcedDataTypes.p) }
  ...
  public static func endElset_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createElset_Full(
    ...
    let __start = Elset_Full.startElset_Full(&fbb)
    Elset_Full.add(idElset: idElset, &fbb)
    Elset_Full.add(classificationMarking: classificationMarking, &fbb)
    Elset_Full.add(satNo: satNo, &fbb)
    Elset_Full.add(epoch: epoch, &fbb)
    Elset_Full.add(meanMotion: meanMotion, &fbb)
    Elset_Full.add(idOnOrbit: idOnOrbit, &fbb)
    Elset_Full.add(uct: uct, &fbb)
    Elset_Full.add(eccentricity: eccentricity, &fbb)
    Elset_Full.add(inclination: inclination, &fbb)
    Elset_Full.add(raan: raan, &fbb)
    Elset_Full.add(argOfPerigee: argOfPerigee, &fbb)
    Elset_Full.add(meanAnomaly: meanAnomaly, &fbb)
    Elset_Full.add(revNo: revNo, &fbb)
    Elset_Full.add(bStar: bStar, &fbb)
    Elset_Full.add(agom: agom, &fbb)
    Elset_Full.add(ballisticCoeff: ballisticCoeff, &fbb)
    Elset_Full.add(meanMotionDot: meanMotionDot, &fbb)
    Elset_Full.add(meanMotionDdot: meanMotionDdot, &fbb)
    Elset_Full.add(semiMajorAxis: semiMajorAxis, &fbb)
    Elset_Full.add(period: period, &fbb)
    Elset_Full.add(apogee: apogee, &fbb)
    Elset_Full.add(perigee: perigee, &fbb)
    Elset_Full.add(origObjectId: origObjectId, &fbb)
    Elset_Full.add(idOrbitDetermination: idOrbitDetermination, &fbb)
    Elset_Full.add(effectiveFrom: effectiveFrom, &fbb)
    Elset_Full.add(effectiveUntil: effectiveUntil, &fbb)
    Elset_Full.add(line1: line1, &fbb)
    Elset_Full.add(line2: line2, &fbb)
    Elset_Full.add(descriptor: descriptor, &fbb)
    Elset_Full.add(createdAt: createdAt, &fbb)
    Elset_Full.add(createdBy: createdBy, &fbb)
    Elset_Full.add(rawFileUri: rawFileUri, &fbb)
    Elset_Full.add(origin: origin, &fbb)
    Elset_Full.add(sourceDl: sourceDl, &fbb)
    Elset_Full.add(source: source, &fbb)
    Elset_Full.add(dataMode: dataMode, &fbb)
    Elset_Full.addVectorOf(tags: tags, &fbb)
    Elset_Full.add(algorithm: algorithm, &fbb)
    Elset_Full.addVectorOf(sourcedData: sourcedData, &fbb)
    Elset_Full.add(sourcedDataTypes: sourcedDataTypes, &fbb)
    Elset_Full.add(transactionId: transactionId, &fbb)
    Elset_Full.add(ephemType: ephemType, &fbb)
    Elset_Full.add(origNetwork: origNetwork, &fbb)
    Elset_Full.add(onOrbit: onOrbit, &fbb)
    return Elset_Full.endElset_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Elset_Full_dataMode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.sourcedDataTypes.p, fieldName: "sourcedDataTypes", required: false, type: Elset_Full_sourcedDataTypes_Enum.self)
