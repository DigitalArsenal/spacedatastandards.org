...
public enum SensorMaintenance_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SensorMaintenance_Abridged_dataMode_Enum { return .exercise }
  public static var min: SensorMaintenance_Abridged_dataMode_Enum { return .real }
}


///  /// Maintenance schedule and operational status of Sensor.
public struct SensorMaintenance_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SensorMaintenance_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: SensorMaintenance_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SensorMaintenance_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startSensorMaintenance_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 31) }
  ...
  public static func add(dataMode: SensorMaintenance_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endSensorMaintenance_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSensorMaintenance_Abridged(
    ...
    let __start = SensorMaintenance_Abridged.startSensorMaintenance_Abridged(&fbb)
    SensorMaintenance_Abridged.add(id: id, &fbb)
    SensorMaintenance_Abridged.add(classificationMarking: classificationMarking, &fbb)
    SensorMaintenance_Abridged.add(siteCode: siteCode, &fbb)
    SensorMaintenance_Abridged.add(idSensor: idSensor, &fbb)
    SensorMaintenance_Abridged.add(startTime: startTime, &fbb)
    SensorMaintenance_Abridged.add(endTime: endTime, &fbb)
    SensorMaintenance_Abridged.add(recall: recall, &fbb)
    SensorMaintenance_Abridged.add(duration: duration, &fbb)
    SensorMaintenance_Abridged.add(mwOpsCap: mwOpsCap, &fbb)
    SensorMaintenance_Abridged.add(ssOpsCap: ssOpsCap, &fbb)
    SensorMaintenance_Abridged.add(mdOpsCap: mdOpsCap, &fbb)
    SensorMaintenance_Abridged.add(impactedFaces: impactedFaces, &fbb)
    SensorMaintenance_Abridged.add(equipStatus: equipStatus, &fbb)
    SensorMaintenance_Abridged.add(activity: activity, &fbb)
    SensorMaintenance_Abridged.add(remark: remark, &fbb)
    SensorMaintenance_Abridged.add(requestor: requestor, &fbb)
    SensorMaintenance_Abridged.add(changer: changer, &fbb)
    SensorMaintenance_Abridged.add(approver: approver, &fbb)
    SensorMaintenance_Abridged.add(eowId: eowId, &fbb)
    SensorMaintenance_Abridged.add(rev: rev, &fbb)
    SensorMaintenance_Abridged.add(priority: priority, &fbb)
    SensorMaintenance_Abridged.add(rel: rel, &fbb)
    SensorMaintenance_Abridged.add(lineNumber: lineNumber, &fbb)
    SensorMaintenance_Abridged.add(resource: resource, &fbb)
    SensorMaintenance_Abridged.add(inactiveDate: inactiveDate, &fbb)
    SensorMaintenance_Abridged.add(createdAt: createdAt, &fbb)
    SensorMaintenance_Abridged.add(createdBy: createdBy, &fbb)
    SensorMaintenance_Abridged.add(source: source, &fbb)
    SensorMaintenance_Abridged.add(origin: origin, &fbb)
    SensorMaintenance_Abridged.add(dataMode: dataMode, &fbb)
    SensorMaintenance_Abridged.add(origNetwork: origNetwork, &fbb)
    return SensorMaintenance_Abridged.endSensorMaintenance_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SensorMaintenance_Abridged_dataMode_Enum.self)
