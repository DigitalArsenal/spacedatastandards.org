...
public enum OnorbitDetails_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OnorbitDetails_Abridged_dataMode_Enum { return .exercise }
  public static var min: OnorbitDetails_Abridged_dataMode_Enum { return .real }
}


///  /// Contains details of the OnOrbit object.
public struct OnorbitDetails_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OnorbitDetails_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: OnorbitDetails_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OnorbitDetails_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOnorbitDetails_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 48) }
  ...
  public static func add(dataMode: OnorbitDetails_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endOnorbitDetails_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnorbitDetails_Abridged(
    ...
    let __start = OnorbitDetails_Abridged.startOnorbitDetails_Abridged(&fbb)
    OnorbitDetails_Abridged.add(id: id, &fbb)
    OnorbitDetails_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    OnorbitDetails_Abridged.add(classificationMarking: classificationMarking, &fbb)
    OnorbitDetails_Abridged.add(lastObTime: lastObTime, &fbb)
    OnorbitDetails_Abridged.add(vismag: vismag, &fbb)
    OnorbitDetails_Abridged.add(vismagMin: vismagMin, &fbb)
    OnorbitDetails_Abridged.add(vismagMax: vismagMax, &fbb)
    OnorbitDetails_Abridged.add(vismagMean: vismagMean, &fbb)
    OnorbitDetails_Abridged.add(rcs: rcs, &fbb)
    OnorbitDetails_Abridged.add(rcsMin: rcsMin, &fbb)
    OnorbitDetails_Abridged.add(rcsMax: rcsMax, &fbb)
    OnorbitDetails_Abridged.add(rcsMean: rcsMean, &fbb)
    OnorbitDetails_Abridged.add(bolDeltaV: bolDeltaV, &fbb)
    OnorbitDetails_Abridged.add(maxDeltaV: maxDeltaV, &fbb)
    OnorbitDetails_Abridged.add(deltaVunc: deltaVunc, &fbb)
    OnorbitDetails_Abridged.add(estDeltaVduration: estDeltaVduration, &fbb)
    OnorbitDetails_Abridged.add(numMission: numMission, &fbb)
    OnorbitDetails_Abridged.addVectorOf(missionTypes: missionTypes, &fbb)
    OnorbitDetails_Abridged.add(busType: busType, &fbb)
    OnorbitDetails_Abridged.add(geoSlot: geoSlot, &fbb)
    OnorbitDetails_Abridged.add(driftRate: driftRate, &fbb)
    OnorbitDetails_Abridged.add(dryMass: dryMass, &fbb)
    OnorbitDetails_Abridged.add(additionalMass: additionalMass, &fbb)
    OnorbitDetails_Abridged.add(launchMassMin: launchMassMin, &fbb)
    OnorbitDetails_Abridged.add(launchMass: launchMass, &fbb)
    OnorbitDetails_Abridged.add(launchMassMax: launchMassMax, &fbb)
    OnorbitDetails_Abridged.add(bolFuelMass: bolFuelMass, &fbb)
    OnorbitDetails_Abridged.add(currentMass: currentMass, &fbb)
    OnorbitDetails_Abridged.add(totalMassUnc: totalMassUnc, &fbb)
    OnorbitDetails_Abridged.add(solarArrayArea: solarArrayArea, &fbb)
    OnorbitDetails_Abridged.add(maneuverable: maneuverable, &fbb)
    OnorbitDetails_Abridged.add(fuelRemaining: fuelRemaining, &fbb)
    OnorbitDetails_Abridged.add(crossSection: crossSection, &fbb)
    OnorbitDetails_Abridged.add(busCrossSection: busCrossSection, &fbb)
    OnorbitDetails_Abridged.add(maxRadius: maxRadius, &fbb)
    OnorbitDetails_Abridged.add(colaRadius: colaRadius, &fbb)
    OnorbitDetails_Abridged.add(adeptRadius: adeptRadius, &fbb)
    OnorbitDetails_Abridged.add(numDeployable: numDeployable, &fbb)
    OnorbitDetails_Abridged.addVectorOf(depNames: depNames, &fbb)
    OnorbitDetails_Abridged.addVectorOf(depEstMasses: depEstMasses, &fbb)
    OnorbitDetails_Abridged.addVectorOf(depMassUncs: depMassUncs, &fbb)
    OnorbitDetails_Abridged.add(source: source, &fbb)
    OnorbitDetails_Abridged.add(origin: origin, &fbb)
    OnorbitDetails_Abridged.add(lastObSource: lastObSource, &fbb)
    OnorbitDetails_Abridged.add(dataMode: dataMode, &fbb)
    OnorbitDetails_Abridged.add(createdAt: createdAt, &fbb)
    OnorbitDetails_Abridged.add(createdBy: createdBy, &fbb)
    OnorbitDetails_Abridged.add(origNetwork: origNetwork, &fbb)
    return OnorbitDetails_Abridged.endOnorbitDetails_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OnorbitDetails_Abridged_dataMode_Enum.self)
