...
public enum SensorStats_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SensorStats_Abridged_dataMode_Enum { return .exercise }
  public static var min: SensorStats_Abridged_dataMode_Enum { return .real }
}


///  /// SensorStats contain statistics on sensors related to observation production such as last reported observation time.
public struct SensorStats_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SensorStats_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: SensorStats_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SensorStats_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSensorStats_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 10) }
  ...
  public static func add(dataMode: SensorStats_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSensorStats_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSensorStats_Abridged(
    ...
    let __start = SensorStats_Abridged.startSensorStats_Abridged(&fbb)
    SensorStats_Abridged.add(id: id, &fbb)
    SensorStats_Abridged.add(idSensor: idSensor, &fbb)
    SensorStats_Abridged.add(classificationMarking: classificationMarking, &fbb)
    SensorStats_Abridged.add(lastObTime: lastObTime, &fbb)
    SensorStats_Abridged.add(createdAt: createdAt, &fbb)
    SensorStats_Abridged.add(createdBy: createdBy, &fbb)
    SensorStats_Abridged.add(updatedAt: updatedAt, &fbb)
    SensorStats_Abridged.add(updatedBy: updatedBy, &fbb)
    SensorStats_Abridged.add(source: source, &fbb)
    SensorStats_Abridged.add(dataMode: dataMode, &fbb)
    return SensorStats_Abridged.endSensorStats_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SensorStats_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
