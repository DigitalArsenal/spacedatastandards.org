...
public struct IonoObservationDensityProfileTopsideExtensionVaryChap_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDensityProfileTopsideExtensionVaryChap_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDensityProfileTopsideExtensionVaryChap_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 8) }
  ...
  public static func endIonoObservationDensityProfileTopsideExtensionVaryChap_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDensityProfileTopsideExtensionVaryChap_Full(
    ...
    let __start = IonoObservationDensityProfileTopsideExtensionVaryChap_Full.startIonoObservationDensityProfileTopsideExtensionVaryChap_Full(&fbb)
    IonoObservationDensityProfileTopsideExtensionVaryChap_Full.add(description: description, &fbb)
    IonoObservationDensityProfileTopsideExtensionVaryChap_Full.add(nmF2: nmF2, &fbb)
    IonoObservationDensityProfileTopsideExtensionVaryChap_Full.add(hmF2: hmF2, &fbb)
    IonoObservationDensityProfileTopsideExtensionVaryChap_Full.add(scaleF2: scaleF2, &fbb)
    IonoObservationDensityProfileTopsideExtensionVaryChap_Full.add(alpha: alpha, &fbb)
    IonoObservationDensityProfileTopsideExtensionVaryChap_Full.add(beta: beta, &fbb)
    IonoObservationDensityProfileTopsideExtensionVaryChap_Full.add(ht: ht, &fbb)
    IonoObservationDensityProfileTopsideExtensionVaryChap_Full.add(chi: chi, &fbb)
    return IonoObservationDensityProfileTopsideExtensionVaryChap_Full.endIonoObservationDensityProfileTopsideExtensionVaryChap_Full(&fbb, start: __start)
  }
