...
public enum SiteStatus_Abridged_instStatus_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SiteStatus_Abridged_instStatus_Enum { return .unk }
  public static var min: SiteStatus_Abridged_instStatus_Enum { return .fmc }
}


public enum SiteStatus_Abridged_fpcon_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: SiteStatus_Abridged_fpcon_Enum { return .delta }
  public static var min: SiteStatus_Abridged_fpcon_Enum { return .normal }
}


public enum SiteStatus_Abridged_hpcon_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: SiteStatus_Abridged_hpcon_Enum { return .delta }
  public static var min: SiteStatus_Abridged_hpcon_Enum { return .e0 }
}


public enum SiteStatus_Abridged_cpcon_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: SiteStatus_Abridged_cpcon_Enum { return .e5 }
  public static var min: SiteStatus_Abridged_cpcon_Enum { return .e1 }
}


public enum SiteStatus_Abridged_cat_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: SiteStatus_Abridged_cat_Enum { return .hot }
  public static var min: SiteStatus_Abridged_cat_Enum { return .cold }
}


public enum SiteStatus_Abridged_eoc_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: SiteStatus_Abridged_eoc_Enum { return .hot }
  public static var min: SiteStatus_Abridged_eoc_Enum { return .cold }
}


public enum SiteStatus_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: SiteStatus_Abridged_dataMode_Enum { return .exercise }
  public static var min: SiteStatus_Abridged_dataMode_Enum { return .real }
}


///  /// No description available.
public struct SiteStatus_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SiteStatus_Abridged.id, addPrefix: prefix) }
  ...
  public var instStatus: SiteStatus_Abridged_instStatus_Enum { let o = _accessor.offset(VTOFFSET.instStatus.v); return o == 0 ? .fmc : SiteStatus_Abridged_instStatus_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .fmc }
  ...
  public var fpcon: SiteStatus_Abridged_fpcon_Enum { let o = _accessor.offset(VTOFFSET.fpcon.v); return o == 0 ? .normal : SiteStatus_Abridged_fpcon_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .normal }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 7
  public var hpcon: SiteStatus_Abridged_hpcon_Enum { let o = _accessor.offset(VTOFFSET.hpcon.v); return o == 0 ? .e0 : SiteStatus_Abridged_hpcon_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .e0 }
  ...
  public var cpcon: SiteStatus_Abridged_cpcon_Enum { let o = _accessor.offset(VTOFFSET.cpcon.v); return o == 0 ? .e1 : SiteStatus_Abridged_cpcon_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .e1 }
  ...
  public var cat: SiteStatus_Abridged_cat_Enum { let o = _accessor.offset(VTOFFSET.cat.v); return o == 0 ? .cold : SiteStatus_Abridged_cat_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .cold }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 4
  public var eoc: SiteStatus_Abridged_eoc_Enum { let o = _accessor.offset(VTOFFSET.eoc.v); return o == 0 ? .cold : SiteStatus_Abridged_eoc_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .cold }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SiteStatus_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SiteStatus_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSiteStatus_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 37) }
  ...
  public static func add(instStatus: SiteStatus_Abridged_instStatus_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: instStatus.rawValue, def: 0, at: VTOFFSET.instStatus.p) }
  public static func add(fpcon: SiteStatus_Abridged_fpcon_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: fpcon.rawValue, def: 0, at: VTOFFSET.fpcon.p) }
  public static func add(hpcon: SiteStatus_Abridged_hpcon_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: hpcon.rawValue, def: 0, at: VTOFFSET.hpcon.p) }
  public static func add(cpcon: SiteStatus_Abridged_cpcon_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: cpcon.rawValue, def: 0, at: VTOFFSET.cpcon.p) }
  ...
  public static func add(cat: SiteStatus_Abridged_cat_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: cat.rawValue, def: 0, at: VTOFFSET.cat.p) }
  public static func add(eoc: SiteStatus_Abridged_eoc_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: eoc.rawValue, def: 0, at: VTOFFSET.eoc.p) }
  ...
  public static func add(dataMode: SiteStatus_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSiteStatus_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSiteStatus_Abridged(
    ...
    let __start = SiteStatus_Abridged.startSiteStatus_Abridged(&fbb)
    SiteStatus_Abridged.add(id: id, &fbb)
    SiteStatus_Abridged.add(classificationMarking: classificationMarking, &fbb)
    SiteStatus_Abridged.add(idSite: idSite, &fbb)
    SiteStatus_Abridged.add(siteType: siteType, &fbb)
    SiteStatus_Abridged.add(mobileAltId: mobileAltId, &fbb)
    SiteStatus_Abridged.add(poiid: poiid, &fbb)
    SiteStatus_Abridged.add(trackId: trackId, &fbb)
    SiteStatus_Abridged.add(trackRefL16: trackRefL16, &fbb)
    SiteStatus_Abridged.add(opsCapability: opsCapability, &fbb)
    SiteStatus_Abridged.add(instStatus: instStatus, &fbb)
    SiteStatus_Abridged.add(fpcon: fpcon, &fbb)
    SiteStatus_Abridged.add(hpcon: hpcon, &fbb)
    SiteStatus_Abridged.add(cpcon: cpcon, &fbb)
    SiteStatus_Abridged.add(reportTime: reportTime, &fbb)
    SiteStatus_Abridged.add(timeFunction: timeFunction, &fbb)
    SiteStatus_Abridged.add(weatherMessage: weatherMessage, &fbb)
    SiteStatus_Abridged.add(pes: pes, &fbb)
    SiteStatus_Abridged.add(hotInventory: hotInventory, &fbb)
    SiteStatus_Abridged.add(coldInventory: coldInventory, &fbb)
    SiteStatus_Abridged.add(samMode: samMode, &fbb)
    SiteStatus_Abridged.add(radiateMode: radiateMode, &fbb)
    SiteStatus_Abridged.add(opsImpairment: opsImpairment, &fbb)
    SiteStatus_Abridged.add(commImpairment: commImpairment, &fbb)
    SiteStatus_Abridged.add(cat: cat, &fbb)
    SiteStatus_Abridged.add(eoc: eoc, &fbb)
    SiteStatus_Abridged.addVectorOf(link: link, &fbb)
    SiteStatus_Abridged.addVectorOf(linkStatus: linkStatus, &fbb)
    SiteStatus_Abridged.addVectorOf(radarSystem: radarSystem, &fbb)
    SiteStatus_Abridged.addVectorOf(radarStatus: radarStatus, &fbb)
    SiteStatus_Abridged.addVectorOf(missile: missile, &fbb)
    SiteStatus_Abridged.addVectorOf(missileInventory: missileInventory, &fbb)
    SiteStatus_Abridged.add(createdAt: createdAt, &fbb)
    SiteStatus_Abridged.add(createdBy: createdBy, &fbb)
    SiteStatus_Abridged.add(source: source, &fbb)
    SiteStatus_Abridged.add(origin: origin, &fbb)
    SiteStatus_Abridged.add(origNetwork: origNetwork, &fbb)
    SiteStatus_Abridged.add(dataMode: dataMode, &fbb)
    return SiteStatus_Abridged.endSiteStatus_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.instStatus.p, fieldName: "instStatus", required: false, type: SiteStatus_Abridged_instStatus_Enum.self)
    try _v.visit(field: VTOFFSET.fpcon.p, fieldName: "fpcon", required: false, type: SiteStatus_Abridged_fpcon_Enum.self)
    try _v.visit(field: VTOFFSET.hpcon.p, fieldName: "hpcon", required: false, type: SiteStatus_Abridged_hpcon_Enum.self)
    try _v.visit(field: VTOFFSET.cpcon.p, fieldName: "cpcon", required: false, type: SiteStatus_Abridged_cpcon_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.cat.p, fieldName: "cat", required: false, type: SiteStatus_Abridged_cat_Enum.self)
    try _v.visit(field: VTOFFSET.eoc.p, fieldName: "eoc", required: false, type: SiteStatus_Abridged_eoc_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SiteStatus_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
