...
public enum Sensorcharacteristics_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Sensorcharacteristics_Abridged_dataMode_Enum { return .exercise }
  public static var min: Sensorcharacteristics_Abridged_dataMode_Enum { return .real }
}


///  /// Model representation of characteristics and capabilities of a sensor.
public struct Sensorcharacteristics_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Sensorcharacteristics_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Sensorcharacteristics_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Sensorcharacteristics_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startSensorcharacteristics_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 54) }
  ...
  public static func add(dataMode: Sensorcharacteristics_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func endSensorcharacteristics_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSensorcharacteristics_Abridged(
    ...
    let __start = Sensorcharacteristics_Abridged.startSensorcharacteristics_Abridged(&fbb)
    Sensorcharacteristics_Abridged.add(id: id, &fbb)
    Sensorcharacteristics_Abridged.add(idSensor: idSensor, &fbb)
    Sensorcharacteristics_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Sensorcharacteristics_Abridged.add(origNetwork: origNetwork, &fbb)
    Sensorcharacteristics_Abridged.add(azimuthRate: azimuthRate, &fbb)
    Sensorcharacteristics_Abridged.add(elevationRateGeolm: elevationRateGeolm, &fbb)
    Sensorcharacteristics_Abridged.add(minRangeLimit: minRangeLimit, &fbb)
    Sensorcharacteristics_Abridged.add(maxRangeLimit: maxRangeLimit, &fbb)
    Sensorcharacteristics_Abridged.add(leftClockAngle: leftClockAngle, &fbb)
    Sensorcharacteristics_Abridged.add(rightClockAngle: rightClockAngle, &fbb)
    Sensorcharacteristics_Abridged.add(boresight: boresight, &fbb)
    Sensorcharacteristics_Abridged.add(boresightOffAngle: boresightOffAngle, &fbb)
    Sensorcharacteristics_Abridged.add(negativeRangeRateLimit: negativeRangeRateLimit, &fbb)
    Sensorcharacteristics_Abridged.add(positiveRangeRateLimit: positiveRangeRateLimit, &fbb)
    Sensorcharacteristics_Abridged.add(magnitudeLimit: magnitudeLimit, &fbb)
    Sensorcharacteristics_Abridged.add(trackAngle: trackAngle, &fbb)
    Sensorcharacteristics_Abridged.add(minSignalNoiseRatio: minSignalNoiseRatio, &fbb)
    Sensorcharacteristics_Abridged.add(fanBeamWidth: fanBeamWidth, &fbb)
    Sensorcharacteristics_Abridged.add(taskableRange: taskableRange, &fbb)
    Sensorcharacteristics_Abridged.add(maxObservableRange: maxObservableRange, &fbb)
    Sensorcharacteristics_Abridged.add(radioFrequency: radioFrequency, &fbb)
    Sensorcharacteristics_Abridged.add(radarFrequency: radarFrequency, &fbb)
    Sensorcharacteristics_Abridged.add(transmitPower: transmitPower, &fbb)
    Sensorcharacteristics_Abridged.add(hFov: hFov, &fbb)
    Sensorcharacteristics_Abridged.add(vFov: vFov, &fbb)
    Sensorcharacteristics_Abridged.add(hResPixels: hResPixels, &fbb)
    Sensorcharacteristics_Abridged.add(vResPixels: vResPixels, &fbb)
    Sensorcharacteristics_Abridged.add(band: band, &fbb)
    Sensorcharacteristics_Abridged.add(maxDeviationAngle: maxDeviationAngle, &fbb)
    Sensorcharacteristics_Abridged.add(aperture: aperture, &fbb)
    Sensorcharacteristics_Abridged.add(leftGeoBeltLimit: leftGeoBeltLimit, &fbb)
    Sensorcharacteristics_Abridged.add(rightGeoBeltLimit: rightGeoBeltLimit, &fbb)
    Sensorcharacteristics_Abridged.add(asrScanRate: asrScanRate, &fbb)
    Sensorcharacteristics_Abridged.add(k: k, &fbb)
    Sensorcharacteristics_Abridged.add(focalPoint: focalPoint, &fbb)
    Sensorcharacteristics_Abridged.add(towerHeight: towerHeight, &fbb)
    Sensorcharacteristics_Abridged.add(trueNorthCorrector: trueNorthCorrector, &fbb)
    Sensorcharacteristics_Abridged.add(magDec: magDec, &fbb)
    Sensorcharacteristics_Abridged.add(z1MinRange: z1MinRange, &fbb)
    Sensorcharacteristics_Abridged.add(z2MinRange: z2MinRange, &fbb)
    Sensorcharacteristics_Abridged.add(z1MaxRange: z1MaxRange, &fbb)
    Sensorcharacteristics_Abridged.add(z2MaxRange: z2MaxRange, &fbb)
    Sensorcharacteristics_Abridged.add(radarMur: radarMur, &fbb)
    Sensorcharacteristics_Abridged.add(probFalseAlarm: probFalseAlarm, &fbb)
    Sensorcharacteristics_Abridged.add(prf: prf, &fbb)
    Sensorcharacteristics_Abridged.add(radarPulseWidth: radarPulseWidth, &fbb)
    Sensorcharacteristics_Abridged.add(numIntegratedPulses: numIntegratedPulses, &fbb)
    Sensorcharacteristics_Abridged.add(trueTilt: trueTilt, &fbb)
    Sensorcharacteristics_Abridged.add(radarMessageFormat: radarMessageFormat, &fbb)
    Sensorcharacteristics_Abridged.add(systemNoiseTemperature: systemNoiseTemperature, &fbb)
    Sensorcharacteristics_Abridged.add(source: source, &fbb)
    Sensorcharacteristics_Abridged.add(dataMode: dataMode, &fbb)
    Sensorcharacteristics_Abridged.add(createdAt: createdAt, &fbb)
    Sensorcharacteristics_Abridged.add(createdBy: createdBy, &fbb)
    return Sensorcharacteristics_Abridged.endSensorcharacteristics_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Sensorcharacteristics_Abridged_dataMode_Enum.self)
