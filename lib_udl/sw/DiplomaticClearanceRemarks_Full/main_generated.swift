...
public struct DiplomaticClearanceRemarks_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DiplomaticClearanceRemarks_Full.id, addPrefix: prefix) }
  ...
  public static func startDiplomaticClearanceRemarks_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endDiplomaticClearanceRemarks_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDiplomaticClearanceRemarks_Full(
    ...
    let __start = DiplomaticClearanceRemarks_Full.startDiplomaticClearanceRemarks_Full(&fbb)
    DiplomaticClearanceRemarks_Full.add(gdssRemarkId: gdssRemarkId, &fbb)
    DiplomaticClearanceRemarks_Full.add(text: text, &fbb)
    DiplomaticClearanceRemarks_Full.add(date: date, &fbb)
    DiplomaticClearanceRemarks_Full.add(user: user, &fbb)
    return DiplomaticClearanceRemarks_Full.endDiplomaticClearanceRemarks_Full(&fbb, start: __start)
  }
