...
public enum AirspaceControlMeans_Ingest_cmShape_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AirspaceControlMeans_Ingest_cmShape_Enum { return .geoline }
  public static var min: AirspaceControlMeans_Ingest_cmShape_Enum { return .polyarc }
}


///  /// A conditional nested segment to report multiple airspace control means within a particular airspace control means status.
public struct AirspaceControlMeans_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirspaceControlMeans_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 8
  public var cmShape: AirspaceControlMeans_Ingest_cmShape_Enum { let o = _accessor.offset(VTOFFSET.cmShape.v); return o == 0 ? .polyarc : AirspaceControlMeans_Ingest_cmShape_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .polyarc }
  ...
  public static func startAirspaceControlMeans_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 29) }
  ...
  public static func add(cmShape: AirspaceControlMeans_Ingest_cmShape_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: cmShape.rawValue, def: 0, at: VTOFFSET.cmShape.p) }
  ...
  public static func endAirspaceControlMeans_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirspaceControlMeans_Ingest(
    ...
    let __start = AirspaceControlMeans_Ingest.startAirspaceControlMeans_Ingest(&fbb)
    AirspaceControlMeans_Ingest.add(cmType: cmType, &fbb)
    AirspaceControlMeans_Ingest.add(cmId: cmId, &fbb)
    AirspaceControlMeans_Ingest.add(cmShape: cmShape, &fbb)
    AirspaceControlMeans_Ingest.add(usage: usage, &fbb)
    AirspaceControlMeans_Ingest.add(link16Id: link16Id, &fbb)
    AirspaceControlMeans_Ingest.add(transAltitude: transAltitude, &fbb)
    AirspaceControlMeans_Ingest.add(geoDatumAlt: geoDatumAlt, &fbb)
    AirspaceControlMeans_Ingest.add(coord0: coord0, &fbb)
    AirspaceControlMeans_Ingest.add(coord1: coord1, &fbb)
    AirspaceControlMeans_Ingest.add(bearing0: bearing0, &fbb)
    AirspaceControlMeans_Ingest.add(bearing1: bearing1, &fbb)
    AirspaceControlMeans_Ingest.add(radMag0: radMag0, &fbb)
    AirspaceControlMeans_Ingest.add(radMag1: radMag1, &fbb)
    AirspaceControlMeans_Ingest.add(radMagUnit: radMagUnit, &fbb)
    AirspaceControlMeans_Ingest.addVectorOf(polyCoord: polyCoord, &fbb)
    AirspaceControlMeans_Ingest.add(trackLeg: trackLeg, &fbb)
    AirspaceControlMeans_Ingest.add(widthLeft: widthLeft, &fbb)
    AirspaceControlMeans_Ingest.add(widthRight: widthRight, &fbb)
    AirspaceControlMeans_Ingest.add(width: width, &fbb)
    AirspaceControlMeans_Ingest.add(widthUnit: widthUnit, &fbb)
    AirspaceControlMeans_Ingest.addVectorOf(corrWayPoints: corrWayPoints, &fbb)
    AirspaceControlMeans_Ingest.add(orbitAlignment: orbitAlignment, &fbb)
    AirspaceControlMeans_Ingest.add(effVdim: effVdim, &fbb)
    AirspaceControlMeans_Ingest.addVectorOf(airspaceTimePeriod: airspaceTimePeriod, &fbb)
    AirspaceControlMeans_Ingest.addVectorOf(airspaceControlPoint: airspaceControlPoint, &fbb)
    AirspaceControlMeans_Ingest.add(ctrlAuth: ctrlAuth, &fbb)
    AirspaceControlMeans_Ingest.addVectorOf(ctrlAuthFreqs: ctrlAuthFreqs, &fbb)
    AirspaceControlMeans_Ingest.add(genTextInd: genTextInd, &fbb)
    AirspaceControlMeans_Ingest.add(freeText: freeText, &fbb)
    return AirspaceControlMeans_Ingest.endAirspaceControlMeans_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.cmShape.p, fieldName: "cmShape", required: false, type: AirspaceControlMeans_Ingest_cmShape_Enum.self)
