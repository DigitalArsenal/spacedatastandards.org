...
public enum GNSSObservationSet_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: GNSSObservationSet_Ingest_dataMode_Enum { return .exercise }
  public static var min: GNSSObservationSet_Ingest_dataMode_Enum { return .real }
}


///  /// Set of GNSSObservation data.
public struct GNSSObservationSet_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: GNSSObservationSet_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: GNSSObservationSet_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : GNSSObservationSet_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startGNSSObservationSet_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 36) }
  ...
  public static func add(dataMode: GNSSObservationSet_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endGNSSObservationSet_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createGNSSObservationSet_Ingest(
    ...
    let __start = GNSSObservationSet_Ingest.startGNSSObservationSet_Ingest(&fbb)
    GNSSObservationSet_Ingest.add(id: id, &fbb)
    GNSSObservationSet_Ingest.add(classificationMarking: classificationMarking, &fbb)
    GNSSObservationSet_Ingest.add(markerType: markerType, &fbb)
    GNSSObservationSet_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    GNSSObservationSet_Ingest.add(satNo: satNo, &fbb)
    GNSSObservationSet_Ingest.add(origObjectId: origObjectId, &fbb)
    GNSSObservationSet_Ingest.add(ts: ts, &fbb)
    GNSSObservationSet_Ingest.add(outage: outage, &fbb)
    GNSSObservationSet_Ingest.add(gDop: gDop, &fbb)
    GNSSObservationSet_Ingest.add(hDop: hDop, &fbb)
    GNSSObservationSet_Ingest.add(pDop: pDop, &fbb)
    GNSSObservationSet_Ingest.add(tDop: tDop, &fbb)
    GNSSObservationSet_Ingest.add(vDop: vDop, &fbb)
    GNSSObservationSet_Ingest.add(esId: esId, &fbb)
    GNSSObservationSet_Ingest.add(receiver: receiver, &fbb)
    GNSSObservationSet_Ingest.addVectorOf(boresight: boresight, &fbb)
    GNSSObservationSet_Ingest.addVectorOf(quat: quat, &fbb)
    GNSSObservationSet_Ingest.add(lat: lat, &fbb)
    GNSSObservationSet_Ingest.add(lon: lon, &fbb)
    GNSSObservationSet_Ingest.add(alt: alt, &fbb)
    GNSSObservationSet_Ingest.addVectorOf(satVelocity: satVelocity, &fbb)
    GNSSObservationSet_Ingest.addVectorOf(obsCodes: obsCodes, &fbb)
    GNSSObservationSet_Ingest.add(trackingStatus: trackingStatus, &fbb)
    GNSSObservationSet_Ingest.add(navigationStatus: navigationStatus, &fbb)
    GNSSObservationSet_Ingest.add(agcState: agcState, &fbb)
    GNSSObservationSet_Ingest.addVectorOf(srcTyps: srcTyps, &fbb)
    GNSSObservationSet_Ingest.addVectorOf(srcIds: srcIds, &fbb)
    GNSSObservationSet_Ingest.addVectorOf(tags: tags, &fbb)
    GNSSObservationSet_Ingest.add(transactionId: transactionId, &fbb)
    GNSSObservationSet_Ingest.add(createdAt: createdAt, &fbb)
    GNSSObservationSet_Ingest.add(createdBy: createdBy, &fbb)
    GNSSObservationSet_Ingest.add(source: source, &fbb)
    GNSSObservationSet_Ingest.add(origin: origin, &fbb)
    GNSSObservationSet_Ingest.add(dataMode: dataMode, &fbb)
    GNSSObservationSet_Ingest.add(origNetwork: origNetwork, &fbb)
    GNSSObservationSet_Ingest.addVectorOf(gnssObservationList: gnssObservationList, &fbb)
    return GNSSObservationSet_Ingest.endGNSSObservationSet_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: GNSSObservationSet_Ingest_dataMode_Enum.self)
