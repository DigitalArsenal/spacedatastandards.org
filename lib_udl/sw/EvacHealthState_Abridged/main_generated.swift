...
public struct EvacHealthState_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacHealthState_Abridged.id, addPrefix: prefix) }
  ...
  public static func startEvacHealthState_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endEvacHealthState_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacHealthState_Abridged(
    ...
    let __start = EvacHealthState_Abridged.startEvacHealthState_Abridged(&fbb)
    EvacHealthState_Abridged.add(type: type, &fbb)
    EvacHealthState_Abridged.add(healthStateCode: healthStateCode, &fbb)
    EvacHealthState_Abridged.add(medConfFactor: medConfFactor, &fbb)
    EvacHealthState_Abridged.add(time: time, &fbb)
    return EvacHealthState_Abridged.endEvacHealthState_Abridged(&fbb, start: __start)
  }
