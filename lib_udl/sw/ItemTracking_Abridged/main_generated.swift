...
public enum ItemTracking_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: ItemTracking_Abridged_dataMode_Enum { return .exercise }
  public static var min: ItemTracking_Abridged_dataMode_Enum { return .real }
}


///  /// No description available.
public struct ItemTracking_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ItemTracking_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: ItemTracking_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : ItemTracking_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startItemTracking_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 22) }
  ...
  public static func add(dataMode: ItemTracking_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endItemTracking_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createItemTracking_Abridged(
    ...
    let __start = ItemTracking_Abridged.startItemTracking_Abridged(&fbb)
    ItemTracking_Abridged.add(id: id, &fbb)
    ItemTracking_Abridged.add(classificationMarking: classificationMarking, &fbb)
    ItemTracking_Abridged.add(scanCode: scanCode, &fbb)
    ItemTracking_Abridged.add(scGenTool: scGenTool, &fbb)
    ItemTracking_Abridged.add(scannerId: scannerId, &fbb)
    ItemTracking_Abridged.add(ts: ts, &fbb)
    ItemTracking_Abridged.add(idItem: idItem, &fbb)
    ItemTracking_Abridged.add(type: type, &fbb)
    ItemTracking_Abridged.add(lat: lat, &fbb)
    ItemTracking_Abridged.add(lon: lon, &fbb)
    ItemTracking_Abridged.add(scanType: scanType, &fbb)
    ItemTracking_Abridged.add(dvCode: dvCode, &fbb)
    ItemTracking_Abridged.add(notes: notes, &fbb)
    ItemTracking_Abridged.addVectorOf(keys: keys, &fbb)
    ItemTracking_Abridged.addVectorOf(values: values, &fbb)
    ItemTracking_Abridged.add(createdAt: createdAt, &fbb)
    ItemTracking_Abridged.add(createdBy: createdBy, &fbb)
    ItemTracking_Abridged.add(sourceDl: sourceDl, &fbb)
    ItemTracking_Abridged.add(source: source, &fbb)
    ItemTracking_Abridged.add(origin: origin, &fbb)
    ItemTracking_Abridged.add(origNetwork: origNetwork, &fbb)
    ItemTracking_Abridged.add(dataMode: dataMode, &fbb)
    return ItemTracking_Abridged.endItemTracking_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: ItemTracking_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
