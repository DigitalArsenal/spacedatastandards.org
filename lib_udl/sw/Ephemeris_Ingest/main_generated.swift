...
public enum Ephemeris_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Ephemeris_Ingest_dataMode_Enum { return .exercise }
  public static var min: Ephemeris_Ingest_dataMode_Enum { return .real }
}
...
public struct Ephemeris_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Ephemeris_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: Ephemeris_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Ephemeris_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startEphemeris_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 21) }
  ...
  public static func add(dataMode: Ephemeris_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endEphemeris_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEphemeris_Ingest(
    ...
    let __start = Ephemeris_Ingest.startEphemeris_Ingest(&fbb)
    Ephemeris_Ingest.add(id: id, &fbb)
    Ephemeris_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Ephemeris_Ingest.add(esId: esId, &fbb)
    Ephemeris_Ingest.add(ts: ts, &fbb)
    Ephemeris_Ingest.add(xpos: xpos, &fbb)
    Ephemeris_Ingest.add(ypos: ypos, &fbb)
    Ephemeris_Ingest.add(zpos: zpos, &fbb)
    Ephemeris_Ingest.add(xvel: xvel, &fbb)
    Ephemeris_Ingest.add(yvel: yvel, &fbb)
    Ephemeris_Ingest.add(zvel: zvel, &fbb)
    Ephemeris_Ingest.add(xaccel: xaccel, &fbb)
    Ephemeris_Ingest.add(yaccel: yaccel, &fbb)
    Ephemeris_Ingest.add(zaccel: zaccel, &fbb)
    Ephemeris_Ingest.addVectorOf(cov: cov, &fbb)
    Ephemeris_Ingest.add(createdAt: createdAt, &fbb)
    Ephemeris_Ingest.add(createdBy: createdBy, &fbb)
    Ephemeris_Ingest.add(source: source, &fbb)
    Ephemeris_Ingest.add(dataMode: dataMode, &fbb)
    Ephemeris_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    Ephemeris_Ingest.add(origObjectId: origObjectId, &fbb)
    Ephemeris_Ingest.add(origin: origin, &fbb)
    return Ephemeris_Ingest.endEphemeris_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Ephemeris_Ingest_dataMode_Enum.self)
