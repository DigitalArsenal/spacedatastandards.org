...
///  /// Allergy information.
public struct EvacAllergy_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacAllergy_Full.id, addPrefix: prefix) }
  ...
  public static func startEvacAllergy_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 2) }
  ...
  public static func endEvacAllergy_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacAllergy_Full(
    _ fbb: inout FlatBufferBuilder,
    typeOffset type: Offset = Offset(),
    commentsOffset comments: Offset = Offset()
  ) -> Offset {
    let __start = EvacAllergy_Full.startEvacAllergy_Full(&fbb)
    EvacAllergy_Full.add(type: type, &fbb)
    EvacAllergy_Full.add(comments: comments, &fbb)
    return EvacAllergy_Full.endEvacAllergy_Full(&fbb, start: __start)
  }
