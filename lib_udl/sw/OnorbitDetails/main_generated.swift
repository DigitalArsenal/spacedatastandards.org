...
public enum OnorbitDetails_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OnorbitDetails_dataMode_Enum { return .exercise }
  public static var min: OnorbitDetails_dataMode_Enum { return .real }
}


///  /// Contains details of the OnOrbit object.
public struct OnorbitDetails: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OnorbitDetails.id, addPrefix: prefix) }
  ...
  public var dataMode: OnorbitDetails_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OnorbitDetails_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOnorbitDetails(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 50) }
  ...
  public static func add(dataMode: OnorbitDetails_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endOnorbitDetails(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnorbitDetails(
    ...
    let __start = OnorbitDetails.startOnorbitDetails(&fbb)
    OnorbitDetails.add(id: id, &fbb)
    OnorbitDetails.add(idOnOrbit: idOnOrbit, &fbb)
    OnorbitDetails.add(classificationMarking: classificationMarking, &fbb)
    OnorbitDetails.add(lastObTime: lastObTime, &fbb)
    OnorbitDetails.add(vismag: vismag, &fbb)
    OnorbitDetails.add(vismagMin: vismagMin, &fbb)
    OnorbitDetails.add(vismagMax: vismagMax, &fbb)
    OnorbitDetails.add(vismagMean: vismagMean, &fbb)
    OnorbitDetails.add(rcs: rcs, &fbb)
    OnorbitDetails.add(rcsMin: rcsMin, &fbb)
    OnorbitDetails.add(rcsMax: rcsMax, &fbb)
    OnorbitDetails.add(rcsMean: rcsMean, &fbb)
    OnorbitDetails.add(bolDeltaV: bolDeltaV, &fbb)
    OnorbitDetails.add(maxDeltaV: maxDeltaV, &fbb)
    OnorbitDetails.add(deltaVunc: deltaVunc, &fbb)
    OnorbitDetails.add(estDeltaVduration: estDeltaVduration, &fbb)
    OnorbitDetails.add(numMission: numMission, &fbb)
    OnorbitDetails.addVectorOf(missionTypes: missionTypes, &fbb)
    OnorbitDetails.add(busType: busType, &fbb)
    OnorbitDetails.add(geoSlot: geoSlot, &fbb)
    OnorbitDetails.add(driftRate: driftRate, &fbb)
    OnorbitDetails.add(dryMass: dryMass, &fbb)
    OnorbitDetails.add(additionalMass: additionalMass, &fbb)
    OnorbitDetails.add(launchMassMin: launchMassMin, &fbb)
    OnorbitDetails.add(launchMass: launchMass, &fbb)
    OnorbitDetails.add(launchMassMax: launchMassMax, &fbb)
    OnorbitDetails.add(bolFuelMass: bolFuelMass, &fbb)
    OnorbitDetails.add(currentMass: currentMass, &fbb)
    OnorbitDetails.add(totalMassUnc: totalMassUnc, &fbb)
    OnorbitDetails.add(solarArrayArea: solarArrayArea, &fbb)
    OnorbitDetails.add(maneuverable: maneuverable, &fbb)
    OnorbitDetails.add(fuelRemaining: fuelRemaining, &fbb)
    OnorbitDetails.add(crossSection: crossSection, &fbb)
    OnorbitDetails.add(busCrossSection: busCrossSection, &fbb)
    OnorbitDetails.add(maxRadius: maxRadius, &fbb)
    OnorbitDetails.add(colaRadius: colaRadius, &fbb)
    OnorbitDetails.add(adeptRadius: adeptRadius, &fbb)
    OnorbitDetails.add(numDeployable: numDeployable, &fbb)
    OnorbitDetails.addVectorOf(depNames: depNames, &fbb)
    OnorbitDetails.addVectorOf(depEstMasses: depEstMasses, &fbb)
    OnorbitDetails.addVectorOf(depMassUncs: depMassUncs, &fbb)
    OnorbitDetails.add(source: source, &fbb)
    OnorbitDetails.add(origin: origin, &fbb)
    OnorbitDetails.add(lastObSource: lastObSource, &fbb)
    OnorbitDetails.add(dataMode: dataMode, &fbb)
    OnorbitDetails.add(createdAt: createdAt, &fbb)
    OnorbitDetails.add(createdBy: createdBy, &fbb)
    OnorbitDetails.add(updatedAt: updatedAt, &fbb)
    OnorbitDetails.add(updatedBy: updatedBy, &fbb)
    OnorbitDetails.add(origNetwork: origNetwork, &fbb)
    return OnorbitDetails.endOnorbitDetails(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OnorbitDetails_dataMode_Enum.self)
