...
public struct ISRCollectionTransit_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollectionTransit_Ingest.id, addPrefix: prefix) }
  ...
  public static func startISRCollectionTransit_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endISRCollectionTransit_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollectionTransit_Ingest(
    _ fbb: inout FlatBufferBuilder,
    idOffset id: Offset = Offset(),
    baseOffset base: Offset = Offset(),
    duration: Double = 0.0
  ) -> Offset {
    let __start = ISRCollectionTransit_Ingest.startISRCollectionTransit_Ingest(&fbb)
    ISRCollectionTransit_Ingest.add(id: id, &fbb)
    ISRCollectionTransit_Ingest.add(base: base, &fbb)
    ISRCollectionTransit_Ingest.add(duration: duration, &fbb)
    return ISRCollectionTransit_Ingest.endISRCollectionTransit_Ingest(&fbb, start: __start)
  }
