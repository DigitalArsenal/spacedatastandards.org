...
public enum ECPSDR_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: ECPSDR_Ingest_dataMode_Enum { return .exercise }
  public static var min: ECPSDR_Ingest_dataMode_Enum { return .real }
}
...
public struct ECPSDR_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ECPSDR_Ingest.id, addPrefix: prefix) }
  ...
  ///  Example: /// Example: TEST
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: ECPSDR_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : ECPSDR_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startECPSDR_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 52) }
  ...
  public static func add(dataMode: ECPSDR_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endECPSDR_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createECPSDR_Ingest(
    ...
    let __start = ECPSDR_Ingest.startECPSDR_Ingest(&fbb)
    ECPSDR_Ingest.add(id: id, &fbb)
    ECPSDR_Ingest.add(classificationMarking: classificationMarking, &fbb)
    ECPSDR_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    ECPSDR_Ingest.add(satNo: satNo, &fbb)
    ECPSDR_Ingest.add(origObjectId: origObjectId, &fbb)
    ECPSDR_Ingest.add(idSensor: idSensor, &fbb)
    ECPSDR_Ingest.add(origSensorId: origSensorId, &fbb)
    ECPSDR_Ingest.add(type: type, &fbb)
    ECPSDR_Ingest.add(msgTime: msgTime, &fbb)
    ECPSDR_Ingest.add(obTime: obTime, &fbb)
    ECPSDR_Ingest.add(retransmit: retransmit, &fbb)
    ECPSDR_Ingest.add(senMode: senMode, &fbb)
    ECPSDR_Ingest.add(dosBias: dosBias, &fbb)
    ECPSDR_Ingest.add(asl5VcurrMon: asl5VcurrMon, &fbb)
    ECPSDR_Ingest.add(dsl5VcurrMon: dsl5VcurrMon, &fbb)
    ECPSDR_Ingest.add(psTempMon: psTempMon, &fbb)
    ECPSDR_Ingest.add(cdsPlateVmon: cdsPlateVmon, &fbb)
    ECPSDR_Ingest.add(cdsRefVmon: cdsRefVmon, &fbb)
    ECPSDR_Ingest.add(mpTemp: mpTemp, &fbb)
    ECPSDR_Ingest.add(vRef: vRef, &fbb)
    ECPSDR_Ingest.add(pd1SigLev: pd1SigLev, &fbb)
    ECPSDR_Ingest.add(pd2SigLev: pd2SigLev, &fbb)
    ECPSDR_Ingest.add(esdTrigCountL: esdTrigCountL, &fbb)
    ECPSDR_Ingest.add(esdTrigCountH: esdTrigCountH, &fbb)
    ECPSDR_Ingest.add(lowLetL: lowLetL, &fbb)
    ECPSDR_Ingest.add(lowLetM: lowLetM, &fbb)
    ECPSDR_Ingest.add(medLet1L: medLet1L, &fbb)
    ECPSDR_Ingest.add(medLet1M: medLet1M, &fbb)
    ECPSDR_Ingest.add(medLet2L: medLet2L, &fbb)
    ECPSDR_Ingest.add(medLet2M: medLet2M, &fbb)
    ECPSDR_Ingest.add(medLet3L: medLet3L, &fbb)
    ECPSDR_Ingest.add(medLet3M: medLet3M, &fbb)
    ECPSDR_Ingest.add(medLet4L: medLet4L, &fbb)
    ECPSDR_Ingest.add(medLet4M: medLet4M, &fbb)
    ECPSDR_Ingest.add(hiLetL: hiLetL, &fbb)
    ECPSDR_Ingest.add(hiLetM: hiLetM, &fbb)
    ECPSDR_Ingest.add(surfDosL: surfDosL, &fbb)
    ECPSDR_Ingest.add(surfDosM: surfDosM, &fbb)
    ECPSDR_Ingest.add(surfDosH: surfDosH, &fbb)
    ECPSDR_Ingest.add(surfDosChargeL: surfDosChargeL, &fbb)
    ECPSDR_Ingest.add(surfDosChargeH: surfDosChargeH, &fbb)
    ECPSDR_Ingest.add(surfDosStat: surfDosStat, &fbb)
    ECPSDR_Ingest.add(cdsThrottle: cdsThrottle, &fbb)
    ECPSDR_Ingest.add(cdsThreshold: cdsThreshold, &fbb)
    ECPSDR_Ingest.add(checksum: checksum, &fbb)
    ECPSDR_Ingest.addVectorOf(transientData: transientData, &fbb)
    ECPSDR_Ingest.add(createdAt: createdAt, &fbb)
    ECPSDR_Ingest.add(createdBy: createdBy, &fbb)
    ECPSDR_Ingest.add(source: source, &fbb)
    ECPSDR_Ingest.add(origin: origin, &fbb)
    ECPSDR_Ingest.add(origNetwork: origNetwork, &fbb)
    ECPSDR_Ingest.add(dataMode: dataMode, &fbb)
    return ECPSDR_Ingest.endECPSDR_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: ECPSDR_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
