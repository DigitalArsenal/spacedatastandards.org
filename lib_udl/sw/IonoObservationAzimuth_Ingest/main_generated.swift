...
public struct IonoObservationAzimuth_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationAzimuth_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationAzimuth_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationAzimuth_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationAzimuth_Ingest(
    ...
    let __start = IonoObservationAzimuth_Ingest.startIonoObservationAzimuth_Ingest(&fbb)
    IonoObservationAzimuth_Ingest.add(notes: notes, &fbb)
    IonoObservationAzimuth_Ingest.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationAzimuth_Ingest.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationAzimuth_Ingest.addVectorOf(data: data, &fbb)
    return IonoObservationAzimuth_Ingest.endIonoObservationAzimuth_Ingest(&fbb, start: __start)
  }
