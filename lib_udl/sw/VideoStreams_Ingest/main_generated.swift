...
public enum VideoStreams_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: VideoStreams_Ingest_dataMode_Enum { return .exercise }
  public static var min: VideoStreams_Ingest_dataMode_Enum { return .real }
}


///  /// The table captures metadata associated with the published videos in UDL.
public struct VideoStreams_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: VideoStreams_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: VideoStreams_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : VideoStreams_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startVideoStreams_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 14) }
  ...
  public static func add(dataMode: VideoStreams_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func add(origin: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origin, at: VTOFFSET.origin.p) }
  public static func endVideoStreams_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createVideoStreams_Ingest(
    ...
    let __start = VideoStreams_Ingest.startVideoStreams_Ingest(&fbb)
    VideoStreams_Ingest.add(id: id, &fbb)
    VideoStreams_Ingest.add(classificationMarking: classificationMarking, &fbb)
    VideoStreams_Ingest.add(name: name, &fbb)
    VideoStreams_Ingest.add(description: description, &fbb)
    VideoStreams_Ingest.add(startTime: startTime, &fbb)
    VideoStreams_Ingest.add(stopTime: stopTime, &fbb)
    VideoStreams_Ingest.add(source: source, &fbb)
    VideoStreams_Ingest.add(tokenValue: tokenValue, &fbb)
    VideoStreams_Ingest.addVectorOf(videoUrls: videoUrls, &fbb)
    VideoStreams_Ingest.add(dataMode: dataMode, &fbb)
    VideoStreams_Ingest.add(createdAt: createdAt, &fbb)
    VideoStreams_Ingest.add(createdBy: createdBy, &fbb)
    VideoStreams_Ingest.add(origNetwork: origNetwork, &fbb)
    VideoStreams_Ingest.add(origin: origin, &fbb)
    return VideoStreams_Ingest.endVideoStreams_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: VideoStreams_Ingest_dataMode_Enum.self)
