...
public enum LaunchVehicleDetails_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: LaunchVehicleDetails_Full_dataMode_Enum { return .exercise }
  public static var min: LaunchVehicleDetails_Full_dataMode_Enum { return .real }
}
...
public struct LaunchVehicleDetails_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LaunchVehicleDetails_Full.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case source = 108
    case origin = 110
    case origNetwork = 112
    case dataMode = 114
    case tags = 116
    case manufacturerOrg = 118
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: LaunchVehicleDetails_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : LaunchVehicleDetails_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Constraints: No constraints specified.
  public var manufacturerOrg: String? { let o = _accessor.offset(VTOFFSET.manufacturerOrg.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var manufacturerOrgSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.manufacturerOrg.v) }
  public static func startLaunchVehicleDetails_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 58) }
  ...
  public static func add(dataMode: LaunchVehicleDetails_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func addVectorOf(tags: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: tags, at: VTOFFSET.tags.p) }
  public static func add(manufacturerOrg: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: manufacturerOrg, at: VTOFFSET.manufacturerOrg.p) }
  public static func endLaunchVehicleDetails_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLaunchVehicleDetails_Full(
    ...
    manufacturerOrgOffset manufacturerOrg: Offset = Offset()
  ) -> Offset {
    let __start = LaunchVehicleDetails_Full.startLaunchVehicleDetails_Full(&fbb)
    LaunchVehicleDetails_Full.add(id: id, &fbb)
    LaunchVehicleDetails_Full.add(idLaunchVehicle: idLaunchVehicle, &fbb)
    LaunchVehicleDetails_Full.add(classificationMarking: classificationMarking, &fbb)
    LaunchVehicleDetails_Full.add(variant: variant, &fbb)
    LaunchVehicleDetails_Full.add(minorVariant: minorVariant, &fbb)
    LaunchVehicleDetails_Full.add(category: category, &fbb)
    LaunchVehicleDetails_Full.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    LaunchVehicleDetails_Full.add(launchPrefix: launchPrefix, &fbb)
    LaunchVehicleDetails_Full.add(family: family, &fbb)
    LaunchVehicleDetails_Full.add(propellant: propellant, &fbb)
    LaunchVehicleDetails_Full.add(oxidizer: oxidizer, &fbb)
    LaunchVehicleDetails_Full.add(length: length, &fbb)
    LaunchVehicleDetails_Full.add(diameter: diameter, &fbb)
    LaunchVehicleDetails_Full.add(launchMass: launchMass, &fbb)
    LaunchVehicleDetails_Full.add(geoPayloadMass: geoPayloadMass, &fbb)
    LaunchVehicleDetails_Full.add(gtoPayloadMass: gtoPayloadMass, &fbb)
    LaunchVehicleDetails_Full.add(leoPayloadMass: leoPayloadMass, &fbb)
    LaunchVehicleDetails_Full.add(ssoPayloadMass: ssoPayloadMass, &fbb)
    LaunchVehicleDetails_Full.add(fairingLength: fairingLength, &fbb)
    LaunchVehicleDetails_Full.add(fairingName: fairingName, &fbb)
    LaunchVehicleDetails_Full.add(fairingExternalDiameter: fairingExternalDiameter, &fbb)
    LaunchVehicleDetails_Full.add(fairingInternalDiameter: fairingInternalDiameter, &fbb)
    LaunchVehicleDetails_Full.add(fairingMass: fairingMass, &fbb)
    LaunchVehicleDetails_Full.add(fairingMaterial: fairingMaterial, &fbb)
    LaunchVehicleDetails_Full.add(maxAccelLoad: maxAccelLoad, &fbb)
    LaunchVehicleDetails_Full.add(maxPayloadFreqLat: maxPayloadFreqLat, &fbb)
    LaunchVehicleDetails_Full.add(maxPayloadFreqLon: maxPayloadFreqLon, &fbb)
    LaunchVehicleDetails_Full.add(maxAcousticLevel: maxAcousticLevel, &fbb)
    LaunchVehicleDetails_Full.add(maxAcousticLevelRange: maxAcousticLevelRange, &fbb)
    LaunchVehicleDetails_Full.add(soundPressureLevel: soundPressureLevel, &fbb)
    LaunchVehicleDetails_Full.add(maxFlightShockForce: maxFlightShockForce, &fbb)
    LaunchVehicleDetails_Full.add(maxFlightShockFreq: maxFlightShockFreq, &fbb)
    LaunchVehicleDetails_Full.add(maxFairingPressureChange: maxFairingPressureChange, &fbb)
    LaunchVehicleDetails_Full.add(estLaunchPrice: estLaunchPrice, &fbb)
    LaunchVehicleDetails_Full.add(estLaunchPriceTypical: estLaunchPriceTypical, &fbb)
    LaunchVehicleDetails_Full.add(gtoInj3SigAccuracyApogeeTarget: gtoInj3SigAccuracyApogeeTarget, &fbb)
    LaunchVehicleDetails_Full.add(gtoInj3SigAccuracyApogeeMargin: gtoInj3SigAccuracyApogeeMargin, &fbb)
    LaunchVehicleDetails_Full.add(gtoInj3SigAccuracyPerigeeTarget: gtoInj3SigAccuracyPerigeeTarget, &fbb)
    LaunchVehicleDetails_Full.add(gtoInj3SigAccuracyPerigeeMargin: gtoInj3SigAccuracyPerigeeMargin, &fbb)
    LaunchVehicleDetails_Full.add(gtoInj3SigAccuracyInclinationTarget: gtoInj3SigAccuracyInclinationTarget, &fbb)
    LaunchVehicleDetails_Full.add(gtoInj3SigAccuracyInclinationMargin: gtoInj3SigAccuracyInclinationMargin, &fbb)
    LaunchVehicleDetails_Full.add(attitudeAccuracy: attitudeAccuracy, &fbb)
    LaunchVehicleDetails_Full.add(payloadSeparationRate: payloadSeparationRate, &fbb)
    LaunchVehicleDetails_Full.add(deploymentRotationRate: deploymentRotationRate, &fbb)
    LaunchVehicleDetails_Full.add(sourceUrl: sourceUrl, &fbb)
    LaunchVehicleDetails_Full.add(notes: notes, &fbb)
    LaunchVehicleDetails_Full.add(fairingNotes: fairingNotes, &fbb)
    LaunchVehicleDetails_Full.add(payloadNotes: payloadNotes, &fbb)
    LaunchVehicleDetails_Full.add(createdAt: createdAt, &fbb)
    LaunchVehicleDetails_Full.add(createdBy: createdBy, &fbb)
    LaunchVehicleDetails_Full.add(updatedAt: updatedAt, &fbb)
    LaunchVehicleDetails_Full.add(updatedBy: updatedBy, &fbb)
    LaunchVehicleDetails_Full.add(source: source, &fbb)
    LaunchVehicleDetails_Full.add(origin: origin, &fbb)
    LaunchVehicleDetails_Full.add(origNetwork: origNetwork, &fbb)
    LaunchVehicleDetails_Full.add(dataMode: dataMode, &fbb)
    LaunchVehicleDetails_Full.addVectorOf(tags: tags, &fbb)
    LaunchVehicleDetails_Full.add(manufacturerOrg: manufacturerOrg, &fbb)
    return LaunchVehicleDetails_Full.endLaunchVehicleDetails_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: LaunchVehicleDetails_Full_dataMode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.manufacturerOrg.p, fieldName: "manufacturerOrg", required: false, type: ForwardOffset<String>.self)
    _v.finish()
  }
}
