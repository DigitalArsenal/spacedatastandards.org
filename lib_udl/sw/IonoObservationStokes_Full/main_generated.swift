...
public struct IonoObservationStokes_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationStokes_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationStokes_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endIonoObservationStokes_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationStokes_Full(
    ...
    let __start = IonoObservationStokes_Full.startIonoObservationStokes_Full(&fbb)
    IonoObservationStokes_Full.add(notes: notes, &fbb)
    IonoObservationStokes_Full.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationStokes_Full.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationStokes_Full.addVectorOf(data: data, &fbb)
    IonoObservationStokes_Full.addVectorOf(s: s, &fbb)
    return IonoObservationStokes_Full.endIonoObservationStokes_Full(&fbb, start: __start)
  }
