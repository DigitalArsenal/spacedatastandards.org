...
public enum GroundImagery_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: GroundImagery_Ingest_dataMode_Enum { return .exercise }
  public static var min: GroundImagery_Ingest_dataMode_Enum { return .real }
}


///  /// Imagery of terrestrial regions from on-orbit, air, and other sensors.
public struct GroundImagery_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: GroundImagery_Ingest.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case createdAt = 42
    case createdBy = 44
    case transactionId = 46
    case tags = 48
    case keywords = 50
    case notes = 52
    case format = 54
    case filesize = 56
    case checksumValue = 58
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: GroundImagery_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : GroundImagery_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startGroundImagery_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 28) }
  ...
  public static func add(dataMode: GroundImagery_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endGroundImagery_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createGroundImagery_Ingest(
    ...
    let __start = GroundImagery_Ingest.startGroundImagery_Ingest(&fbb)
    GroundImagery_Ingest.add(id: id, &fbb)
    GroundImagery_Ingest.add(idSensor: idSensor, &fbb)
    GroundImagery_Ingest.add(classificationMarking: classificationMarking, &fbb)
    GroundImagery_Ingest.add(imageTime: imageTime, &fbb)
    GroundImagery_Ingest.add(filename: filename, &fbb)
    GroundImagery_Ingest.add(region: region, &fbb)
    GroundImagery_Ingest.add(regionText: regionText, &fbb)
    GroundImagery_Ingest.add(regionGeoJson: regionGeoJson, &fbb)
    GroundImagery_Ingest.add(regionType: regionType, &fbb)
    GroundImagery_Ingest.add(regionNdims: regionNdims, &fbb)
    GroundImagery_Ingest.add(regionSrid: regionSrid, &fbb)
    GroundImagery_Ingest.add(origSensorId: origSensorId, &fbb)
    GroundImagery_Ingest.add(subjectId: subjectId, &fbb)
    GroundImagery_Ingest.add(name: name, &fbb)
    GroundImagery_Ingest.add(source: source, &fbb)
    GroundImagery_Ingest.add(origin: origin, &fbb)
    GroundImagery_Ingest.add(origNetwork: origNetwork, &fbb)
    GroundImagery_Ingest.add(sourceDl: sourceDl, &fbb)
    GroundImagery_Ingest.add(dataMode: dataMode, &fbb)
    GroundImagery_Ingest.add(createdAt: createdAt, &fbb)
    GroundImagery_Ingest.add(createdBy: createdBy, &fbb)
    GroundImagery_Ingest.add(transactionId: transactionId, &fbb)
    GroundImagery_Ingest.addVectorOf(tags: tags, &fbb)
    GroundImagery_Ingest.addVectorOf(keywords: keywords, &fbb)
    GroundImagery_Ingest.add(notes: notes, &fbb)
    GroundImagery_Ingest.add(format: format, &fbb)
    GroundImagery_Ingest.add(filesize: filesize, &fbb)
    GroundImagery_Ingest.add(checksumValue: checksumValue, &fbb)
    return GroundImagery_Ingest.endGroundImagery_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: GroundImagery_Ingest_dataMode_Enum.self)
