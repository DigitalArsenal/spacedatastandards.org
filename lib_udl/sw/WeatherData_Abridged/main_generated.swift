...
public enum WeatherData_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: WeatherData_Abridged_dataMode_Enum { return .exercise }
  public static var min: WeatherData_Abridged_dataMode_Enum { return .real }
}
...
public struct WeatherData_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: WeatherData_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: WeatherData_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : WeatherData_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startWeatherData_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 39) }
  ...
  public static func add(dataMode: WeatherData_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endWeatherData_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createWeatherData_Abridged(
    ...
    let __start = WeatherData_Abridged.startWeatherData_Abridged(&fbb)
    WeatherData_Abridged.add(id: id, &fbb)
    WeatherData_Abridged.add(classificationMarking: classificationMarking, &fbb)
    WeatherData_Abridged.add(idSensor: idSensor, &fbb)
    WeatherData_Abridged.add(origSensorId: origSensorId, &fbb)
    WeatherData_Abridged.add(obTime: obTime, &fbb)
    WeatherData_Abridged.addVectorOf(sigPwrs: sigPwrs, &fbb)
    WeatherData_Abridged.addVectorOf(noiseLvls: noiseLvls, &fbb)
    WeatherData_Abridged.addVectorOf(specWidths: specWidths, &fbb)
    WeatherData_Abridged.addVectorOf(firstGuessAvgs: firstGuessAvgs, &fbb)
    WeatherData_Abridged.add(qcValue: qcValue, &fbb)
    WeatherData_Abridged.add(fileCreation: fileCreation, &fbb)
    WeatherData_Abridged.add(termAlt: termAlt, &fbb)
    WeatherData_Abridged.add(avgTxPwr: avgTxPwr, &fbb)
    WeatherData_Abridged.add(avgRefPwr: avgRefPwr, &fbb)
    WeatherData_Abridged.add(sectorNum: sectorNum, &fbb)
    WeatherData_Abridged.add(numElements: numElements, &fbb)
    WeatherData_Abridged.addVectorOf(tdAvgSampleNums: tdAvgSampleNums, &fbb)
    WeatherData_Abridged.add(checksum: checksum, &fbb)
    WeatherData_Abridged.addVectorOf(coIntegs: coIntegs, &fbb)
    WeatherData_Abridged.addVectorOf(specAvgs: specAvgs, &fbb)
    WeatherData_Abridged.addVectorOf(interpulsePeriods: interpulsePeriods, &fbb)
    WeatherData_Abridged.addVectorOf(doppVels: doppVels, &fbb)
    WeatherData_Abridged.addVectorOf(consRecs: consRecs, &fbb)
    WeatherData_Abridged.addVectorOf(snrs: snrs, &fbb)
    WeatherData_Abridged.add(sigStrength: sigStrength, &fbb)
    WeatherData_Abridged.add(semiMajorAxis: semiMajorAxis, &fbb)
    WeatherData_Abridged.add(semiMinorAxis: semiMinorAxis, &fbb)
    WeatherData_Abridged.add(angleOrientation: angleOrientation, &fbb)
    WeatherData_Abridged.add(lightEventNum: lightEventNum, &fbb)
    WeatherData_Abridged.addVectorOf(lightDetSensors: lightDetSensors, &fbb)
    WeatherData_Abridged.add(posConfidence: posConfidence, &fbb)
    WeatherData_Abridged.addVectorOf(srcTyps: srcTyps, &fbb)
    WeatherData_Abridged.addVectorOf(srcIds: srcIds, &fbb)
    WeatherData_Abridged.add(origNetwork: origNetwork, &fbb)
    WeatherData_Abridged.add(createdAt: createdAt, &fbb)
    WeatherData_Abridged.add(createdBy: createdBy, &fbb)
    WeatherData_Abridged.add(source: source, &fbb)
    WeatherData_Abridged.add(origin: origin, &fbb)
    WeatherData_Abridged.add(dataMode: dataMode, &fbb)
    return WeatherData_Abridged.endWeatherData_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: WeatherData_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
