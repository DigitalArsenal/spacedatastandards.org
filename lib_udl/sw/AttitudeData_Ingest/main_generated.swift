...
public enum AttitudeData_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AttitudeData_Ingest_dataMode_Enum { return .exercise }
  public static var min: AttitudeData_Ingest_dataMode_Enum { return .real }
}
...
public struct AttitudeData_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AttitudeData_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: AttitudeData_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AttitudeData_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startAttitudeData_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 33) }
  ...
  public static func add(dataMode: AttitudeData_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endAttitudeData_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAttitudeData_Ingest(
    ...
    let __start = AttitudeData_Ingest.startAttitudeData_Ingest(&fbb)
    AttitudeData_Ingest.add(id: id, &fbb)
    AttitudeData_Ingest.add(classificationMarking: classificationMarking, &fbb)
    AttitudeData_Ingest.add(asId: asId, &fbb)
    AttitudeData_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    AttitudeData_Ingest.add(satNo: satNo, &fbb)
    AttitudeData_Ingest.add(origObjectId: origObjectId, &fbb)
    AttitudeData_Ingest.add(ts: ts, &fbb)
    AttitudeData_Ingest.add(motionType: motionType, &fbb)
    AttitudeData_Ingest.add(q1: q1, &fbb)
    AttitudeData_Ingest.add(q2: q2, &fbb)
    AttitudeData_Ingest.add(q3: q3, &fbb)
    AttitudeData_Ingest.add(qc: qc, &fbb)
    AttitudeData_Ingest.add(q1Dot: q1Dot, &fbb)
    AttitudeData_Ingest.add(q2Dot: q2Dot, &fbb)
    AttitudeData_Ingest.add(q3Dot: q3Dot, &fbb)
    AttitudeData_Ingest.add(qcDot: qcDot, &fbb)
    AttitudeData_Ingest.addVectorOf(xAngle: xAngle, &fbb)
    AttitudeData_Ingest.addVectorOf(yAngle: yAngle, &fbb)
    AttitudeData_Ingest.addVectorOf(zAngle: zAngle, &fbb)
    AttitudeData_Ingest.addVectorOf(xRate: xRate, &fbb)
    AttitudeData_Ingest.addVectorOf(yRate: yRate, &fbb)
    AttitudeData_Ingest.addVectorOf(zRate: zRate, &fbb)
    AttitudeData_Ingest.add(ra: ra, &fbb)
    AttitudeData_Ingest.add(declination: declination, &fbb)
    AttitudeData_Ingest.add(coningAngle: coningAngle, &fbb)
    AttitudeData_Ingest.add(precPeriod: precPeriod, &fbb)
    AttitudeData_Ingest.add(spinPeriod: spinPeriod, &fbb)
    AttitudeData_Ingest.add(createdAt: createdAt, &fbb)
    AttitudeData_Ingest.add(createdBy: createdBy, &fbb)
    AttitudeData_Ingest.add(source: source, &fbb)
    AttitudeData_Ingest.add(origin: origin, &fbb)
    AttitudeData_Ingest.add(dataMode: dataMode, &fbb)
    AttitudeData_Ingest.add(origNetwork: origNetwork, &fbb)
    return AttitudeData_Ingest.endAttitudeData_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AttitudeData_Ingest_dataMode_Enum.self)
