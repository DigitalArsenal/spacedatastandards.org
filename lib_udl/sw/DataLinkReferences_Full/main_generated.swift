...
public struct DataLinkReferences_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DataLinkReferences_Full.id, addPrefix: prefix) }
  ...
  public static func startDataLinkReferences_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 7) }
  ...
  public static func endDataLinkReferences_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDataLinkReferences_Full(
    ...
    let __start = DataLinkReferences_Full.startDataLinkReferences_Full(&fbb)
    DataLinkReferences_Full.add(refSerialId: refSerialId, &fbb)
    DataLinkReferences_Full.add(refType: refType, &fbb)
    DataLinkReferences_Full.add(refOriginator: refOriginator, &fbb)
    DataLinkReferences_Full.add(refTs: refTs, &fbb)
    DataLinkReferences_Full.add(refSerialNum: refSerialNum, &fbb)
    DataLinkReferences_Full.add(refSpecialNotation: refSpecialNotation, &fbb)
    DataLinkReferences_Full.addVectorOf(refSics: refSics, &fbb)
    return DataLinkReferences_Full.endDataLinkReferences_Full(&fbb, start: __start)
  }
