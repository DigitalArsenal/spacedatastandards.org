...
public struct IonoObservationProfileDensityShiftedChebyshevEntry_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationProfileDensityShiftedChebyshevEntry_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationProfileDensityShiftedChebyshevEntry_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 8) }
  ...
  public static func endIonoObservationProfileDensityShiftedChebyshevEntry_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationProfileDensityShiftedChebyshevEntry_Full(
    ...
    let __start = IonoObservationProfileDensityShiftedChebyshevEntry_Full.startIonoObservationProfileDensityShiftedChebyshevEntry_Full(&fbb)
    IonoObservationProfileDensityShiftedChebyshevEntry_Full.add(layer: layer, &fbb)
    IonoObservationProfileDensityShiftedChebyshevEntry_Full.add(fstart: fstart, &fbb)
    IonoObservationProfileDensityShiftedChebyshevEntry_Full.add(fstop: fstop, &fbb)
    IonoObservationProfileDensityShiftedChebyshevEntry_Full.add(peakheight: peakheight, &fbb)
    IonoObservationProfileDensityShiftedChebyshevEntry_Full.add(zhalfNm: zhalfNm, &fbb)
    IonoObservationProfileDensityShiftedChebyshevEntry_Full.add(n: n, &fbb)
    IonoObservationProfileDensityShiftedChebyshevEntry_Full.addVectorOf(coeffs: coeffs, &fbb)
    IonoObservationProfileDensityShiftedChebyshevEntry_Full.add(error: error, &fbb)
    return IonoObservationProfileDensityShiftedChebyshevEntry_Full.endIonoObservationProfileDensityShiftedChebyshevEntry_Full(&fbb, start: __start)
  }
