...
public struct IonoObservationTime_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationTime_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationTime_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationTime_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationTime_Full(
    ...
    let __start = IonoObservationTime_Full.startIonoObservationTime_Full(&fbb)
    IonoObservationTime_Full.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationTime_Full.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationTime_Full.add(notes: notes, &fbb)
    IonoObservationTime_Full.addVectorOf(data: data, &fbb)
    return IonoObservationTime_Full.endIonoObservationTime_Full(&fbb, start: __start)
  }
