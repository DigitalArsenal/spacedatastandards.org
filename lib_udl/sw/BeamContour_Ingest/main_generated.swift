...
public enum BeamContour_Ingest_type_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: BeamContour_Ingest_type_Enum { return .svcArea }
  public static var min: BeamContour_Ingest_type_Enum { return .boresight }
}


public enum BeamContour_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: BeamContour_Ingest_dataMode_Enum { return .exercise }
  public static var min: BeamContour_Ingest_dataMode_Enum { return .real }
}
...
public struct BeamContour_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: BeamContour_Ingest.id, addPrefix: prefix) }
  ...
  public var type: BeamContour_Ingest_type_Enum { let o = _accessor.offset(VTOFFSET.type.v); return o == 0 ? .boresight : BeamContour_Ingest_type_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .boresight }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: BeamContour_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : BeamContour_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startBeamContour_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 19) }
  ...
  public static func add(type: BeamContour_Ingest_type_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: type.rawValue, def: 0, at: VTOFFSET.type.p) }
  ...
  public static func add(dataMode: BeamContour_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endBeamContour_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createBeamContour_Ingest(
    _ fbb: inout FlatBufferBuilder,
    idOffset id: Offset = Offset(),
    classificationMarkingOffset classificationMarking: Offset = Offset(),
    idBeamOffset idBeam: Offset = Offset(),
    type: BeamContour_Ingest_type_Enum = .boresight,
    contourIdx: Int32 = 0,
    gain: Double = 0.0,
    ...
    let __start = BeamContour_Ingest.startBeamContour_Ingest(&fbb)
    BeamContour_Ingest.add(id: id, &fbb)
    BeamContour_Ingest.add(classificationMarking: classificationMarking, &fbb)
    BeamContour_Ingest.add(idBeam: idBeam, &fbb)
    BeamContour_Ingest.add(type: type, &fbb)
    BeamContour_Ingest.add(contourIdx: contourIdx, &fbb)
    BeamContour_Ingest.add(gain: gain, &fbb)
    BeamContour_Ingest.add(regionName: regionName, &fbb)
    BeamContour_Ingest.add(geography: geography, &fbb)
    BeamContour_Ingest.add(geographyText: geographyText, &fbb)
    BeamContour_Ingest.add(geographyJson: geographyJson, &fbb)
    BeamContour_Ingest.add(geographyType: geographyType, &fbb)
    BeamContour_Ingest.add(geographyNdims: geographyNdims, &fbb)
    BeamContour_Ingest.add(geographySrid: geographySrid, &fbb)
    BeamContour_Ingest.add(createdAt: createdAt, &fbb)
    BeamContour_Ingest.add(createdBy: createdBy, &fbb)
    BeamContour_Ingest.add(source: source, &fbb)
    BeamContour_Ingest.add(origin: origin, &fbb)
    BeamContour_Ingest.add(origNetwork: origNetwork, &fbb)
    BeamContour_Ingest.add(dataMode: dataMode, &fbb)
    return BeamContour_Ingest.endBeamContour_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.type.p, fieldName: "type", required: false, type: BeamContour_Ingest_type_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: BeamContour_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
