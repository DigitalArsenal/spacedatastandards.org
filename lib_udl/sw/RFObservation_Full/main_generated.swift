...
public enum RFObservation_Full_polarityType_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: RFObservation_Full_polarityType_Enum { return .l }
  public static var min: RFObservation_Full_polarityType_Enum { return .h }
}


public enum RFObservation_Full_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: RFObservation_Full_dataMode_Enum { return .exercise }
  public static var min: RFObservation_Full_dataMode_Enum { return .real }
}
...
public struct RFObservation_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: RFObservation_Full.id, addPrefix: prefix) }
  ...
  public var polarityType: RFObservation_Full_polarityType_Enum { let o = _accessor.offset(VTOFFSET.polarityType.v); return o == 0 ? .h : RFObservation_Full_polarityType_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .h }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: RFObservation_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : RFObservation_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startRFObservation_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 83) }
  ...
  public static func add(polarityType: RFObservation_Full_polarityType_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: polarityType.rawValue, def: 0, at: VTOFFSET.polarityType.p) }
  ...
  public static func add(dataMode: RFObservation_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endRFObservation_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createRFObservation_Full(
    ...
    let __start = RFObservation_Full.startRFObservation_Full(&fbb)
    RFObservation_Full.add(id: id, &fbb)
    RFObservation_Full.add(classificationMarking: classificationMarking, &fbb)
    RFObservation_Full.add(obTime: obTime, &fbb)
    RFObservation_Full.add(idOnOrbit: idOnOrbit, &fbb)
    RFObservation_Full.add(idSensor: idSensor, &fbb)
    RFObservation_Full.add(type: type, &fbb)
    RFObservation_Full.add(satNo: satNo, &fbb)
    RFObservation_Full.add(taskId: taskId, &fbb)
    RFObservation_Full.add(transactionId: transactionId, &fbb)
    RFObservation_Full.add(trackId: trackId, &fbb)
    RFObservation_Full.add(origObjectId: origObjectId, &fbb)
    RFObservation_Full.add(origSensorId: origSensorId, &fbb)
    RFObservation_Full.add(uct: uct, &fbb)
    RFObservation_Full.add(transponder: transponder, &fbb)
    RFObservation_Full.add(azimuth: azimuth, &fbb)
    RFObservation_Full.add(azimuthUnc: azimuthUnc, &fbb)
    RFObservation_Full.add(azimuthRate: azimuthRate, &fbb)
    RFObservation_Full.add(elevation: elevation, &fbb)
    RFObservation_Full.add(elevationUnc: elevationUnc, &fbb)
    RFObservation_Full.add(elevationRate: elevationRate, &fbb)
    RFObservation_Full.add(range: range, &fbb)
    RFObservation_Full.add(rangeUnc: rangeUnc, &fbb)
    RFObservation_Full.add(rangeRate: rangeRate, &fbb)
    RFObservation_Full.add(rangeRateUnc: rangeRateUnc, &fbb)
    RFObservation_Full.add(trackRange: trackRange, &fbb)
    RFObservation_Full.add(senlat: senlat, &fbb)
    RFObservation_Full.add(senlon: senlon, &fbb)
    RFObservation_Full.add(senalt: senalt, &fbb)
    RFObservation_Full.add(elnot: elnot, &fbb)
    RFObservation_Full.add(frequency: frequency, &fbb)
    RFObservation_Full.add(nominalFrequency: nominalFrequency, &fbb)
    RFObservation_Full.add(startFrequency: startFrequency, &fbb)
    RFObservation_Full.add(endFrequency: endFrequency, &fbb)
    RFObservation_Full.add(relativeCarrierPower: relativeCarrierPower, &fbb)
    RFObservation_Full.add(spectrumAnalyzerPower: spectrumAnalyzerPower, &fbb)
    RFObservation_Full.add(relativeNoiseFloor: relativeNoiseFloor, &fbb)
    RFObservation_Full.add(referenceLevel: referenceLevel, &fbb)
    RFObservation_Full.add(pgri: pgri, &fbb)
    RFObservation_Full.add(confidence: confidence, &fbb)
    RFObservation_Full.add(incoming: incoming, &fbb)
    RFObservation_Full.add(switchPoint: switchPoint, &fbb)
    RFObservation_Full.add(baudRate: baudRate, &fbb)
    RFObservation_Full.add(snr: snr, &fbb)
    RFObservation_Full.add(nominalSnr: nominalSnr, &fbb)
    RFObservation_Full.add(polarity: polarity, &fbb)
    RFObservation_Full.add(polarityType: polarityType, &fbb)
    RFObservation_Full.add(channel: channel, &fbb)
    RFObservation_Full.add(powerOverNoise: powerOverNoise, &fbb)
    RFObservation_Full.add(nominalPowerOverNoise: nominalPowerOverNoise, &fbb)
    RFObservation_Full.add(bandwidth: bandwidth, &fbb)
    RFObservation_Full.add(nominalBandwidth: nominalBandwidth, &fbb)
    RFObservation_Full.add(resolutionBandwidth: resolutionBandwidth, &fbb)
    RFObservation_Full.add(videoBandwidth: videoBandwidth, &fbb)
    RFObservation_Full.add(eirp: eirp, &fbb)
    RFObservation_Full.add(nominalEirp: nominalEirp, &fbb)
    RFObservation_Full.add(minPsd: minPsd, &fbb)
    RFObservation_Full.add(maxPsd: maxPsd, &fbb)
    RFObservation_Full.add(frequencyShift: frequencyShift, &fbb)
    RFObservation_Full.add(peak: peak, &fbb)
    RFObservation_Full.add(antennaName: antennaName, &fbb)
    RFObservation_Full.add(detectionStatus: detectionStatus, &fbb)
    RFObservation_Full.add(collectionMode: collectionMode, &fbb)
    RFObservation_Full.add(rawFileUri: rawFileUri, &fbb)
    RFObservation_Full.add(source: source, &fbb)
    RFObservation_Full.add(origin: origin, &fbb)
    RFObservation_Full.add(dataMode: dataMode, &fbb)
    RFObservation_Full.addVectorOf(tags: tags, &fbb)
    RFObservation_Full.add(createdAt: createdAt, &fbb)
    RFObservation_Full.add(createdBy: createdBy, &fbb)
    RFObservation_Full.add(noisePwrDensity: noisePwrDensity, &fbb)
    RFObservation_Full.add(carrierStandard: carrierStandard, &fbb)
    RFObservation_Full.add(modulation: modulation, &fbb)
    RFObservation_Full.add(innerCodingRate: innerCodingRate, &fbb)
    RFObservation_Full.add(outerCodingRate: outerCodingRate, &fbb)
    RFObservation_Full.add(transmitFilterType: transmitFilterType, &fbb)
    RFObservation_Full.add(transmitFilterRollOff: transmitFilterRollOff, &fbb)
    RFObservation_Full.add(symbolToNoiseRatio: symbolToNoiseRatio, &fbb)
    RFObservation_Full.add(bitErrorRate: bitErrorRate, &fbb)
    RFObservation_Full.add(origNetwork: origNetwork, &fbb)
    RFObservation_Full.add(sourceDl: sourceDl, &fbb)
    RFObservation_Full.add(onOrbit: onOrbit, &fbb)
    RFObservation_Full.add(descriptor: descriptor, &fbb)
    RFObservation_Full.add(url: url, &fbb)
    return RFObservation_Full.endRFObservation_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.polarityType.p, fieldName: "polarityType", required: false, type: RFObservation_Full_polarityType_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: RFObservation_Full_dataMode_Enum.self)
