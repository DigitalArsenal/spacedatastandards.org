...
public enum SkyImagery_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SkyImagery_Ingest_dataMode_Enum { return .exercise }
  public static var min: SkyImagery_Ingest_dataMode_Enum { return .real }
}
...
public struct SkyImagery_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SkyImagery_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SkyImagery_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SkyImagery_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startSkyImagery_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 50) }
  ...
  public static func add(dataMode: SkyImagery_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endSkyImagery_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSkyImagery_Ingest(
    ...
    let __start = SkyImagery_Ingest.startSkyImagery_Ingest(&fbb)
    SkyImagery_Ingest.add(id: id, &fbb)
    SkyImagery_Ingest.add(classificationMarking: classificationMarking, &fbb)
    SkyImagery_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    SkyImagery_Ingest.add(origObjectId: origObjectId, &fbb)
    SkyImagery_Ingest.add(idAttitudeSet: idAttitudeSet, &fbb)
    SkyImagery_Ingest.add(idSensor: idSensor, &fbb)
    SkyImagery_Ingest.add(satNo: satNo, &fbb)
    SkyImagery_Ingest.add(origSensorId: origSensorId, &fbb)
    SkyImagery_Ingest.add(senlat: senlat, &fbb)
    SkyImagery_Ingest.add(senlon: senlon, &fbb)
    SkyImagery_Ingest.add(senalt: senalt, &fbb)
    SkyImagery_Ingest.add(senx: senx, &fbb)
    SkyImagery_Ingest.add(seny: seny, &fbb)
    SkyImagery_Ingest.add(senz: senz, &fbb)
    SkyImagery_Ingest.addVectorOf(senQuat: senQuat, &fbb)
    SkyImagery_Ingest.addVectorOf(senQuatDot: senQuatDot, &fbb)
    SkyImagery_Ingest.add(imageType: imageType, &fbb)
    SkyImagery_Ingest.add(expStartTime: expStartTime, &fbb)
    SkyImagery_Ingest.add(expEndTime: expEndTime, &fbb)
    SkyImagery_Ingest.add(imageSourceInfo: imageSourceInfo, &fbb)
    SkyImagery_Ingest.add(topLeftStartAz: topLeftStartAz, &fbb)
    SkyImagery_Ingest.add(topLeftStartEl: topLeftStartEl, &fbb)
    SkyImagery_Ingest.add(topLeftStopAz: topLeftStopAz, &fbb)
    SkyImagery_Ingest.add(topLeftStopEl: topLeftStopEl, &fbb)
    SkyImagery_Ingest.add(imageSetId: imageSetId, &fbb)
    SkyImagery_Ingest.add(imageSetLength: imageSetLength, &fbb)
    SkyImagery_Ingest.add(sequenceId: sequenceId, &fbb)
    SkyImagery_Ingest.add(frameFovwidth: frameFovwidth, &fbb)
    SkyImagery_Ingest.add(frameFovheight: frameFovheight, &fbb)
    SkyImagery_Ingest.add(pixelFovwidth: pixelFovwidth, &fbb)
    SkyImagery_Ingest.add(pixelFovheight: pixelFovheight, &fbb)
    SkyImagery_Ingest.add(frameWidthPixels: frameWidthPixels, &fbb)
    SkyImagery_Ingest.add(frameHeightPixels: frameHeightPixels, &fbb)
    SkyImagery_Ingest.add(pixelBitDepth: pixelBitDepth, &fbb)
    SkyImagery_Ingest.add(annotationKey: annotationKey, &fbb)
    SkyImagery_Ingest.add(calibrationKey: calibrationKey, &fbb)
    SkyImagery_Ingest.add(filename: filename, &fbb)
    SkyImagery_Ingest.add(filesize: filesize, &fbb)
    SkyImagery_Ingest.add(checksumValue: checksumValue, &fbb)
    SkyImagery_Ingest.add(transactionId: transactionId, &fbb)
    SkyImagery_Ingest.addVectorOf(tags: tags, &fbb)
    SkyImagery_Ingest.add(source: source, &fbb)
    SkyImagery_Ingest.add(origin: origin, &fbb)
    SkyImagery_Ingest.add(origNetwork: origNetwork, &fbb)
    SkyImagery_Ingest.add(sourceDl: sourceDl, &fbb)
    SkyImagery_Ingest.add(description: description, &fbb)
    SkyImagery_Ingest.add(dataMode: dataMode, &fbb)
    SkyImagery_Ingest.add(createdAt: createdAt, &fbb)
    SkyImagery_Ingest.add(createdBy: createdBy, &fbb)
    SkyImagery_Ingest.addVectorOf(eoObservations: eoObservations, &fbb)
    return SkyImagery_Ingest.endSkyImagery_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SkyImagery_Ingest_dataMode_Enum.self)
