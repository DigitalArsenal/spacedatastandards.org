...
public enum SOIObservationSet_Full_type_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SOIObservationSet_Full_type_Enum { return .radar }
  public static var min: SOIObservationSet_Full_type_Enum { return .optical }
}


public enum SOIObservationSet_Full_referenceFrame_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: SOIObservationSet_Full_referenceFrame_Enum { return .gcrf }
  public static var min: SOIObservationSet_Full_referenceFrame_Enum { return .j2000 }
}


public enum SOIObservationSet_Full_senReferenceFrame_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: SOIObservationSet_Full_senReferenceFrame_Enum { return .gcrf }
  public static var min: SOIObservationSet_Full_senReferenceFrame_Enum { return .j2000 }
}


public enum SOIObservationSet_Full_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: SOIObservationSet_Full_dataMode_Enum { return .exercise }
  public static var min: SOIObservationSet_Full_dataMode_Enum { return .real }
}


///  /// These services provide operations for posting space object idenfification observation sets.
public struct SOIObservationSet_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SOIObservationSet_Full.id, addPrefix: prefix) }
  ...
  public var type: SOIObservationSet_Full_type_Enum { let o = _accessor.offset(VTOFFSET.type.v); return o == 0 ? .optical : SOIObservationSet_Full_type_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .optical }
  ...
  public var referenceFrame: SOIObservationSet_Full_referenceFrame_Enum { let o = _accessor.offset(VTOFFSET.referenceFrame.v); return o == 0 ? .j2000 : SOIObservationSet_Full_referenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ///  The reference frame of the observing sensor state. If the senReferenceFrame is null it is assumed to be J2000.
  ///  Example: /// Example: J2000
  ///  Constraints: Minimum length = 0, Maximum length = 24
  public var senReferenceFrame: SOIObservationSet_Full_senReferenceFrame_Enum { let o = _accessor.offset(VTOFFSET.senReferenceFrame.v); return o == 0 ? .j2000 : SOIObservationSet_Full_senReferenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SOIObservationSet_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SOIObservationSet_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSOIObservationSet_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 73) }
  ...
  public static func add(type: SOIObservationSet_Full_type_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: type.rawValue, def: 0, at: VTOFFSET.type.p) }
  ...
  public static func add(referenceFrame: SOIObservationSet_Full_referenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: referenceFrame.rawValue, def: 0, at: VTOFFSET.referenceFrame.p) }
  public static func add(senReferenceFrame: SOIObservationSet_Full_senReferenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: senReferenceFrame.rawValue, def: 0, at: VTOFFSET.senReferenceFrame.p) }
  ...
  public static func add(dataMode: SOIObservationSet_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSOIObservationSet_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSOIObservationSet_Full(
    ...
    numObs: Int32 = 0,
    type: SOIObservationSet_Full_type_Enum = .optical,
    ...
    let __start = SOIObservationSet_Full.startSOIObservationSet_Full(&fbb)
    SOIObservationSet_Full.add(id: id, &fbb)
    SOIObservationSet_Full.add(classificationMarking: classificationMarking, &fbb)
    SOIObservationSet_Full.add(msgCreateDate: msgCreateDate, &fbb)
    SOIObservationSet_Full.add(idSensor: idSensor, &fbb)
    SOIObservationSet_Full.add(origSensorId: origSensorId, &fbb)
    SOIObservationSet_Full.add(sensorAsId: sensorAsId, &fbb)
    SOIObservationSet_Full.add(idOnOrbit: idOnOrbit, &fbb)
    SOIObservationSet_Full.add(satNo: satNo, &fbb)
    SOIObservationSet_Full.add(origObjectId: origObjectId, &fbb)
    SOIObservationSet_Full.add(senlat: senlat, &fbb)
    SOIObservationSet_Full.add(senlon: senlon, &fbb)
    SOIObservationSet_Full.add(senalt: senalt, &fbb)
    SOIObservationSet_Full.add(senx: senx, &fbb)
    SOIObservationSet_Full.add(seny: seny, &fbb)
    SOIObservationSet_Full.add(senz: senz, &fbb)
    SOIObservationSet_Full.add(senvelx: senvelx, &fbb)
    SOIObservationSet_Full.add(senvely: senvely, &fbb)
    SOIObservationSet_Full.add(senvelz: senvelz, &fbb)
    SOIObservationSet_Full.add(idElset: idElset, &fbb)
    SOIObservationSet_Full.add(startTime: startTime, &fbb)
    SOIObservationSet_Full.add(endTime: endTime, &fbb)
    SOIObservationSet_Full.add(numObs: numObs, &fbb)
    SOIObservationSet_Full.add(type: type, &fbb)
    SOIObservationSet_Full.add(polarAngleStart: polarAngleStart, &fbb)
    SOIObservationSet_Full.add(polarAngleEnd: polarAngleEnd, &fbb)
    SOIObservationSet_Full.add(referenceFrame: referenceFrame, &fbb)
    SOIObservationSet_Full.add(senReferenceFrame: senReferenceFrame, &fbb)
    SOIObservationSet_Full.add(losDeclinationStart: losDeclinationStart, &fbb)
    SOIObservationSet_Full.add(losDeclinationEnd: losDeclinationEnd, &fbb)
    SOIObservationSet_Full.add(pointingAngleAzStart: pointingAngleAzStart, &fbb)
    SOIObservationSet_Full.add(pointingAngleAzEnd: pointingAngleAzEnd, &fbb)
    SOIObservationSet_Full.add(pointingAngleElStart: pointingAngleElStart, &fbb)
    SOIObservationSet_Full.add(pointingAngleElEnd: pointingAngleElEnd, &fbb)
    SOIObservationSet_Full.add(pixelArrayWidth: pixelArrayWidth, &fbb)
    SOIObservationSet_Full.add(pixelArrayHeight: pixelArrayHeight, &fbb)
    SOIObservationSet_Full.add(numSpectralFilters: numSpectralFilters, &fbb)
    SOIObservationSet_Full.addVectorOf(spectralFilters: spectralFilters, &fbb)
    SOIObservationSet_Full.add(collectionMode: collectionMode, &fbb)
    SOIObservationSet_Full.add(gain: gain, &fbb)
    SOIObservationSet_Full.add(binningHoriz: binningHoriz, &fbb)
    SOIObservationSet_Full.add(binningVert: binningVert, &fbb)
    SOIObservationSet_Full.add(solarMag: solarMag, &fbb)
    SOIObservationSet_Full.add(pixelMin: pixelMin, &fbb)
    SOIObservationSet_Full.add(pixelMax: pixelMax, &fbb)
    SOIObservationSet_Full.add(softwareVersion: softwareVersion, &fbb)
    SOIObservationSet_Full.add(satelliteName: satelliteName, &fbb)
    SOIObservationSet_Full.add(starCatName: starCatName, &fbb)
    SOIObservationSet_Full.add(corrQuality: corrQuality, &fbb)
    SOIObservationSet_Full.add(uct: uct, &fbb)
    SOIObservationSet_Full.add(validCalibrations: validCalibrations, &fbb)
    SOIObservationSet_Full.add(calibrationType: calibrationType, &fbb)
    SOIObservationSet_Full.add(percentSatThreshold: percentSatThreshold, &fbb)
    SOIObservationSet_Full.add(changeDetected: changeDetected, &fbb)
    SOIObservationSet_Full.add(periodicityChangeDetected: periodicityChangeDetected, &fbb)
    SOIObservationSet_Full.add(brightnessVarianceChangeDetected: brightnessVarianceChangeDetected, &fbb)
    SOIObservationSet_Full.add(solarPhaseAngleBrightnessChangeDetected: solarPhaseAngleBrightnessChangeDetected, &fbb)
    SOIObservationSet_Full.add(changeConf: changeConf, &fbb)
    SOIObservationSet_Full.add(collectionDensityConf: collectionDensityConf, &fbb)
    SOIObservationSet_Full.add(periodicitySamplingConf: periodicitySamplingConf, &fbb)
    SOIObservationSet_Full.add(periodicityDetectionConf: periodicityDetectionConf, &fbb)
    SOIObservationSet_Full.add(collectionId: collectionId, &fbb)
    SOIObservationSet_Full.addVectorOf(calibrations: calibrations, &fbb)
    SOIObservationSet_Full.addVectorOf(tags: tags, &fbb)
    SOIObservationSet_Full.add(transactionId: transactionId, &fbb)
    SOIObservationSet_Full.addVectorOf(opticalSoiobservationList: opticalSoiobservationList, &fbb)
    SOIObservationSet_Full.addVectorOf(radarSoiobservationList: radarSoiobservationList, &fbb)
    SOIObservationSet_Full.add(createdAt: createdAt, &fbb)
    SOIObservationSet_Full.add(createdBy: createdBy, &fbb)
    SOIObservationSet_Full.add(source: source, &fbb)
    SOIObservationSet_Full.add(origin: origin, &fbb)
    SOIObservationSet_Full.add(origNetwork: origNetwork, &fbb)
    SOIObservationSet_Full.add(sourceDl: sourceDl, &fbb)
    SOIObservationSet_Full.add(dataMode: dataMode, &fbb)
    return SOIObservationSet_Full.endSOIObservationSet_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.type.p, fieldName: "type", required: false, type: SOIObservationSet_Full_type_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.referenceFrame.p, fieldName: "referenceFrame", required: false, type: SOIObservationSet_Full_referenceFrame_Enum.self)
    try _v.visit(field: VTOFFSET.senReferenceFrame.p, fieldName: "senReferenceFrame", required: false, type: SOIObservationSet_Full_senReferenceFrame_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SOIObservationSet_Full_dataMode_Enum.self)
    _v.finish()
  }
}
