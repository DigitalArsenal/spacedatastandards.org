...
public struct LogisticsStocks_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LogisticsStocks_Abridged.id, addPrefix: prefix) }
  ...
  public static func startLogisticsStocks_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endLogisticsStocks_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLogisticsStocks_Abridged(
    ...
    let __start = LogisticsStocks_Abridged.startLogisticsStocks_Abridged(&fbb)
    LogisticsStocks_Abridged.add(sourceIcao: sourceIcao, &fbb)
    LogisticsStocks_Abridged.add(quantity: quantity, &fbb)
    LogisticsStocks_Abridged.add(stockCheckTime: stockCheckTime, &fbb)
    LogisticsStocks_Abridged.add(stockPoc: stockPoc, &fbb)
    return LogisticsStocks_Abridged.endLogisticsStocks_Abridged(&fbb, start: __start)
  }
