...
public enum LogisticsSupport_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: LogisticsSupport_Full_dataMode_Enum { return .exercise }
  public static var min: LogisticsSupport_Full_dataMode_Enum { return .real }
}
...
public struct LogisticsSupport_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LogisticsSupport_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: LogisticsSupport_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : LogisticsSupport_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startLogisticsSupport_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 30) }
  ...
  public static func add(dataMode: LogisticsSupport_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endLogisticsSupport_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLogisticsSupport_Full(
    ...
    let __start = LogisticsSupport_Full.startLogisticsSupport_Full(&fbb)
    LogisticsSupport_Full.add(id: id, &fbb)
    LogisticsSupport_Full.add(classificationMarking: classificationMarking, &fbb)
    LogisticsSupport_Full.add(extSystemId: extSystemId, &fbb)
    LogisticsSupport_Full.add(tailNumber: tailNumber, &fbb)
    LogisticsSupport_Full.add(aircraftMds: aircraftMds, &fbb)
    LogisticsSupport_Full.add(currIcao: currIcao, &fbb)
    LogisticsSupport_Full.add(suppIcao: suppIcao, &fbb)
    LogisticsSupport_Full.add(rptCreatedTime: rptCreatedTime, &fbb)
    LogisticsSupport_Full.add(rptClosedTime: rptClosedTime, &fbb)
    LogisticsSupport_Full.add(meTime: meTime, &fbb)
    LogisticsSupport_Full.add(mcTime: mcTime, &fbb)
    LogisticsSupport_Full.add(logisticAction: logisticAction, &fbb)
    LogisticsSupport_Full.add(logisticsRecordId: logisticsRecordId, &fbb)
    LogisticsSupport_Full.add(etic: etic, &fbb)
    LogisticsSupport_Full.add(etmc: etmc, &fbb)
    LogisticsSupport_Full.add(maintStatusCode: maintStatusCode, &fbb)
    LogisticsSupport_Full.add(reopenFlag: reopenFlag, &fbb)
    LogisticsSupport_Full.add(owner: owner, &fbb)
    LogisticsSupport_Full.addVectorOf(logisticsRemarks: logisticsRemarks, &fbb)
    LogisticsSupport_Full.addVectorOf(logisticsDiscrepancyInfos: logisticsDiscrepancyInfos, &fbb)
    LogisticsSupport_Full.addVectorOf(logisticsTransportationPlans: logisticsTransportationPlans, &fbb)
    LogisticsSupport_Full.addVectorOf(logisticsSupportItems: logisticsSupportItems, &fbb)
    LogisticsSupport_Full.add(origNetwork: origNetwork, &fbb)
    LogisticsSupport_Full.add(createdAt: createdAt, &fbb)
    LogisticsSupport_Full.add(createdBy: createdBy, &fbb)
    LogisticsSupport_Full.add(updatedAt: updatedAt, &fbb)
    LogisticsSupport_Full.add(updatedBy: updatedBy, &fbb)
    LogisticsSupport_Full.add(source: source, &fbb)
    LogisticsSupport_Full.add(origin: origin, &fbb)
    LogisticsSupport_Full.add(dataMode: dataMode, &fbb)
    return LogisticsSupport_Full.endLogisticsSupport_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: LogisticsSupport_Full_dataMode_Enum.self)
    _v.finish()
  }
}
