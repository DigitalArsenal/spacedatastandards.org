...
public struct AircraftMissionRequirements_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AircraftMissionRequirements_Ingest.id, addPrefix: prefix) }
  ...
  public static func startAircraftMissionRequirements_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 18) }
  ...
  public static func endAircraftMissionRequirements_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAircraftMissionRequirements_Ingest(
    ...
    let __start = AircraftMissionRequirements_Ingest.startAircraftMissionRequirements_Ingest(&fbb)
    AircraftMissionRequirements_Ingest.add(gdssReqId: gdssReqId, &fbb)
    AircraftMissionRequirements_Ingest.add(onloadId: onloadId, &fbb)
    AircraftMissionRequirements_Ingest.add(onloadLocode: onloadLocode, &fbb)
    AircraftMissionRequirements_Ingest.add(offloadId: offloadId, &fbb)
    AircraftMissionRequirements_Ingest.add(offloadLocode: offloadLocode, &fbb)
    AircraftMissionRequirements_Ingest.add(uln: uln, &fbb)
    AircraftMissionRequirements_Ingest.add(transReqNum: transReqNum, &fbb)
    AircraftMissionRequirements_Ingest.add(projName: projName, &fbb)
    AircraftMissionRequirements_Ingest.add(oplan: oplan, &fbb)
    AircraftMissionRequirements_Ingest.add(numPax: numPax, &fbb)
    AircraftMissionRequirements_Ingest.add(numLitter: numLitter, &fbb)
    AircraftMissionRequirements_Ingest.add(numAmbulatory: numAmbulatory, &fbb)
    AircraftMissionRequirements_Ingest.add(numAttendant: numAttendant, &fbb)
    AircraftMissionRequirements_Ingest.add(bulkWeight: bulkWeight, &fbb)
    AircraftMissionRequirements_Ingest.add(oversizeWeight: oversizeWeight, &fbb)
    AircraftMissionRequirements_Ingest.add(outsizeWeight: outsizeWeight, &fbb)
    AircraftMissionRequirements_Ingest.add(ead: ead, &fbb)
    AircraftMissionRequirements_Ingest.add(lad: lad, &fbb)
    return AircraftMissionRequirements_Ingest.endAircraftMissionRequirements_Ingest(&fbb, start: __start)
  }
