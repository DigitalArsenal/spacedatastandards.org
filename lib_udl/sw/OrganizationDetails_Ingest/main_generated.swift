...
public enum OrganizationDetails_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OrganizationDetails_Ingest_dataMode_Enum { return .exercise }
  public static var min: OrganizationDetails_Ingest_dataMode_Enum { return .real }
}


///  /// Model representation of additional detailed organization data as collected by a particular source.
public struct OrganizationDetails_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OrganizationDetails_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: OrganizationDetails_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OrganizationDetails_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOrganizationDetails_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 37) }
  ...
  public static func add(dataMode: OrganizationDetails_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endOrganizationDetails_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOrganizationDetails_Ingest(
    ...
    let __start = OrganizationDetails_Ingest.startOrganizationDetails_Ingest(&fbb)
    OrganizationDetails_Ingest.add(id: id, &fbb)
    OrganizationDetails_Ingest.add(idOrganization: idOrganization, &fbb)
    OrganizationDetails_Ingest.add(classificationMarking: classificationMarking, &fbb)
    OrganizationDetails_Ingest.add(name: name, &fbb)
    OrganizationDetails_Ingest.add(email: email, &fbb)
    OrganizationDetails_Ingest.add(address1: address1, &fbb)
    OrganizationDetails_Ingest.add(address2: address2, &fbb)
    OrganizationDetails_Ingest.add(address3: address3, &fbb)
    OrganizationDetails_Ingest.add(geoAdminLevel1: geoAdminLevel1, &fbb)
    OrganizationDetails_Ingest.add(geoAdminLevel2: geoAdminLevel2, &fbb)
    OrganizationDetails_Ingest.add(geoAdminLevel3: geoAdminLevel3, &fbb)
    OrganizationDetails_Ingest.add(postalCode: postalCode, &fbb)
    OrganizationDetails_Ingest.add(description: description, &fbb)
    OrganizationDetails_Ingest.add(formerOrgId: formerOrgId, &fbb)
    OrganizationDetails_Ingest.add(parentOrgId: parentOrgId, &fbb)
    OrganizationDetails_Ingest.add(financialYearEndDate: financialYearEndDate, &fbb)
    OrganizationDetails_Ingest.add(revenue: revenue, &fbb)
    OrganizationDetails_Ingest.add(profit: profit, &fbb)
    OrganizationDetails_Ingest.add(ebitda: ebitda, &fbb)
    OrganizationDetails_Ingest.add(ftes: ftes, &fbb)
    OrganizationDetails_Ingest.add(broker: broker, &fbb)
    OrganizationDetails_Ingest.add(ceo: ceo, &fbb)
    OrganizationDetails_Ingest.add(cfo: cfo, &fbb)
    OrganizationDetails_Ingest.add(cto: cto, &fbb)
    OrganizationDetails_Ingest.add(riskManager: riskManager, &fbb)
    OrganizationDetails_Ingest.add(massRanking: massRanking, &fbb)
    OrganizationDetails_Ingest.add(revenueRanking: revenueRanking, &fbb)
    OrganizationDetails_Ingest.add(financialNotes: financialNotes, &fbb)
    OrganizationDetails_Ingest.add(servicesNotes: servicesNotes, &fbb)
    OrganizationDetails_Ingest.add(fleetPlanNotes: fleetPlanNotes, &fbb)
    OrganizationDetails_Ingest.add(source: source, &fbb)
    OrganizationDetails_Ingest.add(origin: origin, &fbb)
    OrganizationDetails_Ingest.add(dataMode: dataMode, &fbb)
    OrganizationDetails_Ingest.addVectorOf(tags: tags, &fbb)
    OrganizationDetails_Ingest.add(createdAt: createdAt, &fbb)
    OrganizationDetails_Ingest.add(createdBy: createdBy, &fbb)
    OrganizationDetails_Ingest.add(origNetwork: origNetwork, &fbb)
    return OrganizationDetails_Ingest.endOrganizationDetails_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OrganizationDetails_Ingest_dataMode_Enum.self)
