...
public enum Entity_Abridged_type_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Entity_Abridged_type_Enum { return .vessel }
  public static var min: Entity_Abridged_type_Enum { return .aircraft }
}


public enum Entity_Abridged_ownerType_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: Entity_Abridged_ownerType_Enum { return .other }
  public static var min: Entity_Abridged_ownerType_Enum { return .commercial }
}


public enum Entity_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: Entity_Abridged_dataMode_Enum { return .exercise }
  public static var min: Entity_Abridged_dataMode_Enum { return .real }
}
...
public struct Entity_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Entity_Abridged.id, addPrefix: prefix) }
  ...
  public var type: Entity_Abridged_type_Enum { let o = _accessor.offset(VTOFFSET.type.v); return o == 0 ? .aircraft : Entity_Abridged_type_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .aircraft }
  ...
  public var ownerType: Entity_Abridged_ownerType_Enum { let o = _accessor.offset(VTOFFSET.ownerType.v); return o == 0 ? .commercial : Entity_Abridged_ownerType_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .commercial }
  ...
  public var dataMode: Entity_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Entity_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startEntity_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 18) }
  ...
  public static func add(type: Entity_Abridged_type_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: type.rawValue, def: 0, at: VTOFFSET.type.p) }
  ...
  public static func add(ownerType: Entity_Abridged_ownerType_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: ownerType.rawValue, def: 0, at: VTOFFSET.ownerType.p) }
  ...
  public static func add(dataMode: Entity_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endEntity_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEntity_Abridged(
    _ fbb: inout FlatBufferBuilder,
    idEntityOffset idEntity: Offset = Offset(),
    nameOffset name: Offset = Offset(),
    classificationMarkingOffset classificationMarking: Offset = Offset(),
    type: Entity_Abridged_type_Enum = .aircraft,
    ...
    let __start = Entity_Abridged.startEntity_Abridged(&fbb)
    Entity_Abridged.add(idEntity: idEntity, &fbb)
    Entity_Abridged.add(name: name, &fbb)
    Entity_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Entity_Abridged.add(type: type, &fbb)
    Entity_Abridged.add(idLocation: idLocation, &fbb)
    Entity_Abridged.add(countryCode: countryCode, &fbb)
    Entity_Abridged.add(ownerType: ownerType, &fbb)
    Entity_Abridged.add(taskable: taskable, &fbb)
    Entity_Abridged.add(createdAt: createdAt, &fbb)
    Entity_Abridged.add(createdBy: createdBy, &fbb)
    Entity_Abridged.add(source: source, &fbb)
    Entity_Abridged.add(origin: origin, &fbb)
    Entity_Abridged.add(dataMode: dataMode, &fbb)
    Entity_Abridged.add(location: location, &fbb)
    Entity_Abridged.add(onOrbit: onOrbit, &fbb)
    Entity_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    Entity_Abridged.add(idOperatingUnit: idOperatingUnit, &fbb)
    Entity_Abridged.add(origNetwork: origNetwork, &fbb)
    return Entity_Abridged.endEntity_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.type.p, fieldName: "type", required: false, type: Entity_Abridged_type_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.ownerType.p, fieldName: "ownerType", required: false, type: Entity_Abridged_ownerType_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Entity_Abridged_dataMode_Enum.self)
