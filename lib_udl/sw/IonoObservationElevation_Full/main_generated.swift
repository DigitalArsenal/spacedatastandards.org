...
public struct IonoObservationElevation_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationElevation_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationElevation_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationElevation_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationElevation_Full(
    ...
    let __start = IonoObservationElevation_Full.startIonoObservationElevation_Full(&fbb)
    IonoObservationElevation_Full.add(notes: notes, &fbb)
    IonoObservationElevation_Full.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationElevation_Full.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationElevation_Full.addVectorOf(data: data, &fbb)
    return IonoObservationElevation_Full.endIonoObservationElevation_Full(&fbb, start: __start)
  }
