...
public struct IonoObservationScalerInfo_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationScalerInfo_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationScalerInfo_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 6) }
  ...
  public static func endIonoObservationScalerInfo_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationScalerInfo_Ingest(
    ...
    let __start = IonoObservationScalerInfo_Ingest.startIonoObservationScalerInfo_Ingest(&fbb)
    IonoObservationScalerInfo_Ingest.add(type: type, &fbb)
    IonoObservationScalerInfo_Ingest.add(name: name, &fbb)
    IonoObservationScalerInfo_Ingest.add(organization: organization, &fbb)
    IonoObservationScalerInfo_Ingest.add(version: version, &fbb)
    IonoObservationScalerInfo_Ingest.add(confidenceScore: confidenceScore, &fbb)
    IonoObservationScalerInfo_Ingest.add(confidenceLevel: confidenceLevel, &fbb)
    return IonoObservationScalerInfo_Ingest.endIonoObservationScalerInfo_Ingest(&fbb, start: __start)
  }
