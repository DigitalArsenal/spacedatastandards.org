...
public struct IonoObservationElevation_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationElevation_Abridged.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationElevation_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationElevation_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationElevation_Abridged(
    ...
    let __start = IonoObservationElevation_Abridged.startIonoObservationElevation_Abridged(&fbb)
    IonoObservationElevation_Abridged.add(notes: notes, &fbb)
    IonoObservationElevation_Abridged.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationElevation_Abridged.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationElevation_Abridged.addVectorOf(data: data, &fbb)
    return IonoObservationElevation_Abridged.endIonoObservationElevation_Abridged(&fbb, start: __start)
  }
