...
public struct EvacEnemyData_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacEnemyData_Ingest.id, addPrefix: prefix) }
  ...
  public static func startEvacEnemyData_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endEvacEnemyData_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacEnemyData_Ingest(
    ...
    let __start = EvacEnemyData_Ingest.startEvacEnemyData_Ingest(&fbb)
    EvacEnemyData_Ingest.add(dirToEnemy: dirToEnemy, &fbb)
    EvacEnemyData_Ingest.add(hostileFireType: hostileFireType, &fbb)
    EvacEnemyData_Ingest.add(friendliesRemarks: friendliesRemarks, &fbb)
    EvacEnemyData_Ingest.add(hlzRemarks: hlzRemarks, &fbb)
    return EvacEnemyData_Ingest.endEvacEnemyData_Ingest(&fbb, start: __start)
  }
