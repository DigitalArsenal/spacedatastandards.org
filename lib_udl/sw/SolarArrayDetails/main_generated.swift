...
public enum SolarArrayDetails_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SolarArrayDetails_dataMode_Enum { return .exercise }
  public static var min: SolarArrayDetails_dataMode_Enum { return .real }
}
...
public struct SolarArrayDetails: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SolarArrayDetails.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SolarArrayDetails_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SolarArrayDetails_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startSolarArrayDetails(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 20) }
  ...
  public static func add(dataMode: SolarArrayDetails_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endSolarArrayDetails(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSolarArrayDetails(
    ...
    let __start = SolarArrayDetails.startSolarArrayDetails(&fbb)
    SolarArrayDetails.add(id: id, &fbb)
    SolarArrayDetails.add(idSolarArray: idSolarArray, &fbb)
    SolarArrayDetails.add(classificationMarking: classificationMarking, &fbb)
    SolarArrayDetails.add(type: type, &fbb)
    SolarArrayDetails.add(technology: technology, &fbb)
    SolarArrayDetails.add(junctionTechnology: junctionTechnology, &fbb)
    SolarArrayDetails.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    SolarArrayDetails.add(span: span, &fbb)
    SolarArrayDetails.add(area: area, &fbb)
    SolarArrayDetails.add(description: description, &fbb)
    SolarArrayDetails.add(createdAt: createdAt, &fbb)
    SolarArrayDetails.add(createdBy: createdBy, &fbb)
    SolarArrayDetails.add(updatedAt: updatedAt, &fbb)
    SolarArrayDetails.add(updatedBy: updatedBy, &fbb)
    SolarArrayDetails.add(source: source, &fbb)
    SolarArrayDetails.add(origin: origin, &fbb)
    SolarArrayDetails.add(origNetwork: origNetwork, &fbb)
    SolarArrayDetails.add(dataMode: dataMode, &fbb)
    SolarArrayDetails.addVectorOf(tags: tags, &fbb)
    SolarArrayDetails.add(manufacturerOrg: manufacturerOrg, &fbb)
    return SolarArrayDetails.endSolarArrayDetails(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SolarArrayDetails_dataMode_Enum.self)
