...
public struct AirspaceControlOrderReference_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirspaceControlOrderReference_Full.id, addPrefix: prefix) }
  ...
  public static func startAirspaceControlOrderReference_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 7) }
  ...
  public static func endAirspaceControlOrderReference_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirspaceControlOrderReference_Full(
    ...
    let __start = AirspaceControlOrderReference_Full.startAirspaceControlOrderReference_Full(&fbb)
    AirspaceControlOrderReference_Full.add(refSid: refSid, &fbb)
    AirspaceControlOrderReference_Full.add(refType: refType, &fbb)
    AirspaceControlOrderReference_Full.add(refOriginator: refOriginator, &fbb)
    AirspaceControlOrderReference_Full.add(refTs: refTs, &fbb)
    AirspaceControlOrderReference_Full.add(refSerialNum: refSerialNum, &fbb)
    AirspaceControlOrderReference_Full.add(refSpecialNotation: refSpecialNotation, &fbb)
    AirspaceControlOrderReference_Full.addVectorOf(refSics: refSics, &fbb)
    return AirspaceControlOrderReference_Full.endAirspaceControlOrderReference_Full(&fbb, start: __start)
  }
