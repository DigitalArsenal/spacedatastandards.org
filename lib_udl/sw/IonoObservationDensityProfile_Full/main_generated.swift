...
public struct IonoObservationDensityProfile_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDensityProfile_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDensityProfile_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 8) }
  ...
  public static func endIonoObservationDensityProfile_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDensityProfile_Full(
    ...
    let __start = IonoObservationDensityProfile_Full.startIonoObservationDensityProfile_Full(&fbb)
    IonoObservationDensityProfile_Full.add(parabolic: parabolic, &fbb)
    IonoObservationDensityProfile_Full.add(quasiParabolic: quasiParabolic, &fbb)
    IonoObservationDensityProfile_Full.add(valleyModelDescription: valleyModelDescription, &fbb)
    IonoObservationDensityProfile_Full.addVectorOf(valleyModelCoeffs: valleyModelCoeffs, &fbb)
    IonoObservationDensityProfile_Full.add(shiftedChebyshev: shiftedChebyshev, &fbb)
    IonoObservationDensityProfile_Full.add(topsideExtensionChapmanConst: topsideExtensionChapmanConst, &fbb)
    IonoObservationDensityProfile_Full.add(topsideExtensionVaryChap: topsideExtensionVaryChap, &fbb)
    IonoObservationDensityProfile_Full.add(iri: iri, &fbb)
    return IonoObservationDensityProfile_Full.endIonoObservationDensityProfile_Full(&fbb, start: __start)
  }
