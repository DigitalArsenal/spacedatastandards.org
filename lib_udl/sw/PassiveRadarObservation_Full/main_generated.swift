...
public enum PassiveRadarObservation_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: PassiveRadarObservation_Full_dataMode_Enum { return .exercise }
  public static var min: PassiveRadarObservation_Full_dataMode_Enum { return .real }
}
...
public struct PassiveRadarObservation_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: PassiveRadarObservation_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: PassiveRadarObservation_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : PassiveRadarObservation_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startPassiveRadarObservation_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 68) }
  ...
  public static func add(dataMode: PassiveRadarObservation_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endPassiveRadarObservation_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPassiveRadarObservation_Full(
    ...
    let __start = PassiveRadarObservation_Full.startPassiveRadarObservation_Full(&fbb)
    PassiveRadarObservation_Full.add(id: id, &fbb)
    PassiveRadarObservation_Full.add(classificationMarking: classificationMarking, &fbb)
    PassiveRadarObservation_Full.add(obTime: obTime, &fbb)
    PassiveRadarObservation_Full.add(idOnOrbit: idOnOrbit, &fbb)
    PassiveRadarObservation_Full.add(satNo: satNo, &fbb)
    PassiveRadarObservation_Full.add(origObjectId: origObjectId, &fbb)
    PassiveRadarObservation_Full.add(idSensor: idSensor, &fbb)
    PassiveRadarObservation_Full.add(origSensorId: origSensorId, &fbb)
    PassiveRadarObservation_Full.add(idRfemitter: idRfemitter, &fbb)
    PassiveRadarObservation_Full.add(idSensorRefReceiver: idSensorRefReceiver, &fbb)
    PassiveRadarObservation_Full.add(extObservationId: extObservationId, &fbb)
    PassiveRadarObservation_Full.add(taskId: taskId, &fbb)
    PassiveRadarObservation_Full.add(trackId: trackId, &fbb)
    PassiveRadarObservation_Full.add(obPosition: obPosition, &fbb)
    PassiveRadarObservation_Full.add(uct: uct, &fbb)
    PassiveRadarObservation_Full.add(azimuth: azimuth, &fbb)
    PassiveRadarObservation_Full.add(azimuthUnc: azimuthUnc, &fbb)
    PassiveRadarObservation_Full.add(azimuthBias: azimuthBias, &fbb)
    PassiveRadarObservation_Full.add(azimuthRate: azimuthRate, &fbb)
    PassiveRadarObservation_Full.add(elevation: elevation, &fbb)
    PassiveRadarObservation_Full.add(elevationUnc: elevationUnc, &fbb)
    PassiveRadarObservation_Full.add(elevationBias: elevationBias, &fbb)
    PassiveRadarObservation_Full.add(elevationRate: elevationRate, &fbb)
    PassiveRadarObservation_Full.add(delay: delay, &fbb)
    PassiveRadarObservation_Full.add(delayUnc: delayUnc, &fbb)
    PassiveRadarObservation_Full.add(delayBias: delayBias, &fbb)
    PassiveRadarObservation_Full.add(bistaticRange: bistaticRange, &fbb)
    PassiveRadarObservation_Full.add(bistaticRangeUnc: bistaticRangeUnc, &fbb)
    PassiveRadarObservation_Full.add(bistaticRangeBias: bistaticRangeBias, &fbb)
    PassiveRadarObservation_Full.add(bistaticRangeRate: bistaticRangeRate, &fbb)
    PassiveRadarObservation_Full.add(bistaticRangeRateUnc: bistaticRangeRateUnc, &fbb)
    PassiveRadarObservation_Full.add(bistaticRangeAccel: bistaticRangeAccel, &fbb)
    PassiveRadarObservation_Full.add(bistaticRangeAccelUnc: bistaticRangeAccelUnc, &fbb)
    PassiveRadarObservation_Full.add(doppler: doppler, &fbb)
    PassiveRadarObservation_Full.add(dopplerUnc: dopplerUnc, &fbb)
    PassiveRadarObservation_Full.add(coning: coning, &fbb)
    PassiveRadarObservation_Full.add(coningUnc: coningUnc, &fbb)
    PassiveRadarObservation_Full.add(tof: tof, &fbb)
    PassiveRadarObservation_Full.add(tofUnc: tofUnc, &fbb)
    PassiveRadarObservation_Full.add(tofBias: tofBias, &fbb)
    PassiveRadarObservation_Full.add(accel: accel, &fbb)
    PassiveRadarObservation_Full.add(accelUnc: accelUnc, &fbb)
    PassiveRadarObservation_Full.add(ra: ra, &fbb)
    PassiveRadarObservation_Full.add(declination: declination, &fbb)
    PassiveRadarObservation_Full.add(lat: lat, &fbb)
    PassiveRadarObservation_Full.add(lon: lon, &fbb)
    PassiveRadarObservation_Full.add(alt: alt, &fbb)
    PassiveRadarObservation_Full.add(xvel: xvel, &fbb)
    PassiveRadarObservation_Full.add(yvel: yvel, &fbb)
    PassiveRadarObservation_Full.add(zvel: zvel, &fbb)
    PassiveRadarObservation_Full.add(rcs: rcs, &fbb)
    PassiveRadarObservation_Full.add(rcsUnc: rcsUnc, &fbb)
    PassiveRadarObservation_Full.add(orthogonalRcs: orthogonalRcs, &fbb)
    PassiveRadarObservation_Full.add(orthogonalRcsUnc: orthogonalRcsUnc, &fbb)
    PassiveRadarObservation_Full.add(snr: snr, &fbb)
    PassiveRadarObservation_Full.add(timingBias: timingBias, &fbb)
    PassiveRadarObservation_Full.addVectorOf(tags: tags, &fbb)
    PassiveRadarObservation_Full.add(transactionId: transactionId, &fbb)
    PassiveRadarObservation_Full.add(descriptor: descriptor, &fbb)
    PassiveRadarObservation_Full.add(createdAt: createdAt, &fbb)
    PassiveRadarObservation_Full.add(createdBy: createdBy, &fbb)
    PassiveRadarObservation_Full.add(source: source, &fbb)
    PassiveRadarObservation_Full.add(origin: origin, &fbb)
    PassiveRadarObservation_Full.add(origNetwork: origNetwork, &fbb)
    PassiveRadarObservation_Full.add(sourceDl: sourceDl, &fbb)
    PassiveRadarObservation_Full.add(dataMode: dataMode, &fbb)
    PassiveRadarObservation_Full.add(onOrbit: onOrbit, &fbb)
    PassiveRadarObservation_Full.add(type: type, &fbb)
    return PassiveRadarObservation_Full.endPassiveRadarObservation_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: PassiveRadarObservation_Full_dataMode_Enum.self)
