...
public struct EvacEnemyData_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacEnemyData_Full.id, addPrefix: prefix) }
  ...
  public static func startEvacEnemyData_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endEvacEnemyData_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacEnemyData_Full(
    ...
    let __start = EvacEnemyData_Full.startEvacEnemyData_Full(&fbb)
    EvacEnemyData_Full.add(dirToEnemy: dirToEnemy, &fbb)
    EvacEnemyData_Full.add(hostileFireType: hostileFireType, &fbb)
    EvacEnemyData_Full.add(friendliesRemarks: friendliesRemarks, &fbb)
    EvacEnemyData_Full.add(hlzRemarks: hlzRemarks, &fbb)
    return EvacEnemyData_Full.endEvacEnemyData_Full(&fbb, start: __start)
  }
