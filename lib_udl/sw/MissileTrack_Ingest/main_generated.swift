...
public enum MissileTrack_Ingest_env_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: MissileTrack_Ingest_env_Enum { return .unknown }
  public static var min: MissileTrack_Ingest_env_Enum { return .air }
}


public enum MissileTrack_Ingest_objIdent_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: MissileTrack_Ingest_objIdent_Enum { return .unknown }
  public static var min: MissileTrack_Ingest_objIdent_Enum { return .assumedFriend }
}


public enum MissileTrack_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: MissileTrack_Ingest_dataMode_Enum { return .exercise }
  public static var min: MissileTrack_Ingest_dataMode_Enum { return .real }
}
...
public struct MissileTrack_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MissileTrack_Ingest.id, addPrefix: prefix) }
  ...
  ///  Example: /// Example: AIR
  ///  Constraints: Minimum length = 0, Maximum length = 16
  public var env: MissileTrack_Ingest_env_Enum { let o = _accessor.offset(VTOFFSET.env.v); return o == 0 ? .air : MissileTrack_Ingest_env_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .air }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 32
  public var objIdent: MissileTrack_Ingest_objIdent_Enum { let o = _accessor.offset(VTOFFSET.objIdent.v); return o == 0 ? .assumedFriend : MissileTrack_Ingest_objIdent_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .assumedFriend }
  ...
  public var dataMode: MissileTrack_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : MissileTrack_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startMissileTrack_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 57) }
  ...
  public static func add(env: MissileTrack_Ingest_env_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: env.rawValue, def: 0, at: VTOFFSET.env.p) }
  ...
  public static func add(objIdent: MissileTrack_Ingest_objIdent_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: objIdent.rawValue, def: 0, at: VTOFFSET.objIdent.p) }
  ...
  public static func add(dataMode: MissileTrack_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endMissileTrack_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMissileTrack_Ingest(
    ...
    objIdent: MissileTrack_Ingest_objIdent_Enum = .assumedFriend,
    ...
    let __start = MissileTrack_Ingest.startMissileTrack_Ingest(&fbb)
    MissileTrack_Ingest.add(id: id, &fbb)
    MissileTrack_Ingest.add(classificationMarking: classificationMarking, &fbb)
    MissileTrack_Ingest.add(msgType: msgType, &fbb)
    MissileTrack_Ingest.add(msgSubType: msgSubType, &fbb)
    MissileTrack_Ingest.add(msgCreateDate: msgCreateDate, &fbb)
    MissileTrack_Ingest.add(env: env, &fbb)
    MissileTrack_Ingest.add(objType: objType, &fbb)
    MissileTrack_Ingest.add(objTypeConf: objTypeConf, &fbb)
    MissileTrack_Ingest.add(objPlat: objPlat, &fbb)
    MissileTrack_Ingest.add(objIdent: objIdent, &fbb)
    MissileTrack_Ingest.add(spaceAmp: spaceAmp, &fbb)
    MissileTrack_Ingest.add(objAct: objAct, &fbb)
    MissileTrack_Ingest.add(spaceSpecType: spaceSpecType, &fbb)
    MissileTrack_Ingest.add(acftSubType: acftSubType, &fbb)
    MissileTrack_Ingest.add(name: name, &fbb)
    MissileTrack_Ingest.add(callSign: callSign, &fbb)
    MissileTrack_Ingest.add(lostTrkInd: lostTrkInd, &fbb)
    MissileTrack_Ingest.add(trackId: trackId, &fbb)
    MissileTrack_Ingest.add(parentTrackId: parentTrackId, &fbb)
    MissileTrack_Ingest.add(muidSrcTrk: muidSrcTrk, &fbb)
    MissileTrack_Ingest.add(muidSrc: muidSrc, &fbb)
    MissileTrack_Ingest.add(alert: alert, &fbb)
    MissileTrack_Ingest.add(mslStatus: mslStatus, &fbb)
    MissileTrack_Ingest.add(ts: ts, &fbb)
    MissileTrack_Ingest.add(aouRptType: aouRptType, &fbb)
    MissileTrack_Ingest.addVectorOf(aouRptData: aouRptData, &fbb)
    MissileTrack_Ingest.add(containment: containment, &fbb)
    MissileTrack_Ingest.add(trkConf: trkConf, &fbb)
    MissileTrack_Ingest.add(trkQual: trkQual, &fbb)
    MissileTrack_Ingest.add(angElev: angElev, &fbb)
    MissileTrack_Ingest.add(senMode: senMode, &fbb)
    MissileTrack_Ingest.add(infoSource: infoSource, &fbb)
    MissileTrack_Ingest.add(boosting: boosting, &fbb)
    MissileTrack_Ingest.add(polarSingLocLat: polarSingLocLat, &fbb)
    MissileTrack_Ingest.add(polarSingLocLon: polarSingLocLon, &fbb)
    MissileTrack_Ingest.add(emgInd: emgInd, &fbb)
    MissileTrack_Ingest.add(dropPtInd: dropPtInd, &fbb)
    MissileTrack_Ingest.add(spaceAmpConf: spaceAmpConf, &fbb)
    MissileTrack_Ingest.add(launchTime: launchTime, &fbb)
    MissileTrack_Ingest.add(launchLat: launchLat, &fbb)
    MissileTrack_Ingest.add(launchLon: launchLon, &fbb)
    MissileTrack_Ingest.add(azCorr: azCorr, &fbb)
    MissileTrack_Ingest.add(burnoutAlt: burnoutAlt, &fbb)
    MissileTrack_Ingest.add(launchAouType: launchAouType, &fbb)
    MissileTrack_Ingest.addVectorOf(launchAouData: launchAouData, &fbb)
    MissileTrack_Ingest.add(impactTime: impactTime, &fbb)
    MissileTrack_Ingest.add(impactLat: impactLat, &fbb)
    MissileTrack_Ingest.add(impactLon: impactLon, &fbb)
    MissileTrack_Ingest.add(impactAouType: impactAouType, &fbb)
    MissileTrack_Ingest.addVectorOf(impactAouData: impactAouData, &fbb)
    MissileTrack_Ingest.addVectorOf(vectors: vectors, &fbb)
    MissileTrack_Ingest.add(origNetwork: origNetwork, &fbb)
    MissileTrack_Ingest.add(createdAt: createdAt, &fbb)
    MissileTrack_Ingest.add(createdBy: createdBy, &fbb)
    MissileTrack_Ingest.add(source: source, &fbb)
    MissileTrack_Ingest.add(origin: origin, &fbb)
    MissileTrack_Ingest.add(dataMode: dataMode, &fbb)
    return MissileTrack_Ingest.endMissileTrack_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.env.p, fieldName: "env", required: false, type: MissileTrack_Ingest_env_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.objIdent.p, fieldName: "objIdent", required: false, type: MissileTrack_Ingest_objIdent_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: MissileTrack_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
