...
public enum TAIUTC_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: TAIUTC_Ingest_dataMode_Enum { return .exercise }
  public static var min: TAIUTC_Ingest_dataMode_Enum { return .real }
}
...
public struct TAIUTC_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: TAIUTC_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: TAIUTC_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : TAIUTC_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startTAIUTC_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 12) }
  ...
  public static func add(dataMode: TAIUTC_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func endTAIUTC_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createTAIUTC_Ingest(
    ...
    let __start = TAIUTC_Ingest.startTAIUTC_Ingest(&fbb)
    TAIUTC_Ingest.add(id: id, &fbb)
    TAIUTC_Ingest.add(classificationMarking: classificationMarking, &fbb)
    TAIUTC_Ingest.add(adjustmentDate: adjustmentDate, &fbb)
    TAIUTC_Ingest.add(taiUtc: taiUtc, &fbb)
    TAIUTC_Ingest.add(multiplicationFactor: multiplicationFactor, &fbb)
    TAIUTC_Ingest.add(rawFileUri: rawFileUri, &fbb)
    TAIUTC_Ingest.add(source: source, &fbb)
    TAIUTC_Ingest.add(origin: origin, &fbb)
    TAIUTC_Ingest.add(origNetwork: origNetwork, &fbb)
    TAIUTC_Ingest.add(dataMode: dataMode, &fbb)
    TAIUTC_Ingest.add(createdAt: createdAt, &fbb)
    TAIUTC_Ingest.add(createdBy: createdBy, &fbb)
    return TAIUTC_Ingest.endTAIUTC_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: TAIUTC_Ingest_dataMode_Enum.self)
