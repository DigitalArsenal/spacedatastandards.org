...
public enum Sensorlimits_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Sensorlimits_Ingest_dataMode_Enum { return .exercise }
  public static var min: Sensorlimits_Ingest_dataMode_Enum { return .real }
}


///  /// Sensorlimits define 0 to many limits of a particular sensor in terms of observation coverage of on-orbit objects.
public struct Sensorlimits_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Sensorlimits_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Sensorlimits_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Sensorlimits_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startSensorlimits_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 16) }
  ...
  public static func add(dataMode: Sensorlimits_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endSensorlimits_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSensorlimits_Ingest(
    ...
    let __start = Sensorlimits_Ingest.startSensorlimits_Ingest(&fbb)
    Sensorlimits_Ingest.add(idSensorLimits: idSensorLimits, &fbb)
    Sensorlimits_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Sensorlimits_Ingest.add(origNetwork: origNetwork, &fbb)
    Sensorlimits_Ingest.add(upperLeftAzimuthLimit: upperLeftAzimuthLimit, &fbb)
    Sensorlimits_Ingest.add(upperRightAzimuthLimit: upperRightAzimuthLimit, &fbb)
    Sensorlimits_Ingest.add(lowerRightAzimuthLimit: lowerRightAzimuthLimit, &fbb)
    Sensorlimits_Ingest.add(lowerLeftAzimuthLimit: lowerLeftAzimuthLimit, &fbb)
    Sensorlimits_Ingest.add(lowerLeftElevationLimit: lowerLeftElevationLimit, &fbb)
    Sensorlimits_Ingest.add(upperLeftElevationLimit: upperLeftElevationLimit, &fbb)
    Sensorlimits_Ingest.add(lowerRightElevationLimit: lowerRightElevationLimit, &fbb)
    Sensorlimits_Ingest.add(upperRightElevationLimit: upperRightElevationLimit, &fbb)
    Sensorlimits_Ingest.add(source: source, &fbb)
    Sensorlimits_Ingest.add(dataMode: dataMode, &fbb)
    Sensorlimits_Ingest.add(createdAt: createdAt, &fbb)
    Sensorlimits_Ingest.add(createdBy: createdBy, &fbb)
    Sensorlimits_Ingest.add(idSensor: idSensor, &fbb)
    return Sensorlimits_Ingest.endSensorlimits_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Sensorlimits_Ingest_dataMode_Enum.self)
