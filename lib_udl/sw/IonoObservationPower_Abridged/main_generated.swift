...
public struct IonoObservationPower_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationPower_Abridged.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationPower_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationPower_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationPower_Abridged(
    ...
    let __start = IonoObservationPower_Abridged.startIonoObservationPower_Abridged(&fbb)
    IonoObservationPower_Abridged.add(notes: notes, &fbb)
    IonoObservationPower_Abridged.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationPower_Abridged.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationPower_Abridged.addVectorOf(data: data, &fbb)
    return IonoObservationPower_Abridged.endIonoObservationPower_Abridged(&fbb, start: __start)
  }
