...
public struct IonoObservationAntennaElementPosition_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationAntennaElementPosition_Abridged.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationAntennaElementPosition_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endIonoObservationAntennaElementPosition_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationAntennaElementPosition_Abridged(
    ...
    let __start = IonoObservationAntennaElementPosition_Abridged.startIonoObservationAntennaElementPosition_Abridged(&fbb)
    IonoObservationAntennaElementPosition_Abridged.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationAntennaElementPosition_Abridged.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationAntennaElementPosition_Abridged.addVectorOf(data: data, &fbb)
    return IonoObservationAntennaElementPosition_Abridged.endIonoObservationAntennaElementPosition_Abridged(&fbb, start: __start)
  }
