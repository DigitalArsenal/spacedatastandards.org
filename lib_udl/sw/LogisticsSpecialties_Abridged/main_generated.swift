...
public struct LogisticsSpecialties_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LogisticsSpecialties_Abridged.id, addPrefix: prefix) }
  ...
  public static func startLogisticsSpecialties_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 7) }
  ...
  public static func endLogisticsSpecialties_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLogisticsSpecialties_Abridged(
    ...
    let __start = LogisticsSpecialties_Abridged.startLogisticsSpecialties_Abridged(&fbb)
    LogisticsSpecialties_Abridged.add(specialty: specialty, &fbb)
    LogisticsSpecialties_Abridged.add(skillLevel: skillLevel, &fbb)
    LogisticsSpecialties_Abridged.add(firstName: firstName, &fbb)
    LogisticsSpecialties_Abridged.add(lastName: lastName, &fbb)
    LogisticsSpecialties_Abridged.add(rankCode: rankCode, &fbb)
    LogisticsSpecialties_Abridged.add(last4Ssn: last4Ssn, &fbb)
    LogisticsSpecialties_Abridged.add(roleTypeCode: roleTypeCode, &fbb)
    return LogisticsSpecialties_Abridged.endLogisticsSpecialties_Abridged(&fbb, start: __start)
  }
