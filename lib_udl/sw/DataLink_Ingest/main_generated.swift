...
public enum DataLink_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: DataLink_Ingest_dataMode_Enum { return .exercise }
  public static var min: DataLink_Ingest_dataMode_Enum { return .real }
}


///  /// Beta Version DataLink: Detailed instructions regarding the operations of data links.
public struct DataLink_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DataLink_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: DataLink_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : DataLink_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startDataLink_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 74) }
  ...
  public static func add(dataMode: DataLink_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endDataLink_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDataLink_Ingest(
    ...
    let __start = DataLink_Ingest.startDataLink_Ingest(&fbb)
    DataLink_Ingest.add(id: id, &fbb)
    DataLink_Ingest.add(classificationMarking: classificationMarking, &fbb)
    DataLink_Ingest.add(opExName: opExName, &fbb)
    DataLink_Ingest.add(originator: originator, &fbb)
    DataLink_Ingest.add(startTime: startTime, &fbb)
    DataLink_Ingest.add(stopTime: stopTime, &fbb)
    DataLink_Ingest.add(stopTimeMod: stopTimeMod, &fbb)
    DataLink_Ingest.add(planOrigNum: planOrigNum, &fbb)
    DataLink_Ingest.add(opExInfo: opExInfo, &fbb)
    DataLink_Ingest.add(opExInfoAlt: opExInfoAlt, &fbb)
    DataLink_Ingest.add(serialNum: serialNum, &fbb)
    DataLink_Ingest.add(month: month, &fbb)
    DataLink_Ingest.add(qualifier: qualifier, &fbb)
    DataLink_Ingest.add(qualSn: qualSn, &fbb)
    DataLink_Ingest.addVectorOf(references: references, &fbb)
    DataLink_Ingest.add(canxId: canxId, &fbb)
    DataLink_Ingest.add(canxOriginator: canxOriginator, &fbb)
    DataLink_Ingest.add(canxTs: canxTs, &fbb)
    DataLink_Ingest.add(canxSerialNum: canxSerialNum, &fbb)
    DataLink_Ingest.add(canxSpecialNotation: canxSpecialNotation, &fbb)
    DataLink_Ingest.addVectorOf(canxSics: canxSics, &fbb)
    DataLink_Ingest.add(pocName: pocName, &fbb)
    DataLink_Ingest.add(pocRank: pocRank, &fbb)
    DataLink_Ingest.add(pocCallSign: pocCallSign, &fbb)
    DataLink_Ingest.add(pocLocName: pocLocName, &fbb)
    DataLink_Ingest.add(pocLat: pocLat, &fbb)
    DataLink_Ingest.add(pocLon: pocLon, &fbb)
    DataLink_Ingest.addVectorOf(pocNums: pocNums, &fbb)
    DataLink_Ingest.add(geoDatum: geoDatum, &fbb)
    DataLink_Ingest.addVectorOf(refPoints: refPoints, &fbb)
    DataLink_Ingest.addVectorOf(voiceCoord: voiceCoord, &fbb)
    DataLink_Ingest.add(sysDefaultCode: sysDefaultCode, &fbb)
    DataLink_Ingest.add(winSizeMult: winSizeMult, &fbb)
    DataLink_Ingest.add(winSizeMin: winSizeMin, &fbb)
    DataLink_Ingest.add(minTrackQual: minTrackQual, &fbb)
    DataLink_Ingest.add(maxTrackQual: maxTrackQual, &fbb)
    DataLink_Ingest.add(resTrackQual: resTrackQual, &fbb)
    DataLink_Ingest.add(courseDiff: courseDiff, &fbb)
    DataLink_Ingest.add(speedDiff: speedDiff, &fbb)
    DataLink_Ingest.add(altDiff: altDiff, &fbb)
    DataLink_Ingest.add(minGeoPosQual: minGeoPosQual, &fbb)
    DataLink_Ingest.add(maxGeoPosQual: maxGeoPosQual, &fbb)
    DataLink_Ingest.add(decorrWinMult: decorrWinMult, &fbb)
    DataLink_Ingest.add(consecDecorr: consecDecorr, &fbb)
    DataLink_Ingest.addVectorOf(multiDuty: multiDuty, &fbb)
    DataLink_Ingest.addVectorOf(ops: ops, &fbb)
    DataLink_Ingest.add(jreUnitDes: jreUnitDes, &fbb)
    DataLink_Ingest.add(jreCallSign: jreCallSign, &fbb)
    DataLink_Ingest.add(jrePriAdd: jrePriAdd, &fbb)
    DataLink_Ingest.add(jreSecAdd: jreSecAdd, &fbb)
    DataLink_Ingest.add(jreDetails: jreDetails, &fbb)
    DataLink_Ingest.addVectorOf(specTracks: specTracks, &fbb)
    DataLink_Ingest.addVectorOf(nonLinkUnitDes: nonLinkUnitDes, &fbb)
    DataLink_Ingest.addVectorOf(trackNumBlockLls: trackNumBlockLls, &fbb)
    DataLink_Ingest.addVectorOf(trackNumBlocks: trackNumBlocks, &fbb)
    DataLink_Ingest.add(mgmtCode: mgmtCode, &fbb)
    DataLink_Ingest.add(mgmtCodeMeaning: mgmtCodeMeaning, &fbb)
    DataLink_Ingest.add(ackReq: ackReq, &fbb)
    DataLink_Ingest.addVectorOf(ackInstUnits: ackInstUnits, &fbb)
    DataLink_Ingest.add(classSource: classSource, &fbb)
    DataLink_Ingest.addVectorOf(classReasons: classReasons, &fbb)
    DataLink_Ingest.addVectorOf(decInstDates: decInstDates, &fbb)
    DataLink_Ingest.addVectorOf(decExemptCodes: decExemptCodes, &fbb)
    DataLink_Ingest.addVectorOf(remarks: remarks, &fbb)
    DataLink_Ingest.add(rawFileUri: rawFileUri, &fbb)
    DataLink_Ingest.add(createdAt: createdAt, &fbb)
    DataLink_Ingest.add(createdBy: createdBy, &fbb)
    DataLink_Ingest.add(updatedAt: updatedAt, &fbb)
    DataLink_Ingest.add(updatedBy: updatedBy, &fbb)
    DataLink_Ingest.add(sourceDl: sourceDl, &fbb)
    DataLink_Ingest.add(source: source, &fbb)
    DataLink_Ingest.add(origin: origin, &fbb)
    DataLink_Ingest.add(origNetwork: origNetwork, &fbb)
    DataLink_Ingest.add(dataMode: dataMode, &fbb)
    return DataLink_Ingest.endDataLink_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: DataLink_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
