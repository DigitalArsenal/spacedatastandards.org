...
public enum TrackSensor_Full_sensorFOVType_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: TrackSensor_Full_sensorFOVType_Enum { return .unknown }
  public static var min: TrackSensor_Full_sensorFOVType_Enum { return .butterfly }
}


///  /// Schema for Track Sensor data.
public struct TrackSensor_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: TrackSensor_Full.id, addPrefix: prefix) }
  ...
  public var sensorFovtype: TrackSensor_Full_sensorFOVType_Enum { let o = _accessor.offset(VTOFFSET.sensorFovtype.v); return o == 0 ? .butterfly : TrackSensor_Full_sensorFOVType_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .butterfly }
  public static func startTrackSensor_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 7) }
  ...
  public static func add(sensorFovtype: TrackSensor_Full_sensorFOVType_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: sensorFovtype.rawValue, def: 0, at: VTOFFSET.sensorFovtype.p) }
  public static func endTrackSensor_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createTrackSensor_Full(
    ...
    let __start = TrackSensor_Full.startTrackSensor_Full(&fbb)
    TrackSensor_Full.add(range: range, &fbb)
    TrackSensor_Full.add(az: az, &fbb)
    TrackSensor_Full.add(sensorNumber: sensorNumber, &fbb)
    TrackSensor_Full.add(sensorName: sensorName, &fbb)
    TrackSensor_Full.add(missionNumber: missionNumber, &fbb)
    TrackSensor_Full.add(minRangeLimit: minRangeLimit, &fbb)
    TrackSensor_Full.add(sensorFovtype: sensorFovtype, &fbb)
    return TrackSensor_Full.endTrackSensor_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.sensorFovtype.p, fieldName: "sensorFovtype", required: false, type: TrackSensor_Full_sensorFOVType_Enum.self)
    _v.finish()
  }
}
