...
public enum EquipmentRemark_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: EquipmentRemark_Abridged_dataMode_Enum { return .exercise }
  public static var min: EquipmentRemark_Abridged_dataMode_Enum { return .real }
}
...
public struct EquipmentRemark_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EquipmentRemark_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: EquipmentRemark_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : EquipmentRemark_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startEquipmentRemark_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 13) }
  ...
  public static func add(dataMode: EquipmentRemark_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endEquipmentRemark_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEquipmentRemark_Abridged(
    ...
    let __start = EquipmentRemark_Abridged.startEquipmentRemark_Abridged(&fbb)
    EquipmentRemark_Abridged.add(id: id, &fbb)
    EquipmentRemark_Abridged.add(classificationMarking: classificationMarking, &fbb)
    EquipmentRemark_Abridged.add(idEquipment: idEquipment, &fbb)
    EquipmentRemark_Abridged.add(altRmkId: altRmkId, &fbb)
    EquipmentRemark_Abridged.add(name: name, &fbb)
    EquipmentRemark_Abridged.add(type: type, &fbb)
    EquipmentRemark_Abridged.add(text: text, &fbb)
    EquipmentRemark_Abridged.add(code: code, &fbb)
    EquipmentRemark_Abridged.add(createdAt: createdAt, &fbb)
    EquipmentRemark_Abridged.add(createdBy: createdBy, &fbb)
    EquipmentRemark_Abridged.add(source: source, &fbb)
    EquipmentRemark_Abridged.add(origin: origin, &fbb)
    EquipmentRemark_Abridged.add(dataMode: dataMode, &fbb)
    return EquipmentRemark_Abridged.endEquipmentRemark_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: EquipmentRemark_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
