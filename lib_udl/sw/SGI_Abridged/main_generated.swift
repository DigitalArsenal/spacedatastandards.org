...
public enum SGI_Abridged_state_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SGI_Abridged_state_Enum { return .p }
  public static var min: SGI_Abridged_state_Enum { return .i }
}


public enum SGI_Abridged_precedence_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: SGI_Abridged_precedence_Enum { return .z }
  public static var min: SGI_Abridged_precedence_Enum { return .o }
}


public enum SGI_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: SGI_Abridged_dataMode_Enum { return .exercise }
  public static var min: SGI_Abridged_dataMode_Enum { return .real }
}


///  /// Model representation of space weather/solar, geomagnetic, and radiation belt indices.
public struct SGI_Abridged: FlatBufferObject, Verifiable {

  static func validateVersion() { FlatBuffersVersion_24_3_25() }
  public var __buffer: ByteBuffer! { return _accessor.bb }
  private var _accessor: Table

  public static var id: String { "SGIA" } 
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SGI_Abridged.id, addPrefix: prefix) }
  ...
  public var state: SGI_Abridged_state_Enum { let o = _accessor.offset(VTOFFSET.state.v); return o == 0 ? .i : SGI_Abridged_state_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .i }
  ...
  ///  Example: /// Example: R
  ///  Constraints: Minimum length = 0, Maximum length = 1
  public var precedence_: SGI_Abridged_precedence_Enum { let o = _accessor.offset(VTOFFSET.precedence_.v); return o == 0 ? .o : SGI_Abridged_precedence_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .o }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SGI_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SGI_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startSGI_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 49) }
  ...
  public static func add(state: SGI_Abridged_state_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: state.rawValue, def: 0, at: VTOFFSET.state.p) }
  ...
  public static func add(precedence_: SGI_Abridged_precedence_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: precedence_.rawValue, def: 0, at: VTOFFSET.precedence_.p) }
  ...
  public static func add(dataMode: SGI_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func endSGI_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSGI_Abridged(
    ...
    mode: Int32 = 0,
    precedence_: SGI_Abridged_precedence_Enum = .o,
    ...
    let __start = SGI_Abridged.startSGI_Abridged(&fbb)
    SGI_Abridged.add(id: id, &fbb)
    SGI_Abridged.add(classificationMarking: classificationMarking, &fbb)
    SGI_Abridged.add(effectiveDate: effectiveDate, &fbb)
    SGI_Abridged.add(sgiDate: sgiDate, &fbb)
    SGI_Abridged.add(type: type, &fbb)
    SGI_Abridged.add(state: state, &fbb)
    SGI_Abridged.add(stationName: stationName, &fbb)
    SGI_Abridged.add(idSensor: idSensor, &fbb)
    SGI_Abridged.add(origSensorId: origSensorId, &fbb)
    SGI_Abridged.add(mode: mode, &fbb)
    SGI_Abridged.add(precedence_: precedence_, &fbb)
    SGI_Abridged.addVectorOf(coeffDegree: coeffDegree, &fbb)
    SGI_Abridged.addVectorOf(coeffOrder: coeffOrder, &fbb)
    SGI_Abridged.addVectorOf(ctce: ctce, &fbb)
    SGI_Abridged.addVectorOf(stce: stce, &fbb)
    SGI_Abridged.addVectorOf(ctci: ctci, &fbb)
    SGI_Abridged.addVectorOf(stci: stci, &fbb)
    SGI_Abridged.add(e10: e10, &fbb)
    SGI_Abridged.add(e54: e54, &fbb)
    SGI_Abridged.add(s10: s10, &fbb)
    SGI_Abridged.add(s54: s54, &fbb)
    SGI_Abridged.add(m10: m10, &fbb)
    SGI_Abridged.add(m54: m54, &fbb)
    SGI_Abridged.add(y10: y10, &fbb)
    SGI_Abridged.add(y54: y54, &fbb)
    SGI_Abridged.add(f10: f10, &fbb)
    SGI_Abridged.add(f54: f54, &fbb)
    SGI_Abridged.add(f81: f81, &fbb)
    SGI_Abridged.add(ap: ap, &fbb)
    SGI_Abridged.add(apDuration: apDuration, &fbb)
    SGI_Abridged.add(kIndex: kIndex, &fbb)
    SGI_Abridged.add(kp: kp, &fbb)
    SGI_Abridged.add(kpDuration: kpDuration, &fbb)
    SGI_Abridged.add(gamma: gamma, &fbb)
    SGI_Abridged.add(dst: dst, &fbb)
    SGI_Abridged.add(dtc: dtc, &fbb)
    SGI_Abridged.add(rbRegionCode: rbRegionCode, &fbb)
    SGI_Abridged.add(rbIndex: rbIndex, &fbb)
    SGI_Abridged.add(normFactor: normFactor, &fbb)
    SGI_Abridged.add(rbDuration: rbDuration, &fbb)
    SGI_Abridged.add(analyzerAttenuation: analyzerAttenuation, &fbb)
    SGI_Abridged.add(rawFileUri: rawFileUri, &fbb)
    SGI_Abridged.add(transactionId: transactionId, &fbb)
    SGI_Abridged.add(source: source, &fbb)
    SGI_Abridged.add(origin: origin, &fbb)
    SGI_Abridged.add(origNetwork: origNetwork, &fbb)
    SGI_Abridged.add(dataMode: dataMode, &fbb)
    SGI_Abridged.add(createdAt: createdAt, &fbb)
    SGI_Abridged.add(createdBy: createdBy, &fbb)
    return SGI_Abridged.endSGI_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.state.p, fieldName: "state", required: false, type: SGI_Abridged_state_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.precedence_.p, fieldName: "precedence_", required: false, type: SGI_Abridged_precedence_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SGI_Abridged_dataMode_Enum.self)
