...
public struct MtiTargetReport_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiTargetReport_Abridged.id, addPrefix: prefix) }
  ...
  public static func startMtiTargetReport_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 18) }
  ...
  public static func endMtiTargetReport_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiTargetReport_Abridged(
    ...
    let __start = MtiTargetReport_Abridged.startMtiTargetReport_Abridged(&fbb)
    MtiTargetReport_Abridged.add(d321: d321, &fbb)
    MtiTargetReport_Abridged.add(d322: d322, &fbb)
    MtiTargetReport_Abridged.add(d323: d323, &fbb)
    MtiTargetReport_Abridged.add(d324: d324, &fbb)
    MtiTargetReport_Abridged.add(d325: d325, &fbb)
    MtiTargetReport_Abridged.add(d326: d326, &fbb)
    MtiTargetReport_Abridged.add(d327: d327, &fbb)
    MtiTargetReport_Abridged.add(d328: d328, &fbb)
    MtiTargetReport_Abridged.add(d329: d329, &fbb)
    MtiTargetReport_Abridged.add(d3210: d3210, &fbb)
    MtiTargetReport_Abridged.add(d3211: d3211, &fbb)
    MtiTargetReport_Abridged.add(d3212: d3212, &fbb)
    MtiTargetReport_Abridged.add(d3213: d3213, &fbb)
    MtiTargetReport_Abridged.add(d3214: d3214, &fbb)
    MtiTargetReport_Abridged.add(d3215: d3215, &fbb)
    MtiTargetReport_Abridged.add(d3216: d3216, &fbb)
    MtiTargetReport_Abridged.add(d3217: d3217, &fbb)
    MtiTargetReport_Abridged.add(d3218: d3218, &fbb)
    return MtiTargetReport_Abridged.endMtiTargetReport_Abridged(&fbb, start: __start)
  }
