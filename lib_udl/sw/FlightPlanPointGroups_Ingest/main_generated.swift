...
public struct FlightPlanPointGroups_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: FlightPlanPointGroups_Ingest.id, addPrefix: prefix) }
  ...
  public static func startFlightPlanPointGroups_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 24) }
  ...
  public static func endFlightPlanPointGroups_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createFlightPlanPointGroups_Ingest(
    ...
    let __start = FlightPlanPointGroups_Ingest.startFlightPlanPointGroups_Ingest(&fbb)
    FlightPlanPointGroups_Ingest.add(pointGroupName: pointGroupName, &fbb)
    FlightPlanPointGroups_Ingest.add(worstFuelCase: worstFuelCase, &fbb)
    FlightPlanPointGroups_Ingest.add(lsafName: lsafName, &fbb)
    FlightPlanPointGroups_Ingest.add(lsafDistance: lsafDistance, &fbb)
    FlightPlanPointGroups_Ingest.add(fsafDistance: fsafDistance, &fbb)
    FlightPlanPointGroups_Ingest.add(etopsDistance: etopsDistance, &fbb)
    FlightPlanPointGroups_Ingest.add(lsafTime: lsafTime, &fbb)
    FlightPlanPointGroups_Ingest.add(fsafTime: fsafTime, &fbb)
    FlightPlanPointGroups_Ingest.add(etopsTime: etopsTime, &fbb)
    FlightPlanPointGroups_Ingest.add(lsafAvgWindFactor: lsafAvgWindFactor, &fbb)
    FlightPlanPointGroups_Ingest.add(fsafAvgWindFactor: fsafAvgWindFactor, &fbb)
    FlightPlanPointGroups_Ingest.add(etopsAvgWindFactor: etopsAvgWindFactor, &fbb)
    FlightPlanPointGroups_Ingest.add(lsafTempDev: lsafTempDev, &fbb)
    FlightPlanPointGroups_Ingest.add(fsafTempDev: fsafTempDev, &fbb)
    FlightPlanPointGroups_Ingest.add(etopsTempDev: etopsTempDev, &fbb)
    FlightPlanPointGroups_Ingest.add(lsafReqFuel: lsafReqFuel, &fbb)
    FlightPlanPointGroups_Ingest.add(fsafReqFuel: fsafReqFuel, &fbb)
    FlightPlanPointGroups_Ingest.add(etopsReqFuel: etopsReqFuel, &fbb)
    FlightPlanPointGroups_Ingest.add(fromTakeoffTime: fromTakeoffTime, &fbb)
    FlightPlanPointGroups_Ingest.add(plannedFuel: plannedFuel, &fbb)
    FlightPlanPointGroups_Ingest.add(fuelCalcAlt: fuelCalcAlt, &fbb)
    FlightPlanPointGroups_Ingest.add(fuelCalcSpd: fuelCalcSpd, &fbb)
    FlightPlanPointGroups_Ingest.add(avgFuelFlow: avgFuelFlow, &fbb)
    FlightPlanPointGroups_Ingest.addVectorOf(flightPlanPoints: flightPlanPoints, &fbb)
    return FlightPlanPointGroups_Ingest.endFlightPlanPointGroups_Ingest(&fbb, start: __start)
  }
