...
public enum OnorbitThrusterStatus_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OnorbitThrusterStatus_Full_dataMode_Enum { return .exercise }
  public static var min: OnorbitThrusterStatus_Full_dataMode_Enum { return .real }
}


///  /// Status information for OnorbitThruster objects.
public struct OnorbitThrusterStatus_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OnorbitThrusterStatus_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: OnorbitThrusterStatus_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OnorbitThrusterStatus_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startOnorbitThrusterStatus_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 24) }
  ...
  public static func add(dataMode: OnorbitThrusterStatus_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endOnorbitThrusterStatus_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnorbitThrusterStatus_Full(
    ...
    let __start = OnorbitThrusterStatus_Full.startOnorbitThrusterStatus_Full(&fbb)
    OnorbitThrusterStatus_Full.add(id: id, &fbb)
    OnorbitThrusterStatus_Full.add(classificationMarking: classificationMarking, &fbb)
    OnorbitThrusterStatus_Full.add(idOnorbitThruster: idOnorbitThruster, &fbb)
    OnorbitThrusterStatus_Full.add(name: name, &fbb)
    OnorbitThrusterStatus_Full.add(statusTime: statusTime, &fbb)
    OnorbitThrusterStatus_Full.add(propMassMin: propMassMin, &fbb)
    OnorbitThrusterStatus_Full.add(propMassAvg: propMassAvg, &fbb)
    OnorbitThrusterStatus_Full.add(propMassMedian: propMassMedian, &fbb)
    OnorbitThrusterStatus_Full.add(propMassMax: propMassMax, &fbb)
    OnorbitThrusterStatus_Full.add(fuelMass: fuelMass, &fbb)
    OnorbitThrusterStatus_Full.add(fuelMassUnc: fuelMassUnc, &fbb)
    OnorbitThrusterStatus_Full.add(totalDeltaV: totalDeltaV, &fbb)
    OnorbitThrusterStatus_Full.add(minDeltaV: minDeltaV, &fbb)
    OnorbitThrusterStatus_Full.add(estDeltaV: estDeltaV, &fbb)
    OnorbitThrusterStatus_Full.add(maxDeltaV: maxDeltaV, &fbb)
    OnorbitThrusterStatus_Full.add(thrustMax: thrustMax, &fbb)
    OnorbitThrusterStatus_Full.add(isp: isp, &fbb)
    OnorbitThrusterStatus_Full.add(operational: operational, &fbb)
    OnorbitThrusterStatus_Full.add(createdAt: createdAt, &fbb)
    OnorbitThrusterStatus_Full.add(createdBy: createdBy, &fbb)
    OnorbitThrusterStatus_Full.add(source: source, &fbb)
    OnorbitThrusterStatus_Full.add(origin: origin, &fbb)
    OnorbitThrusterStatus_Full.add(origNetwork: origNetwork, &fbb)
    OnorbitThrusterStatus_Full.add(dataMode: dataMode, &fbb)
    return OnorbitThrusterStatus_Full.endOnorbitThrusterStatus_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OnorbitThrusterStatus_Full_dataMode_Enum.self)
    _v.finish()
  }
}
