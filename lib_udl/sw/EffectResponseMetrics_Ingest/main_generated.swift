...
public struct EffectResponseMetrics_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EffectResponseMetrics_Ingest.id, addPrefix: prefix) }
  ...
  public static func startEffectResponseMetrics_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endEffectResponseMetrics_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEffectResponseMetrics_Ingest(
    ...
    let __start = EffectResponseMetrics_Ingest.startEffectResponseMetrics_Ingest(&fbb)
    EffectResponseMetrics_Ingest.add(metricType: metricType, &fbb)
    EffectResponseMetrics_Ingest.add(domainValue: domainValue, &fbb)
    EffectResponseMetrics_Ingest.add(relativeValue: relativeValue, &fbb)
    EffectResponseMetrics_Ingest.add(provenance: provenance, &fbb)
    return EffectResponseMetrics_Ingest.endEffectResponseMetrics_Ingest(&fbb, start: __start)
  }
