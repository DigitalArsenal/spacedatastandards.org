...
public enum FlightPlan_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: FlightPlan_Abridged_dataMode_Enum { return .exercise }
  public static var min: FlightPlan_Abridged_dataMode_Enum { return .real }
}


///  /// Flight Plan contains data specifying the details of an intended flight including schedule and expected route.
public struct FlightPlan_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: FlightPlan_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: FlightPlan_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : FlightPlan_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startFlightPlan_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 96) }
  ...
  public static func add(dataMode: FlightPlan_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endFlightPlan_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createFlightPlan_Abridged(
    ...
    let __start = FlightPlan_Abridged.startFlightPlan_Abridged(&fbb)
    FlightPlan_Abridged.add(id: id, &fbb)
    FlightPlan_Abridged.add(classificationMarking: classificationMarking, &fbb)
    FlightPlan_Abridged.add(amcMissionId: amcMissionId, &fbb)
    FlightPlan_Abridged.add(idSortie: idSortie, &fbb)
    FlightPlan_Abridged.add(idAircraft: idAircraft, &fbb)
    FlightPlan_Abridged.add(legNum: legNum, &fbb)
    FlightPlan_Abridged.add(idDepAirfield: idDepAirfield, &fbb)
    FlightPlan_Abridged.add(depAirfield: depAirfield, &fbb)
    FlightPlan_Abridged.add(idArrAirfield: idArrAirfield, &fbb)
    FlightPlan_Abridged.add(arrAirfield: arrAirfield, &fbb)
    FlightPlan_Abridged.add(externalId: externalId, &fbb)
    FlightPlan_Abridged.add(genTs: genTs, &fbb)
    FlightPlan_Abridged.add(aircraftMds: aircraftMds, &fbb)
    FlightPlan_Abridged.add(tailNumber: tailNumber, &fbb)
    FlightPlan_Abridged.add(callSign: callSign, &fbb)
    FlightPlan_Abridged.add(wxValidStart: wxValidStart, &fbb)
    FlightPlan_Abridged.add(wxValidEnd: wxValidEnd, &fbb)
    FlightPlan_Abridged.add(estDepTime: estDepTime, &fbb)
    FlightPlan_Abridged.add(dragIndex: dragIndex, &fbb)
    FlightPlan_Abridged.add(fuelDegrade: fuelDegrade, &fbb)
    FlightPlan_Abridged.add(opWeight: opWeight, &fbb)
    FlightPlan_Abridged.add(msnIndex: msnIndex, &fbb)
    FlightPlan_Abridged.add(rampFuel: rampFuel, &fbb)
    FlightPlan_Abridged.add(taxiFuel: taxiFuel, &fbb)
    FlightPlan_Abridged.add(takeoffFuel: takeoffFuel, &fbb)
    FlightPlan_Abridged.add(climbFuel: climbFuel, &fbb)
    FlightPlan_Abridged.add(climbTime: climbTime, &fbb)
    FlightPlan_Abridged.add(holdDownFuel: holdDownFuel, &fbb)
    FlightPlan_Abridged.add(tocIceFuel: tocIceFuel, &fbb)
    FlightPlan_Abridged.add(tocFuel: tocFuel, &fbb)
    FlightPlan_Abridged.add(enrouteFuel: enrouteFuel, &fbb)
    FlightPlan_Abridged.add(enrouteTime: enrouteTime, &fbb)
    FlightPlan_Abridged.add(thunderAvoidFuel: thunderAvoidFuel, &fbb)
    FlightPlan_Abridged.add(todIceFuel: todIceFuel, &fbb)
    FlightPlan_Abridged.add(opConditionFuel: opConditionFuel, &fbb)
    FlightPlan_Abridged.add(todFuel: todFuel, &fbb)
    FlightPlan_Abridged.add(earlyDescentFuel: earlyDescentFuel, &fbb)
    FlightPlan_Abridged.add(arrIceFuel: arrIceFuel, &fbb)
    FlightPlan_Abridged.add(holdFuel: holdFuel, &fbb)
    FlightPlan_Abridged.add(holdTime: holdTime, &fbb)
    FlightPlan_Abridged.add(appLandingFuel: appLandingFuel, &fbb)
    FlightPlan_Abridged.add(burnedFuel: burnedFuel, &fbb)
    FlightPlan_Abridged.add(landingFuel: landingFuel, &fbb)
    FlightPlan_Abridged.add(minDivertFuel: minDivertFuel, &fbb)
    FlightPlan_Abridged.add(arrAlternate1Fuel: arrAlternate1Fuel, &fbb)
    FlightPlan_Abridged.add(arrAlternate2Fuel: arrAlternate2Fuel, &fbb)
    FlightPlan_Abridged.add(contingencyFuel: contingencyFuel, &fbb)
    FlightPlan_Abridged.add(reserveFuel: reserveFuel, &fbb)
    FlightPlan_Abridged.add(depressFuel: depressFuel, &fbb)
    FlightPlan_Abridged.add(unusableFuel: unusableFuel, &fbb)
    FlightPlan_Abridged.add(unidentExtraFuel: unidentExtraFuel, &fbb)
    FlightPlan_Abridged.add(identExtraFuel: identExtraFuel, &fbb)
    FlightPlan_Abridged.add(remAlternate1Fuel: remAlternate1Fuel, &fbb)
    FlightPlan_Abridged.add(remAlternate2Fuel: remAlternate2Fuel, &fbb)
    FlightPlan_Abridged.add(enduranceTime: enduranceTime, &fbb)
    FlightPlan_Abridged.add(sid: sid, &fbb)
    FlightPlan_Abridged.add(star: star, &fbb)
    FlightPlan_Abridged.add(gpsRaim: gpsRaim, &fbb)
    FlightPlan_Abridged.add(depRunway: depRunway, &fbb)
    FlightPlan_Abridged.add(arrRunway: arrRunway, &fbb)
    FlightPlan_Abridged.add(routeString: routeString, &fbb)
    FlightPlan_Abridged.addVectorOf(countryCodes: countryCodes, &fbb)
    FlightPlan_Abridged.add(etopsRating: etopsRating, &fbb)
    FlightPlan_Abridged.addVectorOf(etopsAirfields: etopsAirfields, &fbb)
    FlightPlan_Abridged.addVectorOf(etopsAltAirfields: etopsAltAirfields, &fbb)
    FlightPlan_Abridged.add(etopsValWindow: etopsValWindow, &fbb)
    FlightPlan_Abridged.add(plannerRemark: plannerRemark, &fbb)
    FlightPlan_Abridged.add(cargoRemark: cargoRemark, &fbb)
    FlightPlan_Abridged.add(windFac1: windFac1, &fbb)
    FlightPlan_Abridged.add(windFac2: windFac2, &fbb)
    FlightPlan_Abridged.add(windFacAvg: windFacAvg, &fbb)
    FlightPlan_Abridged.add(avgTempDev: avgTempDev, &fbb)
    FlightPlan_Abridged.addVectorOf(atcAddresses: atcAddresses, &fbb)
    FlightPlan_Abridged.add(originator: originator, &fbb)
    FlightPlan_Abridged.add(numAircraft: numAircraft, &fbb)
    FlightPlan_Abridged.add(flightRules: flightRules, &fbb)
    FlightPlan_Abridged.add(flightType: flightType, &fbb)
    FlightPlan_Abridged.add(initialCruiseSpeed: initialCruiseSpeed, &fbb)
    FlightPlan_Abridged.add(initialFlightLevel: initialFlightLevel, &fbb)
    FlightPlan_Abridged.add(arrAlternate1: arrAlternate1, &fbb)
    FlightPlan_Abridged.add(arrAlternate2: arrAlternate2, &fbb)
    FlightPlan_Abridged.add(depAlternate: depAlternate, &fbb)
    FlightPlan_Abridged.add(wakeTurbCat: wakeTurbCat, &fbb)
    FlightPlan_Abridged.add(equipment: equipment, &fbb)
    FlightPlan_Abridged.add(notes: notes, &fbb)
    FlightPlan_Abridged.add(createdAt: createdAt, &fbb)
    FlightPlan_Abridged.add(createdBy: createdBy, &fbb)
    FlightPlan_Abridged.add(sourceDl: sourceDl, &fbb)
    FlightPlan_Abridged.add(source: source, &fbb)
    FlightPlan_Abridged.add(origin: origin, &fbb)
    FlightPlan_Abridged.add(origNetwork: origNetwork, &fbb)
    FlightPlan_Abridged.add(dataMode: dataMode, &fbb)
    FlightPlan_Abridged.addVectorOf(airRefuelEvents: airRefuelEvents, &fbb)
    FlightPlan_Abridged.addVectorOf(flightPlanMessages: flightPlanMessages, &fbb)
    FlightPlan_Abridged.addVectorOf(flightPlanWaypoints: flightPlanWaypoints, &fbb)
    FlightPlan_Abridged.addVectorOf(flightPlanPointGroups: flightPlanPointGroups, &fbb)
    return FlightPlan_Abridged.endFlightPlan_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: FlightPlan_Abridged_dataMode_Enum.self)
