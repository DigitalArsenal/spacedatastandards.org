...
public enum Channel_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Channel_Abridged_dataMode_Enum { return .exercise }
  public static var min: Channel_Abridged_dataMode_Enum { return .real }
}


///  /// Channel information on a particular transponder.
public struct Channel_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Channel_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Channel_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Channel_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startChannel_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 22) }
  ...
  public static func add(dataMode: Channel_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func endChannel_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createChannel_Abridged(
    ...
    let __start = Channel_Abridged.startChannel_Abridged(&fbb)
    Channel_Abridged.add(id: id, &fbb)
    Channel_Abridged.add(idTransponder: idTransponder, &fbb)
    Channel_Abridged.add(name: name, &fbb)
    Channel_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Channel_Abridged.add(type: type, &fbb)
    Channel_Abridged.add(idBeam: idBeam, &fbb)
    Channel_Abridged.add(beamName: beamName, &fbb)
    Channel_Abridged.add(idRfband: idRfband, &fbb)
    Channel_Abridged.add(encryption: encryption, &fbb)
    Channel_Abridged.add(pkg: pkg, &fbb)
    Channel_Abridged.add(res: res, &fbb)
    Channel_Abridged.add(compression: compression, &fbb)
    Channel_Abridged.add(vpid: vpid, &fbb)
    Channel_Abridged.add(apid: apid, &fbb)
    Channel_Abridged.add(sid: sid, &fbb)
    Channel_Abridged.add(owner: owner, &fbb)
    Channel_Abridged.add(source: source, &fbb)
    Channel_Abridged.add(origin: origin, &fbb)
    Channel_Abridged.add(origNetwork: origNetwork, &fbb)
    Channel_Abridged.add(dataMode: dataMode, &fbb)
    Channel_Abridged.add(createdAt: createdAt, &fbb)
    Channel_Abridged.add(createdBy: createdBy, &fbb)
    return Channel_Abridged.endChannel_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Channel_Abridged_dataMode_Enum.self)
