...
public enum DiffOfArrival_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: DiffOfArrival_Full_dataMode_Enum { return .exercise }
  public static var min: DiffOfArrival_Full_dataMode_Enum { return .real }
}
...
public struct DiffOfArrival_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DiffOfArrival_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: DiffOfArrival_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : DiffOfArrival_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startDiffOfArrival_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 44) }
  ...
  public static func add(dataMode: DiffOfArrival_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endDiffOfArrival_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDiffOfArrival_Full(
    ...
    let __start = DiffOfArrival_Full.startDiffOfArrival_Full(&fbb)
    DiffOfArrival_Full.add(id: id, &fbb)
    DiffOfArrival_Full.add(classificationMarking: classificationMarking, &fbb)
    DiffOfArrival_Full.add(obTime: obTime, &fbb)
    DiffOfArrival_Full.add(idOnOrbit: idOnOrbit, &fbb)
    DiffOfArrival_Full.add(idSensor1: idSensor1, &fbb)
    DiffOfArrival_Full.add(idSensor2: idSensor2, &fbb)
    DiffOfArrival_Full.add(satNo: satNo, &fbb)
    DiffOfArrival_Full.add(taskId: taskId, &fbb)
    DiffOfArrival_Full.add(origObjectId: origObjectId, &fbb)
    DiffOfArrival_Full.add(origSensorId1: origSensorId1, &fbb)
    DiffOfArrival_Full.add(origSensorId2: origSensorId2, &fbb)
    DiffOfArrival_Full.add(uct: uct, &fbb)
    DiffOfArrival_Full.add(sensor1Delay: sensor1Delay, &fbb)
    DiffOfArrival_Full.add(sensor2Delay: sensor2Delay, &fbb)
    DiffOfArrival_Full.add(senlat: senlat, &fbb)
    DiffOfArrival_Full.add(senlon: senlon, &fbb)
    DiffOfArrival_Full.add(senalt: senalt, &fbb)
    DiffOfArrival_Full.add(sen2lat: sen2lat, &fbb)
    DiffOfArrival_Full.add(sen2lon: sen2lon, &fbb)
    DiffOfArrival_Full.add(sen2alt: sen2alt, &fbb)
    DiffOfArrival_Full.add(frequency: frequency, &fbb)
    DiffOfArrival_Full.add(bandwidth: bandwidth, &fbb)
    DiffOfArrival_Full.add(deltaRange: deltaRange, &fbb)
    DiffOfArrival_Full.add(deltaRangeUnc: deltaRangeUnc, &fbb)
    DiffOfArrival_Full.add(deltaRangeRate: deltaRangeRate, &fbb)
    DiffOfArrival_Full.add(deltaRangeRateUnc: deltaRangeRateUnc, &fbb)
    DiffOfArrival_Full.add(snr: snr, &fbb)
    DiffOfArrival_Full.add(tdoa: tdoa, &fbb)
    DiffOfArrival_Full.add(tdoaUnc: tdoaUnc, &fbb)
    DiffOfArrival_Full.add(fdoa: fdoa, &fbb)
    DiffOfArrival_Full.add(fdoaUnc: fdoaUnc, &fbb)
    DiffOfArrival_Full.add(collectionMode: collectionMode, &fbb)
    DiffOfArrival_Full.add(rawFileUri: rawFileUri, &fbb)
    DiffOfArrival_Full.add(source: source, &fbb)
    DiffOfArrival_Full.add(dataMode: dataMode, &fbb)
    DiffOfArrival_Full.addVectorOf(tags: tags, &fbb)
    DiffOfArrival_Full.add(origin: origin, &fbb)
    DiffOfArrival_Full.add(createdAt: createdAt, &fbb)
    DiffOfArrival_Full.add(createdBy: createdBy, &fbb)
    DiffOfArrival_Full.add(onOrbit: onOrbit, &fbb)
    DiffOfArrival_Full.add(descriptor: descriptor, &fbb)
    DiffOfArrival_Full.add(transactionId: transactionId, &fbb)
    DiffOfArrival_Full.add(origNetwork: origNetwork, &fbb)
    DiffOfArrival_Full.add(sourceDl: sourceDl, &fbb)
    return DiffOfArrival_Full.endDiffOfArrival_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: DiffOfArrival_Full_dataMode_Enum.self)
