...
public enum MissileTrack_Full_env_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: MissileTrack_Full_env_Enum { return .unknown }
  public static var min: MissileTrack_Full_env_Enum { return .air }
}


public enum MissileTrack_Full_objIdent_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: MissileTrack_Full_objIdent_Enum { return .unknown }
  public static var min: MissileTrack_Full_objIdent_Enum { return .assumedFriend }
}


public enum MissileTrack_Full_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: MissileTrack_Full_dataMode_Enum { return .exercise }
  public static var min: MissileTrack_Full_dataMode_Enum { return .real }
}
...
public struct MissileTrack_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MissileTrack_Full.id, addPrefix: prefix) }
  ...
  ///  Example: /// Example: AIR
  ///  Constraints: Minimum length = 0, Maximum length = 16
  public var env: MissileTrack_Full_env_Enum { let o = _accessor.offset(VTOFFSET.env.v); return o == 0 ? .air : MissileTrack_Full_env_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .air }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 32
  public var objIdent: MissileTrack_Full_objIdent_Enum { let o = _accessor.offset(VTOFFSET.objIdent.v); return o == 0 ? .assumedFriend : MissileTrack_Full_objIdent_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .assumedFriend }
  ...
  public var dataMode: MissileTrack_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : MissileTrack_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startMissileTrack_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 57) }
  ...
  public static func add(env: MissileTrack_Full_env_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: env.rawValue, def: 0, at: VTOFFSET.env.p) }
  ...
  public static func add(objIdent: MissileTrack_Full_objIdent_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: objIdent.rawValue, def: 0, at: VTOFFSET.objIdent.p) }
  ...
  public static func add(dataMode: MissileTrack_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endMissileTrack_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMissileTrack_Full(
    ...
    objIdent: MissileTrack_Full_objIdent_Enum = .assumedFriend,
    ...
    let __start = MissileTrack_Full.startMissileTrack_Full(&fbb)
    MissileTrack_Full.add(id: id, &fbb)
    MissileTrack_Full.add(classificationMarking: classificationMarking, &fbb)
    MissileTrack_Full.add(msgType: msgType, &fbb)
    MissileTrack_Full.add(msgSubType: msgSubType, &fbb)
    MissileTrack_Full.add(msgCreateDate: msgCreateDate, &fbb)
    MissileTrack_Full.add(env: env, &fbb)
    MissileTrack_Full.add(objType: objType, &fbb)
    MissileTrack_Full.add(objTypeConf: objTypeConf, &fbb)
    MissileTrack_Full.add(objPlat: objPlat, &fbb)
    MissileTrack_Full.add(objIdent: objIdent, &fbb)
    MissileTrack_Full.add(spaceAmp: spaceAmp, &fbb)
    MissileTrack_Full.add(objAct: objAct, &fbb)
    MissileTrack_Full.add(spaceSpecType: spaceSpecType, &fbb)
    MissileTrack_Full.add(acftSubType: acftSubType, &fbb)
    MissileTrack_Full.add(name: name, &fbb)
    MissileTrack_Full.add(callSign: callSign, &fbb)
    MissileTrack_Full.add(lostTrkInd: lostTrkInd, &fbb)
    MissileTrack_Full.add(trackId: trackId, &fbb)
    MissileTrack_Full.add(parentTrackId: parentTrackId, &fbb)
    MissileTrack_Full.add(muidSrcTrk: muidSrcTrk, &fbb)
    MissileTrack_Full.add(muidSrc: muidSrc, &fbb)
    MissileTrack_Full.add(alert: alert, &fbb)
    MissileTrack_Full.add(mslStatus: mslStatus, &fbb)
    MissileTrack_Full.add(ts: ts, &fbb)
    MissileTrack_Full.add(aouRptType: aouRptType, &fbb)
    MissileTrack_Full.addVectorOf(aouRptData: aouRptData, &fbb)
    MissileTrack_Full.add(containment: containment, &fbb)
    MissileTrack_Full.add(trkConf: trkConf, &fbb)
    MissileTrack_Full.add(trkQual: trkQual, &fbb)
    MissileTrack_Full.add(angElev: angElev, &fbb)
    MissileTrack_Full.add(senMode: senMode, &fbb)
    MissileTrack_Full.add(infoSource: infoSource, &fbb)
    MissileTrack_Full.add(boosting: boosting, &fbb)
    MissileTrack_Full.add(polarSingLocLat: polarSingLocLat, &fbb)
    MissileTrack_Full.add(polarSingLocLon: polarSingLocLon, &fbb)
    MissileTrack_Full.add(emgInd: emgInd, &fbb)
    MissileTrack_Full.add(dropPtInd: dropPtInd, &fbb)
    MissileTrack_Full.add(spaceAmpConf: spaceAmpConf, &fbb)
    MissileTrack_Full.add(launchTime: launchTime, &fbb)
    MissileTrack_Full.add(launchLat: launchLat, &fbb)
    MissileTrack_Full.add(launchLon: launchLon, &fbb)
    MissileTrack_Full.add(azCorr: azCorr, &fbb)
    MissileTrack_Full.add(burnoutAlt: burnoutAlt, &fbb)
    MissileTrack_Full.add(launchAouType: launchAouType, &fbb)
    MissileTrack_Full.addVectorOf(launchAouData: launchAouData, &fbb)
    MissileTrack_Full.add(impactTime: impactTime, &fbb)
    MissileTrack_Full.add(impactLat: impactLat, &fbb)
    MissileTrack_Full.add(impactLon: impactLon, &fbb)
    MissileTrack_Full.add(impactAouType: impactAouType, &fbb)
    MissileTrack_Full.addVectorOf(impactAouData: impactAouData, &fbb)
    MissileTrack_Full.addVectorOf(vectors: vectors, &fbb)
    MissileTrack_Full.add(origNetwork: origNetwork, &fbb)
    MissileTrack_Full.add(createdAt: createdAt, &fbb)
    MissileTrack_Full.add(createdBy: createdBy, &fbb)
    MissileTrack_Full.add(source: source, &fbb)
    MissileTrack_Full.add(origin: origin, &fbb)
    MissileTrack_Full.add(dataMode: dataMode, &fbb)
    return MissileTrack_Full.endMissileTrack_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.env.p, fieldName: "env", required: false, type: MissileTrack_Full_env_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.objIdent.p, fieldName: "objIdent", required: false, type: MissileTrack_Full_objIdent_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: MissileTrack_Full_dataMode_Enum.self)
    _v.finish()
  }
}
