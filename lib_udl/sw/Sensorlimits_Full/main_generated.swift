...
public enum Sensorlimits_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Sensorlimits_Full_dataMode_Enum { return .exercise }
  public static var min: Sensorlimits_Full_dataMode_Enum { return .real }
}


///  /// Sensorlimits define 0 to many limits of a particular sensor in terms of observation coverage of on-orbit objects.
public struct Sensorlimits_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Sensorlimits_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Sensorlimits_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Sensorlimits_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startSensorlimits_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 18) }
  ...
  public static func add(dataMode: Sensorlimits_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endSensorlimits_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSensorlimits_Full(
    ...
    let __start = Sensorlimits_Full.startSensorlimits_Full(&fbb)
    Sensorlimits_Full.add(idSensorLimits: idSensorLimits, &fbb)
    Sensorlimits_Full.add(classificationMarking: classificationMarking, &fbb)
    Sensorlimits_Full.add(origNetwork: origNetwork, &fbb)
    Sensorlimits_Full.add(upperLeftAzimuthLimit: upperLeftAzimuthLimit, &fbb)
    Sensorlimits_Full.add(upperRightAzimuthLimit: upperRightAzimuthLimit, &fbb)
    Sensorlimits_Full.add(lowerRightAzimuthLimit: lowerRightAzimuthLimit, &fbb)
    Sensorlimits_Full.add(lowerLeftAzimuthLimit: lowerLeftAzimuthLimit, &fbb)
    Sensorlimits_Full.add(lowerLeftElevationLimit: lowerLeftElevationLimit, &fbb)
    Sensorlimits_Full.add(upperLeftElevationLimit: upperLeftElevationLimit, &fbb)
    Sensorlimits_Full.add(lowerRightElevationLimit: lowerRightElevationLimit, &fbb)
    Sensorlimits_Full.add(upperRightElevationLimit: upperRightElevationLimit, &fbb)
    Sensorlimits_Full.add(source: source, &fbb)
    Sensorlimits_Full.add(dataMode: dataMode, &fbb)
    Sensorlimits_Full.add(createdAt: createdAt, &fbb)
    Sensorlimits_Full.add(createdBy: createdBy, &fbb)
    Sensorlimits_Full.add(updatedAt: updatedAt, &fbb)
    Sensorlimits_Full.add(updatedBy: updatedBy, &fbb)
    Sensorlimits_Full.add(idSensor: idSensor, &fbb)
    return Sensorlimits_Full.endSensorlimits_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Sensorlimits_Full_dataMode_Enum.self)
