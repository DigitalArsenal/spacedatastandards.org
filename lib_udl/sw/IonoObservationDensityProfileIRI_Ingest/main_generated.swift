...
public struct IonoObservationDensityProfileIRI_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDensityProfileIRI_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDensityProfileIRI_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 22) }
  ...
  public static func endIonoObservationDensityProfileIRI_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDensityProfileIRI_Ingest(
    ...
    let __start = IonoObservationDensityProfileIRI_Ingest.startIonoObservationDensityProfileIRI_Ingest(&fbb)
    IonoObservationDensityProfileIRI_Ingest.add(description: description, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(nmF2: nmF2, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(hmF2: hmF2, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(b0: b0, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(b1: b1, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(nmF1: nmF1, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(hmF1: hmF1, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(d1: d1, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(hz: hz, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(hValTop: hValTop, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(nValB: nValB, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(nmE: nmE, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(hmE: hmE, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(hdx: hdx, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(nmD: nmD, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(hmD: hmD, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(ha: ha, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(fp1: fp1, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(fp2: fp2, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(fp30: fp30, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(fp3U: fp3U, &fbb)
    IonoObservationDensityProfileIRI_Ingest.add(chi: chi, &fbb)
    return IonoObservationDensityProfileIRI_Ingest.endIonoObservationDensityProfileIRI_Ingest(&fbb, start: __start)
  }
