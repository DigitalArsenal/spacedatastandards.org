...
public enum PersonnelRecovery_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: PersonnelRecovery_Full_dataMode_Enum { return .exercise }
  public static var min: PersonnelRecovery_Full_dataMode_Enum { return .real }
}


///  /// Provides information concerning search and rescue operations and other situations involving personnel recovery.
public struct PersonnelRecovery_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: PersonnelRecovery_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: PersonnelRecovery_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : PersonnelRecovery_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startPersonnelRecovery_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 38) }
  ...
  public static func add(dataMode: PersonnelRecovery_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endPersonnelRecovery_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPersonnelRecovery_Full(
    ...
    let __start = PersonnelRecovery_Full.startPersonnelRecovery_Full(&fbb)
    PersonnelRecovery_Full.add(id: id, &fbb)
    PersonnelRecovery_Full.add(classificationMarking: classificationMarking, &fbb)
    PersonnelRecovery_Full.add(type: type, &fbb)
    PersonnelRecovery_Full.add(msgTime: msgTime, &fbb)
    PersonnelRecovery_Full.add(recovId: recovId, &fbb)
    PersonnelRecovery_Full.add(idWeatherReport: idWeatherReport, &fbb)
    PersonnelRecovery_Full.add(pickupLat: pickupLat, &fbb)
    PersonnelRecovery_Full.add(pickupLon: pickupLon, &fbb)
    PersonnelRecovery_Full.add(pickupAlt: pickupAlt, &fbb)
    PersonnelRecovery_Full.add(termInd: termInd, &fbb)
    PersonnelRecovery_Full.add(authStatus: authStatus, &fbb)
    PersonnelRecovery_Full.add(numPersons: numPersons, &fbb)
    PersonnelRecovery_Full.add(milClass: milClass, &fbb)
    PersonnelRecovery_Full.add(natAlliance: natAlliance, &fbb)
    PersonnelRecovery_Full.add(natAlliance1: natAlliance1, &fbb)
    PersonnelRecovery_Full.add(identity: identity, &fbb)
    PersonnelRecovery_Full.add(commEq1: commEq1, &fbb)
    PersonnelRecovery_Full.add(commEq2: commEq2, &fbb)
    PersonnelRecovery_Full.add(commEq3: commEq3, &fbb)
    PersonnelRecovery_Full.add(txFreq: txFreq, &fbb)
    PersonnelRecovery_Full.add(rxFreq: rxFreq, &fbb)
    PersonnelRecovery_Full.add(numNonAmbulatory: numNonAmbulatory, &fbb)
    PersonnelRecovery_Full.add(numAmbulatory: numAmbulatory, &fbb)
    PersonnelRecovery_Full.add(numAmbulatoryInjured: numAmbulatoryInjured, &fbb)
    PersonnelRecovery_Full.add(survivorRadio: survivorRadio, &fbb)
    PersonnelRecovery_Full.add(survivorMessages: survivorMessages, &fbb)
    PersonnelRecovery_Full.add(beaconInd: beaconInd, &fbb)
    PersonnelRecovery_Full.add(callSign: callSign, &fbb)
    PersonnelRecovery_Full.add(textMsg: textMsg, &fbb)
    PersonnelRecovery_Full.add(authMethod: authMethod, &fbb)
    PersonnelRecovery_Full.add(objectiveAreaInfo: objectiveAreaInfo, &fbb)
    PersonnelRecovery_Full.add(executionInfo: executionInfo, &fbb)
    PersonnelRecovery_Full.add(origNetwork: origNetwork, &fbb)
    PersonnelRecovery_Full.add(createdAt: createdAt, &fbb)
    PersonnelRecovery_Full.add(createdBy: createdBy, &fbb)
    PersonnelRecovery_Full.add(source: source, &fbb)
    PersonnelRecovery_Full.add(origin: origin, &fbb)
    PersonnelRecovery_Full.add(dataMode: dataMode, &fbb)
    return PersonnelRecovery_Full.endPersonnelRecovery_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: PersonnelRecovery_Full_dataMode_Enum.self)
    _v.finish()
  }
}
