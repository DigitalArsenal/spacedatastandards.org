...
public struct ISRCollectionPOC_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollectionPOC_Full.id, addPrefix: prefix) }
  ...
  public static func startISRCollectionPOC_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 10) }
  ...
  public static func endISRCollectionPOC_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollectionPOC_Full(
    ...
    let __start = ISRCollectionPOC_Full.startISRCollectionPOC_Full(&fbb)
    ISRCollectionPOC_Full.add(id: id, &fbb)
    ISRCollectionPOC_Full.add(name: name, &fbb)
    ISRCollectionPOC_Full.add(callsign: callsign, &fbb)
    ISRCollectionPOC_Full.add(unit: unit, &fbb)
    ISRCollectionPOC_Full.add(email: email, &fbb)
    ISRCollectionPOC_Full.add(phone: phone, &fbb)
    ISRCollectionPOC_Full.add(radioFrequency: radioFrequency, &fbb)
    ISRCollectionPOC_Full.add(chatSystem: chatSystem, &fbb)
    ISRCollectionPOC_Full.add(chatName: chatName, &fbb)
    ISRCollectionPOC_Full.add(notes: notes, &fbb)
    return ISRCollectionPOC_Full.endISRCollectionPOC_Full(&fbb, start: __start)
  }
