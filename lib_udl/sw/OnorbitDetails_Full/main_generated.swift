...
public enum OnorbitDetails_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OnorbitDetails_Full_dataMode_Enum { return .exercise }
  public static var min: OnorbitDetails_Full_dataMode_Enum { return .real }
}


///  /// Contains details of the OnOrbit object.
public struct OnorbitDetails_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OnorbitDetails_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: OnorbitDetails_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OnorbitDetails_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOnorbitDetails_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 50) }
  ...
  public static func add(dataMode: OnorbitDetails_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endOnorbitDetails_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnorbitDetails_Full(
    ...
    let __start = OnorbitDetails_Full.startOnorbitDetails_Full(&fbb)
    OnorbitDetails_Full.add(id: id, &fbb)
    OnorbitDetails_Full.add(idOnOrbit: idOnOrbit, &fbb)
    OnorbitDetails_Full.add(classificationMarking: classificationMarking, &fbb)
    OnorbitDetails_Full.add(lastObTime: lastObTime, &fbb)
    OnorbitDetails_Full.add(vismag: vismag, &fbb)
    OnorbitDetails_Full.add(vismagMin: vismagMin, &fbb)
    OnorbitDetails_Full.add(vismagMax: vismagMax, &fbb)
    OnorbitDetails_Full.add(vismagMean: vismagMean, &fbb)
    OnorbitDetails_Full.add(rcs: rcs, &fbb)
    OnorbitDetails_Full.add(rcsMin: rcsMin, &fbb)
    OnorbitDetails_Full.add(rcsMax: rcsMax, &fbb)
    OnorbitDetails_Full.add(rcsMean: rcsMean, &fbb)
    OnorbitDetails_Full.add(bolDeltaV: bolDeltaV, &fbb)
    OnorbitDetails_Full.add(maxDeltaV: maxDeltaV, &fbb)
    OnorbitDetails_Full.add(deltaVunc: deltaVunc, &fbb)
    OnorbitDetails_Full.add(estDeltaVduration: estDeltaVduration, &fbb)
    OnorbitDetails_Full.add(numMission: numMission, &fbb)
    OnorbitDetails_Full.addVectorOf(missionTypes: missionTypes, &fbb)
    OnorbitDetails_Full.add(busType: busType, &fbb)
    OnorbitDetails_Full.add(geoSlot: geoSlot, &fbb)
    OnorbitDetails_Full.add(driftRate: driftRate, &fbb)
    OnorbitDetails_Full.add(dryMass: dryMass, &fbb)
    OnorbitDetails_Full.add(additionalMass: additionalMass, &fbb)
    OnorbitDetails_Full.add(launchMassMin: launchMassMin, &fbb)
    OnorbitDetails_Full.add(launchMass: launchMass, &fbb)
    OnorbitDetails_Full.add(launchMassMax: launchMassMax, &fbb)
    OnorbitDetails_Full.add(bolFuelMass: bolFuelMass, &fbb)
    OnorbitDetails_Full.add(currentMass: currentMass, &fbb)
    OnorbitDetails_Full.add(totalMassUnc: totalMassUnc, &fbb)
    OnorbitDetails_Full.add(solarArrayArea: solarArrayArea, &fbb)
    OnorbitDetails_Full.add(maneuverable: maneuverable, &fbb)
    OnorbitDetails_Full.add(fuelRemaining: fuelRemaining, &fbb)
    OnorbitDetails_Full.add(crossSection: crossSection, &fbb)
    OnorbitDetails_Full.add(busCrossSection: busCrossSection, &fbb)
    OnorbitDetails_Full.add(maxRadius: maxRadius, &fbb)
    OnorbitDetails_Full.add(colaRadius: colaRadius, &fbb)
    OnorbitDetails_Full.add(adeptRadius: adeptRadius, &fbb)
    OnorbitDetails_Full.add(numDeployable: numDeployable, &fbb)
    OnorbitDetails_Full.addVectorOf(depNames: depNames, &fbb)
    OnorbitDetails_Full.addVectorOf(depEstMasses: depEstMasses, &fbb)
    OnorbitDetails_Full.addVectorOf(depMassUncs: depMassUncs, &fbb)
    OnorbitDetails_Full.add(source: source, &fbb)
    OnorbitDetails_Full.add(origin: origin, &fbb)
    OnorbitDetails_Full.add(lastObSource: lastObSource, &fbb)
    OnorbitDetails_Full.add(dataMode: dataMode, &fbb)
    OnorbitDetails_Full.add(createdAt: createdAt, &fbb)
    OnorbitDetails_Full.add(createdBy: createdBy, &fbb)
    OnorbitDetails_Full.add(updatedAt: updatedAt, &fbb)
    OnorbitDetails_Full.add(updatedBy: updatedBy, &fbb)
    OnorbitDetails_Full.add(origNetwork: origNetwork, &fbb)
    return OnorbitDetails_Full.endOnorbitDetails_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OnorbitDetails_Full_dataMode_Enum.self)
