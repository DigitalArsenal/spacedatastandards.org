...
public enum ISRCollectionTaskings_Abridged_type_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: ISRCollectionTaskings_Abridged_type_Enum { return .transit }
  public static var min: ISRCollectionTaskings_Abridged_type_Enum { return .deliberate }
}


public enum ISRCollectionTaskings_Abridged_collectionType_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: ISRCollectionTaskings_Abridged_collectionType_Enum { return .order }
  public static var min: ISRCollectionTaskings_Abridged_collectionType_Enum { return .simultaneous }
}


///  /// Individual taskings to complete the mission.
public struct ISRCollectionTaskings_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollectionTaskings_Abridged.id, addPrefix: prefix) }
  ...
  public var type: ISRCollectionTaskings_Abridged_type_Enum { let o = _accessor.offset(VTOFFSET.type.v); return o == 0 ? .deliberate : ISRCollectionTaskings_Abridged_type_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .deliberate }
  ///  Type of collection tasked.
  ///  Example: /// Example: Simultaneous
  ///  Constraints: Minimum length = 1, Maximum length = 16
  public var collectionType: ISRCollectionTaskings_Abridged_collectionType_Enum { let o = _accessor.offset(VTOFFSET.collectionType.v); return o == 0 ? .simultaneous : ISRCollectionTaskings_Abridged_collectionType_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .simultaneous }
  ...
  public static func startISRCollectionTaskings_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 27) }
  public static func add(id: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: id, at: VTOFFSET.id.p) }
  public static func add(type: ISRCollectionTaskings_Abridged_type_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: type.rawValue, def: 0, at: VTOFFSET.type.p) }
  public static func add(collectionType: ISRCollectionTaskings_Abridged_collectionType_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: collectionType.rawValue, def: 0, at: VTOFFSET.collectionType.p) }
  ...
  public static func endISRCollectionTaskings_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollectionTaskings_Abridged(
    _ fbb: inout FlatBufferBuilder,
    idOffset id: Offset = Offset(),
    type: ISRCollectionTaskings_Abridged_type_Enum = .deliberate,
    ...
    let __start = ISRCollectionTaskings_Abridged.startISRCollectionTaskings_Abridged(&fbb)
    ISRCollectionTaskings_Abridged.add(id: id, &fbb)
    ISRCollectionTaskings_Abridged.add(type: type, &fbb)
    ISRCollectionTaskings_Abridged.add(collectionType: collectionType, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingAor: taskingAor, &fbb)
    ISRCollectionTaskings_Abridged.add(eightLine: eightLine, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingPrimaryIntelDiscipline: taskingPrimaryIntelDiscipline, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingPrimarySubCategory: taskingPrimarySubCategory, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingSecondaryIntelDiscipline: taskingSecondaryIntelDiscipline, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingSecondarySubCategory: taskingSecondarySubCategory, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingRole: taskingRole, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingOperation: taskingOperation, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingPriority: taskingPriority, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingSupportedUnit: taskingSupportedUnit, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingEmphasis: taskingEmphasis, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingRetaskTime: taskingRetaskTime, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingStartPointLat: taskingStartPointLat, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingStartPointLong: taskingStartPointLong, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingCollectionArea: taskingCollectionArea, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingJoa: taskingJoa, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingSyncMatrixBin: taskingSyncMatrixBin, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingCountry: taskingCountry, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingRegion: taskingRegion, &fbb)
    ISRCollectionTaskings_Abridged.add(taskingSubRegion: taskingSubRegion, &fbb)
    ISRCollectionTaskings_Abridged.add(sroTrack: sroTrack, &fbb)
    ISRCollectionTaskings_Abridged.add(specialComGuidance: specialComGuidance, &fbb)
    ISRCollectionTaskings_Abridged.add(collectionPeriods: collectionPeriods, &fbb)
    ISRCollectionTaskings_Abridged.addVectorOf(taskingCollectionRequirements: taskingCollectionRequirements, &fbb)
    return ISRCollectionTaskings_Abridged.endISRCollectionTaskings_Abridged(&fbb, start: __start)
  }

  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    var _v = try verifier.visitTable(at: position)
    try _v.visit(field: VTOFFSET.id.p, fieldName: "id", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.type.p, fieldName: "type", required: false, type: ISRCollectionTaskings_Abridged_type_Enum.self)
    try _v.visit(field: VTOFFSET.collectionType.p, fieldName: "collectionType", required: false, type: ISRCollectionTaskings_Abridged_collectionType_Enum.self)
