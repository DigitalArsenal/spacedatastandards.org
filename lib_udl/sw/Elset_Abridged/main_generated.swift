...
public enum Elset_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Elset_Abridged_dataMode_Enum { return .exercise }
  public static var min: Elset_Abridged_dataMode_Enum { return .real }
}
...
public struct Elset_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Elset_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: Elset_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Elset_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startElset_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 37) }
  ...
  public static func add(dataMode: Elset_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endElset_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createElset_Abridged(
    ...
    let __start = Elset_Abridged.startElset_Abridged(&fbb)
    Elset_Abridged.add(idElset: idElset, &fbb)
    Elset_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Elset_Abridged.add(satNo: satNo, &fbb)
    Elset_Abridged.add(epoch: epoch, &fbb)
    Elset_Abridged.add(meanMotion: meanMotion, &fbb)
    Elset_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    Elset_Abridged.add(uct: uct, &fbb)
    Elset_Abridged.add(eccentricity: eccentricity, &fbb)
    Elset_Abridged.add(inclination: inclination, &fbb)
    Elset_Abridged.add(raan: raan, &fbb)
    Elset_Abridged.add(argOfPerigee: argOfPerigee, &fbb)
    Elset_Abridged.add(meanAnomaly: meanAnomaly, &fbb)
    Elset_Abridged.add(revNo: revNo, &fbb)
    Elset_Abridged.add(bStar: bStar, &fbb)
    Elset_Abridged.add(agom: agom, &fbb)
    Elset_Abridged.add(ballisticCoeff: ballisticCoeff, &fbb)
    Elset_Abridged.add(meanMotionDot: meanMotionDot, &fbb)
    Elset_Abridged.add(meanMotionDdot: meanMotionDdot, &fbb)
    Elset_Abridged.add(semiMajorAxis: semiMajorAxis, &fbb)
    Elset_Abridged.add(period: period, &fbb)
    Elset_Abridged.add(apogee: apogee, &fbb)
    Elset_Abridged.add(perigee: perigee, &fbb)
    Elset_Abridged.add(origObjectId: origObjectId, &fbb)
    Elset_Abridged.add(idOrbitDetermination: idOrbitDetermination, &fbb)
    Elset_Abridged.add(line1: line1, &fbb)
    Elset_Abridged.add(line2: line2, &fbb)
    Elset_Abridged.add(descriptor: descriptor, &fbb)
    Elset_Abridged.add(createdAt: createdAt, &fbb)
    Elset_Abridged.add(createdBy: createdBy, &fbb)
    Elset_Abridged.add(origin: origin, &fbb)
    Elset_Abridged.add(sourceDl: sourceDl, &fbb)
    Elset_Abridged.add(source: source, &fbb)
    Elset_Abridged.add(dataMode: dataMode, &fbb)
    Elset_Abridged.add(algorithm: algorithm, &fbb)
    Elset_Abridged.add(transactionId: transactionId, &fbb)
    Elset_Abridged.add(ephemType: ephemType, &fbb)
    Elset_Abridged.add(origNetwork: origNetwork, &fbb)
    return Elset_Abridged.endElset_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Elset_Abridged_dataMode_Enum.self)
