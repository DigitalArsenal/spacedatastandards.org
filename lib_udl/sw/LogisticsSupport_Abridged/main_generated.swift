...
public enum LogisticsSupport_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: LogisticsSupport_Abridged_dataMode_Enum { return .exercise }
  public static var min: LogisticsSupport_Abridged_dataMode_Enum { return .real }
}
...
public struct LogisticsSupport_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LogisticsSupport_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: LogisticsSupport_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : LogisticsSupport_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startLogisticsSupport_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 30) }
  ...
  public static func add(dataMode: LogisticsSupport_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endLogisticsSupport_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLogisticsSupport_Abridged(
    ...
    let __start = LogisticsSupport_Abridged.startLogisticsSupport_Abridged(&fbb)
    LogisticsSupport_Abridged.add(id: id, &fbb)
    LogisticsSupport_Abridged.add(classificationMarking: classificationMarking, &fbb)
    LogisticsSupport_Abridged.add(extSystemId: extSystemId, &fbb)
    LogisticsSupport_Abridged.add(tailNumber: tailNumber, &fbb)
    LogisticsSupport_Abridged.add(aircraftMds: aircraftMds, &fbb)
    LogisticsSupport_Abridged.add(currIcao: currIcao, &fbb)
    LogisticsSupport_Abridged.add(suppIcao: suppIcao, &fbb)
    LogisticsSupport_Abridged.add(rptCreatedTime: rptCreatedTime, &fbb)
    LogisticsSupport_Abridged.add(rptClosedTime: rptClosedTime, &fbb)
    LogisticsSupport_Abridged.add(meTime: meTime, &fbb)
    LogisticsSupport_Abridged.add(mcTime: mcTime, &fbb)
    LogisticsSupport_Abridged.add(logisticAction: logisticAction, &fbb)
    LogisticsSupport_Abridged.add(logisticsRecordId: logisticsRecordId, &fbb)
    LogisticsSupport_Abridged.add(etic: etic, &fbb)
    LogisticsSupport_Abridged.add(etmc: etmc, &fbb)
    LogisticsSupport_Abridged.add(maintStatusCode: maintStatusCode, &fbb)
    LogisticsSupport_Abridged.add(reopenFlag: reopenFlag, &fbb)
    LogisticsSupport_Abridged.add(owner: owner, &fbb)
    LogisticsSupport_Abridged.addVectorOf(logisticsRemarks: logisticsRemarks, &fbb)
    LogisticsSupport_Abridged.addVectorOf(logisticsDiscrepancyInfos: logisticsDiscrepancyInfos, &fbb)
    LogisticsSupport_Abridged.addVectorOf(logisticsTransportationPlans: logisticsTransportationPlans, &fbb)
    LogisticsSupport_Abridged.addVectorOf(logisticsSupportItems: logisticsSupportItems, &fbb)
    LogisticsSupport_Abridged.add(origNetwork: origNetwork, &fbb)
    LogisticsSupport_Abridged.add(createdAt: createdAt, &fbb)
    LogisticsSupport_Abridged.add(createdBy: createdBy, &fbb)
    LogisticsSupport_Abridged.add(updatedAt: updatedAt, &fbb)
    LogisticsSupport_Abridged.add(updatedBy: updatedBy, &fbb)
    LogisticsSupport_Abridged.add(source: source, &fbb)
    LogisticsSupport_Abridged.add(origin: origin, &fbb)
    LogisticsSupport_Abridged.add(dataMode: dataMode, &fbb)
    return LogisticsSupport_Abridged.endLogisticsSupport_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: LogisticsSupport_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
