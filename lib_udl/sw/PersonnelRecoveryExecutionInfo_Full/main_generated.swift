...
public struct PersonnelRecoveryExecutionInfo_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: PersonnelRecoveryExecutionInfo_Full.id, addPrefix: prefix) }
  ...
  public static func startPersonnelRecoveryExecutionInfo_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 7) }
  ...
  public static func endPersonnelRecoveryExecutionInfo_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPersonnelRecoveryExecutionInfo_Full(
    ...
    let __start = PersonnelRecoveryExecutionInfo_Full.startPersonnelRecoveryExecutionInfo_Full(&fbb)
    PersonnelRecoveryExecutionInfo_Full.addVectorOf(initialPoint: initialPoint, &fbb)
    PersonnelRecoveryExecutionInfo_Full.add(ingress: ingress, &fbb)
    PersonnelRecoveryExecutionInfo_Full.add(objStrategy: objStrategy, &fbb)
    PersonnelRecoveryExecutionInfo_Full.addVectorOf(egressPoint: egressPoint, &fbb)
    PersonnelRecoveryExecutionInfo_Full.add(egress: egress, &fbb)
    PersonnelRecoveryExecutionInfo_Full.add(recoveryVehicle: recoveryVehicle, &fbb)
    PersonnelRecoveryExecutionInfo_Full.add(escortVehicle: escortVehicle, &fbb)
    return PersonnelRecoveryExecutionInfo_Full.endPersonnelRecoveryExecutionInfo_Full(&fbb, start: __start)
  }
