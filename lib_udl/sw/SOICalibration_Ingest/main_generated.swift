...
public struct SOICalibration_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SOICalibration_Ingest.id, addPrefix: prefix) }
  ...
  public static func startSOICalibration_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 11) }
  ...
  public static func endSOICalibration_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSOICalibration_Ingest(
    ...
    let __start = SOICalibration_Ingest.startSOICalibration_Ingest(&fbb)
    SOICalibration_Ingest.add(calExtinctionCoeff: calExtinctionCoeff, &fbb)
    SOICalibration_Ingest.add(calSkyBg: calSkyBg, &fbb)
    SOICalibration_Ingest.add(calBgIntensity: calBgIntensity, &fbb)
    SOICalibration_Ingest.add(calSpectralFilterSolarMag: calSpectralFilterSolarMag, &fbb)
    SOICalibration_Ingest.add(calZeroPoint: calZeroPoint, &fbb)
    SOICalibration_Ingest.add(calNumDetectedStars: calNumDetectedStars, &fbb)
    SOICalibration_Ingest.add(calNumCorrelatedStars: calNumCorrelatedStars, &fbb)
    SOICalibration_Ingest.add(calExtinctionCoeffUnc: calExtinctionCoeffUnc, &fbb)
    SOICalibration_Ingest.add(calExtinctionCoeffMaxUnc: calExtinctionCoeffMaxUnc, &fbb)
    SOICalibration_Ingest.add(calTime: calTime, &fbb)
    SOICalibration_Ingest.add(calType: calType, &fbb)
    return SOICalibration_Ingest.endSOICalibration_Ingest(&fbb, start: __start)
  }
