...
public enum SpaceEnvObservation_Ingest_senReferenceFrame_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SpaceEnvObservation_Ingest_senReferenceFrame_Enum { return .gcrf }
  public static var min: SpaceEnvObservation_Ingest_senReferenceFrame_Enum { return .j2000 }
}


public enum SpaceEnvObservation_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: SpaceEnvObservation_Ingest_dataMode_Enum { return .exercise }
  public static var min: SpaceEnvObservation_Ingest_dataMode_Enum { return .real }
}


///  /// SpaceEnvObservation data.
public struct SpaceEnvObservation_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SpaceEnvObservation_Ingest.id, addPrefix: prefix) }
  ...
  public var senReferenceFrame: SpaceEnvObservation_Ingest_senReferenceFrame_Enum { let o = _accessor.offset(VTOFFSET.senReferenceFrame.v); return o == 0 ? .j2000 : SpaceEnvObservation_Ingest_senReferenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ...
  public var dataMode: SpaceEnvObservation_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SpaceEnvObservation_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startSpaceEnvObservation_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 41) }
  ...
  public static func add(senReferenceFrame: SpaceEnvObservation_Ingest_senReferenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: senReferenceFrame.rawValue, def: 0, at: VTOFFSET.senReferenceFrame.p) }
  ...
  public static func add(dataMode: SpaceEnvObservation_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endSpaceEnvObservation_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSpaceEnvObservation_Ingest(
    ...
    let __start = SpaceEnvObservation_Ingest.startSpaceEnvObservation_Ingest(&fbb)
    SpaceEnvObservation_Ingest.add(id: id, &fbb)
    SpaceEnvObservation_Ingest.add(classificationMarking: classificationMarking, &fbb)
    SpaceEnvObservation_Ingest.add(msgType: msgType, &fbb)
    SpaceEnvObservation_Ingest.add(genSystem: genSystem, &fbb)
    SpaceEnvObservation_Ingest.add(externalId: externalId, &fbb)
    SpaceEnvObservation_Ingest.add(dataType: dataType, &fbb)
    SpaceEnvObservation_Ingest.add(genTime: genTime, &fbb)
    SpaceEnvObservation_Ingest.add(forecast: forecast, &fbb)
    SpaceEnvObservation_Ingest.add(derived: derived, &fbb)
    SpaceEnvObservation_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    SpaceEnvObservation_Ingest.add(satNo: satNo, &fbb)
    SpaceEnvObservation_Ingest.add(origObjectId: origObjectId, &fbb)
    SpaceEnvObservation_Ingest.add(idSensor: idSensor, &fbb)
    SpaceEnvObservation_Ingest.add(origSensorId: origSensorId, &fbb)
    SpaceEnvObservation_Ingest.add(observatoryType: observatoryType, &fbb)
    SpaceEnvObservation_Ingest.add(observatoryName: observatoryName, &fbb)
    SpaceEnvObservation_Ingest.add(observatoryNotes: observatoryNotes, &fbb)
    SpaceEnvObservation_Ingest.add(instrumentType: instrumentType, &fbb)
    SpaceEnvObservation_Ingest.add(lat: lat, &fbb)
    SpaceEnvObservation_Ingest.add(lon: lon, &fbb)
    SpaceEnvObservation_Ingest.add(alt: alt, &fbb)
    SpaceEnvObservation_Ingest.add(senReferenceFrame: senReferenceFrame, &fbb)
    SpaceEnvObservation_Ingest.addVectorOf(senPos: senPos, &fbb)
    SpaceEnvObservation_Ingest.addVectorOf(senVel: senVel, &fbb)
    SpaceEnvObservation_Ingest.add(measType: measType, &fbb)
    SpaceEnvObservation_Ingest.add(senEnergyLevel: senEnergyLevel, &fbb)
    SpaceEnvObservation_Ingest.add(obSetId: obSetId, &fbb)
    SpaceEnvObservation_Ingest.add(particleType: particleType, &fbb)
    SpaceEnvObservation_Ingest.add(obTime: obTime, &fbb)
    SpaceEnvObservation_Ingest.addVectorOf(seoList: seoList, &fbb)
    SpaceEnvObservation_Ingest.add(quality: quality, &fbb)
    SpaceEnvObservation_Ingest.add(description: description, &fbb)
    SpaceEnvObservation_Ingest.add(descriptor: descriptor, &fbb)
    SpaceEnvObservation_Ingest.addVectorOf(srcTyps: srcTyps, &fbb)
    SpaceEnvObservation_Ingest.addVectorOf(srcIds: srcIds, &fbb)
    SpaceEnvObservation_Ingest.add(createdAt: createdAt, &fbb)
    SpaceEnvObservation_Ingest.add(createdBy: createdBy, &fbb)
    SpaceEnvObservation_Ingest.add(source: source, &fbb)
    SpaceEnvObservation_Ingest.add(origin: origin, &fbb)
    SpaceEnvObservation_Ingest.add(dataMode: dataMode, &fbb)
    SpaceEnvObservation_Ingest.add(origNetwork: origNetwork, &fbb)
    return SpaceEnvObservation_Ingest.endSpaceEnvObservation_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.senReferenceFrame.p, fieldName: "senReferenceFrame", required: false, type: SpaceEnvObservation_Ingest_senReferenceFrame_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SpaceEnvObservation_Ingest_dataMode_Enum.self)
