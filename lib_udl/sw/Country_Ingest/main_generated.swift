...
public enum Country_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Country_Ingest_dataMode_Enum { return .exercise }
  public static var min: Country_Ingest_dataMode_Enum { return .real }
}


///  /// A Country may represent countries, multi-national consortiums, and international organizations.
public struct Country_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Country_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Country_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Country_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startCountry_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 10) }
  ...
  public static func add(dataMode: Country_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endCountry_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createCountry_Ingest(
    ...
    let __start = Country_Ingest.startCountry_Ingest(&fbb)
    Country_Ingest.add(code: code, &fbb)
    Country_Ingest.add(name: name, &fbb)
    Country_Ingest.add(fipsCode: fipsCode, &fbb)
    Country_Ingest.add(iso3Code: iso3Code, &fbb)
    Country_Ingest.add(codeAlt: codeAlt, &fbb)
    Country_Ingest.add(createdAt: createdAt, &fbb)
    Country_Ingest.add(createdBy: createdBy, &fbb)
    Country_Ingest.add(source: source, &fbb)
    Country_Ingest.add(origNetwork: origNetwork, &fbb)
    Country_Ingest.add(dataMode: dataMode, &fbb)
    return Country_Ingest.endCountry_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Country_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
