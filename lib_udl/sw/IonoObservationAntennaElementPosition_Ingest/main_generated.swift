...
public struct IonoObservationAntennaElementPosition_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationAntennaElementPosition_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationAntennaElementPosition_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endIonoObservationAntennaElementPosition_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationAntennaElementPosition_Ingest(
    ...
    let __start = IonoObservationAntennaElementPosition_Ingest.startIonoObservationAntennaElementPosition_Ingest(&fbb)
    IonoObservationAntennaElementPosition_Ingest.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationAntennaElementPosition_Ingest.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationAntennaElementPosition_Ingest.addVectorOf(data: data, &fbb)
    return IonoObservationAntennaElementPosition_Ingest.endIonoObservationAntennaElementPosition_Ingest(&fbb, start: __start)
  }
