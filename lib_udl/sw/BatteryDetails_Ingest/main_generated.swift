...
public enum BatteryDetails_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: BatteryDetails_Ingest_dataMode_Enum { return .exercise }
  public static var min: BatteryDetails_Ingest_dataMode_Enum { return .real }
}
...
public struct BatteryDetails_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: BatteryDetails_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: BatteryDetails_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : BatteryDetails_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startBatteryDetails_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 16) }
  ...
  public static func add(dataMode: BatteryDetails_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func addVectorOf(tags: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: tags, at: VTOFFSET.tags.p) }
  public static func endBatteryDetails_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createBatteryDetails_Ingest(
    ...
    let __start = BatteryDetails_Ingest.startBatteryDetails_Ingest(&fbb)
    BatteryDetails_Ingest.add(id: id, &fbb)
    BatteryDetails_Ingest.add(idBattery: idBattery, &fbb)
    BatteryDetails_Ingest.add(classificationMarking: classificationMarking, &fbb)
    BatteryDetails_Ingest.add(technology: technology, &fbb)
    BatteryDetails_Ingest.add(capacity: capacity, &fbb)
    BatteryDetails_Ingest.add(dischargeDepth: dischargeDepth, &fbb)
    BatteryDetails_Ingest.add(model: model, &fbb)
    BatteryDetails_Ingest.add(description: description, &fbb)
    BatteryDetails_Ingest.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    BatteryDetails_Ingest.add(createdAt: createdAt, &fbb)
    BatteryDetails_Ingest.add(createdBy: createdBy, &fbb)
    BatteryDetails_Ingest.add(source: source, &fbb)
    BatteryDetails_Ingest.add(origin: origin, &fbb)
    BatteryDetails_Ingest.add(origNetwork: origNetwork, &fbb)
    BatteryDetails_Ingest.add(dataMode: dataMode, &fbb)
    BatteryDetails_Ingest.addVectorOf(tags: tags, &fbb)
    return BatteryDetails_Ingest.endBatteryDetails_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: BatteryDetails_Ingest_dataMode_Enum.self)
