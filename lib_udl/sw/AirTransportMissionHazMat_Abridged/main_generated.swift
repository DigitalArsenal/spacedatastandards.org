...
public struct AirTransportMissionHazMat_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirTransportMissionHazMat_Abridged.id, addPrefix: prefix) }
  ...
  public static func startAirTransportMissionHazMat_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 15) }
  ...
  public static func endAirTransportMissionHazMat_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirTransportMissionHazMat_Abridged(
    ...
    let __start = AirTransportMissionHazMat_Abridged.startAirTransportMissionHazMat_Abridged(&fbb)
    AirTransportMissionHazMat_Abridged.add(extHazMatId: extHazMatId, &fbb)
    AirTransportMissionHazMat_Abridged.add(itemName: itemName, &fbb)
    AirTransportMissionHazMat_Abridged.add(unNum: unNum, &fbb)
    AirTransportMissionHazMat_Abridged.add(pieces: pieces, &fbb)
    AirTransportMissionHazMat_Abridged.add(weight: weight, &fbb)
    AirTransportMissionHazMat_Abridged.add(netExpWt: netExpWt, &fbb)
    AirTransportMissionHazMat_Abridged.add(classDiv: classDiv, &fbb)
    AirTransportMissionHazMat_Abridged.add(cgc: cgc, &fbb)
    AirTransportMissionHazMat_Abridged.add(cgn: cgn, &fbb)
    AirTransportMissionHazMat_Abridged.add(applicableNotes: applicableNotes, &fbb)
    AirTransportMissionHazMat_Abridged.add(onItin: onItin, &fbb)
    AirTransportMissionHazMat_Abridged.add(onIcao: onIcao, &fbb)
    AirTransportMissionHazMat_Abridged.add(offItin: offItin, &fbb)
    AirTransportMissionHazMat_Abridged.add(offIcao: offIcao, &fbb)
    AirTransportMissionHazMat_Abridged.add(planned: planned, &fbb)
    return AirTransportMissionHazMat_Abridged.endAirTransportMissionHazMat_Abridged(&fbb, start: __start)
  }
