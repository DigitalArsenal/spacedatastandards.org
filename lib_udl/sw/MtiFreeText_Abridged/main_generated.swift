...
public struct MtiFreeText_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiFreeText_Abridged.id, addPrefix: prefix) }
  ...
  public static func startMtiFreeText_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endMtiFreeText_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiFreeText_Abridged(
    _ fbb: inout FlatBufferBuilder,
    f1Offset f1: Offset = Offset(),
    f2Offset f2: Offset = Offset(),
    f3Offset f3: Offset = Offset()
  ) -> Offset {
    let __start = MtiFreeText_Abridged.startMtiFreeText_Abridged(&fbb)
    MtiFreeText_Abridged.add(f1: f1, &fbb)
    MtiFreeText_Abridged.add(f2: f2, &fbb)
    MtiFreeText_Abridged.add(f3: f3, &fbb)
    return MtiFreeText_Abridged.endMtiFreeText_Abridged(&fbb, start: __start)
  }
