...
public enum Entity_Full_type_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Entity_Full_type_Enum { return .vessel }
  public static var min: Entity_Full_type_Enum { return .aircraft }
}


public enum Entity_Full_ownerType_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: Entity_Full_ownerType_Enum { return .other }
  public static var min: Entity_Full_ownerType_Enum { return .commercial }
}


public enum Entity_Full_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: Entity_Full_dataMode_Enum { return .exercise }
  public static var min: Entity_Full_dataMode_Enum { return .real }
}
...
public struct Entity_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Entity_Full.id, addPrefix: prefix) }
  ...
  public var type: Entity_Full_type_Enum { let o = _accessor.offset(VTOFFSET.type.v); return o == 0 ? .aircraft : Entity_Full_type_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .aircraft }
  ...
  public var ownerType: Entity_Full_ownerType_Enum { let o = _accessor.offset(VTOFFSET.ownerType.v); return o == 0 ? .commercial : Entity_Full_ownerType_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .commercial }
  ...
  public var dataMode: Entity_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Entity_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startEntity_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 24) }
  ...
  public static func add(type: Entity_Full_type_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: type.rawValue, def: 0, at: VTOFFSET.type.p) }
  ...
  public static func add(ownerType: Entity_Full_ownerType_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: ownerType.rawValue, def: 0, at: VTOFFSET.ownerType.p) }
  ...
  public static func add(dataMode: Entity_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endEntity_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEntity_Full(
    _ fbb: inout FlatBufferBuilder,
    idEntityOffset idEntity: Offset = Offset(),
    nameOffset name: Offset = Offset(),
    classificationMarkingOffset classificationMarking: Offset = Offset(),
    type: Entity_Full_type_Enum = .aircraft,
    ...
    let __start = Entity_Full.startEntity_Full(&fbb)
    Entity_Full.add(idEntity: idEntity, &fbb)
    Entity_Full.add(name: name, &fbb)
    Entity_Full.add(classificationMarking: classificationMarking, &fbb)
    Entity_Full.add(type: type, &fbb)
    Entity_Full.add(idLocation: idLocation, &fbb)
    Entity_Full.add(countryCode: countryCode, &fbb)
    Entity_Full.add(ownerType: ownerType, &fbb)
    Entity_Full.add(taskable: taskable, &fbb)
    Entity_Full.addVectorOf(urls: urls, &fbb)
    Entity_Full.add(createdAt: createdAt, &fbb)
    Entity_Full.add(createdBy: createdBy, &fbb)
    Entity_Full.add(updatedAt: updatedAt, &fbb)
    Entity_Full.add(updatedBy: updatedBy, &fbb)
    Entity_Full.add(source: source, &fbb)
    Entity_Full.add(origin: origin, &fbb)
    Entity_Full.add(dataMode: dataMode, &fbb)
    Entity_Full.add(location: location, &fbb)
    Entity_Full.add(onOrbit: onOrbit, &fbb)
    Entity_Full.add(idOnOrbit: idOnOrbit, &fbb)
    Entity_Full.add(operatingUnit: operatingUnit, &fbb)
    Entity_Full.add(idOperatingUnit: idOperatingUnit, &fbb)
    Entity_Full.add(origNetwork: origNetwork, &fbb)
    Entity_Full.addVectorOf(statusCollection: statusCollection, &fbb)
    Entity_Full.addVectorOf(rfBands: rfBands, &fbb)
    return Entity_Full.endEntity_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.type.p, fieldName: "type", required: false, type: Entity_Full_type_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.ownerType.p, fieldName: "ownerType", required: false, type: Entity_Full_ownerType_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Entity_Full_dataMode_Enum.self)
