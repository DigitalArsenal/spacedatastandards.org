...
public enum GEOStatus_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: GEOStatus_Ingest_dataMode_Enum { return .exercise }
  public static var min: GEOStatus_Ingest_dataMode_Enum { return .real }
}


///  /// Information for the specified on-orbit GEO spacecraft, including status, expected longitude limits, and drift rates.
public struct GEOStatus_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: GEOStatus_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: GEOStatus_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : GEOStatus_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startGEOStatus_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 24) }
  ...
  public static func add(dataMode: GEOStatus_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endGEOStatus_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createGEOStatus_Ingest(
    ...
    let __start = GEOStatus_Ingest.startGEOStatus_Ingest(&fbb)
    GEOStatus_Ingest.add(id: id, &fbb)
    GEOStatus_Ingest.add(classificationMarking: classificationMarking, &fbb)
    GEOStatus_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    GEOStatus_Ingest.add(origObjectId: origObjectId, &fbb)
    GEOStatus_Ingest.add(ss: ss, &fbb)
    GEOStatus_Ingest.add(sc: sc, &fbb)
    GEOStatus_Ingest.add(relativeEnergy: relativeEnergy, &fbb)
    GEOStatus_Ingest.add(longitudeRate: longitudeRate, &fbb)
    GEOStatus_Ingest.add(longitudeMin: longitudeMin, &fbb)
    GEOStatus_Ingest.add(longitudeMax: longitudeMax, &fbb)
    GEOStatus_Ingest.add(confidenceLevel: confidenceLevel, &fbb)
    GEOStatus_Ingest.add(planeChangeStatus: planeChangeStatus, &fbb)
    GEOStatus_Ingest.add(troughType: troughType, &fbb)
    GEOStatus_Ingest.add(lostFlag: lostFlag, &fbb)
    GEOStatus_Ingest.add(semiAnnualCorrFlag: semiAnnualCorrFlag, &fbb)
    GEOStatus_Ingest.add(objectStatus: objectStatus, &fbb)
    GEOStatus_Ingest.add(rawFileUri: rawFileUri, &fbb)
    GEOStatus_Ingest.add(createdAt: createdAt, &fbb)
    GEOStatus_Ingest.add(createdBy: createdBy, &fbb)
    GEOStatus_Ingest.add(source: source, &fbb)
    GEOStatus_Ingest.add(origin: origin, &fbb)
    GEOStatus_Ingest.add(dataMode: dataMode, &fbb)
    GEOStatus_Ingest.add(satNo: satNo, &fbb)
    GEOStatus_Ingest.add(origNetwork: origNetwork, &fbb)
    return GEOStatus_Ingest.endGEOStatus_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: GEOStatus_Ingest_dataMode_Enum.self)
