...
public enum AttitudeSet_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AttitudeSet_Full_dataMode_Enum { return .exercise }
  public static var min: AttitudeSet_Full_dataMode_Enum { return .real }
}
...
public struct AttitudeSet_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AttitudeSet_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: AttitudeSet_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AttitudeSet_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startAttitudeSet_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 30) }
  ...
  public static func add(dataMode: AttitudeSet_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endAttitudeSet_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAttitudeSet_Full(
    ...
    let __start = AttitudeSet_Full.startAttitudeSet_Full(&fbb)
    AttitudeSet_Full.add(id: id, &fbb)
    AttitudeSet_Full.add(classificationMarking: classificationMarking, &fbb)
    AttitudeSet_Full.add(idOnOrbit: idOnOrbit, &fbb)
    AttitudeSet_Full.add(satNo: satNo, &fbb)
    AttitudeSet_Full.add(origObjectId: origObjectId, &fbb)
    AttitudeSet_Full.add(type: type, &fbb)
    AttitudeSet_Full.add(esId: esId, &fbb)
    AttitudeSet_Full.addVectorOf(asRef: asRef, &fbb)
    AttitudeSet_Full.add(idSensor: idSensor, &fbb)
    AttitudeSet_Full.add(origSensorId: origSensorId, &fbb)
    AttitudeSet_Full.add(startTime: startTime, &fbb)
    AttitudeSet_Full.add(endTime: endTime, &fbb)
    AttitudeSet_Full.add(frame1: frame1, &fbb)
    AttitudeSet_Full.add(frame2: frame2, &fbb)
    AttitudeSet_Full.add(numPoints: numPoints, &fbb)
    AttitudeSet_Full.add(stepSize: stepSize, &fbb)
    AttitudeSet_Full.add(precAngleInit: precAngleInit, &fbb)
    AttitudeSet_Full.add(spinAngleInit: spinAngleInit, &fbb)
    AttitudeSet_Full.add(eulerRotSeq: eulerRotSeq, &fbb)
    AttitudeSet_Full.addVectorOf(attitudeList: attitudeList, &fbb)
    AttitudeSet_Full.add(interpolator: interpolator, &fbb)
    AttitudeSet_Full.add(interpolatorDegree: interpolatorDegree, &fbb)
    AttitudeSet_Full.add(notes: notes, &fbb)
    AttitudeSet_Full.add(createdAt: createdAt, &fbb)
    AttitudeSet_Full.add(createdBy: createdBy, &fbb)
    AttitudeSet_Full.add(source: source, &fbb)
    AttitudeSet_Full.add(origin: origin, &fbb)
    AttitudeSet_Full.add(dataMode: dataMode, &fbb)
    AttitudeSet_Full.add(origNetwork: origNetwork, &fbb)
    AttitudeSet_Full.add(onOrbit: onOrbit, &fbb)
    return AttitudeSet_Full.endAttitudeSet_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AttitudeSet_Full_dataMode_Enum.self)
