...
public enum WeatherReport_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: WeatherReport_Full_dataMode_Enum { return .exercise }
  public static var min: WeatherReport_Full_dataMode_Enum { return .real }
}
...
public struct WeatherReport_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: WeatherReport_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: WeatherReport_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : WeatherReport_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startWeatherReport_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 86) }
  ...
  public static func add(dataMode: WeatherReport_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endWeatherReport_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createWeatherReport_Full(
    ...
    let __start = WeatherReport_Full.startWeatherReport_Full(&fbb)
    WeatherReport_Full.add(id: id, &fbb)
    WeatherReport_Full.add(classificationMarking: classificationMarking, &fbb)
    WeatherReport_Full.add(idSensor: idSensor, &fbb)
    WeatherReport_Full.add(origSensorId: origSensorId, &fbb)
    WeatherReport_Full.add(weatherId: weatherId, &fbb)
    WeatherReport_Full.add(idGroundImagery: idGroundImagery, &fbb)
    WeatherReport_Full.add(idSite: idSite, &fbb)
    WeatherReport_Full.add(idAirfield: idAirfield, &fbb)
    WeatherReport_Full.add(icao: icao, &fbb)
    WeatherReport_Full.add(externalId: externalId, &fbb)
    WeatherReport_Full.add(externalLocationId: externalLocationId, &fbb)
    WeatherReport_Full.add(reportType: reportType, &fbb)
    WeatherReport_Full.add(obTime: obTime, &fbb)
    WeatherReport_Full.add(forecastStartTime: forecastStartTime, &fbb)
    WeatherReport_Full.add(forecastEndTime: forecastEndTime, &fbb)
    WeatherReport_Full.add(lat: lat, &fbb)
    WeatherReport_Full.add(lon: lon, &fbb)
    WeatherReport_Full.add(alt: alt, &fbb)
    WeatherReport_Full.add(geoPotentialAlt: geoPotentialAlt, &fbb)
    WeatherReport_Full.add(dataLevel: dataLevel, &fbb)
    WeatherReport_Full.add(area: area, &fbb)
    WeatherReport_Full.add(atext: atext, &fbb)
    WeatherReport_Full.add(agjson: agjson, &fbb)
    WeatherReport_Full.add(atype: atype, &fbb)
    WeatherReport_Full.add(andims: andims, &fbb)
    WeatherReport_Full.add(asrid: asrid, &fbb)
    WeatherReport_Full.add(windSpd: windSpd, &fbb)
    WeatherReport_Full.add(windSpdAvg: windSpdAvg, &fbb)
    WeatherReport_Full.add(windGust: windGust, &fbb)
    WeatherReport_Full.add(windGust10: windGust10, &fbb)
    WeatherReport_Full.add(vshear: vshear, &fbb)
    WeatherReport_Full.add(hshear: hshear, &fbb)
    WeatherReport_Full.add(radVel: radVel, &fbb)
    WeatherReport_Full.add(radVelBeam1: radVelBeam1, &fbb)
    WeatherReport_Full.add(radVelBeam2: radVelBeam2, &fbb)
    WeatherReport_Full.add(radVelBeam3: radVelBeam3, &fbb)
    WeatherReport_Full.add(radVelBeam4: radVelBeam4, &fbb)
    WeatherReport_Full.add(radVelBeam5: radVelBeam5, &fbb)
    WeatherReport_Full.add(windDir: windDir, &fbb)
    WeatherReport_Full.add(windDirAvg: windDirAvg, &fbb)
    WeatherReport_Full.add(windDirPeak: windDirPeak, &fbb)
    WeatherReport_Full.add(windDirPeak10: windDirPeak10, &fbb)
    WeatherReport_Full.add(windChill: windChill, &fbb)
    WeatherReport_Full.add(dirDev: dirDev, &fbb)
    WeatherReport_Full.add(windVar: windVar, &fbb)
    WeatherReport_Full.addVectorOf(windCov: windCov, &fbb)
    WeatherReport_Full.addVectorOf(cloudCover: cloudCover, &fbb)
    WeatherReport_Full.addVectorOf(cloudHght: cloudHght, &fbb)
    WeatherReport_Full.add(actWeather: actWeather, &fbb)
    WeatherReport_Full.add(weatherDesc: weatherDesc, &fbb)
    WeatherReport_Full.add(weatherInt: weatherInt, &fbb)
    WeatherReport_Full.add(rawMetar: rawMetar, &fbb)
    WeatherReport_Full.add(rawTaf: rawTaf, &fbb)
    WeatherReport_Full.add(qnh: qnh, &fbb)
    WeatherReport_Full.add(visibility: visibility, &fbb)
    WeatherReport_Full.add(temperature: temperature, &fbb)
    WeatherReport_Full.add(soilTemp: soilTemp, &fbb)
    WeatherReport_Full.add(barPress: barPress, &fbb)
    WeatherReport_Full.add(precipRate: precipRate, &fbb)
    WeatherReport_Full.add(rainHour: rainHour, &fbb)
    WeatherReport_Full.add(solarRad: solarRad, &fbb)
    WeatherReport_Full.add(difRad: difRad, &fbb)
    WeatherReport_Full.add(refRad: refRad, &fbb)
    WeatherReport_Full.add(senlat: senlat, &fbb)
    WeatherReport_Full.add(senlon: senlon, &fbb)
    WeatherReport_Full.add(senalt: senalt, &fbb)
    WeatherReport_Full.add(dewPoint: dewPoint, &fbb)
    WeatherReport_Full.add(relHumidity: relHumidity, &fbb)
    WeatherReport_Full.add(indexRefraction: indexRefraction, &fbb)
    WeatherReport_Full.add(soilMoisture: soilMoisture, &fbb)
    WeatherReport_Full.add(surroundingWeather: surroundingWeather, &fbb)
    WeatherReport_Full.add(weatherAmp: weatherAmp, &fbb)
    WeatherReport_Full.add(contrailHghtLower: contrailHghtLower, &fbb)
    WeatherReport_Full.add(contrailHghtUpper: contrailHghtUpper, &fbb)
    WeatherReport_Full.add(icingUpperLimit: icingUpperLimit, &fbb)
    WeatherReport_Full.add(icingLowerLimit: icingLowerLimit, &fbb)
    WeatherReport_Full.add(enRouteWeather: enRouteWeather, &fbb)
    WeatherReport_Full.add(ccEvent: ccEvent, &fbb)
    WeatherReport_Full.addVectorOf(srcTyps: srcTyps, &fbb)
    WeatherReport_Full.addVectorOf(srcIds: srcIds, &fbb)
    WeatherReport_Full.add(origNetwork: origNetwork, &fbb)
    WeatherReport_Full.add(createdAt: createdAt, &fbb)
    WeatherReport_Full.add(createdBy: createdBy, &fbb)
    WeatherReport_Full.add(source: source, &fbb)
    WeatherReport_Full.add(origin: origin, &fbb)
    WeatherReport_Full.add(dataMode: dataMode, &fbb)
    return WeatherReport_Full.endWeatherReport_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: WeatherReport_Full_dataMode_Enum.self)
    _v.finish()
  }
}
