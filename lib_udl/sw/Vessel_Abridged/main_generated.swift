...
public enum Vessel_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Vessel_Abridged_dataMode_Enum { return .exercise }
  public static var min: Vessel_Abridged_dataMode_Enum { return .real }
}
...
public struct Vessel_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Vessel_Abridged.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case idEntity = 8
    case altVesselId = 10
    case idOrganization = 12
    case vesselName = 14
    case vesselType = 16
    case vesselClass = 18
    case vesselDescription = 20
    case sconum = 22
    case imon = 24
    case mmsi = 26
    case callsign = 28
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 64
  public var dataMode: Vessel_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Vessel_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: OPS1
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startVessel_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 34) }
  ...
  public static func add(dataMode: Vessel_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endVessel_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createVessel_Abridged(
    ...
    let __start = Vessel_Abridged.startVessel_Abridged(&fbb)
    Vessel_Abridged.add(id: id, &fbb)
    Vessel_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Vessel_Abridged.add(idEntity: idEntity, &fbb)
    Vessel_Abridged.add(altVesselId: altVesselId, &fbb)
    Vessel_Abridged.add(idOrganization: idOrganization, &fbb)
    Vessel_Abridged.add(vesselName: vesselName, &fbb)
    Vessel_Abridged.add(vesselType: vesselType, &fbb)
    Vessel_Abridged.add(vesselClass: vesselClass, &fbb)
    Vessel_Abridged.add(vesselDescription: vesselDescription, &fbb)
    Vessel_Abridged.add(sconum: sconum, &fbb)
    Vessel_Abridged.add(imon: imon, &fbb)
    Vessel_Abridged.add(mmsi: mmsi, &fbb)
    Vessel_Abridged.add(callsign: callsign, &fbb)
    Vessel_Abridged.add(vesselFlag: vesselFlag, &fbb)
    Vessel_Abridged.add(yearBuilt: yearBuilt, &fbb)
    Vessel_Abridged.add(vesselBuilder: vesselBuilder, &fbb)
    Vessel_Abridged.add(status: status, &fbb)
    Vessel_Abridged.add(firstSeen: firstSeen, &fbb)
    Vessel_Abridged.add(length: length, &fbb)
    Vessel_Abridged.add(width: width, &fbb)
    Vessel_Abridged.add(maxDraught: maxDraught, &fbb)
    Vessel_Abridged.add(vslWt: vslWt, &fbb)
    Vessel_Abridged.add(maxSpeed: maxSpeed, &fbb)
    Vessel_Abridged.add(sternType: sternType, &fbb)
    Vessel_Abridged.add(numBlades: numBlades, &fbb)
    Vessel_Abridged.add(numShafts: numShafts, &fbb)
    Vessel_Abridged.add(propType: propType, &fbb)
    Vessel_Abridged.add(hullNum: hullNum, &fbb)
    Vessel_Abridged.add(createdAt: createdAt, &fbb)
    Vessel_Abridged.add(createdBy: createdBy, &fbb)
    Vessel_Abridged.add(source: source, &fbb)
    Vessel_Abridged.add(origin: origin, &fbb)
    Vessel_Abridged.add(dataMode: dataMode, &fbb)
    Vessel_Abridged.add(origNetwork: origNetwork, &fbb)
    return Vessel_Abridged.endVessel_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Vessel_Abridged_dataMode_Enum.self)
