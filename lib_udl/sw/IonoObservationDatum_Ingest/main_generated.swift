...
public struct IonoObservationDatum_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDatum_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDatum_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 2) }
  ...
  public static func endIonoObservationDatum_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDatum_Ingest(
    _ fbb: inout FlatBufferBuilder,
    notesOffset notes: Offset = Offset(),
    dataVectorOffset data: Offset = Offset()
  ) -> Offset {
    let __start = IonoObservationDatum_Ingest.startIonoObservationDatum_Ingest(&fbb)
    IonoObservationDatum_Ingest.add(notes: notes, &fbb)
    IonoObservationDatum_Ingest.addVectorOf(data: data, &fbb)
    return IonoObservationDatum_Ingest.endIonoObservationDatum_Ingest(&fbb, start: __start)
  }
