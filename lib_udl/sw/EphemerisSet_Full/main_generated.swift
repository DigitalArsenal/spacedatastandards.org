...
public enum EphemerisSet_Full_referenceFrame_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: EphemerisSet_Full_referenceFrame_Enum { return .gcrf }
  public static var min: EphemerisSet_Full_referenceFrame_Enum { return .j2000 }
}


public enum EphemerisSet_Full_covReferenceFrame_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: EphemerisSet_Full_covReferenceFrame_Enum { return .uvw }
  public static var min: EphemerisSet_Full_covReferenceFrame_Enum { return .j2000 }
}


public enum EphemerisSet_Full_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: EphemerisSet_Full_dataMode_Enum { return .exercise }
  public static var min: EphemerisSet_Full_dataMode_Enum { return .real }
}
...
public struct EphemerisSet_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EphemerisSet_Full.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case stateVector = 82
    case satNo = 84
    case ephemerisList = 86
    case onOrbit = 88
    case tags = 90
    case transactionId = 92
    case origNetwork = 94
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 24
  public var referenceFrame: EphemerisSet_Full_referenceFrame_Enum { let o = _accessor.offset(VTOFFSET.referenceFrame.v); return o == 0 ? .j2000 : EphemerisSet_Full_referenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ///  The reference frame of the covariance matrix elements. If the covReferenceFrame is null it is assumed to be J2000.
  ///  Example: /// Example: J2000
  ///  Constraints: Minimum length = 0, Maximum length = 24
  public var covReferenceFrame: EphemerisSet_Full_covReferenceFrame_Enum { let o = _accessor.offset(VTOFFSET.covReferenceFrame.v); return o == 0 ? .j2000 : EphemerisSet_Full_covReferenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ...
  public var dataMode: EphemerisSet_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : EphemerisSet_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startEphemerisSet_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 46) }
  ...
  public static func add(referenceFrame: EphemerisSet_Full_referenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: referenceFrame.rawValue, def: 0, at: VTOFFSET.referenceFrame.p) }
  public static func add(covReferenceFrame: EphemerisSet_Full_covReferenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: covReferenceFrame.rawValue, def: 0, at: VTOFFSET.covReferenceFrame.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func add(source: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: source, at: VTOFFSET.source.p) }
  public static func add(origin: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origin, at: VTOFFSET.origin.p) }
  public static func add(dataMode: EphemerisSet_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endEphemerisSet_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEphemerisSet_Full(
    ...
    let __start = EphemerisSet_Full.startEphemerisSet_Full(&fbb)
    EphemerisSet_Full.add(id: id, &fbb)
    EphemerisSet_Full.add(classificationMarking: classificationMarking, &fbb)
    EphemerisSet_Full.add(idOnOrbit: idOnOrbit, &fbb)
    EphemerisSet_Full.add(origObjectId: origObjectId, &fbb)
    EphemerisSet_Full.add(pointStartTime: pointStartTime, &fbb)
    EphemerisSet_Full.add(usableStartTime: usableStartTime, &fbb)
    EphemerisSet_Full.add(pointEndTime: pointEndTime, &fbb)
    EphemerisSet_Full.add(usableEndTime: usableEndTime, &fbb)
    EphemerisSet_Full.add(stepSize: stepSize, &fbb)
    EphemerisSet_Full.add(numPoints: numPoints, &fbb)
    EphemerisSet_Full.add(type: type, &fbb)
    EphemerisSet_Full.add(pedigree: pedigree, &fbb)
    EphemerisSet_Full.add(category: category, &fbb)
    EphemerisSet_Full.add(idStateVector: idStateVector, &fbb)
    EphemerisSet_Full.add(hasMnvr: hasMnvr, &fbb)
    EphemerisSet_Full.addVectorOf(idManeuvers: idManeuvers, &fbb)
    EphemerisSet_Full.add(hasCov: hasCov, &fbb)
    EphemerisSet_Full.add(hasAccel: hasAccel, &fbb)
    EphemerisSet_Full.add(centBody: centBody, &fbb)
    EphemerisSet_Full.add(integrator: integrator, &fbb)
    EphemerisSet_Full.add(geopotentialModel: geopotentialModel, &fbb)
    EphemerisSet_Full.add(dragModel: dragModel, &fbb)
    EphemerisSet_Full.add(lunarSolar: lunarSolar, &fbb)
    EphemerisSet_Full.add(solidEarthTides: solidEarthTides, &fbb)
    EphemerisSet_Full.add(bDot: bDot, &fbb)
    EphemerisSet_Full.add(edr: edr, &fbb)
    EphemerisSet_Full.add(interpolation: interpolation, &fbb)
    EphemerisSet_Full.add(interpolationDegree: interpolationDegree, &fbb)
    EphemerisSet_Full.add(filename: filename, &fbb)
    EphemerisSet_Full.add(comments: comments, &fbb)
    EphemerisSet_Full.add(description: description, &fbb)
    EphemerisSet_Full.add(descriptor: descriptor, &fbb)
    EphemerisSet_Full.add(referenceFrame: referenceFrame, &fbb)
    EphemerisSet_Full.add(covReferenceFrame: covReferenceFrame, &fbb)
    EphemerisSet_Full.add(createdAt: createdAt, &fbb)
    EphemerisSet_Full.add(createdBy: createdBy, &fbb)
    EphemerisSet_Full.add(source: source, &fbb)
    EphemerisSet_Full.add(origin: origin, &fbb)
    EphemerisSet_Full.add(dataMode: dataMode, &fbb)
    EphemerisSet_Full.add(stateVector: stateVector, &fbb)
    EphemerisSet_Full.add(satNo: satNo, &fbb)
    EphemerisSet_Full.addVectorOf(ephemerisList: ephemerisList, &fbb)
    EphemerisSet_Full.add(onOrbit: onOrbit, &fbb)
    EphemerisSet_Full.addVectorOf(tags: tags, &fbb)
    EphemerisSet_Full.add(transactionId: transactionId, &fbb)
    EphemerisSet_Full.add(origNetwork: origNetwork, &fbb)
    return EphemerisSet_Full.endEphemerisSet_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.referenceFrame.p, fieldName: "referenceFrame", required: false, type: EphemerisSet_Full_referenceFrame_Enum.self)
    try _v.visit(field: VTOFFSET.covReferenceFrame.p, fieldName: "covReferenceFrame", required: false, type: EphemerisSet_Full_covReferenceFrame_Enum.self)
    try _v.visit(field: VTOFFSET.createdAt.p, fieldName: "createdAt", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.createdBy.p, fieldName: "createdBy", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.source.p, fieldName: "source", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.origin.p, fieldName: "origin", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: EphemerisSet_Full_dataMode_Enum.self)
