...
public enum AntennaDetails_mode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AntennaDetails_mode_Enum { return .rx }
  public static var min: AntennaDetails_mode_Enum { return .tx }
}


public enum AntennaDetails_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: AntennaDetails_dataMode_Enum { return .exercise }
  public static var min: AntennaDetails_dataMode_Enum { return .real }
}
...
public struct AntennaDetails: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AntennaDetails.id, addPrefix: prefix) }
  ...
  public var mode: AntennaDetails_mode_Enum { let o = _accessor.offset(VTOFFSET.mode.v); return o == 0 ? .tx : AntennaDetails_mode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .tx }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: AntennaDetails_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AntennaDetails_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startAntennaDetails(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 28) }
  ...
  public static func add(mode: AntennaDetails_mode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: mode.rawValue, def: 0, at: VTOFFSET.mode.p) }
  ...
  public static func add(dataMode: AntennaDetails_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endAntennaDetails(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAntennaDetails(
    ...
    let __start = AntennaDetails.startAntennaDetails(&fbb)
    AntennaDetails.add(id: id, &fbb)
    AntennaDetails.add(idAntenna: idAntenna, &fbb)
    AntennaDetails.add(classificationMarking: classificationMarking, &fbb)
    AntennaDetails.add(type: type, &fbb)
    AntennaDetails.add(position: position, &fbb)
    AntennaDetails.add(mode: mode, &fbb)
    AntennaDetails.add(steerable: steerable, &fbb)
    AntennaDetails.add(beamForming: beamForming, &fbb)
    AntennaDetails.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    AntennaDetails.add(diameter: diameter, &fbb)
    AntennaDetails.addVectorOf(size: size, &fbb)
    AntennaDetails.add(startFrequency: startFrequency, &fbb)
    AntennaDetails.add(endFrequency: endFrequency, &fbb)
    AntennaDetails.add(beamwidth: beamwidth, &fbb)
    AntennaDetails.add(gain: gain, &fbb)
    AntennaDetails.add(gainTolerance: gainTolerance, &fbb)
    AntennaDetails.add(polarization: polarization, &fbb)
    AntennaDetails.add(description: description, &fbb)
    AntennaDetails.add(createdAt: createdAt, &fbb)
    AntennaDetails.add(createdBy: createdBy, &fbb)
    AntennaDetails.add(updatedAt: updatedAt, &fbb)
    AntennaDetails.add(updatedBy: updatedBy, &fbb)
    AntennaDetails.add(source: source, &fbb)
    AntennaDetails.add(origin: origin, &fbb)
    AntennaDetails.add(origNetwork: origNetwork, &fbb)
    AntennaDetails.add(dataMode: dataMode, &fbb)
    AntennaDetails.addVectorOf(tags: tags, &fbb)
    AntennaDetails.add(manufacturerOrg: manufacturerOrg, &fbb)
    return AntennaDetails.endAntennaDetails(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.mode.p, fieldName: "mode", required: false, type: AntennaDetails_mode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AntennaDetails_dataMode_Enum.self)
