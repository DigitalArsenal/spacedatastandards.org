...
public struct ISRCollectionRequirements_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollectionRequirements_Ingest.id, addPrefix: prefix) }
  ...
  public static func startISRCollectionRequirements_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 22) }
  ...
  public static func endISRCollectionRequirements_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollectionRequirements_Ingest(
    ...
    let __start = ISRCollectionRequirements_Ingest.startISRCollectionRequirements_Ingest(&fbb)
    ISRCollectionRequirements_Ingest.add(id: id, &fbb)
    ISRCollectionRequirements_Ingest.add(hash: hash, &fbb)
    ISRCollectionRequirements_Ingest.add(type: type, &fbb)
    ISRCollectionRequirements_Ingest.add(cridNumbers: cridNumbers, &fbb)
    ISRCollectionRequirements_Ingest.add(priority: priority, &fbb)
    ISRCollectionRequirements_Ingest.add(recordId: recordId, &fbb)
    ISRCollectionRequirements_Ingest.add(reconSurvey: reconSurvey, &fbb)
    ISRCollectionRequirements_Ingest.add(intelDiscipline: intelDiscipline, &fbb)
    ISRCollectionRequirements_Ingest.add(secondary: secondary, &fbb)
    ISRCollectionRequirements_Ingest.add(emphasized: emphasized, &fbb)
    ISRCollectionRequirements_Ingest.add(isPrismCr: isPrismCr, &fbb)
    ISRCollectionRequirements_Ingest.add(start: start, &fbb)
    ISRCollectionRequirements_Ingest.add(stop: stop, &fbb)
    ISRCollectionRequirements_Ingest.add(operation: operation, &fbb)
    ISRCollectionRequirements_Ingest.add(supportedUnit: supportedUnit, &fbb)
    ISRCollectionRequirements_Ingest.add(country: country, &fbb)
    ISRCollectionRequirements_Ingest.add(region: region, &fbb)
    ISRCollectionRequirements_Ingest.add(subregion: subregion, &fbb)
    ISRCollectionRequirements_Ingest.add(specialComGuidance: specialComGuidance, &fbb)
    ISRCollectionRequirements_Ingest.add(criticalTimes: criticalTimes, &fbb)
    ISRCollectionRequirements_Ingest.add(exploitationRequirement: exploitationRequirement, &fbb)
    ISRCollectionRequirements_Ingest.addVectorOf(targetList: targetList, &fbb)
    return ISRCollectionRequirements_Ingest.endISRCollectionRequirements_Ingest(&fbb, start: __start)
  }
