...
public enum AirLoadPlan_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AirLoadPlan_Full_dataMode_Enum { return .exercise }
  public static var min: AirLoadPlan_Full_dataMode_Enum { return .real }
}


///  /// Information related to how an aircraft is loaded with cargo, equipment, and passengers.
public struct AirLoadPlan_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirLoadPlan_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: AirLoadPlan_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AirLoadPlan_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startAirLoadPlan_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 51) }
  ...
  public static func add(dataMode: AirLoadPlan_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endAirLoadPlan_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirLoadPlan_Full(
    ...
    let __start = AirLoadPlan_Full.startAirLoadPlan_Full(&fbb)
    AirLoadPlan_Full.add(id: id, &fbb)
    AirLoadPlan_Full.add(classificationMarking: classificationMarking, &fbb)
    AirLoadPlan_Full.add(externalId: externalId, &fbb)
    AirLoadPlan_Full.add(idMission: idMission, &fbb)
    AirLoadPlan_Full.add(missionNumber: missionNumber, &fbb)
    AirLoadPlan_Full.add(idSortie: idSortie, &fbb)
    AirLoadPlan_Full.add(legNum: legNum, &fbb)
    AirLoadPlan_Full.add(callSign: callSign, &fbb)
    AirLoadPlan_Full.add(tailNumber: tailNumber, &fbb)
    AirLoadPlan_Full.add(aircraftMds: aircraftMds, &fbb)
    AirLoadPlan_Full.add(depIcao: depIcao, &fbb)
    AirLoadPlan_Full.add(depAirfield: depAirfield, &fbb)
    AirLoadPlan_Full.add(estDepTime: estDepTime, &fbb)
    AirLoadPlan_Full.add(arrIcao: arrIcao, &fbb)
    AirLoadPlan_Full.add(arrAirfield: arrAirfield, &fbb)
    AirLoadPlan_Full.add(estArrTime: estArrTime, &fbb)
    AirLoadPlan_Full.add(crewSize: crewSize, &fbb)
    AirLoadPlan_Full.add(cargoConfig: cargoConfig, &fbb)
    AirLoadPlan_Full.add(equipConfig: equipConfig, &fbb)
    AirLoadPlan_Full.add(tankConfig: tankConfig, &fbb)
    AirLoadPlan_Full.add(basicWeight: basicWeight, &fbb)
    AirLoadPlan_Full.add(basicMoment: basicMoment, &fbb)
    AirLoadPlan_Full.add(fuelWeight: fuelWeight, &fbb)
    AirLoadPlan_Full.add(fuelMoment: fuelMoment, &fbb)
    AirLoadPlan_Full.add(estLandingFuelWeight: estLandingFuelWeight, &fbb)
    AirLoadPlan_Full.add(estLandingFuelMoment: estLandingFuelMoment, &fbb)
    AirLoadPlan_Full.add(operatingWeight: operatingWeight, &fbb)
    AirLoadPlan_Full.add(operatingMoment: operatingMoment, &fbb)
    AirLoadPlan_Full.add(cargoWeight: cargoWeight, &fbb)
    AirLoadPlan_Full.add(cargoMoment: cargoMoment, &fbb)
    AirLoadPlan_Full.add(zeroFuelWeight: zeroFuelWeight, &fbb)
    AirLoadPlan_Full.add(zeroFuelMoment: zeroFuelMoment, &fbb)
    AirLoadPlan_Full.add(zeroFuelCg: zeroFuelCg, &fbb)
    AirLoadPlan_Full.add(grossWeight: grossWeight, &fbb)
    AirLoadPlan_Full.add(grossMoment: grossMoment, &fbb)
    AirLoadPlan_Full.add(grossCg: grossCg, &fbb)
    AirLoadPlan_Full.add(landingWeight: landingWeight, &fbb)
    AirLoadPlan_Full.add(landingMoment: landingMoment, &fbb)
    AirLoadPlan_Full.add(landingCg: landingCg, &fbb)
    AirLoadPlan_Full.add(cargoBayFsmin: cargoBayFsmin, &fbb)
    AirLoadPlan_Full.add(cargoBayFsmax: cargoBayFsmax, &fbb)
    AirLoadPlan_Full.add(cargoBayWidth: cargoBayWidth, &fbb)
    AirLoadPlan_Full.add(createdAt: createdAt, &fbb)
    AirLoadPlan_Full.add(createdBy: createdBy, &fbb)
    AirLoadPlan_Full.add(updatedAt: updatedAt, &fbb)
    AirLoadPlan_Full.add(updatedBy: updatedBy, &fbb)
    AirLoadPlan_Full.add(sourceDl: sourceDl, &fbb)
    AirLoadPlan_Full.add(source: source, &fbb)
    AirLoadPlan_Full.add(origin: origin, &fbb)
    AirLoadPlan_Full.add(origNetwork: origNetwork, &fbb)
    AirLoadPlan_Full.add(dataMode: dataMode, &fbb)
    return AirLoadPlan_Full.endAirLoadPlan_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AirLoadPlan_Full_dataMode_Enum.self)
    _v.finish()
  }
}
