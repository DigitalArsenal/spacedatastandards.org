...
public enum LaunchSite_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: LaunchSite_Ingest_dataMode_Enum { return .exercise }
  public static var min: LaunchSite_Ingest_dataMode_Enum { return .real }
}


///  /// Model representation of known launch sites.
public struct LaunchSite_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LaunchSite_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: LaunchSite_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : LaunchSite_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startLaunchSite_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 13) }
  ...
  public static func add(dataMode: LaunchSite_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endLaunchSite_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLaunchSite_Ingest(
    ...
    let __start = LaunchSite_Ingest.startLaunchSite_Ingest(&fbb)
    LaunchSite_Ingest.add(id: id, &fbb)
    LaunchSite_Ingest.add(classificationMarking: classificationMarking, &fbb)
    LaunchSite_Ingest.add(code: code, &fbb)
    LaunchSite_Ingest.add(shortCode: shortCode, &fbb)
    LaunchSite_Ingest.add(altCode: altCode, &fbb)
    LaunchSite_Ingest.add(idSite: idSite, &fbb)
    LaunchSite_Ingest.add(name: name, &fbb)
    LaunchSite_Ingest.add(createdAt: createdAt, &fbb)
    LaunchSite_Ingest.add(createdBy: createdBy, &fbb)
    LaunchSite_Ingest.add(source: source, &fbb)
    LaunchSite_Ingest.add(origin: origin, &fbb)
    LaunchSite_Ingest.add(origNetwork: origNetwork, &fbb)
    LaunchSite_Ingest.add(dataMode: dataMode, &fbb)
    return LaunchSite_Ingest.endLaunchSite_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: LaunchSite_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
