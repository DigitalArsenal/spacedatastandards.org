...
public struct IonoObservationFrequency_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationFrequency_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationFrequency_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationFrequency_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationFrequency_Ingest(
    ...
    let __start = IonoObservationFrequency_Ingest.startIonoObservationFrequency_Ingest(&fbb)
    IonoObservationFrequency_Ingest.add(notes: notes, &fbb)
    IonoObservationFrequency_Ingest.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationFrequency_Ingest.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationFrequency_Ingest.addVectorOf(data: data, &fbb)
    return IonoObservationFrequency_Ingest.endIonoObservationFrequency_Ingest(&fbb, start: __start)
  }
