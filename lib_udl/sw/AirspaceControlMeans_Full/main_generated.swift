...
public enum AirspaceControlMeans_Full_cmShape_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AirspaceControlMeans_Full_cmShape_Enum { return .geoline }
  public static var min: AirspaceControlMeans_Full_cmShape_Enum { return .polyarc }
}


///  /// A conditional nested segment to report multiple airspace control means within a particular airspace control means status.
public struct AirspaceControlMeans_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirspaceControlMeans_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 8
  public var cmShape: AirspaceControlMeans_Full_cmShape_Enum { let o = _accessor.offset(VTOFFSET.cmShape.v); return o == 0 ? .polyarc : AirspaceControlMeans_Full_cmShape_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .polyarc }
  ...
  public static func startAirspaceControlMeans_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 29) }
  ...
  public static func add(cmShape: AirspaceControlMeans_Full_cmShape_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: cmShape.rawValue, def: 0, at: VTOFFSET.cmShape.p) }
  ...
  public static func endAirspaceControlMeans_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirspaceControlMeans_Full(
    ...
    let __start = AirspaceControlMeans_Full.startAirspaceControlMeans_Full(&fbb)
    AirspaceControlMeans_Full.add(cmType: cmType, &fbb)
    AirspaceControlMeans_Full.add(cmId: cmId, &fbb)
    AirspaceControlMeans_Full.add(cmShape: cmShape, &fbb)
    AirspaceControlMeans_Full.add(usage: usage, &fbb)
    AirspaceControlMeans_Full.add(link16Id: link16Id, &fbb)
    AirspaceControlMeans_Full.add(transAltitude: transAltitude, &fbb)
    AirspaceControlMeans_Full.add(geoDatumAlt: geoDatumAlt, &fbb)
    AirspaceControlMeans_Full.add(coord0: coord0, &fbb)
    AirspaceControlMeans_Full.add(coord1: coord1, &fbb)
    AirspaceControlMeans_Full.add(bearing0: bearing0, &fbb)
    AirspaceControlMeans_Full.add(bearing1: bearing1, &fbb)
    AirspaceControlMeans_Full.add(radMag0: radMag0, &fbb)
    AirspaceControlMeans_Full.add(radMag1: radMag1, &fbb)
    AirspaceControlMeans_Full.add(radMagUnit: radMagUnit, &fbb)
    AirspaceControlMeans_Full.addVectorOf(polyCoord: polyCoord, &fbb)
    AirspaceControlMeans_Full.add(trackLeg: trackLeg, &fbb)
    AirspaceControlMeans_Full.add(widthLeft: widthLeft, &fbb)
    AirspaceControlMeans_Full.add(widthRight: widthRight, &fbb)
    AirspaceControlMeans_Full.add(width: width, &fbb)
    AirspaceControlMeans_Full.add(widthUnit: widthUnit, &fbb)
    AirspaceControlMeans_Full.addVectorOf(corrWayPoints: corrWayPoints, &fbb)
    AirspaceControlMeans_Full.add(orbitAlignment: orbitAlignment, &fbb)
    AirspaceControlMeans_Full.add(effVdim: effVdim, &fbb)
    AirspaceControlMeans_Full.addVectorOf(airspaceTimePeriod: airspaceTimePeriod, &fbb)
    AirspaceControlMeans_Full.addVectorOf(airspaceControlPoint: airspaceControlPoint, &fbb)
    AirspaceControlMeans_Full.add(ctrlAuth: ctrlAuth, &fbb)
    AirspaceControlMeans_Full.addVectorOf(ctrlAuthFreqs: ctrlAuthFreqs, &fbb)
    AirspaceControlMeans_Full.add(genTextInd: genTextInd, &fbb)
    AirspaceControlMeans_Full.add(freeText: freeText, &fbb)
    return AirspaceControlMeans_Full.endAirspaceControlMeans_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.cmShape.p, fieldName: "cmShape", required: false, type: AirspaceControlMeans_Full_cmShape_Enum.self)
