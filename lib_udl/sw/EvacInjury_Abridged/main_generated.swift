...
///  /// Injury specifics.
public struct EvacInjury_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacInjury_Abridged.id, addPrefix: prefix) }
  ...
  public static func startEvacInjury_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endEvacInjury_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacInjury_Abridged(
    ...
    let __start = EvacInjury_Abridged.startEvacInjury_Abridged(&fbb)
    EvacInjury_Abridged.add(type: type, &fbb)
    EvacInjury_Abridged.add(bodyPart: bodyPart, &fbb)
    EvacInjury_Abridged.add(time: time, &fbb)
    EvacInjury_Abridged.add(comments: comments, &fbb)
    return EvacInjury_Abridged.endEvacInjury_Abridged(&fbb, start: __start)
  }
