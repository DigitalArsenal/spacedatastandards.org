...
public struct EvacCondition_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacCondition_Abridged.id, addPrefix: prefix) }
  ...
  public static func startEvacCondition_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endEvacCondition_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacCondition_Abridged(
    ...
    let __start = EvacCondition_Abridged.startEvacCondition_Abridged(&fbb)
    EvacCondition_Abridged.add(type: type, &fbb)
    EvacCondition_Abridged.add(bodyPart: bodyPart, &fbb)
    EvacCondition_Abridged.add(time: time, &fbb)
    EvacCondition_Abridged.add(comments: comments, &fbb)
    return EvacCondition_Abridged.endEvacCondition_Abridged(&fbb, start: __start)
  }
