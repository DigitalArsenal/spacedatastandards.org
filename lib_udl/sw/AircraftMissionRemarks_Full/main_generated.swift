...
public struct AircraftMissionRemarks_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AircraftMissionRemarks_Full.id, addPrefix: prefix) }
  ...
  public static func startAircraftMissionRemarks_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 6) }
  ...
  public static func endAircraftMissionRemarks_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAircraftMissionRemarks_Full(
    ...
    let __start = AircraftMissionRemarks_Full.startAircraftMissionRemarks_Full(&fbb)
    AircraftMissionRemarks_Full.add(gdssRemarkId: gdssRemarkId, &fbb)
    AircraftMissionRemarks_Full.add(type: type, &fbb)
    AircraftMissionRemarks_Full.add(text: text, &fbb)
    AircraftMissionRemarks_Full.add(date: date, &fbb)
    AircraftMissionRemarks_Full.add(user: user, &fbb)
    AircraftMissionRemarks_Full.add(itineraryNum: itineraryNum, &fbb)
    return AircraftMissionRemarks_Full.endAircraftMissionRemarks_Full(&fbb, start: __start)
  }
