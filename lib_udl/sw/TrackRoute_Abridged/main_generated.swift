...
public enum TrackRoute_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: TrackRoute_Abridged_dataMode_Enum { return .exercise }
  public static var min: TrackRoute_Abridged_dataMode_Enum { return .real }
}


///  /// A track route is a prescribed route for performing training events or operations such as air refueling.
public struct TrackRoute_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: TrackRoute_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: TrackRoute_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : TrackRoute_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startTrackRoute_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 38) }
  ...
  public static func add(dataMode: TrackRoute_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endTrackRoute_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createTrackRoute_Abridged(
    ...
    let __start = TrackRoute_Abridged.startTrackRoute_Abridged(&fbb)
    TrackRoute_Abridged.add(id: id, &fbb)
    TrackRoute_Abridged.add(classificationMarking: classificationMarking, &fbb)
    TrackRoute_Abridged.add(type: type, &fbb)
    TrackRoute_Abridged.add(externalId: externalId, &fbb)
    TrackRoute_Abridged.add(direction: direction, &fbb)
    TrackRoute_Abridged.add(creatingOrg: creatingOrg, &fbb)
    TrackRoute_Abridged.add(locationTrackId: locationTrackId, &fbb)
    TrackRoute_Abridged.add(trackId: trackId, &fbb)
    TrackRoute_Abridged.add(trackName: trackName, &fbb)
    TrackRoute_Abridged.add(shortName: shortName, &fbb)
    TrackRoute_Abridged.add(typeCode: typeCode, &fbb)
    TrackRoute_Abridged.add(regionCode: regionCode, &fbb)
    TrackRoute_Abridged.add(regionName: regionName, &fbb)
    TrackRoute_Abridged.add(apxBeaconCode: apxBeaconCode, &fbb)
    TrackRoute_Abridged.add(receiverTankerChcode: receiverTankerChcode, &fbb)
    TrackRoute_Abridged.add(apnSetting: apnSetting, &fbb)
    TrackRoute_Abridged.add(sic: sic, &fbb)
    TrackRoute_Abridged.add(reviewDate: reviewDate, &fbb)
    TrackRoute_Abridged.add(lastUsedDate: lastUsedDate, &fbb)
    TrackRoute_Abridged.add(lastUpdateDate: lastUpdateDate, &fbb)
    TrackRoute_Abridged.add(priFreq: priFreq, &fbb)
    TrackRoute_Abridged.add(secFreq: secFreq, &fbb)
    TrackRoute_Abridged.add(artccMessage: artccMessage, &fbb)
    TrackRoute_Abridged.add(schedulerOrgName: schedulerOrgName, &fbb)
    TrackRoute_Abridged.add(schedulerOrgUnit: schedulerOrgUnit, &fbb)
    TrackRoute_Abridged.add(effectiveDate: effectiveDate, &fbb)
    TrackRoute_Abridged.addVectorOf(routePoints: routePoints, &fbb)
    TrackRoute_Abridged.addVectorOf(altitudeBlocks: altitudeBlocks, &fbb)
    TrackRoute_Abridged.addVectorOf(poc: poc, &fbb)
    TrackRoute_Abridged.add(createdAt: createdAt, &fbb)
    TrackRoute_Abridged.add(createdBy: createdBy, &fbb)
    TrackRoute_Abridged.add(updatedAt: updatedAt, &fbb)
    TrackRoute_Abridged.add(updatedBy: updatedBy, &fbb)
    TrackRoute_Abridged.add(sourceDl: sourceDl, &fbb)
    TrackRoute_Abridged.add(source: source, &fbb)
    TrackRoute_Abridged.add(origin: origin, &fbb)
    TrackRoute_Abridged.add(origNetwork: origNetwork, &fbb)
    TrackRoute_Abridged.add(dataMode: dataMode, &fbb)
    return TrackRoute_Abridged.endTrackRoute_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: TrackRoute_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
