...
public struct PersonnelRecoveryObjectiveAreaInfo_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: PersonnelRecoveryObjectiveAreaInfo_Abridged.id, addPrefix: prefix) }
  ...
  public static func startPersonnelRecoveryObjectiveAreaInfo_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endPersonnelRecoveryObjectiveAreaInfo_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPersonnelRecoveryObjectiveAreaInfo_Abridged(
    ...
    let __start = PersonnelRecoveryObjectiveAreaInfo_Abridged.startPersonnelRecoveryObjectiveAreaInfo_Abridged(&fbb)
    PersonnelRecoveryObjectiveAreaInfo_Abridged.addVectorOf(pzLocation: pzLocation, &fbb)
    PersonnelRecoveryObjectiveAreaInfo_Abridged.add(pzDesc: pzDesc, &fbb)
    PersonnelRecoveryObjectiveAreaInfo_Abridged.add(oscCallSign: oscCallSign, &fbb)
    PersonnelRecoveryObjectiveAreaInfo_Abridged.add(oscFreq: oscFreq, &fbb)
    PersonnelRecoveryObjectiveAreaInfo_Abridged.addVectorOf(enemyData: enemyData, &fbb)
    return PersonnelRecoveryObjectiveAreaInfo_Abridged.endPersonnelRecoveryObjectiveAreaInfo_Abridged(&fbb, start: __start)
  }
