...
public enum Scientific_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Scientific_Full_dataMode_Enum { return .exercise }
  public static var min: Scientific_Full_dataMode_Enum { return .real }
}


///  /// Scientific or other data from Seradata.
public struct Scientific_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Scientific_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Scientific_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Scientific_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startScientific_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 19) }
  ...
  public static func add(dataMode: Scientific_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endScientific_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createScientific_Full(
    ...
    let __start = Scientific_Full.startScientific_Full(&fbb)
    Scientific_Full.add(id: id, &fbb)
    Scientific_Full.add(classificationMarking: classificationMarking, &fbb)
    Scientific_Full.add(spacecraftId: spacecraftId, &fbb)
    Scientific_Full.add(hostedForCompanyOrgId: hostedForCompanyOrgId, &fbb)
    Scientific_Full.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    Scientific_Full.add(payloadCategory: payloadCategory, &fbb)
    Scientific_Full.add(name: name, &fbb)
    Scientific_Full.add(frequencyBand: frequencyBand, &fbb)
    Scientific_Full.add(notes: notes, &fbb)
    Scientific_Full.add(createdAt: createdAt, &fbb)
    Scientific_Full.add(createdBy: createdBy, &fbb)
    Scientific_Full.add(updatedAt: updatedAt, &fbb)
    Scientific_Full.add(updatedBy: updatedBy, &fbb)
    Scientific_Full.add(source: source, &fbb)
    Scientific_Full.add(origin: origin, &fbb)
    Scientific_Full.add(origNetwork: origNetwork, &fbb)
    Scientific_Full.add(dataMode: dataMode, &fbb)
    Scientific_Full.add(idEntity: idEntity, &fbb)
    Scientific_Full.add(entity: entity, &fbb)
    return Scientific_Full.endScientific_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Scientific_Full_dataMode_Enum.self)
