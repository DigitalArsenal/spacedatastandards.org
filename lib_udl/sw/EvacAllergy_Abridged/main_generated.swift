...
///  /// Allergy information.
public struct EvacAllergy_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacAllergy_Abridged.id, addPrefix: prefix) }
  ...
  public static func startEvacAllergy_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 2) }
  ...
  public static func endEvacAllergy_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacAllergy_Abridged(
    _ fbb: inout FlatBufferBuilder,
    typeOffset type: Offset = Offset(),
    commentsOffset comments: Offset = Offset()
  ) -> Offset {
    let __start = EvacAllergy_Abridged.startEvacAllergy_Abridged(&fbb)
    EvacAllergy_Abridged.add(type: type, &fbb)
    EvacAllergy_Abridged.add(comments: comments, &fbb)
    return EvacAllergy_Abridged.endEvacAllergy_Abridged(&fbb, start: __start)
  }
