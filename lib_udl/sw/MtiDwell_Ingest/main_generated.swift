...
public struct MtiDwell_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiDwell_Ingest.id, addPrefix: prefix) }
  ...
  public static func startMtiDwell_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 32) }
  ...
  public static func endMtiDwell_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiDwell_Ingest(
    ...
    let __start = MtiDwell_Ingest.startMtiDwell_Ingest(&fbb)
    MtiDwell_Ingest.add(d2: d2, &fbb)
    MtiDwell_Ingest.add(d3: d3, &fbb)
    MtiDwell_Ingest.add(d4: d4, &fbb)
    MtiDwell_Ingest.add(d5: d5, &fbb)
    MtiDwell_Ingest.add(d6: d6, &fbb)
    MtiDwell_Ingest.add(d7: d7, &fbb)
    MtiDwell_Ingest.add(d8: d8, &fbb)
    MtiDwell_Ingest.add(d9: d9, &fbb)
    MtiDwell_Ingest.add(d10: d10, &fbb)
    MtiDwell_Ingest.add(d11: d11, &fbb)
    MtiDwell_Ingest.add(d12: d12, &fbb)
    MtiDwell_Ingest.add(d13: d13, &fbb)
    MtiDwell_Ingest.add(d14: d14, &fbb)
    MtiDwell_Ingest.add(d15: d15, &fbb)
    MtiDwell_Ingest.add(d16: d16, &fbb)
    MtiDwell_Ingest.add(d17: d17, &fbb)
    MtiDwell_Ingest.add(d18: d18, &fbb)
    MtiDwell_Ingest.add(d19: d19, &fbb)
    MtiDwell_Ingest.add(d20: d20, &fbb)
    MtiDwell_Ingest.add(d21: d21, &fbb)
    MtiDwell_Ingest.add(d22: d22, &fbb)
    MtiDwell_Ingest.add(d23: d23, &fbb)
    MtiDwell_Ingest.add(d24: d24, &fbb)
    MtiDwell_Ingest.add(d25: d25, &fbb)
    MtiDwell_Ingest.add(d26: d26, &fbb)
    MtiDwell_Ingest.add(d27: d27, &fbb)
    MtiDwell_Ingest.add(d28: d28, &fbb)
    MtiDwell_Ingest.add(d29: d29, &fbb)
    MtiDwell_Ingest.add(d30: d30, &fbb)
    MtiDwell_Ingest.add(d31: d31, &fbb)
    MtiDwell_Ingest.addVectorOf(d32: d32, &fbb)
    MtiDwell_Ingest.add(dwellts: dwellts, &fbb)
    return MtiDwell_Ingest.endMtiDwell_Ingest(&fbb, start: __start)
  }
