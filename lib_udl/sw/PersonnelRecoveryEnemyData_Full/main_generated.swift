...
public struct PersonnelRecoveryEnemyData_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: PersonnelRecoveryEnemyData_Full.id, addPrefix: prefix) }
  ...
  public static func startPersonnelRecoveryEnemyData_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endPersonnelRecoveryEnemyData_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPersonnelRecoveryEnemyData_Full(
    ...
    let __start = PersonnelRecoveryEnemyData_Full.startPersonnelRecoveryEnemyData_Full(&fbb)
    PersonnelRecoveryEnemyData_Full.add(dirToEnemy: dirToEnemy, &fbb)
    PersonnelRecoveryEnemyData_Full.add(hostileFireType: hostileFireType, &fbb)
    PersonnelRecoveryEnemyData_Full.add(friendliesRemarks: friendliesRemarks, &fbb)
    PersonnelRecoveryEnemyData_Full.add(hlzRemarks: hlzRemarks, &fbb)
    return PersonnelRecoveryEnemyData_Full.endPersonnelRecoveryEnemyData_Full(&fbb, start: __start)
  }
