...
public struct IonoObservationDensityProfileParabolic_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDensityProfileParabolic_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDensityProfileParabolic_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 2) }
  ...
  public static func endIonoObservationDensityProfileParabolic_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDensityProfileParabolic_Full(
    _ fbb: inout FlatBufferBuilder,
    descriptionOffset description: Offset = Offset(),
    parabolicItemsVectorOffset parabolicItems: Offset = Offset()
  ) -> Offset {
    let __start = IonoObservationDensityProfileParabolic_Full.startIonoObservationDensityProfileParabolic_Full(&fbb)
    IonoObservationDensityProfileParabolic_Full.add(description: description, &fbb)
    IonoObservationDensityProfileParabolic_Full.addVectorOf(parabolicItems: parabolicItems, &fbb)
    return IonoObservationDensityProfileParabolic_Full.endIonoObservationDensityProfileParabolic_Full(&fbb, start: __start)
  }
