...
public struct MtiHRRScatterer_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiHRRScatterer_Ingest.id, addPrefix: prefix) }
  ...
  public static func startMtiHRRScatterer_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endMtiHRRScatterer_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiHRRScatterer_Ingest(
    ...
    let __start = MtiHRRScatterer_Ingest.startMtiHRRScatterer_Ingest(&fbb)
    MtiHRRScatterer_Ingest.add(h321: h321, &fbb)
    MtiHRRScatterer_Ingest.add(h322: h322, &fbb)
    MtiHRRScatterer_Ingest.add(h323: h323, &fbb)
    MtiHRRScatterer_Ingest.add(h324: h324, &fbb)
    return MtiHRRScatterer_Ingest.endMtiHRRScatterer_Ingest(&fbb, start: __start)
  }
