...
public struct EffectResponseMetrics_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EffectResponseMetrics_Abridged.id, addPrefix: prefix) }
  ...
  public static func startEffectResponseMetrics_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endEffectResponseMetrics_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEffectResponseMetrics_Abridged(
    ...
    let __start = EffectResponseMetrics_Abridged.startEffectResponseMetrics_Abridged(&fbb)
    EffectResponseMetrics_Abridged.add(metricType: metricType, &fbb)
    EffectResponseMetrics_Abridged.add(domainValue: domainValue, &fbb)
    EffectResponseMetrics_Abridged.add(relativeValue: relativeValue, &fbb)
    EffectResponseMetrics_Abridged.add(provenance: provenance, &fbb)
    return EffectResponseMetrics_Abridged.endEffectResponseMetrics_Abridged(&fbb, start: __start)
  }
