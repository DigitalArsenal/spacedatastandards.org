...
public struct DataLinkSpecTracks_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DataLinkSpecTracks_Ingest.id, addPrefix: prefix) }
  ...
  public static func startDataLinkSpecTracks_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 2) }
  ...
  public static func endDataLinkSpecTracks_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDataLinkSpecTracks_Ingest(
    _ fbb: inout FlatBufferBuilder,
    specTrackNumOffset specTrackNum: Offset = Offset(),
    specTrackNumDescOffset specTrackNumDesc: Offset = Offset()
  ) -> Offset {
    let __start = DataLinkSpecTracks_Ingest.startDataLinkSpecTracks_Ingest(&fbb)
    DataLinkSpecTracks_Ingest.add(specTrackNum: specTrackNum, &fbb)
    DataLinkSpecTracks_Ingest.add(specTrackNumDesc: specTrackNumDesc, &fbb)
    return DataLinkSpecTracks_Ingest.endDataLinkSpecTracks_Ingest(&fbb, start: __start)
  }
