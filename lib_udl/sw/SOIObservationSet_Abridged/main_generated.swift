...
public enum SOIObservationSet_Abridged_type_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SOIObservationSet_Abridged_type_Enum { return .radar }
  public static var min: SOIObservationSet_Abridged_type_Enum { return .optical }
}


public enum SOIObservationSet_Abridged_referenceFrame_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: SOIObservationSet_Abridged_referenceFrame_Enum { return .gcrf }
  public static var min: SOIObservationSet_Abridged_referenceFrame_Enum { return .j2000 }
}


public enum SOIObservationSet_Abridged_senReferenceFrame_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: SOIObservationSet_Abridged_senReferenceFrame_Enum { return .gcrf }
  public static var min: SOIObservationSet_Abridged_senReferenceFrame_Enum { return .j2000 }
}


public enum SOIObservationSet_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: SOIObservationSet_Abridged_dataMode_Enum { return .exercise }
  public static var min: SOIObservationSet_Abridged_dataMode_Enum { return .real }
}


///  /// These services provide operations for posting space object idenfification observation sets.
public struct SOIObservationSet_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SOIObservationSet_Abridged.id, addPrefix: prefix) }
  ...
  public var type: SOIObservationSet_Abridged_type_Enum { let o = _accessor.offset(VTOFFSET.type.v); return o == 0 ? .optical : SOIObservationSet_Abridged_type_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .optical }
  ...
  public var referenceFrame: SOIObservationSet_Abridged_referenceFrame_Enum { let o = _accessor.offset(VTOFFSET.referenceFrame.v); return o == 0 ? .j2000 : SOIObservationSet_Abridged_referenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ///  The reference frame of the observing sensor state. If the senReferenceFrame is null it is assumed to be J2000.
  ///  Example: /// Example: J2000
  ///  Constraints: Minimum length = 0, Maximum length = 24
  public var senReferenceFrame: SOIObservationSet_Abridged_senReferenceFrame_Enum { let o = _accessor.offset(VTOFFSET.senReferenceFrame.v); return o == 0 ? .j2000 : SOIObservationSet_Abridged_senReferenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SOIObservationSet_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SOIObservationSet_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSOIObservationSet_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 71) }
  ...
  public static func add(type: SOIObservationSet_Abridged_type_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: type.rawValue, def: 0, at: VTOFFSET.type.p) }
  ...
  public static func add(referenceFrame: SOIObservationSet_Abridged_referenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: referenceFrame.rawValue, def: 0, at: VTOFFSET.referenceFrame.p) }
  public static func add(senReferenceFrame: SOIObservationSet_Abridged_senReferenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: senReferenceFrame.rawValue, def: 0, at: VTOFFSET.senReferenceFrame.p) }
  ...
  public static func add(dataMode: SOIObservationSet_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSOIObservationSet_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSOIObservationSet_Abridged(
    ...
    numObs: Int32 = 0,
    type: SOIObservationSet_Abridged_type_Enum = .optical,
    ...
    let __start = SOIObservationSet_Abridged.startSOIObservationSet_Abridged(&fbb)
    SOIObservationSet_Abridged.add(id: id, &fbb)
    SOIObservationSet_Abridged.add(classificationMarking: classificationMarking, &fbb)
    SOIObservationSet_Abridged.add(msgCreateDate: msgCreateDate, &fbb)
    SOIObservationSet_Abridged.add(idSensor: idSensor, &fbb)
    SOIObservationSet_Abridged.add(origSensorId: origSensorId, &fbb)
    SOIObservationSet_Abridged.add(sensorAsId: sensorAsId, &fbb)
    SOIObservationSet_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    SOIObservationSet_Abridged.add(satNo: satNo, &fbb)
    SOIObservationSet_Abridged.add(origObjectId: origObjectId, &fbb)
    SOIObservationSet_Abridged.add(senlat: senlat, &fbb)
    SOIObservationSet_Abridged.add(senlon: senlon, &fbb)
    SOIObservationSet_Abridged.add(senalt: senalt, &fbb)
    SOIObservationSet_Abridged.add(senx: senx, &fbb)
    SOIObservationSet_Abridged.add(seny: seny, &fbb)
    SOIObservationSet_Abridged.add(senz: senz, &fbb)
    SOIObservationSet_Abridged.add(senvelx: senvelx, &fbb)
    SOIObservationSet_Abridged.add(senvely: senvely, &fbb)
    SOIObservationSet_Abridged.add(senvelz: senvelz, &fbb)
    SOIObservationSet_Abridged.add(idElset: idElset, &fbb)
    SOIObservationSet_Abridged.add(startTime: startTime, &fbb)
    SOIObservationSet_Abridged.add(endTime: endTime, &fbb)
    SOIObservationSet_Abridged.add(numObs: numObs, &fbb)
    SOIObservationSet_Abridged.add(type: type, &fbb)
    SOIObservationSet_Abridged.add(polarAngleStart: polarAngleStart, &fbb)
    SOIObservationSet_Abridged.add(polarAngleEnd: polarAngleEnd, &fbb)
    SOIObservationSet_Abridged.add(referenceFrame: referenceFrame, &fbb)
    SOIObservationSet_Abridged.add(senReferenceFrame: senReferenceFrame, &fbb)
    SOIObservationSet_Abridged.add(losDeclinationStart: losDeclinationStart, &fbb)
    SOIObservationSet_Abridged.add(losDeclinationEnd: losDeclinationEnd, &fbb)
    SOIObservationSet_Abridged.add(pointingAngleAzStart: pointingAngleAzStart, &fbb)
    SOIObservationSet_Abridged.add(pointingAngleAzEnd: pointingAngleAzEnd, &fbb)
    SOIObservationSet_Abridged.add(pointingAngleElStart: pointingAngleElStart, &fbb)
    SOIObservationSet_Abridged.add(pointingAngleElEnd: pointingAngleElEnd, &fbb)
    SOIObservationSet_Abridged.add(pixelArrayWidth: pixelArrayWidth, &fbb)
    SOIObservationSet_Abridged.add(pixelArrayHeight: pixelArrayHeight, &fbb)
    SOIObservationSet_Abridged.add(numSpectralFilters: numSpectralFilters, &fbb)
    SOIObservationSet_Abridged.addVectorOf(spectralFilters: spectralFilters, &fbb)
    SOIObservationSet_Abridged.add(collectionMode: collectionMode, &fbb)
    SOIObservationSet_Abridged.add(gain: gain, &fbb)
    SOIObservationSet_Abridged.add(binningHoriz: binningHoriz, &fbb)
    SOIObservationSet_Abridged.add(binningVert: binningVert, &fbb)
    SOIObservationSet_Abridged.add(solarMag: solarMag, &fbb)
    SOIObservationSet_Abridged.add(pixelMin: pixelMin, &fbb)
    SOIObservationSet_Abridged.add(pixelMax: pixelMax, &fbb)
    SOIObservationSet_Abridged.add(softwareVersion: softwareVersion, &fbb)
    SOIObservationSet_Abridged.add(satelliteName: satelliteName, &fbb)
    SOIObservationSet_Abridged.add(starCatName: starCatName, &fbb)
    SOIObservationSet_Abridged.add(corrQuality: corrQuality, &fbb)
    SOIObservationSet_Abridged.add(uct: uct, &fbb)
    SOIObservationSet_Abridged.add(validCalibrations: validCalibrations, &fbb)
    SOIObservationSet_Abridged.add(calibrationType: calibrationType, &fbb)
    SOIObservationSet_Abridged.add(percentSatThreshold: percentSatThreshold, &fbb)
    SOIObservationSet_Abridged.add(changeDetected: changeDetected, &fbb)
    SOIObservationSet_Abridged.add(periodicityChangeDetected: periodicityChangeDetected, &fbb)
    SOIObservationSet_Abridged.add(brightnessVarianceChangeDetected: brightnessVarianceChangeDetected, &fbb)
    SOIObservationSet_Abridged.add(solarPhaseAngleBrightnessChangeDetected: solarPhaseAngleBrightnessChangeDetected, &fbb)
    SOIObservationSet_Abridged.add(changeConf: changeConf, &fbb)
    SOIObservationSet_Abridged.add(collectionDensityConf: collectionDensityConf, &fbb)
    SOIObservationSet_Abridged.add(periodicitySamplingConf: periodicitySamplingConf, &fbb)
    SOIObservationSet_Abridged.add(periodicityDetectionConf: periodicityDetectionConf, &fbb)
    SOIObservationSet_Abridged.add(collectionId: collectionId, &fbb)
    SOIObservationSet_Abridged.addVectorOf(calibrations: calibrations, &fbb)
    SOIObservationSet_Abridged.addVectorOf(tags: tags, &fbb)
    SOIObservationSet_Abridged.add(transactionId: transactionId, &fbb)
    SOIObservationSet_Abridged.add(createdAt: createdAt, &fbb)
    SOIObservationSet_Abridged.add(createdBy: createdBy, &fbb)
    SOIObservationSet_Abridged.add(source: source, &fbb)
    SOIObservationSet_Abridged.add(origin: origin, &fbb)
    SOIObservationSet_Abridged.add(origNetwork: origNetwork, &fbb)
    SOIObservationSet_Abridged.add(sourceDl: sourceDl, &fbb)
    SOIObservationSet_Abridged.add(dataMode: dataMode, &fbb)
    return SOIObservationSet_Abridged.endSOIObservationSet_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.type.p, fieldName: "type", required: false, type: SOIObservationSet_Abridged_type_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.referenceFrame.p, fieldName: "referenceFrame", required: false, type: SOIObservationSet_Abridged_referenceFrame_Enum.self)
    try _v.visit(field: VTOFFSET.senReferenceFrame.p, fieldName: "senReferenceFrame", required: false, type: SOIObservationSet_Abridged_senReferenceFrame_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SOIObservationSet_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
