...
public enum EffectRequest_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: EffectRequest_Full_dataMode_Enum { return .exercise }
  public static var min: EffectRequest_Full_dataMode_Enum { return .real }
}


///  /// A request for various effects on a target.
public struct EffectRequest_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EffectRequest_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: EffectRequest_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : EffectRequest_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startEffectRequest_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 21) }
  ...
  public static func add(dataMode: EffectRequest_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endEffectRequest_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEffectRequest_Full(
    ...
    let __start = EffectRequest_Full.startEffectRequest_Full(&fbb)
    EffectRequest_Full.add(id: id, &fbb)
    EffectRequest_Full.add(classificationMarking: classificationMarking, &fbb)
    EffectRequest_Full.add(externalRequestId: externalRequestId, &fbb)
    EffectRequest_Full.addVectorOf(effectList: effectList, &fbb)
    EffectRequest_Full.add(state: state, &fbb)
    EffectRequest_Full.add(context: context, &fbb)
    EffectRequest_Full.add(startTime: startTime, &fbb)
    EffectRequest_Full.add(endTime: endTime, &fbb)
    EffectRequest_Full.add(deadlineType: deadlineType, &fbb)
    EffectRequest_Full.add(targetSrcType: targetSrcType, &fbb)
    EffectRequest_Full.add(targetSrcId: targetSrcId, &fbb)
    EffectRequest_Full.add(priority: priority, &fbb)
    EffectRequest_Full.add(modelClass: modelClass, &fbb)
    EffectRequest_Full.addVectorOf(metricTypes: metricTypes, &fbb)
    EffectRequest_Full.addVectorOf(metricWeights: metricWeights, &fbb)
    EffectRequest_Full.add(createdAt: createdAt, &fbb)
    EffectRequest_Full.add(createdBy: createdBy, &fbb)
    EffectRequest_Full.add(source: source, &fbb)
    EffectRequest_Full.add(origin: origin, &fbb)
    EffectRequest_Full.add(dataMode: dataMode, &fbb)
    EffectRequest_Full.add(origNetwork: origNetwork, &fbb)
    return EffectRequest_Full.endEffectRequest_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: EffectRequest_Full_dataMode_Enum.self)
