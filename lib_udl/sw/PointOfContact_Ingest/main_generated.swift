...
public struct PointOfContact_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: PointOfContact_Ingest.id, addPrefix: prefix) }
  ...
  public static func startPointOfContact_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 9) }
  ...
  public static func endPointOfContact_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPointOfContact_Ingest(
    ...
    let __start = PointOfContact_Ingest.startPointOfContact_Ingest(&fbb)
    PointOfContact_Ingest.add(pocSequenceId: pocSequenceId, &fbb)
    PointOfContact_Ingest.add(pocTypeName: pocTypeName, &fbb)
    PointOfContact_Ingest.add(pocName: pocName, &fbb)
    PointOfContact_Ingest.add(office: office, &fbb)
    PointOfContact_Ingest.add(username: username, &fbb)
    PointOfContact_Ingest.add(rank: rank, &fbb)
    PointOfContact_Ingest.add(pocOrg: pocOrg, &fbb)
    PointOfContact_Ingest.add(phone: phone, &fbb)
    PointOfContact_Ingest.add(remark: remark, &fbb)
    return PointOfContact_Ingest.endPointOfContact_Ingest(&fbb, start: __start)
  }
