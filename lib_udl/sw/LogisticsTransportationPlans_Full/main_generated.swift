...
public struct LogisticsTransportationPlans_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LogisticsTransportationPlans_Full.id, addPrefix: prefix) }
  ...
  public static func startLogisticsTransportationPlans_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 26) }
  ...
  public static func endLogisticsTransportationPlans_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLogisticsTransportationPlans_Full(
    ...
    let __start = LogisticsTransportationPlans_Full.startLogisticsTransportationPlans_Full(&fbb)
    LogisticsTransportationPlans_Full.add(plansNumber: plansNumber, &fbb)
    LogisticsTransportationPlans_Full.add(missionChange: missionChange, &fbb)
    LogisticsTransportationPlans_Full.add(planDefinition: planDefinition, &fbb)
    LogisticsTransportationPlans_Full.add(statusCode: statusCode, &fbb)
    LogisticsTransportationPlans_Full.add(coordinator: coordinator, &fbb)
    LogisticsTransportationPlans_Full.add(coordinatorUnit: coordinatorUnit, &fbb)
    LogisticsTransportationPlans_Full.add(originIcao: originIcao, &fbb)
    LogisticsTransportationPlans_Full.add(estDepTime: estDepTime, &fbb)
    LogisticsTransportationPlans_Full.add(estArrTime: estArrTime, &fbb)
    LogisticsTransportationPlans_Full.add(destinationIcao: destinationIcao, &fbb)
    LogisticsTransportationPlans_Full.add(logisticMasterRecordId: logisticMasterRecordId, &fbb)
    LogisticsTransportationPlans_Full.add(tpTailNumber: tpTailNumber, &fbb)
    LogisticsTransportationPlans_Full.add(tpAircraftMds: tpAircraftMds, &fbb)
    LogisticsTransportationPlans_Full.add(majcom: majcom, &fbb)
    LogisticsTransportationPlans_Full.add(approxArrTime: approxArrTime, &fbb)
    LogisticsTransportationPlans_Full.add(duration: duration, &fbb)
    LogisticsTransportationPlans_Full.add(actDepTime: actDepTime, &fbb)
    LogisticsTransportationPlans_Full.add(closedDate: closedDate, &fbb)
    LogisticsTransportationPlans_Full.add(cancelledDate: cancelledDate, &fbb)
    LogisticsTransportationPlans_Full.add(aircraftStatus: aircraftStatus, &fbb)
    LogisticsTransportationPlans_Full.add(numEnrouteStops: numEnrouteStops, &fbb)
    LogisticsTransportationPlans_Full.add(serialNumber: serialNumber, &fbb)
    LogisticsTransportationPlans_Full.add(numTransLoads: numTransLoads, &fbb)
    LogisticsTransportationPlans_Full.add(lastChangedDate: lastChangedDate, &fbb)
    LogisticsTransportationPlans_Full.addVectorOf(logisticsSegments: logisticsSegments, &fbb)
    LogisticsTransportationPlans_Full.addVectorOf(logisticsTransportationPlansRemarks: logisticsTransportationPlansRemarks, &fbb)
    return LogisticsTransportationPlans_Full.endLogisticsTransportationPlans_Full(&fbb, start: __start)
  }
