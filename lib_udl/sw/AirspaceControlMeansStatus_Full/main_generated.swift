...
public struct AirspaceControlMeansStatus_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirspaceControlMeansStatus_Full.id, addPrefix: prefix) }
  ...
  public static func startAirspaceControlMeansStatus_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endAirspaceControlMeansStatus_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirspaceControlMeansStatus_Full(
    ...
    let __start = AirspaceControlMeansStatus_Full.startAirspaceControlMeansStatus_Full(&fbb)
    AirspaceControlMeansStatus_Full.add(cmStat: cmStat, &fbb)
    AirspaceControlMeansStatus_Full.addVectorOf(cmStatId: cmStatId, &fbb)
    AirspaceControlMeansStatus_Full.addVectorOf(airspaceControlMeans: airspaceControlMeans, &fbb)
    return AirspaceControlMeansStatus_Full.endAirspaceControlMeansStatus_Full(&fbb, start: __start)
  }
