...
public enum WeatherReport_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: WeatherReport_Abridged_dataMode_Enum { return .exercise }
  public static var min: WeatherReport_Abridged_dataMode_Enum { return .real }
}
...
public struct WeatherReport_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: WeatherReport_Abridged.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case senalt = 132
    case dewPoint = 134
    case relHumidity = 136
    case indexRefraction = 138
    case soilMoisture = 140
    case surroundingWeather = 142
    case weatherAmp = 144
    case contrailHghtLower = 146
    case contrailHghtUpper = 148
    case icingUpperLimit = 150
    case icingLowerLimit = 152
    case enRouteWeather = 154
    case ccEvent = 156
    case srcTyps = 158
    case srcIds = 160
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: WeatherReport_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : WeatherReport_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startWeatherReport_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 85) }
  ...
  public static func add(dataMode: WeatherReport_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endWeatherReport_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createWeatherReport_Abridged(
    ...
    let __start = WeatherReport_Abridged.startWeatherReport_Abridged(&fbb)
    WeatherReport_Abridged.add(id: id, &fbb)
    WeatherReport_Abridged.add(classificationMarking: classificationMarking, &fbb)
    WeatherReport_Abridged.add(idSensor: idSensor, &fbb)
    WeatherReport_Abridged.add(origSensorId: origSensorId, &fbb)
    WeatherReport_Abridged.add(weatherId: weatherId, &fbb)
    WeatherReport_Abridged.add(idGroundImagery: idGroundImagery, &fbb)
    WeatherReport_Abridged.add(idSite: idSite, &fbb)
    WeatherReport_Abridged.add(idAirfield: idAirfield, &fbb)
    WeatherReport_Abridged.add(icao: icao, &fbb)
    WeatherReport_Abridged.add(externalId: externalId, &fbb)
    WeatherReport_Abridged.add(externalLocationId: externalLocationId, &fbb)
    WeatherReport_Abridged.add(reportType: reportType, &fbb)
    WeatherReport_Abridged.add(obTime: obTime, &fbb)
    WeatherReport_Abridged.add(forecastStartTime: forecastStartTime, &fbb)
    WeatherReport_Abridged.add(forecastEndTime: forecastEndTime, &fbb)
    WeatherReport_Abridged.add(lat: lat, &fbb)
    WeatherReport_Abridged.add(lon: lon, &fbb)
    WeatherReport_Abridged.add(alt: alt, &fbb)
    WeatherReport_Abridged.add(geoPotentialAlt: geoPotentialAlt, &fbb)
    WeatherReport_Abridged.add(dataLevel: dataLevel, &fbb)
    WeatherReport_Abridged.add(atext: atext, &fbb)
    WeatherReport_Abridged.add(agjson: agjson, &fbb)
    WeatherReport_Abridged.add(atype: atype, &fbb)
    WeatherReport_Abridged.add(andims: andims, &fbb)
    WeatherReport_Abridged.add(asrid: asrid, &fbb)
    WeatherReport_Abridged.add(windSpd: windSpd, &fbb)
    WeatherReport_Abridged.add(windSpdAvg: windSpdAvg, &fbb)
    WeatherReport_Abridged.add(windGust: windGust, &fbb)
    WeatherReport_Abridged.add(windGust10: windGust10, &fbb)
    WeatherReport_Abridged.add(vshear: vshear, &fbb)
    WeatherReport_Abridged.add(hshear: hshear, &fbb)
    WeatherReport_Abridged.add(radVel: radVel, &fbb)
    WeatherReport_Abridged.add(radVelBeam1: radVelBeam1, &fbb)
    WeatherReport_Abridged.add(radVelBeam2: radVelBeam2, &fbb)
    WeatherReport_Abridged.add(radVelBeam3: radVelBeam3, &fbb)
    WeatherReport_Abridged.add(radVelBeam4: radVelBeam4, &fbb)
    WeatherReport_Abridged.add(radVelBeam5: radVelBeam5, &fbb)
    WeatherReport_Abridged.add(windDir: windDir, &fbb)
    WeatherReport_Abridged.add(windDirAvg: windDirAvg, &fbb)
    WeatherReport_Abridged.add(windDirPeak: windDirPeak, &fbb)
    WeatherReport_Abridged.add(windDirPeak10: windDirPeak10, &fbb)
    WeatherReport_Abridged.add(windChill: windChill, &fbb)
    WeatherReport_Abridged.add(dirDev: dirDev, &fbb)
    WeatherReport_Abridged.add(windVar: windVar, &fbb)
    WeatherReport_Abridged.addVectorOf(windCov: windCov, &fbb)
    WeatherReport_Abridged.addVectorOf(cloudCover: cloudCover, &fbb)
    WeatherReport_Abridged.addVectorOf(cloudHght: cloudHght, &fbb)
    WeatherReport_Abridged.add(actWeather: actWeather, &fbb)
    WeatherReport_Abridged.add(weatherDesc: weatherDesc, &fbb)
    WeatherReport_Abridged.add(weatherInt: weatherInt, &fbb)
    WeatherReport_Abridged.add(rawMetar: rawMetar, &fbb)
    WeatherReport_Abridged.add(rawTaf: rawTaf, &fbb)
    WeatherReport_Abridged.add(qnh: qnh, &fbb)
    WeatherReport_Abridged.add(visibility: visibility, &fbb)
    WeatherReport_Abridged.add(temperature: temperature, &fbb)
    WeatherReport_Abridged.add(soilTemp: soilTemp, &fbb)
    WeatherReport_Abridged.add(barPress: barPress, &fbb)
    WeatherReport_Abridged.add(precipRate: precipRate, &fbb)
    WeatherReport_Abridged.add(rainHour: rainHour, &fbb)
    WeatherReport_Abridged.add(solarRad: solarRad, &fbb)
    WeatherReport_Abridged.add(difRad: difRad, &fbb)
    WeatherReport_Abridged.add(refRad: refRad, &fbb)
    WeatherReport_Abridged.add(senlat: senlat, &fbb)
    WeatherReport_Abridged.add(senlon: senlon, &fbb)
    WeatherReport_Abridged.add(senalt: senalt, &fbb)
    WeatherReport_Abridged.add(dewPoint: dewPoint, &fbb)
    WeatherReport_Abridged.add(relHumidity: relHumidity, &fbb)
    WeatherReport_Abridged.add(indexRefraction: indexRefraction, &fbb)
    WeatherReport_Abridged.add(soilMoisture: soilMoisture, &fbb)
    WeatherReport_Abridged.add(surroundingWeather: surroundingWeather, &fbb)
    WeatherReport_Abridged.add(weatherAmp: weatherAmp, &fbb)
    WeatherReport_Abridged.add(contrailHghtLower: contrailHghtLower, &fbb)
    WeatherReport_Abridged.add(contrailHghtUpper: contrailHghtUpper, &fbb)
    WeatherReport_Abridged.add(icingUpperLimit: icingUpperLimit, &fbb)
    WeatherReport_Abridged.add(icingLowerLimit: icingLowerLimit, &fbb)
    WeatherReport_Abridged.add(enRouteWeather: enRouteWeather, &fbb)
    WeatherReport_Abridged.add(ccEvent: ccEvent, &fbb)
    WeatherReport_Abridged.addVectorOf(srcTyps: srcTyps, &fbb)
    WeatherReport_Abridged.addVectorOf(srcIds: srcIds, &fbb)
    WeatherReport_Abridged.add(origNetwork: origNetwork, &fbb)
    WeatherReport_Abridged.add(createdAt: createdAt, &fbb)
    WeatherReport_Abridged.add(createdBy: createdBy, &fbb)
    WeatherReport_Abridged.add(source: source, &fbb)
    WeatherReport_Abridged.add(origin: origin, &fbb)
    WeatherReport_Abridged.add(dataMode: dataMode, &fbb)
    return WeatherReport_Abridged.endWeatherReport_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: WeatherReport_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
