...
public enum EngineDetails_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: EngineDetails_dataMode_Enum { return .exercise }
  public static var min: EngineDetails_dataMode_Enum { return .real }
}
...
public struct EngineDetails: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EngineDetails.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: EngineDetails_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : EngineDetails_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startEngineDetails(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 26) }
  ...
  public static func add(dataMode: EngineDetails_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func addVectorOf(tags: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: tags, at: VTOFFSET.tags.p) }
  public static func endEngineDetails(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEngineDetails(
    ...
    let __start = EngineDetails.startEngineDetails(&fbb)
    EngineDetails.add(id: id, &fbb)
    EngineDetails.add(idEngine: idEngine, &fbb)
    EngineDetails.add(classificationMarking: classificationMarking, &fbb)
    EngineDetails.add(family: family, &fbb)
    EngineDetails.add(cycleType: cycleType, &fbb)
    EngineDetails.add(characteristicType: characteristicType, &fbb)
    EngineDetails.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    EngineDetails.add(specificImpulse: specificImpulse, &fbb)
    EngineDetails.add(burnTime: burnTime, &fbb)
    EngineDetails.add(seaLevelThrust: seaLevelThrust, &fbb)
    EngineDetails.add(vacuumThrust: vacuumThrust, &fbb)
    EngineDetails.add(chamberPressure: chamberPressure, &fbb)
    EngineDetails.add(nozzleExpansionRatio: nozzleExpansionRatio, &fbb)
    EngineDetails.add(maxFirings: maxFirings, &fbb)
    EngineDetails.add(propellant: propellant, &fbb)
    EngineDetails.add(oxidizer: oxidizer, &fbb)
    EngineDetails.add(notes: notes, &fbb)
    EngineDetails.add(createdAt: createdAt, &fbb)
    EngineDetails.add(createdBy: createdBy, &fbb)
    EngineDetails.add(updatedAt: updatedAt, &fbb)
    EngineDetails.add(updatedBy: updatedBy, &fbb)
    EngineDetails.add(source: source, &fbb)
    EngineDetails.add(origin: origin, &fbb)
    EngineDetails.add(origNetwork: origNetwork, &fbb)
    EngineDetails.add(dataMode: dataMode, &fbb)
    EngineDetails.addVectorOf(tags: tags, &fbb)
    return EngineDetails.endEngineDetails(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: EngineDetails_dataMode_Enum.self)
