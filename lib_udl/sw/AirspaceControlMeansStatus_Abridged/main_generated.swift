...
public struct AirspaceControlMeansStatus_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirspaceControlMeansStatus_Abridged.id, addPrefix: prefix) }
  ...
  public static func startAirspaceControlMeansStatus_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endAirspaceControlMeansStatus_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirspaceControlMeansStatus_Abridged(
    ...
    let __start = AirspaceControlMeansStatus_Abridged.startAirspaceControlMeansStatus_Abridged(&fbb)
    AirspaceControlMeansStatus_Abridged.add(cmStat: cmStat, &fbb)
    AirspaceControlMeansStatus_Abridged.addVectorOf(cmStatId: cmStatId, &fbb)
    AirspaceControlMeansStatus_Abridged.addVectorOf(airspaceControlMeans: airspaceControlMeans, &fbb)
    return AirspaceControlMeansStatus_Abridged.endAirspaceControlMeansStatus_Abridged(&fbb, start: __start)
  }
