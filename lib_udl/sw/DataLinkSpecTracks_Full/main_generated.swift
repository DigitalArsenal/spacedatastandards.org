...
public struct DataLinkSpecTracks_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DataLinkSpecTracks_Full.id, addPrefix: prefix) }
  ...
  public static func startDataLinkSpecTracks_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 2) }
  ...
  public static func endDataLinkSpecTracks_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDataLinkSpecTracks_Full(
    _ fbb: inout FlatBufferBuilder,
    specTrackNumOffset specTrackNum: Offset = Offset(),
    specTrackNumDescOffset specTrackNumDesc: Offset = Offset()
  ) -> Offset {
    let __start = DataLinkSpecTracks_Full.startDataLinkSpecTracks_Full(&fbb)
    DataLinkSpecTracks_Full.add(specTrackNum: specTrackNum, &fbb)
    DataLinkSpecTracks_Full.add(specTrackNumDesc: specTrackNumDesc, &fbb)
    return DataLinkSpecTracks_Full.endDataLinkSpecTracks_Full(&fbb, start: __start)
  }
