...
public enum StarCatalog_Full_astrometryOrigin_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: StarCatalog_Full_astrometryOrigin_Enum { return .usnobsc }
  public static var min: StarCatalog_Full_astrometryOrigin_Enum { return .gaiadr3 }
}


public enum StarCatalog_Full_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: StarCatalog_Full_dataMode_Enum { return .exercise }
  public static var min: StarCatalog_Full_dataMode_Enum { return .real }
}


///  /// The star catalog provides the position, proper motion, parallax, and photometric magnitudes at various bandpasses of a star.
public struct StarCatalog_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: StarCatalog_Full.id, addPrefix: prefix) }
  ...
  public var astrometryOrigin: StarCatalog_Full_astrometryOrigin_Enum { let o = _accessor.offset(VTOFFSET.astrometryOrigin.v); return o == 0 ? .gaiadr3 : StarCatalog_Full_astrometryOrigin_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .gaiadr3 }
  ...
  public var dataMode: StarCatalog_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : StarCatalog_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startStarCatalog_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 48) }
  ...
  public static func add(astrometryOrigin: StarCatalog_Full_astrometryOrigin_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: astrometryOrigin.rawValue, def: 0, at: VTOFFSET.astrometryOrigin.p) }
  ...
  public static func add(dataMode: StarCatalog_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endStarCatalog_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createStarCatalog_Full(
    ...
    let __start = StarCatalog_Full.startStarCatalog_Full(&fbb)
    StarCatalog_Full.add(id: id, &fbb)
    StarCatalog_Full.add(classificationMarking: classificationMarking, &fbb)
    StarCatalog_Full.add(csId: csId, &fbb)
    StarCatalog_Full.add(gncCatId: gncCatId, &fbb)
    StarCatalog_Full.add(gaiadr3CatId: gaiadr3CatId, &fbb)
    StarCatalog_Full.add(hipCatId: hipCatId, &fbb)
    StarCatalog_Full.add(catVersion: catVersion, &fbb)
    StarCatalog_Full.add(ra: ra, &fbb)
    StarCatalog_Full.add(raUnc: raUnc, &fbb)
    StarCatalog_Full.add(dec: dec, &fbb)
    StarCatalog_Full.add(decUnc: decUnc, &fbb)
    StarCatalog_Full.add(posUncFlag: posUncFlag, &fbb)
    StarCatalog_Full.add(parallax: parallax, &fbb)
    StarCatalog_Full.add(parallaxUnc: parallaxUnc, &fbb)
    StarCatalog_Full.add(pmra: pmra, &fbb)
    StarCatalog_Full.add(pmraUnc: pmraUnc, &fbb)
    StarCatalog_Full.add(pmdec: pmdec, &fbb)
    StarCatalog_Full.add(pmdecUnc: pmdecUnc, &fbb)
    StarCatalog_Full.add(pmUncFlag: pmUncFlag, &fbb)
    StarCatalog_Full.add(astrometryOrigin: astrometryOrigin, &fbb)
    StarCatalog_Full.add(starEpoch: starEpoch, &fbb)
    StarCatalog_Full.add(gmag: gmag, &fbb)
    StarCatalog_Full.add(gmagUnc: gmagUnc, &fbb)
    StarCatalog_Full.add(bpmag: bpmag, &fbb)
    StarCatalog_Full.add(bpmagUnc: bpmagUnc, &fbb)
    StarCatalog_Full.add(rpmag: rpmag, &fbb)
    StarCatalog_Full.add(rpmagUnc: rpmagUnc, &fbb)
    StarCatalog_Full.add(jmag: jmag, &fbb)
    StarCatalog_Full.add(jmagUnc: jmagUnc, &fbb)
    StarCatalog_Full.add(kmag: kmag, &fbb)
    StarCatalog_Full.add(kmagUnc: kmagUnc, &fbb)
    StarCatalog_Full.add(hmag: hmag, &fbb)
    StarCatalog_Full.add(hmagUnc: hmagUnc, &fbb)
    StarCatalog_Full.add(varFlag: varFlag, &fbb)
    StarCatalog_Full.add(multFlag: multFlag, &fbb)
    StarCatalog_Full.add(neighborId: neighborId, &fbb)
    StarCatalog_Full.add(neighborFlag: neighborFlag, &fbb)
    StarCatalog_Full.add(neighborDistance: neighborDistance, &fbb)
    StarCatalog_Full.add(shiftFlag: shiftFlag, &fbb)
    StarCatalog_Full.add(shift: shift, &fbb)
    StarCatalog_Full.add(createdAt: createdAt, &fbb)
    StarCatalog_Full.add(createdBy: createdBy, &fbb)
    StarCatalog_Full.add(updatedAt: updatedAt, &fbb)
    StarCatalog_Full.add(updatedBy: updatedBy, &fbb)
    StarCatalog_Full.add(source: source, &fbb)
    StarCatalog_Full.add(origin: origin, &fbb)
    StarCatalog_Full.add(origNetwork: origNetwork, &fbb)
    StarCatalog_Full.add(dataMode: dataMode, &fbb)
    return StarCatalog_Full.endStarCatalog_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.astrometryOrigin.p, fieldName: "astrometryOrigin", required: false, type: StarCatalog_Full_astrometryOrigin_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: StarCatalog_Full_dataMode_Enum.self)
    _v.finish()
  }
}
