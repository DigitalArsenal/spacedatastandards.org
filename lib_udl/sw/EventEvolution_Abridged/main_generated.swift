...
public enum EventEvolution_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: EventEvolution_Abridged_dataMode_Enum { return .exercise }
  public static var min: EventEvolution_Abridged_dataMode_Enum { return .real }
}
...
public struct EventEvolution_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EventEvolution_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: EventEvolution_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : EventEvolution_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startEventEvolution_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 29) }
  ...
  public static func add(dataMode: EventEvolution_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endEventEvolution_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEventEvolution_Abridged(
    ...
    let __start = EventEvolution_Abridged.startEventEvolution_Abridged(&fbb)
    EventEvolution_Abridged.add(id: id, &fbb)
    EventEvolution_Abridged.add(classificationMarking: classificationMarking, &fbb)
    EventEvolution_Abridged.add(eventId: eventId, &fbb)
    EventEvolution_Abridged.add(category: category, &fbb)
    EventEvolution_Abridged.add(summary: summary, &fbb)
    EventEvolution_Abridged.add(startTime: startTime, &fbb)
    EventEvolution_Abridged.add(endTime: endTime, &fbb)
    EventEvolution_Abridged.add(status: status, &fbb)
    EventEvolution_Abridged.add(countryCode: countryCode, &fbb)
    EventEvolution_Abridged.add(geoAdminLevel1: geoAdminLevel1, &fbb)
    EventEvolution_Abridged.add(geoAdminLevel2: geoAdminLevel2, &fbb)
    EventEvolution_Abridged.add(geoAdminLevel3: geoAdminLevel3, &fbb)
    EventEvolution_Abridged.add(redact: redact, &fbb)
    EventEvolution_Abridged.addVectorOf(srcTyps: srcTyps, &fbb)
    EventEvolution_Abridged.addVectorOf(srcIds: srcIds, &fbb)
    EventEvolution_Abridged.add(dataDescription: dataDescription, &fbb)
    EventEvolution_Abridged.add(atext: atext, &fbb)
    EventEvolution_Abridged.add(agjson: agjson, &fbb)
    EventEvolution_Abridged.add(atype: atype, &fbb)
    EventEvolution_Abridged.add(andims: andims, &fbb)
    EventEvolution_Abridged.add(asrid: asrid, &fbb)
    EventEvolution_Abridged.addVectorOf(url: url, &fbb)
    EventEvolution_Abridged.addVectorOf(tags: tags, &fbb)
    EventEvolution_Abridged.add(createdAt: createdAt, &fbb)
    EventEvolution_Abridged.add(createdBy: createdBy, &fbb)
    EventEvolution_Abridged.add(source: source, &fbb)
    EventEvolution_Abridged.add(origin: origin, &fbb)
    EventEvolution_Abridged.add(origNetwork: origNetwork, &fbb)
    EventEvolution_Abridged.add(dataMode: dataMode, &fbb)
    return EventEvolution_Abridged.endEventEvolution_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: EventEvolution_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
