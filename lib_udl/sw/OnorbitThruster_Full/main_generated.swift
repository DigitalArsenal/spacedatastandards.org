...
public enum OnorbitThruster_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OnorbitThruster_Full_dataMode_Enum { return .exercise }
  public static var min: OnorbitThruster_Full_dataMode_Enum { return .real }
}


///  /// Read-only collection of thrusters (engines) on this on-orbit object.
public struct OnorbitThruster_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OnorbitThruster_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: OnorbitThruster_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OnorbitThruster_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOnorbitThruster_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 15) }
  ...
  public static func add(dataMode: OnorbitThruster_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endOnorbitThruster_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnorbitThruster_Full(
    ...
    let __start = OnorbitThruster_Full.startOnorbitThruster_Full(&fbb)
    OnorbitThruster_Full.add(id: id, &fbb)
    OnorbitThruster_Full.add(idOnOrbit: idOnOrbit, &fbb)
    OnorbitThruster_Full.add(idEngine: idEngine, &fbb)
    OnorbitThruster_Full.add(classificationMarking: classificationMarking, &fbb)
    OnorbitThruster_Full.add(type: type, &fbb)
    OnorbitThruster_Full.add(quantity: quantity, &fbb)
    OnorbitThruster_Full.add(createdAt: createdAt, &fbb)
    OnorbitThruster_Full.add(createdBy: createdBy, &fbb)
    OnorbitThruster_Full.add(updatedAt: updatedAt, &fbb)
    OnorbitThruster_Full.add(updatedBy: updatedBy, &fbb)
    OnorbitThruster_Full.add(source: source, &fbb)
    OnorbitThruster_Full.add(origin: origin, &fbb)
    OnorbitThruster_Full.add(dataMode: dataMode, &fbb)
    OnorbitThruster_Full.add(engine: engine, &fbb)
    OnorbitThruster_Full.add(origNetwork: origNetwork, &fbb)
    return OnorbitThruster_Full.endOnorbitThruster_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OnorbitThruster_Full_dataMode_Enum.self)
