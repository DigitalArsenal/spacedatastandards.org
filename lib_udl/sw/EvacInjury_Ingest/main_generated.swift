...
///  /// Injury specifics.
public struct EvacInjury_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacInjury_Ingest.id, addPrefix: prefix) }
  ...
  public static func startEvacInjury_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endEvacInjury_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacInjury_Ingest(
    ...
    let __start = EvacInjury_Ingest.startEvacInjury_Ingest(&fbb)
    EvacInjury_Ingest.add(type: type, &fbb)
    EvacInjury_Ingest.add(bodyPart: bodyPart, &fbb)
    EvacInjury_Ingest.add(time: time, &fbb)
    EvacInjury_Ingest.add(comments: comments, &fbb)
    return EvacInjury_Ingest.endEvacInjury_Ingest(&fbb, start: __start)
  }
