...
public struct Sensortype_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Sensortype_Ingest.id, addPrefix: prefix) }
  ...
  public static func startSensortype_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endSensortype_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSensortype_Ingest(
    ...
    let __start = Sensortype_Ingest.startSensortype_Ingest(&fbb)
    Sensortype_Ingest.add(id: id, &fbb)
    Sensortype_Ingest.add(type: type, &fbb)
    Sensortype_Ingest.add(createdAt: createdAt, &fbb)
    Sensortype_Ingest.add(createdBy: createdBy, &fbb)
    Sensortype_Ingest.add(origNetwork: origNetwork, &fbb)
    return Sensortype_Ingest.endSensortype_Ingest(&fbb, start: __start)
  }
