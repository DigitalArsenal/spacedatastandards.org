...
public enum OnorbitBattery_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OnorbitBattery_dataMode_Enum { return .exercise }
  public static var min: OnorbitBattery_dataMode_Enum { return .real }
}


///  /// Read-only collection of batteries on this on-orbit object.
public struct OnorbitBattery: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OnorbitBattery.id, addPrefix: prefix) }
  ...
  public var dataMode: OnorbitBattery_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OnorbitBattery_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOnorbitBattery(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 14) }
  ...
  public static func add(dataMode: OnorbitBattery_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endOnorbitBattery(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnorbitBattery(
    ...
    let __start = OnorbitBattery.startOnorbitBattery(&fbb)
    OnorbitBattery.add(id: id, &fbb)
    OnorbitBattery.add(idOnOrbit: idOnOrbit, &fbb)
    OnorbitBattery.add(idBattery: idBattery, &fbb)
    OnorbitBattery.add(classificationMarking: classificationMarking, &fbb)
    OnorbitBattery.add(quantity: quantity, &fbb)
    OnorbitBattery.add(createdAt: createdAt, &fbb)
    OnorbitBattery.add(createdBy: createdBy, &fbb)
    OnorbitBattery.add(updatedAt: updatedAt, &fbb)
    OnorbitBattery.add(updatedBy: updatedBy, &fbb)
    OnorbitBattery.add(source: source, &fbb)
    OnorbitBattery.add(origin: origin, &fbb)
    OnorbitBattery.add(dataMode: dataMode, &fbb)
    OnorbitBattery.add(origNetwork: origNetwork, &fbb)
    OnorbitBattery.add(battery: battery, &fbb)
    return OnorbitBattery.endOnorbitBattery(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OnorbitBattery_dataMode_Enum.self)
