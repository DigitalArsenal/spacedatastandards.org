...
public struct ISRCollectionPlanned_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollectionPlanned_Abridged.id, addPrefix: prefix) }
  ...
  public static func startISRCollectionPlanned_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endISRCollectionPlanned_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollectionPlanned_Abridged(
    _ fbb: inout FlatBufferBuilder,
    startOffset start: Offset = Offset(),
    stopOffset stop: Offset = Offset(),
    additionalVectorOffset additional: Offset = Offset()
  ) -> Offset {
    let __start = ISRCollectionPlanned_Abridged.startISRCollectionPlanned_Abridged(&fbb)
    ISRCollectionPlanned_Abridged.add(start: start, &fbb)
    ISRCollectionPlanned_Abridged.add(stop: stop, &fbb)
    ISRCollectionPlanned_Abridged.addVectorOf(additional: additional, &fbb)
    return ISRCollectionPlanned_Abridged.endISRCollectionPlanned_Abridged(&fbb, start: __start)
  }
