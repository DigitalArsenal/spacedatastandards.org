...
public struct LogisticsSegments_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LogisticsSegments_Abridged.id, addPrefix: prefix) }
  ...
  public static func startLogisticsSegments_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 15) }
  ...
  public static func endLogisticsSegments_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLogisticsSegments_Abridged(
    ...
    let __start = LogisticsSegments_Abridged.startLogisticsSegments_Abridged(&fbb)
    LogisticsSegments_Abridged.add(segmentNumber: segmentNumber, &fbb)
    LogisticsSegments_Abridged.add(modeCode: modeCode, &fbb)
    LogisticsSegments_Abridged.add(missionType: missionType, &fbb)
    LogisticsSegments_Abridged.add(idMission: idMission, &fbb)
    LogisticsSegments_Abridged.add(extMissionId: extMissionId, &fbb)
    LogisticsSegments_Abridged.add(missionNumber: missionNumber, &fbb)
    LogisticsSegments_Abridged.add(itin: itin, &fbb)
    LogisticsSegments_Abridged.add(segTailNumber: segTailNumber, &fbb)
    LogisticsSegments_Abridged.add(segAircraftMds: segAircraftMds, &fbb)
    LogisticsSegments_Abridged.add(departureIcao: departureIcao, &fbb)
    LogisticsSegments_Abridged.add(segActDepTime: segActDepTime, &fbb)
    LogisticsSegments_Abridged.add(arrivalIcao: arrivalIcao, &fbb)
    LogisticsSegments_Abridged.add(segActArrTime: segActArrTime, &fbb)
    LogisticsSegments_Abridged.add(segEstDepTime: segEstDepTime, &fbb)
    LogisticsSegments_Abridged.add(segEstArrTime: segEstArrTime, &fbb)
    return LogisticsSegments_Abridged.endLogisticsSegments_Abridged(&fbb, start: __start)
  }
