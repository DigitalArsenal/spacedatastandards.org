...
public struct MtiHRRScatterer_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiHRRScatterer_Full.id, addPrefix: prefix) }
  ...
  public static func startMtiHRRScatterer_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endMtiHRRScatterer_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiHRRScatterer_Full(
    ...
    let __start = MtiHRRScatterer_Full.startMtiHRRScatterer_Full(&fbb)
    MtiHRRScatterer_Full.add(h321: h321, &fbb)
    MtiHRRScatterer_Full.add(h322: h322, &fbb)
    MtiHRRScatterer_Full.add(h323: h323, &fbb)
    MtiHRRScatterer_Full.add(h324: h324, &fbb)
    return MtiHRRScatterer_Full.endMtiHRRScatterer_Full(&fbb, start: __start)
  }
