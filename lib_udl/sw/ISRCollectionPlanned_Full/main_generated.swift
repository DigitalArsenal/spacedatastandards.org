...
public struct ISRCollectionPlanned_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollectionPlanned_Full.id, addPrefix: prefix) }
  ...
  public static func startISRCollectionPlanned_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endISRCollectionPlanned_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollectionPlanned_Full(
    _ fbb: inout FlatBufferBuilder,
    startOffset start: Offset = Offset(),
    stopOffset stop: Offset = Offset(),
    additionalVectorOffset additional: Offset = Offset()
  ) -> Offset {
    let __start = ISRCollectionPlanned_Full.startISRCollectionPlanned_Full(&fbb)
    ISRCollectionPlanned_Full.add(start: start, &fbb)
    ISRCollectionPlanned_Full.add(stop: stop, &fbb)
    ISRCollectionPlanned_Full.addVectorOf(additional: additional, &fbb)
    return ISRCollectionPlanned_Full.endISRCollectionPlanned_Full(&fbb, start: __start)
  }
