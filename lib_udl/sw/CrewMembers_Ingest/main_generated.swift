...
public struct CrewMembers_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: CrewMembers_Ingest.id, addPrefix: prefix) }
  ...
  public static func startCrewMembers_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 17) }
  ...
  public static func endCrewMembers_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createCrewMembers_Ingest(
    ...
    let __start = CrewMembers_Ingest.startCrewMembers_Ingest(&fbb)
    CrewMembers_Ingest.add(lastName: lastName, &fbb)
    CrewMembers_Ingest.add(firstName: firstName, &fbb)
    CrewMembers_Ingest.add(middleInitial: middleInitial, &fbb)
    CrewMembers_Ingest.add(memberId: memberId, &fbb)
    CrewMembers_Ingest.add(civilian: civilian, &fbb)
    CrewMembers_Ingest.add(commander: commander, &fbb)
    CrewMembers_Ingest.add(last4Ssn: last4Ssn, &fbb)
    CrewMembers_Ingest.add(dodId: dodId, &fbb)
    CrewMembers_Ingest.add(dutyPosition: dutyPosition, &fbb)
    CrewMembers_Ingest.add(crewPosition: crewPosition, &fbb)
    CrewMembers_Ingest.add(memberType: memberType, &fbb)
    CrewMembers_Ingest.add(branch: branch, &fbb)
    CrewMembers_Ingest.add(rank: rank, &fbb)
    CrewMembers_Ingest.add(wing: wing, &fbb)
    CrewMembers_Ingest.add(squadron: squadron, &fbb)
    CrewMembers_Ingest.add(memberRemarks: memberRemarks, &fbb)
    CrewMembers_Ingest.add(username: username, &fbb)
    return CrewMembers_Ingest.endCrewMembers_Ingest(&fbb, start: __start)
  }
