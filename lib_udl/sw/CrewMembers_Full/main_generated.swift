...
public struct CrewMembers_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: CrewMembers_Full.id, addPrefix: prefix) }
  ...
  public static func startCrewMembers_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 17) }
  ...
  public static func endCrewMembers_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createCrewMembers_Full(
    ...
    let __start = CrewMembers_Full.startCrewMembers_Full(&fbb)
    CrewMembers_Full.add(lastName: lastName, &fbb)
    CrewMembers_Full.add(firstName: firstName, &fbb)
    CrewMembers_Full.add(middleInitial: middleInitial, &fbb)
    CrewMembers_Full.add(memberId: memberId, &fbb)
    CrewMembers_Full.add(civilian: civilian, &fbb)
    CrewMembers_Full.add(commander: commander, &fbb)
    CrewMembers_Full.add(last4Ssn: last4Ssn, &fbb)
    CrewMembers_Full.add(dodId: dodId, &fbb)
    CrewMembers_Full.add(dutyPosition: dutyPosition, &fbb)
    CrewMembers_Full.add(crewPosition: crewPosition, &fbb)
    CrewMembers_Full.add(memberType: memberType, &fbb)
    CrewMembers_Full.add(branch: branch, &fbb)
    CrewMembers_Full.add(rank: rank, &fbb)
    CrewMembers_Full.add(wing: wing, &fbb)
    CrewMembers_Full.add(squadron: squadron, &fbb)
    CrewMembers_Full.add(memberRemarks: memberRemarks, &fbb)
    CrewMembers_Full.add(username: username, &fbb)
    return CrewMembers_Full.endCrewMembers_Full(&fbb, start: __start)
  }
