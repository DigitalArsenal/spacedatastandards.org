...
public enum OperatingUnitRemark_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OperatingUnitRemark_dataMode_Enum { return .exercise }
  public static var min: OperatingUnitRemark_dataMode_Enum { return .real }
}
...
public struct OperatingUnitRemark: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OperatingUnitRemark.id, addPrefix: prefix) }
  ...
  public var dataMode: OperatingUnitRemark_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OperatingUnitRemark_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startOperatingUnitRemark(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 15) }
  ...
  public static func add(dataMode: OperatingUnitRemark_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endOperatingUnitRemark(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOperatingUnitRemark(
    ...
    let __start = OperatingUnitRemark.startOperatingUnitRemark(&fbb)
    OperatingUnitRemark.add(id: id, &fbb)
    OperatingUnitRemark.add(classificationMarking: classificationMarking, &fbb)
    OperatingUnitRemark.add(idOperatingUnit: idOperatingUnit, &fbb)
    OperatingUnitRemark.add(altRmkId: altRmkId, &fbb)
    OperatingUnitRemark.add(name: name, &fbb)
    OperatingUnitRemark.add(type: type, &fbb)
    OperatingUnitRemark.add(text: text, &fbb)
    OperatingUnitRemark.add(code: code, &fbb)
    OperatingUnitRemark.add(createdAt: createdAt, &fbb)
    OperatingUnitRemark.add(createdBy: createdBy, &fbb)
    OperatingUnitRemark.add(updatedAt: updatedAt, &fbb)
    OperatingUnitRemark.add(updatedBy: updatedBy, &fbb)
    OperatingUnitRemark.add(source: source, &fbb)
    OperatingUnitRemark.add(origin: origin, &fbb)
    OperatingUnitRemark.add(dataMode: dataMode, &fbb)
    return OperatingUnitRemark.endOperatingUnitRemark(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OperatingUnitRemark_dataMode_Enum.self)
    _v.finish()
  }
}
