...
public enum Aircraft_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Aircraft_Ingest_dataMode_Enum { return .exercise }
  public static var min: Aircraft_Ingest_dataMode_Enum { return .real }
}
...
public struct Aircraft_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Aircraft_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 64
  public var dataMode: Aircraft_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Aircraft_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: OPS1
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startAircraft_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 24) }
  ...
  public static func add(dataMode: Aircraft_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endAircraft_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAircraft_Ingest(
    ...
    let __start = Aircraft_Ingest.startAircraft_Ingest(&fbb)
    Aircraft_Ingest.add(id: id, &fbb)
    Aircraft_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Aircraft_Ingest.add(entity: entity, &fbb)
    Aircraft_Ingest.add(idEntity: idEntity, &fbb)
    Aircraft_Ingest.add(aircraftMds: aircraftMds, &fbb)
    Aircraft_Ingest.add(tailNumber: tailNumber, &fbb)
    Aircraft_Ingest.add(serialNumber: serialNumber, &fbb)
    Aircraft_Ingest.add(owner: owner, &fbb)
    Aircraft_Ingest.add(command: command, &fbb)
    Aircraft_Ingest.add(category: category, &fbb)
    Aircraft_Ingest.add(dtd: dtd, &fbb)
    Aircraft_Ingest.add(cruiseSpeed: cruiseSpeed, &fbb)
    Aircraft_Ingest.add(maxSpeed: maxSpeed, &fbb)
    Aircraft_Ingest.add(minReqRunwayM: minReqRunwayM, &fbb)
    Aircraft_Ingest.add(minReqRunwayFt: minReqRunwayFt, &fbb)
    Aircraft_Ingest.add(nominalTatime: nominalTatime, &fbb)
    Aircraft_Ingest.add(notes: notes, &fbb)
    Aircraft_Ingest.add(createdAt: createdAt, &fbb)
    Aircraft_Ingest.add(createdBy: createdBy, &fbb)
    Aircraft_Ingest.add(sourceDl: sourceDl, &fbb)
    Aircraft_Ingest.add(source: source, &fbb)
    Aircraft_Ingest.add(origin: origin, &fbb)
    Aircraft_Ingest.add(dataMode: dataMode, &fbb)
    Aircraft_Ingest.add(origNetwork: origNetwork, &fbb)
    return Aircraft_Ingest.endAircraft_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Aircraft_Ingest_dataMode_Enum.self)
