...
public struct FlightPlanWaypoints_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: FlightPlanWaypoints_Ingest.id, addPrefix: prefix) }
  ...
  public static func startFlightPlanWaypoints_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 56) }
  ...
  public static func endFlightPlanWaypoints_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createFlightPlanWaypoints_Ingest(
    ...
    let __start = FlightPlanWaypoints_Ingest.startFlightPlanWaypoints_Ingest(&fbb)
    FlightPlanWaypoints_Ingest.add(type: type, &fbb)
    FlightPlanWaypoints_Ingest.add(waypointName: waypointName, &fbb)
    FlightPlanWaypoints_Ingest.add(waypointNum: waypointNum, &fbb)
    FlightPlanWaypoints_Ingest.add(airway: airway, &fbb)
    FlightPlanWaypoints_Ingest.add(arpt: arpt, &fbb)
    FlightPlanWaypoints_Ingest.add(lat: lat, &fbb)
    FlightPlanWaypoints_Ingest.add(lon: lon, &fbb)
    FlightPlanWaypoints_Ingest.add(arId: arId, &fbb)
    FlightPlanWaypoints_Ingest.add(navaid: navaid, &fbb)
    FlightPlanWaypoints_Ingest.add(tacanChannel: tacanChannel, &fbb)
    FlightPlanWaypoints_Ingest.add(vorFreq: vorFreq, &fbb)
    FlightPlanWaypoints_Ingest.add(turbCat: turbCat, &fbb)
    FlightPlanWaypoints_Ingest.add(iceCat: iceCat, &fbb)
    FlightPlanWaypoints_Ingest.add(thunderCat: thunderCat, &fbb)
    FlightPlanWaypoints_Ingest.add(alt: alt, &fbb)
    FlightPlanWaypoints_Ingest.add(tempDev: tempDev, &fbb)
    FlightPlanWaypoints_Ingest.add(legFuelDegrade: legFuelDegrade, &fbb)
    FlightPlanWaypoints_Ingest.add(legMach: legMach, &fbb)
    FlightPlanWaypoints_Ingest.add(legMsnIndex: legMsnIndex, &fbb)
    FlightPlanWaypoints_Ingest.add(legDragIndex: legDragIndex, &fbb)
    FlightPlanWaypoints_Ingest.add(avgCalAirspeed: avgCalAirspeed, &fbb)
    FlightPlanWaypoints_Ingest.add(avgTrueAirspeed: avgTrueAirspeed, &fbb)
    FlightPlanWaypoints_Ingest.add(avgGroundSpeed: avgGroundSpeed, &fbb)
    FlightPlanWaypoints_Ingest.add(priFreq: priFreq, &fbb)
    FlightPlanWaypoints_Ingest.add(pointWindDir: pointWindDir, &fbb)
    FlightPlanWaypoints_Ingest.add(pointWindSpeed: pointWindSpeed, &fbb)
    FlightPlanWaypoints_Ingest.add(avgWindDir: avgWindDir, &fbb)
    FlightPlanWaypoints_Ingest.add(avgWindSpeed: avgWindSpeed, &fbb)
    FlightPlanWaypoints_Ingest.add(legWindFac: legWindFac, &fbb)
    FlightPlanWaypoints_Ingest.add(avgDriftAng: avgDriftAng, &fbb)
    FlightPlanWaypoints_Ingest.add(secFreq: secFreq, &fbb)
    FlightPlanWaypoints_Ingest.add(magCourse: magCourse, &fbb)
    FlightPlanWaypoints_Ingest.add(trueCourse: trueCourse, &fbb)
    FlightPlanWaypoints_Ingest.add(magHeading: magHeading, &fbb)
    FlightPlanWaypoints_Ingest.add(aaTacanChannel: aaTacanChannel, &fbb)
    FlightPlanWaypoints_Ingest.add(zoneDistance: zoneDistance, &fbb)
    FlightPlanWaypoints_Ingest.add(totalFlownDistance: totalFlownDistance, &fbb)
    FlightPlanWaypoints_Ingest.add(totalRemDistance: totalRemDistance, &fbb)
    FlightPlanWaypoints_Ingest.add(zoneTime: zoneTime, &fbb)
    FlightPlanWaypoints_Ingest.add(totalTime: totalTime, &fbb)
    FlightPlanWaypoints_Ingest.add(totalTimeRem: totalTimeRem, &fbb)
    FlightPlanWaypoints_Ingest.add(zoneFuel: zoneFuel, &fbb)
    FlightPlanWaypoints_Ingest.add(totalUsedFuel: totalUsedFuel, &fbb)
    FlightPlanWaypoints_Ingest.add(totalRemFuel: totalRemFuel, &fbb)
    FlightPlanWaypoints_Ingest.add(exchangedFuel: exchangedFuel, &fbb)
    FlightPlanWaypoints_Ingest.add(airDistance: airDistance, &fbb)
    FlightPlanWaypoints_Ingest.add(totalAirDistance: totalAirDistance, &fbb)
    FlightPlanWaypoints_Ingest.add(totalWeight: totalWeight, &fbb)
    FlightPlanWaypoints_Ingest.add(eta: eta, &fbb)
    FlightPlanWaypoints_Ingest.add(ata: ata, &fbb)
    FlightPlanWaypoints_Ingest.add(fuelFlow: fuelFlow, &fbb)
    FlightPlanWaypoints_Ingest.add(legAlternate: legAlternate, &fbb)
    FlightPlanWaypoints_Ingest.add(magVar: magVar, &fbb)
    FlightPlanWaypoints_Ingest.add(dayLowAlt: dayLowAlt, &fbb)
    FlightPlanWaypoints_Ingest.add(nightLowAlt: nightLowAlt, &fbb)
    FlightPlanWaypoints_Ingest.add(nvgLowAlt: nvgLowAlt, &fbb)
    return FlightPlanWaypoints_Ingest.endFlightPlanWaypoints_Ingest(&fbb, start: __start)
  }
