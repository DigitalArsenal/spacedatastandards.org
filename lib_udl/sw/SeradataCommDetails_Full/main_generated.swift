...
public enum SeradataCommDetails_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SeradataCommDetails_Full_dataMode_Enum { return .exercise }
  public static var min: SeradataCommDetails_Full_dataMode_Enum { return .real }
}


///  /// Seradata-compiled information on communications payloads.
public struct SeradataCommDetails_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SeradataCommDetails_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SeradataCommDetails_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SeradataCommDetails_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startSeradataCommDetails_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 39) }
  ...
  public static func add(dataMode: SeradataCommDetails_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endSeradataCommDetails_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSeradataCommDetails_Full(
    ...
    let __start = SeradataCommDetails_Full.startSeradataCommDetails_Full(&fbb)
    SeradataCommDetails_Full.add(id: id, &fbb)
    SeradataCommDetails_Full.add(idComm: idComm, &fbb)
    SeradataCommDetails_Full.add(classificationMarking: classificationMarking, &fbb)
    SeradataCommDetails_Full.add(spacecraftId: spacecraftId, &fbb)
    SeradataCommDetails_Full.add(band: band, &fbb)
    SeradataCommDetails_Full.add(solidStatePowerAmp: solidStatePowerAmp, &fbb)
    SeradataCommDetails_Full.add(travelingWaveTubeAmplifier: travelingWaveTubeAmplifier, &fbb)
    SeradataCommDetails_Full.add(gatewayUplinkFrom: gatewayUplinkFrom, &fbb)
    SeradataCommDetails_Full.add(gatewayUplinkTo: gatewayUplinkTo, &fbb)
    SeradataCommDetails_Full.add(gatewayDownlinkFrom: gatewayDownlinkFrom, &fbb)
    SeradataCommDetails_Full.add(gatewayDownlinkTo: gatewayDownlinkTo, &fbb)
    SeradataCommDetails_Full.add(polarization: polarization, &fbb)
    SeradataCommDetails_Full.add(eirp: eirp, &fbb)
    SeradataCommDetails_Full.add(bandwidth: bandwidth, &fbb)
    SeradataCommDetails_Full.add(numOperationalTransponders: numOperationalTransponders, &fbb)
    SeradataCommDetails_Full.add(numSpareTransponders: numSpareTransponders, &fbb)
    SeradataCommDetails_Full.add(hostedForCompanyOrgId: hostedForCompanyOrgId, &fbb)
    SeradataCommDetails_Full.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    SeradataCommDetails_Full.add(tradeLeaseOrgId: tradeLeaseOrgId, &fbb)
    SeradataCommDetails_Full.add(num36MhzEquivalentTransponders: num36MhzEquivalentTransponders, &fbb)
    SeradataCommDetails_Full.add(htsNumUserSpotBeams: htsNumUserSpotBeams, &fbb)
    SeradataCommDetails_Full.add(htsUserDownlinkBandwidthPerBeam: htsUserDownlinkBandwidthPerBeam, &fbb)
    SeradataCommDetails_Full.add(htsUserUplinkBandwidthPerBeam: htsUserUplinkBandwidthPerBeam, &fbb)
    SeradataCommDetails_Full.add(estHtsTotalUserDownlinkBandwidthPerBeam: estHtsTotalUserDownlinkBandwidthPerBeam, &fbb)
    SeradataCommDetails_Full.add(estHtsTotalUserUplinkBandwidthPerBeam: estHtsTotalUserUplinkBandwidthPerBeam, &fbb)
    SeradataCommDetails_Full.add(estHtsTotalCapacity: estHtsTotalCapacity, &fbb)
    SeradataCommDetails_Full.add(userDownlinkFrom: userDownlinkFrom, &fbb)
    SeradataCommDetails_Full.add(userDownlinkTo: userDownlinkTo, &fbb)
    SeradataCommDetails_Full.add(userUplinkFrom: userUplinkFrom, &fbb)
    SeradataCommDetails_Full.add(userUplinkTo: userUplinkTo, &fbb)
    SeradataCommDetails_Full.add(payloadNotes: payloadNotes, &fbb)
    SeradataCommDetails_Full.add(source: source, &fbb)
    SeradataCommDetails_Full.add(origin: origin, &fbb)
    SeradataCommDetails_Full.add(origNetwork: origNetwork, &fbb)
    SeradataCommDetails_Full.add(dataMode: dataMode, &fbb)
    SeradataCommDetails_Full.add(createdAt: createdAt, &fbb)
    SeradataCommDetails_Full.add(createdBy: createdBy, &fbb)
    SeradataCommDetails_Full.add(updatedAt: updatedAt, &fbb)
    SeradataCommDetails_Full.add(updatedBy: updatedBy, &fbb)
    return SeradataCommDetails_Full.endSeradataCommDetails_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SeradataCommDetails_Full_dataMode_Enum.self)
