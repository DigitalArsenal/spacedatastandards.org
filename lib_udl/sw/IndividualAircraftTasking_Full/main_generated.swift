...
public struct IndividualAircraftTasking_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IndividualAircraftTasking_Full.id, addPrefix: prefix) }
  ...
  public static func startIndividualAircraftTasking_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 11) }
  ...
  public static func endIndividualAircraftTasking_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIndividualAircraftTasking_Full(
    ...
    let __start = IndividualAircraftTasking_Full.startIndividualAircraftTasking_Full(&fbb)
    IndividualAircraftTasking_Full.add(numAcft: numAcft, &fbb)
    IndividualAircraftTasking_Full.add(acftType: acftType, &fbb)
    IndividualAircraftTasking_Full.add(callSign: callSign, &fbb)
    IndividualAircraftTasking_Full.add(priConfigCode: priConfigCode, &fbb)
    IndividualAircraftTasking_Full.add(secConfigCode: secConfigCode, &fbb)
    IndividualAircraftTasking_Full.add(link16CallSign: link16CallSign, &fbb)
    IndividualAircraftTasking_Full.add(tacanChan: tacanChan, &fbb)
    IndividualAircraftTasking_Full.addVectorOf(juAddress: juAddress, &fbb)
    IndividualAircraftTasking_Full.add(iffSifMode1Code: iffSifMode1Code, &fbb)
    IndividualAircraftTasking_Full.add(iffSifMode2Code: iffSifMode2Code, &fbb)
    IndividualAircraftTasking_Full.add(iffSifMode3Code: iffSifMode3Code, &fbb)
    return IndividualAircraftTasking_Full.endIndividualAircraftTasking_Full(&fbb, start: __start)
  }
