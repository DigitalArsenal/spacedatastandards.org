...
public struct DataLinkRefPoints_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DataLinkRefPoints_Ingest.id, addPrefix: prefix) }
  ...
  public static func startDataLinkRefPoints_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 6) }
  ...
  public static func endDataLinkRefPoints_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDataLinkRefPoints_Ingest(
    ...
    let __start = DataLinkRefPoints_Ingest.startDataLinkRefPoints_Ingest(&fbb)
    DataLinkRefPoints_Ingest.add(refPointType: refPointType, &fbb)
    DataLinkRefPoints_Ingest.add(refDes: refDes, &fbb)
    DataLinkRefPoints_Ingest.add(refLocName: refLocName, &fbb)
    DataLinkRefPoints_Ingest.add(refLat: refLat, &fbb)
    DataLinkRefPoints_Ingest.add(refLon: refLon, &fbb)
    DataLinkRefPoints_Ingest.add(effEventTime: effEventTime, &fbb)
    return DataLinkRefPoints_Ingest.endDataLinkRefPoints_Ingest(&fbb, start: __start)
  }
