...
public struct NavalFlightOperations_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: NavalFlightOperations_Full.id, addPrefix: prefix) }
  ...
  public static func startNavalFlightOperations_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endNavalFlightOperations_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createNavalFlightOperations_Full(
    ...
    let __start = NavalFlightOperations_Full.startNavalFlightOperations_Full(&fbb)
    NavalFlightOperations_Full.add(shipName: shipName, &fbb)
    NavalFlightOperations_Full.add(fltOpStart: fltOpStart, &fbb)
    NavalFlightOperations_Full.add(fltOpStop: fltOpStop, &fbb)
    NavalFlightOperations_Full.addVectorOf(schdLaunchRcvyTime: schdLaunchRcvyTime, &fbb)
    return NavalFlightOperations_Full.endNavalFlightOperations_Full(&fbb, start: __start)
  }
