...
public enum IonoObservation_Abridged_transmitSensorType_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: IonoObservation_Abridged_transmitSensorType_Enum { return .static_ }
  public static var min: IonoObservation_Abridged_transmitSensorType_Enum { return .mobile }
}


public enum IonoObservation_Abridged_receiveSensorType_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: IonoObservation_Abridged_receiveSensorType_Enum { return .static_ }
  public static var min: IonoObservation_Abridged_receiveSensorType_Enum { return .mobile }
}


public enum IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum { return .geocentric_lat_long_radii_ }
  public static var min: IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum { return .j2000 }
}


public enum IonoObservation_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: IonoObservation_Abridged_dataMode_Enum { return .exercise }
  public static var min: IonoObservation_Abridged_dataMode_Enum { return .real }
}
...
public struct IonoObservation_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservation_Abridged.id, addPrefix: prefix) }
  ...
  public var transmitSensorType: IonoObservation_Abridged_transmitSensorType_Enum { let o = _accessor.offset(VTOFFSET.transmitSensorType.v); return o == 0 ? .mobile : IonoObservation_Abridged_transmitSensorType_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .mobile }
  ///  List of Geodetic Latitude, Longitude, and Altitude coordinates in km of the receiver. Coordinates List must always have 3 elements. Valid ranges are -90.0 to 90.0 for Latitude and -180.0 to 180.0 for Longitude. Altitude is in km and its value must be 0 or greater.
  ///  Example: /// Example: [[45.5, 179.3, 35.6], [-80.2, -20.5, 43.2]]
  ///  Constraints: No constraints specified.
  ...
  ///  Example: /// Example: Mobile
  ///  Constraints: Minimum length = 0, Maximum length = 16
  public var receiveSensorType: IonoObservation_Abridged_receiveSensorType_Enum { let o = _accessor.offset(VTOFFSET.receiveSensorType.v); return o == 0 ? .mobile : IonoObservation_Abridged_receiveSensorType_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .mobile }
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  ...
  public var antennaElementPositionCoordinateSystem: IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum { let o = _accessor.offset(VTOFFSET.antennaElementPositionCoordinateSystem.v); return o == 0 ? .j2000 : IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  ...
  public var dataMode: IonoObservation_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : IonoObservation_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startIonoObservation_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 108) }
  ...
  public static func add(transmitSensorType: IonoObservation_Abridged_transmitSensorType_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: transmitSensorType.rawValue, def: 0, at: VTOFFSET.transmitSensorType.p) }
  ...
  public static func add(receiveSensorType: IonoObservation_Abridged_receiveSensorType_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: receiveSensorType.rawValue, def: 0, at: VTOFFSET.receiveSensorType.p) }
  ...
  public static func add(antennaElementPositionCoordinateSystem: IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: antennaElementPositionCoordinateSystem.rawValue, def: 0, at: VTOFFSET.antennaElementPositionCoordinateSystem.p) }
  ...
  public static func add(dataMode: IonoObservation_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endIonoObservation_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservation_Abridged(
    ...
    let __start = IonoObservation_Abridged.startIonoObservation_Abridged(&fbb)
    IonoObservation_Abridged.add(id: id, &fbb)
    IonoObservation_Abridged.add(classificationMarking: classificationMarking, &fbb)
    IonoObservation_Abridged.add(idSensor: idSensor, &fbb)
    IonoObservation_Abridged.add(origSensorId: origSensorId, &fbb)
    IonoObservation_Abridged.add(system: system, &fbb)
    IonoObservation_Abridged.add(neProfileName: neProfileName, &fbb)
    IonoObservation_Abridged.add(neProfileVersion: neProfileVersion, &fbb)
    IonoObservation_Abridged.add(scalerInfo: scalerInfo, &fbb)
    IonoObservation_Abridged.add(densityProfile: densityProfile, &fbb)
    IonoObservation_Abridged.add(stationId: stationId, &fbb)
    IonoObservation_Abridged.add(startTimeUtc: startTimeUtc, &fbb)
    IonoObservation_Abridged.add(systemInfo: systemInfo, &fbb)
    IonoObservation_Abridged.add(systemNotes: systemNotes, &fbb)
    IonoObservation_Abridged.addVectorOf(transmitCoordinates: transmitCoordinates, &fbb)
    IonoObservation_Abridged.add(transmitSensorType: transmitSensorType, &fbb)
    IonoObservation_Abridged.addVectorOf(receiveCoordinates: receiveCoordinates, &fbb)
    IonoObservation_Abridged.add(receiveSensorType: receiveSensorType, &fbb)
    IonoObservation_Abridged.add(antennaElementPosition: antennaElementPosition, &fbb)
    IonoObservation_Abridged.add(antennaElementPositionCoordinateSystem: antennaElementPositionCoordinateSystem, &fbb)
    IonoObservation_Abridged.add(power: power, &fbb)
    IonoObservation_Abridged.add(range: range, &fbb)
    IonoObservation_Abridged.add(frequency: frequency, &fbb)
    IonoObservation_Abridged.add(polarization: polarization, &fbb)
    IonoObservation_Abridged.add(azimuth: azimuth, &fbb)
    IonoObservation_Abridged.add(elevation: elevation, &fbb)
    IonoObservation_Abridged.addVectorOf(restrictedFrequency: restrictedFrequency, &fbb)
    IonoObservation_Abridged.add(restrictedFrequencyNotes: restrictedFrequencyNotes, &fbb)
    IonoObservation_Abridged.add(doppler: doppler, &fbb)
    IonoObservation_Abridged.add(time: time, &fbb)
    IonoObservation_Abridged.add(stokes: stokes, &fbb)
    IonoObservation_Abridged.add(amplitude: amplitude, &fbb)
    IonoObservation_Abridged.add(phase: phase, &fbb)
    IonoObservation_Abridged.add(foF2: foF2, &fbb)
    IonoObservation_Abridged.add(foF1: foF1, &fbb)
    IonoObservation_Abridged.add(fxF2: fxF2, &fbb)
    IonoObservation_Abridged.add(fxF1: fxF1, &fbb)
    IonoObservation_Abridged.add(md: md, &fbb)
    IonoObservation_Abridged.add(luf: luf, &fbb)
    IonoObservation_Abridged.add(mufd: mufd, &fbb)
    IonoObservation_Abridged.add(fmin: fmin, &fbb)
    IonoObservation_Abridged.add(foEs: foEs, &fbb)
    IonoObservation_Abridged.add(fminF: fminF, &fbb)
    IonoObservation_Abridged.add(fminE: fminE, &fbb)
    IonoObservation_Abridged.add(foE: foE, &fbb)
    IonoObservation_Abridged.add(fxE: fxE, &fbb)
    IonoObservation_Abridged.add(fxI: fxI, &fbb)
    IonoObservation_Abridged.add(hprimeF: hprimeF, &fbb)
    IonoObservation_Abridged.add(hprimeF2: hprimeF2, &fbb)
    IonoObservation_Abridged.add(hprimeF1: hprimeF1, &fbb)
    IonoObservation_Abridged.add(hprimeE: hprimeE, &fbb)
    IonoObservation_Abridged.add(hprimeEs: hprimeEs, &fbb)
    IonoObservation_Abridged.add(zmE: zmE, &fbb)
    IonoObservation_Abridged.add(yE: yE, &fbb)
    IonoObservation_Abridged.add(qf: qf, &fbb)
    IonoObservation_Abridged.add(qe: qe, &fbb)
    IonoObservation_Abridged.add(downF: downF, &fbb)
    IonoObservation_Abridged.add(downE: downE, &fbb)
    IonoObservation_Abridged.add(downEs: downEs, &fbb)
    IonoObservation_Abridged.add(ff: ff, &fbb)
    IonoObservation_Abridged.add(fe: fe, &fbb)
    IonoObservation_Abridged.add(d: d, &fbb)
    IonoObservation_Abridged.add(fmuf: fmuf, &fbb)
    IonoObservation_Abridged.add(hprimefMuf: hprimefMuf, &fbb)
    IonoObservation_Abridged.add(deltafoF2: deltafoF2, &fbb)
    IonoObservation_Abridged.add(foEp: foEp, &fbb)
    IonoObservation_Abridged.add(fhprimeF: fhprimeF, &fbb)
    IonoObservation_Abridged.add(fhprimeF2: fhprimeF2, &fbb)
    IonoObservation_Abridged.add(foF1p: foF1p, &fbb)
    IonoObservation_Abridged.add(foF2p: foF2p, &fbb)
    IonoObservation_Abridged.add(hmF2: hmF2, &fbb)
    IonoObservation_Abridged.add(hmF1: hmF1, &fbb)
    IonoObservation_Abridged.add(hmE: hmE, &fbb)
    IonoObservation_Abridged.add(zhalfNm: zhalfNm, &fbb)
    IonoObservation_Abridged.add(fminEs: fminEs, &fbb)
    IonoObservation_Abridged.add(yF2: yF2, &fbb)
    IonoObservation_Abridged.add(yF1: yF1, &fbb)
    IonoObservation_Abridged.add(tec: tec, &fbb)
    IonoObservation_Abridged.add(scaleHeightF2Peak: scaleHeightF2Peak, &fbb)
    IonoObservation_Abridged.add(b0: b0, &fbb)
    IonoObservation_Abridged.add(b1: b1, &fbb)
    IonoObservation_Abridged.add(d1: d1, &fbb)
    IonoObservation_Abridged.add(foEa: foEa, &fbb)
    IonoObservation_Abridged.add(hprimeEa: hprimeEa, &fbb)
    IonoObservation_Abridged.add(foP: foP, &fbb)
    IonoObservation_Abridged.add(hprimeP: hprimeP, &fbb)
    IonoObservation_Abridged.add(fbEs: fbEs, &fbb)
    IonoObservation_Abridged.add(typeEs: typeEs, &fbb)
    IonoObservation_Abridged.addVectorOf(charAtts: charAtts, &fbb)
    IonoObservation_Abridged.addVectorOf(height: height, &fbb)
    IonoObservation_Abridged.addVectorOf(plasmaFrequency: plasmaFrequency, &fbb)
    IonoObservation_Abridged.addVectorOf(plasmaFrequencyUncertainty: plasmaFrequencyUncertainty, &fbb)
    IonoObservation_Abridged.addVectorOf(electronDensity: electronDensity, &fbb)
    IonoObservation_Abridged.addVectorOf(electronDensityUncertainty: electronDensityUncertainty, &fbb)
    IonoObservation_Abridged.addVectorOf(artistFlags: artistFlags, &fbb)
    IonoObservation_Abridged.add(traceGeneric: traceGeneric, &fbb)
    IonoObservation_Abridged.addVectorOf(tidPhaseSpeeds: tidPhaseSpeeds, &fbb)
    IonoObservation_Abridged.addVectorOf(tidAzimuth: tidAzimuth, &fbb)
    IonoObservation_Abridged.addVectorOf(tidPeriods: tidPeriods, &fbb)
    IonoObservation_Abridged.add(datum: datum, &fbb)
    IonoObservation_Abridged.add(platformName: platformName, &fbb)
    IonoObservation_Abridged.add(createdAt: createdAt, &fbb)
    IonoObservation_Abridged.add(createdBy: createdBy, &fbb)
    IonoObservation_Abridged.add(updatedAt: updatedAt, &fbb)
    IonoObservation_Abridged.add(updatedBy: updatedBy, &fbb)
    IonoObservation_Abridged.add(source: source, &fbb)
    IonoObservation_Abridged.add(origin: origin, &fbb)
    IonoObservation_Abridged.add(dataMode: dataMode, &fbb)
    IonoObservation_Abridged.add(origNetwork: origNetwork, &fbb)
    return IonoObservation_Abridged.endIonoObservation_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.transmitSensorType.p, fieldName: "transmitSensorType", required: false, type: IonoObservation_Abridged_transmitSensorType_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.receiveSensorType.p, fieldName: "receiveSensorType", required: false, type: IonoObservation_Abridged_receiveSensorType_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.antennaElementPositionCoordinateSystem.p, fieldName: "antennaElementPositionCoordinateSystem", required: false, type: IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: IonoObservation_Abridged_dataMode_Enum.self)
