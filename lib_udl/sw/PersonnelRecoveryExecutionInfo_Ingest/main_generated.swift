...
public struct PersonnelRecoveryExecutionInfo_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: PersonnelRecoveryExecutionInfo_Ingest.id, addPrefix: prefix) }
  ...
  public static func startPersonnelRecoveryExecutionInfo_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 7) }
  ...
  public static func endPersonnelRecoveryExecutionInfo_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPersonnelRecoveryExecutionInfo_Ingest(
    ...
    let __start = PersonnelRecoveryExecutionInfo_Ingest.startPersonnelRecoveryExecutionInfo_Ingest(&fbb)
    PersonnelRecoveryExecutionInfo_Ingest.addVectorOf(initialPoint: initialPoint, &fbb)
    PersonnelRecoveryExecutionInfo_Ingest.add(ingress: ingress, &fbb)
    PersonnelRecoveryExecutionInfo_Ingest.add(objStrategy: objStrategy, &fbb)
    PersonnelRecoveryExecutionInfo_Ingest.addVectorOf(egressPoint: egressPoint, &fbb)
    PersonnelRecoveryExecutionInfo_Ingest.add(egress: egress, &fbb)
    PersonnelRecoveryExecutionInfo_Ingest.add(recoveryVehicle: recoveryVehicle, &fbb)
    PersonnelRecoveryExecutionInfo_Ingest.add(escortVehicle: escortVehicle, &fbb)
    return PersonnelRecoveryExecutionInfo_Ingest.endPersonnelRecoveryExecutionInfo_Ingest(&fbb, start: __start)
  }
