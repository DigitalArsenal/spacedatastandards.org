...
public enum Status_Full_state_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Status_Full_state_Enum { return .standby }
  public static var min: Status_Full_state_Enum { return .unknown }
}


public enum Status_Full_sysCap_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: Status_Full_sysCap_Enum { return .unk }
  public static var min: Status_Full_sysCap_Enum { return .fmc }
}


public enum Status_Full_opsCap_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: Status_Full_opsCap_Enum { return .unk }
  public static var min: Status_Full_opsCap_Enum { return .fmc }
}


public enum Status_Full_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: Status_Full_dataMode_Enum { return .exercise }
  public static var min: Status_Full_dataMode_Enum { return .real }
}


///  /// Status for a particular Entity. An entity may have multiple status records collected by various sources.
public struct Status_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Status_Full.id, addPrefix: prefix) }
  ...
  public var state: Status_Full_state_Enum { let o = _accessor.offset(VTOFFSET.state.v); return o == 0 ? .unknown : Status_Full_state_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .unknown }
  ///  System capability of the entity, if applicable (e.g. FMC, NMC, PMC, UNK).
  ///  Example: /// Example: FMC
  ///  Constraints: Minimum length = 0, Maximum length = 3
  public var sysCap: Status_Full_sysCap_Enum { let o = _accessor.offset(VTOFFSET.sysCap.v); return o == 0 ? .fmc : Status_Full_sysCap_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .fmc }
  ///  Operation capability of the entity, if applicable (e.g. FMC, NMC, PMC, UNK).
  ///  Example: /// Example: FMC
  ///  Constraints: Minimum length = 0, Maximum length = 3
  public var opsCap: Status_Full_opsCap_Enum { let o = _accessor.offset(VTOFFSET.opsCap.v); return o == 0 ? .fmc : Status_Full_opsCap_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .fmc }
  ///  Source of the data.
  ...
  public var dataMode: Status_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Status_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startStatus_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 19) }
  ...
  public static func add(state: Status_Full_state_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: state.rawValue, def: 0, at: VTOFFSET.state.p) }
  public static func add(sysCap: Status_Full_sysCap_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: sysCap.rawValue, def: 0, at: VTOFFSET.sysCap.p) }
  public static func add(opsCap: Status_Full_opsCap_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: opsCap.rawValue, def: 0, at: VTOFFSET.opsCap.p) }
  ...
  public static func add(dataMode: Status_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endStatus_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createStatus_Full(
    ...
    let __start = Status_Full.startStatus_Full(&fbb)
    Status_Full.add(id: id, &fbb)
    Status_Full.add(classificationMarking: classificationMarking, &fbb)
    Status_Full.add(derivedFrom: derivedFrom, &fbb)
    Status_Full.add(declassificationDate: declassificationDate, &fbb)
    Status_Full.add(declassificationString: declassificationString, &fbb)
    Status_Full.add(idEntity: idEntity, &fbb)
    Status_Full.add(state: state, &fbb)
    Status_Full.add(sysCap: sysCap, &fbb)
    Status_Full.add(opsCap: opsCap, &fbb)
    Status_Full.add(source: source, &fbb)
    Status_Full.addVectorOf(subStatusCollection: subStatusCollection, &fbb)
    Status_Full.add(dataMode: dataMode, &fbb)
    Status_Full.add(notes: notes, &fbb)
    Status_Full.add(createdAt: createdAt, &fbb)
    Status_Full.add(createdBy: createdBy, &fbb)
    Status_Full.add(updatedAt: updatedAt, &fbb)
    Status_Full.add(updatedBy: updatedBy, &fbb)
    Status_Full.add(origin: origin, &fbb)
    Status_Full.add(origNetwork: origNetwork, &fbb)
    return Status_Full.endStatus_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.state.p, fieldName: "state", required: false, type: Status_Full_state_Enum.self)
    try _v.visit(field: VTOFFSET.sysCap.p, fieldName: "sysCap", required: false, type: Status_Full_sysCap_Enum.self)
    try _v.visit(field: VTOFFSET.opsCap.p, fieldName: "opsCap", required: false, type: Status_Full_opsCap_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Status_Full_dataMode_Enum.self)
