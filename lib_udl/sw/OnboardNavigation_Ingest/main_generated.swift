...
public enum OnboardNavigation_Ingest_referenceFrame_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OnboardNavigation_Ingest_referenceFrame_Enum { return .gcrf }
  public static var min: OnboardNavigation_Ingest_referenceFrame_Enum { return .j2000 }
}


public enum OnboardNavigation_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: OnboardNavigation_Ingest_dataMode_Enum { return .exercise }
  public static var min: OnboardNavigation_Ingest_dataMode_Enum { return .real }
}
...
public struct OnboardNavigation_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OnboardNavigation_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 24
  public var referenceFrame: OnboardNavigation_Ingest_referenceFrame_Enum { let o = _accessor.offset(VTOFFSET.referenceFrame.v); return o == 0 ? .j2000 : OnboardNavigation_Ingest_referenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 36
  public var dataMode: OnboardNavigation_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OnboardNavigation_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startOnboardNavigation_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 23) }
  ...
  public static func add(referenceFrame: OnboardNavigation_Ingest_referenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: referenceFrame.rawValue, def: 0, at: VTOFFSET.referenceFrame.p) }
  ...
  public static func add(dataMode: OnboardNavigation_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endOnboardNavigation_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnboardNavigation_Ingest(
    ...
    let __start = OnboardNavigation_Ingest.startOnboardNavigation_Ingest(&fbb)
    OnboardNavigation_Ingest.add(id: id, &fbb)
    OnboardNavigation_Ingest.add(classificationMarking: classificationMarking, &fbb)
    OnboardNavigation_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    OnboardNavigation_Ingest.add(satNo: satNo, &fbb)
    OnboardNavigation_Ingest.add(origObjectId: origObjectId, &fbb)
    OnboardNavigation_Ingest.add(startTime: startTime, &fbb)
    OnboardNavigation_Ingest.add(endTime: endTime, &fbb)
    OnboardNavigation_Ingest.add(esId: esId, &fbb)
    OnboardNavigation_Ingest.add(starCatName: starCatName, &fbb)
    OnboardNavigation_Ingest.add(starCatLoadTime: starCatLoadTime, &fbb)
    OnboardNavigation_Ingest.add(idStateVector: idStateVector, &fbb)
    OnboardNavigation_Ingest.addVectorOf(ts: ts, &fbb)
    OnboardNavigation_Ingest.add(referenceFrame: referenceFrame, &fbb)
    OnboardNavigation_Ingest.addVectorOf(sunSensor: sunSensor, &fbb)
    OnboardNavigation_Ingest.addVectorOf(mag: mag, &fbb)
    OnboardNavigation_Ingest.addVectorOf(starTracker: starTracker, &fbb)
    OnboardNavigation_Ingest.addVectorOf(deltaPos: deltaPos, &fbb)
    OnboardNavigation_Ingest.add(createdAt: createdAt, &fbb)
    OnboardNavigation_Ingest.add(createdBy: createdBy, &fbb)
    OnboardNavigation_Ingest.add(source: source, &fbb)
    OnboardNavigation_Ingest.add(origin: origin, &fbb)
    OnboardNavigation_Ingest.add(origNetwork: origNetwork, &fbb)
    OnboardNavigation_Ingest.add(dataMode: dataMode, &fbb)
    return OnboardNavigation_Ingest.endOnboardNavigation_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.referenceFrame.p, fieldName: "referenceFrame", required: false, type: OnboardNavigation_Ingest_referenceFrame_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OnboardNavigation_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
