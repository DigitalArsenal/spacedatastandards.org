...
public struct RelatedDocument_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: RelatedDocument_Ingest.id, addPrefix: prefix) }
  ...
  public static func startRelatedDocument_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 2) }
  ...
  public static func endRelatedDocument_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createRelatedDocument_Ingest(
    _ fbb: inout FlatBufferBuilder,
    documentIdOffset documentId: Offset = Offset(),
    dataSourceRefsVectorOffset dataSourceRefs: Offset = Offset()
  ) -> Offset {
    let __start = RelatedDocument_Ingest.startRelatedDocument_Ingest(&fbb)
    RelatedDocument_Ingest.add(documentId: documentId, &fbb)
    RelatedDocument_Ingest.addVectorOf(dataSourceRefs: dataSourceRefs, &fbb)
    return RelatedDocument_Ingest.endRelatedDocument_Ingest(&fbb, start: __start)
  }
