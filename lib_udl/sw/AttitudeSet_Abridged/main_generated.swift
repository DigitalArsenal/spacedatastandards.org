...
public enum AttitudeSet_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AttitudeSet_Abridged_dataMode_Enum { return .exercise }
  public static var min: AttitudeSet_Abridged_dataMode_Enum { return .real }
}
...
public struct AttitudeSet_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AttitudeSet_Abridged.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case numPoints = 30
    case stepSize = 32
    case precAngleInit = 34
    case spinAngleInit = 36
    case eulerRotSeq = 38
    case interpolator = 40
    case interpolatorDegree = 42
    case notes = 44
    case createdAt = 46
    case createdBy = 48
    case source = 50
  ...
  public var dataMode: AttitudeSet_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AttitudeSet_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startAttitudeSet_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 27) }
  ...
  public static func add(dataMode: AttitudeSet_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endAttitudeSet_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAttitudeSet_Abridged(
    ...
    let __start = AttitudeSet_Abridged.startAttitudeSet_Abridged(&fbb)
    AttitudeSet_Abridged.add(id: id, &fbb)
    AttitudeSet_Abridged.add(classificationMarking: classificationMarking, &fbb)
    AttitudeSet_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    AttitudeSet_Abridged.add(satNo: satNo, &fbb)
    AttitudeSet_Abridged.add(origObjectId: origObjectId, &fbb)
    AttitudeSet_Abridged.add(type: type, &fbb)
    AttitudeSet_Abridged.add(esId: esId, &fbb)
    AttitudeSet_Abridged.add(idSensor: idSensor, &fbb)
    AttitudeSet_Abridged.add(origSensorId: origSensorId, &fbb)
    AttitudeSet_Abridged.add(startTime: startTime, &fbb)
    AttitudeSet_Abridged.add(endTime: endTime, &fbb)
    AttitudeSet_Abridged.add(frame1: frame1, &fbb)
    AttitudeSet_Abridged.add(frame2: frame2, &fbb)
    AttitudeSet_Abridged.add(numPoints: numPoints, &fbb)
    AttitudeSet_Abridged.add(stepSize: stepSize, &fbb)
    AttitudeSet_Abridged.add(precAngleInit: precAngleInit, &fbb)
    AttitudeSet_Abridged.add(spinAngleInit: spinAngleInit, &fbb)
    AttitudeSet_Abridged.add(eulerRotSeq: eulerRotSeq, &fbb)
    AttitudeSet_Abridged.add(interpolator: interpolator, &fbb)
    AttitudeSet_Abridged.add(interpolatorDegree: interpolatorDegree, &fbb)
    AttitudeSet_Abridged.add(notes: notes, &fbb)
    AttitudeSet_Abridged.add(createdAt: createdAt, &fbb)
    AttitudeSet_Abridged.add(createdBy: createdBy, &fbb)
    AttitudeSet_Abridged.add(source: source, &fbb)
    AttitudeSet_Abridged.add(origin: origin, &fbb)
    AttitudeSet_Abridged.add(dataMode: dataMode, &fbb)
    AttitudeSet_Abridged.add(origNetwork: origNetwork, &fbb)
    return AttitudeSet_Abridged.endAttitudeSet_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AttitudeSet_Abridged_dataMode_Enum.self)
