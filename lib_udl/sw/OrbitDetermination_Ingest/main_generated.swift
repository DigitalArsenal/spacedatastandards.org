...
public enum OrbitDetermination_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OrbitDetermination_Ingest_dataMode_Enum { return .exercise }
  public static var min: OrbitDetermination_Ingest_dataMode_Enum { return .real }
}
...
public struct OrbitDetermination_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OrbitDetermination_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: OrbitDetermination_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OrbitDetermination_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startOrbitDetermination_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 44) }
  ...
  public static func add(dataMode: OrbitDetermination_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endOrbitDetermination_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOrbitDetermination_Ingest(
    ...
    let __start = OrbitDetermination_Ingest.startOrbitDetermination_Ingest(&fbb)
    OrbitDetermination_Ingest.add(id: id, &fbb)
    OrbitDetermination_Ingest.add(classificationMarking: classificationMarking, &fbb)
    OrbitDetermination_Ingest.add(startTime: startTime, &fbb)
    OrbitDetermination_Ingest.add(endTime: endTime, &fbb)
    OrbitDetermination_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    OrbitDetermination_Ingest.add(origObjectId: origObjectId, &fbb)
    OrbitDetermination_Ingest.add(satNo: satNo, &fbb)
    OrbitDetermination_Ingest.add(aprioriIdElset: aprioriIdElset, &fbb)
    OrbitDetermination_Ingest.add(aprioriElset: aprioriElset, &fbb)
    OrbitDetermination_Ingest.add(aprioriIdStateVector: aprioriIdStateVector, &fbb)
    OrbitDetermination_Ingest.add(aprioriStateVector: aprioriStateVector, &fbb)
    OrbitDetermination_Ingest.add(initialOd: initialOd, &fbb)
    OrbitDetermination_Ingest.add(lastObStart: lastObStart, &fbb)
    OrbitDetermination_Ingest.add(lastObEnd: lastObEnd, &fbb)
    OrbitDetermination_Ingest.add(timeSpan: timeSpan, &fbb)
    OrbitDetermination_Ingest.add(effectiveFrom: effectiveFrom, &fbb)
    OrbitDetermination_Ingest.add(effectiveUntil: effectiveUntil, &fbb)
    OrbitDetermination_Ingest.add(wrms: wrms, &fbb)
    OrbitDetermination_Ingest.add(previousWrms: previousWrms, &fbb)
    OrbitDetermination_Ingest.add(firstPassWrms: firstPassWrms, &fbb)
    OrbitDetermination_Ingest.add(bestPassWrms: bestPassWrms, &fbb)
    OrbitDetermination_Ingest.add(errorGrowthRate: errorGrowthRate, &fbb)
    OrbitDetermination_Ingest.add(edr: edr, &fbb)
    OrbitDetermination_Ingest.add(method: method, &fbb)
    OrbitDetermination_Ingest.add(methodSource: methodSource, &fbb)
    OrbitDetermination_Ingest.add(fitSpan: fitSpan, &fbb)
    OrbitDetermination_Ingest.add(ballisticCoeffEst: ballisticCoeffEst, &fbb)
    OrbitDetermination_Ingest.add(ballisticCoeffModel: ballisticCoeffModel, &fbb)
    OrbitDetermination_Ingest.add(agomEst: agomEst, &fbb)
    OrbitDetermination_Ingest.add(agomModel: agomModel, &fbb)
    OrbitDetermination_Ingest.add(rmsConvergenceCriteria: rmsConvergenceCriteria, &fbb)
    OrbitDetermination_Ingest.add(numIterations: numIterations, &fbb)
    OrbitDetermination_Ingest.addVectorOf(acceptedObTyps: acceptedObTyps, &fbb)
    OrbitDetermination_Ingest.addVectorOf(acceptedObIds: acceptedObIds, &fbb)
    OrbitDetermination_Ingest.addVectorOf(rejectedObTyps: rejectedObTyps, &fbb)
    OrbitDetermination_Ingest.addVectorOf(rejectedObIds: rejectedObIds, &fbb)
    OrbitDetermination_Ingest.addVectorOf(sensorIds: sensorIds, &fbb)
    OrbitDetermination_Ingest.add(createdAt: createdAt, &fbb)
    OrbitDetermination_Ingest.add(createdBy: createdBy, &fbb)
    OrbitDetermination_Ingest.add(sourceDl: sourceDl, &fbb)
    OrbitDetermination_Ingest.add(source: source, &fbb)
    OrbitDetermination_Ingest.add(origin: origin, &fbb)
    OrbitDetermination_Ingest.add(origNetwork: origNetwork, &fbb)
    OrbitDetermination_Ingest.add(dataMode: dataMode, &fbb)
    return OrbitDetermination_Ingest.endOrbitDetermination_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OrbitDetermination_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
