...
public enum EffectResponse_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: EffectResponse_Abridged_dataMode_Enum { return .exercise }
  public static var min: EffectResponse_Abridged_dataMode_Enum { return .real }
}


///  /// A response for various effects on a target.
public struct EffectResponse_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EffectResponse_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: EffectResponse_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : EffectResponse_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startEffectResponse_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 25) }
  ...
  public static func add(dataMode: EffectResponse_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endEffectResponse_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEffectResponse_Abridged(
    ...
    let __start = EffectResponse_Abridged.startEffectResponse_Abridged(&fbb)
    EffectResponse_Abridged.add(id: id, &fbb)
    EffectResponse_Abridged.add(classificationMarking: classificationMarking, &fbb)
    EffectResponse_Abridged.add(idEffectRequest: idEffectRequest, &fbb)
    EffectResponse_Abridged.add(externalRequestId: externalRequestId, &fbb)
    EffectResponse_Abridged.add(type: type, &fbb)
    EffectResponse_Abridged.add(actorSrcType: actorSrcType, &fbb)
    EffectResponse_Abridged.add(actorSrcId: actorSrcId, &fbb)
    EffectResponse_Abridged.add(munitionType: munitionType, &fbb)
    EffectResponse_Abridged.add(munitionId: munitionId, &fbb)
    EffectResponse_Abridged.add(shotsRequired: shotsRequired, &fbb)
    EffectResponse_Abridged.add(probabilityOfKill: probabilityOfKill, &fbb)
    EffectResponse_Abridged.add(collateralDamageEst: collateralDamageEst, &fbb)
    EffectResponse_Abridged.addVectorOf(actionsList: actionsList, &fbb)
    EffectResponse_Abridged.addVectorOf(externalActions: externalActions, &fbb)
    EffectResponse_Abridged.addVectorOf(coaMetrics: coaMetrics, &fbb)
    EffectResponse_Abridged.add(redTimeToOverhead: redTimeToOverhead, &fbb)
    EffectResponse_Abridged.add(decisionDeadline: decisionDeadline, &fbb)
    EffectResponse_Abridged.add(redTargetSrcType: redTargetSrcType, &fbb)
    EffectResponse_Abridged.add(redTargetSrcId: redTargetSrcId, &fbb)
    EffectResponse_Abridged.add(createdAt: createdAt, &fbb)
    EffectResponse_Abridged.add(createdBy: createdBy, &fbb)
    EffectResponse_Abridged.add(source: source, &fbb)
    EffectResponse_Abridged.add(origin: origin, &fbb)
    EffectResponse_Abridged.add(dataMode: dataMode, &fbb)
    EffectResponse_Abridged.add(origNetwork: origNetwork, &fbb)
    return EffectResponse_Abridged.endEffectResponse_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: EffectResponse_Abridged_dataMode_Enum.self)
