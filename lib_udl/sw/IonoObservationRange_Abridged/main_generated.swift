...
public struct IonoObservationRange_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationRange_Abridged.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationRange_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationRange_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationRange_Abridged(
    ...
    let __start = IonoObservationRange_Abridged.startIonoObservationRange_Abridged(&fbb)
    IonoObservationRange_Abridged.add(notes: notes, &fbb)
    IonoObservationRange_Abridged.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationRange_Abridged.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationRange_Abridged.addVectorOf(data: data, &fbb)
    return IonoObservationRange_Abridged.endIonoObservationRange_Abridged(&fbb, start: __start)
  }
