...
public enum Track_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Track_Abridged_dataMode_Enum { return .exercise }
  public static var min: Track_Abridged_dataMode_Enum { return .real }
}
...
public struct Track_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Track_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: Track_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Track_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startTrack_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 68) }
  ...
  public static func add(dataMode: Track_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endTrack_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createTrack_Abridged(
    ...
    let __start = Track_Abridged.startTrack_Abridged(&fbb)
    Track_Abridged.add(id: id, &fbb)
    Track_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Track_Abridged.add(cntct: cntct, &fbb)
    Track_Abridged.add(createdAt: createdAt, &fbb)
    Track_Abridged.add(createdBy: createdBy, &fbb)
    Track_Abridged.add(msgTs: msgTs, &fbb)
    Track_Abridged.add(msnId: msnId, &fbb)
    Track_Abridged.add(assetNat: assetNat, &fbb)
    Track_Abridged.add(asset: asset, &fbb)
    Track_Abridged.add(sen: sen, &fbb)
    Track_Abridged.add(senQual: senQual, &fbb)
    Track_Abridged.add(trkId: trkId, &fbb)
    Track_Abridged.add(trkNum: trkNum, &fbb)
    Track_Abridged.add(trkStat: trkStat, &fbb)
    Track_Abridged.add(objNat: objNat, &fbb)
    Track_Abridged.add(objId: objId, &fbb)
    Track_Abridged.add(objType: objType, &fbb)
    Track_Abridged.add(objSpec: objSpec, &fbb)
    Track_Abridged.add(objPlat: objPlat, &fbb)
    Track_Abridged.add(objAct: objAct, &fbb)
    Track_Abridged.add(modType: modType, &fbb)
    Track_Abridged.add(trkItmId: trkItmId, &fbb)
    Track_Abridged.add(ts: ts, &fbb)
    Track_Abridged.add(trkQual: trkQual, &fbb)
    Track_Abridged.add(trkPtType: trkPtType, &fbb)
    Track_Abridged.add(objIdent: objIdent, &fbb)
    Track_Abridged.add(identCred: identCred, &fbb)
    Track_Abridged.add(identRel: identRel, &fbb)
    Track_Abridged.add(identAmp: identAmp, &fbb)
    Track_Abridged.add(env: env, &fbb)
    Track_Abridged.add(envConf: envConf, &fbb)
    Track_Abridged.add(trkConf: trkConf, &fbb)
    Track_Abridged.addVectorOf(ecefPos: ecefPos, &fbb)
    Track_Abridged.addVectorOf(ecefVel: ecefVel, &fbb)
    Track_Abridged.addVectorOf(ecefAcc: ecefAcc, &fbb)
    Track_Abridged.add(lat: lat, &fbb)
    Track_Abridged.add(lon: lon, &fbb)
    Track_Abridged.add(alt: alt, &fbb)
    Track_Abridged.add(spd: spd, &fbb)
    Track_Abridged.add(hdng: hdng, &fbb)
    Track_Abridged.add(course: course, &fbb)
    Track_Abridged.addVectorOf(lco: lco, &fbb)
    Track_Abridged.addVectorOf(lcs: lcs, &fbb)
    Track_Abridged.addVectorOf(lcPos: lcPos, &fbb)
    Track_Abridged.addVectorOf(lcVel: lcVel, &fbb)
    Track_Abridged.addVectorOf(lcAcc: lcAcc, &fbb)
    Track_Abridged.addVectorOf(eNuvel: eNuvel, &fbb)
    Track_Abridged.addVectorOf(eNupos: eNupos, &fbb)
    Track_Abridged.addVectorOf(cov: cov, &fbb)
    Track_Abridged.addVectorOf(errEllp: errEllp, &fbb)
    Track_Abridged.addVectorOf(srcTyps: srcTyps, &fbb)
    Track_Abridged.addVectorOf(srcIds: srcIds, &fbb)
    Track_Abridged.add(callSign: callSign, &fbb)
    Track_Abridged.add(multiSource: multiSource, &fbb)
    Track_Abridged.add(jSeries: jSeries, &fbb)
    Track_Abridged.add(strength: strength, &fbb)
    Track_Abridged.add(m1: m1, &fbb)
    Track_Abridged.add(m1v: m1v, &fbb)
    Track_Abridged.add(m2: m2, &fbb)
    Track_Abridged.add(m2v: m2v, &fbb)
    Track_Abridged.add(m3a: m3a, &fbb)
    Track_Abridged.add(m3av: m3av, &fbb)
    Track_Abridged.addVectorOf(tags: tags, &fbb)
    Track_Abridged.add(sourceDl: sourceDl, &fbb)
    Track_Abridged.add(source: source, &fbb)
    Track_Abridged.add(origin: origin, &fbb)
    Track_Abridged.add(dataMode: dataMode, &fbb)
    Track_Abridged.add(origNetwork: origNetwork, &fbb)
    return Track_Abridged.endTrack_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Track_Abridged_dataMode_Enum.self)
