...
public enum Conjunction_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Conjunction_Full_dataMode_Enum { return .exercise }
  public static var min: Conjunction_Full_dataMode_Enum { return .real }
}


///  /// Stores the results of a particular Conjunction Assessment (CA) run.
public struct Conjunction_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Conjunction_Full.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case onOrbit1 = 136
    case onOrbit2 = 138
    case origIdOnOrbit1 = 140
    case origIdOnOrbit2 = 142
  ...
  public var dataMode: Conjunction_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Conjunction_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  public var onOrbit1: String? { let o = _accessor.offset(VTOFFSET.onOrbit1.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var onOrbit1SegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.onOrbit1.v) }
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  public var onOrbit2: String? { let o = _accessor.offset(VTOFFSET.onOrbit2.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var onOrbit2SegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.onOrbit2.v) }
  ...
  public static func startConjunction_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 71) }
  ...
  public static func add(dataMode: Conjunction_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func add(onOrbit1: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: onOrbit1, at: VTOFFSET.onOrbit1.p) }
  public static func add(onOrbit2: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: onOrbit2, at: VTOFFSET.onOrbit2.p) }
  ...
  public static func endConjunction_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createConjunction_Full(
    ...
    satNo1: Int32 = 0,
    satNo2: Int32 = 0,
    onOrbit1Offset onOrbit1: Offset = Offset(),
    onOrbit2Offset onOrbit2: Offset = Offset(),
    origIdOnOrbit1Offset origIdOnOrbit1: Offset = Offset(),
    origIdOnOrbit2Offset origIdOnOrbit2: Offset = Offset(),
    origNetworkOffset origNetwork: Offset = Offset()
  ) -> Offset {
    let __start = Conjunction_Full.startConjunction_Full(&fbb)
    Conjunction_Full.add(id: id, &fbb)
    Conjunction_Full.add(classificationMarking: classificationMarking, &fbb)
    Conjunction_Full.add(idOnOrbit1: idOnOrbit1, &fbb)
    Conjunction_Full.add(idOnOrbit2: idOnOrbit2, &fbb)
    Conjunction_Full.add(type: type, &fbb)
    Conjunction_Full.add(tca: tca, &fbb)
    Conjunction_Full.add(missDistance: missDistance, &fbb)
    Conjunction_Full.add(collisionProb: collisionProb, &fbb)
    Conjunction_Full.add(collisionProbMethod: collisionProbMethod, &fbb)
    Conjunction_Full.add(ephemName1: ephemName1, &fbb)
    Conjunction_Full.add(esId1: esId1, &fbb)
    Conjunction_Full.add(ephemName2: ephemName2, &fbb)
    Conjunction_Full.add(esId2: esId2, &fbb)
    Conjunction_Full.add(relPosR: relPosR, &fbb)
    Conjunction_Full.add(relPosT: relPosT, &fbb)
    Conjunction_Full.add(relPosN: relPosN, &fbb)
    Conjunction_Full.add(relVelMag: relVelMag, &fbb)
    Conjunction_Full.add(relVelR: relVelR, &fbb)
    Conjunction_Full.add(relVelT: relVelT, &fbb)
    Conjunction_Full.add(relVelN: relVelN, &fbb)
    Conjunction_Full.add(screenEntryTime: screenEntryTime, &fbb)
    Conjunction_Full.add(screenExitTime: screenExitTime, &fbb)
    Conjunction_Full.add(screenVolumeX: screenVolumeX, &fbb)
    Conjunction_Full.add(screenVolumeY: screenVolumeY, &fbb)
    Conjunction_Full.add(screenVolumeZ: screenVolumeZ, &fbb)
    Conjunction_Full.add(volShape: volShape, &fbb)
    Conjunction_Full.add(volEntryTime: volEntryTime, &fbb)
    Conjunction_Full.add(volExitTime: volExitTime, &fbb)
    Conjunction_Full.add(penetrationLevelSigma: penetrationLevelSigma, &fbb)
    Conjunction_Full.add(idStateVector1: idStateVector1, &fbb)
    Conjunction_Full.add(lastObTime1: lastObTime1, &fbb)
    Conjunction_Full.add(cdAoM1: cdAoM1, &fbb)
    Conjunction_Full.add(crAoM1: crAoM1, &fbb)
    Conjunction_Full.add(thrustAccel1: thrustAccel1, &fbb)
    Conjunction_Full.add(idStateVector2: idStateVector2, &fbb)
    Conjunction_Full.add(lastObTime2: lastObTime2, &fbb)
    Conjunction_Full.add(cdAoM2: cdAoM2, &fbb)
    Conjunction_Full.add(crAoM2: crAoM2, &fbb)
    Conjunction_Full.add(thrustAccel2: thrustAccel2, &fbb)
    Conjunction_Full.add(comments: comments, &fbb)
    Conjunction_Full.add(ccir: ccir, &fbb)
    Conjunction_Full.add(concernNotes: concernNotes, &fbb)
    Conjunction_Full.add(stateDeptNotified: stateDeptNotified, &fbb)
    Conjunction_Full.add(ownerContacted: ownerContacted, &fbb)
    Conjunction_Full.add(rawFileUri: rawFileUri, &fbb)
    Conjunction_Full.add(messageFor: messageFor, &fbb)
    Conjunction_Full.add(messageId: messageId, &fbb)
    Conjunction_Full.add(uvwWarn: uvwWarn, &fbb)
    Conjunction_Full.add(smallRelVelWarning: smallRelVelWarning, &fbb)
    Conjunction_Full.add(largeRelPosWarning: largeRelPosWarning, &fbb)
    Conjunction_Full.add(smallCovWarning: smallCovWarning, &fbb)
    Conjunction_Full.add(largeCovWarning: largeCovWarning, &fbb)
    Conjunction_Full.add(transactionId: transactionId, &fbb)
    Conjunction_Full.add(source: source, &fbb)
    Conjunction_Full.add(origin: origin, &fbb)
    Conjunction_Full.add(originator: originator, &fbb)
    Conjunction_Full.add(eventId: eventId, &fbb)
    Conjunction_Full.add(descriptor: descriptor, &fbb)
    Conjunction_Full.addVectorOf(tags: tags, &fbb)
    Conjunction_Full.add(dataMode: dataMode, &fbb)
    Conjunction_Full.add(createdAt: createdAt, &fbb)
    Conjunction_Full.add(createdBy: createdBy, &fbb)
    Conjunction_Full.add(stateVector1: stateVector1, &fbb)
    Conjunction_Full.add(stateVector2: stateVector2, &fbb)
    Conjunction_Full.add(satNo1: satNo1, &fbb)
    Conjunction_Full.add(satNo2: satNo2, &fbb)
    Conjunction_Full.add(onOrbit1: onOrbit1, &fbb)
    Conjunction_Full.add(onOrbit2: onOrbit2, &fbb)
    Conjunction_Full.add(origIdOnOrbit1: origIdOnOrbit1, &fbb)
    Conjunction_Full.add(origIdOnOrbit2: origIdOnOrbit2, &fbb)
    Conjunction_Full.add(origNetwork: origNetwork, &fbb)
    return Conjunction_Full.endConjunction_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Conjunction_Full_dataMode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.onOrbit1.p, fieldName: "onOrbit1", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.onOrbit2.p, fieldName: "onOrbit2", required: false, type: ForwardOffset<String>.self)
