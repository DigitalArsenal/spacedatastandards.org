...
public enum TrackDetails_Abridged_env_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: TrackDetails_Abridged_env_Enum { return .unknown }
  public static var min: TrackDetails_Abridged_env_Enum { return .air }
}


public enum TrackDetails_Abridged_objIdent_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: TrackDetails_Abridged_objIdent_Enum { return .unknown }
  public static var min: TrackDetails_Abridged_objIdent_Enum { return .assumedFriend }
}


public enum TrackDetails_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: TrackDetails_Abridged_dataMode_Enum { return .exercise }
  public static var min: TrackDetails_Abridged_dataMode_Enum { return .real }
}
...
public struct TrackDetails_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: TrackDetails_Abridged.id, addPrefix: prefix) }
  ...
  public var env: TrackDetails_Abridged_env_Enum { let o = _accessor.offset(VTOFFSET.env.v); return o == 0 ? .air : TrackDetails_Abridged_env_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .air }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 32
  public var objIdent: TrackDetails_Abridged_objIdent_Enum { let o = _accessor.offset(VTOFFSET.objIdent.v); return o == 0 ? .assumedFriend : TrackDetails_Abridged_objIdent_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .assumedFriend }
  ...
  public var dataMode: TrackDetails_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : TrackDetails_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 0, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startTrackDetails_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 158) }
  public static func add(id: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: id, at: VTOFFSET.id.p) }
  public static func add(classificationMarking: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: classificationMarking, at: VTOFFSET.classificationMarking.p) }
  public static func add(env: TrackDetails_Abridged_env_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: env.rawValue, def: 0, at: VTOFFSET.env.p) }
  ...
  public static func add(objIdent: TrackDetails_Abridged_objIdent_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: objIdent.rawValue, def: 0, at: VTOFFSET.objIdent.p) }
  ...
  public static func add(dataMode: TrackDetails_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endTrackDetails_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createTrackDetails_Abridged(
    ...
    objIdent: TrackDetails_Abridged_objIdent_Enum = .assumedFriend,
    ...
    let __start = TrackDetails_Abridged.startTrackDetails_Abridged(&fbb)
    TrackDetails_Abridged.add(id: id, &fbb)
    TrackDetails_Abridged.add(classificationMarking: classificationMarking, &fbb)
    TrackDetails_Abridged.add(env: env, &fbb)
    TrackDetails_Abridged.add(msgType: msgType, &fbb)
    TrackDetails_Abridged.add(hullNum: hullNum, &fbb)
    TrackDetails_Abridged.add(pif: pif, &fbb)
    TrackDetails_Abridged.add(sconum: sconum, &fbb)
    TrackDetails_Abridged.add(ntds: ntds, &fbb)
    TrackDetails_Abridged.add(disId: disId, &fbb)
    TrackDetails_Abridged.add(midbCat: midbCat, &fbb)
    TrackDetails_Abridged.add(beNumber: beNumber, &fbb)
    TrackDetails_Abridged.add(oSuffix: oSuffix, &fbb)
    TrackDetails_Abridged.add(pin: pin, &fbb)
    TrackDetails_Abridged.add(lostTrkInd: lostTrkInd, &fbb)
    TrackDetails_Abridged.add(muidSrcTrk: muidSrcTrk, &fbb)
    TrackDetails_Abridged.add(muidSrc: muidSrc, &fbb)
    TrackDetails_Abridged.add(mslStatus: mslStatus, &fbb)
    TrackDetails_Abridged.add(trkConf: trkConf, &fbb)
    TrackDetails_Abridged.add(trkQual: trkQual, &fbb)
    TrackDetails_Abridged.add(alert: alert, &fbb)
    TrackDetails_Abridged.add(origXref: origXref, &fbb)
    TrackDetails_Abridged.add(elnot1: elnot1, &fbb)
    TrackDetails_Abridged.add(elnot2: elnot2, &fbb)
    TrackDetails_Abridged.add(objIdent: objIdent, &fbb)
    TrackDetails_Abridged.add(objType: objType, &fbb)
    TrackDetails_Abridged.add(objPlat: objPlat, &fbb)
    TrackDetails_Abridged.add(objAct: objAct, &fbb)
    TrackDetails_Abridged.add(objNat: objNat, &fbb)
    TrackDetails_Abridged.add(name: name, &fbb)
    TrackDetails_Abridged.add(shortName: shortName, &fbb)
    TrackDetails_Abridged.add(trkId: trkId, &fbb)
    TrackDetails_Abridged.add(trkNum: trkNum, &fbb)
    TrackDetails_Abridged.add(trkScope: trkScope, &fbb)
    TrackDetails_Abridged.add(sourceUid: sourceUid, &fbb)
    TrackDetails_Abridged.add(callSign: callSign, &fbb)
    TrackDetails_Abridged.add(identAmp: identAmp, &fbb)
    TrackDetails_Abridged.add(spaceAmp: spaceAmp, &fbb)
    TrackDetails_Abridged.add(spaceAmpConf: spaceAmpConf, &fbb)
    TrackDetails_Abridged.add(spaceSpecType: spaceSpecType, &fbb)
    TrackDetails_Abridged.add(acftSubType: acftSubType, &fbb)
    TrackDetails_Abridged.add(ts: ts, &fbb)
    TrackDetails_Abridged.add(launchTime: launchTime, &fbb)
    TrackDetails_Abridged.add(impactTime: impactTime, &fbb)
    TrackDetails_Abridged.add(ftnMsgTs: ftnMsgTs, &fbb)
    TrackDetails_Abridged.add(ftn: ftn, &fbb)
    TrackDetails_Abridged.add(ftnCmd: ftnCmd, &fbb)
    TrackDetails_Abridged.addVectorOf(rtnMsgTs: rtnMsgTs, &fbb)
    TrackDetails_Abridged.addVectorOf(rtn: rtn, &fbb)
    TrackDetails_Abridged.add(rtnTrkState: rtnTrkState, &fbb)
    TrackDetails_Abridged.add(rtnCmd: rtnCmd, &fbb)
    TrackDetails_Abridged.add(sen: sen, &fbb)
    TrackDetails_Abridged.add(rptChxref: rptChxref, &fbb)
    TrackDetails_Abridged.add(rptArchived: rptArchived, &fbb)
    TrackDetails_Abridged.add(selfReport: selfReport, &fbb)
    TrackDetails_Abridged.add(mil2525Bstr: mil2525Bstr, &fbb)
    TrackDetails_Abridged.add(trnspdrId: trnspdrId, &fbb)
    TrackDetails_Abridged.add(trnspdrType: trnspdrType, &fbb)
    TrackDetails_Abridged.add(emitterName: emitterName, &fbb)
    TrackDetails_Abridged.add(infoSource: infoSource, &fbb)
    TrackDetails_Abridged.add(boosting: boosting, &fbb)
    TrackDetails_Abridged.add(freq: freq, &fbb)
    TrackDetails_Abridged.add(maxFreq: maxFreq, &fbb)
    TrackDetails_Abridged.add(harmonics: harmonics, &fbb)
    TrackDetails_Abridged.add(pri: pri, &fbb)
    TrackDetails_Abridged.add(prf: prf, &fbb)
    TrackDetails_Abridged.add(pw: pw, &fbb)
    TrackDetails_Abridged.add(scanType: scanType, &fbb)
    TrackDetails_Abridged.add(scanRate: scanRate, &fbb)
    TrackDetails_Abridged.add(scn: scn, &fbb)
    TrackDetails_Abridged.add(cI: cI, &fbb)
    TrackDetails_Abridged.add(angElev: angElev, &fbb)
    TrackDetails_Abridged.add(lat: lat, &fbb)
    TrackDetails_Abridged.add(lon: lon, &fbb)
    TrackDetails_Abridged.add(launchLat: launchLat, &fbb)
    TrackDetails_Abridged.add(launchLon: launchLon, &fbb)
    TrackDetails_Abridged.add(impactLat: impactLat, &fbb)
    TrackDetails_Abridged.add(impactLon: impactLon, &fbb)
    TrackDetails_Abridged.add(polarSingLocLat: polarSingLocLat, &fbb)
    TrackDetails_Abridged.add(polarSingLocLon: polarSingLocLon, &fbb)
    TrackDetails_Abridged.add(azCorrCenterLine: azCorrCenterLine, &fbb)
    TrackDetails_Abridged.add(azCorrArcWidth: azCorrArcWidth, &fbb)
    TrackDetails_Abridged.add(errSemiIntAxis: errSemiIntAxis, &fbb)
    TrackDetails_Abridged.add(errAreaOrient: errAreaOrient, &fbb)
    TrackDetails_Abridged.add(errSemiMajElev: errSemiMajElev, &fbb)
    TrackDetails_Abridged.add(errGeoAreaSwitch: errGeoAreaSwitch, &fbb)
    TrackDetails_Abridged.add(burnoutAlt: burnoutAlt, &fbb)
    TrackDetails_Abridged.add(tesEventId: tesEventId, &fbb)
    TrackDetails_Abridged.add(spd: spd, &fbb)
    TrackDetails_Abridged.add(avgSpd: avgSpd, &fbb)
    TrackDetails_Abridged.add(tol: tol, &fbb)
    TrackDetails_Abridged.add(alt: alt, &fbb)
    TrackDetails_Abridged.add(hdng: hdng, &fbb)
    TrackDetails_Abridged.add(course: course, &fbb)
    TrackDetails_Abridged.add(propRpm: propRpm, &fbb)
    TrackDetails_Abridged.add(tpk: tpk, &fbb)
    TrackDetails_Abridged.add(coopLocInd: coopLocInd, &fbb)
    TrackDetails_Abridged.add(maneuverInd: maneuverInd, &fbb)
    TrackDetails_Abridged.add(launchAouType: launchAouType, &fbb)
    TrackDetails_Abridged.addVectorOf(launchAouData: launchAouData, &fbb)
    TrackDetails_Abridged.add(impactAouType: impactAouType, &fbb)
    TrackDetails_Abridged.addVectorOf(impactAouData: impactAouData, &fbb)
    TrackDetails_Abridged.add(aouRptType: aouRptType, &fbb)
    TrackDetails_Abridged.addVectorOf(aouRptData: aouRptData, &fbb)
    TrackDetails_Abridged.addVectorOf(ecefPos: ecefPos, &fbb)
    TrackDetails_Abridged.addVectorOf(ecefVel: ecefVel, &fbb)
    TrackDetails_Abridged.add(containment: containment, &fbb)
    TrackDetails_Abridged.add(cpa: cpa, &fbb)
    TrackDetails_Abridged.add(tcpa: tcpa, &fbb)
    TrackDetails_Abridged.add(navStatus: navStatus, &fbb)
    TrackDetails_Abridged.add(posDeviceType: posDeviceType, &fbb)
    TrackDetails_Abridged.add(aton: aton, &fbb)
    TrackDetails_Abridged.add(offPosInd: offPosInd, &fbb)
    TrackDetails_Abridged.addVectorOf(antennaRefDimensions: antennaRefDimensions, &fbb)
    TrackDetails_Abridged.add(shipClass: shipClass, &fbb)
    TrackDetails_Abridged.add(imon: imon, &fbb)
    TrackDetails_Abridged.add(mmsi: mmsi, &fbb)
    TrackDetails_Abridged.add(draught: draught, &fbb)
    TrackDetails_Abridged.add(length: length, &fbb)
    TrackDetails_Abridged.add(width: width, &fbb)
    TrackDetails_Abridged.add(cargoType: cargoType, &fbb)
    TrackDetails_Abridged.add(appGrp: appGrp, &fbb)
    TrackDetails_Abridged.add(hullProf: hullProf, &fbb)
    TrackDetails_Abridged.add(propType: propType, &fbb)
    TrackDetails_Abridged.add(numBlades: numBlades, &fbb)
    TrackDetails_Abridged.add(numShafts: numShafts, &fbb)
    TrackDetails_Abridged.add(sternType: sternType, &fbb)
    TrackDetails_Abridged.add(vslWt: vslWt, &fbb)
    TrackDetails_Abridged.add(arrTime: arrTime, &fbb)
    TrackDetails_Abridged.add(arrFlag: arrFlag, &fbb)
    TrackDetails_Abridged.add(arrCargo: arrCargo, &fbb)
    TrackDetails_Abridged.add(arrPort: arrPort, &fbb)
    TrackDetails_Abridged.add(depPort: depPort, &fbb)
    TrackDetails_Abridged.add(depFlag: depFlag, &fbb)
    TrackDetails_Abridged.add(depCargo: depCargo, &fbb)
    TrackDetails_Abridged.add(desFlag: desFlag, &fbb)
    TrackDetails_Abridged.add(desCargo: desCargo, &fbb)
    TrackDetails_Abridged.add(destination: destination, &fbb)
    TrackDetails_Abridged.add(eta: eta, &fbb)
    TrackDetails_Abridged.add(etd: etd, &fbb)
    TrackDetails_Abridged.add(iff: iff, &fbb)
    TrackDetails_Abridged.add(emgInd: emgInd, &fbb)
    TrackDetails_Abridged.add(dropPtInd: dropPtInd, &fbb)
    TrackDetails_Abridged.add(reinforced: reinforced, &fbb)
    TrackDetails_Abridged.add(reduced: reduced, &fbb)
    TrackDetails_Abridged.add(hq: hq, &fbb)
    TrackDetails_Abridged.add(dummy: dummy, &fbb)
    TrackDetails_Abridged.add(taskForce: taskForce, &fbb)
    TrackDetails_Abridged.add(feint: feint, &fbb)
    TrackDetails_Abridged.add(installation: installation, &fbb)
    TrackDetails_Abridged.add(staffCmts: staffCmts, &fbb)
    TrackDetails_Abridged.add(addInfo: addInfo, &fbb)
    TrackDetails_Abridged.add(evalRating: evalRating, &fbb)
    TrackDetails_Abridged.add(createdAt: createdAt, &fbb)
    TrackDetails_Abridged.add(createdBy: createdBy, &fbb)
    TrackDetails_Abridged.add(source: source, &fbb)
    TrackDetails_Abridged.add(origin: origin, &fbb)
    TrackDetails_Abridged.add(dataMode: dataMode, &fbb)
    TrackDetails_Abridged.add(origNetwork: origNetwork, &fbb)
    return TrackDetails_Abridged.endTrackDetails_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.env.p, fieldName: "env", required: false, type: TrackDetails_Abridged_env_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.objIdent.p, fieldName: "objIdent", required: false, type: TrackDetails_Abridged_objIdent_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: TrackDetails_Abridged_dataMode_Enum.self)
