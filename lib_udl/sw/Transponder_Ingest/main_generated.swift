...
public enum Transponder_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Transponder_Ingest_dataMode_Enum { return .exercise }
  public static var min: Transponder_Ingest_dataMode_Enum { return .real }
}
...
public struct Transponder_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Transponder_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Transponder_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Transponder_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startTransponder_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 18) }
  ...
  public static func add(dataMode: Transponder_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func endTransponder_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createTransponder_Ingest(
    ...
    let __start = Transponder_Ingest.startTransponder_Ingest(&fbb)
    Transponder_Ingest.add(id: id, &fbb)
    Transponder_Ingest.add(idComm: idComm, &fbb)
    Transponder_Ingest.add(name: name, &fbb)
    Transponder_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Transponder_Ingest.add(nid: nid, &fbb)
    Transponder_Ingest.add(tid: tid, &fbb)
    Transponder_Ingest.add(ttf: ttf, &fbb)
    Transponder_Ingest.add(symbolRate: symbolRate, &fbb)
    Transponder_Ingest.add(fec: fec, &fbb)
    Transponder_Ingest.add(modulation: modulation, &fbb)
    Transponder_Ingest.add(format: format, &fbb)
    Transponder_Ingest.add(system: system, &fbb)
    Transponder_Ingest.add(source: source, &fbb)
    Transponder_Ingest.add(origin: origin, &fbb)
    Transponder_Ingest.add(origNetwork: origNetwork, &fbb)
    Transponder_Ingest.add(dataMode: dataMode, &fbb)
    Transponder_Ingest.add(createdAt: createdAt, &fbb)
    Transponder_Ingest.add(createdBy: createdBy, &fbb)
    return Transponder_Ingest.endTransponder_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Transponder_Ingest_dataMode_Enum.self)
