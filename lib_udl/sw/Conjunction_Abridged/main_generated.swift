...
public enum Conjunction_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Conjunction_Abridged_dataMode_Enum { return .exercise }
  public static var min: Conjunction_Abridged_dataMode_Enum { return .real }
}


///  /// Stores the results of a particular Conjunction Assessment (CA) run.
public struct Conjunction_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Conjunction_Abridged.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case createdAt = 122
    case createdBy = 124
    case stateVector1 = 126
    case stateVector2 = 128
    case satNo1 = 130
    case satNo2 = 132
    case origIdOnOrbit1 = 134
    case origIdOnOrbit2 = 136
  ...
  public var dataMode: Conjunction_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Conjunction_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startConjunction_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 68) }
  ...
  public static func add(dataMode: Conjunction_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endConjunction_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createConjunction_Abridged(
    ...
    let __start = Conjunction_Abridged.startConjunction_Abridged(&fbb)
    Conjunction_Abridged.add(id: id, &fbb)
    Conjunction_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Conjunction_Abridged.add(idOnOrbit1: idOnOrbit1, &fbb)
    Conjunction_Abridged.add(idOnOrbit2: idOnOrbit2, &fbb)
    Conjunction_Abridged.add(type: type, &fbb)
    Conjunction_Abridged.add(tca: tca, &fbb)
    Conjunction_Abridged.add(missDistance: missDistance, &fbb)
    Conjunction_Abridged.add(collisionProb: collisionProb, &fbb)
    Conjunction_Abridged.add(collisionProbMethod: collisionProbMethod, &fbb)
    Conjunction_Abridged.add(ephemName1: ephemName1, &fbb)
    Conjunction_Abridged.add(esId1: esId1, &fbb)
    Conjunction_Abridged.add(ephemName2: ephemName2, &fbb)
    Conjunction_Abridged.add(esId2: esId2, &fbb)
    Conjunction_Abridged.add(relPosR: relPosR, &fbb)
    Conjunction_Abridged.add(relPosT: relPosT, &fbb)
    Conjunction_Abridged.add(relPosN: relPosN, &fbb)
    Conjunction_Abridged.add(relVelMag: relVelMag, &fbb)
    Conjunction_Abridged.add(relVelR: relVelR, &fbb)
    Conjunction_Abridged.add(relVelT: relVelT, &fbb)
    Conjunction_Abridged.add(relVelN: relVelN, &fbb)
    Conjunction_Abridged.add(screenEntryTime: screenEntryTime, &fbb)
    Conjunction_Abridged.add(screenExitTime: screenExitTime, &fbb)
    Conjunction_Abridged.add(screenVolumeX: screenVolumeX, &fbb)
    Conjunction_Abridged.add(screenVolumeY: screenVolumeY, &fbb)
    Conjunction_Abridged.add(screenVolumeZ: screenVolumeZ, &fbb)
    Conjunction_Abridged.add(volShape: volShape, &fbb)
    Conjunction_Abridged.add(volEntryTime: volEntryTime, &fbb)
    Conjunction_Abridged.add(volExitTime: volExitTime, &fbb)
    Conjunction_Abridged.add(penetrationLevelSigma: penetrationLevelSigma, &fbb)
    Conjunction_Abridged.add(idStateVector1: idStateVector1, &fbb)
    Conjunction_Abridged.add(lastObTime1: lastObTime1, &fbb)
    Conjunction_Abridged.add(cdAoM1: cdAoM1, &fbb)
    Conjunction_Abridged.add(crAoM1: crAoM1, &fbb)
    Conjunction_Abridged.add(thrustAccel1: thrustAccel1, &fbb)
    Conjunction_Abridged.add(idStateVector2: idStateVector2, &fbb)
    Conjunction_Abridged.add(lastObTime2: lastObTime2, &fbb)
    Conjunction_Abridged.add(cdAoM2: cdAoM2, &fbb)
    Conjunction_Abridged.add(crAoM2: crAoM2, &fbb)
    Conjunction_Abridged.add(thrustAccel2: thrustAccel2, &fbb)
    Conjunction_Abridged.add(comments: comments, &fbb)
    Conjunction_Abridged.add(ccir: ccir, &fbb)
    Conjunction_Abridged.add(concernNotes: concernNotes, &fbb)
    Conjunction_Abridged.add(stateDeptNotified: stateDeptNotified, &fbb)
    Conjunction_Abridged.add(ownerContacted: ownerContacted, &fbb)
    Conjunction_Abridged.add(rawFileUri: rawFileUri, &fbb)
    Conjunction_Abridged.add(messageFor: messageFor, &fbb)
    Conjunction_Abridged.add(messageId: messageId, &fbb)
    Conjunction_Abridged.add(uvwWarn: uvwWarn, &fbb)
    Conjunction_Abridged.add(smallRelVelWarning: smallRelVelWarning, &fbb)
    Conjunction_Abridged.add(largeRelPosWarning: largeRelPosWarning, &fbb)
    Conjunction_Abridged.add(smallCovWarning: smallCovWarning, &fbb)
    Conjunction_Abridged.add(largeCovWarning: largeCovWarning, &fbb)
    Conjunction_Abridged.add(transactionId: transactionId, &fbb)
    Conjunction_Abridged.add(source: source, &fbb)
    Conjunction_Abridged.add(origin: origin, &fbb)
    Conjunction_Abridged.add(originator: originator, &fbb)
    Conjunction_Abridged.add(eventId: eventId, &fbb)
    Conjunction_Abridged.add(descriptor: descriptor, &fbb)
    Conjunction_Abridged.add(dataMode: dataMode, &fbb)
    Conjunction_Abridged.add(createdAt: createdAt, &fbb)
    Conjunction_Abridged.add(createdBy: createdBy, &fbb)
    Conjunction_Abridged.add(stateVector1: stateVector1, &fbb)
    Conjunction_Abridged.add(stateVector2: stateVector2, &fbb)
    Conjunction_Abridged.add(satNo1: satNo1, &fbb)
    Conjunction_Abridged.add(satNo2: satNo2, &fbb)
    Conjunction_Abridged.add(origIdOnOrbit1: origIdOnOrbit1, &fbb)
    Conjunction_Abridged.add(origIdOnOrbit2: origIdOnOrbit2, &fbb)
    Conjunction_Abridged.add(origNetwork: origNetwork, &fbb)
    return Conjunction_Abridged.endConjunction_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Conjunction_Abridged_dataMode_Enum.self)
