...
public struct MtiMission_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiMission_Full.id, addPrefix: prefix) }
  ...
  public static func startMtiMission_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endMtiMission_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiMission_Full(
    ...
    let __start = MtiMission_Full.startMtiMission_Full(&fbb)
    MtiMission_Full.add(m1: m1, &fbb)
    MtiMission_Full.add(m2: m2, &fbb)
    MtiMission_Full.add(m3: m3, &fbb)
    MtiMission_Full.add(m4: m4, &fbb)
    MtiMission_Full.add(msnRefTs: msnRefTs, &fbb)
    return MtiMission_Full.endMtiMission_Full(&fbb, start: __start)
  }
