...
public struct LogisticsSupportItems_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LogisticsSupportItems_Ingest.id, addPrefix: prefix) }
  ...
  public static func startLogisticsSupportItems_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 19) }
  ...
  public static func endLogisticsSupportItems_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLogisticsSupportItems_Ingest(
    ...
    let __start = LogisticsSupportItems_Ingest.startLogisticsSupportItems_Ingest(&fbb)
    LogisticsSupportItems_Ingest.add(recoveryRequestTypeCode: recoveryRequestTypeCode, &fbb)
    LogisticsSupportItems_Ingest.add(requestNumber: requestNumber, &fbb)
    LogisticsSupportItems_Ingest.add(quantity: quantity, &fbb)
    LogisticsSupportItems_Ingest.add(description: description, &fbb)
    LogisticsSupportItems_Ingest.add(shipmentUnitId: shipmentUnitId, &fbb)
    LogisticsSupportItems_Ingest.add(redeployShipmentUnitId: redeployShipmentUnitId, &fbb)
    LogisticsSupportItems_Ingest.add(jobControlNumber: jobControlNumber, &fbb)
    LogisticsSupportItems_Ingest.add(sourceIcao: sourceIcao, &fbb)
    LogisticsSupportItems_Ingest.add(deployPlanNumber: deployPlanNumber, &fbb)
    LogisticsSupportItems_Ingest.add(redeployPlanNumber: redeployPlanNumber, &fbb)
    LogisticsSupportItems_Ingest.add(cannibalized: cannibalized, &fbb)
    LogisticsSupportItems_Ingest.add(siPoc: siPoc, &fbb)
    LogisticsSupportItems_Ingest.add(readyTime: readyTime, &fbb)
    LogisticsSupportItems_Ingest.add(receivedTime: receivedTime, &fbb)
    LogisticsSupportItems_Ingest.add(resupportFlag: resupportFlag, &fbb)
    LogisticsSupportItems_Ingest.add(itemLastChangedDate: itemLastChangedDate, &fbb)
    LogisticsSupportItems_Ingest.addVectorOf(logisticsParts: logisticsParts, &fbb)
    LogisticsSupportItems_Ingest.addVectorOf(logisticsSpecialties: logisticsSpecialties, &fbb)
    LogisticsSupportItems_Ingest.addVectorOf(logisticsRemarks: logisticsRemarks, &fbb)
    return LogisticsSupportItems_Ingest.endLogisticsSupportItems_Ingest(&fbb, start: __start)
  }
