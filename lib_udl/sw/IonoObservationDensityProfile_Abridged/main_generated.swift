...
public struct IonoObservationDensityProfile_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDensityProfile_Abridged.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDensityProfile_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 8) }
  ...
  public static func endIonoObservationDensityProfile_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDensityProfile_Abridged(
    ...
    let __start = IonoObservationDensityProfile_Abridged.startIonoObservationDensityProfile_Abridged(&fbb)
    IonoObservationDensityProfile_Abridged.add(parabolic: parabolic, &fbb)
    IonoObservationDensityProfile_Abridged.add(quasiParabolic: quasiParabolic, &fbb)
    IonoObservationDensityProfile_Abridged.add(valleyModelDescription: valleyModelDescription, &fbb)
    IonoObservationDensityProfile_Abridged.addVectorOf(valleyModelCoeffs: valleyModelCoeffs, &fbb)
    IonoObservationDensityProfile_Abridged.add(shiftedChebyshev: shiftedChebyshev, &fbb)
    IonoObservationDensityProfile_Abridged.add(topsideExtensionChapmanConst: topsideExtensionChapmanConst, &fbb)
    IonoObservationDensityProfile_Abridged.add(topsideExtensionVaryChap: topsideExtensionVaryChap, &fbb)
    IonoObservationDensityProfile_Abridged.add(iri: iri, &fbb)
    return IonoObservationDensityProfile_Abridged.endIonoObservationDensityProfile_Abridged(&fbb, start: __start)
  }
