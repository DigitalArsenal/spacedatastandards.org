...
public enum AirspaceControlOrder_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AirspaceControlOrder_Abridged_dataMode_Enum { return .exercise }
  public static var min: AirspaceControlOrder_Abridged_dataMode_Enum { return .real }
}
...
public struct AirspaceControlOrder_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirspaceControlOrder_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: AirspaceControlOrder_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AirspaceControlOrder_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startAirspaceControlOrder_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 33) }
  ...
  public static func add(dataMode: AirspaceControlOrder_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endAirspaceControlOrder_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirspaceControlOrder_Abridged(
    ...
    let __start = AirspaceControlOrder_Abridged.startAirspaceControlOrder_Abridged(&fbb)
    AirspaceControlOrder_Abridged.add(id: id, &fbb)
    AirspaceControlOrder_Abridged.add(classificationMarking: classificationMarking, &fbb)
    AirspaceControlOrder_Abridged.add(rawFileUri: rawFileUri, &fbb)
    AirspaceControlOrder_Abridged.add(opExName: opExName, &fbb)
    AirspaceControlOrder_Abridged.add(originator: originator, &fbb)
    AirspaceControlOrder_Abridged.add(startTime: startTime, &fbb)
    AirspaceControlOrder_Abridged.add(stopTime: stopTime, &fbb)
    AirspaceControlOrder_Abridged.add(stopQualifier: stopQualifier, &fbb)
    AirspaceControlOrder_Abridged.add(opExInfo: opExInfo, &fbb)
    AirspaceControlOrder_Abridged.add(opExInfoAlt: opExInfoAlt, &fbb)
    AirspaceControlOrder_Abridged.add(planOrigNum: planOrigNum, &fbb)
    AirspaceControlOrder_Abridged.add(serialNum: serialNum, &fbb)
    AirspaceControlOrder_Abridged.add(month: month, &fbb)
    AirspaceControlOrder_Abridged.add(qualifier: qualifier, &fbb)
    AirspaceControlOrder_Abridged.add(qualSn: qualSn, &fbb)
    AirspaceControlOrder_Abridged.add(areaOfValidity: areaOfValidity, &fbb)
    AirspaceControlOrder_Abridged.add(acoSerialNum: acoSerialNum, &fbb)
    AirspaceControlOrder_Abridged.add(geoDatum: geoDatum, &fbb)
    AirspaceControlOrder_Abridged.add(acoComments: acoComments, &fbb)
    AirspaceControlOrder_Abridged.addVectorOf(airspaceControlOrderReferences: airspaceControlOrderReferences, &fbb)
    AirspaceControlOrder_Abridged.addVectorOf(airspaceControlMeansStatus: airspaceControlMeansStatus, &fbb)
    AirspaceControlOrder_Abridged.addVectorOf(undLnkTrk: undLnkTrk, &fbb)
    AirspaceControlOrder_Abridged.add(classSource: classSource, &fbb)
    AirspaceControlOrder_Abridged.addVectorOf(classReason: classReason, &fbb)
    AirspaceControlOrder_Abridged.addVectorOf(downgradeInsDate: downgradeInsDate, &fbb)
    AirspaceControlOrder_Abridged.addVectorOf(declassExemptionCode: declassExemptionCode, &fbb)
    AirspaceControlOrder_Abridged.add(createdAt: createdAt, &fbb)
    AirspaceControlOrder_Abridged.add(createdBy: createdBy, &fbb)
    AirspaceControlOrder_Abridged.add(sourceDl: sourceDl, &fbb)
    AirspaceControlOrder_Abridged.add(source: source, &fbb)
    AirspaceControlOrder_Abridged.add(origin: origin, &fbb)
    AirspaceControlOrder_Abridged.add(origNetwork: origNetwork, &fbb)
    AirspaceControlOrder_Abridged.add(dataMode: dataMode, &fbb)
    return AirspaceControlOrder_Abridged.endAirspaceControlOrder_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AirspaceControlOrder_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
