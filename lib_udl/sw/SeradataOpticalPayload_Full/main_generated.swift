...
public enum SeradataOpticalPayload_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SeradataOpticalPayload_Full_dataMode_Enum { return .exercise }
  public static var min: SeradataOpticalPayload_Full_dataMode_Enum { return .real }
}


///  /// Details for an optical payload from  Seradata.
public struct SeradataOpticalPayload_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SeradataOpticalPayload_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SeradataOpticalPayload_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SeradataOpticalPayload_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSeradataOpticalPayload_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 28) }
  ...
  public static func add(dataMode: SeradataOpticalPayload_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSeradataOpticalPayload_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSeradataOpticalPayload_Full(
    ...
    let __start = SeradataOpticalPayload_Full.startSeradataOpticalPayload_Full(&fbb)
    SeradataOpticalPayload_Full.add(id: id, &fbb)
    SeradataOpticalPayload_Full.add(classificationMarking: classificationMarking, &fbb)
    SeradataOpticalPayload_Full.add(spacecraftId: spacecraftId, &fbb)
    SeradataOpticalPayload_Full.add(idSensor: idSensor, &fbb)
    SeradataOpticalPayload_Full.add(hostedForCompanyOrgId: hostedForCompanyOrgId, &fbb)
    SeradataOpticalPayload_Full.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    SeradataOpticalPayload_Full.add(imagingPayloadCategory: imagingPayloadCategory, &fbb)
    SeradataOpticalPayload_Full.add(name: name, &fbb)
    SeradataOpticalPayload_Full.add(spectralBand: spectralBand, &fbb)
    SeradataOpticalPayload_Full.add(spectralFrequencyLimits: spectralFrequencyLimits, &fbb)
    SeradataOpticalPayload_Full.add(numberOfFilmReturnCanisters: numberOfFilmReturnCanisters, &fbb)
    SeradataOpticalPayload_Full.add(bestResolution: bestResolution, &fbb)
    SeradataOpticalPayload_Full.add(swathWidth: swathWidth, &fbb)
    SeradataOpticalPayload_Full.add(recorderSize: recorderSize, &fbb)
    SeradataOpticalPayload_Full.add(fieldOfView: fieldOfView, &fbb)
    SeradataOpticalPayload_Full.add(fieldOfRegard: fieldOfRegard, &fbb)
    SeradataOpticalPayload_Full.add(pointingMethod: pointingMethod, &fbb)
    SeradataOpticalPayload_Full.add(groundStations: groundStations, &fbb)
    SeradataOpticalPayload_Full.add(groundStationLocations: groundStationLocations, &fbb)
    SeradataOpticalPayload_Full.add(notes: notes, &fbb)
    SeradataOpticalPayload_Full.add(createdAt: createdAt, &fbb)
    SeradataOpticalPayload_Full.add(createdBy: createdBy, &fbb)
    SeradataOpticalPayload_Full.add(updatedAt: updatedAt, &fbb)
    SeradataOpticalPayload_Full.add(updatedBy: updatedBy, &fbb)
    SeradataOpticalPayload_Full.add(source: source, &fbb)
    SeradataOpticalPayload_Full.add(origin: origin, &fbb)
    SeradataOpticalPayload_Full.add(origNetwork: origNetwork, &fbb)
    SeradataOpticalPayload_Full.add(dataMode: dataMode, &fbb)
    return SeradataOpticalPayload_Full.endSeradataOpticalPayload_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SeradataOpticalPayload_Full_dataMode_Enum.self)
    _v.finish()
  }
}
