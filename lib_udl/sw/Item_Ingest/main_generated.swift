...
public enum Item_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Item_Ingest_dataMode_Enum { return .exercise }
  public static var min: Item_Ingest_dataMode_Enum { return .real }
}


///  /// No description available.
public struct Item_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Item_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Item_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Item_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startItem_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 51) }
  ...
  public static func add(dataMode: Item_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endItem_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createItem_Ingest(
    ...
    let __start = Item_Ingest.startItem_Ingest(&fbb)
    Item_Ingest.add(id: id, &fbb)
    Item_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Item_Ingest.add(idAirLoadPlan: idAirLoadPlan, &fbb)
    Item_Ingest.add(scanCode: scanCode, &fbb)
    Item_Ingest.add(scGenTool: scGenTool, &fbb)
    Item_Ingest.add(type: type, &fbb)
    Item_Ingest.add(cargoType: cargoType, &fbb)
    Item_Ingest.add(name: name, &fbb)
    Item_Ingest.add(destination: destination, &fbb)
    Item_Ingest.add(departure: departure, &fbb)
    Item_Ingest.add(receivingUnit: receivingUnit, &fbb)
    Item_Ingest.add(receivingBranch: receivingBranch, &fbb)
    Item_Ingest.add(lastArrDate: lastArrDate, &fbb)
    Item_Ingest.add(uln: uln, &fbb)
    Item_Ingest.add(weight: weight, &fbb)
    Item_Ingest.add(weightTs: weightTs, &fbb)
    Item_Ingest.add(commodityCode: commodityCode, &fbb)
    Item_Ingest.add(commoditySys: commoditySys, &fbb)
    Item_Ingest.add(productCode: productCode, &fbb)
    Item_Ingest.add(productSys: productSys, &fbb)
    Item_Ingest.add(width: width, &fbb)
    Item_Ingest.add(length: length, &fbb)
    Item_Ingest.add(height: height, &fbb)
    Item_Ingest.add(volume: volume, &fbb)
    Item_Ingest.add(cg: cg, &fbb)
    Item_Ingest.add(fs: fs, &fbb)
    Item_Ingest.add(centerlineOffset: centerlineOffset, &fbb)
    Item_Ingest.add(moment: moment, &fbb)
    Item_Ingest.add(airdrop: airdrop, &fbb)
    Item_Ingest.add(tcn: tcn, &fbb)
    Item_Ingest.addVectorOf(hazCodes: hazCodes, &fbb)
    Item_Ingest.add(netExpWt: netExpWt, &fbb)
    Item_Ingest.add(container: container, &fbb)
    Item_Ingest.addVectorOf(itemContains: itemContains, &fbb)
    Item_Ingest.add(numPalletPos: numPalletPos, &fbb)
    Item_Ingest.add(dvCode: dvCode, &fbb)
    Item_Ingest.add(notes: notes, &fbb)
    Item_Ingest.addVectorOf(keys: keys, &fbb)
    Item_Ingest.addVectorOf(values: values, &fbb)
    Item_Ingest.add(altDataFormat: altDataFormat, &fbb)
    Item_Ingest.add(accSystem: accSystem, &fbb)
    Item_Ingest.add(accSysNotes: accSysNotes, &fbb)
    Item_Ingest.addVectorOf(accSysKeys: accSysKeys, &fbb)
    Item_Ingest.addVectorOf(accSysValues: accSysValues, &fbb)
    Item_Ingest.add(createdAt: createdAt, &fbb)
    Item_Ingest.add(createdBy: createdBy, &fbb)
    Item_Ingest.add(sourceDl: sourceDl, &fbb)
    Item_Ingest.add(source: source, &fbb)
    Item_Ingest.add(origin: origin, &fbb)
    Item_Ingest.add(origNetwork: origNetwork, &fbb)
    Item_Ingest.add(dataMode: dataMode, &fbb)
    return Item_Ingest.endItem_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Item_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
