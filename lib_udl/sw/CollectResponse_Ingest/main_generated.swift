...
public enum CollectResponse_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: CollectResponse_Ingest_dataMode_Enum { return .exercise }
  public static var min: CollectResponse_Ingest_dataMode_Enum { return .real }
}
...
public struct CollectResponse_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: CollectResponse_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: CollectResponse_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : CollectResponse_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startCollectResponse_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 27) }
  ...
  public static func add(dataMode: CollectResponse_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func addVectorOf(tags: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: tags, at: VTOFFSET.tags.p) }
  public static func endCollectResponse_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createCollectResponse_Ingest(
    ...
    let __start = CollectResponse_Ingest.startCollectResponse_Ingest(&fbb)
    CollectResponse_Ingest.add(id: id, &fbb)
    CollectResponse_Ingest.add(classificationMarking: classificationMarking, &fbb)
    CollectResponse_Ingest.add(idRequest: idRequest, &fbb)
    CollectResponse_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    CollectResponse_Ingest.add(origObjectId: origObjectId, &fbb)
    CollectResponse_Ingest.add(satNo: satNo, &fbb)
    CollectResponse_Ingest.add(taskId: taskId, &fbb)
    CollectResponse_Ingest.add(idPlan: idPlan, &fbb)
    CollectResponse_Ingest.add(externalId: externalId, &fbb)
    CollectResponse_Ingest.add(status: status, &fbb)
    CollectResponse_Ingest.add(actualStartTime: actualStartTime, &fbb)
    CollectResponse_Ingest.add(actualEndTime: actualEndTime, &fbb)
    CollectResponse_Ingest.add(altStartTime: altStartTime, &fbb)
    CollectResponse_Ingest.add(altEndTime: altEndTime, &fbb)
    CollectResponse_Ingest.add(errCode: errCode, &fbb)
    CollectResponse_Ingest.addVectorOf(srcTyps: srcTyps, &fbb)
    CollectResponse_Ingest.addVectorOf(srcIds: srcIds, &fbb)
    CollectResponse_Ingest.add(notes: notes, &fbb)
    CollectResponse_Ingest.add(createdAt: createdAt, &fbb)
    CollectResponse_Ingest.add(createdBy: createdBy, &fbb)
    CollectResponse_Ingest.add(source: source, &fbb)
    CollectResponse_Ingest.add(origin: origin, &fbb)
    CollectResponse_Ingest.add(origNetwork: origNetwork, &fbb)
    CollectResponse_Ingest.add(idSensor: idSensor, &fbb)
    CollectResponse_Ingest.add(origSensorId: origSensorId, &fbb)
    CollectResponse_Ingest.add(dataMode: dataMode, &fbb)
    CollectResponse_Ingest.addVectorOf(tags: tags, &fbb)
    return CollectResponse_Ingest.endCollectResponse_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: CollectResponse_Ingest_dataMode_Enum.self)
