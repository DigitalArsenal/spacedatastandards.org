...
public enum Sensorcharacteristics_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Sensorcharacteristics_Ingest_dataMode_Enum { return .exercise }
  public static var min: Sensorcharacteristics_Ingest_dataMode_Enum { return .real }
}


///  /// Model representation of characteristics and capabilities of a sensor.
public struct Sensorcharacteristics_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Sensorcharacteristics_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Sensorcharacteristics_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Sensorcharacteristics_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startSensorcharacteristics_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 54) }
  ...
  public static func add(dataMode: Sensorcharacteristics_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func endSensorcharacteristics_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSensorcharacteristics_Ingest(
    ...
    let __start = Sensorcharacteristics_Ingest.startSensorcharacteristics_Ingest(&fbb)
    Sensorcharacteristics_Ingest.add(id: id, &fbb)
    Sensorcharacteristics_Ingest.add(idSensor: idSensor, &fbb)
    Sensorcharacteristics_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Sensorcharacteristics_Ingest.add(origNetwork: origNetwork, &fbb)
    Sensorcharacteristics_Ingest.add(azimuthRate: azimuthRate, &fbb)
    Sensorcharacteristics_Ingest.add(elevationRateGeolm: elevationRateGeolm, &fbb)
    Sensorcharacteristics_Ingest.add(minRangeLimit: minRangeLimit, &fbb)
    Sensorcharacteristics_Ingest.add(maxRangeLimit: maxRangeLimit, &fbb)
    Sensorcharacteristics_Ingest.add(leftClockAngle: leftClockAngle, &fbb)
    Sensorcharacteristics_Ingest.add(rightClockAngle: rightClockAngle, &fbb)
    Sensorcharacteristics_Ingest.add(boresight: boresight, &fbb)
    Sensorcharacteristics_Ingest.add(boresightOffAngle: boresightOffAngle, &fbb)
    Sensorcharacteristics_Ingest.add(negativeRangeRateLimit: negativeRangeRateLimit, &fbb)
    Sensorcharacteristics_Ingest.add(positiveRangeRateLimit: positiveRangeRateLimit, &fbb)
    Sensorcharacteristics_Ingest.add(magnitudeLimit: magnitudeLimit, &fbb)
    Sensorcharacteristics_Ingest.add(trackAngle: trackAngle, &fbb)
    Sensorcharacteristics_Ingest.add(minSignalNoiseRatio: minSignalNoiseRatio, &fbb)
    Sensorcharacteristics_Ingest.add(fanBeamWidth: fanBeamWidth, &fbb)
    Sensorcharacteristics_Ingest.add(taskableRange: taskableRange, &fbb)
    Sensorcharacteristics_Ingest.add(maxObservableRange: maxObservableRange, &fbb)
    Sensorcharacteristics_Ingest.add(radioFrequency: radioFrequency, &fbb)
    Sensorcharacteristics_Ingest.add(radarFrequency: radarFrequency, &fbb)
    Sensorcharacteristics_Ingest.add(transmitPower: transmitPower, &fbb)
    Sensorcharacteristics_Ingest.add(hFov: hFov, &fbb)
    Sensorcharacteristics_Ingest.add(vFov: vFov, &fbb)
    Sensorcharacteristics_Ingest.add(hResPixels: hResPixels, &fbb)
    Sensorcharacteristics_Ingest.add(vResPixels: vResPixels, &fbb)
    Sensorcharacteristics_Ingest.add(band: band, &fbb)
    Sensorcharacteristics_Ingest.add(maxDeviationAngle: maxDeviationAngle, &fbb)
    Sensorcharacteristics_Ingest.add(aperture: aperture, &fbb)
    Sensorcharacteristics_Ingest.add(leftGeoBeltLimit: leftGeoBeltLimit, &fbb)
    Sensorcharacteristics_Ingest.add(rightGeoBeltLimit: rightGeoBeltLimit, &fbb)
    Sensorcharacteristics_Ingest.add(asrScanRate: asrScanRate, &fbb)
    Sensorcharacteristics_Ingest.add(k: k, &fbb)
    Sensorcharacteristics_Ingest.add(focalPoint: focalPoint, &fbb)
    Sensorcharacteristics_Ingest.add(towerHeight: towerHeight, &fbb)
    Sensorcharacteristics_Ingest.add(trueNorthCorrector: trueNorthCorrector, &fbb)
    Sensorcharacteristics_Ingest.add(magDec: magDec, &fbb)
    Sensorcharacteristics_Ingest.add(z1MinRange: z1MinRange, &fbb)
    Sensorcharacteristics_Ingest.add(z2MinRange: z2MinRange, &fbb)
    Sensorcharacteristics_Ingest.add(z1MaxRange: z1MaxRange, &fbb)
    Sensorcharacteristics_Ingest.add(z2MaxRange: z2MaxRange, &fbb)
    Sensorcharacteristics_Ingest.add(radarMur: radarMur, &fbb)
    Sensorcharacteristics_Ingest.add(probFalseAlarm: probFalseAlarm, &fbb)
    Sensorcharacteristics_Ingest.add(prf: prf, &fbb)
    Sensorcharacteristics_Ingest.add(radarPulseWidth: radarPulseWidth, &fbb)
    Sensorcharacteristics_Ingest.add(numIntegratedPulses: numIntegratedPulses, &fbb)
    Sensorcharacteristics_Ingest.add(trueTilt: trueTilt, &fbb)
    Sensorcharacteristics_Ingest.add(radarMessageFormat: radarMessageFormat, &fbb)
    Sensorcharacteristics_Ingest.add(systemNoiseTemperature: systemNoiseTemperature, &fbb)
    Sensorcharacteristics_Ingest.add(source: source, &fbb)
    Sensorcharacteristics_Ingest.add(dataMode: dataMode, &fbb)
    Sensorcharacteristics_Ingest.add(createdAt: createdAt, &fbb)
    Sensorcharacteristics_Ingest.add(createdBy: createdBy, &fbb)
    return Sensorcharacteristics_Ingest.endSensorcharacteristics_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Sensorcharacteristics_Ingest_dataMode_Enum.self)
