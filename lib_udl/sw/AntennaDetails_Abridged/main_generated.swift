...
public enum AntennaDetails_Abridged_mode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AntennaDetails_Abridged_mode_Enum { return .rx }
  public static var min: AntennaDetails_Abridged_mode_Enum { return .tx }
}


public enum AntennaDetails_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: AntennaDetails_Abridged_dataMode_Enum { return .exercise }
  public static var min: AntennaDetails_Abridged_dataMode_Enum { return .real }
}
...
public struct AntennaDetails_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AntennaDetails_Abridged.id, addPrefix: prefix) }
  ...
  public var mode: AntennaDetails_Abridged_mode_Enum { let o = _accessor.offset(VTOFFSET.mode.v); return o == 0 ? .tx : AntennaDetails_Abridged_mode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .tx }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: AntennaDetails_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AntennaDetails_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startAntennaDetails_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 24) }
  ...
  public static func add(mode: AntennaDetails_Abridged_mode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: mode.rawValue, def: 0, at: VTOFFSET.mode.p) }
  ...
  public static func add(dataMode: AntennaDetails_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endAntennaDetails_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAntennaDetails_Abridged(
    ...
    let __start = AntennaDetails_Abridged.startAntennaDetails_Abridged(&fbb)
    AntennaDetails_Abridged.add(id: id, &fbb)
    AntennaDetails_Abridged.add(idAntenna: idAntenna, &fbb)
    AntennaDetails_Abridged.add(classificationMarking: classificationMarking, &fbb)
    AntennaDetails_Abridged.add(type: type, &fbb)
    AntennaDetails_Abridged.add(position: position, &fbb)
    AntennaDetails_Abridged.add(mode: mode, &fbb)
    AntennaDetails_Abridged.add(steerable: steerable, &fbb)
    AntennaDetails_Abridged.add(beamForming: beamForming, &fbb)
    AntennaDetails_Abridged.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    AntennaDetails_Abridged.add(diameter: diameter, &fbb)
    AntennaDetails_Abridged.addVectorOf(size: size, &fbb)
    AntennaDetails_Abridged.add(startFrequency: startFrequency, &fbb)
    AntennaDetails_Abridged.add(endFrequency: endFrequency, &fbb)
    AntennaDetails_Abridged.add(beamwidth: beamwidth, &fbb)
    AntennaDetails_Abridged.add(gain: gain, &fbb)
    AntennaDetails_Abridged.add(gainTolerance: gainTolerance, &fbb)
    AntennaDetails_Abridged.add(polarization: polarization, &fbb)
    AntennaDetails_Abridged.add(description: description, &fbb)
    AntennaDetails_Abridged.add(createdAt: createdAt, &fbb)
    AntennaDetails_Abridged.add(createdBy: createdBy, &fbb)
    AntennaDetails_Abridged.add(source: source, &fbb)
    AntennaDetails_Abridged.add(origin: origin, &fbb)
    AntennaDetails_Abridged.add(origNetwork: origNetwork, &fbb)
    AntennaDetails_Abridged.add(dataMode: dataMode, &fbb)
    return AntennaDetails_Abridged.endAntennaDetails_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.mode.p, fieldName: "mode", required: false, type: AntennaDetails_Abridged_mode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AntennaDetails_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
