...
public struct GNSSObservation_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: GNSSObservation_Full.id, addPrefix: prefix) }
  ...
  public static func startGNSSObservation_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endGNSSObservation_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createGNSSObservation_Full(
    ...
    let __start = GNSSObservation_Full.startGNSSObservation_Full(&fbb)
    GNSSObservation_Full.add(gnssSatId: gnssSatId, &fbb)
    GNSSObservation_Full.add(trackingStatus: trackingStatus, &fbb)
    GNSSObservation_Full.add(agcState: agcState, &fbb)
    GNSSObservation_Full.addVectorOf(obsCodeSet: obsCodeSet, &fbb)
    GNSSObservation_Full.addVectorOf(ob: ob, &fbb)
    return GNSSObservation_Full.endGNSSObservation_Full(&fbb, start: __start)
  }
