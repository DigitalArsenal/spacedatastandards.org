...
public struct IonoObservationProfileDensityShiftedChebyshevEntry_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationProfileDensityShiftedChebyshevEntry_Abridged.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationProfileDensityShiftedChebyshevEntry_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 8) }
  ...
  public static func endIonoObservationProfileDensityShiftedChebyshevEntry_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationProfileDensityShiftedChebyshevEntry_Abridged(
    ...
    let __start = IonoObservationProfileDensityShiftedChebyshevEntry_Abridged.startIonoObservationProfileDensityShiftedChebyshevEntry_Abridged(&fbb)
    IonoObservationProfileDensityShiftedChebyshevEntry_Abridged.add(layer: layer, &fbb)
    IonoObservationProfileDensityShiftedChebyshevEntry_Abridged.add(fstart: fstart, &fbb)
    IonoObservationProfileDensityShiftedChebyshevEntry_Abridged.add(fstop: fstop, &fbb)
    IonoObservationProfileDensityShiftedChebyshevEntry_Abridged.add(peakheight: peakheight, &fbb)
    IonoObservationProfileDensityShiftedChebyshevEntry_Abridged.add(zhalfNm: zhalfNm, &fbb)
    IonoObservationProfileDensityShiftedChebyshevEntry_Abridged.add(n: n, &fbb)
    IonoObservationProfileDensityShiftedChebyshevEntry_Abridged.addVectorOf(coeffs: coeffs, &fbb)
    IonoObservationProfileDensityShiftedChebyshevEntry_Abridged.add(error: error, &fbb)
    return IonoObservationProfileDensityShiftedChebyshevEntry_Abridged.endIonoObservationProfileDensityShiftedChebyshevEntry_Abridged(&fbb, start: __start)
  }
