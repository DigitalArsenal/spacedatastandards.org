...
public struct ISRCollectionAdditional_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollectionAdditional_Abridged.id, addPrefix: prefix) }
  ...
  public static func startISRCollectionAdditional_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endISRCollectionAdditional_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollectionAdditional_Abridged(
    _ fbb: inout FlatBufferBuilder,
    idOffset id: Offset = Offset(),
    startOffset start: Offset = Offset(),
    stopOffset stop: Offset = Offset()
  ) -> Offset {
    let __start = ISRCollectionAdditional_Abridged.startISRCollectionAdditional_Abridged(&fbb)
    ISRCollectionAdditional_Abridged.add(id: id, &fbb)
    ISRCollectionAdditional_Abridged.add(start: start, &fbb)
    ISRCollectionAdditional_Abridged.add(stop: stop, &fbb)
    return ISRCollectionAdditional_Abridged.endISRCollectionAdditional_Abridged(&fbb, start: __start)
  }
