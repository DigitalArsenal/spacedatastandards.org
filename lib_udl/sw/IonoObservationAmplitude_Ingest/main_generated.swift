...
public struct IonoObservationAmplitude_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationAmplitude_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationAmplitude_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationAmplitude_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationAmplitude_Ingest(
    ...
    let __start = IonoObservationAmplitude_Ingest.startIonoObservationAmplitude_Ingest(&fbb)
    IonoObservationAmplitude_Ingest.add(notes: notes, &fbb)
    IonoObservationAmplitude_Ingest.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationAmplitude_Ingest.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationAmplitude_Ingest.addVectorOf(data: data, &fbb)
    return IonoObservationAmplitude_Ingest.endIonoObservationAmplitude_Ingest(&fbb, start: __start)
  }
