...
public struct IonoObservationPhase_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationPhase_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationPhase_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationPhase_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationPhase_Full(
    ...
    let __start = IonoObservationPhase_Full.startIonoObservationPhase_Full(&fbb)
    IonoObservationPhase_Full.add(notes: notes, &fbb)
    IonoObservationPhase_Full.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationPhase_Full.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationPhase_Full.addVectorOf(data: data, &fbb)
    return IonoObservationPhase_Full.endIonoObservationPhase_Full(&fbb, start: __start)
  }
