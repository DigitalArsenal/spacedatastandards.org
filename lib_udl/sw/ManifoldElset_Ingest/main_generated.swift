...
public enum ManifoldElset_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: ManifoldElset_Ingest_dataMode_Enum { return .exercise }
  public static var min: ManifoldElset_Ingest_dataMode_Enum { return .real }
}
...
public struct ManifoldElset_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ManifoldElset_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: ManifoldElset_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : ManifoldElset_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 0, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startManifoldElset_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 27) }
  ...
  public static func add(dataMode: ManifoldElset_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endManifoldElset_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createManifoldElset_Ingest(
    ...
    let __start = ManifoldElset_Ingest.startManifoldElset_Ingest(&fbb)
    ManifoldElset_Ingest.add(id: id, &fbb)
    ManifoldElset_Ingest.add(idManifold: idManifold, &fbb)
    ManifoldElset_Ingest.add(classificationMarking: classificationMarking, &fbb)
    ManifoldElset_Ingest.add(tmpSatNo: tmpSatNo, &fbb)
    ManifoldElset_Ingest.add(epoch: epoch, &fbb)
    ManifoldElset_Ingest.add(meanMotion: meanMotion, &fbb)
    ManifoldElset_Ingest.add(eccentricity: eccentricity, &fbb)
    ManifoldElset_Ingest.add(inclination: inclination, &fbb)
    ManifoldElset_Ingest.add(raan: raan, &fbb)
    ManifoldElset_Ingest.add(argOfPerigee: argOfPerigee, &fbb)
    ManifoldElset_Ingest.add(meanAnomaly: meanAnomaly, &fbb)
    ManifoldElset_Ingest.add(revNo: revNo, &fbb)
    ManifoldElset_Ingest.add(bStar: bStar, &fbb)
    ManifoldElset_Ingest.add(meanMotionDot: meanMotionDot, &fbb)
    ManifoldElset_Ingest.add(meanMotionDdot: meanMotionDdot, &fbb)
    ManifoldElset_Ingest.add(semiMajorAxis: semiMajorAxis, &fbb)
    ManifoldElset_Ingest.add(period: period, &fbb)
    ManifoldElset_Ingest.add(apogee: apogee, &fbb)
    ManifoldElset_Ingest.add(perigee: perigee, &fbb)
    ManifoldElset_Ingest.add(line1: line1, &fbb)
    ManifoldElset_Ingest.add(line2: line2, &fbb)
    ManifoldElset_Ingest.add(createdAt: createdAt, &fbb)
    ManifoldElset_Ingest.add(createdBy: createdBy, &fbb)
    ManifoldElset_Ingest.add(source: source, &fbb)
    ManifoldElset_Ingest.add(origin: origin, &fbb)
    ManifoldElset_Ingest.add(dataMode: dataMode, &fbb)
    ManifoldElset_Ingest.add(origNetwork: origNetwork, &fbb)
    return ManifoldElset_Ingest.endManifoldElset_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: ManifoldElset_Ingest_dataMode_Enum.self)
