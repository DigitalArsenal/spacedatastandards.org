...
public enum Surface_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Surface_Ingest_dataMode_Enum { return .exercise }
  public static var min: Surface_Ingest_dataMode_Enum { return .real }
}
...
public struct Surface_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Surface_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Surface_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Surface_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSurface_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 52) }
  ...
  public static func add(dataMode: Surface_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSurface_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSurface_Ingest(
    ...
    let __start = Surface_Ingest.startSurface_Ingest(&fbb)
    Surface_Ingest.add(id: id, &fbb)
    Surface_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Surface_Ingest.add(name: name, &fbb)
    Surface_Ingest.add(type: type, &fbb)
    Surface_Ingest.add(idSite: idSite, &fbb)
    Surface_Ingest.add(altSiteId: altSiteId, &fbb)
    Surface_Ingest.add(primary: primary, &fbb)
    Surface_Ingest.add(lengthFt: lengthFt, &fbb)
    Surface_Ingest.add(ldaFt: ldaFt, &fbb)
    Surface_Ingest.add(widthFt: widthFt, &fbb)
    Surface_Ingest.add(lengthM: lengthM, &fbb)
    Surface_Ingest.add(ldaM: ldaM, &fbb)
    Surface_Ingest.add(widthM: widthM, &fbb)
    Surface_Ingest.add(material: material, &fbb)
    Surface_Ingest.add(condition: condition, &fbb)
    Surface_Ingest.add(rawWbc: rawWbc, &fbb)
    Surface_Ingest.add(pcn: pcn, &fbb)
    Surface_Ingest.add(lcn: lcn, &fbb)
    Surface_Ingest.add(sWtKip: sWtKip, &fbb)
    Surface_Ingest.add(tWtKip: tWtKip, &fbb)
    Surface_Ingest.add(stWtKip: stWtKip, &fbb)
    Surface_Ingest.add(ttWtKip: ttWtKip, &fbb)
    Surface_Ingest.add(ddWtKip: ddWtKip, &fbb)
    Surface_Ingest.add(sbttWtKip: sbttWtKip, &fbb)
    Surface_Ingest.add(tdtWtkip: tdtWtkip, &fbb)
    Surface_Ingest.add(trtWtKip: trtWtKip, &fbb)
    Surface_Ingest.add(ddtWtKip: ddtWtKip, &fbb)
    Surface_Ingest.add(sWtKn: sWtKn, &fbb)
    Surface_Ingest.add(tWtKn: tWtKn, &fbb)
    Surface_Ingest.add(stWtKn: stWtKn, &fbb)
    Surface_Ingest.add(ttWtKn: ttWtKn, &fbb)
    Surface_Ingest.add(ddWtKn: ddWtKn, &fbb)
    Surface_Ingest.add(sbttWtKn: sbttWtKn, &fbb)
    Surface_Ingest.add(tdtWtKn: tdtWtKn, &fbb)
    Surface_Ingest.add(trtWtKn: trtWtKn, &fbb)
    Surface_Ingest.add(ddtWtKn: ddtWtKn, &fbb)
    Surface_Ingest.add(lighting: lighting, &fbb)
    Surface_Ingest.add(lightsUnkn: lightsUnkn, &fbb)
    Surface_Ingest.add(lightsAprch: lightsAprch, &fbb)
    Surface_Ingest.add(lightsVasi: lightsVasi, &fbb)
    Surface_Ingest.add(lightsPapi: lightsPapi, &fbb)
    Surface_Ingest.add(lightsOls: lightsOls, &fbb)
    Surface_Ingest.add(lightsReil: lightsReil, &fbb)
    Surface_Ingest.add(lightsTdzl: lightsTdzl, &fbb)
    Surface_Ingest.add(lightsCl: lightsCl, &fbb)
    Surface_Ingest.add(obstacle: obstacle, &fbb)
    Surface_Ingest.add(createdAt: createdAt, &fbb)
    Surface_Ingest.add(createdBy: createdBy, &fbb)
    Surface_Ingest.add(source: source, &fbb)
    Surface_Ingest.add(origin: origin, &fbb)
    Surface_Ingest.add(origNetwork: origNetwork, &fbb)
    Surface_Ingest.add(dataMode: dataMode, &fbb)
    return Surface_Ingest.endSurface_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Surface_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
