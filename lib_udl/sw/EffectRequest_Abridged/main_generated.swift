...
public enum EffectRequest_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: EffectRequest_Abridged_dataMode_Enum { return .exercise }
  public static var min: EffectRequest_Abridged_dataMode_Enum { return .real }
}


///  /// A request for various effects on a target.
public struct EffectRequest_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EffectRequest_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: EffectRequest_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : EffectRequest_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startEffectRequest_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 21) }
  ...
  public static func add(dataMode: EffectRequest_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endEffectRequest_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEffectRequest_Abridged(
    ...
    let __start = EffectRequest_Abridged.startEffectRequest_Abridged(&fbb)
    EffectRequest_Abridged.add(id: id, &fbb)
    EffectRequest_Abridged.add(classificationMarking: classificationMarking, &fbb)
    EffectRequest_Abridged.add(externalRequestId: externalRequestId, &fbb)
    EffectRequest_Abridged.addVectorOf(effectList: effectList, &fbb)
    EffectRequest_Abridged.add(state: state, &fbb)
    EffectRequest_Abridged.add(context: context, &fbb)
    EffectRequest_Abridged.add(startTime: startTime, &fbb)
    EffectRequest_Abridged.add(endTime: endTime, &fbb)
    EffectRequest_Abridged.add(deadlineType: deadlineType, &fbb)
    EffectRequest_Abridged.add(targetSrcType: targetSrcType, &fbb)
    EffectRequest_Abridged.add(targetSrcId: targetSrcId, &fbb)
    EffectRequest_Abridged.add(priority: priority, &fbb)
    EffectRequest_Abridged.add(modelClass: modelClass, &fbb)
    EffectRequest_Abridged.addVectorOf(metricTypes: metricTypes, &fbb)
    EffectRequest_Abridged.addVectorOf(metricWeights: metricWeights, &fbb)
    EffectRequest_Abridged.add(createdAt: createdAt, &fbb)
    EffectRequest_Abridged.add(createdBy: createdBy, &fbb)
    EffectRequest_Abridged.add(source: source, &fbb)
    EffectRequest_Abridged.add(origin: origin, &fbb)
    EffectRequest_Abridged.add(dataMode: dataMode, &fbb)
    EffectRequest_Abridged.add(origNetwork: origNetwork, &fbb)
    return EffectRequest_Abridged.endEffectRequest_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: EffectRequest_Abridged_dataMode_Enum.self)
