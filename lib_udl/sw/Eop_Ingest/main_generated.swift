...
public enum Eop_Ingest_polarMotionState_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Eop_Ingest_polarMotionState_Enum { return .p }
  public static var min: Eop_Ingest_polarMotionState_Enum { return .i }
}


public enum Eop_Ingest_ut1UTCState_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: Eop_Ingest_ut1UTCState_Enum { return .p }
  public static var min: Eop_Ingest_ut1UTCState_Enum { return .i }
}


public enum Eop_Ingest_nutationState_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: Eop_Ingest_nutationState_Enum { return .p }
  public static var min: Eop_Ingest_nutationState_Enum { return .i }
}


public enum Eop_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: Eop_Ingest_dataMode_Enum { return .exercise }
  public static var min: Eop_Ingest_dataMode_Enum { return .real }
}
...
public struct Eop_Ingest: FlatBufferObject, Verifiable {

  static func validateVersion() { FlatBuffersVersion_24_3_25() }
  public var __buffer: ByteBuffer! { return _accessor.bb }
  private var _accessor: Table

  public static var id: String { "EOPI" } 
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Eop_Ingest.id, addPrefix: prefix) }
  ...
  public var polarMotionState: Eop_Ingest_polarMotionState_Enum { let o = _accessor.offset(VTOFFSET.polarMotionState.v); return o == 0 ? .i : Eop_Ingest_polarMotionState_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .i }
  ...
  ///  Example: /// Example: I
  ///  Constraints: Minimum length = 0, Maximum length = 1
  public var ut1Utcstate: Eop_Ingest_ut1UTCState_Enum { let o = _accessor.offset(VTOFFSET.ut1Utcstate.v); return o == 0 ? .i : Eop_Ingest_ut1UTCState_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .i }
  ...
  ///  Example: /// Example: I
  ///  Constraints: Minimum length = 0, Maximum length = 1
  public var nutationState: Eop_Ingest_nutationState_Enum { let o = _accessor.offset(VTOFFSET.nutationState.v); return o == 0 ? .i : Eop_Ingest_nutationState_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .i }
  ...
  public var dataMode: Eop_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Eop_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startEop_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 37) }
  ...
  public static func add(polarMotionState: Eop_Ingest_polarMotionState_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: polarMotionState.rawValue, def: 0, at: VTOFFSET.polarMotionState.p) }
  ...
  public static func add(ut1Utcstate: Eop_Ingest_ut1UTCState_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: ut1Utcstate.rawValue, def: 0, at: VTOFFSET.ut1Utcstate.p) }
  ...
  public static func add(nutationState: Eop_Ingest_nutationState_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: nutationState.rawValue, def: 0, at: VTOFFSET.nutationState.p) }
  ...
  public static func add(dataMode: Eop_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endEop_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEop_Ingest(
    ...
    let __start = Eop_Ingest.startEop_Ingest(&fbb)
    Eop_Ingest.add(id: id, &fbb)
    Eop_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Eop_Ingest.add(eopDate: eopDate, &fbb)
    Eop_Ingest.add(polarMotionState: polarMotionState, &fbb)
    Eop_Ingest.add(polarMotionX: polarMotionX, &fbb)
    Eop_Ingest.add(polarMotionXunc: polarMotionXunc, &fbb)
    Eop_Ingest.add(polarMotionY: polarMotionY, &fbb)
    Eop_Ingest.add(polarMotionYunc: polarMotionYunc, &fbb)
    Eop_Ingest.add(ut1Utcstate: ut1Utcstate, &fbb)
    Eop_Ingest.add(ut1Utc: ut1Utc, &fbb)
    Eop_Ingest.add(ut1Utcunc: ut1Utcunc, &fbb)
    Eop_Ingest.add(lod: lod, &fbb)
    Eop_Ingest.add(lodUnc: lodUnc, &fbb)
    Eop_Ingest.add(nutationState: nutationState, &fbb)
    Eop_Ingest.add(dPsi: dPsi, &fbb)
    Eop_Ingest.add(dPsiunc: dPsiunc, &fbb)
    Eop_Ingest.add(dEpsilon: dEpsilon, &fbb)
    Eop_Ingest.add(dEpsilonUnc: dEpsilonUnc, &fbb)
    Eop_Ingest.add(dX: dX, &fbb)
    Eop_Ingest.add(dXunc: dXunc, &fbb)
    Eop_Ingest.add(dY: dY, &fbb)
    Eop_Ingest.add(dYunc: dYunc, &fbb)
    Eop_Ingest.add(polarMotionXb: polarMotionXb, &fbb)
    Eop_Ingest.add(polarMotionYb: polarMotionYb, &fbb)
    Eop_Ingest.add(ut1Utcb: ut1Utcb, &fbb)
    Eop_Ingest.add(dPsib: dPsib, &fbb)
    Eop_Ingest.add(dEpsilonB: dEpsilonB, &fbb)
    Eop_Ingest.add(dXb: dXb, &fbb)
    Eop_Ingest.add(dYb: dYb, &fbb)
    Eop_Ingest.add(precessionNutationStd: precessionNutationStd, &fbb)
    Eop_Ingest.add(rawFileUri: rawFileUri, &fbb)
    Eop_Ingest.add(source: source, &fbb)
    Eop_Ingest.add(origin: origin, &fbb)
    Eop_Ingest.add(dataMode: dataMode, &fbb)
    Eop_Ingest.add(createdAt: createdAt, &fbb)
    Eop_Ingest.add(createdBy: createdBy, &fbb)
    Eop_Ingest.add(origNetwork: origNetwork, &fbb)
    return Eop_Ingest.endEop_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.polarMotionState.p, fieldName: "polarMotionState", required: false, type: Eop_Ingest_polarMotionState_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.ut1Utcstate.p, fieldName: "ut1Utcstate", required: false, type: Eop_Ingest_ut1UTCState_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.nutationState.p, fieldName: "nutationState", required: false, type: Eop_Ingest_nutationState_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Eop_Ingest_dataMode_Enum.self)
