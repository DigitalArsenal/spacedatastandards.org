...
public enum AirEvent_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AirEvent_Abridged_dataMode_Enum { return .exercise }
  public static var min: AirEvent_Abridged_dataMode_Enum { return .real }
}


///  /// Information related to an air event (e.g. FUEL TRANSFER, AIR DROP) and the associated aircraft.
public struct AirEvent_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirEvent_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: AirEvent_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AirEvent_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startAirEvent_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 44) }
  ...
  public static func add(dataMode: AirEvent_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endAirEvent_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirEvent_Abridged(
    ...
    let __start = AirEvent_Abridged.startAirEvent_Abridged(&fbb)
    AirEvent_Abridged.add(id: id, &fbb)
    AirEvent_Abridged.add(classificationMarking: classificationMarking, &fbb)
    AirEvent_Abridged.add(type: type, &fbb)
    AirEvent_Abridged.add(idSortie: idSortie, &fbb)
    AirEvent_Abridged.add(idMission: idMission, &fbb)
    AirEvent_Abridged.add(externalAirEventId: externalAirEventId, &fbb)
    AirEvent_Abridged.add(legNum: legNum, &fbb)
    AirEvent_Abridged.add(location: location, &fbb)
    AirEvent_Abridged.add(arrPurpose: arrPurpose, &fbb)
    AirEvent_Abridged.add(plannedArrTime: plannedArrTime, &fbb)
    AirEvent_Abridged.add(estArrTime: estArrTime, &fbb)
    AirEvent_Abridged.add(actualArrTime: actualArrTime, &fbb)
    AirEvent_Abridged.add(depPurpose: depPurpose, &fbb)
    AirEvent_Abridged.add(plannedDepTime: plannedDepTime, &fbb)
    AirEvent_Abridged.add(estDepTime: estDepTime, &fbb)
    AirEvent_Abridged.add(actualDepTime: actualDepTime, &fbb)
    AirEvent_Abridged.add(externalArtrackId: externalArtrackId, &fbb)
    AirEvent_Abridged.add(arTrackId: arTrackId, &fbb)
    AirEvent_Abridged.add(arTrackName: arTrackName, &fbb)
    AirEvent_Abridged.add(rzct: rzct, &fbb)
    AirEvent_Abridged.add(arct: arct, &fbb)
    AirEvent_Abridged.add(baseAlt: baseAlt, &fbb)
    AirEvent_Abridged.add(priority: priority, &fbb)
    AirEvent_Abridged.add(trackTime: trackTime, &fbb)
    AirEvent_Abridged.add(statusCode: statusCode, &fbb)
    AirEvent_Abridged.add(rzPoint: rzPoint, &fbb)
    AirEvent_Abridged.add(rzType: rzType, &fbb)
    AirEvent_Abridged.add(arEventType: arEventType, &fbb)
    AirEvent_Abridged.add(numTankers: numTankers, &fbb)
    AirEvent_Abridged.add(revTrack: revTrack, &fbb)
    AirEvent_Abridged.add(shortTrack: shortTrack, &fbb)
    AirEvent_Abridged.add(cancelled: cancelled, &fbb)
    AirEvent_Abridged.addVectorOf(tankers: tankers, &fbb)
    AirEvent_Abridged.addVectorOf(receivers: receivers, &fbb)
    AirEvent_Abridged.addVectorOf(remarks: remarks, &fbb)
    AirEvent_Abridged.add(createdAt: createdAt, &fbb)
    AirEvent_Abridged.add(createdBy: createdBy, &fbb)
    AirEvent_Abridged.add(updatedAt: updatedAt, &fbb)
    AirEvent_Abridged.add(updatedBy: updatedBy, &fbb)
    AirEvent_Abridged.add(sourceDl: sourceDl, &fbb)
    AirEvent_Abridged.add(source: source, &fbb)
    AirEvent_Abridged.add(origin: origin, &fbb)
    AirEvent_Abridged.add(origNetwork: origNetwork, &fbb)
    AirEvent_Abridged.add(dataMode: dataMode, &fbb)
    return AirEvent_Abridged.endAirEvent_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AirEvent_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
