...
public struct EvacVitalSignData_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacVitalSignData_Full.id, addPrefix: prefix) }
  ...
  public static func startEvacVitalSignData_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endEvacVitalSignData_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacVitalSignData_Full(
    ...
    let __start = EvacVitalSignData_Full.startEvacVitalSignData_Full(&fbb)
    EvacVitalSignData_Full.add(vitalSign: vitalSign, &fbb)
    EvacVitalSignData_Full.add(vitalSign1: vitalSign1, &fbb)
    EvacVitalSignData_Full.add(vitalSign2: vitalSign2, &fbb)
    EvacVitalSignData_Full.add(medConfFactor: medConfFactor, &fbb)
    EvacVitalSignData_Full.add(time: time, &fbb)
    return EvacVitalSignData_Full.endEvacVitalSignData_Full(&fbb, start: __start)
  }
