...
public enum SeradataRadarPayload_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SeradataRadarPayload_Ingest_dataMode_Enum { return .exercise }
  public static var min: SeradataRadarPayload_Ingest_dataMode_Enum { return .real }
}


///  /// Details for an radar payload from  Seradata.
public struct SeradataRadarPayload_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SeradataRadarPayload_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SeradataRadarPayload_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SeradataRadarPayload_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSeradataRadarPayload_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 32) }
  ...
  public static func add(dataMode: SeradataRadarPayload_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSeradataRadarPayload_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSeradataRadarPayload_Ingest(
    ...
    let __start = SeradataRadarPayload_Ingest.startSeradataRadarPayload_Ingest(&fbb)
    SeradataRadarPayload_Ingest.add(id: id, &fbb)
    SeradataRadarPayload_Ingest.add(classificationMarking: classificationMarking, &fbb)
    SeradataRadarPayload_Ingest.add(spacecraftId: spacecraftId, &fbb)
    SeradataRadarPayload_Ingest.add(idSensor: idSensor, &fbb)
    SeradataRadarPayload_Ingest.add(hostedForCompanyOrgId: hostedForCompanyOrgId, &fbb)
    SeradataRadarPayload_Ingest.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    SeradataRadarPayload_Ingest.add(category: category, &fbb)
    SeradataRadarPayload_Ingest.add(name: name, &fbb)
    SeradataRadarPayload_Ingest.add(frequencyBand: frequencyBand, &fbb)
    SeradataRadarPayload_Ingest.add(frequency: frequency, &fbb)
    SeradataRadarPayload_Ingest.add(waveLength: waveLength, &fbb)
    SeradataRadarPayload_Ingest.add(bestResolution: bestResolution, &fbb)
    SeradataRadarPayload_Ingest.add(swathWidth: swathWidth, &fbb)
    SeradataRadarPayload_Ingest.add(recorderSize: recorderSize, &fbb)
    SeradataRadarPayload_Ingest.add(fieldOfView: fieldOfView, &fbb)
    SeradataRadarPayload_Ingest.add(fieldOfRegard: fieldOfRegard, &fbb)
    SeradataRadarPayload_Ingest.add(pointingMethod: pointingMethod, &fbb)
    SeradataRadarPayload_Ingest.add(groundStations: groundStations, &fbb)
    SeradataRadarPayload_Ingest.add(groundStationLocations: groundStationLocations, &fbb)
    SeradataRadarPayload_Ingest.add(transmitPolarization: transmitPolarization, &fbb)
    SeradataRadarPayload_Ingest.add(receivePolarization: receivePolarization, &fbb)
    SeradataRadarPayload_Ingest.add(dutyCycle: dutyCycle, &fbb)
    SeradataRadarPayload_Ingest.add(partnerSpacecraft: partnerSpacecraft, &fbb)
    SeradataRadarPayload_Ingest.add(constellationInterferometricCapability: constellationInterferometricCapability, &fbb)
    SeradataRadarPayload_Ingest.add(notes: notes, &fbb)
    SeradataRadarPayload_Ingest.add(bandwidth: bandwidth, &fbb)
    SeradataRadarPayload_Ingest.add(createdAt: createdAt, &fbb)
    SeradataRadarPayload_Ingest.add(createdBy: createdBy, &fbb)
    SeradataRadarPayload_Ingest.add(source: source, &fbb)
    SeradataRadarPayload_Ingest.add(origin: origin, &fbb)
    SeradataRadarPayload_Ingest.add(origNetwork: origNetwork, &fbb)
    SeradataRadarPayload_Ingest.add(dataMode: dataMode, &fbb)
    return SeradataRadarPayload_Ingest.endSeradataRadarPayload_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SeradataRadarPayload_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
