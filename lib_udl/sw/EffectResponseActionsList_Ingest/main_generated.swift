...
public struct EffectResponseActionsList_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EffectResponseActionsList_Ingest.id, addPrefix: prefix) }
  ...
  public static func startEffectResponseActionsList_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 18) }
  ...
  public static func endEffectResponseActionsList_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEffectResponseActionsList_Ingest(
    ...
    let __start = EffectResponseActionsList_Ingest.startEffectResponseActionsList_Ingest(&fbb)
    EffectResponseActionsList_Ingest.add(summary: summary, &fbb)
    EffectResponseActionsList_Ingest.add(actionId: actionId, &fbb)
    EffectResponseActionsList_Ingest.add(actionStartTime: actionStartTime, &fbb)
    EffectResponseActionsList_Ingest.add(actionEndTime: actionEndTime, &fbb)
    EffectResponseActionsList_Ingest.add(totStartTime: totStartTime, &fbb)
    EffectResponseActionsList_Ingest.add(totEndTime: totEndTime, &fbb)
    EffectResponseActionsList_Ingest.add(actionActorSrcType: actionActorSrcType, &fbb)
    EffectResponseActionsList_Ingest.add(actionActorSrcId: actionActorSrcId, &fbb)
    EffectResponseActionsList_Ingest.add(effector: effector, &fbb)
    EffectResponseActionsList_Ingest.add(targetSrcType: targetSrcType, &fbb)
    EffectResponseActionsList_Ingest.add(targetSrcId: targetSrcId, &fbb)
    EffectResponseActionsList_Ingest.add(actorInterceptLat: actorInterceptLat, &fbb)
    EffectResponseActionsList_Ingest.add(actorInterceptLon: actorInterceptLon, &fbb)
    EffectResponseActionsList_Ingest.add(actorInterceptAlt: actorInterceptAlt, &fbb)
    EffectResponseActionsList_Ingest.add(weaponInterceptLat: weaponInterceptLat, &fbb)
    EffectResponseActionsList_Ingest.add(weaponInterceptLon: weaponInterceptLon, &fbb)
    EffectResponseActionsList_Ingest.add(weaponInterceptAlt: weaponInterceptAlt, &fbb)
    EffectResponseActionsList_Ingest.addVectorOf(actionMetrics: actionMetrics, &fbb)
    return EffectResponseActionsList_Ingest.endEffectResponseActionsList_Ingest(&fbb, start: __start)
  }
