...
public enum SortiePPR_Ingest_type_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SortiePPR_Ingest_type_Enum { return .c }
  public static var min: SortiePPR_Ingest_type_Enum { return .m }
}


public enum SortiePPR_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: SortiePPR_Ingest_dataMode_Enum { return .exercise }
  public static var min: SortiePPR_Ingest_dataMode_Enum { return .real }
}
...
public struct SortiePPR_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SortiePPR_Ingest.id, addPrefix: prefix) }
  ...
  public var type: SortiePPR_Ingest_type_Enum { let o = _accessor.offset(VTOFFSET.type.v); return o == 0 ? .m : SortiePPR_Ingest_type_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .m }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SortiePPR_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SortiePPR_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSortiePPR_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 18) }
  ...
  public static func add(type: SortiePPR_Ingest_type_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: type.rawValue, def: 0, at: VTOFFSET.type.p) }
  ...
  public static func add(dataMode: SortiePPR_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSortiePPR_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSortiePPR_Ingest(
    ...
    type: SortiePPR_Ingest_type_Enum = .m,
    ...
    let __start = SortiePPR_Ingest.startSortiePPR_Ingest(&fbb)
    SortiePPR_Ingest.add(id: id, &fbb)
    SortiePPR_Ingest.add(classificationMarking: classificationMarking, &fbb)
    SortiePPR_Ingest.add(idSortie: idSortie, &fbb)
    SortiePPR_Ingest.add(externalId: externalId, &fbb)
    SortiePPR_Ingest.add(number: number, &fbb)
    SortiePPR_Ingest.add(startTime: startTime, &fbb)
    SortiePPR_Ingest.add(endTime: endTime, &fbb)
    SortiePPR_Ingest.add(requestor: requestor, &fbb)
    SortiePPR_Ingest.add(grantor: grantor, &fbb)
    SortiePPR_Ingest.add(type: type, &fbb)
    SortiePPR_Ingest.add(remarks: remarks, &fbb)
    SortiePPR_Ingest.add(createdAt: createdAt, &fbb)
    SortiePPR_Ingest.add(createdBy: createdBy, &fbb)
    SortiePPR_Ingest.add(sourceDl: sourceDl, &fbb)
    SortiePPR_Ingest.add(source: source, &fbb)
    SortiePPR_Ingest.add(origin: origin, &fbb)
    SortiePPR_Ingest.add(origNetwork: origNetwork, &fbb)
    SortiePPR_Ingest.add(dataMode: dataMode, &fbb)
    return SortiePPR_Ingest.endSortiePPR_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.type.p, fieldName: "type", required: false, type: SortiePPR_Ingest_type_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SortiePPR_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
