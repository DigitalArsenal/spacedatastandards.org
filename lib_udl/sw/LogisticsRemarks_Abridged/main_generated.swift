...
public struct LogisticsRemarks_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LogisticsRemarks_Abridged.id, addPrefix: prefix) }
  ...
  public static func startLogisticsRemarks_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endLogisticsRemarks_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLogisticsRemarks_Abridged(
    _ fbb: inout FlatBufferBuilder,
    usernameOffset username: Offset = Offset(),
    remarkOffset remark: Offset = Offset(),
    lastChangedOffset lastChanged: Offset = Offset()
  ) -> Offset {
    let __start = LogisticsRemarks_Abridged.startLogisticsRemarks_Abridged(&fbb)
    LogisticsRemarks_Abridged.add(username: username, &fbb)
    LogisticsRemarks_Abridged.add(remark: remark, &fbb)
    LogisticsRemarks_Abridged.add(lastChanged: lastChanged, &fbb)
    return LogisticsRemarks_Abridged.endLogisticsRemarks_Abridged(&fbb, start: __start)
  }
