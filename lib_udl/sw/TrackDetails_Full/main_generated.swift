...
public enum TrackDetails_Full_env_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: TrackDetails_Full_env_Enum { return .unknown }
  public static var min: TrackDetails_Full_env_Enum { return .air }
}


public enum TrackDetails_Full_objIdent_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: TrackDetails_Full_objIdent_Enum { return .unknown }
  public static var min: TrackDetails_Full_objIdent_Enum { return .assumedFriend }
}


public enum TrackDetails_Full_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: TrackDetails_Full_dataMode_Enum { return .exercise }
  public static var min: TrackDetails_Full_dataMode_Enum { return .real }
}
...
public struct TrackDetails_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: TrackDetails_Full.id, addPrefix: prefix) }
  ...
  public var env: TrackDetails_Full_env_Enum { let o = _accessor.offset(VTOFFSET.env.v); return o == 0 ? .air : TrackDetails_Full_env_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .air }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 32
  public var objIdent: TrackDetails_Full_objIdent_Enum { let o = _accessor.offset(VTOFFSET.objIdent.v); return o == 0 ? .assumedFriend : TrackDetails_Full_objIdent_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .assumedFriend }
  ...
  public var dataMode: TrackDetails_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : TrackDetails_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 0, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startTrackDetails_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 158) }
  public static func add(id: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: id, at: VTOFFSET.id.p) }
  public static func add(classificationMarking: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: classificationMarking, at: VTOFFSET.classificationMarking.p) }
  public static func add(env: TrackDetails_Full_env_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: env.rawValue, def: 0, at: VTOFFSET.env.p) }
  ...
  public static func add(objIdent: TrackDetails_Full_objIdent_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: objIdent.rawValue, def: 0, at: VTOFFSET.objIdent.p) }
  ...
  public static func add(dataMode: TrackDetails_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endTrackDetails_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createTrackDetails_Full(
    ...
    objIdent: TrackDetails_Full_objIdent_Enum = .assumedFriend,
    ...
    let __start = TrackDetails_Full.startTrackDetails_Full(&fbb)
    TrackDetails_Full.add(id: id, &fbb)
    TrackDetails_Full.add(classificationMarking: classificationMarking, &fbb)
    TrackDetails_Full.add(env: env, &fbb)
    TrackDetails_Full.add(msgType: msgType, &fbb)
    TrackDetails_Full.add(hullNum: hullNum, &fbb)
    TrackDetails_Full.add(pif: pif, &fbb)
    TrackDetails_Full.add(sconum: sconum, &fbb)
    TrackDetails_Full.add(ntds: ntds, &fbb)
    TrackDetails_Full.add(disId: disId, &fbb)
    TrackDetails_Full.add(midbCat: midbCat, &fbb)
    TrackDetails_Full.add(beNumber: beNumber, &fbb)
    TrackDetails_Full.add(oSuffix: oSuffix, &fbb)
    TrackDetails_Full.add(pin: pin, &fbb)
    TrackDetails_Full.add(lostTrkInd: lostTrkInd, &fbb)
    TrackDetails_Full.add(muidSrcTrk: muidSrcTrk, &fbb)
    TrackDetails_Full.add(muidSrc: muidSrc, &fbb)
    TrackDetails_Full.add(mslStatus: mslStatus, &fbb)
    TrackDetails_Full.add(trkConf: trkConf, &fbb)
    TrackDetails_Full.add(trkQual: trkQual, &fbb)
    TrackDetails_Full.add(alert: alert, &fbb)
    TrackDetails_Full.add(origXref: origXref, &fbb)
    TrackDetails_Full.add(elnot1: elnot1, &fbb)
    TrackDetails_Full.add(elnot2: elnot2, &fbb)
    TrackDetails_Full.add(objIdent: objIdent, &fbb)
    TrackDetails_Full.add(objType: objType, &fbb)
    TrackDetails_Full.add(objPlat: objPlat, &fbb)
    TrackDetails_Full.add(objAct: objAct, &fbb)
    TrackDetails_Full.add(objNat: objNat, &fbb)
    TrackDetails_Full.add(name: name, &fbb)
    TrackDetails_Full.add(shortName: shortName, &fbb)
    TrackDetails_Full.add(trkId: trkId, &fbb)
    TrackDetails_Full.add(trkNum: trkNum, &fbb)
    TrackDetails_Full.add(trkScope: trkScope, &fbb)
    TrackDetails_Full.add(sourceUid: sourceUid, &fbb)
    TrackDetails_Full.add(callSign: callSign, &fbb)
    TrackDetails_Full.add(identAmp: identAmp, &fbb)
    TrackDetails_Full.add(spaceAmp: spaceAmp, &fbb)
    TrackDetails_Full.add(spaceAmpConf: spaceAmpConf, &fbb)
    TrackDetails_Full.add(spaceSpecType: spaceSpecType, &fbb)
    TrackDetails_Full.add(acftSubType: acftSubType, &fbb)
    TrackDetails_Full.add(ts: ts, &fbb)
    TrackDetails_Full.add(launchTime: launchTime, &fbb)
    TrackDetails_Full.add(impactTime: impactTime, &fbb)
    TrackDetails_Full.add(ftnMsgTs: ftnMsgTs, &fbb)
    TrackDetails_Full.add(ftn: ftn, &fbb)
    TrackDetails_Full.add(ftnCmd: ftnCmd, &fbb)
    TrackDetails_Full.addVectorOf(rtnMsgTs: rtnMsgTs, &fbb)
    TrackDetails_Full.addVectorOf(rtn: rtn, &fbb)
    TrackDetails_Full.add(rtnTrkState: rtnTrkState, &fbb)
    TrackDetails_Full.add(rtnCmd: rtnCmd, &fbb)
    TrackDetails_Full.add(sen: sen, &fbb)
    TrackDetails_Full.add(rptChxref: rptChxref, &fbb)
    TrackDetails_Full.add(rptArchived: rptArchived, &fbb)
    TrackDetails_Full.add(selfReport: selfReport, &fbb)
    TrackDetails_Full.add(mil2525Bstr: mil2525Bstr, &fbb)
    TrackDetails_Full.add(trnspdrId: trnspdrId, &fbb)
    TrackDetails_Full.add(trnspdrType: trnspdrType, &fbb)
    TrackDetails_Full.add(emitterName: emitterName, &fbb)
    TrackDetails_Full.add(infoSource: infoSource, &fbb)
    TrackDetails_Full.add(boosting: boosting, &fbb)
    TrackDetails_Full.add(freq: freq, &fbb)
    TrackDetails_Full.add(maxFreq: maxFreq, &fbb)
    TrackDetails_Full.add(harmonics: harmonics, &fbb)
    TrackDetails_Full.add(pri: pri, &fbb)
    TrackDetails_Full.add(prf: prf, &fbb)
    TrackDetails_Full.add(pw: pw, &fbb)
    TrackDetails_Full.add(scanType: scanType, &fbb)
    TrackDetails_Full.add(scanRate: scanRate, &fbb)
    TrackDetails_Full.add(scn: scn, &fbb)
    TrackDetails_Full.add(cI: cI, &fbb)
    TrackDetails_Full.add(angElev: angElev, &fbb)
    TrackDetails_Full.add(lat: lat, &fbb)
    TrackDetails_Full.add(lon: lon, &fbb)
    TrackDetails_Full.add(launchLat: launchLat, &fbb)
    TrackDetails_Full.add(launchLon: launchLon, &fbb)
    TrackDetails_Full.add(impactLat: impactLat, &fbb)
    TrackDetails_Full.add(impactLon: impactLon, &fbb)
    TrackDetails_Full.add(polarSingLocLat: polarSingLocLat, &fbb)
    TrackDetails_Full.add(polarSingLocLon: polarSingLocLon, &fbb)
    TrackDetails_Full.add(azCorrCenterLine: azCorrCenterLine, &fbb)
    TrackDetails_Full.add(azCorrArcWidth: azCorrArcWidth, &fbb)
    TrackDetails_Full.add(errSemiIntAxis: errSemiIntAxis, &fbb)
    TrackDetails_Full.add(errAreaOrient: errAreaOrient, &fbb)
    TrackDetails_Full.add(errSemiMajElev: errSemiMajElev, &fbb)
    TrackDetails_Full.add(errGeoAreaSwitch: errGeoAreaSwitch, &fbb)
    TrackDetails_Full.add(burnoutAlt: burnoutAlt, &fbb)
    TrackDetails_Full.add(tesEventId: tesEventId, &fbb)
    TrackDetails_Full.add(spd: spd, &fbb)
    TrackDetails_Full.add(avgSpd: avgSpd, &fbb)
    TrackDetails_Full.add(tol: tol, &fbb)
    TrackDetails_Full.add(alt: alt, &fbb)
    TrackDetails_Full.add(hdng: hdng, &fbb)
    TrackDetails_Full.add(course: course, &fbb)
    TrackDetails_Full.add(propRpm: propRpm, &fbb)
    TrackDetails_Full.add(tpk: tpk, &fbb)
    TrackDetails_Full.add(coopLocInd: coopLocInd, &fbb)
    TrackDetails_Full.add(maneuverInd: maneuverInd, &fbb)
    TrackDetails_Full.add(launchAouType: launchAouType, &fbb)
    TrackDetails_Full.addVectorOf(launchAouData: launchAouData, &fbb)
    TrackDetails_Full.add(impactAouType: impactAouType, &fbb)
    TrackDetails_Full.addVectorOf(impactAouData: impactAouData, &fbb)
    TrackDetails_Full.add(aouRptType: aouRptType, &fbb)
    TrackDetails_Full.addVectorOf(aouRptData: aouRptData, &fbb)
    TrackDetails_Full.addVectorOf(ecefPos: ecefPos, &fbb)
    TrackDetails_Full.addVectorOf(ecefVel: ecefVel, &fbb)
    TrackDetails_Full.add(containment: containment, &fbb)
    TrackDetails_Full.add(cpa: cpa, &fbb)
    TrackDetails_Full.add(tcpa: tcpa, &fbb)
    TrackDetails_Full.add(navStatus: navStatus, &fbb)
    TrackDetails_Full.add(posDeviceType: posDeviceType, &fbb)
    TrackDetails_Full.add(aton: aton, &fbb)
    TrackDetails_Full.add(offPosInd: offPosInd, &fbb)
    TrackDetails_Full.addVectorOf(antennaRefDimensions: antennaRefDimensions, &fbb)
    TrackDetails_Full.add(shipClass: shipClass, &fbb)
    TrackDetails_Full.add(imon: imon, &fbb)
    TrackDetails_Full.add(mmsi: mmsi, &fbb)
    TrackDetails_Full.add(draught: draught, &fbb)
    TrackDetails_Full.add(length: length, &fbb)
    TrackDetails_Full.add(width: width, &fbb)
    TrackDetails_Full.add(cargoType: cargoType, &fbb)
    TrackDetails_Full.add(appGrp: appGrp, &fbb)
    TrackDetails_Full.add(hullProf: hullProf, &fbb)
    TrackDetails_Full.add(propType: propType, &fbb)
    TrackDetails_Full.add(numBlades: numBlades, &fbb)
    TrackDetails_Full.add(numShafts: numShafts, &fbb)
    TrackDetails_Full.add(sternType: sternType, &fbb)
    TrackDetails_Full.add(vslWt: vslWt, &fbb)
    TrackDetails_Full.add(arrTime: arrTime, &fbb)
    TrackDetails_Full.add(arrFlag: arrFlag, &fbb)
    TrackDetails_Full.add(arrCargo: arrCargo, &fbb)
    TrackDetails_Full.add(arrPort: arrPort, &fbb)
    TrackDetails_Full.add(depPort: depPort, &fbb)
    TrackDetails_Full.add(depFlag: depFlag, &fbb)
    TrackDetails_Full.add(depCargo: depCargo, &fbb)
    TrackDetails_Full.add(desFlag: desFlag, &fbb)
    TrackDetails_Full.add(desCargo: desCargo, &fbb)
    TrackDetails_Full.add(destination: destination, &fbb)
    TrackDetails_Full.add(eta: eta, &fbb)
    TrackDetails_Full.add(etd: etd, &fbb)
    TrackDetails_Full.add(iff: iff, &fbb)
    TrackDetails_Full.add(emgInd: emgInd, &fbb)
    TrackDetails_Full.add(dropPtInd: dropPtInd, &fbb)
    TrackDetails_Full.add(reinforced: reinforced, &fbb)
    TrackDetails_Full.add(reduced: reduced, &fbb)
    TrackDetails_Full.add(hq: hq, &fbb)
    TrackDetails_Full.add(dummy: dummy, &fbb)
    TrackDetails_Full.add(taskForce: taskForce, &fbb)
    TrackDetails_Full.add(feint: feint, &fbb)
    TrackDetails_Full.add(installation: installation, &fbb)
    TrackDetails_Full.add(staffCmts: staffCmts, &fbb)
    TrackDetails_Full.add(addInfo: addInfo, &fbb)
    TrackDetails_Full.add(evalRating: evalRating, &fbb)
    TrackDetails_Full.add(createdAt: createdAt, &fbb)
    TrackDetails_Full.add(createdBy: createdBy, &fbb)
    TrackDetails_Full.add(source: source, &fbb)
    TrackDetails_Full.add(origin: origin, &fbb)
    TrackDetails_Full.add(dataMode: dataMode, &fbb)
    TrackDetails_Full.add(origNetwork: origNetwork, &fbb)
    return TrackDetails_Full.endTrackDetails_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.env.p, fieldName: "env", required: false, type: TrackDetails_Full_env_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.objIdent.p, fieldName: "objIdent", required: false, type: TrackDetails_Full_objIdent_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: TrackDetails_Full_dataMode_Enum.self)
