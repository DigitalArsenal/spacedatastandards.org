...
public enum Bus_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Bus_Abridged_dataMode_Enum { return .exercise }
  public static var min: Bus_Abridged_dataMode_Enum { return .real }
}
...
public struct Bus_Abridged: FlatBufferObject, Verifiable {

  static func validateVersion() { FlatBuffersVersion_24_3_25() }
  public var __buffer: ByteBuffer! { return _accessor.bb }
  private var _accessor: Table

  public static var id: String { "BUSA" } 
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Bus_Abridged.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case telemetryTrackingManufacturerOrgId = 82
    case mainComputerManufacturerOrgId = 84
    case manufacturerOrgId = 86
    case busKitDesignerOrgId = 88
    case countryCode = 90
    case massCategory = 92
    case powerCategory = 94
    case generic = 96
    case description = 98
    case aocsNotes = 100
    case source = 102
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Bus_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Bus_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startBus_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 55) }
  ...
  public static func add(dataMode: Bus_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func endBus_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createBus_Abridged(
    ...
    let __start = Bus_Abridged.startBus_Abridged(&fbb)
    Bus_Abridged.add(id: id, &fbb)
    Bus_Abridged.add(name: name, &fbb)
    Bus_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Bus_Abridged.add(idEntity: idEntity, &fbb)
    Bus_Abridged.add(type: type, &fbb)
    Bus_Abridged.add(maxLaunchMassLower: maxLaunchMassLower, &fbb)
    Bus_Abridged.add(maxLaunchMassUpper: maxLaunchMassUpper, &fbb)
    Bus_Abridged.add(maxBolstationMass: maxBolstationMass, &fbb)
    Bus_Abridged.add(avgPayloadMass: avgPayloadMass, &fbb)
    Bus_Abridged.add(maxPayloadMass: maxPayloadMass, &fbb)
    Bus_Abridged.add(minDryMass: minDryMass, &fbb)
    Bus_Abridged.add(avgDryMass: avgDryMass, &fbb)
    Bus_Abridged.add(medianDryMass: medianDryMass, &fbb)
    Bus_Abridged.add(maxDryMass: maxDryMass, &fbb)
    Bus_Abridged.add(minWetMass: minWetMass, &fbb)
    Bus_Abridged.add(avgWetMass: avgWetMass, &fbb)
    Bus_Abridged.add(medianWetMass: medianWetMass, &fbb)
    Bus_Abridged.add(maxWetMass: maxWetMass, &fbb)
    Bus_Abridged.add(maxBolpowerLower: maxBolpowerLower, &fbb)
    Bus_Abridged.add(maxBolpowerUpper: maxBolpowerUpper, &fbb)
    Bus_Abridged.add(maxEolpowerLower: maxEolpowerLower, &fbb)
    Bus_Abridged.add(maxEolpowerUpper: maxEolpowerUpper, &fbb)
    Bus_Abridged.add(avgSpacecraftPower: avgSpacecraftPower, &fbb)
    Bus_Abridged.add(maxSpacecraftPower: maxSpacecraftPower, &fbb)
    Bus_Abridged.add(oapSpacecraftPower: oapSpacecraftPower, &fbb)
    Bus_Abridged.add(avgPayloadPower: avgPayloadPower, &fbb)
    Bus_Abridged.add(maxPayloadPower: maxPayloadPower, &fbb)
    Bus_Abridged.add(oapPayloadPower: oapPayloadPower, &fbb)
    Bus_Abridged.add(bodyDimensionX: bodyDimensionX, &fbb)
    Bus_Abridged.add(bodyDimensionY: bodyDimensionY, &fbb)
    Bus_Abridged.add(bodyDimensionZ: bodyDimensionZ, &fbb)
    Bus_Abridged.add(payloadDimensionX: payloadDimensionX, &fbb)
    Bus_Abridged.add(payloadDimensionY: payloadDimensionY, &fbb)
    Bus_Abridged.add(payloadDimensionZ: payloadDimensionZ, &fbb)
    Bus_Abridged.add(payloadVolume: payloadVolume, &fbb)
    Bus_Abridged.add(launchEnvelopeDimensionX: launchEnvelopeDimensionX, &fbb)
    Bus_Abridged.add(launchEnvelopeDimensionY: launchEnvelopeDimensionY, &fbb)
    Bus_Abridged.add(launchEnvelopeDimensionZ: launchEnvelopeDimensionZ, &fbb)
    Bus_Abridged.add(numOrbitType: numOrbitType, &fbb)
    Bus_Abridged.add(telemetryTrackingManufacturerOrgId: telemetryTrackingManufacturerOrgId, &fbb)
    Bus_Abridged.add(mainComputerManufacturerOrgId: mainComputerManufacturerOrgId, &fbb)
    Bus_Abridged.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    Bus_Abridged.add(busKitDesignerOrgId: busKitDesignerOrgId, &fbb)
    Bus_Abridged.add(countryCode: countryCode, &fbb)
    Bus_Abridged.add(massCategory: massCategory, &fbb)
    Bus_Abridged.add(powerCategory: powerCategory, &fbb)
    Bus_Abridged.add(generic: generic, &fbb)
    Bus_Abridged.add(description: description, &fbb)
    Bus_Abridged.add(aocsNotes: aocsNotes, &fbb)
    Bus_Abridged.add(source: source, &fbb)
    Bus_Abridged.add(origin: origin, &fbb)
    Bus_Abridged.add(origNetwork: origNetwork, &fbb)
    Bus_Abridged.add(dataMode: dataMode, &fbb)
    Bus_Abridged.add(createdAt: createdAt, &fbb)
    Bus_Abridged.add(createdBy: createdBy, &fbb)
    return Bus_Abridged.endBus_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Bus_Abridged_dataMode_Enum.self)
