...
public enum POI_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: POI_Full_dataMode_Enum { return .exercise }
  public static var min: POI_Full_dataMode_Enum { return .real }
}
...
public struct POI_Full: FlatBufferObject, Verifiable {

  static func validateVersion() { FlatBuffersVersion_24_3_25() }
  public var __buffer: ByteBuffer! { return _accessor.bb }
  private var _accessor: Table

  public static var id: String { "POIF" } 
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: POI_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: POI_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : POI_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startPOI_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 52) }
  ...
  public static func add(dataMode: POI_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endPOI_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPOI_Full(
    ...
    let __start = POI_Full.startPOI_Full(&fbb)
    POI_Full.add(id: id, &fbb)
    POI_Full.add(classificationMarking: classificationMarking, &fbb)
    POI_Full.add(pps: pps, &fbb)
    POI_Full.add(msnid: msnid, &fbb)
    POI_Full.add(pri: pri, &fbb)
    POI_Full.add(trkid: trkid, &fbb)
    POI_Full.addVectorOf(idWeatherReport: idWeatherReport, &fbb)
    POI_Full.add(poiid: poiid, &fbb)
    POI_Full.add(name: name, &fbb)
    POI_Full.add(desc: desc, &fbb)
    POI_Full.add(spec: spec, &fbb)
    POI_Full.add(ident: ident, &fbb)
    POI_Full.add(env: env, &fbb)
    POI_Full.add(plat: plat, &fbb)
    POI_Full.add(activity: activity, &fbb)
    POI_Full.add(ts: ts, &fbb)
    POI_Full.add(start: start, &fbb)
    POI_Full.add(stale: stale, &fbb)
    POI_Full.add(how: how, &fbb)
    POI_Full.add(type: type, &fbb)
    POI_Full.add(lat: lat, &fbb)
    POI_Full.add(lon: lon, &fbb)
    POI_Full.add(alt: alt, &fbb)
    POI_Full.add(az: az, &fbb)
    POI_Full.add(el: el, &fbb)
    POI_Full.add(le: le, &fbb)
    POI_Full.add(ce: ce, &fbb)
    POI_Full.addVectorOf(elle: elle, &fbb)
    POI_Full.add(cntct: cntct, &fbb)
    POI_Full.add(conf: conf, &fbb)
    POI_Full.addVectorOf(urls: urls, &fbb)
    POI_Full.add(area: area, &fbb)
    POI_Full.add(atext: atext, &fbb)
    POI_Full.add(agjson: agjson, &fbb)
    POI_Full.add(atype: atype, &fbb)
    POI_Full.add(andims: andims, &fbb)
    POI_Full.add(asrid: asrid, &fbb)
    POI_Full.add(createdAt: createdAt, &fbb)
    POI_Full.add(createdBy: createdBy, &fbb)
    POI_Full.add(sourceDl: sourceDl, &fbb)
    POI_Full.add(source: source, &fbb)
    POI_Full.add(dataMode: dataMode, &fbb)
    POI_Full.add(origin: origin, &fbb)
    POI_Full.addVectorOf(groups: groups, &fbb)
    POI_Full.add(asset: asset, &fbb)
    POI_Full.addVectorOf(tags: tags, &fbb)
    POI_Full.addVectorOf(srcTyps: srcTyps, &fbb)
    POI_Full.addVectorOf(srcIds: srcIds, &fbb)
    POI_Full.add(beNumber: beNumber, &fbb)
    POI_Full.add(orientation: orientation, &fbb)
    POI_Full.add(origNetwork: origNetwork, &fbb)
    POI_Full.add(transactionId: transactionId, &fbb)
    return POI_Full.endPOI_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: POI_Full_dataMode_Enum.self)
