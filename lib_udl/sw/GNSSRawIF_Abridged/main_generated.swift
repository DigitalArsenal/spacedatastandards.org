...
public enum GNSSRawIF_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: GNSSRawIF_Abridged_dataMode_Enum { return .exercise }
  public static var min: GNSSRawIF_Abridged_dataMode_Enum { return .real }
}
...
public struct GNSSRawIF_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: GNSSRawIF_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: GNSSRawIF_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : GNSSRawIF_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startGNSSRawIF_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 40) }
  ...
  public static func add(dataMode: GNSSRawIF_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endGNSSRawIF_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createGNSSRawIF_Abridged(
    ...
    let __start = GNSSRawIF_Abridged.startGNSSRawIF_Abridged(&fbb)
    GNSSRawIF_Abridged.add(id: id, &fbb)
    GNSSRawIF_Abridged.add(classificationMarking: classificationMarking, &fbb)
    GNSSRawIF_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    GNSSRawIF_Abridged.add(satNo: satNo, &fbb)
    GNSSRawIF_Abridged.add(origObjectId: origObjectId, &fbb)
    GNSSRawIF_Abridged.add(esId: esId, &fbb)
    GNSSRawIF_Abridged.add(receiver: receiver, &fbb)
    GNSSRawIF_Abridged.addVectorOf(boresight: boresight, &fbb)
    GNSSRawIF_Abridged.addVectorOf(quat: quat, &fbb)
    GNSSRawIF_Abridged.add(startIndex: startIndex, &fbb)
    GNSSRawIF_Abridged.add(startTime: startTime, &fbb)
    GNSSRawIF_Abridged.add(endTime: endTime, &fbb)
    GNSSRawIF_Abridged.add(startLat: startLat, &fbb)
    GNSSRawIF_Abridged.add(startLon: startLon, &fbb)
    GNSSRawIF_Abridged.add(startAlt: startAlt, &fbb)
    GNSSRawIF_Abridged.add(endLat: endLat, &fbb)
    GNSSRawIF_Abridged.add(endLon: endLon, &fbb)
    GNSSRawIF_Abridged.add(endAlt: endAlt, &fbb)
    GNSSRawIF_Abridged.addVectorOf(centerFreq: centerFreq, &fbb)
    GNSSRawIF_Abridged.addVectorOf(ifFreq: ifFreq, &fbb)
    GNSSRawIF_Abridged.addVectorOf(sampleRate: sampleRate, &fbb)
    GNSSRawIF_Abridged.addVectorOf(postFourier: postFourier, &fbb)
    GNSSRawIF_Abridged.add(sampleType: sampleType, &fbb)
    GNSSRawIF_Abridged.add(bitDepth: bitDepth, &fbb)
    GNSSRawIF_Abridged.addVectorOf(diffCodeBias: diffCodeBias, &fbb)
    GNSSRawIF_Abridged.add(dataRate: dataRate, &fbb)
    GNSSRawIF_Abridged.add(setId: setId, &fbb)
    GNSSRawIF_Abridged.add(setLength: setLength, &fbb)
    GNSSRawIF_Abridged.add(sequenceId: sequenceId, &fbb)
    GNSSRawIF_Abridged.add(fileName: fileName, &fbb)
    GNSSRawIF_Abridged.addVectorOf(srcTyps: srcTyps, &fbb)
    GNSSRawIF_Abridged.addVectorOf(srcIds: srcIds, &fbb)
    GNSSRawIF_Abridged.add(fileSize: fileSize, &fbb)
    GNSSRawIF_Abridged.addVectorOf(tags: tags, &fbb)
    GNSSRawIF_Abridged.add(createdAt: createdAt, &fbb)
    GNSSRawIF_Abridged.add(createdBy: createdBy, &fbb)
    GNSSRawIF_Abridged.add(source: source, &fbb)
    GNSSRawIF_Abridged.add(origin: origin, &fbb)
    GNSSRawIF_Abridged.add(dataMode: dataMode, &fbb)
    GNSSRawIF_Abridged.add(origNetwork: origNetwork, &fbb)
    return GNSSRawIF_Abridged.endGNSSRawIF_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: GNSSRawIF_Abridged_dataMode_Enum.self)
