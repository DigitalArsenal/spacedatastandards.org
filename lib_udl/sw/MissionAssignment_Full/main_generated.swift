...
public enum MissionAssignment_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: MissionAssignment_Full_dataMode_Enum { return .exercise }
  public static var min: MissionAssignment_Full_dataMode_Enum { return .real }
}


///  /// Platform mission assignment data.
public struct MissionAssignment_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MissionAssignment_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: MissionAssignment_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : MissionAssignment_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startMissionAssignment_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 68) }
  ...
  public static func add(dataMode: MissionAssignment_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endMissionAssignment_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMissionAssignment_Full(
    ...
    let __start = MissionAssignment_Full.startMissionAssignment_Full(&fbb)
    MissionAssignment_Full.add(id: id, &fbb)
    MissionAssignment_Full.add(classificationMarking: classificationMarking, &fbb)
    MissionAssignment_Full.add(trkId: trkId, &fbb)
    MissionAssignment_Full.add(ts: ts, &fbb)
    MissionAssignment_Full.add(mad: mad, &fbb)
    MissionAssignment_Full.add(rc: rc, &fbb)
    MissionAssignment_Full.add(rr: rr, &fbb)
    MissionAssignment_Full.add(tno: tno, &fbb)
    MissionAssignment_Full.add(twenv: twenv, &fbb)
    MissionAssignment_Full.add(lat: lat, &fbb)
    MissionAssignment_Full.add(lon: lon, &fbb)
    MissionAssignment_Full.add(orginx: orginx, &fbb)
    MissionAssignment_Full.add(env: env, &fbb)
    MissionAssignment_Full.add(sz: sz, &fbb)
    MissionAssignment_Full.add(index: index, &fbb)
    MissionAssignment_Full.add(c1associateddmpis: c1associateddmpis, &fbb)
    MissionAssignment_Full.add(c2spc: c2spc, &fbb)
    MissionAssignment_Full.add(c2air: c2air, &fbb)
    MissionAssignment_Full.add(c2sur: c2sur, &fbb)
    MissionAssignment_Full.add(c2lnd: c2lnd, &fbb)
    MissionAssignment_Full.add(c2id: c2id, &fbb)
    MissionAssignment_Full.add(c2idamplifyingdescriptor: c2idamplifyingdescriptor, &fbb)
    MissionAssignment_Full.add(c2alt: c2alt, &fbb)
    MissionAssignment_Full.add(c2crs: c2crs, &fbb)
    MissionAssignment_Full.add(c2spd: c2spd, &fbb)
    MissionAssignment_Full.add(c2specialinterestindicator: c2specialinterestindicator, &fbb)
    MissionAssignment_Full.add(c2exerciseindicator: c2exerciseindicator, &fbb)
    MissionAssignment_Full.add(c2exercisemof: c2exercisemof, &fbb)
    MissionAssignment_Full.add(c3lat: c3lat, &fbb)
    MissionAssignment_Full.add(c3lon: c3lon, &fbb)
    MissionAssignment_Full.add(c3elv: c3elv, &fbb)
    MissionAssignment_Full.add(c3ptl: c3ptl, &fbb)
    MissionAssignment_Full.add(c3ptnum: c3ptnum, &fbb)
    MissionAssignment_Full.add(c4tgt: c4tgt, &fbb)
    MissionAssignment_Full.add(c4def: c4def, &fbb)
    MissionAssignment_Full.add(c4runin: c4runin, &fbb)
    MissionAssignment_Full.add(c4egress: c4egress, &fbb)
    MissionAssignment_Full.add(c4numberofstores: c4numberofstores, &fbb)
    MissionAssignment_Full.add(c4typeofstores: c4typeofstores, &fbb)
    MissionAssignment_Full.add(c4timediscrete: c4timediscrete, &fbb)
    MissionAssignment_Full.add(c4tm: c4tm, &fbb)
    MissionAssignment_Full.add(c4colon: c4colon, &fbb)
    MissionAssignment_Full.add(c4mod: c4mod, &fbb)
    MissionAssignment_Full.add(c5haeadj: c5haeadj, &fbb)
    MissionAssignment_Full.add(c5tw: c5tw, &fbb)
    MissionAssignment_Full.add(c5tgtbrng: c5tgtbrng, &fbb)
    MissionAssignment_Full.add(c5latlsb: c5latlsb, &fbb)
    MissionAssignment_Full.add(c5lonlsb: c5lonlsb, &fbb)
    MissionAssignment_Full.add(c5elevationlsbs: c5elevationlsbs, &fbb)
    MissionAssignment_Full.add(c5colon: c5colon, &fbb)
    MissionAssignment_Full.add(c6laser: c6laser, &fbb)
    MissionAssignment_Full.add(c6intel: c6intel, &fbb)
    MissionAssignment_Full.add(c6tnr3: c6tnr3, &fbb)
    MissionAssignment_Full.add(c6dspct: c6dspct, &fbb)
    MissionAssignment_Full.add(c6dspc: c6dspc, &fbb)
    MissionAssignment_Full.add(c6fplpm: c6fplpm, &fbb)
    MissionAssignment_Full.add(c6longpm: c6longpm, &fbb)
    MissionAssignment_Full.add(c7tnor: c7tnor, &fbb)
    MissionAssignment_Full.add(c7in3p: c7in3p, &fbb)
    MissionAssignment_Full.add(c7elang2: c7elang2, &fbb)
    MissionAssignment_Full.add(createdAt: createdAt, &fbb)
    MissionAssignment_Full.add(createdBy: createdBy, &fbb)
    MissionAssignment_Full.add(updatedAt: updatedAt, &fbb)
    MissionAssignment_Full.add(updatedBy: updatedBy, &fbb)
    MissionAssignment_Full.add(source: source, &fbb)
    MissionAssignment_Full.add(origin: origin, &fbb)
    MissionAssignment_Full.add(dataMode: dataMode, &fbb)
    MissionAssignment_Full.add(origNetwork: origNetwork, &fbb)
    return MissionAssignment_Full.endMissionAssignment_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: MissionAssignment_Full_dataMode_Enum.self)
