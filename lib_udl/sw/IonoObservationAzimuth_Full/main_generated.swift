...
public struct IonoObservationAzimuth_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationAzimuth_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationAzimuth_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationAzimuth_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationAzimuth_Full(
    ...
    let __start = IonoObservationAzimuth_Full.startIonoObservationAzimuth_Full(&fbb)
    IonoObservationAzimuth_Full.add(notes: notes, &fbb)
    IonoObservationAzimuth_Full.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationAzimuth_Full.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationAzimuth_Full.addVectorOf(data: data, &fbb)
    return IonoObservationAzimuth_Full.endIonoObservationAzimuth_Full(&fbb, start: __start)
  }
