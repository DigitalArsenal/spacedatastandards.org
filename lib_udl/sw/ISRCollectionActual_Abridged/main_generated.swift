...
public struct ISRCollectionActual_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollectionActual_Abridged.id, addPrefix: prefix) }
  ...
  public static func startISRCollectionActual_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endISRCollectionActual_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollectionActual_Abridged(
    _ fbb: inout FlatBufferBuilder,
    idOffset id: Offset = Offset(),
    startOffset start: Offset = Offset(),
    stopOffset stop: Offset = Offset()
  ) -> Offset {
    let __start = ISRCollectionActual_Abridged.startISRCollectionActual_Abridged(&fbb)
    ISRCollectionActual_Abridged.add(id: id, &fbb)
    ISRCollectionActual_Abridged.add(start: start, &fbb)
    ISRCollectionActual_Abridged.add(stop: stop, &fbb)
    return ISRCollectionActual_Abridged.endISRCollectionActual_Abridged(&fbb, start: __start)
  }
