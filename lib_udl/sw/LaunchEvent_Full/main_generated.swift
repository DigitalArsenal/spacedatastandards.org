...
public enum LaunchEvent_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: LaunchEvent_Full_dataMode_Enum { return .exercise }
  public static var min: LaunchEvent_Full_dataMode_Enum { return .real }
}


///  /// Information on known launch events.
public struct LaunchEvent_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LaunchEvent_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: LaunchEvent_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : LaunchEvent_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startLaunchEvent_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 21) }
  ...
  public static func add(dataMode: LaunchEvent_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endLaunchEvent_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLaunchEvent_Full(
    ...
    let __start = LaunchEvent_Full.startLaunchEvent_Full(&fbb)
    LaunchEvent_Full.add(id: id, &fbb)
    LaunchEvent_Full.add(idOnOrbit: idOnOrbit, &fbb)
    LaunchEvent_Full.add(origObjectId: origObjectId, &fbb)
    LaunchEvent_Full.add(classificationMarking: classificationMarking, &fbb)
    LaunchEvent_Full.add(derivedFrom: derivedFrom, &fbb)
    LaunchEvent_Full.add(declassificationDate: declassificationDate, &fbb)
    LaunchEvent_Full.add(declassificationString: declassificationString, &fbb)
    LaunchEvent_Full.add(msgCreateDate: msgCreateDate, &fbb)
    LaunchEvent_Full.add(launchFailureCode: launchFailureCode, &fbb)
    LaunchEvent_Full.add(launchDate: launchDate, &fbb)
    LaunchEvent_Full.add(beNumber: beNumber, &fbb)
    LaunchEvent_Full.add(oSuffix: oSuffix, &fbb)
    LaunchEvent_Full.add(launchFacilityName: launchFacilityName, &fbb)
    LaunchEvent_Full.add(createdAt: createdAt, &fbb)
    LaunchEvent_Full.add(createdBy: createdBy, &fbb)
    LaunchEvent_Full.add(origin: origin, &fbb)
    LaunchEvent_Full.add(source: source, &fbb)
    LaunchEvent_Full.add(dataMode: dataMode, &fbb)
    LaunchEvent_Full.add(origNetwork: origNetwork, &fbb)
    LaunchEvent_Full.add(onOrbit: onOrbit, &fbb)
    LaunchEvent_Full.add(satNo: satNo, &fbb)
    return LaunchEvent_Full.endLaunchEvent_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: LaunchEvent_Full_dataMode_Enum.self)
