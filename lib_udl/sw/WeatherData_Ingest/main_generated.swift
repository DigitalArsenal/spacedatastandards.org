...
public enum WeatherData_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: WeatherData_Ingest_dataMode_Enum { return .exercise }
  public static var min: WeatherData_Ingest_dataMode_Enum { return .real }
}
...
public struct WeatherData_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: WeatherData_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: WeatherData_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : WeatherData_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startWeatherData_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 39) }
  ...
  public static func add(dataMode: WeatherData_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endWeatherData_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createWeatherData_Ingest(
    ...
    let __start = WeatherData_Ingest.startWeatherData_Ingest(&fbb)
    WeatherData_Ingest.add(id: id, &fbb)
    WeatherData_Ingest.add(classificationMarking: classificationMarking, &fbb)
    WeatherData_Ingest.add(idSensor: idSensor, &fbb)
    WeatherData_Ingest.add(origSensorId: origSensorId, &fbb)
    WeatherData_Ingest.add(obTime: obTime, &fbb)
    WeatherData_Ingest.addVectorOf(sigPwrs: sigPwrs, &fbb)
    WeatherData_Ingest.addVectorOf(noiseLvls: noiseLvls, &fbb)
    WeatherData_Ingest.addVectorOf(specWidths: specWidths, &fbb)
    WeatherData_Ingest.addVectorOf(firstGuessAvgs: firstGuessAvgs, &fbb)
    WeatherData_Ingest.add(qcValue: qcValue, &fbb)
    WeatherData_Ingest.add(fileCreation: fileCreation, &fbb)
    WeatherData_Ingest.add(termAlt: termAlt, &fbb)
    WeatherData_Ingest.add(avgTxPwr: avgTxPwr, &fbb)
    WeatherData_Ingest.add(avgRefPwr: avgRefPwr, &fbb)
    WeatherData_Ingest.add(sectorNum: sectorNum, &fbb)
    WeatherData_Ingest.add(numElements: numElements, &fbb)
    WeatherData_Ingest.addVectorOf(tdAvgSampleNums: tdAvgSampleNums, &fbb)
    WeatherData_Ingest.add(checksum: checksum, &fbb)
    WeatherData_Ingest.addVectorOf(coIntegs: coIntegs, &fbb)
    WeatherData_Ingest.addVectorOf(specAvgs: specAvgs, &fbb)
    WeatherData_Ingest.addVectorOf(interpulsePeriods: interpulsePeriods, &fbb)
    WeatherData_Ingest.addVectorOf(doppVels: doppVels, &fbb)
    WeatherData_Ingest.addVectorOf(consRecs: consRecs, &fbb)
    WeatherData_Ingest.addVectorOf(snrs: snrs, &fbb)
    WeatherData_Ingest.add(sigStrength: sigStrength, &fbb)
    WeatherData_Ingest.add(semiMajorAxis: semiMajorAxis, &fbb)
    WeatherData_Ingest.add(semiMinorAxis: semiMinorAxis, &fbb)
    WeatherData_Ingest.add(angleOrientation: angleOrientation, &fbb)
    WeatherData_Ingest.add(lightEventNum: lightEventNum, &fbb)
    WeatherData_Ingest.addVectorOf(lightDetSensors: lightDetSensors, &fbb)
    WeatherData_Ingest.add(posConfidence: posConfidence, &fbb)
    WeatherData_Ingest.addVectorOf(srcTyps: srcTyps, &fbb)
    WeatherData_Ingest.addVectorOf(srcIds: srcIds, &fbb)
    WeatherData_Ingest.add(origNetwork: origNetwork, &fbb)
    WeatherData_Ingest.add(createdAt: createdAt, &fbb)
    WeatherData_Ingest.add(createdBy: createdBy, &fbb)
    WeatherData_Ingest.add(source: source, &fbb)
    WeatherData_Ingest.add(origin: origin, &fbb)
    WeatherData_Ingest.add(dataMode: dataMode, &fbb)
    return WeatherData_Ingest.endWeatherData_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: WeatherData_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
