...
public struct IonoObservationCharAtts_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationCharAtts_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationCharAtts_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 10) }
  ...
  public static func endIonoObservationCharAtts_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationCharAtts_Ingest(
    ...
    let __start = IonoObservationCharAtts_Ingest.startIonoObservationCharAtts_Ingest(&fbb)
    IonoObservationCharAtts_Ingest.add(ursiId: ursiId, &fbb)
    IonoObservationCharAtts_Ingest.add(charName: charName, &fbb)
    IonoObservationCharAtts_Ingest.add(lowerBound: lowerBound, &fbb)
    IonoObservationCharAtts_Ingest.add(upperBound: upperBound, &fbb)
    IonoObservationCharAtts_Ingest.add(q: q, &fbb)
    IonoObservationCharAtts_Ingest.add(d: d, &fbb)
    IonoObservationCharAtts_Ingest.add(climateModelName: climateModelName, &fbb)
    IonoObservationCharAtts_Ingest.addVectorOf(climateModelOptions: climateModelOptions, &fbb)
    IonoObservationCharAtts_Ingest.addVectorOf(climateModelInputParams: climateModelInputParams, &fbb)
    IonoObservationCharAtts_Ingest.add(uncertaintyBoundType: uncertaintyBoundType, &fbb)
    return IonoObservationCharAtts_Ingest.endIonoObservationCharAtts_Ingest(&fbb, start: __start)
  }
