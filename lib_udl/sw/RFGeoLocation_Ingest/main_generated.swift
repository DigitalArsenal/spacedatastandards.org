...
public enum RFGeoLocation_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: RFGeoLocation_Ingest_dataMode_Enum { return .exercise }
  public static var min: RFGeoLocation_Ingest_dataMode_Enum { return .real }
}


///  /// Model representation of geolocation data for a radio frequency (RF) signal or emitter.
public struct RFGeoLocation_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: RFGeoLocation_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: RFGeoLocation_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : RFGeoLocation_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startRFGeoLocation_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 42) }
  ...
  public static func add(dataMode: RFGeoLocation_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endRFGeoLocation_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createRFGeoLocation_Ingest(
    ...
    let __start = RFGeoLocation_Ingest.startRFGeoLocation_Ingest(&fbb)
    RFGeoLocation_Ingest.add(id: id, &fbb)
    RFGeoLocation_Ingest.add(classificationMarking: classificationMarking, &fbb)
    RFGeoLocation_Ingest.add(orderId: orderId, &fbb)
    RFGeoLocation_Ingest.add(createdTs: createdTs, &fbb)
    RFGeoLocation_Ingest.add(receivedTs: receivedTs, &fbb)
    RFGeoLocation_Ingest.add(startTime: startTime, &fbb)
    RFGeoLocation_Ingest.add(endTime: endTime, &fbb)
    RFGeoLocation_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    RFGeoLocation_Ingest.add(satNo: satNo, &fbb)
    RFGeoLocation_Ingest.add(origObjectId: origObjectId, &fbb)
    RFGeoLocation_Ingest.add(constellation: constellation, &fbb)
    RFGeoLocation_Ingest.add(signalOfInterest: signalOfInterest, &fbb)
    RFGeoLocation_Ingest.add(idRfemitter: idRfemitter, &fbb)
    RFGeoLocation_Ingest.add(origRfemitterId: origRfemitterId, &fbb)
    RFGeoLocation_Ingest.add(numBursts: numBursts, &fbb)
    RFGeoLocation_Ingest.add(minFreq: minFreq, &fbb)
    RFGeoLocation_Ingest.add(maxFreq: maxFreq, &fbb)
    RFGeoLocation_Ingest.add(centerFreq: centerFreq, &fbb)
    RFGeoLocation_Ingest.add(detectLat: detectLat, &fbb)
    RFGeoLocation_Ingest.add(detectLon: detectLon, &fbb)
    RFGeoLocation_Ingest.add(detectAlt: detectAlt, &fbb)
    RFGeoLocation_Ingest.add(confSemiMajor: confSemiMajor, &fbb)
    RFGeoLocation_Ingest.add(confSemiMinor: confSemiMinor, &fbb)
    RFGeoLocation_Ingest.add(confOrientation: confOrientation, &fbb)
    RFGeoLocation_Ingest.add(confArea: confArea, &fbb)
    RFGeoLocation_Ingest.add(atype: atype, &fbb)
    RFGeoLocation_Ingest.add(agjson: agjson, &fbb)
    RFGeoLocation_Ingest.add(atext: atext, &fbb)
    RFGeoLocation_Ingest.add(area: area, &fbb)
    RFGeoLocation_Ingest.add(andims: andims, &fbb)
    RFGeoLocation_Ingest.add(asrid: asrid, &fbb)
    RFGeoLocation_Ingest.add(passGroupId: passGroupId, &fbb)
    RFGeoLocation_Ingest.add(algVersion: algVersion, &fbb)
    RFGeoLocation_Ingest.add(externalId: externalId, &fbb)
    RFGeoLocation_Ingest.addVectorOf(tags: tags, &fbb)
    RFGeoLocation_Ingest.add(createdAt: createdAt, &fbb)
    RFGeoLocation_Ingest.add(createdBy: createdBy, &fbb)
    RFGeoLocation_Ingest.add(source: source, &fbb)
    RFGeoLocation_Ingest.add(origin: origin, &fbb)
    RFGeoLocation_Ingest.add(origNetwork: origNetwork, &fbb)
    RFGeoLocation_Ingest.add(sourceDl: sourceDl, &fbb)
    RFGeoLocation_Ingest.add(dataMode: dataMode, &fbb)
    return RFGeoLocation_Ingest.endRFGeoLocation_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: RFGeoLocation_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
