...
public struct IonoObservationDensityProfileQuasiParabolicSegment_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDensityProfileQuasiParabolicSegment_Abridged.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDensityProfileQuasiParabolicSegment_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 7) }
  ...
  public static func endIonoObservationDensityProfileQuasiParabolicSegment_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDensityProfileQuasiParabolicSegment_Abridged(
    ...
    let __start = IonoObservationDensityProfileQuasiParabolicSegment_Abridged.startIonoObservationDensityProfileQuasiParabolicSegment_Abridged(&fbb)
    IonoObservationDensityProfileQuasiParabolicSegment_Abridged.add(index: index, &fbb)
    IonoObservationDensityProfileQuasiParabolicSegment_Abridged.add(rb: rb, &fbb)
    IonoObservationDensityProfileQuasiParabolicSegment_Abridged.add(re: re, &fbb)
    IonoObservationDensityProfileQuasiParabolicSegment_Abridged.add(a: a, &fbb)
    IonoObservationDensityProfileQuasiParabolicSegment_Abridged.add(b: b, &fbb)
    IonoObservationDensityProfileQuasiParabolicSegment_Abridged.add(c: c, &fbb)
    IonoObservationDensityProfileQuasiParabolicSegment_Abridged.add(error: error, &fbb)
    return IonoObservationDensityProfileQuasiParabolicSegment_Abridged.endIonoObservationDensityProfileQuasiParabolicSegment_Abridged(&fbb, start: __start)
  }
