...
public enum OperatingUnitRemark_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OperatingUnitRemark_Ingest_dataMode_Enum { return .exercise }
  public static var min: OperatingUnitRemark_Ingest_dataMode_Enum { return .real }
}
...
public struct OperatingUnitRemark_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OperatingUnitRemark_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: OperatingUnitRemark_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OperatingUnitRemark_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startOperatingUnitRemark_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 13) }
  ...
  public static func add(dataMode: OperatingUnitRemark_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endOperatingUnitRemark_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOperatingUnitRemark_Ingest(
    ...
    let __start = OperatingUnitRemark_Ingest.startOperatingUnitRemark_Ingest(&fbb)
    OperatingUnitRemark_Ingest.add(id: id, &fbb)
    OperatingUnitRemark_Ingest.add(classificationMarking: classificationMarking, &fbb)
    OperatingUnitRemark_Ingest.add(idOperatingUnit: idOperatingUnit, &fbb)
    OperatingUnitRemark_Ingest.add(altRmkId: altRmkId, &fbb)
    OperatingUnitRemark_Ingest.add(name: name, &fbb)
    OperatingUnitRemark_Ingest.add(type: type, &fbb)
    OperatingUnitRemark_Ingest.add(text: text, &fbb)
    OperatingUnitRemark_Ingest.add(code: code, &fbb)
    OperatingUnitRemark_Ingest.add(createdAt: createdAt, &fbb)
    OperatingUnitRemark_Ingest.add(createdBy: createdBy, &fbb)
    OperatingUnitRemark_Ingest.add(source: source, &fbb)
    OperatingUnitRemark_Ingest.add(origin: origin, &fbb)
    OperatingUnitRemark_Ingest.add(dataMode: dataMode, &fbb)
    return OperatingUnitRemark_Ingest.endOperatingUnitRemark_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OperatingUnitRemark_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
