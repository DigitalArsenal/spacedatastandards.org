...
public struct SEObservation_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SEObservation_Abridged.id, addPrefix: prefix) }
  ...
  public static func startSEObservation_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 8) }
  ...
  public static func endSEObservation_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSEObservation_Abridged(
    ...
    let __start = SEObservation_Abridged.startSEObservation_Abridged(&fbb)
    SEObservation_Abridged.add(obType: obType, &fbb)
    SEObservation_Abridged.add(obUoM: obUoM, &fbb)
    SEObservation_Abridged.add(obValue: obValue, &fbb)
    SEObservation_Abridged.add(obString: obString, &fbb)
    SEObservation_Abridged.addVectorOf(obArray: obArray, &fbb)
    SEObservation_Abridged.add(obBool: obBool, &fbb)
    SEObservation_Abridged.add(obQuality: obQuality, &fbb)
    SEObservation_Abridged.add(obDescription: obDescription, &fbb)
    return SEObservation_Abridged.endSEObservation_Abridged(&fbb, start: __start)
  }
