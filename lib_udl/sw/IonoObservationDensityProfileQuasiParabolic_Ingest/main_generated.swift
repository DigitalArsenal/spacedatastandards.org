...
public struct IonoObservationDensityProfileQuasiParabolic_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDensityProfileQuasiParabolic_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDensityProfileQuasiParabolic_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endIonoObservationDensityProfileQuasiParabolic_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDensityProfileQuasiParabolic_Ingest(
    _ fbb: inout FlatBufferBuilder,
    descriptionOffset description: Offset = Offset(),
    earthRadius: Double = 0.0,
    quasiParabolicSegmentsVectorOffset quasiParabolicSegments: Offset = Offset()
  ) -> Offset {
    let __start = IonoObservationDensityProfileQuasiParabolic_Ingest.startIonoObservationDensityProfileQuasiParabolic_Ingest(&fbb)
    IonoObservationDensityProfileQuasiParabolic_Ingest.add(description: description, &fbb)
    IonoObservationDensityProfileQuasiParabolic_Ingest.add(earthRadius: earthRadius, &fbb)
    IonoObservationDensityProfileQuasiParabolic_Ingest.addVectorOf(quasiParabolicSegments: quasiParabolicSegments, &fbb)
    return IonoObservationDensityProfileQuasiParabolic_Ingest.endIonoObservationDensityProfileQuasiParabolic_Ingest(&fbb, start: __start)
  }
