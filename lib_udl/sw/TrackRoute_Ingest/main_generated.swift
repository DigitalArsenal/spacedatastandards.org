...
public enum TrackRoute_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: TrackRoute_Ingest_dataMode_Enum { return .exercise }
  public static var min: TrackRoute_Ingest_dataMode_Enum { return .real }
}


///  /// A track route is a prescribed route for performing training events or operations such as air refueling.
public struct TrackRoute_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: TrackRoute_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: TrackRoute_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : TrackRoute_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startTrackRoute_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 38) }
  ...
  public static func add(dataMode: TrackRoute_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endTrackRoute_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createTrackRoute_Ingest(
    ...
    let __start = TrackRoute_Ingest.startTrackRoute_Ingest(&fbb)
    TrackRoute_Ingest.add(id: id, &fbb)
    TrackRoute_Ingest.add(classificationMarking: classificationMarking, &fbb)
    TrackRoute_Ingest.add(type: type, &fbb)
    TrackRoute_Ingest.add(externalId: externalId, &fbb)
    TrackRoute_Ingest.add(direction: direction, &fbb)
    TrackRoute_Ingest.add(creatingOrg: creatingOrg, &fbb)
    TrackRoute_Ingest.add(locationTrackId: locationTrackId, &fbb)
    TrackRoute_Ingest.add(trackId: trackId, &fbb)
    TrackRoute_Ingest.add(trackName: trackName, &fbb)
    TrackRoute_Ingest.add(shortName: shortName, &fbb)
    TrackRoute_Ingest.add(typeCode: typeCode, &fbb)
    TrackRoute_Ingest.add(regionCode: regionCode, &fbb)
    TrackRoute_Ingest.add(regionName: regionName, &fbb)
    TrackRoute_Ingest.add(apxBeaconCode: apxBeaconCode, &fbb)
    TrackRoute_Ingest.add(receiverTankerChcode: receiverTankerChcode, &fbb)
    TrackRoute_Ingest.add(apnSetting: apnSetting, &fbb)
    TrackRoute_Ingest.add(sic: sic, &fbb)
    TrackRoute_Ingest.add(reviewDate: reviewDate, &fbb)
    TrackRoute_Ingest.add(lastUsedDate: lastUsedDate, &fbb)
    TrackRoute_Ingest.add(lastUpdateDate: lastUpdateDate, &fbb)
    TrackRoute_Ingest.add(priFreq: priFreq, &fbb)
    TrackRoute_Ingest.add(secFreq: secFreq, &fbb)
    TrackRoute_Ingest.add(artccMessage: artccMessage, &fbb)
    TrackRoute_Ingest.add(schedulerOrgName: schedulerOrgName, &fbb)
    TrackRoute_Ingest.add(schedulerOrgUnit: schedulerOrgUnit, &fbb)
    TrackRoute_Ingest.add(effectiveDate: effectiveDate, &fbb)
    TrackRoute_Ingest.addVectorOf(routePoints: routePoints, &fbb)
    TrackRoute_Ingest.addVectorOf(altitudeBlocks: altitudeBlocks, &fbb)
    TrackRoute_Ingest.addVectorOf(poc: poc, &fbb)
    TrackRoute_Ingest.add(createdAt: createdAt, &fbb)
    TrackRoute_Ingest.add(createdBy: createdBy, &fbb)
    TrackRoute_Ingest.add(updatedAt: updatedAt, &fbb)
    TrackRoute_Ingest.add(updatedBy: updatedBy, &fbb)
    TrackRoute_Ingest.add(sourceDl: sourceDl, &fbb)
    TrackRoute_Ingest.add(source: source, &fbb)
    TrackRoute_Ingest.add(origin: origin, &fbb)
    TrackRoute_Ingest.add(origNetwork: origNetwork, &fbb)
    TrackRoute_Ingest.add(dataMode: dataMode, &fbb)
    return TrackRoute_Ingest.endTrackRoute_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: TrackRoute_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
