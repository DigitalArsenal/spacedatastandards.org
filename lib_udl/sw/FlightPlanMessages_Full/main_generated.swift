...
public struct FlightPlanMessages_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: FlightPlanMessages_Full.id, addPrefix: prefix) }
  ...
  public static func startFlightPlanMessages_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endFlightPlanMessages_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createFlightPlanMessages_Full(
    ...
    let __start = FlightPlanMessages_Full.startFlightPlanMessages_Full(&fbb)
    FlightPlanMessages_Full.add(severity: severity, &fbb)
    FlightPlanMessages_Full.add(wpNum: wpNum, &fbb)
    FlightPlanMessages_Full.add(routePath: routePath, &fbb)
    FlightPlanMessages_Full.add(msgText: msgText, &fbb)
    return FlightPlanMessages_Full.endFlightPlanMessages_Full(&fbb, start: __start)
  }
