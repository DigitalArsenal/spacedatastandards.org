...
public enum AirspaceControlOrder_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AirspaceControlOrder_Full_dataMode_Enum { return .exercise }
  public static var min: AirspaceControlOrder_Full_dataMode_Enum { return .real }
}
...
public struct AirspaceControlOrder_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirspaceControlOrder_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: AirspaceControlOrder_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AirspaceControlOrder_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startAirspaceControlOrder_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 33) }
  ...
  public static func add(dataMode: AirspaceControlOrder_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endAirspaceControlOrder_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirspaceControlOrder_Full(
    ...
    let __start = AirspaceControlOrder_Full.startAirspaceControlOrder_Full(&fbb)
    AirspaceControlOrder_Full.add(id: id, &fbb)
    AirspaceControlOrder_Full.add(classificationMarking: classificationMarking, &fbb)
    AirspaceControlOrder_Full.add(rawFileUri: rawFileUri, &fbb)
    AirspaceControlOrder_Full.add(opExName: opExName, &fbb)
    AirspaceControlOrder_Full.add(originator: originator, &fbb)
    AirspaceControlOrder_Full.add(startTime: startTime, &fbb)
    AirspaceControlOrder_Full.add(stopTime: stopTime, &fbb)
    AirspaceControlOrder_Full.add(stopQualifier: stopQualifier, &fbb)
    AirspaceControlOrder_Full.add(opExInfo: opExInfo, &fbb)
    AirspaceControlOrder_Full.add(opExInfoAlt: opExInfoAlt, &fbb)
    AirspaceControlOrder_Full.add(planOrigNum: planOrigNum, &fbb)
    AirspaceControlOrder_Full.add(serialNum: serialNum, &fbb)
    AirspaceControlOrder_Full.add(month: month, &fbb)
    AirspaceControlOrder_Full.add(qualifier: qualifier, &fbb)
    AirspaceControlOrder_Full.add(qualSn: qualSn, &fbb)
    AirspaceControlOrder_Full.add(areaOfValidity: areaOfValidity, &fbb)
    AirspaceControlOrder_Full.add(acoSerialNum: acoSerialNum, &fbb)
    AirspaceControlOrder_Full.add(geoDatum: geoDatum, &fbb)
    AirspaceControlOrder_Full.add(acoComments: acoComments, &fbb)
    AirspaceControlOrder_Full.addVectorOf(airspaceControlOrderReferences: airspaceControlOrderReferences, &fbb)
    AirspaceControlOrder_Full.addVectorOf(airspaceControlMeansStatus: airspaceControlMeansStatus, &fbb)
    AirspaceControlOrder_Full.addVectorOf(undLnkTrk: undLnkTrk, &fbb)
    AirspaceControlOrder_Full.add(classSource: classSource, &fbb)
    AirspaceControlOrder_Full.addVectorOf(classReason: classReason, &fbb)
    AirspaceControlOrder_Full.addVectorOf(downgradeInsDate: downgradeInsDate, &fbb)
    AirspaceControlOrder_Full.addVectorOf(declassExemptionCode: declassExemptionCode, &fbb)
    AirspaceControlOrder_Full.add(createdAt: createdAt, &fbb)
    AirspaceControlOrder_Full.add(createdBy: createdBy, &fbb)
    AirspaceControlOrder_Full.add(sourceDl: sourceDl, &fbb)
    AirspaceControlOrder_Full.add(source: source, &fbb)
    AirspaceControlOrder_Full.add(origin: origin, &fbb)
    AirspaceControlOrder_Full.add(origNetwork: origNetwork, &fbb)
    AirspaceControlOrder_Full.add(dataMode: dataMode, &fbb)
    return AirspaceControlOrder_Full.endAirspaceControlOrder_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AirspaceControlOrder_Full_dataMode_Enum.self)
    _v.finish()
  }
}
