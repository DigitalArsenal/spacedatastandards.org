...
public enum PersonnelRecovery_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: PersonnelRecovery_Ingest_dataMode_Enum { return .exercise }
  public static var min: PersonnelRecovery_Ingest_dataMode_Enum { return .real }
}


///  /// Provides information concerning search and rescue operations and other situations involving personnel recovery.
public struct PersonnelRecovery_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: PersonnelRecovery_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: PersonnelRecovery_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : PersonnelRecovery_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startPersonnelRecovery_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 38) }
  ...
  public static func add(dataMode: PersonnelRecovery_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endPersonnelRecovery_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPersonnelRecovery_Ingest(
    ...
    let __start = PersonnelRecovery_Ingest.startPersonnelRecovery_Ingest(&fbb)
    PersonnelRecovery_Ingest.add(id: id, &fbb)
    PersonnelRecovery_Ingest.add(classificationMarking: classificationMarking, &fbb)
    PersonnelRecovery_Ingest.add(type: type, &fbb)
    PersonnelRecovery_Ingest.add(msgTime: msgTime, &fbb)
    PersonnelRecovery_Ingest.add(recovId: recovId, &fbb)
    PersonnelRecovery_Ingest.add(idWeatherReport: idWeatherReport, &fbb)
    PersonnelRecovery_Ingest.add(pickupLat: pickupLat, &fbb)
    PersonnelRecovery_Ingest.add(pickupLon: pickupLon, &fbb)
    PersonnelRecovery_Ingest.add(pickupAlt: pickupAlt, &fbb)
    PersonnelRecovery_Ingest.add(termInd: termInd, &fbb)
    PersonnelRecovery_Ingest.add(authStatus: authStatus, &fbb)
    PersonnelRecovery_Ingest.add(numPersons: numPersons, &fbb)
    PersonnelRecovery_Ingest.add(milClass: milClass, &fbb)
    PersonnelRecovery_Ingest.add(natAlliance: natAlliance, &fbb)
    PersonnelRecovery_Ingest.add(natAlliance1: natAlliance1, &fbb)
    PersonnelRecovery_Ingest.add(identity: identity, &fbb)
    PersonnelRecovery_Ingest.add(commEq1: commEq1, &fbb)
    PersonnelRecovery_Ingest.add(commEq2: commEq2, &fbb)
    PersonnelRecovery_Ingest.add(commEq3: commEq3, &fbb)
    PersonnelRecovery_Ingest.add(txFreq: txFreq, &fbb)
    PersonnelRecovery_Ingest.add(rxFreq: rxFreq, &fbb)
    PersonnelRecovery_Ingest.add(numNonAmbulatory: numNonAmbulatory, &fbb)
    PersonnelRecovery_Ingest.add(numAmbulatory: numAmbulatory, &fbb)
    PersonnelRecovery_Ingest.add(numAmbulatoryInjured: numAmbulatoryInjured, &fbb)
    PersonnelRecovery_Ingest.add(survivorRadio: survivorRadio, &fbb)
    PersonnelRecovery_Ingest.add(survivorMessages: survivorMessages, &fbb)
    PersonnelRecovery_Ingest.add(beaconInd: beaconInd, &fbb)
    PersonnelRecovery_Ingest.add(callSign: callSign, &fbb)
    PersonnelRecovery_Ingest.add(textMsg: textMsg, &fbb)
    PersonnelRecovery_Ingest.add(authMethod: authMethod, &fbb)
    PersonnelRecovery_Ingest.add(objectiveAreaInfo: objectiveAreaInfo, &fbb)
    PersonnelRecovery_Ingest.add(executionInfo: executionInfo, &fbb)
    PersonnelRecovery_Ingest.add(origNetwork: origNetwork, &fbb)
    PersonnelRecovery_Ingest.add(createdAt: createdAt, &fbb)
    PersonnelRecovery_Ingest.add(createdBy: createdBy, &fbb)
    PersonnelRecovery_Ingest.add(source: source, &fbb)
    PersonnelRecovery_Ingest.add(origin: origin, &fbb)
    PersonnelRecovery_Ingest.add(dataMode: dataMode, &fbb)
    return PersonnelRecovery_Ingest.endPersonnelRecovery_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: PersonnelRecovery_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
