...
public enum Item_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Item_Abridged_dataMode_Enum { return .exercise }
  public static var min: Item_Abridged_dataMode_Enum { return .real }
}


///  /// No description available.
public struct Item_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Item_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Item_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Item_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startItem_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 51) }
  ...
  public static func add(dataMode: Item_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endItem_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createItem_Abridged(
    ...
    let __start = Item_Abridged.startItem_Abridged(&fbb)
    Item_Abridged.add(id: id, &fbb)
    Item_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Item_Abridged.add(idAirLoadPlan: idAirLoadPlan, &fbb)
    Item_Abridged.add(scanCode: scanCode, &fbb)
    Item_Abridged.add(scGenTool: scGenTool, &fbb)
    Item_Abridged.add(type: type, &fbb)
    Item_Abridged.add(cargoType: cargoType, &fbb)
    Item_Abridged.add(name: name, &fbb)
    Item_Abridged.add(destination: destination, &fbb)
    Item_Abridged.add(departure: departure, &fbb)
    Item_Abridged.add(receivingUnit: receivingUnit, &fbb)
    Item_Abridged.add(receivingBranch: receivingBranch, &fbb)
    Item_Abridged.add(lastArrDate: lastArrDate, &fbb)
    Item_Abridged.add(uln: uln, &fbb)
    Item_Abridged.add(weight: weight, &fbb)
    Item_Abridged.add(weightTs: weightTs, &fbb)
    Item_Abridged.add(commodityCode: commodityCode, &fbb)
    Item_Abridged.add(commoditySys: commoditySys, &fbb)
    Item_Abridged.add(productCode: productCode, &fbb)
    Item_Abridged.add(productSys: productSys, &fbb)
    Item_Abridged.add(width: width, &fbb)
    Item_Abridged.add(length: length, &fbb)
    Item_Abridged.add(height: height, &fbb)
    Item_Abridged.add(volume: volume, &fbb)
    Item_Abridged.add(cg: cg, &fbb)
    Item_Abridged.add(fs: fs, &fbb)
    Item_Abridged.add(centerlineOffset: centerlineOffset, &fbb)
    Item_Abridged.add(moment: moment, &fbb)
    Item_Abridged.add(airdrop: airdrop, &fbb)
    Item_Abridged.add(tcn: tcn, &fbb)
    Item_Abridged.addVectorOf(hazCodes: hazCodes, &fbb)
    Item_Abridged.add(netExpWt: netExpWt, &fbb)
    Item_Abridged.add(container: container, &fbb)
    Item_Abridged.addVectorOf(itemContains: itemContains, &fbb)
    Item_Abridged.add(numPalletPos: numPalletPos, &fbb)
    Item_Abridged.add(dvCode: dvCode, &fbb)
    Item_Abridged.add(notes: notes, &fbb)
    Item_Abridged.addVectorOf(keys: keys, &fbb)
    Item_Abridged.addVectorOf(values: values, &fbb)
    Item_Abridged.add(altDataFormat: altDataFormat, &fbb)
    Item_Abridged.add(accSystem: accSystem, &fbb)
    Item_Abridged.add(accSysNotes: accSysNotes, &fbb)
    Item_Abridged.addVectorOf(accSysKeys: accSysKeys, &fbb)
    Item_Abridged.addVectorOf(accSysValues: accSysValues, &fbb)
    Item_Abridged.add(createdAt: createdAt, &fbb)
    Item_Abridged.add(createdBy: createdBy, &fbb)
    Item_Abridged.add(sourceDl: sourceDl, &fbb)
    Item_Abridged.add(source: source, &fbb)
    Item_Abridged.add(origin: origin, &fbb)
    Item_Abridged.add(origNetwork: origNetwork, &fbb)
    Item_Abridged.add(dataMode: dataMode, &fbb)
    return Item_Abridged.endItem_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Item_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
