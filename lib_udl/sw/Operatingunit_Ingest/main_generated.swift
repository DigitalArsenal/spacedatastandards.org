...
public enum Operatingunit_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Operatingunit_Ingest_dataMode_Enum { return .exercise }
  public static var min: Operatingunit_Ingest_dataMode_Enum { return .real }
}
...
public struct Operatingunit_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Operatingunit_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: Operatingunit_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Operatingunit_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startOperatingunit_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 60) }
  ...
  public static func add(dataMode: Operatingunit_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endOperatingunit_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOperatingunit_Ingest(
    ...
    let __start = Operatingunit_Ingest.startOperatingunit_Ingest(&fbb)
    Operatingunit_Ingest.add(idOperatingUnit: idOperatingUnit, &fbb)
    Operatingunit_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Operatingunit_Ingest.add(altOperatingUnitId: altOperatingUnitId, &fbb)
    Operatingunit_Ingest.add(name: name, &fbb)
    Operatingunit_Ingest.add(description: description, &fbb)
    Operatingunit_Ingest.add(idLocation: idLocation, &fbb)
    Operatingunit_Ingest.add(idContact: idContact, &fbb)
    Operatingunit_Ingest.add(idOrganization: idOrganization, &fbb)
    Operatingunit_Ingest.add(unitIdentifier: unitIdentifier, &fbb)
    Operatingunit_Ingest.add(countryCode: countryCode, &fbb)
    Operatingunit_Ingest.add(altCountryCode: altCountryCode, &fbb)
    Operatingunit_Ingest.add(wac: wac, &fbb)
    Operatingunit_Ingest.add(operStatus: operStatus, &fbb)
    Operatingunit_Ingest.add(condition: condition, &fbb)
    Operatingunit_Ingest.add(conditionAvail: conditionAvail, &fbb)
    Operatingunit_Ingest.add(eval: eval, &fbb)
    Operatingunit_Ingest.add(fpa: fpa, &fbb)
    Operatingunit_Ingest.add(ident: ident, &fbb)
    Operatingunit_Ingest.add(allegiance: allegiance, &fbb)
    Operatingunit_Ingest.add(altAllegiance: altAllegiance, &fbb)
    Operatingunit_Ingest.add(locName: locName, &fbb)
    Operatingunit_Ingest.add(locReason: locReason, &fbb)
    Operatingunit_Ingest.add(force: force, &fbb)
    Operatingunit_Ingest.add(forceName: forceName, &fbb)
    Operatingunit_Ingest.add(functRole: functRole, &fbb)
    Operatingunit_Ingest.add(msnPrimary: msnPrimary, &fbb)
    Operatingunit_Ingest.add(msnPrimarySpecialty: msnPrimarySpecialty, &fbb)
    Operatingunit_Ingest.add(masterUnit: masterUnit, &fbb)
    Operatingunit_Ingest.add(stylizedUnit: stylizedUnit, &fbb)
    Operatingunit_Ingest.add(divCat: divCat, &fbb)
    Operatingunit_Ingest.add(echelon: echelon, &fbb)
    Operatingunit_Ingest.add(echelonTier: echelonTier, &fbb)
    Operatingunit_Ingest.add(fleetId: fleetId, &fbb)
    Operatingunit_Ingest.add(deployStatus: deployStatus, &fbb)
    Operatingunit_Ingest.add(flagFlown: flagFlown, &fbb)
    Operatingunit_Ingest.add(coordDatum: coordDatum, &fbb)
    Operatingunit_Ingest.add(coord: coord, &fbb)
    Operatingunit_Ingest.add(coordDerivAcc: coordDerivAcc, &fbb)
    Operatingunit_Ingest.add(lat: lat, &fbb)
    Operatingunit_Ingest.add(lon: lon, &fbb)
    Operatingunit_Ingest.add(elevMsl: elevMsl, &fbb)
    Operatingunit_Ingest.add(elevMslConfLvl: elevMslConfLvl, &fbb)
    Operatingunit_Ingest.add(elevMslDerivAcc: elevMslDerivAcc, &fbb)
    Operatingunit_Ingest.add(geoidalMslSep: geoidalMslSep, &fbb)
    Operatingunit_Ingest.add(milGridSys: milGridSys, &fbb)
    Operatingunit_Ingest.add(milGrid: milGrid, &fbb)
    Operatingunit_Ingest.add(utm: utm, &fbb)
    Operatingunit_Ingest.add(airDefArea: airDefArea, &fbb)
    Operatingunit_Ingest.add(polSubdiv: polSubdiv, &fbb)
    Operatingunit_Ingest.add(symCode: symCode, &fbb)
    Operatingunit_Ingest.add(classRating: classRating, &fbb)
    Operatingunit_Ingest.add(recStatus: recStatus, &fbb)
    Operatingunit_Ingest.add(reviewDate: reviewDate, &fbb)
    Operatingunit_Ingest.add(resProd: resProd, &fbb)
    Operatingunit_Ingest.add(referenceDoc: referenceDoc, &fbb)
    Operatingunit_Ingest.add(createdAt: createdAt, &fbb)
    Operatingunit_Ingest.add(createdBy: createdBy, &fbb)
    Operatingunit_Ingest.add(source: source, &fbb)
    Operatingunit_Ingest.add(origin: origin, &fbb)
    Operatingunit_Ingest.add(dataMode: dataMode, &fbb)
    return Operatingunit_Ingest.endOperatingunit_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Operatingunit_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
