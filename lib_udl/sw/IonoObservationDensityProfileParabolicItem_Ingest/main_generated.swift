...
public struct IonoObservationDensityProfileParabolicItem_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDensityProfileParabolicItem_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDensityProfileParabolicItem_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationDensityProfileParabolicItem_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDensityProfileParabolicItem_Ingest(
    ...
    let __start = IonoObservationDensityProfileParabolicItem_Ingest.startIonoObservationDensityProfileParabolicItem_Ingest(&fbb)
    IonoObservationDensityProfileParabolicItem_Ingest.add(layer: layer, &fbb)
    IonoObservationDensityProfileParabolicItem_Ingest.add(f: f, &fbb)
    IonoObservationDensityProfileParabolicItem_Ingest.add(z: z, &fbb)
    IonoObservationDensityProfileParabolicItem_Ingest.add(y: y, &fbb)
    return IonoObservationDensityProfileParabolicItem_Ingest.endIonoObservationDensityProfileParabolicItem_Ingest(&fbb, start: __start)
  }
