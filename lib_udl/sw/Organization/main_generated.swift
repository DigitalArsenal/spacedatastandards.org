...
public enum Organization_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Organization_dataMode_Enum { return .exercise }
  public static var min: Organization_dataMode_Enum { return .real }
}
...
public struct Organization: FlatBufferObject, Verifiable {
  ...
  public var dataMode: Organization_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Organization_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOrganization(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 19) }
  ...
  public static func add(dataMode: Organization_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func createOrganization(
    ...
    Organization.add(id: id, &fbb)
    Organization.add(classificationMarking: classificationMarking, &fbb)
    Organization.add(name: name, &fbb)
    Organization.add(type: type, &fbb)
    Organization.add(category: category, &fbb)
    Organization.add(externalId: externalId, &fbb)
    Organization.add(description: description, &fbb)
    Organization.add(countryCode: countryCode, &fbb)
    Organization.add(nationality: nationality, &fbb)
    Organization.add(active: active, &fbb)
    Organization.add(source: source, &fbb)
    Organization.add(origin: origin, &fbb)
    Organization.add(dataMode: dataMode, &fbb)
    Organization.add(createdAt: createdAt, &fbb)
    Organization.add(createdBy: createdBy, &fbb)
    Organization.add(updatedAt: updatedAt, &fbb)
    Organization.add(updatedBy: updatedBy, &fbb)
    Organization.addVectorOf(organizationDetails: organizationDetails, &fbb)
    Organization.add(origNetwork: origNetwork, &fbb)
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Organization_dataMode_Enum.self)
