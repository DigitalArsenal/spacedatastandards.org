...
public struct DiplomaticClearanceRemarks_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DiplomaticClearanceRemarks_Abridged.id, addPrefix: prefix) }
  ...
  public static func startDiplomaticClearanceRemarks_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endDiplomaticClearanceRemarks_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDiplomaticClearanceRemarks_Abridged(
    ...
    let __start = DiplomaticClearanceRemarks_Abridged.startDiplomaticClearanceRemarks_Abridged(&fbb)
    DiplomaticClearanceRemarks_Abridged.add(gdssRemarkId: gdssRemarkId, &fbb)
    DiplomaticClearanceRemarks_Abridged.add(text: text, &fbb)
    DiplomaticClearanceRemarks_Abridged.add(date: date, &fbb)
    DiplomaticClearanceRemarks_Abridged.add(user: user, &fbb)
    return DiplomaticClearanceRemarks_Abridged.endDiplomaticClearanceRemarks_Abridged(&fbb, start: __start)
  }
