...
public enum Onorbit_objectType_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Onorbit_objectType_Enum { return .unknown }
  public static var min: Onorbit_objectType_Enum { return .rocketBody }
}


public enum Onorbit_category_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: Onorbit_category_Enum { return .docked }
  public static var min: Onorbit_category_Enum { return .unknown }
}


public enum Onorbit_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: Onorbit_dataMode_Enum { return .exercise }
  public static var min: Onorbit_dataMode_Enum { return .real }
}


///  /// Model object representing on-orbit objects or satellites in the system.
public struct Onorbit: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Onorbit.id, addPrefix: prefix) }
  ...
  public var objectType: Onorbit_objectType_Enum { let o = _accessor.offset(VTOFFSET.objectType.v); return o == 0 ? .rocketBody : Onorbit_objectType_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .rocketBody }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 45
  public var category: Onorbit_category_Enum { let o = _accessor.offset(VTOFFSET.category.v); return o == 0 ? .unknown : Onorbit_category_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .unknown }
  ...
  public var dataMode: Onorbit_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Onorbit_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOnorbit(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 28) }
  ...
  public static func add(objectType: Onorbit_objectType_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: objectType.rawValue, def: 0, at: VTOFFSET.objectType.p) }
  ...
  public static func add(category: Onorbit_category_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: category.rawValue, def: 0, at: VTOFFSET.category.p) }
  ...
  public static func add(dataMode: Onorbit_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endOnorbit(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnorbit(
    ...
    objectType: Onorbit_objectType_Enum = .rocketBody,
    ...
    let __start = Onorbit.startOnorbit(&fbb)
    Onorbit.add(idOnOrbit: idOnOrbit, &fbb)
    Onorbit.add(classificationMarking: classificationMarking, &fbb)
    Onorbit.add(satNo: satNo, &fbb)
    Onorbit.add(commonName: commonName, &fbb)
    Onorbit.add(constellation: constellation, &fbb)
    Onorbit.add(intlDes: intlDes, &fbb)
    Onorbit.add(launchDate: launchDate, &fbb)
    Onorbit.add(decayDate: decayDate, &fbb)
    Onorbit.add(objectType: objectType, &fbb)
    Onorbit.add(origin: origin, &fbb)
    Onorbit.add(missionNumber: missionNumber, &fbb)
    Onorbit.add(category: category, &fbb)
    Onorbit.add(lifetimeYears: lifetimeYears, &fbb)
    Onorbit.add(altName: altName, &fbb)
    Onorbit.add(createdAt: createdAt, &fbb)
    Onorbit.add(createdBy: createdBy, &fbb)
    Onorbit.add(updatedAt: updatedAt, &fbb)
    Onorbit.add(updatedBy: updatedBy, &fbb)
    Onorbit.add(source: source, &fbb)
    Onorbit.add(dataMode: dataMode, &fbb)
    Onorbit.add(launchSiteId: launchSiteId, &fbb)
    Onorbit.addVectorOf(antennas: antennas, &fbb)
    Onorbit.addVectorOf(batteries: batteries, &fbb)
    Onorbit.addVectorOf(solarArrays: solarArrays, &fbb)
    Onorbit.addVectorOf(thrusters: thrusters, &fbb)
    Onorbit.addVectorOf(onorbitDetails: onorbitDetails, &fbb)
    Onorbit.add(countryCode: countryCode, &fbb)
    Onorbit.add(origNetwork: origNetwork, &fbb)
    return Onorbit.endOnorbit(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.objectType.p, fieldName: "objectType", required: false, type: Onorbit_objectType_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.category.p, fieldName: "category", required: false, type: Onorbit_category_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Onorbit_dataMode_Enum.self)
