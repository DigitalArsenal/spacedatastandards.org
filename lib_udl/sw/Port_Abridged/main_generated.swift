...
public enum Port_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Port_Abridged_dataMode_Enum { return .exercise }
  public static var min: Port_Abridged_dataMode_Enum { return .real }
}


///  /// Properties and characteristics of a maritime port, which includes location, port identifiers, and remarks.
public struct Port_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Port_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 64
  public var dataMode: Port_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Port_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: OPS1
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startPort_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 22) }
  ...
  public static func add(dataMode: Port_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endPort_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPort_Abridged(
    ...
    let __start = Port_Abridged.startPort_Abridged(&fbb)
    Port_Abridged.add(id: id, &fbb)
    Port_Abridged.add(classificationMarking: classificationMarking, &fbb)
    Port_Abridged.add(idSite: idSite, &fbb)
    Port_Abridged.add(externalId: externalId, &fbb)
    Port_Abridged.add(locode: locode, &fbb)
    Port_Abridged.add(portName: portName, &fbb)
    Port_Abridged.add(harborType: harborType, &fbb)
    Port_Abridged.add(harborSize: harborSize, &fbb)
    Port_Abridged.add(maxDraught: maxDraught, &fbb)
    Port_Abridged.add(avgDuration: avgDuration, &fbb)
    Port_Abridged.add(tideRange: tideRange, &fbb)
    Port_Abridged.add(shelter: shelter, &fbb)
    Port_Abridged.add(pilotReqd: pilotReqd, &fbb)
    Port_Abridged.add(lat: lat, &fbb)
    Port_Abridged.add(lon: lon, &fbb)
    Port_Abridged.add(countryCode: countryCode, &fbb)
    Port_Abridged.add(createdAt: createdAt, &fbb)
    Port_Abridged.add(createdBy: createdBy, &fbb)
    Port_Abridged.add(source: source, &fbb)
    Port_Abridged.add(origin: origin, &fbb)
    Port_Abridged.add(dataMode: dataMode, &fbb)
    Port_Abridged.add(origNetwork: origNetwork, &fbb)
    return Port_Abridged.endPort_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Port_Abridged_dataMode_Enum.self)
