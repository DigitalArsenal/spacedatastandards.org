...
public struct LogisticsRemarks_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LogisticsRemarks_Full.id, addPrefix: prefix) }
  ...
  public static func startLogisticsRemarks_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endLogisticsRemarks_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLogisticsRemarks_Full(
    _ fbb: inout FlatBufferBuilder,
    usernameOffset username: Offset = Offset(),
    remarkOffset remark: Offset = Offset(),
    lastChangedOffset lastChanged: Offset = Offset()
  ) -> Offset {
    let __start = LogisticsRemarks_Full.startLogisticsRemarks_Full(&fbb)
    LogisticsRemarks_Full.add(username: username, &fbb)
    LogisticsRemarks_Full.add(remark: remark, &fbb)
    LogisticsRemarks_Full.add(lastChanged: lastChanged, &fbb)
    return LogisticsRemarks_Full.endLogisticsRemarks_Full(&fbb, start: __start)
  }
