...
public enum CollectRequest_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: CollectRequest_Full_dataMode_Enum { return .exercise }
  public static var min: CollectRequest_Full_dataMode_Enum { return .real }
}
...
public struct CollectRequest_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: CollectRequest_Full.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case source = 170
    case origin = 172
    case origNetwork = 174
    case dataMode = 176
    case stateVector = 178
    case elset = 180
    case onOrbit = 182
    case tags = 184
    case collectResponse = 186
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: CollectRequest_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : CollectRequest_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  public var hasCollectResponse: Bool { let o = _accessor.offset(VTOFFSET.collectResponse.v); return o == 0 ? false : true }
  public var collectResponseCount: Int32 { let o = _accessor.offset(VTOFFSET.collectResponse.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func collectResponse(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.collectResponse.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  public static func startCollectRequest_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 92) }
  ...
  public static func add(dataMode: CollectRequest_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func addVectorOf(collectResponse: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: collectResponse, at: VTOFFSET.collectResponse.p) }
  public static func endCollectRequest_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createCollectRequest_Full(
    ...
    collectResponseVectorOffset collectResponse: Offset = Offset()
  ) -> Offset {
    let __start = CollectRequest_Full.startCollectRequest_Full(&fbb)
    CollectRequest_Full.add(id: id, &fbb)
    CollectRequest_Full.add(classificationMarking: classificationMarking, &fbb)
    CollectRequest_Full.add(idParentReq: idParentReq, &fbb)
    CollectRequest_Full.add(msgType: msgType, &fbb)
    CollectRequest_Full.add(msgCreateDate: msgCreateDate, &fbb)
    CollectRequest_Full.add(type: type, &fbb)
    CollectRequest_Full.add(idPlan: idPlan, &fbb)
    CollectRequest_Full.add(planIndex: planIndex, &fbb)
    CollectRequest_Full.add(taskId: taskId, &fbb)
    CollectRequest_Full.add(dwellId: dwellId, &fbb)
    CollectRequest_Full.add(externalId: externalId, &fbb)
    CollectRequest_Full.add(idSensor: idSensor, &fbb)
    CollectRequest_Full.add(origSensorId: origSensorId, &fbb)
    CollectRequest_Full.add(obType: obType, &fbb)
    CollectRequest_Full.add(priority: priority, &fbb)
    CollectRequest_Full.add(taskCategory: taskCategory, &fbb)
    CollectRequest_Full.add(suffix: suffix, &fbb)
    CollectRequest_Full.add(uctFollowUp: uctFollowUp, &fbb)
    CollectRequest_Full.add(startTime: startTime, &fbb)
    CollectRequest_Full.add(endTime: endTime, &fbb)
    CollectRequest_Full.add(idOnOrbit: idOnOrbit, &fbb)
    CollectRequest_Full.add(satNo: satNo, &fbb)
    CollectRequest_Full.add(origObjectId: origObjectId, &fbb)
    CollectRequest_Full.add(taskGroup: taskGroup, &fbb)
    CollectRequest_Full.add(iron: iron, &fbb)
    CollectRequest_Full.add(orbitRegime: orbitRegime, &fbb)
    CollectRequest_Full.add(targetSize: targetSize, &fbb)
    CollectRequest_Full.add(rcsMin: rcsMin, &fbb)
    CollectRequest_Full.add(rcs: rcs, &fbb)
    CollectRequest_Full.add(rcsMax: rcsMax, &fbb)
    CollectRequest_Full.add(freqMin: freqMin, &fbb)
    CollectRequest_Full.add(freq: freq, &fbb)
    CollectRequest_Full.add(freqMax: freqMax, &fbb)
    CollectRequest_Full.add(polarization: polarization, &fbb)
    CollectRequest_Full.add(visMagMin: visMagMin, &fbb)
    CollectRequest_Full.add(visMag: visMag, &fbb)
    CollectRequest_Full.add(visMagMax: visMagMax, &fbb)
    CollectRequest_Full.add(spectralModel: spectralModel, &fbb)
    CollectRequest_Full.add(reflectance: reflectance, &fbb)
    CollectRequest_Full.add(irradiance: irradiance, &fbb)
    CollectRequest_Full.add(numFrames: numFrames, &fbb)
    CollectRequest_Full.add(frameRate: frameRate, &fbb)
    CollectRequest_Full.add(integrationTime: integrationTime, &fbb)
    CollectRequest_Full.add(numTracks: numTracks, &fbb)
    CollectRequest_Full.add(numObs: numObs, &fbb)
    CollectRequest_Full.add(duration: duration, &fbb)
    CollectRequest_Full.add(srchPattern: srchPattern, &fbb)
    CollectRequest_Full.add(scenario: scenario, &fbb)
    CollectRequest_Full.add(idElset: idElset, &fbb)
    CollectRequest_Full.add(idManifold: idManifold, &fbb)
    CollectRequest_Full.add(idStateVector: idStateVector, &fbb)
    CollectRequest_Full.add(esId: esId, &fbb)
    CollectRequest_Full.add(epoch: epoch, &fbb)
    CollectRequest_Full.add(semiMajorAxis: semiMajorAxis, &fbb)
    CollectRequest_Full.add(eccentricity: eccentricity, &fbb)
    CollectRequest_Full.add(inclination: inclination, &fbb)
    CollectRequest_Full.add(raan: raan, &fbb)
    CollectRequest_Full.add(argOfPerigee: argOfPerigee, &fbb)
    CollectRequest_Full.add(trueAnomoly: trueAnomoly, &fbb)
    CollectRequest_Full.add(ra: ra, &fbb)
    CollectRequest_Full.add(dec: dec, &fbb)
    CollectRequest_Full.add(az: az, &fbb)
    CollectRequest_Full.add(el: el, &fbb)
    CollectRequest_Full.add(range: range, &fbb)
    CollectRequest_Full.add(extentAz: extentAz, &fbb)
    CollectRequest_Full.add(extentEl: extentEl, &fbb)
    CollectRequest_Full.add(extentRange: extentRange, &fbb)
    CollectRequest_Full.add(lat: lat, &fbb)
    CollectRequest_Full.add(lon: lon, &fbb)
    CollectRequest_Full.add(alt: alt, &fbb)
    CollectRequest_Full.add(stopLat: stopLat, &fbb)
    CollectRequest_Full.add(stopLon: stopLon, &fbb)
    CollectRequest_Full.add(stopAlt: stopAlt, &fbb)
    CollectRequest_Full.add(srchInc: srchInc, &fbb)
    CollectRequest_Full.add(xAngle: xAngle, &fbb)
    CollectRequest_Full.add(yAngle: yAngle, &fbb)
    CollectRequest_Full.add(orientAngle: orientAngle, &fbb)
    CollectRequest_Full.add(customer: customer, &fbb)
    CollectRequest_Full.add(notes: notes, &fbb)
    CollectRequest_Full.add(updatedAt: updatedAt, &fbb)
    CollectRequest_Full.add(updatedBy: updatedBy, &fbb)
    CollectRequest_Full.add(createdAt: createdAt, &fbb)
    CollectRequest_Full.add(createdBy: createdBy, &fbb)
    CollectRequest_Full.add(source: source, &fbb)
    CollectRequest_Full.add(origin: origin, &fbb)
    CollectRequest_Full.add(origNetwork: origNetwork, &fbb)
    CollectRequest_Full.add(dataMode: dataMode, &fbb)
    CollectRequest_Full.add(stateVector: stateVector, &fbb)
    CollectRequest_Full.add(elset: elset, &fbb)
    CollectRequest_Full.add(onOrbit: onOrbit, &fbb)
    CollectRequest_Full.addVectorOf(tags: tags, &fbb)
    CollectRequest_Full.addVectorOf(collectResponse: collectResponse, &fbb)
    return CollectRequest_Full.endCollectRequest_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: CollectRequest_Full_dataMode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.collectResponse.p, fieldName: "collectResponse", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
    _v.finish()
  }
}
