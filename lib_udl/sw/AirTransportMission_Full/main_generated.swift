...
public enum AirTransportMission_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AirTransportMission_Full_dataMode_Enum { return .exercise }
  public static var min: AirTransportMission_Full_dataMode_Enum { return .real }
}
...
public struct AirTransportMission_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirTransportMission_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: AirTransportMission_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AirTransportMission_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  public var hasAircraftSorties: Bool { let o = _accessor.offset(VTOFFSET.aircraftSorties.v); return o == 0 ? false : true }
  public var aircraftSortiesCount: Int32 { let o = _accessor.offset(VTOFFSET.aircraftSorties.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func aircraftSorties(at index: Int32) -> String? { let o = _accessor.offset(VTOFFSET.aircraftSorties.v); return o == 0 ? nil : _accessor.directString(at: _accessor.vector(at: o) + index * 4) }
  public static func startAirTransportMission_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 39) }
  ...
  public static func add(dataMode: AirTransportMission_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func addVectorOf(aircraftSorties: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: aircraftSorties, at: VTOFFSET.aircraftSorties.p) }
  public static func endAirTransportMission_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirTransportMission_Full(
    ...
    aircraftSortiesVectorOffset aircraftSorties: Offset = Offset()
  ) -> Offset {
    let __start = AirTransportMission_Full.startAirTransportMission_Full(&fbb)
    AirTransportMission_Full.add(id: id, &fbb)
    AirTransportMission_Full.add(classificationMarking: classificationMarking, &fbb)
    AirTransportMission_Full.add(origMissionId: origMissionId, &fbb)
    AirTransportMission_Full.add(amcMissionId: amcMissionId, &fbb)
    AirTransportMission_Full.add(gdssMissionId: gdssMissionId, &fbb)
    AirTransportMission_Full.add(prevMissionId: prevMissionId, &fbb)
    AirTransportMission_Full.add(prevAmcmissionId: prevAmcmissionId, &fbb)
    AirTransportMission_Full.add(nextMissionId: nextMissionId, &fbb)
    AirTransportMission_Full.add(nextAmcmissionId: nextAmcmissionId, &fbb)
    AirTransportMission_Full.add(objective: objective, &fbb)
    AirTransportMission_Full.add(purpose: purpose, &fbb)
    AirTransportMission_Full.add(jcsPriority: jcsPriority, &fbb)
    AirTransportMission_Full.add(cw: cw, &fbb)
    AirTransportMission_Full.add(type: type, &fbb)
    AirTransportMission_Full.add(firstPickUp: firstPickUp, &fbb)
    AirTransportMission_Full.add(lastDropOff: lastDropOff, &fbb)
    AirTransportMission_Full.add(alias: alias, &fbb)
    AirTransportMission_Full.add(callSign: callSign, &fbb)
    AirTransportMission_Full.add(operation: operation, &fbb)
    AirTransportMission_Full.add(naf: naf, &fbb)
    AirTransportMission_Full.add(allocatedUnit: allocatedUnit, &fbb)
    AirTransportMission_Full.add(loadCategoryType: loadCategoryType, &fbb)
    AirTransportMission_Full.add(state: state, &fbb)
    AirTransportMission_Full.add(sourceSysDeviation: sourceSysDeviation, &fbb)
    AirTransportMission_Full.add(apacsId: apacsId, &fbb)
    AirTransportMission_Full.add(dipWorksheetName: dipWorksheetName, &fbb)
    AirTransportMission_Full.add(createdAt: createdAt, &fbb)
    AirTransportMission_Full.add(createdBy: createdBy, &fbb)
    AirTransportMission_Full.add(updatedAt: updatedAt, &fbb)
    AirTransportMission_Full.add(updatedBy: updatedBy, &fbb)
    AirTransportMission_Full.add(sourceDl: sourceDl, &fbb)
    AirTransportMission_Full.add(source: source, &fbb)
    AirTransportMission_Full.add(origin: origin, &fbb)
    AirTransportMission_Full.add(dataMode: dataMode, &fbb)
    AirTransportMission_Full.add(origNetwork: origNetwork, &fbb)
    AirTransportMission_Full.addVectorOf(requirements: requirements, &fbb)
    AirTransportMission_Full.addVectorOf(remarks: remarks, &fbb)
    AirTransportMission_Full.addVectorOf(hazMat: hazMat, &fbb)
    AirTransportMission_Full.addVectorOf(aircraftSorties: aircraftSorties, &fbb)
    return AirTransportMission_Full.endAirTransportMission_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AirTransportMission_Full_dataMode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.aircraftSorties.p, fieldName: "aircraftSorties", required: false, type: ForwardOffset<Vector<ForwardOffset<String>, String>>.self)
    _v.finish()
  }
}
