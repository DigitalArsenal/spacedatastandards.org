...
public enum Crew_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Crew_Ingest_dataMode_Enum { return .exercise }
  public static var min: Crew_Ingest_dataMode_Enum { return .real }
}


///  /// Crew Services.
public struct Crew_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Crew_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: Crew_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Crew_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startCrew_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 23) }
  ...
  public static func add(dataMode: Crew_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endCrew_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createCrew_Ingest(
    ...
    let __start = Crew_Ingest.startCrew_Ingest(&fbb)
    Crew_Ingest.add(id: id, &fbb)
    Crew_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Crew_Ingest.add(origCrewId: origCrewId, &fbb)
    Crew_Ingest.add(crewName: crewName, &fbb)
    Crew_Ingest.add(status: status, &fbb)
    Crew_Ingest.add(idSortie: idSortie, &fbb)
    Crew_Ingest.add(legalAlertTime: legalAlertTime, &fbb)
    Crew_Ingest.add(legalBravoTime: legalBravoTime, &fbb)
    Crew_Ingest.add(alertedTime: alertedTime, &fbb)
    Crew_Ingest.add(returnTime: returnTime, &fbb)
    Crew_Ingest.add(fdpEligType: fdpEligType, &fbb)
    Crew_Ingest.add(fdpType: fdpType, &fbb)
    Crew_Ingest.add(crewType: crewType, &fbb)
    Crew_Ingest.add(armsCrewUnit: armsCrewUnit, &fbb)
    Crew_Ingest.addVectorOf(crewMembers: crewMembers, &fbb)
    Crew_Ingest.add(createdAt: createdAt, &fbb)
    Crew_Ingest.add(createdBy: createdBy, &fbb)
    Crew_Ingest.add(updatedAt: updatedAt, &fbb)
    Crew_Ingest.add(updatedBy: updatedBy, &fbb)
    Crew_Ingest.add(source: source, &fbb)
    Crew_Ingest.add(origin: origin, &fbb)
    Crew_Ingest.add(origNetwork: origNetwork, &fbb)
    Crew_Ingest.add(dataMode: dataMode, &fbb)
    return Crew_Ingest.endCrew_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Crew_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
