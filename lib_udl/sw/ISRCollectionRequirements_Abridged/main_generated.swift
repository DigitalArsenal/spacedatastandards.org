...
public struct ISRCollectionRequirements_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollectionRequirements_Abridged.id, addPrefix: prefix) }
  ...
  public static func startISRCollectionRequirements_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 22) }
  ...
  public static func endISRCollectionRequirements_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollectionRequirements_Abridged(
    ...
    let __start = ISRCollectionRequirements_Abridged.startISRCollectionRequirements_Abridged(&fbb)
    ISRCollectionRequirements_Abridged.add(id: id, &fbb)
    ISRCollectionRequirements_Abridged.add(hash: hash, &fbb)
    ISRCollectionRequirements_Abridged.add(type: type, &fbb)
    ISRCollectionRequirements_Abridged.add(cridNumbers: cridNumbers, &fbb)
    ISRCollectionRequirements_Abridged.add(priority: priority, &fbb)
    ISRCollectionRequirements_Abridged.add(recordId: recordId, &fbb)
    ISRCollectionRequirements_Abridged.add(reconSurvey: reconSurvey, &fbb)
    ISRCollectionRequirements_Abridged.add(intelDiscipline: intelDiscipline, &fbb)
    ISRCollectionRequirements_Abridged.add(secondary: secondary, &fbb)
    ISRCollectionRequirements_Abridged.add(emphasized: emphasized, &fbb)
    ISRCollectionRequirements_Abridged.add(isPrismCr: isPrismCr, &fbb)
    ISRCollectionRequirements_Abridged.add(start: start, &fbb)
    ISRCollectionRequirements_Abridged.add(stop: stop, &fbb)
    ISRCollectionRequirements_Abridged.add(operation: operation, &fbb)
    ISRCollectionRequirements_Abridged.add(supportedUnit: supportedUnit, &fbb)
    ISRCollectionRequirements_Abridged.add(country: country, &fbb)
    ISRCollectionRequirements_Abridged.add(region: region, &fbb)
    ISRCollectionRequirements_Abridged.add(subregion: subregion, &fbb)
    ISRCollectionRequirements_Abridged.add(specialComGuidance: specialComGuidance, &fbb)
    ISRCollectionRequirements_Abridged.add(criticalTimes: criticalTimes, &fbb)
    ISRCollectionRequirements_Abridged.add(exploitationRequirement: exploitationRequirement, &fbb)
    ISRCollectionRequirements_Abridged.addVectorOf(targetList: targetList, &fbb)
    return ISRCollectionRequirements_Abridged.endISRCollectionRequirements_Abridged(&fbb, start: __start)
  }
