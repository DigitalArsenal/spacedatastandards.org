...
public enum BatteryDetails_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: BatteryDetails_dataMode_Enum { return .exercise }
  public static var min: BatteryDetails_dataMode_Enum { return .real }
}
...
public struct BatteryDetails: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: BatteryDetails.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: BatteryDetails_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : BatteryDetails_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startBatteryDetails(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 19) }
  ...
  public static func add(dataMode: BatteryDetails_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endBatteryDetails(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createBatteryDetails(
    ...
    let __start = BatteryDetails.startBatteryDetails(&fbb)
    BatteryDetails.add(id: id, &fbb)
    BatteryDetails.add(idBattery: idBattery, &fbb)
    BatteryDetails.add(classificationMarking: classificationMarking, &fbb)
    BatteryDetails.add(technology: technology, &fbb)
    BatteryDetails.add(capacity: capacity, &fbb)
    BatteryDetails.add(dischargeDepth: dischargeDepth, &fbb)
    BatteryDetails.add(model: model, &fbb)
    BatteryDetails.add(description: description, &fbb)
    BatteryDetails.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    BatteryDetails.add(createdAt: createdAt, &fbb)
    BatteryDetails.add(createdBy: createdBy, &fbb)
    BatteryDetails.add(updatedAt: updatedAt, &fbb)
    BatteryDetails.add(updatedBy: updatedBy, &fbb)
    BatteryDetails.add(source: source, &fbb)
    BatteryDetails.add(origin: origin, &fbb)
    BatteryDetails.add(origNetwork: origNetwork, &fbb)
    BatteryDetails.add(dataMode: dataMode, &fbb)
    BatteryDetails.addVectorOf(tags: tags, &fbb)
    BatteryDetails.add(manufacturerOrg: manufacturerOrg, &fbb)
    return BatteryDetails.endBatteryDetails(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: BatteryDetails_dataMode_Enum.self)
