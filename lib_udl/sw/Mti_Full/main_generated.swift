...
public enum Mti_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Mti_Full_dataMode_Enum { return .exercise }
  public static var min: Mti_Full_dataMode_Enum { return .real }
}


///  /// Information on the mission and flight plans, the type and configuration of the platform, and the reference time.
public struct Mti_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Mti_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: Mti_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Mti_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startMti_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 21) }
  public static func add(classificationMarking: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: classificationMarking, at: VTOFFSET.classificationMarking.p) }
  public static func add(source: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: source, at: VTOFFSET.source.p) }
  public static func add(origin: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origin, at: VTOFFSET.origin.p) }
  public static func add(id: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: id, at: VTOFFSET.id.p) }
  public static func add(dataMode: Mti_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endMti_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMti_Full(
    ...
    let __start = Mti_Full.startMti_Full(&fbb)
    Mti_Full.add(classificationMarking: classificationMarking, &fbb)
    Mti_Full.add(source: source, &fbb)
    Mti_Full.add(origin: origin, &fbb)
    Mti_Full.add(id: id, &fbb)
    Mti_Full.add(dataMode: dataMode, &fbb)
    Mti_Full.add(createdBy: createdBy, &fbb)
    Mti_Full.add(createdAt: createdAt, &fbb)
    Mti_Full.add(p3: p3, &fbb)
    Mti_Full.add(p6: p6, &fbb)
    Mti_Full.add(p7: p7, &fbb)
    Mti_Full.add(p8: p8, &fbb)
    Mti_Full.add(p9: p9, &fbb)
    Mti_Full.add(p10: p10, &fbb)
    Mti_Full.addVectorOf(missions: missions, &fbb)
    Mti_Full.addVectorOf(dwells: dwells, &fbb)
    Mti_Full.addVectorOf(hrrs: hrrs, &fbb)
    Mti_Full.addVectorOf(jobDefs: jobDefs, &fbb)
    Mti_Full.addVectorOf(freeTexts: freeTexts, &fbb)
    Mti_Full.addVectorOf(platformLocs: platformLocs, &fbb)
    Mti_Full.addVectorOf(jobRequests: jobRequests, &fbb)
    Mti_Full.add(origNetwork: origNetwork, &fbb)
    return Mti_Full.endMti_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Mti_Full_dataMode_Enum.self)
