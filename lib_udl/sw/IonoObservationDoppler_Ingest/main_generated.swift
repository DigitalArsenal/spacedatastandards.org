...
///  /// Array of Doppler.
public struct IonoObservationDoppler_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDoppler_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDoppler_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationDoppler_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDoppler_Ingest(
    ...
    let __start = IonoObservationDoppler_Ingest.startIonoObservationDoppler_Ingest(&fbb)
    IonoObservationDoppler_Ingest.add(notes: notes, &fbb)
    IonoObservationDoppler_Ingest.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationDoppler_Ingest.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationDoppler_Ingest.addVectorOf(data: data, &fbb)
    return IonoObservationDoppler_Ingest.endIonoObservationDoppler_Ingest(&fbb, start: __start)
  }
