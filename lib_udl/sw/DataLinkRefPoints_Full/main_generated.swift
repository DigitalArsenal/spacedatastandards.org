...
public struct DataLinkRefPoints_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DataLinkRefPoints_Full.id, addPrefix: prefix) }
  ...
  public static func startDataLinkRefPoints_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 6) }
  ...
  public static func endDataLinkRefPoints_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDataLinkRefPoints_Full(
    ...
    let __start = DataLinkRefPoints_Full.startDataLinkRefPoints_Full(&fbb)
    DataLinkRefPoints_Full.add(refPointType: refPointType, &fbb)
    DataLinkRefPoints_Full.add(refDes: refDes, &fbb)
    DataLinkRefPoints_Full.add(refLocName: refLocName, &fbb)
    DataLinkRefPoints_Full.add(refLat: refLat, &fbb)
    DataLinkRefPoints_Full.add(refLon: refLon, &fbb)
    DataLinkRefPoints_Full.add(effEventTime: effEventTime, &fbb)
    return DataLinkRefPoints_Full.endDataLinkRefPoints_Full(&fbb, start: __start)
  }
