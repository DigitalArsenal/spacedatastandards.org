...
public struct IonoObservationStokes_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationStokes_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationStokes_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endIonoObservationStokes_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationStokes_Ingest(
    ...
    let __start = IonoObservationStokes_Ingest.startIonoObservationStokes_Ingest(&fbb)
    IonoObservationStokes_Ingest.add(notes: notes, &fbb)
    IonoObservationStokes_Ingest.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationStokes_Ingest.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationStokes_Ingest.addVectorOf(data: data, &fbb)
    IonoObservationStokes_Ingest.addVectorOf(s: s, &fbb)
    return IonoObservationStokes_Ingest.endIonoObservationStokes_Ingest(&fbb, start: __start)
  }
