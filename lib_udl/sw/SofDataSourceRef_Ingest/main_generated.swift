...
public struct SofDataSourceRef_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SofDataSourceRef_Ingest.id, addPrefix: prefix) }
  ...
  public static func startSofDataSourceRef_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endSofDataSourceRef_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSofDataSourceRef_Ingest(
    ...
    let __start = SofDataSourceRef_Ingest.startSofDataSourceRef_Ingest(&fbb)
    SofDataSourceRef_Ingest.add(dataSourceId: dataSourceId, &fbb)
    SofDataSourceRef_Ingest.add(startPosition: startPosition, &fbb)
    SofDataSourceRef_Ingest.add(endPosition: endPosition, &fbb)
    SofDataSourceRef_Ingest.add(paragraphNumber: paragraphNumber, &fbb)
    SofDataSourceRef_Ingest.add(sentenceNumber: sentenceNumber, &fbb)
    return SofDataSourceRef_Ingest.endSofDataSourceRef_Ingest(&fbb, start: __start)
  }
