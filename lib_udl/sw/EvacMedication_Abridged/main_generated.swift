...
public struct EvacMedication_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacMedication_Abridged.id, addPrefix: prefix) }
  ...
  public static func startEvacMedication_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 6) }
  ...
  public static func endEvacMedication_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacMedication_Abridged(
    ...
    let __start = EvacMedication_Abridged.startEvacMedication_Abridged(&fbb)
    EvacMedication_Abridged.add(type: type, &fbb)
    EvacMedication_Abridged.add(bodyPart: bodyPart, &fbb)
    EvacMedication_Abridged.add(dose: dose, &fbb)
    EvacMedication_Abridged.add(adminRoute: adminRoute, &fbb)
    EvacMedication_Abridged.add(time: time, &fbb)
    EvacMedication_Abridged.add(comments: comments, &fbb)
    return EvacMedication_Abridged.endEvacMedication_Abridged(&fbb, start: __start)
  }
