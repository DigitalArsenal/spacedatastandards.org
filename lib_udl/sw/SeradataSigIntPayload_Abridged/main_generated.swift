...
public enum SeradataSigIntPayload_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SeradataSigIntPayload_Abridged_dataMode_Enum { return .exercise }
  public static var min: SeradataSigIntPayload_Abridged_dataMode_Enum { return .real }
}


///  /// Details for an sigint payload from  Seradata.
public struct SeradataSigIntPayload_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SeradataSigIntPayload_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SeradataSigIntPayload_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SeradataSigIntPayload_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSeradataSigIntPayload_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 21) }
  ...
  public static func add(dataMode: SeradataSigIntPayload_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSeradataSigIntPayload_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSeradataSigIntPayload_Abridged(
    ...
    let __start = SeradataSigIntPayload_Abridged.startSeradataSigIntPayload_Abridged(&fbb)
    SeradataSigIntPayload_Abridged.add(id: id, &fbb)
    SeradataSigIntPayload_Abridged.add(classificationMarking: classificationMarking, &fbb)
    SeradataSigIntPayload_Abridged.add(spacecraftId: spacecraftId, &fbb)
    SeradataSigIntPayload_Abridged.add(idSensor: idSensor, &fbb)
    SeradataSigIntPayload_Abridged.add(hostedForCompanyOrgId: hostedForCompanyOrgId, &fbb)
    SeradataSigIntPayload_Abridged.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    SeradataSigIntPayload_Abridged.add(type: type, &fbb)
    SeradataSigIntPayload_Abridged.add(swathWidth: swathWidth, &fbb)
    SeradataSigIntPayload_Abridged.add(groundStations: groundStations, &fbb)
    SeradataSigIntPayload_Abridged.add(groundStationLocations: groundStationLocations, &fbb)
    SeradataSigIntPayload_Abridged.add(frequencyCoverage: frequencyCoverage, &fbb)
    SeradataSigIntPayload_Abridged.add(positionalAccuracy: positionalAccuracy, &fbb)
    SeradataSigIntPayload_Abridged.add(interceptParameters: interceptParameters, &fbb)
    SeradataSigIntPayload_Abridged.add(name: name, &fbb)
    SeradataSigIntPayload_Abridged.add(notes: notes, &fbb)
    SeradataSigIntPayload_Abridged.add(createdAt: createdAt, &fbb)
    SeradataSigIntPayload_Abridged.add(createdBy: createdBy, &fbb)
    SeradataSigIntPayload_Abridged.add(source: source, &fbb)
    SeradataSigIntPayload_Abridged.add(origin: origin, &fbb)
    SeradataSigIntPayload_Abridged.add(origNetwork: origNetwork, &fbb)
    SeradataSigIntPayload_Abridged.add(dataMode: dataMode, &fbb)
    return SeradataSigIntPayload_Abridged.endSeradataSigIntPayload_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SeradataSigIntPayload_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
