...
public enum SeradataOpticalPayload_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SeradataOpticalPayload_Abridged_dataMode_Enum { return .exercise }
  public static var min: SeradataOpticalPayload_Abridged_dataMode_Enum { return .real }
}


///  /// Details for an optical payload from  Seradata.
public struct SeradataOpticalPayload_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SeradataOpticalPayload_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SeradataOpticalPayload_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SeradataOpticalPayload_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSeradataOpticalPayload_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 26) }
  ...
  public static func add(dataMode: SeradataOpticalPayload_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSeradataOpticalPayload_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSeradataOpticalPayload_Abridged(
    ...
    let __start = SeradataOpticalPayload_Abridged.startSeradataOpticalPayload_Abridged(&fbb)
    SeradataOpticalPayload_Abridged.add(id: id, &fbb)
    SeradataOpticalPayload_Abridged.add(classificationMarking: classificationMarking, &fbb)
    SeradataOpticalPayload_Abridged.add(spacecraftId: spacecraftId, &fbb)
    SeradataOpticalPayload_Abridged.add(idSensor: idSensor, &fbb)
    SeradataOpticalPayload_Abridged.add(hostedForCompanyOrgId: hostedForCompanyOrgId, &fbb)
    SeradataOpticalPayload_Abridged.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    SeradataOpticalPayload_Abridged.add(imagingPayloadCategory: imagingPayloadCategory, &fbb)
    SeradataOpticalPayload_Abridged.add(name: name, &fbb)
    SeradataOpticalPayload_Abridged.add(spectralBand: spectralBand, &fbb)
    SeradataOpticalPayload_Abridged.add(spectralFrequencyLimits: spectralFrequencyLimits, &fbb)
    SeradataOpticalPayload_Abridged.add(numberOfFilmReturnCanisters: numberOfFilmReturnCanisters, &fbb)
    SeradataOpticalPayload_Abridged.add(bestResolution: bestResolution, &fbb)
    SeradataOpticalPayload_Abridged.add(swathWidth: swathWidth, &fbb)
    SeradataOpticalPayload_Abridged.add(recorderSize: recorderSize, &fbb)
    SeradataOpticalPayload_Abridged.add(fieldOfView: fieldOfView, &fbb)
    SeradataOpticalPayload_Abridged.add(fieldOfRegard: fieldOfRegard, &fbb)
    SeradataOpticalPayload_Abridged.add(pointingMethod: pointingMethod, &fbb)
    SeradataOpticalPayload_Abridged.add(groundStations: groundStations, &fbb)
    SeradataOpticalPayload_Abridged.add(groundStationLocations: groundStationLocations, &fbb)
    SeradataOpticalPayload_Abridged.add(notes: notes, &fbb)
    SeradataOpticalPayload_Abridged.add(createdAt: createdAt, &fbb)
    SeradataOpticalPayload_Abridged.add(createdBy: createdBy, &fbb)
    SeradataOpticalPayload_Abridged.add(source: source, &fbb)
    SeradataOpticalPayload_Abridged.add(origin: origin, &fbb)
    SeradataOpticalPayload_Abridged.add(origNetwork: origNetwork, &fbb)
    SeradataOpticalPayload_Abridged.add(dataMode: dataMode, &fbb)
    return SeradataOpticalPayload_Abridged.endSeradataOpticalPayload_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SeradataOpticalPayload_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
