...
public enum MonoRadar_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: MonoRadar_Full_dataMode_Enum { return .exercise }
  public static var min: MonoRadar_Full_dataMode_Enum { return .real }
}
...
public struct MonoRadar_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MonoRadar_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: MonoRadar_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : MonoRadar_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startMonoRadar_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 73) }
  ...
  public static func add(dataMode: MonoRadar_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endMonoRadar_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMonoRadar_Full(
    ...
    let __start = MonoRadar_Full.startMonoRadar_Full(&fbb)
    MonoRadar_Full.add(id: id, &fbb)
    MonoRadar_Full.add(classificationMarking: classificationMarking, &fbb)
    MonoRadar_Full.add(tti: tti, &fbb)
    MonoRadar_Full.add(idSensor: idSensor, &fbb)
    MonoRadar_Full.add(senlat: senlat, &fbb)
    MonoRadar_Full.add(senlon: senlon, &fbb)
    MonoRadar_Full.add(senalt: senalt, &fbb)
    MonoRadar_Full.add(sac: sac, &fbb)
    MonoRadar_Full.add(sic: sic, &fbb)
    MonoRadar_Full.add(tgtid: tgtid, &fbb)
    MonoRadar_Full.add(addr: addr, &fbb)
    MonoRadar_Full.add(msgfmt: msgfmt, &fbb)
    MonoRadar_Full.add(msgtyp: msgtyp, &fbb)
    MonoRadar_Full.add(af: af, &fbb)
    MonoRadar_Full.add(faa: faa, &fbb)
    MonoRadar_Full.add(spi: spi, &fbb)
    MonoRadar_Full.add(aims: aims, &fbb)
    MonoRadar_Full.add(mti: mti, &fbb)
    MonoRadar_Full.add(bcnhits: bcnhits, &fbb)
    MonoRadar_Full.add(ts: ts, &fbb)
    MonoRadar_Full.add(msgts: msgts, &fbb)
    MonoRadar_Full.add(rng: rng, &fbb)
    MonoRadar_Full.add(az: az, &fbb)
    MonoRadar_Full.add(acp: acp, &fbb)
    MonoRadar_Full.add(alt3d: alt3d, &fbb)
    MonoRadar_Full.add(mc: mc, &fbb)
    MonoRadar_Full.add(mcv: mcv, &fbb)
    MonoRadar_Full.add(mcg: mcg, &fbb)
    MonoRadar_Full.add(m1: m1, &fbb)
    MonoRadar_Full.add(m1v: m1v, &fbb)
    MonoRadar_Full.add(m1g: m1g, &fbb)
    MonoRadar_Full.add(m2: m2, &fbb)
    MonoRadar_Full.add(m2v: m2v, &fbb)
    MonoRadar_Full.add(m2xv: m2xv, &fbb)
    MonoRadar_Full.add(m2g: m2g, &fbb)
    MonoRadar_Full.add(m3a: m3a, &fbb)
    MonoRadar_Full.add(m3av: m3av, &fbb)
    MonoRadar_Full.add(m3ag: m3ag, &fbb)
    MonoRadar_Full.add(m3axv: m3axv, &fbb)
    MonoRadar_Full.add(m4: m4, &fbb)
    MonoRadar_Full.add(m4v: m4v, &fbb)
    MonoRadar_Full.add(m4d1d2: m4d1d2, &fbb)
    MonoRadar_Full.add(mscommb: mscommb, &fbb)
    MonoRadar_Full.add(milemrgcy: milemrgcy, &fbb)
    MonoRadar_Full.add(code7500: code7500, &fbb)
    MonoRadar_Full.add(code7600: code7600, &fbb)
    MonoRadar_Full.add(code7700: code7700, &fbb)
    MonoRadar_Full.add(grndspd: grndspd, &fbb)
    MonoRadar_Full.add(hdng: hdng, &fbb)
    MonoRadar_Full.add(trknum: trknum, &fbb)
    MonoRadar_Full.add(rad: rad, &fbb)
    MonoRadar_Full.add(mah: mah, &fbb)
    MonoRadar_Full.add(cdm: cdm, &fbb)
    MonoRadar_Full.addVectorOf(cartpos: cartpos, &fbb)
    MonoRadar_Full.add(psrrl: psrrl, &fbb)
    MonoRadar_Full.add(ssrl: ssrl, &fbb)
    MonoRadar_Full.add(rngdelt: rngdelt, &fbb)
    MonoRadar_Full.add(azdelt: azdelt, &fbb)
    MonoRadar_Full.addVectorOf(wectc: wectc, &fbb)
    MonoRadar_Full.add(mrgrpt: mrgrpt, &fbb)
    MonoRadar_Full.add(artsqual: artsqual, &fbb)
    MonoRadar_Full.add(trkelig: trkelig, &fbb)
    MonoRadar_Full.add(tgtconf: tgtconf, &fbb)
    MonoRadar_Full.add(tgtcorr: tgtcorr, &fbb)
    MonoRadar_Full.add(tis: tis, &fbb)
    MonoRadar_Full.addVectorOf(tags: tags, &fbb)
    MonoRadar_Full.add(origSensorId: origSensorId, &fbb)
    MonoRadar_Full.add(source: source, &fbb)
    MonoRadar_Full.add(origin: origin, &fbb)
    MonoRadar_Full.add(dataMode: dataMode, &fbb)
    MonoRadar_Full.add(createdAt: createdAt, &fbb)
    MonoRadar_Full.add(createdBy: createdBy, &fbb)
    MonoRadar_Full.add(origNetwork: origNetwork, &fbb)
    return MonoRadar_Full.endMonoRadar_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: MonoRadar_Full_dataMode_Enum.self)
