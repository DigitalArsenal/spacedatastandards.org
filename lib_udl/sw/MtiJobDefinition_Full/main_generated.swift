...
public struct MtiJobDefinition_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiJobDefinition_Full.id, addPrefix: prefix) }
  ...
  public static func startMtiJobDefinition_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 28) }
  ...
  public static func endMtiJobDefinition_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiJobDefinition_Full(
    ...
    let __start = MtiJobDefinition_Full.startMtiJobDefinition_Full(&fbb)
    MtiJobDefinition_Full.add(j1: j1, &fbb)
    MtiJobDefinition_Full.add(j2: j2, &fbb)
    MtiJobDefinition_Full.add(j3: j3, &fbb)
    MtiJobDefinition_Full.add(j4: j4, &fbb)
    MtiJobDefinition_Full.add(j5: j5, &fbb)
    MtiJobDefinition_Full.add(j6: j6, &fbb)
    MtiJobDefinition_Full.add(j7: j7, &fbb)
    MtiJobDefinition_Full.add(j8: j8, &fbb)
    MtiJobDefinition_Full.add(j9: j9, &fbb)
    MtiJobDefinition_Full.add(j10: j10, &fbb)
    MtiJobDefinition_Full.add(j11: j11, &fbb)
    MtiJobDefinition_Full.add(j12: j12, &fbb)
    MtiJobDefinition_Full.add(j13: j13, &fbb)
    MtiJobDefinition_Full.add(j14: j14, &fbb)
    MtiJobDefinition_Full.add(j15: j15, &fbb)
    MtiJobDefinition_Full.add(j16: j16, &fbb)
    MtiJobDefinition_Full.add(j17: j17, &fbb)
    MtiJobDefinition_Full.add(j18: j18, &fbb)
    MtiJobDefinition_Full.add(j19: j19, &fbb)
    MtiJobDefinition_Full.add(j20: j20, &fbb)
    MtiJobDefinition_Full.add(j21: j21, &fbb)
    MtiJobDefinition_Full.add(j22: j22, &fbb)
    MtiJobDefinition_Full.add(j23: j23, &fbb)
    MtiJobDefinition_Full.add(j24: j24, &fbb)
    MtiJobDefinition_Full.add(j25: j25, &fbb)
    MtiJobDefinition_Full.add(j26: j26, &fbb)
    MtiJobDefinition_Full.add(j27: j27, &fbb)
    MtiJobDefinition_Full.add(j28: j28, &fbb)
    return MtiJobDefinition_Full.endMtiJobDefinition_Full(&fbb, start: __start)
  }
