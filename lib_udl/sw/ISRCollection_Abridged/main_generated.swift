...
public enum ISRCollection_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: ISRCollection_Abridged_dataMode_Enum { return .exercise }
  public static var min: ISRCollection_Abridged_dataMode_Enum { return .real }
}


///  /// ISR Collection data.
public struct ISRCollection_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollection_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: ISRCollection_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : ISRCollection_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startISRCollection_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 34) }
  ...
  public static func add(dataMode: ISRCollection_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endISRCollection_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollection_Abridged(
    ...
    let __start = ISRCollection_Abridged.startISRCollection_Abridged(&fbb)
    ISRCollection_Abridged.add(id: id, &fbb)
    ISRCollection_Abridged.add(classificationMarking: classificationMarking, &fbb)
    ISRCollection_Abridged.add(idexVersion: idexVersion, &fbb)
    ISRCollection_Abridged.add(name: name, &fbb)
    ISRCollection_Abridged.add(missionId: missionId, &fbb)
    ISRCollection_Abridged.add(missionAor: missionAor, &fbb)
    ISRCollection_Abridged.add(missionPrimaryIntelDiscipline: missionPrimaryIntelDiscipline, &fbb)
    ISRCollection_Abridged.add(missionPrimarySubCategory: missionPrimarySubCategory, &fbb)
    ISRCollection_Abridged.add(missionSecondaryIntelDiscipline: missionSecondaryIntelDiscipline, &fbb)
    ISRCollection_Abridged.add(missionSecondarySubCategory: missionSecondarySubCategory, &fbb)
    ISRCollection_Abridged.add(missionRole: missionRole, &fbb)
    ISRCollection_Abridged.add(missionOperation: missionOperation, &fbb)
    ISRCollection_Abridged.add(missionPriority: missionPriority, &fbb)
    ISRCollection_Abridged.add(missionSupportedUnit: missionSupportedUnit, &fbb)
    ISRCollection_Abridged.add(missionEmphasis: missionEmphasis, &fbb)
    ISRCollection_Abridged.add(missionStartPointLat: missionStartPointLat, &fbb)
    ISRCollection_Abridged.add(missionStartPointLong: missionStartPointLong, &fbb)
    ISRCollection_Abridged.add(missionCollectionArea: missionCollectionArea, &fbb)
    ISRCollection_Abridged.add(missionJoa: missionJoa, &fbb)
    ISRCollection_Abridged.add(missionSyncMatrixBin: missionSyncMatrixBin, &fbb)
    ISRCollection_Abridged.add(missionCountry: missionCountry, &fbb)
    ISRCollection_Abridged.add(missionRegion: missionRegion, &fbb)
    ISRCollection_Abridged.add(missionSubRegion: missionSubRegion, &fbb)
    ISRCollection_Abridged.addVectorOf(collectionRequirements: collectionRequirements, &fbb)
    ISRCollection_Abridged.addVectorOf(transit: transit, &fbb)
    ISRCollection_Abridged.addVectorOf(taskings: taskings, &fbb)
    ISRCollection_Abridged.add(createdAt: createdAt, &fbb)
    ISRCollection_Abridged.add(createdBy: createdBy, &fbb)
    ISRCollection_Abridged.add(updatedAt: updatedAt, &fbb)
    ISRCollection_Abridged.add(updatedBy: updatedBy, &fbb)
    ISRCollection_Abridged.add(source: source, &fbb)
    ISRCollection_Abridged.add(origin: origin, &fbb)
    ISRCollection_Abridged.add(dataMode: dataMode, &fbb)
    ISRCollection_Abridged.add(origNetwork: origNetwork, &fbb)
    return ISRCollection_Abridged.endISRCollection_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: ISRCollection_Abridged_dataMode_Enum.self)
