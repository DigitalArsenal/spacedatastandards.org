...
public struct AirEventTankers_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirEventTankers_Full.id, addPrefix: prefix) }
  ...
  public static func startAirEventTankers_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 18) }
  ...
  public static func endAirEventTankers_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirEventTankers_Full(
    ...
    let __start = AirEventTankers_Full.startAirEventTankers_Full(&fbb)
    AirEventTankers_Full.add(idTankerSortie: idTankerSortie, &fbb)
    AirEventTankers_Full.add(idTankerMission: idTankerMission, &fbb)
    AirEventTankers_Full.add(idTankerAirfield: idTankerAirfield, &fbb)
    AirEventTankers_Full.add(externalTankerId: externalTankerId, &fbb)
    AirEventTankers_Full.add(tankerCoord: tankerCoord, &fbb)
    AirEventTankers_Full.add(tankerMds: tankerMds, &fbb)
    AirEventTankers_Full.add(amcTankerMissionId: amcTankerMissionId, &fbb)
    AirEventTankers_Full.add(altTankerMissionId: altTankerMissionId, &fbb)
    AirEventTankers_Full.add(tankerCallSign: tankerCallSign, &fbb)
    AirEventTankers_Full.add(tankerOwner: tankerOwner, &fbb)
    AirEventTankers_Full.add(tankerPoc: tankerPoc, &fbb)
    AirEventTankers_Full.add(tankerLegNum: tankerLegNum, &fbb)
    AirEventTankers_Full.add(tankerDeployedIcao: tankerDeployedIcao, &fbb)
    AirEventTankers_Full.add(tankerDeliveryMethod: tankerDeliveryMethod, &fbb)
    AirEventTankers_Full.add(fuelOff: fuelOff, &fbb)
    AirEventTankers_Full.add(tankerCellPosition: tankerCellPosition, &fbb)
    AirEventTankers_Full.add(tankerFuelType: tankerFuelType, &fbb)
    AirEventTankers_Full.add(dualRole: dualRole, &fbb)
    return AirEventTankers_Full.endAirEventTankers_Full(&fbb, start: __start)
  }
