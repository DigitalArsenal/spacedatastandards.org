...
public struct AirspaceControlPoint_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirspaceControlPoint_Ingest.id, addPrefix: prefix) }
  ...
  public static func startAirspaceControlPoint_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endAirspaceControlPoint_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirspaceControlPoint_Ingest(
    ...
    let __start = AirspaceControlPoint_Ingest.startAirspaceControlPoint_Ingest(&fbb)
    AirspaceControlPoint_Ingest.add(ctrlPtType: ctrlPtType, &fbb)
    AirspaceControlPoint_Ingest.add(ctrlPtName: ctrlPtName, &fbb)
    AirspaceControlPoint_Ingest.add(ctrlPtLocation: ctrlPtLocation, &fbb)
    AirspaceControlPoint_Ingest.add(ctrlPtAltitude: ctrlPtAltitude, &fbb)
    return AirspaceControlPoint_Ingest.endAirspaceControlPoint_Ingest(&fbb, start: __start)
  }
