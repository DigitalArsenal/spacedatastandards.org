...
public enum EOObservationDetails_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: EOObservationDetails_Ingest_dataMode_Enum { return .exercise }
  public static var min: EOObservationDetails_Ingest_dataMode_Enum { return .real }
}


///  /// Model representation of additional detailed observation data for electro-optical based sensor phenomenologies.
public struct EOObservationDetails_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EOObservationDetails_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: EOObservationDetails_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : EOObservationDetails_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startEOObservationDetails_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 83) }
  ...
  public static func add(dataMode: EOObservationDetails_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func endEOObservationDetails_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEOObservationDetails_Ingest(
    ...
    let __start = EOObservationDetails_Ingest.startEOObservationDetails_Ingest(&fbb)
    EOObservationDetails_Ingest.add(idEoobservation: idEoobservation, &fbb)
    EOObservationDetails_Ingest.add(classificationMarking: classificationMarking, &fbb)
    EOObservationDetails_Ingest.add(obTime: obTime, &fbb)
    EOObservationDetails_Ingest.add(predictedRa: predictedRa, &fbb)
    EOObservationDetails_Ingest.add(predictedDeclination: predictedDeclination, &fbb)
    EOObservationDetails_Ingest.add(predictedAzimuth: predictedAzimuth, &fbb)
    EOObservationDetails_Ingest.add(predictedElevation: predictedElevation, &fbb)
    EOObservationDetails_Ingest.add(sunAzimuth: sunAzimuth, &fbb)
    EOObservationDetails_Ingest.add(sunElevation: sunElevation, &fbb)
    EOObservationDetails_Ingest.add(numSpectralFilters: numSpectralFilters, &fbb)
    EOObservationDetails_Ingest.addVectorOf(spectralFilters: spectralFilters, &fbb)
    EOObservationDetails_Ingest.addVectorOf(spectralZmfl: spectralZmfl, &fbb)
    EOObservationDetails_Ingest.addVectorOf(spectralFilterSolarMag: spectralFilterSolarMag, &fbb)
    EOObservationDetails_Ingest.addVectorOf(zeroPoints: zeroPoints, &fbb)
    EOObservationDetails_Ingest.addVectorOf(zeroPointsUnc: zeroPointsUnc, &fbb)
    EOObservationDetails_Ingest.addVectorOf(extinctionCoeffs: extinctionCoeffs, &fbb)
    EOObservationDetails_Ingest.addVectorOf(extinctionCoeffsUnc: extinctionCoeffsUnc, &fbb)
    EOObservationDetails_Ingest.addVectorOf(colorCoeffs: colorCoeffs, &fbb)
    EOObservationDetails_Ingest.add(numNeutralDensityFilters: numNeutralDensityFilters, &fbb)
    EOObservationDetails_Ingest.addVectorOf(neutralDensityFilterNames: neutralDensityFilterNames, &fbb)
    EOObservationDetails_Ingest.addVectorOf(neutralDensityFilterTransmissions: neutralDensityFilterTransmissions, &fbb)
    EOObservationDetails_Ingest.addVectorOf(neutralDensityFilterTransmissionsUnc: neutralDensityFilterTransmissionsUnc, &fbb)
    EOObservationDetails_Ingest.add(gain: gain, &fbb)
    EOObservationDetails_Ingest.add(ifov: ifov, &fbb)
    EOObservationDetails_Ingest.add(pixelArrayWidth: pixelArrayWidth, &fbb)
    EOObservationDetails_Ingest.add(pixelArrayHeight: pixelArrayHeight, &fbb)
    EOObservationDetails_Ingest.add(pixelMin: pixelMin, &fbb)
    EOObservationDetails_Ingest.add(pixelMax: pixelMax, &fbb)
    EOObservationDetails_Ingest.add(centroidRow: centroidRow, &fbb)
    EOObservationDetails_Ingest.add(centroidColumn: centroidColumn, &fbb)
    EOObservationDetails_Ingest.add(rowVariance: rowVariance, &fbb)
    EOObservationDetails_Ingest.add(columnVariance: columnVariance, &fbb)
    EOObservationDetails_Ingest.add(rowColCov: rowColCov, &fbb)
    EOObservationDetails_Ingest.addVectorOf(distFromStreakCenter: distFromStreakCenter, &fbb)
    EOObservationDetails_Ingest.addVectorOf(surfBrightness: surfBrightness, &fbb)
    EOObservationDetails_Ingest.addVectorOf(surfBrightnessUnc: surfBrightnessUnc, &fbb)
    EOObservationDetails_Ingest.add(timesUnc: timesUnc, &fbb)
    EOObservationDetails_Ingest.add(ccdTemp: ccdTemp, &fbb)
    EOObservationDetails_Ingest.add(currentSpectralFilterNum: currentSpectralFilterNum, &fbb)
    EOObservationDetails_Ingest.add(currentNeutralDensityFilterNum: currentNeutralDensityFilterNum, &fbb)
    EOObservationDetails_Ingest.add(binningHoriz: binningHoriz, &fbb)
    EOObservationDetails_Ingest.add(binningVert: binningVert, &fbb)
    EOObservationDetails_Ingest.add(pcalNumStars: pcalNumStars, &fbb)
    EOObservationDetails_Ingest.add(ccdObjPosX: ccdObjPosX, &fbb)
    EOObservationDetails_Ingest.add(ccdObjPosY: ccdObjPosY, &fbb)
    EOObservationDetails_Ingest.add(ccdObjWidth: ccdObjWidth, &fbb)
    EOObservationDetails_Ingest.add(backgroundSignal: backgroundSignal, &fbb)
    EOObservationDetails_Ingest.add(backgroundSignalUnc: backgroundSignalUnc, &fbb)
    EOObservationDetails_Ingest.add(peakApertureCount: peakApertureCount, &fbb)
    EOObservationDetails_Ingest.add(peakBackgroundCount: peakBackgroundCount, &fbb)
    EOObservationDetails_Ingest.add(snrEst: snrEst, &fbb)
    EOObservationDetails_Ingest.add(magInstrumental: magInstrumental, &fbb)
    EOObservationDetails_Ingest.add(magInstrumentalUnc: magInstrumentalUnc, &fbb)
    EOObservationDetails_Ingest.add(opticalCrossSection: opticalCrossSection, &fbb)
    EOObservationDetails_Ingest.add(opticalCrossSectionUnc: opticalCrossSectionUnc, &fbb)
    EOObservationDetails_Ingest.add(sunStatePosX: sunStatePosX, &fbb)
    EOObservationDetails_Ingest.add(sunStatePosY: sunStatePosY, &fbb)
    EOObservationDetails_Ingest.add(sunStatePosZ: sunStatePosZ, &fbb)
    EOObservationDetails_Ingest.add(sunStateVelX: sunStateVelX, &fbb)
    EOObservationDetails_Ingest.add(sunStateVelY: sunStateVelY, &fbb)
    EOObservationDetails_Ingest.add(sunStateVelZ: sunStateVelZ, &fbb)
    EOObservationDetails_Ingest.add(numCatalogStars: numCatalogStars, &fbb)
    EOObservationDetails_Ingest.add(numDetectedStars: numDetectedStars, &fbb)
    EOObservationDetails_Ingest.add(numCorrelatedStars: numCorrelatedStars, &fbb)
    EOObservationDetails_Ingest.add(predictedRaUnc: predictedRaUnc, &fbb)
    EOObservationDetails_Ingest.add(predictedDeclinationUnc: predictedDeclinationUnc, &fbb)
    EOObservationDetails_Ingest.add(raCov: raCov, &fbb)
    EOObservationDetails_Ingest.add(declinationCov: declinationCov, &fbb)
    EOObservationDetails_Ingest.add(raDeclinationCov: raDeclinationCov, &fbb)
    EOObservationDetails_Ingest.add(acalCrPixX: acalCrPixX, &fbb)
    EOObservationDetails_Ingest.add(acalCrPixY: acalCrPixY, &fbb)
    EOObservationDetails_Ingest.add(acalCrValX: acalCrValX, &fbb)
    EOObservationDetails_Ingest.add(acalCrValY: acalCrValY, &fbb)
    EOObservationDetails_Ingest.add(acalNumStars: acalNumStars, &fbb)
    EOObservationDetails_Ingest.add(objSunRange: objSunRange, &fbb)
    EOObservationDetails_Ingest.add(phaseAngBisect: phaseAngBisect, &fbb)
    EOObservationDetails_Ingest.add(solarDiskFrac: solarDiskFrac, &fbb)
    EOObservationDetails_Ingest.add(toes: toes, &fbb)
    EOObservationDetails_Ingest.add(does: does, &fbb)
    EOObservationDetails_Ingest.add(source: source, &fbb)
    EOObservationDetails_Ingest.add(dataMode: dataMode, &fbb)
    EOObservationDetails_Ingest.add(createdAt: createdAt, &fbb)
    EOObservationDetails_Ingest.add(createdBy: createdBy, &fbb)
    return EOObservationDetails_Ingest.endEOObservationDetails_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: EOObservationDetails_Ingest_dataMode_Enum.self)
