...
public enum Airfield_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Airfield_Full_dataMode_Enum { return .exercise }
  public static var min: Airfield_Full_dataMode_Enum { return .real }
}


///  /// Properties and characteristics of an airfield, which includes location, airfield codes, suitability codes, and remarks.
public struct Airfield_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Airfield_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Airfield_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Airfield_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startAirfield_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 37) }
  ...
  public static func add(dataMode: Airfield_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endAirfield_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirfield_Full(
    ...
    let __start = Airfield_Full.startAirfield_Full(&fbb)
    Airfield_Full.add(id: id, &fbb)
    Airfield_Full.add(classificationMarking: classificationMarking, &fbb)
    Airfield_Full.add(idSite: idSite, &fbb)
    Airfield_Full.add(altAirfieldId: altAirfieldId, &fbb)
    Airfield_Full.add(wacInnr: wacInnr, &fbb)
    Airfield_Full.add(zarId: zarId, &fbb)
    Airfield_Full.add(icao: icao, &fbb)
    Airfield_Full.add(iata: iata, &fbb)
    Airfield_Full.add(faa: faa, &fbb)
    Airfield_Full.add(hostNatCode: hostNatCode, &fbb)
    Airfield_Full.add(name: name, &fbb)
    Airfield_Full.add(type: type, &fbb)
    Airfield_Full.add(lat: lat, &fbb)
    Airfield_Full.add(lon: lon, &fbb)
    Airfield_Full.add(elevFt: elevFt, &fbb)
    Airfield_Full.add(elevM: elevM, &fbb)
    Airfield_Full.add(magDec: magDec, &fbb)
    Airfield_Full.add(regionName: regionName, &fbb)
    Airfield_Full.add(countryCode: countryCode, &fbb)
    Airfield_Full.add(city: city, &fbb)
    Airfield_Full.add(state: state, &fbb)
    Airfield_Full.add(geoloc: geoloc, &fbb)
    Airfield_Full.add(gmtOffset: gmtOffset, &fbb)
    Airfield_Full.add(suitabilityCodes: suitabilityCodes, &fbb)
    Airfield_Full.add(miscCodes: miscCodes, &fbb)
    Airfield_Full.add(runways: runways, &fbb)
    Airfield_Full.add(maxRunwayLength: maxRunwayLength, &fbb)
    Airfield_Full.add(infoUrl: infoUrl, &fbb)
    Airfield_Full.add(createdAt: createdAt, &fbb)
    Airfield_Full.add(createdBy: createdBy, &fbb)
    Airfield_Full.add(updatedAt: updatedAt, &fbb)
    Airfield_Full.add(updatedBy: updatedBy, &fbb)
    Airfield_Full.add(sourceDl: sourceDl, &fbb)
    Airfield_Full.add(source: source, &fbb)
    Airfield_Full.add(origin: origin, &fbb)
    Airfield_Full.add(origNetwork: origNetwork, &fbb)
    Airfield_Full.add(dataMode: dataMode, &fbb)
    return Airfield_Full.endAirfield_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Airfield_Full_dataMode_Enum.self)
    _v.finish()
  }
}
