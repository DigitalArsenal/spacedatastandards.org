...
public struct DataLinkMultiDutyVoiceCoord_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DataLinkMultiDutyVoiceCoord_Ingest.id, addPrefix: prefix) }
  ...
  public static func startDataLinkMultiDutyVoiceCoord_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endDataLinkMultiDutyVoiceCoord_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDataLinkMultiDutyVoiceCoord_Ingest(
    ...
    let __start = DataLinkMultiDutyVoiceCoord_Ingest.startDataLinkMultiDutyVoiceCoord_Ingest(&fbb)
    DataLinkMultiDutyVoiceCoord_Ingest.add(multiVoiceNetDes: multiVoiceNetDes, &fbb)
    DataLinkMultiDutyVoiceCoord_Ingest.add(multiFreqDes: multiFreqDes, &fbb)
    DataLinkMultiDutyVoiceCoord_Ingest.add(multiCommPri: multiCommPri, &fbb)
    DataLinkMultiDutyVoiceCoord_Ingest.addVectorOf(multiTeleFreqNums: multiTeleFreqNums, &fbb)
    return DataLinkMultiDutyVoiceCoord_Ingest.endDataLinkMultiDutyVoiceCoord_Ingest(&fbb, start: __start)
  }
