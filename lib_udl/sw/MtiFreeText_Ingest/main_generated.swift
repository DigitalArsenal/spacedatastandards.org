...
public struct MtiFreeText_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiFreeText_Ingest.id, addPrefix: prefix) }
  ...
  public static func startMtiFreeText_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endMtiFreeText_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiFreeText_Ingest(
    _ fbb: inout FlatBufferBuilder,
    f1Offset f1: Offset = Offset(),
    f2Offset f2: Offset = Offset(),
    f3Offset f3: Offset = Offset()
  ) -> Offset {
    let __start = MtiFreeText_Ingest.startMtiFreeText_Ingest(&fbb)
    MtiFreeText_Ingest.add(f1: f1, &fbb)
    MtiFreeText_Ingest.add(f2: f2, &fbb)
    MtiFreeText_Ingest.add(f3: f3, &fbb)
    return MtiFreeText_Ingest.endMtiFreeText_Ingest(&fbb, start: __start)
  }
