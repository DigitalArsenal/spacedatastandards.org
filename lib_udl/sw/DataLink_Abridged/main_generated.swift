...
public enum DataLink_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: DataLink_Abridged_dataMode_Enum { return .exercise }
  public static var min: DataLink_Abridged_dataMode_Enum { return .real }
}


///  /// Beta Version DataLink: Detailed instructions regarding the operations of data links.
public struct DataLink_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DataLink_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: DataLink_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : DataLink_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startDataLink_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 74) }
  ...
  public static func add(dataMode: DataLink_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endDataLink_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDataLink_Abridged(
    ...
    let __start = DataLink_Abridged.startDataLink_Abridged(&fbb)
    DataLink_Abridged.add(id: id, &fbb)
    DataLink_Abridged.add(classificationMarking: classificationMarking, &fbb)
    DataLink_Abridged.add(opExName: opExName, &fbb)
    DataLink_Abridged.add(originator: originator, &fbb)
    DataLink_Abridged.add(startTime: startTime, &fbb)
    DataLink_Abridged.add(stopTime: stopTime, &fbb)
    DataLink_Abridged.add(stopTimeMod: stopTimeMod, &fbb)
    DataLink_Abridged.add(planOrigNum: planOrigNum, &fbb)
    DataLink_Abridged.add(opExInfo: opExInfo, &fbb)
    DataLink_Abridged.add(opExInfoAlt: opExInfoAlt, &fbb)
    DataLink_Abridged.add(serialNum: serialNum, &fbb)
    DataLink_Abridged.add(month: month, &fbb)
    DataLink_Abridged.add(qualifier: qualifier, &fbb)
    DataLink_Abridged.add(qualSn: qualSn, &fbb)
    DataLink_Abridged.addVectorOf(references: references, &fbb)
    DataLink_Abridged.add(canxId: canxId, &fbb)
    DataLink_Abridged.add(canxOriginator: canxOriginator, &fbb)
    DataLink_Abridged.add(canxTs: canxTs, &fbb)
    DataLink_Abridged.add(canxSerialNum: canxSerialNum, &fbb)
    DataLink_Abridged.add(canxSpecialNotation: canxSpecialNotation, &fbb)
    DataLink_Abridged.addVectorOf(canxSics: canxSics, &fbb)
    DataLink_Abridged.add(pocName: pocName, &fbb)
    DataLink_Abridged.add(pocRank: pocRank, &fbb)
    DataLink_Abridged.add(pocCallSign: pocCallSign, &fbb)
    DataLink_Abridged.add(pocLocName: pocLocName, &fbb)
    DataLink_Abridged.add(pocLat: pocLat, &fbb)
    DataLink_Abridged.add(pocLon: pocLon, &fbb)
    DataLink_Abridged.addVectorOf(pocNums: pocNums, &fbb)
    DataLink_Abridged.add(geoDatum: geoDatum, &fbb)
    DataLink_Abridged.addVectorOf(refPoints: refPoints, &fbb)
    DataLink_Abridged.addVectorOf(voiceCoord: voiceCoord, &fbb)
    DataLink_Abridged.add(sysDefaultCode: sysDefaultCode, &fbb)
    DataLink_Abridged.add(winSizeMult: winSizeMult, &fbb)
    DataLink_Abridged.add(winSizeMin: winSizeMin, &fbb)
    DataLink_Abridged.add(minTrackQual: minTrackQual, &fbb)
    DataLink_Abridged.add(maxTrackQual: maxTrackQual, &fbb)
    DataLink_Abridged.add(resTrackQual: resTrackQual, &fbb)
    DataLink_Abridged.add(courseDiff: courseDiff, &fbb)
    DataLink_Abridged.add(speedDiff: speedDiff, &fbb)
    DataLink_Abridged.add(altDiff: altDiff, &fbb)
    DataLink_Abridged.add(minGeoPosQual: minGeoPosQual, &fbb)
    DataLink_Abridged.add(maxGeoPosQual: maxGeoPosQual, &fbb)
    DataLink_Abridged.add(decorrWinMult: decorrWinMult, &fbb)
    DataLink_Abridged.add(consecDecorr: consecDecorr, &fbb)
    DataLink_Abridged.addVectorOf(multiDuty: multiDuty, &fbb)
    DataLink_Abridged.addVectorOf(ops: ops, &fbb)
    DataLink_Abridged.add(jreUnitDes: jreUnitDes, &fbb)
    DataLink_Abridged.add(jreCallSign: jreCallSign, &fbb)
    DataLink_Abridged.add(jrePriAdd: jrePriAdd, &fbb)
    DataLink_Abridged.add(jreSecAdd: jreSecAdd, &fbb)
    DataLink_Abridged.add(jreDetails: jreDetails, &fbb)
    DataLink_Abridged.addVectorOf(specTracks: specTracks, &fbb)
    DataLink_Abridged.addVectorOf(nonLinkUnitDes: nonLinkUnitDes, &fbb)
    DataLink_Abridged.addVectorOf(trackNumBlockLls: trackNumBlockLls, &fbb)
    DataLink_Abridged.addVectorOf(trackNumBlocks: trackNumBlocks, &fbb)
    DataLink_Abridged.add(mgmtCode: mgmtCode, &fbb)
    DataLink_Abridged.add(mgmtCodeMeaning: mgmtCodeMeaning, &fbb)
    DataLink_Abridged.add(ackReq: ackReq, &fbb)
    DataLink_Abridged.addVectorOf(ackInstUnits: ackInstUnits, &fbb)
    DataLink_Abridged.add(classSource: classSource, &fbb)
    DataLink_Abridged.addVectorOf(classReasons: classReasons, &fbb)
    DataLink_Abridged.addVectorOf(decInstDates: decInstDates, &fbb)
    DataLink_Abridged.addVectorOf(decExemptCodes: decExemptCodes, &fbb)
    DataLink_Abridged.addVectorOf(remarks: remarks, &fbb)
    DataLink_Abridged.add(rawFileUri: rawFileUri, &fbb)
    DataLink_Abridged.add(createdAt: createdAt, &fbb)
    DataLink_Abridged.add(createdBy: createdBy, &fbb)
    DataLink_Abridged.add(updatedAt: updatedAt, &fbb)
    DataLink_Abridged.add(updatedBy: updatedBy, &fbb)
    DataLink_Abridged.add(sourceDl: sourceDl, &fbb)
    DataLink_Abridged.add(source: source, &fbb)
    DataLink_Abridged.add(origin: origin, &fbb)
    DataLink_Abridged.add(origNetwork: origNetwork, &fbb)
    DataLink_Abridged.add(dataMode: dataMode, &fbb)
    return DataLink_Abridged.endDataLink_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: DataLink_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
