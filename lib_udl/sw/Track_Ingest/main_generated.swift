...
public enum Track_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Track_Ingest_dataMode_Enum { return .exercise }
  public static var min: Track_Ingest_dataMode_Enum { return .real }
}
...
public struct Track_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Track_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: Track_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Track_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startTrack_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 68) }
  ...
  public static func add(dataMode: Track_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endTrack_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createTrack_Ingest(
    ...
    let __start = Track_Ingest.startTrack_Ingest(&fbb)
    Track_Ingest.add(id: id, &fbb)
    Track_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Track_Ingest.add(cntct: cntct, &fbb)
    Track_Ingest.add(createdAt: createdAt, &fbb)
    Track_Ingest.add(createdBy: createdBy, &fbb)
    Track_Ingest.add(msgTs: msgTs, &fbb)
    Track_Ingest.add(msnId: msnId, &fbb)
    Track_Ingest.add(assetNat: assetNat, &fbb)
    Track_Ingest.add(asset: asset, &fbb)
    Track_Ingest.add(sen: sen, &fbb)
    Track_Ingest.add(senQual: senQual, &fbb)
    Track_Ingest.add(trkId: trkId, &fbb)
    Track_Ingest.add(trkNum: trkNum, &fbb)
    Track_Ingest.add(trkStat: trkStat, &fbb)
    Track_Ingest.add(objNat: objNat, &fbb)
    Track_Ingest.add(objId: objId, &fbb)
    Track_Ingest.add(objType: objType, &fbb)
    Track_Ingest.add(objSpec: objSpec, &fbb)
    Track_Ingest.add(objPlat: objPlat, &fbb)
    Track_Ingest.add(objAct: objAct, &fbb)
    Track_Ingest.add(modType: modType, &fbb)
    Track_Ingest.add(trkItmId: trkItmId, &fbb)
    Track_Ingest.add(ts: ts, &fbb)
    Track_Ingest.add(trkQual: trkQual, &fbb)
    Track_Ingest.add(trkPtType: trkPtType, &fbb)
    Track_Ingest.add(objIdent: objIdent, &fbb)
    Track_Ingest.add(identCred: identCred, &fbb)
    Track_Ingest.add(identRel: identRel, &fbb)
    Track_Ingest.add(identAmp: identAmp, &fbb)
    Track_Ingest.add(env: env, &fbb)
    Track_Ingest.add(envConf: envConf, &fbb)
    Track_Ingest.add(trkConf: trkConf, &fbb)
    Track_Ingest.addVectorOf(ecefPos: ecefPos, &fbb)
    Track_Ingest.addVectorOf(ecefVel: ecefVel, &fbb)
    Track_Ingest.addVectorOf(ecefAcc: ecefAcc, &fbb)
    Track_Ingest.add(lat: lat, &fbb)
    Track_Ingest.add(lon: lon, &fbb)
    Track_Ingest.add(alt: alt, &fbb)
    Track_Ingest.add(spd: spd, &fbb)
    Track_Ingest.add(hdng: hdng, &fbb)
    Track_Ingest.add(course: course, &fbb)
    Track_Ingest.addVectorOf(lco: lco, &fbb)
    Track_Ingest.addVectorOf(lcs: lcs, &fbb)
    Track_Ingest.addVectorOf(lcPos: lcPos, &fbb)
    Track_Ingest.addVectorOf(lcVel: lcVel, &fbb)
    Track_Ingest.addVectorOf(lcAcc: lcAcc, &fbb)
    Track_Ingest.addVectorOf(eNuvel: eNuvel, &fbb)
    Track_Ingest.addVectorOf(eNupos: eNupos, &fbb)
    Track_Ingest.addVectorOf(cov: cov, &fbb)
    Track_Ingest.addVectorOf(errEllp: errEllp, &fbb)
    Track_Ingest.addVectorOf(srcTyps: srcTyps, &fbb)
    Track_Ingest.addVectorOf(srcIds: srcIds, &fbb)
    Track_Ingest.add(callSign: callSign, &fbb)
    Track_Ingest.add(multiSource: multiSource, &fbb)
    Track_Ingest.add(jSeries: jSeries, &fbb)
    Track_Ingest.add(strength: strength, &fbb)
    Track_Ingest.add(m1: m1, &fbb)
    Track_Ingest.add(m1v: m1v, &fbb)
    Track_Ingest.add(m2: m2, &fbb)
    Track_Ingest.add(m2v: m2v, &fbb)
    Track_Ingest.add(m3a: m3a, &fbb)
    Track_Ingest.add(m3av: m3av, &fbb)
    Track_Ingest.addVectorOf(tags: tags, &fbb)
    Track_Ingest.add(sourceDl: sourceDl, &fbb)
    Track_Ingest.add(source: source, &fbb)
    Track_Ingest.add(origin: origin, &fbb)
    Track_Ingest.add(dataMode: dataMode, &fbb)
    Track_Ingest.add(origNetwork: origNetwork, &fbb)
    return Track_Ingest.endTrack_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Track_Ingest_dataMode_Enum.self)
