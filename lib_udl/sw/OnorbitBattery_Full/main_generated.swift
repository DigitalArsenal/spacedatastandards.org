...
public enum OnorbitBattery_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OnorbitBattery_Full_dataMode_Enum { return .exercise }
  public static var min: OnorbitBattery_Full_dataMode_Enum { return .real }
}


///  /// Read-only collection of batteries on this on-orbit object.
public struct OnorbitBattery_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OnorbitBattery_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: OnorbitBattery_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OnorbitBattery_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOnorbitBattery_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 14) }
  ...
  public static func add(dataMode: OnorbitBattery_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endOnorbitBattery_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnorbitBattery_Full(
    ...
    let __start = OnorbitBattery_Full.startOnorbitBattery_Full(&fbb)
    OnorbitBattery_Full.add(id: id, &fbb)
    OnorbitBattery_Full.add(idOnOrbit: idOnOrbit, &fbb)
    OnorbitBattery_Full.add(idBattery: idBattery, &fbb)
    OnorbitBattery_Full.add(classificationMarking: classificationMarking, &fbb)
    OnorbitBattery_Full.add(quantity: quantity, &fbb)
    OnorbitBattery_Full.add(createdAt: createdAt, &fbb)
    OnorbitBattery_Full.add(createdBy: createdBy, &fbb)
    OnorbitBattery_Full.add(updatedAt: updatedAt, &fbb)
    OnorbitBattery_Full.add(updatedBy: updatedBy, &fbb)
    OnorbitBattery_Full.add(source: source, &fbb)
    OnorbitBattery_Full.add(origin: origin, &fbb)
    OnorbitBattery_Full.add(dataMode: dataMode, &fbb)
    OnorbitBattery_Full.add(origNetwork: origNetwork, &fbb)
    OnorbitBattery_Full.add(battery: battery, &fbb)
    return OnorbitBattery_Full.endOnorbitBattery_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OnorbitBattery_Full_dataMode_Enum.self)
