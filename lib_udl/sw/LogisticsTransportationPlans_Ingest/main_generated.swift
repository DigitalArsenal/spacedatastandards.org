...
public struct LogisticsTransportationPlans_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LogisticsTransportationPlans_Ingest.id, addPrefix: prefix) }
  ...
  public static func startLogisticsTransportationPlans_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 26) }
  ...
  public static func endLogisticsTransportationPlans_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLogisticsTransportationPlans_Ingest(
    ...
    let __start = LogisticsTransportationPlans_Ingest.startLogisticsTransportationPlans_Ingest(&fbb)
    LogisticsTransportationPlans_Ingest.add(plansNumber: plansNumber, &fbb)
    LogisticsTransportationPlans_Ingest.add(missionChange: missionChange, &fbb)
    LogisticsTransportationPlans_Ingest.add(planDefinition: planDefinition, &fbb)
    LogisticsTransportationPlans_Ingest.add(statusCode: statusCode, &fbb)
    LogisticsTransportationPlans_Ingest.add(coordinator: coordinator, &fbb)
    LogisticsTransportationPlans_Ingest.add(coordinatorUnit: coordinatorUnit, &fbb)
    LogisticsTransportationPlans_Ingest.add(originIcao: originIcao, &fbb)
    LogisticsTransportationPlans_Ingest.add(estDepTime: estDepTime, &fbb)
    LogisticsTransportationPlans_Ingest.add(estArrTime: estArrTime, &fbb)
    LogisticsTransportationPlans_Ingest.add(destinationIcao: destinationIcao, &fbb)
    LogisticsTransportationPlans_Ingest.add(logisticMasterRecordId: logisticMasterRecordId, &fbb)
    LogisticsTransportationPlans_Ingest.add(tpTailNumber: tpTailNumber, &fbb)
    LogisticsTransportationPlans_Ingest.add(tpAircraftMds: tpAircraftMds, &fbb)
    LogisticsTransportationPlans_Ingest.add(majcom: majcom, &fbb)
    LogisticsTransportationPlans_Ingest.add(approxArrTime: approxArrTime, &fbb)
    LogisticsTransportationPlans_Ingest.add(duration: duration, &fbb)
    LogisticsTransportationPlans_Ingest.add(actDepTime: actDepTime, &fbb)
    LogisticsTransportationPlans_Ingest.add(closedDate: closedDate, &fbb)
    LogisticsTransportationPlans_Ingest.add(cancelledDate: cancelledDate, &fbb)
    LogisticsTransportationPlans_Ingest.add(aircraftStatus: aircraftStatus, &fbb)
    LogisticsTransportationPlans_Ingest.add(numEnrouteStops: numEnrouteStops, &fbb)
    LogisticsTransportationPlans_Ingest.add(serialNumber: serialNumber, &fbb)
    LogisticsTransportationPlans_Ingest.add(numTransLoads: numTransLoads, &fbb)
    LogisticsTransportationPlans_Ingest.add(lastChangedDate: lastChangedDate, &fbb)
    LogisticsTransportationPlans_Ingest.addVectorOf(logisticsSegments: logisticsSegments, &fbb)
    LogisticsTransportationPlans_Ingest.addVectorOf(logisticsTransportationPlansRemarks: logisticsTransportationPlansRemarks, &fbb)
    return LogisticsTransportationPlans_Ingest.endLogisticsTransportationPlans_Ingest(&fbb, start: __start)
  }
