...
public struct EffectResponseActionsList_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EffectResponseActionsList_Full.id, addPrefix: prefix) }
  ...
  public static func startEffectResponseActionsList_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 18) }
  ...
  public static func endEffectResponseActionsList_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEffectResponseActionsList_Full(
    ...
    let __start = EffectResponseActionsList_Full.startEffectResponseActionsList_Full(&fbb)
    EffectResponseActionsList_Full.add(summary: summary, &fbb)
    EffectResponseActionsList_Full.add(actionId: actionId, &fbb)
    EffectResponseActionsList_Full.add(actionStartTime: actionStartTime, &fbb)
    EffectResponseActionsList_Full.add(actionEndTime: actionEndTime, &fbb)
    EffectResponseActionsList_Full.add(totStartTime: totStartTime, &fbb)
    EffectResponseActionsList_Full.add(totEndTime: totEndTime, &fbb)
    EffectResponseActionsList_Full.add(actionActorSrcType: actionActorSrcType, &fbb)
    EffectResponseActionsList_Full.add(actionActorSrcId: actionActorSrcId, &fbb)
    EffectResponseActionsList_Full.add(effector: effector, &fbb)
    EffectResponseActionsList_Full.add(targetSrcType: targetSrcType, &fbb)
    EffectResponseActionsList_Full.add(targetSrcId: targetSrcId, &fbb)
    EffectResponseActionsList_Full.add(actorInterceptLat: actorInterceptLat, &fbb)
    EffectResponseActionsList_Full.add(actorInterceptLon: actorInterceptLon, &fbb)
    EffectResponseActionsList_Full.add(actorInterceptAlt: actorInterceptAlt, &fbb)
    EffectResponseActionsList_Full.add(weaponInterceptLat: weaponInterceptLat, &fbb)
    EffectResponseActionsList_Full.add(weaponInterceptLon: weaponInterceptLon, &fbb)
    EffectResponseActionsList_Full.add(weaponInterceptAlt: weaponInterceptAlt, &fbb)
    EffectResponseActionsList_Full.addVectorOf(actionMetrics: actionMetrics, &fbb)
    return EffectResponseActionsList_Full.endEffectResponseActionsList_Full(&fbb, start: __start)
  }
