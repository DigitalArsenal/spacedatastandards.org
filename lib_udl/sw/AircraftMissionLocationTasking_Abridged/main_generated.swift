...
public struct AircraftMissionLocationTasking_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AircraftMissionLocationTasking_Abridged.id, addPrefix: prefix) }
  ...
  public static func startAircraftMissionLocationTasking_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 10) }
  ...
  public static func endAircraftMissionLocationTasking_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAircraftMissionLocationTasking_Abridged(
    ...
    let __start = AircraftMissionLocationTasking_Abridged.startAircraftMissionLocationTasking_Abridged(&fbb)
    AircraftMissionLocationTasking_Abridged.add(startTime: startTime, &fbb)
    AircraftMissionLocationTasking_Abridged.add(endTime: endTime, &fbb)
    AircraftMissionLocationTasking_Abridged.add(msnLocName: msnLocName, &fbb)
    AircraftMissionLocationTasking_Abridged.add(alt: alt, &fbb)
    AircraftMissionLocationTasking_Abridged.add(airMsnPri: airMsnPri, &fbb)
    AircraftMissionLocationTasking_Abridged.add(areaGeoRad: areaGeoRad, &fbb)
    AircraftMissionLocationTasking_Abridged.add(msnLocPtName: msnLocPtName, &fbb)
    AircraftMissionLocationTasking_Abridged.add(msnLocPtLat: msnLocPtLat, &fbb)
    AircraftMissionLocationTasking_Abridged.add(msnLocPtLon: msnLocPtLon, &fbb)
    AircraftMissionLocationTasking_Abridged.add(msnLocPtBarT: msnLocPtBarT, &fbb)
    return AircraftMissionLocationTasking_Abridged.endAircraftMissionLocationTasking_Abridged(&fbb, start: __start)
  }
