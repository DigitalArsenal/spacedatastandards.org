...
public struct IonoObservationDensityProfileQuasiParabolic_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDensityProfileQuasiParabolic_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDensityProfileQuasiParabolic_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endIonoObservationDensityProfileQuasiParabolic_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDensityProfileQuasiParabolic_Full(
    _ fbb: inout FlatBufferBuilder,
    descriptionOffset description: Offset = Offset(),
    earthRadius: Double = 0.0,
    quasiParabolicSegmentsVectorOffset quasiParabolicSegments: Offset = Offset()
  ) -> Offset {
    let __start = IonoObservationDensityProfileQuasiParabolic_Full.startIonoObservationDensityProfileQuasiParabolic_Full(&fbb)
    IonoObservationDensityProfileQuasiParabolic_Full.add(description: description, &fbb)
    IonoObservationDensityProfileQuasiParabolic_Full.add(earthRadius: earthRadius, &fbb)
    IonoObservationDensityProfileQuasiParabolic_Full.addVectorOf(quasiParabolicSegments: quasiParabolicSegments, &fbb)
    return IonoObservationDensityProfileQuasiParabolic_Full.endIonoObservationDensityProfileQuasiParabolic_Full(&fbb, start: __start)
  }
