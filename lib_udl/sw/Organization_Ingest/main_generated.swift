...
public enum Organization_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Organization_Ingest_dataMode_Enum { return .exercise }
  public static var min: Organization_Ingest_dataMode_Enum { return .real }
}
...
public struct Organization_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Organization_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: Organization_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Organization_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOrganization_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 16) }
  ...
  public static func add(dataMode: Organization_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endOrganization_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOrganization_Ingest(
    ...
    let __start = Organization_Ingest.startOrganization_Ingest(&fbb)
    Organization_Ingest.add(id: id, &fbb)
    Organization_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Organization_Ingest.add(name: name, &fbb)
    Organization_Ingest.add(type: type, &fbb)
    Organization_Ingest.add(category: category, &fbb)
    Organization_Ingest.add(externalId: externalId, &fbb)
    Organization_Ingest.add(description: description, &fbb)
    Organization_Ingest.add(countryCode: countryCode, &fbb)
    Organization_Ingest.add(nationality: nationality, &fbb)
    Organization_Ingest.add(active: active, &fbb)
    Organization_Ingest.add(source: source, &fbb)
    Organization_Ingest.add(origin: origin, &fbb)
    Organization_Ingest.add(dataMode: dataMode, &fbb)
    Organization_Ingest.add(createdAt: createdAt, &fbb)
    Organization_Ingest.add(createdBy: createdBy, &fbb)
    Organization_Ingest.add(origNetwork: origNetwork, &fbb)
    return Organization_Ingest.endOrganization_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Organization_Ingest_dataMode_Enum.self)
