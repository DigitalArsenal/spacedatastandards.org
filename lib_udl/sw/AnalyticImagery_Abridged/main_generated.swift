...
public enum AnalyticImagery_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AnalyticImagery_Abridged_dataMode_Enum { return .exercise }
  public static var min: AnalyticImagery_Abridged_dataMode_Enum { return .real }
}
...
public struct AnalyticImagery_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AnalyticImagery_Abridged.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case srcIds = 62
    case tags = 64
    case checksumValue = 66
    case transactionId = 68
    case createdAt = 70
    case createdBy = 72
    case source = 74
    case origin = 76
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: AnalyticImagery_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AnalyticImagery_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startAnalyticImagery_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 40) }
  ...
  public static func add(dataMode: AnalyticImagery_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endAnalyticImagery_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAnalyticImagery_Abridged(
    ...
    let __start = AnalyticImagery_Abridged.startAnalyticImagery_Abridged(&fbb)
    AnalyticImagery_Abridged.add(id: id, &fbb)
    AnalyticImagery_Abridged.add(classificationMarking: classificationMarking, &fbb)
    AnalyticImagery_Abridged.add(content: content, &fbb)
    AnalyticImagery_Abridged.add(msgTime: msgTime, &fbb)
    AnalyticImagery_Abridged.add(imageType: imageType, &fbb)
    AnalyticImagery_Abridged.add(filename: filename, &fbb)
    AnalyticImagery_Abridged.add(filesize: filesize, &fbb)
    AnalyticImagery_Abridged.add(imgWidth: imgWidth, &fbb)
    AnalyticImagery_Abridged.add(imgHeight: imgHeight, &fbb)
    AnalyticImagery_Abridged.add(xUnits: xUnits, &fbb)
    AnalyticImagery_Abridged.add(yUnits: yUnits, &fbb)
    AnalyticImagery_Abridged.add(zUnits: zUnits, &fbb)
    AnalyticImagery_Abridged.add(imageSetId: imageSetId, &fbb)
    AnalyticImagery_Abridged.add(imageSetLength: imageSetLength, &fbb)
    AnalyticImagery_Abridged.add(sequenceId: sequenceId, &fbb)
    AnalyticImagery_Abridged.add(description: description, &fbb)
    AnalyticImagery_Abridged.add(dataStart: dataStart, &fbb)
    AnalyticImagery_Abridged.add(dataStop: dataStop, &fbb)
    AnalyticImagery_Abridged.addVectorOf(annLims: annLims, &fbb)
    AnalyticImagery_Abridged.addVectorOf(annText: annText, &fbb)
    AnalyticImagery_Abridged.addVectorOf(keywords: keywords, &fbb)
    AnalyticImagery_Abridged.add(atext: atext, &fbb)
    AnalyticImagery_Abridged.add(agjson: agjson, &fbb)
    AnalyticImagery_Abridged.add(atype: atype, &fbb)
    AnalyticImagery_Abridged.add(andims: andims, &fbb)
    AnalyticImagery_Abridged.add(asrid: asrid, &fbb)
    AnalyticImagery_Abridged.addVectorOf(satId: satId, &fbb)
    AnalyticImagery_Abridged.addVectorOf(satIdConf: satIdConf, &fbb)
    AnalyticImagery_Abridged.addVectorOf(srcTyps: srcTyps, &fbb)
    AnalyticImagery_Abridged.addVectorOf(srcIds: srcIds, &fbb)
    AnalyticImagery_Abridged.addVectorOf(tags: tags, &fbb)
    AnalyticImagery_Abridged.add(checksumValue: checksumValue, &fbb)
    AnalyticImagery_Abridged.add(transactionId: transactionId, &fbb)
    AnalyticImagery_Abridged.add(createdAt: createdAt, &fbb)
    AnalyticImagery_Abridged.add(createdBy: createdBy, &fbb)
    AnalyticImagery_Abridged.add(source: source, &fbb)
    AnalyticImagery_Abridged.add(origin: origin, &fbb)
    AnalyticImagery_Abridged.add(origNetwork: origNetwork, &fbb)
    AnalyticImagery_Abridged.add(sourceDl: sourceDl, &fbb)
    AnalyticImagery_Abridged.add(dataMode: dataMode, &fbb)
    return AnalyticImagery_Abridged.endAnalyticImagery_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AnalyticImagery_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
