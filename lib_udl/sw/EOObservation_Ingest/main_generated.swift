...
public enum EOObservation_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: EOObservation_Ingest_dataMode_Enum { return .exercise }
  public static var min: EOObservation_Ingest_dataMode_Enum { return .real }
}


public enum EOObservation_Ingest_referenceFrame_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: EOObservation_Ingest_referenceFrame_Enum { return .teme }
  public static var min: EOObservation_Ingest_referenceFrame_Enum { return .j2000 }
}


public enum EOObservation_Ingest_senReferenceFrame_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ///  No description available.
  ...
  public static var max: EOObservation_Ingest_senReferenceFrame_Enum { return .gcrf }
  public static var min: EOObservation_Ingest_senReferenceFrame_Enum { return .j2000 }
}
...
public struct EOObservation_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EOObservation_Ingest.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case createdBy = 170
    case zeroPtdUnc = 172
    case eoobservationDetails = 174
    case referenceFrame = 176
    case senReferenceFrame = 178
    case umbra = 180
    case penumbra = 182
  ...
  public var dataMode: EOObservation_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : EOObservation_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Example: /// Example: 1.1
  ///  Constraints: No constraints specified.
  public var zeroPtdUnc: Double { let o = _accessor.offset(VTOFFSET.zeroPtdUnc.v); return o == 0 ? 0.0 : _accessor.readBuffer(of: Double.self, at: o) }
  ///  No description provided.
  ///  Example: /// Example: No example provided.
  ///  Constraints: No constraints specified.
  public var eoobservationDetails: String? { let o = _accessor.offset(VTOFFSET.eoobservationDetails.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var eoobservationDetailsSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.eoobservationDetails.v) }
  ///  The reference frame of the EOObservation measurements. If the referenceFrame is null it is assumed to be J2000.
  ///  Example: /// Example: J2000
  ///  Constraints: Minimum length = 0, Maximum length = 24
  public var referenceFrame: EOObservation_Ingest_referenceFrame_Enum { let o = _accessor.offset(VTOFFSET.referenceFrame.v); return o == 0 ? .j2000 : EOObservation_Ingest_referenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ///  The reference frame of the observing sensor state. If the senReferenceFrame is null it is assumed to be J2000.
  ///  Example: /// Example: J2000
  ///  Constraints: Minimum length = 0, Maximum length = 24
  public var senReferenceFrame: EOObservation_Ingest_senReferenceFrame_Enum { let o = _accessor.offset(VTOFFSET.senReferenceFrame.v); return o == 0 ? .j2000 : EOObservation_Ingest_senReferenceFrame_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .j2000 }
  ...
  public static func startEOObservation_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 93) }
  ...
  public static func add(dataMode: EOObservation_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func add(zeroPtdUnc: Double, _ fbb: inout FlatBufferBuilder) { fbb.add(element: zeroPtdUnc, def: 0.0, at: VTOFFSET.zeroPtdUnc.p) }
  public static func add(eoobservationDetails: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: eoobservationDetails, at: VTOFFSET.eoobservationDetails.p) }
  public static func add(referenceFrame: EOObservation_Ingest_referenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: referenceFrame.rawValue, def: 0, at: VTOFFSET.referenceFrame.p) }
  public static func add(senReferenceFrame: EOObservation_Ingest_senReferenceFrame_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: senReferenceFrame.rawValue, def: 0, at: VTOFFSET.senReferenceFrame.p) }
  ...
  public static func endEOObservation_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEOObservation_Ingest(
    ...
    zeroPtdUnc: Double = 0.0,
    eoobservationDetailsOffset eoobservationDetails: Offset = Offset(),
    ...
    let __start = EOObservation_Ingest.startEOObservation_Ingest(&fbb)
    EOObservation_Ingest.add(id: id, &fbb)
    EOObservation_Ingest.add(classificationMarking: classificationMarking, &fbb)
    EOObservation_Ingest.add(obTime: obTime, &fbb)
    EOObservation_Ingest.add(corrQuality: corrQuality, &fbb)
    EOObservation_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    EOObservation_Ingest.add(idSensor: idSensor, &fbb)
    EOObservation_Ingest.add(idSkyImagery: idSkyImagery, &fbb)
    EOObservation_Ingest.add(collectMethod: collectMethod, &fbb)
    EOObservation_Ingest.add(satNo: satNo, &fbb)
    EOObservation_Ingest.add(taskId: taskId, &fbb)
    EOObservation_Ingest.add(transactionId: transactionId, &fbb)
    EOObservation_Ingest.add(trackId: trackId, &fbb)
    EOObservation_Ingest.add(obPosition: obPosition, &fbb)
    EOObservation_Ingest.add(origObjectId: origObjectId, &fbb)
    EOObservation_Ingest.add(origSensorId: origSensorId, &fbb)
    EOObservation_Ingest.add(uct: uct, &fbb)
    EOObservation_Ingest.add(azimuth: azimuth, &fbb)
    EOObservation_Ingest.add(azimuthUnc: azimuthUnc, &fbb)
    EOObservation_Ingest.add(azimuthBias: azimuthBias, &fbb)
    EOObservation_Ingest.add(azimuthRate: azimuthRate, &fbb)
    EOObservation_Ingest.add(elevation: elevation, &fbb)
    EOObservation_Ingest.add(elevationUnc: elevationUnc, &fbb)
    EOObservation_Ingest.add(elevationBias: elevationBias, &fbb)
    EOObservation_Ingest.add(elevationRate: elevationRate, &fbb)
    EOObservation_Ingest.add(range: range, &fbb)
    EOObservation_Ingest.add(rangeUnc: rangeUnc, &fbb)
    EOObservation_Ingest.add(rangeBias: rangeBias, &fbb)
    EOObservation_Ingest.add(rangeRate: rangeRate, &fbb)
    EOObservation_Ingest.add(rangeRateUnc: rangeRateUnc, &fbb)
    EOObservation_Ingest.add(ra: ra, &fbb)
    EOObservation_Ingest.add(raRate: raRate, &fbb)
    EOObservation_Ingest.add(raUnc: raUnc, &fbb)
    EOObservation_Ingest.add(raBias: raBias, &fbb)
    EOObservation_Ingest.add(declination: declination, &fbb)
    EOObservation_Ingest.add(declinationRate: declinationRate, &fbb)
    EOObservation_Ingest.add(declinationUnc: declinationUnc, &fbb)
    EOObservation_Ingest.add(declinationBias: declinationBias, &fbb)
    EOObservation_Ingest.add(losx: losx, &fbb)
    EOObservation_Ingest.add(losy: losy, &fbb)
    EOObservation_Ingest.add(losz: losz, &fbb)
    EOObservation_Ingest.add(losUnc: losUnc, &fbb)
    EOObservation_Ingest.add(losxvel: losxvel, &fbb)
    EOObservation_Ingest.add(losyvel: losyvel, &fbb)
    EOObservation_Ingest.add(loszvel: loszvel, &fbb)
    EOObservation_Ingest.add(senlat: senlat, &fbb)
    EOObservation_Ingest.add(senlon: senlon, &fbb)
    EOObservation_Ingest.add(senalt: senalt, &fbb)
    EOObservation_Ingest.add(senx: senx, &fbb)
    EOObservation_Ingest.add(seny: seny, &fbb)
    EOObservation_Ingest.add(senz: senz, &fbb)
    EOObservation_Ingest.add(senvelx: senvelx, &fbb)
    EOObservation_Ingest.add(senvely: senvely, &fbb)
    EOObservation_Ingest.add(senvelz: senvelz, &fbb)
    EOObservation_Ingest.addVectorOf(senQuat: senQuat, &fbb)
    EOObservation_Ingest.add(fovCount: fovCount, &fbb)
    EOObservation_Ingest.add(expDuration: expDuration, &fbb)
    EOObservation_Ingest.add(zeroptd: zeroptd, &fbb)
    EOObservation_Ingest.add(netObjSig: netObjSig, &fbb)
    EOObservation_Ingest.add(netObjSigUnc: netObjSigUnc, &fbb)
    EOObservation_Ingest.add(mag: mag, &fbb)
    EOObservation_Ingest.add(magUnc: magUnc, &fbb)
    EOObservation_Ingest.add(magNormRange: magNormRange, &fbb)
    EOObservation_Ingest.add(geolat: geolat, &fbb)
    EOObservation_Ingest.add(geolon: geolon, &fbb)
    EOObservation_Ingest.add(geoalt: geoalt, &fbb)
    EOObservation_Ingest.add(georange: georange, &fbb)
    EOObservation_Ingest.add(skyBkgrnd: skyBkgrnd, &fbb)
    EOObservation_Ingest.add(primaryExtinction: primaryExtinction, &fbb)
    EOObservation_Ingest.add(primaryExtinctionUnc: primaryExtinctionUnc, &fbb)
    EOObservation_Ingest.add(solarPhaseAngle: solarPhaseAngle, &fbb)
    EOObservation_Ingest.add(solarEqPhaseAngle: solarEqPhaseAngle, &fbb)
    EOObservation_Ingest.add(solarDecAngle: solarDecAngle, &fbb)
    EOObservation_Ingest.add(shutterDelay: shutterDelay, &fbb)
    EOObservation_Ingest.add(timingBias: timingBias, &fbb)
    EOObservation_Ingest.add(rawFileUri: rawFileUri, &fbb)
    EOObservation_Ingest.add(intensity: intensity, &fbb)
    EOObservation_Ingest.add(bgIntensity: bgIntensity, &fbb)
    EOObservation_Ingest.add(descriptor: descriptor, &fbb)
    EOObservation_Ingest.add(source: source, &fbb)
    EOObservation_Ingest.add(origin: origin, &fbb)
    EOObservation_Ingest.add(dataMode: dataMode, &fbb)
    EOObservation_Ingest.addVectorOf(tags: tags, &fbb)
    EOObservation_Ingest.add(createdAt: createdAt, &fbb)
    EOObservation_Ingest.add(createdBy: createdBy, &fbb)
    EOObservation_Ingest.add(zeroPtdUnc: zeroPtdUnc, &fbb)
    EOObservation_Ingest.add(eoobservationDetails: eoobservationDetails, &fbb)
    EOObservation_Ingest.add(referenceFrame: referenceFrame, &fbb)
    EOObservation_Ingest.add(senReferenceFrame: senReferenceFrame, &fbb)
    EOObservation_Ingest.add(umbra: umbra, &fbb)
    EOObservation_Ingest.add(penumbra: penumbra, &fbb)
    EOObservation_Ingest.add(origNetwork: origNetwork, &fbb)
    EOObservation_Ingest.add(sourceDl: sourceDl, &fbb)
    EOObservation_Ingest.add(type: type, &fbb)
    return EOObservation_Ingest.endEOObservation_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: EOObservation_Ingest_dataMode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.zeroPtdUnc.p, fieldName: "zeroPtdUnc", required: false, type: Double.self)
    try _v.visit(field: VTOFFSET.eoobservationDetails.p, fieldName: "eoobservationDetails", required: false, type: ForwardOffset<String>.self)
    try _v.visit(field: VTOFFSET.referenceFrame.p, fieldName: "referenceFrame", required: false, type: EOObservation_Ingest_referenceFrame_Enum.self)
    try _v.visit(field: VTOFFSET.senReferenceFrame.p, fieldName: "senReferenceFrame", required: false, type: EOObservation_Ingest_senReferenceFrame_Enum.self)
