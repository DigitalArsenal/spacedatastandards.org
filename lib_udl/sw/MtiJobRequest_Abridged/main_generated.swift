...
public struct MtiJobRequest_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiJobRequest_Abridged.id, addPrefix: prefix) }
  ...
  public static func startMtiJobRequest_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 21) }
  ...
  public static func add(r26: Bool, _ fbb: inout FlatBufferBuilder) { fbb.add(element: r26, def: false,
   at: VTOFFSET.r26.p) }
  public static func endMtiJobRequest_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiJobRequest_Abridged(
    ...
    let __start = MtiJobRequest_Abridged.startMtiJobRequest_Abridged(&fbb)
    MtiJobRequest_Abridged.add(r1: r1, &fbb)
    MtiJobRequest_Abridged.add(r2: r2, &fbb)
    MtiJobRequest_Abridged.add(r3: r3, &fbb)
    MtiJobRequest_Abridged.add(r4: r4, &fbb)
    MtiJobRequest_Abridged.add(r5: r5, &fbb)
    MtiJobRequest_Abridged.add(r6: r6, &fbb)
    MtiJobRequest_Abridged.add(r7: r7, &fbb)
    MtiJobRequest_Abridged.add(r8: r8, &fbb)
    MtiJobRequest_Abridged.add(r9: r9, &fbb)
    MtiJobRequest_Abridged.add(r10: r10, &fbb)
    MtiJobRequest_Abridged.add(r11: r11, &fbb)
    MtiJobRequest_Abridged.add(r12: r12, &fbb)
    MtiJobRequest_Abridged.add(r13: r13, &fbb)
    MtiJobRequest_Abridged.add(r14: r14, &fbb)
    MtiJobRequest_Abridged.add(jobReqEst: jobReqEst, &fbb)
    MtiJobRequest_Abridged.add(r21: r21, &fbb)
    MtiJobRequest_Abridged.add(r22: r22, &fbb)
    MtiJobRequest_Abridged.add(r23: r23, &fbb)
    MtiJobRequest_Abridged.add(r24: r24, &fbb)
    MtiJobRequest_Abridged.add(r25: r25, &fbb)
    MtiJobRequest_Abridged.add(r26: r26, &fbb)
    return MtiJobRequest_Abridged.endMtiJobRequest_Abridged(&fbb, start: __start)
  }
