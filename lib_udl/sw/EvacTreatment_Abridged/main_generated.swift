...
public struct EvacTreatment_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacTreatment_Abridged.id, addPrefix: prefix) }
  ...
  public static func startEvacTreatment_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endEvacTreatment_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacTreatment_Abridged(
    ...
    let __start = EvacTreatment_Abridged.startEvacTreatment_Abridged(&fbb)
    EvacTreatment_Abridged.add(type: type, &fbb)
    EvacTreatment_Abridged.add(bodyPart: bodyPart, &fbb)
    EvacTreatment_Abridged.add(time: time, &fbb)
    EvacTreatment_Abridged.add(comments: comments, &fbb)
    return EvacTreatment_Abridged.endEvacTreatment_Abridged(&fbb, start: __start)
  }
