...
public enum SensorPlan_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SensorPlan_Ingest_dataMode_Enum { return .exercise }
  public static var min: SensorPlan_Ingest_dataMode_Enum { return .real }
}
...
public struct SensorPlan_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SensorPlan_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: SensorPlan_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SensorPlan_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startSensorPlan_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 22) }
  ...
  public static func add(dataMode: SensorPlan_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endSensorPlan_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSensorPlan_Ingest(
    ...
    let __start = SensorPlan_Ingest.startSensorPlan_Ingest(&fbb)
    SensorPlan_Ingest.add(id: id, &fbb)
    SensorPlan_Ingest.add(classificationMarking: classificationMarking, &fbb)
    SensorPlan_Ingest.add(type: type, &fbb)
    SensorPlan_Ingest.add(recType: recType, &fbb)
    SensorPlan_Ingest.add(startTime: startTime, &fbb)
    SensorPlan_Ingest.add(endTime: endTime, &fbb)
    SensorPlan_Ingest.add(name: name, &fbb)
    SensorPlan_Ingest.add(idSensor: idSensor, &fbb)
    SensorPlan_Ingest.add(origSensorId: origSensorId, &fbb)
    SensorPlan_Ingest.add(purpose: purpose, &fbb)
    SensorPlan_Ingest.add(senNetwork: senNetwork, &fbb)
    SensorPlan_Ingest.add(reqTotal: reqTotal, &fbb)
    SensorPlan_Ingest.add(customer: customer, &fbb)
    SensorPlan_Ingest.add(status: status, &fbb)
    SensorPlan_Ingest.add(createdAt: createdAt, &fbb)
    SensorPlan_Ingest.add(createdBy: createdBy, &fbb)
    SensorPlan_Ingest.add(source: source, &fbb)
    SensorPlan_Ingest.add(origin: origin, &fbb)
    SensorPlan_Ingest.add(dataMode: dataMode, &fbb)
    SensorPlan_Ingest.add(origNetwork: origNetwork, &fbb)
    SensorPlan_Ingest.addVectorOf(collectRequests: collectRequests, &fbb)
    SensorPlan_Ingest.addVectorOf(tags: tags, &fbb)
    return SensorPlan_Ingest.endSensorPlan_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SensorPlan_Ingest_dataMode_Enum.self)
