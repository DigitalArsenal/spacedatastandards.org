...
public enum OrbitTrack_Full_objIdent_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OrbitTrack_Full_objIdent_Enum { return .unknown }
  public static var min: OrbitTrack_Full_objIdent_Enum { return .assumedFriend }
}


public enum OrbitTrack_Full_objectType_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: OrbitTrack_Full_objectType_Enum { return .unknown }
  public static var min: OrbitTrack_Full_objectType_Enum { return .debris }
}


public enum OrbitTrack_Full_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: OrbitTrack_Full_dataMode_Enum { return .exercise }
  public static var min: OrbitTrack_Full_dataMode_Enum { return .real }
}
...
public struct OrbitTrack_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OrbitTrack_Full.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case taskForce = 72
    case feint = 74
    case installation = 76
    case vehType = 78
    case trkId = 80
    case trackSensors = 82
    case createdAt = 84
    case createdBy = 86
    case source = 88
    case origin = 90
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 32
  public var objIdent: OrbitTrack_Full_objIdent_Enum { let o = _accessor.offset(VTOFFSET.objIdent.v); return o == 0 ? .assumedFriend : OrbitTrack_Full_objIdent_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .assumedFriend }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 32
  public var objectType: OrbitTrack_Full_objectType_Enum { let o = _accessor.offset(VTOFFSET.objectType.v); return o == 0 ? .debris : OrbitTrack_Full_objectType_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .debris }
  ...
  public var dataMode: OrbitTrack_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OrbitTrack_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startOrbitTrack_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 46) }
  ...
  public static func add(objIdent: OrbitTrack_Full_objIdent_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: objIdent.rawValue, def: 0, at: VTOFFSET.objIdent.p) }
  ...
  public static func add(objectType: OrbitTrack_Full_objectType_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: objectType.rawValue, def: 0, at: VTOFFSET.objectType.p) }
  ...
  public static func add(dataMode: OrbitTrack_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endOrbitTrack_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOrbitTrack_Full(
    ...
    objIdent: OrbitTrack_Full_objIdent_Enum = .assumedFriend,
    ...
    let __start = OrbitTrack_Full.startOrbitTrack_Full(&fbb)
    OrbitTrack_Full.add(id: id, &fbb)
    OrbitTrack_Full.add(classificationMarking: classificationMarking, &fbb)
    OrbitTrack_Full.add(idOnOrbit: idOnOrbit, &fbb)
    OrbitTrack_Full.add(satNo: satNo, &fbb)
    OrbitTrack_Full.add(onOrbit: onOrbit, &fbb)
    OrbitTrack_Full.add(origObjectId: origObjectId, &fbb)
    OrbitTrack_Full.add(idElset: idElset, &fbb)
    OrbitTrack_Full.add(ts: ts, &fbb)
    OrbitTrack_Full.add(lat: lat, &fbb)
    OrbitTrack_Full.add(lon: lon, &fbb)
    OrbitTrack_Full.add(alt: alt, &fbb)
    OrbitTrack_Full.add(rdfRf: rdfRf, &fbb)
    OrbitTrack_Full.add(callSign: callSign, &fbb)
    OrbitTrack_Full.add(rptNum: rptNum, &fbb)
    OrbitTrack_Full.add(objIdent: objIdent, &fbb)
    OrbitTrack_Full.add(identAmp: identAmp, &fbb)
    OrbitTrack_Full.add(satStatus: satStatus, &fbb)
    OrbitTrack_Full.add(objectType: objectType, &fbb)
    OrbitTrack_Full.add(countryCode: countryCode, &fbb)
    OrbitTrack_Full.add(decay: decay, &fbb)
    OrbitTrack_Full.add(charlieLine: charlieLine, &fbb)
    OrbitTrack_Full.add(aouType: aouType, &fbb)
    OrbitTrack_Full.addVectorOf(aouData: aouData, &fbb)
    OrbitTrack_Full.add(spd: spd, &fbb)
    OrbitTrack_Full.add(angElev: angElev, &fbb)
    OrbitTrack_Full.add(cntnmnt: cntnmnt, &fbb)
    OrbitTrack_Full.add(xref: xref, &fbb)
    OrbitTrack_Full.add(chXref: chXref, &fbb)
    OrbitTrack_Full.add(amplification: amplification, &fbb)
    OrbitTrack_Full.add(iff: iff, &fbb)
    OrbitTrack_Full.add(reinforced: reinforced, &fbb)
    OrbitTrack_Full.add(reduced: reduced, &fbb)
    OrbitTrack_Full.add(hq: hq, &fbb)
    OrbitTrack_Full.add(dummy: dummy, &fbb)
    OrbitTrack_Full.add(taskForce: taskForce, &fbb)
    OrbitTrack_Full.add(feint: feint, &fbb)
    OrbitTrack_Full.add(installation: installation, &fbb)
    OrbitTrack_Full.add(vehType: vehType, &fbb)
    OrbitTrack_Full.add(trkId: trkId, &fbb)
    OrbitTrack_Full.addVectorOf(trackSensors: trackSensors, &fbb)
    OrbitTrack_Full.add(createdAt: createdAt, &fbb)
    OrbitTrack_Full.add(createdBy: createdBy, &fbb)
    OrbitTrack_Full.add(source: source, &fbb)
    OrbitTrack_Full.add(origin: origin, &fbb)
    OrbitTrack_Full.add(dataMode: dataMode, &fbb)
    OrbitTrack_Full.add(origNetwork: origNetwork, &fbb)
    return OrbitTrack_Full.endOrbitTrack_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.objIdent.p, fieldName: "objIdent", required: false, type: OrbitTrack_Full_objIdent_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.objectType.p, fieldName: "objectType", required: false, type: OrbitTrack_Full_objectType_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OrbitTrack_Full_dataMode_Enum.self)
