...
public struct AircraftMissionRequirements_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AircraftMissionRequirements_Full.id, addPrefix: prefix) }
  ...
  public static func startAircraftMissionRequirements_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 18) }
  ...
  public static func endAircraftMissionRequirements_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAircraftMissionRequirements_Full(
    ...
    let __start = AircraftMissionRequirements_Full.startAircraftMissionRequirements_Full(&fbb)
    AircraftMissionRequirements_Full.add(gdssReqId: gdssReqId, &fbb)
    AircraftMissionRequirements_Full.add(onloadId: onloadId, &fbb)
    AircraftMissionRequirements_Full.add(onloadLocode: onloadLocode, &fbb)
    AircraftMissionRequirements_Full.add(offloadId: offloadId, &fbb)
    AircraftMissionRequirements_Full.add(offloadLocode: offloadLocode, &fbb)
    AircraftMissionRequirements_Full.add(uln: uln, &fbb)
    AircraftMissionRequirements_Full.add(transReqNum: transReqNum, &fbb)
    AircraftMissionRequirements_Full.add(projName: projName, &fbb)
    AircraftMissionRequirements_Full.add(oplan: oplan, &fbb)
    AircraftMissionRequirements_Full.add(numPax: numPax, &fbb)
    AircraftMissionRequirements_Full.add(numLitter: numLitter, &fbb)
    AircraftMissionRequirements_Full.add(numAmbulatory: numAmbulatory, &fbb)
    AircraftMissionRequirements_Full.add(numAttendant: numAttendant, &fbb)
    AircraftMissionRequirements_Full.add(bulkWeight: bulkWeight, &fbb)
    AircraftMissionRequirements_Full.add(oversizeWeight: oversizeWeight, &fbb)
    AircraftMissionRequirements_Full.add(outsizeWeight: outsizeWeight, &fbb)
    AircraftMissionRequirements_Full.add(ead: ead, &fbb)
    AircraftMissionRequirements_Full.add(lad: lad, &fbb)
    return AircraftMissionRequirements_Full.endAircraftMissionRequirements_Full(&fbb, start: __start)
  }
