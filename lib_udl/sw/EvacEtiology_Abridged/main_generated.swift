...
public struct EvacEtiology_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: EvacEtiology_Abridged.id, addPrefix: prefix) }
  ...
  public static func startEvacEtiology_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endEvacEtiology_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEvacEtiology_Abridged(
    ...
    let __start = EvacEtiology_Abridged.startEvacEtiology_Abridged(&fbb)
    EvacEtiology_Abridged.add(type: type, &fbb)
    EvacEtiology_Abridged.add(bodyPart: bodyPart, &fbb)
    EvacEtiology_Abridged.add(time: time, &fbb)
    EvacEtiology_Abridged.add(comments: comments, &fbb)
    return EvacEtiology_Abridged.endEvacEtiology_Abridged(&fbb, start: __start)
  }
