...
public struct LogisticsParts_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LogisticsParts_Abridged.id, addPrefix: prefix) }
  ...
  public static func startLogisticsParts_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 11) }
  ...
  public static func endLogisticsParts_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLogisticsParts_Abridged(
    ...
    let __start = LogisticsParts_Abridged.startLogisticsParts_Abridged(&fbb)
    LogisticsParts_Abridged.add(partNumber: partNumber, &fbb)
    LogisticsParts_Abridged.add(nationalStockNumber: nationalStockNumber, &fbb)
    LogisticsParts_Abridged.add(measurementUnitCode: measurementUnitCode, &fbb)
    LogisticsParts_Abridged.add(workUnitCode: workUnitCode, &fbb)
    LogisticsParts_Abridged.add(technicalOrderText: technicalOrderText, &fbb)
    LogisticsParts_Abridged.add(figureNumber: figureNumber, &fbb)
    LogisticsParts_Abridged.add(indexNumber: indexNumber, &fbb)
    LogisticsParts_Abridged.add(requestVerifier: requestVerifier, &fbb)
    LogisticsParts_Abridged.add(locationVerifier: locationVerifier, &fbb)
    LogisticsParts_Abridged.add(supplyDocumentNumber: supplyDocumentNumber, &fbb)
    LogisticsParts_Abridged.addVectorOf(logisticsStocks: logisticsStocks, &fbb)
    return LogisticsParts_Abridged.endLogisticsParts_Abridged(&fbb, start: __start)
  }
