...
public struct IonoObservationTraceGeneric_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationTraceGeneric_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationTraceGeneric_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endIonoObservationTraceGeneric_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationTraceGeneric_Full(
    ...
    let __start = IonoObservationTraceGeneric_Full.startIonoObservationTraceGeneric_Full(&fbb)
    IonoObservationTraceGeneric_Full.addVectorOf(data: data, &fbb)
    IonoObservationTraceGeneric_Full.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationTraceGeneric_Full.add(notes: notes, &fbb)
    return IonoObservationTraceGeneric_Full.endIonoObservationTraceGeneric_Full(&fbb, start: __start)
  }
