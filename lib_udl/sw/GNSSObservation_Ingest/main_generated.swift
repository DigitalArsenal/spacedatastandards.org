...
public struct GNSSObservation_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: GNSSObservation_Ingest.id, addPrefix: prefix) }
  ...
  public static func startGNSSObservation_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endGNSSObservation_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createGNSSObservation_Ingest(
    ...
    let __start = GNSSObservation_Ingest.startGNSSObservation_Ingest(&fbb)
    GNSSObservation_Ingest.add(gnssSatId: gnssSatId, &fbb)
    GNSSObservation_Ingest.add(trackingStatus: trackingStatus, &fbb)
    GNSSObservation_Ingest.add(agcState: agcState, &fbb)
    GNSSObservation_Ingest.addVectorOf(obsCodeSet: obsCodeSet, &fbb)
    GNSSObservation_Ingest.addVectorOf(ob: ob, &fbb)
    return GNSSObservation_Ingest.endGNSSObservation_Ingest(&fbb, start: __start)
  }
