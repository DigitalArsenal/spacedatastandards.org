...
public struct IndividualAircraftTasking_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IndividualAircraftTasking_Abridged.id, addPrefix: prefix) }
  ...
  public static func startIndividualAircraftTasking_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 11) }
  ...
  public static func endIndividualAircraftTasking_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIndividualAircraftTasking_Abridged(
    ...
    let __start = IndividualAircraftTasking_Abridged.startIndividualAircraftTasking_Abridged(&fbb)
    IndividualAircraftTasking_Abridged.add(numAcft: numAcft, &fbb)
    IndividualAircraftTasking_Abridged.add(acftType: acftType, &fbb)
    IndividualAircraftTasking_Abridged.add(callSign: callSign, &fbb)
    IndividualAircraftTasking_Abridged.add(priConfigCode: priConfigCode, &fbb)
    IndividualAircraftTasking_Abridged.add(secConfigCode: secConfigCode, &fbb)
    IndividualAircraftTasking_Abridged.add(link16CallSign: link16CallSign, &fbb)
    IndividualAircraftTasking_Abridged.add(tacanChan: tacanChan, &fbb)
    IndividualAircraftTasking_Abridged.addVectorOf(juAddress: juAddress, &fbb)
    IndividualAircraftTasking_Abridged.add(iffSifMode1Code: iffSifMode1Code, &fbb)
    IndividualAircraftTasking_Abridged.add(iffSifMode2Code: iffSifMode2Code, &fbb)
    IndividualAircraftTasking_Abridged.add(iffSifMode3Code: iffSifMode3Code, &fbb)
    return IndividualAircraftTasking_Abridged.endIndividualAircraftTasking_Abridged(&fbb, start: __start)
  }
