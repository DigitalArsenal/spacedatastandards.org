...
public enum Ephemeris_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Ephemeris_Full_dataMode_Enum { return .exercise }
  public static var min: Ephemeris_Full_dataMode_Enum { return .real }
}
...
public struct Ephemeris_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Ephemeris_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: Ephemeris_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Ephemeris_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startEphemeris_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 21) }
  ...
  public static func add(dataMode: Ephemeris_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endEphemeris_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createEphemeris_Full(
    ...
    let __start = Ephemeris_Full.startEphemeris_Full(&fbb)
    Ephemeris_Full.add(id: id, &fbb)
    Ephemeris_Full.add(classificationMarking: classificationMarking, &fbb)
    Ephemeris_Full.add(esId: esId, &fbb)
    Ephemeris_Full.add(ts: ts, &fbb)
    Ephemeris_Full.add(xpos: xpos, &fbb)
    Ephemeris_Full.add(ypos: ypos, &fbb)
    Ephemeris_Full.add(zpos: zpos, &fbb)
    Ephemeris_Full.add(xvel: xvel, &fbb)
    Ephemeris_Full.add(yvel: yvel, &fbb)
    Ephemeris_Full.add(zvel: zvel, &fbb)
    Ephemeris_Full.add(xaccel: xaccel, &fbb)
    Ephemeris_Full.add(yaccel: yaccel, &fbb)
    Ephemeris_Full.add(zaccel: zaccel, &fbb)
    Ephemeris_Full.addVectorOf(cov: cov, &fbb)
    Ephemeris_Full.add(createdAt: createdAt, &fbb)
    Ephemeris_Full.add(createdBy: createdBy, &fbb)
    Ephemeris_Full.add(source: source, &fbb)
    Ephemeris_Full.add(dataMode: dataMode, &fbb)
    Ephemeris_Full.add(idOnOrbit: idOnOrbit, &fbb)
    Ephemeris_Full.add(origObjectId: origObjectId, &fbb)
    Ephemeris_Full.add(origin: origin, &fbb)
    return Ephemeris_Full.endEphemeris_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Ephemeris_Full_dataMode_Enum.self)
