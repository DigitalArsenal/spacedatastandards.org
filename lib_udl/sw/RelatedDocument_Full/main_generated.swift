...
public struct RelatedDocument_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: RelatedDocument_Full.id, addPrefix: prefix) }
  ...
  public static func startRelatedDocument_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 2) }
  ...
  public static func endRelatedDocument_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createRelatedDocument_Full(
    _ fbb: inout FlatBufferBuilder,
    documentIdOffset documentId: Offset = Offset(),
    dataSourceRefsVectorOffset dataSourceRefs: Offset = Offset()
  ) -> Offset {
    let __start = RelatedDocument_Full.startRelatedDocument_Full(&fbb)
    RelatedDocument_Full.add(documentId: documentId, &fbb)
    RelatedDocument_Full.addVectorOf(dataSourceRefs: dataSourceRefs, &fbb)
    return RelatedDocument_Full.endRelatedDocument_Full(&fbb, start: __start)
  }
