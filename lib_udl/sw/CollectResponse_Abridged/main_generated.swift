...
public enum CollectResponse_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: CollectResponse_Abridged_dataMode_Enum { return .exercise }
  public static var min: CollectResponse_Abridged_dataMode_Enum { return .real }
}
...
public struct CollectResponse_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: CollectResponse_Abridged.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case externalId = 20
    case status = 22
    case actualStartTime = 24
    case actualEndTime = 26
    case altStartTime = 28
    case altEndTime = 30
    case errCode = 32
    case srcTyps = 34
    case srcIds = 36
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: CollectResponse_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : CollectResponse_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startCollectResponse_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 26) }
  ...
  public static func add(dataMode: CollectResponse_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endCollectResponse_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createCollectResponse_Abridged(
    ...
    let __start = CollectResponse_Abridged.startCollectResponse_Abridged(&fbb)
    CollectResponse_Abridged.add(id: id, &fbb)
    CollectResponse_Abridged.add(classificationMarking: classificationMarking, &fbb)
    CollectResponse_Abridged.add(idRequest: idRequest, &fbb)
    CollectResponse_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    CollectResponse_Abridged.add(origObjectId: origObjectId, &fbb)
    CollectResponse_Abridged.add(satNo: satNo, &fbb)
    CollectResponse_Abridged.add(taskId: taskId, &fbb)
    CollectResponse_Abridged.add(idPlan: idPlan, &fbb)
    CollectResponse_Abridged.add(externalId: externalId, &fbb)
    CollectResponse_Abridged.add(status: status, &fbb)
    CollectResponse_Abridged.add(actualStartTime: actualStartTime, &fbb)
    CollectResponse_Abridged.add(actualEndTime: actualEndTime, &fbb)
    CollectResponse_Abridged.add(altStartTime: altStartTime, &fbb)
    CollectResponse_Abridged.add(altEndTime: altEndTime, &fbb)
    CollectResponse_Abridged.add(errCode: errCode, &fbb)
    CollectResponse_Abridged.addVectorOf(srcTyps: srcTyps, &fbb)
    CollectResponse_Abridged.addVectorOf(srcIds: srcIds, &fbb)
    CollectResponse_Abridged.add(notes: notes, &fbb)
    CollectResponse_Abridged.add(createdAt: createdAt, &fbb)
    CollectResponse_Abridged.add(createdBy: createdBy, &fbb)
    CollectResponse_Abridged.add(source: source, &fbb)
    CollectResponse_Abridged.add(origin: origin, &fbb)
    CollectResponse_Abridged.add(origNetwork: origNetwork, &fbb)
    CollectResponse_Abridged.add(idSensor: idSensor, &fbb)
    CollectResponse_Abridged.add(origSensorId: origSensorId, &fbb)
    CollectResponse_Abridged.add(dataMode: dataMode, &fbb)
    return CollectResponse_Abridged.endCollectResponse_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: CollectResponse_Abridged_dataMode_Enum.self)
    _v.finish()
  }
}
