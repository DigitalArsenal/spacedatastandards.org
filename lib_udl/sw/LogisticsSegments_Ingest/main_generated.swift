...
public struct LogisticsSegments_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LogisticsSegments_Ingest.id, addPrefix: prefix) }
  ...
  public static func startLogisticsSegments_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 15) }
  ...
  public static func endLogisticsSegments_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLogisticsSegments_Ingest(
    ...
    let __start = LogisticsSegments_Ingest.startLogisticsSegments_Ingest(&fbb)
    LogisticsSegments_Ingest.add(segmentNumber: segmentNumber, &fbb)
    LogisticsSegments_Ingest.add(modeCode: modeCode, &fbb)
    LogisticsSegments_Ingest.add(missionType: missionType, &fbb)
    LogisticsSegments_Ingest.add(idMission: idMission, &fbb)
    LogisticsSegments_Ingest.add(extMissionId: extMissionId, &fbb)
    LogisticsSegments_Ingest.add(missionNumber: missionNumber, &fbb)
    LogisticsSegments_Ingest.add(itin: itin, &fbb)
    LogisticsSegments_Ingest.add(segTailNumber: segTailNumber, &fbb)
    LogisticsSegments_Ingest.add(segAircraftMds: segAircraftMds, &fbb)
    LogisticsSegments_Ingest.add(departureIcao: departureIcao, &fbb)
    LogisticsSegments_Ingest.add(segActDepTime: segActDepTime, &fbb)
    LogisticsSegments_Ingest.add(arrivalIcao: arrivalIcao, &fbb)
    LogisticsSegments_Ingest.add(segActArrTime: segActArrTime, &fbb)
    LogisticsSegments_Ingest.add(segEstDepTime: segEstDepTime, &fbb)
    LogisticsSegments_Ingest.add(segEstArrTime: segEstArrTime, &fbb)
    return LogisticsSegments_Ingest.endLogisticsSegments_Ingest(&fbb, start: __start)
  }
