...
public enum Operatingunit_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Operatingunit_dataMode_Enum { return .exercise }
  public static var min: Operatingunit_dataMode_Enum { return .real }
}
...
public struct Operatingunit: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Operatingunit.id, addPrefix: prefix) }
  ...
  public var dataMode: Operatingunit_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Operatingunit_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOperatingunit(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 65) }
  ...
  public static func add(dataMode: Operatingunit_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endOperatingunit(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOperatingunit(
    ...
    let __start = Operatingunit.startOperatingunit(&fbb)
    Operatingunit.add(idOperatingUnit: idOperatingUnit, &fbb)
    Operatingunit.add(classificationMarking: classificationMarking, &fbb)
    Operatingunit.add(altOperatingUnitId: altOperatingUnitId, &fbb)
    Operatingunit.add(name: name, &fbb)
    Operatingunit.add(description: description, &fbb)
    Operatingunit.add(idLocation: idLocation, &fbb)
    Operatingunit.add(idContact: idContact, &fbb)
    Operatingunit.add(idOrganization: idOrganization, &fbb)
    Operatingunit.add(unitIdentifier: unitIdentifier, &fbb)
    Operatingunit.add(countryCode: countryCode, &fbb)
    Operatingunit.add(altCountryCode: altCountryCode, &fbb)
    Operatingunit.add(wac: wac, &fbb)
    Operatingunit.add(operStatus: operStatus, &fbb)
    Operatingunit.add(condition: condition, &fbb)
    Operatingunit.add(conditionAvail: conditionAvail, &fbb)
    Operatingunit.add(eval: eval, &fbb)
    Operatingunit.add(fpa: fpa, &fbb)
    Operatingunit.add(ident: ident, &fbb)
    Operatingunit.add(allegiance: allegiance, &fbb)
    Operatingunit.add(altAllegiance: altAllegiance, &fbb)
    Operatingunit.add(locName: locName, &fbb)
    Operatingunit.add(locReason: locReason, &fbb)
    Operatingunit.add(force: force, &fbb)
    Operatingunit.add(forceName: forceName, &fbb)
    Operatingunit.add(functRole: functRole, &fbb)
    Operatingunit.add(msnPrimary: msnPrimary, &fbb)
    Operatingunit.add(msnPrimarySpecialty: msnPrimarySpecialty, &fbb)
    Operatingunit.add(masterUnit: masterUnit, &fbb)
    Operatingunit.add(stylizedUnit: stylizedUnit, &fbb)
    Operatingunit.add(divCat: divCat, &fbb)
    Operatingunit.add(echelon: echelon, &fbb)
    Operatingunit.add(echelonTier: echelonTier, &fbb)
    Operatingunit.add(fleetId: fleetId, &fbb)
    Operatingunit.add(deployStatus: deployStatus, &fbb)
    Operatingunit.add(flagFlown: flagFlown, &fbb)
    Operatingunit.add(coordDatum: coordDatum, &fbb)
    Operatingunit.add(coord: coord, &fbb)
    Operatingunit.add(coordDerivAcc: coordDerivAcc, &fbb)
    Operatingunit.add(lat: lat, &fbb)
    Operatingunit.add(lon: lon, &fbb)
    Operatingunit.add(elevMsl: elevMsl, &fbb)
    Operatingunit.add(elevMslConfLvl: elevMslConfLvl, &fbb)
    Operatingunit.add(elevMslDerivAcc: elevMslDerivAcc, &fbb)
    Operatingunit.add(geoidalMslSep: geoidalMslSep, &fbb)
    Operatingunit.add(milGridSys: milGridSys, &fbb)
    Operatingunit.add(milGrid: milGrid, &fbb)
    Operatingunit.add(utm: utm, &fbb)
    Operatingunit.add(airDefArea: airDefArea, &fbb)
    Operatingunit.add(polSubdiv: polSubdiv, &fbb)
    Operatingunit.add(symCode: symCode, &fbb)
    Operatingunit.add(classRating: classRating, &fbb)
    Operatingunit.add(recStatus: recStatus, &fbb)
    Operatingunit.add(reviewDate: reviewDate, &fbb)
    Operatingunit.add(resProd: resProd, &fbb)
    Operatingunit.add(referenceDoc: referenceDoc, &fbb)
    Operatingunit.addVectorOf(operatingUnitRemarks: operatingUnitRemarks, &fbb)
    Operatingunit.add(createdAt: createdAt, &fbb)
    Operatingunit.add(createdBy: createdBy, &fbb)
    Operatingunit.add(updatedAt: updatedAt, &fbb)
    Operatingunit.add(updatedBy: updatedBy, &fbb)
    Operatingunit.add(source: source, &fbb)
    Operatingunit.add(origin: origin, &fbb)
    Operatingunit.add(dataMode: dataMode, &fbb)
    Operatingunit.add(organization: organization, &fbb)
    Operatingunit.add(location: location, &fbb)
    return Operatingunit.endOperatingunit(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Operatingunit_dataMode_Enum.self)
