...
public struct FlightPlanPointGroups_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: FlightPlanPointGroups_Full.id, addPrefix: prefix) }
  ...
  public static func startFlightPlanPointGroups_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 24) }
  ...
  public static func endFlightPlanPointGroups_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createFlightPlanPointGroups_Full(
    ...
    let __start = FlightPlanPointGroups_Full.startFlightPlanPointGroups_Full(&fbb)
    FlightPlanPointGroups_Full.add(pointGroupName: pointGroupName, &fbb)
    FlightPlanPointGroups_Full.add(worstFuelCase: worstFuelCase, &fbb)
    FlightPlanPointGroups_Full.add(lsafName: lsafName, &fbb)
    FlightPlanPointGroups_Full.add(lsafDistance: lsafDistance, &fbb)
    FlightPlanPointGroups_Full.add(fsafDistance: fsafDistance, &fbb)
    FlightPlanPointGroups_Full.add(etopsDistance: etopsDistance, &fbb)
    FlightPlanPointGroups_Full.add(lsafTime: lsafTime, &fbb)
    FlightPlanPointGroups_Full.add(fsafTime: fsafTime, &fbb)
    FlightPlanPointGroups_Full.add(etopsTime: etopsTime, &fbb)
    FlightPlanPointGroups_Full.add(lsafAvgWindFactor: lsafAvgWindFactor, &fbb)
    FlightPlanPointGroups_Full.add(fsafAvgWindFactor: fsafAvgWindFactor, &fbb)
    FlightPlanPointGroups_Full.add(etopsAvgWindFactor: etopsAvgWindFactor, &fbb)
    FlightPlanPointGroups_Full.add(lsafTempDev: lsafTempDev, &fbb)
    FlightPlanPointGroups_Full.add(fsafTempDev: fsafTempDev, &fbb)
    FlightPlanPointGroups_Full.add(etopsTempDev: etopsTempDev, &fbb)
    FlightPlanPointGroups_Full.add(lsafReqFuel: lsafReqFuel, &fbb)
    FlightPlanPointGroups_Full.add(fsafReqFuel: fsafReqFuel, &fbb)
    FlightPlanPointGroups_Full.add(etopsReqFuel: etopsReqFuel, &fbb)
    FlightPlanPointGroups_Full.add(fromTakeoffTime: fromTakeoffTime, &fbb)
    FlightPlanPointGroups_Full.add(plannedFuel: plannedFuel, &fbb)
    FlightPlanPointGroups_Full.add(fuelCalcAlt: fuelCalcAlt, &fbb)
    FlightPlanPointGroups_Full.add(fuelCalcSpd: fuelCalcSpd, &fbb)
    FlightPlanPointGroups_Full.add(avgFuelFlow: avgFuelFlow, &fbb)
    FlightPlanPointGroups_Full.addVectorOf(flightPlanPoints: flightPlanPoints, &fbb)
    return FlightPlanPointGroups_Full.endFlightPlanPointGroups_Full(&fbb, start: __start)
  }
