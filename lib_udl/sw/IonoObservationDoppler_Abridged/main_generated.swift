...
///  /// Array of Doppler.
public struct IonoObservationDoppler_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDoppler_Abridged.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDoppler_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationDoppler_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDoppler_Abridged(
    ...
    let __start = IonoObservationDoppler_Abridged.startIonoObservationDoppler_Abridged(&fbb)
    IonoObservationDoppler_Abridged.add(notes: notes, &fbb)
    IonoObservationDoppler_Abridged.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationDoppler_Abridged.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationDoppler_Abridged.addVectorOf(data: data, &fbb)
    return IonoObservationDoppler_Abridged.endIonoObservationDoppler_Abridged(&fbb, start: __start)
  }
