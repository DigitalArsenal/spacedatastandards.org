...
public enum OnorbitEvent_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OnorbitEvent_Abridged_dataMode_Enum { return .exercise }
  public static var min: OnorbitEvent_Abridged_dataMode_Enum { return .real }
}


///  /// No description available.
public struct OnorbitEvent_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OnorbitEvent_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: OnorbitEvent_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OnorbitEvent_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startOnorbitEvent_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 54) }
  ...
  public static func add(dataMode: OnorbitEvent_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(createdAt: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdAt, at: VTOFFSET.createdAt.p) }
  public static func add(createdBy: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: createdBy, at: VTOFFSET.createdBy.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endOnorbitEvent_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOnorbitEvent_Abridged(
    ...
    let __start = OnorbitEvent_Abridged.startOnorbitEvent_Abridged(&fbb)
    OnorbitEvent_Abridged.add(id: id, &fbb)
    OnorbitEvent_Abridged.add(classificationMarking: classificationMarking, &fbb)
    OnorbitEvent_Abridged.add(derivedFrom: derivedFrom, &fbb)
    OnorbitEvent_Abridged.add(declassificationDate: declassificationDate, &fbb)
    OnorbitEvent_Abridged.add(declassificationString: declassificationString, &fbb)
    OnorbitEvent_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    OnorbitEvent_Abridged.add(satNo: satNo, &fbb)
    OnorbitEvent_Abridged.add(origObjectId: origObjectId, &fbb)
    OnorbitEvent_Abridged.add(eventTime: eventTime, &fbb)
    OnorbitEvent_Abridged.add(eventTimeNotes: eventTimeNotes, &fbb)
    OnorbitEvent_Abridged.add(operatorOrgId: operatorOrgId, &fbb)
    OnorbitEvent_Abridged.add(ownerOrgId: ownerOrgId, &fbb)
    OnorbitEvent_Abridged.add(lesseeOrgId: lesseeOrgId, &fbb)
    OnorbitEvent_Abridged.add(operatedOnBehalfOfOrgId: operatedOnBehalfOfOrgId, &fbb)
    OnorbitEvent_Abridged.add(geoPosition: geoPosition, &fbb)
    OnorbitEvent_Abridged.add(planeSlot: planeSlot, &fbb)
    OnorbitEvent_Abridged.add(planeNumber: planeNumber, &fbb)
    OnorbitEvent_Abridged.add(positionStatus: positionStatus, &fbb)
    OnorbitEvent_Abridged.add(untilTime: untilTime, &fbb)
    OnorbitEvent_Abridged.add(officialLossDate: officialLossDate, &fbb)
    OnorbitEvent_Abridged.add(netAmount: netAmount, &fbb)
    OnorbitEvent_Abridged.add(underlyingCause: underlyingCause, &fbb)
    OnorbitEvent_Abridged.add(capabilityLoss: capabilityLoss, &fbb)
    OnorbitEvent_Abridged.add(capacityLoss: capacityLoss, &fbb)
    OnorbitEvent_Abridged.add(insuranceLoss: insuranceLoss, &fbb)
    OnorbitEvent_Abridged.add(thirdPartyInsuranceLoss: thirdPartyInsuranceLoss, &fbb)
    OnorbitEvent_Abridged.add(injured: injured, &fbb)
    OnorbitEvent_Abridged.add(killed: killed, &fbb)
    OnorbitEvent_Abridged.add(lifeLost: lifeLost, &fbb)
    OnorbitEvent_Abridged.add(ageAtEvent: ageAtEvent, &fbb)
    OnorbitEvent_Abridged.add(achievedFlightPhase: achievedFlightPhase, &fbb)
    OnorbitEvent_Abridged.add(occurrenceFlightPhase: occurrenceFlightPhase, &fbb)
    OnorbitEvent_Abridged.add(stageAtFault: stageAtFault, &fbb)
    OnorbitEvent_Abridged.add(equipmentAtFault: equipmentAtFault, &fbb)
    OnorbitEvent_Abridged.add(equipmentTypeAtFault: equipmentTypeAtFault, &fbb)
    OnorbitEvent_Abridged.add(equipmentPartAtFault: equipmentPartAtFault, &fbb)
    OnorbitEvent_Abridged.add(consequentialEquipmentFailure: consequentialEquipmentFailure, &fbb)
    OnorbitEvent_Abridged.add(inclined: inclined, &fbb)
    OnorbitEvent_Abridged.add(description: description, &fbb)
    OnorbitEvent_Abridged.add(remarks: remarks, &fbb)
    OnorbitEvent_Abridged.add(insuranceLossNotes: insuranceLossNotes, &fbb)
    OnorbitEvent_Abridged.add(capabilityLossNotes: capabilityLossNotes, &fbb)
    OnorbitEvent_Abridged.add(insuranceCarriedNotes: insuranceCarriedNotes, &fbb)
    OnorbitEvent_Abridged.add(equipmentCausingLossNotes: equipmentCausingLossNotes, &fbb)
    OnorbitEvent_Abridged.add(eventType: eventType, &fbb)
    OnorbitEvent_Abridged.add(eventResult: eventResult, &fbb)
    OnorbitEvent_Abridged.add(objectStatus: objectStatus, &fbb)
    OnorbitEvent_Abridged.add(satellitePosition: satellitePosition, &fbb)
    OnorbitEvent_Abridged.add(source: source, &fbb)
    OnorbitEvent_Abridged.add(origin: origin, &fbb)
    OnorbitEvent_Abridged.add(dataMode: dataMode, &fbb)
    OnorbitEvent_Abridged.add(createdAt: createdAt, &fbb)
    OnorbitEvent_Abridged.add(createdBy: createdBy, &fbb)
    OnorbitEvent_Abridged.add(origNetwork: origNetwork, &fbb)
    return OnorbitEvent_Abridged.endOnorbitEvent_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OnorbitEvent_Abridged_dataMode_Enum.self)
