...
public struct IonoObservationElevation_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationElevation_Ingest.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationElevation_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationElevation_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationElevation_Ingest(
    ...
    let __start = IonoObservationElevation_Ingest.startIonoObservationElevation_Ingest(&fbb)
    IonoObservationElevation_Ingest.add(notes: notes, &fbb)
    IonoObservationElevation_Ingest.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationElevation_Ingest.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationElevation_Ingest.addVectorOf(data: data, &fbb)
    return IonoObservationElevation_Ingest.endIonoObservationElevation_Ingest(&fbb, start: __start)
  }
