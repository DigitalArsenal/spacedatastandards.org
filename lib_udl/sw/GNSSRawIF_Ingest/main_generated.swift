...
public enum GNSSRawIF_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: GNSSRawIF_Ingest_dataMode_Enum { return .exercise }
  public static var min: GNSSRawIF_Ingest_dataMode_Enum { return .real }
}
...
public struct GNSSRawIF_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: GNSSRawIF_Ingest.id, addPrefix: prefix) }
  ...
  public var dataMode: GNSSRawIF_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : GNSSRawIF_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startGNSSRawIF_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 40) }
  ...
  public static func add(dataMode: GNSSRawIF_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endGNSSRawIF_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createGNSSRawIF_Ingest(
    ...
    let __start = GNSSRawIF_Ingest.startGNSSRawIF_Ingest(&fbb)
    GNSSRawIF_Ingest.add(id: id, &fbb)
    GNSSRawIF_Ingest.add(classificationMarking: classificationMarking, &fbb)
    GNSSRawIF_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    GNSSRawIF_Ingest.add(satNo: satNo, &fbb)
    GNSSRawIF_Ingest.add(origObjectId: origObjectId, &fbb)
    GNSSRawIF_Ingest.add(esId: esId, &fbb)
    GNSSRawIF_Ingest.add(receiver: receiver, &fbb)
    GNSSRawIF_Ingest.addVectorOf(boresight: boresight, &fbb)
    GNSSRawIF_Ingest.addVectorOf(quat: quat, &fbb)
    GNSSRawIF_Ingest.add(startIndex: startIndex, &fbb)
    GNSSRawIF_Ingest.add(startTime: startTime, &fbb)
    GNSSRawIF_Ingest.add(endTime: endTime, &fbb)
    GNSSRawIF_Ingest.add(startLat: startLat, &fbb)
    GNSSRawIF_Ingest.add(startLon: startLon, &fbb)
    GNSSRawIF_Ingest.add(startAlt: startAlt, &fbb)
    GNSSRawIF_Ingest.add(endLat: endLat, &fbb)
    GNSSRawIF_Ingest.add(endLon: endLon, &fbb)
    GNSSRawIF_Ingest.add(endAlt: endAlt, &fbb)
    GNSSRawIF_Ingest.addVectorOf(centerFreq: centerFreq, &fbb)
    GNSSRawIF_Ingest.addVectorOf(ifFreq: ifFreq, &fbb)
    GNSSRawIF_Ingest.addVectorOf(sampleRate: sampleRate, &fbb)
    GNSSRawIF_Ingest.addVectorOf(postFourier: postFourier, &fbb)
    GNSSRawIF_Ingest.add(sampleType: sampleType, &fbb)
    GNSSRawIF_Ingest.add(bitDepth: bitDepth, &fbb)
    GNSSRawIF_Ingest.addVectorOf(diffCodeBias: diffCodeBias, &fbb)
    GNSSRawIF_Ingest.add(dataRate: dataRate, &fbb)
    GNSSRawIF_Ingest.add(setId: setId, &fbb)
    GNSSRawIF_Ingest.add(setLength: setLength, &fbb)
    GNSSRawIF_Ingest.add(sequenceId: sequenceId, &fbb)
    GNSSRawIF_Ingest.add(fileName: fileName, &fbb)
    GNSSRawIF_Ingest.addVectorOf(srcTyps: srcTyps, &fbb)
    GNSSRawIF_Ingest.addVectorOf(srcIds: srcIds, &fbb)
    GNSSRawIF_Ingest.add(fileSize: fileSize, &fbb)
    GNSSRawIF_Ingest.addVectorOf(tags: tags, &fbb)
    GNSSRawIF_Ingest.add(createdAt: createdAt, &fbb)
    GNSSRawIF_Ingest.add(createdBy: createdBy, &fbb)
    GNSSRawIF_Ingest.add(source: source, &fbb)
    GNSSRawIF_Ingest.add(origin: origin, &fbb)
    GNSSRawIF_Ingest.add(dataMode: dataMode, &fbb)
    GNSSRawIF_Ingest.add(origNetwork: origNetwork, &fbb)
    return GNSSRawIF_Ingest.endGNSSRawIF_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: GNSSRawIF_Ingest_dataMode_Enum.self)
