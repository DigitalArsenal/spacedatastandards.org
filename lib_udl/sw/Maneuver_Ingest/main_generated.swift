...
public enum Maneuver_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Maneuver_Ingest_dataMode_Enum { return .exercise }
  public static var min: Maneuver_Ingest_dataMode_Enum { return .real }
}


public enum Maneuver_Ingest_sourcedDataTypes_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: Maneuver_Ingest_sourcedDataTypes_Enum { return .sv }
  public static var min: Maneuver_Ingest_sourcedDataTypes_Enum { return .eo }
}


///  /// Model representation of on-orbit object maneuver information for detected, possible, and confirmed maneuvers.
public struct Maneuver_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Maneuver_Ingest.id, addPrefix: prefix) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case tags = 188
    case algorithm = 190
    case sourcedData = 192
    case sourcedDataTypes = 194
  ...
  public var dataMode: Maneuver_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Maneuver_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  ///  Constraints: No constraints specified.
  public var sourcedDataTypes: Maneuver_Ingest_sourcedDataTypes_Enum { let o = _accessor.offset(VTOFFSET.sourcedDataTypes.v); return o == 0 ? .eo : Maneuver_Ingest_sourcedDataTypes_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .eo }
  ...
  public static func startManeuver_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 98) }
  ...
  public static func add(dataMode: Maneuver_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func add(sourcedDataTypes: Maneuver_Ingest_sourcedDataTypes_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: sourcedDataTypes.rawValue, def: 0, at: VTOFFSET.sourcedDataTypes.p) }
  ...
  public static func endManeuver_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createManeuver_Ingest(
    ...
    let __start = Maneuver_Ingest.startManeuver_Ingest(&fbb)
    Maneuver_Ingest.add(id: id, &fbb)
    Maneuver_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Maneuver_Ingest.add(satNo: satNo, &fbb)
    Maneuver_Ingest.add(reportTime: reportTime, &fbb)
    Maneuver_Ingest.add(eventStartTime: eventStartTime, &fbb)
    Maneuver_Ingest.add(eventEndTime: eventEndTime, &fbb)
    Maneuver_Ingest.add(totalBurnTime: totalBurnTime, &fbb)
    Maneuver_Ingest.add(odFitEndTime: odFitEndTime, &fbb)
    Maneuver_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    Maneuver_Ingest.add(idSensor: idSensor, &fbb)
    Maneuver_Ingest.add(uct: uct, &fbb)
    Maneuver_Ingest.add(maneuverUnc: maneuverUnc, &fbb)
    Maneuver_Ingest.add(characterization: characterization, &fbb)
    Maneuver_Ingest.add(characterizationUnc: characterizationUnc, &fbb)
    Maneuver_Ingest.add(eventId: eventId, &fbb)
    Maneuver_Ingest.add(origObjectId: origObjectId, &fbb)
    Maneuver_Ingest.add(origSensorId: origSensorId, &fbb)
    Maneuver_Ingest.add(status: status, &fbb)
    Maneuver_Ingest.add(deltaPos: deltaPos, &fbb)
    Maneuver_Ingest.add(deltaPosU: deltaPosU, &fbb)
    Maneuver_Ingest.add(deltaPosV: deltaPosV, &fbb)
    Maneuver_Ingest.add(deltaPosW: deltaPosW, &fbb)
    Maneuver_Ingest.add(deltaVel: deltaVel, &fbb)
    Maneuver_Ingest.add(deltaVelU: deltaVelU, &fbb)
    Maneuver_Ingest.add(deltaVelV: deltaVelV, &fbb)
    Maneuver_Ingest.add(deltaVelW: deltaVelW, &fbb)
    Maneuver_Ingest.add(deltaMass: deltaMass, &fbb)
    Maneuver_Ingest.add(preEventIdElset: preEventIdElset, &fbb)
    Maneuver_Ingest.add(preEventElset: preEventElset, &fbb)
    Maneuver_Ingest.add(preEventIdStateVector: preEventIdStateVector, &fbb)
    Maneuver_Ingest.add(preEventStateVector: preEventStateVector, &fbb)
    Maneuver_Ingest.add(prePosX: prePosX, &fbb)
    Maneuver_Ingest.add(prePosY: prePosY, &fbb)
    Maneuver_Ingest.add(prePosZ: prePosZ, &fbb)
    Maneuver_Ingest.add(preVelX: preVelX, &fbb)
    Maneuver_Ingest.add(preVelY: preVelY, &fbb)
    Maneuver_Ingest.add(preVelZ: preVelZ, &fbb)
    Maneuver_Ingest.add(preRadiationPressCoeff: preRadiationPressCoeff, &fbb)
    Maneuver_Ingest.add(preBallisticCoeff: preBallisticCoeff, &fbb)
    Maneuver_Ingest.add(preApogee: preApogee, &fbb)
    Maneuver_Ingest.add(prePerigee: prePerigee, &fbb)
    Maneuver_Ingest.add(preInclination: preInclination, &fbb)
    Maneuver_Ingest.add(preEccentricity: preEccentricity, &fbb)
    Maneuver_Ingest.add(prePeriod: prePeriod, &fbb)
    Maneuver_Ingest.add(preRaan: preRaan, &fbb)
    Maneuver_Ingest.add(preSma: preSma, &fbb)
    Maneuver_Ingest.add(preGeoLongitude: preGeoLongitude, &fbb)
    Maneuver_Ingest.add(preDriftRate: preDriftRate, &fbb)
    Maneuver_Ingest.add(preSigmaU: preSigmaU, &fbb)
    Maneuver_Ingest.add(preSigmaV: preSigmaV, &fbb)
    Maneuver_Ingest.add(preSigmaW: preSigmaW, &fbb)
    Maneuver_Ingest.add(postEventIdElset: postEventIdElset, &fbb)
    Maneuver_Ingest.add(postEventElset: postEventElset, &fbb)
    Maneuver_Ingest.add(postEventIdStateVector: postEventIdStateVector, &fbb)
    Maneuver_Ingest.add(postEventStateVector: postEventStateVector, &fbb)
    Maneuver_Ingest.add(postPosX: postPosX, &fbb)
    Maneuver_Ingest.add(postPosY: postPosY, &fbb)
    Maneuver_Ingest.add(postPosZ: postPosZ, &fbb)
    Maneuver_Ingest.add(postVelX: postVelX, &fbb)
    Maneuver_Ingest.add(postVelY: postVelY, &fbb)
    Maneuver_Ingest.add(postVelZ: postVelZ, &fbb)
    Maneuver_Ingest.add(postRadiationPressCoeff: postRadiationPressCoeff, &fbb)
    Maneuver_Ingest.add(postBallisticCoeff: postBallisticCoeff, &fbb)
    Maneuver_Ingest.add(postApogee: postApogee, &fbb)
    Maneuver_Ingest.add(postPerigee: postPerigee, &fbb)
    Maneuver_Ingest.add(postInclination: postInclination, &fbb)
    Maneuver_Ingest.add(postEccentricity: postEccentricity, &fbb)
    Maneuver_Ingest.add(postPeriod: postPeriod, &fbb)
    Maneuver_Ingest.add(postRaan: postRaan, &fbb)
    Maneuver_Ingest.add(postSma: postSma, &fbb)
    Maneuver_Ingest.add(postGeoLongitude: postGeoLongitude, &fbb)
    Maneuver_Ingest.add(postDriftRate: postDriftRate, &fbb)
    Maneuver_Ingest.add(postSigmaU: postSigmaU, &fbb)
    Maneuver_Ingest.add(postSigmaV: postSigmaV, &fbb)
    Maneuver_Ingest.add(postSigmaW: postSigmaW, &fbb)
    Maneuver_Ingest.addVectorOf(cov: cov, &fbb)
    Maneuver_Ingest.add(postMass: postMass, &fbb)
    Maneuver_Ingest.add(postArea: postArea, &fbb)
    Maneuver_Ingest.add(numObs: numObs, &fbb)
    Maneuver_Ingest.add(description: description, &fbb)
    Maneuver_Ingest.add(descriptor: descriptor, &fbb)
    Maneuver_Ingest.add(stateModel: stateModel, &fbb)
    Maneuver_Ingest.add(stateModelVersion: stateModelVersion, &fbb)
    Maneuver_Ingest.add(numAccelPoints: numAccelPoints, &fbb)
    Maneuver_Ingest.addVectorOf(mnvrAccelTimes: mnvrAccelTimes, &fbb)
    Maneuver_Ingest.addVectorOf(mnvrAccels: mnvrAccels, &fbb)
    Maneuver_Ingest.addVectorOf(mnvrAccelUncs: mnvrAccelUncs, &fbb)
    Maneuver_Ingest.add(source: source, &fbb)
    Maneuver_Ingest.add(origin: origin, &fbb)
    Maneuver_Ingest.add(dataMode: dataMode, &fbb)
    Maneuver_Ingest.add(createdAt: createdAt, &fbb)
    Maneuver_Ingest.add(createdBy: createdBy, &fbb)
    Maneuver_Ingest.addVectorOf(tags: tags, &fbb)
    Maneuver_Ingest.add(algorithm: algorithm, &fbb)
    Maneuver_Ingest.addVectorOf(sourcedData: sourcedData, &fbb)
    Maneuver_Ingest.add(sourcedDataTypes: sourcedDataTypes, &fbb)
    Maneuver_Ingest.add(transactionId: transactionId, &fbb)
    Maneuver_Ingest.add(origNetwork: origNetwork, &fbb)
    return Maneuver_Ingest.endManeuver_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Maneuver_Ingest_dataMode_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.sourcedDataTypes.p, fieldName: "sourcedDataTypes", required: false, type: Maneuver_Ingest_sourcedDataTypes_Enum.self)
