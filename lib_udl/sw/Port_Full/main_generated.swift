...
public enum Port_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Port_Full_dataMode_Enum { return .exercise }
  public static var min: Port_Full_dataMode_Enum { return .real }
}


///  /// Properties and characteristics of a maritime port, which includes location, port identifiers, and remarks.
public struct Port_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Port_Full.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 64
  public var dataMode: Port_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Port_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: OPS1
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startPort_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 25) }
  ...
  public static func add(dataMode: Port_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endPort_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPort_Full(
    ...
    let __start = Port_Full.startPort_Full(&fbb)
    Port_Full.add(id: id, &fbb)
    Port_Full.add(classificationMarking: classificationMarking, &fbb)
    Port_Full.add(idSite: idSite, &fbb)
    Port_Full.add(externalId: externalId, &fbb)
    Port_Full.add(locode: locode, &fbb)
    Port_Full.add(portName: portName, &fbb)
    Port_Full.add(harborType: harborType, &fbb)
    Port_Full.add(harborSize: harborSize, &fbb)
    Port_Full.add(maxDraught: maxDraught, &fbb)
    Port_Full.add(avgDuration: avgDuration, &fbb)
    Port_Full.add(tideRange: tideRange, &fbb)
    Port_Full.add(shelter: shelter, &fbb)
    Port_Full.add(pilotReqd: pilotReqd, &fbb)
    Port_Full.add(lat: lat, &fbb)
    Port_Full.add(lon: lon, &fbb)
    Port_Full.add(countryCode: countryCode, &fbb)
    Port_Full.add(createdAt: createdAt, &fbb)
    Port_Full.add(createdBy: createdBy, &fbb)
    Port_Full.add(updatedAt: updatedAt, &fbb)
    Port_Full.add(updatedBy: updatedBy, &fbb)
    Port_Full.add(source: source, &fbb)
    Port_Full.add(sourceDl: sourceDl, &fbb)
    Port_Full.add(origin: origin, &fbb)
    Port_Full.add(dataMode: dataMode, &fbb)
    Port_Full.add(origNetwork: origNetwork, &fbb)
    return Port_Full.endPort_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Port_Full_dataMode_Enum.self)
