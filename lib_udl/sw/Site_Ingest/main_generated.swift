...
public enum Site_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: Site_Ingest_dataMode_Enum { return .exercise }
  public static var min: Site_Ingest_dataMode_Enum { return .real }
}


///  /// Properties and characteristics of a site entity, such as an airbase, airfield, naval station, etc.
public struct Site_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: Site_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: Site_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : Site_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  public static func startSite_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 66) }
  ...
  public static func add(dataMode: Site_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func endSite_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSite_Ingest(
    ...
    let __start = Site_Ingest.startSite_Ingest(&fbb)
    Site_Ingest.add(id: id, &fbb)
    Site_Ingest.add(entity: entity, &fbb)
    Site_Ingest.add(idEntity: idEntity, &fbb)
    Site_Ingest.add(idParentSite: idParentSite, &fbb)
    Site_Ingest.add(classificationMarking: classificationMarking, &fbb)
    Site_Ingest.add(origSiteId: origSiteId, &fbb)
    Site_Ingest.add(origLzId: origLzId, &fbb)
    Site_Ingest.add(pin: pin, &fbb)
    Site_Ingest.add(type: type, &fbb)
    Site_Ingest.add(usage: usage, &fbb)
    Site_Ingest.add(lzUsage: lzUsage, &fbb)
    Site_Ingest.add(name: name, &fbb)
    Site_Ingest.add(coordDatum: coordDatum, &fbb)
    Site_Ingest.add(coord: coord, &fbb)
    Site_Ingest.add(coordDerivAcc: coordDerivAcc, &fbb)
    Site_Ingest.add(osuffix: osuffix, &fbb)
    Site_Ingest.add(iata: iata, &fbb)
    Site_Ingest.add(icao: icao, &fbb)
    Site_Ingest.add(faa: faa, &fbb)
    Site_Ingest.add(airDefArea: airDefArea, &fbb)
    Site_Ingest.add(utm: utm, &fbb)
    Site_Ingest.add(milGridSys: milGridSys, &fbb)
    Site_Ingest.add(milGrid: milGrid, &fbb)
    Site_Ingest.add(catCode: catCode, &fbb)
    Site_Ingest.add(catText: catText, &fbb)
    Site_Ingest.add(wac: wac, &fbb)
    Site_Ingest.add(polSubdiv: polSubdiv, &fbb)
    Site_Ingest.add(geoArea: geoArea, &fbb)
    Site_Ingest.add(geoidalMslSep: geoidalMslSep, &fbb)
    Site_Ingest.add(allegiance: allegiance, &fbb)
    Site_Ingest.add(altAllegiance: altAllegiance, &fbb)
    Site_Ingest.add(classRating: classRating, &fbb)
    Site_Ingest.add(fpa: fpa, &fbb)
    Site_Ingest.add(beNumber: beNumber, &fbb)
    Site_Ingest.add(runways: runways, &fbb)
    Site_Ingest.add(maxRunwayLength: maxRunwayLength, &fbb)
    Site_Ingest.add(condition: condition, &fbb)
    Site_Ingest.add(conditionAvail: conditionAvail, &fbb)
    Site_Ingest.add(operStatus: operStatus, &fbb)
    Site_Ingest.add(grade: grade, &fbb)
    Site_Ingest.add(activity: activity, &fbb)
    Site_Ingest.add(functPrimary: functPrimary, &fbb)
    Site_Ingest.add(msnPrimary: msnPrimary, &fbb)
    Site_Ingest.add(msnPrimarySpec: msnPrimarySpec, &fbb)
    Site_Ingest.add(nucCap: nucCap, &fbb)
    Site_Ingest.add(ident: ident, &fbb)
    Site_Ingest.add(elevMsl: elevMsl, &fbb)
    Site_Ingest.add(elevMslConfLvl: elevMslConfLvl, &fbb)
    Site_Ingest.add(elevMslDerivAcc: elevMslDerivAcc, &fbb)
    Site_Ingest.add(vegHt: vegHt, &fbb)
    Site_Ingest.add(vegType: vegType, &fbb)
    Site_Ingest.add(popArea: popArea, &fbb)
    Site_Ingest.add(popAreaProx: popAreaProx, &fbb)
    Site_Ingest.add(notes: notes, &fbb)
    Site_Ingest.add(resProd: resProd, &fbb)
    Site_Ingest.add(eval: eval, &fbb)
    Site_Ingest.add(reviewDate: reviewDate, &fbb)
    Site_Ingest.add(recStatus: recStatus, &fbb)
    Site_Ingest.add(symCode: symCode, &fbb)
    Site_Ingest.add(referenceDoc: referenceDoc, &fbb)
    Site_Ingest.add(createdAt: createdAt, &fbb)
    Site_Ingest.add(createdBy: createdBy, &fbb)
    Site_Ingest.add(source: source, &fbb)
    Site_Ingest.add(origin: origin, &fbb)
    Site_Ingest.add(origNetwork: origNetwork, &fbb)
    Site_Ingest.add(dataMode: dataMode, &fbb)
    return Site_Ingest.endSite_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: Site_Ingest_dataMode_Enum.self)
    _v.finish()
  }
}
