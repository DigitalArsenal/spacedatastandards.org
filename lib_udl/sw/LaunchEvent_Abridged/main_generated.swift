...
public enum LaunchEvent_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: LaunchEvent_Abridged_dataMode_Enum { return .exercise }
  public static var min: LaunchEvent_Abridged_dataMode_Enum { return .real }
}


///  /// Information on known launch events.
public struct LaunchEvent_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LaunchEvent_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: LaunchEvent_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : LaunchEvent_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startLaunchEvent_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 20) }
  ...
  public static func add(dataMode: LaunchEvent_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endLaunchEvent_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLaunchEvent_Abridged(
    ...
    let __start = LaunchEvent_Abridged.startLaunchEvent_Abridged(&fbb)
    LaunchEvent_Abridged.add(id: id, &fbb)
    LaunchEvent_Abridged.add(idOnOrbit: idOnOrbit, &fbb)
    LaunchEvent_Abridged.add(origObjectId: origObjectId, &fbb)
    LaunchEvent_Abridged.add(classificationMarking: classificationMarking, &fbb)
    LaunchEvent_Abridged.add(derivedFrom: derivedFrom, &fbb)
    LaunchEvent_Abridged.add(declassificationDate: declassificationDate, &fbb)
    LaunchEvent_Abridged.add(declassificationString: declassificationString, &fbb)
    LaunchEvent_Abridged.add(msgCreateDate: msgCreateDate, &fbb)
    LaunchEvent_Abridged.add(launchFailureCode: launchFailureCode, &fbb)
    LaunchEvent_Abridged.add(launchDate: launchDate, &fbb)
    LaunchEvent_Abridged.add(beNumber: beNumber, &fbb)
    LaunchEvent_Abridged.add(oSuffix: oSuffix, &fbb)
    LaunchEvent_Abridged.add(launchFacilityName: launchFacilityName, &fbb)
    LaunchEvent_Abridged.add(createdAt: createdAt, &fbb)
    LaunchEvent_Abridged.add(createdBy: createdBy, &fbb)
    LaunchEvent_Abridged.add(origin: origin, &fbb)
    LaunchEvent_Abridged.add(source: source, &fbb)
    LaunchEvent_Abridged.add(dataMode: dataMode, &fbb)
    LaunchEvent_Abridged.add(origNetwork: origNetwork, &fbb)
    LaunchEvent_Abridged.add(satNo: satNo, &fbb)
    return LaunchEvent_Abridged.endLaunchEvent_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: LaunchEvent_Abridged_dataMode_Enum.self)
