...
public struct DiplomaticClearanceDetails_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: DiplomaticClearanceDetails_Ingest.id, addPrefix: prefix) }
  ...
  public static func startDiplomaticClearanceDetails_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 24) }
  ...
  public static func endDiplomaticClearanceDetails_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createDiplomaticClearanceDetails_Ingest(
    ...
    let __start = DiplomaticClearanceDetails_Ingest.startDiplomaticClearanceDetails_Ingest(&fbb)
    DiplomaticClearanceDetails_Ingest.add(idSortie: idSortie, &fbb)
    DiplomaticClearanceDetails_Ingest.add(legNum: legNum, &fbb)
    DiplomaticClearanceDetails_Ingest.add(routeString: routeString, &fbb)
    DiplomaticClearanceDetails_Ingest.add(validStartTime: validStartTime, &fbb)
    DiplomaticClearanceDetails_Ingest.add(validEndTime: validEndTime, &fbb)
    DiplomaticClearanceDetails_Ingest.add(clearanceId: clearanceId, &fbb)
    DiplomaticClearanceDetails_Ingest.add(externalClearanceId: externalClearanceId, &fbb)
    DiplomaticClearanceDetails_Ingest.add(clearedCallSign: clearedCallSign, &fbb)
    DiplomaticClearanceDetails_Ingest.add(sequenceNum: sequenceNum, &fbb)
    DiplomaticClearanceDetails_Ingest.add(countryCode: countryCode, &fbb)
    DiplomaticClearanceDetails_Ingest.add(altCountryCode: altCountryCode, &fbb)
    DiplomaticClearanceDetails_Ingest.add(countryName: countryName, &fbb)
    DiplomaticClearanceDetails_Ingest.add(validDesc: validDesc, &fbb)
    DiplomaticClearanceDetails_Ingest.add(windowRemark: windowRemark, &fbb)
    DiplomaticClearanceDetails_Ingest.add(entryPoint: entryPoint, &fbb)
    DiplomaticClearanceDetails_Ingest.add(entryNet: entryNet, &fbb)
    DiplomaticClearanceDetails_Ingest.add(exitPoint: exitPoint, &fbb)
    DiplomaticClearanceDetails_Ingest.add(exitNlt: exitNlt, &fbb)
    DiplomaticClearanceDetails_Ingest.add(reqIcao: reqIcao, &fbb)
    DiplomaticClearanceDetails_Ingest.add(action: action, &fbb)
    DiplomaticClearanceDetails_Ingest.add(status: status, &fbb)
    DiplomaticClearanceDetails_Ingest.add(profile: profile, &fbb)
    DiplomaticClearanceDetails_Ingest.add(reqPoint: reqPoint, &fbb)
    DiplomaticClearanceDetails_Ingest.add(clearanceRemark: clearanceRemark, &fbb)
    return DiplomaticClearanceDetails_Ingest.endDiplomaticClearanceDetails_Ingest(&fbb, start: __start)
  }
