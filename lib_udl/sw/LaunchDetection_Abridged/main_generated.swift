...
public enum LaunchDetection_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: LaunchDetection_Abridged_dataMode_Enum { return .exercise }
  public static var min: LaunchDetection_Abridged_dataMode_Enum { return .real }
}


///  /// Data to analyze launch detections.
public struct LaunchDetection_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: LaunchDetection_Abridged.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: LaunchDetection_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : LaunchDetection_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startLaunchDetection_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 26) }
  ...
  public static func add(dataMode: LaunchDetection_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endLaunchDetection_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createLaunchDetection_Abridged(
    ...
    let __start = LaunchDetection_Abridged.startLaunchDetection_Abridged(&fbb)
    LaunchDetection_Abridged.add(id: id, &fbb)
    LaunchDetection_Abridged.add(classificationMarking: classificationMarking, &fbb)
    LaunchDetection_Abridged.add(launchTime: launchTime, &fbb)
    LaunchDetection_Abridged.add(messageType: messageType, &fbb)
    LaunchDetection_Abridged.add(launchLatitude: launchLatitude, &fbb)
    LaunchDetection_Abridged.add(launchLongitude: launchLongitude, &fbb)
    LaunchDetection_Abridged.add(launchAzimuth: launchAzimuth, &fbb)
    LaunchDetection_Abridged.add(raan: raan, &fbb)
    LaunchDetection_Abridged.add(inclination: inclination, &fbb)
    LaunchDetection_Abridged.add(observationTime: observationTime, &fbb)
    LaunchDetection_Abridged.add(observationLatitude: observationLatitude, &fbb)
    LaunchDetection_Abridged.add(observationLongitude: observationLongitude, &fbb)
    LaunchDetection_Abridged.add(observationAltitude: observationAltitude, &fbb)
    LaunchDetection_Abridged.add(stereoFlag: stereoFlag, &fbb)
    LaunchDetection_Abridged.add(highZenithAzimuth: highZenithAzimuth, &fbb)
    LaunchDetection_Abridged.add(sequenceNumber: sequenceNumber, &fbb)
    LaunchDetection_Abridged.add(eventId: eventId, &fbb)
    LaunchDetection_Abridged.add(source: source, &fbb)
    LaunchDetection_Abridged.add(origin: origin, &fbb)
    LaunchDetection_Abridged.add(descriptor: descriptor, &fbb)
    LaunchDetection_Abridged.add(origNetwork: origNetwork, &fbb)
    LaunchDetection_Abridged.add(dataMode: dataMode, &fbb)
    LaunchDetection_Abridged.add(createdAt: createdAt, &fbb)
    LaunchDetection_Abridged.add(createdBy: createdBy, &fbb)
    LaunchDetection_Abridged.add(updatedAt: updatedAt, &fbb)
    LaunchDetection_Abridged.add(updatedBy: updatedBy, &fbb)
    return LaunchDetection_Abridged.endLaunchDetection_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: LaunchDetection_Abridged_dataMode_Enum.self)
