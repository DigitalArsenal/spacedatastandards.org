...
public enum GNSSObservationSet_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: GNSSObservationSet_Full_dataMode_Enum { return .exercise }
  public static var min: GNSSObservationSet_Full_dataMode_Enum { return .real }
}


///  /// Set of GNSSObservation data.
public struct GNSSObservationSet_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: GNSSObservationSet_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: GNSSObservationSet_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : GNSSObservationSet_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startGNSSObservationSet_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 36) }
  ...
  public static func add(dataMode: GNSSObservationSet_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endGNSSObservationSet_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createGNSSObservationSet_Full(
    ...
    let __start = GNSSObservationSet_Full.startGNSSObservationSet_Full(&fbb)
    GNSSObservationSet_Full.add(id: id, &fbb)
    GNSSObservationSet_Full.add(classificationMarking: classificationMarking, &fbb)
    GNSSObservationSet_Full.add(markerType: markerType, &fbb)
    GNSSObservationSet_Full.add(idOnOrbit: idOnOrbit, &fbb)
    GNSSObservationSet_Full.add(satNo: satNo, &fbb)
    GNSSObservationSet_Full.add(origObjectId: origObjectId, &fbb)
    GNSSObservationSet_Full.add(ts: ts, &fbb)
    GNSSObservationSet_Full.add(outage: outage, &fbb)
    GNSSObservationSet_Full.add(gDop: gDop, &fbb)
    GNSSObservationSet_Full.add(hDop: hDop, &fbb)
    GNSSObservationSet_Full.add(pDop: pDop, &fbb)
    GNSSObservationSet_Full.add(tDop: tDop, &fbb)
    GNSSObservationSet_Full.add(vDop: vDop, &fbb)
    GNSSObservationSet_Full.add(esId: esId, &fbb)
    GNSSObservationSet_Full.add(receiver: receiver, &fbb)
    GNSSObservationSet_Full.addVectorOf(boresight: boresight, &fbb)
    GNSSObservationSet_Full.addVectorOf(quat: quat, &fbb)
    GNSSObservationSet_Full.add(lat: lat, &fbb)
    GNSSObservationSet_Full.add(lon: lon, &fbb)
    GNSSObservationSet_Full.add(alt: alt, &fbb)
    GNSSObservationSet_Full.addVectorOf(satVelocity: satVelocity, &fbb)
    GNSSObservationSet_Full.addVectorOf(obsCodes: obsCodes, &fbb)
    GNSSObservationSet_Full.add(trackingStatus: trackingStatus, &fbb)
    GNSSObservationSet_Full.add(navigationStatus: navigationStatus, &fbb)
    GNSSObservationSet_Full.add(agcState: agcState, &fbb)
    GNSSObservationSet_Full.addVectorOf(srcTyps: srcTyps, &fbb)
    GNSSObservationSet_Full.addVectorOf(srcIds: srcIds, &fbb)
    GNSSObservationSet_Full.addVectorOf(tags: tags, &fbb)
    GNSSObservationSet_Full.add(transactionId: transactionId, &fbb)
    GNSSObservationSet_Full.add(createdAt: createdAt, &fbb)
    GNSSObservationSet_Full.add(createdBy: createdBy, &fbb)
    GNSSObservationSet_Full.add(source: source, &fbb)
    GNSSObservationSet_Full.add(origin: origin, &fbb)
    GNSSObservationSet_Full.add(dataMode: dataMode, &fbb)
    GNSSObservationSet_Full.add(origNetwork: origNetwork, &fbb)
    GNSSObservationSet_Full.addVectorOf(gnssObservationList: gnssObservationList, &fbb)
    return GNSSObservationSet_Full.endGNSSObservationSet_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: GNSSObservationSet_Full_dataMode_Enum.self)
