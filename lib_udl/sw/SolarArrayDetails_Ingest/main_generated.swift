...
public enum SolarArrayDetails_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: SolarArrayDetails_Ingest_dataMode_Enum { return .exercise }
  public static var min: SolarArrayDetails_Ingest_dataMode_Enum { return .real }
}
...
public struct SolarArrayDetails_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: SolarArrayDetails_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var dataMode: SolarArrayDetails_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : SolarArrayDetails_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startSolarArrayDetails_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 17) }
  ...
  public static func add(dataMode: SolarArrayDetails_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func addVectorOf(tags: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: tags, at: VTOFFSET.tags.p) }
  public static func endSolarArrayDetails_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createSolarArrayDetails_Ingest(
    ...
    let __start = SolarArrayDetails_Ingest.startSolarArrayDetails_Ingest(&fbb)
    SolarArrayDetails_Ingest.add(id: id, &fbb)
    SolarArrayDetails_Ingest.add(idSolarArray: idSolarArray, &fbb)
    SolarArrayDetails_Ingest.add(classificationMarking: classificationMarking, &fbb)
    SolarArrayDetails_Ingest.add(type: type, &fbb)
    SolarArrayDetails_Ingest.add(technology: technology, &fbb)
    SolarArrayDetails_Ingest.add(junctionTechnology: junctionTechnology, &fbb)
    SolarArrayDetails_Ingest.add(manufacturerOrgId: manufacturerOrgId, &fbb)
    SolarArrayDetails_Ingest.add(span: span, &fbb)
    SolarArrayDetails_Ingest.add(area: area, &fbb)
    SolarArrayDetails_Ingest.add(description: description, &fbb)
    SolarArrayDetails_Ingest.add(createdAt: createdAt, &fbb)
    SolarArrayDetails_Ingest.add(createdBy: createdBy, &fbb)
    SolarArrayDetails_Ingest.add(source: source, &fbb)
    SolarArrayDetails_Ingest.add(origin: origin, &fbb)
    SolarArrayDetails_Ingest.add(origNetwork: origNetwork, &fbb)
    SolarArrayDetails_Ingest.add(dataMode: dataMode, &fbb)
    SolarArrayDetails_Ingest.addVectorOf(tags: tags, &fbb)
    return SolarArrayDetails_Ingest.endSolarArrayDetails_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: SolarArrayDetails_Ingest_dataMode_Enum.self)
