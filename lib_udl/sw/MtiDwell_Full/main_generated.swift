...
public struct MtiDwell_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: MtiDwell_Full.id, addPrefix: prefix) }
  ...
  public static func startMtiDwell_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 32) }
  ...
  public static func endMtiDwell_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createMtiDwell_Full(
    ...
    let __start = MtiDwell_Full.startMtiDwell_Full(&fbb)
    MtiDwell_Full.add(d2: d2, &fbb)
    MtiDwell_Full.add(d3: d3, &fbb)
    MtiDwell_Full.add(d4: d4, &fbb)
    MtiDwell_Full.add(d5: d5, &fbb)
    MtiDwell_Full.add(d6: d6, &fbb)
    MtiDwell_Full.add(d7: d7, &fbb)
    MtiDwell_Full.add(d8: d8, &fbb)
    MtiDwell_Full.add(d9: d9, &fbb)
    MtiDwell_Full.add(d10: d10, &fbb)
    MtiDwell_Full.add(d11: d11, &fbb)
    MtiDwell_Full.add(d12: d12, &fbb)
    MtiDwell_Full.add(d13: d13, &fbb)
    MtiDwell_Full.add(d14: d14, &fbb)
    MtiDwell_Full.add(d15: d15, &fbb)
    MtiDwell_Full.add(d16: d16, &fbb)
    MtiDwell_Full.add(d17: d17, &fbb)
    MtiDwell_Full.add(d18: d18, &fbb)
    MtiDwell_Full.add(d19: d19, &fbb)
    MtiDwell_Full.add(d20: d20, &fbb)
    MtiDwell_Full.add(d21: d21, &fbb)
    MtiDwell_Full.add(d22: d22, &fbb)
    MtiDwell_Full.add(d23: d23, &fbb)
    MtiDwell_Full.add(d24: d24, &fbb)
    MtiDwell_Full.add(d25: d25, &fbb)
    MtiDwell_Full.add(d26: d26, &fbb)
    MtiDwell_Full.add(d27: d27, &fbb)
    MtiDwell_Full.add(d28: d28, &fbb)
    MtiDwell_Full.add(d29: d29, &fbb)
    MtiDwell_Full.add(d30: d30, &fbb)
    MtiDwell_Full.add(d31: d31, &fbb)
    MtiDwell_Full.addVectorOf(d32: d32, &fbb)
    MtiDwell_Full.add(dwellts: dwellts, &fbb)
    return MtiDwell_Full.endMtiDwell_Full(&fbb, start: __start)
  }
