...
public struct ISRCollectionTransit_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: ISRCollectionTransit_Full.id, addPrefix: prefix) }
  ...
  public static func startISRCollectionTransit_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 3) }
  ...
  public static func endISRCollectionTransit_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createISRCollectionTransit_Full(
    _ fbb: inout FlatBufferBuilder,
    idOffset id: Offset = Offset(),
    baseOffset base: Offset = Offset(),
    duration: Double = 0.0
  ) -> Offset {
    let __start = ISRCollectionTransit_Full.startISRCollectionTransit_Full(&fbb)
    ISRCollectionTransit_Full.add(id: id, &fbb)
    ISRCollectionTransit_Full.add(base: base, &fbb)
    ISRCollectionTransit_Full.add(duration: duration, &fbb)
    return ISRCollectionTransit_Full.endISRCollectionTransit_Full(&fbb, start: __start)
  }
