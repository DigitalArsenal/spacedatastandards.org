...
public enum AIS_Abridged_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: AIS_Abridged_dataMode_Enum { return .exercise }
  public static var min: AIS_Abridged_dataMode_Enum { return .real }
}
...
public struct AIS_Abridged: FlatBufferObject, Verifiable {

  static func validateVersion() { FlatBuffersVersion_24_3_25() }
  public var __buffer: ByteBuffer! { return _accessor.bb }
  private var _accessor: Table

  public static var id: String { "AISA" } 
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AIS_Abridged.id, addPrefix: prefix) }
  ...
  public var dataMode: AIS_Abridged_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : AIS_Abridged_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startAIS_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 51) }
  ...
  public static func add(dataMode: AIS_Abridged_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endAIS_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAIS_Abridged(
    ...
    let __start = AIS_Abridged.startAIS_Abridged(&fbb)
    AIS_Abridged.add(id: id, &fbb)
    AIS_Abridged.add(classificationMarking: classificationMarking, &fbb)
    AIS_Abridged.add(idTrack: idTrack, &fbb)
    AIS_Abridged.add(idVessel: idVessel, &fbb)
    AIS_Abridged.add(mmsi: mmsi, &fbb)
    AIS_Abridged.add(imon: imon, &fbb)
    AIS_Abridged.add(ts: ts, &fbb)
    AIS_Abridged.add(shipName: shipName, &fbb)
    AIS_Abridged.add(shipType: shipType, &fbb)
    AIS_Abridged.add(engagedIn: engagedIn, &fbb)
    AIS_Abridged.add(specialCraft: specialCraft, &fbb)
    AIS_Abridged.add(cargoType: cargoType, &fbb)
    AIS_Abridged.add(callSign: callSign, &fbb)
    AIS_Abridged.add(vesselFlag: vesselFlag, &fbb)
    AIS_Abridged.add(lat: lat, &fbb)
    AIS_Abridged.add(lon: lon, &fbb)
    AIS_Abridged.add(posHiAccuracy: posHiAccuracy, &fbb)
    AIS_Abridged.add(posHiLatency: posHiLatency, &fbb)
    AIS_Abridged.add(speed: speed, &fbb)
    AIS_Abridged.add(trueHeading: trueHeading, &fbb)
    AIS_Abridged.add(course: course, &fbb)
    AIS_Abridged.add(rateOfTurn: rateOfTurn, &fbb)
    AIS_Abridged.add(specialManeuver: specialManeuver, &fbb)
    AIS_Abridged.add(navStatus: navStatus, &fbb)
    AIS_Abridged.add(posDeviceType: posDeviceType, &fbb)
    AIS_Abridged.addVectorOf(antennaRefDimensions: antennaRefDimensions, &fbb)
    AIS_Abridged.add(length: length, &fbb)
    AIS_Abridged.add(width: width, &fbb)
    AIS_Abridged.add(draught: draught, &fbb)
    AIS_Abridged.add(shipDescription: shipDescription, &fbb)
    AIS_Abridged.add(destination: destination, &fbb)
    AIS_Abridged.add(destinationEta: destinationEta, &fbb)
    AIS_Abridged.add(currentPortGuid: currentPortGuid, &fbb)
    AIS_Abridged.add(currentPortLocode: currentPortLocode, &fbb)
    AIS_Abridged.add(lastPortGuid: lastPortGuid, &fbb)
    AIS_Abridged.add(lastPortLocode: lastPortLocode, &fbb)
    AIS_Abridged.add(nextPortGuid: nextPortGuid, &fbb)
    AIS_Abridged.add(nextPortLocode: nextPortLocode, &fbb)
    AIS_Abridged.add(etaCalculated: etaCalculated, &fbb)
    AIS_Abridged.add(etaUpdated: etaUpdated, &fbb)
    AIS_Abridged.add(distanceToGo: distanceToGo, &fbb)
    AIS_Abridged.add(distanceTravelled: distanceTravelled, &fbb)
    AIS_Abridged.add(avgSpeed: avgSpeed, &fbb)
    AIS_Abridged.add(maxSpeed: maxSpeed, &fbb)
    AIS_Abridged.add(createdAt: createdAt, &fbb)
    AIS_Abridged.add(createdBy: createdBy, &fbb)
    AIS_Abridged.add(source: source, &fbb)
    AIS_Abridged.add(sourceDl: sourceDl, &fbb)
    AIS_Abridged.add(origin: origin, &fbb)
    AIS_Abridged.add(dataMode: dataMode, &fbb)
    AIS_Abridged.add(origNetwork: origNetwork, &fbb)
    return AIS_Abridged.endAIS_Abridged(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: AIS_Abridged_dataMode_Enum.self)
