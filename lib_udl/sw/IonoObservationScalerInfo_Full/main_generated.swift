...
public struct IonoObservationScalerInfo_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationScalerInfo_Full.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationScalerInfo_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 6) }
  ...
  public static func endIonoObservationScalerInfo_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationScalerInfo_Full(
    ...
    let __start = IonoObservationScalerInfo_Full.startIonoObservationScalerInfo_Full(&fbb)
    IonoObservationScalerInfo_Full.add(type: type, &fbb)
    IonoObservationScalerInfo_Full.add(name: name, &fbb)
    IonoObservationScalerInfo_Full.add(organization: organization, &fbb)
    IonoObservationScalerInfo_Full.add(version: version, &fbb)
    IonoObservationScalerInfo_Full.add(confidenceScore: confidenceScore, &fbb)
    IonoObservationScalerInfo_Full.add(confidenceLevel: confidenceLevel, &fbb)
    return IonoObservationScalerInfo_Full.endIonoObservationScalerInfo_Full(&fbb, start: __start)
  }
