...
public struct AirEventTankers_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AirEventTankers_Abridged.id, addPrefix: prefix) }
  ...
  public static func startAirEventTankers_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 18) }
  ...
  public static func endAirEventTankers_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAirEventTankers_Abridged(
    ...
    let __start = AirEventTankers_Abridged.startAirEventTankers_Abridged(&fbb)
    AirEventTankers_Abridged.add(idTankerSortie: idTankerSortie, &fbb)
    AirEventTankers_Abridged.add(idTankerMission: idTankerMission, &fbb)
    AirEventTankers_Abridged.add(idTankerAirfield: idTankerAirfield, &fbb)
    AirEventTankers_Abridged.add(externalTankerId: externalTankerId, &fbb)
    AirEventTankers_Abridged.add(tankerCoord: tankerCoord, &fbb)
    AirEventTankers_Abridged.add(tankerMds: tankerMds, &fbb)
    AirEventTankers_Abridged.add(amcTankerMissionId: amcTankerMissionId, &fbb)
    AirEventTankers_Abridged.add(altTankerMissionId: altTankerMissionId, &fbb)
    AirEventTankers_Abridged.add(tankerCallSign: tankerCallSign, &fbb)
    AirEventTankers_Abridged.add(tankerOwner: tankerOwner, &fbb)
    AirEventTankers_Abridged.add(tankerPoc: tankerPoc, &fbb)
    AirEventTankers_Abridged.add(tankerLegNum: tankerLegNum, &fbb)
    AirEventTankers_Abridged.add(tankerDeployedIcao: tankerDeployedIcao, &fbb)
    AirEventTankers_Abridged.add(tankerDeliveryMethod: tankerDeliveryMethod, &fbb)
    AirEventTankers_Abridged.add(fuelOff: fuelOff, &fbb)
    AirEventTankers_Abridged.add(tankerCellPosition: tankerCellPosition, &fbb)
    AirEventTankers_Abridged.add(tankerFuelType: tankerFuelType, &fbb)
    AirEventTankers_Abridged.add(dualRole: dualRole, &fbb)
    return AirEventTankers_Abridged.endAirEventTankers_Abridged(&fbb, start: __start)
  }
