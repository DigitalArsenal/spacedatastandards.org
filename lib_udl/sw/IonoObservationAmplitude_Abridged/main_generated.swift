...
public struct IonoObservationAmplitude_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationAmplitude_Abridged.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationAmplitude_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endIonoObservationAmplitude_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationAmplitude_Abridged(
    ...
    let __start = IonoObservationAmplitude_Abridged.startIonoObservationAmplitude_Abridged(&fbb)
    IonoObservationAmplitude_Abridged.add(notes: notes, &fbb)
    IonoObservationAmplitude_Abridged.addVectorOf(dimensions: dimensions, &fbb)
    IonoObservationAmplitude_Abridged.addVectorOf(dimensionName: dimensionName, &fbb)
    IonoObservationAmplitude_Abridged.addVectorOf(data: data, &fbb)
    return IonoObservationAmplitude_Abridged.endIonoObservationAmplitude_Abridged(&fbb, start: __start)
  }
