...
public struct IonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: IonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged.id, addPrefix: prefix) }
  ...
  public static func startIonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 5) }
  ...
  public static func endIonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createIonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged(
    ...
    let __start = IonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged.startIonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged(&fbb)
    IonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged.add(description: description, &fbb)
    IonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged.add(nmF2: nmF2, &fbb)
    IonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged.add(hmF2: hmF2, &fbb)
    IonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged.add(scaleF2: scaleF2, &fbb)
    IonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged.add(chi: chi, &fbb)
    return IonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged.endIonoObservationDensityProfileTopsideExtensionChapmanConst_Abridged(&fbb, start: __start)
  }
