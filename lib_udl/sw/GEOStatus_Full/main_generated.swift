...
public enum GEOStatus_Full_dataMode_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: GEOStatus_Full_dataMode_Enum { return .exercise }
  public static var min: GEOStatus_Full_dataMode_Enum { return .real }
}


///  /// Information for the specified on-orbit GEO spacecraft, including status, expected longitude limits, and drift rates.
public struct GEOStatus_Full: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: GEOStatus_Full.id, addPrefix: prefix) }
  ...
  public var dataMode: GEOStatus_Full_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : GEOStatus_Full_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ...
  public static func startGEOStatus_Full(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 27) }
  ...
  public static func add(dataMode: GEOStatus_Full_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  ...
  public static func endGEOStatus_Full(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createGEOStatus_Full(
    ...
    let __start = GEOStatus_Full.startGEOStatus_Full(&fbb)
    GEOStatus_Full.add(id: id, &fbb)
    GEOStatus_Full.add(classificationMarking: classificationMarking, &fbb)
    GEOStatus_Full.add(idOnOrbit: idOnOrbit, &fbb)
    GEOStatus_Full.add(origObjectId: origObjectId, &fbb)
    GEOStatus_Full.add(ss: ss, &fbb)
    GEOStatus_Full.add(sc: sc, &fbb)
    GEOStatus_Full.add(relativeEnergy: relativeEnergy, &fbb)
    GEOStatus_Full.add(longitudeRate: longitudeRate, &fbb)
    GEOStatus_Full.add(longitudeMin: longitudeMin, &fbb)
    GEOStatus_Full.add(longitudeMax: longitudeMax, &fbb)
    GEOStatus_Full.add(confidenceLevel: confidenceLevel, &fbb)
    GEOStatus_Full.add(planeChangeStatus: planeChangeStatus, &fbb)
    GEOStatus_Full.add(troughType: troughType, &fbb)
    GEOStatus_Full.add(lostFlag: lostFlag, &fbb)
    GEOStatus_Full.add(semiAnnualCorrFlag: semiAnnualCorrFlag, &fbb)
    GEOStatus_Full.add(objectStatus: objectStatus, &fbb)
    GEOStatus_Full.add(rawFileUri: rawFileUri, &fbb)
    GEOStatus_Full.add(createdAt: createdAt, &fbb)
    GEOStatus_Full.add(createdBy: createdBy, &fbb)
    GEOStatus_Full.add(updatedAt: updatedAt, &fbb)
    GEOStatus_Full.add(updatedBy: updatedBy, &fbb)
    GEOStatus_Full.add(source: source, &fbb)
    GEOStatus_Full.add(origin: origin, &fbb)
    GEOStatus_Full.add(dataMode: dataMode, &fbb)
    GEOStatus_Full.add(onOrbit: onOrbit, &fbb)
    GEOStatus_Full.add(satNo: satNo, &fbb)
    GEOStatus_Full.add(origNetwork: origNetwork, &fbb)
    return GEOStatus_Full.endGEOStatus_Full(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: GEOStatus_Full_dataMode_Enum.self)
