...
public struct PersonnelRecoveryEnemyData_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: PersonnelRecoveryEnemyData_Abridged.id, addPrefix: prefix) }
  ...
  public static func startPersonnelRecoveryEnemyData_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endPersonnelRecoveryEnemyData_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createPersonnelRecoveryEnemyData_Abridged(
    ...
    let __start = PersonnelRecoveryEnemyData_Abridged.startPersonnelRecoveryEnemyData_Abridged(&fbb)
    PersonnelRecoveryEnemyData_Abridged.add(dirToEnemy: dirToEnemy, &fbb)
    PersonnelRecoveryEnemyData_Abridged.add(hostileFireType: hostileFireType, &fbb)
    PersonnelRecoveryEnemyData_Abridged.add(friendliesRemarks: friendliesRemarks, &fbb)
    PersonnelRecoveryEnemyData_Abridged.add(hlzRemarks: hlzRemarks, &fbb)
    return PersonnelRecoveryEnemyData_Abridged.endPersonnelRecoveryEnemyData_Abridged(&fbb, start: __start)
  }
