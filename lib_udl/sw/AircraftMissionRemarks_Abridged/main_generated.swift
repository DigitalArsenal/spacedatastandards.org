...
public struct AircraftMissionRemarks_Abridged: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: AircraftMissionRemarks_Abridged.id, addPrefix: prefix) }
  ...
  public static func startAircraftMissionRemarks_Abridged(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 6) }
  ...
  public static func endAircraftMissionRemarks_Abridged(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createAircraftMissionRemarks_Abridged(
    ...
    let __start = AircraftMissionRemarks_Abridged.startAircraftMissionRemarks_Abridged(&fbb)
    AircraftMissionRemarks_Abridged.add(gdssRemarkId: gdssRemarkId, &fbb)
    AircraftMissionRemarks_Abridged.add(type: type, &fbb)
    AircraftMissionRemarks_Abridged.add(text: text, &fbb)
    AircraftMissionRemarks_Abridged.add(date: date, &fbb)
    AircraftMissionRemarks_Abridged.add(user: user, &fbb)
    AircraftMissionRemarks_Abridged.add(itineraryNum: itineraryNum, &fbb)
    return AircraftMissionRemarks_Abridged.endAircraftMissionRemarks_Abridged(&fbb, start: __start)
  }
