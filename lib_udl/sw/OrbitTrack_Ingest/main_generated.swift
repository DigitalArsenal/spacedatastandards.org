...
public enum OrbitTrack_Ingest_objIdent_Enum: Int8, Enum, Verifiable {
  ...
  public static var max: OrbitTrack_Ingest_objIdent_Enum { return .unknown }
  public static var min: OrbitTrack_Ingest_objIdent_Enum { return .assumedFriend }
}


public enum OrbitTrack_Ingest_objectType_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: OrbitTrack_Ingest_objectType_Enum { return .unknown }
  public static var min: OrbitTrack_Ingest_objectType_Enum { return .debris }
}


public enum OrbitTrack_Ingest_dataMode_Enum: Int8, Enum, Verifiable {
  public typealias T = Int8
  public static var byteSize: Int { return MemoryLayout<Int8>.size }
  public var value: Int8 { return self.rawValue }
  ...
  public static var max: OrbitTrack_Ingest_dataMode_Enum { return .exercise }
  public static var min: OrbitTrack_Ingest_dataMode_Enum { return .real }
}
...
public struct OrbitTrack_Ingest: FlatBufferObject, Verifiable {
  ...
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: OrbitTrack_Ingest.id, addPrefix: prefix) }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 32
  public var objIdent: OrbitTrack_Ingest_objIdent_Enum { let o = _accessor.offset(VTOFFSET.objIdent.v); return o == 0 ? .assumedFriend : OrbitTrack_Ingest_objIdent_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .assumedFriend }
  ...
  ///  Constraints: Minimum length = 0, Maximum length = 32
  public var objectType: OrbitTrack_Ingest_objectType_Enum { let o = _accessor.offset(VTOFFSET.objectType.v); return o == 0 ? .debris : OrbitTrack_Ingest_objectType_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .debris }
  ...
  public var dataMode: OrbitTrack_Ingest_dataMode_Enum { let o = _accessor.offset(VTOFFSET.dataMode.v); return o == 0 ? .real : OrbitTrack_Ingest_dataMode_Enum(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .real }
  ///  The originating source network on which this record was created, auto-populated by the system.
  ///  Example: /// Example: ORIG
  ///  Constraints: Minimum length = 1, Maximum length = 32
  public var origNetwork: String? { let o = _accessor.offset(VTOFFSET.origNetwork.v); return o == 0 ? nil : _accessor.string(at: o) }
  public var origNetworkSegmentArray: [UInt8]? { return _accessor.getVector(at: VTOFFSET.origNetwork.v) }
  public static func startOrbitTrack_Ingest(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 45) }
  ...
  public static func add(objIdent: OrbitTrack_Ingest_objIdent_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: objIdent.rawValue, def: 0, at: VTOFFSET.objIdent.p) }
  ...
  public static func add(objectType: OrbitTrack_Ingest_objectType_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: objectType.rawValue, def: 0, at: VTOFFSET.objectType.p) }
  ...
  public static func add(dataMode: OrbitTrack_Ingest_dataMode_Enum, _ fbb: inout FlatBufferBuilder) { fbb.add(element: dataMode.rawValue, def: 0, at: VTOFFSET.dataMode.p) }
  public static func add(origNetwork: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: origNetwork, at: VTOFFSET.origNetwork.p) }
  public static func endOrbitTrack_Ingest(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOrbitTrack_Ingest(
    ...
    objIdent: OrbitTrack_Ingest_objIdent_Enum = .assumedFriend,
    ...
    let __start = OrbitTrack_Ingest.startOrbitTrack_Ingest(&fbb)
    OrbitTrack_Ingest.add(id: id, &fbb)
    OrbitTrack_Ingest.add(classificationMarking: classificationMarking, &fbb)
    OrbitTrack_Ingest.add(idOnOrbit: idOnOrbit, &fbb)
    OrbitTrack_Ingest.add(satNo: satNo, &fbb)
    OrbitTrack_Ingest.add(origObjectId: origObjectId, &fbb)
    OrbitTrack_Ingest.add(idElset: idElset, &fbb)
    OrbitTrack_Ingest.add(ts: ts, &fbb)
    OrbitTrack_Ingest.add(lat: lat, &fbb)
    OrbitTrack_Ingest.add(lon: lon, &fbb)
    OrbitTrack_Ingest.add(alt: alt, &fbb)
    OrbitTrack_Ingest.add(rdfRf: rdfRf, &fbb)
    OrbitTrack_Ingest.add(callSign: callSign, &fbb)
    OrbitTrack_Ingest.add(rptNum: rptNum, &fbb)
    OrbitTrack_Ingest.add(objIdent: objIdent, &fbb)
    OrbitTrack_Ingest.add(identAmp: identAmp, &fbb)
    OrbitTrack_Ingest.add(satStatus: satStatus, &fbb)
    OrbitTrack_Ingest.add(objectType: objectType, &fbb)
    OrbitTrack_Ingest.add(countryCode: countryCode, &fbb)
    OrbitTrack_Ingest.add(decay: decay, &fbb)
    OrbitTrack_Ingest.add(charlieLine: charlieLine, &fbb)
    OrbitTrack_Ingest.add(aouType: aouType, &fbb)
    OrbitTrack_Ingest.addVectorOf(aouData: aouData, &fbb)
    OrbitTrack_Ingest.add(spd: spd, &fbb)
    OrbitTrack_Ingest.add(angElev: angElev, &fbb)
    OrbitTrack_Ingest.add(cntnmnt: cntnmnt, &fbb)
    OrbitTrack_Ingest.add(xref: xref, &fbb)
    OrbitTrack_Ingest.add(chXref: chXref, &fbb)
    OrbitTrack_Ingest.add(amplification: amplification, &fbb)
    OrbitTrack_Ingest.add(iff: iff, &fbb)
    OrbitTrack_Ingest.add(reinforced: reinforced, &fbb)
    OrbitTrack_Ingest.add(reduced: reduced, &fbb)
    OrbitTrack_Ingest.add(hq: hq, &fbb)
    OrbitTrack_Ingest.add(dummy: dummy, &fbb)
    OrbitTrack_Ingest.add(taskForce: taskForce, &fbb)
    OrbitTrack_Ingest.add(feint: feint, &fbb)
    OrbitTrack_Ingest.add(installation: installation, &fbb)
    OrbitTrack_Ingest.add(vehType: vehType, &fbb)
    OrbitTrack_Ingest.add(trkId: trkId, &fbb)
    OrbitTrack_Ingest.addVectorOf(trackSensors: trackSensors, &fbb)
    OrbitTrack_Ingest.add(createdAt: createdAt, &fbb)
    OrbitTrack_Ingest.add(createdBy: createdBy, &fbb)
    OrbitTrack_Ingest.add(source: source, &fbb)
    OrbitTrack_Ingest.add(origin: origin, &fbb)
    OrbitTrack_Ingest.add(dataMode: dataMode, &fbb)
    OrbitTrack_Ingest.add(origNetwork: origNetwork, &fbb)
    return OrbitTrack_Ingest.endOrbitTrack_Ingest(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.objIdent.p, fieldName: "objIdent", required: false, type: OrbitTrack_Ingest_objIdent_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.objectType.p, fieldName: "objectType", required: false, type: OrbitTrack_Ingest_objectType_Enum.self)
    ...
    try _v.visit(field: VTOFFSET.dataMode.p, fieldName: "dataMode", required: false, type: OrbitTrack_Ingest_dataMode_Enum.self)
