...
public struct OnorbitBattery_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static OnorbitBattery_Full GetRootAsOnorbitBattery_Full(ByteBuffer _bb, OnorbitBattery_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OnorbitBattery_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONOR"); }
  public static bool VerifyOnorbitBattery_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONOR", false, OnorbitBattery_FullVerify.Verify); }
  ...
  public OnorbitBattery_Full_dataMode_Enum DataMode { get { int o = __p.__offset(26); return o != 0 ? (OnorbitBattery_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OnorbitBattery_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<OnorbitBattery_Full> CreateOnorbitBattery_Full(FlatBufferBuilder builder,
      ...
      OnorbitBattery_Full_dataMode_Enum dataMode = OnorbitBattery_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OnorbitBattery_Full_dataMode_Enum dataMode) { builder.AddSbyte(11, (sbyte)dataMode, 0); }
  ...
  public static Offset<OnorbitBattery_Full> EndOnorbitBattery_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OnorbitBattery_Full>(o);
  }
  public static void FinishOnorbitBattery_FullBuffer(FlatBufferBuilder builder, Offset<OnorbitBattery_Full> offset) { builder.Finish(offset.Value, "ONOR"); }
  public static void FinishSizePrefixedOnorbitBattery_FullBuffer(FlatBufferBuilder builder, Offset<OnorbitBattery_Full> offset) { builder.FinishSizePrefixed(offset.Value, "ONOR"); }
  public OnorbitBattery_FullT UnPack() {
    var _o = new OnorbitBattery_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OnorbitBattery_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OnorbitBattery_Full> Pack(FlatBufferBuilder builder, OnorbitBattery_FullT _o) {
    if (_o == null) return default(Offset<OnorbitBattery_Full>);
    ...
    return CreateOnorbitBattery_Full(
      builder,
      _id,
      _idOnOrbit,
      _idBattery,
...
public class OnorbitBattery_FullT
{
  ...
  public OnorbitBattery_Full_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }
  public string Battery { get; set; }

  public OnorbitBattery_FullT() {
    this.Id = null;
    this.IdOnOrbit = null;
    this.IdBattery = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = OnorbitBattery_Full_dataMode_Enum.REAL;
    this.OrigNetwork = null;
    this.Battery = null;
  }
  public static OnorbitBattery_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return OnorbitBattery_Full.GetRootAsOnorbitBattery_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OnorbitBattery_Full.FinishOnorbitBattery_FullBuffer(fbb, OnorbitBattery_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OnorbitBattery_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 26 /*DataMode*/, 1 /*OnorbitBattery_Full_dataMode_Enum*/, 1, false)
