...
public struct AirTransportMission_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirTransportMission_Ingest GetRootAsAirTransportMission_Ingest(ByteBuffer _bb) { return GetRootAsAirTransportMission_Ingest(_bb, new AirTransportMission_Ingest()); }
  public static AirTransportMission_Ingest GetRootAsAirTransportMission_Ingest(ByteBuffer _bb, AirTransportMission_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirTransportMission_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRT"); }
  public static bool VerifyAirTransportMission_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRT", false, AirTransportMission_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirTransportMission_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public AirTransportMission_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(70); return o != 0 ? (AirTransportMission_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirTransportMission_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<AirTransportMission_Ingest> CreateAirTransportMission_Ingest(FlatBufferBuilder builder,
      ...
      AirTransportMission_Ingest_dataMode_Enum dataMode = AirTransportMission_Ingest_dataMode_Enum.REAL,
  ...
  public static void StartAirTransportMission_Ingest(FlatBufferBuilder builder) { builder.StartTable(38); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AirTransportMission_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(33, (sbyte)dataMode, 0); }
  ...
  public static Offset<AirTransportMission_Ingest> EndAirTransportMission_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirTransportMission_Ingest>(o);
  }
  public static void FinishAirTransportMission_IngestBuffer(FlatBufferBuilder builder, Offset<AirTransportMission_Ingest> offset) { builder.Finish(offset.Value, "AIRT"); }
  public static void FinishSizePrefixedAirTransportMission_IngestBuffer(FlatBufferBuilder builder, Offset<AirTransportMission_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AIRT"); }
  public AirTransportMission_IngestT UnPack() {
    var _o = new AirTransportMission_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirTransportMission_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AirTransportMission_Ingest> Pack(FlatBufferBuilder builder, AirTransportMission_IngestT _o) {
    if (_o == null) return default(Offset<AirTransportMission_Ingest>);
...
public class AirTransportMission_IngestT
{
  ...
  public AirTransportMission_Ingest_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }
  public List<string> Requirements { get; set; }
  public List<string> Remarks { get; set; }
  public List<string> HazMat { get; set; }

  public AirTransportMission_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = AirTransportMission_Ingest_dataMode_Enum.REAL;
    this.OrigNetwork = null;
    this.Requirements = null;
    this.Remarks = null;
    this.HazMat = null;
  }
  public static AirTransportMission_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AirTransportMission_Ingest.GetRootAsAirTransportMission_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirTransportMission_Ingest.FinishAirTransportMission_IngestBuffer(fbb, AirTransportMission_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirTransportMission_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 70 /*DataMode*/, 1 /*AirTransportMission_Ingest_dataMode_Enum*/, 1, false)
