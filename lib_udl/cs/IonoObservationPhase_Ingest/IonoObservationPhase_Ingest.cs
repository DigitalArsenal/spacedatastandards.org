...
public struct IonoObservationPhase_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationPhase_Ingest GetRootAsIonoObservationPhase_Ingest(ByteBuffer _bb) { return GetRootAsIonoObservationPhase_Ingest(_bb, new IonoObservationPhase_Ingest()); }
  public static IonoObservationPhase_Ingest GetRootAsIonoObservationPhase_Ingest(ByteBuffer _bb, IonoObservationPhase_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationPhase_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationPhase_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationPhase_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationPhase_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationPhase_Ingest> CreateIonoObservationPhase_Ingest(FlatBufferBuilder builder,
  ...
  public static void StartIonoObservationPhase_Ingest(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationPhase_Ingest> EndIonoObservationPhase_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationPhase_Ingest>(o);
  }
  public static void FinishIonoObservationPhase_IngestBuffer(FlatBufferBuilder builder, Offset<IonoObservationPhase_Ingest> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationPhase_IngestBuffer(FlatBufferBuilder builder, Offset<IonoObservationPhase_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationPhase_IngestT UnPack() {
    var _o = new IonoObservationPhase_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationPhase_IngestT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationPhase_Ingest> Pack(FlatBufferBuilder builder, IonoObservationPhase_IngestT _o) {
    if (_o == null) return default(Offset<IonoObservationPhase_Ingest>);
...
public class IonoObservationPhase_IngestT
{
  ...
  public IonoObservationPhase_IngestT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationPhase_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationPhase_Ingest.GetRootAsIonoObservationPhase_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationPhase_Ingest.FinishIonoObservationPhase_IngestBuffer(fbb, IonoObservationPhase_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationPhase_IngestVerify
{
