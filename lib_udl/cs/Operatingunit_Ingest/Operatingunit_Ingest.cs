...
public struct Operatingunit_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Operatingunit_Ingest GetRootAsOperatingunit_Ingest(ByteBuffer _bb) { return GetRootAsOperatingunit_Ingest(_bb, new Operatingunit_Ingest()); }
  public static Operatingunit_Ingest GetRootAsOperatingunit_Ingest(ByteBuffer _bb, Operatingunit_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Operatingunit_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "OPER"); }
  public static bool VerifyOperatingunit_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("OPER", false, Operatingunit_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Operatingunit_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public Operatingunit_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(122); return o != 0 ? (Operatingunit_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Operatingunit_Ingest_dataMode_Enum.REAL; } }

  public static Offset<Operatingunit_Ingest> CreateOperatingunit_Ingest(FlatBufferBuilder builder,
      ...
      Operatingunit_Ingest_dataMode_Enum dataMode = Operatingunit_Ingest_dataMode_Enum.REAL) {
    builder.StartTable(60);
    Operatingunit_Ingest.AddGeoidalMslSep(builder, geoidalMslSep);
    Operatingunit_Ingest.AddElevMslDerivAcc(builder, elevMslDerivAcc);
    Operatingunit_Ingest.AddElevMsl(builder, elevMsl);
    Operatingunit_Ingest.AddLon(builder, lon);
    Operatingunit_Ingest.AddLat(builder, lat);
    Operatingunit_Ingest.AddCoordDerivAcc(builder, coordDerivAcc);
    Operatingunit_Ingest.AddOrigin(builder, originOffset);
    Operatingunit_Ingest.AddSource(builder, sourceOffset);
    Operatingunit_Ingest.AddCreatedBy(builder, createdByOffset);
    Operatingunit_Ingest.AddCreatedAt(builder, createdAtOffset);
    Operatingunit_Ingest.AddReferenceDoc(builder, referenceDocOffset);
    Operatingunit_Ingest.AddResProd(builder, resProdOffset);
    Operatingunit_Ingest.AddReviewDate(builder, reviewDateOffset);
    Operatingunit_Ingest.AddRecStatus(builder, recStatusOffset);
    Operatingunit_Ingest.AddClassRating(builder, classRatingOffset);
    Operatingunit_Ingest.AddSymCode(builder, symCodeOffset);
    Operatingunit_Ingest.AddPolSubdiv(builder, polSubdivOffset);
    Operatingunit_Ingest.AddAirDefArea(builder, airDefAreaOffset);
    Operatingunit_Ingest.AddUtm(builder, utmOffset);
    Operatingunit_Ingest.AddMilGrid(builder, milGridOffset);
    Operatingunit_Ingest.AddMilGridSys(builder, milGridSysOffset);
    Operatingunit_Ingest.AddElevMslConfLvl(builder, elevMslConfLvl);
    Operatingunit_Ingest.AddCoord(builder, coordOffset);
    Operatingunit_Ingest.AddCoordDatum(builder, coordDatumOffset);
    Operatingunit_Ingest.AddFlagFlown(builder, flagFlownOffset);
    Operatingunit_Ingest.AddDeployStatus(builder, deployStatusOffset);
    Operatingunit_Ingest.AddFleetId(builder, fleetIdOffset);
    Operatingunit_Ingest.AddEchelonTier(builder, echelonTierOffset);
    Operatingunit_Ingest.AddEchelon(builder, echelonOffset);
    Operatingunit_Ingest.AddDivCat(builder, divCatOffset);
    Operatingunit_Ingest.AddMsnPrimarySpecialty(builder, msnPrimarySpecialtyOffset);
    Operatingunit_Ingest.AddMsnPrimary(builder, msnPrimaryOffset);
    Operatingunit_Ingest.AddFunctRole(builder, functRoleOffset);
    Operatingunit_Ingest.AddForceName(builder, forceNameOffset);
    Operatingunit_Ingest.AddForce(builder, forceOffset);
    Operatingunit_Ingest.AddLocReason(builder, locReasonOffset);
    Operatingunit_Ingest.AddLocName(builder, locNameOffset);
    Operatingunit_Ingest.AddAltAllegiance(builder, altAllegianceOffset);
    Operatingunit_Ingest.AddAllegiance(builder, allegianceOffset);
    Operatingunit_Ingest.AddIdent(builder, identOffset);
    Operatingunit_Ingest.AddFpa(builder, fpaOffset);
    Operatingunit_Ingest.AddEval(builder, eval);
    Operatingunit_Ingest.AddConditionAvail(builder, conditionAvailOffset);
    Operatingunit_Ingest.AddCondition(builder, conditionOffset);
    Operatingunit_Ingest.AddOperStatus(builder, operStatusOffset);
    Operatingunit_Ingest.AddWac(builder, wacOffset);
    Operatingunit_Ingest.AddAltCountryCode(builder, altCountryCodeOffset);
    Operatingunit_Ingest.AddCountryCode(builder, countryCodeOffset);
    Operatingunit_Ingest.AddUnitIdentifier(builder, unitIdentifierOffset);
    Operatingunit_Ingest.AddIdOrganization(builder, idOrganizationOffset);
    Operatingunit_Ingest.AddIdContact(builder, idContactOffset);
    Operatingunit_Ingest.AddIdLocation(builder, idLocationOffset);
    Operatingunit_Ingest.AddDescription(builder, descriptionOffset);
    Operatingunit_Ingest.AddName(builder, nameOffset);
    Operatingunit_Ingest.AddAltOperatingUnitId(builder, altOperatingUnitIdOffset);
    Operatingunit_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    Operatingunit_Ingest.AddIdOperatingUnit(builder, idOperatingUnitOffset);
    Operatingunit_Ingest.AddDataMode(builder, dataMode);
    Operatingunit_Ingest.AddStylizedUnit(builder, stylizedUnit);
    Operatingunit_Ingest.AddMasterUnit(builder, masterUnit);
    return Operatingunit_Ingest.EndOperatingunit_Ingest(builder);
  }

  public static void StartOperatingunit_Ingest(FlatBufferBuilder builder) { builder.StartTable(60); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Operatingunit_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(59, (sbyte)dataMode, 0); }
  public static Offset<Operatingunit_Ingest> EndOperatingunit_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Operatingunit_Ingest>(o);
  }
  public static void FinishOperatingunit_IngestBuffer(FlatBufferBuilder builder, Offset<Operatingunit_Ingest> offset) { builder.Finish(offset.Value, "OPER"); }
  public static void FinishSizePrefixedOperatingunit_IngestBuffer(FlatBufferBuilder builder, Offset<Operatingunit_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "OPER"); }
  public Operatingunit_IngestT UnPack() {
    var _o = new Operatingunit_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Operatingunit_IngestT _o) {
  ...
  public static Offset<Operatingunit_Ingest> Pack(FlatBufferBuilder builder, Operatingunit_IngestT _o) {
    if (_o == null) return default(Offset<Operatingunit_Ingest>);
    ...
    return CreateOperatingunit_Ingest(
      builder,
      _idOperatingUnit,
...
public class Operatingunit_IngestT
{
  ...
  public Operatingunit_Ingest_dataMode_Enum DataMode { get; set; }

  public Operatingunit_IngestT() {
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Operatingunit_Ingest_dataMode_Enum.REAL;
  }
  public static Operatingunit_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Operatingunit_Ingest.GetRootAsOperatingunit_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Operatingunit_Ingest.FinishOperatingunit_IngestBuffer(fbb, Operatingunit_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Operatingunit_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 122 /*DataMode*/, 1 /*Operatingunit_Ingest_dataMode_Enum*/, 1, false)
