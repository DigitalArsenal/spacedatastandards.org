...
public struct Stage_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Stage_Abridged GetRootAsStage_Abridged(ByteBuffer _bb) { return GetRootAsStage_Abridged(_bb, new Stage_Abridged()); }
  public static Stage_Abridged GetRootAsStage_Abridged(ByteBuffer _bb, Stage_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Stage_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "STAG"); }
  public static bool VerifyStage_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("STAG", false, Stage_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Stage_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Stage_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(80); return o != 0 ? (Stage_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Stage_Abridged_dataMode_Enum.REAL; } }

  public static Offset<Stage_Abridged> CreateStage_Abridged(FlatBufferBuilder builder,
      ...
      Stage_Abridged_dataMode_Enum dataMode = Stage_Abridged_dataMode_Enum.REAL) {
  ...
  public static void StartStage_Abridged(FlatBufferBuilder builder) { builder.StartTable(39); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Stage_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(38, (sbyte)dataMode, 0); }
  public static Offset<Stage_Abridged> EndStage_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Stage_Abridged>(o);
  }
  public static void FinishStage_AbridgedBuffer(FlatBufferBuilder builder, Offset<Stage_Abridged> offset) { builder.Finish(offset.Value, "STAG"); }
  public static void FinishSizePrefixedStage_AbridgedBuffer(FlatBufferBuilder builder, Offset<Stage_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "STAG"); }
  public Stage_AbridgedT UnPack() {
    var _o = new Stage_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Stage_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Stage_Abridged> Pack(FlatBufferBuilder builder, Stage_AbridgedT _o) {
    if (_o == null) return default(Offset<Stage_Abridged>);
...
public class Stage_AbridgedT
{
  ...
  public Stage_Abridged_dataMode_Enum DataMode { get; set; }

  public Stage_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = Stage_Abridged_dataMode_Enum.REAL;
  }
  public static Stage_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Stage_Abridged.GetRootAsStage_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Stage_Abridged.FinishStage_AbridgedBuffer(fbb, Stage_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Stage_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 80 /*DataMode*/, 1 /*Stage_Abridged_dataMode_Enum*/, 1, false)
