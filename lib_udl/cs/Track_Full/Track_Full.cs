...
public struct Track_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Track_Full GetRootAsTrack_Full(ByteBuffer _bb) { return GetRootAsTrack_Full(_bb, new Track_Full()); }
  public static Track_Full GetRootAsTrack_Full(ByteBuffer _bb, Track_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Track_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "TRAC"); }
  public static bool VerifyTrack_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("TRAC", false, Track_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Track_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public Track_Full_dataMode_Enum DataMode { get { int o = __p.__offset(136); return o != 0 ? (Track_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Track_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<Track_Full> CreateTrack_Full(FlatBufferBuilder builder,
      ...
      Track_Full_dataMode_Enum dataMode = Track_Full_dataMode_Enum.REAL,
  ...
  public static void StartTrack_Full(FlatBufferBuilder builder) { builder.StartTable(68); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Track_Full_dataMode_Enum dataMode) { builder.AddSbyte(66, (sbyte)dataMode, 0); }
  ...
  public static Offset<Track_Full> EndTrack_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Track_Full>(o);
  }
  public static void FinishTrack_FullBuffer(FlatBufferBuilder builder, Offset<Track_Full> offset) { builder.Finish(offset.Value, "TRAC"); }
  public static void FinishSizePrefixedTrack_FullBuffer(FlatBufferBuilder builder, Offset<Track_Full> offset) { builder.FinishSizePrefixed(offset.Value, "TRAC"); }
  public Track_FullT UnPack() {
    var _o = new Track_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Track_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Track_Full> Pack(FlatBufferBuilder builder, Track_FullT _o) {
    if (_o == null) return default(Offset<Track_Full>);
...
public class Track_FullT
{
  ...
  public Track_Full_dataMode_Enum DataMode { get; set; }
  ...
  public Track_FullT() {
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Track_Full_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static Track_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Track_Full.GetRootAsTrack_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Track_Full.FinishTrack_FullBuffer(fbb, Track_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Track_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 136 /*DataMode*/, 1 /*Track_Full_dataMode_Enum*/, 1, false)
