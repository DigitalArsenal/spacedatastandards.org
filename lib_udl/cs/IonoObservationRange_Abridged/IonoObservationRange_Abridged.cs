...
public struct IonoObservationRange_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationRange_Abridged GetRootAsIonoObservationRange_Abridged(ByteBuffer _bb) { return GetRootAsIonoObservationRange_Abridged(_bb, new IonoObservationRange_Abridged()); }
  public static IonoObservationRange_Abridged GetRootAsIonoObservationRange_Abridged(ByteBuffer _bb, IonoObservationRange_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationRange_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationRange_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationRange_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationRange_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationRange_Abridged> CreateIonoObservationRange_Abridged(FlatBufferBuilder builder,
    ...
    IonoObservationRange_Abridged.AddData(builder, dataOffset);
    IonoObservationRange_Abridged.AddDimensionName(builder, dimensionNameOffset);
    IonoObservationRange_Abridged.AddDimensions(builder, dimensionsOffset);
    IonoObservationRange_Abridged.AddNotes(builder, notesOffset);
    return IonoObservationRange_Abridged.EndIonoObservationRange_Abridged(builder);
  }

  public static void StartIonoObservationRange_Abridged(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationRange_Abridged> EndIonoObservationRange_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationRange_Abridged>(o);
  }
  public static void FinishIonoObservationRange_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationRange_Abridged> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationRange_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationRange_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationRange_AbridgedT UnPack() {
    var _o = new IonoObservationRange_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationRange_AbridgedT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationRange_Abridged> Pack(FlatBufferBuilder builder, IonoObservationRange_AbridgedT _o) {
    if (_o == null) return default(Offset<IonoObservationRange_Abridged>);
    ...
    return CreateIonoObservationRange_Abridged(
      builder,
      _notes,
      _dimensions,
      _dimensionName,
...
public class IonoObservationRange_AbridgedT
{
  ...
  public IonoObservationRange_AbridgedT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationRange_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationRange_Abridged.GetRootAsIonoObservationRange_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationRange_Abridged.FinishIonoObservationRange_AbridgedBuffer(fbb, IonoObservationRange_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationRange_AbridgedVerify
{
