...
public struct DataLinkVoiceCoord_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static DataLinkVoiceCoord_Full GetRootAsDataLinkVoiceCoord_Full(ByteBuffer _bb, DataLinkVoiceCoord_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DataLinkVoiceCoord_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DATA"); }
  public static bool VerifyDataLinkVoiceCoord_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DATA", false, DataLinkVoiceCoord_FullVerify.Verify); }
  ...
  public static Offset<DataLinkVoiceCoord_Full> CreateDataLinkVoiceCoord_Full(FlatBufferBuilder builder,
  ...
  public static Offset<DataLinkVoiceCoord_Full> EndDataLinkVoiceCoord_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DataLinkVoiceCoord_Full>(o);
  }
  public static void FinishDataLinkVoiceCoord_FullBuffer(FlatBufferBuilder builder, Offset<DataLinkVoiceCoord_Full> offset) { builder.Finish(offset.Value, "DATA"); }
  public static void FinishSizePrefixedDataLinkVoiceCoord_FullBuffer(FlatBufferBuilder builder, Offset<DataLinkVoiceCoord_Full> offset) { builder.FinishSizePrefixed(offset.Value, "DATA"); }
  public DataLinkVoiceCoord_FullT UnPack() {
    var _o = new DataLinkVoiceCoord_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DataLinkVoiceCoord_FullT _o) {
  ...
  public static Offset<DataLinkVoiceCoord_Full> Pack(FlatBufferBuilder builder, DataLinkVoiceCoord_FullT _o) {
    if (_o == null) return default(Offset<DataLinkVoiceCoord_Full>);
...
public class DataLinkVoiceCoord_FullT
{
  ...
  public DataLinkVoiceCoord_FullT() {
    this.VoiceNetDes = null;
    this.FreqDes = null;
    this.CommPri = null;
    this.TeleFreqNums = null;
  }
  public static DataLinkVoiceCoord_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return DataLinkVoiceCoord_Full.GetRootAsDataLinkVoiceCoord_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DataLinkVoiceCoord_Full.FinishDataLinkVoiceCoord_FullBuffer(fbb, DataLinkVoiceCoord_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DataLinkVoiceCoord_FullVerify
{
