...
public struct PassiveRadarObservation_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static PassiveRadarObservation_Abridged GetRootAsPassiveRadarObservation_Abridged(ByteBuffer _bb, PassiveRadarObservation_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool PassiveRadarObservation_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "PASS"); }
  public static bool VerifyPassiveRadarObservation_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("PASS", false, PassiveRadarObservation_AbridgedVerify.Verify); }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string TransactionId { get { int o = __p.__offset(116); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTransactionIdBytes() { return __p.__vector_as_span<byte>(116, 1); }
#else
  public ArraySegment<byte>? GetTransactionIdBytes() { return __p.__vector_as_arraysegment(116); }
#endif
  public byte[] GetTransactionIdArray() { return __p.__vector_as_array<byte>(116); }
  ...
  /// Constraints: No constraints specified.
  public string CreatedAt { get { int o = __p.__offset(120); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedAtBytes() { return __p.__vector_as_span<byte>(120, 1); }
#else
  public ArraySegment<byte>? GetCreatedAtBytes() { return __p.__vector_as_arraysegment(120); }
#endif
  public byte[] GetCreatedAtArray() { return __p.__vector_as_array<byte>(120); }
  /// Application user who created the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string CreatedBy { get { int o = __p.__offset(122); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedByBytes() { return __p.__vector_as_span<byte>(122, 1); }
#else
  public ArraySegment<byte>? GetCreatedByBytes() { return __p.__vector_as_arraysegment(122); }
#endif
  public byte[] GetCreatedByArray() { return __p.__vector_as_array<byte>(122); }
  /// Source of the data.
  ...
  public string OrigNetwork { get { int o = __p.__offset(128); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOrigNetworkBytes() { return __p.__vector_as_span<byte>(128, 1); }
#else
  public ArraySegment<byte>? GetOrigNetworkBytes() { return __p.__vector_as_arraysegment(128); }
#endif
  public byte[] GetOrigNetworkArray() { return __p.__vector_as_array<byte>(128); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public PassiveRadarObservation_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(132); return o != 0 ? (PassiveRadarObservation_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : PassiveRadarObservation_Abridged_dataMode_Enum.REAL; } }
  /// Read only enumeration specifying the type of observation (e.g. OPTICAL, RADAR, RF, etc).
  /// Example: /// Example: RADAR
  /// Constraints: No constraints specified.
  public string Type { get { int o = __p.__offset(134); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTypeBytes() { return __p.__vector_as_span<byte>(134, 1); }
#else
  public ArraySegment<byte>? GetTypeBytes() { return __p.__vector_as_arraysegment(134); }
#endif
  public byte[] GetTypeArray() { return __p.__vector_as_array<byte>(134); }

  public static Offset<PassiveRadarObservation_Abridged> CreatePassiveRadarObservation_Abridged(FlatBufferBuilder builder,
      ...
      PassiveRadarObservation_Abridged_dataMode_Enum dataMode = PassiveRadarObservation_Abridged_dataMode_Enum.REAL,
  ...
  public static void AddTransactionId(FlatBufferBuilder builder, StringOffset transactionIdOffset) { builder.AddOffset(56, transactionIdOffset.Value, 0); }
  ...
  public static void AddCreatedAt(FlatBufferBuilder builder, StringOffset createdAtOffset) { builder.AddOffset(58, createdAtOffset.Value, 0); }
  public static void AddCreatedBy(FlatBufferBuilder builder, StringOffset createdByOffset) { builder.AddOffset(59, createdByOffset.Value, 0); }
  ...
  public static void AddOrigNetwork(FlatBufferBuilder builder, StringOffset origNetworkOffset) { builder.AddOffset(62, origNetworkOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, PassiveRadarObservation_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(64, (sbyte)dataMode, 0); }
  public static void AddType(FlatBufferBuilder builder, StringOffset typeOffset) { builder.AddOffset(65, typeOffset.Value, 0); }
  public static Offset<PassiveRadarObservation_Abridged> EndPassiveRadarObservation_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PassiveRadarObservation_Abridged>(o);
  }
  public static void FinishPassiveRadarObservation_AbridgedBuffer(FlatBufferBuilder builder, Offset<PassiveRadarObservation_Abridged> offset) { builder.Finish(offset.Value, "PASS"); }
  public static void FinishSizePrefixedPassiveRadarObservation_AbridgedBuffer(FlatBufferBuilder builder, Offset<PassiveRadarObservation_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "PASS"); }
  public PassiveRadarObservation_AbridgedT UnPack() {
    var _o = new PassiveRadarObservation_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(PassiveRadarObservation_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<PassiveRadarObservation_Abridged> Pack(FlatBufferBuilder builder, PassiveRadarObservation_AbridgedT _o) {
    if (_o == null) return default(Offset<PassiveRadarObservation_Abridged>);
...
public class PassiveRadarObservation_AbridgedT
{
  ...
  public PassiveRadarObservation_Abridged_dataMode_Enum DataMode { get; set; }
  public string Type { get; set; }

  public PassiveRadarObservation_AbridgedT() {
    this.Id = null;
    ...
    this.SourceDL = null;
    this.DataMode = PassiveRadarObservation_Abridged_dataMode_Enum.REAL;
    this.Type = null;
  }
  public static PassiveRadarObservation_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return PassiveRadarObservation_Abridged.GetRootAsPassiveRadarObservation_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    PassiveRadarObservation_Abridged.FinishPassiveRadarObservation_AbridgedBuffer(fbb, PassiveRadarObservation_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class PassiveRadarObservation_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyString(tablePos, 116 /*TransactionId*/, false)
      && verifier.VerifyString(tablePos, 118 /*Descriptor*/, false)
      && verifier.VerifyString(tablePos, 120 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 122 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 124 /*Source*/, false)
      && verifier.VerifyString(tablePos, 126 /*Origin*/, false)
      && verifier.VerifyString(tablePos, 128 /*OrigNetwork*/, false)
      && verifier.VerifyString(tablePos, 130 /*SourceDL*/, false)
      && verifier.VerifyField(tablePos, 132 /*DataMode*/, 1 /*PassiveRadarObservation_Abridged_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 134 /*Type*/, false)
