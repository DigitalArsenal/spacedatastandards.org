...
public struct CollectResponse_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static CollectResponse_Full GetRootAsCollectResponse_Full(ByteBuffer _bb, CollectResponse_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool CollectResponse_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "COLL"); }
  public static bool VerifyCollectResponse_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("COLL", false, CollectResponse_FullVerify.Verify); }
  ...
  /// Constraints: No constraints specified.
  public string OnOrbit { get { int o = __p.__offset(16); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbitBytes() { return __p.__vector_as_span<byte>(16, 1); }
#else
  public ArraySegment<byte>? GetOnOrbitBytes() { return __p.__vector_as_arraysegment(16); }
#endif
  public byte[] GetOnOrbitArray() { return __p.__vector_as_array<byte>(16); }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string IdPlan { get { int o = __p.__offset(20); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetIdPlanBytes() { return __p.__vector_as_span<byte>(20, 1); }
#else
  public ArraySegment<byte>? GetIdPlanBytes() { return __p.__vector_as_arraysegment(20); }
#endif
  public byte[] GetIdPlanArray() { return __p.__vector_as_array<byte>(20); }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string Status { get { int o = __p.__offset(24); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetStatusBytes() { return __p.__vector_as_span<byte>(24, 1); }
#else
  public ArraySegment<byte>? GetStatusBytes() { return __p.__vector_as_arraysegment(24); }
#endif
  public byte[] GetStatusArray() { return __p.__vector_as_array<byte>(24); }
  /// The actual start time of the collect or contact, in ISO 8601 UTC format.
  /// Example: /// Example: 2018-01-01T16:00:00.123456Z
  /// Constraints: No constraints specified.
  public string ActualStartTime { get { int o = __p.__offset(26); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetActualStartTimeBytes() { return __p.__vector_as_span<byte>(26, 1); }
#else
  public ArraySegment<byte>? GetActualStartTimeBytes() { return __p.__vector_as_arraysegment(26); }
#endif
  public byte[] GetActualStartTimeArray() { return __p.__vector_as_array<byte>(26); }
  /// The actual end time of the collect or contact, in ISO 8601 UTC format.
  /// Example: /// Example: 2018-01-01T18:00:00.123456Z
  /// Constraints: No constraints specified.
  public string ActualEndTime { get { int o = __p.__offset(28); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetActualEndTimeBytes() { return __p.__vector_as_span<byte>(28, 1); }
#else
  public ArraySegment<byte>? GetActualEndTimeBytes() { return __p.__vector_as_arraysegment(28); }
#endif
  public byte[] GetActualEndTimeArray() { return __p.__vector_as_array<byte>(28); }
  /// Proposed alternative start time, in ISO 8601 UTC format.
  /// Example: /// Example: 2018-01-01T16:00:00.123456Z
  /// Constraints: No constraints specified.
  public string AltStartTime { get { int o = __p.__offset(30); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAltStartTimeBytes() { return __p.__vector_as_span<byte>(30, 1); }
#else
  public ArraySegment<byte>? GetAltStartTimeBytes() { return __p.__vector_as_arraysegment(30); }
#endif
  public byte[] GetAltStartTimeArray() { return __p.__vector_as_array<byte>(30); }
  /// Proposed alternative end time, in ISO 8601 UTC format.
  /// Example: /// Example: 2018-01-01T18:00:00.123456Z
  /// Constraints: No constraints specified.
  public string AltEndTime { get { int o = __p.__offset(32); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAltEndTimeBytes() { return __p.__vector_as_span<byte>(32, 1); }
#else
  public ArraySegment<byte>? GetAltEndTimeBytes() { return __p.__vector_as_arraysegment(32); }
#endif
  public byte[] GetAltEndTimeArray() { return __p.__vector_as_array<byte>(32); }
  /// Error code associated with this request/response.
  /// Example: /// Example: ERROR CODE
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string ErrCode { get { int o = __p.__offset(34); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetErrCodeBytes() { return __p.__vector_as_span<byte>(34, 1); }
#else
  public ArraySegment<byte>? GetErrCodeBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public byte[] GetErrCodeArray() { return __p.__vector_as_array<byte>(34); }
  ...
  /// Constraints: No constraints specified.
  public string SrcTyps(int j) { int o = __p.__offset(36); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SrcTypsLength { get { int o = __p.__offset(36); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Constraints: No constraints specified.
  public string SrcIds(int j) { int o = __p.__offset(38); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SrcIdsLength { get { int o = __p.__offset(38); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string IdSensor { get { int o = __p.__offset(52); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetIdSensorBytes() { return __p.__vector_as_span<byte>(52, 1); }
#else
  public ArraySegment<byte>? GetIdSensorBytes() { return __p.__vector_as_arraysegment(52); }
#endif
  public byte[] GetIdSensorArray() { return __p.__vector_as_array<byte>(52); }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string OrigSensorId { get { int o = __p.__offset(54); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOrigSensorIdBytes() { return __p.__vector_as_span<byte>(54, 1); }
#else
  public ArraySegment<byte>? GetOrigSensorIdBytes() { return __p.__vector_as_arraysegment(54); }
#endif
  public byte[] GetOrigSensorIdArray() { return __p.__vector_as_array<byte>(54); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public CollectResponse_Full_dataMode_Enum DataMode { get { int o = __p.__offset(56); return o != 0 ? (CollectResponse_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : CollectResponse_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<CollectResponse_Full> CreateCollectResponse_Full(FlatBufferBuilder builder,
      ...
      CollectResponse_Full_dataMode_Enum dataMode = CollectResponse_Full_dataMode_Enum.REAL,
  ...
  public static void AddOnOrbit(FlatBufferBuilder builder, StringOffset onOrbitOffset) { builder.AddOffset(6, onOrbitOffset.Value, 0); }
  ...
  public static void AddIdPlan(FlatBufferBuilder builder, StringOffset idPlanOffset) { builder.AddOffset(8, idPlanOffset.Value, 0); }
  ...
  public static void AddStatus(FlatBufferBuilder builder, StringOffset statusOffset) { builder.AddOffset(10, statusOffset.Value, 0); }
  public static void AddActualStartTime(FlatBufferBuilder builder, StringOffset actualStartTimeOffset) { builder.AddOffset(11, actualStartTimeOffset.Value, 0); }
  public static void AddActualEndTime(FlatBufferBuilder builder, StringOffset actualEndTimeOffset) { builder.AddOffset(12, actualEndTimeOffset.Value, 0); }
  public static void AddAltStartTime(FlatBufferBuilder builder, StringOffset altStartTimeOffset) { builder.AddOffset(13, altStartTimeOffset.Value, 0); }
  public static void AddAltEndTime(FlatBufferBuilder builder, StringOffset altEndTimeOffset) { builder.AddOffset(14, altEndTimeOffset.Value, 0); }
  public static void AddErrCode(FlatBufferBuilder builder, StringOffset errCodeOffset) { builder.AddOffset(15, errCodeOffset.Value, 0); }
  public static void AddSrcTyps(FlatBufferBuilder builder, VectorOffset srcTypsOffset) { builder.AddOffset(16, srcTypsOffset.Value, 0); }
  ...
  public static void AddSrcIds(FlatBufferBuilder builder, VectorOffset srcIdsOffset) { builder.AddOffset(17, srcIdsOffset.Value, 0); }
  ...
  public static void AddIdSensor(FlatBufferBuilder builder, StringOffset idSensorOffset) { builder.AddOffset(24, idSensorOffset.Value, 0); }
  public static void AddOrigSensorId(FlatBufferBuilder builder, StringOffset origSensorIdOffset) { builder.AddOffset(25, origSensorIdOffset.Value, 0); }
  public static void AddDataMode(FlatBufferBuilder builder, CollectResponse_Full_dataMode_Enum dataMode) { builder.AddSbyte(26, (sbyte)dataMode, 0); }
  ...
  public static Offset<CollectResponse_Full> EndCollectResponse_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<CollectResponse_Full>(o);
  }
  public static void FinishCollectResponse_FullBuffer(FlatBufferBuilder builder, Offset<CollectResponse_Full> offset) { builder.Finish(offset.Value, "COLL"); }
  public static void FinishSizePrefixedCollectResponse_FullBuffer(FlatBufferBuilder builder, Offset<CollectResponse_Full> offset) { builder.FinishSizePrefixed(offset.Value, "COLL"); }
  public CollectResponse_FullT UnPack() {
    var _o = new CollectResponse_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(CollectResponse_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<CollectResponse_Full> Pack(FlatBufferBuilder builder, CollectResponse_FullT _o) {
    if (_o == null) return default(Offset<CollectResponse_Full>);
    ...
    return CreateCollectResponse_Full(
      builder,
      _id,
...
public class CollectResponse_FullT
{
  ...
  public CollectResponse_Full_dataMode_Enum DataMode { get; set; }
  public List<string> Tags { get; set; }

  public CollectResponse_FullT() {
    this.Id = null;
    ...
    this.DataMode = CollectResponse_Full_dataMode_Enum.REAL;
    this.Tags = null;
  }
  public static CollectResponse_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return CollectResponse_Full.GetRootAsCollectResponse_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    CollectResponse_Full.FinishCollectResponse_FullBuffer(fbb, CollectResponse_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class CollectResponse_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyString(tablePos, 16 /*OnOrbit*/, false)
      && verifier.VerifyString(tablePos, 18 /*TaskId*/, false)
      && verifier.VerifyString(tablePos, 20 /*IdPlan*/, false)
      && verifier.VerifyString(tablePos, 22 /*ExternalId*/, false)
      && verifier.VerifyString(tablePos, 24 /*Status*/, false)
      && verifier.VerifyString(tablePos, 26 /*ActualStartTime*/, false)
      && verifier.VerifyString(tablePos, 28 /*ActualEndTime*/, false)
      && verifier.VerifyString(tablePos, 30 /*AltStartTime*/, false)
      && verifier.VerifyString(tablePos, 32 /*AltEndTime*/, false)
      && verifier.VerifyString(tablePos, 34 /*ErrCode*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 36 /*SrcTyps*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 38 /*SrcIds*/, false)
      ...
      && verifier.VerifyString(tablePos, 52 /*IdSensor*/, false)
      && verifier.VerifyString(tablePos, 54 /*OrigSensorId*/, false)
      && verifier.VerifyField(tablePos, 56 /*DataMode*/, 1 /*CollectResponse_Full_dataMode_Enum*/, 1, false)
