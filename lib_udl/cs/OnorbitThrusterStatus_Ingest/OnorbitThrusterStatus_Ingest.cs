...
public struct OnorbitThrusterStatus_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static OnorbitThrusterStatus_Ingest GetRootAsOnorbitThrusterStatus_Ingest(ByteBuffer _bb) { return GetRootAsOnorbitThrusterStatus_Ingest(_bb, new OnorbitThrusterStatus_Ingest()); }
  public static OnorbitThrusterStatus_Ingest GetRootAsOnorbitThrusterStatus_Ingest(ByteBuffer _bb, OnorbitThrusterStatus_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OnorbitThrusterStatus_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONOR"); }
  public static bool VerifyOnorbitThrusterStatus_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONOR", false, OnorbitThrusterStatus_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public OnorbitThrusterStatus_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public OnorbitThrusterStatus_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(50); return o != 0 ? (OnorbitThrusterStatus_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OnorbitThrusterStatus_Ingest_dataMode_Enum.REAL; } }

  public static Offset<OnorbitThrusterStatus_Ingest> CreateOnorbitThrusterStatus_Ingest(FlatBufferBuilder builder,
      ...
      OnorbitThrusterStatus_Ingest_dataMode_Enum dataMode = OnorbitThrusterStatus_Ingest_dataMode_Enum.REAL) {
    builder.StartTable(24);
    OnorbitThrusterStatus_Ingest.AddIsp(builder, isp);
    OnorbitThrusterStatus_Ingest.AddThrustMax(builder, thrustMax);
    OnorbitThrusterStatus_Ingest.AddMaxDeltaV(builder, maxDeltaV);
    OnorbitThrusterStatus_Ingest.AddEstDeltaV(builder, estDeltaV);
    OnorbitThrusterStatus_Ingest.AddMinDeltaV(builder, minDeltaV);
    OnorbitThrusterStatus_Ingest.AddTotalDeltaV(builder, totalDeltaV);
    OnorbitThrusterStatus_Ingest.AddFuelMassUnc(builder, fuelMassUnc);
    OnorbitThrusterStatus_Ingest.AddFuelMass(builder, fuelMass);
    OnorbitThrusterStatus_Ingest.AddPropMassMax(builder, propMassMax);
    OnorbitThrusterStatus_Ingest.AddPropMassMedian(builder, propMassMedian);
    OnorbitThrusterStatus_Ingest.AddPropMassAvg(builder, propMassAvg);
    OnorbitThrusterStatus_Ingest.AddPropMassMin(builder, propMassMin);
    OnorbitThrusterStatus_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    OnorbitThrusterStatus_Ingest.AddOrigin(builder, originOffset);
    OnorbitThrusterStatus_Ingest.AddSource(builder, sourceOffset);
    OnorbitThrusterStatus_Ingest.AddCreatedBy(builder, createdByOffset);
    OnorbitThrusterStatus_Ingest.AddCreatedAt(builder, createdAtOffset);
    OnorbitThrusterStatus_Ingest.AddStatusTime(builder, statusTimeOffset);
    OnorbitThrusterStatus_Ingest.AddName(builder, nameOffset);
    OnorbitThrusterStatus_Ingest.AddIdOnorbitThruster(builder, idOnorbitThrusterOffset);
    OnorbitThrusterStatus_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    OnorbitThrusterStatus_Ingest.AddId(builder, idOffset);
    OnorbitThrusterStatus_Ingest.AddDataMode(builder, dataMode);
    OnorbitThrusterStatus_Ingest.AddOperational(builder, operational);
    return OnorbitThrusterStatus_Ingest.EndOnorbitThrusterStatus_Ingest(builder);
  }

  public static void StartOnorbitThrusterStatus_Ingest(FlatBufferBuilder builder) { builder.StartTable(24); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OnorbitThrusterStatus_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(23, (sbyte)dataMode, 0); }
  public static Offset<OnorbitThrusterStatus_Ingest> EndOnorbitThrusterStatus_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OnorbitThrusterStatus_Ingest>(o);
  }
  public static void FinishOnorbitThrusterStatus_IngestBuffer(FlatBufferBuilder builder, Offset<OnorbitThrusterStatus_Ingest> offset) { builder.Finish(offset.Value, "ONOR"); }
  public static void FinishSizePrefixedOnorbitThrusterStatus_IngestBuffer(FlatBufferBuilder builder, Offset<OnorbitThrusterStatus_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "ONOR"); }
  public OnorbitThrusterStatus_IngestT UnPack() {
    var _o = new OnorbitThrusterStatus_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OnorbitThrusterStatus_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OnorbitThrusterStatus_Ingest> Pack(FlatBufferBuilder builder, OnorbitThrusterStatus_IngestT _o) {
    if (_o == null) return default(Offset<OnorbitThrusterStatus_Ingest>);
...
public class OnorbitThrusterStatus_IngestT
{
  ...
  public OnorbitThrusterStatus_Ingest_dataMode_Enum DataMode { get; set; }

  public OnorbitThrusterStatus_IngestT() {
    this.Id = null;
    ...
    this.DataMode = OnorbitThrusterStatus_Ingest_dataMode_Enum.REAL;
  }
  public static OnorbitThrusterStatus_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return OnorbitThrusterStatus_Ingest.GetRootAsOnorbitThrusterStatus_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OnorbitThrusterStatus_Ingest.FinishOnorbitThrusterStatus_IngestBuffer(fbb, OnorbitThrusterStatus_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OnorbitThrusterStatus_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 50 /*DataMode*/, 1 /*OnorbitThrusterStatus_Ingest_dataMode_Enum*/, 1, false)
