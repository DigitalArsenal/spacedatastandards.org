...
public struct Sensorlimits_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Sensorlimits_Ingest GetRootAsSensorlimits_Ingest(ByteBuffer _bb) { return GetRootAsSensorlimits_Ingest(_bb, new Sensorlimits_Ingest()); }
  public static Sensorlimits_Ingest GetRootAsSensorlimits_Ingest(ByteBuffer _bb, Sensorlimits_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Sensorlimits_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SENS"); }
  public static bool VerifySensorlimits_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SENS", false, Sensorlimits_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Sensorlimits_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Sensorlimits_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(28); return o != 0 ? (Sensorlimits_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Sensorlimits_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<Sensorlimits_Ingest> CreateSensorlimits_Ingest(FlatBufferBuilder builder,
      ...
      Sensorlimits_Ingest_dataMode_Enum dataMode = Sensorlimits_Ingest_dataMode_Enum.REAL,
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset),
      StringOffset idSensorOffset = default(StringOffset)) {
    builder.StartTable(16);
    Sensorlimits_Ingest.AddUpperRightElevationLimit(builder, upperRightElevationLimit);
    Sensorlimits_Ingest.AddLowerRightElevationLimit(builder, lowerRightElevationLimit);
    Sensorlimits_Ingest.AddUpperLeftElevationLimit(builder, upperLeftElevationLimit);
    Sensorlimits_Ingest.AddLowerLeftElevationLimit(builder, lowerLeftElevationLimit);
    Sensorlimits_Ingest.AddLowerLeftAzimuthLimit(builder, lowerLeftAzimuthLimit);
    Sensorlimits_Ingest.AddLowerRightAzimuthLimit(builder, lowerRightAzimuthLimit);
    Sensorlimits_Ingest.AddUpperRightAzimuthLimit(builder, upperRightAzimuthLimit);
    Sensorlimits_Ingest.AddUpperLeftAzimuthLimit(builder, upperLeftAzimuthLimit);
    Sensorlimits_Ingest.AddIdSensor(builder, idSensorOffset);
    Sensorlimits_Ingest.AddCreatedBy(builder, createdByOffset);
    Sensorlimits_Ingest.AddCreatedAt(builder, createdAtOffset);
    Sensorlimits_Ingest.AddSource(builder, sourceOffset);
    Sensorlimits_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    Sensorlimits_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    Sensorlimits_Ingest.AddIdSensorLimits(builder, idSensorLimitsOffset);
    Sensorlimits_Ingest.AddDataMode(builder, dataMode);
    return Sensorlimits_Ingest.EndSensorlimits_Ingest(builder);
  }

  public static void StartSensorlimits_Ingest(FlatBufferBuilder builder) { builder.StartTable(16); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Sensorlimits_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(12, (sbyte)dataMode, 0); }
  ...
  public static Offset<Sensorlimits_Ingest> EndSensorlimits_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Sensorlimits_Ingest>(o);
  }
  public static void FinishSensorlimits_IngestBuffer(FlatBufferBuilder builder, Offset<Sensorlimits_Ingest> offset) { builder.Finish(offset.Value, "SENS"); }
  public static void FinishSizePrefixedSensorlimits_IngestBuffer(FlatBufferBuilder builder, Offset<Sensorlimits_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "SENS"); }
  public Sensorlimits_IngestT UnPack() {
    var _o = new Sensorlimits_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Sensorlimits_IngestT _o) {
  ...
  public static Offset<Sensorlimits_Ingest> Pack(FlatBufferBuilder builder, Sensorlimits_IngestT _o) {
    if (_o == null) return default(Offset<Sensorlimits_Ingest>);
...
public class Sensorlimits_IngestT
{
  ...
  public Sensorlimits_Ingest_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string IdSensor { get; set; }

  public Sensorlimits_IngestT() {
    ...
    this.Source = null;
    this.DataMode = Sensorlimits_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.IdSensor = null;
  }
  public static Sensorlimits_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Sensorlimits_Ingest.GetRootAsSensorlimits_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Sensorlimits_Ingest.FinishSensorlimits_IngestBuffer(fbb, Sensorlimits_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Sensorlimits_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*DataMode*/, 1 /*Sensorlimits_Ingest_dataMode_Enum*/, 1, false)
