...
public struct DiplomaticClearanceDetails_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static DiplomaticClearanceDetails_Full GetRootAsDiplomaticClearanceDetails_Full(ByteBuffer _bb) { return GetRootAsDiplomaticClearanceDetails_Full(_bb, new DiplomaticClearanceDetails_Full()); }
  public static DiplomaticClearanceDetails_Full GetRootAsDiplomaticClearanceDetails_Full(ByteBuffer _bb, DiplomaticClearanceDetails_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DiplomaticClearanceDetails_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DIPL"); }
  public static bool VerifyDiplomaticClearanceDetails_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DIPL", false, DiplomaticClearanceDetails_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public DiplomaticClearanceDetails_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<DiplomaticClearanceDetails_Full> CreateDiplomaticClearanceDetails_Full(FlatBufferBuilder builder,
  ...
  public static void StartDiplomaticClearanceDetails_Full(FlatBufferBuilder builder) { builder.StartTable(24); }
  ...
  public static Offset<DiplomaticClearanceDetails_Full> EndDiplomaticClearanceDetails_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DiplomaticClearanceDetails_Full>(o);
  }
  public static void FinishDiplomaticClearanceDetails_FullBuffer(FlatBufferBuilder builder, Offset<DiplomaticClearanceDetails_Full> offset) { builder.Finish(offset.Value, "DIPL"); }
  public static void FinishSizePrefixedDiplomaticClearanceDetails_FullBuffer(FlatBufferBuilder builder, Offset<DiplomaticClearanceDetails_Full> offset) { builder.FinishSizePrefixed(offset.Value, "DIPL"); }
  public DiplomaticClearanceDetails_FullT UnPack() {
    var _o = new DiplomaticClearanceDetails_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DiplomaticClearanceDetails_FullT _o) {
  ...
  public static Offset<DiplomaticClearanceDetails_Full> Pack(FlatBufferBuilder builder, DiplomaticClearanceDetails_FullT _o) {
    if (_o == null) return default(Offset<DiplomaticClearanceDetails_Full>);
...
public class DiplomaticClearanceDetails_FullT
{
  ...
  public DiplomaticClearanceDetails_FullT() {
    this.IdSortie = null;
    this.LegNum = 0;
  ...
  public static DiplomaticClearanceDetails_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return DiplomaticClearanceDetails_Full.GetRootAsDiplomaticClearanceDetails_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DiplomaticClearanceDetails_Full.FinishDiplomaticClearanceDetails_FullBuffer(fbb, DiplomaticClearanceDetails_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DiplomaticClearanceDetails_FullVerify
{
