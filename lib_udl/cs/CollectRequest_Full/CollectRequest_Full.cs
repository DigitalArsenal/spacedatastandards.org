...
public struct CollectRequest_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static CollectRequest_Full GetRootAsCollectRequest_Full(ByteBuffer _bb) { return GetRootAsCollectRequest_Full(_bb, new CollectRequest_Full()); }
  public static CollectRequest_Full GetRootAsCollectRequest_Full(ByteBuffer _bb, CollectRequest_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool CollectRequest_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "COLL"); }
  public static bool VerifyCollectRequest_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("COLL", false, CollectRequest_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public CollectRequest_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: No constraints specified.
  public string UpdatedAt { get { int o = __p.__offset(162); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedAtBytes() { return __p.__vector_as_span<byte>(162, 1); }
#else
  public ArraySegment<byte>? GetUpdatedAtBytes() { return __p.__vector_as_arraysegment(162); }
#endif
  public byte[] GetUpdatedAtArray() { return __p.__vector_as_array<byte>(162); }
  /// Application user who updated the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string UpdatedBy { get { int o = __p.__offset(164); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedByBytes() { return __p.__vector_as_span<byte>(164, 1); }
#else
  public ArraySegment<byte>? GetUpdatedByBytes() { return __p.__vector_as_arraysegment(164); }
#endif
  public byte[] GetUpdatedByArray() { return __p.__vector_as_array<byte>(164); }
  ...
  public string OrigNetwork { get { int o = __p.__offset(174); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOrigNetworkBytes() { return __p.__vector_as_span<byte>(174, 1); }
#else
  public ArraySegment<byte>? GetOrigNetworkBytes() { return __p.__vector_as_arraysegment(174); }
#endif
  public byte[] GetOrigNetworkArray() { return __p.__vector_as_array<byte>(174); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public CollectRequest_Full_dataMode_Enum DataMode { get { int o = __p.__offset(176); return o != 0 ? (CollectRequest_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : CollectRequest_Full_dataMode_Enum.REAL; } }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string StateVector { get { int o = __p.__offset(178); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetStateVectorBytes() { return __p.__vector_as_span<byte>(178, 1); }
#else
  public ArraySegment<byte>? GetStateVectorBytes() { return __p.__vector_as_arraysegment(178); }
#endif
  public byte[] GetStateVectorArray() { return __p.__vector_as_array<byte>(178); }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string Elset { get { int o = __p.__offset(180); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetElsetBytes() { return __p.__vector_as_span<byte>(180, 1); }
#else
  public ArraySegment<byte>? GetElsetBytes() { return __p.__vector_as_arraysegment(180); }
#endif
  public byte[] GetElsetArray() { return __p.__vector_as_array<byte>(180); }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string OnOrbit { get { int o = __p.__offset(182); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbitBytes() { return __p.__vector_as_span<byte>(182, 1); }
#else
  public ArraySegment<byte>? GetOnOrbitBytes() { return __p.__vector_as_arraysegment(182); }
#endif
  public byte[] GetOnOrbitArray() { return __p.__vector_as_array<byte>(182); }
  /// Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
  /// Example: /// Example: ['PROVIDER_TAG1', 'PROVIDER_TAG2']
  /// Constraints: No constraints specified.
  public string Tags(int j) { int o = __p.__offset(184); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int TagsLength { get { int o = __p.__offset(184); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string CollectResponse(int j) { int o = __p.__offset(186); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int CollectResponseLength { get { int o = __p.__offset(186); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<CollectRequest_Full> CreateCollectRequest_Full(FlatBufferBuilder builder,
      ...
      CollectRequest_Full_dataMode_Enum dataMode = CollectRequest_Full_dataMode_Enum.REAL,
      ...
      VectorOffset collectResponseOffset = default(VectorOffset)) {
    builder.StartTable(92);
    CollectRequest_Full.AddOrientAngle(builder, orientAngle);
    CollectRequest_Full.AddYAngle(builder, yAngle);
    CollectRequest_Full.AddXAngle(builder, xAngle);
    CollectRequest_Full.AddSrchInc(builder, srchInc);
    CollectRequest_Full.AddStopAlt(builder, stopAlt);
    CollectRequest_Full.AddStopLon(builder, stopLon);
    CollectRequest_Full.AddStopLat(builder, stopLat);
    CollectRequest_Full.AddAlt(builder, alt);
    CollectRequest_Full.AddLon(builder, lon);
    CollectRequest_Full.AddLat(builder, lat);
    CollectRequest_Full.AddExtentRange(builder, extentRange);
    CollectRequest_Full.AddExtentEl(builder, extentEl);
    CollectRequest_Full.AddExtentAz(builder, extentAz);
    CollectRequest_Full.AddRange(builder, range);
    CollectRequest_Full.AddEl(builder, el);
    CollectRequest_Full.AddAz(builder, az);
    CollectRequest_Full.AddDec(builder, dec);
    CollectRequest_Full.AddRa(builder, ra);
    CollectRequest_Full.AddTrueAnomoly(builder, trueAnomoly);
    CollectRequest_Full.AddArgOfPerigee(builder, argOfPerigee);
    CollectRequest_Full.AddRaan(builder, raan);
    CollectRequest_Full.AddInclination(builder, inclination);
    CollectRequest_Full.AddEccentricity(builder, eccentricity);
    CollectRequest_Full.AddSemiMajorAxis(builder, semiMajorAxis);
    CollectRequest_Full.AddIntegrationTime(builder, integrationTime);
    CollectRequest_Full.AddFrameRate(builder, frameRate);
    CollectRequest_Full.AddIrradiance(builder, irradiance);
    CollectRequest_Full.AddReflectance(builder, reflectance);
    CollectRequest_Full.AddVisMagMax(builder, visMagMax);
    CollectRequest_Full.AddVisMag(builder, visMag);
    CollectRequest_Full.AddVisMagMin(builder, visMagMin);
    CollectRequest_Full.AddFreqMax(builder, freqMax);
    CollectRequest_Full.AddFreq(builder, freq);
    CollectRequest_Full.AddFreqMin(builder, freqMin);
    CollectRequest_Full.AddRcsMax(builder, rcsMax);
    CollectRequest_Full.AddRcs(builder, rcs);
    CollectRequest_Full.AddRcsMin(builder, rcsMin);
    CollectRequest_Full.AddTargetSize(builder, targetSize);
    CollectRequest_Full.AddCollectResponse(builder, collectResponseOffset);
    CollectRequest_Full.AddTags(builder, tagsOffset);
    CollectRequest_Full.AddOnOrbit(builder, onOrbitOffset);
    CollectRequest_Full.AddElset(builder, elsetOffset);
    CollectRequest_Full.AddStateVector(builder, stateVectorOffset);
    CollectRequest_Full.AddOrigNetwork(builder, origNetworkOffset);
    CollectRequest_Full.AddOrigin(builder, originOffset);
    CollectRequest_Full.AddSource(builder, sourceOffset);
    CollectRequest_Full.AddCreatedBy(builder, createdByOffset);
    CollectRequest_Full.AddCreatedAt(builder, createdAtOffset);
    CollectRequest_Full.AddUpdatedBy(builder, updatedByOffset);
    CollectRequest_Full.AddUpdatedAt(builder, updatedAtOffset);
    CollectRequest_Full.AddNotes(builder, notesOffset);
    CollectRequest_Full.AddCustomer(builder, customerOffset);
    CollectRequest_Full.AddEpoch(builder, epochOffset);
    CollectRequest_Full.AddEsId(builder, esIdOffset);
    CollectRequest_Full.AddIdStateVector(builder, idStateVectorOffset);
    CollectRequest_Full.AddIdManifold(builder, idManifoldOffset);
    CollectRequest_Full.AddIdElset(builder, idElsetOffset);
    CollectRequest_Full.AddScenario(builder, scenarioOffset);
    CollectRequest_Full.AddSrchPattern(builder, srchPatternOffset);
    CollectRequest_Full.AddDuration(builder, duration);
    CollectRequest_Full.AddNumObs(builder, numObs);
    CollectRequest_Full.AddNumTracks(builder, numTracks);
    CollectRequest_Full.AddNumFrames(builder, numFrames);
    CollectRequest_Full.AddSpectralModel(builder, spectralModelOffset);
    CollectRequest_Full.AddPolarization(builder, polarizationOffset);
    CollectRequest_Full.AddOrbitRegime(builder, orbitRegimeOffset);
    CollectRequest_Full.AddIron(builder, iron);
    CollectRequest_Full.AddTaskGroup(builder, taskGroupOffset);
    CollectRequest_Full.AddOrigObjectId(builder, origObjectIdOffset);
    CollectRequest_Full.AddSatNo(builder, satNo);
    CollectRequest_Full.AddIdOnOrbit(builder, idOnOrbitOffset);
    CollectRequest_Full.AddEndTime(builder, endTimeOffset);
    CollectRequest_Full.AddStartTime(builder, startTimeOffset);
    CollectRequest_Full.AddSuffix(builder, suffixOffset);
    CollectRequest_Full.AddTaskCategory(builder, taskCategory);
    CollectRequest_Full.AddPriority(builder, priorityOffset);
    CollectRequest_Full.AddObType(builder, obTypeOffset);
    CollectRequest_Full.AddOrigSensorId(builder, origSensorIdOffset);
    CollectRequest_Full.AddIdSensor(builder, idSensorOffset);
    CollectRequest_Full.AddExternalId(builder, externalIdOffset);
    CollectRequest_Full.AddDwellId(builder, dwellIdOffset);
    CollectRequest_Full.AddTaskId(builder, taskIdOffset);
    CollectRequest_Full.AddPlanIndex(builder, planIndex);
    CollectRequest_Full.AddIdPlan(builder, idPlanOffset);
    CollectRequest_Full.AddType(builder, typeOffset);
    CollectRequest_Full.AddMsgCreateDate(builder, msgCreateDateOffset);
    CollectRequest_Full.AddMsgType(builder, msgTypeOffset);
    CollectRequest_Full.AddIdParentReq(builder, idParentReqOffset);
    CollectRequest_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    CollectRequest_Full.AddId(builder, idOffset);
    CollectRequest_Full.AddDataMode(builder, dataMode);
    CollectRequest_Full.AddUctFollowUp(builder, uctFollowUp);
    return CollectRequest_Full.EndCollectRequest_Full(builder);
  }

  public static void StartCollectRequest_Full(FlatBufferBuilder builder) { builder.StartTable(92); }
  ...
  public static void AddUpdatedAt(FlatBufferBuilder builder, StringOffset updatedAtOffset) { builder.AddOffset(79, updatedAtOffset.Value, 0); }
  public static void AddUpdatedBy(FlatBufferBuilder builder, StringOffset updatedByOffset) { builder.AddOffset(80, updatedByOffset.Value, 0); }
  ...
  public static void AddOrigNetwork(FlatBufferBuilder builder, StringOffset origNetworkOffset) { builder.AddOffset(85, origNetworkOffset.Value, 0); }
  public static void AddDataMode(FlatBufferBuilder builder, CollectRequest_Full_dataMode_Enum dataMode) { builder.AddSbyte(86, (sbyte)dataMode, 0); }
  public static void AddStateVector(FlatBufferBuilder builder, StringOffset stateVectorOffset) { builder.AddOffset(87, stateVectorOffset.Value, 0); }
  public static void AddElset(FlatBufferBuilder builder, StringOffset elsetOffset) { builder.AddOffset(88, elsetOffset.Value, 0); }
  public static void AddOnOrbit(FlatBufferBuilder builder, StringOffset onOrbitOffset) { builder.AddOffset(89, onOrbitOffset.Value, 0); }
  public static void AddTags(FlatBufferBuilder builder, VectorOffset tagsOffset) { builder.AddOffset(90, tagsOffset.Value, 0); }
  ...
  public static void AddCollectResponse(FlatBufferBuilder builder, VectorOffset collectResponseOffset) { builder.AddOffset(91, collectResponseOffset.Value, 0); }
  public static VectorOffset CreateCollectResponseVector(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateCollectResponseVectorBlock(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateCollectResponseVectorBlock(FlatBufferBuilder builder, ArraySegment<StringOffset> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateCollectResponseVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<StringOffset>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartCollectResponseVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<CollectRequest_Full> EndCollectRequest_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<CollectRequest_Full>(o);
  }
  public static void FinishCollectRequest_FullBuffer(FlatBufferBuilder builder, Offset<CollectRequest_Full> offset) { builder.Finish(offset.Value, "COLL"); }
  public static void FinishSizePrefixedCollectRequest_FullBuffer(FlatBufferBuilder builder, Offset<CollectRequest_Full> offset) { builder.FinishSizePrefixed(offset.Value, "COLL"); }
  public CollectRequest_FullT UnPack() {
    var _o = new CollectRequest_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(CollectRequest_FullT _o) {
    _o.Id = this.Id;
    ...
    _o.CollectResponse = new List<string>();
    for (var _j = 0; _j < this.CollectResponseLength; ++_j) {_o.CollectResponse.Add(this.CollectResponse(_j));}
  }
  public static Offset<CollectRequest_Full> Pack(FlatBufferBuilder builder, CollectRequest_FullT _o) {
    if (_o == null) return default(Offset<CollectRequest_Full>);
    ...
    var _collectResponse = default(VectorOffset);
    if (_o.CollectResponse != null) {
      var __collectResponse = new StringOffset[_o.CollectResponse.Count];
      for (var _j = 0; _j < __collectResponse.Length; ++_j) { __collectResponse[_j] = builder.CreateString(_o.CollectResponse[_j]); }
      _collectResponse = CreateCollectResponseVector(builder, __collectResponse);
    }
    return CreateCollectRequest_Full(
      builder,
      _id,
...
public class CollectRequest_FullT
{
  ...
  public CollectRequest_Full_dataMode_Enum DataMode { get; set; }
  public string StateVector { get; set; }
  public string Elset { get; set; }
  public string OnOrbit { get; set; }
  public List<string> Tags { get; set; }
  public List<string> CollectResponse { get; set; }

  public CollectRequest_FullT() {
    this.Id = null;
    ...
    this.DataMode = CollectRequest_Full_dataMode_Enum.REAL;
    this.StateVector = null;
    this.Elset = null;
    this.OnOrbit = null;
    this.Tags = null;
    this.CollectResponse = null;
  }
  public static CollectRequest_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return CollectRequest_Full.GetRootAsCollectRequest_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    CollectRequest_Full.FinishCollectRequest_FullBuffer(fbb, CollectRequest_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class CollectRequest_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyString(tablePos, 162 /*UpdatedAt*/, false)
      && verifier.VerifyString(tablePos, 164 /*UpdatedBy*/, false)
      ...
      && verifier.VerifyString(tablePos, 174 /*OrigNetwork*/, false)
      && verifier.VerifyField(tablePos, 176 /*DataMode*/, 1 /*CollectRequest_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 178 /*StateVector*/, false)
      && verifier.VerifyString(tablePos, 180 /*Elset*/, false)
      && verifier.VerifyString(tablePos, 182 /*OnOrbit*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 184 /*Tags*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 186 /*CollectResponse*/, false)
