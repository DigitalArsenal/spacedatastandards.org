...
public struct Port_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Port_Ingest GetRootAsPort_Ingest(ByteBuffer _bb) { return GetRootAsPort_Ingest(_bb, new Port_Ingest()); }
  public static Port_Ingest GetRootAsPort_Ingest(ByteBuffer _bb, Port_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Port_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "PORT"); }
  public static bool VerifyPort_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("PORT", false, Port_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Port_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 64
  public Port_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(44); return o != 0 ? (Port_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Port_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<Port_Ingest> CreatePort_Ingest(FlatBufferBuilder builder,
      ...
      Port_Ingest_dataMode_Enum dataMode = Port_Ingest_dataMode_Enum.REAL,
      StringOffset origNetworkOffset = default(StringOffset)) {
    builder.StartTable(22);
    Port_Ingest.AddLon(builder, lon);
    Port_Ingest.AddLat(builder, lat);
    Port_Ingest.AddTideRange(builder, tideRange);
    Port_Ingest.AddAvgDuration(builder, avgDuration);
    Port_Ingest.AddMaxDraught(builder, maxDraught);
    Port_Ingest.AddHarborSize(builder, harborSize);
    Port_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    Port_Ingest.AddOrigin(builder, originOffset);
    Port_Ingest.AddSource(builder, sourceOffset);
    Port_Ingest.AddCreatedBy(builder, createdByOffset);
    Port_Ingest.AddCreatedAt(builder, createdAtOffset);
    Port_Ingest.AddCountryCode(builder, countryCodeOffset);
    Port_Ingest.AddShelter(builder, shelterOffset);
    Port_Ingest.AddHarborType(builder, harborTypeOffset);
    Port_Ingest.AddPortName(builder, portNameOffset);
    Port_Ingest.AddLocode(builder, locodeOffset);
    Port_Ingest.AddExternalId(builder, externalIdOffset);
    Port_Ingest.AddIdSite(builder, idSiteOffset);
    Port_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    Port_Ingest.AddId(builder, idOffset);
    Port_Ingest.AddDataMode(builder, dataMode);
    Port_Ingest.AddPilotReqd(builder, pilotReqd);
    return Port_Ingest.EndPort_Ingest(builder);
  }

  public static void StartPort_Ingest(FlatBufferBuilder builder) { builder.StartTable(22); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Port_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(20, (sbyte)dataMode, 0); }
  ...
  public static Offset<Port_Ingest> EndPort_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Port_Ingest>(o);
  }
  public static void FinishPort_IngestBuffer(FlatBufferBuilder builder, Offset<Port_Ingest> offset) { builder.Finish(offset.Value, "PORT"); }
  public static void FinishSizePrefixedPort_IngestBuffer(FlatBufferBuilder builder, Offset<Port_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "PORT"); }
  public Port_IngestT UnPack() {
    var _o = new Port_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Port_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Port_Ingest> Pack(FlatBufferBuilder builder, Port_IngestT _o) {
    if (_o == null) return default(Offset<Port_Ingest>);
...
public class Port_IngestT
{
  ...
  public Port_Ingest_dataMode_Enum DataMode { get; set; }
  ...
  public Port_IngestT() {
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Port_Ingest_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static Port_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Port_Ingest.GetRootAsPort_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Port_Ingest.FinishPort_IngestBuffer(fbb, Port_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Port_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 44 /*DataMode*/, 1 /*Port_Ingest_dataMode_Enum*/, 1, false)
