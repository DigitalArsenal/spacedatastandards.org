...
public struct MtiTargetReport_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static MtiTargetReport_Abridged GetRootAsMtiTargetReport_Abridged(ByteBuffer _bb) { return GetRootAsMtiTargetReport_Abridged(_bb, new MtiTargetReport_Abridged()); }
  public static MtiTargetReport_Abridged GetRootAsMtiTargetReport_Abridged(ByteBuffer _bb, MtiTargetReport_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool MtiTargetReport_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MTIT"); }
  public static bool VerifyMtiTargetReport_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MTIT", false, MtiTargetReport_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public MtiTargetReport_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<MtiTargetReport_Abridged> CreateMtiTargetReport_Abridged(FlatBufferBuilder builder,
      int d32_1 = 0,
      double d32_2 = 0.0,
      double d32_3 = 0.0,
      int d32_4 = 0,
    ...
    MtiTargetReport_Abridged.AddD3217(builder, d32_17);
    MtiTargetReport_Abridged.AddD323(builder, d32_3);
    MtiTargetReport_Abridged.AddD322(builder, d32_2);
    MtiTargetReport_Abridged.AddD3218(builder, d32_18);
    MtiTargetReport_Abridged.AddD3216(builder, d32_16);
    MtiTargetReport_Abridged.AddD3215(builder, d32_15);
    MtiTargetReport_Abridged.AddD3214(builder, d32_14);
    MtiTargetReport_Abridged.AddD3213(builder, d32_13);
    MtiTargetReport_Abridged.AddD3212(builder, d32_12);
    MtiTargetReport_Abridged.AddD3211(builder, d32_11);
    MtiTargetReport_Abridged.AddD3210(builder, d32_10Offset);
    MtiTargetReport_Abridged.AddD329(builder, d32_9);
    MtiTargetReport_Abridged.AddD328(builder, d32_8);
    MtiTargetReport_Abridged.AddD327(builder, d32_7);
    MtiTargetReport_Abridged.AddD326(builder, d32_6);
    MtiTargetReport_Abridged.AddD325(builder, d32_5);
    MtiTargetReport_Abridged.AddD324(builder, d32_4);
    MtiTargetReport_Abridged.AddD321(builder, d32_1);
    return MtiTargetReport_Abridged.EndMtiTargetReport_Abridged(builder);
  }

  public static void StartMtiTargetReport_Abridged(FlatBufferBuilder builder) { builder.StartTable(18); }
  ...
  public static Offset<MtiTargetReport_Abridged> EndMtiTargetReport_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<MtiTargetReport_Abridged>(o);
  }
  public static void FinishMtiTargetReport_AbridgedBuffer(FlatBufferBuilder builder, Offset<MtiTargetReport_Abridged> offset) { builder.Finish(offset.Value, "MTIT"); }
  public static void FinishSizePrefixedMtiTargetReport_AbridgedBuffer(FlatBufferBuilder builder, Offset<MtiTargetReport_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "MTIT"); }
  public MtiTargetReport_AbridgedT UnPack() {
    var _o = new MtiTargetReport_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(MtiTargetReport_AbridgedT _o) {
    _o.D321 = this.D321;
    _o.D322 = this.D322;
    _o.D323 = this.D323;
    _o.D324 = this.D324;
  ...
  public static Offset<MtiTargetReport_Abridged> Pack(FlatBufferBuilder builder, MtiTargetReport_AbridgedT _o) {
    if (_o == null) return default(Offset<MtiTargetReport_Abridged>);
    var _d32_10 = _o.D3210 == null ? default(StringOffset) : builder.CreateString(_o.D3210);
    return CreateMtiTargetReport_Abridged(
      builder,
      _o.D321,
      _o.D322,
      _o.D323,
...
public class MtiTargetReport_AbridgedT
{
  ...
  public MtiTargetReport_AbridgedT() {
    this.D321 = 0;
    this.D322 = 0.0;
    this.D323 = 0.0;
    this.D324 = 0;
  ...
  public static MtiTargetReport_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return MtiTargetReport_Abridged.GetRootAsMtiTargetReport_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    MtiTargetReport_Abridged.FinishMtiTargetReport_AbridgedBuffer(fbb, MtiTargetReport_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class MtiTargetReport_AbridgedVerify
{
