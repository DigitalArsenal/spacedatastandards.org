...
public struct LaunchSiteDetails_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static LaunchSiteDetails_Ingest GetRootAsLaunchSiteDetails_Ingest(ByteBuffer _bb, LaunchSiteDetails_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LaunchSiteDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LAUN"); }
  public static bool VerifyLaunchSiteDetails_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LAUN", false, LaunchSiteDetails_IngestVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public LaunchSiteDetails_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(28); return o != 0 ? (LaunchSiteDetails_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : LaunchSiteDetails_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<LaunchSiteDetails_Ingest> CreateLaunchSiteDetails_Ingest(FlatBufferBuilder builder,
      ...
      LaunchSiteDetails_Ingest_dataMode_Enum dataMode = LaunchSiteDetails_Ingest_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, LaunchSiteDetails_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(12, (sbyte)dataMode, 0); }
  ...
  public static Offset<LaunchSiteDetails_Ingest> EndLaunchSiteDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LaunchSiteDetails_Ingest>(o);
  }
  public static void FinishLaunchSiteDetails_IngestBuffer(FlatBufferBuilder builder, Offset<LaunchSiteDetails_Ingest> offset) { builder.Finish(offset.Value, "LAUN"); }
  public static void FinishSizePrefixedLaunchSiteDetails_IngestBuffer(FlatBufferBuilder builder, Offset<LaunchSiteDetails_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "LAUN"); }
  public LaunchSiteDetails_IngestT UnPack() {
    var _o = new LaunchSiteDetails_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LaunchSiteDetails_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<LaunchSiteDetails_Ingest> Pack(FlatBufferBuilder builder, LaunchSiteDetails_IngestT _o) {
    if (_o == null) return default(Offset<LaunchSiteDetails_Ingest>);
...
public class LaunchSiteDetails_IngestT
{
  ...
  public LaunchSiteDetails_Ingest_dataMode_Enum DataMode { get; set; }
  public string Location { get; set; }

  public LaunchSiteDetails_IngestT() {
    this.Id = null;
    ...
    this.DataMode = LaunchSiteDetails_Ingest_dataMode_Enum.REAL;
    this.Location = null;
  }
  public static LaunchSiteDetails_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return LaunchSiteDetails_Ingest.GetRootAsLaunchSiteDetails_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LaunchSiteDetails_Ingest.FinishLaunchSiteDetails_IngestBuffer(fbb, LaunchSiteDetails_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LaunchSiteDetails_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*DataMode*/, 1 /*LaunchSiteDetails_Ingest_dataMode_Enum*/, 1, false)
