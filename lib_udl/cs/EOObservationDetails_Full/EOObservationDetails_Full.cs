...
public struct EOObservationDetails_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static EOObservationDetails_Full GetRootAsEOObservationDetails_Full(ByteBuffer _bb, EOObservationDetails_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EOObservationDetails_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EOOB"); }
  public static bool VerifyEOObservationDetails_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EOOB", false, EOObservationDetails_FullVerify.Verify); }
  ...
  public EOObservationDetails_Full_dataMode_Enum DataMode { get { int o = __p.__offset(164); return o != 0 ? (EOObservationDetails_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EOObservationDetails_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<EOObservationDetails_Full> CreateEOObservationDetails_Full(FlatBufferBuilder builder,
      ...
      EOObservationDetails_Full_dataMode_Enum dataMode = EOObservationDetails_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, EOObservationDetails_Full_dataMode_Enum dataMode) { builder.AddSbyte(80, (sbyte)dataMode, 0); }
  ...
  public static Offset<EOObservationDetails_Full> EndEOObservationDetails_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EOObservationDetails_Full>(o);
  }
  public static void FinishEOObservationDetails_FullBuffer(FlatBufferBuilder builder, Offset<EOObservationDetails_Full> offset) { builder.Finish(offset.Value, "EOOB"); }
  public static void FinishSizePrefixedEOObservationDetails_FullBuffer(FlatBufferBuilder builder, Offset<EOObservationDetails_Full> offset) { builder.FinishSizePrefixed(offset.Value, "EOOB"); }
  public EOObservationDetails_FullT UnPack() {
    var _o = new EOObservationDetails_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EOObservationDetails_FullT _o) {
  ...
  public static Offset<EOObservationDetails_Full> Pack(FlatBufferBuilder builder, EOObservationDetails_FullT _o) {
    if (_o == null) return default(Offset<EOObservationDetails_Full>);
...
public class EOObservationDetails_FullT
{
  ...
  public EOObservationDetails_Full_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }

  public EOObservationDetails_FullT() {
    ...
    this.Does = 0.0;
    this.Source = null;
    this.DataMode = EOObservationDetails_Full_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
  }
  public static EOObservationDetails_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return EOObservationDetails_Full.GetRootAsEOObservationDetails_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EOObservationDetails_Full.FinishEOObservationDetails_FullBuffer(fbb, EOObservationDetails_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EOObservationDetails_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 164 /*DataMode*/, 1 /*EOObservationDetails_Full_dataMode_Enum*/, 1, false)
