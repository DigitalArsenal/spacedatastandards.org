...
public struct PointOfContact_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static PointOfContact_Ingest GetRootAsPointOfContact_Ingest(ByteBuffer _bb, PointOfContact_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool PointOfContact_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "POIN"); }
  public static bool VerifyPointOfContact_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("POIN", false, PointOfContact_IngestVerify.Verify); }
  ...
  public static Offset<PointOfContact_Ingest> CreatePointOfContact_Ingest(FlatBufferBuilder builder,
      int pocSequenceId = 0,
  ...
  public static Offset<PointOfContact_Ingest> EndPointOfContact_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PointOfContact_Ingest>(o);
  }
  public static void FinishPointOfContact_IngestBuffer(FlatBufferBuilder builder, Offset<PointOfContact_Ingest> offset) { builder.Finish(offset.Value, "POIN"); }
  public static void FinishSizePrefixedPointOfContact_IngestBuffer(FlatBufferBuilder builder, Offset<PointOfContact_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "POIN"); }
  public PointOfContact_IngestT UnPack() {
    var _o = new PointOfContact_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(PointOfContact_IngestT _o) {
  ...
  public static Offset<PointOfContact_Ingest> Pack(FlatBufferBuilder builder, PointOfContact_IngestT _o) {
    if (_o == null) return default(Offset<PointOfContact_Ingest>);
...
public class PointOfContact_IngestT
{
  ...
  public static PointOfContact_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return PointOfContact_Ingest.GetRootAsPointOfContact_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    PointOfContact_Ingest.FinishPointOfContact_IngestBuffer(fbb, PointOfContact_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class PointOfContact_IngestVerify
{
