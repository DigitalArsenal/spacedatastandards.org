...
public struct MissileTrack_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static MissileTrack_Full GetRootAsMissileTrack_Full(ByteBuffer _bb) { return GetRootAsMissileTrack_Full(_bb, new MissileTrack_Full()); }
  public static MissileTrack_Full GetRootAsMissileTrack_Full(ByteBuffer _bb, MissileTrack_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool MissileTrack_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MISS"); }
  public static bool VerifyMissileTrack_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MISS", false, MissileTrack_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public MissileTrack_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Example: /// Example: AIR
  /// Constraints: Minimum length = 0, Maximum length = 16
  public MissileTrack_Full_env_Enum Env { get { int o = __p.__offset(14); return o != 0 ? (MissileTrack_Full_env_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : MissileTrack_Full_env_Enum.AIR; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 32
  public MissileTrack_Full_objIdent_Enum ObjIdent { get { int o = __p.__offset(22); return o != 0 ? (MissileTrack_Full_objIdent_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : MissileTrack_Full_objIdent_Enum.ASSUMED_FRIEND; } }
  ...
  public MissileTrack_Full_dataMode_Enum DataMode { get { int o = __p.__offset(116); return o != 0 ? (MissileTrack_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : MissileTrack_Full_dataMode_Enum.REAL; } }

  public static Offset<MissileTrack_Full> CreateMissileTrack_Full(FlatBufferBuilder builder,
      ...
      MissileTrack_Full_env_Enum env = MissileTrack_Full_env_Enum.AIR,
      StringOffset objTypeOffset = default(StringOffset),
      int objTypeConf = 0,
      StringOffset objPlatOffset = default(StringOffset),
      MissileTrack_Full_objIdent_Enum objIdent = MissileTrack_Full_objIdent_Enum.ASSUMED_FRIEND,
      ...
      MissileTrack_Full_dataMode_Enum dataMode = MissileTrack_Full_dataMode_Enum.REAL) {
  ...
  public static void StartMissileTrack_Full(FlatBufferBuilder builder) { builder.StartTable(57); }
  ...
  public static void AddEnv(FlatBufferBuilder builder, MissileTrack_Full_env_Enum env) { builder.AddSbyte(5, (sbyte)env, 0); }
  ...
  public static void AddObjIdent(FlatBufferBuilder builder, MissileTrack_Full_objIdent_Enum objIdent) { builder.AddSbyte(9, (sbyte)objIdent, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, MissileTrack_Full_dataMode_Enum dataMode) { builder.AddSbyte(56, (sbyte)dataMode, 0); }
  public static Offset<MissileTrack_Full> EndMissileTrack_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<MissileTrack_Full>(o);
  }
  public static void FinishMissileTrack_FullBuffer(FlatBufferBuilder builder, Offset<MissileTrack_Full> offset) { builder.Finish(offset.Value, "MISS"); }
  public static void FinishSizePrefixedMissileTrack_FullBuffer(FlatBufferBuilder builder, Offset<MissileTrack_Full> offset) { builder.FinishSizePrefixed(offset.Value, "MISS"); }
  public MissileTrack_FullT UnPack() {
    var _o = new MissileTrack_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(MissileTrack_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<MissileTrack_Full> Pack(FlatBufferBuilder builder, MissileTrack_FullT _o) {
    if (_o == null) return default(Offset<MissileTrack_Full>);
...
public class MissileTrack_FullT
{
  ...
  public MissileTrack_Full_env_Enum Env { get; set; }
  public string ObjType { get; set; }
  public int ObjTypeConf { get; set; }
  public string ObjPlat { get; set; }
  public MissileTrack_Full_objIdent_Enum ObjIdent { get; set; }
  ...
  public MissileTrack_Full_dataMode_Enum DataMode { get; set; }

  public MissileTrack_FullT() {
    this.Id = null;
    this.ClassificationMarking = null;
    this.MsgType = null;
    this.MsgSubType = null;
    this.MsgCreateDate = null;
    this.Env = MissileTrack_Full_env_Enum.AIR;
    this.ObjType = null;
    this.ObjTypeConf = 0;
    this.ObjPlat = null;
    this.ObjIdent = MissileTrack_Full_objIdent_Enum.ASSUMED_FRIEND;
    this.SpaceAmp = null;
    this.ObjAct = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = MissileTrack_Full_dataMode_Enum.REAL;
  }
  public static MissileTrack_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return MissileTrack_Full.GetRootAsMissileTrack_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    MissileTrack_Full.FinishMissileTrack_FullBuffer(fbb, MissileTrack_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class MissileTrack_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*Env*/, 1 /*MissileTrack_Full_env_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 22 /*ObjIdent*/, 1 /*MissileTrack_Full_objIdent_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 116 /*DataMode*/, 1 /*MissileTrack_Full_dataMode_Enum*/, 1, false)
