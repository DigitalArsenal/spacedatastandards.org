...
public struct IonoObservationDensityProfileIRI_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static IonoObservationDensityProfileIRI_Full GetRootAsIonoObservationDensityProfileIRI_Full(ByteBuffer _bb, IonoObservationDensityProfileIRI_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationDensityProfileIRI_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationDensityProfileIRI_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationDensityProfileIRI_FullVerify.Verify); }
  ...
  public static Offset<IonoObservationDensityProfileIRI_Full> CreateIonoObservationDensityProfileIRI_Full(FlatBufferBuilder builder,
  ...
  public static Offset<IonoObservationDensityProfileIRI_Full> EndIonoObservationDensityProfileIRI_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationDensityProfileIRI_Full>(o);
  }
  public static void FinishIonoObservationDensityProfileIRI_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationDensityProfileIRI_Full> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationDensityProfileIRI_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationDensityProfileIRI_Full> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationDensityProfileIRI_FullT UnPack() {
    var _o = new IonoObservationDensityProfileIRI_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationDensityProfileIRI_FullT _o) {
  ...
  public static Offset<IonoObservationDensityProfileIRI_Full> Pack(FlatBufferBuilder builder, IonoObservationDensityProfileIRI_FullT _o) {
    if (_o == null) return default(Offset<IonoObservationDensityProfileIRI_Full>);
...
public class IonoObservationDensityProfileIRI_FullT
{
  ...
  public IonoObservationDensityProfileIRI_FullT() {
  ...
  public static IonoObservationDensityProfileIRI_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationDensityProfileIRI_Full.GetRootAsIonoObservationDensityProfileIRI_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationDensityProfileIRI_Full.FinishIonoObservationDensityProfileIRI_FullBuffer(fbb, IonoObservationDensityProfileIRI_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationDensityProfileIRI_FullVerify
{
