...
public struct IonoObservationAntennaElementPosition_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationAntennaElementPosition_Abridged GetRootAsIonoObservationAntennaElementPosition_Abridged(ByteBuffer _bb) { return GetRootAsIonoObservationAntennaElementPosition_Abridged(_bb, new IonoObservationAntennaElementPosition_Abridged()); }
  public static IonoObservationAntennaElementPosition_Abridged GetRootAsIonoObservationAntennaElementPosition_Abridged(ByteBuffer _bb, IonoObservationAntennaElementPosition_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationAntennaElementPosition_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationAntennaElementPosition_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationAntennaElementPosition_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationAntennaElementPosition_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationAntennaElementPosition_Abridged> CreateIonoObservationAntennaElementPosition_Abridged(FlatBufferBuilder builder,
  ...
  public static void StartIonoObservationAntennaElementPosition_Abridged(FlatBufferBuilder builder) { builder.StartTable(3); }
  ...
  public static Offset<IonoObservationAntennaElementPosition_Abridged> EndIonoObservationAntennaElementPosition_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationAntennaElementPosition_Abridged>(o);
  }
  public static void FinishIonoObservationAntennaElementPosition_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationAntennaElementPosition_Abridged> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationAntennaElementPosition_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationAntennaElementPosition_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationAntennaElementPosition_AbridgedT UnPack() {
    var _o = new IonoObservationAntennaElementPosition_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationAntennaElementPosition_AbridgedT _o) {
  ...
  public static Offset<IonoObservationAntennaElementPosition_Abridged> Pack(FlatBufferBuilder builder, IonoObservationAntennaElementPosition_AbridgedT _o) {
    if (_o == null) return default(Offset<IonoObservationAntennaElementPosition_Abridged>);
    ...
    return CreateIonoObservationAntennaElementPosition_Abridged(
      builder,
      _dimensions,
      _dimensionName,
      _data);
...
public class IonoObservationAntennaElementPosition_AbridgedT
{
  public List<string> Dimensions { get; set; }
  public List<string> DimensionName { get; set; }
  public List<string> Data { get; set; }

  public IonoObservationAntennaElementPosition_AbridgedT() {
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationAntennaElementPosition_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationAntennaElementPosition_Abridged.GetRootAsIonoObservationAntennaElementPosition_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationAntennaElementPosition_Abridged.FinishIonoObservationAntennaElementPosition_AbridgedBuffer(fbb, IonoObservationAntennaElementPosition_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationAntennaElementPosition_AbridgedVerify
{
