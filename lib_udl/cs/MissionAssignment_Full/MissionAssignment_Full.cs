...
public struct MissionAssignment_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static MissionAssignment_Full GetRootAsMissionAssignment_Full(ByteBuffer _bb) { return GetRootAsMissionAssignment_Full(_bb, new MissionAssignment_Full()); }
  public static MissionAssignment_Full GetRootAsMissionAssignment_Full(ByteBuffer _bb, MissionAssignment_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool MissionAssignment_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MISS"); }
  public static bool VerifyMissionAssignment_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MISS", false, MissionAssignment_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public MissionAssignment_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string UpdatedAt { get { int o = __p.__offset(128); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedAtBytes() { return __p.__vector_as_span<byte>(128, 1); }
#else
  public ArraySegment<byte>? GetUpdatedAtBytes() { return __p.__vector_as_arraysegment(128); }
#endif
  public byte[] GetUpdatedAtArray() { return __p.__vector_as_array<byte>(128); }
  /// Application user who updated the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string UpdatedBy { get { int o = __p.__offset(130); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedByBytes() { return __p.__vector_as_span<byte>(130, 1); }
#else
  public ArraySegment<byte>? GetUpdatedByBytes() { return __p.__vector_as_arraysegment(130); }
#endif
  public byte[] GetUpdatedByArray() { return __p.__vector_as_array<byte>(130); }
  /// Source of the data.
  ...
  public MissionAssignment_Full_dataMode_Enum DataMode { get { int o = __p.__offset(136); return o != 0 ? (MissionAssignment_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : MissionAssignment_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<MissionAssignment_Full> CreateMissionAssignment_Full(FlatBufferBuilder builder,
      ...
      MissionAssignment_Full_dataMode_Enum dataMode = MissionAssignment_Full_dataMode_Enum.REAL,
      StringOffset origNetworkOffset = default(StringOffset)) {
    builder.StartTable(68);
    MissionAssignment_Full.AddC7elang2(builder, c7elang2);
    MissionAssignment_Full.AddC3elv(builder, c3elv);
    MissionAssignment_Full.AddC3lon(builder, c3lon);
    MissionAssignment_Full.AddC3lat(builder, c3lat);
    MissionAssignment_Full.AddLon(builder, lon);
    MissionAssignment_Full.AddLat(builder, lat);
    MissionAssignment_Full.AddOrigNetwork(builder, origNetworkOffset);
    MissionAssignment_Full.AddOrigin(builder, originOffset);
    MissionAssignment_Full.AddSource(builder, sourceOffset);
    MissionAssignment_Full.AddUpdatedBy(builder, updatedByOffset);
    MissionAssignment_Full.AddUpdatedAt(builder, updatedAtOffset);
    MissionAssignment_Full.AddCreatedBy(builder, createdByOffset);
    MissionAssignment_Full.AddCreatedAt(builder, createdAtOffset);
    MissionAssignment_Full.AddC7in3p(builder, c7in3p);
    MissionAssignment_Full.AddC7tnor(builder, c7tnorOffset);
    MissionAssignment_Full.AddC6longpm(builder, c6longpmOffset);
    MissionAssignment_Full.AddC6fplpm(builder, c6fplpmOffset);
    MissionAssignment_Full.AddC6dspc(builder, c6dspcOffset);
    MissionAssignment_Full.AddC6dspct(builder, c6dspctOffset);
    MissionAssignment_Full.AddC6tnr3(builder, c6tnr3);
    MissionAssignment_Full.AddC6intel(builder, c6intel);
    MissionAssignment_Full.AddC6laser(builder, c6laser);
    MissionAssignment_Full.AddC5colon(builder, c5colon);
    MissionAssignment_Full.AddC5elevationlsbs(builder, c5elevationlsbs);
    MissionAssignment_Full.AddC5lonlsb(builder, c5lonlsb);
    MissionAssignment_Full.AddC5latlsb(builder, c5latlsb);
    MissionAssignment_Full.AddC5tgtbrng(builder, c5tgtbrng);
    MissionAssignment_Full.AddC5tw(builder, c5tw);
    MissionAssignment_Full.AddC5haeadj(builder, c5haeadj);
    MissionAssignment_Full.AddC4mod(builder, c4mod);
    MissionAssignment_Full.AddC4colon(builder, c4colon);
    MissionAssignment_Full.AddC4tm(builder, c4tm);
    MissionAssignment_Full.AddC4timediscrete(builder, c4timediscreteOffset);
    MissionAssignment_Full.AddC4typeofstores(builder, c4typeofstores);
    MissionAssignment_Full.AddC4numberofstores(builder, c4numberofstores);
    MissionAssignment_Full.AddC4egress(builder, c4egress);
    MissionAssignment_Full.AddC4runin(builder, c4runin);
    MissionAssignment_Full.AddC4def(builder, c4defOffset);
    MissionAssignment_Full.AddC4tgt(builder, c4tgtOffset);
    MissionAssignment_Full.AddC3ptnum(builder, c3ptnumOffset);
    MissionAssignment_Full.AddC3ptl(builder, c3ptlOffset);
    MissionAssignment_Full.AddC2exercisemof(builder, c2exercisemofOffset);
    MissionAssignment_Full.AddC2exerciseindicator(builder, c2exerciseindicatorOffset);
    MissionAssignment_Full.AddC2specialinterestindicator(builder, c2specialinterestindicatorOffset);
    MissionAssignment_Full.AddC2spd(builder, c2spd);
    MissionAssignment_Full.AddC2crs(builder, c2crs);
    MissionAssignment_Full.AddC2alt(builder, c2alt);
    MissionAssignment_Full.AddC2idamplifyingdescriptor(builder, c2idamplifyingdescriptorOffset);
    MissionAssignment_Full.AddC2id(builder, c2idOffset);
    MissionAssignment_Full.AddC2lnd(builder, c2lndOffset);
    MissionAssignment_Full.AddC2sur(builder, c2surOffset);
    MissionAssignment_Full.AddC2air(builder, c2airOffset);
    MissionAssignment_Full.AddC2spc(builder, c2spcOffset);
    MissionAssignment_Full.AddC1associateddmpis(builder, c1associateddmpis);
    MissionAssignment_Full.AddIndex(builder, index);
    MissionAssignment_Full.AddSz(builder, szOffset);
    MissionAssignment_Full.AddEnv(builder, envOffset);
    MissionAssignment_Full.AddOrginx(builder, orginxOffset);
    MissionAssignment_Full.AddTwenv(builder, twenvOffset);
    MissionAssignment_Full.AddTno(builder, tnoOffset);
    MissionAssignment_Full.AddRr(builder, rr);
    MissionAssignment_Full.AddRc(builder, rcOffset);
    MissionAssignment_Full.AddMad(builder, madOffset);
    MissionAssignment_Full.AddTs(builder, tsOffset);
    MissionAssignment_Full.AddTrkId(builder, trkIdOffset);
    MissionAssignment_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    MissionAssignment_Full.AddId(builder, idOffset);
    MissionAssignment_Full.AddDataMode(builder, dataMode);
    return MissionAssignment_Full.EndMissionAssignment_Full(builder);
  }

  public static void StartMissionAssignment_Full(FlatBufferBuilder builder) { builder.StartTable(68); }
  ...
  public static void AddUpdatedAt(FlatBufferBuilder builder, StringOffset updatedAtOffset) { builder.AddOffset(62, updatedAtOffset.Value, 0); }
  public static void AddUpdatedBy(FlatBufferBuilder builder, StringOffset updatedByOffset) { builder.AddOffset(63, updatedByOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, MissionAssignment_Full_dataMode_Enum dataMode) { builder.AddSbyte(66, (sbyte)dataMode, 0); }
  ...
  public static Offset<MissionAssignment_Full> EndMissionAssignment_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<MissionAssignment_Full>(o);
  }
  public static void FinishMissionAssignment_FullBuffer(FlatBufferBuilder builder, Offset<MissionAssignment_Full> offset) { builder.Finish(offset.Value, "MISS"); }
  public static void FinishSizePrefixedMissionAssignment_FullBuffer(FlatBufferBuilder builder, Offset<MissionAssignment_Full> offset) { builder.FinishSizePrefixed(offset.Value, "MISS"); }
  public MissionAssignment_FullT UnPack() {
    var _o = new MissionAssignment_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(MissionAssignment_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<MissionAssignment_Full> Pack(FlatBufferBuilder builder, MissionAssignment_FullT _o) {
    if (_o == null) return default(Offset<MissionAssignment_Full>);
    ...
    return CreateMissionAssignment_Full(
      builder,
      _id,
...
public class MissionAssignment_FullT
{
  ...
  public MissionAssignment_Full_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public MissionAssignment_FullT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = MissionAssignment_Full_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static MissionAssignment_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return MissionAssignment_Full.GetRootAsMissionAssignment_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    MissionAssignment_Full.FinishMissionAssignment_FullBuffer(fbb, MissionAssignment_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class MissionAssignment_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyString(tablePos, 128 /*UpdatedAt*/, false)
      && verifier.VerifyString(tablePos, 130 /*UpdatedBy*/, false)
      && verifier.VerifyString(tablePos, 132 /*Source*/, false)
      && verifier.VerifyString(tablePos, 134 /*Origin*/, false)
      && verifier.VerifyField(tablePos, 136 /*DataMode*/, 1 /*MissionAssignment_Full_dataMode_Enum*/, 1, false)
