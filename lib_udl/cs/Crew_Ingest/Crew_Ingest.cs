...
/// /// Crew Services.
public struct Crew_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Crew_Ingest GetRootAsCrew_Ingest(ByteBuffer _bb) { return GetRootAsCrew_Ingest(_bb, new Crew_Ingest()); }
  public static Crew_Ingest GetRootAsCrew_Ingest(ByteBuffer _bb, Crew_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Crew_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "CREW"); }
  public static bool VerifyCrew_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("CREW", false, Crew_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Crew_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public Crew_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(48); return o != 0 ? (Crew_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Crew_Ingest_dataMode_Enum.REAL; } }

  public static Offset<Crew_Ingest> CreateCrew_Ingest(FlatBufferBuilder builder,
      ...
      Crew_Ingest_dataMode_Enum dataMode = Crew_Ingest_dataMode_Enum.REAL) {
    builder.StartTable(23);
    Crew_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    Crew_Ingest.AddOrigin(builder, originOffset);
    Crew_Ingest.AddSource(builder, sourceOffset);
    Crew_Ingest.AddUpdatedBy(builder, updatedByOffset);
    Crew_Ingest.AddUpdatedAt(builder, updatedAtOffset);
    Crew_Ingest.AddCreatedBy(builder, createdByOffset);
    Crew_Ingest.AddCreatedAt(builder, createdAtOffset);
    Crew_Ingest.AddCrewMembers(builder, crewMembersOffset);
    Crew_Ingest.AddArmsCrewUnit(builder, armsCrewUnitOffset);
    Crew_Ingest.AddCrewType(builder, crewTypeOffset);
    Crew_Ingest.AddFdpType(builder, fdpTypeOffset);
    Crew_Ingest.AddFdpEligType(builder, fdpEligTypeOffset);
    Crew_Ingest.AddReturnTime(builder, returnTimeOffset);
    Crew_Ingest.AddAlertedTime(builder, alertedTimeOffset);
    Crew_Ingest.AddLegalBravoTime(builder, legalBravoTimeOffset);
    Crew_Ingest.AddLegalAlertTime(builder, legalAlertTimeOffset);
    Crew_Ingest.AddIdSortie(builder, idSortieOffset);
    Crew_Ingest.AddStatus(builder, statusOffset);
    Crew_Ingest.AddCrewName(builder, crewNameOffset);
    Crew_Ingest.AddOrigCrewId(builder, origCrewIdOffset);
    Crew_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    Crew_Ingest.AddId(builder, idOffset);
    Crew_Ingest.AddDataMode(builder, dataMode);
    return Crew_Ingest.EndCrew_Ingest(builder);
  }

  public static void StartCrew_Ingest(FlatBufferBuilder builder) { builder.StartTable(23); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Crew_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(22, (sbyte)dataMode, 0); }
  public static Offset<Crew_Ingest> EndCrew_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Crew_Ingest>(o);
  }
  public static void FinishCrew_IngestBuffer(FlatBufferBuilder builder, Offset<Crew_Ingest> offset) { builder.Finish(offset.Value, "CREW"); }
  public static void FinishSizePrefixedCrew_IngestBuffer(FlatBufferBuilder builder, Offset<Crew_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "CREW"); }
  public Crew_IngestT UnPack() {
    var _o = new Crew_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Crew_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Crew_Ingest> Pack(FlatBufferBuilder builder, Crew_IngestT _o) {
    if (_o == null) return default(Offset<Crew_Ingest>);
...
public class Crew_IngestT
{
  ...
  public Crew_Ingest_dataMode_Enum DataMode { get; set; }
  ...
  public Crew_IngestT() {
    ...
    this.DataMode = Crew_Ingest_dataMode_Enum.REAL;
  }
  public static Crew_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Crew_Ingest.GetRootAsCrew_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Crew_Ingest.FinishCrew_IngestBuffer(fbb, Crew_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Crew_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 48 /*DataMode*/, 1 /*Crew_Ingest_dataMode_Enum*/, 1, false)
