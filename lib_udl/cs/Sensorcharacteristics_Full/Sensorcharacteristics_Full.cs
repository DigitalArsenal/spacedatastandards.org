...
public struct Sensorcharacteristics_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static Sensorcharacteristics_Full GetRootAsSensorcharacteristics_Full(ByteBuffer _bb, Sensorcharacteristics_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Sensorcharacteristics_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SENS"); }
  public static bool VerifySensorcharacteristics_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SENS", false, Sensorcharacteristics_FullVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Sensorcharacteristics_Full_dataMode_Enum DataMode { get { int o = __p.__offset(106); return o != 0 ? (Sensorcharacteristics_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Sensorcharacteristics_Full_dataMode_Enum.REAL; } }
  ...
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string UpdatedAt { get { int o = __p.__offset(112); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedAtBytes() { return __p.__vector_as_span<byte>(112, 1); }
#else
  public ArraySegment<byte>? GetUpdatedAtBytes() { return __p.__vector_as_arraysegment(112); }
#endif
  public byte[] GetUpdatedAtArray() { return __p.__vector_as_array<byte>(112); }
  /// Application user who updated the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string UpdatedBy { get { int o = __p.__offset(114); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedByBytes() { return __p.__vector_as_span<byte>(114, 1); }
#else
  public ArraySegment<byte>? GetUpdatedByBytes() { return __p.__vector_as_arraysegment(114); }
#endif
  public byte[] GetUpdatedByArray() { return __p.__vector_as_array<byte>(114); }

  public static Offset<Sensorcharacteristics_Full> CreateSensorcharacteristics_Full(FlatBufferBuilder builder,
      ...
      Sensorcharacteristics_Full_dataMode_Enum dataMode = Sensorcharacteristics_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Sensorcharacteristics_Full_dataMode_Enum dataMode) { builder.AddSbyte(51, (sbyte)dataMode, 0); }
  ...
  public static void AddUpdatedAt(FlatBufferBuilder builder, StringOffset updatedAtOffset) { builder.AddOffset(54, updatedAtOffset.Value, 0); }
  public static void AddUpdatedBy(FlatBufferBuilder builder, StringOffset updatedByOffset) { builder.AddOffset(55, updatedByOffset.Value, 0); }
  public static Offset<Sensorcharacteristics_Full> EndSensorcharacteristics_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Sensorcharacteristics_Full>(o);
  }
  public static void FinishSensorcharacteristics_FullBuffer(FlatBufferBuilder builder, Offset<Sensorcharacteristics_Full> offset) { builder.Finish(offset.Value, "SENS"); }
  public static void FinishSizePrefixedSensorcharacteristics_FullBuffer(FlatBufferBuilder builder, Offset<Sensorcharacteristics_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SENS"); }
  public Sensorcharacteristics_FullT UnPack() {
    var _o = new Sensorcharacteristics_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Sensorcharacteristics_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Sensorcharacteristics_Full> Pack(FlatBufferBuilder builder, Sensorcharacteristics_FullT _o) {
    if (_o == null) return default(Offset<Sensorcharacteristics_Full>);
...
public class Sensorcharacteristics_FullT
{
  ...
  public Sensorcharacteristics_Full_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string UpdatedAt { get; set; }
  public string UpdatedBy { get; set; }

  public Sensorcharacteristics_FullT() {
    this.Id = null;
    this.IdSensor = null;
    ...
    this.Source = null;
    this.DataMode = Sensorcharacteristics_Full_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.UpdatedAt = null;
    this.UpdatedBy = null;
  }
  public static Sensorcharacteristics_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Sensorcharacteristics_Full.GetRootAsSensorcharacteristics_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Sensorcharacteristics_Full.FinishSensorcharacteristics_FullBuffer(fbb, Sensorcharacteristics_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Sensorcharacteristics_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 106 /*DataMode*/, 1 /*Sensorcharacteristics_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 108 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 110 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 112 /*UpdatedAt*/, false)
      && verifier.VerifyString(tablePos, 114 /*UpdatedBy*/, false)
