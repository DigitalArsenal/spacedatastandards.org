...
public struct AIS_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static AIS_Ingest GetRootAsAIS_Ingest(ByteBuffer _bb, AIS_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AIS_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AISI"); }
  public static bool VerifyAIS_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AISI", false, AIS_IngestVerify.Verify); }
  ...
  public AIS_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(102); return o != 0 ? (AIS_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AIS_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<AIS_Ingest> CreateAIS_Ingest(FlatBufferBuilder builder,
      ...
      AIS_Ingest_dataMode_Enum dataMode = AIS_Ingest_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AIS_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(49, (sbyte)dataMode, 0); }
  ...
  public static Offset<AIS_Ingest> EndAIS_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AIS_Ingest>(o);
  }
  public static void FinishAIS_IngestBuffer(FlatBufferBuilder builder, Offset<AIS_Ingest> offset) { builder.Finish(offset.Value, "AISI"); }
  public static void FinishSizePrefixedAIS_IngestBuffer(FlatBufferBuilder builder, Offset<AIS_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AISI"); }
  public AIS_IngestT UnPack() {
    var _o = new AIS_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AIS_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AIS_Ingest> Pack(FlatBufferBuilder builder, AIS_IngestT _o) {
    if (_o == null) return default(Offset<AIS_Ingest>);
...
public class AIS_IngestT
{
  ...
  public AIS_Ingest_dataMode_Enum DataMode { get; set; }
  ...
  public AIS_IngestT() {
    ...
    this.SourceDL = null;
    this.Origin = null;
    this.DataMode = AIS_Ingest_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static AIS_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AIS_Ingest.GetRootAsAIS_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AIS_Ingest.FinishAIS_IngestBuffer(fbb, AIS_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AIS_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 102 /*DataMode*/, 1 /*AIS_Ingest_dataMode_Enum*/, 1, false)
