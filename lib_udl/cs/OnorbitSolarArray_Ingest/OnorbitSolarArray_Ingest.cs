...
public struct OnorbitSolarArray_Ingest : IFlatbufferObject
{
  ...
  public static bool OnorbitSolarArray_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONOR"); }
  public static bool VerifyOnorbitSolarArray_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONOR", false, OnorbitSolarArray_IngestVerify.Verify); }
  ...
  public static Offset<OnorbitSolarArray_Ingest> CreateOnorbitSolarArray_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<OnorbitSolarArray_Ingest> EndOnorbitSolarArray_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OnorbitSolarArray_Ingest>(o);
  }
  public static void FinishOnorbitSolarArray_IngestBuffer(FlatBufferBuilder builder, Offset<OnorbitSolarArray_Ingest> offset) { builder.Finish(offset.Value, "ONOR"); }
  public static void FinishSizePrefixedOnorbitSolarArray_IngestBuffer(FlatBufferBuilder builder, Offset<OnorbitSolarArray_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "ONOR"); }
  ...
  public static Offset<OnorbitSolarArray_Ingest> Pack(FlatBufferBuilder builder, OnorbitSolarArray_IngestT _o) {
    if (_o == null) return default(Offset<OnorbitSolarArray_Ingest>);
...
public class OnorbitSolarArray_IngestT
{
  ...
  public static OnorbitSolarArray_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return OnorbitSolarArray_Ingest.GetRootAsOnorbitSolarArray_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OnorbitSolarArray_Ingest.FinishOnorbitSolarArray_IngestBuffer(fbb, OnorbitSolarArray_Ingest.Pack(fbb, this));
