...
public struct AircraftMissionRemarks_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AircraftMissionRemarks_Abridged GetRootAsAircraftMissionRemarks_Abridged(ByteBuffer _bb) { return GetRootAsAircraftMissionRemarks_Abridged(_bb, new AircraftMissionRemarks_Abridged()); }
  public static AircraftMissionRemarks_Abridged GetRootAsAircraftMissionRemarks_Abridged(ByteBuffer _bb, AircraftMissionRemarks_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AircraftMissionRemarks_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRC"); }
  public static bool VerifyAircraftMissionRemarks_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRC", false, AircraftMissionRemarks_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AircraftMissionRemarks_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<AircraftMissionRemarks_Abridged> CreateAircraftMissionRemarks_Abridged(FlatBufferBuilder builder,
    ...
    AircraftMissionRemarks_Abridged.AddItineraryNum(builder, itineraryNum);
    AircraftMissionRemarks_Abridged.AddUser(builder, userOffset);
    AircraftMissionRemarks_Abridged.AddDate(builder, dateOffset);
    AircraftMissionRemarks_Abridged.AddText(builder, textOffset);
    AircraftMissionRemarks_Abridged.AddType(builder, typeOffset);
    AircraftMissionRemarks_Abridged.AddGdssRemarkId(builder, gdssRemarkIdOffset);
    return AircraftMissionRemarks_Abridged.EndAircraftMissionRemarks_Abridged(builder);
  }

  public static void StartAircraftMissionRemarks_Abridged(FlatBufferBuilder builder) { builder.StartTable(6); }
  ...
  public static Offset<AircraftMissionRemarks_Abridged> EndAircraftMissionRemarks_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AircraftMissionRemarks_Abridged>(o);
  }
  public static void FinishAircraftMissionRemarks_AbridgedBuffer(FlatBufferBuilder builder, Offset<AircraftMissionRemarks_Abridged> offset) { builder.Finish(offset.Value, "AIRC"); }
  public static void FinishSizePrefixedAircraftMissionRemarks_AbridgedBuffer(FlatBufferBuilder builder, Offset<AircraftMissionRemarks_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "AIRC"); }
  public AircraftMissionRemarks_AbridgedT UnPack() {
    var _o = new AircraftMissionRemarks_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AircraftMissionRemarks_AbridgedT _o) {
  ...
  public static Offset<AircraftMissionRemarks_Abridged> Pack(FlatBufferBuilder builder, AircraftMissionRemarks_AbridgedT _o) {
    if (_o == null) return default(Offset<AircraftMissionRemarks_Abridged>);
...
public class AircraftMissionRemarks_AbridgedT
{
  ...
  public AircraftMissionRemarks_AbridgedT() {
  ...
  public static AircraftMissionRemarks_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return AircraftMissionRemarks_Abridged.GetRootAsAircraftMissionRemarks_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AircraftMissionRemarks_Abridged.FinishAircraftMissionRemarks_AbridgedBuffer(fbb, AircraftMissionRemarks_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AircraftMissionRemarks_AbridgedVerify
{
