...
public struct CollectRequest_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static CollectRequest_Ingest GetRootAsCollectRequest_Ingest(ByteBuffer _bb, CollectRequest_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool CollectRequest_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "COLL"); }
  public static bool VerifyCollectRequest_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("COLL", false, CollectRequest_IngestVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public CollectRequest_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(172); return o != 0 ? (CollectRequest_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : CollectRequest_Ingest_dataMode_Enum.REAL; } }
  ...
  /// Constraints: No constraints specified.
  public string Tags(int j) { int o = __p.__offset(178); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int TagsLength { get { int o = __p.__offset(178); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<CollectRequest_Ingest> CreateCollectRequest_Ingest(FlatBufferBuilder builder,
      ...
      CollectRequest_Ingest_dataMode_Enum dataMode = CollectRequest_Ingest_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, CollectRequest_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(84, (sbyte)dataMode, 0); }
  ...
  public static void AddTags(FlatBufferBuilder builder, VectorOffset tagsOffset) { builder.AddOffset(87, tagsOffset.Value, 0); }
  ...
  public static Offset<CollectRequest_Ingest> EndCollectRequest_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<CollectRequest_Ingest>(o);
  }
  public static void FinishCollectRequest_IngestBuffer(FlatBufferBuilder builder, Offset<CollectRequest_Ingest> offset) { builder.Finish(offset.Value, "COLL"); }
  public static void FinishSizePrefixedCollectRequest_IngestBuffer(FlatBufferBuilder builder, Offset<CollectRequest_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "COLL"); }
  public CollectRequest_IngestT UnPack() {
    var _o = new CollectRequest_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(CollectRequest_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<CollectRequest_Ingest> Pack(FlatBufferBuilder builder, CollectRequest_IngestT _o) {
    if (_o == null) return default(Offset<CollectRequest_Ingest>);
...
public class CollectRequest_IngestT
{
  ...
  public CollectRequest_Ingest_dataMode_Enum DataMode { get; set; }
  public string StateVector { get; set; }
  public string Elset { get; set; }
  public List<string> Tags { get; set; }

  public CollectRequest_IngestT() {
    this.Id = null;
    ...
    this.DataMode = CollectRequest_Ingest_dataMode_Enum.REAL;
    this.StateVector = null;
    this.Elset = null;
    this.Tags = null;
  }
  public static CollectRequest_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return CollectRequest_Ingest.GetRootAsCollectRequest_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    CollectRequest_Ingest.FinishCollectRequest_IngestBuffer(fbb, CollectRequest_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class CollectRequest_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 172 /*DataMode*/, 1 /*CollectRequest_Ingest_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 174 /*StateVector*/, false)
      && verifier.VerifyString(tablePos, 176 /*Elset*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 178 /*Tags*/, false)
