...
public struct WeatherReport_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static WeatherReport_Ingest GetRootAsWeatherReport_Ingest(ByteBuffer _bb, WeatherReport_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool WeatherReport_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "WEAT"); }
  public static bool VerifyWeatherReport_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("WEAT", false, WeatherReport_IngestVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public WeatherReport_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(174); return o != 0 ? (WeatherReport_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : WeatherReport_Ingest_dataMode_Enum.REAL; } }

  public static Offset<WeatherReport_Ingest> CreateWeatherReport_Ingest(FlatBufferBuilder builder,
      ...
      WeatherReport_Ingest_dataMode_Enum dataMode = WeatherReport_Ingest_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, WeatherReport_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(85, (sbyte)dataMode, 0); }
  public static Offset<WeatherReport_Ingest> EndWeatherReport_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WeatherReport_Ingest>(o);
  }
  public static void FinishWeatherReport_IngestBuffer(FlatBufferBuilder builder, Offset<WeatherReport_Ingest> offset) { builder.Finish(offset.Value, "WEAT"); }
  public static void FinishSizePrefixedWeatherReport_IngestBuffer(FlatBufferBuilder builder, Offset<WeatherReport_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "WEAT"); }
  public WeatherReport_IngestT UnPack() {
    var _o = new WeatherReport_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(WeatherReport_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<WeatherReport_Ingest> Pack(FlatBufferBuilder builder, WeatherReport_IngestT _o) {
    if (_o == null) return default(Offset<WeatherReport_Ingest>);
...
public class WeatherReport_IngestT
{
  ...
  public WeatherReport_Ingest_dataMode_Enum DataMode { get; set; }

  public WeatherReport_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = WeatherReport_Ingest_dataMode_Enum.REAL;
  }
  public static WeatherReport_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return WeatherReport_Ingest.GetRootAsWeatherReport_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    WeatherReport_Ingest.FinishWeatherReport_IngestBuffer(fbb, WeatherReport_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class WeatherReport_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 174 /*DataMode*/, 1 /*WeatherReport_Ingest_dataMode_Enum*/, 1, false)
