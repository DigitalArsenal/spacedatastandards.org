...
public struct AirEventTankers_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirEventTankers_Ingest GetRootAsAirEventTankers_Ingest(ByteBuffer _bb) { return GetRootAsAirEventTankers_Ingest(_bb, new AirEventTankers_Ingest()); }
  public static AirEventTankers_Ingest GetRootAsAirEventTankers_Ingest(ByteBuffer _bb, AirEventTankers_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirEventTankers_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRE"); }
  public static bool VerifyAirEventTankers_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRE", false, AirEventTankers_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirEventTankers_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<AirEventTankers_Ingest> CreateAirEventTankers_Ingest(FlatBufferBuilder builder,
    ...
    AirEventTankers_Ingest.AddFuelOff(builder, fuelOff);
    AirEventTankers_Ingest.AddTankerFuelType(builder, tankerFuelTypeOffset);
    AirEventTankers_Ingest.AddTankerCellPosition(builder, tankerCellPosition);
    AirEventTankers_Ingest.AddTankerDeliveryMethod(builder, tankerDeliveryMethodOffset);
    AirEventTankers_Ingest.AddTankerDeployedICAO(builder, tankerDeployedICAOOffset);
    AirEventTankers_Ingest.AddTankerLegNum(builder, tankerLegNum);
    AirEventTankers_Ingest.AddTankerPOC(builder, tankerPOCOffset);
    AirEventTankers_Ingest.AddTankerOwner(builder, tankerOwnerOffset);
    AirEventTankers_Ingest.AddTankerCallSign(builder, tankerCallSignOffset);
    AirEventTankers_Ingest.AddAltTankerMissionId(builder, altTankerMissionIdOffset);
    AirEventTankers_Ingest.AddAmcTankerMissionId(builder, amcTankerMissionIdOffset);
    AirEventTankers_Ingest.AddTankerMDS(builder, tankerMDSOffset);
    AirEventTankers_Ingest.AddTankerCoord(builder, tankerCoordOffset);
    AirEventTankers_Ingest.AddExternalTankerId(builder, externalTankerIdOffset);
    AirEventTankers_Ingest.AddIdTankerAirfield(builder, idTankerAirfieldOffset);
    AirEventTankers_Ingest.AddIdTankerMission(builder, idTankerMissionOffset);
    AirEventTankers_Ingest.AddIdTankerSortie(builder, idTankerSortieOffset);
    AirEventTankers_Ingest.AddDualRole(builder, dualRole);
    return AirEventTankers_Ingest.EndAirEventTankers_Ingest(builder);
  }

  public static void StartAirEventTankers_Ingest(FlatBufferBuilder builder) { builder.StartTable(18); }
  ...
  public static Offset<AirEventTankers_Ingest> EndAirEventTankers_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirEventTankers_Ingest>(o);
  }
  public static void FinishAirEventTankers_IngestBuffer(FlatBufferBuilder builder, Offset<AirEventTankers_Ingest> offset) { builder.Finish(offset.Value, "AIRE"); }
  public static void FinishSizePrefixedAirEventTankers_IngestBuffer(FlatBufferBuilder builder, Offset<AirEventTankers_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AIRE"); }
  public AirEventTankers_IngestT UnPack() {
    var _o = new AirEventTankers_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirEventTankers_IngestT _o) {
  ...
  public static Offset<AirEventTankers_Ingest> Pack(FlatBufferBuilder builder, AirEventTankers_IngestT _o) {
    if (_o == null) return default(Offset<AirEventTankers_Ingest>);
    ...
    return CreateAirEventTankers_Ingest(
      builder,
      _idTankerSortie,
      _idTankerMission,
      _idTankerAirfield,
...
public class AirEventTankers_IngestT
{
  ...
  public AirEventTankers_IngestT() {
  ...
  public static AirEventTankers_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AirEventTankers_Ingest.GetRootAsAirEventTankers_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirEventTankers_Ingest.FinishAirEventTankers_IngestBuffer(fbb, AirEventTankers_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirEventTankers_IngestVerify
{
