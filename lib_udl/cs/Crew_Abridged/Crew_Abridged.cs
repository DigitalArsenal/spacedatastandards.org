...
/// /// Crew Services.
public struct Crew_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static Crew_Abridged GetRootAsCrew_Abridged(ByteBuffer _bb, Crew_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Crew_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "CREW"); }
  public static bool VerifyCrew_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("CREW", false, Crew_AbridgedVerify.Verify); }
  ...
  public Crew_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(48); return o != 0 ? (Crew_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Crew_Abridged_dataMode_Enum.REAL; } }

  public static Offset<Crew_Abridged> CreateCrew_Abridged(FlatBufferBuilder builder,
      ...
      Crew_Abridged_dataMode_Enum dataMode = Crew_Abridged_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Crew_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(22, (sbyte)dataMode, 0); }
  public static Offset<Crew_Abridged> EndCrew_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Crew_Abridged>(o);
  }
  public static void FinishCrew_AbridgedBuffer(FlatBufferBuilder builder, Offset<Crew_Abridged> offset) { builder.Finish(offset.Value, "CREW"); }
  public static void FinishSizePrefixedCrew_AbridgedBuffer(FlatBufferBuilder builder, Offset<Crew_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "CREW"); }
  public Crew_AbridgedT UnPack() {
    var _o = new Crew_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Crew_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Crew_Abridged> Pack(FlatBufferBuilder builder, Crew_AbridgedT _o) {
    if (_o == null) return default(Offset<Crew_Abridged>);
...
public class Crew_AbridgedT
{
  ...
  public Crew_Abridged_dataMode_Enum DataMode { get; set; }

  public Crew_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = Crew_Abridged_dataMode_Enum.REAL;
  }
  public static Crew_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Crew_Abridged.GetRootAsCrew_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Crew_Abridged.FinishCrew_AbridgedBuffer(fbb, Crew_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Crew_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 48 /*DataMode*/, 1 /*Crew_Abridged_dataMode_Enum*/, 1, false)
