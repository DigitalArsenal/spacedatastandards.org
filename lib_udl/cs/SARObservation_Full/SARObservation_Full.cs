...
public struct SARObservation_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SARObservation_Full GetRootAsSARObservation_Full(ByteBuffer _bb) { return GetRootAsSARObservation_Full(_bb, new SARObservation_Full()); }
  public static SARObservation_Full GetRootAsSARObservation_Full(ByteBuffer _bb, SARObservation_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SARObservation_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SARO"); }
  public static bool VerifySARObservation_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SARO", false, SARObservation_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SARObservation_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: No constraints specified.
  public string OnOrbit { get { int o = __p.__offset(128); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbitBytes() { return __p.__vector_as_span<byte>(128, 1); }
#else
  public ArraySegment<byte>? GetOnOrbitBytes() { return __p.__vector_as_arraysegment(128); }
#endif
  public byte[] GetOnOrbitArray() { return __p.__vector_as_array<byte>(128); }
  /// Time the row was created in the database, auto-populated by the system.
  /// Example: /// Example: 2023-04-22T17:51:40.854Z
  /// Constraints: No constraints specified.
  public string CreatedAt { get { int o = __p.__offset(130); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedAtBytes() { return __p.__vector_as_span<byte>(130, 1); }
#else
  public ArraySegment<byte>? GetCreatedAtBytes() { return __p.__vector_as_arraysegment(130); }
#endif
  public byte[] GetCreatedAtArray() { return __p.__vector_as_array<byte>(130); }
  /// Application user who created the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string CreatedBy { get { int o = __p.__offset(132); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedByBytes() { return __p.__vector_as_span<byte>(132, 1); }
#else
  public ArraySegment<byte>? GetCreatedByBytes() { return __p.__vector_as_arraysegment(132); }
#endif
  public byte[] GetCreatedByArray() { return __p.__vector_as_array<byte>(132); }
  /// Source of the data.
  /// Example: /// Example: Bluestaq
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string Source { get { int o = __p.__offset(134); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceBytes() { return __p.__vector_as_span<byte>(134, 1); }
#else
  public ArraySegment<byte>? GetSourceBytes() { return __p.__vector_as_arraysegment(134); }
#endif
  public byte[] GetSourceArray() { return __p.__vector_as_array<byte>(134); }
  /// Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
  /// Example: /// Example: THIRD_PARTY_DATASOURCE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Origin { get { int o = __p.__offset(136); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOriginBytes() { return __p.__vector_as_span<byte>(136, 1); }
#else
  public ArraySegment<byte>? GetOriginBytes() { return __p.__vector_as_arraysegment(136); }
#endif
  public byte[] GetOriginArray() { return __p.__vector_as_array<byte>(136); }
  ...
  /// Example: /// Example: AXE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string SourceDL { get { int o = __p.__offset(140); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceDLBytes() { return __p.__vector_as_span<byte>(140, 1); }
#else
  public ArraySegment<byte>? GetSourceDLBytes() { return __p.__vector_as_arraysegment(140); }
#endif
  public byte[] GetSourceDLArray() { return __p.__vector_as_array<byte>(140); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SARObservation_Full_dataMode_Enum DataMode { get { int o = __p.__offset(142); return o != 0 ? (SARObservation_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SARObservation_Full_dataMode_Enum.REAL; } }

  public static Offset<SARObservation_Full> CreateSARObservation_Full(FlatBufferBuilder builder,
      ...
      SARObservation_Full_dataMode_Enum dataMode = SARObservation_Full_dataMode_Enum.REAL) {
  ...
  public static void StartSARObservation_Full(FlatBufferBuilder builder) { builder.StartTable(70); }
  ...
  public static void AddOnOrbit(FlatBufferBuilder builder, StringOffset onOrbitOffset) { builder.AddOffset(62, onOrbitOffset.Value, 0); }
  public static void AddCreatedAt(FlatBufferBuilder builder, StringOffset createdAtOffset) { builder.AddOffset(63, createdAtOffset.Value, 0); }
  public static void AddCreatedBy(FlatBufferBuilder builder, StringOffset createdByOffset) { builder.AddOffset(64, createdByOffset.Value, 0); }
  public static void AddSource(FlatBufferBuilder builder, StringOffset sourceOffset) { builder.AddOffset(65, sourceOffset.Value, 0); }
  public static void AddOrigin(FlatBufferBuilder builder, StringOffset originOffset) { builder.AddOffset(66, originOffset.Value, 0); }
  ...
  public static void AddSourceDL(FlatBufferBuilder builder, StringOffset sourceDLOffset) { builder.AddOffset(68, sourceDLOffset.Value, 0); }
  public static void AddDataMode(FlatBufferBuilder builder, SARObservation_Full_dataMode_Enum dataMode) { builder.AddSbyte(69, (sbyte)dataMode, 0); }
  public static Offset<SARObservation_Full> EndSARObservation_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SARObservation_Full>(o);
  }
  public static void FinishSARObservation_FullBuffer(FlatBufferBuilder builder, Offset<SARObservation_Full> offset) { builder.Finish(offset.Value, "SARO"); }
  public static void FinishSizePrefixedSARObservation_FullBuffer(FlatBufferBuilder builder, Offset<SARObservation_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SARO"); }
  public SARObservation_FullT UnPack() {
    var _o = new SARObservation_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SARObservation_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SARObservation_Full> Pack(FlatBufferBuilder builder, SARObservation_FullT _o) {
    if (_o == null) return default(Offset<SARObservation_Full>);
    ...
    return CreateSARObservation_Full(
      builder,
      _id,
...
public class SARObservation_FullT
{
  ...
  public SARObservation_Full_dataMode_Enum DataMode { get; set; }

  public SARObservation_FullT() {
    this.Id = null;
    ...
    this.SourceDL = null;
    this.DataMode = SARObservation_Full_dataMode_Enum.REAL;
  }
  public static SARObservation_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return SARObservation_Full.GetRootAsSARObservation_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SARObservation_Full.FinishSARObservation_FullBuffer(fbb, SARObservation_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SARObservation_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyString(tablePos, 128 /*OnOrbit*/, false)
      && verifier.VerifyString(tablePos, 130 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 132 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 134 /*Source*/, false)
      && verifier.VerifyString(tablePos, 136 /*Origin*/, false)
      && verifier.VerifyString(tablePos, 138 /*OrigNetwork*/, false)
      && verifier.VerifyString(tablePos, 140 /*SourceDL*/, false)
      && verifier.VerifyField(tablePos, 142 /*DataMode*/, 1 /*SARObservation_Full_dataMode_Enum*/, 1, false)
