...
public struct ISRCollectionRequirements_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static ISRCollectionRequirements_Ingest GetRootAsISRCollectionRequirements_Ingest(ByteBuffer _bb, ISRCollectionRequirements_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool ISRCollectionRequirements_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ISRC"); }
  public static bool VerifyISRCollectionRequirements_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ISRC", false, ISRCollectionRequirements_IngestVerify.Verify); }
  ...
  public static Offset<ISRCollectionRequirements_Ingest> CreateISRCollectionRequirements_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<ISRCollectionRequirements_Ingest> EndISRCollectionRequirements_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ISRCollectionRequirements_Ingest>(o);
  }
  public static void FinishISRCollectionRequirements_IngestBuffer(FlatBufferBuilder builder, Offset<ISRCollectionRequirements_Ingest> offset) { builder.Finish(offset.Value, "ISRC"); }
  public static void FinishSizePrefixedISRCollectionRequirements_IngestBuffer(FlatBufferBuilder builder, Offset<ISRCollectionRequirements_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "ISRC"); }
  public ISRCollectionRequirements_IngestT UnPack() {
    var _o = new ISRCollectionRequirements_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(ISRCollectionRequirements_IngestT _o) {
    _o.Id = this.Id;
    _o.Hash = this.Hash;
    _o.Type = this.Type;
  ...
  public static Offset<ISRCollectionRequirements_Ingest> Pack(FlatBufferBuilder builder, ISRCollectionRequirements_IngestT _o) {
    if (_o == null) return default(Offset<ISRCollectionRequirements_Ingest>);
...
public class ISRCollectionRequirements_IngestT
{
  ...
  public ISRCollectionRequirements_IngestT() {
    this.Id = null;
    this.Hash = null;
    this.Type = null;
  ...
  public static ISRCollectionRequirements_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return ISRCollectionRequirements_Ingest.GetRootAsISRCollectionRequirements_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    ISRCollectionRequirements_Ingest.FinishISRCollectionRequirements_IngestBuffer(fbb, ISRCollectionRequirements_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class ISRCollectionRequirements_IngestVerify
{
