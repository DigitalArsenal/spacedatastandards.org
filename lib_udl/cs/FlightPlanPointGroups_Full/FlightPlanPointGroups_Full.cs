...
public struct FlightPlanPointGroups_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static FlightPlanPointGroups_Full GetRootAsFlightPlanPointGroups_Full(ByteBuffer _bb) { return GetRootAsFlightPlanPointGroups_Full(_bb, new FlightPlanPointGroups_Full()); }
  public static FlightPlanPointGroups_Full GetRootAsFlightPlanPointGroups_Full(ByteBuffer _bb, FlightPlanPointGroups_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool FlightPlanPointGroups_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "FLIG"); }
  public static bool VerifyFlightPlanPointGroups_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("FLIG", false, FlightPlanPointGroups_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public FlightPlanPointGroups_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlightPlanPointGroups_Full> CreateFlightPlanPointGroups_Full(FlatBufferBuilder builder,
    ...
    FlightPlanPointGroups_Full.AddAvgFuelFlow(builder, avgFuelFlow);
    FlightPlanPointGroups_Full.AddFuelCalcSpd(builder, fuelCalcSpd);
    FlightPlanPointGroups_Full.AddFuelCalcAlt(builder, fuelCalcAlt);
    FlightPlanPointGroups_Full.AddPlannedFuel(builder, plannedFuel);
    FlightPlanPointGroups_Full.AddEtopsReqFuel(builder, etopsReqFuel);
    FlightPlanPointGroups_Full.AddFsafReqFuel(builder, fsafReqFuel);
    FlightPlanPointGroups_Full.AddLsafReqFuel(builder, lsafReqFuel);
    FlightPlanPointGroups_Full.AddEtopsTempDev(builder, etopsTempDev);
    FlightPlanPointGroups_Full.AddFsafTempDev(builder, fsafTempDev);
    FlightPlanPointGroups_Full.AddLsafTempDev(builder, lsafTempDev);
    FlightPlanPointGroups_Full.AddEtopsAvgWindFactor(builder, etopsAvgWindFactor);
    FlightPlanPointGroups_Full.AddFsafAvgWindFactor(builder, fsafAvgWindFactor);
    FlightPlanPointGroups_Full.AddLsafAvgWindFactor(builder, lsafAvgWindFactor);
    FlightPlanPointGroups_Full.AddEtopsDistance(builder, etopsDistance);
    FlightPlanPointGroups_Full.AddFsafDistance(builder, fsafDistance);
    FlightPlanPointGroups_Full.AddLsafDistance(builder, lsafDistance);
    FlightPlanPointGroups_Full.AddFlightPlanPoints(builder, flightPlanPointsOffset);
    FlightPlanPointGroups_Full.AddFromTakeoffTime(builder, fromTakeoffTimeOffset);
    FlightPlanPointGroups_Full.AddEtopsTime(builder, etopsTimeOffset);
    FlightPlanPointGroups_Full.AddFsafTime(builder, fsafTimeOffset);
    FlightPlanPointGroups_Full.AddLsafTime(builder, lsafTimeOffset);
    FlightPlanPointGroups_Full.AddLsafName(builder, lsafNameOffset);
    FlightPlanPointGroups_Full.AddWorstFuelCase(builder, worstFuelCaseOffset);
    FlightPlanPointGroups_Full.AddPointGroupName(builder, pointGroupNameOffset);
    return FlightPlanPointGroups_Full.EndFlightPlanPointGroups_Full(builder);
  }

  public static void StartFlightPlanPointGroups_Full(FlatBufferBuilder builder) { builder.StartTable(24); }
  ...
  public static Offset<FlightPlanPointGroups_Full> EndFlightPlanPointGroups_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlightPlanPointGroups_Full>(o);
  }
  public static void FinishFlightPlanPointGroups_FullBuffer(FlatBufferBuilder builder, Offset<FlightPlanPointGroups_Full> offset) { builder.Finish(offset.Value, "FLIG"); }
  public static void FinishSizePrefixedFlightPlanPointGroups_FullBuffer(FlatBufferBuilder builder, Offset<FlightPlanPointGroups_Full> offset) { builder.FinishSizePrefixed(offset.Value, "FLIG"); }
  public FlightPlanPointGroups_FullT UnPack() {
    var _o = new FlightPlanPointGroups_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(FlightPlanPointGroups_FullT _o) {
  ...
  public static Offset<FlightPlanPointGroups_Full> Pack(FlatBufferBuilder builder, FlightPlanPointGroups_FullT _o) {
    if (_o == null) return default(Offset<FlightPlanPointGroups_Full>);
...
public class FlightPlanPointGroups_FullT
{
  ...
  public FlightPlanPointGroups_FullT() {
  ...
  public static FlightPlanPointGroups_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return FlightPlanPointGroups_Full.GetRootAsFlightPlanPointGroups_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    FlightPlanPointGroups_Full.FinishFlightPlanPointGroups_FullBuffer(fbb, FlightPlanPointGroups_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class FlightPlanPointGroups_FullVerify
{
