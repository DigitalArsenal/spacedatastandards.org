...
public struct CollectResponse_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static CollectResponse_Ingest GetRootAsCollectResponse_Ingest(ByteBuffer _bb, CollectResponse_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool CollectResponse_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "COLL"); }
  public static bool VerifyCollectResponse_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("COLL", false, CollectResponse_IngestVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public CollectResponse_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(54); return o != 0 ? (CollectResponse_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : CollectResponse_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<CollectResponse_Ingest> CreateCollectResponse_Ingest(FlatBufferBuilder builder,
      ...
      CollectResponse_Ingest_dataMode_Enum dataMode = CollectResponse_Ingest_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, CollectResponse_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(25, (sbyte)dataMode, 0); }
  ...
  public static Offset<CollectResponse_Ingest> EndCollectResponse_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<CollectResponse_Ingest>(o);
  }
  public static void FinishCollectResponse_IngestBuffer(FlatBufferBuilder builder, Offset<CollectResponse_Ingest> offset) { builder.Finish(offset.Value, "COLL"); }
  public static void FinishSizePrefixedCollectResponse_IngestBuffer(FlatBufferBuilder builder, Offset<CollectResponse_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "COLL"); }
  public CollectResponse_IngestT UnPack() {
    var _o = new CollectResponse_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(CollectResponse_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<CollectResponse_Ingest> Pack(FlatBufferBuilder builder, CollectResponse_IngestT _o) {
    if (_o == null) return default(Offset<CollectResponse_Ingest>);
...
public class CollectResponse_IngestT
{
  ...
  public CollectResponse_Ingest_dataMode_Enum DataMode { get; set; }
  public List<string> Tags { get; set; }

  public CollectResponse_IngestT() {
    this.Id = null;
    ...
    this.DataMode = CollectResponse_Ingest_dataMode_Enum.REAL;
    this.Tags = null;
  }
  public static CollectResponse_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return CollectResponse_Ingest.GetRootAsCollectResponse_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    CollectResponse_Ingest.FinishCollectResponse_IngestBuffer(fbb, CollectResponse_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class CollectResponse_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 54 /*DataMode*/, 1 /*CollectResponse_Ingest_dataMode_Enum*/, 1, false)
