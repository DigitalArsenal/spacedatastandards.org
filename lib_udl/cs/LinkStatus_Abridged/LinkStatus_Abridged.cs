...
public struct LinkStatus_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static LinkStatus_Abridged GetRootAsLinkStatus_Abridged(ByteBuffer _bb, LinkStatus_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LinkStatus_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LINK"); }
  public static bool VerifyLinkStatus_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LINK", false, LinkStatus_AbridgedVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public LinkStatus_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(60); return o != 0 ? (LinkStatus_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : LinkStatus_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<LinkStatus_Abridged> CreateLinkStatus_Abridged(FlatBufferBuilder builder,
      ...
      LinkStatus_Abridged_dataMode_Enum dataMode = LinkStatus_Abridged_dataMode_Enum.REAL,
      int satNo1 = 0,
      int satNo2 = 0) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, LinkStatus_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(28, (sbyte)dataMode, 0); }
  ...
  public static Offset<LinkStatus_Abridged> EndLinkStatus_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LinkStatus_Abridged>(o);
  }
  public static void FinishLinkStatus_AbridgedBuffer(FlatBufferBuilder builder, Offset<LinkStatus_Abridged> offset) { builder.Finish(offset.Value, "LINK"); }
  public static void FinishSizePrefixedLinkStatus_AbridgedBuffer(FlatBufferBuilder builder, Offset<LinkStatus_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "LINK"); }
  public LinkStatus_AbridgedT UnPack() {
    var _o = new LinkStatus_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LinkStatus_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<LinkStatus_Abridged> Pack(FlatBufferBuilder builder, LinkStatus_AbridgedT _o) {
    if (_o == null) return default(Offset<LinkStatus_Abridged>);
...
public class LinkStatus_AbridgedT
{
  ...
  public LinkStatus_Abridged_dataMode_Enum DataMode { get; set; }
  public int SatNo1 { get; set; }
  public int SatNo2 { get; set; }

  public LinkStatus_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = LinkStatus_Abridged_dataMode_Enum.REAL;
    this.SatNo1 = 0;
    this.SatNo2 = 0;
  }
  public static LinkStatus_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return LinkStatus_Abridged.GetRootAsLinkStatus_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LinkStatus_Abridged.FinishLinkStatus_AbridgedBuffer(fbb, LinkStatus_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LinkStatus_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 60 /*DataMode*/, 1 /*LinkStatus_Abridged_dataMode_Enum*/, 1, false)
