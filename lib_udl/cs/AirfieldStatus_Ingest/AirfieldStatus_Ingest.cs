...
public struct AirfieldStatus_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirfieldStatus_Ingest GetRootAsAirfieldStatus_Ingest(ByteBuffer _bb) { return GetRootAsAirfieldStatus_Ingest(_bb, new AirfieldStatus_Ingest()); }
  public static AirfieldStatus_Ingest GetRootAsAirfieldStatus_Ingest(ByteBuffer _bb, AirfieldStatus_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirfieldStatus_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRF"); }
  public static bool VerifyAirfieldStatus_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRF", false, AirfieldStatus_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirfieldStatus_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public AirfieldStatus_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(74); return o != 0 ? (AirfieldStatus_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirfieldStatus_Ingest_dataMode_Enum.REAL; } }

  public static Offset<AirfieldStatus_Ingest> CreateAirfieldStatus_Ingest(FlatBufferBuilder builder,
      ...
      AirfieldStatus_Ingest_dataMode_Enum dataMode = AirfieldStatus_Ingest_dataMode_Enum.REAL) {
  ...
  public static void StartAirfieldStatus_Ingest(FlatBufferBuilder builder) { builder.StartTable(36); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AirfieldStatus_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(35, (sbyte)dataMode, 0); }
  public static Offset<AirfieldStatus_Ingest> EndAirfieldStatus_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirfieldStatus_Ingest>(o);
  }
  public static void FinishAirfieldStatus_IngestBuffer(FlatBufferBuilder builder, Offset<AirfieldStatus_Ingest> offset) { builder.Finish(offset.Value, "AIRF"); }
  public static void FinishSizePrefixedAirfieldStatus_IngestBuffer(FlatBufferBuilder builder, Offset<AirfieldStatus_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AIRF"); }
  public AirfieldStatus_IngestT UnPack() {
    var _o = new AirfieldStatus_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirfieldStatus_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AirfieldStatus_Ingest> Pack(FlatBufferBuilder builder, AirfieldStatus_IngestT _o) {
    if (_o == null) return default(Offset<AirfieldStatus_Ingest>);
...
public class AirfieldStatus_IngestT
{
  ...
  public AirfieldStatus_Ingest_dataMode_Enum DataMode { get; set; }

  public AirfieldStatus_IngestT() {
    this.Id = null;
    ...
    this.DataMode = AirfieldStatus_Ingest_dataMode_Enum.REAL;
  }
  public static AirfieldStatus_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AirfieldStatus_Ingest.GetRootAsAirfieldStatus_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirfieldStatus_Ingest.FinishAirfieldStatus_IngestBuffer(fbb, AirfieldStatus_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirfieldStatus_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 74 /*DataMode*/, 1 /*AirfieldStatus_Ingest_dataMode_Enum*/, 1, false)
