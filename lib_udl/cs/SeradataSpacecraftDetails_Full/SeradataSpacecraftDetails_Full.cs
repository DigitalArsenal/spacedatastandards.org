...
public struct SeradataSpacecraftDetails_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SeradataSpacecraftDetails_Full GetRootAsSeradataSpacecraftDetails_Full(ByteBuffer _bb) { return GetRootAsSeradataSpacecraftDetails_Full(_bb, new SeradataSpacecraftDetails_Full()); }
  public static SeradataSpacecraftDetails_Full GetRootAsSeradataSpacecraftDetails_Full(ByteBuffer _bb, SeradataSpacecraftDetails_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SeradataSpacecraftDetails_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SERA"); }
  public static bool VerifySeradataSpacecraftDetails_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SERA", false, SeradataSpacecraftDetails_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SeradataSpacecraftDetails_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SeradataSpacecraftDetails_Full_dataMode_Enum DataMode { get { int o = __p.__offset(188); return o != 0 ? (SeradataSpacecraftDetails_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SeradataSpacecraftDetails_Full_dataMode_Enum.REAL; } }
  ...
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string UpdatedAt { get { int o = __p.__offset(194); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedAtBytes() { return __p.__vector_as_span<byte>(194, 1); }
#else
  public ArraySegment<byte>? GetUpdatedAtBytes() { return __p.__vector_as_arraysegment(194); }
#endif
  public byte[] GetUpdatedAtArray() { return __p.__vector_as_array<byte>(194); }
  /// Application user who updated the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string UpdatedBy { get { int o = __p.__offset(196); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedByBytes() { return __p.__vector_as_span<byte>(196, 1); }
#else
  public ArraySegment<byte>? GetUpdatedByBytes() { return __p.__vector_as_arraysegment(196); }
#endif
  public byte[] GetUpdatedByArray() { return __p.__vector_as_array<byte>(196); }
  ...
  /// Constraints: No constraints specified.
  public string SeradataSigIntPayload(int j) { int o = __p.__offset(198); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SeradataSigIntPayloadLength { get { int o = __p.__offset(198); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string SeradataRadarPayload(int j) { int o = __p.__offset(200); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SeradataRadarPayloadLength { get { int o = __p.__offset(200); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string SeradataNavigation(int j) { int o = __p.__offset(202); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SeradataNavigationLength { get { int o = __p.__offset(202); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string SeradataOpticalPayload(int j) { int o = __p.__offset(204); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SeradataOpticalPayloadLength { get { int o = __p.__offset(204); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string SeradataEarlyWarning(int j) { int o = __p.__offset(206); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SeradataEarlyWarningLength { get { int o = __p.__offset(206); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string Scientific(int j) { int o = __p.__offset(208); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int ScientificLength { get { int o = __p.__offset(208); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string SeradataCommDetails(int j) { int o = __p.__offset(210); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SeradataCommDetailsLength { get { int o = __p.__offset(210); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string OnOrbit { get { int o = __p.__offset(212); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbitBytes() { return __p.__vector_as_span<byte>(212, 1); }
#else
  public ArraySegment<byte>? GetOnOrbitBytes() { return __p.__vector_as_arraysegment(212); }
#endif
  public byte[] GetOnOrbitArray() { return __p.__vector_as_array<byte>(212); }

  public static Offset<SeradataSpacecraftDetails_Full> CreateSeradataSpacecraftDetails_Full(FlatBufferBuilder builder,
      ...
      SeradataSpacecraftDetails_Full_dataMode_Enum dataMode = SeradataSpacecraftDetails_Full_dataMode_Enum.REAL,
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset),
      StringOffset updatedAtOffset = default(StringOffset),
      StringOffset updatedByOffset = default(StringOffset),
      VectorOffset seradataSigIntPayloadOffset = default(VectorOffset),
      VectorOffset seradataRadarPayloadOffset = default(VectorOffset),
      VectorOffset seradataNavigationOffset = default(VectorOffset),
      VectorOffset seradataOpticalPayloadOffset = default(VectorOffset),
      VectorOffset seradataEarlyWarningOffset = default(VectorOffset),
      VectorOffset scientificOffset = default(VectorOffset),
      VectorOffset seradataCommDetailsOffset = default(VectorOffset),
  ...
  public static void StartSeradataSpacecraftDetails_Full(FlatBufferBuilder builder) { builder.StartTable(105); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SeradataSpacecraftDetails_Full_dataMode_Enum dataMode) { builder.AddSbyte(92, (sbyte)dataMode, 0); }
  ...
  public static void AddUpdatedAt(FlatBufferBuilder builder, StringOffset updatedAtOffset) { builder.AddOffset(95, updatedAtOffset.Value, 0); }
  public static void AddUpdatedBy(FlatBufferBuilder builder, StringOffset updatedByOffset) { builder.AddOffset(96, updatedByOffset.Value, 0); }
  public static void AddSeradataSigIntPayload(FlatBufferBuilder builder, VectorOffset seradataSigIntPayloadOffset) { builder.AddOffset(97, seradataSigIntPayloadOffset.Value, 0); }
  public static VectorOffset CreateSeradataSigIntPayloadVector(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateSeradataSigIntPayloadVectorBlock(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSeradataSigIntPayloadVectorBlock(FlatBufferBuilder builder, ArraySegment<StringOffset> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSeradataSigIntPayloadVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<StringOffset>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartSeradataSigIntPayloadVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddSeradataRadarPayload(FlatBufferBuilder builder, VectorOffset seradataRadarPayloadOffset) { builder.AddOffset(98, seradataRadarPayloadOffset.Value, 0); }
  public static VectorOffset CreateSeradataRadarPayloadVector(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateSeradataRadarPayloadVectorBlock(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSeradataRadarPayloadVectorBlock(FlatBufferBuilder builder, ArraySegment<StringOffset> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSeradataRadarPayloadVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<StringOffset>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartSeradataRadarPayloadVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddSeradataNavigation(FlatBufferBuilder builder, VectorOffset seradataNavigationOffset) { builder.AddOffset(99, seradataNavigationOffset.Value, 0); }
  public static VectorOffset CreateSeradataNavigationVector(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateSeradataNavigationVectorBlock(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSeradataNavigationVectorBlock(FlatBufferBuilder builder, ArraySegment<StringOffset> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSeradataNavigationVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<StringOffset>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartSeradataNavigationVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddSeradataOpticalPayload(FlatBufferBuilder builder, VectorOffset seradataOpticalPayloadOffset) { builder.AddOffset(100, seradataOpticalPayloadOffset.Value, 0); }
  public static VectorOffset CreateSeradataOpticalPayloadVector(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateSeradataOpticalPayloadVectorBlock(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSeradataOpticalPayloadVectorBlock(FlatBufferBuilder builder, ArraySegment<StringOffset> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSeradataOpticalPayloadVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<StringOffset>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartSeradataOpticalPayloadVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddSeradataEarlyWarning(FlatBufferBuilder builder, VectorOffset seradataEarlyWarningOffset) { builder.AddOffset(101, seradataEarlyWarningOffset.Value, 0); }
  public static VectorOffset CreateSeradataEarlyWarningVector(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateSeradataEarlyWarningVectorBlock(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSeradataEarlyWarningVectorBlock(FlatBufferBuilder builder, ArraySegment<StringOffset> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSeradataEarlyWarningVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<StringOffset>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartSeradataEarlyWarningVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddScientific(FlatBufferBuilder builder, VectorOffset scientificOffset) { builder.AddOffset(102, scientificOffset.Value, 0); }
  public static VectorOffset CreateScientificVector(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateScientificVectorBlock(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateScientificVectorBlock(FlatBufferBuilder builder, ArraySegment<StringOffset> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateScientificVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<StringOffset>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartScientificVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddSeradataCommDetails(FlatBufferBuilder builder, VectorOffset seradataCommDetailsOffset) { builder.AddOffset(103, seradataCommDetailsOffset.Value, 0); }
  public static VectorOffset CreateSeradataCommDetailsVector(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateSeradataCommDetailsVectorBlock(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSeradataCommDetailsVectorBlock(FlatBufferBuilder builder, ArraySegment<StringOffset> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSeradataCommDetailsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<StringOffset>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartSeradataCommDetailsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddOnOrbit(FlatBufferBuilder builder, StringOffset onOrbitOffset) { builder.AddOffset(104, onOrbitOffset.Value, 0); }
  public static Offset<SeradataSpacecraftDetails_Full> EndSeradataSpacecraftDetails_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SeradataSpacecraftDetails_Full>(o);
  }
  public static void FinishSeradataSpacecraftDetails_FullBuffer(FlatBufferBuilder builder, Offset<SeradataSpacecraftDetails_Full> offset) { builder.Finish(offset.Value, "SERA"); }
  public static void FinishSizePrefixedSeradataSpacecraftDetails_FullBuffer(FlatBufferBuilder builder, Offset<SeradataSpacecraftDetails_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SERA"); }
  public SeradataSpacecraftDetails_FullT UnPack() {
    var _o = new SeradataSpacecraftDetails_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SeradataSpacecraftDetails_FullT _o) {
    _o.Id = this.Id;
    ...
    _o.SeradataSigIntPayload = new List<string>();
    for (var _j = 0; _j < this.SeradataSigIntPayloadLength; ++_j) {_o.SeradataSigIntPayload.Add(this.SeradataSigIntPayload(_j));}
    _o.SeradataRadarPayload = new List<string>();
    for (var _j = 0; _j < this.SeradataRadarPayloadLength; ++_j) {_o.SeradataRadarPayload.Add(this.SeradataRadarPayload(_j));}
    _o.SeradataNavigation = new List<string>();
    for (var _j = 0; _j < this.SeradataNavigationLength; ++_j) {_o.SeradataNavigation.Add(this.SeradataNavigation(_j));}
    _o.SeradataOpticalPayload = new List<string>();
    for (var _j = 0; _j < this.SeradataOpticalPayloadLength; ++_j) {_o.SeradataOpticalPayload.Add(this.SeradataOpticalPayload(_j));}
    _o.SeradataEarlyWarning = new List<string>();
    for (var _j = 0; _j < this.SeradataEarlyWarningLength; ++_j) {_o.SeradataEarlyWarning.Add(this.SeradataEarlyWarning(_j));}
    _o.Scientific = new List<string>();
    for (var _j = 0; _j < this.ScientificLength; ++_j) {_o.Scientific.Add(this.Scientific(_j));}
    _o.SeradataCommDetails = new List<string>();
    for (var _j = 0; _j < this.SeradataCommDetailsLength; ++_j) {_o.SeradataCommDetails.Add(this.SeradataCommDetails(_j));}
    _o.OnOrbit = this.OnOrbit;
  }
  public static Offset<SeradataSpacecraftDetails_Full> Pack(FlatBufferBuilder builder, SeradataSpacecraftDetails_FullT _o) {
    if (_o == null) return default(Offset<SeradataSpacecraftDetails_Full>);
    ...
    var _seradataSigIntPayload = default(VectorOffset);
    if (_o.SeradataSigIntPayload != null) {
      var __seradataSigIntPayload = new StringOffset[_o.SeradataSigIntPayload.Count];
      for (var _j = 0; _j < __seradataSigIntPayload.Length; ++_j) { __seradataSigIntPayload[_j] = builder.CreateString(_o.SeradataSigIntPayload[_j]); }
      _seradataSigIntPayload = CreateSeradataSigIntPayloadVector(builder, __seradataSigIntPayload);
    }
    var _seradataRadarPayload = default(VectorOffset);
    if (_o.SeradataRadarPayload != null) {
      var __seradataRadarPayload = new StringOffset[_o.SeradataRadarPayload.Count];
      for (var _j = 0; _j < __seradataRadarPayload.Length; ++_j) { __seradataRadarPayload[_j] = builder.CreateString(_o.SeradataRadarPayload[_j]); }
      _seradataRadarPayload = CreateSeradataRadarPayloadVector(builder, __seradataRadarPayload);
    }
    var _seradataNavigation = default(VectorOffset);
    if (_o.SeradataNavigation != null) {
      var __seradataNavigation = new StringOffset[_o.SeradataNavigation.Count];
      for (var _j = 0; _j < __seradataNavigation.Length; ++_j) { __seradataNavigation[_j] = builder.CreateString(_o.SeradataNavigation[_j]); }
      _seradataNavigation = CreateSeradataNavigationVector(builder, __seradataNavigation);
    }
    var _seradataOpticalPayload = default(VectorOffset);
    if (_o.SeradataOpticalPayload != null) {
      var __seradataOpticalPayload = new StringOffset[_o.SeradataOpticalPayload.Count];
      for (var _j = 0; _j < __seradataOpticalPayload.Length; ++_j) { __seradataOpticalPayload[_j] = builder.CreateString(_o.SeradataOpticalPayload[_j]); }
      _seradataOpticalPayload = CreateSeradataOpticalPayloadVector(builder, __seradataOpticalPayload);
    }
    var _seradataEarlyWarning = default(VectorOffset);
    if (_o.SeradataEarlyWarning != null) {
      var __seradataEarlyWarning = new StringOffset[_o.SeradataEarlyWarning.Count];
      for (var _j = 0; _j < __seradataEarlyWarning.Length; ++_j) { __seradataEarlyWarning[_j] = builder.CreateString(_o.SeradataEarlyWarning[_j]); }
      _seradataEarlyWarning = CreateSeradataEarlyWarningVector(builder, __seradataEarlyWarning);
    }
    var _scientific = default(VectorOffset);
    if (_o.Scientific != null) {
      var __scientific = new StringOffset[_o.Scientific.Count];
      for (var _j = 0; _j < __scientific.Length; ++_j) { __scientific[_j] = builder.CreateString(_o.Scientific[_j]); }
      _scientific = CreateScientificVector(builder, __scientific);
    }
    var _seradataCommDetails = default(VectorOffset);
    if (_o.SeradataCommDetails != null) {
      var __seradataCommDetails = new StringOffset[_o.SeradataCommDetails.Count];
      for (var _j = 0; _j < __seradataCommDetails.Length; ++_j) { __seradataCommDetails[_j] = builder.CreateString(_o.SeradataCommDetails[_j]); }
      _seradataCommDetails = CreateSeradataCommDetailsVector(builder, __seradataCommDetails);
    }
    ...
    return CreateSeradataSpacecraftDetails_Full(
      ...
      _updatedAt,
      _updatedBy,
      _seradataSigIntPayload,
      _seradataRadarPayload,
      _seradataNavigation,
      _seradataOpticalPayload,
      _seradataEarlyWarning,
      _scientific,
      _seradataCommDetails,
      _onOrbit);
  }
}

public class SeradataSpacecraftDetails_FullT
{
  ...
  public SeradataSpacecraftDetails_Full_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string UpdatedAt { get; set; }
  public string UpdatedBy { get; set; }
  public List<string> SeradataSigIntPayload { get; set; }
  public List<string> SeradataRadarPayload { get; set; }
  public List<string> SeradataNavigation { get; set; }
  public List<string> SeradataOpticalPayload { get; set; }
  public List<string> SeradataEarlyWarning { get; set; }
  public List<string> Scientific { get; set; }
  public List<string> SeradataCommDetails { get; set; }
  public string OnOrbit { get; set; }

  public SeradataSpacecraftDetails_FullT() {
    this.Id = null;
    this.IdOnOrbit = null;
    ...
    this.DataMode = SeradataSpacecraftDetails_Full_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.UpdatedAt = null;
    this.UpdatedBy = null;
    this.SeradataSigIntPayload = null;
    this.SeradataRadarPayload = null;
    this.SeradataNavigation = null;
    this.SeradataOpticalPayload = null;
    this.SeradataEarlyWarning = null;
    this.Scientific = null;
    this.SeradataCommDetails = null;
    this.OnOrbit = null;
  }
  public static SeradataSpacecraftDetails_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return SeradataSpacecraftDetails_Full.GetRootAsSeradataSpacecraftDetails_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SeradataSpacecraftDetails_Full.FinishSeradataSpacecraftDetails_FullBuffer(fbb, SeradataSpacecraftDetails_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SeradataSpacecraftDetails_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 188 /*DataMode*/, 1 /*SeradataSpacecraftDetails_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 190 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 192 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 194 /*UpdatedAt*/, false)
      && verifier.VerifyString(tablePos, 196 /*UpdatedBy*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 198 /*SeradataSigIntPayload*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 200 /*SeradataRadarPayload*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 202 /*SeradataNavigation*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 204 /*SeradataOpticalPayload*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 206 /*SeradataEarlyWarning*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 208 /*Scientific*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 210 /*SeradataCommDetails*/, false)
      && verifier.VerifyString(tablePos, 212 /*OnOrbit*/, false)
