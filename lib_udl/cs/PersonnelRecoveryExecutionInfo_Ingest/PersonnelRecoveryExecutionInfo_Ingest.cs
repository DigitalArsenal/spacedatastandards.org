...
public struct PersonnelRecoveryExecutionInfo_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static PersonnelRecoveryExecutionInfo_Ingest GetRootAsPersonnelRecoveryExecutionInfo_Ingest(ByteBuffer _bb, PersonnelRecoveryExecutionInfo_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool PersonnelRecoveryExecutionInfo_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "PERS"); }
  public static bool VerifyPersonnelRecoveryExecutionInfo_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("PERS", false, PersonnelRecoveryExecutionInfo_IngestVerify.Verify); }
  ...
  public static Offset<PersonnelRecoveryExecutionInfo_Ingest> CreatePersonnelRecoveryExecutionInfo_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<PersonnelRecoveryExecutionInfo_Ingest> EndPersonnelRecoveryExecutionInfo_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PersonnelRecoveryExecutionInfo_Ingest>(o);
  }
  public static void FinishPersonnelRecoveryExecutionInfo_IngestBuffer(FlatBufferBuilder builder, Offset<PersonnelRecoveryExecutionInfo_Ingest> offset) { builder.Finish(offset.Value, "PERS"); }
  public static void FinishSizePrefixedPersonnelRecoveryExecutionInfo_IngestBuffer(FlatBufferBuilder builder, Offset<PersonnelRecoveryExecutionInfo_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "PERS"); }
  public PersonnelRecoveryExecutionInfo_IngestT UnPack() {
    var _o = new PersonnelRecoveryExecutionInfo_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(PersonnelRecoveryExecutionInfo_IngestT _o) {
  ...
  public static Offset<PersonnelRecoveryExecutionInfo_Ingest> Pack(FlatBufferBuilder builder, PersonnelRecoveryExecutionInfo_IngestT _o) {
    if (_o == null) return default(Offset<PersonnelRecoveryExecutionInfo_Ingest>);
...
public class PersonnelRecoveryExecutionInfo_IngestT
{
  ...
  public PersonnelRecoveryExecutionInfo_IngestT() {
  ...
  public static PersonnelRecoveryExecutionInfo_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return PersonnelRecoveryExecutionInfo_Ingest.GetRootAsPersonnelRecoveryExecutionInfo_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    PersonnelRecoveryExecutionInfo_Ingest.FinishPersonnelRecoveryExecutionInfo_IngestBuffer(fbb, PersonnelRecoveryExecutionInfo_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class PersonnelRecoveryExecutionInfo_IngestVerify
{
