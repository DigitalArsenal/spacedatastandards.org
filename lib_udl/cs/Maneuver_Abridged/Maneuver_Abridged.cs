...
public struct Maneuver_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static Maneuver_Abridged GetRootAsManeuver_Abridged(ByteBuffer _bb, Maneuver_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Maneuver_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MANE"); }
  public static bool VerifyManeuver_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MANE", false, Maneuver_AbridgedVerify.Verify); }
  ...
  public Maneuver_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(182); return o != 0 ? (Maneuver_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Maneuver_Abridged_dataMode_Enum.REAL; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Algorithm { get { int o = __p.__offset(188); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAlgorithmBytes() { return __p.__vector_as_span<byte>(188, 1); }
#else
  public ArraySegment<byte>? GetAlgorithmBytes() { return __p.__vector_as_arraysegment(188); }
#endif
  public byte[] GetAlgorithmArray() { return __p.__vector_as_array<byte>(188); }
  ...
  public static Offset<Maneuver_Abridged> CreateManeuver_Abridged(FlatBufferBuilder builder,
      ...
      Maneuver_Abridged_dataMode_Enum dataMode = Maneuver_Abridged_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Maneuver_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(89, (sbyte)dataMode, 0); }
  ...
  public static void AddAlgorithm(FlatBufferBuilder builder, StringOffset algorithmOffset) { builder.AddOffset(92, algorithmOffset.Value, 0); }
  ...
  public static Offset<Maneuver_Abridged> EndManeuver_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Maneuver_Abridged>(o);
  }
  public static void FinishManeuver_AbridgedBuffer(FlatBufferBuilder builder, Offset<Maneuver_Abridged> offset) { builder.Finish(offset.Value, "MANE"); }
  public static void FinishSizePrefixedManeuver_AbridgedBuffer(FlatBufferBuilder builder, Offset<Maneuver_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "MANE"); }
  public Maneuver_AbridgedT UnPack() {
    var _o = new Maneuver_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Maneuver_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Maneuver_Abridged> Pack(FlatBufferBuilder builder, Maneuver_AbridgedT _o) {
    if (_o == null) return default(Offset<Maneuver_Abridged>);
...
public class Maneuver_AbridgedT
{
  ...
  public Maneuver_Abridged_dataMode_Enum DataMode { get; set; }
  ...
  public Maneuver_AbridgedT() {
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Maneuver_Abridged_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.Algorithm = null;
  ...
  public static Maneuver_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Maneuver_Abridged.GetRootAsManeuver_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Maneuver_Abridged.FinishManeuver_AbridgedBuffer(fbb, Maneuver_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Maneuver_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 182 /*DataMode*/, 1 /*Maneuver_Abridged_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 184 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 186 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 188 /*Algorithm*/, false)
