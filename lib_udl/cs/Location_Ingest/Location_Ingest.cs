...
public struct Location_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Location_Ingest GetRootAsLocation_Ingest(ByteBuffer _bb) { return GetRootAsLocation_Ingest(_bb, new Location_Ingest()); }
  public static Location_Ingest GetRootAsLocation_Ingest(ByteBuffer _bb, Location_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Location_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LOCA"); }
  public static bool VerifyLocation_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LOCA", false, Location_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Location_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public Location_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(26); return o != 0 ? (Location_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Location_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<Location_Ingest> CreateLocation_Ingest(FlatBufferBuilder builder,
      ...
      Location_Ingest_dataMode_Enum dataMode = Location_Ingest_dataMode_Enum.REAL,
      StringOffset origNetworkOffset = default(StringOffset)) {
    builder.StartTable(13);
    Location_Ingest.AddAltitude(builder, altitude);
    Location_Ingest.AddLon(builder, lon);
    Location_Ingest.AddLat(builder, lat);
    Location_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    Location_Ingest.AddOrigin(builder, originOffset);
    Location_Ingest.AddSource(builder, sourceOffset);
    Location_Ingest.AddCreatedBy(builder, createdByOffset);
    Location_Ingest.AddCreatedAt(builder, createdAtOffset);
    Location_Ingest.AddCountryCode(builder, countryCodeOffset);
    Location_Ingest.AddName(builder, nameOffset);
    Location_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    Location_Ingest.AddIdLocation(builder, idLocationOffset);
    Location_Ingest.AddDataMode(builder, dataMode);
    return Location_Ingest.EndLocation_Ingest(builder);
  }

  public static void StartLocation_Ingest(FlatBufferBuilder builder) { builder.StartTable(13); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Location_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(11, (sbyte)dataMode, 0); }
  ...
  public static Offset<Location_Ingest> EndLocation_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Location_Ingest>(o);
  }
  public static void FinishLocation_IngestBuffer(FlatBufferBuilder builder, Offset<Location_Ingest> offset) { builder.Finish(offset.Value, "LOCA"); }
  public static void FinishSizePrefixedLocation_IngestBuffer(FlatBufferBuilder builder, Offset<Location_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "LOCA"); }
  public Location_IngestT UnPack() {
    var _o = new Location_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Location_IngestT _o) {
  ...
  public static Offset<Location_Ingest> Pack(FlatBufferBuilder builder, Location_IngestT _o) {
    if (_o == null) return default(Offset<Location_Ingest>);
...
public class Location_IngestT
{
  ...
  public Location_Ingest_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public Location_IngestT() {
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Location_Ingest_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static Location_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Location_Ingest.GetRootAsLocation_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Location_Ingest.FinishLocation_IngestBuffer(fbb, Location_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Location_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 26 /*DataMode*/, 1 /*Location_Ingest_dataMode_Enum*/, 1, false)
