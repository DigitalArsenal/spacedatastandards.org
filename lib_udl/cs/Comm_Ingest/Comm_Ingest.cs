...
public struct Comm_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static Comm_Ingest GetRootAsComm_Ingest(ByteBuffer _bb, Comm_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Comm_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "COMM"); }
  public static bool VerifyComm_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("COMM", false, Comm_IngestVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Comm_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(20); return o != 0 ? (Comm_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Comm_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<Comm_Ingest> CreateComm_Ingest(FlatBufferBuilder builder,
      ...
      Comm_Ingest_dataMode_Enum dataMode = Comm_Ingest_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Comm_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(8, (sbyte)dataMode, 0); }
  ...
  public static Offset<Comm_Ingest> EndComm_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Comm_Ingest>(o);
  }
  public static void FinishComm_IngestBuffer(FlatBufferBuilder builder, Offset<Comm_Ingest> offset) { builder.Finish(offset.Value, "COMM"); }
  public static void FinishSizePrefixedComm_IngestBuffer(FlatBufferBuilder builder, Offset<Comm_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "COMM"); }
  public Comm_IngestT UnPack() {
    var _o = new Comm_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Comm_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Comm_Ingest> Pack(FlatBufferBuilder builder, Comm_IngestT _o) {
    if (_o == null) return default(Offset<Comm_Ingest>);
...
public class Comm_IngestT
{
  ...
  public Comm_Ingest_dataMode_Enum DataMode { get; set; }
  ...
  public Comm_IngestT() {
    ...
    this.DataMode = Comm_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.Entity = null;
  }
  public static Comm_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Comm_Ingest.GetRootAsComm_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Comm_Ingest.FinishComm_IngestBuffer(fbb, Comm_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Comm_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*DataMode*/, 1 /*Comm_Ingest_dataMode_Enum*/, 1, false)
