...
public struct RFBand_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static RFBand_Ingest GetRootAsRFBand_Ingest(ByteBuffer _bb) { return GetRootAsRFBand_Ingest(_bb, new RFBand_Ingest()); }
  public static RFBand_Ingest GetRootAsRFBand_Ingest(ByteBuffer _bb, RFBand_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool RFBand_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "RFBA"); }
  public static bool VerifyRFBand_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("RFBA", false, RFBand_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public RFBand_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public RFBand_Ingest_mode_Enum Mode { get { int o = __p.__offset(14); return o != 0 ? (RFBand_Ingest_mode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFBand_Ingest_mode_Enum.TX; } }
  /// Purpose or use of the RF Band -- COMM = communications, TTC = Telemetry/Tracking/Control, OPS = Operations, OTHER = Other).
  /// Example: /// Example: TTC
  /// Constraints: Minimum length = 0, Maximum length = 16
  public RFBand_Ingest_purpose_Enum Purpose { get { int o = __p.__offset(16); return o != 0 ? (RFBand_Ingest_purpose_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFBand_Ingest_purpose_Enum.COMM; } }
  ...
  /// Example: /// Example: H
  /// Constraints: Minimum length = 0, Maximum length = 4
  public RFBand_Ingest_polarization_Enum Polarization { get { int o = __p.__offset(32); return o != 0 ? (RFBand_Ingest_polarization_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFBand_Ingest_polarization_Enum.H; } }
  ...
  public RFBand_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(42); return o != 0 ? (RFBand_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFBand_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<RFBand_Ingest> CreateRFBand_Ingest(FlatBufferBuilder builder,
      StringOffset idOffset = default(StringOffset),
      StringOffset idEntityOffset = default(StringOffset),
      StringOffset classificationMarkingOffset = default(StringOffset),
      StringOffset nameOffset = default(StringOffset),
      StringOffset bandOffset = default(StringOffset),
      RFBand_Ingest_mode_Enum mode = RFBand_Ingest_mode_Enum.TX,
      RFBand_Ingest_purpose_Enum purpose = RFBand_Ingest_purpose_Enum.COMM,
      double freqMin = 0.0,
      double freqMax = 0.0,
      ...
      RFBand_Ingest_polarization_Enum polarization = RFBand_Ingest_polarization_Enum.H,
      double erp = 0.0,
      double eirp = 0.0,
      StringOffset sourceOffset = default(StringOffset),
      StringOffset originOffset = default(StringOffset),
      RFBand_Ingest_dataMode_Enum dataMode = RFBand_Ingest_dataMode_Enum.REAL,
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset),
      StringOffset origNetworkOffset = default(StringOffset)) {
    builder.StartTable(23);
    RFBand_Ingest.AddEirp(builder, eirp);
    RFBand_Ingest.AddErp(builder, erp);
    RFBand_Ingest.AddBeamwidth(builder, beamwidth);
    RFBand_Ingest.AddBandwidth(builder, bandwidth);
    RFBand_Ingest.AddEdgeGain(builder, edgeGain);
    RFBand_Ingest.AddPeakGain(builder, peakGain);
    RFBand_Ingest.AddCenterFreq(builder, centerFreq);
    RFBand_Ingest.AddFreqMax(builder, freqMax);
    RFBand_Ingest.AddFreqMin(builder, freqMin);
    RFBand_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    RFBand_Ingest.AddCreatedBy(builder, createdByOffset);
    RFBand_Ingest.AddCreatedAt(builder, createdAtOffset);
    RFBand_Ingest.AddOrigin(builder, originOffset);
    RFBand_Ingest.AddSource(builder, sourceOffset);
    RFBand_Ingest.AddBand(builder, bandOffset);
    RFBand_Ingest.AddName(builder, nameOffset);
    RFBand_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    RFBand_Ingest.AddIdEntity(builder, idEntityOffset);
    RFBand_Ingest.AddId(builder, idOffset);
    RFBand_Ingest.AddDataMode(builder, dataMode);
    RFBand_Ingest.AddPolarization(builder, polarization);
    RFBand_Ingest.AddPurpose(builder, purpose);
    RFBand_Ingest.AddMode(builder, mode);
    return RFBand_Ingest.EndRFBand_Ingest(builder);
  }

  public static void StartRFBand_Ingest(FlatBufferBuilder builder) { builder.StartTable(23); }
  ...
  public static void AddMode(FlatBufferBuilder builder, RFBand_Ingest_mode_Enum mode) { builder.AddSbyte(5, (sbyte)mode, 0); }
  public static void AddPurpose(FlatBufferBuilder builder, RFBand_Ingest_purpose_Enum purpose) { builder.AddSbyte(6, (sbyte)purpose, 0); }
  ...
  public static void AddPolarization(FlatBufferBuilder builder, RFBand_Ingest_polarization_Enum polarization) { builder.AddSbyte(14, (sbyte)polarization, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, RFBand_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(19, (sbyte)dataMode, 0); }
  ...
  public static Offset<RFBand_Ingest> EndRFBand_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RFBand_Ingest>(o);
  }
  public static void FinishRFBand_IngestBuffer(FlatBufferBuilder builder, Offset<RFBand_Ingest> offset) { builder.Finish(offset.Value, "RFBA"); }
  public static void FinishSizePrefixedRFBand_IngestBuffer(FlatBufferBuilder builder, Offset<RFBand_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "RFBA"); }
  public RFBand_IngestT UnPack() {
    var _o = new RFBand_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RFBand_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<RFBand_Ingest> Pack(FlatBufferBuilder builder, RFBand_IngestT _o) {
    if (_o == null) return default(Offset<RFBand_Ingest>);
...
public class RFBand_IngestT
{
  ...
  public RFBand_Ingest_mode_Enum Mode { get; set; }
  public RFBand_Ingest_purpose_Enum Purpose { get; set; }
  ...
  public RFBand_Ingest_polarization_Enum Polarization { get; set; }
  public double Erp { get; set; }
  public double Eirp { get; set; }
  public string Source { get; set; }
  public string Origin { get; set; }
  public RFBand_Ingest_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string OrigNetwork { get; set; }

  public RFBand_IngestT() {
    this.Id = null;
    this.IdEntity = null;
    this.ClassificationMarking = null;
    this.Name = null;
    this.Band = null;
    this.Mode = RFBand_Ingest_mode_Enum.TX;
    this.Purpose = RFBand_Ingest_purpose_Enum.COMM;
    this.FreqMin = 0.0;
    this.FreqMax = 0.0;
    this.CenterFreq = 0.0;
    this.PeakGain = 0.0;
    ...
    this.Bandwidth = 0.0;
    this.Beamwidth = 0.0;
    this.Polarization = RFBand_Ingest_polarization_Enum.H;
    this.Erp = 0.0;
    this.Eirp = 0.0;
    this.Source = null;
    this.Origin = null;
    this.DataMode = RFBand_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.OrigNetwork = null;
  }
  public static RFBand_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return RFBand_Ingest.GetRootAsRFBand_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    RFBand_Ingest.FinishRFBand_IngestBuffer(fbb, RFBand_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class RFBand_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*Mode*/, 1 /*RFBand_Ingest_mode_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 16 /*Purpose*/, 1 /*RFBand_Ingest_purpose_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 32 /*Polarization*/, 1 /*RFBand_Ingest_polarization_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 42 /*DataMode*/, 1 /*RFBand_Ingest_dataMode_Enum*/, 1, false)
