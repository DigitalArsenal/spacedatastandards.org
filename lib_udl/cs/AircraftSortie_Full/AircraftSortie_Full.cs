...
public struct AircraftSortie_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static AircraftSortie_Full GetRootAsAircraftSortie_Full(ByteBuffer _bb, AircraftSortie_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AircraftSortie_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRC"); }
  public static bool VerifyAircraftSortie_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRC", false, AircraftSortie_FullVerify.Verify); }
  ...
  public AircraftSortie_Full_paperStatus_Enum PaperStatus { get { int o = __p.__offset(122); return o != 0 ? (AircraftSortie_Full_paperStatus_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AircraftSortie_Full_paperStatus_Enum.PUBLISHED; } }
  /// The prior permission required (PPR) status.
  /// Example: /// Example: PENDING
  /// Constraints: Minimum length = 0, Maximum length = 22
  public AircraftSortie_Full_pprStatus_Enum PprStatus { get { int o = __p.__offset(124); return o != 0 ? (AircraftSortie_Full_pprStatus_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AircraftSortie_Full_pprStatus_Enum.NOT_REQUIRED; } }
  ...
  public AircraftSortie_Full_rvnReq_Enum RvnReq { get { int o = __p.__offset(136); return o != 0 ? (AircraftSortie_Full_rvnReq_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AircraftSortie_Full_rvnReq_Enum.N; } }
  ...
  /// Constraints: No constraints specified.
  public string UpdatedAt { get { int o = __p.__offset(154); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedAtBytes() { return __p.__vector_as_span<byte>(154, 1); }
#else
  public ArraySegment<byte>? GetUpdatedAtBytes() { return __p.__vector_as_arraysegment(154); }
#endif
  public byte[] GetUpdatedAtArray() { return __p.__vector_as_array<byte>(154); }
  /// Application user who updated the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string UpdatedBy { get { int o = __p.__offset(156); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedByBytes() { return __p.__vector_as_span<byte>(156, 1); }
#else
  public ArraySegment<byte>? GetUpdatedByBytes() { return __p.__vector_as_arraysegment(156); }
#endif
  public byte[] GetUpdatedByArray() { return __p.__vector_as_array<byte>(156); }
  /// The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
  /// Example: /// Example: AXE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string SourceDL { get { int o = __p.__offset(158); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceDLBytes() { return __p.__vector_as_span<byte>(158, 1); }
#else
  public ArraySegment<byte>? GetSourceDLBytes() { return __p.__vector_as_arraysegment(158); }
#endif
  public byte[] GetSourceDLArray() { return __p.__vector_as_array<byte>(158); }
  /// Source of the data.
  ...
  public AircraftSortie_Full_dataMode_Enum DataMode { get { int o = __p.__offset(164); return o != 0 ? (AircraftSortie_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AircraftSortie_Full_dataMode_Enum.REAL; } }
  ...
  /// Constraints: No constraints specified.
  public string Crew { get { int o = __p.__offset(168); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCrewBytes() { return __p.__vector_as_span<byte>(168, 1); }
#else
  public ArraySegment<byte>? GetCrewBytes() { return __p.__vector_as_arraysegment(168); }
#endif
  public byte[] GetCrewArray() { return __p.__vector_as_array<byte>(168); }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string SortiePPR(int j) { int o = __p.__offset(170); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SortiePPRLength { get { int o = __p.__offset(170); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<AircraftSortie_Full> CreateAircraftSortie_Full(FlatBufferBuilder builder,
      ...
      int filesize = 0,
      AircraftSortie_Full_paperStatus_Enum paperStatus = AircraftSortie_Full_paperStatus_Enum.PUBLISHED,
      AircraftSortie_Full_pprStatus_Enum pprStatus = AircraftSortie_Full_pprStatus_Enum.NOT_REQUIRED,
      ...
      AircraftSortie_Full_rvnReq_Enum rvnReq = AircraftSortie_Full_rvnReq_Enum.N,
      int passengers = 0,
      ...
      AircraftSortie_Full_dataMode_Enum dataMode = AircraftSortie_Full_dataMode_Enum.REAL,
      StringOffset origNetworkOffset = default(StringOffset),
      StringOffset crewOffset = default(StringOffset),
      VectorOffset sortiePPROffset = default(VectorOffset)) {
  ...
  public static void AddPaperStatus(FlatBufferBuilder builder, AircraftSortie_Full_paperStatus_Enum paperStatus) { builder.AddSbyte(59, (sbyte)paperStatus, 0); }
  public static void AddPprStatus(FlatBufferBuilder builder, AircraftSortie_Full_pprStatus_Enum pprStatus) { builder.AddSbyte(60, (sbyte)pprStatus, 0); }
  ...
  public static void AddRvnReq(FlatBufferBuilder builder, AircraftSortie_Full_rvnReq_Enum rvnReq) { builder.AddSbyte(66, (sbyte)rvnReq, 0); }
  ...
  public static void AddUpdatedAt(FlatBufferBuilder builder, StringOffset updatedAtOffset) { builder.AddOffset(75, updatedAtOffset.Value, 0); }
  public static void AddUpdatedBy(FlatBufferBuilder builder, StringOffset updatedByOffset) { builder.AddOffset(76, updatedByOffset.Value, 0); }
  public static void AddSourceDL(FlatBufferBuilder builder, StringOffset sourceDLOffset) { builder.AddOffset(77, sourceDLOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AircraftSortie_Full_dataMode_Enum dataMode) { builder.AddSbyte(80, (sbyte)dataMode, 0); }
  ...
  public static void AddCrew(FlatBufferBuilder builder, StringOffset crewOffset) { builder.AddOffset(82, crewOffset.Value, 0); }
  public static void AddSortiePPR(FlatBufferBuilder builder, VectorOffset sortiePPROffset) { builder.AddOffset(83, sortiePPROffset.Value, 0); }
  public static VectorOffset CreateSortiePPRVector(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateSortiePPRVectorBlock(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSortiePPRVectorBlock(FlatBufferBuilder builder, ArraySegment<StringOffset> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSortiePPRVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<StringOffset>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartSortiePPRVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<AircraftSortie_Full> EndAircraftSortie_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AircraftSortie_Full>(o);
  }
  public static void FinishAircraftSortie_FullBuffer(FlatBufferBuilder builder, Offset<AircraftSortie_Full> offset) { builder.Finish(offset.Value, "AIRC"); }
  public static void FinishSizePrefixedAircraftSortie_FullBuffer(FlatBufferBuilder builder, Offset<AircraftSortie_Full> offset) { builder.FinishSizePrefixed(offset.Value, "AIRC"); }
  public AircraftSortie_FullT UnPack() {
    var _o = new AircraftSortie_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AircraftSortie_FullT _o) {
    _o.Id = this.Id;
    ...
    _o.Crew = this.Crew;
    _o.SortiePPR = new List<string>();
    for (var _j = 0; _j < this.SortiePPRLength; ++_j) {_o.SortiePPR.Add(this.SortiePPR(_j));}
  }
  public static Offset<AircraftSortie_Full> Pack(FlatBufferBuilder builder, AircraftSortie_FullT _o) {
    if (_o == null) return default(Offset<AircraftSortie_Full>);
    ...
    var _crew = _o.Crew == null ? default(StringOffset) : builder.CreateString(_o.Crew);
    var _sortiePPR = default(VectorOffset);
    if (_o.SortiePPR != null) {
      var __sortiePPR = new StringOffset[_o.SortiePPR.Count];
      for (var _j = 0; _j < __sortiePPR.Length; ++_j) { __sortiePPR[_j] = builder.CreateString(_o.SortiePPR[_j]); }
      _sortiePPR = CreateSortiePPRVector(builder, __sortiePPR);
    }
...
public class AircraftSortie_FullT
{
  ...
  public AircraftSortie_Full_paperStatus_Enum PaperStatus { get; set; }
  public AircraftSortie_Full_pprStatus_Enum PprStatus { get; set; }
  ...
  public AircraftSortie_Full_rvnReq_Enum RvnReq { get; set; }
  ...
  public AircraftSortie_Full_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }
  public string Crew { get; set; }
  public List<string> SortiePPR { get; set; }

  public AircraftSortie_FullT() {
    this.Id = null;
    ...
    this.Filename = null;
    this.Filesize = 0;
    this.PaperStatus = AircraftSortie_Full_paperStatus_Enum.PUBLISHED;
    this.PprStatus = AircraftSortie_Full_pprStatus_Enum.NOT_REQUIRED;
    this.MissionUpdate = null;
    this.DelayCode = null;
    this.CommanderName = null;
    this.FmDeskNum = null;
    this.FmName = null;
    this.RvnReq = AircraftSortie_Full_rvnReq_Enum.N;
    this.Passengers = 0;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = AircraftSortie_Full_dataMode_Enum.REAL;
    this.OrigNetwork = null;
    this.Crew = null;
    this.SortiePPR = null;
  }
  public static AircraftSortie_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return AircraftSortie_Full.GetRootAsAircraftSortie_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AircraftSortie_Full.FinishAircraftSortie_FullBuffer(fbb, AircraftSortie_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AircraftSortie_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 122 /*PaperStatus*/, 1 /*AircraftSortie_Full_paperStatus_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 124 /*PprStatus*/, 1 /*AircraftSortie_Full_pprStatus_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 136 /*RvnReq*/, 1 /*AircraftSortie_Full_rvnReq_Enum*/, 1, false)
      ...
      && verifier.VerifyString(tablePos, 154 /*UpdatedAt*/, false)
      && verifier.VerifyString(tablePos, 156 /*UpdatedBy*/, false)
      && verifier.VerifyString(tablePos, 158 /*SourceDL*/, false)
      && verifier.VerifyString(tablePos, 160 /*Source*/, false)
      && verifier.VerifyString(tablePos, 162 /*Origin*/, false)
      && verifier.VerifyField(tablePos, 164 /*DataMode*/, 1 /*AircraftSortie_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 166 /*OrigNetwork*/, false)
      && verifier.VerifyString(tablePos, 168 /*Crew*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 170 /*SortiePPR*/, false)
