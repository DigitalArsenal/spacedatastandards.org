...
public struct OrbitDetermination_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static OrbitDetermination_Abridged GetRootAsOrbitDetermination_Abridged(ByteBuffer _bb) { return GetRootAsOrbitDetermination_Abridged(_bb, new OrbitDetermination_Abridged()); }
  public static OrbitDetermination_Abridged GetRootAsOrbitDetermination_Abridged(ByteBuffer _bb, OrbitDetermination_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OrbitDetermination_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ORBI"); }
  public static bool VerifyOrbitDetermination_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ORBI", false, OrbitDetermination_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public OrbitDetermination_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public OrbitDetermination_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(90); return o != 0 ? (OrbitDetermination_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OrbitDetermination_Abridged_dataMode_Enum.REAL; } }

  public static Offset<OrbitDetermination_Abridged> CreateOrbitDetermination_Abridged(FlatBufferBuilder builder,
      ...
      OrbitDetermination_Abridged_dataMode_Enum dataMode = OrbitDetermination_Abridged_dataMode_Enum.REAL) {
  ...
  public static void StartOrbitDetermination_Abridged(FlatBufferBuilder builder) { builder.StartTable(44); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OrbitDetermination_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(43, (sbyte)dataMode, 0); }
  public static Offset<OrbitDetermination_Abridged> EndOrbitDetermination_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OrbitDetermination_Abridged>(o);
  }
  public static void FinishOrbitDetermination_AbridgedBuffer(FlatBufferBuilder builder, Offset<OrbitDetermination_Abridged> offset) { builder.Finish(offset.Value, "ORBI"); }
  public static void FinishSizePrefixedOrbitDetermination_AbridgedBuffer(FlatBufferBuilder builder, Offset<OrbitDetermination_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "ORBI"); }
  public OrbitDetermination_AbridgedT UnPack() {
    var _o = new OrbitDetermination_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OrbitDetermination_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OrbitDetermination_Abridged> Pack(FlatBufferBuilder builder, OrbitDetermination_AbridgedT _o) {
    if (_o == null) return default(Offset<OrbitDetermination_Abridged>);
...
public class OrbitDetermination_AbridgedT
{
  ...
  public OrbitDetermination_Abridged_dataMode_Enum DataMode { get; set; }

  public OrbitDetermination_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = OrbitDetermination_Abridged_dataMode_Enum.REAL;
  }
  public static OrbitDetermination_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return OrbitDetermination_Abridged.GetRootAsOrbitDetermination_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OrbitDetermination_Abridged.FinishOrbitDetermination_AbridgedBuffer(fbb, OrbitDetermination_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OrbitDetermination_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 90 /*DataMode*/, 1 /*OrbitDetermination_Abridged_dataMode_Enum*/, 1, false)
