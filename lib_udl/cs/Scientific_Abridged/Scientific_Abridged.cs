...
public struct Scientific_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static Scientific_Abridged GetRootAsScientific_Abridged(ByteBuffer _bb, Scientific_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Scientific_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SCIE"); }
  public static bool VerifyScientific_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SCIE", false, Scientific_AbridgedVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Scientific_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(32); return o != 0 ? (Scientific_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Scientific_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<Scientific_Abridged> CreateScientific_Abridged(FlatBufferBuilder builder,
      ...
      Scientific_Abridged_dataMode_Enum dataMode = Scientific_Abridged_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Scientific_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(14, (sbyte)dataMode, 0); }
  ...
  public static Offset<Scientific_Abridged> EndScientific_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Scientific_Abridged>(o);
  }
  public static void FinishScientific_AbridgedBuffer(FlatBufferBuilder builder, Offset<Scientific_Abridged> offset) { builder.Finish(offset.Value, "SCIE"); }
  public static void FinishSizePrefixedScientific_AbridgedBuffer(FlatBufferBuilder builder, Offset<Scientific_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "SCIE"); }
  public Scientific_AbridgedT UnPack() {
    var _o = new Scientific_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Scientific_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Scientific_Abridged> Pack(FlatBufferBuilder builder, Scientific_AbridgedT _o) {
    if (_o == null) return default(Offset<Scientific_Abridged>);
...
public class Scientific_AbridgedT
{
  ...
  public Scientific_Abridged_dataMode_Enum DataMode { get; set; }
  public string IdEntity { get; set; }

  public Scientific_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = Scientific_Abridged_dataMode_Enum.REAL;
    this.IdEntity = null;
  }
  public static Scientific_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Scientific_Abridged.GetRootAsScientific_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Scientific_Abridged.FinishScientific_AbridgedBuffer(fbb, Scientific_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Scientific_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 32 /*DataMode*/, 1 /*Scientific_Abridged_dataMode_Enum*/, 1, false)
