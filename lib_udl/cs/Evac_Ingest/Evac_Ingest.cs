...
public struct Evac_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Evac_Ingest GetRootAsEvac_Ingest(ByteBuffer _bb) { return GetRootAsEvac_Ingest(_bb, new Evac_Ingest()); }
  public static Evac_Ingest GetRootAsEvac_Ingest(ByteBuffer _bb, Evac_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Evac_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EVAC"); }
  public static bool VerifyEvac_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EVAC", false, Evac_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Evac_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public Evac_Ingest_type_Enum Type { get { int o = __p.__offset(10); return o != 0 ? (Evac_Ingest_type_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Evac_Ingest_type_Enum.REQUEST; } }
  ...
  public Evac_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(82); return o != 0 ? (Evac_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Evac_Ingest_dataMode_Enum.REAL; } }

  public static Offset<Evac_Ingest> CreateEvac_Ingest(FlatBufferBuilder builder,
      StringOffset idOffset = default(StringOffset),
      StringOffset classificationMarkingOffset = default(StringOffset),
      StringOffset medevacIdOffset = default(StringOffset),
      Evac_Ingest_type_Enum type = Evac_Ingest_type_Enum.REQUEST,
      ...
      Evac_Ingest_dataMode_Enum dataMode = Evac_Ingest_dataMode_Enum.REAL) {
    builder.StartTable(40);
    Evac_Ingest.AddCntctFreq(builder, cntctFreq);
    Evac_Ingest.AddLe(builder, le);
    Evac_Ingest.AddCe(builder, ce);
    Evac_Ingest.AddPickupAlt(builder, pickupAlt);
    Evac_Ingest.AddPickupLon(builder, pickupLon);
    Evac_Ingest.AddPickupLat(builder, pickupLat);
    Evac_Ingest.AddOrigin(builder, originOffset);
    Evac_Ingest.AddSource(builder, sourceOffset);
    Evac_Ingest.AddCreatedBy(builder, createdByOffset);
    Evac_Ingest.AddCreatedAt(builder, createdAtOffset);
    Evac_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    Evac_Ingest.AddEnemyData(builder, enemyDataOffset);
    Evac_Ingest.AddCasualtyInfo(builder, casualtyInfoOffset);
    Evac_Ingest.AddComments(builder, commentsOffset);
    Evac_Ingest.AddNumCasualties(builder, numCasualties);
    Evac_Ingest.AddZoneContrCallSign(builder, zoneContrCallSignOffset);
    Evac_Ingest.AddZoneMarkingColor(builder, zoneMarkingColorOffset);
    Evac_Ingest.AddZoneSecurity(builder, zoneSecurityOffset);
    Evac_Ingest.AddZoneMarking(builder, zoneMarkingOffset);
    Evac_Ingest.AddZoneName(builder, zoneNameOffset);
    Evac_Ingest.AddTerrainRemarks(builder, terrainRemarksOffset);
    Evac_Ingest.AddObstaclesRemarks(builder, obstaclesRemarksOffset);
    Evac_Ingest.AddTerrain(builder, terrainOffset);
    Evac_Ingest.AddPickupTime(builder, pickupTimeOffset);
    Evac_Ingest.AddReqCallSign(builder, reqCallSignOffset);
    Evac_Ingest.AddReqTime(builder, reqTimeOffset);
    Evac_Ingest.AddReqNum(builder, reqNumOffset);
    Evac_Ingest.AddNumAmbulatory(builder, numAmbulatory);
    Evac_Ingest.AddNumLitter(builder, numLitter);
    Evac_Ingest.AddNumWIA(builder, numWIA);
    Evac_Ingest.AddNumKIA(builder, numKIA);
    Evac_Ingest.AddIdWeatherReport(builder, idWeatherReportOffset);
    Evac_Ingest.AddMissionType(builder, missionTypeOffset);
    Evac_Ingest.AddMedevacId(builder, medevacIdOffset);
    Evac_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    Evac_Ingest.AddId(builder, idOffset);
    Evac_Ingest.AddDataMode(builder, dataMode);
    Evac_Ingest.AddZoneHot(builder, zoneHot);
    Evac_Ingest.AddMedicReq(builder, medicReq);
    Evac_Ingest.AddType(builder, type);
    return Evac_Ingest.EndEvac_Ingest(builder);
  }

  public static void StartEvac_Ingest(FlatBufferBuilder builder) { builder.StartTable(40); }
  ...
  public static void AddType(FlatBufferBuilder builder, Evac_Ingest_type_Enum type) { builder.AddSbyte(3, (sbyte)type, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Evac_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(39, (sbyte)dataMode, 0); }
  public static Offset<Evac_Ingest> EndEvac_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Evac_Ingest>(o);
  }
  public static void FinishEvac_IngestBuffer(FlatBufferBuilder builder, Offset<Evac_Ingest> offset) { builder.Finish(offset.Value, "EVAC"); }
  public static void FinishSizePrefixedEvac_IngestBuffer(FlatBufferBuilder builder, Offset<Evac_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "EVAC"); }
  public Evac_IngestT UnPack() {
    var _o = new Evac_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Evac_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Evac_Ingest> Pack(FlatBufferBuilder builder, Evac_IngestT _o) {
    if (_o == null) return default(Offset<Evac_Ingest>);
...
public class Evac_IngestT
{
  public string Id { get; set; }
  public string ClassificationMarking { get; set; }
  public string MedevacId { get; set; }
  public Evac_Ingest_type_Enum Type { get; set; }
  ...
  public Evac_Ingest_dataMode_Enum DataMode { get; set; }

  public Evac_IngestT() {
    this.Id = null;
    this.ClassificationMarking = null;
    this.MedevacId = null;
    this.Type = Evac_Ingest_type_Enum.REQUEST;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Evac_Ingest_dataMode_Enum.REAL;
  }
  public static Evac_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Evac_Ingest.GetRootAsEvac_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Evac_Ingest.FinishEvac_IngestBuffer(fbb, Evac_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Evac_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*Type*/, 1 /*Evac_Ingest_type_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 82 /*DataMode*/, 1 /*Evac_Ingest_dataMode_Enum*/, 1, false)
