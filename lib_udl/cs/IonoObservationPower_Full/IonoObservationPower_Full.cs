...
public struct IonoObservationPower_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationPower_Full GetRootAsIonoObservationPower_Full(ByteBuffer _bb) { return GetRootAsIonoObservationPower_Full(_bb, new IonoObservationPower_Full()); }
  public static IonoObservationPower_Full GetRootAsIonoObservationPower_Full(ByteBuffer _bb, IonoObservationPower_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationPower_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationPower_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationPower_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationPower_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationPower_Full> CreateIonoObservationPower_Full(FlatBufferBuilder builder,
    ...
    IonoObservationPower_Full.AddData(builder, dataOffset);
    IonoObservationPower_Full.AddDimensionName(builder, dimensionNameOffset);
    IonoObservationPower_Full.AddDimensions(builder, dimensionsOffset);
    IonoObservationPower_Full.AddNotes(builder, notesOffset);
    return IonoObservationPower_Full.EndIonoObservationPower_Full(builder);
  }

  public static void StartIonoObservationPower_Full(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationPower_Full> EndIonoObservationPower_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationPower_Full>(o);
  }
  public static void FinishIonoObservationPower_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationPower_Full> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationPower_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationPower_Full> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationPower_FullT UnPack() {
    var _o = new IonoObservationPower_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationPower_FullT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationPower_Full> Pack(FlatBufferBuilder builder, IonoObservationPower_FullT _o) {
    if (_o == null) return default(Offset<IonoObservationPower_Full>);
    ...
    return CreateIonoObservationPower_Full(
      builder,
      _notes,
      _dimensions,
      _dimensionName,
...
public class IonoObservationPower_FullT
{
  ...
  public IonoObservationPower_FullT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationPower_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationPower_Full.GetRootAsIonoObservationPower_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationPower_Full.FinishIonoObservationPower_FullBuffer(fbb, IonoObservationPower_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationPower_FullVerify
{
