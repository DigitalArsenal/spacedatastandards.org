...
public struct SeradataEarlyWarning_Ingest : IFlatbufferObject
{
  ...
  public static Offset<SeradataEarlyWarning_Ingest.SeradataEarlyWarning_Ingest> CreateSeradataEarlyWarning_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<SeradataEarlyWarning_Ingest.SeradataEarlyWarning_Ingest> EndSeradataEarlyWarning_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SeradataEarlyWarning_Ingest.SeradataEarlyWarning_Ingest>(o);
  }
  ...
  public static Offset<SeradataEarlyWarning_Ingest.SeradataEarlyWarning_Ingest> Pack(FlatBufferBuilder builder, SeradataEarlyWarning_IngestT _o) {
    if (_o == null) return default(Offset<SeradataEarlyWarning_Ingest.SeradataEarlyWarning_Ingest>);
