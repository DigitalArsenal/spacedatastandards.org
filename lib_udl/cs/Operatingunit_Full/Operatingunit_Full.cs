...
public struct Operatingunit_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static Operatingunit_Full GetRootAsOperatingunit_Full(ByteBuffer _bb, Operatingunit_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Operatingunit_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "OPER"); }
  public static bool VerifyOperatingunit_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("OPER", false, Operatingunit_FullVerify.Verify); }
  ...
  public Operatingunit_Full_dataMode_Enum DataMode { get { int o = __p.__offset(128); return o != 0 ? (Operatingunit_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Operatingunit_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<Operatingunit_Full> CreateOperatingunit_Full(FlatBufferBuilder builder,
      ...
      Operatingunit_Full_dataMode_Enum dataMode = Operatingunit_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Operatingunit_Full_dataMode_Enum dataMode) { builder.AddSbyte(62, (sbyte)dataMode, 0); }
  ...
  public static Offset<Operatingunit_Full> EndOperatingunit_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Operatingunit_Full>(o);
  }
  public static void FinishOperatingunit_FullBuffer(FlatBufferBuilder builder, Offset<Operatingunit_Full> offset) { builder.Finish(offset.Value, "OPER"); }
  public static void FinishSizePrefixedOperatingunit_FullBuffer(FlatBufferBuilder builder, Offset<Operatingunit_Full> offset) { builder.FinishSizePrefixed(offset.Value, "OPER"); }
  public Operatingunit_FullT UnPack() {
    var _o = new Operatingunit_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Operatingunit_FullT _o) {
  ...
  public static Offset<Operatingunit_Full> Pack(FlatBufferBuilder builder, Operatingunit_FullT _o) {
    if (_o == null) return default(Offset<Operatingunit_Full>);
...
public class Operatingunit_FullT
{
  ...
  public Operatingunit_Full_dataMode_Enum DataMode { get; set; }
  public string Organization { get; set; }
  public string Location { get; set; }

  public Operatingunit_FullT() {
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Operatingunit_Full_dataMode_Enum.REAL;
    this.Organization = null;
    this.Location = null;
  }
  public static Operatingunit_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Operatingunit_Full.GetRootAsOperatingunit_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Operatingunit_Full.FinishOperatingunit_FullBuffer(fbb, Operatingunit_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Operatingunit_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 128 /*DataMode*/, 1 /*Operatingunit_Full_dataMode_Enum*/, 1, false)
