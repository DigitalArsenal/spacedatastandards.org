...
public struct AircraftMissionRequirements_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AircraftMissionRequirements_Ingest GetRootAsAircraftMissionRequirements_Ingest(ByteBuffer _bb) { return GetRootAsAircraftMissionRequirements_Ingest(_bb, new AircraftMissionRequirements_Ingest()); }
  public static AircraftMissionRequirements_Ingest GetRootAsAircraftMissionRequirements_Ingest(ByteBuffer _bb, AircraftMissionRequirements_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AircraftMissionRequirements_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRC"); }
  public static bool VerifyAircraftMissionRequirements_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRC", false, AircraftMissionRequirements_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AircraftMissionRequirements_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<AircraftMissionRequirements_Ingest> CreateAircraftMissionRequirements_Ingest(FlatBufferBuilder builder,
    ...
    AircraftMissionRequirements_Ingest.AddOutsizeWeight(builder, outsizeWeight);
    AircraftMissionRequirements_Ingest.AddOversizeWeight(builder, oversizeWeight);
    AircraftMissionRequirements_Ingest.AddBulkWeight(builder, bulkWeight);
    AircraftMissionRequirements_Ingest.AddLad(builder, ladOffset);
    AircraftMissionRequirements_Ingest.AddEad(builder, eadOffset);
    AircraftMissionRequirements_Ingest.AddNumAttendant(builder, numAttendant);
    AircraftMissionRequirements_Ingest.AddNumAmbulatory(builder, numAmbulatory);
    AircraftMissionRequirements_Ingest.AddNumLitter(builder, numLitter);
    AircraftMissionRequirements_Ingest.AddNumPax(builder, numPax);
    AircraftMissionRequirements_Ingest.AddOplan(builder, oplanOffset);
    AircraftMissionRequirements_Ingest.AddProjName(builder, projNameOffset);
    AircraftMissionRequirements_Ingest.AddTransReqNum(builder, transReqNumOffset);
    AircraftMissionRequirements_Ingest.AddUln(builder, ulnOffset);
    AircraftMissionRequirements_Ingest.AddOffloadLOCode(builder, offloadLOCodeOffset);
    AircraftMissionRequirements_Ingest.AddOffloadId(builder, offloadId);
    AircraftMissionRequirements_Ingest.AddOnloadLOCode(builder, onloadLOCodeOffset);
    AircraftMissionRequirements_Ingest.AddOnloadId(builder, onloadId);
    AircraftMissionRequirements_Ingest.AddGdssReqId(builder, gdssReqIdOffset);
    return AircraftMissionRequirements_Ingest.EndAircraftMissionRequirements_Ingest(builder);
  }

  public static void StartAircraftMissionRequirements_Ingest(FlatBufferBuilder builder) { builder.StartTable(18); }
  ...
  public static Offset<AircraftMissionRequirements_Ingest> EndAircraftMissionRequirements_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AircraftMissionRequirements_Ingest>(o);
  }
  public static void FinishAircraftMissionRequirements_IngestBuffer(FlatBufferBuilder builder, Offset<AircraftMissionRequirements_Ingest> offset) { builder.Finish(offset.Value, "AIRC"); }
  public static void FinishSizePrefixedAircraftMissionRequirements_IngestBuffer(FlatBufferBuilder builder, Offset<AircraftMissionRequirements_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AIRC"); }
  public AircraftMissionRequirements_IngestT UnPack() {
    var _o = new AircraftMissionRequirements_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AircraftMissionRequirements_IngestT _o) {
  ...
  public static Offset<AircraftMissionRequirements_Ingest> Pack(FlatBufferBuilder builder, AircraftMissionRequirements_IngestT _o) {
    if (_o == null) return default(Offset<AircraftMissionRequirements_Ingest>);
...
public class AircraftMissionRequirements_IngestT
{
  ...
  public AircraftMissionRequirements_IngestT() {
    this.GdssReqId = null;
    this.OnloadId = 0;
  ...
  public static AircraftMissionRequirements_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AircraftMissionRequirements_Ingest.GetRootAsAircraftMissionRequirements_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AircraftMissionRequirements_Ingest.FinishAircraftMissionRequirements_IngestBuffer(fbb, AircraftMissionRequirements_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AircraftMissionRequirements_IngestVerify
{
