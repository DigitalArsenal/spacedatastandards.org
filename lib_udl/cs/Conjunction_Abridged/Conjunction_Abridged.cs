...
public struct Conjunction_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static Conjunction_Abridged GetRootAsConjunction_Abridged(ByteBuffer _bb, Conjunction_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Conjunction_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "CONJ"); }
  public static bool VerifyConjunction_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("CONJ", false, Conjunction_AbridgedVerify.Verify); }
  ...
  public Conjunction_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(120); return o != 0 ? (Conjunction_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Conjunction_Abridged_dataMode_Enum.REAL; } }
  ...
  /// Constraints: No constraints specified.
  public string StateVector1 { get { int o = __p.__offset(126); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetStateVector1Bytes() { return __p.__vector_as_span<byte>(126, 1); }
#else
  public ArraySegment<byte>? GetStateVector1Bytes() { return __p.__vector_as_arraysegment(126); }
#endif
  public byte[] GetStateVector1Array() { return __p.__vector_as_array<byte>(126); }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string StateVector2 { get { int o = __p.__offset(128); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetStateVector2Bytes() { return __p.__vector_as_span<byte>(128, 1); }
#else
  public ArraySegment<byte>? GetStateVector2Bytes() { return __p.__vector_as_arraysegment(128); }
#endif
  public byte[] GetStateVector2Array() { return __p.__vector_as_array<byte>(128); }
  /// Satellite/catalog number of the target on-orbit primary object.
  /// Example: /// Example: 1
  /// Constraints: No constraints specified.
  public int SatNo1 { get { int o = __p.__offset(130); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  /// Satellite/catalog number of the target on-orbit secondary object.
  /// Example: /// Example: 2
  /// Constraints: No constraints specified.
  public int SatNo2 { get { int o = __p.__offset(132); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  /// Optional place holder for an OnOrbit ID that does not exist in UDL.
  /// Example: /// Example: ORIGONORBIT1-ID
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string OrigIdOnOrbit1 { get { int o = __p.__offset(134); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOrigIdOnOrbit1Bytes() { return __p.__vector_as_span<byte>(134, 1); }
#else
  public ArraySegment<byte>? GetOrigIdOnOrbit1Bytes() { return __p.__vector_as_arraysegment(134); }
#endif
  public byte[] GetOrigIdOnOrbit1Array() { return __p.__vector_as_array<byte>(134); }
  /// Optional place holder for an OnOrbit ID that does not exist in UDL.
  /// Example: /// Example: ORIGONORBIT2-ID
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string OrigIdOnOrbit2 { get { int o = __p.__offset(136); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOrigIdOnOrbit2Bytes() { return __p.__vector_as_span<byte>(136, 1); }
#else
  public ArraySegment<byte>? GetOrigIdOnOrbit2Bytes() { return __p.__vector_as_arraysegment(136); }
#endif
  public byte[] GetOrigIdOnOrbit2Array() { return __p.__vector_as_array<byte>(136); }
  ...
  public static Offset<Conjunction_Abridged> CreateConjunction_Abridged(FlatBufferBuilder builder,
      ...
      Conjunction_Abridged_dataMode_Enum dataMode = Conjunction_Abridged_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Conjunction_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(58, (sbyte)dataMode, 0); }
  ...
  public static void AddStateVector1(FlatBufferBuilder builder, StringOffset stateVector1Offset) { builder.AddOffset(61, stateVector1Offset.Value, 0); }
  public static void AddStateVector2(FlatBufferBuilder builder, StringOffset stateVector2Offset) { builder.AddOffset(62, stateVector2Offset.Value, 0); }
  ...
  public static void AddOrigIdOnOrbit1(FlatBufferBuilder builder, StringOffset origIdOnOrbit1Offset) { builder.AddOffset(65, origIdOnOrbit1Offset.Value, 0); }
  public static void AddOrigIdOnOrbit2(FlatBufferBuilder builder, StringOffset origIdOnOrbit2Offset) { builder.AddOffset(66, origIdOnOrbit2Offset.Value, 0); }
  ...
  public static Offset<Conjunction_Abridged> EndConjunction_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Conjunction_Abridged>(o);
  }
  public static void FinishConjunction_AbridgedBuffer(FlatBufferBuilder builder, Offset<Conjunction_Abridged> offset) { builder.Finish(offset.Value, "CONJ"); }
  public static void FinishSizePrefixedConjunction_AbridgedBuffer(FlatBufferBuilder builder, Offset<Conjunction_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "CONJ"); }
  public Conjunction_AbridgedT UnPack() {
    var _o = new Conjunction_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Conjunction_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Conjunction_Abridged> Pack(FlatBufferBuilder builder, Conjunction_AbridgedT _o) {
    if (_o == null) return default(Offset<Conjunction_Abridged>);
...
public class Conjunction_AbridgedT
{
  ...
  public Conjunction_Abridged_dataMode_Enum DataMode { get; set; }
  ...
  public Conjunction_AbridgedT() {
    ...
    this.DataMode = Conjunction_Abridged_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
  ...
  public static Conjunction_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Conjunction_Abridged.GetRootAsConjunction_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Conjunction_Abridged.FinishConjunction_AbridgedBuffer(fbb, Conjunction_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Conjunction_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 120 /*DataMode*/, 1 /*Conjunction_Abridged_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 122 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 124 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 126 /*StateVector1*/, false)
      && verifier.VerifyString(tablePos, 128 /*StateVector2*/, false)
      && verifier.VerifyField(tablePos, 130 /*SatNo1*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 132 /*SatNo2*/, 4 /*int*/, 4, false)
      && verifier.VerifyString(tablePos, 134 /*OrigIdOnOrbit1*/, false)
      && verifier.VerifyString(tablePos, 136 /*OrigIdOnOrbit2*/, false)
