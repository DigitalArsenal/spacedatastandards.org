...
public struct OnorbitThrusterStatus_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static OnorbitThrusterStatus_Abridged GetRootAsOnorbitThrusterStatus_Abridged(ByteBuffer _bb) { return GetRootAsOnorbitThrusterStatus_Abridged(_bb, new OnorbitThrusterStatus_Abridged()); }
  public static OnorbitThrusterStatus_Abridged GetRootAsOnorbitThrusterStatus_Abridged(ByteBuffer _bb, OnorbitThrusterStatus_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OnorbitThrusterStatus_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONOR"); }
  public static bool VerifyOnorbitThrusterStatus_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONOR", false, OnorbitThrusterStatus_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public OnorbitThrusterStatus_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public OnorbitThrusterStatus_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(50); return o != 0 ? (OnorbitThrusterStatus_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OnorbitThrusterStatus_Abridged_dataMode_Enum.REAL; } }

  public static Offset<OnorbitThrusterStatus_Abridged> CreateOnorbitThrusterStatus_Abridged(FlatBufferBuilder builder,
      ...
      OnorbitThrusterStatus_Abridged_dataMode_Enum dataMode = OnorbitThrusterStatus_Abridged_dataMode_Enum.REAL) {
    builder.StartTable(24);
    OnorbitThrusterStatus_Abridged.AddIsp(builder, isp);
    OnorbitThrusterStatus_Abridged.AddThrustMax(builder, thrustMax);
    OnorbitThrusterStatus_Abridged.AddMaxDeltaV(builder, maxDeltaV);
    OnorbitThrusterStatus_Abridged.AddEstDeltaV(builder, estDeltaV);
    OnorbitThrusterStatus_Abridged.AddMinDeltaV(builder, minDeltaV);
    OnorbitThrusterStatus_Abridged.AddTotalDeltaV(builder, totalDeltaV);
    OnorbitThrusterStatus_Abridged.AddFuelMassUnc(builder, fuelMassUnc);
    OnorbitThrusterStatus_Abridged.AddFuelMass(builder, fuelMass);
    OnorbitThrusterStatus_Abridged.AddPropMassMax(builder, propMassMax);
    OnorbitThrusterStatus_Abridged.AddPropMassMedian(builder, propMassMedian);
    OnorbitThrusterStatus_Abridged.AddPropMassAvg(builder, propMassAvg);
    OnorbitThrusterStatus_Abridged.AddPropMassMin(builder, propMassMin);
    OnorbitThrusterStatus_Abridged.AddOrigNetwork(builder, origNetworkOffset);
    OnorbitThrusterStatus_Abridged.AddOrigin(builder, originOffset);
    OnorbitThrusterStatus_Abridged.AddSource(builder, sourceOffset);
    OnorbitThrusterStatus_Abridged.AddCreatedBy(builder, createdByOffset);
    OnorbitThrusterStatus_Abridged.AddCreatedAt(builder, createdAtOffset);
    OnorbitThrusterStatus_Abridged.AddStatusTime(builder, statusTimeOffset);
    OnorbitThrusterStatus_Abridged.AddName(builder, nameOffset);
    OnorbitThrusterStatus_Abridged.AddIdOnorbitThruster(builder, idOnorbitThrusterOffset);
    OnorbitThrusterStatus_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    OnorbitThrusterStatus_Abridged.AddId(builder, idOffset);
    OnorbitThrusterStatus_Abridged.AddDataMode(builder, dataMode);
    OnorbitThrusterStatus_Abridged.AddOperational(builder, operational);
    return OnorbitThrusterStatus_Abridged.EndOnorbitThrusterStatus_Abridged(builder);
  }

  public static void StartOnorbitThrusterStatus_Abridged(FlatBufferBuilder builder) { builder.StartTable(24); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OnorbitThrusterStatus_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(23, (sbyte)dataMode, 0); }
  public static Offset<OnorbitThrusterStatus_Abridged> EndOnorbitThrusterStatus_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OnorbitThrusterStatus_Abridged>(o);
  }
  public static void FinishOnorbitThrusterStatus_AbridgedBuffer(FlatBufferBuilder builder, Offset<OnorbitThrusterStatus_Abridged> offset) { builder.Finish(offset.Value, "ONOR"); }
  public static void FinishSizePrefixedOnorbitThrusterStatus_AbridgedBuffer(FlatBufferBuilder builder, Offset<OnorbitThrusterStatus_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "ONOR"); }
  public OnorbitThrusterStatus_AbridgedT UnPack() {
    var _o = new OnorbitThrusterStatus_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OnorbitThrusterStatus_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OnorbitThrusterStatus_Abridged> Pack(FlatBufferBuilder builder, OnorbitThrusterStatus_AbridgedT _o) {
    if (_o == null) return default(Offset<OnorbitThrusterStatus_Abridged>);
...
public class OnorbitThrusterStatus_AbridgedT
{
  ...
  public OnorbitThrusterStatus_Abridged_dataMode_Enum DataMode { get; set; }

  public OnorbitThrusterStatus_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = OnorbitThrusterStatus_Abridged_dataMode_Enum.REAL;
  }
  public static OnorbitThrusterStatus_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return OnorbitThrusterStatus_Abridged.GetRootAsOnorbitThrusterStatus_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OnorbitThrusterStatus_Abridged.FinishOnorbitThrusterStatus_AbridgedBuffer(fbb, OnorbitThrusterStatus_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OnorbitThrusterStatus_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 50 /*DataMode*/, 1 /*OnorbitThrusterStatus_Abridged_dataMode_Enum*/, 1, false)
