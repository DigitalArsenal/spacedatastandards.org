...
public struct SOIObservationSet_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SOIObservationSet_Abridged GetRootAsSOIObservationSet_Abridged(ByteBuffer _bb) { return GetRootAsSOIObservationSet_Abridged(_bb, new SOIObservationSet_Abridged()); }
  public static SOIObservationSet_Abridged GetRootAsSOIObservationSet_Abridged(ByteBuffer _bb, SOIObservationSet_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SOIObservationSet_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SOIO"); }
  public static bool VerifySOIObservationSet_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SOIO", false, SOIObservationSet_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SOIObservationSet_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public SOIObservationSet_Abridged_type_Enum Type { get { int o = __p.__offset(48); return o != 0 ? (SOIObservationSet_Abridged_type_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SOIObservationSet_Abridged_type_Enum.OPTICAL; } }
  ...
  public SOIObservationSet_Abridged_referenceFrame_Enum ReferenceFrame { get { int o = __p.__offset(54); return o != 0 ? (SOIObservationSet_Abridged_referenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SOIObservationSet_Abridged_referenceFrame_Enum.J2000; } }
  /// The reference frame of the observing sensor state. If the senReferenceFrame is null it is assumed to be J2000.
  /// Example: /// Example: J2000
  /// Constraints: Minimum length = 0, Maximum length = 24
  public SOIObservationSet_Abridged_senReferenceFrame_Enum SenReferenceFrame { get { int o = __p.__offset(56); return o != 0 ? (SOIObservationSet_Abridged_senReferenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SOIObservationSet_Abridged_senReferenceFrame_Enum.J2000; } }
  ...
  /// Constraints: No constraints specified.
  public string CreatedAt { get { int o = __p.__offset(132); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedAtBytes() { return __p.__vector_as_span<byte>(132, 1); }
#else
  public ArraySegment<byte>? GetCreatedAtBytes() { return __p.__vector_as_arraysegment(132); }
#endif
  public byte[] GetCreatedAtArray() { return __p.__vector_as_array<byte>(132); }
  /// Application user who created the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string CreatedBy { get { int o = __p.__offset(134); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedByBytes() { return __p.__vector_as_span<byte>(134, 1); }
#else
  public ArraySegment<byte>? GetCreatedByBytes() { return __p.__vector_as_arraysegment(134); }
#endif
  public byte[] GetCreatedByArray() { return __p.__vector_as_array<byte>(134); }
  /// Source of the data.
  /// Example: /// Example: Bluestaq
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string Source { get { int o = __p.__offset(136); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceBytes() { return __p.__vector_as_span<byte>(136, 1); }
#else
  public ArraySegment<byte>? GetSourceBytes() { return __p.__vector_as_arraysegment(136); }
#endif
  public byte[] GetSourceArray() { return __p.__vector_as_array<byte>(136); }
  /// Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
  /// Example: /// Example: THIRD_PARTY_DATASOURCE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Origin { get { int o = __p.__offset(138); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOriginBytes() { return __p.__vector_as_span<byte>(138, 1); }
#else
  public ArraySegment<byte>? GetOriginBytes() { return __p.__vector_as_arraysegment(138); }
#endif
  public byte[] GetOriginArray() { return __p.__vector_as_array<byte>(138); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SOIObservationSet_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(144); return o != 0 ? (SOIObservationSet_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SOIObservationSet_Abridged_dataMode_Enum.REAL; } }

  public static Offset<SOIObservationSet_Abridged> CreateSOIObservationSet_Abridged(FlatBufferBuilder builder,
      ...
      int numObs = 0,
      SOIObservationSet_Abridged_type_Enum type = SOIObservationSet_Abridged_type_Enum.OPTICAL,
      double polarAngleStart = 0.0,
      double polarAngleEnd = 0.0,
      SOIObservationSet_Abridged_referenceFrame_Enum referenceFrame = SOIObservationSet_Abridged_referenceFrame_Enum.J2000,
      SOIObservationSet_Abridged_senReferenceFrame_Enum senReferenceFrame = SOIObservationSet_Abridged_senReferenceFrame_Enum.J2000,
      ...
      SOIObservationSet_Abridged_dataMode_Enum dataMode = SOIObservationSet_Abridged_dataMode_Enum.REAL) {
  ...
  public static void StartSOIObservationSet_Abridged(FlatBufferBuilder builder) { builder.StartTable(71); }
  ...
  public static void AddType(FlatBufferBuilder builder, SOIObservationSet_Abridged_type_Enum type) { builder.AddSbyte(22, (sbyte)type, 0); }
  ...
  public static void AddReferenceFrame(FlatBufferBuilder builder, SOIObservationSet_Abridged_referenceFrame_Enum referenceFrame) { builder.AddSbyte(25, (sbyte)referenceFrame, 0); }
  public static void AddSenReferenceFrame(FlatBufferBuilder builder, SOIObservationSet_Abridged_senReferenceFrame_Enum senReferenceFrame) { builder.AddSbyte(26, (sbyte)senReferenceFrame, 0); }
  ...
  public static void AddCreatedAt(FlatBufferBuilder builder, StringOffset createdAtOffset) { builder.AddOffset(64, createdAtOffset.Value, 0); }
  public static void AddCreatedBy(FlatBufferBuilder builder, StringOffset createdByOffset) { builder.AddOffset(65, createdByOffset.Value, 0); }
  public static void AddSource(FlatBufferBuilder builder, StringOffset sourceOffset) { builder.AddOffset(66, sourceOffset.Value, 0); }
  public static void AddOrigin(FlatBufferBuilder builder, StringOffset originOffset) { builder.AddOffset(67, originOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SOIObservationSet_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(70, (sbyte)dataMode, 0); }
  public static Offset<SOIObservationSet_Abridged> EndSOIObservationSet_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SOIObservationSet_Abridged>(o);
  }
  public static void FinishSOIObservationSet_AbridgedBuffer(FlatBufferBuilder builder, Offset<SOIObservationSet_Abridged> offset) { builder.Finish(offset.Value, "SOIO"); }
  public static void FinishSizePrefixedSOIObservationSet_AbridgedBuffer(FlatBufferBuilder builder, Offset<SOIObservationSet_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "SOIO"); }
  public SOIObservationSet_AbridgedT UnPack() {
    var _o = new SOIObservationSet_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SOIObservationSet_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SOIObservationSet_Abridged> Pack(FlatBufferBuilder builder, SOIObservationSet_AbridgedT _o) {
    if (_o == null) return default(Offset<SOIObservationSet_Abridged>);
...
public class SOIObservationSet_AbridgedT
{
  ...
  public SOIObservationSet_Abridged_type_Enum Type { get; set; }
  public double PolarAngleStart { get; set; }
  public double PolarAngleEnd { get; set; }
  public SOIObservationSet_Abridged_referenceFrame_Enum ReferenceFrame { get; set; }
  public SOIObservationSet_Abridged_senReferenceFrame_Enum SenReferenceFrame { get; set; }
  ...
  public SOIObservationSet_Abridged_dataMode_Enum DataMode { get; set; }

  public SOIObservationSet_AbridgedT() {
    this.Id = null;
    ...
    this.EndTime = null;
    this.NumObs = 0;
    this.Type = SOIObservationSet_Abridged_type_Enum.OPTICAL;
    this.PolarAngleStart = 0.0;
    this.PolarAngleEnd = 0.0;
    this.ReferenceFrame = SOIObservationSet_Abridged_referenceFrame_Enum.J2000;
    this.SenReferenceFrame = SOIObservationSet_Abridged_senReferenceFrame_Enum.J2000;
    ...
    this.SourceDL = null;
    this.DataMode = SOIObservationSet_Abridged_dataMode_Enum.REAL;
  }
  public static SOIObservationSet_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return SOIObservationSet_Abridged.GetRootAsSOIObservationSet_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SOIObservationSet_Abridged.FinishSOIObservationSet_AbridgedBuffer(fbb, SOIObservationSet_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SOIObservationSet_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 48 /*Type*/, 1 /*SOIObservationSet_Abridged_type_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 54 /*ReferenceFrame*/, 1 /*SOIObservationSet_Abridged_referenceFrame_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 56 /*SenReferenceFrame*/, 1 /*SOIObservationSet_Abridged_senReferenceFrame_Enum*/, 1, false)
      ...
      && verifier.VerifyString(tablePos, 132 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 134 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 136 /*Source*/, false)
      && verifier.VerifyString(tablePos, 138 /*Origin*/, false)
      && verifier.VerifyString(tablePos, 140 /*OrigNetwork*/, false)
      && verifier.VerifyString(tablePos, 142 /*SourceDL*/, false)
      && verifier.VerifyField(tablePos, 144 /*DataMode*/, 1 /*SOIObservationSet_Abridged_dataMode_Enum*/, 1, false)
