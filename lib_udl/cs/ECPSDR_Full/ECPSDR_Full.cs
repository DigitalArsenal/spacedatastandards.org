...
public struct ECPSDR_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static ECPSDR_Full GetRootAsECPSDR_Full(ByteBuffer _bb) { return GetRootAsECPSDR_Full(_bb, new ECPSDR_Full()); }
  public static ECPSDR_Full GetRootAsECPSDR_Full(ByteBuffer _bb, ECPSDR_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool ECPSDR_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ECPS"); }
  public static bool VerifyECPSDR_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ECPS", false, ECPSDR_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ECPSDR_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string UpdatedAt { get { int o = __p.__offset(100); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedAtBytes() { return __p.__vector_as_span<byte>(100, 1); }
#else
  public ArraySegment<byte>? GetUpdatedAtBytes() { return __p.__vector_as_arraysegment(100); }
#endif
  public byte[] GetUpdatedAtArray() { return __p.__vector_as_array<byte>(100); }
  /// Application user who updated the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string UpdatedBy { get { int o = __p.__offset(102); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedByBytes() { return __p.__vector_as_span<byte>(102, 1); }
#else
  public ArraySegment<byte>? GetUpdatedByBytes() { return __p.__vector_as_arraysegment(102); }
#endif
  public byte[] GetUpdatedByArray() { return __p.__vector_as_array<byte>(102); }
  /// Source of the data.
  ...
  /// Example: /// Example: TEST
  /// Constraints: Minimum length = 1, Maximum length = 32
  public ECPSDR_Full_dataMode_Enum DataMode { get { int o = __p.__offset(110); return o != 0 ? (ECPSDR_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : ECPSDR_Full_dataMode_Enum.REAL; } }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string OnOrbit { get { int o = __p.__offset(112); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbitBytes() { return __p.__vector_as_span<byte>(112, 1); }
#else
  public ArraySegment<byte>? GetOnOrbitBytes() { return __p.__vector_as_arraysegment(112); }
#endif
  public byte[] GetOnOrbitArray() { return __p.__vector_as_array<byte>(112); }

  public static Offset<ECPSDR_Full> CreateECPSDR_Full(FlatBufferBuilder builder,
      ...
      ECPSDR_Full_dataMode_Enum dataMode = ECPSDR_Full_dataMode_Enum.REAL,
  ...
  public static void StartECPSDR_Full(FlatBufferBuilder builder) { builder.StartTable(55); }
  ...
  public static void AddUpdatedAt(FlatBufferBuilder builder, StringOffset updatedAtOffset) { builder.AddOffset(48, updatedAtOffset.Value, 0); }
  public static void AddUpdatedBy(FlatBufferBuilder builder, StringOffset updatedByOffset) { builder.AddOffset(49, updatedByOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, ECPSDR_Full_dataMode_Enum dataMode) { builder.AddSbyte(53, (sbyte)dataMode, 0); }
  public static void AddOnOrbit(FlatBufferBuilder builder, StringOffset onOrbitOffset) { builder.AddOffset(54, onOrbitOffset.Value, 0); }
  public static Offset<ECPSDR_Full> EndECPSDR_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ECPSDR_Full>(o);
  }
  public static void FinishECPSDR_FullBuffer(FlatBufferBuilder builder, Offset<ECPSDR_Full> offset) { builder.Finish(offset.Value, "ECPS"); }
  public static void FinishSizePrefixedECPSDR_FullBuffer(FlatBufferBuilder builder, Offset<ECPSDR_Full> offset) { builder.FinishSizePrefixed(offset.Value, "ECPS"); }
  public ECPSDR_FullT UnPack() {
    var _o = new ECPSDR_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(ECPSDR_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<ECPSDR_Full> Pack(FlatBufferBuilder builder, ECPSDR_FullT _o) {
    if (_o == null) return default(Offset<ECPSDR_Full>);
...
public class ECPSDR_FullT
{
  ...
  public ECPSDR_Full_dataMode_Enum DataMode { get; set; }
  ...
  public ECPSDR_FullT() {
    ...
    this.DataMode = ECPSDR_Full_dataMode_Enum.REAL;
    this.OnOrbit = null;
  }
  public static ECPSDR_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return ECPSDR_Full.GetRootAsECPSDR_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    ECPSDR_Full.FinishECPSDR_FullBuffer(fbb, ECPSDR_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class ECPSDR_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyString(tablePos, 100 /*UpdatedAt*/, false)
      && verifier.VerifyString(tablePos, 102 /*UpdatedBy*/, false)
      ...
      && verifier.VerifyField(tablePos, 110 /*DataMode*/, 1 /*ECPSDR_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 112 /*OnOrbit*/, false)
