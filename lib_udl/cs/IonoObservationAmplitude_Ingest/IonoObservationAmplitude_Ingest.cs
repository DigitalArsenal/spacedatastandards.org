...
public struct IonoObservationAmplitude_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationAmplitude_Ingest GetRootAsIonoObservationAmplitude_Ingest(ByteBuffer _bb) { return GetRootAsIonoObservationAmplitude_Ingest(_bb, new IonoObservationAmplitude_Ingest()); }
  public static IonoObservationAmplitude_Ingest GetRootAsIonoObservationAmplitude_Ingest(ByteBuffer _bb, IonoObservationAmplitude_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationAmplitude_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationAmplitude_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationAmplitude_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationAmplitude_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationAmplitude_Ingest> CreateIonoObservationAmplitude_Ingest(FlatBufferBuilder builder,
    ...
    IonoObservationAmplitude_Ingest.AddData(builder, dataOffset);
    IonoObservationAmplitude_Ingest.AddDimensionName(builder, dimensionNameOffset);
    IonoObservationAmplitude_Ingest.AddDimensions(builder, dimensionsOffset);
    IonoObservationAmplitude_Ingest.AddNotes(builder, notesOffset);
    return IonoObservationAmplitude_Ingest.EndIonoObservationAmplitude_Ingest(builder);
  }

  public static void StartIonoObservationAmplitude_Ingest(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationAmplitude_Ingest> EndIonoObservationAmplitude_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationAmplitude_Ingest>(o);
  }
  public static void FinishIonoObservationAmplitude_IngestBuffer(FlatBufferBuilder builder, Offset<IonoObservationAmplitude_Ingest> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationAmplitude_IngestBuffer(FlatBufferBuilder builder, Offset<IonoObservationAmplitude_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationAmplitude_IngestT UnPack() {
    var _o = new IonoObservationAmplitude_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationAmplitude_IngestT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationAmplitude_Ingest> Pack(FlatBufferBuilder builder, IonoObservationAmplitude_IngestT _o) {
    if (_o == null) return default(Offset<IonoObservationAmplitude_Ingest>);
    ...
    return CreateIonoObservationAmplitude_Ingest(
      builder,
      _notes,
      _dimensions,
      _dimensionName,
...
public class IonoObservationAmplitude_IngestT
{
  ...
  public IonoObservationAmplitude_IngestT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationAmplitude_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationAmplitude_Ingest.GetRootAsIonoObservationAmplitude_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationAmplitude_Ingest.FinishIonoObservationAmplitude_IngestBuffer(fbb, IonoObservationAmplitude_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationAmplitude_IngestVerify
{
