...
public struct EffectResponseActionsList_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EffectResponseActionsList_Abridged GetRootAsEffectResponseActionsList_Abridged(ByteBuffer _bb) { return GetRootAsEffectResponseActionsList_Abridged(_bb, new EffectResponseActionsList_Abridged()); }
  public static EffectResponseActionsList_Abridged GetRootAsEffectResponseActionsList_Abridged(ByteBuffer _bb, EffectResponseActionsList_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EffectResponseActionsList_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EFFE"); }
  public static bool VerifyEffectResponseActionsList_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EFFE", false, EffectResponseActionsList_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EffectResponseActionsList_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<EffectResponseActionsList_Abridged> CreateEffectResponseActionsList_Abridged(FlatBufferBuilder builder,
    ...
    EffectResponseActionsList_Abridged.AddWeaponInterceptAlt(builder, weaponInterceptAlt);
    EffectResponseActionsList_Abridged.AddWeaponInterceptLon(builder, weaponInterceptLon);
    EffectResponseActionsList_Abridged.AddWeaponInterceptLat(builder, weaponInterceptLat);
    EffectResponseActionsList_Abridged.AddActorInterceptAlt(builder, actorInterceptAlt);
    EffectResponseActionsList_Abridged.AddActorInterceptLon(builder, actorInterceptLon);
    EffectResponseActionsList_Abridged.AddActorInterceptLat(builder, actorInterceptLat);
    EffectResponseActionsList_Abridged.AddActionMetrics(builder, actionMetricsOffset);
    EffectResponseActionsList_Abridged.AddTargetSrcId(builder, targetSrcIdOffset);
    EffectResponseActionsList_Abridged.AddTargetSrcType(builder, targetSrcTypeOffset);
    EffectResponseActionsList_Abridged.AddEffector(builder, effectorOffset);
    EffectResponseActionsList_Abridged.AddActionActorSrcId(builder, actionActorSrcIdOffset);
    EffectResponseActionsList_Abridged.AddActionActorSrcType(builder, actionActorSrcTypeOffset);
    EffectResponseActionsList_Abridged.AddTotEndTime(builder, totEndTimeOffset);
    EffectResponseActionsList_Abridged.AddTotStartTime(builder, totStartTimeOffset);
    EffectResponseActionsList_Abridged.AddActionEndTime(builder, actionEndTimeOffset);
    EffectResponseActionsList_Abridged.AddActionStartTime(builder, actionStartTimeOffset);
    EffectResponseActionsList_Abridged.AddActionId(builder, actionIdOffset);
    EffectResponseActionsList_Abridged.AddSummary(builder, summaryOffset);
    return EffectResponseActionsList_Abridged.EndEffectResponseActionsList_Abridged(builder);
  }

  public static void StartEffectResponseActionsList_Abridged(FlatBufferBuilder builder) { builder.StartTable(18); }
  ...
  public static Offset<EffectResponseActionsList_Abridged> EndEffectResponseActionsList_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EffectResponseActionsList_Abridged>(o);
  }
  public static void FinishEffectResponseActionsList_AbridgedBuffer(FlatBufferBuilder builder, Offset<EffectResponseActionsList_Abridged> offset) { builder.Finish(offset.Value, "EFFE"); }
  public static void FinishSizePrefixedEffectResponseActionsList_AbridgedBuffer(FlatBufferBuilder builder, Offset<EffectResponseActionsList_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "EFFE"); }
  public EffectResponseActionsList_AbridgedT UnPack() {
    var _o = new EffectResponseActionsList_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EffectResponseActionsList_AbridgedT _o) {
  ...
  public static Offset<EffectResponseActionsList_Abridged> Pack(FlatBufferBuilder builder, EffectResponseActionsList_AbridgedT _o) {
    if (_o == null) return default(Offset<EffectResponseActionsList_Abridged>);
...
public class EffectResponseActionsList_AbridgedT
{
  ...
  public EffectResponseActionsList_AbridgedT() {
    this.Summary = null;
    this.ActionId = null;
  ...
  public static EffectResponseActionsList_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return EffectResponseActionsList_Abridged.GetRootAsEffectResponseActionsList_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EffectResponseActionsList_Abridged.FinishEffectResponseActionsList_AbridgedBuffer(fbb, EffectResponseActionsList_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EffectResponseActionsList_AbridgedVerify
{
