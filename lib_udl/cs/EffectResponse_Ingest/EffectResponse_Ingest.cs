...
public struct EffectResponse_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EffectResponse_Ingest GetRootAsEffectResponse_Ingest(ByteBuffer _bb) { return GetRootAsEffectResponse_Ingest(_bb, new EffectResponse_Ingest()); }
  public static EffectResponse_Ingest GetRootAsEffectResponse_Ingest(ByteBuffer _bb, EffectResponse_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EffectResponse_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EFFE"); }
  public static bool VerifyEffectResponse_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EFFE", false, EffectResponse_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EffectResponse_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public EffectResponse_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(50); return o != 0 ? (EffectResponse_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EffectResponse_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<EffectResponse_Ingest> CreateEffectResponse_Ingest(FlatBufferBuilder builder,
      ...
      EffectResponse_Ingest_dataMode_Enum dataMode = EffectResponse_Ingest_dataMode_Enum.REAL,
  ...
  public static void StartEffectResponse_Ingest(FlatBufferBuilder builder) { builder.StartTable(25); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, EffectResponse_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(23, (sbyte)dataMode, 0); }
  ...
  public static Offset<EffectResponse_Ingest> EndEffectResponse_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EffectResponse_Ingest>(o);
  }
  public static void FinishEffectResponse_IngestBuffer(FlatBufferBuilder builder, Offset<EffectResponse_Ingest> offset) { builder.Finish(offset.Value, "EFFE"); }
  public static void FinishSizePrefixedEffectResponse_IngestBuffer(FlatBufferBuilder builder, Offset<EffectResponse_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "EFFE"); }
  public EffectResponse_IngestT UnPack() {
    var _o = new EffectResponse_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EffectResponse_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<EffectResponse_Ingest> Pack(FlatBufferBuilder builder, EffectResponse_IngestT _o) {
    if (_o == null) return default(Offset<EffectResponse_Ingest>);
...
public class EffectResponse_IngestT
{
  ...
  public EffectResponse_Ingest_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public EffectResponse_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = EffectResponse_Ingest_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static EffectResponse_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return EffectResponse_Ingest.GetRootAsEffectResponse_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EffectResponse_Ingest.FinishEffectResponse_IngestBuffer(fbb, EffectResponse_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EffectResponse_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 50 /*DataMode*/, 1 /*EffectResponse_Ingest_dataMode_Enum*/, 1, false)
