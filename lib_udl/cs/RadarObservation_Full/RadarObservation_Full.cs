...
public struct RadarObservation_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static RadarObservation_Full GetRootAsRadarObservation_Full(ByteBuffer _bb) { return GetRootAsRadarObservation_Full(_bb, new RadarObservation_Full()); }
  public static RadarObservation_Full GetRootAsRadarObservation_Full(ByteBuffer _bb, RadarObservation_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool RadarObservation_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "RADA"); }
  public static bool VerifyRadarObservation_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("RADA", false, RadarObservation_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public RadarObservation_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public RadarObservation_Full_dataMode_Enum DataMode { get { int o = __p.__offset(106); return o != 0 ? (RadarObservation_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RadarObservation_Full_dataMode_Enum.REAL; } }
  /// Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
  /// Example: /// Example: ['TAG1', 'TAG2']
  /// Constraints: No constraints specified.
  public string Tags(int j) { int o = __p.__offset(108); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int TagsLength { get { int o = __p.__offset(108); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Constraints: No constraints specified.
  public string OnOrbit { get { int o = __p.__offset(114); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbitBytes() { return __p.__vector_as_span<byte>(114, 1); }
#else
  public ArraySegment<byte>? GetOnOrbitBytes() { return __p.__vector_as_arraysegment(114); }
#endif
  public byte[] GetOnOrbitArray() { return __p.__vector_as_array<byte>(114); }
  ...
  public RadarObservation_Full_senReferenceFrame_Enum SenReferenceFrame { get { int o = __p.__offset(116); return o != 0 ? (RadarObservation_Full_senReferenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RadarObservation_Full_senReferenceFrame_Enum.J2000; } }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public string OrigNetwork { get { int o = __p.__offset(120); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOrigNetworkBytes() { return __p.__vector_as_span<byte>(120, 1); }
#else
  public ArraySegment<byte>? GetOrigNetworkBytes() { return __p.__vector_as_arraysegment(120); }
#endif
  public byte[] GetOrigNetworkArray() { return __p.__vector_as_array<byte>(120); }
  /// The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
  /// Example: /// Example: AXE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string SourceDL { get { int o = __p.__offset(122); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceDLBytes() { return __p.__vector_as_span<byte>(122, 1); }
#else
  public ArraySegment<byte>? GetSourceDLBytes() { return __p.__vector_as_arraysegment(122); }
#endif
  public byte[] GetSourceDLArray() { return __p.__vector_as_array<byte>(122); }
  /// Read only enumeration specifying the type of observation (e.g. OPTICAL, RADAR, RF, etc).
  /// Example: /// Example: RADAR
  /// Constraints: No constraints specified.
  public string Type { get { int o = __p.__offset(124); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTypeBytes() { return __p.__vector_as_span<byte>(124, 1); }
#else
  public ArraySegment<byte>? GetTypeBytes() { return __p.__vector_as_arraysegment(124); }
#endif
  public byte[] GetTypeArray() { return __p.__vector_as_array<byte>(124); }

  public static Offset<RadarObservation_Full> CreateRadarObservation_Full(FlatBufferBuilder builder,
      ...
      RadarObservation_Full_dataMode_Enum dataMode = RadarObservation_Full_dataMode_Enum.REAL,
      VectorOffset tagsOffset = default(VectorOffset),
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset),
      StringOffset onOrbitOffset = default(StringOffset),
      RadarObservation_Full_senReferenceFrame_Enum senReferenceFrame = RadarObservation_Full_senReferenceFrame_Enum.J2000,
    ...
    RadarObservation_Full.AddTimingBias(builder, timingBias);
    RadarObservation_Full.AddBeam(builder, beam);
    RadarObservation_Full.AddSnr(builder, snr);
    RadarObservation_Full.AddOrthogonalRcsUnc(builder, orthogonalRcsUnc);
    RadarObservation_Full.AddOrthogonalRcs(builder, orthogonalRcs);
    RadarObservation_Full.AddRcsUnc(builder, rcsUnc);
    RadarObservation_Full.AddRcs(builder, rcs);
    RadarObservation_Full.AddSenz(builder, senz);
    RadarObservation_Full.AddSeny(builder, seny);
    RadarObservation_Full.AddSenx(builder, senx);
    RadarObservation_Full.AddZvel(builder, zvel);
    RadarObservation_Full.AddYvel(builder, yvel);
    RadarObservation_Full.AddXvel(builder, xvel);
    RadarObservation_Full.AddZ(builder, z);
    RadarObservation_Full.AddY(builder, y);
    RadarObservation_Full.AddX(builder, x);
    RadarObservation_Full.AddDeclination(builder, declination);
    RadarObservation_Full.AddRa(builder, ra);
    RadarObservation_Full.AddDopplerUnc(builder, dopplerUnc);
    RadarObservation_Full.AddDoppler(builder, doppler);
    RadarObservation_Full.AddRangeRateUnc(builder, rangeRateUnc);
    RadarObservation_Full.AddRangeRate(builder, rangeRate);
    RadarObservation_Full.AddRangeBias(builder, rangeBias);
    RadarObservation_Full.AddRangeUnc(builder, rangeUnc);
    RadarObservation_Full.AddRangeAccelUnc(builder, rangeAccelUnc);
    RadarObservation_Full.AddRangeAccel(builder, rangeAccel);
    RadarObservation_Full.AddRange(builder, range);
    RadarObservation_Full.AddElevationRate(builder, elevationRate);
    RadarObservation_Full.AddElevationBias(builder, elevationBias);
    RadarObservation_Full.AddElevationUnc(builder, elevationUnc);
    RadarObservation_Full.AddElevation(builder, elevation);
    RadarObservation_Full.AddAzimuthRate(builder, azimuthRate);
    RadarObservation_Full.AddAzimuthBias(builder, azimuthBias);
    RadarObservation_Full.AddAzimuthUnc(builder, azimuthUnc);
    RadarObservation_Full.AddAzimuth(builder, azimuth);
    RadarObservation_Full.AddType(builder, typeOffset);
    RadarObservation_Full.AddSourceDL(builder, sourceDLOffset);
    RadarObservation_Full.AddOrigNetwork(builder, origNetworkOffset);
    RadarObservation_Full.AddDescriptor(builder, descriptorOffset);
    RadarObservation_Full.AddOnOrbit(builder, onOrbitOffset);
    RadarObservation_Full.AddCreatedBy(builder, createdByOffset);
    RadarObservation_Full.AddCreatedAt(builder, createdAtOffset);
    RadarObservation_Full.AddTags(builder, tagsOffset);
    RadarObservation_Full.AddOrigin(builder, originOffset);
    RadarObservation_Full.AddSource(builder, sourceOffset);
    RadarObservation_Full.AddRawFileURI(builder, rawFileURIOffset);
    RadarObservation_Full.AddOrigSensorId(builder, origSensorIdOffset);
    RadarObservation_Full.AddOrigObjectId(builder, origObjectIdOffset);
    RadarObservation_Full.AddObPosition(builder, obPositionOffset);
    RadarObservation_Full.AddTrackId(builder, trackIdOffset);
    RadarObservation_Full.AddTransactionId(builder, transactionIdOffset);
    RadarObservation_Full.AddTaskId(builder, taskIdOffset);
    RadarObservation_Full.AddSatNo(builder, satNo);
    RadarObservation_Full.AddIdSensor(builder, idSensorOffset);
    RadarObservation_Full.AddIdOnOrbit(builder, idOnOrbitOffset);
    RadarObservation_Full.AddObTime(builder, obTimeOffset);
    RadarObservation_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    RadarObservation_Full.AddId(builder, idOffset);
    RadarObservation_Full.AddSenReferenceFrame(builder, senReferenceFrame);
    RadarObservation_Full.AddDataMode(builder, dataMode);
    RadarObservation_Full.AddUct(builder, uct);
    return RadarObservation_Full.EndRadarObservation_Full(builder);
  }

  public static void StartRadarObservation_Full(FlatBufferBuilder builder) { builder.StartTable(61); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, RadarObservation_Full_dataMode_Enum dataMode) { builder.AddSbyte(51, (sbyte)dataMode, 0); }
  public static void AddTags(FlatBufferBuilder builder, VectorOffset tagsOffset) { builder.AddOffset(52, tagsOffset.Value, 0); }
  ...
  public static void AddOnOrbit(FlatBufferBuilder builder, StringOffset onOrbitOffset) { builder.AddOffset(55, onOrbitOffset.Value, 0); }
  public static void AddSenReferenceFrame(FlatBufferBuilder builder, RadarObservation_Full_senReferenceFrame_Enum senReferenceFrame) { builder.AddSbyte(56, (sbyte)senReferenceFrame, 0); }
  ...
  public static void AddOrigNetwork(FlatBufferBuilder builder, StringOffset origNetworkOffset) { builder.AddOffset(58, origNetworkOffset.Value, 0); }
  public static void AddSourceDL(FlatBufferBuilder builder, StringOffset sourceDLOffset) { builder.AddOffset(59, sourceDLOffset.Value, 0); }
  public static void AddType(FlatBufferBuilder builder, StringOffset typeOffset) { builder.AddOffset(60, typeOffset.Value, 0); }
  public static Offset<RadarObservation_Full> EndRadarObservation_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RadarObservation_Full>(o);
  }
  public static void FinishRadarObservation_FullBuffer(FlatBufferBuilder builder, Offset<RadarObservation_Full> offset) { builder.Finish(offset.Value, "RADA"); }
  public static void FinishSizePrefixedRadarObservation_FullBuffer(FlatBufferBuilder builder, Offset<RadarObservation_Full> offset) { builder.FinishSizePrefixed(offset.Value, "RADA"); }
  public RadarObservation_FullT UnPack() {
    var _o = new RadarObservation_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RadarObservation_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<RadarObservation_Full> Pack(FlatBufferBuilder builder, RadarObservation_FullT _o) {
    if (_o == null) return default(Offset<RadarObservation_Full>);
    ...
    return CreateRadarObservation_Full(
      builder,
      _id,
...
public class RadarObservation_FullT
{
  ...
  public RadarObservation_Full_dataMode_Enum DataMode { get; set; }
  public List<string> Tags { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string OnOrbit { get; set; }
  public RadarObservation_Full_senReferenceFrame_Enum SenReferenceFrame { get; set; }
  public string Descriptor { get; set; }
  public string OrigNetwork { get; set; }
  public string SourceDL { get; set; }
  public string Type { get; set; }

  public RadarObservation_FullT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = RadarObservation_Full_dataMode_Enum.REAL;
    this.Tags = null;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.OnOrbit = null;
    this.SenReferenceFrame = RadarObservation_Full_senReferenceFrame_Enum.J2000;
    this.Descriptor = null;
    this.OrigNetwork = null;
    this.SourceDL = null;
    this.Type = null;
  }
  public static RadarObservation_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return RadarObservation_Full.GetRootAsRadarObservation_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    RadarObservation_Full.FinishRadarObservation_FullBuffer(fbb, RadarObservation_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class RadarObservation_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 106 /*DataMode*/, 1 /*RadarObservation_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyVectorOfStrings(tablePos, 108 /*Tags*/, false)
      && verifier.VerifyString(tablePos, 110 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 112 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 114 /*OnOrbit*/, false)
      && verifier.VerifyField(tablePos, 116 /*SenReferenceFrame*/, 1 /*RadarObservation_Full_senReferenceFrame_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 118 /*Descriptor*/, false)
      && verifier.VerifyString(tablePos, 120 /*OrigNetwork*/, false)
      && verifier.VerifyString(tablePos, 122 /*SourceDL*/, false)
      && verifier.VerifyString(tablePos, 124 /*Type*/, false)
