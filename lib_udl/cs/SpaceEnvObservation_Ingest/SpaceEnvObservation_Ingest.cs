...
public struct SpaceEnvObservation_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SpaceEnvObservation_Ingest GetRootAsSpaceEnvObservation_Ingest(ByteBuffer _bb) { return GetRootAsSpaceEnvObservation_Ingest(_bb, new SpaceEnvObservation_Ingest()); }
  public static SpaceEnvObservation_Ingest GetRootAsSpaceEnvObservation_Ingest(ByteBuffer _bb, SpaceEnvObservation_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SpaceEnvObservation_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SPAC"); }
  public static bool VerifySpaceEnvObservation_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SPAC", false, SpaceEnvObservation_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SpaceEnvObservation_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public SpaceEnvObservation_Ingest_senReferenceFrame_Enum SenReferenceFrame { get { int o = __p.__offset(46); return o != 0 ? (SpaceEnvObservation_Ingest_senReferenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SpaceEnvObservation_Ingest_senReferenceFrame_Enum.J2000; } }
  ...
  public SpaceEnvObservation_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(82); return o != 0 ? (SpaceEnvObservation_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SpaceEnvObservation_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<SpaceEnvObservation_Ingest> CreateSpaceEnvObservation_Ingest(FlatBufferBuilder builder,
      ...
      double lon = 0.0,
      double alt = 0.0,
      SpaceEnvObservation_Ingest_senReferenceFrame_Enum senReferenceFrame = SpaceEnvObservation_Ingest_senReferenceFrame_Enum.J2000,
      ...
      SpaceEnvObservation_Ingest_dataMode_Enum dataMode = SpaceEnvObservation_Ingest_dataMode_Enum.REAL,
  ...
  public static void StartSpaceEnvObservation_Ingest(FlatBufferBuilder builder) { builder.StartTable(41); }
  ...
  public static void AddSenReferenceFrame(FlatBufferBuilder builder, SpaceEnvObservation_Ingest_senReferenceFrame_Enum senReferenceFrame) { builder.AddSbyte(21, (sbyte)senReferenceFrame, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SpaceEnvObservation_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(39, (sbyte)dataMode, 0); }
  ...
  public static Offset<SpaceEnvObservation_Ingest> EndSpaceEnvObservation_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SpaceEnvObservation_Ingest>(o);
  }
  public static void FinishSpaceEnvObservation_IngestBuffer(FlatBufferBuilder builder, Offset<SpaceEnvObservation_Ingest> offset) { builder.Finish(offset.Value, "SPAC"); }
  public static void FinishSizePrefixedSpaceEnvObservation_IngestBuffer(FlatBufferBuilder builder, Offset<SpaceEnvObservation_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "SPAC"); }
  public SpaceEnvObservation_IngestT UnPack() {
    var _o = new SpaceEnvObservation_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SpaceEnvObservation_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SpaceEnvObservation_Ingest> Pack(FlatBufferBuilder builder, SpaceEnvObservation_IngestT _o) {
    if (_o == null) return default(Offset<SpaceEnvObservation_Ingest>);
...
public class SpaceEnvObservation_IngestT
{
  ...
  public SpaceEnvObservation_Ingest_senReferenceFrame_Enum SenReferenceFrame { get; set; }
  ...
  public SpaceEnvObservation_Ingest_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public SpaceEnvObservation_IngestT() {
    this.Id = null;
    ...
    this.Lon = 0.0;
    this.Alt = 0.0;
    this.SenReferenceFrame = SpaceEnvObservation_Ingest_senReferenceFrame_Enum.J2000;
    this.SenPos = null;
    this.SenVel = null;
    this.MeasType = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = SpaceEnvObservation_Ingest_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static SpaceEnvObservation_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return SpaceEnvObservation_Ingest.GetRootAsSpaceEnvObservation_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SpaceEnvObservation_Ingest.FinishSpaceEnvObservation_IngestBuffer(fbb, SpaceEnvObservation_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SpaceEnvObservation_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 46 /*SenReferenceFrame*/, 1 /*SpaceEnvObservation_Ingest_senReferenceFrame_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 82 /*DataMode*/, 1 /*SpaceEnvObservation_Ingest_dataMode_Enum*/, 1, false)
