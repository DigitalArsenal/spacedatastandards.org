...
public struct LogisticsParts_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static LogisticsParts_Abridged GetRootAsLogisticsParts_Abridged(ByteBuffer _bb) { return GetRootAsLogisticsParts_Abridged(_bb, new LogisticsParts_Abridged()); }
  public static LogisticsParts_Abridged GetRootAsLogisticsParts_Abridged(ByteBuffer _bb, LogisticsParts_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LogisticsParts_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LOGI"); }
  public static bool VerifyLogisticsParts_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LOGI", false, LogisticsParts_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public LogisticsParts_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<LogisticsParts_Abridged> CreateLogisticsParts_Abridged(FlatBufferBuilder builder,
    ...
    LogisticsParts_Abridged.AddLogisticsStocks(builder, logisticsStocksOffset);
    LogisticsParts_Abridged.AddSupplyDocumentNumber(builder, supplyDocumentNumberOffset);
    LogisticsParts_Abridged.AddLocationVerifier(builder, locationVerifierOffset);
    LogisticsParts_Abridged.AddRequestVerifier(builder, requestVerifierOffset);
    LogisticsParts_Abridged.AddIndexNumber(builder, indexNumberOffset);
    LogisticsParts_Abridged.AddFigureNumber(builder, figureNumberOffset);
    LogisticsParts_Abridged.AddTechnicalOrderText(builder, technicalOrderTextOffset);
    LogisticsParts_Abridged.AddWorkUnitCode(builder, workUnitCodeOffset);
    LogisticsParts_Abridged.AddMeasurementUnitCode(builder, measurementUnitCodeOffset);
    LogisticsParts_Abridged.AddNationalStockNumber(builder, nationalStockNumberOffset);
    LogisticsParts_Abridged.AddPartNumber(builder, partNumberOffset);
    return LogisticsParts_Abridged.EndLogisticsParts_Abridged(builder);
  }

  public static void StartLogisticsParts_Abridged(FlatBufferBuilder builder) { builder.StartTable(11); }
  ...
  public static Offset<LogisticsParts_Abridged> EndLogisticsParts_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LogisticsParts_Abridged>(o);
  }
  public static void FinishLogisticsParts_AbridgedBuffer(FlatBufferBuilder builder, Offset<LogisticsParts_Abridged> offset) { builder.Finish(offset.Value, "LOGI"); }
  public static void FinishSizePrefixedLogisticsParts_AbridgedBuffer(FlatBufferBuilder builder, Offset<LogisticsParts_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "LOGI"); }
  public LogisticsParts_AbridgedT UnPack() {
    var _o = new LogisticsParts_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LogisticsParts_AbridgedT _o) {
  ...
  public static Offset<LogisticsParts_Abridged> Pack(FlatBufferBuilder builder, LogisticsParts_AbridgedT _o) {
    if (_o == null) return default(Offset<LogisticsParts_Abridged>);
...
public class LogisticsParts_AbridgedT
{
  ...
  public LogisticsParts_AbridgedT() {
  ...
  public static LogisticsParts_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return LogisticsParts_Abridged.GetRootAsLogisticsParts_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LogisticsParts_Abridged.FinishLogisticsParts_AbridgedBuffer(fbb, LogisticsParts_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LogisticsParts_AbridgedVerify
{
