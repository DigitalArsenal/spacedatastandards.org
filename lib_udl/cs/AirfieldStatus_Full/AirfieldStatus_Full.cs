...
public struct AirfieldStatus_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirfieldStatus_Full GetRootAsAirfieldStatus_Full(ByteBuffer _bb) { return GetRootAsAirfieldStatus_Full(_bb, new AirfieldStatus_Full()); }
  public static AirfieldStatus_Full GetRootAsAirfieldStatus_Full(ByteBuffer _bb, AirfieldStatus_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirfieldStatus_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRF"); }
  public static bool VerifyAirfieldStatus_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRF", false, AirfieldStatus_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirfieldStatus_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public AirfieldStatus_Full_dataMode_Enum DataMode { get { int o = __p.__offset(78); return o != 0 ? (AirfieldStatus_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirfieldStatus_Full_dataMode_Enum.REAL; } }

  public static Offset<AirfieldStatus_Full> CreateAirfieldStatus_Full(FlatBufferBuilder builder,
      ...
      AirfieldStatus_Full_dataMode_Enum dataMode = AirfieldStatus_Full_dataMode_Enum.REAL) {
  ...
  public static void StartAirfieldStatus_Full(FlatBufferBuilder builder) { builder.StartTable(38); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AirfieldStatus_Full_dataMode_Enum dataMode) { builder.AddSbyte(37, (sbyte)dataMode, 0); }
  public static Offset<AirfieldStatus_Full> EndAirfieldStatus_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirfieldStatus_Full>(o);
  }
  public static void FinishAirfieldStatus_FullBuffer(FlatBufferBuilder builder, Offset<AirfieldStatus_Full> offset) { builder.Finish(offset.Value, "AIRF"); }
  public static void FinishSizePrefixedAirfieldStatus_FullBuffer(FlatBufferBuilder builder, Offset<AirfieldStatus_Full> offset) { builder.FinishSizePrefixed(offset.Value, "AIRF"); }
  public AirfieldStatus_FullT UnPack() {
    var _o = new AirfieldStatus_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirfieldStatus_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AirfieldStatus_Full> Pack(FlatBufferBuilder builder, AirfieldStatus_FullT _o) {
    if (_o == null) return default(Offset<AirfieldStatus_Full>);
...
public class AirfieldStatus_FullT
{
  ...
  public AirfieldStatus_Full_dataMode_Enum DataMode { get; set; }

  public AirfieldStatus_FullT() {
    this.Id = null;
    ...
    this.DataMode = AirfieldStatus_Full_dataMode_Enum.REAL;
  }
  public static AirfieldStatus_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return AirfieldStatus_Full.GetRootAsAirfieldStatus_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirfieldStatus_Full.FinishAirfieldStatus_FullBuffer(fbb, AirfieldStatus_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirfieldStatus_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 78 /*DataMode*/, 1 /*AirfieldStatus_Full_dataMode_Enum*/, 1, false)
