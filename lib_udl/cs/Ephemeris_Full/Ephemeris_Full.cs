...
public struct Ephemeris_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static Ephemeris_Full GetRootAsEphemeris_Full(ByteBuffer _bb, Ephemeris_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Ephemeris_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EPHE"); }
  public static bool VerifyEphemeris_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EPHE", false, Ephemeris_FullVerify.Verify); }
  ...
  public Ephemeris_Full_dataMode_Enum DataMode { get { int o = __p.__offset(38); return o != 0 ? (Ephemeris_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Ephemeris_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<Ephemeris_Full> CreateEphemeris_Full(FlatBufferBuilder builder,
      ...
      Ephemeris_Full_dataMode_Enum dataMode = Ephemeris_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Ephemeris_Full_dataMode_Enum dataMode) { builder.AddSbyte(17, (sbyte)dataMode, 0); }
  ...
  public static Offset<Ephemeris_Full> EndEphemeris_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Ephemeris_Full>(o);
  }
  public static void FinishEphemeris_FullBuffer(FlatBufferBuilder builder, Offset<Ephemeris_Full> offset) { builder.Finish(offset.Value, "EPHE"); }
  public static void FinishSizePrefixedEphemeris_FullBuffer(FlatBufferBuilder builder, Offset<Ephemeris_Full> offset) { builder.FinishSizePrefixed(offset.Value, "EPHE"); }
  public Ephemeris_FullT UnPack() {
    var _o = new Ephemeris_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Ephemeris_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Ephemeris_Full> Pack(FlatBufferBuilder builder, Ephemeris_FullT _o) {
    if (_o == null) return default(Offset<Ephemeris_Full>);
...
public class Ephemeris_FullT
{
  ...
  public Ephemeris_Full_dataMode_Enum DataMode { get; set; }
  public string IdOnOrbit { get; set; }
  public string OrigObjectId { get; set; }
  public string Origin { get; set; }

  public Ephemeris_FullT() {
    this.Id = null;
    ...
    this.CreatedBy = null;
    this.Source = null;
    this.DataMode = Ephemeris_Full_dataMode_Enum.REAL;
    this.IdOnOrbit = null;
    this.OrigObjectId = null;
    this.Origin = null;
  }
  public static Ephemeris_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Ephemeris_Full.GetRootAsEphemeris_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Ephemeris_Full.FinishEphemeris_FullBuffer(fbb, Ephemeris_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Ephemeris_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 38 /*DataMode*/, 1 /*Ephemeris_Full_dataMode_Enum*/, 1, false)
