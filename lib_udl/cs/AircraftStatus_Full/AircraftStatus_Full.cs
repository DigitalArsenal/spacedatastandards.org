...
public struct AircraftStatus_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AircraftStatus_Full GetRootAsAircraftStatus_Full(ByteBuffer _bb) { return GetRootAsAircraftStatus_Full(_bb, new AircraftStatus_Full()); }
  public static AircraftStatus_Full GetRootAsAircraftStatus_Full(ByteBuffer _bb, AircraftStatus_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AircraftStatus_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRC"); }
  public static bool VerifyAircraftStatus_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRC", false, AircraftStatus_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AircraftStatus_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 16
  public AircraftStatus_Full_airToAirStatus_Enum AirToAirStatus { get { int o = __p.__offset(44); return o != 0 ? (AircraftStatus_Full_airToAirStatus_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AircraftStatus_Full_airToAirStatus_Enum.OPERATIONAL; } }
  /// The status of the air-to-ground weapon release system (OPERATIONAL, NON-OPERATIONAL, OFF).
  /// Example: /// Example: OPERATIONAL
  /// Constraints: Minimum length = 0, Maximum length = 16
  public AircraftStatus_Full_airToGroundStatus_Enum AirToGroundStatus { get { int o = __p.__offset(46); return o != 0 ? (AircraftStatus_Full_airToGroundStatus_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AircraftStatus_Full_airToGroundStatus_Enum.OPERATIONAL; } }
  ...
  /// Example: /// Example: AXE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string SourceDL { get { int o = __p.__offset(102); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceDLBytes() { return __p.__vector_as_span<byte>(102, 1); }
#else
  public ArraySegment<byte>? GetSourceDLBytes() { return __p.__vector_as_arraysegment(102); }
#endif
  public byte[] GetSourceDLArray() { return __p.__vector_as_array<byte>(102); }
  /// Source of the data.
  ...
  public AircraftStatus_Full_dataMode_Enum DataMode { get { int o = __p.__offset(108); return o != 0 ? (AircraftStatus_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AircraftStatus_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<AircraftStatus_Full> CreateAircraftStatus_Full(FlatBufferBuilder builder,
      ...
      int gunRdsMin = 0,
      int gunRdsMax = 0,
      AircraftStatus_Full_airToAirStatus_Enum airToAirStatus = AircraftStatus_Full_airToAirStatus_Enum.OPERATIONAL,
      AircraftStatus_Full_airToGroundStatus_Enum airToGroundStatus = AircraftStatus_Full_airToGroundStatus_Enum.OPERATIONAL,
      ...
      AircraftStatus_Full_dataMode_Enum dataMode = AircraftStatus_Full_dataMode_Enum.REAL,
  ...
  public static void StartAircraftStatus_Full(FlatBufferBuilder builder) { builder.StartTable(54); }
  ...
  public static void AddAirToAirStatus(FlatBufferBuilder builder, AircraftStatus_Full_airToAirStatus_Enum airToAirStatus) { builder.AddSbyte(20, (sbyte)airToAirStatus, 0); }
  public static void AddAirToGroundStatus(FlatBufferBuilder builder, AircraftStatus_Full_airToGroundStatus_Enum airToGroundStatus) { builder.AddSbyte(21, (sbyte)airToGroundStatus, 0); }
  ...
  public static void AddSourceDL(FlatBufferBuilder builder, StringOffset sourceDLOffset) { builder.AddOffset(49, sourceDLOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AircraftStatus_Full_dataMode_Enum dataMode) { builder.AddSbyte(52, (sbyte)dataMode, 0); }
  ...
  public static Offset<AircraftStatus_Full> EndAircraftStatus_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AircraftStatus_Full>(o);
  }
  public static void FinishAircraftStatus_FullBuffer(FlatBufferBuilder builder, Offset<AircraftStatus_Full> offset) { builder.Finish(offset.Value, "AIRC"); }
  public static void FinishSizePrefixedAircraftStatus_FullBuffer(FlatBufferBuilder builder, Offset<AircraftStatus_Full> offset) { builder.FinishSizePrefixed(offset.Value, "AIRC"); }
  public AircraftStatus_FullT UnPack() {
    var _o = new AircraftStatus_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AircraftStatus_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AircraftStatus_Full> Pack(FlatBufferBuilder builder, AircraftStatus_FullT _o) {
    if (_o == null) return default(Offset<AircraftStatus_Full>);
...
public class AircraftStatus_FullT
{
  ...
  public AircraftStatus_Full_airToAirStatus_Enum AirToAirStatus { get; set; }
  public AircraftStatus_Full_airToGroundStatus_Enum AirToGroundStatus { get; set; }
  ...
  public AircraftStatus_Full_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public AircraftStatus_FullT() {
    this.Id = null;
    ...
    this.GunRdsMin = 0;
    this.GunRdsMax = 0;
    this.AirToAirStatus = AircraftStatus_Full_airToAirStatus_Enum.OPERATIONAL;
    this.AirToGroundStatus = AircraftStatus_Full_airToGroundStatus_Enum.OPERATIONAL;
    this.Inventory = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = AircraftStatus_Full_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static AircraftStatus_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return AircraftStatus_Full.GetRootAsAircraftStatus_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AircraftStatus_Full.FinishAircraftStatus_FullBuffer(fbb, AircraftStatus_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AircraftStatus_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 44 /*AirToAirStatus*/, 1 /*AircraftStatus_Full_airToAirStatus_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 46 /*AirToGroundStatus*/, 1 /*AircraftStatus_Full_airToGroundStatus_Enum*/, 1, false)
      ...
      && verifier.VerifyString(tablePos, 102 /*SourceDL*/, false)
      && verifier.VerifyString(tablePos, 104 /*Source*/, false)
      && verifier.VerifyString(tablePos, 106 /*Origin*/, false)
      && verifier.VerifyField(tablePos, 108 /*DataMode*/, 1 /*AircraftStatus_Full_dataMode_Enum*/, 1, false)
