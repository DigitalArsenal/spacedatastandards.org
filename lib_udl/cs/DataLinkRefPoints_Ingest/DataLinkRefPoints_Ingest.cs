...
public struct DataLinkRefPoints_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static DataLinkRefPoints_Ingest GetRootAsDataLinkRefPoints_Ingest(ByteBuffer _bb, DataLinkRefPoints_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DataLinkRefPoints_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DATA"); }
  public static bool VerifyDataLinkRefPoints_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DATA", false, DataLinkRefPoints_IngestVerify.Verify); }
  ...
  public static Offset<DataLinkRefPoints_Ingest> CreateDataLinkRefPoints_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<DataLinkRefPoints_Ingest> EndDataLinkRefPoints_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DataLinkRefPoints_Ingest>(o);
  }
  public static void FinishDataLinkRefPoints_IngestBuffer(FlatBufferBuilder builder, Offset<DataLinkRefPoints_Ingest> offset) { builder.Finish(offset.Value, "DATA"); }
  public static void FinishSizePrefixedDataLinkRefPoints_IngestBuffer(FlatBufferBuilder builder, Offset<DataLinkRefPoints_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "DATA"); }
  public DataLinkRefPoints_IngestT UnPack() {
    var _o = new DataLinkRefPoints_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DataLinkRefPoints_IngestT _o) {
  ...
  public static Offset<DataLinkRefPoints_Ingest> Pack(FlatBufferBuilder builder, DataLinkRefPoints_IngestT _o) {
    if (_o == null) return default(Offset<DataLinkRefPoints_Ingest>);
...
public class DataLinkRefPoints_IngestT
{
  ...
  public DataLinkRefPoints_IngestT() {
  ...
  public static DataLinkRefPoints_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return DataLinkRefPoints_Ingest.GetRootAsDataLinkRefPoints_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DataLinkRefPoints_Ingest.FinishDataLinkRefPoints_IngestBuffer(fbb, DataLinkRefPoints_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DataLinkRefPoints_IngestVerify
{
