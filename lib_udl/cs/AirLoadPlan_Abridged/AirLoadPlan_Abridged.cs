...
public struct AirLoadPlan_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirLoadPlan_Abridged GetRootAsAirLoadPlan_Abridged(ByteBuffer _bb) { return GetRootAsAirLoadPlan_Abridged(_bb, new AirLoadPlan_Abridged()); }
  public static AirLoadPlan_Abridged GetRootAsAirLoadPlan_Abridged(ByteBuffer _bb, AirLoadPlan_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirLoadPlan_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRL"); }
  public static bool VerifyAirLoadPlan_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRL", false, AirLoadPlan_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirLoadPlan_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public AirLoadPlan_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(100); return o != 0 ? (AirLoadPlan_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirLoadPlan_Abridged_dataMode_Enum.REAL; } }

  public static Offset<AirLoadPlan_Abridged> CreateAirLoadPlan_Abridged(FlatBufferBuilder builder,
      ...
      AirLoadPlan_Abridged_dataMode_Enum dataMode = AirLoadPlan_Abridged_dataMode_Enum.REAL) {
  ...
  public static void StartAirLoadPlan_Abridged(FlatBufferBuilder builder) { builder.StartTable(49); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AirLoadPlan_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(48, (sbyte)dataMode, 0); }
  public static Offset<AirLoadPlan_Abridged> EndAirLoadPlan_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirLoadPlan_Abridged>(o);
  }
  public static void FinishAirLoadPlan_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirLoadPlan_Abridged> offset) { builder.Finish(offset.Value, "AIRL"); }
  public static void FinishSizePrefixedAirLoadPlan_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirLoadPlan_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "AIRL"); }
  public AirLoadPlan_AbridgedT UnPack() {
    var _o = new AirLoadPlan_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirLoadPlan_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AirLoadPlan_Abridged> Pack(FlatBufferBuilder builder, AirLoadPlan_AbridgedT _o) {
    if (_o == null) return default(Offset<AirLoadPlan_Abridged>);
...
public class AirLoadPlan_AbridgedT
{
  ...
  public AirLoadPlan_Abridged_dataMode_Enum DataMode { get; set; }

  public AirLoadPlan_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = AirLoadPlan_Abridged_dataMode_Enum.REAL;
  }
  public static AirLoadPlan_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return AirLoadPlan_Abridged.GetRootAsAirLoadPlan_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirLoadPlan_Abridged.FinishAirLoadPlan_AbridgedBuffer(fbb, AirLoadPlan_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirLoadPlan_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 100 /*DataMode*/, 1 /*AirLoadPlan_Abridged_dataMode_Enum*/, 1, false)
