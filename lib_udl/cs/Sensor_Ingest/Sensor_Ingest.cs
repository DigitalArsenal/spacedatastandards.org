...
public struct Sensor_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static Sensor_Ingest GetRootAsSensor_Ingest(ByteBuffer _bb, Sensor_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Sensor_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SENS"); }
  public static bool VerifySensor_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SENS", false, Sensor_IngestVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Sensor_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(26); return o != 0 ? (Sensor_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Sensor_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<Sensor_Ingest> CreateSensor_Ingest(FlatBufferBuilder builder,
      ...
      Sensor_Ingest_dataMode_Enum dataMode = Sensor_Ingest_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Sensor_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(11, (sbyte)dataMode, 0); }
  ...
  public static Offset<Sensor_Ingest> EndSensor_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Sensor_Ingest>(o);
  }
  public static void FinishSensor_IngestBuffer(FlatBufferBuilder builder, Offset<Sensor_Ingest> offset) { builder.Finish(offset.Value, "SENS"); }
  public static void FinishSizePrefixedSensor_IngestBuffer(FlatBufferBuilder builder, Offset<Sensor_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "SENS"); }
  public Sensor_IngestT UnPack() {
    var _o = new Sensor_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Sensor_IngestT _o) {
  ...
  public static Offset<Sensor_Ingest> Pack(FlatBufferBuilder builder, Sensor_IngestT _o) {
    if (_o == null) return default(Offset<Sensor_Ingest>);
...
public class Sensor_IngestT
{
  ...
  public Sensor_Ingest_dataMode_Enum DataMode { get; set; }
  ...
  public Sensor_IngestT() {
    ...
    this.DataMode = Sensor_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.Active = false;
  ...
  public static Sensor_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Sensor_Ingest.GetRootAsSensor_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Sensor_Ingest.FinishSensor_IngestBuffer(fbb, Sensor_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Sensor_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 26 /*DataMode*/, 1 /*Sensor_Ingest_dataMode_Enum*/, 1, false)
