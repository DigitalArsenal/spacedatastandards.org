...
public struct MtiHRR_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static MtiHRR_Ingest GetRootAsMtiHRR_Ingest(ByteBuffer _bb) { return GetRootAsMtiHRR_Ingest(_bb, new MtiHRR_Ingest()); }
  public static MtiHRR_Ingest GetRootAsMtiHRR_Ingest(ByteBuffer _bb, MtiHRR_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool MtiHRR_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MTIH"); }
  public static bool VerifyMtiHRR_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MTIH", false, MtiHRR_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public MtiHRR_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<MtiHRR_Ingest> CreateMtiHRR_Ingest(FlatBufferBuilder builder,
      int h2 = 0,
      int h3 = 0,
      bool h4 = false,
      int h5 = 0,
  ...
  public static void StartMtiHRR_Ingest(FlatBufferBuilder builder) { builder.StartTable(29); }
  ...
  public static Offset<MtiHRR_Ingest> EndMtiHRR_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<MtiHRR_Ingest>(o);
  }
  public static void FinishMtiHRR_IngestBuffer(FlatBufferBuilder builder, Offset<MtiHRR_Ingest> offset) { builder.Finish(offset.Value, "MTIH"); }
  public static void FinishSizePrefixedMtiHRR_IngestBuffer(FlatBufferBuilder builder, Offset<MtiHRR_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "MTIH"); }
  public MtiHRR_IngestT UnPack() {
    var _o = new MtiHRR_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(MtiHRR_IngestT _o) {
    _o.H2 = this.H2;
    _o.H3 = this.H3;
    _o.H4 = this.H4;
    _o.H5 = this.H5;
  ...
  public static Offset<MtiHRR_Ingest> Pack(FlatBufferBuilder builder, MtiHRR_IngestT _o) {
    if (_o == null) return default(Offset<MtiHRR_Ingest>);
...
public class MtiHRR_IngestT
{
  ...
  public static MtiHRR_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return MtiHRR_Ingest.GetRootAsMtiHRR_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    MtiHRR_Ingest.FinishMtiHRR_IngestBuffer(fbb, MtiHRR_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class MtiHRR_IngestVerify
{
