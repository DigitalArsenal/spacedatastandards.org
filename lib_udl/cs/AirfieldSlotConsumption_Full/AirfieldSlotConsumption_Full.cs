...
public struct AirfieldSlotConsumption_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirfieldSlotConsumption_Full GetRootAsAirfieldSlotConsumption_Full(ByteBuffer _bb) { return GetRootAsAirfieldSlotConsumption_Full(_bb, new AirfieldSlotConsumption_Full()); }
  public static AirfieldSlotConsumption_Full GetRootAsAirfieldSlotConsumption_Full(ByteBuffer _bb, AirfieldSlotConsumption_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirfieldSlotConsumption_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRF"); }
  public static bool VerifyAirfieldSlotConsumption_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRF", false, AirfieldSlotConsumption_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirfieldSlotConsumption_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public AirfieldSlotConsumption_Full_status_Enum Status { get { int o = __p.__offset(10); return o != 0 ? (AirfieldSlotConsumption_Full_status_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirfieldSlotConsumption_Full_status_Enum.REQUESTED; } }
  ...
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string UpdatedAt { get { int o = __p.__offset(68); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedAtBytes() { return __p.__vector_as_span<byte>(68, 1); }
#else
  public ArraySegment<byte>? GetUpdatedAtBytes() { return __p.__vector_as_arraysegment(68); }
#endif
  public byte[] GetUpdatedAtArray() { return __p.__vector_as_array<byte>(68); }
  /// Application user who updated the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string UpdatedBy { get { int o = __p.__offset(70); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedByBytes() { return __p.__vector_as_span<byte>(70, 1); }
#else
  public ArraySegment<byte>? GetUpdatedByBytes() { return __p.__vector_as_arraysegment(70); }
#endif
  public byte[] GetUpdatedByArray() { return __p.__vector_as_array<byte>(70); }
  ...
  public AirfieldSlotConsumption_Full_dataMode_Enum DataMode { get { int o = __p.__offset(80); return o != 0 ? (AirfieldSlotConsumption_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirfieldSlotConsumption_Full_dataMode_Enum.REAL; } }

  public static Offset<AirfieldSlotConsumption_Full> CreateAirfieldSlotConsumption_Full(FlatBufferBuilder builder,
      StringOffset idOffset = default(StringOffset),
      StringOffset classificationMarkingOffset = default(StringOffset),
      StringOffset idAirfieldSlotOffset = default(StringOffset),
      AirfieldSlotConsumption_Full_status_Enum status = AirfieldSlotConsumption_Full_status_Enum.REQUESTED,
      bool occupied = false,
      ...
      AirfieldSlotConsumption_Full_dataMode_Enum dataMode = AirfieldSlotConsumption_Full_dataMode_Enum.REAL) {
    builder.StartTable(39);
    AirfieldSlotConsumption_Full.AddOrigNetwork(builder, origNetworkOffset);
    AirfieldSlotConsumption_Full.AddOrigin(builder, originOffset);
    AirfieldSlotConsumption_Full.AddSource(builder, sourceOffset);
    AirfieldSlotConsumption_Full.AddSourceDL(builder, sourceDLOffset);
    AirfieldSlotConsumption_Full.AddUpdatedBy(builder, updatedByOffset);
    AirfieldSlotConsumption_Full.AddUpdatedAt(builder, updatedAtOffset);
    AirfieldSlotConsumption_Full.AddCreatedBy(builder, createdByOffset);
    AirfieldSlotConsumption_Full.AddCreatedAt(builder, createdAtOffset);
    AirfieldSlotConsumption_Full.AddAppInitials(builder, appInitialsOffset);
    AirfieldSlotConsumption_Full.AddAppOrg(builder, appOrgOffset);
    AirfieldSlotConsumption_Full.AddReqInitials(builder, reqInitialsOffset);
    AirfieldSlotConsumption_Full.AddReqOrg(builder, reqOrgOffset);
    AirfieldSlotConsumption_Full.AddAppComment(builder, appCommentOffset);
    AirfieldSlotConsumption_Full.AddReqComment(builder, reqCommentOffset);
    AirfieldSlotConsumption_Full.AddAltDepSortieId(builder, altDepSortieIdOffset);
    AirfieldSlotConsumption_Full.AddAltArrSortieId(builder, altArrSortieIdOffset);
    AirfieldSlotConsumption_Full.AddIdDepSortie(builder, idDepSortieOffset);
    AirfieldSlotConsumption_Full.AddIdArrSortie(builder, idArrSortieOffset);
    AirfieldSlotConsumption_Full.AddTargetTime(builder, targetTimeOffset);
    AirfieldSlotConsumption_Full.AddEndTime(builder, endTimeOffset);
    AirfieldSlotConsumption_Full.AddStartTime(builder, startTimeOffset);
    AirfieldSlotConsumption_Full.AddResMissionId(builder, resMissionIdOffset);
    AirfieldSlotConsumption_Full.AddResReason(builder, resReasonOffset);
    AirfieldSlotConsumption_Full.AddResType(builder, resTypeOffset);
    AirfieldSlotConsumption_Full.AddResTailNumber(builder, resTailNumberOffset);
    AirfieldSlotConsumption_Full.AddResAircraftMDS(builder, resAircraftMDSOffset);
    AirfieldSlotConsumption_Full.AddOccStartTime(builder, occStartTimeOffset);
    AirfieldSlotConsumption_Full.AddNumAircraft(builder, numAircraft);
    AirfieldSlotConsumption_Full.AddMissionId(builder, missionIdOffset);
    AirfieldSlotConsumption_Full.AddCallSigns(builder, callSignsOffset);
    AirfieldSlotConsumption_Full.AddOccTailNumber(builder, occTailNumberOffset);
    AirfieldSlotConsumption_Full.AddOccAircraftMDS(builder, occAircraftMDSOffset);
    AirfieldSlotConsumption_Full.AddConsumer(builder, consumerOffset);
    AirfieldSlotConsumption_Full.AddIdAirfieldSlot(builder, idAirfieldSlotOffset);
    AirfieldSlotConsumption_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    AirfieldSlotConsumption_Full.AddId(builder, idOffset);
    AirfieldSlotConsumption_Full.AddDataMode(builder, dataMode);
    AirfieldSlotConsumption_Full.AddOccupied(builder, occupied);
    AirfieldSlotConsumption_Full.AddStatus(builder, status);
    return AirfieldSlotConsumption_Full.EndAirfieldSlotConsumption_Full(builder);
  }

  public static void StartAirfieldSlotConsumption_Full(FlatBufferBuilder builder) { builder.StartTable(39); }
  ...
  public static void AddStatus(FlatBufferBuilder builder, AirfieldSlotConsumption_Full_status_Enum status) { builder.AddSbyte(3, (sbyte)status, 0); }
  ...
  public static void AddUpdatedAt(FlatBufferBuilder builder, StringOffset updatedAtOffset) { builder.AddOffset(32, updatedAtOffset.Value, 0); }
  public static void AddUpdatedBy(FlatBufferBuilder builder, StringOffset updatedByOffset) { builder.AddOffset(33, updatedByOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AirfieldSlotConsumption_Full_dataMode_Enum dataMode) { builder.AddSbyte(38, (sbyte)dataMode, 0); }
  public static Offset<AirfieldSlotConsumption_Full> EndAirfieldSlotConsumption_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirfieldSlotConsumption_Full>(o);
  }
  public static void FinishAirfieldSlotConsumption_FullBuffer(FlatBufferBuilder builder, Offset<AirfieldSlotConsumption_Full> offset) { builder.Finish(offset.Value, "AIRF"); }
  public static void FinishSizePrefixedAirfieldSlotConsumption_FullBuffer(FlatBufferBuilder builder, Offset<AirfieldSlotConsumption_Full> offset) { builder.FinishSizePrefixed(offset.Value, "AIRF"); }
  public AirfieldSlotConsumption_FullT UnPack() {
    var _o = new AirfieldSlotConsumption_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirfieldSlotConsumption_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AirfieldSlotConsumption_Full> Pack(FlatBufferBuilder builder, AirfieldSlotConsumption_FullT _o) {
    if (_o == null) return default(Offset<AirfieldSlotConsumption_Full>);
...
public class AirfieldSlotConsumption_FullT
{
  public string Id { get; set; }
  public string ClassificationMarking { get; set; }
  public string IdAirfieldSlot { get; set; }
  public AirfieldSlotConsumption_Full_status_Enum Status { get; set; }
  ...
  public AirfieldSlotConsumption_Full_dataMode_Enum DataMode { get; set; }

  public AirfieldSlotConsumption_FullT() {
    this.Id = null;
    this.ClassificationMarking = null;
    this.IdAirfieldSlot = null;
    this.Status = AirfieldSlotConsumption_Full_status_Enum.REQUESTED;
    this.Occupied = false;
    this.Consumer = null;
    ...
    this.DataMode = AirfieldSlotConsumption_Full_dataMode_Enum.REAL;
  }
  public static AirfieldSlotConsumption_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return AirfieldSlotConsumption_Full.GetRootAsAirfieldSlotConsumption_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirfieldSlotConsumption_Full.FinishAirfieldSlotConsumption_FullBuffer(fbb, AirfieldSlotConsumption_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirfieldSlotConsumption_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*Status*/, 1 /*AirfieldSlotConsumption_Full_status_Enum*/, 1, false)
      ...
      && verifier.VerifyString(tablePos, 68 /*UpdatedAt*/, false)
      && verifier.VerifyString(tablePos, 70 /*UpdatedBy*/, false)
      ...
      && verifier.VerifyField(tablePos, 80 /*DataMode*/, 1 /*AirfieldSlotConsumption_Full_dataMode_Enum*/, 1, false)
