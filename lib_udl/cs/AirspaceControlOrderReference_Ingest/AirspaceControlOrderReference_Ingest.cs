...
public struct AirspaceControlOrderReference_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirspaceControlOrderReference_Ingest GetRootAsAirspaceControlOrderReference_Ingest(ByteBuffer _bb) { return GetRootAsAirspaceControlOrderReference_Ingest(_bb, new AirspaceControlOrderReference_Ingest()); }
  public static AirspaceControlOrderReference_Ingest GetRootAsAirspaceControlOrderReference_Ingest(ByteBuffer _bb, AirspaceControlOrderReference_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirspaceControlOrderReference_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRS"); }
  public static bool VerifyAirspaceControlOrderReference_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRS", false, AirspaceControlOrderReference_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirspaceControlOrderReference_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<AirspaceControlOrderReference_Ingest> CreateAirspaceControlOrderReference_Ingest(FlatBufferBuilder builder,
    ...
    AirspaceControlOrderReference_Ingest.AddRefSICs(builder, refSICsOffset);
    AirspaceControlOrderReference_Ingest.AddRefSpecialNotation(builder, refSpecialNotationOffset);
    AirspaceControlOrderReference_Ingest.AddRefSerialNum(builder, refSerialNumOffset);
    AirspaceControlOrderReference_Ingest.AddRefTs(builder, refTsOffset);
    AirspaceControlOrderReference_Ingest.AddRefOriginator(builder, refOriginatorOffset);
    AirspaceControlOrderReference_Ingest.AddRefType(builder, refTypeOffset);
    AirspaceControlOrderReference_Ingest.AddRefSId(builder, refSIdOffset);
    return AirspaceControlOrderReference_Ingest.EndAirspaceControlOrderReference_Ingest(builder);
  }

  public static void StartAirspaceControlOrderReference_Ingest(FlatBufferBuilder builder) { builder.StartTable(7); }
  ...
  public static Offset<AirspaceControlOrderReference_Ingest> EndAirspaceControlOrderReference_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirspaceControlOrderReference_Ingest>(o);
  }
  public static void FinishAirspaceControlOrderReference_IngestBuffer(FlatBufferBuilder builder, Offset<AirspaceControlOrderReference_Ingest> offset) { builder.Finish(offset.Value, "AIRS"); }
  public static void FinishSizePrefixedAirspaceControlOrderReference_IngestBuffer(FlatBufferBuilder builder, Offset<AirspaceControlOrderReference_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AIRS"); }
  public AirspaceControlOrderReference_IngestT UnPack() {
    var _o = new AirspaceControlOrderReference_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirspaceControlOrderReference_IngestT _o) {
  ...
  public static Offset<AirspaceControlOrderReference_Ingest> Pack(FlatBufferBuilder builder, AirspaceControlOrderReference_IngestT _o) {
    if (_o == null) return default(Offset<AirspaceControlOrderReference_Ingest>);
    ...
    return CreateAirspaceControlOrderReference_Ingest(
      builder,
      _refSId,
      _refType,
      _refOriginator,
...
public class AirspaceControlOrderReference_IngestT
{
  ...
  public AirspaceControlOrderReference_IngestT() {
    this.RefSId = null;
    this.RefType = null;
  ...
  public static AirspaceControlOrderReference_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AirspaceControlOrderReference_Ingest.GetRootAsAirspaceControlOrderReference_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirspaceControlOrderReference_Ingest.FinishAirspaceControlOrderReference_IngestBuffer(fbb, AirspaceControlOrderReference_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirspaceControlOrderReference_IngestVerify
{
