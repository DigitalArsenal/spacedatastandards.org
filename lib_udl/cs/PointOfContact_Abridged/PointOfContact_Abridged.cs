...
public struct PointOfContact_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static PointOfContact_Abridged GetRootAsPointOfContact_Abridged(ByteBuffer _bb) { return GetRootAsPointOfContact_Abridged(_bb, new PointOfContact_Abridged()); }
  public static PointOfContact_Abridged GetRootAsPointOfContact_Abridged(ByteBuffer _bb, PointOfContact_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool PointOfContact_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "POIN"); }
  public static bool VerifyPointOfContact_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("POIN", false, PointOfContact_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public PointOfContact_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<PointOfContact_Abridged> CreatePointOfContact_Abridged(FlatBufferBuilder builder,
      int pocSequenceId = 0,
  ...
  public static void StartPointOfContact_Abridged(FlatBufferBuilder builder) { builder.StartTable(9); }
  ...
  public static Offset<PointOfContact_Abridged> EndPointOfContact_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PointOfContact_Abridged>(o);
  }
  public static void FinishPointOfContact_AbridgedBuffer(FlatBufferBuilder builder, Offset<PointOfContact_Abridged> offset) { builder.Finish(offset.Value, "POIN"); }
  public static void FinishSizePrefixedPointOfContact_AbridgedBuffer(FlatBufferBuilder builder, Offset<PointOfContact_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "POIN"); }
  public PointOfContact_AbridgedT UnPack() {
    var _o = new PointOfContact_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(PointOfContact_AbridgedT _o) {
  ...
  public static Offset<PointOfContact_Abridged> Pack(FlatBufferBuilder builder, PointOfContact_AbridgedT _o) {
    if (_o == null) return default(Offset<PointOfContact_Abridged>);
...
public class PointOfContact_AbridgedT
{
  ...
  public PointOfContact_AbridgedT() {
  ...
  public static PointOfContact_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return PointOfContact_Abridged.GetRootAsPointOfContact_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    PointOfContact_Abridged.FinishPointOfContact_AbridgedBuffer(fbb, PointOfContact_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class PointOfContact_AbridgedVerify
{
