...
public struct Track_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Track_Ingest GetRootAsTrack_Ingest(ByteBuffer _bb) { return GetRootAsTrack_Ingest(_bb, new Track_Ingest()); }
  public static Track_Ingest GetRootAsTrack_Ingest(ByteBuffer _bb, Track_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Track_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "TRAC"); }
  public static bool VerifyTrack_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("TRAC", false, Track_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Track_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public Track_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(136); return o != 0 ? (Track_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Track_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<Track_Ingest> CreateTrack_Ingest(FlatBufferBuilder builder,
      ...
      Track_Ingest_dataMode_Enum dataMode = Track_Ingest_dataMode_Enum.REAL,
  ...
  public static void StartTrack_Ingest(FlatBufferBuilder builder) { builder.StartTable(68); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Track_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(66, (sbyte)dataMode, 0); }
  ...
  public static Offset<Track_Ingest> EndTrack_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Track_Ingest>(o);
  }
  public static void FinishTrack_IngestBuffer(FlatBufferBuilder builder, Offset<Track_Ingest> offset) { builder.Finish(offset.Value, "TRAC"); }
  public static void FinishSizePrefixedTrack_IngestBuffer(FlatBufferBuilder builder, Offset<Track_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "TRAC"); }
  public Track_IngestT UnPack() {
    var _o = new Track_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Track_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Track_Ingest> Pack(FlatBufferBuilder builder, Track_IngestT _o) {
    if (_o == null) return default(Offset<Track_Ingest>);
...
public class Track_IngestT
{
  ...
  public Track_Ingest_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public Track_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Track_Ingest_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static Track_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Track_Ingest.GetRootAsTrack_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Track_Ingest.FinishTrack_IngestBuffer(fbb, Track_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Track_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 136 /*DataMode*/, 1 /*Track_Ingest_dataMode_Enum*/, 1, false)
