...
public struct AirfieldSlot_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirfieldSlot_Ingest GetRootAsAirfieldSlot_Ingest(ByteBuffer _bb) { return GetRootAsAirfieldSlot_Ingest(_bb, new AirfieldSlot_Ingest()); }
  public static AirfieldSlot_Ingest GetRootAsAirfieldSlot_Ingest(ByteBuffer _bb, AirfieldSlot_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirfieldSlot_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRF"); }
  public static bool VerifyAirfieldSlot_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRF", false, AirfieldSlot_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirfieldSlot_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public AirfieldSlot_Ingest_type_Enum Type { get { int o = __p.__offset(18); return o != 0 ? (AirfieldSlot_Ingest_type_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirfieldSlot_Ingest_type_Enum.WORKING; } }
  /// Largest category of aircraft supported in this slot (WIDE, NARROW, HELO, ALL, OTHER).
  /// Example: /// Example: WIDE
  /// Constraints: Minimum length = 0, Maximum length = 6
  public AirfieldSlot_Ingest_acSlotCat_Enum AcSlotCat { get { int o = __p.__offset(20); return o != 0 ? (AirfieldSlot_Ingest_acSlotCat_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirfieldSlot_Ingest_acSlotCat_Enum.WIDE; } }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public AirfieldSlot_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(44); return o != 0 ? (AirfieldSlot_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirfieldSlot_Ingest_dataMode_Enum.REAL; } }

  public static Offset<AirfieldSlot_Ingest> CreateAirfieldSlot_Ingest(FlatBufferBuilder builder,
      ...
      AirfieldSlot_Ingest_type_Enum type = AirfieldSlot_Ingest_type_Enum.WORKING,
      AirfieldSlot_Ingest_acSlotCat_Enum acSlotCat = AirfieldSlot_Ingest_acSlotCat_Enum.WIDE,
      int capacity = 0,
      ...
      AirfieldSlot_Ingest_dataMode_Enum dataMode = AirfieldSlot_Ingest_dataMode_Enum.REAL) {
  ...
  public static void StartAirfieldSlot_Ingest(FlatBufferBuilder builder) { builder.StartTable(21); }
  ...
  public static void AddType(FlatBufferBuilder builder, AirfieldSlot_Ingest_type_Enum type) { builder.AddSbyte(7, (sbyte)type, 0); }
  public static void AddAcSlotCat(FlatBufferBuilder builder, AirfieldSlot_Ingest_acSlotCat_Enum acSlotCat) { builder.AddSbyte(8, (sbyte)acSlotCat, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AirfieldSlot_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(20, (sbyte)dataMode, 0); }
  public static Offset<AirfieldSlot_Ingest> EndAirfieldSlot_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirfieldSlot_Ingest>(o);
  }
  public static void FinishAirfieldSlot_IngestBuffer(FlatBufferBuilder builder, Offset<AirfieldSlot_Ingest> offset) { builder.Finish(offset.Value, "AIRF"); }
  public static void FinishSizePrefixedAirfieldSlot_IngestBuffer(FlatBufferBuilder builder, Offset<AirfieldSlot_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AIRF"); }
  public AirfieldSlot_IngestT UnPack() {
    var _o = new AirfieldSlot_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirfieldSlot_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AirfieldSlot_Ingest> Pack(FlatBufferBuilder builder, AirfieldSlot_IngestT _o) {
    if (_o == null) return default(Offset<AirfieldSlot_Ingest>);
...
public class AirfieldSlot_IngestT
{
  ...
  public AirfieldSlot_Ingest_type_Enum Type { get; set; }
  public AirfieldSlot_Ingest_acSlotCat_Enum AcSlotCat { get; set; }
  ...
  public AirfieldSlot_Ingest_dataMode_Enum DataMode { get; set; }

  public AirfieldSlot_IngestT() {
    this.Id = null;
    ...
    this.Name = null;
    this.Type = AirfieldSlot_Ingest_type_Enum.WORKING;
    this.AcSlotCat = AirfieldSlot_Ingest_acSlotCat_Enum.WIDE;
    this.Capacity = 0;
    this.StartTime = null;
    this.EndTime = null;
    ...
    this.DataMode = AirfieldSlot_Ingest_dataMode_Enum.REAL;
  }
  public static AirfieldSlot_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AirfieldSlot_Ingest.GetRootAsAirfieldSlot_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirfieldSlot_Ingest.FinishAirfieldSlot_IngestBuffer(fbb, AirfieldSlot_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirfieldSlot_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 18 /*Type*/, 1 /*AirfieldSlot_Ingest_type_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 20 /*AcSlotCat*/, 1 /*AirfieldSlot_Ingest_acSlotCat_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 44 /*DataMode*/, 1 /*AirfieldSlot_Ingest_dataMode_Enum*/, 1, false)
