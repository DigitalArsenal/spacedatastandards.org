...
/// /// Array of Doppler.
public struct IonoObservationDoppler_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationDoppler_Abridged GetRootAsIonoObservationDoppler_Abridged(ByteBuffer _bb) { return GetRootAsIonoObservationDoppler_Abridged(_bb, new IonoObservationDoppler_Abridged()); }
  public static IonoObservationDoppler_Abridged GetRootAsIonoObservationDoppler_Abridged(ByteBuffer _bb, IonoObservationDoppler_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationDoppler_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationDoppler_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationDoppler_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationDoppler_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationDoppler_Abridged> CreateIonoObservationDoppler_Abridged(FlatBufferBuilder builder,
  ...
  public static void StartIonoObservationDoppler_Abridged(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationDoppler_Abridged> EndIonoObservationDoppler_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationDoppler_Abridged>(o);
  }
  public static void FinishIonoObservationDoppler_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationDoppler_Abridged> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationDoppler_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationDoppler_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationDoppler_AbridgedT UnPack() {
    var _o = new IonoObservationDoppler_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationDoppler_AbridgedT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationDoppler_Abridged> Pack(FlatBufferBuilder builder, IonoObservationDoppler_AbridgedT _o) {
    if (_o == null) return default(Offset<IonoObservationDoppler_Abridged>);
...
public class IonoObservationDoppler_AbridgedT
{
  ...
  public IonoObservationDoppler_AbridgedT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationDoppler_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationDoppler_Abridged.GetRootAsIonoObservationDoppler_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationDoppler_Abridged.FinishIonoObservationDoppler_AbridgedBuffer(fbb, IonoObservationDoppler_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationDoppler_AbridgedVerify
{
