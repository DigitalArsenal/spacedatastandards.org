...
public struct OrbitTrack_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static OrbitTrack_Ingest GetRootAsOrbitTrack_Ingest(ByteBuffer _bb) { return GetRootAsOrbitTrack_Ingest(_bb, new OrbitTrack_Ingest()); }
  public static OrbitTrack_Ingest GetRootAsOrbitTrack_Ingest(ByteBuffer _bb, OrbitTrack_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OrbitTrack_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ORBI"); }
  public static bool VerifyOrbitTrack_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ORBI", false, OrbitTrack_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public OrbitTrack_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 32
  public OrbitTrack_Ingest_objIdent_Enum ObjIdent { get { int o = __p.__offset(30); return o != 0 ? (OrbitTrack_Ingest_objIdent_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OrbitTrack_Ingest_objIdent_Enum.ASSUMED_FRIEND; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 32
  public OrbitTrack_Ingest_objectType_Enum ObjectType { get { int o = __p.__offset(36); return o != 0 ? (OrbitTrack_Ingest_objectType_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OrbitTrack_Ingest_objectType_Enum.DEBRIS; } }
  ...
  public OrbitTrack_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(90); return o != 0 ? (OrbitTrack_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OrbitTrack_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<OrbitTrack_Ingest> CreateOrbitTrack_Ingest(FlatBufferBuilder builder,
      ...
      OrbitTrack_Ingest_objIdent_Enum objIdent = OrbitTrack_Ingest_objIdent_Enum.ASSUMED_FRIEND,
      StringOffset identAmpOffset = default(StringOffset),
      StringOffset satStatusOffset = default(StringOffset),
      OrbitTrack_Ingest_objectType_Enum objectType = OrbitTrack_Ingest_objectType_Enum.DEBRIS,
      ...
      OrbitTrack_Ingest_dataMode_Enum dataMode = OrbitTrack_Ingest_dataMode_Enum.REAL,
      StringOffset origNetworkOffset = default(StringOffset)) {
    builder.StartTable(45);
    OrbitTrack_Ingest.AddCntnmnt(builder, cntnmnt);
    OrbitTrack_Ingest.AddAngElev(builder, angElev);
    OrbitTrack_Ingest.AddSpd(builder, spd);
    OrbitTrack_Ingest.AddDecay(builder, decay);
    OrbitTrack_Ingest.AddRdfRF(builder, rdfRF);
    OrbitTrack_Ingest.AddAlt(builder, alt);
    OrbitTrack_Ingest.AddLon(builder, lon);
    OrbitTrack_Ingest.AddLat(builder, lat);
    OrbitTrack_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    OrbitTrack_Ingest.AddOrigin(builder, originOffset);
    OrbitTrack_Ingest.AddSource(builder, sourceOffset);
    OrbitTrack_Ingest.AddCreatedBy(builder, createdByOffset);
    OrbitTrack_Ingest.AddCreatedAt(builder, createdAtOffset);
    OrbitTrack_Ingest.AddTrackSensors(builder, trackSensorsOffset);
    OrbitTrack_Ingest.AddTrkId(builder, trkIdOffset);
    OrbitTrack_Ingest.AddVehType(builder, vehTypeOffset);
    OrbitTrack_Ingest.AddIff(builder, iffOffset);
    OrbitTrack_Ingest.AddAmplification(builder, amplificationOffset);
    OrbitTrack_Ingest.AddChXRef(builder, chXRefOffset);
    OrbitTrack_Ingest.AddXref(builder, xrefOffset);
    OrbitTrack_Ingest.AddAouData(builder, aouDataOffset);
    OrbitTrack_Ingest.AddAouType(builder, aouTypeOffset);
    OrbitTrack_Ingest.AddCharlieLine(builder, charlieLineOffset);
    OrbitTrack_Ingest.AddCountryCode(builder, countryCodeOffset);
    OrbitTrack_Ingest.AddSatStatus(builder, satStatusOffset);
    OrbitTrack_Ingest.AddIdentAmp(builder, identAmpOffset);
    OrbitTrack_Ingest.AddRptNum(builder, rptNumOffset);
    OrbitTrack_Ingest.AddCallSign(builder, callSignOffset);
    OrbitTrack_Ingest.AddTs(builder, tsOffset);
    OrbitTrack_Ingest.AddIdElset(builder, idElsetOffset);
    OrbitTrack_Ingest.AddOrigObjectId(builder, origObjectIdOffset);
    OrbitTrack_Ingest.AddSatNo(builder, satNo);
    OrbitTrack_Ingest.AddIdOnOrbit(builder, idOnOrbitOffset);
    OrbitTrack_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    OrbitTrack_Ingest.AddId(builder, idOffset);
    OrbitTrack_Ingest.AddDataMode(builder, dataMode);
    OrbitTrack_Ingest.AddInstallation(builder, installation);
    OrbitTrack_Ingest.AddFeint(builder, feint);
    OrbitTrack_Ingest.AddTaskForce(builder, taskForce);
    OrbitTrack_Ingest.AddDummy(builder, dummy);
    OrbitTrack_Ingest.AddHq(builder, hq);
    OrbitTrack_Ingest.AddReduced(builder, reduced);
    OrbitTrack_Ingest.AddReinforced(builder, reinforced);
    OrbitTrack_Ingest.AddObjectType(builder, objectType);
    OrbitTrack_Ingest.AddObjIdent(builder, objIdent);
    return OrbitTrack_Ingest.EndOrbitTrack_Ingest(builder);
  }

  public static void StartOrbitTrack_Ingest(FlatBufferBuilder builder) { builder.StartTable(45); }
  ...
  public static void AddObjIdent(FlatBufferBuilder builder, OrbitTrack_Ingest_objIdent_Enum objIdent) { builder.AddSbyte(13, (sbyte)objIdent, 0); }
  ...
  public static void AddObjectType(FlatBufferBuilder builder, OrbitTrack_Ingest_objectType_Enum objectType) { builder.AddSbyte(16, (sbyte)objectType, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OrbitTrack_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(43, (sbyte)dataMode, 0); }
  ...
  public static Offset<OrbitTrack_Ingest> EndOrbitTrack_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OrbitTrack_Ingest>(o);
  }
  public static void FinishOrbitTrack_IngestBuffer(FlatBufferBuilder builder, Offset<OrbitTrack_Ingest> offset) { builder.Finish(offset.Value, "ORBI"); }
  public static void FinishSizePrefixedOrbitTrack_IngestBuffer(FlatBufferBuilder builder, Offset<OrbitTrack_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "ORBI"); }
  public OrbitTrack_IngestT UnPack() {
    var _o = new OrbitTrack_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OrbitTrack_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OrbitTrack_Ingest> Pack(FlatBufferBuilder builder, OrbitTrack_IngestT _o) {
    if (_o == null) return default(Offset<OrbitTrack_Ingest>);
...
public class OrbitTrack_IngestT
{
  ...
  public OrbitTrack_Ingest_objIdent_Enum ObjIdent { get; set; }
  public string IdentAmp { get; set; }
  public string SatStatus { get; set; }
  public OrbitTrack_Ingest_objectType_Enum ObjectType { get; set; }
  ...
  public OrbitTrack_Ingest_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public OrbitTrack_IngestT() {
    this.Id = null;
    ...
    this.CallSign = null;
    this.RptNum = null;
    this.ObjIdent = OrbitTrack_Ingest_objIdent_Enum.ASSUMED_FRIEND;
    this.IdentAmp = null;
    this.SatStatus = null;
    this.ObjectType = OrbitTrack_Ingest_objectType_Enum.DEBRIS;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = OrbitTrack_Ingest_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static OrbitTrack_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return OrbitTrack_Ingest.GetRootAsOrbitTrack_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OrbitTrack_Ingest.FinishOrbitTrack_IngestBuffer(fbb, OrbitTrack_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OrbitTrack_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 30 /*ObjIdent*/, 1 /*OrbitTrack_Ingest_objIdent_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 32 /*IdentAmp*/, false)
      && verifier.VerifyString(tablePos, 34 /*SatStatus*/, false)
      && verifier.VerifyField(tablePos, 36 /*ObjectType*/, 1 /*OrbitTrack_Ingest_objectType_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 90 /*DataMode*/, 1 /*OrbitTrack_Ingest_dataMode_Enum*/, 1, false)
