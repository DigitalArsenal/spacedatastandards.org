...
public struct AircraftMissionTasking_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AircraftMissionTasking_Abridged GetRootAsAircraftMissionTasking_Abridged(ByteBuffer _bb) { return GetRootAsAircraftMissionTasking_Abridged(_bb, new AircraftMissionTasking_Abridged()); }
  public static AircraftMissionTasking_Abridged GetRootAsAircraftMissionTasking_Abridged(ByteBuffer _bb, AircraftMissionTasking_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AircraftMissionTasking_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRC"); }
  public static bool VerifyAircraftMissionTasking_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRC", false, AircraftMissionTasking_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AircraftMissionTasking_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<AircraftMissionTasking_Abridged> CreateAircraftMissionTasking_Abridged(FlatBufferBuilder builder,
  ...
  public static void StartAircraftMissionTasking_Abridged(FlatBufferBuilder builder) { builder.StartTable(24); }
  ...
  public static Offset<AircraftMissionTasking_Abridged> EndAircraftMissionTasking_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AircraftMissionTasking_Abridged>(o);
  }
  public static void FinishAircraftMissionTasking_AbridgedBuffer(FlatBufferBuilder builder, Offset<AircraftMissionTasking_Abridged> offset) { builder.Finish(offset.Value, "AIRC"); }
  public static void FinishSizePrefixedAircraftMissionTasking_AbridgedBuffer(FlatBufferBuilder builder, Offset<AircraftMissionTasking_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "AIRC"); }
  public AircraftMissionTasking_AbridgedT UnPack() {
    var _o = new AircraftMissionTasking_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AircraftMissionTasking_AbridgedT _o) {
  ...
  public static Offset<AircraftMissionTasking_Abridged> Pack(FlatBufferBuilder builder, AircraftMissionTasking_AbridgedT _o) {
    if (_o == null) return default(Offset<AircraftMissionTasking_Abridged>);
    ...
    return CreateAircraftMissionTasking_Abridged(
      builder,
      _countryCode,
      _taskedService,
      _unitDesignator,
...
public class AircraftMissionTasking_AbridgedT
{
  ...
  public AircraftMissionTasking_AbridgedT() {
  ...
  public static AircraftMissionTasking_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return AircraftMissionTasking_Abridged.GetRootAsAircraftMissionTasking_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AircraftMissionTasking_Abridged.FinishAircraftMissionTasking_AbridgedBuffer(fbb, AircraftMissionTasking_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AircraftMissionTasking_AbridgedVerify
{
