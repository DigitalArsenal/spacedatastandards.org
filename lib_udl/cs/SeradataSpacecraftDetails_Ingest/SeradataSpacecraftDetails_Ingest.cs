...
public struct SeradataSpacecraftDetails_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SeradataSpacecraftDetails_Ingest GetRootAsSeradataSpacecraftDetails_Ingest(ByteBuffer _bb) { return GetRootAsSeradataSpacecraftDetails_Ingest(_bb, new SeradataSpacecraftDetails_Ingest()); }
  public static SeradataSpacecraftDetails_Ingest GetRootAsSeradataSpacecraftDetails_Ingest(ByteBuffer _bb, SeradataSpacecraftDetails_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SeradataSpacecraftDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SERA"); }
  public static bool VerifySeradataSpacecraftDetails_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SERA", false, SeradataSpacecraftDetails_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SeradataSpacecraftDetails_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SeradataSpacecraftDetails_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(188); return o != 0 ? (SeradataSpacecraftDetails_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SeradataSpacecraftDetails_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<SeradataSpacecraftDetails_Ingest> CreateSeradataSpacecraftDetails_Ingest(FlatBufferBuilder builder,
      ...
      SeradataSpacecraftDetails_Ingest_dataMode_Enum dataMode = SeradataSpacecraftDetails_Ingest_dataMode_Enum.REAL,
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset)) {
    builder.StartTable(95);
    SeradataSpacecraftDetails_Ingest.AddCollisionRiskCM(builder, collisionRiskCM);
    SeradataSpacecraftDetails_Ingest.AddCollisionRiskMM(builder, collisionRiskMM);
    SeradataSpacecraftDetails_Ingest.AddAltitude(builder, altitude);
    SeradataSpacecraftDetails_Ingest.AddLon(builder, lon);
    SeradataSpacecraftDetails_Ingest.AddLat(builder, lat);
    SeradataSpacecraftDetails_Ingest.AddInsuranceLossesTotal(builder, insuranceLossesTotal);
    SeradataSpacecraftDetails_Ingest.AddGeoPosition(builder, geoPosition);
    SeradataSpacecraftDetails_Ingest.AddLifeLost(builder, lifeLost);
    SeradataSpacecraftDetails_Ingest.AddCurrentAge(builder, currentAge);
    SeradataSpacecraftDetails_Ingest.AddCapacityLost(builder, capacityLost);
    SeradataSpacecraftDetails_Ingest.AddCapabilityLost(builder, capabilityLost);
    SeradataSpacecraftDetails_Ingest.AddInsurancePremiumAtLaunch(builder, insurancePremiumAtLaunch);
    SeradataSpacecraftDetails_Ingest.AddAnnualInsuredDepreciationFactor(builder, annualInsuredDepreciationFactor);
    SeradataSpacecraftDetails_Ingest.AddInsuredValueAtLaunch(builder, insuredValueAtLaunch);
    SeradataSpacecraftDetails_Ingest.AddCombinedNewCost(builder, combinedNewCost);
    SeradataSpacecraftDetails_Ingest.AddNewCost(builder, newCost);
    SeradataSpacecraftDetails_Ingest.AddLaunchCost(builder, launchCost);
    SeradataSpacecraftDetails_Ingest.AddTotalPayloadPower(builder, totalPayloadPower);
    SeradataSpacecraftDetails_Ingest.AddDryMass(builder, dryMass);
    SeradataSpacecraftDetails_Ingest.AddLaunchMass(builder, launchMass);
    SeradataSpacecraftDetails_Ingest.AddInclination(builder, inclination);
    SeradataSpacecraftDetails_Ingest.AddPeriod(builder, period);
    SeradataSpacecraftDetails_Ingest.AddPerigee(builder, perigee);
    SeradataSpacecraftDetails_Ingest.AddApogee(builder, apogee);
    SeradataSpacecraftDetails_Ingest.AddCreatedBy(builder, createdByOffset);
    SeradataSpacecraftDetails_Ingest.AddCreatedAt(builder, createdAtOffset);
    SeradataSpacecraftDetails_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    SeradataSpacecraftDetails_Ingest.AddOrigin(builder, originOffset);
    SeradataSpacecraftDetails_Ingest.AddSource(builder, sourceOffset);
    SeradataSpacecraftDetails_Ingest.AddLaunchNotes(builder, launchNotesOffset);
    SeradataSpacecraftDetails_Ingest.AddInsuranceNotes(builder, insuranceNotesOffset);
    SeradataSpacecraftDetails_Ingest.AddNotes(builder, notesOffset);
    SeradataSpacecraftDetails_Ingest.AddReusableFlights(builder, reusableFlightsOffset);
    SeradataSpacecraftDetails_Ingest.AddQuantity(builder, quantity);
    SeradataSpacecraftDetails_Ingest.AddDateOfObservation(builder, dateOfObservationOffset);
    SeradataSpacecraftDetails_Ingest.AddReusedHullName(builder, reusedHullNameOffset);
    SeradataSpacecraftDetails_Ingest.AddProgramName(builder, programNameOffset);
    SeradataSpacecraftDetails_Ingest.AddSerialNumber(builder, serialNumberOffset);
    SeradataSpacecraftDetails_Ingest.AddLaunchArrangerCountry(builder, launchArrangerCountryOffset);
    SeradataSpacecraftDetails_Ingest.AddLaunchArranger(builder, launchArrangerOffset);
    SeradataSpacecraftDetails_Ingest.AddBusId(builder, busIdOffset);
    SeradataSpacecraftDetails_Ingest.AddNameAtLaunch(builder, nameAtLaunchOffset);
    SeradataSpacecraftDetails_Ingest.AddTotalFatalities(builder, totalFatalities);
    SeradataSpacecraftDetails_Ingest.AddTotalInjuries(builder, totalInjuries);
    SeradataSpacecraftDetails_Ingest.AddTotalClaims(builder, totalClaims);
    SeradataSpacecraftDetails_Ingest.AddAdditionalMissionsGroups(builder, additionalMissionsGroupsOffset);
    SeradataSpacecraftDetails_Ingest.AddPrimaryMissionGroup(builder, primaryMissionGroupOffset);
    SeradataSpacecraftDetails_Ingest.AddOrderDate(builder, orderDateOffset);
    SeradataSpacecraftDetails_Ingest.AddOperatorCountry(builder, operatorCountryOffset);
    SeradataSpacecraftDetails_Ingest.AddOperator(builder, @operatorOffset);
    SeradataSpacecraftDetails_Ingest.AddOwnerCountry(builder, ownerCountryOffset);
    SeradataSpacecraftDetails_Ingest.AddOwner(builder, ownerOffset);
    SeradataSpacecraftDetails_Ingest.AddStatus(builder, statusOffset);
    SeradataSpacecraftDetails_Ingest.AddYoutubeLaunchLink(builder, youtubeLaunchLinkOffset);
    SeradataSpacecraftDetails_Ingest.AddLaunchDateRemarks(builder, launchDateRemarksOffset);
    SeradataSpacecraftDetails_Ingest.AddLaunchDate(builder, launchDateOffset);
    SeradataSpacecraftDetails_Ingest.AddLaunchNumber(builder, launchNumberOffset);
    SeradataSpacecraftDetails_Ingest.AddLaunchCharacteristic(builder, launchCharacteristicOffset);
    SeradataSpacecraftDetails_Ingest.AddLaunchType(builder, launchTypeOffset);
    SeradataSpacecraftDetails_Ingest.AddLaunchProviderCountry(builder, launchProviderCountryOffset);
    SeradataSpacecraftDetails_Ingest.AddLaunchProvider(builder, launchProviderOffset);
    SeradataSpacecraftDetails_Ingest.AddLaunchCountry(builder, launchCountryOffset);
    SeradataSpacecraftDetails_Ingest.AddLaunchSiteId(builder, launchSiteIdOffset);
    SeradataSpacecraftDetails_Ingest.AddLaunchSiteName(builder, launchSiteNameOffset);
    SeradataSpacecraftDetails_Ingest.AddLaunchProviderFlightNumber(builder, launchProviderFlightNumberOffset);
    SeradataSpacecraftDetails_Ingest.AddLaunchVehicleId(builder, launchVehicleIdOffset);
    SeradataSpacecraftDetails_Ingest.AddLaunchId(builder, launchIdOffset);
    SeradataSpacecraftDetails_Ingest.AddMassCategory(builder, massCategoryOffset);
    SeradataSpacecraftDetails_Ingest.AddCubesatDispenserType(builder, cubesatDispenserTypeOffset);
    SeradataSpacecraftDetails_Ingest.AddNumHumans(builder, numHumans);
    SeradataSpacecraftDetails_Ingest.AddOrbitSubCategory(builder, orbitSubCategoryOffset);
    SeradataSpacecraftDetails_Ingest.AddOrbitCategory(builder, orbitCategoryOffset);
    SeradataSpacecraftDetails_Ingest.AddConstellation(builder, constellationOffset);
    SeradataSpacecraftDetails_Ingest.AddCatalogNumber(builder, catalogNumber);
    SeradataSpacecraftDetails_Ingest.AddExpectedLife(builder, expectedLife);
    SeradataSpacecraftDetails_Ingest.AddDesignLife(builder, designLife);
    SeradataSpacecraftDetails_Ingest.AddStabilizer(builder, stabilizerOffset);
    SeradataSpacecraftDetails_Ingest.AddPrimeManufacturerOrgId(builder, primeManufacturerOrgIdOffset);
    SeradataSpacecraftDetails_Ingest.AddSector(builder, sectorOffset);
    SeradataSpacecraftDetails_Ingest.AddIntlNumber(builder, intlNumberOffset);
    SeradataSpacecraftDetails_Ingest.AddDescription(builder, descriptionOffset);
    SeradataSpacecraftDetails_Ingest.AddName(builder, nameOffset);
    SeradataSpacecraftDetails_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    SeradataSpacecraftDetails_Ingest.AddIdOnOrbit(builder, idOnOrbitOffset);
    SeradataSpacecraftDetails_Ingest.AddId(builder, idOffset);
    SeradataSpacecraftDetails_Ingest.AddDataMode(builder, dataMode);
    SeradataSpacecraftDetails_Ingest.AddLeased(builder, leased);
    SeradataSpacecraftDetails_Ingest.AddCommercialLaunch(builder, commercialLaunch);
    SeradataSpacecraftDetails_Ingest.AddInsurancePremiumAtLaunchEstimated(builder, insurancePremiumAtLaunchEstimated);
    SeradataSpacecraftDetails_Ingest.AddAnnualInsuredDepreciationFactorEstimated(builder, annualInsuredDepreciationFactorEstimated);
    SeradataSpacecraftDetails_Ingest.AddInsuredValueLaunchEstimated(builder, insuredValueLaunchEstimated);
    SeradataSpacecraftDetails_Ingest.AddCombinedCostEstimated(builder, combinedCostEstimated);
    SeradataSpacecraftDetails_Ingest.AddCostEstimated(builder, costEstimated);
    SeradataSpacecraftDetails_Ingest.AddLaunchCostEstimated(builder, launchCostEstimated);
    SeradataSpacecraftDetails_Ingest.AddInsuredAtLaunch(builder, insuredAtLaunch);
    return SeradataSpacecraftDetails_Ingest.EndSeradataSpacecraftDetails_Ingest(builder);
  }

  public static void StartSeradataSpacecraftDetails_Ingest(FlatBufferBuilder builder) { builder.StartTable(95); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SeradataSpacecraftDetails_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(92, (sbyte)dataMode, 0); }
  ...
  public static Offset<SeradataSpacecraftDetails_Ingest> EndSeradataSpacecraftDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SeradataSpacecraftDetails_Ingest>(o);
  }
  public static void FinishSeradataSpacecraftDetails_IngestBuffer(FlatBufferBuilder builder, Offset<SeradataSpacecraftDetails_Ingest> offset) { builder.Finish(offset.Value, "SERA"); }
  public static void FinishSizePrefixedSeradataSpacecraftDetails_IngestBuffer(FlatBufferBuilder builder, Offset<SeradataSpacecraftDetails_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "SERA"); }
  public SeradataSpacecraftDetails_IngestT UnPack() {
    var _o = new SeradataSpacecraftDetails_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SeradataSpacecraftDetails_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SeradataSpacecraftDetails_Ingest> Pack(FlatBufferBuilder builder, SeradataSpacecraftDetails_IngestT _o) {
    if (_o == null) return default(Offset<SeradataSpacecraftDetails_Ingest>);
...
public class SeradataSpacecraftDetails_IngestT
{
  ...
  public SeradataSpacecraftDetails_Ingest_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }

  public SeradataSpacecraftDetails_IngestT() {
    this.Id = null;
    this.IdOnOrbit = null;
    ...
    this.DataMode = SeradataSpacecraftDetails_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
  }
  public static SeradataSpacecraftDetails_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return SeradataSpacecraftDetails_Ingest.GetRootAsSeradataSpacecraftDetails_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SeradataSpacecraftDetails_Ingest.FinishSeradataSpacecraftDetails_IngestBuffer(fbb, SeradataSpacecraftDetails_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SeradataSpacecraftDetails_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 188 /*DataMode*/, 1 /*SeradataSpacecraftDetails_Ingest_dataMode_Enum*/, 1, false)
