...
public struct AirTransportMissionHazMat_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static AirTransportMissionHazMat_Full GetRootAsAirTransportMissionHazMat_Full(ByteBuffer _bb, AirTransportMissionHazMat_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirTransportMissionHazMat_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRT"); }
  public static bool VerifyAirTransportMissionHazMat_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRT", false, AirTransportMissionHazMat_FullVerify.Verify); }
  ...
  public static Offset<AirTransportMissionHazMat_Full> CreateAirTransportMissionHazMat_Full(FlatBufferBuilder builder,
  ...
  public static Offset<AirTransportMissionHazMat_Full> EndAirTransportMissionHazMat_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirTransportMissionHazMat_Full>(o);
  }
  public static void FinishAirTransportMissionHazMat_FullBuffer(FlatBufferBuilder builder, Offset<AirTransportMissionHazMat_Full> offset) { builder.Finish(offset.Value, "AIRT"); }
  public static void FinishSizePrefixedAirTransportMissionHazMat_FullBuffer(FlatBufferBuilder builder, Offset<AirTransportMissionHazMat_Full> offset) { builder.FinishSizePrefixed(offset.Value, "AIRT"); }
  public AirTransportMissionHazMat_FullT UnPack() {
    var _o = new AirTransportMissionHazMat_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirTransportMissionHazMat_FullT _o) {
  ...
  public static Offset<AirTransportMissionHazMat_Full> Pack(FlatBufferBuilder builder, AirTransportMissionHazMat_FullT _o) {
    if (_o == null) return default(Offset<AirTransportMissionHazMat_Full>);
...
public class AirTransportMissionHazMat_FullT
{
  ...
  public AirTransportMissionHazMat_FullT() {
  ...
  public static AirTransportMissionHazMat_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return AirTransportMissionHazMat_Full.GetRootAsAirTransportMissionHazMat_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirTransportMissionHazMat_Full.FinishAirTransportMissionHazMat_FullBuffer(fbb, AirTransportMissionHazMat_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirTransportMissionHazMat_FullVerify
{
