...
public struct AirspaceControlPoint_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static AirspaceControlPoint_Full GetRootAsAirspaceControlPoint_Full(ByteBuffer _bb, AirspaceControlPoint_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirspaceControlPoint_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRS"); }
  public static bool VerifyAirspaceControlPoint_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRS", false, AirspaceControlPoint_FullVerify.Verify); }
  ...
  public static Offset<AirspaceControlPoint_Full> CreateAirspaceControlPoint_Full(FlatBufferBuilder builder,
  ...
  public static Offset<AirspaceControlPoint_Full> EndAirspaceControlPoint_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirspaceControlPoint_Full>(o);
  }
  public static void FinishAirspaceControlPoint_FullBuffer(FlatBufferBuilder builder, Offset<AirspaceControlPoint_Full> offset) { builder.Finish(offset.Value, "AIRS"); }
  public static void FinishSizePrefixedAirspaceControlPoint_FullBuffer(FlatBufferBuilder builder, Offset<AirspaceControlPoint_Full> offset) { builder.FinishSizePrefixed(offset.Value, "AIRS"); }
  public AirspaceControlPoint_FullT UnPack() {
    var _o = new AirspaceControlPoint_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirspaceControlPoint_FullT _o) {
  ...
  public static Offset<AirspaceControlPoint_Full> Pack(FlatBufferBuilder builder, AirspaceControlPoint_FullT _o) {
    if (_o == null) return default(Offset<AirspaceControlPoint_Full>);
...
public class AirspaceControlPoint_FullT
{
  ...
  public AirspaceControlPoint_FullT() {
    this.CtrlPtType = null;
    this.CtrlPtName = null;
    this.CtrlPtLocation = null;
    this.CtrlPtAltitude = null;
  }
  public static AirspaceControlPoint_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return AirspaceControlPoint_Full.GetRootAsAirspaceControlPoint_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirspaceControlPoint_Full.FinishAirspaceControlPoint_FullBuffer(fbb, AirspaceControlPoint_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirspaceControlPoint_FullVerify
{
