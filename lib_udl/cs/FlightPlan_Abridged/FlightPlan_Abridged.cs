...
public struct FlightPlan_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static FlightPlan_Abridged GetRootAsFlightPlan_Abridged(ByteBuffer _bb) { return GetRootAsFlightPlan_Abridged(_bb, new FlightPlan_Abridged()); }
  public static FlightPlan_Abridged GetRootAsFlightPlan_Abridged(ByteBuffer _bb, FlightPlan_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool FlightPlan_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "FLIG"); }
  public static bool VerifyFlightPlan_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("FLIG", false, FlightPlan_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public FlightPlan_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public FlightPlan_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(186); return o != 0 ? (FlightPlan_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : FlightPlan_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<FlightPlan_Abridged> CreateFlightPlan_Abridged(FlatBufferBuilder builder,
      ...
      FlightPlan_Abridged_dataMode_Enum dataMode = FlightPlan_Abridged_dataMode_Enum.REAL,
  ...
  public static void StartFlightPlan_Abridged(FlatBufferBuilder builder) { builder.StartTable(96); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, FlightPlan_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(91, (sbyte)dataMode, 0); }
  ...
  public static Offset<FlightPlan_Abridged> EndFlightPlan_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlightPlan_Abridged>(o);
  }
  public static void FinishFlightPlan_AbridgedBuffer(FlatBufferBuilder builder, Offset<FlightPlan_Abridged> offset) { builder.Finish(offset.Value, "FLIG"); }
  public static void FinishSizePrefixedFlightPlan_AbridgedBuffer(FlatBufferBuilder builder, Offset<FlightPlan_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "FLIG"); }
  public FlightPlan_AbridgedT UnPack() {
    var _o = new FlightPlan_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(FlightPlan_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<FlightPlan_Abridged> Pack(FlatBufferBuilder builder, FlightPlan_AbridgedT _o) {
    if (_o == null) return default(Offset<FlightPlan_Abridged>);
...
public class FlightPlan_AbridgedT
{
  ...
  public FlightPlan_Abridged_dataMode_Enum DataMode { get; set; }
  ...
  public FlightPlan_AbridgedT() {
    ...
    this.DataMode = FlightPlan_Abridged_dataMode_Enum.REAL;
    this.AirRefuelEvents = null;
    this.FlightPlanMessages = null;
    this.FlightPlanWaypoints = null;
    this.FlightPlanPointGroups = null;
  }
  public static FlightPlan_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return FlightPlan_Abridged.GetRootAsFlightPlan_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    FlightPlan_Abridged.FinishFlightPlan_AbridgedBuffer(fbb, FlightPlan_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class FlightPlan_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 186 /*DataMode*/, 1 /*FlightPlan_Abridged_dataMode_Enum*/, 1, false)
