...
public struct EphemerisSet_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static EphemerisSet_Ingest GetRootAsEphemerisSet_Ingest(ByteBuffer _bb, EphemerisSet_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EphemerisSet_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EPHE"); }
  public static bool VerifyEphemerisSet_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EPHE", false, EphemerisSet_IngestVerify.Verify); }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 24
  public EphemerisSet_Ingest_referenceFrame_Enum ReferenceFrame { get { int o = __p.__offset(68); return o != 0 ? (EphemerisSet_Ingest_referenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EphemerisSet_Ingest_referenceFrame_Enum.J2000; } }
  /// The reference frame of the covariance matrix elements. If the covReferenceFrame is null it is assumed to be J2000.
  /// Example: /// Example: J2000
  /// Constraints: Minimum length = 0, Maximum length = 24
  public EphemerisSet_Ingest_covReferenceFrame_Enum CovReferenceFrame { get { int o = __p.__offset(70); return o != 0 ? (EphemerisSet_Ingest_covReferenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EphemerisSet_Ingest_covReferenceFrame_Enum.J2000; } }
  ...
  public EphemerisSet_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(80); return o != 0 ? (EphemerisSet_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EphemerisSet_Ingest_dataMode_Enum.REAL; } }
  ...
  /// Constraints: No constraints specified.
  public string EphemerisList(int j) { int o = __p.__offset(84); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int EphemerisListLength { get { int o = __p.__offset(84); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string TransactionId { get { int o = __p.__offset(88); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTransactionIdBytes() { return __p.__vector_as_span<byte>(88, 1); }
#else
  public ArraySegment<byte>? GetTransactionIdBytes() { return __p.__vector_as_arraysegment(88); }
#endif
  public byte[] GetTransactionIdArray() { return __p.__vector_as_array<byte>(88); }
  ...
  public static Offset<EphemerisSet_Ingest> CreateEphemerisSet_Ingest(FlatBufferBuilder builder,
      ...
      EphemerisSet_Ingest_referenceFrame_Enum referenceFrame = EphemerisSet_Ingest_referenceFrame_Enum.J2000,
      EphemerisSet_Ingest_covReferenceFrame_Enum covReferenceFrame = EphemerisSet_Ingest_covReferenceFrame_Enum.J2000,
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset),
      StringOffset sourceOffset = default(StringOffset),
      StringOffset originOffset = default(StringOffset),
      EphemerisSet_Ingest_dataMode_Enum dataMode = EphemerisSet_Ingest_dataMode_Enum.REAL,
      int satNo = 0,
  ...
  public static void AddReferenceFrame(FlatBufferBuilder builder, EphemerisSet_Ingest_referenceFrame_Enum referenceFrame) { builder.AddSbyte(32, (sbyte)referenceFrame, 0); }
  public static void AddCovReferenceFrame(FlatBufferBuilder builder, EphemerisSet_Ingest_covReferenceFrame_Enum covReferenceFrame) { builder.AddSbyte(33, (sbyte)covReferenceFrame, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, EphemerisSet_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(38, (sbyte)dataMode, 0); }
  public static void AddSatNo(FlatBufferBuilder builder, int satNo) { builder.AddInt(39, satNo, 0); }
  public static void AddEphemerisList(FlatBufferBuilder builder, VectorOffset ephemerisListOffset) { builder.AddOffset(40, ephemerisListOffset.Value, 0); }
  ...
  public static void AddTransactionId(FlatBufferBuilder builder, StringOffset transactionIdOffset) { builder.AddOffset(42, transactionIdOffset.Value, 0); }
  ...
  public static Offset<EphemerisSet_Ingest> EndEphemerisSet_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EphemerisSet_Ingest>(o);
  }
  public static void FinishEphemerisSet_IngestBuffer(FlatBufferBuilder builder, Offset<EphemerisSet_Ingest> offset) { builder.Finish(offset.Value, "EPHE"); }
  public static void FinishSizePrefixedEphemerisSet_IngestBuffer(FlatBufferBuilder builder, Offset<EphemerisSet_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "EPHE"); }
  public EphemerisSet_IngestT UnPack() {
    var _o = new EphemerisSet_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EphemerisSet_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<EphemerisSet_Ingest> Pack(FlatBufferBuilder builder, EphemerisSet_IngestT _o) {
    if (_o == null) return default(Offset<EphemerisSet_Ingest>);
...
public class EphemerisSet_IngestT
{
  ...
  public EphemerisSet_Ingest_referenceFrame_Enum ReferenceFrame { get; set; }
  public EphemerisSet_Ingest_covReferenceFrame_Enum CovReferenceFrame { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string Source { get; set; }
  public string Origin { get; set; }
  public EphemerisSet_Ingest_dataMode_Enum DataMode { get; set; }
  ...
  public EphemerisSet_IngestT() {
    ...
    this.ReferenceFrame = EphemerisSet_Ingest_referenceFrame_Enum.J2000;
    this.CovReferenceFrame = EphemerisSet_Ingest_covReferenceFrame_Enum.J2000;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.Source = null;
    this.Origin = null;
    this.DataMode = EphemerisSet_Ingest_dataMode_Enum.REAL;
    this.SatNo = 0;
  ...
  public static EphemerisSet_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return EphemerisSet_Ingest.GetRootAsEphemerisSet_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EphemerisSet_Ingest.FinishEphemerisSet_IngestBuffer(fbb, EphemerisSet_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EphemerisSet_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 68 /*ReferenceFrame*/, 1 /*EphemerisSet_Ingest_referenceFrame_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 70 /*CovReferenceFrame*/, 1 /*EphemerisSet_Ingest_covReferenceFrame_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 80 /*DataMode*/, 1 /*EphemerisSet_Ingest_dataMode_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 82 /*SatNo*/, 4 /*int*/, 4, false)
      && verifier.VerifyVectorOfStrings(tablePos, 84 /*EphemerisList*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 86 /*Tags*/, false)
      && verifier.VerifyString(tablePos, 88 /*TransactionId*/, false)
