...
public struct SiteRemark_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static SiteRemark_Abridged GetRootAsSiteRemark_Abridged(ByteBuffer _bb, SiteRemark_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SiteRemark_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SITE"); }
  public static bool VerifySiteRemark_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SITE", false, SiteRemark_AbridgedVerify.Verify); }
  ...
  public SiteRemark_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(30); return o != 0 ? (SiteRemark_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SiteRemark_Abridged_dataMode_Enum.REAL; } }

  public static Offset<SiteRemark_Abridged> CreateSiteRemark_Abridged(FlatBufferBuilder builder,
      ...
      SiteRemark_Abridged_dataMode_Enum dataMode = SiteRemark_Abridged_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SiteRemark_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(13, (sbyte)dataMode, 0); }
  public static Offset<SiteRemark_Abridged> EndSiteRemark_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SiteRemark_Abridged>(o);
  }
  public static void FinishSiteRemark_AbridgedBuffer(FlatBufferBuilder builder, Offset<SiteRemark_Abridged> offset) { builder.Finish(offset.Value, "SITE"); }
  public static void FinishSizePrefixedSiteRemark_AbridgedBuffer(FlatBufferBuilder builder, Offset<SiteRemark_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "SITE"); }
  public SiteRemark_AbridgedT UnPack() {
    var _o = new SiteRemark_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SiteRemark_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SiteRemark_Abridged> Pack(FlatBufferBuilder builder, SiteRemark_AbridgedT _o) {
    if (_o == null) return default(Offset<SiteRemark_Abridged>);
...
public class SiteRemark_AbridgedT
{
  ...
  public SiteRemark_Abridged_dataMode_Enum DataMode { get; set; }

  public SiteRemark_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = SiteRemark_Abridged_dataMode_Enum.REAL;
  }
  public static SiteRemark_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return SiteRemark_Abridged.GetRootAsSiteRemark_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SiteRemark_Abridged.FinishSiteRemark_AbridgedBuffer(fbb, SiteRemark_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SiteRemark_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 30 /*DataMode*/, 1 /*SiteRemark_Abridged_dataMode_Enum*/, 1, false)
