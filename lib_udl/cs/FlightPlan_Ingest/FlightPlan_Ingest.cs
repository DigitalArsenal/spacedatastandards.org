...
public struct FlightPlan_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static FlightPlan_Ingest GetRootAsFlightPlan_Ingest(ByteBuffer _bb, FlightPlan_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool FlightPlan_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "FLIG"); }
  public static bool VerifyFlightPlan_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("FLIG", false, FlightPlan_IngestVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public FlightPlan_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(186); return o != 0 ? (FlightPlan_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : FlightPlan_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<FlightPlan_Ingest> CreateFlightPlan_Ingest(FlatBufferBuilder builder,
      ...
      FlightPlan_Ingest_dataMode_Enum dataMode = FlightPlan_Ingest_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, FlightPlan_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(91, (sbyte)dataMode, 0); }
  ...
  public static Offset<FlightPlan_Ingest> EndFlightPlan_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlightPlan_Ingest>(o);
  }
  public static void FinishFlightPlan_IngestBuffer(FlatBufferBuilder builder, Offset<FlightPlan_Ingest> offset) { builder.Finish(offset.Value, "FLIG"); }
  public static void FinishSizePrefixedFlightPlan_IngestBuffer(FlatBufferBuilder builder, Offset<FlightPlan_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "FLIG"); }
  public FlightPlan_IngestT UnPack() {
    var _o = new FlightPlan_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(FlightPlan_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<FlightPlan_Ingest> Pack(FlatBufferBuilder builder, FlightPlan_IngestT _o) {
    if (_o == null) return default(Offset<FlightPlan_Ingest>);
...
public class FlightPlan_IngestT
{
  ...
  public FlightPlan_Ingest_dataMode_Enum DataMode { get; set; }
  ...
  public FlightPlan_IngestT() {
    ...
    this.DataMode = FlightPlan_Ingest_dataMode_Enum.REAL;
    this.AirRefuelEvents = null;
    this.FlightPlanMessages = null;
    this.FlightPlanWaypoints = null;
    this.FlightPlanPointGroups = null;
  }
  public static FlightPlan_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return FlightPlan_Ingest.GetRootAsFlightPlan_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    FlightPlan_Ingest.FinishFlightPlan_IngestBuffer(fbb, FlightPlan_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class FlightPlan_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 186 /*DataMode*/, 1 /*FlightPlan_Ingest_dataMode_Enum*/, 1, false)
