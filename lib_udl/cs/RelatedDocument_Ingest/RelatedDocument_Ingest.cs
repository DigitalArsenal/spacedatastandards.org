...
public struct RelatedDocument_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static RelatedDocument_Ingest GetRootAsRelatedDocument_Ingest(ByteBuffer _bb, RelatedDocument_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool RelatedDocument_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "RELA"); }
  public static bool VerifyRelatedDocument_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("RELA", false, RelatedDocument_IngestVerify.Verify); }
  ...
  public static Offset<RelatedDocument_Ingest> CreateRelatedDocument_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<RelatedDocument_Ingest> EndRelatedDocument_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RelatedDocument_Ingest>(o);
  }
  public static void FinishRelatedDocument_IngestBuffer(FlatBufferBuilder builder, Offset<RelatedDocument_Ingest> offset) { builder.Finish(offset.Value, "RELA"); }
  public static void FinishSizePrefixedRelatedDocument_IngestBuffer(FlatBufferBuilder builder, Offset<RelatedDocument_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "RELA"); }
  public RelatedDocument_IngestT UnPack() {
    var _o = new RelatedDocument_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RelatedDocument_IngestT _o) {
  ...
  public static Offset<RelatedDocument_Ingest> Pack(FlatBufferBuilder builder, RelatedDocument_IngestT _o) {
    if (_o == null) return default(Offset<RelatedDocument_Ingest>);
...
public class RelatedDocument_IngestT
{
  public string DocumentId { get; set; }
  public List<string> DataSourceRefs { get; set; }

  public RelatedDocument_IngestT() {
    this.DocumentId = null;
    this.DataSourceRefs = null;
  }
  public static RelatedDocument_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return RelatedDocument_Ingest.GetRootAsRelatedDocument_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    RelatedDocument_Ingest.FinishRelatedDocument_IngestBuffer(fbb, RelatedDocument_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class RelatedDocument_IngestVerify
{
