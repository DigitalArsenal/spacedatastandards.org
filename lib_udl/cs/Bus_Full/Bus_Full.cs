...
public struct Bus_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Bus_Full GetRootAsBus_Full(ByteBuffer _bb) { return GetRootAsBus_Full(_bb, new Bus_Full()); }
  public static Bus_Full GetRootAsBus_Full(ByteBuffer _bb, Bus_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Bus_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "BUSF"); }
  public static bool VerifyBus_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("BUSF", false, Bus_FullVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Bus_Full_dataMode_Enum DataMode { get { int o = __p.__offset(110); return o != 0 ? (Bus_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Bus_Full_dataMode_Enum.REAL; } }
  ...
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string UpdatedAt { get { int o = __p.__offset(116); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedAtBytes() { return __p.__vector_as_span<byte>(116, 1); }
#else
  public ArraySegment<byte>? GetUpdatedAtBytes() { return __p.__vector_as_arraysegment(116); }
#endif
  public byte[] GetUpdatedAtArray() { return __p.__vector_as_array<byte>(116); }
  /// Application user who updated the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string UpdatedBy { get { int o = __p.__offset(118); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedByBytes() { return __p.__vector_as_span<byte>(118, 1); }
#else
  public ArraySegment<byte>? GetUpdatedByBytes() { return __p.__vector_as_arraysegment(118); }
#endif
  public byte[] GetUpdatedByArray() { return __p.__vector_as_array<byte>(118); }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string Entity { get { int o = __p.__offset(120); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetEntityBytes() { return __p.__vector_as_span<byte>(120, 1); }
#else
  public ArraySegment<byte>? GetEntityBytes() { return __p.__vector_as_arraysegment(120); }
#endif
  public byte[] GetEntityArray() { return __p.__vector_as_array<byte>(120); }

  public static Offset<Bus_Full> CreateBus_Full(FlatBufferBuilder builder,
      ...
      Bus_Full_dataMode_Enum dataMode = Bus_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Bus_Full_dataMode_Enum dataMode) { builder.AddSbyte(53, (sbyte)dataMode, 0); }
  ...
  public static void AddUpdatedAt(FlatBufferBuilder builder, StringOffset updatedAtOffset) { builder.AddOffset(56, updatedAtOffset.Value, 0); }
  public static void AddUpdatedBy(FlatBufferBuilder builder, StringOffset updatedByOffset) { builder.AddOffset(57, updatedByOffset.Value, 0); }
  public static void AddEntity(FlatBufferBuilder builder, StringOffset entityOffset) { builder.AddOffset(58, entityOffset.Value, 0); }
  public static Offset<Bus_Full> EndBus_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Bus_Full>(o);
  }
  public static void FinishBus_FullBuffer(FlatBufferBuilder builder, Offset<Bus_Full> offset) { builder.Finish(offset.Value, "BUSF"); }
  public static void FinishSizePrefixedBus_FullBuffer(FlatBufferBuilder builder, Offset<Bus_Full> offset) { builder.FinishSizePrefixed(offset.Value, "BUSF"); }
  public Bus_FullT UnPack() {
    var _o = new Bus_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Bus_FullT _o) {
    _o.Id = this.Id;
    _o.Name = this.Name;
  ...
  public static Offset<Bus_Full> Pack(FlatBufferBuilder builder, Bus_FullT _o) {
    if (_o == null) return default(Offset<Bus_Full>);
...
public class Bus_FullT
{
  ...
  public Bus_Full_dataMode_Enum DataMode { get; set; }
  ...
  public Bus_FullT() {
    ...
    this.DataMode = Bus_Full_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.UpdatedAt = null;
    this.UpdatedBy = null;
  ...
  public static Bus_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Bus_Full.GetRootAsBus_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Bus_Full.FinishBus_FullBuffer(fbb, Bus_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Bus_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 110 /*DataMode*/, 1 /*Bus_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 112 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 114 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 116 /*UpdatedAt*/, false)
      && verifier.VerifyString(tablePos, 118 /*UpdatedBy*/, false)
      && verifier.VerifyString(tablePos, 120 /*Entity*/, false)
