...
public struct LogisticsSegments_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static LogisticsSegments_Ingest GetRootAsLogisticsSegments_Ingest(ByteBuffer _bb) { return GetRootAsLogisticsSegments_Ingest(_bb, new LogisticsSegments_Ingest()); }
  public static LogisticsSegments_Ingest GetRootAsLogisticsSegments_Ingest(ByteBuffer _bb, LogisticsSegments_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LogisticsSegments_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LOGI"); }
  public static bool VerifyLogisticsSegments_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LOGI", false, LogisticsSegments_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public LogisticsSegments_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<LogisticsSegments_Ingest> CreateLogisticsSegments_Ingest(FlatBufferBuilder builder,
      int segmentNumber = 0,
  ...
  public static void StartLogisticsSegments_Ingest(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<LogisticsSegments_Ingest> EndLogisticsSegments_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LogisticsSegments_Ingest>(o);
  }
  public static void FinishLogisticsSegments_IngestBuffer(FlatBufferBuilder builder, Offset<LogisticsSegments_Ingest> offset) { builder.Finish(offset.Value, "LOGI"); }
  public static void FinishSizePrefixedLogisticsSegments_IngestBuffer(FlatBufferBuilder builder, Offset<LogisticsSegments_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "LOGI"); }
  public LogisticsSegments_IngestT UnPack() {
    var _o = new LogisticsSegments_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LogisticsSegments_IngestT _o) {
  ...
  public static Offset<LogisticsSegments_Ingest> Pack(FlatBufferBuilder builder, LogisticsSegments_IngestT _o) {
    if (_o == null) return default(Offset<LogisticsSegments_Ingest>);
...
public class LogisticsSegments_IngestT
{
  ...
  public LogisticsSegments_IngestT() {
  ...
  public static LogisticsSegments_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return LogisticsSegments_Ingest.GetRootAsLogisticsSegments_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LogisticsSegments_Ingest.FinishLogisticsSegments_IngestBuffer(fbb, LogisticsSegments_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LogisticsSegments_IngestVerify
{
