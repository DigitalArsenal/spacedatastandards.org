...
public struct EvacTreatment_Full : IFlatbufferObject
{
  ...
  public static Offset<EvacTreatment_Full.EvacTreatment_Full> CreateEvacTreatment_Full(FlatBufferBuilder builder,
  ...
  public static Offset<EvacTreatment_Full.EvacTreatment_Full> EndEvacTreatment_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EvacTreatment_Full.EvacTreatment_Full>(o);
  }
  ...
  public static Offset<EvacTreatment_Full.EvacTreatment_Full> Pack(FlatBufferBuilder builder, EvacTreatment_FullT _o) {
    if (_o == null) return default(Offset<EvacTreatment_Full.EvacTreatment_Full>);
