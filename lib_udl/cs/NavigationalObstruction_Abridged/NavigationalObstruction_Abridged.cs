...
public struct NavigationalObstruction_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static NavigationalObstruction_Abridged GetRootAsNavigationalObstruction_Abridged(ByteBuffer _bb, NavigationalObstruction_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool NavigationalObstruction_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "NAVI"); }
  public static bool VerifyNavigationalObstruction_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("NAVI", false, NavigationalObstruction_AbridgedVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public NavigationalObstruction_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(156); return o != 0 ? (NavigationalObstruction_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : NavigationalObstruction_Abridged_dataMode_Enum.REAL; } }

  public static Offset<NavigationalObstruction_Abridged> CreateNavigationalObstruction_Abridged(FlatBufferBuilder builder,
      ...
      NavigationalObstruction_Abridged_dataMode_Enum dataMode = NavigationalObstruction_Abridged_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, NavigationalObstruction_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(76, (sbyte)dataMode, 0); }
  public static Offset<NavigationalObstruction_Abridged> EndNavigationalObstruction_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<NavigationalObstruction_Abridged>(o);
  }
  public static void FinishNavigationalObstruction_AbridgedBuffer(FlatBufferBuilder builder, Offset<NavigationalObstruction_Abridged> offset) { builder.Finish(offset.Value, "NAVI"); }
  public static void FinishSizePrefixedNavigationalObstruction_AbridgedBuffer(FlatBufferBuilder builder, Offset<NavigationalObstruction_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "NAVI"); }
  public NavigationalObstruction_AbridgedT UnPack() {
    var _o = new NavigationalObstruction_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(NavigationalObstruction_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<NavigationalObstruction_Abridged> Pack(FlatBufferBuilder builder, NavigationalObstruction_AbridgedT _o) {
    if (_o == null) return default(Offset<NavigationalObstruction_Abridged>);
...
public class NavigationalObstruction_AbridgedT
{
  ...
  public NavigationalObstruction_Abridged_dataMode_Enum DataMode { get; set; }

  public NavigationalObstruction_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = NavigationalObstruction_Abridged_dataMode_Enum.REAL;
  }
  public static NavigationalObstruction_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return NavigationalObstruction_Abridged.GetRootAsNavigationalObstruction_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    NavigationalObstruction_Abridged.FinishNavigationalObstruction_AbridgedBuffer(fbb, NavigationalObstruction_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class NavigationalObstruction_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 156 /*DataMode*/, 1 /*NavigationalObstruction_Abridged_dataMode_Enum*/, 1, false)
