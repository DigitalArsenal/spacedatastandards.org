...
public struct LaunchEvent_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static LaunchEvent_Abridged GetRootAsLaunchEvent_Abridged(ByteBuffer _bb, LaunchEvent_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LaunchEvent_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LAUN"); }
  public static bool VerifyLaunchEvent_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LAUN", false, LaunchEvent_AbridgedVerify.Verify); }
  ...
  public LaunchEvent_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(38); return o != 0 ? (LaunchEvent_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : LaunchEvent_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<LaunchEvent_Abridged> CreateLaunchEvent_Abridged(FlatBufferBuilder builder,
      ...
      LaunchEvent_Abridged_dataMode_Enum dataMode = LaunchEvent_Abridged_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, LaunchEvent_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(17, (sbyte)dataMode, 0); }
  ...
  public static Offset<LaunchEvent_Abridged> EndLaunchEvent_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LaunchEvent_Abridged>(o);
  }
  public static void FinishLaunchEvent_AbridgedBuffer(FlatBufferBuilder builder, Offset<LaunchEvent_Abridged> offset) { builder.Finish(offset.Value, "LAUN"); }
  public static void FinishSizePrefixedLaunchEvent_AbridgedBuffer(FlatBufferBuilder builder, Offset<LaunchEvent_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "LAUN"); }
  public LaunchEvent_AbridgedT UnPack() {
    var _o = new LaunchEvent_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LaunchEvent_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<LaunchEvent_Abridged> Pack(FlatBufferBuilder builder, LaunchEvent_AbridgedT _o) {
    if (_o == null) return default(Offset<LaunchEvent_Abridged>);
...
public class LaunchEvent_AbridgedT
{
  ...
  public LaunchEvent_Abridged_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }
  public int SatNo { get; set; }

  public LaunchEvent_AbridgedT() {
    this.Id = null;
    this.IdOnOrbit = null;
    ...
    this.Origin = null;
    this.Source = null;
    this.DataMode = LaunchEvent_Abridged_dataMode_Enum.REAL;
    this.OrigNetwork = null;
    this.SatNo = 0;
  }
  public static LaunchEvent_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return LaunchEvent_Abridged.GetRootAsLaunchEvent_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LaunchEvent_Abridged.FinishLaunchEvent_AbridgedBuffer(fbb, LaunchEvent_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LaunchEvent_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 38 /*DataMode*/, 1 /*LaunchEvent_Abridged_dataMode_Enum*/, 1, false)
