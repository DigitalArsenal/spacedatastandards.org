...
public struct Item_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Item_Ingest GetRootAsItem_Ingest(ByteBuffer _bb) { return GetRootAsItem_Ingest(_bb, new Item_Ingest()); }
  public static Item_Ingest GetRootAsItem_Ingest(ByteBuffer _bb, Item_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Item_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ITEM"); }
  public static bool VerifyItem_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ITEM", false, Item_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Item_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Item_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(104); return o != 0 ? (Item_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Item_Ingest_dataMode_Enum.REAL; } }

  public static Offset<Item_Ingest> CreateItem_Ingest(FlatBufferBuilder builder,
      ...
      Item_Ingest_dataMode_Enum dataMode = Item_Ingest_dataMode_Enum.REAL) {
  ...
  public static void StartItem_Ingest(FlatBufferBuilder builder) { builder.StartTable(51); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Item_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(50, (sbyte)dataMode, 0); }
  public static Offset<Item_Ingest> EndItem_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Item_Ingest>(o);
  }
  public static void FinishItem_IngestBuffer(FlatBufferBuilder builder, Offset<Item_Ingest> offset) { builder.Finish(offset.Value, "ITEM"); }
  public static void FinishSizePrefixedItem_IngestBuffer(FlatBufferBuilder builder, Offset<Item_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "ITEM"); }
  public Item_IngestT UnPack() {
    var _o = new Item_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Item_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Item_Ingest> Pack(FlatBufferBuilder builder, Item_IngestT _o) {
    if (_o == null) return default(Offset<Item_Ingest>);
...
public class Item_IngestT
{
  ...
  public Item_Ingest_dataMode_Enum DataMode { get; set; }
  ...
  public Item_IngestT() {
    ...
    this.DataMode = Item_Ingest_dataMode_Enum.REAL;
  }
  public static Item_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Item_Ingest.GetRootAsItem_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Item_Ingest.FinishItem_IngestBuffer(fbb, Item_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Item_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 104 /*DataMode*/, 1 /*Item_Ingest_dataMode_Enum*/, 1, false)
