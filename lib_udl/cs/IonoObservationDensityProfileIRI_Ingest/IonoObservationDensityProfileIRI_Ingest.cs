...
public struct IonoObservationDensityProfileIRI_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static IonoObservationDensityProfileIRI_Ingest GetRootAsIonoObservationDensityProfileIRI_Ingest(ByteBuffer _bb, IonoObservationDensityProfileIRI_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationDensityProfileIRI_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationDensityProfileIRI_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationDensityProfileIRI_IngestVerify.Verify); }
  ...
  public static Offset<IonoObservationDensityProfileIRI_Ingest> CreateIonoObservationDensityProfileIRI_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<IonoObservationDensityProfileIRI_Ingest> EndIonoObservationDensityProfileIRI_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationDensityProfileIRI_Ingest>(o);
  }
  public static void FinishIonoObservationDensityProfileIRI_IngestBuffer(FlatBufferBuilder builder, Offset<IonoObservationDensityProfileIRI_Ingest> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationDensityProfileIRI_IngestBuffer(FlatBufferBuilder builder, Offset<IonoObservationDensityProfileIRI_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationDensityProfileIRI_IngestT UnPack() {
    var _o = new IonoObservationDensityProfileIRI_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationDensityProfileIRI_IngestT _o) {
  ...
  public static Offset<IonoObservationDensityProfileIRI_Ingest> Pack(FlatBufferBuilder builder, IonoObservationDensityProfileIRI_IngestT _o) {
    if (_o == null) return default(Offset<IonoObservationDensityProfileIRI_Ingest>);
    var _description = _o.Description == null ? default(StringOffset) : builder.CreateString(_o.Description);
    return CreateIonoObservationDensityProfileIRI_Ingest(
      builder,
      _description,
      _o.NmF2,
      _o.HmF2,
...
public class IonoObservationDensityProfileIRI_IngestT
{
  ...
  public IonoObservationDensityProfileIRI_IngestT() {
  ...
  public static IonoObservationDensityProfileIRI_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationDensityProfileIRI_Ingest.GetRootAsIonoObservationDensityProfileIRI_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationDensityProfileIRI_Ingest.FinishIonoObservationDensityProfileIRI_IngestBuffer(fbb, IonoObservationDensityProfileIRI_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationDensityProfileIRI_IngestVerify
{
