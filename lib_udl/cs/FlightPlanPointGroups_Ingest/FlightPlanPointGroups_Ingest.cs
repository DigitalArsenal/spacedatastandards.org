...
public struct FlightPlanPointGroups_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static FlightPlanPointGroups_Ingest GetRootAsFlightPlanPointGroups_Ingest(ByteBuffer _bb, FlightPlanPointGroups_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool FlightPlanPointGroups_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "FLIG"); }
  public static bool VerifyFlightPlanPointGroups_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("FLIG", false, FlightPlanPointGroups_IngestVerify.Verify); }
  ...
  public static Offset<FlightPlanPointGroups_Ingest> CreateFlightPlanPointGroups_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<FlightPlanPointGroups_Ingest> EndFlightPlanPointGroups_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlightPlanPointGroups_Ingest>(o);
  }
  public static void FinishFlightPlanPointGroups_IngestBuffer(FlatBufferBuilder builder, Offset<FlightPlanPointGroups_Ingest> offset) { builder.Finish(offset.Value, "FLIG"); }
  public static void FinishSizePrefixedFlightPlanPointGroups_IngestBuffer(FlatBufferBuilder builder, Offset<FlightPlanPointGroups_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "FLIG"); }
  public FlightPlanPointGroups_IngestT UnPack() {
    var _o = new FlightPlanPointGroups_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(FlightPlanPointGroups_IngestT _o) {
  ...
  public static Offset<FlightPlanPointGroups_Ingest> Pack(FlatBufferBuilder builder, FlightPlanPointGroups_IngestT _o) {
    if (_o == null) return default(Offset<FlightPlanPointGroups_Ingest>);
...
public class FlightPlanPointGroups_IngestT
{
  ...
  public FlightPlanPointGroups_IngestT() {
  ...
  public static FlightPlanPointGroups_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return FlightPlanPointGroups_Ingest.GetRootAsFlightPlanPointGroups_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    FlightPlanPointGroups_Ingest.FinishFlightPlanPointGroups_IngestBuffer(fbb, FlightPlanPointGroups_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class FlightPlanPointGroups_IngestVerify
{
