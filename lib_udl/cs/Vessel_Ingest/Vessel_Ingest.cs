...
public struct Vessel_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static Vessel_Ingest GetRootAsVessel_Ingest(ByteBuffer _bb, Vessel_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Vessel_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "VESS"); }
  public static bool VerifyVessel_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("VESS", false, Vessel_IngestVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 64
  public Vessel_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(70); return o != 0 ? (Vessel_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Vessel_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<Vessel_Ingest> CreateVessel_Ingest(FlatBufferBuilder builder,
      ...
      Vessel_Ingest_dataMode_Enum dataMode = Vessel_Ingest_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Vessel_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(33, (sbyte)dataMode, 0); }
  ...
  public static Offset<Vessel_Ingest> EndVessel_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Vessel_Ingest>(o);
  }
  public static void FinishVessel_IngestBuffer(FlatBufferBuilder builder, Offset<Vessel_Ingest> offset) { builder.Finish(offset.Value, "VESS"); }
  public static void FinishSizePrefixedVessel_IngestBuffer(FlatBufferBuilder builder, Offset<Vessel_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "VESS"); }
  public Vessel_IngestT UnPack() {
    var _o = new Vessel_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Vessel_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Vessel_Ingest> Pack(FlatBufferBuilder builder, Vessel_IngestT _o) {
    if (_o == null) return default(Offset<Vessel_Ingest>);
...
public class Vessel_IngestT
{
  ...
  public Vessel_Ingest_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public Vessel_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Vessel_Ingest_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static Vessel_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Vessel_Ingest.GetRootAsVessel_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Vessel_Ingest.FinishVessel_IngestBuffer(fbb, Vessel_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Vessel_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 70 /*DataMode*/, 1 /*Vessel_Ingest_dataMode_Enum*/, 1, false)
