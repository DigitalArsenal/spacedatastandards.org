...
public struct DataLink_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static DataLink_Ingest GetRootAsDataLink_Ingest(ByteBuffer _bb) { return GetRootAsDataLink_Ingest(_bb, new DataLink_Ingest()); }
  public static DataLink_Ingest GetRootAsDataLink_Ingest(ByteBuffer _bb, DataLink_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DataLink_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DATA"); }
  public static bool VerifyDataLink_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DATA", false, DataLink_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public DataLink_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public DataLink_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(150); return o != 0 ? (DataLink_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : DataLink_Ingest_dataMode_Enum.REAL; } }

  public static Offset<DataLink_Ingest> CreateDataLink_Ingest(FlatBufferBuilder builder,
      ...
      DataLink_Ingest_dataMode_Enum dataMode = DataLink_Ingest_dataMode_Enum.REAL) {
  ...
  public static void StartDataLink_Ingest(FlatBufferBuilder builder) { builder.StartTable(74); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, DataLink_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(73, (sbyte)dataMode, 0); }
  public static Offset<DataLink_Ingest> EndDataLink_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DataLink_Ingest>(o);
  }
  public static void FinishDataLink_IngestBuffer(FlatBufferBuilder builder, Offset<DataLink_Ingest> offset) { builder.Finish(offset.Value, "DATA"); }
  public static void FinishSizePrefixedDataLink_IngestBuffer(FlatBufferBuilder builder, Offset<DataLink_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "DATA"); }
  public DataLink_IngestT UnPack() {
    var _o = new DataLink_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DataLink_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<DataLink_Ingest> Pack(FlatBufferBuilder builder, DataLink_IngestT _o) {
    if (_o == null) return default(Offset<DataLink_Ingest>);
...
public class DataLink_IngestT
{
  ...
  public DataLink_Ingest_dataMode_Enum DataMode { get; set; }

  public DataLink_IngestT() {
    this.Id = null;
    ...
    this.DataMode = DataLink_Ingest_dataMode_Enum.REAL;
  }
  public static DataLink_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return DataLink_Ingest.GetRootAsDataLink_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DataLink_Ingest.FinishDataLink_IngestBuffer(fbb, DataLink_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DataLink_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 150 /*DataMode*/, 1 /*DataLink_Ingest_dataMode_Enum*/, 1, false)
