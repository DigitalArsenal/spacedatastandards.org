...
public struct Stage_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static Stage_Ingest GetRootAsStage_Ingest(ByteBuffer _bb, Stage_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Stage_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "STAG"); }
  public static bool VerifyStage_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("STAG", false, Stage_IngestVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Stage_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(82); return o != 0 ? (Stage_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Stage_Ingest_dataMode_Enum.REAL; } }

  public static Offset<Stage_Ingest> CreateStage_Ingest(FlatBufferBuilder builder,
      ...
      Stage_Ingest_dataMode_Enum dataMode = Stage_Ingest_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Stage_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(39, (sbyte)dataMode, 0); }
  public static Offset<Stage_Ingest> EndStage_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Stage_Ingest>(o);
  }
  public static void FinishStage_IngestBuffer(FlatBufferBuilder builder, Offset<Stage_Ingest> offset) { builder.Finish(offset.Value, "STAG"); }
  public static void FinishSizePrefixedStage_IngestBuffer(FlatBufferBuilder builder, Offset<Stage_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "STAG"); }
  public Stage_IngestT UnPack() {
    var _o = new Stage_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Stage_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Stage_Ingest> Pack(FlatBufferBuilder builder, Stage_IngestT _o) {
    if (_o == null) return default(Offset<Stage_Ingest>);
...
public class Stage_IngestT
{
  ...
  public Stage_Ingest_dataMode_Enum DataMode { get; set; }

  public Stage_IngestT() {
    this.Id = null;
    ...
    this.DataMode = Stage_Ingest_dataMode_Enum.REAL;
  }
  public static Stage_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Stage_Ingest.GetRootAsStage_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Stage_Ingest.FinishStage_IngestBuffer(fbb, Stage_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Stage_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 82 /*DataMode*/, 1 /*Stage_Ingest_dataMode_Enum*/, 1, false)
