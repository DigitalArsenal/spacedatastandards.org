...
public struct Elset_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Elset_Abridged GetRootAsElset_Abridged(ByteBuffer _bb) { return GetRootAsElset_Abridged(_bb, new Elset_Abridged()); }
  public static Elset_Abridged GetRootAsElset_Abridged(ByteBuffer _bb, Elset_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Elset_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ELSE"); }
  public static bool VerifyElset_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ELSE", false, Elset_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Elset_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public string Line1 { get { int o = __p.__offset(52); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetLine1Bytes() { return __p.__vector_as_span<byte>(52, 1); }
#else
  public ArraySegment<byte>? GetLine1Bytes() { return __p.__vector_as_arraysegment(52); }
#endif
  public byte[] GetLine1Array() { return __p.__vector_as_array<byte>(52); }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 69
  public string Line2 { get { int o = __p.__offset(54); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetLine2Bytes() { return __p.__vector_as_span<byte>(54, 1); }
#else
  public ArraySegment<byte>? GetLine2Bytes() { return __p.__vector_as_arraysegment(54); }
#endif
  public byte[] GetLine2Array() { return __p.__vector_as_array<byte>(54); }
  /// Optional source-provided and searchable metadata or descriptor of the data.
  /// Example: /// Example: Example description
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Descriptor { get { int o = __p.__offset(56); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetDescriptorBytes() { return __p.__vector_as_span<byte>(56, 1); }
#else
  public ArraySegment<byte>? GetDescriptorBytes() { return __p.__vector_as_arraysegment(56); }
#endif
  public byte[] GetDescriptorArray() { return __p.__vector_as_array<byte>(56); }
  ...
  public Elset_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(68); return o != 0 ? (Elset_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Elset_Abridged_dataMode_Enum.REAL; } }
  /// Optional algorithm used to produce this record.
  /// Example: /// Example: Example algorithm
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Algorithm { get { int o = __p.__offset(70); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAlgorithmBytes() { return __p.__vector_as_span<byte>(70, 1); }
#else
  public ArraySegment<byte>? GetAlgorithmBytes() { return __p.__vector_as_arraysegment(70); }
#endif
  public byte[] GetAlgorithmArray() { return __p.__vector_as_array<byte>(70); }
  /// Optional identifier to track a commercial or marketplace transaction executed to produce this data.
  /// Example: /// Example: TRANSACTION-ID
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string TransactionId { get { int o = __p.__offset(72); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTransactionIdBytes() { return __p.__vector_as_span<byte>(72, 1); }
#else
  public ArraySegment<byte>? GetTransactionIdBytes() { return __p.__vector_as_arraysegment(72); }
#endif
  public byte[] GetTransactionIdArray() { return __p.__vector_as_array<byte>(72); }
  ...
  /// Example: /// Example: 1
  /// Constraints: No constraints specified.
  public int EphemType { get { int o = __p.__offset(74); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  public static Offset<Elset_Abridged> CreateElset_Abridged(FlatBufferBuilder builder,
      ...
      Elset_Abridged_dataMode_Enum dataMode = Elset_Abridged_dataMode_Enum.REAL,
    ...
    Elset_Abridged.AddPerigee(builder, perigee);
    Elset_Abridged.AddApogee(builder, apogee);
    Elset_Abridged.AddPeriod(builder, period);
    Elset_Abridged.AddSemiMajorAxis(builder, semiMajorAxis);
    Elset_Abridged.AddMeanMotionDDot(builder, meanMotionDDot);
    Elset_Abridged.AddMeanMotionDot(builder, meanMotionDot);
    Elset_Abridged.AddBallisticCoeff(builder, ballisticCoeff);
    Elset_Abridged.AddAgom(builder, agom);
    Elset_Abridged.AddBStar(builder, bStar);
    Elset_Abridged.AddMeanAnomaly(builder, meanAnomaly);
    Elset_Abridged.AddArgOfPerigee(builder, argOfPerigee);
    Elset_Abridged.AddRaan(builder, raan);
    Elset_Abridged.AddInclination(builder, inclination);
    Elset_Abridged.AddEccentricity(builder, eccentricity);
    Elset_Abridged.AddMeanMotion(builder, meanMotion);
    Elset_Abridged.AddOrigNetwork(builder, origNetworkOffset);
    Elset_Abridged.AddEphemType(builder, ephemType);
    Elset_Abridged.AddTransactionId(builder, transactionIdOffset);
    Elset_Abridged.AddAlgorithm(builder, algorithmOffset);
    Elset_Abridged.AddSource(builder, sourceOffset);
    Elset_Abridged.AddSourceDL(builder, sourceDLOffset);
    Elset_Abridged.AddOrigin(builder, originOffset);
    Elset_Abridged.AddCreatedBy(builder, createdByOffset);
    Elset_Abridged.AddCreatedAt(builder, createdAtOffset);
    Elset_Abridged.AddDescriptor(builder, descriptorOffset);
    Elset_Abridged.AddLine2(builder, line2Offset);
    Elset_Abridged.AddLine1(builder, line1Offset);
    Elset_Abridged.AddIdOrbitDetermination(builder, idOrbitDeterminationOffset);
    Elset_Abridged.AddOrigObjectId(builder, origObjectIdOffset);
    Elset_Abridged.AddRevNo(builder, revNo);
    Elset_Abridged.AddIdOnOrbit(builder, idOnOrbitOffset);
    Elset_Abridged.AddEpoch(builder, epochOffset);
    Elset_Abridged.AddSatNo(builder, satNo);
    Elset_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    Elset_Abridged.AddIdElset(builder, idElsetOffset);
    Elset_Abridged.AddDataMode(builder, dataMode);
    Elset_Abridged.AddUct(builder, uct);
    return Elset_Abridged.EndElset_Abridged(builder);
  }

  public static void StartElset_Abridged(FlatBufferBuilder builder) { builder.StartTable(37); }
  ...
  public static void AddLine1(FlatBufferBuilder builder, StringOffset line1Offset) { builder.AddOffset(24, line1Offset.Value, 0); }
  public static void AddLine2(FlatBufferBuilder builder, StringOffset line2Offset) { builder.AddOffset(25, line2Offset.Value, 0); }
  public static void AddDescriptor(FlatBufferBuilder builder, StringOffset descriptorOffset) { builder.AddOffset(26, descriptorOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Elset_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(32, (sbyte)dataMode, 0); }
  public static void AddAlgorithm(FlatBufferBuilder builder, StringOffset algorithmOffset) { builder.AddOffset(33, algorithmOffset.Value, 0); }
  public static void AddTransactionId(FlatBufferBuilder builder, StringOffset transactionIdOffset) { builder.AddOffset(34, transactionIdOffset.Value, 0); }
  public static void AddEphemType(FlatBufferBuilder builder, int ephemType) { builder.AddInt(35, ephemType, 0); }
  ...
  public static Offset<Elset_Abridged> EndElset_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Elset_Abridged>(o);
  }
  public static void FinishElset_AbridgedBuffer(FlatBufferBuilder builder, Offset<Elset_Abridged> offset) { builder.Finish(offset.Value, "ELSE"); }
  public static void FinishSizePrefixedElset_AbridgedBuffer(FlatBufferBuilder builder, Offset<Elset_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "ELSE"); }
  public Elset_AbridgedT UnPack() {
    var _o = new Elset_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Elset_AbridgedT _o) {
  ...
  public static Offset<Elset_Abridged> Pack(FlatBufferBuilder builder, Elset_AbridgedT _o) {
    if (_o == null) return default(Offset<Elset_Abridged>);
...
public class Elset_AbridgedT
{
  ...
  public Elset_Abridged_dataMode_Enum DataMode { get; set; }
  public string Algorithm { get; set; }
  public string TransactionId { get; set; }
  public int EphemType { get; set; }
  public string OrigNetwork { get; set; }

  public Elset_AbridgedT() {
    this.IdElset = null;
    ...
    this.SourceDL = null;
    this.Source = null;
    this.DataMode = Elset_Abridged_dataMode_Enum.REAL;
    this.Algorithm = null;
    this.TransactionId = null;
    this.EphemType = 0;
    this.OrigNetwork = null;
  }
  public static Elset_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Elset_Abridged.GetRootAsElset_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Elset_Abridged.FinishElset_AbridgedBuffer(fbb, Elset_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Elset_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyString(tablePos, 52 /*Line1*/, false)
      && verifier.VerifyString(tablePos, 54 /*Line2*/, false)
      && verifier.VerifyString(tablePos, 56 /*Descriptor*/, false)
      ...
      && verifier.VerifyField(tablePos, 68 /*DataMode*/, 1 /*Elset_Abridged_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 70 /*Algorithm*/, false)
      && verifier.VerifyString(tablePos, 72 /*TransactionId*/, false)
      && verifier.VerifyField(tablePos, 74 /*EphemType*/, 4 /*int*/, 4, false)
