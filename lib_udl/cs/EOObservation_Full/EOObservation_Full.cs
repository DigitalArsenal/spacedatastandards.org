...
public struct EOObservation_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static EOObservation_Full GetRootAsEOObservation_Full(ByteBuffer _bb, EOObservation_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EOObservation_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EOOB"); }
  public static bool VerifyEOObservation_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EOOB", false, EOObservation_FullVerify.Verify); }
  ...
  public EOObservation_Full_dataMode_Enum DataMode { get { int o = __p.__offset(164); return o != 0 ? (EOObservation_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EOObservation_Full_dataMode_Enum.REAL; } }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string OnOrbit { get { int o = __p.__offset(176); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbitBytes() { return __p.__vector_as_span<byte>(176, 1); }
#else
  public ArraySegment<byte>? GetOnOrbitBytes() { return __p.__vector_as_arraysegment(176); }
#endif
  public byte[] GetOnOrbitArray() { return __p.__vector_as_array<byte>(176); }
  /// The reference frame of the EOObservation measurements. If the referenceFrame is null it is assumed to be J2000.
  /// Example: /// Example: J2000
  /// Constraints: Minimum length = 0, Maximum length = 24
  public EOObservation_Full_referenceFrame_Enum ReferenceFrame { get { int o = __p.__offset(178); return o != 0 ? (EOObservation_Full_referenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EOObservation_Full_referenceFrame_Enum.J2000; } }
  /// The reference frame of the observing sensor state. If the senReferenceFrame is null it is assumed to be J2000.
  /// Example: /// Example: J2000
  /// Constraints: Minimum length = 0, Maximum length = 24
  public EOObservation_Full_senReferenceFrame_Enum SenReferenceFrame { get { int o = __p.__offset(180); return o != 0 ? (EOObservation_Full_senReferenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EOObservation_Full_senReferenceFrame_Enum.J2000; } }
  /// Boolean indicating that the target object was in umbral eclipse at the time of this observation.
  /// Example: /// Example: False
  /// Constraints: No constraints specified.
  public bool Umbra { get { int o = __p.__offset(182); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  /// Boolean indicating that the target object was in a penumbral eclipse at the time of this observation.
  /// Example: /// Example: False
  /// Constraints: No constraints specified.
  public bool Penumbra { get { int o = __p.__offset(184); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  ...
  /// Example: /// Example: AXE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string SourceDL { get { int o = __p.__offset(188); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceDLBytes() { return __p.__vector_as_span<byte>(188, 1); }
#else
  public ArraySegment<byte>? GetSourceDLBytes() { return __p.__vector_as_arraysegment(188); }
#endif
  public byte[] GetSourceDLArray() { return __p.__vector_as_array<byte>(188); }
  /// Read only enumeration specifying the type of observation (e.g. OPTICAL, RADAR, RF, etc).
  /// Example: /// Example: OPTICAL
  /// Constraints: No constraints specified.
  public string Type { get { int o = __p.__offset(190); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTypeBytes() { return __p.__vector_as_span<byte>(190, 1); }
#else
  public ArraySegment<byte>? GetTypeBytes() { return __p.__vector_as_arraysegment(190); }
#endif
  public byte[] GetTypeArray() { return __p.__vector_as_array<byte>(190); }

  public static Offset<EOObservation_Full> CreateEOObservation_Full(FlatBufferBuilder builder,
      ...
      EOObservation_Full_dataMode_Enum dataMode = EOObservation_Full_dataMode_Enum.REAL,
      ...
      EOObservation_Full_referenceFrame_Enum referenceFrame = EOObservation_Full_referenceFrame_Enum.J2000,
      EOObservation_Full_senReferenceFrame_Enum senReferenceFrame = EOObservation_Full_senReferenceFrame_Enum.J2000,
      bool umbra = false,
      bool penumbra = false,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, EOObservation_Full_dataMode_Enum dataMode) { builder.AddSbyte(80, (sbyte)dataMode, 0); }
  ...
  public static void AddOnOrbit(FlatBufferBuilder builder, StringOffset onOrbitOffset) { builder.AddOffset(86, onOrbitOffset.Value, 0); }
  public static void AddReferenceFrame(FlatBufferBuilder builder, EOObservation_Full_referenceFrame_Enum referenceFrame) { builder.AddSbyte(87, (sbyte)referenceFrame, 0); }
  public static void AddSenReferenceFrame(FlatBufferBuilder builder, EOObservation_Full_senReferenceFrame_Enum senReferenceFrame) { builder.AddSbyte(88, (sbyte)senReferenceFrame, 0); }
  public static void AddUmbra(FlatBufferBuilder builder, bool umbra) { builder.AddBool(89, umbra, false); }
  public static void AddPenumbra(FlatBufferBuilder builder, bool penumbra) { builder.AddBool(90, penumbra, false); }
  ...
  public static void AddSourceDL(FlatBufferBuilder builder, StringOffset sourceDLOffset) { builder.AddOffset(92, sourceDLOffset.Value, 0); }
  public static void AddType(FlatBufferBuilder builder, StringOffset typeOffset) { builder.AddOffset(93, typeOffset.Value, 0); }
  public static Offset<EOObservation_Full> EndEOObservation_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EOObservation_Full>(o);
  }
  public static void FinishEOObservation_FullBuffer(FlatBufferBuilder builder, Offset<EOObservation_Full> offset) { builder.Finish(offset.Value, "EOOB"); }
  public static void FinishSizePrefixedEOObservation_FullBuffer(FlatBufferBuilder builder, Offset<EOObservation_Full> offset) { builder.FinishSizePrefixed(offset.Value, "EOOB"); }
  public EOObservation_FullT UnPack() {
    var _o = new EOObservation_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EOObservation_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<EOObservation_Full> Pack(FlatBufferBuilder builder, EOObservation_FullT _o) {
    if (_o == null) return default(Offset<EOObservation_Full>);
...
public class EOObservation_FullT
{
  ...
  public EOObservation_Full_dataMode_Enum DataMode { get; set; }
  ...
  public EOObservation_Full_referenceFrame_Enum ReferenceFrame { get; set; }
  public EOObservation_Full_senReferenceFrame_Enum SenReferenceFrame { get; set; }
  ...
  public EOObservation_FullT() {
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = EOObservation_Full_dataMode_Enum.REAL;
    this.Tags = null;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.ZeroPtdUnc = 0.0;
    ...
    this.OnOrbit = null;
    this.ReferenceFrame = EOObservation_Full_referenceFrame_Enum.J2000;
    this.SenReferenceFrame = EOObservation_Full_senReferenceFrame_Enum.J2000;
    this.Umbra = false;
    this.Penumbra = false;
  ...
  public static EOObservation_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return EOObservation_Full.GetRootAsEOObservation_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EOObservation_Full.FinishEOObservation_FullBuffer(fbb, EOObservation_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EOObservation_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 164 /*DataMode*/, 1 /*EOObservation_Full_dataMode_Enum*/, 1, false)
      ...
      && verifier.VerifyString(tablePos, 176 /*OnOrbit*/, false)
      && verifier.VerifyField(tablePos, 178 /*ReferenceFrame*/, 1 /*EOObservation_Full_referenceFrame_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 180 /*SenReferenceFrame*/, 1 /*EOObservation_Full_senReferenceFrame_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 182 /*Umbra*/, 1 /*bool*/, 1, false)
      && verifier.VerifyField(tablePos, 184 /*Penumbra*/, 1 /*bool*/, 1, false)
      && verifier.VerifyString(tablePos, 186 /*OrigNetwork*/, false)
      && verifier.VerifyString(tablePos, 188 /*SourceDL*/, false)
      && verifier.VerifyString(tablePos, 190 /*Type*/, false)
