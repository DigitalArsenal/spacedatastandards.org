...
public struct RFObservation_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static RFObservation_Abridged GetRootAsRFObservation_Abridged(ByteBuffer _bb, RFObservation_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool RFObservation_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "RFOB"); }
  public static bool VerifyRFObservation_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("RFOB", false, RFObservation_AbridgedVerify.Verify); }
  ...
  public RFObservation_Abridged_polarityType_Enum PolarityType { get { int o = __p.__offset(94); return o != 0 ? (RFObservation_Abridged_polarityType_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFObservation_Abridged_polarityType_Enum.H; } }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public RFObservation_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(134); return o != 0 ? (RFObservation_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFObservation_Abridged_dataMode_Enum.REAL; } }
  ...
  /// Example: /// Example: 10.1
  /// Constraints: No constraints specified.
  public double NoisePwrDensity { get { int o = __p.__offset(140); return o != 0 ? __p.bb.GetDouble(o + __p.bb_pos) : (double)0.0; } }
  /// Carrier standard (e.g. DVB-S2, 802.11g, etc.).
  /// Example: /// Example: DVB-S2
  /// Constraints: Minimum length = 0, Maximum length = 10
  public string CarrierStandard { get { int o = __p.__offset(142); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCarrierStandardBytes() { return __p.__vector_as_span<byte>(142, 1); }
#else
  public ArraySegment<byte>? GetCarrierStandardBytes() { return __p.__vector_as_arraysegment(142); }
#endif
  public byte[] GetCarrierStandardArray() { return __p.__vector_as_array<byte>(142); }
  /// Transponder modulation (e.g. Auto, QPSK, 8PSK, etc).
  /// Example: /// Example: Auto
  /// Constraints: Minimum length = 0, Maximum length = 10
  public string Modulation { get { int o = __p.__offset(144); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetModulationBytes() { return __p.__vector_as_span<byte>(144, 1); }
#else
  public ArraySegment<byte>? GetModulationBytes() { return __p.__vector_as_arraysegment(144); }
#endif
  public byte[] GetModulationArray() { return __p.__vector_as_array<byte>(144); }
  /// Inner forward error correction rate:  0 = Auto, 1 = 1/2, 2 = 2/3, 3 = 3/4, 4 = 5/6, 5 = 7/8, 6 = 8/9, 7 = 3/5, 8 = 4/5, 9 = 9/10, 15 = None.
  /// Example: /// Example: 7
  /// Constraints: No constraints specified.
  public int InnerCodingRate { get { int o = __p.__offset(146); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  /// Outer forward error correction rate:  0 = Auto, 1 = 1/2, 2 = 2/3, 3 = 3/4, 4 = 5/6, 5 = 7/8, 6 = 8/9, 7 = 3/5, 8 = 4/5, 9 = 9/10, 15 = None.
  /// Example: /// Example: 4
  /// Constraints: No constraints specified.
  public int OuterCodingRate { get { int o = __p.__offset(148); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  /// Transmit pulse shaping filter typ (e.g. RRC).
  /// Example: /// Example: RRC
  /// Constraints: Minimum length = 0, Maximum length = 10
  public string TransmitFilterType { get { int o = __p.__offset(150); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTransmitFilterTypeBytes() { return __p.__vector_as_span<byte>(150, 1); }
#else
  public ArraySegment<byte>? GetTransmitFilterTypeBytes() { return __p.__vector_as_arraysegment(150); }
#endif
  public byte[] GetTransmitFilterTypeArray() { return __p.__vector_as_array<byte>(150); }
  /// Transmit pulse shaping filter roll-off value.
  /// Example: /// Example: 10.1
  /// Constraints: No constraints specified.
  public double TransmitFilterRollOff { get { int o = __p.__offset(152); return o != 0 ? __p.bb.GetDouble(o + __p.bb_pos) : (double)0.0; } }
  /// Symbol to noise ratio, in dB.
  /// Example: /// Example: 10.1
  /// Constraints: No constraints specified.
  public double SymbolToNoiseRatio { get { int o = __p.__offset(154); return o != 0 ? __p.bb.GetDouble(o + __p.bb_pos) : (double)0.0; } }
  /// The ratio of bit errors per number of received bits.
  /// Example: /// Example: 10.1
  /// Constraints: No constraints specified.
  public double BitErrorRate { get { int o = __p.__offset(156); return o != 0 ? __p.bb.GetDouble(o + __p.bb_pos) : (double)0.0; } }
  ...
  /// Example: /// Example: AXE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string SourceDL { get { int o = __p.__offset(160); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceDLBytes() { return __p.__vector_as_span<byte>(160, 1); }
#else
  public ArraySegment<byte>? GetSourceDLBytes() { return __p.__vector_as_arraysegment(160); }
#endif
  public byte[] GetSourceDLArray() { return __p.__vector_as_array<byte>(160); }
  /// Optional source-provided and searchable metadata or descriptor of the data.
  /// Example: /// Example: descriptor
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Descriptor { get { int o = __p.__offset(162); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetDescriptorBytes() { return __p.__vector_as_span<byte>(162, 1); }
#else
  public ArraySegment<byte>? GetDescriptorBytes() { return __p.__vector_as_arraysegment(162); }
#endif
  public byte[] GetDescriptorArray() { return __p.__vector_as_array<byte>(162); }
  ...
  public string Url { get { int o = __p.__offset(164); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUrlBytes() { return __p.__vector_as_span<byte>(164, 1); }
#else
  public ArraySegment<byte>? GetUrlBytes() { return __p.__vector_as_arraysegment(164); }
#endif
  public byte[] GetUrlArray() { return __p.__vector_as_array<byte>(164); }

  public static Offset<RFObservation_Abridged> CreateRFObservation_Abridged(FlatBufferBuilder builder,
      ...
      double polarity = 0.0,
      RFObservation_Abridged_polarityType_Enum polarityType = RFObservation_Abridged_polarityType_Enum.H,
      int channel = 0,
      ...
      RFObservation_Abridged_dataMode_Enum dataMode = RFObservation_Abridged_dataMode_Enum.REAL,
  ...
  public static void AddPolarityType(FlatBufferBuilder builder, RFObservation_Abridged_polarityType_Enum polarityType) { builder.AddSbyte(45, (sbyte)polarityType, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, RFObservation_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(65, (sbyte)dataMode, 0); }
  ...
  public static void AddCarrierStandard(FlatBufferBuilder builder, StringOffset carrierStandardOffset) { builder.AddOffset(69, carrierStandardOffset.Value, 0); }
  public static void AddModulation(FlatBufferBuilder builder, StringOffset modulationOffset) { builder.AddOffset(70, modulationOffset.Value, 0); }
  ...
  public static void AddTransmitFilterType(FlatBufferBuilder builder, StringOffset transmitFilterTypeOffset) { builder.AddOffset(73, transmitFilterTypeOffset.Value, 0); }
  ...
  public static void AddSourceDL(FlatBufferBuilder builder, StringOffset sourceDLOffset) { builder.AddOffset(78, sourceDLOffset.Value, 0); }
  public static void AddDescriptor(FlatBufferBuilder builder, StringOffset descriptorOffset) { builder.AddOffset(79, descriptorOffset.Value, 0); }
  public static void AddUrl(FlatBufferBuilder builder, StringOffset urlOffset) { builder.AddOffset(80, urlOffset.Value, 0); }
  public static Offset<RFObservation_Abridged> EndRFObservation_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RFObservation_Abridged>(o);
  }
  public static void FinishRFObservation_AbridgedBuffer(FlatBufferBuilder builder, Offset<RFObservation_Abridged> offset) { builder.Finish(offset.Value, "RFOB"); }
  public static void FinishSizePrefixedRFObservation_AbridgedBuffer(FlatBufferBuilder builder, Offset<RFObservation_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "RFOB"); }
  public RFObservation_AbridgedT UnPack() {
    var _o = new RFObservation_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RFObservation_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<RFObservation_Abridged> Pack(FlatBufferBuilder builder, RFObservation_AbridgedT _o) {
    if (_o == null) return default(Offset<RFObservation_Abridged>);
...
public class RFObservation_AbridgedT
{
  ...
  public RFObservation_Abridged_polarityType_Enum PolarityType { get; set; }
  ...
  public RFObservation_Abridged_dataMode_Enum DataMode { get; set; }
  ...
  public RFObservation_AbridgedT() {
    this.Id = null;
    ...
    this.NominalSnr = 0.0;
    this.Polarity = 0.0;
    this.PolarityType = RFObservation_Abridged_polarityType_Enum.H;
    this.Channel = 0;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = RFObservation_Abridged_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
  ...
  public static RFObservation_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return RFObservation_Abridged.GetRootAsRFObservation_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    RFObservation_Abridged.FinishRFObservation_AbridgedBuffer(fbb, RFObservation_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class RFObservation_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 94 /*PolarityType*/, 1 /*RFObservation_Abridged_polarityType_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 134 /*DataMode*/, 1 /*RFObservation_Abridged_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 136 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 138 /*CreatedBy*/, false)
      && verifier.VerifyField(tablePos, 140 /*NoisePwrDensity*/, 8 /*double*/, 8, false)
      && verifier.VerifyString(tablePos, 142 /*CarrierStandard*/, false)
      && verifier.VerifyString(tablePos, 144 /*Modulation*/, false)
      && verifier.VerifyField(tablePos, 146 /*InnerCodingRate*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 148 /*OuterCodingRate*/, 4 /*int*/, 4, false)
      && verifier.VerifyString(tablePos, 150 /*TransmitFilterType*/, false)
      && verifier.VerifyField(tablePos, 152 /*TransmitFilterRollOff*/, 8 /*double*/, 8, false)
      && verifier.VerifyField(tablePos, 154 /*SymbolToNoiseRatio*/, 8 /*double*/, 8, false)
      && verifier.VerifyField(tablePos, 156 /*BitErrorRate*/, 8 /*double*/, 8, false)
      && verifier.VerifyString(tablePos, 158 /*OrigNetwork*/, false)
      && verifier.VerifyString(tablePos, 160 /*SourceDL*/, false)
      && verifier.VerifyString(tablePos, 162 /*Descriptor*/, false)
      && verifier.VerifyString(tablePos, 164 /*Url*/, false)
