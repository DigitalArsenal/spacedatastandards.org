...
public struct GNSSRawIF_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static GNSSRawIF_Abridged GetRootAsGNSSRawIF_Abridged(ByteBuffer _bb) { return GetRootAsGNSSRawIF_Abridged(_bb, new GNSSRawIF_Abridged()); }
  public static GNSSRawIF_Abridged GetRootAsGNSSRawIF_Abridged(ByteBuffer _bb, GNSSRawIF_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool GNSSRawIF_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "GNSS"); }
  public static bool VerifyGNSSRawIF_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("GNSS", false, GNSSRawIF_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public GNSSRawIF_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public GNSSRawIF_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(80); return o != 0 ? (GNSSRawIF_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : GNSSRawIF_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<GNSSRawIF_Abridged> CreateGNSSRawIF_Abridged(FlatBufferBuilder builder,
      ...
      GNSSRawIF_Abridged_dataMode_Enum dataMode = GNSSRawIF_Abridged_dataMode_Enum.REAL,
  ...
  public static void StartGNSSRawIF_Abridged(FlatBufferBuilder builder) { builder.StartTable(40); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, GNSSRawIF_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(38, (sbyte)dataMode, 0); }
  ...
  public static Offset<GNSSRawIF_Abridged> EndGNSSRawIF_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<GNSSRawIF_Abridged>(o);
  }
  public static void FinishGNSSRawIF_AbridgedBuffer(FlatBufferBuilder builder, Offset<GNSSRawIF_Abridged> offset) { builder.Finish(offset.Value, "GNSS"); }
  public static void FinishSizePrefixedGNSSRawIF_AbridgedBuffer(FlatBufferBuilder builder, Offset<GNSSRawIF_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "GNSS"); }
  public GNSSRawIF_AbridgedT UnPack() {
    var _o = new GNSSRawIF_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(GNSSRawIF_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<GNSSRawIF_Abridged> Pack(FlatBufferBuilder builder, GNSSRawIF_AbridgedT _o) {
    if (_o == null) return default(Offset<GNSSRawIF_Abridged>);
...
public class GNSSRawIF_AbridgedT
{
  ...
  public GNSSRawIF_Abridged_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public GNSSRawIF_AbridgedT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = GNSSRawIF_Abridged_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static GNSSRawIF_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return GNSSRawIF_Abridged.GetRootAsGNSSRawIF_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    GNSSRawIF_Abridged.FinishGNSSRawIF_AbridgedBuffer(fbb, GNSSRawIF_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class GNSSRawIF_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 80 /*DataMode*/, 1 /*GNSSRawIF_Abridged_dataMode_Enum*/, 1, false)
