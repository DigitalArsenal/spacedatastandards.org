...
public struct IonoObservationAntennaElementPosition_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static IonoObservationAntennaElementPosition_Full GetRootAsIonoObservationAntennaElementPosition_Full(ByteBuffer _bb, IonoObservationAntennaElementPosition_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationAntennaElementPosition_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationAntennaElementPosition_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationAntennaElementPosition_FullVerify.Verify); }
  ...
  public static Offset<IonoObservationAntennaElementPosition_Full> CreateIonoObservationAntennaElementPosition_Full(FlatBufferBuilder builder,
  ...
  public static Offset<IonoObservationAntennaElementPosition_Full> EndIonoObservationAntennaElementPosition_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationAntennaElementPosition_Full>(o);
  }
  public static void FinishIonoObservationAntennaElementPosition_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationAntennaElementPosition_Full> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationAntennaElementPosition_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationAntennaElementPosition_Full> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationAntennaElementPosition_FullT UnPack() {
    var _o = new IonoObservationAntennaElementPosition_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationAntennaElementPosition_FullT _o) {
  ...
  public static Offset<IonoObservationAntennaElementPosition_Full> Pack(FlatBufferBuilder builder, IonoObservationAntennaElementPosition_FullT _o) {
    if (_o == null) return default(Offset<IonoObservationAntennaElementPosition_Full>);
...
public class IonoObservationAntennaElementPosition_FullT
{
  public List<string> Dimensions { get; set; }
  public List<string> DimensionName { get; set; }
  public List<string> Data { get; set; }

  public IonoObservationAntennaElementPosition_FullT() {
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationAntennaElementPosition_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationAntennaElementPosition_Full.GetRootAsIonoObservationAntennaElementPosition_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationAntennaElementPosition_Full.FinishIonoObservationAntennaElementPosition_FullBuffer(fbb, IonoObservationAntennaElementPosition_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationAntennaElementPosition_FullVerify
{
