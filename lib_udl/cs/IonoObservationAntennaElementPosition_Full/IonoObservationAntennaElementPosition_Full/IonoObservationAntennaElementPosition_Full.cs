...
namespace IonoObservationAntennaElementPosition_Full
{
...
public struct IonoObservationAntennaElementPosition_Full : IFlatbufferObject
{
  ...
  public static Offset<IonoObservationAntennaElementPosition_Full.IonoObservationAntennaElementPosition_Full> CreateIonoObservationAntennaElementPosition_Full(FlatBufferBuilder builder,
  ...
  public static Offset<IonoObservationAntennaElementPosition_Full.IonoObservationAntennaElementPosition_Full> EndIonoObservationAntennaElementPosition_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationAntennaElementPosition_Full.IonoObservationAntennaElementPosition_Full>(o);
  }
  ...
  public static Offset<IonoObservationAntennaElementPosition_Full.IonoObservationAntennaElementPosition_Full> Pack(FlatBufferBuilder builder, IonoObservationAntennaElementPosition_FullT _o) {
    if (_o == null) return default(Offset<IonoObservationAntennaElementPosition_Full.IonoObservationAntennaElementPosition_Full>);
