...
public struct SpaceEnvObservation_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SpaceEnvObservation_Abridged GetRootAsSpaceEnvObservation_Abridged(ByteBuffer _bb) { return GetRootAsSpaceEnvObservation_Abridged(_bb, new SpaceEnvObservation_Abridged()); }
  public static SpaceEnvObservation_Abridged GetRootAsSpaceEnvObservation_Abridged(ByteBuffer _bb, SpaceEnvObservation_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SpaceEnvObservation_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SPAC"); }
  public static bool VerifySpaceEnvObservation_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SPAC", false, SpaceEnvObservation_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SpaceEnvObservation_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public SpaceEnvObservation_Abridged_senReferenceFrame_Enum SenReferenceFrame { get { int o = __p.__offset(46); return o != 0 ? (SpaceEnvObservation_Abridged_senReferenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SpaceEnvObservation_Abridged_senReferenceFrame_Enum.J2000; } }
  ...
  public SpaceEnvObservation_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(82); return o != 0 ? (SpaceEnvObservation_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SpaceEnvObservation_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<SpaceEnvObservation_Abridged> CreateSpaceEnvObservation_Abridged(FlatBufferBuilder builder,
      ...
      double lon = 0.0,
      double alt = 0.0,
      SpaceEnvObservation_Abridged_senReferenceFrame_Enum senReferenceFrame = SpaceEnvObservation_Abridged_senReferenceFrame_Enum.J2000,
      ...
      SpaceEnvObservation_Abridged_dataMode_Enum dataMode = SpaceEnvObservation_Abridged_dataMode_Enum.REAL,
  ...
  public static void StartSpaceEnvObservation_Abridged(FlatBufferBuilder builder) { builder.StartTable(41); }
  ...
  public static void AddSenReferenceFrame(FlatBufferBuilder builder, SpaceEnvObservation_Abridged_senReferenceFrame_Enum senReferenceFrame) { builder.AddSbyte(21, (sbyte)senReferenceFrame, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SpaceEnvObservation_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(39, (sbyte)dataMode, 0); }
  ...
  public static Offset<SpaceEnvObservation_Abridged> EndSpaceEnvObservation_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SpaceEnvObservation_Abridged>(o);
  }
  public static void FinishSpaceEnvObservation_AbridgedBuffer(FlatBufferBuilder builder, Offset<SpaceEnvObservation_Abridged> offset) { builder.Finish(offset.Value, "SPAC"); }
  public static void FinishSizePrefixedSpaceEnvObservation_AbridgedBuffer(FlatBufferBuilder builder, Offset<SpaceEnvObservation_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "SPAC"); }
  public SpaceEnvObservation_AbridgedT UnPack() {
    var _o = new SpaceEnvObservation_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SpaceEnvObservation_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SpaceEnvObservation_Abridged> Pack(FlatBufferBuilder builder, SpaceEnvObservation_AbridgedT _o) {
    if (_o == null) return default(Offset<SpaceEnvObservation_Abridged>);
...
public class SpaceEnvObservation_AbridgedT
{
  ...
  public SpaceEnvObservation_Abridged_senReferenceFrame_Enum SenReferenceFrame { get; set; }
  ...
  public SpaceEnvObservation_Abridged_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public SpaceEnvObservation_AbridgedT() {
    this.Id = null;
    ...
    this.Lon = 0.0;
    this.Alt = 0.0;
    this.SenReferenceFrame = SpaceEnvObservation_Abridged_senReferenceFrame_Enum.J2000;
    this.SenPos = null;
    this.SenVel = null;
    this.MeasType = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = SpaceEnvObservation_Abridged_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static SpaceEnvObservation_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return SpaceEnvObservation_Abridged.GetRootAsSpaceEnvObservation_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SpaceEnvObservation_Abridged.FinishSpaceEnvObservation_AbridgedBuffer(fbb, SpaceEnvObservation_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SpaceEnvObservation_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 46 /*SenReferenceFrame*/, 1 /*SpaceEnvObservation_Abridged_senReferenceFrame_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 82 /*DataMode*/, 1 /*SpaceEnvObservation_Abridged_dataMode_Enum*/, 1, false)
