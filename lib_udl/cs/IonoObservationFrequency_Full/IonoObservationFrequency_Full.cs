...
public struct IonoObservationFrequency_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationFrequency_Full GetRootAsIonoObservationFrequency_Full(ByteBuffer _bb) { return GetRootAsIonoObservationFrequency_Full(_bb, new IonoObservationFrequency_Full()); }
  public static IonoObservationFrequency_Full GetRootAsIonoObservationFrequency_Full(ByteBuffer _bb, IonoObservationFrequency_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationFrequency_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationFrequency_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationFrequency_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationFrequency_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationFrequency_Full> CreateIonoObservationFrequency_Full(FlatBufferBuilder builder,
    ...
    IonoObservationFrequency_Full.AddData(builder, dataOffset);
    IonoObservationFrequency_Full.AddDimensionName(builder, dimensionNameOffset);
    IonoObservationFrequency_Full.AddDimensions(builder, dimensionsOffset);
    IonoObservationFrequency_Full.AddNotes(builder, notesOffset);
    return IonoObservationFrequency_Full.EndIonoObservationFrequency_Full(builder);
  }

  public static void StartIonoObservationFrequency_Full(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationFrequency_Full> EndIonoObservationFrequency_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationFrequency_Full>(o);
  }
  public static void FinishIonoObservationFrequency_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationFrequency_Full> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationFrequency_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationFrequency_Full> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationFrequency_FullT UnPack() {
    var _o = new IonoObservationFrequency_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationFrequency_FullT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationFrequency_Full> Pack(FlatBufferBuilder builder, IonoObservationFrequency_FullT _o) {
    if (_o == null) return default(Offset<IonoObservationFrequency_Full>);
...
public class IonoObservationFrequency_FullT
{
  ...
  public IonoObservationFrequency_FullT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationFrequency_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationFrequency_Full.GetRootAsIonoObservationFrequency_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationFrequency_Full.FinishIonoObservationFrequency_FullBuffer(fbb, IonoObservationFrequency_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationFrequency_FullVerify
{
