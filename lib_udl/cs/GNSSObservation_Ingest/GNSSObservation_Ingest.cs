...
public struct GNSSObservation_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static GNSSObservation_Ingest GetRootAsGNSSObservation_Ingest(ByteBuffer _bb) { return GetRootAsGNSSObservation_Ingest(_bb, new GNSSObservation_Ingest()); }
  public static GNSSObservation_Ingest GetRootAsGNSSObservation_Ingest(ByteBuffer _bb, GNSSObservation_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool GNSSObservation_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "GNSS"); }
  public static bool VerifyGNSSObservation_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("GNSS", false, GNSSObservation_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public GNSSObservation_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<GNSSObservation_Ingest> CreateGNSSObservation_Ingest(FlatBufferBuilder builder,
  ...
  public static void StartGNSSObservation_Ingest(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<GNSSObservation_Ingest> EndGNSSObservation_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<GNSSObservation_Ingest>(o);
  }
  public static void FinishGNSSObservation_IngestBuffer(FlatBufferBuilder builder, Offset<GNSSObservation_Ingest> offset) { builder.Finish(offset.Value, "GNSS"); }
  public static void FinishSizePrefixedGNSSObservation_IngestBuffer(FlatBufferBuilder builder, Offset<GNSSObservation_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "GNSS"); }
  public GNSSObservation_IngestT UnPack() {
    var _o = new GNSSObservation_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(GNSSObservation_IngestT _o) {
  ...
  public static Offset<GNSSObservation_Ingest> Pack(FlatBufferBuilder builder, GNSSObservation_IngestT _o) {
    if (_o == null) return default(Offset<GNSSObservation_Ingest>);
...
public class GNSSObservation_IngestT
{
  ...
  public GNSSObservation_IngestT() {
    this.GnssSatId = null;
  ...
  public static GNSSObservation_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return GNSSObservation_Ingest.GetRootAsGNSSObservation_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    GNSSObservation_Ingest.FinishGNSSObservation_IngestBuffer(fbb, GNSSObservation_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class GNSSObservation_IngestVerify
{
