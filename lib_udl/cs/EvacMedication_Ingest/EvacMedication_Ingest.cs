...
public struct EvacMedication_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static EvacMedication_Ingest GetRootAsEvacMedication_Ingest(ByteBuffer _bb, EvacMedication_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EvacMedication_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EVAC"); }
  public static bool VerifyEvacMedication_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EVAC", false, EvacMedication_IngestVerify.Verify); }
  ...
  public static Offset<EvacMedication_Ingest> CreateEvacMedication_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<EvacMedication_Ingest> EndEvacMedication_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EvacMedication_Ingest>(o);
  }
  public static void FinishEvacMedication_IngestBuffer(FlatBufferBuilder builder, Offset<EvacMedication_Ingest> offset) { builder.Finish(offset.Value, "EVAC"); }
  public static void FinishSizePrefixedEvacMedication_IngestBuffer(FlatBufferBuilder builder, Offset<EvacMedication_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "EVAC"); }
  public EvacMedication_IngestT UnPack() {
    var _o = new EvacMedication_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EvacMedication_IngestT _o) {
    _o.Type = this.Type;
  ...
  public static Offset<EvacMedication_Ingest> Pack(FlatBufferBuilder builder, EvacMedication_IngestT _o) {
    if (_o == null) return default(Offset<EvacMedication_Ingest>);
...
public class EvacMedication_IngestT
{
  ...
  public static EvacMedication_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return EvacMedication_Ingest.GetRootAsEvacMedication_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EvacMedication_Ingest.FinishEvacMedication_IngestBuffer(fbb, EvacMedication_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EvacMedication_IngestVerify
{
