...
public struct AirspaceTimePeriod_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static AirspaceTimePeriod_Abridged GetRootAsAirspaceTimePeriod_Abridged(ByteBuffer _bb, AirspaceTimePeriod_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirspaceTimePeriod_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRS"); }
  public static bool VerifyAirspaceTimePeriod_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRS", false, AirspaceTimePeriod_AbridgedVerify.Verify); }
  ...
  public static Offset<AirspaceTimePeriod_Abridged> CreateAirspaceTimePeriod_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<AirspaceTimePeriod_Abridged> EndAirspaceTimePeriod_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirspaceTimePeriod_Abridged>(o);
  }
  public static void FinishAirspaceTimePeriod_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirspaceTimePeriod_Abridged> offset) { builder.Finish(offset.Value, "AIRS"); }
  public static void FinishSizePrefixedAirspaceTimePeriod_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirspaceTimePeriod_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "AIRS"); }
  public AirspaceTimePeriod_AbridgedT UnPack() {
    var _o = new AirspaceTimePeriod_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirspaceTimePeriod_AbridgedT _o) {
  ...
  public static Offset<AirspaceTimePeriod_Abridged> Pack(FlatBufferBuilder builder, AirspaceTimePeriod_AbridgedT _o) {
    if (_o == null) return default(Offset<AirspaceTimePeriod_Abridged>);
...
public class AirspaceTimePeriod_AbridgedT
{
  ...
  public AirspaceTimePeriod_AbridgedT() {
    this.TimeMode = null;
    this.TimeStart = null;
    this.TimeEnd = null;
    this.IntFreq = null;
  ...
  public static AirspaceTimePeriod_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return AirspaceTimePeriod_Abridged.GetRootAsAirspaceTimePeriod_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirspaceTimePeriod_Abridged.FinishAirspaceTimePeriod_AbridgedBuffer(fbb, AirspaceTimePeriod_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirspaceTimePeriod_AbridgedVerify
{
