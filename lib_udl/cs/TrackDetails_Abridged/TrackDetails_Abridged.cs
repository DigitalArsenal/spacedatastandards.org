...
public struct TrackDetails_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static TrackDetails_Abridged GetRootAsTrackDetails_Abridged(ByteBuffer _bb, TrackDetails_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool TrackDetails_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "TRAC"); }
  public static bool VerifyTrackDetails_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("TRAC", false, TrackDetails_AbridgedVerify.Verify); }
  ...
  public TrackDetails_Abridged_env_Enum Env { get { int o = __p.__offset(8); return o != 0 ? (TrackDetails_Abridged_env_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : TrackDetails_Abridged_env_Enum.AIR; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 32
  public TrackDetails_Abridged_objIdent_Enum ObjIdent { get { int o = __p.__offset(50); return o != 0 ? (TrackDetails_Abridged_objIdent_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : TrackDetails_Abridged_objIdent_Enum.ASSUMED_FRIEND; } }
  ...
  public TrackDetails_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(316); return o != 0 ? (TrackDetails_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : TrackDetails_Abridged_dataMode_Enum.REAL; } }
  ...
  public static void AddEnv(FlatBufferBuilder builder, TrackDetails_Abridged_env_Enum env) { builder.AddSbyte(2, (sbyte)env, 0); }
  ...
  public static void AddObjIdent(FlatBufferBuilder builder, TrackDetails_Abridged_objIdent_Enum objIdent) { builder.AddSbyte(23, (sbyte)objIdent, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, TrackDetails_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(156, (sbyte)dataMode, 0); }
  ...
  public static Offset<TrackDetails_Abridged> EndTrackDetails_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<TrackDetails_Abridged>(o);
  }
  public static void FinishTrackDetails_AbridgedBuffer(FlatBufferBuilder builder, Offset<TrackDetails_Abridged> offset) { builder.Finish(offset.Value, "TRAC"); }
  public static void FinishSizePrefixedTrackDetails_AbridgedBuffer(FlatBufferBuilder builder, Offset<TrackDetails_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "TRAC"); }
  public TrackDetails_AbridgedT UnPack() {
    var _o = new TrackDetails_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(TrackDetails_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<TrackDetails_Abridged> Pack(FlatBufferBuilder builder, TrackDetails_AbridgedT _o) {
    if (_o == null) return default(Offset<TrackDetails_Abridged>);
    ...
    StartTrackDetails_Abridged(builder);
    AddId(builder, _id);
    ...
    return EndTrackDetails_Abridged(builder);
  }
}

public class TrackDetails_AbridgedT
{
  public string Id { get; set; }
  public string ClassificationMarking { get; set; }
  public TrackDetails_Abridged_env_Enum Env { get; set; }
  ...
  public TrackDetails_Abridged_objIdent_Enum ObjIdent { get; set; }
  ...
  public TrackDetails_Abridged_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public TrackDetails_AbridgedT() {
    this.Id = null;
    this.ClassificationMarking = null;
    this.Env = TrackDetails_Abridged_env_Enum.AIR;
    this.MsgType = null;
    this.HullNum = null;
    this.Pif = null;
    this.Sconum = null;
    ...
    this.Elnot1 = null;
    this.Elnot2 = null;
    this.ObjIdent = TrackDetails_Abridged_objIdent_Enum.ASSUMED_FRIEND;
    this.ObjType = null;
    this.ObjPlat = null;
    this.ObjAct = null;
    this.ObjNat = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = TrackDetails_Abridged_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static TrackDetails_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return TrackDetails_Abridged.GetRootAsTrackDetails_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    TrackDetails_Abridged.FinishTrackDetails_AbridgedBuffer(fbb, TrackDetails_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class TrackDetails_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*Env*/, 1 /*TrackDetails_Abridged_env_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 50 /*ObjIdent*/, 1 /*TrackDetails_Abridged_objIdent_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 316 /*DataMode*/, 1 /*TrackDetails_Abridged_dataMode_Enum*/, 1, false)
