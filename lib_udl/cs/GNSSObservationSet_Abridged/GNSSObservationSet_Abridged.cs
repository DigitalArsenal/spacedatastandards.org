...
public struct GNSSObservationSet_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static GNSSObservationSet_Abridged GetRootAsGNSSObservationSet_Abridged(ByteBuffer _bb) { return GetRootAsGNSSObservationSet_Abridged(_bb, new GNSSObservationSet_Abridged()); }
  public static GNSSObservationSet_Abridged GetRootAsGNSSObservationSet_Abridged(ByteBuffer _bb, GNSSObservationSet_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool GNSSObservationSet_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "GNSS"); }
  public static bool VerifyGNSSObservationSet_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("GNSS", false, GNSSObservationSet_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public GNSSObservationSet_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public GNSSObservationSet_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(70); return o != 0 ? (GNSSObservationSet_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : GNSSObservationSet_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<GNSSObservationSet_Abridged> CreateGNSSObservationSet_Abridged(FlatBufferBuilder builder,
      ...
      GNSSObservationSet_Abridged_dataMode_Enum dataMode = GNSSObservationSet_Abridged_dataMode_Enum.REAL,
  ...
  public static void StartGNSSObservationSet_Abridged(FlatBufferBuilder builder) { builder.StartTable(36); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, GNSSObservationSet_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(33, (sbyte)dataMode, 0); }
  ...
  public static Offset<GNSSObservationSet_Abridged> EndGNSSObservationSet_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<GNSSObservationSet_Abridged>(o);
  }
  public static void FinishGNSSObservationSet_AbridgedBuffer(FlatBufferBuilder builder, Offset<GNSSObservationSet_Abridged> offset) { builder.Finish(offset.Value, "GNSS"); }
  public static void FinishSizePrefixedGNSSObservationSet_AbridgedBuffer(FlatBufferBuilder builder, Offset<GNSSObservationSet_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "GNSS"); }
  public GNSSObservationSet_AbridgedT UnPack() {
    var _o = new GNSSObservationSet_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(GNSSObservationSet_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<GNSSObservationSet_Abridged> Pack(FlatBufferBuilder builder, GNSSObservationSet_AbridgedT _o) {
    if (_o == null) return default(Offset<GNSSObservationSet_Abridged>);
...
public class GNSSObservationSet_AbridgedT
{
  ...
  public GNSSObservationSet_Abridged_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }
  public List<string> GnssObservationList { get; set; }

  public GNSSObservationSet_AbridgedT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = GNSSObservationSet_Abridged_dataMode_Enum.REAL;
    this.OrigNetwork = null;
    this.GnssObservationList = null;
  }
  public static GNSSObservationSet_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return GNSSObservationSet_Abridged.GetRootAsGNSSObservationSet_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    GNSSObservationSet_Abridged.FinishGNSSObservationSet_AbridgedBuffer(fbb, GNSSObservationSet_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class GNSSObservationSet_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 70 /*DataMode*/, 1 /*GNSSObservationSet_Abridged_dataMode_Enum*/, 1, false)
