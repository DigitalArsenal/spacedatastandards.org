...
public struct EvacEtiology_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static EvacEtiology_Abridged GetRootAsEvacEtiology_Abridged(ByteBuffer _bb, EvacEtiology_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EvacEtiology_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EVAC"); }
  public static bool VerifyEvacEtiology_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EVAC", false, EvacEtiology_AbridgedVerify.Verify); }
  ...
  public static Offset<EvacEtiology_Abridged> CreateEvacEtiology_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<EvacEtiology_Abridged> EndEvacEtiology_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EvacEtiology_Abridged>(o);
  }
  public static void FinishEvacEtiology_AbridgedBuffer(FlatBufferBuilder builder, Offset<EvacEtiology_Abridged> offset) { builder.Finish(offset.Value, "EVAC"); }
  public static void FinishSizePrefixedEvacEtiology_AbridgedBuffer(FlatBufferBuilder builder, Offset<EvacEtiology_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "EVAC"); }
  public EvacEtiology_AbridgedT UnPack() {
    var _o = new EvacEtiology_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EvacEtiology_AbridgedT _o) {
    _o.Type = this.Type;
    _o.BodyPart = this.BodyPart;
    _o.Time = this.Time;
    _o.Comments = this.Comments;
  }
  public static Offset<EvacEtiology_Abridged> Pack(FlatBufferBuilder builder, EvacEtiology_AbridgedT _o) {
    if (_o == null) return default(Offset<EvacEtiology_Abridged>);
...
public class EvacEtiology_AbridgedT
{
  ...
  public EvacEtiology_AbridgedT() {
    this.Type = null;
    this.BodyPart = null;
    this.Time = null;
    this.Comments = null;
  }
  public static EvacEtiology_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return EvacEtiology_Abridged.GetRootAsEvacEtiology_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EvacEtiology_Abridged.FinishEvacEtiology_AbridgedBuffer(fbb, EvacEtiology_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EvacEtiology_AbridgedVerify
{
