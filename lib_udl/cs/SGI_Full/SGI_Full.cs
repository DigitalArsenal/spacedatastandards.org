...
public struct SGI_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SGI_Full GetRootAsSGI_Full(ByteBuffer _bb) { return GetRootAsSGI_Full(_bb, new SGI_Full()); }
  public static SGI_Full GetRootAsSGI_Full(ByteBuffer _bb, SGI_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SGI_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SGIF"); }
  public static bool VerifySGI_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SGIF", false, SGI_FullVerify.Verify); }
  ...
  public SGI_Full_state_Enum State { get { int o = __p.__offset(14); return o != 0 ? (SGI_Full_state_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SGI_Full_state_Enum.I; } }
  ...
  /// Example: /// Example: R
  /// Constraints: Minimum length = 0, Maximum length = 1
  public SGI_Full_precedence_Enum Precedence { get { int o = __p.__offset(24); return o != 0 ? (SGI_Full_precedence_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SGI_Full_precedence_Enum.O; } }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SGI_Full_dataMode_Enum DataMode { get { int o = __p.__offset(104); return o != 0 ? (SGI_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SGI_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<SGI_Full> CreateSGI_Full(FlatBufferBuilder builder,
      ...
      SGI_Full_state_Enum state = SGI_Full_state_Enum.I,
      ...
      int mode = 0,
      SGI_Full_precedence_Enum precedence = SGI_Full_precedence_Enum.O,
      ...
      SGI_Full_dataMode_Enum dataMode = SGI_Full_dataMode_Enum.REAL,
  ...
  public static void AddState(FlatBufferBuilder builder, SGI_Full_state_Enum state) { builder.AddSbyte(5, (sbyte)state, 0); }
  ...
  public static void AddPrecedence(FlatBufferBuilder builder, SGI_Full_precedence_Enum precedence) { builder.AddSbyte(10, (sbyte)precedence, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SGI_Full_dataMode_Enum dataMode) { builder.AddSbyte(50, (sbyte)dataMode, 0); }
  ...
  public static Offset<SGI_Full> EndSGI_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SGI_Full>(o);
  }
  public static void FinishSGI_FullBuffer(FlatBufferBuilder builder, Offset<SGI_Full> offset) { builder.Finish(offset.Value, "SGIF"); }
  public static void FinishSizePrefixedSGI_FullBuffer(FlatBufferBuilder builder, Offset<SGI_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SGIF"); }
  public SGI_FullT UnPack() {
    var _o = new SGI_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SGI_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SGI_Full> Pack(FlatBufferBuilder builder, SGI_FullT _o) {
    if (_o == null) return default(Offset<SGI_Full>);
...
public class SGI_FullT
{
  ...
  public SGI_Full_state_Enum State { get; set; }
  public string StationName { get; set; }
  public string IdSensor { get; set; }
  public string OrigSensorId { get; set; }
  public int Mode { get; set; }
  public SGI_Full_precedence_Enum Precedence { get; set; }
  ...
  public SGI_Full_dataMode_Enum DataMode { get; set; }
  ...
  public SGI_FullT() {
    ...
    this.SgiDate = null;
    this.Type = null;
    this.State = SGI_Full_state_Enum.I;
    this.StationName = null;
    this.IdSensor = null;
    this.OrigSensorId = null;
    this.Mode = 0;
    this.Precedence = SGI_Full_precedence_Enum.O;
    ...
    this.DataMode = SGI_Full_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.UpdatedAt = null;
    this.UpdatedBy = null;
  }
  public static SGI_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return SGI_Full.GetRootAsSGI_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SGI_Full.FinishSGI_FullBuffer(fbb, SGI_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SGI_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*State*/, 1 /*SGI_Full_state_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 24 /*Precedence*/, 1 /*SGI_Full_precedence_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 104 /*DataMode*/, 1 /*SGI_Full_dataMode_Enum*/, 1, false)
