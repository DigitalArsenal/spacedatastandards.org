...
public struct TrackSensor_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static TrackSensor_Ingest GetRootAsTrackSensor_Ingest(ByteBuffer _bb, TrackSensor_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool TrackSensor_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "TRAC"); }
  public static bool VerifyTrackSensor_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("TRAC", false, TrackSensor_IngestVerify.Verify); }
  ...
  public TrackSensor_Ingest_sensorFOVType_Enum SensorFOVType { get { int o = __p.__offset(16); return o != 0 ? (TrackSensor_Ingest_sensorFOVType_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : TrackSensor_Ingest_sensorFOVType_Enum.BUTTERFLY; } }

  public static Offset<TrackSensor_Ingest> CreateTrackSensor_Ingest(FlatBufferBuilder builder,
      double range = 0.0,
      double az = 0.0,
      int sensorNumber = 0,
      ...
      TrackSensor_Ingest_sensorFOVType_Enum sensorFOVType = TrackSensor_Ingest_sensorFOVType_Enum.BUTTERFLY) {
  ...
  public static void AddSensorFOVType(FlatBufferBuilder builder, TrackSensor_Ingest_sensorFOVType_Enum sensorFOVType) { builder.AddSbyte(6, (sbyte)sensorFOVType, 0); }
  public static Offset<TrackSensor_Ingest> EndTrackSensor_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<TrackSensor_Ingest>(o);
  }
  public static void FinishTrackSensor_IngestBuffer(FlatBufferBuilder builder, Offset<TrackSensor_Ingest> offset) { builder.Finish(offset.Value, "TRAC"); }
  public static void FinishSizePrefixedTrackSensor_IngestBuffer(FlatBufferBuilder builder, Offset<TrackSensor_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "TRAC"); }
  public TrackSensor_IngestT UnPack() {
    var _o = new TrackSensor_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(TrackSensor_IngestT _o) {
    _o.Range = this.Range;
    _o.Az = this.Az;
  ...
  public static Offset<TrackSensor_Ingest> Pack(FlatBufferBuilder builder, TrackSensor_IngestT _o) {
    if (_o == null) return default(Offset<TrackSensor_Ingest>);
...
public class TrackSensor_IngestT
{
  ...
  public TrackSensor_Ingest_sensorFOVType_Enum SensorFOVType { get; set; }

  public TrackSensor_IngestT() {
    this.Range = 0.0;
    this.Az = 0.0;
    this.SensorNumber = 0;
    ...
    this.SensorFOVType = TrackSensor_Ingest_sensorFOVType_Enum.BUTTERFLY;
  }
  public static TrackSensor_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return TrackSensor_Ingest.GetRootAsTrackSensor_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    TrackSensor_Ingest.FinishTrackSensor_IngestBuffer(fbb, TrackSensor_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class TrackSensor_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*SensorFOVType*/, 1 /*TrackSensor_Ingest_sensorFOVType_Enum*/, 1, false)
