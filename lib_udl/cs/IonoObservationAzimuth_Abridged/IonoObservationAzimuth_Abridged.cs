...
public struct IonoObservationAzimuth_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationAzimuth_Abridged GetRootAsIonoObservationAzimuth_Abridged(ByteBuffer _bb) { return GetRootAsIonoObservationAzimuth_Abridged(_bb, new IonoObservationAzimuth_Abridged()); }
  public static IonoObservationAzimuth_Abridged GetRootAsIonoObservationAzimuth_Abridged(ByteBuffer _bb, IonoObservationAzimuth_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationAzimuth_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationAzimuth_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationAzimuth_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationAzimuth_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationAzimuth_Abridged> CreateIonoObservationAzimuth_Abridged(FlatBufferBuilder builder,
  ...
  public static void StartIonoObservationAzimuth_Abridged(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationAzimuth_Abridged> EndIonoObservationAzimuth_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationAzimuth_Abridged>(o);
  }
  public static void FinishIonoObservationAzimuth_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationAzimuth_Abridged> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationAzimuth_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationAzimuth_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationAzimuth_AbridgedT UnPack() {
    var _o = new IonoObservationAzimuth_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationAzimuth_AbridgedT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationAzimuth_Abridged> Pack(FlatBufferBuilder builder, IonoObservationAzimuth_AbridgedT _o) {
    if (_o == null) return default(Offset<IonoObservationAzimuth_Abridged>);
    ...
    return CreateIonoObservationAzimuth_Abridged(
      builder,
      _notes,
      _dimensions,
      _dimensionName,
...
public class IonoObservationAzimuth_AbridgedT
{
  ...
  public IonoObservationAzimuth_AbridgedT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationAzimuth_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationAzimuth_Abridged.GetRootAsIonoObservationAzimuth_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationAzimuth_Abridged.FinishIonoObservationAzimuth_AbridgedBuffer(fbb, IonoObservationAzimuth_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationAzimuth_AbridgedVerify
{
