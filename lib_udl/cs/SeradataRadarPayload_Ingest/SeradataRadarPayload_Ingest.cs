...
public struct SeradataRadarPayload_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SeradataRadarPayload_Ingest GetRootAsSeradataRadarPayload_Ingest(ByteBuffer _bb) { return GetRootAsSeradataRadarPayload_Ingest(_bb, new SeradataRadarPayload_Ingest()); }
  public static SeradataRadarPayload_Ingest GetRootAsSeradataRadarPayload_Ingest(ByteBuffer _bb, SeradataRadarPayload_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SeradataRadarPayload_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SERA"); }
  public static bool VerifySeradataRadarPayload_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SERA", false, SeradataRadarPayload_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SeradataRadarPayload_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SeradataRadarPayload_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(66); return o != 0 ? (SeradataRadarPayload_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SeradataRadarPayload_Ingest_dataMode_Enum.REAL; } }

  public static Offset<SeradataRadarPayload_Ingest> CreateSeradataRadarPayload_Ingest(FlatBufferBuilder builder,
      ...
      SeradataRadarPayload_Ingest_dataMode_Enum dataMode = SeradataRadarPayload_Ingest_dataMode_Enum.REAL) {
  ...
  public static void StartSeradataRadarPayload_Ingest(FlatBufferBuilder builder) { builder.StartTable(32); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SeradataRadarPayload_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(31, (sbyte)dataMode, 0); }
  public static Offset<SeradataRadarPayload_Ingest> EndSeradataRadarPayload_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SeradataRadarPayload_Ingest>(o);
  }
  public static void FinishSeradataRadarPayload_IngestBuffer(FlatBufferBuilder builder, Offset<SeradataRadarPayload_Ingest> offset) { builder.Finish(offset.Value, "SERA"); }
  public static void FinishSizePrefixedSeradataRadarPayload_IngestBuffer(FlatBufferBuilder builder, Offset<SeradataRadarPayload_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "SERA"); }
  public SeradataRadarPayload_IngestT UnPack() {
    var _o = new SeradataRadarPayload_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SeradataRadarPayload_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SeradataRadarPayload_Ingest> Pack(FlatBufferBuilder builder, SeradataRadarPayload_IngestT _o) {
    if (_o == null) return default(Offset<SeradataRadarPayload_Ingest>);
...
public class SeradataRadarPayload_IngestT
{
  ...
  public SeradataRadarPayload_Ingest_dataMode_Enum DataMode { get; set; }

  public SeradataRadarPayload_IngestT() {
    this.Id = null;
    ...
    this.DataMode = SeradataRadarPayload_Ingest_dataMode_Enum.REAL;
  }
  public static SeradataRadarPayload_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return SeradataRadarPayload_Ingest.GetRootAsSeradataRadarPayload_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SeradataRadarPayload_Ingest.FinishSeradataRadarPayload_IngestBuffer(fbb, SeradataRadarPayload_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SeradataRadarPayload_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 66 /*DataMode*/, 1 /*SeradataRadarPayload_Ingest_dataMode_Enum*/, 1, false)
