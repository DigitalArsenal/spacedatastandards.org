...
public struct LogisticsSupport_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static LogisticsSupport_Full GetRootAsLogisticsSupport_Full(ByteBuffer _bb, LogisticsSupport_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LogisticsSupport_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LOGI"); }
  public static bool VerifyLogisticsSupport_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LOGI", false, LogisticsSupport_FullVerify.Verify); }
  ...
  public LogisticsSupport_Full_dataMode_Enum DataMode { get { int o = __p.__offset(62); return o != 0 ? (LogisticsSupport_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : LogisticsSupport_Full_dataMode_Enum.REAL; } }

  public static Offset<LogisticsSupport_Full> CreateLogisticsSupport_Full(FlatBufferBuilder builder,
      ...
      LogisticsSupport_Full_dataMode_Enum dataMode = LogisticsSupport_Full_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, LogisticsSupport_Full_dataMode_Enum dataMode) { builder.AddSbyte(29, (sbyte)dataMode, 0); }
  public static Offset<LogisticsSupport_Full> EndLogisticsSupport_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LogisticsSupport_Full>(o);
  }
  public static void FinishLogisticsSupport_FullBuffer(FlatBufferBuilder builder, Offset<LogisticsSupport_Full> offset) { builder.Finish(offset.Value, "LOGI"); }
  public static void FinishSizePrefixedLogisticsSupport_FullBuffer(FlatBufferBuilder builder, Offset<LogisticsSupport_Full> offset) { builder.FinishSizePrefixed(offset.Value, "LOGI"); }
  public LogisticsSupport_FullT UnPack() {
    var _o = new LogisticsSupport_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LogisticsSupport_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<LogisticsSupport_Full> Pack(FlatBufferBuilder builder, LogisticsSupport_FullT _o) {
    if (_o == null) return default(Offset<LogisticsSupport_Full>);
...
public class LogisticsSupport_FullT
{
  ...
  public LogisticsSupport_Full_dataMode_Enum DataMode { get; set; }

  public LogisticsSupport_FullT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = LogisticsSupport_Full_dataMode_Enum.REAL;
  }
  public static LogisticsSupport_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return LogisticsSupport_Full.GetRootAsLogisticsSupport_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LogisticsSupport_Full.FinishLogisticsSupport_FullBuffer(fbb, LogisticsSupport_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LogisticsSupport_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 62 /*DataMode*/, 1 /*LogisticsSupport_Full_dataMode_Enum*/, 1, false)
