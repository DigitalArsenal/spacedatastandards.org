...
public struct LinkStatus_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static LinkStatus_Ingest GetRootAsLinkStatus_Ingest(ByteBuffer _bb) { return GetRootAsLinkStatus_Ingest(_bb, new LinkStatus_Ingest()); }
  public static LinkStatus_Ingest GetRootAsLinkStatus_Ingest(ByteBuffer _bb, LinkStatus_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LinkStatus_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LINK"); }
  public static bool VerifyLinkStatus_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LINK", false, LinkStatus_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public LinkStatus_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public LinkStatus_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(60); return o != 0 ? (LinkStatus_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : LinkStatus_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<LinkStatus_Ingest> CreateLinkStatus_Ingest(FlatBufferBuilder builder,
      ...
      LinkStatus_Ingest_dataMode_Enum dataMode = LinkStatus_Ingest_dataMode_Enum.REAL,
      int satNo1 = 0,
      int satNo2 = 0) {
  ...
  public static void StartLinkStatus_Ingest(FlatBufferBuilder builder) { builder.StartTable(31); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, LinkStatus_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(28, (sbyte)dataMode, 0); }
  ...
  public static Offset<LinkStatus_Ingest> EndLinkStatus_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LinkStatus_Ingest>(o);
  }
  public static void FinishLinkStatus_IngestBuffer(FlatBufferBuilder builder, Offset<LinkStatus_Ingest> offset) { builder.Finish(offset.Value, "LINK"); }
  public static void FinishSizePrefixedLinkStatus_IngestBuffer(FlatBufferBuilder builder, Offset<LinkStatus_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "LINK"); }
  public LinkStatus_IngestT UnPack() {
    var _o = new LinkStatus_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LinkStatus_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<LinkStatus_Ingest> Pack(FlatBufferBuilder builder, LinkStatus_IngestT _o) {
    if (_o == null) return default(Offset<LinkStatus_Ingest>);
...
public class LinkStatus_IngestT
{
  ...
  public LinkStatus_Ingest_dataMode_Enum DataMode { get; set; }
  public int SatNo1 { get; set; }
  public int SatNo2 { get; set; }

  public LinkStatus_IngestT() {
    this.Id = null;
    ...
    this.DataMode = LinkStatus_Ingest_dataMode_Enum.REAL;
    this.SatNo1 = 0;
    this.SatNo2 = 0;
  }
  public static LinkStatus_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return LinkStatus_Ingest.GetRootAsLinkStatus_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LinkStatus_Ingest.FinishLinkStatus_IngestBuffer(fbb, LinkStatus_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LinkStatus_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 60 /*DataMode*/, 1 /*LinkStatus_Ingest_dataMode_Enum*/, 1, false)
