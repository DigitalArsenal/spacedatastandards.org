...
public struct Item_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Item_Full GetRootAsItem_Full(ByteBuffer _bb) { return GetRootAsItem_Full(_bb, new Item_Full()); }
  public static Item_Full GetRootAsItem_Full(ByteBuffer _bb, Item_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Item_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ITEM"); }
  public static bool VerifyItem_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ITEM", false, Item_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Item_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: No constraints specified.
  public string UpdatedAt { get { int o = __p.__offset(96); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedAtBytes() { return __p.__vector_as_span<byte>(96, 1); }
#else
  public ArraySegment<byte>? GetUpdatedAtBytes() { return __p.__vector_as_arraysegment(96); }
#endif
  public byte[] GetUpdatedAtArray() { return __p.__vector_as_array<byte>(96); }
  /// Application user who updated the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string UpdatedBy { get { int o = __p.__offset(98); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedByBytes() { return __p.__vector_as_span<byte>(98, 1); }
#else
  public ArraySegment<byte>? GetUpdatedByBytes() { return __p.__vector_as_arraysegment(98); }
#endif
  public byte[] GetUpdatedByArray() { return __p.__vector_as_array<byte>(98); }
  /// The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
  /// Example: /// Example: AXE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string SourceDL { get { int o = __p.__offset(100); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceDLBytes() { return __p.__vector_as_span<byte>(100, 1); }
#else
  public ArraySegment<byte>? GetSourceDLBytes() { return __p.__vector_as_arraysegment(100); }
#endif
  public byte[] GetSourceDLArray() { return __p.__vector_as_array<byte>(100); }
  /// Source of the data.
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Item_Full_dataMode_Enum DataMode { get { int o = __p.__offset(108); return o != 0 ? (Item_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Item_Full_dataMode_Enum.REAL; } }

  public static Offset<Item_Full> CreateItem_Full(FlatBufferBuilder builder,
      ...
      Item_Full_dataMode_Enum dataMode = Item_Full_dataMode_Enum.REAL) {
    builder.StartTable(53);
    Item_Full.AddNetExpWt(builder, netExpWt);
    Item_Full.AddMoment(builder, moment);
    Item_Full.AddCenterlineOffset(builder, centerlineOffset);
    Item_Full.AddFs(builder, fs);
    Item_Full.AddCg(builder, cg);
    Item_Full.AddVolume(builder, volume);
    Item_Full.AddHeight(builder, height);
    Item_Full.AddLength(builder, length);
    Item_Full.AddWidth(builder, width);
    Item_Full.AddWeight(builder, weight);
    Item_Full.AddOrigNetwork(builder, origNetworkOffset);
    Item_Full.AddOrigin(builder, originOffset);
    Item_Full.AddSource(builder, sourceOffset);
    Item_Full.AddSourceDL(builder, sourceDLOffset);
    Item_Full.AddUpdatedBy(builder, updatedByOffset);
    Item_Full.AddUpdatedAt(builder, updatedAtOffset);
    Item_Full.AddCreatedBy(builder, createdByOffset);
    Item_Full.AddCreatedAt(builder, createdAtOffset);
    Item_Full.AddAccSysValues(builder, accSysValuesOffset);
    Item_Full.AddAccSysKeys(builder, accSysKeysOffset);
    Item_Full.AddAccSysNotes(builder, accSysNotesOffset);
    Item_Full.AddAccSystem(builder, accSystemOffset);
    Item_Full.AddAltDataFormat(builder, altDataFormatOffset);
    Item_Full.AddValues(builder, valuesOffset);
    Item_Full.AddKeys(builder, keysOffset);
    Item_Full.AddNotes(builder, notesOffset);
    Item_Full.AddDvCode(builder, dvCodeOffset);
    Item_Full.AddNumPalletPos(builder, numPalletPos);
    Item_Full.AddItemContains(builder, itemContainsOffset);
    Item_Full.AddHazCodes(builder, hazCodesOffset);
    Item_Full.AddTcn(builder, tcnOffset);
    Item_Full.AddProductSys(builder, productSysOffset);
    Item_Full.AddProductCode(builder, productCodeOffset);
    Item_Full.AddCommoditySys(builder, commoditySysOffset);
    Item_Full.AddCommodityCode(builder, commodityCodeOffset);
    Item_Full.AddWeightTS(builder, weightTSOffset);
    Item_Full.AddUln(builder, ulnOffset);
    Item_Full.AddLastArrDate(builder, lastArrDateOffset);
    Item_Full.AddReceivingBranch(builder, receivingBranchOffset);
    Item_Full.AddReceivingUnit(builder, receivingUnitOffset);
    Item_Full.AddDeparture(builder, departureOffset);
    Item_Full.AddDestination(builder, destinationOffset);
    Item_Full.AddName(builder, nameOffset);
    Item_Full.AddCargoType(builder, cargoTypeOffset);
    Item_Full.AddType(builder, typeOffset);
    Item_Full.AddScGenTool(builder, scGenToolOffset);
    Item_Full.AddScanCode(builder, scanCodeOffset);
    Item_Full.AddIdAirLoadPlan(builder, idAirLoadPlanOffset);
    Item_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    Item_Full.AddId(builder, idOffset);
    Item_Full.AddDataMode(builder, dataMode);
    Item_Full.AddContainer(builder, container);
    Item_Full.AddAirdrop(builder, airdrop);
    return Item_Full.EndItem_Full(builder);
  }

  public static void StartItem_Full(FlatBufferBuilder builder) { builder.StartTable(53); }
  ...
  public static void AddUpdatedAt(FlatBufferBuilder builder, StringOffset updatedAtOffset) { builder.AddOffset(46, updatedAtOffset.Value, 0); }
  public static void AddUpdatedBy(FlatBufferBuilder builder, StringOffset updatedByOffset) { builder.AddOffset(47, updatedByOffset.Value, 0); }
  public static void AddSourceDL(FlatBufferBuilder builder, StringOffset sourceDLOffset) { builder.AddOffset(48, sourceDLOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Item_Full_dataMode_Enum dataMode) { builder.AddSbyte(52, (sbyte)dataMode, 0); }
  public static Offset<Item_Full> EndItem_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Item_Full>(o);
  }
  public static void FinishItem_FullBuffer(FlatBufferBuilder builder, Offset<Item_Full> offset) { builder.Finish(offset.Value, "ITEM"); }
  public static void FinishSizePrefixedItem_FullBuffer(FlatBufferBuilder builder, Offset<Item_Full> offset) { builder.FinishSizePrefixed(offset.Value, "ITEM"); }
  public Item_FullT UnPack() {
    var _o = new Item_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Item_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Item_Full> Pack(FlatBufferBuilder builder, Item_FullT _o) {
    if (_o == null) return default(Offset<Item_Full>);
...
public class Item_FullT
{
  ...
  public Item_Full_dataMode_Enum DataMode { get; set; }
  ...
  public Item_FullT() {
    ...
    this.DataMode = Item_Full_dataMode_Enum.REAL;
  }
  public static Item_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Item_Full.GetRootAsItem_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Item_Full.FinishItem_FullBuffer(fbb, Item_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Item_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyString(tablePos, 96 /*UpdatedAt*/, false)
      && verifier.VerifyString(tablePos, 98 /*UpdatedBy*/, false)
      && verifier.VerifyString(tablePos, 100 /*SourceDL*/, false)
      ...
      && verifier.VerifyField(tablePos, 108 /*DataMode*/, 1 /*Item_Full_dataMode_Enum*/, 1, false)
