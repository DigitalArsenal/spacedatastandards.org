...
public struct AntennaDetails_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static AntennaDetails_Full GetRootAsAntennaDetails_Full(ByteBuffer _bb, AntennaDetails_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AntennaDetails_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ANTE"); }
  public static bool VerifyAntennaDetails_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ANTE", false, AntennaDetails_FullVerify.Verify); }
  ...
  public AntennaDetails_Full_mode_Enum Mode { get { int o = __p.__offset(14); return o != 0 ? (AntennaDetails_Full_mode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AntennaDetails_Full_mode_Enum.TX; } }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public AntennaDetails_Full_dataMode_Enum DataMode { get { int o = __p.__offset(54); return o != 0 ? (AntennaDetails_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AntennaDetails_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<AntennaDetails_Full> CreateAntennaDetails_Full(FlatBufferBuilder builder,
      ...
      AntennaDetails_Full_mode_Enum mode = AntennaDetails_Full_mode_Enum.TX,
      ...
      AntennaDetails_Full_dataMode_Enum dataMode = AntennaDetails_Full_dataMode_Enum.REAL,
  ...
  public static void AddMode(FlatBufferBuilder builder, AntennaDetails_Full_mode_Enum mode) { builder.AddSbyte(5, (sbyte)mode, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AntennaDetails_Full_dataMode_Enum dataMode) { builder.AddSbyte(25, (sbyte)dataMode, 0); }
  ...
  public static Offset<AntennaDetails_Full> EndAntennaDetails_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AntennaDetails_Full>(o);
  }
  public static void FinishAntennaDetails_FullBuffer(FlatBufferBuilder builder, Offset<AntennaDetails_Full> offset) { builder.Finish(offset.Value, "ANTE"); }
  public static void FinishSizePrefixedAntennaDetails_FullBuffer(FlatBufferBuilder builder, Offset<AntennaDetails_Full> offset) { builder.FinishSizePrefixed(offset.Value, "ANTE"); }
  public AntennaDetails_FullT UnPack() {
    var _o = new AntennaDetails_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AntennaDetails_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AntennaDetails_Full> Pack(FlatBufferBuilder builder, AntennaDetails_FullT _o) {
    if (_o == null) return default(Offset<AntennaDetails_Full>);
...
public class AntennaDetails_FullT
{
  ...
  public AntennaDetails_Full_mode_Enum Mode { get; set; }
  ...
  public AntennaDetails_Full_dataMode_Enum DataMode { get; set; }
  public List<string> Tags { get; set; }
  public string ManufacturerOrg { get; set; }

  public AntennaDetails_FullT() {
    this.Id = null;
    this.IdAntenna = null;
    this.ClassificationMarking = null;
    this.Type = null;
    this.Position = null;
    this.Mode = AntennaDetails_Full_mode_Enum.TX;
    ...
    this.DataMode = AntennaDetails_Full_dataMode_Enum.REAL;
    this.Tags = null;
    this.ManufacturerOrg = null;
  }
  public static AntennaDetails_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return AntennaDetails_Full.GetRootAsAntennaDetails_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AntennaDetails_Full.FinishAntennaDetails_FullBuffer(fbb, AntennaDetails_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AntennaDetails_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*Mode*/, 1 /*AntennaDetails_Full_mode_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 54 /*DataMode*/, 1 /*AntennaDetails_Full_dataMode_Enum*/, 1, false)
