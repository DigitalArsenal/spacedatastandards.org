...
public struct EvacVitalSignData_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EvacVitalSignData_Full GetRootAsEvacVitalSignData_Full(ByteBuffer _bb) { return GetRootAsEvacVitalSignData_Full(_bb, new EvacVitalSignData_Full()); }
  public static EvacVitalSignData_Full GetRootAsEvacVitalSignData_Full(ByteBuffer _bb, EvacVitalSignData_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EvacVitalSignData_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EVAC"); }
  public static bool VerifyEvacVitalSignData_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EVAC", false, EvacVitalSignData_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EvacVitalSignData_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<EvacVitalSignData_Full> CreateEvacVitalSignData_Full(FlatBufferBuilder builder,
    ...
    EvacVitalSignData_Full.AddVitalSign2(builder, vitalSign2);
    EvacVitalSignData_Full.AddVitalSign1(builder, vitalSign1);
    EvacVitalSignData_Full.AddTime(builder, timeOffset);
    EvacVitalSignData_Full.AddMedConfFactor(builder, medConfFactor);
    EvacVitalSignData_Full.AddVitalSign(builder, vitalSignOffset);
    return EvacVitalSignData_Full.EndEvacVitalSignData_Full(builder);
  }

  public static void StartEvacVitalSignData_Full(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<EvacVitalSignData_Full> EndEvacVitalSignData_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EvacVitalSignData_Full>(o);
  }
  public static void FinishEvacVitalSignData_FullBuffer(FlatBufferBuilder builder, Offset<EvacVitalSignData_Full> offset) { builder.Finish(offset.Value, "EVAC"); }
  public static void FinishSizePrefixedEvacVitalSignData_FullBuffer(FlatBufferBuilder builder, Offset<EvacVitalSignData_Full> offset) { builder.FinishSizePrefixed(offset.Value, "EVAC"); }
  public EvacVitalSignData_FullT UnPack() {
    var _o = new EvacVitalSignData_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EvacVitalSignData_FullT _o) {
  ...
  public static Offset<EvacVitalSignData_Full> Pack(FlatBufferBuilder builder, EvacVitalSignData_FullT _o) {
    if (_o == null) return default(Offset<EvacVitalSignData_Full>);
...
public class EvacVitalSignData_FullT
{
  ...
  public EvacVitalSignData_FullT() {
    this.VitalSign = null;
    this.VitalSign1 = 0.0;
    this.VitalSign2 = 0.0;
  ...
  public static EvacVitalSignData_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return EvacVitalSignData_Full.GetRootAsEvacVitalSignData_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EvacVitalSignData_Full.FinishEvacVitalSignData_FullBuffer(fbb, EvacVitalSignData_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EvacVitalSignData_FullVerify
{
