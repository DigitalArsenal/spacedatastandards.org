...
public struct GEOStatus_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static GEOStatus_Ingest GetRootAsGEOStatus_Ingest(ByteBuffer _bb, GEOStatus_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool GEOStatus_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "GEOS"); }
  public static bool VerifyGEOStatus_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("GEOS", false, GEOStatus_IngestVerify.Verify); }
  ...
  public GEOStatus_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(46); return o != 0 ? (GEOStatus_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : GEOStatus_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<GEOStatus_Ingest> CreateGEOStatus_Ingest(FlatBufferBuilder builder,
      ...
      GEOStatus_Ingest_dataMode_Enum dataMode = GEOStatus_Ingest_dataMode_Enum.REAL,
      int satNo = 0,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, GEOStatus_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(21, (sbyte)dataMode, 0); }
  ...
  public static Offset<GEOStatus_Ingest> EndGEOStatus_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<GEOStatus_Ingest>(o);
  }
  public static void FinishGEOStatus_IngestBuffer(FlatBufferBuilder builder, Offset<GEOStatus_Ingest> offset) { builder.Finish(offset.Value, "GEOS"); }
  public static void FinishSizePrefixedGEOStatus_IngestBuffer(FlatBufferBuilder builder, Offset<GEOStatus_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "GEOS"); }
  public GEOStatus_IngestT UnPack() {
    var _o = new GEOStatus_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(GEOStatus_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<GEOStatus_Ingest> Pack(FlatBufferBuilder builder, GEOStatus_IngestT _o) {
    if (_o == null) return default(Offset<GEOStatus_Ingest>);
...
public class GEOStatus_IngestT
{
  ...
  public GEOStatus_Ingest_dataMode_Enum DataMode { get; set; }
  public int SatNo { get; set; }
  public string OrigNetwork { get; set; }

  public GEOStatus_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = GEOStatus_Ingest_dataMode_Enum.REAL;
    this.SatNo = 0;
    this.OrigNetwork = null;
  }
  public static GEOStatus_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return GEOStatus_Ingest.GetRootAsGEOStatus_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    GEOStatus_Ingest.FinishGEOStatus_IngestBuffer(fbb, GEOStatus_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class GEOStatus_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 46 /*DataMode*/, 1 /*GEOStatus_Ingest_dataMode_Enum*/, 1, false)
