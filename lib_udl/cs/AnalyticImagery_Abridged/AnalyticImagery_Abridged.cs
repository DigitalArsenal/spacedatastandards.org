...
public struct AnalyticImagery_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AnalyticImagery_Abridged GetRootAsAnalyticImagery_Abridged(ByteBuffer _bb) { return GetRootAsAnalyticImagery_Abridged(_bb, new AnalyticImagery_Abridged()); }
  public static AnalyticImagery_Abridged GetRootAsAnalyticImagery_Abridged(ByteBuffer _bb, AnalyticImagery_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AnalyticImagery_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ANAL"); }
  public static bool VerifyAnalyticImagery_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ANAL", false, AnalyticImagery_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AnalyticImagery_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: No constraints specified.
  public string SatId(int j) { int o = __p.__offset(56); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SatIdLength { get { int o = __p.__offset(56); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Constraints: No constraints specified.
  public string SatIdConf(int j) { int o = __p.__offset(58); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SatIdConfLength { get { int o = __p.__offset(58); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Constraints: No constraints specified.
  public string SrcTyps(int j) { int o = __p.__offset(60); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SrcTypsLength { get { int o = __p.__offset(60); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Constraints: No constraints specified.
  public string SrcIds(int j) { int o = __p.__offset(62); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SrcIdsLength { get { int o = __p.__offset(62); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
  /// Example: /// Example: ['TAG1', 'TAG2']
  /// Constraints: No constraints specified.
  public string Tags(int j) { int o = __p.__offset(64); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int TagsLength { get { int o = __p.__offset(64); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// MD5 checksum value of the file. The ingest/create operation will automatically generate the value.
  /// Example: /// Example: 123
  /// Constraints: Minimum length = 0, Maximum length = 256
  public string ChecksumValue { get { int o = __p.__offset(66); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetChecksumValueBytes() { return __p.__vector_as_span<byte>(66, 1); }
#else
  public ArraySegment<byte>? GetChecksumValueBytes() { return __p.__vector_as_arraysegment(66); }
#endif
  public byte[] GetChecksumValueArray() { return __p.__vector_as_array<byte>(66); }
  /// Optional identifier to track a commercial or marketplace transaction executed to produce this data.
  /// Example: /// Example: a7bdef1f-5a4f-4716-bee4-7a1e0ec7d35a
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string TransactionId { get { int o = __p.__offset(68); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTransactionIdBytes() { return __p.__vector_as_span<byte>(68, 1); }
#else
  public ArraySegment<byte>? GetTransactionIdBytes() { return __p.__vector_as_arraysegment(68); }
#endif
  public byte[] GetTransactionIdArray() { return __p.__vector_as_array<byte>(68); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public AnalyticImagery_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(82); return o != 0 ? (AnalyticImagery_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AnalyticImagery_Abridged_dataMode_Enum.REAL; } }

  public static Offset<AnalyticImagery_Abridged> CreateAnalyticImagery_Abridged(FlatBufferBuilder builder,
      ...
      AnalyticImagery_Abridged_dataMode_Enum dataMode = AnalyticImagery_Abridged_dataMode_Enum.REAL) {
    builder.StartTable(40);
    AnalyticImagery_Abridged.AddFilesize(builder, filesize);
    AnalyticImagery_Abridged.AddSourceDL(builder, sourceDLOffset);
    AnalyticImagery_Abridged.AddOrigNetwork(builder, origNetworkOffset);
    AnalyticImagery_Abridged.AddOrigin(builder, originOffset);
    AnalyticImagery_Abridged.AddSource(builder, sourceOffset);
    AnalyticImagery_Abridged.AddCreatedBy(builder, createdByOffset);
    AnalyticImagery_Abridged.AddCreatedAt(builder, createdAtOffset);
    AnalyticImagery_Abridged.AddTransactionId(builder, transactionIdOffset);
    AnalyticImagery_Abridged.AddChecksumValue(builder, checksumValueOffset);
    AnalyticImagery_Abridged.AddTags(builder, tagsOffset);
    AnalyticImagery_Abridged.AddSrcIds(builder, srcIdsOffset);
    AnalyticImagery_Abridged.AddSrcTyps(builder, srcTypsOffset);
    AnalyticImagery_Abridged.AddSatIdConf(builder, satIdConfOffset);
    AnalyticImagery_Abridged.AddSatId(builder, satIdOffset);
    AnalyticImagery_Abridged.AddAsrid(builder, asrid);
    AnalyticImagery_Abridged.AddAndims(builder, andims);
    AnalyticImagery_Abridged.AddAtype(builder, atypeOffset);
    AnalyticImagery_Abridged.AddAgjson(builder, agjsonOffset);
    AnalyticImagery_Abridged.AddAtext(builder, atextOffset);
    AnalyticImagery_Abridged.AddKeywords(builder, keywordsOffset);
    AnalyticImagery_Abridged.AddAnnText(builder, annTextOffset);
    AnalyticImagery_Abridged.AddAnnLims(builder, annLimsOffset);
    AnalyticImagery_Abridged.AddDataStop(builder, dataStopOffset);
    AnalyticImagery_Abridged.AddDataStart(builder, dataStartOffset);
    AnalyticImagery_Abridged.AddDescription(builder, descriptionOffset);
    AnalyticImagery_Abridged.AddSequenceId(builder, sequenceId);
    AnalyticImagery_Abridged.AddImageSetLength(builder, imageSetLength);
    AnalyticImagery_Abridged.AddImageSetId(builder, imageSetIdOffset);
    AnalyticImagery_Abridged.AddZUnits(builder, zUnitsOffset);
    AnalyticImagery_Abridged.AddYUnits(builder, yUnitsOffset);
    AnalyticImagery_Abridged.AddXUnits(builder, xUnitsOffset);
    AnalyticImagery_Abridged.AddImgHeight(builder, imgHeight);
    AnalyticImagery_Abridged.AddImgWidth(builder, imgWidth);
    AnalyticImagery_Abridged.AddFilename(builder, filenameOffset);
    AnalyticImagery_Abridged.AddImageType(builder, imageTypeOffset);
    AnalyticImagery_Abridged.AddMsgTime(builder, msgTimeOffset);
    AnalyticImagery_Abridged.AddContent(builder, contentOffset);
    AnalyticImagery_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    AnalyticImagery_Abridged.AddId(builder, idOffset);
    AnalyticImagery_Abridged.AddDataMode(builder, dataMode);
    return AnalyticImagery_Abridged.EndAnalyticImagery_Abridged(builder);
  }

  public static void StartAnalyticImagery_Abridged(FlatBufferBuilder builder) { builder.StartTable(40); }
  ...
  public static void AddSatId(FlatBufferBuilder builder, VectorOffset satIdOffset) { builder.AddOffset(26, satIdOffset.Value, 0); }
  ...
  public static void AddSatIdConf(FlatBufferBuilder builder, VectorOffset satIdConfOffset) { builder.AddOffset(27, satIdConfOffset.Value, 0); }
  ...
  public static void AddSrcTyps(FlatBufferBuilder builder, VectorOffset srcTypsOffset) { builder.AddOffset(28, srcTypsOffset.Value, 0); }
  ...
  public static void AddSrcIds(FlatBufferBuilder builder, VectorOffset srcIdsOffset) { builder.AddOffset(29, srcIdsOffset.Value, 0); }
  ...
  public static void AddTags(FlatBufferBuilder builder, VectorOffset tagsOffset) { builder.AddOffset(30, tagsOffset.Value, 0); }
  ...
  public static void AddChecksumValue(FlatBufferBuilder builder, StringOffset checksumValueOffset) { builder.AddOffset(31, checksumValueOffset.Value, 0); }
  public static void AddTransactionId(FlatBufferBuilder builder, StringOffset transactionIdOffset) { builder.AddOffset(32, transactionIdOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AnalyticImagery_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(39, (sbyte)dataMode, 0); }
  public static Offset<AnalyticImagery_Abridged> EndAnalyticImagery_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AnalyticImagery_Abridged>(o);
  }
  public static void FinishAnalyticImagery_AbridgedBuffer(FlatBufferBuilder builder, Offset<AnalyticImagery_Abridged> offset) { builder.Finish(offset.Value, "ANAL"); }
  public static void FinishSizePrefixedAnalyticImagery_AbridgedBuffer(FlatBufferBuilder builder, Offset<AnalyticImagery_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "ANAL"); }
  public AnalyticImagery_AbridgedT UnPack() {
    var _o = new AnalyticImagery_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AnalyticImagery_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AnalyticImagery_Abridged> Pack(FlatBufferBuilder builder, AnalyticImagery_AbridgedT _o) {
    if (_o == null) return default(Offset<AnalyticImagery_Abridged>);
    ...
    return CreateAnalyticImagery_Abridged(
      builder,
      _id,
...
public class AnalyticImagery_AbridgedT
{
  ...
  public AnalyticImagery_Abridged_dataMode_Enum DataMode { get; set; }

  public AnalyticImagery_AbridgedT() {
    this.Id = null;
    ...
    this.SourceDL = null;
    this.DataMode = AnalyticImagery_Abridged_dataMode_Enum.REAL;
  }
  public static AnalyticImagery_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return AnalyticImagery_Abridged.GetRootAsAnalyticImagery_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AnalyticImagery_Abridged.FinishAnalyticImagery_AbridgedBuffer(fbb, AnalyticImagery_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AnalyticImagery_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfStrings(tablePos, 56 /*SatId*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 58 /*SatIdConf*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 60 /*SrcTyps*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 62 /*SrcIds*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 64 /*Tags*/, false)
      && verifier.VerifyString(tablePos, 66 /*ChecksumValue*/, false)
      && verifier.VerifyString(tablePos, 68 /*TransactionId*/, false)
      ...
      && verifier.VerifyField(tablePos, 82 /*DataMode*/, 1 /*AnalyticImagery_Abridged_dataMode_Enum*/, 1, false)
