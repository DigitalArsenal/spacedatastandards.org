...
public struct SOICalibration_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SOICalibration_Ingest GetRootAsSOICalibration_Ingest(ByteBuffer _bb) { return GetRootAsSOICalibration_Ingest(_bb, new SOICalibration_Ingest()); }
  public static SOICalibration_Ingest GetRootAsSOICalibration_Ingest(ByteBuffer _bb, SOICalibration_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SOICalibration_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SOIC"); }
  public static bool VerifySOICalibration_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SOIC", false, SOICalibration_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SOICalibration_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<SOICalibration_Ingest> CreateSOICalibration_Ingest(FlatBufferBuilder builder,
    ...
    SOICalibration_Ingest.AddCalExtinctionCoeffMaxUnc(builder, calExtinctionCoeffMaxUnc);
    SOICalibration_Ingest.AddCalExtinctionCoeffUnc(builder, calExtinctionCoeffUnc);
    SOICalibration_Ingest.AddCalZeroPoint(builder, calZeroPoint);
    SOICalibration_Ingest.AddCalSpectralFilterSolarMag(builder, calSpectralFilterSolarMag);
    SOICalibration_Ingest.AddCalBgIntensity(builder, calBgIntensity);
    SOICalibration_Ingest.AddCalSkyBg(builder, calSkyBg);
    SOICalibration_Ingest.AddCalExtinctionCoeff(builder, calExtinctionCoeff);
    SOICalibration_Ingest.AddCalType(builder, calTypeOffset);
    SOICalibration_Ingest.AddCalTime(builder, calTimeOffset);
    SOICalibration_Ingest.AddCalNumCorrelatedStars(builder, calNumCorrelatedStars);
    SOICalibration_Ingest.AddCalNumDetectedStars(builder, calNumDetectedStars);
    return SOICalibration_Ingest.EndSOICalibration_Ingest(builder);
  }

  public static void StartSOICalibration_Ingest(FlatBufferBuilder builder) { builder.StartTable(11); }
  ...
  public static Offset<SOICalibration_Ingest> EndSOICalibration_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SOICalibration_Ingest>(o);
  }
  public static void FinishSOICalibration_IngestBuffer(FlatBufferBuilder builder, Offset<SOICalibration_Ingest> offset) { builder.Finish(offset.Value, "SOIC"); }
  public static void FinishSizePrefixedSOICalibration_IngestBuffer(FlatBufferBuilder builder, Offset<SOICalibration_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "SOIC"); }
  public SOICalibration_IngestT UnPack() {
    var _o = new SOICalibration_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SOICalibration_IngestT _o) {
  ...
  public static Offset<SOICalibration_Ingest> Pack(FlatBufferBuilder builder, SOICalibration_IngestT _o) {
    if (_o == null) return default(Offset<SOICalibration_Ingest>);
    ...
    return CreateSOICalibration_Ingest(
      builder,
...
public class SOICalibration_IngestT
{
  ...
  public static SOICalibration_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return SOICalibration_Ingest.GetRootAsSOICalibration_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SOICalibration_Ingest.FinishSOICalibration_IngestBuffer(fbb, SOICalibration_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SOICalibration_IngestVerify
{
