...
public struct GEOStatus_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static GEOStatus_Full GetRootAsGEOStatus_Full(ByteBuffer _bb) { return GetRootAsGEOStatus_Full(_bb, new GEOStatus_Full()); }
  public static GEOStatus_Full GetRootAsGEOStatus_Full(ByteBuffer _bb, GEOStatus_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool GEOStatus_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "GEOS"); }
  public static bool VerifyGEOStatus_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("GEOS", false, GEOStatus_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public GEOStatus_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public GEOStatus_Full_dataMode_Enum DataMode { get { int o = __p.__offset(50); return o != 0 ? (GEOStatus_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : GEOStatus_Full_dataMode_Enum.REAL; } }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string OnOrbit { get { int o = __p.__offset(52); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbitBytes() { return __p.__vector_as_span<byte>(52, 1); }
#else
  public ArraySegment<byte>? GetOnOrbitBytes() { return __p.__vector_as_arraysegment(52); }
#endif
  public byte[] GetOnOrbitArray() { return __p.__vector_as_array<byte>(52); }
  /// Satellite/catalog number of the target on-orbit object.
  /// Example: /// Example: 21
  /// Constraints: No constraints specified.
  public int SatNo { get { int o = __p.__offset(54); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  public static Offset<GEOStatus_Full> CreateGEOStatus_Full(FlatBufferBuilder builder,
      ...
      GEOStatus_Full_dataMode_Enum dataMode = GEOStatus_Full_dataMode_Enum.REAL,
      StringOffset onOrbitOffset = default(StringOffset),
      int satNo = 0,
      StringOffset origNetworkOffset = default(StringOffset)) {
    builder.StartTable(27);
    GEOStatus_Full.AddLongitudeMax(builder, longitudeMax);
    GEOStatus_Full.AddLongitudeMin(builder, longitudeMin);
    GEOStatus_Full.AddLongitudeRate(builder, longitudeRate);
    GEOStatus_Full.AddRelativeEnergy(builder, relativeEnergy);
    GEOStatus_Full.AddSc(builder, sc);
    GEOStatus_Full.AddSs(builder, ss);
    GEOStatus_Full.AddOrigNetwork(builder, origNetworkOffset);
    GEOStatus_Full.AddSatNo(builder, satNo);
    GEOStatus_Full.AddOnOrbit(builder, onOrbitOffset);
    GEOStatus_Full.AddOrigin(builder, originOffset);
    GEOStatus_Full.AddSource(builder, sourceOffset);
    GEOStatus_Full.AddUpdatedBy(builder, updatedByOffset);
    GEOStatus_Full.AddUpdatedAt(builder, updatedAtOffset);
    GEOStatus_Full.AddCreatedBy(builder, createdByOffset);
    GEOStatus_Full.AddCreatedAt(builder, createdAtOffset);
    GEOStatus_Full.AddRawFileURI(builder, rawFileURIOffset);
    GEOStatus_Full.AddObjectStatus(builder, objectStatusOffset);
    GEOStatus_Full.AddTroughType(builder, troughTypeOffset);
    GEOStatus_Full.AddPlaneChangeStatus(builder, planeChangeStatusOffset);
    GEOStatus_Full.AddConfidenceLevel(builder, confidenceLevelOffset);
    GEOStatus_Full.AddOrigObjectId(builder, origObjectIdOffset);
    GEOStatus_Full.AddIdOnOrbit(builder, idOnOrbitOffset);
    GEOStatus_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    GEOStatus_Full.AddId(builder, idOffset);
    GEOStatus_Full.AddDataMode(builder, dataMode);
    GEOStatus_Full.AddSemiAnnualCorrFlag(builder, semiAnnualCorrFlag);
    GEOStatus_Full.AddLostFlag(builder, lostFlag);
    return GEOStatus_Full.EndGEOStatus_Full(builder);
  }

  public static void StartGEOStatus_Full(FlatBufferBuilder builder) { builder.StartTable(27); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, GEOStatus_Full_dataMode_Enum dataMode) { builder.AddSbyte(23, (sbyte)dataMode, 0); }
  public static void AddOnOrbit(FlatBufferBuilder builder, StringOffset onOrbitOffset) { builder.AddOffset(24, onOrbitOffset.Value, 0); }
  public static void AddSatNo(FlatBufferBuilder builder, int satNo) { builder.AddInt(25, satNo, 0); }
  ...
  public static Offset<GEOStatus_Full> EndGEOStatus_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<GEOStatus_Full>(o);
  }
  public static void FinishGEOStatus_FullBuffer(FlatBufferBuilder builder, Offset<GEOStatus_Full> offset) { builder.Finish(offset.Value, "GEOS"); }
  public static void FinishSizePrefixedGEOStatus_FullBuffer(FlatBufferBuilder builder, Offset<GEOStatus_Full> offset) { builder.FinishSizePrefixed(offset.Value, "GEOS"); }
  public GEOStatus_FullT UnPack() {
    var _o = new GEOStatus_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(GEOStatus_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<GEOStatus_Full> Pack(FlatBufferBuilder builder, GEOStatus_FullT _o) {
    if (_o == null) return default(Offset<GEOStatus_Full>);
...
public class GEOStatus_FullT
{
  ...
  public GEOStatus_Full_dataMode_Enum DataMode { get; set; }
  public string OnOrbit { get; set; }
  public int SatNo { get; set; }
  public string OrigNetwork { get; set; }

  public GEOStatus_FullT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = GEOStatus_Full_dataMode_Enum.REAL;
    this.OnOrbit = null;
    this.SatNo = 0;
    this.OrigNetwork = null;
  }
  public static GEOStatus_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return GEOStatus_Full.GetRootAsGEOStatus_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    GEOStatus_Full.FinishGEOStatus_FullBuffer(fbb, GEOStatus_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class GEOStatus_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 50 /*DataMode*/, 1 /*GEOStatus_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 52 /*OnOrbit*/, false)
      && verifier.VerifyField(tablePos, 54 /*SatNo*/, 4 /*int*/, 4, false)
