...
public struct LogisticsSegments_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static LogisticsSegments_Full GetRootAsLogisticsSegments_Full(ByteBuffer _bb, LogisticsSegments_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LogisticsSegments_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LOGI"); }
  public static bool VerifyLogisticsSegments_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LOGI", false, LogisticsSegments_FullVerify.Verify); }
  ...
  public static Offset<LogisticsSegments_Full> CreateLogisticsSegments_Full(FlatBufferBuilder builder,
      int segmentNumber = 0,
  ...
  public static Offset<LogisticsSegments_Full> EndLogisticsSegments_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LogisticsSegments_Full>(o);
  }
  public static void FinishLogisticsSegments_FullBuffer(FlatBufferBuilder builder, Offset<LogisticsSegments_Full> offset) { builder.Finish(offset.Value, "LOGI"); }
  public static void FinishSizePrefixedLogisticsSegments_FullBuffer(FlatBufferBuilder builder, Offset<LogisticsSegments_Full> offset) { builder.FinishSizePrefixed(offset.Value, "LOGI"); }
  public LogisticsSegments_FullT UnPack() {
    var _o = new LogisticsSegments_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LogisticsSegments_FullT _o) {
  ...
  public static Offset<LogisticsSegments_Full> Pack(FlatBufferBuilder builder, LogisticsSegments_FullT _o) {
    if (_o == null) return default(Offset<LogisticsSegments_Full>);
...
public class LogisticsSegments_FullT
{
  ...
  public LogisticsSegments_FullT() {
  ...
  public static LogisticsSegments_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return LogisticsSegments_Full.GetRootAsLogisticsSegments_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LogisticsSegments_Full.FinishLogisticsSegments_FullBuffer(fbb, LogisticsSegments_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LogisticsSegments_FullVerify
{
