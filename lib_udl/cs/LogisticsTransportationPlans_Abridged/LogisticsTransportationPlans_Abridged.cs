...
public struct LogisticsTransportationPlans_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static LogisticsTransportationPlans_Abridged GetRootAsLogisticsTransportationPlans_Abridged(ByteBuffer _bb) { return GetRootAsLogisticsTransportationPlans_Abridged(_bb, new LogisticsTransportationPlans_Abridged()); }
  public static LogisticsTransportationPlans_Abridged GetRootAsLogisticsTransportationPlans_Abridged(ByteBuffer _bb, LogisticsTransportationPlans_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LogisticsTransportationPlans_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LOGI"); }
  public static bool VerifyLogisticsTransportationPlans_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LOGI", false, LogisticsTransportationPlans_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public LogisticsTransportationPlans_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<LogisticsTransportationPlans_Abridged> CreateLogisticsTransportationPlans_Abridged(FlatBufferBuilder builder,
    ...
    LogisticsTransportationPlans_Abridged.AddLogisticsTransportationPlansRemarks(builder, logisticsTransportationPlansRemarksOffset);
    LogisticsTransportationPlans_Abridged.AddLogisticsSegments(builder, logisticsSegmentsOffset);
    LogisticsTransportationPlans_Abridged.AddLastChangedDate(builder, lastChangedDateOffset);
    LogisticsTransportationPlans_Abridged.AddNumTransLoads(builder, numTransLoads);
    LogisticsTransportationPlans_Abridged.AddSerialNumber(builder, serialNumberOffset);
    LogisticsTransportationPlans_Abridged.AddNumEnrouteStops(builder, numEnrouteStops);
    LogisticsTransportationPlans_Abridged.AddAircraftStatus(builder, aircraftStatusOffset);
    LogisticsTransportationPlans_Abridged.AddCancelledDate(builder, cancelledDateOffset);
    LogisticsTransportationPlans_Abridged.AddClosedDate(builder, closedDateOffset);
    LogisticsTransportationPlans_Abridged.AddActDepTime(builder, actDepTimeOffset);
    LogisticsTransportationPlans_Abridged.AddDuration(builder, durationOffset);
    LogisticsTransportationPlans_Abridged.AddApproxArrTime(builder, approxArrTimeOffset);
    LogisticsTransportationPlans_Abridged.AddMajcom(builder, majcomOffset);
    LogisticsTransportationPlans_Abridged.AddTpAircraftMDS(builder, tpAircraftMDSOffset);
    LogisticsTransportationPlans_Abridged.AddTpTailNumber(builder, tpTailNumberOffset);
    LogisticsTransportationPlans_Abridged.AddLogisticMasterRecordId(builder, logisticMasterRecordIdOffset);
    LogisticsTransportationPlans_Abridged.AddDestinationICAO(builder, destinationICAOOffset);
    LogisticsTransportationPlans_Abridged.AddEstArrTime(builder, estArrTimeOffset);
    LogisticsTransportationPlans_Abridged.AddEstDepTime(builder, estDepTimeOffset);
    LogisticsTransportationPlans_Abridged.AddOriginICAO(builder, originICAOOffset);
    LogisticsTransportationPlans_Abridged.AddCoordinatorUnit(builder, coordinatorUnitOffset);
    LogisticsTransportationPlans_Abridged.AddCoordinator(builder, coordinatorOffset);
    LogisticsTransportationPlans_Abridged.AddStatusCode(builder, statusCodeOffset);
    LogisticsTransportationPlans_Abridged.AddPlanDefinition(builder, planDefinitionOffset);
    LogisticsTransportationPlans_Abridged.AddPlansNumber(builder, plansNumberOffset);
    LogisticsTransportationPlans_Abridged.AddMissionChange(builder, missionChange);
    return LogisticsTransportationPlans_Abridged.EndLogisticsTransportationPlans_Abridged(builder);
  }

  public static void StartLogisticsTransportationPlans_Abridged(FlatBufferBuilder builder) { builder.StartTable(26); }
  ...
  public static Offset<LogisticsTransportationPlans_Abridged> EndLogisticsTransportationPlans_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LogisticsTransportationPlans_Abridged>(o);
  }
  public static void FinishLogisticsTransportationPlans_AbridgedBuffer(FlatBufferBuilder builder, Offset<LogisticsTransportationPlans_Abridged> offset) { builder.Finish(offset.Value, "LOGI"); }
  public static void FinishSizePrefixedLogisticsTransportationPlans_AbridgedBuffer(FlatBufferBuilder builder, Offset<LogisticsTransportationPlans_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "LOGI"); }
  public LogisticsTransportationPlans_AbridgedT UnPack() {
    var _o = new LogisticsTransportationPlans_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LogisticsTransportationPlans_AbridgedT _o) {
  ...
  public static Offset<LogisticsTransportationPlans_Abridged> Pack(FlatBufferBuilder builder, LogisticsTransportationPlans_AbridgedT _o) {
    if (_o == null) return default(Offset<LogisticsTransportationPlans_Abridged>);
...
public class LogisticsTransportationPlans_AbridgedT
{
  ...
  public LogisticsTransportationPlans_AbridgedT() {
  ...
  public static LogisticsTransportationPlans_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return LogisticsTransportationPlans_Abridged.GetRootAsLogisticsTransportationPlans_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LogisticsTransportationPlans_Abridged.FinishLogisticsTransportationPlans_AbridgedBuffer(fbb, LogisticsTransportationPlans_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LogisticsTransportationPlans_AbridgedVerify
{
