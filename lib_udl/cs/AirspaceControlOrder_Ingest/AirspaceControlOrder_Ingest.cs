...
public struct AirspaceControlOrder_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirspaceControlOrder_Ingest GetRootAsAirspaceControlOrder_Ingest(ByteBuffer _bb) { return GetRootAsAirspaceControlOrder_Ingest(_bb, new AirspaceControlOrder_Ingest()); }
  public static AirspaceControlOrder_Ingest GetRootAsAirspaceControlOrder_Ingest(ByteBuffer _bb, AirspaceControlOrder_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirspaceControlOrder_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRS"); }
  public static bool VerifyAirspaceControlOrder_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRS", false, AirspaceControlOrder_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirspaceControlOrder_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public AirspaceControlOrder_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(68); return o != 0 ? (AirspaceControlOrder_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirspaceControlOrder_Ingest_dataMode_Enum.REAL; } }

  public static Offset<AirspaceControlOrder_Ingest> CreateAirspaceControlOrder_Ingest(FlatBufferBuilder builder,
      ...
      AirspaceControlOrder_Ingest_dataMode_Enum dataMode = AirspaceControlOrder_Ingest_dataMode_Enum.REAL) {
  ...
  public static void StartAirspaceControlOrder_Ingest(FlatBufferBuilder builder) { builder.StartTable(33); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AirspaceControlOrder_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(32, (sbyte)dataMode, 0); }
  public static Offset<AirspaceControlOrder_Ingest> EndAirspaceControlOrder_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirspaceControlOrder_Ingest>(o);
  }
  public static void FinishAirspaceControlOrder_IngestBuffer(FlatBufferBuilder builder, Offset<AirspaceControlOrder_Ingest> offset) { builder.Finish(offset.Value, "AIRS"); }
  public static void FinishSizePrefixedAirspaceControlOrder_IngestBuffer(FlatBufferBuilder builder, Offset<AirspaceControlOrder_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AIRS"); }
  public AirspaceControlOrder_IngestT UnPack() {
    var _o = new AirspaceControlOrder_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirspaceControlOrder_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AirspaceControlOrder_Ingest> Pack(FlatBufferBuilder builder, AirspaceControlOrder_IngestT _o) {
    if (_o == null) return default(Offset<AirspaceControlOrder_Ingest>);
...
public class AirspaceControlOrder_IngestT
{
  ...
  public AirspaceControlOrder_Ingest_dataMode_Enum DataMode { get; set; }

  public AirspaceControlOrder_IngestT() {
    this.Id = null;
    ...
    this.DataMode = AirspaceControlOrder_Ingest_dataMode_Enum.REAL;
  }
  public static AirspaceControlOrder_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AirspaceControlOrder_Ingest.GetRootAsAirspaceControlOrder_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirspaceControlOrder_Ingest.FinishAirspaceControlOrder_IngestBuffer(fbb, AirspaceControlOrder_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirspaceControlOrder_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 68 /*DataMode*/, 1 /*AirspaceControlOrder_Ingest_dataMode_Enum*/, 1, false)
