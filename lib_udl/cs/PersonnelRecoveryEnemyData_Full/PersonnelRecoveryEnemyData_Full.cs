...
public struct PersonnelRecoveryEnemyData_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static PersonnelRecoveryEnemyData_Full GetRootAsPersonnelRecoveryEnemyData_Full(ByteBuffer _bb) { return GetRootAsPersonnelRecoveryEnemyData_Full(_bb, new PersonnelRecoveryEnemyData_Full()); }
  public static PersonnelRecoveryEnemyData_Full GetRootAsPersonnelRecoveryEnemyData_Full(ByteBuffer _bb, PersonnelRecoveryEnemyData_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool PersonnelRecoveryEnemyData_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "PERS"); }
  public static bool VerifyPersonnelRecoveryEnemyData_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("PERS", false, PersonnelRecoveryEnemyData_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public PersonnelRecoveryEnemyData_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<PersonnelRecoveryEnemyData_Full> CreatePersonnelRecoveryEnemyData_Full(FlatBufferBuilder builder,
  ...
  public static void StartPersonnelRecoveryEnemyData_Full(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<PersonnelRecoveryEnemyData_Full> EndPersonnelRecoveryEnemyData_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PersonnelRecoveryEnemyData_Full>(o);
  }
  public static void FinishPersonnelRecoveryEnemyData_FullBuffer(FlatBufferBuilder builder, Offset<PersonnelRecoveryEnemyData_Full> offset) { builder.Finish(offset.Value, "PERS"); }
  public static void FinishSizePrefixedPersonnelRecoveryEnemyData_FullBuffer(FlatBufferBuilder builder, Offset<PersonnelRecoveryEnemyData_Full> offset) { builder.FinishSizePrefixed(offset.Value, "PERS"); }
  public PersonnelRecoveryEnemyData_FullT UnPack() {
    var _o = new PersonnelRecoveryEnemyData_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(PersonnelRecoveryEnemyData_FullT _o) {
  ...
  public static Offset<PersonnelRecoveryEnemyData_Full> Pack(FlatBufferBuilder builder, PersonnelRecoveryEnemyData_FullT _o) {
    if (_o == null) return default(Offset<PersonnelRecoveryEnemyData_Full>);
...
public class PersonnelRecoveryEnemyData_FullT
{
  ...
  public PersonnelRecoveryEnemyData_FullT() {
    this.DirToEnemy = null;
    this.HostileFireType = null;
    this.FriendliesRemarks = null;
    this.HlzRemarks = null;
  }
  public static PersonnelRecoveryEnemyData_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return PersonnelRecoveryEnemyData_Full.GetRootAsPersonnelRecoveryEnemyData_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    PersonnelRecoveryEnemyData_Full.FinishPersonnelRecoveryEnemyData_FullBuffer(fbb, PersonnelRecoveryEnemyData_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class PersonnelRecoveryEnemyData_FullVerify
{
