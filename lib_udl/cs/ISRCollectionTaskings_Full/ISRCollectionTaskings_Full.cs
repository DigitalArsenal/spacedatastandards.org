...
public struct ISRCollectionTaskings_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static ISRCollectionTaskings_Full GetRootAsISRCollectionTaskings_Full(ByteBuffer _bb) { return GetRootAsISRCollectionTaskings_Full(_bb, new ISRCollectionTaskings_Full()); }
  public static ISRCollectionTaskings_Full GetRootAsISRCollectionTaskings_Full(ByteBuffer _bb, ISRCollectionTaskings_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool ISRCollectionTaskings_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ISRC"); }
  public static bool VerifyISRCollectionTaskings_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ISRC", false, ISRCollectionTaskings_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ISRCollectionTaskings_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public ISRCollectionTaskings_Full_type_Enum Type { get { int o = __p.__offset(6); return o != 0 ? (ISRCollectionTaskings_Full_type_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : ISRCollectionTaskings_Full_type_Enum.DELIBERATE; } }
  /// Type of collection tasked.
  /// Example: /// Example: Simultaneous
  /// Constraints: Minimum length = 1, Maximum length = 16
  public ISRCollectionTaskings_Full_collectionType_Enum CollectionType { get { int o = __p.__offset(8); return o != 0 ? (ISRCollectionTaskings_Full_collectionType_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : ISRCollectionTaskings_Full_collectionType_Enum.SIMULTANEOUS; } }
  ...
  public static Offset<ISRCollectionTaskings_Full> CreateISRCollectionTaskings_Full(FlatBufferBuilder builder,
      StringOffset idOffset = default(StringOffset),
      ISRCollectionTaskings_Full_type_Enum type = ISRCollectionTaskings_Full_type_Enum.DELIBERATE,
      ISRCollectionTaskings_Full_collectionType_Enum collectionType = ISRCollectionTaskings_Full_collectionType_Enum.SIMULTANEOUS,
    ...
    ISRCollectionTaskings_Full.AddTaskingStartPointLong(builder, taskingStartPointLong);
    ISRCollectionTaskings_Full.AddTaskingStartPointLat(builder, taskingStartPointLat);
    ISRCollectionTaskings_Full.AddTaskingPriority(builder, taskingPriority);
    ISRCollectionTaskings_Full.AddTaskingCollectionRequirements(builder, taskingCollectionRequirementsOffset);
    ISRCollectionTaskings_Full.AddCollectionPeriods(builder, collectionPeriodsOffset);
    ISRCollectionTaskings_Full.AddSpecialComGuidance(builder, specialComGuidanceOffset);
    ISRCollectionTaskings_Full.AddSroTrack(builder, sroTrackOffset);
    ISRCollectionTaskings_Full.AddTaskingSubRegion(builder, taskingSubRegionOffset);
    ISRCollectionTaskings_Full.AddTaskingRegion(builder, taskingRegionOffset);
    ISRCollectionTaskings_Full.AddTaskingCountry(builder, taskingCountryOffset);
    ISRCollectionTaskings_Full.AddTaskingSyncMatrixBin(builder, taskingSyncMatrixBinOffset);
    ISRCollectionTaskings_Full.AddTaskingJoa(builder, taskingJoaOffset);
    ISRCollectionTaskings_Full.AddTaskingCollectionArea(builder, taskingCollectionAreaOffset);
    ISRCollectionTaskings_Full.AddTaskingRetaskTime(builder, taskingRetaskTimeOffset);
    ISRCollectionTaskings_Full.AddTaskingEmphasis(builder, taskingEmphasisOffset);
    ISRCollectionTaskings_Full.AddTaskingSupportedUnit(builder, taskingSupportedUnitOffset);
    ISRCollectionTaskings_Full.AddTaskingOperation(builder, taskingOperationOffset);
    ISRCollectionTaskings_Full.AddTaskingRole(builder, taskingRoleOffset);
    ISRCollectionTaskings_Full.AddTaskingSecondarySubCategory(builder, taskingSecondarySubCategoryOffset);
    ISRCollectionTaskings_Full.AddTaskingSecondaryIntelDiscipline(builder, taskingSecondaryIntelDisciplineOffset);
    ISRCollectionTaskings_Full.AddTaskingPrimarySubCategory(builder, taskingPrimarySubCategoryOffset);
    ISRCollectionTaskings_Full.AddTaskingPrimaryIntelDiscipline(builder, taskingPrimaryIntelDisciplineOffset);
    ISRCollectionTaskings_Full.AddEightLine(builder, eightLineOffset);
    ISRCollectionTaskings_Full.AddTaskingAOR(builder, taskingAOROffset);
    ISRCollectionTaskings_Full.AddId(builder, idOffset);
    ISRCollectionTaskings_Full.AddCollectionType(builder, collectionType);
    ISRCollectionTaskings_Full.AddType(builder, type);
    return ISRCollectionTaskings_Full.EndISRCollectionTaskings_Full(builder);
  }

  public static void StartISRCollectionTaskings_Full(FlatBufferBuilder builder) { builder.StartTable(27); }
  public static void AddId(FlatBufferBuilder builder, StringOffset idOffset) { builder.AddOffset(0, idOffset.Value, 0); }
  public static void AddType(FlatBufferBuilder builder, ISRCollectionTaskings_Full_type_Enum type) { builder.AddSbyte(1, (sbyte)type, 0); }
  public static void AddCollectionType(FlatBufferBuilder builder, ISRCollectionTaskings_Full_collectionType_Enum collectionType) { builder.AddSbyte(2, (sbyte)collectionType, 0); }
  ...
  public static Offset<ISRCollectionTaskings_Full> EndISRCollectionTaskings_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ISRCollectionTaskings_Full>(o);
  }
  public static void FinishISRCollectionTaskings_FullBuffer(FlatBufferBuilder builder, Offset<ISRCollectionTaskings_Full> offset) { builder.Finish(offset.Value, "ISRC"); }
  public static void FinishSizePrefixedISRCollectionTaskings_FullBuffer(FlatBufferBuilder builder, Offset<ISRCollectionTaskings_Full> offset) { builder.FinishSizePrefixed(offset.Value, "ISRC"); }
  public ISRCollectionTaskings_FullT UnPack() {
    var _o = new ISRCollectionTaskings_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(ISRCollectionTaskings_FullT _o) {
    _o.Id = this.Id;
    _o.Type = this.Type;
  ...
  public static Offset<ISRCollectionTaskings_Full> Pack(FlatBufferBuilder builder, ISRCollectionTaskings_FullT _o) {
    if (_o == null) return default(Offset<ISRCollectionTaskings_Full>);
...
public class ISRCollectionTaskings_FullT
{
  public string Id { get; set; }
  public ISRCollectionTaskings_Full_type_Enum Type { get; set; }
  public ISRCollectionTaskings_Full_collectionType_Enum CollectionType { get; set; }
  ...
  public ISRCollectionTaskings_FullT() {
    this.Id = null;
    this.Type = ISRCollectionTaskings_Full_type_Enum.DELIBERATE;
    this.CollectionType = ISRCollectionTaskings_Full_collectionType_Enum.SIMULTANEOUS;
  ...
  public static ISRCollectionTaskings_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return ISRCollectionTaskings_Full.GetRootAsISRCollectionTaskings_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    ISRCollectionTaskings_Full.FinishISRCollectionTaskings_FullBuffer(fbb, ISRCollectionTaskings_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class ISRCollectionTaskings_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyString(tablePos, 4 /*Id*/, false)
      && verifier.VerifyField(tablePos, 6 /*Type*/, 1 /*ISRCollectionTaskings_Full_type_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 8 /*CollectionType*/, 1 /*ISRCollectionTaskings_Full_collectionType_Enum*/, 1, false)
