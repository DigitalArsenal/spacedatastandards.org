...
public struct Surface_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Surface_Full GetRootAsSurface_Full(ByteBuffer _bb) { return GetRootAsSurface_Full(_bb, new Surface_Full()); }
  public static Surface_Full GetRootAsSurface_Full(ByteBuffer _bb, Surface_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Surface_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SURF"); }
  public static bool VerifySurface_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SURF", false, Surface_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Surface_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Surface_Full_dataMode_Enum DataMode { get { int o = __p.__offset(110); return o != 0 ? (Surface_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Surface_Full_dataMode_Enum.REAL; } }

  public static Offset<Surface_Full> CreateSurface_Full(FlatBufferBuilder builder,
      ...
      Surface_Full_dataMode_Enum dataMode = Surface_Full_dataMode_Enum.REAL) {
  ...
  public static void StartSurface_Full(FlatBufferBuilder builder) { builder.StartTable(54); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Surface_Full_dataMode_Enum dataMode) { builder.AddSbyte(53, (sbyte)dataMode, 0); }
  public static Offset<Surface_Full> EndSurface_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Surface_Full>(o);
  }
  public static void FinishSurface_FullBuffer(FlatBufferBuilder builder, Offset<Surface_Full> offset) { builder.Finish(offset.Value, "SURF"); }
  public static void FinishSizePrefixedSurface_FullBuffer(FlatBufferBuilder builder, Offset<Surface_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SURF"); }
  public Surface_FullT UnPack() {
    var _o = new Surface_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Surface_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Surface_Full> Pack(FlatBufferBuilder builder, Surface_FullT _o) {
    if (_o == null) return default(Offset<Surface_Full>);
...
public class Surface_FullT
{
  ...
  public Surface_Full_dataMode_Enum DataMode { get; set; }

  public Surface_FullT() {
    this.Id = null;
    ...
    this.DataMode = Surface_Full_dataMode_Enum.REAL;
  }
  public static Surface_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Surface_Full.GetRootAsSurface_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Surface_Full.FinishSurface_FullBuffer(fbb, Surface_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Surface_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 110 /*DataMode*/, 1 /*Surface_Full_dataMode_Enum*/, 1, false)
