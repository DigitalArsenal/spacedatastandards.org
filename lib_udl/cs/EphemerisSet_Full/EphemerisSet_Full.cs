...
public struct EphemerisSet_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EphemerisSet_Full GetRootAsEphemerisSet_Full(ByteBuffer _bb) { return GetRootAsEphemerisSet_Full(_bb, new EphemerisSet_Full()); }
  public static EphemerisSet_Full GetRootAsEphemerisSet_Full(ByteBuffer _bb, EphemerisSet_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EphemerisSet_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EPHE"); }
  public static bool VerifyEphemerisSet_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EPHE", false, EphemerisSet_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EphemerisSet_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 24
  public EphemerisSet_Full_referenceFrame_Enum ReferenceFrame { get { int o = __p.__offset(68); return o != 0 ? (EphemerisSet_Full_referenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EphemerisSet_Full_referenceFrame_Enum.J2000; } }
  /// The reference frame of the covariance matrix elements. If the covReferenceFrame is null it is assumed to be J2000.
  /// Example: /// Example: J2000
  /// Constraints: Minimum length = 0, Maximum length = 24
  public EphemerisSet_Full_covReferenceFrame_Enum CovReferenceFrame { get { int o = __p.__offset(70); return o != 0 ? (EphemerisSet_Full_covReferenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EphemerisSet_Full_covReferenceFrame_Enum.J2000; } }
  ...
  public EphemerisSet_Full_dataMode_Enum DataMode { get { int o = __p.__offset(80); return o != 0 ? (EphemerisSet_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EphemerisSet_Full_dataMode_Enum.REAL; } }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string StateVector { get { int o = __p.__offset(82); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetStateVectorBytes() { return __p.__vector_as_span<byte>(82, 1); }
#else
  public ArraySegment<byte>? GetStateVectorBytes() { return __p.__vector_as_arraysegment(82); }
#endif
  public byte[] GetStateVectorArray() { return __p.__vector_as_array<byte>(82); }
  /// Satellite/catalog number of the target on-orbit object.
  /// Example: /// Example: 2
  /// Constraints: No constraints specified.
  public int SatNo { get { int o = __p.__offset(84); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string EphemerisList(int j) { int o = __p.__offset(86); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int EphemerisListLength { get { int o = __p.__offset(86); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string OnOrbit { get { int o = __p.__offset(88); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbitBytes() { return __p.__vector_as_span<byte>(88, 1); }
#else
  public ArraySegment<byte>? GetOnOrbitBytes() { return __p.__vector_as_arraysegment(88); }
#endif
  public byte[] GetOnOrbitArray() { return __p.__vector_as_array<byte>(88); }
  /// Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
  /// Example: /// Example: ['PROVIDER_TAG1', 'PROVIDER_TAG2']
  /// Constraints: No constraints specified.
  public string Tags(int j) { int o = __p.__offset(90); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int TagsLength { get { int o = __p.__offset(90); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Optional identifier to track a commercial or marketplace transaction executed to produce this data.
  /// Example: /// Example: TRANSACTION-ID
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string TransactionId { get { int o = __p.__offset(92); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTransactionIdBytes() { return __p.__vector_as_span<byte>(92, 1); }
#else
  public ArraySegment<byte>? GetTransactionIdBytes() { return __p.__vector_as_arraysegment(92); }
#endif
  public byte[] GetTransactionIdArray() { return __p.__vector_as_array<byte>(92); }
  ...
  public static Offset<EphemerisSet_Full> CreateEphemerisSet_Full(FlatBufferBuilder builder,
      ...
      EphemerisSet_Full_referenceFrame_Enum referenceFrame = EphemerisSet_Full_referenceFrame_Enum.J2000,
      EphemerisSet_Full_covReferenceFrame_Enum covReferenceFrame = EphemerisSet_Full_covReferenceFrame_Enum.J2000,
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset),
      StringOffset sourceOffset = default(StringOffset),
      StringOffset originOffset = default(StringOffset),
      EphemerisSet_Full_dataMode_Enum dataMode = EphemerisSet_Full_dataMode_Enum.REAL,
      StringOffset stateVectorOffset = default(StringOffset),
      int satNo = 0,
      VectorOffset ephemerisListOffset = default(VectorOffset),
    ...
    EphemerisSet_Full.AddEdr(builder, edr);
    EphemerisSet_Full.AddBDot(builder, bDot);
    EphemerisSet_Full.AddOrigNetwork(builder, origNetworkOffset);
    EphemerisSet_Full.AddTransactionId(builder, transactionIdOffset);
    EphemerisSet_Full.AddTags(builder, tagsOffset);
    EphemerisSet_Full.AddOnOrbit(builder, onOrbitOffset);
    EphemerisSet_Full.AddEphemerisList(builder, ephemerisListOffset);
    EphemerisSet_Full.AddSatNo(builder, satNo);
    EphemerisSet_Full.AddStateVector(builder, stateVectorOffset);
    EphemerisSet_Full.AddOrigin(builder, originOffset);
    EphemerisSet_Full.AddSource(builder, sourceOffset);
    EphemerisSet_Full.AddCreatedBy(builder, createdByOffset);
    EphemerisSet_Full.AddCreatedAt(builder, createdAtOffset);
    EphemerisSet_Full.AddDescriptor(builder, descriptorOffset);
    EphemerisSet_Full.AddDescription(builder, descriptionOffset);
    EphemerisSet_Full.AddComments(builder, commentsOffset);
    EphemerisSet_Full.AddFilename(builder, filenameOffset);
    EphemerisSet_Full.AddInterpolationDegree(builder, interpolationDegree);
    EphemerisSet_Full.AddInterpolation(builder, interpolationOffset);
    EphemerisSet_Full.AddDragModel(builder, dragModelOffset);
    EphemerisSet_Full.AddGeopotentialModel(builder, geopotentialModelOffset);
    EphemerisSet_Full.AddIntegrator(builder, integratorOffset);
    EphemerisSet_Full.AddCentBody(builder, centBodyOffset);
    EphemerisSet_Full.AddIdManeuvers(builder, idManeuversOffset);
    EphemerisSet_Full.AddIdStateVector(builder, idStateVectorOffset);
    EphemerisSet_Full.AddCategory(builder, categoryOffset);
    EphemerisSet_Full.AddPedigree(builder, pedigreeOffset);
    EphemerisSet_Full.AddType(builder, typeOffset);
    EphemerisSet_Full.AddNumPoints(builder, numPoints);
    EphemerisSet_Full.AddStepSize(builder, stepSize);
    EphemerisSet_Full.AddUsableEndTime(builder, usableEndTimeOffset);
    EphemerisSet_Full.AddPointEndTime(builder, pointEndTimeOffset);
    EphemerisSet_Full.AddUsableStartTime(builder, usableStartTimeOffset);
    EphemerisSet_Full.AddPointStartTime(builder, pointStartTimeOffset);
    EphemerisSet_Full.AddOrigObjectId(builder, origObjectIdOffset);
    EphemerisSet_Full.AddIdOnOrbit(builder, idOnOrbitOffset);
    EphemerisSet_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    EphemerisSet_Full.AddId(builder, idOffset);
    EphemerisSet_Full.AddDataMode(builder, dataMode);
    EphemerisSet_Full.AddCovReferenceFrame(builder, covReferenceFrame);
    EphemerisSet_Full.AddReferenceFrame(builder, referenceFrame);
    EphemerisSet_Full.AddSolidEarthTides(builder, solidEarthTides);
    EphemerisSet_Full.AddLunarSolar(builder, lunarSolar);
    EphemerisSet_Full.AddHasAccel(builder, hasAccel);
    EphemerisSet_Full.AddHasCov(builder, hasCov);
    EphemerisSet_Full.AddHasMnvr(builder, hasMnvr);
    return EphemerisSet_Full.EndEphemerisSet_Full(builder);
  }

  public static void StartEphemerisSet_Full(FlatBufferBuilder builder) { builder.StartTable(46); }
  ...
  public static void AddReferenceFrame(FlatBufferBuilder builder, EphemerisSet_Full_referenceFrame_Enum referenceFrame) { builder.AddSbyte(32, (sbyte)referenceFrame, 0); }
  public static void AddCovReferenceFrame(FlatBufferBuilder builder, EphemerisSet_Full_covReferenceFrame_Enum covReferenceFrame) { builder.AddSbyte(33, (sbyte)covReferenceFrame, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, EphemerisSet_Full_dataMode_Enum dataMode) { builder.AddSbyte(38, (sbyte)dataMode, 0); }
  public static void AddStateVector(FlatBufferBuilder builder, StringOffset stateVectorOffset) { builder.AddOffset(39, stateVectorOffset.Value, 0); }
  public static void AddSatNo(FlatBufferBuilder builder, int satNo) { builder.AddInt(40, satNo, 0); }
  public static void AddEphemerisList(FlatBufferBuilder builder, VectorOffset ephemerisListOffset) { builder.AddOffset(41, ephemerisListOffset.Value, 0); }
  public static VectorOffset CreateEphemerisListVector(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateEphemerisListVectorBlock(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEphemerisListVectorBlock(FlatBufferBuilder builder, ArraySegment<StringOffset> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEphemerisListVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<StringOffset>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartEphemerisListVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddOnOrbit(FlatBufferBuilder builder, StringOffset onOrbitOffset) { builder.AddOffset(42, onOrbitOffset.Value, 0); }
  public static void AddTags(FlatBufferBuilder builder, VectorOffset tagsOffset) { builder.AddOffset(43, tagsOffset.Value, 0); }
  ...
  public static void AddTransactionId(FlatBufferBuilder builder, StringOffset transactionIdOffset) { builder.AddOffset(44, transactionIdOffset.Value, 0); }
  ...
  public static Offset<EphemerisSet_Full> EndEphemerisSet_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EphemerisSet_Full>(o);
  }
  public static void FinishEphemerisSet_FullBuffer(FlatBufferBuilder builder, Offset<EphemerisSet_Full> offset) { builder.Finish(offset.Value, "EPHE"); }
  public static void FinishSizePrefixedEphemerisSet_FullBuffer(FlatBufferBuilder builder, Offset<EphemerisSet_Full> offset) { builder.FinishSizePrefixed(offset.Value, "EPHE"); }
  public EphemerisSet_FullT UnPack() {
    var _o = new EphemerisSet_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EphemerisSet_FullT _o) {
    _o.Id = this.Id;
    ...
    _o.SatNo = this.SatNo;
    _o.EphemerisList = new List<string>();
    for (var _j = 0; _j < this.EphemerisListLength; ++_j) {_o.EphemerisList.Add(this.EphemerisList(_j));}
  ...
  public static Offset<EphemerisSet_Full> Pack(FlatBufferBuilder builder, EphemerisSet_FullT _o) {
    if (_o == null) return default(Offset<EphemerisSet_Full>);
    ...
    var _ephemerisList = default(VectorOffset);
    if (_o.EphemerisList != null) {
      var __ephemerisList = new StringOffset[_o.EphemerisList.Count];
      for (var _j = 0; _j < __ephemerisList.Length; ++_j) { __ephemerisList[_j] = builder.CreateString(_o.EphemerisList[_j]); }
      _ephemerisList = CreateEphemerisListVector(builder, __ephemerisList);
    }
    ...
    return CreateEphemerisSet_Full(
      builder,
      _id,
...
public class EphemerisSet_FullT
{
  ...
  public EphemerisSet_Full_referenceFrame_Enum ReferenceFrame { get; set; }
  public EphemerisSet_Full_covReferenceFrame_Enum CovReferenceFrame { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string Source { get; set; }
  public string Origin { get; set; }
  public EphemerisSet_Full_dataMode_Enum DataMode { get; set; }
  public string StateVector { get; set; }
  public int SatNo { get; set; }
  public List<string> EphemerisList { get; set; }
  public string OnOrbit { get; set; }
  public List<string> Tags { get; set; }
  public string TransactionId { get; set; }
  public string OrigNetwork { get; set; }

  public EphemerisSet_FullT() {
    this.Id = null;
    ...
    this.ReferenceFrame = EphemerisSet_Full_referenceFrame_Enum.J2000;
    this.CovReferenceFrame = EphemerisSet_Full_covReferenceFrame_Enum.J2000;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.Source = null;
    this.Origin = null;
    this.DataMode = EphemerisSet_Full_dataMode_Enum.REAL;
    this.StateVector = null;
    this.SatNo = 0;
    this.EphemerisList = null;
    this.OnOrbit = null;
    this.Tags = null;
    this.TransactionId = null;
    this.OrigNetwork = null;
  }
  public static EphemerisSet_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return EphemerisSet_Full.GetRootAsEphemerisSet_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EphemerisSet_Full.FinishEphemerisSet_FullBuffer(fbb, EphemerisSet_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EphemerisSet_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 68 /*ReferenceFrame*/, 1 /*EphemerisSet_Full_referenceFrame_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 70 /*CovReferenceFrame*/, 1 /*EphemerisSet_Full_covReferenceFrame_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 80 /*DataMode*/, 1 /*EphemerisSet_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 82 /*StateVector*/, false)
      && verifier.VerifyField(tablePos, 84 /*SatNo*/, 4 /*int*/, 4, false)
      && verifier.VerifyVectorOfStrings(tablePos, 86 /*EphemerisList*/, false)
      && verifier.VerifyString(tablePos, 88 /*OnOrbit*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 90 /*Tags*/, false)
      && verifier.VerifyString(tablePos, 92 /*TransactionId*/, false)
