...
public struct AircraftMissionTasking_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static AircraftMissionTasking_Ingest GetRootAsAircraftMissionTasking_Ingest(ByteBuffer _bb, AircraftMissionTasking_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AircraftMissionTasking_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRC"); }
  public static bool VerifyAircraftMissionTasking_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRC", false, AircraftMissionTasking_IngestVerify.Verify); }
  ...
  public static Offset<AircraftMissionTasking_Ingest> CreateAircraftMissionTasking_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<AircraftMissionTasking_Ingest> EndAircraftMissionTasking_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AircraftMissionTasking_Ingest>(o);
  }
  public static void FinishAircraftMissionTasking_IngestBuffer(FlatBufferBuilder builder, Offset<AircraftMissionTasking_Ingest> offset) { builder.Finish(offset.Value, "AIRC"); }
  public static void FinishSizePrefixedAircraftMissionTasking_IngestBuffer(FlatBufferBuilder builder, Offset<AircraftMissionTasking_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AIRC"); }
  public AircraftMissionTasking_IngestT UnPack() {
    var _o = new AircraftMissionTasking_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AircraftMissionTasking_IngestT _o) {
  ...
  public static Offset<AircraftMissionTasking_Ingest> Pack(FlatBufferBuilder builder, AircraftMissionTasking_IngestT _o) {
    if (_o == null) return default(Offset<AircraftMissionTasking_Ingest>);
...
public class AircraftMissionTasking_IngestT
{
  ...
  public AircraftMissionTasking_IngestT() {
  ...
  public static AircraftMissionTasking_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AircraftMissionTasking_Ingest.GetRootAsAircraftMissionTasking_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AircraftMissionTasking_Ingest.FinishAircraftMissionTasking_IngestBuffer(fbb, AircraftMissionTasking_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AircraftMissionTasking_IngestVerify
{
