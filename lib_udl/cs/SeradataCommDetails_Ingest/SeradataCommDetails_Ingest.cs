...
public struct SeradataCommDetails_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SeradataCommDetails_Ingest GetRootAsSeradataCommDetails_Ingest(ByteBuffer _bb) { return GetRootAsSeradataCommDetails_Ingest(_bb, new SeradataCommDetails_Ingest()); }
  public static SeradataCommDetails_Ingest GetRootAsSeradataCommDetails_Ingest(ByteBuffer _bb, SeradataCommDetails_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SeradataCommDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SERA"); }
  public static bool VerifySeradataCommDetails_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SERA", false, SeradataCommDetails_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SeradataCommDetails_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SeradataCommDetails_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(72); return o != 0 ? (SeradataCommDetails_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SeradataCommDetails_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<SeradataCommDetails_Ingest> CreateSeradataCommDetails_Ingest(FlatBufferBuilder builder,
      ...
      SeradataCommDetails_Ingest_dataMode_Enum dataMode = SeradataCommDetails_Ingest_dataMode_Enum.REAL,
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset)) {
    builder.StartTable(37);
    SeradataCommDetails_Ingest.AddUserUplinkTo(builder, userUplinkTo);
    SeradataCommDetails_Ingest.AddUserUplinkFrom(builder, userUplinkFrom);
    SeradataCommDetails_Ingest.AddUserDownlinkTo(builder, userDownlinkTo);
    SeradataCommDetails_Ingest.AddUserDownlinkFrom(builder, userDownlinkFrom);
    SeradataCommDetails_Ingest.AddEstHtsTotalCapacity(builder, estHtsTotalCapacity);
    SeradataCommDetails_Ingest.AddEstHtsTotalUserUplinkBandwidthPerBeam(builder, estHtsTotalUserUplinkBandwidthPerBeam);
    SeradataCommDetails_Ingest.AddEstHtsTotalUserDownlinkBandwidthPerBeam(builder, estHtsTotalUserDownlinkBandwidthPerBeam);
    SeradataCommDetails_Ingest.AddHtsUserUplinkBandwidthPerBeam(builder, htsUserUplinkBandwidthPerBeam);
    SeradataCommDetails_Ingest.AddHtsUserDownlinkBandwidthPerBeam(builder, htsUserDownlinkBandwidthPerBeam);
    SeradataCommDetails_Ingest.AddBandwidth(builder, bandwidth);
    SeradataCommDetails_Ingest.AddEirp(builder, eirp);
    SeradataCommDetails_Ingest.AddGatewayDownlinkTo(builder, gatewayDownlinkTo);
    SeradataCommDetails_Ingest.AddGatewayDownlinkFrom(builder, gatewayDownlinkFrom);
    SeradataCommDetails_Ingest.AddGatewayUplinkTo(builder, gatewayUplinkTo);
    SeradataCommDetails_Ingest.AddGatewayUplinkFrom(builder, gatewayUplinkFrom);
    SeradataCommDetails_Ingest.AddTravelingWaveTubeAmplifier(builder, travelingWaveTubeAmplifier);
    SeradataCommDetails_Ingest.AddSolidStatePowerAmp(builder, solidStatePowerAmp);
    SeradataCommDetails_Ingest.AddCreatedBy(builder, createdByOffset);
    SeradataCommDetails_Ingest.AddCreatedAt(builder, createdAtOffset);
    SeradataCommDetails_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    SeradataCommDetails_Ingest.AddOrigin(builder, originOffset);
    SeradataCommDetails_Ingest.AddSource(builder, sourceOffset);
    SeradataCommDetails_Ingest.AddPayloadNotes(builder, payloadNotesOffset);
    SeradataCommDetails_Ingest.AddHtsNumUserSpotBeams(builder, htsNumUserSpotBeams);
    SeradataCommDetails_Ingest.AddNum36MhzEquivalentTransponders(builder, num36MhzEquivalentTransponders);
    SeradataCommDetails_Ingest.AddTradeLeaseOrgId(builder, tradeLeaseOrgIdOffset);
    SeradataCommDetails_Ingest.AddManufacturerOrgId(builder, manufacturerOrgIdOffset);
    SeradataCommDetails_Ingest.AddHostedForCompanyOrgId(builder, hostedForCompanyOrgIdOffset);
    SeradataCommDetails_Ingest.AddNumSpareTransponders(builder, numSpareTransponders);
    SeradataCommDetails_Ingest.AddNumOperationalTransponders(builder, numOperationalTransponders);
    SeradataCommDetails_Ingest.AddPolarization(builder, polarizationOffset);
    SeradataCommDetails_Ingest.AddBand(builder, bandOffset);
    SeradataCommDetails_Ingest.AddSpacecraftId(builder, spacecraftIdOffset);
    SeradataCommDetails_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    SeradataCommDetails_Ingest.AddIdComm(builder, idCommOffset);
    SeradataCommDetails_Ingest.AddId(builder, idOffset);
    SeradataCommDetails_Ingest.AddDataMode(builder, dataMode);
    return SeradataCommDetails_Ingest.EndSeradataCommDetails_Ingest(builder);
  }

  public static void StartSeradataCommDetails_Ingest(FlatBufferBuilder builder) { builder.StartTable(37); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SeradataCommDetails_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(34, (sbyte)dataMode, 0); }
  ...
  public static Offset<SeradataCommDetails_Ingest> EndSeradataCommDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SeradataCommDetails_Ingest>(o);
  }
  public static void FinishSeradataCommDetails_IngestBuffer(FlatBufferBuilder builder, Offset<SeradataCommDetails_Ingest> offset) { builder.Finish(offset.Value, "SERA"); }
  public static void FinishSizePrefixedSeradataCommDetails_IngestBuffer(FlatBufferBuilder builder, Offset<SeradataCommDetails_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "SERA"); }
  public SeradataCommDetails_IngestT UnPack() {
    var _o = new SeradataCommDetails_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SeradataCommDetails_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SeradataCommDetails_Ingest> Pack(FlatBufferBuilder builder, SeradataCommDetails_IngestT _o) {
    if (_o == null) return default(Offset<SeradataCommDetails_Ingest>);
...
public class SeradataCommDetails_IngestT
{
  ...
  public SeradataCommDetails_Ingest_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }

  public SeradataCommDetails_IngestT() {
    this.Id = null;
    this.IdComm = null;
    ...
    this.DataMode = SeradataCommDetails_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
  }
  public static SeradataCommDetails_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return SeradataCommDetails_Ingest.GetRootAsSeradataCommDetails_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SeradataCommDetails_Ingest.FinishSeradataCommDetails_IngestBuffer(fbb, SeradataCommDetails_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SeradataCommDetails_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 72 /*DataMode*/, 1 /*SeradataCommDetails_Ingest_dataMode_Enum*/, 1, false)
