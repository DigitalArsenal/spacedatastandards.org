...
public struct BeamContour_Abridged : IFlatbufferObject
{
  ...
  public static Offset<BeamContour_Abridged.BeamContour_Abridged> CreateBeamContour_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<BeamContour_Abridged.BeamContour_Abridged> EndBeamContour_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<BeamContour_Abridged.BeamContour_Abridged>(o);
  }
  ...
  public static Offset<BeamContour_Abridged.BeamContour_Abridged> Pack(FlatBufferBuilder builder, BeamContour_AbridgedT _o) {
    if (_o == null) return default(Offset<BeamContour_Abridged.BeamContour_Abridged>);
