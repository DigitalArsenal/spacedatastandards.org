...
public struct Channel_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Channel_Abridged GetRootAsChannel_Abridged(ByteBuffer _bb) { return GetRootAsChannel_Abridged(_bb, new Channel_Abridged()); }
  public static Channel_Abridged GetRootAsChannel_Abridged(ByteBuffer _bb, Channel_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Channel_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "CHAN"); }
  public static bool VerifyChannel_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("CHAN", false, Channel_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Channel_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Channel_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(42); return o != 0 ? (Channel_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Channel_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<Channel_Abridged> CreateChannel_Abridged(FlatBufferBuilder builder,
      ...
      Channel_Abridged_dataMode_Enum dataMode = Channel_Abridged_dataMode_Enum.REAL,
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset)) {
    builder.StartTable(22);
    Channel_Abridged.AddCreatedBy(builder, createdByOffset);
    Channel_Abridged.AddCreatedAt(builder, createdAtOffset);
    Channel_Abridged.AddOrigNetwork(builder, origNetworkOffset);
    Channel_Abridged.AddOrigin(builder, originOffset);
    Channel_Abridged.AddSource(builder, sourceOffset);
    Channel_Abridged.AddOwner(builder, ownerOffset);
    Channel_Abridged.AddSid(builder, sidOffset);
    Channel_Abridged.AddApid(builder, apidOffset);
    Channel_Abridged.AddVpid(builder, vpidOffset);
    Channel_Abridged.AddCompression(builder, compressionOffset);
    Channel_Abridged.AddRes(builder, resOffset);
    Channel_Abridged.AddPkg(builder, pkgOffset);
    Channel_Abridged.AddEncryption(builder, encryptionOffset);
    Channel_Abridged.AddIdRFBand(builder, idRFBandOffset);
    Channel_Abridged.AddBeamName(builder, beamNameOffset);
    Channel_Abridged.AddIdBeam(builder, idBeamOffset);
    Channel_Abridged.AddType(builder, typeOffset);
    Channel_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    Channel_Abridged.AddName(builder, nameOffset);
    Channel_Abridged.AddIdTransponder(builder, idTransponderOffset);
    Channel_Abridged.AddId(builder, idOffset);
    Channel_Abridged.AddDataMode(builder, dataMode);
    return Channel_Abridged.EndChannel_Abridged(builder);
  }

  public static void StartChannel_Abridged(FlatBufferBuilder builder) { builder.StartTable(22); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Channel_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(19, (sbyte)dataMode, 0); }
  ...
  public static Offset<Channel_Abridged> EndChannel_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Channel_Abridged>(o);
  }
  public static void FinishChannel_AbridgedBuffer(FlatBufferBuilder builder, Offset<Channel_Abridged> offset) { builder.Finish(offset.Value, "CHAN"); }
  public static void FinishSizePrefixedChannel_AbridgedBuffer(FlatBufferBuilder builder, Offset<Channel_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "CHAN"); }
  public Channel_AbridgedT UnPack() {
    var _o = new Channel_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Channel_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Channel_Abridged> Pack(FlatBufferBuilder builder, Channel_AbridgedT _o) {
    if (_o == null) return default(Offset<Channel_Abridged>);
...
public class Channel_AbridgedT
{
  ...
  public Channel_Abridged_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }

  public Channel_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = Channel_Abridged_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
  }
  public static Channel_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Channel_Abridged.GetRootAsChannel_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Channel_Abridged.FinishChannel_AbridgedBuffer(fbb, Channel_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Channel_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 42 /*DataMode*/, 1 /*Channel_Abridged_dataMode_Enum*/, 1, false)
