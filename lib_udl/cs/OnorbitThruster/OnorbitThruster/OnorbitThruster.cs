...
public struct OnorbitThruster : IFlatbufferObject
{
  ...
  public static Offset<OnorbitThruster.OnorbitThruster> CreateOnorbitThruster(FlatBufferBuilder builder,
  ...
  public static Offset<OnorbitThruster.OnorbitThruster> EndOnorbitThruster(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OnorbitThruster.OnorbitThruster>(o);
  }
  ...
  public static Offset<OnorbitThruster.OnorbitThruster> Pack(FlatBufferBuilder builder, OnorbitThrusterT _o) {
    if (_o == null) return default(Offset<OnorbitThruster.OnorbitThruster>);
