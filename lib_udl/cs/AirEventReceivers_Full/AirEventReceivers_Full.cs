...
public struct AirEventReceivers_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static AirEventReceivers_Full GetRootAsAirEventReceivers_Full(ByteBuffer _bb, AirEventReceivers_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirEventReceivers_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRE"); }
  public static bool VerifyAirEventReceivers_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRE", false, AirEventReceivers_FullVerify.Verify); }
  ...
  public static Offset<AirEventReceivers_Full> CreateAirEventReceivers_Full(FlatBufferBuilder builder,
  ...
  public static Offset<AirEventReceivers_Full> EndAirEventReceivers_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirEventReceivers_Full>(o);
  }
  public static void FinishAirEventReceivers_FullBuffer(FlatBufferBuilder builder, Offset<AirEventReceivers_Full> offset) { builder.Finish(offset.Value, "AIRE"); }
  public static void FinishSizePrefixedAirEventReceivers_FullBuffer(FlatBufferBuilder builder, Offset<AirEventReceivers_Full> offset) { builder.FinishSizePrefixed(offset.Value, "AIRE"); }
  public AirEventReceivers_FullT UnPack() {
    var _o = new AirEventReceivers_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirEventReceivers_FullT _o) {
  ...
  public static Offset<AirEventReceivers_Full> Pack(FlatBufferBuilder builder, AirEventReceivers_FullT _o) {
    if (_o == null) return default(Offset<AirEventReceivers_Full>);
...
public class AirEventReceivers_FullT
{
  ...
  public AirEventReceivers_FullT() {
  ...
  public static AirEventReceivers_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return AirEventReceivers_Full.GetRootAsAirEventReceivers_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirEventReceivers_Full.FinishAirEventReceivers_FullBuffer(fbb, AirEventReceivers_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirEventReceivers_FullVerify
{
