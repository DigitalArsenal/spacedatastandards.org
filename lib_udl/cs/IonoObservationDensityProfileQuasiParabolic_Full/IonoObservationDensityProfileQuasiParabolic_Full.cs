...
public struct IonoObservationDensityProfileQuasiParabolic_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static IonoObservationDensityProfileQuasiParabolic_Full GetRootAsIonoObservationDensityProfileQuasiParabolic_Full(ByteBuffer _bb, IonoObservationDensityProfileQuasiParabolic_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationDensityProfileQuasiParabolic_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationDensityProfileQuasiParabolic_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationDensityProfileQuasiParabolic_FullVerify.Verify); }
  ...
  public static Offset<IonoObservationDensityProfileQuasiParabolic_Full> CreateIonoObservationDensityProfileQuasiParabolic_Full(FlatBufferBuilder builder,
  ...
  public static Offset<IonoObservationDensityProfileQuasiParabolic_Full> EndIonoObservationDensityProfileQuasiParabolic_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationDensityProfileQuasiParabolic_Full>(o);
  }
  public static void FinishIonoObservationDensityProfileQuasiParabolic_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationDensityProfileQuasiParabolic_Full> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationDensityProfileQuasiParabolic_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationDensityProfileQuasiParabolic_Full> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationDensityProfileQuasiParabolic_FullT UnPack() {
    var _o = new IonoObservationDensityProfileQuasiParabolic_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationDensityProfileQuasiParabolic_FullT _o) {
  ...
  public static Offset<IonoObservationDensityProfileQuasiParabolic_Full> Pack(FlatBufferBuilder builder, IonoObservationDensityProfileQuasiParabolic_FullT _o) {
    if (_o == null) return default(Offset<IonoObservationDensityProfileQuasiParabolic_Full>);
...
public class IonoObservationDensityProfileQuasiParabolic_FullT
{
  public string Description { get; set; }
  public double EarthRadius { get; set; }
  public List<string> QuasiParabolicSegments { get; set; }

  public IonoObservationDensityProfileQuasiParabolic_FullT() {
    this.Description = null;
    this.EarthRadius = 0.0;
    this.QuasiParabolicSegments = null;
  }
  public static IonoObservationDensityProfileQuasiParabolic_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationDensityProfileQuasiParabolic_Full.GetRootAsIonoObservationDensityProfileQuasiParabolic_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationDensityProfileQuasiParabolic_Full.FinishIonoObservationDensityProfileQuasiParabolic_FullBuffer(fbb, IonoObservationDensityProfileQuasiParabolic_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationDensityProfileQuasiParabolic_FullVerify
{
