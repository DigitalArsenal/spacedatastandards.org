...
public struct OnorbitEvent_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static OnorbitEvent_Full GetRootAsOnorbitEvent_Full(ByteBuffer _bb) { return GetRootAsOnorbitEvent_Full(_bb, new OnorbitEvent_Full()); }
  public static OnorbitEvent_Full GetRootAsOnorbitEvent_Full(ByteBuffer _bb, OnorbitEvent_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OnorbitEvent_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONOR"); }
  public static bool VerifyOnorbitEvent_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONOR", false, OnorbitEvent_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public OnorbitEvent_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public OnorbitEvent_Full_dataMode_Enum DataMode { get { int o = __p.__offset(104); return o != 0 ? (OnorbitEvent_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OnorbitEvent_Full_dataMode_Enum.REAL; } }
  ...
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string UpdatedAt { get { int o = __p.__offset(110); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedAtBytes() { return __p.__vector_as_span<byte>(110, 1); }
#else
  public ArraySegment<byte>? GetUpdatedAtBytes() { return __p.__vector_as_arraysegment(110); }
#endif
  public byte[] GetUpdatedAtArray() { return __p.__vector_as_array<byte>(110); }
  /// Application user who updated the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string UpdatedBy { get { int o = __p.__offset(112); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedByBytes() { return __p.__vector_as_span<byte>(112, 1); }
#else
  public ArraySegment<byte>? GetUpdatedByBytes() { return __p.__vector_as_arraysegment(112); }
#endif
  public byte[] GetUpdatedByArray() { return __p.__vector_as_array<byte>(112); }
  ...
  public static Offset<OnorbitEvent_Full> CreateOnorbitEvent_Full(FlatBufferBuilder builder,
      ...
      OnorbitEvent_Full_dataMode_Enum dataMode = OnorbitEvent_Full_dataMode_Enum.REAL,
    ...
    OnorbitEvent_Full.AddAgeAtEvent(builder, ageAtEvent);
    OnorbitEvent_Full.AddLifeLost(builder, lifeLost);
    OnorbitEvent_Full.AddThirdPartyInsuranceLoss(builder, thirdPartyInsuranceLoss);
    OnorbitEvent_Full.AddInsuranceLoss(builder, insuranceLoss);
    OnorbitEvent_Full.AddCapacityLoss(builder, capacityLoss);
    OnorbitEvent_Full.AddCapabilityLoss(builder, capabilityLoss);
    OnorbitEvent_Full.AddNetAmount(builder, netAmount);
    OnorbitEvent_Full.AddGeoPosition(builder, geoPosition);
    OnorbitEvent_Full.AddOrigNetwork(builder, origNetworkOffset);
    OnorbitEvent_Full.AddOnOrbit(builder, onOrbitOffset);
    OnorbitEvent_Full.AddUpdatedBy(builder, updatedByOffset);
    OnorbitEvent_Full.AddUpdatedAt(builder, updatedAtOffset);
    OnorbitEvent_Full.AddCreatedBy(builder, createdByOffset);
    OnorbitEvent_Full.AddCreatedAt(builder, createdAtOffset);
    OnorbitEvent_Full.AddOrigin(builder, originOffset);
    OnorbitEvent_Full.AddSource(builder, sourceOffset);
    OnorbitEvent_Full.AddSatellitePosition(builder, satellitePositionOffset);
    OnorbitEvent_Full.AddObjectStatus(builder, objectStatusOffset);
    OnorbitEvent_Full.AddEventResult(builder, eventResultOffset);
    OnorbitEvent_Full.AddEventType(builder, eventTypeOffset);
    OnorbitEvent_Full.AddEquipmentCausingLossNotes(builder, equipmentCausingLossNotesOffset);
    OnorbitEvent_Full.AddInsuranceCarriedNotes(builder, insuranceCarriedNotesOffset);
    OnorbitEvent_Full.AddCapabilityLossNotes(builder, capabilityLossNotesOffset);
    OnorbitEvent_Full.AddInsuranceLossNotes(builder, insuranceLossNotesOffset);
    OnorbitEvent_Full.AddRemarks(builder, remarksOffset);
    OnorbitEvent_Full.AddDescription(builder, descriptionOffset);
    OnorbitEvent_Full.AddConsequentialEquipmentFailure(builder, consequentialEquipmentFailureOffset);
    OnorbitEvent_Full.AddEquipmentPartAtFault(builder, equipmentPartAtFaultOffset);
    OnorbitEvent_Full.AddEquipmentTypeAtFault(builder, equipmentTypeAtFaultOffset);
    OnorbitEvent_Full.AddEquipmentAtFault(builder, equipmentAtFaultOffset);
    OnorbitEvent_Full.AddStageAtFault(builder, stageAtFaultOffset);
    OnorbitEvent_Full.AddOccurrenceFlightPhase(builder, occurrenceFlightPhaseOffset);
    OnorbitEvent_Full.AddAchievedFlightPhase(builder, achievedFlightPhaseOffset);
    OnorbitEvent_Full.AddKilled(builder, killed);
    OnorbitEvent_Full.AddInjured(builder, injured);
    OnorbitEvent_Full.AddUnderlyingCause(builder, underlyingCauseOffset);
    OnorbitEvent_Full.AddOfficialLossDate(builder, officialLossDateOffset);
    OnorbitEvent_Full.AddUntilTime(builder, untilTimeOffset);
    OnorbitEvent_Full.AddPositionStatus(builder, positionStatusOffset);
    OnorbitEvent_Full.AddPlaneNumber(builder, planeNumberOffset);
    OnorbitEvent_Full.AddPlaneSlot(builder, planeSlotOffset);
    OnorbitEvent_Full.AddOperatedOnBehalfOfOrgId(builder, operatedOnBehalfOfOrgIdOffset);
    OnorbitEvent_Full.AddLesseeOrgId(builder, lesseeOrgIdOffset);
    OnorbitEvent_Full.AddOwnerOrgId(builder, ownerOrgIdOffset);
    OnorbitEvent_Full.AddOperatorOrgId(builder, operatorOrgIdOffset);
    OnorbitEvent_Full.AddEventTimeNotes(builder, eventTimeNotesOffset);
    OnorbitEvent_Full.AddEventTime(builder, eventTimeOffset);
    OnorbitEvent_Full.AddOrigObjectId(builder, origObjectIdOffset);
    OnorbitEvent_Full.AddSatNo(builder, satNo);
    OnorbitEvent_Full.AddIdOnOrbit(builder, idOnOrbitOffset);
    OnorbitEvent_Full.AddDeclassificationString(builder, declassificationStringOffset);
    OnorbitEvent_Full.AddDeclassificationDate(builder, declassificationDateOffset);
    OnorbitEvent_Full.AddDerivedFrom(builder, derivedFromOffset);
    OnorbitEvent_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    OnorbitEvent_Full.AddId(builder, idOffset);
    OnorbitEvent_Full.AddDataMode(builder, dataMode);
    OnorbitEvent_Full.AddInclined(builder, inclined);
    return OnorbitEvent_Full.EndOnorbitEvent_Full(builder);
  }

  public static void StartOnorbitEvent_Full(FlatBufferBuilder builder) { builder.StartTable(57); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OnorbitEvent_Full_dataMode_Enum dataMode) { builder.AddSbyte(50, (sbyte)dataMode, 0); }
  ...
  public static void AddUpdatedAt(FlatBufferBuilder builder, StringOffset updatedAtOffset) { builder.AddOffset(53, updatedAtOffset.Value, 0); }
  public static void AddUpdatedBy(FlatBufferBuilder builder, StringOffset updatedByOffset) { builder.AddOffset(54, updatedByOffset.Value, 0); }
  ...
  public static Offset<OnorbitEvent_Full> EndOnorbitEvent_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OnorbitEvent_Full>(o);
  }
  public static void FinishOnorbitEvent_FullBuffer(FlatBufferBuilder builder, Offset<OnorbitEvent_Full> offset) { builder.Finish(offset.Value, "ONOR"); }
  public static void FinishSizePrefixedOnorbitEvent_FullBuffer(FlatBufferBuilder builder, Offset<OnorbitEvent_Full> offset) { builder.FinishSizePrefixed(offset.Value, "ONOR"); }
  public OnorbitEvent_FullT UnPack() {
    var _o = new OnorbitEvent_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OnorbitEvent_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OnorbitEvent_Full> Pack(FlatBufferBuilder builder, OnorbitEvent_FullT _o) {
    if (_o == null) return default(Offset<OnorbitEvent_Full>);
...
public class OnorbitEvent_FullT
{
  ...
  public OnorbitEvent_Full_dataMode_Enum DataMode { get; set; }
  ...
  public OnorbitEvent_FullT() {
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = OnorbitEvent_Full_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.UpdatedAt = null;
    this.UpdatedBy = null;
  ...
  public static OnorbitEvent_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return OnorbitEvent_Full.GetRootAsOnorbitEvent_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OnorbitEvent_Full.FinishOnorbitEvent_FullBuffer(fbb, OnorbitEvent_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OnorbitEvent_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 104 /*DataMode*/, 1 /*OnorbitEvent_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 106 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 108 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 110 /*UpdatedAt*/, false)
      && verifier.VerifyString(tablePos, 112 /*UpdatedBy*/, false)
