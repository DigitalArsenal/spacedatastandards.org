...
public struct OnorbitEvent_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static OnorbitEvent_Ingest GetRootAsOnorbitEvent_Ingest(ByteBuffer _bb, OnorbitEvent_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OnorbitEvent_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONOR"); }
  public static bool VerifyOnorbitEvent_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONOR", false, OnorbitEvent_IngestVerify.Verify); }
  ...
  public OnorbitEvent_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(104); return o != 0 ? (OnorbitEvent_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OnorbitEvent_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<OnorbitEvent_Ingest> CreateOnorbitEvent_Ingest(FlatBufferBuilder builder,
      ...
      OnorbitEvent_Ingest_dataMode_Enum dataMode = OnorbitEvent_Ingest_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OnorbitEvent_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(50, (sbyte)dataMode, 0); }
  ...
  public static Offset<OnorbitEvent_Ingest> EndOnorbitEvent_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OnorbitEvent_Ingest>(o);
  }
  public static void FinishOnorbitEvent_IngestBuffer(FlatBufferBuilder builder, Offset<OnorbitEvent_Ingest> offset) { builder.Finish(offset.Value, "ONOR"); }
  public static void FinishSizePrefixedOnorbitEvent_IngestBuffer(FlatBufferBuilder builder, Offset<OnorbitEvent_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "ONOR"); }
  public OnorbitEvent_IngestT UnPack() {
    var _o = new OnorbitEvent_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OnorbitEvent_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OnorbitEvent_Ingest> Pack(FlatBufferBuilder builder, OnorbitEvent_IngestT _o) {
    if (_o == null) return default(Offset<OnorbitEvent_Ingest>);
...
public class OnorbitEvent_IngestT
{
  ...
  public OnorbitEvent_Ingest_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string OrigNetwork { get; set; }

  public OnorbitEvent_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = OnorbitEvent_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.OrigNetwork = null;
  }
  public static OnorbitEvent_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return OnorbitEvent_Ingest.GetRootAsOnorbitEvent_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OnorbitEvent_Ingest.FinishOnorbitEvent_IngestBuffer(fbb, OnorbitEvent_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OnorbitEvent_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 104 /*DataMode*/, 1 /*OnorbitEvent_Ingest_dataMode_Enum*/, 1, false)
