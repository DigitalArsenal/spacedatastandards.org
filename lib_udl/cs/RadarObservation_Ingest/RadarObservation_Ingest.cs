...
public struct RadarObservation_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static RadarObservation_Ingest GetRootAsRadarObservation_Ingest(ByteBuffer _bb, RadarObservation_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool RadarObservation_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "RADA"); }
  public static bool VerifyRadarObservation_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("RADA", false, RadarObservation_IngestVerify.Verify); }
  ...
  public RadarObservation_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(106); return o != 0 ? (RadarObservation_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RadarObservation_Ingest_dataMode_Enum.REAL; } }
  ...
  public RadarObservation_Ingest_senReferenceFrame_Enum SenReferenceFrame { get { int o = __p.__offset(114); return o != 0 ? (RadarObservation_Ingest_senReferenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RadarObservation_Ingest_senReferenceFrame_Enum.J2000; } }
  /// Optional source-provided and searchable metadata or descriptor of the data.
  /// Example: /// Example: descriptor
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Descriptor { get { int o = __p.__offset(116); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetDescriptorBytes() { return __p.__vector_as_span<byte>(116, 1); }
#else
  public ArraySegment<byte>? GetDescriptorBytes() { return __p.__vector_as_arraysegment(116); }
#endif
  public byte[] GetDescriptorArray() { return __p.__vector_as_array<byte>(116); }
  /// The originating source network on which this record was created, auto-populated by the system.
  /// Example: /// Example: ORIG
  /// Constraints: Minimum length = 1, Maximum length = 32
  public string OrigNetwork { get { int o = __p.__offset(118); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOrigNetworkBytes() { return __p.__vector_as_span<byte>(118, 1); }
#else
  public ArraySegment<byte>? GetOrigNetworkBytes() { return __p.__vector_as_arraysegment(118); }
#endif
  public byte[] GetOrigNetworkArray() { return __p.__vector_as_array<byte>(118); }
  /// The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
  /// Example: /// Example: AXE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string SourceDL { get { int o = __p.__offset(120); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceDLBytes() { return __p.__vector_as_span<byte>(120, 1); }
#else
  public ArraySegment<byte>? GetSourceDLBytes() { return __p.__vector_as_arraysegment(120); }
#endif
  public byte[] GetSourceDLArray() { return __p.__vector_as_array<byte>(120); }
  /// Read only enumeration specifying the type of observation (e.g. OPTICAL, RADAR, RF, etc).
  /// Example: /// Example: RADAR
  /// Constraints: No constraints specified.
  public string Type { get { int o = __p.__offset(122); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTypeBytes() { return __p.__vector_as_span<byte>(122, 1); }
#else
  public ArraySegment<byte>? GetTypeBytes() { return __p.__vector_as_arraysegment(122); }
#endif
  public byte[] GetTypeArray() { return __p.__vector_as_array<byte>(122); }

  public static Offset<RadarObservation_Ingest> CreateRadarObservation_Ingest(FlatBufferBuilder builder,
      ...
      RadarObservation_Ingest_dataMode_Enum dataMode = RadarObservation_Ingest_dataMode_Enum.REAL,
      VectorOffset tagsOffset = default(VectorOffset),
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset),
      RadarObservation_Ingest_senReferenceFrame_Enum senReferenceFrame = RadarObservation_Ingest_senReferenceFrame_Enum.J2000,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, RadarObservation_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(51, (sbyte)dataMode, 0); }
  ...
  public static void AddSenReferenceFrame(FlatBufferBuilder builder, RadarObservation_Ingest_senReferenceFrame_Enum senReferenceFrame) { builder.AddSbyte(55, (sbyte)senReferenceFrame, 0); }
  public static void AddDescriptor(FlatBufferBuilder builder, StringOffset descriptorOffset) { builder.AddOffset(56, descriptorOffset.Value, 0); }
  public static void AddOrigNetwork(FlatBufferBuilder builder, StringOffset origNetworkOffset) { builder.AddOffset(57, origNetworkOffset.Value, 0); }
  public static void AddSourceDL(FlatBufferBuilder builder, StringOffset sourceDLOffset) { builder.AddOffset(58, sourceDLOffset.Value, 0); }
  public static void AddType(FlatBufferBuilder builder, StringOffset typeOffset) { builder.AddOffset(59, typeOffset.Value, 0); }
  public static Offset<RadarObservation_Ingest> EndRadarObservation_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RadarObservation_Ingest>(o);
  }
  public static void FinishRadarObservation_IngestBuffer(FlatBufferBuilder builder, Offset<RadarObservation_Ingest> offset) { builder.Finish(offset.Value, "RADA"); }
  public static void FinishSizePrefixedRadarObservation_IngestBuffer(FlatBufferBuilder builder, Offset<RadarObservation_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "RADA"); }
  public RadarObservation_IngestT UnPack() {
    var _o = new RadarObservation_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RadarObservation_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<RadarObservation_Ingest> Pack(FlatBufferBuilder builder, RadarObservation_IngestT _o) {
    if (_o == null) return default(Offset<RadarObservation_Ingest>);
...
public class RadarObservation_IngestT
{
  ...
  public RadarObservation_Ingest_dataMode_Enum DataMode { get; set; }
  public List<string> Tags { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public RadarObservation_Ingest_senReferenceFrame_Enum SenReferenceFrame { get; set; }
  public string Descriptor { get; set; }
  public string OrigNetwork { get; set; }
  public string SourceDL { get; set; }
  public string Type { get; set; }

  public RadarObservation_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = RadarObservation_Ingest_dataMode_Enum.REAL;
    this.Tags = null;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.SenReferenceFrame = RadarObservation_Ingest_senReferenceFrame_Enum.J2000;
    this.Descriptor = null;
    this.OrigNetwork = null;
    this.SourceDL = null;
    this.Type = null;
  }
  public static RadarObservation_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return RadarObservation_Ingest.GetRootAsRadarObservation_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    RadarObservation_Ingest.FinishRadarObservation_IngestBuffer(fbb, RadarObservation_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class RadarObservation_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 106 /*DataMode*/, 1 /*RadarObservation_Ingest_dataMode_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 114 /*SenReferenceFrame*/, 1 /*RadarObservation_Ingest_senReferenceFrame_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 116 /*Descriptor*/, false)
      && verifier.VerifyString(tablePos, 118 /*OrigNetwork*/, false)
      && verifier.VerifyString(tablePos, 120 /*SourceDL*/, false)
      && verifier.VerifyString(tablePos, 122 /*Type*/, false)
