...
public struct OnorbitSolarArray : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static OnorbitSolarArray GetRootAsOnorbitSolarArray(ByteBuffer _bb) { return GetRootAsOnorbitSolarArray(_bb, new OnorbitSolarArray()); }
  public static OnorbitSolarArray GetRootAsOnorbitSolarArray(ByteBuffer _bb, OnorbitSolarArray obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OnorbitSolarArrayBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONOR"); }
  public static bool VerifyOnorbitSolarArray(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONOR", false, OnorbitSolarArrayVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public OnorbitSolarArray __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public OnorbitSolarArray_dataMode_Enum DataMode { get { int o = __p.__offset(26); return o != 0 ? (OnorbitSolarArray_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OnorbitSolarArray_dataMode_Enum.REAL; } }
  ...
  public static Offset<OnorbitSolarArray> CreateOnorbitSolarArray(FlatBufferBuilder builder,
      ...
      OnorbitSolarArray_dataMode_Enum dataMode = OnorbitSolarArray_dataMode_Enum.REAL,
      StringOffset solarArrayOffset = default(StringOffset),
      StringOffset origNetworkOffset = default(StringOffset)) {
    builder.StartTable(14);
    OnorbitSolarArray.AddOrigNetwork(builder, origNetworkOffset);
    OnorbitSolarArray.AddSolarArray(builder, solarArrayOffset);
    OnorbitSolarArray.AddOrigin(builder, originOffset);
    OnorbitSolarArray.AddSource(builder, sourceOffset);
    OnorbitSolarArray.AddUpdatedBy(builder, updatedByOffset);
    OnorbitSolarArray.AddUpdatedAt(builder, updatedAtOffset);
    OnorbitSolarArray.AddCreatedBy(builder, createdByOffset);
    OnorbitSolarArray.AddCreatedAt(builder, createdAtOffset);
    OnorbitSolarArray.AddQuantity(builder, quantity);
    OnorbitSolarArray.AddClassificationMarking(builder, classificationMarkingOffset);
    OnorbitSolarArray.AddIdSolarArray(builder, idSolarArrayOffset);
    OnorbitSolarArray.AddIdOnOrbit(builder, idOnOrbitOffset);
    OnorbitSolarArray.AddId(builder, idOffset);
    OnorbitSolarArray.AddDataMode(builder, dataMode);
    return OnorbitSolarArray.EndOnorbitSolarArray(builder);
  }

  public static void StartOnorbitSolarArray(FlatBufferBuilder builder) { builder.StartTable(14); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OnorbitSolarArray_dataMode_Enum dataMode) { builder.AddSbyte(11, (sbyte)dataMode, 0); }
  ...
  public static Offset<OnorbitSolarArray> EndOnorbitSolarArray(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OnorbitSolarArray>(o);
  }
  public static void FinishOnorbitSolarArrayBuffer(FlatBufferBuilder builder, Offset<OnorbitSolarArray> offset) { builder.Finish(offset.Value, "ONOR"); }
  public static void FinishSizePrefixedOnorbitSolarArrayBuffer(FlatBufferBuilder builder, Offset<OnorbitSolarArray> offset) { builder.FinishSizePrefixed(offset.Value, "ONOR"); }
  public OnorbitSolarArrayT UnPack() {
    var _o = new OnorbitSolarArrayT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OnorbitSolarArrayT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OnorbitSolarArray> Pack(FlatBufferBuilder builder, OnorbitSolarArrayT _o) {
    if (_o == null) return default(Offset<OnorbitSolarArray>);
...
public class OnorbitSolarArrayT
{
  ...
  public OnorbitSolarArray_dataMode_Enum DataMode { get; set; }
  public string SolarArray { get; set; }
  public string OrigNetwork { get; set; }

  public OnorbitSolarArrayT() {
    this.Id = null;
    this.IdOnOrbit = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = OnorbitSolarArray_dataMode_Enum.REAL;
    this.SolarArray = null;
    this.OrigNetwork = null;
  }
  public static OnorbitSolarArrayT DeserializeFromBinary(byte[] fbBuffer) {
    return OnorbitSolarArray.GetRootAsOnorbitSolarArray(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OnorbitSolarArray.FinishOnorbitSolarArrayBuffer(fbb, OnorbitSolarArray.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OnorbitSolarArrayVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 26 /*DataMode*/, 1 /*OnorbitSolarArray_dataMode_Enum*/, 1, false)
