...
public struct ISRCollectionRequirements_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static ISRCollectionRequirements_Abridged GetRootAsISRCollectionRequirements_Abridged(ByteBuffer _bb) { return GetRootAsISRCollectionRequirements_Abridged(_bb, new ISRCollectionRequirements_Abridged()); }
  public static ISRCollectionRequirements_Abridged GetRootAsISRCollectionRequirements_Abridged(ByteBuffer _bb, ISRCollectionRequirements_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool ISRCollectionRequirements_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ISRC"); }
  public static bool VerifyISRCollectionRequirements_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ISRC", false, ISRCollectionRequirements_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ISRCollectionRequirements_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<ISRCollectionRequirements_Abridged> CreateISRCollectionRequirements_Abridged(FlatBufferBuilder builder,
    ...
    ISRCollectionRequirements_Abridged.AddPriority(builder, priority);
    ISRCollectionRequirements_Abridged.AddTargetList(builder, targetListOffset);
    ISRCollectionRequirements_Abridged.AddExploitationRequirement(builder, exploitationRequirementOffset);
    ISRCollectionRequirements_Abridged.AddCriticalTimes(builder, criticalTimesOffset);
    ISRCollectionRequirements_Abridged.AddSpecialComGuidance(builder, specialComGuidanceOffset);
    ISRCollectionRequirements_Abridged.AddSubregion(builder, subregionOffset);
    ISRCollectionRequirements_Abridged.AddRegion(builder, regionOffset);
    ISRCollectionRequirements_Abridged.AddCountry(builder, countryOffset);
    ISRCollectionRequirements_Abridged.AddSupportedUnit(builder, supportedUnitOffset);
    ISRCollectionRequirements_Abridged.AddOperation(builder, operationOffset);
    ISRCollectionRequirements_Abridged.AddStop(builder, stopOffset);
    ISRCollectionRequirements_Abridged.AddStart(builder, startOffset);
    ISRCollectionRequirements_Abridged.AddIntelDiscipline(builder, intelDisciplineOffset);
    ISRCollectionRequirements_Abridged.AddReconSurvey(builder, reconSurveyOffset);
    ISRCollectionRequirements_Abridged.AddRecordId(builder, recordIdOffset);
    ISRCollectionRequirements_Abridged.AddCridNumbers(builder, cridNumbersOffset);
    ISRCollectionRequirements_Abridged.AddType(builder, typeOffset);
    ISRCollectionRequirements_Abridged.AddHash(builder, hashOffset);
    ISRCollectionRequirements_Abridged.AddId(builder, idOffset);
    ISRCollectionRequirements_Abridged.AddIsPrismCr(builder, isPrismCr);
    ISRCollectionRequirements_Abridged.AddEmphasized(builder, emphasized);
    ISRCollectionRequirements_Abridged.AddSecondary(builder, secondary);
    return ISRCollectionRequirements_Abridged.EndISRCollectionRequirements_Abridged(builder);
  }

  public static void StartISRCollectionRequirements_Abridged(FlatBufferBuilder builder) { builder.StartTable(22); }
  ...
  public static Offset<ISRCollectionRequirements_Abridged> EndISRCollectionRequirements_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ISRCollectionRequirements_Abridged>(o);
  }
  public static void FinishISRCollectionRequirements_AbridgedBuffer(FlatBufferBuilder builder, Offset<ISRCollectionRequirements_Abridged> offset) { builder.Finish(offset.Value, "ISRC"); }
  public static void FinishSizePrefixedISRCollectionRequirements_AbridgedBuffer(FlatBufferBuilder builder, Offset<ISRCollectionRequirements_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "ISRC"); }
  public ISRCollectionRequirements_AbridgedT UnPack() {
    var _o = new ISRCollectionRequirements_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(ISRCollectionRequirements_AbridgedT _o) {
    _o.Id = this.Id;
    _o.Hash = this.Hash;
    _o.Type = this.Type;
  ...
  public static Offset<ISRCollectionRequirements_Abridged> Pack(FlatBufferBuilder builder, ISRCollectionRequirements_AbridgedT _o) {
    if (_o == null) return default(Offset<ISRCollectionRequirements_Abridged>);
...
public class ISRCollectionRequirements_AbridgedT
{
  ...
  public ISRCollectionRequirements_AbridgedT() {
    this.Id = null;
    this.Hash = null;
    this.Type = null;
  ...
  public static ISRCollectionRequirements_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return ISRCollectionRequirements_Abridged.GetRootAsISRCollectionRequirements_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    ISRCollectionRequirements_Abridged.FinishISRCollectionRequirements_AbridgedBuffer(fbb, ISRCollectionRequirements_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class ISRCollectionRequirements_AbridgedVerify
{
