...
public struct IonoObservationAzimuth_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationAzimuth_Full GetRootAsIonoObservationAzimuth_Full(ByteBuffer _bb) { return GetRootAsIonoObservationAzimuth_Full(_bb, new IonoObservationAzimuth_Full()); }
  public static IonoObservationAzimuth_Full GetRootAsIonoObservationAzimuth_Full(ByteBuffer _bb, IonoObservationAzimuth_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationAzimuth_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationAzimuth_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationAzimuth_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationAzimuth_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationAzimuth_Full> CreateIonoObservationAzimuth_Full(FlatBufferBuilder builder,
  ...
  public static void StartIonoObservationAzimuth_Full(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationAzimuth_Full> EndIonoObservationAzimuth_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationAzimuth_Full>(o);
  }
  public static void FinishIonoObservationAzimuth_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationAzimuth_Full> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationAzimuth_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationAzimuth_Full> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationAzimuth_FullT UnPack() {
    var _o = new IonoObservationAzimuth_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationAzimuth_FullT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationAzimuth_Full> Pack(FlatBufferBuilder builder, IonoObservationAzimuth_FullT _o) {
    if (_o == null) return default(Offset<IonoObservationAzimuth_Full>);
    ...
    return CreateIonoObservationAzimuth_Full(
      builder,
      _notes,
      _dimensions,
      _dimensionName,
...
public class IonoObservationAzimuth_FullT
{
  ...
  public IonoObservationAzimuth_FullT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationAzimuth_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationAzimuth_Full.GetRootAsIonoObservationAzimuth_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationAzimuth_Full.FinishIonoObservationAzimuth_FullBuffer(fbb, IonoObservationAzimuth_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationAzimuth_FullVerify
{
