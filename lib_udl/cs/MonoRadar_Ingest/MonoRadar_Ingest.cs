...
public struct MonoRadar_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static MonoRadar_Ingest GetRootAsMonoRadar_Ingest(ByteBuffer _bb) { return GetRootAsMonoRadar_Ingest(_bb, new MonoRadar_Ingest()); }
  public static MonoRadar_Ingest GetRootAsMonoRadar_Ingest(ByteBuffer _bb, MonoRadar_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool MonoRadar_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MONO"); }
  public static bool VerifyMonoRadar_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MONO", false, MonoRadar_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public MonoRadar_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public MonoRadar_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(142); return o != 0 ? (MonoRadar_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : MonoRadar_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<MonoRadar_Ingest> CreateMonoRadar_Ingest(FlatBufferBuilder builder,
      ...
      MonoRadar_Ingest_dataMode_Enum dataMode = MonoRadar_Ingest_dataMode_Enum.REAL,
  ...
  public static void StartMonoRadar_Ingest(FlatBufferBuilder builder) { builder.StartTable(73); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, MonoRadar_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(69, (sbyte)dataMode, 0); }
  ...
  public static Offset<MonoRadar_Ingest> EndMonoRadar_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<MonoRadar_Ingest>(o);
  }
  public static void FinishMonoRadar_IngestBuffer(FlatBufferBuilder builder, Offset<MonoRadar_Ingest> offset) { builder.Finish(offset.Value, "MONO"); }
  public static void FinishSizePrefixedMonoRadar_IngestBuffer(FlatBufferBuilder builder, Offset<MonoRadar_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "MONO"); }
  public MonoRadar_IngestT UnPack() {
    var _o = new MonoRadar_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(MonoRadar_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<MonoRadar_Ingest> Pack(FlatBufferBuilder builder, MonoRadar_IngestT _o) {
    if (_o == null) return default(Offset<MonoRadar_Ingest>);
...
public class MonoRadar_IngestT
{
  ...
  public MonoRadar_Ingest_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string OrigNetwork { get; set; }

  public MonoRadar_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = MonoRadar_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.OrigNetwork = null;
  }
  public static MonoRadar_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return MonoRadar_Ingest.GetRootAsMonoRadar_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    MonoRadar_Ingest.FinishMonoRadar_IngestBuffer(fbb, MonoRadar_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class MonoRadar_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 142 /*DataMode*/, 1 /*MonoRadar_Ingest_dataMode_Enum*/, 1, false)
