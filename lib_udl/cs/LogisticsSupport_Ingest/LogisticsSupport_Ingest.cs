...
public struct LogisticsSupport_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static LogisticsSupport_Ingest GetRootAsLogisticsSupport_Ingest(ByteBuffer _bb) { return GetRootAsLogisticsSupport_Ingest(_bb, new LogisticsSupport_Ingest()); }
  public static LogisticsSupport_Ingest GetRootAsLogisticsSupport_Ingest(ByteBuffer _bb, LogisticsSupport_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LogisticsSupport_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LOGI"); }
  public static bool VerifyLogisticsSupport_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LOGI", false, LogisticsSupport_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public LogisticsSupport_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public LogisticsSupport_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(62); return o != 0 ? (LogisticsSupport_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : LogisticsSupport_Ingest_dataMode_Enum.REAL; } }

  public static Offset<LogisticsSupport_Ingest> CreateLogisticsSupport_Ingest(FlatBufferBuilder builder,
      ...
      LogisticsSupport_Ingest_dataMode_Enum dataMode = LogisticsSupport_Ingest_dataMode_Enum.REAL) {
  ...
  public static void StartLogisticsSupport_Ingest(FlatBufferBuilder builder) { builder.StartTable(30); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, LogisticsSupport_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(29, (sbyte)dataMode, 0); }
  public static Offset<LogisticsSupport_Ingest> EndLogisticsSupport_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LogisticsSupport_Ingest>(o);
  }
  public static void FinishLogisticsSupport_IngestBuffer(FlatBufferBuilder builder, Offset<LogisticsSupport_Ingest> offset) { builder.Finish(offset.Value, "LOGI"); }
  public static void FinishSizePrefixedLogisticsSupport_IngestBuffer(FlatBufferBuilder builder, Offset<LogisticsSupport_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "LOGI"); }
  public LogisticsSupport_IngestT UnPack() {
    var _o = new LogisticsSupport_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LogisticsSupport_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<LogisticsSupport_Ingest> Pack(FlatBufferBuilder builder, LogisticsSupport_IngestT _o) {
    if (_o == null) return default(Offset<LogisticsSupport_Ingest>);
...
public class LogisticsSupport_IngestT
{
  ...
  public LogisticsSupport_Ingest_dataMode_Enum DataMode { get; set; }

  public LogisticsSupport_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = LogisticsSupport_Ingest_dataMode_Enum.REAL;
  }
  public static LogisticsSupport_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return LogisticsSupport_Ingest.GetRootAsLogisticsSupport_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LogisticsSupport_Ingest.FinishLogisticsSupport_IngestBuffer(fbb, LogisticsSupport_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LogisticsSupport_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 62 /*DataMode*/, 1 /*LogisticsSupport_Ingest_dataMode_Enum*/, 1, false)
