...
public struct Sensorcharacteristics_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Sensorcharacteristics_Ingest GetRootAsSensorcharacteristics_Ingest(ByteBuffer _bb) { return GetRootAsSensorcharacteristics_Ingest(_bb, new Sensorcharacteristics_Ingest()); }
  public static Sensorcharacteristics_Ingest GetRootAsSensorcharacteristics_Ingest(ByteBuffer _bb, Sensorcharacteristics_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Sensorcharacteristics_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SENS"); }
  public static bool VerifySensorcharacteristics_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SENS", false, Sensorcharacteristics_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Sensorcharacteristics_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Sensorcharacteristics_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(106); return o != 0 ? (Sensorcharacteristics_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Sensorcharacteristics_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<Sensorcharacteristics_Ingest> CreateSensorcharacteristics_Ingest(FlatBufferBuilder builder,
      ...
      Sensorcharacteristics_Ingest_dataMode_Enum dataMode = Sensorcharacteristics_Ingest_dataMode_Enum.REAL,
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset)) {
    builder.StartTable(54);
    Sensorcharacteristics_Ingest.AddSystemNoiseTemperature(builder, systemNoiseTemperature);
    Sensorcharacteristics_Ingest.AddTrueTilt(builder, trueTilt);
    Sensorcharacteristics_Ingest.AddRadarPulseWidth(builder, radarPulseWidth);
    Sensorcharacteristics_Ingest.AddPrf(builder, prf);
    Sensorcharacteristics_Ingest.AddProbFalseAlarm(builder, probFalseAlarm);
    Sensorcharacteristics_Ingest.AddRadarMUR(builder, radarMUR);
    Sensorcharacteristics_Ingest.AddZ2MaxRange(builder, z2MaxRange);
    Sensorcharacteristics_Ingest.AddZ1MaxRange(builder, z1MaxRange);
    Sensorcharacteristics_Ingest.AddZ2MinRange(builder, z2MinRange);
    Sensorcharacteristics_Ingest.AddZ1MinRange(builder, z1MinRange);
    Sensorcharacteristics_Ingest.AddMagDec(builder, magDec);
    Sensorcharacteristics_Ingest.AddTowerHeight(builder, towerHeight);
    Sensorcharacteristics_Ingest.AddFocalPoint(builder, focalPoint);
    Sensorcharacteristics_Ingest.AddK(builder, k);
    Sensorcharacteristics_Ingest.AddAsrScanRate(builder, asrScanRate);
    Sensorcharacteristics_Ingest.AddRightGeoBeltLimit(builder, rightGeoBeltLimit);
    Sensorcharacteristics_Ingest.AddLeftGeoBeltLimit(builder, leftGeoBeltLimit);
    Sensorcharacteristics_Ingest.AddAperture(builder, aperture);
    Sensorcharacteristics_Ingest.AddMaxDeviationAngle(builder, maxDeviationAngle);
    Sensorcharacteristics_Ingest.AddVFOV(builder, vFOV);
    Sensorcharacteristics_Ingest.AddHFOV(builder, hFOV);
    Sensorcharacteristics_Ingest.AddTransmitPower(builder, transmitPower);
    Sensorcharacteristics_Ingest.AddRadarFrequency(builder, radarFrequency);
    Sensorcharacteristics_Ingest.AddRadioFrequency(builder, radioFrequency);
    Sensorcharacteristics_Ingest.AddMaxObservableRange(builder, maxObservableRange);
    Sensorcharacteristics_Ingest.AddTaskableRange(builder, taskableRange);
    Sensorcharacteristics_Ingest.AddFanBeamWidth(builder, fanBeamWidth);
    Sensorcharacteristics_Ingest.AddMinSignalNoiseRatio(builder, minSignalNoiseRatio);
    Sensorcharacteristics_Ingest.AddTrackAngle(builder, trackAngle);
    Sensorcharacteristics_Ingest.AddMagnitudeLimit(builder, magnitudeLimit);
    Sensorcharacteristics_Ingest.AddPositiveRangeRateLimit(builder, positiveRangeRateLimit);
    Sensorcharacteristics_Ingest.AddNegativeRangeRateLimit(builder, negativeRangeRateLimit);
    Sensorcharacteristics_Ingest.AddBoresightOffAngle(builder, boresightOffAngle);
    Sensorcharacteristics_Ingest.AddBoresight(builder, boresight);
    Sensorcharacteristics_Ingest.AddRightClockAngle(builder, rightClockAngle);
    Sensorcharacteristics_Ingest.AddLeftClockAngle(builder, leftClockAngle);
    Sensorcharacteristics_Ingest.AddMaxRangeLimit(builder, maxRangeLimit);
    Sensorcharacteristics_Ingest.AddMinRangeLimit(builder, minRangeLimit);
    Sensorcharacteristics_Ingest.AddElevationRateGeolm(builder, elevationRateGeolm);
    Sensorcharacteristics_Ingest.AddAzimuthRate(builder, azimuthRate);
    Sensorcharacteristics_Ingest.AddCreatedBy(builder, createdByOffset);
    Sensorcharacteristics_Ingest.AddCreatedAt(builder, createdAtOffset);
    Sensorcharacteristics_Ingest.AddSource(builder, sourceOffset);
    Sensorcharacteristics_Ingest.AddRadarMessageFormat(builder, radarMessageFormatOffset);
    Sensorcharacteristics_Ingest.AddNumIntegratedPulses(builder, numIntegratedPulses);
    Sensorcharacteristics_Ingest.AddTrueNorthCorrector(builder, trueNorthCorrector);
    Sensorcharacteristics_Ingest.AddBand(builder, bandOffset);
    Sensorcharacteristics_Ingest.AddVResPixels(builder, vResPixels);
    Sensorcharacteristics_Ingest.AddHResPixels(builder, hResPixels);
    Sensorcharacteristics_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    Sensorcharacteristics_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    Sensorcharacteristics_Ingest.AddIdSensor(builder, idSensorOffset);
    Sensorcharacteristics_Ingest.AddId(builder, idOffset);
    Sensorcharacteristics_Ingest.AddDataMode(builder, dataMode);
    return Sensorcharacteristics_Ingest.EndSensorcharacteristics_Ingest(builder);
  }

  public static void StartSensorcharacteristics_Ingest(FlatBufferBuilder builder) { builder.StartTable(54); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Sensorcharacteristics_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(51, (sbyte)dataMode, 0); }
  ...
  public static Offset<Sensorcharacteristics_Ingest> EndSensorcharacteristics_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Sensorcharacteristics_Ingest>(o);
  }
  public static void FinishSensorcharacteristics_IngestBuffer(FlatBufferBuilder builder, Offset<Sensorcharacteristics_Ingest> offset) { builder.Finish(offset.Value, "SENS"); }
  public static void FinishSizePrefixedSensorcharacteristics_IngestBuffer(FlatBufferBuilder builder, Offset<Sensorcharacteristics_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "SENS"); }
  public Sensorcharacteristics_IngestT UnPack() {
    var _o = new Sensorcharacteristics_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Sensorcharacteristics_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Sensorcharacteristics_Ingest> Pack(FlatBufferBuilder builder, Sensorcharacteristics_IngestT _o) {
    if (_o == null) return default(Offset<Sensorcharacteristics_Ingest>);
...
public class Sensorcharacteristics_IngestT
{
  ...
  public Sensorcharacteristics_Ingest_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }

  public Sensorcharacteristics_IngestT() {
    this.Id = null;
    this.IdSensor = null;
    ...
    this.Source = null;
    this.DataMode = Sensorcharacteristics_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
  }
  public static Sensorcharacteristics_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Sensorcharacteristics_Ingest.GetRootAsSensorcharacteristics_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Sensorcharacteristics_Ingest.FinishSensorcharacteristics_IngestBuffer(fbb, Sensorcharacteristics_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Sensorcharacteristics_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 106 /*DataMode*/, 1 /*Sensorcharacteristics_Ingest_dataMode_Enum*/, 1, false)
