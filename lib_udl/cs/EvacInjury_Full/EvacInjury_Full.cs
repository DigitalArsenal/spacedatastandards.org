...
/// /// Injury specifics.
public struct EvacInjury_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EvacInjury_Full GetRootAsEvacInjury_Full(ByteBuffer _bb) { return GetRootAsEvacInjury_Full(_bb, new EvacInjury_Full()); }
  public static EvacInjury_Full GetRootAsEvacInjury_Full(ByteBuffer _bb, EvacInjury_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EvacInjury_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EVAC"); }
  public static bool VerifyEvacInjury_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EVAC", false, EvacInjury_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EvacInjury_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<EvacInjury_Full> CreateEvacInjury_Full(FlatBufferBuilder builder,
  ...
  public static void StartEvacInjury_Full(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<EvacInjury_Full> EndEvacInjury_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EvacInjury_Full>(o);
  }
  public static void FinishEvacInjury_FullBuffer(FlatBufferBuilder builder, Offset<EvacInjury_Full> offset) { builder.Finish(offset.Value, "EVAC"); }
  public static void FinishSizePrefixedEvacInjury_FullBuffer(FlatBufferBuilder builder, Offset<EvacInjury_Full> offset) { builder.FinishSizePrefixed(offset.Value, "EVAC"); }
  public EvacInjury_FullT UnPack() {
    var _o = new EvacInjury_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EvacInjury_FullT _o) {
    _o.Type = this.Type;
    _o.BodyPart = this.BodyPart;
    _o.Time = this.Time;
    _o.Comments = this.Comments;
  }
  public static Offset<EvacInjury_Full> Pack(FlatBufferBuilder builder, EvacInjury_FullT _o) {
    if (_o == null) return default(Offset<EvacInjury_Full>);
...
public class EvacInjury_FullT
{
  ...
  public EvacInjury_FullT() {
    this.Type = null;
    this.BodyPart = null;
    this.Time = null;
    this.Comments = null;
  }
  public static EvacInjury_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return EvacInjury_Full.GetRootAsEvacInjury_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EvacInjury_Full.FinishEvacInjury_FullBuffer(fbb, EvacInjury_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EvacInjury_FullVerify
{
