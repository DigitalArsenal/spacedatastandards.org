...
public struct EvacCasualtyInfo_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static EvacCasualtyInfo_Full GetRootAsEvacCasualtyInfo_Full(ByteBuffer _bb, EvacCasualtyInfo_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EvacCasualtyInfo_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EVAC"); }
  public static bool VerifyEvacCasualtyInfo_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EVAC", false, EvacCasualtyInfo_FullVerify.Verify); }
  ...
  public static Offset<EvacCasualtyInfo_Full> CreateEvacCasualtyInfo_Full(FlatBufferBuilder builder,
  ...
  public static Offset<EvacCasualtyInfo_Full> EndEvacCasualtyInfo_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EvacCasualtyInfo_Full>(o);
  }
  public static void FinishEvacCasualtyInfo_FullBuffer(FlatBufferBuilder builder, Offset<EvacCasualtyInfo_Full> offset) { builder.Finish(offset.Value, "EVAC"); }
  public static void FinishSizePrefixedEvacCasualtyInfo_FullBuffer(FlatBufferBuilder builder, Offset<EvacCasualtyInfo_Full> offset) { builder.FinishSizePrefixed(offset.Value, "EVAC"); }
  public EvacCasualtyInfo_FullT UnPack() {
    var _o = new EvacCasualtyInfo_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EvacCasualtyInfo_FullT _o) {
  ...
  public static Offset<EvacCasualtyInfo_Full> Pack(FlatBufferBuilder builder, EvacCasualtyInfo_FullT _o) {
    if (_o == null) return default(Offset<EvacCasualtyInfo_Full>);
...
public class EvacCasualtyInfo_FullT
{
  ...
  public static EvacCasualtyInfo_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return EvacCasualtyInfo_Full.GetRootAsEvacCasualtyInfo_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EvacCasualtyInfo_Full.FinishEvacCasualtyInfo_FullBuffer(fbb, EvacCasualtyInfo_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EvacCasualtyInfo_FullVerify
{
