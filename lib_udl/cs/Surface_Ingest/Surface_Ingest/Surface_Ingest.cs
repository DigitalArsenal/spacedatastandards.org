...
public struct Surface_Ingest : IFlatbufferObject
{
  ...
  public static Offset<Surface_Ingest.Surface_Ingest> CreateSurface_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<Surface_Ingest.Surface_Ingest> EndSurface_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Surface_Ingest.Surface_Ingest>(o);
  }
  ...
  public static Offset<Surface_Ingest.Surface_Ingest> Pack(FlatBufferBuilder builder, Surface_IngestT _o) {
    if (_o == null) return default(Offset<Surface_Ingest.Surface_Ingest>);
