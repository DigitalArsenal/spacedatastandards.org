...
public struct Surface_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static Surface_Ingest GetRootAsSurface_Ingest(ByteBuffer _bb, Surface_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Surface_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SURF"); }
  public static bool VerifySurface_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SURF", false, Surface_IngestVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Surface_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(106); return o != 0 ? (Surface_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Surface_Ingest_dataMode_Enum.REAL; } }

  public static Offset<Surface_Ingest> CreateSurface_Ingest(FlatBufferBuilder builder,
      ...
      Surface_Ingest_dataMode_Enum dataMode = Surface_Ingest_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Surface_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(51, (sbyte)dataMode, 0); }
  public static Offset<Surface_Ingest> EndSurface_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Surface_Ingest>(o);
  }
  public static void FinishSurface_IngestBuffer(FlatBufferBuilder builder, Offset<Surface_Ingest> offset) { builder.Finish(offset.Value, "SURF"); }
  public static void FinishSizePrefixedSurface_IngestBuffer(FlatBufferBuilder builder, Offset<Surface_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "SURF"); }
  public Surface_IngestT UnPack() {
    var _o = new Surface_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Surface_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Surface_Ingest> Pack(FlatBufferBuilder builder, Surface_IngestT _o) {
    if (_o == null) return default(Offset<Surface_Ingest>);
...
public class Surface_IngestT
{
  ...
  public Surface_Ingest_dataMode_Enum DataMode { get; set; }

  public Surface_IngestT() {
    this.Id = null;
    ...
    this.DataMode = Surface_Ingest_dataMode_Enum.REAL;
  }
  public static Surface_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Surface_Ingest.GetRootAsSurface_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Surface_Ingest.FinishSurface_IngestBuffer(fbb, Surface_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Surface_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 106 /*DataMode*/, 1 /*Surface_Ingest_dataMode_Enum*/, 1, false)
