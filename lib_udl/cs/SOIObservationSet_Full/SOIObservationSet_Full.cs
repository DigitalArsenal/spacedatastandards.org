...
public struct SOIObservationSet_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static SOIObservationSet_Full GetRootAsSOIObservationSet_Full(ByteBuffer _bb, SOIObservationSet_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SOIObservationSet_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SOIO"); }
  public static bool VerifySOIObservationSet_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SOIO", false, SOIObservationSet_FullVerify.Verify); }
  ...
  public SOIObservationSet_Full_type_Enum Type { get { int o = __p.__offset(48); return o != 0 ? (SOIObservationSet_Full_type_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SOIObservationSet_Full_type_Enum.OPTICAL; } }
  ...
  public SOIObservationSet_Full_referenceFrame_Enum ReferenceFrame { get { int o = __p.__offset(54); return o != 0 ? (SOIObservationSet_Full_referenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SOIObservationSet_Full_referenceFrame_Enum.J2000; } }
  /// The reference frame of the observing sensor state. If the senReferenceFrame is null it is assumed to be J2000.
  /// Example: /// Example: J2000
  /// Constraints: Minimum length = 0, Maximum length = 24
  public SOIObservationSet_Full_senReferenceFrame_Enum SenReferenceFrame { get { int o = __p.__offset(56); return o != 0 ? (SOIObservationSet_Full_senReferenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SOIObservationSet_Full_senReferenceFrame_Enum.J2000; } }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SOIObservationSet_Full_dataMode_Enum DataMode { get { int o = __p.__offset(148); return o != 0 ? (SOIObservationSet_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SOIObservationSet_Full_dataMode_Enum.REAL; } }

  public static Offset<SOIObservationSet_Full> CreateSOIObservationSet_Full(FlatBufferBuilder builder,
      ...
      int numObs = 0,
      SOIObservationSet_Full_type_Enum type = SOIObservationSet_Full_type_Enum.OPTICAL,
      double polarAngleStart = 0.0,
      double polarAngleEnd = 0.0,
      SOIObservationSet_Full_referenceFrame_Enum referenceFrame = SOIObservationSet_Full_referenceFrame_Enum.J2000,
      SOIObservationSet_Full_senReferenceFrame_Enum senReferenceFrame = SOIObservationSet_Full_senReferenceFrame_Enum.J2000,
      ...
      SOIObservationSet_Full_dataMode_Enum dataMode = SOIObservationSet_Full_dataMode_Enum.REAL) {
  ...
  public static void AddType(FlatBufferBuilder builder, SOIObservationSet_Full_type_Enum type) { builder.AddSbyte(22, (sbyte)type, 0); }
  ...
  public static void AddReferenceFrame(FlatBufferBuilder builder, SOIObservationSet_Full_referenceFrame_Enum referenceFrame) { builder.AddSbyte(25, (sbyte)referenceFrame, 0); }
  public static void AddSenReferenceFrame(FlatBufferBuilder builder, SOIObservationSet_Full_senReferenceFrame_Enum senReferenceFrame) { builder.AddSbyte(26, (sbyte)senReferenceFrame, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SOIObservationSet_Full_dataMode_Enum dataMode) { builder.AddSbyte(72, (sbyte)dataMode, 0); }
  public static Offset<SOIObservationSet_Full> EndSOIObservationSet_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SOIObservationSet_Full>(o);
  }
  public static void FinishSOIObservationSet_FullBuffer(FlatBufferBuilder builder, Offset<SOIObservationSet_Full> offset) { builder.Finish(offset.Value, "SOIO"); }
  public static void FinishSizePrefixedSOIObservationSet_FullBuffer(FlatBufferBuilder builder, Offset<SOIObservationSet_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SOIO"); }
  public SOIObservationSet_FullT UnPack() {
    var _o = new SOIObservationSet_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SOIObservationSet_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SOIObservationSet_Full> Pack(FlatBufferBuilder builder, SOIObservationSet_FullT _o) {
    if (_o == null) return default(Offset<SOIObservationSet_Full>);
...
public class SOIObservationSet_FullT
{
  ...
  public SOIObservationSet_Full_type_Enum Type { get; set; }
  public double PolarAngleStart { get; set; }
  public double PolarAngleEnd { get; set; }
  public SOIObservationSet_Full_referenceFrame_Enum ReferenceFrame { get; set; }
  public SOIObservationSet_Full_senReferenceFrame_Enum SenReferenceFrame { get; set; }
  ...
  public SOIObservationSet_Full_dataMode_Enum DataMode { get; set; }

  public SOIObservationSet_FullT() {
    this.Id = null;
    ...
    this.EndTime = null;
    this.NumObs = 0;
    this.Type = SOIObservationSet_Full_type_Enum.OPTICAL;
    this.PolarAngleStart = 0.0;
    this.PolarAngleEnd = 0.0;
    this.ReferenceFrame = SOIObservationSet_Full_referenceFrame_Enum.J2000;
    this.SenReferenceFrame = SOIObservationSet_Full_senReferenceFrame_Enum.J2000;
    ...
    this.SourceDL = null;
    this.DataMode = SOIObservationSet_Full_dataMode_Enum.REAL;
  }
  public static SOIObservationSet_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return SOIObservationSet_Full.GetRootAsSOIObservationSet_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SOIObservationSet_Full.FinishSOIObservationSet_FullBuffer(fbb, SOIObservationSet_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SOIObservationSet_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 48 /*Type*/, 1 /*SOIObservationSet_Full_type_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 54 /*ReferenceFrame*/, 1 /*SOIObservationSet_Full_referenceFrame_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 56 /*SenReferenceFrame*/, 1 /*SOIObservationSet_Full_senReferenceFrame_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 148 /*DataMode*/, 1 /*SOIObservationSet_Full_dataMode_Enum*/, 1, false)
