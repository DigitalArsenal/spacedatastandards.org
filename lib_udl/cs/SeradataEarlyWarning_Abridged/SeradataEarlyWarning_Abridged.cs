...
public struct SeradataEarlyWarning_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SeradataEarlyWarning_Abridged GetRootAsSeradataEarlyWarning_Abridged(ByteBuffer _bb) { return GetRootAsSeradataEarlyWarning_Abridged(_bb, new SeradataEarlyWarning_Abridged()); }
  public static SeradataEarlyWarning_Abridged GetRootAsSeradataEarlyWarning_Abridged(ByteBuffer _bb, SeradataEarlyWarning_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SeradataEarlyWarning_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SERA"); }
  public static bool VerifySeradataEarlyWarning_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SERA", false, SeradataEarlyWarning_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SeradataEarlyWarning_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public SeradataEarlyWarning_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(46); return o != 0 ? (SeradataEarlyWarning_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SeradataEarlyWarning_Abridged_dataMode_Enum.REAL; } }

  public static Offset<SeradataEarlyWarning_Abridged> CreateSeradataEarlyWarning_Abridged(FlatBufferBuilder builder,
      ...
      SeradataEarlyWarning_Abridged_dataMode_Enum dataMode = SeradataEarlyWarning_Abridged_dataMode_Enum.REAL) {
    builder.StartTable(22);
    SeradataEarlyWarning_Abridged.AddBestResolution(builder, bestResolution);
    SeradataEarlyWarning_Abridged.AddOrigNetwork(builder, origNetworkOffset);
    SeradataEarlyWarning_Abridged.AddOrigin(builder, originOffset);
    SeradataEarlyWarning_Abridged.AddSource(builder, sourceOffset);
    SeradataEarlyWarning_Abridged.AddCreatedBy(builder, createdByOffset);
    SeradataEarlyWarning_Abridged.AddCreatedAt(builder, createdAtOffset);
    SeradataEarlyWarning_Abridged.AddPayloadNotes(builder, payloadNotesOffset);
    SeradataEarlyWarning_Abridged.AddPartnerSpacecraftId(builder, partnerSpacecraftIdOffset);
    SeradataEarlyWarning_Abridged.AddMissileLaunchPhaseDetectionAbility(builder, missileLaunchPhaseDetectionAbilityOffset);
    SeradataEarlyWarning_Abridged.AddGroundStationLocations(builder, groundStationLocationsOffset);
    SeradataEarlyWarning_Abridged.AddGroundStations(builder, groundStationsOffset);
    SeradataEarlyWarning_Abridged.AddFrequencyLimits(builder, frequencyLimitsOffset);
    SeradataEarlyWarning_Abridged.AddSpectralBands(builder, spectralBandsOffset);
    SeradataEarlyWarning_Abridged.AddName(builder, nameOffset);
    SeradataEarlyWarning_Abridged.AddManufacturerOrgId(builder, manufacturerOrgIdOffset);
    SeradataEarlyWarning_Abridged.AddHostedForCompanyOrgId(builder, hostedForCompanyOrgIdOffset);
    SeradataEarlyWarning_Abridged.AddSpacecraftId(builder, spacecraftIdOffset);
    SeradataEarlyWarning_Abridged.AddIdIR(builder, idIROffset);
    SeradataEarlyWarning_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    SeradataEarlyWarning_Abridged.AddId(builder, idOffset);
    SeradataEarlyWarning_Abridged.AddDataMode(builder, dataMode);
    SeradataEarlyWarning_Abridged.AddEarthPointing(builder, earthPointing);
    return SeradataEarlyWarning_Abridged.EndSeradataEarlyWarning_Abridged(builder);
  }

  public static void StartSeradataEarlyWarning_Abridged(FlatBufferBuilder builder) { builder.StartTable(22); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SeradataEarlyWarning_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(21, (sbyte)dataMode, 0); }
  public static Offset<SeradataEarlyWarning_Abridged> EndSeradataEarlyWarning_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SeradataEarlyWarning_Abridged>(o);
  }
  public static void FinishSeradataEarlyWarning_AbridgedBuffer(FlatBufferBuilder builder, Offset<SeradataEarlyWarning_Abridged> offset) { builder.Finish(offset.Value, "SERA"); }
  public static void FinishSizePrefixedSeradataEarlyWarning_AbridgedBuffer(FlatBufferBuilder builder, Offset<SeradataEarlyWarning_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "SERA"); }
  public SeradataEarlyWarning_AbridgedT UnPack() {
    var _o = new SeradataEarlyWarning_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SeradataEarlyWarning_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SeradataEarlyWarning_Abridged> Pack(FlatBufferBuilder builder, SeradataEarlyWarning_AbridgedT _o) {
    if (_o == null) return default(Offset<SeradataEarlyWarning_Abridged>);
...
public class SeradataEarlyWarning_AbridgedT
{
  ...
  public SeradataEarlyWarning_Abridged_dataMode_Enum DataMode { get; set; }

  public SeradataEarlyWarning_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = SeradataEarlyWarning_Abridged_dataMode_Enum.REAL;
  }
  public static SeradataEarlyWarning_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return SeradataEarlyWarning_Abridged.GetRootAsSeradataEarlyWarning_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SeradataEarlyWarning_Abridged.FinishSeradataEarlyWarning_AbridgedBuffer(fbb, SeradataEarlyWarning_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SeradataEarlyWarning_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 46 /*DataMode*/, 1 /*SeradataEarlyWarning_Abridged_dataMode_Enum*/, 1, false)
