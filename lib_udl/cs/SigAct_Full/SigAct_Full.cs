...
public struct SigAct_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static SigAct_Full GetRootAsSigAct_Full(ByteBuffer _bb, SigAct_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SigAct_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SIGA"); }
  public static bool VerifySigAct_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SIGA", false, SigAct_FullVerify.Verify); }
  ...
  public SigAct_Full_dataMode_Enum DataMode { get { int o = __p.__offset(166); return o != 0 ? (SigAct_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SigAct_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<SigAct_Full> CreateSigAct_Full(FlatBufferBuilder builder,
      ...
      SigAct_Full_dataMode_Enum dataMode = SigAct_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SigAct_Full_dataMode_Enum dataMode) { builder.AddSbyte(81, (sbyte)dataMode, 0); }
  ...
  public static Offset<SigAct_Full> EndSigAct_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SigAct_Full>(o);
  }
  public static void FinishSigAct_FullBuffer(FlatBufferBuilder builder, Offset<SigAct_Full> offset) { builder.Finish(offset.Value, "SIGA"); }
  public static void FinishSizePrefixedSigAct_FullBuffer(FlatBufferBuilder builder, Offset<SigAct_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SIGA"); }
  public SigAct_FullT UnPack() {
    var _o = new SigAct_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SigAct_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SigAct_Full> Pack(FlatBufferBuilder builder, SigAct_FullT _o) {
    if (_o == null) return default(Offset<SigAct_Full>);
...
public class SigAct_FullT
{
  ...
  public SigAct_Full_dataMode_Enum DataMode { get; set; }
  ...
  public SigAct_FullT() {
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = SigAct_Full_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static SigAct_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return SigAct_Full.GetRootAsSigAct_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SigAct_Full.FinishSigAct_FullBuffer(fbb, SigAct_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SigAct_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 166 /*DataMode*/, 1 /*SigAct_Full_dataMode_Enum*/, 1, false)
