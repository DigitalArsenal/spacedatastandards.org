...
public struct OnorbitDetails_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static OnorbitDetails_Abridged GetRootAsOnorbitDetails_Abridged(ByteBuffer _bb) { return GetRootAsOnorbitDetails_Abridged(_bb, new OnorbitDetails_Abridged()); }
  public static OnorbitDetails_Abridged GetRootAsOnorbitDetails_Abridged(ByteBuffer _bb, OnorbitDetails_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OnorbitDetails_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONOR"); }
  public static bool VerifyOnorbitDetails_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONOR", false, OnorbitDetails_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public OnorbitDetails_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public OnorbitDetails_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(92); return o != 0 ? (OnorbitDetails_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OnorbitDetails_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<OnorbitDetails_Abridged> CreateOnorbitDetails_Abridged(FlatBufferBuilder builder,
      ...
      OnorbitDetails_Abridged_dataMode_Enum dataMode = OnorbitDetails_Abridged_dataMode_Enum.REAL,
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset),
      StringOffset origNetworkOffset = default(StringOffset)) {
    builder.StartTable(48);
    OnorbitDetails_Abridged.AddAdeptRadius(builder, adeptRadius);
    OnorbitDetails_Abridged.AddColaRadius(builder, colaRadius);
    OnorbitDetails_Abridged.AddMaxRadius(builder, maxRadius);
    OnorbitDetails_Abridged.AddBusCrossSection(builder, busCrossSection);
    OnorbitDetails_Abridged.AddCrossSection(builder, crossSection);
    OnorbitDetails_Abridged.AddFuelRemaining(builder, fuelRemaining);
    OnorbitDetails_Abridged.AddSolarArrayArea(builder, solarArrayArea);
    OnorbitDetails_Abridged.AddTotalMassUnc(builder, totalMassUnc);
    OnorbitDetails_Abridged.AddCurrentMass(builder, currentMass);
    OnorbitDetails_Abridged.AddBolFuelMass(builder, bolFuelMass);
    OnorbitDetails_Abridged.AddLaunchMassMax(builder, launchMassMax);
    OnorbitDetails_Abridged.AddLaunchMass(builder, launchMass);
    OnorbitDetails_Abridged.AddLaunchMassMin(builder, launchMassMin);
    OnorbitDetails_Abridged.AddAdditionalMass(builder, additionalMass);
    OnorbitDetails_Abridged.AddDryMass(builder, dryMass);
    OnorbitDetails_Abridged.AddDriftRate(builder, driftRate);
    OnorbitDetails_Abridged.AddGeoSlot(builder, geoSlot);
    OnorbitDetails_Abridged.AddEstDeltaVDuration(builder, estDeltaVDuration);
    OnorbitDetails_Abridged.AddDeltaVUnc(builder, deltaVUnc);
    OnorbitDetails_Abridged.AddMaxDeltaV(builder, maxDeltaV);
    OnorbitDetails_Abridged.AddBolDeltaV(builder, bolDeltaV);
    OnorbitDetails_Abridged.AddRcsMean(builder, rcsMean);
    OnorbitDetails_Abridged.AddRcsMax(builder, rcsMax);
    OnorbitDetails_Abridged.AddRcsMin(builder, rcsMin);
    OnorbitDetails_Abridged.AddRcs(builder, rcs);
    OnorbitDetails_Abridged.AddVismagMean(builder, vismagMean);
    OnorbitDetails_Abridged.AddVismagMax(builder, vismagMax);
    OnorbitDetails_Abridged.AddVismagMin(builder, vismagMin);
    OnorbitDetails_Abridged.AddVismag(builder, vismag);
    OnorbitDetails_Abridged.AddOrigNetwork(builder, origNetworkOffset);
    OnorbitDetails_Abridged.AddCreatedBy(builder, createdByOffset);
    OnorbitDetails_Abridged.AddCreatedAt(builder, createdAtOffset);
    OnorbitDetails_Abridged.AddLastObSource(builder, lastObSourceOffset);
    OnorbitDetails_Abridged.AddOrigin(builder, originOffset);
    OnorbitDetails_Abridged.AddSource(builder, sourceOffset);
    OnorbitDetails_Abridged.AddDepMassUncs(builder, depMassUncsOffset);
    OnorbitDetails_Abridged.AddDepEstMasses(builder, depEstMassesOffset);
    OnorbitDetails_Abridged.AddDepNames(builder, depNamesOffset);
    OnorbitDetails_Abridged.AddNumDeployable(builder, numDeployable);
    OnorbitDetails_Abridged.AddBusType(builder, busTypeOffset);
    OnorbitDetails_Abridged.AddMissionTypes(builder, missionTypesOffset);
    OnorbitDetails_Abridged.AddNumMission(builder, numMission);
    OnorbitDetails_Abridged.AddLastObTime(builder, lastObTimeOffset);
    OnorbitDetails_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    OnorbitDetails_Abridged.AddIdOnOrbit(builder, idOnOrbitOffset);
    OnorbitDetails_Abridged.AddId(builder, idOffset);
    OnorbitDetails_Abridged.AddDataMode(builder, dataMode);
    OnorbitDetails_Abridged.AddManeuverable(builder, maneuverable);
    return OnorbitDetails_Abridged.EndOnorbitDetails_Abridged(builder);
  }

  public static void StartOnorbitDetails_Abridged(FlatBufferBuilder builder) { builder.StartTable(48); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OnorbitDetails_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(44, (sbyte)dataMode, 0); }
  ...
  public static Offset<OnorbitDetails_Abridged> EndOnorbitDetails_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OnorbitDetails_Abridged>(o);
  }
  public static void FinishOnorbitDetails_AbridgedBuffer(FlatBufferBuilder builder, Offset<OnorbitDetails_Abridged> offset) { builder.Finish(offset.Value, "ONOR"); }
  public static void FinishSizePrefixedOnorbitDetails_AbridgedBuffer(FlatBufferBuilder builder, Offset<OnorbitDetails_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "ONOR"); }
  public OnorbitDetails_AbridgedT UnPack() {
    var _o = new OnorbitDetails_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OnorbitDetails_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OnorbitDetails_Abridged> Pack(FlatBufferBuilder builder, OnorbitDetails_AbridgedT _o) {
    if (_o == null) return default(Offset<OnorbitDetails_Abridged>);
...
public class OnorbitDetails_AbridgedT
{
  ...
  public OnorbitDetails_Abridged_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string OrigNetwork { get; set; }

  public OnorbitDetails_AbridgedT() {
    this.Id = null;
    this.IdOnOrbit = null;
    ...
    this.DataMode = OnorbitDetails_Abridged_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.OrigNetwork = null;
  }
  public static OnorbitDetails_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return OnorbitDetails_Abridged.GetRootAsOnorbitDetails_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OnorbitDetails_Abridged.FinishOnorbitDetails_AbridgedBuffer(fbb, OnorbitDetails_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OnorbitDetails_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 92 /*DataMode*/, 1 /*OnorbitDetails_Abridged_dataMode_Enum*/, 1, false)
