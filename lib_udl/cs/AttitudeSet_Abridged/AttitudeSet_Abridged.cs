...
public struct AttitudeSet_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AttitudeSet_Abridged GetRootAsAttitudeSet_Abridged(ByteBuffer _bb) { return GetRootAsAttitudeSet_Abridged(_bb, new AttitudeSet_Abridged()); }
  public static AttitudeSet_Abridged GetRootAsAttitudeSet_Abridged(ByteBuffer _bb, AttitudeSet_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AttitudeSet_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ATTI"); }
  public static bool VerifyAttitudeSet_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ATTI", false, AttitudeSet_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AttitudeSet_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: No constraints specified.
  public string StartTime { get { int o = __p.__offset(22); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetStartTimeBytes() { return __p.__vector_as_span<byte>(22, 1); }
#else
  public ArraySegment<byte>? GetStartTimeBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public byte[] GetStartTimeArray() { return __p.__vector_as_array<byte>(22); }
  ...
  /// Constraints: No constraints specified.
  public string EndTime { get { int o = __p.__offset(24); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetEndTimeBytes() { return __p.__vector_as_span<byte>(24, 1); }
#else
  public ArraySegment<byte>? GetEndTimeBytes() { return __p.__vector_as_arraysegment(24); }
#endif
  public byte[] GetEndTimeArray() { return __p.__vector_as_array<byte>(24); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 36
  public string Frame1 { get { int o = __p.__offset(26); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetFrame1Bytes() { return __p.__vector_as_span<byte>(26, 1); }
#else
  public ArraySegment<byte>? GetFrame1Bytes() { return __p.__vector_as_arraysegment(26); }
#endif
  public byte[] GetFrame1Array() { return __p.__vector_as_array<byte>(26); }
  /// Reference frame 2 of the quaternion or Euler angle transformation utilized in this attitude parameter or attitude ephemeris.  The UDL convention is that transformations occur FROM frame1 TO frame2.  A specific spacecraft frame or instrument name may be provided with the assumption the consumer understands the location of these frames (ex. SC BODY, J2000, LVLH, ICRF, INSTRUMENTx, THRUSTERx, etc.).
  /// Example: /// Example: J2000
  /// Constraints: Minimum length = 1, Maximum length = 36
  public string Frame2 { get { int o = __p.__offset(28); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetFrame2Bytes() { return __p.__vector_as_span<byte>(28, 1); }
#else
  public ArraySegment<byte>? GetFrame2Bytes() { return __p.__vector_as_arraysegment(28); }
#endif
  public byte[] GetFrame2Array() { return __p.__vector_as_array<byte>(28); }
  /// Number of attitude records contained in this set.
  /// Example: /// Example: 120
  /// Constraints: No constraints specified.
  public int NumPoints { get { int o = __p.__offset(30); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  /// Attitude ephemeris step size, in seconds. This applies to Attitude Ephemeris Messages (AEM) that employ a fixed step size.
  /// Example: /// Example: 60
  /// Constraints: No constraints specified.
  public int StepSize { get { int o = __p.__offset(32); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  /// Initial precession angle (ECI J2000 frame) in degrees.
  /// Example: /// Example: 30.5
  /// Constraints: No constraints specified.
  public double PrecAngleInit { get { int o = __p.__offset(34); return o != 0 ? __p.bb.GetDouble(o + __p.bb_pos) : (double)0.0; } }
  /// Initial spin angle (ECI J2000 frame) in degrees.
  /// Example: /// Example: 25.5
  /// Constraints: No constraints specified.
  public double SpinAngleInit { get { int o = __p.__offset(36); return o != 0 ? __p.bb.GetDouble(o + __p.bb_pos) : (double)0.0; } }
  ...
  public string EulerRotSeq { get { int o = __p.__offset(38); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetEulerRotSeqBytes() { return __p.__vector_as_span<byte>(38, 1); }
#else
  public ArraySegment<byte>? GetEulerRotSeqBytes() { return __p.__vector_as_arraysegment(38); }
#endif
  public byte[] GetEulerRotSeqArray() { return __p.__vector_as_array<byte>(38); }
  /// Recommended interpolation method for estimating attitude ephemeris data.
  /// Example: /// Example: LINEAR
  /// Constraints: Minimum length = 0, Maximum length = 16
  public string Interpolator { get { int o = __p.__offset(40); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetInterpolatorBytes() { return __p.__vector_as_span<byte>(40, 1); }
#else
  public ArraySegment<byte>? GetInterpolatorBytes() { return __p.__vector_as_arraysegment(40); }
#endif
  public byte[] GetInterpolatorArray() { return __p.__vector_as_array<byte>(40); }
  /// Recommended polynomial interpolation degree.
  /// Example: /// Example: 2
  /// Constraints: No constraints specified.
  public int InterpolatorDegree { get { int o = __p.__offset(42); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 36
  public string Source { get { int o = __p.__offset(50); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceBytes() { return __p.__vector_as_span<byte>(50, 1); }
#else
  public ArraySegment<byte>? GetSourceBytes() { return __p.__vector_as_arraysegment(50); }
#endif
  public byte[] GetSourceArray() { return __p.__vector_as_array<byte>(50); }
  /// Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
  /// Example: /// Example: THIRD_PARTY_DATASOURCE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Origin { get { int o = __p.__offset(52); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOriginBytes() { return __p.__vector_as_span<byte>(52, 1); }
#else
  public ArraySegment<byte>? GetOriginBytes() { return __p.__vector_as_arraysegment(52); }
#endif
  public byte[] GetOriginArray() { return __p.__vector_as_array<byte>(52); }
  ...
  public AttitudeSet_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(54); return o != 0 ? (AttitudeSet_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AttitudeSet_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<AttitudeSet_Abridged> CreateAttitudeSet_Abridged(FlatBufferBuilder builder,
      ...
      AttitudeSet_Abridged_dataMode_Enum dataMode = AttitudeSet_Abridged_dataMode_Enum.REAL,
  ...
  public static void StartAttitudeSet_Abridged(FlatBufferBuilder builder) { builder.StartTable(27); }
  ...
  public static void AddFrame1(FlatBufferBuilder builder, StringOffset frame1Offset) { builder.AddOffset(11, frame1Offset.Value, 0); }
  public static void AddFrame2(FlatBufferBuilder builder, StringOffset frame2Offset) { builder.AddOffset(12, frame2Offset.Value, 0); }
  public static void AddNumPoints(FlatBufferBuilder builder, int numPoints) { builder.AddInt(13, numPoints, 0); }
  public static void AddStepSize(FlatBufferBuilder builder, int stepSize) { builder.AddInt(14, stepSize, 0); }
  public static void AddPrecAngleInit(FlatBufferBuilder builder, double precAngleInit) { builder.AddDouble(15, precAngleInit, 0.0); }
  public static void AddSpinAngleInit(FlatBufferBuilder builder, double spinAngleInit) { builder.AddDouble(16, spinAngleInit, 0.0); }
  public static void AddEulerRotSeq(FlatBufferBuilder builder, StringOffset eulerRotSeqOffset) { builder.AddOffset(17, eulerRotSeqOffset.Value, 0); }
  public static void AddInterpolator(FlatBufferBuilder builder, StringOffset interpolatorOffset) { builder.AddOffset(18, interpolatorOffset.Value, 0); }
  public static void AddInterpolatorDegree(FlatBufferBuilder builder, int interpolatorDegree) { builder.AddInt(19, interpolatorDegree, 0); }
  ...
  public static void AddSource(FlatBufferBuilder builder, StringOffset sourceOffset) { builder.AddOffset(23, sourceOffset.Value, 0); }
  public static void AddOrigin(FlatBufferBuilder builder, StringOffset originOffset) { builder.AddOffset(24, originOffset.Value, 0); }
  public static void AddDataMode(FlatBufferBuilder builder, AttitudeSet_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(25, (sbyte)dataMode, 0); }
  ...
  public static Offset<AttitudeSet_Abridged> EndAttitudeSet_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AttitudeSet_Abridged>(o);
  }
  public static void FinishAttitudeSet_AbridgedBuffer(FlatBufferBuilder builder, Offset<AttitudeSet_Abridged> offset) { builder.Finish(offset.Value, "ATTI"); }
  public static void FinishSizePrefixedAttitudeSet_AbridgedBuffer(FlatBufferBuilder builder, Offset<AttitudeSet_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "ATTI"); }
  public AttitudeSet_AbridgedT UnPack() {
    var _o = new AttitudeSet_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AttitudeSet_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AttitudeSet_Abridged> Pack(FlatBufferBuilder builder, AttitudeSet_AbridgedT _o) {
    if (_o == null) return default(Offset<AttitudeSet_Abridged>);
    ...
    return CreateAttitudeSet_Abridged(
      builder,
      _id,
...
public class AttitudeSet_AbridgedT
{
  ...
  public AttitudeSet_Abridged_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public AttitudeSet_AbridgedT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = AttitudeSet_Abridged_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static AttitudeSet_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return AttitudeSet_Abridged.GetRootAsAttitudeSet_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AttitudeSet_Abridged.FinishAttitudeSet_AbridgedBuffer(fbb, AttitudeSet_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AttitudeSet_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyString(tablePos, 22 /*StartTime*/, false)
      && verifier.VerifyString(tablePos, 24 /*EndTime*/, false)
      && verifier.VerifyString(tablePos, 26 /*Frame1*/, false)
      && verifier.VerifyString(tablePos, 28 /*Frame2*/, false)
      && verifier.VerifyField(tablePos, 30 /*NumPoints*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 32 /*StepSize*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 34 /*PrecAngleInit*/, 8 /*double*/, 8, false)
      && verifier.VerifyField(tablePos, 36 /*SpinAngleInit*/, 8 /*double*/, 8, false)
      && verifier.VerifyString(tablePos, 38 /*EulerRotSeq*/, false)
      && verifier.VerifyString(tablePos, 40 /*Interpolator*/, false)
      && verifier.VerifyField(tablePos, 42 /*InterpolatorDegree*/, 4 /*int*/, 4, false)
      ...
      && verifier.VerifyString(tablePos, 50 /*Source*/, false)
      && verifier.VerifyString(tablePos, 52 /*Origin*/, false)
      && verifier.VerifyField(tablePos, 54 /*DataMode*/, 1 /*AttitudeSet_Abridged_dataMode_Enum*/, 1, false)
