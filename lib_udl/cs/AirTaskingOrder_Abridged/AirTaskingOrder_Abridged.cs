...
public struct AirTaskingOrder_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirTaskingOrder_Abridged GetRootAsAirTaskingOrder_Abridged(ByteBuffer _bb) { return GetRootAsAirTaskingOrder_Abridged(_bb, new AirTaskingOrder_Abridged()); }
  public static AirTaskingOrder_Abridged GetRootAsAirTaskingOrder_Abridged(ByteBuffer _bb, AirTaskingOrder_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirTaskingOrder_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRT"); }
  public static bool VerifyAirTaskingOrder_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRT", false, AirTaskingOrder_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirTaskingOrder_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public AirTaskingOrder_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(46); return o != 0 ? (AirTaskingOrder_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirTaskingOrder_Abridged_dataMode_Enum.REAL; } }

  public static Offset<AirTaskingOrder_Abridged> CreateAirTaskingOrder_Abridged(FlatBufferBuilder builder,
      ...
      AirTaskingOrder_Abridged_dataMode_Enum dataMode = AirTaskingOrder_Abridged_dataMode_Enum.REAL) {
  ...
  public static void StartAirTaskingOrder_Abridged(FlatBufferBuilder builder) { builder.StartTable(22); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AirTaskingOrder_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(21, (sbyte)dataMode, 0); }
  public static Offset<AirTaskingOrder_Abridged> EndAirTaskingOrder_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirTaskingOrder_Abridged>(o);
  }
  public static void FinishAirTaskingOrder_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirTaskingOrder_Abridged> offset) { builder.Finish(offset.Value, "AIRT"); }
  public static void FinishSizePrefixedAirTaskingOrder_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirTaskingOrder_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "AIRT"); }
  public AirTaskingOrder_AbridgedT UnPack() {
    var _o = new AirTaskingOrder_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirTaskingOrder_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AirTaskingOrder_Abridged> Pack(FlatBufferBuilder builder, AirTaskingOrder_AbridgedT _o) {
    if (_o == null) return default(Offset<AirTaskingOrder_Abridged>);
...
public class AirTaskingOrder_AbridgedT
{
  ...
  public AirTaskingOrder_Abridged_dataMode_Enum DataMode { get; set; }

  public AirTaskingOrder_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = AirTaskingOrder_Abridged_dataMode_Enum.REAL;
  }
  public static AirTaskingOrder_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return AirTaskingOrder_Abridged.GetRootAsAirTaskingOrder_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirTaskingOrder_Abridged.FinishAirTaskingOrder_AbridgedBuffer(fbb, AirTaskingOrder_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirTaskingOrder_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 46 /*DataMode*/, 1 /*AirTaskingOrder_Abridged_dataMode_Enum*/, 1, false)
