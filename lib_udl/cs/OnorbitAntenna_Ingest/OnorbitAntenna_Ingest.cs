...
public struct OnorbitAntenna_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static OnorbitAntenna_Ingest GetRootAsOnorbitAntenna_Ingest(ByteBuffer _bb, OnorbitAntenna_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OnorbitAntenna_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONOR"); }
  public static bool VerifyOnorbitAntenna_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONOR", false, OnorbitAntenna_IngestVerify.Verify); }
  ...
  public OnorbitAntenna_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(20); return o != 0 ? (OnorbitAntenna_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OnorbitAntenna_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<OnorbitAntenna_Ingest> CreateOnorbitAntenna_Ingest(FlatBufferBuilder builder,
      ...
      OnorbitAntenna_Ingest_dataMode_Enum dataMode = OnorbitAntenna_Ingest_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OnorbitAntenna_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(8, (sbyte)dataMode, 0); }
  ...
  public static Offset<OnorbitAntenna_Ingest> EndOnorbitAntenna_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OnorbitAntenna_Ingest>(o);
  }
  public static void FinishOnorbitAntenna_IngestBuffer(FlatBufferBuilder builder, Offset<OnorbitAntenna_Ingest> offset) { builder.Finish(offset.Value, "ONOR"); }
  public static void FinishSizePrefixedOnorbitAntenna_IngestBuffer(FlatBufferBuilder builder, Offset<OnorbitAntenna_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "ONOR"); }
  public OnorbitAntenna_IngestT UnPack() {
    var _o = new OnorbitAntenna_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OnorbitAntenna_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OnorbitAntenna_Ingest> Pack(FlatBufferBuilder builder, OnorbitAntenna_IngestT _o) {
    if (_o == null) return default(Offset<OnorbitAntenna_Ingest>);
...
public class OnorbitAntenna_IngestT
{
  ...
  public OnorbitAntenna_Ingest_dataMode_Enum DataMode { get; set; }
  public string Antenna { get; set; }
  public string OrigNetwork { get; set; }

  public OnorbitAntenna_IngestT() {
    this.Id = null;
    this.IdOnOrbit = null;
    this.IdAntenna = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = OnorbitAntenna_Ingest_dataMode_Enum.REAL;
    this.Antenna = null;
    this.OrigNetwork = null;
  }
  public static OnorbitAntenna_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return OnorbitAntenna_Ingest.GetRootAsOnorbitAntenna_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OnorbitAntenna_Ingest.FinishOnorbitAntenna_IngestBuffer(fbb, OnorbitAntenna_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OnorbitAntenna_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*DataMode*/, 1 /*OnorbitAntenna_Ingest_dataMode_Enum*/, 1, false)
