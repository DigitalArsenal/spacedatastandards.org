...
public struct Status_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static Status_Full GetRootAsStatus_Full(ByteBuffer _bb, Status_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Status_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "STAT"); }
  public static bool VerifyStatus_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("STAT", false, Status_FullVerify.Verify); }
  ...
  public Status_Full_state_Enum State { get { int o = __p.__offset(16); return o != 0 ? (Status_Full_state_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Status_Full_state_Enum.UNKNOWN; } }
  /// System capability of the entity, if applicable (e.g. FMC, NMC, PMC, UNK).
  /// Example: /// Example: FMC
  /// Constraints: Minimum length = 0, Maximum length = 3
  public Status_Full_sysCap_Enum SysCap { get { int o = __p.__offset(18); return o != 0 ? (Status_Full_sysCap_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Status_Full_sysCap_Enum.FMC; } }
  /// Operation capability of the entity, if applicable (e.g. FMC, NMC, PMC, UNK).
  /// Example: /// Example: FMC
  /// Constraints: Minimum length = 0, Maximum length = 3
  public Status_Full_opsCap_Enum OpsCap { get { int o = __p.__offset(20); return o != 0 ? (Status_Full_opsCap_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Status_Full_opsCap_Enum.FMC; } }
  /// Source of the data.
  ...
  public Status_Full_dataMode_Enum DataMode { get { int o = __p.__offset(26); return o != 0 ? (Status_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Status_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<Status_Full> CreateStatus_Full(FlatBufferBuilder builder,
      ...
      Status_Full_state_Enum state = Status_Full_state_Enum.UNKNOWN,
      Status_Full_sysCap_Enum sysCap = Status_Full_sysCap_Enum.FMC,
      Status_Full_opsCap_Enum opsCap = Status_Full_opsCap_Enum.FMC,
      StringOffset sourceOffset = default(StringOffset),
      VectorOffset subStatusCollectionOffset = default(VectorOffset),
      Status_Full_dataMode_Enum dataMode = Status_Full_dataMode_Enum.REAL,
  ...
  public static void AddState(FlatBufferBuilder builder, Status_Full_state_Enum state) { builder.AddSbyte(6, (sbyte)state, 0); }
  public static void AddSysCap(FlatBufferBuilder builder, Status_Full_sysCap_Enum sysCap) { builder.AddSbyte(7, (sbyte)sysCap, 0); }
  public static void AddOpsCap(FlatBufferBuilder builder, Status_Full_opsCap_Enum opsCap) { builder.AddSbyte(8, (sbyte)opsCap, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Status_Full_dataMode_Enum dataMode) { builder.AddSbyte(11, (sbyte)dataMode, 0); }
  ...
  public static Offset<Status_Full> EndStatus_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Status_Full>(o);
  }
  public static void FinishStatus_FullBuffer(FlatBufferBuilder builder, Offset<Status_Full> offset) { builder.Finish(offset.Value, "STAT"); }
  public static void FinishSizePrefixedStatus_FullBuffer(FlatBufferBuilder builder, Offset<Status_Full> offset) { builder.FinishSizePrefixed(offset.Value, "STAT"); }
  public Status_FullT UnPack() {
    var _o = new Status_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Status_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Status_Full> Pack(FlatBufferBuilder builder, Status_FullT _o) {
    if (_o == null) return default(Offset<Status_Full>);
...
public class Status_FullT
{
  ...
  public Status_Full_state_Enum State { get; set; }
  public Status_Full_sysCap_Enum SysCap { get; set; }
  public Status_Full_opsCap_Enum OpsCap { get; set; }
  public string Source { get; set; }
  public List<string> SubStatusCollection { get; set; }
  public Status_Full_dataMode_Enum DataMode { get; set; }
  ...
  public Status_FullT() {
    ...
    this.IdEntity = null;
    this.State = Status_Full_state_Enum.UNKNOWN;
    this.SysCap = Status_Full_sysCap_Enum.FMC;
    this.OpsCap = Status_Full_opsCap_Enum.FMC;
    this.Source = null;
    this.SubStatusCollection = null;
    this.DataMode = Status_Full_dataMode_Enum.REAL;
    this.Notes = null;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.UpdatedAt = null;
  ...
  public static Status_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Status_Full.GetRootAsStatus_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Status_Full.FinishStatus_FullBuffer(fbb, Status_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Status_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*State*/, 1 /*Status_Full_state_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 18 /*SysCap*/, 1 /*Status_Full_sysCap_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 20 /*OpsCap*/, 1 /*Status_Full_opsCap_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 22 /*Source*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 24 /*SubStatusCollection*/, false)
      && verifier.VerifyField(tablePos, 26 /*DataMode*/, 1 /*Status_Full_dataMode_Enum*/, 1, false)
