...
public struct EvacCondition_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static EvacCondition_Abridged GetRootAsEvacCondition_Abridged(ByteBuffer _bb, EvacCondition_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EvacCondition_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EVAC"); }
  public static bool VerifyEvacCondition_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EVAC", false, EvacCondition_AbridgedVerify.Verify); }
  ...
  public static Offset<EvacCondition_Abridged> CreateEvacCondition_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<EvacCondition_Abridged> EndEvacCondition_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EvacCondition_Abridged>(o);
  }
  public static void FinishEvacCondition_AbridgedBuffer(FlatBufferBuilder builder, Offset<EvacCondition_Abridged> offset) { builder.Finish(offset.Value, "EVAC"); }
  public static void FinishSizePrefixedEvacCondition_AbridgedBuffer(FlatBufferBuilder builder, Offset<EvacCondition_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "EVAC"); }
  public EvacCondition_AbridgedT UnPack() {
    var _o = new EvacCondition_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EvacCondition_AbridgedT _o) {
    _o.Type = this.Type;
    _o.BodyPart = this.BodyPart;
    _o.Time = this.Time;
    _o.Comments = this.Comments;
  }
  public static Offset<EvacCondition_Abridged> Pack(FlatBufferBuilder builder, EvacCondition_AbridgedT _o) {
    if (_o == null) return default(Offset<EvacCondition_Abridged>);
...
public class EvacCondition_AbridgedT
{
  ...
  public EvacCondition_AbridgedT() {
    this.Type = null;
    this.BodyPart = null;
    this.Time = null;
    this.Comments = null;
  }
  public static EvacCondition_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return EvacCondition_Abridged.GetRootAsEvacCondition_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EvacCondition_Abridged.FinishEvacCondition_AbridgedBuffer(fbb, EvacCondition_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EvacCondition_AbridgedVerify
{
