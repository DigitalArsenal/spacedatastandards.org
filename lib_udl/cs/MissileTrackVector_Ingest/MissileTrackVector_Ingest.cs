...
public struct MissileTrackVector_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static MissileTrackVector_Ingest GetRootAsMissileTrackVector_Ingest(ByteBuffer _bb) { return GetRootAsMissileTrackVector_Ingest(_bb, new MissileTrackVector_Ingest()); }
  public static MissileTrackVector_Ingest GetRootAsMissileTrackVector_Ingest(ByteBuffer _bb, MissileTrackVector_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool MissileTrackVector_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MISS"); }
  public static bool VerifyMissileTrackVector_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MISS", false, MissileTrackVector_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public MissileTrackVector_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<MissileTrackVector_Ingest> CreateMissileTrackVector_Ingest(FlatBufferBuilder builder,
  ...
  public static void StartMissileTrackVector_Ingest(FlatBufferBuilder builder) { builder.StartTable(21); }
  ...
  public static Offset<MissileTrackVector_Ingest> EndMissileTrackVector_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<MissileTrackVector_Ingest>(o);
  }
  public static void FinishMissileTrackVector_IngestBuffer(FlatBufferBuilder builder, Offset<MissileTrackVector_Ingest> offset) { builder.Finish(offset.Value, "MISS"); }
  public static void FinishSizePrefixedMissileTrackVector_IngestBuffer(FlatBufferBuilder builder, Offset<MissileTrackVector_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "MISS"); }
  public MissileTrackVector_IngestT UnPack() {
    var _o = new MissileTrackVector_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(MissileTrackVector_IngestT _o) {
    _o.Type = this.Type;
  ...
  public static Offset<MissileTrackVector_Ingest> Pack(FlatBufferBuilder builder, MissileTrackVector_IngestT _o) {
    if (_o == null) return default(Offset<MissileTrackVector_Ingest>);
...
public class MissileTrackVector_IngestT
{
  ...
  public MissileTrackVector_IngestT() {
    this.Type = null;
    this.Object = null;
    this.Epoch = null;
    this.IdSensor = null;
  ...
  public static MissileTrackVector_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return MissileTrackVector_Ingest.GetRootAsMissileTrackVector_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    MissileTrackVector_Ingest.FinishMissileTrackVector_IngestBuffer(fbb, MissileTrackVector_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class MissileTrackVector_IngestVerify
{
