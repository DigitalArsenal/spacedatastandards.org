...
public struct EngineDetails : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EngineDetails GetRootAsEngineDetails(ByteBuffer _bb) { return GetRootAsEngineDetails(_bb, new EngineDetails()); }
  public static EngineDetails GetRootAsEngineDetails(ByteBuffer _bb, EngineDetails obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EngineDetailsBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ENGI"); }
  public static bool VerifyEngineDetails(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ENGI", false, EngineDetailsVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EngineDetails __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public EngineDetails_dataMode_Enum DataMode { get { int o = __p.__offset(52); return o != 0 ? (EngineDetails_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EngineDetails_dataMode_Enum.REAL; } }
  ...
  public static Offset<EngineDetails> CreateEngineDetails(FlatBufferBuilder builder,
      ...
      EngineDetails_dataMode_Enum dataMode = EngineDetails_dataMode_Enum.REAL,
      VectorOffset tagsOffset = default(VectorOffset)) {
    builder.StartTable(26);
    EngineDetails.AddNozzleExpansionRatio(builder, nozzleExpansionRatio);
    EngineDetails.AddChamberPressure(builder, chamberPressure);
    EngineDetails.AddVacuumThrust(builder, vacuumThrust);
    EngineDetails.AddSeaLevelThrust(builder, seaLevelThrust);
    EngineDetails.AddBurnTime(builder, burnTime);
    EngineDetails.AddSpecificImpulse(builder, specificImpulse);
    EngineDetails.AddTags(builder, tagsOffset);
    EngineDetails.AddOrigNetwork(builder, origNetworkOffset);
    EngineDetails.AddOrigin(builder, originOffset);
    EngineDetails.AddSource(builder, sourceOffset);
    EngineDetails.AddUpdatedBy(builder, updatedByOffset);
    EngineDetails.AddUpdatedAt(builder, updatedAtOffset);
    EngineDetails.AddCreatedBy(builder, createdByOffset);
    EngineDetails.AddCreatedAt(builder, createdAtOffset);
    EngineDetails.AddNotes(builder, notesOffset);
    EngineDetails.AddOxidizer(builder, oxidizerOffset);
    EngineDetails.AddPropellant(builder, propellantOffset);
    EngineDetails.AddMaxFirings(builder, maxFirings);
    EngineDetails.AddManufacturerOrgId(builder, manufacturerOrgIdOffset);
    EngineDetails.AddCharacteristicType(builder, characteristicTypeOffset);
    EngineDetails.AddCycleType(builder, cycleTypeOffset);
    EngineDetails.AddFamily(builder, familyOffset);
    EngineDetails.AddClassificationMarking(builder, classificationMarkingOffset);
    EngineDetails.AddIdEngine(builder, idEngineOffset);
    EngineDetails.AddId(builder, idOffset);
    EngineDetails.AddDataMode(builder, dataMode);
    return EngineDetails.EndEngineDetails(builder);
  }

  public static void StartEngineDetails(FlatBufferBuilder builder) { builder.StartTable(26); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, EngineDetails_dataMode_Enum dataMode) { builder.AddSbyte(24, (sbyte)dataMode, 0); }
  ...
  public static Offset<EngineDetails> EndEngineDetails(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EngineDetails>(o);
  }
  public static void FinishEngineDetailsBuffer(FlatBufferBuilder builder, Offset<EngineDetails> offset) { builder.Finish(offset.Value, "ENGI"); }
  public static void FinishSizePrefixedEngineDetailsBuffer(FlatBufferBuilder builder, Offset<EngineDetails> offset) { builder.FinishSizePrefixed(offset.Value, "ENGI"); }
  public EngineDetailsT UnPack() {
    var _o = new EngineDetailsT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EngineDetailsT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<EngineDetails> Pack(FlatBufferBuilder builder, EngineDetailsT _o) {
    if (_o == null) return default(Offset<EngineDetails>);
...
public class EngineDetailsT
{
  ...
  public EngineDetails_dataMode_Enum DataMode { get; set; }
  public List<string> Tags { get; set; }

  public EngineDetailsT() {
    this.Id = null;
    this.IdEngine = null;
    ...
    this.DataMode = EngineDetails_dataMode_Enum.REAL;
    this.Tags = null;
  }
  public static EngineDetailsT DeserializeFromBinary(byte[] fbBuffer) {
    return EngineDetails.GetRootAsEngineDetails(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EngineDetails.FinishEngineDetailsBuffer(fbb, EngineDetails.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EngineDetailsVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 52 /*DataMode*/, 1 /*EngineDetails_dataMode_Enum*/, 1, false)
