...
public struct LaunchSite_Full : IFlatbufferObject
{
  ...
  public static bool LaunchSite_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LAUN"); }
  public static bool VerifyLaunchSite_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LAUN", false, LaunchSite_FullVerify.Verify); }
  ...
  public static Offset<LaunchSite_Full> CreateLaunchSite_Full(FlatBufferBuilder builder,
  ...
  public static Offset<LaunchSite_Full> EndLaunchSite_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LaunchSite_Full>(o);
  }
  public static void FinishLaunchSite_FullBuffer(FlatBufferBuilder builder, Offset<LaunchSite_Full> offset) { builder.Finish(offset.Value, "LAUN"); }
  public static void FinishSizePrefixedLaunchSite_FullBuffer(FlatBufferBuilder builder, Offset<LaunchSite_Full> offset) { builder.FinishSizePrefixed(offset.Value, "LAUN"); }
  ...
  public static Offset<LaunchSite_Full> Pack(FlatBufferBuilder builder, LaunchSite_FullT _o) {
    if (_o == null) return default(Offset<LaunchSite_Full>);
...
public class LaunchSite_FullT
{
  ...
  public static LaunchSite_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return LaunchSite_Full.GetRootAsLaunchSite_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LaunchSite_Full.FinishLaunchSite_FullBuffer(fbb, LaunchSite_Full.Pack(fbb, this));
