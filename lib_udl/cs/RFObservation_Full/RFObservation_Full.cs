...
public struct RFObservation_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static RFObservation_Full GetRootAsRFObservation_Full(ByteBuffer _bb, RFObservation_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool RFObservation_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "RFOB"); }
  public static bool VerifyRFObservation_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("RFOB", false, RFObservation_FullVerify.Verify); }
  ...
  public RFObservation_Full_polarityType_Enum PolarityType { get { int o = __p.__offset(94); return o != 0 ? (RFObservation_Full_polarityType_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFObservation_Full_polarityType_Enum.H; } }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public RFObservation_Full_dataMode_Enum DataMode { get { int o = __p.__offset(134); return o != 0 ? (RFObservation_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFObservation_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<RFObservation_Full> CreateRFObservation_Full(FlatBufferBuilder builder,
      ...
      double polarity = 0.0,
      RFObservation_Full_polarityType_Enum polarityType = RFObservation_Full_polarityType_Enum.H,
      int channel = 0,
      ...
      RFObservation_Full_dataMode_Enum dataMode = RFObservation_Full_dataMode_Enum.REAL,
  ...
  public static void AddPolarityType(FlatBufferBuilder builder, RFObservation_Full_polarityType_Enum polarityType) { builder.AddSbyte(45, (sbyte)polarityType, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, RFObservation_Full_dataMode_Enum dataMode) { builder.AddSbyte(65, (sbyte)dataMode, 0); }
  ...
  public static Offset<RFObservation_Full> EndRFObservation_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RFObservation_Full>(o);
  }
  public static void FinishRFObservation_FullBuffer(FlatBufferBuilder builder, Offset<RFObservation_Full> offset) { builder.Finish(offset.Value, "RFOB"); }
  public static void FinishSizePrefixedRFObservation_FullBuffer(FlatBufferBuilder builder, Offset<RFObservation_Full> offset) { builder.FinishSizePrefixed(offset.Value, "RFOB"); }
  public RFObservation_FullT UnPack() {
    var _o = new RFObservation_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RFObservation_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<RFObservation_Full> Pack(FlatBufferBuilder builder, RFObservation_FullT _o) {
    if (_o == null) return default(Offset<RFObservation_Full>);
...
public class RFObservation_FullT
{
  ...
  public RFObservation_Full_polarityType_Enum PolarityType { get; set; }
  ...
  public RFObservation_Full_dataMode_Enum DataMode { get; set; }
  ...
  public RFObservation_FullT() {
    ...
    this.NominalSnr = 0.0;
    this.Polarity = 0.0;
    this.PolarityType = RFObservation_Full_polarityType_Enum.H;
    this.Channel = 0;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = RFObservation_Full_dataMode_Enum.REAL;
    this.Tags = null;
    this.CreatedAt = null;
    this.CreatedBy = null;
  ...
  public static RFObservation_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return RFObservation_Full.GetRootAsRFObservation_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    RFObservation_Full.FinishRFObservation_FullBuffer(fbb, RFObservation_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class RFObservation_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 94 /*PolarityType*/, 1 /*RFObservation_Full_polarityType_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 134 /*DataMode*/, 1 /*RFObservation_Full_dataMode_Enum*/, 1, false)
