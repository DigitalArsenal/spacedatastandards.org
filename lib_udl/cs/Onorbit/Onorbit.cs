...
public struct Onorbit : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Onorbit GetRootAsOnorbit(ByteBuffer _bb) { return GetRootAsOnorbit(_bb, new Onorbit()); }
  public static Onorbit GetRootAsOnorbit(ByteBuffer _bb, Onorbit obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OnorbitBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONOR"); }
  public static bool VerifyOnorbit(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONOR", false, OnorbitVerify.Verify); }
  ...
  public Onorbit_objectType_Enum ObjectType { get { int o = __p.__offset(20); return o != 0 ? (Onorbit_objectType_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Onorbit_objectType_Enum.ROCKET_BODY; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 45
  public Onorbit_category_Enum Category { get { int o = __p.__offset(26); return o != 0 ? (Onorbit_category_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Onorbit_category_Enum.UNKNOWN; } }
  ...
  public Onorbit_dataMode_Enum DataMode { get { int o = __p.__offset(42); return o != 0 ? (Onorbit_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Onorbit_dataMode_Enum.REAL; } }
  ...
  public static Offset<Onorbit> CreateOnorbit(FlatBufferBuilder builder,
      ...
      Onorbit_objectType_Enum objectType = Onorbit_objectType_Enum.ROCKET_BODY,
      StringOffset originOffset = default(StringOffset),
      StringOffset missionNumberOffset = default(StringOffset),
      Onorbit_category_Enum category = Onorbit_category_Enum.UNKNOWN,
      int lifetimeYears = 0,
      ...
      Onorbit_dataMode_Enum dataMode = Onorbit_dataMode_Enum.REAL,
  ...
  public static void AddObjectType(FlatBufferBuilder builder, Onorbit_objectType_Enum objectType) { builder.AddSbyte(8, (sbyte)objectType, 0); }
  ...
  public static void AddCategory(FlatBufferBuilder builder, Onorbit_category_Enum category) { builder.AddSbyte(11, (sbyte)category, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Onorbit_dataMode_Enum dataMode) { builder.AddSbyte(19, (sbyte)dataMode, 0); }
  ...
  public static Offset<Onorbit> EndOnorbit(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Onorbit>(o);
  }
  public static void FinishOnorbitBuffer(FlatBufferBuilder builder, Offset<Onorbit> offset) { builder.Finish(offset.Value, "ONOR"); }
  public static void FinishSizePrefixedOnorbitBuffer(FlatBufferBuilder builder, Offset<Onorbit> offset) { builder.FinishSizePrefixed(offset.Value, "ONOR"); }
  public OnorbitT UnPack() {
    var _o = new OnorbitT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OnorbitT _o) {
  ...
  public static Offset<Onorbit> Pack(FlatBufferBuilder builder, OnorbitT _o) {
    if (_o == null) return default(Offset<Onorbit>);
...
public class OnorbitT
{
  ...
  public Onorbit_objectType_Enum ObjectType { get; set; }
  public string Origin { get; set; }
  public string MissionNumber { get; set; }
  public Onorbit_category_Enum Category { get; set; }
  ...
  public Onorbit_dataMode_Enum DataMode { get; set; }
  ...
  public OnorbitT() {
    ...
    this.DecayDate = null;
    this.ObjectType = Onorbit_objectType_Enum.ROCKET_BODY;
    this.Origin = null;
    this.MissionNumber = null;
    this.Category = Onorbit_category_Enum.UNKNOWN;
    ...
    this.UpdatedBy = null;
    this.Source = null;
    this.DataMode = Onorbit_dataMode_Enum.REAL;
  ...
  public static OnorbitT DeserializeFromBinary(byte[] fbBuffer) {
    return Onorbit.GetRootAsOnorbit(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Onorbit.FinishOnorbitBuffer(fbb, Onorbit.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OnorbitVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*ObjectType*/, 1 /*Onorbit_objectType_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 22 /*Origin*/, false)
      && verifier.VerifyString(tablePos, 24 /*MissionNumber*/, false)
      && verifier.VerifyField(tablePos, 26 /*Category*/, 1 /*Onorbit_category_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 42 /*DataMode*/, 1 /*Onorbit_dataMode_Enum*/, 1, false)
