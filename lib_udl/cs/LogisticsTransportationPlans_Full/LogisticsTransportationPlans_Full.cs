...
public struct LogisticsTransportationPlans_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static LogisticsTransportationPlans_Full GetRootAsLogisticsTransportationPlans_Full(ByteBuffer _bb) { return GetRootAsLogisticsTransportationPlans_Full(_bb, new LogisticsTransportationPlans_Full()); }
  public static LogisticsTransportationPlans_Full GetRootAsLogisticsTransportationPlans_Full(ByteBuffer _bb, LogisticsTransportationPlans_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LogisticsTransportationPlans_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LOGI"); }
  public static bool VerifyLogisticsTransportationPlans_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LOGI", false, LogisticsTransportationPlans_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public LogisticsTransportationPlans_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<LogisticsTransportationPlans_Full> CreateLogisticsTransportationPlans_Full(FlatBufferBuilder builder,
    ...
    LogisticsTransportationPlans_Full.AddLogisticsTransportationPlansRemarks(builder, logisticsTransportationPlansRemarksOffset);
    LogisticsTransportationPlans_Full.AddLogisticsSegments(builder, logisticsSegmentsOffset);
    LogisticsTransportationPlans_Full.AddLastChangedDate(builder, lastChangedDateOffset);
    LogisticsTransportationPlans_Full.AddNumTransLoads(builder, numTransLoads);
    LogisticsTransportationPlans_Full.AddSerialNumber(builder, serialNumberOffset);
    LogisticsTransportationPlans_Full.AddNumEnrouteStops(builder, numEnrouteStops);
    LogisticsTransportationPlans_Full.AddAircraftStatus(builder, aircraftStatusOffset);
    LogisticsTransportationPlans_Full.AddCancelledDate(builder, cancelledDateOffset);
    LogisticsTransportationPlans_Full.AddClosedDate(builder, closedDateOffset);
    LogisticsTransportationPlans_Full.AddActDepTime(builder, actDepTimeOffset);
    LogisticsTransportationPlans_Full.AddDuration(builder, durationOffset);
    LogisticsTransportationPlans_Full.AddApproxArrTime(builder, approxArrTimeOffset);
    LogisticsTransportationPlans_Full.AddMajcom(builder, majcomOffset);
    LogisticsTransportationPlans_Full.AddTpAircraftMDS(builder, tpAircraftMDSOffset);
    LogisticsTransportationPlans_Full.AddTpTailNumber(builder, tpTailNumberOffset);
    LogisticsTransportationPlans_Full.AddLogisticMasterRecordId(builder, logisticMasterRecordIdOffset);
    LogisticsTransportationPlans_Full.AddDestinationICAO(builder, destinationICAOOffset);
    LogisticsTransportationPlans_Full.AddEstArrTime(builder, estArrTimeOffset);
    LogisticsTransportationPlans_Full.AddEstDepTime(builder, estDepTimeOffset);
    LogisticsTransportationPlans_Full.AddOriginICAO(builder, originICAOOffset);
    LogisticsTransportationPlans_Full.AddCoordinatorUnit(builder, coordinatorUnitOffset);
    LogisticsTransportationPlans_Full.AddCoordinator(builder, coordinatorOffset);
    LogisticsTransportationPlans_Full.AddStatusCode(builder, statusCodeOffset);
    LogisticsTransportationPlans_Full.AddPlanDefinition(builder, planDefinitionOffset);
    LogisticsTransportationPlans_Full.AddPlansNumber(builder, plansNumberOffset);
    LogisticsTransportationPlans_Full.AddMissionChange(builder, missionChange);
    return LogisticsTransportationPlans_Full.EndLogisticsTransportationPlans_Full(builder);
  }

  public static void StartLogisticsTransportationPlans_Full(FlatBufferBuilder builder) { builder.StartTable(26); }
  ...
  public static Offset<LogisticsTransportationPlans_Full> EndLogisticsTransportationPlans_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LogisticsTransportationPlans_Full>(o);
  }
  public static void FinishLogisticsTransportationPlans_FullBuffer(FlatBufferBuilder builder, Offset<LogisticsTransportationPlans_Full> offset) { builder.Finish(offset.Value, "LOGI"); }
  public static void FinishSizePrefixedLogisticsTransportationPlans_FullBuffer(FlatBufferBuilder builder, Offset<LogisticsTransportationPlans_Full> offset) { builder.FinishSizePrefixed(offset.Value, "LOGI"); }
  public LogisticsTransportationPlans_FullT UnPack() {
    var _o = new LogisticsTransportationPlans_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LogisticsTransportationPlans_FullT _o) {
  ...
  public static Offset<LogisticsTransportationPlans_Full> Pack(FlatBufferBuilder builder, LogisticsTransportationPlans_FullT _o) {
    if (_o == null) return default(Offset<LogisticsTransportationPlans_Full>);
    ...
    return CreateLogisticsTransportationPlans_Full(
      builder,
      _plansNumber,
      _o.MissionChange,
      _planDefinition,
...
public class LogisticsTransportationPlans_FullT
{
  ...
  public LogisticsTransportationPlans_FullT() {
  ...
  public static LogisticsTransportationPlans_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return LogisticsTransportationPlans_Full.GetRootAsLogisticsTransportationPlans_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LogisticsTransportationPlans_Full.FinishLogisticsTransportationPlans_FullBuffer(fbb, LogisticsTransportationPlans_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LogisticsTransportationPlans_FullVerify
{
