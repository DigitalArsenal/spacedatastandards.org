...
public struct Onorbit_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Onorbit_Abridged GetRootAsOnorbit_Abridged(ByteBuffer _bb) { return GetRootAsOnorbit_Abridged(_bb, new Onorbit_Abridged()); }
  public static Onorbit_Abridged GetRootAsOnorbit_Abridged(ByteBuffer _bb, Onorbit_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Onorbit_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONOR"); }
  public static bool VerifyOnorbit_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONOR", false, Onorbit_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Onorbit_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public Onorbit_Abridged_objectType_Enum ObjectType { get { int o = __p.__offset(20); return o != 0 ? (Onorbit_Abridged_objectType_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Onorbit_Abridged_objectType_Enum.ROCKET_BODY; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 45
  public Onorbit_Abridged_category_Enum Category { get { int o = __p.__offset(26); return o != 0 ? (Onorbit_Abridged_category_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Onorbit_Abridged_category_Enum.UNKNOWN; } }
  ...
  public Onorbit_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(38); return o != 0 ? (Onorbit_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Onorbit_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<Onorbit_Abridged> CreateOnorbit_Abridged(FlatBufferBuilder builder,
      ...
      Onorbit_Abridged_objectType_Enum objectType = Onorbit_Abridged_objectType_Enum.ROCKET_BODY,
      StringOffset originOffset = default(StringOffset),
      StringOffset missionNumberOffset = default(StringOffset),
      Onorbit_Abridged_category_Enum category = Onorbit_Abridged_category_Enum.UNKNOWN,
      int lifetimeYears = 0,
      StringOffset altNameOffset = default(StringOffset),
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset),
      StringOffset sourceOffset = default(StringOffset),
      Onorbit_Abridged_dataMode_Enum dataMode = Onorbit_Abridged_dataMode_Enum.REAL,
      StringOffset launchSiteIdOffset = default(StringOffset),
      StringOffset countryCodeOffset = default(StringOffset),
      StringOffset origNetworkOffset = default(StringOffset)) {
    builder.StartTable(21);
    Onorbit_Abridged.AddOrigNetwork(builder, origNetworkOffset);
    Onorbit_Abridged.AddCountryCode(builder, countryCodeOffset);
    Onorbit_Abridged.AddLaunchSiteId(builder, launchSiteIdOffset);
    Onorbit_Abridged.AddSource(builder, sourceOffset);
    Onorbit_Abridged.AddCreatedBy(builder, createdByOffset);
    Onorbit_Abridged.AddCreatedAt(builder, createdAtOffset);
    Onorbit_Abridged.AddAltName(builder, altNameOffset);
    Onorbit_Abridged.AddLifetimeYears(builder, lifetimeYears);
    Onorbit_Abridged.AddMissionNumber(builder, missionNumberOffset);
    Onorbit_Abridged.AddOrigin(builder, originOffset);
    Onorbit_Abridged.AddDecayDate(builder, decayDateOffset);
    Onorbit_Abridged.AddLaunchDate(builder, launchDateOffset);
    Onorbit_Abridged.AddIntlDes(builder, intlDesOffset);
    Onorbit_Abridged.AddConstellation(builder, constellationOffset);
    Onorbit_Abridged.AddCommonName(builder, commonNameOffset);
    Onorbit_Abridged.AddSatNo(builder, satNo);
    Onorbit_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    Onorbit_Abridged.AddIdOnOrbit(builder, idOnOrbitOffset);
    Onorbit_Abridged.AddDataMode(builder, dataMode);
    Onorbit_Abridged.AddCategory(builder, category);
    Onorbit_Abridged.AddObjectType(builder, objectType);
    return Onorbit_Abridged.EndOnorbit_Abridged(builder);
  }

  public static void StartOnorbit_Abridged(FlatBufferBuilder builder) { builder.StartTable(21); }
  ...
  public static void AddObjectType(FlatBufferBuilder builder, Onorbit_Abridged_objectType_Enum objectType) { builder.AddSbyte(8, (sbyte)objectType, 0); }
  ...
  public static void AddCategory(FlatBufferBuilder builder, Onorbit_Abridged_category_Enum category) { builder.AddSbyte(11, (sbyte)category, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Onorbit_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(17, (sbyte)dataMode, 0); }
  ...
  public static Offset<Onorbit_Abridged> EndOnorbit_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Onorbit_Abridged>(o);
  }
  public static void FinishOnorbit_AbridgedBuffer(FlatBufferBuilder builder, Offset<Onorbit_Abridged> offset) { builder.Finish(offset.Value, "ONOR"); }
  public static void FinishSizePrefixedOnorbit_AbridgedBuffer(FlatBufferBuilder builder, Offset<Onorbit_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "ONOR"); }
  public Onorbit_AbridgedT UnPack() {
    var _o = new Onorbit_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Onorbit_AbridgedT _o) {
  ...
  public static Offset<Onorbit_Abridged> Pack(FlatBufferBuilder builder, Onorbit_AbridgedT _o) {
    if (_o == null) return default(Offset<Onorbit_Abridged>);
...
public class Onorbit_AbridgedT
{
  ...
  public Onorbit_Abridged_objectType_Enum ObjectType { get; set; }
  public string Origin { get; set; }
  public string MissionNumber { get; set; }
  public Onorbit_Abridged_category_Enum Category { get; set; }
  public int LifetimeYears { get; set; }
  public string AltName { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string Source { get; set; }
  public Onorbit_Abridged_dataMode_Enum DataMode { get; set; }
  public string LaunchSiteId { get; set; }
  public string CountryCode { get; set; }
  public string OrigNetwork { get; set; }

  public Onorbit_AbridgedT() {
    this.IdOnOrbit = null;
    ...
    this.DecayDate = null;
    this.ObjectType = Onorbit_Abridged_objectType_Enum.ROCKET_BODY;
    this.Origin = null;
    this.MissionNumber = null;
    this.Category = Onorbit_Abridged_category_Enum.UNKNOWN;
    this.LifetimeYears = 0;
    this.AltName = null;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.Source = null;
    this.DataMode = Onorbit_Abridged_dataMode_Enum.REAL;
    this.LaunchSiteId = null;
    this.CountryCode = null;
    this.OrigNetwork = null;
  }
  public static Onorbit_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Onorbit_Abridged.GetRootAsOnorbit_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Onorbit_Abridged.FinishOnorbit_AbridgedBuffer(fbb, Onorbit_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Onorbit_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*ObjectType*/, 1 /*Onorbit_Abridged_objectType_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 22 /*Origin*/, false)
      && verifier.VerifyString(tablePos, 24 /*MissionNumber*/, false)
      && verifier.VerifyField(tablePos, 26 /*Category*/, 1 /*Onorbit_Abridged_category_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 38 /*DataMode*/, 1 /*Onorbit_Abridged_dataMode_Enum*/, 1, false)
