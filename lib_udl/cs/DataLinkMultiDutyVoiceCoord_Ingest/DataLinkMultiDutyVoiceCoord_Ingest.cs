...
public struct DataLinkMultiDutyVoiceCoord_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static DataLinkMultiDutyVoiceCoord_Ingest GetRootAsDataLinkMultiDutyVoiceCoord_Ingest(ByteBuffer _bb, DataLinkMultiDutyVoiceCoord_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DataLinkMultiDutyVoiceCoord_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DATA"); }
  public static bool VerifyDataLinkMultiDutyVoiceCoord_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DATA", false, DataLinkMultiDutyVoiceCoord_IngestVerify.Verify); }
  ...
  public static Offset<DataLinkMultiDutyVoiceCoord_Ingest> CreateDataLinkMultiDutyVoiceCoord_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<DataLinkMultiDutyVoiceCoord_Ingest> EndDataLinkMultiDutyVoiceCoord_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DataLinkMultiDutyVoiceCoord_Ingest>(o);
  }
  public static void FinishDataLinkMultiDutyVoiceCoord_IngestBuffer(FlatBufferBuilder builder, Offset<DataLinkMultiDutyVoiceCoord_Ingest> offset) { builder.Finish(offset.Value, "DATA"); }
  public static void FinishSizePrefixedDataLinkMultiDutyVoiceCoord_IngestBuffer(FlatBufferBuilder builder, Offset<DataLinkMultiDutyVoiceCoord_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "DATA"); }
  public DataLinkMultiDutyVoiceCoord_IngestT UnPack() {
    var _o = new DataLinkMultiDutyVoiceCoord_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DataLinkMultiDutyVoiceCoord_IngestT _o) {
  ...
  public static Offset<DataLinkMultiDutyVoiceCoord_Ingest> Pack(FlatBufferBuilder builder, DataLinkMultiDutyVoiceCoord_IngestT _o) {
    if (_o == null) return default(Offset<DataLinkMultiDutyVoiceCoord_Ingest>);
    ...
    return CreateDataLinkMultiDutyVoiceCoord_Ingest(
      builder,
      _multiVoiceNetDes,
      _multiFreqDes,
      _multiCommPri,
...
public class DataLinkMultiDutyVoiceCoord_IngestT
{
  ...
  public DataLinkMultiDutyVoiceCoord_IngestT() {
    this.MultiVoiceNetDes = null;
    this.MultiFreqDes = null;
    this.MultiCommPri = null;
    this.MultiTeleFreqNums = null;
  }
  public static DataLinkMultiDutyVoiceCoord_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return DataLinkMultiDutyVoiceCoord_Ingest.GetRootAsDataLinkMultiDutyVoiceCoord_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DataLinkMultiDutyVoiceCoord_Ingest.FinishDataLinkMultiDutyVoiceCoord_IngestBuffer(fbb, DataLinkMultiDutyVoiceCoord_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DataLinkMultiDutyVoiceCoord_IngestVerify
{
