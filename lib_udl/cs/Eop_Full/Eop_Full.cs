...
public struct Eop_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Eop_Full GetRootAsEop_Full(ByteBuffer _bb) { return GetRootAsEop_Full(_bb, new Eop_Full()); }
  public static Eop_Full GetRootAsEop_Full(ByteBuffer _bb, Eop_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Eop_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EOPF"); }
  public static bool VerifyEop_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EOPF", false, Eop_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Eop_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public Eop_Full_polarMotionState_Enum PolarMotionState { get { int o = __p.__offset(10); return o != 0 ? (Eop_Full_polarMotionState_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Eop_Full_polarMotionState_Enum.I; } }
  ...
  /// Example: /// Example: I
  /// Constraints: Minimum length = 0, Maximum length = 1
  public Eop_Full_ut1UTCState_Enum Ut1UTCState { get { int o = __p.__offset(20); return o != 0 ? (Eop_Full_ut1UTCState_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Eop_Full_ut1UTCState_Enum.I; } }
  ...
  /// Example: /// Example: I
  /// Constraints: Minimum length = 0, Maximum length = 1
  public Eop_Full_nutationState_Enum NutationState { get { int o = __p.__offset(30); return o != 0 ? (Eop_Full_nutationState_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Eop_Full_nutationState_Enum.I; } }
  ...
  public Eop_Full_dataMode_Enum DataMode { get { int o = __p.__offset(70); return o != 0 ? (Eop_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Eop_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<Eop_Full> CreateEop_Full(FlatBufferBuilder builder,
      StringOffset idOffset = default(StringOffset),
      StringOffset classificationMarkingOffset = default(StringOffset),
      StringOffset eopDateOffset = default(StringOffset),
      Eop_Full_polarMotionState_Enum polarMotionState = Eop_Full_polarMotionState_Enum.I,
      double polarMotionX = 0.0,
      double polarMotionXUnc = 0.0,
      double polarMotionY = 0.0,
      double polarMotionYUnc = 0.0,
      Eop_Full_ut1UTCState_Enum ut1UTCState = Eop_Full_ut1UTCState_Enum.I,
      double ut1UTC = 0.0,
      double ut1UTCUnc = 0.0,
      double lod = 0.0,
      double lodUnc = 0.0,
      Eop_Full_nutationState_Enum nutationState = Eop_Full_nutationState_Enum.I,
      double dPSI = 0.0,
      double dPSIUnc = 0.0,
      double dEpsilon = 0.0,
      ...
      Eop_Full_dataMode_Enum dataMode = Eop_Full_dataMode_Enum.REAL,
    ...
    Eop_Full.AddDYB(builder, dYB);
    Eop_Full.AddDXB(builder, dXB);
    Eop_Full.AddDEpsilonB(builder, dEpsilonB);
    Eop_Full.AddDPSIB(builder, dPSIB);
    Eop_Full.AddUt1UTCB(builder, ut1UTCB);
    Eop_Full.AddPolarMotionYB(builder, polarMotionYB);
    Eop_Full.AddPolarMotionXB(builder, polarMotionXB);
    Eop_Full.AddDYUnc(builder, dYUnc);
    Eop_Full.AddDY(builder, dY);
    Eop_Full.AddDXUnc(builder, dXUnc);
    Eop_Full.AddDX(builder, dX);
    Eop_Full.AddDEpsilonUnc(builder, dEpsilonUnc);
    Eop_Full.AddDEpsilon(builder, dEpsilon);
    Eop_Full.AddDPSIUnc(builder, dPSIUnc);
    Eop_Full.AddDPSI(builder, dPSI);
    Eop_Full.AddLodUnc(builder, lodUnc);
    Eop_Full.AddLod(builder, lod);
    Eop_Full.AddUt1UTCUnc(builder, ut1UTCUnc);
    Eop_Full.AddUt1UTC(builder, ut1UTC);
    Eop_Full.AddPolarMotionYUnc(builder, polarMotionYUnc);
    Eop_Full.AddPolarMotionY(builder, polarMotionY);
    Eop_Full.AddPolarMotionXUnc(builder, polarMotionXUnc);
    Eop_Full.AddPolarMotionX(builder, polarMotionX);
    Eop_Full.AddOrigNetwork(builder, origNetworkOffset);
    Eop_Full.AddUpdatedBy(builder, updatedByOffset);
    Eop_Full.AddUpdatedAt(builder, updatedAtOffset);
    Eop_Full.AddCreatedBy(builder, createdByOffset);
    Eop_Full.AddCreatedAt(builder, createdAtOffset);
    Eop_Full.AddOrigin(builder, originOffset);
    Eop_Full.AddSource(builder, sourceOffset);
    Eop_Full.AddRawFileURI(builder, rawFileURIOffset);
    Eop_Full.AddPrecessionNutationStd(builder, precessionNutationStdOffset);
    Eop_Full.AddEopDate(builder, eopDateOffset);
    Eop_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    Eop_Full.AddId(builder, idOffset);
    Eop_Full.AddDataMode(builder, dataMode);
    Eop_Full.AddNutationState(builder, nutationState);
    Eop_Full.AddUt1UTCState(builder, ut1UTCState);
    Eop_Full.AddPolarMotionState(builder, polarMotionState);
    return Eop_Full.EndEop_Full(builder);
  }

  public static void StartEop_Full(FlatBufferBuilder builder) { builder.StartTable(39); }
  ...
  public static void AddPolarMotionState(FlatBufferBuilder builder, Eop_Full_polarMotionState_Enum polarMotionState) { builder.AddSbyte(3, (sbyte)polarMotionState, 0); }
  ...
  public static void AddUt1UTCState(FlatBufferBuilder builder, Eop_Full_ut1UTCState_Enum ut1UTCState) { builder.AddSbyte(8, (sbyte)ut1UTCState, 0); }
  ...
  public static void AddNutationState(FlatBufferBuilder builder, Eop_Full_nutationState_Enum nutationState) { builder.AddSbyte(13, (sbyte)nutationState, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Eop_Full_dataMode_Enum dataMode) { builder.AddSbyte(33, (sbyte)dataMode, 0); }
  ...
  public static Offset<Eop_Full> EndEop_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Eop_Full>(o);
  }
  public static void FinishEop_FullBuffer(FlatBufferBuilder builder, Offset<Eop_Full> offset) { builder.Finish(offset.Value, "EOPF"); }
  public static void FinishSizePrefixedEop_FullBuffer(FlatBufferBuilder builder, Offset<Eop_Full> offset) { builder.FinishSizePrefixed(offset.Value, "EOPF"); }
  public Eop_FullT UnPack() {
    var _o = new Eop_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Eop_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Eop_Full> Pack(FlatBufferBuilder builder, Eop_FullT _o) {
    if (_o == null) return default(Offset<Eop_Full>);
...
public class Eop_FullT
{
  public string Id { get; set; }
  public string ClassificationMarking { get; set; }
  public string EopDate { get; set; }
  public Eop_Full_polarMotionState_Enum PolarMotionState { get; set; }
  ...
  public Eop_Full_dataMode_Enum DataMode { get; set; }
  ...
  public Eop_FullT() {
    ...
    this.EopDate = null;
    this.PolarMotionState = Eop_Full_polarMotionState_Enum.I;
    this.PolarMotionX = 0.0;
    this.PolarMotionXUnc = 0.0;
    this.PolarMotionY = 0.0;
    this.PolarMotionYUnc = 0.0;
    this.Ut1UTCState = Eop_Full_ut1UTCState_Enum.I;
    this.Ut1UTC = 0.0;
    this.Ut1UTCUnc = 0.0;
    this.Lod = 0.0;
    this.LodUnc = 0.0;
    this.NutationState = Eop_Full_nutationState_Enum.I;
    this.DPSI = 0.0;
    this.DPSIUnc = 0.0;
    this.DEpsilon = 0.0;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Eop_Full_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.UpdatedAt = null;
    this.UpdatedBy = null;
  ...
  public static Eop_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Eop_Full.GetRootAsEop_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Eop_Full.FinishEop_FullBuffer(fbb, Eop_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Eop_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*PolarMotionState*/, 1 /*Eop_Full_polarMotionState_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 20 /*Ut1UTCState*/, 1 /*Eop_Full_ut1UTCState_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 30 /*NutationState*/, 1 /*Eop_Full_nutationState_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 70 /*DataMode*/, 1 /*Eop_Full_dataMode_Enum*/, 1, false)
