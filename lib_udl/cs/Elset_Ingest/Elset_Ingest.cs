...
public struct Elset_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static Elset_Ingest GetRootAsElset_Ingest(ByteBuffer _bb, Elset_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Elset_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ELSE"); }
  public static bool VerifyElset_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ELSE", false, Elset_IngestVerify.Verify); }
  ...
  public string RawFileURI { get { int o = __p.__offset(62); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetRawFileURIBytes() { return __p.__vector_as_span<byte>(62, 1); }
#else
  public ArraySegment<byte>? GetRawFileURIBytes() { return __p.__vector_as_arraysegment(62); }
#endif
  public byte[] GetRawFileURIArray() { return __p.__vector_as_array<byte>(62); }
  ...
  public Elset_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(70); return o != 0 ? (Elset_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Elset_Ingest_dataMode_Enum.REAL; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Algorithm { get { int o = __p.__offset(74); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAlgorithmBytes() { return __p.__vector_as_span<byte>(74, 1); }
#else
  public ArraySegment<byte>? GetAlgorithmBytes() { return __p.__vector_as_arraysegment(74); }
#endif
  public byte[] GetAlgorithmArray() { return __p.__vector_as_array<byte>(74); }
  ...
  /// Constraints: No constraints specified.
  public string SourcedData(int j) { int o = __p.__offset(76); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SourcedDataLength { get { int o = __p.__offset(76); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Constraints: No constraints specified.
  public Elset_Ingest_sourcedDataTypes_Enum SourcedDataTypes { get { int o = __p.__offset(78); return o != 0 ? (Elset_Ingest_sourcedDataTypes_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Elset_Ingest_sourcedDataTypes_Enum.EO; } }
  /// Optional identifier to track a commercial or marketplace transaction executed to produce this data.
  /// Example: /// Example: TRANSACTION-ID
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string TransactionId { get { int o = __p.__offset(80); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTransactionIdBytes() { return __p.__vector_as_span<byte>(80, 1); }
#else
  public ArraySegment<byte>? GetTransactionIdBytes() { return __p.__vector_as_arraysegment(80); }
#endif
  public byte[] GetTransactionIdArray() { return __p.__vector_as_array<byte>(80); }
  ...
  /// Example: /// Example: 1
  /// Constraints: No constraints specified.
  public int EphemType { get { int o = __p.__offset(82); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  public static Offset<Elset_Ingest> CreateElset_Ingest(FlatBufferBuilder builder,
      ...
      Elset_Ingest_dataMode_Enum dataMode = Elset_Ingest_dataMode_Enum.REAL,
      VectorOffset tagsOffset = default(VectorOffset),
      StringOffset algorithmOffset = default(StringOffset),
      VectorOffset sourcedDataOffset = default(VectorOffset),
      Elset_Ingest_sourcedDataTypes_Enum sourcedDataTypes = Elset_Ingest_sourcedDataTypes_Enum.EO,
  ...
  public static void AddRawFileURI(FlatBufferBuilder builder, StringOffset rawFileURIOffset) { builder.AddOffset(29, rawFileURIOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Elset_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(33, (sbyte)dataMode, 0); }
  ...
  public static void AddAlgorithm(FlatBufferBuilder builder, StringOffset algorithmOffset) { builder.AddOffset(35, algorithmOffset.Value, 0); }
  public static void AddSourcedData(FlatBufferBuilder builder, VectorOffset sourcedDataOffset) { builder.AddOffset(36, sourcedDataOffset.Value, 0); }
  ...
  public static void AddSourcedDataTypes(FlatBufferBuilder builder, Elset_Ingest_sourcedDataTypes_Enum sourcedDataTypes) { builder.AddSbyte(37, (sbyte)sourcedDataTypes, 0); }
  public static void AddTransactionId(FlatBufferBuilder builder, StringOffset transactionIdOffset) { builder.AddOffset(38, transactionIdOffset.Value, 0); }
  ...
  public static Offset<Elset_Ingest> EndElset_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Elset_Ingest>(o);
  }
  public static void FinishElset_IngestBuffer(FlatBufferBuilder builder, Offset<Elset_Ingest> offset) { builder.Finish(offset.Value, "ELSE"); }
  public static void FinishSizePrefixedElset_IngestBuffer(FlatBufferBuilder builder, Offset<Elset_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "ELSE"); }
  public Elset_IngestT UnPack() {
    var _o = new Elset_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Elset_IngestT _o) {
  ...
  public static Offset<Elset_Ingest> Pack(FlatBufferBuilder builder, Elset_IngestT _o) {
    if (_o == null) return default(Offset<Elset_Ingest>);
...
public class Elset_IngestT
{
  ...
  public Elset_Ingest_dataMode_Enum DataMode { get; set; }
  public List<string> Tags { get; set; }
  public string Algorithm { get; set; }
  public List<string> SourcedData { get; set; }
  public Elset_Ingest_sourcedDataTypes_Enum SourcedDataTypes { get; set; }
  public string TransactionId { get; set; }
  public int EphemType { get; set; }
  public string OrigNetwork { get; set; }

  public Elset_IngestT() {
    this.IdElset = null;
    ...
    this.SourceDL = null;
    this.Source = null;
    this.DataMode = Elset_Ingest_dataMode_Enum.REAL;
    this.Tags = null;
    this.Algorithm = null;
    this.SourcedData = null;
    this.SourcedDataTypes = Elset_Ingest_sourcedDataTypes_Enum.EO;
    this.TransactionId = null;
    this.EphemType = 0;
    this.OrigNetwork = null;
  }
  public static Elset_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Elset_Ingest.GetRootAsElset_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Elset_Ingest.FinishElset_IngestBuffer(fbb, Elset_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Elset_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyString(tablePos, 62 /*RawFileURI*/, false)
      ...
      && verifier.VerifyField(tablePos, 70 /*DataMode*/, 1 /*Elset_Ingest_dataMode_Enum*/, 1, false)
      && verifier.VerifyVectorOfStrings(tablePos, 72 /*Tags*/, false)
      && verifier.VerifyString(tablePos, 74 /*Algorithm*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 76 /*SourcedData*/, false)
      && verifier.VerifyField(tablePos, 78 /*SourcedDataTypes*/, 1 /*Elset_Ingest_sourcedDataTypes_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 80 /*TransactionId*/, false)
      && verifier.VerifyField(tablePos, 82 /*EphemType*/, 4 /*int*/, 4, false)
