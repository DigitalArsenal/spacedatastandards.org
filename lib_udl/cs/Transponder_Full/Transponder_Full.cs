...
public struct Transponder_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Transponder_Full GetRootAsTransponder_Full(ByteBuffer _bb) { return GetRootAsTransponder_Full(_bb, new Transponder_Full()); }
  public static Transponder_Full GetRootAsTransponder_Full(ByteBuffer _bb, Transponder_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Transponder_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "TRAN"); }
  public static bool VerifyTransponder_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("TRAN", false, Transponder_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Transponder_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Transponder_Full_dataMode_Enum DataMode { get { int o = __p.__offset(34); return o != 0 ? (Transponder_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Transponder_Full_dataMode_Enum.REAL; } }
  ...
  /// Constraints: No constraints specified.
  public string Channels(int j) { int o = __p.__offset(44); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int ChannelsLength { get { int o = __p.__offset(44); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<Transponder_Full> CreateTransponder_Full(FlatBufferBuilder builder,
      ...
      Transponder_Full_dataMode_Enum dataMode = Transponder_Full_dataMode_Enum.REAL,
  ...
  public static void StartTransponder_Full(FlatBufferBuilder builder) { builder.StartTable(21); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Transponder_Full_dataMode_Enum dataMode) { builder.AddSbyte(15, (sbyte)dataMode, 0); }
  ...
  public static void AddChannels(FlatBufferBuilder builder, VectorOffset channelsOffset) { builder.AddOffset(20, channelsOffset.Value, 0); }
  ...
  public static Offset<Transponder_Full> EndTransponder_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Transponder_Full>(o);
  }
  public static void FinishTransponder_FullBuffer(FlatBufferBuilder builder, Offset<Transponder_Full> offset) { builder.Finish(offset.Value, "TRAN"); }
  public static void FinishSizePrefixedTransponder_FullBuffer(FlatBufferBuilder builder, Offset<Transponder_Full> offset) { builder.FinishSizePrefixed(offset.Value, "TRAN"); }
  public Transponder_FullT UnPack() {
    var _o = new Transponder_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Transponder_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Transponder_Full> Pack(FlatBufferBuilder builder, Transponder_FullT _o) {
    if (_o == null) return default(Offset<Transponder_Full>);
...
public class Transponder_FullT
{
  ...
  public Transponder_Full_dataMode_Enum DataMode { get; set; }
  ...
  public Transponder_FullT() {
    ...
    this.DataMode = Transponder_Full_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.UpdatedAt = null;
    this.UpdatedBy = null;
  ...
  public static Transponder_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Transponder_Full.GetRootAsTransponder_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Transponder_Full.FinishTransponder_FullBuffer(fbb, Transponder_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Transponder_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 34 /*DataMode*/, 1 /*Transponder_Full_dataMode_Enum*/, 1, false)
      ...
      && verifier.VerifyVectorOfStrings(tablePos, 44 /*Channels*/, false)
