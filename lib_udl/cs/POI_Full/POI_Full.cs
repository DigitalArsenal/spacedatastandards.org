...
public struct POI_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static POI_Full GetRootAsPOI_Full(ByteBuffer _bb) { return GetRootAsPOI_Full(_bb, new POI_Full()); }
  public static POI_Full GetRootAsPOI_Full(ByteBuffer _bb, POI_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool POI_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "POIF"); }
  public static bool VerifyPOI_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("POIF", false, POI_FullVerify.Verify); }
  ...
  public POI_Full_dataMode_Enum DataMode { get { int o = __p.__offset(86); return o != 0 ? (POI_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : POI_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<POI_Full> CreatePOI_Full(FlatBufferBuilder builder,
      ...
      POI_Full_dataMode_Enum dataMode = POI_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, POI_Full_dataMode_Enum dataMode) { builder.AddSbyte(41, (sbyte)dataMode, 0); }
  ...
  public static Offset<POI_Full> EndPOI_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<POI_Full>(o);
  }
  public static void FinishPOI_FullBuffer(FlatBufferBuilder builder, Offset<POI_Full> offset) { builder.Finish(offset.Value, "POIF"); }
  public static void FinishSizePrefixedPOI_FullBuffer(FlatBufferBuilder builder, Offset<POI_Full> offset) { builder.FinishSizePrefixed(offset.Value, "POIF"); }
  public POI_FullT UnPack() {
    var _o = new POI_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(POI_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<POI_Full> Pack(FlatBufferBuilder builder, POI_FullT _o) {
    if (_o == null) return default(Offset<POI_Full>);
...
public class POI_FullT
{
  ...
  public POI_Full_dataMode_Enum DataMode { get; set; }
  ...
  public POI_FullT() {
    ...
    this.SourceDL = null;
    this.Source = null;
    this.DataMode = POI_Full_dataMode_Enum.REAL;
    this.Origin = null;
    this.Groups = null;
    this.Asset = null;
    this.Tags = null;
  ...
  public static POI_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return POI_Full.GetRootAsPOI_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    POI_Full.FinishPOI_FullBuffer(fbb, POI_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class POI_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 86 /*DataMode*/, 1 /*POI_Full_dataMode_Enum*/, 1, false)
