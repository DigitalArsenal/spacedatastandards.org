...
public struct AirTransportMissionHazMat_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirTransportMissionHazMat_Ingest GetRootAsAirTransportMissionHazMat_Ingest(ByteBuffer _bb) { return GetRootAsAirTransportMissionHazMat_Ingest(_bb, new AirTransportMissionHazMat_Ingest()); }
  public static AirTransportMissionHazMat_Ingest GetRootAsAirTransportMissionHazMat_Ingest(ByteBuffer _bb, AirTransportMissionHazMat_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirTransportMissionHazMat_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRT"); }
  public static bool VerifyAirTransportMissionHazMat_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRT", false, AirTransportMissionHazMat_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirTransportMissionHazMat_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<AirTransportMissionHazMat_Ingest> CreateAirTransportMissionHazMat_Ingest(FlatBufferBuilder builder,
  ...
  public static void StartAirTransportMissionHazMat_Ingest(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static Offset<AirTransportMissionHazMat_Ingest> EndAirTransportMissionHazMat_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirTransportMissionHazMat_Ingest>(o);
  }
  public static void FinishAirTransportMissionHazMat_IngestBuffer(FlatBufferBuilder builder, Offset<AirTransportMissionHazMat_Ingest> offset) { builder.Finish(offset.Value, "AIRT"); }
  public static void FinishSizePrefixedAirTransportMissionHazMat_IngestBuffer(FlatBufferBuilder builder, Offset<AirTransportMissionHazMat_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AIRT"); }
  public AirTransportMissionHazMat_IngestT UnPack() {
    var _o = new AirTransportMissionHazMat_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirTransportMissionHazMat_IngestT _o) {
  ...
  public static Offset<AirTransportMissionHazMat_Ingest> Pack(FlatBufferBuilder builder, AirTransportMissionHazMat_IngestT _o) {
    if (_o == null) return default(Offset<AirTransportMissionHazMat_Ingest>);
...
public class AirTransportMissionHazMat_IngestT
{
  ...
  public AirTransportMissionHazMat_IngestT() {
  ...
  public static AirTransportMissionHazMat_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AirTransportMissionHazMat_Ingest.GetRootAsAirTransportMissionHazMat_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirTransportMissionHazMat_Ingest.FinishAirTransportMissionHazMat_IngestBuffer(fbb, AirTransportMissionHazMat_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirTransportMissionHazMat_IngestVerify
{
