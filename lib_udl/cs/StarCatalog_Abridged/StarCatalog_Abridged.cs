...
public struct StarCatalog_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static StarCatalog_Abridged GetRootAsStarCatalog_Abridged(ByteBuffer _bb, StarCatalog_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool StarCatalog_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "STAR"); }
  public static bool VerifyStarCatalog_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("STAR", false, StarCatalog_AbridgedVerify.Verify); }
  ...
  public StarCatalog_Abridged_astrometryOrigin_Enum AstrometryOrigin { get { int o = __p.__offset(42); return o != 0 ? (StarCatalog_Abridged_astrometryOrigin_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : StarCatalog_Abridged_astrometryOrigin_Enum.GAIADR3; } }
  ...
  public StarCatalog_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(98); return o != 0 ? (StarCatalog_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : StarCatalog_Abridged_dataMode_Enum.REAL; } }

  public static Offset<StarCatalog_Abridged> CreateStarCatalog_Abridged(FlatBufferBuilder builder,
      ...
      StarCatalog_Abridged_astrometryOrigin_Enum astrometryOrigin = StarCatalog_Abridged_astrometryOrigin_Enum.GAIADR3,
      ...
      StarCatalog_Abridged_dataMode_Enum dataMode = StarCatalog_Abridged_dataMode_Enum.REAL) {
  ...
  public static void AddAstrometryOrigin(FlatBufferBuilder builder, StarCatalog_Abridged_astrometryOrigin_Enum astrometryOrigin) { builder.AddSbyte(19, (sbyte)astrometryOrigin, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, StarCatalog_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(47, (sbyte)dataMode, 0); }
  public static Offset<StarCatalog_Abridged> EndStarCatalog_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<StarCatalog_Abridged>(o);
  }
  public static void FinishStarCatalog_AbridgedBuffer(FlatBufferBuilder builder, Offset<StarCatalog_Abridged> offset) { builder.Finish(offset.Value, "STAR"); }
  public static void FinishSizePrefixedStarCatalog_AbridgedBuffer(FlatBufferBuilder builder, Offset<StarCatalog_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "STAR"); }
  public StarCatalog_AbridgedT UnPack() {
    var _o = new StarCatalog_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(StarCatalog_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<StarCatalog_Abridged> Pack(FlatBufferBuilder builder, StarCatalog_AbridgedT _o) {
    if (_o == null) return default(Offset<StarCatalog_Abridged>);
...
public class StarCatalog_AbridgedT
{
  ...
  public StarCatalog_Abridged_astrometryOrigin_Enum AstrometryOrigin { get; set; }
  ...
  public StarCatalog_Abridged_dataMode_Enum DataMode { get; set; }

  public StarCatalog_AbridgedT() {
    this.Id = null;
    ...
    this.AstrometryOrigin = StarCatalog_Abridged_astrometryOrigin_Enum.GAIADR3;
    this.StarEpoch = 0.0;
    this.Gmag = 0.0;
    this.GmagUnc = 0.0;
    this.Bpmag = 0.0;
    ...
    this.DataMode = StarCatalog_Abridged_dataMode_Enum.REAL;
  }
  public static StarCatalog_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return StarCatalog_Abridged.GetRootAsStarCatalog_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    StarCatalog_Abridged.FinishStarCatalog_AbridgedBuffer(fbb, StarCatalog_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class StarCatalog_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 42 /*AstrometryOrigin*/, 1 /*StarCatalog_Abridged_astrometryOrigin_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 98 /*DataMode*/, 1 /*StarCatalog_Abridged_dataMode_Enum*/, 1, false)
