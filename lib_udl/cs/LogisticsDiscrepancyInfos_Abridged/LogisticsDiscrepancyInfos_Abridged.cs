...
public struct LogisticsDiscrepancyInfos_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static LogisticsDiscrepancyInfos_Abridged GetRootAsLogisticsDiscrepancyInfos_Abridged(ByteBuffer _bb) { return GetRootAsLogisticsDiscrepancyInfos_Abridged(_bb, new LogisticsDiscrepancyInfos_Abridged()); }
  public static LogisticsDiscrepancyInfos_Abridged GetRootAsLogisticsDiscrepancyInfos_Abridged(ByteBuffer _bb, LogisticsDiscrepancyInfos_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LogisticsDiscrepancyInfos_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LOGI"); }
  public static bool VerifyLogisticsDiscrepancyInfos_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LOGI", false, LogisticsDiscrepancyInfos_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public LogisticsDiscrepancyInfos_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<LogisticsDiscrepancyInfos_Abridged> CreateLogisticsDiscrepancyInfos_Abridged(FlatBufferBuilder builder,
    ...
    LogisticsDiscrepancyInfos_Abridged.AddClosureTime(builder, closureTimeOffset);
    LogisticsDiscrepancyInfos_Abridged.AddJobStTime(builder, jobStTimeOffset);
    LogisticsDiscrepancyInfos_Abridged.AddDiscrepancyInfo(builder, discrepancyInfoOffset);
    LogisticsDiscrepancyInfos_Abridged.AddJcn(builder, jcnOffset);
    return LogisticsDiscrepancyInfos_Abridged.EndLogisticsDiscrepancyInfos_Abridged(builder);
  }

  public static void StartLogisticsDiscrepancyInfos_Abridged(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<LogisticsDiscrepancyInfos_Abridged> EndLogisticsDiscrepancyInfos_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LogisticsDiscrepancyInfos_Abridged>(o);
  }
  public static void FinishLogisticsDiscrepancyInfos_AbridgedBuffer(FlatBufferBuilder builder, Offset<LogisticsDiscrepancyInfos_Abridged> offset) { builder.Finish(offset.Value, "LOGI"); }
  public static void FinishSizePrefixedLogisticsDiscrepancyInfos_AbridgedBuffer(FlatBufferBuilder builder, Offset<LogisticsDiscrepancyInfos_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "LOGI"); }
  public LogisticsDiscrepancyInfos_AbridgedT UnPack() {
    var _o = new LogisticsDiscrepancyInfos_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LogisticsDiscrepancyInfos_AbridgedT _o) {
    _o.Jcn = this.Jcn;
    _o.DiscrepancyInfo = this.DiscrepancyInfo;
    _o.JobStTime = this.JobStTime;
    _o.ClosureTime = this.ClosureTime;
  }
  public static Offset<LogisticsDiscrepancyInfos_Abridged> Pack(FlatBufferBuilder builder, LogisticsDiscrepancyInfos_AbridgedT _o) {
    if (_o == null) return default(Offset<LogisticsDiscrepancyInfos_Abridged>);
    ...
    return CreateLogisticsDiscrepancyInfos_Abridged(
      builder,
      _jcn,
      _discrepancyInfo,
      _jobStTime,
...
public class LogisticsDiscrepancyInfos_AbridgedT
{
  ...
  public LogisticsDiscrepancyInfos_AbridgedT() {
    this.Jcn = null;
    this.DiscrepancyInfo = null;
    this.JobStTime = null;
    this.ClosureTime = null;
  }
  public static LogisticsDiscrepancyInfos_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return LogisticsDiscrepancyInfos_Abridged.GetRootAsLogisticsDiscrepancyInfos_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LogisticsDiscrepancyInfos_Abridged.FinishLogisticsDiscrepancyInfos_AbridgedBuffer(fbb, LogisticsDiscrepancyInfos_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LogisticsDiscrepancyInfos_AbridgedVerify
{
