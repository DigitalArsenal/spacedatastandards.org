...
public struct SiteStatus_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static SiteStatus_Full GetRootAsSiteStatus_Full(ByteBuffer _bb, SiteStatus_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SiteStatus_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SITE"); }
  public static bool VerifySiteStatus_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SITE", false, SiteStatus_FullVerify.Verify); }
  ...
  public SiteStatus_Full_instStatus_Enum InstStatus { get { int o = __p.__offset(22); return o != 0 ? (SiteStatus_Full_instStatus_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SiteStatus_Full_instStatus_Enum.FMC; } }
  ...
  public SiteStatus_Full_fpcon_Enum Fpcon { get { int o = __p.__offset(24); return o != 0 ? (SiteStatus_Full_fpcon_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SiteStatus_Full_fpcon_Enum.NORMAL; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 7
  public SiteStatus_Full_hpcon_Enum Hpcon { get { int o = __p.__offset(26); return o != 0 ? (SiteStatus_Full_hpcon_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SiteStatus_Full_hpcon_Enum.E0; } }
  ...
  public SiteStatus_Full_cpcon_Enum Cpcon { get { int o = __p.__offset(28); return o != 0 ? (SiteStatus_Full_cpcon_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SiteStatus_Full_cpcon_Enum.E1; } }
  ...
  public SiteStatus_Full_cat_Enum Cat { get { int o = __p.__offset(50); return o != 0 ? (SiteStatus_Full_cat_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SiteStatus_Full_cat_Enum.COLD; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 4
  public SiteStatus_Full_eoc_Enum Eoc { get { int o = __p.__offset(52); return o != 0 ? (SiteStatus_Full_eoc_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SiteStatus_Full_eoc_Enum.COLD; } }
  ...
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string UpdatedAt { get { int o = __p.__offset(70); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedAtBytes() { return __p.__vector_as_span<byte>(70, 1); }
#else
  public ArraySegment<byte>? GetUpdatedAtBytes() { return __p.__vector_as_arraysegment(70); }
#endif
  public byte[] GetUpdatedAtArray() { return __p.__vector_as_array<byte>(70); }
  /// Application user who updated the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string UpdatedBy { get { int o = __p.__offset(72); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedByBytes() { return __p.__vector_as_span<byte>(72, 1); }
#else
  public ArraySegment<byte>? GetUpdatedByBytes() { return __p.__vector_as_arraysegment(72); }
#endif
  public byte[] GetUpdatedByArray() { return __p.__vector_as_array<byte>(72); }
  /// Source of the data.
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SiteStatus_Full_dataMode_Enum DataMode { get { int o = __p.__offset(80); return o != 0 ? (SiteStatus_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SiteStatus_Full_dataMode_Enum.REAL; } }

  public static Offset<SiteStatus_Full> CreateSiteStatus_Full(FlatBufferBuilder builder,
      ...
      SiteStatus_Full_instStatus_Enum instStatus = SiteStatus_Full_instStatus_Enum.FMC,
      SiteStatus_Full_fpcon_Enum fpcon = SiteStatus_Full_fpcon_Enum.NORMAL,
      SiteStatus_Full_hpcon_Enum hpcon = SiteStatus_Full_hpcon_Enum.E0,
      SiteStatus_Full_cpcon_Enum cpcon = SiteStatus_Full_cpcon_Enum.E1,
      ...
      SiteStatus_Full_cat_Enum cat = SiteStatus_Full_cat_Enum.COLD,
      SiteStatus_Full_eoc_Enum eoc = SiteStatus_Full_eoc_Enum.COLD,
      ...
      SiteStatus_Full_dataMode_Enum dataMode = SiteStatus_Full_dataMode_Enum.REAL) {
  ...
  public static void AddInstStatus(FlatBufferBuilder builder, SiteStatus_Full_instStatus_Enum instStatus) { builder.AddSbyte(9, (sbyte)instStatus, 0); }
  public static void AddFpcon(FlatBufferBuilder builder, SiteStatus_Full_fpcon_Enum fpcon) { builder.AddSbyte(10, (sbyte)fpcon, 0); }
  public static void AddHpcon(FlatBufferBuilder builder, SiteStatus_Full_hpcon_Enum hpcon) { builder.AddSbyte(11, (sbyte)hpcon, 0); }
  public static void AddCpcon(FlatBufferBuilder builder, SiteStatus_Full_cpcon_Enum cpcon) { builder.AddSbyte(12, (sbyte)cpcon, 0); }
  ...
  public static void AddCat(FlatBufferBuilder builder, SiteStatus_Full_cat_Enum cat) { builder.AddSbyte(23, (sbyte)cat, 0); }
  public static void AddEoc(FlatBufferBuilder builder, SiteStatus_Full_eoc_Enum eoc) { builder.AddSbyte(24, (sbyte)eoc, 0); }
  ...
  public static void AddUpdatedAt(FlatBufferBuilder builder, StringOffset updatedAtOffset) { builder.AddOffset(33, updatedAtOffset.Value, 0); }
  public static void AddUpdatedBy(FlatBufferBuilder builder, StringOffset updatedByOffset) { builder.AddOffset(34, updatedByOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SiteStatus_Full_dataMode_Enum dataMode) { builder.AddSbyte(38, (sbyte)dataMode, 0); }
  public static Offset<SiteStatus_Full> EndSiteStatus_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SiteStatus_Full>(o);
  }
  public static void FinishSiteStatus_FullBuffer(FlatBufferBuilder builder, Offset<SiteStatus_Full> offset) { builder.Finish(offset.Value, "SITE"); }
  public static void FinishSizePrefixedSiteStatus_FullBuffer(FlatBufferBuilder builder, Offset<SiteStatus_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SITE"); }
  public SiteStatus_FullT UnPack() {
    var _o = new SiteStatus_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SiteStatus_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SiteStatus_Full> Pack(FlatBufferBuilder builder, SiteStatus_FullT _o) {
    if (_o == null) return default(Offset<SiteStatus_Full>);
...
public class SiteStatus_FullT
{
  ...
  public SiteStatus_Full_instStatus_Enum InstStatus { get; set; }
  public SiteStatus_Full_fpcon_Enum Fpcon { get; set; }
  public SiteStatus_Full_hpcon_Enum Hpcon { get; set; }
  public SiteStatus_Full_cpcon_Enum Cpcon { get; set; }
  ...
  public SiteStatus_Full_cat_Enum Cat { get; set; }
  public SiteStatus_Full_eoc_Enum Eoc { get; set; }
  ...
  public SiteStatus_Full_dataMode_Enum DataMode { get; set; }

  public SiteStatus_FullT() {
    this.Id = null;
    ...
    this.InstStatus = SiteStatus_Full_instStatus_Enum.FMC;
    this.Fpcon = SiteStatus_Full_fpcon_Enum.NORMAL;
    this.Hpcon = SiteStatus_Full_hpcon_Enum.E0;
    this.Cpcon = SiteStatus_Full_cpcon_Enum.E1;
    ...
    this.Cat = SiteStatus_Full_cat_Enum.COLD;
    this.Eoc = SiteStatus_Full_eoc_Enum.COLD;
    this.Link = null;
    ...
    this.DataMode = SiteStatus_Full_dataMode_Enum.REAL;
  }
  public static SiteStatus_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return SiteStatus_Full.GetRootAsSiteStatus_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SiteStatus_Full.FinishSiteStatus_FullBuffer(fbb, SiteStatus_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SiteStatus_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*InstStatus*/, 1 /*SiteStatus_Full_instStatus_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 24 /*Fpcon*/, 1 /*SiteStatus_Full_fpcon_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 26 /*Hpcon*/, 1 /*SiteStatus_Full_hpcon_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 28 /*Cpcon*/, 1 /*SiteStatus_Full_cpcon_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 50 /*Cat*/, 1 /*SiteStatus_Full_cat_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 52 /*Eoc*/, 1 /*SiteStatus_Full_eoc_Enum*/, 1, false)
      ...
      && verifier.VerifyString(tablePos, 70 /*UpdatedAt*/, false)
      && verifier.VerifyString(tablePos, 72 /*UpdatedBy*/, false)
      ...
      && verifier.VerifyField(tablePos, 80 /*DataMode*/, 1 /*SiteStatus_Full_dataMode_Enum*/, 1, false)
