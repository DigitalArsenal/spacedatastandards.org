...
public struct RFObservationDetails_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static RFObservationDetails_Ingest GetRootAsRFObservationDetails_Ingest(ByteBuffer _bb, RFObservationDetails_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool RFObservationDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "RFOB"); }
  public static bool VerifyRFObservationDetails_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("RFOB", false, RFObservationDetails_IngestVerify.Verify); }
  ...
  public RFObservationDetails_Ingest_polarityType_Enum PolarityType { get { int o = __p.__offset(94); return o != 0 ? (RFObservationDetails_Ingest_polarityType_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFObservationDetails_Ingest_polarityType_Enum.H; } }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public RFObservationDetails_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(134); return o != 0 ? (RFObservationDetails_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFObservationDetails_Ingest_dataMode_Enum.REAL; } }
  ...
  public string Url { get { int o = __p.__offset(166); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUrlBytes() { return __p.__vector_as_span<byte>(166, 1); }
#else
  public ArraySegment<byte>? GetUrlBytes() { return __p.__vector_as_arraysegment(166); }
#endif
  public byte[] GetUrlArray() { return __p.__vector_as_array<byte>(166); }
  ...
  /// Constraints: No constraints specified.
  public string Frequencies(int j) { int o = __p.__offset(168); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int FrequenciesLength { get { int o = __p.__offset(168); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Example: /// Example: [1.1, 2.2]
  /// Constraints: No constraints specified.
  public string Powers(int j) { int o = __p.__offset(170); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int PowersLength { get { int o = __p.__offset(170); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Array of signal to noise ratios of the signals, in dB.
  /// Example: /// Example: [1.1, 2.2]
  /// Constraints: No constraints specified.
  public string Snrs(int j) { int o = __p.__offset(172); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SnrsLength { get { int o = __p.__offset(172); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Array of measurement confidences.
  /// Example: /// Example: [1.1, 2.2]
  /// Constraints: No constraints specified.
  public string Confidences(int j) { int o = __p.__offset(174); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int ConfidencesLength { get { int o = __p.__offset(174); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Array of detection statuses (e.g. DETECTED, CARRIER_DETECTED, NOT_DETECTED) for each measured signal.
  /// Example: /// Example: ['DETECTED']
  /// Constraints: No constraints specified.
  public string DetectionStatuses(int j) { int o = __p.__offset(176); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int DetectionStatusesLength { get { int o = __p.__offset(176); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Array of chipRates.
  /// Example: /// Example: [1.1, 2.2]
  /// Constraints: No constraints specified.
  public string ChipRates(int j) { int o = __p.__offset(178); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int ChipRatesLength { get { int o = __p.__offset(178); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Array of code taps.
  /// Example: /// Example: ['TAG1', 'TAG2']
  /// Constraints: No constraints specified.
  public string CodeTaps(int j) { int o = __p.__offset(180); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int CodeTapsLength { get { int o = __p.__offset(180); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Array of code fills.
  /// Example: /// Example: ['TAG1', 'TAG2']
  /// Constraints: No constraints specified.
  public string CodeFills(int j) { int o = __p.__offset(182); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int CodeFillsLength { get { int o = __p.__offset(182); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Array of code lengths.
  /// Example: /// Example: [1.1, 2.2]
  /// Constraints: No constraints specified.
  public string CodeLengths(int j) { int o = __p.__offset(184); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int CodeLengthsLength { get { int o = __p.__offset(184); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Array of pnOrder.
  /// Example: /// Example: [1, 2]
  /// Constraints: No constraints specified.
  public string PnOrders(int j) { int o = __p.__offset(186); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int PnOrdersLength { get { int o = __p.__offset(186); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Array of optional source provided identifiers of the measurements/signals.
  /// Example: /// Example: ['ID1', 'ID2']
  /// Constraints: No constraints specified.
  public string SignalIds(int j) { int o = __p.__offset(188); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SignalIdsLength { get { int o = __p.__offset(188); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Array of measured signal baud rates.
  /// Example: /// Example: [1.1, 2.2]
  /// Constraints: No constraints specified.
  public string BaudRates(int j) { int o = __p.__offset(190); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int BaudRatesLength { get { int o = __p.__offset(190); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Array of optional source provided telemetry identifiers of the measurements/signals.
  /// Example: /// Example: ['ID1', 'ID2']
  /// Constraints: No constraints specified.
  public string TelemetryIds(int j) { int o = __p.__offset(192); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int TelemetryIdsLength { get { int o = __p.__offset(192); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Example: /// Example: [1.1, 2.2]
  /// Constraints: No constraints specified.
  public string ConstellationXPoints(int j) { int o = __p.__offset(194); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int ConstellationXPointsLength { get { int o = __p.__offset(194); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Example: /// Example: [1.1, 2.2]
  /// Constraints: No constraints specified.
  public string ConstellationYPoints(int j) { int o = __p.__offset(196); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int ConstellationYPointsLength { get { int o = __p.__offset(196); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<RFObservationDetails_Ingest> CreateRFObservationDetails_Ingest(FlatBufferBuilder builder,
      ...
      double polarity = 0.0,
      RFObservationDetails_Ingest_polarityType_Enum polarityType = RFObservationDetails_Ingest_polarityType_Enum.H,
      int channel = 0,
      ...
      RFObservationDetails_Ingest_dataMode_Enum dataMode = RFObservationDetails_Ingest_dataMode_Enum.REAL,
  ...
  public static void AddPolarityType(FlatBufferBuilder builder, RFObservationDetails_Ingest_polarityType_Enum polarityType) { builder.AddSbyte(45, (sbyte)polarityType, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, RFObservationDetails_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(65, (sbyte)dataMode, 0); }
  ...
  public static void AddUrl(FlatBufferBuilder builder, StringOffset urlOffset) { builder.AddOffset(81, urlOffset.Value, 0); }
  public static void AddFrequencies(FlatBufferBuilder builder, VectorOffset frequenciesOffset) { builder.AddOffset(82, frequenciesOffset.Value, 0); }
  ...
  public static void AddPowers(FlatBufferBuilder builder, VectorOffset powersOffset) { builder.AddOffset(83, powersOffset.Value, 0); }
  ...
  public static void AddSnrs(FlatBufferBuilder builder, VectorOffset snrsOffset) { builder.AddOffset(84, snrsOffset.Value, 0); }
  ...
  public static void AddConfidences(FlatBufferBuilder builder, VectorOffset confidencesOffset) { builder.AddOffset(85, confidencesOffset.Value, 0); }
  ...
  public static void AddDetectionStatuses(FlatBufferBuilder builder, VectorOffset detectionStatusesOffset) { builder.AddOffset(86, detectionStatusesOffset.Value, 0); }
  ...
  public static void AddChipRates(FlatBufferBuilder builder, VectorOffset chipRatesOffset) { builder.AddOffset(87, chipRatesOffset.Value, 0); }
  ...
  public static void AddCodeTaps(FlatBufferBuilder builder, VectorOffset codeTapsOffset) { builder.AddOffset(88, codeTapsOffset.Value, 0); }
  ...
  public static void AddCodeFills(FlatBufferBuilder builder, VectorOffset codeFillsOffset) { builder.AddOffset(89, codeFillsOffset.Value, 0); }
  ...
  public static void AddCodeLengths(FlatBufferBuilder builder, VectorOffset codeLengthsOffset) { builder.AddOffset(90, codeLengthsOffset.Value, 0); }
  ...
  public static void AddPnOrders(FlatBufferBuilder builder, VectorOffset pnOrdersOffset) { builder.AddOffset(91, pnOrdersOffset.Value, 0); }
  ...
  public static void AddSignalIds(FlatBufferBuilder builder, VectorOffset signalIdsOffset) { builder.AddOffset(92, signalIdsOffset.Value, 0); }
  ...
  public static void AddBaudRates(FlatBufferBuilder builder, VectorOffset baudRatesOffset) { builder.AddOffset(93, baudRatesOffset.Value, 0); }
  ...
  public static void AddTelemetryIds(FlatBufferBuilder builder, VectorOffset telemetryIdsOffset) { builder.AddOffset(94, telemetryIdsOffset.Value, 0); }
  ...
  public static void AddConstellationXPoints(FlatBufferBuilder builder, VectorOffset constellationXPointsOffset) { builder.AddOffset(95, constellationXPointsOffset.Value, 0); }
  ...
  public static void AddConstellationYPoints(FlatBufferBuilder builder, VectorOffset constellationYPointsOffset) { builder.AddOffset(96, constellationYPointsOffset.Value, 0); }
  ...
  public static Offset<RFObservationDetails_Ingest> EndRFObservationDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RFObservationDetails_Ingest>(o);
  }
  public static void FinishRFObservationDetails_IngestBuffer(FlatBufferBuilder builder, Offset<RFObservationDetails_Ingest> offset) { builder.Finish(offset.Value, "RFOB"); }
  public static void FinishSizePrefixedRFObservationDetails_IngestBuffer(FlatBufferBuilder builder, Offset<RFObservationDetails_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "RFOB"); }
  public RFObservationDetails_IngestT UnPack() {
    var _o = new RFObservationDetails_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RFObservationDetails_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<RFObservationDetails_Ingest> Pack(FlatBufferBuilder builder, RFObservationDetails_IngestT _o) {
    if (_o == null) return default(Offset<RFObservationDetails_Ingest>);
...
public class RFObservationDetails_IngestT
{
  ...
  public RFObservationDetails_Ingest_polarityType_Enum PolarityType { get; set; }
  ...
  public RFObservationDetails_Ingest_dataMode_Enum DataMode { get; set; }
  ...
  public RFObservationDetails_IngestT() {
    this.Id = null;
    ...
    this.NominalSnr = 0.0;
    this.Polarity = 0.0;
    this.PolarityType = RFObservationDetails_Ingest_polarityType_Enum.H;
    this.Channel = 0;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = RFObservationDetails_Ingest_dataMode_Enum.REAL;
    this.Tags = null;
    this.CreatedAt = null;
    this.CreatedBy = null;
  ...
  public static RFObservationDetails_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return RFObservationDetails_Ingest.GetRootAsRFObservationDetails_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    RFObservationDetails_Ingest.FinishRFObservationDetails_IngestBuffer(fbb, RFObservationDetails_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class RFObservationDetails_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 94 /*PolarityType*/, 1 /*RFObservationDetails_Ingest_polarityType_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 134 /*DataMode*/, 1 /*RFObservationDetails_Ingest_dataMode_Enum*/, 1, false)
      ...
      && verifier.VerifyString(tablePos, 166 /*Url*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 168 /*Frequencies*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 170 /*Powers*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 172 /*Snrs*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 174 /*Confidences*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 176 /*DetectionStatuses*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 178 /*ChipRates*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 180 /*CodeTaps*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 182 /*CodeFills*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 184 /*CodeLengths*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 186 /*PnOrders*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 188 /*SignalIds*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 190 /*BaudRates*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 192 /*TelemetryIds*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 194 /*ConstellationXPoints*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 196 /*ConstellationYPoints*/, false)
