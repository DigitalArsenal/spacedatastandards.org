...
public struct Equipment_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static Equipment_Ingest GetRootAsEquipment_Ingest(ByteBuffer _bb, Equipment_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Equipment_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EQUI"); }
  public static bool VerifyEquipment_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EQUI", false, Equipment_IngestVerify.Verify); }
  ...
  public Equipment_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(108); return o != 0 ? (Equipment_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Equipment_Ingest_dataMode_Enum.REAL; } }

  public static Offset<Equipment_Ingest> CreateEquipment_Ingest(FlatBufferBuilder builder,
      ...
      Equipment_Ingest_dataMode_Enum dataMode = Equipment_Ingest_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Equipment_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(52, (sbyte)dataMode, 0); }
  public static Offset<Equipment_Ingest> EndEquipment_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Equipment_Ingest>(o);
  }
  public static void FinishEquipment_IngestBuffer(FlatBufferBuilder builder, Offset<Equipment_Ingest> offset) { builder.Finish(offset.Value, "EQUI"); }
  public static void FinishSizePrefixedEquipment_IngestBuffer(FlatBufferBuilder builder, Offset<Equipment_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "EQUI"); }
  public Equipment_IngestT UnPack() {
    var _o = new Equipment_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Equipment_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Equipment_Ingest> Pack(FlatBufferBuilder builder, Equipment_IngestT _o) {
    if (_o == null) return default(Offset<Equipment_Ingest>);
...
public class Equipment_IngestT
{
  ...
  public Equipment_Ingest_dataMode_Enum DataMode { get; set; }

  public Equipment_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Equipment_Ingest_dataMode_Enum.REAL;
  }
  public static Equipment_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Equipment_Ingest.GetRootAsEquipment_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Equipment_Ingest.FinishEquipment_IngestBuffer(fbb, Equipment_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Equipment_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 108 /*DataMode*/, 1 /*Equipment_Ingest_dataMode_Enum*/, 1, false)
