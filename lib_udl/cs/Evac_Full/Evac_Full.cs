...
public struct Evac_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Evac_Full GetRootAsEvac_Full(ByteBuffer _bb) { return GetRootAsEvac_Full(_bb, new Evac_Full()); }
  public static Evac_Full GetRootAsEvac_Full(ByteBuffer _bb, Evac_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Evac_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EVAC"); }
  public static bool VerifyEvac_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EVAC", false, Evac_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Evac_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public Evac_Full_type_Enum Type { get { int o = __p.__offset(10); return o != 0 ? (Evac_Full_type_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Evac_Full_type_Enum.REQUEST; } }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string RelatedDocs(int j) { int o = __p.__offset(72); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int RelatedDocsLength { get { int o = __p.__offset(72); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  public Evac_Full_dataMode_Enum DataMode { get { int o = __p.__offset(84); return o != 0 ? (Evac_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Evac_Full_dataMode_Enum.REAL; } }

  public static Offset<Evac_Full> CreateEvac_Full(FlatBufferBuilder builder,
      StringOffset idOffset = default(StringOffset),
      StringOffset classificationMarkingOffset = default(StringOffset),
      StringOffset medevacIdOffset = default(StringOffset),
      Evac_Full_type_Enum type = Evac_Full_type_Enum.REQUEST,
      ...
      Evac_Full_dataMode_Enum dataMode = Evac_Full_dataMode_Enum.REAL) {
    builder.StartTable(41);
    Evac_Full.AddCntctFreq(builder, cntctFreq);
    Evac_Full.AddLe(builder, le);
    Evac_Full.AddCe(builder, ce);
    Evac_Full.AddPickupAlt(builder, pickupAlt);
    Evac_Full.AddPickupLon(builder, pickupLon);
    Evac_Full.AddPickupLat(builder, pickupLat);
    Evac_Full.AddOrigin(builder, originOffset);
    Evac_Full.AddSource(builder, sourceOffset);
    Evac_Full.AddCreatedBy(builder, createdByOffset);
    Evac_Full.AddCreatedAt(builder, createdAtOffset);
    Evac_Full.AddOrigNetwork(builder, origNetworkOffset);
    Evac_Full.AddRelatedDocs(builder, relatedDocsOffset);
    Evac_Full.AddEnemyData(builder, enemyDataOffset);
    Evac_Full.AddCasualtyInfo(builder, casualtyInfoOffset);
    Evac_Full.AddComments(builder, commentsOffset);
    Evac_Full.AddNumCasualties(builder, numCasualties);
    Evac_Full.AddZoneContrCallSign(builder, zoneContrCallSignOffset);
    Evac_Full.AddZoneMarkingColor(builder, zoneMarkingColorOffset);
    Evac_Full.AddZoneSecurity(builder, zoneSecurityOffset);
    Evac_Full.AddZoneMarking(builder, zoneMarkingOffset);
    Evac_Full.AddZoneName(builder, zoneNameOffset);
    Evac_Full.AddTerrainRemarks(builder, terrainRemarksOffset);
    Evac_Full.AddObstaclesRemarks(builder, obstaclesRemarksOffset);
    Evac_Full.AddTerrain(builder, terrainOffset);
    Evac_Full.AddPickupTime(builder, pickupTimeOffset);
    Evac_Full.AddReqCallSign(builder, reqCallSignOffset);
    Evac_Full.AddReqTime(builder, reqTimeOffset);
    Evac_Full.AddReqNum(builder, reqNumOffset);
    Evac_Full.AddNumAmbulatory(builder, numAmbulatory);
    Evac_Full.AddNumLitter(builder, numLitter);
    Evac_Full.AddNumWIA(builder, numWIA);
    Evac_Full.AddNumKIA(builder, numKIA);
    Evac_Full.AddIdWeatherReport(builder, idWeatherReportOffset);
    Evac_Full.AddMissionType(builder, missionTypeOffset);
    Evac_Full.AddMedevacId(builder, medevacIdOffset);
    Evac_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    Evac_Full.AddId(builder, idOffset);
    Evac_Full.AddDataMode(builder, dataMode);
    Evac_Full.AddZoneHot(builder, zoneHot);
    Evac_Full.AddMedicReq(builder, medicReq);
    Evac_Full.AddType(builder, type);
    return Evac_Full.EndEvac_Full(builder);
  }

  public static void StartEvac_Full(FlatBufferBuilder builder) { builder.StartTable(41); }
  ...
  public static void AddType(FlatBufferBuilder builder, Evac_Full_type_Enum type) { builder.AddSbyte(3, (sbyte)type, 0); }
  ...
  public static void AddRelatedDocs(FlatBufferBuilder builder, VectorOffset relatedDocsOffset) { builder.AddOffset(34, relatedDocsOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Evac_Full_dataMode_Enum dataMode) { builder.AddSbyte(40, (sbyte)dataMode, 0); }
  public static Offset<Evac_Full> EndEvac_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Evac_Full>(o);
  }
  public static void FinishEvac_FullBuffer(FlatBufferBuilder builder, Offset<Evac_Full> offset) { builder.Finish(offset.Value, "EVAC"); }
  public static void FinishSizePrefixedEvac_FullBuffer(FlatBufferBuilder builder, Offset<Evac_Full> offset) { builder.FinishSizePrefixed(offset.Value, "EVAC"); }
  public Evac_FullT UnPack() {
    var _o = new Evac_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Evac_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Evac_Full> Pack(FlatBufferBuilder builder, Evac_FullT _o) {
    if (_o == null) return default(Offset<Evac_Full>);
...
public class Evac_FullT
{
  public string Id { get; set; }
  public string ClassificationMarking { get; set; }
  public string MedevacId { get; set; }
  public Evac_Full_type_Enum Type { get; set; }
  ...
  public Evac_Full_dataMode_Enum DataMode { get; set; }

  public Evac_FullT() {
    this.Id = null;
    this.ClassificationMarking = null;
    this.MedevacId = null;
    this.Type = Evac_Full_type_Enum.REQUEST;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Evac_Full_dataMode_Enum.REAL;
  }
  public static Evac_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Evac_Full.GetRootAsEvac_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Evac_Full.FinishEvac_FullBuffer(fbb, Evac_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Evac_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*Type*/, 1 /*Evac_Full_type_Enum*/, 1, false)
      ...
      && verifier.VerifyVectorOfStrings(tablePos, 72 /*RelatedDocs*/, false)
      ...
      && verifier.VerifyField(tablePos, 84 /*DataMode*/, 1 /*Evac_Full_dataMode_Enum*/, 1, false)
