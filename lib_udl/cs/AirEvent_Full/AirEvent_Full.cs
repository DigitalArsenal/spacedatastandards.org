...
public struct AirEvent_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirEvent_Full GetRootAsAirEvent_Full(ByteBuffer _bb) { return GetRootAsAirEvent_Full(_bb, new AirEvent_Full()); }
  public static AirEvent_Full GetRootAsAirEvent_Full(ByteBuffer _bb, AirEvent_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirEvent_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRE"); }
  public static bool VerifyAirEvent_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRE", false, AirEvent_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirEvent_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public AirEvent_Full_dataMode_Enum DataMode { get { int o = __p.__offset(90); return o != 0 ? (AirEvent_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirEvent_Full_dataMode_Enum.REAL; } }

  public static Offset<AirEvent_Full> CreateAirEvent_Full(FlatBufferBuilder builder,
      ...
      AirEvent_Full_dataMode_Enum dataMode = AirEvent_Full_dataMode_Enum.REAL) {
  ...
  public static void StartAirEvent_Full(FlatBufferBuilder builder) { builder.StartTable(44); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AirEvent_Full_dataMode_Enum dataMode) { builder.AddSbyte(43, (sbyte)dataMode, 0); }
  public static Offset<AirEvent_Full> EndAirEvent_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirEvent_Full>(o);
  }
  public static void FinishAirEvent_FullBuffer(FlatBufferBuilder builder, Offset<AirEvent_Full> offset) { builder.Finish(offset.Value, "AIRE"); }
  public static void FinishSizePrefixedAirEvent_FullBuffer(FlatBufferBuilder builder, Offset<AirEvent_Full> offset) { builder.FinishSizePrefixed(offset.Value, "AIRE"); }
  public AirEvent_FullT UnPack() {
    var _o = new AirEvent_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirEvent_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AirEvent_Full> Pack(FlatBufferBuilder builder, AirEvent_FullT _o) {
    if (_o == null) return default(Offset<AirEvent_Full>);
...
public class AirEvent_FullT
{
  ...
  public AirEvent_Full_dataMode_Enum DataMode { get; set; }

  public AirEvent_FullT() {
    this.Id = null;
    ...
    this.DataMode = AirEvent_Full_dataMode_Enum.REAL;
  }
  public static AirEvent_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return AirEvent_Full.GetRootAsAirEvent_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirEvent_Full.FinishAirEvent_FullBuffer(fbb, AirEvent_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirEvent_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 90 /*DataMode*/, 1 /*AirEvent_Full_dataMode_Enum*/, 1, false)
