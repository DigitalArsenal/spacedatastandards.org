...
public struct ObjectOfInterest_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static ObjectOfInterest_Full GetRootAsObjectOfInterest_Full(ByteBuffer _bb) { return GetRootAsObjectOfInterest_Full(_bb, new ObjectOfInterest_Full()); }
  public static ObjectOfInterest_Full GetRootAsObjectOfInterest_Full(ByteBuffer _bb, ObjectOfInterest_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool ObjectOfInterest_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "OBJE"); }
  public static bool VerifyObjectOfInterest_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("OBJE", false, ObjectOfInterest_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ObjectOfInterest_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: No constraints specified.
  public string AffectedObjects(int j) { int o = __p.__offset(78); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int AffectedObjectsLength { get { int o = __p.__offset(78); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Time the row was created in the database, auto-populated by the system.
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string CreatedAt { get { int o = __p.__offset(80); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedAtBytes() { return __p.__vector_as_span<byte>(80, 1); }
#else
  public ArraySegment<byte>? GetCreatedAtBytes() { return __p.__vector_as_arraysegment(80); }
#endif
  public byte[] GetCreatedAtArray() { return __p.__vector_as_array<byte>(80); }
  /// Application user who created the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string CreatedBy { get { int o = __p.__offset(82); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedByBytes() { return __p.__vector_as_span<byte>(82, 1); }
#else
  public ArraySegment<byte>? GetCreatedByBytes() { return __p.__vector_as_arraysegment(82); }
#endif
  public byte[] GetCreatedByArray() { return __p.__vector_as_array<byte>(82); }
  /// Time the row was last updated in the database, auto-populated by the system.
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string UpdatedAt { get { int o = __p.__offset(84); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedAtBytes() { return __p.__vector_as_span<byte>(84, 1); }
#else
  public ArraySegment<byte>? GetUpdatedAtBytes() { return __p.__vector_as_arraysegment(84); }
#endif
  public byte[] GetUpdatedAtArray() { return __p.__vector_as_array<byte>(84); }
  /// Application user who updated the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string UpdatedBy { get { int o = __p.__offset(86); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedByBytes() { return __p.__vector_as_span<byte>(86, 1); }
#else
  public ArraySegment<byte>? GetUpdatedByBytes() { return __p.__vector_as_arraysegment(86); }
#endif
  public byte[] GetUpdatedByArray() { return __p.__vector_as_array<byte>(86); }
  /// Source of the data.
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public ObjectOfInterest_Full_dataMode_Enum DataMode { get { int o = __p.__offset(94); return o != 0 ? (ObjectOfInterest_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : ObjectOfInterest_Full_dataMode_Enum.REAL; } }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string OnOrbit { get { int o = __p.__offset(96); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbitBytes() { return __p.__vector_as_span<byte>(96, 1); }
#else
  public ArraySegment<byte>? GetOnOrbitBytes() { return __p.__vector_as_arraysegment(96); }
#endif
  public byte[] GetOnOrbitArray() { return __p.__vector_as_array<byte>(96); }
  /// Manifolds associated with this object of interest.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string Manifolds(int j) { int o = __p.__offset(98); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int ManifoldsLength { get { int o = __p.__offset(98); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<ObjectOfInterest_Full> CreateObjectOfInterest_Full(FlatBufferBuilder builder,
      ...
      double apogee = 0.0,
      double perigee = 0.0,
      VectorOffset affectedObjectsOffset = default(VectorOffset),
      ...
      ObjectOfInterest_Full_dataMode_Enum dataMode = ObjectOfInterest_Full_dataMode_Enum.REAL,
      StringOffset onOrbitOffset = default(StringOffset),
      VectorOffset manifoldsOffset = default(VectorOffset)) {
    builder.StartTable(48);
    ObjectOfInterest_Full.AddPerigee(builder, perigee);
    ObjectOfInterest_Full.AddApogee(builder, apogee);
    ObjectOfInterest_Full.AddPeriod(builder, period);
    ObjectOfInterest_Full.AddSemiMajorAxis(builder, semiMajorAxis);
    ObjectOfInterest_Full.AddMeanMotionDDot(builder, meanMotionDDot);
    ObjectOfInterest_Full.AddMeanMotionDot(builder, meanMotionDot);
    ObjectOfInterest_Full.AddBStar(builder, bStar);
    ObjectOfInterest_Full.AddMeanAnomaly(builder, meanAnomaly);
    ObjectOfInterest_Full.AddArgOfPerigee(builder, argOfPerigee);
    ObjectOfInterest_Full.AddRaan(builder, raan);
    ObjectOfInterest_Full.AddInclination(builder, inclination);
    ObjectOfInterest_Full.AddEccentricity(builder, eccentricity);
    ObjectOfInterest_Full.AddMeanMotion(builder, meanMotion);
    ObjectOfInterest_Full.AddZvel(builder, zvel);
    ObjectOfInterest_Full.AddYvel(builder, yvel);
    ObjectOfInterest_Full.AddXvel(builder, xvel);
    ObjectOfInterest_Full.AddZ(builder, z);
    ObjectOfInterest_Full.AddY(builder, y);
    ObjectOfInterest_Full.AddX(builder, x);
    ObjectOfInterest_Full.AddManifolds(builder, manifoldsOffset);
    ObjectOfInterest_Full.AddOnOrbit(builder, onOrbitOffset);
    ObjectOfInterest_Full.AddOrigNetwork(builder, origNetworkOffset);
    ObjectOfInterest_Full.AddOrigin(builder, originOffset);
    ObjectOfInterest_Full.AddSource(builder, sourceOffset);
    ObjectOfInterest_Full.AddUpdatedBy(builder, updatedByOffset);
    ObjectOfInterest_Full.AddUpdatedAt(builder, updatedAtOffset);
    ObjectOfInterest_Full.AddCreatedBy(builder, createdByOffset);
    ObjectOfInterest_Full.AddCreatedAt(builder, createdAtOffset);
    ObjectOfInterest_Full.AddAffectedObjects(builder, affectedObjectsOffset);
    ObjectOfInterest_Full.AddRevNo(builder, revNo);
    ObjectOfInterest_Full.AddElsetEpoch(builder, elsetEpochOffset);
    ObjectOfInterest_Full.AddSvEpoch(builder, svEpochOffset);
    ObjectOfInterest_Full.AddDeltaTs(builder, deltaTsOffset);
    ObjectOfInterest_Full.AddDeltaVs(builder, deltaVsOffset);
    ObjectOfInterest_Full.AddMissedObTime(builder, missedObTimeOffset);
    ObjectOfInterest_Full.AddLastObTime(builder, lastObTimeOffset);
    ObjectOfInterest_Full.AddDescription(builder, descriptionOffset);
    ObjectOfInterest_Full.AddStatusDate(builder, statusDateOffset);
    ObjectOfInterest_Full.AddStatus(builder, statusOffset);
    ObjectOfInterest_Full.AddPriority(builder, priority);
    ObjectOfInterest_Full.AddSensorTaskingStopTime(builder, sensorTaskingStopTimeOffset);
    ObjectOfInterest_Full.AddSensorTaskingStartTime(builder, sensorTaskingStartTimeOffset);
    ObjectOfInterest_Full.AddName(builder, nameOffset);
    ObjectOfInterest_Full.AddSatNo(builder, satNo);
    ObjectOfInterest_Full.AddIdOnOrbit(builder, idOnOrbitOffset);
    ObjectOfInterest_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    ObjectOfInterest_Full.AddId(builder, idOffset);
    ObjectOfInterest_Full.AddDataMode(builder, dataMode);
    return ObjectOfInterest_Full.EndObjectOfInterest_Full(builder);
  }

  public static void StartObjectOfInterest_Full(FlatBufferBuilder builder) { builder.StartTable(48); }
  ...
  public static void AddAffectedObjects(FlatBufferBuilder builder, VectorOffset affectedObjectsOffset) { builder.AddOffset(37, affectedObjectsOffset.Value, 0); }
  public static VectorOffset CreateAffectedObjectsVector(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateAffectedObjectsVectorBlock(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateAffectedObjectsVectorBlock(FlatBufferBuilder builder, ArraySegment<StringOffset> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateAffectedObjectsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<StringOffset>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartAffectedObjectsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddCreatedAt(FlatBufferBuilder builder, StringOffset createdAtOffset) { builder.AddOffset(38, createdAtOffset.Value, 0); }
  public static void AddCreatedBy(FlatBufferBuilder builder, StringOffset createdByOffset) { builder.AddOffset(39, createdByOffset.Value, 0); }
  public static void AddUpdatedAt(FlatBufferBuilder builder, StringOffset updatedAtOffset) { builder.AddOffset(40, updatedAtOffset.Value, 0); }
  public static void AddUpdatedBy(FlatBufferBuilder builder, StringOffset updatedByOffset) { builder.AddOffset(41, updatedByOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, ObjectOfInterest_Full_dataMode_Enum dataMode) { builder.AddSbyte(45, (sbyte)dataMode, 0); }
  public static void AddOnOrbit(FlatBufferBuilder builder, StringOffset onOrbitOffset) { builder.AddOffset(46, onOrbitOffset.Value, 0); }
  public static void AddManifolds(FlatBufferBuilder builder, VectorOffset manifoldsOffset) { builder.AddOffset(47, manifoldsOffset.Value, 0); }
  ...
  public static Offset<ObjectOfInterest_Full> EndObjectOfInterest_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ObjectOfInterest_Full>(o);
  }
  public static void FinishObjectOfInterest_FullBuffer(FlatBufferBuilder builder, Offset<ObjectOfInterest_Full> offset) { builder.Finish(offset.Value, "OBJE"); }
  public static void FinishSizePrefixedObjectOfInterest_FullBuffer(FlatBufferBuilder builder, Offset<ObjectOfInterest_Full> offset) { builder.FinishSizePrefixed(offset.Value, "OBJE"); }
  public ObjectOfInterest_FullT UnPack() {
    var _o = new ObjectOfInterest_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(ObjectOfInterest_FullT _o) {
    _o.Id = this.Id;
    ...
    _o.AffectedObjects = new List<string>();
    for (var _j = 0; _j < this.AffectedObjectsLength; ++_j) {_o.AffectedObjects.Add(this.AffectedObjects(_j));}
  ...
  public static Offset<ObjectOfInterest_Full> Pack(FlatBufferBuilder builder, ObjectOfInterest_FullT _o) {
    if (_o == null) return default(Offset<ObjectOfInterest_Full>);
    ...
    var _affectedObjects = default(VectorOffset);
    if (_o.AffectedObjects != null) {
      var __affectedObjects = new StringOffset[_o.AffectedObjects.Count];
      for (var _j = 0; _j < __affectedObjects.Length; ++_j) { __affectedObjects[_j] = builder.CreateString(_o.AffectedObjects[_j]); }
      _affectedObjects = CreateAffectedObjectsVector(builder, __affectedObjects);
    }
    ...
    return CreateObjectOfInterest_Full(
      builder,
      _id,
...
public class ObjectOfInterest_FullT
{
  ...
  public ObjectOfInterest_Full_dataMode_Enum DataMode { get; set; }
  public string OnOrbit { get; set; }
  public List<string> Manifolds { get; set; }

  public ObjectOfInterest_FullT() {
    this.Id = null;
    ...
    this.DataMode = ObjectOfInterest_Full_dataMode_Enum.REAL;
    this.OnOrbit = null;
    this.Manifolds = null;
  }
  public static ObjectOfInterest_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return ObjectOfInterest_Full.GetRootAsObjectOfInterest_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    ObjectOfInterest_Full.FinishObjectOfInterest_FullBuffer(fbb, ObjectOfInterest_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class ObjectOfInterest_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfStrings(tablePos, 78 /*AffectedObjects*/, false)
      && verifier.VerifyString(tablePos, 80 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 82 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 84 /*UpdatedAt*/, false)
      && verifier.VerifyString(tablePos, 86 /*UpdatedBy*/, false)
      ...
      && verifier.VerifyField(tablePos, 94 /*DataMode*/, 1 /*ObjectOfInterest_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 96 /*OnOrbit*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 98 /*Manifolds*/, false)
