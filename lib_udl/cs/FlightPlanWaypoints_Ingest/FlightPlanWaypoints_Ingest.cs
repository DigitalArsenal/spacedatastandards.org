...
public struct FlightPlanWaypoints_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static FlightPlanWaypoints_Ingest GetRootAsFlightPlanWaypoints_Ingest(ByteBuffer _bb) { return GetRootAsFlightPlanWaypoints_Ingest(_bb, new FlightPlanWaypoints_Ingest()); }
  public static FlightPlanWaypoints_Ingest GetRootAsFlightPlanWaypoints_Ingest(ByteBuffer _bb, FlightPlanWaypoints_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool FlightPlanWaypoints_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "FLIG"); }
  public static bool VerifyFlightPlanWaypoints_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("FLIG", false, FlightPlanWaypoints_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public FlightPlanWaypoints_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<FlightPlanWaypoints_Ingest> CreateFlightPlanWaypoints_Ingest(FlatBufferBuilder builder,
    ...
    FlightPlanWaypoints_Ingest.AddNvgLowAlt(builder, nvgLowAlt);
    FlightPlanWaypoints_Ingest.AddNightLowAlt(builder, nightLowAlt);
    FlightPlanWaypoints_Ingest.AddDayLowAlt(builder, dayLowAlt);
    FlightPlanWaypoints_Ingest.AddMagVar(builder, magVar);
    FlightPlanWaypoints_Ingest.AddFuelFlow(builder, fuelFlow);
    FlightPlanWaypoints_Ingest.AddTotalWeight(builder, totalWeight);
    FlightPlanWaypoints_Ingest.AddTotalAirDistance(builder, totalAirDistance);
    FlightPlanWaypoints_Ingest.AddAirDistance(builder, airDistance);
    FlightPlanWaypoints_Ingest.AddExchangedFuel(builder, exchangedFuel);
    FlightPlanWaypoints_Ingest.AddTotalRemFuel(builder, totalRemFuel);
    FlightPlanWaypoints_Ingest.AddTotalUsedFuel(builder, totalUsedFuel);
    FlightPlanWaypoints_Ingest.AddZoneFuel(builder, zoneFuel);
    FlightPlanWaypoints_Ingest.AddZoneTime(builder, zoneTime);
    FlightPlanWaypoints_Ingest.AddTotalRemDistance(builder, totalRemDistance);
    FlightPlanWaypoints_Ingest.AddTotalFlownDistance(builder, totalFlownDistance);
    FlightPlanWaypoints_Ingest.AddZoneDistance(builder, zoneDistance);
    FlightPlanWaypoints_Ingest.AddMagHeading(builder, magHeading);
    FlightPlanWaypoints_Ingest.AddTrueCourse(builder, trueCourse);
    FlightPlanWaypoints_Ingest.AddMagCourse(builder, magCourse);
    FlightPlanWaypoints_Ingest.AddSecFreq(builder, secFreq);
    FlightPlanWaypoints_Ingest.AddAvgDriftAng(builder, avgDriftAng);
    FlightPlanWaypoints_Ingest.AddLegWindFac(builder, legWindFac);
    FlightPlanWaypoints_Ingest.AddAvgWindSpeed(builder, avgWindSpeed);
    FlightPlanWaypoints_Ingest.AddAvgWindDir(builder, avgWindDir);
    FlightPlanWaypoints_Ingest.AddPointWindSpeed(builder, pointWindSpeed);
    FlightPlanWaypoints_Ingest.AddPointWindDir(builder, pointWindDir);
    FlightPlanWaypoints_Ingest.AddPriFreq(builder, priFreq);
    FlightPlanWaypoints_Ingest.AddAvgGroundSpeed(builder, avgGroundSpeed);
    FlightPlanWaypoints_Ingest.AddAvgTrueAirspeed(builder, avgTrueAirspeed);
    FlightPlanWaypoints_Ingest.AddAvgCalAirspeed(builder, avgCalAirspeed);
    FlightPlanWaypoints_Ingest.AddLegDragIndex(builder, legDragIndex);
    FlightPlanWaypoints_Ingest.AddLegMsnIndex(builder, legMsnIndex);
    FlightPlanWaypoints_Ingest.AddLegMach(builder, legMach);
    FlightPlanWaypoints_Ingest.AddLegFuelDegrade(builder, legFuelDegrade);
    FlightPlanWaypoints_Ingest.AddTempDev(builder, tempDev);
    FlightPlanWaypoints_Ingest.AddAlt(builder, alt);
    FlightPlanWaypoints_Ingest.AddVorFreq(builder, vorFreq);
    FlightPlanWaypoints_Ingest.AddLon(builder, lon);
    FlightPlanWaypoints_Ingest.AddLat(builder, lat);
    FlightPlanWaypoints_Ingest.AddLegAlternate(builder, legAlternateOffset);
    FlightPlanWaypoints_Ingest.AddAta(builder, ataOffset);
    FlightPlanWaypoints_Ingest.AddEta(builder, etaOffset);
    FlightPlanWaypoints_Ingest.AddTotalTimeRem(builder, totalTimeRemOffset);
    FlightPlanWaypoints_Ingest.AddTotalTime(builder, totalTimeOffset);
    FlightPlanWaypoints_Ingest.AddAaTacanChannel(builder, aaTacanChannelOffset);
    FlightPlanWaypoints_Ingest.AddThunderCat(builder, thunderCatOffset);
    FlightPlanWaypoints_Ingest.AddIceCat(builder, iceCatOffset);
    FlightPlanWaypoints_Ingest.AddTurbCat(builder, turbCatOffset);
    FlightPlanWaypoints_Ingest.AddTacanChannel(builder, tacanChannelOffset);
    FlightPlanWaypoints_Ingest.AddNavaid(builder, navaidOffset);
    FlightPlanWaypoints_Ingest.AddArId(builder, arIdOffset);
    FlightPlanWaypoints_Ingest.AddArpt(builder, arptOffset);
    FlightPlanWaypoints_Ingest.AddAirway(builder, airwayOffset);
    FlightPlanWaypoints_Ingest.AddWaypointNum(builder, waypointNum);
    FlightPlanWaypoints_Ingest.AddWaypointName(builder, waypointNameOffset);
    FlightPlanWaypoints_Ingest.AddType(builder, typeOffset);
    return FlightPlanWaypoints_Ingest.EndFlightPlanWaypoints_Ingest(builder);
  }

  public static void StartFlightPlanWaypoints_Ingest(FlatBufferBuilder builder) { builder.StartTable(56); }
  ...
  public static Offset<FlightPlanWaypoints_Ingest> EndFlightPlanWaypoints_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlightPlanWaypoints_Ingest>(o);
  }
  public static void FinishFlightPlanWaypoints_IngestBuffer(FlatBufferBuilder builder, Offset<FlightPlanWaypoints_Ingest> offset) { builder.Finish(offset.Value, "FLIG"); }
  public static void FinishSizePrefixedFlightPlanWaypoints_IngestBuffer(FlatBufferBuilder builder, Offset<FlightPlanWaypoints_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "FLIG"); }
  public FlightPlanWaypoints_IngestT UnPack() {
    var _o = new FlightPlanWaypoints_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(FlightPlanWaypoints_IngestT _o) {
    _o.Type = this.Type;
  ...
  public static Offset<FlightPlanWaypoints_Ingest> Pack(FlatBufferBuilder builder, FlightPlanWaypoints_IngestT _o) {
    if (_o == null) return default(Offset<FlightPlanWaypoints_Ingest>);
...
public class FlightPlanWaypoints_IngestT
{
  ...
  public FlightPlanWaypoints_IngestT() {
    this.Type = null;
  ...
  public static FlightPlanWaypoints_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return FlightPlanWaypoints_Ingest.GetRootAsFlightPlanWaypoints_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    FlightPlanWaypoints_Ingest.FinishFlightPlanWaypoints_IngestBuffer(fbb, FlightPlanWaypoints_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class FlightPlanWaypoints_IngestVerify
{
