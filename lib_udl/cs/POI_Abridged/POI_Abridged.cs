...
public struct POI_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static POI_Abridged GetRootAsPOI_Abridged(ByteBuffer _bb) { return GetRootAsPOI_Abridged(_bb, new POI_Abridged()); }
  public static POI_Abridged GetRootAsPOI_Abridged(ByteBuffer _bb, POI_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool POI_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "POIA"); }
  public static bool VerifyPOI_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("POIA", false, POI_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public POI_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: No constraints specified.
  public string Atext { get { int o = __p.__offset(66); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAtextBytes() { return __p.__vector_as_span<byte>(66, 1); }
#else
  public ArraySegment<byte>? GetAtextBytes() { return __p.__vector_as_arraysegment(66); }
#endif
  public byte[] GetAtextArray() { return __p.__vector_as_array<byte>(66); }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 128
  public string Atype { get { int o = __p.__offset(70); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAtypeBytes() { return __p.__vector_as_span<byte>(70, 1); }
#else
  public ArraySegment<byte>? GetAtypeBytes() { return __p.__vector_as_arraysegment(70); }
#endif
  public byte[] GetAtypeArray() { return __p.__vector_as_array<byte>(70); }
  /// Number of dimensions of the geometry depicted by region.
  /// Example: /// Example: 3
  /// Constraints: No constraints specified.
  public int Andims { get { int o = __p.__offset(72); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  /// Geographical spatial_ref_sys for region.
  /// Example: /// Example: 3
  /// Constraints: No constraints specified.
  public int Asrid { get { int o = __p.__offset(74); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  /// Time the row was created in the database.
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string CreatedAt { get { int o = __p.__offset(76); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedAtBytes() { return __p.__vector_as_span<byte>(76, 1); }
#else
  public ArraySegment<byte>? GetCreatedAtBytes() { return __p.__vector_as_arraysegment(76); }
#endif
  public byte[] GetCreatedAtArray() { return __p.__vector_as_array<byte>(76); }
  /// Application user who created the row in the database.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string CreatedBy { get { int o = __p.__offset(78); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedByBytes() { return __p.__vector_as_span<byte>(78, 1); }
#else
  public ArraySegment<byte>? GetCreatedByBytes() { return __p.__vector_as_arraysegment(78); }
#endif
  public byte[] GetCreatedByArray() { return __p.__vector_as_array<byte>(78); }
  /// The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
  /// Example: /// Example: AXE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string SourceDL { get { int o = __p.__offset(80); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceDLBytes() { return __p.__vector_as_span<byte>(80, 1); }
#else
  public ArraySegment<byte>? GetSourceDLBytes() { return __p.__vector_as_arraysegment(80); }
#endif
  public byte[] GetSourceDLArray() { return __p.__vector_as_array<byte>(80); }
  /// Source of the data.
  ...
  public POI_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(84); return o != 0 ? (POI_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : POI_Abridged_dataMode_Enum.REAL; } }
  ...
  /// Constraints: No constraints specified.
  public string Groups(int j) { int o = __p.__offset(88); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int GroupsLength { get { int o = __p.__offset(88); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// ID/name of the platform or entity providing the POI data.
  /// Example: /// Example: PLATFORM_NAME
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Asset { get { int o = __p.__offset(90); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAssetBytes() { return __p.__vector_as_span<byte>(90, 1); }
#else
  public ArraySegment<byte>? GetAssetBytes() { return __p.__vector_as_arraysegment(90); }
#endif
  public byte[] GetAssetArray() { return __p.__vector_as_array<byte>(90); }
  /// The Basic Encyclopedia Number associated with the POI, if applicable.
  /// Example: /// Example: 0427RT1030
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string BeNumber { get { int o = __p.__offset(92); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetBeNumberBytes() { return __p.__vector_as_span<byte>(92, 1); }
#else
  public ArraySegment<byte>? GetBeNumberBytes() { return __p.__vector_as_arraysegment(92); }
#endif
  public byte[] GetBeNumberArray() { return __p.__vector_as_array<byte>(92); }
  ...
  /// Example: /// Example: 45.23
  /// Constraints: No constraints specified.
  public double Orientation { get { int o = __p.__offset(94); return o != 0 ? __p.bb.GetDouble(o + __p.bb_pos) : (double)0.0; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string TransactionId { get { int o = __p.__offset(98); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTransactionIdBytes() { return __p.__vector_as_span<byte>(98, 1); }
#else
  public ArraySegment<byte>? GetTransactionIdBytes() { return __p.__vector_as_arraysegment(98); }
#endif
  public byte[] GetTransactionIdArray() { return __p.__vector_as_array<byte>(98); }

  public static Offset<POI_Abridged> CreatePOI_Abridged(FlatBufferBuilder builder,
      ...
      POI_Abridged_dataMode_Enum dataMode = POI_Abridged_dataMode_Enum.REAL,
    ...
    POI_Abridged.AddOrientation(builder, orientation);
    POI_Abridged.AddConf(builder, conf);
    POI_Abridged.AddCe(builder, ce);
    POI_Abridged.AddLe(builder, le);
    POI_Abridged.AddEl(builder, el);
    POI_Abridged.AddAz(builder, az);
    POI_Abridged.AddAlt(builder, alt);
    POI_Abridged.AddLon(builder, lon);
    POI_Abridged.AddLat(builder, lat);
    POI_Abridged.AddTransactionId(builder, transactionIdOffset);
    POI_Abridged.AddOrigNetwork(builder, origNetworkOffset);
    POI_Abridged.AddBeNumber(builder, beNumberOffset);
    POI_Abridged.AddAsset(builder, assetOffset);
    POI_Abridged.AddGroups(builder, groupsOffset);
    POI_Abridged.AddOrigin(builder, originOffset);
    POI_Abridged.AddSource(builder, sourceOffset);
    POI_Abridged.AddSourceDL(builder, sourceDLOffset);
    POI_Abridged.AddCreatedBy(builder, createdByOffset);
    POI_Abridged.AddCreatedAt(builder, createdAtOffset);
    POI_Abridged.AddAsrid(builder, asrid);
    POI_Abridged.AddAndims(builder, andims);
    POI_Abridged.AddAtype(builder, atypeOffset);
    POI_Abridged.AddAgjson(builder, agjsonOffset);
    POI_Abridged.AddAtext(builder, atextOffset);
    POI_Abridged.AddUrls(builder, urlsOffset);
    POI_Abridged.AddCntct(builder, cntctOffset);
    POI_Abridged.AddElle(builder, elleOffset);
    POI_Abridged.AddType(builder, typeOffset);
    POI_Abridged.AddHow(builder, howOffset);
    POI_Abridged.AddStale(builder, staleOffset);
    POI_Abridged.AddStart(builder, startOffset);
    POI_Abridged.AddTs(builder, tsOffset);
    POI_Abridged.AddActivity(builder, activityOffset);
    POI_Abridged.AddPlat(builder, platOffset);
    POI_Abridged.AddEnv(builder, envOffset);
    POI_Abridged.AddIdent(builder, identOffset);
    POI_Abridged.AddSpec(builder, specOffset);
    POI_Abridged.AddDesc(builder, descOffset);
    POI_Abridged.AddName(builder, nameOffset);
    POI_Abridged.AddPoiid(builder, poiidOffset);
    POI_Abridged.AddIdWeatherReport(builder, idWeatherReportOffset);
    POI_Abridged.AddTrkid(builder, trkidOffset);
    POI_Abridged.AddPri(builder, pri);
    POI_Abridged.AddMsnid(builder, msnidOffset);
    POI_Abridged.AddPps(builder, ppsOffset);
    POI_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    POI_Abridged.AddId(builder, idOffset);
    POI_Abridged.AddDataMode(builder, dataMode);
    return POI_Abridged.EndPOI_Abridged(builder);
  }

  public static void StartPOI_Abridged(FlatBufferBuilder builder) { builder.StartTable(48); }
  ...
  public static void AddAtext(FlatBufferBuilder builder, StringOffset atextOffset) { builder.AddOffset(31, atextOffset.Value, 0); }
  ...
  public static void AddAtype(FlatBufferBuilder builder, StringOffset atypeOffset) { builder.AddOffset(33, atypeOffset.Value, 0); }
  public static void AddAndims(FlatBufferBuilder builder, int andims) { builder.AddInt(34, andims, 0); }
  public static void AddAsrid(FlatBufferBuilder builder, int asrid) { builder.AddInt(35, asrid, 0); }
  public static void AddCreatedAt(FlatBufferBuilder builder, StringOffset createdAtOffset) { builder.AddOffset(36, createdAtOffset.Value, 0); }
  public static void AddCreatedBy(FlatBufferBuilder builder, StringOffset createdByOffset) { builder.AddOffset(37, createdByOffset.Value, 0); }
  public static void AddSourceDL(FlatBufferBuilder builder, StringOffset sourceDLOffset) { builder.AddOffset(38, sourceDLOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, POI_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(40, (sbyte)dataMode, 0); }
  ...
  public static void AddGroups(FlatBufferBuilder builder, VectorOffset groupsOffset) { builder.AddOffset(42, groupsOffset.Value, 0); }
  ...
  public static void AddAsset(FlatBufferBuilder builder, StringOffset assetOffset) { builder.AddOffset(43, assetOffset.Value, 0); }
  public static void AddBeNumber(FlatBufferBuilder builder, StringOffset beNumberOffset) { builder.AddOffset(44, beNumberOffset.Value, 0); }
  public static void AddOrientation(FlatBufferBuilder builder, double orientation) { builder.AddDouble(45, orientation, 0.0); }
  ...
  public static void AddTransactionId(FlatBufferBuilder builder, StringOffset transactionIdOffset) { builder.AddOffset(47, transactionIdOffset.Value, 0); }
  public static Offset<POI_Abridged> EndPOI_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<POI_Abridged>(o);
  }
  public static void FinishPOI_AbridgedBuffer(FlatBufferBuilder builder, Offset<POI_Abridged> offset) { builder.Finish(offset.Value, "POIA"); }
  public static void FinishSizePrefixedPOI_AbridgedBuffer(FlatBufferBuilder builder, Offset<POI_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "POIA"); }
  public POI_AbridgedT UnPack() {
    var _o = new POI_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(POI_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<POI_Abridged> Pack(FlatBufferBuilder builder, POI_AbridgedT _o) {
    if (_o == null) return default(Offset<POI_Abridged>);
...
public class POI_AbridgedT
{
  ...
  public POI_Abridged_dataMode_Enum DataMode { get; set; }
  ...
  public POI_AbridgedT() {
    ...
    this.SourceDL = null;
    this.Source = null;
    this.DataMode = POI_Abridged_dataMode_Enum.REAL;
    this.Origin = null;
    this.Groups = null;
    this.Asset = null;
    this.BeNumber = null;
  ...
  public static POI_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return POI_Abridged.GetRootAsPOI_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    POI_Abridged.FinishPOI_AbridgedBuffer(fbb, POI_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class POI_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyString(tablePos, 66 /*Atext*/, false)
      && verifier.VerifyString(tablePos, 68 /*Agjson*/, false)
      && verifier.VerifyString(tablePos, 70 /*Atype*/, false)
      && verifier.VerifyField(tablePos, 72 /*Andims*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 74 /*Asrid*/, 4 /*int*/, 4, false)
      && verifier.VerifyString(tablePos, 76 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 78 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 80 /*SourceDL*/, false)
      && verifier.VerifyString(tablePos, 82 /*Source*/, false)
      && verifier.VerifyField(tablePos, 84 /*DataMode*/, 1 /*POI_Abridged_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 86 /*Origin*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 88 /*Groups*/, false)
      && verifier.VerifyString(tablePos, 90 /*Asset*/, false)
      && verifier.VerifyString(tablePos, 92 /*BeNumber*/, false)
      && verifier.VerifyField(tablePos, 94 /*Orientation*/, 8 /*double*/, 8, false)
      && verifier.VerifyString(tablePos, 96 /*OrigNetwork*/, false)
      && verifier.VerifyString(tablePos, 98 /*TransactionId*/, false)
