...
public struct Transponder_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static Transponder_Abridged GetRootAsTransponder_Abridged(ByteBuffer _bb, Transponder_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Transponder_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "TRAN"); }
  public static bool VerifyTransponder_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("TRAN", false, Transponder_AbridgedVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Transponder_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(34); return o != 0 ? (Transponder_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Transponder_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<Transponder_Abridged> CreateTransponder_Abridged(FlatBufferBuilder builder,
      ...
      Transponder_Abridged_dataMode_Enum dataMode = Transponder_Abridged_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Transponder_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(15, (sbyte)dataMode, 0); }
  ...
  public static Offset<Transponder_Abridged> EndTransponder_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Transponder_Abridged>(o);
  }
  public static void FinishTransponder_AbridgedBuffer(FlatBufferBuilder builder, Offset<Transponder_Abridged> offset) { builder.Finish(offset.Value, "TRAN"); }
  public static void FinishSizePrefixedTransponder_AbridgedBuffer(FlatBufferBuilder builder, Offset<Transponder_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "TRAN"); }
  public Transponder_AbridgedT UnPack() {
    var _o = new Transponder_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Transponder_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Transponder_Abridged> Pack(FlatBufferBuilder builder, Transponder_AbridgedT _o) {
    if (_o == null) return default(Offset<Transponder_Abridged>);
...
public class Transponder_AbridgedT
{
  ...
  public Transponder_Abridged_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }

  public Transponder_AbridgedT() {
    this.Id = null;
    this.IdComm = null;
    this.Name = null;
    ...
    this.DataMode = Transponder_Abridged_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
  }
  public static Transponder_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Transponder_Abridged.GetRootAsTransponder_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Transponder_Abridged.FinishTransponder_AbridgedBuffer(fbb, Transponder_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Transponder_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 34 /*DataMode*/, 1 /*Transponder_Abridged_dataMode_Enum*/, 1, false)
