...
public struct TrackDetails_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static TrackDetails_Full GetRootAsTrackDetails_Full(ByteBuffer _bb) { return GetRootAsTrackDetails_Full(_bb, new TrackDetails_Full()); }
  public static TrackDetails_Full GetRootAsTrackDetails_Full(ByteBuffer _bb, TrackDetails_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool TrackDetails_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "TRAC"); }
  public static bool VerifyTrackDetails_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("TRAC", false, TrackDetails_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public TrackDetails_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public TrackDetails_Full_env_Enum Env { get { int o = __p.__offset(8); return o != 0 ? (TrackDetails_Full_env_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : TrackDetails_Full_env_Enum.AIR; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 32
  public TrackDetails_Full_objIdent_Enum ObjIdent { get { int o = __p.__offset(50); return o != 0 ? (TrackDetails_Full_objIdent_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : TrackDetails_Full_objIdent_Enum.ASSUMED_FRIEND; } }
  ...
  public TrackDetails_Full_dataMode_Enum DataMode { get { int o = __p.__offset(316); return o != 0 ? (TrackDetails_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : TrackDetails_Full_dataMode_Enum.REAL; } }
  ...
  public static void StartTrackDetails_Full(FlatBufferBuilder builder) { builder.StartTable(158); }
  public static void AddId(FlatBufferBuilder builder, StringOffset idOffset) { builder.AddOffset(0, idOffset.Value, 0); }
  public static void AddClassificationMarking(FlatBufferBuilder builder, StringOffset classificationMarkingOffset) { builder.AddOffset(1, classificationMarkingOffset.Value, 0); }
  public static void AddEnv(FlatBufferBuilder builder, TrackDetails_Full_env_Enum env) { builder.AddSbyte(2, (sbyte)env, 0); }
  ...
  public static void AddObjIdent(FlatBufferBuilder builder, TrackDetails_Full_objIdent_Enum objIdent) { builder.AddSbyte(23, (sbyte)objIdent, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, TrackDetails_Full_dataMode_Enum dataMode) { builder.AddSbyte(156, (sbyte)dataMode, 0); }
  ...
  public static Offset<TrackDetails_Full> EndTrackDetails_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<TrackDetails_Full>(o);
  }
  public static void FinishTrackDetails_FullBuffer(FlatBufferBuilder builder, Offset<TrackDetails_Full> offset) { builder.Finish(offset.Value, "TRAC"); }
  public static void FinishSizePrefixedTrackDetails_FullBuffer(FlatBufferBuilder builder, Offset<TrackDetails_Full> offset) { builder.FinishSizePrefixed(offset.Value, "TRAC"); }
  public TrackDetails_FullT UnPack() {
    var _o = new TrackDetails_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(TrackDetails_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<TrackDetails_Full> Pack(FlatBufferBuilder builder, TrackDetails_FullT _o) {
    if (_o == null) return default(Offset<TrackDetails_Full>);
    ...
    StartTrackDetails_Full(builder);
    AddId(builder, _id);
    ...
    return EndTrackDetails_Full(builder);
  }
}

public class TrackDetails_FullT
{
  public string Id { get; set; }
  public string ClassificationMarking { get; set; }
  public TrackDetails_Full_env_Enum Env { get; set; }
  ...
  public TrackDetails_Full_objIdent_Enum ObjIdent { get; set; }
  ...
  public TrackDetails_Full_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public TrackDetails_FullT() {
    this.Id = null;
    this.ClassificationMarking = null;
    this.Env = TrackDetails_Full_env_Enum.AIR;
    this.MsgType = null;
    this.HullNum = null;
    this.Pif = null;
    this.Sconum = null;
    ...
    this.Elnot1 = null;
    this.Elnot2 = null;
    this.ObjIdent = TrackDetails_Full_objIdent_Enum.ASSUMED_FRIEND;
    this.ObjType = null;
    this.ObjPlat = null;
    this.ObjAct = null;
    this.ObjNat = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = TrackDetails_Full_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static TrackDetails_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return TrackDetails_Full.GetRootAsTrackDetails_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    TrackDetails_Full.FinishTrackDetails_FullBuffer(fbb, TrackDetails_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class TrackDetails_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*Env*/, 1 /*TrackDetails_Full_env_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 50 /*ObjIdent*/, 1 /*TrackDetails_Full_objIdent_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 316 /*DataMode*/, 1 /*TrackDetails_Full_dataMode_Enum*/, 1, false)
