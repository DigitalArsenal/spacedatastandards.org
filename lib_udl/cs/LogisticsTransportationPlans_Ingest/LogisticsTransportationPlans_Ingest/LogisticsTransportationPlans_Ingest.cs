...
public struct LogisticsTransportationPlans_Ingest : IFlatbufferObject
{
  ...
  public static Offset<LogisticsTransportationPlans_Ingest.LogisticsTransportationPlans_Ingest> CreateLogisticsTransportationPlans_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<LogisticsTransportationPlans_Ingest.LogisticsTransportationPlans_Ingest> EndLogisticsTransportationPlans_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LogisticsTransportationPlans_Ingest.LogisticsTransportationPlans_Ingest>(o);
  }
  ...
  public static Offset<LogisticsTransportationPlans_Ingest.LogisticsTransportationPlans_Ingest> Pack(FlatBufferBuilder builder, LogisticsTransportationPlans_IngestT _o) {
    if (_o == null) return default(Offset<LogisticsTransportationPlans_Ingest.LogisticsTransportationPlans_Ingest>);
