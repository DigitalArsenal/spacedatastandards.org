...
public struct EvacHealthState_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EvacHealthState_Abridged GetRootAsEvacHealthState_Abridged(ByteBuffer _bb) { return GetRootAsEvacHealthState_Abridged(_bb, new EvacHealthState_Abridged()); }
  public static EvacHealthState_Abridged GetRootAsEvacHealthState_Abridged(ByteBuffer _bb, EvacHealthState_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EvacHealthState_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EVAC"); }
  public static bool VerifyEvacHealthState_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EVAC", false, EvacHealthState_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EvacHealthState_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<EvacHealthState_Abridged> CreateEvacHealthState_Abridged(FlatBufferBuilder builder,
  ...
  public static void StartEvacHealthState_Abridged(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<EvacHealthState_Abridged> EndEvacHealthState_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EvacHealthState_Abridged>(o);
  }
  public static void FinishEvacHealthState_AbridgedBuffer(FlatBufferBuilder builder, Offset<EvacHealthState_Abridged> offset) { builder.Finish(offset.Value, "EVAC"); }
  public static void FinishSizePrefixedEvacHealthState_AbridgedBuffer(FlatBufferBuilder builder, Offset<EvacHealthState_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "EVAC"); }
  public EvacHealthState_AbridgedT UnPack() {
    var _o = new EvacHealthState_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EvacHealthState_AbridgedT _o) {
    _o.Type = this.Type;
    _o.HealthStateCode = this.HealthStateCode;
    _o.MedConfFactor = this.MedConfFactor;
    _o.Time = this.Time;
  }
  public static Offset<EvacHealthState_Abridged> Pack(FlatBufferBuilder builder, EvacHealthState_AbridgedT _o) {
    if (_o == null) return default(Offset<EvacHealthState_Abridged>);
    ...
    return CreateEvacHealthState_Abridged(
      builder,
      _type,
      _healthStateCode,
      _o.MedConfFactor,
...
public class EvacHealthState_AbridgedT
{
  ...
  public EvacHealthState_AbridgedT() {
    this.Type = null;
    this.HealthStateCode = null;
    this.MedConfFactor = 0;
    this.Time = null;
  }
  public static EvacHealthState_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return EvacHealthState_Abridged.GetRootAsEvacHealthState_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EvacHealthState_Abridged.FinishEvacHealthState_AbridgedBuffer(fbb, EvacHealthState_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EvacHealthState_AbridgedVerify
{
