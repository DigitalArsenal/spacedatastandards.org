...
public struct AirspaceControlMeansStatus_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static AirspaceControlMeansStatus_Ingest GetRootAsAirspaceControlMeansStatus_Ingest(ByteBuffer _bb, AirspaceControlMeansStatus_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirspaceControlMeansStatus_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRS"); }
  public static bool VerifyAirspaceControlMeansStatus_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRS", false, AirspaceControlMeansStatus_IngestVerify.Verify); }
  ...
  public static Offset<AirspaceControlMeansStatus_Ingest> CreateAirspaceControlMeansStatus_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<AirspaceControlMeansStatus_Ingest> EndAirspaceControlMeansStatus_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirspaceControlMeansStatus_Ingest>(o);
  }
  public static void FinishAirspaceControlMeansStatus_IngestBuffer(FlatBufferBuilder builder, Offset<AirspaceControlMeansStatus_Ingest> offset) { builder.Finish(offset.Value, "AIRS"); }
  public static void FinishSizePrefixedAirspaceControlMeansStatus_IngestBuffer(FlatBufferBuilder builder, Offset<AirspaceControlMeansStatus_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AIRS"); }
  public AirspaceControlMeansStatus_IngestT UnPack() {
    var _o = new AirspaceControlMeansStatus_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirspaceControlMeansStatus_IngestT _o) {
  ...
  public static Offset<AirspaceControlMeansStatus_Ingest> Pack(FlatBufferBuilder builder, AirspaceControlMeansStatus_IngestT _o) {
    if (_o == null) return default(Offset<AirspaceControlMeansStatus_Ingest>);
...
public class AirspaceControlMeansStatus_IngestT
{
  public string CmStat { get; set; }
  public List<string> CmStatId { get; set; }
  public List<string> AirspaceControlMeans { get; set; }

  public AirspaceControlMeansStatus_IngestT() {
    this.CmStat = null;
    this.CmStatId = null;
    this.AirspaceControlMeans = null;
  }
  public static AirspaceControlMeansStatus_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AirspaceControlMeansStatus_Ingest.GetRootAsAirspaceControlMeansStatus_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirspaceControlMeansStatus_Ingest.FinishAirspaceControlMeansStatus_IngestBuffer(fbb, AirspaceControlMeansStatus_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirspaceControlMeansStatus_IngestVerify
{
