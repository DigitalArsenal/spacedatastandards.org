...
public struct AircraftMissionRequirements_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static AircraftMissionRequirements_Full GetRootAsAircraftMissionRequirements_Full(ByteBuffer _bb, AircraftMissionRequirements_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AircraftMissionRequirements_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRC"); }
  public static bool VerifyAircraftMissionRequirements_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRC", false, AircraftMissionRequirements_FullVerify.Verify); }
  ...
  public static Offset<AircraftMissionRequirements_Full> CreateAircraftMissionRequirements_Full(FlatBufferBuilder builder,
  ...
  public static Offset<AircraftMissionRequirements_Full> EndAircraftMissionRequirements_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AircraftMissionRequirements_Full>(o);
  }
  public static void FinishAircraftMissionRequirements_FullBuffer(FlatBufferBuilder builder, Offset<AircraftMissionRequirements_Full> offset) { builder.Finish(offset.Value, "AIRC"); }
  public static void FinishSizePrefixedAircraftMissionRequirements_FullBuffer(FlatBufferBuilder builder, Offset<AircraftMissionRequirements_Full> offset) { builder.FinishSizePrefixed(offset.Value, "AIRC"); }
  public AircraftMissionRequirements_FullT UnPack() {
    var _o = new AircraftMissionRequirements_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AircraftMissionRequirements_FullT _o) {
  ...
  public static Offset<AircraftMissionRequirements_Full> Pack(FlatBufferBuilder builder, AircraftMissionRequirements_FullT _o) {
    if (_o == null) return default(Offset<AircraftMissionRequirements_Full>);
...
public class AircraftMissionRequirements_FullT
{
  ...
  public AircraftMissionRequirements_FullT() {
    this.GdssReqId = null;
    this.OnloadId = 0;
  ...
  public static AircraftMissionRequirements_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return AircraftMissionRequirements_Full.GetRootAsAircraftMissionRequirements_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AircraftMissionRequirements_Full.FinishAircraftMissionRequirements_FullBuffer(fbb, AircraftMissionRequirements_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AircraftMissionRequirements_FullVerify
{
