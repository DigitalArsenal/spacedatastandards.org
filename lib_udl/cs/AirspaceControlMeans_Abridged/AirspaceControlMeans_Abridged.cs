...
public struct AirspaceControlMeans_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static AirspaceControlMeans_Abridged GetRootAsAirspaceControlMeans_Abridged(ByteBuffer _bb, AirspaceControlMeans_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirspaceControlMeans_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRS"); }
  public static bool VerifyAirspaceControlMeans_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRS", false, AirspaceControlMeans_AbridgedVerify.Verify); }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 8
  public AirspaceControlMeans_Abridged_cmShape_Enum CmShape { get { int o = __p.__offset(8); return o != 0 ? (AirspaceControlMeans_Abridged_cmShape_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirspaceControlMeans_Abridged_cmShape_Enum.POLYARC; } }
  ...
  public static Offset<AirspaceControlMeans_Abridged> CreateAirspaceControlMeans_Abridged(FlatBufferBuilder builder,
      StringOffset cmTypeOffset = default(StringOffset),
      StringOffset cmIdOffset = default(StringOffset),
      AirspaceControlMeans_Abridged_cmShape_Enum cmShape = AirspaceControlMeans_Abridged_cmShape_Enum.POLYARC,
  ...
  public static void AddCmShape(FlatBufferBuilder builder, AirspaceControlMeans_Abridged_cmShape_Enum cmShape) { builder.AddSbyte(2, (sbyte)cmShape, 0); }
  ...
  public static Offset<AirspaceControlMeans_Abridged> EndAirspaceControlMeans_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirspaceControlMeans_Abridged>(o);
  }
  public static void FinishAirspaceControlMeans_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirspaceControlMeans_Abridged> offset) { builder.Finish(offset.Value, "AIRS"); }
  public static void FinishSizePrefixedAirspaceControlMeans_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirspaceControlMeans_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "AIRS"); }
  public AirspaceControlMeans_AbridgedT UnPack() {
    var _o = new AirspaceControlMeans_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirspaceControlMeans_AbridgedT _o) {
  ...
  public static Offset<AirspaceControlMeans_Abridged> Pack(FlatBufferBuilder builder, AirspaceControlMeans_AbridgedT _o) {
    if (_o == null) return default(Offset<AirspaceControlMeans_Abridged>);
...
public class AirspaceControlMeans_AbridgedT
{
  public string CmType { get; set; }
  public string CmId { get; set; }
  public AirspaceControlMeans_Abridged_cmShape_Enum CmShape { get; set; }
  ...
  public AirspaceControlMeans_AbridgedT() {
    this.CmType = null;
    this.CmId = null;
    this.CmShape = AirspaceControlMeans_Abridged_cmShape_Enum.POLYARC;
    this.Usage = null;
    this.Link16Id = null;
  ...
  public static AirspaceControlMeans_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return AirspaceControlMeans_Abridged.GetRootAsAirspaceControlMeans_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirspaceControlMeans_Abridged.FinishAirspaceControlMeans_AbridgedBuffer(fbb, AirspaceControlMeans_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirspaceControlMeans_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CmShape*/, 1 /*AirspaceControlMeans_Abridged_cmShape_Enum*/, 1, false)
