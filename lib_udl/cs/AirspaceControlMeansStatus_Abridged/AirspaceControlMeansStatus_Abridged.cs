...
public struct AirspaceControlMeansStatus_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirspaceControlMeansStatus_Abridged GetRootAsAirspaceControlMeansStatus_Abridged(ByteBuffer _bb) { return GetRootAsAirspaceControlMeansStatus_Abridged(_bb, new AirspaceControlMeansStatus_Abridged()); }
  public static AirspaceControlMeansStatus_Abridged GetRootAsAirspaceControlMeansStatus_Abridged(ByteBuffer _bb, AirspaceControlMeansStatus_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirspaceControlMeansStatus_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRS"); }
  public static bool VerifyAirspaceControlMeansStatus_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRS", false, AirspaceControlMeansStatus_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirspaceControlMeansStatus_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<AirspaceControlMeansStatus_Abridged> CreateAirspaceControlMeansStatus_Abridged(FlatBufferBuilder builder,
    ...
    AirspaceControlMeansStatus_Abridged.AddAirspaceControlMeans(builder, airspaceControlMeansOffset);
    AirspaceControlMeansStatus_Abridged.AddCmStatId(builder, cmStatIdOffset);
    AirspaceControlMeansStatus_Abridged.AddCmStat(builder, cmStatOffset);
    return AirspaceControlMeansStatus_Abridged.EndAirspaceControlMeansStatus_Abridged(builder);
  }

  public static void StartAirspaceControlMeansStatus_Abridged(FlatBufferBuilder builder) { builder.StartTable(3); }
  ...
  public static Offset<AirspaceControlMeansStatus_Abridged> EndAirspaceControlMeansStatus_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirspaceControlMeansStatus_Abridged>(o);
  }
  public static void FinishAirspaceControlMeansStatus_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirspaceControlMeansStatus_Abridged> offset) { builder.Finish(offset.Value, "AIRS"); }
  public static void FinishSizePrefixedAirspaceControlMeansStatus_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirspaceControlMeansStatus_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "AIRS"); }
  public AirspaceControlMeansStatus_AbridgedT UnPack() {
    var _o = new AirspaceControlMeansStatus_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirspaceControlMeansStatus_AbridgedT _o) {
  ...
  public static Offset<AirspaceControlMeansStatus_Abridged> Pack(FlatBufferBuilder builder, AirspaceControlMeansStatus_AbridgedT _o) {
    if (_o == null) return default(Offset<AirspaceControlMeansStatus_Abridged>);
    ...
    return CreateAirspaceControlMeansStatus_Abridged(
      builder,
      _cmStat,
      _cmStatId,
...
public class AirspaceControlMeansStatus_AbridgedT
{
  public string CmStat { get; set; }
  public List<string> CmStatId { get; set; }
  public List<string> AirspaceControlMeans { get; set; }

  public AirspaceControlMeansStatus_AbridgedT() {
    this.CmStat = null;
    this.CmStatId = null;
    this.AirspaceControlMeans = null;
  }
  public static AirspaceControlMeansStatus_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return AirspaceControlMeansStatus_Abridged.GetRootAsAirspaceControlMeansStatus_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirspaceControlMeansStatus_Abridged.FinishAirspaceControlMeansStatus_AbridgedBuffer(fbb, AirspaceControlMeansStatus_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirspaceControlMeansStatus_AbridgedVerify
{
