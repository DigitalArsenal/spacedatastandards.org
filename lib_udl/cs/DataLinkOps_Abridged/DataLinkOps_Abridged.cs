...
public struct DataLinkOps_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static DataLinkOps_Abridged GetRootAsDataLinkOps_Abridged(ByteBuffer _bb, DataLinkOps_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DataLinkOps_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DATA"); }
  public static bool VerifyDataLinkOps_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DATA", false, DataLinkOps_AbridgedVerify.Verify); }
  ...
  public static Offset<DataLinkOps_Abridged> CreateDataLinkOps_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<DataLinkOps_Abridged> EndDataLinkOps_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DataLinkOps_Abridged>(o);
  }
  public static void FinishDataLinkOps_AbridgedBuffer(FlatBufferBuilder builder, Offset<DataLinkOps_Abridged> offset) { builder.Finish(offset.Value, "DATA"); }
  public static void FinishSizePrefixedDataLinkOps_AbridgedBuffer(FlatBufferBuilder builder, Offset<DataLinkOps_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "DATA"); }
  public DataLinkOps_AbridgedT UnPack() {
    var _o = new DataLinkOps_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DataLinkOps_AbridgedT _o) {
  ...
  public static Offset<DataLinkOps_Abridged> Pack(FlatBufferBuilder builder, DataLinkOps_AbridgedT _o) {
    if (_o == null) return default(Offset<DataLinkOps_Abridged>);
...
public class DataLinkOps_AbridgedT
{
  ...
  public static DataLinkOps_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return DataLinkOps_Abridged.GetRootAsDataLinkOps_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DataLinkOps_Abridged.FinishDataLinkOps_AbridgedBuffer(fbb, DataLinkOps_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DataLinkOps_AbridgedVerify
{
