...
public struct NavigationalObstruction_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static NavigationalObstruction_Full GetRootAsNavigationalObstruction_Full(ByteBuffer _bb) { return GetRootAsNavigationalObstruction_Full(_bb, new NavigationalObstruction_Full()); }
  public static NavigationalObstruction_Full GetRootAsNavigationalObstruction_Full(ByteBuffer _bb, NavigationalObstruction_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool NavigationalObstruction_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "NAVI"); }
  public static bool VerifyNavigationalObstruction_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("NAVI", false, NavigationalObstruction_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public NavigationalObstruction_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: No constraints specified.
  public string UpdatedAt { get { int o = __p.__offset(148); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedAtBytes() { return __p.__vector_as_span<byte>(148, 1); }
#else
  public ArraySegment<byte>? GetUpdatedAtBytes() { return __p.__vector_as_arraysegment(148); }
#endif
  public byte[] GetUpdatedAtArray() { return __p.__vector_as_array<byte>(148); }
  /// Application user who updated the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string UpdatedBy { get { int o = __p.__offset(150); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedByBytes() { return __p.__vector_as_span<byte>(150, 1); }
#else
  public ArraySegment<byte>? GetUpdatedByBytes() { return __p.__vector_as_arraysegment(150); }
#endif
  public byte[] GetUpdatedByArray() { return __p.__vector_as_array<byte>(150); }
  /// The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
  /// Example: /// Example: AXE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string SourceDL { get { int o = __p.__offset(152); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceDLBytes() { return __p.__vector_as_span<byte>(152, 1); }
#else
  public ArraySegment<byte>? GetSourceDLBytes() { return __p.__vector_as_arraysegment(152); }
#endif
  public byte[] GetSourceDLArray() { return __p.__vector_as_array<byte>(152); }
  /// Source of the data.
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public string OrigNetwork { get { int o = __p.__offset(158); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOrigNetworkBytes() { return __p.__vector_as_span<byte>(158, 1); }
#else
  public ArraySegment<byte>? GetOrigNetworkBytes() { return __p.__vector_as_arraysegment(158); }
#endif
  public byte[] GetOrigNetworkArray() { return __p.__vector_as_array<byte>(158); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public NavigationalObstruction_Full_dataMode_Enum DataMode { get { int o = __p.__offset(160); return o != 0 ? (NavigationalObstruction_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : NavigationalObstruction_Full_dataMode_Enum.REAL; } }

  public static Offset<NavigationalObstruction_Full> CreateNavigationalObstruction_Full(FlatBufferBuilder builder,
      ...
      NavigationalObstruction_Full_dataMode_Enum dataMode = NavigationalObstruction_Full_dataMode_Enum.REAL) {
    builder.StartTable(79);
    NavigationalObstruction_Full.AddMinHeightAGL(builder, minHeightAGL);
    NavigationalObstruction_Full.AddBoundSWLat(builder, boundSWLat);
    NavigationalObstruction_Full.AddBoundSWLon(builder, boundSWLon);
    NavigationalObstruction_Full.AddBoundNELat(builder, boundNELat);
    NavigationalObstruction_Full.AddBoundNELon(builder, boundNELon);
    NavigationalObstruction_Full.AddHorizAcc(builder, horizAcc);
    NavigationalObstruction_Full.AddElevationAcc(builder, elevationAcc);
    NavigationalObstruction_Full.AddElevation(builder, elevation);
    NavigationalObstruction_Full.AddHeightMSLAcc(builder, heightMSLAcc);
    NavigationalObstruction_Full.AddHeightMSL(builder, heightMSL);
    NavigationalObstruction_Full.AddHeightAGLAcc(builder, heightAGLAcc);
    NavigationalObstruction_Full.AddHeightAGL(builder, heightAGL);
    NavigationalObstruction_Full.AddLineSWLat(builder, lineSWLat);
    NavigationalObstruction_Full.AddLineSWLon(builder, lineSWLon);
    NavigationalObstruction_Full.AddLineNELat(builder, lineNELat);
    NavigationalObstruction_Full.AddLineNELon(builder, lineNELon);
    NavigationalObstruction_Full.AddPointLon(builder, pointLon);
    NavigationalObstruction_Full.AddPointLat(builder, pointLat);
    NavigationalObstruction_Full.AddOrigNetwork(builder, origNetworkOffset);
    NavigationalObstruction_Full.AddOrigin(builder, originOffset);
    NavigationalObstruction_Full.AddSource(builder, sourceOffset);
    NavigationalObstruction_Full.AddSourceDL(builder, sourceDLOffset);
    NavigationalObstruction_Full.AddUpdatedBy(builder, updatedByOffset);
    NavigationalObstruction_Full.AddUpdatedAt(builder, updatedAtOffset);
    NavigationalObstruction_Full.AddCreatedBy(builder, createdByOffset);
    NavigationalObstruction_Full.AddCreatedAt(builder, createdAtOffset);
    NavigationalObstruction_Full.AddRawFileURI(builder, rawFileURIOffset);
    NavigationalObstruction_Full.AddVectorsFilename(builder, vectorsFilenameOffset);
    NavigationalObstruction_Full.AddLinesFilename(builder, linesFilenameOffset);
    NavigationalObstruction_Full.AddPointsFilename(builder, pointsFilenameOffset);
    NavigationalObstruction_Full.AddDataSetRemarks(builder, dataSetRemarksOffset);
    NavigationalObstruction_Full.AddNumLines(builder, numLines);
    NavigationalObstruction_Full.AddNumPoints(builder, numPoints);
    NavigationalObstruction_Full.AddOwnerCountryCode(builder, ownerCountryCodeOffset);
    NavigationalObstruction_Full.AddBaseAiracCycle(builder, baseAiracCycle);
    NavigationalObstruction_Full.AddAiracCycle(builder, airacCycle);
    NavigationalObstruction_Full.AddCutoffDate(builder, cutoffDateOffset);
    NavigationalObstruction_Full.AddBaselineCutoffDate(builder, baselineCutoffDateOffset);
    NavigationalObstruction_Full.AddNextCycleDate(builder, nextCycleDateOffset);
    NavigationalObstruction_Full.AddObstacleRemarks(builder, obstacleRemarksOffset);
    NavigationalObstruction_Full.AddValues(builder, valuesOffset);
    NavigationalObstruction_Full.AddKeys(builder, keysOffset);
    NavigationalObstruction_Full.AddInitRecordDate(builder, initRecordDateOffset);
    NavigationalObstruction_Full.AddRevDate(builder, revDateOffset);
    NavigationalObstruction_Full.AddSourceDate(builder, sourceDateOffset);
    NavigationalObstruction_Full.AddDeletingOrg(builder, deletingOrgOffset);
    NavigationalObstruction_Full.AddDerivingOrg(builder, derivingOrgOffset);
    NavigationalObstruction_Full.AddProducer(builder, producerOffset);
    NavigationalObstruction_Full.AddActDelCode(builder, actDelCodeOffset);
    NavigationalObstruction_Full.AddProcessCode(builder, processCodeOffset);
    NavigationalObstruction_Full.AddTransactionCode(builder, transactionCodeOffset);
    NavigationalObstruction_Full.AddValidationCode(builder, validationCode);
    NavigationalObstruction_Full.AddDirectivityCode(builder, directivityCode);
    NavigationalObstruction_Full.AddSurfaceMatCode(builder, surfaceMatCodeOffset);
    NavigationalObstruction_Full.AddLightingCode(builder, lightingCodeOffset);
    NavigationalObstruction_Full.AddQuality(builder, qualityOffset);
    NavigationalObstruction_Full.AddHorizDatumCode(builder, horizDatumCodeOffset);
    NavigationalObstruction_Full.AddNumObs(builder, numObs);
    NavigationalObstruction_Full.AddMultObs(builder, multObsOffset);
    NavigationalObstruction_Full.AddWacINNR(builder, wacINNROffset);
    NavigationalObstruction_Full.AddWac(builder, wacOffset);
    NavigationalObstruction_Full.AddFeatureDescription(builder, featureDescriptionOffset);
    NavigationalObstruction_Full.AddFeatureName(builder, featureNameOffset);
    NavigationalObstruction_Full.AddFeatureType(builder, featureTypeOffset);
    NavigationalObstruction_Full.AddFeatureCode(builder, featureCodeOffset);
    NavigationalObstruction_Full.AddFacc(builder, faccOffset);
    NavigationalObstruction_Full.AddSegNum(builder, segNum);
    NavigationalObstruction_Full.AddSegEndPoint(builder, segEndPoint);
    NavigationalObstruction_Full.AddSegStartPoint(builder, segStartPoint);
    NavigationalObstruction_Full.AddProvinceCode(builder, provinceCodeOffset);
    NavigationalObstruction_Full.AddCountryCode(builder, countryCodeOffset);
    NavigationalObstruction_Full.AddOrigId(builder, origIdOffset);
    NavigationalObstruction_Full.AddExternalId(builder, externalIdOffset);
    NavigationalObstruction_Full.AddObstacleId(builder, obstacleIdOffset);
    NavigationalObstruction_Full.AddObstacleType(builder, obstacleTypeOffset);
    NavigationalObstruction_Full.AddCycleDate(builder, cycleDateOffset);
    NavigationalObstruction_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    NavigationalObstruction_Full.AddId(builder, idOffset);
    NavigationalObstruction_Full.AddDataMode(builder, dataMode);
    return NavigationalObstruction_Full.EndNavigationalObstruction_Full(builder);
  }

  public static void StartNavigationalObstruction_Full(FlatBufferBuilder builder) { builder.StartTable(79); }
  ...
  public static void AddUpdatedAt(FlatBufferBuilder builder, StringOffset updatedAtOffset) { builder.AddOffset(72, updatedAtOffset.Value, 0); }
  public static void AddUpdatedBy(FlatBufferBuilder builder, StringOffset updatedByOffset) { builder.AddOffset(73, updatedByOffset.Value, 0); }
  public static void AddSourceDL(FlatBufferBuilder builder, StringOffset sourceDLOffset) { builder.AddOffset(74, sourceDLOffset.Value, 0); }
  ...
  public static void AddOrigNetwork(FlatBufferBuilder builder, StringOffset origNetworkOffset) { builder.AddOffset(77, origNetworkOffset.Value, 0); }
  public static void AddDataMode(FlatBufferBuilder builder, NavigationalObstruction_Full_dataMode_Enum dataMode) { builder.AddSbyte(78, (sbyte)dataMode, 0); }
  public static Offset<NavigationalObstruction_Full> EndNavigationalObstruction_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<NavigationalObstruction_Full>(o);
  }
  public static void FinishNavigationalObstruction_FullBuffer(FlatBufferBuilder builder, Offset<NavigationalObstruction_Full> offset) { builder.Finish(offset.Value, "NAVI"); }
  public static void FinishSizePrefixedNavigationalObstruction_FullBuffer(FlatBufferBuilder builder, Offset<NavigationalObstruction_Full> offset) { builder.FinishSizePrefixed(offset.Value, "NAVI"); }
  public NavigationalObstruction_FullT UnPack() {
    var _o = new NavigationalObstruction_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(NavigationalObstruction_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<NavigationalObstruction_Full> Pack(FlatBufferBuilder builder, NavigationalObstruction_FullT _o) {
    if (_o == null) return default(Offset<NavigationalObstruction_Full>);
    ...
    return CreateNavigationalObstruction_Full(
      builder,
      _id,
...
public class NavigationalObstruction_FullT
{
  ...
  public NavigationalObstruction_Full_dataMode_Enum DataMode { get; set; }

  public NavigationalObstruction_FullT() {
    this.Id = null;
    ...
    this.DataMode = NavigationalObstruction_Full_dataMode_Enum.REAL;
  }
  public static NavigationalObstruction_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return NavigationalObstruction_Full.GetRootAsNavigationalObstruction_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    NavigationalObstruction_Full.FinishNavigationalObstruction_FullBuffer(fbb, NavigationalObstruction_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class NavigationalObstruction_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyString(tablePos, 148 /*UpdatedAt*/, false)
      && verifier.VerifyString(tablePos, 150 /*UpdatedBy*/, false)
      && verifier.VerifyString(tablePos, 152 /*SourceDL*/, false)
      && verifier.VerifyString(tablePos, 154 /*Source*/, false)
      && verifier.VerifyString(tablePos, 156 /*Origin*/, false)
      && verifier.VerifyString(tablePos, 158 /*OrigNetwork*/, false)
      && verifier.VerifyField(tablePos, 160 /*DataMode*/, 1 /*NavigationalObstruction_Full_dataMode_Enum*/, 1, false)
