...
public struct RoutePoints_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static RoutePoints_Ingest GetRootAsRoutePoints_Ingest(ByteBuffer _bb) { return GetRootAsRoutePoints_Ingest(_bb, new RoutePoints_Ingest()); }
  public static RoutePoints_Ingest GetRootAsRoutePoints_Ingest(ByteBuffer _bb, RoutePoints_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool RoutePoints_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ROUT"); }
  public static bool VerifyRoutePoints_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ROUT", false, RoutePoints_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public RoutePoints_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<RoutePoints_Ingest> CreateRoutePoints_Ingest(FlatBufferBuilder builder,
      int ptSequenceId = 0,
    ...
    RoutePoints_Ingest.AddNavaidLength(builder, navaidLength);
    RoutePoints_Ingest.AddMagDec(builder, magDec);
    RoutePoints_Ingest.AddPtLon(builder, ptLon);
    RoutePoints_Ingest.AddPtLat(builder, ptLat);
    RoutePoints_Ingest.AddNavaidType(builder, navaidTypeOffset);
    RoutePoints_Ingest.AddAltCountryCode(builder, altCountryCodeOffset);
    RoutePoints_Ingest.AddCountryCode(builder, countryCodeOffset);
    RoutePoints_Ingest.AddNavaid(builder, navaidOffset);
    RoutePoints_Ingest.AddWaypointName(builder, waypointNameOffset);
    RoutePoints_Ingest.AddPtTypeName(builder, ptTypeNameOffset);
    RoutePoints_Ingest.AddPtTypeCode(builder, ptTypeCodeOffset);
    RoutePoints_Ingest.AddPtSequenceId(builder, ptSequenceId);
    RoutePoints_Ingest.AddDafifPt(builder, dafifPt);
    return RoutePoints_Ingest.EndRoutePoints_Ingest(builder);
  }

  public static void StartRoutePoints_Ingest(FlatBufferBuilder builder) { builder.StartTable(13); }
  ...
  public static Offset<RoutePoints_Ingest> EndRoutePoints_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RoutePoints_Ingest>(o);
  }
  public static void FinishRoutePoints_IngestBuffer(FlatBufferBuilder builder, Offset<RoutePoints_Ingest> offset) { builder.Finish(offset.Value, "ROUT"); }
  public static void FinishSizePrefixedRoutePoints_IngestBuffer(FlatBufferBuilder builder, Offset<RoutePoints_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "ROUT"); }
  public RoutePoints_IngestT UnPack() {
    var _o = new RoutePoints_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RoutePoints_IngestT _o) {
  ...
  public static Offset<RoutePoints_Ingest> Pack(FlatBufferBuilder builder, RoutePoints_IngestT _o) {
    if (_o == null) return default(Offset<RoutePoints_Ingest>);
    ...
    return CreateRoutePoints_Ingest(
      builder,
      _o.PtSequenceId,
      _ptTypeCode,
      _ptTypeName,
...
public class RoutePoints_IngestT
{
  ...
  public static RoutePoints_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return RoutePoints_Ingest.GetRootAsRoutePoints_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    RoutePoints_Ingest.FinishRoutePoints_IngestBuffer(fbb, RoutePoints_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class RoutePoints_IngestVerify
{
