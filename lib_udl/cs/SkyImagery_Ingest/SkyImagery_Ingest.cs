...
public struct SkyImagery_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SkyImagery_Ingest GetRootAsSkyImagery_Ingest(ByteBuffer _bb) { return GetRootAsSkyImagery_Ingest(_bb, new SkyImagery_Ingest()); }
  public static SkyImagery_Ingest GetRootAsSkyImagery_Ingest(ByteBuffer _bb, SkyImagery_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SkyImagery_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SKYI"); }
  public static bool VerifySkyImagery_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SKYI", false, SkyImagery_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SkyImagery_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SkyImagery_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(96); return o != 0 ? (SkyImagery_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SkyImagery_Ingest_dataMode_Enum.REAL; } }
  ...
  /// Constraints: No constraints specified.
  public string EoObservations(int j) { int o = __p.__offset(102); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int EoObservationsLength { get { int o = __p.__offset(102); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<SkyImagery_Ingest> CreateSkyImagery_Ingest(FlatBufferBuilder builder,
      ...
      SkyImagery_Ingest_dataMode_Enum dataMode = SkyImagery_Ingest_dataMode_Enum.REAL,
  ...
  public static void StartSkyImagery_Ingest(FlatBufferBuilder builder) { builder.StartTable(50); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SkyImagery_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(46, (sbyte)dataMode, 0); }
  ...
  public static void AddEoObservations(FlatBufferBuilder builder, VectorOffset eoObservationsOffset) { builder.AddOffset(49, eoObservationsOffset.Value, 0); }
  ...
  public static Offset<SkyImagery_Ingest> EndSkyImagery_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SkyImagery_Ingest>(o);
  }
  public static void FinishSkyImagery_IngestBuffer(FlatBufferBuilder builder, Offset<SkyImagery_Ingest> offset) { builder.Finish(offset.Value, "SKYI"); }
  public static void FinishSizePrefixedSkyImagery_IngestBuffer(FlatBufferBuilder builder, Offset<SkyImagery_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "SKYI"); }
  public SkyImagery_IngestT UnPack() {
    var _o = new SkyImagery_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SkyImagery_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SkyImagery_Ingest> Pack(FlatBufferBuilder builder, SkyImagery_IngestT _o) {
    if (_o == null) return default(Offset<SkyImagery_Ingest>);
    ...
    return CreateSkyImagery_Ingest(
      builder,
      _id,
...
public class SkyImagery_IngestT
{
  ...
  public SkyImagery_Ingest_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public List<string> EoObservations { get; set; }

  public SkyImagery_IngestT() {
    this.Id = null;
    ...
    this.DataMode = SkyImagery_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.EoObservations = null;
  }
  public static SkyImagery_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return SkyImagery_Ingest.GetRootAsSkyImagery_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SkyImagery_Ingest.FinishSkyImagery_IngestBuffer(fbb, SkyImagery_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SkyImagery_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 96 /*DataMode*/, 1 /*SkyImagery_Ingest_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 98 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 100 /*CreatedBy*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 102 /*EoObservations*/, false)
