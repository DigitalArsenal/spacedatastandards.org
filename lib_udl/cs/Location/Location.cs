...
public struct Location : IFlatbufferObject
{
  ...
  public static bool LocationBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LOCA"); }
  public static bool VerifyLocation(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LOCA", false, LocationVerify.Verify); }
  ...
  public Location_dataMode_Enum DataMode { get { int o = __p.__offset(30); return o != 0 ? (Location_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Location_dataMode_Enum.REAL; } }
  ...
  public static Offset<Location> CreateLocation(FlatBufferBuilder builder,
      ...
      Location_dataMode_Enum dataMode = Location_dataMode_Enum.REAL,
  ...
  public static void StartLocation(FlatBufferBuilder builder) { builder.StartTable(15); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Location_dataMode_Enum dataMode) { builder.AddSbyte(13, (sbyte)dataMode, 0); }
  ...
  public static void FinishLocationBuffer(FlatBufferBuilder builder, Offset<Location> offset) { builder.Finish(offset.Value, "LOCA"); }
  public static void FinishSizePrefixedLocationBuffer(FlatBufferBuilder builder, Offset<Location> offset) { builder.FinishSizePrefixed(offset.Value, "LOCA"); }
  ...
  public static Offset<Location> Pack(FlatBufferBuilder builder, LocationT _o) {
    if (_o == null) return default(Offset<Location>);
...
public class LocationT
{
  ...
  public Location_dataMode_Enum DataMode { get; set; }
  ...
  public LocationT() {
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Location_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static LocationT DeserializeFromBinary(byte[] fbBuffer) {
    return Location.GetRootAsLocation(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Location.FinishLocationBuffer(fbb, Location.Pack(fbb, this));
...
static public class LocationVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 30 /*DataMode*/, 1 /*Location_dataMode_Enum*/, 1, false)
