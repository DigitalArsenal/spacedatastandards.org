...
public struct ISRCollectionPlanned_Full : IFlatbufferObject
{
  ...
  public static bool ISRCollectionPlanned_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ISRC"); }
  public static bool VerifyISRCollectionPlanned_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ISRC", false, ISRCollectionPlanned_FullVerify.Verify); }
  ...
  public static Offset<ISRCollectionPlanned_Full> CreateISRCollectionPlanned_Full(FlatBufferBuilder builder,
  ...
  public static Offset<ISRCollectionPlanned_Full> EndISRCollectionPlanned_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ISRCollectionPlanned_Full>(o);
  }
  public static void FinishISRCollectionPlanned_FullBuffer(FlatBufferBuilder builder, Offset<ISRCollectionPlanned_Full> offset) { builder.Finish(offset.Value, "ISRC"); }
  public static void FinishSizePrefixedISRCollectionPlanned_FullBuffer(FlatBufferBuilder builder, Offset<ISRCollectionPlanned_Full> offset) { builder.FinishSizePrefixed(offset.Value, "ISRC"); }
  ...
  public static Offset<ISRCollectionPlanned_Full> Pack(FlatBufferBuilder builder, ISRCollectionPlanned_FullT _o) {
    if (_o == null) return default(Offset<ISRCollectionPlanned_Full>);
...
public class ISRCollectionPlanned_FullT
{
  ...
  public static ISRCollectionPlanned_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return ISRCollectionPlanned_Full.GetRootAsISRCollectionPlanned_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    ISRCollectionPlanned_Full.FinishISRCollectionPlanned_FullBuffer(fbb, ISRCollectionPlanned_Full.Pack(fbb, this));
