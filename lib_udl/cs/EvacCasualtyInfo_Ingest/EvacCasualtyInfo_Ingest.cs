...
public struct EvacCasualtyInfo_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EvacCasualtyInfo_Ingest GetRootAsEvacCasualtyInfo_Ingest(ByteBuffer _bb) { return GetRootAsEvacCasualtyInfo_Ingest(_bb, new EvacCasualtyInfo_Ingest()); }
  public static EvacCasualtyInfo_Ingest GetRootAsEvacCasualtyInfo_Ingest(ByteBuffer _bb, EvacCasualtyInfo_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EvacCasualtyInfo_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EVAC"); }
  public static bool VerifyEvacCasualtyInfo_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EVAC", false, EvacCasualtyInfo_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EvacCasualtyInfo_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<EvacCasualtyInfo_Ingest> CreateEvacCasualtyInfo_Ingest(FlatBufferBuilder builder,
  ...
  public static void StartEvacCasualtyInfo_Ingest(FlatBufferBuilder builder) { builder.StartTable(35); }
  ...
  public static Offset<EvacCasualtyInfo_Ingest> EndEvacCasualtyInfo_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EvacCasualtyInfo_Ingest>(o);
  }
  public static void FinishEvacCasualtyInfo_IngestBuffer(FlatBufferBuilder builder, Offset<EvacCasualtyInfo_Ingest> offset) { builder.Finish(offset.Value, "EVAC"); }
  public static void FinishSizePrefixedEvacCasualtyInfo_IngestBuffer(FlatBufferBuilder builder, Offset<EvacCasualtyInfo_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "EVAC"); }
  public EvacCasualtyInfo_IngestT UnPack() {
    var _o = new EvacCasualtyInfo_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EvacCasualtyInfo_IngestT _o) {
  ...
  public static Offset<EvacCasualtyInfo_Ingest> Pack(FlatBufferBuilder builder, EvacCasualtyInfo_IngestT _o) {
    if (_o == null) return default(Offset<EvacCasualtyInfo_Ingest>);
    ...
    return CreateEvacCasualtyInfo_Ingest(
      builder,
      _priority,
      _evacType,
      _casualtyType,
...
public class EvacCasualtyInfo_IngestT
{
  ...
  public EvacCasualtyInfo_IngestT() {
    this.Priority = null;
    this.EvacType = null;
  ...
  public static EvacCasualtyInfo_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return EvacCasualtyInfo_Ingest.GetRootAsEvacCasualtyInfo_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EvacCasualtyInfo_Ingest.FinishEvacCasualtyInfo_IngestBuffer(fbb, EvacCasualtyInfo_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EvacCasualtyInfo_IngestVerify
{
