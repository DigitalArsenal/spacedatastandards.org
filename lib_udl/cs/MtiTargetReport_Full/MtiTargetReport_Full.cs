...
public struct MtiTargetReport_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static MtiTargetReport_Full GetRootAsMtiTargetReport_Full(ByteBuffer _bb, MtiTargetReport_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool MtiTargetReport_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MTIT"); }
  public static bool VerifyMtiTargetReport_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MTIT", false, MtiTargetReport_FullVerify.Verify); }
  ...
  public static Offset<MtiTargetReport_Full> CreateMtiTargetReport_Full(FlatBufferBuilder builder,
      int d32_1 = 0,
      double d32_2 = 0.0,
      double d32_3 = 0.0,
      int d32_4 = 0,
    ...
    MtiTargetReport_Full.AddD3217(builder, d32_17);
    MtiTargetReport_Full.AddD323(builder, d32_3);
    MtiTargetReport_Full.AddD322(builder, d32_2);
    MtiTargetReport_Full.AddD3218(builder, d32_18);
    MtiTargetReport_Full.AddD3216(builder, d32_16);
    MtiTargetReport_Full.AddD3215(builder, d32_15);
    MtiTargetReport_Full.AddD3214(builder, d32_14);
    MtiTargetReport_Full.AddD3213(builder, d32_13);
    MtiTargetReport_Full.AddD3212(builder, d32_12);
    MtiTargetReport_Full.AddD3211(builder, d32_11);
    MtiTargetReport_Full.AddD3210(builder, d32_10Offset);
    MtiTargetReport_Full.AddD329(builder, d32_9);
    MtiTargetReport_Full.AddD328(builder, d32_8);
    MtiTargetReport_Full.AddD327(builder, d32_7);
    MtiTargetReport_Full.AddD326(builder, d32_6);
    MtiTargetReport_Full.AddD325(builder, d32_5);
    MtiTargetReport_Full.AddD324(builder, d32_4);
    MtiTargetReport_Full.AddD321(builder, d32_1);
  ...
  public static Offset<MtiTargetReport_Full> EndMtiTargetReport_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<MtiTargetReport_Full>(o);
  }
  public static void FinishMtiTargetReport_FullBuffer(FlatBufferBuilder builder, Offset<MtiTargetReport_Full> offset) { builder.Finish(offset.Value, "MTIT"); }
  public static void FinishSizePrefixedMtiTargetReport_FullBuffer(FlatBufferBuilder builder, Offset<MtiTargetReport_Full> offset) { builder.FinishSizePrefixed(offset.Value, "MTIT"); }
  public MtiTargetReport_FullT UnPack() {
    var _o = new MtiTargetReport_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(MtiTargetReport_FullT _o) {
    _o.D321 = this.D321;
    _o.D322 = this.D322;
    _o.D323 = this.D323;
    _o.D324 = this.D324;
  ...
  public static Offset<MtiTargetReport_Full> Pack(FlatBufferBuilder builder, MtiTargetReport_FullT _o) {
    if (_o == null) return default(Offset<MtiTargetReport_Full>);
...
public class MtiTargetReport_FullT
{
  ...
  public static MtiTargetReport_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return MtiTargetReport_Full.GetRootAsMtiTargetReport_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    MtiTargetReport_Full.FinishMtiTargetReport_FullBuffer(fbb, MtiTargetReport_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class MtiTargetReport_FullVerify
{
