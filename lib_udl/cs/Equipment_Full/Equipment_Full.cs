...
public struct Equipment_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static Equipment_Full GetRootAsEquipment_Full(ByteBuffer _bb, Equipment_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Equipment_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EQUI"); }
  public static bool VerifyEquipment_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EQUI", false, Equipment_FullVerify.Verify); }
  ...
  /// Constraints: No constraints specified.
  public string EquipmentRemarks(int j) { int o = __p.__offset(100); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int EquipmentRemarksLength { get { int o = __p.__offset(100); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Time the row was created in the database, auto-populated by the system.
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string CreatedAt { get { int o = __p.__offset(102); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedAtBytes() { return __p.__vector_as_span<byte>(102, 1); }
#else
  public ArraySegment<byte>? GetCreatedAtBytes() { return __p.__vector_as_arraysegment(102); }
#endif
  public byte[] GetCreatedAtArray() { return __p.__vector_as_array<byte>(102); }
  /// Application user who created the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string CreatedBy { get { int o = __p.__offset(104); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedByBytes() { return __p.__vector_as_span<byte>(104, 1); }
#else
  public ArraySegment<byte>? GetCreatedByBytes() { return __p.__vector_as_arraysegment(104); }
#endif
  public byte[] GetCreatedByArray() { return __p.__vector_as_array<byte>(104); }
  /// Time the row was last updated in the database, auto-populated by the system.
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string UpdatedAt { get { int o = __p.__offset(106); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedAtBytes() { return __p.__vector_as_span<byte>(106, 1); }
#else
  public ArraySegment<byte>? GetUpdatedAtBytes() { return __p.__vector_as_arraysegment(106); }
#endif
  public byte[] GetUpdatedAtArray() { return __p.__vector_as_array<byte>(106); }
  /// Application user who updated the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string UpdatedBy { get { int o = __p.__offset(108); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedByBytes() { return __p.__vector_as_span<byte>(108, 1); }
#else
  public ArraySegment<byte>? GetUpdatedByBytes() { return __p.__vector_as_arraysegment(108); }
#endif
  public byte[] GetUpdatedByArray() { return __p.__vector_as_array<byte>(108); }
  /// Source of the data.
  ...
  public Equipment_Full_dataMode_Enum DataMode { get { int o = __p.__offset(114); return o != 0 ? (Equipment_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Equipment_Full_dataMode_Enum.REAL; } }

  public static Offset<Equipment_Full> CreateEquipment_Full(FlatBufferBuilder builder,
      ...
      VectorOffset equipmentRemarksOffset = default(VectorOffset),
      ...
      Equipment_Full_dataMode_Enum dataMode = Equipment_Full_dataMode_Enum.REAL) {
  ...
  public static void AddEquipmentRemarks(FlatBufferBuilder builder, VectorOffset equipmentRemarksOffset) { builder.AddOffset(48, equipmentRemarksOffset.Value, 0); }
  public static VectorOffset CreateEquipmentRemarksVector(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateEquipmentRemarksVectorBlock(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEquipmentRemarksVectorBlock(FlatBufferBuilder builder, ArraySegment<StringOffset> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateEquipmentRemarksVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<StringOffset>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartEquipmentRemarksVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddCreatedAt(FlatBufferBuilder builder, StringOffset createdAtOffset) { builder.AddOffset(49, createdAtOffset.Value, 0); }
  public static void AddCreatedBy(FlatBufferBuilder builder, StringOffset createdByOffset) { builder.AddOffset(50, createdByOffset.Value, 0); }
  public static void AddUpdatedAt(FlatBufferBuilder builder, StringOffset updatedAtOffset) { builder.AddOffset(51, updatedAtOffset.Value, 0); }
  public static void AddUpdatedBy(FlatBufferBuilder builder, StringOffset updatedByOffset) { builder.AddOffset(52, updatedByOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Equipment_Full_dataMode_Enum dataMode) { builder.AddSbyte(55, (sbyte)dataMode, 0); }
  public static Offset<Equipment_Full> EndEquipment_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Equipment_Full>(o);
  }
  public static void FinishEquipment_FullBuffer(FlatBufferBuilder builder, Offset<Equipment_Full> offset) { builder.Finish(offset.Value, "EQUI"); }
  public static void FinishSizePrefixedEquipment_FullBuffer(FlatBufferBuilder builder, Offset<Equipment_Full> offset) { builder.FinishSizePrefixed(offset.Value, "EQUI"); }
  public Equipment_FullT UnPack() {
    var _o = new Equipment_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Equipment_FullT _o) {
    _o.Id = this.Id;
    ...
    _o.EquipmentRemarks = new List<string>();
    for (var _j = 0; _j < this.EquipmentRemarksLength; ++_j) {_o.EquipmentRemarks.Add(this.EquipmentRemarks(_j));}
  ...
  public static Offset<Equipment_Full> Pack(FlatBufferBuilder builder, Equipment_FullT _o) {
    if (_o == null) return default(Offset<Equipment_Full>);
    ...
    var _equipmentRemarks = default(VectorOffset);
    if (_o.EquipmentRemarks != null) {
      var __equipmentRemarks = new StringOffset[_o.EquipmentRemarks.Count];
      for (var _j = 0; _j < __equipmentRemarks.Length; ++_j) { __equipmentRemarks[_j] = builder.CreateString(_o.EquipmentRemarks[_j]); }
      _equipmentRemarks = CreateEquipmentRemarksVector(builder, __equipmentRemarks);
    }
...
public class Equipment_FullT
{
  ...
  public List<string> EquipmentRemarks { get; set; }
  ...
  public Equipment_Full_dataMode_Enum DataMode { get; set; }

  public Equipment_FullT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Equipment_Full_dataMode_Enum.REAL;
  }
  public static Equipment_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Equipment_Full.GetRootAsEquipment_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Equipment_Full.FinishEquipment_FullBuffer(fbb, Equipment_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Equipment_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfStrings(tablePos, 100 /*EquipmentRemarks*/, false)
      && verifier.VerifyString(tablePos, 102 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 104 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 106 /*UpdatedAt*/, false)
      && verifier.VerifyString(tablePos, 108 /*UpdatedBy*/, false)
      && verifier.VerifyString(tablePos, 110 /*Source*/, false)
      && verifier.VerifyString(tablePos, 112 /*Origin*/, false)
      && verifier.VerifyField(tablePos, 114 /*DataMode*/, 1 /*Equipment_Full_dataMode_Enum*/, 1, false)
