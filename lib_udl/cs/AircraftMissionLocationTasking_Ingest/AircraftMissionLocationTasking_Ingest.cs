...
public struct AircraftMissionLocationTasking_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AircraftMissionLocationTasking_Ingest GetRootAsAircraftMissionLocationTasking_Ingest(ByteBuffer _bb) { return GetRootAsAircraftMissionLocationTasking_Ingest(_bb, new AircraftMissionLocationTasking_Ingest()); }
  public static AircraftMissionLocationTasking_Ingest GetRootAsAircraftMissionLocationTasking_Ingest(ByteBuffer _bb, AircraftMissionLocationTasking_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AircraftMissionLocationTasking_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRC"); }
  public static bool VerifyAircraftMissionLocationTasking_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRC", false, AircraftMissionLocationTasking_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AircraftMissionLocationTasking_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<AircraftMissionLocationTasking_Ingest> CreateAircraftMissionLocationTasking_Ingest(FlatBufferBuilder builder,
  ...
  public static void StartAircraftMissionLocationTasking_Ingest(FlatBufferBuilder builder) { builder.StartTable(10); }
  ...
  public static Offset<AircraftMissionLocationTasking_Ingest> EndAircraftMissionLocationTasking_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AircraftMissionLocationTasking_Ingest>(o);
  }
  public static void FinishAircraftMissionLocationTasking_IngestBuffer(FlatBufferBuilder builder, Offset<AircraftMissionLocationTasking_Ingest> offset) { builder.Finish(offset.Value, "AIRC"); }
  public static void FinishSizePrefixedAircraftMissionLocationTasking_IngestBuffer(FlatBufferBuilder builder, Offset<AircraftMissionLocationTasking_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AIRC"); }
  public AircraftMissionLocationTasking_IngestT UnPack() {
    var _o = new AircraftMissionLocationTasking_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AircraftMissionLocationTasking_IngestT _o) {
  ...
  public static Offset<AircraftMissionLocationTasking_Ingest> Pack(FlatBufferBuilder builder, AircraftMissionLocationTasking_IngestT _o) {
    if (_o == null) return default(Offset<AircraftMissionLocationTasking_Ingest>);
...
public class AircraftMissionLocationTasking_IngestT
{
  ...
  public AircraftMissionLocationTasking_IngestT() {
    this.StartTime = null;
    this.EndTime = null;
  ...
  public static AircraftMissionLocationTasking_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AircraftMissionLocationTasking_Ingest.GetRootAsAircraftMissionLocationTasking_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AircraftMissionLocationTasking_Ingest.FinishAircraftMissionLocationTasking_IngestBuffer(fbb, AircraftMissionLocationTasking_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AircraftMissionLocationTasking_IngestVerify
{
