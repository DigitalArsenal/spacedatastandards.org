...
public struct SeradataEarlyWarning_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SeradataEarlyWarning_Full GetRootAsSeradataEarlyWarning_Full(ByteBuffer _bb) { return GetRootAsSeradataEarlyWarning_Full(_bb, new SeradataEarlyWarning_Full()); }
  public static SeradataEarlyWarning_Full GetRootAsSeradataEarlyWarning_Full(ByteBuffer _bb, SeradataEarlyWarning_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SeradataEarlyWarning_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SERA"); }
  public static bool VerifySeradataEarlyWarning_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SERA", false, SeradataEarlyWarning_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SeradataEarlyWarning_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public SeradataEarlyWarning_Full_dataMode_Enum DataMode { get { int o = __p.__offset(50); return o != 0 ? (SeradataEarlyWarning_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SeradataEarlyWarning_Full_dataMode_Enum.REAL; } }

  public static Offset<SeradataEarlyWarning_Full> CreateSeradataEarlyWarning_Full(FlatBufferBuilder builder,
      ...
      SeradataEarlyWarning_Full_dataMode_Enum dataMode = SeradataEarlyWarning_Full_dataMode_Enum.REAL) {
  ...
  public static void StartSeradataEarlyWarning_Full(FlatBufferBuilder builder) { builder.StartTable(24); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SeradataEarlyWarning_Full_dataMode_Enum dataMode) { builder.AddSbyte(23, (sbyte)dataMode, 0); }
  public static Offset<SeradataEarlyWarning_Full> EndSeradataEarlyWarning_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SeradataEarlyWarning_Full>(o);
  }
  public static void FinishSeradataEarlyWarning_FullBuffer(FlatBufferBuilder builder, Offset<SeradataEarlyWarning_Full> offset) { builder.Finish(offset.Value, "SERA"); }
  public static void FinishSizePrefixedSeradataEarlyWarning_FullBuffer(FlatBufferBuilder builder, Offset<SeradataEarlyWarning_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SERA"); }
  public SeradataEarlyWarning_FullT UnPack() {
    var _o = new SeradataEarlyWarning_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SeradataEarlyWarning_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SeradataEarlyWarning_Full> Pack(FlatBufferBuilder builder, SeradataEarlyWarning_FullT _o) {
    if (_o == null) return default(Offset<SeradataEarlyWarning_Full>);
...
public class SeradataEarlyWarning_FullT
{
  ...
  public SeradataEarlyWarning_Full_dataMode_Enum DataMode { get; set; }

  public SeradataEarlyWarning_FullT() {
    this.Id = null;
    ...
    this.DataMode = SeradataEarlyWarning_Full_dataMode_Enum.REAL;
  }
  public static SeradataEarlyWarning_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return SeradataEarlyWarning_Full.GetRootAsSeradataEarlyWarning_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SeradataEarlyWarning_Full.FinishSeradataEarlyWarning_FullBuffer(fbb, SeradataEarlyWarning_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SeradataEarlyWarning_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 50 /*DataMode*/, 1 /*SeradataEarlyWarning_Full_dataMode_Enum*/, 1, false)
