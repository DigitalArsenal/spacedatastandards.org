...
public struct IonoObservationTraceGeneric_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationTraceGeneric_Abridged GetRootAsIonoObservationTraceGeneric_Abridged(ByteBuffer _bb) { return GetRootAsIonoObservationTraceGeneric_Abridged(_bb, new IonoObservationTraceGeneric_Abridged()); }
  public static IonoObservationTraceGeneric_Abridged GetRootAsIonoObservationTraceGeneric_Abridged(ByteBuffer _bb, IonoObservationTraceGeneric_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationTraceGeneric_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationTraceGeneric_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationTraceGeneric_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationTraceGeneric_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationTraceGeneric_Abridged> CreateIonoObservationTraceGeneric_Abridged(FlatBufferBuilder builder,
  ...
  public static void StartIonoObservationTraceGeneric_Abridged(FlatBufferBuilder builder) { builder.StartTable(3); }
  ...
  public static Offset<IonoObservationTraceGeneric_Abridged> EndIonoObservationTraceGeneric_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationTraceGeneric_Abridged>(o);
  }
  public static void FinishIonoObservationTraceGeneric_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationTraceGeneric_Abridged> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationTraceGeneric_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationTraceGeneric_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationTraceGeneric_AbridgedT UnPack() {
    var _o = new IonoObservationTraceGeneric_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationTraceGeneric_AbridgedT _o) {
  ...
  public static Offset<IonoObservationTraceGeneric_Abridged> Pack(FlatBufferBuilder builder, IonoObservationTraceGeneric_AbridgedT _o) {
    if (_o == null) return default(Offset<IonoObservationTraceGeneric_Abridged>);
...
public class IonoObservationTraceGeneric_AbridgedT
{
  public List<string> Data { get; set; }
  public List<string> DimensionName { get; set; }
  public string Notes { get; set; }

  public IonoObservationTraceGeneric_AbridgedT() {
    this.Data = null;
    this.DimensionName = null;
    this.Notes = null;
  }
  public static IonoObservationTraceGeneric_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationTraceGeneric_Abridged.GetRootAsIonoObservationTraceGeneric_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationTraceGeneric_Abridged.FinishIonoObservationTraceGeneric_AbridgedBuffer(fbb, IonoObservationTraceGeneric_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationTraceGeneric_AbridgedVerify
{
