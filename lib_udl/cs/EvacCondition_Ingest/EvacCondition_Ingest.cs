...
public struct EvacCondition_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EvacCondition_Ingest GetRootAsEvacCondition_Ingest(ByteBuffer _bb) { return GetRootAsEvacCondition_Ingest(_bb, new EvacCondition_Ingest()); }
  public static EvacCondition_Ingest GetRootAsEvacCondition_Ingest(ByteBuffer _bb, EvacCondition_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EvacCondition_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EVAC"); }
  public static bool VerifyEvacCondition_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EVAC", false, EvacCondition_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EvacCondition_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<EvacCondition_Ingest> CreateEvacCondition_Ingest(FlatBufferBuilder builder,
  ...
  public static void StartEvacCondition_Ingest(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<EvacCondition_Ingest> EndEvacCondition_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EvacCondition_Ingest>(o);
  }
  public static void FinishEvacCondition_IngestBuffer(FlatBufferBuilder builder, Offset<EvacCondition_Ingest> offset) { builder.Finish(offset.Value, "EVAC"); }
  public static void FinishSizePrefixedEvacCondition_IngestBuffer(FlatBufferBuilder builder, Offset<EvacCondition_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "EVAC"); }
  public EvacCondition_IngestT UnPack() {
    var _o = new EvacCondition_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EvacCondition_IngestT _o) {
    _o.Type = this.Type;
    _o.BodyPart = this.BodyPart;
    _o.Time = this.Time;
    _o.Comments = this.Comments;
  }
  public static Offset<EvacCondition_Ingest> Pack(FlatBufferBuilder builder, EvacCondition_IngestT _o) {
    if (_o == null) return default(Offset<EvacCondition_Ingest>);
    ...
    return CreateEvacCondition_Ingest(
      builder,
      _type,
      _bodyPart,
      _time,
...
public class EvacCondition_IngestT
{
  ...
  public EvacCondition_IngestT() {
    this.Type = null;
    this.BodyPart = null;
    this.Time = null;
    this.Comments = null;
  }
  public static EvacCondition_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return EvacCondition_Ingest.GetRootAsEvacCondition_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EvacCondition_Ingest.FinishEvacCondition_IngestBuffer(fbb, EvacCondition_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EvacCondition_IngestVerify
{
