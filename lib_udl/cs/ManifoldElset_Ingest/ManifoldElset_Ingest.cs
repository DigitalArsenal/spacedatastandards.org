...
public struct ManifoldElset_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static ManifoldElset_Ingest GetRootAsManifoldElset_Ingest(ByteBuffer _bb, ManifoldElset_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool ManifoldElset_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MANI"); }
  public static bool VerifyManifoldElset_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MANI", false, ManifoldElset_IngestVerify.Verify); }
  ...
  public ManifoldElset_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(54); return o != 0 ? (ManifoldElset_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : ManifoldElset_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<ManifoldElset_Ingest> CreateManifoldElset_Ingest(FlatBufferBuilder builder,
      ...
      ManifoldElset_Ingest_dataMode_Enum dataMode = ManifoldElset_Ingest_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, ManifoldElset_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(25, (sbyte)dataMode, 0); }
  ...
  public static Offset<ManifoldElset_Ingest> EndManifoldElset_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ManifoldElset_Ingest>(o);
  }
  public static void FinishManifoldElset_IngestBuffer(FlatBufferBuilder builder, Offset<ManifoldElset_Ingest> offset) { builder.Finish(offset.Value, "MANI"); }
  public static void FinishSizePrefixedManifoldElset_IngestBuffer(FlatBufferBuilder builder, Offset<ManifoldElset_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "MANI"); }
  public ManifoldElset_IngestT UnPack() {
    var _o = new ManifoldElset_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(ManifoldElset_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<ManifoldElset_Ingest> Pack(FlatBufferBuilder builder, ManifoldElset_IngestT _o) {
    if (_o == null) return default(Offset<ManifoldElset_Ingest>);
...
public class ManifoldElset_IngestT
{
  ...
  public ManifoldElset_Ingest_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public ManifoldElset_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = ManifoldElset_Ingest_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static ManifoldElset_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return ManifoldElset_Ingest.GetRootAsManifoldElset_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    ManifoldElset_Ingest.FinishManifoldElset_IngestBuffer(fbb, ManifoldElset_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class ManifoldElset_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 54 /*DataMode*/, 1 /*ManifoldElset_Ingest_dataMode_Enum*/, 1, false)
