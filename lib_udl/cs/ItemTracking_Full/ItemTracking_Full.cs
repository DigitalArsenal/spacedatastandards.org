...
public struct ItemTracking_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static ItemTracking_Full GetRootAsItemTracking_Full(ByteBuffer _bb) { return GetRootAsItemTracking_Full(_bb, new ItemTracking_Full()); }
  public static ItemTracking_Full GetRootAsItemTracking_Full(ByteBuffer _bb, ItemTracking_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool ItemTracking_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ITEM"); }
  public static bool VerifyItemTracking_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ITEM", false, ItemTracking_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ItemTracking_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public ItemTracking_Full_dataMode_Enum DataMode { get { int o = __p.__offset(46); return o != 0 ? (ItemTracking_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : ItemTracking_Full_dataMode_Enum.REAL; } }

  public static Offset<ItemTracking_Full> CreateItemTracking_Full(FlatBufferBuilder builder,
      ...
      ItemTracking_Full_dataMode_Enum dataMode = ItemTracking_Full_dataMode_Enum.REAL) {
  ...
  public static void StartItemTracking_Full(FlatBufferBuilder builder) { builder.StartTable(22); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, ItemTracking_Full_dataMode_Enum dataMode) { builder.AddSbyte(21, (sbyte)dataMode, 0); }
  public static Offset<ItemTracking_Full> EndItemTracking_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ItemTracking_Full>(o);
  }
  public static void FinishItemTracking_FullBuffer(FlatBufferBuilder builder, Offset<ItemTracking_Full> offset) { builder.Finish(offset.Value, "ITEM"); }
  public static void FinishSizePrefixedItemTracking_FullBuffer(FlatBufferBuilder builder, Offset<ItemTracking_Full> offset) { builder.FinishSizePrefixed(offset.Value, "ITEM"); }
  public ItemTracking_FullT UnPack() {
    var _o = new ItemTracking_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(ItemTracking_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<ItemTracking_Full> Pack(FlatBufferBuilder builder, ItemTracking_FullT _o) {
    if (_o == null) return default(Offset<ItemTracking_Full>);
...
public class ItemTracking_FullT
{
  ...
  public ItemTracking_Full_dataMode_Enum DataMode { get; set; }

  public ItemTracking_FullT() {
    this.Id = null;
    ...
    this.DataMode = ItemTracking_Full_dataMode_Enum.REAL;
  }
  public static ItemTracking_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return ItemTracking_Full.GetRootAsItemTracking_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    ItemTracking_Full.FinishItemTracking_FullBuffer(fbb, ItemTracking_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class ItemTracking_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 46 /*DataMode*/, 1 /*ItemTracking_Full_dataMode_Enum*/, 1, false)
