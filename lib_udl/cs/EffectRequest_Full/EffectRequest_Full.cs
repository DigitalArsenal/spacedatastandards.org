...
public struct EffectRequest_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EffectRequest_Full GetRootAsEffectRequest_Full(ByteBuffer _bb) { return GetRootAsEffectRequest_Full(_bb, new EffectRequest_Full()); }
  public static EffectRequest_Full GetRootAsEffectRequest_Full(ByteBuffer _bb, EffectRequest_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EffectRequest_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EFFE"); }
  public static bool VerifyEffectRequest_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EFFE", false, EffectRequest_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EffectRequest_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public EffectRequest_Full_dataMode_Enum DataMode { get { int o = __p.__offset(42); return o != 0 ? (EffectRequest_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EffectRequest_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<EffectRequest_Full> CreateEffectRequest_Full(FlatBufferBuilder builder,
      ...
      EffectRequest_Full_dataMode_Enum dataMode = EffectRequest_Full_dataMode_Enum.REAL,
  ...
  public static void StartEffectRequest_Full(FlatBufferBuilder builder) { builder.StartTable(21); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, EffectRequest_Full_dataMode_Enum dataMode) { builder.AddSbyte(19, (sbyte)dataMode, 0); }
  ...
  public static Offset<EffectRequest_Full> EndEffectRequest_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EffectRequest_Full>(o);
  }
  public static void FinishEffectRequest_FullBuffer(FlatBufferBuilder builder, Offset<EffectRequest_Full> offset) { builder.Finish(offset.Value, "EFFE"); }
  public static void FinishSizePrefixedEffectRequest_FullBuffer(FlatBufferBuilder builder, Offset<EffectRequest_Full> offset) { builder.FinishSizePrefixed(offset.Value, "EFFE"); }
  public EffectRequest_FullT UnPack() {
    var _o = new EffectRequest_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EffectRequest_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<EffectRequest_Full> Pack(FlatBufferBuilder builder, EffectRequest_FullT _o) {
    if (_o == null) return default(Offset<EffectRequest_Full>);
...
public class EffectRequest_FullT
{
  ...
  public EffectRequest_Full_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public EffectRequest_FullT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = EffectRequest_Full_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static EffectRequest_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return EffectRequest_Full.GetRootAsEffectRequest_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EffectRequest_Full.FinishEffectRequest_FullBuffer(fbb, EffectRequest_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EffectRequest_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 42 /*DataMode*/, 1 /*EffectRequest_Full_dataMode_Enum*/, 1, false)
