...
public struct Bus_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Bus_Ingest GetRootAsBus_Ingest(ByteBuffer _bb) { return GetRootAsBus_Ingest(_bb, new Bus_Ingest()); }
  public static Bus_Ingest GetRootAsBus_Ingest(ByteBuffer _bb, Bus_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Bus_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "BUSI"); }
  public static bool VerifyBus_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("BUSI", false, Bus_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Bus_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: No constraints specified.
  public string OrbitTypes(int j) { int o = __p.__offset(82); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int OrbitTypesLength { get { int o = __p.__offset(82); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string TelemetryTrackingManufacturerOrgId { get { int o = __p.__offset(84); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTelemetryTrackingManufacturerOrgIdBytes() { return __p.__vector_as_span<byte>(84, 1); }
#else
  public ArraySegment<byte>? GetTelemetryTrackingManufacturerOrgIdBytes() { return __p.__vector_as_arraysegment(84); }
#endif
  public byte[] GetTelemetryTrackingManufacturerOrgIdArray() { return __p.__vector_as_array<byte>(84); }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string MainComputerManufacturerOrgId { get { int o = __p.__offset(86); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetMainComputerManufacturerOrgIdBytes() { return __p.__vector_as_span<byte>(86, 1); }
#else
  public ArraySegment<byte>? GetMainComputerManufacturerOrgIdBytes() { return __p.__vector_as_arraysegment(86); }
#endif
  public byte[] GetMainComputerManufacturerOrgIdArray() { return __p.__vector_as_array<byte>(86); }
  /// Unique identifier of the organization which manufactures this bus.
  /// Example: /// Example: MANUFACTURERORG-ID
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string ManufacturerOrgId { get { int o = __p.__offset(88); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetManufacturerOrgIdBytes() { return __p.__vector_as_span<byte>(88, 1); }
#else
  public ArraySegment<byte>? GetManufacturerOrgIdBytes() { return __p.__vector_as_arraysegment(88); }
#endif
  public byte[] GetManufacturerOrgIdArray() { return __p.__vector_as_array<byte>(88); }
  /// Unique identifier of the organization which designs the bus kit.
  /// Example: /// Example: BUSKITDESIGNERORG-ID
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string BusKitDesignerOrgId { get { int o = __p.__offset(90); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetBusKitDesignerOrgIdBytes() { return __p.__vector_as_span<byte>(90, 1); }
#else
  public ArraySegment<byte>? GetBusKitDesignerOrgIdBytes() { return __p.__vector_as_arraysegment(90); }
#endif
  public byte[] GetBusKitDesignerOrgIdArray() { return __p.__vector_as_array<byte>(90); }
  ...
  public string CountryCode { get { int o = __p.__offset(92); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCountryCodeBytes() { return __p.__vector_as_span<byte>(92, 1); }
#else
  public ArraySegment<byte>? GetCountryCodeBytes() { return __p.__vector_as_arraysegment(92); }
#endif
  public byte[] GetCountryCodeArray() { return __p.__vector_as_array<byte>(92); }
  ...
  public string MassCategory { get { int o = __p.__offset(94); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetMassCategoryBytes() { return __p.__vector_as_span<byte>(94, 1); }
#else
  public ArraySegment<byte>? GetMassCategoryBytes() { return __p.__vector_as_arraysegment(94); }
#endif
  public byte[] GetMassCategoryArray() { return __p.__vector_as_array<byte>(94); }
  /// Power category of this bus (e.g. 0-1kW low power, etc).
  /// Example: /// Example: low power
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string PowerCategory { get { int o = __p.__offset(96); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetPowerCategoryBytes() { return __p.__vector_as_span<byte>(96, 1); }
#else
  public ArraySegment<byte>? GetPowerCategoryBytes() { return __p.__vector_as_arraysegment(96); }
#endif
  public byte[] GetPowerCategoryArray() { return __p.__vector_as_array<byte>(96); }
  /// Boolean indicating if this bus is generic.
  /// Example: /// Example: False
  /// Constraints: No constraints specified.
  public bool Generic { get { int o = __p.__offset(98); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  /// Notes/description of the bus.
  /// Example: /// Example: Dedicated small spacecraft bus.
  /// Constraints: Minimum length = 0, Maximum length = 128
  public string Description { get { int o = __p.__offset(100); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetDescriptionBytes() { return __p.__vector_as_span<byte>(100, 1); }
#else
  public ArraySegment<byte>? GetDescriptionBytes() { return __p.__vector_as_arraysegment(100); }
#endif
  public byte[] GetDescriptionArray() { return __p.__vector_as_array<byte>(100); }
  /// Attitude and Orbital Control Notes/description for the bus.
  /// Example: /// Example: Example notes
  /// Constraints: Minimum length = 0, Maximum length = 256
  public string AocsNotes { get { int o = __p.__offset(102); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAocsNotesBytes() { return __p.__vector_as_span<byte>(102, 1); }
#else
  public ArraySegment<byte>? GetAocsNotesBytes() { return __p.__vector_as_arraysegment(102); }
#endif
  public byte[] GetAocsNotesArray() { return __p.__vector_as_array<byte>(102); }
  /// Source of the data.
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Bus_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(110); return o != 0 ? (Bus_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Bus_Ingest_dataMode_Enum.REAL; } }
  /// Time the row was created in the database, auto-populated by the system.
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string CreatedAt { get { int o = __p.__offset(112); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedAtBytes() { return __p.__vector_as_span<byte>(112, 1); }
#else
  public ArraySegment<byte>? GetCreatedAtBytes() { return __p.__vector_as_arraysegment(112); }
#endif
  public byte[] GetCreatedAtArray() { return __p.__vector_as_array<byte>(112); }
  /// Application user who created the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string CreatedBy { get { int o = __p.__offset(114); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedByBytes() { return __p.__vector_as_span<byte>(114, 1); }
#else
  public ArraySegment<byte>? GetCreatedByBytes() { return __p.__vector_as_arraysegment(114); }
#endif
  public byte[] GetCreatedByArray() { return __p.__vector_as_array<byte>(114); }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string Entity { get { int o = __p.__offset(116); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetEntityBytes() { return __p.__vector_as_span<byte>(116, 1); }
#else
  public ArraySegment<byte>? GetEntityBytes() { return __p.__vector_as_arraysegment(116); }
#endif
  public byte[] GetEntityArray() { return __p.__vector_as_array<byte>(116); }

  public static Offset<Bus_Ingest> CreateBus_Ingest(FlatBufferBuilder builder,
      ...
      int numOrbitType = 0,
      VectorOffset orbitTypesOffset = default(VectorOffset),
      ...
      Bus_Ingest_dataMode_Enum dataMode = Bus_Ingest_dataMode_Enum.REAL,
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset),
      StringOffset entityOffset = default(StringOffset)) {
    builder.StartTable(57);
    Bus_Ingest.AddLaunchEnvelopeDimensionZ(builder, launchEnvelopeDimensionZ);
    Bus_Ingest.AddLaunchEnvelopeDimensionY(builder, launchEnvelopeDimensionY);
    Bus_Ingest.AddLaunchEnvelopeDimensionX(builder, launchEnvelopeDimensionX);
    Bus_Ingest.AddPayloadVolume(builder, payloadVolume);
    Bus_Ingest.AddPayloadDimensionZ(builder, payloadDimensionZ);
    Bus_Ingest.AddPayloadDimensionY(builder, payloadDimensionY);
    Bus_Ingest.AddPayloadDimensionX(builder, payloadDimensionX);
    Bus_Ingest.AddBodyDimensionZ(builder, bodyDimensionZ);
    Bus_Ingest.AddBodyDimensionY(builder, bodyDimensionY);
    Bus_Ingest.AddBodyDimensionX(builder, bodyDimensionX);
    Bus_Ingest.AddOapPayloadPower(builder, oapPayloadPower);
    Bus_Ingest.AddMaxPayloadPower(builder, maxPayloadPower);
    Bus_Ingest.AddAvgPayloadPower(builder, avgPayloadPower);
    Bus_Ingest.AddOapSpacecraftPower(builder, oapSpacecraftPower);
    Bus_Ingest.AddMaxSpacecraftPower(builder, maxSpacecraftPower);
    Bus_Ingest.AddAvgSpacecraftPower(builder, avgSpacecraftPower);
    Bus_Ingest.AddMaxEOLPowerUpper(builder, maxEOLPowerUpper);
    Bus_Ingest.AddMaxEOLPowerLower(builder, maxEOLPowerLower);
    Bus_Ingest.AddMaxBOLPowerUpper(builder, maxBOLPowerUpper);
    Bus_Ingest.AddMaxBOLPowerLower(builder, maxBOLPowerLower);
    Bus_Ingest.AddMaxWetMass(builder, maxWetMass);
    Bus_Ingest.AddMedianWetMass(builder, medianWetMass);
    Bus_Ingest.AddAvgWetMass(builder, avgWetMass);
    Bus_Ingest.AddMinWetMass(builder, minWetMass);
    Bus_Ingest.AddMaxDryMass(builder, maxDryMass);
    Bus_Ingest.AddMedianDryMass(builder, medianDryMass);
    Bus_Ingest.AddAvgDryMass(builder, avgDryMass);
    Bus_Ingest.AddMinDryMass(builder, minDryMass);
    Bus_Ingest.AddMaxPayloadMass(builder, maxPayloadMass);
    Bus_Ingest.AddAvgPayloadMass(builder, avgPayloadMass);
    Bus_Ingest.AddMaxBOLStationMass(builder, maxBOLStationMass);
    Bus_Ingest.AddMaxLaunchMassUpper(builder, maxLaunchMassUpper);
    Bus_Ingest.AddMaxLaunchMassLower(builder, maxLaunchMassLower);
    Bus_Ingest.AddEntity(builder, entityOffset);
    Bus_Ingest.AddCreatedBy(builder, createdByOffset);
    Bus_Ingest.AddCreatedAt(builder, createdAtOffset);
    Bus_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    Bus_Ingest.AddOrigin(builder, originOffset);
    Bus_Ingest.AddSource(builder, sourceOffset);
    Bus_Ingest.AddAocsNotes(builder, aocsNotesOffset);
    Bus_Ingest.AddDescription(builder, descriptionOffset);
    Bus_Ingest.AddPowerCategory(builder, powerCategoryOffset);
    Bus_Ingest.AddMassCategory(builder, massCategoryOffset);
    Bus_Ingest.AddCountryCode(builder, countryCodeOffset);
    Bus_Ingest.AddBusKitDesignerOrgId(builder, busKitDesignerOrgIdOffset);
    Bus_Ingest.AddManufacturerOrgId(builder, manufacturerOrgIdOffset);
    Bus_Ingest.AddMainComputerManufacturerOrgId(builder, mainComputerManufacturerOrgIdOffset);
    Bus_Ingest.AddTelemetryTrackingManufacturerOrgId(builder, telemetryTrackingManufacturerOrgIdOffset);
    Bus_Ingest.AddOrbitTypes(builder, orbitTypesOffset);
    Bus_Ingest.AddNumOrbitType(builder, numOrbitType);
    Bus_Ingest.AddType(builder, typeOffset);
    Bus_Ingest.AddIdEntity(builder, idEntityOffset);
    Bus_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    Bus_Ingest.AddName(builder, nameOffset);
    Bus_Ingest.AddId(builder, idOffset);
    Bus_Ingest.AddDataMode(builder, dataMode);
    Bus_Ingest.AddGeneric(builder, generic);
    return Bus_Ingest.EndBus_Ingest(builder);
  }

  public static void StartBus_Ingest(FlatBufferBuilder builder) { builder.StartTable(57); }
  ...
  public static void AddOrbitTypes(FlatBufferBuilder builder, VectorOffset orbitTypesOffset) { builder.AddOffset(39, orbitTypesOffset.Value, 0); }
  public static VectorOffset CreateOrbitTypesVector(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateOrbitTypesVectorBlock(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateOrbitTypesVectorBlock(FlatBufferBuilder builder, ArraySegment<StringOffset> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateOrbitTypesVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<StringOffset>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartOrbitTypesVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddTelemetryTrackingManufacturerOrgId(FlatBufferBuilder builder, StringOffset telemetryTrackingManufacturerOrgIdOffset) { builder.AddOffset(40, telemetryTrackingManufacturerOrgIdOffset.Value, 0); }
  public static void AddMainComputerManufacturerOrgId(FlatBufferBuilder builder, StringOffset mainComputerManufacturerOrgIdOffset) { builder.AddOffset(41, mainComputerManufacturerOrgIdOffset.Value, 0); }
  public static void AddManufacturerOrgId(FlatBufferBuilder builder, StringOffset manufacturerOrgIdOffset) { builder.AddOffset(42, manufacturerOrgIdOffset.Value, 0); }
  public static void AddBusKitDesignerOrgId(FlatBufferBuilder builder, StringOffset busKitDesignerOrgIdOffset) { builder.AddOffset(43, busKitDesignerOrgIdOffset.Value, 0); }
  public static void AddCountryCode(FlatBufferBuilder builder, StringOffset countryCodeOffset) { builder.AddOffset(44, countryCodeOffset.Value, 0); }
  public static void AddMassCategory(FlatBufferBuilder builder, StringOffset massCategoryOffset) { builder.AddOffset(45, massCategoryOffset.Value, 0); }
  public static void AddPowerCategory(FlatBufferBuilder builder, StringOffset powerCategoryOffset) { builder.AddOffset(46, powerCategoryOffset.Value, 0); }
  public static void AddGeneric(FlatBufferBuilder builder, bool generic) { builder.AddBool(47, generic, false); }
  public static void AddDescription(FlatBufferBuilder builder, StringOffset descriptionOffset) { builder.AddOffset(48, descriptionOffset.Value, 0); }
  public static void AddAocsNotes(FlatBufferBuilder builder, StringOffset aocsNotesOffset) { builder.AddOffset(49, aocsNotesOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Bus_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(53, (sbyte)dataMode, 0); }
  public static void AddCreatedAt(FlatBufferBuilder builder, StringOffset createdAtOffset) { builder.AddOffset(54, createdAtOffset.Value, 0); }
  public static void AddCreatedBy(FlatBufferBuilder builder, StringOffset createdByOffset) { builder.AddOffset(55, createdByOffset.Value, 0); }
  public static void AddEntity(FlatBufferBuilder builder, StringOffset entityOffset) { builder.AddOffset(56, entityOffset.Value, 0); }
  public static Offset<Bus_Ingest> EndBus_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Bus_Ingest>(o);
  }
  public static void FinishBus_IngestBuffer(FlatBufferBuilder builder, Offset<Bus_Ingest> offset) { builder.Finish(offset.Value, "BUSI"); }
  public static void FinishSizePrefixedBus_IngestBuffer(FlatBufferBuilder builder, Offset<Bus_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "BUSI"); }
  public Bus_IngestT UnPack() {
    var _o = new Bus_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Bus_IngestT _o) {
    _o.Id = this.Id;
    _o.Name = this.Name;
    ...
    _o.OrbitTypes = new List<string>();
    for (var _j = 0; _j < this.OrbitTypesLength; ++_j) {_o.OrbitTypes.Add(this.OrbitTypes(_j));}
  ...
  public static Offset<Bus_Ingest> Pack(FlatBufferBuilder builder, Bus_IngestT _o) {
    if (_o == null) return default(Offset<Bus_Ingest>);
    ...
    var _orbitTypes = default(VectorOffset);
    if (_o.OrbitTypes != null) {
      var __orbitTypes = new StringOffset[_o.OrbitTypes.Count];
      for (var _j = 0; _j < __orbitTypes.Length; ++_j) { __orbitTypes[_j] = builder.CreateString(_o.OrbitTypes[_j]); }
      _orbitTypes = CreateOrbitTypesVector(builder, __orbitTypes);
    }
...
public class Bus_IngestT
{
  ...
  public List<string> OrbitTypes { get; set; }
  ...
  public Bus_Ingest_dataMode_Enum DataMode { get; set; }
  ...
  public Bus_IngestT() {
    ...
    this.DataMode = Bus_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.Entity = null;
  }
  public static Bus_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Bus_Ingest.GetRootAsBus_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Bus_Ingest.FinishBus_IngestBuffer(fbb, Bus_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Bus_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfStrings(tablePos, 82 /*OrbitTypes*/, false)
      && verifier.VerifyString(tablePos, 84 /*TelemetryTrackingManufacturerOrgId*/, false)
      && verifier.VerifyString(tablePos, 86 /*MainComputerManufacturerOrgId*/, false)
      && verifier.VerifyString(tablePos, 88 /*ManufacturerOrgId*/, false)
      && verifier.VerifyString(tablePos, 90 /*BusKitDesignerOrgId*/, false)
      && verifier.VerifyString(tablePos, 92 /*CountryCode*/, false)
      && verifier.VerifyString(tablePos, 94 /*MassCategory*/, false)
      && verifier.VerifyString(tablePos, 96 /*PowerCategory*/, false)
      && verifier.VerifyField(tablePos, 98 /*Generic*/, 1 /*bool*/, 1, false)
      && verifier.VerifyString(tablePos, 100 /*Description*/, false)
      && verifier.VerifyString(tablePos, 102 /*AocsNotes*/, false)
      ...
      && verifier.VerifyField(tablePos, 110 /*DataMode*/, 1 /*Bus_Ingest_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 112 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 114 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 116 /*Entity*/, false)
