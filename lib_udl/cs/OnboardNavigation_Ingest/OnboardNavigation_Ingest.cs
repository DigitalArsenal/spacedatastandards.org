...
public struct OnboardNavigation_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static OnboardNavigation_Ingest GetRootAsOnboardNavigation_Ingest(ByteBuffer _bb) { return GetRootAsOnboardNavigation_Ingest(_bb, new OnboardNavigation_Ingest()); }
  public static OnboardNavigation_Ingest GetRootAsOnboardNavigation_Ingest(ByteBuffer _bb, OnboardNavigation_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OnboardNavigation_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONBO"); }
  public static bool VerifyOnboardNavigation_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONBO", false, OnboardNavigation_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public OnboardNavigation_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 24
  public OnboardNavigation_Ingest_referenceFrame_Enum ReferenceFrame { get { int o = __p.__offset(28); return o != 0 ? (OnboardNavigation_Ingest_referenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OnboardNavigation_Ingest_referenceFrame_Enum.J2000; } }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 36
  public OnboardNavigation_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(48); return o != 0 ? (OnboardNavigation_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OnboardNavigation_Ingest_dataMode_Enum.REAL; } }

  public static Offset<OnboardNavigation_Ingest> CreateOnboardNavigation_Ingest(FlatBufferBuilder builder,
      ...
      OnboardNavigation_Ingest_referenceFrame_Enum referenceFrame = OnboardNavigation_Ingest_referenceFrame_Enum.J2000,
      ...
      OnboardNavigation_Ingest_dataMode_Enum dataMode = OnboardNavigation_Ingest_dataMode_Enum.REAL) {
  ...
  public static void StartOnboardNavigation_Ingest(FlatBufferBuilder builder) { builder.StartTable(23); }
  ...
  public static void AddReferenceFrame(FlatBufferBuilder builder, OnboardNavigation_Ingest_referenceFrame_Enum referenceFrame) { builder.AddSbyte(12, (sbyte)referenceFrame, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OnboardNavigation_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(22, (sbyte)dataMode, 0); }
  public static Offset<OnboardNavigation_Ingest> EndOnboardNavigation_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OnboardNavigation_Ingest>(o);
  }
  public static void FinishOnboardNavigation_IngestBuffer(FlatBufferBuilder builder, Offset<OnboardNavigation_Ingest> offset) { builder.Finish(offset.Value, "ONBO"); }
  public static void FinishSizePrefixedOnboardNavigation_IngestBuffer(FlatBufferBuilder builder, Offset<OnboardNavigation_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "ONBO"); }
  public OnboardNavigation_IngestT UnPack() {
    var _o = new OnboardNavigation_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OnboardNavigation_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OnboardNavigation_Ingest> Pack(FlatBufferBuilder builder, OnboardNavigation_IngestT _o) {
    if (_o == null) return default(Offset<OnboardNavigation_Ingest>);
    ...
    return CreateOnboardNavigation_Ingest(
      builder,
      _id,
...
public class OnboardNavigation_IngestT
{
  ...
  public OnboardNavigation_Ingest_referenceFrame_Enum ReferenceFrame { get; set; }
  ...
  public OnboardNavigation_Ingest_dataMode_Enum DataMode { get; set; }

  public OnboardNavigation_IngestT() {
    this.Id = null;
    ...
    this.Ts = null;
    this.ReferenceFrame = OnboardNavigation_Ingest_referenceFrame_Enum.J2000;
    this.SunSensor = null;
    this.Mag = null;
    ...
    this.DataMode = OnboardNavigation_Ingest_dataMode_Enum.REAL;
  }
  public static OnboardNavigation_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return OnboardNavigation_Ingest.GetRootAsOnboardNavigation_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OnboardNavigation_Ingest.FinishOnboardNavigation_IngestBuffer(fbb, OnboardNavigation_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OnboardNavigation_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*ReferenceFrame*/, 1 /*OnboardNavigation_Ingest_referenceFrame_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 48 /*DataMode*/, 1 /*OnboardNavigation_Ingest_dataMode_Enum*/, 1, false)
