...
public struct IndividualAircraftTasking_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IndividualAircraftTasking_Ingest GetRootAsIndividualAircraftTasking_Ingest(ByteBuffer _bb) { return GetRootAsIndividualAircraftTasking_Ingest(_bb, new IndividualAircraftTasking_Ingest()); }
  public static IndividualAircraftTasking_Ingest GetRootAsIndividualAircraftTasking_Ingest(ByteBuffer _bb, IndividualAircraftTasking_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IndividualAircraftTasking_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "INDI"); }
  public static bool VerifyIndividualAircraftTasking_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("INDI", false, IndividualAircraftTasking_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IndividualAircraftTasking_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IndividualAircraftTasking_Ingest> CreateIndividualAircraftTasking_Ingest(FlatBufferBuilder builder,
      int numAcft = 0,
  ...
  public static void StartIndividualAircraftTasking_Ingest(FlatBufferBuilder builder) { builder.StartTable(11); }
  ...
  public static Offset<IndividualAircraftTasking_Ingest> EndIndividualAircraftTasking_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IndividualAircraftTasking_Ingest>(o);
  }
  public static void FinishIndividualAircraftTasking_IngestBuffer(FlatBufferBuilder builder, Offset<IndividualAircraftTasking_Ingest> offset) { builder.Finish(offset.Value, "INDI"); }
  public static void FinishSizePrefixedIndividualAircraftTasking_IngestBuffer(FlatBufferBuilder builder, Offset<IndividualAircraftTasking_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "INDI"); }
  public IndividualAircraftTasking_IngestT UnPack() {
    var _o = new IndividualAircraftTasking_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IndividualAircraftTasking_IngestT _o) {
  ...
  public static Offset<IndividualAircraftTasking_Ingest> Pack(FlatBufferBuilder builder, IndividualAircraftTasking_IngestT _o) {
    if (_o == null) return default(Offset<IndividualAircraftTasking_Ingest>);
...
public class IndividualAircraftTasking_IngestT
{
  ...
  public IndividualAircraftTasking_IngestT() {
    this.NumAcft = 0;
    this.AcftType = null;
    this.CallSign = null;
  ...
  public static IndividualAircraftTasking_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return IndividualAircraftTasking_Ingest.GetRootAsIndividualAircraftTasking_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IndividualAircraftTasking_Ingest.FinishIndividualAircraftTasking_IngestBuffer(fbb, IndividualAircraftTasking_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IndividualAircraftTasking_IngestVerify
{
