...
public struct IonoObservationElevation_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static IonoObservationElevation_Abridged GetRootAsIonoObservationElevation_Abridged(ByteBuffer _bb, IonoObservationElevation_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationElevation_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationElevation_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationElevation_AbridgedVerify.Verify); }
  ...
  public static Offset<IonoObservationElevation_Abridged> CreateIonoObservationElevation_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<IonoObservationElevation_Abridged> EndIonoObservationElevation_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationElevation_Abridged>(o);
  }
  public static void FinishIonoObservationElevation_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationElevation_Abridged> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationElevation_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationElevation_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationElevation_AbridgedT UnPack() {
    var _o = new IonoObservationElevation_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationElevation_AbridgedT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationElevation_Abridged> Pack(FlatBufferBuilder builder, IonoObservationElevation_AbridgedT _o) {
    if (_o == null) return default(Offset<IonoObservationElevation_Abridged>);
    ...
    return CreateIonoObservationElevation_Abridged(
      builder,
      _notes,
      _dimensions,
      _dimensionName,
...
public class IonoObservationElevation_AbridgedT
{
  ...
  public IonoObservationElevation_AbridgedT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationElevation_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationElevation_Abridged.GetRootAsIonoObservationElevation_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationElevation_Abridged.FinishIonoObservationElevation_AbridgedBuffer(fbb, IonoObservationElevation_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationElevation_AbridgedVerify
{
