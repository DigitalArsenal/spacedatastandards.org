...
public struct AircraftStatusRemark_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AircraftStatusRemark_Abridged GetRootAsAircraftStatusRemark_Abridged(ByteBuffer _bb) { return GetRootAsAircraftStatusRemark_Abridged(_bb, new AircraftStatusRemark_Abridged()); }
  public static AircraftStatusRemark_Abridged GetRootAsAircraftStatusRemark_Abridged(ByteBuffer _bb, AircraftStatusRemark_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AircraftStatusRemark_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRC"); }
  public static bool VerifyAircraftStatusRemark_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRC", false, AircraftStatusRemark_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AircraftStatusRemark_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public AircraftStatusRemark_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(34); return o != 0 ? (AircraftStatusRemark_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AircraftStatusRemark_Abridged_dataMode_Enum.REAL; } }

  public static Offset<AircraftStatusRemark_Abridged> CreateAircraftStatusRemark_Abridged(FlatBufferBuilder builder,
      ...
      AircraftStatusRemark_Abridged_dataMode_Enum dataMode = AircraftStatusRemark_Abridged_dataMode_Enum.REAL) {
    builder.StartTable(16);
    AircraftStatusRemark_Abridged.AddOrigNetwork(builder, origNetworkOffset);
    AircraftStatusRemark_Abridged.AddOrigin(builder, originOffset);
    AircraftStatusRemark_Abridged.AddSource(builder, sourceOffset);
    AircraftStatusRemark_Abridged.AddSourceDL(builder, sourceDLOffset);
    AircraftStatusRemark_Abridged.AddCreatedBy(builder, createdByOffset);
    AircraftStatusRemark_Abridged.AddCreatedAt(builder, createdAtOffset);
    AircraftStatusRemark_Abridged.AddLastUpdatedAt(builder, lastUpdatedAtOffset);
    AircraftStatusRemark_Abridged.AddLastUpdatedBy(builder, lastUpdatedByOffset);
    AircraftStatusRemark_Abridged.AddTimestamp(builder, timestampOffset);
    AircraftStatusRemark_Abridged.AddText(builder, textOffset);
    AircraftStatusRemark_Abridged.AddName(builder, nameOffset);
    AircraftStatusRemark_Abridged.AddAltRmkId(builder, altRmkIdOffset);
    AircraftStatusRemark_Abridged.AddIdAircraftStatus(builder, idAircraftStatusOffset);
    AircraftStatusRemark_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    AircraftStatusRemark_Abridged.AddId(builder, idOffset);
    AircraftStatusRemark_Abridged.AddDataMode(builder, dataMode);
    return AircraftStatusRemark_Abridged.EndAircraftStatusRemark_Abridged(builder);
  }

  public static void StartAircraftStatusRemark_Abridged(FlatBufferBuilder builder) { builder.StartTable(16); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AircraftStatusRemark_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(15, (sbyte)dataMode, 0); }
  public static Offset<AircraftStatusRemark_Abridged> EndAircraftStatusRemark_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AircraftStatusRemark_Abridged>(o);
  }
  public static void FinishAircraftStatusRemark_AbridgedBuffer(FlatBufferBuilder builder, Offset<AircraftStatusRemark_Abridged> offset) { builder.Finish(offset.Value, "AIRC"); }
  public static void FinishSizePrefixedAircraftStatusRemark_AbridgedBuffer(FlatBufferBuilder builder, Offset<AircraftStatusRemark_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "AIRC"); }
  public AircraftStatusRemark_AbridgedT UnPack() {
    var _o = new AircraftStatusRemark_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AircraftStatusRemark_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AircraftStatusRemark_Abridged> Pack(FlatBufferBuilder builder, AircraftStatusRemark_AbridgedT _o) {
    if (_o == null) return default(Offset<AircraftStatusRemark_Abridged>);
...
public class AircraftStatusRemark_AbridgedT
{
  ...
  public AircraftStatusRemark_Abridged_dataMode_Enum DataMode { get; set; }

  public AircraftStatusRemark_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = AircraftStatusRemark_Abridged_dataMode_Enum.REAL;
  }
  public static AircraftStatusRemark_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return AircraftStatusRemark_Abridged.GetRootAsAircraftStatusRemark_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AircraftStatusRemark_Abridged.FinishAircraftStatusRemark_AbridgedBuffer(fbb, AircraftStatusRemark_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AircraftStatusRemark_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 34 /*DataMode*/, 1 /*AircraftStatusRemark_Abridged_dataMode_Enum*/, 1, false)
