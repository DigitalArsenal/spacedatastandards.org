...
public struct ISRCollectionTaskings_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static ISRCollectionTaskings_Abridged GetRootAsISRCollectionTaskings_Abridged(ByteBuffer _bb, ISRCollectionTaskings_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool ISRCollectionTaskings_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ISRC"); }
  public static bool VerifyISRCollectionTaskings_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ISRC", false, ISRCollectionTaskings_AbridgedVerify.Verify); }
  ...
  public ISRCollectionTaskings_Abridged_type_Enum Type { get { int o = __p.__offset(6); return o != 0 ? (ISRCollectionTaskings_Abridged_type_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : ISRCollectionTaskings_Abridged_type_Enum.DELIBERATE; } }
  /// Type of collection tasked.
  /// Example: /// Example: Simultaneous
  /// Constraints: Minimum length = 1, Maximum length = 16
  public ISRCollectionTaskings_Abridged_collectionType_Enum CollectionType { get { int o = __p.__offset(8); return o != 0 ? (ISRCollectionTaskings_Abridged_collectionType_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : ISRCollectionTaskings_Abridged_collectionType_Enum.SIMULTANEOUS; } }
  ...
  public static Offset<ISRCollectionTaskings_Abridged> CreateISRCollectionTaskings_Abridged(FlatBufferBuilder builder,
      StringOffset idOffset = default(StringOffset),
      ISRCollectionTaskings_Abridged_type_Enum type = ISRCollectionTaskings_Abridged_type_Enum.DELIBERATE,
      ISRCollectionTaskings_Abridged_collectionType_Enum collectionType = ISRCollectionTaskings_Abridged_collectionType_Enum.SIMULTANEOUS,
  ...
  public static void AddType(FlatBufferBuilder builder, ISRCollectionTaskings_Abridged_type_Enum type) { builder.AddSbyte(1, (sbyte)type, 0); }
  public static void AddCollectionType(FlatBufferBuilder builder, ISRCollectionTaskings_Abridged_collectionType_Enum collectionType) { builder.AddSbyte(2, (sbyte)collectionType, 0); }
  ...
  public static Offset<ISRCollectionTaskings_Abridged> EndISRCollectionTaskings_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ISRCollectionTaskings_Abridged>(o);
  }
  public static void FinishISRCollectionTaskings_AbridgedBuffer(FlatBufferBuilder builder, Offset<ISRCollectionTaskings_Abridged> offset) { builder.Finish(offset.Value, "ISRC"); }
  public static void FinishSizePrefixedISRCollectionTaskings_AbridgedBuffer(FlatBufferBuilder builder, Offset<ISRCollectionTaskings_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "ISRC"); }
  public ISRCollectionTaskings_AbridgedT UnPack() {
    var _o = new ISRCollectionTaskings_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(ISRCollectionTaskings_AbridgedT _o) {
    _o.Id = this.Id;
    _o.Type = this.Type;
  ...
  public static Offset<ISRCollectionTaskings_Abridged> Pack(FlatBufferBuilder builder, ISRCollectionTaskings_AbridgedT _o) {
    if (_o == null) return default(Offset<ISRCollectionTaskings_Abridged>);
...
public class ISRCollectionTaskings_AbridgedT
{
  public string Id { get; set; }
  public ISRCollectionTaskings_Abridged_type_Enum Type { get; set; }
  public ISRCollectionTaskings_Abridged_collectionType_Enum CollectionType { get; set; }
  ...
  public ISRCollectionTaskings_AbridgedT() {
    this.Id = null;
    this.Type = ISRCollectionTaskings_Abridged_type_Enum.DELIBERATE;
    this.CollectionType = ISRCollectionTaskings_Abridged_collectionType_Enum.SIMULTANEOUS;
  ...
  public static ISRCollectionTaskings_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return ISRCollectionTaskings_Abridged.GetRootAsISRCollectionTaskings_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    ISRCollectionTaskings_Abridged.FinishISRCollectionTaskings_AbridgedBuffer(fbb, ISRCollectionTaskings_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class ISRCollectionTaskings_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyString(tablePos, 4 /*Id*/, false)
      && verifier.VerifyField(tablePos, 6 /*Type*/, 1 /*ISRCollectionTaskings_Abridged_type_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 8 /*CollectionType*/, 1 /*ISRCollectionTaskings_Abridged_collectionType_Enum*/, 1, false)
