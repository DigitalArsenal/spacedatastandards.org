...
public struct PersonnelRecoveryEnemyData_Abridged : IFlatbufferObject
{
  ...
  public static bool PersonnelRecoveryEnemyData_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "PERS"); }
  public static bool VerifyPersonnelRecoveryEnemyData_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("PERS", false, PersonnelRecoveryEnemyData_AbridgedVerify.Verify); }
  ...
  public static Offset<PersonnelRecoveryEnemyData_Abridged> CreatePersonnelRecoveryEnemyData_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<PersonnelRecoveryEnemyData_Abridged> EndPersonnelRecoveryEnemyData_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PersonnelRecoveryEnemyData_Abridged>(o);
  }
  public static void FinishPersonnelRecoveryEnemyData_AbridgedBuffer(FlatBufferBuilder builder, Offset<PersonnelRecoveryEnemyData_Abridged> offset) { builder.Finish(offset.Value, "PERS"); }
  public static void FinishSizePrefixedPersonnelRecoveryEnemyData_AbridgedBuffer(FlatBufferBuilder builder, Offset<PersonnelRecoveryEnemyData_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "PERS"); }
  ...
  public static Offset<PersonnelRecoveryEnemyData_Abridged> Pack(FlatBufferBuilder builder, PersonnelRecoveryEnemyData_AbridgedT _o) {
    if (_o == null) return default(Offset<PersonnelRecoveryEnemyData_Abridged>);
...
public class PersonnelRecoveryEnemyData_AbridgedT
{
  ...
  public static PersonnelRecoveryEnemyData_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return PersonnelRecoveryEnemyData_Abridged.GetRootAsPersonnelRecoveryEnemyData_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    PersonnelRecoveryEnemyData_Abridged.FinishPersonnelRecoveryEnemyData_AbridgedBuffer(fbb, PersonnelRecoveryEnemyData_Abridged.Pack(fbb, this));
