...
public struct SolarArray : IFlatbufferObject
{
  private Table __p;
  ...
  public static SolarArray GetRootAsSolarArray(ByteBuffer _bb, SolarArray obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SolarArrayBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SOLA"); }
  public static bool VerifySolarArray(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SOLA", false, SolarArrayVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SolarArray_dataMode_Enum DataMode { get { int o = __p.__offset(22); return o != 0 ? (SolarArray_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SolarArray_dataMode_Enum.REAL; } }
  ...
  public static Offset<SolarArray> CreateSolarArray(FlatBufferBuilder builder,
      ...
      SolarArray_dataMode_Enum dataMode = SolarArray_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SolarArray_dataMode_Enum dataMode) { builder.AddSbyte(9, (sbyte)dataMode, 0); }
  ...
  public static Offset<SolarArray> EndSolarArray(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SolarArray>(o);
  }
  public static void FinishSolarArrayBuffer(FlatBufferBuilder builder, Offset<SolarArray> offset) { builder.Finish(offset.Value, "SOLA"); }
  public static void FinishSizePrefixedSolarArrayBuffer(FlatBufferBuilder builder, Offset<SolarArray> offset) { builder.FinishSizePrefixed(offset.Value, "SOLA"); }
  public SolarArrayT UnPack() {
    var _o = new SolarArrayT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SolarArrayT _o) {
    _o.Id = this.Id;
    _o.Name = this.Name;
  ...
  public static Offset<SolarArray> Pack(FlatBufferBuilder builder, SolarArrayT _o) {
    if (_o == null) return default(Offset<SolarArray>);
...
public class SolarArrayT
{
  ...
  public SolarArray_dataMode_Enum DataMode { get; set; }
  ...
  public SolarArrayT() {
    ...
    this.DataMode = SolarArray_dataMode_Enum.REAL;
    this.SolarArrayDetails = null;
  }
  public static SolarArrayT DeserializeFromBinary(byte[] fbBuffer) {
    return SolarArray.GetRootAsSolarArray(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SolarArray.FinishSolarArrayBuffer(fbb, SolarArray.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SolarArrayVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*DataMode*/, 1 /*SolarArray_dataMode_Enum*/, 1, false)
