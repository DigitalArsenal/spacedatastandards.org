...
public struct IonoObservationAzimuth_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationAzimuth_Ingest GetRootAsIonoObservationAzimuth_Ingest(ByteBuffer _bb) { return GetRootAsIonoObservationAzimuth_Ingest(_bb, new IonoObservationAzimuth_Ingest()); }
  public static IonoObservationAzimuth_Ingest GetRootAsIonoObservationAzimuth_Ingest(ByteBuffer _bb, IonoObservationAzimuth_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationAzimuth_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationAzimuth_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationAzimuth_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationAzimuth_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationAzimuth_Ingest> CreateIonoObservationAzimuth_Ingest(FlatBufferBuilder builder,
    ...
    IonoObservationAzimuth_Ingest.AddData(builder, dataOffset);
    IonoObservationAzimuth_Ingest.AddDimensionName(builder, dimensionNameOffset);
    IonoObservationAzimuth_Ingest.AddDimensions(builder, dimensionsOffset);
    IonoObservationAzimuth_Ingest.AddNotes(builder, notesOffset);
    return IonoObservationAzimuth_Ingest.EndIonoObservationAzimuth_Ingest(builder);
  }

  public static void StartIonoObservationAzimuth_Ingest(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationAzimuth_Ingest> EndIonoObservationAzimuth_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationAzimuth_Ingest>(o);
  }
  public static void FinishIonoObservationAzimuth_IngestBuffer(FlatBufferBuilder builder, Offset<IonoObservationAzimuth_Ingest> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationAzimuth_IngestBuffer(FlatBufferBuilder builder, Offset<IonoObservationAzimuth_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationAzimuth_IngestT UnPack() {
    var _o = new IonoObservationAzimuth_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationAzimuth_IngestT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationAzimuth_Ingest> Pack(FlatBufferBuilder builder, IonoObservationAzimuth_IngestT _o) {
    if (_o == null) return default(Offset<IonoObservationAzimuth_Ingest>);
    ...
    return CreateIonoObservationAzimuth_Ingest(
      builder,
      _notes,
      _dimensions,
      _dimensionName,
...
public class IonoObservationAzimuth_IngestT
{
  ...
  public IonoObservationAzimuth_IngestT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationAzimuth_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationAzimuth_Ingest.GetRootAsIonoObservationAzimuth_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationAzimuth_Ingest.FinishIonoObservationAzimuth_IngestBuffer(fbb, IonoObservationAzimuth_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationAzimuth_IngestVerify
{
