...
public struct StateVector_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static StateVector_Full GetRootAsStateVector_Full(ByteBuffer _bb) { return GetRootAsStateVector_Full(_bb, new StateVector_Full()); }
  public static StateVector_Full GetRootAsStateVector_Full(ByteBuffer _bb, StateVector_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool StateVector_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "STAT"); }
  public static bool VerifyStateVector_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("STAT", false, StateVector_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public StateVector_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public StateVector_Full_referenceFrame_Enum ReferenceFrame { get { int o = __p.__offset(34); return o != 0 ? (StateVector_Full_referenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : StateVector_Full_referenceFrame_Enum.J2000; } }
  ...
  /// Example: /// Example: J2000
  /// Constraints: Minimum length = 0, Maximum length = 24
  public StateVector_Full_covReferenceFrame_Enum CovReferenceFrame { get { int o = __p.__offset(38); return o != 0 ? (StateVector_Full_covReferenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : StateVector_Full_covReferenceFrame_Enum.J2000; } }
  ...
  /// Constraints: No constraints specified.
  public string EffectiveFrom { get { int o = __p.__offset(168); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetEffectiveFromBytes() { return __p.__vector_as_span<byte>(168, 1); }
#else
  public ArraySegment<byte>? GetEffectiveFromBytes() { return __p.__vector_as_arraysegment(168); }
#endif
  public byte[] GetEffectiveFromArray() { return __p.__vector_as_array<byte>(168); }
  /// End time at which this state vector was no longer the 'current' state vector for its satellite.
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string EffectiveUntil { get { int o = __p.__offset(170); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetEffectiveUntilBytes() { return __p.__vector_as_span<byte>(170, 1); }
#else
  public ArraySegment<byte>? GetEffectiveUntilBytes() { return __p.__vector_as_arraysegment(170); }
#endif
  public byte[] GetEffectiveUntilArray() { return __p.__vector_as_array<byte>(170); }
  /// Optional URI location in the document repository of the raw file parsed by the system to produce this record. To download the raw file, prepend https://udl-hostname/scs/download?id= to this value.
  /// Example: /// Example: rawFileURI
  /// Constraints: Minimum length = 0, Maximum length = 256
  public string RawFileURI { get { int o = __p.__offset(172); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetRawFileURIBytes() { return __p.__vector_as_span<byte>(172, 1); }
#else
  public ArraySegment<byte>? GetRawFileURIBytes() { return __p.__vector_as_arraysegment(172); }
#endif
  public byte[] GetRawFileURIArray() { return __p.__vector_as_array<byte>(172); }
  /// Source of the data.
  /// Example: /// Example: Bluestaq
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string Source { get { int o = __p.__offset(174); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceBytes() { return __p.__vector_as_span<byte>(174, 1); }
#else
  public ArraySegment<byte>? GetSourceBytes() { return __p.__vector_as_arraysegment(174); }
#endif
  public byte[] GetSourceArray() { return __p.__vector_as_array<byte>(174); }
  /// Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
  /// Example: /// Example: THIRD_PARTY_DATASOURCE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Origin { get { int o = __p.__offset(176); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOriginBytes() { return __p.__vector_as_span<byte>(176, 1); }
#else
  public ArraySegment<byte>? GetOriginBytes() { return __p.__vector_as_arraysegment(176); }
#endif
  public byte[] GetOriginArray() { return __p.__vector_as_array<byte>(176); }
  ...
  public StateVector_Full_dataMode_Enum DataMode { get { int o = __p.__offset(178); return o != 0 ? (StateVector_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : StateVector_Full_dataMode_Enum.REAL; } }
  /// Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
  /// Example: /// Example: ['TAG1', 'TAG2']
  /// Constraints: No constraints specified.
  public string Tags(int j) { int o = __p.__offset(180); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int TagsLength { get { int o = __p.__offset(180); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Optional algorithm used to produce this record.
  /// Example: /// Example: SAMPLE_ALGORITHM
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Algorithm { get { int o = __p.__offset(182); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAlgorithmBytes() { return __p.__vector_as_span<byte>(182, 1); }
#else
  public ArraySegment<byte>? GetAlgorithmBytes() { return __p.__vector_as_arraysegment(182); }
#endif
  public byte[] GetAlgorithmArray() { return __p.__vector_as_array<byte>(182); }
  ...
  /// Constraints: No constraints specified.
  public string SourcedData(int j) { int o = __p.__offset(184); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SourcedDataLength { get { int o = __p.__offset(184); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Constraints: No constraints specified.
  public StateVector_Full_sourcedDataTypes_Enum SourcedDataTypes { get { int o = __p.__offset(186); return o != 0 ? (StateVector_Full_sourcedDataTypes_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : StateVector_Full_sourcedDataTypes_Enum.EO; } }
  /// Time the row was created in the database, auto-populated by the system.
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string CreatedAt { get { int o = __p.__offset(188); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedAtBytes() { return __p.__vector_as_span<byte>(188, 1); }
#else
  public ArraySegment<byte>? GetCreatedAtBytes() { return __p.__vector_as_arraysegment(188); }
#endif
  public byte[] GetCreatedAtArray() { return __p.__vector_as_array<byte>(188); }
  /// Application user who created the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string CreatedBy { get { int o = __p.__offset(190); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedByBytes() { return __p.__vector_as_span<byte>(190, 1); }
#else
  public ArraySegment<byte>? GetCreatedByBytes() { return __p.__vector_as_arraysegment(190); }
#endif
  public byte[] GetCreatedByArray() { return __p.__vector_as_array<byte>(190); }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string OnOrbit { get { int o = __p.__offset(192); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbitBytes() { return __p.__vector_as_span<byte>(192, 1); }
#else
  public ArraySegment<byte>? GetOnOrbitBytes() { return __p.__vector_as_arraysegment(192); }
#endif
  public byte[] GetOnOrbitArray() { return __p.__vector_as_array<byte>(192); }
  /// Optional source-provided and searchable metadata or descriptor of the data.
  /// Example: /// Example: descriptor
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Descriptor { get { int o = __p.__offset(194); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetDescriptorBytes() { return __p.__vector_as_span<byte>(194, 1); }
#else
  public ArraySegment<byte>? GetDescriptorBytes() { return __p.__vector_as_arraysegment(194); }
#endif
  public byte[] GetDescriptorArray() { return __p.__vector_as_array<byte>(194); }
  /// Optional identifier to track a commercial or marketplace transaction executed to produce this data.
  /// Example: /// Example: transactionId
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string TransactionId { get { int o = __p.__offset(196); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTransactionIdBytes() { return __p.__vector_as_span<byte>(196, 1); }
#else
  public ArraySegment<byte>? GetTransactionIdBytes() { return __p.__vector_as_arraysegment(196); }
#endif
  public byte[] GetTransactionIdArray() { return __p.__vector_as_array<byte>(196); }
  /// The originating source network on which this record was created, auto-populated by the system.
  /// Example: /// Example: ORIG
  /// Constraints: Minimum length = 1, Maximum length = 32
  public string OrigNetwork { get { int o = __p.__offset(198); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOrigNetworkBytes() { return __p.__vector_as_span<byte>(198, 1); }
#else
  public ArraySegment<byte>? GetOrigNetworkBytes() { return __p.__vector_as_arraysegment(198); }
#endif
  public byte[] GetOrigNetworkArray() { return __p.__vector_as_array<byte>(198); }
  /// The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
  /// Example: /// Example: AXE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string SourceDL { get { int o = __p.__offset(200); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceDLBytes() { return __p.__vector_as_span<byte>(200, 1); }
#else
  public ArraySegment<byte>? GetSourceDLBytes() { return __p.__vector_as_arraysegment(200); }
#endif
  public byte[] GetSourceDLArray() { return __p.__vector_as_array<byte>(200); }

  public static Offset<StateVector_Full> CreateStateVector_Full(FlatBufferBuilder builder,
      ...
      double yvel = 0.0,
      double zvel = 0.0,
      StateVector_Full_referenceFrame_Enum referenceFrame = StateVector_Full_referenceFrame_Enum.J2000,
      VectorOffset covOffset = default(VectorOffset),
      StateVector_Full_covReferenceFrame_Enum covReferenceFrame = StateVector_Full_covReferenceFrame_Enum.J2000,
      ...
      StateVector_Full_dataMode_Enum dataMode = StateVector_Full_dataMode_Enum.REAL,
      VectorOffset tagsOffset = default(VectorOffset),
      StringOffset algorithmOffset = default(StringOffset),
      VectorOffset sourcedDataOffset = default(VectorOffset),
      StateVector_Full_sourcedDataTypes_Enum sourcedDataTypes = StateVector_Full_sourcedDataTypes_Enum.EO,
  ...
  public static void StartStateVector_Full(FlatBufferBuilder builder) { builder.StartTable(99); }
  ...
  public static void AddReferenceFrame(FlatBufferBuilder builder, StateVector_Full_referenceFrame_Enum referenceFrame) { builder.AddSbyte(15, (sbyte)referenceFrame, 0); }
  ...
  public static void AddCovReferenceFrame(FlatBufferBuilder builder, StateVector_Full_covReferenceFrame_Enum covReferenceFrame) { builder.AddSbyte(17, (sbyte)covReferenceFrame, 0); }
  ...
  public static void AddEffectiveFrom(FlatBufferBuilder builder, StringOffset effectiveFromOffset) { builder.AddOffset(82, effectiveFromOffset.Value, 0); }
  public static void AddEffectiveUntil(FlatBufferBuilder builder, StringOffset effectiveUntilOffset) { builder.AddOffset(83, effectiveUntilOffset.Value, 0); }
  public static void AddRawFileURI(FlatBufferBuilder builder, StringOffset rawFileURIOffset) { builder.AddOffset(84, rawFileURIOffset.Value, 0); }
  public static void AddSource(FlatBufferBuilder builder, StringOffset sourceOffset) { builder.AddOffset(85, sourceOffset.Value, 0); }
  public static void AddOrigin(FlatBufferBuilder builder, StringOffset originOffset) { builder.AddOffset(86, originOffset.Value, 0); }
  public static void AddDataMode(FlatBufferBuilder builder, StateVector_Full_dataMode_Enum dataMode) { builder.AddSbyte(87, (sbyte)dataMode, 0); }
  public static void AddTags(FlatBufferBuilder builder, VectorOffset tagsOffset) { builder.AddOffset(88, tagsOffset.Value, 0); }
  ...
  public static void AddAlgorithm(FlatBufferBuilder builder, StringOffset algorithmOffset) { builder.AddOffset(89, algorithmOffset.Value, 0); }
  public static void AddSourcedData(FlatBufferBuilder builder, VectorOffset sourcedDataOffset) { builder.AddOffset(90, sourcedDataOffset.Value, 0); }
  ...
  public static void AddSourcedDataTypes(FlatBufferBuilder builder, StateVector_Full_sourcedDataTypes_Enum sourcedDataTypes) { builder.AddSbyte(91, (sbyte)sourcedDataTypes, 0); }
  public static void AddCreatedAt(FlatBufferBuilder builder, StringOffset createdAtOffset) { builder.AddOffset(92, createdAtOffset.Value, 0); }
  public static void AddCreatedBy(FlatBufferBuilder builder, StringOffset createdByOffset) { builder.AddOffset(93, createdByOffset.Value, 0); }
  public static void AddOnOrbit(FlatBufferBuilder builder, StringOffset onOrbitOffset) { builder.AddOffset(94, onOrbitOffset.Value, 0); }
  public static void AddDescriptor(FlatBufferBuilder builder, StringOffset descriptorOffset) { builder.AddOffset(95, descriptorOffset.Value, 0); }
  public static void AddTransactionId(FlatBufferBuilder builder, StringOffset transactionIdOffset) { builder.AddOffset(96, transactionIdOffset.Value, 0); }
  public static void AddOrigNetwork(FlatBufferBuilder builder, StringOffset origNetworkOffset) { builder.AddOffset(97, origNetworkOffset.Value, 0); }
  public static void AddSourceDL(FlatBufferBuilder builder, StringOffset sourceDLOffset) { builder.AddOffset(98, sourceDLOffset.Value, 0); }
  public static Offset<StateVector_Full> EndStateVector_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<StateVector_Full>(o);
  }
  public static void FinishStateVector_FullBuffer(FlatBufferBuilder builder, Offset<StateVector_Full> offset) { builder.Finish(offset.Value, "STAT"); }
  public static void FinishSizePrefixedStateVector_FullBuffer(FlatBufferBuilder builder, Offset<StateVector_Full> offset) { builder.FinishSizePrefixed(offset.Value, "STAT"); }
  public StateVector_FullT UnPack() {
    var _o = new StateVector_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(StateVector_FullT _o) {
  ...
  public static Offset<StateVector_Full> Pack(FlatBufferBuilder builder, StateVector_FullT _o) {
    if (_o == null) return default(Offset<StateVector_Full>);
...
public class StateVector_FullT
{
  ...
  public StateVector_Full_referenceFrame_Enum ReferenceFrame { get; set; }
  public List<string> Cov { get; set; }
  public StateVector_Full_covReferenceFrame_Enum CovReferenceFrame { get; set; }
  ...
  public StateVector_Full_dataMode_Enum DataMode { get; set; }
  public List<string> Tags { get; set; }
  public string Algorithm { get; set; }
  public List<string> SourcedData { get; set; }
  public StateVector_Full_sourcedDataTypes_Enum SourcedDataTypes { get; set; }
  ...
  public StateVector_FullT() {
    ...
    this.Yvel = 0.0;
    this.Zvel = 0.0;
    this.ReferenceFrame = StateVector_Full_referenceFrame_Enum.J2000;
    this.Cov = null;
    this.CovReferenceFrame = StateVector_Full_covReferenceFrame_Enum.J2000;
    this.CovMethod = null;
    this.EqCov = null;
    this.XposAlt1 = 0.0;
    this.YposAlt1 = 0.0;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = StateVector_Full_dataMode_Enum.REAL;
    this.Tags = null;
    this.Algorithm = null;
    this.SourcedData = null;
    this.SourcedDataTypes = StateVector_Full_sourcedDataTypes_Enum.EO;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.OnOrbit = null;
  ...
  public static StateVector_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return StateVector_Full.GetRootAsStateVector_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    StateVector_Full.FinishStateVector_FullBuffer(fbb, StateVector_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class StateVector_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 34 /*ReferenceFrame*/, 1 /*StateVector_Full_referenceFrame_Enum*/, 1, false)
      && verifier.VerifyVectorOfStrings(tablePos, 36 /*Cov*/, false)
      && verifier.VerifyField(tablePos, 38 /*CovReferenceFrame*/, 1 /*StateVector_Full_covReferenceFrame_Enum*/, 1, false)
      ...
      && verifier.VerifyString(tablePos, 168 /*EffectiveFrom*/, false)
      && verifier.VerifyString(tablePos, 170 /*EffectiveUntil*/, false)
      && verifier.VerifyString(tablePos, 172 /*RawFileURI*/, false)
      && verifier.VerifyString(tablePos, 174 /*Source*/, false)
      && verifier.VerifyString(tablePos, 176 /*Origin*/, false)
      && verifier.VerifyField(tablePos, 178 /*DataMode*/, 1 /*StateVector_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyVectorOfStrings(tablePos, 180 /*Tags*/, false)
      && verifier.VerifyString(tablePos, 182 /*Algorithm*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 184 /*SourcedData*/, false)
      && verifier.VerifyField(tablePos, 186 /*SourcedDataTypes*/, 1 /*StateVector_Full_sourcedDataTypes_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 188 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 190 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 192 /*OnOrbit*/, false)
      && verifier.VerifyString(tablePos, 194 /*Descriptor*/, false)
      && verifier.VerifyString(tablePos, 196 /*TransactionId*/, false)
      && verifier.VerifyString(tablePos, 198 /*OrigNetwork*/, false)
      && verifier.VerifyString(tablePos, 200 /*SourceDL*/, false)
