...
public struct MonoRadar_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static MonoRadar_Full GetRootAsMonoRadar_Full(ByteBuffer _bb, MonoRadar_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool MonoRadar_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MONO"); }
  public static bool VerifyMonoRadar_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MONO", false, MonoRadar_FullVerify.Verify); }
  ...
  public MonoRadar_Full_dataMode_Enum DataMode { get { int o = __p.__offset(142); return o != 0 ? (MonoRadar_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : MonoRadar_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<MonoRadar_Full> CreateMonoRadar_Full(FlatBufferBuilder builder,
      ...
      MonoRadar_Full_dataMode_Enum dataMode = MonoRadar_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, MonoRadar_Full_dataMode_Enum dataMode) { builder.AddSbyte(69, (sbyte)dataMode, 0); }
  ...
  public static Offset<MonoRadar_Full> EndMonoRadar_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<MonoRadar_Full>(o);
  }
  public static void FinishMonoRadar_FullBuffer(FlatBufferBuilder builder, Offset<MonoRadar_Full> offset) { builder.Finish(offset.Value, "MONO"); }
  public static void FinishSizePrefixedMonoRadar_FullBuffer(FlatBufferBuilder builder, Offset<MonoRadar_Full> offset) { builder.FinishSizePrefixed(offset.Value, "MONO"); }
  public MonoRadar_FullT UnPack() {
    var _o = new MonoRadar_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(MonoRadar_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<MonoRadar_Full> Pack(FlatBufferBuilder builder, MonoRadar_FullT _o) {
    if (_o == null) return default(Offset<MonoRadar_Full>);
...
public class MonoRadar_FullT
{
  ...
  public MonoRadar_Full_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string OrigNetwork { get; set; }

  public MonoRadar_FullT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = MonoRadar_Full_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.OrigNetwork = null;
  }
  public static MonoRadar_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return MonoRadar_Full.GetRootAsMonoRadar_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    MonoRadar_Full.FinishMonoRadar_FullBuffer(fbb, MonoRadar_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class MonoRadar_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 142 /*DataMode*/, 1 /*MonoRadar_Full_dataMode_Enum*/, 1, false)
