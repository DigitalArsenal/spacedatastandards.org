...
public struct EvacVitalSignData_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EvacVitalSignData_Ingest GetRootAsEvacVitalSignData_Ingest(ByteBuffer _bb) { return GetRootAsEvacVitalSignData_Ingest(_bb, new EvacVitalSignData_Ingest()); }
  public static EvacVitalSignData_Ingest GetRootAsEvacVitalSignData_Ingest(ByteBuffer _bb, EvacVitalSignData_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EvacVitalSignData_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EVAC"); }
  public static bool VerifyEvacVitalSignData_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EVAC", false, EvacVitalSignData_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EvacVitalSignData_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<EvacVitalSignData_Ingest> CreateEvacVitalSignData_Ingest(FlatBufferBuilder builder,
    ...
    EvacVitalSignData_Ingest.AddVitalSign2(builder, vitalSign2);
    EvacVitalSignData_Ingest.AddVitalSign1(builder, vitalSign1);
    EvacVitalSignData_Ingest.AddTime(builder, timeOffset);
    EvacVitalSignData_Ingest.AddMedConfFactor(builder, medConfFactor);
    EvacVitalSignData_Ingest.AddVitalSign(builder, vitalSignOffset);
    return EvacVitalSignData_Ingest.EndEvacVitalSignData_Ingest(builder);
  }

  public static void StartEvacVitalSignData_Ingest(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<EvacVitalSignData_Ingest> EndEvacVitalSignData_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EvacVitalSignData_Ingest>(o);
  }
  public static void FinishEvacVitalSignData_IngestBuffer(FlatBufferBuilder builder, Offset<EvacVitalSignData_Ingest> offset) { builder.Finish(offset.Value, "EVAC"); }
  public static void FinishSizePrefixedEvacVitalSignData_IngestBuffer(FlatBufferBuilder builder, Offset<EvacVitalSignData_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "EVAC"); }
  public EvacVitalSignData_IngestT UnPack() {
    var _o = new EvacVitalSignData_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EvacVitalSignData_IngestT _o) {
  ...
  public static Offset<EvacVitalSignData_Ingest> Pack(FlatBufferBuilder builder, EvacVitalSignData_IngestT _o) {
    if (_o == null) return default(Offset<EvacVitalSignData_Ingest>);
...
public class EvacVitalSignData_IngestT
{
  ...
  public EvacVitalSignData_IngestT() {
    this.VitalSign = null;
    this.VitalSign1 = 0.0;
    this.VitalSign2 = 0.0;
  ...
  public static EvacVitalSignData_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return EvacVitalSignData_Ingest.GetRootAsEvacVitalSignData_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EvacVitalSignData_Ingest.FinishEvacVitalSignData_IngestBuffer(fbb, EvacVitalSignData_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EvacVitalSignData_IngestVerify
{
