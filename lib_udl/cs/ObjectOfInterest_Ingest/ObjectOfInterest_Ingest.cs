...
public struct ObjectOfInterest_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static ObjectOfInterest_Ingest GetRootAsObjectOfInterest_Ingest(ByteBuffer _bb, ObjectOfInterest_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool ObjectOfInterest_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "OBJE"); }
  public static bool VerifyObjectOfInterest_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("OBJE", false, ObjectOfInterest_IngestVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public ObjectOfInterest_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(90); return o != 0 ? (ObjectOfInterest_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : ObjectOfInterest_Ingest_dataMode_Enum.REAL; } }

  public static Offset<ObjectOfInterest_Ingest> CreateObjectOfInterest_Ingest(FlatBufferBuilder builder,
      ...
      ObjectOfInterest_Ingest_dataMode_Enum dataMode = ObjectOfInterest_Ingest_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, ObjectOfInterest_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(43, (sbyte)dataMode, 0); }
  public static Offset<ObjectOfInterest_Ingest> EndObjectOfInterest_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ObjectOfInterest_Ingest>(o);
  }
  public static void FinishObjectOfInterest_IngestBuffer(FlatBufferBuilder builder, Offset<ObjectOfInterest_Ingest> offset) { builder.Finish(offset.Value, "OBJE"); }
  public static void FinishSizePrefixedObjectOfInterest_IngestBuffer(FlatBufferBuilder builder, Offset<ObjectOfInterest_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "OBJE"); }
  public ObjectOfInterest_IngestT UnPack() {
    var _o = new ObjectOfInterest_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(ObjectOfInterest_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<ObjectOfInterest_Ingest> Pack(FlatBufferBuilder builder, ObjectOfInterest_IngestT _o) {
    if (_o == null) return default(Offset<ObjectOfInterest_Ingest>);
...
public class ObjectOfInterest_IngestT
{
  ...
  public ObjectOfInterest_Ingest_dataMode_Enum DataMode { get; set; }

  public ObjectOfInterest_IngestT() {
    this.Id = null;
    ...
    this.DataMode = ObjectOfInterest_Ingest_dataMode_Enum.REAL;
  }
  public static ObjectOfInterest_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return ObjectOfInterest_Ingest.GetRootAsObjectOfInterest_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    ObjectOfInterest_Ingest.FinishObjectOfInterest_IngestBuffer(fbb, ObjectOfInterest_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class ObjectOfInterest_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 90 /*DataMode*/, 1 /*ObjectOfInterest_Ingest_dataMode_Enum*/, 1, false)
