...
public struct AirTransportMission_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirTransportMission_Full GetRootAsAirTransportMission_Full(ByteBuffer _bb) { return GetRootAsAirTransportMission_Full(_bb, new AirTransportMission_Full()); }
  public static AirTransportMission_Full GetRootAsAirTransportMission_Full(ByteBuffer _bb, AirTransportMission_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirTransportMission_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRT"); }
  public static bool VerifyAirTransportMission_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRT", false, AirTransportMission_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirTransportMission_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public AirTransportMission_Full_dataMode_Enum DataMode { get { int o = __p.__offset(70); return o != 0 ? (AirTransportMission_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirTransportMission_Full_dataMode_Enum.REAL; } }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string AircraftSorties(int j) { int o = __p.__offset(80); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int AircraftSortiesLength { get { int o = __p.__offset(80); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<AirTransportMission_Full> CreateAirTransportMission_Full(FlatBufferBuilder builder,
      ...
      AirTransportMission_Full_dataMode_Enum dataMode = AirTransportMission_Full_dataMode_Enum.REAL,
      ...
      VectorOffset aircraftSortiesOffset = default(VectorOffset)) {
  ...
  public static void StartAirTransportMission_Full(FlatBufferBuilder builder) { builder.StartTable(39); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AirTransportMission_Full_dataMode_Enum dataMode) { builder.AddSbyte(33, (sbyte)dataMode, 0); }
  ...
  public static void AddAircraftSorties(FlatBufferBuilder builder, VectorOffset aircraftSortiesOffset) { builder.AddOffset(38, aircraftSortiesOffset.Value, 0); }
  public static VectorOffset CreateAircraftSortiesVector(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateAircraftSortiesVectorBlock(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateAircraftSortiesVectorBlock(FlatBufferBuilder builder, ArraySegment<StringOffset> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateAircraftSortiesVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<StringOffset>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartAircraftSortiesVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<AirTransportMission_Full> EndAirTransportMission_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirTransportMission_Full>(o);
  }
  public static void FinishAirTransportMission_FullBuffer(FlatBufferBuilder builder, Offset<AirTransportMission_Full> offset) { builder.Finish(offset.Value, "AIRT"); }
  public static void FinishSizePrefixedAirTransportMission_FullBuffer(FlatBufferBuilder builder, Offset<AirTransportMission_Full> offset) { builder.FinishSizePrefixed(offset.Value, "AIRT"); }
  public AirTransportMission_FullT UnPack() {
    var _o = new AirTransportMission_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirTransportMission_FullT _o) {
    _o.Id = this.Id;
    ...
    _o.AircraftSorties = new List<string>();
    for (var _j = 0; _j < this.AircraftSortiesLength; ++_j) {_o.AircraftSorties.Add(this.AircraftSorties(_j));}
  }
  public static Offset<AirTransportMission_Full> Pack(FlatBufferBuilder builder, AirTransportMission_FullT _o) {
    if (_o == null) return default(Offset<AirTransportMission_Full>);
    ...
    var _aircraftSorties = default(VectorOffset);
    if (_o.AircraftSorties != null) {
      var __aircraftSorties = new StringOffset[_o.AircraftSorties.Count];
      for (var _j = 0; _j < __aircraftSorties.Length; ++_j) { __aircraftSorties[_j] = builder.CreateString(_o.AircraftSorties[_j]); }
      _aircraftSorties = CreateAircraftSortiesVector(builder, __aircraftSorties);
    }
...
public class AirTransportMission_FullT
{
  ...
  public AirTransportMission_Full_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }
  public List<string> Requirements { get; set; }
  public List<string> Remarks { get; set; }
  public List<string> HazMat { get; set; }
  public List<string> AircraftSorties { get; set; }

  public AirTransportMission_FullT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = AirTransportMission_Full_dataMode_Enum.REAL;
    this.OrigNetwork = null;
    this.Requirements = null;
    this.Remarks = null;
    this.HazMat = null;
    this.AircraftSorties = null;
  }
  public static AirTransportMission_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return AirTransportMission_Full.GetRootAsAirTransportMission_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirTransportMission_Full.FinishAirTransportMission_FullBuffer(fbb, AirTransportMission_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirTransportMission_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 70 /*DataMode*/, 1 /*AirTransportMission_Full_dataMode_Enum*/, 1, false)
      ...
      && verifier.VerifyVectorOfStrings(tablePos, 80 /*AircraftSorties*/, false)
