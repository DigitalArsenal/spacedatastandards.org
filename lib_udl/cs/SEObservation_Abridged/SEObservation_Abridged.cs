...
public struct SEObservation_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static SEObservation_Abridged GetRootAsSEObservation_Abridged(ByteBuffer _bb, SEObservation_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SEObservation_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SEOB"); }
  public static bool VerifySEObservation_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SEOB", false, SEObservation_AbridgedVerify.Verify); }
  ...
  public static Offset<SEObservation_Abridged> CreateSEObservation_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<SEObservation_Abridged> EndSEObservation_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SEObservation_Abridged>(o);
  }
  public static void FinishSEObservation_AbridgedBuffer(FlatBufferBuilder builder, Offset<SEObservation_Abridged> offset) { builder.Finish(offset.Value, "SEOB"); }
  public static void FinishSizePrefixedSEObservation_AbridgedBuffer(FlatBufferBuilder builder, Offset<SEObservation_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "SEOB"); }
  public SEObservation_AbridgedT UnPack() {
    var _o = new SEObservation_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SEObservation_AbridgedT _o) {
  ...
  public static Offset<SEObservation_Abridged> Pack(FlatBufferBuilder builder, SEObservation_AbridgedT _o) {
    if (_o == null) return default(Offset<SEObservation_Abridged>);
...
public class SEObservation_AbridgedT
{
  ...
  public SEObservation_AbridgedT() {
    this.ObType = null;
    this.ObUoM = null;
    this.ObValue = 0.0;
    this.ObString = null;
  ...
  public static SEObservation_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return SEObservation_Abridged.GetRootAsSEObservation_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SEObservation_Abridged.FinishSEObservation_AbridgedBuffer(fbb, SEObservation_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SEObservation_AbridgedVerify
{
