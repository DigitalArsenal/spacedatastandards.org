...
public struct DiffOfArrival_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static DiffOfArrival_Full GetRootAsDiffOfArrival_Full(ByteBuffer _bb, DiffOfArrival_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DiffOfArrival_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DIFF"); }
  public static bool VerifyDiffOfArrival_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DIFF", false, DiffOfArrival_FullVerify.Verify); }
  ...
  public DiffOfArrival_Full_dataMode_Enum DataMode { get { int o = __p.__offset(72); return o != 0 ? (DiffOfArrival_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : DiffOfArrival_Full_dataMode_Enum.REAL; } }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string OnOrbit { get { int o = __p.__offset(82); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbitBytes() { return __p.__vector_as_span<byte>(82, 1); }
#else
  public ArraySegment<byte>? GetOnOrbitBytes() { return __p.__vector_as_arraysegment(82); }
#endif
  public byte[] GetOnOrbitArray() { return __p.__vector_as_array<byte>(82); }
  /// Optional source-provided and searchable metadata or descriptor of the data.
  /// Example: /// Example: Example descriptor
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Descriptor { get { int o = __p.__offset(84); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetDescriptorBytes() { return __p.__vector_as_span<byte>(84, 1); }
#else
  public ArraySegment<byte>? GetDescriptorBytes() { return __p.__vector_as_arraysegment(84); }
#endif
  public byte[] GetDescriptorArray() { return __p.__vector_as_array<byte>(84); }
  /// Optional identifier to track a commercial or marketplace transaction executed to produce this data.
  /// Example: /// Example: TRANSACTION-ID
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string TransactionId { get { int o = __p.__offset(86); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTransactionIdBytes() { return __p.__vector_as_span<byte>(86, 1); }
#else
  public ArraySegment<byte>? GetTransactionIdBytes() { return __p.__vector_as_arraysegment(86); }
#endif
  public byte[] GetTransactionIdArray() { return __p.__vector_as_array<byte>(86); }
  ...
  /// Example: /// Example: AXE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string SourceDL { get { int o = __p.__offset(90); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceDLBytes() { return __p.__vector_as_span<byte>(90, 1); }
#else
  public ArraySegment<byte>? GetSourceDLBytes() { return __p.__vector_as_arraysegment(90); }
#endif
  public byte[] GetSourceDLArray() { return __p.__vector_as_array<byte>(90); }

  public static Offset<DiffOfArrival_Full> CreateDiffOfArrival_Full(FlatBufferBuilder builder,
      ...
      DiffOfArrival_Full_dataMode_Enum dataMode = DiffOfArrival_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, DiffOfArrival_Full_dataMode_Enum dataMode) { builder.AddSbyte(34, (sbyte)dataMode, 0); }
  ...
  public static void AddOnOrbit(FlatBufferBuilder builder, StringOffset onOrbitOffset) { builder.AddOffset(39, onOrbitOffset.Value, 0); }
  public static void AddDescriptor(FlatBufferBuilder builder, StringOffset descriptorOffset) { builder.AddOffset(40, descriptorOffset.Value, 0); }
  public static void AddTransactionId(FlatBufferBuilder builder, StringOffset transactionIdOffset) { builder.AddOffset(41, transactionIdOffset.Value, 0); }
  ...
  public static void AddSourceDL(FlatBufferBuilder builder, StringOffset sourceDLOffset) { builder.AddOffset(43, sourceDLOffset.Value, 0); }
  public static Offset<DiffOfArrival_Full> EndDiffOfArrival_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DiffOfArrival_Full>(o);
  }
  public static void FinishDiffOfArrival_FullBuffer(FlatBufferBuilder builder, Offset<DiffOfArrival_Full> offset) { builder.Finish(offset.Value, "DIFF"); }
  public static void FinishSizePrefixedDiffOfArrival_FullBuffer(FlatBufferBuilder builder, Offset<DiffOfArrival_Full> offset) { builder.FinishSizePrefixed(offset.Value, "DIFF"); }
  public DiffOfArrival_FullT UnPack() {
    var _o = new DiffOfArrival_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DiffOfArrival_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<DiffOfArrival_Full> Pack(FlatBufferBuilder builder, DiffOfArrival_FullT _o) {
    if (_o == null) return default(Offset<DiffOfArrival_Full>);
...
public class DiffOfArrival_FullT
{
  ...
  public DiffOfArrival_Full_dataMode_Enum DataMode { get; set; }
  ...
  public DiffOfArrival_FullT() {
    ...
    this.Source = null;
    this.DataMode = DiffOfArrival_Full_dataMode_Enum.REAL;
    this.Tags = null;
    this.Origin = null;
    this.CreatedAt = null;
    this.CreatedBy = null;
  ...
  public static DiffOfArrival_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return DiffOfArrival_Full.GetRootAsDiffOfArrival_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DiffOfArrival_Full.FinishDiffOfArrival_FullBuffer(fbb, DiffOfArrival_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DiffOfArrival_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 72 /*DataMode*/, 1 /*DiffOfArrival_Full_dataMode_Enum*/, 1, false)
      ...
      && verifier.VerifyString(tablePos, 82 /*OnOrbit*/, false)
      && verifier.VerifyString(tablePos, 84 /*Descriptor*/, false)
      && verifier.VerifyString(tablePos, 86 /*TransactionId*/, false)
      && verifier.VerifyString(tablePos, 88 /*OrigNetwork*/, false)
      && verifier.VerifyString(tablePos, 90 /*SourceDL*/, false)
