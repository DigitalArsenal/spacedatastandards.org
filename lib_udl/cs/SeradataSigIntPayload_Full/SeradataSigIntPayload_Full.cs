...
public struct SeradataSigIntPayload_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SeradataSigIntPayload_Full GetRootAsSeradataSigIntPayload_Full(ByteBuffer _bb) { return GetRootAsSeradataSigIntPayload_Full(_bb, new SeradataSigIntPayload_Full()); }
  public static SeradataSigIntPayload_Full GetRootAsSeradataSigIntPayload_Full(ByteBuffer _bb, SeradataSigIntPayload_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SeradataSigIntPayload_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SERA"); }
  public static bool VerifySeradataSigIntPayload_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SERA", false, SeradataSigIntPayload_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SeradataSigIntPayload_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SeradataSigIntPayload_Full_dataMode_Enum DataMode { get { int o = __p.__offset(48); return o != 0 ? (SeradataSigIntPayload_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SeradataSigIntPayload_Full_dataMode_Enum.REAL; } }

  public static Offset<SeradataSigIntPayload_Full> CreateSeradataSigIntPayload_Full(FlatBufferBuilder builder,
      ...
      SeradataSigIntPayload_Full_dataMode_Enum dataMode = SeradataSigIntPayload_Full_dataMode_Enum.REAL) {
    builder.StartTable(23);
    SeradataSigIntPayload_Full.AddSwathWidth(builder, swathWidth);
    SeradataSigIntPayload_Full.AddOrigNetwork(builder, origNetworkOffset);
    SeradataSigIntPayload_Full.AddOrigin(builder, originOffset);
    SeradataSigIntPayload_Full.AddSource(builder, sourceOffset);
    SeradataSigIntPayload_Full.AddUpdatedBy(builder, updatedByOffset);
    SeradataSigIntPayload_Full.AddUpdatedAt(builder, updatedAtOffset);
    SeradataSigIntPayload_Full.AddCreatedBy(builder, createdByOffset);
    SeradataSigIntPayload_Full.AddCreatedAt(builder, createdAtOffset);
    SeradataSigIntPayload_Full.AddNotes(builder, notesOffset);
    SeradataSigIntPayload_Full.AddName(builder, nameOffset);
    SeradataSigIntPayload_Full.AddInterceptParameters(builder, interceptParametersOffset);
    SeradataSigIntPayload_Full.AddPositionalAccuracy(builder, positionalAccuracyOffset);
    SeradataSigIntPayload_Full.AddFrequencyCoverage(builder, frequencyCoverageOffset);
    SeradataSigIntPayload_Full.AddGroundStationLocations(builder, groundStationLocationsOffset);
    SeradataSigIntPayload_Full.AddGroundStations(builder, groundStationsOffset);
    SeradataSigIntPayload_Full.AddType(builder, typeOffset);
    SeradataSigIntPayload_Full.AddManufacturerOrgId(builder, manufacturerOrgIdOffset);
    SeradataSigIntPayload_Full.AddHostedForCompanyOrgId(builder, hostedForCompanyOrgIdOffset);
    SeradataSigIntPayload_Full.AddIdSensor(builder, idSensorOffset);
    SeradataSigIntPayload_Full.AddSpacecraftId(builder, spacecraftIdOffset);
    SeradataSigIntPayload_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    SeradataSigIntPayload_Full.AddId(builder, idOffset);
    SeradataSigIntPayload_Full.AddDataMode(builder, dataMode);
    return SeradataSigIntPayload_Full.EndSeradataSigIntPayload_Full(builder);
  }

  public static void StartSeradataSigIntPayload_Full(FlatBufferBuilder builder) { builder.StartTable(23); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SeradataSigIntPayload_Full_dataMode_Enum dataMode) { builder.AddSbyte(22, (sbyte)dataMode, 0); }
  public static Offset<SeradataSigIntPayload_Full> EndSeradataSigIntPayload_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SeradataSigIntPayload_Full>(o);
  }
  public static void FinishSeradataSigIntPayload_FullBuffer(FlatBufferBuilder builder, Offset<SeradataSigIntPayload_Full> offset) { builder.Finish(offset.Value, "SERA"); }
  public static void FinishSizePrefixedSeradataSigIntPayload_FullBuffer(FlatBufferBuilder builder, Offset<SeradataSigIntPayload_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SERA"); }
  public SeradataSigIntPayload_FullT UnPack() {
    var _o = new SeradataSigIntPayload_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SeradataSigIntPayload_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SeradataSigIntPayload_Full> Pack(FlatBufferBuilder builder, SeradataSigIntPayload_FullT _o) {
    if (_o == null) return default(Offset<SeradataSigIntPayload_Full>);
...
public class SeradataSigIntPayload_FullT
{
  ...
  public SeradataSigIntPayload_Full_dataMode_Enum DataMode { get; set; }

  public SeradataSigIntPayload_FullT() {
    this.Id = null;
    ...
    this.DataMode = SeradataSigIntPayload_Full_dataMode_Enum.REAL;
  }
  public static SeradataSigIntPayload_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return SeradataSigIntPayload_Full.GetRootAsSeradataSigIntPayload_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SeradataSigIntPayload_Full.FinishSeradataSigIntPayload_FullBuffer(fbb, SeradataSigIntPayload_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SeradataSigIntPayload_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 48 /*DataMode*/, 1 /*SeradataSigIntPayload_Full_dataMode_Enum*/, 1, false)
