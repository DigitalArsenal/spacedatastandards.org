...
public struct Organization_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Organization_Full GetRootAsOrganization_Full(ByteBuffer _bb) { return GetRootAsOrganization_Full(_bb, new Organization_Full()); }
  public static Organization_Full GetRootAsOrganization_Full(ByteBuffer _bb, Organization_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Organization_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ORGA"); }
  public static bool VerifyOrganization_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ORGA", false, Organization_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Organization_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public Organization_Full_dataMode_Enum DataMode { get { int o = __p.__offset(28); return o != 0 ? (Organization_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Organization_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<Organization_Full> CreateOrganization_Full(FlatBufferBuilder builder,
      ...
      Organization_Full_dataMode_Enum dataMode = Organization_Full_dataMode_Enum.REAL,
  ...
  public static void StartOrganization_Full(FlatBufferBuilder builder) { builder.StartTable(19); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Organization_Full_dataMode_Enum dataMode) { builder.AddSbyte(12, (sbyte)dataMode, 0); }
  ...
  public static Offset<Organization_Full> EndOrganization_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Organization_Full>(o);
  }
  public static void FinishOrganization_FullBuffer(FlatBufferBuilder builder, Offset<Organization_Full> offset) { builder.Finish(offset.Value, "ORGA"); }
  public static void FinishSizePrefixedOrganization_FullBuffer(FlatBufferBuilder builder, Offset<Organization_Full> offset) { builder.FinishSizePrefixed(offset.Value, "ORGA"); }
  public Organization_FullT UnPack() {
    var _o = new Organization_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Organization_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Organization_Full> Pack(FlatBufferBuilder builder, Organization_FullT _o) {
    if (_o == null) return default(Offset<Organization_Full>);
    ...
    return CreateOrganization_Full(
      builder,
      _id,
...
public class Organization_FullT
{
  ...
  public Organization_Full_dataMode_Enum DataMode { get; set; }
  ...
  public Organization_FullT() {
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Organization_Full_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.UpdatedAt = null;
    this.UpdatedBy = null;
  ...
  public static Organization_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Organization_Full.GetRootAsOrganization_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Organization_Full.FinishOrganization_FullBuffer(fbb, Organization_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Organization_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*DataMode*/, 1 /*Organization_Full_dataMode_Enum*/, 1, false)
