...
/// /// Injury specifics.
public struct EvacInjury_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static EvacInjury_Abridged GetRootAsEvacInjury_Abridged(ByteBuffer _bb, EvacInjury_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EvacInjury_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EVAC"); }
  public static bool VerifyEvacInjury_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EVAC", false, EvacInjury_AbridgedVerify.Verify); }
  ...
  public static Offset<EvacInjury_Abridged> CreateEvacInjury_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<EvacInjury_Abridged> EndEvacInjury_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EvacInjury_Abridged>(o);
  }
  public static void FinishEvacInjury_AbridgedBuffer(FlatBufferBuilder builder, Offset<EvacInjury_Abridged> offset) { builder.Finish(offset.Value, "EVAC"); }
  public static void FinishSizePrefixedEvacInjury_AbridgedBuffer(FlatBufferBuilder builder, Offset<EvacInjury_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "EVAC"); }
  public EvacInjury_AbridgedT UnPack() {
    var _o = new EvacInjury_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EvacInjury_AbridgedT _o) {
    _o.Type = this.Type;
    _o.BodyPart = this.BodyPart;
    _o.Time = this.Time;
    _o.Comments = this.Comments;
  }
  public static Offset<EvacInjury_Abridged> Pack(FlatBufferBuilder builder, EvacInjury_AbridgedT _o) {
    if (_o == null) return default(Offset<EvacInjury_Abridged>);
...
public class EvacInjury_AbridgedT
{
  ...
  public EvacInjury_AbridgedT() {
    this.Type = null;
    this.BodyPart = null;
    this.Time = null;
    this.Comments = null;
  }
  public static EvacInjury_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return EvacInjury_Abridged.GetRootAsEvacInjury_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EvacInjury_Abridged.FinishEvacInjury_AbridgedBuffer(fbb, EvacInjury_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EvacInjury_AbridgedVerify
{
