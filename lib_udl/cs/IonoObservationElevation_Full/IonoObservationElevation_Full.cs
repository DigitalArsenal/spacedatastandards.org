...
public struct IonoObservationElevation_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationElevation_Full GetRootAsIonoObservationElevation_Full(ByteBuffer _bb) { return GetRootAsIonoObservationElevation_Full(_bb, new IonoObservationElevation_Full()); }
  public static IonoObservationElevation_Full GetRootAsIonoObservationElevation_Full(ByteBuffer _bb, IonoObservationElevation_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationElevation_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationElevation_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationElevation_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationElevation_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationElevation_Full> CreateIonoObservationElevation_Full(FlatBufferBuilder builder,
    ...
    IonoObservationElevation_Full.AddData(builder, dataOffset);
    IonoObservationElevation_Full.AddDimensionName(builder, dimensionNameOffset);
    IonoObservationElevation_Full.AddDimensions(builder, dimensionsOffset);
    IonoObservationElevation_Full.AddNotes(builder, notesOffset);
    return IonoObservationElevation_Full.EndIonoObservationElevation_Full(builder);
  }

  public static void StartIonoObservationElevation_Full(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationElevation_Full> EndIonoObservationElevation_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationElevation_Full>(o);
  }
  public static void FinishIonoObservationElevation_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationElevation_Full> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationElevation_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationElevation_Full> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationElevation_FullT UnPack() {
    var _o = new IonoObservationElevation_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationElevation_FullT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationElevation_Full> Pack(FlatBufferBuilder builder, IonoObservationElevation_FullT _o) {
    if (_o == null) return default(Offset<IonoObservationElevation_Full>);
...
public class IonoObservationElevation_FullT
{
  ...
  public IonoObservationElevation_FullT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationElevation_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationElevation_Full.GetRootAsIonoObservationElevation_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationElevation_Full.FinishIonoObservationElevation_FullBuffer(fbb, IonoObservationElevation_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationElevation_FullVerify
{
