...
public struct DiplomaticClearance_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static DiplomaticClearance_Abridged GetRootAsDiplomaticClearance_Abridged(ByteBuffer _bb) { return GetRootAsDiplomaticClearance_Abridged(_bb, new DiplomaticClearance_Abridged()); }
  public static DiplomaticClearance_Abridged GetRootAsDiplomaticClearance_Abridged(ByteBuffer _bb, DiplomaticClearance_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DiplomaticClearance_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DIPL"); }
  public static bool VerifyDiplomaticClearance_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DIPL", false, DiplomaticClearance_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public DiplomaticClearance_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public DiplomaticClearance_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(40); return o != 0 ? (DiplomaticClearance_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : DiplomaticClearance_Abridged_dataMode_Enum.REAL; } }

  public static Offset<DiplomaticClearance_Abridged> CreateDiplomaticClearance_Abridged(FlatBufferBuilder builder,
      ...
      DiplomaticClearance_Abridged_dataMode_Enum dataMode = DiplomaticClearance_Abridged_dataMode_Enum.REAL) {
  ...
  public static void StartDiplomaticClearance_Abridged(FlatBufferBuilder builder) { builder.StartTable(19); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, DiplomaticClearance_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(18, (sbyte)dataMode, 0); }
  public static Offset<DiplomaticClearance_Abridged> EndDiplomaticClearance_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DiplomaticClearance_Abridged>(o);
  }
  public static void FinishDiplomaticClearance_AbridgedBuffer(FlatBufferBuilder builder, Offset<DiplomaticClearance_Abridged> offset) { builder.Finish(offset.Value, "DIPL"); }
  public static void FinishSizePrefixedDiplomaticClearance_AbridgedBuffer(FlatBufferBuilder builder, Offset<DiplomaticClearance_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "DIPL"); }
  public DiplomaticClearance_AbridgedT UnPack() {
    var _o = new DiplomaticClearance_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DiplomaticClearance_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<DiplomaticClearance_Abridged> Pack(FlatBufferBuilder builder, DiplomaticClearance_AbridgedT _o) {
    if (_o == null) return default(Offset<DiplomaticClearance_Abridged>);
...
public class DiplomaticClearance_AbridgedT
{
  ...
  public DiplomaticClearance_Abridged_dataMode_Enum DataMode { get; set; }

  public DiplomaticClearance_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = DiplomaticClearance_Abridged_dataMode_Enum.REAL;
  }
  public static DiplomaticClearance_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return DiplomaticClearance_Abridged.GetRootAsDiplomaticClearance_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DiplomaticClearance_Abridged.FinishDiplomaticClearance_AbridgedBuffer(fbb, DiplomaticClearance_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DiplomaticClearance_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 40 /*DataMode*/, 1 /*DiplomaticClearance_Abridged_dataMode_Enum*/, 1, false)
