...
public struct AttitudeSet_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AttitudeSet_Ingest GetRootAsAttitudeSet_Ingest(ByteBuffer _bb) { return GetRootAsAttitudeSet_Ingest(_bb, new AttitudeSet_Ingest()); }
  public static AttitudeSet_Ingest GetRootAsAttitudeSet_Ingest(ByteBuffer _bb, AttitudeSet_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AttitudeSet_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ATTI"); }
  public static bool VerifyAttitudeSet_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ATTI", false, AttitudeSet_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AttitudeSet_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public AttitudeSet_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(58); return o != 0 ? (AttitudeSet_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AttitudeSet_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<AttitudeSet_Ingest> CreateAttitudeSet_Ingest(FlatBufferBuilder builder,
      ...
      AttitudeSet_Ingest_dataMode_Enum dataMode = AttitudeSet_Ingest_dataMode_Enum.REAL,
  ...
  public static void StartAttitudeSet_Ingest(FlatBufferBuilder builder) { builder.StartTable(29); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AttitudeSet_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(27, (sbyte)dataMode, 0); }
  ...
  public static Offset<AttitudeSet_Ingest> EndAttitudeSet_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AttitudeSet_Ingest>(o);
  }
  public static void FinishAttitudeSet_IngestBuffer(FlatBufferBuilder builder, Offset<AttitudeSet_Ingest> offset) { builder.Finish(offset.Value, "ATTI"); }
  public static void FinishSizePrefixedAttitudeSet_IngestBuffer(FlatBufferBuilder builder, Offset<AttitudeSet_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "ATTI"); }
  public AttitudeSet_IngestT UnPack() {
    var _o = new AttitudeSet_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AttitudeSet_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AttitudeSet_Ingest> Pack(FlatBufferBuilder builder, AttitudeSet_IngestT _o) {
    if (_o == null) return default(Offset<AttitudeSet_Ingest>);
...
public class AttitudeSet_IngestT
{
  ...
  public AttitudeSet_Ingest_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public AttitudeSet_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = AttitudeSet_Ingest_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static AttitudeSet_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AttitudeSet_Ingest.GetRootAsAttitudeSet_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AttitudeSet_Ingest.FinishAttitudeSet_IngestBuffer(fbb, AttitudeSet_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AttitudeSet_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 58 /*DataMode*/, 1 /*AttitudeSet_Ingest_dataMode_Enum*/, 1, false)
