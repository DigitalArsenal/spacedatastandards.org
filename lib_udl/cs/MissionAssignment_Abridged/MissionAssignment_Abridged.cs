...
public struct MissionAssignment_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static MissionAssignment_Abridged GetRootAsMissionAssignment_Abridged(ByteBuffer _bb) { return GetRootAsMissionAssignment_Abridged(_bb, new MissionAssignment_Abridged()); }
  public static MissionAssignment_Abridged GetRootAsMissionAssignment_Abridged(ByteBuffer _bb, MissionAssignment_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool MissionAssignment_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MISS"); }
  public static bool VerifyMissionAssignment_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MISS", false, MissionAssignment_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public MissionAssignment_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public MissionAssignment_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(132); return o != 0 ? (MissionAssignment_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : MissionAssignment_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<MissionAssignment_Abridged> CreateMissionAssignment_Abridged(FlatBufferBuilder builder,
      ...
      MissionAssignment_Abridged_dataMode_Enum dataMode = MissionAssignment_Abridged_dataMode_Enum.REAL,
      StringOffset origNetworkOffset = default(StringOffset)) {
    builder.StartTable(66);
    MissionAssignment_Abridged.AddC7elang2(builder, c7elang2);
    MissionAssignment_Abridged.AddC3elv(builder, c3elv);
    MissionAssignment_Abridged.AddC3lon(builder, c3lon);
    MissionAssignment_Abridged.AddC3lat(builder, c3lat);
    MissionAssignment_Abridged.AddLon(builder, lon);
    MissionAssignment_Abridged.AddLat(builder, lat);
    MissionAssignment_Abridged.AddOrigNetwork(builder, origNetworkOffset);
    MissionAssignment_Abridged.AddOrigin(builder, originOffset);
    MissionAssignment_Abridged.AddSource(builder, sourceOffset);
    MissionAssignment_Abridged.AddCreatedBy(builder, createdByOffset);
    MissionAssignment_Abridged.AddCreatedAt(builder, createdAtOffset);
    MissionAssignment_Abridged.AddC7in3p(builder, c7in3p);
    MissionAssignment_Abridged.AddC7tnor(builder, c7tnorOffset);
    MissionAssignment_Abridged.AddC6longpm(builder, c6longpmOffset);
    MissionAssignment_Abridged.AddC6fplpm(builder, c6fplpmOffset);
    MissionAssignment_Abridged.AddC6dspc(builder, c6dspcOffset);
    MissionAssignment_Abridged.AddC6dspct(builder, c6dspctOffset);
    MissionAssignment_Abridged.AddC6tnr3(builder, c6tnr3);
    MissionAssignment_Abridged.AddC6intel(builder, c6intel);
    MissionAssignment_Abridged.AddC6laser(builder, c6laser);
    MissionAssignment_Abridged.AddC5colon(builder, c5colon);
    MissionAssignment_Abridged.AddC5elevationlsbs(builder, c5elevationlsbs);
    MissionAssignment_Abridged.AddC5lonlsb(builder, c5lonlsb);
    MissionAssignment_Abridged.AddC5latlsb(builder, c5latlsb);
    MissionAssignment_Abridged.AddC5tgtbrng(builder, c5tgtbrng);
    MissionAssignment_Abridged.AddC5tw(builder, c5tw);
    MissionAssignment_Abridged.AddC5haeadj(builder, c5haeadj);
    MissionAssignment_Abridged.AddC4mod(builder, c4mod);
    MissionAssignment_Abridged.AddC4colon(builder, c4colon);
    MissionAssignment_Abridged.AddC4tm(builder, c4tm);
    MissionAssignment_Abridged.AddC4timediscrete(builder, c4timediscreteOffset);
    MissionAssignment_Abridged.AddC4typeofstores(builder, c4typeofstores);
    MissionAssignment_Abridged.AddC4numberofstores(builder, c4numberofstores);
    MissionAssignment_Abridged.AddC4egress(builder, c4egress);
    MissionAssignment_Abridged.AddC4runin(builder, c4runin);
    MissionAssignment_Abridged.AddC4def(builder, c4defOffset);
    MissionAssignment_Abridged.AddC4tgt(builder, c4tgtOffset);
    MissionAssignment_Abridged.AddC3ptnum(builder, c3ptnumOffset);
    MissionAssignment_Abridged.AddC3ptl(builder, c3ptlOffset);
    MissionAssignment_Abridged.AddC2exercisemof(builder, c2exercisemofOffset);
    MissionAssignment_Abridged.AddC2exerciseindicator(builder, c2exerciseindicatorOffset);
    MissionAssignment_Abridged.AddC2specialinterestindicator(builder, c2specialinterestindicatorOffset);
    MissionAssignment_Abridged.AddC2spd(builder, c2spd);
    MissionAssignment_Abridged.AddC2crs(builder, c2crs);
    MissionAssignment_Abridged.AddC2alt(builder, c2alt);
    MissionAssignment_Abridged.AddC2idamplifyingdescriptor(builder, c2idamplifyingdescriptorOffset);
    MissionAssignment_Abridged.AddC2id(builder, c2idOffset);
    MissionAssignment_Abridged.AddC2lnd(builder, c2lndOffset);
    MissionAssignment_Abridged.AddC2sur(builder, c2surOffset);
    MissionAssignment_Abridged.AddC2air(builder, c2airOffset);
    MissionAssignment_Abridged.AddC2spc(builder, c2spcOffset);
    MissionAssignment_Abridged.AddC1associateddmpis(builder, c1associateddmpis);
    MissionAssignment_Abridged.AddIndex(builder, index);
    MissionAssignment_Abridged.AddSz(builder, szOffset);
    MissionAssignment_Abridged.AddEnv(builder, envOffset);
    MissionAssignment_Abridged.AddOrginx(builder, orginxOffset);
    MissionAssignment_Abridged.AddTwenv(builder, twenvOffset);
    MissionAssignment_Abridged.AddTno(builder, tnoOffset);
    MissionAssignment_Abridged.AddRr(builder, rr);
    MissionAssignment_Abridged.AddRc(builder, rcOffset);
    MissionAssignment_Abridged.AddMad(builder, madOffset);
    MissionAssignment_Abridged.AddTs(builder, tsOffset);
    MissionAssignment_Abridged.AddTrkId(builder, trkIdOffset);
    MissionAssignment_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    MissionAssignment_Abridged.AddId(builder, idOffset);
    MissionAssignment_Abridged.AddDataMode(builder, dataMode);
    return MissionAssignment_Abridged.EndMissionAssignment_Abridged(builder);
  }

  public static void StartMissionAssignment_Abridged(FlatBufferBuilder builder) { builder.StartTable(66); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, MissionAssignment_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(64, (sbyte)dataMode, 0); }
  ...
  public static Offset<MissionAssignment_Abridged> EndMissionAssignment_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<MissionAssignment_Abridged>(o);
  }
  public static void FinishMissionAssignment_AbridgedBuffer(FlatBufferBuilder builder, Offset<MissionAssignment_Abridged> offset) { builder.Finish(offset.Value, "MISS"); }
  public static void FinishSizePrefixedMissionAssignment_AbridgedBuffer(FlatBufferBuilder builder, Offset<MissionAssignment_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "MISS"); }
  public MissionAssignment_AbridgedT UnPack() {
    var _o = new MissionAssignment_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(MissionAssignment_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<MissionAssignment_Abridged> Pack(FlatBufferBuilder builder, MissionAssignment_AbridgedT _o) {
    if (_o == null) return default(Offset<MissionAssignment_Abridged>);
...
public class MissionAssignment_AbridgedT
{
  ...
  public MissionAssignment_Abridged_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public MissionAssignment_AbridgedT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = MissionAssignment_Abridged_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static MissionAssignment_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return MissionAssignment_Abridged.GetRootAsMissionAssignment_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    MissionAssignment_Abridged.FinishMissionAssignment_AbridgedBuffer(fbb, MissionAssignment_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class MissionAssignment_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 132 /*DataMode*/, 1 /*MissionAssignment_Abridged_dataMode_Enum*/, 1, false)
