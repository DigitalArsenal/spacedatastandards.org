...
public struct Hazard_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Hazard_Ingest GetRootAsHazard_Ingest(ByteBuffer _bb) { return GetRootAsHazard_Ingest(_bb, new Hazard_Ingest()); }
  public static Hazard_Ingest GetRootAsHazard_Ingest(ByteBuffer _bb, Hazard_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Hazard_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "HAZA"); }
  public static bool VerifyHazard_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("HAZA", false, Hazard_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Hazard_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Hazard_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(82); return o != 0 ? (Hazard_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Hazard_Ingest_dataMode_Enum.REAL; } }

  public static Offset<Hazard_Ingest> CreateHazard_Ingest(FlatBufferBuilder builder,
      ...
      Hazard_Ingest_dataMode_Enum dataMode = Hazard_Ingest_dataMode_Enum.REAL) {
  ...
  public static void StartHazard_Ingest(FlatBufferBuilder builder) { builder.StartTable(40); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Hazard_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(39, (sbyte)dataMode, 0); }
  public static Offset<Hazard_Ingest> EndHazard_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Hazard_Ingest>(o);
  }
  public static void FinishHazard_IngestBuffer(FlatBufferBuilder builder, Offset<Hazard_Ingest> offset) { builder.Finish(offset.Value, "HAZA"); }
  public static void FinishSizePrefixedHazard_IngestBuffer(FlatBufferBuilder builder, Offset<Hazard_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "HAZA"); }
  public Hazard_IngestT UnPack() {
    var _o = new Hazard_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Hazard_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Hazard_Ingest> Pack(FlatBufferBuilder builder, Hazard_IngestT _o) {
    if (_o == null) return default(Offset<Hazard_Ingest>);
...
public class Hazard_IngestT
{
  ...
  public Hazard_Ingest_dataMode_Enum DataMode { get; set; }

  public Hazard_IngestT() {
    this.Id = null;
    ...
    this.DataMode = Hazard_Ingest_dataMode_Enum.REAL;
  }
  public static Hazard_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Hazard_Ingest.GetRootAsHazard_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Hazard_Ingest.FinishHazard_IngestBuffer(fbb, Hazard_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Hazard_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 82 /*DataMode*/, 1 /*Hazard_Ingest_dataMode_Enum*/, 1, false)
