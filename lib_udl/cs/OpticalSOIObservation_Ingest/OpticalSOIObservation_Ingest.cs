...
public struct OpticalSOIObservation_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static OpticalSOIObservation_Ingest GetRootAsOpticalSOIObservation_Ingest(ByteBuffer _bb, OpticalSOIObservation_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OpticalSOIObservation_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "OPTI"); }
  public static bool VerifyOpticalSOIObservation_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("OPTI", false, OpticalSOIObservation_IngestVerify.Verify); }
  ...
  public static Offset<OpticalSOIObservation_Ingest> CreateOpticalSOIObservation_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<OpticalSOIObservation_Ingest> EndOpticalSOIObservation_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OpticalSOIObservation_Ingest>(o);
  }
  public static void FinishOpticalSOIObservation_IngestBuffer(FlatBufferBuilder builder, Offset<OpticalSOIObservation_Ingest> offset) { builder.Finish(offset.Value, "OPTI"); }
  public static void FinishSizePrefixedOpticalSOIObservation_IngestBuffer(FlatBufferBuilder builder, Offset<OpticalSOIObservation_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "OPTI"); }
  public OpticalSOIObservation_IngestT UnPack() {
    var _o = new OpticalSOIObservation_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OpticalSOIObservation_IngestT _o) {
  ...
  public static Offset<OpticalSOIObservation_Ingest> Pack(FlatBufferBuilder builder, OpticalSOIObservation_IngestT _o) {
    if (_o == null) return default(Offset<OpticalSOIObservation_Ingest>);
...
public class OpticalSOIObservation_IngestT
{
  ...
  public OpticalSOIObservation_IngestT() {
  ...
  public static OpticalSOIObservation_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return OpticalSOIObservation_Ingest.GetRootAsOpticalSOIObservation_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OpticalSOIObservation_Ingest.FinishOpticalSOIObservation_IngestBuffer(fbb, OpticalSOIObservation_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OpticalSOIObservation_IngestVerify
{
