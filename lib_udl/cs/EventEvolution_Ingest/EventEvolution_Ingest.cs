...
public struct EventEvolution_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EventEvolution_Ingest GetRootAsEventEvolution_Ingest(ByteBuffer _bb) { return GetRootAsEventEvolution_Ingest(_bb, new EventEvolution_Ingest()); }
  public static EventEvolution_Ingest GetRootAsEventEvolution_Ingest(ByteBuffer _bb, EventEvolution_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EventEvolution_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EVEN"); }
  public static bool VerifyEventEvolution_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EVEN", false, EventEvolution_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EventEvolution_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: No constraints specified.
  public string Area { get { int o = __p.__offset(36); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAreaBytes() { return __p.__vector_as_span<byte>(36, 1); }
#else
  public ArraySegment<byte>? GetAreaBytes() { return __p.__vector_as_arraysegment(36); }
#endif
  public byte[] GetAreaArray() { return __p.__vector_as_array<byte>(36); }
  /// Geographical region or polygon (lon/lat pairs), as depicted by the Well-Known Text representation of the geometry/geography, of the image as projected on the ground. WKT reference: https://www.opengeospatial.org/standards/wkt-crs. Ignored if included with a POST or PUT request that also specifies a valid 'area' field.
  /// Example: /// Example: POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))
  /// Constraints: No constraints specified.
  public string Atext { get { int o = __p.__offset(38); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAtextBytes() { return __p.__vector_as_span<byte>(38, 1); }
#else
  public ArraySegment<byte>? GetAtextBytes() { return __p.__vector_as_arraysegment(38); }
#endif
  public byte[] GetAtextArray() { return __p.__vector_as_array<byte>(38); }
  /// Geographical region or polygon (lat/lon pairs), as depicted by the GeoJSON representation of the geometry/geography, of the image as projected on the ground. GeoJSON Reference: https://geojson.org/. Ignored if included with a POST or PUT request that also specifies a valid 'area' or 'atext' field.
  /// Example: /// Example: {"type":"Polygon","coordinates":[[[67.3291113966927,26.156175339112],[67.2580009640721,26.091022064271],[67.1795862381682,26.6637992964562],[67.2501237475598,26.730115808233],[67.3291113966927,26.156175339112]]]}
  /// Constraints: No constraints specified.
  public string Agjson { get { int o = __p.__offset(40); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAgjsonBytes() { return __p.__vector_as_span<byte>(40, 1); }
#else
  public ArraySegment<byte>? GetAgjsonBytes() { return __p.__vector_as_arraysegment(40); }
#endif
  public byte[] GetAgjsonArray() { return __p.__vector_as_array<byte>(40); }
  /// Type of region as projected on the ground.
  /// Example: /// Example: POLYGON
  /// Constraints: Minimum length = 0, Maximum length = 128
  public string Atype { get { int o = __p.__offset(42); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAtypeBytes() { return __p.__vector_as_span<byte>(42, 1); }
#else
  public ArraySegment<byte>? GetAtypeBytes() { return __p.__vector_as_arraysegment(42); }
#endif
  public byte[] GetAtypeArray() { return __p.__vector_as_array<byte>(42); }
  /// Number of dimensions of the geometry depicted by region.
  /// Example: /// Example: 2
  /// Constraints: No constraints specified.
  public int Andims { get { int o = __p.__offset(44); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  /// Geographical spatial_ref_sys for region.
  /// Example: /// Example: 4326
  /// Constraints: No constraints specified.
  public int Asrid { get { int o = __p.__offset(46); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  /// List of URLs to before/after images of this point of interest entity.
  /// Example: /// Example: ['URL1', 'URL2']
  /// Constraints: No constraints specified.
  public string Url(int j) { int o = __p.__offset(48); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int UrlLength { get { int o = __p.__offset(48); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Example: /// Example: 2021-12-02T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string CreatedAt { get { int o = __p.__offset(52); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedAtBytes() { return __p.__vector_as_span<byte>(52, 1); }
#else
  public ArraySegment<byte>? GetCreatedAtBytes() { return __p.__vector_as_arraysegment(52); }
#endif
  public byte[] GetCreatedAtArray() { return __p.__vector_as_array<byte>(52); }
  /// Application user who created the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string CreatedBy { get { int o = __p.__offset(54); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedByBytes() { return __p.__vector_as_span<byte>(54, 1); }
#else
  public ArraySegment<byte>? GetCreatedByBytes() { return __p.__vector_as_arraysegment(54); }
#endif
  public byte[] GetCreatedByArray() { return __p.__vector_as_array<byte>(54); }
  /// Source of the data.
  /// Example: /// Example: Bluestaq
  /// Constraints: Minimum length = 1, Maximum length = 36
  public string Source { get { int o = __p.__offset(56); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceBytes() { return __p.__vector_as_span<byte>(56, 1); }
#else
  public ArraySegment<byte>? GetSourceBytes() { return __p.__vector_as_arraysegment(56); }
#endif
  public byte[] GetSourceArray() { return __p.__vector_as_array<byte>(56); }
  /// Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
  /// Example: /// Example: THIRD_PARTY_DATASOURCE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Origin { get { int o = __p.__offset(58); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOriginBytes() { return __p.__vector_as_span<byte>(58, 1); }
#else
  public ArraySegment<byte>? GetOriginBytes() { return __p.__vector_as_arraysegment(58); }
#endif
  public byte[] GetOriginArray() { return __p.__vector_as_array<byte>(58); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public EventEvolution_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(62); return o != 0 ? (EventEvolution_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EventEvolution_Ingest_dataMode_Enum.REAL; } }

  public static Offset<EventEvolution_Ingest> CreateEventEvolution_Ingest(FlatBufferBuilder builder,
      ...
      EventEvolution_Ingest_dataMode_Enum dataMode = EventEvolution_Ingest_dataMode_Enum.REAL) {
    builder.StartTable(30);
    EventEvolution_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    EventEvolution_Ingest.AddOrigin(builder, originOffset);
    EventEvolution_Ingest.AddSource(builder, sourceOffset);
    EventEvolution_Ingest.AddCreatedBy(builder, createdByOffset);
    EventEvolution_Ingest.AddCreatedAt(builder, createdAtOffset);
    EventEvolution_Ingest.AddTags(builder, tagsOffset);
    EventEvolution_Ingest.AddUrl(builder, urlOffset);
    EventEvolution_Ingest.AddAsrid(builder, asrid);
    EventEvolution_Ingest.AddAndims(builder, andims);
    EventEvolution_Ingest.AddAtype(builder, atypeOffset);
    EventEvolution_Ingest.AddAgjson(builder, agjsonOffset);
    EventEvolution_Ingest.AddAtext(builder, atextOffset);
    EventEvolution_Ingest.AddArea(builder, areaOffset);
    EventEvolution_Ingest.AddDataDescription(builder, dataDescriptionOffset);
    EventEvolution_Ingest.AddSrcIds(builder, srcIdsOffset);
    EventEvolution_Ingest.AddSrcTyps(builder, srcTypsOffset);
    EventEvolution_Ingest.AddGeoAdminLevel3(builder, geoAdminLevel3Offset);
    EventEvolution_Ingest.AddGeoAdminLevel2(builder, geoAdminLevel2Offset);
    EventEvolution_Ingest.AddGeoAdminLevel1(builder, geoAdminLevel1Offset);
    EventEvolution_Ingest.AddCountryCode(builder, countryCodeOffset);
    EventEvolution_Ingest.AddStatus(builder, statusOffset);
    EventEvolution_Ingest.AddEndTime(builder, endTimeOffset);
    EventEvolution_Ingest.AddStartTime(builder, startTimeOffset);
    EventEvolution_Ingest.AddSummary(builder, summaryOffset);
    EventEvolution_Ingest.AddCategory(builder, categoryOffset);
    EventEvolution_Ingest.AddEventId(builder, eventIdOffset);
    EventEvolution_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    EventEvolution_Ingest.AddId(builder, idOffset);
    EventEvolution_Ingest.AddDataMode(builder, dataMode);
    EventEvolution_Ingest.AddRedact(builder, redact);
    return EventEvolution_Ingest.EndEventEvolution_Ingest(builder);
  }

  public static void StartEventEvolution_Ingest(FlatBufferBuilder builder) { builder.StartTable(30); }
  ...
  public static void AddArea(FlatBufferBuilder builder, StringOffset areaOffset) { builder.AddOffset(16, areaOffset.Value, 0); }
  public static void AddAtext(FlatBufferBuilder builder, StringOffset atextOffset) { builder.AddOffset(17, atextOffset.Value, 0); }
  public static void AddAgjson(FlatBufferBuilder builder, StringOffset agjsonOffset) { builder.AddOffset(18, agjsonOffset.Value, 0); }
  public static void AddAtype(FlatBufferBuilder builder, StringOffset atypeOffset) { builder.AddOffset(19, atypeOffset.Value, 0); }
  public static void AddAndims(FlatBufferBuilder builder, int andims) { builder.AddInt(20, andims, 0); }
  public static void AddAsrid(FlatBufferBuilder builder, int asrid) { builder.AddInt(21, asrid, 0); }
  public static void AddUrl(FlatBufferBuilder builder, VectorOffset urlOffset) { builder.AddOffset(22, urlOffset.Value, 0); }
  ...
  public static void AddCreatedAt(FlatBufferBuilder builder, StringOffset createdAtOffset) { builder.AddOffset(24, createdAtOffset.Value, 0); }
  public static void AddCreatedBy(FlatBufferBuilder builder, StringOffset createdByOffset) { builder.AddOffset(25, createdByOffset.Value, 0); }
  public static void AddSource(FlatBufferBuilder builder, StringOffset sourceOffset) { builder.AddOffset(26, sourceOffset.Value, 0); }
  public static void AddOrigin(FlatBufferBuilder builder, StringOffset originOffset) { builder.AddOffset(27, originOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, EventEvolution_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(29, (sbyte)dataMode, 0); }
  public static Offset<EventEvolution_Ingest> EndEventEvolution_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EventEvolution_Ingest>(o);
  }
  public static void FinishEventEvolution_IngestBuffer(FlatBufferBuilder builder, Offset<EventEvolution_Ingest> offset) { builder.Finish(offset.Value, "EVEN"); }
  public static void FinishSizePrefixedEventEvolution_IngestBuffer(FlatBufferBuilder builder, Offset<EventEvolution_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "EVEN"); }
  public EventEvolution_IngestT UnPack() {
    var _o = new EventEvolution_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EventEvolution_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<EventEvolution_Ingest> Pack(FlatBufferBuilder builder, EventEvolution_IngestT _o) {
    if (_o == null) return default(Offset<EventEvolution_Ingest>);
    ...
    return CreateEventEvolution_Ingest(
      builder,
      _id,
...
public class EventEvolution_IngestT
{
  ...
  public EventEvolution_Ingest_dataMode_Enum DataMode { get; set; }

  public EventEvolution_IngestT() {
    this.Id = null;
    ...
    this.DataMode = EventEvolution_Ingest_dataMode_Enum.REAL;
  }
  public static EventEvolution_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return EventEvolution_Ingest.GetRootAsEventEvolution_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EventEvolution_Ingest.FinishEventEvolution_IngestBuffer(fbb, EventEvolution_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EventEvolution_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyString(tablePos, 36 /*Area*/, false)
      && verifier.VerifyString(tablePos, 38 /*Atext*/, false)
      && verifier.VerifyString(tablePos, 40 /*Agjson*/, false)
      && verifier.VerifyString(tablePos, 42 /*Atype*/, false)
      && verifier.VerifyField(tablePos, 44 /*Andims*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 46 /*Asrid*/, 4 /*int*/, 4, false)
      && verifier.VerifyVectorOfStrings(tablePos, 48 /*Url*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 50 /*Tags*/, false)
      && verifier.VerifyString(tablePos, 52 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 54 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 56 /*Source*/, false)
      && verifier.VerifyString(tablePos, 58 /*Origin*/, false)
      && verifier.VerifyString(tablePos, 60 /*OrigNetwork*/, false)
      && verifier.VerifyField(tablePos, 62 /*DataMode*/, 1 /*EventEvolution_Ingest_dataMode_Enum*/, 1, false)
