...
public struct PersonnelRecoveryObjectiveAreaInfo_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static PersonnelRecoveryObjectiveAreaInfo_Abridged GetRootAsPersonnelRecoveryObjectiveAreaInfo_Abridged(ByteBuffer _bb, PersonnelRecoveryObjectiveAreaInfo_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool PersonnelRecoveryObjectiveAreaInfo_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "PERS"); }
  public static bool VerifyPersonnelRecoveryObjectiveAreaInfo_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("PERS", false, PersonnelRecoveryObjectiveAreaInfo_AbridgedVerify.Verify); }
  ...
  public static Offset<PersonnelRecoveryObjectiveAreaInfo_Abridged> CreatePersonnelRecoveryObjectiveAreaInfo_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<PersonnelRecoveryObjectiveAreaInfo_Abridged> EndPersonnelRecoveryObjectiveAreaInfo_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PersonnelRecoveryObjectiveAreaInfo_Abridged>(o);
  }
  public static void FinishPersonnelRecoveryObjectiveAreaInfo_AbridgedBuffer(FlatBufferBuilder builder, Offset<PersonnelRecoveryObjectiveAreaInfo_Abridged> offset) { builder.Finish(offset.Value, "PERS"); }
  public static void FinishSizePrefixedPersonnelRecoveryObjectiveAreaInfo_AbridgedBuffer(FlatBufferBuilder builder, Offset<PersonnelRecoveryObjectiveAreaInfo_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "PERS"); }
  public PersonnelRecoveryObjectiveAreaInfo_AbridgedT UnPack() {
    var _o = new PersonnelRecoveryObjectiveAreaInfo_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(PersonnelRecoveryObjectiveAreaInfo_AbridgedT _o) {
  ...
  public static Offset<PersonnelRecoveryObjectiveAreaInfo_Abridged> Pack(FlatBufferBuilder builder, PersonnelRecoveryObjectiveAreaInfo_AbridgedT _o) {
    if (_o == null) return default(Offset<PersonnelRecoveryObjectiveAreaInfo_Abridged>);
...
public class PersonnelRecoveryObjectiveAreaInfo_AbridgedT
{
  ...
  public PersonnelRecoveryObjectiveAreaInfo_AbridgedT() {
  ...
  public static PersonnelRecoveryObjectiveAreaInfo_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return PersonnelRecoveryObjectiveAreaInfo_Abridged.GetRootAsPersonnelRecoveryObjectiveAreaInfo_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    PersonnelRecoveryObjectiveAreaInfo_Abridged.FinishPersonnelRecoveryObjectiveAreaInfo_AbridgedBuffer(fbb, PersonnelRecoveryObjectiveAreaInfo_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class PersonnelRecoveryObjectiveAreaInfo_AbridgedVerify
{
