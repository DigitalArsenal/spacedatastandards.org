...
public struct ItemTracking_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static ItemTracking_Abridged GetRootAsItemTracking_Abridged(ByteBuffer _bb) { return GetRootAsItemTracking_Abridged(_bb, new ItemTracking_Abridged()); }
  public static ItemTracking_Abridged GetRootAsItemTracking_Abridged(ByteBuffer _bb, ItemTracking_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool ItemTracking_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ITEM"); }
  public static bool VerifyItemTracking_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ITEM", false, ItemTracking_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ItemTracking_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public ItemTracking_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(46); return o != 0 ? (ItemTracking_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : ItemTracking_Abridged_dataMode_Enum.REAL; } }

  public static Offset<ItemTracking_Abridged> CreateItemTracking_Abridged(FlatBufferBuilder builder,
      ...
      ItemTracking_Abridged_dataMode_Enum dataMode = ItemTracking_Abridged_dataMode_Enum.REAL) {
    builder.StartTable(22);
    ItemTracking_Abridged.AddLon(builder, lon);
    ItemTracking_Abridged.AddLat(builder, lat);
    ItemTracking_Abridged.AddOrigNetwork(builder, origNetworkOffset);
    ItemTracking_Abridged.AddOrigin(builder, originOffset);
    ItemTracking_Abridged.AddSource(builder, sourceOffset);
    ItemTracking_Abridged.AddSourceDL(builder, sourceDLOffset);
    ItemTracking_Abridged.AddCreatedBy(builder, createdByOffset);
    ItemTracking_Abridged.AddCreatedAt(builder, createdAtOffset);
    ItemTracking_Abridged.AddValues(builder, valuesOffset);
    ItemTracking_Abridged.AddKeys(builder, keysOffset);
    ItemTracking_Abridged.AddNotes(builder, notesOffset);
    ItemTracking_Abridged.AddDvCode(builder, dvCodeOffset);
    ItemTracking_Abridged.AddScanType(builder, scanTypeOffset);
    ItemTracking_Abridged.AddType(builder, typeOffset);
    ItemTracking_Abridged.AddIdItem(builder, idItemOffset);
    ItemTracking_Abridged.AddTs(builder, tsOffset);
    ItemTracking_Abridged.AddScannerId(builder, scannerIdOffset);
    ItemTracking_Abridged.AddScGenTool(builder, scGenToolOffset);
    ItemTracking_Abridged.AddScanCode(builder, scanCodeOffset);
    ItemTracking_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    ItemTracking_Abridged.AddId(builder, idOffset);
    ItemTracking_Abridged.AddDataMode(builder, dataMode);
    return ItemTracking_Abridged.EndItemTracking_Abridged(builder);
  }

  public static void StartItemTracking_Abridged(FlatBufferBuilder builder) { builder.StartTable(22); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, ItemTracking_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(21, (sbyte)dataMode, 0); }
  public static Offset<ItemTracking_Abridged> EndItemTracking_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ItemTracking_Abridged>(o);
  }
  public static void FinishItemTracking_AbridgedBuffer(FlatBufferBuilder builder, Offset<ItemTracking_Abridged> offset) { builder.Finish(offset.Value, "ITEM"); }
  public static void FinishSizePrefixedItemTracking_AbridgedBuffer(FlatBufferBuilder builder, Offset<ItemTracking_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "ITEM"); }
  public ItemTracking_AbridgedT UnPack() {
    var _o = new ItemTracking_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(ItemTracking_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<ItemTracking_Abridged> Pack(FlatBufferBuilder builder, ItemTracking_AbridgedT _o) {
    if (_o == null) return default(Offset<ItemTracking_Abridged>);
...
public class ItemTracking_AbridgedT
{
  ...
  public ItemTracking_Abridged_dataMode_Enum DataMode { get; set; }

  public ItemTracking_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = ItemTracking_Abridged_dataMode_Enum.REAL;
  }
  public static ItemTracking_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return ItemTracking_Abridged.GetRootAsItemTracking_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    ItemTracking_Abridged.FinishItemTracking_AbridgedBuffer(fbb, ItemTracking_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class ItemTracking_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 46 /*DataMode*/, 1 /*ItemTracking_Abridged_dataMode_Enum*/, 1, false)
