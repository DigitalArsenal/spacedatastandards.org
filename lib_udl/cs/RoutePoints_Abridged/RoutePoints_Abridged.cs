...
public struct RoutePoints_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static RoutePoints_Abridged GetRootAsRoutePoints_Abridged(ByteBuffer _bb) { return GetRootAsRoutePoints_Abridged(_bb, new RoutePoints_Abridged()); }
  public static RoutePoints_Abridged GetRootAsRoutePoints_Abridged(ByteBuffer _bb, RoutePoints_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool RoutePoints_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ROUT"); }
  public static bool VerifyRoutePoints_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ROUT", false, RoutePoints_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public RoutePoints_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<RoutePoints_Abridged> CreateRoutePoints_Abridged(FlatBufferBuilder builder,
      int ptSequenceId = 0,
  ...
  public static void StartRoutePoints_Abridged(FlatBufferBuilder builder) { builder.StartTable(13); }
  ...
  public static Offset<RoutePoints_Abridged> EndRoutePoints_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RoutePoints_Abridged>(o);
  }
  public static void FinishRoutePoints_AbridgedBuffer(FlatBufferBuilder builder, Offset<RoutePoints_Abridged> offset) { builder.Finish(offset.Value, "ROUT"); }
  public static void FinishSizePrefixedRoutePoints_AbridgedBuffer(FlatBufferBuilder builder, Offset<RoutePoints_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "ROUT"); }
  public RoutePoints_AbridgedT UnPack() {
    var _o = new RoutePoints_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RoutePoints_AbridgedT _o) {
  ...
  public static Offset<RoutePoints_Abridged> Pack(FlatBufferBuilder builder, RoutePoints_AbridgedT _o) {
    if (_o == null) return default(Offset<RoutePoints_Abridged>);
...
public class RoutePoints_AbridgedT
{
  ...
  public static RoutePoints_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return RoutePoints_Abridged.GetRootAsRoutePoints_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    RoutePoints_Abridged.FinishRoutePoints_AbridgedBuffer(fbb, RoutePoints_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class RoutePoints_AbridgedVerify
{
