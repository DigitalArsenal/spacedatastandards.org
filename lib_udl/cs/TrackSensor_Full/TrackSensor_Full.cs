...
public struct TrackSensor_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static TrackSensor_Full GetRootAsTrackSensor_Full(ByteBuffer _bb, TrackSensor_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool TrackSensor_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "TRAC"); }
  public static bool VerifyTrackSensor_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("TRAC", false, TrackSensor_FullVerify.Verify); }
  ...
  public TrackSensor_Full_sensorFOVType_Enum SensorFOVType { get { int o = __p.__offset(16); return o != 0 ? (TrackSensor_Full_sensorFOVType_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : TrackSensor_Full_sensorFOVType_Enum.BUTTERFLY; } }

  public static Offset<TrackSensor_Full> CreateTrackSensor_Full(FlatBufferBuilder builder,
      double range = 0.0,
      double az = 0.0,
      int sensorNumber = 0,
      ...
      TrackSensor_Full_sensorFOVType_Enum sensorFOVType = TrackSensor_Full_sensorFOVType_Enum.BUTTERFLY) {
  ...
  public static void AddSensorFOVType(FlatBufferBuilder builder, TrackSensor_Full_sensorFOVType_Enum sensorFOVType) { builder.AddSbyte(6, (sbyte)sensorFOVType, 0); }
  public static Offset<TrackSensor_Full> EndTrackSensor_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<TrackSensor_Full>(o);
  }
  public static void FinishTrackSensor_FullBuffer(FlatBufferBuilder builder, Offset<TrackSensor_Full> offset) { builder.Finish(offset.Value, "TRAC"); }
  public static void FinishSizePrefixedTrackSensor_FullBuffer(FlatBufferBuilder builder, Offset<TrackSensor_Full> offset) { builder.FinishSizePrefixed(offset.Value, "TRAC"); }
  public TrackSensor_FullT UnPack() {
    var _o = new TrackSensor_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(TrackSensor_FullT _o) {
    _o.Range = this.Range;
    _o.Az = this.Az;
  ...
  public static Offset<TrackSensor_Full> Pack(FlatBufferBuilder builder, TrackSensor_FullT _o) {
    if (_o == null) return default(Offset<TrackSensor_Full>);
...
public class TrackSensor_FullT
{
  ...
  public TrackSensor_Full_sensorFOVType_Enum SensorFOVType { get; set; }

  public TrackSensor_FullT() {
    this.Range = 0.0;
    this.Az = 0.0;
    this.SensorNumber = 0;
    ...
    this.SensorFOVType = TrackSensor_Full_sensorFOVType_Enum.BUTTERFLY;
  }
  public static TrackSensor_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return TrackSensor_Full.GetRootAsTrackSensor_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    TrackSensor_Full.FinishTrackSensor_FullBuffer(fbb, TrackSensor_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class TrackSensor_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*SensorFOVType*/, 1 /*TrackSensor_Full_sensorFOVType_Enum*/, 1, false)
