...
public struct AirTaskingOrder_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirTaskingOrder_Ingest GetRootAsAirTaskingOrder_Ingest(ByteBuffer _bb) { return GetRootAsAirTaskingOrder_Ingest(_bb, new AirTaskingOrder_Ingest()); }
  public static AirTaskingOrder_Ingest GetRootAsAirTaskingOrder_Ingest(ByteBuffer _bb, AirTaskingOrder_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirTaskingOrder_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRT"); }
  public static bool VerifyAirTaskingOrder_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRT", false, AirTaskingOrder_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirTaskingOrder_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public AirTaskingOrder_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(46); return o != 0 ? (AirTaskingOrder_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirTaskingOrder_Ingest_dataMode_Enum.REAL; } }

  public static Offset<AirTaskingOrder_Ingest> CreateAirTaskingOrder_Ingest(FlatBufferBuilder builder,
      ...
      AirTaskingOrder_Ingest_dataMode_Enum dataMode = AirTaskingOrder_Ingest_dataMode_Enum.REAL) {
  ...
  public static void StartAirTaskingOrder_Ingest(FlatBufferBuilder builder) { builder.StartTable(22); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AirTaskingOrder_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(21, (sbyte)dataMode, 0); }
  public static Offset<AirTaskingOrder_Ingest> EndAirTaskingOrder_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirTaskingOrder_Ingest>(o);
  }
  public static void FinishAirTaskingOrder_IngestBuffer(FlatBufferBuilder builder, Offset<AirTaskingOrder_Ingest> offset) { builder.Finish(offset.Value, "AIRT"); }
  public static void FinishSizePrefixedAirTaskingOrder_IngestBuffer(FlatBufferBuilder builder, Offset<AirTaskingOrder_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AIRT"); }
  public AirTaskingOrder_IngestT UnPack() {
    var _o = new AirTaskingOrder_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirTaskingOrder_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AirTaskingOrder_Ingest> Pack(FlatBufferBuilder builder, AirTaskingOrder_IngestT _o) {
    if (_o == null) return default(Offset<AirTaskingOrder_Ingest>);
...
public class AirTaskingOrder_IngestT
{
  ...
  public AirTaskingOrder_Ingest_dataMode_Enum DataMode { get; set; }

  public AirTaskingOrder_IngestT() {
    this.Id = null;
    ...
    this.DataMode = AirTaskingOrder_Ingest_dataMode_Enum.REAL;
  }
  public static AirTaskingOrder_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AirTaskingOrder_Ingest.GetRootAsAirTaskingOrder_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirTaskingOrder_Ingest.FinishAirTaskingOrder_IngestBuffer(fbb, AirTaskingOrder_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirTaskingOrder_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 46 /*DataMode*/, 1 /*AirTaskingOrder_Ingest_dataMode_Enum*/, 1, false)
