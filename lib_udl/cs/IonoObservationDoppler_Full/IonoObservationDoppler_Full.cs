...
/// /// Array of Doppler.
public struct IonoObservationDoppler_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationDoppler_Full GetRootAsIonoObservationDoppler_Full(ByteBuffer _bb) { return GetRootAsIonoObservationDoppler_Full(_bb, new IonoObservationDoppler_Full()); }
  public static IonoObservationDoppler_Full GetRootAsIonoObservationDoppler_Full(ByteBuffer _bb, IonoObservationDoppler_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationDoppler_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationDoppler_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationDoppler_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationDoppler_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationDoppler_Full> CreateIonoObservationDoppler_Full(FlatBufferBuilder builder,
    ...
    IonoObservationDoppler_Full.AddData(builder, dataOffset);
    IonoObservationDoppler_Full.AddDimensionName(builder, dimensionNameOffset);
    IonoObservationDoppler_Full.AddDimensions(builder, dimensionsOffset);
    IonoObservationDoppler_Full.AddNotes(builder, notesOffset);
    return IonoObservationDoppler_Full.EndIonoObservationDoppler_Full(builder);
  }

  public static void StartIonoObservationDoppler_Full(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationDoppler_Full> EndIonoObservationDoppler_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationDoppler_Full>(o);
  }
  public static void FinishIonoObservationDoppler_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationDoppler_Full> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationDoppler_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationDoppler_Full> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationDoppler_FullT UnPack() {
    var _o = new IonoObservationDoppler_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationDoppler_FullT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationDoppler_Full> Pack(FlatBufferBuilder builder, IonoObservationDoppler_FullT _o) {
    if (_o == null) return default(Offset<IonoObservationDoppler_Full>);
...
public class IonoObservationDoppler_FullT
{
  ...
  public IonoObservationDoppler_FullT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationDoppler_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationDoppler_Full.GetRootAsIonoObservationDoppler_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationDoppler_Full.FinishIonoObservationDoppler_FullBuffer(fbb, IonoObservationDoppler_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationDoppler_FullVerify
{
