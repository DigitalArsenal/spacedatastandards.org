...
public struct IonoObservationFrequency_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationFrequency_Abridged GetRootAsIonoObservationFrequency_Abridged(ByteBuffer _bb) { return GetRootAsIonoObservationFrequency_Abridged(_bb, new IonoObservationFrequency_Abridged()); }
  public static IonoObservationFrequency_Abridged GetRootAsIonoObservationFrequency_Abridged(ByteBuffer _bb, IonoObservationFrequency_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationFrequency_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationFrequency_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationFrequency_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationFrequency_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationFrequency_Abridged> CreateIonoObservationFrequency_Abridged(FlatBufferBuilder builder,
    ...
    IonoObservationFrequency_Abridged.AddData(builder, dataOffset);
    IonoObservationFrequency_Abridged.AddDimensionName(builder, dimensionNameOffset);
    IonoObservationFrequency_Abridged.AddDimensions(builder, dimensionsOffset);
    IonoObservationFrequency_Abridged.AddNotes(builder, notesOffset);
    return IonoObservationFrequency_Abridged.EndIonoObservationFrequency_Abridged(builder);
  }

  public static void StartIonoObservationFrequency_Abridged(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationFrequency_Abridged> EndIonoObservationFrequency_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationFrequency_Abridged>(o);
  }
  public static void FinishIonoObservationFrequency_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationFrequency_Abridged> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationFrequency_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationFrequency_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationFrequency_AbridgedT UnPack() {
    var _o = new IonoObservationFrequency_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationFrequency_AbridgedT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationFrequency_Abridged> Pack(FlatBufferBuilder builder, IonoObservationFrequency_AbridgedT _o) {
    if (_o == null) return default(Offset<IonoObservationFrequency_Abridged>);
    ...
    return CreateIonoObservationFrequency_Abridged(
      builder,
      _notes,
      _dimensions,
      _dimensionName,
...
public class IonoObservationFrequency_AbridgedT
{
  ...
  public IonoObservationFrequency_AbridgedT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationFrequency_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationFrequency_Abridged.GetRootAsIonoObservationFrequency_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationFrequency_Abridged.FinishIonoObservationFrequency_AbridgedBuffer(fbb, IonoObservationFrequency_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationFrequency_AbridgedVerify
{
