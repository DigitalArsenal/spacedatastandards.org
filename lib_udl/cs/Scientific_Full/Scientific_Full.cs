...
public struct Scientific_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Scientific_Full GetRootAsScientific_Full(ByteBuffer _bb) { return GetRootAsScientific_Full(_bb, new Scientific_Full()); }
  public static Scientific_Full GetRootAsScientific_Full(ByteBuffer _bb, Scientific_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Scientific_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SCIE"); }
  public static bool VerifyScientific_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SCIE", false, Scientific_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Scientific_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Scientific_Full_dataMode_Enum DataMode { get { int o = __p.__offset(36); return o != 0 ? (Scientific_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Scientific_Full_dataMode_Enum.REAL; } }
  /// ID of the parent entity for this Scientific.
  /// Example: /// Example: 0167f577-e06c-358e-85aa-0a07a730bdd0
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string IdEntity { get { int o = __p.__offset(38); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetIdEntityBytes() { return __p.__vector_as_span<byte>(38, 1); }
#else
  public ArraySegment<byte>? GetIdEntityBytes() { return __p.__vector_as_arraysegment(38); }
#endif
  public byte[] GetIdEntityArray() { return __p.__vector_as_array<byte>(38); }
  ...
  public static Offset<Scientific_Full> CreateScientific_Full(FlatBufferBuilder builder,
      ...
      Scientific_Full_dataMode_Enum dataMode = Scientific_Full_dataMode_Enum.REAL,
  ...
  public static void StartScientific_Full(FlatBufferBuilder builder) { builder.StartTable(19); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Scientific_Full_dataMode_Enum dataMode) { builder.AddSbyte(16, (sbyte)dataMode, 0); }
  public static void AddIdEntity(FlatBufferBuilder builder, StringOffset idEntityOffset) { builder.AddOffset(17, idEntityOffset.Value, 0); }
  ...
  public static Offset<Scientific_Full> EndScientific_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Scientific_Full>(o);
  }
  public static void FinishScientific_FullBuffer(FlatBufferBuilder builder, Offset<Scientific_Full> offset) { builder.Finish(offset.Value, "SCIE"); }
  public static void FinishSizePrefixedScientific_FullBuffer(FlatBufferBuilder builder, Offset<Scientific_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SCIE"); }
  public Scientific_FullT UnPack() {
    var _o = new Scientific_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Scientific_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Scientific_Full> Pack(FlatBufferBuilder builder, Scientific_FullT _o) {
    if (_o == null) return default(Offset<Scientific_Full>);
...
public class Scientific_FullT
{
  ...
  public Scientific_Full_dataMode_Enum DataMode { get; set; }
  public string IdEntity { get; set; }
  public string Entity { get; set; }

  public Scientific_FullT() {
    this.Id = null;
    ...
    this.DataMode = Scientific_Full_dataMode_Enum.REAL;
    this.IdEntity = null;
    this.Entity = null;
  }
  public static Scientific_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Scientific_Full.GetRootAsScientific_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Scientific_Full.FinishScientific_FullBuffer(fbb, Scientific_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Scientific_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 36 /*DataMode*/, 1 /*Scientific_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 38 /*IdEntity*/, false)
