...
public struct SensorPlan_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SensorPlan_Abridged GetRootAsSensorPlan_Abridged(ByteBuffer _bb) { return GetRootAsSensorPlan_Abridged(_bb, new SensorPlan_Abridged()); }
  public static SensorPlan_Abridged GetRootAsSensorPlan_Abridged(ByteBuffer _bb, SensorPlan_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SensorPlan_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SENS"); }
  public static bool VerifySensorPlan_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SENS", false, SensorPlan_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SensorPlan_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public SensorPlan_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(40); return o != 0 ? (SensorPlan_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SensorPlan_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<SensorPlan_Abridged> CreateSensorPlan_Abridged(FlatBufferBuilder builder,
      ...
      SensorPlan_Abridged_dataMode_Enum dataMode = SensorPlan_Abridged_dataMode_Enum.REAL,
  ...
  public static void StartSensorPlan_Abridged(FlatBufferBuilder builder) { builder.StartTable(20); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SensorPlan_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(18, (sbyte)dataMode, 0); }
  ...
  public static Offset<SensorPlan_Abridged> EndSensorPlan_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SensorPlan_Abridged>(o);
  }
  public static void FinishSensorPlan_AbridgedBuffer(FlatBufferBuilder builder, Offset<SensorPlan_Abridged> offset) { builder.Finish(offset.Value, "SENS"); }
  public static void FinishSizePrefixedSensorPlan_AbridgedBuffer(FlatBufferBuilder builder, Offset<SensorPlan_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "SENS"); }
  public SensorPlan_AbridgedT UnPack() {
    var _o = new SensorPlan_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SensorPlan_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SensorPlan_Abridged> Pack(FlatBufferBuilder builder, SensorPlan_AbridgedT _o) {
    if (_o == null) return default(Offset<SensorPlan_Abridged>);
...
public class SensorPlan_AbridgedT
{
  ...
  public SensorPlan_Abridged_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public SensorPlan_AbridgedT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = SensorPlan_Abridged_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static SensorPlan_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return SensorPlan_Abridged.GetRootAsSensorPlan_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SensorPlan_Abridged.FinishSensorPlan_AbridgedBuffer(fbb, SensorPlan_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SensorPlan_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 40 /*DataMode*/, 1 /*SensorPlan_Abridged_dataMode_Enum*/, 1, false)
