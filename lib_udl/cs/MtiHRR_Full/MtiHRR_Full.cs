...
public struct MtiHRR_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static MtiHRR_Full GetRootAsMtiHRR_Full(ByteBuffer _bb) { return GetRootAsMtiHRR_Full(_bb, new MtiHRR_Full()); }
  public static MtiHRR_Full GetRootAsMtiHRR_Full(ByteBuffer _bb, MtiHRR_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool MtiHRR_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MTIH"); }
  public static bool VerifyMtiHRR_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MTIH", false, MtiHRR_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public MtiHRR_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<MtiHRR_Full> CreateMtiHRR_Full(FlatBufferBuilder builder,
      int h2 = 0,
      int h3 = 0,
      bool h4 = false,
      int h5 = 0,
    ...
    MtiHRR_Full.AddH28(builder, h28);
    MtiHRR_Full.AddH19(builder, h19);
    MtiHRR_Full.AddH15(builder, h15);
    MtiHRR_Full.AddH14(builder, h14);
    MtiHRR_Full.AddH13(builder, h13);
    MtiHRR_Full.AddH12(builder, h12);
    MtiHRR_Full.AddH11(builder, h11);
    MtiHRR_Full.AddH32(builder, h32Offset);
    MtiHRR_Full.AddH31(builder, h31);
    MtiHRR_Full.AddH30(builder, h30);
    MtiHRR_Full.AddH29(builder, h29);
    MtiHRR_Full.AddH27(builder, h27);
    MtiHRR_Full.AddH24(builder, h24Offset);
    MtiHRR_Full.AddH23(builder, h23Offset);
    MtiHRR_Full.AddH22(builder, h22);
    MtiHRR_Full.AddH21(builder, h21);
    MtiHRR_Full.AddH20(builder, h20);
    MtiHRR_Full.AddH18(builder, h18Offset);
    MtiHRR_Full.AddH17(builder, h17Offset);
    MtiHRR_Full.AddH16(builder, h16Offset);
    MtiHRR_Full.AddH10(builder, h10);
    MtiHRR_Full.AddH9(builder, h9);
    MtiHRR_Full.AddH8(builder, h8);
    MtiHRR_Full.AddH7(builder, h7);
    MtiHRR_Full.AddH6(builder, h6);
    MtiHRR_Full.AddH5(builder, h5);
    MtiHRR_Full.AddH3(builder, h3);
    MtiHRR_Full.AddH2(builder, h2);
    MtiHRR_Full.AddH4(builder, h4);
    return MtiHRR_Full.EndMtiHRR_Full(builder);
  }

  public static void StartMtiHRR_Full(FlatBufferBuilder builder) { builder.StartTable(29); }
  ...
  public static Offset<MtiHRR_Full> EndMtiHRR_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<MtiHRR_Full>(o);
  }
  public static void FinishMtiHRR_FullBuffer(FlatBufferBuilder builder, Offset<MtiHRR_Full> offset) { builder.Finish(offset.Value, "MTIH"); }
  public static void FinishSizePrefixedMtiHRR_FullBuffer(FlatBufferBuilder builder, Offset<MtiHRR_Full> offset) { builder.FinishSizePrefixed(offset.Value, "MTIH"); }
  public MtiHRR_FullT UnPack() {
    var _o = new MtiHRR_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(MtiHRR_FullT _o) {
    _o.H2 = this.H2;
    _o.H3 = this.H3;
    _o.H4 = this.H4;
    _o.H5 = this.H5;
  ...
  public static Offset<MtiHRR_Full> Pack(FlatBufferBuilder builder, MtiHRR_FullT _o) {
    if (_o == null) return default(Offset<MtiHRR_Full>);
...
public class MtiHRR_FullT
{
  ...
  public static MtiHRR_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return MtiHRR_Full.GetRootAsMtiHRR_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    MtiHRR_Full.FinishMtiHRR_FullBuffer(fbb, MtiHRR_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class MtiHRR_FullVerify
{
