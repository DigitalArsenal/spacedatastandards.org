...
public struct AirspaceControlOrderReference_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirspaceControlOrderReference_Abridged GetRootAsAirspaceControlOrderReference_Abridged(ByteBuffer _bb) { return GetRootAsAirspaceControlOrderReference_Abridged(_bb, new AirspaceControlOrderReference_Abridged()); }
  public static AirspaceControlOrderReference_Abridged GetRootAsAirspaceControlOrderReference_Abridged(ByteBuffer _bb, AirspaceControlOrderReference_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirspaceControlOrderReference_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRS"); }
  public static bool VerifyAirspaceControlOrderReference_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRS", false, AirspaceControlOrderReference_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirspaceControlOrderReference_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<AirspaceControlOrderReference_Abridged> CreateAirspaceControlOrderReference_Abridged(FlatBufferBuilder builder,
    ...
    AirspaceControlOrderReference_Abridged.AddRefSICs(builder, refSICsOffset);
    AirspaceControlOrderReference_Abridged.AddRefSpecialNotation(builder, refSpecialNotationOffset);
    AirspaceControlOrderReference_Abridged.AddRefSerialNum(builder, refSerialNumOffset);
    AirspaceControlOrderReference_Abridged.AddRefTs(builder, refTsOffset);
    AirspaceControlOrderReference_Abridged.AddRefOriginator(builder, refOriginatorOffset);
    AirspaceControlOrderReference_Abridged.AddRefType(builder, refTypeOffset);
    AirspaceControlOrderReference_Abridged.AddRefSId(builder, refSIdOffset);
    return AirspaceControlOrderReference_Abridged.EndAirspaceControlOrderReference_Abridged(builder);
  }

  public static void StartAirspaceControlOrderReference_Abridged(FlatBufferBuilder builder) { builder.StartTable(7); }
  ...
  public static Offset<AirspaceControlOrderReference_Abridged> EndAirspaceControlOrderReference_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirspaceControlOrderReference_Abridged>(o);
  }
  public static void FinishAirspaceControlOrderReference_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirspaceControlOrderReference_Abridged> offset) { builder.Finish(offset.Value, "AIRS"); }
  public static void FinishSizePrefixedAirspaceControlOrderReference_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirspaceControlOrderReference_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "AIRS"); }
  public AirspaceControlOrderReference_AbridgedT UnPack() {
    var _o = new AirspaceControlOrderReference_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirspaceControlOrderReference_AbridgedT _o) {
  ...
  public static Offset<AirspaceControlOrderReference_Abridged> Pack(FlatBufferBuilder builder, AirspaceControlOrderReference_AbridgedT _o) {
    if (_o == null) return default(Offset<AirspaceControlOrderReference_Abridged>);
...
public class AirspaceControlOrderReference_AbridgedT
{
  ...
  public AirspaceControlOrderReference_AbridgedT() {
    this.RefSId = null;
    this.RefType = null;
  ...
  public static AirspaceControlOrderReference_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return AirspaceControlOrderReference_Abridged.GetRootAsAirspaceControlOrderReference_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirspaceControlOrderReference_Abridged.FinishAirspaceControlOrderReference_AbridgedBuffer(fbb, AirspaceControlOrderReference_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirspaceControlOrderReference_AbridgedVerify
{
