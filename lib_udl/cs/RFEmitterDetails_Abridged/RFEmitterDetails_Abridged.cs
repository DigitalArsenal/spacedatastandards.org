...
public struct RFEmitterDetails_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static RFEmitterDetails_Abridged GetRootAsRFEmitterDetails_Abridged(ByteBuffer _bb) { return GetRootAsRFEmitterDetails_Abridged(_bb, new RFEmitterDetails_Abridged()); }
  public static RFEmitterDetails_Abridged GetRootAsRFEmitterDetails_Abridged(ByteBuffer _bb, RFEmitterDetails_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool RFEmitterDetails_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "RFEM"); }
  public static bool VerifyRFEmitterDetails_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("RFEM", false, RFEmitterDetails_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public RFEmitterDetails_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public RFEmitterDetails_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(68); return o != 0 ? (RFEmitterDetails_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFEmitterDetails_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<RFEmitterDetails_Abridged> CreateRFEmitterDetails_Abridged(FlatBufferBuilder builder,
      ...
      RFEmitterDetails_Abridged_dataMode_Enum dataMode = RFEmitterDetails_Abridged_dataMode_Enum.REAL,
  ...
  public static void StartRFEmitterDetails_Abridged(FlatBufferBuilder builder) { builder.StartTable(35); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, RFEmitterDetails_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(32, (sbyte)dataMode, 0); }
  ...
  public static Offset<RFEmitterDetails_Abridged> EndRFEmitterDetails_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RFEmitterDetails_Abridged>(o);
  }
  public static void FinishRFEmitterDetails_AbridgedBuffer(FlatBufferBuilder builder, Offset<RFEmitterDetails_Abridged> offset) { builder.Finish(offset.Value, "RFEM"); }
  public static void FinishSizePrefixedRFEmitterDetails_AbridgedBuffer(FlatBufferBuilder builder, Offset<RFEmitterDetails_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "RFEM"); }
  public RFEmitterDetails_AbridgedT UnPack() {
    var _o = new RFEmitterDetails_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RFEmitterDetails_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<RFEmitterDetails_Abridged> Pack(FlatBufferBuilder builder, RFEmitterDetails_AbridgedT _o) {
    if (_o == null) return default(Offset<RFEmitterDetails_Abridged>);
...
public class RFEmitterDetails_AbridgedT
{
  ...
  public RFEmitterDetails_Abridged_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }

  public RFEmitterDetails_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = RFEmitterDetails_Abridged_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
  }
  public static RFEmitterDetails_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return RFEmitterDetails_Abridged.GetRootAsRFEmitterDetails_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    RFEmitterDetails_Abridged.FinishRFEmitterDetails_AbridgedBuffer(fbb, RFEmitterDetails_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class RFEmitterDetails_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 68 /*DataMode*/, 1 /*RFEmitterDetails_Abridged_dataMode_Enum*/, 1, false)
