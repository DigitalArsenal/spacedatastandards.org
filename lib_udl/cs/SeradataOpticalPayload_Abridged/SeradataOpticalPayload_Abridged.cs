...
public struct SeradataOpticalPayload_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SeradataOpticalPayload_Abridged GetRootAsSeradataOpticalPayload_Abridged(ByteBuffer _bb) { return GetRootAsSeradataOpticalPayload_Abridged(_bb, new SeradataOpticalPayload_Abridged()); }
  public static SeradataOpticalPayload_Abridged GetRootAsSeradataOpticalPayload_Abridged(ByteBuffer _bb, SeradataOpticalPayload_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SeradataOpticalPayload_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SERA"); }
  public static bool VerifySeradataOpticalPayload_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SERA", false, SeradataOpticalPayload_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SeradataOpticalPayload_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SeradataOpticalPayload_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(54); return o != 0 ? (SeradataOpticalPayload_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SeradataOpticalPayload_Abridged_dataMode_Enum.REAL; } }

  public static Offset<SeradataOpticalPayload_Abridged> CreateSeradataOpticalPayload_Abridged(FlatBufferBuilder builder,
      ...
      SeradataOpticalPayload_Abridged_dataMode_Enum dataMode = SeradataOpticalPayload_Abridged_dataMode_Enum.REAL) {
    builder.StartTable(26);
    SeradataOpticalPayload_Abridged.AddFieldOfRegard(builder, fieldOfRegard);
    SeradataOpticalPayload_Abridged.AddFieldOfView(builder, fieldOfView);
    SeradataOpticalPayload_Abridged.AddSwathWidth(builder, swathWidth);
    SeradataOpticalPayload_Abridged.AddBestResolution(builder, bestResolution);
    SeradataOpticalPayload_Abridged.AddOrigNetwork(builder, origNetworkOffset);
    SeradataOpticalPayload_Abridged.AddOrigin(builder, originOffset);
    SeradataOpticalPayload_Abridged.AddSource(builder, sourceOffset);
    SeradataOpticalPayload_Abridged.AddCreatedBy(builder, createdByOffset);
    SeradataOpticalPayload_Abridged.AddCreatedAt(builder, createdAtOffset);
    SeradataOpticalPayload_Abridged.AddNotes(builder, notesOffset);
    SeradataOpticalPayload_Abridged.AddGroundStationLocations(builder, groundStationLocationsOffset);
    SeradataOpticalPayload_Abridged.AddGroundStations(builder, groundStationsOffset);
    SeradataOpticalPayload_Abridged.AddPointingMethod(builder, pointingMethodOffset);
    SeradataOpticalPayload_Abridged.AddRecorderSize(builder, recorderSizeOffset);
    SeradataOpticalPayload_Abridged.AddNumberOfFilmReturnCanisters(builder, numberOfFilmReturnCanisters);
    SeradataOpticalPayload_Abridged.AddSpectralFrequencyLimits(builder, spectralFrequencyLimitsOffset);
    SeradataOpticalPayload_Abridged.AddSpectralBand(builder, spectralBandOffset);
    SeradataOpticalPayload_Abridged.AddName(builder, nameOffset);
    SeradataOpticalPayload_Abridged.AddImagingPayloadCategory(builder, imagingPayloadCategoryOffset);
    SeradataOpticalPayload_Abridged.AddManufacturerOrgId(builder, manufacturerOrgIdOffset);
    SeradataOpticalPayload_Abridged.AddHostedForCompanyOrgId(builder, hostedForCompanyOrgIdOffset);
    SeradataOpticalPayload_Abridged.AddIdSensor(builder, idSensorOffset);
    SeradataOpticalPayload_Abridged.AddSpacecraftId(builder, spacecraftIdOffset);
    SeradataOpticalPayload_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    SeradataOpticalPayload_Abridged.AddId(builder, idOffset);
    SeradataOpticalPayload_Abridged.AddDataMode(builder, dataMode);
    return SeradataOpticalPayload_Abridged.EndSeradataOpticalPayload_Abridged(builder);
  }

  public static void StartSeradataOpticalPayload_Abridged(FlatBufferBuilder builder) { builder.StartTable(26); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SeradataOpticalPayload_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(25, (sbyte)dataMode, 0); }
  public static Offset<SeradataOpticalPayload_Abridged> EndSeradataOpticalPayload_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SeradataOpticalPayload_Abridged>(o);
  }
  public static void FinishSeradataOpticalPayload_AbridgedBuffer(FlatBufferBuilder builder, Offset<SeradataOpticalPayload_Abridged> offset) { builder.Finish(offset.Value, "SERA"); }
  public static void FinishSizePrefixedSeradataOpticalPayload_AbridgedBuffer(FlatBufferBuilder builder, Offset<SeradataOpticalPayload_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "SERA"); }
  public SeradataOpticalPayload_AbridgedT UnPack() {
    var _o = new SeradataOpticalPayload_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SeradataOpticalPayload_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SeradataOpticalPayload_Abridged> Pack(FlatBufferBuilder builder, SeradataOpticalPayload_AbridgedT _o) {
    if (_o == null) return default(Offset<SeradataOpticalPayload_Abridged>);
    ...
    return CreateSeradataOpticalPayload_Abridged(
      builder,
      _id,
...
public class SeradataOpticalPayload_AbridgedT
{
  ...
  public SeradataOpticalPayload_Abridged_dataMode_Enum DataMode { get; set; }

  public SeradataOpticalPayload_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = SeradataOpticalPayload_Abridged_dataMode_Enum.REAL;
  }
  public static SeradataOpticalPayload_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return SeradataOpticalPayload_Abridged.GetRootAsSeradataOpticalPayload_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SeradataOpticalPayload_Abridged.FinishSeradataOpticalPayload_AbridgedBuffer(fbb, SeradataOpticalPayload_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SeradataOpticalPayload_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 54 /*DataMode*/, 1 /*SeradataOpticalPayload_Abridged_dataMode_Enum*/, 1, false)
