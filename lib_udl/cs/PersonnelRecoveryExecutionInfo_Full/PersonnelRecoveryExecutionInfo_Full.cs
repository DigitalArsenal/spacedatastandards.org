...
public struct PersonnelRecoveryExecutionInfo_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static PersonnelRecoveryExecutionInfo_Full GetRootAsPersonnelRecoveryExecutionInfo_Full(ByteBuffer _bb) { return GetRootAsPersonnelRecoveryExecutionInfo_Full(_bb, new PersonnelRecoveryExecutionInfo_Full()); }
  public static PersonnelRecoveryExecutionInfo_Full GetRootAsPersonnelRecoveryExecutionInfo_Full(ByteBuffer _bb, PersonnelRecoveryExecutionInfo_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool PersonnelRecoveryExecutionInfo_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "PERS"); }
  public static bool VerifyPersonnelRecoveryExecutionInfo_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("PERS", false, PersonnelRecoveryExecutionInfo_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public PersonnelRecoveryExecutionInfo_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<PersonnelRecoveryExecutionInfo_Full> CreatePersonnelRecoveryExecutionInfo_Full(FlatBufferBuilder builder,
  ...
  public static void StartPersonnelRecoveryExecutionInfo_Full(FlatBufferBuilder builder) { builder.StartTable(7); }
  ...
  public static Offset<PersonnelRecoveryExecutionInfo_Full> EndPersonnelRecoveryExecutionInfo_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PersonnelRecoveryExecutionInfo_Full>(o);
  }
  public static void FinishPersonnelRecoveryExecutionInfo_FullBuffer(FlatBufferBuilder builder, Offset<PersonnelRecoveryExecutionInfo_Full> offset) { builder.Finish(offset.Value, "PERS"); }
  public static void FinishSizePrefixedPersonnelRecoveryExecutionInfo_FullBuffer(FlatBufferBuilder builder, Offset<PersonnelRecoveryExecutionInfo_Full> offset) { builder.FinishSizePrefixed(offset.Value, "PERS"); }
  public PersonnelRecoveryExecutionInfo_FullT UnPack() {
    var _o = new PersonnelRecoveryExecutionInfo_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(PersonnelRecoveryExecutionInfo_FullT _o) {
  ...
  public static Offset<PersonnelRecoveryExecutionInfo_Full> Pack(FlatBufferBuilder builder, PersonnelRecoveryExecutionInfo_FullT _o) {
    if (_o == null) return default(Offset<PersonnelRecoveryExecutionInfo_Full>);
...
public class PersonnelRecoveryExecutionInfo_FullT
{
  ...
  public PersonnelRecoveryExecutionInfo_FullT() {
  ...
  public static PersonnelRecoveryExecutionInfo_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return PersonnelRecoveryExecutionInfo_Full.GetRootAsPersonnelRecoveryExecutionInfo_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    PersonnelRecoveryExecutionInfo_Full.FinishPersonnelRecoveryExecutionInfo_FullBuffer(fbb, PersonnelRecoveryExecutionInfo_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class PersonnelRecoveryExecutionInfo_FullVerify
{
