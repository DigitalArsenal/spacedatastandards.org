...
public struct PassiveRadarObservation_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static PassiveRadarObservation_Full GetRootAsPassiveRadarObservation_Full(ByteBuffer _bb, PassiveRadarObservation_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool PassiveRadarObservation_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "PASS"); }
  public static bool VerifyPassiveRadarObservation_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("PASS", false, PassiveRadarObservation_FullVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public PassiveRadarObservation_Full_dataMode_Enum DataMode { get { int o = __p.__offset(134); return o != 0 ? (PassiveRadarObservation_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : PassiveRadarObservation_Full_dataMode_Enum.REAL; } }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string OnOrbit { get { int o = __p.__offset(136); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbitBytes() { return __p.__vector_as_span<byte>(136, 1); }
#else
  public ArraySegment<byte>? GetOnOrbitBytes() { return __p.__vector_as_arraysegment(136); }
#endif
  public byte[] GetOnOrbitArray() { return __p.__vector_as_array<byte>(136); }
  /// Read only enumeration specifying the type of observation (e.g. OPTICAL, RADAR, RF, etc).
  /// Example: /// Example: RADAR
  /// Constraints: No constraints specified.
  public string Type { get { int o = __p.__offset(138); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTypeBytes() { return __p.__vector_as_span<byte>(138, 1); }
#else
  public ArraySegment<byte>? GetTypeBytes() { return __p.__vector_as_arraysegment(138); }
#endif
  public byte[] GetTypeArray() { return __p.__vector_as_array<byte>(138); }

  public static Offset<PassiveRadarObservation_Full> CreatePassiveRadarObservation_Full(FlatBufferBuilder builder,
      ...
      PassiveRadarObservation_Full_dataMode_Enum dataMode = PassiveRadarObservation_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, PassiveRadarObservation_Full_dataMode_Enum dataMode) { builder.AddSbyte(65, (sbyte)dataMode, 0); }
  public static void AddOnOrbit(FlatBufferBuilder builder, StringOffset onOrbitOffset) { builder.AddOffset(66, onOrbitOffset.Value, 0); }
  public static void AddType(FlatBufferBuilder builder, StringOffset typeOffset) { builder.AddOffset(67, typeOffset.Value, 0); }
  public static Offset<PassiveRadarObservation_Full> EndPassiveRadarObservation_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PassiveRadarObservation_Full>(o);
  }
  public static void FinishPassiveRadarObservation_FullBuffer(FlatBufferBuilder builder, Offset<PassiveRadarObservation_Full> offset) { builder.Finish(offset.Value, "PASS"); }
  public static void FinishSizePrefixedPassiveRadarObservation_FullBuffer(FlatBufferBuilder builder, Offset<PassiveRadarObservation_Full> offset) { builder.FinishSizePrefixed(offset.Value, "PASS"); }
  public PassiveRadarObservation_FullT UnPack() {
    var _o = new PassiveRadarObservation_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(PassiveRadarObservation_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<PassiveRadarObservation_Full> Pack(FlatBufferBuilder builder, PassiveRadarObservation_FullT _o) {
    if (_o == null) return default(Offset<PassiveRadarObservation_Full>);
...
public class PassiveRadarObservation_FullT
{
  ...
  public PassiveRadarObservation_Full_dataMode_Enum DataMode { get; set; }
  public string OnOrbit { get; set; }
  public string Type { get; set; }

  public PassiveRadarObservation_FullT() {
    this.Id = null;
    ...
    this.SourceDL = null;
    this.DataMode = PassiveRadarObservation_Full_dataMode_Enum.REAL;
    this.OnOrbit = null;
    this.Type = null;
  }
  public static PassiveRadarObservation_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return PassiveRadarObservation_Full.GetRootAsPassiveRadarObservation_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    PassiveRadarObservation_Full.FinishPassiveRadarObservation_FullBuffer(fbb, PassiveRadarObservation_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class PassiveRadarObservation_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 134 /*DataMode*/, 1 /*PassiveRadarObservation_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 136 /*OnOrbit*/, false)
      && verifier.VerifyString(tablePos, 138 /*Type*/, false)
