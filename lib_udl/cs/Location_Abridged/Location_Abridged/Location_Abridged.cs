...
public struct Location_Abridged : IFlatbufferObject
{
  ...
  public static Offset<Location_Abridged.Location_Abridged> CreateLocation_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<Location_Abridged.Location_Abridged> EndLocation_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Location_Abridged.Location_Abridged>(o);
  }
  ...
  public static Offset<Location_Abridged.Location_Abridged> Pack(FlatBufferBuilder builder, Location_AbridgedT _o) {
    if (_o == null) return default(Offset<Location_Abridged.Location_Abridged>);
