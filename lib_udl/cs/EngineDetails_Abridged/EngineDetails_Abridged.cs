...
public struct EngineDetails_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EngineDetails_Abridged GetRootAsEngineDetails_Abridged(ByteBuffer _bb) { return GetRootAsEngineDetails_Abridged(_bb, new EngineDetails_Abridged()); }
  public static EngineDetails_Abridged GetRootAsEngineDetails_Abridged(ByteBuffer _bb, EngineDetails_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EngineDetails_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ENGI"); }
  public static bool VerifyEngineDetails_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ENGI", false, EngineDetails_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EngineDetails_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public EngineDetails_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(48); return o != 0 ? (EngineDetails_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EngineDetails_Abridged_dataMode_Enum.REAL; } }

  public static Offset<EngineDetails_Abridged> CreateEngineDetails_Abridged(FlatBufferBuilder builder,
      ...
      EngineDetails_Abridged_dataMode_Enum dataMode = EngineDetails_Abridged_dataMode_Enum.REAL) {
    builder.StartTable(23);
    EngineDetails_Abridged.AddNozzleExpansionRatio(builder, nozzleExpansionRatio);
    EngineDetails_Abridged.AddChamberPressure(builder, chamberPressure);
    EngineDetails_Abridged.AddVacuumThrust(builder, vacuumThrust);
    EngineDetails_Abridged.AddSeaLevelThrust(builder, seaLevelThrust);
    EngineDetails_Abridged.AddBurnTime(builder, burnTime);
    EngineDetails_Abridged.AddSpecificImpulse(builder, specificImpulse);
    EngineDetails_Abridged.AddOrigNetwork(builder, origNetworkOffset);
    EngineDetails_Abridged.AddOrigin(builder, originOffset);
    EngineDetails_Abridged.AddSource(builder, sourceOffset);
    EngineDetails_Abridged.AddCreatedBy(builder, createdByOffset);
    EngineDetails_Abridged.AddCreatedAt(builder, createdAtOffset);
    EngineDetails_Abridged.AddNotes(builder, notesOffset);
    EngineDetails_Abridged.AddOxidizer(builder, oxidizerOffset);
    EngineDetails_Abridged.AddPropellant(builder, propellantOffset);
    EngineDetails_Abridged.AddMaxFirings(builder, maxFirings);
    EngineDetails_Abridged.AddManufacturerOrgId(builder, manufacturerOrgIdOffset);
    EngineDetails_Abridged.AddCharacteristicType(builder, characteristicTypeOffset);
    EngineDetails_Abridged.AddCycleType(builder, cycleTypeOffset);
    EngineDetails_Abridged.AddFamily(builder, familyOffset);
    EngineDetails_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    EngineDetails_Abridged.AddIdEngine(builder, idEngineOffset);
    EngineDetails_Abridged.AddId(builder, idOffset);
    EngineDetails_Abridged.AddDataMode(builder, dataMode);
    return EngineDetails_Abridged.EndEngineDetails_Abridged(builder);
  }

  public static void StartEngineDetails_Abridged(FlatBufferBuilder builder) { builder.StartTable(23); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, EngineDetails_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(22, (sbyte)dataMode, 0); }
  public static Offset<EngineDetails_Abridged> EndEngineDetails_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EngineDetails_Abridged>(o);
  }
  public static void FinishEngineDetails_AbridgedBuffer(FlatBufferBuilder builder, Offset<EngineDetails_Abridged> offset) { builder.Finish(offset.Value, "ENGI"); }
  public static void FinishSizePrefixedEngineDetails_AbridgedBuffer(FlatBufferBuilder builder, Offset<EngineDetails_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "ENGI"); }
  public EngineDetails_AbridgedT UnPack() {
    var _o = new EngineDetails_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EngineDetails_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<EngineDetails_Abridged> Pack(FlatBufferBuilder builder, EngineDetails_AbridgedT _o) {
    if (_o == null) return default(Offset<EngineDetails_Abridged>);
...
public class EngineDetails_AbridgedT
{
  ...
  public EngineDetails_Abridged_dataMode_Enum DataMode { get; set; }

  public EngineDetails_AbridgedT() {
    this.Id = null;
    this.IdEngine = null;
    ...
    this.DataMode = EngineDetails_Abridged_dataMode_Enum.REAL;
  }
  public static EngineDetails_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return EngineDetails_Abridged.GetRootAsEngineDetails_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EngineDetails_Abridged.FinishEngineDetails_AbridgedBuffer(fbb, EngineDetails_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EngineDetails_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 48 /*DataMode*/, 1 /*EngineDetails_Abridged_dataMode_Enum*/, 1, false)
