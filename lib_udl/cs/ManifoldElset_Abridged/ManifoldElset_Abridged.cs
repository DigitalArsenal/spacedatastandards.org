...
public struct ManifoldElset_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static ManifoldElset_Abridged GetRootAsManifoldElset_Abridged(ByteBuffer _bb) { return GetRootAsManifoldElset_Abridged(_bb, new ManifoldElset_Abridged()); }
  public static ManifoldElset_Abridged GetRootAsManifoldElset_Abridged(ByteBuffer _bb, ManifoldElset_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool ManifoldElset_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MANI"); }
  public static bool VerifyManifoldElset_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MANI", false, ManifoldElset_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ManifoldElset_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public ManifoldElset_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(54); return o != 0 ? (ManifoldElset_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : ManifoldElset_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<ManifoldElset_Abridged> CreateManifoldElset_Abridged(FlatBufferBuilder builder,
      ...
      ManifoldElset_Abridged_dataMode_Enum dataMode = ManifoldElset_Abridged_dataMode_Enum.REAL,
      StringOffset origNetworkOffset = default(StringOffset)) {
    builder.StartTable(27);
    ManifoldElset_Abridged.AddPerigee(builder, perigee);
    ManifoldElset_Abridged.AddApogee(builder, apogee);
    ManifoldElset_Abridged.AddPeriod(builder, period);
    ManifoldElset_Abridged.AddSemiMajorAxis(builder, semiMajorAxis);
    ManifoldElset_Abridged.AddMeanMotionDDot(builder, meanMotionDDot);
    ManifoldElset_Abridged.AddMeanMotionDot(builder, meanMotionDot);
    ManifoldElset_Abridged.AddBStar(builder, bStar);
    ManifoldElset_Abridged.AddMeanAnomaly(builder, meanAnomaly);
    ManifoldElset_Abridged.AddArgOfPerigee(builder, argOfPerigee);
    ManifoldElset_Abridged.AddRaan(builder, raan);
    ManifoldElset_Abridged.AddInclination(builder, inclination);
    ManifoldElset_Abridged.AddEccentricity(builder, eccentricity);
    ManifoldElset_Abridged.AddMeanMotion(builder, meanMotion);
    ManifoldElset_Abridged.AddOrigNetwork(builder, origNetworkOffset);
    ManifoldElset_Abridged.AddOrigin(builder, originOffset);
    ManifoldElset_Abridged.AddSource(builder, sourceOffset);
    ManifoldElset_Abridged.AddCreatedBy(builder, createdByOffset);
    ManifoldElset_Abridged.AddCreatedAt(builder, createdAtOffset);
    ManifoldElset_Abridged.AddLine2(builder, line2Offset);
    ManifoldElset_Abridged.AddLine1(builder, line1Offset);
    ManifoldElset_Abridged.AddRevNo(builder, revNo);
    ManifoldElset_Abridged.AddEpoch(builder, epochOffset);
    ManifoldElset_Abridged.AddTmpSatNo(builder, tmpSatNo);
    ManifoldElset_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    ManifoldElset_Abridged.AddIdManifold(builder, idManifoldOffset);
    ManifoldElset_Abridged.AddId(builder, idOffset);
    ManifoldElset_Abridged.AddDataMode(builder, dataMode);
    return ManifoldElset_Abridged.EndManifoldElset_Abridged(builder);
  }

  public static void StartManifoldElset_Abridged(FlatBufferBuilder builder) { builder.StartTable(27); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, ManifoldElset_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(25, (sbyte)dataMode, 0); }
  ...
  public static Offset<ManifoldElset_Abridged> EndManifoldElset_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ManifoldElset_Abridged>(o);
  }
  public static void FinishManifoldElset_AbridgedBuffer(FlatBufferBuilder builder, Offset<ManifoldElset_Abridged> offset) { builder.Finish(offset.Value, "MANI"); }
  public static void FinishSizePrefixedManifoldElset_AbridgedBuffer(FlatBufferBuilder builder, Offset<ManifoldElset_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "MANI"); }
  public ManifoldElset_AbridgedT UnPack() {
    var _o = new ManifoldElset_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(ManifoldElset_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<ManifoldElset_Abridged> Pack(FlatBufferBuilder builder, ManifoldElset_AbridgedT _o) {
    if (_o == null) return default(Offset<ManifoldElset_Abridged>);
    ...
    return CreateManifoldElset_Abridged(
      builder,
      _id,
      _idManifold,
...
public class ManifoldElset_AbridgedT
{
  ...
  public ManifoldElset_Abridged_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public ManifoldElset_AbridgedT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = ManifoldElset_Abridged_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static ManifoldElset_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return ManifoldElset_Abridged.GetRootAsManifoldElset_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    ManifoldElset_Abridged.FinishManifoldElset_AbridgedBuffer(fbb, ManifoldElset_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class ManifoldElset_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 54 /*DataMode*/, 1 /*ManifoldElset_Abridged_dataMode_Enum*/, 1, false)
