...
public struct IonoObservationPhase_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static IonoObservationPhase_Abridged GetRootAsIonoObservationPhase_Abridged(ByteBuffer _bb, IonoObservationPhase_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationPhase_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationPhase_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationPhase_AbridgedVerify.Verify); }
  ...
  public static Offset<IonoObservationPhase_Abridged> CreateIonoObservationPhase_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<IonoObservationPhase_Abridged> EndIonoObservationPhase_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationPhase_Abridged>(o);
  }
  public static void FinishIonoObservationPhase_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationPhase_Abridged> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationPhase_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationPhase_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationPhase_AbridgedT UnPack() {
    var _o = new IonoObservationPhase_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationPhase_AbridgedT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationPhase_Abridged> Pack(FlatBufferBuilder builder, IonoObservationPhase_AbridgedT _o) {
    if (_o == null) return default(Offset<IonoObservationPhase_Abridged>);
...
public class IonoObservationPhase_AbridgedT
{
  ...
  public IonoObservationPhase_AbridgedT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationPhase_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationPhase_Abridged.GetRootAsIonoObservationPhase_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationPhase_Abridged.FinishIonoObservationPhase_AbridgedBuffer(fbb, IonoObservationPhase_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationPhase_AbridgedVerify
{
