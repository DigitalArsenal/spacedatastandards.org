...
public struct IonoObservationPhase_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationPhase_Full GetRootAsIonoObservationPhase_Full(ByteBuffer _bb) { return GetRootAsIonoObservationPhase_Full(_bb, new IonoObservationPhase_Full()); }
  public static IonoObservationPhase_Full GetRootAsIonoObservationPhase_Full(ByteBuffer _bb, IonoObservationPhase_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationPhase_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationPhase_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationPhase_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationPhase_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationPhase_Full> CreateIonoObservationPhase_Full(FlatBufferBuilder builder,
    ...
    IonoObservationPhase_Full.AddData(builder, dataOffset);
    IonoObservationPhase_Full.AddDimensionName(builder, dimensionNameOffset);
    IonoObservationPhase_Full.AddDimensions(builder, dimensionsOffset);
    IonoObservationPhase_Full.AddNotes(builder, notesOffset);
    return IonoObservationPhase_Full.EndIonoObservationPhase_Full(builder);
  }

  public static void StartIonoObservationPhase_Full(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationPhase_Full> EndIonoObservationPhase_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationPhase_Full>(o);
  }
  public static void FinishIonoObservationPhase_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationPhase_Full> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationPhase_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationPhase_Full> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationPhase_FullT UnPack() {
    var _o = new IonoObservationPhase_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationPhase_FullT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationPhase_Full> Pack(FlatBufferBuilder builder, IonoObservationPhase_FullT _o) {
    if (_o == null) return default(Offset<IonoObservationPhase_Full>);
    ...
    return CreateIonoObservationPhase_Full(
      builder,
      _notes,
      _dimensions,
      _dimensionName,
...
public class IonoObservationPhase_FullT
{
  ...
  public IonoObservationPhase_FullT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationPhase_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationPhase_Full.GetRootAsIonoObservationPhase_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationPhase_Full.FinishIonoObservationPhase_FullBuffer(fbb, IonoObservationPhase_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationPhase_FullVerify
{
