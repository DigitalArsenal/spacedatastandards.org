...
public struct IonoObservationPower_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationPower_Abridged GetRootAsIonoObservationPower_Abridged(ByteBuffer _bb) { return GetRootAsIonoObservationPower_Abridged(_bb, new IonoObservationPower_Abridged()); }
  public static IonoObservationPower_Abridged GetRootAsIonoObservationPower_Abridged(ByteBuffer _bb, IonoObservationPower_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationPower_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationPower_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationPower_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationPower_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationPower_Abridged> CreateIonoObservationPower_Abridged(FlatBufferBuilder builder,
  ...
  public static void StartIonoObservationPower_Abridged(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationPower_Abridged> EndIonoObservationPower_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationPower_Abridged>(o);
  }
  public static void FinishIonoObservationPower_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationPower_Abridged> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationPower_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationPower_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationPower_AbridgedT UnPack() {
    var _o = new IonoObservationPower_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationPower_AbridgedT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationPower_Abridged> Pack(FlatBufferBuilder builder, IonoObservationPower_AbridgedT _o) {
    if (_o == null) return default(Offset<IonoObservationPower_Abridged>);
    ...
    return CreateIonoObservationPower_Abridged(
      builder,
      _notes,
      _dimensions,
      _dimensionName,
...
public class IonoObservationPower_AbridgedT
{
  ...
  public IonoObservationPower_AbridgedT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationPower_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationPower_Abridged.GetRootAsIonoObservationPower_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationPower_Abridged.FinishIonoObservationPower_AbridgedBuffer(fbb, IonoObservationPower_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationPower_AbridgedVerify
{
