...
public struct MissileTrackVector_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static MissileTrackVector_Abridged GetRootAsMissileTrackVector_Abridged(ByteBuffer _bb) { return GetRootAsMissileTrackVector_Abridged(_bb, new MissileTrackVector_Abridged()); }
  public static MissileTrackVector_Abridged GetRootAsMissileTrackVector_Abridged(ByteBuffer _bb, MissileTrackVector_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool MissileTrackVector_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MISS"); }
  public static bool VerifyMissileTrackVector_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MISS", false, MissileTrackVector_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public MissileTrackVector_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<MissileTrackVector_Abridged> CreateMissileTrackVector_Abridged(FlatBufferBuilder builder,
  ...
  public static void StartMissileTrackVector_Abridged(FlatBufferBuilder builder) { builder.StartTable(21); }
  ...
  public static Offset<MissileTrackVector_Abridged> EndMissileTrackVector_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<MissileTrackVector_Abridged>(o);
  }
  public static void FinishMissileTrackVector_AbridgedBuffer(FlatBufferBuilder builder, Offset<MissileTrackVector_Abridged> offset) { builder.Finish(offset.Value, "MISS"); }
  public static void FinishSizePrefixedMissileTrackVector_AbridgedBuffer(FlatBufferBuilder builder, Offset<MissileTrackVector_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "MISS"); }
  public MissileTrackVector_AbridgedT UnPack() {
    var _o = new MissileTrackVector_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(MissileTrackVector_AbridgedT _o) {
    _o.Type = this.Type;
  ...
  public static Offset<MissileTrackVector_Abridged> Pack(FlatBufferBuilder builder, MissileTrackVector_AbridgedT _o) {
    if (_o == null) return default(Offset<MissileTrackVector_Abridged>);
    ...
    return CreateMissileTrackVector_Abridged(
      builder,
      _type,
      _object,
      _epoch,
...
public class MissileTrackVector_AbridgedT
{
  ...
  public MissileTrackVector_AbridgedT() {
    this.Type = null;
    this.Object = null;
    this.Epoch = null;
    this.IdSensor = null;
  ...
  public static MissileTrackVector_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return MissileTrackVector_Abridged.GetRootAsMissileTrackVector_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    MissileTrackVector_Abridged.FinishMissileTrackVector_AbridgedBuffer(fbb, MissileTrackVector_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class MissileTrackVector_AbridgedVerify
{
