...
public struct OnorbitDetails_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static OnorbitDetails_Ingest GetRootAsOnorbitDetails_Ingest(ByteBuffer _bb) { return GetRootAsOnorbitDetails_Ingest(_bb, new OnorbitDetails_Ingest()); }
  public static OnorbitDetails_Ingest GetRootAsOnorbitDetails_Ingest(ByteBuffer _bb, OnorbitDetails_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OnorbitDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONOR"); }
  public static bool VerifyOnorbitDetails_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONOR", false, OnorbitDetails_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public OnorbitDetails_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public OnorbitDetails_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(92); return o != 0 ? (OnorbitDetails_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OnorbitDetails_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<OnorbitDetails_Ingest> CreateOnorbitDetails_Ingest(FlatBufferBuilder builder,
      ...
      OnorbitDetails_Ingest_dataMode_Enum dataMode = OnorbitDetails_Ingest_dataMode_Enum.REAL,
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset),
      StringOffset origNetworkOffset = default(StringOffset)) {
    builder.StartTable(48);
    OnorbitDetails_Ingest.AddAdeptRadius(builder, adeptRadius);
    OnorbitDetails_Ingest.AddColaRadius(builder, colaRadius);
    OnorbitDetails_Ingest.AddMaxRadius(builder, maxRadius);
    OnorbitDetails_Ingest.AddBusCrossSection(builder, busCrossSection);
    OnorbitDetails_Ingest.AddCrossSection(builder, crossSection);
    OnorbitDetails_Ingest.AddFuelRemaining(builder, fuelRemaining);
    OnorbitDetails_Ingest.AddSolarArrayArea(builder, solarArrayArea);
    OnorbitDetails_Ingest.AddTotalMassUnc(builder, totalMassUnc);
    OnorbitDetails_Ingest.AddCurrentMass(builder, currentMass);
    OnorbitDetails_Ingest.AddBolFuelMass(builder, bolFuelMass);
    OnorbitDetails_Ingest.AddLaunchMassMax(builder, launchMassMax);
    OnorbitDetails_Ingest.AddLaunchMass(builder, launchMass);
    OnorbitDetails_Ingest.AddLaunchMassMin(builder, launchMassMin);
    OnorbitDetails_Ingest.AddAdditionalMass(builder, additionalMass);
    OnorbitDetails_Ingest.AddDryMass(builder, dryMass);
    OnorbitDetails_Ingest.AddDriftRate(builder, driftRate);
    OnorbitDetails_Ingest.AddGeoSlot(builder, geoSlot);
    OnorbitDetails_Ingest.AddEstDeltaVDuration(builder, estDeltaVDuration);
    OnorbitDetails_Ingest.AddDeltaVUnc(builder, deltaVUnc);
    OnorbitDetails_Ingest.AddMaxDeltaV(builder, maxDeltaV);
    OnorbitDetails_Ingest.AddBolDeltaV(builder, bolDeltaV);
    OnorbitDetails_Ingest.AddRcsMean(builder, rcsMean);
    OnorbitDetails_Ingest.AddRcsMax(builder, rcsMax);
    OnorbitDetails_Ingest.AddRcsMin(builder, rcsMin);
    OnorbitDetails_Ingest.AddRcs(builder, rcs);
    OnorbitDetails_Ingest.AddVismagMean(builder, vismagMean);
    OnorbitDetails_Ingest.AddVismagMax(builder, vismagMax);
    OnorbitDetails_Ingest.AddVismagMin(builder, vismagMin);
    OnorbitDetails_Ingest.AddVismag(builder, vismag);
    OnorbitDetails_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    OnorbitDetails_Ingest.AddCreatedBy(builder, createdByOffset);
    OnorbitDetails_Ingest.AddCreatedAt(builder, createdAtOffset);
    OnorbitDetails_Ingest.AddLastObSource(builder, lastObSourceOffset);
    OnorbitDetails_Ingest.AddOrigin(builder, originOffset);
    OnorbitDetails_Ingest.AddSource(builder, sourceOffset);
    OnorbitDetails_Ingest.AddDepMassUncs(builder, depMassUncsOffset);
    OnorbitDetails_Ingest.AddDepEstMasses(builder, depEstMassesOffset);
    OnorbitDetails_Ingest.AddDepNames(builder, depNamesOffset);
    OnorbitDetails_Ingest.AddNumDeployable(builder, numDeployable);
    OnorbitDetails_Ingest.AddBusType(builder, busTypeOffset);
    OnorbitDetails_Ingest.AddMissionTypes(builder, missionTypesOffset);
    OnorbitDetails_Ingest.AddNumMission(builder, numMission);
    OnorbitDetails_Ingest.AddLastObTime(builder, lastObTimeOffset);
    OnorbitDetails_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    OnorbitDetails_Ingest.AddIdOnOrbit(builder, idOnOrbitOffset);
    OnorbitDetails_Ingest.AddId(builder, idOffset);
    OnorbitDetails_Ingest.AddDataMode(builder, dataMode);
    OnorbitDetails_Ingest.AddManeuverable(builder, maneuverable);
    return OnorbitDetails_Ingest.EndOnorbitDetails_Ingest(builder);
  }

  public static void StartOnorbitDetails_Ingest(FlatBufferBuilder builder) { builder.StartTable(48); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OnorbitDetails_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(44, (sbyte)dataMode, 0); }
  ...
  public static Offset<OnorbitDetails_Ingest> EndOnorbitDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OnorbitDetails_Ingest>(o);
  }
  public static void FinishOnorbitDetails_IngestBuffer(FlatBufferBuilder builder, Offset<OnorbitDetails_Ingest> offset) { builder.Finish(offset.Value, "ONOR"); }
  public static void FinishSizePrefixedOnorbitDetails_IngestBuffer(FlatBufferBuilder builder, Offset<OnorbitDetails_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "ONOR"); }
  public OnorbitDetails_IngestT UnPack() {
    var _o = new OnorbitDetails_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OnorbitDetails_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OnorbitDetails_Ingest> Pack(FlatBufferBuilder builder, OnorbitDetails_IngestT _o) {
    if (_o == null) return default(Offset<OnorbitDetails_Ingest>);
...
public class OnorbitDetails_IngestT
{
  ...
  public OnorbitDetails_Ingest_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string OrigNetwork { get; set; }

  public OnorbitDetails_IngestT() {
    this.Id = null;
    this.IdOnOrbit = null;
    ...
    this.DataMode = OnorbitDetails_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.OrigNetwork = null;
  }
  public static OnorbitDetails_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return OnorbitDetails_Ingest.GetRootAsOnorbitDetails_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OnorbitDetails_Ingest.FinishOnorbitDetails_IngestBuffer(fbb, OnorbitDetails_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OnorbitDetails_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 92 /*DataMode*/, 1 /*OnorbitDetails_Ingest_dataMode_Enum*/, 1, false)
