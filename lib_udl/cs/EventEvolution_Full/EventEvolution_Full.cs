...
public struct EventEvolution_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EventEvolution_Full GetRootAsEventEvolution_Full(ByteBuffer _bb) { return GetRootAsEventEvolution_Full(_bb, new EventEvolution_Full()); }
  public static EventEvolution_Full GetRootAsEventEvolution_Full(ByteBuffer _bb, EventEvolution_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EventEvolution_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EVEN"); }
  public static bool VerifyEventEvolution_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EVEN", false, EventEvolution_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EventEvolution_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public EventEvolution_Full_dataMode_Enum DataMode { get { int o = __p.__offset(62); return o != 0 ? (EventEvolution_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EventEvolution_Full_dataMode_Enum.REAL; } }

  public static Offset<EventEvolution_Full> CreateEventEvolution_Full(FlatBufferBuilder builder,
      ...
      EventEvolution_Full_dataMode_Enum dataMode = EventEvolution_Full_dataMode_Enum.REAL) {
  ...
  public static void StartEventEvolution_Full(FlatBufferBuilder builder) { builder.StartTable(30); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, EventEvolution_Full_dataMode_Enum dataMode) { builder.AddSbyte(29, (sbyte)dataMode, 0); }
  public static Offset<EventEvolution_Full> EndEventEvolution_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EventEvolution_Full>(o);
  }
  public static void FinishEventEvolution_FullBuffer(FlatBufferBuilder builder, Offset<EventEvolution_Full> offset) { builder.Finish(offset.Value, "EVEN"); }
  public static void FinishSizePrefixedEventEvolution_FullBuffer(FlatBufferBuilder builder, Offset<EventEvolution_Full> offset) { builder.FinishSizePrefixed(offset.Value, "EVEN"); }
  public EventEvolution_FullT UnPack() {
    var _o = new EventEvolution_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EventEvolution_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<EventEvolution_Full> Pack(FlatBufferBuilder builder, EventEvolution_FullT _o) {
    if (_o == null) return default(Offset<EventEvolution_Full>);
...
public class EventEvolution_FullT
{
  ...
  public EventEvolution_Full_dataMode_Enum DataMode { get; set; }

  public EventEvolution_FullT() {
    this.Id = null;
    ...
    this.DataMode = EventEvolution_Full_dataMode_Enum.REAL;
  }
  public static EventEvolution_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return EventEvolution_Full.GetRootAsEventEvolution_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EventEvolution_Full.FinishEventEvolution_FullBuffer(fbb, EventEvolution_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EventEvolution_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 62 /*DataMode*/, 1 /*EventEvolution_Full_dataMode_Enum*/, 1, false)
