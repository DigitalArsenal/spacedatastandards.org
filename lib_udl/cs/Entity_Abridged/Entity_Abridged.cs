...
public struct Entity_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static Entity_Abridged GetRootAsEntity_Abridged(ByteBuffer _bb, Entity_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Entity_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ENTI"); }
  public static bool VerifyEntity_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ENTI", false, Entity_AbridgedVerify.Verify); }
  ...
  public Entity_Abridged_type_Enum Type { get { int o = __p.__offset(10); return o != 0 ? (Entity_Abridged_type_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Entity_Abridged_type_Enum.AIRCRAFT; } }
  ...
  public Entity_Abridged_ownerType_Enum OwnerType { get { int o = __p.__offset(16); return o != 0 ? (Entity_Abridged_ownerType_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Entity_Abridged_ownerType_Enum.COMMERCIAL; } }
  ...
  public Entity_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(28); return o != 0 ? (Entity_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Entity_Abridged_dataMode_Enum.REAL; } }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string OnOrbit { get { int o = __p.__offset(32); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbitBytes() { return __p.__vector_as_span<byte>(32, 1); }
#else
  public ArraySegment<byte>? GetOnOrbitBytes() { return __p.__vector_as_arraysegment(32); }
#endif
  public byte[] GetOnOrbitArray() { return __p.__vector_as_array<byte>(32); }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string IdOnOrbit { get { int o = __p.__offset(34); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetIdOnOrbitBytes() { return __p.__vector_as_span<byte>(34, 1); }
#else
  public ArraySegment<byte>? GetIdOnOrbitBytes() { return __p.__vector_as_arraysegment(34); }
#endif
  public byte[] GetIdOnOrbitArray() { return __p.__vector_as_array<byte>(34); }
  /// Unique identifier of the associated operating unit object.
  /// Example: /// Example: OPERATINGUNIT-ID
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string IdOperatingUnit { get { int o = __p.__offset(36); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetIdOperatingUnitBytes() { return __p.__vector_as_span<byte>(36, 1); }
#else
  public ArraySegment<byte>? GetIdOperatingUnitBytes() { return __p.__vector_as_arraysegment(36); }
#endif
  public byte[] GetIdOperatingUnitArray() { return __p.__vector_as_array<byte>(36); }
  ...
  public static Offset<Entity_Abridged> CreateEntity_Abridged(FlatBufferBuilder builder,
      StringOffset idEntityOffset = default(StringOffset),
      StringOffset nameOffset = default(StringOffset),
      StringOffset classificationMarkingOffset = default(StringOffset),
      Entity_Abridged_type_Enum type = Entity_Abridged_type_Enum.AIRCRAFT,
      StringOffset idLocationOffset = default(StringOffset),
      StringOffset countryCodeOffset = default(StringOffset),
      Entity_Abridged_ownerType_Enum ownerType = Entity_Abridged_ownerType_Enum.COMMERCIAL,
      bool taskable = false,
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset),
      StringOffset sourceOffset = default(StringOffset),
      StringOffset originOffset = default(StringOffset),
      Entity_Abridged_dataMode_Enum dataMode = Entity_Abridged_dataMode_Enum.REAL,
  ...
  public static void AddType(FlatBufferBuilder builder, Entity_Abridged_type_Enum type) { builder.AddSbyte(3, (sbyte)type, 0); }
  ...
  public static void AddOwnerType(FlatBufferBuilder builder, Entity_Abridged_ownerType_Enum ownerType) { builder.AddSbyte(6, (sbyte)ownerType, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Entity_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(12, (sbyte)dataMode, 0); }
  ...
  public static void AddOnOrbit(FlatBufferBuilder builder, StringOffset onOrbitOffset) { builder.AddOffset(14, onOrbitOffset.Value, 0); }
  public static void AddIdOnOrbit(FlatBufferBuilder builder, StringOffset idOnOrbitOffset) { builder.AddOffset(15, idOnOrbitOffset.Value, 0); }
  public static void AddIdOperatingUnit(FlatBufferBuilder builder, StringOffset idOperatingUnitOffset) { builder.AddOffset(16, idOperatingUnitOffset.Value, 0); }
  ...
  public static Offset<Entity_Abridged> EndEntity_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Entity_Abridged>(o);
  }
  public static void FinishEntity_AbridgedBuffer(FlatBufferBuilder builder, Offset<Entity_Abridged> offset) { builder.Finish(offset.Value, "ENTI"); }
  public static void FinishSizePrefixedEntity_AbridgedBuffer(FlatBufferBuilder builder, Offset<Entity_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "ENTI"); }
  public Entity_AbridgedT UnPack() {
    var _o = new Entity_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Entity_AbridgedT _o) {
  ...
  public static Offset<Entity_Abridged> Pack(FlatBufferBuilder builder, Entity_AbridgedT _o) {
    if (_o == null) return default(Offset<Entity_Abridged>);
...
public class Entity_AbridgedT
{
  public string IdEntity { get; set; }
  public string Name { get; set; }
  public string ClassificationMarking { get; set; }
  public Entity_Abridged_type_Enum Type { get; set; }
  public string IdLocation { get; set; }
  public string CountryCode { get; set; }
  public Entity_Abridged_ownerType_Enum OwnerType { get; set; }
  public bool Taskable { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string Source { get; set; }
  public string Origin { get; set; }
  public Entity_Abridged_dataMode_Enum DataMode { get; set; }
  ...
  public Entity_AbridgedT() {
    this.IdEntity = null;
    this.Name = null;
    this.ClassificationMarking = null;
    this.Type = Entity_Abridged_type_Enum.AIRCRAFT;
    this.IdLocation = null;
    this.CountryCode = null;
    this.OwnerType = Entity_Abridged_ownerType_Enum.COMMERCIAL;
    this.Taskable = false;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.Source = null;
    this.Origin = null;
    this.DataMode = Entity_Abridged_dataMode_Enum.REAL;
    this.Location = null;
    this.OnOrbit = null;
    this.IdOnOrbit = null;
  ...
  public static Entity_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Entity_Abridged.GetRootAsEntity_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Entity_Abridged.FinishEntity_AbridgedBuffer(fbb, Entity_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Entity_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*Type*/, 1 /*Entity_Abridged_type_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 12 /*IdLocation*/, false)
      && verifier.VerifyString(tablePos, 14 /*CountryCode*/, false)
      && verifier.VerifyField(tablePos, 16 /*OwnerType*/, 1 /*Entity_Abridged_ownerType_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 28 /*DataMode*/, 1 /*Entity_Abridged_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 30 /*Location*/, false)
      && verifier.VerifyString(tablePos, 32 /*OnOrbit*/, false)
      && verifier.VerifyString(tablePos, 34 /*IdOnOrbit*/, false)
      && verifier.VerifyString(tablePos, 36 /*IdOperatingUnit*/, false)
