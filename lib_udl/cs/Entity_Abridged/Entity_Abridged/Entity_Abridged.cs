...
public struct Entity_Abridged : IFlatbufferObject
{
  ...
  public static Offset<Entity_Abridged.Entity_Abridged> CreateEntity_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<Entity_Abridged.Entity_Abridged> EndEntity_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Entity_Abridged.Entity_Abridged>(o);
  }
  ...
  public static Offset<Entity_Abridged.Entity_Abridged> Pack(FlatBufferBuilder builder, Entity_AbridgedT _o) {
    if (_o == null) return default(Offset<Entity_Abridged.Entity_Abridged>);
