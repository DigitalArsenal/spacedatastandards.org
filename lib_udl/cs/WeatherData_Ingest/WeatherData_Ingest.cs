...
public struct WeatherData_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static WeatherData_Ingest GetRootAsWeatherData_Ingest(ByteBuffer _bb) { return GetRootAsWeatherData_Ingest(_bb, new WeatherData_Ingest()); }
  public static WeatherData_Ingest GetRootAsWeatherData_Ingest(ByteBuffer _bb, WeatherData_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool WeatherData_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "WEAT"); }
  public static bool VerifyWeatherData_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("WEAT", false, WeatherData_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public WeatherData_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public WeatherData_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(80); return o != 0 ? (WeatherData_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : WeatherData_Ingest_dataMode_Enum.REAL; } }

  public static Offset<WeatherData_Ingest> CreateWeatherData_Ingest(FlatBufferBuilder builder,
      ...
      WeatherData_Ingest_dataMode_Enum dataMode = WeatherData_Ingest_dataMode_Enum.REAL) {
  ...
  public static void StartWeatherData_Ingest(FlatBufferBuilder builder) { builder.StartTable(39); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, WeatherData_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(38, (sbyte)dataMode, 0); }
  public static Offset<WeatherData_Ingest> EndWeatherData_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WeatherData_Ingest>(o);
  }
  public static void FinishWeatherData_IngestBuffer(FlatBufferBuilder builder, Offset<WeatherData_Ingest> offset) { builder.Finish(offset.Value, "WEAT"); }
  public static void FinishSizePrefixedWeatherData_IngestBuffer(FlatBufferBuilder builder, Offset<WeatherData_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "WEAT"); }
  public WeatherData_IngestT UnPack() {
    var _o = new WeatherData_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(WeatherData_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<WeatherData_Ingest> Pack(FlatBufferBuilder builder, WeatherData_IngestT _o) {
    if (_o == null) return default(Offset<WeatherData_Ingest>);
...
public class WeatherData_IngestT
{
  ...
  public WeatherData_Ingest_dataMode_Enum DataMode { get; set; }

  public WeatherData_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = WeatherData_Ingest_dataMode_Enum.REAL;
  }
  public static WeatherData_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return WeatherData_Ingest.GetRootAsWeatherData_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    WeatherData_Ingest.FinishWeatherData_IngestBuffer(fbb, WeatherData_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class WeatherData_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 80 /*DataMode*/, 1 /*WeatherData_Ingest_dataMode_Enum*/, 1, false)
