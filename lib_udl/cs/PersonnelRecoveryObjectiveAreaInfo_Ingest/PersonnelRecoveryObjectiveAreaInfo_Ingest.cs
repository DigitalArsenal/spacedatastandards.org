...
public struct PersonnelRecoveryObjectiveAreaInfo_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static PersonnelRecoveryObjectiveAreaInfo_Ingest GetRootAsPersonnelRecoveryObjectiveAreaInfo_Ingest(ByteBuffer _bb) { return GetRootAsPersonnelRecoveryObjectiveAreaInfo_Ingest(_bb, new PersonnelRecoveryObjectiveAreaInfo_Ingest()); }
  public static PersonnelRecoveryObjectiveAreaInfo_Ingest GetRootAsPersonnelRecoveryObjectiveAreaInfo_Ingest(ByteBuffer _bb, PersonnelRecoveryObjectiveAreaInfo_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool PersonnelRecoveryObjectiveAreaInfo_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "PERS"); }
  public static bool VerifyPersonnelRecoveryObjectiveAreaInfo_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("PERS", false, PersonnelRecoveryObjectiveAreaInfo_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public PersonnelRecoveryObjectiveAreaInfo_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<PersonnelRecoveryObjectiveAreaInfo_Ingest> CreatePersonnelRecoveryObjectiveAreaInfo_Ingest(FlatBufferBuilder builder,
  ...
  public static void StartPersonnelRecoveryObjectiveAreaInfo_Ingest(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<PersonnelRecoveryObjectiveAreaInfo_Ingest> EndPersonnelRecoveryObjectiveAreaInfo_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PersonnelRecoveryObjectiveAreaInfo_Ingest>(o);
  }
  public static void FinishPersonnelRecoveryObjectiveAreaInfo_IngestBuffer(FlatBufferBuilder builder, Offset<PersonnelRecoveryObjectiveAreaInfo_Ingest> offset) { builder.Finish(offset.Value, "PERS"); }
  public static void FinishSizePrefixedPersonnelRecoveryObjectiveAreaInfo_IngestBuffer(FlatBufferBuilder builder, Offset<PersonnelRecoveryObjectiveAreaInfo_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "PERS"); }
  public PersonnelRecoveryObjectiveAreaInfo_IngestT UnPack() {
    var _o = new PersonnelRecoveryObjectiveAreaInfo_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(PersonnelRecoveryObjectiveAreaInfo_IngestT _o) {
  ...
  public static Offset<PersonnelRecoveryObjectiveAreaInfo_Ingest> Pack(FlatBufferBuilder builder, PersonnelRecoveryObjectiveAreaInfo_IngestT _o) {
    if (_o == null) return default(Offset<PersonnelRecoveryObjectiveAreaInfo_Ingest>);
...
public class PersonnelRecoveryObjectiveAreaInfo_IngestT
{
  ...
  public PersonnelRecoveryObjectiveAreaInfo_IngestT() {
  ...
  public static PersonnelRecoveryObjectiveAreaInfo_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return PersonnelRecoveryObjectiveAreaInfo_Ingest.GetRootAsPersonnelRecoveryObjectiveAreaInfo_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    PersonnelRecoveryObjectiveAreaInfo_Ingest.FinishPersonnelRecoveryObjectiveAreaInfo_IngestBuffer(fbb, PersonnelRecoveryObjectiveAreaInfo_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class PersonnelRecoveryObjectiveAreaInfo_IngestVerify
{
