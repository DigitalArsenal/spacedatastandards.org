...
public struct SensorMaintenance_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static SensorMaintenance_Full GetRootAsSensorMaintenance_Full(ByteBuffer _bb, SensorMaintenance_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SensorMaintenance_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SENS"); }
  public static bool VerifySensorMaintenance_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SENS", false, SensorMaintenance_FullVerify.Verify); }
  ...
  public SensorMaintenance_Full_dataMode_Enum DataMode { get { int o = __p.__offset(62); return o != 0 ? (SensorMaintenance_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SensorMaintenance_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<SensorMaintenance_Full> CreateSensorMaintenance_Full(FlatBufferBuilder builder,
      ...
      SensorMaintenance_Full_dataMode_Enum dataMode = SensorMaintenance_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SensorMaintenance_Full_dataMode_Enum dataMode) { builder.AddSbyte(29, (sbyte)dataMode, 0); }
  ...
  public static Offset<SensorMaintenance_Full> EndSensorMaintenance_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SensorMaintenance_Full>(o);
  }
  public static void FinishSensorMaintenance_FullBuffer(FlatBufferBuilder builder, Offset<SensorMaintenance_Full> offset) { builder.Finish(offset.Value, "SENS"); }
  public static void FinishSizePrefixedSensorMaintenance_FullBuffer(FlatBufferBuilder builder, Offset<SensorMaintenance_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SENS"); }
  public SensorMaintenance_FullT UnPack() {
    var _o = new SensorMaintenance_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SensorMaintenance_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SensorMaintenance_Full> Pack(FlatBufferBuilder builder, SensorMaintenance_FullT _o) {
    if (_o == null) return default(Offset<SensorMaintenance_Full>);
...
public class SensorMaintenance_FullT
{
  ...
  public SensorMaintenance_Full_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }
  public string UpdatedAt { get; set; }
  public string UpdatedBy { get; set; }

  public SensorMaintenance_FullT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = SensorMaintenance_Full_dataMode_Enum.REAL;
    this.OrigNetwork = null;
    this.UpdatedAt = null;
    this.UpdatedBy = null;
  }
  public static SensorMaintenance_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return SensorMaintenance_Full.GetRootAsSensorMaintenance_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SensorMaintenance_Full.FinishSensorMaintenance_FullBuffer(fbb, SensorMaintenance_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SensorMaintenance_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 62 /*DataMode*/, 1 /*SensorMaintenance_Full_dataMode_Enum*/, 1, false)
