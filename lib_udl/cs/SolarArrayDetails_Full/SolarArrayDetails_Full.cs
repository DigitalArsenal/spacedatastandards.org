...
public struct SolarArrayDetails_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static SolarArrayDetails_Full GetRootAsSolarArrayDetails_Full(ByteBuffer _bb, SolarArrayDetails_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SolarArrayDetails_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SOLA"); }
  public static bool VerifySolarArrayDetails_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SOLA", false, SolarArrayDetails_FullVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SolarArrayDetails_Full_dataMode_Enum DataMode { get { int o = __p.__offset(38); return o != 0 ? (SolarArrayDetails_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SolarArrayDetails_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<SolarArrayDetails_Full> CreateSolarArrayDetails_Full(FlatBufferBuilder builder,
      ...
      SolarArrayDetails_Full_dataMode_Enum dataMode = SolarArrayDetails_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SolarArrayDetails_Full_dataMode_Enum dataMode) { builder.AddSbyte(17, (sbyte)dataMode, 0); }
  ...
  public static Offset<SolarArrayDetails_Full> EndSolarArrayDetails_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SolarArrayDetails_Full>(o);
  }
  public static void FinishSolarArrayDetails_FullBuffer(FlatBufferBuilder builder, Offset<SolarArrayDetails_Full> offset) { builder.Finish(offset.Value, "SOLA"); }
  public static void FinishSizePrefixedSolarArrayDetails_FullBuffer(FlatBufferBuilder builder, Offset<SolarArrayDetails_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SOLA"); }
  public SolarArrayDetails_FullT UnPack() {
    var _o = new SolarArrayDetails_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SolarArrayDetails_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SolarArrayDetails_Full> Pack(FlatBufferBuilder builder, SolarArrayDetails_FullT _o) {
    if (_o == null) return default(Offset<SolarArrayDetails_Full>);
...
public class SolarArrayDetails_FullT
{
  ...
  public SolarArrayDetails_Full_dataMode_Enum DataMode { get; set; }
  public List<string> Tags { get; set; }
  public string ManufacturerOrg { get; set; }

  public SolarArrayDetails_FullT() {
    this.Id = null;
    ...
    this.DataMode = SolarArrayDetails_Full_dataMode_Enum.REAL;
    this.Tags = null;
    this.ManufacturerOrg = null;
  }
  public static SolarArrayDetails_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return SolarArrayDetails_Full.GetRootAsSolarArrayDetails_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SolarArrayDetails_Full.FinishSolarArrayDetails_FullBuffer(fbb, SolarArrayDetails_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SolarArrayDetails_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 38 /*DataMode*/, 1 /*SolarArrayDetails_Full_dataMode_Enum*/, 1, false)
