...
public struct OnorbitDetails : IFlatbufferObject
{
  private Table __p;
  ...
  public static OnorbitDetails GetRootAsOnorbitDetails(ByteBuffer _bb, OnorbitDetails obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OnorbitDetailsBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONOR"); }
  public static bool VerifyOnorbitDetails(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONOR", false, OnorbitDetailsVerify.Verify); }
  ...
  public OnorbitDetails_dataMode_Enum DataMode { get { int o = __p.__offset(92); return o != 0 ? (OnorbitDetails_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OnorbitDetails_dataMode_Enum.REAL; } }
  ...
  public static Offset<OnorbitDetails> CreateOnorbitDetails(FlatBufferBuilder builder,
      ...
      OnorbitDetails_dataMode_Enum dataMode = OnorbitDetails_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OnorbitDetails_dataMode_Enum dataMode) { builder.AddSbyte(44, (sbyte)dataMode, 0); }
  ...
  public static Offset<OnorbitDetails> EndOnorbitDetails(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OnorbitDetails>(o);
  }
  public static void FinishOnorbitDetailsBuffer(FlatBufferBuilder builder, Offset<OnorbitDetails> offset) { builder.Finish(offset.Value, "ONOR"); }
  public static void FinishSizePrefixedOnorbitDetailsBuffer(FlatBufferBuilder builder, Offset<OnorbitDetails> offset) { builder.FinishSizePrefixed(offset.Value, "ONOR"); }
  public OnorbitDetailsT UnPack() {
    var _o = new OnorbitDetailsT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OnorbitDetailsT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OnorbitDetails> Pack(FlatBufferBuilder builder, OnorbitDetailsT _o) {
    if (_o == null) return default(Offset<OnorbitDetails>);
...
public class OnorbitDetailsT
{
  ...
  public OnorbitDetails_dataMode_Enum DataMode { get; set; }
  ...
  public OnorbitDetailsT() {
    ...
    this.DataMode = OnorbitDetails_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.UpdatedAt = null;
    this.UpdatedBy = null;
  ...
  public static OnorbitDetailsT DeserializeFromBinary(byte[] fbBuffer) {
    return OnorbitDetails.GetRootAsOnorbitDetails(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OnorbitDetails.FinishOnorbitDetailsBuffer(fbb, OnorbitDetails.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OnorbitDetailsVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 92 /*DataMode*/, 1 /*OnorbitDetails_dataMode_Enum*/, 1, false)
