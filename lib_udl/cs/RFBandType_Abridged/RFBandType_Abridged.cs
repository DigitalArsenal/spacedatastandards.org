...
public struct RFBandType_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static RFBandType_Abridged GetRootAsRFBandType_Abridged(ByteBuffer _bb, RFBandType_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool RFBandType_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "RFBA"); }
  public static bool VerifyRFBandType_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("RFBA", false, RFBandType_AbridgedVerify.Verify); }
  ...
  public RFBandType_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(18); return o != 0 ? (RFBandType_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFBandType_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<RFBandType_Abridged> CreateRFBandType_Abridged(FlatBufferBuilder builder,
      ...
      RFBandType_Abridged_dataMode_Enum dataMode = RFBandType_Abridged_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, RFBandType_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(7, (sbyte)dataMode, 0); }
  ...
  public static Offset<RFBandType_Abridged> EndRFBandType_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RFBandType_Abridged>(o);
  }
  public static void FinishRFBandType_AbridgedBuffer(FlatBufferBuilder builder, Offset<RFBandType_Abridged> offset) { builder.Finish(offset.Value, "RFBA"); }
  public static void FinishSizePrefixedRFBandType_AbridgedBuffer(FlatBufferBuilder builder, Offset<RFBandType_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "RFBA"); }
  public RFBandType_AbridgedT UnPack() {
    var _o = new RFBandType_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RFBandType_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<RFBandType_Abridged> Pack(FlatBufferBuilder builder, RFBandType_AbridgedT _o) {
    if (_o == null) return default(Offset<RFBandType_Abridged>);
...
public class RFBandType_AbridgedT
{
  ...
  public RFBandType_Abridged_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }

  public RFBandType_AbridgedT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = RFBandType_Abridged_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
  }
  public static RFBandType_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return RFBandType_Abridged.GetRootAsRFBandType_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    RFBandType_Abridged.FinishRFBandType_AbridgedBuffer(fbb, RFBandType_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class RFBandType_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 18 /*DataMode*/, 1 /*RFBandType_Abridged_dataMode_Enum*/, 1, false)
