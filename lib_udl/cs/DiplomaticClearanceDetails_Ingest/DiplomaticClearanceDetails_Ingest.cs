...
public struct DiplomaticClearanceDetails_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static DiplomaticClearanceDetails_Ingest GetRootAsDiplomaticClearanceDetails_Ingest(ByteBuffer _bb) { return GetRootAsDiplomaticClearanceDetails_Ingest(_bb, new DiplomaticClearanceDetails_Ingest()); }
  public static DiplomaticClearanceDetails_Ingest GetRootAsDiplomaticClearanceDetails_Ingest(ByteBuffer _bb, DiplomaticClearanceDetails_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DiplomaticClearanceDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DIPL"); }
  public static bool VerifyDiplomaticClearanceDetails_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DIPL", false, DiplomaticClearanceDetails_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public DiplomaticClearanceDetails_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<DiplomaticClearanceDetails_Ingest> CreateDiplomaticClearanceDetails_Ingest(FlatBufferBuilder builder,
    ...
    DiplomaticClearanceDetails_Ingest.AddClearanceRemark(builder, clearanceRemarkOffset);
    DiplomaticClearanceDetails_Ingest.AddProfile(builder, profileOffset);
    DiplomaticClearanceDetails_Ingest.AddStatus(builder, statusOffset);
    DiplomaticClearanceDetails_Ingest.AddAction(builder, actionOffset);
    DiplomaticClearanceDetails_Ingest.AddExitNLT(builder, exitNLTOffset);
    DiplomaticClearanceDetails_Ingest.AddExitPoint(builder, exitPointOffset);
    DiplomaticClearanceDetails_Ingest.AddEntryNET(builder, entryNETOffset);
    DiplomaticClearanceDetails_Ingest.AddEntryPoint(builder, entryPointOffset);
    DiplomaticClearanceDetails_Ingest.AddWindowRemark(builder, windowRemarkOffset);
    DiplomaticClearanceDetails_Ingest.AddValidDesc(builder, validDescOffset);
    DiplomaticClearanceDetails_Ingest.AddCountryName(builder, countryNameOffset);
    DiplomaticClearanceDetails_Ingest.AddAltCountryCode(builder, altCountryCodeOffset);
    DiplomaticClearanceDetails_Ingest.AddCountryCode(builder, countryCodeOffset);
    DiplomaticClearanceDetails_Ingest.AddSequenceNum(builder, sequenceNum);
    DiplomaticClearanceDetails_Ingest.AddClearedCallSign(builder, clearedCallSignOffset);
    DiplomaticClearanceDetails_Ingest.AddExternalClearanceId(builder, externalClearanceIdOffset);
    DiplomaticClearanceDetails_Ingest.AddClearanceId(builder, clearanceIdOffset);
    DiplomaticClearanceDetails_Ingest.AddValidEndTime(builder, validEndTimeOffset);
    DiplomaticClearanceDetails_Ingest.AddValidStartTime(builder, validStartTimeOffset);
    DiplomaticClearanceDetails_Ingest.AddRouteString(builder, routeStringOffset);
    DiplomaticClearanceDetails_Ingest.AddLegNum(builder, legNum);
    DiplomaticClearanceDetails_Ingest.AddIdSortie(builder, idSortieOffset);
    DiplomaticClearanceDetails_Ingest.AddReqPoint(builder, reqPoint);
    DiplomaticClearanceDetails_Ingest.AddReqICAO(builder, reqICAO);
    return DiplomaticClearanceDetails_Ingest.EndDiplomaticClearanceDetails_Ingest(builder);
  }

  public static void StartDiplomaticClearanceDetails_Ingest(FlatBufferBuilder builder) { builder.StartTable(24); }
  ...
  public static Offset<DiplomaticClearanceDetails_Ingest> EndDiplomaticClearanceDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DiplomaticClearanceDetails_Ingest>(o);
  }
  public static void FinishDiplomaticClearanceDetails_IngestBuffer(FlatBufferBuilder builder, Offset<DiplomaticClearanceDetails_Ingest> offset) { builder.Finish(offset.Value, "DIPL"); }
  public static void FinishSizePrefixedDiplomaticClearanceDetails_IngestBuffer(FlatBufferBuilder builder, Offset<DiplomaticClearanceDetails_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "DIPL"); }
  public DiplomaticClearanceDetails_IngestT UnPack() {
    var _o = new DiplomaticClearanceDetails_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DiplomaticClearanceDetails_IngestT _o) {
  ...
  public static Offset<DiplomaticClearanceDetails_Ingest> Pack(FlatBufferBuilder builder, DiplomaticClearanceDetails_IngestT _o) {
    if (_o == null) return default(Offset<DiplomaticClearanceDetails_Ingest>);
    ...
    return CreateDiplomaticClearanceDetails_Ingest(
      builder,
      _idSortie,
      _o.LegNum,
      _routeString,
...
public class DiplomaticClearanceDetails_IngestT
{
  ...
  public DiplomaticClearanceDetails_IngestT() {
    this.IdSortie = null;
    this.LegNum = 0;
  ...
  public static DiplomaticClearanceDetails_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return DiplomaticClearanceDetails_Ingest.GetRootAsDiplomaticClearanceDetails_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DiplomaticClearanceDetails_Ingest.FinishDiplomaticClearanceDetails_IngestBuffer(fbb, DiplomaticClearanceDetails_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DiplomaticClearanceDetails_IngestVerify
{
