...
public struct AirspaceControlMeans_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirspaceControlMeans_Ingest GetRootAsAirspaceControlMeans_Ingest(ByteBuffer _bb) { return GetRootAsAirspaceControlMeans_Ingest(_bb, new AirspaceControlMeans_Ingest()); }
  public static AirspaceControlMeans_Ingest GetRootAsAirspaceControlMeans_Ingest(ByteBuffer _bb, AirspaceControlMeans_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirspaceControlMeans_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRS"); }
  public static bool VerifyAirspaceControlMeans_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRS", false, AirspaceControlMeans_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirspaceControlMeans_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 8
  public AirspaceControlMeans_Ingest_cmShape_Enum CmShape { get { int o = __p.__offset(8); return o != 0 ? (AirspaceControlMeans_Ingest_cmShape_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirspaceControlMeans_Ingest_cmShape_Enum.POLYARC; } }
  ...
  public static Offset<AirspaceControlMeans_Ingest> CreateAirspaceControlMeans_Ingest(FlatBufferBuilder builder,
      StringOffset cmTypeOffset = default(StringOffset),
      StringOffset cmIdOffset = default(StringOffset),
      AirspaceControlMeans_Ingest_cmShape_Enum cmShape = AirspaceControlMeans_Ingest_cmShape_Enum.POLYARC,
  ...
  public static void StartAirspaceControlMeans_Ingest(FlatBufferBuilder builder) { builder.StartTable(29); }
  ...
  public static void AddCmShape(FlatBufferBuilder builder, AirspaceControlMeans_Ingest_cmShape_Enum cmShape) { builder.AddSbyte(2, (sbyte)cmShape, 0); }
  ...
  public static Offset<AirspaceControlMeans_Ingest> EndAirspaceControlMeans_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirspaceControlMeans_Ingest>(o);
  }
  public static void FinishAirspaceControlMeans_IngestBuffer(FlatBufferBuilder builder, Offset<AirspaceControlMeans_Ingest> offset) { builder.Finish(offset.Value, "AIRS"); }
  public static void FinishSizePrefixedAirspaceControlMeans_IngestBuffer(FlatBufferBuilder builder, Offset<AirspaceControlMeans_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AIRS"); }
  public AirspaceControlMeans_IngestT UnPack() {
    var _o = new AirspaceControlMeans_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirspaceControlMeans_IngestT _o) {
  ...
  public static Offset<AirspaceControlMeans_Ingest> Pack(FlatBufferBuilder builder, AirspaceControlMeans_IngestT _o) {
    if (_o == null) return default(Offset<AirspaceControlMeans_Ingest>);
...
public class AirspaceControlMeans_IngestT
{
  public string CmType { get; set; }
  public string CmId { get; set; }
  public AirspaceControlMeans_Ingest_cmShape_Enum CmShape { get; set; }
  ...
  public AirspaceControlMeans_IngestT() {
    this.CmType = null;
    this.CmId = null;
    this.CmShape = AirspaceControlMeans_Ingest_cmShape_Enum.POLYARC;
    this.Usage = null;
    this.Link16Id = null;
  ...
  public static AirspaceControlMeans_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AirspaceControlMeans_Ingest.GetRootAsAirspaceControlMeans_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirspaceControlMeans_Ingest.FinishAirspaceControlMeans_IngestBuffer(fbb, AirspaceControlMeans_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirspaceControlMeans_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*CmShape*/, 1 /*AirspaceControlMeans_Ingest_cmShape_Enum*/, 1, false)
