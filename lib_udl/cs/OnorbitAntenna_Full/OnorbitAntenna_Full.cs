...
public struct OnorbitAntenna_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static OnorbitAntenna_Full GetRootAsOnorbitAntenna_Full(ByteBuffer _bb) { return GetRootAsOnorbitAntenna_Full(_bb, new OnorbitAntenna_Full()); }
  public static OnorbitAntenna_Full GetRootAsOnorbitAntenna_Full(ByteBuffer _bb, OnorbitAntenna_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OnorbitAntenna_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONOR"); }
  public static bool VerifyOnorbitAntenna_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONOR", false, OnorbitAntenna_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public OnorbitAntenna_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public OnorbitAntenna_Full_dataMode_Enum DataMode { get { int o = __p.__offset(24); return o != 0 ? (OnorbitAntenna_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OnorbitAntenna_Full_dataMode_Enum.REAL; } }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string Antenna { get { int o = __p.__offset(26); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAntennaBytes() { return __p.__vector_as_span<byte>(26, 1); }
#else
  public ArraySegment<byte>? GetAntennaBytes() { return __p.__vector_as_arraysegment(26); }
#endif
  public byte[] GetAntennaArray() { return __p.__vector_as_array<byte>(26); }
  ...
  public static Offset<OnorbitAntenna_Full> CreateOnorbitAntenna_Full(FlatBufferBuilder builder,
      ...
      OnorbitAntenna_Full_dataMode_Enum dataMode = OnorbitAntenna_Full_dataMode_Enum.REAL,
      StringOffset antennaOffset = default(StringOffset),
      StringOffset origNetworkOffset = default(StringOffset)) {
    builder.StartTable(13);
    OnorbitAntenna_Full.AddOrigNetwork(builder, origNetworkOffset);
    OnorbitAntenna_Full.AddAntenna(builder, antennaOffset);
    OnorbitAntenna_Full.AddOrigin(builder, originOffset);
    OnorbitAntenna_Full.AddSource(builder, sourceOffset);
    OnorbitAntenna_Full.AddUpdatedBy(builder, updatedByOffset);
    OnorbitAntenna_Full.AddUpdatedAt(builder, updatedAtOffset);
    OnorbitAntenna_Full.AddCreatedBy(builder, createdByOffset);
    OnorbitAntenna_Full.AddCreatedAt(builder, createdAtOffset);
    OnorbitAntenna_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    OnorbitAntenna_Full.AddIdAntenna(builder, idAntennaOffset);
    OnorbitAntenna_Full.AddIdOnOrbit(builder, idOnOrbitOffset);
    OnorbitAntenna_Full.AddId(builder, idOffset);
    OnorbitAntenna_Full.AddDataMode(builder, dataMode);
    return OnorbitAntenna_Full.EndOnorbitAntenna_Full(builder);
  }

  public static void StartOnorbitAntenna_Full(FlatBufferBuilder builder) { builder.StartTable(13); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OnorbitAntenna_Full_dataMode_Enum dataMode) { builder.AddSbyte(10, (sbyte)dataMode, 0); }
  public static void AddAntenna(FlatBufferBuilder builder, StringOffset antennaOffset) { builder.AddOffset(11, antennaOffset.Value, 0); }
  ...
  public static Offset<OnorbitAntenna_Full> EndOnorbitAntenna_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OnorbitAntenna_Full>(o);
  }
  public static void FinishOnorbitAntenna_FullBuffer(FlatBufferBuilder builder, Offset<OnorbitAntenna_Full> offset) { builder.Finish(offset.Value, "ONOR"); }
  public static void FinishSizePrefixedOnorbitAntenna_FullBuffer(FlatBufferBuilder builder, Offset<OnorbitAntenna_Full> offset) { builder.FinishSizePrefixed(offset.Value, "ONOR"); }
  public OnorbitAntenna_FullT UnPack() {
    var _o = new OnorbitAntenna_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OnorbitAntenna_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OnorbitAntenna_Full> Pack(FlatBufferBuilder builder, OnorbitAntenna_FullT _o) {
    if (_o == null) return default(Offset<OnorbitAntenna_Full>);
...
public class OnorbitAntenna_FullT
{
  ...
  public OnorbitAntenna_Full_dataMode_Enum DataMode { get; set; }
  public string Antenna { get; set; }
  public string OrigNetwork { get; set; }

  public OnorbitAntenna_FullT() {
    this.Id = null;
    this.IdOnOrbit = null;
    this.IdAntenna = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = OnorbitAntenna_Full_dataMode_Enum.REAL;
    this.Antenna = null;
    this.OrigNetwork = null;
  }
  public static OnorbitAntenna_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return OnorbitAntenna_Full.GetRootAsOnorbitAntenna_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OnorbitAntenna_Full.FinishOnorbitAntenna_FullBuffer(fbb, OnorbitAntenna_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OnorbitAntenna_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 24 /*DataMode*/, 1 /*OnorbitAntenna_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 26 /*Antenna*/, false)
