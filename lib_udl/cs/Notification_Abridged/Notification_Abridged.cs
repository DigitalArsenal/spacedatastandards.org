...
public struct Notification_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Notification_Abridged GetRootAsNotification_Abridged(ByteBuffer _bb) { return GetRootAsNotification_Abridged(_bb, new Notification_Abridged()); }
  public static Notification_Abridged GetRootAsNotification_Abridged(ByteBuffer _bb, Notification_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Notification_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "NOTI"); }
  public static bool VerifyNotification_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("NOTI", false, Notification_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Notification_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public Notification_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(12); return o != 0 ? (Notification_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Notification_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<Notification_Abridged> CreateNotification_Abridged(FlatBufferBuilder builder,
      StringOffset idOffset = default(StringOffset),
      StringOffset classificationMarkingOffset = default(StringOffset),
      StringOffset msgTypeOffset = default(StringOffset),
      StringOffset msgBodyOffset = default(StringOffset),
      Notification_Abridged_dataMode_Enum dataMode = Notification_Abridged_dataMode_Enum.REAL,
  ...
  public static void StartNotification_Abridged(FlatBufferBuilder builder) { builder.StartTable(12); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Notification_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(4, (sbyte)dataMode, 0); }
  ...
  public static Offset<Notification_Abridged> EndNotification_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Notification_Abridged>(o);
  }
  public static void FinishNotification_AbridgedBuffer(FlatBufferBuilder builder, Offset<Notification_Abridged> offset) { builder.Finish(offset.Value, "NOTI"); }
  public static void FinishSizePrefixedNotification_AbridgedBuffer(FlatBufferBuilder builder, Offset<Notification_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "NOTI"); }
  public Notification_AbridgedT UnPack() {
    var _o = new Notification_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Notification_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Notification_Abridged> Pack(FlatBufferBuilder builder, Notification_AbridgedT _o) {
    if (_o == null) return default(Offset<Notification_Abridged>);
...
public class Notification_AbridgedT
{
  public string Id { get; set; }
  public string ClassificationMarking { get; set; }
  public string MsgType { get; set; }
  public string MsgBody { get; set; }
  public Notification_Abridged_dataMode_Enum DataMode { get; set; }
  ...
  public Notification_AbridgedT() {
    this.Id = null;
    this.ClassificationMarking = null;
    this.MsgType = null;
    this.MsgBody = null;
    this.DataMode = Notification_Abridged_dataMode_Enum.REAL;
    this.SourceDL = null;
    this.Source = null;
    this.Origin = null;
    this.Tags = null;
  ...
  public static Notification_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Notification_Abridged.GetRootAsNotification_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Notification_Abridged.FinishNotification_AbridgedBuffer(fbb, Notification_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Notification_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 12 /*DataMode*/, 1 /*Notification_Abridged_dataMode_Enum*/, 1, false)
