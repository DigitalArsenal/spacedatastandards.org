...
public struct EffectResponseActionsList_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EffectResponseActionsList_Full GetRootAsEffectResponseActionsList_Full(ByteBuffer _bb) { return GetRootAsEffectResponseActionsList_Full(_bb, new EffectResponseActionsList_Full()); }
  public static EffectResponseActionsList_Full GetRootAsEffectResponseActionsList_Full(ByteBuffer _bb, EffectResponseActionsList_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EffectResponseActionsList_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EFFE"); }
  public static bool VerifyEffectResponseActionsList_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EFFE", false, EffectResponseActionsList_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EffectResponseActionsList_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<EffectResponseActionsList_Full> CreateEffectResponseActionsList_Full(FlatBufferBuilder builder,
  ...
  public static void StartEffectResponseActionsList_Full(FlatBufferBuilder builder) { builder.StartTable(18); }
  ...
  public static Offset<EffectResponseActionsList_Full> EndEffectResponseActionsList_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EffectResponseActionsList_Full>(o);
  }
  public static void FinishEffectResponseActionsList_FullBuffer(FlatBufferBuilder builder, Offset<EffectResponseActionsList_Full> offset) { builder.Finish(offset.Value, "EFFE"); }
  public static void FinishSizePrefixedEffectResponseActionsList_FullBuffer(FlatBufferBuilder builder, Offset<EffectResponseActionsList_Full> offset) { builder.FinishSizePrefixed(offset.Value, "EFFE"); }
  public EffectResponseActionsList_FullT UnPack() {
    var _o = new EffectResponseActionsList_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EffectResponseActionsList_FullT _o) {
  ...
  public static Offset<EffectResponseActionsList_Full> Pack(FlatBufferBuilder builder, EffectResponseActionsList_FullT _o) {
    if (_o == null) return default(Offset<EffectResponseActionsList_Full>);
...
public class EffectResponseActionsList_FullT
{
  ...
  public EffectResponseActionsList_FullT() {
    this.Summary = null;
    this.ActionId = null;
  ...
  public static EffectResponseActionsList_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return EffectResponseActionsList_Full.GetRootAsEffectResponseActionsList_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EffectResponseActionsList_Full.FinishEffectResponseActionsList_FullBuffer(fbb, EffectResponseActionsList_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EffectResponseActionsList_FullVerify
{
