...
public struct TrackRoute_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static TrackRoute_Full GetRootAsTrackRoute_Full(ByteBuffer _bb) { return GetRootAsTrackRoute_Full(_bb, new TrackRoute_Full()); }
  public static TrackRoute_Full GetRootAsTrackRoute_Full(ByteBuffer _bb, TrackRoute_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool TrackRoute_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "TRAC"); }
  public static bool VerifyTrackRoute_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("TRAC", false, TrackRoute_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public TrackRoute_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public TrackRoute_Full_dataMode_Enum DataMode { get { int o = __p.__offset(78); return o != 0 ? (TrackRoute_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : TrackRoute_Full_dataMode_Enum.REAL; } }

  public static Offset<TrackRoute_Full> CreateTrackRoute_Full(FlatBufferBuilder builder,
      ...
      TrackRoute_Full_dataMode_Enum dataMode = TrackRoute_Full_dataMode_Enum.REAL) {
  ...
  public static void StartTrackRoute_Full(FlatBufferBuilder builder) { builder.StartTable(38); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, TrackRoute_Full_dataMode_Enum dataMode) { builder.AddSbyte(37, (sbyte)dataMode, 0); }
  public static Offset<TrackRoute_Full> EndTrackRoute_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<TrackRoute_Full>(o);
  }
  public static void FinishTrackRoute_FullBuffer(FlatBufferBuilder builder, Offset<TrackRoute_Full> offset) { builder.Finish(offset.Value, "TRAC"); }
  public static void FinishSizePrefixedTrackRoute_FullBuffer(FlatBufferBuilder builder, Offset<TrackRoute_Full> offset) { builder.FinishSizePrefixed(offset.Value, "TRAC"); }
  public TrackRoute_FullT UnPack() {
    var _o = new TrackRoute_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(TrackRoute_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<TrackRoute_Full> Pack(FlatBufferBuilder builder, TrackRoute_FullT _o) {
    if (_o == null) return default(Offset<TrackRoute_Full>);
...
public class TrackRoute_FullT
{
  ...
  public TrackRoute_Full_dataMode_Enum DataMode { get; set; }

  public TrackRoute_FullT() {
    this.Id = null;
    ...
    this.DataMode = TrackRoute_Full_dataMode_Enum.REAL;
  }
  public static TrackRoute_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return TrackRoute_Full.GetRootAsTrackRoute_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    TrackRoute_Full.FinishTrackRoute_FullBuffer(fbb, TrackRoute_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class TrackRoute_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 78 /*DataMode*/, 1 /*TrackRoute_Full_dataMode_Enum*/, 1, false)
