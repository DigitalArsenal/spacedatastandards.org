...
public struct GNSSRawIF_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static GNSSRawIF_Full GetRootAsGNSSRawIF_Full(ByteBuffer _bb) { return GetRootAsGNSSRawIF_Full(_bb, new GNSSRawIF_Full()); }
  public static GNSSRawIF_Full GetRootAsGNSSRawIF_Full(ByteBuffer _bb, GNSSRawIF_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool GNSSRawIF_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "GNSS"); }
  public static bool VerifyGNSSRawIF_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("GNSS", false, GNSSRawIF_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public GNSSRawIF_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public GNSSRawIF_Full_dataMode_Enum DataMode { get { int o = __p.__offset(80); return o != 0 ? (GNSSRawIF_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : GNSSRawIF_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<GNSSRawIF_Full> CreateGNSSRawIF_Full(FlatBufferBuilder builder,
      ...
      GNSSRawIF_Full_dataMode_Enum dataMode = GNSSRawIF_Full_dataMode_Enum.REAL,
  ...
  public static void StartGNSSRawIF_Full(FlatBufferBuilder builder) { builder.StartTable(40); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, GNSSRawIF_Full_dataMode_Enum dataMode) { builder.AddSbyte(38, (sbyte)dataMode, 0); }
  ...
  public static Offset<GNSSRawIF_Full> EndGNSSRawIF_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<GNSSRawIF_Full>(o);
  }
  public static void FinishGNSSRawIF_FullBuffer(FlatBufferBuilder builder, Offset<GNSSRawIF_Full> offset) { builder.Finish(offset.Value, "GNSS"); }
  public static void FinishSizePrefixedGNSSRawIF_FullBuffer(FlatBufferBuilder builder, Offset<GNSSRawIF_Full> offset) { builder.FinishSizePrefixed(offset.Value, "GNSS"); }
  public GNSSRawIF_FullT UnPack() {
    var _o = new GNSSRawIF_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(GNSSRawIF_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<GNSSRawIF_Full> Pack(FlatBufferBuilder builder, GNSSRawIF_FullT _o) {
    if (_o == null) return default(Offset<GNSSRawIF_Full>);
...
public class GNSSRawIF_FullT
{
  ...
  public GNSSRawIF_Full_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public GNSSRawIF_FullT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = GNSSRawIF_Full_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static GNSSRawIF_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return GNSSRawIF_Full.GetRootAsGNSSRawIF_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    GNSSRawIF_Full.FinishGNSSRawIF_FullBuffer(fbb, GNSSRawIF_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class GNSSRawIF_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 80 /*DataMode*/, 1 /*GNSSRawIF_Full_dataMode_Enum*/, 1, false)
