...
public struct IonoObservationCharAtts_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationCharAtts_Abridged GetRootAsIonoObservationCharAtts_Abridged(ByteBuffer _bb) { return GetRootAsIonoObservationCharAtts_Abridged(_bb, new IonoObservationCharAtts_Abridged()); }
  public static IonoObservationCharAtts_Abridged GetRootAsIonoObservationCharAtts_Abridged(ByteBuffer _bb, IonoObservationCharAtts_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationCharAtts_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationCharAtts_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationCharAtts_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationCharAtts_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationCharAtts_Abridged> CreateIonoObservationCharAtts_Abridged(FlatBufferBuilder builder,
  ...
  public static void StartIonoObservationCharAtts_Abridged(FlatBufferBuilder builder) { builder.StartTable(10); }
  ...
  public static Offset<IonoObservationCharAtts_Abridged> EndIonoObservationCharAtts_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationCharAtts_Abridged>(o);
  }
  public static void FinishIonoObservationCharAtts_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationCharAtts_Abridged> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationCharAtts_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationCharAtts_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationCharAtts_AbridgedT UnPack() {
    var _o = new IonoObservationCharAtts_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationCharAtts_AbridgedT _o) {
  ...
  public static Offset<IonoObservationCharAtts_Abridged> Pack(FlatBufferBuilder builder, IonoObservationCharAtts_AbridgedT _o) {
    if (_o == null) return default(Offset<IonoObservationCharAtts_Abridged>);
...
public class IonoObservationCharAtts_AbridgedT
{
  ...
  public IonoObservationCharAtts_AbridgedT() {
    this.UrsiID = null;
    this.CharName = null;
    this.LowerBound = 0.0;
    this.UpperBound = 0.0;
  ...
  public static IonoObservationCharAtts_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationCharAtts_Abridged.GetRootAsIonoObservationCharAtts_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationCharAtts_Abridged.FinishIonoObservationCharAtts_AbridgedBuffer(fbb, IonoObservationCharAtts_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationCharAtts_AbridgedVerify
{
