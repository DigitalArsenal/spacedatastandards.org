...
public struct SeradataCommDetails_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SeradataCommDetails_Full GetRootAsSeradataCommDetails_Full(ByteBuffer _bb) { return GetRootAsSeradataCommDetails_Full(_bb, new SeradataCommDetails_Full()); }
  public static SeradataCommDetails_Full GetRootAsSeradataCommDetails_Full(ByteBuffer _bb, SeradataCommDetails_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SeradataCommDetails_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SERA"); }
  public static bool VerifySeradataCommDetails_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SERA", false, SeradataCommDetails_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SeradataCommDetails_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SeradataCommDetails_Full_dataMode_Enum DataMode { get { int o = __p.__offset(72); return o != 0 ? (SeradataCommDetails_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SeradataCommDetails_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<SeradataCommDetails_Full> CreateSeradataCommDetails_Full(FlatBufferBuilder builder,
      ...
      SeradataCommDetails_Full_dataMode_Enum dataMode = SeradataCommDetails_Full_dataMode_Enum.REAL,
    ...
    SeradataCommDetails_Full.AddUserUplinkTo(builder, userUplinkTo);
    SeradataCommDetails_Full.AddUserUplinkFrom(builder, userUplinkFrom);
    SeradataCommDetails_Full.AddUserDownlinkTo(builder, userDownlinkTo);
    SeradataCommDetails_Full.AddUserDownlinkFrom(builder, userDownlinkFrom);
    SeradataCommDetails_Full.AddEstHtsTotalCapacity(builder, estHtsTotalCapacity);
    SeradataCommDetails_Full.AddEstHtsTotalUserUplinkBandwidthPerBeam(builder, estHtsTotalUserUplinkBandwidthPerBeam);
    SeradataCommDetails_Full.AddEstHtsTotalUserDownlinkBandwidthPerBeam(builder, estHtsTotalUserDownlinkBandwidthPerBeam);
    SeradataCommDetails_Full.AddHtsUserUplinkBandwidthPerBeam(builder, htsUserUplinkBandwidthPerBeam);
    SeradataCommDetails_Full.AddHtsUserDownlinkBandwidthPerBeam(builder, htsUserDownlinkBandwidthPerBeam);
    SeradataCommDetails_Full.AddBandwidth(builder, bandwidth);
    SeradataCommDetails_Full.AddEirp(builder, eirp);
    SeradataCommDetails_Full.AddGatewayDownlinkTo(builder, gatewayDownlinkTo);
    SeradataCommDetails_Full.AddGatewayDownlinkFrom(builder, gatewayDownlinkFrom);
    SeradataCommDetails_Full.AddGatewayUplinkTo(builder, gatewayUplinkTo);
    SeradataCommDetails_Full.AddGatewayUplinkFrom(builder, gatewayUplinkFrom);
    SeradataCommDetails_Full.AddTravelingWaveTubeAmplifier(builder, travelingWaveTubeAmplifier);
    SeradataCommDetails_Full.AddSolidStatePowerAmp(builder, solidStatePowerAmp);
    SeradataCommDetails_Full.AddUpdatedBy(builder, updatedByOffset);
    SeradataCommDetails_Full.AddUpdatedAt(builder, updatedAtOffset);
    SeradataCommDetails_Full.AddCreatedBy(builder, createdByOffset);
    SeradataCommDetails_Full.AddCreatedAt(builder, createdAtOffset);
    SeradataCommDetails_Full.AddOrigNetwork(builder, origNetworkOffset);
    SeradataCommDetails_Full.AddOrigin(builder, originOffset);
    SeradataCommDetails_Full.AddSource(builder, sourceOffset);
    SeradataCommDetails_Full.AddPayloadNotes(builder, payloadNotesOffset);
    SeradataCommDetails_Full.AddHtsNumUserSpotBeams(builder, htsNumUserSpotBeams);
    SeradataCommDetails_Full.AddNum36MhzEquivalentTransponders(builder, num36MhzEquivalentTransponders);
    SeradataCommDetails_Full.AddTradeLeaseOrgId(builder, tradeLeaseOrgIdOffset);
    SeradataCommDetails_Full.AddManufacturerOrgId(builder, manufacturerOrgIdOffset);
    SeradataCommDetails_Full.AddHostedForCompanyOrgId(builder, hostedForCompanyOrgIdOffset);
    SeradataCommDetails_Full.AddNumSpareTransponders(builder, numSpareTransponders);
    SeradataCommDetails_Full.AddNumOperationalTransponders(builder, numOperationalTransponders);
    SeradataCommDetails_Full.AddPolarization(builder, polarizationOffset);
    SeradataCommDetails_Full.AddBand(builder, bandOffset);
    SeradataCommDetails_Full.AddSpacecraftId(builder, spacecraftIdOffset);
    SeradataCommDetails_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    SeradataCommDetails_Full.AddIdComm(builder, idCommOffset);
    SeradataCommDetails_Full.AddId(builder, idOffset);
    SeradataCommDetails_Full.AddDataMode(builder, dataMode);
    return SeradataCommDetails_Full.EndSeradataCommDetails_Full(builder);
  }

  public static void StartSeradataCommDetails_Full(FlatBufferBuilder builder) { builder.StartTable(39); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SeradataCommDetails_Full_dataMode_Enum dataMode) { builder.AddSbyte(34, (sbyte)dataMode, 0); }
  ...
  public static Offset<SeradataCommDetails_Full> EndSeradataCommDetails_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SeradataCommDetails_Full>(o);
  }
  public static void FinishSeradataCommDetails_FullBuffer(FlatBufferBuilder builder, Offset<SeradataCommDetails_Full> offset) { builder.Finish(offset.Value, "SERA"); }
  public static void FinishSizePrefixedSeradataCommDetails_FullBuffer(FlatBufferBuilder builder, Offset<SeradataCommDetails_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SERA"); }
  public SeradataCommDetails_FullT UnPack() {
    var _o = new SeradataCommDetails_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SeradataCommDetails_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SeradataCommDetails_Full> Pack(FlatBufferBuilder builder, SeradataCommDetails_FullT _o) {
    if (_o == null) return default(Offset<SeradataCommDetails_Full>);
...
public class SeradataCommDetails_FullT
{
  ...
  public SeradataCommDetails_Full_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string UpdatedAt { get; set; }
  public string UpdatedBy { get; set; }

  public SeradataCommDetails_FullT() {
    this.Id = null;
    this.IdComm = null;
    ...
    this.DataMode = SeradataCommDetails_Full_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.UpdatedAt = null;
    this.UpdatedBy = null;
  }
  public static SeradataCommDetails_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return SeradataCommDetails_Full.GetRootAsSeradataCommDetails_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SeradataCommDetails_Full.FinishSeradataCommDetails_FullBuffer(fbb, SeradataCommDetails_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SeradataCommDetails_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 72 /*DataMode*/, 1 /*SeradataCommDetails_Full_dataMode_Enum*/, 1, false)
