...
public struct Bus_Abridged : IFlatbufferObject
{
  ...
  public static Offset<Bus_Abridged.Bus_Abridged> CreateBus_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<Bus_Abridged.Bus_Abridged> EndBus_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Bus_Abridged.Bus_Abridged>(o);
  }
  ...
  public static Offset<Bus_Abridged.Bus_Abridged> Pack(FlatBufferBuilder builder, Bus_AbridgedT _o) {
    if (_o == null) return default(Offset<Bus_Abridged.Bus_Abridged>);
