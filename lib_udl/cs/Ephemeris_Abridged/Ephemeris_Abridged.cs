...
public struct Ephemeris_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Ephemeris_Abridged GetRootAsEphemeris_Abridged(ByteBuffer _bb) { return GetRootAsEphemeris_Abridged(_bb, new Ephemeris_Abridged()); }
  public static Ephemeris_Abridged GetRootAsEphemeris_Abridged(ByteBuffer _bb, Ephemeris_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Ephemeris_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EPHE"); }
  public static bool VerifyEphemeris_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EPHE", false, Ephemeris_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Ephemeris_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public Ephemeris_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(38); return o != 0 ? (Ephemeris_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Ephemeris_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<Ephemeris_Abridged> CreateEphemeris_Abridged(FlatBufferBuilder builder,
      ...
      Ephemeris_Abridged_dataMode_Enum dataMode = Ephemeris_Abridged_dataMode_Enum.REAL,
  ...
  public static void StartEphemeris_Abridged(FlatBufferBuilder builder) { builder.StartTable(21); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Ephemeris_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(17, (sbyte)dataMode, 0); }
  ...
  public static Offset<Ephemeris_Abridged> EndEphemeris_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Ephemeris_Abridged>(o);
  }
  public static void FinishEphemeris_AbridgedBuffer(FlatBufferBuilder builder, Offset<Ephemeris_Abridged> offset) { builder.Finish(offset.Value, "EPHE"); }
  public static void FinishSizePrefixedEphemeris_AbridgedBuffer(FlatBufferBuilder builder, Offset<Ephemeris_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "EPHE"); }
  public Ephemeris_AbridgedT UnPack() {
    var _o = new Ephemeris_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Ephemeris_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Ephemeris_Abridged> Pack(FlatBufferBuilder builder, Ephemeris_AbridgedT _o) {
    if (_o == null) return default(Offset<Ephemeris_Abridged>);
...
public class Ephemeris_AbridgedT
{
  ...
  public Ephemeris_Abridged_dataMode_Enum DataMode { get; set; }
  public string IdOnOrbit { get; set; }
  public string OrigObjectId { get; set; }
  public string Origin { get; set; }

  public Ephemeris_AbridgedT() {
    this.Id = null;
    ...
    this.CreatedBy = null;
    this.Source = null;
    this.DataMode = Ephemeris_Abridged_dataMode_Enum.REAL;
    this.IdOnOrbit = null;
    this.OrigObjectId = null;
    this.Origin = null;
  }
  public static Ephemeris_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Ephemeris_Abridged.GetRootAsEphemeris_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Ephemeris_Abridged.FinishEphemeris_AbridgedBuffer(fbb, Ephemeris_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Ephemeris_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 38 /*DataMode*/, 1 /*Ephemeris_Abridged_dataMode_Enum*/, 1, false)
