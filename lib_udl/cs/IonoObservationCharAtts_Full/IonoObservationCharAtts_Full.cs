...
public struct IonoObservationCharAtts_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static IonoObservationCharAtts_Full GetRootAsIonoObservationCharAtts_Full(ByteBuffer _bb, IonoObservationCharAtts_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationCharAtts_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationCharAtts_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationCharAtts_FullVerify.Verify); }
  ...
  public static Offset<IonoObservationCharAtts_Full> CreateIonoObservationCharAtts_Full(FlatBufferBuilder builder,
  ...
  public static Offset<IonoObservationCharAtts_Full> EndIonoObservationCharAtts_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationCharAtts_Full>(o);
  }
  public static void FinishIonoObservationCharAtts_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationCharAtts_Full> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationCharAtts_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationCharAtts_Full> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationCharAtts_FullT UnPack() {
    var _o = new IonoObservationCharAtts_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationCharAtts_FullT _o) {
  ...
  public static Offset<IonoObservationCharAtts_Full> Pack(FlatBufferBuilder builder, IonoObservationCharAtts_FullT _o) {
    if (_o == null) return default(Offset<IonoObservationCharAtts_Full>);
...
public class IonoObservationCharAtts_FullT
{
  ...
  public IonoObservationCharAtts_FullT() {
    this.UrsiID = null;
    this.CharName = null;
    this.LowerBound = 0.0;
    this.UpperBound = 0.0;
  ...
  public static IonoObservationCharAtts_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationCharAtts_Full.GetRootAsIonoObservationCharAtts_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationCharAtts_Full.FinishIonoObservationCharAtts_FullBuffer(fbb, IonoObservationCharAtts_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationCharAtts_FullVerify
{
