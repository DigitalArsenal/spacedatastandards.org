...
public struct RadarSOIObservation_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static RadarSOIObservation_Ingest GetRootAsRadarSOIObservation_Ingest(ByteBuffer _bb, RadarSOIObservation_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool RadarSOIObservation_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "RADA"); }
  public static bool VerifyRadarSOIObservation_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("RADA", false, RadarSOIObservation_IngestVerify.Verify); }
  ...
  public static Offset<RadarSOIObservation_Ingest> CreateRadarSOIObservation_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<RadarSOIObservation_Ingest> EndRadarSOIObservation_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RadarSOIObservation_Ingest>(o);
  }
  public static void FinishRadarSOIObservation_IngestBuffer(FlatBufferBuilder builder, Offset<RadarSOIObservation_Ingest> offset) { builder.Finish(offset.Value, "RADA"); }
  public static void FinishSizePrefixedRadarSOIObservation_IngestBuffer(FlatBufferBuilder builder, Offset<RadarSOIObservation_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "RADA"); }
  public RadarSOIObservation_IngestT UnPack() {
    var _o = new RadarSOIObservation_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RadarSOIObservation_IngestT _o) {
  ...
  public static Offset<RadarSOIObservation_Ingest> Pack(FlatBufferBuilder builder, RadarSOIObservation_IngestT _o) {
    if (_o == null) return default(Offset<RadarSOIObservation_Ingest>);
...
public class RadarSOIObservation_IngestT
{
  ...
  public RadarSOIObservation_IngestT() {
  ...
  public static RadarSOIObservation_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return RadarSOIObservation_Ingest.GetRootAsRadarSOIObservation_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    RadarSOIObservation_Ingest.FinishRadarSOIObservation_IngestBuffer(fbb, RadarSOIObservation_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class RadarSOIObservation_IngestVerify
{
