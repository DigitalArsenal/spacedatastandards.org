...
public struct NavalFlightOperations_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static NavalFlightOperations_Full GetRootAsNavalFlightOperations_Full(ByteBuffer _bb) { return GetRootAsNavalFlightOperations_Full(_bb, new NavalFlightOperations_Full()); }
  public static NavalFlightOperations_Full GetRootAsNavalFlightOperations_Full(ByteBuffer _bb, NavalFlightOperations_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool NavalFlightOperations_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "NAVA"); }
  public static bool VerifyNavalFlightOperations_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("NAVA", false, NavalFlightOperations_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public NavalFlightOperations_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<NavalFlightOperations_Full> CreateNavalFlightOperations_Full(FlatBufferBuilder builder,
    ...
    NavalFlightOperations_Full.AddSchdLaunchRcvyTime(builder, schdLaunchRcvyTimeOffset);
    NavalFlightOperations_Full.AddFltOpStop(builder, fltOpStopOffset);
    NavalFlightOperations_Full.AddFltOpStart(builder, fltOpStartOffset);
    NavalFlightOperations_Full.AddShipName(builder, shipNameOffset);
    return NavalFlightOperations_Full.EndNavalFlightOperations_Full(builder);
  }

  public static void StartNavalFlightOperations_Full(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<NavalFlightOperations_Full> EndNavalFlightOperations_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<NavalFlightOperations_Full>(o);
  }
  public static void FinishNavalFlightOperations_FullBuffer(FlatBufferBuilder builder, Offset<NavalFlightOperations_Full> offset) { builder.Finish(offset.Value, "NAVA"); }
  public static void FinishSizePrefixedNavalFlightOperations_FullBuffer(FlatBufferBuilder builder, Offset<NavalFlightOperations_Full> offset) { builder.FinishSizePrefixed(offset.Value, "NAVA"); }
  public NavalFlightOperations_FullT UnPack() {
    var _o = new NavalFlightOperations_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(NavalFlightOperations_FullT _o) {
  ...
  public static Offset<NavalFlightOperations_Full> Pack(FlatBufferBuilder builder, NavalFlightOperations_FullT _o) {
    if (_o == null) return default(Offset<NavalFlightOperations_Full>);
...
public class NavalFlightOperations_FullT
{
  ...
  public NavalFlightOperations_FullT() {
    this.ShipName = null;
    this.FltOpStart = null;
    this.FltOpStop = null;
    this.SchdLaunchRcvyTime = null;
  }
  public static NavalFlightOperations_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return NavalFlightOperations_Full.GetRootAsNavalFlightOperations_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    NavalFlightOperations_Full.FinishNavalFlightOperations_FullBuffer(fbb, NavalFlightOperations_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class NavalFlightOperations_FullVerify
{
