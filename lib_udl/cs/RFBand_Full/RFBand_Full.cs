...
public struct RFBand_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static RFBand_Full GetRootAsRFBand_Full(ByteBuffer _bb) { return GetRootAsRFBand_Full(_bb, new RFBand_Full()); }
  public static RFBand_Full GetRootAsRFBand_Full(ByteBuffer _bb, RFBand_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool RFBand_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "RFBA"); }
  public static bool VerifyRFBand_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("RFBA", false, RFBand_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public RFBand_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public RFBand_Full_mode_Enum Mode { get { int o = __p.__offset(14); return o != 0 ? (RFBand_Full_mode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFBand_Full_mode_Enum.TX; } }
  /// Purpose or use of the RF Band -- COMM = communications, TTC = Telemetry/Tracking/Control, OPS = Operations, OTHER = Other).
  /// Example: /// Example: TTC
  /// Constraints: Minimum length = 0, Maximum length = 16
  public RFBand_Full_purpose_Enum Purpose { get { int o = __p.__offset(16); return o != 0 ? (RFBand_Full_purpose_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFBand_Full_purpose_Enum.COMM; } }
  ...
  /// Example: /// Example: H
  /// Constraints: Minimum length = 0, Maximum length = 4
  public RFBand_Full_polarization_Enum Polarization { get { int o = __p.__offset(32); return o != 0 ? (RFBand_Full_polarization_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFBand_Full_polarization_Enum.H; } }
  ...
  public RFBand_Full_dataMode_Enum DataMode { get { int o = __p.__offset(42); return o != 0 ? (RFBand_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFBand_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<RFBand_Full> CreateRFBand_Full(FlatBufferBuilder builder,
      StringOffset idOffset = default(StringOffset),
      StringOffset idEntityOffset = default(StringOffset),
      StringOffset classificationMarkingOffset = default(StringOffset),
      StringOffset nameOffset = default(StringOffset),
      StringOffset bandOffset = default(StringOffset),
      RFBand_Full_mode_Enum mode = RFBand_Full_mode_Enum.TX,
      RFBand_Full_purpose_Enum purpose = RFBand_Full_purpose_Enum.COMM,
      double freqMin = 0.0,
      double freqMax = 0.0,
      ...
      RFBand_Full_polarization_Enum polarization = RFBand_Full_polarization_Enum.H,
      double erp = 0.0,
      double eirp = 0.0,
      StringOffset sourceOffset = default(StringOffset),
      StringOffset originOffset = default(StringOffset),
      RFBand_Full_dataMode_Enum dataMode = RFBand_Full_dataMode_Enum.REAL,
    ...
    RFBand_Full.AddEirp(builder, eirp);
    RFBand_Full.AddErp(builder, erp);
    RFBand_Full.AddBeamwidth(builder, beamwidth);
    RFBand_Full.AddBandwidth(builder, bandwidth);
    RFBand_Full.AddEdgeGain(builder, edgeGain);
    RFBand_Full.AddPeakGain(builder, peakGain);
    RFBand_Full.AddCenterFreq(builder, centerFreq);
    RFBand_Full.AddFreqMax(builder, freqMax);
    RFBand_Full.AddFreqMin(builder, freqMin);
    RFBand_Full.AddOrigNetwork(builder, origNetworkOffset);
    RFBand_Full.AddUpdatedBy(builder, updatedByOffset);
    RFBand_Full.AddUpdatedAt(builder, updatedAtOffset);
    RFBand_Full.AddCreatedBy(builder, createdByOffset);
    RFBand_Full.AddCreatedAt(builder, createdAtOffset);
    RFBand_Full.AddOrigin(builder, originOffset);
    RFBand_Full.AddSource(builder, sourceOffset);
    RFBand_Full.AddBand(builder, bandOffset);
    RFBand_Full.AddName(builder, nameOffset);
    RFBand_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    RFBand_Full.AddIdEntity(builder, idEntityOffset);
    RFBand_Full.AddId(builder, idOffset);
    RFBand_Full.AddDataMode(builder, dataMode);
    RFBand_Full.AddPolarization(builder, polarization);
    RFBand_Full.AddPurpose(builder, purpose);
    RFBand_Full.AddMode(builder, mode);
    return RFBand_Full.EndRFBand_Full(builder);
  }

  public static void StartRFBand_Full(FlatBufferBuilder builder) { builder.StartTable(25); }
  ...
  public static void AddMode(FlatBufferBuilder builder, RFBand_Full_mode_Enum mode) { builder.AddSbyte(5, (sbyte)mode, 0); }
  public static void AddPurpose(FlatBufferBuilder builder, RFBand_Full_purpose_Enum purpose) { builder.AddSbyte(6, (sbyte)purpose, 0); }
  ...
  public static void AddPolarization(FlatBufferBuilder builder, RFBand_Full_polarization_Enum polarization) { builder.AddSbyte(14, (sbyte)polarization, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, RFBand_Full_dataMode_Enum dataMode) { builder.AddSbyte(19, (sbyte)dataMode, 0); }
  ...
  public static Offset<RFBand_Full> EndRFBand_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RFBand_Full>(o);
  }
  public static void FinishRFBand_FullBuffer(FlatBufferBuilder builder, Offset<RFBand_Full> offset) { builder.Finish(offset.Value, "RFBA"); }
  public static void FinishSizePrefixedRFBand_FullBuffer(FlatBufferBuilder builder, Offset<RFBand_Full> offset) { builder.FinishSizePrefixed(offset.Value, "RFBA"); }
  public RFBand_FullT UnPack() {
    var _o = new RFBand_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RFBand_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<RFBand_Full> Pack(FlatBufferBuilder builder, RFBand_FullT _o) {
    if (_o == null) return default(Offset<RFBand_Full>);
...
public class RFBand_FullT
{
  ...
  public RFBand_Full_mode_Enum Mode { get; set; }
  public RFBand_Full_purpose_Enum Purpose { get; set; }
  ...
  public RFBand_Full_polarization_Enum Polarization { get; set; }
  public double Erp { get; set; }
  public double Eirp { get; set; }
  public string Source { get; set; }
  public string Origin { get; set; }
  public RFBand_Full_dataMode_Enum DataMode { get; set; }
  ...
  public RFBand_FullT() {
    ...
    this.Name = null;
    this.Band = null;
    this.Mode = RFBand_Full_mode_Enum.TX;
    this.Purpose = RFBand_Full_purpose_Enum.COMM;
    this.FreqMin = 0.0;
    this.FreqMax = 0.0;
    this.CenterFreq = 0.0;
    this.PeakGain = 0.0;
    ...
    this.Bandwidth = 0.0;
    this.Beamwidth = 0.0;
    this.Polarization = RFBand_Full_polarization_Enum.H;
    this.Erp = 0.0;
    this.Eirp = 0.0;
    this.Source = null;
    this.Origin = null;
    this.DataMode = RFBand_Full_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.UpdatedAt = null;
    this.UpdatedBy = null;
  ...
  public static RFBand_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return RFBand_Full.GetRootAsRFBand_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    RFBand_Full.FinishRFBand_FullBuffer(fbb, RFBand_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class RFBand_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*Mode*/, 1 /*RFBand_Full_mode_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 16 /*Purpose*/, 1 /*RFBand_Full_purpose_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 32 /*Polarization*/, 1 /*RFBand_Full_polarization_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 42 /*DataMode*/, 1 /*RFBand_Full_dataMode_Enum*/, 1, false)
