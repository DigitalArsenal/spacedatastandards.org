...
public struct Site_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Site_Full GetRootAsSite_Full(ByteBuffer _bb) { return GetRootAsSite_Full(_bb, new Site_Full()); }
  public static Site_Full GetRootAsSite_Full(ByteBuffer _bb, Site_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Site_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SITE"); }
  public static bool VerifySite_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SITE", false, Site_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Site_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string SiteRemarks(int j) { int o = __p.__offset(124); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int SiteRemarksLength { get { int o = __p.__offset(124); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Time the row was created in the database, auto-populated by the system.
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string CreatedAt { get { int o = __p.__offset(126); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedAtBytes() { return __p.__vector_as_span<byte>(126, 1); }
#else
  public ArraySegment<byte>? GetCreatedAtBytes() { return __p.__vector_as_arraysegment(126); }
#endif
  public byte[] GetCreatedAtArray() { return __p.__vector_as_array<byte>(126); }
  /// Application user who created the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string CreatedBy { get { int o = __p.__offset(128); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedByBytes() { return __p.__vector_as_span<byte>(128, 1); }
#else
  public ArraySegment<byte>? GetCreatedByBytes() { return __p.__vector_as_arraysegment(128); }
#endif
  public byte[] GetCreatedByArray() { return __p.__vector_as_array<byte>(128); }
  /// Time the row was updated in the database, auto-populated by the system.
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string UpdatedAt { get { int o = __p.__offset(130); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedAtBytes() { return __p.__vector_as_span<byte>(130, 1); }
#else
  public ArraySegment<byte>? GetUpdatedAtBytes() { return __p.__vector_as_arraysegment(130); }
#endif
  public byte[] GetUpdatedAtArray() { return __p.__vector_as_array<byte>(130); }
  /// Application user who updated the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string UpdatedBy { get { int o = __p.__offset(132); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedByBytes() { return __p.__vector_as_span<byte>(132, 1); }
#else
  public ArraySegment<byte>? GetUpdatedByBytes() { return __p.__vector_as_arraysegment(132); }
#endif
  public byte[] GetUpdatedByArray() { return __p.__vector_as_array<byte>(132); }
  /// Source of the data.
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Site_Full_dataMode_Enum DataMode { get { int o = __p.__offset(140); return o != 0 ? (Site_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Site_Full_dataMode_Enum.REAL; } }

  public static Offset<Site_Full> CreateSite_Full(FlatBufferBuilder builder,
      ...
      VectorOffset siteRemarksOffset = default(VectorOffset),
      ...
      Site_Full_dataMode_Enum dataMode = Site_Full_dataMode_Enum.REAL) {
    builder.StartTable(69);
    Site_Full.AddPopAreaProx(builder, popAreaProx);
    Site_Full.AddVegHt(builder, vegHt);
    Site_Full.AddElevMslDerivAcc(builder, elevMslDerivAcc);
    Site_Full.AddElevMsl(builder, elevMsl);
    Site_Full.AddGeoidalMslSep(builder, geoidalMslSep);
    Site_Full.AddCoordDerivAcc(builder, coordDerivAcc);
    Site_Full.AddOrigNetwork(builder, origNetworkOffset);
    Site_Full.AddOrigin(builder, originOffset);
    Site_Full.AddSource(builder, sourceOffset);
    Site_Full.AddUpdatedBy(builder, updatedByOffset);
    Site_Full.AddUpdatedAt(builder, updatedAtOffset);
    Site_Full.AddCreatedBy(builder, createdByOffset);
    Site_Full.AddCreatedAt(builder, createdAtOffset);
    Site_Full.AddSiteRemarks(builder, siteRemarksOffset);
    Site_Full.AddReferenceDoc(builder, referenceDocOffset);
    Site_Full.AddSymCode(builder, symCodeOffset);
    Site_Full.AddRecStatus(builder, recStatusOffset);
    Site_Full.AddReviewDate(builder, reviewDateOffset);
    Site_Full.AddEval(builder, eval);
    Site_Full.AddResProd(builder, resProdOffset);
    Site_Full.AddNotes(builder, notesOffset);
    Site_Full.AddVegType(builder, vegTypeOffset);
    Site_Full.AddElevMslConfLvl(builder, elevMslConfLvl);
    Site_Full.AddIdent(builder, identOffset);
    Site_Full.AddNucCap(builder, nucCapOffset);
    Site_Full.AddMsnPrimarySpec(builder, msnPrimarySpecOffset);
    Site_Full.AddMsnPrimary(builder, msnPrimaryOffset);
    Site_Full.AddFunctPrimary(builder, functPrimaryOffset);
    Site_Full.AddActivity(builder, activityOffset);
    Site_Full.AddGrade(builder, grade);
    Site_Full.AddOperStatus(builder, operStatusOffset);
    Site_Full.AddConditionAvail(builder, conditionAvailOffset);
    Site_Full.AddCondition(builder, conditionOffset);
    Site_Full.AddMaxRunwayLength(builder, maxRunwayLength);
    Site_Full.AddRunways(builder, runways);
    Site_Full.AddBeNumber(builder, beNumberOffset);
    Site_Full.AddFpa(builder, fpaOffset);
    Site_Full.AddClassRating(builder, classRatingOffset);
    Site_Full.AddAltAllegiance(builder, altAllegianceOffset);
    Site_Full.AddAllegiance(builder, allegianceOffset);
    Site_Full.AddGeoArea(builder, geoAreaOffset);
    Site_Full.AddPolSubdiv(builder, polSubdivOffset);
    Site_Full.AddWac(builder, wacOffset);
    Site_Full.AddCatText(builder, catTextOffset);
    Site_Full.AddCatCode(builder, catCodeOffset);
    Site_Full.AddMilGrid(builder, milGridOffset);
    Site_Full.AddMilGridSys(builder, milGridSysOffset);
    Site_Full.AddUtm(builder, utmOffset);
    Site_Full.AddAirDefArea(builder, airDefAreaOffset);
    Site_Full.AddFaa(builder, faaOffset);
    Site_Full.AddIcao(builder, icaoOffset);
    Site_Full.AddIata(builder, iataOffset);
    Site_Full.AddOsuffix(builder, osuffixOffset);
    Site_Full.AddCoord(builder, coordOffset);
    Site_Full.AddCoordDatum(builder, coordDatumOffset);
    Site_Full.AddName(builder, nameOffset);
    Site_Full.AddLzUsage(builder, lzUsageOffset);
    Site_Full.AddUsage(builder, usageOffset);
    Site_Full.AddType(builder, typeOffset);
    Site_Full.AddPin(builder, pinOffset);
    Site_Full.AddOrigLzId(builder, origLzIdOffset);
    Site_Full.AddOrigSiteID(builder, origSiteIDOffset);
    Site_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    Site_Full.AddIdParentSite(builder, idParentSiteOffset);
    Site_Full.AddIdEntity(builder, idEntityOffset);
    Site_Full.AddEntity(builder, entityOffset);
    Site_Full.AddId(builder, idOffset);
    Site_Full.AddDataMode(builder, dataMode);
    Site_Full.AddPopArea(builder, popArea);
    return Site_Full.EndSite_Full(builder);
  }

  public static void StartSite_Full(FlatBufferBuilder builder) { builder.StartTable(69); }
  ...
  public static void AddSiteRemarks(FlatBufferBuilder builder, VectorOffset siteRemarksOffset) { builder.AddOffset(60, siteRemarksOffset.Value, 0); }
  public static VectorOffset CreateSiteRemarksVector(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateSiteRemarksVectorBlock(FlatBufferBuilder builder, StringOffset[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSiteRemarksVectorBlock(FlatBufferBuilder builder, ArraySegment<StringOffset> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateSiteRemarksVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<StringOffset>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartSiteRemarksVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static void AddCreatedAt(FlatBufferBuilder builder, StringOffset createdAtOffset) { builder.AddOffset(61, createdAtOffset.Value, 0); }
  public static void AddCreatedBy(FlatBufferBuilder builder, StringOffset createdByOffset) { builder.AddOffset(62, createdByOffset.Value, 0); }
  public static void AddUpdatedAt(FlatBufferBuilder builder, StringOffset updatedAtOffset) { builder.AddOffset(63, updatedAtOffset.Value, 0); }
  public static void AddUpdatedBy(FlatBufferBuilder builder, StringOffset updatedByOffset) { builder.AddOffset(64, updatedByOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Site_Full_dataMode_Enum dataMode) { builder.AddSbyte(68, (sbyte)dataMode, 0); }
  public static Offset<Site_Full> EndSite_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Site_Full>(o);
  }
  public static void FinishSite_FullBuffer(FlatBufferBuilder builder, Offset<Site_Full> offset) { builder.Finish(offset.Value, "SITE"); }
  public static void FinishSizePrefixedSite_FullBuffer(FlatBufferBuilder builder, Offset<Site_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SITE"); }
  public Site_FullT UnPack() {
    var _o = new Site_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Site_FullT _o) {
    _o.Id = this.Id;
    ...
    _o.SiteRemarks = new List<string>();
    for (var _j = 0; _j < this.SiteRemarksLength; ++_j) {_o.SiteRemarks.Add(this.SiteRemarks(_j));}
  ...
  public static Offset<Site_Full> Pack(FlatBufferBuilder builder, Site_FullT _o) {
    if (_o == null) return default(Offset<Site_Full>);
    ...
    var _siteRemarks = default(VectorOffset);
    if (_o.SiteRemarks != null) {
      var __siteRemarks = new StringOffset[_o.SiteRemarks.Count];
      for (var _j = 0; _j < __siteRemarks.Length; ++_j) { __siteRemarks[_j] = builder.CreateString(_o.SiteRemarks[_j]); }
      _siteRemarks = CreateSiteRemarksVector(builder, __siteRemarks);
    }
...
public class Site_FullT
{
  ...
  public List<string> SiteRemarks { get; set; }
  ...
  public Site_Full_dataMode_Enum DataMode { get; set; }
  ...
  public Site_FullT() {
    ...
    this.DataMode = Site_Full_dataMode_Enum.REAL;
  }
  public static Site_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Site_Full.GetRootAsSite_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Site_Full.FinishSite_FullBuffer(fbb, Site_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Site_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfStrings(tablePos, 124 /*SiteRemarks*/, false)
      && verifier.VerifyString(tablePos, 126 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 128 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 130 /*UpdatedAt*/, false)
      && verifier.VerifyString(tablePos, 132 /*UpdatedBy*/, false)
      ...
      && verifier.VerifyField(tablePos, 140 /*DataMode*/, 1 /*Site_Full_dataMode_Enum*/, 1, false)
