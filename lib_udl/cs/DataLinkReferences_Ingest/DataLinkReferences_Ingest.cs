...
public struct DataLinkReferences_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static DataLinkReferences_Ingest GetRootAsDataLinkReferences_Ingest(ByteBuffer _bb) { return GetRootAsDataLinkReferences_Ingest(_bb, new DataLinkReferences_Ingest()); }
  public static DataLinkReferences_Ingest GetRootAsDataLinkReferences_Ingest(ByteBuffer _bb, DataLinkReferences_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DataLinkReferences_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DATA"); }
  public static bool VerifyDataLinkReferences_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DATA", false, DataLinkReferences_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public DataLinkReferences_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<DataLinkReferences_Ingest> CreateDataLinkReferences_Ingest(FlatBufferBuilder builder,
  ...
  public static void StartDataLinkReferences_Ingest(FlatBufferBuilder builder) { builder.StartTable(7); }
  ...
  public static Offset<DataLinkReferences_Ingest> EndDataLinkReferences_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DataLinkReferences_Ingest>(o);
  }
  public static void FinishDataLinkReferences_IngestBuffer(FlatBufferBuilder builder, Offset<DataLinkReferences_Ingest> offset) { builder.Finish(offset.Value, "DATA"); }
  public static void FinishSizePrefixedDataLinkReferences_IngestBuffer(FlatBufferBuilder builder, Offset<DataLinkReferences_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "DATA"); }
  public DataLinkReferences_IngestT UnPack() {
    var _o = new DataLinkReferences_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DataLinkReferences_IngestT _o) {
  ...
  public static Offset<DataLinkReferences_Ingest> Pack(FlatBufferBuilder builder, DataLinkReferences_IngestT _o) {
    if (_o == null) return default(Offset<DataLinkReferences_Ingest>);
    ...
    return CreateDataLinkReferences_Ingest(
      builder,
      _refSerialId,
      _refType,
      _refOriginator,
...
public class DataLinkReferences_IngestT
{
  ...
  public DataLinkReferences_IngestT() {
  ...
  public static DataLinkReferences_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return DataLinkReferences_Ingest.GetRootAsDataLinkReferences_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DataLinkReferences_Ingest.FinishDataLinkReferences_IngestBuffer(fbb, DataLinkReferences_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DataLinkReferences_IngestVerify
{
