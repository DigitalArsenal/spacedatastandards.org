...
public struct Operatingunit_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Operatingunit_Abridged GetRootAsOperatingunit_Abridged(ByteBuffer _bb) { return GetRootAsOperatingunit_Abridged(_bb, new Operatingunit_Abridged()); }
  public static Operatingunit_Abridged GetRootAsOperatingunit_Abridged(ByteBuffer _bb, Operatingunit_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Operatingunit_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "OPER"); }
  public static bool VerifyOperatingunit_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("OPER", false, Operatingunit_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Operatingunit_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: No constraints specified.
  public string CreatedAt { get { int o = __p.__offset(114); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedAtBytes() { return __p.__vector_as_span<byte>(114, 1); }
#else
  public ArraySegment<byte>? GetCreatedAtBytes() { return __p.__vector_as_arraysegment(114); }
#endif
  public byte[] GetCreatedAtArray() { return __p.__vector_as_array<byte>(114); }
  /// Application user who created the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string CreatedBy { get { int o = __p.__offset(116); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedByBytes() { return __p.__vector_as_span<byte>(116, 1); }
#else
  public ArraySegment<byte>? GetCreatedByBytes() { return __p.__vector_as_arraysegment(116); }
#endif
  public byte[] GetCreatedByArray() { return __p.__vector_as_array<byte>(116); }
  /// Source of the data.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string Source { get { int o = __p.__offset(118); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceBytes() { return __p.__vector_as_span<byte>(118, 1); }
#else
  public ArraySegment<byte>? GetSourceBytes() { return __p.__vector_as_arraysegment(118); }
#endif
  public byte[] GetSourceArray() { return __p.__vector_as_array<byte>(118); }
  /// Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
  /// Example: /// Example: THIRD_PARTY_DATASOURCE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Origin { get { int o = __p.__offset(120); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOriginBytes() { return __p.__vector_as_span<byte>(120, 1); }
#else
  public ArraySegment<byte>? GetOriginBytes() { return __p.__vector_as_arraysegment(120); }
#endif
  public byte[] GetOriginArray() { return __p.__vector_as_array<byte>(120); }
  ...
  public Operatingunit_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(122); return o != 0 ? (Operatingunit_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Operatingunit_Abridged_dataMode_Enum.REAL; } }

  public static Offset<Operatingunit_Abridged> CreateOperatingunit_Abridged(FlatBufferBuilder builder,
      ...
      Operatingunit_Abridged_dataMode_Enum dataMode = Operatingunit_Abridged_dataMode_Enum.REAL) {
    builder.StartTable(60);
    Operatingunit_Abridged.AddGeoidalMslSep(builder, geoidalMslSep);
    Operatingunit_Abridged.AddElevMslDerivAcc(builder, elevMslDerivAcc);
    Operatingunit_Abridged.AddElevMsl(builder, elevMsl);
    Operatingunit_Abridged.AddLon(builder, lon);
    Operatingunit_Abridged.AddLat(builder, lat);
    Operatingunit_Abridged.AddCoordDerivAcc(builder, coordDerivAcc);
    Operatingunit_Abridged.AddOrigin(builder, originOffset);
    Operatingunit_Abridged.AddSource(builder, sourceOffset);
    Operatingunit_Abridged.AddCreatedBy(builder, createdByOffset);
    Operatingunit_Abridged.AddCreatedAt(builder, createdAtOffset);
    Operatingunit_Abridged.AddReferenceDoc(builder, referenceDocOffset);
    Operatingunit_Abridged.AddResProd(builder, resProdOffset);
    Operatingunit_Abridged.AddReviewDate(builder, reviewDateOffset);
    Operatingunit_Abridged.AddRecStatus(builder, recStatusOffset);
    Operatingunit_Abridged.AddClassRating(builder, classRatingOffset);
    Operatingunit_Abridged.AddSymCode(builder, symCodeOffset);
    Operatingunit_Abridged.AddPolSubdiv(builder, polSubdivOffset);
    Operatingunit_Abridged.AddAirDefArea(builder, airDefAreaOffset);
    Operatingunit_Abridged.AddUtm(builder, utmOffset);
    Operatingunit_Abridged.AddMilGrid(builder, milGridOffset);
    Operatingunit_Abridged.AddMilGridSys(builder, milGridSysOffset);
    Operatingunit_Abridged.AddElevMslConfLvl(builder, elevMslConfLvl);
    Operatingunit_Abridged.AddCoord(builder, coordOffset);
    Operatingunit_Abridged.AddCoordDatum(builder, coordDatumOffset);
    Operatingunit_Abridged.AddFlagFlown(builder, flagFlownOffset);
    Operatingunit_Abridged.AddDeployStatus(builder, deployStatusOffset);
    Operatingunit_Abridged.AddFleetId(builder, fleetIdOffset);
    Operatingunit_Abridged.AddEchelonTier(builder, echelonTierOffset);
    Operatingunit_Abridged.AddEchelon(builder, echelonOffset);
    Operatingunit_Abridged.AddDivCat(builder, divCatOffset);
    Operatingunit_Abridged.AddMsnPrimarySpecialty(builder, msnPrimarySpecialtyOffset);
    Operatingunit_Abridged.AddMsnPrimary(builder, msnPrimaryOffset);
    Operatingunit_Abridged.AddFunctRole(builder, functRoleOffset);
    Operatingunit_Abridged.AddForceName(builder, forceNameOffset);
    Operatingunit_Abridged.AddForce(builder, forceOffset);
    Operatingunit_Abridged.AddLocReason(builder, locReasonOffset);
    Operatingunit_Abridged.AddLocName(builder, locNameOffset);
    Operatingunit_Abridged.AddAltAllegiance(builder, altAllegianceOffset);
    Operatingunit_Abridged.AddAllegiance(builder, allegianceOffset);
    Operatingunit_Abridged.AddIdent(builder, identOffset);
    Operatingunit_Abridged.AddFpa(builder, fpaOffset);
    Operatingunit_Abridged.AddEval(builder, eval);
    Operatingunit_Abridged.AddConditionAvail(builder, conditionAvailOffset);
    Operatingunit_Abridged.AddCondition(builder, conditionOffset);
    Operatingunit_Abridged.AddOperStatus(builder, operStatusOffset);
    Operatingunit_Abridged.AddWac(builder, wacOffset);
    Operatingunit_Abridged.AddAltCountryCode(builder, altCountryCodeOffset);
    Operatingunit_Abridged.AddCountryCode(builder, countryCodeOffset);
    Operatingunit_Abridged.AddUnitIdentifier(builder, unitIdentifierOffset);
    Operatingunit_Abridged.AddIdOrganization(builder, idOrganizationOffset);
    Operatingunit_Abridged.AddIdContact(builder, idContactOffset);
    Operatingunit_Abridged.AddIdLocation(builder, idLocationOffset);
    Operatingunit_Abridged.AddDescription(builder, descriptionOffset);
    Operatingunit_Abridged.AddName(builder, nameOffset);
    Operatingunit_Abridged.AddAltOperatingUnitId(builder, altOperatingUnitIdOffset);
    Operatingunit_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    Operatingunit_Abridged.AddIdOperatingUnit(builder, idOperatingUnitOffset);
    Operatingunit_Abridged.AddDataMode(builder, dataMode);
    Operatingunit_Abridged.AddStylizedUnit(builder, stylizedUnit);
    Operatingunit_Abridged.AddMasterUnit(builder, masterUnit);
    return Operatingunit_Abridged.EndOperatingunit_Abridged(builder);
  }

  public static void StartOperatingunit_Abridged(FlatBufferBuilder builder) { builder.StartTable(60); }
  ...
  public static void AddCreatedAt(FlatBufferBuilder builder, StringOffset createdAtOffset) { builder.AddOffset(55, createdAtOffset.Value, 0); }
  public static void AddCreatedBy(FlatBufferBuilder builder, StringOffset createdByOffset) { builder.AddOffset(56, createdByOffset.Value, 0); }
  public static void AddSource(FlatBufferBuilder builder, StringOffset sourceOffset) { builder.AddOffset(57, sourceOffset.Value, 0); }
  public static void AddOrigin(FlatBufferBuilder builder, StringOffset originOffset) { builder.AddOffset(58, originOffset.Value, 0); }
  public static void AddDataMode(FlatBufferBuilder builder, Operatingunit_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(59, (sbyte)dataMode, 0); }
  public static Offset<Operatingunit_Abridged> EndOperatingunit_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Operatingunit_Abridged>(o);
  }
  public static void FinishOperatingunit_AbridgedBuffer(FlatBufferBuilder builder, Offset<Operatingunit_Abridged> offset) { builder.Finish(offset.Value, "OPER"); }
  public static void FinishSizePrefixedOperatingunit_AbridgedBuffer(FlatBufferBuilder builder, Offset<Operatingunit_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "OPER"); }
  public Operatingunit_AbridgedT UnPack() {
    var _o = new Operatingunit_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Operatingunit_AbridgedT _o) {
  ...
  public static Offset<Operatingunit_Abridged> Pack(FlatBufferBuilder builder, Operatingunit_AbridgedT _o) {
    if (_o == null) return default(Offset<Operatingunit_Abridged>);
...
public class Operatingunit_AbridgedT
{
  ...
  public Operatingunit_Abridged_dataMode_Enum DataMode { get; set; }

  public Operatingunit_AbridgedT() {
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Operatingunit_Abridged_dataMode_Enum.REAL;
  }
  public static Operatingunit_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Operatingunit_Abridged.GetRootAsOperatingunit_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Operatingunit_Abridged.FinishOperatingunit_AbridgedBuffer(fbb, Operatingunit_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Operatingunit_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyString(tablePos, 114 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 116 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 118 /*Source*/, false)
      && verifier.VerifyString(tablePos, 120 /*Origin*/, false)
      && verifier.VerifyField(tablePos, 122 /*DataMode*/, 1 /*Operatingunit_Abridged_dataMode_Enum*/, 1, false)
