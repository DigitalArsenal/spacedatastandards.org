...
/// /// ISR Collection data.
public struct ISRCollection_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static ISRCollection_Full GetRootAsISRCollection_Full(ByteBuffer _bb) { return GetRootAsISRCollection_Full(_bb, new ISRCollection_Full()); }
  public static ISRCollection_Full GetRootAsISRCollection_Full(ByteBuffer _bb, ISRCollection_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool ISRCollection_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ISRC"); }
  public static bool VerifyISRCollection_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ISRC", false, ISRCollection_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ISRCollection_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public ISRCollection_Full_dataMode_Enum DataMode { get { int o = __p.__offset(68); return o != 0 ? (ISRCollection_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : ISRCollection_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<ISRCollection_Full> CreateISRCollection_Full(FlatBufferBuilder builder,
      ...
      ISRCollection_Full_dataMode_Enum dataMode = ISRCollection_Full_dataMode_Enum.REAL,
      StringOffset origNetworkOffset = default(StringOffset)) {
    builder.StartTable(34);
    ISRCollection_Full.AddMissionStartPointLong(builder, missionStartPointLong);
    ISRCollection_Full.AddMissionStartPointLat(builder, missionStartPointLat);
    ISRCollection_Full.AddOrigNetwork(builder, origNetworkOffset);
    ISRCollection_Full.AddOrigin(builder, originOffset);
    ISRCollection_Full.AddSource(builder, sourceOffset);
    ISRCollection_Full.AddUpdatedBy(builder, updatedByOffset);
    ISRCollection_Full.AddUpdatedAt(builder, updatedAtOffset);
    ISRCollection_Full.AddCreatedBy(builder, createdByOffset);
    ISRCollection_Full.AddCreatedAt(builder, createdAtOffset);
    ISRCollection_Full.AddTaskings(builder, taskingsOffset);
    ISRCollection_Full.AddTransit(builder, transitOffset);
    ISRCollection_Full.AddCollectionRequirements(builder, collectionRequirementsOffset);
    ISRCollection_Full.AddMissionSubRegion(builder, missionSubRegionOffset);
    ISRCollection_Full.AddMissionRegion(builder, missionRegionOffset);
    ISRCollection_Full.AddMissionCountry(builder, missionCountryOffset);
    ISRCollection_Full.AddMissionSyncMatrixBin(builder, missionSyncMatrixBinOffset);
    ISRCollection_Full.AddMissionJoa(builder, missionJoaOffset);
    ISRCollection_Full.AddMissionCollectionArea(builder, missionCollectionAreaOffset);
    ISRCollection_Full.AddMissionEmphasis(builder, missionEmphasisOffset);
    ISRCollection_Full.AddMissionSupportedUnit(builder, missionSupportedUnitOffset);
    ISRCollection_Full.AddMissionPriority(builder, missionPriority);
    ISRCollection_Full.AddMissionOperation(builder, missionOperationOffset);
    ISRCollection_Full.AddMissionRole(builder, missionRoleOffset);
    ISRCollection_Full.AddMissionSecondarySubCategory(builder, missionSecondarySubCategoryOffset);
    ISRCollection_Full.AddMissionSecondaryIntelDiscipline(builder, missionSecondaryIntelDisciplineOffset);
    ISRCollection_Full.AddMissionPrimarySubCategory(builder, missionPrimarySubCategoryOffset);
    ISRCollection_Full.AddMissionPrimaryIntelDiscipline(builder, missionPrimaryIntelDisciplineOffset);
    ISRCollection_Full.AddMissionAOR(builder, missionAOROffset);
    ISRCollection_Full.AddMissionId(builder, missionIdOffset);
    ISRCollection_Full.AddName(builder, nameOffset);
    ISRCollection_Full.AddIdexVersion(builder, idexVersion);
    ISRCollection_Full.AddClassificationMarking(builder, classificationMarkingOffset);
    ISRCollection_Full.AddId(builder, idOffset);
    ISRCollection_Full.AddDataMode(builder, dataMode);
    return ISRCollection_Full.EndISRCollection_Full(builder);
  }

  public static void StartISRCollection_Full(FlatBufferBuilder builder) { builder.StartTable(34); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, ISRCollection_Full_dataMode_Enum dataMode) { builder.AddSbyte(32, (sbyte)dataMode, 0); }
  ...
  public static Offset<ISRCollection_Full> EndISRCollection_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ISRCollection_Full>(o);
  }
  public static void FinishISRCollection_FullBuffer(FlatBufferBuilder builder, Offset<ISRCollection_Full> offset) { builder.Finish(offset.Value, "ISRC"); }
  public static void FinishSizePrefixedISRCollection_FullBuffer(FlatBufferBuilder builder, Offset<ISRCollection_Full> offset) { builder.FinishSizePrefixed(offset.Value, "ISRC"); }
  public ISRCollection_FullT UnPack() {
    var _o = new ISRCollection_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(ISRCollection_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<ISRCollection_Full> Pack(FlatBufferBuilder builder, ISRCollection_FullT _o) {
    if (_o == null) return default(Offset<ISRCollection_Full>);
...
public class ISRCollection_FullT
{
  ...
  public ISRCollection_Full_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public ISRCollection_FullT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = ISRCollection_Full_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static ISRCollection_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return ISRCollection_Full.GetRootAsISRCollection_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    ISRCollection_Full.FinishISRCollection_FullBuffer(fbb, ISRCollection_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class ISRCollection_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 68 /*DataMode*/, 1 /*ISRCollection_Full_dataMode_Enum*/, 1, false)
