...
public struct OnorbitAntenna : IFlatbufferObject
{
  private Table __p;
  ...
  public static OnorbitAntenna GetRootAsOnorbitAntenna(ByteBuffer _bb, OnorbitAntenna obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OnorbitAntennaBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONOR"); }
  public static bool VerifyOnorbitAntenna(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONOR", false, OnorbitAntennaVerify.Verify); }
  ...
  public OnorbitAntenna_dataMode_Enum DataMode { get { int o = __p.__offset(24); return o != 0 ? (OnorbitAntenna_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OnorbitAntenna_dataMode_Enum.REAL; } }
  ...
  public static Offset<OnorbitAntenna> CreateOnorbitAntenna(FlatBufferBuilder builder,
      ...
      OnorbitAntenna_dataMode_Enum dataMode = OnorbitAntenna_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OnorbitAntenna_dataMode_Enum dataMode) { builder.AddSbyte(10, (sbyte)dataMode, 0); }
  ...
  public static Offset<OnorbitAntenna> EndOnorbitAntenna(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OnorbitAntenna>(o);
  }
  public static void FinishOnorbitAntennaBuffer(FlatBufferBuilder builder, Offset<OnorbitAntenna> offset) { builder.Finish(offset.Value, "ONOR"); }
  public static void FinishSizePrefixedOnorbitAntennaBuffer(FlatBufferBuilder builder, Offset<OnorbitAntenna> offset) { builder.FinishSizePrefixed(offset.Value, "ONOR"); }
  public OnorbitAntennaT UnPack() {
    var _o = new OnorbitAntennaT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OnorbitAntennaT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OnorbitAntenna> Pack(FlatBufferBuilder builder, OnorbitAntennaT _o) {
    if (_o == null) return default(Offset<OnorbitAntenna>);
...
public class OnorbitAntennaT
{
  ...
  public OnorbitAntenna_dataMode_Enum DataMode { get; set; }
  public string Antenna { get; set; }
  public string OrigNetwork { get; set; }

  public OnorbitAntennaT() {
    this.Id = null;
    this.IdOnOrbit = null;
    this.IdAntenna = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = OnorbitAntenna_dataMode_Enum.REAL;
    this.Antenna = null;
    this.OrigNetwork = null;
  }
  public static OnorbitAntennaT DeserializeFromBinary(byte[] fbBuffer) {
    return OnorbitAntenna.GetRootAsOnorbitAntenna(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OnorbitAntenna.FinishOnorbitAntennaBuffer(fbb, OnorbitAntenna.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OnorbitAntennaVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 24 /*DataMode*/, 1 /*OnorbitAntenna_dataMode_Enum*/, 1, false)
