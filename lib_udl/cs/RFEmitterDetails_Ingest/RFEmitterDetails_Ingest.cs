...
public struct RFEmitterDetails_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static RFEmitterDetails_Ingest GetRootAsRFEmitterDetails_Ingest(ByteBuffer _bb) { return GetRootAsRFEmitterDetails_Ingest(_bb, new RFEmitterDetails_Ingest()); }
  public static RFEmitterDetails_Ingest GetRootAsRFEmitterDetails_Ingest(ByteBuffer _bb, RFEmitterDetails_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool RFEmitterDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "RFEM"); }
  public static bool VerifyRFEmitterDetails_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("RFEM", false, RFEmitterDetails_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public RFEmitterDetails_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public RFEmitterDetails_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(68); return o != 0 ? (RFEmitterDetails_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFEmitterDetails_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<RFEmitterDetails_Ingest> CreateRFEmitterDetails_Ingest(FlatBufferBuilder builder,
      ...
      RFEmitterDetails_Ingest_dataMode_Enum dataMode = RFEmitterDetails_Ingest_dataMode_Enum.REAL,
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset)) {
    builder.StartTable(35);
    RFEmitterDetails_Ingest.AddAntennaDiameter(builder, antennaDiameter);
    RFEmitterDetails_Ingest.AddDrfmInstantaneousBandwidth(builder, drfmInstantaneousBandwidth);
    RFEmitterDetails_Ingest.AddDopplerNoise(builder, dopplerNoise);
    RFEmitterDetails_Ingest.AddBarrageNoiseBandwidth(builder, barrageNoiseBandwidth);
    RFEmitterDetails_Ingest.AddTransmitPower(builder, transmitPower);
    RFEmitterDetails_Ingest.AddTransmitterBandwidth(builder, transmitterBandwidth);
    RFEmitterDetails_Ingest.AddTransmitterFrequency(builder, transmitterFrequency);
    RFEmitterDetails_Ingest.AddReceiverBandwidth(builder, receiverBandwidth);
    RFEmitterDetails_Ingest.AddReceiverSensitivity(builder, receiverSensitivity);
    RFEmitterDetails_Ingest.AddSystemSensitivityEnd(builder, systemSensitivityEnd);
    RFEmitterDetails_Ingest.AddSystemSensitivityStart(builder, systemSensitivityStart);
    RFEmitterDetails_Ingest.AddCreatedBy(builder, createdByOffset);
    RFEmitterDetails_Ingest.AddCreatedAt(builder, createdAtOffset);
    RFEmitterDetails_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    RFEmitterDetails_Ingest.AddOrigin(builder, originOffset);
    RFEmitterDetails_Ingest.AddSource(builder, sourceOffset);
    RFEmitterDetails_Ingest.AddUrls(builder, urlsOffset);
    RFEmitterDetails_Ingest.AddDescription(builder, descriptionOffset);
    RFEmitterDetails_Ingest.AddSecondaryNotes(builder, secondaryNotesOffset);
    RFEmitterDetails_Ingest.AddNotes(builder, notesOffset);
    RFEmitterDetails_Ingest.AddAntennaSize(builder, antennaSizeOffset);
    RFEmitterDetails_Ingest.AddNumBits(builder, numBits);
    RFEmitterDetails_Ingest.AddNumChannels(builder, numChannels);
    RFEmitterDetails_Ingest.AddReceiverType(builder, receiverTypeOffset);
    RFEmitterDetails_Ingest.AddProductionFacilityLocationId(builder, productionFacilityLocationIdOffset);
    RFEmitterDetails_Ingest.AddManufacturerOrgId(builder, manufacturerOrgIdOffset);
    RFEmitterDetails_Ingest.AddAlternateFacilityName(builder, alternateFacilityNameOffset);
    RFEmitterDetails_Ingest.AddProductionFacilityName(builder, productionFacilityNameOffset);
    RFEmitterDetails_Ingest.AddFamily(builder, familyOffset);
    RFEmitterDetails_Ingest.AddAltName(builder, altNameOffset);
    RFEmitterDetails_Ingest.AddDesignator(builder, designatorOffset);
    RFEmitterDetails_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    RFEmitterDetails_Ingest.AddIdRFEmitter(builder, idRFEmitterOffset);
    RFEmitterDetails_Ingest.AddId(builder, idOffset);
    RFEmitterDetails_Ingest.AddDataMode(builder, dataMode);
    return RFEmitterDetails_Ingest.EndRFEmitterDetails_Ingest(builder);
  }

  public static void StartRFEmitterDetails_Ingest(FlatBufferBuilder builder) { builder.StartTable(35); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, RFEmitterDetails_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(32, (sbyte)dataMode, 0); }
  ...
  public static Offset<RFEmitterDetails_Ingest> EndRFEmitterDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RFEmitterDetails_Ingest>(o);
  }
  public static void FinishRFEmitterDetails_IngestBuffer(FlatBufferBuilder builder, Offset<RFEmitterDetails_Ingest> offset) { builder.Finish(offset.Value, "RFEM"); }
  public static void FinishSizePrefixedRFEmitterDetails_IngestBuffer(FlatBufferBuilder builder, Offset<RFEmitterDetails_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "RFEM"); }
  public RFEmitterDetails_IngestT UnPack() {
    var _o = new RFEmitterDetails_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RFEmitterDetails_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<RFEmitterDetails_Ingest> Pack(FlatBufferBuilder builder, RFEmitterDetails_IngestT _o) {
    if (_o == null) return default(Offset<RFEmitterDetails_Ingest>);
...
public class RFEmitterDetails_IngestT
{
  ...
  public RFEmitterDetails_Ingest_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }

  public RFEmitterDetails_IngestT() {
    this.Id = null;
    ...
    this.DataMode = RFEmitterDetails_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
  }
  public static RFEmitterDetails_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return RFEmitterDetails_Ingest.GetRootAsRFEmitterDetails_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    RFEmitterDetails_Ingest.FinishRFEmitterDetails_IngestBuffer(fbb, RFEmitterDetails_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class RFEmitterDetails_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 68 /*DataMode*/, 1 /*RFEmitterDetails_Ingest_dataMode_Enum*/, 1, false)
