...
public struct IonoObservationFrequency_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationFrequency_Ingest GetRootAsIonoObservationFrequency_Ingest(ByteBuffer _bb) { return GetRootAsIonoObservationFrequency_Ingest(_bb, new IonoObservationFrequency_Ingest()); }
  public static IonoObservationFrequency_Ingest GetRootAsIonoObservationFrequency_Ingest(ByteBuffer _bb, IonoObservationFrequency_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationFrequency_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationFrequency_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationFrequency_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationFrequency_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationFrequency_Ingest> CreateIonoObservationFrequency_Ingest(FlatBufferBuilder builder,
  ...
  public static void StartIonoObservationFrequency_Ingest(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationFrequency_Ingest> EndIonoObservationFrequency_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationFrequency_Ingest>(o);
  }
  public static void FinishIonoObservationFrequency_IngestBuffer(FlatBufferBuilder builder, Offset<IonoObservationFrequency_Ingest> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationFrequency_IngestBuffer(FlatBufferBuilder builder, Offset<IonoObservationFrequency_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationFrequency_IngestT UnPack() {
    var _o = new IonoObservationFrequency_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationFrequency_IngestT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationFrequency_Ingest> Pack(FlatBufferBuilder builder, IonoObservationFrequency_IngestT _o) {
    if (_o == null) return default(Offset<IonoObservationFrequency_Ingest>);
    ...
    return CreateIonoObservationFrequency_Ingest(
      builder,
      _notes,
      _dimensions,
      _dimensionName,
...
public class IonoObservationFrequency_IngestT
{
  ...
  public IonoObservationFrequency_IngestT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationFrequency_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationFrequency_Ingest.GetRootAsIonoObservationFrequency_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationFrequency_Ingest.FinishIonoObservationFrequency_IngestBuffer(fbb, IonoObservationFrequency_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationFrequency_IngestVerify
{
