...
public struct EOObservation_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EOObservation_Abridged GetRootAsEOObservation_Abridged(ByteBuffer _bb) { return GetRootAsEOObservation_Abridged(_bb, new EOObservation_Abridged()); }
  public static EOObservation_Abridged GetRootAsEOObservation_Abridged(ByteBuffer _bb, EOObservation_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EOObservation_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EOOB"); }
  public static bool VerifyEOObservation_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EOOB", false, EOObservation_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EOObservation_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public EOObservation_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(164); return o != 0 ? (EOObservation_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EOObservation_Abridged_dataMode_Enum.REAL; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 24
  public EOObservation_Abridged_referenceFrame_Enum ReferenceFrame { get { int o = __p.__offset(170); return o != 0 ? (EOObservation_Abridged_referenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EOObservation_Abridged_referenceFrame_Enum.J2000; } }
  /// The reference frame of the observing sensor state. If the senReferenceFrame is null it is assumed to be J2000.
  /// Example: /// Example: J2000
  /// Constraints: Minimum length = 0, Maximum length = 24
  public EOObservation_Abridged_senReferenceFrame_Enum SenReferenceFrame { get { int o = __p.__offset(172); return o != 0 ? (EOObservation_Abridged_senReferenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EOObservation_Abridged_senReferenceFrame_Enum.J2000; } }
  /// Boolean indicating that the target object was in umbral eclipse at the time of this observation.
  /// Example: /// Example: False
  /// Constraints: No constraints specified.
  public bool Umbra { get { int o = __p.__offset(174); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  /// Boolean indicating that the target object was in a penumbral eclipse at the time of this observation.
  /// Example: /// Example: False
  /// Constraints: No constraints specified.
  public bool Penumbra { get { int o = __p.__offset(176); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  /// The originating source network on which this record was created, auto-populated by the system.
  /// Example: /// Example: ORIG
  /// Constraints: Minimum length = 1, Maximum length = 32
  public string OrigNetwork { get { int o = __p.__offset(178); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOrigNetworkBytes() { return __p.__vector_as_span<byte>(178, 1); }
#else
  public ArraySegment<byte>? GetOrigNetworkBytes() { return __p.__vector_as_arraysegment(178); }
#endif
  public byte[] GetOrigNetworkArray() { return __p.__vector_as_array<byte>(178); }
  /// The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
  /// Example: /// Example: AXE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string SourceDL { get { int o = __p.__offset(180); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceDLBytes() { return __p.__vector_as_span<byte>(180, 1); }
#else
  public ArraySegment<byte>? GetSourceDLBytes() { return __p.__vector_as_arraysegment(180); }
#endif
  public byte[] GetSourceDLArray() { return __p.__vector_as_array<byte>(180); }
  /// Read only enumeration specifying the type of observation (e.g. OPTICAL, RADAR, RF, etc).
  /// Example: /// Example: OPTICAL
  /// Constraints: No constraints specified.
  public string Type { get { int o = __p.__offset(182); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTypeBytes() { return __p.__vector_as_span<byte>(182, 1); }
#else
  public ArraySegment<byte>? GetTypeBytes() { return __p.__vector_as_arraysegment(182); }
#endif
  public byte[] GetTypeArray() { return __p.__vector_as_array<byte>(182); }

  public static Offset<EOObservation_Abridged> CreateEOObservation_Abridged(FlatBufferBuilder builder,
      ...
      EOObservation_Abridged_dataMode_Enum dataMode = EOObservation_Abridged_dataMode_Enum.REAL,
      StringOffset createdAtOffset = default(StringOffset),
      StringOffset createdByOffset = default(StringOffset),
      EOObservation_Abridged_referenceFrame_Enum referenceFrame = EOObservation_Abridged_referenceFrame_Enum.J2000,
      EOObservation_Abridged_senReferenceFrame_Enum senReferenceFrame = EOObservation_Abridged_senReferenceFrame_Enum.J2000,
      bool umbra = false,
      bool penumbra = false,
    ...
    EOObservation_Abridged.AddBgIntensity(builder, bgIntensity);
    EOObservation_Abridged.AddIntensity(builder, intensity);
    EOObservation_Abridged.AddTimingBias(builder, timingBias);
    EOObservation_Abridged.AddShutterDelay(builder, shutterDelay);
    EOObservation_Abridged.AddSolarDecAngle(builder, solarDecAngle);
    EOObservation_Abridged.AddSolarEqPhaseAngle(builder, solarEqPhaseAngle);
    EOObservation_Abridged.AddSolarPhaseAngle(builder, solarPhaseAngle);
    EOObservation_Abridged.AddPrimaryExtinctionUnc(builder, primaryExtinctionUnc);
    EOObservation_Abridged.AddPrimaryExtinction(builder, primaryExtinction);
    EOObservation_Abridged.AddSkyBkgrnd(builder, skyBkgrnd);
    EOObservation_Abridged.AddGeorange(builder, georange);
    EOObservation_Abridged.AddGeoalt(builder, geoalt);
    EOObservation_Abridged.AddGeolon(builder, geolon);
    EOObservation_Abridged.AddGeolat(builder, geolat);
    EOObservation_Abridged.AddMagNormRange(builder, magNormRange);
    EOObservation_Abridged.AddMagUnc(builder, magUnc);
    EOObservation_Abridged.AddMag(builder, mag);
    EOObservation_Abridged.AddNetObjSigUnc(builder, netObjSigUnc);
    EOObservation_Abridged.AddNetObjSig(builder, netObjSig);
    EOObservation_Abridged.AddZeroptd(builder, zeroptd);
    EOObservation_Abridged.AddExpDuration(builder, expDuration);
    EOObservation_Abridged.AddSenvelz(builder, senvelz);
    EOObservation_Abridged.AddSenvely(builder, senvely);
    EOObservation_Abridged.AddSenvelx(builder, senvelx);
    EOObservation_Abridged.AddSenz(builder, senz);
    EOObservation_Abridged.AddSeny(builder, seny);
    EOObservation_Abridged.AddSenx(builder, senx);
    EOObservation_Abridged.AddSenalt(builder, senalt);
    EOObservation_Abridged.AddSenlon(builder, senlon);
    EOObservation_Abridged.AddSenlat(builder, senlat);
    EOObservation_Abridged.AddLoszvel(builder, loszvel);
    EOObservation_Abridged.AddLosyvel(builder, losyvel);
    EOObservation_Abridged.AddLosxvel(builder, losxvel);
    EOObservation_Abridged.AddLosUnc(builder, losUnc);
    EOObservation_Abridged.AddLosz(builder, losz);
    EOObservation_Abridged.AddLosy(builder, losy);
    EOObservation_Abridged.AddLosx(builder, losx);
    EOObservation_Abridged.AddDeclinationBias(builder, declinationBias);
    EOObservation_Abridged.AddDeclinationUnc(builder, declinationUnc);
    EOObservation_Abridged.AddDeclinationRate(builder, declinationRate);
    EOObservation_Abridged.AddDeclination(builder, declination);
    EOObservation_Abridged.AddRaBias(builder, raBias);
    EOObservation_Abridged.AddRaUnc(builder, raUnc);
    EOObservation_Abridged.AddRaRate(builder, raRate);
    EOObservation_Abridged.AddRa(builder, ra);
    EOObservation_Abridged.AddRangeRateUnc(builder, rangeRateUnc);
    EOObservation_Abridged.AddRangeRate(builder, rangeRate);
    EOObservation_Abridged.AddRangeBias(builder, rangeBias);
    EOObservation_Abridged.AddRangeUnc(builder, rangeUnc);
    EOObservation_Abridged.AddRange(builder, range);
    EOObservation_Abridged.AddElevationRate(builder, elevationRate);
    EOObservation_Abridged.AddElevationBias(builder, elevationBias);
    EOObservation_Abridged.AddElevationUnc(builder, elevationUnc);
    EOObservation_Abridged.AddElevation(builder, elevation);
    EOObservation_Abridged.AddAzimuthRate(builder, azimuthRate);
    EOObservation_Abridged.AddAzimuthBias(builder, azimuthBias);
    EOObservation_Abridged.AddAzimuthUnc(builder, azimuthUnc);
    EOObservation_Abridged.AddAzimuth(builder, azimuth);
    EOObservation_Abridged.AddCorrQuality(builder, corrQuality);
    EOObservation_Abridged.AddType(builder, typeOffset);
    EOObservation_Abridged.AddSourceDL(builder, sourceDLOffset);
    EOObservation_Abridged.AddOrigNetwork(builder, origNetworkOffset);
    EOObservation_Abridged.AddCreatedBy(builder, createdByOffset);
    EOObservation_Abridged.AddCreatedAt(builder, createdAtOffset);
    EOObservation_Abridged.AddOrigin(builder, originOffset);
    EOObservation_Abridged.AddSource(builder, sourceOffset);
    EOObservation_Abridged.AddDescriptor(builder, descriptorOffset);
    EOObservation_Abridged.AddRawFileURI(builder, rawFileURIOffset);
    EOObservation_Abridged.AddFovCount(builder, fovCount);
    EOObservation_Abridged.AddSenQuat(builder, senQuatOffset);
    EOObservation_Abridged.AddOrigSensorId(builder, origSensorIdOffset);
    EOObservation_Abridged.AddOrigObjectId(builder, origObjectIdOffset);
    EOObservation_Abridged.AddObPosition(builder, obPositionOffset);
    EOObservation_Abridged.AddTrackId(builder, trackIdOffset);
    EOObservation_Abridged.AddTransactionId(builder, transactionIdOffset);
    EOObservation_Abridged.AddTaskId(builder, taskIdOffset);
    EOObservation_Abridged.AddSatNo(builder, satNo);
    EOObservation_Abridged.AddCollectMethod(builder, collectMethodOffset);
    EOObservation_Abridged.AddIdSkyImagery(builder, idSkyImageryOffset);
    EOObservation_Abridged.AddIdSensor(builder, idSensorOffset);
    EOObservation_Abridged.AddIdOnOrbit(builder, idOnOrbitOffset);
    EOObservation_Abridged.AddObTime(builder, obTimeOffset);
    EOObservation_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    EOObservation_Abridged.AddId(builder, idOffset);
    EOObservation_Abridged.AddPenumbra(builder, penumbra);
    EOObservation_Abridged.AddUmbra(builder, umbra);
    EOObservation_Abridged.AddSenReferenceFrame(builder, senReferenceFrame);
    EOObservation_Abridged.AddReferenceFrame(builder, referenceFrame);
    EOObservation_Abridged.AddDataMode(builder, dataMode);
    EOObservation_Abridged.AddUct(builder, uct);
    return EOObservation_Abridged.EndEOObservation_Abridged(builder);
  }

  public static void StartEOObservation_Abridged(FlatBufferBuilder builder) { builder.StartTable(90); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, EOObservation_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(80, (sbyte)dataMode, 0); }
  ...
  public static void AddReferenceFrame(FlatBufferBuilder builder, EOObservation_Abridged_referenceFrame_Enum referenceFrame) { builder.AddSbyte(83, (sbyte)referenceFrame, 0); }
  public static void AddSenReferenceFrame(FlatBufferBuilder builder, EOObservation_Abridged_senReferenceFrame_Enum senReferenceFrame) { builder.AddSbyte(84, (sbyte)senReferenceFrame, 0); }
  public static void AddUmbra(FlatBufferBuilder builder, bool umbra) { builder.AddBool(85, umbra, false); }
  public static void AddPenumbra(FlatBufferBuilder builder, bool penumbra) { builder.AddBool(86, penumbra, false); }
  public static void AddOrigNetwork(FlatBufferBuilder builder, StringOffset origNetworkOffset) { builder.AddOffset(87, origNetworkOffset.Value, 0); }
  public static void AddSourceDL(FlatBufferBuilder builder, StringOffset sourceDLOffset) { builder.AddOffset(88, sourceDLOffset.Value, 0); }
  public static void AddType(FlatBufferBuilder builder, StringOffset typeOffset) { builder.AddOffset(89, typeOffset.Value, 0); }
  public static Offset<EOObservation_Abridged> EndEOObservation_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EOObservation_Abridged>(o);
  }
  public static void FinishEOObservation_AbridgedBuffer(FlatBufferBuilder builder, Offset<EOObservation_Abridged> offset) { builder.Finish(offset.Value, "EOOB"); }
  public static void FinishSizePrefixedEOObservation_AbridgedBuffer(FlatBufferBuilder builder, Offset<EOObservation_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "EOOB"); }
  public EOObservation_AbridgedT UnPack() {
    var _o = new EOObservation_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EOObservation_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<EOObservation_Abridged> Pack(FlatBufferBuilder builder, EOObservation_AbridgedT _o) {
    if (_o == null) return default(Offset<EOObservation_Abridged>);
...
public class EOObservation_AbridgedT
{
  ...
  public EOObservation_Abridged_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public EOObservation_Abridged_referenceFrame_Enum ReferenceFrame { get; set; }
  public EOObservation_Abridged_senReferenceFrame_Enum SenReferenceFrame { get; set; }
  ...
  public EOObservation_AbridgedT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = EOObservation_Abridged_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.ReferenceFrame = EOObservation_Abridged_referenceFrame_Enum.J2000;
    this.SenReferenceFrame = EOObservation_Abridged_senReferenceFrame_Enum.J2000;
    this.Umbra = false;
    this.Penumbra = false;
  ...
  public static EOObservation_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return EOObservation_Abridged.GetRootAsEOObservation_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EOObservation_Abridged.FinishEOObservation_AbridgedBuffer(fbb, EOObservation_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EOObservation_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 164 /*DataMode*/, 1 /*EOObservation_Abridged_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 166 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 168 /*CreatedBy*/, false)
      && verifier.VerifyField(tablePos, 170 /*ReferenceFrame*/, 1 /*EOObservation_Abridged_referenceFrame_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 172 /*SenReferenceFrame*/, 1 /*EOObservation_Abridged_senReferenceFrame_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 174 /*Umbra*/, 1 /*bool*/, 1, false)
      && verifier.VerifyField(tablePos, 176 /*Penumbra*/, 1 /*bool*/, 1, false)
      && verifier.VerifyString(tablePos, 178 /*OrigNetwork*/, false)
      && verifier.VerifyString(tablePos, 180 /*SourceDL*/, false)
      && verifier.VerifyString(tablePos, 182 /*Type*/, false)
