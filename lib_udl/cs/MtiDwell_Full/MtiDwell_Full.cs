...
public struct MtiDwell_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static MtiDwell_Full GetRootAsMtiDwell_Full(ByteBuffer _bb) { return GetRootAsMtiDwell_Full(_bb, new MtiDwell_Full()); }
  public static MtiDwell_Full GetRootAsMtiDwell_Full(ByteBuffer _bb, MtiDwell_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool MtiDwell_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MTID"); }
  public static bool VerifyMtiDwell_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MTID", false, MtiDwell_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public MtiDwell_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<MtiDwell_Full> CreateMtiDwell_Full(FlatBufferBuilder builder,
      int d2 = 0,
      int d3 = 0,
      bool d4 = false,
      int d5 = 0,
  ...
  public static void StartMtiDwell_Full(FlatBufferBuilder builder) { builder.StartTable(32); }
  ...
  public static Offset<MtiDwell_Full> EndMtiDwell_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<MtiDwell_Full>(o);
  }
  public static void FinishMtiDwell_FullBuffer(FlatBufferBuilder builder, Offset<MtiDwell_Full> offset) { builder.Finish(offset.Value, "MTID"); }
  public static void FinishSizePrefixedMtiDwell_FullBuffer(FlatBufferBuilder builder, Offset<MtiDwell_Full> offset) { builder.FinishSizePrefixed(offset.Value, "MTID"); }
  public MtiDwell_FullT UnPack() {
    var _o = new MtiDwell_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(MtiDwell_FullT _o) {
    _o.D2 = this.D2;
    _o.D3 = this.D3;
    _o.D4 = this.D4;
    _o.D5 = this.D5;
  ...
  public static Offset<MtiDwell_Full> Pack(FlatBufferBuilder builder, MtiDwell_FullT _o) {
    if (_o == null) return default(Offset<MtiDwell_Full>);
...
public class MtiDwell_FullT
{
  ...
  public static MtiDwell_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return MtiDwell_Full.GetRootAsMtiDwell_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    MtiDwell_Full.FinishMtiDwell_FullBuffer(fbb, MtiDwell_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class MtiDwell_FullVerify
{
