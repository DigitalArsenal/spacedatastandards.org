...
public struct IonoObservationStokes_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static IonoObservationStokes_Ingest GetRootAsIonoObservationStokes_Ingest(ByteBuffer _bb, IonoObservationStokes_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationStokes_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationStokes_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationStokes_IngestVerify.Verify); }
  ...
  public static Offset<IonoObservationStokes_Ingest> CreateIonoObservationStokes_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<IonoObservationStokes_Ingest> EndIonoObservationStokes_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationStokes_Ingest>(o);
  }
  public static void FinishIonoObservationStokes_IngestBuffer(FlatBufferBuilder builder, Offset<IonoObservationStokes_Ingest> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationStokes_IngestBuffer(FlatBufferBuilder builder, Offset<IonoObservationStokes_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationStokes_IngestT UnPack() {
    var _o = new IonoObservationStokes_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationStokes_IngestT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationStokes_Ingest> Pack(FlatBufferBuilder builder, IonoObservationStokes_IngestT _o) {
    if (_o == null) return default(Offset<IonoObservationStokes_Ingest>);
...
public class IonoObservationStokes_IngestT
{
  ...
  public IonoObservationStokes_IngestT() {
    this.Notes = null;
  ...
  public static IonoObservationStokes_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationStokes_Ingest.GetRootAsIonoObservationStokes_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationStokes_Ingest.FinishIonoObservationStokes_IngestBuffer(fbb, IonoObservationStokes_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationStokes_IngestVerify
{
