...
/// /// Array of Doppler.
public struct IonoObservationDoppler_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationDoppler_Ingest GetRootAsIonoObservationDoppler_Ingest(ByteBuffer _bb) { return GetRootAsIonoObservationDoppler_Ingest(_bb, new IonoObservationDoppler_Ingest()); }
  public static IonoObservationDoppler_Ingest GetRootAsIonoObservationDoppler_Ingest(ByteBuffer _bb, IonoObservationDoppler_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationDoppler_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationDoppler_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationDoppler_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationDoppler_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationDoppler_Ingest> CreateIonoObservationDoppler_Ingest(FlatBufferBuilder builder,
  ...
  public static void StartIonoObservationDoppler_Ingest(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationDoppler_Ingest> EndIonoObservationDoppler_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationDoppler_Ingest>(o);
  }
  public static void FinishIonoObservationDoppler_IngestBuffer(FlatBufferBuilder builder, Offset<IonoObservationDoppler_Ingest> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationDoppler_IngestBuffer(FlatBufferBuilder builder, Offset<IonoObservationDoppler_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationDoppler_IngestT UnPack() {
    var _o = new IonoObservationDoppler_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationDoppler_IngestT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationDoppler_Ingest> Pack(FlatBufferBuilder builder, IonoObservationDoppler_IngestT _o) {
    if (_o == null) return default(Offset<IonoObservationDoppler_Ingest>);
    ...
    return CreateIonoObservationDoppler_Ingest(
      builder,
      _notes,
      _dimensions,
      _dimensionName,
...
public class IonoObservationDoppler_IngestT
{
  ...
  public IonoObservationDoppler_IngestT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationDoppler_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationDoppler_Ingest.GetRootAsIonoObservationDoppler_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationDoppler_Ingest.FinishIonoObservationDoppler_IngestBuffer(fbb, IonoObservationDoppler_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationDoppler_IngestVerify
{
