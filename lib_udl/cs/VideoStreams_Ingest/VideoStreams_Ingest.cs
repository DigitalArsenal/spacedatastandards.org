...
public struct VideoStreams_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static VideoStreams_Ingest GetRootAsVideoStreams_Ingest(ByteBuffer _bb, VideoStreams_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool VideoStreams_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "VIDE"); }
  public static bool VerifyVideoStreams_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("VIDE", false, VideoStreams_IngestVerify.Verify); }
  ...
  public VideoStreams_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(22); return o != 0 ? (VideoStreams_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : VideoStreams_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<VideoStreams_Ingest> CreateVideoStreams_Ingest(FlatBufferBuilder builder,
      ...
      VideoStreams_Ingest_dataMode_Enum dataMode = VideoStreams_Ingest_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, VideoStreams_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(9, (sbyte)dataMode, 0); }
  ...
  public static Offset<VideoStreams_Ingest> EndVideoStreams_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<VideoStreams_Ingest>(o);
  }
  public static void FinishVideoStreams_IngestBuffer(FlatBufferBuilder builder, Offset<VideoStreams_Ingest> offset) { builder.Finish(offset.Value, "VIDE"); }
  public static void FinishSizePrefixedVideoStreams_IngestBuffer(FlatBufferBuilder builder, Offset<VideoStreams_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "VIDE"); }
  public VideoStreams_IngestT UnPack() {
    var _o = new VideoStreams_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(VideoStreams_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<VideoStreams_Ingest> Pack(FlatBufferBuilder builder, VideoStreams_IngestT _o) {
    if (_o == null) return default(Offset<VideoStreams_Ingest>);
...
public class VideoStreams_IngestT
{
  ...
  public VideoStreams_Ingest_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string OrigNetwork { get; set; }
  public string Origin { get; set; }

  public VideoStreams_IngestT() {
    this.Id = null;
    ...
    this.VideoUrls = null;
    this.DataMode = VideoStreams_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.OrigNetwork = null;
    this.Origin = null;
  }
  public static VideoStreams_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return VideoStreams_Ingest.GetRootAsVideoStreams_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    VideoStreams_Ingest.FinishVideoStreams_IngestBuffer(fbb, VideoStreams_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class VideoStreams_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*DataMode*/, 1 /*VideoStreams_Ingest_dataMode_Enum*/, 1, false)
