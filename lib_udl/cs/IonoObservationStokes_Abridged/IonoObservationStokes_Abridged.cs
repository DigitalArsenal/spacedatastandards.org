...
public struct IonoObservationStokes_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationStokes_Abridged GetRootAsIonoObservationStokes_Abridged(ByteBuffer _bb) { return GetRootAsIonoObservationStokes_Abridged(_bb, new IonoObservationStokes_Abridged()); }
  public static IonoObservationStokes_Abridged GetRootAsIonoObservationStokes_Abridged(ByteBuffer _bb, IonoObservationStokes_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationStokes_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationStokes_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationStokes_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationStokes_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationStokes_Abridged> CreateIonoObservationStokes_Abridged(FlatBufferBuilder builder,
  ...
  public static void StartIonoObservationStokes_Abridged(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<IonoObservationStokes_Abridged> EndIonoObservationStokes_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationStokes_Abridged>(o);
  }
  public static void FinishIonoObservationStokes_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationStokes_Abridged> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationStokes_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservationStokes_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationStokes_AbridgedT UnPack() {
    var _o = new IonoObservationStokes_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationStokes_AbridgedT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationStokes_Abridged> Pack(FlatBufferBuilder builder, IonoObservationStokes_AbridgedT _o) {
    if (_o == null) return default(Offset<IonoObservationStokes_Abridged>);
    ...
    return CreateIonoObservationStokes_Abridged(
      builder,
      _notes,
      _dimensions,
      _dimensionName,
...
public class IonoObservationStokes_AbridgedT
{
  ...
  public IonoObservationStokes_AbridgedT() {
    this.Notes = null;
  ...
  public static IonoObservationStokes_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationStokes_Abridged.GetRootAsIonoObservationStokes_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationStokes_Abridged.FinishIonoObservationStokes_AbridgedBuffer(fbb, IonoObservationStokes_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationStokes_AbridgedVerify
{
