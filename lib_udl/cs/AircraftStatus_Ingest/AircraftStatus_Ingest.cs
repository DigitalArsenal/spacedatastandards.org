...
public struct AircraftStatus_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static AircraftStatus_Ingest GetRootAsAircraftStatus_Ingest(ByteBuffer _bb, AircraftStatus_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AircraftStatus_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRC"); }
  public static bool VerifyAircraftStatus_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRC", false, AircraftStatus_IngestVerify.Verify); }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 16
  public AircraftStatus_Ingest_airToAirStatus_Enum AirToAirStatus { get { int o = __p.__offset(44); return o != 0 ? (AircraftStatus_Ingest_airToAirStatus_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AircraftStatus_Ingest_airToAirStatus_Enum.OPERATIONAL; } }
  /// The status of the air-to-ground weapon release system (OPERATIONAL, NON-OPERATIONAL, OFF).
  /// Example: /// Example: OPERATIONAL
  /// Constraints: Minimum length = 0, Maximum length = 16
  public AircraftStatus_Ingest_airToGroundStatus_Enum AirToGroundStatus { get { int o = __p.__offset(46); return o != 0 ? (AircraftStatus_Ingest_airToGroundStatus_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AircraftStatus_Ingest_airToGroundStatus_Enum.OPERATIONAL; } }
  ...
  public AircraftStatus_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(104); return o != 0 ? (AircraftStatus_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AircraftStatus_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<AircraftStatus_Ingest> CreateAircraftStatus_Ingest(FlatBufferBuilder builder,
      ...
      int gunRdsMin = 0,
      int gunRdsMax = 0,
      AircraftStatus_Ingest_airToAirStatus_Enum airToAirStatus = AircraftStatus_Ingest_airToAirStatus_Enum.OPERATIONAL,
      AircraftStatus_Ingest_airToGroundStatus_Enum airToGroundStatus = AircraftStatus_Ingest_airToGroundStatus_Enum.OPERATIONAL,
      ...
      AircraftStatus_Ingest_dataMode_Enum dataMode = AircraftStatus_Ingest_dataMode_Enum.REAL,
  ...
  public static void AddAirToAirStatus(FlatBufferBuilder builder, AircraftStatus_Ingest_airToAirStatus_Enum airToAirStatus) { builder.AddSbyte(20, (sbyte)airToAirStatus, 0); }
  public static void AddAirToGroundStatus(FlatBufferBuilder builder, AircraftStatus_Ingest_airToGroundStatus_Enum airToGroundStatus) { builder.AddSbyte(21, (sbyte)airToGroundStatus, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AircraftStatus_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(50, (sbyte)dataMode, 0); }
  ...
  public static Offset<AircraftStatus_Ingest> EndAircraftStatus_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AircraftStatus_Ingest>(o);
  }
  public static void FinishAircraftStatus_IngestBuffer(FlatBufferBuilder builder, Offset<AircraftStatus_Ingest> offset) { builder.Finish(offset.Value, "AIRC"); }
  public static void FinishSizePrefixedAircraftStatus_IngestBuffer(FlatBufferBuilder builder, Offset<AircraftStatus_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AIRC"); }
  public AircraftStatus_IngestT UnPack() {
    var _o = new AircraftStatus_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AircraftStatus_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AircraftStatus_Ingest> Pack(FlatBufferBuilder builder, AircraftStatus_IngestT _o) {
    if (_o == null) return default(Offset<AircraftStatus_Ingest>);
...
public class AircraftStatus_IngestT
{
  ...
  public AircraftStatus_Ingest_airToAirStatus_Enum AirToAirStatus { get; set; }
  public AircraftStatus_Ingest_airToGroundStatus_Enum AirToGroundStatus { get; set; }
  ...
  public AircraftStatus_Ingest_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public AircraftStatus_IngestT() {
    this.Id = null;
    ...
    this.GunRdsMin = 0;
    this.GunRdsMax = 0;
    this.AirToAirStatus = AircraftStatus_Ingest_airToAirStatus_Enum.OPERATIONAL;
    this.AirToGroundStatus = AircraftStatus_Ingest_airToGroundStatus_Enum.OPERATIONAL;
    this.Inventory = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = AircraftStatus_Ingest_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static AircraftStatus_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AircraftStatus_Ingest.GetRootAsAircraftStatus_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AircraftStatus_Ingest.FinishAircraftStatus_IngestBuffer(fbb, AircraftStatus_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AircraftStatus_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 44 /*AirToAirStatus*/, 1 /*AircraftStatus_Ingest_airToAirStatus_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 46 /*AirToGroundStatus*/, 1 /*AircraftStatus_Ingest_airToGroundStatus_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 104 /*DataMode*/, 1 /*AircraftStatus_Ingest_dataMode_Enum*/, 1, false)
