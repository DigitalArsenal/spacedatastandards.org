...
public struct IonoObservation_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static IonoObservation_Abridged GetRootAsIonoObservation_Abridged(ByteBuffer _bb, IonoObservation_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservation_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservation_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservation_AbridgedVerify.Verify); }
  ...
  public IonoObservation_Abridged_transmitSensorType_Enum TransmitSensorType { get { int o = __p.__offset(32); return o != 0 ? (IonoObservation_Abridged_transmitSensorType_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : IonoObservation_Abridged_transmitSensorType_Enum.MOBILE; } }
  /// List of Geodetic Latitude, Longitude, and Altitude coordinates in km of the receiver. Coordinates List must always have 3 elements. Valid ranges are -90.0 to 90.0 for Latitude and -180.0 to 180.0 for Longitude. Altitude is in km and its value must be 0 or greater.
  /// Example: /// Example: [[45.5, 179.3, 35.6], [-80.2, -20.5, 43.2]]
  /// Constraints: No constraints specified.
  ...
  /// Example: /// Example: Mobile
  /// Constraints: Minimum length = 0, Maximum length = 16
  public IonoObservation_Abridged_receiveSensorType_Enum ReceiveSensorType { get { int o = __p.__offset(36); return o != 0 ? (IonoObservation_Abridged_receiveSensorType_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : IonoObservation_Abridged_receiveSensorType_Enum.MOBILE; } }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  ...
  public IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum AntennaElementPositionCoordinateSystem { get { int o = __p.__offset(40); return o != 0 ? (IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum.J2000; } }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  ...
  public IonoObservation_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(216); return o != 0 ? (IonoObservation_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : IonoObservation_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<IonoObservation_Abridged> CreateIonoObservation_Abridged(FlatBufferBuilder builder,
      ...
      IonoObservation_Abridged_transmitSensorType_Enum transmitSensorType = IonoObservation_Abridged_transmitSensorType_Enum.MOBILE,
      VectorOffset receiveCoordinatesOffset = default(VectorOffset),
      IonoObservation_Abridged_receiveSensorType_Enum receiveSensorType = IonoObservation_Abridged_receiveSensorType_Enum.MOBILE,
      StringOffset antennaElementPositionOffset = default(StringOffset),
      IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum antennaElementPositionCoordinateSystem = IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum.J2000,
      ...
      IonoObservation_Abridged_dataMode_Enum dataMode = IonoObservation_Abridged_dataMode_Enum.REAL,
  ...
  public static void AddTransmitSensorType(FlatBufferBuilder builder, IonoObservation_Abridged_transmitSensorType_Enum transmitSensorType) { builder.AddSbyte(14, (sbyte)transmitSensorType, 0); }
  ...
  public static void AddReceiveSensorType(FlatBufferBuilder builder, IonoObservation_Abridged_receiveSensorType_Enum receiveSensorType) { builder.AddSbyte(16, (sbyte)receiveSensorType, 0); }
  ...
  public static void AddAntennaElementPositionCoordinateSystem(FlatBufferBuilder builder, IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum antennaElementPositionCoordinateSystem) { builder.AddSbyte(18, (sbyte)antennaElementPositionCoordinateSystem, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, IonoObservation_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(106, (sbyte)dataMode, 0); }
  ...
  public static Offset<IonoObservation_Abridged> EndIonoObservation_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservation_Abridged>(o);
  }
  public static void FinishIonoObservation_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservation_Abridged> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservation_AbridgedBuffer(FlatBufferBuilder builder, Offset<IonoObservation_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservation_AbridgedT UnPack() {
    var _o = new IonoObservation_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservation_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<IonoObservation_Abridged> Pack(FlatBufferBuilder builder, IonoObservation_AbridgedT _o) {
    if (_o == null) return default(Offset<IonoObservation_Abridged>);
...
public class IonoObservation_AbridgedT
{
  ...
  public IonoObservation_Abridged_transmitSensorType_Enum TransmitSensorType { get; set; }
  public List<string> ReceiveCoordinates { get; set; }
  public IonoObservation_Abridged_receiveSensorType_Enum ReceiveSensorType { get; set; }
  public string AntennaElementPosition { get; set; }
  public IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum AntennaElementPositionCoordinateSystem { get; set; }
  ...
  public IonoObservation_Abridged_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public IonoObservation_AbridgedT() {
    this.Id = null;
    ...
    this.TransmitSensorType = IonoObservation_Abridged_transmitSensorType_Enum.MOBILE;
    this.ReceiveCoordinates = null;
    this.ReceiveSensorType = IonoObservation_Abridged_receiveSensorType_Enum.MOBILE;
    this.AntennaElementPosition = null;
    this.AntennaElementPositionCoordinateSystem = IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum.J2000;
    this.Power = null;
    this.Range = null;
    this.Frequency = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = IonoObservation_Abridged_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static IonoObservation_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservation_Abridged.GetRootAsIonoObservation_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservation_Abridged.FinishIonoObservation_AbridgedBuffer(fbb, IonoObservation_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservation_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 32 /*TransmitSensorType*/, 1 /*IonoObservation_Abridged_transmitSensorType_Enum*/, 1, false)
      && verifier.VerifyVectorOfStrings(tablePos, 34 /*ReceiveCoordinates*/, false)
      && verifier.VerifyField(tablePos, 36 /*ReceiveSensorType*/, 1 /*IonoObservation_Abridged_receiveSensorType_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 38 /*AntennaElementPosition*/, false)
      && verifier.VerifyField(tablePos, 40 /*AntennaElementPositionCoordinateSystem*/, 1 /*IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 216 /*DataMode*/, 1 /*IonoObservation_Abridged_dataMode_Enum*/, 1, false)
