...
public struct OnorbitSolarArray_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static OnorbitSolarArray_Full GetRootAsOnorbitSolarArray_Full(ByteBuffer _bb) { return GetRootAsOnorbitSolarArray_Full(_bb, new OnorbitSolarArray_Full()); }
  public static OnorbitSolarArray_Full GetRootAsOnorbitSolarArray_Full(ByteBuffer _bb, OnorbitSolarArray_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OnorbitSolarArray_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ONOR"); }
  public static bool VerifyOnorbitSolarArray_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ONOR", false, OnorbitSolarArray_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public OnorbitSolarArray_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public OnorbitSolarArray_Full_dataMode_Enum DataMode { get { int o = __p.__offset(26); return o != 0 ? (OnorbitSolarArray_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OnorbitSolarArray_Full_dataMode_Enum.REAL; } }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string SolarArray { get { int o = __p.__offset(28); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSolarArrayBytes() { return __p.__vector_as_span<byte>(28, 1); }
#else
  public ArraySegment<byte>? GetSolarArrayBytes() { return __p.__vector_as_arraysegment(28); }
#endif
  public byte[] GetSolarArrayArray() { return __p.__vector_as_array<byte>(28); }
  ...
  public static Offset<OnorbitSolarArray_Full> CreateOnorbitSolarArray_Full(FlatBufferBuilder builder,
      ...
      OnorbitSolarArray_Full_dataMode_Enum dataMode = OnorbitSolarArray_Full_dataMode_Enum.REAL,
  ...
  public static void StartOnorbitSolarArray_Full(FlatBufferBuilder builder) { builder.StartTable(14); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OnorbitSolarArray_Full_dataMode_Enum dataMode) { builder.AddSbyte(11, (sbyte)dataMode, 0); }
  public static void AddSolarArray(FlatBufferBuilder builder, StringOffset solarArrayOffset) { builder.AddOffset(12, solarArrayOffset.Value, 0); }
  ...
  public static Offset<OnorbitSolarArray_Full> EndOnorbitSolarArray_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OnorbitSolarArray_Full>(o);
  }
  public static void FinishOnorbitSolarArray_FullBuffer(FlatBufferBuilder builder, Offset<OnorbitSolarArray_Full> offset) { builder.Finish(offset.Value, "ONOR"); }
  public static void FinishSizePrefixedOnorbitSolarArray_FullBuffer(FlatBufferBuilder builder, Offset<OnorbitSolarArray_Full> offset) { builder.FinishSizePrefixed(offset.Value, "ONOR"); }
  public OnorbitSolarArray_FullT UnPack() {
    var _o = new OnorbitSolarArray_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OnorbitSolarArray_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OnorbitSolarArray_Full> Pack(FlatBufferBuilder builder, OnorbitSolarArray_FullT _o) {
    if (_o == null) return default(Offset<OnorbitSolarArray_Full>);
...
public class OnorbitSolarArray_FullT
{
  ...
  public OnorbitSolarArray_Full_dataMode_Enum DataMode { get; set; }
  public string SolarArray { get; set; }
  public string OrigNetwork { get; set; }

  public OnorbitSolarArray_FullT() {
    this.Id = null;
    this.IdOnOrbit = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = OnorbitSolarArray_Full_dataMode_Enum.REAL;
    this.SolarArray = null;
    this.OrigNetwork = null;
  }
  public static OnorbitSolarArray_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return OnorbitSolarArray_Full.GetRootAsOnorbitSolarArray_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OnorbitSolarArray_Full.FinishOnorbitSolarArray_FullBuffer(fbb, OnorbitSolarArray_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OnorbitSolarArray_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 26 /*DataMode*/, 1 /*OnorbitSolarArray_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 28 /*SolarArray*/, false)
