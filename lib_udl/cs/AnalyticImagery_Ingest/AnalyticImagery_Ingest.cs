...
public struct AnalyticImagery_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AnalyticImagery_Ingest GetRootAsAnalyticImagery_Ingest(ByteBuffer _bb) { return GetRootAsAnalyticImagery_Ingest(_bb, new AnalyticImagery_Ingest()); }
  public static AnalyticImagery_Ingest GetRootAsAnalyticImagery_Ingest(ByteBuffer _bb, AnalyticImagery_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AnalyticImagery_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ANAL"); }
  public static bool VerifyAnalyticImagery_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ANAL", false, AnalyticImagery_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AnalyticImagery_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public AnalyticImagery_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(84); return o != 0 ? (AnalyticImagery_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AnalyticImagery_Ingest_dataMode_Enum.REAL; } }

  public static Offset<AnalyticImagery_Ingest> CreateAnalyticImagery_Ingest(FlatBufferBuilder builder,
      ...
      AnalyticImagery_Ingest_dataMode_Enum dataMode = AnalyticImagery_Ingest_dataMode_Enum.REAL) {
  ...
  public static void StartAnalyticImagery_Ingest(FlatBufferBuilder builder) { builder.StartTable(41); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AnalyticImagery_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(40, (sbyte)dataMode, 0); }
  public static Offset<AnalyticImagery_Ingest> EndAnalyticImagery_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AnalyticImagery_Ingest>(o);
  }
  public static void FinishAnalyticImagery_IngestBuffer(FlatBufferBuilder builder, Offset<AnalyticImagery_Ingest> offset) { builder.Finish(offset.Value, "ANAL"); }
  public static void FinishSizePrefixedAnalyticImagery_IngestBuffer(FlatBufferBuilder builder, Offset<AnalyticImagery_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "ANAL"); }
  public AnalyticImagery_IngestT UnPack() {
    var _o = new AnalyticImagery_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AnalyticImagery_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AnalyticImagery_Ingest> Pack(FlatBufferBuilder builder, AnalyticImagery_IngestT _o) {
    if (_o == null) return default(Offset<AnalyticImagery_Ingest>);
...
public class AnalyticImagery_IngestT
{
  ...
  public AnalyticImagery_Ingest_dataMode_Enum DataMode { get; set; }

  public AnalyticImagery_IngestT() {
    this.Id = null;
    ...
    this.SourceDL = null;
    this.DataMode = AnalyticImagery_Ingest_dataMode_Enum.REAL;
  }
  public static AnalyticImagery_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AnalyticImagery_Ingest.GetRootAsAnalyticImagery_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AnalyticImagery_Ingest.FinishAnalyticImagery_IngestBuffer(fbb, AnalyticImagery_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AnalyticImagery_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 84 /*DataMode*/, 1 /*AnalyticImagery_Ingest_dataMode_Enum*/, 1, false)
