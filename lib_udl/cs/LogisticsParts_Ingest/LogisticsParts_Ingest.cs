...
public struct LogisticsParts_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static LogisticsParts_Ingest GetRootAsLogisticsParts_Ingest(ByteBuffer _bb, LogisticsParts_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LogisticsParts_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LOGI"); }
  public static bool VerifyLogisticsParts_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LOGI", false, LogisticsParts_IngestVerify.Verify); }
  ...
  public static Offset<LogisticsParts_Ingest> CreateLogisticsParts_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<LogisticsParts_Ingest> EndLogisticsParts_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LogisticsParts_Ingest>(o);
  }
  public static void FinishLogisticsParts_IngestBuffer(FlatBufferBuilder builder, Offset<LogisticsParts_Ingest> offset) { builder.Finish(offset.Value, "LOGI"); }
  public static void FinishSizePrefixedLogisticsParts_IngestBuffer(FlatBufferBuilder builder, Offset<LogisticsParts_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "LOGI"); }
  public LogisticsParts_IngestT UnPack() {
    var _o = new LogisticsParts_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LogisticsParts_IngestT _o) {
  ...
  public static Offset<LogisticsParts_Ingest> Pack(FlatBufferBuilder builder, LogisticsParts_IngestT _o) {
    if (_o == null) return default(Offset<LogisticsParts_Ingest>);
...
public class LogisticsParts_IngestT
{
  ...
  public static LogisticsParts_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return LogisticsParts_Ingest.GetRootAsLogisticsParts_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LogisticsParts_Ingest.FinishLogisticsParts_IngestBuffer(fbb, LogisticsParts_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LogisticsParts_IngestVerify
{
