...
public struct AntennaDetails_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AntennaDetails_Ingest GetRootAsAntennaDetails_Ingest(ByteBuffer _bb) { return GetRootAsAntennaDetails_Ingest(_bb, new AntennaDetails_Ingest()); }
  public static AntennaDetails_Ingest GetRootAsAntennaDetails_Ingest(ByteBuffer _bb, AntennaDetails_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AntennaDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ANTE"); }
  public static bool VerifyAntennaDetails_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ANTE", false, AntennaDetails_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AntennaDetails_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public AntennaDetails_Ingest_mode_Enum Mode { get { int o = __p.__offset(14); return o != 0 ? (AntennaDetails_Ingest_mode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AntennaDetails_Ingest_mode_Enum.TX; } }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public AntennaDetails_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(50); return o != 0 ? (AntennaDetails_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AntennaDetails_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<AntennaDetails_Ingest> CreateAntennaDetails_Ingest(FlatBufferBuilder builder,
      ...
      AntennaDetails_Ingest_mode_Enum mode = AntennaDetails_Ingest_mode_Enum.TX,
      ...
      AntennaDetails_Ingest_dataMode_Enum dataMode = AntennaDetails_Ingest_dataMode_Enum.REAL,
  ...
  public static void StartAntennaDetails_Ingest(FlatBufferBuilder builder) { builder.StartTable(25); }
  ...
  public static void AddMode(FlatBufferBuilder builder, AntennaDetails_Ingest_mode_Enum mode) { builder.AddSbyte(5, (sbyte)mode, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AntennaDetails_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(23, (sbyte)dataMode, 0); }
  ...
  public static Offset<AntennaDetails_Ingest> EndAntennaDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AntennaDetails_Ingest>(o);
  }
  public static void FinishAntennaDetails_IngestBuffer(FlatBufferBuilder builder, Offset<AntennaDetails_Ingest> offset) { builder.Finish(offset.Value, "ANTE"); }
  public static void FinishSizePrefixedAntennaDetails_IngestBuffer(FlatBufferBuilder builder, Offset<AntennaDetails_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "ANTE"); }
  public AntennaDetails_IngestT UnPack() {
    var _o = new AntennaDetails_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AntennaDetails_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AntennaDetails_Ingest> Pack(FlatBufferBuilder builder, AntennaDetails_IngestT _o) {
    if (_o == null) return default(Offset<AntennaDetails_Ingest>);
...
public class AntennaDetails_IngestT
{
  ...
  public AntennaDetails_Ingest_mode_Enum Mode { get; set; }
  ...
  public AntennaDetails_Ingest_dataMode_Enum DataMode { get; set; }
  public List<string> Tags { get; set; }

  public AntennaDetails_IngestT() {
    this.Id = null;
    this.IdAntenna = null;
    this.ClassificationMarking = null;
    this.Type = null;
    this.Position = null;
    this.Mode = AntennaDetails_Ingest_mode_Enum.TX;
    ...
    this.DataMode = AntennaDetails_Ingest_dataMode_Enum.REAL;
    this.Tags = null;
  }
  public static AntennaDetails_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AntennaDetails_Ingest.GetRootAsAntennaDetails_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AntennaDetails_Ingest.FinishAntennaDetails_IngestBuffer(fbb, AntennaDetails_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AntennaDetails_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*Mode*/, 1 /*AntennaDetails_Ingest_mode_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 50 /*DataMode*/, 1 /*AntennaDetails_Ingest_dataMode_Enum*/, 1, false)
