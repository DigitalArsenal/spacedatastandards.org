...
public struct AirspaceControlOrder_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static AirspaceControlOrder_Abridged GetRootAsAirspaceControlOrder_Abridged(ByteBuffer _bb, AirspaceControlOrder_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirspaceControlOrder_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRS"); }
  public static bool VerifyAirspaceControlOrder_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRS", false, AirspaceControlOrder_AbridgedVerify.Verify); }
  ...
  public AirspaceControlOrder_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(68); return o != 0 ? (AirspaceControlOrder_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirspaceControlOrder_Abridged_dataMode_Enum.REAL; } }

  public static Offset<AirspaceControlOrder_Abridged> CreateAirspaceControlOrder_Abridged(FlatBufferBuilder builder,
      ...
      AirspaceControlOrder_Abridged_dataMode_Enum dataMode = AirspaceControlOrder_Abridged_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AirspaceControlOrder_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(32, (sbyte)dataMode, 0); }
  public static Offset<AirspaceControlOrder_Abridged> EndAirspaceControlOrder_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirspaceControlOrder_Abridged>(o);
  }
  public static void FinishAirspaceControlOrder_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirspaceControlOrder_Abridged> offset) { builder.Finish(offset.Value, "AIRS"); }
  public static void FinishSizePrefixedAirspaceControlOrder_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirspaceControlOrder_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "AIRS"); }
  public AirspaceControlOrder_AbridgedT UnPack() {
    var _o = new AirspaceControlOrder_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirspaceControlOrder_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AirspaceControlOrder_Abridged> Pack(FlatBufferBuilder builder, AirspaceControlOrder_AbridgedT _o) {
    if (_o == null) return default(Offset<AirspaceControlOrder_Abridged>);
...
public class AirspaceControlOrder_AbridgedT
{
  ...
  public AirspaceControlOrder_Abridged_dataMode_Enum DataMode { get; set; }

  public AirspaceControlOrder_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = AirspaceControlOrder_Abridged_dataMode_Enum.REAL;
  }
  public static AirspaceControlOrder_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return AirspaceControlOrder_Abridged.GetRootAsAirspaceControlOrder_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirspaceControlOrder_Abridged.FinishAirspaceControlOrder_AbridgedBuffer(fbb, AirspaceControlOrder_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirspaceControlOrder_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 68 /*DataMode*/, 1 /*AirspaceControlOrder_Abridged_dataMode_Enum*/, 1, false)
