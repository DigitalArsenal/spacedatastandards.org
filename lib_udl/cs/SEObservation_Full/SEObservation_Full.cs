...
public struct SEObservation_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SEObservation_Full GetRootAsSEObservation_Full(ByteBuffer _bb) { return GetRootAsSEObservation_Full(_bb, new SEObservation_Full()); }
  public static SEObservation_Full GetRootAsSEObservation_Full(ByteBuffer _bb, SEObservation_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SEObservation_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SEOB"); }
  public static bool VerifySEObservation_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SEOB", false, SEObservation_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SEObservation_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<SEObservation_Full> CreateSEObservation_Full(FlatBufferBuilder builder,
    ...
    SEObservation_Full.AddObValue(builder, obValue);
    SEObservation_Full.AddObDescription(builder, obDescriptionOffset);
    SEObservation_Full.AddObQuality(builder, obQualityOffset);
    SEObservation_Full.AddObArray(builder, obArrayOffset);
    SEObservation_Full.AddObString(builder, obStringOffset);
    SEObservation_Full.AddObUoM(builder, obUoMOffset);
    SEObservation_Full.AddObType(builder, obTypeOffset);
    SEObservation_Full.AddObBool(builder, obBool);
    return SEObservation_Full.EndSEObservation_Full(builder);
  }

  public static void StartSEObservation_Full(FlatBufferBuilder builder) { builder.StartTable(8); }
  ...
  public static Offset<SEObservation_Full> EndSEObservation_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SEObservation_Full>(o);
  }
  public static void FinishSEObservation_FullBuffer(FlatBufferBuilder builder, Offset<SEObservation_Full> offset) { builder.Finish(offset.Value, "SEOB"); }
  public static void FinishSizePrefixedSEObservation_FullBuffer(FlatBufferBuilder builder, Offset<SEObservation_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SEOB"); }
  public SEObservation_FullT UnPack() {
    var _o = new SEObservation_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SEObservation_FullT _o) {
  ...
  public static Offset<SEObservation_Full> Pack(FlatBufferBuilder builder, SEObservation_FullT _o) {
    if (_o == null) return default(Offset<SEObservation_Full>);
    ...
    return CreateSEObservation_Full(
      builder,
      _obType,
      _obUoM,
      _o.ObValue,
...
public class SEObservation_FullT
{
  ...
  public static SEObservation_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return SEObservation_Full.GetRootAsSEObservation_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SEObservation_Full.FinishSEObservation_FullBuffer(fbb, SEObservation_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SEObservation_FullVerify
{
