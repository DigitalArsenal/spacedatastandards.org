...
public struct LaunchDetection_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static LaunchDetection_Abridged GetRootAsLaunchDetection_Abridged(ByteBuffer _bb, LaunchDetection_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LaunchDetection_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LAUN"); }
  public static bool VerifyLaunchDetection_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LAUN", false, LaunchDetection_AbridgedVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public LaunchDetection_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(46); return o != 0 ? (LaunchDetection_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : LaunchDetection_Abridged_dataMode_Enum.REAL; } }
  /// Time the row was created in the database.
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string CreatedAt { get { int o = __p.__offset(48); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedAtBytes() { return __p.__vector_as_span<byte>(48, 1); }
#else
  public ArraySegment<byte>? GetCreatedAtBytes() { return __p.__vector_as_arraysegment(48); }
#endif
  public byte[] GetCreatedAtArray() { return __p.__vector_as_array<byte>(48); }
  /// Application user who created the row in the database.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string CreatedBy { get { int o = __p.__offset(50); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedByBytes() { return __p.__vector_as_span<byte>(50, 1); }
#else
  public ArraySegment<byte>? GetCreatedByBytes() { return __p.__vector_as_arraysegment(50); }
#endif
  public byte[] GetCreatedByArray() { return __p.__vector_as_array<byte>(50); }
  /// Read-only time the row was updated in the database, set automatically by the system on update.
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string UpdatedAt { get { int o = __p.__offset(52); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedAtBytes() { return __p.__vector_as_span<byte>(52, 1); }
#else
  public ArraySegment<byte>? GetUpdatedAtBytes() { return __p.__vector_as_arraysegment(52); }
#endif
  public byte[] GetUpdatedAtArray() { return __p.__vector_as_array<byte>(52); }
  ...
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string UpdatedBy { get { int o = __p.__offset(54); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetUpdatedByBytes() { return __p.__vector_as_span<byte>(54, 1); }
#else
  public ArraySegment<byte>? GetUpdatedByBytes() { return __p.__vector_as_arraysegment(54); }
#endif
  public byte[] GetUpdatedByArray() { return __p.__vector_as_array<byte>(54); }

  public static Offset<LaunchDetection_Abridged> CreateLaunchDetection_Abridged(FlatBufferBuilder builder,
      ...
      LaunchDetection_Abridged_dataMode_Enum dataMode = LaunchDetection_Abridged_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, LaunchDetection_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(21, (sbyte)dataMode, 0); }
  public static void AddCreatedAt(FlatBufferBuilder builder, StringOffset createdAtOffset) { builder.AddOffset(22, createdAtOffset.Value, 0); }
  public static void AddCreatedBy(FlatBufferBuilder builder, StringOffset createdByOffset) { builder.AddOffset(23, createdByOffset.Value, 0); }
  public static void AddUpdatedAt(FlatBufferBuilder builder, StringOffset updatedAtOffset) { builder.AddOffset(24, updatedAtOffset.Value, 0); }
  public static void AddUpdatedBy(FlatBufferBuilder builder, StringOffset updatedByOffset) { builder.AddOffset(25, updatedByOffset.Value, 0); }
  public static Offset<LaunchDetection_Abridged> EndLaunchDetection_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LaunchDetection_Abridged>(o);
  }
  public static void FinishLaunchDetection_AbridgedBuffer(FlatBufferBuilder builder, Offset<LaunchDetection_Abridged> offset) { builder.Finish(offset.Value, "LAUN"); }
  public static void FinishSizePrefixedLaunchDetection_AbridgedBuffer(FlatBufferBuilder builder, Offset<LaunchDetection_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "LAUN"); }
  public LaunchDetection_AbridgedT UnPack() {
    var _o = new LaunchDetection_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LaunchDetection_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<LaunchDetection_Abridged> Pack(FlatBufferBuilder builder, LaunchDetection_AbridgedT _o) {
    if (_o == null) return default(Offset<LaunchDetection_Abridged>);
...
public class LaunchDetection_AbridgedT
{
  ...
  public LaunchDetection_Abridged_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string UpdatedAt { get; set; }
  public string UpdatedBy { get; set; }

  public LaunchDetection_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = LaunchDetection_Abridged_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.UpdatedAt = null;
    this.UpdatedBy = null;
  }
  public static LaunchDetection_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return LaunchDetection_Abridged.GetRootAsLaunchDetection_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LaunchDetection_Abridged.FinishLaunchDetection_AbridgedBuffer(fbb, LaunchDetection_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LaunchDetection_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 46 /*DataMode*/, 1 /*LaunchDetection_Abridged_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 48 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 50 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 52 /*UpdatedAt*/, false)
      && verifier.VerifyString(tablePos, 54 /*UpdatedBy*/, false)
