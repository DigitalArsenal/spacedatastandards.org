...
public struct AirEventReceivers_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirEventReceivers_Abridged GetRootAsAirEventReceivers_Abridged(ByteBuffer _bb) { return GetRootAsAirEventReceivers_Abridged(_bb, new AirEventReceivers_Abridged()); }
  public static AirEventReceivers_Abridged GetRootAsAirEventReceivers_Abridged(ByteBuffer _bb, AirEventReceivers_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirEventReceivers_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRE"); }
  public static bool VerifyAirEventReceivers_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRE", false, AirEventReceivers_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirEventReceivers_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<AirEventReceivers_Abridged> CreateAirEventReceivers_Abridged(FlatBufferBuilder builder,
  ...
  public static void StartAirEventReceivers_Abridged(FlatBufferBuilder builder) { builder.StartTable(22); }
  ...
  public static Offset<AirEventReceivers_Abridged> EndAirEventReceivers_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirEventReceivers_Abridged>(o);
  }
  public static void FinishAirEventReceivers_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirEventReceivers_Abridged> offset) { builder.Finish(offset.Value, "AIRE"); }
  public static void FinishSizePrefixedAirEventReceivers_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirEventReceivers_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "AIRE"); }
  public AirEventReceivers_AbridgedT UnPack() {
    var _o = new AirEventReceivers_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirEventReceivers_AbridgedT _o) {
  ...
  public static Offset<AirEventReceivers_Abridged> Pack(FlatBufferBuilder builder, AirEventReceivers_AbridgedT _o) {
    if (_o == null) return default(Offset<AirEventReceivers_Abridged>);
...
public class AirEventReceivers_AbridgedT
{
  ...
  public AirEventReceivers_AbridgedT() {
  ...
  public static AirEventReceivers_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return AirEventReceivers_Abridged.GetRootAsAirEventReceivers_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirEventReceivers_Abridged.FinishAirEventReceivers_AbridgedBuffer(fbb, AirEventReceivers_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirEventReceivers_AbridgedVerify
{
