...
public struct DataLinkOps_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static DataLinkOps_Full GetRootAsDataLinkOps_Full(ByteBuffer _bb, DataLinkOps_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DataLinkOps_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DATA"); }
  public static bool VerifyDataLinkOps_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DATA", false, DataLinkOps_FullVerify.Verify); }
  ...
  public static Offset<DataLinkOps_Full> CreateDataLinkOps_Full(FlatBufferBuilder builder,
  ...
  public static Offset<DataLinkOps_Full> EndDataLinkOps_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DataLinkOps_Full>(o);
  }
  public static void FinishDataLinkOps_FullBuffer(FlatBufferBuilder builder, Offset<DataLinkOps_Full> offset) { builder.Finish(offset.Value, "DATA"); }
  public static void FinishSizePrefixedDataLinkOps_FullBuffer(FlatBufferBuilder builder, Offset<DataLinkOps_Full> offset) { builder.FinishSizePrefixed(offset.Value, "DATA"); }
  public DataLinkOps_FullT UnPack() {
    var _o = new DataLinkOps_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DataLinkOps_FullT _o) {
  ...
  public static Offset<DataLinkOps_Full> Pack(FlatBufferBuilder builder, DataLinkOps_FullT _o) {
    if (_o == null) return default(Offset<DataLinkOps_Full>);
...
public class DataLinkOps_FullT
{
  ...
  public static DataLinkOps_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return DataLinkOps_Full.GetRootAsDataLinkOps_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DataLinkOps_Full.FinishDataLinkOps_FullBuffer(fbb, DataLinkOps_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DataLinkOps_FullVerify
{
