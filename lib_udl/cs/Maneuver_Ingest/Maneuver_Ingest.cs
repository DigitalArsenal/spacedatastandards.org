...
public struct Maneuver_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Maneuver_Ingest GetRootAsManeuver_Ingest(ByteBuffer _bb) { return GetRootAsManeuver_Ingest(_bb, new Maneuver_Ingest()); }
  public static Maneuver_Ingest GetRootAsManeuver_Ingest(ByteBuffer _bb, Maneuver_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Maneuver_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MANE"); }
  public static bool VerifyManeuver_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MANE", false, Maneuver_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Maneuver_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public Maneuver_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(182); return o != 0 ? (Maneuver_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Maneuver_Ingest_dataMode_Enum.REAL; } }
  ...
  /// Constraints: No constraints specified.
  public Maneuver_Ingest_sourcedDataTypes_Enum SourcedDataTypes { get { int o = __p.__offset(194); return o != 0 ? (Maneuver_Ingest_sourcedDataTypes_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Maneuver_Ingest_sourcedDataTypes_Enum.EO; } }
  ...
  public static Offset<Maneuver_Ingest> CreateManeuver_Ingest(FlatBufferBuilder builder,
      ...
      Maneuver_Ingest_dataMode_Enum dataMode = Maneuver_Ingest_dataMode_Enum.REAL,
      ...
      Maneuver_Ingest_sourcedDataTypes_Enum sourcedDataTypes = Maneuver_Ingest_sourcedDataTypes_Enum.EO,
      StringOffset transactionIdOffset = default(StringOffset),
      StringOffset origNetworkOffset = default(StringOffset)) {
    builder.StartTable(98);
    Maneuver_Ingest.AddStateModelVersion(builder, stateModelVersion);
    Maneuver_Ingest.AddPostArea(builder, postArea);
    Maneuver_Ingest.AddPostMass(builder, postMass);
    Maneuver_Ingest.AddPostSigmaW(builder, postSigmaW);
    Maneuver_Ingest.AddPostSigmaV(builder, postSigmaV);
    Maneuver_Ingest.AddPostSigmaU(builder, postSigmaU);
    Maneuver_Ingest.AddPostDriftRate(builder, postDriftRate);
    Maneuver_Ingest.AddPostGeoLongitude(builder, postGeoLongitude);
    Maneuver_Ingest.AddPostSMA(builder, postSMA);
    Maneuver_Ingest.AddPostRAAN(builder, postRAAN);
    Maneuver_Ingest.AddPostPeriod(builder, postPeriod);
    Maneuver_Ingest.AddPostEccentricity(builder, postEccentricity);
    Maneuver_Ingest.AddPostInclination(builder, postInclination);
    Maneuver_Ingest.AddPostPerigee(builder, postPerigee);
    Maneuver_Ingest.AddPostApogee(builder, postApogee);
    Maneuver_Ingest.AddPostBallisticCoeff(builder, postBallisticCoeff);
    Maneuver_Ingest.AddPostRadiationPressCoeff(builder, postRadiationPressCoeff);
    Maneuver_Ingest.AddPostVelZ(builder, postVelZ);
    Maneuver_Ingest.AddPostVelY(builder, postVelY);
    Maneuver_Ingest.AddPostVelX(builder, postVelX);
    Maneuver_Ingest.AddPostPosZ(builder, postPosZ);
    Maneuver_Ingest.AddPostPosY(builder, postPosY);
    Maneuver_Ingest.AddPostPosX(builder, postPosX);
    Maneuver_Ingest.AddPreSigmaW(builder, preSigmaW);
    Maneuver_Ingest.AddPreSigmaV(builder, preSigmaV);
    Maneuver_Ingest.AddPreSigmaU(builder, preSigmaU);
    Maneuver_Ingest.AddPreDriftRate(builder, preDriftRate);
    Maneuver_Ingest.AddPreGeoLongitude(builder, preGeoLongitude);
    Maneuver_Ingest.AddPreSMA(builder, preSMA);
    Maneuver_Ingest.AddPreRAAN(builder, preRAAN);
    Maneuver_Ingest.AddPrePeriod(builder, prePeriod);
    Maneuver_Ingest.AddPreEccentricity(builder, preEccentricity);
    Maneuver_Ingest.AddPreInclination(builder, preInclination);
    Maneuver_Ingest.AddPrePerigee(builder, prePerigee);
    Maneuver_Ingest.AddPreApogee(builder, preApogee);
    Maneuver_Ingest.AddPreBallisticCoeff(builder, preBallisticCoeff);
    Maneuver_Ingest.AddPreRadiationPressCoeff(builder, preRadiationPressCoeff);
    Maneuver_Ingest.AddPreVelZ(builder, preVelZ);
    Maneuver_Ingest.AddPreVelY(builder, preVelY);
    Maneuver_Ingest.AddPreVelX(builder, preVelX);
    Maneuver_Ingest.AddPrePosZ(builder, prePosZ);
    Maneuver_Ingest.AddPrePosY(builder, prePosY);
    Maneuver_Ingest.AddPrePosX(builder, prePosX);
    Maneuver_Ingest.AddDeltaMass(builder, deltaMass);
    Maneuver_Ingest.AddDeltaVelW(builder, deltaVelW);
    Maneuver_Ingest.AddDeltaVelV(builder, deltaVelV);
    Maneuver_Ingest.AddDeltaVelU(builder, deltaVelU);
    Maneuver_Ingest.AddDeltaVel(builder, deltaVel);
    Maneuver_Ingest.AddDeltaPosW(builder, deltaPosW);
    Maneuver_Ingest.AddDeltaPosV(builder, deltaPosV);
    Maneuver_Ingest.AddDeltaPosU(builder, deltaPosU);
    Maneuver_Ingest.AddDeltaPos(builder, deltaPos);
    Maneuver_Ingest.AddCharacterizationUnc(builder, characterizationUnc);
    Maneuver_Ingest.AddManeuverUnc(builder, maneuverUnc);
    Maneuver_Ingest.AddTotalBurnTime(builder, totalBurnTime);
    Maneuver_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    Maneuver_Ingest.AddTransactionId(builder, transactionIdOffset);
    Maneuver_Ingest.AddSourcedData(builder, sourcedDataOffset);
    Maneuver_Ingest.AddAlgorithm(builder, algorithmOffset);
    Maneuver_Ingest.AddTags(builder, tagsOffset);
    Maneuver_Ingest.AddCreatedBy(builder, createdByOffset);
    Maneuver_Ingest.AddCreatedAt(builder, createdAtOffset);
    Maneuver_Ingest.AddOrigin(builder, originOffset);
    Maneuver_Ingest.AddSource(builder, sourceOffset);
    Maneuver_Ingest.AddMnvrAccelUncs(builder, mnvrAccelUncsOffset);
    Maneuver_Ingest.AddMnvrAccels(builder, mnvrAccelsOffset);
    Maneuver_Ingest.AddMnvrAccelTimes(builder, mnvrAccelTimesOffset);
    Maneuver_Ingest.AddNumAccelPoints(builder, numAccelPoints);
    Maneuver_Ingest.AddStateModel(builder, stateModelOffset);
    Maneuver_Ingest.AddDescriptor(builder, descriptorOffset);
    Maneuver_Ingest.AddDescription(builder, descriptionOffset);
    Maneuver_Ingest.AddNumObs(builder, numObs);
    Maneuver_Ingest.AddCov(builder, covOffset);
    Maneuver_Ingest.AddPostEventStateVector(builder, postEventStateVectorOffset);
    Maneuver_Ingest.AddPostEventIdStateVector(builder, postEventIdStateVectorOffset);
    Maneuver_Ingest.AddPostEventElset(builder, postEventElsetOffset);
    Maneuver_Ingest.AddPostEventIdElset(builder, postEventIdElsetOffset);
    Maneuver_Ingest.AddPreEventStateVector(builder, preEventStateVectorOffset);
    Maneuver_Ingest.AddPreEventIdStateVector(builder, preEventIdStateVectorOffset);
    Maneuver_Ingest.AddPreEventElset(builder, preEventElsetOffset);
    Maneuver_Ingest.AddPreEventIdElset(builder, preEventIdElsetOffset);
    Maneuver_Ingest.AddStatus(builder, statusOffset);
    Maneuver_Ingest.AddOrigSensorId(builder, origSensorIdOffset);
    Maneuver_Ingest.AddOrigObjectId(builder, origObjectIdOffset);
    Maneuver_Ingest.AddEventId(builder, eventIdOffset);
    Maneuver_Ingest.AddCharacterization(builder, characterizationOffset);
    Maneuver_Ingest.AddIdSensor(builder, idSensorOffset);
    Maneuver_Ingest.AddIdOnOrbit(builder, idOnOrbitOffset);
    Maneuver_Ingest.AddOdFitEndTime(builder, odFitEndTimeOffset);
    Maneuver_Ingest.AddEventEndTime(builder, eventEndTimeOffset);
    Maneuver_Ingest.AddEventStartTime(builder, eventStartTimeOffset);
    Maneuver_Ingest.AddReportTime(builder, reportTimeOffset);
    Maneuver_Ingest.AddSatNo(builder, satNo);
    Maneuver_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    Maneuver_Ingest.AddId(builder, idOffset);
    Maneuver_Ingest.AddSourcedDataTypes(builder, sourcedDataTypes);
    Maneuver_Ingest.AddDataMode(builder, dataMode);
    Maneuver_Ingest.AddUct(builder, uct);
    return Maneuver_Ingest.EndManeuver_Ingest(builder);
  }

  public static void StartManeuver_Ingest(FlatBufferBuilder builder) { builder.StartTable(98); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Maneuver_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(89, (sbyte)dataMode, 0); }
  ...
  public static void AddSourcedDataTypes(FlatBufferBuilder builder, Maneuver_Ingest_sourcedDataTypes_Enum sourcedDataTypes) { builder.AddSbyte(95, (sbyte)sourcedDataTypes, 0); }
  ...
  public static Offset<Maneuver_Ingest> EndManeuver_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Maneuver_Ingest>(o);
  }
  public static void FinishManeuver_IngestBuffer(FlatBufferBuilder builder, Offset<Maneuver_Ingest> offset) { builder.Finish(offset.Value, "MANE"); }
  public static void FinishSizePrefixedManeuver_IngestBuffer(FlatBufferBuilder builder, Offset<Maneuver_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "MANE"); }
  public Maneuver_IngestT UnPack() {
    var _o = new Maneuver_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Maneuver_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Maneuver_Ingest> Pack(FlatBufferBuilder builder, Maneuver_IngestT _o) {
    if (_o == null) return default(Offset<Maneuver_Ingest>);
...
public class Maneuver_IngestT
{
  ...
  public Maneuver_Ingest_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public List<string> Tags { get; set; }
  public string Algorithm { get; set; }
  public List<string> SourcedData { get; set; }
  public Maneuver_Ingest_sourcedDataTypes_Enum SourcedDataTypes { get; set; }
  public string TransactionId { get; set; }
  public string OrigNetwork { get; set; }

  public Maneuver_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Maneuver_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.Tags = null;
    this.Algorithm = null;
    this.SourcedData = null;
    this.SourcedDataTypes = Maneuver_Ingest_sourcedDataTypes_Enum.EO;
    this.TransactionId = null;
    this.OrigNetwork = null;
  }
  public static Maneuver_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Maneuver_Ingest.GetRootAsManeuver_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Maneuver_Ingest.FinishManeuver_IngestBuffer(fbb, Maneuver_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Maneuver_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 182 /*DataMode*/, 1 /*Maneuver_Ingest_dataMode_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 194 /*SourcedDataTypes*/, 1 /*Maneuver_Ingest_sourcedDataTypes_Enum*/, 1, false)
