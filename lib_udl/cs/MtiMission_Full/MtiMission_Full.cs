...
public struct MtiMission_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static MtiMission_Full GetRootAsMtiMission_Full(ByteBuffer _bb, MtiMission_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool MtiMission_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MTIM"); }
  public static bool VerifyMtiMission_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MTIM", false, MtiMission_FullVerify.Verify); }
  ...
  public static Offset<MtiMission_Full> CreateMtiMission_Full(FlatBufferBuilder builder,
  ...
  public static Offset<MtiMission_Full> EndMtiMission_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<MtiMission_Full>(o);
  }
  public static void FinishMtiMission_FullBuffer(FlatBufferBuilder builder, Offset<MtiMission_Full> offset) { builder.Finish(offset.Value, "MTIM"); }
  public static void FinishSizePrefixedMtiMission_FullBuffer(FlatBufferBuilder builder, Offset<MtiMission_Full> offset) { builder.FinishSizePrefixed(offset.Value, "MTIM"); }
  public MtiMission_FullT UnPack() {
    var _o = new MtiMission_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(MtiMission_FullT _o) {
    _o.M1 = this.M1;
    _o.M2 = this.M2;
    _o.M3 = this.M3;
    _o.M4 = this.M4;
  ...
  public static Offset<MtiMission_Full> Pack(FlatBufferBuilder builder, MtiMission_FullT _o) {
    if (_o == null) return default(Offset<MtiMission_Full>);
...
public class MtiMission_FullT
{
  ...
  public static MtiMission_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return MtiMission_Full.GetRootAsMtiMission_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    MtiMission_Full.FinishMtiMission_FullBuffer(fbb, MtiMission_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class MtiMission_FullVerify
{
