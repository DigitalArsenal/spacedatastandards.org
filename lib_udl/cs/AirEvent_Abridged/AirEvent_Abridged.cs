...
public struct AirEvent_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static AirEvent_Abridged GetRootAsAirEvent_Abridged(ByteBuffer _bb, AirEvent_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirEvent_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRE"); }
  public static bool VerifyAirEvent_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRE", false, AirEvent_AbridgedVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public AirEvent_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(90); return o != 0 ? (AirEvent_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirEvent_Abridged_dataMode_Enum.REAL; } }

  public static Offset<AirEvent_Abridged> CreateAirEvent_Abridged(FlatBufferBuilder builder,
      ...
      AirEvent_Abridged_dataMode_Enum dataMode = AirEvent_Abridged_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AirEvent_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(43, (sbyte)dataMode, 0); }
  public static Offset<AirEvent_Abridged> EndAirEvent_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirEvent_Abridged>(o);
  }
  public static void FinishAirEvent_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirEvent_Abridged> offset) { builder.Finish(offset.Value, "AIRE"); }
  public static void FinishSizePrefixedAirEvent_AbridgedBuffer(FlatBufferBuilder builder, Offset<AirEvent_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "AIRE"); }
  public AirEvent_AbridgedT UnPack() {
    var _o = new AirEvent_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirEvent_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AirEvent_Abridged> Pack(FlatBufferBuilder builder, AirEvent_AbridgedT _o) {
    if (_o == null) return default(Offset<AirEvent_Abridged>);
...
public class AirEvent_AbridgedT
{
  ...
  public AirEvent_Abridged_dataMode_Enum DataMode { get; set; }

  public AirEvent_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = AirEvent_Abridged_dataMode_Enum.REAL;
  }
  public static AirEvent_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return AirEvent_Abridged.GetRootAsAirEvent_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirEvent_Abridged.FinishAirEvent_AbridgedBuffer(fbb, AirEvent_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirEvent_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 90 /*DataMode*/, 1 /*AirEvent_Abridged_dataMode_Enum*/, 1, false)
