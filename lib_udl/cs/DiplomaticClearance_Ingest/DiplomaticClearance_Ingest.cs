...
public struct DiplomaticClearance_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static DiplomaticClearance_Ingest GetRootAsDiplomaticClearance_Ingest(ByteBuffer _bb, DiplomaticClearance_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DiplomaticClearance_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DIPL"); }
  public static bool VerifyDiplomaticClearance_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DIPL", false, DiplomaticClearance_IngestVerify.Verify); }
  ...
  public DiplomaticClearance_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(40); return o != 0 ? (DiplomaticClearance_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : DiplomaticClearance_Ingest_dataMode_Enum.REAL; } }

  public static Offset<DiplomaticClearance_Ingest> CreateDiplomaticClearance_Ingest(FlatBufferBuilder builder,
      ...
      DiplomaticClearance_Ingest_dataMode_Enum dataMode = DiplomaticClearance_Ingest_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, DiplomaticClearance_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(18, (sbyte)dataMode, 0); }
  public static Offset<DiplomaticClearance_Ingest> EndDiplomaticClearance_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DiplomaticClearance_Ingest>(o);
  }
  public static void FinishDiplomaticClearance_IngestBuffer(FlatBufferBuilder builder, Offset<DiplomaticClearance_Ingest> offset) { builder.Finish(offset.Value, "DIPL"); }
  public static void FinishSizePrefixedDiplomaticClearance_IngestBuffer(FlatBufferBuilder builder, Offset<DiplomaticClearance_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "DIPL"); }
  public DiplomaticClearance_IngestT UnPack() {
    var _o = new DiplomaticClearance_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DiplomaticClearance_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<DiplomaticClearance_Ingest> Pack(FlatBufferBuilder builder, DiplomaticClearance_IngestT _o) {
    if (_o == null) return default(Offset<DiplomaticClearance_Ingest>);
...
public class DiplomaticClearance_IngestT
{
  ...
  public DiplomaticClearance_Ingest_dataMode_Enum DataMode { get; set; }

  public DiplomaticClearance_IngestT() {
    this.Id = null;
    ...
    this.DataMode = DiplomaticClearance_Ingest_dataMode_Enum.REAL;
  }
  public static DiplomaticClearance_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return DiplomaticClearance_Ingest.GetRootAsDiplomaticClearance_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DiplomaticClearance_Ingest.FinishDiplomaticClearance_IngestBuffer(fbb, DiplomaticClearance_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DiplomaticClearance_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 40 /*DataMode*/, 1 /*DiplomaticClearance_Ingest_dataMode_Enum*/, 1, false)
