...
public struct IonoObservationTime_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static IonoObservationTime_Full GetRootAsIonoObservationTime_Full(ByteBuffer _bb, IonoObservationTime_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationTime_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationTime_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationTime_FullVerify.Verify); }
  ...
  public static Offset<IonoObservationTime_Full> CreateIonoObservationTime_Full(FlatBufferBuilder builder,
  ...
  public static Offset<IonoObservationTime_Full> EndIonoObservationTime_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationTime_Full>(o);
  }
  public static void FinishIonoObservationTime_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationTime_Full> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationTime_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationTime_Full> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationTime_FullT UnPack() {
    var _o = new IonoObservationTime_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationTime_FullT _o) {
  ...
  public static Offset<IonoObservationTime_Full> Pack(FlatBufferBuilder builder, IonoObservationTime_FullT _o) {
    if (_o == null) return default(Offset<IonoObservationTime_Full>);
...
public class IonoObservationTime_FullT
{
  ...
  public IonoObservationTime_FullT() {
    this.Dimensions = null;
    this.DimensionName = null;
    this.Notes = null;
    this.Data = null;
  }
  public static IonoObservationTime_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationTime_Full.GetRootAsIonoObservationTime_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationTime_Full.FinishIonoObservationTime_FullBuffer(fbb, IonoObservationTime_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationTime_FullVerify
{
