...
public struct ECPSDR_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static ECPSDR_Ingest GetRootAsECPSDR_Ingest(ByteBuffer _bb) { return GetRootAsECPSDR_Ingest(_bb, new ECPSDR_Ingest()); }
  public static ECPSDR_Ingest GetRootAsECPSDR_Ingest(ByteBuffer _bb, ECPSDR_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool ECPSDR_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ECPS"); }
  public static bool VerifyECPSDR_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ECPS", false, ECPSDR_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public ECPSDR_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Example: /// Example: TEST
  /// Constraints: Minimum length = 1, Maximum length = 32
  public ECPSDR_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(106); return o != 0 ? (ECPSDR_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : ECPSDR_Ingest_dataMode_Enum.REAL; } }

  public static Offset<ECPSDR_Ingest> CreateECPSDR_Ingest(FlatBufferBuilder builder,
      ...
      ECPSDR_Ingest_dataMode_Enum dataMode = ECPSDR_Ingest_dataMode_Enum.REAL) {
    builder.StartTable(52);
    ECPSDR_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    ECPSDR_Ingest.AddOrigin(builder, originOffset);
    ECPSDR_Ingest.AddSource(builder, sourceOffset);
    ECPSDR_Ingest.AddCreatedBy(builder, createdByOffset);
    ECPSDR_Ingest.AddCreatedAt(builder, createdAtOffset);
    ECPSDR_Ingest.AddTransientData(builder, transientDataOffset);
    ECPSDR_Ingest.AddChecksum(builder, checksum);
    ECPSDR_Ingest.AddCdsThreshold(builder, cdsThreshold);
    ECPSDR_Ingest.AddCdsThrottle(builder, cdsThrottle);
    ECPSDR_Ingest.AddSurfDosStat(builder, surfDosStat);
    ECPSDR_Ingest.AddSurfDosChargeH(builder, surfDosChargeH);
    ECPSDR_Ingest.AddSurfDosChargeL(builder, surfDosChargeL);
    ECPSDR_Ingest.AddSurfDosH(builder, surfDosH);
    ECPSDR_Ingest.AddSurfDosM(builder, surfDosM);
    ECPSDR_Ingest.AddSurfDosL(builder, surfDosL);
    ECPSDR_Ingest.AddHiLetM(builder, hiLetM);
    ECPSDR_Ingest.AddHiLetL(builder, hiLetL);
    ECPSDR_Ingest.AddMedLet4M(builder, medLet4M);
    ECPSDR_Ingest.AddMedLet4L(builder, medLet4L);
    ECPSDR_Ingest.AddMedLet3M(builder, medLet3M);
    ECPSDR_Ingest.AddMedLet3L(builder, medLet3L);
    ECPSDR_Ingest.AddMedLet2M(builder, medLet2M);
    ECPSDR_Ingest.AddMedLet2L(builder, medLet2L);
    ECPSDR_Ingest.AddMedLet1M(builder, medLet1M);
    ECPSDR_Ingest.AddMedLet1L(builder, medLet1L);
    ECPSDR_Ingest.AddLowLetM(builder, lowLetM);
    ECPSDR_Ingest.AddLowLetL(builder, lowLetL);
    ECPSDR_Ingest.AddEsdTrigCountH(builder, esdTrigCountH);
    ECPSDR_Ingest.AddEsdTrigCountL(builder, esdTrigCountL);
    ECPSDR_Ingest.AddPd2SigLev(builder, pd2SigLev);
    ECPSDR_Ingest.AddPd1SigLev(builder, pd1SigLev);
    ECPSDR_Ingest.AddVRef(builder, vRef);
    ECPSDR_Ingest.AddMpTemp(builder, mpTemp);
    ECPSDR_Ingest.AddCdsRefVMon(builder, cdsRefVMon);
    ECPSDR_Ingest.AddCdsPlateVMon(builder, cdsPlateVMon);
    ECPSDR_Ingest.AddPsTempMon(builder, psTempMon);
    ECPSDR_Ingest.AddDsl5VCurrMon(builder, dsl5VCurrMon);
    ECPSDR_Ingest.AddAsl5VCurrMon(builder, asl5VCurrMon);
    ECPSDR_Ingest.AddDosBias(builder, dosBias);
    ECPSDR_Ingest.AddSenMode(builder, senModeOffset);
    ECPSDR_Ingest.AddObTime(builder, obTimeOffset);
    ECPSDR_Ingest.AddMsgTime(builder, msgTimeOffset);
    ECPSDR_Ingest.AddType(builder, typeOffset);
    ECPSDR_Ingest.AddOrigSensorId(builder, origSensorIdOffset);
    ECPSDR_Ingest.AddIdSensor(builder, idSensorOffset);
    ECPSDR_Ingest.AddOrigObjectId(builder, origObjectIdOffset);
    ECPSDR_Ingest.AddSatNo(builder, satNo);
    ECPSDR_Ingest.AddIdOnOrbit(builder, idOnOrbitOffset);
    ECPSDR_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    ECPSDR_Ingest.AddId(builder, idOffset);
    ECPSDR_Ingest.AddDataMode(builder, dataMode);
    ECPSDR_Ingest.AddRetransmit(builder, retransmit);
    return ECPSDR_Ingest.EndECPSDR_Ingest(builder);
  }

  public static void StartECPSDR_Ingest(FlatBufferBuilder builder) { builder.StartTable(52); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, ECPSDR_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(51, (sbyte)dataMode, 0); }
  public static Offset<ECPSDR_Ingest> EndECPSDR_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<ECPSDR_Ingest>(o);
  }
  public static void FinishECPSDR_IngestBuffer(FlatBufferBuilder builder, Offset<ECPSDR_Ingest> offset) { builder.Finish(offset.Value, "ECPS"); }
  public static void FinishSizePrefixedECPSDR_IngestBuffer(FlatBufferBuilder builder, Offset<ECPSDR_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "ECPS"); }
  public ECPSDR_IngestT UnPack() {
    var _o = new ECPSDR_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(ECPSDR_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<ECPSDR_Ingest> Pack(FlatBufferBuilder builder, ECPSDR_IngestT _o) {
    if (_o == null) return default(Offset<ECPSDR_Ingest>);
...
public class ECPSDR_IngestT
{
  ...
  public ECPSDR_Ingest_dataMode_Enum DataMode { get; set; }

  public ECPSDR_IngestT() {
    this.Id = null;
    ...
    this.DataMode = ECPSDR_Ingest_dataMode_Enum.REAL;
  }
  public static ECPSDR_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return ECPSDR_Ingest.GetRootAsECPSDR_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    ECPSDR_Ingest.FinishECPSDR_IngestBuffer(fbb, ECPSDR_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class ECPSDR_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 106 /*DataMode*/, 1 /*ECPSDR_Ingest_dataMode_Enum*/, 1, false)
