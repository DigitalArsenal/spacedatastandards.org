...
public struct SensorPlan_Ingest : IFlatbufferObject
{
  ...
  public static Offset<SensorPlan_Ingest.SensorPlan_Ingest> CreateSensorPlan_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<SensorPlan_Ingest.SensorPlan_Ingest> EndSensorPlan_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SensorPlan_Ingest.SensorPlan_Ingest>(o);
  }
  ...
  public static Offset<SensorPlan_Ingest.SensorPlan_Ingest> Pack(FlatBufferBuilder builder, SensorPlan_IngestT _o) {
    if (_o == null) return default(Offset<SensorPlan_Ingest.SensorPlan_Ingest>);
