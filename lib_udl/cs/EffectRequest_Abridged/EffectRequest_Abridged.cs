...
public struct EffectRequest_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EffectRequest_Abridged GetRootAsEffectRequest_Abridged(ByteBuffer _bb) { return GetRootAsEffectRequest_Abridged(_bb, new EffectRequest_Abridged()); }
  public static EffectRequest_Abridged GetRootAsEffectRequest_Abridged(ByteBuffer _bb, EffectRequest_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EffectRequest_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EFFE"); }
  public static bool VerifyEffectRequest_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EFFE", false, EffectRequest_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EffectRequest_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public EffectRequest_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(42); return o != 0 ? (EffectRequest_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EffectRequest_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<EffectRequest_Abridged> CreateEffectRequest_Abridged(FlatBufferBuilder builder,
      ...
      EffectRequest_Abridged_dataMode_Enum dataMode = EffectRequest_Abridged_dataMode_Enum.REAL,
  ...
  public static void StartEffectRequest_Abridged(FlatBufferBuilder builder) { builder.StartTable(21); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, EffectRequest_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(19, (sbyte)dataMode, 0); }
  ...
  public static Offset<EffectRequest_Abridged> EndEffectRequest_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EffectRequest_Abridged>(o);
  }
  public static void FinishEffectRequest_AbridgedBuffer(FlatBufferBuilder builder, Offset<EffectRequest_Abridged> offset) { builder.Finish(offset.Value, "EFFE"); }
  public static void FinishSizePrefixedEffectRequest_AbridgedBuffer(FlatBufferBuilder builder, Offset<EffectRequest_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "EFFE"); }
  public EffectRequest_AbridgedT UnPack() {
    var _o = new EffectRequest_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EffectRequest_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<EffectRequest_Abridged> Pack(FlatBufferBuilder builder, EffectRequest_AbridgedT _o) {
    if (_o == null) return default(Offset<EffectRequest_Abridged>);
...
public class EffectRequest_AbridgedT
{
  ...
  public EffectRequest_Abridged_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public EffectRequest_AbridgedT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = EffectRequest_Abridged_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static EffectRequest_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return EffectRequest_Abridged.GetRootAsEffectRequest_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EffectRequest_Abridged.FinishEffectRequest_AbridgedBuffer(fbb, EffectRequest_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EffectRequest_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 42 /*DataMode*/, 1 /*EffectRequest_Abridged_dataMode_Enum*/, 1, false)
