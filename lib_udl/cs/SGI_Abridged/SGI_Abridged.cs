...
public struct SGI_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static SGI_Abridged GetRootAsSGI_Abridged(ByteBuffer _bb, SGI_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SGI_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SGIA"); }
  public static bool VerifySGI_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SGIA", false, SGI_AbridgedVerify.Verify); }
  ...
  public SGI_Abridged_state_Enum State { get { int o = __p.__offset(14); return o != 0 ? (SGI_Abridged_state_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SGI_Abridged_state_Enum.I; } }
  ...
  /// Example: /// Example: R
  /// Constraints: Minimum length = 0, Maximum length = 1
  public SGI_Abridged_precedence_Enum Precedence { get { int o = __p.__offset(24); return o != 0 ? (SGI_Abridged_precedence_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SGI_Abridged_precedence_Enum.O; } }
  ...
  public string RawFileURI { get { int o = __p.__offset(86); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetRawFileURIBytes() { return __p.__vector_as_span<byte>(86, 1); }
#else
  public ArraySegment<byte>? GetRawFileURIBytes() { return __p.__vector_as_arraysegment(86); }
#endif
  public byte[] GetRawFileURIArray() { return __p.__vector_as_array<byte>(86); }
  ...
  public string Source { get { int o = __p.__offset(90); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceBytes() { return __p.__vector_as_span<byte>(90, 1); }
#else
  public ArraySegment<byte>? GetSourceBytes() { return __p.__vector_as_arraysegment(90); }
#endif
  public byte[] GetSourceArray() { return __p.__vector_as_array<byte>(90); }
  /// Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
  /// Example: /// Example: THIRD_PARTY_DATASOURCE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Origin { get { int o = __p.__offset(92); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOriginBytes() { return __p.__vector_as_span<byte>(92, 1); }
#else
  public ArraySegment<byte>? GetOriginBytes() { return __p.__vector_as_arraysegment(92); }
#endif
  public byte[] GetOriginArray() { return __p.__vector_as_array<byte>(92); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SGI_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(96); return o != 0 ? (SGI_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SGI_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<SGI_Abridged> CreateSGI_Abridged(FlatBufferBuilder builder,
      ...
      SGI_Abridged_state_Enum state = SGI_Abridged_state_Enum.I,
      ...
      int mode = 0,
      SGI_Abridged_precedence_Enum precedence = SGI_Abridged_precedence_Enum.O,
      ...
      SGI_Abridged_dataMode_Enum dataMode = SGI_Abridged_dataMode_Enum.REAL,
  ...
  public static void AddState(FlatBufferBuilder builder, SGI_Abridged_state_Enum state) { builder.AddSbyte(5, (sbyte)state, 0); }
  ...
  public static void AddPrecedence(FlatBufferBuilder builder, SGI_Abridged_precedence_Enum precedence) { builder.AddSbyte(10, (sbyte)precedence, 0); }
  ...
  public static void AddRawFileURI(FlatBufferBuilder builder, StringOffset rawFileURIOffset) { builder.AddOffset(41, rawFileURIOffset.Value, 0); }
  ...
  public static void AddSource(FlatBufferBuilder builder, StringOffset sourceOffset) { builder.AddOffset(43, sourceOffset.Value, 0); }
  public static void AddOrigin(FlatBufferBuilder builder, StringOffset originOffset) { builder.AddOffset(44, originOffset.Value, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SGI_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(46, (sbyte)dataMode, 0); }
  ...
  public static Offset<SGI_Abridged> EndSGI_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SGI_Abridged>(o);
  }
  public static void FinishSGI_AbridgedBuffer(FlatBufferBuilder builder, Offset<SGI_Abridged> offset) { builder.Finish(offset.Value, "SGIA"); }
  public static void FinishSizePrefixedSGI_AbridgedBuffer(FlatBufferBuilder builder, Offset<SGI_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "SGIA"); }
  public SGI_AbridgedT UnPack() {
    var _o = new SGI_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SGI_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SGI_Abridged> Pack(FlatBufferBuilder builder, SGI_AbridgedT _o) {
    if (_o == null) return default(Offset<SGI_Abridged>);
...
public class SGI_AbridgedT
{
  ...
  public SGI_Abridged_state_Enum State { get; set; }
  public string StationName { get; set; }
  public string IdSensor { get; set; }
  public string OrigSensorId { get; set; }
  public int Mode { get; set; }
  public SGI_Abridged_precedence_Enum Precedence { get; set; }
  ...
  public SGI_Abridged_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }

  public SGI_AbridgedT() {
    this.Id = null;
    this.ClassificationMarking = null;
    this.EffectiveDate = null;
    this.SgiDate = null;
    this.Type = null;
    this.State = SGI_Abridged_state_Enum.I;
    this.StationName = null;
    this.IdSensor = null;
    this.OrigSensorId = null;
    this.Mode = 0;
    this.Precedence = SGI_Abridged_precedence_Enum.O;
    ...
    this.DataMode = SGI_Abridged_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
  }
  public static SGI_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return SGI_Abridged.GetRootAsSGI_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SGI_Abridged.FinishSGI_AbridgedBuffer(fbb, SGI_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SGI_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 14 /*State*/, 1 /*SGI_Abridged_state_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 24 /*Precedence*/, 1 /*SGI_Abridged_precedence_Enum*/, 1, false)
      ...
      && verifier.VerifyString(tablePos, 86 /*RawFileURI*/, false)
      && verifier.VerifyString(tablePos, 88 /*TransactionId*/, false)
      && verifier.VerifyString(tablePos, 90 /*Source*/, false)
      && verifier.VerifyString(tablePos, 92 /*Origin*/, false)
      && verifier.VerifyString(tablePos, 94 /*OrigNetwork*/, false)
      && verifier.VerifyField(tablePos, 96 /*DataMode*/, 1 /*SGI_Abridged_dataMode_Enum*/, 1, false)
