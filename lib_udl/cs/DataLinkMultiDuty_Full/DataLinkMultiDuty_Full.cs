...
public struct DataLinkMultiDuty_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static DataLinkMultiDuty_Full GetRootAsDataLinkMultiDuty_Full(ByteBuffer _bb) { return GetRootAsDataLinkMultiDuty_Full(_bb, new DataLinkMultiDuty_Full()); }
  public static DataLinkMultiDuty_Full GetRootAsDataLinkMultiDuty_Full(ByteBuffer _bb, DataLinkMultiDuty_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DataLinkMultiDuty_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DATA"); }
  public static bool VerifyDataLinkMultiDuty_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DATA", false, DataLinkMultiDuty_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public DataLinkMultiDuty_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<DataLinkMultiDuty_Full> CreateDataLinkMultiDuty_Full(FlatBufferBuilder builder,
  ...
  public static void StartDataLinkMultiDuty_Full(FlatBufferBuilder builder) { builder.StartTable(6); }
  ...
  public static Offset<DataLinkMultiDuty_Full> EndDataLinkMultiDuty_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DataLinkMultiDuty_Full>(o);
  }
  public static void FinishDataLinkMultiDuty_FullBuffer(FlatBufferBuilder builder, Offset<DataLinkMultiDuty_Full> offset) { builder.Finish(offset.Value, "DATA"); }
  public static void FinishSizePrefixedDataLinkMultiDuty_FullBuffer(FlatBufferBuilder builder, Offset<DataLinkMultiDuty_Full> offset) { builder.FinishSizePrefixed(offset.Value, "DATA"); }
  public DataLinkMultiDuty_FullT UnPack() {
    var _o = new DataLinkMultiDuty_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DataLinkMultiDuty_FullT _o) {
  ...
  public static Offset<DataLinkMultiDuty_Full> Pack(FlatBufferBuilder builder, DataLinkMultiDuty_FullT _o) {
    if (_o == null) return default(Offset<DataLinkMultiDuty_Full>);
    ...
    return CreateDataLinkMultiDuty_Full(
      builder,
      _unitDes,
      _name,
      _rank,
...
public class DataLinkMultiDuty_FullT
{
  ...
  public DataLinkMultiDuty_FullT() {
    this.UnitDes = null;
    this.Name = null;
    this.Rank = null;
    this.Duty = null;
  ...
  public static DataLinkMultiDuty_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return DataLinkMultiDuty_Full.GetRootAsDataLinkMultiDuty_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DataLinkMultiDuty_Full.FinishDataLinkMultiDuty_FullBuffer(fbb, DataLinkMultiDuty_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DataLinkMultiDuty_FullVerify
{
