...
public struct SensorPlan_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static SensorPlan_Full GetRootAsSensorPlan_Full(ByteBuffer _bb, SensorPlan_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SensorPlan_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SENS"); }
  public static bool VerifySensorPlan_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SENS", false, SensorPlan_FullVerify.Verify); }
  ...
  public SensorPlan_Full_dataMode_Enum DataMode { get { int o = __p.__offset(44); return o != 0 ? (SensorPlan_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SensorPlan_Full_dataMode_Enum.REAL; } }
  ...
  /// Constraints: No constraints specified.
  public string CollectRequests(int j) { int o = __p.__offset(48); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int CollectRequestsLength { get { int o = __p.__offset(48); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  public static Offset<SensorPlan_Full> CreateSensorPlan_Full(FlatBufferBuilder builder,
      ...
      SensorPlan_Full_dataMode_Enum dataMode = SensorPlan_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SensorPlan_Full_dataMode_Enum dataMode) { builder.AddSbyte(20, (sbyte)dataMode, 0); }
  ...
  public static void AddCollectRequests(FlatBufferBuilder builder, VectorOffset collectRequestsOffset) { builder.AddOffset(22, collectRequestsOffset.Value, 0); }
  ...
  public static Offset<SensorPlan_Full> EndSensorPlan_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SensorPlan_Full>(o);
  }
  public static void FinishSensorPlan_FullBuffer(FlatBufferBuilder builder, Offset<SensorPlan_Full> offset) { builder.Finish(offset.Value, "SENS"); }
  public static void FinishSizePrefixedSensorPlan_FullBuffer(FlatBufferBuilder builder, Offset<SensorPlan_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SENS"); }
  public SensorPlan_FullT UnPack() {
    var _o = new SensorPlan_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SensorPlan_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SensorPlan_Full> Pack(FlatBufferBuilder builder, SensorPlan_FullT _o) {
    if (_o == null) return default(Offset<SensorPlan_Full>);
...
public class SensorPlan_FullT
{
  ...
  public SensorPlan_Full_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }
  public List<string> CollectRequests { get; set; }
  public List<string> Tags { get; set; }

  public SensorPlan_FullT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = SensorPlan_Full_dataMode_Enum.REAL;
    this.OrigNetwork = null;
    this.CollectRequests = null;
    this.Tags = null;
  }
  public static SensorPlan_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return SensorPlan_Full.GetRootAsSensorPlan_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SensorPlan_Full.FinishSensorPlan_FullBuffer(fbb, SensorPlan_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SensorPlan_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 44 /*DataMode*/, 1 /*SensorPlan_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 46 /*OrigNetwork*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 48 /*CollectRequests*/, false)
