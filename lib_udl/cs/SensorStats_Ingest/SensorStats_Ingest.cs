...
public struct SensorStats_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static SensorStats_Ingest GetRootAsSensorStats_Ingest(ByteBuffer _bb, SensorStats_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SensorStats_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SENS"); }
  public static bool VerifySensorStats_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SENS", false, SensorStats_IngestVerify.Verify); }
  ...
  public SensorStats_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(22); return o != 0 ? (SensorStats_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SensorStats_Ingest_dataMode_Enum.REAL; } }

  public static Offset<SensorStats_Ingest> CreateSensorStats_Ingest(FlatBufferBuilder builder,
      ...
      SensorStats_Ingest_dataMode_Enum dataMode = SensorStats_Ingest_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SensorStats_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(9, (sbyte)dataMode, 0); }
  public static Offset<SensorStats_Ingest> EndSensorStats_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SensorStats_Ingest>(o);
  }
  public static void FinishSensorStats_IngestBuffer(FlatBufferBuilder builder, Offset<SensorStats_Ingest> offset) { builder.Finish(offset.Value, "SENS"); }
  public static void FinishSizePrefixedSensorStats_IngestBuffer(FlatBufferBuilder builder, Offset<SensorStats_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "SENS"); }
  public SensorStats_IngestT UnPack() {
    var _o = new SensorStats_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SensorStats_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SensorStats_Ingest> Pack(FlatBufferBuilder builder, SensorStats_IngestT _o) {
    if (_o == null) return default(Offset<SensorStats_Ingest>);
...
public class SensorStats_IngestT
{
  ...
  public SensorStats_Ingest_dataMode_Enum DataMode { get; set; }

  public SensorStats_IngestT() {
    this.Id = null;
    this.IdSensor = null;
    ...
    this.UpdatedBy = null;
    this.Source = null;
    this.DataMode = SensorStats_Ingest_dataMode_Enum.REAL;
  }
  public static SensorStats_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return SensorStats_Ingest.GetRootAsSensorStats_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SensorStats_Ingest.FinishSensorStats_IngestBuffer(fbb, SensorStats_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SensorStats_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*DataMode*/, 1 /*SensorStats_Ingest_dataMode_Enum*/, 1, false)
