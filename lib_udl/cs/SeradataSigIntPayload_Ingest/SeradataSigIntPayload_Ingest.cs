...
public struct SeradataSigIntPayload_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static SeradataSigIntPayload_Ingest GetRootAsSeradataSigIntPayload_Ingest(ByteBuffer _bb, SeradataSigIntPayload_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SeradataSigIntPayload_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SERA"); }
  public static bool VerifySeradataSigIntPayload_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SERA", false, SeradataSigIntPayload_IngestVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SeradataSigIntPayload_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(44); return o != 0 ? (SeradataSigIntPayload_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SeradataSigIntPayload_Ingest_dataMode_Enum.REAL; } }

  public static Offset<SeradataSigIntPayload_Ingest> CreateSeradataSigIntPayload_Ingest(FlatBufferBuilder builder,
      ...
      SeradataSigIntPayload_Ingest_dataMode_Enum dataMode = SeradataSigIntPayload_Ingest_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SeradataSigIntPayload_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(20, (sbyte)dataMode, 0); }
  public static Offset<SeradataSigIntPayload_Ingest> EndSeradataSigIntPayload_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SeradataSigIntPayload_Ingest>(o);
  }
  public static void FinishSeradataSigIntPayload_IngestBuffer(FlatBufferBuilder builder, Offset<SeradataSigIntPayload_Ingest> offset) { builder.Finish(offset.Value, "SERA"); }
  public static void FinishSizePrefixedSeradataSigIntPayload_IngestBuffer(FlatBufferBuilder builder, Offset<SeradataSigIntPayload_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "SERA"); }
  public SeradataSigIntPayload_IngestT UnPack() {
    var _o = new SeradataSigIntPayload_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SeradataSigIntPayload_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SeradataSigIntPayload_Ingest> Pack(FlatBufferBuilder builder, SeradataSigIntPayload_IngestT _o) {
    if (_o == null) return default(Offset<SeradataSigIntPayload_Ingest>);
...
public class SeradataSigIntPayload_IngestT
{
  ...
  public SeradataSigIntPayload_Ingest_dataMode_Enum DataMode { get; set; }

  public SeradataSigIntPayload_IngestT() {
    this.Id = null;
    ...
    this.DataMode = SeradataSigIntPayload_Ingest_dataMode_Enum.REAL;
  }
  public static SeradataSigIntPayload_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return SeradataSigIntPayload_Ingest.GetRootAsSeradataSigIntPayload_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SeradataSigIntPayload_Ingest.FinishSeradataSigIntPayload_IngestBuffer(fbb, SeradataSigIntPayload_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SeradataSigIntPayload_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 44 /*DataMode*/, 1 /*SeradataSigIntPayload_Ingest_dataMode_Enum*/, 1, false)
