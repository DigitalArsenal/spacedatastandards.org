...
public struct RFGeoLocation_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static RFGeoLocation_Full GetRootAsRFGeoLocation_Full(ByteBuffer _bb) { return GetRootAsRFGeoLocation_Full(_bb, new RFGeoLocation_Full()); }
  public static RFGeoLocation_Full GetRootAsRFGeoLocation_Full(ByteBuffer _bb, RFGeoLocation_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool RFGeoLocation_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "RFGE"); }
  public static bool VerifyRFGeoLocation_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("RFGE", false, RFGeoLocation_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public RFGeoLocation_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Example: /// Example: POLYGON((67.3291113966927 26.156175339112,67.2580009640721 26.091022064271,67.1795862381682 26.6637992964562,67.2501237475598 26.730115808233,67.3291113966927 26.156175339112))
  /// Constraints: No constraints specified.
  public string Area { get { int o = __p.__offset(60); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAreaBytes() { return __p.__vector_as_span<byte>(60, 1); }
#else
  public ArraySegment<byte>? GetAreaBytes() { return __p.__vector_as_arraysegment(60); }
#endif
  public byte[] GetAreaArray() { return __p.__vector_as_array<byte>(60); }
  /// Number of dimensions of the geometry depicted by region.
  /// Example: /// Example: 3
  /// Constraints: No constraints specified.
  public int Andims { get { int o = __p.__offset(62); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  /// Geographical spatial_ref_sys for region.
  /// Example: /// Example: 3
  /// Constraints: No constraints specified.
  public int Asrid { get { int o = __p.__offset(64); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string PassGroupId { get { int o = __p.__offset(66); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetPassGroupIdBytes() { return __p.__vector_as_span<byte>(66, 1); }
#else
  public ArraySegment<byte>? GetPassGroupIdBytes() { return __p.__vector_as_arraysegment(66); }
#endif
  public byte[] GetPassGroupIdArray() { return __p.__vector_as_array<byte>(66); }
  /// The RFGeo algorithm type and version used in geolocation calculations.
  /// Example: /// Example: v1.0-3-gps_nb_3ball
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string AlgVersion { get { int o = __p.__offset(68); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAlgVersionBytes() { return __p.__vector_as_span<byte>(68, 1); }
#else
  public ArraySegment<byte>? GetAlgVersionBytes() { return __p.__vector_as_arraysegment(68); }
#endif
  public byte[] GetAlgVersionArray() { return __p.__vector_as_array<byte>(68); }
  /// Optional ID from external systems. This field has no meaning within UDL and is provided as a convenience for systems that require tracking of an internal system generated ID.
  /// Example: /// Example: 780180925
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string ExternalId { get { int o = __p.__offset(70); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetExternalIdBytes() { return __p.__vector_as_span<byte>(70, 1); }
#else
  public ArraySegment<byte>? GetExternalIdBytes() { return __p.__vector_as_arraysegment(70); }
#endif
  public byte[] GetExternalIdArray() { return __p.__vector_as_array<byte>(70); }
  ...
  /// Example: /// Example: AXE
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string SourceDL { get { int o = __p.__offset(84); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetSourceDLBytes() { return __p.__vector_as_span<byte>(84, 1); }
#else
  public ArraySegment<byte>? GetSourceDLBytes() { return __p.__vector_as_arraysegment(84); }
#endif
  public byte[] GetSourceDLArray() { return __p.__vector_as_array<byte>(84); }
  ...
  public RFGeoLocation_Full_dataMode_Enum DataMode { get { int o = __p.__offset(86); return o != 0 ? (RFGeoLocation_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFGeoLocation_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<RFGeoLocation_Full> CreateRFGeoLocation_Full(FlatBufferBuilder builder,
      ...
      RFGeoLocation_Full_dataMode_Enum dataMode = RFGeoLocation_Full_dataMode_Enum.REAL,
  ...
  public static void StartRFGeoLocation_Full(FlatBufferBuilder builder) { builder.StartTable(43); }
  ...
  public static void AddArea(FlatBufferBuilder builder, StringOffset areaOffset) { builder.AddOffset(28, areaOffset.Value, 0); }
  ...
  public static void AddPassGroupId(FlatBufferBuilder builder, StringOffset passGroupIdOffset) { builder.AddOffset(31, passGroupIdOffset.Value, 0); }
  public static void AddAlgVersion(FlatBufferBuilder builder, StringOffset algVersionOffset) { builder.AddOffset(32, algVersionOffset.Value, 0); }
  public static void AddExternalId(FlatBufferBuilder builder, StringOffset externalIdOffset) { builder.AddOffset(33, externalIdOffset.Value, 0); }
  ...
  public static void AddSourceDL(FlatBufferBuilder builder, StringOffset sourceDLOffset) { builder.AddOffset(40, sourceDLOffset.Value, 0); }
  public static void AddDataMode(FlatBufferBuilder builder, RFGeoLocation_Full_dataMode_Enum dataMode) { builder.AddSbyte(41, (sbyte)dataMode, 0); }
  ...
  public static Offset<RFGeoLocation_Full> EndRFGeoLocation_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RFGeoLocation_Full>(o);
  }
  public static void FinishRFGeoLocation_FullBuffer(FlatBufferBuilder builder, Offset<RFGeoLocation_Full> offset) { builder.Finish(offset.Value, "RFGE"); }
  public static void FinishSizePrefixedRFGeoLocation_FullBuffer(FlatBufferBuilder builder, Offset<RFGeoLocation_Full> offset) { builder.FinishSizePrefixed(offset.Value, "RFGE"); }
  public RFGeoLocation_FullT UnPack() {
    var _o = new RFGeoLocation_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RFGeoLocation_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<RFGeoLocation_Full> Pack(FlatBufferBuilder builder, RFGeoLocation_FullT _o) {
    if (_o == null) return default(Offset<RFGeoLocation_Full>);
...
public class RFGeoLocation_FullT
{
  ...
  public RFGeoLocation_Full_dataMode_Enum DataMode { get; set; }
  public string OnOrbit { get; set; }

  public RFGeoLocation_FullT() {
    this.Id = null;
    ...
    this.SourceDL = null;
    this.DataMode = RFGeoLocation_Full_dataMode_Enum.REAL;
    this.OnOrbit = null;
  }
  public static RFGeoLocation_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return RFGeoLocation_Full.GetRootAsRFGeoLocation_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    RFGeoLocation_Full.FinishRFGeoLocation_FullBuffer(fbb, RFGeoLocation_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class RFGeoLocation_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyString(tablePos, 60 /*Area*/, false)
      && verifier.VerifyField(tablePos, 62 /*Andims*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 64 /*Asrid*/, 4 /*int*/, 4, false)
      && verifier.VerifyString(tablePos, 66 /*PassGroupId*/, false)
      && verifier.VerifyString(tablePos, 68 /*AlgVersion*/, false)
      && verifier.VerifyString(tablePos, 70 /*ExternalId*/, false)
      ...
      && verifier.VerifyString(tablePos, 84 /*SourceDL*/, false)
      && verifier.VerifyField(tablePos, 86 /*DataMode*/, 1 /*RFGeoLocation_Full_dataMode_Enum*/, 1, false)
