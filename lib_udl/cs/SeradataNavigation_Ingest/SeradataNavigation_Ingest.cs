...
public struct SeradataNavigation_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static SeradataNavigation_Ingest GetRootAsSeradataNavigation_Ingest(ByteBuffer _bb, SeradataNavigation_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SeradataNavigation_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SERA"); }
  public static bool VerifySeradataNavigation_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SERA", false, SeradataNavigation_IngestVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SeradataNavigation_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(44); return o != 0 ? (SeradataNavigation_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SeradataNavigation_Ingest_dataMode_Enum.REAL; } }

  public static Offset<SeradataNavigation_Ingest> CreateSeradataNavigation_Ingest(FlatBufferBuilder builder,
      ...
      SeradataNavigation_Ingest_dataMode_Enum dataMode = SeradataNavigation_Ingest_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SeradataNavigation_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(20, (sbyte)dataMode, 0); }
  public static Offset<SeradataNavigation_Ingest> EndSeradataNavigation_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SeradataNavigation_Ingest>(o);
  }
  public static void FinishSeradataNavigation_IngestBuffer(FlatBufferBuilder builder, Offset<SeradataNavigation_Ingest> offset) { builder.Finish(offset.Value, "SERA"); }
  public static void FinishSizePrefixedSeradataNavigation_IngestBuffer(FlatBufferBuilder builder, Offset<SeradataNavigation_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "SERA"); }
  public SeradataNavigation_IngestT UnPack() {
    var _o = new SeradataNavigation_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SeradataNavigation_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SeradataNavigation_Ingest> Pack(FlatBufferBuilder builder, SeradataNavigation_IngestT _o) {
    if (_o == null) return default(Offset<SeradataNavigation_Ingest>);
    ...
    return CreateSeradataNavigation_Ingest(
      builder,
      _id,
...
public class SeradataNavigation_IngestT
{
  ...
  public SeradataNavigation_Ingest_dataMode_Enum DataMode { get; set; }

  public SeradataNavigation_IngestT() {
    this.Id = null;
    ...
    this.DataMode = SeradataNavigation_Ingest_dataMode_Enum.REAL;
  }
  public static SeradataNavigation_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return SeradataNavigation_Ingest.GetRootAsSeradataNavigation_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SeradataNavigation_Ingest.FinishSeradataNavigation_IngestBuffer(fbb, SeradataNavigation_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SeradataNavigation_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 44 /*DataMode*/, 1 /*SeradataNavigation_Ingest_dataMode_Enum*/, 1, false)
