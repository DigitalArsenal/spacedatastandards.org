...
public struct AirfieldSlotConsumption_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirfieldSlotConsumption_Ingest GetRootAsAirfieldSlotConsumption_Ingest(ByteBuffer _bb) { return GetRootAsAirfieldSlotConsumption_Ingest(_bb, new AirfieldSlotConsumption_Ingest()); }
  public static AirfieldSlotConsumption_Ingest GetRootAsAirfieldSlotConsumption_Ingest(ByteBuffer _bb, AirfieldSlotConsumption_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirfieldSlotConsumption_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRF"); }
  public static bool VerifyAirfieldSlotConsumption_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRF", false, AirfieldSlotConsumption_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirfieldSlotConsumption_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public AirfieldSlotConsumption_Ingest_status_Enum Status { get { int o = __p.__offset(10); return o != 0 ? (AirfieldSlotConsumption_Ingest_status_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirfieldSlotConsumption_Ingest_status_Enum.REQUESTED; } }
  ...
  public AirfieldSlotConsumption_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(76); return o != 0 ? (AirfieldSlotConsumption_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AirfieldSlotConsumption_Ingest_dataMode_Enum.REAL; } }

  public static Offset<AirfieldSlotConsumption_Ingest> CreateAirfieldSlotConsumption_Ingest(FlatBufferBuilder builder,
      StringOffset idOffset = default(StringOffset),
      StringOffset classificationMarkingOffset = default(StringOffset),
      StringOffset idAirfieldSlotOffset = default(StringOffset),
      AirfieldSlotConsumption_Ingest_status_Enum status = AirfieldSlotConsumption_Ingest_status_Enum.REQUESTED,
      bool occupied = false,
      ...
      AirfieldSlotConsumption_Ingest_dataMode_Enum dataMode = AirfieldSlotConsumption_Ingest_dataMode_Enum.REAL) {
    builder.StartTable(37);
    AirfieldSlotConsumption_Ingest.AddOrigNetwork(builder, origNetworkOffset);
    AirfieldSlotConsumption_Ingest.AddOrigin(builder, originOffset);
    AirfieldSlotConsumption_Ingest.AddSource(builder, sourceOffset);
    AirfieldSlotConsumption_Ingest.AddSourceDL(builder, sourceDLOffset);
    AirfieldSlotConsumption_Ingest.AddCreatedBy(builder, createdByOffset);
    AirfieldSlotConsumption_Ingest.AddCreatedAt(builder, createdAtOffset);
    AirfieldSlotConsumption_Ingest.AddAppInitials(builder, appInitialsOffset);
    AirfieldSlotConsumption_Ingest.AddAppOrg(builder, appOrgOffset);
    AirfieldSlotConsumption_Ingest.AddReqInitials(builder, reqInitialsOffset);
    AirfieldSlotConsumption_Ingest.AddReqOrg(builder, reqOrgOffset);
    AirfieldSlotConsumption_Ingest.AddAppComment(builder, appCommentOffset);
    AirfieldSlotConsumption_Ingest.AddReqComment(builder, reqCommentOffset);
    AirfieldSlotConsumption_Ingest.AddAltDepSortieId(builder, altDepSortieIdOffset);
    AirfieldSlotConsumption_Ingest.AddAltArrSortieId(builder, altArrSortieIdOffset);
    AirfieldSlotConsumption_Ingest.AddIdDepSortie(builder, idDepSortieOffset);
    AirfieldSlotConsumption_Ingest.AddIdArrSortie(builder, idArrSortieOffset);
    AirfieldSlotConsumption_Ingest.AddTargetTime(builder, targetTimeOffset);
    AirfieldSlotConsumption_Ingest.AddEndTime(builder, endTimeOffset);
    AirfieldSlotConsumption_Ingest.AddStartTime(builder, startTimeOffset);
    AirfieldSlotConsumption_Ingest.AddResMissionId(builder, resMissionIdOffset);
    AirfieldSlotConsumption_Ingest.AddResReason(builder, resReasonOffset);
    AirfieldSlotConsumption_Ingest.AddResType(builder, resTypeOffset);
    AirfieldSlotConsumption_Ingest.AddResTailNumber(builder, resTailNumberOffset);
    AirfieldSlotConsumption_Ingest.AddResAircraftMDS(builder, resAircraftMDSOffset);
    AirfieldSlotConsumption_Ingest.AddOccStartTime(builder, occStartTimeOffset);
    AirfieldSlotConsumption_Ingest.AddNumAircraft(builder, numAircraft);
    AirfieldSlotConsumption_Ingest.AddMissionId(builder, missionIdOffset);
    AirfieldSlotConsumption_Ingest.AddCallSigns(builder, callSignsOffset);
    AirfieldSlotConsumption_Ingest.AddOccTailNumber(builder, occTailNumberOffset);
    AirfieldSlotConsumption_Ingest.AddOccAircraftMDS(builder, occAircraftMDSOffset);
    AirfieldSlotConsumption_Ingest.AddConsumer(builder, consumerOffset);
    AirfieldSlotConsumption_Ingest.AddIdAirfieldSlot(builder, idAirfieldSlotOffset);
    AirfieldSlotConsumption_Ingest.AddClassificationMarking(builder, classificationMarkingOffset);
    AirfieldSlotConsumption_Ingest.AddId(builder, idOffset);
    AirfieldSlotConsumption_Ingest.AddDataMode(builder, dataMode);
    AirfieldSlotConsumption_Ingest.AddOccupied(builder, occupied);
    AirfieldSlotConsumption_Ingest.AddStatus(builder, status);
    return AirfieldSlotConsumption_Ingest.EndAirfieldSlotConsumption_Ingest(builder);
  }

  public static void StartAirfieldSlotConsumption_Ingest(FlatBufferBuilder builder) { builder.StartTable(37); }
  ...
  public static void AddStatus(FlatBufferBuilder builder, AirfieldSlotConsumption_Ingest_status_Enum status) { builder.AddSbyte(3, (sbyte)status, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AirfieldSlotConsumption_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(36, (sbyte)dataMode, 0); }
  public static Offset<AirfieldSlotConsumption_Ingest> EndAirfieldSlotConsumption_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirfieldSlotConsumption_Ingest>(o);
  }
  public static void FinishAirfieldSlotConsumption_IngestBuffer(FlatBufferBuilder builder, Offset<AirfieldSlotConsumption_Ingest> offset) { builder.Finish(offset.Value, "AIRF"); }
  public static void FinishSizePrefixedAirfieldSlotConsumption_IngestBuffer(FlatBufferBuilder builder, Offset<AirfieldSlotConsumption_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AIRF"); }
  public AirfieldSlotConsumption_IngestT UnPack() {
    var _o = new AirfieldSlotConsumption_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirfieldSlotConsumption_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AirfieldSlotConsumption_Ingest> Pack(FlatBufferBuilder builder, AirfieldSlotConsumption_IngestT _o) {
    if (_o == null) return default(Offset<AirfieldSlotConsumption_Ingest>);
...
public class AirfieldSlotConsumption_IngestT
{
  public string Id { get; set; }
  public string ClassificationMarking { get; set; }
  public string IdAirfieldSlot { get; set; }
  public AirfieldSlotConsumption_Ingest_status_Enum Status { get; set; }
  ...
  public AirfieldSlotConsumption_Ingest_dataMode_Enum DataMode { get; set; }

  public AirfieldSlotConsumption_IngestT() {
    this.Id = null;
    this.ClassificationMarking = null;
    this.IdAirfieldSlot = null;
    this.Status = AirfieldSlotConsumption_Ingest_status_Enum.REQUESTED;
    this.Occupied = false;
    this.Consumer = null;
    ...
    this.DataMode = AirfieldSlotConsumption_Ingest_dataMode_Enum.REAL;
  }
  public static AirfieldSlotConsumption_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AirfieldSlotConsumption_Ingest.GetRootAsAirfieldSlotConsumption_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirfieldSlotConsumption_Ingest.FinishAirfieldSlotConsumption_IngestBuffer(fbb, AirfieldSlotConsumption_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirfieldSlotConsumption_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*Status*/, 1 /*AirfieldSlotConsumption_Ingest_status_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 76 /*DataMode*/, 1 /*AirfieldSlotConsumption_Ingest_dataMode_Enum*/, 1, false)
