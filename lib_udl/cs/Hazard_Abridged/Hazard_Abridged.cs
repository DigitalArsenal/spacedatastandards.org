...
public struct Hazard_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static Hazard_Abridged GetRootAsHazard_Abridged(ByteBuffer _bb, Hazard_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Hazard_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "HAZA"); }
  public static bool VerifyHazard_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("HAZA", false, Hazard_AbridgedVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Hazard_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(82); return o != 0 ? (Hazard_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Hazard_Abridged_dataMode_Enum.REAL; } }

  public static Offset<Hazard_Abridged> CreateHazard_Abridged(FlatBufferBuilder builder,
      ...
      Hazard_Abridged_dataMode_Enum dataMode = Hazard_Abridged_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Hazard_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(39, (sbyte)dataMode, 0); }
  public static Offset<Hazard_Abridged> EndHazard_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Hazard_Abridged>(o);
  }
  public static void FinishHazard_AbridgedBuffer(FlatBufferBuilder builder, Offset<Hazard_Abridged> offset) { builder.Finish(offset.Value, "HAZA"); }
  public static void FinishSizePrefixedHazard_AbridgedBuffer(FlatBufferBuilder builder, Offset<Hazard_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "HAZA"); }
  public Hazard_AbridgedT UnPack() {
    var _o = new Hazard_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Hazard_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Hazard_Abridged> Pack(FlatBufferBuilder builder, Hazard_AbridgedT _o) {
    if (_o == null) return default(Offset<Hazard_Abridged>);
...
public class Hazard_AbridgedT
{
  ...
  public Hazard_Abridged_dataMode_Enum DataMode { get; set; }

  public Hazard_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = Hazard_Abridged_dataMode_Enum.REAL;
  }
  public static Hazard_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Hazard_Abridged.GetRootAsHazard_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Hazard_Abridged.FinishHazard_AbridgedBuffer(fbb, Hazard_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Hazard_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 82 /*DataMode*/, 1 /*Hazard_Abridged_dataMode_Enum*/, 1, false)
