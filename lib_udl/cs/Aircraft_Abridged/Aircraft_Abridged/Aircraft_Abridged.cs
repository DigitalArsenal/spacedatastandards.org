...
public struct Aircraft_Abridged : IFlatbufferObject
{
  ...
  public static Offset<Aircraft_Abridged.Aircraft_Abridged> CreateAircraft_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<Aircraft_Abridged.Aircraft_Abridged> EndAircraft_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Aircraft_Abridged.Aircraft_Abridged>(o);
  }
  ...
  public static Offset<Aircraft_Abridged.Aircraft_Abridged> Pack(FlatBufferBuilder builder, Aircraft_AbridgedT _o) {
    if (_o == null) return default(Offset<Aircraft_Abridged.Aircraft_Abridged>);
