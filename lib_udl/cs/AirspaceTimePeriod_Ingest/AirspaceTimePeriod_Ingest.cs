...
public struct AirspaceTimePeriod_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AirspaceTimePeriod_Ingest GetRootAsAirspaceTimePeriod_Ingest(ByteBuffer _bb) { return GetRootAsAirspaceTimePeriod_Ingest(_bb, new AirspaceTimePeriod_Ingest()); }
  public static AirspaceTimePeriod_Ingest GetRootAsAirspaceTimePeriod_Ingest(ByteBuffer _bb, AirspaceTimePeriod_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirspaceTimePeriod_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRS"); }
  public static bool VerifyAirspaceTimePeriod_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRS", false, AirspaceTimePeriod_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AirspaceTimePeriod_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<AirspaceTimePeriod_Ingest> CreateAirspaceTimePeriod_Ingest(FlatBufferBuilder builder,
  ...
  public static void StartAirspaceTimePeriod_Ingest(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<AirspaceTimePeriod_Ingest> EndAirspaceTimePeriod_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirspaceTimePeriod_Ingest>(o);
  }
  public static void FinishAirspaceTimePeriod_IngestBuffer(FlatBufferBuilder builder, Offset<AirspaceTimePeriod_Ingest> offset) { builder.Finish(offset.Value, "AIRS"); }
  public static void FinishSizePrefixedAirspaceTimePeriod_IngestBuffer(FlatBufferBuilder builder, Offset<AirspaceTimePeriod_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "AIRS"); }
  public AirspaceTimePeriod_IngestT UnPack() {
    var _o = new AirspaceTimePeriod_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirspaceTimePeriod_IngestT _o) {
  ...
  public static Offset<AirspaceTimePeriod_Ingest> Pack(FlatBufferBuilder builder, AirspaceTimePeriod_IngestT _o) {
    if (_o == null) return default(Offset<AirspaceTimePeriod_Ingest>);
    ...
    return CreateAirspaceTimePeriod_Ingest(
      builder,
      _timeMode,
      _timeStart,
      _timeEnd,
...
public class AirspaceTimePeriod_IngestT
{
  ...
  public AirspaceTimePeriod_IngestT() {
    this.TimeMode = null;
    this.TimeStart = null;
    this.TimeEnd = null;
    this.IntFreq = null;
  ...
  public static AirspaceTimePeriod_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AirspaceTimePeriod_Ingest.GetRootAsAirspaceTimePeriod_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirspaceTimePeriod_Ingest.FinishAirspaceTimePeriod_IngestBuffer(fbb, AirspaceTimePeriod_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirspaceTimePeriod_IngestVerify
{
