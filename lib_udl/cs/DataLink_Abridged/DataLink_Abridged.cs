...
public struct DataLink_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static DataLink_Abridged GetRootAsDataLink_Abridged(ByteBuffer _bb) { return GetRootAsDataLink_Abridged(_bb, new DataLink_Abridged()); }
  public static DataLink_Abridged GetRootAsDataLink_Abridged(ByteBuffer _bb, DataLink_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DataLink_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DATA"); }
  public static bool VerifyDataLink_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DATA", false, DataLink_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public DataLink_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public DataLink_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(150); return o != 0 ? (DataLink_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : DataLink_Abridged_dataMode_Enum.REAL; } }

  public static Offset<DataLink_Abridged> CreateDataLink_Abridged(FlatBufferBuilder builder,
      ...
      DataLink_Abridged_dataMode_Enum dataMode = DataLink_Abridged_dataMode_Enum.REAL) {
  ...
  public static void StartDataLink_Abridged(FlatBufferBuilder builder) { builder.StartTable(74); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, DataLink_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(73, (sbyte)dataMode, 0); }
  public static Offset<DataLink_Abridged> EndDataLink_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DataLink_Abridged>(o);
  }
  public static void FinishDataLink_AbridgedBuffer(FlatBufferBuilder builder, Offset<DataLink_Abridged> offset) { builder.Finish(offset.Value, "DATA"); }
  public static void FinishSizePrefixedDataLink_AbridgedBuffer(FlatBufferBuilder builder, Offset<DataLink_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "DATA"); }
  public DataLink_AbridgedT UnPack() {
    var _o = new DataLink_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DataLink_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<DataLink_Abridged> Pack(FlatBufferBuilder builder, DataLink_AbridgedT _o) {
    if (_o == null) return default(Offset<DataLink_Abridged>);
...
public class DataLink_AbridgedT
{
  ...
  public DataLink_Abridged_dataMode_Enum DataMode { get; set; }

  public DataLink_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = DataLink_Abridged_dataMode_Enum.REAL;
  }
  public static DataLink_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return DataLink_Abridged.GetRootAsDataLink_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DataLink_Abridged.FinishDataLink_AbridgedBuffer(fbb, DataLink_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DataLink_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 150 /*DataMode*/, 1 /*DataLink_Abridged_dataMode_Enum*/, 1, false)
