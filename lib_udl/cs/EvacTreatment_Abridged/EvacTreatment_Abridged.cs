...
public struct EvacTreatment_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EvacTreatment_Abridged GetRootAsEvacTreatment_Abridged(ByteBuffer _bb) { return GetRootAsEvacTreatment_Abridged(_bb, new EvacTreatment_Abridged()); }
  public static EvacTreatment_Abridged GetRootAsEvacTreatment_Abridged(ByteBuffer _bb, EvacTreatment_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EvacTreatment_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EVAC"); }
  public static bool VerifyEvacTreatment_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EVAC", false, EvacTreatment_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EvacTreatment_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<EvacTreatment_Abridged> CreateEvacTreatment_Abridged(FlatBufferBuilder builder,
  ...
  public static void StartEvacTreatment_Abridged(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<EvacTreatment_Abridged> EndEvacTreatment_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EvacTreatment_Abridged>(o);
  }
  public static void FinishEvacTreatment_AbridgedBuffer(FlatBufferBuilder builder, Offset<EvacTreatment_Abridged> offset) { builder.Finish(offset.Value, "EVAC"); }
  public static void FinishSizePrefixedEvacTreatment_AbridgedBuffer(FlatBufferBuilder builder, Offset<EvacTreatment_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "EVAC"); }
  public EvacTreatment_AbridgedT UnPack() {
    var _o = new EvacTreatment_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EvacTreatment_AbridgedT _o) {
    _o.Type = this.Type;
    _o.BodyPart = this.BodyPart;
    _o.Time = this.Time;
    _o.Comments = this.Comments;
  }
  public static Offset<EvacTreatment_Abridged> Pack(FlatBufferBuilder builder, EvacTreatment_AbridgedT _o) {
    if (_o == null) return default(Offset<EvacTreatment_Abridged>);
...
public class EvacTreatment_AbridgedT
{
  ...
  public EvacTreatment_AbridgedT() {
    this.Type = null;
    this.BodyPart = null;
    this.Time = null;
    this.Comments = null;
  }
  public static EvacTreatment_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return EvacTreatment_Abridged.GetRootAsEvacTreatment_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EvacTreatment_Abridged.FinishEvacTreatment_AbridgedBuffer(fbb, EvacTreatment_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EvacTreatment_AbridgedVerify
{
