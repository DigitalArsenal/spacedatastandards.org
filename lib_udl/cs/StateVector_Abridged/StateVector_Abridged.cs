...
public struct StateVector_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static StateVector_Abridged GetRootAsStateVector_Abridged(ByteBuffer _bb, StateVector_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool StateVector_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "STAT"); }
  public static bool VerifyStateVector_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("STAT", false, StateVector_AbridgedVerify.Verify); }
  ...
  public StateVector_Abridged_referenceFrame_Enum ReferenceFrame { get { int o = __p.__offset(34); return o != 0 ? (StateVector_Abridged_referenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : StateVector_Abridged_referenceFrame_Enum.J2000; } }
  ...
  /// Example: /// Example: J2000
  /// Constraints: Minimum length = 0, Maximum length = 24
  public StateVector_Abridged_covReferenceFrame_Enum CovReferenceFrame { get { int o = __p.__offset(38); return o != 0 ? (StateVector_Abridged_covReferenceFrame_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : StateVector_Abridged_covReferenceFrame_Enum.J2000; } }
  ...
  public StateVector_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(172); return o != 0 ? (StateVector_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : StateVector_Abridged_dataMode_Enum.REAL; } }
  /// Optional algorithm used to produce this record.
  /// Example: /// Example: SAMPLE_ALGORITHM
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Algorithm { get { int o = __p.__offset(174); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetAlgorithmBytes() { return __p.__vector_as_span<byte>(174, 1); }
#else
  public ArraySegment<byte>? GetAlgorithmBytes() { return __p.__vector_as_arraysegment(174); }
#endif
  public byte[] GetAlgorithmArray() { return __p.__vector_as_array<byte>(174); }
  /// Time the row was created in the database, auto-populated by the system.
  /// Example: /// Example: 2018-01-01T16:00:00.123Z
  /// Constraints: No constraints specified.
  public string CreatedAt { get { int o = __p.__offset(176); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedAtBytes() { return __p.__vector_as_span<byte>(176, 1); }
#else
  public ArraySegment<byte>? GetCreatedAtBytes() { return __p.__vector_as_arraysegment(176); }
#endif
  public byte[] GetCreatedAtArray() { return __p.__vector_as_array<byte>(176); }
  /// Application user who created the row in the database, auto-populated by the system.
  /// Example: /// Example: some.user
  /// Constraints: Minimum length = 1, Maximum length = 64
  public string CreatedBy { get { int o = __p.__offset(178); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetCreatedByBytes() { return __p.__vector_as_span<byte>(178, 1); }
#else
  public ArraySegment<byte>? GetCreatedByBytes() { return __p.__vector_as_arraysegment(178); }
#endif
  public byte[] GetCreatedByArray() { return __p.__vector_as_array<byte>(178); }
  /// Optional source-provided and searchable metadata or descriptor of the data.
  /// Example: /// Example: descriptor
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Descriptor { get { int o = __p.__offset(180); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetDescriptorBytes() { return __p.__vector_as_span<byte>(180, 1); }
#else
  public ArraySegment<byte>? GetDescriptorBytes() { return __p.__vector_as_arraysegment(180); }
#endif
  public byte[] GetDescriptorArray() { return __p.__vector_as_array<byte>(180); }
  /// Optional identifier to track a commercial or marketplace transaction executed to produce this data.
  /// Example: /// Example: transactionId
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string TransactionId { get { int o = __p.__offset(182); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetTransactionIdBytes() { return __p.__vector_as_span<byte>(182, 1); }
#else
  public ArraySegment<byte>? GetTransactionIdBytes() { return __p.__vector_as_arraysegment(182); }
#endif
  public byte[] GetTransactionIdArray() { return __p.__vector_as_array<byte>(182); }
  ...
  public static Offset<StateVector_Abridged> CreateStateVector_Abridged(FlatBufferBuilder builder,
      ...
      double yvel = 0.0,
      double zvel = 0.0,
      StateVector_Abridged_referenceFrame_Enum referenceFrame = StateVector_Abridged_referenceFrame_Enum.J2000,
      VectorOffset covOffset = default(VectorOffset),
      StateVector_Abridged_covReferenceFrame_Enum covReferenceFrame = StateVector_Abridged_covReferenceFrame_Enum.J2000,
      ...
      StateVector_Abridged_dataMode_Enum dataMode = StateVector_Abridged_dataMode_Enum.REAL,
  ...
  public static void AddReferenceFrame(FlatBufferBuilder builder, StateVector_Abridged_referenceFrame_Enum referenceFrame) { builder.AddSbyte(15, (sbyte)referenceFrame, 0); }
  ...
  public static void AddCovReferenceFrame(FlatBufferBuilder builder, StateVector_Abridged_covReferenceFrame_Enum covReferenceFrame) { builder.AddSbyte(17, (sbyte)covReferenceFrame, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, StateVector_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(84, (sbyte)dataMode, 0); }
  public static void AddAlgorithm(FlatBufferBuilder builder, StringOffset algorithmOffset) { builder.AddOffset(85, algorithmOffset.Value, 0); }
  public static void AddCreatedAt(FlatBufferBuilder builder, StringOffset createdAtOffset) { builder.AddOffset(86, createdAtOffset.Value, 0); }
  public static void AddCreatedBy(FlatBufferBuilder builder, StringOffset createdByOffset) { builder.AddOffset(87, createdByOffset.Value, 0); }
  public static void AddDescriptor(FlatBufferBuilder builder, StringOffset descriptorOffset) { builder.AddOffset(88, descriptorOffset.Value, 0); }
  public static void AddTransactionId(FlatBufferBuilder builder, StringOffset transactionIdOffset) { builder.AddOffset(89, transactionIdOffset.Value, 0); }
  ...
  public static Offset<StateVector_Abridged> EndStateVector_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<StateVector_Abridged>(o);
  }
  public static void FinishStateVector_AbridgedBuffer(FlatBufferBuilder builder, Offset<StateVector_Abridged> offset) { builder.Finish(offset.Value, "STAT"); }
  public static void FinishSizePrefixedStateVector_AbridgedBuffer(FlatBufferBuilder builder, Offset<StateVector_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "STAT"); }
  public StateVector_AbridgedT UnPack() {
    var _o = new StateVector_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(StateVector_AbridgedT _o) {
  ...
  public static Offset<StateVector_Abridged> Pack(FlatBufferBuilder builder, StateVector_AbridgedT _o) {
    if (_o == null) return default(Offset<StateVector_Abridged>);
...
public class StateVector_AbridgedT
{
  ...
  public StateVector_Abridged_referenceFrame_Enum ReferenceFrame { get; set; }
  public List<string> Cov { get; set; }
  public StateVector_Abridged_covReferenceFrame_Enum CovReferenceFrame { get; set; }
  ...
  public StateVector_Abridged_dataMode_Enum DataMode { get; set; }
  ...
  public StateVector_AbridgedT() {
    ...
    this.Yvel = 0.0;
    this.Zvel = 0.0;
    this.ReferenceFrame = StateVector_Abridged_referenceFrame_Enum.J2000;
    this.Cov = null;
    this.CovReferenceFrame = StateVector_Abridged_covReferenceFrame_Enum.J2000;
    this.CovMethod = null;
    this.EqCov = null;
    this.XposAlt1 = 0.0;
    this.YposAlt1 = 0.0;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = StateVector_Abridged_dataMode_Enum.REAL;
    this.Algorithm = null;
    this.CreatedAt = null;
    this.CreatedBy = null;
  ...
  public static StateVector_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return StateVector_Abridged.GetRootAsStateVector_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    StateVector_Abridged.FinishStateVector_AbridgedBuffer(fbb, StateVector_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class StateVector_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 34 /*ReferenceFrame*/, 1 /*StateVector_Abridged_referenceFrame_Enum*/, 1, false)
      && verifier.VerifyVectorOfStrings(tablePos, 36 /*Cov*/, false)
      && verifier.VerifyField(tablePos, 38 /*CovReferenceFrame*/, 1 /*StateVector_Abridged_covReferenceFrame_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 172 /*DataMode*/, 1 /*StateVector_Abridged_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 174 /*Algorithm*/, false)
      && verifier.VerifyString(tablePos, 176 /*CreatedAt*/, false)
      && verifier.VerifyString(tablePos, 178 /*CreatedBy*/, false)
      && verifier.VerifyString(tablePos, 180 /*Descriptor*/, false)
      && verifier.VerifyString(tablePos, 182 /*TransactionId*/, false)
