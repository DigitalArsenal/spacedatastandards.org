...
public struct SolarArrayDetails_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SolarArrayDetails_Abridged GetRootAsSolarArrayDetails_Abridged(ByteBuffer _bb) { return GetRootAsSolarArrayDetails_Abridged(_bb, new SolarArrayDetails_Abridged()); }
  public static SolarArrayDetails_Abridged GetRootAsSolarArrayDetails_Abridged(ByteBuffer _bb, SolarArrayDetails_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SolarArrayDetails_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SOLA"); }
  public static bool VerifySolarArrayDetails_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SOLA", false, SolarArrayDetails_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SolarArrayDetails_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SolarArrayDetails_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(34); return o != 0 ? (SolarArrayDetails_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SolarArrayDetails_Abridged_dataMode_Enum.REAL; } }

  public static Offset<SolarArrayDetails_Abridged> CreateSolarArrayDetails_Abridged(FlatBufferBuilder builder,
      ...
      SolarArrayDetails_Abridged_dataMode_Enum dataMode = SolarArrayDetails_Abridged_dataMode_Enum.REAL) {
  ...
  public static void StartSolarArrayDetails_Abridged(FlatBufferBuilder builder) { builder.StartTable(16); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SolarArrayDetails_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(15, (sbyte)dataMode, 0); }
  public static Offset<SolarArrayDetails_Abridged> EndSolarArrayDetails_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SolarArrayDetails_Abridged>(o);
  }
  public static void FinishSolarArrayDetails_AbridgedBuffer(FlatBufferBuilder builder, Offset<SolarArrayDetails_Abridged> offset) { builder.Finish(offset.Value, "SOLA"); }
  public static void FinishSizePrefixedSolarArrayDetails_AbridgedBuffer(FlatBufferBuilder builder, Offset<SolarArrayDetails_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "SOLA"); }
  public SolarArrayDetails_AbridgedT UnPack() {
    var _o = new SolarArrayDetails_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SolarArrayDetails_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SolarArrayDetails_Abridged> Pack(FlatBufferBuilder builder, SolarArrayDetails_AbridgedT _o) {
    if (_o == null) return default(Offset<SolarArrayDetails_Abridged>);
...
public class SolarArrayDetails_AbridgedT
{
  ...
  public SolarArrayDetails_Abridged_dataMode_Enum DataMode { get; set; }

  public SolarArrayDetails_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = SolarArrayDetails_Abridged_dataMode_Enum.REAL;
  }
  public static SolarArrayDetails_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return SolarArrayDetails_Abridged.GetRootAsSolarArrayDetails_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SolarArrayDetails_Abridged.FinishSolarArrayDetails_AbridgedBuffer(fbb, SolarArrayDetails_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SolarArrayDetails_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 34 /*DataMode*/, 1 /*SolarArrayDetails_Abridged_dataMode_Enum*/, 1, false)
