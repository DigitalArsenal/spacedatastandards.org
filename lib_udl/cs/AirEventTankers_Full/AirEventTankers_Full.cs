...
public struct AirEventTankers_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static AirEventTankers_Full GetRootAsAirEventTankers_Full(ByteBuffer _bb, AirEventTankers_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AirEventTankers_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRE"); }
  public static bool VerifyAirEventTankers_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRE", false, AirEventTankers_FullVerify.Verify); }
  ...
  public static Offset<AirEventTankers_Full> CreateAirEventTankers_Full(FlatBufferBuilder builder,
  ...
  public static Offset<AirEventTankers_Full> EndAirEventTankers_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirEventTankers_Full>(o);
  }
  public static void FinishAirEventTankers_FullBuffer(FlatBufferBuilder builder, Offset<AirEventTankers_Full> offset) { builder.Finish(offset.Value, "AIRE"); }
  public static void FinishSizePrefixedAirEventTankers_FullBuffer(FlatBufferBuilder builder, Offset<AirEventTankers_Full> offset) { builder.FinishSizePrefixed(offset.Value, "AIRE"); }
  public AirEventTankers_FullT UnPack() {
    var _o = new AirEventTankers_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AirEventTankers_FullT _o) {
  ...
  public static Offset<AirEventTankers_Full> Pack(FlatBufferBuilder builder, AirEventTankers_FullT _o) {
    if (_o == null) return default(Offset<AirEventTankers_Full>);
...
public class AirEventTankers_FullT
{
  ...
  public static AirEventTankers_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return AirEventTankers_Full.GetRootAsAirEventTankers_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AirEventTankers_Full.FinishAirEventTankers_FullBuffer(fbb, AirEventTankers_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AirEventTankers_FullVerify
{
