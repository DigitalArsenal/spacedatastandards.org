...
namespace AirEventTankers_Full
{
...
public struct AirEventTankers_Full : IFlatbufferObject
{
  ...
  public static Offset<AirEventTankers_Full.AirEventTankers_Full> CreateAirEventTankers_Full(FlatBufferBuilder builder,
  ...
  public static Offset<AirEventTankers_Full.AirEventTankers_Full> EndAirEventTankers_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AirEventTankers_Full.AirEventTankers_Full>(o);
  }
  ...
  public static Offset<AirEventTankers_Full.AirEventTankers_Full> Pack(FlatBufferBuilder builder, AirEventTankers_FullT _o) {
    if (_o == null) return default(Offset<AirEventTankers_Full.AirEventTankers_Full>);
