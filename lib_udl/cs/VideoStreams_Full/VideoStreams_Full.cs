...
public struct VideoStreams_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static VideoStreams_Full GetRootAsVideoStreams_Full(ByteBuffer _bb, VideoStreams_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool VideoStreams_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "VIDE"); }
  public static bool VerifyVideoStreams_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("VIDE", false, VideoStreams_FullVerify.Verify); }
  ...
  public VideoStreams_Full_dataMode_Enum DataMode { get { int o = __p.__offset(22); return o != 0 ? (VideoStreams_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : VideoStreams_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<VideoStreams_Full> CreateVideoStreams_Full(FlatBufferBuilder builder,
      ...
      VideoStreams_Full_dataMode_Enum dataMode = VideoStreams_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, VideoStreams_Full_dataMode_Enum dataMode) { builder.AddSbyte(9, (sbyte)dataMode, 0); }
  ...
  public static Offset<VideoStreams_Full> EndVideoStreams_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<VideoStreams_Full>(o);
  }
  public static void FinishVideoStreams_FullBuffer(FlatBufferBuilder builder, Offset<VideoStreams_Full> offset) { builder.Finish(offset.Value, "VIDE"); }
  public static void FinishSizePrefixedVideoStreams_FullBuffer(FlatBufferBuilder builder, Offset<VideoStreams_Full> offset) { builder.FinishSizePrefixed(offset.Value, "VIDE"); }
  public VideoStreams_FullT UnPack() {
    var _o = new VideoStreams_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(VideoStreams_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<VideoStreams_Full> Pack(FlatBufferBuilder builder, VideoStreams_FullT _o) {
    if (_o == null) return default(Offset<VideoStreams_Full>);
...
public class VideoStreams_FullT
{
  ...
  public VideoStreams_Full_dataMode_Enum DataMode { get; set; }
  ...
  public VideoStreams_FullT() {
    ...
    this.VideoUrls = null;
    this.DataMode = VideoStreams_Full_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.UpdatedAt = null;
    this.UpdatedBy = null;
  ...
  public static VideoStreams_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return VideoStreams_Full.GetRootAsVideoStreams_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    VideoStreams_Full.FinishVideoStreams_FullBuffer(fbb, VideoStreams_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class VideoStreams_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 22 /*DataMode*/, 1 /*VideoStreams_Full_dataMode_Enum*/, 1, false)
