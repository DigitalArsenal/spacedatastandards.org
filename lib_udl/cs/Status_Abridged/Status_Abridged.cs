...
public struct Status_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Status_Abridged GetRootAsStatus_Abridged(ByteBuffer _bb) { return GetRootAsStatus_Abridged(_bb, new Status_Abridged()); }
  public static Status_Abridged GetRootAsStatus_Abridged(ByteBuffer _bb, Status_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Status_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "STAT"); }
  public static bool VerifyStatus_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("STAT", false, Status_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Status_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public Status_Abridged_state_Enum State { get { int o = __p.__offset(16); return o != 0 ? (Status_Abridged_state_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Status_Abridged_state_Enum.UNKNOWN; } }
  /// System capability of the entity, if applicable (e.g. FMC, NMC, PMC, UNK).
  /// Example: /// Example: FMC
  /// Constraints: Minimum length = 0, Maximum length = 3
  public Status_Abridged_sysCap_Enum SysCap { get { int o = __p.__offset(18); return o != 0 ? (Status_Abridged_sysCap_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Status_Abridged_sysCap_Enum.FMC; } }
  /// Operation capability of the entity, if applicable (e.g. FMC, NMC, PMC, UNK).
  /// Example: /// Example: FMC
  /// Constraints: Minimum length = 0, Maximum length = 3
  public Status_Abridged_opsCap_Enum OpsCap { get { int o = __p.__offset(20); return o != 0 ? (Status_Abridged_opsCap_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Status_Abridged_opsCap_Enum.FMC; } }
  /// Source of the data.
  ...
  public Status_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(26); return o != 0 ? (Status_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Status_Abridged_dataMode_Enum.REAL; } }
  ...
  public static Offset<Status_Abridged> CreateStatus_Abridged(FlatBufferBuilder builder,
      ...
      Status_Abridged_state_Enum state = Status_Abridged_state_Enum.UNKNOWN,
      Status_Abridged_sysCap_Enum sysCap = Status_Abridged_sysCap_Enum.FMC,
      Status_Abridged_opsCap_Enum opsCap = Status_Abridged_opsCap_Enum.FMC,
      StringOffset sourceOffset = default(StringOffset),
      VectorOffset subStatusCollectionOffset = default(VectorOffset),
      Status_Abridged_dataMode_Enum dataMode = Status_Abridged_dataMode_Enum.REAL,
    ...
    Status_Abridged.AddOrigNetwork(builder, origNetworkOffset);
    Status_Abridged.AddOrigin(builder, originOffset);
    Status_Abridged.AddCreatedBy(builder, createdByOffset);
    Status_Abridged.AddCreatedAt(builder, createdAtOffset);
    Status_Abridged.AddNotes(builder, notesOffset);
    Status_Abridged.AddSubStatusCollection(builder, subStatusCollectionOffset);
    Status_Abridged.AddSource(builder, sourceOffset);
    Status_Abridged.AddIdEntity(builder, idEntityOffset);
    Status_Abridged.AddDeclassificationString(builder, declassificationStringOffset);
    Status_Abridged.AddDeclassificationDate(builder, declassificationDateOffset);
    Status_Abridged.AddDerivedFrom(builder, derivedFromOffset);
    Status_Abridged.AddClassificationMarking(builder, classificationMarkingOffset);
    Status_Abridged.AddId(builder, idOffset);
    Status_Abridged.AddDataMode(builder, dataMode);
    Status_Abridged.AddOpsCap(builder, opsCap);
    Status_Abridged.AddSysCap(builder, sysCap);
    Status_Abridged.AddState(builder, state);
    return Status_Abridged.EndStatus_Abridged(builder);
  }

  public static void StartStatus_Abridged(FlatBufferBuilder builder) { builder.StartTable(17); }
  ...
  public static void AddState(FlatBufferBuilder builder, Status_Abridged_state_Enum state) { builder.AddSbyte(6, (sbyte)state, 0); }
  public static void AddSysCap(FlatBufferBuilder builder, Status_Abridged_sysCap_Enum sysCap) { builder.AddSbyte(7, (sbyte)sysCap, 0); }
  public static void AddOpsCap(FlatBufferBuilder builder, Status_Abridged_opsCap_Enum opsCap) { builder.AddSbyte(8, (sbyte)opsCap, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Status_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(11, (sbyte)dataMode, 0); }
  ...
  public static Offset<Status_Abridged> EndStatus_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Status_Abridged>(o);
  }
  public static void FinishStatus_AbridgedBuffer(FlatBufferBuilder builder, Offset<Status_Abridged> offset) { builder.Finish(offset.Value, "STAT"); }
  public static void FinishSizePrefixedStatus_AbridgedBuffer(FlatBufferBuilder builder, Offset<Status_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "STAT"); }
  public Status_AbridgedT UnPack() {
    var _o = new Status_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Status_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Status_Abridged> Pack(FlatBufferBuilder builder, Status_AbridgedT _o) {
    if (_o == null) return default(Offset<Status_Abridged>);
...
public class Status_AbridgedT
{
  ...
  public Status_Abridged_state_Enum State { get; set; }
  public Status_Abridged_sysCap_Enum SysCap { get; set; }
  public Status_Abridged_opsCap_Enum OpsCap { get; set; }
  public string Source { get; set; }
  public List<string> SubStatusCollection { get; set; }
  public Status_Abridged_dataMode_Enum DataMode { get; set; }
  ...
  public Status_AbridgedT() {
    ...
    this.IdEntity = null;
    this.State = Status_Abridged_state_Enum.UNKNOWN;
    this.SysCap = Status_Abridged_sysCap_Enum.FMC;
    this.OpsCap = Status_Abridged_opsCap_Enum.FMC;
    this.Source = null;
    this.SubStatusCollection = null;
    this.DataMode = Status_Abridged_dataMode_Enum.REAL;
    this.Notes = null;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.Origin = null;
  ...
  public static Status_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Status_Abridged.GetRootAsStatus_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Status_Abridged.FinishStatus_AbridgedBuffer(fbb, Status_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Status_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*State*/, 1 /*Status_Abridged_state_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 18 /*SysCap*/, 1 /*Status_Abridged_sysCap_Enum*/, 1, false)
      && verifier.VerifyField(tablePos, 20 /*OpsCap*/, 1 /*Status_Abridged_opsCap_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 22 /*Source*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 24 /*SubStatusCollection*/, false)
      && verifier.VerifyField(tablePos, 26 /*DataMode*/, 1 /*Status_Abridged_dataMode_Enum*/, 1, false)
