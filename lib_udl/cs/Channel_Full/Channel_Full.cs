...
public struct Channel_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static Channel_Full GetRootAsChannel_Full(ByteBuffer _bb) { return GetRootAsChannel_Full(_bb, new Channel_Full()); }
  public static Channel_Full GetRootAsChannel_Full(ByteBuffer _bb, Channel_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Channel_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "CHAN"); }
  public static bool VerifyChannel_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("CHAN", false, Channel_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public Channel_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Channel_Full_dataMode_Enum DataMode { get { int o = __p.__offset(42); return o != 0 ? (Channel_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Channel_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<Channel_Full> CreateChannel_Full(FlatBufferBuilder builder,
      ...
      Channel_Full_dataMode_Enum dataMode = Channel_Full_dataMode_Enum.REAL,
  ...
  public static void StartChannel_Full(FlatBufferBuilder builder) { builder.StartTable(24); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Channel_Full_dataMode_Enum dataMode) { builder.AddSbyte(19, (sbyte)dataMode, 0); }
  ...
  public static Offset<Channel_Full> EndChannel_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Channel_Full>(o);
  }
  public static void FinishChannel_FullBuffer(FlatBufferBuilder builder, Offset<Channel_Full> offset) { builder.Finish(offset.Value, "CHAN"); }
  public static void FinishSizePrefixedChannel_FullBuffer(FlatBufferBuilder builder, Offset<Channel_Full> offset) { builder.FinishSizePrefixed(offset.Value, "CHAN"); }
  public Channel_FullT UnPack() {
    var _o = new Channel_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Channel_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Channel_Full> Pack(FlatBufferBuilder builder, Channel_FullT _o) {
    if (_o == null) return default(Offset<Channel_Full>);
...
public class Channel_FullT
{
  ...
  public Channel_Full_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string UpdatedAt { get; set; }
  public string UpdatedBy { get; set; }

  public Channel_FullT() {
    this.Id = null;
    ...
    this.DataMode = Channel_Full_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.UpdatedAt = null;
    this.UpdatedBy = null;
  }
  public static Channel_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Channel_Full.GetRootAsChannel_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Channel_Full.FinishChannel_FullBuffer(fbb, Channel_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Channel_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 42 /*DataMode*/, 1 /*Channel_Full_dataMode_Enum*/, 1, false)
