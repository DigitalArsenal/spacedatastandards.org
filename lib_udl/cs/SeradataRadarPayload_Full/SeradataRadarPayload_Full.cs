...
public struct SeradataRadarPayload_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static SeradataRadarPayload_Full GetRootAsSeradataRadarPayload_Full(ByteBuffer _bb, SeradataRadarPayload_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SeradataRadarPayload_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SERA"); }
  public static bool VerifySeradataRadarPayload_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SERA", false, SeradataRadarPayload_FullVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public SeradataRadarPayload_Full_dataMode_Enum DataMode { get { int o = __p.__offset(70); return o != 0 ? (SeradataRadarPayload_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SeradataRadarPayload_Full_dataMode_Enum.REAL; } }

  public static Offset<SeradataRadarPayload_Full> CreateSeradataRadarPayload_Full(FlatBufferBuilder builder,
      ...
      SeradataRadarPayload_Full_dataMode_Enum dataMode = SeradataRadarPayload_Full_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, SeradataRadarPayload_Full_dataMode_Enum dataMode) { builder.AddSbyte(33, (sbyte)dataMode, 0); }
  public static Offset<SeradataRadarPayload_Full> EndSeradataRadarPayload_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SeradataRadarPayload_Full>(o);
  }
  public static void FinishSeradataRadarPayload_FullBuffer(FlatBufferBuilder builder, Offset<SeradataRadarPayload_Full> offset) { builder.Finish(offset.Value, "SERA"); }
  public static void FinishSizePrefixedSeradataRadarPayload_FullBuffer(FlatBufferBuilder builder, Offset<SeradataRadarPayload_Full> offset) { builder.FinishSizePrefixed(offset.Value, "SERA"); }
  public SeradataRadarPayload_FullT UnPack() {
    var _o = new SeradataRadarPayload_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SeradataRadarPayload_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SeradataRadarPayload_Full> Pack(FlatBufferBuilder builder, SeradataRadarPayload_FullT _o) {
    if (_o == null) return default(Offset<SeradataRadarPayload_Full>);
...
public class SeradataRadarPayload_FullT
{
  ...
  public SeradataRadarPayload_Full_dataMode_Enum DataMode { get; set; }

  public SeradataRadarPayload_FullT() {
    this.Id = null;
    ...
    this.DataMode = SeradataRadarPayload_Full_dataMode_Enum.REAL;
  }
  public static SeradataRadarPayload_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return SeradataRadarPayload_Full.GetRootAsSeradataRadarPayload_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SeradataRadarPayload_Full.FinishSeradataRadarPayload_FullBuffer(fbb, SeradataRadarPayload_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SeradataRadarPayload_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 70 /*DataMode*/, 1 /*SeradataRadarPayload_Full_dataMode_Enum*/, 1, false)
