...
public struct OrbitDetermination_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static OrbitDetermination_Full GetRootAsOrbitDetermination_Full(ByteBuffer _bb, OrbitDetermination_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool OrbitDetermination_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ORBI"); }
  public static bool VerifyOrbitDetermination_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ORBI", false, OrbitDetermination_FullVerify.Verify); }
  ...
  public OrbitDetermination_Full_dataMode_Enum DataMode { get { int o = __p.__offset(90); return o != 0 ? (OrbitDetermination_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : OrbitDetermination_Full_dataMode_Enum.REAL; } }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string OnOrbit { get { int o = __p.__offset(92); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbitBytes() { return __p.__vector_as_span<byte>(92, 1); }
#else
  public ArraySegment<byte>? GetOnOrbitBytes() { return __p.__vector_as_arraysegment(92); }
#endif
  public byte[] GetOnOrbitArray() { return __p.__vector_as_array<byte>(92); }

  public static Offset<OrbitDetermination_Full> CreateOrbitDetermination_Full(FlatBufferBuilder builder,
      ...
      OrbitDetermination_Full_dataMode_Enum dataMode = OrbitDetermination_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, OrbitDetermination_Full_dataMode_Enum dataMode) { builder.AddSbyte(43, (sbyte)dataMode, 0); }
  public static void AddOnOrbit(FlatBufferBuilder builder, StringOffset onOrbitOffset) { builder.AddOffset(44, onOrbitOffset.Value, 0); }
  public static Offset<OrbitDetermination_Full> EndOrbitDetermination_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<OrbitDetermination_Full>(o);
  }
  public static void FinishOrbitDetermination_FullBuffer(FlatBufferBuilder builder, Offset<OrbitDetermination_Full> offset) { builder.Finish(offset.Value, "ORBI"); }
  public static void FinishSizePrefixedOrbitDetermination_FullBuffer(FlatBufferBuilder builder, Offset<OrbitDetermination_Full> offset) { builder.FinishSizePrefixed(offset.Value, "ORBI"); }
  public OrbitDetermination_FullT UnPack() {
    var _o = new OrbitDetermination_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(OrbitDetermination_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<OrbitDetermination_Full> Pack(FlatBufferBuilder builder, OrbitDetermination_FullT _o) {
    if (_o == null) return default(Offset<OrbitDetermination_Full>);
...
public class OrbitDetermination_FullT
{
  ...
  public OrbitDetermination_Full_dataMode_Enum DataMode { get; set; }
  public string OnOrbit { get; set; }

  public OrbitDetermination_FullT() {
    this.Id = null;
    ...
    this.DataMode = OrbitDetermination_Full_dataMode_Enum.REAL;
    this.OnOrbit = null;
  }
  public static OrbitDetermination_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return OrbitDetermination_Full.GetRootAsOrbitDetermination_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    OrbitDetermination_Full.FinishOrbitDetermination_FullBuffer(fbb, OrbitDetermination_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class OrbitDetermination_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 90 /*DataMode*/, 1 /*OrbitDetermination_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 92 /*OnOrbit*/, false)
