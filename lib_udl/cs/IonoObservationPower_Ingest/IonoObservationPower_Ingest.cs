...
public struct IonoObservationPower_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationPower_Ingest GetRootAsIonoObservationPower_Ingest(ByteBuffer _bb) { return GetRootAsIonoObservationPower_Ingest(_bb, new IonoObservationPower_Ingest()); }
  public static IonoObservationPower_Ingest GetRootAsIonoObservationPower_Ingest(ByteBuffer _bb, IonoObservationPower_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationPower_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationPower_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationPower_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationPower_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationPower_Ingest> CreateIonoObservationPower_Ingest(FlatBufferBuilder builder,
  ...
  public static void StartIonoObservationPower_Ingest(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationPower_Ingest> EndIonoObservationPower_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationPower_Ingest>(o);
  }
  public static void FinishIonoObservationPower_IngestBuffer(FlatBufferBuilder builder, Offset<IonoObservationPower_Ingest> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationPower_IngestBuffer(FlatBufferBuilder builder, Offset<IonoObservationPower_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationPower_IngestT UnPack() {
    var _o = new IonoObservationPower_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationPower_IngestT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationPower_Ingest> Pack(FlatBufferBuilder builder, IonoObservationPower_IngestT _o) {
    if (_o == null) return default(Offset<IonoObservationPower_Ingest>);
    ...
    return CreateIonoObservationPower_Ingest(
      builder,
      _notes,
      _dimensions,
      _dimensionName,
...
public class IonoObservationPower_IngestT
{
  ...
  public IonoObservationPower_IngestT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationPower_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationPower_Ingest.GetRootAsIonoObservationPower_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationPower_Ingest.FinishIonoObservationPower_IngestBuffer(fbb, IonoObservationPower_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationPower_IngestVerify
{
