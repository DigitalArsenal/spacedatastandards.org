...
public struct EquipmentRemark_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static EquipmentRemark_Ingest GetRootAsEquipmentRemark_Ingest(ByteBuffer _bb) { return GetRootAsEquipmentRemark_Ingest(_bb, new EquipmentRemark_Ingest()); }
  public static EquipmentRemark_Ingest GetRootAsEquipmentRemark_Ingest(ByteBuffer _bb, EquipmentRemark_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool EquipmentRemark_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EQUI"); }
  public static bool VerifyEquipmentRemark_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EQUI", false, EquipmentRemark_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public EquipmentRemark_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public EquipmentRemark_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(28); return o != 0 ? (EquipmentRemark_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : EquipmentRemark_Ingest_dataMode_Enum.REAL; } }

  public static Offset<EquipmentRemark_Ingest> CreateEquipmentRemark_Ingest(FlatBufferBuilder builder,
      ...
      EquipmentRemark_Ingest_dataMode_Enum dataMode = EquipmentRemark_Ingest_dataMode_Enum.REAL) {
  ...
  public static void StartEquipmentRemark_Ingest(FlatBufferBuilder builder) { builder.StartTable(13); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, EquipmentRemark_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(12, (sbyte)dataMode, 0); }
  public static Offset<EquipmentRemark_Ingest> EndEquipmentRemark_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EquipmentRemark_Ingest>(o);
  }
  public static void FinishEquipmentRemark_IngestBuffer(FlatBufferBuilder builder, Offset<EquipmentRemark_Ingest> offset) { builder.Finish(offset.Value, "EQUI"); }
  public static void FinishSizePrefixedEquipmentRemark_IngestBuffer(FlatBufferBuilder builder, Offset<EquipmentRemark_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "EQUI"); }
  public EquipmentRemark_IngestT UnPack() {
    var _o = new EquipmentRemark_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(EquipmentRemark_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<EquipmentRemark_Ingest> Pack(FlatBufferBuilder builder, EquipmentRemark_IngestT _o) {
    if (_o == null) return default(Offset<EquipmentRemark_Ingest>);
    ...
    return CreateEquipmentRemark_Ingest(
      builder,
      _id,
...
public class EquipmentRemark_IngestT
{
  ...
  public EquipmentRemark_Ingest_dataMode_Enum DataMode { get; set; }

  public EquipmentRemark_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = EquipmentRemark_Ingest_dataMode_Enum.REAL;
  }
  public static EquipmentRemark_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return EquipmentRemark_Ingest.GetRootAsEquipmentRemark_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EquipmentRemark_Ingest.FinishEquipmentRemark_IngestBuffer(fbb, EquipmentRemark_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class EquipmentRemark_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 28 /*DataMode*/, 1 /*EquipmentRemark_Ingest_dataMode_Enum*/, 1, false)
