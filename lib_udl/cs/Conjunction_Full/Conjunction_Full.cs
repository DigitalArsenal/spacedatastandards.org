...
public struct Conjunction_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static Conjunction_Full GetRootAsConjunction_Full(ByteBuffer _bb, Conjunction_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Conjunction_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "CONJ"); }
  public static bool VerifyConjunction_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("CONJ", false, Conjunction_FullVerify.Verify); }
  ...
  public Conjunction_Full_dataMode_Enum DataMode { get { int o = __p.__offset(122); return o != 0 ? (Conjunction_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Conjunction_Full_dataMode_Enum.REAL; } }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string OnOrbit1 { get { int o = __p.__offset(136); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbit1Bytes() { return __p.__vector_as_span<byte>(136, 1); }
#else
  public ArraySegment<byte>? GetOnOrbit1Bytes() { return __p.__vector_as_arraysegment(136); }
#endif
  public byte[] GetOnOrbit1Array() { return __p.__vector_as_array<byte>(136); }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  public string OnOrbit2 { get { int o = __p.__offset(138); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbit2Bytes() { return __p.__vector_as_span<byte>(138, 1); }
#else
  public ArraySegment<byte>? GetOnOrbit2Bytes() { return __p.__vector_as_arraysegment(138); }
#endif
  public byte[] GetOnOrbit2Array() { return __p.__vector_as_array<byte>(138); }
  /// Optional place holder for an OnOrbit ID that does not exist in UDL.
  /// Example: /// Example: ORIGONORBIT1-ID
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string OrigIdOnOrbit1 { get { int o = __p.__offset(140); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOrigIdOnOrbit1Bytes() { return __p.__vector_as_span<byte>(140, 1); }
#else
  public ArraySegment<byte>? GetOrigIdOnOrbit1Bytes() { return __p.__vector_as_arraysegment(140); }
#endif
  public byte[] GetOrigIdOnOrbit1Array() { return __p.__vector_as_array<byte>(140); }
  /// Optional place holder for an OnOrbit ID that does not exist in UDL.
  /// Example: /// Example: ORIGONORBIT2-ID
  /// Constraints: Minimum length = 0, Maximum length = 36
  public string OrigIdOnOrbit2 { get { int o = __p.__offset(142); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOrigIdOnOrbit2Bytes() { return __p.__vector_as_span<byte>(142, 1); }
#else
  public ArraySegment<byte>? GetOrigIdOnOrbit2Bytes() { return __p.__vector_as_arraysegment(142); }
#endif
  public byte[] GetOrigIdOnOrbit2Array() { return __p.__vector_as_array<byte>(142); }
  ...
  public static Offset<Conjunction_Full> CreateConjunction_Full(FlatBufferBuilder builder,
      ...
      Conjunction_Full_dataMode_Enum dataMode = Conjunction_Full_dataMode_Enum.REAL,
      ...
      int satNo1 = 0,
      int satNo2 = 0,
      StringOffset onOrbit1Offset = default(StringOffset),
      StringOffset onOrbit2Offset = default(StringOffset),
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Conjunction_Full_dataMode_Enum dataMode) { builder.AddSbyte(59, (sbyte)dataMode, 0); }
  ...
  public static void AddOnOrbit1(FlatBufferBuilder builder, StringOffset onOrbit1Offset) { builder.AddOffset(66, onOrbit1Offset.Value, 0); }
  public static void AddOnOrbit2(FlatBufferBuilder builder, StringOffset onOrbit2Offset) { builder.AddOffset(67, onOrbit2Offset.Value, 0); }
  public static void AddOrigIdOnOrbit1(FlatBufferBuilder builder, StringOffset origIdOnOrbit1Offset) { builder.AddOffset(68, origIdOnOrbit1Offset.Value, 0); }
  public static void AddOrigIdOnOrbit2(FlatBufferBuilder builder, StringOffset origIdOnOrbit2Offset) { builder.AddOffset(69, origIdOnOrbit2Offset.Value, 0); }
  ...
  public static Offset<Conjunction_Full> EndConjunction_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Conjunction_Full>(o);
  }
  public static void FinishConjunction_FullBuffer(FlatBufferBuilder builder, Offset<Conjunction_Full> offset) { builder.Finish(offset.Value, "CONJ"); }
  public static void FinishSizePrefixedConjunction_FullBuffer(FlatBufferBuilder builder, Offset<Conjunction_Full> offset) { builder.FinishSizePrefixed(offset.Value, "CONJ"); }
  public Conjunction_FullT UnPack() {
    var _o = new Conjunction_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Conjunction_FullT _o) {
    _o.Id = this.Id;
    ...
    _o.OnOrbit1 = this.OnOrbit1;
    _o.OnOrbit2 = this.OnOrbit2;
    _o.OrigIdOnOrbit1 = this.OrigIdOnOrbit1;
    _o.OrigIdOnOrbit2 = this.OrigIdOnOrbit2;
    _o.OrigNetwork = this.OrigNetwork;
  }
  public static Offset<Conjunction_Full> Pack(FlatBufferBuilder builder, Conjunction_FullT _o) {
    if (_o == null) return default(Offset<Conjunction_Full>);
    ...
    var _onOrbit1 = _o.OnOrbit1 == null ? default(StringOffset) : builder.CreateString(_o.OnOrbit1);
    var _onOrbit2 = _o.OnOrbit2 == null ? default(StringOffset) : builder.CreateString(_o.OnOrbit2);
...
public class Conjunction_FullT
{
  ...
  public Conjunction_Full_dataMode_Enum DataMode { get; set; }
  ...
  public string OnOrbit1 { get; set; }
  public string OnOrbit2 { get; set; }
  public string OrigIdOnOrbit1 { get; set; }
  public string OrigIdOnOrbit2 { get; set; }
  public string OrigNetwork { get; set; }

  public Conjunction_FullT() {
    this.Id = null;
    ...
    this.Tags = null;
    this.DataMode = Conjunction_Full_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
  ...
  public static Conjunction_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return Conjunction_Full.GetRootAsConjunction_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Conjunction_Full.FinishConjunction_FullBuffer(fbb, Conjunction_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Conjunction_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 122 /*DataMode*/, 1 /*Conjunction_Full_dataMode_Enum*/, 1, false)
      ...
      && verifier.VerifyString(tablePos, 136 /*OnOrbit1*/, false)
      && verifier.VerifyString(tablePos, 138 /*OnOrbit2*/, false)
      && verifier.VerifyString(tablePos, 140 /*OrigIdOnOrbit1*/, false)
      && verifier.VerifyString(tablePos, 142 /*OrigIdOnOrbit2*/, false)
