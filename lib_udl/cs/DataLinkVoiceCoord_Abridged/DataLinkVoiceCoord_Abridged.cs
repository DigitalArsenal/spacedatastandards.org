...
public struct DataLinkVoiceCoord_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static DataLinkVoiceCoord_Abridged GetRootAsDataLinkVoiceCoord_Abridged(ByteBuffer _bb, DataLinkVoiceCoord_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DataLinkVoiceCoord_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DATA"); }
  public static bool VerifyDataLinkVoiceCoord_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DATA", false, DataLinkVoiceCoord_AbridgedVerify.Verify); }
  ...
  public static Offset<DataLinkVoiceCoord_Abridged> CreateDataLinkVoiceCoord_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<DataLinkVoiceCoord_Abridged> EndDataLinkVoiceCoord_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DataLinkVoiceCoord_Abridged>(o);
  }
  public static void FinishDataLinkVoiceCoord_AbridgedBuffer(FlatBufferBuilder builder, Offset<DataLinkVoiceCoord_Abridged> offset) { builder.Finish(offset.Value, "DATA"); }
  public static void FinishSizePrefixedDataLinkVoiceCoord_AbridgedBuffer(FlatBufferBuilder builder, Offset<DataLinkVoiceCoord_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "DATA"); }
  public DataLinkVoiceCoord_AbridgedT UnPack() {
    var _o = new DataLinkVoiceCoord_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DataLinkVoiceCoord_AbridgedT _o) {
  ...
  public static Offset<DataLinkVoiceCoord_Abridged> Pack(FlatBufferBuilder builder, DataLinkVoiceCoord_AbridgedT _o) {
    if (_o == null) return default(Offset<DataLinkVoiceCoord_Abridged>);
...
public class DataLinkVoiceCoord_AbridgedT
{
  ...
  public DataLinkVoiceCoord_AbridgedT() {
    this.VoiceNetDes = null;
    this.FreqDes = null;
    this.CommPri = null;
    this.TeleFreqNums = null;
  }
  public static DataLinkVoiceCoord_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return DataLinkVoiceCoord_Abridged.GetRootAsDataLinkVoiceCoord_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DataLinkVoiceCoord_Abridged.FinishDataLinkVoiceCoord_AbridgedBuffer(fbb, DataLinkVoiceCoord_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DataLinkVoiceCoord_AbridgedVerify
{
