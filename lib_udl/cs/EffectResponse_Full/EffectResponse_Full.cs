...
public struct EffectResponse_Full : IFlatbufferObject
{
  ...
  public static bool EffectResponse_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EFFE"); }
  public static bool VerifyEffectResponse_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EFFE", false, EffectResponse_FullVerify.Verify); }
  ...
  public static Offset<EffectResponse_Full> CreateEffectResponse_Full(FlatBufferBuilder builder,
  ...
  public static Offset<EffectResponse_Full> EndEffectResponse_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EffectResponse_Full>(o);
  }
  public static void FinishEffectResponse_FullBuffer(FlatBufferBuilder builder, Offset<EffectResponse_Full> offset) { builder.Finish(offset.Value, "EFFE"); }
  public static void FinishSizePrefixedEffectResponse_FullBuffer(FlatBufferBuilder builder, Offset<EffectResponse_Full> offset) { builder.FinishSizePrefixed(offset.Value, "EFFE"); }
  ...
  public static Offset<EffectResponse_Full> Pack(FlatBufferBuilder builder, EffectResponse_FullT _o) {
    if (_o == null) return default(Offset<EffectResponse_Full>);
...
public class EffectResponse_FullT
{
  ...
  public static EffectResponse_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return EffectResponse_Full.GetRootAsEffectResponse_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    EffectResponse_Full.FinishEffectResponse_FullBuffer(fbb, EffectResponse_Full.Pack(fbb, this));
