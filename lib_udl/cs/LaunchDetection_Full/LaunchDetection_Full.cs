...
public struct LaunchDetection_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static LaunchDetection_Full GetRootAsLaunchDetection_Full(ByteBuffer _bb, LaunchDetection_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LaunchDetection_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LAUN"); }
  public static bool VerifyLaunchDetection_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LAUN", false, LaunchDetection_FullVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public LaunchDetection_Full_dataMode_Enum DataMode { get { int o = __p.__offset(48); return o != 0 ? (LaunchDetection_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : LaunchDetection_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<LaunchDetection_Full> CreateLaunchDetection_Full(FlatBufferBuilder builder,
      ...
      LaunchDetection_Full_dataMode_Enum dataMode = LaunchDetection_Full_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, LaunchDetection_Full_dataMode_Enum dataMode) { builder.AddSbyte(22, (sbyte)dataMode, 0); }
  ...
  public static Offset<LaunchDetection_Full> EndLaunchDetection_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LaunchDetection_Full>(o);
  }
  public static void FinishLaunchDetection_FullBuffer(FlatBufferBuilder builder, Offset<LaunchDetection_Full> offset) { builder.Finish(offset.Value, "LAUN"); }
  public static void FinishSizePrefixedLaunchDetection_FullBuffer(FlatBufferBuilder builder, Offset<LaunchDetection_Full> offset) { builder.FinishSizePrefixed(offset.Value, "LAUN"); }
  public LaunchDetection_FullT UnPack() {
    var _o = new LaunchDetection_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LaunchDetection_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<LaunchDetection_Full> Pack(FlatBufferBuilder builder, LaunchDetection_FullT _o) {
    if (_o == null) return default(Offset<LaunchDetection_Full>);
...
public class LaunchDetection_FullT
{
  ...
  public LaunchDetection_Full_dataMode_Enum DataMode { get; set; }
  public string CreatedAt { get; set; }
  public string CreatedBy { get; set; }
  public string UpdatedAt { get; set; }
  public string UpdatedBy { get; set; }

  public LaunchDetection_FullT() {
    this.Id = null;
    ...
    this.DataMode = LaunchDetection_Full_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.UpdatedAt = null;
    this.UpdatedBy = null;
  }
  public static LaunchDetection_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return LaunchDetection_Full.GetRootAsLaunchDetection_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LaunchDetection_Full.FinishLaunchDetection_FullBuffer(fbb, LaunchDetection_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LaunchDetection_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 48 /*DataMode*/, 1 /*LaunchDetection_Full_dataMode_Enum*/, 1, false)
