...
public struct SWIR_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static SWIR_Ingest GetRootAsSWIR_Ingest(ByteBuffer _bb) { return GetRootAsSWIR_Ingest(_bb, new SWIR_Ingest()); }
  public static SWIR_Ingest GetRootAsSWIR_Ingest(ByteBuffer _bb, SWIR_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SWIR_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SWIR"); }
  public static bool VerifySWIR_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SWIR", false, SWIR_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public SWIR_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: No constraints specified.
  public string Wavelengths(int j) { int o = __p.__offset(22); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int WavelengthsLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Example: /// Example: [1.23, 4.56]
  /// Constraints: No constraints specified.
  public string AbsFluxes(int j) { int o = __p.__offset(24); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int AbsFluxesLength { get { int o = __p.__offset(24); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Array of ratio wavelength data. This array should correspond with the same-sized array of fluxRatios.
  /// Example: /// Example: [1.23, 4.56]
  /// Constraints: No constraints specified.
  public string RatioWavelengths(int j) { int o = __p.__offset(26); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int RatioWavelengthsLength { get { int o = __p.__offset(26); return o != 0 ? __p.__vector_len(o) : 0; } }
  /// Array of flux ratio data. This array should correspond with the same-sized array of ratioWavelengths.
  /// Example: /// Example: [1.23, 4.56]
  /// Constraints: No constraints specified.
  public string FluxRatios(int j) { int o = __p.__offset(28); return o != 0 ? __p.__string(__p.__vector(o) + j * 4) : null; }
  public int FluxRatiosLength { get { int o = __p.__offset(28); return o != 0 ? __p.__vector_len(o) : 0; } }
  ...
  /// Constraints: No constraints specified.
  public int SatNo { get { int o = __p.__offset(36); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }
  ...
  public SWIR_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(38); return o != 0 ? (SWIR_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : SWIR_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<SWIR_Ingest> CreateSWIR_Ingest(FlatBufferBuilder builder,
      ...
      int satNo = 0,
      SWIR_Ingest_dataMode_Enum dataMode = SWIR_Ingest_dataMode_Enum.REAL,
  ...
  public static void StartSWIR_Ingest(FlatBufferBuilder builder) { builder.StartTable(21); }
  ...
  public static void AddWavelengths(FlatBufferBuilder builder, VectorOffset wavelengthsOffset) { builder.AddOffset(9, wavelengthsOffset.Value, 0); }
  ...
  public static void AddAbsFluxes(FlatBufferBuilder builder, VectorOffset absFluxesOffset) { builder.AddOffset(10, absFluxesOffset.Value, 0); }
  ...
  public static void AddRatioWavelengths(FlatBufferBuilder builder, VectorOffset ratioWavelengthsOffset) { builder.AddOffset(11, ratioWavelengthsOffset.Value, 0); }
  ...
  public static void AddFluxRatios(FlatBufferBuilder builder, VectorOffset fluxRatiosOffset) { builder.AddOffset(12, fluxRatiosOffset.Value, 0); }
  ...
  public static void AddSatNo(FlatBufferBuilder builder, int satNo) { builder.AddInt(16, satNo, 0); }
  public static void AddDataMode(FlatBufferBuilder builder, SWIR_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(17, (sbyte)dataMode, 0); }
  ...
  public static Offset<SWIR_Ingest> EndSWIR_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SWIR_Ingest>(o);
  }
  public static void FinishSWIR_IngestBuffer(FlatBufferBuilder builder, Offset<SWIR_Ingest> offset) { builder.Finish(offset.Value, "SWIR"); }
  public static void FinishSizePrefixedSWIR_IngestBuffer(FlatBufferBuilder builder, Offset<SWIR_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "SWIR"); }
  public SWIR_IngestT UnPack() {
    var _o = new SWIR_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SWIR_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<SWIR_Ingest> Pack(FlatBufferBuilder builder, SWIR_IngestT _o) {
    if (_o == null) return default(Offset<SWIR_Ingest>);
...
public class SWIR_IngestT
{
  ...
  public SWIR_Ingest_dataMode_Enum DataMode { get; set; }
  ...
  public SWIR_IngestT() {
    ...
    this.Origin = null;
    this.SatNo = 0;
    this.DataMode = SWIR_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.OrigNetwork = null;
  }
  public static SWIR_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return SWIR_Ingest.GetRootAsSWIR_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SWIR_Ingest.FinishSWIR_IngestBuffer(fbb, SWIR_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SWIR_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfStrings(tablePos, 22 /*Wavelengths*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 24 /*AbsFluxes*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 26 /*RatioWavelengths*/, false)
      && verifier.VerifyVectorOfStrings(tablePos, 28 /*FluxRatios*/, false)
      ...
      && verifier.VerifyField(tablePos, 36 /*SatNo*/, 4 /*int*/, 4, false)
      && verifier.VerifyField(tablePos, 38 /*DataMode*/, 1 /*SWIR_Ingest_dataMode_Enum*/, 1, false)
