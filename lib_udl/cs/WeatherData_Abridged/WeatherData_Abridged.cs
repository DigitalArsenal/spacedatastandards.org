...
public struct WeatherData_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static WeatherData_Abridged GetRootAsWeatherData_Abridged(ByteBuffer _bb) { return GetRootAsWeatherData_Abridged(_bb, new WeatherData_Abridged()); }
  public static WeatherData_Abridged GetRootAsWeatherData_Abridged(ByteBuffer _bb, WeatherData_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool WeatherData_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "WEAT"); }
  public static bool VerifyWeatherData_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("WEAT", false, WeatherData_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public WeatherData_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public WeatherData_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(80); return o != 0 ? (WeatherData_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : WeatherData_Abridged_dataMode_Enum.REAL; } }

  public static Offset<WeatherData_Abridged> CreateWeatherData_Abridged(FlatBufferBuilder builder,
      ...
      WeatherData_Abridged_dataMode_Enum dataMode = WeatherData_Abridged_dataMode_Enum.REAL) {
  ...
  public static void StartWeatherData_Abridged(FlatBufferBuilder builder) { builder.StartTable(39); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, WeatherData_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(38, (sbyte)dataMode, 0); }
  public static Offset<WeatherData_Abridged> EndWeatherData_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<WeatherData_Abridged>(o);
  }
  public static void FinishWeatherData_AbridgedBuffer(FlatBufferBuilder builder, Offset<WeatherData_Abridged> offset) { builder.Finish(offset.Value, "WEAT"); }
  public static void FinishSizePrefixedWeatherData_AbridgedBuffer(FlatBufferBuilder builder, Offset<WeatherData_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "WEAT"); }
  public WeatherData_AbridgedT UnPack() {
    var _o = new WeatherData_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(WeatherData_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<WeatherData_Abridged> Pack(FlatBufferBuilder builder, WeatherData_AbridgedT _o) {
    if (_o == null) return default(Offset<WeatherData_Abridged>);
...
public class WeatherData_AbridgedT
{
  ...
  public WeatherData_Abridged_dataMode_Enum DataMode { get; set; }

  public WeatherData_AbridgedT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = WeatherData_Abridged_dataMode_Enum.REAL;
  }
  public static WeatherData_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return WeatherData_Abridged.GetRootAsWeatherData_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    WeatherData_Abridged.FinishWeatherData_AbridgedBuffer(fbb, WeatherData_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class WeatherData_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 80 /*DataMode*/, 1 /*WeatherData_Abridged_dataMode_Enum*/, 1, false)
