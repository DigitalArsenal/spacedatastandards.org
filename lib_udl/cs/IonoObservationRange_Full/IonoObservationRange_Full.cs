...
public struct IonoObservationRange_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationRange_Full GetRootAsIonoObservationRange_Full(ByteBuffer _bb) { return GetRootAsIonoObservationRange_Full(_bb, new IonoObservationRange_Full()); }
  public static IonoObservationRange_Full GetRootAsIonoObservationRange_Full(ByteBuffer _bb, IonoObservationRange_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationRange_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationRange_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationRange_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationRange_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationRange_Full> CreateIonoObservationRange_Full(FlatBufferBuilder builder,
  ...
  public static void StartIonoObservationRange_Full(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationRange_Full> EndIonoObservationRange_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationRange_Full>(o);
  }
  public static void FinishIonoObservationRange_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationRange_Full> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationRange_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationRange_Full> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationRange_FullT UnPack() {
    var _o = new IonoObservationRange_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationRange_FullT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationRange_Full> Pack(FlatBufferBuilder builder, IonoObservationRange_FullT _o) {
    if (_o == null) return default(Offset<IonoObservationRange_Full>);
    ...
    return CreateIonoObservationRange_Full(
      builder,
      _notes,
      _dimensions,
      _dimensionName,
...
public class IonoObservationRange_FullT
{
  ...
  public IonoObservationRange_FullT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationRange_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationRange_Full.GetRootAsIonoObservationRange_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationRange_Full.FinishIonoObservationRange_FullBuffer(fbb, IonoObservationRange_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationRange_FullVerify
{
