...
public struct DiffOfArrival_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static DiffOfArrival_Abridged GetRootAsDiffOfArrival_Abridged(ByteBuffer _bb, DiffOfArrival_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DiffOfArrival_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DIFF"); }
  public static bool VerifyDiffOfArrival_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DIFF", false, DiffOfArrival_AbridgedVerify.Verify); }
  ...
  public DiffOfArrival_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(70); return o != 0 ? (DiffOfArrival_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : DiffOfArrival_Abridged_dataMode_Enum.REAL; } }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 64
  public string Descriptor { get { int o = __p.__offset(78); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetDescriptorBytes() { return __p.__vector_as_span<byte>(78, 1); }
#else
  public ArraySegment<byte>? GetDescriptorBytes() { return __p.__vector_as_arraysegment(78); }
#endif
  public byte[] GetDescriptorArray() { return __p.__vector_as_array<byte>(78); }
  ...
  public static Offset<DiffOfArrival_Abridged> CreateDiffOfArrival_Abridged(FlatBufferBuilder builder,
      ...
      DiffOfArrival_Abridged_dataMode_Enum dataMode = DiffOfArrival_Abridged_dataMode_Enum.REAL,
  ...
  public static void AddDataMode(FlatBufferBuilder builder, DiffOfArrival_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(33, (sbyte)dataMode, 0); }
  ...
  public static void AddDescriptor(FlatBufferBuilder builder, StringOffset descriptorOffset) { builder.AddOffset(37, descriptorOffset.Value, 0); }
  ...
  public static Offset<DiffOfArrival_Abridged> EndDiffOfArrival_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DiffOfArrival_Abridged>(o);
  }
  public static void FinishDiffOfArrival_AbridgedBuffer(FlatBufferBuilder builder, Offset<DiffOfArrival_Abridged> offset) { builder.Finish(offset.Value, "DIFF"); }
  public static void FinishSizePrefixedDiffOfArrival_AbridgedBuffer(FlatBufferBuilder builder, Offset<DiffOfArrival_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "DIFF"); }
  public DiffOfArrival_AbridgedT UnPack() {
    var _o = new DiffOfArrival_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DiffOfArrival_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<DiffOfArrival_Abridged> Pack(FlatBufferBuilder builder, DiffOfArrival_AbridgedT _o) {
    if (_o == null) return default(Offset<DiffOfArrival_Abridged>);
...
public class DiffOfArrival_AbridgedT
{
  ...
  public DiffOfArrival_Abridged_dataMode_Enum DataMode { get; set; }
  ...
  public DiffOfArrival_AbridgedT() {
    this.Id = null;
    ...
    this.Source = null;
    this.DataMode = DiffOfArrival_Abridged_dataMode_Enum.REAL;
    this.Origin = null;
    this.CreatedAt = null;
    this.CreatedBy = null;
  ...
  public static DiffOfArrival_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return DiffOfArrival_Abridged.GetRootAsDiffOfArrival_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DiffOfArrival_Abridged.FinishDiffOfArrival_AbridgedBuffer(fbb, DiffOfArrival_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DiffOfArrival_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 70 /*DataMode*/, 1 /*DiffOfArrival_Abridged_dataMode_Enum*/, 1, false)
      ...
      && verifier.VerifyString(tablePos, 78 /*Descriptor*/, false)
