...
public struct LaunchEvent_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static LaunchEvent_Full GetRootAsLaunchEvent_Full(ByteBuffer _bb) { return GetRootAsLaunchEvent_Full(_bb, new LaunchEvent_Full()); }
  public static LaunchEvent_Full GetRootAsLaunchEvent_Full(ByteBuffer _bb, LaunchEvent_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LaunchEvent_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LAUN"); }
  public static bool VerifyLaunchEvent_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LAUN", false, LaunchEvent_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public LaunchEvent_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public LaunchEvent_Full_dataMode_Enum DataMode { get { int o = __p.__offset(38); return o != 0 ? (LaunchEvent_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : LaunchEvent_Full_dataMode_Enum.REAL; } }
  ...
  /// Constraints: No constraints specified.
  public string OnOrbit { get { int o = __p.__offset(42); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetOnOrbitBytes() { return __p.__vector_as_span<byte>(42, 1); }
#else
  public ArraySegment<byte>? GetOnOrbitBytes() { return __p.__vector_as_arraysegment(42); }
#endif
  public byte[] GetOnOrbitArray() { return __p.__vector_as_array<byte>(42); }
  /// Satellite/catalog number of the target on-orbit object.
  /// Example: /// Example: 12
  /// Constraints: No constraints specified.
  public int SatNo { get { int o = __p.__offset(44); return o != 0 ? __p.bb.GetInt(o + __p.bb_pos) : (int)0; } }

  public static Offset<LaunchEvent_Full> CreateLaunchEvent_Full(FlatBufferBuilder builder,
      ...
      LaunchEvent_Full_dataMode_Enum dataMode = LaunchEvent_Full_dataMode_Enum.REAL,
  ...
  public static void StartLaunchEvent_Full(FlatBufferBuilder builder) { builder.StartTable(21); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, LaunchEvent_Full_dataMode_Enum dataMode) { builder.AddSbyte(17, (sbyte)dataMode, 0); }
  ...
  public static void AddOnOrbit(FlatBufferBuilder builder, StringOffset onOrbitOffset) { builder.AddOffset(19, onOrbitOffset.Value, 0); }
  public static void AddSatNo(FlatBufferBuilder builder, int satNo) { builder.AddInt(20, satNo, 0); }
  public static Offset<LaunchEvent_Full> EndLaunchEvent_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LaunchEvent_Full>(o);
  }
  public static void FinishLaunchEvent_FullBuffer(FlatBufferBuilder builder, Offset<LaunchEvent_Full> offset) { builder.Finish(offset.Value, "LAUN"); }
  public static void FinishSizePrefixedLaunchEvent_FullBuffer(FlatBufferBuilder builder, Offset<LaunchEvent_Full> offset) { builder.FinishSizePrefixed(offset.Value, "LAUN"); }
  public LaunchEvent_FullT UnPack() {
    var _o = new LaunchEvent_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LaunchEvent_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<LaunchEvent_Full> Pack(FlatBufferBuilder builder, LaunchEvent_FullT _o) {
    if (_o == null) return default(Offset<LaunchEvent_Full>);
...
public class LaunchEvent_FullT
{
  ...
  public LaunchEvent_Full_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }
  public string OnOrbit { get; set; }
  public int SatNo { get; set; }

  public LaunchEvent_FullT() {
    this.Id = null;
    this.IdOnOrbit = null;
    ...
    this.Origin = null;
    this.Source = null;
    this.DataMode = LaunchEvent_Full_dataMode_Enum.REAL;
    this.OrigNetwork = null;
    this.OnOrbit = null;
    this.SatNo = 0;
  }
  public static LaunchEvent_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return LaunchEvent_Full.GetRootAsLaunchEvent_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LaunchEvent_Full.FinishLaunchEvent_FullBuffer(fbb, LaunchEvent_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LaunchEvent_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 38 /*DataMode*/, 1 /*LaunchEvent_Full_dataMode_Enum*/, 1, false)
      && verifier.VerifyString(tablePos, 40 /*OrigNetwork*/, false)
      && verifier.VerifyString(tablePos, 42 /*OnOrbit*/, false)
      && verifier.VerifyField(tablePos, 44 /*SatNo*/, 4 /*int*/, 4, false)
