...
public struct AttitudeData_Ingest : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AttitudeData_Ingest GetRootAsAttitudeData_Ingest(ByteBuffer _bb) { return GetRootAsAttitudeData_Ingest(_bb, new AttitudeData_Ingest()); }
  public static AttitudeData_Ingest GetRootAsAttitudeData_Ingest(ByteBuffer _bb, AttitudeData_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AttitudeData_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ATTI"); }
  public static bool VerifyAttitudeData_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ATTI", false, AttitudeData_IngestVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AttitudeData_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public AttitudeData_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(66); return o != 0 ? (AttitudeData_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AttitudeData_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<AttitudeData_Ingest> CreateAttitudeData_Ingest(FlatBufferBuilder builder,
      ...
      AttitudeData_Ingest_dataMode_Enum dataMode = AttitudeData_Ingest_dataMode_Enum.REAL,
  ...
  public static void StartAttitudeData_Ingest(FlatBufferBuilder builder) { builder.StartTable(33); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AttitudeData_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(31, (sbyte)dataMode, 0); }
  ...
  public static Offset<AttitudeData_Ingest> EndAttitudeData_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AttitudeData_Ingest>(o);
  }
  public static void FinishAttitudeData_IngestBuffer(FlatBufferBuilder builder, Offset<AttitudeData_Ingest> offset) { builder.Finish(offset.Value, "ATTI"); }
  public static void FinishSizePrefixedAttitudeData_IngestBuffer(FlatBufferBuilder builder, Offset<AttitudeData_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "ATTI"); }
  public AttitudeData_IngestT UnPack() {
    var _o = new AttitudeData_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AttitudeData_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AttitudeData_Ingest> Pack(FlatBufferBuilder builder, AttitudeData_IngestT _o) {
    if (_o == null) return default(Offset<AttitudeData_Ingest>);
...
public class AttitudeData_IngestT
{
  ...
  public AttitudeData_Ingest_dataMode_Enum DataMode { get; set; }
  public string OrigNetwork { get; set; }

  public AttitudeData_IngestT() {
    this.Id = null;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = AttitudeData_Ingest_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static AttitudeData_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return AttitudeData_Ingest.GetRootAsAttitudeData_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AttitudeData_Ingest.FinishAttitudeData_IngestBuffer(fbb, AttitudeData_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AttitudeData_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 66 /*DataMode*/, 1 /*AttitudeData_Ingest_dataMode_Enum*/, 1, false)
