...
public struct TrackRoute_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static TrackRoute_Abridged GetRootAsTrackRoute_Abridged(ByteBuffer _bb, TrackRoute_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool TrackRoute_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "TRAC"); }
  public static bool VerifyTrackRoute_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("TRAC", false, TrackRoute_AbridgedVerify.Verify); }
  ...
  public TrackRoute_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(78); return o != 0 ? (TrackRoute_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : TrackRoute_Abridged_dataMode_Enum.REAL; } }

  public static Offset<TrackRoute_Abridged> CreateTrackRoute_Abridged(FlatBufferBuilder builder,
      ...
      TrackRoute_Abridged_dataMode_Enum dataMode = TrackRoute_Abridged_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, TrackRoute_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(37, (sbyte)dataMode, 0); }
  public static Offset<TrackRoute_Abridged> EndTrackRoute_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<TrackRoute_Abridged>(o);
  }
  public static void FinishTrackRoute_AbridgedBuffer(FlatBufferBuilder builder, Offset<TrackRoute_Abridged> offset) { builder.Finish(offset.Value, "TRAC"); }
  public static void FinishSizePrefixedTrackRoute_AbridgedBuffer(FlatBufferBuilder builder, Offset<TrackRoute_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "TRAC"); }
  public TrackRoute_AbridgedT UnPack() {
    var _o = new TrackRoute_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(TrackRoute_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<TrackRoute_Abridged> Pack(FlatBufferBuilder builder, TrackRoute_AbridgedT _o) {
    if (_o == null) return default(Offset<TrackRoute_Abridged>);
...
public class TrackRoute_AbridgedT
{
  ...
  public TrackRoute_Abridged_dataMode_Enum DataMode { get; set; }

  public TrackRoute_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = TrackRoute_Abridged_dataMode_Enum.REAL;
  }
  public static TrackRoute_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return TrackRoute_Abridged.GetRootAsTrackRoute_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    TrackRoute_Abridged.FinishTrackRoute_AbridgedBuffer(fbb, TrackRoute_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class TrackRoute_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 78 /*DataMode*/, 1 /*TrackRoute_Abridged_dataMode_Enum*/, 1, false)
