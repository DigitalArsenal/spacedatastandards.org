...
public struct DataLinkReferences_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static DataLinkReferences_Abridged GetRootAsDataLinkReferences_Abridged(ByteBuffer _bb) { return GetRootAsDataLinkReferences_Abridged(_bb, new DataLinkReferences_Abridged()); }
  public static DataLinkReferences_Abridged GetRootAsDataLinkReferences_Abridged(ByteBuffer _bb, DataLinkReferences_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool DataLinkReferences_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "DATA"); }
  public static bool VerifyDataLinkReferences_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("DATA", false, DataLinkReferences_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public DataLinkReferences_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<DataLinkReferences_Abridged> CreateDataLinkReferences_Abridged(FlatBufferBuilder builder,
    ...
    DataLinkReferences_Abridged.AddRefSICs(builder, refSICsOffset);
    DataLinkReferences_Abridged.AddRefSpecialNotation(builder, refSpecialNotationOffset);
    DataLinkReferences_Abridged.AddRefSerialNum(builder, refSerialNumOffset);
    DataLinkReferences_Abridged.AddRefTs(builder, refTsOffset);
    DataLinkReferences_Abridged.AddRefOriginator(builder, refOriginatorOffset);
    DataLinkReferences_Abridged.AddRefType(builder, refTypeOffset);
    DataLinkReferences_Abridged.AddRefSerialId(builder, refSerialIdOffset);
    return DataLinkReferences_Abridged.EndDataLinkReferences_Abridged(builder);
  }

  public static void StartDataLinkReferences_Abridged(FlatBufferBuilder builder) { builder.StartTable(7); }
  ...
  public static Offset<DataLinkReferences_Abridged> EndDataLinkReferences_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<DataLinkReferences_Abridged>(o);
  }
  public static void FinishDataLinkReferences_AbridgedBuffer(FlatBufferBuilder builder, Offset<DataLinkReferences_Abridged> offset) { builder.Finish(offset.Value, "DATA"); }
  public static void FinishSizePrefixedDataLinkReferences_AbridgedBuffer(FlatBufferBuilder builder, Offset<DataLinkReferences_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "DATA"); }
  public DataLinkReferences_AbridgedT UnPack() {
    var _o = new DataLinkReferences_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(DataLinkReferences_AbridgedT _o) {
  ...
  public static Offset<DataLinkReferences_Abridged> Pack(FlatBufferBuilder builder, DataLinkReferences_AbridgedT _o) {
    if (_o == null) return default(Offset<DataLinkReferences_Abridged>);
    ...
    return CreateDataLinkReferences_Abridged(
      builder,
      _refSerialId,
      _refType,
      _refOriginator,
...
public class DataLinkReferences_AbridgedT
{
  ...
  public DataLinkReferences_AbridgedT() {
  ...
  public static DataLinkReferences_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return DataLinkReferences_Abridged.GetRootAsDataLinkReferences_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    DataLinkReferences_Abridged.FinishDataLinkReferences_AbridgedBuffer(fbb, DataLinkReferences_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class DataLinkReferences_AbridgedVerify
{
