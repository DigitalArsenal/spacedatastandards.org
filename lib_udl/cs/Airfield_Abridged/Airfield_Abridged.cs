...
public struct Airfield_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static Airfield_Abridged GetRootAsAirfield_Abridged(ByteBuffer _bb, Airfield_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Airfield_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AIRF"); }
  public static bool VerifyAirfield_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AIRF", false, Airfield_AbridgedVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public Airfield_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(72); return o != 0 ? (Airfield_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Airfield_Abridged_dataMode_Enum.REAL; } }

  public static Offset<Airfield_Abridged> CreateAirfield_Abridged(FlatBufferBuilder builder,
      ...
      Airfield_Abridged_dataMode_Enum dataMode = Airfield_Abridged_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Airfield_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(34, (sbyte)dataMode, 0); }
  public static Offset<Airfield_Abridged> EndAirfield_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Airfield_Abridged>(o);
  }
  public static void FinishAirfield_AbridgedBuffer(FlatBufferBuilder builder, Offset<Airfield_Abridged> offset) { builder.Finish(offset.Value, "AIRF"); }
  public static void FinishSizePrefixedAirfield_AbridgedBuffer(FlatBufferBuilder builder, Offset<Airfield_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "AIRF"); }
  public Airfield_AbridgedT UnPack() {
    var _o = new Airfield_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Airfield_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Airfield_Abridged> Pack(FlatBufferBuilder builder, Airfield_AbridgedT _o) {
    if (_o == null) return default(Offset<Airfield_Abridged>);
...
public class Airfield_AbridgedT
{
  ...
  public Airfield_Abridged_dataMode_Enum DataMode { get; set; }

  public Airfield_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = Airfield_Abridged_dataMode_Enum.REAL;
  }
  public static Airfield_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Airfield_Abridged.GetRootAsAirfield_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Airfield_Abridged.FinishAirfield_AbridgedBuffer(fbb, Airfield_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Airfield_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 72 /*DataMode*/, 1 /*Airfield_Abridged_dataMode_Enum*/, 1, false)
