...
public struct StarCatalog_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static StarCatalog_Full GetRootAsStarCatalog_Full(ByteBuffer _bb) { return GetRootAsStarCatalog_Full(_bb, new StarCatalog_Full()); }
  public static StarCatalog_Full GetRootAsStarCatalog_Full(ByteBuffer _bb, StarCatalog_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool StarCatalog_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "STAR"); }
  public static bool VerifyStarCatalog_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("STAR", false, StarCatalog_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public StarCatalog_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public StarCatalog_Full_astrometryOrigin_Enum AstrometryOrigin { get { int o = __p.__offset(42); return o != 0 ? (StarCatalog_Full_astrometryOrigin_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : StarCatalog_Full_astrometryOrigin_Enum.GAIADR3; } }
  ...
  public StarCatalog_Full_dataMode_Enum DataMode { get { int o = __p.__offset(98); return o != 0 ? (StarCatalog_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : StarCatalog_Full_dataMode_Enum.REAL; } }

  public static Offset<StarCatalog_Full> CreateStarCatalog_Full(FlatBufferBuilder builder,
      ...
      StarCatalog_Full_astrometryOrigin_Enum astrometryOrigin = StarCatalog_Full_astrometryOrigin_Enum.GAIADR3,
      ...
      StarCatalog_Full_dataMode_Enum dataMode = StarCatalog_Full_dataMode_Enum.REAL) {
  ...
  public static void StartStarCatalog_Full(FlatBufferBuilder builder) { builder.StartTable(48); }
  ...
  public static void AddAstrometryOrigin(FlatBufferBuilder builder, StarCatalog_Full_astrometryOrigin_Enum astrometryOrigin) { builder.AddSbyte(19, (sbyte)astrometryOrigin, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, StarCatalog_Full_dataMode_Enum dataMode) { builder.AddSbyte(47, (sbyte)dataMode, 0); }
  public static Offset<StarCatalog_Full> EndStarCatalog_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<StarCatalog_Full>(o);
  }
  public static void FinishStarCatalog_FullBuffer(FlatBufferBuilder builder, Offset<StarCatalog_Full> offset) { builder.Finish(offset.Value, "STAR"); }
  public static void FinishSizePrefixedStarCatalog_FullBuffer(FlatBufferBuilder builder, Offset<StarCatalog_Full> offset) { builder.FinishSizePrefixed(offset.Value, "STAR"); }
  public StarCatalog_FullT UnPack() {
    var _o = new StarCatalog_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(StarCatalog_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<StarCatalog_Full> Pack(FlatBufferBuilder builder, StarCatalog_FullT _o) {
    if (_o == null) return default(Offset<StarCatalog_Full>);
...
public class StarCatalog_FullT
{
  ...
  public StarCatalog_Full_astrometryOrigin_Enum AstrometryOrigin { get; set; }
  ...
  public StarCatalog_Full_dataMode_Enum DataMode { get; set; }

  public StarCatalog_FullT() {
    this.Id = null;
    ...
    this.AstrometryOrigin = StarCatalog_Full_astrometryOrigin_Enum.GAIADR3;
    this.StarEpoch = 0.0;
    this.Gmag = 0.0;
    this.GmagUnc = 0.0;
    this.Bpmag = 0.0;
    ...
    this.DataMode = StarCatalog_Full_dataMode_Enum.REAL;
  }
  public static StarCatalog_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return StarCatalog_Full.GetRootAsStarCatalog_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    StarCatalog_Full.FinishStarCatalog_FullBuffer(fbb, StarCatalog_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class StarCatalog_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 42 /*AstrometryOrigin*/, 1 /*StarCatalog_Full_astrometryOrigin_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 98 /*DataMode*/, 1 /*StarCatalog_Full_dataMode_Enum*/, 1, false)
