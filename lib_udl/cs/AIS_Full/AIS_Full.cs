...
public struct AIS_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static AIS_Full GetRootAsAIS_Full(ByteBuffer _bb) { return GetRootAsAIS_Full(_bb, new AIS_Full()); }
  public static AIS_Full GetRootAsAIS_Full(ByteBuffer _bb, AIS_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool AIS_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "AISF"); }
  public static bool VerifyAIS_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("AISF", false, AIS_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public AIS_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public AIS_Full_dataMode_Enum DataMode { get { int o = __p.__offset(102); return o != 0 ? (AIS_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : AIS_Full_dataMode_Enum.REAL; } }
  ...
  public static Offset<AIS_Full> CreateAIS_Full(FlatBufferBuilder builder,
      ...
      AIS_Full_dataMode_Enum dataMode = AIS_Full_dataMode_Enum.REAL,
  ...
  public static void StartAIS_Full(FlatBufferBuilder builder) { builder.StartTable(51); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, AIS_Full_dataMode_Enum dataMode) { builder.AddSbyte(49, (sbyte)dataMode, 0); }
  ...
  public static Offset<AIS_Full> EndAIS_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<AIS_Full>(o);
  }
  public static void FinishAIS_FullBuffer(FlatBufferBuilder builder, Offset<AIS_Full> offset) { builder.Finish(offset.Value, "AISF"); }
  public static void FinishSizePrefixedAIS_FullBuffer(FlatBufferBuilder builder, Offset<AIS_Full> offset) { builder.FinishSizePrefixed(offset.Value, "AISF"); }
  public AIS_FullT UnPack() {
    var _o = new AIS_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(AIS_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<AIS_Full> Pack(FlatBufferBuilder builder, AIS_FullT _o) {
    if (_o == null) return default(Offset<AIS_Full>);
...
public class AIS_FullT
{
  ...
  public AIS_Full_dataMode_Enum DataMode { get; set; }
  ...
  public AIS_FullT() {
    ...
    this.SourceDL = null;
    this.Origin = null;
    this.DataMode = AIS_Full_dataMode_Enum.REAL;
    this.OrigNetwork = null;
  }
  public static AIS_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return AIS_Full.GetRootAsAIS_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    AIS_Full.FinishAIS_FullBuffer(fbb, AIS_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class AIS_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 102 /*DataMode*/, 1 /*AIS_Full_dataMode_Enum*/, 1, false)
