...
public struct LaunchVehicleDetails_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static LaunchVehicleDetails_Abridged GetRootAsLaunchVehicleDetails_Abridged(ByteBuffer _bb, LaunchVehicleDetails_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool LaunchVehicleDetails_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "LAUN"); }
  public static bool VerifyLaunchVehicleDetails_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("LAUN", false, LaunchVehicleDetails_AbridgedVerify.Verify); }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public LaunchVehicleDetails_Abridged_dataMode_Enum DataMode { get { int o = __p.__offset(110); return o != 0 ? (LaunchVehicleDetails_Abridged_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : LaunchVehicleDetails_Abridged_dataMode_Enum.REAL; } }

  public static Offset<LaunchVehicleDetails_Abridged> CreateLaunchVehicleDetails_Abridged(FlatBufferBuilder builder,
      ...
      LaunchVehicleDetails_Abridged_dataMode_Enum dataMode = LaunchVehicleDetails_Abridged_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, LaunchVehicleDetails_Abridged_dataMode_Enum dataMode) { builder.AddSbyte(53, (sbyte)dataMode, 0); }
  public static Offset<LaunchVehicleDetails_Abridged> EndLaunchVehicleDetails_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<LaunchVehicleDetails_Abridged>(o);
  }
  public static void FinishLaunchVehicleDetails_AbridgedBuffer(FlatBufferBuilder builder, Offset<LaunchVehicleDetails_Abridged> offset) { builder.Finish(offset.Value, "LAUN"); }
  public static void FinishSizePrefixedLaunchVehicleDetails_AbridgedBuffer(FlatBufferBuilder builder, Offset<LaunchVehicleDetails_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "LAUN"); }
  public LaunchVehicleDetails_AbridgedT UnPack() {
    var _o = new LaunchVehicleDetails_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(LaunchVehicleDetails_AbridgedT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<LaunchVehicleDetails_Abridged> Pack(FlatBufferBuilder builder, LaunchVehicleDetails_AbridgedT _o) {
    if (_o == null) return default(Offset<LaunchVehicleDetails_Abridged>);
...
public class LaunchVehicleDetails_AbridgedT
{
  ...
  public LaunchVehicleDetails_Abridged_dataMode_Enum DataMode { get; set; }

  public LaunchVehicleDetails_AbridgedT() {
    this.Id = null;
    ...
    this.DataMode = LaunchVehicleDetails_Abridged_dataMode_Enum.REAL;
  }
  public static LaunchVehicleDetails_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return LaunchVehicleDetails_Abridged.GetRootAsLaunchVehicleDetails_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    LaunchVehicleDetails_Abridged.FinishLaunchVehicleDetails_AbridgedBuffer(fbb, LaunchVehicleDetails_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class LaunchVehicleDetails_AbridgedVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 110 /*DataMode*/, 1 /*LaunchVehicleDetails_Abridged_dataMode_Enum*/, 1, false)
