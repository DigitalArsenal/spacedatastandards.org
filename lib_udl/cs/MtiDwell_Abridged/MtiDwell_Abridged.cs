...
public struct MtiDwell_Abridged : IFlatbufferObject
{
  private Table __p;
  ...
  public static MtiDwell_Abridged GetRootAsMtiDwell_Abridged(ByteBuffer _bb, MtiDwell_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool MtiDwell_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "MTID"); }
  public static bool VerifyMtiDwell_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("MTID", false, MtiDwell_AbridgedVerify.Verify); }
  ...
  public static Offset<MtiDwell_Abridged> CreateMtiDwell_Abridged(FlatBufferBuilder builder,
      int d2 = 0,
      int d3 = 0,
      bool d4 = false,
      int d5 = 0,
  ...
  public static Offset<MtiDwell_Abridged> EndMtiDwell_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<MtiDwell_Abridged>(o);
  }
  public static void FinishMtiDwell_AbridgedBuffer(FlatBufferBuilder builder, Offset<MtiDwell_Abridged> offset) { builder.Finish(offset.Value, "MTID"); }
  public static void FinishSizePrefixedMtiDwell_AbridgedBuffer(FlatBufferBuilder builder, Offset<MtiDwell_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "MTID"); }
  public MtiDwell_AbridgedT UnPack() {
    var _o = new MtiDwell_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(MtiDwell_AbridgedT _o) {
    _o.D2 = this.D2;
    _o.D3 = this.D3;
    _o.D4 = this.D4;
    _o.D5 = this.D5;
  ...
  public static Offset<MtiDwell_Abridged> Pack(FlatBufferBuilder builder, MtiDwell_AbridgedT _o) {
    if (_o == null) return default(Offset<MtiDwell_Abridged>);
...
public class MtiDwell_AbridgedT
{
  ...
  public static MtiDwell_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return MtiDwell_Abridged.GetRootAsMtiDwell_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    MtiDwell_Abridged.FinishMtiDwell_AbridgedBuffer(fbb, MtiDwell_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class MtiDwell_AbridgedVerify
{
