...
public struct EvacEnemyData_Ingest : IFlatbufferObject
{
  ...
  public static Offset<EvacEnemyData_Ingest.EvacEnemyData_Ingest> CreateEvacEnemyData_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<EvacEnemyData_Ingest.EvacEnemyData_Ingest> EndEvacEnemyData_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<EvacEnemyData_Ingest.EvacEnemyData_Ingest>(o);
  }
  ...
  public static Offset<EvacEnemyData_Ingest.EvacEnemyData_Ingest> Pack(FlatBufferBuilder builder, EvacEnemyData_IngestT _o) {
    if (_o == null) return default(Offset<EvacEnemyData_Ingest.EvacEnemyData_Ingest>);
