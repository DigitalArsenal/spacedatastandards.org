...
public struct SofDataSourceRef_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static SofDataSourceRef_Ingest GetRootAsSofDataSourceRef_Ingest(ByteBuffer _bb, SofDataSourceRef_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool SofDataSourceRef_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "SOFD"); }
  public static bool VerifySofDataSourceRef_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("SOFD", false, SofDataSourceRef_IngestVerify.Verify); }
  ...
  public static Offset<SofDataSourceRef_Ingest> CreateSofDataSourceRef_Ingest(FlatBufferBuilder builder,
  ...
  public static Offset<SofDataSourceRef_Ingest> EndSofDataSourceRef_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<SofDataSourceRef_Ingest>(o);
  }
  public static void FinishSofDataSourceRef_IngestBuffer(FlatBufferBuilder builder, Offset<SofDataSourceRef_Ingest> offset) { builder.Finish(offset.Value, "SOFD"); }
  public static void FinishSizePrefixedSofDataSourceRef_IngestBuffer(FlatBufferBuilder builder, Offset<SofDataSourceRef_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "SOFD"); }
  public SofDataSourceRef_IngestT UnPack() {
    var _o = new SofDataSourceRef_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(SofDataSourceRef_IngestT _o) {
  ...
  public static Offset<SofDataSourceRef_Ingest> Pack(FlatBufferBuilder builder, SofDataSourceRef_IngestT _o) {
    if (_o == null) return default(Offset<SofDataSourceRef_Ingest>);
...
public class SofDataSourceRef_IngestT
{
  ...
  public SofDataSourceRef_IngestT() {
  ...
  public static SofDataSourceRef_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return SofDataSourceRef_Ingest.GetRootAsSofDataSourceRef_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    SofDataSourceRef_Ingest.FinishSofDataSourceRef_IngestBuffer(fbb, SofDataSourceRef_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class SofDataSourceRef_IngestVerify
{
