...
public struct BeamContour_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static BeamContour_Full GetRootAsBeamContour_Full(ByteBuffer _bb) { return GetRootAsBeamContour_Full(_bb, new BeamContour_Full()); }
  public static BeamContour_Full GetRootAsBeamContour_Full(ByteBuffer _bb, BeamContour_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool BeamContour_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "BEAM"); }
  public static bool VerifyBeamContour_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("BEAM", false, BeamContour_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public BeamContour_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public BeamContour_Full_type_Enum Type { get { int o = __p.__offset(10); return o != 0 ? (BeamContour_Full_type_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : BeamContour_Full_type_Enum.BORESIGHT; } }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  public BeamContour_Full_dataMode_Enum DataMode { get { int o = __p.__offset(44); return o != 0 ? (BeamContour_Full_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : BeamContour_Full_dataMode_Enum.REAL; } }

  public static Offset<BeamContour_Full> CreateBeamContour_Full(FlatBufferBuilder builder,
      StringOffset idOffset = default(StringOffset),
      StringOffset classificationMarkingOffset = default(StringOffset),
      StringOffset idBeamOffset = default(StringOffset),
      BeamContour_Full_type_Enum type = BeamContour_Full_type_Enum.BORESIGHT,
      int contourIdx = 0,
      double gain = 0.0,
      ...
      BeamContour_Full_dataMode_Enum dataMode = BeamContour_Full_dataMode_Enum.REAL) {
  ...
  public static void StartBeamContour_Full(FlatBufferBuilder builder) { builder.StartTable(21); }
  ...
  public static void AddType(FlatBufferBuilder builder, BeamContour_Full_type_Enum type) { builder.AddSbyte(3, (sbyte)type, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, BeamContour_Full_dataMode_Enum dataMode) { builder.AddSbyte(20, (sbyte)dataMode, 0); }
  public static Offset<BeamContour_Full> EndBeamContour_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<BeamContour_Full>(o);
  }
  public static void FinishBeamContour_FullBuffer(FlatBufferBuilder builder, Offset<BeamContour_Full> offset) { builder.Finish(offset.Value, "BEAM"); }
  public static void FinishSizePrefixedBeamContour_FullBuffer(FlatBufferBuilder builder, Offset<BeamContour_Full> offset) { builder.FinishSizePrefixed(offset.Value, "BEAM"); }
  public BeamContour_FullT UnPack() {
    var _o = new BeamContour_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(BeamContour_FullT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<BeamContour_Full> Pack(FlatBufferBuilder builder, BeamContour_FullT _o) {
    if (_o == null) return default(Offset<BeamContour_Full>);
...
public class BeamContour_FullT
{
  public string Id { get; set; }
  public string ClassificationMarking { get; set; }
  public string IdBeam { get; set; }
  public BeamContour_Full_type_Enum Type { get; set; }
  ...
  public BeamContour_Full_dataMode_Enum DataMode { get; set; }

  public BeamContour_FullT() {
    this.Id = null;
    this.ClassificationMarking = null;
    this.IdBeam = null;
    this.Type = BeamContour_Full_type_Enum.BORESIGHT;
    this.ContourIdx = 0;
    this.Gain = 0.0;
    ...
    this.DataMode = BeamContour_Full_dataMode_Enum.REAL;
  }
  public static BeamContour_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return BeamContour_Full.GetRootAsBeamContour_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    BeamContour_Full.FinishBeamContour_FullBuffer(fbb, BeamContour_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class BeamContour_FullVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*Type*/, 1 /*BeamContour_Full_type_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 44 /*DataMode*/, 1 /*BeamContour_Full_dataMode_Enum*/, 1, false)
