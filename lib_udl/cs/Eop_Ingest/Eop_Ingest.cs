...
public struct Eop_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static Eop_Ingest GetRootAsEop_Ingest(ByteBuffer _bb, Eop_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool Eop_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "EOPI"); }
  public static bool VerifyEop_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("EOPI", false, Eop_IngestVerify.Verify); }
  ...
  public Eop_Ingest_polarMotionState_Enum PolarMotionState { get { int o = __p.__offset(10); return o != 0 ? (Eop_Ingest_polarMotionState_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Eop_Ingest_polarMotionState_Enum.I; } }
  ...
  /// Example: /// Example: I
  /// Constraints: Minimum length = 0, Maximum length = 1
  public Eop_Ingest_ut1UTCState_Enum Ut1UTCState { get { int o = __p.__offset(20); return o != 0 ? (Eop_Ingest_ut1UTCState_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Eop_Ingest_ut1UTCState_Enum.I; } }
  ...
  /// Example: /// Example: I
  /// Constraints: Minimum length = 0, Maximum length = 1
  public Eop_Ingest_nutationState_Enum NutationState { get { int o = __p.__offset(30); return o != 0 ? (Eop_Ingest_nutationState_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Eop_Ingest_nutationState_Enum.I; } }
  ...
  public Eop_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(70); return o != 0 ? (Eop_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : Eop_Ingest_dataMode_Enum.REAL; } }
  ...
  public static Offset<Eop_Ingest> CreateEop_Ingest(FlatBufferBuilder builder,
      StringOffset idOffset = default(StringOffset),
      StringOffset classificationMarkingOffset = default(StringOffset),
      StringOffset eopDateOffset = default(StringOffset),
      Eop_Ingest_polarMotionState_Enum polarMotionState = Eop_Ingest_polarMotionState_Enum.I,
      double polarMotionX = 0.0,
      double polarMotionXUnc = 0.0,
      double polarMotionY = 0.0,
      double polarMotionYUnc = 0.0,
      Eop_Ingest_ut1UTCState_Enum ut1UTCState = Eop_Ingest_ut1UTCState_Enum.I,
      double ut1UTC = 0.0,
      double ut1UTCUnc = 0.0,
      double lod = 0.0,
      double lodUnc = 0.0,
      Eop_Ingest_nutationState_Enum nutationState = Eop_Ingest_nutationState_Enum.I,
      double dPSI = 0.0,
      double dPSIUnc = 0.0,
      double dEpsilon = 0.0,
      ...
      Eop_Ingest_dataMode_Enum dataMode = Eop_Ingest_dataMode_Enum.REAL,
  ...
  public static void AddPolarMotionState(FlatBufferBuilder builder, Eop_Ingest_polarMotionState_Enum polarMotionState) { builder.AddSbyte(3, (sbyte)polarMotionState, 0); }
  ...
  public static void AddUt1UTCState(FlatBufferBuilder builder, Eop_Ingest_ut1UTCState_Enum ut1UTCState) { builder.AddSbyte(8, (sbyte)ut1UTCState, 0); }
  ...
  public static void AddNutationState(FlatBufferBuilder builder, Eop_Ingest_nutationState_Enum nutationState) { builder.AddSbyte(13, (sbyte)nutationState, 0); }
  ...
  public static void AddDataMode(FlatBufferBuilder builder, Eop_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(33, (sbyte)dataMode, 0); }
  ...
  public static Offset<Eop_Ingest> EndEop_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Eop_Ingest>(o);
  }
  public static void FinishEop_IngestBuffer(FlatBufferBuilder builder, Offset<Eop_Ingest> offset) { builder.Finish(offset.Value, "EOPI"); }
  public static void FinishSizePrefixedEop_IngestBuffer(FlatBufferBuilder builder, Offset<Eop_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "EOPI"); }
  public Eop_IngestT UnPack() {
    var _o = new Eop_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(Eop_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<Eop_Ingest> Pack(FlatBufferBuilder builder, Eop_IngestT _o) {
    if (_o == null) return default(Offset<Eop_Ingest>);
...
public class Eop_IngestT
{
  public string Id { get; set; }
  public string ClassificationMarking { get; set; }
  public string EopDate { get; set; }
  public Eop_Ingest_polarMotionState_Enum PolarMotionState { get; set; }
  ...
  public Eop_Ingest_ut1UTCState_Enum Ut1UTCState { get; set; }
  public double Ut1UTC { get; set; }
  public double Ut1UTCUnc { get; set; }
  public double Lod { get; set; }
  public double LodUnc { get; set; }
  public Eop_Ingest_nutationState_Enum NutationState { get; set; }
  ...
  public Eop_Ingest_dataMode_Enum DataMode { get; set; }
  ...
  public Eop_IngestT() {
    ...
    this.EopDate = null;
    this.PolarMotionState = Eop_Ingest_polarMotionState_Enum.I;
    this.PolarMotionX = 0.0;
    this.PolarMotionXUnc = 0.0;
    this.PolarMotionY = 0.0;
    this.PolarMotionYUnc = 0.0;
    this.Ut1UTCState = Eop_Ingest_ut1UTCState_Enum.I;
    this.Ut1UTC = 0.0;
    this.Ut1UTCUnc = 0.0;
    this.Lod = 0.0;
    this.LodUnc = 0.0;
    this.NutationState = Eop_Ingest_nutationState_Enum.I;
    this.DPSI = 0.0;
    this.DPSIUnc = 0.0;
    this.DEpsilon = 0.0;
    ...
    this.Source = null;
    this.Origin = null;
    this.DataMode = Eop_Ingest_dataMode_Enum.REAL;
    this.CreatedAt = null;
    this.CreatedBy = null;
    this.OrigNetwork = null;
  }
  public static Eop_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return Eop_Ingest.GetRootAsEop_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Eop_Ingest.FinishEop_IngestBuffer(fbb, Eop_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class Eop_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 10 /*PolarMotionState*/, 1 /*Eop_Ingest_polarMotionState_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 20 /*Ut1UTCState*/, 1 /*Eop_Ingest_ut1UTCState_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 30 /*NutationState*/, 1 /*Eop_Ingest_nutationState_Enum*/, 1, false)
      ...
      && verifier.VerifyField(tablePos, 70 /*DataMode*/, 1 /*Eop_Ingest_dataMode_Enum*/, 1, false)
