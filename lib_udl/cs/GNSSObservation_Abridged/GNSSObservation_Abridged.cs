...
public struct GNSSObservation_Abridged : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static GNSSObservation_Abridged GetRootAsGNSSObservation_Abridged(ByteBuffer _bb) { return GetRootAsGNSSObservation_Abridged(_bb, new GNSSObservation_Abridged()); }
  public static GNSSObservation_Abridged GetRootAsGNSSObservation_Abridged(ByteBuffer _bb, GNSSObservation_Abridged obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool GNSSObservation_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "GNSS"); }
  public static bool VerifyGNSSObservation_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("GNSS", false, GNSSObservation_AbridgedVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public GNSSObservation_Abridged __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<GNSSObservation_Abridged> CreateGNSSObservation_Abridged(FlatBufferBuilder builder,
  ...
  public static void StartGNSSObservation_Abridged(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<GNSSObservation_Abridged> EndGNSSObservation_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<GNSSObservation_Abridged>(o);
  }
  public static void FinishGNSSObservation_AbridgedBuffer(FlatBufferBuilder builder, Offset<GNSSObservation_Abridged> offset) { builder.Finish(offset.Value, "GNSS"); }
  public static void FinishSizePrefixedGNSSObservation_AbridgedBuffer(FlatBufferBuilder builder, Offset<GNSSObservation_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "GNSS"); }
  public GNSSObservation_AbridgedT UnPack() {
    var _o = new GNSSObservation_AbridgedT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(GNSSObservation_AbridgedT _o) {
  ...
  public static Offset<GNSSObservation_Abridged> Pack(FlatBufferBuilder builder, GNSSObservation_AbridgedT _o) {
    if (_o == null) return default(Offset<GNSSObservation_Abridged>);
    ...
    return CreateGNSSObservation_Abridged(
      builder,
      _gnssSatId,
      _o.TrackingStatus,
      _o.AgcState,
...
public class GNSSObservation_AbridgedT
{
  ...
  public GNSSObservation_AbridgedT() {
    this.GnssSatId = null;
  ...
  public static GNSSObservation_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return GNSSObservation_Abridged.GetRootAsGNSSObservation_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    GNSSObservation_Abridged.FinishGNSSObservation_AbridgedBuffer(fbb, GNSSObservation_Abridged.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class GNSSObservation_AbridgedVerify
{
