...
public struct Organization_Abridged : IFlatbufferObject
{
  ...
  public static bool Organization_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "ORGA"); }
  public static bool VerifyOrganization_Abridged(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("ORGA", false, Organization_AbridgedVerify.Verify); }
  ...
  public static Offset<Organization_Abridged> CreateOrganization_Abridged(FlatBufferBuilder builder,
  ...
  public static Offset<Organization_Abridged> EndOrganization_Abridged(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Organization_Abridged>(o);
  }
  public static void FinishOrganization_AbridgedBuffer(FlatBufferBuilder builder, Offset<Organization_Abridged> offset) { builder.Finish(offset.Value, "ORGA"); }
  public static void FinishSizePrefixedOrganization_AbridgedBuffer(FlatBufferBuilder builder, Offset<Organization_Abridged> offset) { builder.FinishSizePrefixed(offset.Value, "ORGA"); }
  ...
  public static Offset<Organization_Abridged> Pack(FlatBufferBuilder builder, Organization_AbridgedT _o) {
    if (_o == null) return default(Offset<Organization_Abridged>);
...
public class Organization_AbridgedT
{
  ...
  public static Organization_AbridgedT DeserializeFromBinary(byte[] fbBuffer) {
    return Organization_Abridged.GetRootAsOrganization_Abridged(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    Organization_Abridged.FinishOrganization_AbridgedBuffer(fbb, Organization_Abridged.Pack(fbb, this));
