...
public struct IonoObservationAmplitude_Full : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static IonoObservationAmplitude_Full GetRootAsIonoObservationAmplitude_Full(ByteBuffer _bb) { return GetRootAsIonoObservationAmplitude_Full(_bb, new IonoObservationAmplitude_Full()); }
  public static IonoObservationAmplitude_Full GetRootAsIonoObservationAmplitude_Full(ByteBuffer _bb, IonoObservationAmplitude_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IonoObservationAmplitude_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "IONO"); }
  public static bool VerifyIonoObservationAmplitude_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("IONO", false, IonoObservationAmplitude_FullVerify.Verify); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public IonoObservationAmplitude_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<IonoObservationAmplitude_Full> CreateIonoObservationAmplitude_Full(FlatBufferBuilder builder,
  ...
  public static void StartIonoObservationAmplitude_Full(FlatBufferBuilder builder) { builder.StartTable(4); }
  ...
  public static Offset<IonoObservationAmplitude_Full> EndIonoObservationAmplitude_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IonoObservationAmplitude_Full>(o);
  }
  public static void FinishIonoObservationAmplitude_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationAmplitude_Full> offset) { builder.Finish(offset.Value, "IONO"); }
  public static void FinishSizePrefixedIonoObservationAmplitude_FullBuffer(FlatBufferBuilder builder, Offset<IonoObservationAmplitude_Full> offset) { builder.FinishSizePrefixed(offset.Value, "IONO"); }
  public IonoObservationAmplitude_FullT UnPack() {
    var _o = new IonoObservationAmplitude_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IonoObservationAmplitude_FullT _o) {
    _o.Notes = this.Notes;
  ...
  public static Offset<IonoObservationAmplitude_Full> Pack(FlatBufferBuilder builder, IonoObservationAmplitude_FullT _o) {
    if (_o == null) return default(Offset<IonoObservationAmplitude_Full>);
    ...
    return CreateIonoObservationAmplitude_Full(
      builder,
      _notes,
      _dimensions,
      _dimensionName,
...
public class IonoObservationAmplitude_FullT
{
  ...
  public IonoObservationAmplitude_FullT() {
    this.Notes = null;
    this.Dimensions = null;
    this.DimensionName = null;
    this.Data = null;
  }
  public static IonoObservationAmplitude_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return IonoObservationAmplitude_Full.GetRootAsIonoObservationAmplitude_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IonoObservationAmplitude_Full.FinishIonoObservationAmplitude_FullBuffer(fbb, IonoObservationAmplitude_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IonoObservationAmplitude_FullVerify
{
