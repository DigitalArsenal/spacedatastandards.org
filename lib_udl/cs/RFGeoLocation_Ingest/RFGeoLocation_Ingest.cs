...
public struct RFGeoLocation_Ingest : IFlatbufferObject
{
  private Table __p;
  ...
  public static RFGeoLocation_Ingest GetRootAsRFGeoLocation_Ingest(ByteBuffer _bb, RFGeoLocation_Ingest obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool RFGeoLocation_IngestBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "RFGE"); }
  public static bool VerifyRFGeoLocation_Ingest(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("RFGE", false, RFGeoLocation_IngestVerify.Verify); }
  ...
  public RFGeoLocation_Ingest_dataMode_Enum DataMode { get { int o = __p.__offset(86); return o != 0 ? (RFGeoLocation_Ingest_dataMode_Enum)__p.bb.GetSbyte(o + __p.bb_pos) : RFGeoLocation_Ingest_dataMode_Enum.REAL; } }

  public static Offset<RFGeoLocation_Ingest> CreateRFGeoLocation_Ingest(FlatBufferBuilder builder,
      ...
      RFGeoLocation_Ingest_dataMode_Enum dataMode = RFGeoLocation_Ingest_dataMode_Enum.REAL) {
  ...
  public static void AddDataMode(FlatBufferBuilder builder, RFGeoLocation_Ingest_dataMode_Enum dataMode) { builder.AddSbyte(41, (sbyte)dataMode, 0); }
  public static Offset<RFGeoLocation_Ingest> EndRFGeoLocation_Ingest(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<RFGeoLocation_Ingest>(o);
  }
  public static void FinishRFGeoLocation_IngestBuffer(FlatBufferBuilder builder, Offset<RFGeoLocation_Ingest> offset) { builder.Finish(offset.Value, "RFGE"); }
  public static void FinishSizePrefixedRFGeoLocation_IngestBuffer(FlatBufferBuilder builder, Offset<RFGeoLocation_Ingest> offset) { builder.FinishSizePrefixed(offset.Value, "RFGE"); }
  public RFGeoLocation_IngestT UnPack() {
    var _o = new RFGeoLocation_IngestT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(RFGeoLocation_IngestT _o) {
    _o.Id = this.Id;
  ...
  public static Offset<RFGeoLocation_Ingest> Pack(FlatBufferBuilder builder, RFGeoLocation_IngestT _o) {
    if (_o == null) return default(Offset<RFGeoLocation_Ingest>);
...
public class RFGeoLocation_IngestT
{
  ...
  public RFGeoLocation_Ingest_dataMode_Enum DataMode { get; set; }

  public RFGeoLocation_IngestT() {
    this.Id = null;
    ...
    this.SourceDL = null;
    this.DataMode = RFGeoLocation_Ingest_dataMode_Enum.REAL;
  }
  public static RFGeoLocation_IngestT DeserializeFromBinary(byte[] fbBuffer) {
    return RFGeoLocation_Ingest.GetRootAsRFGeoLocation_Ingest(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    RFGeoLocation_Ingest.FinishRFGeoLocation_IngestBuffer(fbb, RFGeoLocation_Ingest.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class RFGeoLocation_IngestVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 86 /*DataMode*/, 1 /*RFGeoLocation_Ingest_dataMode_Enum*/, 1, false)
