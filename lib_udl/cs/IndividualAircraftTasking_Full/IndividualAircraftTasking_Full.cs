...
public struct IndividualAircraftTasking_Full : IFlatbufferObject
{
  private Table __p;
  ...
  public static IndividualAircraftTasking_Full GetRootAsIndividualAircraftTasking_Full(ByteBuffer _bb, IndividualAircraftTasking_Full obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public static bool IndividualAircraftTasking_FullBufferHasIdentifier(ByteBuffer _bb) { return Table.__has_identifier(_bb, "INDI"); }
  public static bool VerifyIndividualAircraftTasking_Full(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("INDI", false, IndividualAircraftTasking_FullVerify.Verify); }
  ...
  public static Offset<IndividualAircraftTasking_Full> CreateIndividualAircraftTasking_Full(FlatBufferBuilder builder,
      int numAcft = 0,
  ...
  public static Offset<IndividualAircraftTasking_Full> EndIndividualAircraftTasking_Full(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<IndividualAircraftTasking_Full>(o);
  }
  public static void FinishIndividualAircraftTasking_FullBuffer(FlatBufferBuilder builder, Offset<IndividualAircraftTasking_Full> offset) { builder.Finish(offset.Value, "INDI"); }
  public static void FinishSizePrefixedIndividualAircraftTasking_FullBuffer(FlatBufferBuilder builder, Offset<IndividualAircraftTasking_Full> offset) { builder.FinishSizePrefixed(offset.Value, "INDI"); }
  public IndividualAircraftTasking_FullT UnPack() {
    var _o = new IndividualAircraftTasking_FullT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(IndividualAircraftTasking_FullT _o) {
  ...
  public static Offset<IndividualAircraftTasking_Full> Pack(FlatBufferBuilder builder, IndividualAircraftTasking_FullT _o) {
    if (_o == null) return default(Offset<IndividualAircraftTasking_Full>);
...
public class IndividualAircraftTasking_FullT
{
  ...
  public IndividualAircraftTasking_FullT() {
    this.NumAcft = 0;
    this.AcftType = null;
    this.CallSign = null;
  ...
  public static IndividualAircraftTasking_FullT DeserializeFromBinary(byte[] fbBuffer) {
    return IndividualAircraftTasking_Full.GetRootAsIndividualAircraftTasking_Full(new ByteBuffer(fbBuffer)).UnPack();
  }
  public byte[] SerializeToBinary() {
    var fbb = new FlatBufferBuilder(0x10000);
    IndividualAircraftTasking_Full.FinishIndividualAircraftTasking_FullBuffer(fbb, IndividualAircraftTasking_Full.Pack(fbb, this));
    return fbb.DataBuffer.ToSizedArray();
  }
}


static public class IndividualAircraftTasking_FullVerify
{
