...
struct TrackRoute_Abridged;
struct TrackRoute_AbridgedBuilder;

enum TrackRoute_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  TrackRoute_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  TrackRoute_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  TrackRoute_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  TrackRoute_Abridged_dataMode_Enum_EXERCISE = 3,
  TrackRoute_Abridged_dataMode_Enum_MIN = TrackRoute_Abridged_dataMode_Enum_REAL,
  TrackRoute_Abridged_dataMode_Enum_MAX = TrackRoute_Abridged_dataMode_Enum_EXERCISE
};

inline const TrackRoute_Abridged_dataMode_Enum (&EnumValuesTrackRoute_Abridged_dataMode_Enum())[4] {
  static const TrackRoute_Abridged_dataMode_Enum values[] = {
    TrackRoute_Abridged_dataMode_Enum_REAL,
    TrackRoute_Abridged_dataMode_Enum_TEST,
    TrackRoute_Abridged_dataMode_Enum_SIMULATED,
    TrackRoute_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesTrackRoute_Abridged_dataMode_Enum() {
...
inline const char *EnumNameTrackRoute_Abridged_dataMode_Enum(TrackRoute_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, TrackRoute_Abridged_dataMode_Enum_REAL, TrackRoute_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesTrackRoute_Abridged_dataMode_Enum()[index];
}

/// /// A track route is a prescribed route for performing training events or operations such as air refueling.
struct TrackRoute_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef TrackRoute_AbridgedBuilder Builder;
  ...
  TrackRoute_Abridged_dataMode_Enum dataMode() const {
    return static_cast<TrackRoute_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct TrackRoute_AbridgedBuilder {
  typedef TrackRoute_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_TYPE, type);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_EXTERNALID, externalId);
  }
  void add_direction(::flatbuffers::Offset<::flatbuffers::String> direction) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_DIRECTION, direction);
  }
  void add_creatingOrg(::flatbuffers::Offset<::flatbuffers::String> creatingOrg) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_CREATINGORG, creatingOrg);
  }
  void add_locationTrackId(::flatbuffers::Offset<::flatbuffers::String> locationTrackId) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_LOCATIONTRACKID, locationTrackId);
  }
  void add_trackId(::flatbuffers::Offset<::flatbuffers::String> trackId) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_TRACKID, trackId);
  }
  void add_trackName(::flatbuffers::Offset<::flatbuffers::String> trackName) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_TRACKNAME, trackName);
  }
  void add_shortName(::flatbuffers::Offset<::flatbuffers::String> shortName) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_SHORTNAME, shortName);
  }
  void add_typeCode(::flatbuffers::Offset<::flatbuffers::String> typeCode) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_TYPECODE, typeCode);
  }
  void add_regionCode(::flatbuffers::Offset<::flatbuffers::String> regionCode) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_REGIONCODE, regionCode);
  }
  void add_regionName(::flatbuffers::Offset<::flatbuffers::String> regionName) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_REGIONNAME, regionName);
  }
  void add_apxBeaconCode(::flatbuffers::Offset<::flatbuffers::String> apxBeaconCode) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_APXBEACONCODE, apxBeaconCode);
  }
  void add_receiverTankerCHCode(::flatbuffers::Offset<::flatbuffers::String> receiverTankerCHCode) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_RECEIVERTANKERCHCODE, receiverTankerCHCode);
  }
  void add_apnSetting(::flatbuffers::Offset<::flatbuffers::String> apnSetting) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_APNSETTING, apnSetting);
  }
  void add_sic(::flatbuffers::Offset<::flatbuffers::String> sic) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_SIC, sic);
  }
  void add_reviewDate(::flatbuffers::Offset<::flatbuffers::String> reviewDate) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_REVIEWDATE, reviewDate);
  }
  void add_lastUsedDate(::flatbuffers::Offset<::flatbuffers::String> lastUsedDate) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_LASTUSEDDATE, lastUsedDate);
  }
  void add_lastUpdateDate(::flatbuffers::Offset<::flatbuffers::String> lastUpdateDate) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_LASTUPDATEDATE, lastUpdateDate);
  }
  void add_priFreq(double priFreq) {
    fbb_.AddElement<double>(TrackRoute_Abridged::VT_PRIFREQ, priFreq, 0.0);
  }
  void add_secFreq(double secFreq) {
    fbb_.AddElement<double>(TrackRoute_Abridged::VT_SECFREQ, secFreq, 0.0);
  }
  void add_artccMessage(::flatbuffers::Offset<::flatbuffers::String> artccMessage) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_ARTCCMESSAGE, artccMessage);
  }
  void add_schedulerOrgName(::flatbuffers::Offset<::flatbuffers::String> schedulerOrgName) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_SCHEDULERORGNAME, schedulerOrgName);
  }
  void add_schedulerOrgUnit(::flatbuffers::Offset<::flatbuffers::String> schedulerOrgUnit) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_SCHEDULERORGUNIT, schedulerOrgUnit);
  }
  void add_effectiveDate(::flatbuffers::Offset<::flatbuffers::String> effectiveDate) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_EFFECTIVEDATE, effectiveDate);
  }
  void add_routePoints(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> routePoints) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_ROUTEPOINTS, routePoints);
  }
  void add_altitudeBlocks(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> altitudeBlocks) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_ALTITUDEBLOCKS, altitudeBlocks);
  }
  void add_poc(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> poc) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_POC, poc);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_UPDATEDBY, updatedBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(TrackRoute_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(TrackRoute_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(TrackRoute_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit TrackRoute_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<TrackRoute_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<TrackRoute_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<TrackRoute_Abridged> CreateTrackRoute_Abridged(
    ...
    TrackRoute_Abridged_dataMode_Enum dataMode = TrackRoute_Abridged_dataMode_Enum_REAL) {
  TrackRoute_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<TrackRoute_Abridged> CreateTrackRoute_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateTrackRoute_Abridged(
      _fbb,
      id__,
...
inline const TrackRoute_Abridged *GetTrackRoute_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<TrackRoute_Abridged>(buf);
}

inline const TrackRoute_Abridged *GetSizePrefixedTrackRoute_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<TrackRoute_Abridged>(buf);
}

inline const char *TrackRoute_AbridgedIdentifier() {
  return "TRAC";
}

inline bool TrackRoute_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, TrackRoute_AbridgedIdentifier());
}

inline bool SizePrefixedTrackRoute_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, TrackRoute_AbridgedIdentifier(), true);
}

inline bool VerifyTrackRoute_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<TrackRoute_Abridged>(TrackRoute_AbridgedIdentifier());
}

inline bool VerifySizePrefixedTrackRoute_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<TrackRoute_Abridged>(TrackRoute_AbridgedIdentifier());
}

inline void FinishTrackRoute_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<TrackRoute_Abridged> root) {
  fbb.Finish(root, TrackRoute_AbridgedIdentifier());
}

inline void FinishSizePrefixedTrackRoute_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<TrackRoute_Abridged> root) {
  fbb.FinishSizePrefixed(root, TrackRoute_AbridgedIdentifier());
}
