...
enum Location_dataMode_Enum : int8_t {
  ...
  Location_dataMode_Enum_MIN = Location_dataMode_Enum_REAL,
  Location_dataMode_Enum_MAX = Location_dataMode_Enum_EXERCISE
};

inline const Location_dataMode_Enum (&EnumValuesLocation_dataMode_Enum())[4] {
  static const Location_dataMode_Enum values[] = {
    Location_dataMode_Enum_REAL,
    Location_dataMode_Enum_TEST,
    Location_dataMode_Enum_SIMULATED,
    Location_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesLocation_dataMode_Enum() {
...
inline const char *EnumNameLocation_dataMode_Enum(Location_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Location_dataMode_Enum_REAL, Location_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesLocation_dataMode_Enum()[index];
}
...
struct Location FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  Location_dataMode_Enum dataMode() const {
    return static_cast<Location_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct LocationBuilder {
  ...
  void add_idLocation(::flatbuffers::Offset<::flatbuffers::String> idLocation) {
    fbb_.AddOffset(Location::VT_IDLOCATION, idLocation);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Location::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(Location::VT_NAME, name);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(Location::VT_COUNTRYCODE, countryCode);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(Location::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(Location::VT_LON, lon, 0.0);
  }
  void add_altitude(double altitude) {
    fbb_.AddElement<double>(Location::VT_ALTITUDE, altitude, 0.0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Location::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Location::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(Location::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(Location::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Location::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Location::VT_ORIGIN, origin);
  }
  void add_dataMode(Location_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Location::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Location::VT_ORIGNETWORK, origNetwork);
  }
...
inline ::flatbuffers::Offset<Location> CreateLocation(
    ...
    Location_dataMode_Enum dataMode = Location_dataMode_Enum_REAL,
...
inline const Location *GetLocation(const void *buf) {
  return ::flatbuffers::GetRoot<Location>(buf);
}

inline const Location *GetSizePrefixedLocation(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Location>(buf);
}

inline const char *LocationIdentifier() {
  return "LOCA";
}

inline bool LocationBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LocationIdentifier());
}

inline bool SizePrefixedLocationBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LocationIdentifier(), true);
}

inline bool VerifyLocationBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Location>(LocationIdentifier());
}

inline bool VerifySizePrefixedLocationBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Location>(LocationIdentifier());
}

inline void FinishLocationBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Location> root) {
  fbb.Finish(root, LocationIdentifier());
}

inline void FinishSizePrefixedLocationBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Location> root) {
  fbb.FinishSizePrefixed(root, LocationIdentifier());
}
