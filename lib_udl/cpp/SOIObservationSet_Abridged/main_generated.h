...
struct SOIObservationSet_Abridged;
struct SOIObservationSet_AbridgedBuilder;

enum SOIObservationSet_Abridged_type_Enum : int8_t {
  /// No description available.
  SOIObservationSet_Abridged_type_Enum_OPTICAL = 0,
  /// No description available.
  SOIObservationSet_Abridged_type_Enum_RADAR = 1,
  SOIObservationSet_Abridged_type_Enum_MIN = SOIObservationSet_Abridged_type_Enum_OPTICAL,
  SOIObservationSet_Abridged_type_Enum_MAX = SOIObservationSet_Abridged_type_Enum_RADAR
};

inline const SOIObservationSet_Abridged_type_Enum (&EnumValuesSOIObservationSet_Abridged_type_Enum())[2] {
  static const SOIObservationSet_Abridged_type_Enum values[] = {
    SOIObservationSet_Abridged_type_Enum_OPTICAL,
    SOIObservationSet_Abridged_type_Enum_RADAR
  };
  return values;
}

inline const char * const *EnumNamesSOIObservationSet_Abridged_type_Enum() {
...
inline const char *EnumNameSOIObservationSet_Abridged_type_Enum(SOIObservationSet_Abridged_type_Enum e) {
  if (::flatbuffers::IsOutRange(e, SOIObservationSet_Abridged_type_Enum_OPTICAL, SOIObservationSet_Abridged_type_Enum_RADAR)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSOIObservationSet_Abridged_type_Enum()[index];
}

enum SOIObservationSet_Abridged_referenceFrame_Enum : int8_t {
  /// No description available.
  SOIObservationSet_Abridged_referenceFrame_Enum_J2000 = 0,
  /// No description available.
  SOIObservationSet_Abridged_referenceFrame_Enum_EFG_TDR = 1,
  /// No description available.
  SOIObservationSet_Abridged_referenceFrame_Enum_ECR_ECEF = 2,
  /// No description available.
  SOIObservationSet_Abridged_referenceFrame_Enum_TEME = 3,
  /// No description available.
  SOIObservationSet_Abridged_referenceFrame_Enum_ITRF = 4,
  /// No description available.
  SOIObservationSet_Abridged_referenceFrame_Enum_GCRF = 5,
  SOIObservationSet_Abridged_referenceFrame_Enum_MIN = SOIObservationSet_Abridged_referenceFrame_Enum_J2000,
  SOIObservationSet_Abridged_referenceFrame_Enum_MAX = SOIObservationSet_Abridged_referenceFrame_Enum_GCRF
};

inline const SOIObservationSet_Abridged_referenceFrame_Enum (&EnumValuesSOIObservationSet_Abridged_referenceFrame_Enum())[6] {
  static const SOIObservationSet_Abridged_referenceFrame_Enum values[] = {
    SOIObservationSet_Abridged_referenceFrame_Enum_J2000,
    SOIObservationSet_Abridged_referenceFrame_Enum_EFG_TDR,
    SOIObservationSet_Abridged_referenceFrame_Enum_ECR_ECEF,
    SOIObservationSet_Abridged_referenceFrame_Enum_TEME,
    SOIObservationSet_Abridged_referenceFrame_Enum_ITRF,
    SOIObservationSet_Abridged_referenceFrame_Enum_GCRF
  };
  return values;
}

inline const char * const *EnumNamesSOIObservationSet_Abridged_referenceFrame_Enum() {
...
inline const char *EnumNameSOIObservationSet_Abridged_referenceFrame_Enum(SOIObservationSet_Abridged_referenceFrame_Enum e) {
  if (::flatbuffers::IsOutRange(e, SOIObservationSet_Abridged_referenceFrame_Enum_J2000, SOIObservationSet_Abridged_referenceFrame_Enum_GCRF)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSOIObservationSet_Abridged_referenceFrame_Enum()[index];
}

enum SOIObservationSet_Abridged_senReferenceFrame_Enum : int8_t {
  /// No description available.
  SOIObservationSet_Abridged_senReferenceFrame_Enum_J2000 = 0,
  /// No description available.
  SOIObservationSet_Abridged_senReferenceFrame_Enum_EFG_TDR = 1,
  /// No description available.
  SOIObservationSet_Abridged_senReferenceFrame_Enum_ECR_ECEF = 2,
  /// No description available.
  SOIObservationSet_Abridged_senReferenceFrame_Enum_TEME = 3,
  /// No description available.
  SOIObservationSet_Abridged_senReferenceFrame_Enum_ITRF = 4,
  /// No description available.
  SOIObservationSet_Abridged_senReferenceFrame_Enum_GCRF = 5,
  SOIObservationSet_Abridged_senReferenceFrame_Enum_MIN = SOIObservationSet_Abridged_senReferenceFrame_Enum_J2000,
  SOIObservationSet_Abridged_senReferenceFrame_Enum_MAX = SOIObservationSet_Abridged_senReferenceFrame_Enum_GCRF
};

inline const SOIObservationSet_Abridged_senReferenceFrame_Enum (&EnumValuesSOIObservationSet_Abridged_senReferenceFrame_Enum())[6] {
  static const SOIObservationSet_Abridged_senReferenceFrame_Enum values[] = {
    SOIObservationSet_Abridged_senReferenceFrame_Enum_J2000,
    SOIObservationSet_Abridged_senReferenceFrame_Enum_EFG_TDR,
    SOIObservationSet_Abridged_senReferenceFrame_Enum_ECR_ECEF,
    SOIObservationSet_Abridged_senReferenceFrame_Enum_TEME,
    SOIObservationSet_Abridged_senReferenceFrame_Enum_ITRF,
    SOIObservationSet_Abridged_senReferenceFrame_Enum_GCRF
  };
  return values;
}

inline const char * const *EnumNamesSOIObservationSet_Abridged_senReferenceFrame_Enum() {
  static const char * const names[7] = {
    "J2000",
    "EFG_TDR",
    "ECR_ECEF",
...
inline const char *EnumNameSOIObservationSet_Abridged_senReferenceFrame_Enum(SOIObservationSet_Abridged_senReferenceFrame_Enum e) {
  if (::flatbuffers::IsOutRange(e, SOIObservationSet_Abridged_senReferenceFrame_Enum_J2000, SOIObservationSet_Abridged_senReferenceFrame_Enum_GCRF)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSOIObservationSet_Abridged_senReferenceFrame_Enum()[index];
}

enum SOIObservationSet_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  SOIObservationSet_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  SOIObservationSet_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  SOIObservationSet_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  SOIObservationSet_Abridged_dataMode_Enum_EXERCISE = 3,
  SOIObservationSet_Abridged_dataMode_Enum_MIN = SOIObservationSet_Abridged_dataMode_Enum_REAL,
  SOIObservationSet_Abridged_dataMode_Enum_MAX = SOIObservationSet_Abridged_dataMode_Enum_EXERCISE
};

inline const SOIObservationSet_Abridged_dataMode_Enum (&EnumValuesSOIObservationSet_Abridged_dataMode_Enum())[4] {
  static const SOIObservationSet_Abridged_dataMode_Enum values[] = {
    SOIObservationSet_Abridged_dataMode_Enum_REAL,
    SOIObservationSet_Abridged_dataMode_Enum_TEST,
    SOIObservationSet_Abridged_dataMode_Enum_SIMULATED,
    SOIObservationSet_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSOIObservationSet_Abridged_dataMode_Enum() {
...
inline const char *EnumNameSOIObservationSet_Abridged_dataMode_Enum(SOIObservationSet_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SOIObservationSet_Abridged_dataMode_Enum_REAL, SOIObservationSet_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSOIObservationSet_Abridged_dataMode_Enum()[index];
}

/// /// These services provide operations for posting space object idenfification observation sets.
struct SOIObservationSet_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SOIObservationSet_AbridgedBuilder Builder;
  ...
  SOIObservationSet_Abridged_type_Enum type() const {
    return static_cast<SOIObservationSet_Abridged_type_Enum>(GetField<int8_t>(VT_TYPE, 0));
  }
  ...
  SOIObservationSet_Abridged_referenceFrame_Enum referenceFrame() const {
    return static_cast<SOIObservationSet_Abridged_referenceFrame_Enum>(GetField<int8_t>(VT_REFERENCEFRAME, 0));
  }
  /// The reference frame of the observing sensor state. If the senReferenceFrame is null it is assumed to be J2000.
  /// Example: /// Example: J2000
  /// Constraints: Minimum length = 0, Maximum length = 24
  SOIObservationSet_Abridged_senReferenceFrame_Enum senReferenceFrame() const {
    return static_cast<SOIObservationSet_Abridged_senReferenceFrame_Enum>(GetField<int8_t>(VT_SENREFERENCEFRAME, 0));
  }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SOIObservationSet_Abridged_dataMode_Enum dataMode() const {
    return static_cast<SOIObservationSet_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SOIObservationSet_AbridgedBuilder {
  typedef SOIObservationSet_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_msgCreateDate(::flatbuffers::Offset<::flatbuffers::String> msgCreateDate) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_MSGCREATEDATE, msgCreateDate);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_ORIGSENSORID, origSensorId);
  }
  void add_sensorAsId(::flatbuffers::Offset<::flatbuffers::String> sensorAsId) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_SENSORASID, sensorAsId);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(SOIObservationSet_Abridged::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_ORIGOBJECTID, origObjectId);
  }
  void add_senlat(double senlat) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_SENLAT, senlat, 0.0);
  }
  void add_senlon(double senlon) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_SENLON, senlon, 0.0);
  }
  void add_senalt(double senalt) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_SENALT, senalt, 0.0);
  }
  void add_senx(double senx) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_SENX, senx, 0.0);
  }
  void add_seny(double seny) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_SENY, seny, 0.0);
  }
  void add_senz(double senz) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_SENZ, senz, 0.0);
  }
  void add_senvelx(double senvelx) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_SENVELX, senvelx, 0.0);
  }
  void add_senvely(double senvely) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_SENVELY, senvely, 0.0);
  }
  void add_senvelz(double senvelz) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_SENVELZ, senvelz, 0.0);
  }
  void add_idElset(::flatbuffers::Offset<::flatbuffers::String> idElset) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_IDELSET, idElset);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_ENDTIME, endTime);
  }
  void add_numObs(int32_t numObs) {
    fbb_.AddElement<int32_t>(SOIObservationSet_Abridged::VT_NUMOBS, numObs, 0);
  }
  void add_type(SOIObservationSet_Abridged_type_Enum type) {
    fbb_.AddElement<int8_t>(SOIObservationSet_Abridged::VT_TYPE, static_cast<int8_t>(type), 0);
  }
  void add_polarAngleStart(double polarAngleStart) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_POLARANGLESTART, polarAngleStart, 0.0);
  }
  void add_polarAngleEnd(double polarAngleEnd) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_POLARANGLEEND, polarAngleEnd, 0.0);
  }
  void add_referenceFrame(SOIObservationSet_Abridged_referenceFrame_Enum referenceFrame) {
    fbb_.AddElement<int8_t>(SOIObservationSet_Abridged::VT_REFERENCEFRAME, static_cast<int8_t>(referenceFrame), 0);
  }
  void add_senReferenceFrame(SOIObservationSet_Abridged_senReferenceFrame_Enum senReferenceFrame) {
    fbb_.AddElement<int8_t>(SOIObservationSet_Abridged::VT_SENREFERENCEFRAME, static_cast<int8_t>(senReferenceFrame), 0);
  }
  void add_losDeclinationStart(double losDeclinationStart) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_LOSDECLINATIONSTART, losDeclinationStart, 0.0);
  }
  void add_losDeclinationEnd(double losDeclinationEnd) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_LOSDECLINATIONEND, losDeclinationEnd, 0.0);
  }
  void add_pointingAngleAzStart(double pointingAngleAzStart) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_POINTINGANGLEAZSTART, pointingAngleAzStart, 0.0);
  }
  void add_pointingAngleAzEnd(double pointingAngleAzEnd) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_POINTINGANGLEAZEND, pointingAngleAzEnd, 0.0);
  }
  void add_pointingAngleElStart(double pointingAngleElStart) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_POINTINGANGLEELSTART, pointingAngleElStart, 0.0);
  }
  void add_pointingAngleElEnd(double pointingAngleElEnd) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_POINTINGANGLEELEND, pointingAngleElEnd, 0.0);
  }
  void add_pixelArrayWidth(int32_t pixelArrayWidth) {
    fbb_.AddElement<int32_t>(SOIObservationSet_Abridged::VT_PIXELARRAYWIDTH, pixelArrayWidth, 0);
  }
  void add_pixelArrayHeight(int32_t pixelArrayHeight) {
    fbb_.AddElement<int32_t>(SOIObservationSet_Abridged::VT_PIXELARRAYHEIGHT, pixelArrayHeight, 0);
  }
  void add_numSpectralFilters(int32_t numSpectralFilters) {
    fbb_.AddElement<int32_t>(SOIObservationSet_Abridged::VT_NUMSPECTRALFILTERS, numSpectralFilters, 0);
  }
  void add_spectralFilters(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> spectralFilters) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_SPECTRALFILTERS, spectralFilters);
  }
  void add_collectionMode(::flatbuffers::Offset<::flatbuffers::String> collectionMode) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_COLLECTIONMODE, collectionMode);
  }
  void add_gain(double gain) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_GAIN, gain, 0.0);
  }
  void add_binningHoriz(int32_t binningHoriz) {
    fbb_.AddElement<int32_t>(SOIObservationSet_Abridged::VT_BINNINGHORIZ, binningHoriz, 0);
  }
  void add_binningVert(int32_t binningVert) {
    fbb_.AddElement<int32_t>(SOIObservationSet_Abridged::VT_BINNINGVERT, binningVert, 0);
  }
  void add_solarMag(double solarMag) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_SOLARMAG, solarMag, 0.0);
  }
  void add_pixelMin(int32_t pixelMin) {
    fbb_.AddElement<int32_t>(SOIObservationSet_Abridged::VT_PIXELMIN, pixelMin, 0);
  }
  void add_pixelMax(int32_t pixelMax) {
    fbb_.AddElement<int32_t>(SOIObservationSet_Abridged::VT_PIXELMAX, pixelMax, 0);
  }
  void add_softwareVersion(::flatbuffers::Offset<::flatbuffers::String> softwareVersion) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_SOFTWAREVERSION, softwareVersion);
  }
  void add_satelliteName(::flatbuffers::Offset<::flatbuffers::String> satelliteName) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_SATELLITENAME, satelliteName);
  }
  void add_starCatName(::flatbuffers::Offset<::flatbuffers::String> starCatName) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_STARCATNAME, starCatName);
  }
  void add_corrQuality(double corrQuality) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_CORRQUALITY, corrQuality, 0.0);
  }
  void add_uct(bool uct) {
    fbb_.AddElement<uint8_t>(SOIObservationSet_Abridged::VT_UCT, static_cast<uint8_t>(uct), 0);
  }
  void add_validCalibrations(::flatbuffers::Offset<::flatbuffers::String> validCalibrations) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_VALIDCALIBRATIONS, validCalibrations);
  }
  void add_calibrationType(::flatbuffers::Offset<::flatbuffers::String> calibrationType) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_CALIBRATIONTYPE, calibrationType);
  }
  void add_percentSatThreshold(double percentSatThreshold) {
    fbb_.AddElement<double>(SOIObservationSet_Abridged::VT_PERCENTSATTHRESHOLD, percentSatThreshold, 0.0);
  }
  void add_changeDetected(bool changeDetected) {
    fbb_.AddElement<uint8_t>(SOIObservationSet_Abridged::VT_CHANGEDETECTED, static_cast<uint8_t>(changeDetected), 0);
  }
  void add_periodicityChangeDetected(bool periodicityChangeDetected) {
    fbb_.AddElement<uint8_t>(SOIObservationSet_Abridged::VT_PERIODICITYCHANGEDETECTED, static_cast<uint8_t>(periodicityChangeDetected), 0);
  }
  void add_brightnessVarianceChangeDetected(bool brightnessVarianceChangeDetected) {
    fbb_.AddElement<uint8_t>(SOIObservationSet_Abridged::VT_BRIGHTNESSVARIANCECHANGEDETECTED, static_cast<uint8_t>(brightnessVarianceChangeDetected), 0);
  }
  void add_solarPhaseAngleBrightnessChangeDetected(bool solarPhaseAngleBrightnessChangeDetected) {
    fbb_.AddElement<uint8_t>(SOIObservationSet_Abridged::VT_SOLARPHASEANGLEBRIGHTNESSCHANGEDETECTED, static_cast<uint8_t>(solarPhaseAngleBrightnessChangeDetected), 0);
  }
  void add_changeConf(::flatbuffers::Offset<::flatbuffers::String> changeConf) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_CHANGECONF, changeConf);
  }
  void add_collectionDensityConf(::flatbuffers::Offset<::flatbuffers::String> collectionDensityConf) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_COLLECTIONDENSITYCONF, collectionDensityConf);
  }
  void add_periodicitySamplingConf(::flatbuffers::Offset<::flatbuffers::String> periodicitySamplingConf) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_PERIODICITYSAMPLINGCONF, periodicitySamplingConf);
  }
  void add_periodicityDetectionConf(::flatbuffers::Offset<::flatbuffers::String> periodicityDetectionConf) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_PERIODICITYDETECTIONCONF, periodicityDetectionConf);
  }
  void add_collectionId(::flatbuffers::Offset<::flatbuffers::String> collectionId) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_COLLECTIONID, collectionId);
  }
  void add_calibrations(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> calibrations) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_CALIBRATIONS, calibrations);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_TAGS, tags);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_TRANSACTIONID, transactionId);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(SOIObservationSet_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_dataMode(SOIObservationSet_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SOIObservationSet_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit SOIObservationSet_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SOIObservationSet_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SOIObservationSet_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SOIObservationSet_Abridged> CreateSOIObservationSet_Abridged(
    ...
    int32_t numObs = 0,
    SOIObservationSet_Abridged_type_Enum type = SOIObservationSet_Abridged_type_Enum_OPTICAL,
    double polarAngleStart = 0.0,
    double polarAngleEnd = 0.0,
    SOIObservationSet_Abridged_referenceFrame_Enum referenceFrame = SOIObservationSet_Abridged_referenceFrame_Enum_J2000,
    SOIObservationSet_Abridged_senReferenceFrame_Enum senReferenceFrame = SOIObservationSet_Abridged_senReferenceFrame_Enum_J2000,
    ...
    SOIObservationSet_Abridged_dataMode_Enum dataMode = SOIObservationSet_Abridged_dataMode_Enum_REAL) {
  SOIObservationSet_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SOIObservationSet_Abridged> CreateSOIObservationSet_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateSOIObservationSet_Abridged(
      _fbb,
      id__,
...
inline const SOIObservationSet_Abridged *GetSOIObservationSet_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<SOIObservationSet_Abridged>(buf);
}

inline const SOIObservationSet_Abridged *GetSizePrefixedSOIObservationSet_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SOIObservationSet_Abridged>(buf);
}

inline const char *SOIObservationSet_AbridgedIdentifier() {
  return "SOIO";
}

inline bool SOIObservationSet_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SOIObservationSet_AbridgedIdentifier());
}

inline bool SizePrefixedSOIObservationSet_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SOIObservationSet_AbridgedIdentifier(), true);
}

inline bool VerifySOIObservationSet_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SOIObservationSet_Abridged>(SOIObservationSet_AbridgedIdentifier());
}

inline bool VerifySizePrefixedSOIObservationSet_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SOIObservationSet_Abridged>(SOIObservationSet_AbridgedIdentifier());
}

inline void FinishSOIObservationSet_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SOIObservationSet_Abridged> root) {
  fbb.Finish(root, SOIObservationSet_AbridgedIdentifier());
}

inline void FinishSizePrefixedSOIObservationSet_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SOIObservationSet_Abridged> root) {
  fbb.FinishSizePrefixed(root, SOIObservationSet_AbridgedIdentifier());
}
