...
struct AircraftStatusRemark_Full;
struct AircraftStatusRemark_FullBuilder;

enum AircraftStatusRemark_Full_dataMode_Enum : int8_t {
  ...
  AircraftStatusRemark_Full_dataMode_Enum_MIN = AircraftStatusRemark_Full_dataMode_Enum_REAL,
  AircraftStatusRemark_Full_dataMode_Enum_MAX = AircraftStatusRemark_Full_dataMode_Enum_EXERCISE
};

inline const AircraftStatusRemark_Full_dataMode_Enum (&EnumValuesAircraftStatusRemark_Full_dataMode_Enum())[4] {
  static const AircraftStatusRemark_Full_dataMode_Enum values[] = {
    AircraftStatusRemark_Full_dataMode_Enum_REAL,
    AircraftStatusRemark_Full_dataMode_Enum_TEST,
    AircraftStatusRemark_Full_dataMode_Enum_SIMULATED,
    AircraftStatusRemark_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAircraftStatusRemark_Full_dataMode_Enum() {
...
inline const char *EnumNameAircraftStatusRemark_Full_dataMode_Enum(AircraftStatusRemark_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AircraftStatusRemark_Full_dataMode_Enum_REAL, AircraftStatusRemark_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAircraftStatusRemark_Full_dataMode_Enum()[index];
}

/// /// Properties and characteristics of a remark that is associated with an aircraft status.
struct AircraftStatusRemark_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AircraftStatusRemark_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  AircraftStatusRemark_Full_dataMode_Enum dataMode() const {
    return static_cast<AircraftStatusRemark_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AircraftStatusRemark_FullBuilder {
  typedef AircraftStatusRemark_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idAircraftStatus(::flatbuffers::Offset<::flatbuffers::String> idAircraftStatus) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_IDAIRCRAFTSTATUS, idAircraftStatus);
  }
  void add_altRmkId(::flatbuffers::Offset<::flatbuffers::String> altRmkId) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_ALTRMKID, altRmkId);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_NAME, name);
  }
  void add_text(::flatbuffers::Offset<::flatbuffers::String> text) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_TEXT, text);
  }
  void add_timestamp(::flatbuffers::Offset<::flatbuffers::String> timestamp) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_TIMESTAMP, timestamp);
  }
  void add_lastUpdatedBy(::flatbuffers::Offset<::flatbuffers::String> lastUpdatedBy) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_LASTUPDATEDBY, lastUpdatedBy);
  }
  void add_lastUpdatedAt(::flatbuffers::Offset<::flatbuffers::String> lastUpdatedAt) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_LASTUPDATEDAT, lastUpdatedAt);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AircraftStatusRemark_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(AircraftStatusRemark_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AircraftStatusRemark_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit AircraftStatusRemark_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AircraftStatusRemark_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AircraftStatusRemark_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AircraftStatusRemark_Full> CreateAircraftStatusRemark_Full(
    ...
    AircraftStatusRemark_Full_dataMode_Enum dataMode = AircraftStatusRemark_Full_dataMode_Enum_REAL) {
  AircraftStatusRemark_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AircraftStatusRemark_Full> CreateAircraftStatusRemark_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AircraftStatusRemark_Full *GetAircraftStatusRemark_Full(const void *buf) {
  return ::flatbuffers::GetRoot<AircraftStatusRemark_Full>(buf);
}

inline const AircraftStatusRemark_Full *GetSizePrefixedAircraftStatusRemark_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AircraftStatusRemark_Full>(buf);
}

inline const char *AircraftStatusRemark_FullIdentifier() {
  return "AIRC";
}

inline bool AircraftStatusRemark_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftStatusRemark_FullIdentifier());
}

inline bool SizePrefixedAircraftStatusRemark_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftStatusRemark_FullIdentifier(), true);
}

inline bool VerifyAircraftStatusRemark_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AircraftStatusRemark_Full>(AircraftStatusRemark_FullIdentifier());
}

inline bool VerifySizePrefixedAircraftStatusRemark_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AircraftStatusRemark_Full>(AircraftStatusRemark_FullIdentifier());
}

inline void FinishAircraftStatusRemark_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftStatusRemark_Full> root) {
  fbb.Finish(root, AircraftStatusRemark_FullIdentifier());
}

inline void FinishSizePrefixedAircraftStatusRemark_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftStatusRemark_Full> root) {
  fbb.FinishSizePrefixed(root, AircraftStatusRemark_FullIdentifier());
}
