...
struct MonoRadar_Ingest;
struct MonoRadar_IngestBuilder;

enum MonoRadar_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  MonoRadar_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  MonoRadar_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  MonoRadar_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  MonoRadar_Ingest_dataMode_Enum_EXERCISE = 3,
  MonoRadar_Ingest_dataMode_Enum_MIN = MonoRadar_Ingest_dataMode_Enum_REAL,
  MonoRadar_Ingest_dataMode_Enum_MAX = MonoRadar_Ingest_dataMode_Enum_EXERCISE
};

inline const MonoRadar_Ingest_dataMode_Enum (&EnumValuesMonoRadar_Ingest_dataMode_Enum())[4] {
  static const MonoRadar_Ingest_dataMode_Enum values[] = {
    MonoRadar_Ingest_dataMode_Enum_REAL,
    MonoRadar_Ingest_dataMode_Enum_TEST,
    MonoRadar_Ingest_dataMode_Enum_SIMULATED,
    MonoRadar_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesMonoRadar_Ingest_dataMode_Enum() {
...
inline const char *EnumNameMonoRadar_Ingest_dataMode_Enum(MonoRadar_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, MonoRadar_Ingest_dataMode_Enum_REAL, MonoRadar_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesMonoRadar_Ingest_dataMode_Enum()[index];
}
...
struct MonoRadar_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef MonoRadar_IngestBuilder Builder;
  ...
  MonoRadar_Ingest_dataMode_Enum dataMode() const {
    return static_cast<MonoRadar_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct MonoRadar_IngestBuilder {
  typedef MonoRadar_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_tti(::flatbuffers::Offset<::flatbuffers::String> tti) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_TTI, tti);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_IDSENSOR, idSensor);
  }
  void add_senlat(double senlat) {
    fbb_.AddElement<double>(MonoRadar_Ingest::VT_SENLAT, senlat, 0.0);
  }
  void add_senlon(double senlon) {
    fbb_.AddElement<double>(MonoRadar_Ingest::VT_SENLON, senlon, 0.0);
  }
  void add_senalt(double senalt) {
    fbb_.AddElement<double>(MonoRadar_Ingest::VT_SENALT, senalt, 0.0);
  }
  void add_sac(int32_t sac) {
    fbb_.AddElement<int32_t>(MonoRadar_Ingest::VT_SAC, sac, 0);
  }
  void add_sic(int32_t sic) {
    fbb_.AddElement<int32_t>(MonoRadar_Ingest::VT_SIC, sic, 0);
  }
  void add_tgtid(::flatbuffers::Offset<::flatbuffers::String> tgtid) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_TGTID, tgtid);
  }
  void add_addr(::flatbuffers::Offset<::flatbuffers::String> addr) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_ADDR, addr);
  }
  void add_msgfmt(::flatbuffers::Offset<::flatbuffers::String> msgfmt) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_MSGFMT, msgfmt);
  }
  void add_msgtyp(::flatbuffers::Offset<::flatbuffers::String> msgtyp) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_MSGTYP, msgtyp);
  }
  void add_af(bool af) {
    fbb_.AddElement<uint8_t>(MonoRadar_Ingest::VT_AF, static_cast<uint8_t>(af), 0);
  }
  void add_faa(bool faa) {
    fbb_.AddElement<uint8_t>(MonoRadar_Ingest::VT_FAA, static_cast<uint8_t>(faa), 0);
  }
  void add_spi(bool spi) {
    fbb_.AddElement<uint8_t>(MonoRadar_Ingest::VT_SPI, static_cast<uint8_t>(spi), 0);
  }
  void add_aims(bool aims) {
    fbb_.AddElement<uint8_t>(MonoRadar_Ingest::VT_AIMS, static_cast<uint8_t>(aims), 0);
  }
  void add_mti(bool mti) {
    fbb_.AddElement<uint8_t>(MonoRadar_Ingest::VT_MTI, static_cast<uint8_t>(mti), 0);
  }
  void add_bcnhits(int32_t bcnhits) {
    fbb_.AddElement<int32_t>(MonoRadar_Ingest::VT_BCNHITS, bcnhits, 0);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::String> ts) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_TS, ts);
  }
  void add_msgts(::flatbuffers::Offset<::flatbuffers::String> msgts) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_MSGTS, msgts);
  }
  void add_rng(double rng) {
    fbb_.AddElement<double>(MonoRadar_Ingest::VT_RNG, rng, 0.0);
  }
  void add_az(double az) {
    fbb_.AddElement<double>(MonoRadar_Ingest::VT_AZ, az, 0.0);
  }
  void add_acp(int32_t acp) {
    fbb_.AddElement<int32_t>(MonoRadar_Ingest::VT_ACP, acp, 0);
  }
  void add_alt3d(double alt3d) {
    fbb_.AddElement<double>(MonoRadar_Ingest::VT_ALT3D, alt3d, 0.0);
  }
  void add_mc(double mc) {
    fbb_.AddElement<double>(MonoRadar_Ingest::VT_MC, mc, 0.0);
  }
  void add_mcv(::flatbuffers::Offset<::flatbuffers::String> mcv) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_MCV, mcv);
  }
  void add_mcg(bool mcg) {
    fbb_.AddElement<uint8_t>(MonoRadar_Ingest::VT_MCG, static_cast<uint8_t>(mcg), 0);
  }
  void add_m1(::flatbuffers::Offset<::flatbuffers::String> m1) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_M1, m1);
  }
  void add_m1v(::flatbuffers::Offset<::flatbuffers::String> m1v) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_M1V, m1v);
  }
  void add_m1g(bool m1g) {
    fbb_.AddElement<uint8_t>(MonoRadar_Ingest::VT_M1G, static_cast<uint8_t>(m1g), 0);
  }
  void add_m2(::flatbuffers::Offset<::flatbuffers::String> m2) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_M2, m2);
  }
  void add_m2v(::flatbuffers::Offset<::flatbuffers::String> m2v) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_M2V, m2v);
  }
  void add_m2xv(::flatbuffers::Offset<::flatbuffers::String> m2xv) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_M2XV, m2xv);
  }
  void add_m2g(bool m2g) {
    fbb_.AddElement<uint8_t>(MonoRadar_Ingest::VT_M2G, static_cast<uint8_t>(m2g), 0);
  }
  void add_m3a(::flatbuffers::Offset<::flatbuffers::String> m3a) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_M3A, m3a);
  }
  void add_m3av(::flatbuffers::Offset<::flatbuffers::String> m3av) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_M3AV, m3av);
  }
  void add_m3ag(bool m3ag) {
    fbb_.AddElement<uint8_t>(MonoRadar_Ingest::VT_M3AG, static_cast<uint8_t>(m3ag), 0);
  }
  void add_m3axv(::flatbuffers::Offset<::flatbuffers::String> m3axv) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_M3AXV, m3axv);
  }
  void add_m4(::flatbuffers::Offset<::flatbuffers::String> m4) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_M4, m4);
  }
  void add_m4v(::flatbuffers::Offset<::flatbuffers::String> m4v) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_M4V, m4v);
  }
  void add_m4d1d2(::flatbuffers::Offset<::flatbuffers::String> m4d1d2) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_M4D1D2, m4d1d2);
  }
  void add_mscommb(::flatbuffers::Offset<::flatbuffers::String> mscommb) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_MSCOMMB, mscommb);
  }
  void add_milemrgcy(bool milemrgcy) {
    fbb_.AddElement<uint8_t>(MonoRadar_Ingest::VT_MILEMRGCY, static_cast<uint8_t>(milemrgcy), 0);
  }
  void add_code7500(bool code7500) {
    fbb_.AddElement<uint8_t>(MonoRadar_Ingest::VT_CODE7500, static_cast<uint8_t>(code7500), 0);
  }
  void add_code7600(bool code7600) {
    fbb_.AddElement<uint8_t>(MonoRadar_Ingest::VT_CODE7600, static_cast<uint8_t>(code7600), 0);
  }
  void add_code7700(bool code7700) {
    fbb_.AddElement<uint8_t>(MonoRadar_Ingest::VT_CODE7700, static_cast<uint8_t>(code7700), 0);
  }
  void add_grndspd(double grndspd) {
    fbb_.AddElement<double>(MonoRadar_Ingest::VT_GRNDSPD, grndspd, 0.0);
  }
  void add_hdng(double hdng) {
    fbb_.AddElement<double>(MonoRadar_Ingest::VT_HDNG, hdng, 0.0);
  }
  void add_trknum(int32_t trknum) {
    fbb_.AddElement<int32_t>(MonoRadar_Ingest::VT_TRKNUM, trknum, 0);
  }
  void add_rad(::flatbuffers::Offset<::flatbuffers::String> rad) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_RAD, rad);
  }
  void add_mah(::flatbuffers::Offset<::flatbuffers::String> mah) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_MAH, mah);
  }
  void add_cdm(::flatbuffers::Offset<::flatbuffers::String> cdm) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_CDM, cdm);
  }
  void add_cartpos(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> cartpos) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_CARTPOS, cartpos);
  }
  void add_psrrl(double psrrl) {
    fbb_.AddElement<double>(MonoRadar_Ingest::VT_PSRRL, psrrl, 0.0);
  }
  void add_ssrl(double ssrl) {
    fbb_.AddElement<double>(MonoRadar_Ingest::VT_SSRL, ssrl, 0.0);
  }
  void add_rngdelt(double rngdelt) {
    fbb_.AddElement<double>(MonoRadar_Ingest::VT_RNGDELT, rngdelt, 0.0);
  }
  void add_azdelt(double azdelt) {
    fbb_.AddElement<double>(MonoRadar_Ingest::VT_AZDELT, azdelt, 0.0);
  }
  void add_wectc(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> wectc) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_WECTC, wectc);
  }
  void add_mrgrpt(bool mrgrpt) {
    fbb_.AddElement<uint8_t>(MonoRadar_Ingest::VT_MRGRPT, static_cast<uint8_t>(mrgrpt), 0);
  }
  void add_artsqual(::flatbuffers::Offset<::flatbuffers::String> artsqual) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_ARTSQUAL, artsqual);
  }
  void add_trkelig(::flatbuffers::Offset<::flatbuffers::String> trkelig) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_TRKELIG, trkelig);
  }
  void add_tgtconf(::flatbuffers::Offset<::flatbuffers::String> tgtconf) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_TGTCONF, tgtconf);
  }
  void add_tgtcorr(::flatbuffers::Offset<::flatbuffers::String> tgtcorr) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_TGTCORR, tgtcorr);
  }
  void add_tis(double tis) {
    fbb_.AddElement<double>(MonoRadar_Ingest::VT_TIS, tis, 0.0);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_TAGS, tags);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_ORIGSENSORID, origSensorId);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(MonoRadar_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(MonoRadar_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(MonoRadar_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  explicit MonoRadar_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<MonoRadar_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<MonoRadar_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<MonoRadar_Ingest> CreateMonoRadar_Ingest(
    ...
    MonoRadar_Ingest_dataMode_Enum dataMode = MonoRadar_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  MonoRadar_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<MonoRadar_Ingest> CreateMonoRadar_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const MonoRadar_Ingest *GetMonoRadar_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<MonoRadar_Ingest>(buf);
}

inline const MonoRadar_Ingest *GetSizePrefixedMonoRadar_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<MonoRadar_Ingest>(buf);
}

inline const char *MonoRadar_IngestIdentifier() {
  return "MONO";
}

inline bool MonoRadar_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MonoRadar_IngestIdentifier());
}

inline bool SizePrefixedMonoRadar_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MonoRadar_IngestIdentifier(), true);
}

inline bool VerifyMonoRadar_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<MonoRadar_Ingest>(MonoRadar_IngestIdentifier());
}

inline bool VerifySizePrefixedMonoRadar_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<MonoRadar_Ingest>(MonoRadar_IngestIdentifier());
}

inline void FinishMonoRadar_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MonoRadar_Ingest> root) {
  fbb.Finish(root, MonoRadar_IngestIdentifier());
}

inline void FinishSizePrefixedMonoRadar_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MonoRadar_Ingest> root) {
  fbb.FinishSizePrefixed(root, MonoRadar_IngestIdentifier());
}
