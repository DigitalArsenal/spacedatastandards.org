...
struct DiplomaticClearance_Full;
struct DiplomaticClearance_FullBuilder;

enum DiplomaticClearance_Full_dataMode_Enum : int8_t {
  ...
  DiplomaticClearance_Full_dataMode_Enum_MIN = DiplomaticClearance_Full_dataMode_Enum_REAL,
  DiplomaticClearance_Full_dataMode_Enum_MAX = DiplomaticClearance_Full_dataMode_Enum_EXERCISE
};

inline const DiplomaticClearance_Full_dataMode_Enum (&EnumValuesDiplomaticClearance_Full_dataMode_Enum())[4] {
  static const DiplomaticClearance_Full_dataMode_Enum values[] = {
    DiplomaticClearance_Full_dataMode_Enum_REAL,
    DiplomaticClearance_Full_dataMode_Enum_TEST,
    DiplomaticClearance_Full_dataMode_Enum_SIMULATED,
    DiplomaticClearance_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesDiplomaticClearance_Full_dataMode_Enum() {
...
inline const char *EnumNameDiplomaticClearance_Full_dataMode_Enum(DiplomaticClearance_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, DiplomaticClearance_Full_dataMode_Enum_REAL, DiplomaticClearance_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesDiplomaticClearance_Full_dataMode_Enum()[index];
}

/// /// A diplomatic clearance is an authorization for an aircraft to traverse or land within a specified country.
struct DiplomaticClearance_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef DiplomaticClearance_FullBuilder Builder;
  ...
  DiplomaticClearance_Full_dataMode_Enum dataMode() const {
    return static_cast<DiplomaticClearance_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct DiplomaticClearance_FullBuilder {
  typedef DiplomaticClearance_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idMission(::flatbuffers::Offset<::flatbuffers::String> idMission) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_IDMISSION, idMission);
  }
  void add_externalWorksheetId(::flatbuffers::Offset<::flatbuffers::String> externalWorksheetId) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_EXTERNALWORKSHEETID, externalWorksheetId);
  }
  void add_dipWorksheetName(::flatbuffers::Offset<::flatbuffers::String> dipWorksheetName) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_DIPWORKSHEETNAME, dipWorksheetName);
  }
  void add_firstDepDate(::flatbuffers::Offset<::flatbuffers::String> firstDepDate) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_FIRSTDEPDATE, firstDepDate);
  }
  void add_docDeadline(::flatbuffers::Offset<::flatbuffers::String> docDeadline) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_DOCDEADLINE, docDeadline);
  }
  void add_apacsId(::flatbuffers::Offset<::flatbuffers::String> apacsId) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_APACSID, apacsId);
  }
  void add_diplomaticClearanceDetails(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> diplomaticClearanceDetails) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_DIPLOMATICCLEARANCEDETAILS, diplomaticClearanceDetails);
  }
  void add_diplomaticClearanceRemarks(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> diplomaticClearanceRemarks) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_DIPLOMATICCLEARANCEREMARKS, diplomaticClearanceRemarks);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(DiplomaticClearance_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(DiplomaticClearance_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(DiplomaticClearance_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit DiplomaticClearance_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<DiplomaticClearance_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<DiplomaticClearance_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<DiplomaticClearance_Full> CreateDiplomaticClearance_Full(
    ...
    DiplomaticClearance_Full_dataMode_Enum dataMode = DiplomaticClearance_Full_dataMode_Enum_REAL) {
  DiplomaticClearance_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<DiplomaticClearance_Full> CreateDiplomaticClearance_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const DiplomaticClearance_Full *GetDiplomaticClearance_Full(const void *buf) {
  return ::flatbuffers::GetRoot<DiplomaticClearance_Full>(buf);
}

inline const DiplomaticClearance_Full *GetSizePrefixedDiplomaticClearance_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<DiplomaticClearance_Full>(buf);
}

inline const char *DiplomaticClearance_FullIdentifier() {
  return "DIPL";
}

inline bool DiplomaticClearance_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DiplomaticClearance_FullIdentifier());
}

inline bool SizePrefixedDiplomaticClearance_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DiplomaticClearance_FullIdentifier(), true);
}

inline bool VerifyDiplomaticClearance_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<DiplomaticClearance_Full>(DiplomaticClearance_FullIdentifier());
}

inline bool VerifySizePrefixedDiplomaticClearance_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<DiplomaticClearance_Full>(DiplomaticClearance_FullIdentifier());
}

inline void FinishDiplomaticClearance_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DiplomaticClearance_Full> root) {
  fbb.Finish(root, DiplomaticClearance_FullIdentifier());
}

inline void FinishSizePrefixedDiplomaticClearance_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DiplomaticClearance_Full> root) {
  fbb.FinishSizePrefixed(root, DiplomaticClearance_FullIdentifier());
}
