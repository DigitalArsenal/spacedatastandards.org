...
struct CrewMembers_Abridged;
struct CrewMembers_AbridgedBuilder;

/// /// Schema for Crew Member data.
struct CrewMembers_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef CrewMembers_AbridgedBuilder Builder;
...
struct CrewMembers_AbridgedBuilder {
  typedef CrewMembers_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_lastName(::flatbuffers::Offset<::flatbuffers::String> lastName) {
    fbb_.AddOffset(CrewMembers_Abridged::VT_LASTNAME, lastName);
  }
  void add_firstName(::flatbuffers::Offset<::flatbuffers::String> firstName) {
    fbb_.AddOffset(CrewMembers_Abridged::VT_FIRSTNAME, firstName);
  }
  void add_middleInitial(::flatbuffers::Offset<::flatbuffers::String> middleInitial) {
    fbb_.AddOffset(CrewMembers_Abridged::VT_MIDDLEINITIAL, middleInitial);
  }
  void add_memberId(::flatbuffers::Offset<::flatbuffers::String> memberId) {
    fbb_.AddOffset(CrewMembers_Abridged::VT_MEMBERID, memberId);
  }
  void add_civilian(bool civilian) {
    fbb_.AddElement<uint8_t>(CrewMembers_Abridged::VT_CIVILIAN, static_cast<uint8_t>(civilian), 0);
  }
  void add_commander(bool commander) {
    fbb_.AddElement<uint8_t>(CrewMembers_Abridged::VT_COMMANDER, static_cast<uint8_t>(commander), 0);
  }
  void add_last4SSN(::flatbuffers::Offset<::flatbuffers::String> last4SSN) {
    fbb_.AddOffset(CrewMembers_Abridged::VT_LAST4SSN, last4SSN);
  }
  void add_dodID(::flatbuffers::Offset<::flatbuffers::String> dodID) {
    fbb_.AddOffset(CrewMembers_Abridged::VT_DODID, dodID);
  }
  void add_dutyPosition(::flatbuffers::Offset<::flatbuffers::String> dutyPosition) {
    fbb_.AddOffset(CrewMembers_Abridged::VT_DUTYPOSITION, dutyPosition);
  }
  void add_crewPosition(::flatbuffers::Offset<::flatbuffers::String> crewPosition) {
    fbb_.AddOffset(CrewMembers_Abridged::VT_CREWPOSITION, crewPosition);
  }
  void add_memberType(::flatbuffers::Offset<::flatbuffers::String> memberType) {
    fbb_.AddOffset(CrewMembers_Abridged::VT_MEMBERTYPE, memberType);
  }
  void add_branch(::flatbuffers::Offset<::flatbuffers::String> branch) {
    fbb_.AddOffset(CrewMembers_Abridged::VT_BRANCH, branch);
  }
  void add_rank(::flatbuffers::Offset<::flatbuffers::String> rank) {
    fbb_.AddOffset(CrewMembers_Abridged::VT_RANK, rank);
  }
  void add_wing(::flatbuffers::Offset<::flatbuffers::String> wing) {
    fbb_.AddOffset(CrewMembers_Abridged::VT_WING, wing);
  }
  void add_squadron(::flatbuffers::Offset<::flatbuffers::String> squadron) {
    fbb_.AddOffset(CrewMembers_Abridged::VT_SQUADRON, squadron);
  }
  void add_memberRemarks(::flatbuffers::Offset<::flatbuffers::String> memberRemarks) {
    fbb_.AddOffset(CrewMembers_Abridged::VT_MEMBERREMARKS, memberRemarks);
  }
  void add_username(::flatbuffers::Offset<::flatbuffers::String> username) {
    fbb_.AddOffset(CrewMembers_Abridged::VT_USERNAME, username);
  }
  explicit CrewMembers_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<CrewMembers_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<CrewMembers_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<CrewMembers_Abridged> CreateCrewMembers_Abridged(
  ...
  CrewMembers_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<CrewMembers_Abridged> CreateCrewMembers_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const CrewMembers_Abridged *GetCrewMembers_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<CrewMembers_Abridged>(buf);
}

inline const CrewMembers_Abridged *GetSizePrefixedCrewMembers_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<CrewMembers_Abridged>(buf);
}

inline const char *CrewMembers_AbridgedIdentifier() {
  return "CREW";
}

inline bool CrewMembers_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, CrewMembers_AbridgedIdentifier());
}

inline bool SizePrefixedCrewMembers_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, CrewMembers_AbridgedIdentifier(), true);
}

inline bool VerifyCrewMembers_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<CrewMembers_Abridged>(CrewMembers_AbridgedIdentifier());
}

inline bool VerifySizePrefixedCrewMembers_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<CrewMembers_Abridged>(CrewMembers_AbridgedIdentifier());
}

inline void FinishCrewMembers_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<CrewMembers_Abridged> root) {
  fbb.Finish(root, CrewMembers_AbridgedIdentifier());
}

inline void FinishSizePrefixedCrewMembers_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<CrewMembers_Abridged> root) {
  fbb.FinishSizePrefixed(root, CrewMembers_AbridgedIdentifier());
}
