...
enum TAIUTC_Full_dataMode_Enum : int8_t {
  ...
  TAIUTC_Full_dataMode_Enum_MIN = TAIUTC_Full_dataMode_Enum_REAL,
  TAIUTC_Full_dataMode_Enum_MAX = TAIUTC_Full_dataMode_Enum_EXERCISE
};

inline const TAIUTC_Full_dataMode_Enum (&EnumValuesTAIUTC_Full_dataMode_Enum())[4] {
  static const TAIUTC_Full_dataMode_Enum values[] = {
    TAIUTC_Full_dataMode_Enum_REAL,
    TAIUTC_Full_dataMode_Enum_TEST,
    TAIUTC_Full_dataMode_Enum_SIMULATED,
    TAIUTC_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesTAIUTC_Full_dataMode_Enum() {
...
inline const char *EnumNameTAIUTC_Full_dataMode_Enum(TAIUTC_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, TAIUTC_Full_dataMode_Enum_REAL, TAIUTC_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesTAIUTC_Full_dataMode_Enum()[index];
}
...
struct TAIUTC_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef TAIUTC_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  TAIUTC_Full_dataMode_Enum dataMode() const {
    return static_cast<TAIUTC_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct TAIUTC_FullBuilder {
  typedef TAIUTC_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(TAIUTC_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(TAIUTC_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_adjustmentDate(::flatbuffers::Offset<::flatbuffers::String> adjustmentDate) {
    fbb_.AddOffset(TAIUTC_Full::VT_ADJUSTMENTDATE, adjustmentDate);
  }
  void add_taiUTC(double taiUTC) {
    fbb_.AddElement<double>(TAIUTC_Full::VT_TAIUTC, taiUTC, 0.0);
  }
  void add_multiplicationFactor(double multiplicationFactor) {
    fbb_.AddElement<double>(TAIUTC_Full::VT_MULTIPLICATIONFACTOR, multiplicationFactor, 0.0);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(TAIUTC_Full::VT_RAWFILEURI, rawFileURI);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(TAIUTC_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(TAIUTC_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(TAIUTC_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(TAIUTC_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(TAIUTC_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(TAIUTC_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(TAIUTC_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(TAIUTC_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(TAIUTC_Full::VT_UPDATEDBY, updatedBy);
  }
  explicit TAIUTC_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<TAIUTC_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<TAIUTC_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<TAIUTC_Full> CreateTAIUTC_Full(
...
inline ::flatbuffers::Offset<TAIUTC_Full> CreateTAIUTC_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const TAIUTC_Full *GetTAIUTC_Full(const void *buf) {
  return ::flatbuffers::GetRoot<TAIUTC_Full>(buf);
}

inline const TAIUTC_Full *GetSizePrefixedTAIUTC_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<TAIUTC_Full>(buf);
}

inline const char *TAIUTC_FullIdentifier() {
  return "TAIU";
}

inline bool TAIUTC_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, TAIUTC_FullIdentifier());
}

inline bool SizePrefixedTAIUTC_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, TAIUTC_FullIdentifier(), true);
}

inline bool VerifyTAIUTC_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<TAIUTC_Full>(TAIUTC_FullIdentifier());
}

inline bool VerifySizePrefixedTAIUTC_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<TAIUTC_Full>(TAIUTC_FullIdentifier());
}

inline void FinishTAIUTC_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<TAIUTC_Full> root) {
  fbb.Finish(root, TAIUTC_FullIdentifier());
}

inline void FinishSizePrefixedTAIUTC_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<TAIUTC_Full> root) {
  fbb.FinishSizePrefixed(root, TAIUTC_FullIdentifier());
}
