...
struct AirTransportMissionHazMat_Ingest;
...
struct AirTransportMissionHazMat_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirTransportMissionHazMat_IngestBuilder Builder;
...
struct AirTransportMissionHazMat_IngestBuilder {
  typedef AirTransportMissionHazMat_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_extHazMatId(::flatbuffers::Offset<::flatbuffers::String> extHazMatId) {
    fbb_.AddOffset(AirTransportMissionHazMat_Ingest::VT_EXTHAZMATID, extHazMatId);
  }
  void add_itemName(::flatbuffers::Offset<::flatbuffers::String> itemName) {
    fbb_.AddOffset(AirTransportMissionHazMat_Ingest::VT_ITEMNAME, itemName);
  }
  void add_unNum(::flatbuffers::Offset<::flatbuffers::String> unNum) {
    fbb_.AddOffset(AirTransportMissionHazMat_Ingest::VT_UNNUM, unNum);
  }
  void add_pieces(int32_t pieces) {
    fbb_.AddElement<int32_t>(AirTransportMissionHazMat_Ingest::VT_PIECES, pieces, 0);
  }
  void add_weight(double weight) {
    fbb_.AddElement<double>(AirTransportMissionHazMat_Ingest::VT_WEIGHT, weight, 0.0);
  }
  void add_netExpWt(double netExpWt) {
    fbb_.AddElement<double>(AirTransportMissionHazMat_Ingest::VT_NETEXPWT, netExpWt, 0.0);
  }
  void add_classDiv(double classDiv) {
    fbb_.AddElement<double>(AirTransportMissionHazMat_Ingest::VT_CLASSDIV, classDiv, 0.0);
  }
  void add_cgc(::flatbuffers::Offset<::flatbuffers::String> cgc) {
    fbb_.AddOffset(AirTransportMissionHazMat_Ingest::VT_CGC, cgc);
  }
  void add_cgn(::flatbuffers::Offset<::flatbuffers::String> cgn) {
    fbb_.AddOffset(AirTransportMissionHazMat_Ingest::VT_CGN, cgn);
  }
  void add_applicableNotes(::flatbuffers::Offset<::flatbuffers::String> applicableNotes) {
    fbb_.AddOffset(AirTransportMissionHazMat_Ingest::VT_APPLICABLENOTES, applicableNotes);
  }
  void add_onItin(int32_t onItin) {
    fbb_.AddElement<int32_t>(AirTransportMissionHazMat_Ingest::VT_ONITIN, onItin, 0);
  }
  void add_onICAO(::flatbuffers::Offset<::flatbuffers::String> onICAO) {
    fbb_.AddOffset(AirTransportMissionHazMat_Ingest::VT_ONICAO, onICAO);
  }
  void add_offItin(int32_t offItin) {
    fbb_.AddElement<int32_t>(AirTransportMissionHazMat_Ingest::VT_OFFITIN, offItin, 0);
  }
  void add_offICAO(::flatbuffers::Offset<::flatbuffers::String> offICAO) {
    fbb_.AddOffset(AirTransportMissionHazMat_Ingest::VT_OFFICAO, offICAO);
  }
  void add_planned(::flatbuffers::Offset<::flatbuffers::String> planned) {
    fbb_.AddOffset(AirTransportMissionHazMat_Ingest::VT_PLANNED, planned);
  }
  explicit AirTransportMissionHazMat_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirTransportMissionHazMat_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirTransportMissionHazMat_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirTransportMissionHazMat_Ingest> CreateAirTransportMissionHazMat_Ingest(
  ...
  AirTransportMissionHazMat_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirTransportMissionHazMat_Ingest> CreateAirTransportMissionHazMat_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAirTransportMissionHazMat_Ingest(
      _fbb,
      extHazMatId__,
      itemName__,
      unNum__,
...
inline const AirTransportMissionHazMat_Ingest *GetAirTransportMissionHazMat_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<AirTransportMissionHazMat_Ingest>(buf);
}

inline const AirTransportMissionHazMat_Ingest *GetSizePrefixedAirTransportMissionHazMat_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirTransportMissionHazMat_Ingest>(buf);
}

inline const char *AirTransportMissionHazMat_IngestIdentifier() {
  return "AIRT";
}

inline bool AirTransportMissionHazMat_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirTransportMissionHazMat_IngestIdentifier());
}

inline bool SizePrefixedAirTransportMissionHazMat_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirTransportMissionHazMat_IngestIdentifier(), true);
}

inline bool VerifyAirTransportMissionHazMat_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirTransportMissionHazMat_Ingest>(AirTransportMissionHazMat_IngestIdentifier());
}

inline bool VerifySizePrefixedAirTransportMissionHazMat_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirTransportMissionHazMat_Ingest>(AirTransportMissionHazMat_IngestIdentifier());
}

inline void FinishAirTransportMissionHazMat_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirTransportMissionHazMat_Ingest> root) {
  fbb.Finish(root, AirTransportMissionHazMat_IngestIdentifier());
}

inline void FinishSizePrefixedAirTransportMissionHazMat_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirTransportMissionHazMat_Ingest> root) {
  fbb.FinishSizePrefixed(root, AirTransportMissionHazMat_IngestIdentifier());
}
