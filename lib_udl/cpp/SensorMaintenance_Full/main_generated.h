...
struct SensorMaintenance_Full;
struct SensorMaintenance_FullBuilder;

enum SensorMaintenance_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  SensorMaintenance_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  SensorMaintenance_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  SensorMaintenance_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  SensorMaintenance_Full_dataMode_Enum_EXERCISE = 3,
  SensorMaintenance_Full_dataMode_Enum_MIN = SensorMaintenance_Full_dataMode_Enum_REAL,
  SensorMaintenance_Full_dataMode_Enum_MAX = SensorMaintenance_Full_dataMode_Enum_EXERCISE
};

inline const SensorMaintenance_Full_dataMode_Enum (&EnumValuesSensorMaintenance_Full_dataMode_Enum())[4] {
  static const SensorMaintenance_Full_dataMode_Enum values[] = {
    SensorMaintenance_Full_dataMode_Enum_REAL,
    SensorMaintenance_Full_dataMode_Enum_TEST,
    SensorMaintenance_Full_dataMode_Enum_SIMULATED,
    SensorMaintenance_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSensorMaintenance_Full_dataMode_Enum() {
...
inline const char *EnumNameSensorMaintenance_Full_dataMode_Enum(SensorMaintenance_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SensorMaintenance_Full_dataMode_Enum_REAL, SensorMaintenance_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSensorMaintenance_Full_dataMode_Enum()[index];
}

/// /// Maintenance schedule and operational status of Sensor.
struct SensorMaintenance_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SensorMaintenance_FullBuilder Builder;
  ...
  SensorMaintenance_Full_dataMode_Enum dataMode() const {
    return static_cast<SensorMaintenance_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SensorMaintenance_FullBuilder {
  typedef SensorMaintenance_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_siteCode(::flatbuffers::Offset<::flatbuffers::String> siteCode) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_SITECODE, siteCode);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_IDSENSOR, idSensor);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_ENDTIME, endTime);
  }
  void add_recall(::flatbuffers::Offset<::flatbuffers::String> recall) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_RECALL, recall);
  }
  void add_duration(::flatbuffers::Offset<::flatbuffers::String> duration) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_DURATION, duration);
  }
  void add_mwOpsCap(::flatbuffers::Offset<::flatbuffers::String> mwOpsCap) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_MWOPSCAP, mwOpsCap);
  }
  void add_ssOpsCap(::flatbuffers::Offset<::flatbuffers::String> ssOpsCap) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_SSOPSCAP, ssOpsCap);
  }
  void add_mdOpsCap(::flatbuffers::Offset<::flatbuffers::String> mdOpsCap) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_MDOPSCAP, mdOpsCap);
  }
  void add_impactedFaces(::flatbuffers::Offset<::flatbuffers::String> impactedFaces) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_IMPACTEDFACES, impactedFaces);
  }
  void add_equipStatus(::flatbuffers::Offset<::flatbuffers::String> equipStatus) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_EQUIPSTATUS, equipStatus);
  }
  void add_activity(::flatbuffers::Offset<::flatbuffers::String> activity) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_ACTIVITY, activity);
  }
  void add_remark(::flatbuffers::Offset<::flatbuffers::String> remark) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_REMARK, remark);
  }
  void add_requestor(::flatbuffers::Offset<::flatbuffers::String> requestor) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_REQUESTOR, requestor);
  }
  void add_changer(::flatbuffers::Offset<::flatbuffers::String> changer) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_CHANGER, changer);
  }
  void add_approver(::flatbuffers::Offset<::flatbuffers::String> approver) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_APPROVER, approver);
  }
  void add_eowId(::flatbuffers::Offset<::flatbuffers::String> eowId) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_EOWID, eowId);
  }
  void add_rev(::flatbuffers::Offset<::flatbuffers::String> rev) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_REV, rev);
  }
  void add_priority(::flatbuffers::Offset<::flatbuffers::String> priority) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_PRIORITY, priority);
  }
  void add_rel(::flatbuffers::Offset<::flatbuffers::String> rel) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_REL, rel);
  }
  void add_lineNumber(::flatbuffers::Offset<::flatbuffers::String> lineNumber) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_LINENUMBER, lineNumber);
  }
  void add_resource(::flatbuffers::Offset<::flatbuffers::String> resource) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_RESOURCE, resource);
  }
  void add_inactiveDate(::flatbuffers::Offset<::flatbuffers::String> inactiveDate) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_INACTIVEDATE, inactiveDate);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(SensorMaintenance_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SensorMaintenance_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(SensorMaintenance_Full::VT_UPDATEDBY, updatedBy);
  }
  explicit SensorMaintenance_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SensorMaintenance_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SensorMaintenance_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SensorMaintenance_Full> CreateSensorMaintenance_Full(
    ...
    SensorMaintenance_Full_dataMode_Enum dataMode = SensorMaintenance_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0,
    ::flatbuffers::Offset<::flatbuffers::String> updatedAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> updatedBy = 0) {
  SensorMaintenance_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SensorMaintenance_Full> CreateSensorMaintenance_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateSensorMaintenance_Full(
      _fbb,
      id__,
...
inline const SensorMaintenance_Full *GetSensorMaintenance_Full(const void *buf) {
  return ::flatbuffers::GetRoot<SensorMaintenance_Full>(buf);
}

inline const SensorMaintenance_Full *GetSizePrefixedSensorMaintenance_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SensorMaintenance_Full>(buf);
}

inline const char *SensorMaintenance_FullIdentifier() {
  return "SENS";
}

inline bool SensorMaintenance_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SensorMaintenance_FullIdentifier());
}

inline bool SizePrefixedSensorMaintenance_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SensorMaintenance_FullIdentifier(), true);
}

inline bool VerifySensorMaintenance_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SensorMaintenance_Full>(SensorMaintenance_FullIdentifier());
}

inline bool VerifySizePrefixedSensorMaintenance_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SensorMaintenance_Full>(SensorMaintenance_FullIdentifier());
}

inline void FinishSensorMaintenance_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SensorMaintenance_Full> root) {
  fbb.Finish(root, SensorMaintenance_FullIdentifier());
}

inline void FinishSizePrefixedSensorMaintenance_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SensorMaintenance_Full> root) {
  fbb.FinishSizePrefixed(root, SensorMaintenance_FullIdentifier());
}
