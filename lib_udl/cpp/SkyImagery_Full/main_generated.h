...
struct SkyImagery_Full;
struct SkyImagery_FullBuilder;

enum SkyImagery_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  SkyImagery_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  SkyImagery_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  SkyImagery_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  SkyImagery_Full_dataMode_Enum_EXERCISE = 3,
  SkyImagery_Full_dataMode_Enum_MIN = SkyImagery_Full_dataMode_Enum_REAL,
  SkyImagery_Full_dataMode_Enum_MAX = SkyImagery_Full_dataMode_Enum_EXERCISE
};

inline const SkyImagery_Full_dataMode_Enum (&EnumValuesSkyImagery_Full_dataMode_Enum())[4] {
  static const SkyImagery_Full_dataMode_Enum values[] = {
    SkyImagery_Full_dataMode_Enum_REAL,
    SkyImagery_Full_dataMode_Enum_TEST,
    SkyImagery_Full_dataMode_Enum_SIMULATED,
    SkyImagery_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSkyImagery_Full_dataMode_Enum() {
...
inline const char *EnumNameSkyImagery_Full_dataMode_Enum(SkyImagery_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SkyImagery_Full_dataMode_Enum_REAL, SkyImagery_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSkyImagery_Full_dataMode_Enum()[index];
}
...
struct SkyImagery_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SkyImagery_FullBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_EXPSTARTTIME = 40,
    VT_EXPENDTIME = 42,
    VT_IMAGESOURCEINFO = 44,
    VT_TOPLEFTSTARTAZ = 46,
    VT_TOPLEFTSTARTEL = 48,
    VT_TOPLEFTSTOPAZ = 50,
    VT_TOPLEFTSTOPEL = 52,
    VT_IMAGESETID = 54,
    VT_IMAGESETLENGTH = 56,
    VT_SEQUENCEID = 58,
    VT_FRAMEFOVWIDTH = 60,
    VT_FRAMEFOVHEIGHT = 62,
    VT_PIXELFOVWIDTH = 64,
    VT_PIXELFOVHEIGHT = 66,
    VT_FRAMEWIDTHPIXELS = 68,
    VT_FRAMEHEIGHTPIXELS = 70,
    VT_PIXELBITDEPTH = 72,
    VT_ANNOTATIONKEY = 74,
    VT_CALIBRATIONKEY = 76,
    VT_FILENAME = 78,
    VT_FILESIZE = 80,
    VT_CHECKSUMVALUE = 82,
    VT_TRANSACTIONID = 84,
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SkyImagery_Full_dataMode_Enum dataMode() const {
    return static_cast<SkyImagery_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *eoObservations() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_EOOBSERVATIONS);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_EOOBSERVATIONS) &&
           verifier.VerifyVector(eoObservations()) &&
           verifier.VerifyVectorOfStrings(eoObservations()) &&
           verifier.EndTable();
  }
};

struct SkyImagery_FullBuilder {
  typedef SkyImagery_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SkyImagery_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SkyImagery_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(SkyImagery_Full::VT_IDONORBIT, idOnOrbit);
  }
  void add_onOrbit(::flatbuffers::Offset<::flatbuffers::String> onOrbit) {
    fbb_.AddOffset(SkyImagery_Full::VT_ONORBIT, onOrbit);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(SkyImagery_Full::VT_ORIGOBJECTID, origObjectId);
  }
  void add_idAttitudeSet(::flatbuffers::Offset<::flatbuffers::String> idAttitudeSet) {
    fbb_.AddOffset(SkyImagery_Full::VT_IDATTITUDESET, idAttitudeSet);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(SkyImagery_Full::VT_IDSENSOR, idSensor);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(SkyImagery_Full::VT_SATNO, satNo, 0);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(SkyImagery_Full::VT_ORIGSENSORID, origSensorId);
  }
  void add_senlat(double senlat) {
    fbb_.AddElement<double>(SkyImagery_Full::VT_SENLAT, senlat, 0.0);
  }
  void add_senlon(double senlon) {
    fbb_.AddElement<double>(SkyImagery_Full::VT_SENLON, senlon, 0.0);
  }
  void add_senalt(double senalt) {
    fbb_.AddElement<double>(SkyImagery_Full::VT_SENALT, senalt, 0.0);
  }
  void add_senx(double senx) {
    fbb_.AddElement<double>(SkyImagery_Full::VT_SENX, senx, 0.0);
  }
  void add_seny(double seny) {
    fbb_.AddElement<double>(SkyImagery_Full::VT_SENY, seny, 0.0);
  }
  void add_senz(double senz) {
    fbb_.AddElement<double>(SkyImagery_Full::VT_SENZ, senz, 0.0);
  }
  void add_senQuat(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> senQuat) {
    fbb_.AddOffset(SkyImagery_Full::VT_SENQUAT, senQuat);
  }
  void add_senQuatDot(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> senQuatDot) {
    fbb_.AddOffset(SkyImagery_Full::VT_SENQUATDOT, senQuatDot);
  }
  void add_imageType(::flatbuffers::Offset<::flatbuffers::String> imageType) {
    fbb_.AddOffset(SkyImagery_Full::VT_IMAGETYPE, imageType);
  }
  void add_expStartTime(::flatbuffers::Offset<::flatbuffers::String> expStartTime) {
    fbb_.AddOffset(SkyImagery_Full::VT_EXPSTARTTIME, expStartTime);
  }
  void add_expEndTime(::flatbuffers::Offset<::flatbuffers::String> expEndTime) {
    fbb_.AddOffset(SkyImagery_Full::VT_EXPENDTIME, expEndTime);
  }
  void add_imageSourceInfo(::flatbuffers::Offset<::flatbuffers::String> imageSourceInfo) {
    fbb_.AddOffset(SkyImagery_Full::VT_IMAGESOURCEINFO, imageSourceInfo);
  }
  void add_topLeftStartAz(double topLeftStartAz) {
    fbb_.AddElement<double>(SkyImagery_Full::VT_TOPLEFTSTARTAZ, topLeftStartAz, 0.0);
  }
  void add_topLeftStartEl(double topLeftStartEl) {
    fbb_.AddElement<double>(SkyImagery_Full::VT_TOPLEFTSTARTEL, topLeftStartEl, 0.0);
  }
  void add_topLeftStopAz(double topLeftStopAz) {
    fbb_.AddElement<double>(SkyImagery_Full::VT_TOPLEFTSTOPAZ, topLeftStopAz, 0.0);
  }
  void add_topLeftStopEl(double topLeftStopEl) {
    fbb_.AddElement<double>(SkyImagery_Full::VT_TOPLEFTSTOPEL, topLeftStopEl, 0.0);
  }
  void add_imageSetId(::flatbuffers::Offset<::flatbuffers::String> imageSetId) {
    fbb_.AddOffset(SkyImagery_Full::VT_IMAGESETID, imageSetId);
  }
  void add_imageSetLength(int32_t imageSetLength) {
    fbb_.AddElement<int32_t>(SkyImagery_Full::VT_IMAGESETLENGTH, imageSetLength, 0);
  }
  void add_sequenceId(int32_t sequenceId) {
    fbb_.AddElement<int32_t>(SkyImagery_Full::VT_SEQUENCEID, sequenceId, 0);
  }
  void add_frameFOVWidth(double frameFOVWidth) {
    fbb_.AddElement<double>(SkyImagery_Full::VT_FRAMEFOVWIDTH, frameFOVWidth, 0.0);
  }
  void add_frameFOVHeight(double frameFOVHeight) {
    fbb_.AddElement<double>(SkyImagery_Full::VT_FRAMEFOVHEIGHT, frameFOVHeight, 0.0);
  }
  void add_pixelFOVWidth(double pixelFOVWidth) {
    fbb_.AddElement<double>(SkyImagery_Full::VT_PIXELFOVWIDTH, pixelFOVWidth, 0.0);
  }
  void add_pixelFOVHeight(double pixelFOVHeight) {
    fbb_.AddElement<double>(SkyImagery_Full::VT_PIXELFOVHEIGHT, pixelFOVHeight, 0.0);
  }
  void add_frameWidthPixels(int32_t frameWidthPixels) {
    fbb_.AddElement<int32_t>(SkyImagery_Full::VT_FRAMEWIDTHPIXELS, frameWidthPixels, 0);
  }
  void add_frameHeightPixels(int32_t frameHeightPixels) {
    fbb_.AddElement<int32_t>(SkyImagery_Full::VT_FRAMEHEIGHTPIXELS, frameHeightPixels, 0);
  }
  void add_pixelBitDepth(int32_t pixelBitDepth) {
    fbb_.AddElement<int32_t>(SkyImagery_Full::VT_PIXELBITDEPTH, pixelBitDepth, 0);
  }
  void add_annotationKey(::flatbuffers::Offset<::flatbuffers::String> annotationKey) {
    fbb_.AddOffset(SkyImagery_Full::VT_ANNOTATIONKEY, annotationKey);
  }
  void add_calibrationKey(::flatbuffers::Offset<::flatbuffers::String> calibrationKey) {
    fbb_.AddOffset(SkyImagery_Full::VT_CALIBRATIONKEY, calibrationKey);
  }
  void add_filename(::flatbuffers::Offset<::flatbuffers::String> filename) {
    fbb_.AddOffset(SkyImagery_Full::VT_FILENAME, filename);
  }
  void add_filesize(int64_t filesize) {
    fbb_.AddElement<int64_t>(SkyImagery_Full::VT_FILESIZE, filesize, 0);
  }
  void add_checksumValue(::flatbuffers::Offset<::flatbuffers::String> checksumValue) {
    fbb_.AddOffset(SkyImagery_Full::VT_CHECKSUMVALUE, checksumValue);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(SkyImagery_Full::VT_TRANSACTIONID, transactionId);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(SkyImagery_Full::VT_TAGS, tags);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SkyImagery_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SkyImagery_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SkyImagery_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(SkyImagery_Full::VT_SOURCEDL, sourceDL);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(SkyImagery_Full::VT_DESCRIPTION, description);
  }
  void add_dataMode(SkyImagery_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SkyImagery_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SkyImagery_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SkyImagery_Full::VT_CREATEDBY, createdBy);
  }
  void add_eoObservations(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> eoObservations) {
    fbb_.AddOffset(SkyImagery_Full::VT_EOOBSERVATIONS, eoObservations);
  }
  explicit SkyImagery_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SkyImagery_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SkyImagery_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SkyImagery_Full> CreateSkyImagery_Full(
    ...
    SkyImagery_Full_dataMode_Enum dataMode = SkyImagery_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> eoObservations = 0) {
  SkyImagery_FullBuilder builder_(_fbb);
  ...
  builder_.add_eoObservations(eoObservations);
...
inline ::flatbuffers::Offset<SkyImagery_Full> CreateSkyImagery_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ...
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *eoObservations = nullptr) {
  ...
  auto eoObservations__ = eoObservations ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*eoObservations) : 0;
...
inline const SkyImagery_Full *GetSkyImagery_Full(const void *buf) {
  return ::flatbuffers::GetRoot<SkyImagery_Full>(buf);
}

inline const SkyImagery_Full *GetSizePrefixedSkyImagery_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SkyImagery_Full>(buf);
}

inline const char *SkyImagery_FullIdentifier() {
  return "SKYI";
}

inline bool SkyImagery_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SkyImagery_FullIdentifier());
}

inline bool SizePrefixedSkyImagery_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SkyImagery_FullIdentifier(), true);
}

inline bool VerifySkyImagery_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SkyImagery_Full>(SkyImagery_FullIdentifier());
}

inline bool VerifySizePrefixedSkyImagery_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SkyImagery_Full>(SkyImagery_FullIdentifier());
}

inline void FinishSkyImagery_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SkyImagery_Full> root) {
  fbb.Finish(root, SkyImagery_FullIdentifier());
}

inline void FinishSizePrefixedSkyImagery_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SkyImagery_Full> root) {
  fbb.FinishSizePrefixed(root, SkyImagery_FullIdentifier());
}
