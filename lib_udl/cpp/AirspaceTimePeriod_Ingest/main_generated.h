...
struct AirspaceTimePeriod_Ingest;
struct AirspaceTimePeriod_IngestBuilder;

/// /// The timePeriod set describes the effective datetime for a given airspace control means.
struct AirspaceTimePeriod_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirspaceTimePeriod_IngestBuilder Builder;
...
struct AirspaceTimePeriod_IngestBuilder {
  typedef AirspaceTimePeriod_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_timeMode(::flatbuffers::Offset<::flatbuffers::String> timeMode) {
    fbb_.AddOffset(AirspaceTimePeriod_Ingest::VT_TIMEMODE, timeMode);
  }
  void add_timeStart(::flatbuffers::Offset<::flatbuffers::String> timeStart) {
    fbb_.AddOffset(AirspaceTimePeriod_Ingest::VT_TIMESTART, timeStart);
  }
  void add_timeEnd(::flatbuffers::Offset<::flatbuffers::String> timeEnd) {
    fbb_.AddOffset(AirspaceTimePeriod_Ingest::VT_TIMEEND, timeEnd);
  }
  void add_intFreq(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> intFreq) {
    fbb_.AddOffset(AirspaceTimePeriod_Ingest::VT_INTFREQ, intFreq);
  }
  void add_intDur(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> intDur) {
    fbb_.AddOffset(AirspaceTimePeriod_Ingest::VT_INTDUR, intDur);
  }
  explicit AirspaceTimePeriod_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirspaceTimePeriod_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirspaceTimePeriod_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirspaceTimePeriod_Ingest> CreateAirspaceTimePeriod_Ingest(
  ...
  AirspaceTimePeriod_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirspaceTimePeriod_Ingest> CreateAirspaceTimePeriod_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AirspaceTimePeriod_Ingest *GetAirspaceTimePeriod_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<AirspaceTimePeriod_Ingest>(buf);
}

inline const AirspaceTimePeriod_Ingest *GetSizePrefixedAirspaceTimePeriod_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirspaceTimePeriod_Ingest>(buf);
}

inline const char *AirspaceTimePeriod_IngestIdentifier() {
  return "AIRS";
}

inline bool AirspaceTimePeriod_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirspaceTimePeriod_IngestIdentifier());
}

inline bool SizePrefixedAirspaceTimePeriod_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirspaceTimePeriod_IngestIdentifier(), true);
}

inline bool VerifyAirspaceTimePeriod_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirspaceTimePeriod_Ingest>(AirspaceTimePeriod_IngestIdentifier());
}

inline bool VerifySizePrefixedAirspaceTimePeriod_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirspaceTimePeriod_Ingest>(AirspaceTimePeriod_IngestIdentifier());
}

inline void FinishAirspaceTimePeriod_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirspaceTimePeriod_Ingest> root) {
  fbb.Finish(root, AirspaceTimePeriod_IngestIdentifier());
}

inline void FinishSizePrefixedAirspaceTimePeriod_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirspaceTimePeriod_Ingest> root) {
  fbb.FinishSizePrefixed(root, AirspaceTimePeriod_IngestIdentifier());
}
