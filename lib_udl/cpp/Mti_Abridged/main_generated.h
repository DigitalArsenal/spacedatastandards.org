...
struct Mti_Abridged;
struct Mti_AbridgedBuilder;

enum Mti_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Mti_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Mti_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Mti_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Mti_Abridged_dataMode_Enum_EXERCISE = 3,
  Mti_Abridged_dataMode_Enum_MIN = Mti_Abridged_dataMode_Enum_REAL,
  Mti_Abridged_dataMode_Enum_MAX = Mti_Abridged_dataMode_Enum_EXERCISE
};

inline const Mti_Abridged_dataMode_Enum (&EnumValuesMti_Abridged_dataMode_Enum())[4] {
  static const Mti_Abridged_dataMode_Enum values[] = {
    Mti_Abridged_dataMode_Enum_REAL,
    Mti_Abridged_dataMode_Enum_TEST,
    Mti_Abridged_dataMode_Enum_SIMULATED,
    Mti_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesMti_Abridged_dataMode_Enum() {
...
inline const char *EnumNameMti_Abridged_dataMode_Enum(Mti_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Mti_Abridged_dataMode_Enum_REAL, Mti_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesMti_Abridged_dataMode_Enum()[index];
}

/// /// Information on the mission and flight plans, the type and configuration of the platform, and the reference time.
struct Mti_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Mti_AbridgedBuilder Builder;
  ...
  Mti_Abridged_dataMode_Enum dataMode() const {
    return static_cast<Mti_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Mti_AbridgedBuilder {
  typedef Mti_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Mti_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Mti_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Mti_Abridged::VT_ORIGIN, origin);
  }
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Mti_Abridged::VT_ID, id);
  }
  void add_dataMode(Mti_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Mti_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Mti_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Mti_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_p3(::flatbuffers::Offset<::flatbuffers::String> p3) {
    fbb_.AddOffset(Mti_Abridged::VT_P3, p3);
  }
  void add_p6(::flatbuffers::Offset<::flatbuffers::String> p6) {
    fbb_.AddOffset(Mti_Abridged::VT_P6, p6);
  }
  void add_p7(::flatbuffers::Offset<::flatbuffers::String> p7) {
    fbb_.AddOffset(Mti_Abridged::VT_P7, p7);
  }
  void add_p8(::flatbuffers::Offset<::flatbuffers::String> p8) {
    fbb_.AddOffset(Mti_Abridged::VT_P8, p8);
  }
  void add_p9(int32_t p9) {
    fbb_.AddElement<int32_t>(Mti_Abridged::VT_P9, p9, 0);
  }
  void add_p10(int32_t p10) {
    fbb_.AddElement<int32_t>(Mti_Abridged::VT_P10, p10, 0);
  }
  void add_missions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> missions) {
    fbb_.AddOffset(Mti_Abridged::VT_MISSIONS, missions);
  }
  void add_dwells(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dwells) {
    fbb_.AddOffset(Mti_Abridged::VT_DWELLS, dwells);
  }
  void add_hrrs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> hrrs) {
    fbb_.AddOffset(Mti_Abridged::VT_HRRS, hrrs);
  }
  void add_jobDefs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> jobDefs) {
    fbb_.AddOffset(Mti_Abridged::VT_JOBDEFS, jobDefs);
  }
  void add_freeTexts(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> freeTexts) {
    fbb_.AddOffset(Mti_Abridged::VT_FREETEXTS, freeTexts);
  }
  void add_platformLocs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> platformLocs) {
    fbb_.AddOffset(Mti_Abridged::VT_PLATFORMLOCS, platformLocs);
  }
  void add_jobRequests(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> jobRequests) {
    fbb_.AddOffset(Mti_Abridged::VT_JOBREQUESTS, jobRequests);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Mti_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  explicit Mti_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Mti_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Mti_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Mti_Abridged> CreateMti_Abridged(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::String> classificationMarking = 0,
    ::flatbuffers::Offset<::flatbuffers::String> source = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origin = 0,
    ::flatbuffers::Offset<::flatbuffers::String> id = 0,
    Mti_Abridged_dataMode_Enum dataMode = Mti_Abridged_dataMode_Enum_REAL,
  ...
  Mti_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Mti_Abridged> CreateMti_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Mti_Abridged *GetMti_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<Mti_Abridged>(buf);
}

inline const Mti_Abridged *GetSizePrefixedMti_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Mti_Abridged>(buf);
}

inline const char *Mti_AbridgedIdentifier() {
  return "MTIA";
}

inline bool Mti_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Mti_AbridgedIdentifier());
}

inline bool SizePrefixedMti_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Mti_AbridgedIdentifier(), true);
}

inline bool VerifyMti_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Mti_Abridged>(Mti_AbridgedIdentifier());
}

inline bool VerifySizePrefixedMti_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Mti_Abridged>(Mti_AbridgedIdentifier());
}

inline void FinishMti_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Mti_Abridged> root) {
  fbb.Finish(root, Mti_AbridgedIdentifier());
}

inline void FinishSizePrefixedMti_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Mti_Abridged> root) {
  fbb.FinishSizePrefixed(root, Mti_AbridgedIdentifier());
}
