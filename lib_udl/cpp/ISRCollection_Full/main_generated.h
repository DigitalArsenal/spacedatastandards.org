...
struct ISRCollection_Full;
struct ISRCollection_FullBuilder;

enum ISRCollection_Full_dataMode_Enum : int8_t {
  ...
  ISRCollection_Full_dataMode_Enum_MIN = ISRCollection_Full_dataMode_Enum_REAL,
  ISRCollection_Full_dataMode_Enum_MAX = ISRCollection_Full_dataMode_Enum_EXERCISE
};

inline const ISRCollection_Full_dataMode_Enum (&EnumValuesISRCollection_Full_dataMode_Enum())[4] {
  static const ISRCollection_Full_dataMode_Enum values[] = {
    ISRCollection_Full_dataMode_Enum_REAL,
    ISRCollection_Full_dataMode_Enum_TEST,
    ISRCollection_Full_dataMode_Enum_SIMULATED,
    ISRCollection_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesISRCollection_Full_dataMode_Enum() {
...
inline const char *EnumNameISRCollection_Full_dataMode_Enum(ISRCollection_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, ISRCollection_Full_dataMode_Enum_REAL, ISRCollection_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesISRCollection_Full_dataMode_Enum()[index];
}

/// /// ISR Collection data.
struct ISRCollection_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef ISRCollection_FullBuilder Builder;
  ...
  ISRCollection_Full_dataMode_Enum dataMode() const {
    return static_cast<ISRCollection_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct ISRCollection_FullBuilder {
  typedef ISRCollection_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(ISRCollection_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(ISRCollection_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idexVersion(int32_t idexVersion) {
    fbb_.AddElement<int32_t>(ISRCollection_Full::VT_IDEXVERSION, idexVersion, 0);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(ISRCollection_Full::VT_NAME, name);
  }
  void add_missionId(::flatbuffers::Offset<::flatbuffers::String> missionId) {
    fbb_.AddOffset(ISRCollection_Full::VT_MISSIONID, missionId);
  }
  void add_missionAOR(::flatbuffers::Offset<::flatbuffers::String> missionAOR) {
    fbb_.AddOffset(ISRCollection_Full::VT_MISSIONAOR, missionAOR);
  }
  void add_missionPrimaryIntelDiscipline(::flatbuffers::Offset<::flatbuffers::String> missionPrimaryIntelDiscipline) {
    fbb_.AddOffset(ISRCollection_Full::VT_MISSIONPRIMARYINTELDISCIPLINE, missionPrimaryIntelDiscipline);
  }
  void add_missionPrimarySubCategory(::flatbuffers::Offset<::flatbuffers::String> missionPrimarySubCategory) {
    fbb_.AddOffset(ISRCollection_Full::VT_MISSIONPRIMARYSUBCATEGORY, missionPrimarySubCategory);
  }
  void add_missionSecondaryIntelDiscipline(::flatbuffers::Offset<::flatbuffers::String> missionSecondaryIntelDiscipline) {
    fbb_.AddOffset(ISRCollection_Full::VT_MISSIONSECONDARYINTELDISCIPLINE, missionSecondaryIntelDiscipline);
  }
  void add_missionSecondarySubCategory(::flatbuffers::Offset<::flatbuffers::String> missionSecondarySubCategory) {
    fbb_.AddOffset(ISRCollection_Full::VT_MISSIONSECONDARYSUBCATEGORY, missionSecondarySubCategory);
  }
  void add_missionRole(::flatbuffers::Offset<::flatbuffers::String> missionRole) {
    fbb_.AddOffset(ISRCollection_Full::VT_MISSIONROLE, missionRole);
  }
  void add_missionOperation(::flatbuffers::Offset<::flatbuffers::String> missionOperation) {
    fbb_.AddOffset(ISRCollection_Full::VT_MISSIONOPERATION, missionOperation);
  }
  void add_missionPriority(int32_t missionPriority) {
    fbb_.AddElement<int32_t>(ISRCollection_Full::VT_MISSIONPRIORITY, missionPriority, 0);
  }
  void add_missionSupportedUnit(::flatbuffers::Offset<::flatbuffers::String> missionSupportedUnit) {
    fbb_.AddOffset(ISRCollection_Full::VT_MISSIONSUPPORTEDUNIT, missionSupportedUnit);
  }
  void add_missionEmphasis(::flatbuffers::Offset<::flatbuffers::String> missionEmphasis) {
    fbb_.AddOffset(ISRCollection_Full::VT_MISSIONEMPHASIS, missionEmphasis);
  }
  void add_missionStartPointLat(double missionStartPointLat) {
    fbb_.AddElement<double>(ISRCollection_Full::VT_MISSIONSTARTPOINTLAT, missionStartPointLat, 0.0);
  }
  void add_missionStartPointLong(double missionStartPointLong) {
    fbb_.AddElement<double>(ISRCollection_Full::VT_MISSIONSTARTPOINTLONG, missionStartPointLong, 0.0);
  }
  void add_missionCollectionArea(::flatbuffers::Offset<::flatbuffers::String> missionCollectionArea) {
    fbb_.AddOffset(ISRCollection_Full::VT_MISSIONCOLLECTIONAREA, missionCollectionArea);
  }
  void add_missionJoa(::flatbuffers::Offset<::flatbuffers::String> missionJoa) {
    fbb_.AddOffset(ISRCollection_Full::VT_MISSIONJOA, missionJoa);
  }
  void add_missionSyncMatrixBin(::flatbuffers::Offset<::flatbuffers::String> missionSyncMatrixBin) {
    fbb_.AddOffset(ISRCollection_Full::VT_MISSIONSYNCMATRIXBIN, missionSyncMatrixBin);
  }
  void add_missionCountry(::flatbuffers::Offset<::flatbuffers::String> missionCountry) {
    fbb_.AddOffset(ISRCollection_Full::VT_MISSIONCOUNTRY, missionCountry);
  }
  void add_missionRegion(::flatbuffers::Offset<::flatbuffers::String> missionRegion) {
    fbb_.AddOffset(ISRCollection_Full::VT_MISSIONREGION, missionRegion);
  }
  void add_missionSubRegion(::flatbuffers::Offset<::flatbuffers::String> missionSubRegion) {
    fbb_.AddOffset(ISRCollection_Full::VT_MISSIONSUBREGION, missionSubRegion);
  }
  void add_collectionRequirements(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> collectionRequirements) {
    fbb_.AddOffset(ISRCollection_Full::VT_COLLECTIONREQUIREMENTS, collectionRequirements);
  }
  void add_transit(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> transit) {
    fbb_.AddOffset(ISRCollection_Full::VT_TRANSIT, transit);
  }
  void add_taskings(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> taskings) {
    fbb_.AddOffset(ISRCollection_Full::VT_TASKINGS, taskings);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(ISRCollection_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(ISRCollection_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(ISRCollection_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(ISRCollection_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(ISRCollection_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(ISRCollection_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(ISRCollection_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(ISRCollection_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(ISRCollection_Full::VT_ORIGNETWORK, origNetwork);
  }
  explicit ISRCollection_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<ISRCollection_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<ISRCollection_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<ISRCollection_Full> CreateISRCollection_Full(
    ...
    ISRCollection_Full_dataMode_Enum dataMode = ISRCollection_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  ISRCollection_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<ISRCollection_Full> CreateISRCollection_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateISRCollection_Full(
      _fbb,
      id__,
...
inline const ISRCollection_Full *GetISRCollection_Full(const void *buf) {
  return ::flatbuffers::GetRoot<ISRCollection_Full>(buf);
}

inline const ISRCollection_Full *GetSizePrefixedISRCollection_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<ISRCollection_Full>(buf);
}

inline const char *ISRCollection_FullIdentifier() {
  return "ISRC";
}

inline bool ISRCollection_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ISRCollection_FullIdentifier());
}

inline bool SizePrefixedISRCollection_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ISRCollection_FullIdentifier(), true);
}

inline bool VerifyISRCollection_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<ISRCollection_Full>(ISRCollection_FullIdentifier());
}

inline bool VerifySizePrefixedISRCollection_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<ISRCollection_Full>(ISRCollection_FullIdentifier());
}

inline void FinishISRCollection_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ISRCollection_Full> root) {
  fbb.Finish(root, ISRCollection_FullIdentifier());
}

inline void FinishSizePrefixedISRCollection_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ISRCollection_Full> root) {
  fbb.FinishSizePrefixed(root, ISRCollection_FullIdentifier());
}
