...
struct GNSSRawIF_Ingest;
struct GNSSRawIF_IngestBuilder;

enum GNSSRawIF_Ingest_dataMode_Enum : int8_t {
  ...
  GNSSRawIF_Ingest_dataMode_Enum_MIN = GNSSRawIF_Ingest_dataMode_Enum_REAL,
  GNSSRawIF_Ingest_dataMode_Enum_MAX = GNSSRawIF_Ingest_dataMode_Enum_EXERCISE
};

inline const GNSSRawIF_Ingest_dataMode_Enum (&EnumValuesGNSSRawIF_Ingest_dataMode_Enum())[4] {
  static const GNSSRawIF_Ingest_dataMode_Enum values[] = {
    GNSSRawIF_Ingest_dataMode_Enum_REAL,
    GNSSRawIF_Ingest_dataMode_Enum_TEST,
    GNSSRawIF_Ingest_dataMode_Enum_SIMULATED,
    GNSSRawIF_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesGNSSRawIF_Ingest_dataMode_Enum() {
...
inline const char *EnumNameGNSSRawIF_Ingest_dataMode_Enum(GNSSRawIF_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, GNSSRawIF_Ingest_dataMode_Enum_REAL, GNSSRawIF_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesGNSSRawIF_Ingest_dataMode_Enum()[index];
}
...
struct GNSSRawIF_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef GNSSRawIF_IngestBuilder Builder;
  ...
  GNSSRawIF_Ingest_dataMode_Enum dataMode() const {
    return static_cast<GNSSRawIF_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct GNSSRawIF_IngestBuilder {
  typedef GNSSRawIF_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(GNSSRawIF_Ingest::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_ORIGOBJECTID, origObjectId);
  }
  void add_esId(::flatbuffers::Offset<::flatbuffers::String> esId) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_ESID, esId);
  }
  void add_receiver(::flatbuffers::Offset<::flatbuffers::String> receiver) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_RECEIVER, receiver);
  }
  void add_boresight(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> boresight) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_BORESIGHT, boresight);
  }
  void add_quat(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> quat) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_QUAT, quat);
  }
  void add_startIndex(int32_t startIndex) {
    fbb_.AddElement<int32_t>(GNSSRawIF_Ingest::VT_STARTINDEX, startIndex, 0);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_ENDTIME, endTime);
  }
  void add_startLat(double startLat) {
    fbb_.AddElement<double>(GNSSRawIF_Ingest::VT_STARTLAT, startLat, 0.0);
  }
  void add_startLon(double startLon) {
    fbb_.AddElement<double>(GNSSRawIF_Ingest::VT_STARTLON, startLon, 0.0);
  }
  void add_startAlt(double startAlt) {
    fbb_.AddElement<double>(GNSSRawIF_Ingest::VT_STARTALT, startAlt, 0.0);
  }
  void add_endLat(double endLat) {
    fbb_.AddElement<double>(GNSSRawIF_Ingest::VT_ENDLAT, endLat, 0.0);
  }
  void add_endLon(double endLon) {
    fbb_.AddElement<double>(GNSSRawIF_Ingest::VT_ENDLON, endLon, 0.0);
  }
  void add_endAlt(double endAlt) {
    fbb_.AddElement<double>(GNSSRawIF_Ingest::VT_ENDALT, endAlt, 0.0);
  }
  void add_centerFreq(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> centerFreq) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_CENTERFREQ, centerFreq);
  }
  void add_ifFreq(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> ifFreq) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_IFFREQ, ifFreq);
  }
  void add_sampleRate(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sampleRate) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_SAMPLERATE, sampleRate);
  }
  void add_postFourier(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> postFourier) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_POSTFOURIER, postFourier);
  }
  void add_sampleType(::flatbuffers::Offset<::flatbuffers::String> sampleType) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_SAMPLETYPE, sampleType);
  }
  void add_bitDepth(int32_t bitDepth) {
    fbb_.AddElement<int32_t>(GNSSRawIF_Ingest::VT_BITDEPTH, bitDepth, 0);
  }
  void add_diffCodeBias(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> diffCodeBias) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_DIFFCODEBIAS, diffCodeBias);
  }
  void add_dataRate(double dataRate) {
    fbb_.AddElement<double>(GNSSRawIF_Ingest::VT_DATARATE, dataRate, 0.0);
  }
  void add_setId(::flatbuffers::Offset<::flatbuffers::String> setId) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_SETID, setId);
  }
  void add_setLength(int32_t setLength) {
    fbb_.AddElement<int32_t>(GNSSRawIF_Ingest::VT_SETLENGTH, setLength, 0);
  }
  void add_sequenceID(int32_t sequenceID) {
    fbb_.AddElement<int32_t>(GNSSRawIF_Ingest::VT_SEQUENCEID, sequenceID, 0);
  }
  void add_fileName(::flatbuffers::Offset<::flatbuffers::String> fileName) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_FILENAME, fileName);
  }
  void add_srcTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcTyps) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_SRCTYPS, srcTyps);
  }
  void add_srcIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcIds) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_SRCIDS, srcIds);
  }
  void add_fileSize(int64_t fileSize) {
    fbb_.AddElement<int64_t>(GNSSRawIF_Ingest::VT_FILESIZE, fileSize, 0);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_TAGS, tags);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(GNSSRawIF_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(GNSSRawIF_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(GNSSRawIF_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  explicit GNSSRawIF_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<GNSSRawIF_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<GNSSRawIF_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<GNSSRawIF_Ingest> CreateGNSSRawIF_Ingest(
    ...
    GNSSRawIF_Ingest_dataMode_Enum dataMode = GNSSRawIF_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  GNSSRawIF_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<GNSSRawIF_Ingest> CreateGNSSRawIF_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const GNSSRawIF_Ingest *GetGNSSRawIF_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<GNSSRawIF_Ingest>(buf);
}

inline const GNSSRawIF_Ingest *GetSizePrefixedGNSSRawIF_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<GNSSRawIF_Ingest>(buf);
}

inline const char *GNSSRawIF_IngestIdentifier() {
  return "GNSS";
}

inline bool GNSSRawIF_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, GNSSRawIF_IngestIdentifier());
}

inline bool SizePrefixedGNSSRawIF_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, GNSSRawIF_IngestIdentifier(), true);
}

inline bool VerifyGNSSRawIF_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<GNSSRawIF_Ingest>(GNSSRawIF_IngestIdentifier());
}

inline bool VerifySizePrefixedGNSSRawIF_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<GNSSRawIF_Ingest>(GNSSRawIF_IngestIdentifier());
}

inline void FinishGNSSRawIF_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<GNSSRawIF_Ingest> root) {
  fbb.Finish(root, GNSSRawIF_IngestIdentifier());
}

inline void FinishSizePrefixedGNSSRawIF_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<GNSSRawIF_Ingest> root) {
  fbb.FinishSizePrefixed(root, GNSSRawIF_IngestIdentifier());
}
