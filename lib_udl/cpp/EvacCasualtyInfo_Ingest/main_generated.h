...
struct EvacCasualtyInfo_Ingest;
struct EvacCasualtyInfo_IngestBuilder;

/// /// Identity and medical information on the patient to be evacuated.
struct EvacCasualtyInfo_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EvacCasualtyInfo_IngestBuilder Builder;
...
inline ::flatbuffers::Offset<EvacCasualtyInfo_Ingest> CreateEvacCasualtyInfo_Ingest(
  ...
  EvacCasualtyInfo_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<EvacCasualtyInfo_Ingest> CreateEvacCasualtyInfo_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const EvacCasualtyInfo_Ingest *GetEvacCasualtyInfo_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<EvacCasualtyInfo_Ingest>(buf);
}

inline const EvacCasualtyInfo_Ingest *GetSizePrefixedEvacCasualtyInfo_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EvacCasualtyInfo_Ingest>(buf);
}

inline const char *EvacCasualtyInfo_IngestIdentifier() {
  return "EVAC";
}

inline bool EvacCasualtyInfo_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EvacCasualtyInfo_IngestIdentifier());
}

inline bool SizePrefixedEvacCasualtyInfo_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EvacCasualtyInfo_IngestIdentifier(), true);
}

inline bool VerifyEvacCasualtyInfo_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EvacCasualtyInfo_Ingest>(EvacCasualtyInfo_IngestIdentifier());
}

inline bool VerifySizePrefixedEvacCasualtyInfo_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EvacCasualtyInfo_Ingest>(EvacCasualtyInfo_IngestIdentifier());
}

inline void FinishEvacCasualtyInfo_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EvacCasualtyInfo_Ingest> root) {
  fbb.Finish(root, EvacCasualtyInfo_IngestIdentifier());
}

inline void FinishSizePrefixedEvacCasualtyInfo_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EvacCasualtyInfo_Ingest> root) {
  fbb.FinishSizePrefixed(root, EvacCasualtyInfo_IngestIdentifier());
}
