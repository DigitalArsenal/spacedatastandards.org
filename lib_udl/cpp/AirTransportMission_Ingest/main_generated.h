...
struct AirTransportMission_Ingest;
struct AirTransportMission_IngestBuilder;

enum AirTransportMission_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  AirTransportMission_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  AirTransportMission_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  AirTransportMission_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  AirTransportMission_Ingest_dataMode_Enum_EXERCISE = 3,
  AirTransportMission_Ingest_dataMode_Enum_MIN = AirTransportMission_Ingest_dataMode_Enum_REAL,
  AirTransportMission_Ingest_dataMode_Enum_MAX = AirTransportMission_Ingest_dataMode_Enum_EXERCISE
};

inline const AirTransportMission_Ingest_dataMode_Enum (&EnumValuesAirTransportMission_Ingest_dataMode_Enum())[4] {
  static const AirTransportMission_Ingest_dataMode_Enum values[] = {
    AirTransportMission_Ingest_dataMode_Enum_REAL,
    AirTransportMission_Ingest_dataMode_Enum_TEST,
    AirTransportMission_Ingest_dataMode_Enum_SIMULATED,
    AirTransportMission_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAirTransportMission_Ingest_dataMode_Enum() {
...
inline const char *EnumNameAirTransportMission_Ingest_dataMode_Enum(AirTransportMission_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AirTransportMission_Ingest_dataMode_Enum_REAL, AirTransportMission_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAirTransportMission_Ingest_dataMode_Enum()[index];
}
...
struct AirTransportMission_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirTransportMission_IngestBuilder Builder;
  ...
  AirTransportMission_Ingest_dataMode_Enum dataMode() const {
    return static_cast<AirTransportMission_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AirTransportMission_IngestBuilder {
  typedef AirTransportMission_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_origMissionId(::flatbuffers::Offset<::flatbuffers::String> origMissionId) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_ORIGMISSIONID, origMissionId);
  }
  void add_amcMissionId(::flatbuffers::Offset<::flatbuffers::String> amcMissionId) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_AMCMISSIONID, amcMissionId);
  }
  void add_gdssMissionId(::flatbuffers::Offset<::flatbuffers::String> gdssMissionId) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_GDSSMISSIONID, gdssMissionId);
  }
  void add_prevMissionId(::flatbuffers::Offset<::flatbuffers::String> prevMissionId) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_PREVMISSIONID, prevMissionId);
  }
  void add_prevAMCMissionId(::flatbuffers::Offset<::flatbuffers::String> prevAMCMissionId) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_PREVAMCMISSIONID, prevAMCMissionId);
  }
  void add_nextMissionId(::flatbuffers::Offset<::flatbuffers::String> nextMissionId) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_NEXTMISSIONID, nextMissionId);
  }
  void add_nextAMCMissionId(::flatbuffers::Offset<::flatbuffers::String> nextAMCMissionId) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_NEXTAMCMISSIONID, nextAMCMissionId);
  }
  void add_objective(::flatbuffers::Offset<::flatbuffers::String> objective) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_OBJECTIVE, objective);
  }
  void add_purpose(::flatbuffers::Offset<::flatbuffers::String> purpose) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_PURPOSE, purpose);
  }
  void add_jcsPriority(::flatbuffers::Offset<::flatbuffers::String> jcsPriority) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_JCSPRIORITY, jcsPriority);
  }
  void add_cw(bool cw) {
    fbb_.AddElement<uint8_t>(AirTransportMission_Ingest::VT_CW, static_cast<uint8_t>(cw), 0);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_TYPE, type);
  }
  void add_firstPickUp(::flatbuffers::Offset<::flatbuffers::String> firstPickUp) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_FIRSTPICKUP, firstPickUp);
  }
  void add_lastDropOff(::flatbuffers::Offset<::flatbuffers::String> lastDropOff) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_LASTDROPOFF, lastDropOff);
  }
  void add_alias(::flatbuffers::Offset<::flatbuffers::String> alias) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_ALIAS, alias);
  }
  void add_callSign(::flatbuffers::Offset<::flatbuffers::String> callSign) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_CALLSIGN, callSign);
  }
  void add_operation(::flatbuffers::Offset<::flatbuffers::String> operation) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_OPERATION, operation);
  }
  void add_naf(::flatbuffers::Offset<::flatbuffers::String> naf) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_NAF, naf);
  }
  void add_allocatedUnit(::flatbuffers::Offset<::flatbuffers::String> allocatedUnit) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_ALLOCATEDUNIT, allocatedUnit);
  }
  void add_loadCategoryType(::flatbuffers::Offset<::flatbuffers::String> loadCategoryType) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_LOADCATEGORYTYPE, loadCategoryType);
  }
  void add_state(::flatbuffers::Offset<::flatbuffers::String> state) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_STATE, state);
  }
  void add_sourceSysDeviation(double sourceSysDeviation) {
    fbb_.AddElement<double>(AirTransportMission_Ingest::VT_SOURCESYSDEVIATION, sourceSysDeviation, 0.0);
  }
  void add_apacsId(::flatbuffers::Offset<::flatbuffers::String> apacsId) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_APACSID, apacsId);
  }
  void add_dipWorksheetName(::flatbuffers::Offset<::flatbuffers::String> dipWorksheetName) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_DIPWORKSHEETNAME, dipWorksheetName);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_UPDATEDBY, updatedBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(AirTransportMission_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AirTransportMission_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_requirements(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> requirements) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_REQUIREMENTS, requirements);
  }
  void add_remarks(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> remarks) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_REMARKS, remarks);
  }
  void add_hazMat(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> hazMat) {
    fbb_.AddOffset(AirTransportMission_Ingest::VT_HAZMAT, hazMat);
  }
  explicit AirTransportMission_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirTransportMission_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirTransportMission_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirTransportMission_Ingest> CreateAirTransportMission_Ingest(
    ...
    AirTransportMission_Ingest_dataMode_Enum dataMode = AirTransportMission_Ingest_dataMode_Enum_REAL,
  ...
  AirTransportMission_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirTransportMission_Ingest> CreateAirTransportMission_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAirTransportMission_Ingest(
      _fbb,
      id__,
...
inline const AirTransportMission_Ingest *GetAirTransportMission_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<AirTransportMission_Ingest>(buf);
}

inline const AirTransportMission_Ingest *GetSizePrefixedAirTransportMission_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirTransportMission_Ingest>(buf);
}

inline const char *AirTransportMission_IngestIdentifier() {
  return "AIRT";
}

inline bool AirTransportMission_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirTransportMission_IngestIdentifier());
}

inline bool SizePrefixedAirTransportMission_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirTransportMission_IngestIdentifier(), true);
}

inline bool VerifyAirTransportMission_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirTransportMission_Ingest>(AirTransportMission_IngestIdentifier());
}

inline bool VerifySizePrefixedAirTransportMission_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirTransportMission_Ingest>(AirTransportMission_IngestIdentifier());
}

inline void FinishAirTransportMission_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirTransportMission_Ingest> root) {
  fbb.Finish(root, AirTransportMission_IngestIdentifier());
}

inline void FinishSizePrefixedAirTransportMission_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirTransportMission_Ingest> root) {
  fbb.FinishSizePrefixed(root, AirTransportMission_IngestIdentifier());
}
