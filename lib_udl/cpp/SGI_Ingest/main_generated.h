...
struct SGI_Ingest;
struct SGI_IngestBuilder;

enum SGI_Ingest_state_Enum : int8_t {
  /// No description available.
  SGI_Ingest_state_Enum_I = 0,
  /// No description available.
  SGI_Ingest_state_Enum_N = 1,
  /// No description available.
  SGI_Ingest_state_Enum_P = 2,
  SGI_Ingest_state_Enum_MIN = SGI_Ingest_state_Enum_I,
  SGI_Ingest_state_Enum_MAX = SGI_Ingest_state_Enum_P
};

inline const SGI_Ingest_state_Enum (&EnumValuesSGI_Ingest_state_Enum())[3] {
  static const SGI_Ingest_state_Enum values[] = {
    SGI_Ingest_state_Enum_I,
    SGI_Ingest_state_Enum_N,
    SGI_Ingest_state_Enum_P
  };
  return values;
}

inline const char * const *EnumNamesSGI_Ingest_state_Enum() {
...
inline const char *EnumNameSGI_Ingest_state_Enum(SGI_Ingest_state_Enum e) {
  if (::flatbuffers::IsOutRange(e, SGI_Ingest_state_Enum_I, SGI_Ingest_state_Enum_P)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSGI_Ingest_state_Enum()[index];
}

enum SGI_Ingest_precedence_Enum : int8_t {
  /// No description available.
  SGI_Ingest_precedence_Enum_O = 0,
  /// No description available.
  SGI_Ingest_precedence_Enum_P = 1,
  /// No description available.
  SGI_Ingest_precedence_Enum_R = 2,
  /// No description available.
  SGI_Ingest_precedence_Enum_Y = 3,
  /// No description available.
  SGI_Ingest_precedence_Enum_Z = 4,
  SGI_Ingest_precedence_Enum_MIN = SGI_Ingest_precedence_Enum_O,
  SGI_Ingest_precedence_Enum_MAX = SGI_Ingest_precedence_Enum_Z
};

inline const SGI_Ingest_precedence_Enum (&EnumValuesSGI_Ingest_precedence_Enum())[5] {
  static const SGI_Ingest_precedence_Enum values[] = {
    SGI_Ingest_precedence_Enum_O,
    SGI_Ingest_precedence_Enum_P,
    SGI_Ingest_precedence_Enum_R,
    SGI_Ingest_precedence_Enum_Y,
    SGI_Ingest_precedence_Enum_Z
  };
  return values;
}

inline const char * const *EnumNamesSGI_Ingest_precedence_Enum() {
...
inline const char *EnumNameSGI_Ingest_precedence_Enum(SGI_Ingest_precedence_Enum e) {
  if (::flatbuffers::IsOutRange(e, SGI_Ingest_precedence_Enum_O, SGI_Ingest_precedence_Enum_Z)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSGI_Ingest_precedence_Enum()[index];
}

enum SGI_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  SGI_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  SGI_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  SGI_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  SGI_Ingest_dataMode_Enum_EXERCISE = 3,
  SGI_Ingest_dataMode_Enum_MIN = SGI_Ingest_dataMode_Enum_REAL,
  SGI_Ingest_dataMode_Enum_MAX = SGI_Ingest_dataMode_Enum_EXERCISE
};

inline const SGI_Ingest_dataMode_Enum (&EnumValuesSGI_Ingest_dataMode_Enum())[4] {
  static const SGI_Ingest_dataMode_Enum values[] = {
    SGI_Ingest_dataMode_Enum_REAL,
    SGI_Ingest_dataMode_Enum_TEST,
    SGI_Ingest_dataMode_Enum_SIMULATED,
    SGI_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSGI_Ingest_dataMode_Enum() {
...
inline const char *EnumNameSGI_Ingest_dataMode_Enum(SGI_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SGI_Ingest_dataMode_Enum_REAL, SGI_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSGI_Ingest_dataMode_Enum()[index];
}

/// /// Model representation of space weather/solar, geomagnetic, and radiation belt indices.
struct SGI_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SGI_IngestBuilder Builder;
  ...
  SGI_Ingest_state_Enum state() const {
    return static_cast<SGI_Ingest_state_Enum>(GetField<int8_t>(VT_STATE, 0));
  }
  ...
  /// Example: /// Example: R
  /// Constraints: Minimum length = 0, Maximum length = 1
  SGI_Ingest_precedence_Enum precedence() const {
    return static_cast<SGI_Ingest_precedence_Enum>(GetField<int8_t>(VT_PRECEDENCE, 0));
  }
  ...
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *observedBaseline() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_OBSERVEDBASELINE);
  }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SGI_Ingest_dataMode_Enum dataMode() const {
    return static_cast<SGI_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_OBSERVEDBASELINE) &&
           verifier.VerifyVector(observedBaseline()) &&
           verifier.VerifyVectorOfStrings(observedBaseline()) &&
...
struct SGI_IngestBuilder {
  typedef SGI_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SGI_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SGI_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_effectiveDate(::flatbuffers::Offset<::flatbuffers::String> effectiveDate) {
    fbb_.AddOffset(SGI_Ingest::VT_EFFECTIVEDATE, effectiveDate);
  }
  void add_sgiDate(::flatbuffers::Offset<::flatbuffers::String> sgiDate) {
    fbb_.AddOffset(SGI_Ingest::VT_SGIDATE, sgiDate);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(SGI_Ingest::VT_TYPE, type);
  }
  void add_state(SGI_Ingest_state_Enum state) {
    fbb_.AddElement<int8_t>(SGI_Ingest::VT_STATE, static_cast<int8_t>(state), 0);
  }
  void add_stationName(::flatbuffers::Offset<::flatbuffers::String> stationName) {
    fbb_.AddOffset(SGI_Ingest::VT_STATIONNAME, stationName);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(SGI_Ingest::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(SGI_Ingest::VT_ORIGSENSORID, origSensorId);
  }
  void add_mode(int32_t mode) {
    fbb_.AddElement<int32_t>(SGI_Ingest::VT_MODE, mode, 0);
  }
  void add_precedence(SGI_Ingest_precedence_Enum precedence) {
    fbb_.AddElement<int8_t>(SGI_Ingest::VT_PRECEDENCE, static_cast<int8_t>(precedence), 0);
  }
  void add_coeffDegree(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> coeffDegree) {
    fbb_.AddOffset(SGI_Ingest::VT_COEFFDEGREE, coeffDegree);
  }
  void add_coeffOrder(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> coeffOrder) {
    fbb_.AddOffset(SGI_Ingest::VT_COEFFORDER, coeffOrder);
  }
  void add_ctce(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> ctce) {
    fbb_.AddOffset(SGI_Ingest::VT_CTCE, ctce);
  }
  void add_stce(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> stce) {
    fbb_.AddOffset(SGI_Ingest::VT_STCE, stce);
  }
  void add_ctci(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> ctci) {
    fbb_.AddOffset(SGI_Ingest::VT_CTCI, ctci);
  }
  void add_stci(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> stci) {
    fbb_.AddOffset(SGI_Ingest::VT_STCI, stci);
  }
  void add_e10(double e10) {
    fbb_.AddElement<double>(SGI_Ingest::VT_E10, e10, 0.0);
  }
  void add_e54(double e54) {
    fbb_.AddElement<double>(SGI_Ingest::VT_E54, e54, 0.0);
  }
  void add_s10(double s10) {
    fbb_.AddElement<double>(SGI_Ingest::VT_S10, s10, 0.0);
  }
  void add_s54(double s54) {
    fbb_.AddElement<double>(SGI_Ingest::VT_S54, s54, 0.0);
  }
  void add_m10(double m10) {
    fbb_.AddElement<double>(SGI_Ingest::VT_M10, m10, 0.0);
  }
  void add_m54(double m54) {
    fbb_.AddElement<double>(SGI_Ingest::VT_M54, m54, 0.0);
  }
  void add_y10(double y10) {
    fbb_.AddElement<double>(SGI_Ingest::VT_Y10, y10, 0.0);
  }
  void add_y54(double y54) {
    fbb_.AddElement<double>(SGI_Ingest::VT_Y54, y54, 0.0);
  }
  void add_f10(double f10) {
    fbb_.AddElement<double>(SGI_Ingest::VT_F10, f10, 0.0);
  }
  void add_f54(double f54) {
    fbb_.AddElement<double>(SGI_Ingest::VT_F54, f54, 0.0);
  }
  void add_f81(double f81) {
    fbb_.AddElement<double>(SGI_Ingest::VT_F81, f81, 0.0);
  }
  void add_ap(double ap) {
    fbb_.AddElement<double>(SGI_Ingest::VT_AP, ap, 0.0);
  }
  void add_apDuration(int32_t apDuration) {
    fbb_.AddElement<int32_t>(SGI_Ingest::VT_APDURATION, apDuration, 0);
  }
  void add_kIndex(int32_t kIndex) {
    fbb_.AddElement<int32_t>(SGI_Ingest::VT_KINDEX, kIndex, 0);
  }
  void add_kp(double kp) {
    fbb_.AddElement<double>(SGI_Ingest::VT_KP, kp, 0.0);
  }
  void add_kpDuration(int32_t kpDuration) {
    fbb_.AddElement<int32_t>(SGI_Ingest::VT_KPDURATION, kpDuration, 0);
  }
  void add_gamma(int32_t gamma) {
    fbb_.AddElement<int32_t>(SGI_Ingest::VT_GAMMA, gamma, 0);
  }
  void add_dst(double dst) {
    fbb_.AddElement<double>(SGI_Ingest::VT_DST, dst, 0.0);
  }
  void add_dtc(double dtc) {
    fbb_.AddElement<double>(SGI_Ingest::VT_DTC, dtc, 0.0);
  }
  void add_rbRegionCode(int32_t rbRegionCode) {
    fbb_.AddElement<int32_t>(SGI_Ingest::VT_RBREGIONCODE, rbRegionCode, 0);
  }
  void add_rbIndex(double rbIndex) {
    fbb_.AddElement<double>(SGI_Ingest::VT_RBINDEX, rbIndex, 0.0);
  }
  void add_normFactor(double normFactor) {
    fbb_.AddElement<double>(SGI_Ingest::VT_NORMFACTOR, normFactor, 0.0);
  }
  void add_rbDuration(int32_t rbDuration) {
    fbb_.AddElement<int32_t>(SGI_Ingest::VT_RBDURATION, rbDuration, 0);
  }
  void add_analyzerAttenuation(double analyzerAttenuation) {
    fbb_.AddElement<double>(SGI_Ingest::VT_ANALYZERATTENUATION, analyzerAttenuation, 0.0);
  }
  void add_observedBaseline(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> observedBaseline) {
    fbb_.AddOffset(SGI_Ingest::VT_OBSERVEDBASELINE, observedBaseline);
  }
  void add_frequencies(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> frequencies) {
    fbb_.AddOffset(SGI_Ingest::VT_FREQUENCIES, frequencies);
  }
  void add_powers(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> powers) {
    fbb_.AddOffset(SGI_Ingest::VT_POWERS, powers);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(SGI_Ingest::VT_RAWFILEURI, rawFileURI);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(SGI_Ingest::VT_TRANSACTIONID, transactionId);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(SGI_Ingest::VT_TAGS, tags);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SGI_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SGI_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SGI_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(SGI_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SGI_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SGI_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SGI_Ingest::VT_CREATEDBY, createdBy);
  }
  explicit SGI_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SGI_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SGI_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SGI_Ingest> CreateSGI_Ingest(
    ...
    SGI_Ingest_state_Enum state = SGI_Ingest_state_Enum_I,
    ...
    int32_t mode = 0,
    SGI_Ingest_precedence_Enum precedence = SGI_Ingest_precedence_Enum_O,
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> observedBaseline = 0,
    ...
    SGI_Ingest_dataMode_Enum dataMode = SGI_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0) {
  SGI_IngestBuilder builder_(_fbb);
  ...
  builder_.add_observedBaseline(observedBaseline);
...
inline ::flatbuffers::Offset<SGI_Ingest> CreateSGI_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ...
    int32_t rbDuration = 0,
    double analyzerAttenuation = 0.0,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *observedBaseline = nullptr,
  ...
  auto observedBaseline__ = observedBaseline ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*observedBaseline) : 0;
...
inline const SGI_Ingest *GetSGI_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<SGI_Ingest>(buf);
}

inline const SGI_Ingest *GetSizePrefixedSGI_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SGI_Ingest>(buf);
}

inline const char *SGI_IngestIdentifier() {
  return "SGII";
}

inline bool SGI_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SGI_IngestIdentifier());
}

inline bool SizePrefixedSGI_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SGI_IngestIdentifier(), true);
}

inline bool VerifySGI_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SGI_Ingest>(SGI_IngestIdentifier());
}

inline bool VerifySizePrefixedSGI_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SGI_Ingest>(SGI_IngestIdentifier());
}

inline void FinishSGI_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SGI_Ingest> root) {
  fbb.Finish(root, SGI_IngestIdentifier());
}

inline void FinishSizePrefixedSGI_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SGI_Ingest> root) {
  fbb.FinishSizePrefixed(root, SGI_IngestIdentifier());
}
