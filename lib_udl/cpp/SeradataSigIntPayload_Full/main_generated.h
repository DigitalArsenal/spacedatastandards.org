...
struct SeradataSigIntPayload_Full;
struct SeradataSigIntPayload_FullBuilder;

enum SeradataSigIntPayload_Full_dataMode_Enum : int8_t {
  ...
  SeradataSigIntPayload_Full_dataMode_Enum_MIN = SeradataSigIntPayload_Full_dataMode_Enum_REAL,
  SeradataSigIntPayload_Full_dataMode_Enum_MAX = SeradataSigIntPayload_Full_dataMode_Enum_EXERCISE
};

inline const SeradataSigIntPayload_Full_dataMode_Enum (&EnumValuesSeradataSigIntPayload_Full_dataMode_Enum())[4] {
  static const SeradataSigIntPayload_Full_dataMode_Enum values[] = {
    SeradataSigIntPayload_Full_dataMode_Enum_REAL,
    SeradataSigIntPayload_Full_dataMode_Enum_TEST,
    SeradataSigIntPayload_Full_dataMode_Enum_SIMULATED,
    SeradataSigIntPayload_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSeradataSigIntPayload_Full_dataMode_Enum() {
...
inline const char *EnumNameSeradataSigIntPayload_Full_dataMode_Enum(SeradataSigIntPayload_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SeradataSigIntPayload_Full_dataMode_Enum_REAL, SeradataSigIntPayload_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSeradataSigIntPayload_Full_dataMode_Enum()[index];
}

/// /// Details for an sigint payload from  Seradata.
struct SeradataSigIntPayload_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SeradataSigIntPayload_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SeradataSigIntPayload_Full_dataMode_Enum dataMode() const {
    return static_cast<SeradataSigIntPayload_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SeradataSigIntPayload_FullBuilder {
  typedef SeradataSigIntPayload_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_spacecraftId(::flatbuffers::Offset<::flatbuffers::String> spacecraftId) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_SPACECRAFTID, spacecraftId);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_IDSENSOR, idSensor);
  }
  void add_hostedForCompanyOrgId(::flatbuffers::Offset<::flatbuffers::String> hostedForCompanyOrgId) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_HOSTEDFORCOMPANYORGID, hostedForCompanyOrgId);
  }
  void add_manufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrgId) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_MANUFACTURERORGID, manufacturerOrgId);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_TYPE, type);
  }
  void add_swathWidth(double swathWidth) {
    fbb_.AddElement<double>(SeradataSigIntPayload_Full::VT_SWATHWIDTH, swathWidth, 0.0);
  }
  void add_groundStations(::flatbuffers::Offset<::flatbuffers::String> groundStations) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_GROUNDSTATIONS, groundStations);
  }
  void add_groundStationLocations(::flatbuffers::Offset<::flatbuffers::String> groundStationLocations) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_GROUNDSTATIONLOCATIONS, groundStationLocations);
  }
  void add_frequencyCoverage(::flatbuffers::Offset<::flatbuffers::String> frequencyCoverage) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_FREQUENCYCOVERAGE, frequencyCoverage);
  }
  void add_positionalAccuracy(::flatbuffers::Offset<::flatbuffers::String> positionalAccuracy) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_POSITIONALACCURACY, positionalAccuracy);
  }
  void add_interceptParameters(::flatbuffers::Offset<::flatbuffers::String> interceptParameters) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_INTERCEPTPARAMETERS, interceptParameters);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_NAME, name);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_NOTES, notes);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SeradataSigIntPayload_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(SeradataSigIntPayload_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SeradataSigIntPayload_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit SeradataSigIntPayload_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SeradataSigIntPayload_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SeradataSigIntPayload_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SeradataSigIntPayload_Full> CreateSeradataSigIntPayload_Full(
    ...
    SeradataSigIntPayload_Full_dataMode_Enum dataMode = SeradataSigIntPayload_Full_dataMode_Enum_REAL) {
  SeradataSigIntPayload_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SeradataSigIntPayload_Full> CreateSeradataSigIntPayload_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateSeradataSigIntPayload_Full(
      _fbb,
      id__,
...
inline const SeradataSigIntPayload_Full *GetSeradataSigIntPayload_Full(const void *buf) {
  return ::flatbuffers::GetRoot<SeradataSigIntPayload_Full>(buf);
}

inline const SeradataSigIntPayload_Full *GetSizePrefixedSeradataSigIntPayload_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SeradataSigIntPayload_Full>(buf);
}

inline const char *SeradataSigIntPayload_FullIdentifier() {
  return "SERA";
}

inline bool SeradataSigIntPayload_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataSigIntPayload_FullIdentifier());
}

inline bool SizePrefixedSeradataSigIntPayload_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataSigIntPayload_FullIdentifier(), true);
}

inline bool VerifySeradataSigIntPayload_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SeradataSigIntPayload_Full>(SeradataSigIntPayload_FullIdentifier());
}

inline bool VerifySizePrefixedSeradataSigIntPayload_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SeradataSigIntPayload_Full>(SeradataSigIntPayload_FullIdentifier());
}

inline void FinishSeradataSigIntPayload_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataSigIntPayload_Full> root) {
  fbb.Finish(root, SeradataSigIntPayload_FullIdentifier());
}

inline void FinishSizePrefixedSeradataSigIntPayload_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataSigIntPayload_Full> root) {
  fbb.FinishSizePrefixed(root, SeradataSigIntPayload_FullIdentifier());
}
