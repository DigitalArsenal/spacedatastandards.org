...
struct Hazard_Ingest;
struct Hazard_IngestBuilder;

enum Hazard_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Hazard_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Hazard_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Hazard_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Hazard_Ingest_dataMode_Enum_EXERCISE = 3,
  Hazard_Ingest_dataMode_Enum_MIN = Hazard_Ingest_dataMode_Enum_REAL,
  Hazard_Ingest_dataMode_Enum_MAX = Hazard_Ingest_dataMode_Enum_EXERCISE
};

inline const Hazard_Ingest_dataMode_Enum (&EnumValuesHazard_Ingest_dataMode_Enum())[4] {
  static const Hazard_Ingest_dataMode_Enum values[] = {
    Hazard_Ingest_dataMode_Enum_REAL,
    Hazard_Ingest_dataMode_Enum_TEST,
    Hazard_Ingest_dataMode_Enum_SIMULATED,
    Hazard_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesHazard_Ingest_dataMode_Enum() {
...
inline const char *EnumNameHazard_Ingest_dataMode_Enum(Hazard_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Hazard_Ingest_dataMode_Enum_REAL, Hazard_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesHazard_Ingest_dataMode_Enum()[index];
}
...
struct Hazard_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Hazard_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Hazard_Ingest_dataMode_Enum dataMode() const {
    return static_cast<Hazard_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Hazard_IngestBuilder {
  typedef Hazard_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Hazard_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Hazard_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_detectType(::flatbuffers::Offset<::flatbuffers::String> detectType) {
    fbb_.AddOffset(Hazard_Ingest::VT_DETECTTYPE, detectType);
  }
  void add_detectTime(::flatbuffers::Offset<::flatbuffers::String> detectTime) {
    fbb_.AddOffset(Hazard_Ingest::VT_DETECTTIME, detectTime);
  }
  void add_harmful(bool harmful) {
    fbb_.AddElement<uint8_t>(Hazard_Ingest::VT_HARMFUL, static_cast<uint8_t>(harmful), 0);
  }
  void add_alarms(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> alarms) {
    fbb_.AddOffset(Hazard_Ingest::VT_ALARMS, alarms);
  }
  void add_alarmValues(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> alarmValues) {
    fbb_.AddOffset(Hazard_Ingest::VT_ALARMVALUES, alarmValues);
  }
  void add_readings(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> readings) {
    fbb_.AddOffset(Hazard_Ingest::VT_READINGS, readings);
  }
  void add_readingUnits(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> readingUnits) {
    fbb_.AddOffset(Hazard_Ingest::VT_READINGUNITS, readingUnits);
  }
  void add_readingValues(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> readingValues) {
    fbb_.AddOffset(Hazard_Ingest::VT_READINGVALUES, readingValues);
  }
  void add_matType(::flatbuffers::Offset<::flatbuffers::String> matType) {
    fbb_.AddOffset(Hazard_Ingest::VT_MATTYPE, matType);
  }
  void add_matClass(::flatbuffers::Offset<::flatbuffers::String> matClass) {
    fbb_.AddOffset(Hazard_Ingest::VT_MATCLASS, matClass);
  }
  void add_matName(::flatbuffers::Offset<::flatbuffers::String> matName) {
    fbb_.AddOffset(Hazard_Ingest::VT_MATNAME, matName);
  }
  void add_matCat(int32_t matCat) {
    fbb_.AddElement<int32_t>(Hazard_Ingest::VT_MATCAT, matCat, 0);
  }
  void add_casRN(::flatbuffers::Offset<::flatbuffers::String> casRN) {
    fbb_.AddOffset(Hazard_Ingest::VT_CASRN, casRN);
  }
  void add_ppm(int32_t ppm) {
    fbb_.AddElement<int32_t>(Hazard_Ingest::VT_PPM, ppm, 0);
  }
  void add_density(double density) {
    fbb_.AddElement<double>(Hazard_Ingest::VT_DENSITY, density, 0.0);
  }
  void add_radCtrn(double radCtrn) {
    fbb_.AddElement<double>(Hazard_Ingest::VT_RADCTRN, radCtrn, 0.0);
  }
  void add_gBar(double gBar) {
    fbb_.AddElement<double>(Hazard_Ingest::VT_GBAR, gBar, 0.0);
  }
  void add_hBar(double hBar) {
    fbb_.AddElement<double>(Hazard_Ingest::VT_HBAR, hBar, 0.0);
  }
  void add_z(int32_t z) {
    fbb_.AddElement<int32_t>(Hazard_Ingest::VT_Z, z, 0);
  }
  void add_a(int32_t a) {
    fbb_.AddElement<int32_t>(Hazard_Ingest::VT_A, a, 0);
  }
  void add_bottleId(::flatbuffers::Offset<::flatbuffers::String> bottleId) {
    fbb_.AddOffset(Hazard_Ingest::VT_BOTTLEID, bottleId);
  }
  void add_channel(::flatbuffers::Offset<::flatbuffers::String> channel) {
    fbb_.AddOffset(Hazard_Ingest::VT_CHANNEL, channel);
  }
  void add_duration(int32_t duration) {
    fbb_.AddElement<int32_t>(Hazard_Ingest::VT_DURATION, duration, 0);
  }
  void add_activity(double activity) {
    fbb_.AddElement<double>(Hazard_Ingest::VT_ACTIVITY, activity, 0.0);
  }
  void add_dep(double dep) {
    fbb_.AddElement<double>(Hazard_Ingest::VT_DEP, dep, 0.0);
  }
  void add_depCtrn(double depCtrn) {
    fbb_.AddElement<double>(Hazard_Ingest::VT_DEPCTRN, depCtrn, 0.0);
  }
  void add_massFrac(double massFrac) {
    fbb_.AddElement<double>(Hazard_Ingest::VT_MASSFRAC, massFrac, 0.0);
  }
  void add_dose(double dose) {
    fbb_.AddElement<double>(Hazard_Ingest::VT_DOSE, dose, 0.0);
  }
  void add_ctrnTime(double ctrnTime) {
    fbb_.AddElement<double>(Hazard_Ingest::VT_CTRNTIME, ctrnTime, 0.0);
  }
  void add_doseRate(double doseRate) {
    fbb_.AddElement<double>(Hazard_Ingest::VT_DOSERATE, doseRate, 0.0);
  }
  void add_idPOI(::flatbuffers::Offset<::flatbuffers::String> idPOI) {
    fbb_.AddOffset(Hazard_Ingest::VT_IDPOI, idPOI);
  }
  void add_idTrack(::flatbuffers::Offset<::flatbuffers::String> idTrack) {
    fbb_.AddOffset(Hazard_Ingest::VT_IDTRACK, idTrack);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Hazard_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Hazard_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Hazard_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Hazard_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Hazard_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(Hazard_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Hazard_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit Hazard_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Hazard_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Hazard_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Hazard_Ingest> CreateHazard_Ingest(
    ...
    Hazard_Ingest_dataMode_Enum dataMode = Hazard_Ingest_dataMode_Enum_REAL) {
  Hazard_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Hazard_Ingest> CreateHazard_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Hazard_Ingest *GetHazard_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<Hazard_Ingest>(buf);
}

inline const Hazard_Ingest *GetSizePrefixedHazard_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Hazard_Ingest>(buf);
}

inline const char *Hazard_IngestIdentifier() {
  return "HAZA";
}

inline bool Hazard_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Hazard_IngestIdentifier());
}

inline bool SizePrefixedHazard_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Hazard_IngestIdentifier(), true);
}

inline bool VerifyHazard_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Hazard_Ingest>(Hazard_IngestIdentifier());
}

inline bool VerifySizePrefixedHazard_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Hazard_Ingest>(Hazard_IngestIdentifier());
}

inline void FinishHazard_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Hazard_Ingest> root) {
  fbb.Finish(root, Hazard_IngestIdentifier());
}

inline void FinishSizePrefixedHazard_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Hazard_Ingest> root) {
  fbb.FinishSizePrefixed(root, Hazard_IngestIdentifier());
}
