...
struct WeatherReport_Full;
struct WeatherReport_FullBuilder;

enum WeatherReport_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  WeatherReport_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  WeatherReport_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  WeatherReport_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  WeatherReport_Full_dataMode_Enum_EXERCISE = 3,
  WeatherReport_Full_dataMode_Enum_MIN = WeatherReport_Full_dataMode_Enum_REAL,
  WeatherReport_Full_dataMode_Enum_MAX = WeatherReport_Full_dataMode_Enum_EXERCISE
};

inline const WeatherReport_Full_dataMode_Enum (&EnumValuesWeatherReport_Full_dataMode_Enum())[4] {
  static const WeatherReport_Full_dataMode_Enum values[] = {
    WeatherReport_Full_dataMode_Enum_REAL,
    WeatherReport_Full_dataMode_Enum_TEST,
    WeatherReport_Full_dataMode_Enum_SIMULATED,
    WeatherReport_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesWeatherReport_Full_dataMode_Enum() {
...
inline const char *EnumNameWeatherReport_Full_dataMode_Enum(WeatherReport_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, WeatherReport_Full_dataMode_Enum_REAL, WeatherReport_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesWeatherReport_Full_dataMode_Enum()[index];
}
...
struct WeatherReport_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef WeatherReport_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  WeatherReport_Full_dataMode_Enum dataMode() const {
    return static_cast<WeatherReport_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct WeatherReport_FullBuilder {
  typedef WeatherReport_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(WeatherReport_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(WeatherReport_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(WeatherReport_Full::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(WeatherReport_Full::VT_ORIGSENSORID, origSensorId);
  }
  void add_weatherId(::flatbuffers::Offset<::flatbuffers::String> weatherId) {
    fbb_.AddOffset(WeatherReport_Full::VT_WEATHERID, weatherId);
  }
  void add_idGroundImagery(::flatbuffers::Offset<::flatbuffers::String> idGroundImagery) {
    fbb_.AddOffset(WeatherReport_Full::VT_IDGROUNDIMAGERY, idGroundImagery);
  }
  void add_idSite(::flatbuffers::Offset<::flatbuffers::String> idSite) {
    fbb_.AddOffset(WeatherReport_Full::VT_IDSITE, idSite);
  }
  void add_idAirfield(::flatbuffers::Offset<::flatbuffers::String> idAirfield) {
    fbb_.AddOffset(WeatherReport_Full::VT_IDAIRFIELD, idAirfield);
  }
  void add_icao(::flatbuffers::Offset<::flatbuffers::String> icao) {
    fbb_.AddOffset(WeatherReport_Full::VT_ICAO, icao);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(WeatherReport_Full::VT_EXTERNALID, externalId);
  }
  void add_externalLocationId(::flatbuffers::Offset<::flatbuffers::String> externalLocationId) {
    fbb_.AddOffset(WeatherReport_Full::VT_EXTERNALLOCATIONID, externalLocationId);
  }
  void add_reportType(::flatbuffers::Offset<::flatbuffers::String> reportType) {
    fbb_.AddOffset(WeatherReport_Full::VT_REPORTTYPE, reportType);
  }
  void add_obTime(::flatbuffers::Offset<::flatbuffers::String> obTime) {
    fbb_.AddOffset(WeatherReport_Full::VT_OBTIME, obTime);
  }
  void add_forecastStartTime(::flatbuffers::Offset<::flatbuffers::String> forecastStartTime) {
    fbb_.AddOffset(WeatherReport_Full::VT_FORECASTSTARTTIME, forecastStartTime);
  }
  void add_forecastEndTime(::flatbuffers::Offset<::flatbuffers::String> forecastEndTime) {
    fbb_.AddOffset(WeatherReport_Full::VT_FORECASTENDTIME, forecastEndTime);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_LON, lon, 0.0);
  }
  void add_alt(double alt) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_ALT, alt, 0.0);
  }
  void add_geoPotentialAlt(double geoPotentialAlt) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_GEOPOTENTIALALT, geoPotentialAlt, 0.0);
  }
  void add_dataLevel(::flatbuffers::Offset<::flatbuffers::String> dataLevel) {
    fbb_.AddOffset(WeatherReport_Full::VT_DATALEVEL, dataLevel);
  }
  void add_area(::flatbuffers::Offset<::flatbuffers::String> area) {
    fbb_.AddOffset(WeatherReport_Full::VT_AREA, area);
  }
  void add_atext(::flatbuffers::Offset<::flatbuffers::String> atext) {
    fbb_.AddOffset(WeatherReport_Full::VT_ATEXT, atext);
  }
  void add_agjson(::flatbuffers::Offset<::flatbuffers::String> agjson) {
    fbb_.AddOffset(WeatherReport_Full::VT_AGJSON, agjson);
  }
  void add_atype(::flatbuffers::Offset<::flatbuffers::String> atype) {
    fbb_.AddOffset(WeatherReport_Full::VT_ATYPE, atype);
  }
  void add_andims(int32_t andims) {
    fbb_.AddElement<int32_t>(WeatherReport_Full::VT_ANDIMS, andims, 0);
  }
  void add_asrid(int32_t asrid) {
    fbb_.AddElement<int32_t>(WeatherReport_Full::VT_ASRID, asrid, 0);
  }
  void add_windSpd(double windSpd) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_WINDSPD, windSpd, 0.0);
  }
  void add_windSpdAvg(double windSpdAvg) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_WINDSPDAVG, windSpdAvg, 0.0);
  }
  void add_windGust(double windGust) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_WINDGUST, windGust, 0.0);
  }
  void add_windGust10(double windGust10) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_WINDGUST10, windGust10, 0.0);
  }
  void add_vshear(double vshear) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_VSHEAR, vshear, 0.0);
  }
  void add_hshear(double hshear) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_HSHEAR, hshear, 0.0);
  }
  void add_radVel(double radVel) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_RADVEL, radVel, 0.0);
  }
  void add_radVelBeam1(double radVelBeam1) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_RADVELBEAM1, radVelBeam1, 0.0);
  }
  void add_radVelBeam2(double radVelBeam2) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_RADVELBEAM2, radVelBeam2, 0.0);
  }
  void add_radVelBeam3(double radVelBeam3) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_RADVELBEAM3, radVelBeam3, 0.0);
  }
  void add_radVelBeam4(double radVelBeam4) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_RADVELBEAM4, radVelBeam4, 0.0);
  }
  void add_radVelBeam5(double radVelBeam5) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_RADVELBEAM5, radVelBeam5, 0.0);
  }
  void add_windDir(double windDir) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_WINDDIR, windDir, 0.0);
  }
  void add_windDirAvg(double windDirAvg) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_WINDDIRAVG, windDirAvg, 0.0);
  }
  void add_windDirPeak(double windDirPeak) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_WINDDIRPEAK, windDirPeak, 0.0);
  }
  void add_windDirPeak10(double windDirPeak10) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_WINDDIRPEAK10, windDirPeak10, 0.0);
  }
  void add_windChill(double windChill) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_WINDCHILL, windChill, 0.0);
  }
  void add_dirDev(double dirDev) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_DIRDEV, dirDev, 0.0);
  }
  void add_windVar(bool windVar) {
    fbb_.AddElement<uint8_t>(WeatherReport_Full::VT_WINDVAR, static_cast<uint8_t>(windVar), 0);
  }
  void add_windCov(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> windCov) {
    fbb_.AddOffset(WeatherReport_Full::VT_WINDCOV, windCov);
  }
  void add_cloudCover(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> cloudCover) {
    fbb_.AddOffset(WeatherReport_Full::VT_CLOUDCOVER, cloudCover);
  }
  void add_cloudHght(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> cloudHght) {
    fbb_.AddOffset(WeatherReport_Full::VT_CLOUDHGHT, cloudHght);
  }
  void add_actWeather(::flatbuffers::Offset<::flatbuffers::String> actWeather) {
    fbb_.AddOffset(WeatherReport_Full::VT_ACTWEATHER, actWeather);
  }
  void add_weatherDesc(::flatbuffers::Offset<::flatbuffers::String> weatherDesc) {
    fbb_.AddOffset(WeatherReport_Full::VT_WEATHERDESC, weatherDesc);
  }
  void add_weatherInt(::flatbuffers::Offset<::flatbuffers::String> weatherInt) {
    fbb_.AddOffset(WeatherReport_Full::VT_WEATHERINT, weatherInt);
  }
  void add_rawMETAR(::flatbuffers::Offset<::flatbuffers::String> rawMETAR) {
    fbb_.AddOffset(WeatherReport_Full::VT_RAWMETAR, rawMETAR);
  }
  void add_rawTAF(::flatbuffers::Offset<::flatbuffers::String> rawTAF) {
    fbb_.AddOffset(WeatherReport_Full::VT_RAWTAF, rawTAF);
  }
  void add_qnh(double qnh) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_QNH, qnh, 0.0);
  }
  void add_visibility(double visibility) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_VISIBILITY, visibility, 0.0);
  }
  void add_temperature(double temperature) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_TEMPERATURE, temperature, 0.0);
  }
  void add_soilTemp(double soilTemp) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_SOILTEMP, soilTemp, 0.0);
  }
  void add_barPress(double barPress) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_BARPRESS, barPress, 0.0);
  }
  void add_precipRate(double precipRate) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_PRECIPRATE, precipRate, 0.0);
  }
  void add_rainHour(double rainHour) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_RAINHOUR, rainHour, 0.0);
  }
  void add_solarRad(double solarRad) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_SOLARRAD, solarRad, 0.0);
  }
  void add_difRad(double difRad) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_DIFRAD, difRad, 0.0);
  }
  void add_refRad(double refRad) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_REFRAD, refRad, 0.0);
  }
  void add_senlat(double senlat) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_SENLAT, senlat, 0.0);
  }
  void add_senlon(double senlon) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_SENLON, senlon, 0.0);
  }
  void add_senalt(double senalt) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_SENALT, senalt, 0.0);
  }
  void add_dewPoint(double dewPoint) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_DEWPOINT, dewPoint, 0.0);
  }
  void add_relHumidity(double relHumidity) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_RELHUMIDITY, relHumidity, 0.0);
  }
  void add_indexRefraction(double indexRefraction) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_INDEXREFRACTION, indexRefraction, 0.0);
  }
  void add_soilMoisture(double soilMoisture) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_SOILMOISTURE, soilMoisture, 0.0);
  }
  void add_surroundingWeather(::flatbuffers::Offset<::flatbuffers::String> surroundingWeather) {
    fbb_.AddOffset(WeatherReport_Full::VT_SURROUNDINGWEATHER, surroundingWeather);
  }
  void add_weatherAmp(::flatbuffers::Offset<::flatbuffers::String> weatherAmp) {
    fbb_.AddOffset(WeatherReport_Full::VT_WEATHERAMP, weatherAmp);
  }
  void add_contrailHghtLower(double contrailHghtLower) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_CONTRAILHGHTLOWER, contrailHghtLower, 0.0);
  }
  void add_contrailHghtUpper(double contrailHghtUpper) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_CONTRAILHGHTUPPER, contrailHghtUpper, 0.0);
  }
  void add_icingUpperLimit(double icingUpperLimit) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_ICINGUPPERLIMIT, icingUpperLimit, 0.0);
  }
  void add_icingLowerLimit(double icingLowerLimit) {
    fbb_.AddElement<double>(WeatherReport_Full::VT_ICINGLOWERLIMIT, icingLowerLimit, 0.0);
  }
  void add_enRouteWeather(::flatbuffers::Offset<::flatbuffers::String> enRouteWeather) {
    fbb_.AddOffset(WeatherReport_Full::VT_ENROUTEWEATHER, enRouteWeather);
  }
  void add_ccEvent(bool ccEvent) {
    fbb_.AddElement<uint8_t>(WeatherReport_Full::VT_CCEVENT, static_cast<uint8_t>(ccEvent), 0);
  }
  void add_srcTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcTyps) {
    fbb_.AddOffset(WeatherReport_Full::VT_SRCTYPS, srcTyps);
  }
  void add_srcIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcIds) {
    fbb_.AddOffset(WeatherReport_Full::VT_SRCIDS, srcIds);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(WeatherReport_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(WeatherReport_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(WeatherReport_Full::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(WeatherReport_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(WeatherReport_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(WeatherReport_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(WeatherReport_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit WeatherReport_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<WeatherReport_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<WeatherReport_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<WeatherReport_Full> CreateWeatherReport_Full(
    ...
    WeatherReport_Full_dataMode_Enum dataMode = WeatherReport_Full_dataMode_Enum_REAL) {
  WeatherReport_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<WeatherReport_Full> CreateWeatherReport_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const WeatherReport_Full *GetWeatherReport_Full(const void *buf) {
  return ::flatbuffers::GetRoot<WeatherReport_Full>(buf);
}

inline const WeatherReport_Full *GetSizePrefixedWeatherReport_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<WeatherReport_Full>(buf);
}

inline const char *WeatherReport_FullIdentifier() {
  return "WEAT";
}

inline bool WeatherReport_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, WeatherReport_FullIdentifier());
}

inline bool SizePrefixedWeatherReport_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, WeatherReport_FullIdentifier(), true);
}

inline bool VerifyWeatherReport_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<WeatherReport_Full>(WeatherReport_FullIdentifier());
}

inline bool VerifySizePrefixedWeatherReport_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<WeatherReport_Full>(WeatherReport_FullIdentifier());
}

inline void FinishWeatherReport_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<WeatherReport_Full> root) {
  fbb.Finish(root, WeatherReport_FullIdentifier());
}

inline void FinishSizePrefixedWeatherReport_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<WeatherReport_Full> root) {
  fbb.FinishSizePrefixed(root, WeatherReport_FullIdentifier());
}
