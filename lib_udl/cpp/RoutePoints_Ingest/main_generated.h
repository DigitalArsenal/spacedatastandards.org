...
struct RoutePoints_Ingest;
struct RoutePoints_IngestBuilder;

/// /// Points identified within the route.
struct RoutePoints_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef RoutePoints_IngestBuilder Builder;
...
struct RoutePoints_IngestBuilder {
  typedef RoutePoints_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_ptSequenceId(int32_t ptSequenceId) {
    fbb_.AddElement<int32_t>(RoutePoints_Ingest::VT_PTSEQUENCEID, ptSequenceId, 0);
  }
  void add_ptTypeCode(::flatbuffers::Offset<::flatbuffers::String> ptTypeCode) {
    fbb_.AddOffset(RoutePoints_Ingest::VT_PTTYPECODE, ptTypeCode);
  }
  void add_ptTypeName(::flatbuffers::Offset<::flatbuffers::String> ptTypeName) {
    fbb_.AddOffset(RoutePoints_Ingest::VT_PTTYPENAME, ptTypeName);
  }
  void add_waypointName(::flatbuffers::Offset<::flatbuffers::String> waypointName) {
    fbb_.AddOffset(RoutePoints_Ingest::VT_WAYPOINTNAME, waypointName);
  }
  void add_dafifPt(bool dafifPt) {
    fbb_.AddElement<uint8_t>(RoutePoints_Ingest::VT_DAFIFPT, static_cast<uint8_t>(dafifPt), 0);
  }
  void add_ptLat(double ptLat) {
    fbb_.AddElement<double>(RoutePoints_Ingest::VT_PTLAT, ptLat, 0.0);
  }
  void add_ptLon(double ptLon) {
    fbb_.AddElement<double>(RoutePoints_Ingest::VT_PTLON, ptLon, 0.0);
  }
  void add_magDec(double magDec) {
    fbb_.AddElement<double>(RoutePoints_Ingest::VT_MAGDEC, magDec, 0.0);
  }
  void add_navaidLength(double navaidLength) {
    fbb_.AddElement<double>(RoutePoints_Ingest::VT_NAVAIDLENGTH, navaidLength, 0.0);
  }
  void add_navaid(::flatbuffers::Offset<::flatbuffers::String> navaid) {
    fbb_.AddOffset(RoutePoints_Ingest::VT_NAVAID, navaid);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(RoutePoints_Ingest::VT_COUNTRYCODE, countryCode);
  }
  void add_altCountryCode(::flatbuffers::Offset<::flatbuffers::String> altCountryCode) {
    fbb_.AddOffset(RoutePoints_Ingest::VT_ALTCOUNTRYCODE, altCountryCode);
  }
  void add_navaidType(::flatbuffers::Offset<::flatbuffers::String> navaidType) {
    fbb_.AddOffset(RoutePoints_Ingest::VT_NAVAIDTYPE, navaidType);
  }
  explicit RoutePoints_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<RoutePoints_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<RoutePoints_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<RoutePoints_Ingest> CreateRoutePoints_Ingest(
  ...
  RoutePoints_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<RoutePoints_Ingest> CreateRoutePoints_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    int32_t ptSequenceId = 0,
...
inline const RoutePoints_Ingest *GetRoutePoints_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<RoutePoints_Ingest>(buf);
}

inline const RoutePoints_Ingest *GetSizePrefixedRoutePoints_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<RoutePoints_Ingest>(buf);
}

inline const char *RoutePoints_IngestIdentifier() {
  return "ROUT";
}

inline bool RoutePoints_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RoutePoints_IngestIdentifier());
}

inline bool SizePrefixedRoutePoints_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RoutePoints_IngestIdentifier(), true);
}

inline bool VerifyRoutePoints_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<RoutePoints_Ingest>(RoutePoints_IngestIdentifier());
}

inline bool VerifySizePrefixedRoutePoints_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<RoutePoints_Ingest>(RoutePoints_IngestIdentifier());
}

inline void FinishRoutePoints_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RoutePoints_Ingest> root) {
  fbb.Finish(root, RoutePoints_IngestIdentifier());
}

inline void FinishSizePrefixedRoutePoints_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RoutePoints_Ingest> root) {
  fbb.FinishSizePrefixed(root, RoutePoints_IngestIdentifier());
}
