...
struct ISRCollectionTaskings_Full;
struct ISRCollectionTaskings_FullBuilder;

enum ISRCollectionTaskings_Full_type_Enum : int8_t {
  /// No description available.
  ISRCollectionTaskings_Full_type_Enum_DELIBERATE = 0,
  /// No description available.
  ISRCollectionTaskings_Full_type_Enum_DYNAMIC = 1,
  /// No description available.
  ISRCollectionTaskings_Full_type_Enum_TRAINING = 2,
  /// No description available.
  ISRCollectionTaskings_Full_type_Enum_TRANSIT = 3,
  ISRCollectionTaskings_Full_type_Enum_MIN = ISRCollectionTaskings_Full_type_Enum_DELIBERATE,
  ISRCollectionTaskings_Full_type_Enum_MAX = ISRCollectionTaskings_Full_type_Enum_TRANSIT
};

inline const ISRCollectionTaskings_Full_type_Enum (&EnumValuesISRCollectionTaskings_Full_type_Enum())[4] {
  static const ISRCollectionTaskings_Full_type_Enum values[] = {
    ISRCollectionTaskings_Full_type_Enum_DELIBERATE,
    ISRCollectionTaskings_Full_type_Enum_DYNAMIC,
    ISRCollectionTaskings_Full_type_Enum_TRAINING,
    ISRCollectionTaskings_Full_type_Enum_TRANSIT
  };
  return values;
}

inline const char * const *EnumNamesISRCollectionTaskings_Full_type_Enum() {
...
inline const char *EnumNameISRCollectionTaskings_Full_type_Enum(ISRCollectionTaskings_Full_type_Enum e) {
  if (::flatbuffers::IsOutRange(e, ISRCollectionTaskings_Full_type_Enum_DELIBERATE, ISRCollectionTaskings_Full_type_Enum_TRANSIT)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesISRCollectionTaskings_Full_type_Enum()[index];
}

enum ISRCollectionTaskings_Full_collectionType_Enum : int8_t {
  /// No description available.
  ISRCollectionTaskings_Full_collectionType_Enum_SIMULTANEOUS = 0,
  /// No description available.
  ISRCollectionTaskings_Full_collectionType_Enum_SEQUENTIAL = 1,
  /// No description available.
  ISRCollectionTaskings_Full_collectionType_Enum_OPERATIONALLY = 2,
  /// No description available.
  ISRCollectionTaskings_Full_collectionType_Enum_DRIVEN = 3,
  /// No description available.
  ISRCollectionTaskings_Full_collectionType_Enum_PRIORITY = 4,
  /// No description available.
  ISRCollectionTaskings_Full_collectionType_Enum_ORDER = 5,
  ISRCollectionTaskings_Full_collectionType_Enum_MIN = ISRCollectionTaskings_Full_collectionType_Enum_SIMULTANEOUS,
  ISRCollectionTaskings_Full_collectionType_Enum_MAX = ISRCollectionTaskings_Full_collectionType_Enum_ORDER
};

inline const ISRCollectionTaskings_Full_collectionType_Enum (&EnumValuesISRCollectionTaskings_Full_collectionType_Enum())[6] {
  static const ISRCollectionTaskings_Full_collectionType_Enum values[] = {
    ISRCollectionTaskings_Full_collectionType_Enum_SIMULTANEOUS,
    ISRCollectionTaskings_Full_collectionType_Enum_SEQUENTIAL,
    ISRCollectionTaskings_Full_collectionType_Enum_OPERATIONALLY,
    ISRCollectionTaskings_Full_collectionType_Enum_DRIVEN,
    ISRCollectionTaskings_Full_collectionType_Enum_PRIORITY,
    ISRCollectionTaskings_Full_collectionType_Enum_ORDER
  };
  return values;
}

inline const char * const *EnumNamesISRCollectionTaskings_Full_collectionType_Enum() {
...
inline const char *EnumNameISRCollectionTaskings_Full_collectionType_Enum(ISRCollectionTaskings_Full_collectionType_Enum e) {
  if (::flatbuffers::IsOutRange(e, ISRCollectionTaskings_Full_collectionType_Enum_SIMULTANEOUS, ISRCollectionTaskings_Full_collectionType_Enum_ORDER)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesISRCollectionTaskings_Full_collectionType_Enum()[index];
}

/// /// Individual taskings to complete the mission.
struct ISRCollectionTaskings_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef ISRCollectionTaskings_FullBuilder Builder;
  ...
  ISRCollectionTaskings_Full_type_Enum type() const {
    return static_cast<ISRCollectionTaskings_Full_type_Enum>(GetField<int8_t>(VT_TYPE, 0));
  }
  /// Type of collection tasked.
  /// Example: /// Example: Simultaneous
  /// Constraints: Minimum length = 1, Maximum length = 16
  ISRCollectionTaskings_Full_collectionType_Enum collectionType() const {
    return static_cast<ISRCollectionTaskings_Full_collectionType_Enum>(GetField<int8_t>(VT_COLLECTIONTYPE, 0));
  }
...
struct ISRCollectionTaskings_FullBuilder {
  typedef ISRCollectionTaskings_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_ID, id);
  }
  void add_type(ISRCollectionTaskings_Full_type_Enum type) {
    fbb_.AddElement<int8_t>(ISRCollectionTaskings_Full::VT_TYPE, static_cast<int8_t>(type), 0);
  }
  void add_collectionType(ISRCollectionTaskings_Full_collectionType_Enum collectionType) {
    fbb_.AddElement<int8_t>(ISRCollectionTaskings_Full::VT_COLLECTIONTYPE, static_cast<int8_t>(collectionType), 0);
  }
  void add_taskingAOR(::flatbuffers::Offset<::flatbuffers::String> taskingAOR) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGAOR, taskingAOR);
  }
  void add_eightLine(::flatbuffers::Offset<::flatbuffers::String> eightLine) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_EIGHTLINE, eightLine);
  }
  void add_taskingPrimaryIntelDiscipline(::flatbuffers::Offset<::flatbuffers::String> taskingPrimaryIntelDiscipline) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGPRIMARYINTELDISCIPLINE, taskingPrimaryIntelDiscipline);
  }
  void add_taskingPrimarySubCategory(::flatbuffers::Offset<::flatbuffers::String> taskingPrimarySubCategory) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGPRIMARYSUBCATEGORY, taskingPrimarySubCategory);
  }
  void add_taskingSecondaryIntelDiscipline(::flatbuffers::Offset<::flatbuffers::String> taskingSecondaryIntelDiscipline) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGSECONDARYINTELDISCIPLINE, taskingSecondaryIntelDiscipline);
  }
  void add_taskingSecondarySubCategory(::flatbuffers::Offset<::flatbuffers::String> taskingSecondarySubCategory) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGSECONDARYSUBCATEGORY, taskingSecondarySubCategory);
  }
  void add_taskingRole(::flatbuffers::Offset<::flatbuffers::String> taskingRole) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGROLE, taskingRole);
  }
  void add_taskingOperation(::flatbuffers::Offset<::flatbuffers::String> taskingOperation) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGOPERATION, taskingOperation);
  }
  void add_taskingPriority(double taskingPriority) {
    fbb_.AddElement<double>(ISRCollectionTaskings_Full::VT_TASKINGPRIORITY, taskingPriority, 0.0);
  }
  void add_taskingSupportedUnit(::flatbuffers::Offset<::flatbuffers::String> taskingSupportedUnit) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGSUPPORTEDUNIT, taskingSupportedUnit);
  }
  void add_taskingEmphasis(::flatbuffers::Offset<::flatbuffers::String> taskingEmphasis) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGEMPHASIS, taskingEmphasis);
  }
  void add_taskingRetaskTime(::flatbuffers::Offset<::flatbuffers::String> taskingRetaskTime) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGRETASKTIME, taskingRetaskTime);
  }
  void add_taskingStartPointLat(double taskingStartPointLat) {
    fbb_.AddElement<double>(ISRCollectionTaskings_Full::VT_TASKINGSTARTPOINTLAT, taskingStartPointLat, 0.0);
  }
  void add_taskingStartPointLong(double taskingStartPointLong) {
    fbb_.AddElement<double>(ISRCollectionTaskings_Full::VT_TASKINGSTARTPOINTLONG, taskingStartPointLong, 0.0);
  }
  void add_taskingCollectionArea(::flatbuffers::Offset<::flatbuffers::String> taskingCollectionArea) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGCOLLECTIONAREA, taskingCollectionArea);
  }
  void add_taskingJoa(::flatbuffers::Offset<::flatbuffers::String> taskingJoa) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGJOA, taskingJoa);
  }
  void add_taskingSyncMatrixBin(::flatbuffers::Offset<::flatbuffers::String> taskingSyncMatrixBin) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGSYNCMATRIXBIN, taskingSyncMatrixBin);
  }
  void add_taskingCountry(::flatbuffers::Offset<::flatbuffers::String> taskingCountry) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGCOUNTRY, taskingCountry);
  }
  void add_taskingRegion(::flatbuffers::Offset<::flatbuffers::String> taskingRegion) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGREGION, taskingRegion);
  }
  void add_taskingSubRegion(::flatbuffers::Offset<::flatbuffers::String> taskingSubRegion) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGSUBREGION, taskingSubRegion);
  }
  void add_sroTrack(::flatbuffers::Offset<::flatbuffers::String> sroTrack) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_SROTRACK, sroTrack);
  }
  void add_specialComGuidance(::flatbuffers::Offset<::flatbuffers::String> specialComGuidance) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_SPECIALCOMGUIDANCE, specialComGuidance);
  }
  void add_collectionPeriods(::flatbuffers::Offset<::flatbuffers::String> collectionPeriods) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_COLLECTIONPERIODS, collectionPeriods);
  }
  void add_taskingCollectionRequirements(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> taskingCollectionRequirements) {
    fbb_.AddOffset(ISRCollectionTaskings_Full::VT_TASKINGCOLLECTIONREQUIREMENTS, taskingCollectionRequirements);
  }
  explicit ISRCollectionTaskings_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<ISRCollectionTaskings_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<ISRCollectionTaskings_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<ISRCollectionTaskings_Full> CreateISRCollectionTaskings_Full(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::String> id = 0,
    ISRCollectionTaskings_Full_type_Enum type = ISRCollectionTaskings_Full_type_Enum_DELIBERATE,
    ISRCollectionTaskings_Full_collectionType_Enum collectionType = ISRCollectionTaskings_Full_collectionType_Enum_SIMULTANEOUS,
  ...
  ISRCollectionTaskings_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<ISRCollectionTaskings_Full> CreateISRCollectionTaskings_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateISRCollectionTaskings_Full(
      _fbb,
      id__,
      type,
      collectionType,
...
inline const ISRCollectionTaskings_Full *GetISRCollectionTaskings_Full(const void *buf) {
  return ::flatbuffers::GetRoot<ISRCollectionTaskings_Full>(buf);
}

inline const ISRCollectionTaskings_Full *GetSizePrefixedISRCollectionTaskings_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<ISRCollectionTaskings_Full>(buf);
}

inline const char *ISRCollectionTaskings_FullIdentifier() {
  return "ISRC";
}

inline bool ISRCollectionTaskings_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ISRCollectionTaskings_FullIdentifier());
}

inline bool SizePrefixedISRCollectionTaskings_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ISRCollectionTaskings_FullIdentifier(), true);
}

inline bool VerifyISRCollectionTaskings_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<ISRCollectionTaskings_Full>(ISRCollectionTaskings_FullIdentifier());
}

inline bool VerifySizePrefixedISRCollectionTaskings_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<ISRCollectionTaskings_Full>(ISRCollectionTaskings_FullIdentifier());
}

inline void FinishISRCollectionTaskings_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ISRCollectionTaskings_Full> root) {
  fbb.Finish(root, ISRCollectionTaskings_FullIdentifier());
}

inline void FinishSizePrefixedISRCollectionTaskings_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ISRCollectionTaskings_Full> root) {
  fbb.FinishSizePrefixed(root, ISRCollectionTaskings_FullIdentifier());
}
