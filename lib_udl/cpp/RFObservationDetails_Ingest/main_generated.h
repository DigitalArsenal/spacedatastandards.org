...
struct RFObservationDetails_Ingest;
struct RFObservationDetails_IngestBuilder;

enum RFObservationDetails_Ingest_polarityType_Enum : int8_t {
  ...
  RFObservationDetails_Ingest_polarityType_Enum_MIN = RFObservationDetails_Ingest_polarityType_Enum_H,
  RFObservationDetails_Ingest_polarityType_Enum_MAX = RFObservationDetails_Ingest_polarityType_Enum_L
};

inline const RFObservationDetails_Ingest_polarityType_Enum (&EnumValuesRFObservationDetails_Ingest_polarityType_Enum())[4] {
  static const RFObservationDetails_Ingest_polarityType_Enum values[] = {
    RFObservationDetails_Ingest_polarityType_Enum_H,
    RFObservationDetails_Ingest_polarityType_Enum_V,
    RFObservationDetails_Ingest_polarityType_Enum_R,
    RFObservationDetails_Ingest_polarityType_Enum_L
  };
  return values;
}

inline const char * const *EnumNamesRFObservationDetails_Ingest_polarityType_Enum() {
...
inline const char *EnumNameRFObservationDetails_Ingest_polarityType_Enum(RFObservationDetails_Ingest_polarityType_Enum e) {
  if (::flatbuffers::IsOutRange(e, RFObservationDetails_Ingest_polarityType_Enum_H, RFObservationDetails_Ingest_polarityType_Enum_L)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesRFObservationDetails_Ingest_polarityType_Enum()[index];
}

enum RFObservationDetails_Ingest_dataMode_Enum : int8_t {
  ...
  RFObservationDetails_Ingest_dataMode_Enum_MIN = RFObservationDetails_Ingest_dataMode_Enum_REAL,
  RFObservationDetails_Ingest_dataMode_Enum_MAX = RFObservationDetails_Ingest_dataMode_Enum_EXERCISE
};

inline const RFObservationDetails_Ingest_dataMode_Enum (&EnumValuesRFObservationDetails_Ingest_dataMode_Enum())[4] {
  static const RFObservationDetails_Ingest_dataMode_Enum values[] = {
    RFObservationDetails_Ingest_dataMode_Enum_REAL,
    RFObservationDetails_Ingest_dataMode_Enum_TEST,
    RFObservationDetails_Ingest_dataMode_Enum_SIMULATED,
    RFObservationDetails_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesRFObservationDetails_Ingest_dataMode_Enum() {
  static const char * const names[5] = {
    "REAL",
    "TEST",
    "SIMULATED",
...
inline const char *EnumNameRFObservationDetails_Ingest_dataMode_Enum(RFObservationDetails_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, RFObservationDetails_Ingest_dataMode_Enum_REAL, RFObservationDetails_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesRFObservationDetails_Ingest_dataMode_Enum()[index];
}
...
struct RFObservationDetails_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef RFObservationDetails_IngestBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_BAUDRATES = 190,
    VT_TELEMETRYIDS = 192,
    VT_CONSTELLATIONXPOINTS = 194,
    VT_CONSTELLATIONYPOINTS = 196
  };
  ...
  RFObservationDetails_Ingest_polarityType_Enum polarityType() const {
    return static_cast<RFObservationDetails_Ingest_polarityType_Enum>(GetField<int8_t>(VT_POLARITYTYPE, 0));
  }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  RFObservationDetails_Ingest_dataMode_Enum dataMode() const {
    return static_cast<RFObservationDetails_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct RFObservationDetails_IngestBuilder {
  typedef RFObservationDetails_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_obTime(::flatbuffers::Offset<::flatbuffers::String> obTime) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_OBTIME, obTime);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_IDSENSOR, idSensor);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_TYPE, type);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(RFObservationDetails_Ingest::VT_SATNO, satNo, 0);
  }
  void add_taskId(::flatbuffers::Offset<::flatbuffers::String> taskId) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_TASKID, taskId);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_TRANSACTIONID, transactionId);
  }
  void add_trackId(::flatbuffers::Offset<::flatbuffers::String> trackId) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_TRACKID, trackId);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_ORIGOBJECTID, origObjectId);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_ORIGSENSORID, origSensorId);
  }
  void add_uct(bool uct) {
    fbb_.AddElement<uint8_t>(RFObservationDetails_Ingest::VT_UCT, static_cast<uint8_t>(uct), 0);
  }
  void add_transponder(::flatbuffers::Offset<::flatbuffers::String> transponder) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_TRANSPONDER, transponder);
  }
  void add_azimuth(double azimuth) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_AZIMUTH, azimuth, 0.0);
  }
  void add_azimuthUnc(double azimuthUnc) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_AZIMUTHUNC, azimuthUnc, 0.0);
  }
  void add_azimuthRate(double azimuthRate) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_AZIMUTHRATE, azimuthRate, 0.0);
  }
  void add_elevation(double elevation) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_ELEVATION, elevation, 0.0);
  }
  void add_elevationUnc(double elevationUnc) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_ELEVATIONUNC, elevationUnc, 0.0);
  }
  void add_elevationRate(double elevationRate) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_ELEVATIONRATE, elevationRate, 0.0);
  }
  void add_range(double range) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_RANGE, range, 0.0);
  }
  void add_rangeUnc(double rangeUnc) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_RANGEUNC, rangeUnc, 0.0);
  }
  void add_rangeRate(double rangeRate) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_RANGERATE, rangeRate, 0.0);
  }
  void add_rangeRateUnc(double rangeRateUnc) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_RANGERATEUNC, rangeRateUnc, 0.0);
  }
  void add_trackRange(double trackRange) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_TRACKRANGE, trackRange, 0.0);
  }
  void add_senlat(double senlat) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_SENLAT, senlat, 0.0);
  }
  void add_senlon(double senlon) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_SENLON, senlon, 0.0);
  }
  void add_senalt(double senalt) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_SENALT, senalt, 0.0);
  }
  void add_elnot(::flatbuffers::Offset<::flatbuffers::String> elnot) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_ELNOT, elnot);
  }
  void add_frequency(double frequency) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_FREQUENCY, frequency, 0.0);
  }
  void add_nominalFrequency(double nominalFrequency) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_NOMINALFREQUENCY, nominalFrequency, 0.0);
  }
  void add_startFrequency(double startFrequency) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_STARTFREQUENCY, startFrequency, 0.0);
  }
  void add_endFrequency(double endFrequency) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_ENDFREQUENCY, endFrequency, 0.0);
  }
  void add_relativeCarrierPower(double relativeCarrierPower) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_RELATIVECARRIERPOWER, relativeCarrierPower, 0.0);
  }
  void add_spectrumAnalyzerPower(double spectrumAnalyzerPower) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_SPECTRUMANALYZERPOWER, spectrumAnalyzerPower, 0.0);
  }
  void add_relativeNoiseFloor(double relativeNoiseFloor) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_RELATIVENOISEFLOOR, relativeNoiseFloor, 0.0);
  }
  void add_referenceLevel(double referenceLevel) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_REFERENCELEVEL, referenceLevel, 0.0);
  }
  void add_pgri(double pgri) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_PGRI, pgri, 0.0);
  }
  void add_confidence(double confidence) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_CONFIDENCE, confidence, 0.0);
  }
  void add_incoming(bool incoming) {
    fbb_.AddElement<uint8_t>(RFObservationDetails_Ingest::VT_INCOMING, static_cast<uint8_t>(incoming), 0);
  }
  void add_switchPoint(int32_t switchPoint) {
    fbb_.AddElement<int32_t>(RFObservationDetails_Ingest::VT_SWITCHPOINT, switchPoint, 0);
  }
  void add_baudRate(double baudRate) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_BAUDRATE, baudRate, 0.0);
  }
  void add_snr(double snr) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_SNR, snr, 0.0);
  }
  void add_nominalSnr(double nominalSnr) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_NOMINALSNR, nominalSnr, 0.0);
  }
  void add_polarity(double polarity) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_POLARITY, polarity, 0.0);
  }
  void add_polarityType(RFObservationDetails_Ingest_polarityType_Enum polarityType) {
    fbb_.AddElement<int8_t>(RFObservationDetails_Ingest::VT_POLARITYTYPE, static_cast<int8_t>(polarityType), 0);
  }
  void add_channel(int32_t channel) {
    fbb_.AddElement<int32_t>(RFObservationDetails_Ingest::VT_CHANNEL, channel, 0);
  }
  void add_powerOverNoise(double powerOverNoise) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_POWEROVERNOISE, powerOverNoise, 0.0);
  }
  void add_nominalPowerOverNoise(double nominalPowerOverNoise) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_NOMINALPOWEROVERNOISE, nominalPowerOverNoise, 0.0);
  }
  void add_bandwidth(double bandwidth) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_BANDWIDTH, bandwidth, 0.0);
  }
  void add_nominalBandwidth(double nominalBandwidth) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_NOMINALBANDWIDTH, nominalBandwidth, 0.0);
  }
  void add_resolutionBandwidth(double resolutionBandwidth) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_RESOLUTIONBANDWIDTH, resolutionBandwidth, 0.0);
  }
  void add_videoBandwidth(double videoBandwidth) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_VIDEOBANDWIDTH, videoBandwidth, 0.0);
  }
  void add_eirp(double eirp) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_EIRP, eirp, 0.0);
  }
  void add_nominalEirp(double nominalEirp) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_NOMINALEIRP, nominalEirp, 0.0);
  }
  void add_minPSD(double minPSD) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_MINPSD, minPSD, 0.0);
  }
  void add_maxPSD(double maxPSD) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_MAXPSD, maxPSD, 0.0);
  }
  void add_frequencyShift(double frequencyShift) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_FREQUENCYSHIFT, frequencyShift, 0.0);
  }
  void add_peak(bool peak) {
    fbb_.AddElement<uint8_t>(RFObservationDetails_Ingest::VT_PEAK, static_cast<uint8_t>(peak), 0);
  }
  void add_antennaName(::flatbuffers::Offset<::flatbuffers::String> antennaName) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_ANTENNANAME, antennaName);
  }
  void add_detectionStatus(::flatbuffers::Offset<::flatbuffers::String> detectionStatus) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_DETECTIONSTATUS, detectionStatus);
  }
  void add_collectionMode(::flatbuffers::Offset<::flatbuffers::String> collectionMode) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_COLLECTIONMODE, collectionMode);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_RAWFILEURI, rawFileURI);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(RFObservationDetails_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(RFObservationDetails_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_TAGS, tags);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_noisePwrDensity(double noisePwrDensity) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_NOISEPWRDENSITY, noisePwrDensity, 0.0);
  }
  void add_carrierStandard(::flatbuffers::Offset<::flatbuffers::String> carrierStandard) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_CARRIERSTANDARD, carrierStandard);
  }
  void add_modulation(::flatbuffers::Offset<::flatbuffers::String> modulation) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_MODULATION, modulation);
  }
  void add_innerCodingRate(int32_t innerCodingRate) {
    fbb_.AddElement<int32_t>(RFObservationDetails_Ingest::VT_INNERCODINGRATE, innerCodingRate, 0);
  }
  void add_outerCodingRate(int32_t outerCodingRate) {
    fbb_.AddElement<int32_t>(RFObservationDetails_Ingest::VT_OUTERCODINGRATE, outerCodingRate, 0);
  }
  void add_transmitFilterType(::flatbuffers::Offset<::flatbuffers::String> transmitFilterType) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_TRANSMITFILTERTYPE, transmitFilterType);
  }
  void add_transmitFilterRollOff(double transmitFilterRollOff) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_TRANSMITFILTERROLLOFF, transmitFilterRollOff, 0.0);
  }
  void add_symbolToNoiseRatio(double symbolToNoiseRatio) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_SYMBOLTONOISERATIO, symbolToNoiseRatio, 0.0);
  }
  void add_bitErrorRate(double bitErrorRate) {
    fbb_.AddElement<double>(RFObservationDetails_Ingest::VT_BITERRORRATE, bitErrorRate, 0.0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_SOURCEDL, sourceDL);
  }
  void add_descriptor(::flatbuffers::Offset<::flatbuffers::String> descriptor) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_DESCRIPTOR, descriptor);
  }
  void add_url(::flatbuffers::Offset<::flatbuffers::String> url) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_URL, url);
  }
  void add_frequencies(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> frequencies) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_FREQUENCIES, frequencies);
  }
  void add_powers(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> powers) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_POWERS, powers);
  }
  void add_snrs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> snrs) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_SNRS, snrs);
  }
  void add_confidences(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> confidences) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_CONFIDENCES, confidences);
  }
  void add_detectionStatuses(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> detectionStatuses) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_DETECTIONSTATUSES, detectionStatuses);
  }
  void add_chipRates(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> chipRates) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_CHIPRATES, chipRates);
  }
  void add_codeTaps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> codeTaps) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_CODETAPS, codeTaps);
  }
  void add_codeFills(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> codeFills) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_CODEFILLS, codeFills);
  }
  void add_codeLengths(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> codeLengths) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_CODELENGTHS, codeLengths);
  }
  void add_pnOrders(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> pnOrders) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_PNORDERS, pnOrders);
  }
  void add_signalIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> signalIds) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_SIGNALIDS, signalIds);
  }
  void add_baudRates(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> baudRates) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_BAUDRATES, baudRates);
  }
  void add_telemetryIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> telemetryIds) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_TELEMETRYIDS, telemetryIds);
  }
  void add_constellationXPoints(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> constellationXPoints) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_CONSTELLATIONXPOINTS, constellationXPoints);
  }
  void add_constellationYPoints(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> constellationYPoints) {
    fbb_.AddOffset(RFObservationDetails_Ingest::VT_CONSTELLATIONYPOINTS, constellationYPoints);
  }
  explicit RFObservationDetails_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<RFObservationDetails_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<RFObservationDetails_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<RFObservationDetails_Ingest> CreateRFObservationDetails_Ingest(
    ...
    double polarity = 0.0,
    RFObservationDetails_Ingest_polarityType_Enum polarityType = RFObservationDetails_Ingest_polarityType_Enum_H,
    int32_t channel = 0,
    ...
    RFObservationDetails_Ingest_dataMode_Enum dataMode = RFObservationDetails_Ingest_dataMode_Enum_REAL,
  ...
  RFObservationDetails_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<RFObservationDetails_Ingest> CreateRFObservationDetails_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateRFObservationDetails_Ingest(
      _fbb,
      id__,
...
inline const RFObservationDetails_Ingest *GetRFObservationDetails_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<RFObservationDetails_Ingest>(buf);
}

inline const RFObservationDetails_Ingest *GetSizePrefixedRFObservationDetails_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<RFObservationDetails_Ingest>(buf);
}

inline const char *RFObservationDetails_IngestIdentifier() {
  return "RFOB";
}

inline bool RFObservationDetails_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RFObservationDetails_IngestIdentifier());
}

inline bool SizePrefixedRFObservationDetails_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RFObservationDetails_IngestIdentifier(), true);
}

inline bool VerifyRFObservationDetails_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<RFObservationDetails_Ingest>(RFObservationDetails_IngestIdentifier());
}

inline bool VerifySizePrefixedRFObservationDetails_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<RFObservationDetails_Ingest>(RFObservationDetails_IngestIdentifier());
}

inline void FinishRFObservationDetails_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RFObservationDetails_Ingest> root) {
  fbb.Finish(root, RFObservationDetails_IngestIdentifier());
}

inline void FinishSizePrefixedRFObservationDetails_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RFObservationDetails_Ingest> root) {
  fbb.FinishSizePrefixed(root, RFObservationDetails_IngestIdentifier());
}
