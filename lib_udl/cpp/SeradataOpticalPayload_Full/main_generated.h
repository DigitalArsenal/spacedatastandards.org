...
struct SeradataOpticalPayload_Full;
struct SeradataOpticalPayload_FullBuilder;

enum SeradataOpticalPayload_Full_dataMode_Enum : int8_t {
  ...
  SeradataOpticalPayload_Full_dataMode_Enum_MIN = SeradataOpticalPayload_Full_dataMode_Enum_REAL,
  SeradataOpticalPayload_Full_dataMode_Enum_MAX = SeradataOpticalPayload_Full_dataMode_Enum_EXERCISE
};

inline const SeradataOpticalPayload_Full_dataMode_Enum (&EnumValuesSeradataOpticalPayload_Full_dataMode_Enum())[4] {
  static const SeradataOpticalPayload_Full_dataMode_Enum values[] = {
    SeradataOpticalPayload_Full_dataMode_Enum_REAL,
    SeradataOpticalPayload_Full_dataMode_Enum_TEST,
    SeradataOpticalPayload_Full_dataMode_Enum_SIMULATED,
    SeradataOpticalPayload_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSeradataOpticalPayload_Full_dataMode_Enum() {
...
inline const char *EnumNameSeradataOpticalPayload_Full_dataMode_Enum(SeradataOpticalPayload_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SeradataOpticalPayload_Full_dataMode_Enum_REAL, SeradataOpticalPayload_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSeradataOpticalPayload_Full_dataMode_Enum()[index];
}

/// /// Details for an optical payload from  Seradata.
struct SeradataOpticalPayload_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SeradataOpticalPayload_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SeradataOpticalPayload_Full_dataMode_Enum dataMode() const {
    return static_cast<SeradataOpticalPayload_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SeradataOpticalPayload_FullBuilder {
  typedef SeradataOpticalPayload_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_spacecraftId(::flatbuffers::Offset<::flatbuffers::String> spacecraftId) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_SPACECRAFTID, spacecraftId);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_IDSENSOR, idSensor);
  }
  void add_hostedForCompanyOrgId(::flatbuffers::Offset<::flatbuffers::String> hostedForCompanyOrgId) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_HOSTEDFORCOMPANYORGID, hostedForCompanyOrgId);
  }
  void add_manufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrgId) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_MANUFACTURERORGID, manufacturerOrgId);
  }
  void add_imagingPayloadCategory(::flatbuffers::Offset<::flatbuffers::String> imagingPayloadCategory) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_IMAGINGPAYLOADCATEGORY, imagingPayloadCategory);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_NAME, name);
  }
  void add_spectralBand(::flatbuffers::Offset<::flatbuffers::String> spectralBand) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_SPECTRALBAND, spectralBand);
  }
  void add_spectralFrequencyLimits(::flatbuffers::Offset<::flatbuffers::String> spectralFrequencyLimits) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_SPECTRALFREQUENCYLIMITS, spectralFrequencyLimits);
  }
  void add_numberOfFilmReturnCanisters(int32_t numberOfFilmReturnCanisters) {
    fbb_.AddElement<int32_t>(SeradataOpticalPayload_Full::VT_NUMBEROFFILMRETURNCANISTERS, numberOfFilmReturnCanisters, 0);
  }
  void add_bestResolution(double bestResolution) {
    fbb_.AddElement<double>(SeradataOpticalPayload_Full::VT_BESTRESOLUTION, bestResolution, 0.0);
  }
  void add_swathWidth(double swathWidth) {
    fbb_.AddElement<double>(SeradataOpticalPayload_Full::VT_SWATHWIDTH, swathWidth, 0.0);
  }
  void add_recorderSize(::flatbuffers::Offset<::flatbuffers::String> recorderSize) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_RECORDERSIZE, recorderSize);
  }
  void add_fieldOfView(double fieldOfView) {
    fbb_.AddElement<double>(SeradataOpticalPayload_Full::VT_FIELDOFVIEW, fieldOfView, 0.0);
  }
  void add_fieldOfRegard(double fieldOfRegard) {
    fbb_.AddElement<double>(SeradataOpticalPayload_Full::VT_FIELDOFREGARD, fieldOfRegard, 0.0);
  }
  void add_pointingMethod(::flatbuffers::Offset<::flatbuffers::String> pointingMethod) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_POINTINGMETHOD, pointingMethod);
  }
  void add_groundStations(::flatbuffers::Offset<::flatbuffers::String> groundStations) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_GROUNDSTATIONS, groundStations);
  }
  void add_groundStationLocations(::flatbuffers::Offset<::flatbuffers::String> groundStationLocations) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_GROUNDSTATIONLOCATIONS, groundStationLocations);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_NOTES, notes);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SeradataOpticalPayload_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(SeradataOpticalPayload_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SeradataOpticalPayload_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit SeradataOpticalPayload_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SeradataOpticalPayload_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SeradataOpticalPayload_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SeradataOpticalPayload_Full> CreateSeradataOpticalPayload_Full(
    ...
    SeradataOpticalPayload_Full_dataMode_Enum dataMode = SeradataOpticalPayload_Full_dataMode_Enum_REAL) {
  SeradataOpticalPayload_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SeradataOpticalPayload_Full> CreateSeradataOpticalPayload_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const SeradataOpticalPayload_Full *GetSeradataOpticalPayload_Full(const void *buf) {
  return ::flatbuffers::GetRoot<SeradataOpticalPayload_Full>(buf);
}

inline const SeradataOpticalPayload_Full *GetSizePrefixedSeradataOpticalPayload_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SeradataOpticalPayload_Full>(buf);
}

inline const char *SeradataOpticalPayload_FullIdentifier() {
  return "SERA";
}

inline bool SeradataOpticalPayload_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataOpticalPayload_FullIdentifier());
}

inline bool SizePrefixedSeradataOpticalPayload_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataOpticalPayload_FullIdentifier(), true);
}

inline bool VerifySeradataOpticalPayload_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SeradataOpticalPayload_Full>(SeradataOpticalPayload_FullIdentifier());
}

inline bool VerifySizePrefixedSeradataOpticalPayload_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SeradataOpticalPayload_Full>(SeradataOpticalPayload_FullIdentifier());
}

inline void FinishSeradataOpticalPayload_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataOpticalPayload_Full> root) {
  fbb.Finish(root, SeradataOpticalPayload_FullIdentifier());
}

inline void FinishSizePrefixedSeradataOpticalPayload_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataOpticalPayload_Full> root) {
  fbb.FinishSizePrefixed(root, SeradataOpticalPayload_FullIdentifier());
}
