...
struct SpaceEnvObservation_Ingest;
struct SpaceEnvObservation_IngestBuilder;

enum SpaceEnvObservation_Ingest_senReferenceFrame_Enum : int8_t {
  /// No description available.
  SpaceEnvObservation_Ingest_senReferenceFrame_Enum_J2000 = 0,
  /// No description available.
  SpaceEnvObservation_Ingest_senReferenceFrame_Enum_EFG_TDR = 1,
  /// No description available.
  SpaceEnvObservation_Ingest_senReferenceFrame_Enum_ECR_ECEF = 2,
  /// No description available.
  SpaceEnvObservation_Ingest_senReferenceFrame_Enum_TEME = 3,
  /// No description available.
  SpaceEnvObservation_Ingest_senReferenceFrame_Enum_ITRF = 4,
  /// No description available.
  SpaceEnvObservation_Ingest_senReferenceFrame_Enum_GCRF = 5,
  SpaceEnvObservation_Ingest_senReferenceFrame_Enum_MIN = SpaceEnvObservation_Ingest_senReferenceFrame_Enum_J2000,
  SpaceEnvObservation_Ingest_senReferenceFrame_Enum_MAX = SpaceEnvObservation_Ingest_senReferenceFrame_Enum_GCRF
};

inline const SpaceEnvObservation_Ingest_senReferenceFrame_Enum (&EnumValuesSpaceEnvObservation_Ingest_senReferenceFrame_Enum())[6] {
  static const SpaceEnvObservation_Ingest_senReferenceFrame_Enum values[] = {
    SpaceEnvObservation_Ingest_senReferenceFrame_Enum_J2000,
    SpaceEnvObservation_Ingest_senReferenceFrame_Enum_EFG_TDR,
    SpaceEnvObservation_Ingest_senReferenceFrame_Enum_ECR_ECEF,
    SpaceEnvObservation_Ingest_senReferenceFrame_Enum_TEME,
    SpaceEnvObservation_Ingest_senReferenceFrame_Enum_ITRF,
    SpaceEnvObservation_Ingest_senReferenceFrame_Enum_GCRF
  };
  return values;
}

inline const char * const *EnumNamesSpaceEnvObservation_Ingest_senReferenceFrame_Enum() {
...
inline const char *EnumNameSpaceEnvObservation_Ingest_senReferenceFrame_Enum(SpaceEnvObservation_Ingest_senReferenceFrame_Enum e) {
  if (::flatbuffers::IsOutRange(e, SpaceEnvObservation_Ingest_senReferenceFrame_Enum_J2000, SpaceEnvObservation_Ingest_senReferenceFrame_Enum_GCRF)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSpaceEnvObservation_Ingest_senReferenceFrame_Enum()[index];
}

enum SpaceEnvObservation_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  SpaceEnvObservation_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  SpaceEnvObservation_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  SpaceEnvObservation_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  SpaceEnvObservation_Ingest_dataMode_Enum_EXERCISE = 3,
  SpaceEnvObservation_Ingest_dataMode_Enum_MIN = SpaceEnvObservation_Ingest_dataMode_Enum_REAL,
  SpaceEnvObservation_Ingest_dataMode_Enum_MAX = SpaceEnvObservation_Ingest_dataMode_Enum_EXERCISE
};

inline const SpaceEnvObservation_Ingest_dataMode_Enum (&EnumValuesSpaceEnvObservation_Ingest_dataMode_Enum())[4] {
  static const SpaceEnvObservation_Ingest_dataMode_Enum values[] = {
    SpaceEnvObservation_Ingest_dataMode_Enum_REAL,
    SpaceEnvObservation_Ingest_dataMode_Enum_TEST,
    SpaceEnvObservation_Ingest_dataMode_Enum_SIMULATED,
    SpaceEnvObservation_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSpaceEnvObservation_Ingest_dataMode_Enum() {
...
inline const char *EnumNameSpaceEnvObservation_Ingest_dataMode_Enum(SpaceEnvObservation_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SpaceEnvObservation_Ingest_dataMode_Enum_REAL, SpaceEnvObservation_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSpaceEnvObservation_Ingest_dataMode_Enum()[index];
}

/// /// SpaceEnvObservation data.
struct SpaceEnvObservation_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SpaceEnvObservation_IngestBuilder Builder;
  ...
  SpaceEnvObservation_Ingest_senReferenceFrame_Enum senReferenceFrame() const {
    return static_cast<SpaceEnvObservation_Ingest_senReferenceFrame_Enum>(GetField<int8_t>(VT_SENREFERENCEFRAME, 0));
  }
  ...
  SpaceEnvObservation_Ingest_dataMode_Enum dataMode() const {
    return static_cast<SpaceEnvObservation_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SpaceEnvObservation_IngestBuilder {
  typedef SpaceEnvObservation_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_msgType(::flatbuffers::Offset<::flatbuffers::String> msgType) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_MSGTYPE, msgType);
  }
  void add_genSystem(::flatbuffers::Offset<::flatbuffers::String> genSystem) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_GENSYSTEM, genSystem);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_EXTERNALID, externalId);
  }
  void add_dataType(::flatbuffers::Offset<::flatbuffers::String> dataType) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_DATATYPE, dataType);
  }
  void add_genTime(::flatbuffers::Offset<::flatbuffers::String> genTime) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_GENTIME, genTime);
  }
  void add_forecast(bool forecast) {
    fbb_.AddElement<uint8_t>(SpaceEnvObservation_Ingest::VT_FORECAST, static_cast<uint8_t>(forecast), 0);
  }
  void add_derived(bool derived) {
    fbb_.AddElement<uint8_t>(SpaceEnvObservation_Ingest::VT_DERIVED, static_cast<uint8_t>(derived), 0);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(SpaceEnvObservation_Ingest::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_ORIGOBJECTID, origObjectId);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_ORIGSENSORID, origSensorId);
  }
  void add_observatoryType(::flatbuffers::Offset<::flatbuffers::String> observatoryType) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_OBSERVATORYTYPE, observatoryType);
  }
  void add_observatoryName(::flatbuffers::Offset<::flatbuffers::String> observatoryName) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_OBSERVATORYNAME, observatoryName);
  }
  void add_observatoryNotes(::flatbuffers::Offset<::flatbuffers::String> observatoryNotes) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_OBSERVATORYNOTES, observatoryNotes);
  }
  void add_instrumentType(::flatbuffers::Offset<::flatbuffers::String> instrumentType) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_INSTRUMENTTYPE, instrumentType);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(SpaceEnvObservation_Ingest::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(SpaceEnvObservation_Ingest::VT_LON, lon, 0.0);
  }
  void add_alt(double alt) {
    fbb_.AddElement<double>(SpaceEnvObservation_Ingest::VT_ALT, alt, 0.0);
  }
  void add_senReferenceFrame(SpaceEnvObservation_Ingest_senReferenceFrame_Enum senReferenceFrame) {
    fbb_.AddElement<int8_t>(SpaceEnvObservation_Ingest::VT_SENREFERENCEFRAME, static_cast<int8_t>(senReferenceFrame), 0);
  }
  void add_senPos(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> senPos) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_SENPOS, senPos);
  }
  void add_senVel(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> senVel) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_SENVEL, senVel);
  }
  void add_measType(::flatbuffers::Offset<::flatbuffers::String> measType) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_MEASTYPE, measType);
  }
  void add_senEnergyLevel(::flatbuffers::Offset<::flatbuffers::String> senEnergyLevel) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_SENENERGYLEVEL, senEnergyLevel);
  }
  void add_obSetId(::flatbuffers::Offset<::flatbuffers::String> obSetId) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_OBSETID, obSetId);
  }
  void add_particleType(::flatbuffers::Offset<::flatbuffers::String> particleType) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_PARTICLETYPE, particleType);
  }
  void add_obTime(::flatbuffers::Offset<::flatbuffers::String> obTime) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_OBTIME, obTime);
  }
  void add_seoList(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> seoList) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_SEOLIST, seoList);
  }
  void add_quality(::flatbuffers::Offset<::flatbuffers::String> quality) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_QUALITY, quality);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_DESCRIPTION, description);
  }
  void add_descriptor(::flatbuffers::Offset<::flatbuffers::String> descriptor) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_DESCRIPTOR, descriptor);
  }
  void add_srcTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcTyps) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_SRCTYPS, srcTyps);
  }
  void add_srcIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcIds) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_SRCIDS, srcIds);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(SpaceEnvObservation_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SpaceEnvObservation_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SpaceEnvObservation_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  explicit SpaceEnvObservation_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SpaceEnvObservation_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SpaceEnvObservation_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SpaceEnvObservation_Ingest> CreateSpaceEnvObservation_Ingest(
    ...
    double lon = 0.0,
    double alt = 0.0,
    SpaceEnvObservation_Ingest_senReferenceFrame_Enum senReferenceFrame = SpaceEnvObservation_Ingest_senReferenceFrame_Enum_J2000,
    ...
    SpaceEnvObservation_Ingest_dataMode_Enum dataMode = SpaceEnvObservation_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  SpaceEnvObservation_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SpaceEnvObservation_Ingest> CreateSpaceEnvObservation_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateSpaceEnvObservation_Ingest(
      _fbb,
      id__,
...
inline const SpaceEnvObservation_Ingest *GetSpaceEnvObservation_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<SpaceEnvObservation_Ingest>(buf);
}

inline const SpaceEnvObservation_Ingest *GetSizePrefixedSpaceEnvObservation_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SpaceEnvObservation_Ingest>(buf);
}

inline const char *SpaceEnvObservation_IngestIdentifier() {
  return "SPAC";
}

inline bool SpaceEnvObservation_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SpaceEnvObservation_IngestIdentifier());
}

inline bool SizePrefixedSpaceEnvObservation_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SpaceEnvObservation_IngestIdentifier(), true);
}

inline bool VerifySpaceEnvObservation_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SpaceEnvObservation_Ingest>(SpaceEnvObservation_IngestIdentifier());
}

inline bool VerifySizePrefixedSpaceEnvObservation_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SpaceEnvObservation_Ingest>(SpaceEnvObservation_IngestIdentifier());
}

inline void FinishSpaceEnvObservation_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SpaceEnvObservation_Ingest> root) {
  fbb.Finish(root, SpaceEnvObservation_IngestIdentifier());
}

inline void FinishSizePrefixedSpaceEnvObservation_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SpaceEnvObservation_Ingest> root) {
  fbb.FinishSizePrefixed(root, SpaceEnvObservation_IngestIdentifier());
}
