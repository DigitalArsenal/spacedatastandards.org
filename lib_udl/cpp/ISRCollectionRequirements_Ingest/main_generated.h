...
struct ISRCollectionRequirements_Ingest;
struct ISRCollectionRequirements_IngestBuilder;

/// /// Tasking desired collection requirements.
struct ISRCollectionRequirements_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef ISRCollectionRequirements_IngestBuilder Builder;
...
struct ISRCollectionRequirements_IngestBuilder {
  typedef ISRCollectionRequirements_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_ID, id);
  }
  void add_hash(::flatbuffers::Offset<::flatbuffers::String> hash) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_HASH, hash);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_TYPE, type);
  }
  void add_cridNumbers(::flatbuffers::Offset<::flatbuffers::String> cridNumbers) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_CRIDNUMBERS, cridNumbers);
  }
  void add_priority(double priority) {
    fbb_.AddElement<double>(ISRCollectionRequirements_Ingest::VT_PRIORITY, priority, 0.0);
  }
  void add_recordId(::flatbuffers::Offset<::flatbuffers::String> recordId) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_RECORDID, recordId);
  }
  void add_reconSurvey(::flatbuffers::Offset<::flatbuffers::String> reconSurvey) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_RECONSURVEY, reconSurvey);
  }
  void add_intelDiscipline(::flatbuffers::Offset<::flatbuffers::String> intelDiscipline) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_INTELDISCIPLINE, intelDiscipline);
  }
  void add_secondary(bool secondary) {
    fbb_.AddElement<uint8_t>(ISRCollectionRequirements_Ingest::VT_SECONDARY, static_cast<uint8_t>(secondary), 0);
  }
  void add_emphasized(bool emphasized) {
    fbb_.AddElement<uint8_t>(ISRCollectionRequirements_Ingest::VT_EMPHASIZED, static_cast<uint8_t>(emphasized), 0);
  }
  void add_isPrismCr(bool isPrismCr) {
    fbb_.AddElement<uint8_t>(ISRCollectionRequirements_Ingest::VT_ISPRISMCR, static_cast<uint8_t>(isPrismCr), 0);
  }
  void add_start(::flatbuffers::Offset<::flatbuffers::String> start) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_START, start);
  }
  void add_stop(::flatbuffers::Offset<::flatbuffers::String> stop) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_STOP, stop);
  }
  void add_operation(::flatbuffers::Offset<::flatbuffers::String> operation) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_OPERATION, operation);
  }
  void add_supportedUnit(::flatbuffers::Offset<::flatbuffers::String> supportedUnit) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_SUPPORTEDUNIT, supportedUnit);
  }
  void add_country(::flatbuffers::Offset<::flatbuffers::String> country) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_COUNTRY, country);
  }
  void add_region(::flatbuffers::Offset<::flatbuffers::String> region) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_REGION, region);
  }
  void add_subregion(::flatbuffers::Offset<::flatbuffers::String> subregion) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_SUBREGION, subregion);
  }
  void add_specialComGuidance(::flatbuffers::Offset<::flatbuffers::String> specialComGuidance) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_SPECIALCOMGUIDANCE, specialComGuidance);
  }
  void add_criticalTimes(::flatbuffers::Offset<::flatbuffers::String> criticalTimes) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_CRITICALTIMES, criticalTimes);
  }
  void add_exploitationRequirement(::flatbuffers::Offset<::flatbuffers::String> exploitationRequirement) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_EXPLOITATIONREQUIREMENT, exploitationRequirement);
  }
  void add_targetList(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> targetList) {
    fbb_.AddOffset(ISRCollectionRequirements_Ingest::VT_TARGETLIST, targetList);
  }
  explicit ISRCollectionRequirements_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<ISRCollectionRequirements_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<ISRCollectionRequirements_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<ISRCollectionRequirements_Ingest> CreateISRCollectionRequirements_Ingest(
  ...
  ISRCollectionRequirements_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<ISRCollectionRequirements_Ingest> CreateISRCollectionRequirements_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateISRCollectionRequirements_Ingest(
      _fbb,
      id__,
      hash__,
      type__,
...
inline const ISRCollectionRequirements_Ingest *GetISRCollectionRequirements_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<ISRCollectionRequirements_Ingest>(buf);
}

inline const ISRCollectionRequirements_Ingest *GetSizePrefixedISRCollectionRequirements_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<ISRCollectionRequirements_Ingest>(buf);
}

inline const char *ISRCollectionRequirements_IngestIdentifier() {
  return "ISRC";
}

inline bool ISRCollectionRequirements_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ISRCollectionRequirements_IngestIdentifier());
}

inline bool SizePrefixedISRCollectionRequirements_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ISRCollectionRequirements_IngestIdentifier(), true);
}

inline bool VerifyISRCollectionRequirements_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<ISRCollectionRequirements_Ingest>(ISRCollectionRequirements_IngestIdentifier());
}

inline bool VerifySizePrefixedISRCollectionRequirements_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<ISRCollectionRequirements_Ingest>(ISRCollectionRequirements_IngestIdentifier());
}

inline void FinishISRCollectionRequirements_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ISRCollectionRequirements_Ingest> root) {
  fbb.Finish(root, ISRCollectionRequirements_IngestIdentifier());
}

inline void FinishSizePrefixedISRCollectionRequirements_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ISRCollectionRequirements_Ingest> root) {
  fbb.FinishSizePrefixed(root, ISRCollectionRequirements_IngestIdentifier());
}
