...
struct GNSSObservation_Abridged;
struct GNSSObservation_AbridgedBuilder;
...
struct GNSSObservation_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef GNSSObservation_AbridgedBuilder Builder;
...
struct GNSSObservation_AbridgedBuilder {
  typedef GNSSObservation_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_gnssSatId(::flatbuffers::Offset<::flatbuffers::String> gnssSatId) {
    fbb_.AddOffset(GNSSObservation_Abridged::VT_GNSSSATID, gnssSatId);
  }
  void add_trackingStatus(int32_t trackingStatus) {
    fbb_.AddElement<int32_t>(GNSSObservation_Abridged::VT_TRACKINGSTATUS, trackingStatus, 0);
  }
  void add_agcState(int32_t agcState) {
    fbb_.AddElement<int32_t>(GNSSObservation_Abridged::VT_AGCSTATE, agcState, 0);
  }
  void add_obsCodeSet(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> obsCodeSet) {
    fbb_.AddOffset(GNSSObservation_Abridged::VT_OBSCODESET, obsCodeSet);
  }
  void add_ob(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> ob) {
    fbb_.AddOffset(GNSSObservation_Abridged::VT_OB, ob);
  }
  explicit GNSSObservation_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<GNSSObservation_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<GNSSObservation_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<GNSSObservation_Abridged> CreateGNSSObservation_Abridged(
  ...
  GNSSObservation_AbridgedBuilder builder_(_fbb);
  builder_.add_ob(ob);
...
inline ::flatbuffers::Offset<GNSSObservation_Abridged> CreateGNSSObservation_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const GNSSObservation_Abridged *GetGNSSObservation_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<GNSSObservation_Abridged>(buf);
}

inline const GNSSObservation_Abridged *GetSizePrefixedGNSSObservation_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<GNSSObservation_Abridged>(buf);
}

inline const char *GNSSObservation_AbridgedIdentifier() {
  return "GNSS";
}

inline bool GNSSObservation_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, GNSSObservation_AbridgedIdentifier());
}

inline bool SizePrefixedGNSSObservation_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, GNSSObservation_AbridgedIdentifier(), true);
}

inline bool VerifyGNSSObservation_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<GNSSObservation_Abridged>(GNSSObservation_AbridgedIdentifier());
}

inline bool VerifySizePrefixedGNSSObservation_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<GNSSObservation_Abridged>(GNSSObservation_AbridgedIdentifier());
}

inline void FinishGNSSObservation_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<GNSSObservation_Abridged> root) {
  fbb.Finish(root, GNSSObservation_AbridgedIdentifier());
}

inline void FinishSizePrefixedGNSSObservation_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<GNSSObservation_Abridged> root) {
  fbb.FinishSizePrefixed(root, GNSSObservation_AbridgedIdentifier());
}
