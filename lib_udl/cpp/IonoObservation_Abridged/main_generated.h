...
struct IonoObservation_Abridged;
struct IonoObservation_AbridgedBuilder;

enum IonoObservation_Abridged_transmitSensorType_Enum : int8_t {
  /// No description available.
  IonoObservation_Abridged_transmitSensorType_Enum_MOBILE = 0,
  /// No description available.
  IonoObservation_Abridged_transmitSensorType_Enum_STATIC = 1,
  IonoObservation_Abridged_transmitSensorType_Enum_MIN = IonoObservation_Abridged_transmitSensorType_Enum_MOBILE,
  IonoObservation_Abridged_transmitSensorType_Enum_MAX = IonoObservation_Abridged_transmitSensorType_Enum_STATIC
};

inline const IonoObservation_Abridged_transmitSensorType_Enum (&EnumValuesIonoObservation_Abridged_transmitSensorType_Enum())[2] {
  static const IonoObservation_Abridged_transmitSensorType_Enum values[] = {
    IonoObservation_Abridged_transmitSensorType_Enum_MOBILE,
    IonoObservation_Abridged_transmitSensorType_Enum_STATIC
  };
  return values;
}

inline const char * const *EnumNamesIonoObservation_Abridged_transmitSensorType_Enum() {
...
inline const char *EnumNameIonoObservation_Abridged_transmitSensorType_Enum(IonoObservation_Abridged_transmitSensorType_Enum e) {
  if (::flatbuffers::IsOutRange(e, IonoObservation_Abridged_transmitSensorType_Enum_MOBILE, IonoObservation_Abridged_transmitSensorType_Enum_STATIC)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesIonoObservation_Abridged_transmitSensorType_Enum()[index];
}

enum IonoObservation_Abridged_receiveSensorType_Enum : int8_t {
  /// No description available.
  IonoObservation_Abridged_receiveSensorType_Enum_MOBILE = 0,
  /// No description available.
  IonoObservation_Abridged_receiveSensorType_Enum_STATIC = 1,
  IonoObservation_Abridged_receiveSensorType_Enum_MIN = IonoObservation_Abridged_receiveSensorType_Enum_MOBILE,
  IonoObservation_Abridged_receiveSensorType_Enum_MAX = IonoObservation_Abridged_receiveSensorType_Enum_STATIC
};

inline const IonoObservation_Abridged_receiveSensorType_Enum (&EnumValuesIonoObservation_Abridged_receiveSensorType_Enum())[2] {
  static const IonoObservation_Abridged_receiveSensorType_Enum values[] = {
    IonoObservation_Abridged_receiveSensorType_Enum_MOBILE,
    IonoObservation_Abridged_receiveSensorType_Enum_STATIC
  };
  return values;
}

inline const char * const *EnumNamesIonoObservation_Abridged_receiveSensorType_Enum() {
  static const char * const names[3] = {
    "MOBILE",
    "STATIC",
    nullptr
...
inline const char *EnumNameIonoObservation_Abridged_receiveSensorType_Enum(IonoObservation_Abridged_receiveSensorType_Enum e) {
  if (::flatbuffers::IsOutRange(e, IonoObservation_Abridged_receiveSensorType_Enum_MOBILE, IonoObservation_Abridged_receiveSensorType_Enum_STATIC)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesIonoObservation_Abridged_receiveSensorType_Enum()[index];
}

enum IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum : int8_t {
  /// No description available.
  IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_J2000 = 0,
  /// No description available.
  IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_ECR_ECEF = 1,
  /// No description available.
  IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_TEME = 2,
  /// No description available.
  IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_GCRF = 3,
  /// No description available.
  IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_WGS84__GEODETIC_LAT__LONG__ALT_ = 4,
  /// No description available.
  IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_GEOCENTRIC__LAT__LONG__RADII_ = 5,
  IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_MIN = IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_J2000,
  IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_MAX = IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_GEOCENTRIC__LAT__LONG__RADII_
};

inline const IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum (&EnumValuesIonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum())[6] {
  static const IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum values[] = {
    IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_J2000,
    IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_ECR_ECEF,
    IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_TEME,
    IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_GCRF,
    IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_WGS84__GEODETIC_LAT__LONG__ALT_,
    IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_GEOCENTRIC__LAT__LONG__RADII_
  };
  return values;
}

inline const char * const *EnumNamesIonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum() {
...
inline const char *EnumNameIonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum(IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum e) {
  if (::flatbuffers::IsOutRange(e, IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_J2000, IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_GEOCENTRIC__LAT__LONG__RADII_)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesIonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum()[index];
}

enum IonoObservation_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  IonoObservation_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  IonoObservation_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  IonoObservation_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  IonoObservation_Abridged_dataMode_Enum_EXERCISE = 3,
  IonoObservation_Abridged_dataMode_Enum_MIN = IonoObservation_Abridged_dataMode_Enum_REAL,
  IonoObservation_Abridged_dataMode_Enum_MAX = IonoObservation_Abridged_dataMode_Enum_EXERCISE
};

inline const IonoObservation_Abridged_dataMode_Enum (&EnumValuesIonoObservation_Abridged_dataMode_Enum())[4] {
  static const IonoObservation_Abridged_dataMode_Enum values[] = {
    IonoObservation_Abridged_dataMode_Enum_REAL,
    IonoObservation_Abridged_dataMode_Enum_TEST,
    IonoObservation_Abridged_dataMode_Enum_SIMULATED,
    IonoObservation_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesIonoObservation_Abridged_dataMode_Enum() {
...
inline const char *EnumNameIonoObservation_Abridged_dataMode_Enum(IonoObservation_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, IonoObservation_Abridged_dataMode_Enum_REAL, IonoObservation_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesIonoObservation_Abridged_dataMode_Enum()[index];
}
...
struct IonoObservation_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef IonoObservation_AbridgedBuilder Builder;
  ...
  IonoObservation_Abridged_transmitSensorType_Enum transmitSensorType() const {
    return static_cast<IonoObservation_Abridged_transmitSensorType_Enum>(GetField<int8_t>(VT_TRANSMITSENSORTYPE, 0));
  }
  /// List of Geodetic Latitude, Longitude, and Altitude coordinates in km of the receiver. Coordinates List must always have 3 elements. Valid ranges are -90.0 to 90.0 for Latitude and -180.0 to 180.0 for Longitude. Altitude is in km and its value must be 0 or greater.
  /// Example: /// Example: [[45.5, 179.3, 35.6], [-80.2, -20.5, 43.2]]
  /// Constraints: No constraints specified.
  ...
  /// Example: /// Example: Mobile
  /// Constraints: Minimum length = 0, Maximum length = 16
  IonoObservation_Abridged_receiveSensorType_Enum receiveSensorType() const {
    return static_cast<IonoObservation_Abridged_receiveSensorType_Enum>(GetField<int8_t>(VT_RECEIVESENSORTYPE, 0));
  }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  ...
  IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum antennaElementPositionCoordinateSystem() const {
    return static_cast<IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum>(GetField<int8_t>(VT_ANTENNAELEMENTPOSITIONCOORDINATESYSTEM, 0));
  }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  ...
  IonoObservation_Abridged_dataMode_Enum dataMode() const {
    return static_cast<IonoObservation_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct IonoObservation_AbridgedBuilder {
  typedef IonoObservation_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_ORIGSENSORID, origSensorId);
  }
  void add_system(::flatbuffers::Offset<::flatbuffers::String> system) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_SYSTEM, system);
  }
  void add_neProfileName(::flatbuffers::Offset<::flatbuffers::String> neProfileName) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_NEPROFILENAME, neProfileName);
  }
  void add_neProfileVersion(double neProfileVersion) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_NEPROFILEVERSION, neProfileVersion, 0.0);
  }
  void add_scalerInfo(::flatbuffers::Offset<::flatbuffers::String> scalerInfo) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_SCALERINFO, scalerInfo);
  }
  void add_densityProfile(::flatbuffers::Offset<::flatbuffers::String> densityProfile) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_DENSITYPROFILE, densityProfile);
  }
  void add_stationId(::flatbuffers::Offset<::flatbuffers::String> stationId) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_STATIONID, stationId);
  }
  void add_startTimeUTC(::flatbuffers::Offset<::flatbuffers::String> startTimeUTC) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_STARTTIMEUTC, startTimeUTC);
  }
  void add_systemInfo(::flatbuffers::Offset<::flatbuffers::String> systemInfo) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_SYSTEMINFO, systemInfo);
  }
  void add_systemNotes(::flatbuffers::Offset<::flatbuffers::String> systemNotes) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_SYSTEMNOTES, systemNotes);
  }
  void add_transmitCoordinates(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> transmitCoordinates) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_TRANSMITCOORDINATES, transmitCoordinates);
  }
  void add_transmitSensorType(IonoObservation_Abridged_transmitSensorType_Enum transmitSensorType) {
    fbb_.AddElement<int8_t>(IonoObservation_Abridged::VT_TRANSMITSENSORTYPE, static_cast<int8_t>(transmitSensorType), 0);
  }
  void add_receiveCoordinates(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> receiveCoordinates) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_RECEIVECOORDINATES, receiveCoordinates);
  }
  void add_receiveSensorType(IonoObservation_Abridged_receiveSensorType_Enum receiveSensorType) {
    fbb_.AddElement<int8_t>(IonoObservation_Abridged::VT_RECEIVESENSORTYPE, static_cast<int8_t>(receiveSensorType), 0);
  }
  void add_antennaElementPosition(::flatbuffers::Offset<::flatbuffers::String> antennaElementPosition) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_ANTENNAELEMENTPOSITION, antennaElementPosition);
  }
  void add_antennaElementPositionCoordinateSystem(IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum antennaElementPositionCoordinateSystem) {
    fbb_.AddElement<int8_t>(IonoObservation_Abridged::VT_ANTENNAELEMENTPOSITIONCOORDINATESYSTEM, static_cast<int8_t>(antennaElementPositionCoordinateSystem), 0);
  }
  void add_power(::flatbuffers::Offset<::flatbuffers::String> power) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_POWER, power);
  }
  void add_range(::flatbuffers::Offset<::flatbuffers::String> range) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_RANGE, range);
  }
  void add_frequency(::flatbuffers::Offset<::flatbuffers::String> frequency) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_FREQUENCY, frequency);
  }
  void add_polarization(::flatbuffers::Offset<::flatbuffers::String> polarization) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_POLARIZATION, polarization);
  }
  void add_azimuth(::flatbuffers::Offset<::flatbuffers::String> azimuth) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_AZIMUTH, azimuth);
  }
  void add_elevation(::flatbuffers::Offset<::flatbuffers::String> elevation) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_ELEVATION, elevation);
  }
  void add_restrictedFrequency(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> restrictedFrequency) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_RESTRICTEDFREQUENCY, restrictedFrequency);
  }
  void add_restrictedFrequencyNotes(::flatbuffers::Offset<::flatbuffers::String> restrictedFrequencyNotes) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_RESTRICTEDFREQUENCYNOTES, restrictedFrequencyNotes);
  }
  void add_doppler(::flatbuffers::Offset<::flatbuffers::String> doppler) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_DOPPLER, doppler);
  }
  void add_time(::flatbuffers::Offset<::flatbuffers::String> time) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_TIME, time);
  }
  void add_stokes(::flatbuffers::Offset<::flatbuffers::String> stokes) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_STOKES, stokes);
  }
  void add_amplitude(::flatbuffers::Offset<::flatbuffers::String> amplitude) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_AMPLITUDE, amplitude);
  }
  void add_phase(::flatbuffers::Offset<::flatbuffers::String> phase) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_PHASE, phase);
  }
  void add_foF2(double foF2) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FOF2, foF2, 0.0);
  }
  void add_foF1(double foF1) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FOF1, foF1, 0.0);
  }
  void add_fxF2(double fxF2) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FXF2, fxF2, 0.0);
  }
  void add_fxF1(double fxF1) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FXF1, fxF1, 0.0);
  }
  void add_md(double md) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_MD, md, 0.0);
  }
  void add_luf(double luf) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_LUF, luf, 0.0);
  }
  void add_mufd(double mufd) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_MUFD, mufd, 0.0);
  }
  void add_fmin(double fmin) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FMIN, fmin, 0.0);
  }
  void add_foEs(double foEs) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FOES, foEs, 0.0);
  }
  void add_fminF(double fminF) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FMINF, fminF, 0.0);
  }
  void add_fminE(double fminE) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FMINE, fminE, 0.0);
  }
  void add_foE(double foE) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FOE, foE, 0.0);
  }
  void add_fxE(double fxE) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FXE, fxE, 0.0);
  }
  void add_fxI(double fxI) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FXI, fxI, 0.0);
  }
  void add_hprimeF(double hprimeF) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_HPRIMEF, hprimeF, 0.0);
  }
  void add_hprimeF2(double hprimeF2) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_HPRIMEF2, hprimeF2, 0.0);
  }
  void add_hprimeF1(double hprimeF1) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_HPRIMEF1, hprimeF1, 0.0);
  }
  void add_hprimeE(double hprimeE) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_HPRIMEE, hprimeE, 0.0);
  }
  void add_hprimeEs(double hprimeEs) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_HPRIMEES, hprimeEs, 0.0);
  }
  void add_zmE(double zmE) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_ZME, zmE, 0.0);
  }
  void add_yE(double yE) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_YE, yE, 0.0);
  }
  void add_qf(double qf) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_QF, qf, 0.0);
  }
  void add_qe(double qe) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_QE, qe, 0.0);
  }
  void add_downF(double downF) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_DOWNF, downF, 0.0);
  }
  void add_downE(double downE) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_DOWNE, downE, 0.0);
  }
  void add_downEs(double downEs) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_DOWNES, downEs, 0.0);
  }
  void add_ff(double ff) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FF, ff, 0.0);
  }
  void add_fe(double fe) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FE, fe, 0.0);
  }
  void add_d(double d) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_D, d, 0.0);
  }
  void add_fmuf(double fmuf) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FMUF, fmuf, 0.0);
  }
  void add_hprimefMUF(double hprimefMUF) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_HPRIMEFMUF, hprimefMUF, 0.0);
  }
  void add_deltafoF2(double deltafoF2) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_DELTAFOF2, deltafoF2, 0.0);
  }
  void add_foEp(double foEp) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FOEP, foEp, 0.0);
  }
  void add_fhprimeF(double fhprimeF) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FHPRIMEF, fhprimeF, 0.0);
  }
  void add_fhprimeF2(double fhprimeF2) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FHPRIMEF2, fhprimeF2, 0.0);
  }
  void add_foF1p(double foF1p) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FOF1P, foF1p, 0.0);
  }
  void add_foF2p(double foF2p) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FOF2P, foF2p, 0.0);
  }
  void add_hmF2(double hmF2) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_HMF2, hmF2, 0.0);
  }
  void add_hmF1(double hmF1) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_HMF1, hmF1, 0.0);
  }
  void add_hmE(double hmE) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_HME, hmE, 0.0);
  }
  void add_zhalfNm(double zhalfNm) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_ZHALFNM, zhalfNm, 0.0);
  }
  void add_fminEs(double fminEs) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FMINES, fminEs, 0.0);
  }
  void add_yF2(double yF2) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_YF2, yF2, 0.0);
  }
  void add_yF1(double yF1) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_YF1, yF1, 0.0);
  }
  void add_tec(double tec) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_TEC, tec, 0.0);
  }
  void add_scaleHeightF2Peak(double scaleHeightF2Peak) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_SCALEHEIGHTF2PEAK, scaleHeightF2Peak, 0.0);
  }
  void add_b0(double b0) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_B0, b0, 0.0);
  }
  void add_b1(double b1) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_B1, b1, 0.0);
  }
  void add_d1(double d1) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_D1, d1, 0.0);
  }
  void add_foEa(double foEa) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FOEA, foEa, 0.0);
  }
  void add_hprimeEa(double hprimeEa) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_HPRIMEEA, hprimeEa, 0.0);
  }
  void add_foP(double foP) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FOP, foP, 0.0);
  }
  void add_hprimeP(double hprimeP) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_HPRIMEP, hprimeP, 0.0);
  }
  void add_fbEs(double fbEs) {
    fbb_.AddElement<double>(IonoObservation_Abridged::VT_FBES, fbEs, 0.0);
  }
  void add_typeEs(::flatbuffers::Offset<::flatbuffers::String> typeEs) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_TYPEES, typeEs);
  }
  void add_charAtts(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> charAtts) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_CHARATTS, charAtts);
  }
  void add_height(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> height) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_HEIGHT, height);
  }
  void add_plasmaFrequency(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> plasmaFrequency) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_PLASMAFREQUENCY, plasmaFrequency);
  }
  void add_plasmaFrequencyUncertainty(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> plasmaFrequencyUncertainty) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_PLASMAFREQUENCYUNCERTAINTY, plasmaFrequencyUncertainty);
  }
  void add_electronDensity(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> electronDensity) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_ELECTRONDENSITY, electronDensity);
  }
  void add_electronDensityUncertainty(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> electronDensityUncertainty) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_ELECTRONDENSITYUNCERTAINTY, electronDensityUncertainty);
  }
  void add_artistFlags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> artistFlags) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_ARTISTFLAGS, artistFlags);
  }
  void add_traceGeneric(::flatbuffers::Offset<::flatbuffers::String> traceGeneric) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_TRACEGENERIC, traceGeneric);
  }
  void add_tidPhaseSpeeds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tidPhaseSpeeds) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_TIDPHASESPEEDS, tidPhaseSpeeds);
  }
  void add_tidAzimuth(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tidAzimuth) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_TIDAZIMUTH, tidAzimuth);
  }
  void add_tidPeriods(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tidPeriods) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_TIDPERIODS, tidPeriods);
  }
  void add_datum(::flatbuffers::Offset<::flatbuffers::String> datum) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_DATUM, datum);
  }
  void add_platformName(::flatbuffers::Offset<::flatbuffers::String> platformName) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_PLATFORMNAME, platformName);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(IonoObservation_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(IonoObservation_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(IonoObservation_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  explicit IonoObservation_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<IonoObservation_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<IonoObservation_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<IonoObservation_Abridged> CreateIonoObservation_Abridged(
    ...
    IonoObservation_Abridged_transmitSensorType_Enum transmitSensorType = IonoObservation_Abridged_transmitSensorType_Enum_MOBILE,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> receiveCoordinates = 0,
    IonoObservation_Abridged_receiveSensorType_Enum receiveSensorType = IonoObservation_Abridged_receiveSensorType_Enum_MOBILE,
    ::flatbuffers::Offset<::flatbuffers::String> antennaElementPosition = 0,
    IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum antennaElementPositionCoordinateSystem = IonoObservation_Abridged_antennaElementPositionCoordinateSystem_Enum_J2000,
    ...
    IonoObservation_Abridged_dataMode_Enum dataMode = IonoObservation_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  IonoObservation_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<IonoObservation_Abridged> CreateIonoObservation_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateIonoObservation_Abridged(
      _fbb,
      id__,
...
inline const IonoObservation_Abridged *GetIonoObservation_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<IonoObservation_Abridged>(buf);
}

inline const IonoObservation_Abridged *GetSizePrefixedIonoObservation_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<IonoObservation_Abridged>(buf);
}

inline const char *IonoObservation_AbridgedIdentifier() {
  return "IONO";
}

inline bool IonoObservation_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservation_AbridgedIdentifier());
}

inline bool SizePrefixedIonoObservation_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservation_AbridgedIdentifier(), true);
}

inline bool VerifyIonoObservation_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<IonoObservation_Abridged>(IonoObservation_AbridgedIdentifier());
}

inline bool VerifySizePrefixedIonoObservation_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<IonoObservation_Abridged>(IonoObservation_AbridgedIdentifier());
}

inline void FinishIonoObservation_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservation_Abridged> root) {
  fbb.Finish(root, IonoObservation_AbridgedIdentifier());
}

inline void FinishSizePrefixedIonoObservation_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservation_Abridged> root) {
  fbb.FinishSizePrefixed(root, IonoObservation_AbridgedIdentifier());
}
