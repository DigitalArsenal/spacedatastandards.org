...
struct Sensor_Abridged;
struct Sensor_AbridgedBuilder;

enum Sensor_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Sensor_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Sensor_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Sensor_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Sensor_Abridged_dataMode_Enum_EXERCISE = 3,
  Sensor_Abridged_dataMode_Enum_MIN = Sensor_Abridged_dataMode_Enum_REAL,
  Sensor_Abridged_dataMode_Enum_MAX = Sensor_Abridged_dataMode_Enum_EXERCISE
};

inline const Sensor_Abridged_dataMode_Enum (&EnumValuesSensor_Abridged_dataMode_Enum())[4] {
  static const Sensor_Abridged_dataMode_Enum values[] = {
    Sensor_Abridged_dataMode_Enum_REAL,
    Sensor_Abridged_dataMode_Enum_TEST,
    Sensor_Abridged_dataMode_Enum_SIMULATED,
    Sensor_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSensor_Abridged_dataMode_Enum() {
...
inline const char *EnumNameSensor_Abridged_dataMode_Enum(Sensor_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Sensor_Abridged_dataMode_Enum_REAL, Sensor_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSensor_Abridged_dataMode_Enum()[index];
}

/// /// Model representation of observation data for electro-optical based sensor phenomenologies.
struct Sensor_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Sensor_AbridgedBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_CREATEDBY = 30,
    VT_ACTIVE = 32,
    VT_SENSORCHARACTERISTICS = 34,
    VT_SENSORSTATS = 36,
    VT_SENSORLIMITSCOLLECTION = 38,
    VT_ENTITY = 40,
    VT_IDENTITY = 42,
    VT_SENSOROBSERVATIONTYPE = 44,
    VT_SENSORTYPE = 46
  };
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Sensor_Abridged_dataMode_Enum dataMode() const {
    return static_cast<Sensor_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Sensor_AbridgedBuilder {
  typedef Sensor_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(Sensor_Abridged::VT_IDSENSOR, idSensor);
  }
  void add_sensorName(::flatbuffers::Offset<::flatbuffers::String> sensorName) {
    fbb_.AddOffset(Sensor_Abridged::VT_SENSORNAME, sensorName);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Sensor_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_sensorNumber(int32_t sensorNumber) {
    fbb_.AddElement<int32_t>(Sensor_Abridged::VT_SENSORNUMBER, sensorNumber, 0);
  }
  void add_shortName(::flatbuffers::Offset<::flatbuffers::String> shortName) {
    fbb_.AddOffset(Sensor_Abridged::VT_SHORTNAME, shortName);
  }
  void add_dataControl(::flatbuffers::Offset<::flatbuffers::String> dataControl) {
    fbb_.AddOffset(Sensor_Abridged::VT_DATACONTROL, dataControl);
  }
  void add_afId(::flatbuffers::Offset<::flatbuffers::String> afId) {
    fbb_.AddOffset(Sensor_Abridged::VT_AFID, afId);
  }
  void add_asrType(::flatbuffers::Offset<::flatbuffers::String> asrType) {
    fbb_.AddOffset(Sensor_Abridged::VT_ASRTYPE, asrType);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Sensor_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Sensor_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Sensor_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(Sensor_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Sensor_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Sensor_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Sensor_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_active(bool active) {
    fbb_.AddElement<uint8_t>(Sensor_Abridged::VT_ACTIVE, static_cast<uint8_t>(active), 0);
  }
  void add_sensorcharacteristics(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sensorcharacteristics) {
    fbb_.AddOffset(Sensor_Abridged::VT_SENSORCHARACTERISTICS, sensorcharacteristics);
  }
  void add_sensorStats(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sensorStats) {
    fbb_.AddOffset(Sensor_Abridged::VT_SENSORSTATS, sensorStats);
  }
  void add_sensorlimitsCollection(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sensorlimitsCollection) {
    fbb_.AddOffset(Sensor_Abridged::VT_SENSORLIMITSCOLLECTION, sensorlimitsCollection);
  }
  void add_entity(::flatbuffers::Offset<::flatbuffers::String> entity) {
    fbb_.AddOffset(Sensor_Abridged::VT_ENTITY, entity);
  }
  void add_idEntity(::flatbuffers::Offset<::flatbuffers::String> idEntity) {
    fbb_.AddOffset(Sensor_Abridged::VT_IDENTITY, idEntity);
  }
  void add_sensorObservationType(::flatbuffers::Offset<::flatbuffers::String> sensorObservationType) {
    fbb_.AddOffset(Sensor_Abridged::VT_SENSOROBSERVATIONTYPE, sensorObservationType);
  }
  void add_sensorType(::flatbuffers::Offset<::flatbuffers::String> sensorType) {
    fbb_.AddOffset(Sensor_Abridged::VT_SENSORTYPE, sensorType);
  }
  explicit Sensor_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Sensor_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Sensor_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Sensor_Abridged> CreateSensor_Abridged(
    ...
    Sensor_Abridged_dataMode_Enum dataMode = Sensor_Abridged_dataMode_Enum_REAL,
  ...
  Sensor_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Sensor_Abridged> CreateSensor_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Sensor_Abridged *GetSensor_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<Sensor_Abridged>(buf);
}

inline const Sensor_Abridged *GetSizePrefixedSensor_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Sensor_Abridged>(buf);
}

inline const char *Sensor_AbridgedIdentifier() {
  return "SENS";
}

inline bool Sensor_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Sensor_AbridgedIdentifier());
}

inline bool SizePrefixedSensor_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Sensor_AbridgedIdentifier(), true);
}

inline bool VerifySensor_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Sensor_Abridged>(Sensor_AbridgedIdentifier());
}

inline bool VerifySizePrefixedSensor_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Sensor_Abridged>(Sensor_AbridgedIdentifier());
}

inline void FinishSensor_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Sensor_Abridged> root) {
  fbb.Finish(root, Sensor_AbridgedIdentifier());
}

inline void FinishSizePrefixedSensor_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Sensor_Abridged> root) {
  fbb.FinishSizePrefixed(root, Sensor_AbridgedIdentifier());
}
