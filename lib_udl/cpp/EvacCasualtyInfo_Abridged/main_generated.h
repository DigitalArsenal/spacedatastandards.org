...
struct EvacCasualtyInfo_Abridged;
struct EvacCasualtyInfo_AbridgedBuilder;

/// /// Identity and medical information on the patient to be evacuated.
struct EvacCasualtyInfo_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EvacCasualtyInfo_AbridgedBuilder Builder;
...
inline ::flatbuffers::Offset<EvacCasualtyInfo_Abridged> CreateEvacCasualtyInfo_Abridged(
  ...
  EvacCasualtyInfo_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<EvacCasualtyInfo_Abridged> CreateEvacCasualtyInfo_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const EvacCasualtyInfo_Abridged *GetEvacCasualtyInfo_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<EvacCasualtyInfo_Abridged>(buf);
}

inline const EvacCasualtyInfo_Abridged *GetSizePrefixedEvacCasualtyInfo_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EvacCasualtyInfo_Abridged>(buf);
}

inline const char *EvacCasualtyInfo_AbridgedIdentifier() {
  return "EVAC";
}

inline bool EvacCasualtyInfo_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EvacCasualtyInfo_AbridgedIdentifier());
}

inline bool SizePrefixedEvacCasualtyInfo_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EvacCasualtyInfo_AbridgedIdentifier(), true);
}

inline bool VerifyEvacCasualtyInfo_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EvacCasualtyInfo_Abridged>(EvacCasualtyInfo_AbridgedIdentifier());
}

inline bool VerifySizePrefixedEvacCasualtyInfo_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EvacCasualtyInfo_Abridged>(EvacCasualtyInfo_AbridgedIdentifier());
}

inline void FinishEvacCasualtyInfo_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EvacCasualtyInfo_Abridged> root) {
  fbb.Finish(root, EvacCasualtyInfo_AbridgedIdentifier());
}

inline void FinishSizePrefixedEvacCasualtyInfo_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EvacCasualtyInfo_Abridged> root) {
  fbb.FinishSizePrefixed(root, EvacCasualtyInfo_AbridgedIdentifier());
}
