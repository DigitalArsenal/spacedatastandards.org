...
struct EffectResponse_Abridged;
struct EffectResponse_AbridgedBuilder;

enum EffectResponse_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  EffectResponse_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  EffectResponse_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  EffectResponse_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  EffectResponse_Abridged_dataMode_Enum_EXERCISE = 3,
  EffectResponse_Abridged_dataMode_Enum_MIN = EffectResponse_Abridged_dataMode_Enum_REAL,
  EffectResponse_Abridged_dataMode_Enum_MAX = EffectResponse_Abridged_dataMode_Enum_EXERCISE
};

inline const EffectResponse_Abridged_dataMode_Enum (&EnumValuesEffectResponse_Abridged_dataMode_Enum())[4] {
  static const EffectResponse_Abridged_dataMode_Enum values[] = {
    EffectResponse_Abridged_dataMode_Enum_REAL,
    EffectResponse_Abridged_dataMode_Enum_TEST,
    EffectResponse_Abridged_dataMode_Enum_SIMULATED,
    EffectResponse_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesEffectResponse_Abridged_dataMode_Enum() {
...
inline const char *EnumNameEffectResponse_Abridged_dataMode_Enum(EffectResponse_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, EffectResponse_Abridged_dataMode_Enum_REAL, EffectResponse_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEffectResponse_Abridged_dataMode_Enum()[index];
}

/// /// A response for various effects on a target.
struct EffectResponse_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EffectResponse_AbridgedBuilder Builder;
  ...
  EffectResponse_Abridged_dataMode_Enum dataMode() const {
    return static_cast<EffectResponse_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct EffectResponse_AbridgedBuilder {
  typedef EffectResponse_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idEffectRequest(::flatbuffers::Offset<::flatbuffers::String> idEffectRequest) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_IDEFFECTREQUEST, idEffectRequest);
  }
  void add_externalRequestId(::flatbuffers::Offset<::flatbuffers::String> externalRequestId) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_EXTERNALREQUESTID, externalRequestId);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_TYPE, type);
  }
  void add_actorSrcType(::flatbuffers::Offset<::flatbuffers::String> actorSrcType) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_ACTORSRCTYPE, actorSrcType);
  }
  void add_actorSrcId(::flatbuffers::Offset<::flatbuffers::String> actorSrcId) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_ACTORSRCID, actorSrcId);
  }
  void add_munitionType(::flatbuffers::Offset<::flatbuffers::String> munitionType) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_MUNITIONTYPE, munitionType);
  }
  void add_munitionId(::flatbuffers::Offset<::flatbuffers::String> munitionId) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_MUNITIONID, munitionId);
  }
  void add_shotsRequired(int32_t shotsRequired) {
    fbb_.AddElement<int32_t>(EffectResponse_Abridged::VT_SHOTSREQUIRED, shotsRequired, 0);
  }
  void add_probabilityOfKill(double probabilityOfKill) {
    fbb_.AddElement<double>(EffectResponse_Abridged::VT_PROBABILITYOFKILL, probabilityOfKill, 0.0);
  }
  void add_collateralDamageEst(double collateralDamageEst) {
    fbb_.AddElement<double>(EffectResponse_Abridged::VT_COLLATERALDAMAGEEST, collateralDamageEst, 0.0);
  }
  void add_actionsList(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> actionsList) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_ACTIONSLIST, actionsList);
  }
  void add_externalActions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> externalActions) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_EXTERNALACTIONS, externalActions);
  }
  void add_coaMetrics(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> coaMetrics) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_COAMETRICS, coaMetrics);
  }
  void add_redTimeToOverhead(::flatbuffers::Offset<::flatbuffers::String> redTimeToOverhead) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_REDTIMETOOVERHEAD, redTimeToOverhead);
  }
  void add_decisionDeadline(::flatbuffers::Offset<::flatbuffers::String> decisionDeadline) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_DECISIONDEADLINE, decisionDeadline);
  }
  void add_redTargetSrcType(::flatbuffers::Offset<::flatbuffers::String> redTargetSrcType) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_REDTARGETSRCTYPE, redTargetSrcType);
  }
  void add_redTargetSrcId(::flatbuffers::Offset<::flatbuffers::String> redTargetSrcId) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_REDTARGETSRCID, redTargetSrcId);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(EffectResponse_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(EffectResponse_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(EffectResponse_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  explicit EffectResponse_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<EffectResponse_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<EffectResponse_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<EffectResponse_Abridged> CreateEffectResponse_Abridged(
    ...
    EffectResponse_Abridged_dataMode_Enum dataMode = EffectResponse_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  EffectResponse_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<EffectResponse_Abridged> CreateEffectResponse_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const EffectResponse_Abridged *GetEffectResponse_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<EffectResponse_Abridged>(buf);
}

inline const EffectResponse_Abridged *GetSizePrefixedEffectResponse_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EffectResponse_Abridged>(buf);
}

inline const char *EffectResponse_AbridgedIdentifier() {
  return "EFFE";
}

inline bool EffectResponse_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EffectResponse_AbridgedIdentifier());
}

inline bool SizePrefixedEffectResponse_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EffectResponse_AbridgedIdentifier(), true);
}

inline bool VerifyEffectResponse_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EffectResponse_Abridged>(EffectResponse_AbridgedIdentifier());
}

inline bool VerifySizePrefixedEffectResponse_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EffectResponse_Abridged>(EffectResponse_AbridgedIdentifier());
}

inline void FinishEffectResponse_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EffectResponse_Abridged> root) {
  fbb.Finish(root, EffectResponse_AbridgedIdentifier());
}

inline void FinishSizePrefixedEffectResponse_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EffectResponse_Abridged> root) {
  fbb.FinishSizePrefixed(root, EffectResponse_AbridgedIdentifier());
}
