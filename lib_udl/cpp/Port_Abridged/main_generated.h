...
struct Port_Abridged;
struct Port_AbridgedBuilder;

enum Port_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Port_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Port_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Port_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Port_Abridged_dataMode_Enum_EXERCISE = 3,
  Port_Abridged_dataMode_Enum_MIN = Port_Abridged_dataMode_Enum_REAL,
  Port_Abridged_dataMode_Enum_MAX = Port_Abridged_dataMode_Enum_EXERCISE
};

inline const Port_Abridged_dataMode_Enum (&EnumValuesPort_Abridged_dataMode_Enum())[4] {
  static const Port_Abridged_dataMode_Enum values[] = {
    Port_Abridged_dataMode_Enum_REAL,
    Port_Abridged_dataMode_Enum_TEST,
    Port_Abridged_dataMode_Enum_SIMULATED,
    Port_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesPort_Abridged_dataMode_Enum() {
...
inline const char *EnumNamePort_Abridged_dataMode_Enum(Port_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Port_Abridged_dataMode_Enum_REAL, Port_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesPort_Abridged_dataMode_Enum()[index];
}

/// /// Properties and characteristics of a maritime port, which includes location, port identifiers, and remarks.
struct Port_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Port_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 64
  Port_Abridged_dataMode_Enum dataMode() const {
    return static_cast<Port_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Port_AbridgedBuilder {
  typedef Port_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Port_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Port_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idSite(::flatbuffers::Offset<::flatbuffers::String> idSite) {
    fbb_.AddOffset(Port_Abridged::VT_IDSITE, idSite);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(Port_Abridged::VT_EXTERNALID, externalId);
  }
  void add_locode(::flatbuffers::Offset<::flatbuffers::String> locode) {
    fbb_.AddOffset(Port_Abridged::VT_LOCODE, locode);
  }
  void add_portName(::flatbuffers::Offset<::flatbuffers::String> portName) {
    fbb_.AddOffset(Port_Abridged::VT_PORTNAME, portName);
  }
  void add_harborType(::flatbuffers::Offset<::flatbuffers::String> harborType) {
    fbb_.AddOffset(Port_Abridged::VT_HARBORTYPE, harborType);
  }
  void add_harborSize(double harborSize) {
    fbb_.AddElement<double>(Port_Abridged::VT_HARBORSIZE, harborSize, 0.0);
  }
  void add_maxDraught(double maxDraught) {
    fbb_.AddElement<double>(Port_Abridged::VT_MAXDRAUGHT, maxDraught, 0.0);
  }
  void add_avgDuration(double avgDuration) {
    fbb_.AddElement<double>(Port_Abridged::VT_AVGDURATION, avgDuration, 0.0);
  }
  void add_tideRange(double tideRange) {
    fbb_.AddElement<double>(Port_Abridged::VT_TIDERANGE, tideRange, 0.0);
  }
  void add_shelter(::flatbuffers::Offset<::flatbuffers::String> shelter) {
    fbb_.AddOffset(Port_Abridged::VT_SHELTER, shelter);
  }
  void add_pilotReqd(bool pilotReqd) {
    fbb_.AddElement<uint8_t>(Port_Abridged::VT_PILOTREQD, static_cast<uint8_t>(pilotReqd), 0);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(Port_Abridged::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(Port_Abridged::VT_LON, lon, 0.0);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(Port_Abridged::VT_COUNTRYCODE, countryCode);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Port_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Port_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Port_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Port_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(Port_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Port_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Port_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  explicit Port_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Port_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Port_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Port_Abridged> CreatePort_Abridged(
    ...
    Port_Abridged_dataMode_Enum dataMode = Port_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  Port_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Port_Abridged> CreatePort_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Port_Abridged *GetPort_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<Port_Abridged>(buf);
}

inline const Port_Abridged *GetSizePrefixedPort_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Port_Abridged>(buf);
}

inline const char *Port_AbridgedIdentifier() {
  return "PORT";
}

inline bool Port_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Port_AbridgedIdentifier());
}

inline bool SizePrefixedPort_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Port_AbridgedIdentifier(), true);
}

inline bool VerifyPort_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Port_Abridged>(Port_AbridgedIdentifier());
}

inline bool VerifySizePrefixedPort_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Port_Abridged>(Port_AbridgedIdentifier());
}

inline void FinishPort_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Port_Abridged> root) {
  fbb.Finish(root, Port_AbridgedIdentifier());
}

inline void FinishSizePrefixedPort_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Port_Abridged> root) {
  fbb.FinishSizePrefixed(root, Port_AbridgedIdentifier());
}
