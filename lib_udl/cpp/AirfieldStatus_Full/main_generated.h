...
struct AirfieldStatus_Full;
struct AirfieldStatus_FullBuilder;

enum AirfieldStatus_Full_dataMode_Enum : int8_t {
  ...
  AirfieldStatus_Full_dataMode_Enum_MIN = AirfieldStatus_Full_dataMode_Enum_REAL,
  AirfieldStatus_Full_dataMode_Enum_MAX = AirfieldStatus_Full_dataMode_Enum_EXERCISE
};

inline const AirfieldStatus_Full_dataMode_Enum (&EnumValuesAirfieldStatus_Full_dataMode_Enum())[4] {
  static const AirfieldStatus_Full_dataMode_Enum values[] = {
    AirfieldStatus_Full_dataMode_Enum_REAL,
    AirfieldStatus_Full_dataMode_Enum_TEST,
    AirfieldStatus_Full_dataMode_Enum_SIMULATED,
    AirfieldStatus_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAirfieldStatus_Full_dataMode_Enum() {
...
inline const char *EnumNameAirfieldStatus_Full_dataMode_Enum(AirfieldStatus_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AirfieldStatus_Full_dataMode_Enum_REAL, AirfieldStatus_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAirfieldStatus_Full_dataMode_Enum()[index];
}

/// /// The airfield status contains dynamic data of an airfield's capabilities.
struct AirfieldStatus_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirfieldStatus_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  AirfieldStatus_Full_dataMode_Enum dataMode() const {
    return static_cast<AirfieldStatus_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AirfieldStatus_FullBuilder {
  typedef AirfieldStatus_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idAirfield(::flatbuffers::Offset<::flatbuffers::String> idAirfield) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_IDAIRFIELD, idAirfield);
  }
  void add_altAirfieldId(::flatbuffers::Offset<::flatbuffers::String> altAirfieldId) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_ALTAIRFIELDID, altAirfieldId);
  }
  void add_passengerServiceMOG(int32_t passengerServiceMOG) {
    fbb_.AddElement<int32_t>(AirfieldStatus_Full::VT_PASSENGERSERVICEMOG, passengerServiceMOG, 0);
  }
  void add_fleetServiceMOG(int32_t fleetServiceMOG) {
    fbb_.AddElement<int32_t>(AirfieldStatus_Full::VT_FLEETSERVICEMOG, fleetServiceMOG, 0);
  }
  void add_cargoMOG(int32_t cargoMOG) {
    fbb_.AddElement<int32_t>(AirfieldStatus_Full::VT_CARGOMOG, cargoMOG, 0);
  }
  void add_fuelMOG(int32_t fuelMOG) {
    fbb_.AddElement<int32_t>(AirfieldStatus_Full::VT_FUELMOG, fuelMOG, 0);
  }
  void add_fuelTypes(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> fuelTypes) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_FUELTYPES, fuelTypes);
  }
  void add_fuelQtys(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> fuelQtys) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_FUELQTYS, fuelQtys);
  }
  void add_mxMOG(int32_t mxMOG) {
    fbb_.AddElement<int32_t>(AirfieldStatus_Full::VT_MXMOG, mxMOG, 0);
  }
  void add_operatingMOG(int32_t operatingMOG) {
    fbb_.AddElement<int32_t>(AirfieldStatus_Full::VT_OPERATINGMOG, operatingMOG, 0);
  }
  void add_numCOG(int32_t numCOG) {
    fbb_.AddElement<int32_t>(AirfieldStatus_Full::VT_NUMCOG, numCOG, 0);
  }
  void add_wideWorkingMOG(int32_t wideWorkingMOG) {
    fbb_.AddElement<int32_t>(AirfieldStatus_Full::VT_WIDEWORKINGMOG, wideWorkingMOG, 0);
  }
  void add_wideParkingMOG(int32_t wideParkingMOG) {
    fbb_.AddElement<int32_t>(AirfieldStatus_Full::VT_WIDEPARKINGMOG, wideParkingMOG, 0);
  }
  void add_narrowWorkingMOG(int32_t narrowWorkingMOG) {
    fbb_.AddElement<int32_t>(AirfieldStatus_Full::VT_NARROWWORKINGMOG, narrowWorkingMOG, 0);
  }
  void add_narrowParkingMOG(int32_t narrowParkingMOG) {
    fbb_.AddElement<int32_t>(AirfieldStatus_Full::VT_NARROWPARKINGMOG, narrowParkingMOG, 0);
  }
  void add_mheTypes(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> mheTypes) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_MHETYPES, mheTypes);
  }
  void add_mheQtys(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> mheQtys) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_MHEQTYS, mheQtys);
  }
  void add_medCap(::flatbuffers::Offset<::flatbuffers::String> medCap) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_MEDCAP, medCap);
  }
  void add_arffCat(::flatbuffers::Offset<::flatbuffers::String> arffCat) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_ARFFCAT, arffCat);
  }
  void add_gseTime(int32_t gseTime) {
    fbb_.AddElement<int32_t>(AirfieldStatus_Full::VT_GSETIME, gseTime, 0);
  }
  void add_priRwyNum(::flatbuffers::Offset<::flatbuffers::String> priRwyNum) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_PRIRWYNUM, priRwyNum);
  }
  void add_rwyCondReading(int32_t rwyCondReading) {
    fbb_.AddElement<int32_t>(AirfieldStatus_Full::VT_RWYCONDREADING, rwyCondReading, 0);
  }
  void add_rwyFrictionFactor(int32_t rwyFrictionFactor) {
    fbb_.AddElement<int32_t>(AirfieldStatus_Full::VT_RWYFRICTIONFACTOR, rwyFrictionFactor, 0);
  }
  void add_rwyMarkings(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rwyMarkings) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_RWYMARKINGS, rwyMarkings);
  }
  void add_message(::flatbuffers::Offset<::flatbuffers::String> message) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_MESSAGE, message);
  }
  void add_priFreq(double priFreq) {
    fbb_.AddElement<double>(AirfieldStatus_Full::VT_PRIFREQ, priFreq, 0.0);
  }
  void add_slotTypesReq(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> slotTypesReq) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_SLOTTYPESREQ, slotTypesReq);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AirfieldStatus_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(AirfieldStatus_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AirfieldStatus_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit AirfieldStatus_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirfieldStatus_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirfieldStatus_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirfieldStatus_Full> CreateAirfieldStatus_Full(
    ...
    AirfieldStatus_Full_dataMode_Enum dataMode = AirfieldStatus_Full_dataMode_Enum_REAL) {
  AirfieldStatus_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirfieldStatus_Full> CreateAirfieldStatus_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAirfieldStatus_Full(
      _fbb,
      id__,
...
inline const AirfieldStatus_Full *GetAirfieldStatus_Full(const void *buf) {
  return ::flatbuffers::GetRoot<AirfieldStatus_Full>(buf);
}

inline const AirfieldStatus_Full *GetSizePrefixedAirfieldStatus_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirfieldStatus_Full>(buf);
}

inline const char *AirfieldStatus_FullIdentifier() {
  return "AIRF";
}

inline bool AirfieldStatus_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirfieldStatus_FullIdentifier());
}

inline bool SizePrefixedAirfieldStatus_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirfieldStatus_FullIdentifier(), true);
}

inline bool VerifyAirfieldStatus_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirfieldStatus_Full>(AirfieldStatus_FullIdentifier());
}

inline bool VerifySizePrefixedAirfieldStatus_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirfieldStatus_Full>(AirfieldStatus_FullIdentifier());
}

inline void FinishAirfieldStatus_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirfieldStatus_Full> root) {
  fbb.Finish(root, AirfieldStatus_FullIdentifier());
}

inline void FinishSizePrefixedAirfieldStatus_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirfieldStatus_Full> root) {
  fbb.FinishSizePrefixed(root, AirfieldStatus_FullIdentifier());
}
