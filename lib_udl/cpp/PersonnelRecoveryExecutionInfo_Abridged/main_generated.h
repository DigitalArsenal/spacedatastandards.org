...
struct PersonnelRecoveryExecutionInfo_Abridged;
struct PersonnelRecoveryExecutionInfo_AbridgedBuilder;

/// /// Information pertaining to the details of executing the recovery.
struct PersonnelRecoveryExecutionInfo_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef PersonnelRecoveryExecutionInfo_AbridgedBuilder Builder;
...
struct PersonnelRecoveryExecutionInfo_AbridgedBuilder {
  typedef PersonnelRecoveryExecutionInfo_Abridged Table;
  ...
  void add_initialPoint(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> initialPoint) {
    fbb_.AddOffset(PersonnelRecoveryExecutionInfo_Abridged::VT_INITIALPOINT, initialPoint);
  }
  void add_ingress(double ingress) {
    fbb_.AddElement<double>(PersonnelRecoveryExecutionInfo_Abridged::VT_INGRESS, ingress, 0.0);
  }
  void add_objStrategy(::flatbuffers::Offset<::flatbuffers::String> objStrategy) {
    fbb_.AddOffset(PersonnelRecoveryExecutionInfo_Abridged::VT_OBJSTRATEGY, objStrategy);
  }
  void add_egressPoint(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> egressPoint) {
    fbb_.AddOffset(PersonnelRecoveryExecutionInfo_Abridged::VT_EGRESSPOINT, egressPoint);
  }
  void add_egress(double egress) {
    fbb_.AddElement<double>(PersonnelRecoveryExecutionInfo_Abridged::VT_EGRESS, egress, 0.0);
  }
  void add_recoveryVehicle(::flatbuffers::Offset<::flatbuffers::String> recoveryVehicle) {
    fbb_.AddOffset(PersonnelRecoveryExecutionInfo_Abridged::VT_RECOVERYVEHICLE, recoveryVehicle);
  }
  void add_escortVehicle(::flatbuffers::Offset<::flatbuffers::String> escortVehicle) {
    fbb_.AddOffset(PersonnelRecoveryExecutionInfo_Abridged::VT_ESCORTVEHICLE, escortVehicle);
  }
  explicit PersonnelRecoveryExecutionInfo_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<PersonnelRecoveryExecutionInfo_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<PersonnelRecoveryExecutionInfo_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<PersonnelRecoveryExecutionInfo_Abridged> CreatePersonnelRecoveryExecutionInfo_Abridged(
  ...
  PersonnelRecoveryExecutionInfo_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<PersonnelRecoveryExecutionInfo_Abridged> CreatePersonnelRecoveryExecutionInfo_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const PersonnelRecoveryExecutionInfo_Abridged *GetPersonnelRecoveryExecutionInfo_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<PersonnelRecoveryExecutionInfo_Abridged>(buf);
}

inline const PersonnelRecoveryExecutionInfo_Abridged *GetSizePrefixedPersonnelRecoveryExecutionInfo_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<PersonnelRecoveryExecutionInfo_Abridged>(buf);
}

inline const char *PersonnelRecoveryExecutionInfo_AbridgedIdentifier() {
  return "PERS";
}

inline bool PersonnelRecoveryExecutionInfo_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, PersonnelRecoveryExecutionInfo_AbridgedIdentifier());
}

inline bool SizePrefixedPersonnelRecoveryExecutionInfo_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, PersonnelRecoveryExecutionInfo_AbridgedIdentifier(), true);
}

inline bool VerifyPersonnelRecoveryExecutionInfo_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<PersonnelRecoveryExecutionInfo_Abridged>(PersonnelRecoveryExecutionInfo_AbridgedIdentifier());
}

inline bool VerifySizePrefixedPersonnelRecoveryExecutionInfo_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<PersonnelRecoveryExecutionInfo_Abridged>(PersonnelRecoveryExecutionInfo_AbridgedIdentifier());
}

inline void FinishPersonnelRecoveryExecutionInfo_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<PersonnelRecoveryExecutionInfo_Abridged> root) {
  fbb.Finish(root, PersonnelRecoveryExecutionInfo_AbridgedIdentifier());
}

inline void FinishSizePrefixedPersonnelRecoveryExecutionInfo_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<PersonnelRecoveryExecutionInfo_Abridged> root) {
  fbb.FinishSizePrefixed(root, PersonnelRecoveryExecutionInfo_AbridgedIdentifier());
}
