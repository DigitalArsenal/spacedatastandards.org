...
struct Track_Full;
struct Track_FullBuilder;

enum Track_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Track_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Track_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Track_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Track_Full_dataMode_Enum_EXERCISE = 3,
  Track_Full_dataMode_Enum_MIN = Track_Full_dataMode_Enum_REAL,
  Track_Full_dataMode_Enum_MAX = Track_Full_dataMode_Enum_EXERCISE
};

inline const Track_Full_dataMode_Enum (&EnumValuesTrack_Full_dataMode_Enum())[4] {
  static const Track_Full_dataMode_Enum values[] = {
    Track_Full_dataMode_Enum_REAL,
    Track_Full_dataMode_Enum_TEST,
    Track_Full_dataMode_Enum_SIMULATED,
    Track_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesTrack_Full_dataMode_Enum() {
...
inline const char *EnumNameTrack_Full_dataMode_Enum(Track_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Track_Full_dataMode_Enum_REAL, Track_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesTrack_Full_dataMode_Enum()[index];
}
...
struct Track_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Track_FullBuilder Builder;
  ...
  Track_Full_dataMode_Enum dataMode() const {
    return static_cast<Track_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
inline ::flatbuffers::Offset<Track_Full> CreateTrack_Full(
    ...
    Track_Full_dataMode_Enum dataMode = Track_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  Track_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Track_Full> CreateTrack_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Track_Full *GetTrack_Full(const void *buf) {
  return ::flatbuffers::GetRoot<Track_Full>(buf);
}

inline const Track_Full *GetSizePrefixedTrack_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Track_Full>(buf);
}

inline const char *Track_FullIdentifier() {
  return "TRAC";
}

inline bool Track_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Track_FullIdentifier());
}

inline bool SizePrefixedTrack_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Track_FullIdentifier(), true);
}

inline bool VerifyTrack_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Track_Full>(Track_FullIdentifier());
}

inline bool VerifySizePrefixedTrack_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Track_Full>(Track_FullIdentifier());
}

inline void FinishTrack_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Track_Full> root) {
  fbb.Finish(root, Track_FullIdentifier());
}

inline void FinishSizePrefixedTrack_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Track_Full> root) {
  fbb.FinishSizePrefixed(root, Track_FullIdentifier());
}
