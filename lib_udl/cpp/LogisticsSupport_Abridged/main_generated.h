...
struct LogisticsSupport_Abridged;
struct LogisticsSupport_AbridgedBuilder;

enum LogisticsSupport_Abridged_dataMode_Enum : int8_t {
  ...
  LogisticsSupport_Abridged_dataMode_Enum_MIN = LogisticsSupport_Abridged_dataMode_Enum_REAL,
  LogisticsSupport_Abridged_dataMode_Enum_MAX = LogisticsSupport_Abridged_dataMode_Enum_EXERCISE
};

inline const LogisticsSupport_Abridged_dataMode_Enum (&EnumValuesLogisticsSupport_Abridged_dataMode_Enum())[4] {
  static const LogisticsSupport_Abridged_dataMode_Enum values[] = {
    LogisticsSupport_Abridged_dataMode_Enum_REAL,
    LogisticsSupport_Abridged_dataMode_Enum_TEST,
    LogisticsSupport_Abridged_dataMode_Enum_SIMULATED,
    LogisticsSupport_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesLogisticsSupport_Abridged_dataMode_Enum() {
...
inline const char *EnumNameLogisticsSupport_Abridged_dataMode_Enum(LogisticsSupport_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, LogisticsSupport_Abridged_dataMode_Enum_REAL, LogisticsSupport_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesLogisticsSupport_Abridged_dataMode_Enum()[index];
}
...
struct LogisticsSupport_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LogisticsSupport_AbridgedBuilder Builder;
  ...
  LogisticsSupport_Abridged_dataMode_Enum dataMode() const {
    return static_cast<LogisticsSupport_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct LogisticsSupport_AbridgedBuilder {
  typedef LogisticsSupport_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_extSystemId(::flatbuffers::Offset<::flatbuffers::String> extSystemId) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_EXTSYSTEMID, extSystemId);
  }
  void add_tailNumber(::flatbuffers::Offset<::flatbuffers::String> tailNumber) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_TAILNUMBER, tailNumber);
  }
  void add_aircraftMDS(::flatbuffers::Offset<::flatbuffers::String> aircraftMDS) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_AIRCRAFTMDS, aircraftMDS);
  }
  void add_currICAO(::flatbuffers::Offset<::flatbuffers::String> currICAO) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_CURRICAO, currICAO);
  }
  void add_suppICAO(::flatbuffers::Offset<::flatbuffers::String> suppICAO) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_SUPPICAO, suppICAO);
  }
  void add_rptCreatedTime(::flatbuffers::Offset<::flatbuffers::String> rptCreatedTime) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_RPTCREATEDTIME, rptCreatedTime);
  }
  void add_rptClosedTime(::flatbuffers::Offset<::flatbuffers::String> rptClosedTime) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_RPTCLOSEDTIME, rptClosedTime);
  }
  void add_meTime(::flatbuffers::Offset<::flatbuffers::String> meTime) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_METIME, meTime);
  }
  void add_mcTime(::flatbuffers::Offset<::flatbuffers::String> mcTime) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_MCTIME, mcTime);
  }
  void add_logisticAction(::flatbuffers::Offset<::flatbuffers::String> logisticAction) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_LOGISTICACTION, logisticAction);
  }
  void add_logisticsRecordId(::flatbuffers::Offset<::flatbuffers::String> logisticsRecordId) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_LOGISTICSRECORDID, logisticsRecordId);
  }
  void add_etic(::flatbuffers::Offset<::flatbuffers::String> etic) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_ETIC, etic);
  }
  void add_etmc(::flatbuffers::Offset<::flatbuffers::String> etmc) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_ETMC, etmc);
  }
  void add_maintStatusCode(::flatbuffers::Offset<::flatbuffers::String> maintStatusCode) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_MAINTSTATUSCODE, maintStatusCode);
  }
  void add_reopenFlag(bool reopenFlag) {
    fbb_.AddElement<uint8_t>(LogisticsSupport_Abridged::VT_REOPENFLAG, static_cast<uint8_t>(reopenFlag), 0);
  }
  void add_owner(::flatbuffers::Offset<::flatbuffers::String> owner) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_OWNER, owner);
  }
  void add_logisticsRemarks(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsRemarks) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_LOGISTICSREMARKS, logisticsRemarks);
  }
  void add_logisticsDiscrepancyInfos(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsDiscrepancyInfos) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_LOGISTICSDISCREPANCYINFOS, logisticsDiscrepancyInfos);
  }
  void add_logisticsTransportationPlans(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsTransportationPlans) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_LOGISTICSTRANSPORTATIONPLANS, logisticsTransportationPlans);
  }
  void add_logisticsSupportItems(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsSupportItems) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_LOGISTICSSUPPORTITEMS, logisticsSupportItems);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(LogisticsSupport_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(LogisticsSupport_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(LogisticsSupport_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit LogisticsSupport_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LogisticsSupport_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LogisticsSupport_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LogisticsSupport_Abridged> CreateLogisticsSupport_Abridged(
    ...
    LogisticsSupport_Abridged_dataMode_Enum dataMode = LogisticsSupport_Abridged_dataMode_Enum_REAL) {
  LogisticsSupport_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<LogisticsSupport_Abridged> CreateLogisticsSupport_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const LogisticsSupport_Abridged *GetLogisticsSupport_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<LogisticsSupport_Abridged>(buf);
}

inline const LogisticsSupport_Abridged *GetSizePrefixedLogisticsSupport_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<LogisticsSupport_Abridged>(buf);
}

inline const char *LogisticsSupport_AbridgedIdentifier() {
  return "LOGI";
}

inline bool LogisticsSupport_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsSupport_AbridgedIdentifier());
}

inline bool SizePrefixedLogisticsSupport_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsSupport_AbridgedIdentifier(), true);
}

inline bool VerifyLogisticsSupport_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<LogisticsSupport_Abridged>(LogisticsSupport_AbridgedIdentifier());
}

inline bool VerifySizePrefixedLogisticsSupport_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<LogisticsSupport_Abridged>(LogisticsSupport_AbridgedIdentifier());
}

inline void FinishLogisticsSupport_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsSupport_Abridged> root) {
  fbb.Finish(root, LogisticsSupport_AbridgedIdentifier());
}

inline void FinishSizePrefixedLogisticsSupport_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsSupport_Abridged> root) {
  fbb.FinishSizePrefixed(root, LogisticsSupport_AbridgedIdentifier());
}
