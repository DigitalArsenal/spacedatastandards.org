...
struct RFObservationDetails_Full;
struct RFObservationDetails_FullBuilder;

enum RFObservationDetails_Full_polarityType_Enum : int8_t {
  /// No description available.
  RFObservationDetails_Full_polarityType_Enum_H = 0,
  /// No description available.
  RFObservationDetails_Full_polarityType_Enum_V = 1,
  /// No description available.
  RFObservationDetails_Full_polarityType_Enum_R = 2,
  /// No description available.
  RFObservationDetails_Full_polarityType_Enum_L = 3,
  RFObservationDetails_Full_polarityType_Enum_MIN = RFObservationDetails_Full_polarityType_Enum_H,
  RFObservationDetails_Full_polarityType_Enum_MAX = RFObservationDetails_Full_polarityType_Enum_L
};

inline const RFObservationDetails_Full_polarityType_Enum (&EnumValuesRFObservationDetails_Full_polarityType_Enum())[4] {
  static const RFObservationDetails_Full_polarityType_Enum values[] = {
    RFObservationDetails_Full_polarityType_Enum_H,
    RFObservationDetails_Full_polarityType_Enum_V,
    RFObservationDetails_Full_polarityType_Enum_R,
    RFObservationDetails_Full_polarityType_Enum_L
  };
  return values;
}

inline const char * const *EnumNamesRFObservationDetails_Full_polarityType_Enum() {
...
inline const char *EnumNameRFObservationDetails_Full_polarityType_Enum(RFObservationDetails_Full_polarityType_Enum e) {
  if (::flatbuffers::IsOutRange(e, RFObservationDetails_Full_polarityType_Enum_H, RFObservationDetails_Full_polarityType_Enum_L)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesRFObservationDetails_Full_polarityType_Enum()[index];
}

enum RFObservationDetails_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  RFObservationDetails_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  RFObservationDetails_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  RFObservationDetails_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  RFObservationDetails_Full_dataMode_Enum_EXERCISE = 3,
  RFObservationDetails_Full_dataMode_Enum_MIN = RFObservationDetails_Full_dataMode_Enum_REAL,
  RFObservationDetails_Full_dataMode_Enum_MAX = RFObservationDetails_Full_dataMode_Enum_EXERCISE
};

inline const RFObservationDetails_Full_dataMode_Enum (&EnumValuesRFObservationDetails_Full_dataMode_Enum())[4] {
  static const RFObservationDetails_Full_dataMode_Enum values[] = {
    RFObservationDetails_Full_dataMode_Enum_REAL,
    RFObservationDetails_Full_dataMode_Enum_TEST,
    RFObservationDetails_Full_dataMode_Enum_SIMULATED,
    RFObservationDetails_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesRFObservationDetails_Full_dataMode_Enum() {
  static const char * const names[5] = {
    "REAL",
    "TEST",
    "SIMULATED",
...
inline const char *EnumNameRFObservationDetails_Full_dataMode_Enum(RFObservationDetails_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, RFObservationDetails_Full_dataMode_Enum_REAL, RFObservationDetails_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesRFObservationDetails_Full_dataMode_Enum()[index];
}
...
struct RFObservationDetails_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef RFObservationDetails_FullBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_CREATEDAT = 138,
    VT_CREATEDBY = 140,
    VT_NOISEPWRDENSITY = 142,
    VT_CARRIERSTANDARD = 144,
    VT_MODULATION = 146,
    VT_INNERCODINGRATE = 148,
    VT_OUTERCODINGRATE = 150,
    VT_TRANSMITFILTERTYPE = 152,
    VT_TRANSMITFILTERROLLOFF = 154,
    VT_SYMBOLTONOISERATIO = 156,
    VT_BITERRORRATE = 158,
    VT_ORIGNETWORK = 160,
    VT_SOURCEDL = 162,
    VT_ONORBIT = 164,
    ...
    VT_BAUDRATES = 192,
    VT_TELEMETRYIDS = 194,
    VT_CONSTELLATIONXPOINTS = 196,
    VT_CONSTELLATIONYPOINTS = 198
  };
  ...
  RFObservationDetails_Full_polarityType_Enum polarityType() const {
    return static_cast<RFObservationDetails_Full_polarityType_Enum>(GetField<int8_t>(VT_POLARITYTYPE, 0));
  }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  RFObservationDetails_Full_dataMode_Enum dataMode() const {
    return static_cast<RFObservationDetails_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
  ...
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *frequencies() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_FREQUENCIES);
  }
  ...
  /// Example: /// Example: [1.1, 2.2]
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *powers() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_POWERS);
  }
  ...
  /// Example: /// Example: [1.1, 2.2]
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *confidences() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_CONFIDENCES);
  }
  /// Array of detection statuses (e.g. DETECTED, CARRIER_DETECTED, NOT_DETECTED) for each measured signal.
  /// Example: /// Example: ['DETECTED']
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *detectionStatuses() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_DETECTIONSTATUSES);
  }
  /// Array of chipRates.
  /// Example: /// Example: [1.1, 2.2]
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *chipRates() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_CHIPRATES);
  }
  /// Array of code taps.
  /// Example: /// Example: ['TAG1', 'TAG2']
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *codeTaps() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_CODETAPS);
  }
  /// Array of code fills.
  /// Example: /// Example: ['TAG1', 'TAG2']
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *codeFills() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_CODEFILLS);
  }
  /// Array of code lengths.
  /// Example: /// Example: [1.1, 2.2]
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *codeLengths() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_CODELENGTHS);
  }
  /// Array of pnOrder.
  /// Example: /// Example: [1, 2]
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *pnOrders() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_PNORDERS);
  }
  /// Array of optional source provided identifiers of the measurements/signals.
  /// Example: /// Example: ['ID1', 'ID2']
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *signalIds() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_SIGNALIDS);
  }
  /// Array of measured signal baud rates.
  /// Example: /// Example: [1.1, 2.2]
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *baudRates() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_BAUDRATES);
  }
  /// Array of optional source provided telemetry identifiers of the measurements/signals.
  /// Example: /// Example: ['ID1', 'ID2']
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *telemetryIds() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_TELEMETRYIDS);
  }
  ...
  /// Example: /// Example: [1.1, 2.2]
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *constellationXPoints() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_CONSTELLATIONXPOINTS);
  }
  ...
  /// Example: /// Example: [1.1, 2.2]
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *constellationYPoints() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_CONSTELLATIONYPOINTS);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_FREQUENCIES) &&
           verifier.VerifyVector(frequencies()) &&
           verifier.VerifyVectorOfStrings(frequencies()) &&
           VerifyOffset(verifier, VT_POWERS) &&
           verifier.VerifyVector(powers()) &&
           verifier.VerifyVectorOfStrings(powers()) &&
           VerifyOffset(verifier, VT_SNRS) &&
           verifier.VerifyVector(snrs()) &&
           verifier.VerifyVectorOfStrings(snrs()) &&
           VerifyOffset(verifier, VT_CONFIDENCES) &&
           verifier.VerifyVector(confidences()) &&
           verifier.VerifyVectorOfStrings(confidences()) &&
           VerifyOffset(verifier, VT_DETECTIONSTATUSES) &&
           verifier.VerifyVector(detectionStatuses()) &&
           verifier.VerifyVectorOfStrings(detectionStatuses()) &&
           VerifyOffset(verifier, VT_CHIPRATES) &&
           verifier.VerifyVector(chipRates()) &&
           verifier.VerifyVectorOfStrings(chipRates()) &&
           VerifyOffset(verifier, VT_CODETAPS) &&
           verifier.VerifyVector(codeTaps()) &&
           verifier.VerifyVectorOfStrings(codeTaps()) &&
           VerifyOffset(verifier, VT_CODEFILLS) &&
           verifier.VerifyVector(codeFills()) &&
           verifier.VerifyVectorOfStrings(codeFills()) &&
           VerifyOffset(verifier, VT_CODELENGTHS) &&
           verifier.VerifyVector(codeLengths()) &&
           verifier.VerifyVectorOfStrings(codeLengths()) &&
           VerifyOffset(verifier, VT_PNORDERS) &&
           verifier.VerifyVector(pnOrders()) &&
           verifier.VerifyVectorOfStrings(pnOrders()) &&
           VerifyOffset(verifier, VT_SIGNALIDS) &&
           verifier.VerifyVector(signalIds()) &&
           verifier.VerifyVectorOfStrings(signalIds()) &&
           VerifyOffset(verifier, VT_BAUDRATES) &&
           verifier.VerifyVector(baudRates()) &&
           verifier.VerifyVectorOfStrings(baudRates()) &&
           VerifyOffset(verifier, VT_TELEMETRYIDS) &&
           verifier.VerifyVector(telemetryIds()) &&
           verifier.VerifyVectorOfStrings(telemetryIds()) &&
           VerifyOffset(verifier, VT_CONSTELLATIONXPOINTS) &&
           verifier.VerifyVector(constellationXPoints()) &&
           verifier.VerifyVectorOfStrings(constellationXPoints()) &&
           VerifyOffset(verifier, VT_CONSTELLATIONYPOINTS) &&
           verifier.VerifyVector(constellationYPoints()) &&
           verifier.VerifyVectorOfStrings(constellationYPoints()) &&
           verifier.EndTable();
  }
};

struct RFObservationDetails_FullBuilder {
  typedef RFObservationDetails_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_obTime(::flatbuffers::Offset<::flatbuffers::String> obTime) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_OBTIME, obTime);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_IDONORBIT, idOnOrbit);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_IDSENSOR, idSensor);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_TYPE, type);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(RFObservationDetails_Full::VT_SATNO, satNo, 0);
  }
  void add_taskId(::flatbuffers::Offset<::flatbuffers::String> taskId) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_TASKID, taskId);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_TRANSACTIONID, transactionId);
  }
  void add_trackId(::flatbuffers::Offset<::flatbuffers::String> trackId) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_TRACKID, trackId);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_ORIGOBJECTID, origObjectId);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_ORIGSENSORID, origSensorId);
  }
  void add_uct(bool uct) {
    fbb_.AddElement<uint8_t>(RFObservationDetails_Full::VT_UCT, static_cast<uint8_t>(uct), 0);
  }
  void add_transponder(::flatbuffers::Offset<::flatbuffers::String> transponder) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_TRANSPONDER, transponder);
  }
  void add_azimuth(double azimuth) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_AZIMUTH, azimuth, 0.0);
  }
  void add_azimuthUnc(double azimuthUnc) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_AZIMUTHUNC, azimuthUnc, 0.0);
  }
  void add_azimuthRate(double azimuthRate) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_AZIMUTHRATE, azimuthRate, 0.0);
  }
  void add_elevation(double elevation) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_ELEVATION, elevation, 0.0);
  }
  void add_elevationUnc(double elevationUnc) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_ELEVATIONUNC, elevationUnc, 0.0);
  }
  void add_elevationRate(double elevationRate) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_ELEVATIONRATE, elevationRate, 0.0);
  }
  void add_range(double range) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_RANGE, range, 0.0);
  }
  void add_rangeUnc(double rangeUnc) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_RANGEUNC, rangeUnc, 0.0);
  }
  void add_rangeRate(double rangeRate) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_RANGERATE, rangeRate, 0.0);
  }
  void add_rangeRateUnc(double rangeRateUnc) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_RANGERATEUNC, rangeRateUnc, 0.0);
  }
  void add_trackRange(double trackRange) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_TRACKRANGE, trackRange, 0.0);
  }
  void add_senlat(double senlat) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_SENLAT, senlat, 0.0);
  }
  void add_senlon(double senlon) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_SENLON, senlon, 0.0);
  }
  void add_senalt(double senalt) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_SENALT, senalt, 0.0);
  }
  void add_elnot(::flatbuffers::Offset<::flatbuffers::String> elnot) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_ELNOT, elnot);
  }
  void add_frequency(double frequency) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_FREQUENCY, frequency, 0.0);
  }
  void add_nominalFrequency(double nominalFrequency) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_NOMINALFREQUENCY, nominalFrequency, 0.0);
  }
  void add_startFrequency(double startFrequency) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_STARTFREQUENCY, startFrequency, 0.0);
  }
  void add_endFrequency(double endFrequency) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_ENDFREQUENCY, endFrequency, 0.0);
  }
  void add_relativeCarrierPower(double relativeCarrierPower) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_RELATIVECARRIERPOWER, relativeCarrierPower, 0.0);
  }
  void add_spectrumAnalyzerPower(double spectrumAnalyzerPower) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_SPECTRUMANALYZERPOWER, spectrumAnalyzerPower, 0.0);
  }
  void add_relativeNoiseFloor(double relativeNoiseFloor) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_RELATIVENOISEFLOOR, relativeNoiseFloor, 0.0);
  }
  void add_referenceLevel(double referenceLevel) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_REFERENCELEVEL, referenceLevel, 0.0);
  }
  void add_pgri(double pgri) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_PGRI, pgri, 0.0);
  }
  void add_confidence(double confidence) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_CONFIDENCE, confidence, 0.0);
  }
  void add_incoming(bool incoming) {
    fbb_.AddElement<uint8_t>(RFObservationDetails_Full::VT_INCOMING, static_cast<uint8_t>(incoming), 0);
  }
  void add_switchPoint(int32_t switchPoint) {
    fbb_.AddElement<int32_t>(RFObservationDetails_Full::VT_SWITCHPOINT, switchPoint, 0);
  }
  void add_baudRate(double baudRate) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_BAUDRATE, baudRate, 0.0);
  }
  void add_snr(double snr) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_SNR, snr, 0.0);
  }
  void add_nominalSnr(double nominalSnr) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_NOMINALSNR, nominalSnr, 0.0);
  }
  void add_polarity(double polarity) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_POLARITY, polarity, 0.0);
  }
  void add_polarityType(RFObservationDetails_Full_polarityType_Enum polarityType) {
    fbb_.AddElement<int8_t>(RFObservationDetails_Full::VT_POLARITYTYPE, static_cast<int8_t>(polarityType), 0);
  }
  void add_channel(int32_t channel) {
    fbb_.AddElement<int32_t>(RFObservationDetails_Full::VT_CHANNEL, channel, 0);
  }
  void add_powerOverNoise(double powerOverNoise) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_POWEROVERNOISE, powerOverNoise, 0.0);
  }
  void add_nominalPowerOverNoise(double nominalPowerOverNoise) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_NOMINALPOWEROVERNOISE, nominalPowerOverNoise, 0.0);
  }
  void add_bandwidth(double bandwidth) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_BANDWIDTH, bandwidth, 0.0);
  }
  void add_nominalBandwidth(double nominalBandwidth) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_NOMINALBANDWIDTH, nominalBandwidth, 0.0);
  }
  void add_resolutionBandwidth(double resolutionBandwidth) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_RESOLUTIONBANDWIDTH, resolutionBandwidth, 0.0);
  }
  void add_videoBandwidth(double videoBandwidth) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_VIDEOBANDWIDTH, videoBandwidth, 0.0);
  }
  void add_eirp(double eirp) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_EIRP, eirp, 0.0);
  }
  void add_nominalEirp(double nominalEirp) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_NOMINALEIRP, nominalEirp, 0.0);
  }
  void add_minPSD(double minPSD) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_MINPSD, minPSD, 0.0);
  }
  void add_maxPSD(double maxPSD) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_MAXPSD, maxPSD, 0.0);
  }
  void add_frequencyShift(double frequencyShift) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_FREQUENCYSHIFT, frequencyShift, 0.0);
  }
  void add_peak(bool peak) {
    fbb_.AddElement<uint8_t>(RFObservationDetails_Full::VT_PEAK, static_cast<uint8_t>(peak), 0);
  }
  void add_antennaName(::flatbuffers::Offset<::flatbuffers::String> antennaName) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_ANTENNANAME, antennaName);
  }
  void add_detectionStatus(::flatbuffers::Offset<::flatbuffers::String> detectionStatus) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_DETECTIONSTATUS, detectionStatus);
  }
  void add_collectionMode(::flatbuffers::Offset<::flatbuffers::String> collectionMode) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_COLLECTIONMODE, collectionMode);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_RAWFILEURI, rawFileURI);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(RFObservationDetails_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(RFObservationDetails_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_TAGS, tags);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_CREATEDBY, createdBy);
  }
  void add_noisePwrDensity(double noisePwrDensity) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_NOISEPWRDENSITY, noisePwrDensity, 0.0);
  }
  void add_carrierStandard(::flatbuffers::Offset<::flatbuffers::String> carrierStandard) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_CARRIERSTANDARD, carrierStandard);
  }
  void add_modulation(::flatbuffers::Offset<::flatbuffers::String> modulation) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_MODULATION, modulation);
  }
  void add_innerCodingRate(int32_t innerCodingRate) {
    fbb_.AddElement<int32_t>(RFObservationDetails_Full::VT_INNERCODINGRATE, innerCodingRate, 0);
  }
  void add_outerCodingRate(int32_t outerCodingRate) {
    fbb_.AddElement<int32_t>(RFObservationDetails_Full::VT_OUTERCODINGRATE, outerCodingRate, 0);
  }
  void add_transmitFilterType(::flatbuffers::Offset<::flatbuffers::String> transmitFilterType) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_TRANSMITFILTERTYPE, transmitFilterType);
  }
  void add_transmitFilterRollOff(double transmitFilterRollOff) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_TRANSMITFILTERROLLOFF, transmitFilterRollOff, 0.0);
  }
  void add_symbolToNoiseRatio(double symbolToNoiseRatio) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_SYMBOLTONOISERATIO, symbolToNoiseRatio, 0.0);
  }
  void add_bitErrorRate(double bitErrorRate) {
    fbb_.AddElement<double>(RFObservationDetails_Full::VT_BITERRORRATE, bitErrorRate, 0.0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_SOURCEDL, sourceDL);
  }
  void add_onOrbit(::flatbuffers::Offset<::flatbuffers::String> onOrbit) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_ONORBIT, onOrbit);
  }
  void add_descriptor(::flatbuffers::Offset<::flatbuffers::String> descriptor) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_DESCRIPTOR, descriptor);
  }
  void add_url(::flatbuffers::Offset<::flatbuffers::String> url) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_URL, url);
  }
  void add_frequencies(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> frequencies) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_FREQUENCIES, frequencies);
  }
  void add_powers(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> powers) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_POWERS, powers);
  }
  void add_snrs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> snrs) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_SNRS, snrs);
  }
  void add_confidences(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> confidences) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_CONFIDENCES, confidences);
  }
  void add_detectionStatuses(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> detectionStatuses) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_DETECTIONSTATUSES, detectionStatuses);
  }
  void add_chipRates(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> chipRates) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_CHIPRATES, chipRates);
  }
  void add_codeTaps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> codeTaps) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_CODETAPS, codeTaps);
  }
  void add_codeFills(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> codeFills) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_CODEFILLS, codeFills);
  }
  void add_codeLengths(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> codeLengths) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_CODELENGTHS, codeLengths);
  }
  void add_pnOrders(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> pnOrders) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_PNORDERS, pnOrders);
  }
  void add_signalIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> signalIds) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_SIGNALIDS, signalIds);
  }
  void add_baudRates(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> baudRates) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_BAUDRATES, baudRates);
  }
  void add_telemetryIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> telemetryIds) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_TELEMETRYIDS, telemetryIds);
  }
  void add_constellationXPoints(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> constellationXPoints) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_CONSTELLATIONXPOINTS, constellationXPoints);
  }
  void add_constellationYPoints(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> constellationYPoints) {
    fbb_.AddOffset(RFObservationDetails_Full::VT_CONSTELLATIONYPOINTS, constellationYPoints);
  }
  explicit RFObservationDetails_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<RFObservationDetails_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<RFObservationDetails_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<RFObservationDetails_Full> CreateRFObservationDetails_Full(
    ...
    double polarity = 0.0,
    RFObservationDetails_Full_polarityType_Enum polarityType = RFObservationDetails_Full_polarityType_Enum_H,
    int32_t channel = 0,
    ...
    RFObservationDetails_Full_dataMode_Enum dataMode = RFObservationDetails_Full_dataMode_Enum_REAL,
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> frequencies = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> powers = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> snrs = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> confidences = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> detectionStatuses = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> chipRates = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> codeTaps = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> codeFills = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> codeLengths = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> pnOrders = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> signalIds = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> baudRates = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> telemetryIds = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> constellationXPoints = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> constellationYPoints = 0) {
  RFObservationDetails_FullBuilder builder_(_fbb);
  ...
  builder_.add_constellationYPoints(constellationYPoints);
  builder_.add_constellationXPoints(constellationXPoints);
  builder_.add_telemetryIds(telemetryIds);
  builder_.add_baudRates(baudRates);
  builder_.add_signalIds(signalIds);
  builder_.add_pnOrders(pnOrders);
  builder_.add_codeLengths(codeLengths);
  builder_.add_codeFills(codeFills);
  builder_.add_codeTaps(codeTaps);
  builder_.add_chipRates(chipRates);
  builder_.add_detectionStatuses(detectionStatuses);
  builder_.add_confidences(confidences);
  builder_.add_snrs(snrs);
  builder_.add_powers(powers);
  builder_.add_frequencies(frequencies);
...
inline ::flatbuffers::Offset<RFObservationDetails_Full> CreateRFObservationDetails_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ...
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *frequencies = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *powers = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *snrs = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *confidences = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *detectionStatuses = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *chipRates = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *codeTaps = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *codeFills = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *codeLengths = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *pnOrders = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *signalIds = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *baudRates = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *telemetryIds = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *constellationXPoints = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *constellationYPoints = nullptr) {
  ...
  auto frequencies__ = frequencies ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*frequencies) : 0;
  auto powers__ = powers ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*powers) : 0;
  auto snrs__ = snrs ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*snrs) : 0;
  auto confidences__ = confidences ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*confidences) : 0;
  auto detectionStatuses__ = detectionStatuses ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*detectionStatuses) : 0;
  auto chipRates__ = chipRates ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*chipRates) : 0;
  auto codeTaps__ = codeTaps ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*codeTaps) : 0;
  auto codeFills__ = codeFills ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*codeFills) : 0;
  auto codeLengths__ = codeLengths ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*codeLengths) : 0;
  auto pnOrders__ = pnOrders ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*pnOrders) : 0;
  auto signalIds__ = signalIds ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*signalIds) : 0;
  auto baudRates__ = baudRates ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*baudRates) : 0;
  auto telemetryIds__ = telemetryIds ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*telemetryIds) : 0;
  auto constellationXPoints__ = constellationXPoints ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*constellationXPoints) : 0;
  auto constellationYPoints__ = constellationYPoints ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*constellationYPoints) : 0;
  return CreateRFObservationDetails_Full(
      ...
      baudRates__,
      telemetryIds__,
      constellationXPoints__,
      constellationYPoints__);
}

inline const RFObservationDetails_Full *GetRFObservationDetails_Full(const void *buf) {
  return ::flatbuffers::GetRoot<RFObservationDetails_Full>(buf);
}

inline const RFObservationDetails_Full *GetSizePrefixedRFObservationDetails_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<RFObservationDetails_Full>(buf);
}

inline const char *RFObservationDetails_FullIdentifier() {
  return "RFOB";
}

inline bool RFObservationDetails_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RFObservationDetails_FullIdentifier());
}

inline bool SizePrefixedRFObservationDetails_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RFObservationDetails_FullIdentifier(), true);
}

inline bool VerifyRFObservationDetails_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<RFObservationDetails_Full>(RFObservationDetails_FullIdentifier());
}

inline bool VerifySizePrefixedRFObservationDetails_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<RFObservationDetails_Full>(RFObservationDetails_FullIdentifier());
}

inline void FinishRFObservationDetails_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RFObservationDetails_Full> root) {
  fbb.Finish(root, RFObservationDetails_FullIdentifier());
}

inline void FinishSizePrefixedRFObservationDetails_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RFObservationDetails_Full> root) {
  fbb.FinishSizePrefixed(root, RFObservationDetails_FullIdentifier());
}
