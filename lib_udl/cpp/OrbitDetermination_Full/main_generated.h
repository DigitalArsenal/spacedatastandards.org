...
struct OrbitDetermination_Full;
struct OrbitDetermination_FullBuilder;

enum OrbitDetermination_Full_dataMode_Enum : int8_t {
  ...
  OrbitDetermination_Full_dataMode_Enum_MIN = OrbitDetermination_Full_dataMode_Enum_REAL,
  OrbitDetermination_Full_dataMode_Enum_MAX = OrbitDetermination_Full_dataMode_Enum_EXERCISE
};

inline const OrbitDetermination_Full_dataMode_Enum (&EnumValuesOrbitDetermination_Full_dataMode_Enum())[4] {
  static const OrbitDetermination_Full_dataMode_Enum values[] = {
    OrbitDetermination_Full_dataMode_Enum_REAL,
    OrbitDetermination_Full_dataMode_Enum_TEST,
    OrbitDetermination_Full_dataMode_Enum_SIMULATED,
    OrbitDetermination_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesOrbitDetermination_Full_dataMode_Enum() {
...
inline const char *EnumNameOrbitDetermination_Full_dataMode_Enum(OrbitDetermination_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, OrbitDetermination_Full_dataMode_Enum_REAL, OrbitDetermination_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOrbitDetermination_Full_dataMode_Enum()[index];
}
...
struct OrbitDetermination_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef OrbitDetermination_FullBuilder Builder;
  ...
  OrbitDetermination_Full_dataMode_Enum dataMode() const {
    return static_cast<OrbitDetermination_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
...
struct OrbitDetermination_FullBuilder {
  typedef OrbitDetermination_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_ENDTIME, endTime);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_IDONORBIT, idOnOrbit);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_ORIGOBJECTID, origObjectId);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(OrbitDetermination_Full::VT_SATNO, satNo, 0);
  }
  void add_aprioriIdElset(::flatbuffers::Offset<::flatbuffers::String> aprioriIdElset) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_APRIORIIDELSET, aprioriIdElset);
  }
  void add_aprioriElset(::flatbuffers::Offset<::flatbuffers::String> aprioriElset) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_APRIORIELSET, aprioriElset);
  }
  void add_aprioriIdStateVector(::flatbuffers::Offset<::flatbuffers::String> aprioriIdStateVector) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_APRIORIIDSTATEVECTOR, aprioriIdStateVector);
  }
  void add_aprioriStateVector(::flatbuffers::Offset<::flatbuffers::String> aprioriStateVector) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_APRIORISTATEVECTOR, aprioriStateVector);
  }
  void add_initialOD(bool initialOD) {
    fbb_.AddElement<uint8_t>(OrbitDetermination_Full::VT_INITIALOD, static_cast<uint8_t>(initialOD), 0);
  }
  void add_lastObStart(::flatbuffers::Offset<::flatbuffers::String> lastObStart) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_LASTOBSTART, lastObStart);
  }
  void add_lastObEnd(::flatbuffers::Offset<::flatbuffers::String> lastObEnd) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_LASTOBEND, lastObEnd);
  }
  void add_timeSpan(double timeSpan) {
    fbb_.AddElement<double>(OrbitDetermination_Full::VT_TIMESPAN, timeSpan, 0.0);
  }
  void add_effectiveFrom(::flatbuffers::Offset<::flatbuffers::String> effectiveFrom) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_EFFECTIVEFROM, effectiveFrom);
  }
  void add_effectiveUntil(::flatbuffers::Offset<::flatbuffers::String> effectiveUntil) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_EFFECTIVEUNTIL, effectiveUntil);
  }
  void add_wrms(double wrms) {
    fbb_.AddElement<double>(OrbitDetermination_Full::VT_WRMS, wrms, 0.0);
  }
  void add_previousWrms(double previousWrms) {
    fbb_.AddElement<double>(OrbitDetermination_Full::VT_PREVIOUSWRMS, previousWrms, 0.0);
  }
  void add_firstPassWrms(double firstPassWrms) {
    fbb_.AddElement<double>(OrbitDetermination_Full::VT_FIRSTPASSWRMS, firstPassWrms, 0.0);
  }
  void add_bestPassWrms(double bestPassWrms) {
    fbb_.AddElement<double>(OrbitDetermination_Full::VT_BESTPASSWRMS, bestPassWrms, 0.0);
  }
  void add_errorGrowthRate(double errorGrowthRate) {
    fbb_.AddElement<double>(OrbitDetermination_Full::VT_ERRORGROWTHRATE, errorGrowthRate, 0.0);
  }
  void add_edr(double edr) {
    fbb_.AddElement<double>(OrbitDetermination_Full::VT_EDR, edr, 0.0);
  }
  void add_method(::flatbuffers::Offset<::flatbuffers::String> method) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_METHOD, method);
  }
  void add_methodSource(::flatbuffers::Offset<::flatbuffers::String> methodSource) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_METHODSOURCE, methodSource);
  }
  void add_fitSpan(double fitSpan) {
    fbb_.AddElement<double>(OrbitDetermination_Full::VT_FITSPAN, fitSpan, 0.0);
  }
  void add_ballisticCoeffEst(bool ballisticCoeffEst) {
    fbb_.AddElement<uint8_t>(OrbitDetermination_Full::VT_BALLISTICCOEFFEST, static_cast<uint8_t>(ballisticCoeffEst), 0);
  }
  void add_ballisticCoeffModel(::flatbuffers::Offset<::flatbuffers::String> ballisticCoeffModel) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_BALLISTICCOEFFMODEL, ballisticCoeffModel);
  }
  void add_agomEst(bool agomEst) {
    fbb_.AddElement<uint8_t>(OrbitDetermination_Full::VT_AGOMEST, static_cast<uint8_t>(agomEst), 0);
  }
  void add_agomModel(::flatbuffers::Offset<::flatbuffers::String> agomModel) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_AGOMMODEL, agomModel);
  }
  void add_rmsConvergenceCriteria(double rmsConvergenceCriteria) {
    fbb_.AddElement<double>(OrbitDetermination_Full::VT_RMSCONVERGENCECRITERIA, rmsConvergenceCriteria, 0.0);
  }
  void add_numIterations(int32_t numIterations) {
    fbb_.AddElement<int32_t>(OrbitDetermination_Full::VT_NUMITERATIONS, numIterations, 0);
  }
  void add_acceptedObTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> acceptedObTyps) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_ACCEPTEDOBTYPS, acceptedObTyps);
  }
  void add_acceptedObIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> acceptedObIds) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_ACCEPTEDOBIDS, acceptedObIds);
  }
  void add_rejectedObTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rejectedObTyps) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_REJECTEDOBTYPS, rejectedObTyps);
  }
  void add_rejectedObIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rejectedObIds) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_REJECTEDOBIDS, rejectedObIds);
  }
  void add_sensorIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sensorIds) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_SENSORIDS, sensorIds);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(OrbitDetermination_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(OrbitDetermination_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_onOrbit(::flatbuffers::Offset<::flatbuffers::String> onOrbit) {
    fbb_.AddOffset(OrbitDetermination_Full::VT_ONORBIT, onOrbit);
  }
  explicit OrbitDetermination_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<OrbitDetermination_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<OrbitDetermination_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<OrbitDetermination_Full> CreateOrbitDetermination_Full(
    ...
    OrbitDetermination_Full_dataMode_Enum dataMode = OrbitDetermination_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> onOrbit = 0) {
  OrbitDetermination_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<OrbitDetermination_Full> CreateOrbitDetermination_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateOrbitDetermination_Full(
      _fbb,
      id__,
...
inline const OrbitDetermination_Full *GetOrbitDetermination_Full(const void *buf) {
  return ::flatbuffers::GetRoot<OrbitDetermination_Full>(buf);
}

inline const OrbitDetermination_Full *GetSizePrefixedOrbitDetermination_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<OrbitDetermination_Full>(buf);
}

inline const char *OrbitDetermination_FullIdentifier() {
  return "ORBI";
}

inline bool OrbitDetermination_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OrbitDetermination_FullIdentifier());
}

inline bool SizePrefixedOrbitDetermination_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OrbitDetermination_FullIdentifier(), true);
}

inline bool VerifyOrbitDetermination_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<OrbitDetermination_Full>(OrbitDetermination_FullIdentifier());
}

inline bool VerifySizePrefixedOrbitDetermination_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<OrbitDetermination_Full>(OrbitDetermination_FullIdentifier());
}

inline void FinishOrbitDetermination_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OrbitDetermination_Full> root) {
  fbb.Finish(root, OrbitDetermination_FullIdentifier());
}

inline void FinishSizePrefixedOrbitDetermination_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OrbitDetermination_Full> root) {
  fbb.FinishSizePrefixed(root, OrbitDetermination_FullIdentifier());
}
