...
struct SigAct_Ingest;
struct SigAct_IngestBuilder;

enum SigAct_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  SigAct_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  SigAct_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  SigAct_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  SigAct_Ingest_dataMode_Enum_EXERCISE = 3,
  SigAct_Ingest_dataMode_Enum_MIN = SigAct_Ingest_dataMode_Enum_REAL,
  SigAct_Ingest_dataMode_Enum_MAX = SigAct_Ingest_dataMode_Enum_EXERCISE
};

inline const SigAct_Ingest_dataMode_Enum (&EnumValuesSigAct_Ingest_dataMode_Enum())[4] {
  static const SigAct_Ingest_dataMode_Enum values[] = {
    SigAct_Ingest_dataMode_Enum_REAL,
    SigAct_Ingest_dataMode_Enum_TEST,
    SigAct_Ingest_dataMode_Enum_SIMULATED,
    SigAct_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSigAct_Ingest_dataMode_Enum() {
...
inline const char *EnumNameSigAct_Ingest_dataMode_Enum(SigAct_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SigAct_Ingest_dataMode_Enum_REAL, SigAct_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSigAct_Ingest_dataMode_Enum()[index];
}
...
struct SigAct_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SigAct_IngestBuilder Builder;
  ...
  SigAct_Ingest_dataMode_Enum dataMode() const {
    return static_cast<SigAct_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SigAct_IngestBuilder {
  typedef SigAct_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SigAct_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SigAct_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_sourceLanguage(::flatbuffers::Offset<::flatbuffers::String> sourceLanguage) {
    fbb_.AddOffset(SigAct_Ingest::VT_SOURCELANGUAGE, sourceLanguage);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(SigAct_Ingest::VT_COUNTRYCODE, countryCode);
  }
  void add_city(::flatbuffers::Offset<::flatbuffers::String> city) {
    fbb_.AddOffset(SigAct_Ingest::VT_CITY, city);
  }
  void add_district(::flatbuffers::Offset<::flatbuffers::String> district) {
    fbb_.AddOffset(SigAct_Ingest::VT_DISTRICT, district);
  }
  void add_province(::flatbuffers::Offset<::flatbuffers::String> province) {
    fbb_.AddOffset(SigAct_Ingest::VT_PROVINCE, province);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(SigAct_Ingest::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(SigAct_Ingest::VT_LON, lon, 0.0);
  }
  void add_milgrid(::flatbuffers::Offset<::flatbuffers::String> milgrid) {
    fbb_.AddOffset(SigAct_Ingest::VT_MILGRID, milgrid);
  }
  void add_theater(::flatbuffers::Offset<::flatbuffers::String> theater) {
    fbb_.AddOffset(SigAct_Ingest::VT_THEATER, theater);
  }
  void add_area(::flatbuffers::Offset<::flatbuffers::String> area) {
    fbb_.AddOffset(SigAct_Ingest::VT_AREA, area);
  }
  void add_atext(::flatbuffers::Offset<::flatbuffers::String> atext) {
    fbb_.AddOffset(SigAct_Ingest::VT_ATEXT, atext);
  }
  void add_agjson(::flatbuffers::Offset<::flatbuffers::String> agjson) {
    fbb_.AddOffset(SigAct_Ingest::VT_AGJSON, agjson);
  }
  void add_atype(::flatbuffers::Offset<::flatbuffers::String> atype) {
    fbb_.AddOffset(SigAct_Ingest::VT_ATYPE, atype);
  }
  void add_andims(int32_t andims) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_ANDIMS, andims, 0);
  }
  void add_asrid(int32_t asrid) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_ASRID, asrid, 0);
  }
  void add_eventStart(::flatbuffers::Offset<::flatbuffers::String> eventStart) {
    fbb_.AddOffset(SigAct_Ingest::VT_EVENTSTART, eventStart);
  }
  void add_eventEnd(::flatbuffers::Offset<::flatbuffers::String> eventEnd) {
    fbb_.AddOffset(SigAct_Ingest::VT_EVENTEND, eventEnd);
  }
  void add_reportDate(::flatbuffers::Offset<::flatbuffers::String> reportDate) {
    fbb_.AddOffset(SigAct_Ingest::VT_REPORTDATE, reportDate);
  }
  void add_actors(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> actors) {
    fbb_.AddOffset(SigAct_Ingest::VT_ACTORS, actors);
  }
  void add_civAbd(int32_t civAbd) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_CIVABD, civAbd, 0);
  }
  void add_civDet(int32_t civDet) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_CIVDET, civDet, 0);
  }
  void add_civKIA(int32_t civKIA) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_CIVKIA, civKIA, 0);
  }
  void add_civWound(int32_t civWound) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_CIVWOUND, civWound, 0);
  }
  void add_coalAbd(int32_t coalAbd) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_COALABD, coalAbd, 0);
  }
  void add_coalDet(int32_t coalDet) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_COALDET, coalDet, 0);
  }
  void add_coalKIA(int32_t coalKIA) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_COALKIA, coalKIA, 0);
  }
  void add_coalWound(int32_t coalWound) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_COALWOUND, coalWound, 0);
  }
  void add_enemyAbd(int32_t enemyAbd) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_ENEMYABD, enemyAbd, 0);
  }
  void add_enemyDet(int32_t enemyDet) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_ENEMYDET, enemyDet, 0);
  }
  void add_enemyKIA(int32_t enemyKIA) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_ENEMYKIA, enemyKIA, 0);
  }
  void add_friendlyAbd(int32_t friendlyAbd) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_FRIENDLYABD, friendlyAbd, 0);
  }
  void add_friendlyDet(int32_t friendlyDet) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_FRIENDLYDET, friendlyDet, 0);
  }
  void add_friendlyKIA(int32_t friendlyKIA) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_FRIENDLYKIA, friendlyKIA, 0);
  }
  void add_friendlyWound(int32_t friendlyWound) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_FRIENDLYWOUND, friendlyWound, 0);
  }
  void add_hostNatAbd(int32_t hostNatAbd) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_HOSTNATABD, hostNatAbd, 0);
  }
  void add_hostNatDet(int32_t hostNatDet) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_HOSTNATDET, hostNatDet, 0);
  }
  void add_hostNatKIA(int32_t hostNatKIA) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_HOSTNATKIA, hostNatKIA, 0);
  }
  void add_hostNatWound(int32_t hostNatWound) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_HOSTNATWOUND, hostNatWound, 0);
  }
  void add_sideAAbd(int32_t sideAAbd) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_SIDEAABD, sideAAbd, 0);
  }
  void add_sideADet(int32_t sideADet) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_SIDEADET, sideADet, 0);
  }
  void add_sideAKIA(int32_t sideAKIA) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_SIDEAKIA, sideAKIA, 0);
  }
  void add_sideAWound(int32_t sideAWound) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_SIDEAWOUND, sideAWound, 0);
  }
  void add_sideBAbd(int32_t sideBAbd) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_SIDEBABD, sideBAbd, 0);
  }
  void add_sideBDet(int32_t sideBDet) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_SIDEBDET, sideBDet, 0);
  }
  void add_sideBKIA(int32_t sideBKIA) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_SIDEBKIA, sideBKIA, 0);
  }
  void add_sideBWound(int32_t sideBWound) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_SIDEBWOUND, sideBWound, 0);
  }
  void add_target(::flatbuffers::Offset<::flatbuffers::String> target) {
    fbb_.AddOffset(SigAct_Ingest::VT_TARGET, target);
  }
  void add_eventDescription(::flatbuffers::Offset<::flatbuffers::String> eventDescription) {
    fbb_.AddOffset(SigAct_Ingest::VT_EVENTDESCRIPTION, eventDescription);
  }
  void add_eventType(::flatbuffers::Offset<::flatbuffers::String> eventType) {
    fbb_.AddOffset(SigAct_Ingest::VT_EVENTTYPE, eventType);
  }
  void add_typeOfAttack(::flatbuffers::Offset<::flatbuffers::String> typeOfAttack) {
    fbb_.AddOffset(SigAct_Ingest::VT_TYPEOFATTACK, typeOfAttack);
  }
  void add_complexAttack(bool complexAttack) {
    fbb_.AddElement<uint8_t>(SigAct_Ingest::VT_COMPLEXATTACK, static_cast<uint8_t>(complexAttack), 0);
  }
  void add_idNumber(::flatbuffers::Offset<::flatbuffers::String> idNumber) {
    fbb_.AddOffset(SigAct_Ingest::VT_IDNUMBER, idNumber);
  }
  void add_confidence(int32_t confidence) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_CONFIDENCE, confidence, 0);
  }
  void add_accuracy(int32_t accuracy) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_ACCURACY, accuracy, 0);
  }
  void add_clarity(int32_t clarity) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_CLARITY, clarity, 0);
  }
  void add_cameoCode(::flatbuffers::Offset<::flatbuffers::String> cameoCode) {
    fbb_.AddOffset(SigAct_Ingest::VT_CAMEOCODE, cameoCode);
  }
  void add_cameoBaseCode(::flatbuffers::Offset<::flatbuffers::String> cameoBaseCode) {
    fbb_.AddOffset(SigAct_Ingest::VT_CAMEOBASECODE, cameoBaseCode);
  }
  void add_cameoRootCode(::flatbuffers::Offset<::flatbuffers::String> cameoRootCode) {
    fbb_.AddOffset(SigAct_Ingest::VT_CAMEOROOTCODE, cameoRootCode);
  }
  void add_goldstein(double goldstein) {
    fbb_.AddElement<double>(SigAct_Ingest::VT_GOLDSTEIN, goldstein, 0.0);
  }
  void add_documentSource(::flatbuffers::Offset<::flatbuffers::String> documentSource) {
    fbb_.AddOffset(SigAct_Ingest::VT_DOCUMENTSOURCE, documentSource);
  }
  void add_documentFilename(::flatbuffers::Offset<::flatbuffers::String> documentFilename) {
    fbb_.AddOffset(SigAct_Ingest::VT_DOCUMENTFILENAME, documentFilename);
  }
  void add_hasAttachment(bool hasAttachment) {
    fbb_.AddElement<uint8_t>(SigAct_Ingest::VT_HASATTACHMENT, static_cast<uint8_t>(hasAttachment), 0);
  }
  void add_filesize(int64_t filesize) {
    fbb_.AddElement<int64_t>(SigAct_Ingest::VT_FILESIZE, filesize, 0);
  }
  void add_checksumValue(::flatbuffers::Offset<::flatbuffers::String> checksumValue) {
    fbb_.AddOffset(SigAct_Ingest::VT_CHECKSUMVALUE, checksumValue);
  }
  void add_repUnit(::flatbuffers::Offset<::flatbuffers::String> repUnit) {
    fbb_.AddOffset(SigAct_Ingest::VT_REPUNIT, repUnit);
  }
  void add_repUnitType(::flatbuffers::Offset<::flatbuffers::String> repUnitType) {
    fbb_.AddOffset(SigAct_Ingest::VT_REPUNITTYPE, repUnitType);
  }
  void add_repUnitActivity(::flatbuffers::Offset<::flatbuffers::String> repUnitActivity) {
    fbb_.AddOffset(SigAct_Ingest::VT_REPUNITACTIVITY, repUnitActivity);
  }
  void add_numMentions(int32_t numMentions) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_NUMMENTIONS, numMentions, 0);
  }
  void add_numSources(int32_t numSources) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_NUMSOURCES, numSources, 0);
  }
  void add_numArticles(int32_t numArticles) {
    fbb_.AddElement<int32_t>(SigAct_Ingest::VT_NUMARTICLES, numArticles, 0);
  }
  void add_avgTone(double avgTone) {
    fbb_.AddElement<double>(SigAct_Ingest::VT_AVGTONE, avgTone, 0.0);
  }
  void add_sourceUrl(::flatbuffers::Offset<::flatbuffers::String> sourceUrl) {
    fbb_.AddOffset(SigAct_Ingest::VT_SOURCEURL, sourceUrl);
  }
  void add_relatedDocs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> relatedDocs) {
    fbb_.AddOffset(SigAct_Ingest::VT_RELATEDDOCS, relatedDocs);
  }
  void add_summary(::flatbuffers::Offset<::flatbuffers::String> summary) {
    fbb_.AddOffset(SigAct_Ingest::VT_SUMMARY, summary);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(SigAct_Ingest::VT_NOTES, notes);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SigAct_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SigAct_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SigAct_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SigAct_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(SigAct_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SigAct_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SigAct_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  explicit SigAct_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SigAct_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SigAct_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SigAct_Ingest> CreateSigAct_Ingest(
    ...
    SigAct_Ingest_dataMode_Enum dataMode = SigAct_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  SigAct_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SigAct_Ingest> CreateSigAct_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const SigAct_Ingest *GetSigAct_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<SigAct_Ingest>(buf);
}

inline const SigAct_Ingest *GetSizePrefixedSigAct_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SigAct_Ingest>(buf);
}

inline const char *SigAct_IngestIdentifier() {
  return "SIGA";
}

inline bool SigAct_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SigAct_IngestIdentifier());
}

inline bool SizePrefixedSigAct_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SigAct_IngestIdentifier(), true);
}

inline bool VerifySigAct_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SigAct_Ingest>(SigAct_IngestIdentifier());
}

inline bool VerifySizePrefixedSigAct_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SigAct_Ingest>(SigAct_IngestIdentifier());
}

inline void FinishSigAct_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SigAct_Ingest> root) {
  fbb.Finish(root, SigAct_IngestIdentifier());
}

inline void FinishSizePrefixedSigAct_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SigAct_Ingest> root) {
  fbb.FinishSizePrefixed(root, SigAct_IngestIdentifier());
}
