...
struct AirfieldSlotConsumption_Abridged;
struct AirfieldSlotConsumption_AbridgedBuilder;

enum AirfieldSlotConsumption_Abridged_status_Enum : int8_t {
  /// No description available.
  AirfieldSlotConsumption_Abridged_status_Enum_REQUESTED = 0,
  /// No description available.
  AirfieldSlotConsumption_Abridged_status_Enum_APPROVED = 1,
  /// No description available.
  AirfieldSlotConsumption_Abridged_status_Enum_DENIED = 2,
  /// No description available.
  AirfieldSlotConsumption_Abridged_status_Enum_BLOCKED = 3,
  /// No description available.
  AirfieldSlotConsumption_Abridged_status_Enum_OTHER = 4,
  AirfieldSlotConsumption_Abridged_status_Enum_MIN = AirfieldSlotConsumption_Abridged_status_Enum_REQUESTED,
  AirfieldSlotConsumption_Abridged_status_Enum_MAX = AirfieldSlotConsumption_Abridged_status_Enum_OTHER
};

inline const AirfieldSlotConsumption_Abridged_status_Enum (&EnumValuesAirfieldSlotConsumption_Abridged_status_Enum())[5] {
  static const AirfieldSlotConsumption_Abridged_status_Enum values[] = {
    AirfieldSlotConsumption_Abridged_status_Enum_REQUESTED,
    AirfieldSlotConsumption_Abridged_status_Enum_APPROVED,
    AirfieldSlotConsumption_Abridged_status_Enum_DENIED,
    AirfieldSlotConsumption_Abridged_status_Enum_BLOCKED,
    AirfieldSlotConsumption_Abridged_status_Enum_OTHER
  };
  return values;
}

inline const char * const *EnumNamesAirfieldSlotConsumption_Abridged_status_Enum() {
...
inline const char *EnumNameAirfieldSlotConsumption_Abridged_status_Enum(AirfieldSlotConsumption_Abridged_status_Enum e) {
  if (::flatbuffers::IsOutRange(e, AirfieldSlotConsumption_Abridged_status_Enum_REQUESTED, AirfieldSlotConsumption_Abridged_status_Enum_OTHER)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAirfieldSlotConsumption_Abridged_status_Enum()[index];
}

enum AirfieldSlotConsumption_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  AirfieldSlotConsumption_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  AirfieldSlotConsumption_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  AirfieldSlotConsumption_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  AirfieldSlotConsumption_Abridged_dataMode_Enum_EXERCISE = 3,
  AirfieldSlotConsumption_Abridged_dataMode_Enum_MIN = AirfieldSlotConsumption_Abridged_dataMode_Enum_REAL,
  AirfieldSlotConsumption_Abridged_dataMode_Enum_MAX = AirfieldSlotConsumption_Abridged_dataMode_Enum_EXERCISE
};

inline const AirfieldSlotConsumption_Abridged_dataMode_Enum (&EnumValuesAirfieldSlotConsumption_Abridged_dataMode_Enum())[4] {
  static const AirfieldSlotConsumption_Abridged_dataMode_Enum values[] = {
    AirfieldSlotConsumption_Abridged_dataMode_Enum_REAL,
    AirfieldSlotConsumption_Abridged_dataMode_Enum_TEST,
    AirfieldSlotConsumption_Abridged_dataMode_Enum_SIMULATED,
    AirfieldSlotConsumption_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAirfieldSlotConsumption_Abridged_dataMode_Enum() {
...
inline const char *EnumNameAirfieldSlotConsumption_Abridged_dataMode_Enum(AirfieldSlotConsumption_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AirfieldSlotConsumption_Abridged_dataMode_Enum_REAL, AirfieldSlotConsumption_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAirfieldSlotConsumption_Abridged_dataMode_Enum()[index];
}

/// /// Airfield slot use data. Contains the dynamic data associated with the status and use of specific airfield slots.
struct AirfieldSlotConsumption_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirfieldSlotConsumption_AbridgedBuilder Builder;
  ...
  AirfieldSlotConsumption_Abridged_status_Enum status() const {
    return static_cast<AirfieldSlotConsumption_Abridged_status_Enum>(GetField<int8_t>(VT_STATUS, 0));
  }
  ...
  AirfieldSlotConsumption_Abridged_dataMode_Enum dataMode() const {
    return static_cast<AirfieldSlotConsumption_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AirfieldSlotConsumption_AbridgedBuilder {
  typedef AirfieldSlotConsumption_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idAirfieldSlot(::flatbuffers::Offset<::flatbuffers::String> idAirfieldSlot) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_IDAIRFIELDSLOT, idAirfieldSlot);
  }
  void add_status(AirfieldSlotConsumption_Abridged_status_Enum status) {
    fbb_.AddElement<int8_t>(AirfieldSlotConsumption_Abridged::VT_STATUS, static_cast<int8_t>(status), 0);
  }
  void add_occupied(bool occupied) {
    fbb_.AddElement<uint8_t>(AirfieldSlotConsumption_Abridged::VT_OCCUPIED, static_cast<uint8_t>(occupied), 0);
  }
  void add_consumer(::flatbuffers::Offset<::flatbuffers::String> consumer) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_CONSUMER, consumer);
  }
  void add_occAircraftMDS(::flatbuffers::Offset<::flatbuffers::String> occAircraftMDS) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_OCCAIRCRAFTMDS, occAircraftMDS);
  }
  void add_occTailNumber(::flatbuffers::Offset<::flatbuffers::String> occTailNumber) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_OCCTAILNUMBER, occTailNumber);
  }
  void add_callSigns(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> callSigns) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_CALLSIGNS, callSigns);
  }
  void add_missionId(::flatbuffers::Offset<::flatbuffers::String> missionId) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_MISSIONID, missionId);
  }
  void add_numAircraft(int32_t numAircraft) {
    fbb_.AddElement<int32_t>(AirfieldSlotConsumption_Abridged::VT_NUMAIRCRAFT, numAircraft, 0);
  }
  void add_occStartTime(::flatbuffers::Offset<::flatbuffers::String> occStartTime) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_OCCSTARTTIME, occStartTime);
  }
  void add_resAircraftMDS(::flatbuffers::Offset<::flatbuffers::String> resAircraftMDS) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_RESAIRCRAFTMDS, resAircraftMDS);
  }
  void add_resTailNumber(::flatbuffers::Offset<::flatbuffers::String> resTailNumber) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_RESTAILNUMBER, resTailNumber);
  }
  void add_resType(::flatbuffers::Offset<::flatbuffers::String> resType) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_RESTYPE, resType);
  }
  void add_resReason(::flatbuffers::Offset<::flatbuffers::String> resReason) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_RESREASON, resReason);
  }
  void add_resMissionId(::flatbuffers::Offset<::flatbuffers::String> resMissionId) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_RESMISSIONID, resMissionId);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_ENDTIME, endTime);
  }
  void add_targetTime(::flatbuffers::Offset<::flatbuffers::String> targetTime) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_TARGETTIME, targetTime);
  }
  void add_idArrSortie(::flatbuffers::Offset<::flatbuffers::String> idArrSortie) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_IDARRSORTIE, idArrSortie);
  }
  void add_idDepSortie(::flatbuffers::Offset<::flatbuffers::String> idDepSortie) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_IDDEPSORTIE, idDepSortie);
  }
  void add_altArrSortieId(::flatbuffers::Offset<::flatbuffers::String> altArrSortieId) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_ALTARRSORTIEID, altArrSortieId);
  }
  void add_altDepSortieId(::flatbuffers::Offset<::flatbuffers::String> altDepSortieId) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_ALTDEPSORTIEID, altDepSortieId);
  }
  void add_reqComment(::flatbuffers::Offset<::flatbuffers::String> reqComment) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_REQCOMMENT, reqComment);
  }
  void add_appComment(::flatbuffers::Offset<::flatbuffers::String> appComment) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_APPCOMMENT, appComment);
  }
  void add_reqOrg(::flatbuffers::Offset<::flatbuffers::String> reqOrg) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_REQORG, reqOrg);
  }
  void add_reqInitials(::flatbuffers::Offset<::flatbuffers::String> reqInitials) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_REQINITIALS, reqInitials);
  }
  void add_appOrg(::flatbuffers::Offset<::flatbuffers::String> appOrg) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_APPORG, appOrg);
  }
  void add_appInitials(::flatbuffers::Offset<::flatbuffers::String> appInitials) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_APPINITIALS, appInitials);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AirfieldSlotConsumption_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(AirfieldSlotConsumption_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AirfieldSlotConsumption_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit AirfieldSlotConsumption_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirfieldSlotConsumption_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirfieldSlotConsumption_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirfieldSlotConsumption_Abridged> CreateAirfieldSlotConsumption_Abridged(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::String> id = 0,
    ::flatbuffers::Offset<::flatbuffers::String> classificationMarking = 0,
    ::flatbuffers::Offset<::flatbuffers::String> idAirfieldSlot = 0,
    AirfieldSlotConsumption_Abridged_status_Enum status = AirfieldSlotConsumption_Abridged_status_Enum_REQUESTED,
    bool occupied = false,
    ...
    AirfieldSlotConsumption_Abridged_dataMode_Enum dataMode = AirfieldSlotConsumption_Abridged_dataMode_Enum_REAL) {
  AirfieldSlotConsumption_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirfieldSlotConsumption_Abridged> CreateAirfieldSlotConsumption_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AirfieldSlotConsumption_Abridged *GetAirfieldSlotConsumption_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<AirfieldSlotConsumption_Abridged>(buf);
}

inline const AirfieldSlotConsumption_Abridged *GetSizePrefixedAirfieldSlotConsumption_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirfieldSlotConsumption_Abridged>(buf);
}

inline const char *AirfieldSlotConsumption_AbridgedIdentifier() {
  return "AIRF";
}

inline bool AirfieldSlotConsumption_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirfieldSlotConsumption_AbridgedIdentifier());
}

inline bool SizePrefixedAirfieldSlotConsumption_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirfieldSlotConsumption_AbridgedIdentifier(), true);
}

inline bool VerifyAirfieldSlotConsumption_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirfieldSlotConsumption_Abridged>(AirfieldSlotConsumption_AbridgedIdentifier());
}

inline bool VerifySizePrefixedAirfieldSlotConsumption_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirfieldSlotConsumption_Abridged>(AirfieldSlotConsumption_AbridgedIdentifier());
}

inline void FinishAirfieldSlotConsumption_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirfieldSlotConsumption_Abridged> root) {
  fbb.Finish(root, AirfieldSlotConsumption_AbridgedIdentifier());
}

inline void FinishSizePrefixedAirfieldSlotConsumption_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirfieldSlotConsumption_Abridged> root) {
  fbb.FinishSizePrefixed(root, AirfieldSlotConsumption_AbridgedIdentifier());
}
