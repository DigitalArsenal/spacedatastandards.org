...
struct Elset_Abridged;
struct Elset_AbridgedBuilder;

enum Elset_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Elset_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Elset_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Elset_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Elset_Abridged_dataMode_Enum_EXERCISE = 3,
  Elset_Abridged_dataMode_Enum_MIN = Elset_Abridged_dataMode_Enum_REAL,
  Elset_Abridged_dataMode_Enum_MAX = Elset_Abridged_dataMode_Enum_EXERCISE
};

inline const Elset_Abridged_dataMode_Enum (&EnumValuesElset_Abridged_dataMode_Enum())[4] {
  static const Elset_Abridged_dataMode_Enum values[] = {
    Elset_Abridged_dataMode_Enum_REAL,
    Elset_Abridged_dataMode_Enum_TEST,
    Elset_Abridged_dataMode_Enum_SIMULATED,
    Elset_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesElset_Abridged_dataMode_Enum() {
...
inline const char *EnumNameElset_Abridged_dataMode_Enum(Elset_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Elset_Abridged_dataMode_Enum_REAL, Elset_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesElset_Abridged_dataMode_Enum()[index];
}
...
struct Elset_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Elset_AbridgedBuilder Builder;
  ...
  Elset_Abridged_dataMode_Enum dataMode() const {
    return static_cast<Elset_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Elset_AbridgedBuilder {
  typedef Elset_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_idElset(::flatbuffers::Offset<::flatbuffers::String> idElset) {
    fbb_.AddOffset(Elset_Abridged::VT_IDELSET, idElset);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Elset_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(Elset_Abridged::VT_SATNO, satNo, 0);
  }
  void add_epoch(::flatbuffers::Offset<::flatbuffers::String> epoch) {
    fbb_.AddOffset(Elset_Abridged::VT_EPOCH, epoch);
  }
  void add_meanMotion(double meanMotion) {
    fbb_.AddElement<double>(Elset_Abridged::VT_MEANMOTION, meanMotion, 0.0);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(Elset_Abridged::VT_IDONORBIT, idOnOrbit);
  }
  void add_uct(bool uct) {
    fbb_.AddElement<uint8_t>(Elset_Abridged::VT_UCT, static_cast<uint8_t>(uct), 0);
  }
  void add_eccentricity(double eccentricity) {
    fbb_.AddElement<double>(Elset_Abridged::VT_ECCENTRICITY, eccentricity, 0.0);
  }
  void add_inclination(double inclination) {
    fbb_.AddElement<double>(Elset_Abridged::VT_INCLINATION, inclination, 0.0);
  }
  void add_raan(double raan) {
    fbb_.AddElement<double>(Elset_Abridged::VT_RAAN, raan, 0.0);
  }
  void add_argOfPerigee(double argOfPerigee) {
    fbb_.AddElement<double>(Elset_Abridged::VT_ARGOFPERIGEE, argOfPerigee, 0.0);
  }
  void add_meanAnomaly(double meanAnomaly) {
    fbb_.AddElement<double>(Elset_Abridged::VT_MEANANOMALY, meanAnomaly, 0.0);
  }
  void add_revNo(int32_t revNo) {
    fbb_.AddElement<int32_t>(Elset_Abridged::VT_REVNO, revNo, 0);
  }
  void add_bStar(double bStar) {
    fbb_.AddElement<double>(Elset_Abridged::VT_BSTAR, bStar, 0.0);
  }
  void add_agom(double agom) {
    fbb_.AddElement<double>(Elset_Abridged::VT_AGOM, agom, 0.0);
  }
  void add_ballisticCoeff(double ballisticCoeff) {
    fbb_.AddElement<double>(Elset_Abridged::VT_BALLISTICCOEFF, ballisticCoeff, 0.0);
  }
  void add_meanMotionDot(double meanMotionDot) {
    fbb_.AddElement<double>(Elset_Abridged::VT_MEANMOTIONDOT, meanMotionDot, 0.0);
  }
  void add_meanMotionDDot(double meanMotionDDot) {
    fbb_.AddElement<double>(Elset_Abridged::VT_MEANMOTIONDDOT, meanMotionDDot, 0.0);
  }
  void add_semiMajorAxis(double semiMajorAxis) {
    fbb_.AddElement<double>(Elset_Abridged::VT_SEMIMAJORAXIS, semiMajorAxis, 0.0);
  }
  void add_period(double period) {
    fbb_.AddElement<double>(Elset_Abridged::VT_PERIOD, period, 0.0);
  }
  void add_apogee(double apogee) {
    fbb_.AddElement<double>(Elset_Abridged::VT_APOGEE, apogee, 0.0);
  }
  void add_perigee(double perigee) {
    fbb_.AddElement<double>(Elset_Abridged::VT_PERIGEE, perigee, 0.0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(Elset_Abridged::VT_ORIGOBJECTID, origObjectId);
  }
  void add_idOrbitDetermination(::flatbuffers::Offset<::flatbuffers::String> idOrbitDetermination) {
    fbb_.AddOffset(Elset_Abridged::VT_IDORBITDETERMINATION, idOrbitDetermination);
  }
  void add_line1(::flatbuffers::Offset<::flatbuffers::String> line1) {
    fbb_.AddOffset(Elset_Abridged::VT_LINE1, line1);
  }
  void add_line2(::flatbuffers::Offset<::flatbuffers::String> line2) {
    fbb_.AddOffset(Elset_Abridged::VT_LINE2, line2);
  }
  void add_descriptor(::flatbuffers::Offset<::flatbuffers::String> descriptor) {
    fbb_.AddOffset(Elset_Abridged::VT_DESCRIPTOR, descriptor);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Elset_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Elset_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Elset_Abridged::VT_ORIGIN, origin);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(Elset_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Elset_Abridged::VT_SOURCE, source);
  }
  void add_dataMode(Elset_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Elset_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_algorithm(::flatbuffers::Offset<::flatbuffers::String> algorithm) {
    fbb_.AddOffset(Elset_Abridged::VT_ALGORITHM, algorithm);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(Elset_Abridged::VT_TRANSACTIONID, transactionId);
  }
  void add_ephemType(int32_t ephemType) {
    fbb_.AddElement<int32_t>(Elset_Abridged::VT_EPHEMTYPE, ephemType, 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Elset_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  explicit Elset_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Elset_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Elset_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Elset_Abridged> CreateElset_Abridged(
...
inline ::flatbuffers::Offset<Elset_Abridged> CreateElset_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Elset_Abridged *GetElset_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<Elset_Abridged>(buf);
}

inline const Elset_Abridged *GetSizePrefixedElset_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Elset_Abridged>(buf);
}

inline const char *Elset_AbridgedIdentifier() {
  return "ELSE";
}

inline bool Elset_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Elset_AbridgedIdentifier());
}

inline bool SizePrefixedElset_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Elset_AbridgedIdentifier(), true);
}

inline bool VerifyElset_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Elset_Abridged>(Elset_AbridgedIdentifier());
}

inline bool VerifySizePrefixedElset_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Elset_Abridged>(Elset_AbridgedIdentifier());
}

inline void FinishElset_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Elset_Abridged> root) {
  fbb.Finish(root, Elset_AbridgedIdentifier());
}

inline void FinishSizePrefixedElset_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Elset_Abridged> root) {
  fbb.FinishSizePrefixed(root, Elset_AbridgedIdentifier());
}
