...
struct LogisticsStocks_Full;
struct LogisticsStocks_FullBuilder;

/// /// The supply stocks for this support item.
struct LogisticsStocks_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LogisticsStocks_FullBuilder Builder;
...
struct LogisticsStocks_FullBuilder {
  typedef LogisticsStocks_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_sourceICAO(::flatbuffers::Offset<::flatbuffers::String> sourceICAO) {
    fbb_.AddOffset(LogisticsStocks_Full::VT_SOURCEICAO, sourceICAO);
  }
  void add_quantity(int32_t quantity) {
    fbb_.AddElement<int32_t>(LogisticsStocks_Full::VT_QUANTITY, quantity, 0);
  }
  void add_stockCheckTime(::flatbuffers::Offset<::flatbuffers::String> stockCheckTime) {
    fbb_.AddOffset(LogisticsStocks_Full::VT_STOCKCHECKTIME, stockCheckTime);
  }
  void add_stockPOC(::flatbuffers::Offset<::flatbuffers::String> stockPOC) {
    fbb_.AddOffset(LogisticsStocks_Full::VT_STOCKPOC, stockPOC);
  }
  explicit LogisticsStocks_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LogisticsStocks_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LogisticsStocks_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LogisticsStocks_Full> CreateLogisticsStocks_Full(
  ...
  LogisticsStocks_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<LogisticsStocks_Full> CreateLogisticsStocks_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const LogisticsStocks_Full *GetLogisticsStocks_Full(const void *buf) {
  return ::flatbuffers::GetRoot<LogisticsStocks_Full>(buf);
}

inline const LogisticsStocks_Full *GetSizePrefixedLogisticsStocks_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<LogisticsStocks_Full>(buf);
}

inline const char *LogisticsStocks_FullIdentifier() {
  return "LOGI";
}

inline bool LogisticsStocks_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsStocks_FullIdentifier());
}

inline bool SizePrefixedLogisticsStocks_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsStocks_FullIdentifier(), true);
}

inline bool VerifyLogisticsStocks_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<LogisticsStocks_Full>(LogisticsStocks_FullIdentifier());
}

inline bool VerifySizePrefixedLogisticsStocks_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<LogisticsStocks_Full>(LogisticsStocks_FullIdentifier());
}

inline void FinishLogisticsStocks_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsStocks_Full> root) {
  fbb.Finish(root, LogisticsStocks_FullIdentifier());
}

inline void FinishSizePrefixedLogisticsStocks_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsStocks_Full> root) {
  fbb.FinishSizePrefixed(root, LogisticsStocks_FullIdentifier());
}
