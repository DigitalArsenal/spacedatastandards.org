...
struct EvacTreatment_Ingest;
struct EvacTreatment_IngestBuilder;

/// /// Treatment information.
struct EvacTreatment_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EvacTreatment_IngestBuilder Builder;
...
struct EvacTreatment_IngestBuilder {
  typedef EvacTreatment_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(EvacTreatment_Ingest::VT_TYPE, type);
  }
  void add_bodyPart(::flatbuffers::Offset<::flatbuffers::String> bodyPart) {
    fbb_.AddOffset(EvacTreatment_Ingest::VT_BODYPART, bodyPart);
  }
  void add_time(::flatbuffers::Offset<::flatbuffers::String> time) {
    fbb_.AddOffset(EvacTreatment_Ingest::VT_TIME, time);
  }
  void add_comments(::flatbuffers::Offset<::flatbuffers::String> comments) {
    fbb_.AddOffset(EvacTreatment_Ingest::VT_COMMENTS, comments);
  }
  explicit EvacTreatment_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<EvacTreatment_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<EvacTreatment_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<EvacTreatment_Ingest> CreateEvacTreatment_Ingest(
  ...
  EvacTreatment_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<EvacTreatment_Ingest> CreateEvacTreatment_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const EvacTreatment_Ingest *GetEvacTreatment_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<EvacTreatment_Ingest>(buf);
}

inline const EvacTreatment_Ingest *GetSizePrefixedEvacTreatment_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EvacTreatment_Ingest>(buf);
}

inline const char *EvacTreatment_IngestIdentifier() {
  return "EVAC";
}

inline bool EvacTreatment_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EvacTreatment_IngestIdentifier());
}

inline bool SizePrefixedEvacTreatment_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EvacTreatment_IngestIdentifier(), true);
}

inline bool VerifyEvacTreatment_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EvacTreatment_Ingest>(EvacTreatment_IngestIdentifier());
}

inline bool VerifySizePrefixedEvacTreatment_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EvacTreatment_Ingest>(EvacTreatment_IngestIdentifier());
}

inline void FinishEvacTreatment_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EvacTreatment_Ingest> root) {
  fbb.Finish(root, EvacTreatment_IngestIdentifier());
}

inline void FinishSizePrefixedEvacTreatment_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EvacTreatment_Ingest> root) {
  fbb.FinishSizePrefixed(root, EvacTreatment_IngestIdentifier());
}
