...
struct OnorbitEvent_Abridged;
struct OnorbitEvent_AbridgedBuilder;

enum OnorbitEvent_Abridged_dataMode_Enum : int8_t {
  ...
  OnorbitEvent_Abridged_dataMode_Enum_MIN = OnorbitEvent_Abridged_dataMode_Enum_REAL,
  OnorbitEvent_Abridged_dataMode_Enum_MAX = OnorbitEvent_Abridged_dataMode_Enum_EXERCISE
};

inline const OnorbitEvent_Abridged_dataMode_Enum (&EnumValuesOnorbitEvent_Abridged_dataMode_Enum())[4] {
  static const OnorbitEvent_Abridged_dataMode_Enum values[] = {
    OnorbitEvent_Abridged_dataMode_Enum_REAL,
    OnorbitEvent_Abridged_dataMode_Enum_TEST,
    OnorbitEvent_Abridged_dataMode_Enum_SIMULATED,
    OnorbitEvent_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesOnorbitEvent_Abridged_dataMode_Enum() {
...
inline const char *EnumNameOnorbitEvent_Abridged_dataMode_Enum(OnorbitEvent_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, OnorbitEvent_Abridged_dataMode_Enum_REAL, OnorbitEvent_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOnorbitEvent_Abridged_dataMode_Enum()[index];
}

/// /// No description available.
struct OnorbitEvent_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef OnorbitEvent_AbridgedBuilder Builder;
  ...
  OnorbitEvent_Abridged_dataMode_Enum dataMode() const {
    return static_cast<OnorbitEvent_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct OnorbitEvent_AbridgedBuilder {
  typedef OnorbitEvent_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_derivedFrom(::flatbuffers::Offset<::flatbuffers::String> derivedFrom) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_DERIVEDFROM, derivedFrom);
  }
  void add_declassificationDate(::flatbuffers::Offset<::flatbuffers::String> declassificationDate) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_DECLASSIFICATIONDATE, declassificationDate);
  }
  void add_declassificationString(::flatbuffers::Offset<::flatbuffers::String> declassificationString) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_DECLASSIFICATIONSTRING, declassificationString);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(OnorbitEvent_Abridged::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_ORIGOBJECTID, origObjectId);
  }
  void add_eventTime(::flatbuffers::Offset<::flatbuffers::String> eventTime) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_EVENTTIME, eventTime);
  }
  void add_eventTimeNotes(::flatbuffers::Offset<::flatbuffers::String> eventTimeNotes) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_EVENTTIMENOTES, eventTimeNotes);
  }
  void add_operatorOrgId(::flatbuffers::Offset<::flatbuffers::String> operatorOrgId) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_OPERATORORGID, operatorOrgId);
  }
  void add_ownerOrgId(::flatbuffers::Offset<::flatbuffers::String> ownerOrgId) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_OWNERORGID, ownerOrgId);
  }
  void add_lesseeOrgId(::flatbuffers::Offset<::flatbuffers::String> lesseeOrgId) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_LESSEEORGID, lesseeOrgId);
  }
  void add_operatedOnBehalfOfOrgId(::flatbuffers::Offset<::flatbuffers::String> operatedOnBehalfOfOrgId) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_OPERATEDONBEHALFOFORGID, operatedOnBehalfOfOrgId);
  }
  void add_geoPosition(double geoPosition) {
    fbb_.AddElement<double>(OnorbitEvent_Abridged::VT_GEOPOSITION, geoPosition, 0.0);
  }
  void add_planeSlot(::flatbuffers::Offset<::flatbuffers::String> planeSlot) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_PLANESLOT, planeSlot);
  }
  void add_planeNumber(::flatbuffers::Offset<::flatbuffers::String> planeNumber) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_PLANENUMBER, planeNumber);
  }
  void add_positionStatus(::flatbuffers::Offset<::flatbuffers::String> positionStatus) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_POSITIONSTATUS, positionStatus);
  }
  void add_untilTime(::flatbuffers::Offset<::flatbuffers::String> untilTime) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_UNTILTIME, untilTime);
  }
  void add_officialLossDate(::flatbuffers::Offset<::flatbuffers::String> officialLossDate) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_OFFICIALLOSSDATE, officialLossDate);
  }
  void add_netAmount(double netAmount) {
    fbb_.AddElement<double>(OnorbitEvent_Abridged::VT_NETAMOUNT, netAmount, 0.0);
  }
  void add_underlyingCause(::flatbuffers::Offset<::flatbuffers::String> underlyingCause) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_UNDERLYINGCAUSE, underlyingCause);
  }
  void add_capabilityLoss(double capabilityLoss) {
    fbb_.AddElement<double>(OnorbitEvent_Abridged::VT_CAPABILITYLOSS, capabilityLoss, 0.0);
  }
  void add_capacityLoss(double capacityLoss) {
    fbb_.AddElement<double>(OnorbitEvent_Abridged::VT_CAPACITYLOSS, capacityLoss, 0.0);
  }
  void add_insuranceLoss(double insuranceLoss) {
    fbb_.AddElement<double>(OnorbitEvent_Abridged::VT_INSURANCELOSS, insuranceLoss, 0.0);
  }
  void add_thirdPartyInsuranceLoss(double thirdPartyInsuranceLoss) {
    fbb_.AddElement<double>(OnorbitEvent_Abridged::VT_THIRDPARTYINSURANCELOSS, thirdPartyInsuranceLoss, 0.0);
  }
  void add_injured(int32_t injured) {
    fbb_.AddElement<int32_t>(OnorbitEvent_Abridged::VT_INJURED, injured, 0);
  }
  void add_killed(int32_t killed) {
    fbb_.AddElement<int32_t>(OnorbitEvent_Abridged::VT_KILLED, killed, 0);
  }
  void add_lifeLost(double lifeLost) {
    fbb_.AddElement<double>(OnorbitEvent_Abridged::VT_LIFELOST, lifeLost, 0.0);
  }
  void add_ageAtEvent(double ageAtEvent) {
    fbb_.AddElement<double>(OnorbitEvent_Abridged::VT_AGEATEVENT, ageAtEvent, 0.0);
  }
  void add_achievedFlightPhase(::flatbuffers::Offset<::flatbuffers::String> achievedFlightPhase) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_ACHIEVEDFLIGHTPHASE, achievedFlightPhase);
  }
  void add_occurrenceFlightPhase(::flatbuffers::Offset<::flatbuffers::String> occurrenceFlightPhase) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_OCCURRENCEFLIGHTPHASE, occurrenceFlightPhase);
  }
  void add_stageAtFault(::flatbuffers::Offset<::flatbuffers::String> stageAtFault) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_STAGEATFAULT, stageAtFault);
  }
  void add_equipmentAtFault(::flatbuffers::Offset<::flatbuffers::String> equipmentAtFault) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_EQUIPMENTATFAULT, equipmentAtFault);
  }
  void add_equipmentTypeAtFault(::flatbuffers::Offset<::flatbuffers::String> equipmentTypeAtFault) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_EQUIPMENTTYPEATFAULT, equipmentTypeAtFault);
  }
  void add_equipmentPartAtFault(::flatbuffers::Offset<::flatbuffers::String> equipmentPartAtFault) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_EQUIPMENTPARTATFAULT, equipmentPartAtFault);
  }
  void add_consequentialEquipmentFailure(::flatbuffers::Offset<::flatbuffers::String> consequentialEquipmentFailure) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_CONSEQUENTIALEQUIPMENTFAILURE, consequentialEquipmentFailure);
  }
  void add_inclined(bool inclined) {
    fbb_.AddElement<uint8_t>(OnorbitEvent_Abridged::VT_INCLINED, static_cast<uint8_t>(inclined), 0);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_DESCRIPTION, description);
  }
  void add_remarks(::flatbuffers::Offset<::flatbuffers::String> remarks) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_REMARKS, remarks);
  }
  void add_insuranceLossNotes(::flatbuffers::Offset<::flatbuffers::String> insuranceLossNotes) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_INSURANCELOSSNOTES, insuranceLossNotes);
  }
  void add_capabilityLossNotes(::flatbuffers::Offset<::flatbuffers::String> capabilityLossNotes) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_CAPABILITYLOSSNOTES, capabilityLossNotes);
  }
  void add_insuranceCarriedNotes(::flatbuffers::Offset<::flatbuffers::String> insuranceCarriedNotes) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_INSURANCECARRIEDNOTES, insuranceCarriedNotes);
  }
  void add_equipmentCausingLossNotes(::flatbuffers::Offset<::flatbuffers::String> equipmentCausingLossNotes) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_EQUIPMENTCAUSINGLOSSNOTES, equipmentCausingLossNotes);
  }
  void add_eventType(::flatbuffers::Offset<::flatbuffers::String> eventType) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_EVENTTYPE, eventType);
  }
  void add_eventResult(::flatbuffers::Offset<::flatbuffers::String> eventResult) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_EVENTRESULT, eventResult);
  }
  void add_objectStatus(::flatbuffers::Offset<::flatbuffers::String> objectStatus) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_OBJECTSTATUS, objectStatus);
  }
  void add_satellitePosition(::flatbuffers::Offset<::flatbuffers::String> satellitePosition) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_SATELLITEPOSITION, satellitePosition);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(OnorbitEvent_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(OnorbitEvent_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(OnorbitEvent_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  explicit OnorbitEvent_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<OnorbitEvent_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<OnorbitEvent_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<OnorbitEvent_Abridged> CreateOnorbitEvent_Abridged(
    ...
    OnorbitEvent_Abridged_dataMode_Enum dataMode = OnorbitEvent_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  OnorbitEvent_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<OnorbitEvent_Abridged> CreateOnorbitEvent_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const OnorbitEvent_Abridged *GetOnorbitEvent_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<OnorbitEvent_Abridged>(buf);
}

inline const OnorbitEvent_Abridged *GetSizePrefixedOnorbitEvent_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<OnorbitEvent_Abridged>(buf);
}

inline const char *OnorbitEvent_AbridgedIdentifier() {
  return "ONOR";
}

inline bool OnorbitEvent_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OnorbitEvent_AbridgedIdentifier());
}

inline bool SizePrefixedOnorbitEvent_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OnorbitEvent_AbridgedIdentifier(), true);
}

inline bool VerifyOnorbitEvent_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<OnorbitEvent_Abridged>(OnorbitEvent_AbridgedIdentifier());
}

inline bool VerifySizePrefixedOnorbitEvent_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<OnorbitEvent_Abridged>(OnorbitEvent_AbridgedIdentifier());
}

inline void FinishOnorbitEvent_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OnorbitEvent_Abridged> root) {
  fbb.Finish(root, OnorbitEvent_AbridgedIdentifier());
}

inline void FinishSizePrefixedOnorbitEvent_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OnorbitEvent_Abridged> root) {
  fbb.FinishSizePrefixed(root, OnorbitEvent_AbridgedIdentifier());
}
