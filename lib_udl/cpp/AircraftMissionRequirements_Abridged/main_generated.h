...
struct AircraftMissionRequirements_Abridged;
struct AircraftMissionRequirements_AbridgedBuilder;

/// /// Collection of Requirements associated with this Air Transport Mission.
struct AircraftMissionRequirements_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AircraftMissionRequirements_AbridgedBuilder Builder;
...
struct AircraftMissionRequirements_AbridgedBuilder {
  typedef AircraftMissionRequirements_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_gdssReqId(::flatbuffers::Offset<::flatbuffers::String> gdssReqId) {
    fbb_.AddOffset(AircraftMissionRequirements_Abridged::VT_GDSSREQID, gdssReqId);
  }
  void add_onloadId(int32_t onloadId) {
    fbb_.AddElement<int32_t>(AircraftMissionRequirements_Abridged::VT_ONLOADID, onloadId, 0);
  }
  void add_onloadLOCode(::flatbuffers::Offset<::flatbuffers::String> onloadLOCode) {
    fbb_.AddOffset(AircraftMissionRequirements_Abridged::VT_ONLOADLOCODE, onloadLOCode);
  }
  void add_offloadId(int32_t offloadId) {
    fbb_.AddElement<int32_t>(AircraftMissionRequirements_Abridged::VT_OFFLOADID, offloadId, 0);
  }
  void add_offloadLOCode(::flatbuffers::Offset<::flatbuffers::String> offloadLOCode) {
    fbb_.AddOffset(AircraftMissionRequirements_Abridged::VT_OFFLOADLOCODE, offloadLOCode);
  }
  void add_uln(::flatbuffers::Offset<::flatbuffers::String> uln) {
    fbb_.AddOffset(AircraftMissionRequirements_Abridged::VT_ULN, uln);
  }
  void add_transReqNum(::flatbuffers::Offset<::flatbuffers::String> transReqNum) {
    fbb_.AddOffset(AircraftMissionRequirements_Abridged::VT_TRANSREQNUM, transReqNum);
  }
  void add_projName(::flatbuffers::Offset<::flatbuffers::String> projName) {
    fbb_.AddOffset(AircraftMissionRequirements_Abridged::VT_PROJNAME, projName);
  }
  void add_oplan(::flatbuffers::Offset<::flatbuffers::String> oplan) {
    fbb_.AddOffset(AircraftMissionRequirements_Abridged::VT_OPLAN, oplan);
  }
  void add_numPax(int32_t numPax) {
    fbb_.AddElement<int32_t>(AircraftMissionRequirements_Abridged::VT_NUMPAX, numPax, 0);
  }
  void add_numLitter(int32_t numLitter) {
    fbb_.AddElement<int32_t>(AircraftMissionRequirements_Abridged::VT_NUMLITTER, numLitter, 0);
  }
  void add_numAmbulatory(int32_t numAmbulatory) {
    fbb_.AddElement<int32_t>(AircraftMissionRequirements_Abridged::VT_NUMAMBULATORY, numAmbulatory, 0);
  }
  void add_numAttendant(int32_t numAttendant) {
    fbb_.AddElement<int32_t>(AircraftMissionRequirements_Abridged::VT_NUMATTENDANT, numAttendant, 0);
  }
  void add_bulkWeight(double bulkWeight) {
    fbb_.AddElement<double>(AircraftMissionRequirements_Abridged::VT_BULKWEIGHT, bulkWeight, 0.0);
  }
  void add_oversizeWeight(double oversizeWeight) {
    fbb_.AddElement<double>(AircraftMissionRequirements_Abridged::VT_OVERSIZEWEIGHT, oversizeWeight, 0.0);
  }
  void add_outsizeWeight(double outsizeWeight) {
    fbb_.AddElement<double>(AircraftMissionRequirements_Abridged::VT_OUTSIZEWEIGHT, outsizeWeight, 0.0);
  }
  void add_ead(::flatbuffers::Offset<::flatbuffers::String> ead) {
    fbb_.AddOffset(AircraftMissionRequirements_Abridged::VT_EAD, ead);
  }
  void add_lad(::flatbuffers::Offset<::flatbuffers::String> lad) {
    fbb_.AddOffset(AircraftMissionRequirements_Abridged::VT_LAD, lad);
  }
  explicit AircraftMissionRequirements_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AircraftMissionRequirements_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AircraftMissionRequirements_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AircraftMissionRequirements_Abridged> CreateAircraftMissionRequirements_Abridged(
  ...
  AircraftMissionRequirements_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AircraftMissionRequirements_Abridged> CreateAircraftMissionRequirements_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AircraftMissionRequirements_Abridged *GetAircraftMissionRequirements_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<AircraftMissionRequirements_Abridged>(buf);
}

inline const AircraftMissionRequirements_Abridged *GetSizePrefixedAircraftMissionRequirements_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AircraftMissionRequirements_Abridged>(buf);
}

inline const char *AircraftMissionRequirements_AbridgedIdentifier() {
  return "AIRC";
}

inline bool AircraftMissionRequirements_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftMissionRequirements_AbridgedIdentifier());
}

inline bool SizePrefixedAircraftMissionRequirements_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftMissionRequirements_AbridgedIdentifier(), true);
}

inline bool VerifyAircraftMissionRequirements_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AircraftMissionRequirements_Abridged>(AircraftMissionRequirements_AbridgedIdentifier());
}

inline bool VerifySizePrefixedAircraftMissionRequirements_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AircraftMissionRequirements_Abridged>(AircraftMissionRequirements_AbridgedIdentifier());
}

inline void FinishAircraftMissionRequirements_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftMissionRequirements_Abridged> root) {
  fbb.Finish(root, AircraftMissionRequirements_AbridgedIdentifier());
}

inline void FinishSizePrefixedAircraftMissionRequirements_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftMissionRequirements_Abridged> root) {
  fbb.FinishSizePrefixed(root, AircraftMissionRequirements_AbridgedIdentifier());
}
