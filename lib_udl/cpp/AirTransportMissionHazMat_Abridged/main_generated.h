...
struct AirTransportMissionHazMat_Abridged;
struct AirTransportMissionHazMat_AbridgedBuilder;

/// /// Collection of Hazardous Material information associated with this Air Transport Mission.
struct AirTransportMissionHazMat_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirTransportMissionHazMat_AbridgedBuilder Builder;
...
struct AirTransportMissionHazMat_AbridgedBuilder {
  typedef AirTransportMissionHazMat_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_extHazMatId(::flatbuffers::Offset<::flatbuffers::String> extHazMatId) {
    fbb_.AddOffset(AirTransportMissionHazMat_Abridged::VT_EXTHAZMATID, extHazMatId);
  }
  void add_itemName(::flatbuffers::Offset<::flatbuffers::String> itemName) {
    fbb_.AddOffset(AirTransportMissionHazMat_Abridged::VT_ITEMNAME, itemName);
  }
  void add_unNum(::flatbuffers::Offset<::flatbuffers::String> unNum) {
    fbb_.AddOffset(AirTransportMissionHazMat_Abridged::VT_UNNUM, unNum);
  }
  void add_pieces(int32_t pieces) {
    fbb_.AddElement<int32_t>(AirTransportMissionHazMat_Abridged::VT_PIECES, pieces, 0);
  }
  void add_weight(double weight) {
    fbb_.AddElement<double>(AirTransportMissionHazMat_Abridged::VT_WEIGHT, weight, 0.0);
  }
  void add_netExpWt(double netExpWt) {
    fbb_.AddElement<double>(AirTransportMissionHazMat_Abridged::VT_NETEXPWT, netExpWt, 0.0);
  }
  void add_classDiv(double classDiv) {
    fbb_.AddElement<double>(AirTransportMissionHazMat_Abridged::VT_CLASSDIV, classDiv, 0.0);
  }
  void add_cgc(::flatbuffers::Offset<::flatbuffers::String> cgc) {
    fbb_.AddOffset(AirTransportMissionHazMat_Abridged::VT_CGC, cgc);
  }
  void add_cgn(::flatbuffers::Offset<::flatbuffers::String> cgn) {
    fbb_.AddOffset(AirTransportMissionHazMat_Abridged::VT_CGN, cgn);
  }
  void add_applicableNotes(::flatbuffers::Offset<::flatbuffers::String> applicableNotes) {
    fbb_.AddOffset(AirTransportMissionHazMat_Abridged::VT_APPLICABLENOTES, applicableNotes);
  }
  void add_onItin(int32_t onItin) {
    fbb_.AddElement<int32_t>(AirTransportMissionHazMat_Abridged::VT_ONITIN, onItin, 0);
  }
  void add_onICAO(::flatbuffers::Offset<::flatbuffers::String> onICAO) {
    fbb_.AddOffset(AirTransportMissionHazMat_Abridged::VT_ONICAO, onICAO);
  }
  void add_offItin(int32_t offItin) {
    fbb_.AddElement<int32_t>(AirTransportMissionHazMat_Abridged::VT_OFFITIN, offItin, 0);
  }
  void add_offICAO(::flatbuffers::Offset<::flatbuffers::String> offICAO) {
    fbb_.AddOffset(AirTransportMissionHazMat_Abridged::VT_OFFICAO, offICAO);
  }
  void add_planned(::flatbuffers::Offset<::flatbuffers::String> planned) {
    fbb_.AddOffset(AirTransportMissionHazMat_Abridged::VT_PLANNED, planned);
  }
  explicit AirTransportMissionHazMat_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirTransportMissionHazMat_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirTransportMissionHazMat_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirTransportMissionHazMat_Abridged> CreateAirTransportMissionHazMat_Abridged(
  ...
  AirTransportMissionHazMat_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirTransportMissionHazMat_Abridged> CreateAirTransportMissionHazMat_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AirTransportMissionHazMat_Abridged *GetAirTransportMissionHazMat_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<AirTransportMissionHazMat_Abridged>(buf);
}

inline const AirTransportMissionHazMat_Abridged *GetSizePrefixedAirTransportMissionHazMat_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirTransportMissionHazMat_Abridged>(buf);
}

inline const char *AirTransportMissionHazMat_AbridgedIdentifier() {
  return "AIRT";
}

inline bool AirTransportMissionHazMat_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirTransportMissionHazMat_AbridgedIdentifier());
}

inline bool SizePrefixedAirTransportMissionHazMat_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirTransportMissionHazMat_AbridgedIdentifier(), true);
}

inline bool VerifyAirTransportMissionHazMat_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirTransportMissionHazMat_Abridged>(AirTransportMissionHazMat_AbridgedIdentifier());
}

inline bool VerifySizePrefixedAirTransportMissionHazMat_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirTransportMissionHazMat_Abridged>(AirTransportMissionHazMat_AbridgedIdentifier());
}

inline void FinishAirTransportMissionHazMat_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirTransportMissionHazMat_Abridged> root) {
  fbb.Finish(root, AirTransportMissionHazMat_AbridgedIdentifier());
}

inline void FinishSizePrefixedAirTransportMissionHazMat_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirTransportMissionHazMat_Abridged> root) {
  fbb.FinishSizePrefixed(root, AirTransportMissionHazMat_AbridgedIdentifier());
}
