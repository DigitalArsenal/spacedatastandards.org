...
struct MtiHRR_Ingest;
struct MtiHRR_IngestBuilder;

/// /// Data on High-Range Resolution (HRR) targets or High Range Resolution Range Doppler Maps (RDM) for a specified area.
struct MtiHRR_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef MtiHRR_IngestBuilder Builder;
...
struct MtiHRR_IngestBuilder {
  typedef MtiHRR_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_h2(int32_t h2) {
    fbb_.AddElement<int32_t>(MtiHRR_Ingest::VT_H2, h2, 0);
  }
  void add_h3(int32_t h3) {
    fbb_.AddElement<int32_t>(MtiHRR_Ingest::VT_H3, h3, 0);
  }
  void add_h4(bool h4) {
    fbb_.AddElement<uint8_t>(MtiHRR_Ingest::VT_H4, static_cast<uint8_t>(h4), 0);
  }
  void add_h5(int32_t h5) {
    fbb_.AddElement<int32_t>(MtiHRR_Ingest::VT_H5, h5, 0);
  }
  void add_h6(int32_t h6) {
    fbb_.AddElement<int32_t>(MtiHRR_Ingest::VT_H6, h6, 0);
  }
  void add_h7(int32_t h7) {
    fbb_.AddElement<int32_t>(MtiHRR_Ingest::VT_H7, h7, 0);
  }
  void add_h8(int32_t h8) {
    fbb_.AddElement<int32_t>(MtiHRR_Ingest::VT_H8, h8, 0);
  }
  void add_h9(int32_t h9) {
    fbb_.AddElement<int32_t>(MtiHRR_Ingest::VT_H9, h9, 0);
  }
  void add_h10(int32_t h10) {
    fbb_.AddElement<int32_t>(MtiHRR_Ingest::VT_H10, h10, 0);
  }
  void add_h11(double h11) {
    fbb_.AddElement<double>(MtiHRR_Ingest::VT_H11, h11, 0.0);
  }
  void add_h12(double h12) {
    fbb_.AddElement<double>(MtiHRR_Ingest::VT_H12, h12, 0.0);
  }
  void add_h13(double h13) {
    fbb_.AddElement<double>(MtiHRR_Ingest::VT_H13, h13, 0.0);
  }
  void add_h14(double h14) {
    fbb_.AddElement<double>(MtiHRR_Ingest::VT_H14, h14, 0.0);
  }
  void add_h15(double h15) {
    fbb_.AddElement<double>(MtiHRR_Ingest::VT_H15, h15, 0.0);
  }
  void add_h16(::flatbuffers::Offset<::flatbuffers::String> h16) {
    fbb_.AddOffset(MtiHRR_Ingest::VT_H16, h16);
  }
  void add_h17(::flatbuffers::Offset<::flatbuffers::String> h17) {
    fbb_.AddOffset(MtiHRR_Ingest::VT_H17, h17);
  }
  void add_h18(::flatbuffers::Offset<::flatbuffers::String> h18) {
    fbb_.AddOffset(MtiHRR_Ingest::VT_H18, h18);
  }
  void add_h19(double h19) {
    fbb_.AddElement<double>(MtiHRR_Ingest::VT_H19, h19, 0.0);
  }
  void add_h20(int32_t h20) {
    fbb_.AddElement<int32_t>(MtiHRR_Ingest::VT_H20, h20, 0);
  }
  void add_h21(int32_t h21) {
    fbb_.AddElement<int32_t>(MtiHRR_Ingest::VT_H21, h21, 0);
  }
  void add_h22(int32_t h22) {
    fbb_.AddElement<int32_t>(MtiHRR_Ingest::VT_H22, h22, 0);
  }
  void add_h23(::flatbuffers::Offset<::flatbuffers::String> h23) {
    fbb_.AddOffset(MtiHRR_Ingest::VT_H23, h23);
  }
  void add_h24(::flatbuffers::Offset<::flatbuffers::String> h24) {
    fbb_.AddOffset(MtiHRR_Ingest::VT_H24, h24);
  }
  void add_h27(int32_t h27) {
    fbb_.AddElement<int32_t>(MtiHRR_Ingest::VT_H27, h27, 0);
  }
  void add_h28(int64_t h28) {
    fbb_.AddElement<int64_t>(MtiHRR_Ingest::VT_H28, h28, 0);
  }
  void add_h29(int32_t h29) {
    fbb_.AddElement<int32_t>(MtiHRR_Ingest::VT_H29, h29, 0);
  }
  void add_h30(int32_t h30) {
    fbb_.AddElement<int32_t>(MtiHRR_Ingest::VT_H30, h30, 0);
  }
  void add_h31(int32_t h31) {
    fbb_.AddElement<int32_t>(MtiHRR_Ingest::VT_H31, h31, 0);
  }
  void add_h32(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> h32) {
    fbb_.AddOffset(MtiHRR_Ingest::VT_H32, h32);
  }
  explicit MtiHRR_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<MtiHRR_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<MtiHRR_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<MtiHRR_Ingest> CreateMtiHRR_Ingest(
  ...
  MtiHRR_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<MtiHRR_Ingest> CreateMtiHRR_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    int32_t h2 = 0,
    int32_t h3 = 0,
    bool h4 = false,
...
inline const MtiHRR_Ingest *GetMtiHRR_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<MtiHRR_Ingest>(buf);
}

inline const MtiHRR_Ingest *GetSizePrefixedMtiHRR_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<MtiHRR_Ingest>(buf);
}

inline const char *MtiHRR_IngestIdentifier() {
  return "MTIH";
}

inline bool MtiHRR_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MtiHRR_IngestIdentifier());
}

inline bool SizePrefixedMtiHRR_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MtiHRR_IngestIdentifier(), true);
}

inline bool VerifyMtiHRR_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<MtiHRR_Ingest>(MtiHRR_IngestIdentifier());
}

inline bool VerifySizePrefixedMtiHRR_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<MtiHRR_Ingest>(MtiHRR_IngestIdentifier());
}

inline void FinishMtiHRR_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MtiHRR_Ingest> root) {
  fbb.Finish(root, MtiHRR_IngestIdentifier());
}

inline void FinishSizePrefixedMtiHRR_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MtiHRR_Ingest> root) {
  fbb.FinishSizePrefixed(root, MtiHRR_IngestIdentifier());
}
