...
struct SeradataSpacecraftDetails_Ingest;
struct SeradataSpacecraftDetails_IngestBuilder;

enum SeradataSpacecraftDetails_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  SeradataSpacecraftDetails_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  SeradataSpacecraftDetails_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  SeradataSpacecraftDetails_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  SeradataSpacecraftDetails_Ingest_dataMode_Enum_EXERCISE = 3,
  SeradataSpacecraftDetails_Ingest_dataMode_Enum_MIN = SeradataSpacecraftDetails_Ingest_dataMode_Enum_REAL,
  SeradataSpacecraftDetails_Ingest_dataMode_Enum_MAX = SeradataSpacecraftDetails_Ingest_dataMode_Enum_EXERCISE
};

inline const SeradataSpacecraftDetails_Ingest_dataMode_Enum (&EnumValuesSeradataSpacecraftDetails_Ingest_dataMode_Enum())[4] {
  static const SeradataSpacecraftDetails_Ingest_dataMode_Enum values[] = {
    SeradataSpacecraftDetails_Ingest_dataMode_Enum_REAL,
    SeradataSpacecraftDetails_Ingest_dataMode_Enum_TEST,
    SeradataSpacecraftDetails_Ingest_dataMode_Enum_SIMULATED,
    SeradataSpacecraftDetails_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSeradataSpacecraftDetails_Ingest_dataMode_Enum() {
...
inline const char *EnumNameSeradataSpacecraftDetails_Ingest_dataMode_Enum(SeradataSpacecraftDetails_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SeradataSpacecraftDetails_Ingest_dataMode_Enum_REAL, SeradataSpacecraftDetails_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSeradataSpacecraftDetails_Ingest_dataMode_Enum()[index];
}

/// /// On-orbit spacecraft details compiled by Seradata for a particular satellite.
struct SeradataSpacecraftDetails_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SeradataSpacecraftDetails_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SeradataSpacecraftDetails_Ingest_dataMode_Enum dataMode() const {
    return static_cast<SeradataSpacecraftDetails_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SeradataSpacecraftDetails_IngestBuilder {
  typedef SeradataSpacecraftDetails_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_ID, id);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_NAME, name);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_DESCRIPTION, description);
  }
  void add_intlNumber(::flatbuffers::Offset<::flatbuffers::String> intlNumber) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_INTLNUMBER, intlNumber);
  }
  void add_sector(::flatbuffers::Offset<::flatbuffers::String> sector) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_SECTOR, sector);
  }
  void add_apogee(double apogee) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_APOGEE, apogee, 0.0);
  }
  void add_perigee(double perigee) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_PERIGEE, perigee, 0.0);
  }
  void add_period(double period) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_PERIOD, period, 0.0);
  }
  void add_inclination(double inclination) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_INCLINATION, inclination, 0.0);
  }
  void add_primeManufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> primeManufacturerOrgId) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_PRIMEMANUFACTURERORGID, primeManufacturerOrgId);
  }
  void add_stabilizer(::flatbuffers::Offset<::flatbuffers::String> stabilizer) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_STABILIZER, stabilizer);
  }
  void add_designLife(int32_t designLife) {
    fbb_.AddElement<int32_t>(SeradataSpacecraftDetails_Ingest::VT_DESIGNLIFE, designLife, 0);
  }
  void add_expectedLife(int32_t expectedLife) {
    fbb_.AddElement<int32_t>(SeradataSpacecraftDetails_Ingest::VT_EXPECTEDLIFE, expectedLife, 0);
  }
  void add_insuredAtLaunch(bool insuredAtLaunch) {
    fbb_.AddElement<uint8_t>(SeradataSpacecraftDetails_Ingest::VT_INSUREDATLAUNCH, static_cast<uint8_t>(insuredAtLaunch), 0);
  }
  void add_launchMass(double launchMass) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_LAUNCHMASS, launchMass, 0.0);
  }
  void add_dryMass(double dryMass) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_DRYMASS, dryMass, 0.0);
  }
  void add_catalogNumber(int32_t catalogNumber) {
    fbb_.AddElement<int32_t>(SeradataSpacecraftDetails_Ingest::VT_CATALOGNUMBER, catalogNumber, 0);
  }
  void add_totalPayloadPower(double totalPayloadPower) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_TOTALPAYLOADPOWER, totalPayloadPower, 0.0);
  }
  void add_constellation(::flatbuffers::Offset<::flatbuffers::String> constellation) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_CONSTELLATION, constellation);
  }
  void add_orbitCategory(::flatbuffers::Offset<::flatbuffers::String> orbitCategory) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_ORBITCATEGORY, orbitCategory);
  }
  void add_orbitSubCategory(::flatbuffers::Offset<::flatbuffers::String> orbitSubCategory) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_ORBITSUBCATEGORY, orbitSubCategory);
  }
  void add_launchCost(double launchCost) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_LAUNCHCOST, launchCost, 0.0);
  }
  void add_launchCostEstimated(bool launchCostEstimated) {
    fbb_.AddElement<uint8_t>(SeradataSpacecraftDetails_Ingest::VT_LAUNCHCOSTESTIMATED, static_cast<uint8_t>(launchCostEstimated), 0);
  }
  void add_costEstimated(bool costEstimated) {
    fbb_.AddElement<uint8_t>(SeradataSpacecraftDetails_Ingest::VT_COSTESTIMATED, static_cast<uint8_t>(costEstimated), 0);
  }
  void add_newCost(double newCost) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_NEWCOST, newCost, 0.0);
  }
  void add_combinedNewCost(double combinedNewCost) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_COMBINEDNEWCOST, combinedNewCost, 0.0);
  }
  void add_combinedCostEstimated(bool combinedCostEstimated) {
    fbb_.AddElement<uint8_t>(SeradataSpacecraftDetails_Ingest::VT_COMBINEDCOSTESTIMATED, static_cast<uint8_t>(combinedCostEstimated), 0);
  }
  void add_insuredValueAtLaunch(double insuredValueAtLaunch) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_INSUREDVALUEATLAUNCH, insuredValueAtLaunch, 0.0);
  }
  void add_insuredValueLaunchEstimated(bool insuredValueLaunchEstimated) {
    fbb_.AddElement<uint8_t>(SeradataSpacecraftDetails_Ingest::VT_INSUREDVALUELAUNCHESTIMATED, static_cast<uint8_t>(insuredValueLaunchEstimated), 0);
  }
  void add_annualInsuredDepreciationFactor(double annualInsuredDepreciationFactor) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_ANNUALINSUREDDEPRECIATIONFACTOR, annualInsuredDepreciationFactor, 0.0);
  }
  void add_annualInsuredDepreciationFactorEstimated(bool annualInsuredDepreciationFactorEstimated) {
    fbb_.AddElement<uint8_t>(SeradataSpacecraftDetails_Ingest::VT_ANNUALINSUREDDEPRECIATIONFACTORESTIMATED, static_cast<uint8_t>(annualInsuredDepreciationFactorEstimated), 0);
  }
  void add_insurancePremiumAtLaunch(double insurancePremiumAtLaunch) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_INSURANCEPREMIUMATLAUNCH, insurancePremiumAtLaunch, 0.0);
  }
  void add_insurancePremiumAtLaunchEstimated(bool insurancePremiumAtLaunchEstimated) {
    fbb_.AddElement<uint8_t>(SeradataSpacecraftDetails_Ingest::VT_INSURANCEPREMIUMATLAUNCHESTIMATED, static_cast<uint8_t>(insurancePremiumAtLaunchEstimated), 0);
  }
  void add_numHumans(int32_t numHumans) {
    fbb_.AddElement<int32_t>(SeradataSpacecraftDetails_Ingest::VT_NUMHUMANS, numHumans, 0);
  }
  void add_cubesatDispenserType(::flatbuffers::Offset<::flatbuffers::String> cubesatDispenserType) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_CUBESATDISPENSERTYPE, cubesatDispenserType);
  }
  void add_massCategory(::flatbuffers::Offset<::flatbuffers::String> massCategory) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_MASSCATEGORY, massCategory);
  }
  void add_launchId(::flatbuffers::Offset<::flatbuffers::String> launchId) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_LAUNCHID, launchId);
  }
  void add_launchVehicleId(::flatbuffers::Offset<::flatbuffers::String> launchVehicleId) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_LAUNCHVEHICLEID, launchVehicleId);
  }
  void add_launchProviderFlightNumber(::flatbuffers::Offset<::flatbuffers::String> launchProviderFlightNumber) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_LAUNCHPROVIDERFLIGHTNUMBER, launchProviderFlightNumber);
  }
  void add_launchSiteName(::flatbuffers::Offset<::flatbuffers::String> launchSiteName) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_LAUNCHSITENAME, launchSiteName);
  }
  void add_launchSiteId(::flatbuffers::Offset<::flatbuffers::String> launchSiteId) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_LAUNCHSITEID, launchSiteId);
  }
  void add_launchCountry(::flatbuffers::Offset<::flatbuffers::String> launchCountry) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_LAUNCHCOUNTRY, launchCountry);
  }
  void add_launchProvider(::flatbuffers::Offset<::flatbuffers::String> launchProvider) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_LAUNCHPROVIDER, launchProvider);
  }
  void add_launchProviderCountry(::flatbuffers::Offset<::flatbuffers::String> launchProviderCountry) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_LAUNCHPROVIDERCOUNTRY, launchProviderCountry);
  }
  void add_commercialLaunch(bool commercialLaunch) {
    fbb_.AddElement<uint8_t>(SeradataSpacecraftDetails_Ingest::VT_COMMERCIALLAUNCH, static_cast<uint8_t>(commercialLaunch), 0);
  }
  void add_launchType(::flatbuffers::Offset<::flatbuffers::String> launchType) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_LAUNCHTYPE, launchType);
  }
  void add_launchCharacteristic(::flatbuffers::Offset<::flatbuffers::String> launchCharacteristic) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_LAUNCHCHARACTERISTIC, launchCharacteristic);
  }
  void add_launchNumber(::flatbuffers::Offset<::flatbuffers::String> launchNumber) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_LAUNCHNUMBER, launchNumber);
  }
  void add_launchDate(::flatbuffers::Offset<::flatbuffers::String> launchDate) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_LAUNCHDATE, launchDate);
  }
  void add_launchDateRemarks(::flatbuffers::Offset<::flatbuffers::String> launchDateRemarks) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_LAUNCHDATEREMARKS, launchDateRemarks);
  }
  void add_youtubeLaunchLink(::flatbuffers::Offset<::flatbuffers::String> youtubeLaunchLink) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_YOUTUBELAUNCHLINK, youtubeLaunchLink);
  }
  void add_status(::flatbuffers::Offset<::flatbuffers::String> status) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_STATUS, status);
  }
  void add_owner(::flatbuffers::Offset<::flatbuffers::String> owner) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_OWNER, owner);
  }
  void add_ownerCountry(::flatbuffers::Offset<::flatbuffers::String> ownerCountry) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_OWNERCOUNTRY, ownerCountry);
  }
  void add_operator_(::flatbuffers::Offset<::flatbuffers::String> operator_) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_OPERATOR_, operator_);
  }
  void add_operatorCountry(::flatbuffers::Offset<::flatbuffers::String> operatorCountry) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_OPERATORCOUNTRY, operatorCountry);
  }
  void add_leased(bool leased) {
    fbb_.AddElement<uint8_t>(SeradataSpacecraftDetails_Ingest::VT_LEASED, static_cast<uint8_t>(leased), 0);
  }
  void add_orderDate(::flatbuffers::Offset<::flatbuffers::String> orderDate) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_ORDERDATE, orderDate);
  }
  void add_capabilityLost(double capabilityLost) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_CAPABILITYLOST, capabilityLost, 0.0);
  }
  void add_capacityLost(double capacityLost) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_CAPACITYLOST, capacityLost, 0.0);
  }
  void add_primaryMissionGroup(::flatbuffers::Offset<::flatbuffers::String> primaryMissionGroup) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_PRIMARYMISSIONGROUP, primaryMissionGroup);
  }
  void add_additionalMissionsGroups(::flatbuffers::Offset<::flatbuffers::String> additionalMissionsGroups) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_ADDITIONALMISSIONSGROUPS, additionalMissionsGroups);
  }
  void add_totalClaims(int32_t totalClaims) {
    fbb_.AddElement<int32_t>(SeradataSpacecraftDetails_Ingest::VT_TOTALCLAIMS, totalClaims, 0);
  }
  void add_totalInjuries(int32_t totalInjuries) {
    fbb_.AddElement<int32_t>(SeradataSpacecraftDetails_Ingest::VT_TOTALINJURIES, totalInjuries, 0);
  }
  void add_totalFatalities(int32_t totalFatalities) {
    fbb_.AddElement<int32_t>(SeradataSpacecraftDetails_Ingest::VT_TOTALFATALITIES, totalFatalities, 0);
  }
  void add_nameAtLaunch(::flatbuffers::Offset<::flatbuffers::String> nameAtLaunch) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_NAMEATLAUNCH, nameAtLaunch);
  }
  void add_busId(::flatbuffers::Offset<::flatbuffers::String> busId) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_BUSID, busId);
  }
  void add_currentAge(double currentAge) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_CURRENTAGE, currentAge, 0.0);
  }
  void add_lifeLost(double lifeLost) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_LIFELOST, lifeLost, 0.0);
  }
  void add_geoPosition(double geoPosition) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_GEOPOSITION, geoPosition, 0.0);
  }
  void add_insuranceLossesTotal(double insuranceLossesTotal) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_INSURANCELOSSESTOTAL, insuranceLossesTotal, 0.0);
  }
  void add_launchArranger(::flatbuffers::Offset<::flatbuffers::String> launchArranger) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_LAUNCHARRANGER, launchArranger);
  }
  void add_launchArrangerCountry(::flatbuffers::Offset<::flatbuffers::String> launchArrangerCountry) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_LAUNCHARRANGERCOUNTRY, launchArrangerCountry);
  }
  void add_serialNumber(::flatbuffers::Offset<::flatbuffers::String> serialNumber) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_SERIALNUMBER, serialNumber);
  }
  void add_programName(::flatbuffers::Offset<::flatbuffers::String> programName) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_PROGRAMNAME, programName);
  }
  void add_reusedHullName(::flatbuffers::Offset<::flatbuffers::String> reusedHullName) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_REUSEDHULLNAME, reusedHullName);
  }
  void add_dateOfObservation(::flatbuffers::Offset<::flatbuffers::String> dateOfObservation) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_DATEOFOBSERVATION, dateOfObservation);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_LON, lon, 0.0);
  }
  void add_altitude(double altitude) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_ALTITUDE, altitude, 0.0);
  }
  void add_collisionRiskMM(double collisionRiskMM) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_COLLISIONRISKMM, collisionRiskMM, 0.0);
  }
  void add_collisionRiskCM(double collisionRiskCM) {
    fbb_.AddElement<double>(SeradataSpacecraftDetails_Ingest::VT_COLLISIONRISKCM, collisionRiskCM, 0.0);
  }
  void add_quantity(int32_t quantity) {
    fbb_.AddElement<int32_t>(SeradataSpacecraftDetails_Ingest::VT_QUANTITY, quantity, 0);
  }
  void add_reusableFlights(::flatbuffers::Offset<::flatbuffers::String> reusableFlights) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_REUSABLEFLIGHTS, reusableFlights);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_NOTES, notes);
  }
  void add_insuranceNotes(::flatbuffers::Offset<::flatbuffers::String> insuranceNotes) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_INSURANCENOTES, insuranceNotes);
  }
  void add_launchNotes(::flatbuffers::Offset<::flatbuffers::String> launchNotes) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_LAUNCHNOTES, launchNotes);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(SeradataSpacecraftDetails_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SeradataSpacecraftDetails_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SeradataSpacecraftDetails_Ingest::VT_CREATEDBY, createdBy);
  }
  explicit SeradataSpacecraftDetails_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SeradataSpacecraftDetails_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SeradataSpacecraftDetails_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SeradataSpacecraftDetails_Ingest> CreateSeradataSpacecraftDetails_Ingest(
    ...
    SeradataSpacecraftDetails_Ingest_dataMode_Enum dataMode = SeradataSpacecraftDetails_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0) {
  SeradataSpacecraftDetails_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SeradataSpacecraftDetails_Ingest> CreateSeradataSpacecraftDetails_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateSeradataSpacecraftDetails_Ingest(
      _fbb,
      id__,
      idOnOrbit__,
...
inline const SeradataSpacecraftDetails_Ingest *GetSeradataSpacecraftDetails_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<SeradataSpacecraftDetails_Ingest>(buf);
}

inline const SeradataSpacecraftDetails_Ingest *GetSizePrefixedSeradataSpacecraftDetails_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SeradataSpacecraftDetails_Ingest>(buf);
}

inline const char *SeradataSpacecraftDetails_IngestIdentifier() {
  return "SERA";
}

inline bool SeradataSpacecraftDetails_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataSpacecraftDetails_IngestIdentifier());
}

inline bool SizePrefixedSeradataSpacecraftDetails_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataSpacecraftDetails_IngestIdentifier(), true);
}

inline bool VerifySeradataSpacecraftDetails_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SeradataSpacecraftDetails_Ingest>(SeradataSpacecraftDetails_IngestIdentifier());
}

inline bool VerifySizePrefixedSeradataSpacecraftDetails_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SeradataSpacecraftDetails_Ingest>(SeradataSpacecraftDetails_IngestIdentifier());
}

inline void FinishSeradataSpacecraftDetails_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataSpacecraftDetails_Ingest> root) {
  fbb.Finish(root, SeradataSpacecraftDetails_IngestIdentifier());
}

inline void FinishSizePrefixedSeradataSpacecraftDetails_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataSpacecraftDetails_Ingest> root) {
  fbb.FinishSizePrefixed(root, SeradataSpacecraftDetails_IngestIdentifier());
}
