...
struct DataLinkMultiDutyVoiceCoord_Ingest;
struct DataLinkMultiDutyVoiceCoord_IngestBuilder;
...
struct DataLinkMultiDutyVoiceCoord_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef DataLinkMultiDutyVoiceCoord_IngestBuilder Builder;
...
struct DataLinkMultiDutyVoiceCoord_IngestBuilder {
  typedef DataLinkMultiDutyVoiceCoord_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_multiVoiceNetDes(::flatbuffers::Offset<::flatbuffers::String> multiVoiceNetDes) {
    fbb_.AddOffset(DataLinkMultiDutyVoiceCoord_Ingest::VT_MULTIVOICENETDES, multiVoiceNetDes);
  }
  void add_multiFreqDes(::flatbuffers::Offset<::flatbuffers::String> multiFreqDes) {
    fbb_.AddOffset(DataLinkMultiDutyVoiceCoord_Ingest::VT_MULTIFREQDES, multiFreqDes);
  }
  void add_multiCommPri(::flatbuffers::Offset<::flatbuffers::String> multiCommPri) {
    fbb_.AddOffset(DataLinkMultiDutyVoiceCoord_Ingest::VT_MULTICOMMPRI, multiCommPri);
  }
  void add_multiTeleFreqNums(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> multiTeleFreqNums) {
    fbb_.AddOffset(DataLinkMultiDutyVoiceCoord_Ingest::VT_MULTITELEFREQNUMS, multiTeleFreqNums);
  }
  explicit DataLinkMultiDutyVoiceCoord_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<DataLinkMultiDutyVoiceCoord_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<DataLinkMultiDutyVoiceCoord_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<DataLinkMultiDutyVoiceCoord_Ingest> CreateDataLinkMultiDutyVoiceCoord_Ingest(
  ...
  DataLinkMultiDutyVoiceCoord_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<DataLinkMultiDutyVoiceCoord_Ingest> CreateDataLinkMultiDutyVoiceCoord_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const DataLinkMultiDutyVoiceCoord_Ingest *GetDataLinkMultiDutyVoiceCoord_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<DataLinkMultiDutyVoiceCoord_Ingest>(buf);
}

inline const DataLinkMultiDutyVoiceCoord_Ingest *GetSizePrefixedDataLinkMultiDutyVoiceCoord_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<DataLinkMultiDutyVoiceCoord_Ingest>(buf);
}

inline const char *DataLinkMultiDutyVoiceCoord_IngestIdentifier() {
  return "DATA";
}

inline bool DataLinkMultiDutyVoiceCoord_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLinkMultiDutyVoiceCoord_IngestIdentifier());
}

inline bool SizePrefixedDataLinkMultiDutyVoiceCoord_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLinkMultiDutyVoiceCoord_IngestIdentifier(), true);
}

inline bool VerifyDataLinkMultiDutyVoiceCoord_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<DataLinkMultiDutyVoiceCoord_Ingest>(DataLinkMultiDutyVoiceCoord_IngestIdentifier());
}

inline bool VerifySizePrefixedDataLinkMultiDutyVoiceCoord_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<DataLinkMultiDutyVoiceCoord_Ingest>(DataLinkMultiDutyVoiceCoord_IngestIdentifier());
}

inline void FinishDataLinkMultiDutyVoiceCoord_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLinkMultiDutyVoiceCoord_Ingest> root) {
  fbb.Finish(root, DataLinkMultiDutyVoiceCoord_IngestIdentifier());
}

inline void FinishSizePrefixedDataLinkMultiDutyVoiceCoord_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLinkMultiDutyVoiceCoord_Ingest> root) {
  fbb.FinishSizePrefixed(root, DataLinkMultiDutyVoiceCoord_IngestIdentifier());
}
