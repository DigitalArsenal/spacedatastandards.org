...
struct DataLinkReferences_Abridged;
...
struct DataLinkReferences_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef DataLinkReferences_AbridgedBuilder Builder;
...
struct DataLinkReferences_AbridgedBuilder {
  typedef DataLinkReferences_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_refSerialId(::flatbuffers::Offset<::flatbuffers::String> refSerialId) {
    fbb_.AddOffset(DataLinkReferences_Abridged::VT_REFSERIALID, refSerialId);
  }
  void add_refType(::flatbuffers::Offset<::flatbuffers::String> refType) {
    fbb_.AddOffset(DataLinkReferences_Abridged::VT_REFTYPE, refType);
  }
  void add_refOriginator(::flatbuffers::Offset<::flatbuffers::String> refOriginator) {
    fbb_.AddOffset(DataLinkReferences_Abridged::VT_REFORIGINATOR, refOriginator);
  }
  void add_refTs(::flatbuffers::Offset<::flatbuffers::String> refTs) {
    fbb_.AddOffset(DataLinkReferences_Abridged::VT_REFTS, refTs);
  }
  void add_refSerialNum(::flatbuffers::Offset<::flatbuffers::String> refSerialNum) {
    fbb_.AddOffset(DataLinkReferences_Abridged::VT_REFSERIALNUM, refSerialNum);
  }
  void add_refSpecialNotation(::flatbuffers::Offset<::flatbuffers::String> refSpecialNotation) {
    fbb_.AddOffset(DataLinkReferences_Abridged::VT_REFSPECIALNOTATION, refSpecialNotation);
  }
  void add_refSICs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> refSICs) {
    fbb_.AddOffset(DataLinkReferences_Abridged::VT_REFSICS, refSICs);
  }
  explicit DataLinkReferences_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<DataLinkReferences_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<DataLinkReferences_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<DataLinkReferences_Abridged> CreateDataLinkReferences_Abridged(
  ...
  DataLinkReferences_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<DataLinkReferences_Abridged> CreateDataLinkReferences_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const DataLinkReferences_Abridged *GetDataLinkReferences_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<DataLinkReferences_Abridged>(buf);
}

inline const DataLinkReferences_Abridged *GetSizePrefixedDataLinkReferences_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<DataLinkReferences_Abridged>(buf);
}

inline const char *DataLinkReferences_AbridgedIdentifier() {
  return "DATA";
}

inline bool DataLinkReferences_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLinkReferences_AbridgedIdentifier());
}

inline bool SizePrefixedDataLinkReferences_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLinkReferences_AbridgedIdentifier(), true);
}

inline bool VerifyDataLinkReferences_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<DataLinkReferences_Abridged>(DataLinkReferences_AbridgedIdentifier());
}

inline bool VerifySizePrefixedDataLinkReferences_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<DataLinkReferences_Abridged>(DataLinkReferences_AbridgedIdentifier());
}

inline void FinishDataLinkReferences_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLinkReferences_Abridged> root) {
  fbb.Finish(root, DataLinkReferences_AbridgedIdentifier());
}

inline void FinishSizePrefixedDataLinkReferences_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLinkReferences_Abridged> root) {
  fbb.FinishSizePrefixed(root, DataLinkReferences_AbridgedIdentifier());
}
