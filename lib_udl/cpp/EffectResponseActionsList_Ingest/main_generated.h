...
struct EffectResponseActionsList_Ingest;
struct EffectResponseActionsList_IngestBuilder;

/// /// List of actions associated with this effect response.
struct EffectResponseActionsList_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EffectResponseActionsList_IngestBuilder Builder;
...
struct EffectResponseActionsList_IngestBuilder {
  typedef EffectResponseActionsList_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_summary(::flatbuffers::Offset<::flatbuffers::String> summary) {
    fbb_.AddOffset(EffectResponseActionsList_Ingest::VT_SUMMARY, summary);
  }
  void add_actionId(::flatbuffers::Offset<::flatbuffers::String> actionId) {
    fbb_.AddOffset(EffectResponseActionsList_Ingest::VT_ACTIONID, actionId);
  }
  void add_actionStartTime(::flatbuffers::Offset<::flatbuffers::String> actionStartTime) {
    fbb_.AddOffset(EffectResponseActionsList_Ingest::VT_ACTIONSTARTTIME, actionStartTime);
  }
  void add_actionEndTime(::flatbuffers::Offset<::flatbuffers::String> actionEndTime) {
    fbb_.AddOffset(EffectResponseActionsList_Ingest::VT_ACTIONENDTIME, actionEndTime);
  }
  void add_totStartTime(::flatbuffers::Offset<::flatbuffers::String> totStartTime) {
    fbb_.AddOffset(EffectResponseActionsList_Ingest::VT_TOTSTARTTIME, totStartTime);
  }
  void add_totEndTime(::flatbuffers::Offset<::flatbuffers::String> totEndTime) {
    fbb_.AddOffset(EffectResponseActionsList_Ingest::VT_TOTENDTIME, totEndTime);
  }
  void add_actionActorSrcType(::flatbuffers::Offset<::flatbuffers::String> actionActorSrcType) {
    fbb_.AddOffset(EffectResponseActionsList_Ingest::VT_ACTIONACTORSRCTYPE, actionActorSrcType);
  }
  void add_actionActorSrcId(::flatbuffers::Offset<::flatbuffers::String> actionActorSrcId) {
    fbb_.AddOffset(EffectResponseActionsList_Ingest::VT_ACTIONACTORSRCID, actionActorSrcId);
  }
  void add_effector(::flatbuffers::Offset<::flatbuffers::String> effector) {
    fbb_.AddOffset(EffectResponseActionsList_Ingest::VT_EFFECTOR, effector);
  }
  void add_targetSrcType(::flatbuffers::Offset<::flatbuffers::String> targetSrcType) {
    fbb_.AddOffset(EffectResponseActionsList_Ingest::VT_TARGETSRCTYPE, targetSrcType);
  }
  void add_targetSrcId(::flatbuffers::Offset<::flatbuffers::String> targetSrcId) {
    fbb_.AddOffset(EffectResponseActionsList_Ingest::VT_TARGETSRCID, targetSrcId);
  }
  void add_actorInterceptLat(double actorInterceptLat) {
    fbb_.AddElement<double>(EffectResponseActionsList_Ingest::VT_ACTORINTERCEPTLAT, actorInterceptLat, 0.0);
  }
  void add_actorInterceptLon(double actorInterceptLon) {
    fbb_.AddElement<double>(EffectResponseActionsList_Ingest::VT_ACTORINTERCEPTLON, actorInterceptLon, 0.0);
  }
  void add_actorInterceptAlt(double actorInterceptAlt) {
    fbb_.AddElement<double>(EffectResponseActionsList_Ingest::VT_ACTORINTERCEPTALT, actorInterceptAlt, 0.0);
  }
  void add_weaponInterceptLat(double weaponInterceptLat) {
    fbb_.AddElement<double>(EffectResponseActionsList_Ingest::VT_WEAPONINTERCEPTLAT, weaponInterceptLat, 0.0);
  }
  void add_weaponInterceptLon(double weaponInterceptLon) {
    fbb_.AddElement<double>(EffectResponseActionsList_Ingest::VT_WEAPONINTERCEPTLON, weaponInterceptLon, 0.0);
  }
  void add_weaponInterceptAlt(double weaponInterceptAlt) {
    fbb_.AddElement<double>(EffectResponseActionsList_Ingest::VT_WEAPONINTERCEPTALT, weaponInterceptAlt, 0.0);
  }
  void add_actionMetrics(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> actionMetrics) {
    fbb_.AddOffset(EffectResponseActionsList_Ingest::VT_ACTIONMETRICS, actionMetrics);
  }
  explicit EffectResponseActionsList_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<EffectResponseActionsList_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<EffectResponseActionsList_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<EffectResponseActionsList_Ingest> CreateEffectResponseActionsList_Ingest(
  ...
  EffectResponseActionsList_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<EffectResponseActionsList_Ingest> CreateEffectResponseActionsList_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const EffectResponseActionsList_Ingest *GetEffectResponseActionsList_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<EffectResponseActionsList_Ingest>(buf);
}

inline const EffectResponseActionsList_Ingest *GetSizePrefixedEffectResponseActionsList_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EffectResponseActionsList_Ingest>(buf);
}

inline const char *EffectResponseActionsList_IngestIdentifier() {
  return "EFFE";
}

inline bool EffectResponseActionsList_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EffectResponseActionsList_IngestIdentifier());
}

inline bool SizePrefixedEffectResponseActionsList_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EffectResponseActionsList_IngestIdentifier(), true);
}

inline bool VerifyEffectResponseActionsList_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EffectResponseActionsList_Ingest>(EffectResponseActionsList_IngestIdentifier());
}

inline bool VerifySizePrefixedEffectResponseActionsList_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EffectResponseActionsList_Ingest>(EffectResponseActionsList_IngestIdentifier());
}

inline void FinishEffectResponseActionsList_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EffectResponseActionsList_Ingest> root) {
  fbb.Finish(root, EffectResponseActionsList_IngestIdentifier());
}

inline void FinishSizePrefixedEffectResponseActionsList_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EffectResponseActionsList_Ingest> root) {
  fbb.FinishSizePrefixed(root, EffectResponseActionsList_IngestIdentifier());
}
