...
struct AirspaceControlOrderReference_Ingest;
struct AirspaceControlOrderReference_IngestBuilder;

/// /// The airspaceControlReferences set provides both USMTF and non-USMTF references for this airspace control order.
struct AirspaceControlOrderReference_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirspaceControlOrderReference_IngestBuilder Builder;
...
struct AirspaceControlOrderReference_IngestBuilder {
  typedef AirspaceControlOrderReference_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_refSId(::flatbuffers::Offset<::flatbuffers::String> refSId) {
    fbb_.AddOffset(AirspaceControlOrderReference_Ingest::VT_REFSID, refSId);
  }
  void add_refType(::flatbuffers::Offset<::flatbuffers::String> refType) {
    fbb_.AddOffset(AirspaceControlOrderReference_Ingest::VT_REFTYPE, refType);
  }
  void add_refOriginator(::flatbuffers::Offset<::flatbuffers::String> refOriginator) {
    fbb_.AddOffset(AirspaceControlOrderReference_Ingest::VT_REFORIGINATOR, refOriginator);
  }
  void add_refTs(::flatbuffers::Offset<::flatbuffers::String> refTs) {
    fbb_.AddOffset(AirspaceControlOrderReference_Ingest::VT_REFTS, refTs);
  }
  void add_refSerialNum(::flatbuffers::Offset<::flatbuffers::String> refSerialNum) {
    fbb_.AddOffset(AirspaceControlOrderReference_Ingest::VT_REFSERIALNUM, refSerialNum);
  }
  void add_refSpecialNotation(::flatbuffers::Offset<::flatbuffers::String> refSpecialNotation) {
    fbb_.AddOffset(AirspaceControlOrderReference_Ingest::VT_REFSPECIALNOTATION, refSpecialNotation);
  }
  void add_refSICs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> refSICs) {
    fbb_.AddOffset(AirspaceControlOrderReference_Ingest::VT_REFSICS, refSICs);
  }
  explicit AirspaceControlOrderReference_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirspaceControlOrderReference_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirspaceControlOrderReference_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirspaceControlOrderReference_Ingest> CreateAirspaceControlOrderReference_Ingest(
  ...
  AirspaceControlOrderReference_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirspaceControlOrderReference_Ingest> CreateAirspaceControlOrderReference_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AirspaceControlOrderReference_Ingest *GetAirspaceControlOrderReference_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<AirspaceControlOrderReference_Ingest>(buf);
}

inline const AirspaceControlOrderReference_Ingest *GetSizePrefixedAirspaceControlOrderReference_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirspaceControlOrderReference_Ingest>(buf);
}

inline const char *AirspaceControlOrderReference_IngestIdentifier() {
  return "AIRS";
}

inline bool AirspaceControlOrderReference_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirspaceControlOrderReference_IngestIdentifier());
}

inline bool SizePrefixedAirspaceControlOrderReference_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirspaceControlOrderReference_IngestIdentifier(), true);
}

inline bool VerifyAirspaceControlOrderReference_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirspaceControlOrderReference_Ingest>(AirspaceControlOrderReference_IngestIdentifier());
}

inline bool VerifySizePrefixedAirspaceControlOrderReference_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirspaceControlOrderReference_Ingest>(AirspaceControlOrderReference_IngestIdentifier());
}

inline void FinishAirspaceControlOrderReference_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirspaceControlOrderReference_Ingest> root) {
  fbb.Finish(root, AirspaceControlOrderReference_IngestIdentifier());
}

inline void FinishSizePrefixedAirspaceControlOrderReference_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirspaceControlOrderReference_Ingest> root) {
  fbb.FinishSizePrefixed(root, AirspaceControlOrderReference_IngestIdentifier());
}
