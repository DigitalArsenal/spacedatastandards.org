...
enum AIS_Ingest_dataMode_Enum : int8_t {
  ...
  AIS_Ingest_dataMode_Enum_MIN = AIS_Ingest_dataMode_Enum_REAL,
  AIS_Ingest_dataMode_Enum_MAX = AIS_Ingest_dataMode_Enum_EXERCISE
};

inline const AIS_Ingest_dataMode_Enum (&EnumValuesAIS_Ingest_dataMode_Enum())[4] {
  static const AIS_Ingest_dataMode_Enum values[] = {
    AIS_Ingest_dataMode_Enum_REAL,
    AIS_Ingest_dataMode_Enum_TEST,
    AIS_Ingest_dataMode_Enum_SIMULATED,
    AIS_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAIS_Ingest_dataMode_Enum() {
...
inline const char *EnumNameAIS_Ingest_dataMode_Enum(AIS_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AIS_Ingest_dataMode_Enum_REAL, AIS_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAIS_Ingest_dataMode_Enum()[index];
}
...
struct AIS_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AIS_IngestBuilder Builder;
  ...
  AIS_Ingest_dataMode_Enum dataMode() const {
    return static_cast<AIS_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AIS_IngestBuilder {
  typedef AIS_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AIS_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AIS_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idTrack(::flatbuffers::Offset<::flatbuffers::String> idTrack) {
    fbb_.AddOffset(AIS_Ingest::VT_IDTRACK, idTrack);
  }
  void add_idVessel(::flatbuffers::Offset<::flatbuffers::String> idVessel) {
    fbb_.AddOffset(AIS_Ingest::VT_IDVESSEL, idVessel);
  }
  void add_mmsi(int64_t mmsi) {
    fbb_.AddElement<int64_t>(AIS_Ingest::VT_MMSI, mmsi, 0);
  }
  void add_imon(int64_t imon) {
    fbb_.AddElement<int64_t>(AIS_Ingest::VT_IMON, imon, 0);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::String> ts) {
    fbb_.AddOffset(AIS_Ingest::VT_TS, ts);
  }
  void add_shipName(::flatbuffers::Offset<::flatbuffers::String> shipName) {
    fbb_.AddOffset(AIS_Ingest::VT_SHIPNAME, shipName);
  }
  void add_shipType(::flatbuffers::Offset<::flatbuffers::String> shipType) {
    fbb_.AddOffset(AIS_Ingest::VT_SHIPTYPE, shipType);
  }
  void add_engagedIn(::flatbuffers::Offset<::flatbuffers::String> engagedIn) {
    fbb_.AddOffset(AIS_Ingest::VT_ENGAGEDIN, engagedIn);
  }
  void add_specialCraft(::flatbuffers::Offset<::flatbuffers::String> specialCraft) {
    fbb_.AddOffset(AIS_Ingest::VT_SPECIALCRAFT, specialCraft);
  }
  void add_cargoType(::flatbuffers::Offset<::flatbuffers::String> cargoType) {
    fbb_.AddOffset(AIS_Ingest::VT_CARGOTYPE, cargoType);
  }
  void add_callSign(::flatbuffers::Offset<::flatbuffers::String> callSign) {
    fbb_.AddOffset(AIS_Ingest::VT_CALLSIGN, callSign);
  }
  void add_vesselFlag(::flatbuffers::Offset<::flatbuffers::String> vesselFlag) {
    fbb_.AddOffset(AIS_Ingest::VT_VESSELFLAG, vesselFlag);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(AIS_Ingest::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(AIS_Ingest::VT_LON, lon, 0.0);
  }
  void add_posHiAccuracy(bool posHiAccuracy) {
    fbb_.AddElement<uint8_t>(AIS_Ingest::VT_POSHIACCURACY, static_cast<uint8_t>(posHiAccuracy), 0);
  }
  void add_posHiLatency(bool posHiLatency) {
    fbb_.AddElement<uint8_t>(AIS_Ingest::VT_POSHILATENCY, static_cast<uint8_t>(posHiLatency), 0);
  }
  void add_speed(double speed) {
    fbb_.AddElement<double>(AIS_Ingest::VT_SPEED, speed, 0.0);
  }
  void add_trueHeading(double trueHeading) {
    fbb_.AddElement<double>(AIS_Ingest::VT_TRUEHEADING, trueHeading, 0.0);
  }
  void add_course(double course) {
    fbb_.AddElement<double>(AIS_Ingest::VT_COURSE, course, 0.0);
  }
  void add_rateOfTurn(double rateOfTurn) {
    fbb_.AddElement<double>(AIS_Ingest::VT_RATEOFTURN, rateOfTurn, 0.0);
  }
  void add_specialManeuver(bool specialManeuver) {
    fbb_.AddElement<uint8_t>(AIS_Ingest::VT_SPECIALMANEUVER, static_cast<uint8_t>(specialManeuver), 0);
  }
  void add_navStatus(::flatbuffers::Offset<::flatbuffers::String> navStatus) {
    fbb_.AddOffset(AIS_Ingest::VT_NAVSTATUS, navStatus);
  }
  void add_posDeviceType(::flatbuffers::Offset<::flatbuffers::String> posDeviceType) {
    fbb_.AddOffset(AIS_Ingest::VT_POSDEVICETYPE, posDeviceType);
  }
  void add_antennaRefDimensions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> antennaRefDimensions) {
    fbb_.AddOffset(AIS_Ingest::VT_ANTENNAREFDIMENSIONS, antennaRefDimensions);
  }
  void add_length(double length) {
    fbb_.AddElement<double>(AIS_Ingest::VT_LENGTH, length, 0.0);
  }
  void add_width(double width) {
    fbb_.AddElement<double>(AIS_Ingest::VT_WIDTH, width, 0.0);
  }
  void add_draught(double draught) {
    fbb_.AddElement<double>(AIS_Ingest::VT_DRAUGHT, draught, 0.0);
  }
  void add_shipDescription(::flatbuffers::Offset<::flatbuffers::String> shipDescription) {
    fbb_.AddOffset(AIS_Ingest::VT_SHIPDESCRIPTION, shipDescription);
  }
  void add_destination(::flatbuffers::Offset<::flatbuffers::String> destination) {
    fbb_.AddOffset(AIS_Ingest::VT_DESTINATION, destination);
  }
  void add_destinationETA(::flatbuffers::Offset<::flatbuffers::String> destinationETA) {
    fbb_.AddOffset(AIS_Ingest::VT_DESTINATIONETA, destinationETA);
  }
  void add_currentPortGUID(::flatbuffers::Offset<::flatbuffers::String> currentPortGUID) {
    fbb_.AddOffset(AIS_Ingest::VT_CURRENTPORTGUID, currentPortGUID);
  }
  void add_currentPortLOCODE(::flatbuffers::Offset<::flatbuffers::String> currentPortLOCODE) {
    fbb_.AddOffset(AIS_Ingest::VT_CURRENTPORTLOCODE, currentPortLOCODE);
  }
  void add_lastPortGUID(::flatbuffers::Offset<::flatbuffers::String> lastPortGUID) {
    fbb_.AddOffset(AIS_Ingest::VT_LASTPORTGUID, lastPortGUID);
  }
  void add_lastPortLOCODE(::flatbuffers::Offset<::flatbuffers::String> lastPortLOCODE) {
    fbb_.AddOffset(AIS_Ingest::VT_LASTPORTLOCODE, lastPortLOCODE);
  }
  void add_nextPortGUID(::flatbuffers::Offset<::flatbuffers::String> nextPortGUID) {
    fbb_.AddOffset(AIS_Ingest::VT_NEXTPORTGUID, nextPortGUID);
  }
  void add_nextPortLOCODE(::flatbuffers::Offset<::flatbuffers::String> nextPortLOCODE) {
    fbb_.AddOffset(AIS_Ingest::VT_NEXTPORTLOCODE, nextPortLOCODE);
  }
  void add_etaCalculated(::flatbuffers::Offset<::flatbuffers::String> etaCalculated) {
    fbb_.AddOffset(AIS_Ingest::VT_ETACALCULATED, etaCalculated);
  }
  void add_etaUpdated(::flatbuffers::Offset<::flatbuffers::String> etaUpdated) {
    fbb_.AddOffset(AIS_Ingest::VT_ETAUPDATED, etaUpdated);
  }
  void add_distanceToGo(double distanceToGo) {
    fbb_.AddElement<double>(AIS_Ingest::VT_DISTANCETOGO, distanceToGo, 0.0);
  }
  void add_distanceTravelled(double distanceTravelled) {
    fbb_.AddElement<double>(AIS_Ingest::VT_DISTANCETRAVELLED, distanceTravelled, 0.0);
  }
  void add_avgSpeed(double avgSpeed) {
    fbb_.AddElement<double>(AIS_Ingest::VT_AVGSPEED, avgSpeed, 0.0);
  }
  void add_maxSpeed(double maxSpeed) {
    fbb_.AddElement<double>(AIS_Ingest::VT_MAXSPEED, maxSpeed, 0.0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AIS_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AIS_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AIS_Ingest::VT_SOURCE, source);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(AIS_Ingest::VT_SOURCEDL, sourceDL);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AIS_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(AIS_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AIS_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AIS_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  explicit AIS_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AIS_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AIS_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AIS_Ingest> CreateAIS_Ingest(
    ...
    AIS_Ingest_dataMode_Enum dataMode = AIS_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  AIS_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AIS_Ingest> CreateAIS_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AIS_Ingest *GetAIS_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<AIS_Ingest>(buf);
}

inline const AIS_Ingest *GetSizePrefixedAIS_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AIS_Ingest>(buf);
}

inline const char *AIS_IngestIdentifier() {
  return "AISI";
}

inline bool AIS_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AIS_IngestIdentifier());
}

inline bool SizePrefixedAIS_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AIS_IngestIdentifier(), true);
}

inline bool VerifyAIS_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AIS_Ingest>(AIS_IngestIdentifier());
}

inline bool VerifySizePrefixedAIS_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AIS_Ingest>(AIS_IngestIdentifier());
}

inline void FinishAIS_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AIS_Ingest> root) {
  fbb.Finish(root, AIS_IngestIdentifier());
}

inline void FinishSizePrefixedAIS_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AIS_Ingest> root) {
  fbb.FinishSizePrefixed(root, AIS_IngestIdentifier());
}
