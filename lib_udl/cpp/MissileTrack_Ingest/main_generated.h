...
struct MissileTrack_Ingest;
struct MissileTrack_IngestBuilder;

enum MissileTrack_Ingest_env_Enum : int8_t {
  /// Between sea level and the Kármán line, which has an altitude of 100 kilometers (62 miles).
  MissileTrack_Ingest_env_Enum_AIR = 0,
  /// On the surface of dry land.
  MissileTrack_Ingest_env_Enum_LAND = 1,
  /// Above the Kármán line, which has an altitude of 100 kilometers (62 miles).
  MissileTrack_Ingest_env_Enum_SPACE = 2,
  /// On the surface of a body of water.
  MissileTrack_Ingest_env_Enum_SURFACE = 3,
  /// Below the surface of a body of water.
  MissileTrack_Ingest_env_Enum_SUBSURFACE = 4,
  /// Environment is not known.
  MissileTrack_Ingest_env_Enum_UNKNOWN = 5,
  MissileTrack_Ingest_env_Enum_MIN = MissileTrack_Ingest_env_Enum_AIR,
  MissileTrack_Ingest_env_Enum_MAX = MissileTrack_Ingest_env_Enum_UNKNOWN
};

inline const MissileTrack_Ingest_env_Enum (&EnumValuesMissileTrack_Ingest_env_Enum())[6] {
  static const MissileTrack_Ingest_env_Enum values[] = {
    MissileTrack_Ingest_env_Enum_AIR,
    MissileTrack_Ingest_env_Enum_LAND,
    MissileTrack_Ingest_env_Enum_SPACE,
    MissileTrack_Ingest_env_Enum_SURFACE,
    MissileTrack_Ingest_env_Enum_SUBSURFACE,
    MissileTrack_Ingest_env_Enum_UNKNOWN
  };
  return values;
}

inline const char * const *EnumNamesMissileTrack_Ingest_env_Enum() {
...
inline const char *EnumNameMissileTrack_Ingest_env_Enum(MissileTrack_Ingest_env_Enum e) {
  if (::flatbuffers::IsOutRange(e, MissileTrack_Ingest_env_Enum_AIR, MissileTrack_Ingest_env_Enum_UNKNOWN)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesMissileTrack_Ingest_env_Enum()[index];
}

enum MissileTrack_Ingest_objIdent_Enum : int8_t {
  /// Track assumed to be a friend due to the object characteristics, behavior, and/or origin.
  MissileTrack_Ingest_objIdent_Enum_ASSUMED_FRIEND = 0,
  /// Track object supporting friendly forces and belonging to a declared friendly nation or entity.
  MissileTrack_Ingest_objIdent_Enum_FRIEND = 1,
  ...
  MissileTrack_Ingest_objIdent_Enum_HOSTILE = 2,
  ...
  MissileTrack_Ingest_objIdent_Enum_NEUTRAL = 3,
  /// Track object which has not been evaluated.
  MissileTrack_Ingest_objIdent_Enum_PENDING = 4,
  /// Track object deemed potentially hostile due to the object characteristics, behavior, nationality, and/or origin.
  MissileTrack_Ingest_objIdent_Enum_SUSPECT = 5,
  /// Track object which has been evaluated and does not meet criteria for any standard identity.
  MissileTrack_Ingest_objIdent_Enum_UNKNOWN = 6,
  MissileTrack_Ingest_objIdent_Enum_MIN = MissileTrack_Ingest_objIdent_Enum_ASSUMED_FRIEND,
  MissileTrack_Ingest_objIdent_Enum_MAX = MissileTrack_Ingest_objIdent_Enum_UNKNOWN
};

inline const MissileTrack_Ingest_objIdent_Enum (&EnumValuesMissileTrack_Ingest_objIdent_Enum())[7] {
  static const MissileTrack_Ingest_objIdent_Enum values[] = {
    MissileTrack_Ingest_objIdent_Enum_ASSUMED_FRIEND,
    MissileTrack_Ingest_objIdent_Enum_FRIEND,
    MissileTrack_Ingest_objIdent_Enum_HOSTILE,
    MissileTrack_Ingest_objIdent_Enum_NEUTRAL,
    MissileTrack_Ingest_objIdent_Enum_PENDING,
    MissileTrack_Ingest_objIdent_Enum_SUSPECT,
    MissileTrack_Ingest_objIdent_Enum_UNKNOWN
  };
  return values;
}

inline const char * const *EnumNamesMissileTrack_Ingest_objIdent_Enum() {
...
inline const char *EnumNameMissileTrack_Ingest_objIdent_Enum(MissileTrack_Ingest_objIdent_Enum e) {
  if (::flatbuffers::IsOutRange(e, MissileTrack_Ingest_objIdent_Enum_ASSUMED_FRIEND, MissileTrack_Ingest_objIdent_Enum_UNKNOWN)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesMissileTrack_Ingest_objIdent_Enum()[index];
}

enum MissileTrack_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  MissileTrack_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  MissileTrack_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  MissileTrack_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  MissileTrack_Ingest_dataMode_Enum_EXERCISE = 3,
  MissileTrack_Ingest_dataMode_Enum_MIN = MissileTrack_Ingest_dataMode_Enum_REAL,
  MissileTrack_Ingest_dataMode_Enum_MAX = MissileTrack_Ingest_dataMode_Enum_EXERCISE
};

inline const MissileTrack_Ingest_dataMode_Enum (&EnumValuesMissileTrack_Ingest_dataMode_Enum())[4] {
  static const MissileTrack_Ingest_dataMode_Enum values[] = {
    MissileTrack_Ingest_dataMode_Enum_REAL,
    MissileTrack_Ingest_dataMode_Enum_TEST,
    MissileTrack_Ingest_dataMode_Enum_SIMULATED,
    MissileTrack_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesMissileTrack_Ingest_dataMode_Enum() {
...
inline const char *EnumNameMissileTrack_Ingest_dataMode_Enum(MissileTrack_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, MissileTrack_Ingest_dataMode_Enum_REAL, MissileTrack_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesMissileTrack_Ingest_dataMode_Enum()[index];
}
...
struct MissileTrack_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef MissileTrack_IngestBuilder Builder;
  ...
  /// Example: /// Example: AIR
  /// Constraints: Minimum length = 0, Maximum length = 16
  MissileTrack_Ingest_env_Enum env() const {
    return static_cast<MissileTrack_Ingest_env_Enum>(GetField<int8_t>(VT_ENV, 0));
  }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 32
  MissileTrack_Ingest_objIdent_Enum objIdent() const {
    return static_cast<MissileTrack_Ingest_objIdent_Enum>(GetField<int8_t>(VT_OBJIDENT, 0));
  }
  ...
  MissileTrack_Ingest_dataMode_Enum dataMode() const {
    return static_cast<MissileTrack_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct MissileTrack_IngestBuilder {
  typedef MissileTrack_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_msgType(::flatbuffers::Offset<::flatbuffers::String> msgType) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_MSGTYPE, msgType);
  }
  void add_msgSubType(::flatbuffers::Offset<::flatbuffers::String> msgSubType) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_MSGSUBTYPE, msgSubType);
  }
  void add_msgCreateDate(::flatbuffers::Offset<::flatbuffers::String> msgCreateDate) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_MSGCREATEDATE, msgCreateDate);
  }
  void add_env(MissileTrack_Ingest_env_Enum env) {
    fbb_.AddElement<int8_t>(MissileTrack_Ingest::VT_ENV, static_cast<int8_t>(env), 0);
  }
  void add_objType(::flatbuffers::Offset<::flatbuffers::String> objType) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_OBJTYPE, objType);
  }
  void add_objTypeConf(int32_t objTypeConf) {
    fbb_.AddElement<int32_t>(MissileTrack_Ingest::VT_OBJTYPECONF, objTypeConf, 0);
  }
  void add_objPlat(::flatbuffers::Offset<::flatbuffers::String> objPlat) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_OBJPLAT, objPlat);
  }
  void add_objIdent(MissileTrack_Ingest_objIdent_Enum objIdent) {
    fbb_.AddElement<int8_t>(MissileTrack_Ingest::VT_OBJIDENT, static_cast<int8_t>(objIdent), 0);
  }
  void add_spaceAmp(::flatbuffers::Offset<::flatbuffers::String> spaceAmp) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_SPACEAMP, spaceAmp);
  }
  void add_objAct(::flatbuffers::Offset<::flatbuffers::String> objAct) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_OBJACT, objAct);
  }
  void add_spaceSpecType(::flatbuffers::Offset<::flatbuffers::String> spaceSpecType) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_SPACESPECTYPE, spaceSpecType);
  }
  void add_acftSubType(::flatbuffers::Offset<::flatbuffers::String> acftSubType) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_ACFTSUBTYPE, acftSubType);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_NAME, name);
  }
  void add_callSign(::flatbuffers::Offset<::flatbuffers::String> callSign) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_CALLSIGN, callSign);
  }
  void add_lostTrkInd(bool lostTrkInd) {
    fbb_.AddElement<uint8_t>(MissileTrack_Ingest::VT_LOSTTRKIND, static_cast<uint8_t>(lostTrkInd), 0);
  }
  void add_trackId(::flatbuffers::Offset<::flatbuffers::String> trackId) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_TRACKID, trackId);
  }
  void add_parentTrackId(::flatbuffers::Offset<::flatbuffers::String> parentTrackId) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_PARENTTRACKID, parentTrackId);
  }
  void add_muidSrcTrk(::flatbuffers::Offset<::flatbuffers::String> muidSrcTrk) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_MUIDSRCTRK, muidSrcTrk);
  }
  void add_muidSrc(::flatbuffers::Offset<::flatbuffers::String> muidSrc) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_MUIDSRC, muidSrc);
  }
  void add_alert(::flatbuffers::Offset<::flatbuffers::String> alert) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_ALERT, alert);
  }
  void add_mslStatus(::flatbuffers::Offset<::flatbuffers::String> mslStatus) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_MSLSTATUS, mslStatus);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::String> ts) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_TS, ts);
  }
  void add_aouRptType(::flatbuffers::Offset<::flatbuffers::String> aouRptType) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_AOURPTTYPE, aouRptType);
  }
  void add_aouRptData(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> aouRptData) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_AOURPTDATA, aouRptData);
  }
  void add_containment(double containment) {
    fbb_.AddElement<double>(MissileTrack_Ingest::VT_CONTAINMENT, containment, 0.0);
  }
  void add_trkConf(double trkConf) {
    fbb_.AddElement<double>(MissileTrack_Ingest::VT_TRKCONF, trkConf, 0.0);
  }
  void add_trkQual(int32_t trkQual) {
    fbb_.AddElement<int32_t>(MissileTrack_Ingest::VT_TRKQUAL, trkQual, 0);
  }
  void add_angElev(double angElev) {
    fbb_.AddElement<double>(MissileTrack_Ingest::VT_ANGELEV, angElev, 0.0);
  }
  void add_senMode(::flatbuffers::Offset<::flatbuffers::String> senMode) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_SENMODE, senMode);
  }
  void add_infoSource(::flatbuffers::Offset<::flatbuffers::String> infoSource) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_INFOSOURCE, infoSource);
  }
  void add_boosting(bool boosting) {
    fbb_.AddElement<uint8_t>(MissileTrack_Ingest::VT_BOOSTING, static_cast<uint8_t>(boosting), 0);
  }
  void add_polarSingLocLat(double polarSingLocLat) {
    fbb_.AddElement<double>(MissileTrack_Ingest::VT_POLARSINGLOCLAT, polarSingLocLat, 0.0);
  }
  void add_polarSingLocLon(double polarSingLocLon) {
    fbb_.AddElement<double>(MissileTrack_Ingest::VT_POLARSINGLOCLON, polarSingLocLon, 0.0);
  }
  void add_emgInd(bool emgInd) {
    fbb_.AddElement<uint8_t>(MissileTrack_Ingest::VT_EMGIND, static_cast<uint8_t>(emgInd), 0);
  }
  void add_dropPtInd(bool dropPtInd) {
    fbb_.AddElement<uint8_t>(MissileTrack_Ingest::VT_DROPPTIND, static_cast<uint8_t>(dropPtInd), 0);
  }
  void add_spaceAmpConf(int32_t spaceAmpConf) {
    fbb_.AddElement<int32_t>(MissileTrack_Ingest::VT_SPACEAMPCONF, spaceAmpConf, 0);
  }
  void add_launchTime(::flatbuffers::Offset<::flatbuffers::String> launchTime) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_LAUNCHTIME, launchTime);
  }
  void add_launchLat(double launchLat) {
    fbb_.AddElement<double>(MissileTrack_Ingest::VT_LAUNCHLAT, launchLat, 0.0);
  }
  void add_launchLon(double launchLon) {
    fbb_.AddElement<double>(MissileTrack_Ingest::VT_LAUNCHLON, launchLon, 0.0);
  }
  void add_azCorr(double azCorr) {
    fbb_.AddElement<double>(MissileTrack_Ingest::VT_AZCORR, azCorr, 0.0);
  }
  void add_burnoutAlt(double burnoutAlt) {
    fbb_.AddElement<double>(MissileTrack_Ingest::VT_BURNOUTALT, burnoutAlt, 0.0);
  }
  void add_launchAouType(::flatbuffers::Offset<::flatbuffers::String> launchAouType) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_LAUNCHAOUTYPE, launchAouType);
  }
  void add_launchAouData(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> launchAouData) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_LAUNCHAOUDATA, launchAouData);
  }
  void add_impactTime(::flatbuffers::Offset<::flatbuffers::String> impactTime) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_IMPACTTIME, impactTime);
  }
  void add_impactLat(double impactLat) {
    fbb_.AddElement<double>(MissileTrack_Ingest::VT_IMPACTLAT, impactLat, 0.0);
  }
  void add_impactLon(double impactLon) {
    fbb_.AddElement<double>(MissileTrack_Ingest::VT_IMPACTLON, impactLon, 0.0);
  }
  void add_impactAouType(::flatbuffers::Offset<::flatbuffers::String> impactAouType) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_IMPACTAOUTYPE, impactAouType);
  }
  void add_impactAouData(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> impactAouData) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_IMPACTAOUDATA, impactAouData);
  }
  void add_vectors(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> vectors) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_VECTORS, vectors);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(MissileTrack_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(MissileTrack_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(MissileTrack_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit MissileTrack_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<MissileTrack_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<MissileTrack_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<MissileTrack_Ingest> CreateMissileTrack_Ingest(
    ...
    MissileTrack_Ingest_env_Enum env = MissileTrack_Ingest_env_Enum_AIR,
    ::flatbuffers::Offset<::flatbuffers::String> objType = 0,
    int32_t objTypeConf = 0,
    ::flatbuffers::Offset<::flatbuffers::String> objPlat = 0,
    MissileTrack_Ingest_objIdent_Enum objIdent = MissileTrack_Ingest_objIdent_Enum_ASSUMED_FRIEND,
    ...
    MissileTrack_Ingest_dataMode_Enum dataMode = MissileTrack_Ingest_dataMode_Enum_REAL) {
  MissileTrack_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<MissileTrack_Ingest> CreateMissileTrack_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const MissileTrack_Ingest *GetMissileTrack_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<MissileTrack_Ingest>(buf);
}

inline const MissileTrack_Ingest *GetSizePrefixedMissileTrack_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<MissileTrack_Ingest>(buf);
}

inline const char *MissileTrack_IngestIdentifier() {
  return "MISS";
}

inline bool MissileTrack_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MissileTrack_IngestIdentifier());
}

inline bool SizePrefixedMissileTrack_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MissileTrack_IngestIdentifier(), true);
}

inline bool VerifyMissileTrack_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<MissileTrack_Ingest>(MissileTrack_IngestIdentifier());
}

inline bool VerifySizePrefixedMissileTrack_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<MissileTrack_Ingest>(MissileTrack_IngestIdentifier());
}

inline void FinishMissileTrack_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MissileTrack_Ingest> root) {
  fbb.Finish(root, MissileTrack_IngestIdentifier());
}

inline void FinishSizePrefixedMissileTrack_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MissileTrack_Ingest> root) {
  fbb.FinishSizePrefixed(root, MissileTrack_IngestIdentifier());
}
