...
struct ObjectOfInterest_Full;
struct ObjectOfInterest_FullBuilder;

enum ObjectOfInterest_Full_dataMode_Enum : int8_t {
  ...
  ObjectOfInterest_Full_dataMode_Enum_MIN = ObjectOfInterest_Full_dataMode_Enum_REAL,
  ObjectOfInterest_Full_dataMode_Enum_MAX = ObjectOfInterest_Full_dataMode_Enum_EXERCISE
};

inline const ObjectOfInterest_Full_dataMode_Enum (&EnumValuesObjectOfInterest_Full_dataMode_Enum())[4] {
  static const ObjectOfInterest_Full_dataMode_Enum values[] = {
    ObjectOfInterest_Full_dataMode_Enum_REAL,
    ObjectOfInterest_Full_dataMode_Enum_TEST,
    ObjectOfInterest_Full_dataMode_Enum_SIMULATED,
    ObjectOfInterest_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesObjectOfInterest_Full_dataMode_Enum() {
...
inline const char *EnumNameObjectOfInterest_Full_dataMode_Enum(ObjectOfInterest_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, ObjectOfInterest_Full_dataMode_Enum_REAL, ObjectOfInterest_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesObjectOfInterest_Full_dataMode_Enum()[index];
}

/// /// OnOrbit objects of interest, which include information about the last known state of the object.
struct ObjectOfInterest_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef ObjectOfInterest_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  ObjectOfInterest_Full_dataMode_Enum dataMode() const {
    return static_cast<ObjectOfInterest_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct ObjectOfInterest_FullBuilder {
  typedef ObjectOfInterest_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(ObjectOfInterest_Full::VT_SATNO, satNo, 0);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_NAME, name);
  }
  void add_sensorTaskingStartTime(::flatbuffers::Offset<::flatbuffers::String> sensorTaskingStartTime) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_SENSORTASKINGSTARTTIME, sensorTaskingStartTime);
  }
  void add_sensorTaskingStopTime(::flatbuffers::Offset<::flatbuffers::String> sensorTaskingStopTime) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_SENSORTASKINGSTOPTIME, sensorTaskingStopTime);
  }
  void add_priority(int32_t priority) {
    fbb_.AddElement<int32_t>(ObjectOfInterest_Full::VT_PRIORITY, priority, 0);
  }
  void add_status(::flatbuffers::Offset<::flatbuffers::String> status) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_STATUS, status);
  }
  void add_statusDate(::flatbuffers::Offset<::flatbuffers::String> statusDate) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_STATUSDATE, statusDate);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_DESCRIPTION, description);
  }
  void add_lastObTime(::flatbuffers::Offset<::flatbuffers::String> lastObTime) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_LASTOBTIME, lastObTime);
  }
  void add_missedObTime(::flatbuffers::Offset<::flatbuffers::String> missedObTime) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_MISSEDOBTIME, missedObTime);
  }
  void add_deltaVs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> deltaVs) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_DELTAVS, deltaVs);
  }
  void add_deltaTs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> deltaTs) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_DELTATS, deltaTs);
  }
  void add_svEpoch(::flatbuffers::Offset<::flatbuffers::String> svEpoch) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_SVEPOCH, svEpoch);
  }
  void add_x(double x) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_X, x, 0.0);
  }
  void add_y(double y) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_Y, y, 0.0);
  }
  void add_z(double z) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_Z, z, 0.0);
  }
  void add_xvel(double xvel) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_XVEL, xvel, 0.0);
  }
  void add_yvel(double yvel) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_YVEL, yvel, 0.0);
  }
  void add_zvel(double zvel) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_ZVEL, zvel, 0.0);
  }
  void add_elsetEpoch(::flatbuffers::Offset<::flatbuffers::String> elsetEpoch) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_ELSETEPOCH, elsetEpoch);
  }
  void add_meanMotion(double meanMotion) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_MEANMOTION, meanMotion, 0.0);
  }
  void add_eccentricity(double eccentricity) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_ECCENTRICITY, eccentricity, 0.0);
  }
  void add_inclination(double inclination) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_INCLINATION, inclination, 0.0);
  }
  void add_raan(double raan) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_RAAN, raan, 0.0);
  }
  void add_argOfPerigee(double argOfPerigee) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_ARGOFPERIGEE, argOfPerigee, 0.0);
  }
  void add_meanAnomaly(double meanAnomaly) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_MEANANOMALY, meanAnomaly, 0.0);
  }
  void add_revNo(int32_t revNo) {
    fbb_.AddElement<int32_t>(ObjectOfInterest_Full::VT_REVNO, revNo, 0);
  }
  void add_bStar(double bStar) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_BSTAR, bStar, 0.0);
  }
  void add_meanMotionDot(double meanMotionDot) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_MEANMOTIONDOT, meanMotionDot, 0.0);
  }
  void add_meanMotionDDot(double meanMotionDDot) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_MEANMOTIONDDOT, meanMotionDDot, 0.0);
  }
  void add_semiMajorAxis(double semiMajorAxis) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_SEMIMAJORAXIS, semiMajorAxis, 0.0);
  }
  void add_period(double period) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_PERIOD, period, 0.0);
  }
  void add_apogee(double apogee) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_APOGEE, apogee, 0.0);
  }
  void add_perigee(double perigee) {
    fbb_.AddElement<double>(ObjectOfInterest_Full::VT_PERIGEE, perigee, 0.0);
  }
  void add_affectedObjects(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> affectedObjects) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_AFFECTEDOBJECTS, affectedObjects);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(ObjectOfInterest_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(ObjectOfInterest_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_onOrbit(::flatbuffers::Offset<::flatbuffers::String> onOrbit) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_ONORBIT, onOrbit);
  }
  void add_manifolds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> manifolds) {
    fbb_.AddOffset(ObjectOfInterest_Full::VT_MANIFOLDS, manifolds);
  }
  explicit ObjectOfInterest_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<ObjectOfInterest_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<ObjectOfInterest_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<ObjectOfInterest_Full> CreateObjectOfInterest_Full(
    ...
    ObjectOfInterest_Full_dataMode_Enum dataMode = ObjectOfInterest_Full_dataMode_Enum_REAL,
  ...
  ObjectOfInterest_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<ObjectOfInterest_Full> CreateObjectOfInterest_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const ObjectOfInterest_Full *GetObjectOfInterest_Full(const void *buf) {
  return ::flatbuffers::GetRoot<ObjectOfInterest_Full>(buf);
}

inline const ObjectOfInterest_Full *GetSizePrefixedObjectOfInterest_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<ObjectOfInterest_Full>(buf);
}

inline const char *ObjectOfInterest_FullIdentifier() {
  return "OBJE";
}

inline bool ObjectOfInterest_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ObjectOfInterest_FullIdentifier());
}

inline bool SizePrefixedObjectOfInterest_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ObjectOfInterest_FullIdentifier(), true);
}

inline bool VerifyObjectOfInterest_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<ObjectOfInterest_Full>(ObjectOfInterest_FullIdentifier());
}

inline bool VerifySizePrefixedObjectOfInterest_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<ObjectOfInterest_Full>(ObjectOfInterest_FullIdentifier());
}

inline void FinishObjectOfInterest_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ObjectOfInterest_Full> root) {
  fbb.Finish(root, ObjectOfInterest_FullIdentifier());
}

inline void FinishSizePrefixedObjectOfInterest_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ObjectOfInterest_Full> root) {
  fbb.FinishSizePrefixed(root, ObjectOfInterest_FullIdentifier());
}
