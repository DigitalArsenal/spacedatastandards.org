...
struct NavigationalObstruction_Abridged;
struct NavigationalObstruction_AbridgedBuilder;

enum NavigationalObstruction_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  NavigationalObstruction_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  NavigationalObstruction_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  NavigationalObstruction_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  NavigationalObstruction_Abridged_dataMode_Enum_EXERCISE = 3,
  NavigationalObstruction_Abridged_dataMode_Enum_MIN = NavigationalObstruction_Abridged_dataMode_Enum_REAL,
  NavigationalObstruction_Abridged_dataMode_Enum_MAX = NavigationalObstruction_Abridged_dataMode_Enum_EXERCISE
};

inline const NavigationalObstruction_Abridged_dataMode_Enum (&EnumValuesNavigationalObstruction_Abridged_dataMode_Enum())[4] {
  static const NavigationalObstruction_Abridged_dataMode_Enum values[] = {
    NavigationalObstruction_Abridged_dataMode_Enum_REAL,
    NavigationalObstruction_Abridged_dataMode_Enum_TEST,
    NavigationalObstruction_Abridged_dataMode_Enum_SIMULATED,
    NavigationalObstruction_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesNavigationalObstruction_Abridged_dataMode_Enum() {
...
inline const char *EnumNameNavigationalObstruction_Abridged_dataMode_Enum(NavigationalObstruction_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, NavigationalObstruction_Abridged_dataMode_Enum_REAL, NavigationalObstruction_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesNavigationalObstruction_Abridged_dataMode_Enum()[index];
}
...
struct NavigationalObstruction_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef NavigationalObstruction_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  NavigationalObstruction_Abridged_dataMode_Enum dataMode() const {
    return static_cast<NavigationalObstruction_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct NavigationalObstruction_AbridgedBuilder {
  typedef NavigationalObstruction_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_cycleDate(::flatbuffers::Offset<::flatbuffers::String> cycleDate) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_CYCLEDATE, cycleDate);
  }
  void add_obstacleType(::flatbuffers::Offset<::flatbuffers::String> obstacleType) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_OBSTACLETYPE, obstacleType);
  }
  void add_obstacleId(::flatbuffers::Offset<::flatbuffers::String> obstacleId) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_OBSTACLEID, obstacleId);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_EXTERNALID, externalId);
  }
  void add_origId(::flatbuffers::Offset<::flatbuffers::String> origId) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_ORIGID, origId);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_COUNTRYCODE, countryCode);
  }
  void add_provinceCode(::flatbuffers::Offset<::flatbuffers::String> provinceCode) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_PROVINCECODE, provinceCode);
  }
  void add_pointLat(double pointLat) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_POINTLAT, pointLat, 0.0);
  }
  void add_pointLon(double pointLon) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_POINTLON, pointLon, 0.0);
  }
  void add_lineNELon(double lineNELon) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_LINENELON, lineNELon, 0.0);
  }
  void add_lineNELat(double lineNELat) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_LINENELAT, lineNELat, 0.0);
  }
  void add_lineSWLon(double lineSWLon) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_LINESWLON, lineSWLon, 0.0);
  }
  void add_lineSWLat(double lineSWLat) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_LINESWLAT, lineSWLat, 0.0);
  }
  void add_segStartPoint(int32_t segStartPoint) {
    fbb_.AddElement<int32_t>(NavigationalObstruction_Abridged::VT_SEGSTARTPOINT, segStartPoint, 0);
  }
  void add_segEndPoint(int32_t segEndPoint) {
    fbb_.AddElement<int32_t>(NavigationalObstruction_Abridged::VT_SEGENDPOINT, segEndPoint, 0);
  }
  void add_segNum(int32_t segNum) {
    fbb_.AddElement<int32_t>(NavigationalObstruction_Abridged::VT_SEGNUM, segNum, 0);
  }
  void add_facc(::flatbuffers::Offset<::flatbuffers::String> facc) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_FACC, facc);
  }
  void add_featureCode(::flatbuffers::Offset<::flatbuffers::String> featureCode) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_FEATURECODE, featureCode);
  }
  void add_featureType(::flatbuffers::Offset<::flatbuffers::String> featureType) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_FEATURETYPE, featureType);
  }
  void add_featureName(::flatbuffers::Offset<::flatbuffers::String> featureName) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_FEATURENAME, featureName);
  }
  void add_featureDescription(::flatbuffers::Offset<::flatbuffers::String> featureDescription) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_FEATUREDESCRIPTION, featureDescription);
  }
  void add_wac(::flatbuffers::Offset<::flatbuffers::String> wac) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_WAC, wac);
  }
  void add_wacINNR(::flatbuffers::Offset<::flatbuffers::String> wacINNR) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_WACINNR, wacINNR);
  }
  void add_multObs(::flatbuffers::Offset<::flatbuffers::String> multObs) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_MULTOBS, multObs);
  }
  void add_numObs(int32_t numObs) {
    fbb_.AddElement<int32_t>(NavigationalObstruction_Abridged::VT_NUMOBS, numObs, 0);
  }
  void add_horizDatumCode(::flatbuffers::Offset<::flatbuffers::String> horizDatumCode) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_HORIZDATUMCODE, horizDatumCode);
  }
  void add_heightAGL(double heightAGL) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_HEIGHTAGL, heightAGL, 0.0);
  }
  void add_heightAGLAcc(double heightAGLAcc) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_HEIGHTAGLACC, heightAGLAcc, 0.0);
  }
  void add_heightMSL(double heightMSL) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_HEIGHTMSL, heightMSL, 0.0);
  }
  void add_heightMSLAcc(double heightMSLAcc) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_HEIGHTMSLACC, heightMSLAcc, 0.0);
  }
  void add_elevation(double elevation) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_ELEVATION, elevation, 0.0);
  }
  void add_elevationAcc(double elevationAcc) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_ELEVATIONACC, elevationAcc, 0.0);
  }
  void add_horizAcc(double horizAcc) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_HORIZACC, horizAcc, 0.0);
  }
  void add_quality(::flatbuffers::Offset<::flatbuffers::String> quality) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_QUALITY, quality);
  }
  void add_lightingCode(::flatbuffers::Offset<::flatbuffers::String> lightingCode) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_LIGHTINGCODE, lightingCode);
  }
  void add_surfaceMatCode(::flatbuffers::Offset<::flatbuffers::String> surfaceMatCode) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_SURFACEMATCODE, surfaceMatCode);
  }
  void add_directivityCode(int32_t directivityCode) {
    fbb_.AddElement<int32_t>(NavigationalObstruction_Abridged::VT_DIRECTIVITYCODE, directivityCode, 0);
  }
  void add_validationCode(int32_t validationCode) {
    fbb_.AddElement<int32_t>(NavigationalObstruction_Abridged::VT_VALIDATIONCODE, validationCode, 0);
  }
  void add_transactionCode(::flatbuffers::Offset<::flatbuffers::String> transactionCode) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_TRANSACTIONCODE, transactionCode);
  }
  void add_processCode(::flatbuffers::Offset<::flatbuffers::String> processCode) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_PROCESSCODE, processCode);
  }
  void add_actDelCode(::flatbuffers::Offset<::flatbuffers::String> actDelCode) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_ACTDELCODE, actDelCode);
  }
  void add_producer(::flatbuffers::Offset<::flatbuffers::String> producer) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_PRODUCER, producer);
  }
  void add_derivingOrg(::flatbuffers::Offset<::flatbuffers::String> derivingOrg) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_DERIVINGORG, derivingOrg);
  }
  void add_deletingOrg(::flatbuffers::Offset<::flatbuffers::String> deletingOrg) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_DELETINGORG, deletingOrg);
  }
  void add_sourceDate(::flatbuffers::Offset<::flatbuffers::String> sourceDate) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_SOURCEDATE, sourceDate);
  }
  void add_revDate(::flatbuffers::Offset<::flatbuffers::String> revDate) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_REVDATE, revDate);
  }
  void add_initRecordDate(::flatbuffers::Offset<::flatbuffers::String> initRecordDate) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_INITRECORDDATE, initRecordDate);
  }
  void add_keys(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> keys) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_KEYS, keys);
  }
  void add_values(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> values) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_VALUES, values);
  }
  void add_obstacleRemarks(::flatbuffers::Offset<::flatbuffers::String> obstacleRemarks) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_OBSTACLEREMARKS, obstacleRemarks);
  }
  void add_nextCycleDate(::flatbuffers::Offset<::flatbuffers::String> nextCycleDate) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_NEXTCYCLEDATE, nextCycleDate);
  }
  void add_baselineCutoffDate(::flatbuffers::Offset<::flatbuffers::String> baselineCutoffDate) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_BASELINECUTOFFDATE, baselineCutoffDate);
  }
  void add_cutoffDate(::flatbuffers::Offset<::flatbuffers::String> cutoffDate) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_CUTOFFDATE, cutoffDate);
  }
  void add_airacCycle(int32_t airacCycle) {
    fbb_.AddElement<int32_t>(NavigationalObstruction_Abridged::VT_AIRACCYCLE, airacCycle, 0);
  }
  void add_baseAiracCycle(int32_t baseAiracCycle) {
    fbb_.AddElement<int32_t>(NavigationalObstruction_Abridged::VT_BASEAIRACCYCLE, baseAiracCycle, 0);
  }
  void add_ownerCountryCode(::flatbuffers::Offset<::flatbuffers::String> ownerCountryCode) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_OWNERCOUNTRYCODE, ownerCountryCode);
  }
  void add_boundNELon(double boundNELon) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_BOUNDNELON, boundNELon, 0.0);
  }
  void add_boundNELat(double boundNELat) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_BOUNDNELAT, boundNELat, 0.0);
  }
  void add_boundSWLon(double boundSWLon) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_BOUNDSWLON, boundSWLon, 0.0);
  }
  void add_boundSWLat(double boundSWLat) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_BOUNDSWLAT, boundSWLat, 0.0);
  }
  void add_minHeightAGL(double minHeightAGL) {
    fbb_.AddElement<double>(NavigationalObstruction_Abridged::VT_MINHEIGHTAGL, minHeightAGL, 0.0);
  }
  void add_numPoints(int32_t numPoints) {
    fbb_.AddElement<int32_t>(NavigationalObstruction_Abridged::VT_NUMPOINTS, numPoints, 0);
  }
  void add_numLines(int32_t numLines) {
    fbb_.AddElement<int32_t>(NavigationalObstruction_Abridged::VT_NUMLINES, numLines, 0);
  }
  void add_dataSetRemarks(::flatbuffers::Offset<::flatbuffers::String> dataSetRemarks) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_DATASETREMARKS, dataSetRemarks);
  }
  void add_pointsFilename(::flatbuffers::Offset<::flatbuffers::String> pointsFilename) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_POINTSFILENAME, pointsFilename);
  }
  void add_linesFilename(::flatbuffers::Offset<::flatbuffers::String> linesFilename) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_LINESFILENAME, linesFilename);
  }
  void add_vectorsFilename(::flatbuffers::Offset<::flatbuffers::String> vectorsFilename) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_VECTORSFILENAME, vectorsFilename);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_RAWFILEURI, rawFileURI);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(NavigationalObstruction_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(NavigationalObstruction_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(NavigationalObstruction_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit NavigationalObstruction_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<NavigationalObstruction_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<NavigationalObstruction_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<NavigationalObstruction_Abridged> CreateNavigationalObstruction_Abridged(
    ...
    NavigationalObstruction_Abridged_dataMode_Enum dataMode = NavigationalObstruction_Abridged_dataMode_Enum_REAL) {
  NavigationalObstruction_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<NavigationalObstruction_Abridged> CreateNavigationalObstruction_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateNavigationalObstruction_Abridged(
      _fbb,
      id__,
...
inline const NavigationalObstruction_Abridged *GetNavigationalObstruction_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<NavigationalObstruction_Abridged>(buf);
}

inline const NavigationalObstruction_Abridged *GetSizePrefixedNavigationalObstruction_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<NavigationalObstruction_Abridged>(buf);
}

inline const char *NavigationalObstruction_AbridgedIdentifier() {
  return "NAVI";
}

inline bool NavigationalObstruction_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, NavigationalObstruction_AbridgedIdentifier());
}

inline bool SizePrefixedNavigationalObstruction_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, NavigationalObstruction_AbridgedIdentifier(), true);
}

inline bool VerifyNavigationalObstruction_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<NavigationalObstruction_Abridged>(NavigationalObstruction_AbridgedIdentifier());
}

inline bool VerifySizePrefixedNavigationalObstruction_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<NavigationalObstruction_Abridged>(NavigationalObstruction_AbridgedIdentifier());
}

inline void FinishNavigationalObstruction_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<NavigationalObstruction_Abridged> root) {
  fbb.Finish(root, NavigationalObstruction_AbridgedIdentifier());
}

inline void FinishSizePrefixedNavigationalObstruction_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<NavigationalObstruction_Abridged> root) {
  fbb.FinishSizePrefixed(root, NavigationalObstruction_AbridgedIdentifier());
}
