...
struct RFObservation_Full;
struct RFObservation_FullBuilder;

enum RFObservation_Full_polarityType_Enum : int8_t {
  /// No description available.
  RFObservation_Full_polarityType_Enum_H = 0,
  /// No description available.
  RFObservation_Full_polarityType_Enum_V = 1,
  /// No description available.
  RFObservation_Full_polarityType_Enum_R = 2,
  /// No description available.
  RFObservation_Full_polarityType_Enum_L = 3,
  RFObservation_Full_polarityType_Enum_MIN = RFObservation_Full_polarityType_Enum_H,
  RFObservation_Full_polarityType_Enum_MAX = RFObservation_Full_polarityType_Enum_L
};

inline const RFObservation_Full_polarityType_Enum (&EnumValuesRFObservation_Full_polarityType_Enum())[4] {
  static const RFObservation_Full_polarityType_Enum values[] = {
    RFObservation_Full_polarityType_Enum_H,
    RFObservation_Full_polarityType_Enum_V,
    RFObservation_Full_polarityType_Enum_R,
    RFObservation_Full_polarityType_Enum_L
  };
  return values;
}

inline const char * const *EnumNamesRFObservation_Full_polarityType_Enum() {
...
inline const char *EnumNameRFObservation_Full_polarityType_Enum(RFObservation_Full_polarityType_Enum e) {
  if (::flatbuffers::IsOutRange(e, RFObservation_Full_polarityType_Enum_H, RFObservation_Full_polarityType_Enum_L)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesRFObservation_Full_polarityType_Enum()[index];
}

enum RFObservation_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  RFObservation_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  RFObservation_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  RFObservation_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  RFObservation_Full_dataMode_Enum_EXERCISE = 3,
  RFObservation_Full_dataMode_Enum_MIN = RFObservation_Full_dataMode_Enum_REAL,
  RFObservation_Full_dataMode_Enum_MAX = RFObservation_Full_dataMode_Enum_EXERCISE
};

inline const RFObservation_Full_dataMode_Enum (&EnumValuesRFObservation_Full_dataMode_Enum())[4] {
  static const RFObservation_Full_dataMode_Enum values[] = {
    RFObservation_Full_dataMode_Enum_REAL,
    RFObservation_Full_dataMode_Enum_TEST,
    RFObservation_Full_dataMode_Enum_SIMULATED,
    RFObservation_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesRFObservation_Full_dataMode_Enum() {
  static const char * const names[5] = {
    "REAL",
    "TEST",
    "SIMULATED",
...
inline const char *EnumNameRFObservation_Full_dataMode_Enum(RFObservation_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, RFObservation_Full_dataMode_Enum_REAL, RFObservation_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesRFObservation_Full_dataMode_Enum()[index];
}
...
struct RFObservation_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef RFObservation_FullBuilder Builder;
  ...
  RFObservation_Full_polarityType_Enum polarityType() const {
    return static_cast<RFObservation_Full_polarityType_Enum>(GetField<int8_t>(VT_POLARITYTYPE, 0));
  }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  RFObservation_Full_dataMode_Enum dataMode() const {
    return static_cast<RFObservation_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct RFObservation_FullBuilder {
  typedef RFObservation_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(RFObservation_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(RFObservation_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_obTime(::flatbuffers::Offset<::flatbuffers::String> obTime) {
    fbb_.AddOffset(RFObservation_Full::VT_OBTIME, obTime);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(RFObservation_Full::VT_IDONORBIT, idOnOrbit);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(RFObservation_Full::VT_IDSENSOR, idSensor);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(RFObservation_Full::VT_TYPE, type);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(RFObservation_Full::VT_SATNO, satNo, 0);
  }
  void add_taskId(::flatbuffers::Offset<::flatbuffers::String> taskId) {
    fbb_.AddOffset(RFObservation_Full::VT_TASKID, taskId);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(RFObservation_Full::VT_TRANSACTIONID, transactionId);
  }
  void add_trackId(::flatbuffers::Offset<::flatbuffers::String> trackId) {
    fbb_.AddOffset(RFObservation_Full::VT_TRACKID, trackId);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(RFObservation_Full::VT_ORIGOBJECTID, origObjectId);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(RFObservation_Full::VT_ORIGSENSORID, origSensorId);
  }
  void add_uct(bool uct) {
    fbb_.AddElement<uint8_t>(RFObservation_Full::VT_UCT, static_cast<uint8_t>(uct), 0);
  }
  void add_transponder(::flatbuffers::Offset<::flatbuffers::String> transponder) {
    fbb_.AddOffset(RFObservation_Full::VT_TRANSPONDER, transponder);
  }
  void add_azimuth(double azimuth) {
    fbb_.AddElement<double>(RFObservation_Full::VT_AZIMUTH, azimuth, 0.0);
  }
  void add_azimuthUnc(double azimuthUnc) {
    fbb_.AddElement<double>(RFObservation_Full::VT_AZIMUTHUNC, azimuthUnc, 0.0);
  }
  void add_azimuthRate(double azimuthRate) {
    fbb_.AddElement<double>(RFObservation_Full::VT_AZIMUTHRATE, azimuthRate, 0.0);
  }
  void add_elevation(double elevation) {
    fbb_.AddElement<double>(RFObservation_Full::VT_ELEVATION, elevation, 0.0);
  }
  void add_elevationUnc(double elevationUnc) {
    fbb_.AddElement<double>(RFObservation_Full::VT_ELEVATIONUNC, elevationUnc, 0.0);
  }
  void add_elevationRate(double elevationRate) {
    fbb_.AddElement<double>(RFObservation_Full::VT_ELEVATIONRATE, elevationRate, 0.0);
  }
  void add_range(double range) {
    fbb_.AddElement<double>(RFObservation_Full::VT_RANGE, range, 0.0);
  }
  void add_rangeUnc(double rangeUnc) {
    fbb_.AddElement<double>(RFObservation_Full::VT_RANGEUNC, rangeUnc, 0.0);
  }
  void add_rangeRate(double rangeRate) {
    fbb_.AddElement<double>(RFObservation_Full::VT_RANGERATE, rangeRate, 0.0);
  }
  void add_rangeRateUnc(double rangeRateUnc) {
    fbb_.AddElement<double>(RFObservation_Full::VT_RANGERATEUNC, rangeRateUnc, 0.0);
  }
  void add_trackRange(double trackRange) {
    fbb_.AddElement<double>(RFObservation_Full::VT_TRACKRANGE, trackRange, 0.0);
  }
  void add_senlat(double senlat) {
    fbb_.AddElement<double>(RFObservation_Full::VT_SENLAT, senlat, 0.0);
  }
  void add_senlon(double senlon) {
    fbb_.AddElement<double>(RFObservation_Full::VT_SENLON, senlon, 0.0);
  }
  void add_senalt(double senalt) {
    fbb_.AddElement<double>(RFObservation_Full::VT_SENALT, senalt, 0.0);
  }
  void add_elnot(::flatbuffers::Offset<::flatbuffers::String> elnot) {
    fbb_.AddOffset(RFObservation_Full::VT_ELNOT, elnot);
  }
  void add_frequency(double frequency) {
    fbb_.AddElement<double>(RFObservation_Full::VT_FREQUENCY, frequency, 0.0);
  }
  void add_nominalFrequency(double nominalFrequency) {
    fbb_.AddElement<double>(RFObservation_Full::VT_NOMINALFREQUENCY, nominalFrequency, 0.0);
  }
  void add_startFrequency(double startFrequency) {
    fbb_.AddElement<double>(RFObservation_Full::VT_STARTFREQUENCY, startFrequency, 0.0);
  }
  void add_endFrequency(double endFrequency) {
    fbb_.AddElement<double>(RFObservation_Full::VT_ENDFREQUENCY, endFrequency, 0.0);
  }
  void add_relativeCarrierPower(double relativeCarrierPower) {
    fbb_.AddElement<double>(RFObservation_Full::VT_RELATIVECARRIERPOWER, relativeCarrierPower, 0.0);
  }
  void add_spectrumAnalyzerPower(double spectrumAnalyzerPower) {
    fbb_.AddElement<double>(RFObservation_Full::VT_SPECTRUMANALYZERPOWER, spectrumAnalyzerPower, 0.0);
  }
  void add_relativeNoiseFloor(double relativeNoiseFloor) {
    fbb_.AddElement<double>(RFObservation_Full::VT_RELATIVENOISEFLOOR, relativeNoiseFloor, 0.0);
  }
  void add_referenceLevel(double referenceLevel) {
    fbb_.AddElement<double>(RFObservation_Full::VT_REFERENCELEVEL, referenceLevel, 0.0);
  }
  void add_pgri(double pgri) {
    fbb_.AddElement<double>(RFObservation_Full::VT_PGRI, pgri, 0.0);
  }
  void add_confidence(double confidence) {
    fbb_.AddElement<double>(RFObservation_Full::VT_CONFIDENCE, confidence, 0.0);
  }
  void add_incoming(bool incoming) {
    fbb_.AddElement<uint8_t>(RFObservation_Full::VT_INCOMING, static_cast<uint8_t>(incoming), 0);
  }
  void add_switchPoint(int32_t switchPoint) {
    fbb_.AddElement<int32_t>(RFObservation_Full::VT_SWITCHPOINT, switchPoint, 0);
  }
  void add_baudRate(double baudRate) {
    fbb_.AddElement<double>(RFObservation_Full::VT_BAUDRATE, baudRate, 0.0);
  }
  void add_snr(double snr) {
    fbb_.AddElement<double>(RFObservation_Full::VT_SNR, snr, 0.0);
  }
  void add_nominalSnr(double nominalSnr) {
    fbb_.AddElement<double>(RFObservation_Full::VT_NOMINALSNR, nominalSnr, 0.0);
  }
  void add_polarity(double polarity) {
    fbb_.AddElement<double>(RFObservation_Full::VT_POLARITY, polarity, 0.0);
  }
  void add_polarityType(RFObservation_Full_polarityType_Enum polarityType) {
    fbb_.AddElement<int8_t>(RFObservation_Full::VT_POLARITYTYPE, static_cast<int8_t>(polarityType), 0);
  }
  void add_channel(int32_t channel) {
    fbb_.AddElement<int32_t>(RFObservation_Full::VT_CHANNEL, channel, 0);
  }
  void add_powerOverNoise(double powerOverNoise) {
    fbb_.AddElement<double>(RFObservation_Full::VT_POWEROVERNOISE, powerOverNoise, 0.0);
  }
  void add_nominalPowerOverNoise(double nominalPowerOverNoise) {
    fbb_.AddElement<double>(RFObservation_Full::VT_NOMINALPOWEROVERNOISE, nominalPowerOverNoise, 0.0);
  }
  void add_bandwidth(double bandwidth) {
    fbb_.AddElement<double>(RFObservation_Full::VT_BANDWIDTH, bandwidth, 0.0);
  }
  void add_nominalBandwidth(double nominalBandwidth) {
    fbb_.AddElement<double>(RFObservation_Full::VT_NOMINALBANDWIDTH, nominalBandwidth, 0.0);
  }
  void add_resolutionBandwidth(double resolutionBandwidth) {
    fbb_.AddElement<double>(RFObservation_Full::VT_RESOLUTIONBANDWIDTH, resolutionBandwidth, 0.0);
  }
  void add_videoBandwidth(double videoBandwidth) {
    fbb_.AddElement<double>(RFObservation_Full::VT_VIDEOBANDWIDTH, videoBandwidth, 0.0);
  }
  void add_eirp(double eirp) {
    fbb_.AddElement<double>(RFObservation_Full::VT_EIRP, eirp, 0.0);
  }
  void add_nominalEirp(double nominalEirp) {
    fbb_.AddElement<double>(RFObservation_Full::VT_NOMINALEIRP, nominalEirp, 0.0);
  }
  void add_minPSD(double minPSD) {
    fbb_.AddElement<double>(RFObservation_Full::VT_MINPSD, minPSD, 0.0);
  }
  void add_maxPSD(double maxPSD) {
    fbb_.AddElement<double>(RFObservation_Full::VT_MAXPSD, maxPSD, 0.0);
  }
  void add_frequencyShift(double frequencyShift) {
    fbb_.AddElement<double>(RFObservation_Full::VT_FREQUENCYSHIFT, frequencyShift, 0.0);
  }
  void add_peak(bool peak) {
    fbb_.AddElement<uint8_t>(RFObservation_Full::VT_PEAK, static_cast<uint8_t>(peak), 0);
  }
  void add_antennaName(::flatbuffers::Offset<::flatbuffers::String> antennaName) {
    fbb_.AddOffset(RFObservation_Full::VT_ANTENNANAME, antennaName);
  }
  void add_detectionStatus(::flatbuffers::Offset<::flatbuffers::String> detectionStatus) {
    fbb_.AddOffset(RFObservation_Full::VT_DETECTIONSTATUS, detectionStatus);
  }
  void add_collectionMode(::flatbuffers::Offset<::flatbuffers::String> collectionMode) {
    fbb_.AddOffset(RFObservation_Full::VT_COLLECTIONMODE, collectionMode);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(RFObservation_Full::VT_RAWFILEURI, rawFileURI);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(RFObservation_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(RFObservation_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(RFObservation_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(RFObservation_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(RFObservation_Full::VT_TAGS, tags);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(RFObservation_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(RFObservation_Full::VT_CREATEDBY, createdBy);
  }
  void add_noisePwrDensity(double noisePwrDensity) {
    fbb_.AddElement<double>(RFObservation_Full::VT_NOISEPWRDENSITY, noisePwrDensity, 0.0);
  }
  void add_carrierStandard(::flatbuffers::Offset<::flatbuffers::String> carrierStandard) {
    fbb_.AddOffset(RFObservation_Full::VT_CARRIERSTANDARD, carrierStandard);
  }
  void add_modulation(::flatbuffers::Offset<::flatbuffers::String> modulation) {
    fbb_.AddOffset(RFObservation_Full::VT_MODULATION, modulation);
  }
  void add_innerCodingRate(int32_t innerCodingRate) {
    fbb_.AddElement<int32_t>(RFObservation_Full::VT_INNERCODINGRATE, innerCodingRate, 0);
  }
  void add_outerCodingRate(int32_t outerCodingRate) {
    fbb_.AddElement<int32_t>(RFObservation_Full::VT_OUTERCODINGRATE, outerCodingRate, 0);
  }
  void add_transmitFilterType(::flatbuffers::Offset<::flatbuffers::String> transmitFilterType) {
    fbb_.AddOffset(RFObservation_Full::VT_TRANSMITFILTERTYPE, transmitFilterType);
  }
  void add_transmitFilterRollOff(double transmitFilterRollOff) {
    fbb_.AddElement<double>(RFObservation_Full::VT_TRANSMITFILTERROLLOFF, transmitFilterRollOff, 0.0);
  }
  void add_symbolToNoiseRatio(double symbolToNoiseRatio) {
    fbb_.AddElement<double>(RFObservation_Full::VT_SYMBOLTONOISERATIO, symbolToNoiseRatio, 0.0);
  }
  void add_bitErrorRate(double bitErrorRate) {
    fbb_.AddElement<double>(RFObservation_Full::VT_BITERRORRATE, bitErrorRate, 0.0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(RFObservation_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(RFObservation_Full::VT_SOURCEDL, sourceDL);
  }
  void add_onOrbit(::flatbuffers::Offset<::flatbuffers::String> onOrbit) {
    fbb_.AddOffset(RFObservation_Full::VT_ONORBIT, onOrbit);
  }
  void add_descriptor(::flatbuffers::Offset<::flatbuffers::String> descriptor) {
    fbb_.AddOffset(RFObservation_Full::VT_DESCRIPTOR, descriptor);
  }
  void add_url(::flatbuffers::Offset<::flatbuffers::String> url) {
    fbb_.AddOffset(RFObservation_Full::VT_URL, url);
  }
  explicit RFObservation_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<RFObservation_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<RFObservation_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<RFObservation_Full> CreateRFObservation_Full(
    ...
    double polarity = 0.0,
    RFObservation_Full_polarityType_Enum polarityType = RFObservation_Full_polarityType_Enum_H,
    int32_t channel = 0,
    ...
    RFObservation_Full_dataMode_Enum dataMode = RFObservation_Full_dataMode_Enum_REAL,
  ...
  RFObservation_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<RFObservation_Full> CreateRFObservation_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateRFObservation_Full(
      _fbb,
      id__,
...
inline const RFObservation_Full *GetRFObservation_Full(const void *buf) {
  return ::flatbuffers::GetRoot<RFObservation_Full>(buf);
}

inline const RFObservation_Full *GetSizePrefixedRFObservation_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<RFObservation_Full>(buf);
}

inline const char *RFObservation_FullIdentifier() {
  return "RFOB";
}

inline bool RFObservation_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RFObservation_FullIdentifier());
}

inline bool SizePrefixedRFObservation_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RFObservation_FullIdentifier(), true);
}

inline bool VerifyRFObservation_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<RFObservation_Full>(RFObservation_FullIdentifier());
}

inline bool VerifySizePrefixedRFObservation_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<RFObservation_Full>(RFObservation_FullIdentifier());
}

inline void FinishRFObservation_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RFObservation_Full> root) {
  fbb.Finish(root, RFObservation_FullIdentifier());
}

inline void FinishSizePrefixedRFObservation_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RFObservation_Full> root) {
  fbb.FinishSizePrefixed(root, RFObservation_FullIdentifier());
}
