...
struct TrackDetails_Full;
struct TrackDetails_FullBuilder;

enum TrackDetails_Full_env_Enum : int8_t {
  /// Between sea level and the Kármán line, which has an altitude of 100 kilometers (62 miles).
  TrackDetails_Full_env_Enum_AIR = 0,
  /// On the surface of dry land.
  TrackDetails_Full_env_Enum_LAND = 1,
  /// Above the Kármán line, which has an altitude of 100 kilometers (62 miles).
  TrackDetails_Full_env_Enum_SPACE = 2,
  /// On the surface of a body of water.
  TrackDetails_Full_env_Enum_SURFACE = 3,
  /// Below the surface of a body of water.
  TrackDetails_Full_env_Enum_SUBSURFACE = 4,
  /// Environment is not known.
  TrackDetails_Full_env_Enum_UNKNOWN = 5,
  TrackDetails_Full_env_Enum_MIN = TrackDetails_Full_env_Enum_AIR,
  TrackDetails_Full_env_Enum_MAX = TrackDetails_Full_env_Enum_UNKNOWN
};

inline const TrackDetails_Full_env_Enum (&EnumValuesTrackDetails_Full_env_Enum())[6] {
  static const TrackDetails_Full_env_Enum values[] = {
    TrackDetails_Full_env_Enum_AIR,
    TrackDetails_Full_env_Enum_LAND,
    TrackDetails_Full_env_Enum_SPACE,
    TrackDetails_Full_env_Enum_SURFACE,
    TrackDetails_Full_env_Enum_SUBSURFACE,
    TrackDetails_Full_env_Enum_UNKNOWN
  };
  return values;
}

inline const char * const *EnumNamesTrackDetails_Full_env_Enum() {
...
inline const char *EnumNameTrackDetails_Full_env_Enum(TrackDetails_Full_env_Enum e) {
  if (::flatbuffers::IsOutRange(e, TrackDetails_Full_env_Enum_AIR, TrackDetails_Full_env_Enum_UNKNOWN)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesTrackDetails_Full_env_Enum()[index];
}

enum TrackDetails_Full_objIdent_Enum : int8_t {
  /// Track assumed to be a friend due to the object characteristics, behavior, and/or origin.
  TrackDetails_Full_objIdent_Enum_ASSUMED_FRIEND = 0,
  /// Track object supporting friendly forces and belonging to a declared friendly nation or entity.
  TrackDetails_Full_objIdent_Enum_FRIEND = 1,
  ...
  TrackDetails_Full_objIdent_Enum_HOSTILE = 2,
  ...
  TrackDetails_Full_objIdent_Enum_NEUTRAL = 3,
  /// Track object which has not been evaluated.
  TrackDetails_Full_objIdent_Enum_PENDING = 4,
  /// Track object deemed potentially hostile due to the object characteristics, behavior, nationality, and/or origin.
  TrackDetails_Full_objIdent_Enum_SUSPECT = 5,
  /// Track object which has been evaluated and does not meet criteria for any standard identity.
  TrackDetails_Full_objIdent_Enum_UNKNOWN = 6,
  TrackDetails_Full_objIdent_Enum_MIN = TrackDetails_Full_objIdent_Enum_ASSUMED_FRIEND,
  TrackDetails_Full_objIdent_Enum_MAX = TrackDetails_Full_objIdent_Enum_UNKNOWN
};

inline const TrackDetails_Full_objIdent_Enum (&EnumValuesTrackDetails_Full_objIdent_Enum())[7] {
  static const TrackDetails_Full_objIdent_Enum values[] = {
    TrackDetails_Full_objIdent_Enum_ASSUMED_FRIEND,
    TrackDetails_Full_objIdent_Enum_FRIEND,
    TrackDetails_Full_objIdent_Enum_HOSTILE,
    TrackDetails_Full_objIdent_Enum_NEUTRAL,
    TrackDetails_Full_objIdent_Enum_PENDING,
    TrackDetails_Full_objIdent_Enum_SUSPECT,
    TrackDetails_Full_objIdent_Enum_UNKNOWN
  };
  return values;
}

inline const char * const *EnumNamesTrackDetails_Full_objIdent_Enum() {
...
inline const char *EnumNameTrackDetails_Full_objIdent_Enum(TrackDetails_Full_objIdent_Enum e) {
  if (::flatbuffers::IsOutRange(e, TrackDetails_Full_objIdent_Enum_ASSUMED_FRIEND, TrackDetails_Full_objIdent_Enum_UNKNOWN)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesTrackDetails_Full_objIdent_Enum()[index];
}

enum TrackDetails_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  TrackDetails_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  TrackDetails_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  TrackDetails_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  TrackDetails_Full_dataMode_Enum_EXERCISE = 3,
  TrackDetails_Full_dataMode_Enum_MIN = TrackDetails_Full_dataMode_Enum_REAL,
  TrackDetails_Full_dataMode_Enum_MAX = TrackDetails_Full_dataMode_Enum_EXERCISE
};

inline const TrackDetails_Full_dataMode_Enum (&EnumValuesTrackDetails_Full_dataMode_Enum())[4] {
  static const TrackDetails_Full_dataMode_Enum values[] = {
    TrackDetails_Full_dataMode_Enum_REAL,
    TrackDetails_Full_dataMode_Enum_TEST,
    TrackDetails_Full_dataMode_Enum_SIMULATED,
    TrackDetails_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesTrackDetails_Full_dataMode_Enum() {
...
inline const char *EnumNameTrackDetails_Full_dataMode_Enum(TrackDetails_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, TrackDetails_Full_dataMode_Enum_REAL, TrackDetails_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesTrackDetails_Full_dataMode_Enum()[index];
}
...
struct TrackDetails_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef TrackDetails_FullBuilder Builder;
  ...
  TrackDetails_Full_env_Enum env() const {
    return static_cast<TrackDetails_Full_env_Enum>(GetField<int8_t>(VT_ENV, 0));
  }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 32
  TrackDetails_Full_objIdent_Enum objIdent() const {
    return static_cast<TrackDetails_Full_objIdent_Enum>(GetField<int8_t>(VT_OBJIDENT, 0));
  }
  ...
  TrackDetails_Full_dataMode_Enum dataMode() const {
    return static_cast<TrackDetails_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct TrackDetails_FullBuilder {
  typedef TrackDetails_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(TrackDetails_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(TrackDetails_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_env(TrackDetails_Full_env_Enum env) {
    fbb_.AddElement<int8_t>(TrackDetails_Full::VT_ENV, static_cast<int8_t>(env), 0);
  }
  void add_msgType(::flatbuffers::Offset<::flatbuffers::String> msgType) {
    fbb_.AddOffset(TrackDetails_Full::VT_MSGTYPE, msgType);
  }
  void add_hullNum(::flatbuffers::Offset<::flatbuffers::String> hullNum) {
    fbb_.AddOffset(TrackDetails_Full::VT_HULLNUM, hullNum);
  }
  void add_pif(::flatbuffers::Offset<::flatbuffers::String> pif) {
    fbb_.AddOffset(TrackDetails_Full::VT_PIF, pif);
  }
  void add_sconum(::flatbuffers::Offset<::flatbuffers::String> sconum) {
    fbb_.AddOffset(TrackDetails_Full::VT_SCONUM, sconum);
  }
  void add_ntds(::flatbuffers::Offset<::flatbuffers::String> ntds) {
    fbb_.AddOffset(TrackDetails_Full::VT_NTDS, ntds);
  }
  void add_disId(::flatbuffers::Offset<::flatbuffers::String> disId) {
    fbb_.AddOffset(TrackDetails_Full::VT_DISID, disId);
  }
  void add_midbCat(::flatbuffers::Offset<::flatbuffers::String> midbCat) {
    fbb_.AddOffset(TrackDetails_Full::VT_MIDBCAT, midbCat);
  }
  void add_beNumber(::flatbuffers::Offset<::flatbuffers::String> beNumber) {
    fbb_.AddOffset(TrackDetails_Full::VT_BENUMBER, beNumber);
  }
  void add_oSuffix(::flatbuffers::Offset<::flatbuffers::String> oSuffix) {
    fbb_.AddOffset(TrackDetails_Full::VT_OSUFFIX, oSuffix);
  }
  void add_pin(::flatbuffers::Offset<::flatbuffers::String> pin) {
    fbb_.AddOffset(TrackDetails_Full::VT_PIN, pin);
  }
  void add_lostTrkInd(bool lostTrkInd) {
    fbb_.AddElement<uint8_t>(TrackDetails_Full::VT_LOSTTRKIND, static_cast<uint8_t>(lostTrkInd), 0);
  }
  void add_muidSrcTrk(::flatbuffers::Offset<::flatbuffers::String> muidSrcTrk) {
    fbb_.AddOffset(TrackDetails_Full::VT_MUIDSRCTRK, muidSrcTrk);
  }
  void add_muidSrc(::flatbuffers::Offset<::flatbuffers::String> muidSrc) {
    fbb_.AddOffset(TrackDetails_Full::VT_MUIDSRC, muidSrc);
  }
  void add_mslStatus(::flatbuffers::Offset<::flatbuffers::String> mslStatus) {
    fbb_.AddOffset(TrackDetails_Full::VT_MSLSTATUS, mslStatus);
  }
  void add_trkConf(double trkConf) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_TRKCONF, trkConf, 0.0);
  }
  void add_trkQual(int32_t trkQual) {
    fbb_.AddElement<int32_t>(TrackDetails_Full::VT_TRKQUAL, trkQual, 0);
  }
  void add_alert(::flatbuffers::Offset<::flatbuffers::String> alert) {
    fbb_.AddOffset(TrackDetails_Full::VT_ALERT, alert);
  }
  void add_origXref(::flatbuffers::Offset<::flatbuffers::String> origXref) {
    fbb_.AddOffset(TrackDetails_Full::VT_ORIGXREF, origXref);
  }
  void add_elnot1(::flatbuffers::Offset<::flatbuffers::String> elnot1) {
    fbb_.AddOffset(TrackDetails_Full::VT_ELNOT1, elnot1);
  }
  void add_elnot2(::flatbuffers::Offset<::flatbuffers::String> elnot2) {
    fbb_.AddOffset(TrackDetails_Full::VT_ELNOT2, elnot2);
  }
  void add_objIdent(TrackDetails_Full_objIdent_Enum objIdent) {
    fbb_.AddElement<int8_t>(TrackDetails_Full::VT_OBJIDENT, static_cast<int8_t>(objIdent), 0);
  }
  void add_objType(::flatbuffers::Offset<::flatbuffers::String> objType) {
    fbb_.AddOffset(TrackDetails_Full::VT_OBJTYPE, objType);
  }
  void add_objPlat(::flatbuffers::Offset<::flatbuffers::String> objPlat) {
    fbb_.AddOffset(TrackDetails_Full::VT_OBJPLAT, objPlat);
  }
  void add_objAct(::flatbuffers::Offset<::flatbuffers::String> objAct) {
    fbb_.AddOffset(TrackDetails_Full::VT_OBJACT, objAct);
  }
  void add_objNat(::flatbuffers::Offset<::flatbuffers::String> objNat) {
    fbb_.AddOffset(TrackDetails_Full::VT_OBJNAT, objNat);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(TrackDetails_Full::VT_NAME, name);
  }
  void add_shortName(::flatbuffers::Offset<::flatbuffers::String> shortName) {
    fbb_.AddOffset(TrackDetails_Full::VT_SHORTNAME, shortName);
  }
  void add_trkId(::flatbuffers::Offset<::flatbuffers::String> trkId) {
    fbb_.AddOffset(TrackDetails_Full::VT_TRKID, trkId);
  }
  void add_trkNum(::flatbuffers::Offset<::flatbuffers::String> trkNum) {
    fbb_.AddOffset(TrackDetails_Full::VT_TRKNUM, trkNum);
  }
  void add_trkScope(::flatbuffers::Offset<::flatbuffers::String> trkScope) {
    fbb_.AddOffset(TrackDetails_Full::VT_TRKSCOPE, trkScope);
  }
  void add_sourceUid(::flatbuffers::Offset<::flatbuffers::String> sourceUid) {
    fbb_.AddOffset(TrackDetails_Full::VT_SOURCEUID, sourceUid);
  }
  void add_callSign(::flatbuffers::Offset<::flatbuffers::String> callSign) {
    fbb_.AddOffset(TrackDetails_Full::VT_CALLSIGN, callSign);
  }
  void add_identAmp(::flatbuffers::Offset<::flatbuffers::String> identAmp) {
    fbb_.AddOffset(TrackDetails_Full::VT_IDENTAMP, identAmp);
  }
  void add_spaceAmp(::flatbuffers::Offset<::flatbuffers::String> spaceAmp) {
    fbb_.AddOffset(TrackDetails_Full::VT_SPACEAMP, spaceAmp);
  }
  void add_spaceAmpConf(int32_t spaceAmpConf) {
    fbb_.AddElement<int32_t>(TrackDetails_Full::VT_SPACEAMPCONF, spaceAmpConf, 0);
  }
  void add_spaceSpecType(::flatbuffers::Offset<::flatbuffers::String> spaceSpecType) {
    fbb_.AddOffset(TrackDetails_Full::VT_SPACESPECTYPE, spaceSpecType);
  }
  void add_acftSubType(::flatbuffers::Offset<::flatbuffers::String> acftSubType) {
    fbb_.AddOffset(TrackDetails_Full::VT_ACFTSUBTYPE, acftSubType);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::String> ts) {
    fbb_.AddOffset(TrackDetails_Full::VT_TS, ts);
  }
  void add_launchTime(::flatbuffers::Offset<::flatbuffers::String> launchTime) {
    fbb_.AddOffset(TrackDetails_Full::VT_LAUNCHTIME, launchTime);
  }
  void add_impactTime(::flatbuffers::Offset<::flatbuffers::String> impactTime) {
    fbb_.AddOffset(TrackDetails_Full::VT_IMPACTTIME, impactTime);
  }
  void add_ftnMsgTs(::flatbuffers::Offset<::flatbuffers::String> ftnMsgTs) {
    fbb_.AddOffset(TrackDetails_Full::VT_FTNMSGTS, ftnMsgTs);
  }
  void add_ftn(::flatbuffers::Offset<::flatbuffers::String> ftn) {
    fbb_.AddOffset(TrackDetails_Full::VT_FTN, ftn);
  }
  void add_ftnCmd(::flatbuffers::Offset<::flatbuffers::String> ftnCmd) {
    fbb_.AddOffset(TrackDetails_Full::VT_FTNCMD, ftnCmd);
  }
  void add_rtnMsgTs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rtnMsgTs) {
    fbb_.AddOffset(TrackDetails_Full::VT_RTNMSGTS, rtnMsgTs);
  }
  void add_rtn(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rtn) {
    fbb_.AddOffset(TrackDetails_Full::VT_RTN, rtn);
  }
  void add_rtnTrkState(::flatbuffers::Offset<::flatbuffers::String> rtnTrkState) {
    fbb_.AddOffset(TrackDetails_Full::VT_RTNTRKSTATE, rtnTrkState);
  }
  void add_rtnCmd(::flatbuffers::Offset<::flatbuffers::String> rtnCmd) {
    fbb_.AddOffset(TrackDetails_Full::VT_RTNCMD, rtnCmd);
  }
  void add_sen(::flatbuffers::Offset<::flatbuffers::String> sen) {
    fbb_.AddOffset(TrackDetails_Full::VT_SEN, sen);
  }
  void add_rptChxref(::flatbuffers::Offset<::flatbuffers::String> rptChxref) {
    fbb_.AddOffset(TrackDetails_Full::VT_RPTCHXREF, rptChxref);
  }
  void add_rptArchived(bool rptArchived) {
    fbb_.AddElement<uint8_t>(TrackDetails_Full::VT_RPTARCHIVED, static_cast<uint8_t>(rptArchived), 0);
  }
  void add_selfReport(bool selfReport) {
    fbb_.AddElement<uint8_t>(TrackDetails_Full::VT_SELFREPORT, static_cast<uint8_t>(selfReport), 0);
  }
  void add_mil2525Bstr(::flatbuffers::Offset<::flatbuffers::String> mil2525Bstr) {
    fbb_.AddOffset(TrackDetails_Full::VT_MIL2525BSTR, mil2525Bstr);
  }
  void add_trnspdrId(::flatbuffers::Offset<::flatbuffers::String> trnspdrId) {
    fbb_.AddOffset(TrackDetails_Full::VT_TRNSPDRID, trnspdrId);
  }
  void add_trnspdrType(::flatbuffers::Offset<::flatbuffers::String> trnspdrType) {
    fbb_.AddOffset(TrackDetails_Full::VT_TRNSPDRTYPE, trnspdrType);
  }
  void add_emitterName(::flatbuffers::Offset<::flatbuffers::String> emitterName) {
    fbb_.AddOffset(TrackDetails_Full::VT_EMITTERNAME, emitterName);
  }
  void add_infoSource(::flatbuffers::Offset<::flatbuffers::String> infoSource) {
    fbb_.AddOffset(TrackDetails_Full::VT_INFOSOURCE, infoSource);
  }
  void add_boosting(bool boosting) {
    fbb_.AddElement<uint8_t>(TrackDetails_Full::VT_BOOSTING, static_cast<uint8_t>(boosting), 0);
  }
  void add_freq(double freq) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_FREQ, freq, 0.0);
  }
  void add_maxFreq(double maxFreq) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_MAXFREQ, maxFreq, 0.0);
  }
  void add_harmonics(::flatbuffers::Offset<::flatbuffers::String> harmonics) {
    fbb_.AddOffset(TrackDetails_Full::VT_HARMONICS, harmonics);
  }
  void add_pri(double pri) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_PRI, pri, 0.0);
  }
  void add_prf(double prf) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_PRF, prf, 0.0);
  }
  void add_pw(double pw) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_PW, pw, 0.0);
  }
  void add_scanType(::flatbuffers::Offset<::flatbuffers::String> scanType) {
    fbb_.AddOffset(TrackDetails_Full::VT_SCANTYPE, scanType);
  }
  void add_scanRate(double scanRate) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_SCANRATE, scanRate, 0.0);
  }
  void add_scn(int32_t scn) {
    fbb_.AddElement<int32_t>(TrackDetails_Full::VT_SCN, scn, 0);
  }
  void add_cI(::flatbuffers::Offset<::flatbuffers::String> cI) {
    fbb_.AddOffset(TrackDetails_Full::VT_CI, cI);
  }
  void add_angElev(double angElev) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_ANGELEV, angElev, 0.0);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_LON, lon, 0.0);
  }
  void add_launchLat(double launchLat) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_LAUNCHLAT, launchLat, 0.0);
  }
  void add_launchLon(double launchLon) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_LAUNCHLON, launchLon, 0.0);
  }
  void add_impactLat(double impactLat) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_IMPACTLAT, impactLat, 0.0);
  }
  void add_impactLon(double impactLon) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_IMPACTLON, impactLon, 0.0);
  }
  void add_polarSingLocLat(double polarSingLocLat) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_POLARSINGLOCLAT, polarSingLocLat, 0.0);
  }
  void add_polarSingLocLon(double polarSingLocLon) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_POLARSINGLOCLON, polarSingLocLon, 0.0);
  }
  void add_azCorrCenterLine(double azCorrCenterLine) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_AZCORRCENTERLINE, azCorrCenterLine, 0.0);
  }
  void add_azCorrArcWidth(double azCorrArcWidth) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_AZCORRARCWIDTH, azCorrArcWidth, 0.0);
  }
  void add_errSemiIntAxis(double errSemiIntAxis) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_ERRSEMIINTAXIS, errSemiIntAxis, 0.0);
  }
  void add_errAreaOrient(double errAreaOrient) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_ERRAREAORIENT, errAreaOrient, 0.0);
  }
  void add_errSemiMajElev(double errSemiMajElev) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_ERRSEMIMAJELEV, errSemiMajElev, 0.0);
  }
  void add_errGeoAreaSwitch(::flatbuffers::Offset<::flatbuffers::String> errGeoAreaSwitch) {
    fbb_.AddOffset(TrackDetails_Full::VT_ERRGEOAREASWITCH, errGeoAreaSwitch);
  }
  void add_burnoutAlt(double burnoutAlt) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_BURNOUTALT, burnoutAlt, 0.0);
  }
  void add_tesEventId(::flatbuffers::Offset<::flatbuffers::String> tesEventId) {
    fbb_.AddOffset(TrackDetails_Full::VT_TESEVENTID, tesEventId);
  }
  void add_spd(double spd) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_SPD, spd, 0.0);
  }
  void add_avgSpd(double avgSpd) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_AVGSPD, avgSpd, 0.0);
  }
  void add_tol(double tol) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_TOL, tol, 0.0);
  }
  void add_alt(double alt) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_ALT, alt, 0.0);
  }
  void add_hdng(double hdng) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_HDNG, hdng, 0.0);
  }
  void add_course(double course) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_COURSE, course, 0.0);
  }
  void add_propRPM(double propRPM) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_PROPRPM, propRPM, 0.0);
  }
  void add_tpk(double tpk) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_TPK, tpk, 0.0);
  }
  void add_coopLocInd(::flatbuffers::Offset<::flatbuffers::String> coopLocInd) {
    fbb_.AddOffset(TrackDetails_Full::VT_COOPLOCIND, coopLocInd);
  }
  void add_maneuverInd(::flatbuffers::Offset<::flatbuffers::String> maneuverInd) {
    fbb_.AddOffset(TrackDetails_Full::VT_MANEUVERIND, maneuverInd);
  }
  void add_launchAouType(::flatbuffers::Offset<::flatbuffers::String> launchAouType) {
    fbb_.AddOffset(TrackDetails_Full::VT_LAUNCHAOUTYPE, launchAouType);
  }
  void add_launchAouData(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> launchAouData) {
    fbb_.AddOffset(TrackDetails_Full::VT_LAUNCHAOUDATA, launchAouData);
  }
  void add_impactAouType(::flatbuffers::Offset<::flatbuffers::String> impactAouType) {
    fbb_.AddOffset(TrackDetails_Full::VT_IMPACTAOUTYPE, impactAouType);
  }
  void add_impactAouData(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> impactAouData) {
    fbb_.AddOffset(TrackDetails_Full::VT_IMPACTAOUDATA, impactAouData);
  }
  void add_aouRptType(::flatbuffers::Offset<::flatbuffers::String> aouRptType) {
    fbb_.AddOffset(TrackDetails_Full::VT_AOURPTTYPE, aouRptType);
  }
  void add_aouRptData(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> aouRptData) {
    fbb_.AddOffset(TrackDetails_Full::VT_AOURPTDATA, aouRptData);
  }
  void add_ecefPos(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> ecefPos) {
    fbb_.AddOffset(TrackDetails_Full::VT_ECEFPOS, ecefPos);
  }
  void add_ecefVel(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> ecefVel) {
    fbb_.AddOffset(TrackDetails_Full::VT_ECEFVEL, ecefVel);
  }
  void add_containment(double containment) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_CONTAINMENT, containment, 0.0);
  }
  void add_cpa(double cpa) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_CPA, cpa, 0.0);
  }
  void add_tcpa(::flatbuffers::Offset<::flatbuffers::String> tcpa) {
    fbb_.AddOffset(TrackDetails_Full::VT_TCPA, tcpa);
  }
  void add_navStatus(::flatbuffers::Offset<::flatbuffers::String> navStatus) {
    fbb_.AddOffset(TrackDetails_Full::VT_NAVSTATUS, navStatus);
  }
  void add_posDeviceType(::flatbuffers::Offset<::flatbuffers::String> posDeviceType) {
    fbb_.AddOffset(TrackDetails_Full::VT_POSDEVICETYPE, posDeviceType);
  }
  void add_aton(::flatbuffers::Offset<::flatbuffers::String> aton) {
    fbb_.AddOffset(TrackDetails_Full::VT_ATON, aton);
  }
  void add_offPosInd(::flatbuffers::Offset<::flatbuffers::String> offPosInd) {
    fbb_.AddOffset(TrackDetails_Full::VT_OFFPOSIND, offPosInd);
  }
  void add_antennaRefDimensions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> antennaRefDimensions) {
    fbb_.AddOffset(TrackDetails_Full::VT_ANTENNAREFDIMENSIONS, antennaRefDimensions);
  }
  void add_shipClass(::flatbuffers::Offset<::flatbuffers::String> shipClass) {
    fbb_.AddOffset(TrackDetails_Full::VT_SHIPCLASS, shipClass);
  }
  void add_imon(int32_t imon) {
    fbb_.AddElement<int32_t>(TrackDetails_Full::VT_IMON, imon, 0);
  }
  void add_mmsi(int32_t mmsi) {
    fbb_.AddElement<int32_t>(TrackDetails_Full::VT_MMSI, mmsi, 0);
  }
  void add_draught(double draught) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_DRAUGHT, draught, 0.0);
  }
  void add_length(double length) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_LENGTH, length, 0.0);
  }
  void add_width(double width) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_WIDTH, width, 0.0);
  }
  void add_cargoType(::flatbuffers::Offset<::flatbuffers::String> cargoType) {
    fbb_.AddOffset(TrackDetails_Full::VT_CARGOTYPE, cargoType);
  }
  void add_appGrp(::flatbuffers::Offset<::flatbuffers::String> appGrp) {
    fbb_.AddOffset(TrackDetails_Full::VT_APPGRP, appGrp);
  }
  void add_hullProf(::flatbuffers::Offset<::flatbuffers::String> hullProf) {
    fbb_.AddOffset(TrackDetails_Full::VT_HULLPROF, hullProf);
  }
  void add_propType(::flatbuffers::Offset<::flatbuffers::String> propType) {
    fbb_.AddOffset(TrackDetails_Full::VT_PROPTYPE, propType);
  }
  void add_numBlades(int32_t numBlades) {
    fbb_.AddElement<int32_t>(TrackDetails_Full::VT_NUMBLADES, numBlades, 0);
  }
  void add_numShafts(int32_t numShafts) {
    fbb_.AddElement<int32_t>(TrackDetails_Full::VT_NUMSHAFTS, numShafts, 0);
  }
  void add_sternType(::flatbuffers::Offset<::flatbuffers::String> sternType) {
    fbb_.AddOffset(TrackDetails_Full::VT_STERNTYPE, sternType);
  }
  void add_vslWt(double vslWt) {
    fbb_.AddElement<double>(TrackDetails_Full::VT_VSLWT, vslWt, 0.0);
  }
  void add_arrTime(::flatbuffers::Offset<::flatbuffers::String> arrTime) {
    fbb_.AddOffset(TrackDetails_Full::VT_ARRTIME, arrTime);
  }
  void add_arrFlag(::flatbuffers::Offset<::flatbuffers::String> arrFlag) {
    fbb_.AddOffset(TrackDetails_Full::VT_ARRFLAG, arrFlag);
  }
  void add_arrCargo(::flatbuffers::Offset<::flatbuffers::String> arrCargo) {
    fbb_.AddOffset(TrackDetails_Full::VT_ARRCARGO, arrCargo);
  }
  void add_arrPort(::flatbuffers::Offset<::flatbuffers::String> arrPort) {
    fbb_.AddOffset(TrackDetails_Full::VT_ARRPORT, arrPort);
  }
  void add_depPort(::flatbuffers::Offset<::flatbuffers::String> depPort) {
    fbb_.AddOffset(TrackDetails_Full::VT_DEPPORT, depPort);
  }
  void add_depFlag(::flatbuffers::Offset<::flatbuffers::String> depFlag) {
    fbb_.AddOffset(TrackDetails_Full::VT_DEPFLAG, depFlag);
  }
  void add_depCargo(::flatbuffers::Offset<::flatbuffers::String> depCargo) {
    fbb_.AddOffset(TrackDetails_Full::VT_DEPCARGO, depCargo);
  }
  void add_desFlag(::flatbuffers::Offset<::flatbuffers::String> desFlag) {
    fbb_.AddOffset(TrackDetails_Full::VT_DESFLAG, desFlag);
  }
  void add_desCargo(::flatbuffers::Offset<::flatbuffers::String> desCargo) {
    fbb_.AddOffset(TrackDetails_Full::VT_DESCARGO, desCargo);
  }
  void add_destination(::flatbuffers::Offset<::flatbuffers::String> destination) {
    fbb_.AddOffset(TrackDetails_Full::VT_DESTINATION, destination);
  }
  void add_eta(::flatbuffers::Offset<::flatbuffers::String> eta) {
    fbb_.AddOffset(TrackDetails_Full::VT_ETA, eta);
  }
  void add_etd(::flatbuffers::Offset<::flatbuffers::String> etd) {
    fbb_.AddOffset(TrackDetails_Full::VT_ETD, etd);
  }
  void add_iff(::flatbuffers::Offset<::flatbuffers::String> iff) {
    fbb_.AddOffset(TrackDetails_Full::VT_IFF, iff);
  }
  void add_emgInd(bool emgInd) {
    fbb_.AddElement<uint8_t>(TrackDetails_Full::VT_EMGIND, static_cast<uint8_t>(emgInd), 0);
  }
  void add_dropPtInd(bool dropPtInd) {
    fbb_.AddElement<uint8_t>(TrackDetails_Full::VT_DROPPTIND, static_cast<uint8_t>(dropPtInd), 0);
  }
  void add_reinforced(bool reinforced) {
    fbb_.AddElement<uint8_t>(TrackDetails_Full::VT_REINFORCED, static_cast<uint8_t>(reinforced), 0);
  }
  void add_reduced(bool reduced) {
    fbb_.AddElement<uint8_t>(TrackDetails_Full::VT_REDUCED, static_cast<uint8_t>(reduced), 0);
  }
  void add_hq(bool hq) {
    fbb_.AddElement<uint8_t>(TrackDetails_Full::VT_HQ, static_cast<uint8_t>(hq), 0);
  }
  void add_dummy(bool dummy) {
    fbb_.AddElement<uint8_t>(TrackDetails_Full::VT_DUMMY, static_cast<uint8_t>(dummy), 0);
  }
  void add_taskForce(bool taskForce) {
    fbb_.AddElement<uint8_t>(TrackDetails_Full::VT_TASKFORCE, static_cast<uint8_t>(taskForce), 0);
  }
  void add_feint(bool feint) {
    fbb_.AddElement<uint8_t>(TrackDetails_Full::VT_FEINT, static_cast<uint8_t>(feint), 0);
  }
  void add_installation(bool installation) {
    fbb_.AddElement<uint8_t>(TrackDetails_Full::VT_INSTALLATION, static_cast<uint8_t>(installation), 0);
  }
  void add_staffCmts(::flatbuffers::Offset<::flatbuffers::String> staffCmts) {
    fbb_.AddOffset(TrackDetails_Full::VT_STAFFCMTS, staffCmts);
  }
  void add_addInfo(::flatbuffers::Offset<::flatbuffers::String> addInfo) {
    fbb_.AddOffset(TrackDetails_Full::VT_ADDINFO, addInfo);
  }
  void add_evalRating(::flatbuffers::Offset<::flatbuffers::String> evalRating) {
    fbb_.AddOffset(TrackDetails_Full::VT_EVALRATING, evalRating);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(TrackDetails_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(TrackDetails_Full::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(TrackDetails_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(TrackDetails_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(TrackDetails_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(TrackDetails_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(TrackDetails_Full::VT_ORIGNETWORK, origNetwork);
  }
  explicit TrackDetails_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<TrackDetails_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<TrackDetails_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<TrackDetails_Full> CreateTrackDetails_Full(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::String> id = 0,
    ::flatbuffers::Offset<::flatbuffers::String> classificationMarking = 0,
    TrackDetails_Full_env_Enum env = TrackDetails_Full_env_Enum_AIR,
    ...
    TrackDetails_Full_objIdent_Enum objIdent = TrackDetails_Full_objIdent_Enum_ASSUMED_FRIEND,
    ...
    TrackDetails_Full_dataMode_Enum dataMode = TrackDetails_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  TrackDetails_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<TrackDetails_Full> CreateTrackDetails_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateTrackDetails_Full(
      _fbb,
      id__,
...
inline const TrackDetails_Full *GetTrackDetails_Full(const void *buf) {
  return ::flatbuffers::GetRoot<TrackDetails_Full>(buf);
}

inline const TrackDetails_Full *GetSizePrefixedTrackDetails_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<TrackDetails_Full>(buf);
}

inline const char *TrackDetails_FullIdentifier() {
  return "TRAC";
}

inline bool TrackDetails_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, TrackDetails_FullIdentifier());
}

inline bool SizePrefixedTrackDetails_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, TrackDetails_FullIdentifier(), true);
}

inline bool VerifyTrackDetails_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<TrackDetails_Full>(TrackDetails_FullIdentifier());
}

inline bool VerifySizePrefixedTrackDetails_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<TrackDetails_Full>(TrackDetails_FullIdentifier());
}

inline void FinishTrackDetails_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<TrackDetails_Full> root) {
  fbb.Finish(root, TrackDetails_FullIdentifier());
}

inline void FinishSizePrefixedTrackDetails_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<TrackDetails_Full> root) {
  fbb.FinishSizePrefixed(root, TrackDetails_FullIdentifier());
}
