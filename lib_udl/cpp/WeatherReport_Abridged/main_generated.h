...
struct WeatherReport_Abridged;
struct WeatherReport_AbridgedBuilder;

enum WeatherReport_Abridged_dataMode_Enum : int8_t {
  ...
  WeatherReport_Abridged_dataMode_Enum_MIN = WeatherReport_Abridged_dataMode_Enum_REAL,
  WeatherReport_Abridged_dataMode_Enum_MAX = WeatherReport_Abridged_dataMode_Enum_EXERCISE
};

inline const WeatherReport_Abridged_dataMode_Enum (&EnumValuesWeatherReport_Abridged_dataMode_Enum())[4] {
  static const WeatherReport_Abridged_dataMode_Enum values[] = {
    WeatherReport_Abridged_dataMode_Enum_REAL,
    WeatherReport_Abridged_dataMode_Enum_TEST,
    WeatherReport_Abridged_dataMode_Enum_SIMULATED,
    WeatherReport_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesWeatherReport_Abridged_dataMode_Enum() {
...
inline const char *EnumNameWeatherReport_Abridged_dataMode_Enum(WeatherReport_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, WeatherReport_Abridged_dataMode_Enum_REAL, WeatherReport_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesWeatherReport_Abridged_dataMode_Enum()[index];
}
...
struct WeatherReport_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef WeatherReport_AbridgedBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_DEWPOINT = 134,
    VT_RELHUMIDITY = 136,
    VT_INDEXREFRACTION = 138,
    VT_SOILMOISTURE = 140,
    VT_SURROUNDINGWEATHER = 142,
    VT_WEATHERAMP = 144,
    VT_CONTRAILHGHTLOWER = 146,
    VT_CONTRAILHGHTUPPER = 148,
    VT_ICINGUPPERLIMIT = 150,
    VT_ICINGLOWERLIMIT = 152,
    VT_ENROUTEWEATHER = 154,
    VT_CCEVENT = 156,
    VT_SRCTYPS = 158,
    VT_SRCIDS = 160,
    VT_ORIGNETWORK = 162,
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  WeatherReport_Abridged_dataMode_Enum dataMode() const {
    return static_cast<WeatherReport_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct WeatherReport_AbridgedBuilder {
  typedef WeatherReport_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_ORIGSENSORID, origSensorId);
  }
  void add_weatherId(::flatbuffers::Offset<::flatbuffers::String> weatherId) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_WEATHERID, weatherId);
  }
  void add_idGroundImagery(::flatbuffers::Offset<::flatbuffers::String> idGroundImagery) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_IDGROUNDIMAGERY, idGroundImagery);
  }
  void add_idSite(::flatbuffers::Offset<::flatbuffers::String> idSite) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_IDSITE, idSite);
  }
  void add_idAirfield(::flatbuffers::Offset<::flatbuffers::String> idAirfield) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_IDAIRFIELD, idAirfield);
  }
  void add_icao(::flatbuffers::Offset<::flatbuffers::String> icao) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_ICAO, icao);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_EXTERNALID, externalId);
  }
  void add_externalLocationId(::flatbuffers::Offset<::flatbuffers::String> externalLocationId) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_EXTERNALLOCATIONID, externalLocationId);
  }
  void add_reportType(::flatbuffers::Offset<::flatbuffers::String> reportType) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_REPORTTYPE, reportType);
  }
  void add_obTime(::flatbuffers::Offset<::flatbuffers::String> obTime) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_OBTIME, obTime);
  }
  void add_forecastStartTime(::flatbuffers::Offset<::flatbuffers::String> forecastStartTime) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_FORECASTSTARTTIME, forecastStartTime);
  }
  void add_forecastEndTime(::flatbuffers::Offset<::flatbuffers::String> forecastEndTime) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_FORECASTENDTIME, forecastEndTime);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_LON, lon, 0.0);
  }
  void add_alt(double alt) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_ALT, alt, 0.0);
  }
  void add_geoPotentialAlt(double geoPotentialAlt) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_GEOPOTENTIALALT, geoPotentialAlt, 0.0);
  }
  void add_dataLevel(::flatbuffers::Offset<::flatbuffers::String> dataLevel) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_DATALEVEL, dataLevel);
  }
  void add_atext(::flatbuffers::Offset<::flatbuffers::String> atext) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_ATEXT, atext);
  }
  void add_agjson(::flatbuffers::Offset<::flatbuffers::String> agjson) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_AGJSON, agjson);
  }
  void add_atype(::flatbuffers::Offset<::flatbuffers::String> atype) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_ATYPE, atype);
  }
  void add_andims(int32_t andims) {
    fbb_.AddElement<int32_t>(WeatherReport_Abridged::VT_ANDIMS, andims, 0);
  }
  void add_asrid(int32_t asrid) {
    fbb_.AddElement<int32_t>(WeatherReport_Abridged::VT_ASRID, asrid, 0);
  }
  void add_windSpd(double windSpd) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_WINDSPD, windSpd, 0.0);
  }
  void add_windSpdAvg(double windSpdAvg) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_WINDSPDAVG, windSpdAvg, 0.0);
  }
  void add_windGust(double windGust) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_WINDGUST, windGust, 0.0);
  }
  void add_windGust10(double windGust10) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_WINDGUST10, windGust10, 0.0);
  }
  void add_vshear(double vshear) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_VSHEAR, vshear, 0.0);
  }
  void add_hshear(double hshear) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_HSHEAR, hshear, 0.0);
  }
  void add_radVel(double radVel) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_RADVEL, radVel, 0.0);
  }
  void add_radVelBeam1(double radVelBeam1) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_RADVELBEAM1, radVelBeam1, 0.0);
  }
  void add_radVelBeam2(double radVelBeam2) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_RADVELBEAM2, radVelBeam2, 0.0);
  }
  void add_radVelBeam3(double radVelBeam3) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_RADVELBEAM3, radVelBeam3, 0.0);
  }
  void add_radVelBeam4(double radVelBeam4) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_RADVELBEAM4, radVelBeam4, 0.0);
  }
  void add_radVelBeam5(double radVelBeam5) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_RADVELBEAM5, radVelBeam5, 0.0);
  }
  void add_windDir(double windDir) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_WINDDIR, windDir, 0.0);
  }
  void add_windDirAvg(double windDirAvg) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_WINDDIRAVG, windDirAvg, 0.0);
  }
  void add_windDirPeak(double windDirPeak) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_WINDDIRPEAK, windDirPeak, 0.0);
  }
  void add_windDirPeak10(double windDirPeak10) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_WINDDIRPEAK10, windDirPeak10, 0.0);
  }
  void add_windChill(double windChill) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_WINDCHILL, windChill, 0.0);
  }
  void add_dirDev(double dirDev) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_DIRDEV, dirDev, 0.0);
  }
  void add_windVar(bool windVar) {
    fbb_.AddElement<uint8_t>(WeatherReport_Abridged::VT_WINDVAR, static_cast<uint8_t>(windVar), 0);
  }
  void add_windCov(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> windCov) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_WINDCOV, windCov);
  }
  void add_cloudCover(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> cloudCover) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_CLOUDCOVER, cloudCover);
  }
  void add_cloudHght(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> cloudHght) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_CLOUDHGHT, cloudHght);
  }
  void add_actWeather(::flatbuffers::Offset<::flatbuffers::String> actWeather) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_ACTWEATHER, actWeather);
  }
  void add_weatherDesc(::flatbuffers::Offset<::flatbuffers::String> weatherDesc) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_WEATHERDESC, weatherDesc);
  }
  void add_weatherInt(::flatbuffers::Offset<::flatbuffers::String> weatherInt) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_WEATHERINT, weatherInt);
  }
  void add_rawMETAR(::flatbuffers::Offset<::flatbuffers::String> rawMETAR) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_RAWMETAR, rawMETAR);
  }
  void add_rawTAF(::flatbuffers::Offset<::flatbuffers::String> rawTAF) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_RAWTAF, rawTAF);
  }
  void add_qnh(double qnh) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_QNH, qnh, 0.0);
  }
  void add_visibility(double visibility) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_VISIBILITY, visibility, 0.0);
  }
  void add_temperature(double temperature) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_TEMPERATURE, temperature, 0.0);
  }
  void add_soilTemp(double soilTemp) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_SOILTEMP, soilTemp, 0.0);
  }
  void add_barPress(double barPress) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_BARPRESS, barPress, 0.0);
  }
  void add_precipRate(double precipRate) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_PRECIPRATE, precipRate, 0.0);
  }
  void add_rainHour(double rainHour) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_RAINHOUR, rainHour, 0.0);
  }
  void add_solarRad(double solarRad) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_SOLARRAD, solarRad, 0.0);
  }
  void add_difRad(double difRad) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_DIFRAD, difRad, 0.0);
  }
  void add_refRad(double refRad) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_REFRAD, refRad, 0.0);
  }
  void add_senlat(double senlat) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_SENLAT, senlat, 0.0);
  }
  void add_senlon(double senlon) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_SENLON, senlon, 0.0);
  }
  void add_senalt(double senalt) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_SENALT, senalt, 0.0);
  }
  void add_dewPoint(double dewPoint) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_DEWPOINT, dewPoint, 0.0);
  }
  void add_relHumidity(double relHumidity) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_RELHUMIDITY, relHumidity, 0.0);
  }
  void add_indexRefraction(double indexRefraction) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_INDEXREFRACTION, indexRefraction, 0.0);
  }
  void add_soilMoisture(double soilMoisture) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_SOILMOISTURE, soilMoisture, 0.0);
  }
  void add_surroundingWeather(::flatbuffers::Offset<::flatbuffers::String> surroundingWeather) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_SURROUNDINGWEATHER, surroundingWeather);
  }
  void add_weatherAmp(::flatbuffers::Offset<::flatbuffers::String> weatherAmp) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_WEATHERAMP, weatherAmp);
  }
  void add_contrailHghtLower(double contrailHghtLower) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_CONTRAILHGHTLOWER, contrailHghtLower, 0.0);
  }
  void add_contrailHghtUpper(double contrailHghtUpper) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_CONTRAILHGHTUPPER, contrailHghtUpper, 0.0);
  }
  void add_icingUpperLimit(double icingUpperLimit) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_ICINGUPPERLIMIT, icingUpperLimit, 0.0);
  }
  void add_icingLowerLimit(double icingLowerLimit) {
    fbb_.AddElement<double>(WeatherReport_Abridged::VT_ICINGLOWERLIMIT, icingLowerLimit, 0.0);
  }
  void add_enRouteWeather(::flatbuffers::Offset<::flatbuffers::String> enRouteWeather) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_ENROUTEWEATHER, enRouteWeather);
  }
  void add_ccEvent(bool ccEvent) {
    fbb_.AddElement<uint8_t>(WeatherReport_Abridged::VT_CCEVENT, static_cast<uint8_t>(ccEvent), 0);
  }
  void add_srcTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcTyps) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_SRCTYPS, srcTyps);
  }
  void add_srcIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcIds) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_SRCIDS, srcIds);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(WeatherReport_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(WeatherReport_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(WeatherReport_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit WeatherReport_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<WeatherReport_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<WeatherReport_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<WeatherReport_Abridged> CreateWeatherReport_Abridged(
    ...
    WeatherReport_Abridged_dataMode_Enum dataMode = WeatherReport_Abridged_dataMode_Enum_REAL) {
  WeatherReport_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<WeatherReport_Abridged> CreateWeatherReport_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const WeatherReport_Abridged *GetWeatherReport_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<WeatherReport_Abridged>(buf);
}

inline const WeatherReport_Abridged *GetSizePrefixedWeatherReport_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<WeatherReport_Abridged>(buf);
}

inline const char *WeatherReport_AbridgedIdentifier() {
  return "WEAT";
}

inline bool WeatherReport_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, WeatherReport_AbridgedIdentifier());
}

inline bool SizePrefixedWeatherReport_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, WeatherReport_AbridgedIdentifier(), true);
}

inline bool VerifyWeatherReport_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<WeatherReport_Abridged>(WeatherReport_AbridgedIdentifier());
}

inline bool VerifySizePrefixedWeatherReport_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<WeatherReport_Abridged>(WeatherReport_AbridgedIdentifier());
}

inline void FinishWeatherReport_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<WeatherReport_Abridged> root) {
  fbb.Finish(root, WeatherReport_AbridgedIdentifier());
}

inline void FinishSizePrefixedWeatherReport_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<WeatherReport_Abridged> root) {
  fbb.FinishSizePrefixed(root, WeatherReport_AbridgedIdentifier());
}
