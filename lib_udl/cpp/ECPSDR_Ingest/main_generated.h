...
struct ECPSDR_Ingest;
struct ECPSDR_IngestBuilder;

enum ECPSDR_Ingest_dataMode_Enum : int8_t {
  ...
  ECPSDR_Ingest_dataMode_Enum_MIN = ECPSDR_Ingest_dataMode_Enum_REAL,
  ECPSDR_Ingest_dataMode_Enum_MAX = ECPSDR_Ingest_dataMode_Enum_EXERCISE
};

inline const ECPSDR_Ingest_dataMode_Enum (&EnumValuesECPSDR_Ingest_dataMode_Enum())[4] {
  static const ECPSDR_Ingest_dataMode_Enum values[] = {
    ECPSDR_Ingest_dataMode_Enum_REAL,
    ECPSDR_Ingest_dataMode_Enum_TEST,
    ECPSDR_Ingest_dataMode_Enum_SIMULATED,
    ECPSDR_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesECPSDR_Ingest_dataMode_Enum() {
...
inline const char *EnumNameECPSDR_Ingest_dataMode_Enum(ECPSDR_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, ECPSDR_Ingest_dataMode_Enum_REAL, ECPSDR_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesECPSDR_Ingest_dataMode_Enum()[index];
}
...
struct ECPSDR_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef ECPSDR_IngestBuilder Builder;
  ...
  /// Example: /// Example: TEST
  /// Constraints: Minimum length = 1, Maximum length = 32
  ECPSDR_Ingest_dataMode_Enum dataMode() const {
    return static_cast<ECPSDR_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct ECPSDR_IngestBuilder {
  typedef ECPSDR_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(ECPSDR_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(ECPSDR_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(ECPSDR_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(ECPSDR_Ingest::VT_ORIGOBJECTID, origObjectId);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(ECPSDR_Ingest::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(ECPSDR_Ingest::VT_ORIGSENSORID, origSensorId);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(ECPSDR_Ingest::VT_TYPE, type);
  }
  void add_msgTime(::flatbuffers::Offset<::flatbuffers::String> msgTime) {
    fbb_.AddOffset(ECPSDR_Ingest::VT_MSGTIME, msgTime);
  }
  void add_obTime(::flatbuffers::Offset<::flatbuffers::String> obTime) {
    fbb_.AddOffset(ECPSDR_Ingest::VT_OBTIME, obTime);
  }
  void add_retransmit(bool retransmit) {
    fbb_.AddElement<uint8_t>(ECPSDR_Ingest::VT_RETRANSMIT, static_cast<uint8_t>(retransmit), 0);
  }
  void add_senMode(::flatbuffers::Offset<::flatbuffers::String> senMode) {
    fbb_.AddOffset(ECPSDR_Ingest::VT_SENMODE, senMode);
  }
  void add_dosBias(int32_t dosBias) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_DOSBIAS, dosBias, 0);
  }
  void add_asl5VCurrMon(int32_t asl5VCurrMon) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_ASL5VCURRMON, asl5VCurrMon, 0);
  }
  void add_dsl5VCurrMon(int32_t dsl5VCurrMon) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_DSL5VCURRMON, dsl5VCurrMon, 0);
  }
  void add_psTempMon(int32_t psTempMon) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_PSTEMPMON, psTempMon, 0);
  }
  void add_cdsPlateVMon(int32_t cdsPlateVMon) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_CDSPLATEVMON, cdsPlateVMon, 0);
  }
  void add_cdsRefVMon(int32_t cdsRefVMon) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_CDSREFVMON, cdsRefVMon, 0);
  }
  void add_mpTemp(int32_t mpTemp) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_MPTEMP, mpTemp, 0);
  }
  void add_vRef(int32_t vRef) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_VREF, vRef, 0);
  }
  void add_pd1SigLev(int32_t pd1SigLev) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_PD1SIGLEV, pd1SigLev, 0);
  }
  void add_pd2SigLev(int32_t pd2SigLev) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_PD2SIGLEV, pd2SigLev, 0);
  }
  void add_esdTrigCountL(int32_t esdTrigCountL) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_ESDTRIGCOUNTL, esdTrigCountL, 0);
  }
  void add_esdTrigCountH(int32_t esdTrigCountH) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_ESDTRIGCOUNTH, esdTrigCountH, 0);
  }
  void add_lowLetL(int32_t lowLetL) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_LOWLETL, lowLetL, 0);
  }
  void add_lowLetM(int32_t lowLetM) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_LOWLETM, lowLetM, 0);
  }
  void add_medLet1L(int32_t medLet1L) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_MEDLET1L, medLet1L, 0);
  }
  void add_medLet1M(int32_t medLet1M) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_MEDLET1M, medLet1M, 0);
  }
  void add_medLet2L(int32_t medLet2L) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_MEDLET2L, medLet2L, 0);
  }
  void add_medLet2M(int32_t medLet2M) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_MEDLET2M, medLet2M, 0);
  }
  void add_medLet3L(int32_t medLet3L) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_MEDLET3L, medLet3L, 0);
  }
  void add_medLet3M(int32_t medLet3M) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_MEDLET3M, medLet3M, 0);
  }
  void add_medLet4L(int32_t medLet4L) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_MEDLET4L, medLet4L, 0);
  }
  void add_medLet4M(int32_t medLet4M) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_MEDLET4M, medLet4M, 0);
  }
  void add_hiLetL(int32_t hiLetL) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_HILETL, hiLetL, 0);
  }
  void add_hiLetM(int32_t hiLetM) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_HILETM, hiLetM, 0);
  }
  void add_surfDosL(int32_t surfDosL) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_SURFDOSL, surfDosL, 0);
  }
  void add_surfDosM(int32_t surfDosM) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_SURFDOSM, surfDosM, 0);
  }
  void add_surfDosH(int32_t surfDosH) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_SURFDOSH, surfDosH, 0);
  }
  void add_surfDosChargeL(int32_t surfDosChargeL) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_SURFDOSCHARGEL, surfDosChargeL, 0);
  }
  void add_surfDosChargeH(int32_t surfDosChargeH) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_SURFDOSCHARGEH, surfDosChargeH, 0);
  }
  void add_surfDosStat(int32_t surfDosStat) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_SURFDOSSTAT, surfDosStat, 0);
  }
  void add_cdsThrottle(int32_t cdsThrottle) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_CDSTHROTTLE, cdsThrottle, 0);
  }
  void add_cdsThreshold(int32_t cdsThreshold) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_CDSTHRESHOLD, cdsThreshold, 0);
  }
  void add_checksum(int32_t checksum) {
    fbb_.AddElement<int32_t>(ECPSDR_Ingest::VT_CHECKSUM, checksum, 0);
  }
  void add_transientData(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> transientData) {
    fbb_.AddOffset(ECPSDR_Ingest::VT_TRANSIENTDATA, transientData);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(ECPSDR_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(ECPSDR_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(ECPSDR_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(ECPSDR_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(ECPSDR_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(ECPSDR_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(ECPSDR_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit ECPSDR_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<ECPSDR_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<ECPSDR_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<ECPSDR_Ingest> CreateECPSDR_Ingest(
    ...
    ECPSDR_Ingest_dataMode_Enum dataMode = ECPSDR_Ingest_dataMode_Enum_REAL) {
  ECPSDR_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<ECPSDR_Ingest> CreateECPSDR_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const ECPSDR_Ingest *GetECPSDR_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<ECPSDR_Ingest>(buf);
}

inline const ECPSDR_Ingest *GetSizePrefixedECPSDR_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<ECPSDR_Ingest>(buf);
}

inline const char *ECPSDR_IngestIdentifier() {
  return "ECPS";
}

inline bool ECPSDR_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ECPSDR_IngestIdentifier());
}

inline bool SizePrefixedECPSDR_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ECPSDR_IngestIdentifier(), true);
}

inline bool VerifyECPSDR_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<ECPSDR_Ingest>(ECPSDR_IngestIdentifier());
}

inline bool VerifySizePrefixedECPSDR_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<ECPSDR_Ingest>(ECPSDR_IngestIdentifier());
}

inline void FinishECPSDR_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ECPSDR_Ingest> root) {
  fbb.Finish(root, ECPSDR_IngestIdentifier());
}

inline void FinishSizePrefixedECPSDR_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ECPSDR_Ingest> root) {
  fbb.FinishSizePrefixed(root, ECPSDR_IngestIdentifier());
}
