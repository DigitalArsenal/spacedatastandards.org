...
struct AttitudeData_Full;
struct AttitudeData_FullBuilder;

enum AttitudeData_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  AttitudeData_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  AttitudeData_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  AttitudeData_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  AttitudeData_Full_dataMode_Enum_EXERCISE = 3,
  AttitudeData_Full_dataMode_Enum_MIN = AttitudeData_Full_dataMode_Enum_REAL,
  AttitudeData_Full_dataMode_Enum_MAX = AttitudeData_Full_dataMode_Enum_EXERCISE
};

inline const AttitudeData_Full_dataMode_Enum (&EnumValuesAttitudeData_Full_dataMode_Enum())[4] {
  static const AttitudeData_Full_dataMode_Enum values[] = {
    AttitudeData_Full_dataMode_Enum_REAL,
    AttitudeData_Full_dataMode_Enum_TEST,
    AttitudeData_Full_dataMode_Enum_SIMULATED,
    AttitudeData_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAttitudeData_Full_dataMode_Enum() {
...
inline const char *EnumNameAttitudeData_Full_dataMode_Enum(AttitudeData_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AttitudeData_Full_dataMode_Enum_REAL, AttitudeData_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAttitudeData_Full_dataMode_Enum()[index];
}
...
struct AttitudeData_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AttitudeData_FullBuilder Builder;
  ...
  AttitudeData_Full_dataMode_Enum dataMode() const {
    return static_cast<AttitudeData_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AttitudeData_FullBuilder {
  typedef AttitudeData_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AttitudeData_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AttitudeData_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_asId(::flatbuffers::Offset<::flatbuffers::String> asId) {
    fbb_.AddOffset(AttitudeData_Full::VT_ASID, asId);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(AttitudeData_Full::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(AttitudeData_Full::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(AttitudeData_Full::VT_ORIGOBJECTID, origObjectId);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::String> ts) {
    fbb_.AddOffset(AttitudeData_Full::VT_TS, ts);
  }
  void add_motionType(::flatbuffers::Offset<::flatbuffers::String> motionType) {
    fbb_.AddOffset(AttitudeData_Full::VT_MOTIONTYPE, motionType);
  }
  void add_q1(double q1) {
    fbb_.AddElement<double>(AttitudeData_Full::VT_Q1, q1, 0.0);
  }
  void add_q2(double q2) {
    fbb_.AddElement<double>(AttitudeData_Full::VT_Q2, q2, 0.0);
  }
  void add_q3(double q3) {
    fbb_.AddElement<double>(AttitudeData_Full::VT_Q3, q3, 0.0);
  }
  void add_qc(double qc) {
    fbb_.AddElement<double>(AttitudeData_Full::VT_QC, qc, 0.0);
  }
  void add_q1Dot(double q1Dot) {
    fbb_.AddElement<double>(AttitudeData_Full::VT_Q1DOT, q1Dot, 0.0);
  }
  void add_q2Dot(double q2Dot) {
    fbb_.AddElement<double>(AttitudeData_Full::VT_Q2DOT, q2Dot, 0.0);
  }
  void add_q3Dot(double q3Dot) {
    fbb_.AddElement<double>(AttitudeData_Full::VT_Q3DOT, q3Dot, 0.0);
  }
  void add_qcDot(double qcDot) {
    fbb_.AddElement<double>(AttitudeData_Full::VT_QCDOT, qcDot, 0.0);
  }
  void add_xAngle(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> xAngle) {
    fbb_.AddOffset(AttitudeData_Full::VT_XANGLE, xAngle);
  }
  void add_yAngle(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> yAngle) {
    fbb_.AddOffset(AttitudeData_Full::VT_YANGLE, yAngle);
  }
  void add_zAngle(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> zAngle) {
    fbb_.AddOffset(AttitudeData_Full::VT_ZANGLE, zAngle);
  }
  void add_xRate(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> xRate) {
    fbb_.AddOffset(AttitudeData_Full::VT_XRATE, xRate);
  }
  void add_yRate(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> yRate) {
    fbb_.AddOffset(AttitudeData_Full::VT_YRATE, yRate);
  }
  void add_zRate(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> zRate) {
    fbb_.AddOffset(AttitudeData_Full::VT_ZRATE, zRate);
  }
  void add_ra(double ra) {
    fbb_.AddElement<double>(AttitudeData_Full::VT_RA, ra, 0.0);
  }
  void add_declination(double declination) {
    fbb_.AddElement<double>(AttitudeData_Full::VT_DECLINATION, declination, 0.0);
  }
  void add_coningAngle(double coningAngle) {
    fbb_.AddElement<double>(AttitudeData_Full::VT_CONINGANGLE, coningAngle, 0.0);
  }
  void add_precPeriod(double precPeriod) {
    fbb_.AddElement<double>(AttitudeData_Full::VT_PRECPERIOD, precPeriod, 0.0);
  }
  void add_spinPeriod(double spinPeriod) {
    fbb_.AddElement<double>(AttitudeData_Full::VT_SPINPERIOD, spinPeriod, 0.0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AttitudeData_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AttitudeData_Full::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AttitudeData_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AttitudeData_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(AttitudeData_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AttitudeData_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AttitudeData_Full::VT_ORIGNETWORK, origNetwork);
  }
  explicit AttitudeData_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AttitudeData_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AttitudeData_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AttitudeData_Full> CreateAttitudeData_Full(
    ...
    AttitudeData_Full_dataMode_Enum dataMode = AttitudeData_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  AttitudeData_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AttitudeData_Full> CreateAttitudeData_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAttitudeData_Full(
      _fbb,
      id__,
...
inline const AttitudeData_Full *GetAttitudeData_Full(const void *buf) {
  return ::flatbuffers::GetRoot<AttitudeData_Full>(buf);
}

inline const AttitudeData_Full *GetSizePrefixedAttitudeData_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AttitudeData_Full>(buf);
}

inline const char *AttitudeData_FullIdentifier() {
  return "ATTI";
}

inline bool AttitudeData_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AttitudeData_FullIdentifier());
}

inline bool SizePrefixedAttitudeData_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AttitudeData_FullIdentifier(), true);
}

inline bool VerifyAttitudeData_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AttitudeData_Full>(AttitudeData_FullIdentifier());
}

inline bool VerifySizePrefixedAttitudeData_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AttitudeData_Full>(AttitudeData_FullIdentifier());
}

inline void FinishAttitudeData_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AttitudeData_Full> root) {
  fbb.Finish(root, AttitudeData_FullIdentifier());
}

inline void FinishSizePrefixedAttitudeData_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AttitudeData_Full> root) {
  fbb.FinishSizePrefixed(root, AttitudeData_FullIdentifier());
}
