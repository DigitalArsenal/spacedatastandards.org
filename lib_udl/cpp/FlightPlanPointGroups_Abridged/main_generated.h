...
struct FlightPlanPointGroups_Abridged;
...
struct FlightPlanPointGroups_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef FlightPlanPointGroups_AbridgedBuilder Builder;
...
struct FlightPlanPointGroups_AbridgedBuilder {
  typedef FlightPlanPointGroups_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_pointGroupName(::flatbuffers::Offset<::flatbuffers::String> pointGroupName) {
    fbb_.AddOffset(FlightPlanPointGroups_Abridged::VT_POINTGROUPNAME, pointGroupName);
  }
  void add_worstFuelCase(::flatbuffers::Offset<::flatbuffers::String> worstFuelCase) {
    fbb_.AddOffset(FlightPlanPointGroups_Abridged::VT_WORSTFUELCASE, worstFuelCase);
  }
  void add_lsafName(::flatbuffers::Offset<::flatbuffers::String> lsafName) {
    fbb_.AddOffset(FlightPlanPointGroups_Abridged::VT_LSAFNAME, lsafName);
  }
  void add_lsafDistance(double lsafDistance) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Abridged::VT_LSAFDISTANCE, lsafDistance, 0.0);
  }
  void add_fsafDistance(double fsafDistance) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Abridged::VT_FSAFDISTANCE, fsafDistance, 0.0);
  }
  void add_etopsDistance(double etopsDistance) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Abridged::VT_ETOPSDISTANCE, etopsDistance, 0.0);
  }
  void add_lsafTime(::flatbuffers::Offset<::flatbuffers::String> lsafTime) {
    fbb_.AddOffset(FlightPlanPointGroups_Abridged::VT_LSAFTIME, lsafTime);
  }
  void add_fsafTime(::flatbuffers::Offset<::flatbuffers::String> fsafTime) {
    fbb_.AddOffset(FlightPlanPointGroups_Abridged::VT_FSAFTIME, fsafTime);
  }
  void add_etopsTime(::flatbuffers::Offset<::flatbuffers::String> etopsTime) {
    fbb_.AddOffset(FlightPlanPointGroups_Abridged::VT_ETOPSTIME, etopsTime);
  }
  void add_lsafAvgWindFactor(double lsafAvgWindFactor) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Abridged::VT_LSAFAVGWINDFACTOR, lsafAvgWindFactor, 0.0);
  }
  void add_fsafAvgWindFactor(double fsafAvgWindFactor) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Abridged::VT_FSAFAVGWINDFACTOR, fsafAvgWindFactor, 0.0);
  }
  void add_etopsAvgWindFactor(double etopsAvgWindFactor) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Abridged::VT_ETOPSAVGWINDFACTOR, etopsAvgWindFactor, 0.0);
  }
  void add_lsafTempDev(double lsafTempDev) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Abridged::VT_LSAFTEMPDEV, lsafTempDev, 0.0);
  }
  void add_fsafTempDev(double fsafTempDev) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Abridged::VT_FSAFTEMPDEV, fsafTempDev, 0.0);
  }
  void add_etopsTempDev(double etopsTempDev) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Abridged::VT_ETOPSTEMPDEV, etopsTempDev, 0.0);
  }
  void add_lsafReqFuel(double lsafReqFuel) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Abridged::VT_LSAFREQFUEL, lsafReqFuel, 0.0);
  }
  void add_fsafReqFuel(double fsafReqFuel) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Abridged::VT_FSAFREQFUEL, fsafReqFuel, 0.0);
  }
  void add_etopsReqFuel(double etopsReqFuel) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Abridged::VT_ETOPSREQFUEL, etopsReqFuel, 0.0);
  }
  void add_fromTakeoffTime(::flatbuffers::Offset<::flatbuffers::String> fromTakeoffTime) {
    fbb_.AddOffset(FlightPlanPointGroups_Abridged::VT_FROMTAKEOFFTIME, fromTakeoffTime);
  }
  void add_plannedFuel(double plannedFuel) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Abridged::VT_PLANNEDFUEL, plannedFuel, 0.0);
  }
  void add_fuelCalcAlt(double fuelCalcAlt) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Abridged::VT_FUELCALCALT, fuelCalcAlt, 0.0);
  }
  void add_fuelCalcSpd(double fuelCalcSpd) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Abridged::VT_FUELCALCSPD, fuelCalcSpd, 0.0);
  }
  void add_avgFuelFlow(double avgFuelFlow) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Abridged::VT_AVGFUELFLOW, avgFuelFlow, 0.0);
  }
  void add_flightPlanPoints(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> flightPlanPoints) {
    fbb_.AddOffset(FlightPlanPointGroups_Abridged::VT_FLIGHTPLANPOINTS, flightPlanPoints);
  }
  explicit FlightPlanPointGroups_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<FlightPlanPointGroups_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<FlightPlanPointGroups_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<FlightPlanPointGroups_Abridged> CreateFlightPlanPointGroups_Abridged(
  ...
  FlightPlanPointGroups_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<FlightPlanPointGroups_Abridged> CreateFlightPlanPointGroups_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const FlightPlanPointGroups_Abridged *GetFlightPlanPointGroups_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<FlightPlanPointGroups_Abridged>(buf);
}

inline const FlightPlanPointGroups_Abridged *GetSizePrefixedFlightPlanPointGroups_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<FlightPlanPointGroups_Abridged>(buf);
}

inline const char *FlightPlanPointGroups_AbridgedIdentifier() {
  return "FLIG";
}

inline bool FlightPlanPointGroups_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, FlightPlanPointGroups_AbridgedIdentifier());
}

inline bool SizePrefixedFlightPlanPointGroups_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, FlightPlanPointGroups_AbridgedIdentifier(), true);
}

inline bool VerifyFlightPlanPointGroups_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<FlightPlanPointGroups_Abridged>(FlightPlanPointGroups_AbridgedIdentifier());
}

inline bool VerifySizePrefixedFlightPlanPointGroups_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<FlightPlanPointGroups_Abridged>(FlightPlanPointGroups_AbridgedIdentifier());
}

inline void FinishFlightPlanPointGroups_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<FlightPlanPointGroups_Abridged> root) {
  fbb.Finish(root, FlightPlanPointGroups_AbridgedIdentifier());
}

inline void FinishSizePrefixedFlightPlanPointGroups_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<FlightPlanPointGroups_Abridged> root) {
  fbb.FinishSizePrefixed(root, FlightPlanPointGroups_AbridgedIdentifier());
}
