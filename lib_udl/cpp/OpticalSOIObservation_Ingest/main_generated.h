...
struct OpticalSOIObservation_Ingest;
struct OpticalSOIObservation_IngestBuilder;

/// /// An Optical SOI record contains observation information taken from a sensor about a Space Object.
struct OpticalSOIObservation_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef OpticalSOIObservation_IngestBuilder Builder;
...
struct OpticalSOIObservation_IngestBuilder {
  typedef OpticalSOIObservation_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_obStartTime(::flatbuffers::Offset<::flatbuffers::String> obStartTime) {
    fbb_.AddOffset(OpticalSOIObservation_Ingest::VT_OBSTARTTIME, obStartTime);
  }
  void add_intensityTimes(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> intensityTimes) {
    fbb_.AddOffset(OpticalSOIObservation_Ingest::VT_INTENSITYTIMES, intensityTimes);
  }
  void add_currentSpectralFilterNum(int32_t currentSpectralFilterNum) {
    fbb_.AddElement<int32_t>(OpticalSOIObservation_Ingest::VT_CURRENTSPECTRALFILTERNUM, currentSpectralFilterNum, 0);
  }
  void add_expDuration(double expDuration) {
    fbb_.AddElement<double>(OpticalSOIObservation_Ingest::VT_EXPDURATION, expDuration, 0.0);
  }
  void add_intensities(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> intensities) {
    fbb_.AddOffset(OpticalSOIObservation_Ingest::VT_INTENSITIES, intensities);
  }
  void add_extinctionCoeffs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> extinctionCoeffs) {
    fbb_.AddOffset(OpticalSOIObservation_Ingest::VT_EXTINCTIONCOEFFS, extinctionCoeffs);
  }
  ...
  void add_numCorrelatedStars(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> numCorrelatedStars) {
    fbb_.AddOffset(OpticalSOIObservation_Ingest::VT_NUMCORRELATEDSTARS, numCorrelatedStars);
  }
  void add_zeroPoints(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> zeroPoints) {
    fbb_.AddOffset(OpticalSOIObservation_Ingest::VT_ZEROPOINTS, zeroPoints);
  }
  void add_ras(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> ras) {
    fbb_.AddOffset(OpticalSOIObservation_Ingest::VT_RAS, ras);
  }
  void add_declinations(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> declinations) {
    fbb_.AddOffset(OpticalSOIObservation_Ingest::VT_DECLINATIONS, declinations);
  }
  void add_raRates(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> raRates) {
    fbb_.AddOffset(OpticalSOIObservation_Ingest::VT_RARATES, raRates);
  }
  void add_percentSats(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> percentSats) {
    fbb_.AddOffset(OpticalSOIObservation_Ingest::VT_PERCENTSATS, percentSats);
  }
  explicit OpticalSOIObservation_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<OpticalSOIObservation_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<OpticalSOIObservation_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<OpticalSOIObservation_Ingest> CreateOpticalSOIObservation_Ingest(
  ...
  OpticalSOIObservation_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<OpticalSOIObservation_Ingest> CreateOpticalSOIObservation_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateOpticalSOIObservation_Ingest(
      _fbb,
      obStartTime__,
      intensityTimes__,
...
inline const OpticalSOIObservation_Ingest *GetOpticalSOIObservation_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<OpticalSOIObservation_Ingest>(buf);
}

inline const OpticalSOIObservation_Ingest *GetSizePrefixedOpticalSOIObservation_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<OpticalSOIObservation_Ingest>(buf);
}

inline const char *OpticalSOIObservation_IngestIdentifier() {
  return "OPTI";
}

inline bool OpticalSOIObservation_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OpticalSOIObservation_IngestIdentifier());
}

inline bool SizePrefixedOpticalSOIObservation_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OpticalSOIObservation_IngestIdentifier(), true);
}

inline bool VerifyOpticalSOIObservation_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<OpticalSOIObservation_Ingest>(OpticalSOIObservation_IngestIdentifier());
}

inline bool VerifySizePrefixedOpticalSOIObservation_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<OpticalSOIObservation_Ingest>(OpticalSOIObservation_IngestIdentifier());
}

inline void FinishOpticalSOIObservation_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OpticalSOIObservation_Ingest> root) {
  fbb.Finish(root, OpticalSOIObservation_IngestIdentifier());
}

inline void FinishSizePrefixedOpticalSOIObservation_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OpticalSOIObservation_Ingest> root) {
  fbb.FinishSizePrefixed(root, OpticalSOIObservation_IngestIdentifier());
}
