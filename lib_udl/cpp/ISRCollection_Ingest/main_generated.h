...
struct ISRCollection_Ingest;
struct ISRCollection_IngestBuilder;

enum ISRCollection_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  ISRCollection_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  ISRCollection_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  ISRCollection_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  ISRCollection_Ingest_dataMode_Enum_EXERCISE = 3,
  ISRCollection_Ingest_dataMode_Enum_MIN = ISRCollection_Ingest_dataMode_Enum_REAL,
  ISRCollection_Ingest_dataMode_Enum_MAX = ISRCollection_Ingest_dataMode_Enum_EXERCISE
};

inline const ISRCollection_Ingest_dataMode_Enum (&EnumValuesISRCollection_Ingest_dataMode_Enum())[4] {
  static const ISRCollection_Ingest_dataMode_Enum values[] = {
    ISRCollection_Ingest_dataMode_Enum_REAL,
    ISRCollection_Ingest_dataMode_Enum_TEST,
    ISRCollection_Ingest_dataMode_Enum_SIMULATED,
    ISRCollection_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesISRCollection_Ingest_dataMode_Enum() {
...
inline const char *EnumNameISRCollection_Ingest_dataMode_Enum(ISRCollection_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, ISRCollection_Ingest_dataMode_Enum_REAL, ISRCollection_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesISRCollection_Ingest_dataMode_Enum()[index];
}

/// /// ISR Collection data.
struct ISRCollection_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef ISRCollection_IngestBuilder Builder;
  ...
  ISRCollection_Ingest_dataMode_Enum dataMode() const {
    return static_cast<ISRCollection_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct ISRCollection_IngestBuilder {
  typedef ISRCollection_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idexVersion(int32_t idexVersion) {
    fbb_.AddElement<int32_t>(ISRCollection_Ingest::VT_IDEXVERSION, idexVersion, 0);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_NAME, name);
  }
  void add_missionId(::flatbuffers::Offset<::flatbuffers::String> missionId) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_MISSIONID, missionId);
  }
  void add_missionAOR(::flatbuffers::Offset<::flatbuffers::String> missionAOR) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_MISSIONAOR, missionAOR);
  }
  void add_missionPrimaryIntelDiscipline(::flatbuffers::Offset<::flatbuffers::String> missionPrimaryIntelDiscipline) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_MISSIONPRIMARYINTELDISCIPLINE, missionPrimaryIntelDiscipline);
  }
  void add_missionPrimarySubCategory(::flatbuffers::Offset<::flatbuffers::String> missionPrimarySubCategory) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_MISSIONPRIMARYSUBCATEGORY, missionPrimarySubCategory);
  }
  void add_missionSecondaryIntelDiscipline(::flatbuffers::Offset<::flatbuffers::String> missionSecondaryIntelDiscipline) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_MISSIONSECONDARYINTELDISCIPLINE, missionSecondaryIntelDiscipline);
  }
  void add_missionSecondarySubCategory(::flatbuffers::Offset<::flatbuffers::String> missionSecondarySubCategory) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_MISSIONSECONDARYSUBCATEGORY, missionSecondarySubCategory);
  }
  void add_missionRole(::flatbuffers::Offset<::flatbuffers::String> missionRole) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_MISSIONROLE, missionRole);
  }
  void add_missionOperation(::flatbuffers::Offset<::flatbuffers::String> missionOperation) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_MISSIONOPERATION, missionOperation);
  }
  void add_missionPriority(int32_t missionPriority) {
    fbb_.AddElement<int32_t>(ISRCollection_Ingest::VT_MISSIONPRIORITY, missionPriority, 0);
  }
  void add_missionSupportedUnit(::flatbuffers::Offset<::flatbuffers::String> missionSupportedUnit) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_MISSIONSUPPORTEDUNIT, missionSupportedUnit);
  }
  void add_missionEmphasis(::flatbuffers::Offset<::flatbuffers::String> missionEmphasis) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_MISSIONEMPHASIS, missionEmphasis);
  }
  void add_missionStartPointLat(double missionStartPointLat) {
    fbb_.AddElement<double>(ISRCollection_Ingest::VT_MISSIONSTARTPOINTLAT, missionStartPointLat, 0.0);
  }
  void add_missionStartPointLong(double missionStartPointLong) {
    fbb_.AddElement<double>(ISRCollection_Ingest::VT_MISSIONSTARTPOINTLONG, missionStartPointLong, 0.0);
  }
  void add_missionCollectionArea(::flatbuffers::Offset<::flatbuffers::String> missionCollectionArea) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_MISSIONCOLLECTIONAREA, missionCollectionArea);
  }
  void add_missionJoa(::flatbuffers::Offset<::flatbuffers::String> missionJoa) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_MISSIONJOA, missionJoa);
  }
  void add_missionSyncMatrixBin(::flatbuffers::Offset<::flatbuffers::String> missionSyncMatrixBin) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_MISSIONSYNCMATRIXBIN, missionSyncMatrixBin);
  }
  void add_missionCountry(::flatbuffers::Offset<::flatbuffers::String> missionCountry) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_MISSIONCOUNTRY, missionCountry);
  }
  void add_missionRegion(::flatbuffers::Offset<::flatbuffers::String> missionRegion) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_MISSIONREGION, missionRegion);
  }
  void add_missionSubRegion(::flatbuffers::Offset<::flatbuffers::String> missionSubRegion) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_MISSIONSUBREGION, missionSubRegion);
  }
  void add_collectionRequirements(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> collectionRequirements) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_COLLECTIONREQUIREMENTS, collectionRequirements);
  }
  void add_transit(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> transit) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_TRANSIT, transit);
  }
  void add_taskings(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> taskings) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_TASKINGS, taskings);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(ISRCollection_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(ISRCollection_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(ISRCollection_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  explicit ISRCollection_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<ISRCollection_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<ISRCollection_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<ISRCollection_Ingest> CreateISRCollection_Ingest(
    ...
    ISRCollection_Ingest_dataMode_Enum dataMode = ISRCollection_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  ISRCollection_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<ISRCollection_Ingest> CreateISRCollection_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const ISRCollection_Ingest *GetISRCollection_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<ISRCollection_Ingest>(buf);
}

inline const ISRCollection_Ingest *GetSizePrefixedISRCollection_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<ISRCollection_Ingest>(buf);
}

inline const char *ISRCollection_IngestIdentifier() {
  return "ISRC";
}

inline bool ISRCollection_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ISRCollection_IngestIdentifier());
}

inline bool SizePrefixedISRCollection_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ISRCollection_IngestIdentifier(), true);
}

inline bool VerifyISRCollection_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<ISRCollection_Ingest>(ISRCollection_IngestIdentifier());
}

inline bool VerifySizePrefixedISRCollection_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<ISRCollection_Ingest>(ISRCollection_IngestIdentifier());
}

inline void FinishISRCollection_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ISRCollection_Ingest> root) {
  fbb.Finish(root, ISRCollection_IngestIdentifier());
}

inline void FinishSizePrefixedISRCollection_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ISRCollection_Ingest> root) {
  fbb.FinishSizePrefixed(root, ISRCollection_IngestIdentifier());
}
