...
struct AirEventReceivers_Full;
struct AirEventReceivers_FullBuilder;

/// /// Collection of receiver aircraft associated with this Air Event.
struct AirEventReceivers_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirEventReceivers_FullBuilder Builder;
...
struct AirEventReceivers_FullBuilder {
  typedef AirEventReceivers_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_idReceiverSortie(::flatbuffers::Offset<::flatbuffers::String> idReceiverSortie) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_IDRECEIVERSORTIE, idReceiverSortie);
  }
  void add_idReceiverMission(::flatbuffers::Offset<::flatbuffers::String> idReceiverMission) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_IDRECEIVERMISSION, idReceiverMission);
  }
  void add_idReceiverAirfield(::flatbuffers::Offset<::flatbuffers::String> idReceiverAirfield) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_IDRECEIVERAIRFIELD, idReceiverAirfield);
  }
  void add_externalReceiverId(::flatbuffers::Offset<::flatbuffers::String> externalReceiverId) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_EXTERNALRECEIVERID, externalReceiverId);
  }
  void add_receiverCoord(::flatbuffers::Offset<::flatbuffers::String> receiverCoord) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_RECEIVERCOORD, receiverCoord);
  }
  void add_receiverMDS(::flatbuffers::Offset<::flatbuffers::String> receiverMDS) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_RECEIVERMDS, receiverMDS);
  }
  void add_amcReceiverMissionId(::flatbuffers::Offset<::flatbuffers::String> amcReceiverMissionId) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_AMCRECEIVERMISSIONID, amcReceiverMissionId);
  }
  void add_altReceiverMissionId(::flatbuffers::Offset<::flatbuffers::String> altReceiverMissionId) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_ALTRECEIVERMISSIONID, altReceiverMissionId);
  }
  void add_receiverCallSign(::flatbuffers::Offset<::flatbuffers::String> receiverCallSign) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_RECEIVERCALLSIGN, receiverCallSign);
  }
  void add_receiverOwner(::flatbuffers::Offset<::flatbuffers::String> receiverOwner) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_RECEIVEROWNER, receiverOwner);
  }
  void add_receiverPOC(::flatbuffers::Offset<::flatbuffers::String> receiverPOC) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_RECEIVERPOC, receiverPOC);
  }
  void add_receiverLegNum(int32_t receiverLegNum) {
    fbb_.AddElement<int32_t>(AirEventReceivers_Full::VT_RECEIVERLEGNUM, receiverLegNum, 0);
  }
  void add_receiverDeployedICAO(::flatbuffers::Offset<::flatbuffers::String> receiverDeployedICAO) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_RECEIVERDEPLOYEDICAO, receiverDeployedICAO);
  }
  void add_receiverDeliveryMethod(::flatbuffers::Offset<::flatbuffers::String> receiverDeliveryMethod) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_RECEIVERDELIVERYMETHOD, receiverDeliveryMethod);
  }
  void add_fuelOn(double fuelOn) {
    fbb_.AddElement<double>(AirEventReceivers_Full::VT_FUELON, fuelOn, 0.0);
  }
  void add_receiverCellPosition(int32_t receiverCellPosition) {
    fbb_.AddElement<int32_t>(AirEventReceivers_Full::VT_RECEIVERCELLPOSITION, receiverCellPosition, 0);
  }
  void add_sequenceNum(::flatbuffers::Offset<::flatbuffers::String> sequenceNum) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_SEQUENCENUM, sequenceNum);
  }
  void add_recOrg(::flatbuffers::Offset<::flatbuffers::String> recOrg) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_RECORG, recOrg);
  }
  void add_numRecAircraft(int32_t numRecAircraft) {
    fbb_.AddElement<int32_t>(AirEventReceivers_Full::VT_NUMRECAIRCRAFT, numRecAircraft, 0);
  }
  void add_receiverFuelType(::flatbuffers::Offset<::flatbuffers::String> receiverFuelType) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_RECEIVERFUELTYPE, receiverFuelType);
  }
  void add_receiverExercise(::flatbuffers::Offset<::flatbuffers::String> receiverExercise) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_RECEIVEREXERCISE, receiverExercise);
  }
  void add_packageId(::flatbuffers::Offset<::flatbuffers::String> packageId) {
    fbb_.AddOffset(AirEventReceivers_Full::VT_PACKAGEID, packageId);
  }
  explicit AirEventReceivers_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirEventReceivers_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirEventReceivers_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirEventReceivers_Full> CreateAirEventReceivers_Full(
  ...
  AirEventReceivers_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirEventReceivers_Full> CreateAirEventReceivers_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAirEventReceivers_Full(
      _fbb,
      idReceiverSortie__,
      idReceiverMission__,
...
inline const AirEventReceivers_Full *GetAirEventReceivers_Full(const void *buf) {
  return ::flatbuffers::GetRoot<AirEventReceivers_Full>(buf);
}

inline const AirEventReceivers_Full *GetSizePrefixedAirEventReceivers_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirEventReceivers_Full>(buf);
}

inline const char *AirEventReceivers_FullIdentifier() {
  return "AIRE";
}

inline bool AirEventReceivers_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirEventReceivers_FullIdentifier());
}

inline bool SizePrefixedAirEventReceivers_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirEventReceivers_FullIdentifier(), true);
}

inline bool VerifyAirEventReceivers_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirEventReceivers_Full>(AirEventReceivers_FullIdentifier());
}

inline bool VerifySizePrefixedAirEventReceivers_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirEventReceivers_Full>(AirEventReceivers_FullIdentifier());
}

inline void FinishAirEventReceivers_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirEventReceivers_Full> root) {
  fbb.Finish(root, AirEventReceivers_FullIdentifier());
}

inline void FinishSizePrefixedAirEventReceivers_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirEventReceivers_Full> root) {
  fbb.FinishSizePrefixed(root, AirEventReceivers_FullIdentifier());
}
