...
struct DataLinkRefPoints_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef DataLinkRefPoints_FullBuilder Builder;
...
struct DataLinkRefPoints_FullBuilder {
  typedef DataLinkRefPoints_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_refPointType(::flatbuffers::Offset<::flatbuffers::String> refPointType) {
    fbb_.AddOffset(DataLinkRefPoints_Full::VT_REFPOINTTYPE, refPointType);
  }
  void add_refDes(::flatbuffers::Offset<::flatbuffers::String> refDes) {
    fbb_.AddOffset(DataLinkRefPoints_Full::VT_REFDES, refDes);
  }
  void add_refLocName(::flatbuffers::Offset<::flatbuffers::String> refLocName) {
    fbb_.AddOffset(DataLinkRefPoints_Full::VT_REFLOCNAME, refLocName);
  }
  void add_refLat(double refLat) {
    fbb_.AddElement<double>(DataLinkRefPoints_Full::VT_REFLAT, refLat, 0.0);
  }
  void add_refLon(double refLon) {
    fbb_.AddElement<double>(DataLinkRefPoints_Full::VT_REFLON, refLon, 0.0);
  }
  void add_effEventTime(::flatbuffers::Offset<::flatbuffers::String> effEventTime) {
    fbb_.AddOffset(DataLinkRefPoints_Full::VT_EFFEVENTTIME, effEventTime);
  }
  explicit DataLinkRefPoints_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<DataLinkRefPoints_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<DataLinkRefPoints_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<DataLinkRefPoints_Full> CreateDataLinkRefPoints_Full(
  ...
  DataLinkRefPoints_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<DataLinkRefPoints_Full> CreateDataLinkRefPoints_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const DataLinkRefPoints_Full *GetDataLinkRefPoints_Full(const void *buf) {
  return ::flatbuffers::GetRoot<DataLinkRefPoints_Full>(buf);
}

inline const DataLinkRefPoints_Full *GetSizePrefixedDataLinkRefPoints_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<DataLinkRefPoints_Full>(buf);
}

inline const char *DataLinkRefPoints_FullIdentifier() {
  return "DATA";
}

inline bool DataLinkRefPoints_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLinkRefPoints_FullIdentifier());
}

inline bool SizePrefixedDataLinkRefPoints_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLinkRefPoints_FullIdentifier(), true);
}

inline bool VerifyDataLinkRefPoints_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<DataLinkRefPoints_Full>(DataLinkRefPoints_FullIdentifier());
}

inline bool VerifySizePrefixedDataLinkRefPoints_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<DataLinkRefPoints_Full>(DataLinkRefPoints_FullIdentifier());
}

inline void FinishDataLinkRefPoints_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLinkRefPoints_Full> root) {
  fbb.Finish(root, DataLinkRefPoints_FullIdentifier());
}

inline void FinishSizePrefixedDataLinkRefPoints_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLinkRefPoints_Full> root) {
  fbb.FinishSizePrefixed(root, DataLinkRefPoints_FullIdentifier());
}
