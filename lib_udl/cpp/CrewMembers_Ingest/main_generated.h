...
struct CrewMembers_Ingest;
struct CrewMembers_IngestBuilder;

/// /// Schema for Crew Member data.
struct CrewMembers_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef CrewMembers_IngestBuilder Builder;
...
struct CrewMembers_IngestBuilder {
  typedef CrewMembers_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_lastName(::flatbuffers::Offset<::flatbuffers::String> lastName) {
    fbb_.AddOffset(CrewMembers_Ingest::VT_LASTNAME, lastName);
  }
  void add_firstName(::flatbuffers::Offset<::flatbuffers::String> firstName) {
    fbb_.AddOffset(CrewMembers_Ingest::VT_FIRSTNAME, firstName);
  }
  void add_middleInitial(::flatbuffers::Offset<::flatbuffers::String> middleInitial) {
    fbb_.AddOffset(CrewMembers_Ingest::VT_MIDDLEINITIAL, middleInitial);
  }
  void add_memberId(::flatbuffers::Offset<::flatbuffers::String> memberId) {
    fbb_.AddOffset(CrewMembers_Ingest::VT_MEMBERID, memberId);
  }
  void add_civilian(bool civilian) {
    fbb_.AddElement<uint8_t>(CrewMembers_Ingest::VT_CIVILIAN, static_cast<uint8_t>(civilian), 0);
  }
  void add_commander(bool commander) {
    fbb_.AddElement<uint8_t>(CrewMembers_Ingest::VT_COMMANDER, static_cast<uint8_t>(commander), 0);
  }
  void add_last4SSN(::flatbuffers::Offset<::flatbuffers::String> last4SSN) {
    fbb_.AddOffset(CrewMembers_Ingest::VT_LAST4SSN, last4SSN);
  }
  void add_dodID(::flatbuffers::Offset<::flatbuffers::String> dodID) {
    fbb_.AddOffset(CrewMembers_Ingest::VT_DODID, dodID);
  }
  void add_dutyPosition(::flatbuffers::Offset<::flatbuffers::String> dutyPosition) {
    fbb_.AddOffset(CrewMembers_Ingest::VT_DUTYPOSITION, dutyPosition);
  }
  void add_crewPosition(::flatbuffers::Offset<::flatbuffers::String> crewPosition) {
    fbb_.AddOffset(CrewMembers_Ingest::VT_CREWPOSITION, crewPosition);
  }
  void add_memberType(::flatbuffers::Offset<::flatbuffers::String> memberType) {
    fbb_.AddOffset(CrewMembers_Ingest::VT_MEMBERTYPE, memberType);
  }
  void add_branch(::flatbuffers::Offset<::flatbuffers::String> branch) {
    fbb_.AddOffset(CrewMembers_Ingest::VT_BRANCH, branch);
  }
  void add_rank(::flatbuffers::Offset<::flatbuffers::String> rank) {
    fbb_.AddOffset(CrewMembers_Ingest::VT_RANK, rank);
  }
  void add_wing(::flatbuffers::Offset<::flatbuffers::String> wing) {
    fbb_.AddOffset(CrewMembers_Ingest::VT_WING, wing);
  }
  void add_squadron(::flatbuffers::Offset<::flatbuffers::String> squadron) {
    fbb_.AddOffset(CrewMembers_Ingest::VT_SQUADRON, squadron);
  }
  void add_memberRemarks(::flatbuffers::Offset<::flatbuffers::String> memberRemarks) {
    fbb_.AddOffset(CrewMembers_Ingest::VT_MEMBERREMARKS, memberRemarks);
  }
  void add_username(::flatbuffers::Offset<::flatbuffers::String> username) {
    fbb_.AddOffset(CrewMembers_Ingest::VT_USERNAME, username);
  }
  explicit CrewMembers_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<CrewMembers_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<CrewMembers_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<CrewMembers_Ingest> CreateCrewMembers_Ingest(
  ...
  CrewMembers_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<CrewMembers_Ingest> CreateCrewMembers_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const CrewMembers_Ingest *GetCrewMembers_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<CrewMembers_Ingest>(buf);
}

inline const CrewMembers_Ingest *GetSizePrefixedCrewMembers_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<CrewMembers_Ingest>(buf);
}

inline const char *CrewMembers_IngestIdentifier() {
  return "CREW";
}

inline bool CrewMembers_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, CrewMembers_IngestIdentifier());
}

inline bool SizePrefixedCrewMembers_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, CrewMembers_IngestIdentifier(), true);
}

inline bool VerifyCrewMembers_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<CrewMembers_Ingest>(CrewMembers_IngestIdentifier());
}

inline bool VerifySizePrefixedCrewMembers_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<CrewMembers_Ingest>(CrewMembers_IngestIdentifier());
}

inline void FinishCrewMembers_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<CrewMembers_Ingest> root) {
  fbb.Finish(root, CrewMembers_IngestIdentifier());
}

inline void FinishSizePrefixedCrewMembers_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<CrewMembers_Ingest> root) {
  fbb.FinishSizePrefixed(root, CrewMembers_IngestIdentifier());
}
