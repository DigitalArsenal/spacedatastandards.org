...
struct LogisticsSupportItems_Abridged;
struct LogisticsSupportItems_AbridgedBuilder;

/// /// Support items associated with this LogisticsSupport record.
struct LogisticsSupportItems_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LogisticsSupportItems_AbridgedBuilder Builder;
...
struct LogisticsSupportItems_AbridgedBuilder {
  typedef LogisticsSupportItems_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_recoveryRequestTypeCode(::flatbuffers::Offset<::flatbuffers::String> recoveryRequestTypeCode) {
    fbb_.AddOffset(LogisticsSupportItems_Abridged::VT_RECOVERYREQUESTTYPECODE, recoveryRequestTypeCode);
  }
  void add_requestNumber(::flatbuffers::Offset<::flatbuffers::String> requestNumber) {
    fbb_.AddOffset(LogisticsSupportItems_Abridged::VT_REQUESTNUMBER, requestNumber);
  }
  void add_quantity(int32_t quantity) {
    fbb_.AddElement<int32_t>(LogisticsSupportItems_Abridged::VT_QUANTITY, quantity, 0);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(LogisticsSupportItems_Abridged::VT_DESCRIPTION, description);
  }
  void add_shipmentUnitId(::flatbuffers::Offset<::flatbuffers::String> shipmentUnitId) {
    fbb_.AddOffset(LogisticsSupportItems_Abridged::VT_SHIPMENTUNITID, shipmentUnitId);
  }
  void add_redeployShipmentUnitId(::flatbuffers::Offset<::flatbuffers::String> redeployShipmentUnitId) {
    fbb_.AddOffset(LogisticsSupportItems_Abridged::VT_REDEPLOYSHIPMENTUNITID, redeployShipmentUnitId);
  }
  void add_jobControlNumber(::flatbuffers::Offset<::flatbuffers::String> jobControlNumber) {
    fbb_.AddOffset(LogisticsSupportItems_Abridged::VT_JOBCONTROLNUMBER, jobControlNumber);
  }
  void add_sourceICAO(::flatbuffers::Offset<::flatbuffers::String> sourceICAO) {
    fbb_.AddOffset(LogisticsSupportItems_Abridged::VT_SOURCEICAO, sourceICAO);
  }
  void add_deployPlanNumber(::flatbuffers::Offset<::flatbuffers::String> deployPlanNumber) {
    fbb_.AddOffset(LogisticsSupportItems_Abridged::VT_DEPLOYPLANNUMBER, deployPlanNumber);
  }
  void add_redeployPlanNumber(::flatbuffers::Offset<::flatbuffers::String> redeployPlanNumber) {
    fbb_.AddOffset(LogisticsSupportItems_Abridged::VT_REDEPLOYPLANNUMBER, redeployPlanNumber);
  }
  void add_cannibalized(bool cannibalized) {
    fbb_.AddElement<uint8_t>(LogisticsSupportItems_Abridged::VT_CANNIBALIZED, static_cast<uint8_t>(cannibalized), 0);
  }
  void add_siPOC(::flatbuffers::Offset<::flatbuffers::String> siPOC) {
    fbb_.AddOffset(LogisticsSupportItems_Abridged::VT_SIPOC, siPOC);
  }
  void add_readyTime(::flatbuffers::Offset<::flatbuffers::String> readyTime) {
    fbb_.AddOffset(LogisticsSupportItems_Abridged::VT_READYTIME, readyTime);
  }
  void add_receivedTime(::flatbuffers::Offset<::flatbuffers::String> receivedTime) {
    fbb_.AddOffset(LogisticsSupportItems_Abridged::VT_RECEIVEDTIME, receivedTime);
  }
  void add_resupportFlag(bool resupportFlag) {
    fbb_.AddElement<uint8_t>(LogisticsSupportItems_Abridged::VT_RESUPPORTFLAG, static_cast<uint8_t>(resupportFlag), 0);
  }
  void add_itemLastChangedDate(::flatbuffers::Offset<::flatbuffers::String> itemLastChangedDate) {
    fbb_.AddOffset(LogisticsSupportItems_Abridged::VT_ITEMLASTCHANGEDDATE, itemLastChangedDate);
  }
  void add_logisticsParts(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsParts) {
    fbb_.AddOffset(LogisticsSupportItems_Abridged::VT_LOGISTICSPARTS, logisticsParts);
  }
  void add_logisticsSpecialties(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsSpecialties) {
    fbb_.AddOffset(LogisticsSupportItems_Abridged::VT_LOGISTICSSPECIALTIES, logisticsSpecialties);
  }
  void add_logisticsRemarks(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsRemarks) {
    fbb_.AddOffset(LogisticsSupportItems_Abridged::VT_LOGISTICSREMARKS, logisticsRemarks);
  }
  explicit LogisticsSupportItems_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LogisticsSupportItems_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LogisticsSupportItems_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LogisticsSupportItems_Abridged> CreateLogisticsSupportItems_Abridged(
  ...
  LogisticsSupportItems_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<LogisticsSupportItems_Abridged> CreateLogisticsSupportItems_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const LogisticsSupportItems_Abridged *GetLogisticsSupportItems_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<LogisticsSupportItems_Abridged>(buf);
}

inline const LogisticsSupportItems_Abridged *GetSizePrefixedLogisticsSupportItems_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<LogisticsSupportItems_Abridged>(buf);
}

inline const char *LogisticsSupportItems_AbridgedIdentifier() {
  return "LOGI";
}

inline bool LogisticsSupportItems_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsSupportItems_AbridgedIdentifier());
}

inline bool SizePrefixedLogisticsSupportItems_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsSupportItems_AbridgedIdentifier(), true);
}

inline bool VerifyLogisticsSupportItems_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<LogisticsSupportItems_Abridged>(LogisticsSupportItems_AbridgedIdentifier());
}

inline bool VerifySizePrefixedLogisticsSupportItems_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<LogisticsSupportItems_Abridged>(LogisticsSupportItems_AbridgedIdentifier());
}

inline void FinishLogisticsSupportItems_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsSupportItems_Abridged> root) {
  fbb.Finish(root, LogisticsSupportItems_AbridgedIdentifier());
}

inline void FinishSizePrefixedLogisticsSupportItems_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsSupportItems_Abridged> root) {
  fbb.FinishSizePrefixed(root, LogisticsSupportItems_AbridgedIdentifier());
}
