...
struct PersonnelRecovery_Full;
struct PersonnelRecovery_FullBuilder;

enum PersonnelRecovery_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  PersonnelRecovery_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  PersonnelRecovery_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  PersonnelRecovery_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  PersonnelRecovery_Full_dataMode_Enum_EXERCISE = 3,
  PersonnelRecovery_Full_dataMode_Enum_MIN = PersonnelRecovery_Full_dataMode_Enum_REAL,
  PersonnelRecovery_Full_dataMode_Enum_MAX = PersonnelRecovery_Full_dataMode_Enum_EXERCISE
};

inline const PersonnelRecovery_Full_dataMode_Enum (&EnumValuesPersonnelRecovery_Full_dataMode_Enum())[4] {
  static const PersonnelRecovery_Full_dataMode_Enum values[] = {
    PersonnelRecovery_Full_dataMode_Enum_REAL,
    PersonnelRecovery_Full_dataMode_Enum_TEST,
    PersonnelRecovery_Full_dataMode_Enum_SIMULATED,
    PersonnelRecovery_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesPersonnelRecovery_Full_dataMode_Enum() {
...
inline const char *EnumNamePersonnelRecovery_Full_dataMode_Enum(PersonnelRecovery_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, PersonnelRecovery_Full_dataMode_Enum_REAL, PersonnelRecovery_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesPersonnelRecovery_Full_dataMode_Enum()[index];
}

/// /// Provides information concerning search and rescue operations and other situations involving personnel recovery.
struct PersonnelRecovery_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef PersonnelRecovery_FullBuilder Builder;
  ...
  PersonnelRecovery_Full_dataMode_Enum dataMode() const {
    return static_cast<PersonnelRecovery_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct PersonnelRecovery_FullBuilder {
  typedef PersonnelRecovery_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_TYPE, type);
  }
  void add_msgTime(::flatbuffers::Offset<::flatbuffers::String> msgTime) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_MSGTIME, msgTime);
  }
  void add_recovId(::flatbuffers::Offset<::flatbuffers::String> recovId) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_RECOVID, recovId);
  }
  void add_idWeatherReport(::flatbuffers::Offset<::flatbuffers::String> idWeatherReport) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_IDWEATHERREPORT, idWeatherReport);
  }
  void add_pickupLat(double pickupLat) {
    fbb_.AddElement<double>(PersonnelRecovery_Full::VT_PICKUPLAT, pickupLat, 0.0);
  }
  void add_pickupLon(double pickupLon) {
    fbb_.AddElement<double>(PersonnelRecovery_Full::VT_PICKUPLON, pickupLon, 0.0);
  }
  void add_pickupAlt(double pickupAlt) {
    fbb_.AddElement<double>(PersonnelRecovery_Full::VT_PICKUPALT, pickupAlt, 0.0);
  }
  void add_termInd(bool termInd) {
    fbb_.AddElement<uint8_t>(PersonnelRecovery_Full::VT_TERMIND, static_cast<uint8_t>(termInd), 0);
  }
  void add_authStatus(::flatbuffers::Offset<::flatbuffers::String> authStatus) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_AUTHSTATUS, authStatus);
  }
  void add_numPersons(int32_t numPersons) {
    fbb_.AddElement<int32_t>(PersonnelRecovery_Full::VT_NUMPERSONS, numPersons, 0);
  }
  void add_milClass(::flatbuffers::Offset<::flatbuffers::String> milClass) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_MILCLASS, milClass);
  }
  void add_natAlliance(int32_t natAlliance) {
    fbb_.AddElement<int32_t>(PersonnelRecovery_Full::VT_NATALLIANCE, natAlliance, 0);
  }
  void add_natAlliance1(int32_t natAlliance1) {
    fbb_.AddElement<int32_t>(PersonnelRecovery_Full::VT_NATALLIANCE1, natAlliance1, 0);
  }
  void add_identity(::flatbuffers::Offset<::flatbuffers::String> identity) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_IDENTITY, identity);
  }
  void add_commEq1(::flatbuffers::Offset<::flatbuffers::String> commEq1) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_COMMEQ1, commEq1);
  }
  void add_commEq2(::flatbuffers::Offset<::flatbuffers::String> commEq2) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_COMMEQ2, commEq2);
  }
  void add_commEq3(::flatbuffers::Offset<::flatbuffers::String> commEq3) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_COMMEQ3, commEq3);
  }
  void add_txFreq(double txFreq) {
    fbb_.AddElement<double>(PersonnelRecovery_Full::VT_TXFREQ, txFreq, 0.0);
  }
  void add_rxFreq(double rxFreq) {
    fbb_.AddElement<double>(PersonnelRecovery_Full::VT_RXFREQ, rxFreq, 0.0);
  }
  void add_numNonAmbulatory(int32_t numNonAmbulatory) {
    fbb_.AddElement<int32_t>(PersonnelRecovery_Full::VT_NUMNONAMBULATORY, numNonAmbulatory, 0);
  }
  void add_numAmbulatory(int32_t numAmbulatory) {
    fbb_.AddElement<int32_t>(PersonnelRecovery_Full::VT_NUMAMBULATORY, numAmbulatory, 0);
  }
  void add_numAmbulatoryInjured(int32_t numAmbulatoryInjured) {
    fbb_.AddElement<int32_t>(PersonnelRecovery_Full::VT_NUMAMBULATORYINJURED, numAmbulatoryInjured, 0);
  }
  void add_survivorRadio(::flatbuffers::Offset<::flatbuffers::String> survivorRadio) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_SURVIVORRADIO, survivorRadio);
  }
  void add_survivorMessages(::flatbuffers::Offset<::flatbuffers::String> survivorMessages) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_SURVIVORMESSAGES, survivorMessages);
  }
  void add_beaconInd(bool beaconInd) {
    fbb_.AddElement<uint8_t>(PersonnelRecovery_Full::VT_BEACONIND, static_cast<uint8_t>(beaconInd), 0);
  }
  void add_callSign(::flatbuffers::Offset<::flatbuffers::String> callSign) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_CALLSIGN, callSign);
  }
  void add_textMsg(::flatbuffers::Offset<::flatbuffers::String> textMsg) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_TEXTMSG, textMsg);
  }
  void add_authMethod(::flatbuffers::Offset<::flatbuffers::String> authMethod) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_AUTHMETHOD, authMethod);
  }
  void add_objectiveAreaInfo(::flatbuffers::Offset<::flatbuffers::String> objectiveAreaInfo) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_OBJECTIVEAREAINFO, objectiveAreaInfo);
  }
  void add_executionInfo(::flatbuffers::Offset<::flatbuffers::String> executionInfo) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_EXECUTIONINFO, executionInfo);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(PersonnelRecovery_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(PersonnelRecovery_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(PersonnelRecovery_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit PersonnelRecovery_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<PersonnelRecovery_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<PersonnelRecovery_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<PersonnelRecovery_Full> CreatePersonnelRecovery_Full(
    ...
    PersonnelRecovery_Full_dataMode_Enum dataMode = PersonnelRecovery_Full_dataMode_Enum_REAL) {
  PersonnelRecovery_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<PersonnelRecovery_Full> CreatePersonnelRecovery_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const PersonnelRecovery_Full *GetPersonnelRecovery_Full(const void *buf) {
  return ::flatbuffers::GetRoot<PersonnelRecovery_Full>(buf);
}

inline const PersonnelRecovery_Full *GetSizePrefixedPersonnelRecovery_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<PersonnelRecovery_Full>(buf);
}

inline const char *PersonnelRecovery_FullIdentifier() {
  return "PERS";
}

inline bool PersonnelRecovery_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, PersonnelRecovery_FullIdentifier());
}

inline bool SizePrefixedPersonnelRecovery_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, PersonnelRecovery_FullIdentifier(), true);
}

inline bool VerifyPersonnelRecovery_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<PersonnelRecovery_Full>(PersonnelRecovery_FullIdentifier());
}

inline bool VerifySizePrefixedPersonnelRecovery_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<PersonnelRecovery_Full>(PersonnelRecovery_FullIdentifier());
}

inline void FinishPersonnelRecovery_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<PersonnelRecovery_Full> root) {
  fbb.Finish(root, PersonnelRecovery_FullIdentifier());
}

inline void FinishSizePrefixedPersonnelRecovery_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<PersonnelRecovery_Full> root) {
  fbb.FinishSizePrefixed(root, PersonnelRecovery_FullIdentifier());
}
