...
struct DataLinkMultiDuty_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef DataLinkMultiDuty_FullBuilder Builder;
...
struct DataLinkMultiDuty_FullBuilder {
  typedef DataLinkMultiDuty_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_unitDes(::flatbuffers::Offset<::flatbuffers::String> unitDes) {
    fbb_.AddOffset(DataLinkMultiDuty_Full::VT_UNITDES, unitDes);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(DataLinkMultiDuty_Full::VT_NAME, name);
  }
  void add_rank(::flatbuffers::Offset<::flatbuffers::String> rank) {
    fbb_.AddOffset(DataLinkMultiDuty_Full::VT_RANK, rank);
  }
  void add_duty(::flatbuffers::Offset<::flatbuffers::String> duty) {
    fbb_.AddOffset(DataLinkMultiDuty_Full::VT_DUTY, duty);
  }
  void add_dutyTeleFreqNums(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dutyTeleFreqNums) {
    fbb_.AddOffset(DataLinkMultiDuty_Full::VT_DUTYTELEFREQNUMS, dutyTeleFreqNums);
  }
  void add_multiDutyVoiceCoord(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> multiDutyVoiceCoord) {
    fbb_.AddOffset(DataLinkMultiDuty_Full::VT_MULTIDUTYVOICECOORD, multiDutyVoiceCoord);
  }
  explicit DataLinkMultiDuty_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<DataLinkMultiDuty_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<DataLinkMultiDuty_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<DataLinkMultiDuty_Full> CreateDataLinkMultiDuty_Full(
  ...
  DataLinkMultiDuty_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<DataLinkMultiDuty_Full> CreateDataLinkMultiDuty_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const DataLinkMultiDuty_Full *GetDataLinkMultiDuty_Full(const void *buf) {
  return ::flatbuffers::GetRoot<DataLinkMultiDuty_Full>(buf);
}

inline const DataLinkMultiDuty_Full *GetSizePrefixedDataLinkMultiDuty_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<DataLinkMultiDuty_Full>(buf);
}

inline const char *DataLinkMultiDuty_FullIdentifier() {
  return "DATA";
}

inline bool DataLinkMultiDuty_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLinkMultiDuty_FullIdentifier());
}

inline bool SizePrefixedDataLinkMultiDuty_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLinkMultiDuty_FullIdentifier(), true);
}

inline bool VerifyDataLinkMultiDuty_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<DataLinkMultiDuty_Full>(DataLinkMultiDuty_FullIdentifier());
}

inline bool VerifySizePrefixedDataLinkMultiDuty_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<DataLinkMultiDuty_Full>(DataLinkMultiDuty_FullIdentifier());
}

inline void FinishDataLinkMultiDuty_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLinkMultiDuty_Full> root) {
  fbb.Finish(root, DataLinkMultiDuty_FullIdentifier());
}

inline void FinishSizePrefixedDataLinkMultiDuty_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLinkMultiDuty_Full> root) {
  fbb.FinishSizePrefixed(root, DataLinkMultiDuty_FullIdentifier());
}
