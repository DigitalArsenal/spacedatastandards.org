...
struct AirEventTankers_Abridged;
struct AirEventTankers_AbridgedBuilder;

/// /// Collection of tanker aircraft associated with this Air Event.
struct AirEventTankers_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirEventTankers_AbridgedBuilder Builder;
...
struct AirEventTankers_AbridgedBuilder {
  typedef AirEventTankers_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_idTankerSortie(::flatbuffers::Offset<::flatbuffers::String> idTankerSortie) {
    fbb_.AddOffset(AirEventTankers_Abridged::VT_IDTANKERSORTIE, idTankerSortie);
  }
  void add_idTankerMission(::flatbuffers::Offset<::flatbuffers::String> idTankerMission) {
    fbb_.AddOffset(AirEventTankers_Abridged::VT_IDTANKERMISSION, idTankerMission);
  }
  void add_idTankerAirfield(::flatbuffers::Offset<::flatbuffers::String> idTankerAirfield) {
    fbb_.AddOffset(AirEventTankers_Abridged::VT_IDTANKERAIRFIELD, idTankerAirfield);
  }
  void add_externalTankerId(::flatbuffers::Offset<::flatbuffers::String> externalTankerId) {
    fbb_.AddOffset(AirEventTankers_Abridged::VT_EXTERNALTANKERID, externalTankerId);
  }
  void add_tankerCoord(::flatbuffers::Offset<::flatbuffers::String> tankerCoord) {
    fbb_.AddOffset(AirEventTankers_Abridged::VT_TANKERCOORD, tankerCoord);
  }
  void add_tankerMDS(::flatbuffers::Offset<::flatbuffers::String> tankerMDS) {
    fbb_.AddOffset(AirEventTankers_Abridged::VT_TANKERMDS, tankerMDS);
  }
  void add_amcTankerMissionId(::flatbuffers::Offset<::flatbuffers::String> amcTankerMissionId) {
    fbb_.AddOffset(AirEventTankers_Abridged::VT_AMCTANKERMISSIONID, amcTankerMissionId);
  }
  void add_altTankerMissionId(::flatbuffers::Offset<::flatbuffers::String> altTankerMissionId) {
    fbb_.AddOffset(AirEventTankers_Abridged::VT_ALTTANKERMISSIONID, altTankerMissionId);
  }
  void add_tankerCallSign(::flatbuffers::Offset<::flatbuffers::String> tankerCallSign) {
    fbb_.AddOffset(AirEventTankers_Abridged::VT_TANKERCALLSIGN, tankerCallSign);
  }
  void add_tankerOwner(::flatbuffers::Offset<::flatbuffers::String> tankerOwner) {
    fbb_.AddOffset(AirEventTankers_Abridged::VT_TANKEROWNER, tankerOwner);
  }
  void add_tankerPOC(::flatbuffers::Offset<::flatbuffers::String> tankerPOC) {
    fbb_.AddOffset(AirEventTankers_Abridged::VT_TANKERPOC, tankerPOC);
  }
  void add_tankerLegNum(int32_t tankerLegNum) {
    fbb_.AddElement<int32_t>(AirEventTankers_Abridged::VT_TANKERLEGNUM, tankerLegNum, 0);
  }
  void add_tankerDeployedICAO(::flatbuffers::Offset<::flatbuffers::String> tankerDeployedICAO) {
    fbb_.AddOffset(AirEventTankers_Abridged::VT_TANKERDEPLOYEDICAO, tankerDeployedICAO);
  }
  void add_tankerDeliveryMethod(::flatbuffers::Offset<::flatbuffers::String> tankerDeliveryMethod) {
    fbb_.AddOffset(AirEventTankers_Abridged::VT_TANKERDELIVERYMETHOD, tankerDeliveryMethod);
  }
  void add_fuelOff(double fuelOff) {
    fbb_.AddElement<double>(AirEventTankers_Abridged::VT_FUELOFF, fuelOff, 0.0);
  }
  void add_tankerCellPosition(int32_t tankerCellPosition) {
    fbb_.AddElement<int32_t>(AirEventTankers_Abridged::VT_TANKERCELLPOSITION, tankerCellPosition, 0);
  }
  void add_tankerFuelType(::flatbuffers::Offset<::flatbuffers::String> tankerFuelType) {
    fbb_.AddOffset(AirEventTankers_Abridged::VT_TANKERFUELTYPE, tankerFuelType);
  }
  void add_dualRole(bool dualRole) {
    fbb_.AddElement<uint8_t>(AirEventTankers_Abridged::VT_DUALROLE, static_cast<uint8_t>(dualRole), 0);
  }
  explicit AirEventTankers_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirEventTankers_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirEventTankers_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirEventTankers_Abridged> CreateAirEventTankers_Abridged(
    ...
    bool dualRole = false) {
  AirEventTankers_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirEventTankers_Abridged> CreateAirEventTankers_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AirEventTankers_Abridged *GetAirEventTankers_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<AirEventTankers_Abridged>(buf);
}

inline const AirEventTankers_Abridged *GetSizePrefixedAirEventTankers_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirEventTankers_Abridged>(buf);
}

inline const char *AirEventTankers_AbridgedIdentifier() {
  return "AIRE";
}

inline bool AirEventTankers_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirEventTankers_AbridgedIdentifier());
}

inline bool SizePrefixedAirEventTankers_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirEventTankers_AbridgedIdentifier(), true);
}

inline bool VerifyAirEventTankers_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirEventTankers_Abridged>(AirEventTankers_AbridgedIdentifier());
}

inline bool VerifySizePrefixedAirEventTankers_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirEventTankers_Abridged>(AirEventTankers_AbridgedIdentifier());
}

inline void FinishAirEventTankers_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirEventTankers_Abridged> root) {
  fbb.Finish(root, AirEventTankers_AbridgedIdentifier());
}

inline void FinishSizePrefixedAirEventTankers_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirEventTankers_Abridged> root) {
  fbb.FinishSizePrefixed(root, AirEventTankers_AbridgedIdentifier());
}
