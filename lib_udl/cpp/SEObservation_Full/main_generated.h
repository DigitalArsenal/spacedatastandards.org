...
struct SEObservation_Full;
struct SEObservation_FullBuilder;

/// /// A single space environment observation.
struct SEObservation_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SEObservation_FullBuilder Builder;
...
struct SEObservation_FullBuilder {
  typedef SEObservation_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_obType(::flatbuffers::Offset<::flatbuffers::String> obType) {
    fbb_.AddOffset(SEObservation_Full::VT_OBTYPE, obType);
  }
  void add_obUoM(::flatbuffers::Offset<::flatbuffers::String> obUoM) {
    fbb_.AddOffset(SEObservation_Full::VT_OBUOM, obUoM);
  }
  void add_obValue(double obValue) {
    fbb_.AddElement<double>(SEObservation_Full::VT_OBVALUE, obValue, 0.0);
  }
  void add_obString(::flatbuffers::Offset<::flatbuffers::String> obString) {
    fbb_.AddOffset(SEObservation_Full::VT_OBSTRING, obString);
  }
  void add_obArray(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> obArray) {
    fbb_.AddOffset(SEObservation_Full::VT_OBARRAY, obArray);
  }
  void add_obBool(bool obBool) {
    fbb_.AddElement<uint8_t>(SEObservation_Full::VT_OBBOOL, static_cast<uint8_t>(obBool), 0);
  }
  void add_obQuality(::flatbuffers::Offset<::flatbuffers::String> obQuality) {
    fbb_.AddOffset(SEObservation_Full::VT_OBQUALITY, obQuality);
  }
  void add_obDescription(::flatbuffers::Offset<::flatbuffers::String> obDescription) {
    fbb_.AddOffset(SEObservation_Full::VT_OBDESCRIPTION, obDescription);
  }
  explicit SEObservation_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SEObservation_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SEObservation_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SEObservation_Full> CreateSEObservation_Full(
  ...
  SEObservation_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SEObservation_Full> CreateSEObservation_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const SEObservation_Full *GetSEObservation_Full(const void *buf) {
  return ::flatbuffers::GetRoot<SEObservation_Full>(buf);
}

inline const SEObservation_Full *GetSizePrefixedSEObservation_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SEObservation_Full>(buf);
}

inline const char *SEObservation_FullIdentifier() {
  return "SEOB";
}

inline bool SEObservation_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SEObservation_FullIdentifier());
}

inline bool SizePrefixedSEObservation_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SEObservation_FullIdentifier(), true);
}

inline bool VerifySEObservation_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SEObservation_Full>(SEObservation_FullIdentifier());
}

inline bool VerifySizePrefixedSEObservation_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SEObservation_Full>(SEObservation_FullIdentifier());
}

inline void FinishSEObservation_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SEObservation_Full> root) {
  fbb.Finish(root, SEObservation_FullIdentifier());
}

inline void FinishSizePrefixedSEObservation_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SEObservation_Full> root) {
  fbb.FinishSizePrefixed(root, SEObservation_FullIdentifier());
}
