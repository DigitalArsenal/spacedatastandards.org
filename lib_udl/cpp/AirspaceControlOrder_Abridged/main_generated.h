...
struct AirspaceControlOrder_Abridged;
struct AirspaceControlOrder_AbridgedBuilder;

enum AirspaceControlOrder_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  AirspaceControlOrder_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  AirspaceControlOrder_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  AirspaceControlOrder_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  AirspaceControlOrder_Abridged_dataMode_Enum_EXERCISE = 3,
  AirspaceControlOrder_Abridged_dataMode_Enum_MIN = AirspaceControlOrder_Abridged_dataMode_Enum_REAL,
  AirspaceControlOrder_Abridged_dataMode_Enum_MAX = AirspaceControlOrder_Abridged_dataMode_Enum_EXERCISE
};

inline const AirspaceControlOrder_Abridged_dataMode_Enum (&EnumValuesAirspaceControlOrder_Abridged_dataMode_Enum())[4] {
  static const AirspaceControlOrder_Abridged_dataMode_Enum values[] = {
    AirspaceControlOrder_Abridged_dataMode_Enum_REAL,
    AirspaceControlOrder_Abridged_dataMode_Enum_TEST,
    AirspaceControlOrder_Abridged_dataMode_Enum_SIMULATED,
    AirspaceControlOrder_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAirspaceControlOrder_Abridged_dataMode_Enum() {
...
inline const char *EnumNameAirspaceControlOrder_Abridged_dataMode_Enum(AirspaceControlOrder_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AirspaceControlOrder_Abridged_dataMode_Enum_REAL, AirspaceControlOrder_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAirspaceControlOrder_Abridged_dataMode_Enum()[index];
}
...
struct AirspaceControlOrder_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirspaceControlOrder_AbridgedBuilder Builder;
  ...
  AirspaceControlOrder_Abridged_dataMode_Enum dataMode() const {
    return static_cast<AirspaceControlOrder_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AirspaceControlOrder_AbridgedBuilder {
  typedef AirspaceControlOrder_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_RAWFILEURI, rawFileURI);
  }
  void add_opExName(::flatbuffers::Offset<::flatbuffers::String> opExName) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_OPEXNAME, opExName);
  }
  void add_originator(::flatbuffers::Offset<::flatbuffers::String> originator) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_ORIGINATOR, originator);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_STARTTIME, startTime);
  }
  void add_stopTime(::flatbuffers::Offset<::flatbuffers::String> stopTime) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_STOPTIME, stopTime);
  }
  void add_stopQualifier(::flatbuffers::Offset<::flatbuffers::String> stopQualifier) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_STOPQUALIFIER, stopQualifier);
  }
  void add_opExInfo(::flatbuffers::Offset<::flatbuffers::String> opExInfo) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_OPEXINFO, opExInfo);
  }
  void add_opExInfoAlt(::flatbuffers::Offset<::flatbuffers::String> opExInfoAlt) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_OPEXINFOALT, opExInfoAlt);
  }
  void add_planOrigNum(::flatbuffers::Offset<::flatbuffers::String> planOrigNum) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_PLANORIGNUM, planOrigNum);
  }
  void add_serialNum(::flatbuffers::Offset<::flatbuffers::String> serialNum) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_SERIALNUM, serialNum);
  }
  void add_month(::flatbuffers::Offset<::flatbuffers::String> month) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_MONTH, month);
  }
  void add_qualifier(::flatbuffers::Offset<::flatbuffers::String> qualifier) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_QUALIFIER, qualifier);
  }
  void add_qualSN(int32_t qualSN) {
    fbb_.AddElement<int32_t>(AirspaceControlOrder_Abridged::VT_QUALSN, qualSN, 0);
  }
  void add_areaOfValidity(::flatbuffers::Offset<::flatbuffers::String> areaOfValidity) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_AREAOFVALIDITY, areaOfValidity);
  }
  void add_acoSerialNum(::flatbuffers::Offset<::flatbuffers::String> acoSerialNum) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_ACOSERIALNUM, acoSerialNum);
  }
  void add_geoDatum(::flatbuffers::Offset<::flatbuffers::String> geoDatum) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_GEODATUM, geoDatum);
  }
  void add_acoComments(::flatbuffers::Offset<::flatbuffers::String> acoComments) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_ACOCOMMENTS, acoComments);
  }
  void add_airspaceControlOrderReferences(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> airspaceControlOrderReferences) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_AIRSPACECONTROLORDERREFERENCES, airspaceControlOrderReferences);
  }
  ...
  void add_declassExemptionCode(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> declassExemptionCode) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_DECLASSEXEMPTIONCODE, declassExemptionCode);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AirspaceControlOrder_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(AirspaceControlOrder_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AirspaceControlOrder_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit AirspaceControlOrder_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirspaceControlOrder_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirspaceControlOrder_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirspaceControlOrder_Abridged> CreateAirspaceControlOrder_Abridged(
    ...
    AirspaceControlOrder_Abridged_dataMode_Enum dataMode = AirspaceControlOrder_Abridged_dataMode_Enum_REAL) {
  AirspaceControlOrder_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirspaceControlOrder_Abridged> CreateAirspaceControlOrder_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAirspaceControlOrder_Abridged(
      _fbb,
      id__,
...
inline const AirspaceControlOrder_Abridged *GetAirspaceControlOrder_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<AirspaceControlOrder_Abridged>(buf);
}

inline const AirspaceControlOrder_Abridged *GetSizePrefixedAirspaceControlOrder_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirspaceControlOrder_Abridged>(buf);
}

inline const char *AirspaceControlOrder_AbridgedIdentifier() {
  return "AIRS";
}

inline bool AirspaceControlOrder_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirspaceControlOrder_AbridgedIdentifier());
}

inline bool SizePrefixedAirspaceControlOrder_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirspaceControlOrder_AbridgedIdentifier(), true);
}

inline bool VerifyAirspaceControlOrder_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirspaceControlOrder_Abridged>(AirspaceControlOrder_AbridgedIdentifier());
}

inline bool VerifySizePrefixedAirspaceControlOrder_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirspaceControlOrder_Abridged>(AirspaceControlOrder_AbridgedIdentifier());
}

inline void FinishAirspaceControlOrder_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirspaceControlOrder_Abridged> root) {
  fbb.Finish(root, AirspaceControlOrder_AbridgedIdentifier());
}

inline void FinishSizePrefixedAirspaceControlOrder_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirspaceControlOrder_Abridged> root) {
  fbb.FinishSizePrefixed(root, AirspaceControlOrder_AbridgedIdentifier());
}
