...
struct Aircraft_Abridged;
struct Aircraft_AbridgedBuilder;

enum Aircraft_Abridged_dataMode_Enum : int8_t {
  ...
  Aircraft_Abridged_dataMode_Enum_MIN = Aircraft_Abridged_dataMode_Enum_REAL,
  Aircraft_Abridged_dataMode_Enum_MAX = Aircraft_Abridged_dataMode_Enum_EXERCISE
};

inline const Aircraft_Abridged_dataMode_Enum (&EnumValuesAircraft_Abridged_dataMode_Enum())[4] {
  static const Aircraft_Abridged_dataMode_Enum values[] = {
    Aircraft_Abridged_dataMode_Enum_REAL,
    Aircraft_Abridged_dataMode_Enum_TEST,
    Aircraft_Abridged_dataMode_Enum_SIMULATED,
    Aircraft_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAircraft_Abridged_dataMode_Enum() {
...
inline const char *EnumNameAircraft_Abridged_dataMode_Enum(Aircraft_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Aircraft_Abridged_dataMode_Enum_REAL, Aircraft_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAircraft_Abridged_dataMode_Enum()[index];
}
...
struct Aircraft_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Aircraft_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 64
  Aircraft_Abridged_dataMode_Enum dataMode() const {
    return static_cast<Aircraft_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Aircraft_AbridgedBuilder {
  typedef Aircraft_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Aircraft_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Aircraft_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idEntity(::flatbuffers::Offset<::flatbuffers::String> idEntity) {
    fbb_.AddOffset(Aircraft_Abridged::VT_IDENTITY, idEntity);
  }
  void add_aircraftMDS(::flatbuffers::Offset<::flatbuffers::String> aircraftMDS) {
    fbb_.AddOffset(Aircraft_Abridged::VT_AIRCRAFTMDS, aircraftMDS);
  }
  void add_tailNumber(::flatbuffers::Offset<::flatbuffers::String> tailNumber) {
    fbb_.AddOffset(Aircraft_Abridged::VT_TAILNUMBER, tailNumber);
  }
  void add_serialNumber(::flatbuffers::Offset<::flatbuffers::String> serialNumber) {
    fbb_.AddOffset(Aircraft_Abridged::VT_SERIALNUMBER, serialNumber);
  }
  void add_owner(::flatbuffers::Offset<::flatbuffers::String> owner) {
    fbb_.AddOffset(Aircraft_Abridged::VT_OWNER, owner);
  }
  void add_command(::flatbuffers::Offset<::flatbuffers::String> command) {
    fbb_.AddOffset(Aircraft_Abridged::VT_COMMAND, command);
  }
  void add_category(::flatbuffers::Offset<::flatbuffers::String> category) {
    fbb_.AddOffset(Aircraft_Abridged::VT_CATEGORY, category);
  }
  void add_dtd(::flatbuffers::Offset<::flatbuffers::String> dtd) {
    fbb_.AddOffset(Aircraft_Abridged::VT_DTD, dtd);
  }
  void add_cruiseSpeed(double cruiseSpeed) {
    fbb_.AddElement<double>(Aircraft_Abridged::VT_CRUISESPEED, cruiseSpeed, 0.0);
  }
  void add_maxSpeed(double maxSpeed) {
    fbb_.AddElement<double>(Aircraft_Abridged::VT_MAXSPEED, maxSpeed, 0.0);
  }
  void add_minReqRunwayM(int32_t minReqRunwayM) {
    fbb_.AddElement<int32_t>(Aircraft_Abridged::VT_MINREQRUNWAYM, minReqRunwayM, 0);
  }
  void add_minReqRunwayFt(int32_t minReqRunwayFt) {
    fbb_.AddElement<int32_t>(Aircraft_Abridged::VT_MINREQRUNWAYFT, minReqRunwayFt, 0);
  }
  void add_nominalTATime(int32_t nominalTATime) {
    fbb_.AddElement<int32_t>(Aircraft_Abridged::VT_NOMINALTATIME, nominalTATime, 0);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(Aircraft_Abridged::VT_NOTES, notes);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Aircraft_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Aircraft_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(Aircraft_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Aircraft_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Aircraft_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(Aircraft_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Aircraft_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Aircraft_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  explicit Aircraft_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Aircraft_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Aircraft_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Aircraft_Abridged> CreateAircraft_Abridged(
    ...
    Aircraft_Abridged_dataMode_Enum dataMode = Aircraft_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  Aircraft_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Aircraft_Abridged> CreateAircraft_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Aircraft_Abridged *GetAircraft_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<Aircraft_Abridged>(buf);
}

inline const Aircraft_Abridged *GetSizePrefixedAircraft_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Aircraft_Abridged>(buf);
}

inline const char *Aircraft_AbridgedIdentifier() {
  return "AIRC";
}

inline bool Aircraft_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Aircraft_AbridgedIdentifier());
}

inline bool SizePrefixedAircraft_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Aircraft_AbridgedIdentifier(), true);
}

inline bool VerifyAircraft_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Aircraft_Abridged>(Aircraft_AbridgedIdentifier());
}

inline bool VerifySizePrefixedAircraft_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Aircraft_Abridged>(Aircraft_AbridgedIdentifier());
}

inline void FinishAircraft_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Aircraft_Abridged> root) {
  fbb.Finish(root, Aircraft_AbridgedIdentifier());
}

inline void FinishSizePrefixedAircraft_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Aircraft_Abridged> root) {
  fbb.FinishSizePrefixed(root, Aircraft_AbridgedIdentifier());
}
