...
struct Operatingunit;
struct OperatingunitBuilder;

enum Operatingunit_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Operatingunit_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Operatingunit_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Operatingunit_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Operatingunit_dataMode_Enum_EXERCISE = 3,
  Operatingunit_dataMode_Enum_MIN = Operatingunit_dataMode_Enum_REAL,
  Operatingunit_dataMode_Enum_MAX = Operatingunit_dataMode_Enum_EXERCISE
};

inline const Operatingunit_dataMode_Enum (&EnumValuesOperatingunit_dataMode_Enum())[4] {
  static const Operatingunit_dataMode_Enum values[] = {
    Operatingunit_dataMode_Enum_REAL,
    Operatingunit_dataMode_Enum_TEST,
    Operatingunit_dataMode_Enum_SIMULATED,
    Operatingunit_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesOperatingunit_dataMode_Enum() {
...
inline const char *EnumNameOperatingunit_dataMode_Enum(Operatingunit_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Operatingunit_dataMode_Enum_REAL, Operatingunit_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOperatingunit_dataMode_Enum()[index];
}
...
struct Operatingunit FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef OperatingunitBuilder Builder;
  ...
  Operatingunit_dataMode_Enum dataMode() const {
    return static_cast<Operatingunit_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct OperatingunitBuilder {
  ...
  void add_operatingUnitRemarks(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> operatingUnitRemarks) {
    fbb_.AddOffset(Operatingunit::VT_OPERATINGUNITREMARKS, operatingUnitRemarks);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Operatingunit::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Operatingunit::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(Operatingunit::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(Operatingunit::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Operatingunit::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Operatingunit::VT_ORIGIN, origin);
  }
  void add_dataMode(Operatingunit_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Operatingunit::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_organization(::flatbuffers::Offset<::flatbuffers::String> organization) {
    fbb_.AddOffset(Operatingunit::VT_ORGANIZATION, organization);
  }
  void add_location(::flatbuffers::Offset<::flatbuffers::String> location) {
    fbb_.AddOffset(Operatingunit::VT_LOCATION, location);
  }
  explicit OperatingunitBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Operatingunit> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Operatingunit>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Operatingunit> CreateOperatingunit(
    ...
    Operatingunit_dataMode_Enum dataMode = Operatingunit_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> organization = 0,
    ::flatbuffers::Offset<::flatbuffers::String> location = 0) {
  OperatingunitBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Operatingunit> CreateOperatingunitDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Operatingunit *GetOperatingunit(const void *buf) {
  return ::flatbuffers::GetRoot<Operatingunit>(buf);
}

inline const Operatingunit *GetSizePrefixedOperatingunit(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Operatingunit>(buf);
}

inline const char *OperatingunitIdentifier() {
  return "OPER";
}

inline bool OperatingunitBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OperatingunitIdentifier());
}

inline bool SizePrefixedOperatingunitBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OperatingunitIdentifier(), true);
}

inline bool VerifyOperatingunitBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Operatingunit>(OperatingunitIdentifier());
}

inline bool VerifySizePrefixedOperatingunitBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Operatingunit>(OperatingunitIdentifier());
}

inline void FinishOperatingunitBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Operatingunit> root) {
  fbb.Finish(root, OperatingunitIdentifier());
}

inline void FinishSizePrefixedOperatingunitBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Operatingunit> root) {
  fbb.FinishSizePrefixed(root, OperatingunitIdentifier());
}
