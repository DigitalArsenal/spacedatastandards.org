...
struct LogisticsSpecialties_Full;
struct LogisticsSpecialties_FullBuilder;

/// /// The specialties required to implement this support item.
struct LogisticsSpecialties_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LogisticsSpecialties_FullBuilder Builder;
...
struct LogisticsSpecialties_FullBuilder {
  typedef LogisticsSpecialties_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_specialty(::flatbuffers::Offset<::flatbuffers::String> specialty) {
    fbb_.AddOffset(LogisticsSpecialties_Full::VT_SPECIALTY, specialty);
  }
  void add_skillLevel(int32_t skillLevel) {
    fbb_.AddElement<int32_t>(LogisticsSpecialties_Full::VT_SKILLLEVEL, skillLevel, 0);
  }
  void add_firstName(::flatbuffers::Offset<::flatbuffers::String> firstName) {
    fbb_.AddOffset(LogisticsSpecialties_Full::VT_FIRSTNAME, firstName);
  }
  void add_lastName(::flatbuffers::Offset<::flatbuffers::String> lastName) {
    fbb_.AddOffset(LogisticsSpecialties_Full::VT_LASTNAME, lastName);
  }
  void add_rankCode(::flatbuffers::Offset<::flatbuffers::String> rankCode) {
    fbb_.AddOffset(LogisticsSpecialties_Full::VT_RANKCODE, rankCode);
  }
  void add_last4Ssn(::flatbuffers::Offset<::flatbuffers::String> last4Ssn) {
    fbb_.AddOffset(LogisticsSpecialties_Full::VT_LAST4SSN, last4Ssn);
  }
  void add_roleTypeCode(::flatbuffers::Offset<::flatbuffers::String> roleTypeCode) {
    fbb_.AddOffset(LogisticsSpecialties_Full::VT_ROLETYPECODE, roleTypeCode);
  }
  explicit LogisticsSpecialties_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LogisticsSpecialties_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LogisticsSpecialties_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LogisticsSpecialties_Full> CreateLogisticsSpecialties_Full(
  ...
  LogisticsSpecialties_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<LogisticsSpecialties_Full> CreateLogisticsSpecialties_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const LogisticsSpecialties_Full *GetLogisticsSpecialties_Full(const void *buf) {
  return ::flatbuffers::GetRoot<LogisticsSpecialties_Full>(buf);
}

inline const LogisticsSpecialties_Full *GetSizePrefixedLogisticsSpecialties_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<LogisticsSpecialties_Full>(buf);
}

inline const char *LogisticsSpecialties_FullIdentifier() {
  return "LOGI";
}

inline bool LogisticsSpecialties_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsSpecialties_FullIdentifier());
}

inline bool SizePrefixedLogisticsSpecialties_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsSpecialties_FullIdentifier(), true);
}

inline bool VerifyLogisticsSpecialties_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<LogisticsSpecialties_Full>(LogisticsSpecialties_FullIdentifier());
}

inline bool VerifySizePrefixedLogisticsSpecialties_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<LogisticsSpecialties_Full>(LogisticsSpecialties_FullIdentifier());
}

inline void FinishLogisticsSpecialties_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsSpecialties_Full> root) {
  fbb.Finish(root, LogisticsSpecialties_FullIdentifier());
}

inline void FinishSizePrefixedLogisticsSpecialties_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsSpecialties_Full> root) {
  fbb.FinishSizePrefixed(root, LogisticsSpecialties_FullIdentifier());
}
