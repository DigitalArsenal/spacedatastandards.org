...
struct OrbitDetermination_Ingest;
struct OrbitDetermination_IngestBuilder;

enum OrbitDetermination_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  OrbitDetermination_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  OrbitDetermination_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  OrbitDetermination_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  OrbitDetermination_Ingest_dataMode_Enum_EXERCISE = 3,
  OrbitDetermination_Ingest_dataMode_Enum_MIN = OrbitDetermination_Ingest_dataMode_Enum_REAL,
  OrbitDetermination_Ingest_dataMode_Enum_MAX = OrbitDetermination_Ingest_dataMode_Enum_EXERCISE
};

inline const OrbitDetermination_Ingest_dataMode_Enum (&EnumValuesOrbitDetermination_Ingest_dataMode_Enum())[4] {
  static const OrbitDetermination_Ingest_dataMode_Enum values[] = {
    OrbitDetermination_Ingest_dataMode_Enum_REAL,
    OrbitDetermination_Ingest_dataMode_Enum_TEST,
    OrbitDetermination_Ingest_dataMode_Enum_SIMULATED,
    OrbitDetermination_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesOrbitDetermination_Ingest_dataMode_Enum() {
...
inline const char *EnumNameOrbitDetermination_Ingest_dataMode_Enum(OrbitDetermination_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, OrbitDetermination_Ingest_dataMode_Enum_REAL, OrbitDetermination_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOrbitDetermination_Ingest_dataMode_Enum()[index];
}
...
struct OrbitDetermination_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef OrbitDetermination_IngestBuilder Builder;
  ...
  OrbitDetermination_Ingest_dataMode_Enum dataMode() const {
    return static_cast<OrbitDetermination_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct OrbitDetermination_IngestBuilder {
  typedef OrbitDetermination_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_ENDTIME, endTime);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_ORIGOBJECTID, origObjectId);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(OrbitDetermination_Ingest::VT_SATNO, satNo, 0);
  }
  void add_aprioriIdElset(::flatbuffers::Offset<::flatbuffers::String> aprioriIdElset) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_APRIORIIDELSET, aprioriIdElset);
  }
  void add_aprioriElset(::flatbuffers::Offset<::flatbuffers::String> aprioriElset) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_APRIORIELSET, aprioriElset);
  }
  void add_aprioriIdStateVector(::flatbuffers::Offset<::flatbuffers::String> aprioriIdStateVector) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_APRIORIIDSTATEVECTOR, aprioriIdStateVector);
  }
  void add_aprioriStateVector(::flatbuffers::Offset<::flatbuffers::String> aprioriStateVector) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_APRIORISTATEVECTOR, aprioriStateVector);
  }
  void add_initialOD(bool initialOD) {
    fbb_.AddElement<uint8_t>(OrbitDetermination_Ingest::VT_INITIALOD, static_cast<uint8_t>(initialOD), 0);
  }
  void add_lastObStart(::flatbuffers::Offset<::flatbuffers::String> lastObStart) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_LASTOBSTART, lastObStart);
  }
  void add_lastObEnd(::flatbuffers::Offset<::flatbuffers::String> lastObEnd) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_LASTOBEND, lastObEnd);
  }
  void add_timeSpan(double timeSpan) {
    fbb_.AddElement<double>(OrbitDetermination_Ingest::VT_TIMESPAN, timeSpan, 0.0);
  }
  void add_effectiveFrom(::flatbuffers::Offset<::flatbuffers::String> effectiveFrom) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_EFFECTIVEFROM, effectiveFrom);
  }
  void add_effectiveUntil(::flatbuffers::Offset<::flatbuffers::String> effectiveUntil) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_EFFECTIVEUNTIL, effectiveUntil);
  }
  void add_wrms(double wrms) {
    fbb_.AddElement<double>(OrbitDetermination_Ingest::VT_WRMS, wrms, 0.0);
  }
  void add_previousWrms(double previousWrms) {
    fbb_.AddElement<double>(OrbitDetermination_Ingest::VT_PREVIOUSWRMS, previousWrms, 0.0);
  }
  void add_firstPassWrms(double firstPassWrms) {
    fbb_.AddElement<double>(OrbitDetermination_Ingest::VT_FIRSTPASSWRMS, firstPassWrms, 0.0);
  }
  void add_bestPassWrms(double bestPassWrms) {
    fbb_.AddElement<double>(OrbitDetermination_Ingest::VT_BESTPASSWRMS, bestPassWrms, 0.0);
  }
  void add_errorGrowthRate(double errorGrowthRate) {
    fbb_.AddElement<double>(OrbitDetermination_Ingest::VT_ERRORGROWTHRATE, errorGrowthRate, 0.0);
  }
  void add_edr(double edr) {
    fbb_.AddElement<double>(OrbitDetermination_Ingest::VT_EDR, edr, 0.0);
  }
  void add_method(::flatbuffers::Offset<::flatbuffers::String> method) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_METHOD, method);
  }
  void add_methodSource(::flatbuffers::Offset<::flatbuffers::String> methodSource) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_METHODSOURCE, methodSource);
  }
  void add_fitSpan(double fitSpan) {
    fbb_.AddElement<double>(OrbitDetermination_Ingest::VT_FITSPAN, fitSpan, 0.0);
  }
  void add_ballisticCoeffEst(bool ballisticCoeffEst) {
    fbb_.AddElement<uint8_t>(OrbitDetermination_Ingest::VT_BALLISTICCOEFFEST, static_cast<uint8_t>(ballisticCoeffEst), 0);
  }
  void add_ballisticCoeffModel(::flatbuffers::Offset<::flatbuffers::String> ballisticCoeffModel) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_BALLISTICCOEFFMODEL, ballisticCoeffModel);
  }
  void add_agomEst(bool agomEst) {
    fbb_.AddElement<uint8_t>(OrbitDetermination_Ingest::VT_AGOMEST, static_cast<uint8_t>(agomEst), 0);
  }
  void add_agomModel(::flatbuffers::Offset<::flatbuffers::String> agomModel) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_AGOMMODEL, agomModel);
  }
  void add_rmsConvergenceCriteria(double rmsConvergenceCriteria) {
    fbb_.AddElement<double>(OrbitDetermination_Ingest::VT_RMSCONVERGENCECRITERIA, rmsConvergenceCriteria, 0.0);
  }
  void add_numIterations(int32_t numIterations) {
    fbb_.AddElement<int32_t>(OrbitDetermination_Ingest::VT_NUMITERATIONS, numIterations, 0);
  }
  void add_acceptedObTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> acceptedObTyps) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_ACCEPTEDOBTYPS, acceptedObTyps);
  }
  void add_acceptedObIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> acceptedObIds) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_ACCEPTEDOBIDS, acceptedObIds);
  }
  void add_rejectedObTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rejectedObTyps) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_REJECTEDOBTYPS, rejectedObTyps);
  }
  void add_rejectedObIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rejectedObIds) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_REJECTEDOBIDS, rejectedObIds);
  }
  void add_sensorIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sensorIds) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_SENSORIDS, sensorIds);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(OrbitDetermination_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(OrbitDetermination_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(OrbitDetermination_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit OrbitDetermination_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<OrbitDetermination_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<OrbitDetermination_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<OrbitDetermination_Ingest> CreateOrbitDetermination_Ingest(
    ...
    OrbitDetermination_Ingest_dataMode_Enum dataMode = OrbitDetermination_Ingest_dataMode_Enum_REAL) {
  OrbitDetermination_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<OrbitDetermination_Ingest> CreateOrbitDetermination_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const OrbitDetermination_Ingest *GetOrbitDetermination_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<OrbitDetermination_Ingest>(buf);
}

inline const OrbitDetermination_Ingest *GetSizePrefixedOrbitDetermination_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<OrbitDetermination_Ingest>(buf);
}

inline const char *OrbitDetermination_IngestIdentifier() {
  return "ORBI";
}

inline bool OrbitDetermination_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OrbitDetermination_IngestIdentifier());
}

inline bool SizePrefixedOrbitDetermination_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OrbitDetermination_IngestIdentifier(), true);
}

inline bool VerifyOrbitDetermination_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<OrbitDetermination_Ingest>(OrbitDetermination_IngestIdentifier());
}

inline bool VerifySizePrefixedOrbitDetermination_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<OrbitDetermination_Ingest>(OrbitDetermination_IngestIdentifier());
}

inline void FinishOrbitDetermination_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OrbitDetermination_Ingest> root) {
  fbb.Finish(root, OrbitDetermination_IngestIdentifier());
}

inline void FinishSizePrefixedOrbitDetermination_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OrbitDetermination_Ingest> root) {
  fbb.FinishSizePrefixed(root, OrbitDetermination_IngestIdentifier());
}
