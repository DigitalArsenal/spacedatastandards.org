...
struct IonoObservationAmplitude_Full;
...
struct IonoObservationAmplitude_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef IonoObservationAmplitude_FullBuilder Builder;
...
struct IonoObservationAmplitude_FullBuilder {
  typedef IonoObservationAmplitude_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(IonoObservationAmplitude_Full::VT_NOTES, notes);
  }
  void add_dimensions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dimensions) {
    fbb_.AddOffset(IonoObservationAmplitude_Full::VT_DIMENSIONS, dimensions);
  }
  void add_dimensionName(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dimensionName) {
    fbb_.AddOffset(IonoObservationAmplitude_Full::VT_DIMENSIONNAME, dimensionName);
  }
  void add_data(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> data) {
    fbb_.AddOffset(IonoObservationAmplitude_Full::VT_DATA, data);
  }
  explicit IonoObservationAmplitude_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<IonoObservationAmplitude_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<IonoObservationAmplitude_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<IonoObservationAmplitude_Full> CreateIonoObservationAmplitude_Full(
  ...
  IonoObservationAmplitude_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<IonoObservationAmplitude_Full> CreateIonoObservationAmplitude_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const IonoObservationAmplitude_Full *GetIonoObservationAmplitude_Full(const void *buf) {
  return ::flatbuffers::GetRoot<IonoObservationAmplitude_Full>(buf);
}

inline const IonoObservationAmplitude_Full *GetSizePrefixedIonoObservationAmplitude_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<IonoObservationAmplitude_Full>(buf);
}

inline const char *IonoObservationAmplitude_FullIdentifier() {
  return "IONO";
}

inline bool IonoObservationAmplitude_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationAmplitude_FullIdentifier());
}

inline bool SizePrefixedIonoObservationAmplitude_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationAmplitude_FullIdentifier(), true);
}

inline bool VerifyIonoObservationAmplitude_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<IonoObservationAmplitude_Full>(IonoObservationAmplitude_FullIdentifier());
}

inline bool VerifySizePrefixedIonoObservationAmplitude_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<IonoObservationAmplitude_Full>(IonoObservationAmplitude_FullIdentifier());
}

inline void FinishIonoObservationAmplitude_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationAmplitude_Full> root) {
  fbb.Finish(root, IonoObservationAmplitude_FullIdentifier());
}

inline void FinishSizePrefixedIonoObservationAmplitude_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationAmplitude_Full> root) {
  fbb.FinishSizePrefixed(root, IonoObservationAmplitude_FullIdentifier());
}
