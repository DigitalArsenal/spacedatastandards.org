...
struct Bus_Abridged;
struct Bus_AbridgedBuilder;

enum Bus_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Bus_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Bus_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Bus_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Bus_Abridged_dataMode_Enum_EXERCISE = 3,
  Bus_Abridged_dataMode_Enum_MIN = Bus_Abridged_dataMode_Enum_REAL,
  Bus_Abridged_dataMode_Enum_MAX = Bus_Abridged_dataMode_Enum_EXERCISE
};

inline const Bus_Abridged_dataMode_Enum (&EnumValuesBus_Abridged_dataMode_Enum())[4] {
  static const Bus_Abridged_dataMode_Enum values[] = {
    Bus_Abridged_dataMode_Enum_REAL,
    Bus_Abridged_dataMode_Enum_TEST,
    Bus_Abridged_dataMode_Enum_SIMULATED,
    Bus_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesBus_Abridged_dataMode_Enum() {
...
inline const char *EnumNameBus_Abridged_dataMode_Enum(Bus_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Bus_Abridged_dataMode_Enum_REAL, Bus_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesBus_Abridged_dataMode_Enum()[index];
}
...
struct Bus_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Bus_AbridgedBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_NUMORBITTYPE = 80,
    VT_TELEMETRYTRACKINGMANUFACTURERORGID = 82,
    VT_MAINCOMPUTERMANUFACTURERORGID = 84,
    VT_MANUFACTURERORGID = 86,
    VT_BUSKITDESIGNERORGID = 88,
    VT_COUNTRYCODE = 90,
    VT_MASSCATEGORY = 92,
    VT_POWERCATEGORY = 94,
    VT_GENERIC = 96,
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Bus_Abridged_dataMode_Enum dataMode() const {
    return static_cast<Bus_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Bus_AbridgedBuilder {
  typedef Bus_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Bus_Abridged::VT_ID, id);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(Bus_Abridged::VT_NAME, name);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Bus_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idEntity(::flatbuffers::Offset<::flatbuffers::String> idEntity) {
    fbb_.AddOffset(Bus_Abridged::VT_IDENTITY, idEntity);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(Bus_Abridged::VT_TYPE, type);
  }
  void add_maxLaunchMassLower(double maxLaunchMassLower) {
    fbb_.AddElement<double>(Bus_Abridged::VT_MAXLAUNCHMASSLOWER, maxLaunchMassLower, 0.0);
  }
  void add_maxLaunchMassUpper(double maxLaunchMassUpper) {
    fbb_.AddElement<double>(Bus_Abridged::VT_MAXLAUNCHMASSUPPER, maxLaunchMassUpper, 0.0);
  }
  void add_maxBOLStationMass(double maxBOLStationMass) {
    fbb_.AddElement<double>(Bus_Abridged::VT_MAXBOLSTATIONMASS, maxBOLStationMass, 0.0);
  }
  void add_avgPayloadMass(double avgPayloadMass) {
    fbb_.AddElement<double>(Bus_Abridged::VT_AVGPAYLOADMASS, avgPayloadMass, 0.0);
  }
  void add_maxPayloadMass(double maxPayloadMass) {
    fbb_.AddElement<double>(Bus_Abridged::VT_MAXPAYLOADMASS, maxPayloadMass, 0.0);
  }
  void add_minDryMass(double minDryMass) {
    fbb_.AddElement<double>(Bus_Abridged::VT_MINDRYMASS, minDryMass, 0.0);
  }
  void add_avgDryMass(double avgDryMass) {
    fbb_.AddElement<double>(Bus_Abridged::VT_AVGDRYMASS, avgDryMass, 0.0);
  }
  void add_medianDryMass(double medianDryMass) {
    fbb_.AddElement<double>(Bus_Abridged::VT_MEDIANDRYMASS, medianDryMass, 0.0);
  }
  void add_maxDryMass(double maxDryMass) {
    fbb_.AddElement<double>(Bus_Abridged::VT_MAXDRYMASS, maxDryMass, 0.0);
  }
  void add_minWetMass(double minWetMass) {
    fbb_.AddElement<double>(Bus_Abridged::VT_MINWETMASS, minWetMass, 0.0);
  }
  void add_avgWetMass(double avgWetMass) {
    fbb_.AddElement<double>(Bus_Abridged::VT_AVGWETMASS, avgWetMass, 0.0);
  }
  void add_medianWetMass(double medianWetMass) {
    fbb_.AddElement<double>(Bus_Abridged::VT_MEDIANWETMASS, medianWetMass, 0.0);
  }
  void add_maxWetMass(double maxWetMass) {
    fbb_.AddElement<double>(Bus_Abridged::VT_MAXWETMASS, maxWetMass, 0.0);
  }
  void add_maxBOLPowerLower(double maxBOLPowerLower) {
    fbb_.AddElement<double>(Bus_Abridged::VT_MAXBOLPOWERLOWER, maxBOLPowerLower, 0.0);
  }
  void add_maxBOLPowerUpper(double maxBOLPowerUpper) {
    fbb_.AddElement<double>(Bus_Abridged::VT_MAXBOLPOWERUPPER, maxBOLPowerUpper, 0.0);
  }
  void add_maxEOLPowerLower(double maxEOLPowerLower) {
    fbb_.AddElement<double>(Bus_Abridged::VT_MAXEOLPOWERLOWER, maxEOLPowerLower, 0.0);
  }
  void add_maxEOLPowerUpper(double maxEOLPowerUpper) {
    fbb_.AddElement<double>(Bus_Abridged::VT_MAXEOLPOWERUPPER, maxEOLPowerUpper, 0.0);
  }
  void add_avgSpacecraftPower(double avgSpacecraftPower) {
    fbb_.AddElement<double>(Bus_Abridged::VT_AVGSPACECRAFTPOWER, avgSpacecraftPower, 0.0);
  }
  void add_maxSpacecraftPower(double maxSpacecraftPower) {
    fbb_.AddElement<double>(Bus_Abridged::VT_MAXSPACECRAFTPOWER, maxSpacecraftPower, 0.0);
  }
  void add_oapSpacecraftPower(double oapSpacecraftPower) {
    fbb_.AddElement<double>(Bus_Abridged::VT_OAPSPACECRAFTPOWER, oapSpacecraftPower, 0.0);
  }
  void add_avgPayloadPower(double avgPayloadPower) {
    fbb_.AddElement<double>(Bus_Abridged::VT_AVGPAYLOADPOWER, avgPayloadPower, 0.0);
  }
  void add_maxPayloadPower(double maxPayloadPower) {
    fbb_.AddElement<double>(Bus_Abridged::VT_MAXPAYLOADPOWER, maxPayloadPower, 0.0);
  }
  void add_oapPayloadPower(double oapPayloadPower) {
    fbb_.AddElement<double>(Bus_Abridged::VT_OAPPAYLOADPOWER, oapPayloadPower, 0.0);
  }
  void add_bodyDimensionX(double bodyDimensionX) {
    fbb_.AddElement<double>(Bus_Abridged::VT_BODYDIMENSIONX, bodyDimensionX, 0.0);
  }
  void add_bodyDimensionY(double bodyDimensionY) {
    fbb_.AddElement<double>(Bus_Abridged::VT_BODYDIMENSIONY, bodyDimensionY, 0.0);
  }
  void add_bodyDimensionZ(double bodyDimensionZ) {
    fbb_.AddElement<double>(Bus_Abridged::VT_BODYDIMENSIONZ, bodyDimensionZ, 0.0);
  }
  void add_payloadDimensionX(double payloadDimensionX) {
    fbb_.AddElement<double>(Bus_Abridged::VT_PAYLOADDIMENSIONX, payloadDimensionX, 0.0);
  }
  void add_payloadDimensionY(double payloadDimensionY) {
    fbb_.AddElement<double>(Bus_Abridged::VT_PAYLOADDIMENSIONY, payloadDimensionY, 0.0);
  }
  void add_payloadDimensionZ(double payloadDimensionZ) {
    fbb_.AddElement<double>(Bus_Abridged::VT_PAYLOADDIMENSIONZ, payloadDimensionZ, 0.0);
  }
  void add_payloadVolume(double payloadVolume) {
    fbb_.AddElement<double>(Bus_Abridged::VT_PAYLOADVOLUME, payloadVolume, 0.0);
  }
  void add_launchEnvelopeDimensionX(double launchEnvelopeDimensionX) {
    fbb_.AddElement<double>(Bus_Abridged::VT_LAUNCHENVELOPEDIMENSIONX, launchEnvelopeDimensionX, 0.0);
  }
  void add_launchEnvelopeDimensionY(double launchEnvelopeDimensionY) {
    fbb_.AddElement<double>(Bus_Abridged::VT_LAUNCHENVELOPEDIMENSIONY, launchEnvelopeDimensionY, 0.0);
  }
  void add_launchEnvelopeDimensionZ(double launchEnvelopeDimensionZ) {
    fbb_.AddElement<double>(Bus_Abridged::VT_LAUNCHENVELOPEDIMENSIONZ, launchEnvelopeDimensionZ, 0.0);
  }
  void add_numOrbitType(int32_t numOrbitType) {
    fbb_.AddElement<int32_t>(Bus_Abridged::VT_NUMORBITTYPE, numOrbitType, 0);
  }
  void add_telemetryTrackingManufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> telemetryTrackingManufacturerOrgId) {
    fbb_.AddOffset(Bus_Abridged::VT_TELEMETRYTRACKINGMANUFACTURERORGID, telemetryTrackingManufacturerOrgId);
  }
  void add_mainComputerManufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> mainComputerManufacturerOrgId) {
    fbb_.AddOffset(Bus_Abridged::VT_MAINCOMPUTERMANUFACTURERORGID, mainComputerManufacturerOrgId);
  }
  void add_manufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrgId) {
    fbb_.AddOffset(Bus_Abridged::VT_MANUFACTURERORGID, manufacturerOrgId);
  }
  void add_busKitDesignerOrgId(::flatbuffers::Offset<::flatbuffers::String> busKitDesignerOrgId) {
    fbb_.AddOffset(Bus_Abridged::VT_BUSKITDESIGNERORGID, busKitDesignerOrgId);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(Bus_Abridged::VT_COUNTRYCODE, countryCode);
  }
  void add_massCategory(::flatbuffers::Offset<::flatbuffers::String> massCategory) {
    fbb_.AddOffset(Bus_Abridged::VT_MASSCATEGORY, massCategory);
  }
  void add_powerCategory(::flatbuffers::Offset<::flatbuffers::String> powerCategory) {
    fbb_.AddOffset(Bus_Abridged::VT_POWERCATEGORY, powerCategory);
  }
  void add_generic(bool generic) {
    fbb_.AddElement<uint8_t>(Bus_Abridged::VT_GENERIC, static_cast<uint8_t>(generic), 0);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(Bus_Abridged::VT_DESCRIPTION, description);
  }
  void add_aocsNotes(::flatbuffers::Offset<::flatbuffers::String> aocsNotes) {
    fbb_.AddOffset(Bus_Abridged::VT_AOCSNOTES, aocsNotes);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Bus_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Bus_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Bus_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(Bus_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Bus_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Bus_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Bus_Abridged::VT_CREATEDBY, createdBy);
  }
  explicit Bus_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Bus_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Bus_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Bus_Abridged> CreateBus_Abridged(
    ...
    Bus_Abridged_dataMode_Enum dataMode = Bus_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0) {
  Bus_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Bus_Abridged> CreateBus_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Bus_Abridged *GetBus_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<Bus_Abridged>(buf);
}

inline const Bus_Abridged *GetSizePrefixedBus_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Bus_Abridged>(buf);
}

inline const char *Bus_AbridgedIdentifier() {
  return "BUSA";
}

inline bool Bus_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Bus_AbridgedIdentifier());
}

inline bool SizePrefixedBus_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Bus_AbridgedIdentifier(), true);
}

inline bool VerifyBus_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Bus_Abridged>(Bus_AbridgedIdentifier());
}

inline bool VerifySizePrefixedBus_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Bus_Abridged>(Bus_AbridgedIdentifier());
}

inline void FinishBus_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Bus_Abridged> root) {
  fbb.Finish(root, Bus_AbridgedIdentifier());
}

inline void FinishSizePrefixedBus_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Bus_Abridged> root) {
  fbb.FinishSizePrefixed(root, Bus_AbridgedIdentifier());
}
