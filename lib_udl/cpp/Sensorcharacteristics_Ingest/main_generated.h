...
struct Sensorcharacteristics_Ingest;
struct Sensorcharacteristics_IngestBuilder;

enum Sensorcharacteristics_Ingest_dataMode_Enum : int8_t {
  ...
  Sensorcharacteristics_Ingest_dataMode_Enum_MIN = Sensorcharacteristics_Ingest_dataMode_Enum_REAL,
  Sensorcharacteristics_Ingest_dataMode_Enum_MAX = Sensorcharacteristics_Ingest_dataMode_Enum_EXERCISE
};

inline const Sensorcharacteristics_Ingest_dataMode_Enum (&EnumValuesSensorcharacteristics_Ingest_dataMode_Enum())[4] {
  static const Sensorcharacteristics_Ingest_dataMode_Enum values[] = {
    Sensorcharacteristics_Ingest_dataMode_Enum_REAL,
    Sensorcharacteristics_Ingest_dataMode_Enum_TEST,
    Sensorcharacteristics_Ingest_dataMode_Enum_SIMULATED,
    Sensorcharacteristics_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSensorcharacteristics_Ingest_dataMode_Enum() {
...
inline const char *EnumNameSensorcharacteristics_Ingest_dataMode_Enum(Sensorcharacteristics_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Sensorcharacteristics_Ingest_dataMode_Enum_REAL, Sensorcharacteristics_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSensorcharacteristics_Ingest_dataMode_Enum()[index];
}

/// /// Model representation of characteristics and capabilities of a sensor.
struct Sensorcharacteristics_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Sensorcharacteristics_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Sensorcharacteristics_Ingest_dataMode_Enum dataMode() const {
    return static_cast<Sensorcharacteristics_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Sensorcharacteristics_IngestBuilder {
  typedef Sensorcharacteristics_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Sensorcharacteristics_Ingest::VT_ID, id);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(Sensorcharacteristics_Ingest::VT_IDSENSOR, idSensor);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Sensorcharacteristics_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Sensorcharacteristics_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_azimuthRate(double azimuthRate) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_AZIMUTHRATE, azimuthRate, 0.0);
  }
  void add_elevationRateGeolm(double elevationRateGeolm) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_ELEVATIONRATEGEOLM, elevationRateGeolm, 0.0);
  }
  void add_minRangeLimit(double minRangeLimit) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_MINRANGELIMIT, minRangeLimit, 0.0);
  }
  void add_maxRangeLimit(double maxRangeLimit) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_MAXRANGELIMIT, maxRangeLimit, 0.0);
  }
  void add_leftClockAngle(double leftClockAngle) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_LEFTCLOCKANGLE, leftClockAngle, 0.0);
  }
  void add_rightClockAngle(double rightClockAngle) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_RIGHTCLOCKANGLE, rightClockAngle, 0.0);
  }
  void add_boresight(double boresight) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_BORESIGHT, boresight, 0.0);
  }
  void add_boresightOffAngle(double boresightOffAngle) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_BORESIGHTOFFANGLE, boresightOffAngle, 0.0);
  }
  void add_negativeRangeRateLimit(double negativeRangeRateLimit) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_NEGATIVERANGERATELIMIT, negativeRangeRateLimit, 0.0);
  }
  void add_positiveRangeRateLimit(double positiveRangeRateLimit) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_POSITIVERANGERATELIMIT, positiveRangeRateLimit, 0.0);
  }
  void add_magnitudeLimit(double magnitudeLimit) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_MAGNITUDELIMIT, magnitudeLimit, 0.0);
  }
  void add_trackAngle(double trackAngle) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_TRACKANGLE, trackAngle, 0.0);
  }
  void add_minSignalNoiseRatio(double minSignalNoiseRatio) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_MINSIGNALNOISERATIO, minSignalNoiseRatio, 0.0);
  }
  void add_fanBeamWidth(double fanBeamWidth) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_FANBEAMWIDTH, fanBeamWidth, 0.0);
  }
  void add_taskableRange(double taskableRange) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_TASKABLERANGE, taskableRange, 0.0);
  }
  void add_maxObservableRange(double maxObservableRange) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_MAXOBSERVABLERANGE, maxObservableRange, 0.0);
  }
  void add_radioFrequency(double radioFrequency) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_RADIOFREQUENCY, radioFrequency, 0.0);
  }
  void add_radarFrequency(double radarFrequency) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_RADARFREQUENCY, radarFrequency, 0.0);
  }
  void add_transmitPower(double transmitPower) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_TRANSMITPOWER, transmitPower, 0.0);
  }
  void add_hFOV(double hFOV) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_HFOV, hFOV, 0.0);
  }
  void add_vFOV(double vFOV) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_VFOV, vFOV, 0.0);
  }
  void add_hResPixels(int32_t hResPixels) {
    fbb_.AddElement<int32_t>(Sensorcharacteristics_Ingest::VT_HRESPIXELS, hResPixels, 0);
  }
  void add_vResPixels(int32_t vResPixels) {
    fbb_.AddElement<int32_t>(Sensorcharacteristics_Ingest::VT_VRESPIXELS, vResPixels, 0);
  }
  void add_band(::flatbuffers::Offset<::flatbuffers::String> band) {
    fbb_.AddOffset(Sensorcharacteristics_Ingest::VT_BAND, band);
  }
  void add_maxDeviationAngle(double maxDeviationAngle) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_MAXDEVIATIONANGLE, maxDeviationAngle, 0.0);
  }
  void add_aperture(double aperture) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_APERTURE, aperture, 0.0);
  }
  void add_leftGeoBeltLimit(double leftGeoBeltLimit) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_LEFTGEOBELTLIMIT, leftGeoBeltLimit, 0.0);
  }
  void add_rightGeoBeltLimit(double rightGeoBeltLimit) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_RIGHTGEOBELTLIMIT, rightGeoBeltLimit, 0.0);
  }
  void add_asrScanRate(double asrScanRate) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_ASRSCANRATE, asrScanRate, 0.0);
  }
  void add_k(double k) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_K, k, 0.0);
  }
  void add_focalPoint(double focalPoint) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_FOCALPOINT, focalPoint, 0.0);
  }
  void add_towerHeight(double towerHeight) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_TOWERHEIGHT, towerHeight, 0.0);
  }
  void add_trueNorthCorrector(int32_t trueNorthCorrector) {
    fbb_.AddElement<int32_t>(Sensorcharacteristics_Ingest::VT_TRUENORTHCORRECTOR, trueNorthCorrector, 0);
  }
  void add_magDec(double magDec) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_MAGDEC, magDec, 0.0);
  }
  void add_z1MinRange(double z1MinRange) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_Z1MINRANGE, z1MinRange, 0.0);
  }
  void add_z2MinRange(double z2MinRange) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_Z2MINRANGE, z2MinRange, 0.0);
  }
  void add_z1MaxRange(double z1MaxRange) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_Z1MAXRANGE, z1MaxRange, 0.0);
  }
  void add_z2MaxRange(double z2MaxRange) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_Z2MAXRANGE, z2MaxRange, 0.0);
  }
  void add_radarMUR(double radarMUR) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_RADARMUR, radarMUR, 0.0);
  }
  void add_probFalseAlarm(double probFalseAlarm) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_PROBFALSEALARM, probFalseAlarm, 0.0);
  }
  void add_prf(double prf) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_PRF, prf, 0.0);
  }
  void add_radarPulseWidth(double radarPulseWidth) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_RADARPULSEWIDTH, radarPulseWidth, 0.0);
  }
  void add_numIntegratedPulses(int32_t numIntegratedPulses) {
    fbb_.AddElement<int32_t>(Sensorcharacteristics_Ingest::VT_NUMINTEGRATEDPULSES, numIntegratedPulses, 0);
  }
  void add_trueTilt(double trueTilt) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_TRUETILT, trueTilt, 0.0);
  }
  void add_radarMessageFormat(::flatbuffers::Offset<::flatbuffers::String> radarMessageFormat) {
    fbb_.AddOffset(Sensorcharacteristics_Ingest::VT_RADARMESSAGEFORMAT, radarMessageFormat);
  }
  void add_systemNoiseTemperature(double systemNoiseTemperature) {
    fbb_.AddElement<double>(Sensorcharacteristics_Ingest::VT_SYSTEMNOISETEMPERATURE, systemNoiseTemperature, 0.0);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Sensorcharacteristics_Ingest::VT_SOURCE, source);
  }
  void add_dataMode(Sensorcharacteristics_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Sensorcharacteristics_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Sensorcharacteristics_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Sensorcharacteristics_Ingest::VT_CREATEDBY, createdBy);
  }
  explicit Sensorcharacteristics_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Sensorcharacteristics_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Sensorcharacteristics_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Sensorcharacteristics_Ingest> CreateSensorcharacteristics_Ingest(
    ...
    Sensorcharacteristics_Ingest_dataMode_Enum dataMode = Sensorcharacteristics_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0) {
  Sensorcharacteristics_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Sensorcharacteristics_Ingest> CreateSensorcharacteristics_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateSensorcharacteristics_Ingest(
      _fbb,
      id__,
      idSensor__,
...
inline const Sensorcharacteristics_Ingest *GetSensorcharacteristics_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<Sensorcharacteristics_Ingest>(buf);
}

inline const Sensorcharacteristics_Ingest *GetSizePrefixedSensorcharacteristics_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Sensorcharacteristics_Ingest>(buf);
}

inline const char *Sensorcharacteristics_IngestIdentifier() {
  return "SENS";
}

inline bool Sensorcharacteristics_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Sensorcharacteristics_IngestIdentifier());
}

inline bool SizePrefixedSensorcharacteristics_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Sensorcharacteristics_IngestIdentifier(), true);
}

inline bool VerifySensorcharacteristics_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Sensorcharacteristics_Ingest>(Sensorcharacteristics_IngestIdentifier());
}

inline bool VerifySizePrefixedSensorcharacteristics_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Sensorcharacteristics_Ingest>(Sensorcharacteristics_IngestIdentifier());
}

inline void FinishSensorcharacteristics_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Sensorcharacteristics_Ingest> root) {
  fbb.Finish(root, Sensorcharacteristics_IngestIdentifier());
}

inline void FinishSizePrefixedSensorcharacteristics_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Sensorcharacteristics_Ingest> root) {
  fbb.FinishSizePrefixed(root, Sensorcharacteristics_IngestIdentifier());
}
