...
struct OnboardNavigation_Ingest;
struct OnboardNavigation_IngestBuilder;

enum OnboardNavigation_Ingest_referenceFrame_Enum : int8_t {
  ...
  OnboardNavigation_Ingest_referenceFrame_Enum_MIN = OnboardNavigation_Ingest_referenceFrame_Enum_J2000,
  OnboardNavigation_Ingest_referenceFrame_Enum_MAX = OnboardNavigation_Ingest_referenceFrame_Enum_GCRF
};

inline const OnboardNavigation_Ingest_referenceFrame_Enum (&EnumValuesOnboardNavigation_Ingest_referenceFrame_Enum())[6] {
  static const OnboardNavigation_Ingest_referenceFrame_Enum values[] = {
    OnboardNavigation_Ingest_referenceFrame_Enum_J2000,
    OnboardNavigation_Ingest_referenceFrame_Enum_EFG_TDR,
    OnboardNavigation_Ingest_referenceFrame_Enum_ECR_ECEF,
    OnboardNavigation_Ingest_referenceFrame_Enum_TEME,
    OnboardNavigation_Ingest_referenceFrame_Enum_ITRF,
    OnboardNavigation_Ingest_referenceFrame_Enum_GCRF
  };
  return values;
}

inline const char * const *EnumNamesOnboardNavigation_Ingest_referenceFrame_Enum() {
...
inline const char *EnumNameOnboardNavigation_Ingest_referenceFrame_Enum(OnboardNavigation_Ingest_referenceFrame_Enum e) {
  if (::flatbuffers::IsOutRange(e, OnboardNavigation_Ingest_referenceFrame_Enum_J2000, OnboardNavigation_Ingest_referenceFrame_Enum_GCRF)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOnboardNavigation_Ingest_referenceFrame_Enum()[index];
}

enum OnboardNavigation_Ingest_dataMode_Enum : int8_t {
  ...
  OnboardNavigation_Ingest_dataMode_Enum_MIN = OnboardNavigation_Ingest_dataMode_Enum_REAL,
  OnboardNavigation_Ingest_dataMode_Enum_MAX = OnboardNavigation_Ingest_dataMode_Enum_EXERCISE
};

inline const OnboardNavigation_Ingest_dataMode_Enum (&EnumValuesOnboardNavigation_Ingest_dataMode_Enum())[4] {
  static const OnboardNavigation_Ingest_dataMode_Enum values[] = {
    OnboardNavigation_Ingest_dataMode_Enum_REAL,
    OnboardNavigation_Ingest_dataMode_Enum_TEST,
    OnboardNavigation_Ingest_dataMode_Enum_SIMULATED,
    OnboardNavigation_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesOnboardNavigation_Ingest_dataMode_Enum() {
...
inline const char *EnumNameOnboardNavigation_Ingest_dataMode_Enum(OnboardNavigation_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, OnboardNavigation_Ingest_dataMode_Enum_REAL, OnboardNavigation_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOnboardNavigation_Ingest_dataMode_Enum()[index];
}
...
struct OnboardNavigation_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef OnboardNavigation_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 0, Maximum length = 24
  OnboardNavigation_Ingest_referenceFrame_Enum referenceFrame() const {
    return static_cast<OnboardNavigation_Ingest_referenceFrame_Enum>(GetField<int8_t>(VT_REFERENCEFRAME, 0));
  }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 36
  OnboardNavigation_Ingest_dataMode_Enum dataMode() const {
    return static_cast<OnboardNavigation_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct OnboardNavigation_IngestBuilder {
  typedef OnboardNavigation_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(OnboardNavigation_Ingest::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_ORIGOBJECTID, origObjectId);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_ENDTIME, endTime);
  }
  void add_esId(::flatbuffers::Offset<::flatbuffers::String> esId) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_ESID, esId);
  }
  void add_starCatName(::flatbuffers::Offset<::flatbuffers::String> starCatName) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_STARCATNAME, starCatName);
  }
  void add_starCatLoadTime(::flatbuffers::Offset<::flatbuffers::String> starCatLoadTime) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_STARCATLOADTIME, starCatLoadTime);
  }
  void add_idStateVector(::flatbuffers::Offset<::flatbuffers::String> idStateVector) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_IDSTATEVECTOR, idStateVector);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> ts) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_TS, ts);
  }
  void add_referenceFrame(OnboardNavigation_Ingest_referenceFrame_Enum referenceFrame) {
    fbb_.AddElement<int8_t>(OnboardNavigation_Ingest::VT_REFERENCEFRAME, static_cast<int8_t>(referenceFrame), 0);
  }
  void add_sunSensor(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sunSensor) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_SUNSENSOR, sunSensor);
  }
  void add_mag(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> mag) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_MAG, mag);
  }
  void add_starTracker(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> starTracker) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_STARTRACKER, starTracker);
  }
  void add_deltaPos(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> deltaPos) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_DELTAPOS, deltaPos);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(OnboardNavigation_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(OnboardNavigation_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(OnboardNavigation_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit OnboardNavigation_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<OnboardNavigation_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<OnboardNavigation_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<OnboardNavigation_Ingest> CreateOnboardNavigation_Ingest(
    ...
    OnboardNavigation_Ingest_referenceFrame_Enum referenceFrame = OnboardNavigation_Ingest_referenceFrame_Enum_J2000,
    ...
    OnboardNavigation_Ingest_dataMode_Enum dataMode = OnboardNavigation_Ingest_dataMode_Enum_REAL) {
  OnboardNavigation_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<OnboardNavigation_Ingest> CreateOnboardNavigation_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const OnboardNavigation_Ingest *GetOnboardNavigation_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<OnboardNavigation_Ingest>(buf);
}

inline const OnboardNavigation_Ingest *GetSizePrefixedOnboardNavigation_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<OnboardNavigation_Ingest>(buf);
}

inline const char *OnboardNavigation_IngestIdentifier() {
  return "ONBO";
}

inline bool OnboardNavigation_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OnboardNavigation_IngestIdentifier());
}

inline bool SizePrefixedOnboardNavigation_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OnboardNavigation_IngestIdentifier(), true);
}

inline bool VerifyOnboardNavigation_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<OnboardNavigation_Ingest>(OnboardNavigation_IngestIdentifier());
}

inline bool VerifySizePrefixedOnboardNavigation_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<OnboardNavigation_Ingest>(OnboardNavigation_IngestIdentifier());
}

inline void FinishOnboardNavigation_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OnboardNavigation_Ingest> root) {
  fbb.Finish(root, OnboardNavigation_IngestIdentifier());
}

inline void FinishSizePrefixedOnboardNavigation_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OnboardNavigation_Ingest> root) {
  fbb.FinishSizePrefixed(root, OnboardNavigation_IngestIdentifier());
}
