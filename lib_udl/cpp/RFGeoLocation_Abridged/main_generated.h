...
struct RFGeoLocation_Abridged;
struct RFGeoLocation_AbridgedBuilder;

enum RFGeoLocation_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  RFGeoLocation_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  RFGeoLocation_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  RFGeoLocation_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  RFGeoLocation_Abridged_dataMode_Enum_EXERCISE = 3,
  RFGeoLocation_Abridged_dataMode_Enum_MIN = RFGeoLocation_Abridged_dataMode_Enum_REAL,
  RFGeoLocation_Abridged_dataMode_Enum_MAX = RFGeoLocation_Abridged_dataMode_Enum_EXERCISE
};

inline const RFGeoLocation_Abridged_dataMode_Enum (&EnumValuesRFGeoLocation_Abridged_dataMode_Enum())[4] {
  static const RFGeoLocation_Abridged_dataMode_Enum values[] = {
    RFGeoLocation_Abridged_dataMode_Enum_REAL,
    RFGeoLocation_Abridged_dataMode_Enum_TEST,
    RFGeoLocation_Abridged_dataMode_Enum_SIMULATED,
    RFGeoLocation_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesRFGeoLocation_Abridged_dataMode_Enum() {
...
inline const char *EnumNameRFGeoLocation_Abridged_dataMode_Enum(RFGeoLocation_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, RFGeoLocation_Abridged_dataMode_Enum_REAL, RFGeoLocation_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesRFGeoLocation_Abridged_dataMode_Enum()[index];
}

/// /// Model representation of geolocation data for a radio frequency (RF) signal or emitter.
struct RFGeoLocation_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef RFGeoLocation_AbridgedBuilder Builder;
  ...
  RFGeoLocation_Abridged_dataMode_Enum dataMode() const {
    return static_cast<RFGeoLocation_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct RFGeoLocation_AbridgedBuilder {
  typedef RFGeoLocation_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_orderId(::flatbuffers::Offset<::flatbuffers::String> orderId) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_ORDERID, orderId);
  }
  void add_createdTs(::flatbuffers::Offset<::flatbuffers::String> createdTs) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_CREATEDTS, createdTs);
  }
  void add_receivedTs(::flatbuffers::Offset<::flatbuffers::String> receivedTs) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_RECEIVEDTS, receivedTs);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_ENDTIME, endTime);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(RFGeoLocation_Abridged::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_ORIGOBJECTID, origObjectId);
  }
  void add_constellation(::flatbuffers::Offset<::flatbuffers::String> constellation) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_CONSTELLATION, constellation);
  }
  void add_signalOfInterest(::flatbuffers::Offset<::flatbuffers::String> signalOfInterest) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_SIGNALOFINTEREST, signalOfInterest);
  }
  void add_idRFEmitter(::flatbuffers::Offset<::flatbuffers::String> idRFEmitter) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_IDRFEMITTER, idRFEmitter);
  }
  void add_origRFEmitterId(::flatbuffers::Offset<::flatbuffers::String> origRFEmitterId) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_ORIGRFEMITTERID, origRFEmitterId);
  }
  void add_numBursts(int32_t numBursts) {
    fbb_.AddElement<int32_t>(RFGeoLocation_Abridged::VT_NUMBURSTS, numBursts, 0);
  }
  void add_minFreq(double minFreq) {
    fbb_.AddElement<double>(RFGeoLocation_Abridged::VT_MINFREQ, minFreq, 0.0);
  }
  void add_maxFreq(double maxFreq) {
    fbb_.AddElement<double>(RFGeoLocation_Abridged::VT_MAXFREQ, maxFreq, 0.0);
  }
  void add_centerFreq(double centerFreq) {
    fbb_.AddElement<double>(RFGeoLocation_Abridged::VT_CENTERFREQ, centerFreq, 0.0);
  }
  void add_detectLat(double detectLat) {
    fbb_.AddElement<double>(RFGeoLocation_Abridged::VT_DETECTLAT, detectLat, 0.0);
  }
  void add_detectLon(double detectLon) {
    fbb_.AddElement<double>(RFGeoLocation_Abridged::VT_DETECTLON, detectLon, 0.0);
  }
  void add_detectAlt(double detectAlt) {
    fbb_.AddElement<double>(RFGeoLocation_Abridged::VT_DETECTALT, detectAlt, 0.0);
  }
  void add_confSemiMajor(double confSemiMajor) {
    fbb_.AddElement<double>(RFGeoLocation_Abridged::VT_CONFSEMIMAJOR, confSemiMajor, 0.0);
  }
  void add_confSemiMinor(double confSemiMinor) {
    fbb_.AddElement<double>(RFGeoLocation_Abridged::VT_CONFSEMIMINOR, confSemiMinor, 0.0);
  }
  void add_confOrientation(double confOrientation) {
    fbb_.AddElement<double>(RFGeoLocation_Abridged::VT_CONFORIENTATION, confOrientation, 0.0);
  }
  void add_confArea(double confArea) {
    fbb_.AddElement<double>(RFGeoLocation_Abridged::VT_CONFAREA, confArea, 0.0);
  }
  void add_atype(::flatbuffers::Offset<::flatbuffers::String> atype) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_ATYPE, atype);
  }
  void add_agjson(::flatbuffers::Offset<::flatbuffers::String> agjson) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_AGJSON, agjson);
  }
  void add_atext(::flatbuffers::Offset<::flatbuffers::String> atext) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_ATEXT, atext);
  }
  void add_andims(int32_t andims) {
    fbb_.AddElement<int32_t>(RFGeoLocation_Abridged::VT_ANDIMS, andims, 0);
  }
  void add_asrid(int32_t asrid) {
    fbb_.AddElement<int32_t>(RFGeoLocation_Abridged::VT_ASRID, asrid, 0);
  }
  void add_passGroupId(::flatbuffers::Offset<::flatbuffers::String> passGroupId) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_PASSGROUPID, passGroupId);
  }
  void add_algVersion(::flatbuffers::Offset<::flatbuffers::String> algVersion) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_ALGVERSION, algVersion);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_EXTERNALID, externalId);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_TAGS, tags);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(RFGeoLocation_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_dataMode(RFGeoLocation_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(RFGeoLocation_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit RFGeoLocation_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<RFGeoLocation_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<RFGeoLocation_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<RFGeoLocation_Abridged> CreateRFGeoLocation_Abridged(
    ...
    RFGeoLocation_Abridged_dataMode_Enum dataMode = RFGeoLocation_Abridged_dataMode_Enum_REAL) {
  RFGeoLocation_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<RFGeoLocation_Abridged> CreateRFGeoLocation_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const RFGeoLocation_Abridged *GetRFGeoLocation_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<RFGeoLocation_Abridged>(buf);
}

inline const RFGeoLocation_Abridged *GetSizePrefixedRFGeoLocation_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<RFGeoLocation_Abridged>(buf);
}

inline const char *RFGeoLocation_AbridgedIdentifier() {
  return "RFGE";
}

inline bool RFGeoLocation_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RFGeoLocation_AbridgedIdentifier());
}

inline bool SizePrefixedRFGeoLocation_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RFGeoLocation_AbridgedIdentifier(), true);
}

inline bool VerifyRFGeoLocation_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<RFGeoLocation_Abridged>(RFGeoLocation_AbridgedIdentifier());
}

inline bool VerifySizePrefixedRFGeoLocation_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<RFGeoLocation_Abridged>(RFGeoLocation_AbridgedIdentifier());
}

inline void FinishRFGeoLocation_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RFGeoLocation_Abridged> root) {
  fbb.Finish(root, RFGeoLocation_AbridgedIdentifier());
}

inline void FinishSizePrefixedRFGeoLocation_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RFGeoLocation_Abridged> root) {
  fbb.FinishSizePrefixed(root, RFGeoLocation_AbridgedIdentifier());
}
