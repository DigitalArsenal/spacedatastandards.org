...
struct IonoObservationElevation_Ingest;
struct IonoObservationElevation_IngestBuilder;
...
struct IonoObservationElevation_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef IonoObservationElevation_IngestBuilder Builder;
...
struct IonoObservationElevation_IngestBuilder {
  typedef IonoObservationElevation_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(IonoObservationElevation_Ingest::VT_NOTES, notes);
  }
  void add_dimensions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dimensions) {
    fbb_.AddOffset(IonoObservationElevation_Ingest::VT_DIMENSIONS, dimensions);
  }
  void add_dimensionName(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dimensionName) {
    fbb_.AddOffset(IonoObservationElevation_Ingest::VT_DIMENSIONNAME, dimensionName);
  }
  void add_data(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> data) {
    fbb_.AddOffset(IonoObservationElevation_Ingest::VT_DATA, data);
  }
  explicit IonoObservationElevation_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<IonoObservationElevation_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<IonoObservationElevation_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<IonoObservationElevation_Ingest> CreateIonoObservationElevation_Ingest(
  ...
  IonoObservationElevation_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<IonoObservationElevation_Ingest> CreateIonoObservationElevation_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const IonoObservationElevation_Ingest *GetIonoObservationElevation_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<IonoObservationElevation_Ingest>(buf);
}

inline const IonoObservationElevation_Ingest *GetSizePrefixedIonoObservationElevation_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<IonoObservationElevation_Ingest>(buf);
}

inline const char *IonoObservationElevation_IngestIdentifier() {
  return "IONO";
}

inline bool IonoObservationElevation_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationElevation_IngestIdentifier());
}

inline bool SizePrefixedIonoObservationElevation_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationElevation_IngestIdentifier(), true);
}

inline bool VerifyIonoObservationElevation_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<IonoObservationElevation_Ingest>(IonoObservationElevation_IngestIdentifier());
}

inline bool VerifySizePrefixedIonoObservationElevation_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<IonoObservationElevation_Ingest>(IonoObservationElevation_IngestIdentifier());
}

inline void FinishIonoObservationElevation_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationElevation_Ingest> root) {
  fbb.Finish(root, IonoObservationElevation_IngestIdentifier());
}

inline void FinishSizePrefixedIonoObservationElevation_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationElevation_Ingest> root) {
  fbb.FinishSizePrefixed(root, IonoObservationElevation_IngestIdentifier());
}
