...
struct IonoObservationCharAtts_Full;
struct IonoObservationCharAtts_FullBuilder;

/// /// Characteristic attributes of a IonoObservation.
struct IonoObservationCharAtts_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef IonoObservationCharAtts_FullBuilder Builder;
...
struct IonoObservationCharAtts_FullBuilder {
  typedef IonoObservationCharAtts_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_ursiID(::flatbuffers::Offset<::flatbuffers::String> ursiID) {
    fbb_.AddOffset(IonoObservationCharAtts_Full::VT_URSIID, ursiID);
  }
  void add_charName(::flatbuffers::Offset<::flatbuffers::String> charName) {
    fbb_.AddOffset(IonoObservationCharAtts_Full::VT_CHARNAME, charName);
  }
  void add_lowerBound(double lowerBound) {
    fbb_.AddElement<double>(IonoObservationCharAtts_Full::VT_LOWERBOUND, lowerBound, 0.0);
  }
  void add_upperBound(double upperBound) {
    fbb_.AddElement<double>(IonoObservationCharAtts_Full::VT_UPPERBOUND, upperBound, 0.0);
  }
  void add_q(::flatbuffers::Offset<::flatbuffers::String> q) {
    fbb_.AddOffset(IonoObservationCharAtts_Full::VT_Q, q);
  }
  void add_d(::flatbuffers::Offset<::flatbuffers::String> d) {
    fbb_.AddOffset(IonoObservationCharAtts_Full::VT_D, d);
  }
  void add_climateModelName(::flatbuffers::Offset<::flatbuffers::String> climateModelName) {
    fbb_.AddOffset(IonoObservationCharAtts_Full::VT_CLIMATEMODELNAME, climateModelName);
  }
  void add_climateModelOptions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> climateModelOptions) {
    fbb_.AddOffset(IonoObservationCharAtts_Full::VT_CLIMATEMODELOPTIONS, climateModelOptions);
  }
  void add_climateModelInputParams(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> climateModelInputParams) {
    fbb_.AddOffset(IonoObservationCharAtts_Full::VT_CLIMATEMODELINPUTPARAMS, climateModelInputParams);
  }
  void add_uncertaintyBoundType(::flatbuffers::Offset<::flatbuffers::String> uncertaintyBoundType) {
    fbb_.AddOffset(IonoObservationCharAtts_Full::VT_UNCERTAINTYBOUNDTYPE, uncertaintyBoundType);
  }
  explicit IonoObservationCharAtts_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<IonoObservationCharAtts_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<IonoObservationCharAtts_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<IonoObservationCharAtts_Full> CreateIonoObservationCharAtts_Full(
  ...
  IonoObservationCharAtts_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<IonoObservationCharAtts_Full> CreateIonoObservationCharAtts_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateIonoObservationCharAtts_Full(
      _fbb,
      ursiID__,
      charName__,
      lowerBound,
...
inline const IonoObservationCharAtts_Full *GetIonoObservationCharAtts_Full(const void *buf) {
  return ::flatbuffers::GetRoot<IonoObservationCharAtts_Full>(buf);
}

inline const IonoObservationCharAtts_Full *GetSizePrefixedIonoObservationCharAtts_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<IonoObservationCharAtts_Full>(buf);
}

inline const char *IonoObservationCharAtts_FullIdentifier() {
  return "IONO";
}

inline bool IonoObservationCharAtts_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationCharAtts_FullIdentifier());
}

inline bool SizePrefixedIonoObservationCharAtts_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationCharAtts_FullIdentifier(), true);
}

inline bool VerifyIonoObservationCharAtts_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<IonoObservationCharAtts_Full>(IonoObservationCharAtts_FullIdentifier());
}

inline bool VerifySizePrefixedIonoObservationCharAtts_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<IonoObservationCharAtts_Full>(IonoObservationCharAtts_FullIdentifier());
}

inline void FinishIonoObservationCharAtts_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationCharAtts_Full> root) {
  fbb.Finish(root, IonoObservationCharAtts_FullIdentifier());
}

inline void FinishSizePrefixedIonoObservationCharAtts_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationCharAtts_Full> root) {
  fbb.FinishSizePrefixed(root, IonoObservationCharAtts_FullIdentifier());
}
