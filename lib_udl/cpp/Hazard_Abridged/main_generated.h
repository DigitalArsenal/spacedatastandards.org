...
struct Hazard_Abridged;
struct Hazard_AbridgedBuilder;

enum Hazard_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Hazard_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Hazard_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Hazard_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Hazard_Abridged_dataMode_Enum_EXERCISE = 3,
  Hazard_Abridged_dataMode_Enum_MIN = Hazard_Abridged_dataMode_Enum_REAL,
  Hazard_Abridged_dataMode_Enum_MAX = Hazard_Abridged_dataMode_Enum_EXERCISE
};

inline const Hazard_Abridged_dataMode_Enum (&EnumValuesHazard_Abridged_dataMode_Enum())[4] {
  static const Hazard_Abridged_dataMode_Enum values[] = {
    Hazard_Abridged_dataMode_Enum_REAL,
    Hazard_Abridged_dataMode_Enum_TEST,
    Hazard_Abridged_dataMode_Enum_SIMULATED,
    Hazard_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesHazard_Abridged_dataMode_Enum() {
...
inline const char *EnumNameHazard_Abridged_dataMode_Enum(Hazard_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Hazard_Abridged_dataMode_Enum_REAL, Hazard_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesHazard_Abridged_dataMode_Enum()[index];
}
...
struct Hazard_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Hazard_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Hazard_Abridged_dataMode_Enum dataMode() const {
    return static_cast<Hazard_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Hazard_AbridgedBuilder {
  typedef Hazard_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Hazard_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Hazard_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_detectType(::flatbuffers::Offset<::flatbuffers::String> detectType) {
    fbb_.AddOffset(Hazard_Abridged::VT_DETECTTYPE, detectType);
  }
  void add_detectTime(::flatbuffers::Offset<::flatbuffers::String> detectTime) {
    fbb_.AddOffset(Hazard_Abridged::VT_DETECTTIME, detectTime);
  }
  void add_harmful(bool harmful) {
    fbb_.AddElement<uint8_t>(Hazard_Abridged::VT_HARMFUL, static_cast<uint8_t>(harmful), 0);
  }
  void add_alarms(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> alarms) {
    fbb_.AddOffset(Hazard_Abridged::VT_ALARMS, alarms);
  }
  void add_alarmValues(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> alarmValues) {
    fbb_.AddOffset(Hazard_Abridged::VT_ALARMVALUES, alarmValues);
  }
  void add_readings(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> readings) {
    fbb_.AddOffset(Hazard_Abridged::VT_READINGS, readings);
  }
  void add_readingUnits(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> readingUnits) {
    fbb_.AddOffset(Hazard_Abridged::VT_READINGUNITS, readingUnits);
  }
  void add_readingValues(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> readingValues) {
    fbb_.AddOffset(Hazard_Abridged::VT_READINGVALUES, readingValues);
  }
  void add_matType(::flatbuffers::Offset<::flatbuffers::String> matType) {
    fbb_.AddOffset(Hazard_Abridged::VT_MATTYPE, matType);
  }
  void add_matClass(::flatbuffers::Offset<::flatbuffers::String> matClass) {
    fbb_.AddOffset(Hazard_Abridged::VT_MATCLASS, matClass);
  }
  void add_matName(::flatbuffers::Offset<::flatbuffers::String> matName) {
    fbb_.AddOffset(Hazard_Abridged::VT_MATNAME, matName);
  }
  void add_matCat(int32_t matCat) {
    fbb_.AddElement<int32_t>(Hazard_Abridged::VT_MATCAT, matCat, 0);
  }
  void add_casRN(::flatbuffers::Offset<::flatbuffers::String> casRN) {
    fbb_.AddOffset(Hazard_Abridged::VT_CASRN, casRN);
  }
  void add_ppm(int32_t ppm) {
    fbb_.AddElement<int32_t>(Hazard_Abridged::VT_PPM, ppm, 0);
  }
  void add_density(double density) {
    fbb_.AddElement<double>(Hazard_Abridged::VT_DENSITY, density, 0.0);
  }
  void add_radCtrn(double radCtrn) {
    fbb_.AddElement<double>(Hazard_Abridged::VT_RADCTRN, radCtrn, 0.0);
  }
  void add_gBar(double gBar) {
    fbb_.AddElement<double>(Hazard_Abridged::VT_GBAR, gBar, 0.0);
  }
  void add_hBar(double hBar) {
    fbb_.AddElement<double>(Hazard_Abridged::VT_HBAR, hBar, 0.0);
  }
  void add_z(int32_t z) {
    fbb_.AddElement<int32_t>(Hazard_Abridged::VT_Z, z, 0);
  }
  void add_a(int32_t a) {
    fbb_.AddElement<int32_t>(Hazard_Abridged::VT_A, a, 0);
  }
  void add_bottleId(::flatbuffers::Offset<::flatbuffers::String> bottleId) {
    fbb_.AddOffset(Hazard_Abridged::VT_BOTTLEID, bottleId);
  }
  void add_channel(::flatbuffers::Offset<::flatbuffers::String> channel) {
    fbb_.AddOffset(Hazard_Abridged::VT_CHANNEL, channel);
  }
  void add_duration(int32_t duration) {
    fbb_.AddElement<int32_t>(Hazard_Abridged::VT_DURATION, duration, 0);
  }
  void add_activity(double activity) {
    fbb_.AddElement<double>(Hazard_Abridged::VT_ACTIVITY, activity, 0.0);
  }
  void add_dep(double dep) {
    fbb_.AddElement<double>(Hazard_Abridged::VT_DEP, dep, 0.0);
  }
  void add_depCtrn(double depCtrn) {
    fbb_.AddElement<double>(Hazard_Abridged::VT_DEPCTRN, depCtrn, 0.0);
  }
  void add_massFrac(double massFrac) {
    fbb_.AddElement<double>(Hazard_Abridged::VT_MASSFRAC, massFrac, 0.0);
  }
  void add_dose(double dose) {
    fbb_.AddElement<double>(Hazard_Abridged::VT_DOSE, dose, 0.0);
  }
  void add_ctrnTime(double ctrnTime) {
    fbb_.AddElement<double>(Hazard_Abridged::VT_CTRNTIME, ctrnTime, 0.0);
  }
  void add_doseRate(double doseRate) {
    fbb_.AddElement<double>(Hazard_Abridged::VT_DOSERATE, doseRate, 0.0);
  }
  void add_idPOI(::flatbuffers::Offset<::flatbuffers::String> idPOI) {
    fbb_.AddOffset(Hazard_Abridged::VT_IDPOI, idPOI);
  }
  void add_idTrack(::flatbuffers::Offset<::flatbuffers::String> idTrack) {
    fbb_.AddOffset(Hazard_Abridged::VT_IDTRACK, idTrack);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Hazard_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Hazard_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Hazard_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Hazard_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Hazard_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(Hazard_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Hazard_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit Hazard_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Hazard_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Hazard_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Hazard_Abridged> CreateHazard_Abridged(
    ...
    Hazard_Abridged_dataMode_Enum dataMode = Hazard_Abridged_dataMode_Enum_REAL) {
  Hazard_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Hazard_Abridged> CreateHazard_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Hazard_Abridged *GetHazard_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<Hazard_Abridged>(buf);
}

inline const Hazard_Abridged *GetSizePrefixedHazard_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Hazard_Abridged>(buf);
}

inline const char *Hazard_AbridgedIdentifier() {
  return "HAZA";
}

inline bool Hazard_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Hazard_AbridgedIdentifier());
}

inline bool SizePrefixedHazard_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Hazard_AbridgedIdentifier(), true);
}

inline bool VerifyHazard_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Hazard_Abridged>(Hazard_AbridgedIdentifier());
}

inline bool VerifySizePrefixedHazard_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Hazard_Abridged>(Hazard_AbridgedIdentifier());
}

inline void FinishHazard_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Hazard_Abridged> root) {
  fbb.Finish(root, Hazard_AbridgedIdentifier());
}

inline void FinishSizePrefixedHazard_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Hazard_Abridged> root) {
  fbb.FinishSizePrefixed(root, Hazard_AbridgedIdentifier());
}
