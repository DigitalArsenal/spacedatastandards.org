...
struct OrbitTrack_Abridged;
struct OrbitTrack_AbridgedBuilder;

enum OrbitTrack_Abridged_objIdent_Enum : int8_t {
  /// Track assumed to be a friend due to the object characteristics, behavior, and/or origin.
  OrbitTrack_Abridged_objIdent_Enum_ASSUMED_FRIEND = 0,
  /// Track object supporting friendly forces and belonging to a declared friendly nation or entity.
  OrbitTrack_Abridged_objIdent_Enum_FRIEND = 1,
  ...
  OrbitTrack_Abridged_objIdent_Enum_HOSTILE = 2,
  ...
  OrbitTrack_Abridged_objIdent_Enum_NEUTRAL = 3,
  /// Track object which has not been evaluated.
  OrbitTrack_Abridged_objIdent_Enum_PENDING = 4,
  /// Track object deemed potentially hostile due to the object characteristics, behavior, nationality, and/or origin.
  OrbitTrack_Abridged_objIdent_Enum_SUSPECT = 5,
  /// Track object which has been evaluated and does not meet criteria for any standard identity.
  OrbitTrack_Abridged_objIdent_Enum_UNKNOWN = 6,
  OrbitTrack_Abridged_objIdent_Enum_MIN = OrbitTrack_Abridged_objIdent_Enum_ASSUMED_FRIEND,
  OrbitTrack_Abridged_objIdent_Enum_MAX = OrbitTrack_Abridged_objIdent_Enum_UNKNOWN
};

inline const OrbitTrack_Abridged_objIdent_Enum (&EnumValuesOrbitTrack_Abridged_objIdent_Enum())[7] {
  static const OrbitTrack_Abridged_objIdent_Enum values[] = {
    OrbitTrack_Abridged_objIdent_Enum_ASSUMED_FRIEND,
    OrbitTrack_Abridged_objIdent_Enum_FRIEND,
    OrbitTrack_Abridged_objIdent_Enum_HOSTILE,
    OrbitTrack_Abridged_objIdent_Enum_NEUTRAL,
    OrbitTrack_Abridged_objIdent_Enum_PENDING,
    OrbitTrack_Abridged_objIdent_Enum_SUSPECT,
    OrbitTrack_Abridged_objIdent_Enum_UNKNOWN
  };
  return values;
}

inline const char * const *EnumNamesOrbitTrack_Abridged_objIdent_Enum() {
...
inline const char *EnumNameOrbitTrack_Abridged_objIdent_Enum(OrbitTrack_Abridged_objIdent_Enum e) {
  if (::flatbuffers::IsOutRange(e, OrbitTrack_Abridged_objIdent_Enum_ASSUMED_FRIEND, OrbitTrack_Abridged_objIdent_Enum_UNKNOWN)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOrbitTrack_Abridged_objIdent_Enum()[index];
}

enum OrbitTrack_Abridged_objectType_Enum : int8_t {
  /// No description available.
  OrbitTrack_Abridged_objectType_Enum_DEBRIS = 0,
  /// No description available.
  OrbitTrack_Abridged_objectType_Enum_MANNED = 1,
  /// No description available.
  OrbitTrack_Abridged_objectType_Enum_PAYLOAD = 2,
  /// No description available.
  OrbitTrack_Abridged_objectType_Enum_PLATFORM = 3,
  /// No description available.
  OrbitTrack_Abridged_objectType_Enum_ROCKET_BODY = 4,
  /// No description available.
  OrbitTrack_Abridged_objectType_Enum_UNKNOWN = 5,
  OrbitTrack_Abridged_objectType_Enum_MIN = OrbitTrack_Abridged_objectType_Enum_DEBRIS,
  OrbitTrack_Abridged_objectType_Enum_MAX = OrbitTrack_Abridged_objectType_Enum_UNKNOWN
};

inline const OrbitTrack_Abridged_objectType_Enum (&EnumValuesOrbitTrack_Abridged_objectType_Enum())[6] {
  static const OrbitTrack_Abridged_objectType_Enum values[] = {
    OrbitTrack_Abridged_objectType_Enum_DEBRIS,
    OrbitTrack_Abridged_objectType_Enum_MANNED,
    OrbitTrack_Abridged_objectType_Enum_PAYLOAD,
    OrbitTrack_Abridged_objectType_Enum_PLATFORM,
    OrbitTrack_Abridged_objectType_Enum_ROCKET_BODY,
    OrbitTrack_Abridged_objectType_Enum_UNKNOWN
  };
  return values;
}

inline const char * const *EnumNamesOrbitTrack_Abridged_objectType_Enum() {
...
inline const char *EnumNameOrbitTrack_Abridged_objectType_Enum(OrbitTrack_Abridged_objectType_Enum e) {
  if (::flatbuffers::IsOutRange(e, OrbitTrack_Abridged_objectType_Enum_DEBRIS, OrbitTrack_Abridged_objectType_Enum_UNKNOWN)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOrbitTrack_Abridged_objectType_Enum()[index];
}

enum OrbitTrack_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  OrbitTrack_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  OrbitTrack_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  OrbitTrack_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  OrbitTrack_Abridged_dataMode_Enum_EXERCISE = 3,
  OrbitTrack_Abridged_dataMode_Enum_MIN = OrbitTrack_Abridged_dataMode_Enum_REAL,
  OrbitTrack_Abridged_dataMode_Enum_MAX = OrbitTrack_Abridged_dataMode_Enum_EXERCISE
};

inline const OrbitTrack_Abridged_dataMode_Enum (&EnumValuesOrbitTrack_Abridged_dataMode_Enum())[4] {
  static const OrbitTrack_Abridged_dataMode_Enum values[] = {
    OrbitTrack_Abridged_dataMode_Enum_REAL,
    OrbitTrack_Abridged_dataMode_Enum_TEST,
    OrbitTrack_Abridged_dataMode_Enum_SIMULATED,
    OrbitTrack_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesOrbitTrack_Abridged_dataMode_Enum() {
...
inline const char *EnumNameOrbitTrack_Abridged_dataMode_Enum(OrbitTrack_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, OrbitTrack_Abridged_dataMode_Enum_REAL, OrbitTrack_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOrbitTrack_Abridged_dataMode_Enum()[index];
}
...
struct OrbitTrack_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef OrbitTrack_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 0, Maximum length = 32
  OrbitTrack_Abridged_objIdent_Enum objIdent() const {
    return static_cast<OrbitTrack_Abridged_objIdent_Enum>(GetField<int8_t>(VT_OBJIDENT, 0));
  }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 32
  OrbitTrack_Abridged_objectType_Enum objectType() const {
    return static_cast<OrbitTrack_Abridged_objectType_Enum>(GetField<int8_t>(VT_OBJECTTYPE, 0));
  }
  ...
  OrbitTrack_Abridged_dataMode_Enum dataMode() const {
    return static_cast<OrbitTrack_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct OrbitTrack_AbridgedBuilder {
  typedef OrbitTrack_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(OrbitTrack_Abridged::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_ORIGOBJECTID, origObjectId);
  }
  void add_idElset(::flatbuffers::Offset<::flatbuffers::String> idElset) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_IDELSET, idElset);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::String> ts) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_TS, ts);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(OrbitTrack_Abridged::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(OrbitTrack_Abridged::VT_LON, lon, 0.0);
  }
  void add_alt(double alt) {
    fbb_.AddElement<double>(OrbitTrack_Abridged::VT_ALT, alt, 0.0);
  }
  void add_rdfRF(double rdfRF) {
    fbb_.AddElement<double>(OrbitTrack_Abridged::VT_RDFRF, rdfRF, 0.0);
  }
  void add_callSign(::flatbuffers::Offset<::flatbuffers::String> callSign) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_CALLSIGN, callSign);
  }
  void add_rptNum(::flatbuffers::Offset<::flatbuffers::String> rptNum) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_RPTNUM, rptNum);
  }
  void add_objIdent(OrbitTrack_Abridged_objIdent_Enum objIdent) {
    fbb_.AddElement<int8_t>(OrbitTrack_Abridged::VT_OBJIDENT, static_cast<int8_t>(objIdent), 0);
  }
  void add_identAmp(::flatbuffers::Offset<::flatbuffers::String> identAmp) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_IDENTAMP, identAmp);
  }
  void add_satStatus(::flatbuffers::Offset<::flatbuffers::String> satStatus) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_SATSTATUS, satStatus);
  }
  void add_objectType(OrbitTrack_Abridged_objectType_Enum objectType) {
    fbb_.AddElement<int8_t>(OrbitTrack_Abridged::VT_OBJECTTYPE, static_cast<int8_t>(objectType), 0);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_COUNTRYCODE, countryCode);
  }
  void add_decay(double decay) {
    fbb_.AddElement<double>(OrbitTrack_Abridged::VT_DECAY, decay, 0.0);
  }
  void add_charlieLine(::flatbuffers::Offset<::flatbuffers::String> charlieLine) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_CHARLIELINE, charlieLine);
  }
  void add_aouType(::flatbuffers::Offset<::flatbuffers::String> aouType) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_AOUTYPE, aouType);
  }
  void add_aouData(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> aouData) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_AOUDATA, aouData);
  }
  void add_spd(double spd) {
    fbb_.AddElement<double>(OrbitTrack_Abridged::VT_SPD, spd, 0.0);
  }
  void add_angElev(double angElev) {
    fbb_.AddElement<double>(OrbitTrack_Abridged::VT_ANGELEV, angElev, 0.0);
  }
  void add_cntnmnt(double cntnmnt) {
    fbb_.AddElement<double>(OrbitTrack_Abridged::VT_CNTNMNT, cntnmnt, 0.0);
  }
  void add_xref(::flatbuffers::Offset<::flatbuffers::String> xref) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_XREF, xref);
  }
  void add_chXRef(::flatbuffers::Offset<::flatbuffers::String> chXRef) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_CHXREF, chXRef);
  }
  void add_amplification(::flatbuffers::Offset<::flatbuffers::String> amplification) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_AMPLIFICATION, amplification);
  }
  void add_iff(::flatbuffers::Offset<::flatbuffers::String> iff) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_IFF, iff);
  }
  void add_reinforced(bool reinforced) {
    fbb_.AddElement<uint8_t>(OrbitTrack_Abridged::VT_REINFORCED, static_cast<uint8_t>(reinforced), 0);
  }
  void add_reduced(bool reduced) {
    fbb_.AddElement<uint8_t>(OrbitTrack_Abridged::VT_REDUCED, static_cast<uint8_t>(reduced), 0);
  }
  void add_hq(bool hq) {
    fbb_.AddElement<uint8_t>(OrbitTrack_Abridged::VT_HQ, static_cast<uint8_t>(hq), 0);
  }
  void add_dummy(bool dummy) {
    fbb_.AddElement<uint8_t>(OrbitTrack_Abridged::VT_DUMMY, static_cast<uint8_t>(dummy), 0);
  }
  void add_taskForce(bool taskForce) {
    fbb_.AddElement<uint8_t>(OrbitTrack_Abridged::VT_TASKFORCE, static_cast<uint8_t>(taskForce), 0);
  }
  void add_feint(bool feint) {
    fbb_.AddElement<uint8_t>(OrbitTrack_Abridged::VT_FEINT, static_cast<uint8_t>(feint), 0);
  }
  void add_installation(bool installation) {
    fbb_.AddElement<uint8_t>(OrbitTrack_Abridged::VT_INSTALLATION, static_cast<uint8_t>(installation), 0);
  }
  void add_vehType(::flatbuffers::Offset<::flatbuffers::String> vehType) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_VEHTYPE, vehType);
  }
  void add_trkId(::flatbuffers::Offset<::flatbuffers::String> trkId) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_TRKID, trkId);
  }
  void add_trackSensors(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> trackSensors) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_TRACKSENSORS, trackSensors);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(OrbitTrack_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(OrbitTrack_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(OrbitTrack_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  explicit OrbitTrack_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<OrbitTrack_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<OrbitTrack_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<OrbitTrack_Abridged> CreateOrbitTrack_Abridged(
    ...
    OrbitTrack_Abridged_objIdent_Enum objIdent = OrbitTrack_Abridged_objIdent_Enum_ASSUMED_FRIEND,
    ::flatbuffers::Offset<::flatbuffers::String> identAmp = 0,
    ::flatbuffers::Offset<::flatbuffers::String> satStatus = 0,
    OrbitTrack_Abridged_objectType_Enum objectType = OrbitTrack_Abridged_objectType_Enum_DEBRIS,
    ...
    OrbitTrack_Abridged_dataMode_Enum dataMode = OrbitTrack_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  OrbitTrack_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<OrbitTrack_Abridged> CreateOrbitTrack_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const OrbitTrack_Abridged *GetOrbitTrack_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<OrbitTrack_Abridged>(buf);
}

inline const OrbitTrack_Abridged *GetSizePrefixedOrbitTrack_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<OrbitTrack_Abridged>(buf);
}

inline const char *OrbitTrack_AbridgedIdentifier() {
  return "ORBI";
}

inline bool OrbitTrack_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OrbitTrack_AbridgedIdentifier());
}

inline bool SizePrefixedOrbitTrack_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OrbitTrack_AbridgedIdentifier(), true);
}

inline bool VerifyOrbitTrack_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<OrbitTrack_Abridged>(OrbitTrack_AbridgedIdentifier());
}

inline bool VerifySizePrefixedOrbitTrack_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<OrbitTrack_Abridged>(OrbitTrack_AbridgedIdentifier());
}

inline void FinishOrbitTrack_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OrbitTrack_Abridged> root) {
  fbb.Finish(root, OrbitTrack_AbridgedIdentifier());
}

inline void FinishSizePrefixedOrbitTrack_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OrbitTrack_Abridged> root) {
  fbb.FinishSizePrefixed(root, OrbitTrack_AbridgedIdentifier());
}
