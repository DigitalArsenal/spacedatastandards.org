...
struct SkyImagery_Ingest;
struct SkyImagery_IngestBuilder;

enum SkyImagery_Ingest_dataMode_Enum : int8_t {
  ...
  SkyImagery_Ingest_dataMode_Enum_MIN = SkyImagery_Ingest_dataMode_Enum_REAL,
  SkyImagery_Ingest_dataMode_Enum_MAX = SkyImagery_Ingest_dataMode_Enum_EXERCISE
};

inline const SkyImagery_Ingest_dataMode_Enum (&EnumValuesSkyImagery_Ingest_dataMode_Enum())[4] {
  static const SkyImagery_Ingest_dataMode_Enum values[] = {
    SkyImagery_Ingest_dataMode_Enum_REAL,
    SkyImagery_Ingest_dataMode_Enum_TEST,
    SkyImagery_Ingest_dataMode_Enum_SIMULATED,
    SkyImagery_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSkyImagery_Ingest_dataMode_Enum() {
...
inline const char *EnumNameSkyImagery_Ingest_dataMode_Enum(SkyImagery_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SkyImagery_Ingest_dataMode_Enum_REAL, SkyImagery_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSkyImagery_Ingest_dataMode_Enum()[index];
}
...
struct SkyImagery_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SkyImagery_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SkyImagery_Ingest_dataMode_Enum dataMode() const {
    return static_cast<SkyImagery_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SkyImagery_IngestBuilder {
  typedef SkyImagery_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_ORIGOBJECTID, origObjectId);
  }
  void add_idAttitudeSet(::flatbuffers::Offset<::flatbuffers::String> idAttitudeSet) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_IDATTITUDESET, idAttitudeSet);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_IDSENSOR, idSensor);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(SkyImagery_Ingest::VT_SATNO, satNo, 0);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_ORIGSENSORID, origSensorId);
  }
  void add_senlat(double senlat) {
    fbb_.AddElement<double>(SkyImagery_Ingest::VT_SENLAT, senlat, 0.0);
  }
  void add_senlon(double senlon) {
    fbb_.AddElement<double>(SkyImagery_Ingest::VT_SENLON, senlon, 0.0);
  }
  void add_senalt(double senalt) {
    fbb_.AddElement<double>(SkyImagery_Ingest::VT_SENALT, senalt, 0.0);
  }
  void add_senx(double senx) {
    fbb_.AddElement<double>(SkyImagery_Ingest::VT_SENX, senx, 0.0);
  }
  void add_seny(double seny) {
    fbb_.AddElement<double>(SkyImagery_Ingest::VT_SENY, seny, 0.0);
  }
  void add_senz(double senz) {
    fbb_.AddElement<double>(SkyImagery_Ingest::VT_SENZ, senz, 0.0);
  }
  void add_senQuat(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> senQuat) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_SENQUAT, senQuat);
  }
  void add_senQuatDot(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> senQuatDot) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_SENQUATDOT, senQuatDot);
  }
  void add_imageType(::flatbuffers::Offset<::flatbuffers::String> imageType) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_IMAGETYPE, imageType);
  }
  void add_expStartTime(::flatbuffers::Offset<::flatbuffers::String> expStartTime) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_EXPSTARTTIME, expStartTime);
  }
  void add_expEndTime(::flatbuffers::Offset<::flatbuffers::String> expEndTime) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_EXPENDTIME, expEndTime);
  }
  void add_imageSourceInfo(::flatbuffers::Offset<::flatbuffers::String> imageSourceInfo) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_IMAGESOURCEINFO, imageSourceInfo);
  }
  void add_topLeftStartAz(double topLeftStartAz) {
    fbb_.AddElement<double>(SkyImagery_Ingest::VT_TOPLEFTSTARTAZ, topLeftStartAz, 0.0);
  }
  void add_topLeftStartEl(double topLeftStartEl) {
    fbb_.AddElement<double>(SkyImagery_Ingest::VT_TOPLEFTSTARTEL, topLeftStartEl, 0.0);
  }
  void add_topLeftStopAz(double topLeftStopAz) {
    fbb_.AddElement<double>(SkyImagery_Ingest::VT_TOPLEFTSTOPAZ, topLeftStopAz, 0.0);
  }
  void add_topLeftStopEl(double topLeftStopEl) {
    fbb_.AddElement<double>(SkyImagery_Ingest::VT_TOPLEFTSTOPEL, topLeftStopEl, 0.0);
  }
  void add_imageSetId(::flatbuffers::Offset<::flatbuffers::String> imageSetId) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_IMAGESETID, imageSetId);
  }
  void add_imageSetLength(int32_t imageSetLength) {
    fbb_.AddElement<int32_t>(SkyImagery_Ingest::VT_IMAGESETLENGTH, imageSetLength, 0);
  }
  void add_sequenceId(int32_t sequenceId) {
    fbb_.AddElement<int32_t>(SkyImagery_Ingest::VT_SEQUENCEID, sequenceId, 0);
  }
  void add_frameFOVWidth(double frameFOVWidth) {
    fbb_.AddElement<double>(SkyImagery_Ingest::VT_FRAMEFOVWIDTH, frameFOVWidth, 0.0);
  }
  void add_frameFOVHeight(double frameFOVHeight) {
    fbb_.AddElement<double>(SkyImagery_Ingest::VT_FRAMEFOVHEIGHT, frameFOVHeight, 0.0);
  }
  void add_pixelFOVWidth(double pixelFOVWidth) {
    fbb_.AddElement<double>(SkyImagery_Ingest::VT_PIXELFOVWIDTH, pixelFOVWidth, 0.0);
  }
  void add_pixelFOVHeight(double pixelFOVHeight) {
    fbb_.AddElement<double>(SkyImagery_Ingest::VT_PIXELFOVHEIGHT, pixelFOVHeight, 0.0);
  }
  void add_frameWidthPixels(int32_t frameWidthPixels) {
    fbb_.AddElement<int32_t>(SkyImagery_Ingest::VT_FRAMEWIDTHPIXELS, frameWidthPixels, 0);
  }
  void add_frameHeightPixels(int32_t frameHeightPixels) {
    fbb_.AddElement<int32_t>(SkyImagery_Ingest::VT_FRAMEHEIGHTPIXELS, frameHeightPixels, 0);
  }
  void add_pixelBitDepth(int32_t pixelBitDepth) {
    fbb_.AddElement<int32_t>(SkyImagery_Ingest::VT_PIXELBITDEPTH, pixelBitDepth, 0);
  }
  void add_annotationKey(::flatbuffers::Offset<::flatbuffers::String> annotationKey) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_ANNOTATIONKEY, annotationKey);
  }
  void add_calibrationKey(::flatbuffers::Offset<::flatbuffers::String> calibrationKey) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_CALIBRATIONKEY, calibrationKey);
  }
  void add_filename(::flatbuffers::Offset<::flatbuffers::String> filename) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_FILENAME, filename);
  }
  void add_filesize(int64_t filesize) {
    fbb_.AddElement<int64_t>(SkyImagery_Ingest::VT_FILESIZE, filesize, 0);
  }
  void add_checksumValue(::flatbuffers::Offset<::flatbuffers::String> checksumValue) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_CHECKSUMVALUE, checksumValue);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_TRANSACTIONID, transactionId);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_TAGS, tags);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_SOURCEDL, sourceDL);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_DESCRIPTION, description);
  }
  void add_dataMode(SkyImagery_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SkyImagery_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_eoObservations(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> eoObservations) {
    fbb_.AddOffset(SkyImagery_Ingest::VT_EOOBSERVATIONS, eoObservations);
  }
  explicit SkyImagery_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SkyImagery_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SkyImagery_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SkyImagery_Ingest> CreateSkyImagery_Ingest(
    ...
    SkyImagery_Ingest_dataMode_Enum dataMode = SkyImagery_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> eoObservations = 0) {
  SkyImagery_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SkyImagery_Ingest> CreateSkyImagery_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const SkyImagery_Ingest *GetSkyImagery_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<SkyImagery_Ingest>(buf);
}

inline const SkyImagery_Ingest *GetSizePrefixedSkyImagery_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SkyImagery_Ingest>(buf);
}

inline const char *SkyImagery_IngestIdentifier() {
  return "SKYI";
}

inline bool SkyImagery_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SkyImagery_IngestIdentifier());
}

inline bool SizePrefixedSkyImagery_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SkyImagery_IngestIdentifier(), true);
}

inline bool VerifySkyImagery_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SkyImagery_Ingest>(SkyImagery_IngestIdentifier());
}

inline bool VerifySizePrefixedSkyImagery_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SkyImagery_Ingest>(SkyImagery_IngestIdentifier());
}

inline void FinishSkyImagery_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SkyImagery_Ingest> root) {
  fbb.Finish(root, SkyImagery_IngestIdentifier());
}

inline void FinishSizePrefixedSkyImagery_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SkyImagery_Ingest> root) {
  fbb.FinishSizePrefixed(root, SkyImagery_IngestIdentifier());
}
