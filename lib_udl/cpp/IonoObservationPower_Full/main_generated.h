...
struct IonoObservationPower_Full;
struct IonoObservationPower_FullBuilder;

/// /// Multi dimensional array of received power in db.
struct IonoObservationPower_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef IonoObservationPower_FullBuilder Builder;
...
struct IonoObservationPower_FullBuilder {
  typedef IonoObservationPower_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(IonoObservationPower_Full::VT_NOTES, notes);
  }
  void add_dimensions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dimensions) {
    fbb_.AddOffset(IonoObservationPower_Full::VT_DIMENSIONS, dimensions);
  }
  void add_dimensionName(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dimensionName) {
    fbb_.AddOffset(IonoObservationPower_Full::VT_DIMENSIONNAME, dimensionName);
  }
  void add_data(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> data) {
    fbb_.AddOffset(IonoObservationPower_Full::VT_DATA, data);
  }
  explicit IonoObservationPower_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<IonoObservationPower_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<IonoObservationPower_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<IonoObservationPower_Full> CreateIonoObservationPower_Full(
  ...
  IonoObservationPower_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<IonoObservationPower_Full> CreateIonoObservationPower_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const IonoObservationPower_Full *GetIonoObservationPower_Full(const void *buf) {
  return ::flatbuffers::GetRoot<IonoObservationPower_Full>(buf);
}

inline const IonoObservationPower_Full *GetSizePrefixedIonoObservationPower_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<IonoObservationPower_Full>(buf);
}

inline const char *IonoObservationPower_FullIdentifier() {
  return "IONO";
}

inline bool IonoObservationPower_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationPower_FullIdentifier());
}

inline bool SizePrefixedIonoObservationPower_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationPower_FullIdentifier(), true);
}

inline bool VerifyIonoObservationPower_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<IonoObservationPower_Full>(IonoObservationPower_FullIdentifier());
}

inline bool VerifySizePrefixedIonoObservationPower_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<IonoObservationPower_Full>(IonoObservationPower_FullIdentifier());
}

inline void FinishIonoObservationPower_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationPower_Full> root) {
  fbb.Finish(root, IonoObservationPower_FullIdentifier());
}

inline void FinishSizePrefixedIonoObservationPower_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationPower_Full> root) {
  fbb.FinishSizePrefixed(root, IonoObservationPower_FullIdentifier());
}
