...
struct SeradataRadarPayload_Abridged;
struct SeradataRadarPayload_AbridgedBuilder;

enum SeradataRadarPayload_Abridged_dataMode_Enum : int8_t {
  ...
  SeradataRadarPayload_Abridged_dataMode_Enum_MIN = SeradataRadarPayload_Abridged_dataMode_Enum_REAL,
  SeradataRadarPayload_Abridged_dataMode_Enum_MAX = SeradataRadarPayload_Abridged_dataMode_Enum_EXERCISE
};

inline const SeradataRadarPayload_Abridged_dataMode_Enum (&EnumValuesSeradataRadarPayload_Abridged_dataMode_Enum())[4] {
  static const SeradataRadarPayload_Abridged_dataMode_Enum values[] = {
    SeradataRadarPayload_Abridged_dataMode_Enum_REAL,
    SeradataRadarPayload_Abridged_dataMode_Enum_TEST,
    SeradataRadarPayload_Abridged_dataMode_Enum_SIMULATED,
    SeradataRadarPayload_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSeradataRadarPayload_Abridged_dataMode_Enum() {
...
inline const char *EnumNameSeradataRadarPayload_Abridged_dataMode_Enum(SeradataRadarPayload_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SeradataRadarPayload_Abridged_dataMode_Enum_REAL, SeradataRadarPayload_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSeradataRadarPayload_Abridged_dataMode_Enum()[index];
}

/// /// Details for an radar payload from  Seradata.
struct SeradataRadarPayload_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SeradataRadarPayload_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SeradataRadarPayload_Abridged_dataMode_Enum dataMode() const {
    return static_cast<SeradataRadarPayload_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SeradataRadarPayload_AbridgedBuilder {
  typedef SeradataRadarPayload_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_spacecraftId(::flatbuffers::Offset<::flatbuffers::String> spacecraftId) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_SPACECRAFTID, spacecraftId);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_IDSENSOR, idSensor);
  }
  void add_hostedForCompanyOrgId(::flatbuffers::Offset<::flatbuffers::String> hostedForCompanyOrgId) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_HOSTEDFORCOMPANYORGID, hostedForCompanyOrgId);
  }
  void add_manufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrgId) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_MANUFACTURERORGID, manufacturerOrgId);
  }
  void add_category(::flatbuffers::Offset<::flatbuffers::String> category) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_CATEGORY, category);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_NAME, name);
  }
  void add_frequencyBand(::flatbuffers::Offset<::flatbuffers::String> frequencyBand) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_FREQUENCYBAND, frequencyBand);
  }
  void add_frequency(double frequency) {
    fbb_.AddElement<double>(SeradataRadarPayload_Abridged::VT_FREQUENCY, frequency, 0.0);
  }
  void add_waveLength(double waveLength) {
    fbb_.AddElement<double>(SeradataRadarPayload_Abridged::VT_WAVELENGTH, waveLength, 0.0);
  }
  void add_bestResolution(double bestResolution) {
    fbb_.AddElement<double>(SeradataRadarPayload_Abridged::VT_BESTRESOLUTION, bestResolution, 0.0);
  }
  void add_swathWidth(double swathWidth) {
    fbb_.AddElement<double>(SeradataRadarPayload_Abridged::VT_SWATHWIDTH, swathWidth, 0.0);
  }
  void add_recorderSize(::flatbuffers::Offset<::flatbuffers::String> recorderSize) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_RECORDERSIZE, recorderSize);
  }
  void add_fieldOfView(double fieldOfView) {
    fbb_.AddElement<double>(SeradataRadarPayload_Abridged::VT_FIELDOFVIEW, fieldOfView, 0.0);
  }
  void add_fieldOfRegard(double fieldOfRegard) {
    fbb_.AddElement<double>(SeradataRadarPayload_Abridged::VT_FIELDOFREGARD, fieldOfRegard, 0.0);
  }
  void add_pointingMethod(::flatbuffers::Offset<::flatbuffers::String> pointingMethod) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_POINTINGMETHOD, pointingMethod);
  }
  void add_groundStations(::flatbuffers::Offset<::flatbuffers::String> groundStations) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_GROUNDSTATIONS, groundStations);
  }
  void add_groundStationLocations(::flatbuffers::Offset<::flatbuffers::String> groundStationLocations) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_GROUNDSTATIONLOCATIONS, groundStationLocations);
  }
  void add_transmitPolarization(::flatbuffers::Offset<::flatbuffers::String> transmitPolarization) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_TRANSMITPOLARIZATION, transmitPolarization);
  }
  void add_receivePolarization(::flatbuffers::Offset<::flatbuffers::String> receivePolarization) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_RECEIVEPOLARIZATION, receivePolarization);
  }
  void add_dutyCycle(::flatbuffers::Offset<::flatbuffers::String> dutyCycle) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_DUTYCYCLE, dutyCycle);
  }
  void add_partnerSpacecraft(::flatbuffers::Offset<::flatbuffers::String> partnerSpacecraft) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_PARTNERSPACECRAFT, partnerSpacecraft);
  }
  void add_constellationInterferometricCapability(::flatbuffers::Offset<::flatbuffers::String> constellationInterferometricCapability) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_CONSTELLATIONINTERFEROMETRICCAPABILITY, constellationInterferometricCapability);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_NOTES, notes);
  }
  void add_bandwidth(double bandwidth) {
    fbb_.AddElement<double>(SeradataRadarPayload_Abridged::VT_BANDWIDTH, bandwidth, 0.0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SeradataRadarPayload_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(SeradataRadarPayload_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SeradataRadarPayload_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit SeradataRadarPayload_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SeradataRadarPayload_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SeradataRadarPayload_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SeradataRadarPayload_Abridged> CreateSeradataRadarPayload_Abridged(
    ...
    SeradataRadarPayload_Abridged_dataMode_Enum dataMode = SeradataRadarPayload_Abridged_dataMode_Enum_REAL) {
  SeradataRadarPayload_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SeradataRadarPayload_Abridged> CreateSeradataRadarPayload_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const SeradataRadarPayload_Abridged *GetSeradataRadarPayload_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<SeradataRadarPayload_Abridged>(buf);
}

inline const SeradataRadarPayload_Abridged *GetSizePrefixedSeradataRadarPayload_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SeradataRadarPayload_Abridged>(buf);
}

inline const char *SeradataRadarPayload_AbridgedIdentifier() {
  return "SERA";
}

inline bool SeradataRadarPayload_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataRadarPayload_AbridgedIdentifier());
}

inline bool SizePrefixedSeradataRadarPayload_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataRadarPayload_AbridgedIdentifier(), true);
}

inline bool VerifySeradataRadarPayload_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SeradataRadarPayload_Abridged>(SeradataRadarPayload_AbridgedIdentifier());
}

inline bool VerifySizePrefixedSeradataRadarPayload_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SeradataRadarPayload_Abridged>(SeradataRadarPayload_AbridgedIdentifier());
}

inline void FinishSeradataRadarPayload_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataRadarPayload_Abridged> root) {
  fbb.Finish(root, SeradataRadarPayload_AbridgedIdentifier());
}

inline void FinishSizePrefixedSeradataRadarPayload_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataRadarPayload_Abridged> root) {
  fbb.FinishSizePrefixed(root, SeradataRadarPayload_AbridgedIdentifier());
}
