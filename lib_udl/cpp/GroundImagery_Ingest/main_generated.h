...
struct GroundImagery_Ingest;
struct GroundImagery_IngestBuilder;

enum GroundImagery_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  GroundImagery_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  GroundImagery_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  GroundImagery_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  GroundImagery_Ingest_dataMode_Enum_EXERCISE = 3,
  GroundImagery_Ingest_dataMode_Enum_MIN = GroundImagery_Ingest_dataMode_Enum_REAL,
  GroundImagery_Ingest_dataMode_Enum_MAX = GroundImagery_Ingest_dataMode_Enum_EXERCISE
};

inline const GroundImagery_Ingest_dataMode_Enum (&EnumValuesGroundImagery_Ingest_dataMode_Enum())[4] {
  static const GroundImagery_Ingest_dataMode_Enum values[] = {
    GroundImagery_Ingest_dataMode_Enum_REAL,
    GroundImagery_Ingest_dataMode_Enum_TEST,
    GroundImagery_Ingest_dataMode_Enum_SIMULATED,
    GroundImagery_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesGroundImagery_Ingest_dataMode_Enum() {
...
inline const char *EnumNameGroundImagery_Ingest_dataMode_Enum(GroundImagery_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, GroundImagery_Ingest_dataMode_Enum_REAL, GroundImagery_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesGroundImagery_Ingest_dataMode_Enum()[index];
}

/// /// Imagery of terrestrial regions from on-orbit, air, and other sensors.
struct GroundImagery_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef GroundImagery_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  GroundImagery_Ingest_dataMode_Enum dataMode() const {
    return static_cast<GroundImagery_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct GroundImagery_IngestBuilder {
  typedef GroundImagery_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_ID, id);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_IDSENSOR, idSensor);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_imageTime(::flatbuffers::Offset<::flatbuffers::String> imageTime) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_IMAGETIME, imageTime);
  }
  void add_filename(::flatbuffers::Offset<::flatbuffers::String> filename) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_FILENAME, filename);
  }
  void add_region(::flatbuffers::Offset<::flatbuffers::String> region) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_REGION, region);
  }
  void add_regionText(::flatbuffers::Offset<::flatbuffers::String> regionText) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_REGIONTEXT, regionText);
  }
  void add_regionGeoJSON(::flatbuffers::Offset<::flatbuffers::String> regionGeoJSON) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_REGIONGEOJSON, regionGeoJSON);
  }
  void add_regionType(::flatbuffers::Offset<::flatbuffers::String> regionType) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_REGIONTYPE, regionType);
  }
  void add_regionNDims(int32_t regionNDims) {
    fbb_.AddElement<int32_t>(GroundImagery_Ingest::VT_REGIONNDIMS, regionNDims, 0);
  }
  void add_regionSRid(int32_t regionSRid) {
    fbb_.AddElement<int32_t>(GroundImagery_Ingest::VT_REGIONSRID, regionSRid, 0);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_ORIGSENSORID, origSensorId);
  }
  void add_subjectId(::flatbuffers::Offset<::flatbuffers::String> subjectId) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_SUBJECTID, subjectId);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_NAME, name);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_SOURCEDL, sourceDL);
  }
  void add_dataMode(GroundImagery_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(GroundImagery_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_TRANSACTIONID, transactionId);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_TAGS, tags);
  }
  void add_keywords(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> keywords) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_KEYWORDS, keywords);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_NOTES, notes);
  }
  void add_format(::flatbuffers::Offset<::flatbuffers::String> format) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_FORMAT, format);
  }
  void add_filesize(int64_t filesize) {
    fbb_.AddElement<int64_t>(GroundImagery_Ingest::VT_FILESIZE, filesize, 0);
  }
  void add_checksumValue(::flatbuffers::Offset<::flatbuffers::String> checksumValue) {
    fbb_.AddOffset(GroundImagery_Ingest::VT_CHECKSUMVALUE, checksumValue);
  }
  explicit GroundImagery_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<GroundImagery_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<GroundImagery_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<GroundImagery_Ingest> CreateGroundImagery_Ingest(
    ...
    GroundImagery_Ingest_dataMode_Enum dataMode = GroundImagery_Ingest_dataMode_Enum_REAL,
  ...
  GroundImagery_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<GroundImagery_Ingest> CreateGroundImagery_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const GroundImagery_Ingest *GetGroundImagery_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<GroundImagery_Ingest>(buf);
}

inline const GroundImagery_Ingest *GetSizePrefixedGroundImagery_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<GroundImagery_Ingest>(buf);
}

inline const char *GroundImagery_IngestIdentifier() {
  return "GROU";
}

inline bool GroundImagery_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, GroundImagery_IngestIdentifier());
}

inline bool SizePrefixedGroundImagery_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, GroundImagery_IngestIdentifier(), true);
}

inline bool VerifyGroundImagery_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<GroundImagery_Ingest>(GroundImagery_IngestIdentifier());
}

inline bool VerifySizePrefixedGroundImagery_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<GroundImagery_Ingest>(GroundImagery_IngestIdentifier());
}

inline void FinishGroundImagery_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<GroundImagery_Ingest> root) {
  fbb.Finish(root, GroundImagery_IngestIdentifier());
}

inline void FinishSizePrefixedGroundImagery_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<GroundImagery_Ingest> root) {
  fbb.FinishSizePrefixed(root, GroundImagery_IngestIdentifier());
}
