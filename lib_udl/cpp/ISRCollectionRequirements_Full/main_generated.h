...
struct ISRCollectionRequirements_Full;
struct ISRCollectionRequirements_FullBuilder;

/// /// Tasking desired collection requirements.
struct ISRCollectionRequirements_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef ISRCollectionRequirements_FullBuilder Builder;
...
struct ISRCollectionRequirements_FullBuilder {
  typedef ISRCollectionRequirements_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_ID, id);
  }
  void add_hash(::flatbuffers::Offset<::flatbuffers::String> hash) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_HASH, hash);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_TYPE, type);
  }
  void add_cridNumbers(::flatbuffers::Offset<::flatbuffers::String> cridNumbers) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_CRIDNUMBERS, cridNumbers);
  }
  void add_priority(double priority) {
    fbb_.AddElement<double>(ISRCollectionRequirements_Full::VT_PRIORITY, priority, 0.0);
  }
  void add_recordId(::flatbuffers::Offset<::flatbuffers::String> recordId) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_RECORDID, recordId);
  }
  void add_reconSurvey(::flatbuffers::Offset<::flatbuffers::String> reconSurvey) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_RECONSURVEY, reconSurvey);
  }
  void add_intelDiscipline(::flatbuffers::Offset<::flatbuffers::String> intelDiscipline) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_INTELDISCIPLINE, intelDiscipline);
  }
  void add_secondary(bool secondary) {
    fbb_.AddElement<uint8_t>(ISRCollectionRequirements_Full::VT_SECONDARY, static_cast<uint8_t>(secondary), 0);
  }
  void add_emphasized(bool emphasized) {
    fbb_.AddElement<uint8_t>(ISRCollectionRequirements_Full::VT_EMPHASIZED, static_cast<uint8_t>(emphasized), 0);
  }
  void add_isPrismCr(bool isPrismCr) {
    fbb_.AddElement<uint8_t>(ISRCollectionRequirements_Full::VT_ISPRISMCR, static_cast<uint8_t>(isPrismCr), 0);
  }
  void add_start(::flatbuffers::Offset<::flatbuffers::String> start) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_START, start);
  }
  void add_stop(::flatbuffers::Offset<::flatbuffers::String> stop) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_STOP, stop);
  }
  void add_operation(::flatbuffers::Offset<::flatbuffers::String> operation) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_OPERATION, operation);
  }
  void add_supportedUnit(::flatbuffers::Offset<::flatbuffers::String> supportedUnit) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_SUPPORTEDUNIT, supportedUnit);
  }
  void add_country(::flatbuffers::Offset<::flatbuffers::String> country) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_COUNTRY, country);
  }
  void add_region(::flatbuffers::Offset<::flatbuffers::String> region) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_REGION, region);
  }
  void add_subregion(::flatbuffers::Offset<::flatbuffers::String> subregion) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_SUBREGION, subregion);
  }
  void add_specialComGuidance(::flatbuffers::Offset<::flatbuffers::String> specialComGuidance) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_SPECIALCOMGUIDANCE, specialComGuidance);
  }
  void add_criticalTimes(::flatbuffers::Offset<::flatbuffers::String> criticalTimes) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_CRITICALTIMES, criticalTimes);
  }
  void add_exploitationRequirement(::flatbuffers::Offset<::flatbuffers::String> exploitationRequirement) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_EXPLOITATIONREQUIREMENT, exploitationRequirement);
  }
  void add_targetList(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> targetList) {
    fbb_.AddOffset(ISRCollectionRequirements_Full::VT_TARGETLIST, targetList);
  }
  explicit ISRCollectionRequirements_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<ISRCollectionRequirements_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<ISRCollectionRequirements_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<ISRCollectionRequirements_Full> CreateISRCollectionRequirements_Full(
  ...
  ISRCollectionRequirements_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<ISRCollectionRequirements_Full> CreateISRCollectionRequirements_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const ISRCollectionRequirements_Full *GetISRCollectionRequirements_Full(const void *buf) {
  return ::flatbuffers::GetRoot<ISRCollectionRequirements_Full>(buf);
}

inline const ISRCollectionRequirements_Full *GetSizePrefixedISRCollectionRequirements_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<ISRCollectionRequirements_Full>(buf);
}

inline const char *ISRCollectionRequirements_FullIdentifier() {
  return "ISRC";
}

inline bool ISRCollectionRequirements_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ISRCollectionRequirements_FullIdentifier());
}

inline bool SizePrefixedISRCollectionRequirements_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ISRCollectionRequirements_FullIdentifier(), true);
}

inline bool VerifyISRCollectionRequirements_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<ISRCollectionRequirements_Full>(ISRCollectionRequirements_FullIdentifier());
}

inline bool VerifySizePrefixedISRCollectionRequirements_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<ISRCollectionRequirements_Full>(ISRCollectionRequirements_FullIdentifier());
}

inline void FinishISRCollectionRequirements_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ISRCollectionRequirements_Full> root) {
  fbb.Finish(root, ISRCollectionRequirements_FullIdentifier());
}

inline void FinishSizePrefixedISRCollectionRequirements_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ISRCollectionRequirements_Full> root) {
  fbb.FinishSizePrefixed(root, ISRCollectionRequirements_FullIdentifier());
}
