...
struct FlightPlan_Abridged;
struct FlightPlan_AbridgedBuilder;

enum FlightPlan_Abridged_dataMode_Enum : int8_t {
  ...
  FlightPlan_Abridged_dataMode_Enum_MIN = FlightPlan_Abridged_dataMode_Enum_REAL,
  FlightPlan_Abridged_dataMode_Enum_MAX = FlightPlan_Abridged_dataMode_Enum_EXERCISE
};

inline const FlightPlan_Abridged_dataMode_Enum (&EnumValuesFlightPlan_Abridged_dataMode_Enum())[4] {
  static const FlightPlan_Abridged_dataMode_Enum values[] = {
    FlightPlan_Abridged_dataMode_Enum_REAL,
    FlightPlan_Abridged_dataMode_Enum_TEST,
    FlightPlan_Abridged_dataMode_Enum_SIMULATED,
    FlightPlan_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesFlightPlan_Abridged_dataMode_Enum() {
...
inline const char *EnumNameFlightPlan_Abridged_dataMode_Enum(FlightPlan_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, FlightPlan_Abridged_dataMode_Enum_REAL, FlightPlan_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesFlightPlan_Abridged_dataMode_Enum()[index];
}

/// /// Flight Plan contains data specifying the details of an intended flight including schedule and expected route.
struct FlightPlan_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef FlightPlan_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  FlightPlan_Abridged_dataMode_Enum dataMode() const {
    return static_cast<FlightPlan_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct FlightPlan_AbridgedBuilder {
  typedef FlightPlan_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_amcMissionId(::flatbuffers::Offset<::flatbuffers::String> amcMissionId) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_AMCMISSIONID, amcMissionId);
  }
  void add_idSortie(::flatbuffers::Offset<::flatbuffers::String> idSortie) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_IDSORTIE, idSortie);
  }
  void add_idAircraft(::flatbuffers::Offset<::flatbuffers::String> idAircraft) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_IDAIRCRAFT, idAircraft);
  }
  void add_legNum(int32_t legNum) {
    fbb_.AddElement<int32_t>(FlightPlan_Abridged::VT_LEGNUM, legNum, 0);
  }
  void add_idDepAirfield(::flatbuffers::Offset<::flatbuffers::String> idDepAirfield) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_IDDEPAIRFIELD, idDepAirfield);
  }
  void add_depAirfield(::flatbuffers::Offset<::flatbuffers::String> depAirfield) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_DEPAIRFIELD, depAirfield);
  }
  void add_idArrAirfield(::flatbuffers::Offset<::flatbuffers::String> idArrAirfield) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_IDARRAIRFIELD, idArrAirfield);
  }
  void add_arrAirfield(::flatbuffers::Offset<::flatbuffers::String> arrAirfield) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ARRAIRFIELD, arrAirfield);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_EXTERNALID, externalId);
  }
  void add_genTS(::flatbuffers::Offset<::flatbuffers::String> genTS) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_GENTS, genTS);
  }
  void add_aircraftMDS(::flatbuffers::Offset<::flatbuffers::String> aircraftMDS) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_AIRCRAFTMDS, aircraftMDS);
  }
  void add_tailNumber(::flatbuffers::Offset<::flatbuffers::String> tailNumber) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_TAILNUMBER, tailNumber);
  }
  void add_callSign(::flatbuffers::Offset<::flatbuffers::String> callSign) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_CALLSIGN, callSign);
  }
  void add_wxValidStart(::flatbuffers::Offset<::flatbuffers::String> wxValidStart) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_WXVALIDSTART, wxValidStart);
  }
  void add_wxValidEnd(::flatbuffers::Offset<::flatbuffers::String> wxValidEnd) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_WXVALIDEND, wxValidEnd);
  }
  void add_estDepTime(::flatbuffers::Offset<::flatbuffers::String> estDepTime) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ESTDEPTIME, estDepTime);
  }
  void add_dragIndex(double dragIndex) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_DRAGINDEX, dragIndex, 0.0);
  }
  void add_fuelDegrade(double fuelDegrade) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_FUELDEGRADE, fuelDegrade, 0.0);
  }
  void add_opWeight(double opWeight) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_OPWEIGHT, opWeight, 0.0);
  }
  void add_msnIndex(double msnIndex) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_MSNINDEX, msnIndex, 0.0);
  }
  void add_rampFuel(double rampFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_RAMPFUEL, rampFuel, 0.0);
  }
  void add_taxiFuel(double taxiFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_TAXIFUEL, taxiFuel, 0.0);
  }
  void add_takeoffFuel(double takeoffFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_TAKEOFFFUEL, takeoffFuel, 0.0);
  }
  void add_climbFuel(double climbFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_CLIMBFUEL, climbFuel, 0.0);
  }
  void add_climbTime(::flatbuffers::Offset<::flatbuffers::String> climbTime) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_CLIMBTIME, climbTime);
  }
  void add_holdDownFuel(double holdDownFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_HOLDDOWNFUEL, holdDownFuel, 0.0);
  }
  void add_tocIceFuel(double tocIceFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_TOCICEFUEL, tocIceFuel, 0.0);
  }
  void add_tocFuel(double tocFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_TOCFUEL, tocFuel, 0.0);
  }
  void add_enrouteFuel(double enrouteFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_ENROUTEFUEL, enrouteFuel, 0.0);
  }
  void add_enrouteTime(::flatbuffers::Offset<::flatbuffers::String> enrouteTime) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ENROUTETIME, enrouteTime);
  }
  void add_thunderAvoidFuel(double thunderAvoidFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_THUNDERAVOIDFUEL, thunderAvoidFuel, 0.0);
  }
  void add_todIceFuel(double todIceFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_TODICEFUEL, todIceFuel, 0.0);
  }
  void add_opConditionFuel(double opConditionFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_OPCONDITIONFUEL, opConditionFuel, 0.0);
  }
  void add_todFuel(double todFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_TODFUEL, todFuel, 0.0);
  }
  void add_earlyDescentFuel(double earlyDescentFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_EARLYDESCENTFUEL, earlyDescentFuel, 0.0);
  }
  void add_arrIceFuel(double arrIceFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_ARRICEFUEL, arrIceFuel, 0.0);
  }
  void add_holdFuel(double holdFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_HOLDFUEL, holdFuel, 0.0);
  }
  void add_holdTime(::flatbuffers::Offset<::flatbuffers::String> holdTime) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_HOLDTIME, holdTime);
  }
  void add_appLandingFuel(double appLandingFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_APPLANDINGFUEL, appLandingFuel, 0.0);
  }
  void add_burnedFuel(double burnedFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_BURNEDFUEL, burnedFuel, 0.0);
  }
  void add_landingFuel(double landingFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_LANDINGFUEL, landingFuel, 0.0);
  }
  void add_minDivertFuel(double minDivertFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_MINDIVERTFUEL, minDivertFuel, 0.0);
  }
  void add_arrAlternate1Fuel(double arrAlternate1Fuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_ARRALTERNATE1FUEL, arrAlternate1Fuel, 0.0);
  }
  void add_arrAlternate2Fuel(double arrAlternate2Fuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_ARRALTERNATE2FUEL, arrAlternate2Fuel, 0.0);
  }
  void add_contingencyFuel(double contingencyFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_CONTINGENCYFUEL, contingencyFuel, 0.0);
  }
  void add_reserveFuel(double reserveFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_RESERVEFUEL, reserveFuel, 0.0);
  }
  void add_depressFuel(double depressFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_DEPRESSFUEL, depressFuel, 0.0);
  }
  void add_unusableFuel(double unusableFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_UNUSABLEFUEL, unusableFuel, 0.0);
  }
  void add_unidentExtraFuel(double unidentExtraFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_UNIDENTEXTRAFUEL, unidentExtraFuel, 0.0);
  }
  void add_identExtraFuel(double identExtraFuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_IDENTEXTRAFUEL, identExtraFuel, 0.0);
  }
  void add_remAlternate1Fuel(double remAlternate1Fuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_REMALTERNATE1FUEL, remAlternate1Fuel, 0.0);
  }
  void add_remAlternate2Fuel(double remAlternate2Fuel) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_REMALTERNATE2FUEL, remAlternate2Fuel, 0.0);
  }
  void add_enduranceTime(::flatbuffers::Offset<::flatbuffers::String> enduranceTime) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ENDURANCETIME, enduranceTime);
  }
  void add_sid(::flatbuffers::Offset<::flatbuffers::String> sid) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_SID, sid);
  }
  void add_star(::flatbuffers::Offset<::flatbuffers::String> star) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_STAR, star);
  }
  void add_gpsRAIM(::flatbuffers::Offset<::flatbuffers::String> gpsRAIM) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_GPSRAIM, gpsRAIM);
  }
  void add_depRunway(::flatbuffers::Offset<::flatbuffers::String> depRunway) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_DEPRUNWAY, depRunway);
  }
  void add_arrRunway(::flatbuffers::Offset<::flatbuffers::String> arrRunway) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ARRRUNWAY, arrRunway);
  }
  void add_routeString(::flatbuffers::Offset<::flatbuffers::String> routeString) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ROUTESTRING, routeString);
  }
  void add_countryCodes(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> countryCodes) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_COUNTRYCODES, countryCodes);
  }
  void add_etopsRating(::flatbuffers::Offset<::flatbuffers::String> etopsRating) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ETOPSRATING, etopsRating);
  }
  void add_etopsAirfields(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> etopsAirfields) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ETOPSAIRFIELDS, etopsAirfields);
  }
  void add_etopsAltAirfields(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> etopsAltAirfields) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ETOPSALTAIRFIELDS, etopsAltAirfields);
  }
  void add_etopsValWindow(::flatbuffers::Offset<::flatbuffers::String> etopsValWindow) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ETOPSVALWINDOW, etopsValWindow);
  }
  void add_plannerRemark(::flatbuffers::Offset<::flatbuffers::String> plannerRemark) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_PLANNERREMARK, plannerRemark);
  }
  void add_cargoRemark(::flatbuffers::Offset<::flatbuffers::String> cargoRemark) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_CARGOREMARK, cargoRemark);
  }
  void add_windFac1(double windFac1) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_WINDFAC1, windFac1, 0.0);
  }
  void add_windFac2(double windFac2) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_WINDFAC2, windFac2, 0.0);
  }
  void add_windFacAvg(double windFacAvg) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_WINDFACAVG, windFacAvg, 0.0);
  }
  void add_avgTempDev(double avgTempDev) {
    fbb_.AddElement<double>(FlightPlan_Abridged::VT_AVGTEMPDEV, avgTempDev, 0.0);
  }
  void add_atcAddresses(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> atcAddresses) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ATCADDRESSES, atcAddresses);
  }
  void add_originator(::flatbuffers::Offset<::flatbuffers::String> originator) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ORIGINATOR, originator);
  }
  void add_numAircraft(int32_t numAircraft) {
    fbb_.AddElement<int32_t>(FlightPlan_Abridged::VT_NUMAIRCRAFT, numAircraft, 0);
  }
  void add_flightRules(::flatbuffers::Offset<::flatbuffers::String> flightRules) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_FLIGHTRULES, flightRules);
  }
  void add_flightType(::flatbuffers::Offset<::flatbuffers::String> flightType) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_FLIGHTTYPE, flightType);
  }
  void add_initialCruiseSpeed(::flatbuffers::Offset<::flatbuffers::String> initialCruiseSpeed) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_INITIALCRUISESPEED, initialCruiseSpeed);
  }
  void add_initialFlightLevel(::flatbuffers::Offset<::flatbuffers::String> initialFlightLevel) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_INITIALFLIGHTLEVEL, initialFlightLevel);
  }
  void add_arrAlternate1(::flatbuffers::Offset<::flatbuffers::String> arrAlternate1) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ARRALTERNATE1, arrAlternate1);
  }
  void add_arrAlternate2(::flatbuffers::Offset<::flatbuffers::String> arrAlternate2) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ARRALTERNATE2, arrAlternate2);
  }
  void add_depAlternate(::flatbuffers::Offset<::flatbuffers::String> depAlternate) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_DEPALTERNATE, depAlternate);
  }
  void add_wakeTurbCat(::flatbuffers::Offset<::flatbuffers::String> wakeTurbCat) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_WAKETURBCAT, wakeTurbCat);
  }
  void add_equipment(::flatbuffers::Offset<::flatbuffers::String> equipment) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_EQUIPMENT, equipment);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_NOTES, notes);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(FlightPlan_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(FlightPlan_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_airRefuelEvents(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> airRefuelEvents) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_AIRREFUELEVENTS, airRefuelEvents);
  }
  void add_flightPlanMessages(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> flightPlanMessages) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_FLIGHTPLANMESSAGES, flightPlanMessages);
  }
  void add_flightPlanWaypoints(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> flightPlanWaypoints) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_FLIGHTPLANWAYPOINTS, flightPlanWaypoints);
  }
  void add_flightPlanPointGroups(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> flightPlanPointGroups) {
    fbb_.AddOffset(FlightPlan_Abridged::VT_FLIGHTPLANPOINTGROUPS, flightPlanPointGroups);
  }
  explicit FlightPlan_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<FlightPlan_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<FlightPlan_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<FlightPlan_Abridged> CreateFlightPlan_Abridged(
    ...
    FlightPlan_Abridged_dataMode_Enum dataMode = FlightPlan_Abridged_dataMode_Enum_REAL,
  ...
  FlightPlan_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<FlightPlan_Abridged> CreateFlightPlan_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateFlightPlan_Abridged(
      _fbb,
      id__,
...
inline const FlightPlan_Abridged *GetFlightPlan_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<FlightPlan_Abridged>(buf);
}

inline const FlightPlan_Abridged *GetSizePrefixedFlightPlan_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<FlightPlan_Abridged>(buf);
}

inline const char *FlightPlan_AbridgedIdentifier() {
  return "FLIG";
}

inline bool FlightPlan_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, FlightPlan_AbridgedIdentifier());
}

inline bool SizePrefixedFlightPlan_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, FlightPlan_AbridgedIdentifier(), true);
}

inline bool VerifyFlightPlan_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<FlightPlan_Abridged>(FlightPlan_AbridgedIdentifier());
}

inline bool VerifySizePrefixedFlightPlan_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<FlightPlan_Abridged>(FlightPlan_AbridgedIdentifier());
}

inline void FinishFlightPlan_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<FlightPlan_Abridged> root) {
  fbb.Finish(root, FlightPlan_AbridgedIdentifier());
}

inline void FinishSizePrefixedFlightPlan_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<FlightPlan_Abridged> root) {
  fbb.FinishSizePrefixed(root, FlightPlan_AbridgedIdentifier());
}
