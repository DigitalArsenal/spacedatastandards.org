...
struct SARObservation_Full;
struct SARObservation_FullBuilder;

enum SARObservation_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  SARObservation_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  SARObservation_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  SARObservation_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  SARObservation_Full_dataMode_Enum_EXERCISE = 3,
  SARObservation_Full_dataMode_Enum_MIN = SARObservation_Full_dataMode_Enum_REAL,
  SARObservation_Full_dataMode_Enum_MAX = SARObservation_Full_dataMode_Enum_EXERCISE
};

inline const SARObservation_Full_dataMode_Enum (&EnumValuesSARObservation_Full_dataMode_Enum())[4] {
  static const SARObservation_Full_dataMode_Enum values[] = {
    SARObservation_Full_dataMode_Enum_REAL,
    SARObservation_Full_dataMode_Enum_TEST,
    SARObservation_Full_dataMode_Enum_SIMULATED,
    SARObservation_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSARObservation_Full_dataMode_Enum() {
...
inline const char *EnumNameSARObservation_Full_dataMode_Enum(SARObservation_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SARObservation_Full_dataMode_Enum_REAL, SARObservation_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSARObservation_Full_dataMode_Enum()[index];
}
...
struct SARObservation_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SARObservation_FullBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_ASRID = 80,
    VT_SPACINGRANGE = 82,
    VT_SPACINGAZIMUTH = 84,
    VT_LOOKSAZIMUTH = 86,
    VT_LOOKSRANGE = 88,
    VT_RESOLUTIONRANGE = 90,
    VT_RESOLUTIONAZIMUTH = 92,
    VT_OBDIRECTION = 94,
    VT_COORDSYS = 96,
    VT_TARGETPOSX = 98,
    VT_TARGETPOSY = 100,
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SARObservation_Full_dataMode_Enum dataMode() const {
    return static_cast<SARObservation_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SARObservation_FullBuilder {
  typedef SARObservation_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SARObservation_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SARObservation_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(SARObservation_Full::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(SARObservation_Full::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(SARObservation_Full::VT_ORIGOBJECTID, origObjectId);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(SARObservation_Full::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(SARObservation_Full::VT_ORIGSENSORID, origSensorId);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(SARObservation_Full::VT_EXTERNALID, externalId);
  }
  void add_collectionId(::flatbuffers::Offset<::flatbuffers::String> collectionId) {
    fbb_.AddOffset(SARObservation_Full::VT_COLLECTIONID, collectionId);
  }
  void add_detectionId(::flatbuffers::Offset<::flatbuffers::String> detectionId) {
    fbb_.AddOffset(SARObservation_Full::VT_DETECTIONID, detectionId);
  }
  void add_collectionStart(::flatbuffers::Offset<::flatbuffers::String> collectionStart) {
    fbb_.AddOffset(SARObservation_Full::VT_COLLECTIONSTART, collectionStart);
  }
  void add_collectionEnd(::flatbuffers::Offset<::flatbuffers::String> collectionEnd) {
    fbb_.AddOffset(SARObservation_Full::VT_COLLECTIONEND, collectionEnd);
  }
  void add_centerTime(::flatbuffers::Offset<::flatbuffers::String> centerTime) {
    fbb_.AddOffset(SARObservation_Full::VT_CENTERTIME, centerTime);
  }
  void add_detectionStart(::flatbuffers::Offset<::flatbuffers::String> detectionStart) {
    fbb_.AddOffset(SARObservation_Full::VT_DETECTIONSTART, detectionStart);
  }
  void add_detectionEnd(::flatbuffers::Offset<::flatbuffers::String> detectionEnd) {
    fbb_.AddOffset(SARObservation_Full::VT_DETECTIONEND, detectionEnd);
  }
  void add_dwellTime(double dwellTime) {
    fbb_.AddElement<double>(SARObservation_Full::VT_DWELLTIME, dwellTime, 0.0);
  }
  void add_orbitState(::flatbuffers::Offset<::flatbuffers::String> orbitState) {
    fbb_.AddOffset(SARObservation_Full::VT_ORBITSTATE, orbitState);
  }
  void add_sarMode(::flatbuffers::Offset<::flatbuffers::String> sarMode) {
    fbb_.AddOffset(SARObservation_Full::VT_SARMODE, sarMode);
  }
  void add_operatingBand(::flatbuffers::Offset<::flatbuffers::String> operatingBand) {
    fbb_.AddOffset(SARObservation_Full::VT_OPERATINGBAND, operatingBand);
  }
  void add_operatingFreq(double operatingFreq) {
    fbb_.AddElement<double>(SARObservation_Full::VT_OPERATINGFREQ, operatingFreq, 0.0);
  }
  void add_snr(double snr) {
    fbb_.AddElement<double>(SARObservation_Full::VT_SNR, snr, 0.0);
  }
  void add_txPolarization(::flatbuffers::Offset<::flatbuffers::String> txPolarization) {
    fbb_.AddOffset(SARObservation_Full::VT_TXPOLARIZATION, txPolarization);
  }
  void add_rxPolarization(::flatbuffers::Offset<::flatbuffers::String> rxPolarization) {
    fbb_.AddOffset(SARObservation_Full::VT_RXPOLARIZATION, rxPolarization);
  }
  void add_grazeAngle(double grazeAngle) {
    fbb_.AddElement<double>(SARObservation_Full::VT_GRAZEANGLE, grazeAngle, 0.0);
  }
  void add_incidenceAngle(double incidenceAngle) {
    fbb_.AddElement<double>(SARObservation_Full::VT_INCIDENCEANGLE, incidenceAngle, 0.0);
  }
  void add_squintAngle(double squintAngle) {
    fbb_.AddElement<double>(SARObservation_Full::VT_SQUINTANGLE, squintAngle, 0.0);
  }
  void add_pulseBandwidth(double pulseBandwidth) {
    fbb_.AddElement<double>(SARObservation_Full::VT_PULSEBANDWIDTH, pulseBandwidth, 0.0);
  }
  void add_pulseDuration(double pulseDuration) {
    fbb_.AddElement<double>(SARObservation_Full::VT_PULSEDURATION, pulseDuration, 0.0);
  }
  void add_continuousSpotAngle(double continuousSpotAngle) {
    fbb_.AddElement<double>(SARObservation_Full::VT_CONTINUOUSSPOTANGLE, continuousSpotAngle, 0.0);
  }
  void add_slantRange(double slantRange) {
    fbb_.AddElement<double>(SARObservation_Full::VT_SLANTRANGE, slantRange, 0.0);
  }
  void add_nearRange(double nearRange) {
    fbb_.AddElement<double>(SARObservation_Full::VT_NEARRANGE, nearRange, 0.0);
  }
  void add_farRange(double farRange) {
    fbb_.AddElement<double>(SARObservation_Full::VT_FARRANGE, farRange, 0.0);
  }
  void add_swathLength(double swathLength) {
    fbb_.AddElement<double>(SARObservation_Full::VT_SWATHLENGTH, swathLength, 0.0);
  }
  void add_area(::flatbuffers::Offset<::flatbuffers::String> area) {
    fbb_.AddOffset(SARObservation_Full::VT_AREA, area);
  }
  void add_atext(::flatbuffers::Offset<::flatbuffers::String> atext) {
    fbb_.AddOffset(SARObservation_Full::VT_ATEXT, atext);
  }
  void add_agjson(::flatbuffers::Offset<::flatbuffers::String> agjson) {
    fbb_.AddOffset(SARObservation_Full::VT_AGJSON, agjson);
  }
  void add_atype(::flatbuffers::Offset<::flatbuffers::String> atype) {
    fbb_.AddOffset(SARObservation_Full::VT_ATYPE, atype);
  }
  void add_andims(int32_t andims) {
    fbb_.AddElement<int32_t>(SARObservation_Full::VT_ANDIMS, andims, 0);
  }
  void add_asrid(int32_t asrid) {
    fbb_.AddElement<int32_t>(SARObservation_Full::VT_ASRID, asrid, 0);
  }
  void add_spacingRange(double spacingRange) {
    fbb_.AddElement<double>(SARObservation_Full::VT_SPACINGRANGE, spacingRange, 0.0);
  }
  void add_spacingAzimuth(double spacingAzimuth) {
    fbb_.AddElement<double>(SARObservation_Full::VT_SPACINGAZIMUTH, spacingAzimuth, 0.0);
  }
  void add_looksAzimuth(int32_t looksAzimuth) {
    fbb_.AddElement<int32_t>(SARObservation_Full::VT_LOOKSAZIMUTH, looksAzimuth, 0);
  }
  void add_looksRange(int32_t looksRange) {
    fbb_.AddElement<int32_t>(SARObservation_Full::VT_LOOKSRANGE, looksRange, 0);
  }
  void add_resolutionRange(double resolutionRange) {
    fbb_.AddElement<double>(SARObservation_Full::VT_RESOLUTIONRANGE, resolutionRange, 0.0);
  }
  void add_resolutionAzimuth(double resolutionAzimuth) {
    fbb_.AddElement<double>(SARObservation_Full::VT_RESOLUTIONAZIMUTH, resolutionAzimuth, 0.0);
  }
  void add_obDirection(::flatbuffers::Offset<::flatbuffers::String> obDirection) {
    fbb_.AddOffset(SARObservation_Full::VT_OBDIRECTION, obDirection);
  }
  void add_coordSys(::flatbuffers::Offset<::flatbuffers::String> coordSys) {
    fbb_.AddOffset(SARObservation_Full::VT_COORDSYS, coordSys);
  }
  void add_targetposx(double targetposx) {
    fbb_.AddElement<double>(SARObservation_Full::VT_TARGETPOSX, targetposx, 0.0);
  }
  void add_targetposy(double targetposy) {
    fbb_.AddElement<double>(SARObservation_Full::VT_TARGETPOSY, targetposy, 0.0);
  }
  void add_targetposz(double targetposz) {
    fbb_.AddElement<double>(SARObservation_Full::VT_TARGETPOSZ, targetposz, 0.0);
  }
  void add_senalt(double senalt) {
    fbb_.AddElement<double>(SARObservation_Full::VT_SENALT, senalt, 0.0);
  }
  void add_senvelx(double senvelx) {
    fbb_.AddElement<double>(SARObservation_Full::VT_SENVELX, senvelx, 0.0);
  }
  void add_senvely(double senvely) {
    fbb_.AddElement<double>(SARObservation_Full::VT_SENVELY, senvely, 0.0);
  }
  void add_senvelz(double senvelz) {
    fbb_.AddElement<double>(SARObservation_Full::VT_SENVELZ, senvelz, 0.0);
  }
  void add_senlatStart(double senlatStart) {
    fbb_.AddElement<double>(SARObservation_Full::VT_SENLATSTART, senlatStart, 0.0);
  }
  void add_senlonStart(double senlonStart) {
    fbb_.AddElement<double>(SARObservation_Full::VT_SENLONSTART, senlonStart, 0.0);
  }
  void add_senlatEnd(double senlatEnd) {
    fbb_.AddElement<double>(SARObservation_Full::VT_SENLATEND, senlatEnd, 0.0);
  }
  void add_senlonEnd(double senlonEnd) {
    fbb_.AddElement<double>(SARObservation_Full::VT_SENLONEND, senlonEnd, 0.0);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(SARObservation_Full::VT_TRANSACTIONID, transactionId);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(SARObservation_Full::VT_TAGS, tags);
  }
  void add_srcTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcTyps) {
    fbb_.AddOffset(SARObservation_Full::VT_SRCTYPS, srcTyps);
  }
  void add_srcIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcIds) {
    fbb_.AddOffset(SARObservation_Full::VT_SRCIDS, srcIds);
  }
  void add_onOrbit(::flatbuffers::Offset<::flatbuffers::String> onOrbit) {
    fbb_.AddOffset(SARObservation_Full::VT_ONORBIT, onOrbit);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SARObservation_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SARObservation_Full::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SARObservation_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SARObservation_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SARObservation_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(SARObservation_Full::VT_SOURCEDL, sourceDL);
  }
  void add_dataMode(SARObservation_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SARObservation_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit SARObservation_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SARObservation_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SARObservation_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SARObservation_Full> CreateSARObservation_Full(
    ...
    SARObservation_Full_dataMode_Enum dataMode = SARObservation_Full_dataMode_Enum_REAL) {
  SARObservation_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SARObservation_Full> CreateSARObservation_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const SARObservation_Full *GetSARObservation_Full(const void *buf) {
  return ::flatbuffers::GetRoot<SARObservation_Full>(buf);
}

inline const SARObservation_Full *GetSizePrefixedSARObservation_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SARObservation_Full>(buf);
}

inline const char *SARObservation_FullIdentifier() {
  return "SARO";
}

inline bool SARObservation_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SARObservation_FullIdentifier());
}

inline bool SizePrefixedSARObservation_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SARObservation_FullIdentifier(), true);
}

inline bool VerifySARObservation_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SARObservation_Full>(SARObservation_FullIdentifier());
}

inline bool VerifySizePrefixedSARObservation_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SARObservation_Full>(SARObservation_FullIdentifier());
}

inline void FinishSARObservation_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SARObservation_Full> root) {
  fbb.Finish(root, SARObservation_FullIdentifier());
}

inline void FinishSizePrefixedSARObservation_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SARObservation_Full> root) {
  fbb.FinishSizePrefixed(root, SARObservation_FullIdentifier());
}
