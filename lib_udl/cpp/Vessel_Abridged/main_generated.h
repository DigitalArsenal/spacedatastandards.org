...
struct Vessel_Abridged;
struct Vessel_AbridgedBuilder;

enum Vessel_Abridged_dataMode_Enum : int8_t {
  ...
  Vessel_Abridged_dataMode_Enum_MIN = Vessel_Abridged_dataMode_Enum_REAL,
  Vessel_Abridged_dataMode_Enum_MAX = Vessel_Abridged_dataMode_Enum_EXERCISE
};

inline const Vessel_Abridged_dataMode_Enum (&EnumValuesVessel_Abridged_dataMode_Enum())[4] {
  static const Vessel_Abridged_dataMode_Enum values[] = {
    Vessel_Abridged_dataMode_Enum_REAL,
    Vessel_Abridged_dataMode_Enum_TEST,
    Vessel_Abridged_dataMode_Enum_SIMULATED,
    Vessel_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesVessel_Abridged_dataMode_Enum() {
...
inline const char *EnumNameVessel_Abridged_dataMode_Enum(Vessel_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Vessel_Abridged_dataMode_Enum_REAL, Vessel_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesVessel_Abridged_dataMode_Enum()[index];
}
...
struct Vessel_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Vessel_AbridgedBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_ID = 4,
    VT_CLASSIFICATIONMARKING = 6,
    VT_IDENTITY = 8,
    VT_ALTVESSELID = 10,
    VT_IDORGANIZATION = 12,
    VT_VESSELNAME = 14,
    VT_VESSELTYPE = 16,
    VT_VESSELCLASS = 18,
    VT_VESSELDESCRIPTION = 20,
    VT_SCONUM = 22,
    VT_IMON = 24,
    VT_MMSI = 26,
    VT_CALLSIGN = 28,
  ...
  /// Constraints: Minimum length = 1, Maximum length = 64
  Vessel_Abridged_dataMode_Enum dataMode() const {
    return static_cast<Vessel_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Vessel_AbridgedBuilder {
  typedef Vessel_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Vessel_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Vessel_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idEntity(::flatbuffers::Offset<::flatbuffers::String> idEntity) {
    fbb_.AddOffset(Vessel_Abridged::VT_IDENTITY, idEntity);
  }
  void add_altVesselId(::flatbuffers::Offset<::flatbuffers::String> altVesselId) {
    fbb_.AddOffset(Vessel_Abridged::VT_ALTVESSELID, altVesselId);
  }
  void add_idOrganization(::flatbuffers::Offset<::flatbuffers::String> idOrganization) {
    fbb_.AddOffset(Vessel_Abridged::VT_IDORGANIZATION, idOrganization);
  }
  void add_vesselName(::flatbuffers::Offset<::flatbuffers::String> vesselName) {
    fbb_.AddOffset(Vessel_Abridged::VT_VESSELNAME, vesselName);
  }
  void add_vesselType(::flatbuffers::Offset<::flatbuffers::String> vesselType) {
    fbb_.AddOffset(Vessel_Abridged::VT_VESSELTYPE, vesselType);
  }
  void add_vesselClass(::flatbuffers::Offset<::flatbuffers::String> vesselClass) {
    fbb_.AddOffset(Vessel_Abridged::VT_VESSELCLASS, vesselClass);
  }
  void add_vesselDescription(::flatbuffers::Offset<::flatbuffers::String> vesselDescription) {
    fbb_.AddOffset(Vessel_Abridged::VT_VESSELDESCRIPTION, vesselDescription);
  }
  void add_sconum(::flatbuffers::Offset<::flatbuffers::String> sconum) {
    fbb_.AddOffset(Vessel_Abridged::VT_SCONUM, sconum);
  }
  void add_imon(int32_t imon) {
    fbb_.AddElement<int32_t>(Vessel_Abridged::VT_IMON, imon, 0);
  }
  void add_mmsi(::flatbuffers::Offset<::flatbuffers::String> mmsi) {
    fbb_.AddOffset(Vessel_Abridged::VT_MMSI, mmsi);
  }
  void add_callsign(::flatbuffers::Offset<::flatbuffers::String> callsign) {
    fbb_.AddOffset(Vessel_Abridged::VT_CALLSIGN, callsign);
  }
  void add_vesselFlag(::flatbuffers::Offset<::flatbuffers::String> vesselFlag) {
    fbb_.AddOffset(Vessel_Abridged::VT_VESSELFLAG, vesselFlag);
  }
  void add_yearBuilt(::flatbuffers::Offset<::flatbuffers::String> yearBuilt) {
    fbb_.AddOffset(Vessel_Abridged::VT_YEARBUILT, yearBuilt);
  }
  void add_vesselBuilder(::flatbuffers::Offset<::flatbuffers::String> vesselBuilder) {
    fbb_.AddOffset(Vessel_Abridged::VT_VESSELBUILDER, vesselBuilder);
  }
  void add_status(::flatbuffers::Offset<::flatbuffers::String> status) {
    fbb_.AddOffset(Vessel_Abridged::VT_STATUS, status);
  }
  void add_firstSeen(::flatbuffers::Offset<::flatbuffers::String> firstSeen) {
    fbb_.AddOffset(Vessel_Abridged::VT_FIRSTSEEN, firstSeen);
  }
  void add_length(double length) {
    fbb_.AddElement<double>(Vessel_Abridged::VT_LENGTH, length, 0.0);
  }
  void add_width(double width) {
    fbb_.AddElement<double>(Vessel_Abridged::VT_WIDTH, width, 0.0);
  }
  void add_maxDraught(double maxDraught) {
    fbb_.AddElement<double>(Vessel_Abridged::VT_MAXDRAUGHT, maxDraught, 0.0);
  }
  void add_vslWt(double vslWt) {
    fbb_.AddElement<double>(Vessel_Abridged::VT_VSLWT, vslWt, 0.0);
  }
  void add_maxSpeed(double maxSpeed) {
    fbb_.AddElement<double>(Vessel_Abridged::VT_MAXSPEED, maxSpeed, 0.0);
  }
  void add_sternType(::flatbuffers::Offset<::flatbuffers::String> sternType) {
    fbb_.AddOffset(Vessel_Abridged::VT_STERNTYPE, sternType);
  }
  void add_numBlades(int32_t numBlades) {
    fbb_.AddElement<int32_t>(Vessel_Abridged::VT_NUMBLADES, numBlades, 0);
  }
  void add_numShafts(int32_t numShafts) {
    fbb_.AddElement<int32_t>(Vessel_Abridged::VT_NUMSHAFTS, numShafts, 0);
  }
  void add_propType(::flatbuffers::Offset<::flatbuffers::String> propType) {
    fbb_.AddOffset(Vessel_Abridged::VT_PROPTYPE, propType);
  }
  void add_hullNum(::flatbuffers::Offset<::flatbuffers::String> hullNum) {
    fbb_.AddOffset(Vessel_Abridged::VT_HULLNUM, hullNum);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Vessel_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Vessel_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Vessel_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Vessel_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(Vessel_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Vessel_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Vessel_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  explicit Vessel_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Vessel_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Vessel_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Vessel_Abridged> CreateVessel_Abridged(
    ...
    Vessel_Abridged_dataMode_Enum dataMode = Vessel_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  Vessel_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Vessel_Abridged> CreateVessel_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Vessel_Abridged *GetVessel_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<Vessel_Abridged>(buf);
}

inline const Vessel_Abridged *GetSizePrefixedVessel_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Vessel_Abridged>(buf);
}

inline const char *Vessel_AbridgedIdentifier() {
  return "VESS";
}

inline bool Vessel_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Vessel_AbridgedIdentifier());
}

inline bool SizePrefixedVessel_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Vessel_AbridgedIdentifier(), true);
}

inline bool VerifyVessel_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Vessel_Abridged>(Vessel_AbridgedIdentifier());
}

inline bool VerifySizePrefixedVessel_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Vessel_Abridged>(Vessel_AbridgedIdentifier());
}

inline void FinishVessel_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Vessel_Abridged> root) {
  fbb.Finish(root, Vessel_AbridgedIdentifier());
}

inline void FinishSizePrefixedVessel_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Vessel_Abridged> root) {
  fbb.FinishSizePrefixed(root, Vessel_AbridgedIdentifier());
}
