...
struct MissileTrackVector_Full;
struct MissileTrackVector_FullBuilder;

/// /// Schema for Missile Track Vector data.
struct MissileTrackVector_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef MissileTrackVector_FullBuilder Builder;
...
struct MissileTrackVector_FullBuilder {
  typedef MissileTrackVector_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(MissileTrackVector_Full::VT_TYPE, type);
  }
  void add_object(::flatbuffers::Offset<::flatbuffers::String> object) {
    fbb_.AddOffset(MissileTrackVector_Full::VT_OBJECT, object);
  }
  void add_epoch(::flatbuffers::Offset<::flatbuffers::String> epoch) {
    fbb_.AddOffset(MissileTrackVector_Full::VT_EPOCH, epoch);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(MissileTrackVector_Full::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(MissileTrackVector_Full::VT_ORIGSENSORID, origSensorId);
  }
  void add_pos(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> pos) {
    fbb_.AddOffset(MissileTrackVector_Full::VT_POS, pos);
  }
  void add_vel(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> vel) {
    fbb_.AddOffset(MissileTrackVector_Full::VT_VEL, vel);
  }
  void add_accel(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> accel) {
    fbb_.AddOffset(MissileTrackVector_Full::VT_ACCEL, accel);
  }
  void add_course(double course) {
    fbb_.AddElement<double>(MissileTrackVector_Full::VT_COURSE, course, 0.0);
  }
  void add_spd(double spd) {
    fbb_.AddElement<double>(MissileTrackVector_Full::VT_SPD, spd, 0.0);
  }
  void add_referenceFrame(::flatbuffers::Offset<::flatbuffers::String> referenceFrame) {
    fbb_.AddOffset(MissileTrackVector_Full::VT_REFERENCEFRAME, referenceFrame);
  }
  void add_cov(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> cov) {
    fbb_.AddOffset(MissileTrackVector_Full::VT_COV, cov);
  }
  void add_covReferenceFrame(::flatbuffers::Offset<::flatbuffers::String> covReferenceFrame) {
    fbb_.AddOffset(MissileTrackVector_Full::VT_COVREFERENCEFRAME, covReferenceFrame);
  }
  void add_vectorLat(double vectorLat) {
    fbb_.AddElement<double>(MissileTrackVector_Full::VT_VECTORLAT, vectorLat, 0.0);
  }
  void add_vectorLon(double vectorLon) {
    fbb_.AddElement<double>(MissileTrackVector_Full::VT_VECTORLON, vectorLon, 0.0);
  }
  void add_vectorAlt(double vectorAlt) {
    fbb_.AddElement<double>(MissileTrackVector_Full::VT_VECTORALT, vectorAlt, 0.0);
  }
  void add_confidence(int32_t confidence) {
    fbb_.AddElement<int32_t>(MissileTrackVector_Full::VT_CONFIDENCE, confidence, 0);
  }
  void add_status(::flatbuffers::Offset<::flatbuffers::String> status) {
    fbb_.AddOffset(MissileTrackVector_Full::VT_STATUS, status);
  }
  void add_timeSource(::flatbuffers::Offset<::flatbuffers::String> timeSource) {
    fbb_.AddOffset(MissileTrackVector_Full::VT_TIMESOURCE, timeSource);
  }
  void add_quat(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> quat) {
    fbb_.AddOffset(MissileTrackVector_Full::VT_QUAT, quat);
  }
  void add_flightAz(double flightAz) {
    fbb_.AddElement<double>(MissileTrackVector_Full::VT_FLIGHTAZ, flightAz, 0.0);
  }
  explicit MissileTrackVector_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<MissileTrackVector_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<MissileTrackVector_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<MissileTrackVector_Full> CreateMissileTrackVector_Full(
    ...
    double flightAz = 0.0) {
  MissileTrackVector_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<MissileTrackVector_Full> CreateMissileTrackVector_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const MissileTrackVector_Full *GetMissileTrackVector_Full(const void *buf) {
  return ::flatbuffers::GetRoot<MissileTrackVector_Full>(buf);
}

inline const MissileTrackVector_Full *GetSizePrefixedMissileTrackVector_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<MissileTrackVector_Full>(buf);
}

inline const char *MissileTrackVector_FullIdentifier() {
  return "MISS";
}

inline bool MissileTrackVector_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MissileTrackVector_FullIdentifier());
}

inline bool SizePrefixedMissileTrackVector_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MissileTrackVector_FullIdentifier(), true);
}

inline bool VerifyMissileTrackVector_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<MissileTrackVector_Full>(MissileTrackVector_FullIdentifier());
}

inline bool VerifySizePrefixedMissileTrackVector_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<MissileTrackVector_Full>(MissileTrackVector_FullIdentifier());
}

inline void FinishMissileTrackVector_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MissileTrackVector_Full> root) {
  fbb.Finish(root, MissileTrackVector_FullIdentifier());
}

inline void FinishSizePrefixedMissileTrackVector_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MissileTrackVector_Full> root) {
  fbb.FinishSizePrefixed(root, MissileTrackVector_FullIdentifier());
}
