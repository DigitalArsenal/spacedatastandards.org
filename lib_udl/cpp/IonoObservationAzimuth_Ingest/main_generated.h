...
struct IonoObservationAzimuth_Ingest;
struct IonoObservationAzimuth_IngestBuilder;
...
struct IonoObservationAzimuth_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef IonoObservationAzimuth_IngestBuilder Builder;
...
struct IonoObservationAzimuth_IngestBuilder {
  typedef IonoObservationAzimuth_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(IonoObservationAzimuth_Ingest::VT_NOTES, notes);
  }
  void add_dimensions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dimensions) {
    fbb_.AddOffset(IonoObservationAzimuth_Ingest::VT_DIMENSIONS, dimensions);
  }
  void add_dimensionName(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dimensionName) {
    fbb_.AddOffset(IonoObservationAzimuth_Ingest::VT_DIMENSIONNAME, dimensionName);
  }
  void add_data(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> data) {
    fbb_.AddOffset(IonoObservationAzimuth_Ingest::VT_DATA, data);
  }
  explicit IonoObservationAzimuth_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<IonoObservationAzimuth_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<IonoObservationAzimuth_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<IonoObservationAzimuth_Ingest> CreateIonoObservationAzimuth_Ingest(
  ...
  IonoObservationAzimuth_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<IonoObservationAzimuth_Ingest> CreateIonoObservationAzimuth_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const IonoObservationAzimuth_Ingest *GetIonoObservationAzimuth_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<IonoObservationAzimuth_Ingest>(buf);
}

inline const IonoObservationAzimuth_Ingest *GetSizePrefixedIonoObservationAzimuth_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<IonoObservationAzimuth_Ingest>(buf);
}

inline const char *IonoObservationAzimuth_IngestIdentifier() {
  return "IONO";
}

inline bool IonoObservationAzimuth_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationAzimuth_IngestIdentifier());
}

inline bool SizePrefixedIonoObservationAzimuth_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationAzimuth_IngestIdentifier(), true);
}

inline bool VerifyIonoObservationAzimuth_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<IonoObservationAzimuth_Ingest>(IonoObservationAzimuth_IngestIdentifier());
}

inline bool VerifySizePrefixedIonoObservationAzimuth_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<IonoObservationAzimuth_Ingest>(IonoObservationAzimuth_IngestIdentifier());
}

inline void FinishIonoObservationAzimuth_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationAzimuth_Ingest> root) {
  fbb.Finish(root, IonoObservationAzimuth_IngestIdentifier());
}

inline void FinishSizePrefixedIonoObservationAzimuth_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationAzimuth_Ingest> root) {
  fbb.FinishSizePrefixed(root, IonoObservationAzimuth_IngestIdentifier());
}
