...
struct Channel_Full;
struct Channel_FullBuilder;

enum Channel_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Channel_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Channel_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Channel_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Channel_Full_dataMode_Enum_EXERCISE = 3,
  Channel_Full_dataMode_Enum_MIN = Channel_Full_dataMode_Enum_REAL,
  Channel_Full_dataMode_Enum_MAX = Channel_Full_dataMode_Enum_EXERCISE
};

inline const Channel_Full_dataMode_Enum (&EnumValuesChannel_Full_dataMode_Enum())[4] {
  static const Channel_Full_dataMode_Enum values[] = {
    Channel_Full_dataMode_Enum_REAL,
    Channel_Full_dataMode_Enum_TEST,
    Channel_Full_dataMode_Enum_SIMULATED,
    Channel_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesChannel_Full_dataMode_Enum() {
...
inline const char *EnumNameChannel_Full_dataMode_Enum(Channel_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Channel_Full_dataMode_Enum_REAL, Channel_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesChannel_Full_dataMode_Enum()[index];
}

/// /// Channel information on a particular transponder.
struct Channel_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Channel_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Channel_Full_dataMode_Enum dataMode() const {
    return static_cast<Channel_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Channel_FullBuilder {
  typedef Channel_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Channel_Full::VT_ID, id);
  }
  void add_idTransponder(::flatbuffers::Offset<::flatbuffers::String> idTransponder) {
    fbb_.AddOffset(Channel_Full::VT_IDTRANSPONDER, idTransponder);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(Channel_Full::VT_NAME, name);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Channel_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(Channel_Full::VT_TYPE, type);
  }
  void add_idBeam(::flatbuffers::Offset<::flatbuffers::String> idBeam) {
    fbb_.AddOffset(Channel_Full::VT_IDBEAM, idBeam);
  }
  void add_beamName(::flatbuffers::Offset<::flatbuffers::String> beamName) {
    fbb_.AddOffset(Channel_Full::VT_BEAMNAME, beamName);
  }
  void add_idRFBand(::flatbuffers::Offset<::flatbuffers::String> idRFBand) {
    fbb_.AddOffset(Channel_Full::VT_IDRFBAND, idRFBand);
  }
  void add_encryption(::flatbuffers::Offset<::flatbuffers::String> encryption) {
    fbb_.AddOffset(Channel_Full::VT_ENCRYPTION, encryption);
  }
  void add_pkg(::flatbuffers::Offset<::flatbuffers::String> pkg) {
    fbb_.AddOffset(Channel_Full::VT_PKG, pkg);
  }
  void add_res(::flatbuffers::Offset<::flatbuffers::String> res) {
    fbb_.AddOffset(Channel_Full::VT_RES, res);
  }
  void add_compression(::flatbuffers::Offset<::flatbuffers::String> compression) {
    fbb_.AddOffset(Channel_Full::VT_COMPRESSION, compression);
  }
  void add_vpid(::flatbuffers::Offset<::flatbuffers::String> vpid) {
    fbb_.AddOffset(Channel_Full::VT_VPID, vpid);
  }
  void add_apid(::flatbuffers::Offset<::flatbuffers::String> apid) {
    fbb_.AddOffset(Channel_Full::VT_APID, apid);
  }
  void add_sid(::flatbuffers::Offset<::flatbuffers::String> sid) {
    fbb_.AddOffset(Channel_Full::VT_SID, sid);
  }
  void add_owner(::flatbuffers::Offset<::flatbuffers::String> owner) {
    fbb_.AddOffset(Channel_Full::VT_OWNER, owner);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Channel_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Channel_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Channel_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(Channel_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Channel_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Channel_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Channel_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(Channel_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(Channel_Full::VT_UPDATEDBY, updatedBy);
  }
  explicit Channel_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Channel_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Channel_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Channel_Full> CreateChannel_Full(
...
inline ::flatbuffers::Offset<Channel_Full> CreateChannel_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Channel_Full *GetChannel_Full(const void *buf) {
  return ::flatbuffers::GetRoot<Channel_Full>(buf);
}

inline const Channel_Full *GetSizePrefixedChannel_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Channel_Full>(buf);
}

inline const char *Channel_FullIdentifier() {
  return "CHAN";
}

inline bool Channel_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Channel_FullIdentifier());
}

inline bool SizePrefixedChannel_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Channel_FullIdentifier(), true);
}

inline bool VerifyChannel_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Channel_Full>(Channel_FullIdentifier());
}

inline bool VerifySizePrefixedChannel_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Channel_Full>(Channel_FullIdentifier());
}

inline void FinishChannel_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Channel_Full> root) {
  fbb.Finish(root, Channel_FullIdentifier());
}

inline void FinishSizePrefixedChannel_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Channel_Full> root) {
  fbb.FinishSizePrefixed(root, Channel_FullIdentifier());
}
