...
struct CollectRequest_Full;
struct CollectRequest_FullBuilder;

enum CollectRequest_Full_dataMode_Enum : int8_t {
  ...
  CollectRequest_Full_dataMode_Enum_MIN = CollectRequest_Full_dataMode_Enum_REAL,
  CollectRequest_Full_dataMode_Enum_MAX = CollectRequest_Full_dataMode_Enum_EXERCISE
};

inline const CollectRequest_Full_dataMode_Enum (&EnumValuesCollectRequest_Full_dataMode_Enum())[4] {
  static const CollectRequest_Full_dataMode_Enum values[] = {
    CollectRequest_Full_dataMode_Enum_REAL,
    CollectRequest_Full_dataMode_Enum_TEST,
    CollectRequest_Full_dataMode_Enum_SIMULATED,
    CollectRequest_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesCollectRequest_Full_dataMode_Enum() {
...
inline const char *EnumNameCollectRequest_Full_dataMode_Enum(CollectRequest_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, CollectRequest_Full_dataMode_Enum_REAL, CollectRequest_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesCollectRequest_Full_dataMode_Enum()[index];
}
...
struct CollectRequest_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef CollectRequest_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  CollectRequest_Full_dataMode_Enum dataMode() const {
    return static_cast<CollectRequest_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *collectResponse() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_COLLECTRESPONSE);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_COLLECTRESPONSE) &&
           verifier.VerifyVector(collectResponse()) &&
           verifier.VerifyVectorOfStrings(collectResponse()) &&
           verifier.EndTable();
  }
};

struct CollectRequest_FullBuilder {
  typedef CollectRequest_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(CollectRequest_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(CollectRequest_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idParentReq(::flatbuffers::Offset<::flatbuffers::String> idParentReq) {
    fbb_.AddOffset(CollectRequest_Full::VT_IDPARENTREQ, idParentReq);
  }
  void add_msgType(::flatbuffers::Offset<::flatbuffers::String> msgType) {
    fbb_.AddOffset(CollectRequest_Full::VT_MSGTYPE, msgType);
  }
  void add_msgCreateDate(::flatbuffers::Offset<::flatbuffers::String> msgCreateDate) {
    fbb_.AddOffset(CollectRequest_Full::VT_MSGCREATEDATE, msgCreateDate);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(CollectRequest_Full::VT_TYPE, type);
  }
  void add_idPlan(::flatbuffers::Offset<::flatbuffers::String> idPlan) {
    fbb_.AddOffset(CollectRequest_Full::VT_IDPLAN, idPlan);
  }
  void add_planIndex(int32_t planIndex) {
    fbb_.AddElement<int32_t>(CollectRequest_Full::VT_PLANINDEX, planIndex, 0);
  }
  void add_taskId(::flatbuffers::Offset<::flatbuffers::String> taskId) {
    fbb_.AddOffset(CollectRequest_Full::VT_TASKID, taskId);
  }
  void add_dwellId(::flatbuffers::Offset<::flatbuffers::String> dwellId) {
    fbb_.AddOffset(CollectRequest_Full::VT_DWELLID, dwellId);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(CollectRequest_Full::VT_EXTERNALID, externalId);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(CollectRequest_Full::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(CollectRequest_Full::VT_ORIGSENSORID, origSensorId);
  }
  void add_obType(::flatbuffers::Offset<::flatbuffers::String> obType) {
    fbb_.AddOffset(CollectRequest_Full::VT_OBTYPE, obType);
  }
  void add_priority(::flatbuffers::Offset<::flatbuffers::String> priority) {
    fbb_.AddOffset(CollectRequest_Full::VT_PRIORITY, priority);
  }
  void add_taskCategory(int32_t taskCategory) {
    fbb_.AddElement<int32_t>(CollectRequest_Full::VT_TASKCATEGORY, taskCategory, 0);
  }
  void add_suffix(::flatbuffers::Offset<::flatbuffers::String> suffix) {
    fbb_.AddOffset(CollectRequest_Full::VT_SUFFIX, suffix);
  }
  void add_uctFollowUp(bool uctFollowUp) {
    fbb_.AddElement<uint8_t>(CollectRequest_Full::VT_UCTFOLLOWUP, static_cast<uint8_t>(uctFollowUp), 0);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(CollectRequest_Full::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(CollectRequest_Full::VT_ENDTIME, endTime);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(CollectRequest_Full::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(CollectRequest_Full::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(CollectRequest_Full::VT_ORIGOBJECTID, origObjectId);
  }
  void add_taskGroup(::flatbuffers::Offset<::flatbuffers::String> taskGroup) {
    fbb_.AddOffset(CollectRequest_Full::VT_TASKGROUP, taskGroup);
  }
  void add_iron(int32_t iron) {
    fbb_.AddElement<int32_t>(CollectRequest_Full::VT_IRON, iron, 0);
  }
  void add_orbitRegime(::flatbuffers::Offset<::flatbuffers::String> orbitRegime) {
    fbb_.AddOffset(CollectRequest_Full::VT_ORBITREGIME, orbitRegime);
  }
  void add_targetSize(double targetSize) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_TARGETSIZE, targetSize, 0.0);
  }
  void add_rcsMin(double rcsMin) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_RCSMIN, rcsMin, 0.0);
  }
  void add_rcs(double rcs) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_RCS, rcs, 0.0);
  }
  void add_rcsMax(double rcsMax) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_RCSMAX, rcsMax, 0.0);
  }
  void add_freqMin(double freqMin) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_FREQMIN, freqMin, 0.0);
  }
  void add_freq(double freq) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_FREQ, freq, 0.0);
  }
  void add_freqMax(double freqMax) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_FREQMAX, freqMax, 0.0);
  }
  void add_polarization(::flatbuffers::Offset<::flatbuffers::String> polarization) {
    fbb_.AddOffset(CollectRequest_Full::VT_POLARIZATION, polarization);
  }
  void add_visMagMin(double visMagMin) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_VISMAGMIN, visMagMin, 0.0);
  }
  void add_visMag(double visMag) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_VISMAG, visMag, 0.0);
  }
  void add_visMagMax(double visMagMax) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_VISMAGMAX, visMagMax, 0.0);
  }
  void add_spectralModel(::flatbuffers::Offset<::flatbuffers::String> spectralModel) {
    fbb_.AddOffset(CollectRequest_Full::VT_SPECTRALMODEL, spectralModel);
  }
  void add_reflectance(double reflectance) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_REFLECTANCE, reflectance, 0.0);
  }
  void add_irradiance(double irradiance) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_IRRADIANCE, irradiance, 0.0);
  }
  void add_numFrames(int32_t numFrames) {
    fbb_.AddElement<int32_t>(CollectRequest_Full::VT_NUMFRAMES, numFrames, 0);
  }
  void add_frameRate(double frameRate) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_FRAMERATE, frameRate, 0.0);
  }
  void add_integrationTime(double integrationTime) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_INTEGRATIONTIME, integrationTime, 0.0);
  }
  void add_numTracks(int32_t numTracks) {
    fbb_.AddElement<int32_t>(CollectRequest_Full::VT_NUMTRACKS, numTracks, 0);
  }
  void add_numObs(int32_t numObs) {
    fbb_.AddElement<int32_t>(CollectRequest_Full::VT_NUMOBS, numObs, 0);
  }
  void add_duration(int32_t duration) {
    fbb_.AddElement<int32_t>(CollectRequest_Full::VT_DURATION, duration, 0);
  }
  void add_srchPattern(::flatbuffers::Offset<::flatbuffers::String> srchPattern) {
    fbb_.AddOffset(CollectRequest_Full::VT_SRCHPATTERN, srchPattern);
  }
  void add_scenario(::flatbuffers::Offset<::flatbuffers::String> scenario) {
    fbb_.AddOffset(CollectRequest_Full::VT_SCENARIO, scenario);
  }
  void add_idElset(::flatbuffers::Offset<::flatbuffers::String> idElset) {
    fbb_.AddOffset(CollectRequest_Full::VT_IDELSET, idElset);
  }
  void add_idManifold(::flatbuffers::Offset<::flatbuffers::String> idManifold) {
    fbb_.AddOffset(CollectRequest_Full::VT_IDMANIFOLD, idManifold);
  }
  void add_idStateVector(::flatbuffers::Offset<::flatbuffers::String> idStateVector) {
    fbb_.AddOffset(CollectRequest_Full::VT_IDSTATEVECTOR, idStateVector);
  }
  void add_esId(::flatbuffers::Offset<::flatbuffers::String> esId) {
    fbb_.AddOffset(CollectRequest_Full::VT_ESID, esId);
  }
  void add_epoch(::flatbuffers::Offset<::flatbuffers::String> epoch) {
    fbb_.AddOffset(CollectRequest_Full::VT_EPOCH, epoch);
  }
  void add_semiMajorAxis(double semiMajorAxis) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_SEMIMAJORAXIS, semiMajorAxis, 0.0);
  }
  void add_eccentricity(double eccentricity) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_ECCENTRICITY, eccentricity, 0.0);
  }
  void add_inclination(double inclination) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_INCLINATION, inclination, 0.0);
  }
  void add_raan(double raan) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_RAAN, raan, 0.0);
  }
  void add_argOfPerigee(double argOfPerigee) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_ARGOFPERIGEE, argOfPerigee, 0.0);
  }
  void add_trueAnomoly(double trueAnomoly) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_TRUEANOMOLY, trueAnomoly, 0.0);
  }
  void add_ra(double ra) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_RA, ra, 0.0);
  }
  void add_dec(double dec) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_DEC, dec, 0.0);
  }
  void add_az(double az) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_AZ, az, 0.0);
  }
  void add_el(double el) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_EL, el, 0.0);
  }
  void add_range(double range) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_RANGE, range, 0.0);
  }
  void add_extentAz(double extentAz) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_EXTENTAZ, extentAz, 0.0);
  }
  void add_extentEl(double extentEl) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_EXTENTEL, extentEl, 0.0);
  }
  void add_extentRange(double extentRange) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_EXTENTRANGE, extentRange, 0.0);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_LON, lon, 0.0);
  }
  void add_alt(double alt) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_ALT, alt, 0.0);
  }
  void add_stopLat(double stopLat) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_STOPLAT, stopLat, 0.0);
  }
  void add_stopLon(double stopLon) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_STOPLON, stopLon, 0.0);
  }
  void add_stopAlt(double stopAlt) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_STOPALT, stopAlt, 0.0);
  }
  void add_srchInc(double srchInc) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_SRCHINC, srchInc, 0.0);
  }
  void add_xAngle(double xAngle) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_XANGLE, xAngle, 0.0);
  }
  void add_yAngle(double yAngle) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_YANGLE, yAngle, 0.0);
  }
  void add_orientAngle(double orientAngle) {
    fbb_.AddElement<double>(CollectRequest_Full::VT_ORIENTANGLE, orientAngle, 0.0);
  }
  void add_customer(::flatbuffers::Offset<::flatbuffers::String> customer) {
    fbb_.AddOffset(CollectRequest_Full::VT_CUSTOMER, customer);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(CollectRequest_Full::VT_NOTES, notes);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(CollectRequest_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(CollectRequest_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(CollectRequest_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(CollectRequest_Full::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(CollectRequest_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(CollectRequest_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(CollectRequest_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(CollectRequest_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(CollectRequest_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_stateVector(::flatbuffers::Offset<::flatbuffers::String> stateVector) {
    fbb_.AddOffset(CollectRequest_Full::VT_STATEVECTOR, stateVector);
  }
  void add_elset(::flatbuffers::Offset<::flatbuffers::String> elset) {
    fbb_.AddOffset(CollectRequest_Full::VT_ELSET, elset);
  }
  void add_onOrbit(::flatbuffers::Offset<::flatbuffers::String> onOrbit) {
    fbb_.AddOffset(CollectRequest_Full::VT_ONORBIT, onOrbit);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(CollectRequest_Full::VT_TAGS, tags);
  }
  void add_collectResponse(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> collectResponse) {
    fbb_.AddOffset(CollectRequest_Full::VT_COLLECTRESPONSE, collectResponse);
  }
  explicit CollectRequest_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<CollectRequest_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<CollectRequest_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<CollectRequest_Full> CreateCollectRequest_Full(
    ...
    CollectRequest_Full_dataMode_Enum dataMode = CollectRequest_Full_dataMode_Enum_REAL,
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> collectResponse = 0) {
  CollectRequest_FullBuilder builder_(_fbb);
  ...
  builder_.add_collectResponse(collectResponse);
...
inline ::flatbuffers::Offset<CollectRequest_Full> CreateCollectRequest_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ...
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *collectResponse = nullptr) {
  ...
  auto collectResponse__ = collectResponse ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*collectResponse) : 0;
...
inline const CollectRequest_Full *GetCollectRequest_Full(const void *buf) {
  return ::flatbuffers::GetRoot<CollectRequest_Full>(buf);
}

inline const CollectRequest_Full *GetSizePrefixedCollectRequest_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<CollectRequest_Full>(buf);
}

inline const char *CollectRequest_FullIdentifier() {
  return "COLL";
}

inline bool CollectRequest_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, CollectRequest_FullIdentifier());
}

inline bool SizePrefixedCollectRequest_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, CollectRequest_FullIdentifier(), true);
}

inline bool VerifyCollectRequest_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<CollectRequest_Full>(CollectRequest_FullIdentifier());
}

inline bool VerifySizePrefixedCollectRequest_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<CollectRequest_Full>(CollectRequest_FullIdentifier());
}

inline void FinishCollectRequest_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<CollectRequest_Full> root) {
  fbb.Finish(root, CollectRequest_FullIdentifier());
}

inline void FinishSizePrefixedCollectRequest_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<CollectRequest_Full> root) {
  fbb.FinishSizePrefixed(root, CollectRequest_FullIdentifier());
}
