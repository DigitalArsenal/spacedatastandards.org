...
struct PersonnelRecovery_Ingest;
struct PersonnelRecovery_IngestBuilder;

enum PersonnelRecovery_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  PersonnelRecovery_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  PersonnelRecovery_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  PersonnelRecovery_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  PersonnelRecovery_Ingest_dataMode_Enum_EXERCISE = 3,
  PersonnelRecovery_Ingest_dataMode_Enum_MIN = PersonnelRecovery_Ingest_dataMode_Enum_REAL,
  PersonnelRecovery_Ingest_dataMode_Enum_MAX = PersonnelRecovery_Ingest_dataMode_Enum_EXERCISE
};

inline const PersonnelRecovery_Ingest_dataMode_Enum (&EnumValuesPersonnelRecovery_Ingest_dataMode_Enum())[4] {
  static const PersonnelRecovery_Ingest_dataMode_Enum values[] = {
    PersonnelRecovery_Ingest_dataMode_Enum_REAL,
    PersonnelRecovery_Ingest_dataMode_Enum_TEST,
    PersonnelRecovery_Ingest_dataMode_Enum_SIMULATED,
    PersonnelRecovery_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesPersonnelRecovery_Ingest_dataMode_Enum() {
...
inline const char *EnumNamePersonnelRecovery_Ingest_dataMode_Enum(PersonnelRecovery_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, PersonnelRecovery_Ingest_dataMode_Enum_REAL, PersonnelRecovery_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesPersonnelRecovery_Ingest_dataMode_Enum()[index];
}

/// /// Provides information concerning search and rescue operations and other situations involving personnel recovery.
struct PersonnelRecovery_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef PersonnelRecovery_IngestBuilder Builder;
  ...
  PersonnelRecovery_Ingest_dataMode_Enum dataMode() const {
    return static_cast<PersonnelRecovery_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct PersonnelRecovery_IngestBuilder {
  typedef PersonnelRecovery_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_TYPE, type);
  }
  void add_msgTime(::flatbuffers::Offset<::flatbuffers::String> msgTime) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_MSGTIME, msgTime);
  }
  void add_recovId(::flatbuffers::Offset<::flatbuffers::String> recovId) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_RECOVID, recovId);
  }
  void add_idWeatherReport(::flatbuffers::Offset<::flatbuffers::String> idWeatherReport) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_IDWEATHERREPORT, idWeatherReport);
  }
  void add_pickupLat(double pickupLat) {
    fbb_.AddElement<double>(PersonnelRecovery_Ingest::VT_PICKUPLAT, pickupLat, 0.0);
  }
  void add_pickupLon(double pickupLon) {
    fbb_.AddElement<double>(PersonnelRecovery_Ingest::VT_PICKUPLON, pickupLon, 0.0);
  }
  void add_pickupAlt(double pickupAlt) {
    fbb_.AddElement<double>(PersonnelRecovery_Ingest::VT_PICKUPALT, pickupAlt, 0.0);
  }
  void add_termInd(bool termInd) {
    fbb_.AddElement<uint8_t>(PersonnelRecovery_Ingest::VT_TERMIND, static_cast<uint8_t>(termInd), 0);
  }
  void add_authStatus(::flatbuffers::Offset<::flatbuffers::String> authStatus) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_AUTHSTATUS, authStatus);
  }
  void add_numPersons(int32_t numPersons) {
    fbb_.AddElement<int32_t>(PersonnelRecovery_Ingest::VT_NUMPERSONS, numPersons, 0);
  }
  void add_milClass(::flatbuffers::Offset<::flatbuffers::String> milClass) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_MILCLASS, milClass);
  }
  void add_natAlliance(int32_t natAlliance) {
    fbb_.AddElement<int32_t>(PersonnelRecovery_Ingest::VT_NATALLIANCE, natAlliance, 0);
  }
  void add_natAlliance1(int32_t natAlliance1) {
    fbb_.AddElement<int32_t>(PersonnelRecovery_Ingest::VT_NATALLIANCE1, natAlliance1, 0);
  }
  void add_identity(::flatbuffers::Offset<::flatbuffers::String> identity) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_IDENTITY, identity);
  }
  void add_commEq1(::flatbuffers::Offset<::flatbuffers::String> commEq1) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_COMMEQ1, commEq1);
  }
  void add_commEq2(::flatbuffers::Offset<::flatbuffers::String> commEq2) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_COMMEQ2, commEq2);
  }
  void add_commEq3(::flatbuffers::Offset<::flatbuffers::String> commEq3) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_COMMEQ3, commEq3);
  }
  void add_txFreq(double txFreq) {
    fbb_.AddElement<double>(PersonnelRecovery_Ingest::VT_TXFREQ, txFreq, 0.0);
  }
  void add_rxFreq(double rxFreq) {
    fbb_.AddElement<double>(PersonnelRecovery_Ingest::VT_RXFREQ, rxFreq, 0.0);
  }
  void add_numNonAmbulatory(int32_t numNonAmbulatory) {
    fbb_.AddElement<int32_t>(PersonnelRecovery_Ingest::VT_NUMNONAMBULATORY, numNonAmbulatory, 0);
  }
  void add_numAmbulatory(int32_t numAmbulatory) {
    fbb_.AddElement<int32_t>(PersonnelRecovery_Ingest::VT_NUMAMBULATORY, numAmbulatory, 0);
  }
  void add_numAmbulatoryInjured(int32_t numAmbulatoryInjured) {
    fbb_.AddElement<int32_t>(PersonnelRecovery_Ingest::VT_NUMAMBULATORYINJURED, numAmbulatoryInjured, 0);
  }
  void add_survivorRadio(::flatbuffers::Offset<::flatbuffers::String> survivorRadio) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_SURVIVORRADIO, survivorRadio);
  }
  void add_survivorMessages(::flatbuffers::Offset<::flatbuffers::String> survivorMessages) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_SURVIVORMESSAGES, survivorMessages);
  }
  void add_beaconInd(bool beaconInd) {
    fbb_.AddElement<uint8_t>(PersonnelRecovery_Ingest::VT_BEACONIND, static_cast<uint8_t>(beaconInd), 0);
  }
  void add_callSign(::flatbuffers::Offset<::flatbuffers::String> callSign) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_CALLSIGN, callSign);
  }
  void add_textMsg(::flatbuffers::Offset<::flatbuffers::String> textMsg) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_TEXTMSG, textMsg);
  }
  void add_authMethod(::flatbuffers::Offset<::flatbuffers::String> authMethod) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_AUTHMETHOD, authMethod);
  }
  void add_objectiveAreaInfo(::flatbuffers::Offset<::flatbuffers::String> objectiveAreaInfo) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_OBJECTIVEAREAINFO, objectiveAreaInfo);
  }
  void add_executionInfo(::flatbuffers::Offset<::flatbuffers::String> executionInfo) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_EXECUTIONINFO, executionInfo);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(PersonnelRecovery_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(PersonnelRecovery_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(PersonnelRecovery_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit PersonnelRecovery_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<PersonnelRecovery_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<PersonnelRecovery_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<PersonnelRecovery_Ingest> CreatePersonnelRecovery_Ingest(
    ...
    PersonnelRecovery_Ingest_dataMode_Enum dataMode = PersonnelRecovery_Ingest_dataMode_Enum_REAL) {
  PersonnelRecovery_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<PersonnelRecovery_Ingest> CreatePersonnelRecovery_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const PersonnelRecovery_Ingest *GetPersonnelRecovery_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<PersonnelRecovery_Ingest>(buf);
}

inline const PersonnelRecovery_Ingest *GetSizePrefixedPersonnelRecovery_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<PersonnelRecovery_Ingest>(buf);
}

inline const char *PersonnelRecovery_IngestIdentifier() {
  return "PERS";
}

inline bool PersonnelRecovery_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, PersonnelRecovery_IngestIdentifier());
}

inline bool SizePrefixedPersonnelRecovery_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, PersonnelRecovery_IngestIdentifier(), true);
}

inline bool VerifyPersonnelRecovery_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<PersonnelRecovery_Ingest>(PersonnelRecovery_IngestIdentifier());
}

inline bool VerifySizePrefixedPersonnelRecovery_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<PersonnelRecovery_Ingest>(PersonnelRecovery_IngestIdentifier());
}

inline void FinishPersonnelRecovery_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<PersonnelRecovery_Ingest> root) {
  fbb.Finish(root, PersonnelRecovery_IngestIdentifier());
}

inline void FinishSizePrefixedPersonnelRecovery_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<PersonnelRecovery_Ingest> root) {
  fbb.FinishSizePrefixed(root, PersonnelRecovery_IngestIdentifier());
}
