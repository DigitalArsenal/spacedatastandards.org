...
struct PassiveRadarObservation_Abridged;
struct PassiveRadarObservation_AbridgedBuilder;

enum PassiveRadarObservation_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  PassiveRadarObservation_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  PassiveRadarObservation_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  PassiveRadarObservation_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  PassiveRadarObservation_Abridged_dataMode_Enum_EXERCISE = 3,
  PassiveRadarObservation_Abridged_dataMode_Enum_MIN = PassiveRadarObservation_Abridged_dataMode_Enum_REAL,
  PassiveRadarObservation_Abridged_dataMode_Enum_MAX = PassiveRadarObservation_Abridged_dataMode_Enum_EXERCISE
};

inline const PassiveRadarObservation_Abridged_dataMode_Enum (&EnumValuesPassiveRadarObservation_Abridged_dataMode_Enum())[4] {
  static const PassiveRadarObservation_Abridged_dataMode_Enum values[] = {
    PassiveRadarObservation_Abridged_dataMode_Enum_REAL,
    PassiveRadarObservation_Abridged_dataMode_Enum_TEST,
    PassiveRadarObservation_Abridged_dataMode_Enum_SIMULATED,
    PassiveRadarObservation_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesPassiveRadarObservation_Abridged_dataMode_Enum() {
...
inline const char *EnumNamePassiveRadarObservation_Abridged_dataMode_Enum(PassiveRadarObservation_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, PassiveRadarObservation_Abridged_dataMode_Enum_REAL, PassiveRadarObservation_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesPassiveRadarObservation_Abridged_dataMode_Enum()[index];
}
...
struct PassiveRadarObservation_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef PassiveRadarObservation_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  PassiveRadarObservation_Abridged_dataMode_Enum dataMode() const {
    return static_cast<PassiveRadarObservation_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct PassiveRadarObservation_AbridgedBuilder {
  typedef PassiveRadarObservation_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_obTime(::flatbuffers::Offset<::flatbuffers::String> obTime) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_OBTIME, obTime);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(PassiveRadarObservation_Abridged::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_ORIGOBJECTID, origObjectId);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_ORIGSENSORID, origSensorId);
  }
  void add_idRFEmitter(::flatbuffers::Offset<::flatbuffers::String> idRFEmitter) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_IDRFEMITTER, idRFEmitter);
  }
  void add_idSensorRefReceiver(::flatbuffers::Offset<::flatbuffers::String> idSensorRefReceiver) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_IDSENSORREFRECEIVER, idSensorRefReceiver);
  }
  void add_extObservationId(::flatbuffers::Offset<::flatbuffers::String> extObservationId) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_EXTOBSERVATIONID, extObservationId);
  }
  void add_taskId(::flatbuffers::Offset<::flatbuffers::String> taskId) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_TASKID, taskId);
  }
  void add_trackId(::flatbuffers::Offset<::flatbuffers::String> trackId) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_TRACKID, trackId);
  }
  void add_obPosition(::flatbuffers::Offset<::flatbuffers::String> obPosition) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_OBPOSITION, obPosition);
  }
  void add_uct(bool uct) {
    fbb_.AddElement<uint8_t>(PassiveRadarObservation_Abridged::VT_UCT, static_cast<uint8_t>(uct), 0);
  }
  void add_azimuth(double azimuth) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_AZIMUTH, azimuth, 0.0);
  }
  void add_azimuthUnc(double azimuthUnc) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_AZIMUTHUNC, azimuthUnc, 0.0);
  }
  void add_azimuthBias(double azimuthBias) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_AZIMUTHBIAS, azimuthBias, 0.0);
  }
  void add_azimuthRate(double azimuthRate) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_AZIMUTHRATE, azimuthRate, 0.0);
  }
  void add_elevation(double elevation) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_ELEVATION, elevation, 0.0);
  }
  void add_elevationUnc(double elevationUnc) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_ELEVATIONUNC, elevationUnc, 0.0);
  }
  void add_elevationBias(double elevationBias) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_ELEVATIONBIAS, elevationBias, 0.0);
  }
  void add_elevationRate(double elevationRate) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_ELEVATIONRATE, elevationRate, 0.0);
  }
  void add_delay(double delay) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_DELAY, delay, 0.0);
  }
  void add_delayUnc(double delayUnc) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_DELAYUNC, delayUnc, 0.0);
  }
  void add_delayBias(double delayBias) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_DELAYBIAS, delayBias, 0.0);
  }
  void add_bistaticRange(double bistaticRange) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_BISTATICRANGE, bistaticRange, 0.0);
  }
  void add_bistaticRangeUnc(double bistaticRangeUnc) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_BISTATICRANGEUNC, bistaticRangeUnc, 0.0);
  }
  void add_bistaticRangeBias(double bistaticRangeBias) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_BISTATICRANGEBIAS, bistaticRangeBias, 0.0);
  }
  void add_bistaticRangeRate(double bistaticRangeRate) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_BISTATICRANGERATE, bistaticRangeRate, 0.0);
  }
  void add_bistaticRangeRateUnc(double bistaticRangeRateUnc) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_BISTATICRANGERATEUNC, bistaticRangeRateUnc, 0.0);
  }
  void add_bistaticRangeAccel(double bistaticRangeAccel) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_BISTATICRANGEACCEL, bistaticRangeAccel, 0.0);
  }
  void add_bistaticRangeAccelUnc(double bistaticRangeAccelUnc) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_BISTATICRANGEACCELUNC, bistaticRangeAccelUnc, 0.0);
  }
  void add_doppler(double doppler) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_DOPPLER, doppler, 0.0);
  }
  void add_dopplerUnc(double dopplerUnc) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_DOPPLERUNC, dopplerUnc, 0.0);
  }
  void add_coning(double coning) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_CONING, coning, 0.0);
  }
  void add_coningUnc(double coningUnc) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_CONINGUNC, coningUnc, 0.0);
  }
  void add_tof(double tof) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_TOF, tof, 0.0);
  }
  void add_tofUnc(double tofUnc) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_TOFUNC, tofUnc, 0.0);
  }
  void add_tofBias(double tofBias) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_TOFBIAS, tofBias, 0.0);
  }
  void add_accel(double accel) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_ACCEL, accel, 0.0);
  }
  void add_accelUnc(double accelUnc) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_ACCELUNC, accelUnc, 0.0);
  }
  void add_ra(double ra) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_RA, ra, 0.0);
  }
  void add_declination(double declination) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_DECLINATION, declination, 0.0);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_LON, lon, 0.0);
  }
  void add_alt(double alt) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_ALT, alt, 0.0);
  }
  void add_xvel(double xvel) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_XVEL, xvel, 0.0);
  }
  void add_yvel(double yvel) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_YVEL, yvel, 0.0);
  }
  void add_zvel(double zvel) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_ZVEL, zvel, 0.0);
  }
  void add_rcs(double rcs) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_RCS, rcs, 0.0);
  }
  void add_rcsUnc(double rcsUnc) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_RCSUNC, rcsUnc, 0.0);
  }
  void add_orthogonalRcs(double orthogonalRcs) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_ORTHOGONALRCS, orthogonalRcs, 0.0);
  }
  void add_orthogonalRcsUnc(double orthogonalRcsUnc) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_ORTHOGONALRCSUNC, orthogonalRcsUnc, 0.0);
  }
  void add_snr(double snr) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_SNR, snr, 0.0);
  }
  void add_timingBias(double timingBias) {
    fbb_.AddElement<double>(PassiveRadarObservation_Abridged::VT_TIMINGBIAS, timingBias, 0.0);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_TRANSACTIONID, transactionId);
  }
  void add_descriptor(::flatbuffers::Offset<::flatbuffers::String> descriptor) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_DESCRIPTOR, descriptor);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_dataMode(PassiveRadarObservation_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(PassiveRadarObservation_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(PassiveRadarObservation_Abridged::VT_TYPE, type);
  }
  explicit PassiveRadarObservation_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<PassiveRadarObservation_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<PassiveRadarObservation_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<PassiveRadarObservation_Abridged> CreatePassiveRadarObservation_Abridged(
    ...
    PassiveRadarObservation_Abridged_dataMode_Enum dataMode = PassiveRadarObservation_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> type = 0) {
  PassiveRadarObservation_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<PassiveRadarObservation_Abridged> CreatePassiveRadarObservation_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreatePassiveRadarObservation_Abridged(
      _fbb,
      id__,
...
inline const PassiveRadarObservation_Abridged *GetPassiveRadarObservation_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<PassiveRadarObservation_Abridged>(buf);
}

inline const PassiveRadarObservation_Abridged *GetSizePrefixedPassiveRadarObservation_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<PassiveRadarObservation_Abridged>(buf);
}

inline const char *PassiveRadarObservation_AbridgedIdentifier() {
  return "PASS";
}

inline bool PassiveRadarObservation_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, PassiveRadarObservation_AbridgedIdentifier());
}

inline bool SizePrefixedPassiveRadarObservation_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, PassiveRadarObservation_AbridgedIdentifier(), true);
}

inline bool VerifyPassiveRadarObservation_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<PassiveRadarObservation_Abridged>(PassiveRadarObservation_AbridgedIdentifier());
}

inline bool VerifySizePrefixedPassiveRadarObservation_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<PassiveRadarObservation_Abridged>(PassiveRadarObservation_AbridgedIdentifier());
}

inline void FinishPassiveRadarObservation_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<PassiveRadarObservation_Abridged> root) {
  fbb.Finish(root, PassiveRadarObservation_AbridgedIdentifier());
}

inline void FinishSizePrefixedPassiveRadarObservation_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<PassiveRadarObservation_Abridged> root) {
  fbb.FinishSizePrefixed(root, PassiveRadarObservation_AbridgedIdentifier());
}
