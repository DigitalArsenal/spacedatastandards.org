...
struct Item_Abridged;
struct Item_AbridgedBuilder;

enum Item_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Item_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Item_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Item_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Item_Abridged_dataMode_Enum_EXERCISE = 3,
  Item_Abridged_dataMode_Enum_MIN = Item_Abridged_dataMode_Enum_REAL,
  Item_Abridged_dataMode_Enum_MAX = Item_Abridged_dataMode_Enum_EXERCISE
};

inline const Item_Abridged_dataMode_Enum (&EnumValuesItem_Abridged_dataMode_Enum())[4] {
  static const Item_Abridged_dataMode_Enum values[] = {
    Item_Abridged_dataMode_Enum_REAL,
    Item_Abridged_dataMode_Enum_TEST,
    Item_Abridged_dataMode_Enum_SIMULATED,
    Item_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesItem_Abridged_dataMode_Enum() {
...
inline const char *EnumNameItem_Abridged_dataMode_Enum(Item_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Item_Abridged_dataMode_Enum_REAL, Item_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesItem_Abridged_dataMode_Enum()[index];
}

/// /// No description available.
struct Item_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Item_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Item_Abridged_dataMode_Enum dataMode() const {
    return static_cast<Item_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Item_AbridgedBuilder {
  typedef Item_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Item_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Item_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idAirLoadPlan(::flatbuffers::Offset<::flatbuffers::String> idAirLoadPlan) {
    fbb_.AddOffset(Item_Abridged::VT_IDAIRLOADPLAN, idAirLoadPlan);
  }
  void add_scanCode(::flatbuffers::Offset<::flatbuffers::String> scanCode) {
    fbb_.AddOffset(Item_Abridged::VT_SCANCODE, scanCode);
  }
  void add_scGenTool(::flatbuffers::Offset<::flatbuffers::String> scGenTool) {
    fbb_.AddOffset(Item_Abridged::VT_SCGENTOOL, scGenTool);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(Item_Abridged::VT_TYPE, type);
  }
  void add_cargoType(::flatbuffers::Offset<::flatbuffers::String> cargoType) {
    fbb_.AddOffset(Item_Abridged::VT_CARGOTYPE, cargoType);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(Item_Abridged::VT_NAME, name);
  }
  void add_destination(::flatbuffers::Offset<::flatbuffers::String> destination) {
    fbb_.AddOffset(Item_Abridged::VT_DESTINATION, destination);
  }
  void add_departure(::flatbuffers::Offset<::flatbuffers::String> departure) {
    fbb_.AddOffset(Item_Abridged::VT_DEPARTURE, departure);
  }
  void add_receivingUnit(::flatbuffers::Offset<::flatbuffers::String> receivingUnit) {
    fbb_.AddOffset(Item_Abridged::VT_RECEIVINGUNIT, receivingUnit);
  }
  void add_receivingBranch(::flatbuffers::Offset<::flatbuffers::String> receivingBranch) {
    fbb_.AddOffset(Item_Abridged::VT_RECEIVINGBRANCH, receivingBranch);
  }
  void add_lastArrDate(::flatbuffers::Offset<::flatbuffers::String> lastArrDate) {
    fbb_.AddOffset(Item_Abridged::VT_LASTARRDATE, lastArrDate);
  }
  void add_uln(::flatbuffers::Offset<::flatbuffers::String> uln) {
    fbb_.AddOffset(Item_Abridged::VT_ULN, uln);
  }
  void add_weight(double weight) {
    fbb_.AddElement<double>(Item_Abridged::VT_WEIGHT, weight, 0.0);
  }
  void add_weightTS(::flatbuffers::Offset<::flatbuffers::String> weightTS) {
    fbb_.AddOffset(Item_Abridged::VT_WEIGHTTS, weightTS);
  }
  void add_commodityCode(::flatbuffers::Offset<::flatbuffers::String> commodityCode) {
    fbb_.AddOffset(Item_Abridged::VT_COMMODITYCODE, commodityCode);
  }
  void add_commoditySys(::flatbuffers::Offset<::flatbuffers::String> commoditySys) {
    fbb_.AddOffset(Item_Abridged::VT_COMMODITYSYS, commoditySys);
  }
  void add_productCode(::flatbuffers::Offset<::flatbuffers::String> productCode) {
    fbb_.AddOffset(Item_Abridged::VT_PRODUCTCODE, productCode);
  }
  void add_productSys(::flatbuffers::Offset<::flatbuffers::String> productSys) {
    fbb_.AddOffset(Item_Abridged::VT_PRODUCTSYS, productSys);
  }
  void add_width(double width) {
    fbb_.AddElement<double>(Item_Abridged::VT_WIDTH, width, 0.0);
  }
  void add_length(double length) {
    fbb_.AddElement<double>(Item_Abridged::VT_LENGTH, length, 0.0);
  }
  void add_height(double height) {
    fbb_.AddElement<double>(Item_Abridged::VT_HEIGHT, height, 0.0);
  }
  void add_volume(double volume) {
    fbb_.AddElement<double>(Item_Abridged::VT_VOLUME, volume, 0.0);
  }
  void add_cg(double cg) {
    fbb_.AddElement<double>(Item_Abridged::VT_CG, cg, 0.0);
  }
  void add_fs(double fs) {
    fbb_.AddElement<double>(Item_Abridged::VT_FS, fs, 0.0);
  }
  void add_centerlineOffset(double centerlineOffset) {
    fbb_.AddElement<double>(Item_Abridged::VT_CENTERLINEOFFSET, centerlineOffset, 0.0);
  }
  void add_moment(double moment) {
    fbb_.AddElement<double>(Item_Abridged::VT_MOMENT, moment, 0.0);
  }
  void add_airdrop(bool airdrop) {
    fbb_.AddElement<uint8_t>(Item_Abridged::VT_AIRDROP, static_cast<uint8_t>(airdrop), 0);
  }
  void add_tcn(::flatbuffers::Offset<::flatbuffers::String> tcn) {
    fbb_.AddOffset(Item_Abridged::VT_TCN, tcn);
  }
  void add_hazCodes(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> hazCodes) {
    fbb_.AddOffset(Item_Abridged::VT_HAZCODES, hazCodes);
  }
  void add_netExpWt(double netExpWt) {
    fbb_.AddElement<double>(Item_Abridged::VT_NETEXPWT, netExpWt, 0.0);
  }
  void add_container(bool container) {
    fbb_.AddElement<uint8_t>(Item_Abridged::VT_CONTAINER, static_cast<uint8_t>(container), 0);
  }
  void add_itemContains(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> itemContains) {
    fbb_.AddOffset(Item_Abridged::VT_ITEMCONTAINS, itemContains);
  }
  void add_numPalletPos(int32_t numPalletPos) {
    fbb_.AddElement<int32_t>(Item_Abridged::VT_NUMPALLETPOS, numPalletPos, 0);
  }
  void add_dvCode(::flatbuffers::Offset<::flatbuffers::String> dvCode) {
    fbb_.AddOffset(Item_Abridged::VT_DVCODE, dvCode);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(Item_Abridged::VT_NOTES, notes);
  }
  void add_keys(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> keys) {
    fbb_.AddOffset(Item_Abridged::VT_KEYS, keys);
  }
  void add_values(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> values) {
    fbb_.AddOffset(Item_Abridged::VT_VALUES, values);
  }
  void add_altDataFormat(::flatbuffers::Offset<::flatbuffers::String> altDataFormat) {
    fbb_.AddOffset(Item_Abridged::VT_ALTDATAFORMAT, altDataFormat);
  }
  void add_accSystem(::flatbuffers::Offset<::flatbuffers::String> accSystem) {
    fbb_.AddOffset(Item_Abridged::VT_ACCSYSTEM, accSystem);
  }
  void add_accSysNotes(::flatbuffers::Offset<::flatbuffers::String> accSysNotes) {
    fbb_.AddOffset(Item_Abridged::VT_ACCSYSNOTES, accSysNotes);
  }
  void add_accSysKeys(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> accSysKeys) {
    fbb_.AddOffset(Item_Abridged::VT_ACCSYSKEYS, accSysKeys);
  }
  void add_accSysValues(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> accSysValues) {
    fbb_.AddOffset(Item_Abridged::VT_ACCSYSVALUES, accSysValues);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Item_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Item_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(Item_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Item_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Item_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Item_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(Item_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Item_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit Item_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Item_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Item_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Item_Abridged> CreateItem_Abridged(
    ...
    Item_Abridged_dataMode_Enum dataMode = Item_Abridged_dataMode_Enum_REAL) {
  Item_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Item_Abridged> CreateItem_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Item_Abridged *GetItem_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<Item_Abridged>(buf);
}

inline const Item_Abridged *GetSizePrefixedItem_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Item_Abridged>(buf);
}

inline const char *Item_AbridgedIdentifier() {
  return "ITEM";
}

inline bool Item_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Item_AbridgedIdentifier());
}

inline bool SizePrefixedItem_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Item_AbridgedIdentifier(), true);
}

inline bool VerifyItem_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Item_Abridged>(Item_AbridgedIdentifier());
}

inline bool VerifySizePrefixedItem_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Item_Abridged>(Item_AbridgedIdentifier());
}

inline void FinishItem_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Item_Abridged> root) {
  fbb.Finish(root, Item_AbridgedIdentifier());
}

inline void FinishSizePrefixedItem_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Item_Abridged> root) {
  fbb.FinishSizePrefixed(root, Item_AbridgedIdentifier());
}
