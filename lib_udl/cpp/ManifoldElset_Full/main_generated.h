...
struct ManifoldElset_Full;
struct ManifoldElset_FullBuilder;

enum ManifoldElset_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  ManifoldElset_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  ManifoldElset_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  ManifoldElset_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  ManifoldElset_Full_dataMode_Enum_EXERCISE = 3,
  ManifoldElset_Full_dataMode_Enum_MIN = ManifoldElset_Full_dataMode_Enum_REAL,
  ManifoldElset_Full_dataMode_Enum_MAX = ManifoldElset_Full_dataMode_Enum_EXERCISE
};

inline const ManifoldElset_Full_dataMode_Enum (&EnumValuesManifoldElset_Full_dataMode_Enum())[4] {
  static const ManifoldElset_Full_dataMode_Enum values[] = {
    ManifoldElset_Full_dataMode_Enum_REAL,
    ManifoldElset_Full_dataMode_Enum_TEST,
    ManifoldElset_Full_dataMode_Enum_SIMULATED,
    ManifoldElset_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesManifoldElset_Full_dataMode_Enum() {
...
inline const char *EnumNameManifoldElset_Full_dataMode_Enum(ManifoldElset_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, ManifoldElset_Full_dataMode_Enum_REAL, ManifoldElset_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesManifoldElset_Full_dataMode_Enum()[index];
}
...
struct ManifoldElset_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef ManifoldElset_FullBuilder Builder;
  ...
  ManifoldElset_Full_dataMode_Enum dataMode() const {
    return static_cast<ManifoldElset_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct ManifoldElset_FullBuilder {
  typedef ManifoldElset_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(ManifoldElset_Full::VT_ID, id);
  }
  void add_idManifold(::flatbuffers::Offset<::flatbuffers::String> idManifold) {
    fbb_.AddOffset(ManifoldElset_Full::VT_IDMANIFOLD, idManifold);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(ManifoldElset_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_tmpSatNo(int32_t tmpSatNo) {
    fbb_.AddElement<int32_t>(ManifoldElset_Full::VT_TMPSATNO, tmpSatNo, 0);
  }
  void add_epoch(::flatbuffers::Offset<::flatbuffers::String> epoch) {
    fbb_.AddOffset(ManifoldElset_Full::VT_EPOCH, epoch);
  }
  void add_meanMotion(double meanMotion) {
    fbb_.AddElement<double>(ManifoldElset_Full::VT_MEANMOTION, meanMotion, 0.0);
  }
  void add_eccentricity(double eccentricity) {
    fbb_.AddElement<double>(ManifoldElset_Full::VT_ECCENTRICITY, eccentricity, 0.0);
  }
  void add_inclination(double inclination) {
    fbb_.AddElement<double>(ManifoldElset_Full::VT_INCLINATION, inclination, 0.0);
  }
  void add_raan(double raan) {
    fbb_.AddElement<double>(ManifoldElset_Full::VT_RAAN, raan, 0.0);
  }
  void add_argOfPerigee(double argOfPerigee) {
    fbb_.AddElement<double>(ManifoldElset_Full::VT_ARGOFPERIGEE, argOfPerigee, 0.0);
  }
  void add_meanAnomaly(double meanAnomaly) {
    fbb_.AddElement<double>(ManifoldElset_Full::VT_MEANANOMALY, meanAnomaly, 0.0);
  }
  void add_revNo(int32_t revNo) {
    fbb_.AddElement<int32_t>(ManifoldElset_Full::VT_REVNO, revNo, 0);
  }
  void add_bStar(double bStar) {
    fbb_.AddElement<double>(ManifoldElset_Full::VT_BSTAR, bStar, 0.0);
  }
  void add_meanMotionDot(double meanMotionDot) {
    fbb_.AddElement<double>(ManifoldElset_Full::VT_MEANMOTIONDOT, meanMotionDot, 0.0);
  }
  void add_meanMotionDDot(double meanMotionDDot) {
    fbb_.AddElement<double>(ManifoldElset_Full::VT_MEANMOTIONDDOT, meanMotionDDot, 0.0);
  }
  void add_semiMajorAxis(double semiMajorAxis) {
    fbb_.AddElement<double>(ManifoldElset_Full::VT_SEMIMAJORAXIS, semiMajorAxis, 0.0);
  }
  void add_period(double period) {
    fbb_.AddElement<double>(ManifoldElset_Full::VT_PERIOD, period, 0.0);
  }
  void add_apogee(double apogee) {
    fbb_.AddElement<double>(ManifoldElset_Full::VT_APOGEE, apogee, 0.0);
  }
  void add_perigee(double perigee) {
    fbb_.AddElement<double>(ManifoldElset_Full::VT_PERIGEE, perigee, 0.0);
  }
  void add_line1(::flatbuffers::Offset<::flatbuffers::String> line1) {
    fbb_.AddOffset(ManifoldElset_Full::VT_LINE1, line1);
  }
  void add_line2(::flatbuffers::Offset<::flatbuffers::String> line2) {
    fbb_.AddOffset(ManifoldElset_Full::VT_LINE2, line2);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(ManifoldElset_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(ManifoldElset_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(ManifoldElset_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(ManifoldElset_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(ManifoldElset_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(ManifoldElset_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(ManifoldElset_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(ManifoldElset_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(ManifoldElset_Full::VT_ORIGNETWORK, origNetwork);
  }
  explicit ManifoldElset_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<ManifoldElset_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<ManifoldElset_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<ManifoldElset_Full> CreateManifoldElset_Full(
    ...
    ManifoldElset_Full_dataMode_Enum dataMode = ManifoldElset_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  ManifoldElset_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<ManifoldElset_Full> CreateManifoldElset_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const ManifoldElset_Full *GetManifoldElset_Full(const void *buf) {
  return ::flatbuffers::GetRoot<ManifoldElset_Full>(buf);
}

inline const ManifoldElset_Full *GetSizePrefixedManifoldElset_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<ManifoldElset_Full>(buf);
}

inline const char *ManifoldElset_FullIdentifier() {
  return "MANI";
}

inline bool ManifoldElset_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ManifoldElset_FullIdentifier());
}

inline bool SizePrefixedManifoldElset_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ManifoldElset_FullIdentifier(), true);
}

inline bool VerifyManifoldElset_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<ManifoldElset_Full>(ManifoldElset_FullIdentifier());
}

inline bool VerifySizePrefixedManifoldElset_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<ManifoldElset_Full>(ManifoldElset_FullIdentifier());
}

inline void FinishManifoldElset_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ManifoldElset_Full> root) {
  fbb.Finish(root, ManifoldElset_FullIdentifier());
}

inline void FinishSizePrefixedManifoldElset_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ManifoldElset_Full> root) {
  fbb.FinishSizePrefixed(root, ManifoldElset_FullIdentifier());
}
