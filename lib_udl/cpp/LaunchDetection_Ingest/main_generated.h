...
struct LaunchDetection_Ingest;
struct LaunchDetection_IngestBuilder;

enum LaunchDetection_Ingest_dataMode_Enum : int8_t {
  ...
  LaunchDetection_Ingest_dataMode_Enum_MIN = LaunchDetection_Ingest_dataMode_Enum_REAL,
  LaunchDetection_Ingest_dataMode_Enum_MAX = LaunchDetection_Ingest_dataMode_Enum_EXERCISE
};

inline const LaunchDetection_Ingest_dataMode_Enum (&EnumValuesLaunchDetection_Ingest_dataMode_Enum())[4] {
  static const LaunchDetection_Ingest_dataMode_Enum values[] = {
    LaunchDetection_Ingest_dataMode_Enum_REAL,
    LaunchDetection_Ingest_dataMode_Enum_TEST,
    LaunchDetection_Ingest_dataMode_Enum_SIMULATED,
    LaunchDetection_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesLaunchDetection_Ingest_dataMode_Enum() {
...
inline const char *EnumNameLaunchDetection_Ingest_dataMode_Enum(LaunchDetection_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, LaunchDetection_Ingest_dataMode_Enum_REAL, LaunchDetection_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesLaunchDetection_Ingest_dataMode_Enum()[index];
}

/// /// Data to analyze launch detections.
struct LaunchDetection_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LaunchDetection_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  LaunchDetection_Ingest_dataMode_Enum dataMode() const {
    return static_cast<LaunchDetection_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct LaunchDetection_IngestBuilder {
  typedef LaunchDetection_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(LaunchDetection_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(LaunchDetection_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_launchTime(::flatbuffers::Offset<::flatbuffers::String> launchTime) {
    fbb_.AddOffset(LaunchDetection_Ingest::VT_LAUNCHTIME, launchTime);
  }
  void add_messageType(::flatbuffers::Offset<::flatbuffers::String> messageType) {
    fbb_.AddOffset(LaunchDetection_Ingest::VT_MESSAGETYPE, messageType);
  }
  void add_launchLatitude(double launchLatitude) {
    fbb_.AddElement<double>(LaunchDetection_Ingest::VT_LAUNCHLATITUDE, launchLatitude, 0.0);
  }
  void add_launchLongitude(double launchLongitude) {
    fbb_.AddElement<double>(LaunchDetection_Ingest::VT_LAUNCHLONGITUDE, launchLongitude, 0.0);
  }
  void add_launchAzimuth(double launchAzimuth) {
    fbb_.AddElement<double>(LaunchDetection_Ingest::VT_LAUNCHAZIMUTH, launchAzimuth, 0.0);
  }
  void add_raan(double raan) {
    fbb_.AddElement<double>(LaunchDetection_Ingest::VT_RAAN, raan, 0.0);
  }
  void add_inclination(double inclination) {
    fbb_.AddElement<double>(LaunchDetection_Ingest::VT_INCLINATION, inclination, 0.0);
  }
  void add_observationTime(::flatbuffers::Offset<::flatbuffers::String> observationTime) {
    fbb_.AddOffset(LaunchDetection_Ingest::VT_OBSERVATIONTIME, observationTime);
  }
  void add_observationLatitude(double observationLatitude) {
    fbb_.AddElement<double>(LaunchDetection_Ingest::VT_OBSERVATIONLATITUDE, observationLatitude, 0.0);
  }
  void add_observationLongitude(double observationLongitude) {
    fbb_.AddElement<double>(LaunchDetection_Ingest::VT_OBSERVATIONLONGITUDE, observationLongitude, 0.0);
  }
  void add_observationAltitude(double observationAltitude) {
    fbb_.AddElement<double>(LaunchDetection_Ingest::VT_OBSERVATIONALTITUDE, observationAltitude, 0.0);
  }
  void add_stereoFlag(bool stereoFlag) {
    fbb_.AddElement<uint8_t>(LaunchDetection_Ingest::VT_STEREOFLAG, static_cast<uint8_t>(stereoFlag), 0);
  }
  void add_highZenithAzimuth(bool highZenithAzimuth) {
    fbb_.AddElement<uint8_t>(LaunchDetection_Ingest::VT_HIGHZENITHAZIMUTH, static_cast<uint8_t>(highZenithAzimuth), 0);
  }
  void add_sequenceNumber(int32_t sequenceNumber) {
    fbb_.AddElement<int32_t>(LaunchDetection_Ingest::VT_SEQUENCENUMBER, sequenceNumber, 0);
  }
  void add_eventId(::flatbuffers::Offset<::flatbuffers::String> eventId) {
    fbb_.AddOffset(LaunchDetection_Ingest::VT_EVENTID, eventId);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(LaunchDetection_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(LaunchDetection_Ingest::VT_ORIGIN, origin);
  }
  void add_descriptor(::flatbuffers::Offset<::flatbuffers::String> descriptor) {
    fbb_.AddOffset(LaunchDetection_Ingest::VT_DESCRIPTOR, descriptor);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(LaunchDetection_Ingest::VT_TAGS, tags);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(LaunchDetection_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(LaunchDetection_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(LaunchDetection_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(LaunchDetection_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(LaunchDetection_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(LaunchDetection_Ingest::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(LaunchDetection_Ingest::VT_UPDATEDBY, updatedBy);
  }
  explicit LaunchDetection_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LaunchDetection_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LaunchDetection_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LaunchDetection_Ingest> CreateLaunchDetection_Ingest(
    ...
    LaunchDetection_Ingest_dataMode_Enum dataMode = LaunchDetection_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0,
    ::flatbuffers::Offset<::flatbuffers::String> updatedAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> updatedBy = 0) {
  LaunchDetection_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<LaunchDetection_Ingest> CreateLaunchDetection_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const LaunchDetection_Ingest *GetLaunchDetection_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<LaunchDetection_Ingest>(buf);
}

inline const LaunchDetection_Ingest *GetSizePrefixedLaunchDetection_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<LaunchDetection_Ingest>(buf);
}

inline const char *LaunchDetection_IngestIdentifier() {
  return "LAUN";
}

inline bool LaunchDetection_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LaunchDetection_IngestIdentifier());
}

inline bool SizePrefixedLaunchDetection_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LaunchDetection_IngestIdentifier(), true);
}

inline bool VerifyLaunchDetection_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<LaunchDetection_Ingest>(LaunchDetection_IngestIdentifier());
}

inline bool VerifySizePrefixedLaunchDetection_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<LaunchDetection_Ingest>(LaunchDetection_IngestIdentifier());
}

inline void FinishLaunchDetection_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LaunchDetection_Ingest> root) {
  fbb.Finish(root, LaunchDetection_IngestIdentifier());
}

inline void FinishSizePrefixedLaunchDetection_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LaunchDetection_Ingest> root) {
  fbb.FinishSizePrefixed(root, LaunchDetection_IngestIdentifier());
}
