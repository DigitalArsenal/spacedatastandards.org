...
struct AirEvent_Ingest;
struct AirEvent_IngestBuilder;

enum AirEvent_Ingest_dataMode_Enum : int8_t {
  ...
  AirEvent_Ingest_dataMode_Enum_MIN = AirEvent_Ingest_dataMode_Enum_REAL,
  AirEvent_Ingest_dataMode_Enum_MAX = AirEvent_Ingest_dataMode_Enum_EXERCISE
};

inline const AirEvent_Ingest_dataMode_Enum (&EnumValuesAirEvent_Ingest_dataMode_Enum())[4] {
  static const AirEvent_Ingest_dataMode_Enum values[] = {
    AirEvent_Ingest_dataMode_Enum_REAL,
    AirEvent_Ingest_dataMode_Enum_TEST,
    AirEvent_Ingest_dataMode_Enum_SIMULATED,
    AirEvent_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAirEvent_Ingest_dataMode_Enum() {
...
inline const char *EnumNameAirEvent_Ingest_dataMode_Enum(AirEvent_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AirEvent_Ingest_dataMode_Enum_REAL, AirEvent_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAirEvent_Ingest_dataMode_Enum()[index];
}

/// /// Information related to an air event (e.g. FUEL TRANSFER, AIR DROP) and the associated aircraft.
struct AirEvent_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirEvent_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  AirEvent_Ingest_dataMode_Enum dataMode() const {
    return static_cast<AirEvent_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AirEvent_IngestBuilder {
  typedef AirEvent_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AirEvent_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AirEvent_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(AirEvent_Ingest::VT_TYPE, type);
  }
  void add_idSortie(::flatbuffers::Offset<::flatbuffers::String> idSortie) {
    fbb_.AddOffset(AirEvent_Ingest::VT_IDSORTIE, idSortie);
  }
  void add_idMission(::flatbuffers::Offset<::flatbuffers::String> idMission) {
    fbb_.AddOffset(AirEvent_Ingest::VT_IDMISSION, idMission);
  }
  void add_externalAirEventId(::flatbuffers::Offset<::flatbuffers::String> externalAirEventId) {
    fbb_.AddOffset(AirEvent_Ingest::VT_EXTERNALAIREVENTID, externalAirEventId);
  }
  void add_legNum(int32_t legNum) {
    fbb_.AddElement<int32_t>(AirEvent_Ingest::VT_LEGNUM, legNum, 0);
  }
  void add_location(::flatbuffers::Offset<::flatbuffers::String> location) {
    fbb_.AddOffset(AirEvent_Ingest::VT_LOCATION, location);
  }
  void add_arrPurpose(::flatbuffers::Offset<::flatbuffers::String> arrPurpose) {
    fbb_.AddOffset(AirEvent_Ingest::VT_ARRPURPOSE, arrPurpose);
  }
  void add_plannedArrTime(::flatbuffers::Offset<::flatbuffers::String> plannedArrTime) {
    fbb_.AddOffset(AirEvent_Ingest::VT_PLANNEDARRTIME, plannedArrTime);
  }
  void add_estArrTime(::flatbuffers::Offset<::flatbuffers::String> estArrTime) {
    fbb_.AddOffset(AirEvent_Ingest::VT_ESTARRTIME, estArrTime);
  }
  void add_actualArrTime(::flatbuffers::Offset<::flatbuffers::String> actualArrTime) {
    fbb_.AddOffset(AirEvent_Ingest::VT_ACTUALARRTIME, actualArrTime);
  }
  void add_depPurpose(::flatbuffers::Offset<::flatbuffers::String> depPurpose) {
    fbb_.AddOffset(AirEvent_Ingest::VT_DEPPURPOSE, depPurpose);
  }
  void add_plannedDepTime(::flatbuffers::Offset<::flatbuffers::String> plannedDepTime) {
    fbb_.AddOffset(AirEvent_Ingest::VT_PLANNEDDEPTIME, plannedDepTime);
  }
  void add_estDepTime(::flatbuffers::Offset<::flatbuffers::String> estDepTime) {
    fbb_.AddOffset(AirEvent_Ingest::VT_ESTDEPTIME, estDepTime);
  }
  void add_actualDepTime(::flatbuffers::Offset<::flatbuffers::String> actualDepTime) {
    fbb_.AddOffset(AirEvent_Ingest::VT_ACTUALDEPTIME, actualDepTime);
  }
  void add_externalARTrackId(::flatbuffers::Offset<::flatbuffers::String> externalARTrackId) {
    fbb_.AddOffset(AirEvent_Ingest::VT_EXTERNALARTRACKID, externalARTrackId);
  }
  void add_arTrackId(::flatbuffers::Offset<::flatbuffers::String> arTrackId) {
    fbb_.AddOffset(AirEvent_Ingest::VT_ARTRACKID, arTrackId);
  }
  void add_arTrackName(::flatbuffers::Offset<::flatbuffers::String> arTrackName) {
    fbb_.AddOffset(AirEvent_Ingest::VT_ARTRACKNAME, arTrackName);
  }
  void add_rzct(::flatbuffers::Offset<::flatbuffers::String> rzct) {
    fbb_.AddOffset(AirEvent_Ingest::VT_RZCT, rzct);
  }
  void add_arct(::flatbuffers::Offset<::flatbuffers::String> arct) {
    fbb_.AddOffset(AirEvent_Ingest::VT_ARCT, arct);
  }
  void add_baseAlt(double baseAlt) {
    fbb_.AddElement<double>(AirEvent_Ingest::VT_BASEALT, baseAlt, 0.0);
  }
  void add_priority(::flatbuffers::Offset<::flatbuffers::String> priority) {
    fbb_.AddOffset(AirEvent_Ingest::VT_PRIORITY, priority);
  }
  void add_trackTime(double trackTime) {
    fbb_.AddElement<double>(AirEvent_Ingest::VT_TRACKTIME, trackTime, 0.0);
  }
  void add_statusCode(::flatbuffers::Offset<::flatbuffers::String> statusCode) {
    fbb_.AddOffset(AirEvent_Ingest::VT_STATUSCODE, statusCode);
  }
  void add_rzPoint(::flatbuffers::Offset<::flatbuffers::String> rzPoint) {
    fbb_.AddOffset(AirEvent_Ingest::VT_RZPOINT, rzPoint);
  }
  void add_rzType(::flatbuffers::Offset<::flatbuffers::String> rzType) {
    fbb_.AddOffset(AirEvent_Ingest::VT_RZTYPE, rzType);
  }
  void add_arEventType(::flatbuffers::Offset<::flatbuffers::String> arEventType) {
    fbb_.AddOffset(AirEvent_Ingest::VT_AREVENTTYPE, arEventType);
  }
  void add_numTankers(int32_t numTankers) {
    fbb_.AddElement<int32_t>(AirEvent_Ingest::VT_NUMTANKERS, numTankers, 0);
  }
  void add_revTrack(bool revTrack) {
    fbb_.AddElement<uint8_t>(AirEvent_Ingest::VT_REVTRACK, static_cast<uint8_t>(revTrack), 0);
  }
  void add_shortTrack(bool shortTrack) {
    fbb_.AddElement<uint8_t>(AirEvent_Ingest::VT_SHORTTRACK, static_cast<uint8_t>(shortTrack), 0);
  }
  void add_cancelled(bool cancelled) {
    fbb_.AddElement<uint8_t>(AirEvent_Ingest::VT_CANCELLED, static_cast<uint8_t>(cancelled), 0);
  }
  void add_tankers(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tankers) {
    fbb_.AddOffset(AirEvent_Ingest::VT_TANKERS, tankers);
  }
  void add_receivers(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> receivers) {
    fbb_.AddOffset(AirEvent_Ingest::VT_RECEIVERS, receivers);
  }
  void add_remarks(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> remarks) {
    fbb_.AddOffset(AirEvent_Ingest::VT_REMARKS, remarks);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AirEvent_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AirEvent_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(AirEvent_Ingest::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(AirEvent_Ingest::VT_UPDATEDBY, updatedBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(AirEvent_Ingest::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AirEvent_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AirEvent_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AirEvent_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(AirEvent_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AirEvent_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit AirEvent_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirEvent_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirEvent_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirEvent_Ingest> CreateAirEvent_Ingest(
    ...
    AirEvent_Ingest_dataMode_Enum dataMode = AirEvent_Ingest_dataMode_Enum_REAL) {
  AirEvent_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirEvent_Ingest> CreateAirEvent_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AirEvent_Ingest *GetAirEvent_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<AirEvent_Ingest>(buf);
}

inline const AirEvent_Ingest *GetSizePrefixedAirEvent_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirEvent_Ingest>(buf);
}

inline const char *AirEvent_IngestIdentifier() {
  return "AIRE";
}

inline bool AirEvent_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirEvent_IngestIdentifier());
}

inline bool SizePrefixedAirEvent_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirEvent_IngestIdentifier(), true);
}

inline bool VerifyAirEvent_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirEvent_Ingest>(AirEvent_IngestIdentifier());
}

inline bool VerifySizePrefixedAirEvent_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirEvent_Ingest>(AirEvent_IngestIdentifier());
}

inline void FinishAirEvent_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirEvent_Ingest> root) {
  fbb.Finish(root, AirEvent_IngestIdentifier());
}

inline void FinishSizePrefixedAirEvent_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirEvent_Ingest> root) {
  fbb.FinishSizePrefixed(root, AirEvent_IngestIdentifier());
}
