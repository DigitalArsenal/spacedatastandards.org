...
struct EventEvolution_Ingest;
struct EventEvolution_IngestBuilder;

enum EventEvolution_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  EventEvolution_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  EventEvolution_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  EventEvolution_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  EventEvolution_Ingest_dataMode_Enum_EXERCISE = 3,
  EventEvolution_Ingest_dataMode_Enum_MIN = EventEvolution_Ingest_dataMode_Enum_REAL,
  EventEvolution_Ingest_dataMode_Enum_MAX = EventEvolution_Ingest_dataMode_Enum_EXERCISE
};

inline const EventEvolution_Ingest_dataMode_Enum (&EnumValuesEventEvolution_Ingest_dataMode_Enum())[4] {
  static const EventEvolution_Ingest_dataMode_Enum values[] = {
    EventEvolution_Ingest_dataMode_Enum_REAL,
    EventEvolution_Ingest_dataMode_Enum_TEST,
    EventEvolution_Ingest_dataMode_Enum_SIMULATED,
    EventEvolution_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesEventEvolution_Ingest_dataMode_Enum() {
...
inline const char *EnumNameEventEvolution_Ingest_dataMode_Enum(EventEvolution_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, EventEvolution_Ingest_dataMode_Enum_REAL, EventEvolution_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEventEvolution_Ingest_dataMode_Enum()[index];
}
...
struct EventEvolution_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EventEvolution_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  EventEvolution_Ingest_dataMode_Enum dataMode() const {
    return static_cast<EventEvolution_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct EventEvolution_IngestBuilder {
  typedef EventEvolution_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_eventId(::flatbuffers::Offset<::flatbuffers::String> eventId) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_EVENTID, eventId);
  }
  void add_category(::flatbuffers::Offset<::flatbuffers::String> category) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_CATEGORY, category);
  }
  void add_summary(::flatbuffers::Offset<::flatbuffers::String> summary) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_SUMMARY, summary);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_ENDTIME, endTime);
  }
  void add_status(::flatbuffers::Offset<::flatbuffers::String> status) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_STATUS, status);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_COUNTRYCODE, countryCode);
  }
  void add_geoAdminLevel1(::flatbuffers::Offset<::flatbuffers::String> geoAdminLevel1) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_GEOADMINLEVEL1, geoAdminLevel1);
  }
  void add_geoAdminLevel2(::flatbuffers::Offset<::flatbuffers::String> geoAdminLevel2) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_GEOADMINLEVEL2, geoAdminLevel2);
  }
  void add_geoAdminLevel3(::flatbuffers::Offset<::flatbuffers::String> geoAdminLevel3) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_GEOADMINLEVEL3, geoAdminLevel3);
  }
  void add_redact(bool redact) {
    fbb_.AddElement<uint8_t>(EventEvolution_Ingest::VT_REDACT, static_cast<uint8_t>(redact), 0);
  }
  void add_srcTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcTyps) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_SRCTYPS, srcTyps);
  }
  void add_srcIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcIds) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_SRCIDS, srcIds);
  }
  void add_dataDescription(::flatbuffers::Offset<::flatbuffers::String> dataDescription) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_DATADESCRIPTION, dataDescription);
  }
  void add_area(::flatbuffers::Offset<::flatbuffers::String> area) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_AREA, area);
  }
  void add_atext(::flatbuffers::Offset<::flatbuffers::String> atext) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_ATEXT, atext);
  }
  void add_agjson(::flatbuffers::Offset<::flatbuffers::String> agjson) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_AGJSON, agjson);
  }
  void add_atype(::flatbuffers::Offset<::flatbuffers::String> atype) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_ATYPE, atype);
  }
  void add_andims(int32_t andims) {
    fbb_.AddElement<int32_t>(EventEvolution_Ingest::VT_ANDIMS, andims, 0);
  }
  void add_asrid(int32_t asrid) {
    fbb_.AddElement<int32_t>(EventEvolution_Ingest::VT_ASRID, asrid, 0);
  }
  void add_url(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> url) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_URL, url);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_TAGS, tags);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(EventEvolution_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(EventEvolution_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(EventEvolution_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit EventEvolution_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<EventEvolution_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<EventEvolution_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<EventEvolution_Ingest> CreateEventEvolution_Ingest(
    ...
    EventEvolution_Ingest_dataMode_Enum dataMode = EventEvolution_Ingest_dataMode_Enum_REAL) {
  EventEvolution_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<EventEvolution_Ingest> CreateEventEvolution_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const EventEvolution_Ingest *GetEventEvolution_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<EventEvolution_Ingest>(buf);
}

inline const EventEvolution_Ingest *GetSizePrefixedEventEvolution_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EventEvolution_Ingest>(buf);
}

inline const char *EventEvolution_IngestIdentifier() {
  return "EVEN";
}

inline bool EventEvolution_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EventEvolution_IngestIdentifier());
}

inline bool SizePrefixedEventEvolution_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EventEvolution_IngestIdentifier(), true);
}

inline bool VerifyEventEvolution_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EventEvolution_Ingest>(EventEvolution_IngestIdentifier());
}

inline bool VerifySizePrefixedEventEvolution_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EventEvolution_Ingest>(EventEvolution_IngestIdentifier());
}

inline void FinishEventEvolution_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EventEvolution_Ingest> root) {
  fbb.Finish(root, EventEvolution_IngestIdentifier());
}

inline void FinishSizePrefixedEventEvolution_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EventEvolution_Ingest> root) {
  fbb.FinishSizePrefixed(root, EventEvolution_IngestIdentifier());
}
