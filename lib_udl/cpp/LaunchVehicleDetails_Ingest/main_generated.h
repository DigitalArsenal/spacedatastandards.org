...
struct LaunchVehicleDetails_Ingest;
struct LaunchVehicleDetails_IngestBuilder;

enum LaunchVehicleDetails_Ingest_dataMode_Enum : int8_t {
  ...
  LaunchVehicleDetails_Ingest_dataMode_Enum_MIN = LaunchVehicleDetails_Ingest_dataMode_Enum_REAL,
  LaunchVehicleDetails_Ingest_dataMode_Enum_MAX = LaunchVehicleDetails_Ingest_dataMode_Enum_EXERCISE
};

inline const LaunchVehicleDetails_Ingest_dataMode_Enum (&EnumValuesLaunchVehicleDetails_Ingest_dataMode_Enum())[4] {
  static const LaunchVehicleDetails_Ingest_dataMode_Enum values[] = {
    LaunchVehicleDetails_Ingest_dataMode_Enum_REAL,
    LaunchVehicleDetails_Ingest_dataMode_Enum_TEST,
    LaunchVehicleDetails_Ingest_dataMode_Enum_SIMULATED,
    LaunchVehicleDetails_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesLaunchVehicleDetails_Ingest_dataMode_Enum() {
...
inline const char *EnumNameLaunchVehicleDetails_Ingest_dataMode_Enum(LaunchVehicleDetails_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, LaunchVehicleDetails_Ingest_dataMode_Enum_REAL, LaunchVehicleDetails_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesLaunchVehicleDetails_Ingest_dataMode_Enum()[index];
}
...
struct LaunchVehicleDetails_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LaunchVehicleDetails_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  LaunchVehicleDetails_Ingest_dataMode_Enum dataMode() const {
    return static_cast<LaunchVehicleDetails_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct LaunchVehicleDetails_IngestBuilder {
  typedef LaunchVehicleDetails_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_ID, id);
  }
  void add_idLaunchVehicle(::flatbuffers::Offset<::flatbuffers::String> idLaunchVehicle) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_IDLAUNCHVEHICLE, idLaunchVehicle);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_variant(::flatbuffers::Offset<::flatbuffers::String> variant) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_VARIANT, variant);
  }
  void add_minorVariant(::flatbuffers::Offset<::flatbuffers::String> minorVariant) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_MINORVARIANT, minorVariant);
  }
  void add_category(::flatbuffers::Offset<::flatbuffers::String> category) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_CATEGORY, category);
  }
  void add_manufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrgId) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_MANUFACTURERORGID, manufacturerOrgId);
  }
  void add_launchPrefix(::flatbuffers::Offset<::flatbuffers::String> launchPrefix) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_LAUNCHPREFIX, launchPrefix);
  }
  void add_family(::flatbuffers::Offset<::flatbuffers::String> family) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_FAMILY, family);
  }
  void add_propellant(::flatbuffers::Offset<::flatbuffers::String> propellant) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_PROPELLANT, propellant);
  }
  void add_oxidizer(::flatbuffers::Offset<::flatbuffers::String> oxidizer) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_OXIDIZER, oxidizer);
  }
  void add_length(double length) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_LENGTH, length, 0.0);
  }
  void add_diameter(double diameter) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_DIAMETER, diameter, 0.0);
  }
  void add_launchMass(double launchMass) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_LAUNCHMASS, launchMass, 0.0);
  }
  void add_geoPayloadMass(double geoPayloadMass) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_GEOPAYLOADMASS, geoPayloadMass, 0.0);
  }
  void add_gtoPayloadMass(double gtoPayloadMass) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_GTOPAYLOADMASS, gtoPayloadMass, 0.0);
  }
  void add_leoPayloadMass(double leoPayloadMass) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_LEOPAYLOADMASS, leoPayloadMass, 0.0);
  }
  void add_ssoPayloadMass(double ssoPayloadMass) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_SSOPAYLOADMASS, ssoPayloadMass, 0.0);
  }
  void add_fairingLength(double fairingLength) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_FAIRINGLENGTH, fairingLength, 0.0);
  }
  void add_fairingName(::flatbuffers::Offset<::flatbuffers::String> fairingName) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_FAIRINGNAME, fairingName);
  }
  void add_fairingExternalDiameter(double fairingExternalDiameter) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_FAIRINGEXTERNALDIAMETER, fairingExternalDiameter, 0.0);
  }
  void add_fairingInternalDiameter(double fairingInternalDiameter) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_FAIRINGINTERNALDIAMETER, fairingInternalDiameter, 0.0);
  }
  void add_fairingMass(double fairingMass) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_FAIRINGMASS, fairingMass, 0.0);
  }
  void add_fairingMaterial(::flatbuffers::Offset<::flatbuffers::String> fairingMaterial) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_FAIRINGMATERIAL, fairingMaterial);
  }
  void add_maxAccelLoad(double maxAccelLoad) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_MAXACCELLOAD, maxAccelLoad, 0.0);
  }
  void add_maxPayloadFreqLat(double maxPayloadFreqLat) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_MAXPAYLOADFREQLAT, maxPayloadFreqLat, 0.0);
  }
  void add_maxPayloadFreqLon(double maxPayloadFreqLon) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_MAXPAYLOADFREQLON, maxPayloadFreqLon, 0.0);
  }
  void add_maxAcousticLevel(double maxAcousticLevel) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_MAXACOUSTICLEVEL, maxAcousticLevel, 0.0);
  }
  void add_maxAcousticLevelRange(double maxAcousticLevelRange) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_MAXACOUSTICLEVELRANGE, maxAcousticLevelRange, 0.0);
  }
  void add_soundPressureLevel(double soundPressureLevel) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_SOUNDPRESSURELEVEL, soundPressureLevel, 0.0);
  }
  void add_maxFlightShockForce(double maxFlightShockForce) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_MAXFLIGHTSHOCKFORCE, maxFlightShockForce, 0.0);
  }
  void add_maxFlightShockFreq(double maxFlightShockFreq) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_MAXFLIGHTSHOCKFREQ, maxFlightShockFreq, 0.0);
  }
  void add_maxFairingPressureChange(double maxFairingPressureChange) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_MAXFAIRINGPRESSURECHANGE, maxFairingPressureChange, 0.0);
  }
  void add_estLaunchPrice(double estLaunchPrice) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_ESTLAUNCHPRICE, estLaunchPrice, 0.0);
  }
  void add_estLaunchPriceTypical(double estLaunchPriceTypical) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_ESTLAUNCHPRICETYPICAL, estLaunchPriceTypical, 0.0);
  }
  void add_gtoInj3SigAccuracyApogeeTarget(double gtoInj3SigAccuracyApogeeTarget) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_GTOINJ3SIGACCURACYAPOGEETARGET, gtoInj3SigAccuracyApogeeTarget, 0.0);
  }
  void add_gtoInj3SigAccuracyApogeeMargin(double gtoInj3SigAccuracyApogeeMargin) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_GTOINJ3SIGACCURACYAPOGEEMARGIN, gtoInj3SigAccuracyApogeeMargin, 0.0);
  }
  void add_gtoInj3SigAccuracyPerigeeTarget(double gtoInj3SigAccuracyPerigeeTarget) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_GTOINJ3SIGACCURACYPERIGEETARGET, gtoInj3SigAccuracyPerigeeTarget, 0.0);
  }
  void add_gtoInj3SigAccuracyPerigeeMargin(double gtoInj3SigAccuracyPerigeeMargin) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_GTOINJ3SIGACCURACYPERIGEEMARGIN, gtoInj3SigAccuracyPerigeeMargin, 0.0);
  }
  void add_gtoInj3SigAccuracyInclinationTarget(double gtoInj3SigAccuracyInclinationTarget) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_GTOINJ3SIGACCURACYINCLINATIONTARGET, gtoInj3SigAccuracyInclinationTarget, 0.0);
  }
  void add_gtoInj3SigAccuracyInclinationMargin(double gtoInj3SigAccuracyInclinationMargin) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_GTOINJ3SIGACCURACYINCLINATIONMARGIN, gtoInj3SigAccuracyInclinationMargin, 0.0);
  }
  void add_attitudeAccuracy(double attitudeAccuracy) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_ATTITUDEACCURACY, attitudeAccuracy, 0.0);
  }
  void add_payloadSeparationRate(double payloadSeparationRate) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_PAYLOADSEPARATIONRATE, payloadSeparationRate, 0.0);
  }
  void add_deploymentRotationRate(double deploymentRotationRate) {
    fbb_.AddElement<double>(LaunchVehicleDetails_Ingest::VT_DEPLOYMENTROTATIONRATE, deploymentRotationRate, 0.0);
  }
  void add_sourceURL(::flatbuffers::Offset<::flatbuffers::String> sourceURL) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_SOURCEURL, sourceURL);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_NOTES, notes);
  }
  void add_fairingNotes(::flatbuffers::Offset<::flatbuffers::String> fairingNotes) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_FAIRINGNOTES, fairingNotes);
  }
  void add_payloadNotes(::flatbuffers::Offset<::flatbuffers::String> payloadNotes) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_PAYLOADNOTES, payloadNotes);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(LaunchVehicleDetails_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(LaunchVehicleDetails_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(LaunchVehicleDetails_Ingest::VT_TAGS, tags);
  }
  explicit LaunchVehicleDetails_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LaunchVehicleDetails_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LaunchVehicleDetails_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LaunchVehicleDetails_Ingest> CreateLaunchVehicleDetails_Ingest(
    ...
    LaunchVehicleDetails_Ingest_dataMode_Enum dataMode = LaunchVehicleDetails_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags = 0) {
  LaunchVehicleDetails_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<LaunchVehicleDetails_Ingest> CreateLaunchVehicleDetails_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const LaunchVehicleDetails_Ingest *GetLaunchVehicleDetails_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<LaunchVehicleDetails_Ingest>(buf);
}

inline const LaunchVehicleDetails_Ingest *GetSizePrefixedLaunchVehicleDetails_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<LaunchVehicleDetails_Ingest>(buf);
}

inline const char *LaunchVehicleDetails_IngestIdentifier() {
  return "LAUN";
}

inline bool LaunchVehicleDetails_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LaunchVehicleDetails_IngestIdentifier());
}

inline bool SizePrefixedLaunchVehicleDetails_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LaunchVehicleDetails_IngestIdentifier(), true);
}

inline bool VerifyLaunchVehicleDetails_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<LaunchVehicleDetails_Ingest>(LaunchVehicleDetails_IngestIdentifier());
}

inline bool VerifySizePrefixedLaunchVehicleDetails_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<LaunchVehicleDetails_Ingest>(LaunchVehicleDetails_IngestIdentifier());
}

inline void FinishLaunchVehicleDetails_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LaunchVehicleDetails_Ingest> root) {
  fbb.Finish(root, LaunchVehicleDetails_IngestIdentifier());
}

inline void FinishSizePrefixedLaunchVehicleDetails_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LaunchVehicleDetails_Ingest> root) {
  fbb.FinishSizePrefixed(root, LaunchVehicleDetails_IngestIdentifier());
}
