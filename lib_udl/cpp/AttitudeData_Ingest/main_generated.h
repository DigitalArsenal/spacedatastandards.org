...
struct AttitudeData_Ingest;
struct AttitudeData_IngestBuilder;

enum AttitudeData_Ingest_dataMode_Enum : int8_t {
  ...
  AttitudeData_Ingest_dataMode_Enum_MIN = AttitudeData_Ingest_dataMode_Enum_REAL,
  AttitudeData_Ingest_dataMode_Enum_MAX = AttitudeData_Ingest_dataMode_Enum_EXERCISE
};

inline const AttitudeData_Ingest_dataMode_Enum (&EnumValuesAttitudeData_Ingest_dataMode_Enum())[4] {
  static const AttitudeData_Ingest_dataMode_Enum values[] = {
    AttitudeData_Ingest_dataMode_Enum_REAL,
    AttitudeData_Ingest_dataMode_Enum_TEST,
    AttitudeData_Ingest_dataMode_Enum_SIMULATED,
    AttitudeData_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAttitudeData_Ingest_dataMode_Enum() {
...
inline const char *EnumNameAttitudeData_Ingest_dataMode_Enum(AttitudeData_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AttitudeData_Ingest_dataMode_Enum_REAL, AttitudeData_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAttitudeData_Ingest_dataMode_Enum()[index];
}
...
struct AttitudeData_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AttitudeData_IngestBuilder Builder;
  ...
  AttitudeData_Ingest_dataMode_Enum dataMode() const {
    return static_cast<AttitudeData_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AttitudeData_IngestBuilder {
  typedef AttitudeData_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_asId(::flatbuffers::Offset<::flatbuffers::String> asId) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_ASID, asId);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(AttitudeData_Ingest::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_ORIGOBJECTID, origObjectId);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::String> ts) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_TS, ts);
  }
  void add_motionType(::flatbuffers::Offset<::flatbuffers::String> motionType) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_MOTIONTYPE, motionType);
  }
  void add_q1(double q1) {
    fbb_.AddElement<double>(AttitudeData_Ingest::VT_Q1, q1, 0.0);
  }
  void add_q2(double q2) {
    fbb_.AddElement<double>(AttitudeData_Ingest::VT_Q2, q2, 0.0);
  }
  void add_q3(double q3) {
    fbb_.AddElement<double>(AttitudeData_Ingest::VT_Q3, q3, 0.0);
  }
  void add_qc(double qc) {
    fbb_.AddElement<double>(AttitudeData_Ingest::VT_QC, qc, 0.0);
  }
  void add_q1Dot(double q1Dot) {
    fbb_.AddElement<double>(AttitudeData_Ingest::VT_Q1DOT, q1Dot, 0.0);
  }
  void add_q2Dot(double q2Dot) {
    fbb_.AddElement<double>(AttitudeData_Ingest::VT_Q2DOT, q2Dot, 0.0);
  }
  void add_q3Dot(double q3Dot) {
    fbb_.AddElement<double>(AttitudeData_Ingest::VT_Q3DOT, q3Dot, 0.0);
  }
  void add_qcDot(double qcDot) {
    fbb_.AddElement<double>(AttitudeData_Ingest::VT_QCDOT, qcDot, 0.0);
  }
  void add_xAngle(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> xAngle) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_XANGLE, xAngle);
  }
  void add_yAngle(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> yAngle) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_YANGLE, yAngle);
  }
  void add_zAngle(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> zAngle) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_ZANGLE, zAngle);
  }
  void add_xRate(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> xRate) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_XRATE, xRate);
  }
  void add_yRate(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> yRate) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_YRATE, yRate);
  }
  void add_zRate(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> zRate) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_ZRATE, zRate);
  }
  void add_ra(double ra) {
    fbb_.AddElement<double>(AttitudeData_Ingest::VT_RA, ra, 0.0);
  }
  void add_declination(double declination) {
    fbb_.AddElement<double>(AttitudeData_Ingest::VT_DECLINATION, declination, 0.0);
  }
  void add_coningAngle(double coningAngle) {
    fbb_.AddElement<double>(AttitudeData_Ingest::VT_CONINGANGLE, coningAngle, 0.0);
  }
  void add_precPeriod(double precPeriod) {
    fbb_.AddElement<double>(AttitudeData_Ingest::VT_PRECPERIOD, precPeriod, 0.0);
  }
  void add_spinPeriod(double spinPeriod) {
    fbb_.AddElement<double>(AttitudeData_Ingest::VT_SPINPERIOD, spinPeriod, 0.0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(AttitudeData_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AttitudeData_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AttitudeData_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  explicit AttitudeData_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AttitudeData_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AttitudeData_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AttitudeData_Ingest> CreateAttitudeData_Ingest(
    ...
    AttitudeData_Ingest_dataMode_Enum dataMode = AttitudeData_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  AttitudeData_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AttitudeData_Ingest> CreateAttitudeData_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAttitudeData_Ingest(
      _fbb,
      id__,
...
inline const AttitudeData_Ingest *GetAttitudeData_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<AttitudeData_Ingest>(buf);
}

inline const AttitudeData_Ingest *GetSizePrefixedAttitudeData_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AttitudeData_Ingest>(buf);
}

inline const char *AttitudeData_IngestIdentifier() {
  return "ATTI";
}

inline bool AttitudeData_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AttitudeData_IngestIdentifier());
}

inline bool SizePrefixedAttitudeData_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AttitudeData_IngestIdentifier(), true);
}

inline bool VerifyAttitudeData_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AttitudeData_Ingest>(AttitudeData_IngestIdentifier());
}

inline bool VerifySizePrefixedAttitudeData_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AttitudeData_Ingest>(AttitudeData_IngestIdentifier());
}

inline void FinishAttitudeData_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AttitudeData_Ingest> root) {
  fbb.Finish(root, AttitudeData_IngestIdentifier());
}

inline void FinishSizePrefixedAttitudeData_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AttitudeData_Ingest> root) {
  fbb.FinishSizePrefixed(root, AttitudeData_IngestIdentifier());
}
