...
struct EffectResponse_Ingest;
struct EffectResponse_IngestBuilder;

enum EffectResponse_Ingest_dataMode_Enum : int8_t {
  ...
  EffectResponse_Ingest_dataMode_Enum_MIN = EffectResponse_Ingest_dataMode_Enum_REAL,
  EffectResponse_Ingest_dataMode_Enum_MAX = EffectResponse_Ingest_dataMode_Enum_EXERCISE
};

inline const EffectResponse_Ingest_dataMode_Enum (&EnumValuesEffectResponse_Ingest_dataMode_Enum())[4] {
  static const EffectResponse_Ingest_dataMode_Enum values[] = {
    EffectResponse_Ingest_dataMode_Enum_REAL,
    EffectResponse_Ingest_dataMode_Enum_TEST,
    EffectResponse_Ingest_dataMode_Enum_SIMULATED,
    EffectResponse_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesEffectResponse_Ingest_dataMode_Enum() {
...
inline const char *EnumNameEffectResponse_Ingest_dataMode_Enum(EffectResponse_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, EffectResponse_Ingest_dataMode_Enum_REAL, EffectResponse_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEffectResponse_Ingest_dataMode_Enum()[index];
}

/// /// A response for various effects on a target.
struct EffectResponse_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EffectResponse_IngestBuilder Builder;
  ...
  EffectResponse_Ingest_dataMode_Enum dataMode() const {
    return static_cast<EffectResponse_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct EffectResponse_IngestBuilder {
  typedef EffectResponse_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idEffectRequest(::flatbuffers::Offset<::flatbuffers::String> idEffectRequest) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_IDEFFECTREQUEST, idEffectRequest);
  }
  void add_externalRequestId(::flatbuffers::Offset<::flatbuffers::String> externalRequestId) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_EXTERNALREQUESTID, externalRequestId);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_TYPE, type);
  }
  void add_actorSrcType(::flatbuffers::Offset<::flatbuffers::String> actorSrcType) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_ACTORSRCTYPE, actorSrcType);
  }
  void add_actorSrcId(::flatbuffers::Offset<::flatbuffers::String> actorSrcId) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_ACTORSRCID, actorSrcId);
  }
  void add_munitionType(::flatbuffers::Offset<::flatbuffers::String> munitionType) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_MUNITIONTYPE, munitionType);
  }
  void add_munitionId(::flatbuffers::Offset<::flatbuffers::String> munitionId) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_MUNITIONID, munitionId);
  }
  void add_shotsRequired(int32_t shotsRequired) {
    fbb_.AddElement<int32_t>(EffectResponse_Ingest::VT_SHOTSREQUIRED, shotsRequired, 0);
  }
  void add_probabilityOfKill(double probabilityOfKill) {
    fbb_.AddElement<double>(EffectResponse_Ingest::VT_PROBABILITYOFKILL, probabilityOfKill, 0.0);
  }
  void add_collateralDamageEst(double collateralDamageEst) {
    fbb_.AddElement<double>(EffectResponse_Ingest::VT_COLLATERALDAMAGEEST, collateralDamageEst, 0.0);
  }
  void add_actionsList(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> actionsList) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_ACTIONSLIST, actionsList);
  }
  void add_externalActions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> externalActions) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_EXTERNALACTIONS, externalActions);
  }
  void add_coaMetrics(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> coaMetrics) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_COAMETRICS, coaMetrics);
  }
  void add_redTimeToOverhead(::flatbuffers::Offset<::flatbuffers::String> redTimeToOverhead) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_REDTIMETOOVERHEAD, redTimeToOverhead);
  }
  void add_decisionDeadline(::flatbuffers::Offset<::flatbuffers::String> decisionDeadline) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_DECISIONDEADLINE, decisionDeadline);
  }
  void add_redTargetSrcType(::flatbuffers::Offset<::flatbuffers::String> redTargetSrcType) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_REDTARGETSRCTYPE, redTargetSrcType);
  }
  void add_redTargetSrcId(::flatbuffers::Offset<::flatbuffers::String> redTargetSrcId) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_REDTARGETSRCID, redTargetSrcId);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(EffectResponse_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(EffectResponse_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(EffectResponse_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  explicit EffectResponse_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<EffectResponse_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<EffectResponse_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<EffectResponse_Ingest> CreateEffectResponse_Ingest(
    ...
    EffectResponse_Ingest_dataMode_Enum dataMode = EffectResponse_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  EffectResponse_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<EffectResponse_Ingest> CreateEffectResponse_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateEffectResponse_Ingest(
      _fbb,
      id__,
...
inline const EffectResponse_Ingest *GetEffectResponse_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<EffectResponse_Ingest>(buf);
}

inline const EffectResponse_Ingest *GetSizePrefixedEffectResponse_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EffectResponse_Ingest>(buf);
}

inline const char *EffectResponse_IngestIdentifier() {
  return "EFFE";
}

inline bool EffectResponse_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EffectResponse_IngestIdentifier());
}

inline bool SizePrefixedEffectResponse_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EffectResponse_IngestIdentifier(), true);
}

inline bool VerifyEffectResponse_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EffectResponse_Ingest>(EffectResponse_IngestIdentifier());
}

inline bool VerifySizePrefixedEffectResponse_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EffectResponse_Ingest>(EffectResponse_IngestIdentifier());
}

inline void FinishEffectResponse_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EffectResponse_Ingest> root) {
  fbb.Finish(root, EffectResponse_IngestIdentifier());
}

inline void FinishSizePrefixedEffectResponse_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EffectResponse_Ingest> root) {
  fbb.FinishSizePrefixed(root, EffectResponse_IngestIdentifier());
}
