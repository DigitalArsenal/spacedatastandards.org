...
struct AirfieldSlotConsumption_Ingest;
struct AirfieldSlotConsumption_IngestBuilder;

enum AirfieldSlotConsumption_Ingest_status_Enum : int8_t {
  /// No description available.
  AirfieldSlotConsumption_Ingest_status_Enum_REQUESTED = 0,
  /// No description available.
  AirfieldSlotConsumption_Ingest_status_Enum_APPROVED = 1,
  /// No description available.
  AirfieldSlotConsumption_Ingest_status_Enum_DENIED = 2,
  /// No description available.
  AirfieldSlotConsumption_Ingest_status_Enum_BLOCKED = 3,
  /// No description available.
  AirfieldSlotConsumption_Ingest_status_Enum_OTHER = 4,
  AirfieldSlotConsumption_Ingest_status_Enum_MIN = AirfieldSlotConsumption_Ingest_status_Enum_REQUESTED,
  AirfieldSlotConsumption_Ingest_status_Enum_MAX = AirfieldSlotConsumption_Ingest_status_Enum_OTHER
};

inline const AirfieldSlotConsumption_Ingest_status_Enum (&EnumValuesAirfieldSlotConsumption_Ingest_status_Enum())[5] {
  static const AirfieldSlotConsumption_Ingest_status_Enum values[] = {
    AirfieldSlotConsumption_Ingest_status_Enum_REQUESTED,
    AirfieldSlotConsumption_Ingest_status_Enum_APPROVED,
    AirfieldSlotConsumption_Ingest_status_Enum_DENIED,
    AirfieldSlotConsumption_Ingest_status_Enum_BLOCKED,
    AirfieldSlotConsumption_Ingest_status_Enum_OTHER
  };
  return values;
}

inline const char * const *EnumNamesAirfieldSlotConsumption_Ingest_status_Enum() {
...
inline const char *EnumNameAirfieldSlotConsumption_Ingest_status_Enum(AirfieldSlotConsumption_Ingest_status_Enum e) {
  if (::flatbuffers::IsOutRange(e, AirfieldSlotConsumption_Ingest_status_Enum_REQUESTED, AirfieldSlotConsumption_Ingest_status_Enum_OTHER)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAirfieldSlotConsumption_Ingest_status_Enum()[index];
}

enum AirfieldSlotConsumption_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  AirfieldSlotConsumption_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  AirfieldSlotConsumption_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  AirfieldSlotConsumption_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  AirfieldSlotConsumption_Ingest_dataMode_Enum_EXERCISE = 3,
  AirfieldSlotConsumption_Ingest_dataMode_Enum_MIN = AirfieldSlotConsumption_Ingest_dataMode_Enum_REAL,
  AirfieldSlotConsumption_Ingest_dataMode_Enum_MAX = AirfieldSlotConsumption_Ingest_dataMode_Enum_EXERCISE
};

inline const AirfieldSlotConsumption_Ingest_dataMode_Enum (&EnumValuesAirfieldSlotConsumption_Ingest_dataMode_Enum())[4] {
  static const AirfieldSlotConsumption_Ingest_dataMode_Enum values[] = {
    AirfieldSlotConsumption_Ingest_dataMode_Enum_REAL,
    AirfieldSlotConsumption_Ingest_dataMode_Enum_TEST,
    AirfieldSlotConsumption_Ingest_dataMode_Enum_SIMULATED,
    AirfieldSlotConsumption_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAirfieldSlotConsumption_Ingest_dataMode_Enum() {
...
inline const char *EnumNameAirfieldSlotConsumption_Ingest_dataMode_Enum(AirfieldSlotConsumption_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AirfieldSlotConsumption_Ingest_dataMode_Enum_REAL, AirfieldSlotConsumption_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAirfieldSlotConsumption_Ingest_dataMode_Enum()[index];
}

/// /// Airfield slot use data. Contains the dynamic data associated with the status and use of specific airfield slots.
struct AirfieldSlotConsumption_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirfieldSlotConsumption_IngestBuilder Builder;
  ...
  AirfieldSlotConsumption_Ingest_status_Enum status() const {
    return static_cast<AirfieldSlotConsumption_Ingest_status_Enum>(GetField<int8_t>(VT_STATUS, 0));
  }
  ...
  AirfieldSlotConsumption_Ingest_dataMode_Enum dataMode() const {
    return static_cast<AirfieldSlotConsumption_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AirfieldSlotConsumption_IngestBuilder {
  typedef AirfieldSlotConsumption_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idAirfieldSlot(::flatbuffers::Offset<::flatbuffers::String> idAirfieldSlot) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_IDAIRFIELDSLOT, idAirfieldSlot);
  }
  void add_status(AirfieldSlotConsumption_Ingest_status_Enum status) {
    fbb_.AddElement<int8_t>(AirfieldSlotConsumption_Ingest::VT_STATUS, static_cast<int8_t>(status), 0);
  }
  void add_occupied(bool occupied) {
    fbb_.AddElement<uint8_t>(AirfieldSlotConsumption_Ingest::VT_OCCUPIED, static_cast<uint8_t>(occupied), 0);
  }
  void add_consumer(::flatbuffers::Offset<::flatbuffers::String> consumer) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_CONSUMER, consumer);
  }
  void add_occAircraftMDS(::flatbuffers::Offset<::flatbuffers::String> occAircraftMDS) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_OCCAIRCRAFTMDS, occAircraftMDS);
  }
  void add_occTailNumber(::flatbuffers::Offset<::flatbuffers::String> occTailNumber) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_OCCTAILNUMBER, occTailNumber);
  }
  void add_callSigns(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> callSigns) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_CALLSIGNS, callSigns);
  }
  void add_missionId(::flatbuffers::Offset<::flatbuffers::String> missionId) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_MISSIONID, missionId);
  }
  void add_numAircraft(int32_t numAircraft) {
    fbb_.AddElement<int32_t>(AirfieldSlotConsumption_Ingest::VT_NUMAIRCRAFT, numAircraft, 0);
  }
  void add_occStartTime(::flatbuffers::Offset<::flatbuffers::String> occStartTime) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_OCCSTARTTIME, occStartTime);
  }
  void add_resAircraftMDS(::flatbuffers::Offset<::flatbuffers::String> resAircraftMDS) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_RESAIRCRAFTMDS, resAircraftMDS);
  }
  void add_resTailNumber(::flatbuffers::Offset<::flatbuffers::String> resTailNumber) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_RESTAILNUMBER, resTailNumber);
  }
  void add_resType(::flatbuffers::Offset<::flatbuffers::String> resType) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_RESTYPE, resType);
  }
  void add_resReason(::flatbuffers::Offset<::flatbuffers::String> resReason) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_RESREASON, resReason);
  }
  void add_resMissionId(::flatbuffers::Offset<::flatbuffers::String> resMissionId) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_RESMISSIONID, resMissionId);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_ENDTIME, endTime);
  }
  void add_targetTime(::flatbuffers::Offset<::flatbuffers::String> targetTime) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_TARGETTIME, targetTime);
  }
  void add_idArrSortie(::flatbuffers::Offset<::flatbuffers::String> idArrSortie) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_IDARRSORTIE, idArrSortie);
  }
  void add_idDepSortie(::flatbuffers::Offset<::flatbuffers::String> idDepSortie) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_IDDEPSORTIE, idDepSortie);
  }
  void add_altArrSortieId(::flatbuffers::Offset<::flatbuffers::String> altArrSortieId) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_ALTARRSORTIEID, altArrSortieId);
  }
  void add_altDepSortieId(::flatbuffers::Offset<::flatbuffers::String> altDepSortieId) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_ALTDEPSORTIEID, altDepSortieId);
  }
  void add_reqComment(::flatbuffers::Offset<::flatbuffers::String> reqComment) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_REQCOMMENT, reqComment);
  }
  void add_appComment(::flatbuffers::Offset<::flatbuffers::String> appComment) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_APPCOMMENT, appComment);
  }
  void add_reqOrg(::flatbuffers::Offset<::flatbuffers::String> reqOrg) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_REQORG, reqOrg);
  }
  void add_reqInitials(::flatbuffers::Offset<::flatbuffers::String> reqInitials) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_REQINITIALS, reqInitials);
  }
  void add_appOrg(::flatbuffers::Offset<::flatbuffers::String> appOrg) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_APPORG, appOrg);
  }
  void add_appInitials(::flatbuffers::Offset<::flatbuffers::String> appInitials) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_APPINITIALS, appInitials);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AirfieldSlotConsumption_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(AirfieldSlotConsumption_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AirfieldSlotConsumption_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit AirfieldSlotConsumption_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirfieldSlotConsumption_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirfieldSlotConsumption_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirfieldSlotConsumption_Ingest> CreateAirfieldSlotConsumption_Ingest(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::String> id = 0,
    ::flatbuffers::Offset<::flatbuffers::String> classificationMarking = 0,
    ::flatbuffers::Offset<::flatbuffers::String> idAirfieldSlot = 0,
    AirfieldSlotConsumption_Ingest_status_Enum status = AirfieldSlotConsumption_Ingest_status_Enum_REQUESTED,
    bool occupied = false,
    ...
    AirfieldSlotConsumption_Ingest_dataMode_Enum dataMode = AirfieldSlotConsumption_Ingest_dataMode_Enum_REAL) {
  AirfieldSlotConsumption_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirfieldSlotConsumption_Ingest> CreateAirfieldSlotConsumption_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAirfieldSlotConsumption_Ingest(
      _fbb,
      id__,
...
inline const AirfieldSlotConsumption_Ingest *GetAirfieldSlotConsumption_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<AirfieldSlotConsumption_Ingest>(buf);
}

inline const AirfieldSlotConsumption_Ingest *GetSizePrefixedAirfieldSlotConsumption_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirfieldSlotConsumption_Ingest>(buf);
}

inline const char *AirfieldSlotConsumption_IngestIdentifier() {
  return "AIRF";
}

inline bool AirfieldSlotConsumption_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirfieldSlotConsumption_IngestIdentifier());
}

inline bool SizePrefixedAirfieldSlotConsumption_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirfieldSlotConsumption_IngestIdentifier(), true);
}

inline bool VerifyAirfieldSlotConsumption_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirfieldSlotConsumption_Ingest>(AirfieldSlotConsumption_IngestIdentifier());
}

inline bool VerifySizePrefixedAirfieldSlotConsumption_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirfieldSlotConsumption_Ingest>(AirfieldSlotConsumption_IngestIdentifier());
}

inline void FinishAirfieldSlotConsumption_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirfieldSlotConsumption_Ingest> root) {
  fbb.Finish(root, AirfieldSlotConsumption_IngestIdentifier());
}

inline void FinishSizePrefixedAirfieldSlotConsumption_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirfieldSlotConsumption_Ingest> root) {
  fbb.FinishSizePrefixed(root, AirfieldSlotConsumption_IngestIdentifier());
}
