...
struct AircraftMissionTasking_Full;
struct AircraftMissionTasking_FullBuilder;

/// /// Collection that specifies the tasked country, tasked service, unit and mission level tasking for this ATO.
struct AircraftMissionTasking_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AircraftMissionTasking_FullBuilder Builder;
...
struct AircraftMissionTasking_FullBuilder {
  typedef AircraftMissionTasking_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_COUNTRYCODE, countryCode);
  }
  void add_taskedService(::flatbuffers::Offset<::flatbuffers::String> taskedService) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_TASKEDSERVICE, taskedService);
  }
  void add_unitDesignator(::flatbuffers::Offset<::flatbuffers::String> unitDesignator) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_UNITDESIGNATOR, unitDesignator);
  }
  void add_unitLocName(::flatbuffers::Offset<::flatbuffers::String> unitLocName) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_UNITLOCNAME, unitLocName);
  }
  void add_resMsnInd(::flatbuffers::Offset<::flatbuffers::String> resMsnInd) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_RESMSNIND, resMsnInd);
  }
  void add_amcMsnNum(::flatbuffers::Offset<::flatbuffers::String> amcMsnNum) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_AMCMSNNUM, amcMsnNum);
  }
  void add_pkgId(::flatbuffers::Offset<::flatbuffers::String> pkgId) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_PKGID, pkgId);
  }
  void add_msnCommander(::flatbuffers::Offset<::flatbuffers::String> msnCommander) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_MSNCOMMANDER, msnCommander);
  }
  void add_msnNum(::flatbuffers::Offset<::flatbuffers::String> msnNum) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_MSNNUM, msnNum);
  }
  void add_priMsnType(::flatbuffers::Offset<::flatbuffers::String> priMsnType) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_PRIMSNTYPE, priMsnType);
  }
  void add_secMsnType(::flatbuffers::Offset<::flatbuffers::String> secMsnType) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_SECMSNTYPE, secMsnType);
  }
  void add_alertStatus(int32_t alertStatus) {
    fbb_.AddElement<int32_t>(AircraftMissionTasking_Full::VT_ALERTSTATUS, alertStatus, 0);
  }
  void add_depLocName(::flatbuffers::Offset<::flatbuffers::String> depLocName) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_DEPLOCNAME, depLocName);
  }
  void add_depLocUTM(::flatbuffers::Offset<::flatbuffers::String> depLocUTM) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_DEPLOCUTM, depLocUTM);
  }
  void add_depLocLat(double depLocLat) {
    fbb_.AddElement<double>(AircraftMissionTasking_Full::VT_DEPLOCLAT, depLocLat, 0.0);
  }
  void add_depLocLon(double depLocLon) {
    fbb_.AddElement<double>(AircraftMissionTasking_Full::VT_DEPLOCLON, depLocLon, 0.0);
  }
  void add_depTime(::flatbuffers::Offset<::flatbuffers::String> depTime) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_DEPTIME, depTime);
  }
  void add_rcvyLocName(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rcvyLocName) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_RCVYLOCNAME, rcvyLocName);
  }
  void add_rcvyLocUTM(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rcvyLocUTM) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_RCVYLOCUTM, rcvyLocUTM);
  }
  void add_rcvyLocLat(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rcvyLocLat) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_RCVYLOCLAT, rcvyLocLat);
  }
  void add_rcvyLocLon(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rcvyLocLon) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_RCVYLOCLON, rcvyLocLon);
  }
  void add_rcvyTime(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rcvyTime) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_RCVYTIME, rcvyTime);
  }
  void add_indACTasking(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> indACTasking) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_INDACTASKING, indACTasking);
  }
  void add_acMsnLocSeg(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> acMsnLocSeg) {
    fbb_.AddOffset(AircraftMissionTasking_Full::VT_ACMSNLOCSEG, acMsnLocSeg);
  }
  explicit AircraftMissionTasking_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AircraftMissionTasking_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AircraftMissionTasking_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AircraftMissionTasking_Full> CreateAircraftMissionTasking_Full(
  ...
  AircraftMissionTasking_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AircraftMissionTasking_Full> CreateAircraftMissionTasking_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AircraftMissionTasking_Full *GetAircraftMissionTasking_Full(const void *buf) {
  return ::flatbuffers::GetRoot<AircraftMissionTasking_Full>(buf);
}

inline const AircraftMissionTasking_Full *GetSizePrefixedAircraftMissionTasking_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AircraftMissionTasking_Full>(buf);
}

inline const char *AircraftMissionTasking_FullIdentifier() {
  return "AIRC";
}

inline bool AircraftMissionTasking_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftMissionTasking_FullIdentifier());
}

inline bool SizePrefixedAircraftMissionTasking_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftMissionTasking_FullIdentifier(), true);
}

inline bool VerifyAircraftMissionTasking_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AircraftMissionTasking_Full>(AircraftMissionTasking_FullIdentifier());
}

inline bool VerifySizePrefixedAircraftMissionTasking_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AircraftMissionTasking_Full>(AircraftMissionTasking_FullIdentifier());
}

inline void FinishAircraftMissionTasking_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftMissionTasking_Full> root) {
  fbb.Finish(root, AircraftMissionTasking_FullIdentifier());
}

inline void FinishSizePrefixedAircraftMissionTasking_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftMissionTasking_Full> root) {
  fbb.FinishSizePrefixed(root, AircraftMissionTasking_FullIdentifier());
}
