...
struct ObjectOfInterest_Ingest;
struct ObjectOfInterest_IngestBuilder;

enum ObjectOfInterest_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  ObjectOfInterest_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  ObjectOfInterest_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  ObjectOfInterest_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  ObjectOfInterest_Ingest_dataMode_Enum_EXERCISE = 3,
  ObjectOfInterest_Ingest_dataMode_Enum_MIN = ObjectOfInterest_Ingest_dataMode_Enum_REAL,
  ObjectOfInterest_Ingest_dataMode_Enum_MAX = ObjectOfInterest_Ingest_dataMode_Enum_EXERCISE
};

inline const ObjectOfInterest_Ingest_dataMode_Enum (&EnumValuesObjectOfInterest_Ingest_dataMode_Enum())[4] {
  static const ObjectOfInterest_Ingest_dataMode_Enum values[] = {
    ObjectOfInterest_Ingest_dataMode_Enum_REAL,
    ObjectOfInterest_Ingest_dataMode_Enum_TEST,
    ObjectOfInterest_Ingest_dataMode_Enum_SIMULATED,
    ObjectOfInterest_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesObjectOfInterest_Ingest_dataMode_Enum() {
...
inline const char *EnumNameObjectOfInterest_Ingest_dataMode_Enum(ObjectOfInterest_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, ObjectOfInterest_Ingest_dataMode_Enum_REAL, ObjectOfInterest_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesObjectOfInterest_Ingest_dataMode_Enum()[index];
}

/// /// OnOrbit objects of interest, which include information about the last known state of the object.
struct ObjectOfInterest_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef ObjectOfInterest_IngestBuilder Builder;
  ...
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *affectedObjects() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_AFFECTEDOBJECTS);
  }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  ObjectOfInterest_Ingest_dataMode_Enum dataMode() const {
    return static_cast<ObjectOfInterest_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_AFFECTEDOBJECTS) &&
           verifier.VerifyVector(affectedObjects()) &&
           verifier.VerifyVectorOfStrings(affectedObjects()) &&
...
struct ObjectOfInterest_IngestBuilder {
  typedef ObjectOfInterest_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(ObjectOfInterest_Ingest::VT_SATNO, satNo, 0);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_NAME, name);
  }
  void add_sensorTaskingStartTime(::flatbuffers::Offset<::flatbuffers::String> sensorTaskingStartTime) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_SENSORTASKINGSTARTTIME, sensorTaskingStartTime);
  }
  void add_sensorTaskingStopTime(::flatbuffers::Offset<::flatbuffers::String> sensorTaskingStopTime) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_SENSORTASKINGSTOPTIME, sensorTaskingStopTime);
  }
  void add_priority(int32_t priority) {
    fbb_.AddElement<int32_t>(ObjectOfInterest_Ingest::VT_PRIORITY, priority, 0);
  }
  void add_status(::flatbuffers::Offset<::flatbuffers::String> status) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_STATUS, status);
  }
  void add_statusDate(::flatbuffers::Offset<::flatbuffers::String> statusDate) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_STATUSDATE, statusDate);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_DESCRIPTION, description);
  }
  void add_lastObTime(::flatbuffers::Offset<::flatbuffers::String> lastObTime) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_LASTOBTIME, lastObTime);
  }
  void add_missedObTime(::flatbuffers::Offset<::flatbuffers::String> missedObTime) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_MISSEDOBTIME, missedObTime);
  }
  void add_deltaVs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> deltaVs) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_DELTAVS, deltaVs);
  }
  void add_deltaTs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> deltaTs) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_DELTATS, deltaTs);
  }
  void add_svEpoch(::flatbuffers::Offset<::flatbuffers::String> svEpoch) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_SVEPOCH, svEpoch);
  }
  void add_x(double x) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_X, x, 0.0);
  }
  void add_y(double y) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_Y, y, 0.0);
  }
  void add_z(double z) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_Z, z, 0.0);
  }
  void add_xvel(double xvel) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_XVEL, xvel, 0.0);
  }
  void add_yvel(double yvel) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_YVEL, yvel, 0.0);
  }
  void add_zvel(double zvel) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_ZVEL, zvel, 0.0);
  }
  void add_elsetEpoch(::flatbuffers::Offset<::flatbuffers::String> elsetEpoch) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_ELSETEPOCH, elsetEpoch);
  }
  void add_meanMotion(double meanMotion) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_MEANMOTION, meanMotion, 0.0);
  }
  void add_eccentricity(double eccentricity) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_ECCENTRICITY, eccentricity, 0.0);
  }
  void add_inclination(double inclination) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_INCLINATION, inclination, 0.0);
  }
  void add_raan(double raan) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_RAAN, raan, 0.0);
  }
  void add_argOfPerigee(double argOfPerigee) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_ARGOFPERIGEE, argOfPerigee, 0.0);
  }
  void add_meanAnomaly(double meanAnomaly) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_MEANANOMALY, meanAnomaly, 0.0);
  }
  void add_revNo(int32_t revNo) {
    fbb_.AddElement<int32_t>(ObjectOfInterest_Ingest::VT_REVNO, revNo, 0);
  }
  void add_bStar(double bStar) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_BSTAR, bStar, 0.0);
  }
  void add_meanMotionDot(double meanMotionDot) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_MEANMOTIONDOT, meanMotionDot, 0.0);
  }
  void add_meanMotionDDot(double meanMotionDDot) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_MEANMOTIONDDOT, meanMotionDDot, 0.0);
  }
  void add_semiMajorAxis(double semiMajorAxis) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_SEMIMAJORAXIS, semiMajorAxis, 0.0);
  }
  void add_period(double period) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_PERIOD, period, 0.0);
  }
  void add_apogee(double apogee) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_APOGEE, apogee, 0.0);
  }
  void add_perigee(double perigee) {
    fbb_.AddElement<double>(ObjectOfInterest_Ingest::VT_PERIGEE, perigee, 0.0);
  }
  void add_affectedObjects(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> affectedObjects) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_AFFECTEDOBJECTS, affectedObjects);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(ObjectOfInterest_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(ObjectOfInterest_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(ObjectOfInterest_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit ObjectOfInterest_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<ObjectOfInterest_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<ObjectOfInterest_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<ObjectOfInterest_Ingest> CreateObjectOfInterest_Ingest(
    ...
    double apogee = 0.0,
    double perigee = 0.0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> affectedObjects = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0,
    ::flatbuffers::Offset<::flatbuffers::String> source = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origin = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0,
    ObjectOfInterest_Ingest_dataMode_Enum dataMode = ObjectOfInterest_Ingest_dataMode_Enum_REAL) {
  ObjectOfInterest_IngestBuilder builder_(_fbb);
  ...
  builder_.add_affectedObjects(affectedObjects);
...
inline ::flatbuffers::Offset<ObjectOfInterest_Ingest> CreateObjectOfInterest_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ...
    double apogee = 0.0,
    double perigee = 0.0,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *affectedObjects = nullptr,
  ...
  auto affectedObjects__ = affectedObjects ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*affectedObjects) : 0;
  auto createdAt__ = createdAt ? _fbb.CreateString(createdAt) : 0;
  auto createdBy__ = createdBy ? _fbb.CreateString(createdBy) : 0;
  auto source__ = source ? _fbb.CreateString(source) : 0;
  auto origin__ = origin ? _fbb.CreateString(origin) : 0;
  auto origNetwork__ = origNetwork ? _fbb.CreateString(origNetwork) : 0;
  return CreateObjectOfInterest_Ingest(
      _fbb,
      id__,
...
inline const ObjectOfInterest_Ingest *GetObjectOfInterest_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<ObjectOfInterest_Ingest>(buf);
}

inline const ObjectOfInterest_Ingest *GetSizePrefixedObjectOfInterest_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<ObjectOfInterest_Ingest>(buf);
}

inline const char *ObjectOfInterest_IngestIdentifier() {
  return "OBJE";
}

inline bool ObjectOfInterest_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ObjectOfInterest_IngestIdentifier());
}

inline bool SizePrefixedObjectOfInterest_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ObjectOfInterest_IngestIdentifier(), true);
}

inline bool VerifyObjectOfInterest_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<ObjectOfInterest_Ingest>(ObjectOfInterest_IngestIdentifier());
}

inline bool VerifySizePrefixedObjectOfInterest_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<ObjectOfInterest_Ingest>(ObjectOfInterest_IngestIdentifier());
}

inline void FinishObjectOfInterest_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ObjectOfInterest_Ingest> root) {
  fbb.Finish(root, ObjectOfInterest_IngestIdentifier());
}

inline void FinishSizePrefixedObjectOfInterest_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ObjectOfInterest_Ingest> root) {
  fbb.FinishSizePrefixed(root, ObjectOfInterest_IngestIdentifier());
}
