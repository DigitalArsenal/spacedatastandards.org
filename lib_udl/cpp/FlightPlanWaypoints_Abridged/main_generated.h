...
struct FlightPlanWaypoints_Abridged;
struct FlightPlanWaypoints_AbridgedBuilder;

/// /// Collection of waypoints associated with this flight plan.
struct FlightPlanWaypoints_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef FlightPlanWaypoints_AbridgedBuilder Builder;
...
struct FlightPlanWaypoints_AbridgedBuilder {
  typedef FlightPlanWaypoints_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(FlightPlanWaypoints_Abridged::VT_TYPE, type);
  }
  void add_waypointName(::flatbuffers::Offset<::flatbuffers::String> waypointName) {
    fbb_.AddOffset(FlightPlanWaypoints_Abridged::VT_WAYPOINTNAME, waypointName);
  }
  void add_waypointNum(int32_t waypointNum) {
    fbb_.AddElement<int32_t>(FlightPlanWaypoints_Abridged::VT_WAYPOINTNUM, waypointNum, 0);
  }
  void add_airway(::flatbuffers::Offset<::flatbuffers::String> airway) {
    fbb_.AddOffset(FlightPlanWaypoints_Abridged::VT_AIRWAY, airway);
  }
  void add_arpt(::flatbuffers::Offset<::flatbuffers::String> arpt) {
    fbb_.AddOffset(FlightPlanWaypoints_Abridged::VT_ARPT, arpt);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_LON, lon, 0.0);
  }
  void add_arId(::flatbuffers::Offset<::flatbuffers::String> arId) {
    fbb_.AddOffset(FlightPlanWaypoints_Abridged::VT_ARID, arId);
  }
  void add_navaid(::flatbuffers::Offset<::flatbuffers::String> navaid) {
    fbb_.AddOffset(FlightPlanWaypoints_Abridged::VT_NAVAID, navaid);
  }
  void add_tacanChannel(::flatbuffers::Offset<::flatbuffers::String> tacanChannel) {
    fbb_.AddOffset(FlightPlanWaypoints_Abridged::VT_TACANCHANNEL, tacanChannel);
  }
  void add_vorFreq(double vorFreq) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_VORFREQ, vorFreq, 0.0);
  }
  void add_turbCat(::flatbuffers::Offset<::flatbuffers::String> turbCat) {
    fbb_.AddOffset(FlightPlanWaypoints_Abridged::VT_TURBCAT, turbCat);
  }
  void add_iceCat(::flatbuffers::Offset<::flatbuffers::String> iceCat) {
    fbb_.AddOffset(FlightPlanWaypoints_Abridged::VT_ICECAT, iceCat);
  }
  void add_thunderCat(::flatbuffers::Offset<::flatbuffers::String> thunderCat) {
    fbb_.AddOffset(FlightPlanWaypoints_Abridged::VT_THUNDERCAT, thunderCat);
  }
  void add_alt(double alt) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_ALT, alt, 0.0);
  }
  void add_tempDev(double tempDev) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_TEMPDEV, tempDev, 0.0);
  }
  void add_legFuelDegrade(double legFuelDegrade) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_LEGFUELDEGRADE, legFuelDegrade, 0.0);
  }
  void add_legMach(double legMach) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_LEGMACH, legMach, 0.0);
  }
  void add_legMsnIndex(double legMsnIndex) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_LEGMSNINDEX, legMsnIndex, 0.0);
  }
  void add_legDragIndex(double legDragIndex) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_LEGDRAGINDEX, legDragIndex, 0.0);
  }
  void add_avgCalAirspeed(double avgCalAirspeed) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_AVGCALAIRSPEED, avgCalAirspeed, 0.0);
  }
  void add_avgTrueAirspeed(double avgTrueAirspeed) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_AVGTRUEAIRSPEED, avgTrueAirspeed, 0.0);
  }
  void add_avgGroundSpeed(double avgGroundSpeed) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_AVGGROUNDSPEED, avgGroundSpeed, 0.0);
  }
  void add_priFreq(double priFreq) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_PRIFREQ, priFreq, 0.0);
  }
  void add_pointWindDir(double pointWindDir) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_POINTWINDDIR, pointWindDir, 0.0);
  }
  void add_pointWindSpeed(double pointWindSpeed) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_POINTWINDSPEED, pointWindSpeed, 0.0);
  }
  void add_avgWindDir(double avgWindDir) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_AVGWINDDIR, avgWindDir, 0.0);
  }
  void add_avgWindSpeed(double avgWindSpeed) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_AVGWINDSPEED, avgWindSpeed, 0.0);
  }
  void add_legWindFac(double legWindFac) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_LEGWINDFAC, legWindFac, 0.0);
  }
  void add_avgDriftAng(double avgDriftAng) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_AVGDRIFTANG, avgDriftAng, 0.0);
  }
  void add_secFreq(double secFreq) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_SECFREQ, secFreq, 0.0);
  }
  void add_magCourse(double magCourse) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_MAGCOURSE, magCourse, 0.0);
  }
  void add_trueCourse(double trueCourse) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_TRUECOURSE, trueCourse, 0.0);
  }
  void add_magHeading(double magHeading) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_MAGHEADING, magHeading, 0.0);
  }
  void add_aaTacanChannel(::flatbuffers::Offset<::flatbuffers::String> aaTacanChannel) {
    fbb_.AddOffset(FlightPlanWaypoints_Abridged::VT_AATACANCHANNEL, aaTacanChannel);
  }
  void add_zoneDistance(double zoneDistance) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_ZONEDISTANCE, zoneDistance, 0.0);
  }
  void add_totalFlownDistance(double totalFlownDistance) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_TOTALFLOWNDISTANCE, totalFlownDistance, 0.0);
  }
  void add_totalRemDistance(double totalRemDistance) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_TOTALREMDISTANCE, totalRemDistance, 0.0);
  }
  void add_zoneTime(double zoneTime) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_ZONETIME, zoneTime, 0.0);
  }
  void add_totalTime(::flatbuffers::Offset<::flatbuffers::String> totalTime) {
    fbb_.AddOffset(FlightPlanWaypoints_Abridged::VT_TOTALTIME, totalTime);
  }
  void add_totalTimeRem(::flatbuffers::Offset<::flatbuffers::String> totalTimeRem) {
    fbb_.AddOffset(FlightPlanWaypoints_Abridged::VT_TOTALTIMEREM, totalTimeRem);
  }
  void add_zoneFuel(double zoneFuel) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_ZONEFUEL, zoneFuel, 0.0);
  }
  void add_totalUsedFuel(double totalUsedFuel) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_TOTALUSEDFUEL, totalUsedFuel, 0.0);
  }
  void add_totalRemFuel(double totalRemFuel) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_TOTALREMFUEL, totalRemFuel, 0.0);
  }
  void add_exchangedFuel(double exchangedFuel) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_EXCHANGEDFUEL, exchangedFuel, 0.0);
  }
  void add_airDistance(double airDistance) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_AIRDISTANCE, airDistance, 0.0);
  }
  void add_totalAirDistance(double totalAirDistance) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_TOTALAIRDISTANCE, totalAirDistance, 0.0);
  }
  void add_totalWeight(double totalWeight) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_TOTALWEIGHT, totalWeight, 0.0);
  }
  void add_eta(::flatbuffers::Offset<::flatbuffers::String> eta) {
    fbb_.AddOffset(FlightPlanWaypoints_Abridged::VT_ETA, eta);
  }
  void add_ata(::flatbuffers::Offset<::flatbuffers::String> ata) {
    fbb_.AddOffset(FlightPlanWaypoints_Abridged::VT_ATA, ata);
  }
  void add_fuelFlow(double fuelFlow) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_FUELFLOW, fuelFlow, 0.0);
  }
  void add_legAlternate(::flatbuffers::Offset<::flatbuffers::String> legAlternate) {
    fbb_.AddOffset(FlightPlanWaypoints_Abridged::VT_LEGALTERNATE, legAlternate);
  }
  void add_magVar(double magVar) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_MAGVAR, magVar, 0.0);
  }
  void add_dayLowAlt(double dayLowAlt) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_DAYLOWALT, dayLowAlt, 0.0);
  }
  void add_nightLowAlt(double nightLowAlt) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_NIGHTLOWALT, nightLowAlt, 0.0);
  }
  void add_nvgLowAlt(double nvgLowAlt) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Abridged::VT_NVGLOWALT, nvgLowAlt, 0.0);
  }
  explicit FlightPlanWaypoints_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<FlightPlanWaypoints_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<FlightPlanWaypoints_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<FlightPlanWaypoints_Abridged> CreateFlightPlanWaypoints_Abridged(
  ...
  FlightPlanWaypoints_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<FlightPlanWaypoints_Abridged> CreateFlightPlanWaypoints_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateFlightPlanWaypoints_Abridged(
      _fbb,
      type__,
      waypointName__,
      waypointNum,
...
inline const FlightPlanWaypoints_Abridged *GetFlightPlanWaypoints_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<FlightPlanWaypoints_Abridged>(buf);
}

inline const FlightPlanWaypoints_Abridged *GetSizePrefixedFlightPlanWaypoints_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<FlightPlanWaypoints_Abridged>(buf);
}

inline const char *FlightPlanWaypoints_AbridgedIdentifier() {
  return "FLIG";
}

inline bool FlightPlanWaypoints_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, FlightPlanWaypoints_AbridgedIdentifier());
}

inline bool SizePrefixedFlightPlanWaypoints_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, FlightPlanWaypoints_AbridgedIdentifier(), true);
}

inline bool VerifyFlightPlanWaypoints_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<FlightPlanWaypoints_Abridged>(FlightPlanWaypoints_AbridgedIdentifier());
}

inline bool VerifySizePrefixedFlightPlanWaypoints_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<FlightPlanWaypoints_Abridged>(FlightPlanWaypoints_AbridgedIdentifier());
}

inline void FinishFlightPlanWaypoints_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<FlightPlanWaypoints_Abridged> root) {
  fbb.Finish(root, FlightPlanWaypoints_AbridgedIdentifier());
}

inline void FinishSizePrefixedFlightPlanWaypoints_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<FlightPlanWaypoints_Abridged> root) {
  fbb.FinishSizePrefixed(root, FlightPlanWaypoints_AbridgedIdentifier());
}
