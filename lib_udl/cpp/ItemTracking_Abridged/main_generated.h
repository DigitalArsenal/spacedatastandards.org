...
struct ItemTracking_Abridged;
struct ItemTracking_AbridgedBuilder;

enum ItemTracking_Abridged_dataMode_Enum : int8_t {
  ...
  ItemTracking_Abridged_dataMode_Enum_MIN = ItemTracking_Abridged_dataMode_Enum_REAL,
  ItemTracking_Abridged_dataMode_Enum_MAX = ItemTracking_Abridged_dataMode_Enum_EXERCISE
};

inline const ItemTracking_Abridged_dataMode_Enum (&EnumValuesItemTracking_Abridged_dataMode_Enum())[4] {
  static const ItemTracking_Abridged_dataMode_Enum values[] = {
    ItemTracking_Abridged_dataMode_Enum_REAL,
    ItemTracking_Abridged_dataMode_Enum_TEST,
    ItemTracking_Abridged_dataMode_Enum_SIMULATED,
    ItemTracking_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesItemTracking_Abridged_dataMode_Enum() {
...
inline const char *EnumNameItemTracking_Abridged_dataMode_Enum(ItemTracking_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, ItemTracking_Abridged_dataMode_Enum_REAL, ItemTracking_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesItemTracking_Abridged_dataMode_Enum()[index];
}

/// /// No description available.
struct ItemTracking_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef ItemTracking_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  ItemTracking_Abridged_dataMode_Enum dataMode() const {
    return static_cast<ItemTracking_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct ItemTracking_AbridgedBuilder {
  typedef ItemTracking_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_scanCode(::flatbuffers::Offset<::flatbuffers::String> scanCode) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_SCANCODE, scanCode);
  }
  void add_scGenTool(::flatbuffers::Offset<::flatbuffers::String> scGenTool) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_SCGENTOOL, scGenTool);
  }
  void add_scannerId(::flatbuffers::Offset<::flatbuffers::String> scannerId) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_SCANNERID, scannerId);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::String> ts) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_TS, ts);
  }
  void add_idItem(::flatbuffers::Offset<::flatbuffers::String> idItem) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_IDITEM, idItem);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_TYPE, type);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(ItemTracking_Abridged::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(ItemTracking_Abridged::VT_LON, lon, 0.0);
  }
  void add_scanType(::flatbuffers::Offset<::flatbuffers::String> scanType) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_SCANTYPE, scanType);
  }
  void add_dvCode(::flatbuffers::Offset<::flatbuffers::String> dvCode) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_DVCODE, dvCode);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_NOTES, notes);
  }
  void add_keys(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> keys) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_KEYS, keys);
  }
  void add_values(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> values) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_VALUES, values);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(ItemTracking_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(ItemTracking_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(ItemTracking_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit ItemTracking_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<ItemTracking_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<ItemTracking_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<ItemTracking_Abridged> CreateItemTracking_Abridged(
    ...
    ItemTracking_Abridged_dataMode_Enum dataMode = ItemTracking_Abridged_dataMode_Enum_REAL) {
  ItemTracking_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<ItemTracking_Abridged> CreateItemTracking_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateItemTracking_Abridged(
      _fbb,
      id__,
...
inline const ItemTracking_Abridged *GetItemTracking_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<ItemTracking_Abridged>(buf);
}

inline const ItemTracking_Abridged *GetSizePrefixedItemTracking_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<ItemTracking_Abridged>(buf);
}

inline const char *ItemTracking_AbridgedIdentifier() {
  return "ITEM";
}

inline bool ItemTracking_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ItemTracking_AbridgedIdentifier());
}

inline bool SizePrefixedItemTracking_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ItemTracking_AbridgedIdentifier(), true);
}

inline bool VerifyItemTracking_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<ItemTracking_Abridged>(ItemTracking_AbridgedIdentifier());
}

inline bool VerifySizePrefixedItemTracking_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<ItemTracking_Abridged>(ItemTracking_AbridgedIdentifier());
}

inline void FinishItemTracking_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ItemTracking_Abridged> root) {
  fbb.Finish(root, ItemTracking_AbridgedIdentifier());
}

inline void FinishSizePrefixedItemTracking_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ItemTracking_Abridged> root) {
  fbb.FinishSizePrefixed(root, ItemTracking_AbridgedIdentifier());
}
