...
struct Surface_Full;
struct Surface_FullBuilder;

enum Surface_Full_dataMode_Enum : int8_t {
  /// No description available.
  Surface_Full_dataMode_Enum_REAL = 0,
  /// No description available.
  Surface_Full_dataMode_Enum_TEST = 1,
  /// No description available.
  Surface_Full_dataMode_Enum_SIMULATED = 2,
  /// No description available.
  Surface_Full_dataMode_Enum_EXERCISE = 3,
  Surface_Full_dataMode_Enum_MIN = Surface_Full_dataMode_Enum_REAL,
  Surface_Full_dataMode_Enum_MAX = Surface_Full_dataMode_Enum_EXERCISE
};

inline const Surface_Full_dataMode_Enum (&EnumValuesSurface_Full_dataMode_Enum())[4] {
  static const Surface_Full_dataMode_Enum values[] = {
    Surface_Full_dataMode_Enum_REAL,
    Surface_Full_dataMode_Enum_TEST,
    Surface_Full_dataMode_Enum_SIMULATED,
    Surface_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSurface_Full_dataMode_Enum() {
...
inline const char *EnumNameSurface_Full_dataMode_Enum(Surface_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Surface_Full_dataMode_Enum_REAL, Surface_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSurface_Full_dataMode_Enum()[index];
}
...
struct Surface_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Surface_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Surface_Full_dataMode_Enum dataMode() const {
    return static_cast<Surface_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Surface_FullBuilder {
  typedef Surface_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Surface_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Surface_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(Surface_Full::VT_NAME, name);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(Surface_Full::VT_TYPE, type);
  }
  void add_idSite(::flatbuffers::Offset<::flatbuffers::String> idSite) {
    fbb_.AddOffset(Surface_Full::VT_IDSITE, idSite);
  }
  void add_altSiteId(::flatbuffers::Offset<::flatbuffers::String> altSiteId) {
    fbb_.AddOffset(Surface_Full::VT_ALTSITEID, altSiteId);
  }
  void add_primary(bool primary) {
    fbb_.AddElement<uint8_t>(Surface_Full::VT_PRIMARY, static_cast<uint8_t>(primary), 0);
  }
  void add_lengthFt(int32_t lengthFt) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_LENGTHFT, lengthFt, 0);
  }
  void add_ldaFt(int32_t ldaFt) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_LDAFT, ldaFt, 0);
  }
  void add_widthFt(int32_t widthFt) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_WIDTHFT, widthFt, 0);
  }
  void add_lengthM(int32_t lengthM) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_LENGTHM, lengthM, 0);
  }
  void add_ldaM(int32_t ldaM) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_LDAM, ldaM, 0);
  }
  void add_widthM(int32_t widthM) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_WIDTHM, widthM, 0);
  }
  void add_material(::flatbuffers::Offset<::flatbuffers::String> material) {
    fbb_.AddOffset(Surface_Full::VT_MATERIAL, material);
  }
  void add_condition(::flatbuffers::Offset<::flatbuffers::String> condition) {
    fbb_.AddOffset(Surface_Full::VT_CONDITION, condition);
  }
  void add_rawWBC(::flatbuffers::Offset<::flatbuffers::String> rawWBC) {
    fbb_.AddOffset(Surface_Full::VT_RAWWBC, rawWBC);
  }
  void add_pcn(::flatbuffers::Offset<::flatbuffers::String> pcn) {
    fbb_.AddOffset(Surface_Full::VT_PCN, pcn);
  }
  void add_lcn(int32_t lcn) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_LCN, lcn, 0);
  }
  void add_sWtKip(int32_t sWtKip) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_SWTKIP, sWtKip, 0);
  }
  void add_tWtKip(int32_t tWtKip) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_TWTKIP, tWtKip, 0);
  }
  void add_stWtKip(int32_t stWtKip) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_STWTKIP, stWtKip, 0);
  }
  void add_ttWtKip(int32_t ttWtKip) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_TTWTKIP, ttWtKip, 0);
  }
  void add_ddWtKip(int32_t ddWtKip) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_DDWTKIP, ddWtKip, 0);
  }
  void add_sbttWtKip(int32_t sbttWtKip) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_SBTTWTKIP, sbttWtKip, 0);
  }
  void add_tdtWtkip(int32_t tdtWtkip) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_TDTWTKIP, tdtWtkip, 0);
  }
  void add_trtWtKip(int32_t trtWtKip) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_TRTWTKIP, trtWtKip, 0);
  }
  void add_ddtWtKip(int32_t ddtWtKip) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_DDTWTKIP, ddtWtKip, 0);
  }
  void add_sWtKN(int32_t sWtKN) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_SWTKN, sWtKN, 0);
  }
  void add_tWtKN(int32_t tWtKN) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_TWTKN, tWtKN, 0);
  }
  void add_stWtKN(int32_t stWtKN) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_STWTKN, stWtKN, 0);
  }
  void add_ttWtKN(int32_t ttWtKN) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_TTWTKN, ttWtKN, 0);
  }
  void add_ddWtKN(int32_t ddWtKN) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_DDWTKN, ddWtKN, 0);
  }
  void add_sbttWtKN(int32_t sbttWtKN) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_SBTTWTKN, sbttWtKN, 0);
  }
  void add_tdtWtKN(int32_t tdtWtKN) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_TDTWTKN, tdtWtKN, 0);
  }
  void add_trtWtKN(int32_t trtWtKN) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_TRTWTKN, trtWtKN, 0);
  }
  void add_ddtWtKN(int32_t ddtWtKN) {
    fbb_.AddElement<int32_t>(Surface_Full::VT_DDTWTKN, ddtWtKN, 0);
  }
  void add_lighting(bool lighting) {
    fbb_.AddElement<uint8_t>(Surface_Full::VT_LIGHTING, static_cast<uint8_t>(lighting), 0);
  }
  void add_lightsUNKN(bool lightsUNKN) {
    fbb_.AddElement<uint8_t>(Surface_Full::VT_LIGHTSUNKN, static_cast<uint8_t>(lightsUNKN), 0);
  }
  void add_lightsAPRCH(bool lightsAPRCH) {
    fbb_.AddElement<uint8_t>(Surface_Full::VT_LIGHTSAPRCH, static_cast<uint8_t>(lightsAPRCH), 0);
  }
  void add_lightsVASI(bool lightsVASI) {
    fbb_.AddElement<uint8_t>(Surface_Full::VT_LIGHTSVASI, static_cast<uint8_t>(lightsVASI), 0);
  }
  void add_lightsPAPI(bool lightsPAPI) {
    fbb_.AddElement<uint8_t>(Surface_Full::VT_LIGHTSPAPI, static_cast<uint8_t>(lightsPAPI), 0);
  }
  void add_lightsOLS(bool lightsOLS) {
    fbb_.AddElement<uint8_t>(Surface_Full::VT_LIGHTSOLS, static_cast<uint8_t>(lightsOLS), 0);
  }
  void add_lightsREIL(bool lightsREIL) {
    fbb_.AddElement<uint8_t>(Surface_Full::VT_LIGHTSREIL, static_cast<uint8_t>(lightsREIL), 0);
  }
  void add_lightsTDZL(bool lightsTDZL) {
    fbb_.AddElement<uint8_t>(Surface_Full::VT_LIGHTSTDZL, static_cast<uint8_t>(lightsTDZL), 0);
  }
  void add_lightsCL(bool lightsCL) {
    fbb_.AddElement<uint8_t>(Surface_Full::VT_LIGHTSCL, static_cast<uint8_t>(lightsCL), 0);
  }
  void add_obstacle(bool obstacle) {
    fbb_.AddElement<uint8_t>(Surface_Full::VT_OBSTACLE, static_cast<uint8_t>(obstacle), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Surface_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Surface_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(Surface_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(Surface_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Surface_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Surface_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Surface_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(Surface_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Surface_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit Surface_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Surface_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Surface_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Surface_Full> CreateSurface_Full(
    ...
    Surface_Full_dataMode_Enum dataMode = Surface_Full_dataMode_Enum_REAL) {
  Surface_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Surface_Full> CreateSurface_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Surface_Full *GetSurface_Full(const void *buf) {
  return ::flatbuffers::GetRoot<Surface_Full>(buf);
}

inline const Surface_Full *GetSizePrefixedSurface_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Surface_Full>(buf);
}

inline const char *Surface_FullIdentifier() {
  return "SURF";
}

inline bool Surface_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Surface_FullIdentifier());
}

inline bool SizePrefixedSurface_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Surface_FullIdentifier(), true);
}

inline bool VerifySurface_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Surface_Full>(Surface_FullIdentifier());
}

inline bool VerifySizePrefixedSurface_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Surface_Full>(Surface_FullIdentifier());
}

inline void FinishSurface_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Surface_Full> root) {
  fbb.Finish(root, Surface_FullIdentifier());
}

inline void FinishSizePrefixedSurface_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Surface_Full> root) {
  fbb.FinishSizePrefixed(root, Surface_FullIdentifier());
}
