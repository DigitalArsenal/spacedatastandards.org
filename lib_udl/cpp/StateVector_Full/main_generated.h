...
struct StateVector_Full;
struct StateVector_FullBuilder;

enum StateVector_Full_referenceFrame_Enum : int8_t {
  ...
  StateVector_Full_referenceFrame_Enum_MIN = StateVector_Full_referenceFrame_Enum_J2000,
  StateVector_Full_referenceFrame_Enum_MAX = StateVector_Full_referenceFrame_Enum_GCRF
};

inline const StateVector_Full_referenceFrame_Enum (&EnumValuesStateVector_Full_referenceFrame_Enum())[6] {
  static const StateVector_Full_referenceFrame_Enum values[] = {
    StateVector_Full_referenceFrame_Enum_J2000,
    StateVector_Full_referenceFrame_Enum_EFG_TDR,
    StateVector_Full_referenceFrame_Enum_ECR_ECEF,
    StateVector_Full_referenceFrame_Enum_TEME,
    StateVector_Full_referenceFrame_Enum_ITRF,
    StateVector_Full_referenceFrame_Enum_GCRF
  };
  return values;
}

inline const char * const *EnumNamesStateVector_Full_referenceFrame_Enum() {
...
inline const char *EnumNameStateVector_Full_referenceFrame_Enum(StateVector_Full_referenceFrame_Enum e) {
  if (::flatbuffers::IsOutRange(e, StateVector_Full_referenceFrame_Enum_J2000, StateVector_Full_referenceFrame_Enum_GCRF)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesStateVector_Full_referenceFrame_Enum()[index];
}

enum StateVector_Full_covReferenceFrame_Enum : int8_t {
  /// No description available.
  StateVector_Full_covReferenceFrame_Enum_J2000 = 0,
  /// No description available.
  StateVector_Full_covReferenceFrame_Enum_UVW = 1,
  StateVector_Full_covReferenceFrame_Enum_MIN = StateVector_Full_covReferenceFrame_Enum_J2000,
  StateVector_Full_covReferenceFrame_Enum_MAX = StateVector_Full_covReferenceFrame_Enum_UVW
};

inline const StateVector_Full_covReferenceFrame_Enum (&EnumValuesStateVector_Full_covReferenceFrame_Enum())[2] {
  static const StateVector_Full_covReferenceFrame_Enum values[] = {
    StateVector_Full_covReferenceFrame_Enum_J2000,
    StateVector_Full_covReferenceFrame_Enum_UVW
  };
  return values;
}

inline const char * const *EnumNamesStateVector_Full_covReferenceFrame_Enum() {
...
inline const char *EnumNameStateVector_Full_covReferenceFrame_Enum(StateVector_Full_covReferenceFrame_Enum e) {
  if (::flatbuffers::IsOutRange(e, StateVector_Full_covReferenceFrame_Enum_J2000, StateVector_Full_covReferenceFrame_Enum_UVW)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesStateVector_Full_covReferenceFrame_Enum()[index];
}

enum StateVector_Full_dataMode_Enum : int8_t {
  ...
  StateVector_Full_dataMode_Enum_MIN = StateVector_Full_dataMode_Enum_REAL,
  StateVector_Full_dataMode_Enum_MAX = StateVector_Full_dataMode_Enum_EXERCISE
};

inline const StateVector_Full_dataMode_Enum (&EnumValuesStateVector_Full_dataMode_Enum())[4] {
  static const StateVector_Full_dataMode_Enum values[] = {
    StateVector_Full_dataMode_Enum_REAL,
    StateVector_Full_dataMode_Enum_TEST,
    StateVector_Full_dataMode_Enum_SIMULATED,
    StateVector_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesStateVector_Full_dataMode_Enum() {
...
inline const char *EnumNameStateVector_Full_dataMode_Enum(StateVector_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, StateVector_Full_dataMode_Enum_REAL, StateVector_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesStateVector_Full_dataMode_Enum()[index];
}

enum StateVector_Full_sourcedDataTypes_Enum : int8_t {
  /// No description available.
  ...
  StateVector_Full_sourcedDataTypes_Enum_MIN = StateVector_Full_sourcedDataTypes_Enum_EO,
  StateVector_Full_sourcedDataTypes_Enum_MAX = StateVector_Full_sourcedDataTypes_Enum_SV
};

inline const StateVector_Full_sourcedDataTypes_Enum (&EnumValuesStateVector_Full_sourcedDataTypes_Enum())[6] {
  static const StateVector_Full_sourcedDataTypes_Enum values[] = {
    StateVector_Full_sourcedDataTypes_Enum_EO,
    StateVector_Full_sourcedDataTypes_Enum_RADAR,
    StateVector_Full_sourcedDataTypes_Enum_RF,
    StateVector_Full_sourcedDataTypes_Enum_DOA,
    StateVector_Full_sourcedDataTypes_Enum_ELSET,
    StateVector_Full_sourcedDataTypes_Enum_SV
  };
  return values;
}

inline const char * const *EnumNamesStateVector_Full_sourcedDataTypes_Enum() {
  static const char * const names[7] = {
    "EO",
    "RADAR",
    "RF",
...
inline const char *EnumNameStateVector_Full_sourcedDataTypes_Enum(StateVector_Full_sourcedDataTypes_Enum e) {
  if (::flatbuffers::IsOutRange(e, StateVector_Full_sourcedDataTypes_Enum_EO, StateVector_Full_sourcedDataTypes_Enum_SV)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesStateVector_Full_sourcedDataTypes_Enum()[index];
}
...
struct StateVector_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef StateVector_FullBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_SIGMAVELUVW = 164,
    VT_RMS = 166,
    VT_EFFECTIVEFROM = 168,
    VT_EFFECTIVEUNTIL = 170,
    VT_RAWFILEURI = 172,
    VT_SOURCE = 174,
    VT_ORIGIN = 176,
    VT_DATAMODE = 178,
    ...
    VT_ALGORITHM = 182,
    VT_SOURCEDDATA = 184,
    VT_SOURCEDDATATYPES = 186,
    VT_CREATEDAT = 188,
    VT_CREATEDBY = 190,
    VT_ONORBIT = 192,
    VT_DESCRIPTOR = 194,
    VT_TRANSACTIONID = 196,
    VT_ORIGNETWORK = 198,
    VT_SOURCEDL = 200
  };
  ...
  StateVector_Full_referenceFrame_Enum referenceFrame() const {
    return static_cast<StateVector_Full_referenceFrame_Enum>(GetField<int8_t>(VT_REFERENCEFRAME, 0));
  }
  ...
  /// Example: /// Example: J2000
  /// Constraints: Minimum length = 0, Maximum length = 24
  StateVector_Full_covReferenceFrame_Enum covReferenceFrame() const {
    return static_cast<StateVector_Full_covReferenceFrame_Enum>(GetField<int8_t>(VT_COVREFERENCEFRAME, 0));
  }
  ...
  StateVector_Full_dataMode_Enum dataMode() const {
    return static_cast<StateVector_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
  ...
  /// Constraints: No constraints specified.
  StateVector_Full_sourcedDataTypes_Enum sourcedDataTypes() const {
    return static_cast<StateVector_Full_sourcedDataTypes_Enum>(GetField<int8_t>(VT_SOURCEDDATATYPES, 0));
  }
...
struct StateVector_FullBuilder {
  typedef StateVector_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_idStateVector(::flatbuffers::Offset<::flatbuffers::String> idStateVector) {
    fbb_.AddOffset(StateVector_Full::VT_IDSTATEVECTOR, idStateVector);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(StateVector_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_epoch(::flatbuffers::Offset<::flatbuffers::String> epoch) {
    fbb_.AddOffset(StateVector_Full::VT_EPOCH, epoch);
  }
  void add_pedigree(::flatbuffers::Offset<::flatbuffers::String> pedigree) {
    fbb_.AddOffset(StateVector_Full::VT_PEDIGREE, pedigree);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(StateVector_Full::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(StateVector_Full::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(StateVector_Full::VT_ORIGOBJECTID, origObjectId);
  }
  void add_idOrbitDetermination(::flatbuffers::Offset<::flatbuffers::String> idOrbitDetermination) {
    fbb_.AddOffset(StateVector_Full::VT_IDORBITDETERMINATION, idOrbitDetermination);
  }
  void add_uct(bool uct) {
    fbb_.AddElement<uint8_t>(StateVector_Full::VT_UCT, static_cast<uint8_t>(uct), 0);
  }
  void add_xpos(double xpos) {
    fbb_.AddElement<double>(StateVector_Full::VT_XPOS, xpos, 0.0);
  }
  void add_ypos(double ypos) {
    fbb_.AddElement<double>(StateVector_Full::VT_YPOS, ypos, 0.0);
  }
  void add_zpos(double zpos) {
    fbb_.AddElement<double>(StateVector_Full::VT_ZPOS, zpos, 0.0);
  }
  void add_xvel(double xvel) {
    fbb_.AddElement<double>(StateVector_Full::VT_XVEL, xvel, 0.0);
  }
  void add_yvel(double yvel) {
    fbb_.AddElement<double>(StateVector_Full::VT_YVEL, yvel, 0.0);
  }
  void add_zvel(double zvel) {
    fbb_.AddElement<double>(StateVector_Full::VT_ZVEL, zvel, 0.0);
  }
  void add_referenceFrame(StateVector_Full_referenceFrame_Enum referenceFrame) {
    fbb_.AddElement<int8_t>(StateVector_Full::VT_REFERENCEFRAME, static_cast<int8_t>(referenceFrame), 0);
  }
  void add_cov(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> cov) {
    fbb_.AddOffset(StateVector_Full::VT_COV, cov);
  }
  void add_covReferenceFrame(StateVector_Full_covReferenceFrame_Enum covReferenceFrame) {
    fbb_.AddElement<int8_t>(StateVector_Full::VT_COVREFERENCEFRAME, static_cast<int8_t>(covReferenceFrame), 0);
  }
  void add_covMethod(::flatbuffers::Offset<::flatbuffers::String> covMethod) {
    fbb_.AddOffset(StateVector_Full::VT_COVMETHOD, covMethod);
  }
  void add_eqCov(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> eqCov) {
    fbb_.AddOffset(StateVector_Full::VT_EQCOV, eqCov);
  }
  void add_xposAlt1(double xposAlt1) {
    fbb_.AddElement<double>(StateVector_Full::VT_XPOSALT1, xposAlt1, 0.0);
  }
  void add_yposAlt1(double yposAlt1) {
    fbb_.AddElement<double>(StateVector_Full::VT_YPOSALT1, yposAlt1, 0.0);
  }
  void add_zposAlt1(double zposAlt1) {
    fbb_.AddElement<double>(StateVector_Full::VT_ZPOSALT1, zposAlt1, 0.0);
  }
  void add_xvelAlt1(double xvelAlt1) {
    fbb_.AddElement<double>(StateVector_Full::VT_XVELALT1, xvelAlt1, 0.0);
  }
  void add_yvelAlt1(double yvelAlt1) {
    fbb_.AddElement<double>(StateVector_Full::VT_YVELALT1, yvelAlt1, 0.0);
  }
  void add_zvelAlt1(double zvelAlt1) {
    fbb_.AddElement<double>(StateVector_Full::VT_ZVELALT1, zvelAlt1, 0.0);
  }
  void add_alt1ReferenceFrame(::flatbuffers::Offset<::flatbuffers::String> alt1ReferenceFrame) {
    fbb_.AddOffset(StateVector_Full::VT_ALT1REFERENCEFRAME, alt1ReferenceFrame);
  }
  void add_xposAlt2(double xposAlt2) {
    fbb_.AddElement<double>(StateVector_Full::VT_XPOSALT2, xposAlt2, 0.0);
  }
  void add_yposAlt2(double yposAlt2) {
    fbb_.AddElement<double>(StateVector_Full::VT_YPOSALT2, yposAlt2, 0.0);
  }
  void add_zposAlt2(double zposAlt2) {
    fbb_.AddElement<double>(StateVector_Full::VT_ZPOSALT2, zposAlt2, 0.0);
  }
  void add_xvelAlt2(double xvelAlt2) {
    fbb_.AddElement<double>(StateVector_Full::VT_XVELALT2, xvelAlt2, 0.0);
  }
  void add_yvelAlt2(double yvelAlt2) {
    fbb_.AddElement<double>(StateVector_Full::VT_YVELALT2, yvelAlt2, 0.0);
  }
  void add_zvelAlt2(double zvelAlt2) {
    fbb_.AddElement<double>(StateVector_Full::VT_ZVELALT2, zvelAlt2, 0.0);
  }
  void add_alt2ReferenceFrame(::flatbuffers::Offset<::flatbuffers::String> alt2ReferenceFrame) {
    fbb_.AddOffset(StateVector_Full::VT_ALT2REFERENCEFRAME, alt2ReferenceFrame);
  }
  void add_posUnc(double posUnc) {
    fbb_.AddElement<double>(StateVector_Full::VT_POSUNC, posUnc, 0.0);
  }
  void add_velUnc(double velUnc) {
    fbb_.AddElement<double>(StateVector_Full::VT_VELUNC, velUnc, 0.0);
  }
  void add_mass(double mass) {
    fbb_.AddElement<double>(StateVector_Full::VT_MASS, mass, 0.0);
  }
  void add_area(double area) {
    fbb_.AddElement<double>(StateVector_Full::VT_AREA, area, 0.0);
  }
  void add_solarRadPressCoeff(double solarRadPressCoeff) {
    fbb_.AddElement<double>(StateVector_Full::VT_SOLARRADPRESSCOEFF, solarRadPressCoeff, 0.0);
  }
  void add_dragCoeff(double dragCoeff) {
    fbb_.AddElement<double>(StateVector_Full::VT_DRAGCOEFF, dragCoeff, 0.0);
  }
  void add_dragArea(double dragArea) {
    fbb_.AddElement<double>(StateVector_Full::VT_DRAGAREA, dragArea, 0.0);
  }
  void add_revNo(int32_t revNo) {
    fbb_.AddElement<int32_t>(StateVector_Full::VT_REVNO, revNo, 0);
  }
  void add_geopotentialModel(::flatbuffers::Offset<::flatbuffers::String> geopotentialModel) {
    fbb_.AddOffset(StateVector_Full::VT_GEOPOTENTIALMODEL, geopotentialModel);
  }
  void add_dragModel(::flatbuffers::Offset<::flatbuffers::String> dragModel) {
    fbb_.AddOffset(StateVector_Full::VT_DRAGMODEL, dragModel);
  }
  void add_lunarSolar(bool lunarSolar) {
    fbb_.AddElement<uint8_t>(StateVector_Full::VT_LUNARSOLAR, static_cast<uint8_t>(lunarSolar), 0);
  }
  void add_solarRadPress(bool solarRadPress) {
    fbb_.AddElement<uint8_t>(StateVector_Full::VT_SOLARRADPRESS, static_cast<uint8_t>(solarRadPress), 0);
  }
  void add_srpArea(double srpArea) {
    fbb_.AddElement<double>(StateVector_Full::VT_SRPAREA, srpArea, 0.0);
  }
  void add_solidEarthTides(bool solidEarthTides) {
    fbb_.AddElement<uint8_t>(StateVector_Full::VT_SOLIDEARTHTIDES, static_cast<uint8_t>(solidEarthTides), 0);
  }
  void add_inTrackThrust(bool inTrackThrust) {
    fbb_.AddElement<uint8_t>(StateVector_Full::VT_INTRACKTHRUST, static_cast<uint8_t>(inTrackThrust), 0);
  }
  void add_bDot(double bDot) {
    fbb_.AddElement<double>(StateVector_Full::VT_BDOT, bDot, 0.0);
  }
  void add_edr(double edr) {
    fbb_.AddElement<double>(StateVector_Full::VT_EDR, edr, 0.0);
  }
  void add_thrustAccel(double thrustAccel) {
    fbb_.AddElement<double>(StateVector_Full::VT_THRUSTACCEL, thrustAccel, 0.0);
  }
  void add_cmOffset(double cmOffset) {
    fbb_.AddElement<double>(StateVector_Full::VT_CMOFFSET, cmOffset, 0.0);
  }
  void add_lastObStart(::flatbuffers::Offset<::flatbuffers::String> lastObStart) {
    fbb_.AddOffset(StateVector_Full::VT_LASTOBSTART, lastObStart);
  }
  void add_lastObEnd(::flatbuffers::Offset<::flatbuffers::String> lastObEnd) {
    fbb_.AddOffset(StateVector_Full::VT_LASTOBEND, lastObEnd);
  }
  void add_obsAvailable(int32_t obsAvailable) {
    fbb_.AddElement<int32_t>(StateVector_Full::VT_OBSAVAILABLE, obsAvailable, 0);
  }
  void add_obsUsed(int32_t obsUsed) {
    fbb_.AddElement<int32_t>(StateVector_Full::VT_OBSUSED, obsUsed, 0);
  }
  void add_tracksAvail(int32_t tracksAvail) {
    fbb_.AddElement<int32_t>(StateVector_Full::VT_TRACKSAVAIL, tracksAvail, 0);
  }
  void add_tracksUsed(int32_t tracksUsed) {
    fbb_.AddElement<int32_t>(StateVector_Full::VT_TRACKSUSED, tracksUsed, 0);
  }
  void add_recODSpan(double recODSpan) {
    fbb_.AddElement<double>(StateVector_Full::VT_RECODSPAN, recODSpan, 0.0);
  }
  void add_actualODSpan(double actualODSpan) {
    fbb_.AddElement<double>(StateVector_Full::VT_ACTUALODSPAN, actualODSpan, 0.0);
  }
  void add_residualsAcc(double residualsAcc) {
    fbb_.AddElement<double>(StateVector_Full::VT_RESIDUALSACC, residualsAcc, 0.0);
  }
  void add_solarFluxF10(double solarFluxF10) {
    fbb_.AddElement<double>(StateVector_Full::VT_SOLARFLUXF10, solarFluxF10, 0.0);
  }
  void add_solarFluxF10Avg(double solarFluxF10Avg) {
    fbb_.AddElement<double>(StateVector_Full::VT_SOLARFLUXF10AVG, solarFluxF10Avg, 0.0);
  }
  void add_solarFluxAPAvg(double solarFluxAPAvg) {
    fbb_.AddElement<double>(StateVector_Full::VT_SOLARFLUXAPAVG, solarFluxAPAvg, 0.0);
  }
  void add_taiUtc(double taiUtc) {
    fbb_.AddElement<double>(StateVector_Full::VT_TAIUTC, taiUtc, 0.0);
  }
  void add_ut1Utc(double ut1Utc) {
    fbb_.AddElement<double>(StateVector_Full::VT_UT1UTC, ut1Utc, 0.0);
  }
  void add_ut1Rate(double ut1Rate) {
    fbb_.AddElement<double>(StateVector_Full::VT_UT1RATE, ut1Rate, 0.0);
  }
  void add_polarMotionX(double polarMotionX) {
    fbb_.AddElement<double>(StateVector_Full::VT_POLARMOTIONX, polarMotionX, 0.0);
  }
  void add_polarMotionY(double polarMotionY) {
    fbb_.AddElement<double>(StateVector_Full::VT_POLARMOTIONY, polarMotionY, 0.0);
  }
  void add_iau1980Terms(int32_t iau1980Terms) {
    fbb_.AddElement<int32_t>(StateVector_Full::VT_IAU1980TERMS, iau1980Terms, 0);
  }
  void add_leapSecondTime(::flatbuffers::Offset<::flatbuffers::String> leapSecondTime) {
    fbb_.AddOffset(StateVector_Full::VT_LEAPSECONDTIME, leapSecondTime);
  }
  void add_integratorMode(::flatbuffers::Offset<::flatbuffers::String> integratorMode) {
    fbb_.AddOffset(StateVector_Full::VT_INTEGRATORMODE, integratorMode);
  }
  void add_partials(::flatbuffers::Offset<::flatbuffers::String> partials) {
    fbb_.AddOffset(StateVector_Full::VT_PARTIALS, partials);
  }
  void add_stepMode(::flatbuffers::Offset<::flatbuffers::String> stepMode) {
    fbb_.AddOffset(StateVector_Full::VT_STEPMODE, stepMode);
  }
  void add_fixedStep(bool fixedStep) {
    fbb_.AddElement<uint8_t>(StateVector_Full::VT_FIXEDSTEP, static_cast<uint8_t>(fixedStep), 0);
  }
  void add_stepSizeSelection(::flatbuffers::Offset<::flatbuffers::String> stepSizeSelection) {
    fbb_.AddOffset(StateVector_Full::VT_STEPSIZESELECTION, stepSizeSelection);
  }
  void add_stepSize(double stepSize) {
    fbb_.AddElement<double>(StateVector_Full::VT_STEPSIZE, stepSize, 0.0);
  }
  void add_errorControl(double errorControl) {
    fbb_.AddElement<double>(StateVector_Full::VT_ERRORCONTROL, errorControl, 0.0);
  }
  void add_sigmaPosUVW(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sigmaPosUVW) {
    fbb_.AddOffset(StateVector_Full::VT_SIGMAPOSUVW, sigmaPosUVW);
  }
  void add_sigmaVelUVW(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sigmaVelUVW) {
    fbb_.AddOffset(StateVector_Full::VT_SIGMAVELUVW, sigmaVelUVW);
  }
  void add_rms(double rms) {
    fbb_.AddElement<double>(StateVector_Full::VT_RMS, rms, 0.0);
  }
  void add_effectiveFrom(::flatbuffers::Offset<::flatbuffers::String> effectiveFrom) {
    fbb_.AddOffset(StateVector_Full::VT_EFFECTIVEFROM, effectiveFrom);
  }
  void add_effectiveUntil(::flatbuffers::Offset<::flatbuffers::String> effectiveUntil) {
    fbb_.AddOffset(StateVector_Full::VT_EFFECTIVEUNTIL, effectiveUntil);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(StateVector_Full::VT_RAWFILEURI, rawFileURI);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(StateVector_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(StateVector_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(StateVector_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(StateVector_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(StateVector_Full::VT_TAGS, tags);
  }
  void add_algorithm(::flatbuffers::Offset<::flatbuffers::String> algorithm) {
    fbb_.AddOffset(StateVector_Full::VT_ALGORITHM, algorithm);
  }
  void add_sourcedData(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sourcedData) {
    fbb_.AddOffset(StateVector_Full::VT_SOURCEDDATA, sourcedData);
  }
  void add_sourcedDataTypes(StateVector_Full_sourcedDataTypes_Enum sourcedDataTypes) {
    fbb_.AddElement<int8_t>(StateVector_Full::VT_SOURCEDDATATYPES, static_cast<int8_t>(sourcedDataTypes), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(StateVector_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(StateVector_Full::VT_CREATEDBY, createdBy);
  }
  void add_onOrbit(::flatbuffers::Offset<::flatbuffers::String> onOrbit) {
    fbb_.AddOffset(StateVector_Full::VT_ONORBIT, onOrbit);
  }
  void add_descriptor(::flatbuffers::Offset<::flatbuffers::String> descriptor) {
    fbb_.AddOffset(StateVector_Full::VT_DESCRIPTOR, descriptor);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(StateVector_Full::VT_TRANSACTIONID, transactionId);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(StateVector_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(StateVector_Full::VT_SOURCEDL, sourceDL);
  }
  explicit StateVector_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<StateVector_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<StateVector_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<StateVector_Full> CreateStateVector_Full(
    ...
    double yvel = 0.0,
    double zvel = 0.0,
    StateVector_Full_referenceFrame_Enum referenceFrame = StateVector_Full_referenceFrame_Enum_J2000,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> cov = 0,
    StateVector_Full_covReferenceFrame_Enum covReferenceFrame = StateVector_Full_covReferenceFrame_Enum_J2000,
    ...
    StateVector_Full_dataMode_Enum dataMode = StateVector_Full_dataMode_Enum_REAL,
    ...
    StateVector_Full_sourcedDataTypes_Enum sourcedDataTypes = StateVector_Full_sourcedDataTypes_Enum_EO,
  ...
  StateVector_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<StateVector_Full> CreateStateVector_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const StateVector_Full *GetStateVector_Full(const void *buf) {
  return ::flatbuffers::GetRoot<StateVector_Full>(buf);
}

inline const StateVector_Full *GetSizePrefixedStateVector_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<StateVector_Full>(buf);
}

inline const char *StateVector_FullIdentifier() {
  return "STAT";
}

inline bool StateVector_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, StateVector_FullIdentifier());
}

inline bool SizePrefixedStateVector_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, StateVector_FullIdentifier(), true);
}

inline bool VerifyStateVector_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<StateVector_Full>(StateVector_FullIdentifier());
}

inline bool VerifySizePrefixedStateVector_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<StateVector_Full>(StateVector_FullIdentifier());
}

inline void FinishStateVector_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<StateVector_Full> root) {
  fbb.Finish(root, StateVector_FullIdentifier());
}

inline void FinishSizePrefixedStateVector_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<StateVector_Full> root) {
  fbb.FinishSizePrefixed(root, StateVector_FullIdentifier());
}
