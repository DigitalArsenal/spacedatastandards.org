...
enum Port_Ingest_dataMode_Enum : int8_t {
  ...
  Port_Ingest_dataMode_Enum_MIN = Port_Ingest_dataMode_Enum_REAL,
  Port_Ingest_dataMode_Enum_MAX = Port_Ingest_dataMode_Enum_EXERCISE
};

inline const Port_Ingest_dataMode_Enum (&EnumValuesPort_Ingest_dataMode_Enum())[4] {
  static const Port_Ingest_dataMode_Enum values[] = {
    Port_Ingest_dataMode_Enum_REAL,
    Port_Ingest_dataMode_Enum_TEST,
    Port_Ingest_dataMode_Enum_SIMULATED,
    Port_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesPort_Ingest_dataMode_Enum() {
...
inline const char *EnumNamePort_Ingest_dataMode_Enum(Port_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Port_Ingest_dataMode_Enum_REAL, Port_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesPort_Ingest_dataMode_Enum()[index];
}

/// /// Properties and characteristics of a maritime port, which includes location, port identifiers, and remarks.
struct Port_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Port_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 64
  Port_Ingest_dataMode_Enum dataMode() const {
    return static_cast<Port_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Port_IngestBuilder {
  typedef Port_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Port_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Port_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idSite(::flatbuffers::Offset<::flatbuffers::String> idSite) {
    fbb_.AddOffset(Port_Ingest::VT_IDSITE, idSite);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(Port_Ingest::VT_EXTERNALID, externalId);
  }
  void add_locode(::flatbuffers::Offset<::flatbuffers::String> locode) {
    fbb_.AddOffset(Port_Ingest::VT_LOCODE, locode);
  }
  void add_portName(::flatbuffers::Offset<::flatbuffers::String> portName) {
    fbb_.AddOffset(Port_Ingest::VT_PORTNAME, portName);
  }
  void add_harborType(::flatbuffers::Offset<::flatbuffers::String> harborType) {
    fbb_.AddOffset(Port_Ingest::VT_HARBORTYPE, harborType);
  }
  void add_harborSize(double harborSize) {
    fbb_.AddElement<double>(Port_Ingest::VT_HARBORSIZE, harborSize, 0.0);
  }
  void add_maxDraught(double maxDraught) {
    fbb_.AddElement<double>(Port_Ingest::VT_MAXDRAUGHT, maxDraught, 0.0);
  }
  void add_avgDuration(double avgDuration) {
    fbb_.AddElement<double>(Port_Ingest::VT_AVGDURATION, avgDuration, 0.0);
  }
  void add_tideRange(double tideRange) {
    fbb_.AddElement<double>(Port_Ingest::VT_TIDERANGE, tideRange, 0.0);
  }
  void add_shelter(::flatbuffers::Offset<::flatbuffers::String> shelter) {
    fbb_.AddOffset(Port_Ingest::VT_SHELTER, shelter);
  }
  void add_pilotReqd(bool pilotReqd) {
    fbb_.AddElement<uint8_t>(Port_Ingest::VT_PILOTREQD, static_cast<uint8_t>(pilotReqd), 0);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(Port_Ingest::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(Port_Ingest::VT_LON, lon, 0.0);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(Port_Ingest::VT_COUNTRYCODE, countryCode);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Port_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Port_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Port_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Port_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(Port_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Port_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Port_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  explicit Port_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Port_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Port_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Port_Ingest> CreatePort_Ingest(
    ...
    Port_Ingest_dataMode_Enum dataMode = Port_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  Port_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Port_Ingest> CreatePort_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Port_Ingest *GetPort_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<Port_Ingest>(buf);
}

inline const Port_Ingest *GetSizePrefixedPort_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Port_Ingest>(buf);
}

inline const char *Port_IngestIdentifier() {
  return "PORT";
}

inline bool Port_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Port_IngestIdentifier());
}

inline bool SizePrefixedPort_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Port_IngestIdentifier(), true);
}

inline bool VerifyPort_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Port_Ingest>(Port_IngestIdentifier());
}

inline bool VerifySizePrefixedPort_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Port_Ingest>(Port_IngestIdentifier());
}

inline void FinishPort_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Port_Ingest> root) {
  fbb.Finish(root, Port_IngestIdentifier());
}

inline void FinishSizePrefixedPort_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Port_Ingest> root) {
  fbb.FinishSizePrefixed(root, Port_IngestIdentifier());
}
