...
struct IonoObservationTime_Ingest;
...
struct IonoObservationTime_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef IonoObservationTime_IngestBuilder Builder;
...
struct IonoObservationTime_IngestBuilder {
  typedef IonoObservationTime_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_dimensions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dimensions) {
    fbb_.AddOffset(IonoObservationTime_Ingest::VT_DIMENSIONS, dimensions);
  }
  void add_dimensionName(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dimensionName) {
    fbb_.AddOffset(IonoObservationTime_Ingest::VT_DIMENSIONNAME, dimensionName);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(IonoObservationTime_Ingest::VT_NOTES, notes);
  }
  void add_data(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> data) {
    fbb_.AddOffset(IonoObservationTime_Ingest::VT_DATA, data);
  }
  explicit IonoObservationTime_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<IonoObservationTime_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<IonoObservationTime_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<IonoObservationTime_Ingest> CreateIonoObservationTime_Ingest(
  ...
  IonoObservationTime_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<IonoObservationTime_Ingest> CreateIonoObservationTime_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const IonoObservationTime_Ingest *GetIonoObservationTime_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<IonoObservationTime_Ingest>(buf);
}

inline const IonoObservationTime_Ingest *GetSizePrefixedIonoObservationTime_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<IonoObservationTime_Ingest>(buf);
}

inline const char *IonoObservationTime_IngestIdentifier() {
  return "IONO";
}

inline bool IonoObservationTime_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationTime_IngestIdentifier());
}

inline bool SizePrefixedIonoObservationTime_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationTime_IngestIdentifier(), true);
}

inline bool VerifyIonoObservationTime_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<IonoObservationTime_Ingest>(IonoObservationTime_IngestIdentifier());
}

inline bool VerifySizePrefixedIonoObservationTime_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<IonoObservationTime_Ingest>(IonoObservationTime_IngestIdentifier());
}

inline void FinishIonoObservationTime_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationTime_Ingest> root) {
  fbb.Finish(root, IonoObservationTime_IngestIdentifier());
}

inline void FinishSizePrefixedIonoObservationTime_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationTime_Ingest> root) {
  fbb.FinishSizePrefixed(root, IonoObservationTime_IngestIdentifier());
}
