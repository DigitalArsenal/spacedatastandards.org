...
struct MtiTargetReport_Abridged;
struct MtiTargetReport_AbridgedBuilder;
...
struct MtiTargetReport_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef MtiTargetReport_AbridgedBuilder Builder;
...
struct MtiTargetReport_AbridgedBuilder {
  typedef MtiTargetReport_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_d32_1(int32_t d32_1) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Abridged::VT_D32_1, d32_1, 0);
  }
  void add_d32_2(double d32_2) {
    fbb_.AddElement<double>(MtiTargetReport_Abridged::VT_D32_2, d32_2, 0.0);
  }
  void add_d32_3(double d32_3) {
    fbb_.AddElement<double>(MtiTargetReport_Abridged::VT_D32_3, d32_3, 0.0);
  }
  void add_d32_4(int32_t d32_4) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Abridged::VT_D32_4, d32_4, 0);
  }
  void add_d32_5(int32_t d32_5) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Abridged::VT_D32_5, d32_5, 0);
  }
  void add_d32_6(int32_t d32_6) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Abridged::VT_D32_6, d32_6, 0);
  }
  void add_d32_7(int32_t d32_7) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Abridged::VT_D32_7, d32_7, 0);
  }
  void add_d32_8(int32_t d32_8) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Abridged::VT_D32_8, d32_8, 0);
  }
  void add_d32_9(int32_t d32_9) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Abridged::VT_D32_9, d32_9, 0);
  }
  void add_d32_10(::flatbuffers::Offset<::flatbuffers::String> d32_10) {
    fbb_.AddOffset(MtiTargetReport_Abridged::VT_D32_10, d32_10);
  }
  void add_d32_11(int32_t d32_11) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Abridged::VT_D32_11, d32_11, 0);
  }
  void add_d32_12(int32_t d32_12) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Abridged::VT_D32_12, d32_12, 0);
  }
  void add_d32_13(int32_t d32_13) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Abridged::VT_D32_13, d32_13, 0);
  }
  void add_d32_14(int32_t d32_14) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Abridged::VT_D32_14, d32_14, 0);
  }
  void add_d32_15(int32_t d32_15) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Abridged::VT_D32_15, d32_15, 0);
  }
  void add_d32_16(int32_t d32_16) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Abridged::VT_D32_16, d32_16, 0);
  }
  void add_d32_17(int64_t d32_17) {
    fbb_.AddElement<int64_t>(MtiTargetReport_Abridged::VT_D32_17, d32_17, 0);
  }
  void add_d32_18(int32_t d32_18) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Abridged::VT_D32_18, d32_18, 0);
  }
  explicit MtiTargetReport_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<MtiTargetReport_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<MtiTargetReport_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<MtiTargetReport_Abridged> CreateMtiTargetReport_Abridged(
    ...
    int64_t d32_17 = 0,
    int32_t d32_18 = 0) {
  MtiTargetReport_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<MtiTargetReport_Abridged> CreateMtiTargetReport_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    int32_t d32_1 = 0,
    double d32_2 = 0.0,
    double d32_3 = 0.0,
...
inline const MtiTargetReport_Abridged *GetMtiTargetReport_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<MtiTargetReport_Abridged>(buf);
}

inline const MtiTargetReport_Abridged *GetSizePrefixedMtiTargetReport_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<MtiTargetReport_Abridged>(buf);
}

inline const char *MtiTargetReport_AbridgedIdentifier() {
  return "MTIT";
}

inline bool MtiTargetReport_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MtiTargetReport_AbridgedIdentifier());
}

inline bool SizePrefixedMtiTargetReport_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MtiTargetReport_AbridgedIdentifier(), true);
}

inline bool VerifyMtiTargetReport_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<MtiTargetReport_Abridged>(MtiTargetReport_AbridgedIdentifier());
}

inline bool VerifySizePrefixedMtiTargetReport_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<MtiTargetReport_Abridged>(MtiTargetReport_AbridgedIdentifier());
}

inline void FinishMtiTargetReport_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MtiTargetReport_Abridged> root) {
  fbb.Finish(root, MtiTargetReport_AbridgedIdentifier());
}

inline void FinishSizePrefixedMtiTargetReport_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MtiTargetReport_Abridged> root) {
  fbb.FinishSizePrefixed(root, MtiTargetReport_AbridgedIdentifier());
}
