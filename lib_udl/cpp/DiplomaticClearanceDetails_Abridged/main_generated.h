...
struct DiplomaticClearanceDetails_Abridged;
struct DiplomaticClearanceDetails_AbridgedBuilder;

/// /// Collection of diplomatic clearance details.
struct DiplomaticClearanceDetails_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef DiplomaticClearanceDetails_AbridgedBuilder Builder;
...
struct DiplomaticClearanceDetails_AbridgedBuilder {
  typedef DiplomaticClearanceDetails_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_idSortie(::flatbuffers::Offset<::flatbuffers::String> idSortie) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_IDSORTIE, idSortie);
  }
  void add_legNum(int32_t legNum) {
    fbb_.AddElement<int32_t>(DiplomaticClearanceDetails_Abridged::VT_LEGNUM, legNum, 0);
  }
  void add_routeString(::flatbuffers::Offset<::flatbuffers::String> routeString) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_ROUTESTRING, routeString);
  }
  void add_validStartTime(::flatbuffers::Offset<::flatbuffers::String> validStartTime) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_VALIDSTARTTIME, validStartTime);
  }
  void add_validEndTime(::flatbuffers::Offset<::flatbuffers::String> validEndTime) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_VALIDENDTIME, validEndTime);
  }
  void add_clearanceId(::flatbuffers::Offset<::flatbuffers::String> clearanceId) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_CLEARANCEID, clearanceId);
  }
  void add_externalClearanceId(::flatbuffers::Offset<::flatbuffers::String> externalClearanceId) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_EXTERNALCLEARANCEID, externalClearanceId);
  }
  void add_clearedCallSign(::flatbuffers::Offset<::flatbuffers::String> clearedCallSign) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_CLEAREDCALLSIGN, clearedCallSign);
  }
  void add_sequenceNum(int32_t sequenceNum) {
    fbb_.AddElement<int32_t>(DiplomaticClearanceDetails_Abridged::VT_SEQUENCENUM, sequenceNum, 0);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_COUNTRYCODE, countryCode);
  }
  void add_altCountryCode(::flatbuffers::Offset<::flatbuffers::String> altCountryCode) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_ALTCOUNTRYCODE, altCountryCode);
  }
  void add_countryName(::flatbuffers::Offset<::flatbuffers::String> countryName) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_COUNTRYNAME, countryName);
  }
  void add_validDesc(::flatbuffers::Offset<::flatbuffers::String> validDesc) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_VALIDDESC, validDesc);
  }
  void add_windowRemark(::flatbuffers::Offset<::flatbuffers::String> windowRemark) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_WINDOWREMARK, windowRemark);
  }
  void add_entryPoint(::flatbuffers::Offset<::flatbuffers::String> entryPoint) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_ENTRYPOINT, entryPoint);
  }
  void add_entryNET(::flatbuffers::Offset<::flatbuffers::String> entryNET) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_ENTRYNET, entryNET);
  }
  void add_exitPoint(::flatbuffers::Offset<::flatbuffers::String> exitPoint) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_EXITPOINT, exitPoint);
  }
  void add_exitNLT(::flatbuffers::Offset<::flatbuffers::String> exitNLT) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_EXITNLT, exitNLT);
  }
  void add_reqICAO(bool reqICAO) {
    fbb_.AddElement<uint8_t>(DiplomaticClearanceDetails_Abridged::VT_REQICAO, static_cast<uint8_t>(reqICAO), 0);
  }
  void add_action(::flatbuffers::Offset<::flatbuffers::String> action) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_ACTION, action);
  }
  void add_status(::flatbuffers::Offset<::flatbuffers::String> status) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_STATUS, status);
  }
  void add_profile(::flatbuffers::Offset<::flatbuffers::String> profile) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_PROFILE, profile);
  }
  void add_reqPoint(bool reqPoint) {
    fbb_.AddElement<uint8_t>(DiplomaticClearanceDetails_Abridged::VT_REQPOINT, static_cast<uint8_t>(reqPoint), 0);
  }
  void add_clearanceRemark(::flatbuffers::Offset<::flatbuffers::String> clearanceRemark) {
    fbb_.AddOffset(DiplomaticClearanceDetails_Abridged::VT_CLEARANCEREMARK, clearanceRemark);
  }
  explicit DiplomaticClearanceDetails_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<DiplomaticClearanceDetails_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<DiplomaticClearanceDetails_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<DiplomaticClearanceDetails_Abridged> CreateDiplomaticClearanceDetails_Abridged(
  ...
  DiplomaticClearanceDetails_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<DiplomaticClearanceDetails_Abridged> CreateDiplomaticClearanceDetails_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const DiplomaticClearanceDetails_Abridged *GetDiplomaticClearanceDetails_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<DiplomaticClearanceDetails_Abridged>(buf);
}

inline const DiplomaticClearanceDetails_Abridged *GetSizePrefixedDiplomaticClearanceDetails_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<DiplomaticClearanceDetails_Abridged>(buf);
}

inline const char *DiplomaticClearanceDetails_AbridgedIdentifier() {
  return "DIPL";
}

inline bool DiplomaticClearanceDetails_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DiplomaticClearanceDetails_AbridgedIdentifier());
}

inline bool SizePrefixedDiplomaticClearanceDetails_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DiplomaticClearanceDetails_AbridgedIdentifier(), true);
}

inline bool VerifyDiplomaticClearanceDetails_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<DiplomaticClearanceDetails_Abridged>(DiplomaticClearanceDetails_AbridgedIdentifier());
}

inline bool VerifySizePrefixedDiplomaticClearanceDetails_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<DiplomaticClearanceDetails_Abridged>(DiplomaticClearanceDetails_AbridgedIdentifier());
}

inline void FinishDiplomaticClearanceDetails_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DiplomaticClearanceDetails_Abridged> root) {
  fbb.Finish(root, DiplomaticClearanceDetails_AbridgedIdentifier());
}

inline void FinishSizePrefixedDiplomaticClearanceDetails_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DiplomaticClearanceDetails_Abridged> root) {
  fbb.FinishSizePrefixed(root, DiplomaticClearanceDetails_AbridgedIdentifier());
}
