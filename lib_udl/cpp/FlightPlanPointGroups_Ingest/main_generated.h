...
struct FlightPlanPointGroups_Ingest;
struct FlightPlanPointGroups_IngestBuilder;
...
struct FlightPlanPointGroups_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef FlightPlanPointGroups_IngestBuilder Builder;
...
struct FlightPlanPointGroups_IngestBuilder {
  typedef FlightPlanPointGroups_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_pointGroupName(::flatbuffers::Offset<::flatbuffers::String> pointGroupName) {
    fbb_.AddOffset(FlightPlanPointGroups_Ingest::VT_POINTGROUPNAME, pointGroupName);
  }
  void add_worstFuelCase(::flatbuffers::Offset<::flatbuffers::String> worstFuelCase) {
    fbb_.AddOffset(FlightPlanPointGroups_Ingest::VT_WORSTFUELCASE, worstFuelCase);
  }
  void add_lsafName(::flatbuffers::Offset<::flatbuffers::String> lsafName) {
    fbb_.AddOffset(FlightPlanPointGroups_Ingest::VT_LSAFNAME, lsafName);
  }
  void add_lsafDistance(double lsafDistance) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Ingest::VT_LSAFDISTANCE, lsafDistance, 0.0);
  }
  void add_fsafDistance(double fsafDistance) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Ingest::VT_FSAFDISTANCE, fsafDistance, 0.0);
  }
  void add_etopsDistance(double etopsDistance) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Ingest::VT_ETOPSDISTANCE, etopsDistance, 0.0);
  }
  void add_lsafTime(::flatbuffers::Offset<::flatbuffers::String> lsafTime) {
    fbb_.AddOffset(FlightPlanPointGroups_Ingest::VT_LSAFTIME, lsafTime);
  }
  void add_fsafTime(::flatbuffers::Offset<::flatbuffers::String> fsafTime) {
    fbb_.AddOffset(FlightPlanPointGroups_Ingest::VT_FSAFTIME, fsafTime);
  }
  void add_etopsTime(::flatbuffers::Offset<::flatbuffers::String> etopsTime) {
    fbb_.AddOffset(FlightPlanPointGroups_Ingest::VT_ETOPSTIME, etopsTime);
  }
  void add_lsafAvgWindFactor(double lsafAvgWindFactor) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Ingest::VT_LSAFAVGWINDFACTOR, lsafAvgWindFactor, 0.0);
  }
  void add_fsafAvgWindFactor(double fsafAvgWindFactor) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Ingest::VT_FSAFAVGWINDFACTOR, fsafAvgWindFactor, 0.0);
  }
  void add_etopsAvgWindFactor(double etopsAvgWindFactor) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Ingest::VT_ETOPSAVGWINDFACTOR, etopsAvgWindFactor, 0.0);
  }
  void add_lsafTempDev(double lsafTempDev) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Ingest::VT_LSAFTEMPDEV, lsafTempDev, 0.0);
  }
  void add_fsafTempDev(double fsafTempDev) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Ingest::VT_FSAFTEMPDEV, fsafTempDev, 0.0);
  }
  void add_etopsTempDev(double etopsTempDev) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Ingest::VT_ETOPSTEMPDEV, etopsTempDev, 0.0);
  }
  void add_lsafReqFuel(double lsafReqFuel) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Ingest::VT_LSAFREQFUEL, lsafReqFuel, 0.0);
  }
  void add_fsafReqFuel(double fsafReqFuel) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Ingest::VT_FSAFREQFUEL, fsafReqFuel, 0.0);
  }
  void add_etopsReqFuel(double etopsReqFuel) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Ingest::VT_ETOPSREQFUEL, etopsReqFuel, 0.0);
  }
  void add_fromTakeoffTime(::flatbuffers::Offset<::flatbuffers::String> fromTakeoffTime) {
    fbb_.AddOffset(FlightPlanPointGroups_Ingest::VT_FROMTAKEOFFTIME, fromTakeoffTime);
  }
  void add_plannedFuel(double plannedFuel) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Ingest::VT_PLANNEDFUEL, plannedFuel, 0.0);
  }
  void add_fuelCalcAlt(double fuelCalcAlt) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Ingest::VT_FUELCALCALT, fuelCalcAlt, 0.0);
  }
  void add_fuelCalcSpd(double fuelCalcSpd) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Ingest::VT_FUELCALCSPD, fuelCalcSpd, 0.0);
  }
  void add_avgFuelFlow(double avgFuelFlow) {
    fbb_.AddElement<double>(FlightPlanPointGroups_Ingest::VT_AVGFUELFLOW, avgFuelFlow, 0.0);
  }
  void add_flightPlanPoints(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> flightPlanPoints) {
    fbb_.AddOffset(FlightPlanPointGroups_Ingest::VT_FLIGHTPLANPOINTS, flightPlanPoints);
  }
  explicit FlightPlanPointGroups_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<FlightPlanPointGroups_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<FlightPlanPointGroups_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<FlightPlanPointGroups_Ingest> CreateFlightPlanPointGroups_Ingest(
  ...
  FlightPlanPointGroups_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<FlightPlanPointGroups_Ingest> CreateFlightPlanPointGroups_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateFlightPlanPointGroups_Ingest(
      _fbb,
      pointGroupName__,
      worstFuelCase__,
      lsafName__,
...
inline const FlightPlanPointGroups_Ingest *GetFlightPlanPointGroups_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<FlightPlanPointGroups_Ingest>(buf);
}

inline const FlightPlanPointGroups_Ingest *GetSizePrefixedFlightPlanPointGroups_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<FlightPlanPointGroups_Ingest>(buf);
}

inline const char *FlightPlanPointGroups_IngestIdentifier() {
  return "FLIG";
}

inline bool FlightPlanPointGroups_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, FlightPlanPointGroups_IngestIdentifier());
}

inline bool SizePrefixedFlightPlanPointGroups_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, FlightPlanPointGroups_IngestIdentifier(), true);
}

inline bool VerifyFlightPlanPointGroups_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<FlightPlanPointGroups_Ingest>(FlightPlanPointGroups_IngestIdentifier());
}

inline bool VerifySizePrefixedFlightPlanPointGroups_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<FlightPlanPointGroups_Ingest>(FlightPlanPointGroups_IngestIdentifier());
}

inline void FinishFlightPlanPointGroups_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<FlightPlanPointGroups_Ingest> root) {
  fbb.Finish(root, FlightPlanPointGroups_IngestIdentifier());
}

inline void FinishSizePrefixedFlightPlanPointGroups_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<FlightPlanPointGroups_Ingest> root) {
  fbb.FinishSizePrefixed(root, FlightPlanPointGroups_IngestIdentifier());
}
