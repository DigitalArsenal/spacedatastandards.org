...
struct OrbitTrack_Full;
struct OrbitTrack_FullBuilder;

enum OrbitTrack_Full_objIdent_Enum : int8_t {
  ...
  OrbitTrack_Full_objIdent_Enum_MIN = OrbitTrack_Full_objIdent_Enum_ASSUMED_FRIEND,
  OrbitTrack_Full_objIdent_Enum_MAX = OrbitTrack_Full_objIdent_Enum_UNKNOWN
};

inline const OrbitTrack_Full_objIdent_Enum (&EnumValuesOrbitTrack_Full_objIdent_Enum())[7] {
  static const OrbitTrack_Full_objIdent_Enum values[] = {
    OrbitTrack_Full_objIdent_Enum_ASSUMED_FRIEND,
    OrbitTrack_Full_objIdent_Enum_FRIEND,
    OrbitTrack_Full_objIdent_Enum_HOSTILE,
    OrbitTrack_Full_objIdent_Enum_NEUTRAL,
    OrbitTrack_Full_objIdent_Enum_PENDING,
    OrbitTrack_Full_objIdent_Enum_SUSPECT,
    OrbitTrack_Full_objIdent_Enum_UNKNOWN
  };
  return values;
}

inline const char * const *EnumNamesOrbitTrack_Full_objIdent_Enum() {
...
inline const char *EnumNameOrbitTrack_Full_objIdent_Enum(OrbitTrack_Full_objIdent_Enum e) {
  if (::flatbuffers::IsOutRange(e, OrbitTrack_Full_objIdent_Enum_ASSUMED_FRIEND, OrbitTrack_Full_objIdent_Enum_UNKNOWN)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOrbitTrack_Full_objIdent_Enum()[index];
}

enum OrbitTrack_Full_objectType_Enum : int8_t {
  ...
  OrbitTrack_Full_objectType_Enum_MIN = OrbitTrack_Full_objectType_Enum_DEBRIS,
  OrbitTrack_Full_objectType_Enum_MAX = OrbitTrack_Full_objectType_Enum_UNKNOWN
};

inline const OrbitTrack_Full_objectType_Enum (&EnumValuesOrbitTrack_Full_objectType_Enum())[6] {
  static const OrbitTrack_Full_objectType_Enum values[] = {
    OrbitTrack_Full_objectType_Enum_DEBRIS,
    OrbitTrack_Full_objectType_Enum_MANNED,
    OrbitTrack_Full_objectType_Enum_PAYLOAD,
    OrbitTrack_Full_objectType_Enum_PLATFORM,
    OrbitTrack_Full_objectType_Enum_ROCKET_BODY,
    OrbitTrack_Full_objectType_Enum_UNKNOWN
  };
  return values;
}

inline const char * const *EnumNamesOrbitTrack_Full_objectType_Enum() {
...
inline const char *EnumNameOrbitTrack_Full_objectType_Enum(OrbitTrack_Full_objectType_Enum e) {
  if (::flatbuffers::IsOutRange(e, OrbitTrack_Full_objectType_Enum_DEBRIS, OrbitTrack_Full_objectType_Enum_UNKNOWN)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOrbitTrack_Full_objectType_Enum()[index];
}

enum OrbitTrack_Full_dataMode_Enum : int8_t {
  ...
  OrbitTrack_Full_dataMode_Enum_MIN = OrbitTrack_Full_dataMode_Enum_REAL,
  OrbitTrack_Full_dataMode_Enum_MAX = OrbitTrack_Full_dataMode_Enum_EXERCISE
};

inline const OrbitTrack_Full_dataMode_Enum (&EnumValuesOrbitTrack_Full_dataMode_Enum())[4] {
  static const OrbitTrack_Full_dataMode_Enum values[] = {
    OrbitTrack_Full_dataMode_Enum_REAL,
    OrbitTrack_Full_dataMode_Enum_TEST,
    OrbitTrack_Full_dataMode_Enum_SIMULATED,
    OrbitTrack_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesOrbitTrack_Full_dataMode_Enum() {
...
inline const char *EnumNameOrbitTrack_Full_dataMode_Enum(OrbitTrack_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, OrbitTrack_Full_dataMode_Enum_REAL, OrbitTrack_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOrbitTrack_Full_dataMode_Enum()[index];
}
...
struct OrbitTrack_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef OrbitTrack_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 0, Maximum length = 32
  OrbitTrack_Full_objIdent_Enum objIdent() const {
    return static_cast<OrbitTrack_Full_objIdent_Enum>(GetField<int8_t>(VT_OBJIDENT, 0));
  }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 32
  OrbitTrack_Full_objectType_Enum objectType() const {
    return static_cast<OrbitTrack_Full_objectType_Enum>(GetField<int8_t>(VT_OBJECTTYPE, 0));
  }
  ...
  OrbitTrack_Full_dataMode_Enum dataMode() const {
    return static_cast<OrbitTrack_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct OrbitTrack_FullBuilder {
  typedef OrbitTrack_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(OrbitTrack_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(OrbitTrack_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(OrbitTrack_Full::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(OrbitTrack_Full::VT_SATNO, satNo, 0);
  }
  void add_onOrbit(::flatbuffers::Offset<::flatbuffers::String> onOrbit) {
    fbb_.AddOffset(OrbitTrack_Full::VT_ONORBIT, onOrbit);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(OrbitTrack_Full::VT_ORIGOBJECTID, origObjectId);
  }
  void add_idElset(::flatbuffers::Offset<::flatbuffers::String> idElset) {
    fbb_.AddOffset(OrbitTrack_Full::VT_IDELSET, idElset);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::String> ts) {
    fbb_.AddOffset(OrbitTrack_Full::VT_TS, ts);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(OrbitTrack_Full::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(OrbitTrack_Full::VT_LON, lon, 0.0);
  }
  void add_alt(double alt) {
    fbb_.AddElement<double>(OrbitTrack_Full::VT_ALT, alt, 0.0);
  }
  void add_rdfRF(double rdfRF) {
    fbb_.AddElement<double>(OrbitTrack_Full::VT_RDFRF, rdfRF, 0.0);
  }
  void add_callSign(::flatbuffers::Offset<::flatbuffers::String> callSign) {
    fbb_.AddOffset(OrbitTrack_Full::VT_CALLSIGN, callSign);
  }
  void add_rptNum(::flatbuffers::Offset<::flatbuffers::String> rptNum) {
    fbb_.AddOffset(OrbitTrack_Full::VT_RPTNUM, rptNum);
  }
  void add_objIdent(OrbitTrack_Full_objIdent_Enum objIdent) {
    fbb_.AddElement<int8_t>(OrbitTrack_Full::VT_OBJIDENT, static_cast<int8_t>(objIdent), 0);
  }
  void add_identAmp(::flatbuffers::Offset<::flatbuffers::String> identAmp) {
    fbb_.AddOffset(OrbitTrack_Full::VT_IDENTAMP, identAmp);
  }
  void add_satStatus(::flatbuffers::Offset<::flatbuffers::String> satStatus) {
    fbb_.AddOffset(OrbitTrack_Full::VT_SATSTATUS, satStatus);
  }
  void add_objectType(OrbitTrack_Full_objectType_Enum objectType) {
    fbb_.AddElement<int8_t>(OrbitTrack_Full::VT_OBJECTTYPE, static_cast<int8_t>(objectType), 0);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(OrbitTrack_Full::VT_COUNTRYCODE, countryCode);
  }
  void add_decay(double decay) {
    fbb_.AddElement<double>(OrbitTrack_Full::VT_DECAY, decay, 0.0);
  }
  void add_charlieLine(::flatbuffers::Offset<::flatbuffers::String> charlieLine) {
    fbb_.AddOffset(OrbitTrack_Full::VT_CHARLIELINE, charlieLine);
  }
  void add_aouType(::flatbuffers::Offset<::flatbuffers::String> aouType) {
    fbb_.AddOffset(OrbitTrack_Full::VT_AOUTYPE, aouType);
  }
  void add_aouData(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> aouData) {
    fbb_.AddOffset(OrbitTrack_Full::VT_AOUDATA, aouData);
  }
  void add_spd(double spd) {
    fbb_.AddElement<double>(OrbitTrack_Full::VT_SPD, spd, 0.0);
  }
  void add_angElev(double angElev) {
    fbb_.AddElement<double>(OrbitTrack_Full::VT_ANGELEV, angElev, 0.0);
  }
  void add_cntnmnt(double cntnmnt) {
    fbb_.AddElement<double>(OrbitTrack_Full::VT_CNTNMNT, cntnmnt, 0.0);
  }
  void add_xref(::flatbuffers::Offset<::flatbuffers::String> xref) {
    fbb_.AddOffset(OrbitTrack_Full::VT_XREF, xref);
  }
  void add_chXRef(::flatbuffers::Offset<::flatbuffers::String> chXRef) {
    fbb_.AddOffset(OrbitTrack_Full::VT_CHXREF, chXRef);
  }
  void add_amplification(::flatbuffers::Offset<::flatbuffers::String> amplification) {
    fbb_.AddOffset(OrbitTrack_Full::VT_AMPLIFICATION, amplification);
  }
  void add_iff(::flatbuffers::Offset<::flatbuffers::String> iff) {
    fbb_.AddOffset(OrbitTrack_Full::VT_IFF, iff);
  }
  void add_reinforced(bool reinforced) {
    fbb_.AddElement<uint8_t>(OrbitTrack_Full::VT_REINFORCED, static_cast<uint8_t>(reinforced), 0);
  }
  void add_reduced(bool reduced) {
    fbb_.AddElement<uint8_t>(OrbitTrack_Full::VT_REDUCED, static_cast<uint8_t>(reduced), 0);
  }
  void add_hq(bool hq) {
    fbb_.AddElement<uint8_t>(OrbitTrack_Full::VT_HQ, static_cast<uint8_t>(hq), 0);
  }
  void add_dummy(bool dummy) {
    fbb_.AddElement<uint8_t>(OrbitTrack_Full::VT_DUMMY, static_cast<uint8_t>(dummy), 0);
  }
  void add_taskForce(bool taskForce) {
    fbb_.AddElement<uint8_t>(OrbitTrack_Full::VT_TASKFORCE, static_cast<uint8_t>(taskForce), 0);
  }
  void add_feint(bool feint) {
    fbb_.AddElement<uint8_t>(OrbitTrack_Full::VT_FEINT, static_cast<uint8_t>(feint), 0);
  }
  void add_installation(bool installation) {
    fbb_.AddElement<uint8_t>(OrbitTrack_Full::VT_INSTALLATION, static_cast<uint8_t>(installation), 0);
  }
  void add_vehType(::flatbuffers::Offset<::flatbuffers::String> vehType) {
    fbb_.AddOffset(OrbitTrack_Full::VT_VEHTYPE, vehType);
  }
  void add_trkId(::flatbuffers::Offset<::flatbuffers::String> trkId) {
    fbb_.AddOffset(OrbitTrack_Full::VT_TRKID, trkId);
  }
  void add_trackSensors(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> trackSensors) {
    fbb_.AddOffset(OrbitTrack_Full::VT_TRACKSENSORS, trackSensors);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(OrbitTrack_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(OrbitTrack_Full::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(OrbitTrack_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(OrbitTrack_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(OrbitTrack_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(OrbitTrack_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(OrbitTrack_Full::VT_ORIGNETWORK, origNetwork);
  }
  explicit OrbitTrack_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<OrbitTrack_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<OrbitTrack_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<OrbitTrack_Full> CreateOrbitTrack_Full(
    ...
    OrbitTrack_Full_objIdent_Enum objIdent = OrbitTrack_Full_objIdent_Enum_ASSUMED_FRIEND,
    ::flatbuffers::Offset<::flatbuffers::String> identAmp = 0,
    ::flatbuffers::Offset<::flatbuffers::String> satStatus = 0,
    OrbitTrack_Full_objectType_Enum objectType = OrbitTrack_Full_objectType_Enum_DEBRIS,
    ...
    OrbitTrack_Full_dataMode_Enum dataMode = OrbitTrack_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  OrbitTrack_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<OrbitTrack_Full> CreateOrbitTrack_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const OrbitTrack_Full *GetOrbitTrack_Full(const void *buf) {
  return ::flatbuffers::GetRoot<OrbitTrack_Full>(buf);
}

inline const OrbitTrack_Full *GetSizePrefixedOrbitTrack_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<OrbitTrack_Full>(buf);
}

inline const char *OrbitTrack_FullIdentifier() {
  return "ORBI";
}

inline bool OrbitTrack_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OrbitTrack_FullIdentifier());
}

inline bool SizePrefixedOrbitTrack_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OrbitTrack_FullIdentifier(), true);
}

inline bool VerifyOrbitTrack_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<OrbitTrack_Full>(OrbitTrack_FullIdentifier());
}

inline bool VerifySizePrefixedOrbitTrack_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<OrbitTrack_Full>(OrbitTrack_FullIdentifier());
}

inline void FinishOrbitTrack_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OrbitTrack_Full> root) {
  fbb.Finish(root, OrbitTrack_FullIdentifier());
}

inline void FinishSizePrefixedOrbitTrack_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OrbitTrack_Full> root) {
  fbb.FinishSizePrefixed(root, OrbitTrack_FullIdentifier());
}
