...
struct AntennaDetails_Full;
struct AntennaDetails_FullBuilder;

enum AntennaDetails_Full_mode_Enum : int8_t {
  /// No description available.
  AntennaDetails_Full_mode_Enum_TX = 0,
  /// No description available.
  AntennaDetails_Full_mode_Enum_RX = 1,
  AntennaDetails_Full_mode_Enum_MIN = AntennaDetails_Full_mode_Enum_TX,
  AntennaDetails_Full_mode_Enum_MAX = AntennaDetails_Full_mode_Enum_RX
};

inline const AntennaDetails_Full_mode_Enum (&EnumValuesAntennaDetails_Full_mode_Enum())[2] {
  static const AntennaDetails_Full_mode_Enum values[] = {
    AntennaDetails_Full_mode_Enum_TX,
    AntennaDetails_Full_mode_Enum_RX
  };
  return values;
}

inline const char * const *EnumNamesAntennaDetails_Full_mode_Enum() {
...
inline const char *EnumNameAntennaDetails_Full_mode_Enum(AntennaDetails_Full_mode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AntennaDetails_Full_mode_Enum_TX, AntennaDetails_Full_mode_Enum_RX)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAntennaDetails_Full_mode_Enum()[index];
}

enum AntennaDetails_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  AntennaDetails_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  AntennaDetails_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  AntennaDetails_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  AntennaDetails_Full_dataMode_Enum_EXERCISE = 3,
  AntennaDetails_Full_dataMode_Enum_MIN = AntennaDetails_Full_dataMode_Enum_REAL,
  AntennaDetails_Full_dataMode_Enum_MAX = AntennaDetails_Full_dataMode_Enum_EXERCISE
};

inline const AntennaDetails_Full_dataMode_Enum (&EnumValuesAntennaDetails_Full_dataMode_Enum())[4] {
  static const AntennaDetails_Full_dataMode_Enum values[] = {
    AntennaDetails_Full_dataMode_Enum_REAL,
    AntennaDetails_Full_dataMode_Enum_TEST,
    AntennaDetails_Full_dataMode_Enum_SIMULATED,
    AntennaDetails_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAntennaDetails_Full_dataMode_Enum() {
...
inline const char *EnumNameAntennaDetails_Full_dataMode_Enum(AntennaDetails_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AntennaDetails_Full_dataMode_Enum_REAL, AntennaDetails_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAntennaDetails_Full_dataMode_Enum()[index];
}
...
struct AntennaDetails_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AntennaDetails_FullBuilder Builder;
  ...
  AntennaDetails_Full_mode_Enum mode() const {
    return static_cast<AntennaDetails_Full_mode_Enum>(GetField<int8_t>(VT_MODE, 0));
  }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  AntennaDetails_Full_dataMode_Enum dataMode() const {
    return static_cast<AntennaDetails_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AntennaDetails_FullBuilder {
  typedef AntennaDetails_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AntennaDetails_Full::VT_ID, id);
  }
  void add_idAntenna(::flatbuffers::Offset<::flatbuffers::String> idAntenna) {
    fbb_.AddOffset(AntennaDetails_Full::VT_IDANTENNA, idAntenna);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AntennaDetails_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(AntennaDetails_Full::VT_TYPE, type);
  }
  void add_position(::flatbuffers::Offset<::flatbuffers::String> position) {
    fbb_.AddOffset(AntennaDetails_Full::VT_POSITION, position);
  }
  void add_mode(AntennaDetails_Full_mode_Enum mode) {
    fbb_.AddElement<int8_t>(AntennaDetails_Full::VT_MODE, static_cast<int8_t>(mode), 0);
  }
  void add_steerable(bool steerable) {
    fbb_.AddElement<uint8_t>(AntennaDetails_Full::VT_STEERABLE, static_cast<uint8_t>(steerable), 0);
  }
  void add_beamForming(bool beamForming) {
    fbb_.AddElement<uint8_t>(AntennaDetails_Full::VT_BEAMFORMING, static_cast<uint8_t>(beamForming), 0);
  }
  void add_manufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrgId) {
    fbb_.AddOffset(AntennaDetails_Full::VT_MANUFACTURERORGID, manufacturerOrgId);
  }
  void add_diameter(double diameter) {
    fbb_.AddElement<double>(AntennaDetails_Full::VT_DIAMETER, diameter, 0.0);
  }
  void add_size(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> size) {
    fbb_.AddOffset(AntennaDetails_Full::VT_SIZE, size);
  }
  void add_startFrequency(double startFrequency) {
    fbb_.AddElement<double>(AntennaDetails_Full::VT_STARTFREQUENCY, startFrequency, 0.0);
  }
  void add_endFrequency(double endFrequency) {
    fbb_.AddElement<double>(AntennaDetails_Full::VT_ENDFREQUENCY, endFrequency, 0.0);
  }
  void add_beamwidth(double beamwidth) {
    fbb_.AddElement<double>(AntennaDetails_Full::VT_BEAMWIDTH, beamwidth, 0.0);
  }
  void add_gain(double gain) {
    fbb_.AddElement<double>(AntennaDetails_Full::VT_GAIN, gain, 0.0);
  }
  void add_gainTolerance(double gainTolerance) {
    fbb_.AddElement<double>(AntennaDetails_Full::VT_GAINTOLERANCE, gainTolerance, 0.0);
  }
  void add_polarization(double polarization) {
    fbb_.AddElement<double>(AntennaDetails_Full::VT_POLARIZATION, polarization, 0.0);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(AntennaDetails_Full::VT_DESCRIPTION, description);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AntennaDetails_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AntennaDetails_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(AntennaDetails_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(AntennaDetails_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AntennaDetails_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AntennaDetails_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AntennaDetails_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(AntennaDetails_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AntennaDetails_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(AntennaDetails_Full::VT_TAGS, tags);
  }
  void add_manufacturerOrg(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrg) {
    fbb_.AddOffset(AntennaDetails_Full::VT_MANUFACTURERORG, manufacturerOrg);
  }
  explicit AntennaDetails_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AntennaDetails_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AntennaDetails_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AntennaDetails_Full> CreateAntennaDetails_Full(
    ...
    AntennaDetails_Full_mode_Enum mode = AntennaDetails_Full_mode_Enum_TX,
    ...
    AntennaDetails_Full_dataMode_Enum dataMode = AntennaDetails_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags = 0,
    ::flatbuffers::Offset<::flatbuffers::String> manufacturerOrg = 0) {
  AntennaDetails_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AntennaDetails_Full> CreateAntennaDetails_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAntennaDetails_Full(
      _fbb,
      id__,
      idAntenna__,
...
inline const AntennaDetails_Full *GetAntennaDetails_Full(const void *buf) {
  return ::flatbuffers::GetRoot<AntennaDetails_Full>(buf);
}

inline const AntennaDetails_Full *GetSizePrefixedAntennaDetails_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AntennaDetails_Full>(buf);
}

inline const char *AntennaDetails_FullIdentifier() {
  return "ANTE";
}

inline bool AntennaDetails_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AntennaDetails_FullIdentifier());
}

inline bool SizePrefixedAntennaDetails_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AntennaDetails_FullIdentifier(), true);
}

inline bool VerifyAntennaDetails_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AntennaDetails_Full>(AntennaDetails_FullIdentifier());
}

inline bool VerifySizePrefixedAntennaDetails_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AntennaDetails_Full>(AntennaDetails_FullIdentifier());
}

inline void FinishAntennaDetails_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AntennaDetails_Full> root) {
  fbb.Finish(root, AntennaDetails_FullIdentifier());
}

inline void FinishSizePrefixedAntennaDetails_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AntennaDetails_Full> root) {
  fbb.FinishSizePrefixed(root, AntennaDetails_FullIdentifier());
}
