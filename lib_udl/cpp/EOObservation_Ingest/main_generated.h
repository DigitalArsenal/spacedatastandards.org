...
struct EOObservation_Ingest;
struct EOObservation_IngestBuilder;

enum EOObservation_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  EOObservation_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  EOObservation_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  EOObservation_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  EOObservation_Ingest_dataMode_Enum_EXERCISE = 3,
  EOObservation_Ingest_dataMode_Enum_MIN = EOObservation_Ingest_dataMode_Enum_REAL,
  EOObservation_Ingest_dataMode_Enum_MAX = EOObservation_Ingest_dataMode_Enum_EXERCISE
};

inline const EOObservation_Ingest_dataMode_Enum (&EnumValuesEOObservation_Ingest_dataMode_Enum())[4] {
  static const EOObservation_Ingest_dataMode_Enum values[] = {
    EOObservation_Ingest_dataMode_Enum_REAL,
    EOObservation_Ingest_dataMode_Enum_TEST,
    EOObservation_Ingest_dataMode_Enum_SIMULATED,
    EOObservation_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesEOObservation_Ingest_dataMode_Enum() {
...
inline const char *EnumNameEOObservation_Ingest_dataMode_Enum(EOObservation_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, EOObservation_Ingest_dataMode_Enum_REAL, EOObservation_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEOObservation_Ingest_dataMode_Enum()[index];
}

enum EOObservation_Ingest_referenceFrame_Enum : int8_t {
  /// No description available.
  EOObservation_Ingest_referenceFrame_Enum_J2000 = 0,
  /// No description available.
  EOObservation_Ingest_referenceFrame_Enum_GCRF = 1,
  /// No description available.
  EOObservation_Ingest_referenceFrame_Enum_ITRF = 2,
  /// No description available.
  EOObservation_Ingest_referenceFrame_Enum_TEME = 3,
  EOObservation_Ingest_referenceFrame_Enum_MIN = EOObservation_Ingest_referenceFrame_Enum_J2000,
  EOObservation_Ingest_referenceFrame_Enum_MAX = EOObservation_Ingest_referenceFrame_Enum_TEME
};

inline const EOObservation_Ingest_referenceFrame_Enum (&EnumValuesEOObservation_Ingest_referenceFrame_Enum())[4] {
  static const EOObservation_Ingest_referenceFrame_Enum values[] = {
    EOObservation_Ingest_referenceFrame_Enum_J2000,
    EOObservation_Ingest_referenceFrame_Enum_GCRF,
    EOObservation_Ingest_referenceFrame_Enum_ITRF,
    EOObservation_Ingest_referenceFrame_Enum_TEME
  };
  return values;
}

inline const char * const *EnumNamesEOObservation_Ingest_referenceFrame_Enum() {
  static const char * const names[5] = {
    "J2000",
    "GCRF",
    "ITRF",
...
inline const char *EnumNameEOObservation_Ingest_referenceFrame_Enum(EOObservation_Ingest_referenceFrame_Enum e) {
  if (::flatbuffers::IsOutRange(e, EOObservation_Ingest_referenceFrame_Enum_J2000, EOObservation_Ingest_referenceFrame_Enum_TEME)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEOObservation_Ingest_referenceFrame_Enum()[index];
}

enum EOObservation_Ingest_senReferenceFrame_Enum : int8_t {
  /// No description available.
  EOObservation_Ingest_senReferenceFrame_Enum_J2000 = 0,
  /// No description available.
  EOObservation_Ingest_senReferenceFrame_Enum_EFG_TDR = 1,
  /// No description available.
  EOObservation_Ingest_senReferenceFrame_Enum_ECR_ECEF = 2,
  /// No description available.
  EOObservation_Ingest_senReferenceFrame_Enum_TEME = 3,
  /// No description available.
  EOObservation_Ingest_senReferenceFrame_Enum_ITRF = 4,
  /// No description available.
  EOObservation_Ingest_senReferenceFrame_Enum_GCRF = 5,
  EOObservation_Ingest_senReferenceFrame_Enum_MIN = EOObservation_Ingest_senReferenceFrame_Enum_J2000,
  EOObservation_Ingest_senReferenceFrame_Enum_MAX = EOObservation_Ingest_senReferenceFrame_Enum_GCRF
};

inline const EOObservation_Ingest_senReferenceFrame_Enum (&EnumValuesEOObservation_Ingest_senReferenceFrame_Enum())[6] {
  static const EOObservation_Ingest_senReferenceFrame_Enum values[] = {
    EOObservation_Ingest_senReferenceFrame_Enum_J2000,
    EOObservation_Ingest_senReferenceFrame_Enum_EFG_TDR,
    EOObservation_Ingest_senReferenceFrame_Enum_ECR_ECEF,
    EOObservation_Ingest_senReferenceFrame_Enum_TEME,
    EOObservation_Ingest_senReferenceFrame_Enum_ITRF,
    EOObservation_Ingest_senReferenceFrame_Enum_GCRF
  };
  return values;
}

inline const char * const *EnumNamesEOObservation_Ingest_senReferenceFrame_Enum() {
...
inline const char *EnumNameEOObservation_Ingest_senReferenceFrame_Enum(EOObservation_Ingest_senReferenceFrame_Enum e) {
  if (::flatbuffers::IsOutRange(e, EOObservation_Ingest_senReferenceFrame_Enum_J2000, EOObservation_Ingest_senReferenceFrame_Enum_GCRF)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEOObservation_Ingest_senReferenceFrame_Enum()[index];
}
...
struct EOObservation_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EOObservation_IngestBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_CREATEDBY = 170,
    VT_ZEROPTDUNC = 172,
    VT_EOOBSERVATIONDETAILS = 174,
    VT_REFERENCEFRAME = 176,
    VT_SENREFERENCEFRAME = 178,
    VT_UMBRA = 180,
    VT_PENUMBRA = 182,
    VT_ORIGNETWORK = 184,
    VT_SOURCEDL = 186,
  ...
  EOObservation_Ingest_dataMode_Enum dataMode() const {
    return static_cast<EOObservation_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
  ...
  /// Example: /// Example: 1.1
  /// Constraints: No constraints specified.
  double zeroPtdUnc() const {
    return GetField<double>(VT_ZEROPTDUNC, 0.0);
  }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  const ::flatbuffers::String *eoobservationDetails() const {
    return GetPointer<const ::flatbuffers::String *>(VT_EOOBSERVATIONDETAILS);
  }
  /// The reference frame of the EOObservation measurements. If the referenceFrame is null it is assumed to be J2000.
  /// Example: /// Example: J2000
  /// Constraints: Minimum length = 0, Maximum length = 24
  EOObservation_Ingest_referenceFrame_Enum referenceFrame() const {
    return static_cast<EOObservation_Ingest_referenceFrame_Enum>(GetField<int8_t>(VT_REFERENCEFRAME, 0));
  }
  /// The reference frame of the observing sensor state. If the senReferenceFrame is null it is assumed to be J2000.
  /// Example: /// Example: J2000
  /// Constraints: Minimum length = 0, Maximum length = 24
  EOObservation_Ingest_senReferenceFrame_Enum senReferenceFrame() const {
    return static_cast<EOObservation_Ingest_senReferenceFrame_Enum>(GetField<int8_t>(VT_SENREFERENCEFRAME, 0));
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<double>(verifier, VT_ZEROPTDUNC, 8) &&
           VerifyOffset(verifier, VT_EOOBSERVATIONDETAILS) &&
           verifier.VerifyString(eoobservationDetails()) &&
...
struct EOObservation_IngestBuilder {
  typedef EOObservation_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(EOObservation_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(EOObservation_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_obTime(::flatbuffers::Offset<::flatbuffers::String> obTime) {
    fbb_.AddOffset(EOObservation_Ingest::VT_OBTIME, obTime);
  }
  void add_corrQuality(double corrQuality) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_CORRQUALITY, corrQuality, 0.0);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(EOObservation_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(EOObservation_Ingest::VT_IDSENSOR, idSensor);
  }
  void add_idSkyImagery(::flatbuffers::Offset<::flatbuffers::String> idSkyImagery) {
    fbb_.AddOffset(EOObservation_Ingest::VT_IDSKYIMAGERY, idSkyImagery);
  }
  void add_collectMethod(::flatbuffers::Offset<::flatbuffers::String> collectMethod) {
    fbb_.AddOffset(EOObservation_Ingest::VT_COLLECTMETHOD, collectMethod);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(EOObservation_Ingest::VT_SATNO, satNo, 0);
  }
  void add_taskId(::flatbuffers::Offset<::flatbuffers::String> taskId) {
    fbb_.AddOffset(EOObservation_Ingest::VT_TASKID, taskId);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(EOObservation_Ingest::VT_TRANSACTIONID, transactionId);
  }
  void add_trackId(::flatbuffers::Offset<::flatbuffers::String> trackId) {
    fbb_.AddOffset(EOObservation_Ingest::VT_TRACKID, trackId);
  }
  void add_obPosition(::flatbuffers::Offset<::flatbuffers::String> obPosition) {
    fbb_.AddOffset(EOObservation_Ingest::VT_OBPOSITION, obPosition);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(EOObservation_Ingest::VT_ORIGOBJECTID, origObjectId);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(EOObservation_Ingest::VT_ORIGSENSORID, origSensorId);
  }
  void add_uct(bool uct) {
    fbb_.AddElement<uint8_t>(EOObservation_Ingest::VT_UCT, static_cast<uint8_t>(uct), 0);
  }
  void add_azimuth(double azimuth) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_AZIMUTH, azimuth, 0.0);
  }
  void add_azimuthUnc(double azimuthUnc) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_AZIMUTHUNC, azimuthUnc, 0.0);
  }
  void add_azimuthBias(double azimuthBias) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_AZIMUTHBIAS, azimuthBias, 0.0);
  }
  void add_azimuthRate(double azimuthRate) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_AZIMUTHRATE, azimuthRate, 0.0);
  }
  void add_elevation(double elevation) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_ELEVATION, elevation, 0.0);
  }
  void add_elevationUnc(double elevationUnc) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_ELEVATIONUNC, elevationUnc, 0.0);
  }
  void add_elevationBias(double elevationBias) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_ELEVATIONBIAS, elevationBias, 0.0);
  }
  void add_elevationRate(double elevationRate) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_ELEVATIONRATE, elevationRate, 0.0);
  }
  void add_range(double range) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_RANGE, range, 0.0);
  }
  void add_rangeUnc(double rangeUnc) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_RANGEUNC, rangeUnc, 0.0);
  }
  void add_rangeBias(double rangeBias) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_RANGEBIAS, rangeBias, 0.0);
  }
  void add_rangeRate(double rangeRate) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_RANGERATE, rangeRate, 0.0);
  }
  void add_rangeRateUnc(double rangeRateUnc) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_RANGERATEUNC, rangeRateUnc, 0.0);
  }
  void add_ra(double ra) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_RA, ra, 0.0);
  }
  void add_raRate(double raRate) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_RARATE, raRate, 0.0);
  }
  void add_raUnc(double raUnc) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_RAUNC, raUnc, 0.0);
  }
  void add_raBias(double raBias) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_RABIAS, raBias, 0.0);
  }
  void add_declination(double declination) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_DECLINATION, declination, 0.0);
  }
  void add_declinationRate(double declinationRate) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_DECLINATIONRATE, declinationRate, 0.0);
  }
  void add_declinationUnc(double declinationUnc) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_DECLINATIONUNC, declinationUnc, 0.0);
  }
  void add_declinationBias(double declinationBias) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_DECLINATIONBIAS, declinationBias, 0.0);
  }
  void add_losx(double losx) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_LOSX, losx, 0.0);
  }
  void add_losy(double losy) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_LOSY, losy, 0.0);
  }
  void add_losz(double losz) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_LOSZ, losz, 0.0);
  }
  void add_losUnc(double losUnc) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_LOSUNC, losUnc, 0.0);
  }
  void add_losxvel(double losxvel) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_LOSXVEL, losxvel, 0.0);
  }
  void add_losyvel(double losyvel) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_LOSYVEL, losyvel, 0.0);
  }
  void add_loszvel(double loszvel) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_LOSZVEL, loszvel, 0.0);
  }
  void add_senlat(double senlat) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_SENLAT, senlat, 0.0);
  }
  void add_senlon(double senlon) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_SENLON, senlon, 0.0);
  }
  void add_senalt(double senalt) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_SENALT, senalt, 0.0);
  }
  void add_senx(double senx) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_SENX, senx, 0.0);
  }
  void add_seny(double seny) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_SENY, seny, 0.0);
  }
  void add_senz(double senz) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_SENZ, senz, 0.0);
  }
  void add_senvelx(double senvelx) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_SENVELX, senvelx, 0.0);
  }
  void add_senvely(double senvely) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_SENVELY, senvely, 0.0);
  }
  void add_senvelz(double senvelz) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_SENVELZ, senvelz, 0.0);
  }
  void add_senQuat(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> senQuat) {
    fbb_.AddOffset(EOObservation_Ingest::VT_SENQUAT, senQuat);
  }
  void add_fovCount(int32_t fovCount) {
    fbb_.AddElement<int32_t>(EOObservation_Ingest::VT_FOVCOUNT, fovCount, 0);
  }
  void add_expDuration(double expDuration) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_EXPDURATION, expDuration, 0.0);
  }
  void add_zeroptd(double zeroptd) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_ZEROPTD, zeroptd, 0.0);
  }
  void add_netObjSig(double netObjSig) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_NETOBJSIG, netObjSig, 0.0);
  }
  void add_netObjSigUnc(double netObjSigUnc) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_NETOBJSIGUNC, netObjSigUnc, 0.0);
  }
  void add_mag(double mag) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_MAG, mag, 0.0);
  }
  void add_magUnc(double magUnc) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_MAGUNC, magUnc, 0.0);
  }
  void add_magNormRange(double magNormRange) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_MAGNORMRANGE, magNormRange, 0.0);
  }
  void add_geolat(double geolat) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_GEOLAT, geolat, 0.0);
  }
  void add_geolon(double geolon) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_GEOLON, geolon, 0.0);
  }
  void add_geoalt(double geoalt) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_GEOALT, geoalt, 0.0);
  }
  void add_georange(double georange) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_GEORANGE, georange, 0.0);
  }
  void add_skyBkgrnd(double skyBkgrnd) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_SKYBKGRND, skyBkgrnd, 0.0);
  }
  void add_primaryExtinction(double primaryExtinction) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_PRIMARYEXTINCTION, primaryExtinction, 0.0);
  }
  void add_primaryExtinctionUnc(double primaryExtinctionUnc) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_PRIMARYEXTINCTIONUNC, primaryExtinctionUnc, 0.0);
  }
  void add_solarPhaseAngle(double solarPhaseAngle) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_SOLARPHASEANGLE, solarPhaseAngle, 0.0);
  }
  void add_solarEqPhaseAngle(double solarEqPhaseAngle) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_SOLAREQPHASEANGLE, solarEqPhaseAngle, 0.0);
  }
  void add_solarDecAngle(double solarDecAngle) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_SOLARDECANGLE, solarDecAngle, 0.0);
  }
  void add_shutterDelay(double shutterDelay) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_SHUTTERDELAY, shutterDelay, 0.0);
  }
  void add_timingBias(double timingBias) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_TIMINGBIAS, timingBias, 0.0);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(EOObservation_Ingest::VT_RAWFILEURI, rawFileURI);
  }
  void add_intensity(double intensity) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_INTENSITY, intensity, 0.0);
  }
  void add_bgIntensity(double bgIntensity) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_BGINTENSITY, bgIntensity, 0.0);
  }
  void add_descriptor(::flatbuffers::Offset<::flatbuffers::String> descriptor) {
    fbb_.AddOffset(EOObservation_Ingest::VT_DESCRIPTOR, descriptor);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(EOObservation_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(EOObservation_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(EOObservation_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(EOObservation_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(EOObservation_Ingest::VT_TAGS, tags);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(EOObservation_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(EOObservation_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_zeroPtdUnc(double zeroPtdUnc) {
    fbb_.AddElement<double>(EOObservation_Ingest::VT_ZEROPTDUNC, zeroPtdUnc, 0.0);
  }
  void add_eoobservationDetails(::flatbuffers::Offset<::flatbuffers::String> eoobservationDetails) {
    fbb_.AddOffset(EOObservation_Ingest::VT_EOOBSERVATIONDETAILS, eoobservationDetails);
  }
  void add_referenceFrame(EOObservation_Ingest_referenceFrame_Enum referenceFrame) {
    fbb_.AddElement<int8_t>(EOObservation_Ingest::VT_REFERENCEFRAME, static_cast<int8_t>(referenceFrame), 0);
  }
  void add_senReferenceFrame(EOObservation_Ingest_senReferenceFrame_Enum senReferenceFrame) {
    fbb_.AddElement<int8_t>(EOObservation_Ingest::VT_SENREFERENCEFRAME, static_cast<int8_t>(senReferenceFrame), 0);
  }
  void add_umbra(bool umbra) {
    fbb_.AddElement<uint8_t>(EOObservation_Ingest::VT_UMBRA, static_cast<uint8_t>(umbra), 0);
  }
  void add_penumbra(bool penumbra) {
    fbb_.AddElement<uint8_t>(EOObservation_Ingest::VT_PENUMBRA, static_cast<uint8_t>(penumbra), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(EOObservation_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(EOObservation_Ingest::VT_SOURCEDL, sourceDL);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(EOObservation_Ingest::VT_TYPE, type);
  }
  explicit EOObservation_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<EOObservation_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<EOObservation_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<EOObservation_Ingest> CreateEOObservation_Ingest(
    ...
    EOObservation_Ingest_dataMode_Enum dataMode = EOObservation_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0,
    double zeroPtdUnc = 0.0,
    ::flatbuffers::Offset<::flatbuffers::String> eoobservationDetails = 0,
    EOObservation_Ingest_referenceFrame_Enum referenceFrame = EOObservation_Ingest_referenceFrame_Enum_J2000,
    EOObservation_Ingest_senReferenceFrame_Enum senReferenceFrame = EOObservation_Ingest_senReferenceFrame_Enum_J2000,
    bool umbra = false,
    bool penumbra = false,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0,
    ::flatbuffers::Offset<::flatbuffers::String> sourceDL = 0,
    ::flatbuffers::Offset<::flatbuffers::String> type = 0) {
  EOObservation_IngestBuilder builder_(_fbb);
  builder_.add_zeroPtdUnc(zeroPtdUnc);
  ...
  builder_.add_eoobservationDetails(eoobservationDetails);
...
inline ::flatbuffers::Offset<EOObservation_Ingest> CreateEOObservation_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ...
    double zeroPtdUnc = 0.0,
    const char *eoobservationDetails = nullptr,
    EOObservation_Ingest_referenceFrame_Enum referenceFrame = EOObservation_Ingest_referenceFrame_Enum_J2000,
    EOObservation_Ingest_senReferenceFrame_Enum senReferenceFrame = EOObservation_Ingest_senReferenceFrame_Enum_J2000,
    bool umbra = false,
    bool penumbra = false,
  ...
  auto eoobservationDetails__ = eoobservationDetails ? _fbb.CreateString(eoobservationDetails) : 0;
...
inline const EOObservation_Ingest *GetEOObservation_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<EOObservation_Ingest>(buf);
}

inline const EOObservation_Ingest *GetSizePrefixedEOObservation_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EOObservation_Ingest>(buf);
}

inline const char *EOObservation_IngestIdentifier() {
  return "EOOB";
}

inline bool EOObservation_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EOObservation_IngestIdentifier());
}

inline bool SizePrefixedEOObservation_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EOObservation_IngestIdentifier(), true);
}

inline bool VerifyEOObservation_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EOObservation_Ingest>(EOObservation_IngestIdentifier());
}

inline bool VerifySizePrefixedEOObservation_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EOObservation_Ingest>(EOObservation_IngestIdentifier());
}

inline void FinishEOObservation_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EOObservation_Ingest> root) {
  fbb.Finish(root, EOObservation_IngestIdentifier());
}

inline void FinishSizePrefixedEOObservation_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EOObservation_Ingest> root) {
  fbb.FinishSizePrefixed(root, EOObservation_IngestIdentifier());
}
