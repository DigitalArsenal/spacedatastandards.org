...
struct FlightPlanWaypoints_Ingest;
struct FlightPlanWaypoints_IngestBuilder;

/// /// Collection of waypoints associated with this flight plan.
struct FlightPlanWaypoints_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef FlightPlanWaypoints_IngestBuilder Builder;
...
struct FlightPlanWaypoints_IngestBuilder {
  typedef FlightPlanWaypoints_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(FlightPlanWaypoints_Ingest::VT_TYPE, type);
  }
  void add_waypointName(::flatbuffers::Offset<::flatbuffers::String> waypointName) {
    fbb_.AddOffset(FlightPlanWaypoints_Ingest::VT_WAYPOINTNAME, waypointName);
  }
  void add_waypointNum(int32_t waypointNum) {
    fbb_.AddElement<int32_t>(FlightPlanWaypoints_Ingest::VT_WAYPOINTNUM, waypointNum, 0);
  }
  void add_airway(::flatbuffers::Offset<::flatbuffers::String> airway) {
    fbb_.AddOffset(FlightPlanWaypoints_Ingest::VT_AIRWAY, airway);
  }
  void add_arpt(::flatbuffers::Offset<::flatbuffers::String> arpt) {
    fbb_.AddOffset(FlightPlanWaypoints_Ingest::VT_ARPT, arpt);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_LON, lon, 0.0);
  }
  void add_arId(::flatbuffers::Offset<::flatbuffers::String> arId) {
    fbb_.AddOffset(FlightPlanWaypoints_Ingest::VT_ARID, arId);
  }
  void add_navaid(::flatbuffers::Offset<::flatbuffers::String> navaid) {
    fbb_.AddOffset(FlightPlanWaypoints_Ingest::VT_NAVAID, navaid);
  }
  void add_tacanChannel(::flatbuffers::Offset<::flatbuffers::String> tacanChannel) {
    fbb_.AddOffset(FlightPlanWaypoints_Ingest::VT_TACANCHANNEL, tacanChannel);
  }
  void add_vorFreq(double vorFreq) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_VORFREQ, vorFreq, 0.0);
  }
  void add_turbCat(::flatbuffers::Offset<::flatbuffers::String> turbCat) {
    fbb_.AddOffset(FlightPlanWaypoints_Ingest::VT_TURBCAT, turbCat);
  }
  void add_iceCat(::flatbuffers::Offset<::flatbuffers::String> iceCat) {
    fbb_.AddOffset(FlightPlanWaypoints_Ingest::VT_ICECAT, iceCat);
  }
  void add_thunderCat(::flatbuffers::Offset<::flatbuffers::String> thunderCat) {
    fbb_.AddOffset(FlightPlanWaypoints_Ingest::VT_THUNDERCAT, thunderCat);
  }
  void add_alt(double alt) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_ALT, alt, 0.0);
  }
  void add_tempDev(double tempDev) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_TEMPDEV, tempDev, 0.0);
  }
  void add_legFuelDegrade(double legFuelDegrade) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_LEGFUELDEGRADE, legFuelDegrade, 0.0);
  }
  void add_legMach(double legMach) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_LEGMACH, legMach, 0.0);
  }
  void add_legMsnIndex(double legMsnIndex) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_LEGMSNINDEX, legMsnIndex, 0.0);
  }
  void add_legDragIndex(double legDragIndex) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_LEGDRAGINDEX, legDragIndex, 0.0);
  }
  void add_avgCalAirspeed(double avgCalAirspeed) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_AVGCALAIRSPEED, avgCalAirspeed, 0.0);
  }
  void add_avgTrueAirspeed(double avgTrueAirspeed) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_AVGTRUEAIRSPEED, avgTrueAirspeed, 0.0);
  }
  void add_avgGroundSpeed(double avgGroundSpeed) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_AVGGROUNDSPEED, avgGroundSpeed, 0.0);
  }
  void add_priFreq(double priFreq) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_PRIFREQ, priFreq, 0.0);
  }
  void add_pointWindDir(double pointWindDir) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_POINTWINDDIR, pointWindDir, 0.0);
  }
  void add_pointWindSpeed(double pointWindSpeed) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_POINTWINDSPEED, pointWindSpeed, 0.0);
  }
  void add_avgWindDir(double avgWindDir) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_AVGWINDDIR, avgWindDir, 0.0);
  }
  void add_avgWindSpeed(double avgWindSpeed) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_AVGWINDSPEED, avgWindSpeed, 0.0);
  }
  void add_legWindFac(double legWindFac) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_LEGWINDFAC, legWindFac, 0.0);
  }
  void add_avgDriftAng(double avgDriftAng) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_AVGDRIFTANG, avgDriftAng, 0.0);
  }
  void add_secFreq(double secFreq) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_SECFREQ, secFreq, 0.0);
  }
  void add_magCourse(double magCourse) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_MAGCOURSE, magCourse, 0.0);
  }
  void add_trueCourse(double trueCourse) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_TRUECOURSE, trueCourse, 0.0);
  }
  void add_magHeading(double magHeading) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_MAGHEADING, magHeading, 0.0);
  }
  void add_aaTacanChannel(::flatbuffers::Offset<::flatbuffers::String> aaTacanChannel) {
    fbb_.AddOffset(FlightPlanWaypoints_Ingest::VT_AATACANCHANNEL, aaTacanChannel);
  }
  void add_zoneDistance(double zoneDistance) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_ZONEDISTANCE, zoneDistance, 0.0);
  }
  void add_totalFlownDistance(double totalFlownDistance) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_TOTALFLOWNDISTANCE, totalFlownDistance, 0.0);
  }
  void add_totalRemDistance(double totalRemDistance) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_TOTALREMDISTANCE, totalRemDistance, 0.0);
  }
  void add_zoneTime(double zoneTime) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_ZONETIME, zoneTime, 0.0);
  }
  void add_totalTime(::flatbuffers::Offset<::flatbuffers::String> totalTime) {
    fbb_.AddOffset(FlightPlanWaypoints_Ingest::VT_TOTALTIME, totalTime);
  }
  void add_totalTimeRem(::flatbuffers::Offset<::flatbuffers::String> totalTimeRem) {
    fbb_.AddOffset(FlightPlanWaypoints_Ingest::VT_TOTALTIMEREM, totalTimeRem);
  }
  void add_zoneFuel(double zoneFuel) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_ZONEFUEL, zoneFuel, 0.0);
  }
  void add_totalUsedFuel(double totalUsedFuel) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_TOTALUSEDFUEL, totalUsedFuel, 0.0);
  }
  void add_totalRemFuel(double totalRemFuel) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_TOTALREMFUEL, totalRemFuel, 0.0);
  }
  void add_exchangedFuel(double exchangedFuel) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_EXCHANGEDFUEL, exchangedFuel, 0.0);
  }
  void add_airDistance(double airDistance) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_AIRDISTANCE, airDistance, 0.0);
  }
  void add_totalAirDistance(double totalAirDistance) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_TOTALAIRDISTANCE, totalAirDistance, 0.0);
  }
  void add_totalWeight(double totalWeight) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_TOTALWEIGHT, totalWeight, 0.0);
  }
  void add_eta(::flatbuffers::Offset<::flatbuffers::String> eta) {
    fbb_.AddOffset(FlightPlanWaypoints_Ingest::VT_ETA, eta);
  }
  void add_ata(::flatbuffers::Offset<::flatbuffers::String> ata) {
    fbb_.AddOffset(FlightPlanWaypoints_Ingest::VT_ATA, ata);
  }
  void add_fuelFlow(double fuelFlow) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_FUELFLOW, fuelFlow, 0.0);
  }
  void add_legAlternate(::flatbuffers::Offset<::flatbuffers::String> legAlternate) {
    fbb_.AddOffset(FlightPlanWaypoints_Ingest::VT_LEGALTERNATE, legAlternate);
  }
  void add_magVar(double magVar) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_MAGVAR, magVar, 0.0);
  }
  void add_dayLowAlt(double dayLowAlt) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_DAYLOWALT, dayLowAlt, 0.0);
  }
  void add_nightLowAlt(double nightLowAlt) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_NIGHTLOWALT, nightLowAlt, 0.0);
  }
  void add_nvgLowAlt(double nvgLowAlt) {
    fbb_.AddElement<double>(FlightPlanWaypoints_Ingest::VT_NVGLOWALT, nvgLowAlt, 0.0);
  }
  explicit FlightPlanWaypoints_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<FlightPlanWaypoints_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<FlightPlanWaypoints_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<FlightPlanWaypoints_Ingest> CreateFlightPlanWaypoints_Ingest(
  ...
  FlightPlanWaypoints_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<FlightPlanWaypoints_Ingest> CreateFlightPlanWaypoints_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateFlightPlanWaypoints_Ingest(
      _fbb,
      type__,
      waypointName__,
      waypointNum,
...
inline const FlightPlanWaypoints_Ingest *GetFlightPlanWaypoints_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<FlightPlanWaypoints_Ingest>(buf);
}

inline const FlightPlanWaypoints_Ingest *GetSizePrefixedFlightPlanWaypoints_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<FlightPlanWaypoints_Ingest>(buf);
}

inline const char *FlightPlanWaypoints_IngestIdentifier() {
  return "FLIG";
}

inline bool FlightPlanWaypoints_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, FlightPlanWaypoints_IngestIdentifier());
}

inline bool SizePrefixedFlightPlanWaypoints_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, FlightPlanWaypoints_IngestIdentifier(), true);
}

inline bool VerifyFlightPlanWaypoints_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<FlightPlanWaypoints_Ingest>(FlightPlanWaypoints_IngestIdentifier());
}

inline bool VerifySizePrefixedFlightPlanWaypoints_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<FlightPlanWaypoints_Ingest>(FlightPlanWaypoints_IngestIdentifier());
}

inline void FinishFlightPlanWaypoints_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<FlightPlanWaypoints_Ingest> root) {
  fbb.Finish(root, FlightPlanWaypoints_IngestIdentifier());
}

inline void FinishSizePrefixedFlightPlanWaypoints_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<FlightPlanWaypoints_Ingest> root) {
  fbb.FinishSizePrefixed(root, FlightPlanWaypoints_IngestIdentifier());
}
