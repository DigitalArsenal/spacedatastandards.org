...
struct Sensor_Ingest;
struct Sensor_IngestBuilder;

enum Sensor_Ingest_dataMode_Enum : int8_t {
  ...
  Sensor_Ingest_dataMode_Enum_MIN = Sensor_Ingest_dataMode_Enum_REAL,
  Sensor_Ingest_dataMode_Enum_MAX = Sensor_Ingest_dataMode_Enum_EXERCISE
};

inline const Sensor_Ingest_dataMode_Enum (&EnumValuesSensor_Ingest_dataMode_Enum())[4] {
  static const Sensor_Ingest_dataMode_Enum values[] = {
    Sensor_Ingest_dataMode_Enum_REAL,
    Sensor_Ingest_dataMode_Enum_TEST,
    Sensor_Ingest_dataMode_Enum_SIMULATED,
    Sensor_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSensor_Ingest_dataMode_Enum() {
...
inline const char *EnumNameSensor_Ingest_dataMode_Enum(Sensor_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Sensor_Ingest_dataMode_Enum_REAL, Sensor_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSensor_Ingest_dataMode_Enum()[index];
}

/// /// Model representation of observation data for electro-optical based sensor phenomenologies.
struct Sensor_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Sensor_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Sensor_Ingest_dataMode_Enum dataMode() const {
    return static_cast<Sensor_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Sensor_IngestBuilder {
  typedef Sensor_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(Sensor_Ingest::VT_IDSENSOR, idSensor);
  }
  void add_sensorName(::flatbuffers::Offset<::flatbuffers::String> sensorName) {
    fbb_.AddOffset(Sensor_Ingest::VT_SENSORNAME, sensorName);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Sensor_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_sensorNumber(int32_t sensorNumber) {
    fbb_.AddElement<int32_t>(Sensor_Ingest::VT_SENSORNUMBER, sensorNumber, 0);
  }
  void add_shortName(::flatbuffers::Offset<::flatbuffers::String> shortName) {
    fbb_.AddOffset(Sensor_Ingest::VT_SHORTNAME, shortName);
  }
  void add_dataControl(::flatbuffers::Offset<::flatbuffers::String> dataControl) {
    fbb_.AddOffset(Sensor_Ingest::VT_DATACONTROL, dataControl);
  }
  void add_afId(::flatbuffers::Offset<::flatbuffers::String> afId) {
    fbb_.AddOffset(Sensor_Ingest::VT_AFID, afId);
  }
  void add_asrType(::flatbuffers::Offset<::flatbuffers::String> asrType) {
    fbb_.AddOffset(Sensor_Ingest::VT_ASRTYPE, asrType);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Sensor_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Sensor_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Sensor_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(Sensor_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Sensor_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Sensor_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Sensor_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_active(bool active) {
    fbb_.AddElement<uint8_t>(Sensor_Ingest::VT_ACTIVE, static_cast<uint8_t>(active), 0);
  }
  void add_sensorcharacteristics(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sensorcharacteristics) {
    fbb_.AddOffset(Sensor_Ingest::VT_SENSORCHARACTERISTICS, sensorcharacteristics);
  }
  void add_sensorStats(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sensorStats) {
    fbb_.AddOffset(Sensor_Ingest::VT_SENSORSTATS, sensorStats);
  }
  void add_sensorlimitsCollection(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sensorlimitsCollection) {
    fbb_.AddOffset(Sensor_Ingest::VT_SENSORLIMITSCOLLECTION, sensorlimitsCollection);
  }
  void add_entity(::flatbuffers::Offset<::flatbuffers::String> entity) {
    fbb_.AddOffset(Sensor_Ingest::VT_ENTITY, entity);
  }
  void add_idEntity(::flatbuffers::Offset<::flatbuffers::String> idEntity) {
    fbb_.AddOffset(Sensor_Ingest::VT_IDENTITY, idEntity);
  }
  void add_sensorObservationType(::flatbuffers::Offset<::flatbuffers::String> sensorObservationType) {
    fbb_.AddOffset(Sensor_Ingest::VT_SENSOROBSERVATIONTYPE, sensorObservationType);
  }
  void add_sensorType(::flatbuffers::Offset<::flatbuffers::String> sensorType) {
    fbb_.AddOffset(Sensor_Ingest::VT_SENSORTYPE, sensorType);
  }
  explicit Sensor_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Sensor_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Sensor_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Sensor_Ingest> CreateSensor_Ingest(
    ...
    Sensor_Ingest_dataMode_Enum dataMode = Sensor_Ingest_dataMode_Enum_REAL,
  ...
  Sensor_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Sensor_Ingest> CreateSensor_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Sensor_Ingest *GetSensor_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<Sensor_Ingest>(buf);
}

inline const Sensor_Ingest *GetSizePrefixedSensor_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Sensor_Ingest>(buf);
}

inline const char *Sensor_IngestIdentifier() {
  return "SENS";
}

inline bool Sensor_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Sensor_IngestIdentifier());
}

inline bool SizePrefixedSensor_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Sensor_IngestIdentifier(), true);
}

inline bool VerifySensor_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Sensor_Ingest>(Sensor_IngestIdentifier());
}

inline bool VerifySizePrefixedSensor_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Sensor_Ingest>(Sensor_IngestIdentifier());
}

inline void FinishSensor_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Sensor_Ingest> root) {
  fbb.Finish(root, Sensor_IngestIdentifier());
}

inline void FinishSizePrefixedSensor_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Sensor_Ingest> root) {
  fbb.FinishSizePrefixed(root, Sensor_IngestIdentifier());
}
