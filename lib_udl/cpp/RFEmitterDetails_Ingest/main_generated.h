...
struct RFEmitterDetails_Ingest;
struct RFEmitterDetails_IngestBuilder;

enum RFEmitterDetails_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  RFEmitterDetails_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  RFEmitterDetails_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  RFEmitterDetails_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  RFEmitterDetails_Ingest_dataMode_Enum_EXERCISE = 3,
  RFEmitterDetails_Ingest_dataMode_Enum_MIN = RFEmitterDetails_Ingest_dataMode_Enum_REAL,
  RFEmitterDetails_Ingest_dataMode_Enum_MAX = RFEmitterDetails_Ingest_dataMode_Enum_EXERCISE
};

inline const RFEmitterDetails_Ingest_dataMode_Enum (&EnumValuesRFEmitterDetails_Ingest_dataMode_Enum())[4] {
  static const RFEmitterDetails_Ingest_dataMode_Enum values[] = {
    RFEmitterDetails_Ingest_dataMode_Enum_REAL,
    RFEmitterDetails_Ingest_dataMode_Enum_TEST,
    RFEmitterDetails_Ingest_dataMode_Enum_SIMULATED,
    RFEmitterDetails_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesRFEmitterDetails_Ingest_dataMode_Enum() {
...
inline const char *EnumNameRFEmitterDetails_Ingest_dataMode_Enum(RFEmitterDetails_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, RFEmitterDetails_Ingest_dataMode_Enum_REAL, RFEmitterDetails_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesRFEmitterDetails_Ingest_dataMode_Enum()[index];
}
...
struct RFEmitterDetails_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef RFEmitterDetails_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  RFEmitterDetails_Ingest_dataMode_Enum dataMode() const {
    return static_cast<RFEmitterDetails_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct RFEmitterDetails_IngestBuilder {
  typedef RFEmitterDetails_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_ID, id);
  }
  void add_idRFEmitter(::flatbuffers::Offset<::flatbuffers::String> idRFEmitter) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_IDRFEMITTER, idRFEmitter);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_designator(::flatbuffers::Offset<::flatbuffers::String> designator) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_DESIGNATOR, designator);
  }
  void add_altName(::flatbuffers::Offset<::flatbuffers::String> altName) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_ALTNAME, altName);
  }
  void add_family(::flatbuffers::Offset<::flatbuffers::String> family) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_FAMILY, family);
  }
  void add_productionFacilityName(::flatbuffers::Offset<::flatbuffers::String> productionFacilityName) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_PRODUCTIONFACILITYNAME, productionFacilityName);
  }
  void add_alternateFacilityName(::flatbuffers::Offset<::flatbuffers::String> alternateFacilityName) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_ALTERNATEFACILITYNAME, alternateFacilityName);
  }
  void add_manufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrgId) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_MANUFACTURERORGID, manufacturerOrgId);
  }
  void add_productionFacilityLocationId(::flatbuffers::Offset<::flatbuffers::String> productionFacilityLocationId) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_PRODUCTIONFACILITYLOCATIONID, productionFacilityLocationId);
  }
  void add_systemSensitivityStart(double systemSensitivityStart) {
    fbb_.AddElement<double>(RFEmitterDetails_Ingest::VT_SYSTEMSENSITIVITYSTART, systemSensitivityStart, 0.0);
  }
  void add_systemSensitivityEnd(double systemSensitivityEnd) {
    fbb_.AddElement<double>(RFEmitterDetails_Ingest::VT_SYSTEMSENSITIVITYEND, systemSensitivityEnd, 0.0);
  }
  void add_receiverType(::flatbuffers::Offset<::flatbuffers::String> receiverType) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_RECEIVERTYPE, receiverType);
  }
  void add_receiverSensitivity(double receiverSensitivity) {
    fbb_.AddElement<double>(RFEmitterDetails_Ingest::VT_RECEIVERSENSITIVITY, receiverSensitivity, 0.0);
  }
  void add_receiverBandwidth(double receiverBandwidth) {
    fbb_.AddElement<double>(RFEmitterDetails_Ingest::VT_RECEIVERBANDWIDTH, receiverBandwidth, 0.0);
  }
  void add_transmitterFrequency(double transmitterFrequency) {
    fbb_.AddElement<double>(RFEmitterDetails_Ingest::VT_TRANSMITTERFREQUENCY, transmitterFrequency, 0.0);
  }
  void add_transmitterBandwidth(double transmitterBandwidth) {
    fbb_.AddElement<double>(RFEmitterDetails_Ingest::VT_TRANSMITTERBANDWIDTH, transmitterBandwidth, 0.0);
  }
  void add_transmitPower(double transmitPower) {
    fbb_.AddElement<double>(RFEmitterDetails_Ingest::VT_TRANSMITPOWER, transmitPower, 0.0);
  }
  void add_barrageNoiseBandwidth(double barrageNoiseBandwidth) {
    fbb_.AddElement<double>(RFEmitterDetails_Ingest::VT_BARRAGENOISEBANDWIDTH, barrageNoiseBandwidth, 0.0);
  }
  void add_dopplerNoise(double dopplerNoise) {
    fbb_.AddElement<double>(RFEmitterDetails_Ingest::VT_DOPPLERNOISE, dopplerNoise, 0.0);
  }
  void add_drfmInstantaneousBandwidth(double drfmInstantaneousBandwidth) {
    fbb_.AddElement<double>(RFEmitterDetails_Ingest::VT_DRFMINSTANTANEOUSBANDWIDTH, drfmInstantaneousBandwidth, 0.0);
  }
  void add_numChannels(int32_t numChannels) {
    fbb_.AddElement<int32_t>(RFEmitterDetails_Ingest::VT_NUMCHANNELS, numChannels, 0);
  }
  void add_numBits(int32_t numBits) {
    fbb_.AddElement<int32_t>(RFEmitterDetails_Ingest::VT_NUMBITS, numBits, 0);
  }
  void add_antennaSize(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> antennaSize) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_ANTENNASIZE, antennaSize);
  }
  void add_antennaDiameter(double antennaDiameter) {
    fbb_.AddElement<double>(RFEmitterDetails_Ingest::VT_ANTENNADIAMETER, antennaDiameter, 0.0);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_NOTES, notes);
  }
  void add_secondaryNotes(::flatbuffers::Offset<::flatbuffers::String> secondaryNotes) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_SECONDARYNOTES, secondaryNotes);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_DESCRIPTION, description);
  }
  void add_urls(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> urls) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_URLS, urls);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(RFEmitterDetails_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(RFEmitterDetails_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(RFEmitterDetails_Ingest::VT_CREATEDBY, createdBy);
  }
  explicit RFEmitterDetails_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<RFEmitterDetails_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<RFEmitterDetails_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<RFEmitterDetails_Ingest> CreateRFEmitterDetails_Ingest(
    ...
    RFEmitterDetails_Ingest_dataMode_Enum dataMode = RFEmitterDetails_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0) {
  RFEmitterDetails_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<RFEmitterDetails_Ingest> CreateRFEmitterDetails_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateRFEmitterDetails_Ingest(
      _fbb,
      id__,
      idRFEmitter__,
...
inline const RFEmitterDetails_Ingest *GetRFEmitterDetails_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<RFEmitterDetails_Ingest>(buf);
}

inline const RFEmitterDetails_Ingest *GetSizePrefixedRFEmitterDetails_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<RFEmitterDetails_Ingest>(buf);
}

inline const char *RFEmitterDetails_IngestIdentifier() {
  return "RFEM";
}

inline bool RFEmitterDetails_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RFEmitterDetails_IngestIdentifier());
}

inline bool SizePrefixedRFEmitterDetails_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RFEmitterDetails_IngestIdentifier(), true);
}

inline bool VerifyRFEmitterDetails_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<RFEmitterDetails_Ingest>(RFEmitterDetails_IngestIdentifier());
}

inline bool VerifySizePrefixedRFEmitterDetails_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<RFEmitterDetails_Ingest>(RFEmitterDetails_IngestIdentifier());
}

inline void FinishRFEmitterDetails_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RFEmitterDetails_Ingest> root) {
  fbb.Finish(root, RFEmitterDetails_IngestIdentifier());
}

inline void FinishSizePrefixedRFEmitterDetails_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RFEmitterDetails_Ingest> root) {
  fbb.FinishSizePrefixed(root, RFEmitterDetails_IngestIdentifier());
}
