...
struct MtiTargetReport_Ingest;
struct MtiTargetReport_IngestBuilder;
...
struct MtiTargetReport_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef MtiTargetReport_IngestBuilder Builder;
...
struct MtiTargetReport_IngestBuilder {
  typedef MtiTargetReport_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_d32_1(int32_t d32_1) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Ingest::VT_D32_1, d32_1, 0);
  }
  void add_d32_2(double d32_2) {
    fbb_.AddElement<double>(MtiTargetReport_Ingest::VT_D32_2, d32_2, 0.0);
  }
  void add_d32_3(double d32_3) {
    fbb_.AddElement<double>(MtiTargetReport_Ingest::VT_D32_3, d32_3, 0.0);
  }
  void add_d32_4(int32_t d32_4) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Ingest::VT_D32_4, d32_4, 0);
  }
  void add_d32_5(int32_t d32_5) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Ingest::VT_D32_5, d32_5, 0);
  }
  void add_d32_6(int32_t d32_6) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Ingest::VT_D32_6, d32_6, 0);
  }
  void add_d32_7(int32_t d32_7) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Ingest::VT_D32_7, d32_7, 0);
  }
  void add_d32_8(int32_t d32_8) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Ingest::VT_D32_8, d32_8, 0);
  }
  void add_d32_9(int32_t d32_9) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Ingest::VT_D32_9, d32_9, 0);
  }
  void add_d32_10(::flatbuffers::Offset<::flatbuffers::String> d32_10) {
    fbb_.AddOffset(MtiTargetReport_Ingest::VT_D32_10, d32_10);
  }
  void add_d32_11(int32_t d32_11) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Ingest::VT_D32_11, d32_11, 0);
  }
  void add_d32_12(int32_t d32_12) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Ingest::VT_D32_12, d32_12, 0);
  }
  void add_d32_13(int32_t d32_13) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Ingest::VT_D32_13, d32_13, 0);
  }
  void add_d32_14(int32_t d32_14) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Ingest::VT_D32_14, d32_14, 0);
  }
  void add_d32_15(int32_t d32_15) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Ingest::VT_D32_15, d32_15, 0);
  }
  void add_d32_16(int32_t d32_16) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Ingest::VT_D32_16, d32_16, 0);
  }
  void add_d32_17(int64_t d32_17) {
    fbb_.AddElement<int64_t>(MtiTargetReport_Ingest::VT_D32_17, d32_17, 0);
  }
  void add_d32_18(int32_t d32_18) {
    fbb_.AddElement<int32_t>(MtiTargetReport_Ingest::VT_D32_18, d32_18, 0);
  }
  explicit MtiTargetReport_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<MtiTargetReport_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<MtiTargetReport_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<MtiTargetReport_Ingest> CreateMtiTargetReport_Ingest(
    ...
    int64_t d32_17 = 0,
    int32_t d32_18 = 0) {
  MtiTargetReport_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<MtiTargetReport_Ingest> CreateMtiTargetReport_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    int32_t d32_1 = 0,
    double d32_2 = 0.0,
    double d32_3 = 0.0,
...
inline const MtiTargetReport_Ingest *GetMtiTargetReport_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<MtiTargetReport_Ingest>(buf);
}

inline const MtiTargetReport_Ingest *GetSizePrefixedMtiTargetReport_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<MtiTargetReport_Ingest>(buf);
}

inline const char *MtiTargetReport_IngestIdentifier() {
  return "MTIT";
}

inline bool MtiTargetReport_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MtiTargetReport_IngestIdentifier());
}

inline bool SizePrefixedMtiTargetReport_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MtiTargetReport_IngestIdentifier(), true);
}

inline bool VerifyMtiTargetReport_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<MtiTargetReport_Ingest>(MtiTargetReport_IngestIdentifier());
}

inline bool VerifySizePrefixedMtiTargetReport_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<MtiTargetReport_Ingest>(MtiTargetReport_IngestIdentifier());
}

inline void FinishMtiTargetReport_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MtiTargetReport_Ingest> root) {
  fbb.Finish(root, MtiTargetReport_IngestIdentifier());
}

inline void FinishSizePrefixedMtiTargetReport_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MtiTargetReport_Ingest> root) {
  fbb.FinishSizePrefixed(root, MtiTargetReport_IngestIdentifier());
}
