...
struct IonoObservationDensityProfile_Ingest;
struct IonoObservationDensityProfile_IngestBuilder;

/// /// Profile of electron densities in the ionosphere associated with an IonoObservation.
struct IonoObservationDensityProfile_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef IonoObservationDensityProfile_IngestBuilder Builder;
...
struct IonoObservationDensityProfile_IngestBuilder {
  typedef IonoObservationDensityProfile_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_parabolic(::flatbuffers::Offset<::flatbuffers::String> parabolic) {
    fbb_.AddOffset(IonoObservationDensityProfile_Ingest::VT_PARABOLIC, parabolic);
  }
  void add_quasiParabolic(::flatbuffers::Offset<::flatbuffers::String> quasiParabolic) {
    fbb_.AddOffset(IonoObservationDensityProfile_Ingest::VT_QUASIPARABOLIC, quasiParabolic);
  }
  void add_valleyModelDescription(::flatbuffers::Offset<::flatbuffers::String> valleyModelDescription) {
    fbb_.AddOffset(IonoObservationDensityProfile_Ingest::VT_VALLEYMODELDESCRIPTION, valleyModelDescription);
  }
  void add_valleyModelCoeffs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> valleyModelCoeffs) {
    fbb_.AddOffset(IonoObservationDensityProfile_Ingest::VT_VALLEYMODELCOEFFS, valleyModelCoeffs);
  }
  void add_shiftedChebyshev(::flatbuffers::Offset<::flatbuffers::String> shiftedChebyshev) {
    fbb_.AddOffset(IonoObservationDensityProfile_Ingest::VT_SHIFTEDCHEBYSHEV, shiftedChebyshev);
  }
  void add_topsideExtensionChapmanConst(::flatbuffers::Offset<::flatbuffers::String> topsideExtensionChapmanConst) {
    fbb_.AddOffset(IonoObservationDensityProfile_Ingest::VT_TOPSIDEEXTENSIONCHAPMANCONST, topsideExtensionChapmanConst);
  }
  void add_topsideExtensionVaryChap(::flatbuffers::Offset<::flatbuffers::String> topsideExtensionVaryChap) {
    fbb_.AddOffset(IonoObservationDensityProfile_Ingest::VT_TOPSIDEEXTENSIONVARYCHAP, topsideExtensionVaryChap);
  }
  void add_iri(::flatbuffers::Offset<::flatbuffers::String> iri) {
    fbb_.AddOffset(IonoObservationDensityProfile_Ingest::VT_IRI, iri);
  }
  explicit IonoObservationDensityProfile_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<IonoObservationDensityProfile_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<IonoObservationDensityProfile_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<IonoObservationDensityProfile_Ingest> CreateIonoObservationDensityProfile_Ingest(
  ...
  IonoObservationDensityProfile_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<IonoObservationDensityProfile_Ingest> CreateIonoObservationDensityProfile_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const IonoObservationDensityProfile_Ingest *GetIonoObservationDensityProfile_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<IonoObservationDensityProfile_Ingest>(buf);
}

inline const IonoObservationDensityProfile_Ingest *GetSizePrefixedIonoObservationDensityProfile_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<IonoObservationDensityProfile_Ingest>(buf);
}

inline const char *IonoObservationDensityProfile_IngestIdentifier() {
  return "IONO";
}

inline bool IonoObservationDensityProfile_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationDensityProfile_IngestIdentifier());
}

inline bool SizePrefixedIonoObservationDensityProfile_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationDensityProfile_IngestIdentifier(), true);
}

inline bool VerifyIonoObservationDensityProfile_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<IonoObservationDensityProfile_Ingest>(IonoObservationDensityProfile_IngestIdentifier());
}

inline bool VerifySizePrefixedIonoObservationDensityProfile_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<IonoObservationDensityProfile_Ingest>(IonoObservationDensityProfile_IngestIdentifier());
}

inline void FinishIonoObservationDensityProfile_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationDensityProfile_Ingest> root) {
  fbb.Finish(root, IonoObservationDensityProfile_IngestIdentifier());
}

inline void FinishSizePrefixedIonoObservationDensityProfile_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationDensityProfile_Ingest> root) {
  fbb.FinishSizePrefixed(root, IonoObservationDensityProfile_IngestIdentifier());
}
