...
struct SeradataOpticalPayload_Abridged;
struct SeradataOpticalPayload_AbridgedBuilder;

enum SeradataOpticalPayload_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  SeradataOpticalPayload_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  SeradataOpticalPayload_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  SeradataOpticalPayload_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  SeradataOpticalPayload_Abridged_dataMode_Enum_EXERCISE = 3,
  SeradataOpticalPayload_Abridged_dataMode_Enum_MIN = SeradataOpticalPayload_Abridged_dataMode_Enum_REAL,
  SeradataOpticalPayload_Abridged_dataMode_Enum_MAX = SeradataOpticalPayload_Abridged_dataMode_Enum_EXERCISE
};

inline const SeradataOpticalPayload_Abridged_dataMode_Enum (&EnumValuesSeradataOpticalPayload_Abridged_dataMode_Enum())[4] {
  static const SeradataOpticalPayload_Abridged_dataMode_Enum values[] = {
    SeradataOpticalPayload_Abridged_dataMode_Enum_REAL,
    SeradataOpticalPayload_Abridged_dataMode_Enum_TEST,
    SeradataOpticalPayload_Abridged_dataMode_Enum_SIMULATED,
    SeradataOpticalPayload_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSeradataOpticalPayload_Abridged_dataMode_Enum() {
...
inline const char *EnumNameSeradataOpticalPayload_Abridged_dataMode_Enum(SeradataOpticalPayload_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SeradataOpticalPayload_Abridged_dataMode_Enum_REAL, SeradataOpticalPayload_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSeradataOpticalPayload_Abridged_dataMode_Enum()[index];
}

/// /// Details for an optical payload from  Seradata.
struct SeradataOpticalPayload_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SeradataOpticalPayload_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SeradataOpticalPayload_Abridged_dataMode_Enum dataMode() const {
    return static_cast<SeradataOpticalPayload_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SeradataOpticalPayload_AbridgedBuilder {
  typedef SeradataOpticalPayload_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_spacecraftId(::flatbuffers::Offset<::flatbuffers::String> spacecraftId) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_SPACECRAFTID, spacecraftId);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_IDSENSOR, idSensor);
  }
  void add_hostedForCompanyOrgId(::flatbuffers::Offset<::flatbuffers::String> hostedForCompanyOrgId) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_HOSTEDFORCOMPANYORGID, hostedForCompanyOrgId);
  }
  void add_manufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrgId) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_MANUFACTURERORGID, manufacturerOrgId);
  }
  void add_imagingPayloadCategory(::flatbuffers::Offset<::flatbuffers::String> imagingPayloadCategory) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_IMAGINGPAYLOADCATEGORY, imagingPayloadCategory);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_NAME, name);
  }
  void add_spectralBand(::flatbuffers::Offset<::flatbuffers::String> spectralBand) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_SPECTRALBAND, spectralBand);
  }
  void add_spectralFrequencyLimits(::flatbuffers::Offset<::flatbuffers::String> spectralFrequencyLimits) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_SPECTRALFREQUENCYLIMITS, spectralFrequencyLimits);
  }
  void add_numberOfFilmReturnCanisters(int32_t numberOfFilmReturnCanisters) {
    fbb_.AddElement<int32_t>(SeradataOpticalPayload_Abridged::VT_NUMBEROFFILMRETURNCANISTERS, numberOfFilmReturnCanisters, 0);
  }
  void add_bestResolution(double bestResolution) {
    fbb_.AddElement<double>(SeradataOpticalPayload_Abridged::VT_BESTRESOLUTION, bestResolution, 0.0);
  }
  void add_swathWidth(double swathWidth) {
    fbb_.AddElement<double>(SeradataOpticalPayload_Abridged::VT_SWATHWIDTH, swathWidth, 0.0);
  }
  void add_recorderSize(::flatbuffers::Offset<::flatbuffers::String> recorderSize) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_RECORDERSIZE, recorderSize);
  }
  void add_fieldOfView(double fieldOfView) {
    fbb_.AddElement<double>(SeradataOpticalPayload_Abridged::VT_FIELDOFVIEW, fieldOfView, 0.0);
  }
  void add_fieldOfRegard(double fieldOfRegard) {
    fbb_.AddElement<double>(SeradataOpticalPayload_Abridged::VT_FIELDOFREGARD, fieldOfRegard, 0.0);
  }
  void add_pointingMethod(::flatbuffers::Offset<::flatbuffers::String> pointingMethod) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_POINTINGMETHOD, pointingMethod);
  }
  void add_groundStations(::flatbuffers::Offset<::flatbuffers::String> groundStations) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_GROUNDSTATIONS, groundStations);
  }
  void add_groundStationLocations(::flatbuffers::Offset<::flatbuffers::String> groundStationLocations) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_GROUNDSTATIONLOCATIONS, groundStationLocations);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_NOTES, notes);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SeradataOpticalPayload_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(SeradataOpticalPayload_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SeradataOpticalPayload_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit SeradataOpticalPayload_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SeradataOpticalPayload_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SeradataOpticalPayload_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SeradataOpticalPayload_Abridged> CreateSeradataOpticalPayload_Abridged(
    ...
    SeradataOpticalPayload_Abridged_dataMode_Enum dataMode = SeradataOpticalPayload_Abridged_dataMode_Enum_REAL) {
  SeradataOpticalPayload_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SeradataOpticalPayload_Abridged> CreateSeradataOpticalPayload_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const SeradataOpticalPayload_Abridged *GetSeradataOpticalPayload_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<SeradataOpticalPayload_Abridged>(buf);
}

inline const SeradataOpticalPayload_Abridged *GetSizePrefixedSeradataOpticalPayload_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SeradataOpticalPayload_Abridged>(buf);
}

inline const char *SeradataOpticalPayload_AbridgedIdentifier() {
  return "SERA";
}

inline bool SeradataOpticalPayload_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataOpticalPayload_AbridgedIdentifier());
}

inline bool SizePrefixedSeradataOpticalPayload_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataOpticalPayload_AbridgedIdentifier(), true);
}

inline bool VerifySeradataOpticalPayload_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SeradataOpticalPayload_Abridged>(SeradataOpticalPayload_AbridgedIdentifier());
}

inline bool VerifySizePrefixedSeradataOpticalPayload_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SeradataOpticalPayload_Abridged>(SeradataOpticalPayload_AbridgedIdentifier());
}

inline void FinishSeradataOpticalPayload_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataOpticalPayload_Abridged> root) {
  fbb.Finish(root, SeradataOpticalPayload_AbridgedIdentifier());
}

inline void FinishSizePrefixedSeradataOpticalPayload_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataOpticalPayload_Abridged> root) {
  fbb.FinishSizePrefixed(root, SeradataOpticalPayload_AbridgedIdentifier());
}
