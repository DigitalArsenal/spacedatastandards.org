...
struct POI_Abridged;
struct POI_AbridgedBuilder;

enum POI_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  POI_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  POI_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  POI_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  POI_Abridged_dataMode_Enum_EXERCISE = 3,
  POI_Abridged_dataMode_Enum_MIN = POI_Abridged_dataMode_Enum_REAL,
  POI_Abridged_dataMode_Enum_MAX = POI_Abridged_dataMode_Enum_EXERCISE
};

inline const POI_Abridged_dataMode_Enum (&EnumValuesPOI_Abridged_dataMode_Enum())[4] {
  static const POI_Abridged_dataMode_Enum values[] = {
    POI_Abridged_dataMode_Enum_REAL,
    POI_Abridged_dataMode_Enum_TEST,
    POI_Abridged_dataMode_Enum_SIMULATED,
    POI_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesPOI_Abridged_dataMode_Enum() {
...
inline const char *EnumNamePOI_Abridged_dataMode_Enum(POI_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, POI_Abridged_dataMode_Enum_REAL, POI_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesPOI_Abridged_dataMode_Enum()[index];
}
...
struct POI_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef POI_AbridgedBuilder Builder;
  ...
  POI_Abridged_dataMode_Enum dataMode() const {
    return static_cast<POI_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct POI_AbridgedBuilder {
  typedef POI_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(POI_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(POI_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_pps(::flatbuffers::Offset<::flatbuffers::String> pps) {
    fbb_.AddOffset(POI_Abridged::VT_PPS, pps);
  }
  void add_msnid(::flatbuffers::Offset<::flatbuffers::String> msnid) {
    fbb_.AddOffset(POI_Abridged::VT_MSNID, msnid);
  }
  void add_pri(int32_t pri) {
    fbb_.AddElement<int32_t>(POI_Abridged::VT_PRI, pri, 0);
  }
  void add_trkid(::flatbuffers::Offset<::flatbuffers::String> trkid) {
    fbb_.AddOffset(POI_Abridged::VT_TRKID, trkid);
  }
  void add_idWeatherReport(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> idWeatherReport) {
    fbb_.AddOffset(POI_Abridged::VT_IDWEATHERREPORT, idWeatherReport);
  }
  void add_poiid(::flatbuffers::Offset<::flatbuffers::String> poiid) {
    fbb_.AddOffset(POI_Abridged::VT_POIID, poiid);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(POI_Abridged::VT_NAME, name);
  }
  void add_desc(::flatbuffers::Offset<::flatbuffers::String> desc) {
    fbb_.AddOffset(POI_Abridged::VT_DESC, desc);
  }
  void add_spec(::flatbuffers::Offset<::flatbuffers::String> spec) {
    fbb_.AddOffset(POI_Abridged::VT_SPEC, spec);
  }
  void add_ident(::flatbuffers::Offset<::flatbuffers::String> ident) {
    fbb_.AddOffset(POI_Abridged::VT_IDENT, ident);
  }
  void add_env(::flatbuffers::Offset<::flatbuffers::String> env) {
    fbb_.AddOffset(POI_Abridged::VT_ENV, env);
  }
  void add_plat(::flatbuffers::Offset<::flatbuffers::String> plat) {
    fbb_.AddOffset(POI_Abridged::VT_PLAT, plat);
  }
  void add_activity(::flatbuffers::Offset<::flatbuffers::String> activity) {
    fbb_.AddOffset(POI_Abridged::VT_ACTIVITY, activity);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::String> ts) {
    fbb_.AddOffset(POI_Abridged::VT_TS, ts);
  }
  void add_start(::flatbuffers::Offset<::flatbuffers::String> start) {
    fbb_.AddOffset(POI_Abridged::VT_START, start);
  }
  void add_stale(::flatbuffers::Offset<::flatbuffers::String> stale) {
    fbb_.AddOffset(POI_Abridged::VT_STALE, stale);
  }
  void add_how(::flatbuffers::Offset<::flatbuffers::String> how) {
    fbb_.AddOffset(POI_Abridged::VT_HOW, how);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(POI_Abridged::VT_TYPE, type);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(POI_Abridged::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(POI_Abridged::VT_LON, lon, 0.0);
  }
  void add_alt(double alt) {
    fbb_.AddElement<double>(POI_Abridged::VT_ALT, alt, 0.0);
  }
  void add_az(double az) {
    fbb_.AddElement<double>(POI_Abridged::VT_AZ, az, 0.0);
  }
  void add_el(double el) {
    fbb_.AddElement<double>(POI_Abridged::VT_EL, el, 0.0);
  }
  void add_le(double le) {
    fbb_.AddElement<double>(POI_Abridged::VT_LE, le, 0.0);
  }
  void add_ce(double ce) {
    fbb_.AddElement<double>(POI_Abridged::VT_CE, ce, 0.0);
  }
  void add_elle(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> elle) {
    fbb_.AddOffset(POI_Abridged::VT_ELLE, elle);
  }
  void add_cntct(::flatbuffers::Offset<::flatbuffers::String> cntct) {
    fbb_.AddOffset(POI_Abridged::VT_CNTCT, cntct);
  }
  void add_conf(double conf) {
    fbb_.AddElement<double>(POI_Abridged::VT_CONF, conf, 0.0);
  }
  void add_urls(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> urls) {
    fbb_.AddOffset(POI_Abridged::VT_URLS, urls);
  }
  void add_atext(::flatbuffers::Offset<::flatbuffers::String> atext) {
    fbb_.AddOffset(POI_Abridged::VT_ATEXT, atext);
  }
  void add_agjson(::flatbuffers::Offset<::flatbuffers::String> agjson) {
    fbb_.AddOffset(POI_Abridged::VT_AGJSON, agjson);
  }
  void add_atype(::flatbuffers::Offset<::flatbuffers::String> atype) {
    fbb_.AddOffset(POI_Abridged::VT_ATYPE, atype);
  }
  void add_andims(int32_t andims) {
    fbb_.AddElement<int32_t>(POI_Abridged::VT_ANDIMS, andims, 0);
  }
  void add_asrid(int32_t asrid) {
    fbb_.AddElement<int32_t>(POI_Abridged::VT_ASRID, asrid, 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(POI_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(POI_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(POI_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(POI_Abridged::VT_SOURCE, source);
  }
  void add_dataMode(POI_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(POI_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(POI_Abridged::VT_ORIGIN, origin);
  }
  void add_groups(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> groups) {
    fbb_.AddOffset(POI_Abridged::VT_GROUPS, groups);
  }
  void add_asset(::flatbuffers::Offset<::flatbuffers::String> asset) {
    fbb_.AddOffset(POI_Abridged::VT_ASSET, asset);
  }
  void add_beNumber(::flatbuffers::Offset<::flatbuffers::String> beNumber) {
    fbb_.AddOffset(POI_Abridged::VT_BENUMBER, beNumber);
  }
  void add_orientation(double orientation) {
    fbb_.AddElement<double>(POI_Abridged::VT_ORIENTATION, orientation, 0.0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(POI_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(POI_Abridged::VT_TRANSACTIONID, transactionId);
  }
  explicit POI_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<POI_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<POI_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<POI_Abridged> CreatePOI_Abridged(
    ...
    POI_Abridged_dataMode_Enum dataMode = POI_Abridged_dataMode_Enum_REAL,
  ...
  POI_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<POI_Abridged> CreatePOI_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const POI_Abridged *GetPOI_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<POI_Abridged>(buf);
}

inline const POI_Abridged *GetSizePrefixedPOI_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<POI_Abridged>(buf);
}

inline const char *POI_AbridgedIdentifier() {
  return "POIA";
}

inline bool POI_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, POI_AbridgedIdentifier());
}

inline bool SizePrefixedPOI_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, POI_AbridgedIdentifier(), true);
}

inline bool VerifyPOI_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<POI_Abridged>(POI_AbridgedIdentifier());
}

inline bool VerifySizePrefixedPOI_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<POI_Abridged>(POI_AbridgedIdentifier());
}

inline void FinishPOI_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<POI_Abridged> root) {
  fbb.Finish(root, POI_AbridgedIdentifier());
}

inline void FinishSizePrefixedPOI_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<POI_Abridged> root) {
  fbb.FinishSizePrefixed(root, POI_AbridgedIdentifier());
}
