...
struct LogisticsSpecialties_Abridged;
struct LogisticsSpecialties_AbridgedBuilder;

/// /// The specialties required to implement this support item.
struct LogisticsSpecialties_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LogisticsSpecialties_AbridgedBuilder Builder;
...
struct LogisticsSpecialties_AbridgedBuilder {
  typedef LogisticsSpecialties_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_specialty(::flatbuffers::Offset<::flatbuffers::String> specialty) {
    fbb_.AddOffset(LogisticsSpecialties_Abridged::VT_SPECIALTY, specialty);
  }
  void add_skillLevel(int32_t skillLevel) {
    fbb_.AddElement<int32_t>(LogisticsSpecialties_Abridged::VT_SKILLLEVEL, skillLevel, 0);
  }
  void add_firstName(::flatbuffers::Offset<::flatbuffers::String> firstName) {
    fbb_.AddOffset(LogisticsSpecialties_Abridged::VT_FIRSTNAME, firstName);
  }
  void add_lastName(::flatbuffers::Offset<::flatbuffers::String> lastName) {
    fbb_.AddOffset(LogisticsSpecialties_Abridged::VT_LASTNAME, lastName);
  }
  void add_rankCode(::flatbuffers::Offset<::flatbuffers::String> rankCode) {
    fbb_.AddOffset(LogisticsSpecialties_Abridged::VT_RANKCODE, rankCode);
  }
  void add_last4Ssn(::flatbuffers::Offset<::flatbuffers::String> last4Ssn) {
    fbb_.AddOffset(LogisticsSpecialties_Abridged::VT_LAST4SSN, last4Ssn);
  }
  void add_roleTypeCode(::flatbuffers::Offset<::flatbuffers::String> roleTypeCode) {
    fbb_.AddOffset(LogisticsSpecialties_Abridged::VT_ROLETYPECODE, roleTypeCode);
  }
  explicit LogisticsSpecialties_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LogisticsSpecialties_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LogisticsSpecialties_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LogisticsSpecialties_Abridged> CreateLogisticsSpecialties_Abridged(
  ...
  LogisticsSpecialties_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<LogisticsSpecialties_Abridged> CreateLogisticsSpecialties_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const LogisticsSpecialties_Abridged *GetLogisticsSpecialties_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<LogisticsSpecialties_Abridged>(buf);
}

inline const LogisticsSpecialties_Abridged *GetSizePrefixedLogisticsSpecialties_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<LogisticsSpecialties_Abridged>(buf);
}

inline const char *LogisticsSpecialties_AbridgedIdentifier() {
  return "LOGI";
}

inline bool LogisticsSpecialties_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsSpecialties_AbridgedIdentifier());
}

inline bool SizePrefixedLogisticsSpecialties_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsSpecialties_AbridgedIdentifier(), true);
}

inline bool VerifyLogisticsSpecialties_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<LogisticsSpecialties_Abridged>(LogisticsSpecialties_AbridgedIdentifier());
}

inline bool VerifySizePrefixedLogisticsSpecialties_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<LogisticsSpecialties_Abridged>(LogisticsSpecialties_AbridgedIdentifier());
}

inline void FinishLogisticsSpecialties_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsSpecialties_Abridged> root) {
  fbb.Finish(root, LogisticsSpecialties_AbridgedIdentifier());
}

inline void FinishSizePrefixedLogisticsSpecialties_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsSpecialties_Abridged> root) {
  fbb.FinishSizePrefixed(root, LogisticsSpecialties_AbridgedIdentifier());
}
