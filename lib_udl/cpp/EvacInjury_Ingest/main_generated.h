...
struct EvacInjury_Ingest;
struct EvacInjury_IngestBuilder;

/// /// Injury specifics.
struct EvacInjury_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EvacInjury_IngestBuilder Builder;
...
struct EvacInjury_IngestBuilder {
  typedef EvacInjury_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(EvacInjury_Ingest::VT_TYPE, type);
  }
  void add_bodyPart(::flatbuffers::Offset<::flatbuffers::String> bodyPart) {
    fbb_.AddOffset(EvacInjury_Ingest::VT_BODYPART, bodyPart);
  }
  void add_time(::flatbuffers::Offset<::flatbuffers::String> time) {
    fbb_.AddOffset(EvacInjury_Ingest::VT_TIME, time);
  }
  void add_comments(::flatbuffers::Offset<::flatbuffers::String> comments) {
    fbb_.AddOffset(EvacInjury_Ingest::VT_COMMENTS, comments);
  }
  explicit EvacInjury_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<EvacInjury_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<EvacInjury_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<EvacInjury_Ingest> CreateEvacInjury_Ingest(
  ...
  EvacInjury_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<EvacInjury_Ingest> CreateEvacInjury_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const EvacInjury_Ingest *GetEvacInjury_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<EvacInjury_Ingest>(buf);
}

inline const EvacInjury_Ingest *GetSizePrefixedEvacInjury_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EvacInjury_Ingest>(buf);
}

inline const char *EvacInjury_IngestIdentifier() {
  return "EVAC";
}

inline bool EvacInjury_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EvacInjury_IngestIdentifier());
}

inline bool SizePrefixedEvacInjury_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EvacInjury_IngestIdentifier(), true);
}

inline bool VerifyEvacInjury_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EvacInjury_Ingest>(EvacInjury_IngestIdentifier());
}

inline bool VerifySizePrefixedEvacInjury_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EvacInjury_Ingest>(EvacInjury_IngestIdentifier());
}

inline void FinishEvacInjury_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EvacInjury_Ingest> root) {
  fbb.Finish(root, EvacInjury_IngestIdentifier());
}

inline void FinishSizePrefixedEvacInjury_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EvacInjury_Ingest> root) {
  fbb.FinishSizePrefixed(root, EvacInjury_IngestIdentifier());
}
