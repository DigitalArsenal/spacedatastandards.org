...
struct EffectRequest_Abridged;
struct EffectRequest_AbridgedBuilder;

enum EffectRequest_Abridged_dataMode_Enum : int8_t {
  ...
  EffectRequest_Abridged_dataMode_Enum_MIN = EffectRequest_Abridged_dataMode_Enum_REAL,
  EffectRequest_Abridged_dataMode_Enum_MAX = EffectRequest_Abridged_dataMode_Enum_EXERCISE
};

inline const EffectRequest_Abridged_dataMode_Enum (&EnumValuesEffectRequest_Abridged_dataMode_Enum())[4] {
  static const EffectRequest_Abridged_dataMode_Enum values[] = {
    EffectRequest_Abridged_dataMode_Enum_REAL,
    EffectRequest_Abridged_dataMode_Enum_TEST,
    EffectRequest_Abridged_dataMode_Enum_SIMULATED,
    EffectRequest_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesEffectRequest_Abridged_dataMode_Enum() {
...
inline const char *EnumNameEffectRequest_Abridged_dataMode_Enum(EffectRequest_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, EffectRequest_Abridged_dataMode_Enum_REAL, EffectRequest_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEffectRequest_Abridged_dataMode_Enum()[index];
}

/// /// A request for various effects on a target.
struct EffectRequest_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EffectRequest_AbridgedBuilder Builder;
  ...
  EffectRequest_Abridged_dataMode_Enum dataMode() const {
    return static_cast<EffectRequest_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct EffectRequest_AbridgedBuilder {
  typedef EffectRequest_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_externalRequestId(::flatbuffers::Offset<::flatbuffers::String> externalRequestId) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_EXTERNALREQUESTID, externalRequestId);
  }
  void add_effectList(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> effectList) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_EFFECTLIST, effectList);
  }
  void add_state(::flatbuffers::Offset<::flatbuffers::String> state) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_STATE, state);
  }
  void add_context(::flatbuffers::Offset<::flatbuffers::String> context) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_CONTEXT, context);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_ENDTIME, endTime);
  }
  void add_deadlineType(::flatbuffers::Offset<::flatbuffers::String> deadlineType) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_DEADLINETYPE, deadlineType);
  }
  void add_targetSrcType(::flatbuffers::Offset<::flatbuffers::String> targetSrcType) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_TARGETSRCTYPE, targetSrcType);
  }
  void add_targetSrcId(::flatbuffers::Offset<::flatbuffers::String> targetSrcId) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_TARGETSRCID, targetSrcId);
  }
  void add_priority(::flatbuffers::Offset<::flatbuffers::String> priority) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_PRIORITY, priority);
  }
  void add_modelClass(::flatbuffers::Offset<::flatbuffers::String> modelClass) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_MODELCLASS, modelClass);
  }
  void add_metricTypes(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> metricTypes) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_METRICTYPES, metricTypes);
  }
  void add_metricWeights(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> metricWeights) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_METRICWEIGHTS, metricWeights);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(EffectRequest_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(EffectRequest_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(EffectRequest_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  explicit EffectRequest_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<EffectRequest_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<EffectRequest_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<EffectRequest_Abridged> CreateEffectRequest_Abridged(
    ...
    EffectRequest_Abridged_dataMode_Enum dataMode = EffectRequest_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  EffectRequest_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<EffectRequest_Abridged> CreateEffectRequest_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateEffectRequest_Abridged(
      _fbb,
      id__,
...
inline const EffectRequest_Abridged *GetEffectRequest_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<EffectRequest_Abridged>(buf);
}

inline const EffectRequest_Abridged *GetSizePrefixedEffectRequest_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EffectRequest_Abridged>(buf);
}

inline const char *EffectRequest_AbridgedIdentifier() {
  return "EFFE";
}

inline bool EffectRequest_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EffectRequest_AbridgedIdentifier());
}

inline bool SizePrefixedEffectRequest_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EffectRequest_AbridgedIdentifier(), true);
}

inline bool VerifyEffectRequest_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EffectRequest_Abridged>(EffectRequest_AbridgedIdentifier());
}

inline bool VerifySizePrefixedEffectRequest_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EffectRequest_Abridged>(EffectRequest_AbridgedIdentifier());
}

inline void FinishEffectRequest_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EffectRequest_Abridged> root) {
  fbb.Finish(root, EffectRequest_AbridgedIdentifier());
}

inline void FinishSizePrefixedEffectRequest_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EffectRequest_Abridged> root) {
  fbb.FinishSizePrefixed(root, EffectRequest_AbridgedIdentifier());
}
