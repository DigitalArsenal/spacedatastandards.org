...
struct MtiMission_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef MtiMission_FullBuilder Builder;
...
struct MtiMission_FullBuilder {
  typedef MtiMission_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_m1(::flatbuffers::Offset<::flatbuffers::String> m1) {
    fbb_.AddOffset(MtiMission_Full::VT_M1, m1);
  }
  void add_m2(::flatbuffers::Offset<::flatbuffers::String> m2) {
    fbb_.AddOffset(MtiMission_Full::VT_M2, m2);
  }
  void add_m3(::flatbuffers::Offset<::flatbuffers::String> m3) {
    fbb_.AddOffset(MtiMission_Full::VT_M3, m3);
  }
  void add_m4(::flatbuffers::Offset<::flatbuffers::String> m4) {
    fbb_.AddOffset(MtiMission_Full::VT_M4, m4);
  }
  void add_msnRefTs(::flatbuffers::Offset<::flatbuffers::String> msnRefTs) {
    fbb_.AddOffset(MtiMission_Full::VT_MSNREFTS, msnRefTs);
  }
  explicit MtiMission_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<MtiMission_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<MtiMission_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<MtiMission_Full> CreateMtiMission_Full(
  ...
  MtiMission_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<MtiMission_Full> CreateMtiMission_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const MtiMission_Full *GetMtiMission_Full(const void *buf) {
  return ::flatbuffers::GetRoot<MtiMission_Full>(buf);
}

inline const MtiMission_Full *GetSizePrefixedMtiMission_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<MtiMission_Full>(buf);
}

inline const char *MtiMission_FullIdentifier() {
  return "MTIM";
}

inline bool MtiMission_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MtiMission_FullIdentifier());
}

inline bool SizePrefixedMtiMission_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MtiMission_FullIdentifier(), true);
}

inline bool VerifyMtiMission_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<MtiMission_Full>(MtiMission_FullIdentifier());
}

inline bool VerifySizePrefixedMtiMission_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<MtiMission_Full>(MtiMission_FullIdentifier());
}

inline void FinishMtiMission_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MtiMission_Full> root) {
  fbb.Finish(root, MtiMission_FullIdentifier());
}

inline void FinishSizePrefixedMtiMission_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MtiMission_Full> root) {
  fbb.FinishSizePrefixed(root, MtiMission_FullIdentifier());
}
