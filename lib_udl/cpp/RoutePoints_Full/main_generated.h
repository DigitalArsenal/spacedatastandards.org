...
struct RoutePoints_Full;
struct RoutePoints_FullBuilder;

/// /// Points identified within the route.
struct RoutePoints_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef RoutePoints_FullBuilder Builder;
...
struct RoutePoints_FullBuilder {
  typedef RoutePoints_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_ptSequenceId(int32_t ptSequenceId) {
    fbb_.AddElement<int32_t>(RoutePoints_Full::VT_PTSEQUENCEID, ptSequenceId, 0);
  }
  void add_ptTypeCode(::flatbuffers::Offset<::flatbuffers::String> ptTypeCode) {
    fbb_.AddOffset(RoutePoints_Full::VT_PTTYPECODE, ptTypeCode);
  }
  void add_ptTypeName(::flatbuffers::Offset<::flatbuffers::String> ptTypeName) {
    fbb_.AddOffset(RoutePoints_Full::VT_PTTYPENAME, ptTypeName);
  }
  void add_waypointName(::flatbuffers::Offset<::flatbuffers::String> waypointName) {
    fbb_.AddOffset(RoutePoints_Full::VT_WAYPOINTNAME, waypointName);
  }
  void add_dafifPt(bool dafifPt) {
    fbb_.AddElement<uint8_t>(RoutePoints_Full::VT_DAFIFPT, static_cast<uint8_t>(dafifPt), 0);
  }
  void add_ptLat(double ptLat) {
    fbb_.AddElement<double>(RoutePoints_Full::VT_PTLAT, ptLat, 0.0);
  }
  void add_ptLon(double ptLon) {
    fbb_.AddElement<double>(RoutePoints_Full::VT_PTLON, ptLon, 0.0);
  }
  void add_magDec(double magDec) {
    fbb_.AddElement<double>(RoutePoints_Full::VT_MAGDEC, magDec, 0.0);
  }
  void add_navaidLength(double navaidLength) {
    fbb_.AddElement<double>(RoutePoints_Full::VT_NAVAIDLENGTH, navaidLength, 0.0);
  }
  void add_navaid(::flatbuffers::Offset<::flatbuffers::String> navaid) {
    fbb_.AddOffset(RoutePoints_Full::VT_NAVAID, navaid);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(RoutePoints_Full::VT_COUNTRYCODE, countryCode);
  }
  void add_altCountryCode(::flatbuffers::Offset<::flatbuffers::String> altCountryCode) {
    fbb_.AddOffset(RoutePoints_Full::VT_ALTCOUNTRYCODE, altCountryCode);
  }
  void add_navaidType(::flatbuffers::Offset<::flatbuffers::String> navaidType) {
    fbb_.AddOffset(RoutePoints_Full::VT_NAVAIDTYPE, navaidType);
  }
  explicit RoutePoints_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<RoutePoints_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<RoutePoints_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<RoutePoints_Full> CreateRoutePoints_Full(
  ...
  RoutePoints_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<RoutePoints_Full> CreateRoutePoints_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    int32_t ptSequenceId = 0,
...
inline const RoutePoints_Full *GetRoutePoints_Full(const void *buf) {
  return ::flatbuffers::GetRoot<RoutePoints_Full>(buf);
}

inline const RoutePoints_Full *GetSizePrefixedRoutePoints_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<RoutePoints_Full>(buf);
}

inline const char *RoutePoints_FullIdentifier() {
  return "ROUT";
}

inline bool RoutePoints_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RoutePoints_FullIdentifier());
}

inline bool SizePrefixedRoutePoints_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RoutePoints_FullIdentifier(), true);
}

inline bool VerifyRoutePoints_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<RoutePoints_Full>(RoutePoints_FullIdentifier());
}

inline bool VerifySizePrefixedRoutePoints_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<RoutePoints_Full>(RoutePoints_FullIdentifier());
}

inline void FinishRoutePoints_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RoutePoints_Full> root) {
  fbb.Finish(root, RoutePoints_FullIdentifier());
}

inline void FinishSizePrefixedRoutePoints_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RoutePoints_Full> root) {
  fbb.FinishSizePrefixed(root, RoutePoints_FullIdentifier());
}
