...
struct LogisticsParts_Ingest;
struct LogisticsParts_IngestBuilder;

/// /// The parts associated with this support item.
struct LogisticsParts_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LogisticsParts_IngestBuilder Builder;
...
struct LogisticsParts_IngestBuilder {
  typedef LogisticsParts_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_partNumber(::flatbuffers::Offset<::flatbuffers::String> partNumber) {
    fbb_.AddOffset(LogisticsParts_Ingest::VT_PARTNUMBER, partNumber);
  }
  void add_nationalStockNumber(::flatbuffers::Offset<::flatbuffers::String> nationalStockNumber) {
    fbb_.AddOffset(LogisticsParts_Ingest::VT_NATIONALSTOCKNUMBER, nationalStockNumber);
  }
  void add_measurementUnitCode(::flatbuffers::Offset<::flatbuffers::String> measurementUnitCode) {
    fbb_.AddOffset(LogisticsParts_Ingest::VT_MEASUREMENTUNITCODE, measurementUnitCode);
  }
  void add_workUnitCode(::flatbuffers::Offset<::flatbuffers::String> workUnitCode) {
    fbb_.AddOffset(LogisticsParts_Ingest::VT_WORKUNITCODE, workUnitCode);
  }
  void add_technicalOrderText(::flatbuffers::Offset<::flatbuffers::String> technicalOrderText) {
    fbb_.AddOffset(LogisticsParts_Ingest::VT_TECHNICALORDERTEXT, technicalOrderText);
  }
  void add_figureNumber(::flatbuffers::Offset<::flatbuffers::String> figureNumber) {
    fbb_.AddOffset(LogisticsParts_Ingest::VT_FIGURENUMBER, figureNumber);
  }
  void add_indexNumber(::flatbuffers::Offset<::flatbuffers::String> indexNumber) {
    fbb_.AddOffset(LogisticsParts_Ingest::VT_INDEXNUMBER, indexNumber);
  }
  void add_requestVerifier(::flatbuffers::Offset<::flatbuffers::String> requestVerifier) {
    fbb_.AddOffset(LogisticsParts_Ingest::VT_REQUESTVERIFIER, requestVerifier);
  }
  void add_locationVerifier(::flatbuffers::Offset<::flatbuffers::String> locationVerifier) {
    fbb_.AddOffset(LogisticsParts_Ingest::VT_LOCATIONVERIFIER, locationVerifier);
  }
  void add_supplyDocumentNumber(::flatbuffers::Offset<::flatbuffers::String> supplyDocumentNumber) {
    fbb_.AddOffset(LogisticsParts_Ingest::VT_SUPPLYDOCUMENTNUMBER, supplyDocumentNumber);
  }
  void add_logisticsStocks(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsStocks) {
    fbb_.AddOffset(LogisticsParts_Ingest::VT_LOGISTICSSTOCKS, logisticsStocks);
  }
  explicit LogisticsParts_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LogisticsParts_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LogisticsParts_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LogisticsParts_Ingest> CreateLogisticsParts_Ingest(
  ...
  LogisticsParts_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<LogisticsParts_Ingest> CreateLogisticsParts_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateLogisticsParts_Ingest(
      _fbb,
      partNumber__,
...
inline const LogisticsParts_Ingest *GetLogisticsParts_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<LogisticsParts_Ingest>(buf);
}

inline const LogisticsParts_Ingest *GetSizePrefixedLogisticsParts_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<LogisticsParts_Ingest>(buf);
}

inline const char *LogisticsParts_IngestIdentifier() {
  return "LOGI";
}

inline bool LogisticsParts_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsParts_IngestIdentifier());
}

inline bool SizePrefixedLogisticsParts_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsParts_IngestIdentifier(), true);
}

inline bool VerifyLogisticsParts_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<LogisticsParts_Ingest>(LogisticsParts_IngestIdentifier());
}

inline bool VerifySizePrefixedLogisticsParts_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<LogisticsParts_Ingest>(LogisticsParts_IngestIdentifier());
}

inline void FinishLogisticsParts_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsParts_Ingest> root) {
  fbb.Finish(root, LogisticsParts_IngestIdentifier());
}

inline void FinishSizePrefixedLogisticsParts_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsParts_Ingest> root) {
  fbb.FinishSizePrefixed(root, LogisticsParts_IngestIdentifier());
}
