...
struct AirEvent_Abridged;
struct AirEvent_AbridgedBuilder;

enum AirEvent_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  AirEvent_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  AirEvent_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  AirEvent_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  AirEvent_Abridged_dataMode_Enum_EXERCISE = 3,
  AirEvent_Abridged_dataMode_Enum_MIN = AirEvent_Abridged_dataMode_Enum_REAL,
  AirEvent_Abridged_dataMode_Enum_MAX = AirEvent_Abridged_dataMode_Enum_EXERCISE
};

inline const AirEvent_Abridged_dataMode_Enum (&EnumValuesAirEvent_Abridged_dataMode_Enum())[4] {
  static const AirEvent_Abridged_dataMode_Enum values[] = {
    AirEvent_Abridged_dataMode_Enum_REAL,
    AirEvent_Abridged_dataMode_Enum_TEST,
    AirEvent_Abridged_dataMode_Enum_SIMULATED,
    AirEvent_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAirEvent_Abridged_dataMode_Enum() {
...
inline const char *EnumNameAirEvent_Abridged_dataMode_Enum(AirEvent_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AirEvent_Abridged_dataMode_Enum_REAL, AirEvent_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAirEvent_Abridged_dataMode_Enum()[index];
}

/// /// Information related to an air event (e.g. FUEL TRANSFER, AIR DROP) and the associated aircraft.
struct AirEvent_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirEvent_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  AirEvent_Abridged_dataMode_Enum dataMode() const {
    return static_cast<AirEvent_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AirEvent_AbridgedBuilder {
  typedef AirEvent_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AirEvent_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AirEvent_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(AirEvent_Abridged::VT_TYPE, type);
  }
  void add_idSortie(::flatbuffers::Offset<::flatbuffers::String> idSortie) {
    fbb_.AddOffset(AirEvent_Abridged::VT_IDSORTIE, idSortie);
  }
  void add_idMission(::flatbuffers::Offset<::flatbuffers::String> idMission) {
    fbb_.AddOffset(AirEvent_Abridged::VT_IDMISSION, idMission);
  }
  void add_externalAirEventId(::flatbuffers::Offset<::flatbuffers::String> externalAirEventId) {
    fbb_.AddOffset(AirEvent_Abridged::VT_EXTERNALAIREVENTID, externalAirEventId);
  }
  void add_legNum(int32_t legNum) {
    fbb_.AddElement<int32_t>(AirEvent_Abridged::VT_LEGNUM, legNum, 0);
  }
  void add_location(::flatbuffers::Offset<::flatbuffers::String> location) {
    fbb_.AddOffset(AirEvent_Abridged::VT_LOCATION, location);
  }
  void add_arrPurpose(::flatbuffers::Offset<::flatbuffers::String> arrPurpose) {
    fbb_.AddOffset(AirEvent_Abridged::VT_ARRPURPOSE, arrPurpose);
  }
  void add_plannedArrTime(::flatbuffers::Offset<::flatbuffers::String> plannedArrTime) {
    fbb_.AddOffset(AirEvent_Abridged::VT_PLANNEDARRTIME, plannedArrTime);
  }
  void add_estArrTime(::flatbuffers::Offset<::flatbuffers::String> estArrTime) {
    fbb_.AddOffset(AirEvent_Abridged::VT_ESTARRTIME, estArrTime);
  }
  void add_actualArrTime(::flatbuffers::Offset<::flatbuffers::String> actualArrTime) {
    fbb_.AddOffset(AirEvent_Abridged::VT_ACTUALARRTIME, actualArrTime);
  }
  void add_depPurpose(::flatbuffers::Offset<::flatbuffers::String> depPurpose) {
    fbb_.AddOffset(AirEvent_Abridged::VT_DEPPURPOSE, depPurpose);
  }
  void add_plannedDepTime(::flatbuffers::Offset<::flatbuffers::String> plannedDepTime) {
    fbb_.AddOffset(AirEvent_Abridged::VT_PLANNEDDEPTIME, plannedDepTime);
  }
  void add_estDepTime(::flatbuffers::Offset<::flatbuffers::String> estDepTime) {
    fbb_.AddOffset(AirEvent_Abridged::VT_ESTDEPTIME, estDepTime);
  }
  void add_actualDepTime(::flatbuffers::Offset<::flatbuffers::String> actualDepTime) {
    fbb_.AddOffset(AirEvent_Abridged::VT_ACTUALDEPTIME, actualDepTime);
  }
  void add_externalARTrackId(::flatbuffers::Offset<::flatbuffers::String> externalARTrackId) {
    fbb_.AddOffset(AirEvent_Abridged::VT_EXTERNALARTRACKID, externalARTrackId);
  }
  void add_arTrackId(::flatbuffers::Offset<::flatbuffers::String> arTrackId) {
    fbb_.AddOffset(AirEvent_Abridged::VT_ARTRACKID, arTrackId);
  }
  void add_arTrackName(::flatbuffers::Offset<::flatbuffers::String> arTrackName) {
    fbb_.AddOffset(AirEvent_Abridged::VT_ARTRACKNAME, arTrackName);
  }
  void add_rzct(::flatbuffers::Offset<::flatbuffers::String> rzct) {
    fbb_.AddOffset(AirEvent_Abridged::VT_RZCT, rzct);
  }
  void add_arct(::flatbuffers::Offset<::flatbuffers::String> arct) {
    fbb_.AddOffset(AirEvent_Abridged::VT_ARCT, arct);
  }
  void add_baseAlt(double baseAlt) {
    fbb_.AddElement<double>(AirEvent_Abridged::VT_BASEALT, baseAlt, 0.0);
  }
  void add_priority(::flatbuffers::Offset<::flatbuffers::String> priority) {
    fbb_.AddOffset(AirEvent_Abridged::VT_PRIORITY, priority);
  }
  void add_trackTime(double trackTime) {
    fbb_.AddElement<double>(AirEvent_Abridged::VT_TRACKTIME, trackTime, 0.0);
  }
  void add_statusCode(::flatbuffers::Offset<::flatbuffers::String> statusCode) {
    fbb_.AddOffset(AirEvent_Abridged::VT_STATUSCODE, statusCode);
  }
  void add_rzPoint(::flatbuffers::Offset<::flatbuffers::String> rzPoint) {
    fbb_.AddOffset(AirEvent_Abridged::VT_RZPOINT, rzPoint);
  }
  void add_rzType(::flatbuffers::Offset<::flatbuffers::String> rzType) {
    fbb_.AddOffset(AirEvent_Abridged::VT_RZTYPE, rzType);
  }
  void add_arEventType(::flatbuffers::Offset<::flatbuffers::String> arEventType) {
    fbb_.AddOffset(AirEvent_Abridged::VT_AREVENTTYPE, arEventType);
  }
  void add_numTankers(int32_t numTankers) {
    fbb_.AddElement<int32_t>(AirEvent_Abridged::VT_NUMTANKERS, numTankers, 0);
  }
  void add_revTrack(bool revTrack) {
    fbb_.AddElement<uint8_t>(AirEvent_Abridged::VT_REVTRACK, static_cast<uint8_t>(revTrack), 0);
  }
  void add_shortTrack(bool shortTrack) {
    fbb_.AddElement<uint8_t>(AirEvent_Abridged::VT_SHORTTRACK, static_cast<uint8_t>(shortTrack), 0);
  }
  void add_cancelled(bool cancelled) {
    fbb_.AddElement<uint8_t>(AirEvent_Abridged::VT_CANCELLED, static_cast<uint8_t>(cancelled), 0);
  }
  void add_tankers(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tankers) {
    fbb_.AddOffset(AirEvent_Abridged::VT_TANKERS, tankers);
  }
  void add_receivers(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> receivers) {
    fbb_.AddOffset(AirEvent_Abridged::VT_RECEIVERS, receivers);
  }
  void add_remarks(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> remarks) {
    fbb_.AddOffset(AirEvent_Abridged::VT_REMARKS, remarks);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AirEvent_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AirEvent_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(AirEvent_Abridged::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(AirEvent_Abridged::VT_UPDATEDBY, updatedBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(AirEvent_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AirEvent_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AirEvent_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AirEvent_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(AirEvent_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AirEvent_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit AirEvent_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirEvent_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirEvent_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirEvent_Abridged> CreateAirEvent_Abridged(
    ...
    AirEvent_Abridged_dataMode_Enum dataMode = AirEvent_Abridged_dataMode_Enum_REAL) {
  AirEvent_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirEvent_Abridged> CreateAirEvent_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAirEvent_Abridged(
      _fbb,
      id__,
...
inline const AirEvent_Abridged *GetAirEvent_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<AirEvent_Abridged>(buf);
}

inline const AirEvent_Abridged *GetSizePrefixedAirEvent_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirEvent_Abridged>(buf);
}

inline const char *AirEvent_AbridgedIdentifier() {
  return "AIRE";
}

inline bool AirEvent_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirEvent_AbridgedIdentifier());
}

inline bool SizePrefixedAirEvent_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirEvent_AbridgedIdentifier(), true);
}

inline bool VerifyAirEvent_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirEvent_Abridged>(AirEvent_AbridgedIdentifier());
}

inline bool VerifySizePrefixedAirEvent_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirEvent_Abridged>(AirEvent_AbridgedIdentifier());
}

inline void FinishAirEvent_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirEvent_Abridged> root) {
  fbb.Finish(root, AirEvent_AbridgedIdentifier());
}

inline void FinishSizePrefixedAirEvent_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirEvent_Abridged> root) {
  fbb.FinishSizePrefixed(root, AirEvent_AbridgedIdentifier());
}
