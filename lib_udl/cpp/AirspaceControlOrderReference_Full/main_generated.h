...
struct AirspaceControlOrderReference_Full;
struct AirspaceControlOrderReference_FullBuilder;

/// /// The airspaceControlReferences set provides both USMTF and non-USMTF references for this airspace control order.
struct AirspaceControlOrderReference_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirspaceControlOrderReference_FullBuilder Builder;
...
struct AirspaceControlOrderReference_FullBuilder {
  typedef AirspaceControlOrderReference_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_refSId(::flatbuffers::Offset<::flatbuffers::String> refSId) {
    fbb_.AddOffset(AirspaceControlOrderReference_Full::VT_REFSID, refSId);
  }
  void add_refType(::flatbuffers::Offset<::flatbuffers::String> refType) {
    fbb_.AddOffset(AirspaceControlOrderReference_Full::VT_REFTYPE, refType);
  }
  void add_refOriginator(::flatbuffers::Offset<::flatbuffers::String> refOriginator) {
    fbb_.AddOffset(AirspaceControlOrderReference_Full::VT_REFORIGINATOR, refOriginator);
  }
  void add_refTs(::flatbuffers::Offset<::flatbuffers::String> refTs) {
    fbb_.AddOffset(AirspaceControlOrderReference_Full::VT_REFTS, refTs);
  }
  void add_refSerialNum(::flatbuffers::Offset<::flatbuffers::String> refSerialNum) {
    fbb_.AddOffset(AirspaceControlOrderReference_Full::VT_REFSERIALNUM, refSerialNum);
  }
  void add_refSpecialNotation(::flatbuffers::Offset<::flatbuffers::String> refSpecialNotation) {
    fbb_.AddOffset(AirspaceControlOrderReference_Full::VT_REFSPECIALNOTATION, refSpecialNotation);
  }
  void add_refSICs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> refSICs) {
    fbb_.AddOffset(AirspaceControlOrderReference_Full::VT_REFSICS, refSICs);
  }
  explicit AirspaceControlOrderReference_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirspaceControlOrderReference_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirspaceControlOrderReference_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirspaceControlOrderReference_Full> CreateAirspaceControlOrderReference_Full(
  ...
  AirspaceControlOrderReference_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirspaceControlOrderReference_Full> CreateAirspaceControlOrderReference_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AirspaceControlOrderReference_Full *GetAirspaceControlOrderReference_Full(const void *buf) {
  return ::flatbuffers::GetRoot<AirspaceControlOrderReference_Full>(buf);
}

inline const AirspaceControlOrderReference_Full *GetSizePrefixedAirspaceControlOrderReference_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirspaceControlOrderReference_Full>(buf);
}

inline const char *AirspaceControlOrderReference_FullIdentifier() {
  return "AIRS";
}

inline bool AirspaceControlOrderReference_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirspaceControlOrderReference_FullIdentifier());
}

inline bool SizePrefixedAirspaceControlOrderReference_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirspaceControlOrderReference_FullIdentifier(), true);
}

inline bool VerifyAirspaceControlOrderReference_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirspaceControlOrderReference_Full>(AirspaceControlOrderReference_FullIdentifier());
}

inline bool VerifySizePrefixedAirspaceControlOrderReference_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirspaceControlOrderReference_Full>(AirspaceControlOrderReference_FullIdentifier());
}

inline void FinishAirspaceControlOrderReference_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirspaceControlOrderReference_Full> root) {
  fbb.Finish(root, AirspaceControlOrderReference_FullIdentifier());
}

inline void FinishSizePrefixedAirspaceControlOrderReference_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirspaceControlOrderReference_Full> root) {
  fbb.FinishSizePrefixed(root, AirspaceControlOrderReference_FullIdentifier());
}
