...
struct DataLinkMultiDuty_Ingest;
struct DataLinkMultiDuty_IngestBuilder;
...
struct DataLinkMultiDuty_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef DataLinkMultiDuty_IngestBuilder Builder;
...
struct DataLinkMultiDuty_IngestBuilder {
  typedef DataLinkMultiDuty_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_unitDes(::flatbuffers::Offset<::flatbuffers::String> unitDes) {
    fbb_.AddOffset(DataLinkMultiDuty_Ingest::VT_UNITDES, unitDes);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(DataLinkMultiDuty_Ingest::VT_NAME, name);
  }
  void add_rank(::flatbuffers::Offset<::flatbuffers::String> rank) {
    fbb_.AddOffset(DataLinkMultiDuty_Ingest::VT_RANK, rank);
  }
  void add_duty(::flatbuffers::Offset<::flatbuffers::String> duty) {
    fbb_.AddOffset(DataLinkMultiDuty_Ingest::VT_DUTY, duty);
  }
  void add_dutyTeleFreqNums(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dutyTeleFreqNums) {
    fbb_.AddOffset(DataLinkMultiDuty_Ingest::VT_DUTYTELEFREQNUMS, dutyTeleFreqNums);
  }
  void add_multiDutyVoiceCoord(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> multiDutyVoiceCoord) {
    fbb_.AddOffset(DataLinkMultiDuty_Ingest::VT_MULTIDUTYVOICECOORD, multiDutyVoiceCoord);
  }
  explicit DataLinkMultiDuty_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<DataLinkMultiDuty_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<DataLinkMultiDuty_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<DataLinkMultiDuty_Ingest> CreateDataLinkMultiDuty_Ingest(
  ...
  DataLinkMultiDuty_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<DataLinkMultiDuty_Ingest> CreateDataLinkMultiDuty_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const DataLinkMultiDuty_Ingest *GetDataLinkMultiDuty_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<DataLinkMultiDuty_Ingest>(buf);
}

inline const DataLinkMultiDuty_Ingest *GetSizePrefixedDataLinkMultiDuty_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<DataLinkMultiDuty_Ingest>(buf);
}

inline const char *DataLinkMultiDuty_IngestIdentifier() {
  return "DATA";
}

inline bool DataLinkMultiDuty_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLinkMultiDuty_IngestIdentifier());
}

inline bool SizePrefixedDataLinkMultiDuty_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLinkMultiDuty_IngestIdentifier(), true);
}

inline bool VerifyDataLinkMultiDuty_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<DataLinkMultiDuty_Ingest>(DataLinkMultiDuty_IngestIdentifier());
}

inline bool VerifySizePrefixedDataLinkMultiDuty_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<DataLinkMultiDuty_Ingest>(DataLinkMultiDuty_IngestIdentifier());
}

inline void FinishDataLinkMultiDuty_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLinkMultiDuty_Ingest> root) {
  fbb.Finish(root, DataLinkMultiDuty_IngestIdentifier());
}

inline void FinishSizePrefixedDataLinkMultiDuty_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLinkMultiDuty_Ingest> root) {
  fbb.FinishSizePrefixed(root, DataLinkMultiDuty_IngestIdentifier());
}
