...
struct AttitudeSet_Ingest;
struct AttitudeSet_IngestBuilder;

enum AttitudeSet_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  AttitudeSet_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  AttitudeSet_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  AttitudeSet_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  AttitudeSet_Ingest_dataMode_Enum_EXERCISE = 3,
  AttitudeSet_Ingest_dataMode_Enum_MIN = AttitudeSet_Ingest_dataMode_Enum_REAL,
  AttitudeSet_Ingest_dataMode_Enum_MAX = AttitudeSet_Ingest_dataMode_Enum_EXERCISE
};

inline const AttitudeSet_Ingest_dataMode_Enum (&EnumValuesAttitudeSet_Ingest_dataMode_Enum())[4] {
  static const AttitudeSet_Ingest_dataMode_Enum values[] = {
    AttitudeSet_Ingest_dataMode_Enum_REAL,
    AttitudeSet_Ingest_dataMode_Enum_TEST,
    AttitudeSet_Ingest_dataMode_Enum_SIMULATED,
    AttitudeSet_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAttitudeSet_Ingest_dataMode_Enum() {
...
inline const char *EnumNameAttitudeSet_Ingest_dataMode_Enum(AttitudeSet_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AttitudeSet_Ingest_dataMode_Enum_REAL, AttitudeSet_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAttitudeSet_Ingest_dataMode_Enum()[index];
}
...
struct AttitudeSet_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AttitudeSet_IngestBuilder Builder;
  ...
  AttitudeSet_Ingest_dataMode_Enum dataMode() const {
    return static_cast<AttitudeSet_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AttitudeSet_IngestBuilder {
  typedef AttitudeSet_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(AttitudeSet_Ingest::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_ORIGOBJECTID, origObjectId);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_TYPE, type);
  }
  void add_esId(::flatbuffers::Offset<::flatbuffers::String> esId) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_ESID, esId);
  }
  void add_asRef(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> asRef) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_ASREF, asRef);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_ORIGSENSORID, origSensorId);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_ENDTIME, endTime);
  }
  void add_frame1(::flatbuffers::Offset<::flatbuffers::String> frame1) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_FRAME1, frame1);
  }
  void add_frame2(::flatbuffers::Offset<::flatbuffers::String> frame2) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_FRAME2, frame2);
  }
  void add_numPoints(int32_t numPoints) {
    fbb_.AddElement<int32_t>(AttitudeSet_Ingest::VT_NUMPOINTS, numPoints, 0);
  }
  void add_stepSize(int32_t stepSize) {
    fbb_.AddElement<int32_t>(AttitudeSet_Ingest::VT_STEPSIZE, stepSize, 0);
  }
  void add_precAngleInit(double precAngleInit) {
    fbb_.AddElement<double>(AttitudeSet_Ingest::VT_PRECANGLEINIT, precAngleInit, 0.0);
  }
  void add_spinAngleInit(double spinAngleInit) {
    fbb_.AddElement<double>(AttitudeSet_Ingest::VT_SPINANGLEINIT, spinAngleInit, 0.0);
  }
  void add_eulerRotSeq(::flatbuffers::Offset<::flatbuffers::String> eulerRotSeq) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_EULERROTSEQ, eulerRotSeq);
  }
  void add_attitudeList(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> attitudeList) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_ATTITUDELIST, attitudeList);
  }
  void add_interpolator(::flatbuffers::Offset<::flatbuffers::String> interpolator) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_INTERPOLATOR, interpolator);
  }
  void add_interpolatorDegree(int32_t interpolatorDegree) {
    fbb_.AddElement<int32_t>(AttitudeSet_Ingest::VT_INTERPOLATORDEGREE, interpolatorDegree, 0);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_NOTES, notes);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(AttitudeSet_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AttitudeSet_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AttitudeSet_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  explicit AttitudeSet_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AttitudeSet_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AttitudeSet_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AttitudeSet_Ingest> CreateAttitudeSet_Ingest(
    ...
    AttitudeSet_Ingest_dataMode_Enum dataMode = AttitudeSet_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  AttitudeSet_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AttitudeSet_Ingest> CreateAttitudeSet_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAttitudeSet_Ingest(
      _fbb,
      id__,
...
inline const AttitudeSet_Ingest *GetAttitudeSet_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<AttitudeSet_Ingest>(buf);
}

inline const AttitudeSet_Ingest *GetSizePrefixedAttitudeSet_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AttitudeSet_Ingest>(buf);
}

inline const char *AttitudeSet_IngestIdentifier() {
  return "ATTI";
}

inline bool AttitudeSet_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AttitudeSet_IngestIdentifier());
}

inline bool SizePrefixedAttitudeSet_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AttitudeSet_IngestIdentifier(), true);
}

inline bool VerifyAttitudeSet_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AttitudeSet_Ingest>(AttitudeSet_IngestIdentifier());
}

inline bool VerifySizePrefixedAttitudeSet_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AttitudeSet_Ingest>(AttitudeSet_IngestIdentifier());
}

inline void FinishAttitudeSet_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AttitudeSet_Ingest> root) {
  fbb.Finish(root, AttitudeSet_IngestIdentifier());
}

inline void FinishSizePrefixedAttitudeSet_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AttitudeSet_Ingest> root) {
  fbb.FinishSizePrefixed(root, AttitudeSet_IngestIdentifier());
}
