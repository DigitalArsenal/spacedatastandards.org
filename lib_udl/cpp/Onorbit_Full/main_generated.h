...
enum Onorbit_Full_objectType_Enum : int8_t {
  ...
  Onorbit_Full_objectType_Enum_MIN = Onorbit_Full_objectType_Enum_ROCKET_BODY,
  Onorbit_Full_objectType_Enum_MAX = Onorbit_Full_objectType_Enum_UNKNOWN
};

inline const Onorbit_Full_objectType_Enum (&EnumValuesOnorbit_Full_objectType_Enum())[6] {
  static const Onorbit_Full_objectType_Enum values[] = {
    Onorbit_Full_objectType_Enum_ROCKET_BODY,
    Onorbit_Full_objectType_Enum_DEBRIS,
    Onorbit_Full_objectType_Enum_PAYLOAD,
    Onorbit_Full_objectType_Enum_PLATFORM,
    Onorbit_Full_objectType_Enum_MANNED,
    Onorbit_Full_objectType_Enum_UNKNOWN
  };
  return values;
}

inline const char * const *EnumNamesOnorbit_Full_objectType_Enum() {
...
inline const char *EnumNameOnorbit_Full_objectType_Enum(Onorbit_Full_objectType_Enum e) {
  if (::flatbuffers::IsOutRange(e, Onorbit_Full_objectType_Enum_ROCKET_BODY, Onorbit_Full_objectType_Enum_UNKNOWN)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOnorbit_Full_objectType_Enum()[index];
}

enum Onorbit_Full_category_Enum : int8_t {
  /// No description available.
  ...
  Onorbit_Full_category_Enum_MIN = Onorbit_Full_category_Enum_UNKNOWN,
  Onorbit_Full_category_Enum_MAX = Onorbit_Full_category_Enum_DOCKED
};

inline const Onorbit_Full_category_Enum (&EnumValuesOnorbit_Full_category_Enum())[13] {
  static const Onorbit_Full_category_Enum values[] = {
    Onorbit_Full_category_Enum_UNKNOWN,
    Onorbit_Full_category_Enum_ON_ORBIT,
    Onorbit_Full_category_Enum_DECAYED,
    Onorbit_Full_category_Enum_CATALOGED_WITHOUT_STATE,
    Onorbit_Full_category_Enum_LAUNCH_NOMINAL,
    Onorbit_Full_category_Enum_ANALYST_SATELLITE,
    Onorbit_Full_category_Enum_CISLUNAR,
    Onorbit_Full_category_Enum_LUNAR,
    Onorbit_Full_category_Enum_HYPERBOLIC,
    Onorbit_Full_category_Enum_HELIOCENTRIC,
    Onorbit_Full_category_Enum_INTERPLANETARY,
    Onorbit_Full_category_Enum_LAGRANGIAN,
    Onorbit_Full_category_Enum_DOCKED
  };
  return values;
}

inline const char * const *EnumNamesOnorbit_Full_category_Enum() {
...
inline const char *EnumNameOnorbit_Full_category_Enum(Onorbit_Full_category_Enum e) {
  if (::flatbuffers::IsOutRange(e, Onorbit_Full_category_Enum_UNKNOWN, Onorbit_Full_category_Enum_DOCKED)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOnorbit_Full_category_Enum()[index];
}

enum Onorbit_Full_dataMode_Enum : int8_t {
  ...
  Onorbit_Full_dataMode_Enum_MIN = Onorbit_Full_dataMode_Enum_REAL,
  Onorbit_Full_dataMode_Enum_MAX = Onorbit_Full_dataMode_Enum_EXERCISE
};

inline const Onorbit_Full_dataMode_Enum (&EnumValuesOnorbit_Full_dataMode_Enum())[4] {
  static const Onorbit_Full_dataMode_Enum values[] = {
    Onorbit_Full_dataMode_Enum_REAL,
    Onorbit_Full_dataMode_Enum_TEST,
    Onorbit_Full_dataMode_Enum_SIMULATED,
    Onorbit_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesOnorbit_Full_dataMode_Enum() {
...
inline const char *EnumNameOnorbit_Full_dataMode_Enum(Onorbit_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Onorbit_Full_dataMode_Enum_REAL, Onorbit_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOnorbit_Full_dataMode_Enum()[index];
}

/// /// Model object representing on-orbit objects or satellites in the system.
struct Onorbit_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Onorbit_FullBuilder Builder;
  ...
  Onorbit_Full_objectType_Enum objectType() const {
    return static_cast<Onorbit_Full_objectType_Enum>(GetField<int8_t>(VT_OBJECTTYPE, 0));
  }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 45
  Onorbit_Full_category_Enum category() const {
    return static_cast<Onorbit_Full_category_Enum>(GetField<int8_t>(VT_CATEGORY, 0));
  }
  ...
  Onorbit_Full_dataMode_Enum dataMode() const {
    return static_cast<Onorbit_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
  ...
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *entityCollection() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_ENTITYCOLLECTION);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_ENTITYCOLLECTION) &&
           verifier.VerifyVector(entityCollection()) &&
           verifier.VerifyVectorOfStrings(entityCollection()) &&
           verifier.EndTable();
  }
};

struct Onorbit_FullBuilder {
  typedef Onorbit_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(Onorbit_Full::VT_IDONORBIT, idOnOrbit);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Onorbit_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(Onorbit_Full::VT_SATNO, satNo, 0);
  }
  void add_commonName(::flatbuffers::Offset<::flatbuffers::String> commonName) {
    fbb_.AddOffset(Onorbit_Full::VT_COMMONNAME, commonName);
  }
  void add_constellation(::flatbuffers::Offset<::flatbuffers::String> constellation) {
    fbb_.AddOffset(Onorbit_Full::VT_CONSTELLATION, constellation);
  }
  void add_intlDes(::flatbuffers::Offset<::flatbuffers::String> intlDes) {
    fbb_.AddOffset(Onorbit_Full::VT_INTLDES, intlDes);
  }
  void add_launchDate(::flatbuffers::Offset<::flatbuffers::String> launchDate) {
    fbb_.AddOffset(Onorbit_Full::VT_LAUNCHDATE, launchDate);
  }
  void add_decayDate(::flatbuffers::Offset<::flatbuffers::String> decayDate) {
    fbb_.AddOffset(Onorbit_Full::VT_DECAYDATE, decayDate);
  }
  void add_objectType(Onorbit_Full_objectType_Enum objectType) {
    fbb_.AddElement<int8_t>(Onorbit_Full::VT_OBJECTTYPE, static_cast<int8_t>(objectType), 0);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Onorbit_Full::VT_ORIGIN, origin);
  }
  void add_missionNumber(::flatbuffers::Offset<::flatbuffers::String> missionNumber) {
    fbb_.AddOffset(Onorbit_Full::VT_MISSIONNUMBER, missionNumber);
  }
  void add_category(Onorbit_Full_category_Enum category) {
    fbb_.AddElement<int8_t>(Onorbit_Full::VT_CATEGORY, static_cast<int8_t>(category), 0);
  }
  void add_lifetimeYears(int32_t lifetimeYears) {
    fbb_.AddElement<int32_t>(Onorbit_Full::VT_LIFETIMEYEARS, lifetimeYears, 0);
  }
  void add_altName(::flatbuffers::Offset<::flatbuffers::String> altName) {
    fbb_.AddOffset(Onorbit_Full::VT_ALTNAME, altName);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Onorbit_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Onorbit_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(Onorbit_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(Onorbit_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Onorbit_Full::VT_SOURCE, source);
  }
  void add_dataMode(Onorbit_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Onorbit_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_launchSiteId(::flatbuffers::Offset<::flatbuffers::String> launchSiteId) {
    fbb_.AddOffset(Onorbit_Full::VT_LAUNCHSITEID, launchSiteId);
  }
  void add_antennas(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> antennas) {
    fbb_.AddOffset(Onorbit_Full::VT_ANTENNAS, antennas);
  }
  void add_batteries(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> batteries) {
    fbb_.AddOffset(Onorbit_Full::VT_BATTERIES, batteries);
  }
  void add_solarArrays(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> solarArrays) {
    fbb_.AddOffset(Onorbit_Full::VT_SOLARARRAYS, solarArrays);
  }
  void add_thrusters(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> thrusters) {
    fbb_.AddOffset(Onorbit_Full::VT_THRUSTERS, thrusters);
  }
  void add_onorbitDetails(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> onorbitDetails) {
    fbb_.AddOffset(Onorbit_Full::VT_ONORBITDETAILS, onorbitDetails);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(Onorbit_Full::VT_COUNTRYCODE, countryCode);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Onorbit_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_entityCollection(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> entityCollection) {
    fbb_.AddOffset(Onorbit_Full::VT_ENTITYCOLLECTION, entityCollection);
  }
  explicit Onorbit_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Onorbit_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Onorbit_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Onorbit_Full> CreateOnorbit_Full(
    ...
    Onorbit_Full_objectType_Enum objectType = Onorbit_Full_objectType_Enum_ROCKET_BODY,
    ::flatbuffers::Offset<::flatbuffers::String> origin = 0,
    ::flatbuffers::Offset<::flatbuffers::String> missionNumber = 0,
    Onorbit_Full_category_Enum category = Onorbit_Full_category_Enum_UNKNOWN,
    ...
    Onorbit_Full_dataMode_Enum dataMode = Onorbit_Full_dataMode_Enum_REAL,
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> entityCollection = 0) {
  Onorbit_FullBuilder builder_(_fbb);
  builder_.add_entityCollection(entityCollection);
...
inline ::flatbuffers::Offset<Onorbit_Full> CreateOnorbit_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ...
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *entityCollection = nullptr) {
  ...
  auto entityCollection__ = entityCollection ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*entityCollection) : 0;
...
inline const Onorbit_Full *GetOnorbit_Full(const void *buf) {
  return ::flatbuffers::GetRoot<Onorbit_Full>(buf);
}

inline const Onorbit_Full *GetSizePrefixedOnorbit_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Onorbit_Full>(buf);
}

inline const char *Onorbit_FullIdentifier() {
  return "ONOR";
}

inline bool Onorbit_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Onorbit_FullIdentifier());
}

inline bool SizePrefixedOnorbit_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Onorbit_FullIdentifier(), true);
}

inline bool VerifyOnorbit_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Onorbit_Full>(Onorbit_FullIdentifier());
}

inline bool VerifySizePrefixedOnorbit_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Onorbit_Full>(Onorbit_FullIdentifier());
}

inline void FinishOnorbit_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Onorbit_Full> root) {
  fbb.Finish(root, Onorbit_FullIdentifier());
}

inline void FinishSizePrefixedOnorbit_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Onorbit_Full> root) {
  fbb.FinishSizePrefixed(root, Onorbit_FullIdentifier());
}
