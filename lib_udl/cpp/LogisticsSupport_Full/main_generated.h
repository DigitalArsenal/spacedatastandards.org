...
struct LogisticsSupport_Full;
struct LogisticsSupport_FullBuilder;

enum LogisticsSupport_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  LogisticsSupport_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  LogisticsSupport_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  LogisticsSupport_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  LogisticsSupport_Full_dataMode_Enum_EXERCISE = 3,
  LogisticsSupport_Full_dataMode_Enum_MIN = LogisticsSupport_Full_dataMode_Enum_REAL,
  LogisticsSupport_Full_dataMode_Enum_MAX = LogisticsSupport_Full_dataMode_Enum_EXERCISE
};

inline const LogisticsSupport_Full_dataMode_Enum (&EnumValuesLogisticsSupport_Full_dataMode_Enum())[4] {
  static const LogisticsSupport_Full_dataMode_Enum values[] = {
    LogisticsSupport_Full_dataMode_Enum_REAL,
    LogisticsSupport_Full_dataMode_Enum_TEST,
    LogisticsSupport_Full_dataMode_Enum_SIMULATED,
    LogisticsSupport_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesLogisticsSupport_Full_dataMode_Enum() {
...
inline const char *EnumNameLogisticsSupport_Full_dataMode_Enum(LogisticsSupport_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, LogisticsSupport_Full_dataMode_Enum_REAL, LogisticsSupport_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesLogisticsSupport_Full_dataMode_Enum()[index];
}
...
struct LogisticsSupport_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LogisticsSupport_FullBuilder Builder;
  ...
  LogisticsSupport_Full_dataMode_Enum dataMode() const {
    return static_cast<LogisticsSupport_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct LogisticsSupport_FullBuilder {
  typedef LogisticsSupport_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_extSystemId(::flatbuffers::Offset<::flatbuffers::String> extSystemId) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_EXTSYSTEMID, extSystemId);
  }
  void add_tailNumber(::flatbuffers::Offset<::flatbuffers::String> tailNumber) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_TAILNUMBER, tailNumber);
  }
  void add_aircraftMDS(::flatbuffers::Offset<::flatbuffers::String> aircraftMDS) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_AIRCRAFTMDS, aircraftMDS);
  }
  void add_currICAO(::flatbuffers::Offset<::flatbuffers::String> currICAO) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_CURRICAO, currICAO);
  }
  void add_suppICAO(::flatbuffers::Offset<::flatbuffers::String> suppICAO) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_SUPPICAO, suppICAO);
  }
  void add_rptCreatedTime(::flatbuffers::Offset<::flatbuffers::String> rptCreatedTime) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_RPTCREATEDTIME, rptCreatedTime);
  }
  void add_rptClosedTime(::flatbuffers::Offset<::flatbuffers::String> rptClosedTime) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_RPTCLOSEDTIME, rptClosedTime);
  }
  void add_meTime(::flatbuffers::Offset<::flatbuffers::String> meTime) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_METIME, meTime);
  }
  void add_mcTime(::flatbuffers::Offset<::flatbuffers::String> mcTime) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_MCTIME, mcTime);
  }
  void add_logisticAction(::flatbuffers::Offset<::flatbuffers::String> logisticAction) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_LOGISTICACTION, logisticAction);
  }
  void add_logisticsRecordId(::flatbuffers::Offset<::flatbuffers::String> logisticsRecordId) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_LOGISTICSRECORDID, logisticsRecordId);
  }
  void add_etic(::flatbuffers::Offset<::flatbuffers::String> etic) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_ETIC, etic);
  }
  void add_etmc(::flatbuffers::Offset<::flatbuffers::String> etmc) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_ETMC, etmc);
  }
  void add_maintStatusCode(::flatbuffers::Offset<::flatbuffers::String> maintStatusCode) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_MAINTSTATUSCODE, maintStatusCode);
  }
  void add_reopenFlag(bool reopenFlag) {
    fbb_.AddElement<uint8_t>(LogisticsSupport_Full::VT_REOPENFLAG, static_cast<uint8_t>(reopenFlag), 0);
  }
  void add_owner(::flatbuffers::Offset<::flatbuffers::String> owner) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_OWNER, owner);
  }
  void add_logisticsRemarks(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsRemarks) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_LOGISTICSREMARKS, logisticsRemarks);
  }
  void add_logisticsDiscrepancyInfos(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsDiscrepancyInfos) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_LOGISTICSDISCREPANCYINFOS, logisticsDiscrepancyInfos);
  }
  void add_logisticsTransportationPlans(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsTransportationPlans) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_LOGISTICSTRANSPORTATIONPLANS, logisticsTransportationPlans);
  }
  void add_logisticsSupportItems(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsSupportItems) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_LOGISTICSSUPPORTITEMS, logisticsSupportItems);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(LogisticsSupport_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(LogisticsSupport_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(LogisticsSupport_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit LogisticsSupport_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LogisticsSupport_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LogisticsSupport_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LogisticsSupport_Full> CreateLogisticsSupport_Full(
    ...
    LogisticsSupport_Full_dataMode_Enum dataMode = LogisticsSupport_Full_dataMode_Enum_REAL) {
  LogisticsSupport_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<LogisticsSupport_Full> CreateLogisticsSupport_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateLogisticsSupport_Full(
      _fbb,
      id__,
...
inline const LogisticsSupport_Full *GetLogisticsSupport_Full(const void *buf) {
  return ::flatbuffers::GetRoot<LogisticsSupport_Full>(buf);
}

inline const LogisticsSupport_Full *GetSizePrefixedLogisticsSupport_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<LogisticsSupport_Full>(buf);
}

inline const char *LogisticsSupport_FullIdentifier() {
  return "LOGI";
}

inline bool LogisticsSupport_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsSupport_FullIdentifier());
}

inline bool SizePrefixedLogisticsSupport_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsSupport_FullIdentifier(), true);
}

inline bool VerifyLogisticsSupport_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<LogisticsSupport_Full>(LogisticsSupport_FullIdentifier());
}

inline bool VerifySizePrefixedLogisticsSupport_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<LogisticsSupport_Full>(LogisticsSupport_FullIdentifier());
}

inline void FinishLogisticsSupport_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsSupport_Full> root) {
  fbb.Finish(root, LogisticsSupport_FullIdentifier());
}

inline void FinishSizePrefixedLogisticsSupport_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsSupport_Full> root) {
  fbb.FinishSizePrefixed(root, LogisticsSupport_FullIdentifier());
}
