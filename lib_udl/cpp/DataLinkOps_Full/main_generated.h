...
struct DataLinkOps_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef DataLinkOps_FullBuilder Builder;
...
struct DataLinkOps_FullBuilder {
  typedef DataLinkOps_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_linkName(::flatbuffers::Offset<::flatbuffers::String> linkName) {
    fbb_.AddOffset(DataLinkOps_Full::VT_LINKNAME, linkName);
  }
  void add_linkStartTime(::flatbuffers::Offset<::flatbuffers::String> linkStartTime) {
    fbb_.AddOffset(DataLinkOps_Full::VT_LINKSTARTTIME, linkStartTime);
  }
  void add_linkStopTime(::flatbuffers::Offset<::flatbuffers::String> linkStopTime) {
    fbb_.AddOffset(DataLinkOps_Full::VT_LINKSTOPTIME, linkStopTime);
  }
  void add_linkStopTimeMod(::flatbuffers::Offset<::flatbuffers::String> linkStopTimeMod) {
    fbb_.AddOffset(DataLinkOps_Full::VT_LINKSTOPTIMEMOD, linkStopTimeMod);
  }
  void add_linkDetails(::flatbuffers::Offset<::flatbuffers::String> linkDetails) {
    fbb_.AddOffset(DataLinkOps_Full::VT_LINKDETAILS, linkDetails);
  }
  explicit DataLinkOps_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<DataLinkOps_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<DataLinkOps_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<DataLinkOps_Full> CreateDataLinkOps_Full(
  ...
  DataLinkOps_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<DataLinkOps_Full> CreateDataLinkOps_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const DataLinkOps_Full *GetDataLinkOps_Full(const void *buf) {
  return ::flatbuffers::GetRoot<DataLinkOps_Full>(buf);
}

inline const DataLinkOps_Full *GetSizePrefixedDataLinkOps_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<DataLinkOps_Full>(buf);
}

inline const char *DataLinkOps_FullIdentifier() {
  return "DATA";
}

inline bool DataLinkOps_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLinkOps_FullIdentifier());
}

inline bool SizePrefixedDataLinkOps_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLinkOps_FullIdentifier(), true);
}

inline bool VerifyDataLinkOps_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<DataLinkOps_Full>(DataLinkOps_FullIdentifier());
}

inline bool VerifySizePrefixedDataLinkOps_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<DataLinkOps_Full>(DataLinkOps_FullIdentifier());
}

inline void FinishDataLinkOps_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLinkOps_Full> root) {
  fbb.Finish(root, DataLinkOps_FullIdentifier());
}

inline void FinishSizePrefixedDataLinkOps_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLinkOps_Full> root) {
  fbb.FinishSizePrefixed(root, DataLinkOps_FullIdentifier());
}
