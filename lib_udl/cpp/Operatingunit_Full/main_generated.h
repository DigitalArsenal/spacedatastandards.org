...
struct Operatingunit_Full;
struct Operatingunit_FullBuilder;

enum Operatingunit_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Operatingunit_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Operatingunit_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Operatingunit_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Operatingunit_Full_dataMode_Enum_EXERCISE = 3,
  Operatingunit_Full_dataMode_Enum_MIN = Operatingunit_Full_dataMode_Enum_REAL,
  Operatingunit_Full_dataMode_Enum_MAX = Operatingunit_Full_dataMode_Enum_EXERCISE
};

inline const Operatingunit_Full_dataMode_Enum (&EnumValuesOperatingunit_Full_dataMode_Enum())[4] {
  static const Operatingunit_Full_dataMode_Enum values[] = {
    Operatingunit_Full_dataMode_Enum_REAL,
    Operatingunit_Full_dataMode_Enum_TEST,
    Operatingunit_Full_dataMode_Enum_SIMULATED,
    Operatingunit_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesOperatingunit_Full_dataMode_Enum() {
...
inline const char *EnumNameOperatingunit_Full_dataMode_Enum(Operatingunit_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Operatingunit_Full_dataMode_Enum_REAL, Operatingunit_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOperatingunit_Full_dataMode_Enum()[index];
}
...
struct Operatingunit_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Operatingunit_FullBuilder Builder;
  ...
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *operatingUnitRemarks() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_OPERATINGUNITREMARKS);
  }
  ...
  Operatingunit_Full_dataMode_Enum dataMode() const {
    return static_cast<Operatingunit_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_OPERATINGUNITREMARKS) &&
           verifier.VerifyVector(operatingUnitRemarks()) &&
           verifier.VerifyVectorOfStrings(operatingUnitRemarks()) &&
...
struct Operatingunit_FullBuilder {
  typedef Operatingunit_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_idOperatingUnit(::flatbuffers::Offset<::flatbuffers::String> idOperatingUnit) {
    fbb_.AddOffset(Operatingunit_Full::VT_IDOPERATINGUNIT, idOperatingUnit);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Operatingunit_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_altOperatingUnitId(::flatbuffers::Offset<::flatbuffers::String> altOperatingUnitId) {
    fbb_.AddOffset(Operatingunit_Full::VT_ALTOPERATINGUNITID, altOperatingUnitId);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(Operatingunit_Full::VT_NAME, name);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(Operatingunit_Full::VT_DESCRIPTION, description);
  }
  void add_idLocation(::flatbuffers::Offset<::flatbuffers::String> idLocation) {
    fbb_.AddOffset(Operatingunit_Full::VT_IDLOCATION, idLocation);
  }
  void add_idContact(::flatbuffers::Offset<::flatbuffers::String> idContact) {
    fbb_.AddOffset(Operatingunit_Full::VT_IDCONTACT, idContact);
  }
  void add_idOrganization(::flatbuffers::Offset<::flatbuffers::String> idOrganization) {
    fbb_.AddOffset(Operatingunit_Full::VT_IDORGANIZATION, idOrganization);
  }
  void add_unitIdentifier(::flatbuffers::Offset<::flatbuffers::String> unitIdentifier) {
    fbb_.AddOffset(Operatingunit_Full::VT_UNITIDENTIFIER, unitIdentifier);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(Operatingunit_Full::VT_COUNTRYCODE, countryCode);
  }
  void add_altCountryCode(::flatbuffers::Offset<::flatbuffers::String> altCountryCode) {
    fbb_.AddOffset(Operatingunit_Full::VT_ALTCOUNTRYCODE, altCountryCode);
  }
  void add_wac(::flatbuffers::Offset<::flatbuffers::String> wac) {
    fbb_.AddOffset(Operatingunit_Full::VT_WAC, wac);
  }
  void add_operStatus(::flatbuffers::Offset<::flatbuffers::String> operStatus) {
    fbb_.AddOffset(Operatingunit_Full::VT_OPERSTATUS, operStatus);
  }
  void add_condition(::flatbuffers::Offset<::flatbuffers::String> condition) {
    fbb_.AddOffset(Operatingunit_Full::VT_CONDITION, condition);
  }
  void add_conditionAvail(::flatbuffers::Offset<::flatbuffers::String> conditionAvail) {
    fbb_.AddOffset(Operatingunit_Full::VT_CONDITIONAVAIL, conditionAvail);
  }
  void add_eval(int32_t eval) {
    fbb_.AddElement<int32_t>(Operatingunit_Full::VT_EVAL, eval, 0);
  }
  void add_fpa(::flatbuffers::Offset<::flatbuffers::String> fpa) {
    fbb_.AddOffset(Operatingunit_Full::VT_FPA, fpa);
  }
  void add_ident(::flatbuffers::Offset<::flatbuffers::String> ident) {
    fbb_.AddOffset(Operatingunit_Full::VT_IDENT, ident);
  }
  void add_allegiance(::flatbuffers::Offset<::flatbuffers::String> allegiance) {
    fbb_.AddOffset(Operatingunit_Full::VT_ALLEGIANCE, allegiance);
  }
  void add_altAllegiance(::flatbuffers::Offset<::flatbuffers::String> altAllegiance) {
    fbb_.AddOffset(Operatingunit_Full::VT_ALTALLEGIANCE, altAllegiance);
  }
  void add_locName(::flatbuffers::Offset<::flatbuffers::String> locName) {
    fbb_.AddOffset(Operatingunit_Full::VT_LOCNAME, locName);
  }
  void add_locReason(::flatbuffers::Offset<::flatbuffers::String> locReason) {
    fbb_.AddOffset(Operatingunit_Full::VT_LOCREASON, locReason);
  }
  void add_force(::flatbuffers::Offset<::flatbuffers::String> force) {
    fbb_.AddOffset(Operatingunit_Full::VT_FORCE, force);
  }
  void add_forceName(::flatbuffers::Offset<::flatbuffers::String> forceName) {
    fbb_.AddOffset(Operatingunit_Full::VT_FORCENAME, forceName);
  }
  void add_functRole(::flatbuffers::Offset<::flatbuffers::String> functRole) {
    fbb_.AddOffset(Operatingunit_Full::VT_FUNCTROLE, functRole);
  }
  void add_msnPrimary(::flatbuffers::Offset<::flatbuffers::String> msnPrimary) {
    fbb_.AddOffset(Operatingunit_Full::VT_MSNPRIMARY, msnPrimary);
  }
  void add_msnPrimarySpecialty(::flatbuffers::Offset<::flatbuffers::String> msnPrimarySpecialty) {
    fbb_.AddOffset(Operatingunit_Full::VT_MSNPRIMARYSPECIALTY, msnPrimarySpecialty);
  }
  void add_masterUnit(bool masterUnit) {
    fbb_.AddElement<uint8_t>(Operatingunit_Full::VT_MASTERUNIT, static_cast<uint8_t>(masterUnit), 0);
  }
  void add_stylizedUnit(bool stylizedUnit) {
    fbb_.AddElement<uint8_t>(Operatingunit_Full::VT_STYLIZEDUNIT, static_cast<uint8_t>(stylizedUnit), 0);
  }
  void add_divCat(::flatbuffers::Offset<::flatbuffers::String> divCat) {
    fbb_.AddOffset(Operatingunit_Full::VT_DIVCAT, divCat);
  }
  void add_echelon(::flatbuffers::Offset<::flatbuffers::String> echelon) {
    fbb_.AddOffset(Operatingunit_Full::VT_ECHELON, echelon);
  }
  void add_echelonTier(::flatbuffers::Offset<::flatbuffers::String> echelonTier) {
    fbb_.AddOffset(Operatingunit_Full::VT_ECHELONTIER, echelonTier);
  }
  void add_fleetId(::flatbuffers::Offset<::flatbuffers::String> fleetId) {
    fbb_.AddOffset(Operatingunit_Full::VT_FLEETID, fleetId);
  }
  void add_deployStatus(::flatbuffers::Offset<::flatbuffers::String> deployStatus) {
    fbb_.AddOffset(Operatingunit_Full::VT_DEPLOYSTATUS, deployStatus);
  }
  void add_flagFlown(::flatbuffers::Offset<::flatbuffers::String> flagFlown) {
    fbb_.AddOffset(Operatingunit_Full::VT_FLAGFLOWN, flagFlown);
  }
  void add_coordDatum(::flatbuffers::Offset<::flatbuffers::String> coordDatum) {
    fbb_.AddOffset(Operatingunit_Full::VT_COORDDATUM, coordDatum);
  }
  void add_coord(::flatbuffers::Offset<::flatbuffers::String> coord) {
    fbb_.AddOffset(Operatingunit_Full::VT_COORD, coord);
  }
  void add_coordDerivAcc(double coordDerivAcc) {
    fbb_.AddElement<double>(Operatingunit_Full::VT_COORDDERIVACC, coordDerivAcc, 0.0);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(Operatingunit_Full::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(Operatingunit_Full::VT_LON, lon, 0.0);
  }
  void add_elevMsl(double elevMsl) {
    fbb_.AddElement<double>(Operatingunit_Full::VT_ELEVMSL, elevMsl, 0.0);
  }
  void add_elevMslConfLvl(int32_t elevMslConfLvl) {
    fbb_.AddElement<int32_t>(Operatingunit_Full::VT_ELEVMSLCONFLVL, elevMslConfLvl, 0);
  }
  void add_elevMslDerivAcc(double elevMslDerivAcc) {
    fbb_.AddElement<double>(Operatingunit_Full::VT_ELEVMSLDERIVACC, elevMslDerivAcc, 0.0);
  }
  void add_geoidalMslSep(double geoidalMslSep) {
    fbb_.AddElement<double>(Operatingunit_Full::VT_GEOIDALMSLSEP, geoidalMslSep, 0.0);
  }
  void add_milGridSys(::flatbuffers::Offset<::flatbuffers::String> milGridSys) {
    fbb_.AddOffset(Operatingunit_Full::VT_MILGRIDSYS, milGridSys);
  }
  void add_milGrid(::flatbuffers::Offset<::flatbuffers::String> milGrid) {
    fbb_.AddOffset(Operatingunit_Full::VT_MILGRID, milGrid);
  }
  void add_utm(::flatbuffers::Offset<::flatbuffers::String> utm) {
    fbb_.AddOffset(Operatingunit_Full::VT_UTM, utm);
  }
  void add_airDefArea(::flatbuffers::Offset<::flatbuffers::String> airDefArea) {
    fbb_.AddOffset(Operatingunit_Full::VT_AIRDEFAREA, airDefArea);
  }
  void add_polSubdiv(::flatbuffers::Offset<::flatbuffers::String> polSubdiv) {
    fbb_.AddOffset(Operatingunit_Full::VT_POLSUBDIV, polSubdiv);
  }
  void add_symCode(::flatbuffers::Offset<::flatbuffers::String> symCode) {
    fbb_.AddOffset(Operatingunit_Full::VT_SYMCODE, symCode);
  }
  void add_classRating(::flatbuffers::Offset<::flatbuffers::String> classRating) {
    fbb_.AddOffset(Operatingunit_Full::VT_CLASSRATING, classRating);
  }
  void add_recStatus(::flatbuffers::Offset<::flatbuffers::String> recStatus) {
    fbb_.AddOffset(Operatingunit_Full::VT_RECSTATUS, recStatus);
  }
  void add_reviewDate(::flatbuffers::Offset<::flatbuffers::String> reviewDate) {
    fbb_.AddOffset(Operatingunit_Full::VT_REVIEWDATE, reviewDate);
  }
  void add_resProd(::flatbuffers::Offset<::flatbuffers::String> resProd) {
    fbb_.AddOffset(Operatingunit_Full::VT_RESPROD, resProd);
  }
  void add_referenceDoc(::flatbuffers::Offset<::flatbuffers::String> referenceDoc) {
    fbb_.AddOffset(Operatingunit_Full::VT_REFERENCEDOC, referenceDoc);
  }
  void add_operatingUnitRemarks(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> operatingUnitRemarks) {
    fbb_.AddOffset(Operatingunit_Full::VT_OPERATINGUNITREMARKS, operatingUnitRemarks);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Operatingunit_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Operatingunit_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(Operatingunit_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(Operatingunit_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Operatingunit_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Operatingunit_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(Operatingunit_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Operatingunit_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_organization(::flatbuffers::Offset<::flatbuffers::String> organization) {
    fbb_.AddOffset(Operatingunit_Full::VT_ORGANIZATION, organization);
  }
  void add_location(::flatbuffers::Offset<::flatbuffers::String> location) {
    fbb_.AddOffset(Operatingunit_Full::VT_LOCATION, location);
  }
  explicit Operatingunit_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Operatingunit_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Operatingunit_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Operatingunit_Full> CreateOperatingunit_Full(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> operatingUnitRemarks = 0,
    ...
    Operatingunit_Full_dataMode_Enum dataMode = Operatingunit_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> organization = 0,
    ::flatbuffers::Offset<::flatbuffers::String> location = 0) {
  Operatingunit_FullBuilder builder_(_fbb);
  ...
  builder_.add_operatingUnitRemarks(operatingUnitRemarks);
...
inline ::flatbuffers::Offset<Operatingunit_Full> CreateOperatingunit_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ...
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *operatingUnitRemarks = nullptr,
  ...
  auto operatingUnitRemarks__ = operatingUnitRemarks ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*operatingUnitRemarks) : 0;
  ...
  return CreateOperatingunit_Full(
      _fbb,
      idOperatingUnit__,
...
inline const Operatingunit_Full *GetOperatingunit_Full(const void *buf) {
  return ::flatbuffers::GetRoot<Operatingunit_Full>(buf);
}

inline const Operatingunit_Full *GetSizePrefixedOperatingunit_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Operatingunit_Full>(buf);
}

inline const char *Operatingunit_FullIdentifier() {
  return "OPER";
}

inline bool Operatingunit_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Operatingunit_FullIdentifier());
}

inline bool SizePrefixedOperatingunit_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Operatingunit_FullIdentifier(), true);
}

inline bool VerifyOperatingunit_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Operatingunit_Full>(Operatingunit_FullIdentifier());
}

inline bool VerifySizePrefixedOperatingunit_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Operatingunit_Full>(Operatingunit_FullIdentifier());
}

inline void FinishOperatingunit_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Operatingunit_Full> root) {
  fbb.Finish(root, Operatingunit_FullIdentifier());
}

inline void FinishSizePrefixedOperatingunit_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Operatingunit_Full> root) {
  fbb.FinishSizePrefixed(root, Operatingunit_FullIdentifier());
}
