...
struct MtiMission_Ingest;
struct MtiMission_IngestBuilder;

/// /// Information on the mission and flight plans, the type and configuration of the platform, and the reference time.
struct MtiMission_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef MtiMission_IngestBuilder Builder;
...
struct MtiMission_IngestBuilder {
  typedef MtiMission_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_m1(::flatbuffers::Offset<::flatbuffers::String> m1) {
    fbb_.AddOffset(MtiMission_Ingest::VT_M1, m1);
  }
  void add_m2(::flatbuffers::Offset<::flatbuffers::String> m2) {
    fbb_.AddOffset(MtiMission_Ingest::VT_M2, m2);
  }
  void add_m3(::flatbuffers::Offset<::flatbuffers::String> m3) {
    fbb_.AddOffset(MtiMission_Ingest::VT_M3, m3);
  }
  void add_m4(::flatbuffers::Offset<::flatbuffers::String> m4) {
    fbb_.AddOffset(MtiMission_Ingest::VT_M4, m4);
  }
  void add_msnRefTs(::flatbuffers::Offset<::flatbuffers::String> msnRefTs) {
    fbb_.AddOffset(MtiMission_Ingest::VT_MSNREFTS, msnRefTs);
  }
  explicit MtiMission_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<MtiMission_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<MtiMission_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<MtiMission_Ingest> CreateMtiMission_Ingest(
  ...
  MtiMission_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<MtiMission_Ingest> CreateMtiMission_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const MtiMission_Ingest *GetMtiMission_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<MtiMission_Ingest>(buf);
}

inline const MtiMission_Ingest *GetSizePrefixedMtiMission_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<MtiMission_Ingest>(buf);
}

inline const char *MtiMission_IngestIdentifier() {
  return "MTIM";
}

inline bool MtiMission_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MtiMission_IngestIdentifier());
}

inline bool SizePrefixedMtiMission_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MtiMission_IngestIdentifier(), true);
}

inline bool VerifyMtiMission_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<MtiMission_Ingest>(MtiMission_IngestIdentifier());
}

inline bool VerifySizePrefixedMtiMission_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<MtiMission_Ingest>(MtiMission_IngestIdentifier());
}

inline void FinishMtiMission_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MtiMission_Ingest> root) {
  fbb.Finish(root, MtiMission_IngestIdentifier());
}

inline void FinishSizePrefixedMtiMission_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MtiMission_Ingest> root) {
  fbb.FinishSizePrefixed(root, MtiMission_IngestIdentifier());
}
