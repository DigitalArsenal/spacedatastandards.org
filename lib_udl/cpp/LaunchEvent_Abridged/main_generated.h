...
struct LaunchEvent_Abridged;
struct LaunchEvent_AbridgedBuilder;

enum LaunchEvent_Abridged_dataMode_Enum : int8_t {
  ...
  LaunchEvent_Abridged_dataMode_Enum_MIN = LaunchEvent_Abridged_dataMode_Enum_REAL,
  LaunchEvent_Abridged_dataMode_Enum_MAX = LaunchEvent_Abridged_dataMode_Enum_EXERCISE
};

inline const LaunchEvent_Abridged_dataMode_Enum (&EnumValuesLaunchEvent_Abridged_dataMode_Enum())[4] {
  static const LaunchEvent_Abridged_dataMode_Enum values[] = {
    LaunchEvent_Abridged_dataMode_Enum_REAL,
    LaunchEvent_Abridged_dataMode_Enum_TEST,
    LaunchEvent_Abridged_dataMode_Enum_SIMULATED,
    LaunchEvent_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesLaunchEvent_Abridged_dataMode_Enum() {
...
inline const char *EnumNameLaunchEvent_Abridged_dataMode_Enum(LaunchEvent_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, LaunchEvent_Abridged_dataMode_Enum_REAL, LaunchEvent_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesLaunchEvent_Abridged_dataMode_Enum()[index];
}

/// /// Information on known launch events.
struct LaunchEvent_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LaunchEvent_AbridgedBuilder Builder;
  ...
  LaunchEvent_Abridged_dataMode_Enum dataMode() const {
    return static_cast<LaunchEvent_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct LaunchEvent_AbridgedBuilder {
  typedef LaunchEvent_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_ID, id);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_IDONORBIT, idOnOrbit);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_ORIGOBJECTID, origObjectId);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_derivedFrom(::flatbuffers::Offset<::flatbuffers::String> derivedFrom) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_DERIVEDFROM, derivedFrom);
  }
  void add_declassificationDate(::flatbuffers::Offset<::flatbuffers::String> declassificationDate) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_DECLASSIFICATIONDATE, declassificationDate);
  }
  void add_declassificationString(::flatbuffers::Offset<::flatbuffers::String> declassificationString) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_DECLASSIFICATIONSTRING, declassificationString);
  }
  void add_msgCreateDate(::flatbuffers::Offset<::flatbuffers::String> msgCreateDate) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_MSGCREATEDATE, msgCreateDate);
  }
  void add_launchFailureCode(::flatbuffers::Offset<::flatbuffers::String> launchFailureCode) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_LAUNCHFAILURECODE, launchFailureCode);
  }
  void add_launchDate(::flatbuffers::Offset<::flatbuffers::String> launchDate) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_LAUNCHDATE, launchDate);
  }
  void add_beNumber(::flatbuffers::Offset<::flatbuffers::String> beNumber) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_BENUMBER, beNumber);
  }
  void add_oSuffix(::flatbuffers::Offset<::flatbuffers::String> oSuffix) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_OSUFFIX, oSuffix);
  }
  void add_launchFacilityName(::flatbuffers::Offset<::flatbuffers::String> launchFacilityName) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_LAUNCHFACILITYNAME, launchFacilityName);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_ORIGIN, origin);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_SOURCE, source);
  }
  void add_dataMode(LaunchEvent_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(LaunchEvent_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(LaunchEvent_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(LaunchEvent_Abridged::VT_SATNO, satNo, 0);
  }
  explicit LaunchEvent_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LaunchEvent_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LaunchEvent_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LaunchEvent_Abridged> CreateLaunchEvent_Abridged(
    ...
    LaunchEvent_Abridged_dataMode_Enum dataMode = LaunchEvent_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0,
    int32_t satNo = 0) {
  LaunchEvent_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<LaunchEvent_Abridged> CreateLaunchEvent_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateLaunchEvent_Abridged(
      _fbb,
      id__,
      idOnOrbit__,
      origObjectId__,
...
inline const LaunchEvent_Abridged *GetLaunchEvent_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<LaunchEvent_Abridged>(buf);
}

inline const LaunchEvent_Abridged *GetSizePrefixedLaunchEvent_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<LaunchEvent_Abridged>(buf);
}

inline const char *LaunchEvent_AbridgedIdentifier() {
  return "LAUN";
}

inline bool LaunchEvent_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LaunchEvent_AbridgedIdentifier());
}

inline bool SizePrefixedLaunchEvent_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LaunchEvent_AbridgedIdentifier(), true);
}

inline bool VerifyLaunchEvent_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<LaunchEvent_Abridged>(LaunchEvent_AbridgedIdentifier());
}

inline bool VerifySizePrefixedLaunchEvent_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<LaunchEvent_Abridged>(LaunchEvent_AbridgedIdentifier());
}

inline void FinishLaunchEvent_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LaunchEvent_Abridged> root) {
  fbb.Finish(root, LaunchEvent_AbridgedIdentifier());
}

inline void FinishSizePrefixedLaunchEvent_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LaunchEvent_Abridged> root) {
  fbb.FinishSizePrefixed(root, LaunchEvent_AbridgedIdentifier());
}
