...
struct IonoObservationCharAtts_Abridged;
struct IonoObservationCharAtts_AbridgedBuilder;

/// /// Characteristic attributes of a IonoObservation.
struct IonoObservationCharAtts_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef IonoObservationCharAtts_AbridgedBuilder Builder;
...
struct IonoObservationCharAtts_AbridgedBuilder {
  typedef IonoObservationCharAtts_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_ursiID(::flatbuffers::Offset<::flatbuffers::String> ursiID) {
    fbb_.AddOffset(IonoObservationCharAtts_Abridged::VT_URSIID, ursiID);
  }
  void add_charName(::flatbuffers::Offset<::flatbuffers::String> charName) {
    fbb_.AddOffset(IonoObservationCharAtts_Abridged::VT_CHARNAME, charName);
  }
  void add_lowerBound(double lowerBound) {
    fbb_.AddElement<double>(IonoObservationCharAtts_Abridged::VT_LOWERBOUND, lowerBound, 0.0);
  }
  void add_upperBound(double upperBound) {
    fbb_.AddElement<double>(IonoObservationCharAtts_Abridged::VT_UPPERBOUND, upperBound, 0.0);
  }
  void add_q(::flatbuffers::Offset<::flatbuffers::String> q) {
    fbb_.AddOffset(IonoObservationCharAtts_Abridged::VT_Q, q);
  }
  void add_d(::flatbuffers::Offset<::flatbuffers::String> d) {
    fbb_.AddOffset(IonoObservationCharAtts_Abridged::VT_D, d);
  }
  void add_climateModelName(::flatbuffers::Offset<::flatbuffers::String> climateModelName) {
    fbb_.AddOffset(IonoObservationCharAtts_Abridged::VT_CLIMATEMODELNAME, climateModelName);
  }
  void add_climateModelOptions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> climateModelOptions) {
    fbb_.AddOffset(IonoObservationCharAtts_Abridged::VT_CLIMATEMODELOPTIONS, climateModelOptions);
  }
  void add_climateModelInputParams(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> climateModelInputParams) {
    fbb_.AddOffset(IonoObservationCharAtts_Abridged::VT_CLIMATEMODELINPUTPARAMS, climateModelInputParams);
  }
  void add_uncertaintyBoundType(::flatbuffers::Offset<::flatbuffers::String> uncertaintyBoundType) {
    fbb_.AddOffset(IonoObservationCharAtts_Abridged::VT_UNCERTAINTYBOUNDTYPE, uncertaintyBoundType);
  }
  explicit IonoObservationCharAtts_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<IonoObservationCharAtts_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<IonoObservationCharAtts_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<IonoObservationCharAtts_Abridged> CreateIonoObservationCharAtts_Abridged(
  ...
  IonoObservationCharAtts_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<IonoObservationCharAtts_Abridged> CreateIonoObservationCharAtts_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateIonoObservationCharAtts_Abridged(
      _fbb,
      ursiID__,
      charName__,
      lowerBound,
...
inline const IonoObservationCharAtts_Abridged *GetIonoObservationCharAtts_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<IonoObservationCharAtts_Abridged>(buf);
}

inline const IonoObservationCharAtts_Abridged *GetSizePrefixedIonoObservationCharAtts_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<IonoObservationCharAtts_Abridged>(buf);
}

inline const char *IonoObservationCharAtts_AbridgedIdentifier() {
  return "IONO";
}

inline bool IonoObservationCharAtts_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationCharAtts_AbridgedIdentifier());
}

inline bool SizePrefixedIonoObservationCharAtts_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationCharAtts_AbridgedIdentifier(), true);
}

inline bool VerifyIonoObservationCharAtts_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<IonoObservationCharAtts_Abridged>(IonoObservationCharAtts_AbridgedIdentifier());
}

inline bool VerifySizePrefixedIonoObservationCharAtts_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<IonoObservationCharAtts_Abridged>(IonoObservationCharAtts_AbridgedIdentifier());
}

inline void FinishIonoObservationCharAtts_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationCharAtts_Abridged> root) {
  fbb.Finish(root, IonoObservationCharAtts_AbridgedIdentifier());
}

inline void FinishSizePrefixedIonoObservationCharAtts_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationCharAtts_Abridged> root) {
  fbb.FinishSizePrefixed(root, IonoObservationCharAtts_AbridgedIdentifier());
}
