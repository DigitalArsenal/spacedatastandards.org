...
struct SOICalibration_Full;
struct SOICalibration_FullBuilder;

/// /// Schema for SOI Calibration data.
struct SOICalibration_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SOICalibration_FullBuilder Builder;
...
struct SOICalibration_FullBuilder {
  typedef SOICalibration_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_calExtinctionCoeff(double calExtinctionCoeff) {
    fbb_.AddElement<double>(SOICalibration_Full::VT_CALEXTINCTIONCOEFF, calExtinctionCoeff, 0.0);
  }
  void add_calSkyBg(double calSkyBg) {
    fbb_.AddElement<double>(SOICalibration_Full::VT_CALSKYBG, calSkyBg, 0.0);
  }
  void add_calBgIntensity(double calBgIntensity) {
    fbb_.AddElement<double>(SOICalibration_Full::VT_CALBGINTENSITY, calBgIntensity, 0.0);
  }
  void add_calSpectralFilterSolarMag(double calSpectralFilterSolarMag) {
    fbb_.AddElement<double>(SOICalibration_Full::VT_CALSPECTRALFILTERSOLARMAG, calSpectralFilterSolarMag, 0.0);
  }
  void add_calZeroPoint(double calZeroPoint) {
    fbb_.AddElement<double>(SOICalibration_Full::VT_CALZEROPOINT, calZeroPoint, 0.0);
  }
  void add_calNumDetectedStars(int32_t calNumDetectedStars) {
    fbb_.AddElement<int32_t>(SOICalibration_Full::VT_CALNUMDETECTEDSTARS, calNumDetectedStars, 0);
  }
  void add_calNumCorrelatedStars(int32_t calNumCorrelatedStars) {
    fbb_.AddElement<int32_t>(SOICalibration_Full::VT_CALNUMCORRELATEDSTARS, calNumCorrelatedStars, 0);
  }
  void add_calExtinctionCoeffUnc(double calExtinctionCoeffUnc) {
    fbb_.AddElement<double>(SOICalibration_Full::VT_CALEXTINCTIONCOEFFUNC, calExtinctionCoeffUnc, 0.0);
  }
  void add_calExtinctionCoeffMaxUnc(double calExtinctionCoeffMaxUnc) {
    fbb_.AddElement<double>(SOICalibration_Full::VT_CALEXTINCTIONCOEFFMAXUNC, calExtinctionCoeffMaxUnc, 0.0);
  }
  void add_calTime(::flatbuffers::Offset<::flatbuffers::String> calTime) {
    fbb_.AddOffset(SOICalibration_Full::VT_CALTIME, calTime);
  }
  void add_calType(::flatbuffers::Offset<::flatbuffers::String> calType) {
    fbb_.AddOffset(SOICalibration_Full::VT_CALTYPE, calType);
  }
  explicit SOICalibration_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SOICalibration_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SOICalibration_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SOICalibration_Full> CreateSOICalibration_Full(
  ...
  SOICalibration_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SOICalibration_Full> CreateSOICalibration_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    double calExtinctionCoeff = 0.0,
    double calSkyBg = 0.0,
    double calBgIntensity = 0.0,
...
inline const SOICalibration_Full *GetSOICalibration_Full(const void *buf) {
  return ::flatbuffers::GetRoot<SOICalibration_Full>(buf);
}

inline const SOICalibration_Full *GetSizePrefixedSOICalibration_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SOICalibration_Full>(buf);
}

inline const char *SOICalibration_FullIdentifier() {
  return "SOIC";
}

inline bool SOICalibration_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SOICalibration_FullIdentifier());
}

inline bool SizePrefixedSOICalibration_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SOICalibration_FullIdentifier(), true);
}

inline bool VerifySOICalibration_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SOICalibration_Full>(SOICalibration_FullIdentifier());
}

inline bool VerifySizePrefixedSOICalibration_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SOICalibration_Full>(SOICalibration_FullIdentifier());
}

inline void FinishSOICalibration_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SOICalibration_Full> root) {
  fbb.Finish(root, SOICalibration_FullIdentifier());
}

inline void FinishSizePrefixedSOICalibration_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SOICalibration_Full> root) {
  fbb.FinishSizePrefixed(root, SOICalibration_FullIdentifier());
}
