...
struct LogisticsSegments_Ingest;
struct LogisticsSegments_IngestBuilder;

/// /// Remarks associated with this LogisticsSupport record.
struct LogisticsSegments_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LogisticsSegments_IngestBuilder Builder;
...
struct LogisticsSegments_IngestBuilder {
  typedef LogisticsSegments_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_segmentNumber(int32_t segmentNumber) {
    fbb_.AddElement<int32_t>(LogisticsSegments_Ingest::VT_SEGMENTNUMBER, segmentNumber, 0);
  }
  void add_modeCode(::flatbuffers::Offset<::flatbuffers::String> modeCode) {
    fbb_.AddOffset(LogisticsSegments_Ingest::VT_MODECODE, modeCode);
  }
  void add_missionType(::flatbuffers::Offset<::flatbuffers::String> missionType) {
    fbb_.AddOffset(LogisticsSegments_Ingest::VT_MISSIONTYPE, missionType);
  }
  void add_idMission(::flatbuffers::Offset<::flatbuffers::String> idMission) {
    fbb_.AddOffset(LogisticsSegments_Ingest::VT_IDMISSION, idMission);
  }
  void add_extMissionId(::flatbuffers::Offset<::flatbuffers::String> extMissionId) {
    fbb_.AddOffset(LogisticsSegments_Ingest::VT_EXTMISSIONID, extMissionId);
  }
  void add_missionNumber(::flatbuffers::Offset<::flatbuffers::String> missionNumber) {
    fbb_.AddOffset(LogisticsSegments_Ingest::VT_MISSIONNUMBER, missionNumber);
  }
  void add_itin(int32_t itin) {
    fbb_.AddElement<int32_t>(LogisticsSegments_Ingest::VT_ITIN, itin, 0);
  }
  void add_segTailNumber(::flatbuffers::Offset<::flatbuffers::String> segTailNumber) {
    fbb_.AddOffset(LogisticsSegments_Ingest::VT_SEGTAILNUMBER, segTailNumber);
  }
  void add_segAircraftMDS(::flatbuffers::Offset<::flatbuffers::String> segAircraftMDS) {
    fbb_.AddOffset(LogisticsSegments_Ingest::VT_SEGAIRCRAFTMDS, segAircraftMDS);
  }
  void add_departureICAO(::flatbuffers::Offset<::flatbuffers::String> departureICAO) {
    fbb_.AddOffset(LogisticsSegments_Ingest::VT_DEPARTUREICAO, departureICAO);
  }
  void add_segActDepTime(::flatbuffers::Offset<::flatbuffers::String> segActDepTime) {
    fbb_.AddOffset(LogisticsSegments_Ingest::VT_SEGACTDEPTIME, segActDepTime);
  }
  void add_arrivalICAO(::flatbuffers::Offset<::flatbuffers::String> arrivalICAO) {
    fbb_.AddOffset(LogisticsSegments_Ingest::VT_ARRIVALICAO, arrivalICAO);
  }
  void add_segActArrTime(::flatbuffers::Offset<::flatbuffers::String> segActArrTime) {
    fbb_.AddOffset(LogisticsSegments_Ingest::VT_SEGACTARRTIME, segActArrTime);
  }
  void add_segEstDepTime(::flatbuffers::Offset<::flatbuffers::String> segEstDepTime) {
    fbb_.AddOffset(LogisticsSegments_Ingest::VT_SEGESTDEPTIME, segEstDepTime);
  }
  void add_segEstArrTime(::flatbuffers::Offset<::flatbuffers::String> segEstArrTime) {
    fbb_.AddOffset(LogisticsSegments_Ingest::VT_SEGESTARRTIME, segEstArrTime);
  }
  explicit LogisticsSegments_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LogisticsSegments_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LogisticsSegments_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LogisticsSegments_Ingest> CreateLogisticsSegments_Ingest(
  ...
  LogisticsSegments_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<LogisticsSegments_Ingest> CreateLogisticsSegments_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    int32_t segmentNumber = 0,
  ...
  return CreateLogisticsSegments_Ingest(
      _fbb,
      segmentNumber,
      modeCode__,
      missionType__,
...
inline const LogisticsSegments_Ingest *GetLogisticsSegments_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<LogisticsSegments_Ingest>(buf);
}

inline const LogisticsSegments_Ingest *GetSizePrefixedLogisticsSegments_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<LogisticsSegments_Ingest>(buf);
}

inline const char *LogisticsSegments_IngestIdentifier() {
  return "LOGI";
}

inline bool LogisticsSegments_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsSegments_IngestIdentifier());
}

inline bool SizePrefixedLogisticsSegments_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsSegments_IngestIdentifier(), true);
}

inline bool VerifyLogisticsSegments_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<LogisticsSegments_Ingest>(LogisticsSegments_IngestIdentifier());
}

inline bool VerifySizePrefixedLogisticsSegments_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<LogisticsSegments_Ingest>(LogisticsSegments_IngestIdentifier());
}

inline void FinishLogisticsSegments_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsSegments_Ingest> root) {
  fbb.Finish(root, LogisticsSegments_IngestIdentifier());
}

inline void FinishSizePrefixedLogisticsSegments_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsSegments_Ingest> root) {
  fbb.FinishSizePrefixed(root, LogisticsSegments_IngestIdentifier());
}
