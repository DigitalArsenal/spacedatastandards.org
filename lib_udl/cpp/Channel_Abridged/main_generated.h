...
struct Channel_Abridged;
struct Channel_AbridgedBuilder;

enum Channel_Abridged_dataMode_Enum : int8_t {
  ...
  Channel_Abridged_dataMode_Enum_MIN = Channel_Abridged_dataMode_Enum_REAL,
  Channel_Abridged_dataMode_Enum_MAX = Channel_Abridged_dataMode_Enum_EXERCISE
};

inline const Channel_Abridged_dataMode_Enum (&EnumValuesChannel_Abridged_dataMode_Enum())[4] {
  static const Channel_Abridged_dataMode_Enum values[] = {
    Channel_Abridged_dataMode_Enum_REAL,
    Channel_Abridged_dataMode_Enum_TEST,
    Channel_Abridged_dataMode_Enum_SIMULATED,
    Channel_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesChannel_Abridged_dataMode_Enum() {
...
inline const char *EnumNameChannel_Abridged_dataMode_Enum(Channel_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Channel_Abridged_dataMode_Enum_REAL, Channel_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesChannel_Abridged_dataMode_Enum()[index];
}

/// /// Channel information on a particular transponder.
struct Channel_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Channel_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Channel_Abridged_dataMode_Enum dataMode() const {
    return static_cast<Channel_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Channel_AbridgedBuilder {
  typedef Channel_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Channel_Abridged::VT_ID, id);
  }
  void add_idTransponder(::flatbuffers::Offset<::flatbuffers::String> idTransponder) {
    fbb_.AddOffset(Channel_Abridged::VT_IDTRANSPONDER, idTransponder);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(Channel_Abridged::VT_NAME, name);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Channel_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(Channel_Abridged::VT_TYPE, type);
  }
  void add_idBeam(::flatbuffers::Offset<::flatbuffers::String> idBeam) {
    fbb_.AddOffset(Channel_Abridged::VT_IDBEAM, idBeam);
  }
  void add_beamName(::flatbuffers::Offset<::flatbuffers::String> beamName) {
    fbb_.AddOffset(Channel_Abridged::VT_BEAMNAME, beamName);
  }
  void add_idRFBand(::flatbuffers::Offset<::flatbuffers::String> idRFBand) {
    fbb_.AddOffset(Channel_Abridged::VT_IDRFBAND, idRFBand);
  }
  void add_encryption(::flatbuffers::Offset<::flatbuffers::String> encryption) {
    fbb_.AddOffset(Channel_Abridged::VT_ENCRYPTION, encryption);
  }
  void add_pkg(::flatbuffers::Offset<::flatbuffers::String> pkg) {
    fbb_.AddOffset(Channel_Abridged::VT_PKG, pkg);
  }
  void add_res(::flatbuffers::Offset<::flatbuffers::String> res) {
    fbb_.AddOffset(Channel_Abridged::VT_RES, res);
  }
  void add_compression(::flatbuffers::Offset<::flatbuffers::String> compression) {
    fbb_.AddOffset(Channel_Abridged::VT_COMPRESSION, compression);
  }
  void add_vpid(::flatbuffers::Offset<::flatbuffers::String> vpid) {
    fbb_.AddOffset(Channel_Abridged::VT_VPID, vpid);
  }
  void add_apid(::flatbuffers::Offset<::flatbuffers::String> apid) {
    fbb_.AddOffset(Channel_Abridged::VT_APID, apid);
  }
  void add_sid(::flatbuffers::Offset<::flatbuffers::String> sid) {
    fbb_.AddOffset(Channel_Abridged::VT_SID, sid);
  }
  void add_owner(::flatbuffers::Offset<::flatbuffers::String> owner) {
    fbb_.AddOffset(Channel_Abridged::VT_OWNER, owner);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Channel_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Channel_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Channel_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(Channel_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Channel_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Channel_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Channel_Abridged::VT_CREATEDBY, createdBy);
  }
  explicit Channel_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Channel_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Channel_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Channel_Abridged> CreateChannel_Abridged(
    ...
    Channel_Abridged_dataMode_Enum dataMode = Channel_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0) {
  Channel_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Channel_Abridged> CreateChannel_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Channel_Abridged *GetChannel_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<Channel_Abridged>(buf);
}

inline const Channel_Abridged *GetSizePrefixedChannel_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Channel_Abridged>(buf);
}

inline const char *Channel_AbridgedIdentifier() {
  return "CHAN";
}

inline bool Channel_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Channel_AbridgedIdentifier());
}

inline bool SizePrefixedChannel_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Channel_AbridgedIdentifier(), true);
}

inline bool VerifyChannel_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Channel_Abridged>(Channel_AbridgedIdentifier());
}

inline bool VerifySizePrefixedChannel_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Channel_Abridged>(Channel_AbridgedIdentifier());
}

inline void FinishChannel_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Channel_Abridged> root) {
  fbb.Finish(root, Channel_AbridgedIdentifier());
}

inline void FinishSizePrefixedChannel_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Channel_Abridged> root) {
  fbb.FinishSizePrefixed(root, Channel_AbridgedIdentifier());
}
