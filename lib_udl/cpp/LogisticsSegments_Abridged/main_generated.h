...
struct LogisticsSegments_Abridged;
struct LogisticsSegments_AbridgedBuilder;

/// /// Remarks associated with this LogisticsSupport record.
struct LogisticsSegments_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LogisticsSegments_AbridgedBuilder Builder;
...
struct LogisticsSegments_AbridgedBuilder {
  typedef LogisticsSegments_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_segmentNumber(int32_t segmentNumber) {
    fbb_.AddElement<int32_t>(LogisticsSegments_Abridged::VT_SEGMENTNUMBER, segmentNumber, 0);
  }
  void add_modeCode(::flatbuffers::Offset<::flatbuffers::String> modeCode) {
    fbb_.AddOffset(LogisticsSegments_Abridged::VT_MODECODE, modeCode);
  }
  void add_missionType(::flatbuffers::Offset<::flatbuffers::String> missionType) {
    fbb_.AddOffset(LogisticsSegments_Abridged::VT_MISSIONTYPE, missionType);
  }
  void add_idMission(::flatbuffers::Offset<::flatbuffers::String> idMission) {
    fbb_.AddOffset(LogisticsSegments_Abridged::VT_IDMISSION, idMission);
  }
  void add_extMissionId(::flatbuffers::Offset<::flatbuffers::String> extMissionId) {
    fbb_.AddOffset(LogisticsSegments_Abridged::VT_EXTMISSIONID, extMissionId);
  }
  void add_missionNumber(::flatbuffers::Offset<::flatbuffers::String> missionNumber) {
    fbb_.AddOffset(LogisticsSegments_Abridged::VT_MISSIONNUMBER, missionNumber);
  }
  void add_itin(int32_t itin) {
    fbb_.AddElement<int32_t>(LogisticsSegments_Abridged::VT_ITIN, itin, 0);
  }
  void add_segTailNumber(::flatbuffers::Offset<::flatbuffers::String> segTailNumber) {
    fbb_.AddOffset(LogisticsSegments_Abridged::VT_SEGTAILNUMBER, segTailNumber);
  }
  void add_segAircraftMDS(::flatbuffers::Offset<::flatbuffers::String> segAircraftMDS) {
    fbb_.AddOffset(LogisticsSegments_Abridged::VT_SEGAIRCRAFTMDS, segAircraftMDS);
  }
  void add_departureICAO(::flatbuffers::Offset<::flatbuffers::String> departureICAO) {
    fbb_.AddOffset(LogisticsSegments_Abridged::VT_DEPARTUREICAO, departureICAO);
  }
  void add_segActDepTime(::flatbuffers::Offset<::flatbuffers::String> segActDepTime) {
    fbb_.AddOffset(LogisticsSegments_Abridged::VT_SEGACTDEPTIME, segActDepTime);
  }
  void add_arrivalICAO(::flatbuffers::Offset<::flatbuffers::String> arrivalICAO) {
    fbb_.AddOffset(LogisticsSegments_Abridged::VT_ARRIVALICAO, arrivalICAO);
  }
  void add_segActArrTime(::flatbuffers::Offset<::flatbuffers::String> segActArrTime) {
    fbb_.AddOffset(LogisticsSegments_Abridged::VT_SEGACTARRTIME, segActArrTime);
  }
  void add_segEstDepTime(::flatbuffers::Offset<::flatbuffers::String> segEstDepTime) {
    fbb_.AddOffset(LogisticsSegments_Abridged::VT_SEGESTDEPTIME, segEstDepTime);
  }
  void add_segEstArrTime(::flatbuffers::Offset<::flatbuffers::String> segEstArrTime) {
    fbb_.AddOffset(LogisticsSegments_Abridged::VT_SEGESTARRTIME, segEstArrTime);
  }
  explicit LogisticsSegments_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LogisticsSegments_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LogisticsSegments_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LogisticsSegments_Abridged> CreateLogisticsSegments_Abridged(
  ...
  LogisticsSegments_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<LogisticsSegments_Abridged> CreateLogisticsSegments_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    int32_t segmentNumber = 0,
...
inline const LogisticsSegments_Abridged *GetLogisticsSegments_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<LogisticsSegments_Abridged>(buf);
}

inline const LogisticsSegments_Abridged *GetSizePrefixedLogisticsSegments_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<LogisticsSegments_Abridged>(buf);
}

inline const char *LogisticsSegments_AbridgedIdentifier() {
  return "LOGI";
}

inline bool LogisticsSegments_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsSegments_AbridgedIdentifier());
}

inline bool SizePrefixedLogisticsSegments_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsSegments_AbridgedIdentifier(), true);
}

inline bool VerifyLogisticsSegments_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<LogisticsSegments_Abridged>(LogisticsSegments_AbridgedIdentifier());
}

inline bool VerifySizePrefixedLogisticsSegments_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<LogisticsSegments_Abridged>(LogisticsSegments_AbridgedIdentifier());
}

inline void FinishLogisticsSegments_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsSegments_Abridged> root) {
  fbb.Finish(root, LogisticsSegments_AbridgedIdentifier());
}

inline void FinishSizePrefixedLogisticsSegments_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsSegments_Abridged> root) {
  fbb.FinishSizePrefixed(root, LogisticsSegments_AbridgedIdentifier());
}
