...
struct Vessel_Full;
struct Vessel_FullBuilder;

enum Vessel_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Vessel_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Vessel_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Vessel_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Vessel_Full_dataMode_Enum_EXERCISE = 3,
  Vessel_Full_dataMode_Enum_MIN = Vessel_Full_dataMode_Enum_REAL,
  Vessel_Full_dataMode_Enum_MAX = Vessel_Full_dataMode_Enum_EXERCISE
};

inline const Vessel_Full_dataMode_Enum (&EnumValuesVessel_Full_dataMode_Enum())[4] {
  static const Vessel_Full_dataMode_Enum values[] = {
    Vessel_Full_dataMode_Enum_REAL,
    Vessel_Full_dataMode_Enum_TEST,
    Vessel_Full_dataMode_Enum_SIMULATED,
    Vessel_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesVessel_Full_dataMode_Enum() {
...
inline const char *EnumNameVessel_Full_dataMode_Enum(Vessel_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Vessel_Full_dataMode_Enum_REAL, Vessel_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesVessel_Full_dataMode_Enum()[index];
}
...
struct Vessel_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Vessel_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 64
  Vessel_Full_dataMode_Enum dataMode() const {
    return static_cast<Vessel_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Vessel_FullBuilder {
  typedef Vessel_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Vessel_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Vessel_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_entity(::flatbuffers::Offset<::flatbuffers::String> entity) {
    fbb_.AddOffset(Vessel_Full::VT_ENTITY, entity);
  }
  void add_idEntity(::flatbuffers::Offset<::flatbuffers::String> idEntity) {
    fbb_.AddOffset(Vessel_Full::VT_IDENTITY, idEntity);
  }
  void add_altVesselId(::flatbuffers::Offset<::flatbuffers::String> altVesselId) {
    fbb_.AddOffset(Vessel_Full::VT_ALTVESSELID, altVesselId);
  }
  void add_idOrganization(::flatbuffers::Offset<::flatbuffers::String> idOrganization) {
    fbb_.AddOffset(Vessel_Full::VT_IDORGANIZATION, idOrganization);
  }
  void add_vesselName(::flatbuffers::Offset<::flatbuffers::String> vesselName) {
    fbb_.AddOffset(Vessel_Full::VT_VESSELNAME, vesselName);
  }
  void add_vesselType(::flatbuffers::Offset<::flatbuffers::String> vesselType) {
    fbb_.AddOffset(Vessel_Full::VT_VESSELTYPE, vesselType);
  }
  void add_vesselClass(::flatbuffers::Offset<::flatbuffers::String> vesselClass) {
    fbb_.AddOffset(Vessel_Full::VT_VESSELCLASS, vesselClass);
  }
  void add_vesselDescription(::flatbuffers::Offset<::flatbuffers::String> vesselDescription) {
    fbb_.AddOffset(Vessel_Full::VT_VESSELDESCRIPTION, vesselDescription);
  }
  void add_sconum(::flatbuffers::Offset<::flatbuffers::String> sconum) {
    fbb_.AddOffset(Vessel_Full::VT_SCONUM, sconum);
  }
  void add_imon(int32_t imon) {
    fbb_.AddElement<int32_t>(Vessel_Full::VT_IMON, imon, 0);
  }
  void add_mmsi(::flatbuffers::Offset<::flatbuffers::String> mmsi) {
    fbb_.AddOffset(Vessel_Full::VT_MMSI, mmsi);
  }
  void add_callsign(::flatbuffers::Offset<::flatbuffers::String> callsign) {
    fbb_.AddOffset(Vessel_Full::VT_CALLSIGN, callsign);
  }
  void add_vesselFlag(::flatbuffers::Offset<::flatbuffers::String> vesselFlag) {
    fbb_.AddOffset(Vessel_Full::VT_VESSELFLAG, vesselFlag);
  }
  void add_yearBuilt(::flatbuffers::Offset<::flatbuffers::String> yearBuilt) {
    fbb_.AddOffset(Vessel_Full::VT_YEARBUILT, yearBuilt);
  }
  void add_vesselBuilder(::flatbuffers::Offset<::flatbuffers::String> vesselBuilder) {
    fbb_.AddOffset(Vessel_Full::VT_VESSELBUILDER, vesselBuilder);
  }
  void add_status(::flatbuffers::Offset<::flatbuffers::String> status) {
    fbb_.AddOffset(Vessel_Full::VT_STATUS, status);
  }
  void add_firstSeen(::flatbuffers::Offset<::flatbuffers::String> firstSeen) {
    fbb_.AddOffset(Vessel_Full::VT_FIRSTSEEN, firstSeen);
  }
  void add_length(double length) {
    fbb_.AddElement<double>(Vessel_Full::VT_LENGTH, length, 0.0);
  }
  void add_width(double width) {
    fbb_.AddElement<double>(Vessel_Full::VT_WIDTH, width, 0.0);
  }
  void add_maxDraught(double maxDraught) {
    fbb_.AddElement<double>(Vessel_Full::VT_MAXDRAUGHT, maxDraught, 0.0);
  }
  void add_vslWt(double vslWt) {
    fbb_.AddElement<double>(Vessel_Full::VT_VSLWT, vslWt, 0.0);
  }
  void add_maxSpeed(double maxSpeed) {
    fbb_.AddElement<double>(Vessel_Full::VT_MAXSPEED, maxSpeed, 0.0);
  }
  void add_sternType(::flatbuffers::Offset<::flatbuffers::String> sternType) {
    fbb_.AddOffset(Vessel_Full::VT_STERNTYPE, sternType);
  }
  void add_numBlades(int32_t numBlades) {
    fbb_.AddElement<int32_t>(Vessel_Full::VT_NUMBLADES, numBlades, 0);
  }
  void add_numShafts(int32_t numShafts) {
    fbb_.AddElement<int32_t>(Vessel_Full::VT_NUMSHAFTS, numShafts, 0);
  }
  void add_propType(::flatbuffers::Offset<::flatbuffers::String> propType) {
    fbb_.AddOffset(Vessel_Full::VT_PROPTYPE, propType);
  }
  void add_hullNum(::flatbuffers::Offset<::flatbuffers::String> hullNum) {
    fbb_.AddOffset(Vessel_Full::VT_HULLNUM, hullNum);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Vessel_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Vessel_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(Vessel_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(Vessel_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Vessel_Full::VT_SOURCE, source);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(Vessel_Full::VT_SOURCEDL, sourceDL);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Vessel_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(Vessel_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Vessel_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Vessel_Full::VT_ORIGNETWORK, origNetwork);
  }
  explicit Vessel_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Vessel_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Vessel_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Vessel_Full> CreateVessel_Full(
    ...
    Vessel_Full_dataMode_Enum dataMode = Vessel_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  Vessel_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Vessel_Full> CreateVessel_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Vessel_Full *GetVessel_Full(const void *buf) {
  return ::flatbuffers::GetRoot<Vessel_Full>(buf);
}

inline const Vessel_Full *GetSizePrefixedVessel_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Vessel_Full>(buf);
}

inline const char *Vessel_FullIdentifier() {
  return "VESS";
}

inline bool Vessel_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Vessel_FullIdentifier());
}

inline bool SizePrefixedVessel_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Vessel_FullIdentifier(), true);
}

inline bool VerifyVessel_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Vessel_Full>(Vessel_FullIdentifier());
}

inline bool VerifySizePrefixedVessel_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Vessel_Full>(Vessel_FullIdentifier());
}

inline void FinishVessel_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Vessel_Full> root) {
  fbb.Finish(root, Vessel_FullIdentifier());
}

inline void FinishSizePrefixedVessel_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Vessel_Full> root) {
  fbb.FinishSizePrefixed(root, Vessel_FullIdentifier());
}
