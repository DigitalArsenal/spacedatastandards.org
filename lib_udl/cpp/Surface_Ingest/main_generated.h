...
struct Surface_Ingest;
struct Surface_IngestBuilder;

enum Surface_Ingest_dataMode_Enum : int8_t {
  ...
  Surface_Ingest_dataMode_Enum_MIN = Surface_Ingest_dataMode_Enum_REAL,
  Surface_Ingest_dataMode_Enum_MAX = Surface_Ingest_dataMode_Enum_EXERCISE
};

inline const Surface_Ingest_dataMode_Enum (&EnumValuesSurface_Ingest_dataMode_Enum())[4] {
  static const Surface_Ingest_dataMode_Enum values[] = {
    Surface_Ingest_dataMode_Enum_REAL,
    Surface_Ingest_dataMode_Enum_TEST,
    Surface_Ingest_dataMode_Enum_SIMULATED,
    Surface_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSurface_Ingest_dataMode_Enum() {
...
inline const char *EnumNameSurface_Ingest_dataMode_Enum(Surface_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Surface_Ingest_dataMode_Enum_REAL, Surface_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSurface_Ingest_dataMode_Enum()[index];
}
...
struct Surface_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Surface_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Surface_Ingest_dataMode_Enum dataMode() const {
    return static_cast<Surface_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Surface_IngestBuilder {
  typedef Surface_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Surface_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Surface_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(Surface_Ingest::VT_NAME, name);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(Surface_Ingest::VT_TYPE, type);
  }
  void add_idSite(::flatbuffers::Offset<::flatbuffers::String> idSite) {
    fbb_.AddOffset(Surface_Ingest::VT_IDSITE, idSite);
  }
  void add_altSiteId(::flatbuffers::Offset<::flatbuffers::String> altSiteId) {
    fbb_.AddOffset(Surface_Ingest::VT_ALTSITEID, altSiteId);
  }
  void add_primary(bool primary) {
    fbb_.AddElement<uint8_t>(Surface_Ingest::VT_PRIMARY, static_cast<uint8_t>(primary), 0);
  }
  void add_lengthFt(int32_t lengthFt) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_LENGTHFT, lengthFt, 0);
  }
  void add_ldaFt(int32_t ldaFt) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_LDAFT, ldaFt, 0);
  }
  void add_widthFt(int32_t widthFt) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_WIDTHFT, widthFt, 0);
  }
  void add_lengthM(int32_t lengthM) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_LENGTHM, lengthM, 0);
  }
  void add_ldaM(int32_t ldaM) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_LDAM, ldaM, 0);
  }
  void add_widthM(int32_t widthM) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_WIDTHM, widthM, 0);
  }
  void add_material(::flatbuffers::Offset<::flatbuffers::String> material) {
    fbb_.AddOffset(Surface_Ingest::VT_MATERIAL, material);
  }
  void add_condition(::flatbuffers::Offset<::flatbuffers::String> condition) {
    fbb_.AddOffset(Surface_Ingest::VT_CONDITION, condition);
  }
  void add_rawWBC(::flatbuffers::Offset<::flatbuffers::String> rawWBC) {
    fbb_.AddOffset(Surface_Ingest::VT_RAWWBC, rawWBC);
  }
  void add_pcn(::flatbuffers::Offset<::flatbuffers::String> pcn) {
    fbb_.AddOffset(Surface_Ingest::VT_PCN, pcn);
  }
  void add_lcn(int32_t lcn) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_LCN, lcn, 0);
  }
  void add_sWtKip(int32_t sWtKip) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_SWTKIP, sWtKip, 0);
  }
  void add_tWtKip(int32_t tWtKip) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_TWTKIP, tWtKip, 0);
  }
  void add_stWtKip(int32_t stWtKip) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_STWTKIP, stWtKip, 0);
  }
  void add_ttWtKip(int32_t ttWtKip) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_TTWTKIP, ttWtKip, 0);
  }
  void add_ddWtKip(int32_t ddWtKip) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_DDWTKIP, ddWtKip, 0);
  }
  void add_sbttWtKip(int32_t sbttWtKip) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_SBTTWTKIP, sbttWtKip, 0);
  }
  void add_tdtWtkip(int32_t tdtWtkip) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_TDTWTKIP, tdtWtkip, 0);
  }
  void add_trtWtKip(int32_t trtWtKip) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_TRTWTKIP, trtWtKip, 0);
  }
  void add_ddtWtKip(int32_t ddtWtKip) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_DDTWTKIP, ddtWtKip, 0);
  }
  void add_sWtKN(int32_t sWtKN) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_SWTKN, sWtKN, 0);
  }
  void add_tWtKN(int32_t tWtKN) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_TWTKN, tWtKN, 0);
  }
  void add_stWtKN(int32_t stWtKN) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_STWTKN, stWtKN, 0);
  }
  void add_ttWtKN(int32_t ttWtKN) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_TTWTKN, ttWtKN, 0);
  }
  void add_ddWtKN(int32_t ddWtKN) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_DDWTKN, ddWtKN, 0);
  }
  void add_sbttWtKN(int32_t sbttWtKN) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_SBTTWTKN, sbttWtKN, 0);
  }
  void add_tdtWtKN(int32_t tdtWtKN) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_TDTWTKN, tdtWtKN, 0);
  }
  void add_trtWtKN(int32_t trtWtKN) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_TRTWTKN, trtWtKN, 0);
  }
  void add_ddtWtKN(int32_t ddtWtKN) {
    fbb_.AddElement<int32_t>(Surface_Ingest::VT_DDTWTKN, ddtWtKN, 0);
  }
  void add_lighting(bool lighting) {
    fbb_.AddElement<uint8_t>(Surface_Ingest::VT_LIGHTING, static_cast<uint8_t>(lighting), 0);
  }
  void add_lightsUNKN(bool lightsUNKN) {
    fbb_.AddElement<uint8_t>(Surface_Ingest::VT_LIGHTSUNKN, static_cast<uint8_t>(lightsUNKN), 0);
  }
  void add_lightsAPRCH(bool lightsAPRCH) {
    fbb_.AddElement<uint8_t>(Surface_Ingest::VT_LIGHTSAPRCH, static_cast<uint8_t>(lightsAPRCH), 0);
  }
  void add_lightsVASI(bool lightsVASI) {
    fbb_.AddElement<uint8_t>(Surface_Ingest::VT_LIGHTSVASI, static_cast<uint8_t>(lightsVASI), 0);
  }
  void add_lightsPAPI(bool lightsPAPI) {
    fbb_.AddElement<uint8_t>(Surface_Ingest::VT_LIGHTSPAPI, static_cast<uint8_t>(lightsPAPI), 0);
  }
  void add_lightsOLS(bool lightsOLS) {
    fbb_.AddElement<uint8_t>(Surface_Ingest::VT_LIGHTSOLS, static_cast<uint8_t>(lightsOLS), 0);
  }
  void add_lightsREIL(bool lightsREIL) {
    fbb_.AddElement<uint8_t>(Surface_Ingest::VT_LIGHTSREIL, static_cast<uint8_t>(lightsREIL), 0);
  }
  void add_lightsTDZL(bool lightsTDZL) {
    fbb_.AddElement<uint8_t>(Surface_Ingest::VT_LIGHTSTDZL, static_cast<uint8_t>(lightsTDZL), 0);
  }
  void add_lightsCL(bool lightsCL) {
    fbb_.AddElement<uint8_t>(Surface_Ingest::VT_LIGHTSCL, static_cast<uint8_t>(lightsCL), 0);
  }
  void add_obstacle(bool obstacle) {
    fbb_.AddElement<uint8_t>(Surface_Ingest::VT_OBSTACLE, static_cast<uint8_t>(obstacle), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Surface_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Surface_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Surface_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Surface_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Surface_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(Surface_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Surface_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit Surface_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Surface_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Surface_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Surface_Ingest> CreateSurface_Ingest(
    ...
    Surface_Ingest_dataMode_Enum dataMode = Surface_Ingest_dataMode_Enum_REAL) {
  Surface_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Surface_Ingest> CreateSurface_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Surface_Ingest *GetSurface_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<Surface_Ingest>(buf);
}

inline const Surface_Ingest *GetSizePrefixedSurface_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Surface_Ingest>(buf);
}

inline const char *Surface_IngestIdentifier() {
  return "SURF";
}

inline bool Surface_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Surface_IngestIdentifier());
}

inline bool SizePrefixedSurface_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Surface_IngestIdentifier(), true);
}

inline bool VerifySurface_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Surface_Ingest>(Surface_IngestIdentifier());
}

inline bool VerifySizePrefixedSurface_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Surface_Ingest>(Surface_IngestIdentifier());
}

inline void FinishSurface_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Surface_Ingest> root) {
  fbb.Finish(root, Surface_IngestIdentifier());
}

inline void FinishSizePrefixedSurface_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Surface_Ingest> root) {
  fbb.FinishSizePrefixed(root, Surface_IngestIdentifier());
}
