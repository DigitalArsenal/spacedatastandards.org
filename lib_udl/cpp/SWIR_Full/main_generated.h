...
struct SWIR_Full;
struct SWIR_FullBuilder;

enum SWIR_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  SWIR_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  SWIR_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  SWIR_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  SWIR_Full_dataMode_Enum_EXERCISE = 3,
  SWIR_Full_dataMode_Enum_MIN = SWIR_Full_dataMode_Enum_REAL,
  SWIR_Full_dataMode_Enum_MAX = SWIR_Full_dataMode_Enum_EXERCISE
};

inline const SWIR_Full_dataMode_Enum (&EnumValuesSWIR_Full_dataMode_Enum())[4] {
  static const SWIR_Full_dataMode_Enum values[] = {
    SWIR_Full_dataMode_Enum_REAL,
    SWIR_Full_dataMode_Enum_TEST,
    SWIR_Full_dataMode_Enum_SIMULATED,
    SWIR_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSWIR_Full_dataMode_Enum() {
...
inline const char *EnumNameSWIR_Full_dataMode_Enum(SWIR_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SWIR_Full_dataMode_Enum_REAL, SWIR_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSWIR_Full_dataMode_Enum()[index];
}

/// /// Data representing observed short wave infrared (SWIR) measurements.
struct SWIR_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SWIR_FullBuilder Builder;
  ...
  SWIR_Full_dataMode_Enum dataMode() const {
    return static_cast<SWIR_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SWIR_FullBuilder {
  typedef SWIR_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SWIR_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SWIR_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(SWIR_Full::VT_IDONORBIT, idOnOrbit);
  }
  void add_onOrbit(::flatbuffers::Offset<::flatbuffers::String> onOrbit) {
    fbb_.AddOffset(SWIR_Full::VT_ONORBIT, onOrbit);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::String> ts) {
    fbb_.AddOffset(SWIR_Full::VT_TS, ts);
  }
  void add_solarPhaseAngle(double solarPhaseAngle) {
    fbb_.AddElement<double>(SWIR_Full::VT_SOLARPHASEANGLE, solarPhaseAngle, 0.0);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(SWIR_Full::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(SWIR_Full::VT_LON, lon, 0.0);
  }
  void add_locationName(::flatbuffers::Offset<::flatbuffers::String> locationName) {
    fbb_.AddOffset(SWIR_Full::VT_LOCATIONNAME, locationName);
  }
  void add_badWave(::flatbuffers::Offset<::flatbuffers::String> badWave) {
    fbb_.AddOffset(SWIR_Full::VT_BADWAVE, badWave);
  }
  void add_wavelengths(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> wavelengths) {
    fbb_.AddOffset(SWIR_Full::VT_WAVELENGTHS, wavelengths);
  }
  void add_absFluxes(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> absFluxes) {
    fbb_.AddOffset(SWIR_Full::VT_ABSFLUXES, absFluxes);
  }
  void add_ratioWavelengths(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> ratioWavelengths) {
    fbb_.AddOffset(SWIR_Full::VT_RATIOWAVELENGTHS, ratioWavelengths);
  }
  void add_fluxRatios(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> fluxRatios) {
    fbb_.AddOffset(SWIR_Full::VT_FLUXRATIOS, fluxRatios);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(SWIR_Full::VT_ORIGOBJECTID, origObjectId);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SWIR_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SWIR_Full::VT_ORIGIN, origin);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(SWIR_Full::VT_SATNO, satNo, 0);
  }
  void add_dataMode(SWIR_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SWIR_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SWIR_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SWIR_Full::VT_CREATEDBY, createdBy);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SWIR_Full::VT_ORIGNETWORK, origNetwork);
  }
  explicit SWIR_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SWIR_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SWIR_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SWIR_Full> CreateSWIR_Full(
    ...
    int32_t satNo = 0,
    SWIR_Full_dataMode_Enum dataMode = SWIR_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  SWIR_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SWIR_Full> CreateSWIR_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const SWIR_Full *GetSWIR_Full(const void *buf) {
  return ::flatbuffers::GetRoot<SWIR_Full>(buf);
}

inline const SWIR_Full *GetSizePrefixedSWIR_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SWIR_Full>(buf);
}

inline const char *SWIR_FullIdentifier() {
  return "SWIR";
}

inline bool SWIR_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SWIR_FullIdentifier());
}

inline bool SizePrefixedSWIR_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SWIR_FullIdentifier(), true);
}

inline bool VerifySWIR_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SWIR_Full>(SWIR_FullIdentifier());
}

inline bool VerifySizePrefixedSWIR_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SWIR_Full>(SWIR_FullIdentifier());
}

inline void FinishSWIR_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SWIR_Full> root) {
  fbb.Finish(root, SWIR_FullIdentifier());
}

inline void FinishSizePrefixedSWIR_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SWIR_Full> root) {
  fbb.FinishSizePrefixed(root, SWIR_FullIdentifier());
}
