...
struct DataLink_Ingest;
struct DataLink_IngestBuilder;

enum DataLink_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  DataLink_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  DataLink_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  DataLink_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  DataLink_Ingest_dataMode_Enum_EXERCISE = 3,
  DataLink_Ingest_dataMode_Enum_MIN = DataLink_Ingest_dataMode_Enum_REAL,
  DataLink_Ingest_dataMode_Enum_MAX = DataLink_Ingest_dataMode_Enum_EXERCISE
};

inline const DataLink_Ingest_dataMode_Enum (&EnumValuesDataLink_Ingest_dataMode_Enum())[4] {
  static const DataLink_Ingest_dataMode_Enum values[] = {
    DataLink_Ingest_dataMode_Enum_REAL,
    DataLink_Ingest_dataMode_Enum_TEST,
    DataLink_Ingest_dataMode_Enum_SIMULATED,
    DataLink_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesDataLink_Ingest_dataMode_Enum() {
...
inline const char *EnumNameDataLink_Ingest_dataMode_Enum(DataLink_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, DataLink_Ingest_dataMode_Enum_REAL, DataLink_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesDataLink_Ingest_dataMode_Enum()[index];
}

/// /// Beta Version DataLink: Detailed instructions regarding the operations of data links.
struct DataLink_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef DataLink_IngestBuilder Builder;
  ...
  DataLink_Ingest_dataMode_Enum dataMode() const {
    return static_cast<DataLink_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
inline ::flatbuffers::Offset<DataLink_Ingest> CreateDataLink_Ingest(
    ...
    DataLink_Ingest_dataMode_Enum dataMode = DataLink_Ingest_dataMode_Enum_REAL) {
  DataLink_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<DataLink_Ingest> CreateDataLink_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const DataLink_Ingest *GetDataLink_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<DataLink_Ingest>(buf);
}

inline const DataLink_Ingest *GetSizePrefixedDataLink_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<DataLink_Ingest>(buf);
}

inline const char *DataLink_IngestIdentifier() {
  return "DATA";
}

inline bool DataLink_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLink_IngestIdentifier());
}

inline bool SizePrefixedDataLink_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLink_IngestIdentifier(), true);
}

inline bool VerifyDataLink_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<DataLink_Ingest>(DataLink_IngestIdentifier());
}

inline bool VerifySizePrefixedDataLink_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<DataLink_Ingest>(DataLink_IngestIdentifier());
}

inline void FinishDataLink_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLink_Ingest> root) {
  fbb.Finish(root, DataLink_IngestIdentifier());
}

inline void FinishSizePrefixedDataLink_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLink_Ingest> root) {
  fbb.FinishSizePrefixed(root, DataLink_IngestIdentifier());
}
