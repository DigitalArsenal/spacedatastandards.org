...
struct RadarSOIObservation_Full;
struct RadarSOIObservation_FullBuilder;

/// /// A Radar SOI record contains observation information taken from a sensor about a Space Object.
struct RadarSOIObservation_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef RadarSOIObservation_FullBuilder Builder;
...
inline ::flatbuffers::Offset<RadarSOIObservation_Full> CreateRadarSOIObservation_Full(
  ...
  RadarSOIObservation_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<RadarSOIObservation_Full> CreateRadarSOIObservation_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const RadarSOIObservation_Full *GetRadarSOIObservation_Full(const void *buf) {
  return ::flatbuffers::GetRoot<RadarSOIObservation_Full>(buf);
}

inline const RadarSOIObservation_Full *GetSizePrefixedRadarSOIObservation_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<RadarSOIObservation_Full>(buf);
}

inline const char *RadarSOIObservation_FullIdentifier() {
  return "RADA";
}

inline bool RadarSOIObservation_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RadarSOIObservation_FullIdentifier());
}

inline bool SizePrefixedRadarSOIObservation_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RadarSOIObservation_FullIdentifier(), true);
}

inline bool VerifyRadarSOIObservation_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<RadarSOIObservation_Full>(RadarSOIObservation_FullIdentifier());
}

inline bool VerifySizePrefixedRadarSOIObservation_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<RadarSOIObservation_Full>(RadarSOIObservation_FullIdentifier());
}

inline void FinishRadarSOIObservation_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RadarSOIObservation_Full> root) {
  fbb.Finish(root, RadarSOIObservation_FullIdentifier());
}

inline void FinishSizePrefixedRadarSOIObservation_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RadarSOIObservation_Full> root) {
  fbb.FinishSizePrefixed(root, RadarSOIObservation_FullIdentifier());
}
