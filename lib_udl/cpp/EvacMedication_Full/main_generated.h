...
struct EvacMedication_Full;
struct EvacMedication_FullBuilder;

/// /// Medication specifics.
struct EvacMedication_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EvacMedication_FullBuilder Builder;
...
struct EvacMedication_FullBuilder {
  typedef EvacMedication_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(EvacMedication_Full::VT_TYPE, type);
  }
  void add_bodyPart(::flatbuffers::Offset<::flatbuffers::String> bodyPart) {
    fbb_.AddOffset(EvacMedication_Full::VT_BODYPART, bodyPart);
  }
  void add_dose(::flatbuffers::Offset<::flatbuffers::String> dose) {
    fbb_.AddOffset(EvacMedication_Full::VT_DOSE, dose);
  }
  void add_adminRoute(::flatbuffers::Offset<::flatbuffers::String> adminRoute) {
    fbb_.AddOffset(EvacMedication_Full::VT_ADMINROUTE, adminRoute);
  }
  void add_time(::flatbuffers::Offset<::flatbuffers::String> time) {
    fbb_.AddOffset(EvacMedication_Full::VT_TIME, time);
  }
  void add_comments(::flatbuffers::Offset<::flatbuffers::String> comments) {
    fbb_.AddOffset(EvacMedication_Full::VT_COMMENTS, comments);
  }
  explicit EvacMedication_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<EvacMedication_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<EvacMedication_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<EvacMedication_Full> CreateEvacMedication_Full(
  ...
  EvacMedication_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<EvacMedication_Full> CreateEvacMedication_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const EvacMedication_Full *GetEvacMedication_Full(const void *buf) {
  return ::flatbuffers::GetRoot<EvacMedication_Full>(buf);
}

inline const EvacMedication_Full *GetSizePrefixedEvacMedication_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EvacMedication_Full>(buf);
}

inline const char *EvacMedication_FullIdentifier() {
  return "EVAC";
}

inline bool EvacMedication_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EvacMedication_FullIdentifier());
}

inline bool SizePrefixedEvacMedication_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EvacMedication_FullIdentifier(), true);
}

inline bool VerifyEvacMedication_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EvacMedication_Full>(EvacMedication_FullIdentifier());
}

inline bool VerifySizePrefixedEvacMedication_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EvacMedication_Full>(EvacMedication_FullIdentifier());
}

inline void FinishEvacMedication_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EvacMedication_Full> root) {
  fbb.Finish(root, EvacMedication_FullIdentifier());
}

inline void FinishSizePrefixedEvacMedication_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EvacMedication_Full> root) {
  fbb.FinishSizePrefixed(root, EvacMedication_FullIdentifier());
}
