...
struct AirLoadPlan_Full;
struct AirLoadPlan_FullBuilder;

enum AirLoadPlan_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  AirLoadPlan_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  AirLoadPlan_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  AirLoadPlan_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  AirLoadPlan_Full_dataMode_Enum_EXERCISE = 3,
  AirLoadPlan_Full_dataMode_Enum_MIN = AirLoadPlan_Full_dataMode_Enum_REAL,
  AirLoadPlan_Full_dataMode_Enum_MAX = AirLoadPlan_Full_dataMode_Enum_EXERCISE
};

inline const AirLoadPlan_Full_dataMode_Enum (&EnumValuesAirLoadPlan_Full_dataMode_Enum())[4] {
  static const AirLoadPlan_Full_dataMode_Enum values[] = {
    AirLoadPlan_Full_dataMode_Enum_REAL,
    AirLoadPlan_Full_dataMode_Enum_TEST,
    AirLoadPlan_Full_dataMode_Enum_SIMULATED,
    AirLoadPlan_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAirLoadPlan_Full_dataMode_Enum() {
...
inline const char *EnumNameAirLoadPlan_Full_dataMode_Enum(AirLoadPlan_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AirLoadPlan_Full_dataMode_Enum_REAL, AirLoadPlan_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAirLoadPlan_Full_dataMode_Enum()[index];
}

/// /// Information related to how an aircraft is loaded with cargo, equipment, and passengers.
struct AirLoadPlan_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirLoadPlan_FullBuilder Builder;
  ...
  AirLoadPlan_Full_dataMode_Enum dataMode() const {
    return static_cast<AirLoadPlan_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AirLoadPlan_FullBuilder {
  typedef AirLoadPlan_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_EXTERNALID, externalId);
  }
  void add_idMission(::flatbuffers::Offset<::flatbuffers::String> idMission) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_IDMISSION, idMission);
  }
  void add_missionNumber(::flatbuffers::Offset<::flatbuffers::String> missionNumber) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_MISSIONNUMBER, missionNumber);
  }
  void add_idSortie(::flatbuffers::Offset<::flatbuffers::String> idSortie) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_IDSORTIE, idSortie);
  }
  void add_legNum(int32_t legNum) {
    fbb_.AddElement<int32_t>(AirLoadPlan_Full::VT_LEGNUM, legNum, 0);
  }
  void add_callSign(::flatbuffers::Offset<::flatbuffers::String> callSign) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_CALLSIGN, callSign);
  }
  void add_tailNumber(::flatbuffers::Offset<::flatbuffers::String> tailNumber) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_TAILNUMBER, tailNumber);
  }
  void add_aircraftMDS(::flatbuffers::Offset<::flatbuffers::String> aircraftMDS) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_AIRCRAFTMDS, aircraftMDS);
  }
  void add_depICAO(::flatbuffers::Offset<::flatbuffers::String> depICAO) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_DEPICAO, depICAO);
  }
  void add_depAirfield(::flatbuffers::Offset<::flatbuffers::String> depAirfield) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_DEPAIRFIELD, depAirfield);
  }
  void add_estDepTime(::flatbuffers::Offset<::flatbuffers::String> estDepTime) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_ESTDEPTIME, estDepTime);
  }
  void add_arrICAO(::flatbuffers::Offset<::flatbuffers::String> arrICAO) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_ARRICAO, arrICAO);
  }
  void add_arrAirfield(::flatbuffers::Offset<::flatbuffers::String> arrAirfield) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_ARRAIRFIELD, arrAirfield);
  }
  void add_estArrTime(::flatbuffers::Offset<::flatbuffers::String> estArrTime) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_ESTARRTIME, estArrTime);
  }
  void add_crewSize(int32_t crewSize) {
    fbb_.AddElement<int32_t>(AirLoadPlan_Full::VT_CREWSIZE, crewSize, 0);
  }
  void add_cargoConfig(::flatbuffers::Offset<::flatbuffers::String> cargoConfig) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_CARGOCONFIG, cargoConfig);
  }
  void add_equipConfig(::flatbuffers::Offset<::flatbuffers::String> equipConfig) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_EQUIPCONFIG, equipConfig);
  }
  void add_tankConfig(::flatbuffers::Offset<::flatbuffers::String> tankConfig) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_TANKCONFIG, tankConfig);
  }
  void add_basicWeight(double basicWeight) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_BASICWEIGHT, basicWeight, 0.0);
  }
  void add_basicMoment(double basicMoment) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_BASICMOMENT, basicMoment, 0.0);
  }
  void add_fuelWeight(double fuelWeight) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_FUELWEIGHT, fuelWeight, 0.0);
  }
  void add_fuelMoment(double fuelMoment) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_FUELMOMENT, fuelMoment, 0.0);
  }
  void add_estLandingFuelWeight(double estLandingFuelWeight) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_ESTLANDINGFUELWEIGHT, estLandingFuelWeight, 0.0);
  }
  void add_estLandingFuelMoment(double estLandingFuelMoment) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_ESTLANDINGFUELMOMENT, estLandingFuelMoment, 0.0);
  }
  void add_operatingWeight(double operatingWeight) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_OPERATINGWEIGHT, operatingWeight, 0.0);
  }
  void add_operatingMoment(double operatingMoment) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_OPERATINGMOMENT, operatingMoment, 0.0);
  }
  void add_cargoWeight(double cargoWeight) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_CARGOWEIGHT, cargoWeight, 0.0);
  }
  void add_cargoMoment(double cargoMoment) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_CARGOMOMENT, cargoMoment, 0.0);
  }
  void add_zeroFuelWeight(double zeroFuelWeight) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_ZEROFUELWEIGHT, zeroFuelWeight, 0.0);
  }
  void add_zeroFuelMoment(double zeroFuelMoment) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_ZEROFUELMOMENT, zeroFuelMoment, 0.0);
  }
  void add_zeroFuelCG(double zeroFuelCG) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_ZEROFUELCG, zeroFuelCG, 0.0);
  }
  void add_grossWeight(double grossWeight) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_GROSSWEIGHT, grossWeight, 0.0);
  }
  void add_grossMoment(double grossMoment) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_GROSSMOMENT, grossMoment, 0.0);
  }
  void add_grossCG(double grossCG) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_GROSSCG, grossCG, 0.0);
  }
  void add_landingWeight(double landingWeight) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_LANDINGWEIGHT, landingWeight, 0.0);
  }
  void add_landingMoment(double landingMoment) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_LANDINGMOMENT, landingMoment, 0.0);
  }
  void add_landingCG(double landingCG) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_LANDINGCG, landingCG, 0.0);
  }
  void add_cargoBayFSMin(int32_t cargoBayFSMin) {
    fbb_.AddElement<int32_t>(AirLoadPlan_Full::VT_CARGOBAYFSMIN, cargoBayFSMin, 0);
  }
  void add_cargoBayFSMax(int32_t cargoBayFSMax) {
    fbb_.AddElement<int32_t>(AirLoadPlan_Full::VT_CARGOBAYFSMAX, cargoBayFSMax, 0);
  }
  void add_cargoBayWidth(double cargoBayWidth) {
    fbb_.AddElement<double>(AirLoadPlan_Full::VT_CARGOBAYWIDTH, cargoBayWidth, 0.0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AirLoadPlan_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(AirLoadPlan_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AirLoadPlan_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit AirLoadPlan_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirLoadPlan_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirLoadPlan_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirLoadPlan_Full> CreateAirLoadPlan_Full(
    ...
    AirLoadPlan_Full_dataMode_Enum dataMode = AirLoadPlan_Full_dataMode_Enum_REAL) {
  AirLoadPlan_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirLoadPlan_Full> CreateAirLoadPlan_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AirLoadPlan_Full *GetAirLoadPlan_Full(const void *buf) {
  return ::flatbuffers::GetRoot<AirLoadPlan_Full>(buf);
}

inline const AirLoadPlan_Full *GetSizePrefixedAirLoadPlan_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirLoadPlan_Full>(buf);
}

inline const char *AirLoadPlan_FullIdentifier() {
  return "AIRL";
}

inline bool AirLoadPlan_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirLoadPlan_FullIdentifier());
}

inline bool SizePrefixedAirLoadPlan_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirLoadPlan_FullIdentifier(), true);
}

inline bool VerifyAirLoadPlan_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirLoadPlan_Full>(AirLoadPlan_FullIdentifier());
}

inline bool VerifySizePrefixedAirLoadPlan_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirLoadPlan_Full>(AirLoadPlan_FullIdentifier());
}

inline void FinishAirLoadPlan_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirLoadPlan_Full> root) {
  fbb.Finish(root, AirLoadPlan_FullIdentifier());
}

inline void FinishSizePrefixedAirLoadPlan_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirLoadPlan_Full> root) {
  fbb.FinishSizePrefixed(root, AirLoadPlan_FullIdentifier());
}
