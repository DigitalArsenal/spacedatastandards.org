...
struct CollectResponse_Ingest;
struct CollectResponse_IngestBuilder;

enum CollectResponse_Ingest_dataMode_Enum : int8_t {
  ...
  CollectResponse_Ingest_dataMode_Enum_MIN = CollectResponse_Ingest_dataMode_Enum_REAL,
  CollectResponse_Ingest_dataMode_Enum_MAX = CollectResponse_Ingest_dataMode_Enum_EXERCISE
};

inline const CollectResponse_Ingest_dataMode_Enum (&EnumValuesCollectResponse_Ingest_dataMode_Enum())[4] {
  static const CollectResponse_Ingest_dataMode_Enum values[] = {
    CollectResponse_Ingest_dataMode_Enum_REAL,
    CollectResponse_Ingest_dataMode_Enum_TEST,
    CollectResponse_Ingest_dataMode_Enum_SIMULATED,
    CollectResponse_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesCollectResponse_Ingest_dataMode_Enum() {
...
inline const char *EnumNameCollectResponse_Ingest_dataMode_Enum(CollectResponse_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, CollectResponse_Ingest_dataMode_Enum_REAL, CollectResponse_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesCollectResponse_Ingest_dataMode_Enum()[index];
}
...
struct CollectResponse_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef CollectResponse_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  CollectResponse_Ingest_dataMode_Enum dataMode() const {
    return static_cast<CollectResponse_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct CollectResponse_IngestBuilder {
  typedef CollectResponse_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idRequest(::flatbuffers::Offset<::flatbuffers::String> idRequest) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_IDREQUEST, idRequest);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_ORIGOBJECTID, origObjectId);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(CollectResponse_Ingest::VT_SATNO, satNo, 0);
  }
  void add_taskId(::flatbuffers::Offset<::flatbuffers::String> taskId) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_TASKID, taskId);
  }
  void add_idPlan(::flatbuffers::Offset<::flatbuffers::String> idPlan) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_IDPLAN, idPlan);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_EXTERNALID, externalId);
  }
  void add_status(::flatbuffers::Offset<::flatbuffers::String> status) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_STATUS, status);
  }
  void add_actualStartTime(::flatbuffers::Offset<::flatbuffers::String> actualStartTime) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_ACTUALSTARTTIME, actualStartTime);
  }
  void add_actualEndTime(::flatbuffers::Offset<::flatbuffers::String> actualEndTime) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_ACTUALENDTIME, actualEndTime);
  }
  void add_altStartTime(::flatbuffers::Offset<::flatbuffers::String> altStartTime) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_ALTSTARTTIME, altStartTime);
  }
  void add_altEndTime(::flatbuffers::Offset<::flatbuffers::String> altEndTime) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_ALTENDTIME, altEndTime);
  }
  void add_errCode(::flatbuffers::Offset<::flatbuffers::String> errCode) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_ERRCODE, errCode);
  }
  void add_srcTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcTyps) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_SRCTYPS, srcTyps);
  }
  void add_srcIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcIds) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_SRCIDS, srcIds);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_NOTES, notes);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_ORIGSENSORID, origSensorId);
  }
  void add_dataMode(CollectResponse_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(CollectResponse_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(CollectResponse_Ingest::VT_TAGS, tags);
  }
  explicit CollectResponse_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<CollectResponse_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<CollectResponse_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<CollectResponse_Ingest> CreateCollectResponse_Ingest(
    ...
    CollectResponse_Ingest_dataMode_Enum dataMode = CollectResponse_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags = 0) {
  CollectResponse_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<CollectResponse_Ingest> CreateCollectResponse_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateCollectResponse_Ingest(
      _fbb,
      id__,
...
inline const CollectResponse_Ingest *GetCollectResponse_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<CollectResponse_Ingest>(buf);
}

inline const CollectResponse_Ingest *GetSizePrefixedCollectResponse_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<CollectResponse_Ingest>(buf);
}

inline const char *CollectResponse_IngestIdentifier() {
  return "COLL";
}

inline bool CollectResponse_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, CollectResponse_IngestIdentifier());
}

inline bool SizePrefixedCollectResponse_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, CollectResponse_IngestIdentifier(), true);
}

inline bool VerifyCollectResponse_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<CollectResponse_Ingest>(CollectResponse_IngestIdentifier());
}

inline bool VerifySizePrefixedCollectResponse_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<CollectResponse_Ingest>(CollectResponse_IngestIdentifier());
}

inline void FinishCollectResponse_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<CollectResponse_Ingest> root) {
  fbb.Finish(root, CollectResponse_IngestIdentifier());
}

inline void FinishSizePrefixedCollectResponse_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<CollectResponse_Ingest> root) {
  fbb.FinishSizePrefixed(root, CollectResponse_IngestIdentifier());
}
