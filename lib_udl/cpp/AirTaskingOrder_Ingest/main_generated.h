...
struct AirTaskingOrder_Ingest;
struct AirTaskingOrder_IngestBuilder;

enum AirTaskingOrder_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  AirTaskingOrder_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  AirTaskingOrder_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  AirTaskingOrder_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  AirTaskingOrder_Ingest_dataMode_Enum_EXERCISE = 3,
  AirTaskingOrder_Ingest_dataMode_Enum_MIN = AirTaskingOrder_Ingest_dataMode_Enum_REAL,
  AirTaskingOrder_Ingest_dataMode_Enum_MAX = AirTaskingOrder_Ingest_dataMode_Enum_EXERCISE
};

inline const AirTaskingOrder_Ingest_dataMode_Enum (&EnumValuesAirTaskingOrder_Ingest_dataMode_Enum())[4] {
  static const AirTaskingOrder_Ingest_dataMode_Enum values[] = {
    AirTaskingOrder_Ingest_dataMode_Enum_REAL,
    AirTaskingOrder_Ingest_dataMode_Enum_TEST,
    AirTaskingOrder_Ingest_dataMode_Enum_SIMULATED,
    AirTaskingOrder_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAirTaskingOrder_Ingest_dataMode_Enum() {
...
inline const char *EnumNameAirTaskingOrder_Ingest_dataMode_Enum(AirTaskingOrder_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AirTaskingOrder_Ingest_dataMode_Enum_REAL, AirTaskingOrder_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAirTaskingOrder_Ingest_dataMode_Enum()[index];
}
...
struct AirTaskingOrder_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirTaskingOrder_IngestBuilder Builder;
  ...
  AirTaskingOrder_Ingest_dataMode_Enum dataMode() const {
    return static_cast<AirTaskingOrder_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AirTaskingOrder_IngestBuilder {
  typedef AirTaskingOrder_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_RAWFILEURI, rawFileURI);
  }
  void add_opExerName(::flatbuffers::Offset<::flatbuffers::String> opExerName) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_OPEXERNAME, opExerName);
  }
  void add_msgOriginator(::flatbuffers::Offset<::flatbuffers::String> msgOriginator) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_MSGORIGINATOR, msgOriginator);
  }
  void add_msgSN(::flatbuffers::Offset<::flatbuffers::String> msgSN) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_MSGSN, msgSN);
  }
  void add_msgMonth(::flatbuffers::Offset<::flatbuffers::String> msgMonth) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_MSGMONTH, msgMonth);
  }
  void add_msgQualifier(::flatbuffers::Offset<::flatbuffers::String> msgQualifier) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_MSGQUALIFIER, msgQualifier);
  }
  void add_ackReqInd(::flatbuffers::Offset<::flatbuffers::String> ackReqInd) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_ACKREQIND, ackReqInd);
  }
  void add_ackUnitInstructions(::flatbuffers::Offset<::flatbuffers::String> ackUnitInstructions) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_ACKUNITINSTRUCTIONS, ackUnitInstructions);
  }
  void add_beginTs(::flatbuffers::Offset<::flatbuffers::String> beginTs) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_BEGINTS, beginTs);
  }
  void add_endTs(::flatbuffers::Offset<::flatbuffers::String> endTs) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_ENDTS, endTs);
  }
  void add_genText(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> genText) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_GENTEXT, genText);
  }
  void add_acMsnTasking(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> acMsnTasking) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_ACMSNTASKING, acMsnTasking);
  }
  void add_navalFltOps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> navalFltOps) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_NAVALFLTOPS, navalFltOps);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_SOURCE, source);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_SOURCEDL, sourceDL);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AirTaskingOrder_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(AirTaskingOrder_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AirTaskingOrder_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit AirTaskingOrder_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirTaskingOrder_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirTaskingOrder_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirTaskingOrder_Ingest> CreateAirTaskingOrder_Ingest(
    ...
    AirTaskingOrder_Ingest_dataMode_Enum dataMode = AirTaskingOrder_Ingest_dataMode_Enum_REAL) {
  AirTaskingOrder_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirTaskingOrder_Ingest> CreateAirTaskingOrder_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAirTaskingOrder_Ingest(
      _fbb,
      id__,
...
inline const AirTaskingOrder_Ingest *GetAirTaskingOrder_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<AirTaskingOrder_Ingest>(buf);
}

inline const AirTaskingOrder_Ingest *GetSizePrefixedAirTaskingOrder_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirTaskingOrder_Ingest>(buf);
}

inline const char *AirTaskingOrder_IngestIdentifier() {
  return "AIRT";
}

inline bool AirTaskingOrder_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirTaskingOrder_IngestIdentifier());
}

inline bool SizePrefixedAirTaskingOrder_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirTaskingOrder_IngestIdentifier(), true);
}

inline bool VerifyAirTaskingOrder_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirTaskingOrder_Ingest>(AirTaskingOrder_IngestIdentifier());
}

inline bool VerifySizePrefixedAirTaskingOrder_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirTaskingOrder_Ingest>(AirTaskingOrder_IngestIdentifier());
}

inline void FinishAirTaskingOrder_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirTaskingOrder_Ingest> root) {
  fbb.Finish(root, AirTaskingOrder_IngestIdentifier());
}

inline void FinishSizePrefixedAirTaskingOrder_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirTaskingOrder_Ingest> root) {
  fbb.FinishSizePrefixed(root, AirTaskingOrder_IngestIdentifier());
}
