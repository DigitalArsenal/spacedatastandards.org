...
struct SiteStatus_Ingest;
struct SiteStatus_IngestBuilder;

enum SiteStatus_Ingest_instStatus_Enum : int8_t {
  /// No description available.
  SiteStatus_Ingest_instStatus_Enum_FMC = 0,
  /// No description available.
  SiteStatus_Ingest_instStatus_Enum_PMC = 1,
  /// No description available.
  SiteStatus_Ingest_instStatus_Enum_NMC = 2,
  /// No description available.
  SiteStatus_Ingest_instStatus_Enum_UNK = 3,
  SiteStatus_Ingest_instStatus_Enum_MIN = SiteStatus_Ingest_instStatus_Enum_FMC,
  SiteStatus_Ingest_instStatus_Enum_MAX = SiteStatus_Ingest_instStatus_Enum_UNK
};

inline const SiteStatus_Ingest_instStatus_Enum (&EnumValuesSiteStatus_Ingest_instStatus_Enum())[4] {
  static const SiteStatus_Ingest_instStatus_Enum values[] = {
    SiteStatus_Ingest_instStatus_Enum_FMC,
    SiteStatus_Ingest_instStatus_Enum_PMC,
    SiteStatus_Ingest_instStatus_Enum_NMC,
    SiteStatus_Ingest_instStatus_Enum_UNK
  };
  return values;
}

inline const char * const *EnumNamesSiteStatus_Ingest_instStatus_Enum() {
...
inline const char *EnumNameSiteStatus_Ingest_instStatus_Enum(SiteStatus_Ingest_instStatus_Enum e) {
  if (::flatbuffers::IsOutRange(e, SiteStatus_Ingest_instStatus_Enum_FMC, SiteStatus_Ingest_instStatus_Enum_UNK)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSiteStatus_Ingest_instStatus_Enum()[index];
}

enum SiteStatus_Ingest_fpcon_Enum : int8_t {
  /// No description available.
  SiteStatus_Ingest_fpcon_Enum_NORMAL = 0,
  /// No description available.
  SiteStatus_Ingest_fpcon_Enum_ALPHA = 1,
  /// No description available.
  SiteStatus_Ingest_fpcon_Enum_BRAVO = 2,
  /// No description available.
  SiteStatus_Ingest_fpcon_Enum_CHARLIE = 3,
  /// No description available.
  SiteStatus_Ingest_fpcon_Enum_DELTA = 4,
  SiteStatus_Ingest_fpcon_Enum_MIN = SiteStatus_Ingest_fpcon_Enum_NORMAL,
  SiteStatus_Ingest_fpcon_Enum_MAX = SiteStatus_Ingest_fpcon_Enum_DELTA
};

inline const SiteStatus_Ingest_fpcon_Enum (&EnumValuesSiteStatus_Ingest_fpcon_Enum())[5] {
  static const SiteStatus_Ingest_fpcon_Enum values[] = {
    SiteStatus_Ingest_fpcon_Enum_NORMAL,
    SiteStatus_Ingest_fpcon_Enum_ALPHA,
    SiteStatus_Ingest_fpcon_Enum_BRAVO,
    SiteStatus_Ingest_fpcon_Enum_CHARLIE,
    SiteStatus_Ingest_fpcon_Enum_DELTA
  };
  return values;
}

inline const char * const *EnumNamesSiteStatus_Ingest_fpcon_Enum() {
...
inline const char *EnumNameSiteStatus_Ingest_fpcon_Enum(SiteStatus_Ingest_fpcon_Enum e) {
  if (::flatbuffers::IsOutRange(e, SiteStatus_Ingest_fpcon_Enum_NORMAL, SiteStatus_Ingest_fpcon_Enum_DELTA)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSiteStatus_Ingest_fpcon_Enum()[index];
}

enum SiteStatus_Ingest_hpcon_Enum : int8_t {
  /// No description available.
  SiteStatus_Ingest_hpcon_Enum_E0 = 0,
  /// No description available.
  SiteStatus_Ingest_hpcon_Enum_ALPHA = 1,
  /// No description available.
  SiteStatus_Ingest_hpcon_Enum_BRAVO = 2,
  /// No description available.
  SiteStatus_Ingest_hpcon_Enum_CHARLIE = 3,
  /// No description available.
  SiteStatus_Ingest_hpcon_Enum_DELTA = 4,
  SiteStatus_Ingest_hpcon_Enum_MIN = SiteStatus_Ingest_hpcon_Enum_E0,
  SiteStatus_Ingest_hpcon_Enum_MAX = SiteStatus_Ingest_hpcon_Enum_DELTA
};

inline const SiteStatus_Ingest_hpcon_Enum (&EnumValuesSiteStatus_Ingest_hpcon_Enum())[5] {
  static const SiteStatus_Ingest_hpcon_Enum values[] = {
    SiteStatus_Ingest_hpcon_Enum_E0,
    SiteStatus_Ingest_hpcon_Enum_ALPHA,
    SiteStatus_Ingest_hpcon_Enum_BRAVO,
    SiteStatus_Ingest_hpcon_Enum_CHARLIE,
    SiteStatus_Ingest_hpcon_Enum_DELTA
  };
  return values;
}

inline const char * const *EnumNamesSiteStatus_Ingest_hpcon_Enum() {
  static const char * const names[6] = {
    "E0",
    "ALPHA",
    "BRAVO",
...
inline const char *EnumNameSiteStatus_Ingest_hpcon_Enum(SiteStatus_Ingest_hpcon_Enum e) {
  if (::flatbuffers::IsOutRange(e, SiteStatus_Ingest_hpcon_Enum_E0, SiteStatus_Ingest_hpcon_Enum_DELTA)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSiteStatus_Ingest_hpcon_Enum()[index];
}

enum SiteStatus_Ingest_cpcon_Enum : int8_t {
  /// No description available.
  SiteStatus_Ingest_cpcon_Enum_E1 = 0,
  /// No description available.
  SiteStatus_Ingest_cpcon_Enum_E2 = 1,
  /// No description available.
  SiteStatus_Ingest_cpcon_Enum_E3 = 2,
  /// No description available.
  SiteStatus_Ingest_cpcon_Enum_E4 = 3,
  /// No description available.
  SiteStatus_Ingest_cpcon_Enum_E5 = 4,
  SiteStatus_Ingest_cpcon_Enum_MIN = SiteStatus_Ingest_cpcon_Enum_E1,
  SiteStatus_Ingest_cpcon_Enum_MAX = SiteStatus_Ingest_cpcon_Enum_E5
};

inline const SiteStatus_Ingest_cpcon_Enum (&EnumValuesSiteStatus_Ingest_cpcon_Enum())[5] {
  static const SiteStatus_Ingest_cpcon_Enum values[] = {
    SiteStatus_Ingest_cpcon_Enum_E1,
    SiteStatus_Ingest_cpcon_Enum_E2,
    SiteStatus_Ingest_cpcon_Enum_E3,
    SiteStatus_Ingest_cpcon_Enum_E4,
    SiteStatus_Ingest_cpcon_Enum_E5
  };
  return values;
}

inline const char * const *EnumNamesSiteStatus_Ingest_cpcon_Enum() {
  static const char * const names[6] = {
    "E1",
    "E2",
    "E3",
...
inline const char *EnumNameSiteStatus_Ingest_cpcon_Enum(SiteStatus_Ingest_cpcon_Enum e) {
  if (::flatbuffers::IsOutRange(e, SiteStatus_Ingest_cpcon_Enum_E1, SiteStatus_Ingest_cpcon_Enum_E5)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSiteStatus_Ingest_cpcon_Enum()[index];
}

enum SiteStatus_Ingest_cat_Enum : int8_t {
  /// No description available.
  SiteStatus_Ingest_cat_Enum_COLD = 0,
  /// No description available.
  SiteStatus_Ingest_cat_Enum_WARM = 1,
  /// No description available.
  SiteStatus_Ingest_cat_Enum_HOT = 2,
  SiteStatus_Ingest_cat_Enum_MIN = SiteStatus_Ingest_cat_Enum_COLD,
  SiteStatus_Ingest_cat_Enum_MAX = SiteStatus_Ingest_cat_Enum_HOT
};

inline const SiteStatus_Ingest_cat_Enum (&EnumValuesSiteStatus_Ingest_cat_Enum())[3] {
  static const SiteStatus_Ingest_cat_Enum values[] = {
    SiteStatus_Ingest_cat_Enum_COLD,
    SiteStatus_Ingest_cat_Enum_WARM,
    SiteStatus_Ingest_cat_Enum_HOT
  };
  return values;
}

inline const char * const *EnumNamesSiteStatus_Ingest_cat_Enum() {
...
inline const char *EnumNameSiteStatus_Ingest_cat_Enum(SiteStatus_Ingest_cat_Enum e) {
  if (::flatbuffers::IsOutRange(e, SiteStatus_Ingest_cat_Enum_COLD, SiteStatus_Ingest_cat_Enum_HOT)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSiteStatus_Ingest_cat_Enum()[index];
}

enum SiteStatus_Ingest_eoc_Enum : int8_t {
  /// No description available.
  SiteStatus_Ingest_eoc_Enum_COLD = 0,
  /// No description available.
  SiteStatus_Ingest_eoc_Enum_WARM = 1,
  /// No description available.
  SiteStatus_Ingest_eoc_Enum_HOT = 2,
  SiteStatus_Ingest_eoc_Enum_MIN = SiteStatus_Ingest_eoc_Enum_COLD,
  SiteStatus_Ingest_eoc_Enum_MAX = SiteStatus_Ingest_eoc_Enum_HOT
};

inline const SiteStatus_Ingest_eoc_Enum (&EnumValuesSiteStatus_Ingest_eoc_Enum())[3] {
  static const SiteStatus_Ingest_eoc_Enum values[] = {
    SiteStatus_Ingest_eoc_Enum_COLD,
    SiteStatus_Ingest_eoc_Enum_WARM,
    SiteStatus_Ingest_eoc_Enum_HOT
  };
  return values;
}

inline const char * const *EnumNamesSiteStatus_Ingest_eoc_Enum() {
  static const char * const names[4] = {
    "COLD",
    "WARM",
    "HOT",
...
inline const char *EnumNameSiteStatus_Ingest_eoc_Enum(SiteStatus_Ingest_eoc_Enum e) {
  if (::flatbuffers::IsOutRange(e, SiteStatus_Ingest_eoc_Enum_COLD, SiteStatus_Ingest_eoc_Enum_HOT)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSiteStatus_Ingest_eoc_Enum()[index];
}

enum SiteStatus_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  SiteStatus_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  SiteStatus_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  SiteStatus_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  SiteStatus_Ingest_dataMode_Enum_EXERCISE = 3,
  SiteStatus_Ingest_dataMode_Enum_MIN = SiteStatus_Ingest_dataMode_Enum_REAL,
  SiteStatus_Ingest_dataMode_Enum_MAX = SiteStatus_Ingest_dataMode_Enum_EXERCISE
};

inline const SiteStatus_Ingest_dataMode_Enum (&EnumValuesSiteStatus_Ingest_dataMode_Enum())[4] {
  static const SiteStatus_Ingest_dataMode_Enum values[] = {
    SiteStatus_Ingest_dataMode_Enum_REAL,
    SiteStatus_Ingest_dataMode_Enum_TEST,
    SiteStatus_Ingest_dataMode_Enum_SIMULATED,
    SiteStatus_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSiteStatus_Ingest_dataMode_Enum() {
  static const char * const names[5] = {
    "REAL",
    "TEST",
    "SIMULATED",
...
inline const char *EnumNameSiteStatus_Ingest_dataMode_Enum(SiteStatus_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SiteStatus_Ingest_dataMode_Enum_REAL, SiteStatus_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSiteStatus_Ingest_dataMode_Enum()[index];
}

/// /// No description available.
struct SiteStatus_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SiteStatus_IngestBuilder Builder;
  ...
  SiteStatus_Ingest_instStatus_Enum instStatus() const {
    return static_cast<SiteStatus_Ingest_instStatus_Enum>(GetField<int8_t>(VT_INSTSTATUS, 0));
  }
  ...
  SiteStatus_Ingest_fpcon_Enum fpcon() const {
    return static_cast<SiteStatus_Ingest_fpcon_Enum>(GetField<int8_t>(VT_FPCON, 0));
  }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 7
  SiteStatus_Ingest_hpcon_Enum hpcon() const {
    return static_cast<SiteStatus_Ingest_hpcon_Enum>(GetField<int8_t>(VT_HPCON, 0));
  }
  ...
  SiteStatus_Ingest_cpcon_Enum cpcon() const {
    return static_cast<SiteStatus_Ingest_cpcon_Enum>(GetField<int8_t>(VT_CPCON, 0));
  }
  ...
  SiteStatus_Ingest_cat_Enum cat() const {
    return static_cast<SiteStatus_Ingest_cat_Enum>(GetField<int8_t>(VT_CAT, 0));
  }
  ...
  /// Constraints: Minimum length = 0, Maximum length = 4
  SiteStatus_Ingest_eoc_Enum eoc() const {
    return static_cast<SiteStatus_Ingest_eoc_Enum>(GetField<int8_t>(VT_EOC, 0));
  }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SiteStatus_Ingest_dataMode_Enum dataMode() const {
    return static_cast<SiteStatus_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SiteStatus_IngestBuilder {
  typedef SiteStatus_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idSite(::flatbuffers::Offset<::flatbuffers::String> idSite) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_IDSITE, idSite);
  }
  void add_siteType(::flatbuffers::Offset<::flatbuffers::String> siteType) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_SITETYPE, siteType);
  }
  void add_mobileAltId(::flatbuffers::Offset<::flatbuffers::String> mobileAltId) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_MOBILEALTID, mobileAltId);
  }
  void add_poiid(::flatbuffers::Offset<::flatbuffers::String> poiid) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_POIID, poiid);
  }
  void add_trackId(::flatbuffers::Offset<::flatbuffers::String> trackId) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_TRACKID, trackId);
  }
  void add_trackRefL16(::flatbuffers::Offset<::flatbuffers::String> trackRefL16) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_TRACKREFL16, trackRefL16);
  }
  void add_opsCapability(::flatbuffers::Offset<::flatbuffers::String> opsCapability) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_OPSCAPABILITY, opsCapability);
  }
  void add_instStatus(SiteStatus_Ingest_instStatus_Enum instStatus) {
    fbb_.AddElement<int8_t>(SiteStatus_Ingest::VT_INSTSTATUS, static_cast<int8_t>(instStatus), 0);
  }
  void add_fpcon(SiteStatus_Ingest_fpcon_Enum fpcon) {
    fbb_.AddElement<int8_t>(SiteStatus_Ingest::VT_FPCON, static_cast<int8_t>(fpcon), 0);
  }
  void add_hpcon(SiteStatus_Ingest_hpcon_Enum hpcon) {
    fbb_.AddElement<int8_t>(SiteStatus_Ingest::VT_HPCON, static_cast<int8_t>(hpcon), 0);
  }
  void add_cpcon(SiteStatus_Ingest_cpcon_Enum cpcon) {
    fbb_.AddElement<int8_t>(SiteStatus_Ingest::VT_CPCON, static_cast<int8_t>(cpcon), 0);
  }
  void add_reportTime(::flatbuffers::Offset<::flatbuffers::String> reportTime) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_REPORTTIME, reportTime);
  }
  void add_timeFunction(::flatbuffers::Offset<::flatbuffers::String> timeFunction) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_TIMEFUNCTION, timeFunction);
  }
  void add_weatherMessage(::flatbuffers::Offset<::flatbuffers::String> weatherMessage) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_WEATHERMESSAGE, weatherMessage);
  }
  void add_pes(bool pes) {
    fbb_.AddElement<uint8_t>(SiteStatus_Ingest::VT_PES, static_cast<uint8_t>(pes), 0);
  }
  void add_hotInventory(int32_t hotInventory) {
    fbb_.AddElement<int32_t>(SiteStatus_Ingest::VT_HOTINVENTORY, hotInventory, 0);
  }
  void add_coldInventory(int32_t coldInventory) {
    fbb_.AddElement<int32_t>(SiteStatus_Ingest::VT_COLDINVENTORY, coldInventory, 0);
  }
  void add_samMode(::flatbuffers::Offset<::flatbuffers::String> samMode) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_SAMMODE, samMode);
  }
  void add_radiateMode(::flatbuffers::Offset<::flatbuffers::String> radiateMode) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_RADIATEMODE, radiateMode);
  }
  void add_opsImpairment(::flatbuffers::Offset<::flatbuffers::String> opsImpairment) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_OPSIMPAIRMENT, opsImpairment);
  }
  void add_commImpairment(::flatbuffers::Offset<::flatbuffers::String> commImpairment) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_COMMIMPAIRMENT, commImpairment);
  }
  void add_cat(SiteStatus_Ingest_cat_Enum cat) {
    fbb_.AddElement<int8_t>(SiteStatus_Ingest::VT_CAT, static_cast<int8_t>(cat), 0);
  }
  void add_eoc(SiteStatus_Ingest_eoc_Enum eoc) {
    fbb_.AddElement<int8_t>(SiteStatus_Ingest::VT_EOC, static_cast<int8_t>(eoc), 0);
  }
  void add_link(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> link) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_LINK, link);
  }
  void add_linkStatus(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> linkStatus) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_LINKSTATUS, linkStatus);
  }
  void add_radarSystem(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> radarSystem) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_RADARSYSTEM, radarSystem);
  }
  void add_radarStatus(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> radarStatus) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_RADARSTATUS, radarStatus);
  }
  void add_missile(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> missile) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_MISSILE, missile);
  }
  void add_missileInventory(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> missileInventory) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_MISSILEINVENTORY, missileInventory);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SiteStatus_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(SiteStatus_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SiteStatus_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit SiteStatus_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SiteStatus_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SiteStatus_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SiteStatus_Ingest> CreateSiteStatus_Ingest(
    ...
    SiteStatus_Ingest_instStatus_Enum instStatus = SiteStatus_Ingest_instStatus_Enum_FMC,
    SiteStatus_Ingest_fpcon_Enum fpcon = SiteStatus_Ingest_fpcon_Enum_NORMAL,
    SiteStatus_Ingest_hpcon_Enum hpcon = SiteStatus_Ingest_hpcon_Enum_E0,
    SiteStatus_Ingest_cpcon_Enum cpcon = SiteStatus_Ingest_cpcon_Enum_E1,
    ...
    SiteStatus_Ingest_cat_Enum cat = SiteStatus_Ingest_cat_Enum_COLD,
    SiteStatus_Ingest_eoc_Enum eoc = SiteStatus_Ingest_eoc_Enum_COLD,
    ...
    SiteStatus_Ingest_dataMode_Enum dataMode = SiteStatus_Ingest_dataMode_Enum_REAL) {
  SiteStatus_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SiteStatus_Ingest> CreateSiteStatus_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const SiteStatus_Ingest *GetSiteStatus_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<SiteStatus_Ingest>(buf);
}

inline const SiteStatus_Ingest *GetSizePrefixedSiteStatus_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SiteStatus_Ingest>(buf);
}

inline const char *SiteStatus_IngestIdentifier() {
  return "SITE";
}

inline bool SiteStatus_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SiteStatus_IngestIdentifier());
}

inline bool SizePrefixedSiteStatus_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SiteStatus_IngestIdentifier(), true);
}

inline bool VerifySiteStatus_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SiteStatus_Ingest>(SiteStatus_IngestIdentifier());
}

inline bool VerifySizePrefixedSiteStatus_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SiteStatus_Ingest>(SiteStatus_IngestIdentifier());
}

inline void FinishSiteStatus_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SiteStatus_Ingest> root) {
  fbb.Finish(root, SiteStatus_IngestIdentifier());
}

inline void FinishSizePrefixedSiteStatus_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SiteStatus_Ingest> root) {
  fbb.FinishSizePrefixed(root, SiteStatus_IngestIdentifier());
}
