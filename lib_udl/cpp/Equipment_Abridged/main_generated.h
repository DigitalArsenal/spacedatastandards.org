...
struct Equipment_Abridged;
struct Equipment_AbridgedBuilder;

enum Equipment_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Equipment_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Equipment_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Equipment_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Equipment_Abridged_dataMode_Enum_EXERCISE = 3,
  Equipment_Abridged_dataMode_Enum_MIN = Equipment_Abridged_dataMode_Enum_REAL,
  Equipment_Abridged_dataMode_Enum_MAX = Equipment_Abridged_dataMode_Enum_EXERCISE
};

inline const Equipment_Abridged_dataMode_Enum (&EnumValuesEquipment_Abridged_dataMode_Enum())[4] {
  static const Equipment_Abridged_dataMode_Enum values[] = {
    Equipment_Abridged_dataMode_Enum_REAL,
    Equipment_Abridged_dataMode_Enum_TEST,
    Equipment_Abridged_dataMode_Enum_SIMULATED,
    Equipment_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesEquipment_Abridged_dataMode_Enum() {
...
inline const char *EnumNameEquipment_Abridged_dataMode_Enum(Equipment_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Equipment_Abridged_dataMode_Enum_REAL, Equipment_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEquipment_Abridged_dataMode_Enum()[index];
}

/// /// Properties and characteristics of equipment that can be associated with a site or other entity.
struct Equipment_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Equipment_AbridgedBuilder Builder;
  ...
  Equipment_Abridged_dataMode_Enum dataMode() const {
    return static_cast<Equipment_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Equipment_AbridgedBuilder {
  typedef Equipment_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Equipment_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Equipment_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idParentEquipment(::flatbuffers::Offset<::flatbuffers::String> idParentEquipment) {
    fbb_.AddOffset(Equipment_Abridged::VT_IDPARENTEQUIPMENT, idParentEquipment);
  }
  void add_idSite(::flatbuffers::Offset<::flatbuffers::String> idSite) {
    fbb_.AddOffset(Equipment_Abridged::VT_IDSITE, idSite);
  }
  void add_idOperatingUnit(::flatbuffers::Offset<::flatbuffers::String> idOperatingUnit) {
    fbb_.AddOffset(Equipment_Abridged::VT_IDOPERATINGUNIT, idOperatingUnit);
  }
  void add_altEqpId(::flatbuffers::Offset<::flatbuffers::String> altEqpId) {
    fbb_.AddOffset(Equipment_Abridged::VT_ALTEQPID, altEqpId);
  }
  void add_eqpCode(::flatbuffers::Offset<::flatbuffers::String> eqpCode) {
    fbb_.AddOffset(Equipment_Abridged::VT_EQPCODE, eqpCode);
  }
  void add_eqpIdNum(::flatbuffers::Offset<::flatbuffers::String> eqpIdNum) {
    fbb_.AddOffset(Equipment_Abridged::VT_EQPIDNUM, eqpIdNum);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(Equipment_Abridged::VT_COUNTRYCODE, countryCode);
  }
  void add_altCountryCode(::flatbuffers::Offset<::flatbuffers::String> altCountryCode) {
    fbb_.AddOffset(Equipment_Abridged::VT_ALTCOUNTRYCODE, altCountryCode);
  }
  void add_wac(::flatbuffers::Offset<::flatbuffers::String> wac) {
    fbb_.AddOffset(Equipment_Abridged::VT_WAC, wac);
  }
  void add_seqNum(int32_t seqNum) {
    fbb_.AddElement<int32_t>(Equipment_Abridged::VT_SEQNUM, seqNum, 0);
  }
  void add_nomen(::flatbuffers::Offset<::flatbuffers::String> nomen) {
    fbb_.AddOffset(Equipment_Abridged::VT_NOMEN, nomen);
  }
  void add_operStatus(::flatbuffers::Offset<::flatbuffers::String> operStatus) {
    fbb_.AddOffset(Equipment_Abridged::VT_OPERSTATUS, operStatus);
  }
  void add_condition(::flatbuffers::Offset<::flatbuffers::String> condition) {
    fbb_.AddOffset(Equipment_Abridged::VT_CONDITION, condition);
  }
  void add_conditionAvail(::flatbuffers::Offset<::flatbuffers::String> conditionAvail) {
    fbb_.AddOffset(Equipment_Abridged::VT_CONDITIONAVAIL, conditionAvail);
  }
  void add_eval(int32_t eval) {
    fbb_.AddElement<int32_t>(Equipment_Abridged::VT_EVAL, eval, 0);
  }
  void add_fpa(::flatbuffers::Offset<::flatbuffers::String> fpa) {
    fbb_.AddOffset(Equipment_Abridged::VT_FPA, fpa);
  }
  void add_function(::flatbuffers::Offset<::flatbuffers::String> function) {
    fbb_.AddOffset(Equipment_Abridged::VT_FUNCTION, function);
  }
  void add_ident(::flatbuffers::Offset<::flatbuffers::String> ident) {
    fbb_.AddOffset(Equipment_Abridged::VT_IDENT, ident);
  }
  void add_allegiance(::flatbuffers::Offset<::flatbuffers::String> allegiance) {
    fbb_.AddOffset(Equipment_Abridged::VT_ALLEGIANCE, allegiance);
  }
  void add_altAllegiance(::flatbuffers::Offset<::flatbuffers::String> altAllegiance) {
    fbb_.AddOffset(Equipment_Abridged::VT_ALTALLEGIANCE, altAllegiance);
  }
  void add_locReason(::flatbuffers::Offset<::flatbuffers::String> locReason) {
    fbb_.AddOffset(Equipment_Abridged::VT_LOCREASON, locReason);
  }
  void add_operAreaPrimary(::flatbuffers::Offset<::flatbuffers::String> operAreaPrimary) {
    fbb_.AddOffset(Equipment_Abridged::VT_OPERAREAPRIMARY, operAreaPrimary);
  }
  void add_functPrimary(::flatbuffers::Offset<::flatbuffers::String> functPrimary) {
    fbb_.AddOffset(Equipment_Abridged::VT_FUNCTPRIMARY, functPrimary);
  }
  void add_coordDatum(::flatbuffers::Offset<::flatbuffers::String> coordDatum) {
    fbb_.AddOffset(Equipment_Abridged::VT_COORDDATUM, coordDatum);
  }
  void add_coord(::flatbuffers::Offset<::flatbuffers::String> coord) {
    fbb_.AddOffset(Equipment_Abridged::VT_COORD, coord);
  }
  void add_coordDerivAcc(double coordDerivAcc) {
    fbb_.AddElement<double>(Equipment_Abridged::VT_COORDDERIVACC, coordDerivAcc, 0.0);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(Equipment_Abridged::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(Equipment_Abridged::VT_LON, lon, 0.0);
  }
  void add_elevMsl(double elevMsl) {
    fbb_.AddElement<double>(Equipment_Abridged::VT_ELEVMSL, elevMsl, 0.0);
  }
  void add_elevMslConfLvl(int32_t elevMslConfLvl) {
    fbb_.AddElement<int32_t>(Equipment_Abridged::VT_ELEVMSLCONFLVL, elevMslConfLvl, 0);
  }
  void add_elevMslDerivAcc(double elevMslDerivAcc) {
    fbb_.AddElement<double>(Equipment_Abridged::VT_ELEVMSLDERIVACC, elevMslDerivAcc, 0.0);
  }
  void add_geoidalMslSep(double geoidalMslSep) {
    fbb_.AddElement<double>(Equipment_Abridged::VT_GEOIDALMSLSEP, geoidalMslSep, 0.0);
  }
  void add_milGridSys(::flatbuffers::Offset<::flatbuffers::String> milGridSys) {
    fbb_.AddOffset(Equipment_Abridged::VT_MILGRIDSYS, milGridSys);
  }
  void add_milGrid(::flatbuffers::Offset<::flatbuffers::String> milGrid) {
    fbb_.AddOffset(Equipment_Abridged::VT_MILGRID, milGrid);
  }
  void add_utm(::flatbuffers::Offset<::flatbuffers::String> utm) {
    fbb_.AddOffset(Equipment_Abridged::VT_UTM, utm);
  }
  void add_airDefArea(::flatbuffers::Offset<::flatbuffers::String> airDefArea) {
    fbb_.AddOffset(Equipment_Abridged::VT_AIRDEFAREA, airDefArea);
  }
  void add_polSubdiv(::flatbuffers::Offset<::flatbuffers::String> polSubdiv) {
    fbb_.AddOffset(Equipment_Abridged::VT_POLSUBDIV, polSubdiv);
  }
  void add_qtyOH(int32_t qtyOH) {
    fbb_.AddElement<int32_t>(Equipment_Abridged::VT_QTYOH, qtyOH, 0);
  }
  void add_symCode(::flatbuffers::Offset<::flatbuffers::String> symCode) {
    fbb_.AddOffset(Equipment_Abridged::VT_SYMCODE, symCode);
  }
  void add_classRating(::flatbuffers::Offset<::flatbuffers::String> classRating) {
    fbb_.AddOffset(Equipment_Abridged::VT_CLASSRATING, classRating);
  }
  void add_recStatus(::flatbuffers::Offset<::flatbuffers::String> recStatus) {
    fbb_.AddOffset(Equipment_Abridged::VT_RECSTATUS, recStatus);
  }
  void add_reviewDate(::flatbuffers::Offset<::flatbuffers::String> reviewDate) {
    fbb_.AddOffset(Equipment_Abridged::VT_REVIEWDATE, reviewDate);
  }
  void add_resProd(::flatbuffers::Offset<::flatbuffers::String> resProd) {
    fbb_.AddOffset(Equipment_Abridged::VT_RESPROD, resProd);
  }
  void add_referenceDoc(::flatbuffers::Offset<::flatbuffers::String> referenceDoc) {
    fbb_.AddOffset(Equipment_Abridged::VT_REFERENCEDOC, referenceDoc);
  }
  void add_srcTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcTyps) {
    fbb_.AddOffset(Equipment_Abridged::VT_SRCTYPS, srcTyps);
  }
  void add_srcIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcIds) {
    fbb_.AddOffset(Equipment_Abridged::VT_SRCIDS, srcIds);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Equipment_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Equipment_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Equipment_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Equipment_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(Equipment_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Equipment_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit Equipment_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Equipment_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Equipment_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Equipment_Abridged> CreateEquipment_Abridged(
    ...
    Equipment_Abridged_dataMode_Enum dataMode = Equipment_Abridged_dataMode_Enum_REAL) {
  Equipment_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Equipment_Abridged> CreateEquipment_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Equipment_Abridged *GetEquipment_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<Equipment_Abridged>(buf);
}

inline const Equipment_Abridged *GetSizePrefixedEquipment_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Equipment_Abridged>(buf);
}

inline const char *Equipment_AbridgedIdentifier() {
  return "EQUI";
}

inline bool Equipment_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Equipment_AbridgedIdentifier());
}

inline bool SizePrefixedEquipment_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Equipment_AbridgedIdentifier(), true);
}

inline bool VerifyEquipment_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Equipment_Abridged>(Equipment_AbridgedIdentifier());
}

inline bool VerifySizePrefixedEquipment_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Equipment_Abridged>(Equipment_AbridgedIdentifier());
}

inline void FinishEquipment_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Equipment_Abridged> root) {
  fbb.Finish(root, Equipment_AbridgedIdentifier());
}

inline void FinishSizePrefixedEquipment_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Equipment_Abridged> root) {
  fbb.FinishSizePrefixed(root, Equipment_AbridgedIdentifier());
}
