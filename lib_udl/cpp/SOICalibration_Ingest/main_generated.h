...
struct SOICalibration_Ingest;
struct SOICalibration_IngestBuilder;

/// /// Schema for SOI Calibration data.
struct SOICalibration_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SOICalibration_IngestBuilder Builder;
...
struct SOICalibration_IngestBuilder {
  typedef SOICalibration_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_calExtinctionCoeff(double calExtinctionCoeff) {
    fbb_.AddElement<double>(SOICalibration_Ingest::VT_CALEXTINCTIONCOEFF, calExtinctionCoeff, 0.0);
  }
  void add_calSkyBg(double calSkyBg) {
    fbb_.AddElement<double>(SOICalibration_Ingest::VT_CALSKYBG, calSkyBg, 0.0);
  }
  void add_calBgIntensity(double calBgIntensity) {
    fbb_.AddElement<double>(SOICalibration_Ingest::VT_CALBGINTENSITY, calBgIntensity, 0.0);
  }
  void add_calSpectralFilterSolarMag(double calSpectralFilterSolarMag) {
    fbb_.AddElement<double>(SOICalibration_Ingest::VT_CALSPECTRALFILTERSOLARMAG, calSpectralFilterSolarMag, 0.0);
  }
  void add_calZeroPoint(double calZeroPoint) {
    fbb_.AddElement<double>(SOICalibration_Ingest::VT_CALZEROPOINT, calZeroPoint, 0.0);
  }
  void add_calNumDetectedStars(int32_t calNumDetectedStars) {
    fbb_.AddElement<int32_t>(SOICalibration_Ingest::VT_CALNUMDETECTEDSTARS, calNumDetectedStars, 0);
  }
  void add_calNumCorrelatedStars(int32_t calNumCorrelatedStars) {
    fbb_.AddElement<int32_t>(SOICalibration_Ingest::VT_CALNUMCORRELATEDSTARS, calNumCorrelatedStars, 0);
  }
  void add_calExtinctionCoeffUnc(double calExtinctionCoeffUnc) {
    fbb_.AddElement<double>(SOICalibration_Ingest::VT_CALEXTINCTIONCOEFFUNC, calExtinctionCoeffUnc, 0.0);
  }
  void add_calExtinctionCoeffMaxUnc(double calExtinctionCoeffMaxUnc) {
    fbb_.AddElement<double>(SOICalibration_Ingest::VT_CALEXTINCTIONCOEFFMAXUNC, calExtinctionCoeffMaxUnc, 0.0);
  }
  void add_calTime(::flatbuffers::Offset<::flatbuffers::String> calTime) {
    fbb_.AddOffset(SOICalibration_Ingest::VT_CALTIME, calTime);
  }
  void add_calType(::flatbuffers::Offset<::flatbuffers::String> calType) {
    fbb_.AddOffset(SOICalibration_Ingest::VT_CALTYPE, calType);
  }
  explicit SOICalibration_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SOICalibration_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SOICalibration_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SOICalibration_Ingest> CreateSOICalibration_Ingest(
  ...
  SOICalibration_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SOICalibration_Ingest> CreateSOICalibration_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    double calExtinctionCoeff = 0.0,
    double calSkyBg = 0.0,
    double calBgIntensity = 0.0,
...
inline const SOICalibration_Ingest *GetSOICalibration_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<SOICalibration_Ingest>(buf);
}

inline const SOICalibration_Ingest *GetSizePrefixedSOICalibration_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SOICalibration_Ingest>(buf);
}

inline const char *SOICalibration_IngestIdentifier() {
  return "SOIC";
}

inline bool SOICalibration_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SOICalibration_IngestIdentifier());
}

inline bool SizePrefixedSOICalibration_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SOICalibration_IngestIdentifier(), true);
}

inline bool VerifySOICalibration_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SOICalibration_Ingest>(SOICalibration_IngestIdentifier());
}

inline bool VerifySizePrefixedSOICalibration_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SOICalibration_Ingest>(SOICalibration_IngestIdentifier());
}

inline void FinishSOICalibration_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SOICalibration_Ingest> root) {
  fbb.Finish(root, SOICalibration_IngestIdentifier());
}

inline void FinishSizePrefixedSOICalibration_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SOICalibration_Ingest> root) {
  fbb.FinishSizePrefixed(root, SOICalibration_IngestIdentifier());
}
