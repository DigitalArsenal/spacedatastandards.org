...
struct AIS_Full;
struct AIS_FullBuilder;

enum AIS_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  AIS_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  AIS_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  AIS_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  AIS_Full_dataMode_Enum_EXERCISE = 3,
  AIS_Full_dataMode_Enum_MIN = AIS_Full_dataMode_Enum_REAL,
  AIS_Full_dataMode_Enum_MAX = AIS_Full_dataMode_Enum_EXERCISE
};

inline const AIS_Full_dataMode_Enum (&EnumValuesAIS_Full_dataMode_Enum())[4] {
  static const AIS_Full_dataMode_Enum values[] = {
    AIS_Full_dataMode_Enum_REAL,
    AIS_Full_dataMode_Enum_TEST,
    AIS_Full_dataMode_Enum_SIMULATED,
    AIS_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAIS_Full_dataMode_Enum() {
...
inline const char *EnumNameAIS_Full_dataMode_Enum(AIS_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AIS_Full_dataMode_Enum_REAL, AIS_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAIS_Full_dataMode_Enum()[index];
}
...
struct AIS_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AIS_FullBuilder Builder;
  ...
  AIS_Full_dataMode_Enum dataMode() const {
    return static_cast<AIS_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AIS_FullBuilder {
  typedef AIS_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AIS_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AIS_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idTrack(::flatbuffers::Offset<::flatbuffers::String> idTrack) {
    fbb_.AddOffset(AIS_Full::VT_IDTRACK, idTrack);
  }
  void add_idVessel(::flatbuffers::Offset<::flatbuffers::String> idVessel) {
    fbb_.AddOffset(AIS_Full::VT_IDVESSEL, idVessel);
  }
  void add_mmsi(int64_t mmsi) {
    fbb_.AddElement<int64_t>(AIS_Full::VT_MMSI, mmsi, 0);
  }
  void add_imon(int64_t imon) {
    fbb_.AddElement<int64_t>(AIS_Full::VT_IMON, imon, 0);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::String> ts) {
    fbb_.AddOffset(AIS_Full::VT_TS, ts);
  }
  void add_shipName(::flatbuffers::Offset<::flatbuffers::String> shipName) {
    fbb_.AddOffset(AIS_Full::VT_SHIPNAME, shipName);
  }
  void add_shipType(::flatbuffers::Offset<::flatbuffers::String> shipType) {
    fbb_.AddOffset(AIS_Full::VT_SHIPTYPE, shipType);
  }
  void add_engagedIn(::flatbuffers::Offset<::flatbuffers::String> engagedIn) {
    fbb_.AddOffset(AIS_Full::VT_ENGAGEDIN, engagedIn);
  }
  void add_specialCraft(::flatbuffers::Offset<::flatbuffers::String> specialCraft) {
    fbb_.AddOffset(AIS_Full::VT_SPECIALCRAFT, specialCraft);
  }
  void add_cargoType(::flatbuffers::Offset<::flatbuffers::String> cargoType) {
    fbb_.AddOffset(AIS_Full::VT_CARGOTYPE, cargoType);
  }
  void add_callSign(::flatbuffers::Offset<::flatbuffers::String> callSign) {
    fbb_.AddOffset(AIS_Full::VT_CALLSIGN, callSign);
  }
  void add_vesselFlag(::flatbuffers::Offset<::flatbuffers::String> vesselFlag) {
    fbb_.AddOffset(AIS_Full::VT_VESSELFLAG, vesselFlag);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(AIS_Full::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(AIS_Full::VT_LON, lon, 0.0);
  }
  void add_posHiAccuracy(bool posHiAccuracy) {
    fbb_.AddElement<uint8_t>(AIS_Full::VT_POSHIACCURACY, static_cast<uint8_t>(posHiAccuracy), 0);
  }
  void add_posHiLatency(bool posHiLatency) {
    fbb_.AddElement<uint8_t>(AIS_Full::VT_POSHILATENCY, static_cast<uint8_t>(posHiLatency), 0);
  }
  void add_speed(double speed) {
    fbb_.AddElement<double>(AIS_Full::VT_SPEED, speed, 0.0);
  }
  void add_trueHeading(double trueHeading) {
    fbb_.AddElement<double>(AIS_Full::VT_TRUEHEADING, trueHeading, 0.0);
  }
  void add_course(double course) {
    fbb_.AddElement<double>(AIS_Full::VT_COURSE, course, 0.0);
  }
  void add_rateOfTurn(double rateOfTurn) {
    fbb_.AddElement<double>(AIS_Full::VT_RATEOFTURN, rateOfTurn, 0.0);
  }
  void add_specialManeuver(bool specialManeuver) {
    fbb_.AddElement<uint8_t>(AIS_Full::VT_SPECIALMANEUVER, static_cast<uint8_t>(specialManeuver), 0);
  }
  void add_navStatus(::flatbuffers::Offset<::flatbuffers::String> navStatus) {
    fbb_.AddOffset(AIS_Full::VT_NAVSTATUS, navStatus);
  }
  void add_posDeviceType(::flatbuffers::Offset<::flatbuffers::String> posDeviceType) {
    fbb_.AddOffset(AIS_Full::VT_POSDEVICETYPE, posDeviceType);
  }
  void add_antennaRefDimensions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> antennaRefDimensions) {
    fbb_.AddOffset(AIS_Full::VT_ANTENNAREFDIMENSIONS, antennaRefDimensions);
  }
  void add_length(double length) {
    fbb_.AddElement<double>(AIS_Full::VT_LENGTH, length, 0.0);
  }
  void add_width(double width) {
    fbb_.AddElement<double>(AIS_Full::VT_WIDTH, width, 0.0);
  }
  void add_draught(double draught) {
    fbb_.AddElement<double>(AIS_Full::VT_DRAUGHT, draught, 0.0);
  }
  void add_shipDescription(::flatbuffers::Offset<::flatbuffers::String> shipDescription) {
    fbb_.AddOffset(AIS_Full::VT_SHIPDESCRIPTION, shipDescription);
  }
  void add_destination(::flatbuffers::Offset<::flatbuffers::String> destination) {
    fbb_.AddOffset(AIS_Full::VT_DESTINATION, destination);
  }
  void add_destinationETA(::flatbuffers::Offset<::flatbuffers::String> destinationETA) {
    fbb_.AddOffset(AIS_Full::VT_DESTINATIONETA, destinationETA);
  }
  void add_currentPortGUID(::flatbuffers::Offset<::flatbuffers::String> currentPortGUID) {
    fbb_.AddOffset(AIS_Full::VT_CURRENTPORTGUID, currentPortGUID);
  }
  void add_currentPortLOCODE(::flatbuffers::Offset<::flatbuffers::String> currentPortLOCODE) {
    fbb_.AddOffset(AIS_Full::VT_CURRENTPORTLOCODE, currentPortLOCODE);
  }
  void add_lastPortGUID(::flatbuffers::Offset<::flatbuffers::String> lastPortGUID) {
    fbb_.AddOffset(AIS_Full::VT_LASTPORTGUID, lastPortGUID);
  }
  void add_lastPortLOCODE(::flatbuffers::Offset<::flatbuffers::String> lastPortLOCODE) {
    fbb_.AddOffset(AIS_Full::VT_LASTPORTLOCODE, lastPortLOCODE);
  }
  void add_nextPortGUID(::flatbuffers::Offset<::flatbuffers::String> nextPortGUID) {
    fbb_.AddOffset(AIS_Full::VT_NEXTPORTGUID, nextPortGUID);
  }
  void add_nextPortLOCODE(::flatbuffers::Offset<::flatbuffers::String> nextPortLOCODE) {
    fbb_.AddOffset(AIS_Full::VT_NEXTPORTLOCODE, nextPortLOCODE);
  }
  void add_etaCalculated(::flatbuffers::Offset<::flatbuffers::String> etaCalculated) {
    fbb_.AddOffset(AIS_Full::VT_ETACALCULATED, etaCalculated);
  }
  void add_etaUpdated(::flatbuffers::Offset<::flatbuffers::String> etaUpdated) {
    fbb_.AddOffset(AIS_Full::VT_ETAUPDATED, etaUpdated);
  }
  void add_distanceToGo(double distanceToGo) {
    fbb_.AddElement<double>(AIS_Full::VT_DISTANCETOGO, distanceToGo, 0.0);
  }
  void add_distanceTravelled(double distanceTravelled) {
    fbb_.AddElement<double>(AIS_Full::VT_DISTANCETRAVELLED, distanceTravelled, 0.0);
  }
  void add_avgSpeed(double avgSpeed) {
    fbb_.AddElement<double>(AIS_Full::VT_AVGSPEED, avgSpeed, 0.0);
  }
  void add_maxSpeed(double maxSpeed) {
    fbb_.AddElement<double>(AIS_Full::VT_MAXSPEED, maxSpeed, 0.0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AIS_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AIS_Full::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AIS_Full::VT_SOURCE, source);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(AIS_Full::VT_SOURCEDL, sourceDL);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AIS_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(AIS_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AIS_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AIS_Full::VT_ORIGNETWORK, origNetwork);
  }
  explicit AIS_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AIS_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AIS_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AIS_Full> CreateAIS_Full(
    ...
    AIS_Full_dataMode_Enum dataMode = AIS_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  AIS_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AIS_Full> CreateAIS_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AIS_Full *GetAIS_Full(const void *buf) {
  return ::flatbuffers::GetRoot<AIS_Full>(buf);
}

inline const AIS_Full *GetSizePrefixedAIS_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AIS_Full>(buf);
}

inline const char *AIS_FullIdentifier() {
  return "AISF";
}

inline bool AIS_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AIS_FullIdentifier());
}

inline bool SizePrefixedAIS_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AIS_FullIdentifier(), true);
}

inline bool VerifyAIS_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AIS_Full>(AIS_FullIdentifier());
}

inline bool VerifySizePrefixedAIS_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AIS_Full>(AIS_FullIdentifier());
}

inline void FinishAIS_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AIS_Full> root) {
  fbb.Finish(root, AIS_FullIdentifier());
}

inline void FinishSizePrefixedAIS_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AIS_Full> root) {
  fbb.FinishSizePrefixed(root, AIS_FullIdentifier());
}
