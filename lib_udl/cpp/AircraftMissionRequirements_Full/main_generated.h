...
struct AircraftMissionRequirements_Full;
struct AircraftMissionRequirements_FullBuilder;

/// /// Collection of Requirements associated with this Air Transport Mission.
struct AircraftMissionRequirements_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AircraftMissionRequirements_FullBuilder Builder;
...
struct AircraftMissionRequirements_FullBuilder {
  typedef AircraftMissionRequirements_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_gdssReqId(::flatbuffers::Offset<::flatbuffers::String> gdssReqId) {
    fbb_.AddOffset(AircraftMissionRequirements_Full::VT_GDSSREQID, gdssReqId);
  }
  void add_onloadId(int32_t onloadId) {
    fbb_.AddElement<int32_t>(AircraftMissionRequirements_Full::VT_ONLOADID, onloadId, 0);
  }
  void add_onloadLOCode(::flatbuffers::Offset<::flatbuffers::String> onloadLOCode) {
    fbb_.AddOffset(AircraftMissionRequirements_Full::VT_ONLOADLOCODE, onloadLOCode);
  }
  void add_offloadId(int32_t offloadId) {
    fbb_.AddElement<int32_t>(AircraftMissionRequirements_Full::VT_OFFLOADID, offloadId, 0);
  }
  void add_offloadLOCode(::flatbuffers::Offset<::flatbuffers::String> offloadLOCode) {
    fbb_.AddOffset(AircraftMissionRequirements_Full::VT_OFFLOADLOCODE, offloadLOCode);
  }
  void add_uln(::flatbuffers::Offset<::flatbuffers::String> uln) {
    fbb_.AddOffset(AircraftMissionRequirements_Full::VT_ULN, uln);
  }
  void add_transReqNum(::flatbuffers::Offset<::flatbuffers::String> transReqNum) {
    fbb_.AddOffset(AircraftMissionRequirements_Full::VT_TRANSREQNUM, transReqNum);
  }
  void add_projName(::flatbuffers::Offset<::flatbuffers::String> projName) {
    fbb_.AddOffset(AircraftMissionRequirements_Full::VT_PROJNAME, projName);
  }
  void add_oplan(::flatbuffers::Offset<::flatbuffers::String> oplan) {
    fbb_.AddOffset(AircraftMissionRequirements_Full::VT_OPLAN, oplan);
  }
  void add_numPax(int32_t numPax) {
    fbb_.AddElement<int32_t>(AircraftMissionRequirements_Full::VT_NUMPAX, numPax, 0);
  }
  void add_numLitter(int32_t numLitter) {
    fbb_.AddElement<int32_t>(AircraftMissionRequirements_Full::VT_NUMLITTER, numLitter, 0);
  }
  void add_numAmbulatory(int32_t numAmbulatory) {
    fbb_.AddElement<int32_t>(AircraftMissionRequirements_Full::VT_NUMAMBULATORY, numAmbulatory, 0);
  }
  void add_numAttendant(int32_t numAttendant) {
    fbb_.AddElement<int32_t>(AircraftMissionRequirements_Full::VT_NUMATTENDANT, numAttendant, 0);
  }
  void add_bulkWeight(double bulkWeight) {
    fbb_.AddElement<double>(AircraftMissionRequirements_Full::VT_BULKWEIGHT, bulkWeight, 0.0);
  }
  void add_oversizeWeight(double oversizeWeight) {
    fbb_.AddElement<double>(AircraftMissionRequirements_Full::VT_OVERSIZEWEIGHT, oversizeWeight, 0.0);
  }
  void add_outsizeWeight(double outsizeWeight) {
    fbb_.AddElement<double>(AircraftMissionRequirements_Full::VT_OUTSIZEWEIGHT, outsizeWeight, 0.0);
  }
  void add_ead(::flatbuffers::Offset<::flatbuffers::String> ead) {
    fbb_.AddOffset(AircraftMissionRequirements_Full::VT_EAD, ead);
  }
  void add_lad(::flatbuffers::Offset<::flatbuffers::String> lad) {
    fbb_.AddOffset(AircraftMissionRequirements_Full::VT_LAD, lad);
  }
  explicit AircraftMissionRequirements_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AircraftMissionRequirements_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AircraftMissionRequirements_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AircraftMissionRequirements_Full> CreateAircraftMissionRequirements_Full(
  ...
  AircraftMissionRequirements_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AircraftMissionRequirements_Full> CreateAircraftMissionRequirements_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAircraftMissionRequirements_Full(
      _fbb,
      gdssReqId__,
      onloadId,
      onloadLOCode__,
...
inline const AircraftMissionRequirements_Full *GetAircraftMissionRequirements_Full(const void *buf) {
  return ::flatbuffers::GetRoot<AircraftMissionRequirements_Full>(buf);
}

inline const AircraftMissionRequirements_Full *GetSizePrefixedAircraftMissionRequirements_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AircraftMissionRequirements_Full>(buf);
}

inline const char *AircraftMissionRequirements_FullIdentifier() {
  return "AIRC";
}

inline bool AircraftMissionRequirements_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftMissionRequirements_FullIdentifier());
}

inline bool SizePrefixedAircraftMissionRequirements_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftMissionRequirements_FullIdentifier(), true);
}

inline bool VerifyAircraftMissionRequirements_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AircraftMissionRequirements_Full>(AircraftMissionRequirements_FullIdentifier());
}

inline bool VerifySizePrefixedAircraftMissionRequirements_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AircraftMissionRequirements_Full>(AircraftMissionRequirements_FullIdentifier());
}

inline void FinishAircraftMissionRequirements_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftMissionRequirements_Full> root) {
  fbb.Finish(root, AircraftMissionRequirements_FullIdentifier());
}

inline void FinishSizePrefixedAircraftMissionRequirements_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftMissionRequirements_Full> root) {
  fbb.FinishSizePrefixed(root, AircraftMissionRequirements_FullIdentifier());
}
