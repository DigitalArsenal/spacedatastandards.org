...
struct LogisticsTransportationPlans_Ingest;
struct LogisticsTransportationPlans_IngestBuilder;

/// /// Transportation plans associated with this LogisticsSupport record, used to coordinate maintenance efforts.
struct LogisticsTransportationPlans_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LogisticsTransportationPlans_IngestBuilder Builder;
...
struct LogisticsTransportationPlans_IngestBuilder {
  typedef LogisticsTransportationPlans_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_plansNumber(::flatbuffers::Offset<::flatbuffers::String> plansNumber) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_PLANSNUMBER, plansNumber);
  }
  void add_missionChange(bool missionChange) {
    fbb_.AddElement<uint8_t>(LogisticsTransportationPlans_Ingest::VT_MISSIONCHANGE, static_cast<uint8_t>(missionChange), 0);
  }
  void add_planDefinition(::flatbuffers::Offset<::flatbuffers::String> planDefinition) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_PLANDEFINITION, planDefinition);
  }
  void add_statusCode(::flatbuffers::Offset<::flatbuffers::String> statusCode) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_STATUSCODE, statusCode);
  }
  void add_coordinator(::flatbuffers::Offset<::flatbuffers::String> coordinator) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_COORDINATOR, coordinator);
  }
  void add_coordinatorUnit(::flatbuffers::Offset<::flatbuffers::String> coordinatorUnit) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_COORDINATORUNIT, coordinatorUnit);
  }
  void add_originICAO(::flatbuffers::Offset<::flatbuffers::String> originICAO) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_ORIGINICAO, originICAO);
  }
  void add_estDepTime(::flatbuffers::Offset<::flatbuffers::String> estDepTime) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_ESTDEPTIME, estDepTime);
  }
  void add_estArrTime(::flatbuffers::Offset<::flatbuffers::String> estArrTime) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_ESTARRTIME, estArrTime);
  }
  void add_destinationICAO(::flatbuffers::Offset<::flatbuffers::String> destinationICAO) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_DESTINATIONICAO, destinationICAO);
  }
  void add_logisticMasterRecordId(::flatbuffers::Offset<::flatbuffers::String> logisticMasterRecordId) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_LOGISTICMASTERRECORDID, logisticMasterRecordId);
  }
  void add_tpTailNumber(::flatbuffers::Offset<::flatbuffers::String> tpTailNumber) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_TPTAILNUMBER, tpTailNumber);
  }
  void add_tpAircraftMDS(::flatbuffers::Offset<::flatbuffers::String> tpAircraftMDS) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_TPAIRCRAFTMDS, tpAircraftMDS);
  }
  void add_majcom(::flatbuffers::Offset<::flatbuffers::String> majcom) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_MAJCOM, majcom);
  }
  void add_approxArrTime(::flatbuffers::Offset<::flatbuffers::String> approxArrTime) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_APPROXARRTIME, approxArrTime);
  }
  void add_duration(::flatbuffers::Offset<::flatbuffers::String> duration) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_DURATION, duration);
  }
  void add_actDepTime(::flatbuffers::Offset<::flatbuffers::String> actDepTime) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_ACTDEPTIME, actDepTime);
  }
  void add_closedDate(::flatbuffers::Offset<::flatbuffers::String> closedDate) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_CLOSEDDATE, closedDate);
  }
  void add_cancelledDate(::flatbuffers::Offset<::flatbuffers::String> cancelledDate) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_CANCELLEDDATE, cancelledDate);
  }
  void add_aircraftStatus(::flatbuffers::Offset<::flatbuffers::String> aircraftStatus) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_AIRCRAFTSTATUS, aircraftStatus);
  }
  void add_numEnrouteStops(int32_t numEnrouteStops) {
    fbb_.AddElement<int32_t>(LogisticsTransportationPlans_Ingest::VT_NUMENROUTESTOPS, numEnrouteStops, 0);
  }
  void add_serialNumber(::flatbuffers::Offset<::flatbuffers::String> serialNumber) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_SERIALNUMBER, serialNumber);
  }
  void add_numTransLoads(int32_t numTransLoads) {
    fbb_.AddElement<int32_t>(LogisticsTransportationPlans_Ingest::VT_NUMTRANSLOADS, numTransLoads, 0);
  }
  void add_lastChangedDate(::flatbuffers::Offset<::flatbuffers::String> lastChangedDate) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_LASTCHANGEDDATE, lastChangedDate);
  }
  void add_logisticsSegments(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsSegments) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_LOGISTICSSEGMENTS, logisticsSegments);
  }
  void add_logisticsTransportationPlansRemarks(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsTransportationPlansRemarks) {
    fbb_.AddOffset(LogisticsTransportationPlans_Ingest::VT_LOGISTICSTRANSPORTATIONPLANSREMARKS, logisticsTransportationPlansRemarks);
  }
  explicit LogisticsTransportationPlans_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LogisticsTransportationPlans_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LogisticsTransportationPlans_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LogisticsTransportationPlans_Ingest> CreateLogisticsTransportationPlans_Ingest(
  ...
  LogisticsTransportationPlans_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<LogisticsTransportationPlans_Ingest> CreateLogisticsTransportationPlans_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const LogisticsTransportationPlans_Ingest *GetLogisticsTransportationPlans_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<LogisticsTransportationPlans_Ingest>(buf);
}

inline const LogisticsTransportationPlans_Ingest *GetSizePrefixedLogisticsTransportationPlans_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<LogisticsTransportationPlans_Ingest>(buf);
}

inline const char *LogisticsTransportationPlans_IngestIdentifier() {
  return "LOGI";
}

inline bool LogisticsTransportationPlans_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsTransportationPlans_IngestIdentifier());
}

inline bool SizePrefixedLogisticsTransportationPlans_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsTransportationPlans_IngestIdentifier(), true);
}

inline bool VerifyLogisticsTransportationPlans_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<LogisticsTransportationPlans_Ingest>(LogisticsTransportationPlans_IngestIdentifier());
}

inline bool VerifySizePrefixedLogisticsTransportationPlans_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<LogisticsTransportationPlans_Ingest>(LogisticsTransportationPlans_IngestIdentifier());
}

inline void FinishLogisticsTransportationPlans_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsTransportationPlans_Ingest> root) {
  fbb.Finish(root, LogisticsTransportationPlans_IngestIdentifier());
}

inline void FinishSizePrefixedLogisticsTransportationPlans_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsTransportationPlans_Ingest> root) {
  fbb.FinishSizePrefixed(root, LogisticsTransportationPlans_IngestIdentifier());
}
