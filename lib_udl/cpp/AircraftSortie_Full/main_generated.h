...
struct AircraftSortie_Full;
struct AircraftSortie_FullBuilder;

enum AircraftSortie_Full_paperStatus_Enum : int8_t {
  /// No description available.
  AircraftSortie_Full_paperStatus_Enum_PUBLISHED = 0,
  /// No description available.
  AircraftSortie_Full_paperStatus_Enum_DELETED = 1,
  /// No description available.
  AircraftSortie_Full_paperStatus_Enum_UPDATED = 2,
  /// No description available.
  AircraftSortie_Full_paperStatus_Enum_READ = 3,
  AircraftSortie_Full_paperStatus_Enum_MIN = AircraftSortie_Full_paperStatus_Enum_PUBLISHED,
  AircraftSortie_Full_paperStatus_Enum_MAX = AircraftSortie_Full_paperStatus_Enum_READ
};

inline const AircraftSortie_Full_paperStatus_Enum (&EnumValuesAircraftSortie_Full_paperStatus_Enum())[4] {
  static const AircraftSortie_Full_paperStatus_Enum values[] = {
    AircraftSortie_Full_paperStatus_Enum_PUBLISHED,
    AircraftSortie_Full_paperStatus_Enum_DELETED,
    AircraftSortie_Full_paperStatus_Enum_UPDATED,
    AircraftSortie_Full_paperStatus_Enum_READ
  };
  return values;
}

inline const char * const *EnumNamesAircraftSortie_Full_paperStatus_Enum() {
...
inline const char *EnumNameAircraftSortie_Full_paperStatus_Enum(AircraftSortie_Full_paperStatus_Enum e) {
  if (::flatbuffers::IsOutRange(e, AircraftSortie_Full_paperStatus_Enum_PUBLISHED, AircraftSortie_Full_paperStatus_Enum_READ)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAircraftSortie_Full_paperStatus_Enum()[index];
}

enum AircraftSortie_Full_pprStatus_Enum : int8_t {
  /// No description available.
  AircraftSortie_Full_pprStatus_Enum_NOT_REQUIRED = 0,
  /// No description available.
  AircraftSortie_Full_pprStatus_Enum_REQUIRED_NOT_REQUESTED = 1,
  /// No description available.
  AircraftSortie_Full_pprStatus_Enum_GRANTED = 2,
  /// No description available.
  AircraftSortie_Full_pprStatus_Enum_PENDING = 3,
  AircraftSortie_Full_pprStatus_Enum_MIN = AircraftSortie_Full_pprStatus_Enum_NOT_REQUIRED,
  AircraftSortie_Full_pprStatus_Enum_MAX = AircraftSortie_Full_pprStatus_Enum_PENDING
};

inline const AircraftSortie_Full_pprStatus_Enum (&EnumValuesAircraftSortie_Full_pprStatus_Enum())[4] {
  static const AircraftSortie_Full_pprStatus_Enum values[] = {
    AircraftSortie_Full_pprStatus_Enum_NOT_REQUIRED,
    AircraftSortie_Full_pprStatus_Enum_REQUIRED_NOT_REQUESTED,
    AircraftSortie_Full_pprStatus_Enum_GRANTED,
    AircraftSortie_Full_pprStatus_Enum_PENDING
  };
  return values;
}

inline const char * const *EnumNamesAircraftSortie_Full_pprStatus_Enum() {
  static const char * const names[5] = {
    "NOT_REQUIRED",
...
inline const char *EnumNameAircraftSortie_Full_pprStatus_Enum(AircraftSortie_Full_pprStatus_Enum e) {
  if (::flatbuffers::IsOutRange(e, AircraftSortie_Full_pprStatus_Enum_NOT_REQUIRED, AircraftSortie_Full_pprStatus_Enum_PENDING)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAircraftSortie_Full_pprStatus_Enum()[index];
}

enum AircraftSortie_Full_rvnReq_Enum : int8_t {
  /// No description available.
  AircraftSortie_Full_rvnReq_Enum_N = 0,
  /// No description available.
  AircraftSortie_Full_rvnReq_Enum_R = 1,
  /// No description available.
  AircraftSortie_Full_rvnReq_Enum_C6 = 2,
  /// No description available.
  AircraftSortie_Full_rvnReq_Enum_R6 = 3,
  AircraftSortie_Full_rvnReq_Enum_MIN = AircraftSortie_Full_rvnReq_Enum_N,
  AircraftSortie_Full_rvnReq_Enum_MAX = AircraftSortie_Full_rvnReq_Enum_R6
};

inline const AircraftSortie_Full_rvnReq_Enum (&EnumValuesAircraftSortie_Full_rvnReq_Enum())[4] {
  static const AircraftSortie_Full_rvnReq_Enum values[] = {
    AircraftSortie_Full_rvnReq_Enum_N,
    AircraftSortie_Full_rvnReq_Enum_R,
    AircraftSortie_Full_rvnReq_Enum_C6,
    AircraftSortie_Full_rvnReq_Enum_R6
  };
  return values;
}

inline const char * const *EnumNamesAircraftSortie_Full_rvnReq_Enum() {
  static const char * const names[5] = {
    "N",
    "R",
    "C6",
...
inline const char *EnumNameAircraftSortie_Full_rvnReq_Enum(AircraftSortie_Full_rvnReq_Enum e) {
  if (::flatbuffers::IsOutRange(e, AircraftSortie_Full_rvnReq_Enum_N, AircraftSortie_Full_rvnReq_Enum_R6)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAircraftSortie_Full_rvnReq_Enum()[index];
}

enum AircraftSortie_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  AircraftSortie_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  AircraftSortie_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  AircraftSortie_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  AircraftSortie_Full_dataMode_Enum_EXERCISE = 3,
  AircraftSortie_Full_dataMode_Enum_MIN = AircraftSortie_Full_dataMode_Enum_REAL,
  AircraftSortie_Full_dataMode_Enum_MAX = AircraftSortie_Full_dataMode_Enum_EXERCISE
};

inline const AircraftSortie_Full_dataMode_Enum (&EnumValuesAircraftSortie_Full_dataMode_Enum())[4] {
  static const AircraftSortie_Full_dataMode_Enum values[] = {
    AircraftSortie_Full_dataMode_Enum_REAL,
    AircraftSortie_Full_dataMode_Enum_TEST,
    AircraftSortie_Full_dataMode_Enum_SIMULATED,
    AircraftSortie_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAircraftSortie_Full_dataMode_Enum() {
  static const char * const names[5] = {
    "REAL",
    "TEST",
    "SIMULATED",
...
inline const char *EnumNameAircraftSortie_Full_dataMode_Enum(AircraftSortie_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AircraftSortie_Full_dataMode_Enum_REAL, AircraftSortie_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAircraftSortie_Full_dataMode_Enum()[index];
}

/// /// Information related to the planning, load, status, and deployment or dispatch of one aircraft to carry out a mission.
struct AircraftSortie_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AircraftSortie_FullBuilder Builder;
  ...
  AircraftSortie_Full_paperStatus_Enum paperStatus() const {
    return static_cast<AircraftSortie_Full_paperStatus_Enum>(GetField<int8_t>(VT_PAPERSTATUS, 0));
  }
  /// The prior permission required (PPR) status.
  /// Example: /// Example: PENDING
  /// Constraints: Minimum length = 0, Maximum length = 22
  AircraftSortie_Full_pprStatus_Enum pprStatus() const {
    return static_cast<AircraftSortie_Full_pprStatus_Enum>(GetField<int8_t>(VT_PPRSTATUS, 0));
  }
  ...
  AircraftSortie_Full_rvnReq_Enum rvnReq() const {
    return static_cast<AircraftSortie_Full_rvnReq_Enum>(GetField<int8_t>(VT_RVNREQ, 0));
  }
  ...
  AircraftSortie_Full_dataMode_Enum dataMode() const {
    return static_cast<AircraftSortie_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
  ...
  /// Constraints: No constraints specified.
  const ::flatbuffers::String *crew() const {
    return GetPointer<const ::flatbuffers::String *>(VT_CREW);
  }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *sortiePPR() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_SORTIEPPR);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.VerifyString(crew()) &&
           VerifyOffset(verifier, VT_SORTIEPPR) &&
           verifier.VerifyVector(sortiePPR()) &&
           verifier.VerifyVectorOfStrings(sortiePPR()) &&
           verifier.EndTable();
  }
};

struct AircraftSortie_FullBuilder {
  typedef AircraftSortie_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AircraftSortie_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_origSortieId(::flatbuffers::Offset<::flatbuffers::String> origSortieId) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ORIGSORTIEID, origSortieId);
  }
  void add_idAircraft(::flatbuffers::Offset<::flatbuffers::String> idAircraft) {
    fbb_.AddOffset(AircraftSortie_Full::VT_IDAIRCRAFT, idAircraft);
  }
  void add_aircraftAltId(::flatbuffers::Offset<::flatbuffers::String> aircraftAltId) {
    fbb_.AddOffset(AircraftSortie_Full::VT_AIRCRAFTALTID, aircraftAltId);
  }
  void add_tailNumber(::flatbuffers::Offset<::flatbuffers::String> tailNumber) {
    fbb_.AddOffset(AircraftSortie_Full::VT_TAILNUMBER, tailNumber);
  }
  void add_aircraftMDS(::flatbuffers::Offset<::flatbuffers::String> aircraftMDS) {
    fbb_.AddOffset(AircraftSortie_Full::VT_AIRCRAFTMDS, aircraftMDS);
  }
  void add_aircraftADSB(::flatbuffers::Offset<::flatbuffers::String> aircraftADSB) {
    fbb_.AddOffset(AircraftSortie_Full::VT_AIRCRAFTADSB, aircraftADSB);
  }
  void add_sortieDate(::flatbuffers::Offset<::flatbuffers::String> sortieDate) {
    fbb_.AddOffset(AircraftSortie_Full::VT_SORTIEDATE, sortieDate);
  }
  void add_lineNumber(int32_t lineNumber) {
    fbb_.AddElement<int32_t>(AircraftSortie_Full::VT_LINENUMBER, lineNumber, 0);
  }
  void add_idMission(::flatbuffers::Offset<::flatbuffers::String> idMission) {
    fbb_.AddOffset(AircraftSortie_Full::VT_IDMISSION, idMission);
  }
  void add_missionId(::flatbuffers::Offset<::flatbuffers::String> missionId) {
    fbb_.AddOffset(AircraftSortie_Full::VT_MISSIONID, missionId);
  }
  void add_amcMsnNum(::flatbuffers::Offset<::flatbuffers::String> amcMsnNum) {
    fbb_.AddOffset(AircraftSortie_Full::VT_AMCMSNNUM, amcMsnNum);
  }
  void add_amcMsnType(::flatbuffers::Offset<::flatbuffers::String> amcMsnType) {
    fbb_.AddOffset(AircraftSortie_Full::VT_AMCMSNTYPE, amcMsnType);
  }
  void add_callSign(::flatbuffers::Offset<::flatbuffers::String> callSign) {
    fbb_.AddOffset(AircraftSortie_Full::VT_CALLSIGN, callSign);
  }
  void add_jcsPriority(::flatbuffers::Offset<::flatbuffers::String> jcsPriority) {
    fbb_.AddOffset(AircraftSortie_Full::VT_JCSPRIORITY, jcsPriority);
  }
  void add_primarySCL(::flatbuffers::Offset<::flatbuffers::String> primarySCL) {
    fbb_.AddOffset(AircraftSortie_Full::VT_PRIMARYSCL, primarySCL);
  }
  void add_secondarySCL(::flatbuffers::Offset<::flatbuffers::String> secondarySCL) {
    fbb_.AddOffset(AircraftSortie_Full::VT_SECONDARYSCL, secondarySCL);
  }
  void add_reqConfig(::flatbuffers::Offset<::flatbuffers::String> reqConfig) {
    fbb_.AddOffset(AircraftSortie_Full::VT_REQCONFIG, reqConfig);
  }
  void add_cargoConfig(::flatbuffers::Offset<::flatbuffers::String> cargoConfig) {
    fbb_.AddOffset(AircraftSortie_Full::VT_CARGOCONFIG, cargoConfig);
  }
  void add_fuelReq(double fuelReq) {
    fbb_.AddElement<double>(AircraftSortie_Full::VT_FUELREQ, fuelReq, 0.0);
  }
  void add_oxyReqCrew(double oxyReqCrew) {
    fbb_.AddElement<double>(AircraftSortie_Full::VT_OXYREQCREW, oxyReqCrew, 0.0);
  }
  void add_oxyOnCrew(double oxyOnCrew) {
    fbb_.AddElement<double>(AircraftSortie_Full::VT_OXYONCREW, oxyOnCrew, 0.0);
  }
  void add_oxyReqPax(double oxyReqPax) {
    fbb_.AddElement<double>(AircraftSortie_Full::VT_OXYREQPAX, oxyReqPax, 0.0);
  }
  void add_oxyOnPax(double oxyOnPax) {
    fbb_.AddElement<double>(AircraftSortie_Full::VT_OXYONPAX, oxyOnPax, 0.0);
  }
  void add_alertStatusCode(::flatbuffers::Offset<::flatbuffers::String> alertStatusCode) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ALERTSTATUSCODE, alertStatusCode);
  }
  void add_alertStatus(int32_t alertStatus) {
    fbb_.AddElement<int32_t>(AircraftSortie_Full::VT_ALERTSTATUS, alertStatus, 0);
  }
  void add_currentState(::flatbuffers::Offset<::flatbuffers::String> currentState) {
    fbb_.AddOffset(AircraftSortie_Full::VT_CURRENTSTATE, currentState);
  }
  void add_depItinerary(int32_t depItinerary) {
    fbb_.AddElement<int32_t>(AircraftSortie_Full::VT_DEPITINERARY, depItinerary, 0);
  }
  void add_depICAO(::flatbuffers::Offset<::flatbuffers::String> depICAO) {
    fbb_.AddOffset(AircraftSortie_Full::VT_DEPICAO, depICAO);
  }
  void add_depIATA(::flatbuffers::Offset<::flatbuffers::String> depIATA) {
    fbb_.AddOffset(AircraftSortie_Full::VT_DEPIATA, depIATA);
  }
  void add_depFAA(::flatbuffers::Offset<::flatbuffers::String> depFAA) {
    fbb_.AddOffset(AircraftSortie_Full::VT_DEPFAA, depFAA);
  }
  void add_plannedDepTime(::flatbuffers::Offset<::flatbuffers::String> plannedDepTime) {
    fbb_.AddOffset(AircraftSortie_Full::VT_PLANNEDDEPTIME, plannedDepTime);
  }
  void add_estDepTime(::flatbuffers::Offset<::flatbuffers::String> estDepTime) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ESTDEPTIME, estDepTime);
  }
  void add_actualDepTime(::flatbuffers::Offset<::flatbuffers::String> actualDepTime) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ACTUALDEPTIME, actualDepTime);
  }
  void add_estBlockOutTime(::flatbuffers::Offset<::flatbuffers::String> estBlockOutTime) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ESTBLOCKOUTTIME, estBlockOutTime);
  }
  void add_actualBlockOutTime(::flatbuffers::Offset<::flatbuffers::String> actualBlockOutTime) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ACTUALBLOCKOUTTIME, actualBlockOutTime);
  }
  void add_depPurposeCode(::flatbuffers::Offset<::flatbuffers::String> depPurposeCode) {
    fbb_.AddOffset(AircraftSortie_Full::VT_DEPPURPOSECODE, depPurposeCode);
  }
  void add_arrItinerary(int32_t arrItinerary) {
    fbb_.AddElement<int32_t>(AircraftSortie_Full::VT_ARRITINERARY, arrItinerary, 0);
  }
  void add_arrICAO(::flatbuffers::Offset<::flatbuffers::String> arrICAO) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ARRICAO, arrICAO);
  }
  void add_arrIATA(::flatbuffers::Offset<::flatbuffers::String> arrIATA) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ARRIATA, arrIATA);
  }
  void add_arrFAA(::flatbuffers::Offset<::flatbuffers::String> arrFAA) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ARRFAA, arrFAA);
  }
  void add_plannedArrTime(::flatbuffers::Offset<::flatbuffers::String> plannedArrTime) {
    fbb_.AddOffset(AircraftSortie_Full::VT_PLANNEDARRTIME, plannedArrTime);
  }
  void add_estArrTime(::flatbuffers::Offset<::flatbuffers::String> estArrTime) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ESTARRTIME, estArrTime);
  }
  void add_actualArrTime(::flatbuffers::Offset<::flatbuffers::String> actualArrTime) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ACTUALARRTIME, actualArrTime);
  }
  void add_estBlockInTime(::flatbuffers::Offset<::flatbuffers::String> estBlockInTime) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ESTBLOCKINTIME, estBlockInTime);
  }
  void add_actualBlockInTime(::flatbuffers::Offset<::flatbuffers::String> actualBlockInTime) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ACTUALBLOCKINTIME, actualBlockInTime);
  }
  void add_arrPurposeCode(::flatbuffers::Offset<::flatbuffers::String> arrPurposeCode) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ARRPURPOSECODE, arrPurposeCode);
  }
  void add_dhd(::flatbuffers::Offset<::flatbuffers::String> dhd) {
    fbb_.AddOffset(AircraftSortie_Full::VT_DHD, dhd);
  }
  void add_dhdReason(::flatbuffers::Offset<::flatbuffers::String> dhdReason) {
    fbb_.AddOffset(AircraftSortie_Full::VT_DHDREASON, dhdReason);
  }
  void add_aircraftEvent(::flatbuffers::Offset<::flatbuffers::String> aircraftEvent) {
    fbb_.AddOffset(AircraftSortie_Full::VT_AIRCRAFTEVENT, aircraftEvent);
  }
  void add_soe(::flatbuffers::Offset<::flatbuffers::String> soe) {
    fbb_.AddOffset(AircraftSortie_Full::VT_SOE, soe);
  }
  void add_legNum(int32_t legNum) {
    fbb_.AddElement<int32_t>(AircraftSortie_Full::VT_LEGNUM, legNum, 0);
  }
  void add_flightTime(double flightTime) {
    fbb_.AddElement<double>(AircraftSortie_Full::VT_FLIGHTTIME, flightTime, 0.0);
  }
  void add_gndTime(double gndTime) {
    fbb_.AddElement<double>(AircraftSortie_Full::VT_GNDTIME, gndTime, 0.0);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(AircraftSortie_Full::VT_RAWFILEURI, rawFileURI);
  }
  void add_papersVersion(::flatbuffers::Offset<::flatbuffers::String> papersVersion) {
    fbb_.AddOffset(AircraftSortie_Full::VT_PAPERSVERSION, papersVersion);
  }
  void add_filename(::flatbuffers::Offset<::flatbuffers::String> filename) {
    fbb_.AddOffset(AircraftSortie_Full::VT_FILENAME, filename);
  }
  void add_filesize(int32_t filesize) {
    fbb_.AddElement<int32_t>(AircraftSortie_Full::VT_FILESIZE, filesize, 0);
  }
  void add_paperStatus(AircraftSortie_Full_paperStatus_Enum paperStatus) {
    fbb_.AddElement<int8_t>(AircraftSortie_Full::VT_PAPERSTATUS, static_cast<int8_t>(paperStatus), 0);
  }
  void add_pprStatus(AircraftSortie_Full_pprStatus_Enum pprStatus) {
    fbb_.AddElement<int8_t>(AircraftSortie_Full::VT_PPRSTATUS, static_cast<int8_t>(pprStatus), 0);
  }
  void add_missionUpdate(::flatbuffers::Offset<::flatbuffers::String> missionUpdate) {
    fbb_.AddOffset(AircraftSortie_Full::VT_MISSIONUPDATE, missionUpdate);
  }
  void add_delayCode(::flatbuffers::Offset<::flatbuffers::String> delayCode) {
    fbb_.AddOffset(AircraftSortie_Full::VT_DELAYCODE, delayCode);
  }
  void add_commanderName(::flatbuffers::Offset<::flatbuffers::String> commanderName) {
    fbb_.AddOffset(AircraftSortie_Full::VT_COMMANDERNAME, commanderName);
  }
  void add_fmDeskNum(::flatbuffers::Offset<::flatbuffers::String> fmDeskNum) {
    fbb_.AddOffset(AircraftSortie_Full::VT_FMDESKNUM, fmDeskNum);
  }
  void add_fmName(::flatbuffers::Offset<::flatbuffers::String> fmName) {
    fbb_.AddOffset(AircraftSortie_Full::VT_FMNAME, fmName);
  }
  void add_rvnReq(AircraftSortie_Full_rvnReq_Enum rvnReq) {
    fbb_.AddElement<int8_t>(AircraftSortie_Full::VT_RVNREQ, static_cast<int8_t>(rvnReq), 0);
  }
  void add_passengers(int32_t passengers) {
    fbb_.AddElement<int32_t>(AircraftSortie_Full::VT_PASSENGERS, passengers, 0);
  }
  void add_parkingLoc(::flatbuffers::Offset<::flatbuffers::String> parkingLoc) {
    fbb_.AddOffset(AircraftSortie_Full::VT_PARKINGLOC, parkingLoc);
  }
  void add_objectiveRemarks(::flatbuffers::Offset<::flatbuffers::String> objectiveRemarks) {
    fbb_.AddOffset(AircraftSortie_Full::VT_OBJECTIVEREMARKS, objectiveRemarks);
  }
  void add_aircraftRemarks(::flatbuffers::Offset<::flatbuffers::String> aircraftRemarks) {
    fbb_.AddOffset(AircraftSortie_Full::VT_AIRCRAFTREMARKS, aircraftRemarks);
  }
  void add_scheduleRemarks(::flatbuffers::Offset<::flatbuffers::String> scheduleRemarks) {
    fbb_.AddOffset(AircraftSortie_Full::VT_SCHEDULEREMARKS, scheduleRemarks);
  }
  void add_resultRemarks(::flatbuffers::Offset<::flatbuffers::String> resultRemarks) {
    fbb_.AddOffset(AircraftSortie_Full::VT_RESULTREMARKS, resultRemarks);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AircraftSortie_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AircraftSortie_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(AircraftSortie_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(AircraftSortie_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(AircraftSortie_Full::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AircraftSortie_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(AircraftSortie_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AircraftSortie_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AircraftSortie_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_crew(::flatbuffers::Offset<::flatbuffers::String> crew) {
    fbb_.AddOffset(AircraftSortie_Full::VT_CREW, crew);
  }
  void add_sortiePPR(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sortiePPR) {
    fbb_.AddOffset(AircraftSortie_Full::VT_SORTIEPPR, sortiePPR);
  }
  explicit AircraftSortie_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AircraftSortie_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AircraftSortie_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AircraftSortie_Full> CreateAircraftSortie_Full(
    ...
    int32_t filesize = 0,
    AircraftSortie_Full_paperStatus_Enum paperStatus = AircraftSortie_Full_paperStatus_Enum_PUBLISHED,
    AircraftSortie_Full_pprStatus_Enum pprStatus = AircraftSortie_Full_pprStatus_Enum_NOT_REQUIRED,
    ...
    AircraftSortie_Full_rvnReq_Enum rvnReq = AircraftSortie_Full_rvnReq_Enum_N,
    ...
    AircraftSortie_Full_dataMode_Enum dataMode = AircraftSortie_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0,
    ::flatbuffers::Offset<::flatbuffers::String> crew = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sortiePPR = 0) {
  AircraftSortie_FullBuilder builder_(_fbb);
  ...
  builder_.add_sortiePPR(sortiePPR);
...
inline ::flatbuffers::Offset<AircraftSortie_Full> CreateAircraftSortie_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ...
    const char *crew = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *sortiePPR = nullptr) {
  ...
  auto crew__ = crew ? _fbb.CreateString(crew) : 0;
  auto sortiePPR__ = sortiePPR ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*sortiePPR) : 0;
  return CreateAircraftSortie_Full(
      _fbb,
      id__,
...
inline const AircraftSortie_Full *GetAircraftSortie_Full(const void *buf) {
  return ::flatbuffers::GetRoot<AircraftSortie_Full>(buf);
}

inline const AircraftSortie_Full *GetSizePrefixedAircraftSortie_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AircraftSortie_Full>(buf);
}

inline const char *AircraftSortie_FullIdentifier() {
  return "AIRC";
}

inline bool AircraftSortie_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftSortie_FullIdentifier());
}

inline bool SizePrefixedAircraftSortie_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftSortie_FullIdentifier(), true);
}

inline bool VerifyAircraftSortie_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AircraftSortie_Full>(AircraftSortie_FullIdentifier());
}

inline bool VerifySizePrefixedAircraftSortie_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AircraftSortie_Full>(AircraftSortie_FullIdentifier());
}

inline void FinishAircraftSortie_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftSortie_Full> root) {
  fbb.Finish(root, AircraftSortie_FullIdentifier());
}

inline void FinishSizePrefixedAircraftSortie_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftSortie_Full> root) {
  fbb.FinishSizePrefixed(root, AircraftSortie_FullIdentifier());
}
