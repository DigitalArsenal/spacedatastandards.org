...
struct EngineDetails_Ingest;
struct EngineDetails_IngestBuilder;

enum EngineDetails_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  EngineDetails_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  EngineDetails_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  EngineDetails_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  EngineDetails_Ingest_dataMode_Enum_EXERCISE = 3,
  EngineDetails_Ingest_dataMode_Enum_MIN = EngineDetails_Ingest_dataMode_Enum_REAL,
  EngineDetails_Ingest_dataMode_Enum_MAX = EngineDetails_Ingest_dataMode_Enum_EXERCISE
};

inline const EngineDetails_Ingest_dataMode_Enum (&EnumValuesEngineDetails_Ingest_dataMode_Enum())[4] {
  static const EngineDetails_Ingest_dataMode_Enum values[] = {
    EngineDetails_Ingest_dataMode_Enum_REAL,
    EngineDetails_Ingest_dataMode_Enum_TEST,
    EngineDetails_Ingest_dataMode_Enum_SIMULATED,
    EngineDetails_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesEngineDetails_Ingest_dataMode_Enum() {
...
inline const char *EnumNameEngineDetails_Ingest_dataMode_Enum(EngineDetails_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, EngineDetails_Ingest_dataMode_Enum_REAL, EngineDetails_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEngineDetails_Ingest_dataMode_Enum()[index];
}
...
struct EngineDetails_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EngineDetails_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  EngineDetails_Ingest_dataMode_Enum dataMode() const {
    return static_cast<EngineDetails_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct EngineDetails_IngestBuilder {
  typedef EngineDetails_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(EngineDetails_Ingest::VT_ID, id);
  }
  void add_idEngine(::flatbuffers::Offset<::flatbuffers::String> idEngine) {
    fbb_.AddOffset(EngineDetails_Ingest::VT_IDENGINE, idEngine);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(EngineDetails_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_family(::flatbuffers::Offset<::flatbuffers::String> family) {
    fbb_.AddOffset(EngineDetails_Ingest::VT_FAMILY, family);
  }
  void add_cycleType(::flatbuffers::Offset<::flatbuffers::String> cycleType) {
    fbb_.AddOffset(EngineDetails_Ingest::VT_CYCLETYPE, cycleType);
  }
  void add_characteristicType(::flatbuffers::Offset<::flatbuffers::String> characteristicType) {
    fbb_.AddOffset(EngineDetails_Ingest::VT_CHARACTERISTICTYPE, characteristicType);
  }
  void add_manufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrgId) {
    fbb_.AddOffset(EngineDetails_Ingest::VT_MANUFACTURERORGID, manufacturerOrgId);
  }
  void add_specificImpulse(double specificImpulse) {
    fbb_.AddElement<double>(EngineDetails_Ingest::VT_SPECIFICIMPULSE, specificImpulse, 0.0);
  }
  void add_burnTime(double burnTime) {
    fbb_.AddElement<double>(EngineDetails_Ingest::VT_BURNTIME, burnTime, 0.0);
  }
  void add_seaLevelThrust(double seaLevelThrust) {
    fbb_.AddElement<double>(EngineDetails_Ingest::VT_SEALEVELTHRUST, seaLevelThrust, 0.0);
  }
  void add_vacuumThrust(double vacuumThrust) {
    fbb_.AddElement<double>(EngineDetails_Ingest::VT_VACUUMTHRUST, vacuumThrust, 0.0);
  }
  void add_chamberPressure(double chamberPressure) {
    fbb_.AddElement<double>(EngineDetails_Ingest::VT_CHAMBERPRESSURE, chamberPressure, 0.0);
  }
  void add_nozzleExpansionRatio(double nozzleExpansionRatio) {
    fbb_.AddElement<double>(EngineDetails_Ingest::VT_NOZZLEEXPANSIONRATIO, nozzleExpansionRatio, 0.0);
  }
  void add_maxFirings(int32_t maxFirings) {
    fbb_.AddElement<int32_t>(EngineDetails_Ingest::VT_MAXFIRINGS, maxFirings, 0);
  }
  void add_propellant(::flatbuffers::Offset<::flatbuffers::String> propellant) {
    fbb_.AddOffset(EngineDetails_Ingest::VT_PROPELLANT, propellant);
  }
  void add_oxidizer(::flatbuffers::Offset<::flatbuffers::String> oxidizer) {
    fbb_.AddOffset(EngineDetails_Ingest::VT_OXIDIZER, oxidizer);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(EngineDetails_Ingest::VT_NOTES, notes);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(EngineDetails_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(EngineDetails_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(EngineDetails_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(EngineDetails_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(EngineDetails_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(EngineDetails_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(EngineDetails_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(EngineDetails_Ingest::VT_TAGS, tags);
  }
  explicit EngineDetails_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<EngineDetails_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<EngineDetails_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<EngineDetails_Ingest> CreateEngineDetails_Ingest(
    ...
    EngineDetails_Ingest_dataMode_Enum dataMode = EngineDetails_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags = 0) {
  EngineDetails_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<EngineDetails_Ingest> CreateEngineDetails_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const EngineDetails_Ingest *GetEngineDetails_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<EngineDetails_Ingest>(buf);
}

inline const EngineDetails_Ingest *GetSizePrefixedEngineDetails_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EngineDetails_Ingest>(buf);
}

inline const char *EngineDetails_IngestIdentifier() {
  return "ENGI";
}

inline bool EngineDetails_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EngineDetails_IngestIdentifier());
}

inline bool SizePrefixedEngineDetails_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EngineDetails_IngestIdentifier(), true);
}

inline bool VerifyEngineDetails_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EngineDetails_Ingest>(EngineDetails_IngestIdentifier());
}

inline bool VerifySizePrefixedEngineDetails_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EngineDetails_Ingest>(EngineDetails_IngestIdentifier());
}

inline void FinishEngineDetails_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EngineDetails_Ingest> root) {
  fbb.Finish(root, EngineDetails_IngestIdentifier());
}

inline void FinishSizePrefixedEngineDetails_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EngineDetails_Ingest> root) {
  fbb.FinishSizePrefixed(root, EngineDetails_IngestIdentifier());
}
