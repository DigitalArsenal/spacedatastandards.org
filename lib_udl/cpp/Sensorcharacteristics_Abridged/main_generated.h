...
struct Sensorcharacteristics_Abridged;
struct Sensorcharacteristics_AbridgedBuilder;

enum Sensorcharacteristics_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Sensorcharacteristics_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Sensorcharacteristics_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Sensorcharacteristics_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Sensorcharacteristics_Abridged_dataMode_Enum_EXERCISE = 3,
  Sensorcharacteristics_Abridged_dataMode_Enum_MIN = Sensorcharacteristics_Abridged_dataMode_Enum_REAL,
  Sensorcharacteristics_Abridged_dataMode_Enum_MAX = Sensorcharacteristics_Abridged_dataMode_Enum_EXERCISE
};

inline const Sensorcharacteristics_Abridged_dataMode_Enum (&EnumValuesSensorcharacteristics_Abridged_dataMode_Enum())[4] {
  static const Sensorcharacteristics_Abridged_dataMode_Enum values[] = {
    Sensorcharacteristics_Abridged_dataMode_Enum_REAL,
    Sensorcharacteristics_Abridged_dataMode_Enum_TEST,
    Sensorcharacteristics_Abridged_dataMode_Enum_SIMULATED,
    Sensorcharacteristics_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSensorcharacteristics_Abridged_dataMode_Enum() {
...
inline const char *EnumNameSensorcharacteristics_Abridged_dataMode_Enum(Sensorcharacteristics_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Sensorcharacteristics_Abridged_dataMode_Enum_REAL, Sensorcharacteristics_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSensorcharacteristics_Abridged_dataMode_Enum()[index];
}

/// /// Model representation of characteristics and capabilities of a sensor.
struct Sensorcharacteristics_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Sensorcharacteristics_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Sensorcharacteristics_Abridged_dataMode_Enum dataMode() const {
    return static_cast<Sensorcharacteristics_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Sensorcharacteristics_AbridgedBuilder {
  typedef Sensorcharacteristics_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Sensorcharacteristics_Abridged::VT_ID, id);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(Sensorcharacteristics_Abridged::VT_IDSENSOR, idSensor);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Sensorcharacteristics_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Sensorcharacteristics_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_azimuthRate(double azimuthRate) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_AZIMUTHRATE, azimuthRate, 0.0);
  }
  void add_elevationRateGeolm(double elevationRateGeolm) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_ELEVATIONRATEGEOLM, elevationRateGeolm, 0.0);
  }
  void add_minRangeLimit(double minRangeLimit) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_MINRANGELIMIT, minRangeLimit, 0.0);
  }
  void add_maxRangeLimit(double maxRangeLimit) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_MAXRANGELIMIT, maxRangeLimit, 0.0);
  }
  void add_leftClockAngle(double leftClockAngle) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_LEFTCLOCKANGLE, leftClockAngle, 0.0);
  }
  void add_rightClockAngle(double rightClockAngle) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_RIGHTCLOCKANGLE, rightClockAngle, 0.0);
  }
  void add_boresight(double boresight) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_BORESIGHT, boresight, 0.0);
  }
  void add_boresightOffAngle(double boresightOffAngle) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_BORESIGHTOFFANGLE, boresightOffAngle, 0.0);
  }
  void add_negativeRangeRateLimit(double negativeRangeRateLimit) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_NEGATIVERANGERATELIMIT, negativeRangeRateLimit, 0.0);
  }
  void add_positiveRangeRateLimit(double positiveRangeRateLimit) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_POSITIVERANGERATELIMIT, positiveRangeRateLimit, 0.0);
  }
  void add_magnitudeLimit(double magnitudeLimit) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_MAGNITUDELIMIT, magnitudeLimit, 0.0);
  }
  void add_trackAngle(double trackAngle) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_TRACKANGLE, trackAngle, 0.0);
  }
  void add_minSignalNoiseRatio(double minSignalNoiseRatio) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_MINSIGNALNOISERATIO, minSignalNoiseRatio, 0.0);
  }
  void add_fanBeamWidth(double fanBeamWidth) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_FANBEAMWIDTH, fanBeamWidth, 0.0);
  }
  void add_taskableRange(double taskableRange) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_TASKABLERANGE, taskableRange, 0.0);
  }
  void add_maxObservableRange(double maxObservableRange) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_MAXOBSERVABLERANGE, maxObservableRange, 0.0);
  }
  void add_radioFrequency(double radioFrequency) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_RADIOFREQUENCY, radioFrequency, 0.0);
  }
  void add_radarFrequency(double radarFrequency) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_RADARFREQUENCY, radarFrequency, 0.0);
  }
  void add_transmitPower(double transmitPower) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_TRANSMITPOWER, transmitPower, 0.0);
  }
  void add_hFOV(double hFOV) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_HFOV, hFOV, 0.0);
  }
  void add_vFOV(double vFOV) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_VFOV, vFOV, 0.0);
  }
  void add_hResPixels(int32_t hResPixels) {
    fbb_.AddElement<int32_t>(Sensorcharacteristics_Abridged::VT_HRESPIXELS, hResPixels, 0);
  }
  void add_vResPixels(int32_t vResPixels) {
    fbb_.AddElement<int32_t>(Sensorcharacteristics_Abridged::VT_VRESPIXELS, vResPixels, 0);
  }
  void add_band(::flatbuffers::Offset<::flatbuffers::String> band) {
    fbb_.AddOffset(Sensorcharacteristics_Abridged::VT_BAND, band);
  }
  void add_maxDeviationAngle(double maxDeviationAngle) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_MAXDEVIATIONANGLE, maxDeviationAngle, 0.0);
  }
  void add_aperture(double aperture) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_APERTURE, aperture, 0.0);
  }
  void add_leftGeoBeltLimit(double leftGeoBeltLimit) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_LEFTGEOBELTLIMIT, leftGeoBeltLimit, 0.0);
  }
  void add_rightGeoBeltLimit(double rightGeoBeltLimit) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_RIGHTGEOBELTLIMIT, rightGeoBeltLimit, 0.0);
  }
  void add_asrScanRate(double asrScanRate) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_ASRSCANRATE, asrScanRate, 0.0);
  }
  void add_k(double k) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_K, k, 0.0);
  }
  void add_focalPoint(double focalPoint) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_FOCALPOINT, focalPoint, 0.0);
  }
  void add_towerHeight(double towerHeight) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_TOWERHEIGHT, towerHeight, 0.0);
  }
  void add_trueNorthCorrector(int32_t trueNorthCorrector) {
    fbb_.AddElement<int32_t>(Sensorcharacteristics_Abridged::VT_TRUENORTHCORRECTOR, trueNorthCorrector, 0);
  }
  void add_magDec(double magDec) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_MAGDEC, magDec, 0.0);
  }
  void add_z1MinRange(double z1MinRange) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_Z1MINRANGE, z1MinRange, 0.0);
  }
  void add_z2MinRange(double z2MinRange) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_Z2MINRANGE, z2MinRange, 0.0);
  }
  void add_z1MaxRange(double z1MaxRange) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_Z1MAXRANGE, z1MaxRange, 0.0);
  }
  void add_z2MaxRange(double z2MaxRange) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_Z2MAXRANGE, z2MaxRange, 0.0);
  }
  void add_radarMUR(double radarMUR) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_RADARMUR, radarMUR, 0.0);
  }
  void add_probFalseAlarm(double probFalseAlarm) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_PROBFALSEALARM, probFalseAlarm, 0.0);
  }
  void add_prf(double prf) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_PRF, prf, 0.0);
  }
  void add_radarPulseWidth(double radarPulseWidth) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_RADARPULSEWIDTH, radarPulseWidth, 0.0);
  }
  void add_numIntegratedPulses(int32_t numIntegratedPulses) {
    fbb_.AddElement<int32_t>(Sensorcharacteristics_Abridged::VT_NUMINTEGRATEDPULSES, numIntegratedPulses, 0);
  }
  void add_trueTilt(double trueTilt) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_TRUETILT, trueTilt, 0.0);
  }
  void add_radarMessageFormat(::flatbuffers::Offset<::flatbuffers::String> radarMessageFormat) {
    fbb_.AddOffset(Sensorcharacteristics_Abridged::VT_RADARMESSAGEFORMAT, radarMessageFormat);
  }
  void add_systemNoiseTemperature(double systemNoiseTemperature) {
    fbb_.AddElement<double>(Sensorcharacteristics_Abridged::VT_SYSTEMNOISETEMPERATURE, systemNoiseTemperature, 0.0);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Sensorcharacteristics_Abridged::VT_SOURCE, source);
  }
  void add_dataMode(Sensorcharacteristics_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Sensorcharacteristics_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Sensorcharacteristics_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Sensorcharacteristics_Abridged::VT_CREATEDBY, createdBy);
  }
  explicit Sensorcharacteristics_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Sensorcharacteristics_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Sensorcharacteristics_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Sensorcharacteristics_Abridged> CreateSensorcharacteristics_Abridged(
    ...
    Sensorcharacteristics_Abridged_dataMode_Enum dataMode = Sensorcharacteristics_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0) {
  Sensorcharacteristics_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Sensorcharacteristics_Abridged> CreateSensorcharacteristics_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Sensorcharacteristics_Abridged *GetSensorcharacteristics_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<Sensorcharacteristics_Abridged>(buf);
}

inline const Sensorcharacteristics_Abridged *GetSizePrefixedSensorcharacteristics_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Sensorcharacteristics_Abridged>(buf);
}

inline const char *Sensorcharacteristics_AbridgedIdentifier() {
  return "SENS";
}

inline bool Sensorcharacteristics_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Sensorcharacteristics_AbridgedIdentifier());
}

inline bool SizePrefixedSensorcharacteristics_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Sensorcharacteristics_AbridgedIdentifier(), true);
}

inline bool VerifySensorcharacteristics_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Sensorcharacteristics_Abridged>(Sensorcharacteristics_AbridgedIdentifier());
}

inline bool VerifySizePrefixedSensorcharacteristics_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Sensorcharacteristics_Abridged>(Sensorcharacteristics_AbridgedIdentifier());
}

inline void FinishSensorcharacteristics_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Sensorcharacteristics_Abridged> root) {
  fbb.Finish(root, Sensorcharacteristics_AbridgedIdentifier());
}

inline void FinishSizePrefixedSensorcharacteristics_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Sensorcharacteristics_Abridged> root) {
  fbb.FinishSizePrefixed(root, Sensorcharacteristics_AbridgedIdentifier());
}
