...
struct Ephemeris_Ingest;
struct Ephemeris_IngestBuilder;

enum Ephemeris_Ingest_dataMode_Enum : int8_t {
  ...
  Ephemeris_Ingest_dataMode_Enum_MIN = Ephemeris_Ingest_dataMode_Enum_REAL,
  Ephemeris_Ingest_dataMode_Enum_MAX = Ephemeris_Ingest_dataMode_Enum_EXERCISE
};

inline const Ephemeris_Ingest_dataMode_Enum (&EnumValuesEphemeris_Ingest_dataMode_Enum())[4] {
  static const Ephemeris_Ingest_dataMode_Enum values[] = {
    Ephemeris_Ingest_dataMode_Enum_REAL,
    Ephemeris_Ingest_dataMode_Enum_TEST,
    Ephemeris_Ingest_dataMode_Enum_SIMULATED,
    Ephemeris_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesEphemeris_Ingest_dataMode_Enum() {
...
inline const char *EnumNameEphemeris_Ingest_dataMode_Enum(Ephemeris_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Ephemeris_Ingest_dataMode_Enum_REAL, Ephemeris_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEphemeris_Ingest_dataMode_Enum()[index];
}
...
struct Ephemeris_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Ephemeris_IngestBuilder Builder;
  ...
  Ephemeris_Ingest_dataMode_Enum dataMode() const {
    return static_cast<Ephemeris_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Ephemeris_IngestBuilder {
  typedef Ephemeris_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Ephemeris_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Ephemeris_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_esId(::flatbuffers::Offset<::flatbuffers::String> esId) {
    fbb_.AddOffset(Ephemeris_Ingest::VT_ESID, esId);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::String> ts) {
    fbb_.AddOffset(Ephemeris_Ingest::VT_TS, ts);
  }
  void add_xpos(double xpos) {
    fbb_.AddElement<double>(Ephemeris_Ingest::VT_XPOS, xpos, 0.0);
  }
  void add_ypos(double ypos) {
    fbb_.AddElement<double>(Ephemeris_Ingest::VT_YPOS, ypos, 0.0);
  }
  void add_zpos(double zpos) {
    fbb_.AddElement<double>(Ephemeris_Ingest::VT_ZPOS, zpos, 0.0);
  }
  void add_xvel(double xvel) {
    fbb_.AddElement<double>(Ephemeris_Ingest::VT_XVEL, xvel, 0.0);
  }
  void add_yvel(double yvel) {
    fbb_.AddElement<double>(Ephemeris_Ingest::VT_YVEL, yvel, 0.0);
  }
  void add_zvel(double zvel) {
    fbb_.AddElement<double>(Ephemeris_Ingest::VT_ZVEL, zvel, 0.0);
  }
  void add_xaccel(double xaccel) {
    fbb_.AddElement<double>(Ephemeris_Ingest::VT_XACCEL, xaccel, 0.0);
  }
  void add_yaccel(double yaccel) {
    fbb_.AddElement<double>(Ephemeris_Ingest::VT_YACCEL, yaccel, 0.0);
  }
  void add_zaccel(double zaccel) {
    fbb_.AddElement<double>(Ephemeris_Ingest::VT_ZACCEL, zaccel, 0.0);
  }
  void add_cov(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> cov) {
    fbb_.AddOffset(Ephemeris_Ingest::VT_COV, cov);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Ephemeris_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Ephemeris_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Ephemeris_Ingest::VT_SOURCE, source);
  }
  void add_dataMode(Ephemeris_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Ephemeris_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(Ephemeris_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(Ephemeris_Ingest::VT_ORIGOBJECTID, origObjectId);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Ephemeris_Ingest::VT_ORIGIN, origin);
  }
  explicit Ephemeris_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Ephemeris_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Ephemeris_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Ephemeris_Ingest> CreateEphemeris_Ingest(
    ...
    Ephemeris_Ingest_dataMode_Enum dataMode = Ephemeris_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> idOnOrbit = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origObjectId = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origin = 0) {
  Ephemeris_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Ephemeris_Ingest> CreateEphemeris_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Ephemeris_Ingest *GetEphemeris_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<Ephemeris_Ingest>(buf);
}

inline const Ephemeris_Ingest *GetSizePrefixedEphemeris_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Ephemeris_Ingest>(buf);
}

inline const char *Ephemeris_IngestIdentifier() {
  return "EPHE";
}

inline bool Ephemeris_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Ephemeris_IngestIdentifier());
}

inline bool SizePrefixedEphemeris_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Ephemeris_IngestIdentifier(), true);
}

inline bool VerifyEphemeris_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Ephemeris_Ingest>(Ephemeris_IngestIdentifier());
}

inline bool VerifySizePrefixedEphemeris_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Ephemeris_Ingest>(Ephemeris_IngestIdentifier());
}

inline void FinishEphemeris_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Ephemeris_Ingest> root) {
  fbb.Finish(root, Ephemeris_IngestIdentifier());
}

inline void FinishSizePrefixedEphemeris_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Ephemeris_Ingest> root) {
  fbb.FinishSizePrefixed(root, Ephemeris_IngestIdentifier());
}
