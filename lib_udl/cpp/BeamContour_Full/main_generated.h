...
struct BeamContour_Full;
struct BeamContour_FullBuilder;

enum BeamContour_Full_type_Enum : int8_t {
  ...
  BeamContour_Full_type_Enum_MIN = BeamContour_Full_type_Enum_BORESIGHT,
  BeamContour_Full_type_Enum_MAX = BeamContour_Full_type_Enum_SVC_AREA
};

inline const BeamContour_Full_type_Enum (&EnumValuesBeamContour_Full_type_Enum())[3] {
  static const BeamContour_Full_type_Enum values[] = {
    BeamContour_Full_type_Enum_BORESIGHT,
    BeamContour_Full_type_Enum_CONTOUR,
    BeamContour_Full_type_Enum_SVC_AREA
  };
  return values;
}

inline const char * const *EnumNamesBeamContour_Full_type_Enum() {
...
inline const char *EnumNameBeamContour_Full_type_Enum(BeamContour_Full_type_Enum e) {
  if (::flatbuffers::IsOutRange(e, BeamContour_Full_type_Enum_BORESIGHT, BeamContour_Full_type_Enum_SVC_AREA)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesBeamContour_Full_type_Enum()[index];
}

enum BeamContour_Full_dataMode_Enum : int8_t {
  ...
  BeamContour_Full_dataMode_Enum_MIN = BeamContour_Full_dataMode_Enum_REAL,
  BeamContour_Full_dataMode_Enum_MAX = BeamContour_Full_dataMode_Enum_EXERCISE
};

inline const BeamContour_Full_dataMode_Enum (&EnumValuesBeamContour_Full_dataMode_Enum())[4] {
  static const BeamContour_Full_dataMode_Enum values[] = {
    BeamContour_Full_dataMode_Enum_REAL,
    BeamContour_Full_dataMode_Enum_TEST,
    BeamContour_Full_dataMode_Enum_SIMULATED,
    BeamContour_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesBeamContour_Full_dataMode_Enum() {
...
inline const char *EnumNameBeamContour_Full_dataMode_Enum(BeamContour_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, BeamContour_Full_dataMode_Enum_REAL, BeamContour_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesBeamContour_Full_dataMode_Enum()[index];
}
...
struct BeamContour_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef BeamContour_FullBuilder Builder;
  ...
  BeamContour_Full_type_Enum type() const {
    return static_cast<BeamContour_Full_type_Enum>(GetField<int8_t>(VT_TYPE, 0));
  }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  BeamContour_Full_dataMode_Enum dataMode() const {
    return static_cast<BeamContour_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct BeamContour_FullBuilder {
  typedef BeamContour_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(BeamContour_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(BeamContour_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idBeam(::flatbuffers::Offset<::flatbuffers::String> idBeam) {
    fbb_.AddOffset(BeamContour_Full::VT_IDBEAM, idBeam);
  }
  void add_type(BeamContour_Full_type_Enum type) {
    fbb_.AddElement<int8_t>(BeamContour_Full::VT_TYPE, static_cast<int8_t>(type), 0);
  }
  void add_contourIdx(int32_t contourIdx) {
    fbb_.AddElement<int32_t>(BeamContour_Full::VT_CONTOURIDX, contourIdx, 0);
  }
  void add_gain(double gain) {
    fbb_.AddElement<double>(BeamContour_Full::VT_GAIN, gain, 0.0);
  }
  void add_regionName(::flatbuffers::Offset<::flatbuffers::String> regionName) {
    fbb_.AddOffset(BeamContour_Full::VT_REGIONNAME, regionName);
  }
  void add_geography(::flatbuffers::Offset<::flatbuffers::String> geography) {
    fbb_.AddOffset(BeamContour_Full::VT_GEOGRAPHY, geography);
  }
  void add_geographyText(::flatbuffers::Offset<::flatbuffers::String> geographyText) {
    fbb_.AddOffset(BeamContour_Full::VT_GEOGRAPHYTEXT, geographyText);
  }
  void add_geographyJson(::flatbuffers::Offset<::flatbuffers::String> geographyJson) {
    fbb_.AddOffset(BeamContour_Full::VT_GEOGRAPHYJSON, geographyJson);
  }
  void add_geographyType(::flatbuffers::Offset<::flatbuffers::String> geographyType) {
    fbb_.AddOffset(BeamContour_Full::VT_GEOGRAPHYTYPE, geographyType);
  }
  void add_geographyNdims(int32_t geographyNdims) {
    fbb_.AddElement<int32_t>(BeamContour_Full::VT_GEOGRAPHYNDIMS, geographyNdims, 0);
  }
  void add_geographySrid(int32_t geographySrid) {
    fbb_.AddElement<int32_t>(BeamContour_Full::VT_GEOGRAPHYSRID, geographySrid, 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(BeamContour_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(BeamContour_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(BeamContour_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(BeamContour_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(BeamContour_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(BeamContour_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(BeamContour_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(BeamContour_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(BeamContour_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit BeamContour_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<BeamContour_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<BeamContour_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<BeamContour_Full> CreateBeamContour_Full(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::String> id = 0,
    ::flatbuffers::Offset<::flatbuffers::String> classificationMarking = 0,
    ::flatbuffers::Offset<::flatbuffers::String> idBeam = 0,
    BeamContour_Full_type_Enum type = BeamContour_Full_type_Enum_BORESIGHT,
    ...
    BeamContour_Full_dataMode_Enum dataMode = BeamContour_Full_dataMode_Enum_REAL) {
  BeamContour_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<BeamContour_Full> CreateBeamContour_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const BeamContour_Full *GetBeamContour_Full(const void *buf) {
  return ::flatbuffers::GetRoot<BeamContour_Full>(buf);
}

inline const BeamContour_Full *GetSizePrefixedBeamContour_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<BeamContour_Full>(buf);
}

inline const char *BeamContour_FullIdentifier() {
  return "BEAM";
}

inline bool BeamContour_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, BeamContour_FullIdentifier());
}

inline bool SizePrefixedBeamContour_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, BeamContour_FullIdentifier(), true);
}

inline bool VerifyBeamContour_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<BeamContour_Full>(BeamContour_FullIdentifier());
}

inline bool VerifySizePrefixedBeamContour_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<BeamContour_Full>(BeamContour_FullIdentifier());
}

inline void FinishBeamContour_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<BeamContour_Full> root) {
  fbb.Finish(root, BeamContour_FullIdentifier());
}

inline void FinishSizePrefixedBeamContour_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<BeamContour_Full> root) {
  fbb.FinishSizePrefixed(root, BeamContour_FullIdentifier());
}
