...
struct AircraftMissionTasking_Abridged;
...
struct AircraftMissionTasking_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AircraftMissionTasking_AbridgedBuilder Builder;
...
struct AircraftMissionTasking_AbridgedBuilder {
  typedef AircraftMissionTasking_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_COUNTRYCODE, countryCode);
  }
  void add_taskedService(::flatbuffers::Offset<::flatbuffers::String> taskedService) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_TASKEDSERVICE, taskedService);
  }
  void add_unitDesignator(::flatbuffers::Offset<::flatbuffers::String> unitDesignator) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_UNITDESIGNATOR, unitDesignator);
  }
  void add_unitLocName(::flatbuffers::Offset<::flatbuffers::String> unitLocName) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_UNITLOCNAME, unitLocName);
  }
  void add_resMsnInd(::flatbuffers::Offset<::flatbuffers::String> resMsnInd) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_RESMSNIND, resMsnInd);
  }
  void add_amcMsnNum(::flatbuffers::Offset<::flatbuffers::String> amcMsnNum) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_AMCMSNNUM, amcMsnNum);
  }
  void add_pkgId(::flatbuffers::Offset<::flatbuffers::String> pkgId) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_PKGID, pkgId);
  }
  void add_msnCommander(::flatbuffers::Offset<::flatbuffers::String> msnCommander) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_MSNCOMMANDER, msnCommander);
  }
  void add_msnNum(::flatbuffers::Offset<::flatbuffers::String> msnNum) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_MSNNUM, msnNum);
  }
  void add_priMsnType(::flatbuffers::Offset<::flatbuffers::String> priMsnType) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_PRIMSNTYPE, priMsnType);
  }
  void add_secMsnType(::flatbuffers::Offset<::flatbuffers::String> secMsnType) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_SECMSNTYPE, secMsnType);
  }
  void add_alertStatus(int32_t alertStatus) {
    fbb_.AddElement<int32_t>(AircraftMissionTasking_Abridged::VT_ALERTSTATUS, alertStatus, 0);
  }
  void add_depLocName(::flatbuffers::Offset<::flatbuffers::String> depLocName) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_DEPLOCNAME, depLocName);
  }
  void add_depLocUTM(::flatbuffers::Offset<::flatbuffers::String> depLocUTM) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_DEPLOCUTM, depLocUTM);
  }
  void add_depLocLat(double depLocLat) {
    fbb_.AddElement<double>(AircraftMissionTasking_Abridged::VT_DEPLOCLAT, depLocLat, 0.0);
  }
  void add_depLocLon(double depLocLon) {
    fbb_.AddElement<double>(AircraftMissionTasking_Abridged::VT_DEPLOCLON, depLocLon, 0.0);
  }
  void add_depTime(::flatbuffers::Offset<::flatbuffers::String> depTime) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_DEPTIME, depTime);
  }
  void add_rcvyLocName(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rcvyLocName) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_RCVYLOCNAME, rcvyLocName);
  }
  void add_rcvyLocUTM(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rcvyLocUTM) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_RCVYLOCUTM, rcvyLocUTM);
  }
  void add_rcvyLocLat(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rcvyLocLat) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_RCVYLOCLAT, rcvyLocLat);
  }
  void add_rcvyLocLon(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rcvyLocLon) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_RCVYLOCLON, rcvyLocLon);
  }
  void add_rcvyTime(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> rcvyTime) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_RCVYTIME, rcvyTime);
  }
  void add_indACTasking(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> indACTasking) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_INDACTASKING, indACTasking);
  }
  void add_acMsnLocSeg(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> acMsnLocSeg) {
    fbb_.AddOffset(AircraftMissionTasking_Abridged::VT_ACMSNLOCSEG, acMsnLocSeg);
  }
  explicit AircraftMissionTasking_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AircraftMissionTasking_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AircraftMissionTasking_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AircraftMissionTasking_Abridged> CreateAircraftMissionTasking_Abridged(
  ...
  AircraftMissionTasking_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AircraftMissionTasking_Abridged> CreateAircraftMissionTasking_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AircraftMissionTasking_Abridged *GetAircraftMissionTasking_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<AircraftMissionTasking_Abridged>(buf);
}

inline const AircraftMissionTasking_Abridged *GetSizePrefixedAircraftMissionTasking_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AircraftMissionTasking_Abridged>(buf);
}

inline const char *AircraftMissionTasking_AbridgedIdentifier() {
  return "AIRC";
}

inline bool AircraftMissionTasking_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftMissionTasking_AbridgedIdentifier());
}

inline bool SizePrefixedAircraftMissionTasking_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftMissionTasking_AbridgedIdentifier(), true);
}

inline bool VerifyAircraftMissionTasking_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AircraftMissionTasking_Abridged>(AircraftMissionTasking_AbridgedIdentifier());
}

inline bool VerifySizePrefixedAircraftMissionTasking_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AircraftMissionTasking_Abridged>(AircraftMissionTasking_AbridgedIdentifier());
}

inline void FinishAircraftMissionTasking_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftMissionTasking_Abridged> root) {
  fbb.Finish(root, AircraftMissionTasking_AbridgedIdentifier());
}

inline void FinishSizePrefixedAircraftMissionTasking_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftMissionTasking_Abridged> root) {
  fbb.FinishSizePrefixed(root, AircraftMissionTasking_AbridgedIdentifier());
}
