...
struct AirspaceControlMeans_Full;
struct AirspaceControlMeans_FullBuilder;

enum AirspaceControlMeans_Full_cmShape_Enum : int8_t {
  ...
  AirspaceControlMeans_Full_cmShape_Enum_MIN = AirspaceControlMeans_Full_cmShape_Enum_POLYARC,
  AirspaceControlMeans_Full_cmShape_Enum_MAX = AirspaceControlMeans_Full_cmShape_Enum_GEOLINE
};

inline const AirspaceControlMeans_Full_cmShape_Enum (&EnumValuesAirspaceControlMeans_Full_cmShape_Enum())[8] {
  static const AirspaceControlMeans_Full_cmShape_Enum values[] = {
    AirspaceControlMeans_Full_cmShape_Enum_POLYARC,
    AirspaceControlMeans_Full_cmShape_Enum_E1TRACK,
    AirspaceControlMeans_Full_cmShape_Enum_POLYGON,
    AirspaceControlMeans_Full_cmShape_Enum_CIRCLE,
    AirspaceControlMeans_Full_cmShape_Enum_CORRIDOR,
    AirspaceControlMeans_Full_cmShape_Enum_APOINT,
    AirspaceControlMeans_Full_cmShape_Enum_AORBIT,
    AirspaceControlMeans_Full_cmShape_Enum_GEOLINE
  };
  return values;
}

inline const char * const *EnumNamesAirspaceControlMeans_Full_cmShape_Enum() {
...
inline const char *EnumNameAirspaceControlMeans_Full_cmShape_Enum(AirspaceControlMeans_Full_cmShape_Enum e) {
  if (::flatbuffers::IsOutRange(e, AirspaceControlMeans_Full_cmShape_Enum_POLYARC, AirspaceControlMeans_Full_cmShape_Enum_GEOLINE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAirspaceControlMeans_Full_cmShape_Enum()[index];
}

/// /// A conditional nested segment to report multiple airspace control means within a particular airspace control means status.
struct AirspaceControlMeans_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirspaceControlMeans_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 0, Maximum length = 8
  AirspaceControlMeans_Full_cmShape_Enum cmShape() const {
    return static_cast<AirspaceControlMeans_Full_cmShape_Enum>(GetField<int8_t>(VT_CMSHAPE, 0));
  }
...
struct AirspaceControlMeans_FullBuilder {
  typedef AirspaceControlMeans_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_cmType(::flatbuffers::Offset<::flatbuffers::String> cmType) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_CMTYPE, cmType);
  }
  void add_cmId(::flatbuffers::Offset<::flatbuffers::String> cmId) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_CMID, cmId);
  }
  void add_cmShape(AirspaceControlMeans_Full_cmShape_Enum cmShape) {
    fbb_.AddElement<int8_t>(AirspaceControlMeans_Full::VT_CMSHAPE, static_cast<int8_t>(cmShape), 0);
  }
  void add_usage(::flatbuffers::Offset<::flatbuffers::String> usage) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_USAGE, usage);
  }
  void add_link16Id(::flatbuffers::Offset<::flatbuffers::String> link16Id) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_LINK16ID, link16Id);
  }
  void add_transAltitude(::flatbuffers::Offset<::flatbuffers::String> transAltitude) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_TRANSALTITUDE, transAltitude);
  }
  void add_geoDatumAlt(::flatbuffers::Offset<::flatbuffers::String> geoDatumAlt) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_GEODATUMALT, geoDatumAlt);
  }
  void add_coord0(::flatbuffers::Offset<::flatbuffers::String> coord0) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_COORD0, coord0);
  }
  void add_coord1(::flatbuffers::Offset<::flatbuffers::String> coord1) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_COORD1, coord1);
  }
  void add_bearing0(double bearing0) {
    fbb_.AddElement<double>(AirspaceControlMeans_Full::VT_BEARING0, bearing0, 0.0);
  }
  void add_bearing1(double bearing1) {
    fbb_.AddElement<double>(AirspaceControlMeans_Full::VT_BEARING1, bearing1, 0.0);
  }
  void add_radMag0(double radMag0) {
    fbb_.AddElement<double>(AirspaceControlMeans_Full::VT_RADMAG0, radMag0, 0.0);
  }
  void add_radMag1(double radMag1) {
    fbb_.AddElement<double>(AirspaceControlMeans_Full::VT_RADMAG1, radMag1, 0.0);
  }
  void add_radMagUnit(::flatbuffers::Offset<::flatbuffers::String> radMagUnit) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_RADMAGUNIT, radMagUnit);
  }
  void add_polyCoord(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> polyCoord) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_POLYCOORD, polyCoord);
  }
  void add_trackLeg(int32_t trackLeg) {
    fbb_.AddElement<int32_t>(AirspaceControlMeans_Full::VT_TRACKLEG, trackLeg, 0);
  }
  void add_widthLeft(double widthLeft) {
    fbb_.AddElement<double>(AirspaceControlMeans_Full::VT_WIDTHLEFT, widthLeft, 0.0);
  }
  void add_widthRight(double widthRight) {
    fbb_.AddElement<double>(AirspaceControlMeans_Full::VT_WIDTHRIGHT, widthRight, 0.0);
  }
  void add_width(double width) {
    fbb_.AddElement<double>(AirspaceControlMeans_Full::VT_WIDTH, width, 0.0);
  }
  void add_widthUnit(::flatbuffers::Offset<::flatbuffers::String> widthUnit) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_WIDTHUNIT, widthUnit);
  }
  void add_corrWayPoints(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> corrWayPoints) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_CORRWAYPOINTS, corrWayPoints);
  }
  void add_orbitAlignment(::flatbuffers::Offset<::flatbuffers::String> orbitAlignment) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_ORBITALIGNMENT, orbitAlignment);
  }
  void add_effVDim(::flatbuffers::Offset<::flatbuffers::String> effVDim) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_EFFVDIM, effVDim);
  }
  void add_airspaceTimePeriod(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> airspaceTimePeriod) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_AIRSPACETIMEPERIOD, airspaceTimePeriod);
  }
  void add_airspaceControlPoint(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> airspaceControlPoint) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_AIRSPACECONTROLPOINT, airspaceControlPoint);
  }
  void add_ctrlAuth(::flatbuffers::Offset<::flatbuffers::String> ctrlAuth) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_CTRLAUTH, ctrlAuth);
  }
  void add_ctrlAuthFreqs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> ctrlAuthFreqs) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_CTRLAUTHFREQS, ctrlAuthFreqs);
  }
  void add_genTextInd(::flatbuffers::Offset<::flatbuffers::String> genTextInd) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_GENTEXTIND, genTextInd);
  }
  void add_freeText(::flatbuffers::Offset<::flatbuffers::String> freeText) {
    fbb_.AddOffset(AirspaceControlMeans_Full::VT_FREETEXT, freeText);
  }
  explicit AirspaceControlMeans_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirspaceControlMeans_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirspaceControlMeans_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirspaceControlMeans_Full> CreateAirspaceControlMeans_Full(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::String> cmType = 0,
    ::flatbuffers::Offset<::flatbuffers::String> cmId = 0,
    AirspaceControlMeans_Full_cmShape_Enum cmShape = AirspaceControlMeans_Full_cmShape_Enum_POLYARC,
  ...
  AirspaceControlMeans_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirspaceControlMeans_Full> CreateAirspaceControlMeans_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AirspaceControlMeans_Full *GetAirspaceControlMeans_Full(const void *buf) {
  return ::flatbuffers::GetRoot<AirspaceControlMeans_Full>(buf);
}

inline const AirspaceControlMeans_Full *GetSizePrefixedAirspaceControlMeans_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirspaceControlMeans_Full>(buf);
}

inline const char *AirspaceControlMeans_FullIdentifier() {
  return "AIRS";
}

inline bool AirspaceControlMeans_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirspaceControlMeans_FullIdentifier());
}

inline bool SizePrefixedAirspaceControlMeans_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirspaceControlMeans_FullIdentifier(), true);
}

inline bool VerifyAirspaceControlMeans_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirspaceControlMeans_Full>(AirspaceControlMeans_FullIdentifier());
}

inline bool VerifySizePrefixedAirspaceControlMeans_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirspaceControlMeans_Full>(AirspaceControlMeans_FullIdentifier());
}

inline void FinishAirspaceControlMeans_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirspaceControlMeans_Full> root) {
  fbb.Finish(root, AirspaceControlMeans_FullIdentifier());
}

inline void FinishSizePrefixedAirspaceControlMeans_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirspaceControlMeans_Full> root) {
  fbb.FinishSizePrefixed(root, AirspaceControlMeans_FullIdentifier());
}
