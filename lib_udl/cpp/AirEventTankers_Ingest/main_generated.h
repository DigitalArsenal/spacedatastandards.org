...
struct AirEventTankers_Ingest;
struct AirEventTankers_IngestBuilder;

/// /// Collection of tanker aircraft associated with this Air Event.
struct AirEventTankers_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirEventTankers_IngestBuilder Builder;
...
struct AirEventTankers_IngestBuilder {
  typedef AirEventTankers_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_idTankerSortie(::flatbuffers::Offset<::flatbuffers::String> idTankerSortie) {
    fbb_.AddOffset(AirEventTankers_Ingest::VT_IDTANKERSORTIE, idTankerSortie);
  }
  void add_idTankerMission(::flatbuffers::Offset<::flatbuffers::String> idTankerMission) {
    fbb_.AddOffset(AirEventTankers_Ingest::VT_IDTANKERMISSION, idTankerMission);
  }
  void add_idTankerAirfield(::flatbuffers::Offset<::flatbuffers::String> idTankerAirfield) {
    fbb_.AddOffset(AirEventTankers_Ingest::VT_IDTANKERAIRFIELD, idTankerAirfield);
  }
  void add_externalTankerId(::flatbuffers::Offset<::flatbuffers::String> externalTankerId) {
    fbb_.AddOffset(AirEventTankers_Ingest::VT_EXTERNALTANKERID, externalTankerId);
  }
  void add_tankerCoord(::flatbuffers::Offset<::flatbuffers::String> tankerCoord) {
    fbb_.AddOffset(AirEventTankers_Ingest::VT_TANKERCOORD, tankerCoord);
  }
  void add_tankerMDS(::flatbuffers::Offset<::flatbuffers::String> tankerMDS) {
    fbb_.AddOffset(AirEventTankers_Ingest::VT_TANKERMDS, tankerMDS);
  }
  void add_amcTankerMissionId(::flatbuffers::Offset<::flatbuffers::String> amcTankerMissionId) {
    fbb_.AddOffset(AirEventTankers_Ingest::VT_AMCTANKERMISSIONID, amcTankerMissionId);
  }
  void add_altTankerMissionId(::flatbuffers::Offset<::flatbuffers::String> altTankerMissionId) {
    fbb_.AddOffset(AirEventTankers_Ingest::VT_ALTTANKERMISSIONID, altTankerMissionId);
  }
  void add_tankerCallSign(::flatbuffers::Offset<::flatbuffers::String> tankerCallSign) {
    fbb_.AddOffset(AirEventTankers_Ingest::VT_TANKERCALLSIGN, tankerCallSign);
  }
  void add_tankerOwner(::flatbuffers::Offset<::flatbuffers::String> tankerOwner) {
    fbb_.AddOffset(AirEventTankers_Ingest::VT_TANKEROWNER, tankerOwner);
  }
  void add_tankerPOC(::flatbuffers::Offset<::flatbuffers::String> tankerPOC) {
    fbb_.AddOffset(AirEventTankers_Ingest::VT_TANKERPOC, tankerPOC);
  }
  void add_tankerLegNum(int32_t tankerLegNum) {
    fbb_.AddElement<int32_t>(AirEventTankers_Ingest::VT_TANKERLEGNUM, tankerLegNum, 0);
  }
  void add_tankerDeployedICAO(::flatbuffers::Offset<::flatbuffers::String> tankerDeployedICAO) {
    fbb_.AddOffset(AirEventTankers_Ingest::VT_TANKERDEPLOYEDICAO, tankerDeployedICAO);
  }
  void add_tankerDeliveryMethod(::flatbuffers::Offset<::flatbuffers::String> tankerDeliveryMethod) {
    fbb_.AddOffset(AirEventTankers_Ingest::VT_TANKERDELIVERYMETHOD, tankerDeliveryMethod);
  }
  void add_fuelOff(double fuelOff) {
    fbb_.AddElement<double>(AirEventTankers_Ingest::VT_FUELOFF, fuelOff, 0.0);
  }
  void add_tankerCellPosition(int32_t tankerCellPosition) {
    fbb_.AddElement<int32_t>(AirEventTankers_Ingest::VT_TANKERCELLPOSITION, tankerCellPosition, 0);
  }
  void add_tankerFuelType(::flatbuffers::Offset<::flatbuffers::String> tankerFuelType) {
    fbb_.AddOffset(AirEventTankers_Ingest::VT_TANKERFUELTYPE, tankerFuelType);
  }
  void add_dualRole(bool dualRole) {
    fbb_.AddElement<uint8_t>(AirEventTankers_Ingest::VT_DUALROLE, static_cast<uint8_t>(dualRole), 0);
  }
  explicit AirEventTankers_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirEventTankers_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirEventTankers_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirEventTankers_Ingest> CreateAirEventTankers_Ingest(
    ...
    bool dualRole = false) {
  AirEventTankers_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirEventTankers_Ingest> CreateAirEventTankers_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AirEventTankers_Ingest *GetAirEventTankers_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<AirEventTankers_Ingest>(buf);
}

inline const AirEventTankers_Ingest *GetSizePrefixedAirEventTankers_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirEventTankers_Ingest>(buf);
}

inline const char *AirEventTankers_IngestIdentifier() {
  return "AIRE";
}

inline bool AirEventTankers_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirEventTankers_IngestIdentifier());
}

inline bool SizePrefixedAirEventTankers_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirEventTankers_IngestIdentifier(), true);
}

inline bool VerifyAirEventTankers_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirEventTankers_Ingest>(AirEventTankers_IngestIdentifier());
}

inline bool VerifySizePrefixedAirEventTankers_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirEventTankers_Ingest>(AirEventTankers_IngestIdentifier());
}

inline void FinishAirEventTankers_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirEventTankers_Ingest> root) {
  fbb.Finish(root, AirEventTankers_IngestIdentifier());
}

inline void FinishSizePrefixedAirEventTankers_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirEventTankers_Ingest> root) {
  fbb.FinishSizePrefixed(root, AirEventTankers_IngestIdentifier());
}
