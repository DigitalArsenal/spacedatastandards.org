...
struct ManifoldElset_Abridged;
struct ManifoldElset_AbridgedBuilder;

enum ManifoldElset_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  ManifoldElset_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  ManifoldElset_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  ManifoldElset_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  ManifoldElset_Abridged_dataMode_Enum_EXERCISE = 3,
  ManifoldElset_Abridged_dataMode_Enum_MIN = ManifoldElset_Abridged_dataMode_Enum_REAL,
  ManifoldElset_Abridged_dataMode_Enum_MAX = ManifoldElset_Abridged_dataMode_Enum_EXERCISE
};

inline const ManifoldElset_Abridged_dataMode_Enum (&EnumValuesManifoldElset_Abridged_dataMode_Enum())[4] {
  static const ManifoldElset_Abridged_dataMode_Enum values[] = {
    ManifoldElset_Abridged_dataMode_Enum_REAL,
    ManifoldElset_Abridged_dataMode_Enum_TEST,
    ManifoldElset_Abridged_dataMode_Enum_SIMULATED,
    ManifoldElset_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesManifoldElset_Abridged_dataMode_Enum() {
...
inline const char *EnumNameManifoldElset_Abridged_dataMode_Enum(ManifoldElset_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, ManifoldElset_Abridged_dataMode_Enum_REAL, ManifoldElset_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesManifoldElset_Abridged_dataMode_Enum()[index];
}
...
struct ManifoldElset_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef ManifoldElset_AbridgedBuilder Builder;
  ...
  ManifoldElset_Abridged_dataMode_Enum dataMode() const {
    return static_cast<ManifoldElset_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct ManifoldElset_AbridgedBuilder {
  typedef ManifoldElset_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(ManifoldElset_Abridged::VT_ID, id);
  }
  void add_idManifold(::flatbuffers::Offset<::flatbuffers::String> idManifold) {
    fbb_.AddOffset(ManifoldElset_Abridged::VT_IDMANIFOLD, idManifold);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(ManifoldElset_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_tmpSatNo(int32_t tmpSatNo) {
    fbb_.AddElement<int32_t>(ManifoldElset_Abridged::VT_TMPSATNO, tmpSatNo, 0);
  }
  void add_epoch(::flatbuffers::Offset<::flatbuffers::String> epoch) {
    fbb_.AddOffset(ManifoldElset_Abridged::VT_EPOCH, epoch);
  }
  void add_meanMotion(double meanMotion) {
    fbb_.AddElement<double>(ManifoldElset_Abridged::VT_MEANMOTION, meanMotion, 0.0);
  }
  void add_eccentricity(double eccentricity) {
    fbb_.AddElement<double>(ManifoldElset_Abridged::VT_ECCENTRICITY, eccentricity, 0.0);
  }
  void add_inclination(double inclination) {
    fbb_.AddElement<double>(ManifoldElset_Abridged::VT_INCLINATION, inclination, 0.0);
  }
  void add_raan(double raan) {
    fbb_.AddElement<double>(ManifoldElset_Abridged::VT_RAAN, raan, 0.0);
  }
  void add_argOfPerigee(double argOfPerigee) {
    fbb_.AddElement<double>(ManifoldElset_Abridged::VT_ARGOFPERIGEE, argOfPerigee, 0.0);
  }
  void add_meanAnomaly(double meanAnomaly) {
    fbb_.AddElement<double>(ManifoldElset_Abridged::VT_MEANANOMALY, meanAnomaly, 0.0);
  }
  void add_revNo(int32_t revNo) {
    fbb_.AddElement<int32_t>(ManifoldElset_Abridged::VT_REVNO, revNo, 0);
  }
  void add_bStar(double bStar) {
    fbb_.AddElement<double>(ManifoldElset_Abridged::VT_BSTAR, bStar, 0.0);
  }
  void add_meanMotionDot(double meanMotionDot) {
    fbb_.AddElement<double>(ManifoldElset_Abridged::VT_MEANMOTIONDOT, meanMotionDot, 0.0);
  }
  void add_meanMotionDDot(double meanMotionDDot) {
    fbb_.AddElement<double>(ManifoldElset_Abridged::VT_MEANMOTIONDDOT, meanMotionDDot, 0.0);
  }
  void add_semiMajorAxis(double semiMajorAxis) {
    fbb_.AddElement<double>(ManifoldElset_Abridged::VT_SEMIMAJORAXIS, semiMajorAxis, 0.0);
  }
  void add_period(double period) {
    fbb_.AddElement<double>(ManifoldElset_Abridged::VT_PERIOD, period, 0.0);
  }
  void add_apogee(double apogee) {
    fbb_.AddElement<double>(ManifoldElset_Abridged::VT_APOGEE, apogee, 0.0);
  }
  void add_perigee(double perigee) {
    fbb_.AddElement<double>(ManifoldElset_Abridged::VT_PERIGEE, perigee, 0.0);
  }
  void add_line1(::flatbuffers::Offset<::flatbuffers::String> line1) {
    fbb_.AddOffset(ManifoldElset_Abridged::VT_LINE1, line1);
  }
  void add_line2(::flatbuffers::Offset<::flatbuffers::String> line2) {
    fbb_.AddOffset(ManifoldElset_Abridged::VT_LINE2, line2);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(ManifoldElset_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(ManifoldElset_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(ManifoldElset_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(ManifoldElset_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(ManifoldElset_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(ManifoldElset_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(ManifoldElset_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  explicit ManifoldElset_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<ManifoldElset_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<ManifoldElset_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<ManifoldElset_Abridged> CreateManifoldElset_Abridged(
    ...
    ManifoldElset_Abridged_dataMode_Enum dataMode = ManifoldElset_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  ManifoldElset_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<ManifoldElset_Abridged> CreateManifoldElset_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const ManifoldElset_Abridged *GetManifoldElset_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<ManifoldElset_Abridged>(buf);
}

inline const ManifoldElset_Abridged *GetSizePrefixedManifoldElset_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<ManifoldElset_Abridged>(buf);
}

inline const char *ManifoldElset_AbridgedIdentifier() {
  return "MANI";
}

inline bool ManifoldElset_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ManifoldElset_AbridgedIdentifier());
}

inline bool SizePrefixedManifoldElset_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ManifoldElset_AbridgedIdentifier(), true);
}

inline bool VerifyManifoldElset_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<ManifoldElset_Abridged>(ManifoldElset_AbridgedIdentifier());
}

inline bool VerifySizePrefixedManifoldElset_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<ManifoldElset_Abridged>(ManifoldElset_AbridgedIdentifier());
}

inline void FinishManifoldElset_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ManifoldElset_Abridged> root) {
  fbb.Finish(root, ManifoldElset_AbridgedIdentifier());
}

inline void FinishSizePrefixedManifoldElset_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ManifoldElset_Abridged> root) {
  fbb.FinishSizePrefixed(root, ManifoldElset_AbridgedIdentifier());
}
