...
struct SeradataCommDetails_Abridged;
struct SeradataCommDetails_AbridgedBuilder;

enum SeradataCommDetails_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  SeradataCommDetails_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  SeradataCommDetails_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  SeradataCommDetails_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  SeradataCommDetails_Abridged_dataMode_Enum_EXERCISE = 3,
  SeradataCommDetails_Abridged_dataMode_Enum_MIN = SeradataCommDetails_Abridged_dataMode_Enum_REAL,
  SeradataCommDetails_Abridged_dataMode_Enum_MAX = SeradataCommDetails_Abridged_dataMode_Enum_EXERCISE
};

inline const SeradataCommDetails_Abridged_dataMode_Enum (&EnumValuesSeradataCommDetails_Abridged_dataMode_Enum())[4] {
  static const SeradataCommDetails_Abridged_dataMode_Enum values[] = {
    SeradataCommDetails_Abridged_dataMode_Enum_REAL,
    SeradataCommDetails_Abridged_dataMode_Enum_TEST,
    SeradataCommDetails_Abridged_dataMode_Enum_SIMULATED,
    SeradataCommDetails_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSeradataCommDetails_Abridged_dataMode_Enum() {
...
inline const char *EnumNameSeradataCommDetails_Abridged_dataMode_Enum(SeradataCommDetails_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SeradataCommDetails_Abridged_dataMode_Enum_REAL, SeradataCommDetails_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSeradataCommDetails_Abridged_dataMode_Enum()[index];
}

/// /// Seradata-compiled information on communications payloads.
struct SeradataCommDetails_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SeradataCommDetails_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SeradataCommDetails_Abridged_dataMode_Enum dataMode() const {
    return static_cast<SeradataCommDetails_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SeradataCommDetails_AbridgedBuilder {
  typedef SeradataCommDetails_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SeradataCommDetails_Abridged::VT_ID, id);
  }
  void add_idComm(::flatbuffers::Offset<::flatbuffers::String> idComm) {
    fbb_.AddOffset(SeradataCommDetails_Abridged::VT_IDCOMM, idComm);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SeradataCommDetails_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_spacecraftId(::flatbuffers::Offset<::flatbuffers::String> spacecraftId) {
    fbb_.AddOffset(SeradataCommDetails_Abridged::VT_SPACECRAFTID, spacecraftId);
  }
  void add_band(::flatbuffers::Offset<::flatbuffers::String> band) {
    fbb_.AddOffset(SeradataCommDetails_Abridged::VT_BAND, band);
  }
  void add_solidStatePowerAmp(double solidStatePowerAmp) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_SOLIDSTATEPOWERAMP, solidStatePowerAmp, 0.0);
  }
  void add_travelingWaveTubeAmplifier(double travelingWaveTubeAmplifier) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_TRAVELINGWAVETUBEAMPLIFIER, travelingWaveTubeAmplifier, 0.0);
  }
  void add_gatewayUplinkFrom(double gatewayUplinkFrom) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_GATEWAYUPLINKFROM, gatewayUplinkFrom, 0.0);
  }
  void add_gatewayUplinkTo(double gatewayUplinkTo) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_GATEWAYUPLINKTO, gatewayUplinkTo, 0.0);
  }
  void add_gatewayDownlinkFrom(double gatewayDownlinkFrom) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_GATEWAYDOWNLINKFROM, gatewayDownlinkFrom, 0.0);
  }
  void add_gatewayDownlinkTo(double gatewayDownlinkTo) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_GATEWAYDOWNLINKTO, gatewayDownlinkTo, 0.0);
  }
  void add_polarization(::flatbuffers::Offset<::flatbuffers::String> polarization) {
    fbb_.AddOffset(SeradataCommDetails_Abridged::VT_POLARIZATION, polarization);
  }
  void add_eirp(double eirp) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_EIRP, eirp, 0.0);
  }
  void add_bandwidth(double bandwidth) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_BANDWIDTH, bandwidth, 0.0);
  }
  void add_numOperationalTransponders(int32_t numOperationalTransponders) {
    fbb_.AddElement<int32_t>(SeradataCommDetails_Abridged::VT_NUMOPERATIONALTRANSPONDERS, numOperationalTransponders, 0);
  }
  void add_numSpareTransponders(int32_t numSpareTransponders) {
    fbb_.AddElement<int32_t>(SeradataCommDetails_Abridged::VT_NUMSPARETRANSPONDERS, numSpareTransponders, 0);
  }
  void add_hostedForCompanyOrgId(::flatbuffers::Offset<::flatbuffers::String> hostedForCompanyOrgId) {
    fbb_.AddOffset(SeradataCommDetails_Abridged::VT_HOSTEDFORCOMPANYORGID, hostedForCompanyOrgId);
  }
  void add_manufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrgId) {
    fbb_.AddOffset(SeradataCommDetails_Abridged::VT_MANUFACTURERORGID, manufacturerOrgId);
  }
  void add_tradeLeaseOrgId(::flatbuffers::Offset<::flatbuffers::String> tradeLeaseOrgId) {
    fbb_.AddOffset(SeradataCommDetails_Abridged::VT_TRADELEASEORGID, tradeLeaseOrgId);
  }
  void add_num36MhzEquivalentTransponders(int32_t num36MhzEquivalentTransponders) {
    fbb_.AddElement<int32_t>(SeradataCommDetails_Abridged::VT_NUM36MHZEQUIVALENTTRANSPONDERS, num36MhzEquivalentTransponders, 0);
  }
  void add_htsNumUserSpotBeams(int32_t htsNumUserSpotBeams) {
    fbb_.AddElement<int32_t>(SeradataCommDetails_Abridged::VT_HTSNUMUSERSPOTBEAMS, htsNumUserSpotBeams, 0);
  }
  void add_htsUserDownlinkBandwidthPerBeam(double htsUserDownlinkBandwidthPerBeam) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_HTSUSERDOWNLINKBANDWIDTHPERBEAM, htsUserDownlinkBandwidthPerBeam, 0.0);
  }
  void add_htsUserUplinkBandwidthPerBeam(double htsUserUplinkBandwidthPerBeam) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_HTSUSERUPLINKBANDWIDTHPERBEAM, htsUserUplinkBandwidthPerBeam, 0.0);
  }
  void add_estHtsTotalUserDownlinkBandwidthPerBeam(double estHtsTotalUserDownlinkBandwidthPerBeam) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_ESTHTSTOTALUSERDOWNLINKBANDWIDTHPERBEAM, estHtsTotalUserDownlinkBandwidthPerBeam, 0.0);
  }
  void add_estHtsTotalUserUplinkBandwidthPerBeam(double estHtsTotalUserUplinkBandwidthPerBeam) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_ESTHTSTOTALUSERUPLINKBANDWIDTHPERBEAM, estHtsTotalUserUplinkBandwidthPerBeam, 0.0);
  }
  void add_estHtsTotalCapacity(double estHtsTotalCapacity) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_ESTHTSTOTALCAPACITY, estHtsTotalCapacity, 0.0);
  }
  void add_userDownlinkFrom(double userDownlinkFrom) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_USERDOWNLINKFROM, userDownlinkFrom, 0.0);
  }
  void add_userDownlinkTo(double userDownlinkTo) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_USERDOWNLINKTO, userDownlinkTo, 0.0);
  }
  void add_userUplinkFrom(double userUplinkFrom) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_USERUPLINKFROM, userUplinkFrom, 0.0);
  }
  void add_userUplinkTo(double userUplinkTo) {
    fbb_.AddElement<double>(SeradataCommDetails_Abridged::VT_USERUPLINKTO, userUplinkTo, 0.0);
  }
  void add_payloadNotes(::flatbuffers::Offset<::flatbuffers::String> payloadNotes) {
    fbb_.AddOffset(SeradataCommDetails_Abridged::VT_PAYLOADNOTES, payloadNotes);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SeradataCommDetails_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SeradataCommDetails_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SeradataCommDetails_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(SeradataCommDetails_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SeradataCommDetails_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SeradataCommDetails_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SeradataCommDetails_Abridged::VT_CREATEDBY, createdBy);
  }
  explicit SeradataCommDetails_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SeradataCommDetails_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SeradataCommDetails_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SeradataCommDetails_Abridged> CreateSeradataCommDetails_Abridged(
    ...
    SeradataCommDetails_Abridged_dataMode_Enum dataMode = SeradataCommDetails_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0) {
  SeradataCommDetails_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SeradataCommDetails_Abridged> CreateSeradataCommDetails_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const SeradataCommDetails_Abridged *GetSeradataCommDetails_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<SeradataCommDetails_Abridged>(buf);
}

inline const SeradataCommDetails_Abridged *GetSizePrefixedSeradataCommDetails_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SeradataCommDetails_Abridged>(buf);
}

inline const char *SeradataCommDetails_AbridgedIdentifier() {
  return "SERA";
}

inline bool SeradataCommDetails_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataCommDetails_AbridgedIdentifier());
}

inline bool SizePrefixedSeradataCommDetails_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataCommDetails_AbridgedIdentifier(), true);
}

inline bool VerifySeradataCommDetails_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SeradataCommDetails_Abridged>(SeradataCommDetails_AbridgedIdentifier());
}

inline bool VerifySizePrefixedSeradataCommDetails_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SeradataCommDetails_Abridged>(SeradataCommDetails_AbridgedIdentifier());
}

inline void FinishSeradataCommDetails_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataCommDetails_Abridged> root) {
  fbb.Finish(root, SeradataCommDetails_AbridgedIdentifier());
}

inline void FinishSizePrefixedSeradataCommDetails_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataCommDetails_Abridged> root) {
  fbb.FinishSizePrefixed(root, SeradataCommDetails_AbridgedIdentifier());
}
