...
struct LogisticsSupportItems_Full;
struct LogisticsSupportItems_FullBuilder;

/// /// Support items associated with this LogisticsSupport record.
struct LogisticsSupportItems_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LogisticsSupportItems_FullBuilder Builder;
...
struct LogisticsSupportItems_FullBuilder {
  typedef LogisticsSupportItems_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_recoveryRequestTypeCode(::flatbuffers::Offset<::flatbuffers::String> recoveryRequestTypeCode) {
    fbb_.AddOffset(LogisticsSupportItems_Full::VT_RECOVERYREQUESTTYPECODE, recoveryRequestTypeCode);
  }
  void add_requestNumber(::flatbuffers::Offset<::flatbuffers::String> requestNumber) {
    fbb_.AddOffset(LogisticsSupportItems_Full::VT_REQUESTNUMBER, requestNumber);
  }
  void add_quantity(int32_t quantity) {
    fbb_.AddElement<int32_t>(LogisticsSupportItems_Full::VT_QUANTITY, quantity, 0);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(LogisticsSupportItems_Full::VT_DESCRIPTION, description);
  }
  void add_shipmentUnitId(::flatbuffers::Offset<::flatbuffers::String> shipmentUnitId) {
    fbb_.AddOffset(LogisticsSupportItems_Full::VT_SHIPMENTUNITID, shipmentUnitId);
  }
  void add_redeployShipmentUnitId(::flatbuffers::Offset<::flatbuffers::String> redeployShipmentUnitId) {
    fbb_.AddOffset(LogisticsSupportItems_Full::VT_REDEPLOYSHIPMENTUNITID, redeployShipmentUnitId);
  }
  void add_jobControlNumber(::flatbuffers::Offset<::flatbuffers::String> jobControlNumber) {
    fbb_.AddOffset(LogisticsSupportItems_Full::VT_JOBCONTROLNUMBER, jobControlNumber);
  }
  void add_sourceICAO(::flatbuffers::Offset<::flatbuffers::String> sourceICAO) {
    fbb_.AddOffset(LogisticsSupportItems_Full::VT_SOURCEICAO, sourceICAO);
  }
  void add_deployPlanNumber(::flatbuffers::Offset<::flatbuffers::String> deployPlanNumber) {
    fbb_.AddOffset(LogisticsSupportItems_Full::VT_DEPLOYPLANNUMBER, deployPlanNumber);
  }
  void add_redeployPlanNumber(::flatbuffers::Offset<::flatbuffers::String> redeployPlanNumber) {
    fbb_.AddOffset(LogisticsSupportItems_Full::VT_REDEPLOYPLANNUMBER, redeployPlanNumber);
  }
  void add_cannibalized(bool cannibalized) {
    fbb_.AddElement<uint8_t>(LogisticsSupportItems_Full::VT_CANNIBALIZED, static_cast<uint8_t>(cannibalized), 0);
  }
  void add_siPOC(::flatbuffers::Offset<::flatbuffers::String> siPOC) {
    fbb_.AddOffset(LogisticsSupportItems_Full::VT_SIPOC, siPOC);
  }
  void add_readyTime(::flatbuffers::Offset<::flatbuffers::String> readyTime) {
    fbb_.AddOffset(LogisticsSupportItems_Full::VT_READYTIME, readyTime);
  }
  void add_receivedTime(::flatbuffers::Offset<::flatbuffers::String> receivedTime) {
    fbb_.AddOffset(LogisticsSupportItems_Full::VT_RECEIVEDTIME, receivedTime);
  }
  void add_resupportFlag(bool resupportFlag) {
    fbb_.AddElement<uint8_t>(LogisticsSupportItems_Full::VT_RESUPPORTFLAG, static_cast<uint8_t>(resupportFlag), 0);
  }
  void add_itemLastChangedDate(::flatbuffers::Offset<::flatbuffers::String> itemLastChangedDate) {
    fbb_.AddOffset(LogisticsSupportItems_Full::VT_ITEMLASTCHANGEDDATE, itemLastChangedDate);
  }
  void add_logisticsParts(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsParts) {
    fbb_.AddOffset(LogisticsSupportItems_Full::VT_LOGISTICSPARTS, logisticsParts);
  }
  void add_logisticsSpecialties(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsSpecialties) {
    fbb_.AddOffset(LogisticsSupportItems_Full::VT_LOGISTICSSPECIALTIES, logisticsSpecialties);
  }
  void add_logisticsRemarks(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsRemarks) {
    fbb_.AddOffset(LogisticsSupportItems_Full::VT_LOGISTICSREMARKS, logisticsRemarks);
  }
  explicit LogisticsSupportItems_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LogisticsSupportItems_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LogisticsSupportItems_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LogisticsSupportItems_Full> CreateLogisticsSupportItems_Full(
  ...
  LogisticsSupportItems_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<LogisticsSupportItems_Full> CreateLogisticsSupportItems_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const LogisticsSupportItems_Full *GetLogisticsSupportItems_Full(const void *buf) {
  return ::flatbuffers::GetRoot<LogisticsSupportItems_Full>(buf);
}

inline const LogisticsSupportItems_Full *GetSizePrefixedLogisticsSupportItems_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<LogisticsSupportItems_Full>(buf);
}

inline const char *LogisticsSupportItems_FullIdentifier() {
  return "LOGI";
}

inline bool LogisticsSupportItems_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsSupportItems_FullIdentifier());
}

inline bool SizePrefixedLogisticsSupportItems_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsSupportItems_FullIdentifier(), true);
}

inline bool VerifyLogisticsSupportItems_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<LogisticsSupportItems_Full>(LogisticsSupportItems_FullIdentifier());
}

inline bool VerifySizePrefixedLogisticsSupportItems_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<LogisticsSupportItems_Full>(LogisticsSupportItems_FullIdentifier());
}

inline void FinishLogisticsSupportItems_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsSupportItems_Full> root) {
  fbb.Finish(root, LogisticsSupportItems_FullIdentifier());
}

inline void FinishSizePrefixedLogisticsSupportItems_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsSupportItems_Full> root) {
  fbb.FinishSizePrefixed(root, LogisticsSupportItems_FullIdentifier());
}
