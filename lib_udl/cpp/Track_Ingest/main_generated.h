...
struct Track_Ingest;
struct Track_IngestBuilder;

enum Track_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Track_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Track_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Track_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Track_Ingest_dataMode_Enum_EXERCISE = 3,
  Track_Ingest_dataMode_Enum_MIN = Track_Ingest_dataMode_Enum_REAL,
  Track_Ingest_dataMode_Enum_MAX = Track_Ingest_dataMode_Enum_EXERCISE
};

inline const Track_Ingest_dataMode_Enum (&EnumValuesTrack_Ingest_dataMode_Enum())[4] {
  static const Track_Ingest_dataMode_Enum values[] = {
    Track_Ingest_dataMode_Enum_REAL,
    Track_Ingest_dataMode_Enum_TEST,
    Track_Ingest_dataMode_Enum_SIMULATED,
    Track_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesTrack_Ingest_dataMode_Enum() {
...
inline const char *EnumNameTrack_Ingest_dataMode_Enum(Track_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Track_Ingest_dataMode_Enum_REAL, Track_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesTrack_Ingest_dataMode_Enum()[index];
}
...
struct Track_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Track_IngestBuilder Builder;
  ...
  Track_Ingest_dataMode_Enum dataMode() const {
    return static_cast<Track_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
inline ::flatbuffers::Offset<Track_Ingest> CreateTrack_Ingest(
    ...
    Track_Ingest_dataMode_Enum dataMode = Track_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  Track_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Track_Ingest> CreateTrack_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Track_Ingest *GetTrack_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<Track_Ingest>(buf);
}

inline const Track_Ingest *GetSizePrefixedTrack_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Track_Ingest>(buf);
}

inline const char *Track_IngestIdentifier() {
  return "TRAC";
}

inline bool Track_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Track_IngestIdentifier());
}

inline bool SizePrefixedTrack_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Track_IngestIdentifier(), true);
}

inline bool VerifyTrack_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Track_Ingest>(Track_IngestIdentifier());
}

inline bool VerifySizePrefixedTrack_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Track_Ingest>(Track_IngestIdentifier());
}

inline void FinishTrack_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Track_Ingest> root) {
  fbb.Finish(root, Track_IngestIdentifier());
}

inline void FinishSizePrefixedTrack_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Track_Ingest> root) {
  fbb.FinishSizePrefixed(root, Track_IngestIdentifier());
}
