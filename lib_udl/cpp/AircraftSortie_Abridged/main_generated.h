...
struct AircraftSortie_Abridged;
struct AircraftSortie_AbridgedBuilder;

enum AircraftSortie_Abridged_paperStatus_Enum : int8_t {
  ...
  AircraftSortie_Abridged_paperStatus_Enum_MIN = AircraftSortie_Abridged_paperStatus_Enum_PUBLISHED,
  AircraftSortie_Abridged_paperStatus_Enum_MAX = AircraftSortie_Abridged_paperStatus_Enum_READ
};

inline const AircraftSortie_Abridged_paperStatus_Enum (&EnumValuesAircraftSortie_Abridged_paperStatus_Enum())[4] {
  static const AircraftSortie_Abridged_paperStatus_Enum values[] = {
    AircraftSortie_Abridged_paperStatus_Enum_PUBLISHED,
    AircraftSortie_Abridged_paperStatus_Enum_DELETED,
    AircraftSortie_Abridged_paperStatus_Enum_UPDATED,
    AircraftSortie_Abridged_paperStatus_Enum_READ
  };
  return values;
}

inline const char * const *EnumNamesAircraftSortie_Abridged_paperStatus_Enum() {
...
inline const char *EnumNameAircraftSortie_Abridged_paperStatus_Enum(AircraftSortie_Abridged_paperStatus_Enum e) {
  if (::flatbuffers::IsOutRange(e, AircraftSortie_Abridged_paperStatus_Enum_PUBLISHED, AircraftSortie_Abridged_paperStatus_Enum_READ)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAircraftSortie_Abridged_paperStatus_Enum()[index];
}

enum AircraftSortie_Abridged_pprStatus_Enum : int8_t {
  /// No description available.
  ...
  AircraftSortie_Abridged_pprStatus_Enum_MIN = AircraftSortie_Abridged_pprStatus_Enum_NOT_REQUIRED,
  AircraftSortie_Abridged_pprStatus_Enum_MAX = AircraftSortie_Abridged_pprStatus_Enum_PENDING
};

inline const AircraftSortie_Abridged_pprStatus_Enum (&EnumValuesAircraftSortie_Abridged_pprStatus_Enum())[4] {
  static const AircraftSortie_Abridged_pprStatus_Enum values[] = {
    AircraftSortie_Abridged_pprStatus_Enum_NOT_REQUIRED,
    AircraftSortie_Abridged_pprStatus_Enum_REQUIRED_NOT_REQUESTED,
    AircraftSortie_Abridged_pprStatus_Enum_GRANTED,
    AircraftSortie_Abridged_pprStatus_Enum_PENDING
  };
  return values;
}

inline const char * const *EnumNamesAircraftSortie_Abridged_pprStatus_Enum() {
  static const char * const names[5] = {
    "NOT_REQUIRED",
...
inline const char *EnumNameAircraftSortie_Abridged_pprStatus_Enum(AircraftSortie_Abridged_pprStatus_Enum e) {
  if (::flatbuffers::IsOutRange(e, AircraftSortie_Abridged_pprStatus_Enum_NOT_REQUIRED, AircraftSortie_Abridged_pprStatus_Enum_PENDING)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAircraftSortie_Abridged_pprStatus_Enum()[index];
}

enum AircraftSortie_Abridged_rvnReq_Enum : int8_t {
  /// No description available.
  ...
  AircraftSortie_Abridged_rvnReq_Enum_MIN = AircraftSortie_Abridged_rvnReq_Enum_N,
  AircraftSortie_Abridged_rvnReq_Enum_MAX = AircraftSortie_Abridged_rvnReq_Enum_R6
};

inline const AircraftSortie_Abridged_rvnReq_Enum (&EnumValuesAircraftSortie_Abridged_rvnReq_Enum())[4] {
  static const AircraftSortie_Abridged_rvnReq_Enum values[] = {
    AircraftSortie_Abridged_rvnReq_Enum_N,
    AircraftSortie_Abridged_rvnReq_Enum_R,
    AircraftSortie_Abridged_rvnReq_Enum_C6,
    AircraftSortie_Abridged_rvnReq_Enum_R6
  };
  return values;
}

inline const char * const *EnumNamesAircraftSortie_Abridged_rvnReq_Enum() {
  static const char * const names[5] = {
    "N",
    "R",
    "C6",
...
inline const char *EnumNameAircraftSortie_Abridged_rvnReq_Enum(AircraftSortie_Abridged_rvnReq_Enum e) {
  if (::flatbuffers::IsOutRange(e, AircraftSortie_Abridged_rvnReq_Enum_N, AircraftSortie_Abridged_rvnReq_Enum_R6)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAircraftSortie_Abridged_rvnReq_Enum()[index];
}

enum AircraftSortie_Abridged_dataMode_Enum : int8_t {
  ...
  AircraftSortie_Abridged_dataMode_Enum_MIN = AircraftSortie_Abridged_dataMode_Enum_REAL,
  AircraftSortie_Abridged_dataMode_Enum_MAX = AircraftSortie_Abridged_dataMode_Enum_EXERCISE
};

inline const AircraftSortie_Abridged_dataMode_Enum (&EnumValuesAircraftSortie_Abridged_dataMode_Enum())[4] {
  static const AircraftSortie_Abridged_dataMode_Enum values[] = {
    AircraftSortie_Abridged_dataMode_Enum_REAL,
    AircraftSortie_Abridged_dataMode_Enum_TEST,
    AircraftSortie_Abridged_dataMode_Enum_SIMULATED,
    AircraftSortie_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAircraftSortie_Abridged_dataMode_Enum() {
  static const char * const names[5] = {
    "REAL",
    "TEST",
    "SIMULATED",
...
inline const char *EnumNameAircraftSortie_Abridged_dataMode_Enum(AircraftSortie_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AircraftSortie_Abridged_dataMode_Enum_REAL, AircraftSortie_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAircraftSortie_Abridged_dataMode_Enum()[index];
}

/// /// Information related to the planning, load, status, and deployment or dispatch of one aircraft to carry out a mission.
struct AircraftSortie_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AircraftSortie_AbridgedBuilder Builder;
  ...
  AircraftSortie_Abridged_paperStatus_Enum paperStatus() const {
    return static_cast<AircraftSortie_Abridged_paperStatus_Enum>(GetField<int8_t>(VT_PAPERSTATUS, 0));
  }
  /// The prior permission required (PPR) status.
  /// Example: /// Example: PENDING
  /// Constraints: Minimum length = 0, Maximum length = 22
  AircraftSortie_Abridged_pprStatus_Enum pprStatus() const {
    return static_cast<AircraftSortie_Abridged_pprStatus_Enum>(GetField<int8_t>(VT_PPRSTATUS, 0));
  }
  ...
  AircraftSortie_Abridged_rvnReq_Enum rvnReq() const {
    return static_cast<AircraftSortie_Abridged_rvnReq_Enum>(GetField<int8_t>(VT_RVNREQ, 0));
  }
  ...
  AircraftSortie_Abridged_dataMode_Enum dataMode() const {
    return static_cast<AircraftSortie_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AircraftSortie_AbridgedBuilder {
  typedef AircraftSortie_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_origSortieId(::flatbuffers::Offset<::flatbuffers::String> origSortieId) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ORIGSORTIEID, origSortieId);
  }
  void add_idAircraft(::flatbuffers::Offset<::flatbuffers::String> idAircraft) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_IDAIRCRAFT, idAircraft);
  }
  void add_aircraftAltId(::flatbuffers::Offset<::flatbuffers::String> aircraftAltId) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_AIRCRAFTALTID, aircraftAltId);
  }
  void add_tailNumber(::flatbuffers::Offset<::flatbuffers::String> tailNumber) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_TAILNUMBER, tailNumber);
  }
  void add_aircraftMDS(::flatbuffers::Offset<::flatbuffers::String> aircraftMDS) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_AIRCRAFTMDS, aircraftMDS);
  }
  void add_aircraftADSB(::flatbuffers::Offset<::flatbuffers::String> aircraftADSB) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_AIRCRAFTADSB, aircraftADSB);
  }
  void add_sortieDate(::flatbuffers::Offset<::flatbuffers::String> sortieDate) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_SORTIEDATE, sortieDate);
  }
  void add_lineNumber(int32_t lineNumber) {
    fbb_.AddElement<int32_t>(AircraftSortie_Abridged::VT_LINENUMBER, lineNumber, 0);
  }
  void add_idMission(::flatbuffers::Offset<::flatbuffers::String> idMission) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_IDMISSION, idMission);
  }
  void add_missionId(::flatbuffers::Offset<::flatbuffers::String> missionId) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_MISSIONID, missionId);
  }
  void add_amcMsnNum(::flatbuffers::Offset<::flatbuffers::String> amcMsnNum) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_AMCMSNNUM, amcMsnNum);
  }
  void add_amcMsnType(::flatbuffers::Offset<::flatbuffers::String> amcMsnType) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_AMCMSNTYPE, amcMsnType);
  }
  void add_callSign(::flatbuffers::Offset<::flatbuffers::String> callSign) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_CALLSIGN, callSign);
  }
  void add_jcsPriority(::flatbuffers::Offset<::flatbuffers::String> jcsPriority) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_JCSPRIORITY, jcsPriority);
  }
  void add_primarySCL(::flatbuffers::Offset<::flatbuffers::String> primarySCL) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_PRIMARYSCL, primarySCL);
  }
  void add_secondarySCL(::flatbuffers::Offset<::flatbuffers::String> secondarySCL) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_SECONDARYSCL, secondarySCL);
  }
  void add_reqConfig(::flatbuffers::Offset<::flatbuffers::String> reqConfig) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_REQCONFIG, reqConfig);
  }
  void add_cargoConfig(::flatbuffers::Offset<::flatbuffers::String> cargoConfig) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_CARGOCONFIG, cargoConfig);
  }
  void add_fuelReq(double fuelReq) {
    fbb_.AddElement<double>(AircraftSortie_Abridged::VT_FUELREQ, fuelReq, 0.0);
  }
  void add_oxyReqCrew(double oxyReqCrew) {
    fbb_.AddElement<double>(AircraftSortie_Abridged::VT_OXYREQCREW, oxyReqCrew, 0.0);
  }
  void add_oxyOnCrew(double oxyOnCrew) {
    fbb_.AddElement<double>(AircraftSortie_Abridged::VT_OXYONCREW, oxyOnCrew, 0.0);
  }
  void add_oxyReqPax(double oxyReqPax) {
    fbb_.AddElement<double>(AircraftSortie_Abridged::VT_OXYREQPAX, oxyReqPax, 0.0);
  }
  void add_oxyOnPax(double oxyOnPax) {
    fbb_.AddElement<double>(AircraftSortie_Abridged::VT_OXYONPAX, oxyOnPax, 0.0);
  }
  void add_alertStatusCode(::flatbuffers::Offset<::flatbuffers::String> alertStatusCode) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ALERTSTATUSCODE, alertStatusCode);
  }
  void add_alertStatus(int32_t alertStatus) {
    fbb_.AddElement<int32_t>(AircraftSortie_Abridged::VT_ALERTSTATUS, alertStatus, 0);
  }
  void add_currentState(::flatbuffers::Offset<::flatbuffers::String> currentState) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_CURRENTSTATE, currentState);
  }
  void add_depItinerary(int32_t depItinerary) {
    fbb_.AddElement<int32_t>(AircraftSortie_Abridged::VT_DEPITINERARY, depItinerary, 0);
  }
  void add_depICAO(::flatbuffers::Offset<::flatbuffers::String> depICAO) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_DEPICAO, depICAO);
  }
  void add_depIATA(::flatbuffers::Offset<::flatbuffers::String> depIATA) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_DEPIATA, depIATA);
  }
  void add_depFAA(::flatbuffers::Offset<::flatbuffers::String> depFAA) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_DEPFAA, depFAA);
  }
  void add_plannedDepTime(::flatbuffers::Offset<::flatbuffers::String> plannedDepTime) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_PLANNEDDEPTIME, plannedDepTime);
  }
  void add_estDepTime(::flatbuffers::Offset<::flatbuffers::String> estDepTime) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ESTDEPTIME, estDepTime);
  }
  void add_actualDepTime(::flatbuffers::Offset<::flatbuffers::String> actualDepTime) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ACTUALDEPTIME, actualDepTime);
  }
  void add_estBlockOutTime(::flatbuffers::Offset<::flatbuffers::String> estBlockOutTime) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ESTBLOCKOUTTIME, estBlockOutTime);
  }
  void add_actualBlockOutTime(::flatbuffers::Offset<::flatbuffers::String> actualBlockOutTime) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ACTUALBLOCKOUTTIME, actualBlockOutTime);
  }
  void add_depPurposeCode(::flatbuffers::Offset<::flatbuffers::String> depPurposeCode) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_DEPPURPOSECODE, depPurposeCode);
  }
  void add_arrItinerary(int32_t arrItinerary) {
    fbb_.AddElement<int32_t>(AircraftSortie_Abridged::VT_ARRITINERARY, arrItinerary, 0);
  }
  void add_arrICAO(::flatbuffers::Offset<::flatbuffers::String> arrICAO) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ARRICAO, arrICAO);
  }
  void add_arrIATA(::flatbuffers::Offset<::flatbuffers::String> arrIATA) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ARRIATA, arrIATA);
  }
  void add_arrFAA(::flatbuffers::Offset<::flatbuffers::String> arrFAA) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ARRFAA, arrFAA);
  }
  void add_plannedArrTime(::flatbuffers::Offset<::flatbuffers::String> plannedArrTime) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_PLANNEDARRTIME, plannedArrTime);
  }
  void add_estArrTime(::flatbuffers::Offset<::flatbuffers::String> estArrTime) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ESTARRTIME, estArrTime);
  }
  void add_actualArrTime(::flatbuffers::Offset<::flatbuffers::String> actualArrTime) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ACTUALARRTIME, actualArrTime);
  }
  void add_estBlockInTime(::flatbuffers::Offset<::flatbuffers::String> estBlockInTime) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ESTBLOCKINTIME, estBlockInTime);
  }
  void add_actualBlockInTime(::flatbuffers::Offset<::flatbuffers::String> actualBlockInTime) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ACTUALBLOCKINTIME, actualBlockInTime);
  }
  void add_arrPurposeCode(::flatbuffers::Offset<::flatbuffers::String> arrPurposeCode) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ARRPURPOSECODE, arrPurposeCode);
  }
  void add_dhd(::flatbuffers::Offset<::flatbuffers::String> dhd) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_DHD, dhd);
  }
  void add_dhdReason(::flatbuffers::Offset<::flatbuffers::String> dhdReason) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_DHDREASON, dhdReason);
  }
  void add_aircraftEvent(::flatbuffers::Offset<::flatbuffers::String> aircraftEvent) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_AIRCRAFTEVENT, aircraftEvent);
  }
  void add_soe(::flatbuffers::Offset<::flatbuffers::String> soe) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_SOE, soe);
  }
  void add_legNum(int32_t legNum) {
    fbb_.AddElement<int32_t>(AircraftSortie_Abridged::VT_LEGNUM, legNum, 0);
  }
  void add_flightTime(double flightTime) {
    fbb_.AddElement<double>(AircraftSortie_Abridged::VT_FLIGHTTIME, flightTime, 0.0);
  }
  void add_gndTime(double gndTime) {
    fbb_.AddElement<double>(AircraftSortie_Abridged::VT_GNDTIME, gndTime, 0.0);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_RAWFILEURI, rawFileURI);
  }
  void add_papersVersion(::flatbuffers::Offset<::flatbuffers::String> papersVersion) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_PAPERSVERSION, papersVersion);
  }
  void add_filename(::flatbuffers::Offset<::flatbuffers::String> filename) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_FILENAME, filename);
  }
  void add_filesize(int32_t filesize) {
    fbb_.AddElement<int32_t>(AircraftSortie_Abridged::VT_FILESIZE, filesize, 0);
  }
  void add_paperStatus(AircraftSortie_Abridged_paperStatus_Enum paperStatus) {
    fbb_.AddElement<int8_t>(AircraftSortie_Abridged::VT_PAPERSTATUS, static_cast<int8_t>(paperStatus), 0);
  }
  void add_pprStatus(AircraftSortie_Abridged_pprStatus_Enum pprStatus) {
    fbb_.AddElement<int8_t>(AircraftSortie_Abridged::VT_PPRSTATUS, static_cast<int8_t>(pprStatus), 0);
  }
  void add_missionUpdate(::flatbuffers::Offset<::flatbuffers::String> missionUpdate) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_MISSIONUPDATE, missionUpdate);
  }
  void add_delayCode(::flatbuffers::Offset<::flatbuffers::String> delayCode) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_DELAYCODE, delayCode);
  }
  void add_commanderName(::flatbuffers::Offset<::flatbuffers::String> commanderName) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_COMMANDERNAME, commanderName);
  }
  void add_fmDeskNum(::flatbuffers::Offset<::flatbuffers::String> fmDeskNum) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_FMDESKNUM, fmDeskNum);
  }
  void add_fmName(::flatbuffers::Offset<::flatbuffers::String> fmName) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_FMNAME, fmName);
  }
  void add_rvnReq(AircraftSortie_Abridged_rvnReq_Enum rvnReq) {
    fbb_.AddElement<int8_t>(AircraftSortie_Abridged::VT_RVNREQ, static_cast<int8_t>(rvnReq), 0);
  }
  void add_passengers(int32_t passengers) {
    fbb_.AddElement<int32_t>(AircraftSortie_Abridged::VT_PASSENGERS, passengers, 0);
  }
  void add_parkingLoc(::flatbuffers::Offset<::flatbuffers::String> parkingLoc) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_PARKINGLOC, parkingLoc);
  }
  void add_objectiveRemarks(::flatbuffers::Offset<::flatbuffers::String> objectiveRemarks) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_OBJECTIVEREMARKS, objectiveRemarks);
  }
  void add_aircraftRemarks(::flatbuffers::Offset<::flatbuffers::String> aircraftRemarks) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_AIRCRAFTREMARKS, aircraftRemarks);
  }
  void add_scheduleRemarks(::flatbuffers::Offset<::flatbuffers::String> scheduleRemarks) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_SCHEDULEREMARKS, scheduleRemarks);
  }
  void add_resultRemarks(::flatbuffers::Offset<::flatbuffers::String> resultRemarks) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_RESULTREMARKS, resultRemarks);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(AircraftSortie_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AircraftSortie_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AircraftSortie_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  explicit AircraftSortie_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AircraftSortie_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AircraftSortie_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AircraftSortie_Abridged> CreateAircraftSortie_Abridged(
    ...
    int32_t filesize = 0,
    AircraftSortie_Abridged_paperStatus_Enum paperStatus = AircraftSortie_Abridged_paperStatus_Enum_PUBLISHED,
    AircraftSortie_Abridged_pprStatus_Enum pprStatus = AircraftSortie_Abridged_pprStatus_Enum_NOT_REQUIRED,
    ...
    AircraftSortie_Abridged_rvnReq_Enum rvnReq = AircraftSortie_Abridged_rvnReq_Enum_N,
    ...
    AircraftSortie_Abridged_dataMode_Enum dataMode = AircraftSortie_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  AircraftSortie_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AircraftSortie_Abridged> CreateAircraftSortie_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AircraftSortie_Abridged *GetAircraftSortie_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<AircraftSortie_Abridged>(buf);
}

inline const AircraftSortie_Abridged *GetSizePrefixedAircraftSortie_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AircraftSortie_Abridged>(buf);
}

inline const char *AircraftSortie_AbridgedIdentifier() {
  return "AIRC";
}

inline bool AircraftSortie_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftSortie_AbridgedIdentifier());
}

inline bool SizePrefixedAircraftSortie_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftSortie_AbridgedIdentifier(), true);
}

inline bool VerifyAircraftSortie_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AircraftSortie_Abridged>(AircraftSortie_AbridgedIdentifier());
}

inline bool VerifySizePrefixedAircraftSortie_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AircraftSortie_Abridged>(AircraftSortie_AbridgedIdentifier());
}

inline void FinishAircraftSortie_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftSortie_Abridged> root) {
  fbb.Finish(root, AircraftSortie_AbridgedIdentifier());
}

inline void FinishSizePrefixedAircraftSortie_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftSortie_Abridged> root) {
  fbb.FinishSizePrefixed(root, AircraftSortie_AbridgedIdentifier());
}
