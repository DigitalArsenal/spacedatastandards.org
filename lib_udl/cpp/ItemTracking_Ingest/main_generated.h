...
struct ItemTracking_Ingest;
struct ItemTracking_IngestBuilder;

enum ItemTracking_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  ItemTracking_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  ItemTracking_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  ItemTracking_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  ItemTracking_Ingest_dataMode_Enum_EXERCISE = 3,
  ItemTracking_Ingest_dataMode_Enum_MIN = ItemTracking_Ingest_dataMode_Enum_REAL,
  ItemTracking_Ingest_dataMode_Enum_MAX = ItemTracking_Ingest_dataMode_Enum_EXERCISE
};

inline const ItemTracking_Ingest_dataMode_Enum (&EnumValuesItemTracking_Ingest_dataMode_Enum())[4] {
  static const ItemTracking_Ingest_dataMode_Enum values[] = {
    ItemTracking_Ingest_dataMode_Enum_REAL,
    ItemTracking_Ingest_dataMode_Enum_TEST,
    ItemTracking_Ingest_dataMode_Enum_SIMULATED,
    ItemTracking_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesItemTracking_Ingest_dataMode_Enum() {
...
inline const char *EnumNameItemTracking_Ingest_dataMode_Enum(ItemTracking_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, ItemTracking_Ingest_dataMode_Enum_REAL, ItemTracking_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesItemTracking_Ingest_dataMode_Enum()[index];
}

/// /// No description available.
struct ItemTracking_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef ItemTracking_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  ItemTracking_Ingest_dataMode_Enum dataMode() const {
    return static_cast<ItemTracking_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct ItemTracking_IngestBuilder {
  typedef ItemTracking_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_scanCode(::flatbuffers::Offset<::flatbuffers::String> scanCode) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_SCANCODE, scanCode);
  }
  void add_scGenTool(::flatbuffers::Offset<::flatbuffers::String> scGenTool) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_SCGENTOOL, scGenTool);
  }
  void add_scannerId(::flatbuffers::Offset<::flatbuffers::String> scannerId) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_SCANNERID, scannerId);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::String> ts) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_TS, ts);
  }
  void add_idItem(::flatbuffers::Offset<::flatbuffers::String> idItem) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_IDITEM, idItem);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_TYPE, type);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(ItemTracking_Ingest::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(ItemTracking_Ingest::VT_LON, lon, 0.0);
  }
  void add_scanType(::flatbuffers::Offset<::flatbuffers::String> scanType) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_SCANTYPE, scanType);
  }
  void add_dvCode(::flatbuffers::Offset<::flatbuffers::String> dvCode) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_DVCODE, dvCode);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_NOTES, notes);
  }
  void add_keys(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> keys) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_KEYS, keys);
  }
  void add_values(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> values) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_VALUES, values);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(ItemTracking_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(ItemTracking_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(ItemTracking_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit ItemTracking_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<ItemTracking_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<ItemTracking_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<ItemTracking_Ingest> CreateItemTracking_Ingest(
    ...
    ItemTracking_Ingest_dataMode_Enum dataMode = ItemTracking_Ingest_dataMode_Enum_REAL) {
  ItemTracking_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<ItemTracking_Ingest> CreateItemTracking_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const ItemTracking_Ingest *GetItemTracking_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<ItemTracking_Ingest>(buf);
}

inline const ItemTracking_Ingest *GetSizePrefixedItemTracking_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<ItemTracking_Ingest>(buf);
}

inline const char *ItemTracking_IngestIdentifier() {
  return "ITEM";
}

inline bool ItemTracking_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ItemTracking_IngestIdentifier());
}

inline bool SizePrefixedItemTracking_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, ItemTracking_IngestIdentifier(), true);
}

inline bool VerifyItemTracking_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<ItemTracking_Ingest>(ItemTracking_IngestIdentifier());
}

inline bool VerifySizePrefixedItemTracking_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<ItemTracking_Ingest>(ItemTracking_IngestIdentifier());
}

inline void FinishItemTracking_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ItemTracking_Ingest> root) {
  fbb.Finish(root, ItemTracking_IngestIdentifier());
}

inline void FinishSizePrefixedItemTracking_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<ItemTracking_Ingest> root) {
  fbb.FinishSizePrefixed(root, ItemTracking_IngestIdentifier());
}
