...
struct DataLink_Full;
struct DataLink_FullBuilder;

enum DataLink_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  DataLink_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  DataLink_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  DataLink_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  DataLink_Full_dataMode_Enum_EXERCISE = 3,
  DataLink_Full_dataMode_Enum_MIN = DataLink_Full_dataMode_Enum_REAL,
  DataLink_Full_dataMode_Enum_MAX = DataLink_Full_dataMode_Enum_EXERCISE
};

inline const DataLink_Full_dataMode_Enum (&EnumValuesDataLink_Full_dataMode_Enum())[4] {
  static const DataLink_Full_dataMode_Enum values[] = {
    DataLink_Full_dataMode_Enum_REAL,
    DataLink_Full_dataMode_Enum_TEST,
    DataLink_Full_dataMode_Enum_SIMULATED,
    DataLink_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesDataLink_Full_dataMode_Enum() {
...
inline const char *EnumNameDataLink_Full_dataMode_Enum(DataLink_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, DataLink_Full_dataMode_Enum_REAL, DataLink_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesDataLink_Full_dataMode_Enum()[index];
}

/// /// Beta Version DataLink: Detailed instructions regarding the operations of data links.
struct DataLink_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef DataLink_FullBuilder Builder;
  ...
  DataLink_Full_dataMode_Enum dataMode() const {
    return static_cast<DataLink_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
inline ::flatbuffers::Offset<DataLink_Full> CreateDataLink_Full(
    ...
    DataLink_Full_dataMode_Enum dataMode = DataLink_Full_dataMode_Enum_REAL) {
  DataLink_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<DataLink_Full> CreateDataLink_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const DataLink_Full *GetDataLink_Full(const void *buf) {
  return ::flatbuffers::GetRoot<DataLink_Full>(buf);
}

inline const DataLink_Full *GetSizePrefixedDataLink_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<DataLink_Full>(buf);
}

inline const char *DataLink_FullIdentifier() {
  return "DATA";
}

inline bool DataLink_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLink_FullIdentifier());
}

inline bool SizePrefixedDataLink_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLink_FullIdentifier(), true);
}

inline bool VerifyDataLink_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<DataLink_Full>(DataLink_FullIdentifier());
}

inline bool VerifySizePrefixedDataLink_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<DataLink_Full>(DataLink_FullIdentifier());
}

inline void FinishDataLink_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLink_Full> root) {
  fbb.Finish(root, DataLink_FullIdentifier());
}

inline void FinishSizePrefixedDataLink_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLink_Full> root) {
  fbb.FinishSizePrefixed(root, DataLink_FullIdentifier());
}
