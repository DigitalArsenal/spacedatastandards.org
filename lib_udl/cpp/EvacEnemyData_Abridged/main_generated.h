...
struct EvacEnemyData_Abridged;
struct EvacEnemyData_AbridgedBuilder;

/// /// Data defining any enemy intelligence reported by the requestor.
struct EvacEnemyData_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EvacEnemyData_AbridgedBuilder Builder;
...
struct EvacEnemyData_AbridgedBuilder {
  typedef EvacEnemyData_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_dirToEnemy(::flatbuffers::Offset<::flatbuffers::String> dirToEnemy) {
    fbb_.AddOffset(EvacEnemyData_Abridged::VT_DIRTOENEMY, dirToEnemy);
  }
  void add_hostileFireType(::flatbuffers::Offset<::flatbuffers::String> hostileFireType) {
    fbb_.AddOffset(EvacEnemyData_Abridged::VT_HOSTILEFIRETYPE, hostileFireType);
  }
  void add_friendliesRemarks(::flatbuffers::Offset<::flatbuffers::String> friendliesRemarks) {
    fbb_.AddOffset(EvacEnemyData_Abridged::VT_FRIENDLIESREMARKS, friendliesRemarks);
  }
  void add_hlzRemarks(::flatbuffers::Offset<::flatbuffers::String> hlzRemarks) {
    fbb_.AddOffset(EvacEnemyData_Abridged::VT_HLZREMARKS, hlzRemarks);
  }
  explicit EvacEnemyData_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<EvacEnemyData_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<EvacEnemyData_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<EvacEnemyData_Abridged> CreateEvacEnemyData_Abridged(
  ...
  EvacEnemyData_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<EvacEnemyData_Abridged> CreateEvacEnemyData_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const EvacEnemyData_Abridged *GetEvacEnemyData_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<EvacEnemyData_Abridged>(buf);
}

inline const EvacEnemyData_Abridged *GetSizePrefixedEvacEnemyData_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EvacEnemyData_Abridged>(buf);
}

inline const char *EvacEnemyData_AbridgedIdentifier() {
  return "EVAC";
}

inline bool EvacEnemyData_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EvacEnemyData_AbridgedIdentifier());
}

inline bool SizePrefixedEvacEnemyData_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EvacEnemyData_AbridgedIdentifier(), true);
}

inline bool VerifyEvacEnemyData_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EvacEnemyData_Abridged>(EvacEnemyData_AbridgedIdentifier());
}

inline bool VerifySizePrefixedEvacEnemyData_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EvacEnemyData_Abridged>(EvacEnemyData_AbridgedIdentifier());
}

inline void FinishEvacEnemyData_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EvacEnemyData_Abridged> root) {
  fbb.Finish(root, EvacEnemyData_AbridgedIdentifier());
}

inline void FinishSizePrefixedEvacEnemyData_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EvacEnemyData_Abridged> root) {
  fbb.FinishSizePrefixed(root, EvacEnemyData_AbridgedIdentifier());
}
