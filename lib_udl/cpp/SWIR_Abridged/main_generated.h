...
struct SWIR_Abridged;
struct SWIR_AbridgedBuilder;

enum SWIR_Abridged_dataMode_Enum : int8_t {
  ...
  SWIR_Abridged_dataMode_Enum_MIN = SWIR_Abridged_dataMode_Enum_REAL,
  SWIR_Abridged_dataMode_Enum_MAX = SWIR_Abridged_dataMode_Enum_EXERCISE
};

inline const SWIR_Abridged_dataMode_Enum (&EnumValuesSWIR_Abridged_dataMode_Enum())[4] {
  static const SWIR_Abridged_dataMode_Enum values[] = {
    SWIR_Abridged_dataMode_Enum_REAL,
    SWIR_Abridged_dataMode_Enum_TEST,
    SWIR_Abridged_dataMode_Enum_SIMULATED,
    SWIR_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSWIR_Abridged_dataMode_Enum() {
...
inline const char *EnumNameSWIR_Abridged_dataMode_Enum(SWIR_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SWIR_Abridged_dataMode_Enum_REAL, SWIR_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSWIR_Abridged_dataMode_Enum()[index];
}

/// /// Data representing observed short wave infrared (SWIR) measurements.
struct SWIR_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SWIR_AbridgedBuilder Builder;
  ...
  SWIR_Abridged_dataMode_Enum dataMode() const {
    return static_cast<SWIR_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SWIR_AbridgedBuilder {
  typedef SWIR_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SWIR_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SWIR_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(SWIR_Abridged::VT_IDONORBIT, idOnOrbit);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::String> ts) {
    fbb_.AddOffset(SWIR_Abridged::VT_TS, ts);
  }
  void add_solarPhaseAngle(double solarPhaseAngle) {
    fbb_.AddElement<double>(SWIR_Abridged::VT_SOLARPHASEANGLE, solarPhaseAngle, 0.0);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(SWIR_Abridged::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(SWIR_Abridged::VT_LON, lon, 0.0);
  }
  void add_locationName(::flatbuffers::Offset<::flatbuffers::String> locationName) {
    fbb_.AddOffset(SWIR_Abridged::VT_LOCATIONNAME, locationName);
  }
  void add_badWave(::flatbuffers::Offset<::flatbuffers::String> badWave) {
    fbb_.AddOffset(SWIR_Abridged::VT_BADWAVE, badWave);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(SWIR_Abridged::VT_ORIGOBJECTID, origObjectId);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SWIR_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SWIR_Abridged::VT_ORIGIN, origin);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(SWIR_Abridged::VT_SATNO, satNo, 0);
  }
  void add_dataMode(SWIR_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SWIR_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SWIR_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SWIR_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SWIR_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  explicit SWIR_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SWIR_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SWIR_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SWIR_Abridged> CreateSWIR_Abridged(
    ...
    int32_t satNo = 0,
    SWIR_Abridged_dataMode_Enum dataMode = SWIR_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  SWIR_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SWIR_Abridged> CreateSWIR_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const SWIR_Abridged *GetSWIR_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<SWIR_Abridged>(buf);
}

inline const SWIR_Abridged *GetSizePrefixedSWIR_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SWIR_Abridged>(buf);
}

inline const char *SWIR_AbridgedIdentifier() {
  return "SWIR";
}

inline bool SWIR_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SWIR_AbridgedIdentifier());
}

inline bool SizePrefixedSWIR_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SWIR_AbridgedIdentifier(), true);
}

inline bool VerifySWIR_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SWIR_Abridged>(SWIR_AbridgedIdentifier());
}

inline bool VerifySizePrefixedSWIR_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SWIR_Abridged>(SWIR_AbridgedIdentifier());
}

inline void FinishSWIR_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SWIR_Abridged> root) {
  fbb.Finish(root, SWIR_AbridgedIdentifier());
}

inline void FinishSizePrefixedSWIR_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SWIR_Abridged> root) {
  fbb.FinishSizePrefixed(root, SWIR_AbridgedIdentifier());
}
