...
struct EffectResponseActionsList_Full;
struct EffectResponseActionsList_FullBuilder;

/// /// List of actions associated with this effect response.
struct EffectResponseActionsList_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EffectResponseActionsList_FullBuilder Builder;
...
struct EffectResponseActionsList_FullBuilder {
  typedef EffectResponseActionsList_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_summary(::flatbuffers::Offset<::flatbuffers::String> summary) {
    fbb_.AddOffset(EffectResponseActionsList_Full::VT_SUMMARY, summary);
  }
  void add_actionId(::flatbuffers::Offset<::flatbuffers::String> actionId) {
    fbb_.AddOffset(EffectResponseActionsList_Full::VT_ACTIONID, actionId);
  }
  void add_actionStartTime(::flatbuffers::Offset<::flatbuffers::String> actionStartTime) {
    fbb_.AddOffset(EffectResponseActionsList_Full::VT_ACTIONSTARTTIME, actionStartTime);
  }
  void add_actionEndTime(::flatbuffers::Offset<::flatbuffers::String> actionEndTime) {
    fbb_.AddOffset(EffectResponseActionsList_Full::VT_ACTIONENDTIME, actionEndTime);
  }
  void add_totStartTime(::flatbuffers::Offset<::flatbuffers::String> totStartTime) {
    fbb_.AddOffset(EffectResponseActionsList_Full::VT_TOTSTARTTIME, totStartTime);
  }
  void add_totEndTime(::flatbuffers::Offset<::flatbuffers::String> totEndTime) {
    fbb_.AddOffset(EffectResponseActionsList_Full::VT_TOTENDTIME, totEndTime);
  }
  void add_actionActorSrcType(::flatbuffers::Offset<::flatbuffers::String> actionActorSrcType) {
    fbb_.AddOffset(EffectResponseActionsList_Full::VT_ACTIONACTORSRCTYPE, actionActorSrcType);
  }
  void add_actionActorSrcId(::flatbuffers::Offset<::flatbuffers::String> actionActorSrcId) {
    fbb_.AddOffset(EffectResponseActionsList_Full::VT_ACTIONACTORSRCID, actionActorSrcId);
  }
  void add_effector(::flatbuffers::Offset<::flatbuffers::String> effector) {
    fbb_.AddOffset(EffectResponseActionsList_Full::VT_EFFECTOR, effector);
  }
  void add_targetSrcType(::flatbuffers::Offset<::flatbuffers::String> targetSrcType) {
    fbb_.AddOffset(EffectResponseActionsList_Full::VT_TARGETSRCTYPE, targetSrcType);
  }
  void add_targetSrcId(::flatbuffers::Offset<::flatbuffers::String> targetSrcId) {
    fbb_.AddOffset(EffectResponseActionsList_Full::VT_TARGETSRCID, targetSrcId);
  }
  void add_actorInterceptLat(double actorInterceptLat) {
    fbb_.AddElement<double>(EffectResponseActionsList_Full::VT_ACTORINTERCEPTLAT, actorInterceptLat, 0.0);
  }
  void add_actorInterceptLon(double actorInterceptLon) {
    fbb_.AddElement<double>(EffectResponseActionsList_Full::VT_ACTORINTERCEPTLON, actorInterceptLon, 0.0);
  }
  void add_actorInterceptAlt(double actorInterceptAlt) {
    fbb_.AddElement<double>(EffectResponseActionsList_Full::VT_ACTORINTERCEPTALT, actorInterceptAlt, 0.0);
  }
  void add_weaponInterceptLat(double weaponInterceptLat) {
    fbb_.AddElement<double>(EffectResponseActionsList_Full::VT_WEAPONINTERCEPTLAT, weaponInterceptLat, 0.0);
  }
  void add_weaponInterceptLon(double weaponInterceptLon) {
    fbb_.AddElement<double>(EffectResponseActionsList_Full::VT_WEAPONINTERCEPTLON, weaponInterceptLon, 0.0);
  }
  void add_weaponInterceptAlt(double weaponInterceptAlt) {
    fbb_.AddElement<double>(EffectResponseActionsList_Full::VT_WEAPONINTERCEPTALT, weaponInterceptAlt, 0.0);
  }
  void add_actionMetrics(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> actionMetrics) {
    fbb_.AddOffset(EffectResponseActionsList_Full::VT_ACTIONMETRICS, actionMetrics);
  }
  explicit EffectResponseActionsList_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<EffectResponseActionsList_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<EffectResponseActionsList_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<EffectResponseActionsList_Full> CreateEffectResponseActionsList_Full(
  ...
  EffectResponseActionsList_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<EffectResponseActionsList_Full> CreateEffectResponseActionsList_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateEffectResponseActionsList_Full(
      _fbb,
      summary__,
      actionId__,
      actionStartTime__,
...
inline const EffectResponseActionsList_Full *GetEffectResponseActionsList_Full(const void *buf) {
  return ::flatbuffers::GetRoot<EffectResponseActionsList_Full>(buf);
}

inline const EffectResponseActionsList_Full *GetSizePrefixedEffectResponseActionsList_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EffectResponseActionsList_Full>(buf);
}

inline const char *EffectResponseActionsList_FullIdentifier() {
  return "EFFE";
}

inline bool EffectResponseActionsList_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EffectResponseActionsList_FullIdentifier());
}

inline bool SizePrefixedEffectResponseActionsList_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EffectResponseActionsList_FullIdentifier(), true);
}

inline bool VerifyEffectResponseActionsList_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EffectResponseActionsList_Full>(EffectResponseActionsList_FullIdentifier());
}

inline bool VerifySizePrefixedEffectResponseActionsList_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EffectResponseActionsList_Full>(EffectResponseActionsList_FullIdentifier());
}

inline void FinishEffectResponseActionsList_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EffectResponseActionsList_Full> root) {
  fbb.Finish(root, EffectResponseActionsList_FullIdentifier());
}

inline void FinishSizePrefixedEffectResponseActionsList_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EffectResponseActionsList_Full> root) {
  fbb.FinishSizePrefixed(root, EffectResponseActionsList_FullIdentifier());
}
