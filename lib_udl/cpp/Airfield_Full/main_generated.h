...
struct Airfield_Full;
struct Airfield_FullBuilder;

enum Airfield_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Airfield_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Airfield_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Airfield_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Airfield_Full_dataMode_Enum_EXERCISE = 3,
  Airfield_Full_dataMode_Enum_MIN = Airfield_Full_dataMode_Enum_REAL,
  Airfield_Full_dataMode_Enum_MAX = Airfield_Full_dataMode_Enum_EXERCISE
};

inline const Airfield_Full_dataMode_Enum (&EnumValuesAirfield_Full_dataMode_Enum())[4] {
  static const Airfield_Full_dataMode_Enum values[] = {
    Airfield_Full_dataMode_Enum_REAL,
    Airfield_Full_dataMode_Enum_TEST,
    Airfield_Full_dataMode_Enum_SIMULATED,
    Airfield_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAirfield_Full_dataMode_Enum() {
...
inline const char *EnumNameAirfield_Full_dataMode_Enum(Airfield_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Airfield_Full_dataMode_Enum_REAL, Airfield_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAirfield_Full_dataMode_Enum()[index];
}

/// /// Properties and characteristics of an airfield, which includes location, airfield codes, suitability codes, and remarks.
struct Airfield_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Airfield_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Airfield_Full_dataMode_Enum dataMode() const {
    return static_cast<Airfield_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Airfield_FullBuilder {
  typedef Airfield_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Airfield_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Airfield_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idSite(::flatbuffers::Offset<::flatbuffers::String> idSite) {
    fbb_.AddOffset(Airfield_Full::VT_IDSITE, idSite);
  }
  void add_altAirfieldId(::flatbuffers::Offset<::flatbuffers::String> altAirfieldId) {
    fbb_.AddOffset(Airfield_Full::VT_ALTAIRFIELDID, altAirfieldId);
  }
  void add_wacINNR(::flatbuffers::Offset<::flatbuffers::String> wacINNR) {
    fbb_.AddOffset(Airfield_Full::VT_WACINNR, wacINNR);
  }
  void add_zarId(::flatbuffers::Offset<::flatbuffers::String> zarId) {
    fbb_.AddOffset(Airfield_Full::VT_ZARID, zarId);
  }
  void add_icao(::flatbuffers::Offset<::flatbuffers::String> icao) {
    fbb_.AddOffset(Airfield_Full::VT_ICAO, icao);
  }
  void add_iata(::flatbuffers::Offset<::flatbuffers::String> iata) {
    fbb_.AddOffset(Airfield_Full::VT_IATA, iata);
  }
  void add_faa(::flatbuffers::Offset<::flatbuffers::String> faa) {
    fbb_.AddOffset(Airfield_Full::VT_FAA, faa);
  }
  void add_hostNatCode(::flatbuffers::Offset<::flatbuffers::String> hostNatCode) {
    fbb_.AddOffset(Airfield_Full::VT_HOSTNATCODE, hostNatCode);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(Airfield_Full::VT_NAME, name);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(Airfield_Full::VT_TYPE, type);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(Airfield_Full::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(Airfield_Full::VT_LON, lon, 0.0);
  }
  void add_elevFt(double elevFt) {
    fbb_.AddElement<double>(Airfield_Full::VT_ELEVFT, elevFt, 0.0);
  }
  void add_elevM(double elevM) {
    fbb_.AddElement<double>(Airfield_Full::VT_ELEVM, elevM, 0.0);
  }
  void add_magDec(double magDec) {
    fbb_.AddElement<double>(Airfield_Full::VT_MAGDEC, magDec, 0.0);
  }
  void add_regionName(::flatbuffers::Offset<::flatbuffers::String> regionName) {
    fbb_.AddOffset(Airfield_Full::VT_REGIONNAME, regionName);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(Airfield_Full::VT_COUNTRYCODE, countryCode);
  }
  void add_city(::flatbuffers::Offset<::flatbuffers::String> city) {
    fbb_.AddOffset(Airfield_Full::VT_CITY, city);
  }
  void add_state(::flatbuffers::Offset<::flatbuffers::String> state) {
    fbb_.AddOffset(Airfield_Full::VT_STATE, state);
  }
  void add_geoloc(::flatbuffers::Offset<::flatbuffers::String> geoloc) {
    fbb_.AddOffset(Airfield_Full::VT_GEOLOC, geoloc);
  }
  void add_gmtOffset(::flatbuffers::Offset<::flatbuffers::String> gmtOffset) {
    fbb_.AddOffset(Airfield_Full::VT_GMTOFFSET, gmtOffset);
  }
  void add_suitabilityCodes(::flatbuffers::Offset<::flatbuffers::String> suitabilityCodes) {
    fbb_.AddOffset(Airfield_Full::VT_SUITABILITYCODES, suitabilityCodes);
  }
  void add_miscCodes(::flatbuffers::Offset<::flatbuffers::String> miscCodes) {
    fbb_.AddOffset(Airfield_Full::VT_MISCCODES, miscCodes);
  }
  void add_runways(int32_t runways) {
    fbb_.AddElement<int32_t>(Airfield_Full::VT_RUNWAYS, runways, 0);
  }
  void add_maxRunwayLength(int32_t maxRunwayLength) {
    fbb_.AddElement<int32_t>(Airfield_Full::VT_MAXRUNWAYLENGTH, maxRunwayLength, 0);
  }
  void add_infoURL(::flatbuffers::Offset<::flatbuffers::String> infoURL) {
    fbb_.AddOffset(Airfield_Full::VT_INFOURL, infoURL);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Airfield_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Airfield_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(Airfield_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(Airfield_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(Airfield_Full::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Airfield_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Airfield_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Airfield_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(Airfield_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Airfield_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit Airfield_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Airfield_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Airfield_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Airfield_Full> CreateAirfield_Full(
    ...
    Airfield_Full_dataMode_Enum dataMode = Airfield_Full_dataMode_Enum_REAL) {
  Airfield_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Airfield_Full> CreateAirfield_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Airfield_Full *GetAirfield_Full(const void *buf) {
  return ::flatbuffers::GetRoot<Airfield_Full>(buf);
}

inline const Airfield_Full *GetSizePrefixedAirfield_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Airfield_Full>(buf);
}

inline const char *Airfield_FullIdentifier() {
  return "AIRF";
}

inline bool Airfield_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Airfield_FullIdentifier());
}

inline bool SizePrefixedAirfield_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Airfield_FullIdentifier(), true);
}

inline bool VerifyAirfield_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Airfield_Full>(Airfield_FullIdentifier());
}

inline bool VerifySizePrefixedAirfield_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Airfield_Full>(Airfield_FullIdentifier());
}

inline void FinishAirfield_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Airfield_Full> root) {
  fbb.Finish(root, Airfield_FullIdentifier());
}

inline void FinishSizePrefixedAirfield_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Airfield_Full> root) {
  fbb.FinishSizePrefixed(root, Airfield_FullIdentifier());
}
