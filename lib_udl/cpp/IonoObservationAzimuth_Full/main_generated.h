...
struct IonoObservationAzimuth_Full;
struct IonoObservationAzimuth_FullBuilder;
...
struct IonoObservationAzimuth_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef IonoObservationAzimuth_FullBuilder Builder;
...
struct IonoObservationAzimuth_FullBuilder {
  typedef IonoObservationAzimuth_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(IonoObservationAzimuth_Full::VT_NOTES, notes);
  }
  void add_dimensions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dimensions) {
    fbb_.AddOffset(IonoObservationAzimuth_Full::VT_DIMENSIONS, dimensions);
  }
  void add_dimensionName(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dimensionName) {
    fbb_.AddOffset(IonoObservationAzimuth_Full::VT_DIMENSIONNAME, dimensionName);
  }
  void add_data(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> data) {
    fbb_.AddOffset(IonoObservationAzimuth_Full::VT_DATA, data);
  }
  explicit IonoObservationAzimuth_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<IonoObservationAzimuth_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<IonoObservationAzimuth_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<IonoObservationAzimuth_Full> CreateIonoObservationAzimuth_Full(
  ...
  IonoObservationAzimuth_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<IonoObservationAzimuth_Full> CreateIonoObservationAzimuth_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const IonoObservationAzimuth_Full *GetIonoObservationAzimuth_Full(const void *buf) {
  return ::flatbuffers::GetRoot<IonoObservationAzimuth_Full>(buf);
}

inline const IonoObservationAzimuth_Full *GetSizePrefixedIonoObservationAzimuth_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<IonoObservationAzimuth_Full>(buf);
}

inline const char *IonoObservationAzimuth_FullIdentifier() {
  return "IONO";
}

inline bool IonoObservationAzimuth_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationAzimuth_FullIdentifier());
}

inline bool SizePrefixedIonoObservationAzimuth_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationAzimuth_FullIdentifier(), true);
}

inline bool VerifyIonoObservationAzimuth_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<IonoObservationAzimuth_Full>(IonoObservationAzimuth_FullIdentifier());
}

inline bool VerifySizePrefixedIonoObservationAzimuth_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<IonoObservationAzimuth_Full>(IonoObservationAzimuth_FullIdentifier());
}

inline void FinishIonoObservationAzimuth_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationAzimuth_Full> root) {
  fbb.Finish(root, IonoObservationAzimuth_FullIdentifier());
}

inline void FinishSizePrefixedIonoObservationAzimuth_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationAzimuth_Full> root) {
  fbb.FinishSizePrefixed(root, IonoObservationAzimuth_FullIdentifier());
}
