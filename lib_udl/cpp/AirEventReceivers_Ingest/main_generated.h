...
struct AirEventReceivers_Ingest;
struct AirEventReceivers_IngestBuilder;

/// /// Collection of receiver aircraft associated with this Air Event.
struct AirEventReceivers_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirEventReceivers_IngestBuilder Builder;
...
struct AirEventReceivers_IngestBuilder {
  typedef AirEventReceivers_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_idReceiverSortie(::flatbuffers::Offset<::flatbuffers::String> idReceiverSortie) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_IDRECEIVERSORTIE, idReceiverSortie);
  }
  void add_idReceiverMission(::flatbuffers::Offset<::flatbuffers::String> idReceiverMission) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_IDRECEIVERMISSION, idReceiverMission);
  }
  void add_idReceiverAirfield(::flatbuffers::Offset<::flatbuffers::String> idReceiverAirfield) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_IDRECEIVERAIRFIELD, idReceiverAirfield);
  }
  void add_externalReceiverId(::flatbuffers::Offset<::flatbuffers::String> externalReceiverId) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_EXTERNALRECEIVERID, externalReceiverId);
  }
  void add_receiverCoord(::flatbuffers::Offset<::flatbuffers::String> receiverCoord) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_RECEIVERCOORD, receiverCoord);
  }
  void add_receiverMDS(::flatbuffers::Offset<::flatbuffers::String> receiverMDS) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_RECEIVERMDS, receiverMDS);
  }
  void add_amcReceiverMissionId(::flatbuffers::Offset<::flatbuffers::String> amcReceiverMissionId) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_AMCRECEIVERMISSIONID, amcReceiverMissionId);
  }
  void add_altReceiverMissionId(::flatbuffers::Offset<::flatbuffers::String> altReceiverMissionId) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_ALTRECEIVERMISSIONID, altReceiverMissionId);
  }
  void add_receiverCallSign(::flatbuffers::Offset<::flatbuffers::String> receiverCallSign) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_RECEIVERCALLSIGN, receiverCallSign);
  }
  void add_receiverOwner(::flatbuffers::Offset<::flatbuffers::String> receiverOwner) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_RECEIVEROWNER, receiverOwner);
  }
  void add_receiverPOC(::flatbuffers::Offset<::flatbuffers::String> receiverPOC) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_RECEIVERPOC, receiverPOC);
  }
  void add_receiverLegNum(int32_t receiverLegNum) {
    fbb_.AddElement<int32_t>(AirEventReceivers_Ingest::VT_RECEIVERLEGNUM, receiverLegNum, 0);
  }
  void add_receiverDeployedICAO(::flatbuffers::Offset<::flatbuffers::String> receiverDeployedICAO) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_RECEIVERDEPLOYEDICAO, receiverDeployedICAO);
  }
  void add_receiverDeliveryMethod(::flatbuffers::Offset<::flatbuffers::String> receiverDeliveryMethod) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_RECEIVERDELIVERYMETHOD, receiverDeliveryMethod);
  }
  void add_fuelOn(double fuelOn) {
    fbb_.AddElement<double>(AirEventReceivers_Ingest::VT_FUELON, fuelOn, 0.0);
  }
  void add_receiverCellPosition(int32_t receiverCellPosition) {
    fbb_.AddElement<int32_t>(AirEventReceivers_Ingest::VT_RECEIVERCELLPOSITION, receiverCellPosition, 0);
  }
  void add_sequenceNum(::flatbuffers::Offset<::flatbuffers::String> sequenceNum) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_SEQUENCENUM, sequenceNum);
  }
  void add_recOrg(::flatbuffers::Offset<::flatbuffers::String> recOrg) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_RECORG, recOrg);
  }
  void add_numRecAircraft(int32_t numRecAircraft) {
    fbb_.AddElement<int32_t>(AirEventReceivers_Ingest::VT_NUMRECAIRCRAFT, numRecAircraft, 0);
  }
  void add_receiverFuelType(::flatbuffers::Offset<::flatbuffers::String> receiverFuelType) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_RECEIVERFUELTYPE, receiverFuelType);
  }
  void add_receiverExercise(::flatbuffers::Offset<::flatbuffers::String> receiverExercise) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_RECEIVEREXERCISE, receiverExercise);
  }
  void add_packageId(::flatbuffers::Offset<::flatbuffers::String> packageId) {
    fbb_.AddOffset(AirEventReceivers_Ingest::VT_PACKAGEID, packageId);
  }
  explicit AirEventReceivers_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirEventReceivers_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirEventReceivers_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirEventReceivers_Ingest> CreateAirEventReceivers_Ingest(
  ...
  AirEventReceivers_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirEventReceivers_Ingest> CreateAirEventReceivers_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AirEventReceivers_Ingest *GetAirEventReceivers_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<AirEventReceivers_Ingest>(buf);
}

inline const AirEventReceivers_Ingest *GetSizePrefixedAirEventReceivers_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirEventReceivers_Ingest>(buf);
}

inline const char *AirEventReceivers_IngestIdentifier() {
  return "AIRE";
}

inline bool AirEventReceivers_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirEventReceivers_IngestIdentifier());
}

inline bool SizePrefixedAirEventReceivers_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirEventReceivers_IngestIdentifier(), true);
}

inline bool VerifyAirEventReceivers_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirEventReceivers_Ingest>(AirEventReceivers_IngestIdentifier());
}

inline bool VerifySizePrefixedAirEventReceivers_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirEventReceivers_Ingest>(AirEventReceivers_IngestIdentifier());
}

inline void FinishAirEventReceivers_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirEventReceivers_Ingest> root) {
  fbb.Finish(root, AirEventReceivers_IngestIdentifier());
}

inline void FinishSizePrefixedAirEventReceivers_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirEventReceivers_Ingest> root) {
  fbb.FinishSizePrefixed(root, AirEventReceivers_IngestIdentifier());
}
