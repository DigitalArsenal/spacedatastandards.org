...
struct CollectResponse_Full;
struct CollectResponse_FullBuilder;

enum CollectResponse_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  CollectResponse_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  CollectResponse_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  CollectResponse_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  CollectResponse_Full_dataMode_Enum_EXERCISE = 3,
  CollectResponse_Full_dataMode_Enum_MIN = CollectResponse_Full_dataMode_Enum_REAL,
  CollectResponse_Full_dataMode_Enum_MAX = CollectResponse_Full_dataMode_Enum_EXERCISE
};

inline const CollectResponse_Full_dataMode_Enum (&EnumValuesCollectResponse_Full_dataMode_Enum())[4] {
  static const CollectResponse_Full_dataMode_Enum values[] = {
    CollectResponse_Full_dataMode_Enum_REAL,
    CollectResponse_Full_dataMode_Enum_TEST,
    CollectResponse_Full_dataMode_Enum_SIMULATED,
    CollectResponse_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesCollectResponse_Full_dataMode_Enum() {
...
inline const char *EnumNameCollectResponse_Full_dataMode_Enum(CollectResponse_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, CollectResponse_Full_dataMode_Enum_REAL, CollectResponse_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesCollectResponse_Full_dataMode_Enum()[index];
}
...
struct CollectResponse_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef CollectResponse_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  CollectResponse_Full_dataMode_Enum dataMode() const {
    return static_cast<CollectResponse_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct CollectResponse_FullBuilder {
  typedef CollectResponse_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(CollectResponse_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(CollectResponse_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idRequest(::flatbuffers::Offset<::flatbuffers::String> idRequest) {
    fbb_.AddOffset(CollectResponse_Full::VT_IDREQUEST, idRequest);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(CollectResponse_Full::VT_IDONORBIT, idOnOrbit);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(CollectResponse_Full::VT_ORIGOBJECTID, origObjectId);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(CollectResponse_Full::VT_SATNO, satNo, 0);
  }
  void add_onOrbit(::flatbuffers::Offset<::flatbuffers::String> onOrbit) {
    fbb_.AddOffset(CollectResponse_Full::VT_ONORBIT, onOrbit);
  }
  void add_taskId(::flatbuffers::Offset<::flatbuffers::String> taskId) {
    fbb_.AddOffset(CollectResponse_Full::VT_TASKID, taskId);
  }
  void add_idPlan(::flatbuffers::Offset<::flatbuffers::String> idPlan) {
    fbb_.AddOffset(CollectResponse_Full::VT_IDPLAN, idPlan);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(CollectResponse_Full::VT_EXTERNALID, externalId);
  }
  void add_status(::flatbuffers::Offset<::flatbuffers::String> status) {
    fbb_.AddOffset(CollectResponse_Full::VT_STATUS, status);
  }
  void add_actualStartTime(::flatbuffers::Offset<::flatbuffers::String> actualStartTime) {
    fbb_.AddOffset(CollectResponse_Full::VT_ACTUALSTARTTIME, actualStartTime);
  }
  void add_actualEndTime(::flatbuffers::Offset<::flatbuffers::String> actualEndTime) {
    fbb_.AddOffset(CollectResponse_Full::VT_ACTUALENDTIME, actualEndTime);
  }
  void add_altStartTime(::flatbuffers::Offset<::flatbuffers::String> altStartTime) {
    fbb_.AddOffset(CollectResponse_Full::VT_ALTSTARTTIME, altStartTime);
  }
  void add_altEndTime(::flatbuffers::Offset<::flatbuffers::String> altEndTime) {
    fbb_.AddOffset(CollectResponse_Full::VT_ALTENDTIME, altEndTime);
  }
  void add_errCode(::flatbuffers::Offset<::flatbuffers::String> errCode) {
    fbb_.AddOffset(CollectResponse_Full::VT_ERRCODE, errCode);
  }
  void add_srcTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcTyps) {
    fbb_.AddOffset(CollectResponse_Full::VT_SRCTYPS, srcTyps);
  }
  void add_srcIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcIds) {
    fbb_.AddOffset(CollectResponse_Full::VT_SRCIDS, srcIds);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(CollectResponse_Full::VT_NOTES, notes);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(CollectResponse_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(CollectResponse_Full::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(CollectResponse_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(CollectResponse_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(CollectResponse_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(CollectResponse_Full::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(CollectResponse_Full::VT_ORIGSENSORID, origSensorId);
  }
  void add_dataMode(CollectResponse_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(CollectResponse_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(CollectResponse_Full::VT_TAGS, tags);
  }
  explicit CollectResponse_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<CollectResponse_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<CollectResponse_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<CollectResponse_Full> CreateCollectResponse_Full(
    ...
    CollectResponse_Full_dataMode_Enum dataMode = CollectResponse_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags = 0) {
  CollectResponse_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<CollectResponse_Full> CreateCollectResponse_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const CollectResponse_Full *GetCollectResponse_Full(const void *buf) {
  return ::flatbuffers::GetRoot<CollectResponse_Full>(buf);
}

inline const CollectResponse_Full *GetSizePrefixedCollectResponse_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<CollectResponse_Full>(buf);
}

inline const char *CollectResponse_FullIdentifier() {
  return "COLL";
}

inline bool CollectResponse_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, CollectResponse_FullIdentifier());
}

inline bool SizePrefixedCollectResponse_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, CollectResponse_FullIdentifier(), true);
}

inline bool VerifyCollectResponse_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<CollectResponse_Full>(CollectResponse_FullIdentifier());
}

inline bool VerifySizePrefixedCollectResponse_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<CollectResponse_Full>(CollectResponse_FullIdentifier());
}

inline void FinishCollectResponse_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<CollectResponse_Full> root) {
  fbb.Finish(root, CollectResponse_FullIdentifier());
}

inline void FinishSizePrefixedCollectResponse_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<CollectResponse_Full> root) {
  fbb.FinishSizePrefixed(root, CollectResponse_FullIdentifier());
}
