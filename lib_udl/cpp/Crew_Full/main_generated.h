...
struct Crew_Full;
struct Crew_FullBuilder;

enum Crew_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Crew_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Crew_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Crew_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Crew_Full_dataMode_Enum_EXERCISE = 3,
  Crew_Full_dataMode_Enum_MIN = Crew_Full_dataMode_Enum_REAL,
  Crew_Full_dataMode_Enum_MAX = Crew_Full_dataMode_Enum_EXERCISE
};

inline const Crew_Full_dataMode_Enum (&EnumValuesCrew_Full_dataMode_Enum())[4] {
  static const Crew_Full_dataMode_Enum values[] = {
    Crew_Full_dataMode_Enum_REAL,
    Crew_Full_dataMode_Enum_TEST,
    Crew_Full_dataMode_Enum_SIMULATED,
    Crew_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesCrew_Full_dataMode_Enum() {
...
inline const char *EnumNameCrew_Full_dataMode_Enum(Crew_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Crew_Full_dataMode_Enum_REAL, Crew_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesCrew_Full_dataMode_Enum()[index];
}

/// /// Crew Services.
struct Crew_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Crew_FullBuilder Builder;
  ...
  Crew_Full_dataMode_Enum dataMode() const {
    return static_cast<Crew_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Crew_FullBuilder {
  typedef Crew_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Crew_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Crew_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_origCrewId(::flatbuffers::Offset<::flatbuffers::String> origCrewId) {
    fbb_.AddOffset(Crew_Full::VT_ORIGCREWID, origCrewId);
  }
  void add_crewName(::flatbuffers::Offset<::flatbuffers::String> crewName) {
    fbb_.AddOffset(Crew_Full::VT_CREWNAME, crewName);
  }
  void add_status(::flatbuffers::Offset<::flatbuffers::String> status) {
    fbb_.AddOffset(Crew_Full::VT_STATUS, status);
  }
  void add_idSortie(::flatbuffers::Offset<::flatbuffers::String> idSortie) {
    fbb_.AddOffset(Crew_Full::VT_IDSORTIE, idSortie);
  }
  void add_legalAlertTime(::flatbuffers::Offset<::flatbuffers::String> legalAlertTime) {
    fbb_.AddOffset(Crew_Full::VT_LEGALALERTTIME, legalAlertTime);
  }
  void add_legalBravoTime(::flatbuffers::Offset<::flatbuffers::String> legalBravoTime) {
    fbb_.AddOffset(Crew_Full::VT_LEGALBRAVOTIME, legalBravoTime);
  }
  void add_alertedTime(::flatbuffers::Offset<::flatbuffers::String> alertedTime) {
    fbb_.AddOffset(Crew_Full::VT_ALERTEDTIME, alertedTime);
  }
  void add_returnTime(::flatbuffers::Offset<::flatbuffers::String> returnTime) {
    fbb_.AddOffset(Crew_Full::VT_RETURNTIME, returnTime);
  }
  void add_fdpEligType(::flatbuffers::Offset<::flatbuffers::String> fdpEligType) {
    fbb_.AddOffset(Crew_Full::VT_FDPELIGTYPE, fdpEligType);
  }
  void add_fdpType(::flatbuffers::Offset<::flatbuffers::String> fdpType) {
    fbb_.AddOffset(Crew_Full::VT_FDPTYPE, fdpType);
  }
  void add_crewType(::flatbuffers::Offset<::flatbuffers::String> crewType) {
    fbb_.AddOffset(Crew_Full::VT_CREWTYPE, crewType);
  }
  void add_armsCrewUnit(::flatbuffers::Offset<::flatbuffers::String> armsCrewUnit) {
    fbb_.AddOffset(Crew_Full::VT_ARMSCREWUNIT, armsCrewUnit);
  }
  void add_crewMembers(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> crewMembers) {
    fbb_.AddOffset(Crew_Full::VT_CREWMEMBERS, crewMembers);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Crew_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Crew_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(Crew_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(Crew_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Crew_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Crew_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Crew_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(Crew_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Crew_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit Crew_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Crew_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Crew_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Crew_Full> CreateCrew_Full(
    ...
    Crew_Full_dataMode_Enum dataMode = Crew_Full_dataMode_Enum_REAL) {
  Crew_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Crew_Full> CreateCrew_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Crew_Full *GetCrew_Full(const void *buf) {
  return ::flatbuffers::GetRoot<Crew_Full>(buf);
}

inline const Crew_Full *GetSizePrefixedCrew_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Crew_Full>(buf);
}

inline const char *Crew_FullIdentifier() {
  return "CREW";
}

inline bool Crew_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Crew_FullIdentifier());
}

inline bool SizePrefixedCrew_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Crew_FullIdentifier(), true);
}

inline bool VerifyCrew_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Crew_Full>(Crew_FullIdentifier());
}

inline bool VerifySizePrefixedCrew_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Crew_Full>(Crew_FullIdentifier());
}

inline void FinishCrew_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Crew_Full> root) {
  fbb.Finish(root, Crew_FullIdentifier());
}

inline void FinishSizePrefixedCrew_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Crew_Full> root) {
  fbb.FinishSizePrefixed(root, Crew_FullIdentifier());
}
