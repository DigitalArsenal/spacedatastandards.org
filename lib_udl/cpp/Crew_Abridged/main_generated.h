...
struct Crew_Abridged;
struct Crew_AbridgedBuilder;

enum Crew_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Crew_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Crew_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Crew_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Crew_Abridged_dataMode_Enum_EXERCISE = 3,
  Crew_Abridged_dataMode_Enum_MIN = Crew_Abridged_dataMode_Enum_REAL,
  Crew_Abridged_dataMode_Enum_MAX = Crew_Abridged_dataMode_Enum_EXERCISE
};

inline const Crew_Abridged_dataMode_Enum (&EnumValuesCrew_Abridged_dataMode_Enum())[4] {
  static const Crew_Abridged_dataMode_Enum values[] = {
    Crew_Abridged_dataMode_Enum_REAL,
    Crew_Abridged_dataMode_Enum_TEST,
    Crew_Abridged_dataMode_Enum_SIMULATED,
    Crew_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesCrew_Abridged_dataMode_Enum() {
...
inline const char *EnumNameCrew_Abridged_dataMode_Enum(Crew_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Crew_Abridged_dataMode_Enum_REAL, Crew_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesCrew_Abridged_dataMode_Enum()[index];
}

/// /// Crew Services.
struct Crew_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Crew_AbridgedBuilder Builder;
  ...
  Crew_Abridged_dataMode_Enum dataMode() const {
    return static_cast<Crew_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Crew_AbridgedBuilder {
  typedef Crew_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Crew_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Crew_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_origCrewId(::flatbuffers::Offset<::flatbuffers::String> origCrewId) {
    fbb_.AddOffset(Crew_Abridged::VT_ORIGCREWID, origCrewId);
  }
  void add_crewName(::flatbuffers::Offset<::flatbuffers::String> crewName) {
    fbb_.AddOffset(Crew_Abridged::VT_CREWNAME, crewName);
  }
  void add_status(::flatbuffers::Offset<::flatbuffers::String> status) {
    fbb_.AddOffset(Crew_Abridged::VT_STATUS, status);
  }
  void add_idSortie(::flatbuffers::Offset<::flatbuffers::String> idSortie) {
    fbb_.AddOffset(Crew_Abridged::VT_IDSORTIE, idSortie);
  }
  void add_legalAlertTime(::flatbuffers::Offset<::flatbuffers::String> legalAlertTime) {
    fbb_.AddOffset(Crew_Abridged::VT_LEGALALERTTIME, legalAlertTime);
  }
  void add_legalBravoTime(::flatbuffers::Offset<::flatbuffers::String> legalBravoTime) {
    fbb_.AddOffset(Crew_Abridged::VT_LEGALBRAVOTIME, legalBravoTime);
  }
  void add_alertedTime(::flatbuffers::Offset<::flatbuffers::String> alertedTime) {
    fbb_.AddOffset(Crew_Abridged::VT_ALERTEDTIME, alertedTime);
  }
  void add_returnTime(::flatbuffers::Offset<::flatbuffers::String> returnTime) {
    fbb_.AddOffset(Crew_Abridged::VT_RETURNTIME, returnTime);
  }
  void add_fdpEligType(::flatbuffers::Offset<::flatbuffers::String> fdpEligType) {
    fbb_.AddOffset(Crew_Abridged::VT_FDPELIGTYPE, fdpEligType);
  }
  void add_fdpType(::flatbuffers::Offset<::flatbuffers::String> fdpType) {
    fbb_.AddOffset(Crew_Abridged::VT_FDPTYPE, fdpType);
  }
  void add_crewType(::flatbuffers::Offset<::flatbuffers::String> crewType) {
    fbb_.AddOffset(Crew_Abridged::VT_CREWTYPE, crewType);
  }
  void add_armsCrewUnit(::flatbuffers::Offset<::flatbuffers::String> armsCrewUnit) {
    fbb_.AddOffset(Crew_Abridged::VT_ARMSCREWUNIT, armsCrewUnit);
  }
  void add_crewMembers(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> crewMembers) {
    fbb_.AddOffset(Crew_Abridged::VT_CREWMEMBERS, crewMembers);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Crew_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Crew_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(Crew_Abridged::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(Crew_Abridged::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Crew_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Crew_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Crew_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(Crew_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Crew_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit Crew_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Crew_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Crew_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Crew_Abridged> CreateCrew_Abridged(
    ...
    Crew_Abridged_dataMode_Enum dataMode = Crew_Abridged_dataMode_Enum_REAL) {
  Crew_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Crew_Abridged> CreateCrew_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Crew_Abridged *GetCrew_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<Crew_Abridged>(buf);
}

inline const Crew_Abridged *GetSizePrefixedCrew_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Crew_Abridged>(buf);
}

inline const char *Crew_AbridgedIdentifier() {
  return "CREW";
}

inline bool Crew_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Crew_AbridgedIdentifier());
}

inline bool SizePrefixedCrew_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Crew_AbridgedIdentifier(), true);
}

inline bool VerifyCrew_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Crew_Abridged>(Crew_AbridgedIdentifier());
}

inline bool VerifySizePrefixedCrew_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Crew_Abridged>(Crew_AbridgedIdentifier());
}

inline void FinishCrew_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Crew_Abridged> root) {
  fbb.Finish(root, Crew_AbridgedIdentifier());
}

inline void FinishSizePrefixedCrew_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Crew_Abridged> root) {
  fbb.FinishSizePrefixed(root, Crew_AbridgedIdentifier());
}
