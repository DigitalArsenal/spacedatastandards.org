...
struct EphemerisSet_Ingest;
struct EphemerisSet_IngestBuilder;

enum EphemerisSet_Ingest_referenceFrame_Enum : int8_t {
  /// No description available.
  EphemerisSet_Ingest_referenceFrame_Enum_J2000 = 0,
  /// No description available.
  EphemerisSet_Ingest_referenceFrame_Enum_EFG_TDR = 1,
  /// No description available.
  EphemerisSet_Ingest_referenceFrame_Enum_ECR_ECEF = 2,
  /// No description available.
  EphemerisSet_Ingest_referenceFrame_Enum_TEME = 3,
  /// No description available.
  EphemerisSet_Ingest_referenceFrame_Enum_ITRF = 4,
  /// No description available.
  EphemerisSet_Ingest_referenceFrame_Enum_GCRF = 5,
  EphemerisSet_Ingest_referenceFrame_Enum_MIN = EphemerisSet_Ingest_referenceFrame_Enum_J2000,
  EphemerisSet_Ingest_referenceFrame_Enum_MAX = EphemerisSet_Ingest_referenceFrame_Enum_GCRF
};

inline const EphemerisSet_Ingest_referenceFrame_Enum (&EnumValuesEphemerisSet_Ingest_referenceFrame_Enum())[6] {
  static const EphemerisSet_Ingest_referenceFrame_Enum values[] = {
    EphemerisSet_Ingest_referenceFrame_Enum_J2000,
    EphemerisSet_Ingest_referenceFrame_Enum_EFG_TDR,
    EphemerisSet_Ingest_referenceFrame_Enum_ECR_ECEF,
    EphemerisSet_Ingest_referenceFrame_Enum_TEME,
    EphemerisSet_Ingest_referenceFrame_Enum_ITRF,
    EphemerisSet_Ingest_referenceFrame_Enum_GCRF
  };
  return values;
}

inline const char * const *EnumNamesEphemerisSet_Ingest_referenceFrame_Enum() {
...
inline const char *EnumNameEphemerisSet_Ingest_referenceFrame_Enum(EphemerisSet_Ingest_referenceFrame_Enum e) {
  if (::flatbuffers::IsOutRange(e, EphemerisSet_Ingest_referenceFrame_Enum_J2000, EphemerisSet_Ingest_referenceFrame_Enum_GCRF)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEphemerisSet_Ingest_referenceFrame_Enum()[index];
}

enum EphemerisSet_Ingest_covReferenceFrame_Enum : int8_t {
  /// No description available.
  EphemerisSet_Ingest_covReferenceFrame_Enum_J2000 = 0,
  /// No description available.
  EphemerisSet_Ingest_covReferenceFrame_Enum_UVW = 1,
  EphemerisSet_Ingest_covReferenceFrame_Enum_MIN = EphemerisSet_Ingest_covReferenceFrame_Enum_J2000,
  EphemerisSet_Ingest_covReferenceFrame_Enum_MAX = EphemerisSet_Ingest_covReferenceFrame_Enum_UVW
};

inline const EphemerisSet_Ingest_covReferenceFrame_Enum (&EnumValuesEphemerisSet_Ingest_covReferenceFrame_Enum())[2] {
  static const EphemerisSet_Ingest_covReferenceFrame_Enum values[] = {
    EphemerisSet_Ingest_covReferenceFrame_Enum_J2000,
    EphemerisSet_Ingest_covReferenceFrame_Enum_UVW
  };
  return values;
}

inline const char * const *EnumNamesEphemerisSet_Ingest_covReferenceFrame_Enum() {
...
inline const char *EnumNameEphemerisSet_Ingest_covReferenceFrame_Enum(EphemerisSet_Ingest_covReferenceFrame_Enum e) {
  if (::flatbuffers::IsOutRange(e, EphemerisSet_Ingest_covReferenceFrame_Enum_J2000, EphemerisSet_Ingest_covReferenceFrame_Enum_UVW)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEphemerisSet_Ingest_covReferenceFrame_Enum()[index];
}

enum EphemerisSet_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  EphemerisSet_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  EphemerisSet_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  EphemerisSet_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  EphemerisSet_Ingest_dataMode_Enum_EXERCISE = 3,
  EphemerisSet_Ingest_dataMode_Enum_MIN = EphemerisSet_Ingest_dataMode_Enum_REAL,
  EphemerisSet_Ingest_dataMode_Enum_MAX = EphemerisSet_Ingest_dataMode_Enum_EXERCISE
};

inline const EphemerisSet_Ingest_dataMode_Enum (&EnumValuesEphemerisSet_Ingest_dataMode_Enum())[4] {
  static const EphemerisSet_Ingest_dataMode_Enum values[] = {
    EphemerisSet_Ingest_dataMode_Enum_REAL,
    EphemerisSet_Ingest_dataMode_Enum_TEST,
    EphemerisSet_Ingest_dataMode_Enum_SIMULATED,
    EphemerisSet_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesEphemerisSet_Ingest_dataMode_Enum() {
...
inline const char *EnumNameEphemerisSet_Ingest_dataMode_Enum(EphemerisSet_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, EphemerisSet_Ingest_dataMode_Enum_REAL, EphemerisSet_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEphemerisSet_Ingest_dataMode_Enum()[index];
}
...
struct EphemerisSet_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EphemerisSet_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 0, Maximum length = 24
  EphemerisSet_Ingest_referenceFrame_Enum referenceFrame() const {
    return static_cast<EphemerisSet_Ingest_referenceFrame_Enum>(GetField<int8_t>(VT_REFERENCEFRAME, 0));
  }
  /// The reference frame of the covariance matrix elements. If the covReferenceFrame is null it is assumed to be J2000.
  /// Example: /// Example: J2000
  /// Constraints: Minimum length = 0, Maximum length = 24
  EphemerisSet_Ingest_covReferenceFrame_Enum covReferenceFrame() const {
    return static_cast<EphemerisSet_Ingest_covReferenceFrame_Enum>(GetField<int8_t>(VT_COVREFERENCEFRAME, 0));
  }
  ...
  EphemerisSet_Ingest_dataMode_Enum dataMode() const {
    return static_cast<EphemerisSet_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
  ...
  /// Constraints: No constraints specified.
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *ephemerisList() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *>(VT_EPHEMERISLIST);
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_EPHEMERISLIST) &&
           verifier.VerifyVector(ephemerisList()) &&
           verifier.VerifyVectorOfStrings(ephemerisList()) &&
...
struct EphemerisSet_IngestBuilder {
  typedef EphemerisSet_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_ORIGOBJECTID, origObjectId);
  }
  void add_pointStartTime(::flatbuffers::Offset<::flatbuffers::String> pointStartTime) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_POINTSTARTTIME, pointStartTime);
  }
  void add_usableStartTime(::flatbuffers::Offset<::flatbuffers::String> usableStartTime) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_USABLESTARTTIME, usableStartTime);
  }
  void add_pointEndTime(::flatbuffers::Offset<::flatbuffers::String> pointEndTime) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_POINTENDTIME, pointEndTime);
  }
  void add_usableEndTime(::flatbuffers::Offset<::flatbuffers::String> usableEndTime) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_USABLEENDTIME, usableEndTime);
  }
  void add_stepSize(int32_t stepSize) {
    fbb_.AddElement<int32_t>(EphemerisSet_Ingest::VT_STEPSIZE, stepSize, 0);
  }
  void add_numPoints(int32_t numPoints) {
    fbb_.AddElement<int32_t>(EphemerisSet_Ingest::VT_NUMPOINTS, numPoints, 0);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_TYPE, type);
  }
  void add_pedigree(::flatbuffers::Offset<::flatbuffers::String> pedigree) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_PEDIGREE, pedigree);
  }
  void add_category(::flatbuffers::Offset<::flatbuffers::String> category) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_CATEGORY, category);
  }
  void add_idStateVector(::flatbuffers::Offset<::flatbuffers::String> idStateVector) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_IDSTATEVECTOR, idStateVector);
  }
  void add_hasMnvr(bool hasMnvr) {
    fbb_.AddElement<uint8_t>(EphemerisSet_Ingest::VT_HASMNVR, static_cast<uint8_t>(hasMnvr), 0);
  }
  void add_idManeuvers(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> idManeuvers) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_IDMANEUVERS, idManeuvers);
  }
  void add_hasCov(bool hasCov) {
    fbb_.AddElement<uint8_t>(EphemerisSet_Ingest::VT_HASCOV, static_cast<uint8_t>(hasCov), 0);
  }
  void add_hasAccel(bool hasAccel) {
    fbb_.AddElement<uint8_t>(EphemerisSet_Ingest::VT_HASACCEL, static_cast<uint8_t>(hasAccel), 0);
  }
  void add_centBody(::flatbuffers::Offset<::flatbuffers::String> centBody) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_CENTBODY, centBody);
  }
  void add_integrator(::flatbuffers::Offset<::flatbuffers::String> integrator) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_INTEGRATOR, integrator);
  }
  void add_geopotentialModel(::flatbuffers::Offset<::flatbuffers::String> geopotentialModel) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_GEOPOTENTIALMODEL, geopotentialModel);
  }
  void add_dragModel(::flatbuffers::Offset<::flatbuffers::String> dragModel) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_DRAGMODEL, dragModel);
  }
  void add_lunarSolar(bool lunarSolar) {
    fbb_.AddElement<uint8_t>(EphemerisSet_Ingest::VT_LUNARSOLAR, static_cast<uint8_t>(lunarSolar), 0);
  }
  void add_solidEarthTides(bool solidEarthTides) {
    fbb_.AddElement<uint8_t>(EphemerisSet_Ingest::VT_SOLIDEARTHTIDES, static_cast<uint8_t>(solidEarthTides), 0);
  }
  void add_bDot(double bDot) {
    fbb_.AddElement<double>(EphemerisSet_Ingest::VT_BDOT, bDot, 0.0);
  }
  void add_edr(double edr) {
    fbb_.AddElement<double>(EphemerisSet_Ingest::VT_EDR, edr, 0.0);
  }
  void add_interpolation(::flatbuffers::Offset<::flatbuffers::String> interpolation) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_INTERPOLATION, interpolation);
  }
  void add_interpolationDegree(int32_t interpolationDegree) {
    fbb_.AddElement<int32_t>(EphemerisSet_Ingest::VT_INTERPOLATIONDEGREE, interpolationDegree, 0);
  }
  void add_filename(::flatbuffers::Offset<::flatbuffers::String> filename) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_FILENAME, filename);
  }
  void add_comments(::flatbuffers::Offset<::flatbuffers::String> comments) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_COMMENTS, comments);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_DESCRIPTION, description);
  }
  void add_descriptor(::flatbuffers::Offset<::flatbuffers::String> descriptor) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_DESCRIPTOR, descriptor);
  }
  void add_referenceFrame(EphemerisSet_Ingest_referenceFrame_Enum referenceFrame) {
    fbb_.AddElement<int8_t>(EphemerisSet_Ingest::VT_REFERENCEFRAME, static_cast<int8_t>(referenceFrame), 0);
  }
  void add_covReferenceFrame(EphemerisSet_Ingest_covReferenceFrame_Enum covReferenceFrame) {
    fbb_.AddElement<int8_t>(EphemerisSet_Ingest::VT_COVREFERENCEFRAME, static_cast<int8_t>(covReferenceFrame), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(EphemerisSet_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(EphemerisSet_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(EphemerisSet_Ingest::VT_SATNO, satNo, 0);
  }
  void add_ephemerisList(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> ephemerisList) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_EPHEMERISLIST, ephemerisList);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_TAGS, tags);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_TRANSACTIONID, transactionId);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(EphemerisSet_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  explicit EphemerisSet_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<EphemerisSet_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<EphemerisSet_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<EphemerisSet_Ingest> CreateEphemerisSet_Ingest(
    ...
    EphemerisSet_Ingest_referenceFrame_Enum referenceFrame = EphemerisSet_Ingest_referenceFrame_Enum_J2000,
    EphemerisSet_Ingest_covReferenceFrame_Enum covReferenceFrame = EphemerisSet_Ingest_covReferenceFrame_Enum_J2000,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0,
    ::flatbuffers::Offset<::flatbuffers::String> source = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origin = 0,
    EphemerisSet_Ingest_dataMode_Enum dataMode = EphemerisSet_Ingest_dataMode_Enum_REAL,
    int32_t satNo = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> ephemerisList = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags = 0,
    ::flatbuffers::Offset<::flatbuffers::String> transactionId = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  EphemerisSet_IngestBuilder builder_(_fbb);
  builder_.add_edr(edr);
  builder_.add_bDot(bDot);
  builder_.add_origNetwork(origNetwork);
  builder_.add_transactionId(transactionId);
  builder_.add_tags(tags);
  builder_.add_ephemerisList(ephemerisList);
...
inline ::flatbuffers::Offset<EphemerisSet_Ingest> CreateEphemerisSet_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ...
    EphemerisSet_Ingest_dataMode_Enum dataMode = EphemerisSet_Ingest_dataMode_Enum_REAL,
    int32_t satNo = 0,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *ephemerisList = nullptr,
  ...
  auto ephemerisList__ = ephemerisList ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*ephemerisList) : 0;
  auto tags__ = tags ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*tags) : 0;
  auto transactionId__ = transactionId ? _fbb.CreateString(transactionId) : 0;
  auto origNetwork__ = origNetwork ? _fbb.CreateString(origNetwork) : 0;
  return CreateEphemerisSet_Ingest(
      _fbb,
      id__,
...
inline const EphemerisSet_Ingest *GetEphemerisSet_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<EphemerisSet_Ingest>(buf);
}

inline const EphemerisSet_Ingest *GetSizePrefixedEphemerisSet_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EphemerisSet_Ingest>(buf);
}

inline const char *EphemerisSet_IngestIdentifier() {
  return "EPHE";
}

inline bool EphemerisSet_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EphemerisSet_IngestIdentifier());
}

inline bool SizePrefixedEphemerisSet_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EphemerisSet_IngestIdentifier(), true);
}

inline bool VerifyEphemerisSet_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EphemerisSet_Ingest>(EphemerisSet_IngestIdentifier());
}

inline bool VerifySizePrefixedEphemerisSet_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EphemerisSet_Ingest>(EphemerisSet_IngestIdentifier());
}

inline void FinishEphemerisSet_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EphemerisSet_Ingest> root) {
  fbb.Finish(root, EphemerisSet_IngestIdentifier());
}

inline void FinishSizePrefixedEphemerisSet_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EphemerisSet_Ingest> root) {
  fbb.FinishSizePrefixed(root, EphemerisSet_IngestIdentifier());
}
