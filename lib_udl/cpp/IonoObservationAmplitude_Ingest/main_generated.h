...
struct IonoObservationAmplitude_Ingest;
struct IonoObservationAmplitude_IngestBuilder;
...
struct IonoObservationAmplitude_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef IonoObservationAmplitude_IngestBuilder Builder;
...
struct IonoObservationAmplitude_IngestBuilder {
  typedef IonoObservationAmplitude_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(IonoObservationAmplitude_Ingest::VT_NOTES, notes);
  }
  void add_dimensions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dimensions) {
    fbb_.AddOffset(IonoObservationAmplitude_Ingest::VT_DIMENSIONS, dimensions);
  }
  void add_dimensionName(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dimensionName) {
    fbb_.AddOffset(IonoObservationAmplitude_Ingest::VT_DIMENSIONNAME, dimensionName);
  }
  void add_data(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> data) {
    fbb_.AddOffset(IonoObservationAmplitude_Ingest::VT_DATA, data);
  }
  explicit IonoObservationAmplitude_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<IonoObservationAmplitude_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<IonoObservationAmplitude_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<IonoObservationAmplitude_Ingest> CreateIonoObservationAmplitude_Ingest(
  ...
  IonoObservationAmplitude_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<IonoObservationAmplitude_Ingest> CreateIonoObservationAmplitude_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const IonoObservationAmplitude_Ingest *GetIonoObservationAmplitude_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<IonoObservationAmplitude_Ingest>(buf);
}

inline const IonoObservationAmplitude_Ingest *GetSizePrefixedIonoObservationAmplitude_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<IonoObservationAmplitude_Ingest>(buf);
}

inline const char *IonoObservationAmplitude_IngestIdentifier() {
  return "IONO";
}

inline bool IonoObservationAmplitude_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationAmplitude_IngestIdentifier());
}

inline bool SizePrefixedIonoObservationAmplitude_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationAmplitude_IngestIdentifier(), true);
}

inline bool VerifyIonoObservationAmplitude_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<IonoObservationAmplitude_Ingest>(IonoObservationAmplitude_IngestIdentifier());
}

inline bool VerifySizePrefixedIonoObservationAmplitude_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<IonoObservationAmplitude_Ingest>(IonoObservationAmplitude_IngestIdentifier());
}

inline void FinishIonoObservationAmplitude_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationAmplitude_Ingest> root) {
  fbb.Finish(root, IonoObservationAmplitude_IngestIdentifier());
}

inline void FinishSizePrefixedIonoObservationAmplitude_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationAmplitude_Ingest> root) {
  fbb.FinishSizePrefixed(root, IonoObservationAmplitude_IngestIdentifier());
}
