...
struct AirspaceControlMeans_Ingest;
struct AirspaceControlMeans_IngestBuilder;

enum AirspaceControlMeans_Ingest_cmShape_Enum : int8_t {
  /// No description available.
  AirspaceControlMeans_Ingest_cmShape_Enum_POLYARC = 0,
  /// No description available.
  AirspaceControlMeans_Ingest_cmShape_Enum_E1TRACK = 1,
  /// No description available.
  AirspaceControlMeans_Ingest_cmShape_Enum_POLYGON = 2,
  /// No description available.
  AirspaceControlMeans_Ingest_cmShape_Enum_CIRCLE = 3,
  /// No description available.
  AirspaceControlMeans_Ingest_cmShape_Enum_CORRIDOR = 4,
  /// No description available.
  AirspaceControlMeans_Ingest_cmShape_Enum_APOINT = 5,
  /// No description available.
  AirspaceControlMeans_Ingest_cmShape_Enum_AORBIT = 6,
  /// No description available.
  AirspaceControlMeans_Ingest_cmShape_Enum_GEOLINE = 7,
  AirspaceControlMeans_Ingest_cmShape_Enum_MIN = AirspaceControlMeans_Ingest_cmShape_Enum_POLYARC,
  AirspaceControlMeans_Ingest_cmShape_Enum_MAX = AirspaceControlMeans_Ingest_cmShape_Enum_GEOLINE
};

inline const AirspaceControlMeans_Ingest_cmShape_Enum (&EnumValuesAirspaceControlMeans_Ingest_cmShape_Enum())[8] {
  static const AirspaceControlMeans_Ingest_cmShape_Enum values[] = {
    AirspaceControlMeans_Ingest_cmShape_Enum_POLYARC,
    AirspaceControlMeans_Ingest_cmShape_Enum_E1TRACK,
    AirspaceControlMeans_Ingest_cmShape_Enum_POLYGON,
    AirspaceControlMeans_Ingest_cmShape_Enum_CIRCLE,
    AirspaceControlMeans_Ingest_cmShape_Enum_CORRIDOR,
    AirspaceControlMeans_Ingest_cmShape_Enum_APOINT,
    AirspaceControlMeans_Ingest_cmShape_Enum_AORBIT,
    AirspaceControlMeans_Ingest_cmShape_Enum_GEOLINE
  };
  return values;
}

inline const char * const *EnumNamesAirspaceControlMeans_Ingest_cmShape_Enum() {
...
inline const char *EnumNameAirspaceControlMeans_Ingest_cmShape_Enum(AirspaceControlMeans_Ingest_cmShape_Enum e) {
  if (::flatbuffers::IsOutRange(e, AirspaceControlMeans_Ingest_cmShape_Enum_POLYARC, AirspaceControlMeans_Ingest_cmShape_Enum_GEOLINE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAirspaceControlMeans_Ingest_cmShape_Enum()[index];
}

/// /// A conditional nested segment to report multiple airspace control means within a particular airspace control means status.
struct AirspaceControlMeans_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirspaceControlMeans_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 0, Maximum length = 8
  AirspaceControlMeans_Ingest_cmShape_Enum cmShape() const {
    return static_cast<AirspaceControlMeans_Ingest_cmShape_Enum>(GetField<int8_t>(VT_CMSHAPE, 0));
  }
...
struct AirspaceControlMeans_IngestBuilder {
  typedef AirspaceControlMeans_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_cmType(::flatbuffers::Offset<::flatbuffers::String> cmType) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_CMTYPE, cmType);
  }
  void add_cmId(::flatbuffers::Offset<::flatbuffers::String> cmId) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_CMID, cmId);
  }
  void add_cmShape(AirspaceControlMeans_Ingest_cmShape_Enum cmShape) {
    fbb_.AddElement<int8_t>(AirspaceControlMeans_Ingest::VT_CMSHAPE, static_cast<int8_t>(cmShape), 0);
  }
  void add_usage(::flatbuffers::Offset<::flatbuffers::String> usage) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_USAGE, usage);
  }
  void add_link16Id(::flatbuffers::Offset<::flatbuffers::String> link16Id) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_LINK16ID, link16Id);
  }
  void add_transAltitude(::flatbuffers::Offset<::flatbuffers::String> transAltitude) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_TRANSALTITUDE, transAltitude);
  }
  void add_geoDatumAlt(::flatbuffers::Offset<::flatbuffers::String> geoDatumAlt) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_GEODATUMALT, geoDatumAlt);
  }
  void add_coord0(::flatbuffers::Offset<::flatbuffers::String> coord0) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_COORD0, coord0);
  }
  void add_coord1(::flatbuffers::Offset<::flatbuffers::String> coord1) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_COORD1, coord1);
  }
  void add_bearing0(double bearing0) {
    fbb_.AddElement<double>(AirspaceControlMeans_Ingest::VT_BEARING0, bearing0, 0.0);
  }
  void add_bearing1(double bearing1) {
    fbb_.AddElement<double>(AirspaceControlMeans_Ingest::VT_BEARING1, bearing1, 0.0);
  }
  void add_radMag0(double radMag0) {
    fbb_.AddElement<double>(AirspaceControlMeans_Ingest::VT_RADMAG0, radMag0, 0.0);
  }
  void add_radMag1(double radMag1) {
    fbb_.AddElement<double>(AirspaceControlMeans_Ingest::VT_RADMAG1, radMag1, 0.0);
  }
  void add_radMagUnit(::flatbuffers::Offset<::flatbuffers::String> radMagUnit) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_RADMAGUNIT, radMagUnit);
  }
  void add_polyCoord(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> polyCoord) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_POLYCOORD, polyCoord);
  }
  void add_trackLeg(int32_t trackLeg) {
    fbb_.AddElement<int32_t>(AirspaceControlMeans_Ingest::VT_TRACKLEG, trackLeg, 0);
  }
  void add_widthLeft(double widthLeft) {
    fbb_.AddElement<double>(AirspaceControlMeans_Ingest::VT_WIDTHLEFT, widthLeft, 0.0);
  }
  void add_widthRight(double widthRight) {
    fbb_.AddElement<double>(AirspaceControlMeans_Ingest::VT_WIDTHRIGHT, widthRight, 0.0);
  }
  void add_width(double width) {
    fbb_.AddElement<double>(AirspaceControlMeans_Ingest::VT_WIDTH, width, 0.0);
  }
  void add_widthUnit(::flatbuffers::Offset<::flatbuffers::String> widthUnit) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_WIDTHUNIT, widthUnit);
  }
  void add_corrWayPoints(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> corrWayPoints) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_CORRWAYPOINTS, corrWayPoints);
  }
  void add_orbitAlignment(::flatbuffers::Offset<::flatbuffers::String> orbitAlignment) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_ORBITALIGNMENT, orbitAlignment);
  }
  void add_effVDim(::flatbuffers::Offset<::flatbuffers::String> effVDim) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_EFFVDIM, effVDim);
  }
  void add_airspaceTimePeriod(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> airspaceTimePeriod) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_AIRSPACETIMEPERIOD, airspaceTimePeriod);
  }
  void add_airspaceControlPoint(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> airspaceControlPoint) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_AIRSPACECONTROLPOINT, airspaceControlPoint);
  }
  void add_ctrlAuth(::flatbuffers::Offset<::flatbuffers::String> ctrlAuth) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_CTRLAUTH, ctrlAuth);
  }
  void add_ctrlAuthFreqs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> ctrlAuthFreqs) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_CTRLAUTHFREQS, ctrlAuthFreqs);
  }
  void add_genTextInd(::flatbuffers::Offset<::flatbuffers::String> genTextInd) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_GENTEXTIND, genTextInd);
  }
  void add_freeText(::flatbuffers::Offset<::flatbuffers::String> freeText) {
    fbb_.AddOffset(AirspaceControlMeans_Ingest::VT_FREETEXT, freeText);
  }
  explicit AirspaceControlMeans_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirspaceControlMeans_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirspaceControlMeans_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirspaceControlMeans_Ingest> CreateAirspaceControlMeans_Ingest(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::String> cmType = 0,
    ::flatbuffers::Offset<::flatbuffers::String> cmId = 0,
    AirspaceControlMeans_Ingest_cmShape_Enum cmShape = AirspaceControlMeans_Ingest_cmShape_Enum_POLYARC,
  ...
  AirspaceControlMeans_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirspaceControlMeans_Ingest> CreateAirspaceControlMeans_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAirspaceControlMeans_Ingest(
      _fbb,
      cmType__,
      cmId__,
      cmShape,
...
inline const AirspaceControlMeans_Ingest *GetAirspaceControlMeans_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<AirspaceControlMeans_Ingest>(buf);
}

inline const AirspaceControlMeans_Ingest *GetSizePrefixedAirspaceControlMeans_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirspaceControlMeans_Ingest>(buf);
}

inline const char *AirspaceControlMeans_IngestIdentifier() {
  return "AIRS";
}

inline bool AirspaceControlMeans_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirspaceControlMeans_IngestIdentifier());
}

inline bool SizePrefixedAirspaceControlMeans_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirspaceControlMeans_IngestIdentifier(), true);
}

inline bool VerifyAirspaceControlMeans_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirspaceControlMeans_Ingest>(AirspaceControlMeans_IngestIdentifier());
}

inline bool VerifySizePrefixedAirspaceControlMeans_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirspaceControlMeans_Ingest>(AirspaceControlMeans_IngestIdentifier());
}

inline void FinishAirspaceControlMeans_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirspaceControlMeans_Ingest> root) {
  fbb.Finish(root, AirspaceControlMeans_IngestIdentifier());
}

inline void FinishSizePrefixedAirspaceControlMeans_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirspaceControlMeans_Ingest> root) {
  fbb.FinishSizePrefixed(root, AirspaceControlMeans_IngestIdentifier());
}
