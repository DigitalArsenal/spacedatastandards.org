...
struct LaunchDetection_Full;
struct LaunchDetection_FullBuilder;

enum LaunchDetection_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  LaunchDetection_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  LaunchDetection_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  LaunchDetection_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  LaunchDetection_Full_dataMode_Enum_EXERCISE = 3,
  LaunchDetection_Full_dataMode_Enum_MIN = LaunchDetection_Full_dataMode_Enum_REAL,
  LaunchDetection_Full_dataMode_Enum_MAX = LaunchDetection_Full_dataMode_Enum_EXERCISE
};

inline const LaunchDetection_Full_dataMode_Enum (&EnumValuesLaunchDetection_Full_dataMode_Enum())[4] {
  static const LaunchDetection_Full_dataMode_Enum values[] = {
    LaunchDetection_Full_dataMode_Enum_REAL,
    LaunchDetection_Full_dataMode_Enum_TEST,
    LaunchDetection_Full_dataMode_Enum_SIMULATED,
    LaunchDetection_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesLaunchDetection_Full_dataMode_Enum() {
...
inline const char *EnumNameLaunchDetection_Full_dataMode_Enum(LaunchDetection_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, LaunchDetection_Full_dataMode_Enum_REAL, LaunchDetection_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesLaunchDetection_Full_dataMode_Enum()[index];
}

/// /// Data to analyze launch detections.
struct LaunchDetection_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LaunchDetection_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  LaunchDetection_Full_dataMode_Enum dataMode() const {
    return static_cast<LaunchDetection_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct LaunchDetection_FullBuilder {
  typedef LaunchDetection_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(LaunchDetection_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(LaunchDetection_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_launchTime(::flatbuffers::Offset<::flatbuffers::String> launchTime) {
    fbb_.AddOffset(LaunchDetection_Full::VT_LAUNCHTIME, launchTime);
  }
  void add_messageType(::flatbuffers::Offset<::flatbuffers::String> messageType) {
    fbb_.AddOffset(LaunchDetection_Full::VT_MESSAGETYPE, messageType);
  }
  void add_launchLatitude(double launchLatitude) {
    fbb_.AddElement<double>(LaunchDetection_Full::VT_LAUNCHLATITUDE, launchLatitude, 0.0);
  }
  void add_launchLongitude(double launchLongitude) {
    fbb_.AddElement<double>(LaunchDetection_Full::VT_LAUNCHLONGITUDE, launchLongitude, 0.0);
  }
  void add_launchAzimuth(double launchAzimuth) {
    fbb_.AddElement<double>(LaunchDetection_Full::VT_LAUNCHAZIMUTH, launchAzimuth, 0.0);
  }
  void add_raan(double raan) {
    fbb_.AddElement<double>(LaunchDetection_Full::VT_RAAN, raan, 0.0);
  }
  void add_inclination(double inclination) {
    fbb_.AddElement<double>(LaunchDetection_Full::VT_INCLINATION, inclination, 0.0);
  }
  void add_observationTime(::flatbuffers::Offset<::flatbuffers::String> observationTime) {
    fbb_.AddOffset(LaunchDetection_Full::VT_OBSERVATIONTIME, observationTime);
  }
  void add_observationLatitude(double observationLatitude) {
    fbb_.AddElement<double>(LaunchDetection_Full::VT_OBSERVATIONLATITUDE, observationLatitude, 0.0);
  }
  void add_observationLongitude(double observationLongitude) {
    fbb_.AddElement<double>(LaunchDetection_Full::VT_OBSERVATIONLONGITUDE, observationLongitude, 0.0);
  }
  void add_observationAltitude(double observationAltitude) {
    fbb_.AddElement<double>(LaunchDetection_Full::VT_OBSERVATIONALTITUDE, observationAltitude, 0.0);
  }
  void add_stereoFlag(bool stereoFlag) {
    fbb_.AddElement<uint8_t>(LaunchDetection_Full::VT_STEREOFLAG, static_cast<uint8_t>(stereoFlag), 0);
  }
  void add_highZenithAzimuth(bool highZenithAzimuth) {
    fbb_.AddElement<uint8_t>(LaunchDetection_Full::VT_HIGHZENITHAZIMUTH, static_cast<uint8_t>(highZenithAzimuth), 0);
  }
  void add_sequenceNumber(int32_t sequenceNumber) {
    fbb_.AddElement<int32_t>(LaunchDetection_Full::VT_SEQUENCENUMBER, sequenceNumber, 0);
  }
  void add_eventId(::flatbuffers::Offset<::flatbuffers::String> eventId) {
    fbb_.AddOffset(LaunchDetection_Full::VT_EVENTID, eventId);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(LaunchDetection_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(LaunchDetection_Full::VT_ORIGIN, origin);
  }
  void add_descriptor(::flatbuffers::Offset<::flatbuffers::String> descriptor) {
    fbb_.AddOffset(LaunchDetection_Full::VT_DESCRIPTOR, descriptor);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(LaunchDetection_Full::VT_TAGS, tags);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(LaunchDetection_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(LaunchDetection_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(LaunchDetection_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(LaunchDetection_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(LaunchDetection_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(LaunchDetection_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(LaunchDetection_Full::VT_UPDATEDBY, updatedBy);
  }
  explicit LaunchDetection_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LaunchDetection_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LaunchDetection_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LaunchDetection_Full> CreateLaunchDetection_Full(
    ...
    LaunchDetection_Full_dataMode_Enum dataMode = LaunchDetection_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0,
    ::flatbuffers::Offset<::flatbuffers::String> updatedAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> updatedBy = 0) {
  LaunchDetection_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<LaunchDetection_Full> CreateLaunchDetection_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateLaunchDetection_Full(
      _fbb,
      id__,
...
inline const LaunchDetection_Full *GetLaunchDetection_Full(const void *buf) {
  return ::flatbuffers::GetRoot<LaunchDetection_Full>(buf);
}

inline const LaunchDetection_Full *GetSizePrefixedLaunchDetection_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<LaunchDetection_Full>(buf);
}

inline const char *LaunchDetection_FullIdentifier() {
  return "LAUN";
}

inline bool LaunchDetection_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LaunchDetection_FullIdentifier());
}

inline bool SizePrefixedLaunchDetection_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LaunchDetection_FullIdentifier(), true);
}

inline bool VerifyLaunchDetection_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<LaunchDetection_Full>(LaunchDetection_FullIdentifier());
}

inline bool VerifySizePrefixedLaunchDetection_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<LaunchDetection_Full>(LaunchDetection_FullIdentifier());
}

inline void FinishLaunchDetection_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LaunchDetection_Full> root) {
  fbb.Finish(root, LaunchDetection_FullIdentifier());
}

inline void FinishSizePrefixedLaunchDetection_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LaunchDetection_Full> root) {
  fbb.FinishSizePrefixed(root, LaunchDetection_FullIdentifier());
}
