...
struct AircraftMissionLocationTasking_Abridged;
...
struct AircraftMissionLocationTasking_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AircraftMissionLocationTasking_AbridgedBuilder Builder;
...
struct AircraftMissionLocationTasking_AbridgedBuilder {
  typedef AircraftMissionLocationTasking_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(AircraftMissionLocationTasking_Abridged::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(AircraftMissionLocationTasking_Abridged::VT_ENDTIME, endTime);
  }
  void add_msnLocName(::flatbuffers::Offset<::flatbuffers::String> msnLocName) {
    fbb_.AddOffset(AircraftMissionLocationTasking_Abridged::VT_MSNLOCNAME, msnLocName);
  }
  void add_alt(int32_t alt) {
    fbb_.AddElement<int32_t>(AircraftMissionLocationTasking_Abridged::VT_ALT, alt, 0);
  }
  void add_airMsnPri(::flatbuffers::Offset<::flatbuffers::String> airMsnPri) {
    fbb_.AddOffset(AircraftMissionLocationTasking_Abridged::VT_AIRMSNPRI, airMsnPri);
  }
  void add_areaGeoRad(int32_t areaGeoRad) {
    fbb_.AddElement<int32_t>(AircraftMissionLocationTasking_Abridged::VT_AREAGEORAD, areaGeoRad, 0);
  }
  void add_msnLocPtName(::flatbuffers::Offset<::flatbuffers::String> msnLocPtName) {
    fbb_.AddOffset(AircraftMissionLocationTasking_Abridged::VT_MSNLOCPTNAME, msnLocPtName);
  }
  void add_msnLocPtLat(double msnLocPtLat) {
    fbb_.AddElement<double>(AircraftMissionLocationTasking_Abridged::VT_MSNLOCPTLAT, msnLocPtLat, 0.0);
  }
  void add_msnLocPtLon(double msnLocPtLon) {
    fbb_.AddElement<double>(AircraftMissionLocationTasking_Abridged::VT_MSNLOCPTLON, msnLocPtLon, 0.0);
  }
  void add_msnLocPtBarT(::flatbuffers::Offset<::flatbuffers::String> msnLocPtBarT) {
    fbb_.AddOffset(AircraftMissionLocationTasking_Abridged::VT_MSNLOCPTBART, msnLocPtBarT);
  }
  explicit AircraftMissionLocationTasking_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AircraftMissionLocationTasking_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AircraftMissionLocationTasking_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AircraftMissionLocationTasking_Abridged> CreateAircraftMissionLocationTasking_Abridged(
  ...
  AircraftMissionLocationTasking_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AircraftMissionLocationTasking_Abridged> CreateAircraftMissionLocationTasking_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AircraftMissionLocationTasking_Abridged *GetAircraftMissionLocationTasking_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<AircraftMissionLocationTasking_Abridged>(buf);
}

inline const AircraftMissionLocationTasking_Abridged *GetSizePrefixedAircraftMissionLocationTasking_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AircraftMissionLocationTasking_Abridged>(buf);
}

inline const char *AircraftMissionLocationTasking_AbridgedIdentifier() {
  return "AIRC";
}

inline bool AircraftMissionLocationTasking_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftMissionLocationTasking_AbridgedIdentifier());
}

inline bool SizePrefixedAircraftMissionLocationTasking_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftMissionLocationTasking_AbridgedIdentifier(), true);
}

inline bool VerifyAircraftMissionLocationTasking_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AircraftMissionLocationTasking_Abridged>(AircraftMissionLocationTasking_AbridgedIdentifier());
}

inline bool VerifySizePrefixedAircraftMissionLocationTasking_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AircraftMissionLocationTasking_Abridged>(AircraftMissionLocationTasking_AbridgedIdentifier());
}

inline void FinishAircraftMissionLocationTasking_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftMissionLocationTasking_Abridged> root) {
  fbb.Finish(root, AircraftMissionLocationTasking_AbridgedIdentifier());
}

inline void FinishSizePrefixedAircraftMissionLocationTasking_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftMissionLocationTasking_Abridged> root) {
  fbb.FinishSizePrefixed(root, AircraftMissionLocationTasking_AbridgedIdentifier());
}
