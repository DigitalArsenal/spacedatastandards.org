...
struct DiffOfArrival_Ingest;
struct DiffOfArrival_IngestBuilder;

enum DiffOfArrival_Ingest_dataMode_Enum : int8_t {
  ...
  DiffOfArrival_Ingest_dataMode_Enum_MIN = DiffOfArrival_Ingest_dataMode_Enum_REAL,
  DiffOfArrival_Ingest_dataMode_Enum_MAX = DiffOfArrival_Ingest_dataMode_Enum_EXERCISE
};

inline const DiffOfArrival_Ingest_dataMode_Enum (&EnumValuesDiffOfArrival_Ingest_dataMode_Enum())[4] {
  static const DiffOfArrival_Ingest_dataMode_Enum values[] = {
    DiffOfArrival_Ingest_dataMode_Enum_REAL,
    DiffOfArrival_Ingest_dataMode_Enum_TEST,
    DiffOfArrival_Ingest_dataMode_Enum_SIMULATED,
    DiffOfArrival_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesDiffOfArrival_Ingest_dataMode_Enum() {
...
inline const char *EnumNameDiffOfArrival_Ingest_dataMode_Enum(DiffOfArrival_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, DiffOfArrival_Ingest_dataMode_Enum_REAL, DiffOfArrival_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesDiffOfArrival_Ingest_dataMode_Enum()[index];
}
...
struct DiffOfArrival_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef DiffOfArrival_IngestBuilder Builder;
  ...
  DiffOfArrival_Ingest_dataMode_Enum dataMode() const {
    return static_cast<DiffOfArrival_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct DiffOfArrival_IngestBuilder {
  typedef DiffOfArrival_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_obTime(::flatbuffers::Offset<::flatbuffers::String> obTime) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_OBTIME, obTime);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_idSensor1(::flatbuffers::Offset<::flatbuffers::String> idSensor1) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_IDSENSOR1, idSensor1);
  }
  void add_idSensor2(::flatbuffers::Offset<::flatbuffers::String> idSensor2) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_IDSENSOR2, idSensor2);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(DiffOfArrival_Ingest::VT_SATNO, satNo, 0);
  }
  void add_taskId(::flatbuffers::Offset<::flatbuffers::String> taskId) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_TASKID, taskId);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_ORIGOBJECTID, origObjectId);
  }
  void add_origSensorId1(::flatbuffers::Offset<::flatbuffers::String> origSensorId1) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_ORIGSENSORID1, origSensorId1);
  }
  void add_origSensorId2(::flatbuffers::Offset<::flatbuffers::String> origSensorId2) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_ORIGSENSORID2, origSensorId2);
  }
  void add_uct(bool uct) {
    fbb_.AddElement<uint8_t>(DiffOfArrival_Ingest::VT_UCT, static_cast<uint8_t>(uct), 0);
  }
  void add_sensor1Delay(double sensor1Delay) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_SENSOR1DELAY, sensor1Delay, 0.0);
  }
  void add_sensor2Delay(double sensor2Delay) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_SENSOR2DELAY, sensor2Delay, 0.0);
  }
  void add_senlat(double senlat) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_SENLAT, senlat, 0.0);
  }
  void add_senlon(double senlon) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_SENLON, senlon, 0.0);
  }
  void add_senalt(double senalt) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_SENALT, senalt, 0.0);
  }
  void add_sen2lat(double sen2lat) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_SEN2LAT, sen2lat, 0.0);
  }
  void add_sen2lon(double sen2lon) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_SEN2LON, sen2lon, 0.0);
  }
  void add_sen2alt(double sen2alt) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_SEN2ALT, sen2alt, 0.0);
  }
  void add_frequency(double frequency) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_FREQUENCY, frequency, 0.0);
  }
  void add_bandwidth(double bandwidth) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_BANDWIDTH, bandwidth, 0.0);
  }
  void add_deltaRange(double deltaRange) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_DELTARANGE, deltaRange, 0.0);
  }
  void add_deltaRangeUnc(double deltaRangeUnc) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_DELTARANGEUNC, deltaRangeUnc, 0.0);
  }
  void add_deltaRangeRate(double deltaRangeRate) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_DELTARANGERATE, deltaRangeRate, 0.0);
  }
  void add_deltaRangeRateUnc(double deltaRangeRateUnc) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_DELTARANGERATEUNC, deltaRangeRateUnc, 0.0);
  }
  void add_snr(double snr) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_SNR, snr, 0.0);
  }
  void add_tdoa(double tdoa) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_TDOA, tdoa, 0.0);
  }
  void add_tdoaUnc(double tdoaUnc) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_TDOAUNC, tdoaUnc, 0.0);
  }
  void add_fdoa(double fdoa) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_FDOA, fdoa, 0.0);
  }
  void add_fdoaUnc(double fdoaUnc) {
    fbb_.AddElement<double>(DiffOfArrival_Ingest::VT_FDOAUNC, fdoaUnc, 0.0);
  }
  void add_collectionMode(::flatbuffers::Offset<::flatbuffers::String> collectionMode) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_COLLECTIONMODE, collectionMode);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_RAWFILEURI, rawFileURI);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_SOURCE, source);
  }
  void add_dataMode(DiffOfArrival_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(DiffOfArrival_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_TAGS, tags);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_ORIGIN, origin);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_descriptor(::flatbuffers::Offset<::flatbuffers::String> descriptor) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_DESCRIPTOR, descriptor);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_TRANSACTIONID, transactionId);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(DiffOfArrival_Ingest::VT_SOURCEDL, sourceDL);
  }
  explicit DiffOfArrival_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<DiffOfArrival_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<DiffOfArrival_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<DiffOfArrival_Ingest> CreateDiffOfArrival_Ingest(
    ...
    DiffOfArrival_Ingest_dataMode_Enum dataMode = DiffOfArrival_Ingest_dataMode_Enum_REAL,
  ...
  DiffOfArrival_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<DiffOfArrival_Ingest> CreateDiffOfArrival_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const DiffOfArrival_Ingest *GetDiffOfArrival_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<DiffOfArrival_Ingest>(buf);
}

inline const DiffOfArrival_Ingest *GetSizePrefixedDiffOfArrival_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<DiffOfArrival_Ingest>(buf);
}

inline const char *DiffOfArrival_IngestIdentifier() {
  return "DIFF";
}

inline bool DiffOfArrival_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DiffOfArrival_IngestIdentifier());
}

inline bool SizePrefixedDiffOfArrival_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DiffOfArrival_IngestIdentifier(), true);
}

inline bool VerifyDiffOfArrival_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<DiffOfArrival_Ingest>(DiffOfArrival_IngestIdentifier());
}

inline bool VerifySizePrefixedDiffOfArrival_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<DiffOfArrival_Ingest>(DiffOfArrival_IngestIdentifier());
}

inline void FinishDiffOfArrival_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DiffOfArrival_Ingest> root) {
  fbb.Finish(root, DiffOfArrival_IngestIdentifier());
}

inline void FinishSizePrefixedDiffOfArrival_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DiffOfArrival_Ingest> root) {
  fbb.FinishSizePrefixed(root, DiffOfArrival_IngestIdentifier());
}
