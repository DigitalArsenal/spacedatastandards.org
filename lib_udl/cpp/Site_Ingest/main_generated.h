...
struct Site_Ingest;
struct Site_IngestBuilder;

enum Site_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Site_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Site_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Site_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Site_Ingest_dataMode_Enum_EXERCISE = 3,
  Site_Ingest_dataMode_Enum_MIN = Site_Ingest_dataMode_Enum_REAL,
  Site_Ingest_dataMode_Enum_MAX = Site_Ingest_dataMode_Enum_EXERCISE
};

inline const Site_Ingest_dataMode_Enum (&EnumValuesSite_Ingest_dataMode_Enum())[4] {
  static const Site_Ingest_dataMode_Enum values[] = {
    Site_Ingest_dataMode_Enum_REAL,
    Site_Ingest_dataMode_Enum_TEST,
    Site_Ingest_dataMode_Enum_SIMULATED,
    Site_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSite_Ingest_dataMode_Enum() {
...
inline const char *EnumNameSite_Ingest_dataMode_Enum(Site_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Site_Ingest_dataMode_Enum_REAL, Site_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSite_Ingest_dataMode_Enum()[index];
}

/// /// Properties and characteristics of a site entity, such as an airbase, airfield, naval station, etc.
struct Site_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Site_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Site_Ingest_dataMode_Enum dataMode() const {
    return static_cast<Site_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Site_IngestBuilder {
  typedef Site_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Site_Ingest::VT_ID, id);
  }
  void add_entity(::flatbuffers::Offset<::flatbuffers::String> entity) {
    fbb_.AddOffset(Site_Ingest::VT_ENTITY, entity);
  }
  void add_idEntity(::flatbuffers::Offset<::flatbuffers::String> idEntity) {
    fbb_.AddOffset(Site_Ingest::VT_IDENTITY, idEntity);
  }
  void add_idParentSite(::flatbuffers::Offset<::flatbuffers::String> idParentSite) {
    fbb_.AddOffset(Site_Ingest::VT_IDPARENTSITE, idParentSite);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Site_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_origSiteID(::flatbuffers::Offset<::flatbuffers::String> origSiteID) {
    fbb_.AddOffset(Site_Ingest::VT_ORIGSITEID, origSiteID);
  }
  void add_origLzId(::flatbuffers::Offset<::flatbuffers::String> origLzId) {
    fbb_.AddOffset(Site_Ingest::VT_ORIGLZID, origLzId);
  }
  void add_pin(::flatbuffers::Offset<::flatbuffers::String> pin) {
    fbb_.AddOffset(Site_Ingest::VT_PIN, pin);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(Site_Ingest::VT_TYPE, type);
  }
  void add_usage(::flatbuffers::Offset<::flatbuffers::String> usage) {
    fbb_.AddOffset(Site_Ingest::VT_USAGE, usage);
  }
  void add_lzUsage(::flatbuffers::Offset<::flatbuffers::String> lzUsage) {
    fbb_.AddOffset(Site_Ingest::VT_LZUSAGE, lzUsage);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(Site_Ingest::VT_NAME, name);
  }
  void add_coordDatum(::flatbuffers::Offset<::flatbuffers::String> coordDatum) {
    fbb_.AddOffset(Site_Ingest::VT_COORDDATUM, coordDatum);
  }
  void add_coord(::flatbuffers::Offset<::flatbuffers::String> coord) {
    fbb_.AddOffset(Site_Ingest::VT_COORD, coord);
  }
  void add_coordDerivAcc(double coordDerivAcc) {
    fbb_.AddElement<double>(Site_Ingest::VT_COORDDERIVACC, coordDerivAcc, 0.0);
  }
  void add_osuffix(::flatbuffers::Offset<::flatbuffers::String> osuffix) {
    fbb_.AddOffset(Site_Ingest::VT_OSUFFIX, osuffix);
  }
  void add_iata(::flatbuffers::Offset<::flatbuffers::String> iata) {
    fbb_.AddOffset(Site_Ingest::VT_IATA, iata);
  }
  void add_icao(::flatbuffers::Offset<::flatbuffers::String> icao) {
    fbb_.AddOffset(Site_Ingest::VT_ICAO, icao);
  }
  void add_faa(::flatbuffers::Offset<::flatbuffers::String> faa) {
    fbb_.AddOffset(Site_Ingest::VT_FAA, faa);
  }
  void add_airDefArea(::flatbuffers::Offset<::flatbuffers::String> airDefArea) {
    fbb_.AddOffset(Site_Ingest::VT_AIRDEFAREA, airDefArea);
  }
  void add_utm(::flatbuffers::Offset<::flatbuffers::String> utm) {
    fbb_.AddOffset(Site_Ingest::VT_UTM, utm);
  }
  void add_milGridSys(::flatbuffers::Offset<::flatbuffers::String> milGridSys) {
    fbb_.AddOffset(Site_Ingest::VT_MILGRIDSYS, milGridSys);
  }
  void add_milGrid(::flatbuffers::Offset<::flatbuffers::String> milGrid) {
    fbb_.AddOffset(Site_Ingest::VT_MILGRID, milGrid);
  }
  void add_catCode(::flatbuffers::Offset<::flatbuffers::String> catCode) {
    fbb_.AddOffset(Site_Ingest::VT_CATCODE, catCode);
  }
  void add_catText(::flatbuffers::Offset<::flatbuffers::String> catText) {
    fbb_.AddOffset(Site_Ingest::VT_CATTEXT, catText);
  }
  void add_wac(::flatbuffers::Offset<::flatbuffers::String> wac) {
    fbb_.AddOffset(Site_Ingest::VT_WAC, wac);
  }
  void add_polSubdiv(::flatbuffers::Offset<::flatbuffers::String> polSubdiv) {
    fbb_.AddOffset(Site_Ingest::VT_POLSUBDIV, polSubdiv);
  }
  void add_geoArea(::flatbuffers::Offset<::flatbuffers::String> geoArea) {
    fbb_.AddOffset(Site_Ingest::VT_GEOAREA, geoArea);
  }
  void add_geoidalMslSep(double geoidalMslSep) {
    fbb_.AddElement<double>(Site_Ingest::VT_GEOIDALMSLSEP, geoidalMslSep, 0.0);
  }
  void add_allegiance(::flatbuffers::Offset<::flatbuffers::String> allegiance) {
    fbb_.AddOffset(Site_Ingest::VT_ALLEGIANCE, allegiance);
  }
  void add_altAllegiance(::flatbuffers::Offset<::flatbuffers::String> altAllegiance) {
    fbb_.AddOffset(Site_Ingest::VT_ALTALLEGIANCE, altAllegiance);
  }
  void add_classRating(::flatbuffers::Offset<::flatbuffers::String> classRating) {
    fbb_.AddOffset(Site_Ingest::VT_CLASSRATING, classRating);
  }
  void add_fpa(::flatbuffers::Offset<::flatbuffers::String> fpa) {
    fbb_.AddOffset(Site_Ingest::VT_FPA, fpa);
  }
  void add_beNumber(::flatbuffers::Offset<::flatbuffers::String> beNumber) {
    fbb_.AddOffset(Site_Ingest::VT_BENUMBER, beNumber);
  }
  void add_runways(int32_t runways) {
    fbb_.AddElement<int32_t>(Site_Ingest::VT_RUNWAYS, runways, 0);
  }
  void add_maxRunwayLength(int32_t maxRunwayLength) {
    fbb_.AddElement<int32_t>(Site_Ingest::VT_MAXRUNWAYLENGTH, maxRunwayLength, 0);
  }
  void add_condition(::flatbuffers::Offset<::flatbuffers::String> condition) {
    fbb_.AddOffset(Site_Ingest::VT_CONDITION, condition);
  }
  void add_conditionAvail(::flatbuffers::Offset<::flatbuffers::String> conditionAvail) {
    fbb_.AddOffset(Site_Ingest::VT_CONDITIONAVAIL, conditionAvail);
  }
  void add_operStatus(::flatbuffers::Offset<::flatbuffers::String> operStatus) {
    fbb_.AddOffset(Site_Ingest::VT_OPERSTATUS, operStatus);
  }
  void add_grade(int32_t grade) {
    fbb_.AddElement<int32_t>(Site_Ingest::VT_GRADE, grade, 0);
  }
  void add_activity(::flatbuffers::Offset<::flatbuffers::String> activity) {
    fbb_.AddOffset(Site_Ingest::VT_ACTIVITY, activity);
  }
  void add_functPrimary(::flatbuffers::Offset<::flatbuffers::String> functPrimary) {
    fbb_.AddOffset(Site_Ingest::VT_FUNCTPRIMARY, functPrimary);
  }
  void add_msnPrimary(::flatbuffers::Offset<::flatbuffers::String> msnPrimary) {
    fbb_.AddOffset(Site_Ingest::VT_MSNPRIMARY, msnPrimary);
  }
  void add_msnPrimarySpec(::flatbuffers::Offset<::flatbuffers::String> msnPrimarySpec) {
    fbb_.AddOffset(Site_Ingest::VT_MSNPRIMARYSPEC, msnPrimarySpec);
  }
  void add_nucCap(::flatbuffers::Offset<::flatbuffers::String> nucCap) {
    fbb_.AddOffset(Site_Ingest::VT_NUCCAP, nucCap);
  }
  void add_ident(::flatbuffers::Offset<::flatbuffers::String> ident) {
    fbb_.AddOffset(Site_Ingest::VT_IDENT, ident);
  }
  void add_elevMsl(double elevMsl) {
    fbb_.AddElement<double>(Site_Ingest::VT_ELEVMSL, elevMsl, 0.0);
  }
  void add_elevMslConfLvl(int32_t elevMslConfLvl) {
    fbb_.AddElement<int32_t>(Site_Ingest::VT_ELEVMSLCONFLVL, elevMslConfLvl, 0);
  }
  void add_elevMslDerivAcc(double elevMslDerivAcc) {
    fbb_.AddElement<double>(Site_Ingest::VT_ELEVMSLDERIVACC, elevMslDerivAcc, 0.0);
  }
  void add_vegHt(double vegHt) {
    fbb_.AddElement<double>(Site_Ingest::VT_VEGHT, vegHt, 0.0);
  }
  void add_vegType(::flatbuffers::Offset<::flatbuffers::String> vegType) {
    fbb_.AddOffset(Site_Ingest::VT_VEGTYPE, vegType);
  }
  void add_popArea(bool popArea) {
    fbb_.AddElement<uint8_t>(Site_Ingest::VT_POPAREA, static_cast<uint8_t>(popArea), 0);
  }
  void add_popAreaProx(double popAreaProx) {
    fbb_.AddElement<double>(Site_Ingest::VT_POPAREAPROX, popAreaProx, 0.0);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(Site_Ingest::VT_NOTES, notes);
  }
  void add_resProd(::flatbuffers::Offset<::flatbuffers::String> resProd) {
    fbb_.AddOffset(Site_Ingest::VT_RESPROD, resProd);
  }
  void add_eval(int32_t eval) {
    fbb_.AddElement<int32_t>(Site_Ingest::VT_EVAL, eval, 0);
  }
  void add_reviewDate(::flatbuffers::Offset<::flatbuffers::String> reviewDate) {
    fbb_.AddOffset(Site_Ingest::VT_REVIEWDATE, reviewDate);
  }
  void add_recStatus(::flatbuffers::Offset<::flatbuffers::String> recStatus) {
    fbb_.AddOffset(Site_Ingest::VT_RECSTATUS, recStatus);
  }
  void add_symCode(::flatbuffers::Offset<::flatbuffers::String> symCode) {
    fbb_.AddOffset(Site_Ingest::VT_SYMCODE, symCode);
  }
  void add_referenceDoc(::flatbuffers::Offset<::flatbuffers::String> referenceDoc) {
    fbb_.AddOffset(Site_Ingest::VT_REFERENCEDOC, referenceDoc);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Site_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Site_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Site_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Site_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Site_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(Site_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Site_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit Site_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Site_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Site_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Site_Ingest> CreateSite_Ingest(
    ...
    Site_Ingest_dataMode_Enum dataMode = Site_Ingest_dataMode_Enum_REAL) {
  Site_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Site_Ingest> CreateSite_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Site_Ingest *GetSite_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<Site_Ingest>(buf);
}

inline const Site_Ingest *GetSizePrefixedSite_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Site_Ingest>(buf);
}

inline const char *Site_IngestIdentifier() {
  return "SITE";
}

inline bool Site_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Site_IngestIdentifier());
}

inline bool SizePrefixedSite_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Site_IngestIdentifier(), true);
}

inline bool VerifySite_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Site_Ingest>(Site_IngestIdentifier());
}

inline bool VerifySizePrefixedSite_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Site_Ingest>(Site_IngestIdentifier());
}

inline void FinishSite_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Site_Ingest> root) {
  fbb.Finish(root, Site_IngestIdentifier());
}

inline void FinishSizePrefixedSite_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Site_Ingest> root) {
  fbb.FinishSizePrefixed(root, Site_IngestIdentifier());
}
