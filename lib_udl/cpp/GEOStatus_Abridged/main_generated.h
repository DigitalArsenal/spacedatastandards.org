...
struct GEOStatus_Abridged;
struct GEOStatus_AbridgedBuilder;

enum GEOStatus_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  GEOStatus_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  GEOStatus_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  GEOStatus_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  GEOStatus_Abridged_dataMode_Enum_EXERCISE = 3,
  GEOStatus_Abridged_dataMode_Enum_MIN = GEOStatus_Abridged_dataMode_Enum_REAL,
  GEOStatus_Abridged_dataMode_Enum_MAX = GEOStatus_Abridged_dataMode_Enum_EXERCISE
};

inline const GEOStatus_Abridged_dataMode_Enum (&EnumValuesGEOStatus_Abridged_dataMode_Enum())[4] {
  static const GEOStatus_Abridged_dataMode_Enum values[] = {
    GEOStatus_Abridged_dataMode_Enum_REAL,
    GEOStatus_Abridged_dataMode_Enum_TEST,
    GEOStatus_Abridged_dataMode_Enum_SIMULATED,
    GEOStatus_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesGEOStatus_Abridged_dataMode_Enum() {
...
inline const char *EnumNameGEOStatus_Abridged_dataMode_Enum(GEOStatus_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, GEOStatus_Abridged_dataMode_Enum_REAL, GEOStatus_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesGEOStatus_Abridged_dataMode_Enum()[index];
}

/// /// Information for the specified on-orbit GEO spacecraft, including status, expected longitude limits, and drift rates.
struct GEOStatus_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef GEOStatus_AbridgedBuilder Builder;
  ...
  GEOStatus_Abridged_dataMode_Enum dataMode() const {
    return static_cast<GEOStatus_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct GEOStatus_AbridgedBuilder {
  typedef GEOStatus_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(GEOStatus_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(GEOStatus_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(GEOStatus_Abridged::VT_IDONORBIT, idOnOrbit);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(GEOStatus_Abridged::VT_ORIGOBJECTID, origObjectId);
  }
  void add_ss(double ss) {
    fbb_.AddElement<double>(GEOStatus_Abridged::VT_SS, ss, 0.0);
  }
  void add_sc(double sc) {
    fbb_.AddElement<double>(GEOStatus_Abridged::VT_SC, sc, 0.0);
  }
  void add_relativeEnergy(double relativeEnergy) {
    fbb_.AddElement<double>(GEOStatus_Abridged::VT_RELATIVEENERGY, relativeEnergy, 0.0);
  }
  void add_longitudeRate(double longitudeRate) {
    fbb_.AddElement<double>(GEOStatus_Abridged::VT_LONGITUDERATE, longitudeRate, 0.0);
  }
  void add_longitudeMin(double longitudeMin) {
    fbb_.AddElement<double>(GEOStatus_Abridged::VT_LONGITUDEMIN, longitudeMin, 0.0);
  }
  void add_longitudeMax(double longitudeMax) {
    fbb_.AddElement<double>(GEOStatus_Abridged::VT_LONGITUDEMAX, longitudeMax, 0.0);
  }
  void add_confidenceLevel(::flatbuffers::Offset<::flatbuffers::String> confidenceLevel) {
    fbb_.AddOffset(GEOStatus_Abridged::VT_CONFIDENCELEVEL, confidenceLevel);
  }
  void add_planeChangeStatus(::flatbuffers::Offset<::flatbuffers::String> planeChangeStatus) {
    fbb_.AddOffset(GEOStatus_Abridged::VT_PLANECHANGESTATUS, planeChangeStatus);
  }
  void add_troughType(::flatbuffers::Offset<::flatbuffers::String> troughType) {
    fbb_.AddOffset(GEOStatus_Abridged::VT_TROUGHTYPE, troughType);
  }
  void add_lostFlag(bool lostFlag) {
    fbb_.AddElement<uint8_t>(GEOStatus_Abridged::VT_LOSTFLAG, static_cast<uint8_t>(lostFlag), 0);
  }
  void add_semiAnnualCorrFlag(bool semiAnnualCorrFlag) {
    fbb_.AddElement<uint8_t>(GEOStatus_Abridged::VT_SEMIANNUALCORRFLAG, static_cast<uint8_t>(semiAnnualCorrFlag), 0);
  }
  void add_objectStatus(::flatbuffers::Offset<::flatbuffers::String> objectStatus) {
    fbb_.AddOffset(GEOStatus_Abridged::VT_OBJECTSTATUS, objectStatus);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(GEOStatus_Abridged::VT_RAWFILEURI, rawFileURI);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(GEOStatus_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(GEOStatus_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(GEOStatus_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(GEOStatus_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(GEOStatus_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(GEOStatus_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(GEOStatus_Abridged::VT_SATNO, satNo, 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(GEOStatus_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  explicit GEOStatus_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<GEOStatus_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<GEOStatus_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<GEOStatus_Abridged> CreateGEOStatus_Abridged(
    ...
    GEOStatus_Abridged_dataMode_Enum dataMode = GEOStatus_Abridged_dataMode_Enum_REAL,
    int32_t satNo = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  GEOStatus_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<GEOStatus_Abridged> CreateGEOStatus_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const GEOStatus_Abridged *GetGEOStatus_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<GEOStatus_Abridged>(buf);
}

inline const GEOStatus_Abridged *GetSizePrefixedGEOStatus_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<GEOStatus_Abridged>(buf);
}

inline const char *GEOStatus_AbridgedIdentifier() {
  return "GEOS";
}

inline bool GEOStatus_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, GEOStatus_AbridgedIdentifier());
}

inline bool SizePrefixedGEOStatus_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, GEOStatus_AbridgedIdentifier(), true);
}

inline bool VerifyGEOStatus_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<GEOStatus_Abridged>(GEOStatus_AbridgedIdentifier());
}

inline bool VerifySizePrefixedGEOStatus_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<GEOStatus_Abridged>(GEOStatus_AbridgedIdentifier());
}

inline void FinishGEOStatus_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<GEOStatus_Abridged> root) {
  fbb.Finish(root, GEOStatus_AbridgedIdentifier());
}

inline void FinishSizePrefixedGEOStatus_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<GEOStatus_Abridged> root) {
  fbb.FinishSizePrefixed(root, GEOStatus_AbridgedIdentifier());
}
