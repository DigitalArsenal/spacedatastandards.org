...
struct SeradataCommDetails_Full;
struct SeradataCommDetails_FullBuilder;

enum SeradataCommDetails_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  SeradataCommDetails_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  SeradataCommDetails_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  SeradataCommDetails_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  SeradataCommDetails_Full_dataMode_Enum_EXERCISE = 3,
  SeradataCommDetails_Full_dataMode_Enum_MIN = SeradataCommDetails_Full_dataMode_Enum_REAL,
  SeradataCommDetails_Full_dataMode_Enum_MAX = SeradataCommDetails_Full_dataMode_Enum_EXERCISE
};

inline const SeradataCommDetails_Full_dataMode_Enum (&EnumValuesSeradataCommDetails_Full_dataMode_Enum())[4] {
  static const SeradataCommDetails_Full_dataMode_Enum values[] = {
    SeradataCommDetails_Full_dataMode_Enum_REAL,
    SeradataCommDetails_Full_dataMode_Enum_TEST,
    SeradataCommDetails_Full_dataMode_Enum_SIMULATED,
    SeradataCommDetails_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSeradataCommDetails_Full_dataMode_Enum() {
...
inline const char *EnumNameSeradataCommDetails_Full_dataMode_Enum(SeradataCommDetails_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SeradataCommDetails_Full_dataMode_Enum_REAL, SeradataCommDetails_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSeradataCommDetails_Full_dataMode_Enum()[index];
}

/// /// Seradata-compiled information on communications payloads.
struct SeradataCommDetails_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SeradataCommDetails_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SeradataCommDetails_Full_dataMode_Enum dataMode() const {
    return static_cast<SeradataCommDetails_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SeradataCommDetails_FullBuilder {
  typedef SeradataCommDetails_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_ID, id);
  }
  void add_idComm(::flatbuffers::Offset<::flatbuffers::String> idComm) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_IDCOMM, idComm);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_spacecraftId(::flatbuffers::Offset<::flatbuffers::String> spacecraftId) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_SPACECRAFTID, spacecraftId);
  }
  void add_band(::flatbuffers::Offset<::flatbuffers::String> band) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_BAND, band);
  }
  void add_solidStatePowerAmp(double solidStatePowerAmp) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_SOLIDSTATEPOWERAMP, solidStatePowerAmp, 0.0);
  }
  void add_travelingWaveTubeAmplifier(double travelingWaveTubeAmplifier) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_TRAVELINGWAVETUBEAMPLIFIER, travelingWaveTubeAmplifier, 0.0);
  }
  void add_gatewayUplinkFrom(double gatewayUplinkFrom) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_GATEWAYUPLINKFROM, gatewayUplinkFrom, 0.0);
  }
  void add_gatewayUplinkTo(double gatewayUplinkTo) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_GATEWAYUPLINKTO, gatewayUplinkTo, 0.0);
  }
  void add_gatewayDownlinkFrom(double gatewayDownlinkFrom) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_GATEWAYDOWNLINKFROM, gatewayDownlinkFrom, 0.0);
  }
  void add_gatewayDownlinkTo(double gatewayDownlinkTo) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_GATEWAYDOWNLINKTO, gatewayDownlinkTo, 0.0);
  }
  void add_polarization(::flatbuffers::Offset<::flatbuffers::String> polarization) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_POLARIZATION, polarization);
  }
  void add_eirp(double eirp) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_EIRP, eirp, 0.0);
  }
  void add_bandwidth(double bandwidth) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_BANDWIDTH, bandwidth, 0.0);
  }
  void add_numOperationalTransponders(int32_t numOperationalTransponders) {
    fbb_.AddElement<int32_t>(SeradataCommDetails_Full::VT_NUMOPERATIONALTRANSPONDERS, numOperationalTransponders, 0);
  }
  void add_numSpareTransponders(int32_t numSpareTransponders) {
    fbb_.AddElement<int32_t>(SeradataCommDetails_Full::VT_NUMSPARETRANSPONDERS, numSpareTransponders, 0);
  }
  void add_hostedForCompanyOrgId(::flatbuffers::Offset<::flatbuffers::String> hostedForCompanyOrgId) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_HOSTEDFORCOMPANYORGID, hostedForCompanyOrgId);
  }
  void add_manufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrgId) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_MANUFACTURERORGID, manufacturerOrgId);
  }
  void add_tradeLeaseOrgId(::flatbuffers::Offset<::flatbuffers::String> tradeLeaseOrgId) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_TRADELEASEORGID, tradeLeaseOrgId);
  }
  void add_num36MhzEquivalentTransponders(int32_t num36MhzEquivalentTransponders) {
    fbb_.AddElement<int32_t>(SeradataCommDetails_Full::VT_NUM36MHZEQUIVALENTTRANSPONDERS, num36MhzEquivalentTransponders, 0);
  }
  void add_htsNumUserSpotBeams(int32_t htsNumUserSpotBeams) {
    fbb_.AddElement<int32_t>(SeradataCommDetails_Full::VT_HTSNUMUSERSPOTBEAMS, htsNumUserSpotBeams, 0);
  }
  void add_htsUserDownlinkBandwidthPerBeam(double htsUserDownlinkBandwidthPerBeam) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_HTSUSERDOWNLINKBANDWIDTHPERBEAM, htsUserDownlinkBandwidthPerBeam, 0.0);
  }
  void add_htsUserUplinkBandwidthPerBeam(double htsUserUplinkBandwidthPerBeam) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_HTSUSERUPLINKBANDWIDTHPERBEAM, htsUserUplinkBandwidthPerBeam, 0.0);
  }
  void add_estHtsTotalUserDownlinkBandwidthPerBeam(double estHtsTotalUserDownlinkBandwidthPerBeam) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_ESTHTSTOTALUSERDOWNLINKBANDWIDTHPERBEAM, estHtsTotalUserDownlinkBandwidthPerBeam, 0.0);
  }
  void add_estHtsTotalUserUplinkBandwidthPerBeam(double estHtsTotalUserUplinkBandwidthPerBeam) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_ESTHTSTOTALUSERUPLINKBANDWIDTHPERBEAM, estHtsTotalUserUplinkBandwidthPerBeam, 0.0);
  }
  void add_estHtsTotalCapacity(double estHtsTotalCapacity) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_ESTHTSTOTALCAPACITY, estHtsTotalCapacity, 0.0);
  }
  void add_userDownlinkFrom(double userDownlinkFrom) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_USERDOWNLINKFROM, userDownlinkFrom, 0.0);
  }
  void add_userDownlinkTo(double userDownlinkTo) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_USERDOWNLINKTO, userDownlinkTo, 0.0);
  }
  void add_userUplinkFrom(double userUplinkFrom) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_USERUPLINKFROM, userUplinkFrom, 0.0);
  }
  void add_userUplinkTo(double userUplinkTo) {
    fbb_.AddElement<double>(SeradataCommDetails_Full::VT_USERUPLINKTO, userUplinkTo, 0.0);
  }
  void add_payloadNotes(::flatbuffers::Offset<::flatbuffers::String> payloadNotes) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_PAYLOADNOTES, payloadNotes);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(SeradataCommDetails_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SeradataCommDetails_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(SeradataCommDetails_Full::VT_UPDATEDBY, updatedBy);
  }
  explicit SeradataCommDetails_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SeradataCommDetails_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SeradataCommDetails_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SeradataCommDetails_Full> CreateSeradataCommDetails_Full(
    ...
    SeradataCommDetails_Full_dataMode_Enum dataMode = SeradataCommDetails_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0,
    ::flatbuffers::Offset<::flatbuffers::String> updatedAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> updatedBy = 0) {
  SeradataCommDetails_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SeradataCommDetails_Full> CreateSeradataCommDetails_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateSeradataCommDetails_Full(
      _fbb,
      id__,
      idComm__,
...
inline const SeradataCommDetails_Full *GetSeradataCommDetails_Full(const void *buf) {
  return ::flatbuffers::GetRoot<SeradataCommDetails_Full>(buf);
}

inline const SeradataCommDetails_Full *GetSizePrefixedSeradataCommDetails_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SeradataCommDetails_Full>(buf);
}

inline const char *SeradataCommDetails_FullIdentifier() {
  return "SERA";
}

inline bool SeradataCommDetails_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataCommDetails_FullIdentifier());
}

inline bool SizePrefixedSeradataCommDetails_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataCommDetails_FullIdentifier(), true);
}

inline bool VerifySeradataCommDetails_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SeradataCommDetails_Full>(SeradataCommDetails_FullIdentifier());
}

inline bool VerifySizePrefixedSeradataCommDetails_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SeradataCommDetails_Full>(SeradataCommDetails_FullIdentifier());
}

inline void FinishSeradataCommDetails_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataCommDetails_Full> root) {
  fbb.Finish(root, SeradataCommDetails_FullIdentifier());
}

inline void FinishSizePrefixedSeradataCommDetails_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataCommDetails_Full> root) {
  fbb.FinishSizePrefixed(root, SeradataCommDetails_FullIdentifier());
}
