...
struct SeradataRadarPayload_Full;
struct SeradataRadarPayload_FullBuilder;

enum SeradataRadarPayload_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  SeradataRadarPayload_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  SeradataRadarPayload_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  SeradataRadarPayload_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  SeradataRadarPayload_Full_dataMode_Enum_EXERCISE = 3,
  SeradataRadarPayload_Full_dataMode_Enum_MIN = SeradataRadarPayload_Full_dataMode_Enum_REAL,
  SeradataRadarPayload_Full_dataMode_Enum_MAX = SeradataRadarPayload_Full_dataMode_Enum_EXERCISE
};

inline const SeradataRadarPayload_Full_dataMode_Enum (&EnumValuesSeradataRadarPayload_Full_dataMode_Enum())[4] {
  static const SeradataRadarPayload_Full_dataMode_Enum values[] = {
    SeradataRadarPayload_Full_dataMode_Enum_REAL,
    SeradataRadarPayload_Full_dataMode_Enum_TEST,
    SeradataRadarPayload_Full_dataMode_Enum_SIMULATED,
    SeradataRadarPayload_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSeradataRadarPayload_Full_dataMode_Enum() {
...
inline const char *EnumNameSeradataRadarPayload_Full_dataMode_Enum(SeradataRadarPayload_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SeradataRadarPayload_Full_dataMode_Enum_REAL, SeradataRadarPayload_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSeradataRadarPayload_Full_dataMode_Enum()[index];
}

/// /// Details for an radar payload from  Seradata.
struct SeradataRadarPayload_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SeradataRadarPayload_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SeradataRadarPayload_Full_dataMode_Enum dataMode() const {
    return static_cast<SeradataRadarPayload_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SeradataRadarPayload_FullBuilder {
  typedef SeradataRadarPayload_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_spacecraftId(::flatbuffers::Offset<::flatbuffers::String> spacecraftId) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_SPACECRAFTID, spacecraftId);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_IDSENSOR, idSensor);
  }
  void add_hostedForCompanyOrgId(::flatbuffers::Offset<::flatbuffers::String> hostedForCompanyOrgId) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_HOSTEDFORCOMPANYORGID, hostedForCompanyOrgId);
  }
  void add_manufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrgId) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_MANUFACTURERORGID, manufacturerOrgId);
  }
  void add_category(::flatbuffers::Offset<::flatbuffers::String> category) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_CATEGORY, category);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_NAME, name);
  }
  void add_frequencyBand(::flatbuffers::Offset<::flatbuffers::String> frequencyBand) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_FREQUENCYBAND, frequencyBand);
  }
  void add_frequency(double frequency) {
    fbb_.AddElement<double>(SeradataRadarPayload_Full::VT_FREQUENCY, frequency, 0.0);
  }
  void add_waveLength(double waveLength) {
    fbb_.AddElement<double>(SeradataRadarPayload_Full::VT_WAVELENGTH, waveLength, 0.0);
  }
  void add_bestResolution(double bestResolution) {
    fbb_.AddElement<double>(SeradataRadarPayload_Full::VT_BESTRESOLUTION, bestResolution, 0.0);
  }
  void add_swathWidth(double swathWidth) {
    fbb_.AddElement<double>(SeradataRadarPayload_Full::VT_SWATHWIDTH, swathWidth, 0.0);
  }
  void add_recorderSize(::flatbuffers::Offset<::flatbuffers::String> recorderSize) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_RECORDERSIZE, recorderSize);
  }
  void add_fieldOfView(double fieldOfView) {
    fbb_.AddElement<double>(SeradataRadarPayload_Full::VT_FIELDOFVIEW, fieldOfView, 0.0);
  }
  void add_fieldOfRegard(double fieldOfRegard) {
    fbb_.AddElement<double>(SeradataRadarPayload_Full::VT_FIELDOFREGARD, fieldOfRegard, 0.0);
  }
  void add_pointingMethod(::flatbuffers::Offset<::flatbuffers::String> pointingMethod) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_POINTINGMETHOD, pointingMethod);
  }
  void add_groundStations(::flatbuffers::Offset<::flatbuffers::String> groundStations) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_GROUNDSTATIONS, groundStations);
  }
  void add_groundStationLocations(::flatbuffers::Offset<::flatbuffers::String> groundStationLocations) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_GROUNDSTATIONLOCATIONS, groundStationLocations);
  }
  void add_transmitPolarization(::flatbuffers::Offset<::flatbuffers::String> transmitPolarization) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_TRANSMITPOLARIZATION, transmitPolarization);
  }
  void add_receivePolarization(::flatbuffers::Offset<::flatbuffers::String> receivePolarization) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_RECEIVEPOLARIZATION, receivePolarization);
  }
  void add_dutyCycle(::flatbuffers::Offset<::flatbuffers::String> dutyCycle) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_DUTYCYCLE, dutyCycle);
  }
  void add_partnerSpacecraft(::flatbuffers::Offset<::flatbuffers::String> partnerSpacecraft) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_PARTNERSPACECRAFT, partnerSpacecraft);
  }
  void add_constellationInterferometricCapability(::flatbuffers::Offset<::flatbuffers::String> constellationInterferometricCapability) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_CONSTELLATIONINTERFEROMETRICCAPABILITY, constellationInterferometricCapability);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_NOTES, notes);
  }
  void add_bandwidth(double bandwidth) {
    fbb_.AddElement<double>(SeradataRadarPayload_Full::VT_BANDWIDTH, bandwidth, 0.0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SeradataRadarPayload_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(SeradataRadarPayload_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SeradataRadarPayload_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit SeradataRadarPayload_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SeradataRadarPayload_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SeradataRadarPayload_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SeradataRadarPayload_Full> CreateSeradataRadarPayload_Full(
    ...
    SeradataRadarPayload_Full_dataMode_Enum dataMode = SeradataRadarPayload_Full_dataMode_Enum_REAL) {
  SeradataRadarPayload_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SeradataRadarPayload_Full> CreateSeradataRadarPayload_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateSeradataRadarPayload_Full(
      _fbb,
      id__,
...
inline const SeradataRadarPayload_Full *GetSeradataRadarPayload_Full(const void *buf) {
  return ::flatbuffers::GetRoot<SeradataRadarPayload_Full>(buf);
}

inline const SeradataRadarPayload_Full *GetSizePrefixedSeradataRadarPayload_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SeradataRadarPayload_Full>(buf);
}

inline const char *SeradataRadarPayload_FullIdentifier() {
  return "SERA";
}

inline bool SeradataRadarPayload_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataRadarPayload_FullIdentifier());
}

inline bool SizePrefixedSeradataRadarPayload_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataRadarPayload_FullIdentifier(), true);
}

inline bool VerifySeradataRadarPayload_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SeradataRadarPayload_Full>(SeradataRadarPayload_FullIdentifier());
}

inline bool VerifySizePrefixedSeradataRadarPayload_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SeradataRadarPayload_Full>(SeradataRadarPayload_FullIdentifier());
}

inline void FinishSeradataRadarPayload_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataRadarPayload_Full> root) {
  fbb.Finish(root, SeradataRadarPayload_FullIdentifier());
}

inline void FinishSizePrefixedSeradataRadarPayload_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataRadarPayload_Full> root) {
  fbb.FinishSizePrefixed(root, SeradataRadarPayload_FullIdentifier());
}
