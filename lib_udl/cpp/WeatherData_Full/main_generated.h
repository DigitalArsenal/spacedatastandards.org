...
struct WeatherData_Full;
struct WeatherData_FullBuilder;

enum WeatherData_Full_dataMode_Enum : int8_t {
  ...
  WeatherData_Full_dataMode_Enum_MIN = WeatherData_Full_dataMode_Enum_REAL,
  WeatherData_Full_dataMode_Enum_MAX = WeatherData_Full_dataMode_Enum_EXERCISE
};

inline const WeatherData_Full_dataMode_Enum (&EnumValuesWeatherData_Full_dataMode_Enum())[4] {
  static const WeatherData_Full_dataMode_Enum values[] = {
    WeatherData_Full_dataMode_Enum_REAL,
    WeatherData_Full_dataMode_Enum_TEST,
    WeatherData_Full_dataMode_Enum_SIMULATED,
    WeatherData_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesWeatherData_Full_dataMode_Enum() {
...
inline const char *EnumNameWeatherData_Full_dataMode_Enum(WeatherData_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, WeatherData_Full_dataMode_Enum_REAL, WeatherData_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesWeatherData_Full_dataMode_Enum()[index];
}
...
struct WeatherData_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef WeatherData_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  WeatherData_Full_dataMode_Enum dataMode() const {
    return static_cast<WeatherData_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct WeatherData_FullBuilder {
  typedef WeatherData_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(WeatherData_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(WeatherData_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(WeatherData_Full::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(WeatherData_Full::VT_ORIGSENSORID, origSensorId);
  }
  void add_obTime(::flatbuffers::Offset<::flatbuffers::String> obTime) {
    fbb_.AddOffset(WeatherData_Full::VT_OBTIME, obTime);
  }
  void add_sigPwrs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sigPwrs) {
    fbb_.AddOffset(WeatherData_Full::VT_SIGPWRS, sigPwrs);
  }
  void add_noiseLvls(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> noiseLvls) {
    fbb_.AddOffset(WeatherData_Full::VT_NOISELVLS, noiseLvls);
  }
  void add_specWidths(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> specWidths) {
    fbb_.AddOffset(WeatherData_Full::VT_SPECWIDTHS, specWidths);
  }
  void add_firstGuessAvgs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> firstGuessAvgs) {
    fbb_.AddOffset(WeatherData_Full::VT_FIRSTGUESSAVGS, firstGuessAvgs);
  }
  void add_qcValue(int32_t qcValue) {
    fbb_.AddElement<int32_t>(WeatherData_Full::VT_QCVALUE, qcValue, 0);
  }
  void add_fileCreation(::flatbuffers::Offset<::flatbuffers::String> fileCreation) {
    fbb_.AddOffset(WeatherData_Full::VT_FILECREATION, fileCreation);
  }
  void add_termAlt(double termAlt) {
    fbb_.AddElement<double>(WeatherData_Full::VT_TERMALT, termAlt, 0.0);
  }
  void add_avgTxPwr(double avgTxPwr) {
    fbb_.AddElement<double>(WeatherData_Full::VT_AVGTXPWR, avgTxPwr, 0.0);
  }
  void add_avgRefPwr(double avgRefPwr) {
    fbb_.AddElement<double>(WeatherData_Full::VT_AVGREFPWR, avgRefPwr, 0.0);
  }
  void add_sectorNum(int32_t sectorNum) {
    fbb_.AddElement<int32_t>(WeatherData_Full::VT_SECTORNUM, sectorNum, 0);
  }
  void add_numElements(int32_t numElements) {
    fbb_.AddElement<int32_t>(WeatherData_Full::VT_NUMELEMENTS, numElements, 0);
  }
  void add_tdAvgSampleNums(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tdAvgSampleNums) {
    fbb_.AddOffset(WeatherData_Full::VT_TDAVGSAMPLENUMS, tdAvgSampleNums);
  }
  void add_checksum(int32_t checksum) {
    fbb_.AddElement<int32_t>(WeatherData_Full::VT_CHECKSUM, checksum, 0);
  }
  void add_coIntegs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> coIntegs) {
    fbb_.AddOffset(WeatherData_Full::VT_COINTEGS, coIntegs);
  }
  void add_specAvgs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> specAvgs) {
    fbb_.AddOffset(WeatherData_Full::VT_SPECAVGS, specAvgs);
  }
  void add_interpulsePeriods(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> interpulsePeriods) {
    fbb_.AddOffset(WeatherData_Full::VT_INTERPULSEPERIODS, interpulsePeriods);
  }
  void add_doppVels(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> doppVels) {
    fbb_.AddOffset(WeatherData_Full::VT_DOPPVELS, doppVels);
  }
  void add_consRecs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> consRecs) {
    fbb_.AddOffset(WeatherData_Full::VT_CONSRECS, consRecs);
  }
  void add_snrs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> snrs) {
    fbb_.AddOffset(WeatherData_Full::VT_SNRS, snrs);
  }
  void add_sigStrength(double sigStrength) {
    fbb_.AddElement<double>(WeatherData_Full::VT_SIGSTRENGTH, sigStrength, 0.0);
  }
  void add_semiMajorAxis(double semiMajorAxis) {
    fbb_.AddElement<double>(WeatherData_Full::VT_SEMIMAJORAXIS, semiMajorAxis, 0.0);
  }
  void add_semiMinorAxis(double semiMinorAxis) {
    fbb_.AddElement<double>(WeatherData_Full::VT_SEMIMINORAXIS, semiMinorAxis, 0.0);
  }
  void add_angleOrientation(double angleOrientation) {
    fbb_.AddElement<double>(WeatherData_Full::VT_ANGLEORIENTATION, angleOrientation, 0.0);
  }
  void add_lightEventNum(int32_t lightEventNum) {
    fbb_.AddElement<int32_t>(WeatherData_Full::VT_LIGHTEVENTNUM, lightEventNum, 0);
  }
  void add_lightDetSensors(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> lightDetSensors) {
    fbb_.AddOffset(WeatherData_Full::VT_LIGHTDETSENSORS, lightDetSensors);
  }
  void add_posConfidence(double posConfidence) {
    fbb_.AddElement<double>(WeatherData_Full::VT_POSCONFIDENCE, posConfidence, 0.0);
  }
  void add_srcTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcTyps) {
    fbb_.AddOffset(WeatherData_Full::VT_SRCTYPS, srcTyps);
  }
  void add_srcIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcIds) {
    fbb_.AddOffset(WeatherData_Full::VT_SRCIDS, srcIds);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(WeatherData_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(WeatherData_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(WeatherData_Full::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(WeatherData_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(WeatherData_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(WeatherData_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(WeatherData_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit WeatherData_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<WeatherData_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<WeatherData_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<WeatherData_Full> CreateWeatherData_Full(
    ...
    WeatherData_Full_dataMode_Enum dataMode = WeatherData_Full_dataMode_Enum_REAL) {
  WeatherData_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<WeatherData_Full> CreateWeatherData_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const WeatherData_Full *GetWeatherData_Full(const void *buf) {
  return ::flatbuffers::GetRoot<WeatherData_Full>(buf);
}

inline const WeatherData_Full *GetSizePrefixedWeatherData_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<WeatherData_Full>(buf);
}

inline const char *WeatherData_FullIdentifier() {
  return "WEAT";
}

inline bool WeatherData_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, WeatherData_FullIdentifier());
}

inline bool SizePrefixedWeatherData_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, WeatherData_FullIdentifier(), true);
}

inline bool VerifyWeatherData_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<WeatherData_Full>(WeatherData_FullIdentifier());
}

inline bool VerifySizePrefixedWeatherData_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<WeatherData_Full>(WeatherData_FullIdentifier());
}

inline void FinishWeatherData_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<WeatherData_Full> root) {
  fbb.Finish(root, WeatherData_FullIdentifier());
}

inline void FinishSizePrefixedWeatherData_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<WeatherData_Full> root) {
  fbb.FinishSizePrefixed(root, WeatherData_FullIdentifier());
}
