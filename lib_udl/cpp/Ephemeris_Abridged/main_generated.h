...
struct Ephemeris_Abridged;
struct Ephemeris_AbridgedBuilder;

enum Ephemeris_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Ephemeris_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Ephemeris_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Ephemeris_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Ephemeris_Abridged_dataMode_Enum_EXERCISE = 3,
  Ephemeris_Abridged_dataMode_Enum_MIN = Ephemeris_Abridged_dataMode_Enum_REAL,
  Ephemeris_Abridged_dataMode_Enum_MAX = Ephemeris_Abridged_dataMode_Enum_EXERCISE
};

inline const Ephemeris_Abridged_dataMode_Enum (&EnumValuesEphemeris_Abridged_dataMode_Enum())[4] {
  static const Ephemeris_Abridged_dataMode_Enum values[] = {
    Ephemeris_Abridged_dataMode_Enum_REAL,
    Ephemeris_Abridged_dataMode_Enum_TEST,
    Ephemeris_Abridged_dataMode_Enum_SIMULATED,
    Ephemeris_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesEphemeris_Abridged_dataMode_Enum() {
...
inline const char *EnumNameEphemeris_Abridged_dataMode_Enum(Ephemeris_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Ephemeris_Abridged_dataMode_Enum_REAL, Ephemeris_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEphemeris_Abridged_dataMode_Enum()[index];
}
...
struct Ephemeris_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Ephemeris_AbridgedBuilder Builder;
  ...
  Ephemeris_Abridged_dataMode_Enum dataMode() const {
    return static_cast<Ephemeris_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Ephemeris_AbridgedBuilder {
  typedef Ephemeris_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Ephemeris_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Ephemeris_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_esId(::flatbuffers::Offset<::flatbuffers::String> esId) {
    fbb_.AddOffset(Ephemeris_Abridged::VT_ESID, esId);
  }
  void add_ts(::flatbuffers::Offset<::flatbuffers::String> ts) {
    fbb_.AddOffset(Ephemeris_Abridged::VT_TS, ts);
  }
  void add_xpos(double xpos) {
    fbb_.AddElement<double>(Ephemeris_Abridged::VT_XPOS, xpos, 0.0);
  }
  void add_ypos(double ypos) {
    fbb_.AddElement<double>(Ephemeris_Abridged::VT_YPOS, ypos, 0.0);
  }
  void add_zpos(double zpos) {
    fbb_.AddElement<double>(Ephemeris_Abridged::VT_ZPOS, zpos, 0.0);
  }
  void add_xvel(double xvel) {
    fbb_.AddElement<double>(Ephemeris_Abridged::VT_XVEL, xvel, 0.0);
  }
  void add_yvel(double yvel) {
    fbb_.AddElement<double>(Ephemeris_Abridged::VT_YVEL, yvel, 0.0);
  }
  void add_zvel(double zvel) {
    fbb_.AddElement<double>(Ephemeris_Abridged::VT_ZVEL, zvel, 0.0);
  }
  void add_xaccel(double xaccel) {
    fbb_.AddElement<double>(Ephemeris_Abridged::VT_XACCEL, xaccel, 0.0);
  }
  void add_yaccel(double yaccel) {
    fbb_.AddElement<double>(Ephemeris_Abridged::VT_YACCEL, yaccel, 0.0);
  }
  void add_zaccel(double zaccel) {
    fbb_.AddElement<double>(Ephemeris_Abridged::VT_ZACCEL, zaccel, 0.0);
  }
  void add_cov(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> cov) {
    fbb_.AddOffset(Ephemeris_Abridged::VT_COV, cov);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Ephemeris_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Ephemeris_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Ephemeris_Abridged::VT_SOURCE, source);
  }
  void add_dataMode(Ephemeris_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Ephemeris_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(Ephemeris_Abridged::VT_IDONORBIT, idOnOrbit);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(Ephemeris_Abridged::VT_ORIGOBJECTID, origObjectId);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Ephemeris_Abridged::VT_ORIGIN, origin);
  }
  explicit Ephemeris_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Ephemeris_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Ephemeris_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Ephemeris_Abridged> CreateEphemeris_Abridged(
    ...
    Ephemeris_Abridged_dataMode_Enum dataMode = Ephemeris_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> idOnOrbit = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origObjectId = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origin = 0) {
  Ephemeris_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Ephemeris_Abridged> CreateEphemeris_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateEphemeris_Abridged(
      _fbb,
      id__,
...
inline const Ephemeris_Abridged *GetEphemeris_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<Ephemeris_Abridged>(buf);
}

inline const Ephemeris_Abridged *GetSizePrefixedEphemeris_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Ephemeris_Abridged>(buf);
}

inline const char *Ephemeris_AbridgedIdentifier() {
  return "EPHE";
}

inline bool Ephemeris_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Ephemeris_AbridgedIdentifier());
}

inline bool SizePrefixedEphemeris_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Ephemeris_AbridgedIdentifier(), true);
}

inline bool VerifyEphemeris_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Ephemeris_Abridged>(Ephemeris_AbridgedIdentifier());
}

inline bool VerifySizePrefixedEphemeris_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Ephemeris_Abridged>(Ephemeris_AbridgedIdentifier());
}

inline void FinishEphemeris_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Ephemeris_Abridged> root) {
  fbb.Finish(root, Ephemeris_AbridgedIdentifier());
}

inline void FinishSizePrefixedEphemeris_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Ephemeris_Abridged> root) {
  fbb.FinishSizePrefixed(root, Ephemeris_AbridgedIdentifier());
}
