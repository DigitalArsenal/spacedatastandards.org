...
struct WeatherData_Abridged;
struct WeatherData_AbridgedBuilder;

enum WeatherData_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  WeatherData_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  WeatherData_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  WeatherData_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  WeatherData_Abridged_dataMode_Enum_EXERCISE = 3,
  WeatherData_Abridged_dataMode_Enum_MIN = WeatherData_Abridged_dataMode_Enum_REAL,
  WeatherData_Abridged_dataMode_Enum_MAX = WeatherData_Abridged_dataMode_Enum_EXERCISE
};

inline const WeatherData_Abridged_dataMode_Enum (&EnumValuesWeatherData_Abridged_dataMode_Enum())[4] {
  static const WeatherData_Abridged_dataMode_Enum values[] = {
    WeatherData_Abridged_dataMode_Enum_REAL,
    WeatherData_Abridged_dataMode_Enum_TEST,
    WeatherData_Abridged_dataMode_Enum_SIMULATED,
    WeatherData_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesWeatherData_Abridged_dataMode_Enum() {
...
inline const char *EnumNameWeatherData_Abridged_dataMode_Enum(WeatherData_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, WeatherData_Abridged_dataMode_Enum_REAL, WeatherData_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesWeatherData_Abridged_dataMode_Enum()[index];
}
...
struct WeatherData_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef WeatherData_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  WeatherData_Abridged_dataMode_Enum dataMode() const {
    return static_cast<WeatherData_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct WeatherData_AbridgedBuilder {
  typedef WeatherData_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(WeatherData_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(WeatherData_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(WeatherData_Abridged::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(WeatherData_Abridged::VT_ORIGSENSORID, origSensorId);
  }
  void add_obTime(::flatbuffers::Offset<::flatbuffers::String> obTime) {
    fbb_.AddOffset(WeatherData_Abridged::VT_OBTIME, obTime);
  }
  void add_sigPwrs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sigPwrs) {
    fbb_.AddOffset(WeatherData_Abridged::VT_SIGPWRS, sigPwrs);
  }
  void add_noiseLvls(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> noiseLvls) {
    fbb_.AddOffset(WeatherData_Abridged::VT_NOISELVLS, noiseLvls);
  }
  void add_specWidths(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> specWidths) {
    fbb_.AddOffset(WeatherData_Abridged::VT_SPECWIDTHS, specWidths);
  }
  void add_firstGuessAvgs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> firstGuessAvgs) {
    fbb_.AddOffset(WeatherData_Abridged::VT_FIRSTGUESSAVGS, firstGuessAvgs);
  }
  void add_qcValue(int32_t qcValue) {
    fbb_.AddElement<int32_t>(WeatherData_Abridged::VT_QCVALUE, qcValue, 0);
  }
  void add_fileCreation(::flatbuffers::Offset<::flatbuffers::String> fileCreation) {
    fbb_.AddOffset(WeatherData_Abridged::VT_FILECREATION, fileCreation);
  }
  void add_termAlt(double termAlt) {
    fbb_.AddElement<double>(WeatherData_Abridged::VT_TERMALT, termAlt, 0.0);
  }
  void add_avgTxPwr(double avgTxPwr) {
    fbb_.AddElement<double>(WeatherData_Abridged::VT_AVGTXPWR, avgTxPwr, 0.0);
  }
  void add_avgRefPwr(double avgRefPwr) {
    fbb_.AddElement<double>(WeatherData_Abridged::VT_AVGREFPWR, avgRefPwr, 0.0);
  }
  void add_sectorNum(int32_t sectorNum) {
    fbb_.AddElement<int32_t>(WeatherData_Abridged::VT_SECTORNUM, sectorNum, 0);
  }
  void add_numElements(int32_t numElements) {
    fbb_.AddElement<int32_t>(WeatherData_Abridged::VT_NUMELEMENTS, numElements, 0);
  }
  void add_tdAvgSampleNums(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tdAvgSampleNums) {
    fbb_.AddOffset(WeatherData_Abridged::VT_TDAVGSAMPLENUMS, tdAvgSampleNums);
  }
  void add_checksum(int32_t checksum) {
    fbb_.AddElement<int32_t>(WeatherData_Abridged::VT_CHECKSUM, checksum, 0);
  }
  void add_coIntegs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> coIntegs) {
    fbb_.AddOffset(WeatherData_Abridged::VT_COINTEGS, coIntegs);
  }
  void add_specAvgs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> specAvgs) {
    fbb_.AddOffset(WeatherData_Abridged::VT_SPECAVGS, specAvgs);
  }
  void add_interpulsePeriods(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> interpulsePeriods) {
    fbb_.AddOffset(WeatherData_Abridged::VT_INTERPULSEPERIODS, interpulsePeriods);
  }
  void add_doppVels(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> doppVels) {
    fbb_.AddOffset(WeatherData_Abridged::VT_DOPPVELS, doppVels);
  }
  void add_consRecs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> consRecs) {
    fbb_.AddOffset(WeatherData_Abridged::VT_CONSRECS, consRecs);
  }
  void add_snrs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> snrs) {
    fbb_.AddOffset(WeatherData_Abridged::VT_SNRS, snrs);
  }
  void add_sigStrength(double sigStrength) {
    fbb_.AddElement<double>(WeatherData_Abridged::VT_SIGSTRENGTH, sigStrength, 0.0);
  }
  void add_semiMajorAxis(double semiMajorAxis) {
    fbb_.AddElement<double>(WeatherData_Abridged::VT_SEMIMAJORAXIS, semiMajorAxis, 0.0);
  }
  void add_semiMinorAxis(double semiMinorAxis) {
    fbb_.AddElement<double>(WeatherData_Abridged::VT_SEMIMINORAXIS, semiMinorAxis, 0.0);
  }
  void add_angleOrientation(double angleOrientation) {
    fbb_.AddElement<double>(WeatherData_Abridged::VT_ANGLEORIENTATION, angleOrientation, 0.0);
  }
  void add_lightEventNum(int32_t lightEventNum) {
    fbb_.AddElement<int32_t>(WeatherData_Abridged::VT_LIGHTEVENTNUM, lightEventNum, 0);
  }
  void add_lightDetSensors(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> lightDetSensors) {
    fbb_.AddOffset(WeatherData_Abridged::VT_LIGHTDETSENSORS, lightDetSensors);
  }
  void add_posConfidence(double posConfidence) {
    fbb_.AddElement<double>(WeatherData_Abridged::VT_POSCONFIDENCE, posConfidence, 0.0);
  }
  void add_srcTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcTyps) {
    fbb_.AddOffset(WeatherData_Abridged::VT_SRCTYPS, srcTyps);
  }
  void add_srcIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcIds) {
    fbb_.AddOffset(WeatherData_Abridged::VT_SRCIDS, srcIds);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(WeatherData_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(WeatherData_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(WeatherData_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(WeatherData_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(WeatherData_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(WeatherData_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(WeatherData_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit WeatherData_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<WeatherData_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<WeatherData_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<WeatherData_Abridged> CreateWeatherData_Abridged(
    ...
    WeatherData_Abridged_dataMode_Enum dataMode = WeatherData_Abridged_dataMode_Enum_REAL) {
  WeatherData_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<WeatherData_Abridged> CreateWeatherData_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateWeatherData_Abridged(
      _fbb,
      id__,
...
inline const WeatherData_Abridged *GetWeatherData_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<WeatherData_Abridged>(buf);
}

inline const WeatherData_Abridged *GetSizePrefixedWeatherData_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<WeatherData_Abridged>(buf);
}

inline const char *WeatherData_AbridgedIdentifier() {
  return "WEAT";
}

inline bool WeatherData_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, WeatherData_AbridgedIdentifier());
}

inline bool SizePrefixedWeatherData_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, WeatherData_AbridgedIdentifier(), true);
}

inline bool VerifyWeatherData_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<WeatherData_Abridged>(WeatherData_AbridgedIdentifier());
}

inline bool VerifySizePrefixedWeatherData_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<WeatherData_Abridged>(WeatherData_AbridgedIdentifier());
}

inline void FinishWeatherData_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<WeatherData_Abridged> root) {
  fbb.Finish(root, WeatherData_AbridgedIdentifier());
}

inline void FinishSizePrefixedWeatherData_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<WeatherData_Abridged> root) {
  fbb.FinishSizePrefixed(root, WeatherData_AbridgedIdentifier());
}
