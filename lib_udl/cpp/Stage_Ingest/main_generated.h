...
enum Stage_Ingest_dataMode_Enum : int8_t {
  ...
  Stage_Ingest_dataMode_Enum_MIN = Stage_Ingest_dataMode_Enum_REAL,
  Stage_Ingest_dataMode_Enum_MAX = Stage_Ingest_dataMode_Enum_EXERCISE
};

inline const Stage_Ingest_dataMode_Enum (&EnumValuesStage_Ingest_dataMode_Enum())[4] {
  static const Stage_Ingest_dataMode_Enum values[] = {
    Stage_Ingest_dataMode_Enum_REAL,
    Stage_Ingest_dataMode_Enum_TEST,
    Stage_Ingest_dataMode_Enum_SIMULATED,
    Stage_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesStage_Ingest_dataMode_Enum() {
...
inline const char *EnumNameStage_Ingest_dataMode_Enum(Stage_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Stage_Ingest_dataMode_Enum_REAL, Stage_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesStage_Ingest_dataMode_Enum()[index];
}
...
struct Stage_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Stage_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Stage_Ingest_dataMode_Enum dataMode() const {
    return static_cast<Stage_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Stage_IngestBuilder {
  typedef Stage_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Stage_Ingest::VT_ID, id);
  }
  void add_idLaunchVehicle(::flatbuffers::Offset<::flatbuffers::String> idLaunchVehicle) {
    fbb_.AddOffset(Stage_Ingest::VT_IDLAUNCHVEHICLE, idLaunchVehicle);
  }
  void add_idEngine(::flatbuffers::Offset<::flatbuffers::String> idEngine) {
    fbb_.AddOffset(Stage_Ingest::VT_IDENGINE, idEngine);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Stage_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_stageNumber(int32_t stageNumber) {
    fbb_.AddElement<int32_t>(Stage_Ingest::VT_STAGENUMBER, stageNumber, 0);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(Stage_Ingest::VT_TYPE, type);
  }
  void add_manufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrgId) {
    fbb_.AddOffset(Stage_Ingest::VT_MANUFACTURERORGID, manufacturerOrgId);
  }
  void add_numEngines(int32_t numEngines) {
    fbb_.AddElement<int32_t>(Stage_Ingest::VT_NUMENGINES, numEngines, 0);
  }
  void add_length(double length) {
    fbb_.AddElement<double>(Stage_Ingest::VT_LENGTH, length, 0.0);
  }
  void add_diameter(double diameter) {
    fbb_.AddElement<double>(Stage_Ingest::VT_DIAMETER, diameter, 0.0);
  }
  void add_mass(double mass) {
    fbb_.AddElement<double>(Stage_Ingest::VT_MASS, mass, 0.0);
  }
  void add_vernier(::flatbuffers::Offset<::flatbuffers::String> vernier) {
    fbb_.AddOffset(Stage_Ingest::VT_VERNIER, vernier);
  }
  void add_numVernier(int32_t numVernier) {
    fbb_.AddElement<int32_t>(Stage_Ingest::VT_NUMVERNIER, numVernier, 0);
  }
  void add_mainEngineThrustSeaLevel(double mainEngineThrustSeaLevel) {
    fbb_.AddElement<double>(Stage_Ingest::VT_MAINENGINETHRUSTSEALEVEL, mainEngineThrustSeaLevel, 0.0);
  }
  void add_mainEngineThrustVacuum(double mainEngineThrustVacuum) {
    fbb_.AddElement<double>(Stage_Ingest::VT_MAINENGINETHRUSTVACUUM, mainEngineThrustVacuum, 0.0);
  }
  void add_thrustSeaLevel(double thrustSeaLevel) {
    fbb_.AddElement<double>(Stage_Ingest::VT_THRUSTSEALEVEL, thrustSeaLevel, 0.0);
  }
  void add_thrustVacuum(double thrustVacuum) {
    fbb_.AddElement<double>(Stage_Ingest::VT_THRUSTVACUUM, thrustVacuum, 0.0);
  }
  void add_burnTime(double burnTime) {
    fbb_.AddElement<double>(Stage_Ingest::VT_BURNTIME, burnTime, 0.0);
  }
  void add_numBurns(int32_t numBurns) {
    fbb_.AddElement<int32_t>(Stage_Ingest::VT_NUMBURNS, numBurns, 0);
  }
  void add_vernierBurnTime(double vernierBurnTime) {
    fbb_.AddElement<double>(Stage_Ingest::VT_VERNIERBURNTIME, vernierBurnTime, 0.0);
  }
  void add_vernierNumBurns(int32_t vernierNumBurns) {
    fbb_.AddElement<int32_t>(Stage_Ingest::VT_VERNIERNUMBURNS, vernierNumBurns, 0);
  }
  void add_vernierThrustSeaLevel(double vernierThrustSeaLevel) {
    fbb_.AddElement<double>(Stage_Ingest::VT_VERNIERTHRUSTSEALEVEL, vernierThrustSeaLevel, 0.0);
  }
  void add_vernierThrustVacuum(double vernierThrustVacuum) {
    fbb_.AddElement<double>(Stage_Ingest::VT_VERNIERTHRUSTVACUUM, vernierThrustVacuum, 0.0);
  }
  void add_numStageElements(int32_t numStageElements) {
    fbb_.AddElement<int32_t>(Stage_Ingest::VT_NUMSTAGEELEMENTS, numStageElements, 0);
  }
  void add_reusable(bool reusable) {
    fbb_.AddElement<uint8_t>(Stage_Ingest::VT_REUSABLE, static_cast<uint8_t>(reusable), 0);
  }
  void add_restartable(bool restartable) {
    fbb_.AddElement<uint8_t>(Stage_Ingest::VT_RESTARTABLE, static_cast<uint8_t>(restartable), 0);
  }
  void add_controlThruster1(::flatbuffers::Offset<::flatbuffers::String> controlThruster1) {
    fbb_.AddOffset(Stage_Ingest::VT_CONTROLTHRUSTER1, controlThruster1);
  }
  void add_numControlThruster1(int32_t numControlThruster1) {
    fbb_.AddElement<int32_t>(Stage_Ingest::VT_NUMCONTROLTHRUSTER1, numControlThruster1, 0);
  }
  void add_controlThruster2(::flatbuffers::Offset<::flatbuffers::String> controlThruster2) {
    fbb_.AddOffset(Stage_Ingest::VT_CONTROLTHRUSTER2, controlThruster2);
  }
  void add_numControlThruster2(int32_t numControlThruster2) {
    fbb_.AddElement<int32_t>(Stage_Ingest::VT_NUMCONTROLTHRUSTER2, numControlThruster2, 0);
  }
  void add_photoURLs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> photoURLs) {
    fbb_.AddOffset(Stage_Ingest::VT_PHOTOURLS, photoURLs);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(Stage_Ingest::VT_NOTES, notes);
  }
  void add_avionicsNotes(::flatbuffers::Offset<::flatbuffers::String> avionicsNotes) {
    fbb_.AddOffset(Stage_Ingest::VT_AVIONICSNOTES, avionicsNotes);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(Stage_Ingest::VT_TAGS, tags);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Stage_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Stage_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Stage_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Stage_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Stage_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(Stage_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Stage_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit Stage_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Stage_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Stage_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Stage_Ingest> CreateStage_Ingest(
    ...
    Stage_Ingest_dataMode_Enum dataMode = Stage_Ingest_dataMode_Enum_REAL) {
  Stage_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Stage_Ingest> CreateStage_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Stage_Ingest *GetStage_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<Stage_Ingest>(buf);
}

inline const Stage_Ingest *GetSizePrefixedStage_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Stage_Ingest>(buf);
}

inline const char *Stage_IngestIdentifier() {
  return "STAG";
}

inline bool Stage_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Stage_IngestIdentifier());
}

inline bool SizePrefixedStage_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Stage_IngestIdentifier(), true);
}

inline bool VerifyStage_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Stage_Ingest>(Stage_IngestIdentifier());
}

inline bool VerifySizePrefixedStage_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Stage_Ingest>(Stage_IngestIdentifier());
}

inline void FinishStage_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Stage_Ingest> root) {
  fbb.Finish(root, Stage_IngestIdentifier());
}

inline void FinishSizePrefixedStage_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Stage_Ingest> root) {
  fbb.FinishSizePrefixed(root, Stage_IngestIdentifier());
}
