...
struct SeradataNavigation_Full;
struct SeradataNavigation_FullBuilder;

enum SeradataNavigation_Full_dataMode_Enum : int8_t {
  ...
  SeradataNavigation_Full_dataMode_Enum_MIN = SeradataNavigation_Full_dataMode_Enum_REAL,
  SeradataNavigation_Full_dataMode_Enum_MAX = SeradataNavigation_Full_dataMode_Enum_EXERCISE
};

inline const SeradataNavigation_Full_dataMode_Enum (&EnumValuesSeradataNavigation_Full_dataMode_Enum())[4] {
  static const SeradataNavigation_Full_dataMode_Enum values[] = {
    SeradataNavigation_Full_dataMode_Enum_REAL,
    SeradataNavigation_Full_dataMode_Enum_TEST,
    SeradataNavigation_Full_dataMode_Enum_SIMULATED,
    SeradataNavigation_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSeradataNavigation_Full_dataMode_Enum() {
...
inline const char *EnumNameSeradataNavigation_Full_dataMode_Enum(SeradataNavigation_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SeradataNavigation_Full_dataMode_Enum_REAL, SeradataNavigation_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSeradataNavigation_Full_dataMode_Enum()[index];
}

/// /// Details for a navigation payload from  Seradata.
struct SeradataNavigation_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SeradataNavigation_FullBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SeradataNavigation_Full_dataMode_Enum dataMode() const {
    return static_cast<SeradataNavigation_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SeradataNavigation_FullBuilder {
  typedef SeradataNavigation_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idNavigation(::flatbuffers::Offset<::flatbuffers::String> idNavigation) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_IDNAVIGATION, idNavigation);
  }
  void add_spacecraftId(::flatbuffers::Offset<::flatbuffers::String> spacecraftId) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_SPACECRAFTID, spacecraftId);
  }
  void add_hostedForCompanyOrgId(::flatbuffers::Offset<::flatbuffers::String> hostedForCompanyOrgId) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_HOSTEDFORCOMPANYORGID, hostedForCompanyOrgId);
  }
  void add_manufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrgId) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_MANUFACTURERORGID, manufacturerOrgId);
  }
  void add_payloadType(::flatbuffers::Offset<::flatbuffers::String> payloadType) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_PAYLOADTYPE, payloadType);
  }
  void add_modes(::flatbuffers::Offset<::flatbuffers::String> modes) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_MODES, modes);
  }
  void add_modeFrequency(::flatbuffers::Offset<::flatbuffers::String> modeFrequency) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_MODEFREQUENCY, modeFrequency);
  }
  void add_locationAccuracy(double locationAccuracy) {
    fbb_.AddElement<double>(SeradataNavigation_Full::VT_LOCATIONACCURACY, locationAccuracy, 0.0);
  }
  void add_partnerSpacecraftId(::flatbuffers::Offset<::flatbuffers::String> partnerSpacecraftId) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_PARTNERSPACECRAFTID, partnerSpacecraftId);
  }
  void add_areaCoverage(::flatbuffers::Offset<::flatbuffers::String> areaCoverage) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_AREACOVERAGE, areaCoverage);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_NOTES, notes);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_NAME, name);
  }
  void add_clockType(::flatbuffers::Offset<::flatbuffers::String> clockType) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_CLOCKTYPE, clockType);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SeradataNavigation_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(SeradataNavigation_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SeradataNavigation_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit SeradataNavigation_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SeradataNavigation_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SeradataNavigation_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SeradataNavigation_Full> CreateSeradataNavigation_Full(
    ...
    SeradataNavigation_Full_dataMode_Enum dataMode = SeradataNavigation_Full_dataMode_Enum_REAL) {
  SeradataNavigation_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SeradataNavigation_Full> CreateSeradataNavigation_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const SeradataNavigation_Full *GetSeradataNavigation_Full(const void *buf) {
  return ::flatbuffers::GetRoot<SeradataNavigation_Full>(buf);
}

inline const SeradataNavigation_Full *GetSizePrefixedSeradataNavigation_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SeradataNavigation_Full>(buf);
}

inline const char *SeradataNavigation_FullIdentifier() {
  return "SERA";
}

inline bool SeradataNavigation_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataNavigation_FullIdentifier());
}

inline bool SizePrefixedSeradataNavigation_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SeradataNavigation_FullIdentifier(), true);
}

inline bool VerifySeradataNavigation_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SeradataNavigation_Full>(SeradataNavigation_FullIdentifier());
}

inline bool VerifySizePrefixedSeradataNavigation_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SeradataNavigation_Full>(SeradataNavigation_FullIdentifier());
}

inline void FinishSeradataNavigation_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataNavigation_Full> root) {
  fbb.Finish(root, SeradataNavigation_FullIdentifier());
}

inline void FinishSizePrefixedSeradataNavigation_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SeradataNavigation_Full> root) {
  fbb.FinishSizePrefixed(root, SeradataNavigation_FullIdentifier());
}
