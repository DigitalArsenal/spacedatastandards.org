...
struct Airfield_Abridged;
struct Airfield_AbridgedBuilder;

enum Airfield_Abridged_dataMode_Enum : int8_t {
  ...
  Airfield_Abridged_dataMode_Enum_MIN = Airfield_Abridged_dataMode_Enum_REAL,
  Airfield_Abridged_dataMode_Enum_MAX = Airfield_Abridged_dataMode_Enum_EXERCISE
};

inline const Airfield_Abridged_dataMode_Enum (&EnumValuesAirfield_Abridged_dataMode_Enum())[4] {
  static const Airfield_Abridged_dataMode_Enum values[] = {
    Airfield_Abridged_dataMode_Enum_REAL,
    Airfield_Abridged_dataMode_Enum_TEST,
    Airfield_Abridged_dataMode_Enum_SIMULATED,
    Airfield_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAirfield_Abridged_dataMode_Enum() {
...
inline const char *EnumNameAirfield_Abridged_dataMode_Enum(Airfield_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Airfield_Abridged_dataMode_Enum_REAL, Airfield_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAirfield_Abridged_dataMode_Enum()[index];
}

/// /// Properties and characteristics of an airfield, which includes location, airfield codes, suitability codes, and remarks.
struct Airfield_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Airfield_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Airfield_Abridged_dataMode_Enum dataMode() const {
    return static_cast<Airfield_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Airfield_AbridgedBuilder {
  typedef Airfield_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Airfield_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Airfield_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idSite(::flatbuffers::Offset<::flatbuffers::String> idSite) {
    fbb_.AddOffset(Airfield_Abridged::VT_IDSITE, idSite);
  }
  void add_altAirfieldId(::flatbuffers::Offset<::flatbuffers::String> altAirfieldId) {
    fbb_.AddOffset(Airfield_Abridged::VT_ALTAIRFIELDID, altAirfieldId);
  }
  void add_wacINNR(::flatbuffers::Offset<::flatbuffers::String> wacINNR) {
    fbb_.AddOffset(Airfield_Abridged::VT_WACINNR, wacINNR);
  }
  void add_zarId(::flatbuffers::Offset<::flatbuffers::String> zarId) {
    fbb_.AddOffset(Airfield_Abridged::VT_ZARID, zarId);
  }
  void add_icao(::flatbuffers::Offset<::flatbuffers::String> icao) {
    fbb_.AddOffset(Airfield_Abridged::VT_ICAO, icao);
  }
  void add_iata(::flatbuffers::Offset<::flatbuffers::String> iata) {
    fbb_.AddOffset(Airfield_Abridged::VT_IATA, iata);
  }
  void add_faa(::flatbuffers::Offset<::flatbuffers::String> faa) {
    fbb_.AddOffset(Airfield_Abridged::VT_FAA, faa);
  }
  void add_hostNatCode(::flatbuffers::Offset<::flatbuffers::String> hostNatCode) {
    fbb_.AddOffset(Airfield_Abridged::VT_HOSTNATCODE, hostNatCode);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(Airfield_Abridged::VT_NAME, name);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(Airfield_Abridged::VT_TYPE, type);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(Airfield_Abridged::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(Airfield_Abridged::VT_LON, lon, 0.0);
  }
  void add_elevFt(double elevFt) {
    fbb_.AddElement<double>(Airfield_Abridged::VT_ELEVFT, elevFt, 0.0);
  }
  void add_elevM(double elevM) {
    fbb_.AddElement<double>(Airfield_Abridged::VT_ELEVM, elevM, 0.0);
  }
  void add_magDec(double magDec) {
    fbb_.AddElement<double>(Airfield_Abridged::VT_MAGDEC, magDec, 0.0);
  }
  void add_regionName(::flatbuffers::Offset<::flatbuffers::String> regionName) {
    fbb_.AddOffset(Airfield_Abridged::VT_REGIONNAME, regionName);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(Airfield_Abridged::VT_COUNTRYCODE, countryCode);
  }
  void add_city(::flatbuffers::Offset<::flatbuffers::String> city) {
    fbb_.AddOffset(Airfield_Abridged::VT_CITY, city);
  }
  void add_state(::flatbuffers::Offset<::flatbuffers::String> state) {
    fbb_.AddOffset(Airfield_Abridged::VT_STATE, state);
  }
  void add_geoloc(::flatbuffers::Offset<::flatbuffers::String> geoloc) {
    fbb_.AddOffset(Airfield_Abridged::VT_GEOLOC, geoloc);
  }
  void add_gmtOffset(::flatbuffers::Offset<::flatbuffers::String> gmtOffset) {
    fbb_.AddOffset(Airfield_Abridged::VT_GMTOFFSET, gmtOffset);
  }
  void add_suitabilityCodes(::flatbuffers::Offset<::flatbuffers::String> suitabilityCodes) {
    fbb_.AddOffset(Airfield_Abridged::VT_SUITABILITYCODES, suitabilityCodes);
  }
  void add_miscCodes(::flatbuffers::Offset<::flatbuffers::String> miscCodes) {
    fbb_.AddOffset(Airfield_Abridged::VT_MISCCODES, miscCodes);
  }
  void add_runways(int32_t runways) {
    fbb_.AddElement<int32_t>(Airfield_Abridged::VT_RUNWAYS, runways, 0);
  }
  void add_maxRunwayLength(int32_t maxRunwayLength) {
    fbb_.AddElement<int32_t>(Airfield_Abridged::VT_MAXRUNWAYLENGTH, maxRunwayLength, 0);
  }
  void add_infoURL(::flatbuffers::Offset<::flatbuffers::String> infoURL) {
    fbb_.AddOffset(Airfield_Abridged::VT_INFOURL, infoURL);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Airfield_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Airfield_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(Airfield_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Airfield_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Airfield_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Airfield_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(Airfield_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Airfield_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit Airfield_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Airfield_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Airfield_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Airfield_Abridged> CreateAirfield_Abridged(
    ...
    Airfield_Abridged_dataMode_Enum dataMode = Airfield_Abridged_dataMode_Enum_REAL) {
  Airfield_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Airfield_Abridged> CreateAirfield_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAirfield_Abridged(
      _fbb,
      id__,
...
inline const Airfield_Abridged *GetAirfield_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<Airfield_Abridged>(buf);
}

inline const Airfield_Abridged *GetSizePrefixedAirfield_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Airfield_Abridged>(buf);
}

inline const char *Airfield_AbridgedIdentifier() {
  return "AIRF";
}

inline bool Airfield_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Airfield_AbridgedIdentifier());
}

inline bool SizePrefixedAirfield_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Airfield_AbridgedIdentifier(), true);
}

inline bool VerifyAirfield_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Airfield_Abridged>(Airfield_AbridgedIdentifier());
}

inline bool VerifySizePrefixedAirfield_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Airfield_Abridged>(Airfield_AbridgedIdentifier());
}

inline void FinishAirfield_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Airfield_Abridged> root) {
  fbb.Finish(root, Airfield_AbridgedIdentifier());
}

inline void FinishSizePrefixedAirfield_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Airfield_Abridged> root) {
  fbb.FinishSizePrefixed(root, Airfield_AbridgedIdentifier());
}
