...
struct Sensorlimits_Ingest;
struct Sensorlimits_IngestBuilder;

enum Sensorlimits_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Sensorlimits_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Sensorlimits_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Sensorlimits_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Sensorlimits_Ingest_dataMode_Enum_EXERCISE = 3,
  Sensorlimits_Ingest_dataMode_Enum_MIN = Sensorlimits_Ingest_dataMode_Enum_REAL,
  Sensorlimits_Ingest_dataMode_Enum_MAX = Sensorlimits_Ingest_dataMode_Enum_EXERCISE
};

inline const Sensorlimits_Ingest_dataMode_Enum (&EnumValuesSensorlimits_Ingest_dataMode_Enum())[4] {
  static const Sensorlimits_Ingest_dataMode_Enum values[] = {
    Sensorlimits_Ingest_dataMode_Enum_REAL,
    Sensorlimits_Ingest_dataMode_Enum_TEST,
    Sensorlimits_Ingest_dataMode_Enum_SIMULATED,
    Sensorlimits_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSensorlimits_Ingest_dataMode_Enum() {
...
inline const char *EnumNameSensorlimits_Ingest_dataMode_Enum(Sensorlimits_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Sensorlimits_Ingest_dataMode_Enum_REAL, Sensorlimits_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSensorlimits_Ingest_dataMode_Enum()[index];
}

/// /// Sensorlimits define 0 to many limits of a particular sensor in terms of observation coverage of on-orbit objects.
struct Sensorlimits_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Sensorlimits_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  Sensorlimits_Ingest_dataMode_Enum dataMode() const {
    return static_cast<Sensorlimits_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Sensorlimits_IngestBuilder {
  typedef Sensorlimits_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_idSensorLimits(::flatbuffers::Offset<::flatbuffers::String> idSensorLimits) {
    fbb_.AddOffset(Sensorlimits_Ingest::VT_IDSENSORLIMITS, idSensorLimits);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Sensorlimits_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Sensorlimits_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_upperLeftAzimuthLimit(double upperLeftAzimuthLimit) {
    fbb_.AddElement<double>(Sensorlimits_Ingest::VT_UPPERLEFTAZIMUTHLIMIT, upperLeftAzimuthLimit, 0.0);
  }
  void add_upperRightAzimuthLimit(double upperRightAzimuthLimit) {
    fbb_.AddElement<double>(Sensorlimits_Ingest::VT_UPPERRIGHTAZIMUTHLIMIT, upperRightAzimuthLimit, 0.0);
  }
  void add_lowerRightAzimuthLimit(double lowerRightAzimuthLimit) {
    fbb_.AddElement<double>(Sensorlimits_Ingest::VT_LOWERRIGHTAZIMUTHLIMIT, lowerRightAzimuthLimit, 0.0);
  }
  void add_lowerLeftAzimuthLimit(double lowerLeftAzimuthLimit) {
    fbb_.AddElement<double>(Sensorlimits_Ingest::VT_LOWERLEFTAZIMUTHLIMIT, lowerLeftAzimuthLimit, 0.0);
  }
  void add_lowerLeftElevationLimit(double lowerLeftElevationLimit) {
    fbb_.AddElement<double>(Sensorlimits_Ingest::VT_LOWERLEFTELEVATIONLIMIT, lowerLeftElevationLimit, 0.0);
  }
  void add_upperLeftElevationLimit(double upperLeftElevationLimit) {
    fbb_.AddElement<double>(Sensorlimits_Ingest::VT_UPPERLEFTELEVATIONLIMIT, upperLeftElevationLimit, 0.0);
  }
  void add_lowerRightElevationLimit(double lowerRightElevationLimit) {
    fbb_.AddElement<double>(Sensorlimits_Ingest::VT_LOWERRIGHTELEVATIONLIMIT, lowerRightElevationLimit, 0.0);
  }
  void add_upperRightElevationLimit(double upperRightElevationLimit) {
    fbb_.AddElement<double>(Sensorlimits_Ingest::VT_UPPERRIGHTELEVATIONLIMIT, upperRightElevationLimit, 0.0);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Sensorlimits_Ingest::VT_SOURCE, source);
  }
  void add_dataMode(Sensorlimits_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Sensorlimits_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Sensorlimits_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Sensorlimits_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(Sensorlimits_Ingest::VT_IDSENSOR, idSensor);
  }
  explicit Sensorlimits_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Sensorlimits_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Sensorlimits_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Sensorlimits_Ingest> CreateSensorlimits_Ingest(
    ...
    Sensorlimits_Ingest_dataMode_Enum dataMode = Sensorlimits_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0,
    ::flatbuffers::Offset<::flatbuffers::String> idSensor = 0) {
  Sensorlimits_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Sensorlimits_Ingest> CreateSensorlimits_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateSensorlimits_Ingest(
      _fbb,
      idSensorLimits__,
...
inline const Sensorlimits_Ingest *GetSensorlimits_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<Sensorlimits_Ingest>(buf);
}

inline const Sensorlimits_Ingest *GetSizePrefixedSensorlimits_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Sensorlimits_Ingest>(buf);
}

inline const char *Sensorlimits_IngestIdentifier() {
  return "SENS";
}

inline bool Sensorlimits_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Sensorlimits_IngestIdentifier());
}

inline bool SizePrefixedSensorlimits_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Sensorlimits_IngestIdentifier(), true);
}

inline bool VerifySensorlimits_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Sensorlimits_Ingest>(Sensorlimits_IngestIdentifier());
}

inline bool VerifySizePrefixedSensorlimits_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Sensorlimits_Ingest>(Sensorlimits_IngestIdentifier());
}

inline void FinishSensorlimits_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Sensorlimits_Ingest> root) {
  fbb.Finish(root, Sensorlimits_IngestIdentifier());
}

inline void FinishSizePrefixedSensorlimits_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Sensorlimits_Ingest> root) {
  fbb.FinishSizePrefixed(root, Sensorlimits_IngestIdentifier());
}
