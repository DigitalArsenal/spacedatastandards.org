...
struct Eop_Full;
struct Eop_FullBuilder;

enum Eop_Full_polarMotionState_Enum : int8_t {
  /// No description available.
  Eop_Full_polarMotionState_Enum_I = 0,
  /// No description available.
  Eop_Full_polarMotionState_Enum_P = 1,
  Eop_Full_polarMotionState_Enum_MIN = Eop_Full_polarMotionState_Enum_I,
  Eop_Full_polarMotionState_Enum_MAX = Eop_Full_polarMotionState_Enum_P
};

inline const Eop_Full_polarMotionState_Enum (&EnumValuesEop_Full_polarMotionState_Enum())[2] {
  static const Eop_Full_polarMotionState_Enum values[] = {
    Eop_Full_polarMotionState_Enum_I,
    Eop_Full_polarMotionState_Enum_P
  };
  return values;
}

inline const char * const *EnumNamesEop_Full_polarMotionState_Enum() {
...
inline const char *EnumNameEop_Full_polarMotionState_Enum(Eop_Full_polarMotionState_Enum e) {
  if (::flatbuffers::IsOutRange(e, Eop_Full_polarMotionState_Enum_I, Eop_Full_polarMotionState_Enum_P)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEop_Full_polarMotionState_Enum()[index];
}

enum Eop_Full_ut1UTCState_Enum : int8_t {
  /// No description available.
  Eop_Full_ut1UTCState_Enum_I = 0,
  /// No description available.
  Eop_Full_ut1UTCState_Enum_P = 1,
  Eop_Full_ut1UTCState_Enum_MIN = Eop_Full_ut1UTCState_Enum_I,
  Eop_Full_ut1UTCState_Enum_MAX = Eop_Full_ut1UTCState_Enum_P
};

inline const Eop_Full_ut1UTCState_Enum (&EnumValuesEop_Full_ut1UTCState_Enum())[2] {
  static const Eop_Full_ut1UTCState_Enum values[] = {
    Eop_Full_ut1UTCState_Enum_I,
    Eop_Full_ut1UTCState_Enum_P
  };
  return values;
}

inline const char * const *EnumNamesEop_Full_ut1UTCState_Enum() {
  static const char * const names[3] = {
    "I",
    "P",
    nullptr
...
inline const char *EnumNameEop_Full_ut1UTCState_Enum(Eop_Full_ut1UTCState_Enum e) {
  if (::flatbuffers::IsOutRange(e, Eop_Full_ut1UTCState_Enum_I, Eop_Full_ut1UTCState_Enum_P)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEop_Full_ut1UTCState_Enum()[index];
}

enum Eop_Full_nutationState_Enum : int8_t {
  /// No description available.
  Eop_Full_nutationState_Enum_I = 0,
  /// No description available.
  Eop_Full_nutationState_Enum_P = 1,
  Eop_Full_nutationState_Enum_MIN = Eop_Full_nutationState_Enum_I,
  Eop_Full_nutationState_Enum_MAX = Eop_Full_nutationState_Enum_P
};

inline const Eop_Full_nutationState_Enum (&EnumValuesEop_Full_nutationState_Enum())[2] {
  static const Eop_Full_nutationState_Enum values[] = {
    Eop_Full_nutationState_Enum_I,
    Eop_Full_nutationState_Enum_P
  };
  return values;
}

inline const char * const *EnumNamesEop_Full_nutationState_Enum() {
  static const char * const names[3] = {
    "I",
    "P",
    nullptr
...
inline const char *EnumNameEop_Full_nutationState_Enum(Eop_Full_nutationState_Enum e) {
  if (::flatbuffers::IsOutRange(e, Eop_Full_nutationState_Enum_I, Eop_Full_nutationState_Enum_P)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEop_Full_nutationState_Enum()[index];
}

enum Eop_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Eop_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Eop_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Eop_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Eop_Full_dataMode_Enum_EXERCISE = 3,
  Eop_Full_dataMode_Enum_MIN = Eop_Full_dataMode_Enum_REAL,
  Eop_Full_dataMode_Enum_MAX = Eop_Full_dataMode_Enum_EXERCISE
};

inline const Eop_Full_dataMode_Enum (&EnumValuesEop_Full_dataMode_Enum())[4] {
  static const Eop_Full_dataMode_Enum values[] = {
    Eop_Full_dataMode_Enum_REAL,
    Eop_Full_dataMode_Enum_TEST,
    Eop_Full_dataMode_Enum_SIMULATED,
    Eop_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesEop_Full_dataMode_Enum() {
...
inline const char *EnumNameEop_Full_dataMode_Enum(Eop_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Eop_Full_dataMode_Enum_REAL, Eop_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEop_Full_dataMode_Enum()[index];
}
...
struct Eop_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Eop_FullBuilder Builder;
  ...
  Eop_Full_polarMotionState_Enum polarMotionState() const {
    return static_cast<Eop_Full_polarMotionState_Enum>(GetField<int8_t>(VT_POLARMOTIONSTATE, 0));
  }
  ...
  /// Example: /// Example: I
  /// Constraints: Minimum length = 0, Maximum length = 1
  Eop_Full_ut1UTCState_Enum ut1UTCState() const {
    return static_cast<Eop_Full_ut1UTCState_Enum>(GetField<int8_t>(VT_UT1UTCSTATE, 0));
  }
  ...
  /// Example: /// Example: I
  /// Constraints: Minimum length = 0, Maximum length = 1
  Eop_Full_nutationState_Enum nutationState() const {
    return static_cast<Eop_Full_nutationState_Enum>(GetField<int8_t>(VT_NUTATIONSTATE, 0));
  }
  ...
  Eop_Full_dataMode_Enum dataMode() const {
    return static_cast<Eop_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Eop_FullBuilder {
  typedef Eop_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Eop_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Eop_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_eopDate(::flatbuffers::Offset<::flatbuffers::String> eopDate) {
    fbb_.AddOffset(Eop_Full::VT_EOPDATE, eopDate);
  }
  void add_polarMotionState(Eop_Full_polarMotionState_Enum polarMotionState) {
    fbb_.AddElement<int8_t>(Eop_Full::VT_POLARMOTIONSTATE, static_cast<int8_t>(polarMotionState), 0);
  }
  void add_polarMotionX(double polarMotionX) {
    fbb_.AddElement<double>(Eop_Full::VT_POLARMOTIONX, polarMotionX, 0.0);
  }
  void add_polarMotionXUnc(double polarMotionXUnc) {
    fbb_.AddElement<double>(Eop_Full::VT_POLARMOTIONXUNC, polarMotionXUnc, 0.0);
  }
  void add_polarMotionY(double polarMotionY) {
    fbb_.AddElement<double>(Eop_Full::VT_POLARMOTIONY, polarMotionY, 0.0);
  }
  void add_polarMotionYUnc(double polarMotionYUnc) {
    fbb_.AddElement<double>(Eop_Full::VT_POLARMOTIONYUNC, polarMotionYUnc, 0.0);
  }
  void add_ut1UTCState(Eop_Full_ut1UTCState_Enum ut1UTCState) {
    fbb_.AddElement<int8_t>(Eop_Full::VT_UT1UTCSTATE, static_cast<int8_t>(ut1UTCState), 0);
  }
  void add_ut1UTC(double ut1UTC) {
    fbb_.AddElement<double>(Eop_Full::VT_UT1UTC, ut1UTC, 0.0);
  }
  void add_ut1UTCUnc(double ut1UTCUnc) {
    fbb_.AddElement<double>(Eop_Full::VT_UT1UTCUNC, ut1UTCUnc, 0.0);
  }
  void add_lod(double lod) {
    fbb_.AddElement<double>(Eop_Full::VT_LOD, lod, 0.0);
  }
  void add_lodUnc(double lodUnc) {
    fbb_.AddElement<double>(Eop_Full::VT_LODUNC, lodUnc, 0.0);
  }
  void add_nutationState(Eop_Full_nutationState_Enum nutationState) {
    fbb_.AddElement<int8_t>(Eop_Full::VT_NUTATIONSTATE, static_cast<int8_t>(nutationState), 0);
  }
  void add_dPSI(double dPSI) {
    fbb_.AddElement<double>(Eop_Full::VT_DPSI, dPSI, 0.0);
  }
  void add_dPSIUnc(double dPSIUnc) {
    fbb_.AddElement<double>(Eop_Full::VT_DPSIUNC, dPSIUnc, 0.0);
  }
  void add_dEpsilon(double dEpsilon) {
    fbb_.AddElement<double>(Eop_Full::VT_DEPSILON, dEpsilon, 0.0);
  }
  void add_dEpsilonUnc(double dEpsilonUnc) {
    fbb_.AddElement<double>(Eop_Full::VT_DEPSILONUNC, dEpsilonUnc, 0.0);
  }
  void add_dX(double dX) {
    fbb_.AddElement<double>(Eop_Full::VT_DX, dX, 0.0);
  }
  void add_dXUnc(double dXUnc) {
    fbb_.AddElement<double>(Eop_Full::VT_DXUNC, dXUnc, 0.0);
  }
  void add_dY(double dY) {
    fbb_.AddElement<double>(Eop_Full::VT_DY, dY, 0.0);
  }
  void add_dYUnc(double dYUnc) {
    fbb_.AddElement<double>(Eop_Full::VT_DYUNC, dYUnc, 0.0);
  }
  void add_polarMotionXB(double polarMotionXB) {
    fbb_.AddElement<double>(Eop_Full::VT_POLARMOTIONXB, polarMotionXB, 0.0);
  }
  void add_polarMotionYB(double polarMotionYB) {
    fbb_.AddElement<double>(Eop_Full::VT_POLARMOTIONYB, polarMotionYB, 0.0);
  }
  void add_ut1UTCB(double ut1UTCB) {
    fbb_.AddElement<double>(Eop_Full::VT_UT1UTCB, ut1UTCB, 0.0);
  }
  void add_dPSIB(double dPSIB) {
    fbb_.AddElement<double>(Eop_Full::VT_DPSIB, dPSIB, 0.0);
  }
  void add_dEpsilonB(double dEpsilonB) {
    fbb_.AddElement<double>(Eop_Full::VT_DEPSILONB, dEpsilonB, 0.0);
  }
  void add_dXB(double dXB) {
    fbb_.AddElement<double>(Eop_Full::VT_DXB, dXB, 0.0);
  }
  void add_dYB(double dYB) {
    fbb_.AddElement<double>(Eop_Full::VT_DYB, dYB, 0.0);
  }
  void add_precessionNutationStd(::flatbuffers::Offset<::flatbuffers::String> precessionNutationStd) {
    fbb_.AddOffset(Eop_Full::VT_PRECESSIONNUTATIONSTD, precessionNutationStd);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(Eop_Full::VT_RAWFILEURI, rawFileURI);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Eop_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Eop_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(Eop_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Eop_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Eop_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Eop_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(Eop_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(Eop_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Eop_Full::VT_ORIGNETWORK, origNetwork);
  }
  explicit Eop_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Eop_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Eop_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Eop_Full> CreateEop_Full(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::String> id = 0,
    ::flatbuffers::Offset<::flatbuffers::String> classificationMarking = 0,
    ::flatbuffers::Offset<::flatbuffers::String> eopDate = 0,
    Eop_Full_polarMotionState_Enum polarMotionState = Eop_Full_polarMotionState_Enum_I,
    double polarMotionX = 0.0,
    double polarMotionXUnc = 0.0,
    double polarMotionY = 0.0,
    double polarMotionYUnc = 0.0,
    Eop_Full_ut1UTCState_Enum ut1UTCState = Eop_Full_ut1UTCState_Enum_I,
    double ut1UTC = 0.0,
    double ut1UTCUnc = 0.0,
    double lod = 0.0,
    double lodUnc = 0.0,
    Eop_Full_nutationState_Enum nutationState = Eop_Full_nutationState_Enum_I,
    double dPSI = 0.0,
    double dPSIUnc = 0.0,
    double dEpsilon = 0.0,
    ...
    Eop_Full_dataMode_Enum dataMode = Eop_Full_dataMode_Enum_REAL,
...
inline ::flatbuffers::Offset<Eop_Full> CreateEop_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Eop_Full *GetEop_Full(const void *buf) {
  return ::flatbuffers::GetRoot<Eop_Full>(buf);
}

inline const Eop_Full *GetSizePrefixedEop_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Eop_Full>(buf);
}

inline const char *Eop_FullIdentifier() {
  return "EOPF";
}

inline bool Eop_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Eop_FullIdentifier());
}

inline bool SizePrefixedEop_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Eop_FullIdentifier(), true);
}

inline bool VerifyEop_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Eop_Full>(Eop_FullIdentifier());
}

inline bool VerifySizePrefixedEop_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Eop_Full>(Eop_FullIdentifier());
}

inline void FinishEop_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Eop_Full> root) {
  fbb.Finish(root, Eop_FullIdentifier());
}

inline void FinishSizePrefixedEop_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Eop_Full> root) {
  fbb.FinishSizePrefixed(root, Eop_FullIdentifier());
}
