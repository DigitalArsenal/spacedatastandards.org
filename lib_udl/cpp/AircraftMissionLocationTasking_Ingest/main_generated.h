...
struct AircraftMissionLocationTasking_Ingest;
struct AircraftMissionLocationTasking_IngestBuilder;

/// /// Collection of aircraft mission location information for this aircraft mission tasking.
struct AircraftMissionLocationTasking_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AircraftMissionLocationTasking_IngestBuilder Builder;
...
struct AircraftMissionLocationTasking_IngestBuilder {
  typedef AircraftMissionLocationTasking_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(AircraftMissionLocationTasking_Ingest::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(AircraftMissionLocationTasking_Ingest::VT_ENDTIME, endTime);
  }
  void add_msnLocName(::flatbuffers::Offset<::flatbuffers::String> msnLocName) {
    fbb_.AddOffset(AircraftMissionLocationTasking_Ingest::VT_MSNLOCNAME, msnLocName);
  }
  void add_alt(int32_t alt) {
    fbb_.AddElement<int32_t>(AircraftMissionLocationTasking_Ingest::VT_ALT, alt, 0);
  }
  void add_airMsnPri(::flatbuffers::Offset<::flatbuffers::String> airMsnPri) {
    fbb_.AddOffset(AircraftMissionLocationTasking_Ingest::VT_AIRMSNPRI, airMsnPri);
  }
  void add_areaGeoRad(int32_t areaGeoRad) {
    fbb_.AddElement<int32_t>(AircraftMissionLocationTasking_Ingest::VT_AREAGEORAD, areaGeoRad, 0);
  }
  void add_msnLocPtName(::flatbuffers::Offset<::flatbuffers::String> msnLocPtName) {
    fbb_.AddOffset(AircraftMissionLocationTasking_Ingest::VT_MSNLOCPTNAME, msnLocPtName);
  }
  void add_msnLocPtLat(double msnLocPtLat) {
    fbb_.AddElement<double>(AircraftMissionLocationTasking_Ingest::VT_MSNLOCPTLAT, msnLocPtLat, 0.0);
  }
  void add_msnLocPtLon(double msnLocPtLon) {
    fbb_.AddElement<double>(AircraftMissionLocationTasking_Ingest::VT_MSNLOCPTLON, msnLocPtLon, 0.0);
  }
  void add_msnLocPtBarT(::flatbuffers::Offset<::flatbuffers::String> msnLocPtBarT) {
    fbb_.AddOffset(AircraftMissionLocationTasking_Ingest::VT_MSNLOCPTBART, msnLocPtBarT);
  }
  explicit AircraftMissionLocationTasking_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AircraftMissionLocationTasking_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AircraftMissionLocationTasking_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AircraftMissionLocationTasking_Ingest> CreateAircraftMissionLocationTasking_Ingest(
  ...
  AircraftMissionLocationTasking_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AircraftMissionLocationTasking_Ingest> CreateAircraftMissionLocationTasking_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAircraftMissionLocationTasking_Ingest(
      _fbb,
      startTime__,
      endTime__,
      msnLocName__,
...
inline const AircraftMissionLocationTasking_Ingest *GetAircraftMissionLocationTasking_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<AircraftMissionLocationTasking_Ingest>(buf);
}

inline const AircraftMissionLocationTasking_Ingest *GetSizePrefixedAircraftMissionLocationTasking_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AircraftMissionLocationTasking_Ingest>(buf);
}

inline const char *AircraftMissionLocationTasking_IngestIdentifier() {
  return "AIRC";
}

inline bool AircraftMissionLocationTasking_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftMissionLocationTasking_IngestIdentifier());
}

inline bool SizePrefixedAircraftMissionLocationTasking_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftMissionLocationTasking_IngestIdentifier(), true);
}

inline bool VerifyAircraftMissionLocationTasking_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AircraftMissionLocationTasking_Ingest>(AircraftMissionLocationTasking_IngestIdentifier());
}

inline bool VerifySizePrefixedAircraftMissionLocationTasking_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AircraftMissionLocationTasking_Ingest>(AircraftMissionLocationTasking_IngestIdentifier());
}

inline void FinishAircraftMissionLocationTasking_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftMissionLocationTasking_Ingest> root) {
  fbb.Finish(root, AircraftMissionLocationTasking_IngestIdentifier());
}

inline void FinishSizePrefixedAircraftMissionLocationTasking_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftMissionLocationTasking_Ingest> root) {
  fbb.FinishSizePrefixed(root, AircraftMissionLocationTasking_IngestIdentifier());
}
