...
struct AirspaceControlOrder_Ingest;
struct AirspaceControlOrder_IngestBuilder;

enum AirspaceControlOrder_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  AirspaceControlOrder_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  AirspaceControlOrder_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  AirspaceControlOrder_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  AirspaceControlOrder_Ingest_dataMode_Enum_EXERCISE = 3,
  AirspaceControlOrder_Ingest_dataMode_Enum_MIN = AirspaceControlOrder_Ingest_dataMode_Enum_REAL,
  AirspaceControlOrder_Ingest_dataMode_Enum_MAX = AirspaceControlOrder_Ingest_dataMode_Enum_EXERCISE
};

inline const AirspaceControlOrder_Ingest_dataMode_Enum (&EnumValuesAirspaceControlOrder_Ingest_dataMode_Enum())[4] {
  static const AirspaceControlOrder_Ingest_dataMode_Enum values[] = {
    AirspaceControlOrder_Ingest_dataMode_Enum_REAL,
    AirspaceControlOrder_Ingest_dataMode_Enum_TEST,
    AirspaceControlOrder_Ingest_dataMode_Enum_SIMULATED,
    AirspaceControlOrder_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAirspaceControlOrder_Ingest_dataMode_Enum() {
...
inline const char *EnumNameAirspaceControlOrder_Ingest_dataMode_Enum(AirspaceControlOrder_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AirspaceControlOrder_Ingest_dataMode_Enum_REAL, AirspaceControlOrder_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAirspaceControlOrder_Ingest_dataMode_Enum()[index];
}
...
struct AirspaceControlOrder_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AirspaceControlOrder_IngestBuilder Builder;
  ...
  AirspaceControlOrder_Ingest_dataMode_Enum dataMode() const {
    return static_cast<AirspaceControlOrder_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AirspaceControlOrder_IngestBuilder {
  typedef AirspaceControlOrder_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_RAWFILEURI, rawFileURI);
  }
  void add_opExName(::flatbuffers::Offset<::flatbuffers::String> opExName) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_OPEXNAME, opExName);
  }
  void add_originator(::flatbuffers::Offset<::flatbuffers::String> originator) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_ORIGINATOR, originator);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_STARTTIME, startTime);
  }
  void add_stopTime(::flatbuffers::Offset<::flatbuffers::String> stopTime) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_STOPTIME, stopTime);
  }
  void add_stopQualifier(::flatbuffers::Offset<::flatbuffers::String> stopQualifier) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_STOPQUALIFIER, stopQualifier);
  }
  void add_opExInfo(::flatbuffers::Offset<::flatbuffers::String> opExInfo) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_OPEXINFO, opExInfo);
  }
  void add_opExInfoAlt(::flatbuffers::Offset<::flatbuffers::String> opExInfoAlt) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_OPEXINFOALT, opExInfoAlt);
  }
  void add_planOrigNum(::flatbuffers::Offset<::flatbuffers::String> planOrigNum) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_PLANORIGNUM, planOrigNum);
  }
  void add_serialNum(::flatbuffers::Offset<::flatbuffers::String> serialNum) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_SERIALNUM, serialNum);
  }
  void add_month(::flatbuffers::Offset<::flatbuffers::String> month) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_MONTH, month);
  }
  void add_qualifier(::flatbuffers::Offset<::flatbuffers::String> qualifier) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_QUALIFIER, qualifier);
  }
  void add_qualSN(int32_t qualSN) {
    fbb_.AddElement<int32_t>(AirspaceControlOrder_Ingest::VT_QUALSN, qualSN, 0);
  }
  void add_areaOfValidity(::flatbuffers::Offset<::flatbuffers::String> areaOfValidity) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_AREAOFVALIDITY, areaOfValidity);
  }
  void add_acoSerialNum(::flatbuffers::Offset<::flatbuffers::String> acoSerialNum) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_ACOSERIALNUM, acoSerialNum);
  }
  void add_geoDatum(::flatbuffers::Offset<::flatbuffers::String> geoDatum) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_GEODATUM, geoDatum);
  }
  void add_acoComments(::flatbuffers::Offset<::flatbuffers::String> acoComments) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_ACOCOMMENTS, acoComments);
  }
  void add_airspaceControlOrderReferences(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> airspaceControlOrderReferences) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_AIRSPACECONTROLORDERREFERENCES, airspaceControlOrderReferences);
  }
  ...
  void add_declassExemptionCode(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> declassExemptionCode) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_DECLASSEXEMPTIONCODE, declassExemptionCode);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AirspaceControlOrder_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(AirspaceControlOrder_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AirspaceControlOrder_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit AirspaceControlOrder_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AirspaceControlOrder_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AirspaceControlOrder_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AirspaceControlOrder_Ingest> CreateAirspaceControlOrder_Ingest(
    ...
    AirspaceControlOrder_Ingest_dataMode_Enum dataMode = AirspaceControlOrder_Ingest_dataMode_Enum_REAL) {
  AirspaceControlOrder_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AirspaceControlOrder_Ingest> CreateAirspaceControlOrder_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateAirspaceControlOrder_Ingest(
      _fbb,
      id__,
...
inline const AirspaceControlOrder_Ingest *GetAirspaceControlOrder_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<AirspaceControlOrder_Ingest>(buf);
}

inline const AirspaceControlOrder_Ingest *GetSizePrefixedAirspaceControlOrder_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AirspaceControlOrder_Ingest>(buf);
}

inline const char *AirspaceControlOrder_IngestIdentifier() {
  return "AIRS";
}

inline bool AirspaceControlOrder_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirspaceControlOrder_IngestIdentifier());
}

inline bool SizePrefixedAirspaceControlOrder_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AirspaceControlOrder_IngestIdentifier(), true);
}

inline bool VerifyAirspaceControlOrder_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AirspaceControlOrder_Ingest>(AirspaceControlOrder_IngestIdentifier());
}

inline bool VerifySizePrefixedAirspaceControlOrder_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AirspaceControlOrder_Ingest>(AirspaceControlOrder_IngestIdentifier());
}

inline void FinishAirspaceControlOrder_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirspaceControlOrder_Ingest> root) {
  fbb.Finish(root, AirspaceControlOrder_IngestIdentifier());
}

inline void FinishSizePrefixedAirspaceControlOrder_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AirspaceControlOrder_Ingest> root) {
  fbb.FinishSizePrefixed(root, AirspaceControlOrder_IngestIdentifier());
}
