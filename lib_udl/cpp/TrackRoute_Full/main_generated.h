...
struct TrackRoute_Full;
struct TrackRoute_FullBuilder;

enum TrackRoute_Full_dataMode_Enum : int8_t {
  ...
  TrackRoute_Full_dataMode_Enum_MIN = TrackRoute_Full_dataMode_Enum_REAL,
  TrackRoute_Full_dataMode_Enum_MAX = TrackRoute_Full_dataMode_Enum_EXERCISE
};

inline const TrackRoute_Full_dataMode_Enum (&EnumValuesTrackRoute_Full_dataMode_Enum())[4] {
  static const TrackRoute_Full_dataMode_Enum values[] = {
    TrackRoute_Full_dataMode_Enum_REAL,
    TrackRoute_Full_dataMode_Enum_TEST,
    TrackRoute_Full_dataMode_Enum_SIMULATED,
    TrackRoute_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesTrackRoute_Full_dataMode_Enum() {
...
inline const char *EnumNameTrackRoute_Full_dataMode_Enum(TrackRoute_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, TrackRoute_Full_dataMode_Enum_REAL, TrackRoute_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesTrackRoute_Full_dataMode_Enum()[index];
}

/// /// A track route is a prescribed route for performing training events or operations such as air refueling.
struct TrackRoute_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef TrackRoute_FullBuilder Builder;
  ...
  TrackRoute_Full_dataMode_Enum dataMode() const {
    return static_cast<TrackRoute_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct TrackRoute_FullBuilder {
  typedef TrackRoute_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(TrackRoute_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(TrackRoute_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(TrackRoute_Full::VT_TYPE, type);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(TrackRoute_Full::VT_EXTERNALID, externalId);
  }
  void add_direction(::flatbuffers::Offset<::flatbuffers::String> direction) {
    fbb_.AddOffset(TrackRoute_Full::VT_DIRECTION, direction);
  }
  void add_creatingOrg(::flatbuffers::Offset<::flatbuffers::String> creatingOrg) {
    fbb_.AddOffset(TrackRoute_Full::VT_CREATINGORG, creatingOrg);
  }
  void add_locationTrackId(::flatbuffers::Offset<::flatbuffers::String> locationTrackId) {
    fbb_.AddOffset(TrackRoute_Full::VT_LOCATIONTRACKID, locationTrackId);
  }
  void add_trackId(::flatbuffers::Offset<::flatbuffers::String> trackId) {
    fbb_.AddOffset(TrackRoute_Full::VT_TRACKID, trackId);
  }
  void add_trackName(::flatbuffers::Offset<::flatbuffers::String> trackName) {
    fbb_.AddOffset(TrackRoute_Full::VT_TRACKNAME, trackName);
  }
  void add_shortName(::flatbuffers::Offset<::flatbuffers::String> shortName) {
    fbb_.AddOffset(TrackRoute_Full::VT_SHORTNAME, shortName);
  }
  void add_typeCode(::flatbuffers::Offset<::flatbuffers::String> typeCode) {
    fbb_.AddOffset(TrackRoute_Full::VT_TYPECODE, typeCode);
  }
  void add_regionCode(::flatbuffers::Offset<::flatbuffers::String> regionCode) {
    fbb_.AddOffset(TrackRoute_Full::VT_REGIONCODE, regionCode);
  }
  void add_regionName(::flatbuffers::Offset<::flatbuffers::String> regionName) {
    fbb_.AddOffset(TrackRoute_Full::VT_REGIONNAME, regionName);
  }
  void add_apxBeaconCode(::flatbuffers::Offset<::flatbuffers::String> apxBeaconCode) {
    fbb_.AddOffset(TrackRoute_Full::VT_APXBEACONCODE, apxBeaconCode);
  }
  void add_receiverTankerCHCode(::flatbuffers::Offset<::flatbuffers::String> receiverTankerCHCode) {
    fbb_.AddOffset(TrackRoute_Full::VT_RECEIVERTANKERCHCODE, receiverTankerCHCode);
  }
  void add_apnSetting(::flatbuffers::Offset<::flatbuffers::String> apnSetting) {
    fbb_.AddOffset(TrackRoute_Full::VT_APNSETTING, apnSetting);
  }
  void add_sic(::flatbuffers::Offset<::flatbuffers::String> sic) {
    fbb_.AddOffset(TrackRoute_Full::VT_SIC, sic);
  }
  void add_reviewDate(::flatbuffers::Offset<::flatbuffers::String> reviewDate) {
    fbb_.AddOffset(TrackRoute_Full::VT_REVIEWDATE, reviewDate);
  }
  void add_lastUsedDate(::flatbuffers::Offset<::flatbuffers::String> lastUsedDate) {
    fbb_.AddOffset(TrackRoute_Full::VT_LASTUSEDDATE, lastUsedDate);
  }
  void add_lastUpdateDate(::flatbuffers::Offset<::flatbuffers::String> lastUpdateDate) {
    fbb_.AddOffset(TrackRoute_Full::VT_LASTUPDATEDATE, lastUpdateDate);
  }
  void add_priFreq(double priFreq) {
    fbb_.AddElement<double>(TrackRoute_Full::VT_PRIFREQ, priFreq, 0.0);
  }
  void add_secFreq(double secFreq) {
    fbb_.AddElement<double>(TrackRoute_Full::VT_SECFREQ, secFreq, 0.0);
  }
  void add_artccMessage(::flatbuffers::Offset<::flatbuffers::String> artccMessage) {
    fbb_.AddOffset(TrackRoute_Full::VT_ARTCCMESSAGE, artccMessage);
  }
  void add_schedulerOrgName(::flatbuffers::Offset<::flatbuffers::String> schedulerOrgName) {
    fbb_.AddOffset(TrackRoute_Full::VT_SCHEDULERORGNAME, schedulerOrgName);
  }
  void add_schedulerOrgUnit(::flatbuffers::Offset<::flatbuffers::String> schedulerOrgUnit) {
    fbb_.AddOffset(TrackRoute_Full::VT_SCHEDULERORGUNIT, schedulerOrgUnit);
  }
  void add_effectiveDate(::flatbuffers::Offset<::flatbuffers::String> effectiveDate) {
    fbb_.AddOffset(TrackRoute_Full::VT_EFFECTIVEDATE, effectiveDate);
  }
  void add_routePoints(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> routePoints) {
    fbb_.AddOffset(TrackRoute_Full::VT_ROUTEPOINTS, routePoints);
  }
  void add_altitudeBlocks(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> altitudeBlocks) {
    fbb_.AddOffset(TrackRoute_Full::VT_ALTITUDEBLOCKS, altitudeBlocks);
  }
  void add_poc(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> poc) {
    fbb_.AddOffset(TrackRoute_Full::VT_POC, poc);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(TrackRoute_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(TrackRoute_Full::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(TrackRoute_Full::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(TrackRoute_Full::VT_UPDATEDBY, updatedBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(TrackRoute_Full::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(TrackRoute_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(TrackRoute_Full::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(TrackRoute_Full::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(TrackRoute_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(TrackRoute_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit TrackRoute_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<TrackRoute_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<TrackRoute_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<TrackRoute_Full> CreateTrackRoute_Full(
    ...
    TrackRoute_Full_dataMode_Enum dataMode = TrackRoute_Full_dataMode_Enum_REAL) {
  TrackRoute_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<TrackRoute_Full> CreateTrackRoute_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const TrackRoute_Full *GetTrackRoute_Full(const void *buf) {
  return ::flatbuffers::GetRoot<TrackRoute_Full>(buf);
}

inline const TrackRoute_Full *GetSizePrefixedTrackRoute_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<TrackRoute_Full>(buf);
}

inline const char *TrackRoute_FullIdentifier() {
  return "TRAC";
}

inline bool TrackRoute_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, TrackRoute_FullIdentifier());
}

inline bool SizePrefixedTrackRoute_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, TrackRoute_FullIdentifier(), true);
}

inline bool VerifyTrackRoute_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<TrackRoute_Full>(TrackRoute_FullIdentifier());
}

inline bool VerifySizePrefixedTrackRoute_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<TrackRoute_Full>(TrackRoute_FullIdentifier());
}

inline void FinishTrackRoute_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<TrackRoute_Full> root) {
  fbb.Finish(root, TrackRoute_FullIdentifier());
}

inline void FinishSizePrefixedTrackRoute_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<TrackRoute_Full> root) {
  fbb.FinishSizePrefixed(root, TrackRoute_FullIdentifier());
}
