...
struct DataLinkReferences_Ingest;
struct DataLinkReferences_IngestBuilder;

/// /// Collection of reference information. There can be 0 to many DataLinkReferences collections within the datalink service.
struct DataLinkReferences_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef DataLinkReferences_IngestBuilder Builder;
...
struct DataLinkReferences_IngestBuilder {
  typedef DataLinkReferences_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_refSerialId(::flatbuffers::Offset<::flatbuffers::String> refSerialId) {
    fbb_.AddOffset(DataLinkReferences_Ingest::VT_REFSERIALID, refSerialId);
  }
  void add_refType(::flatbuffers::Offset<::flatbuffers::String> refType) {
    fbb_.AddOffset(DataLinkReferences_Ingest::VT_REFTYPE, refType);
  }
  void add_refOriginator(::flatbuffers::Offset<::flatbuffers::String> refOriginator) {
    fbb_.AddOffset(DataLinkReferences_Ingest::VT_REFORIGINATOR, refOriginator);
  }
  void add_refTs(::flatbuffers::Offset<::flatbuffers::String> refTs) {
    fbb_.AddOffset(DataLinkReferences_Ingest::VT_REFTS, refTs);
  }
  void add_refSerialNum(::flatbuffers::Offset<::flatbuffers::String> refSerialNum) {
    fbb_.AddOffset(DataLinkReferences_Ingest::VT_REFSERIALNUM, refSerialNum);
  }
  void add_refSpecialNotation(::flatbuffers::Offset<::flatbuffers::String> refSpecialNotation) {
    fbb_.AddOffset(DataLinkReferences_Ingest::VT_REFSPECIALNOTATION, refSpecialNotation);
  }
  void add_refSICs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> refSICs) {
    fbb_.AddOffset(DataLinkReferences_Ingest::VT_REFSICS, refSICs);
  }
  explicit DataLinkReferences_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<DataLinkReferences_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<DataLinkReferences_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<DataLinkReferences_Ingest> CreateDataLinkReferences_Ingest(
  ...
  DataLinkReferences_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<DataLinkReferences_Ingest> CreateDataLinkReferences_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const DataLinkReferences_Ingest *GetDataLinkReferences_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<DataLinkReferences_Ingest>(buf);
}

inline const DataLinkReferences_Ingest *GetSizePrefixedDataLinkReferences_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<DataLinkReferences_Ingest>(buf);
}

inline const char *DataLinkReferences_IngestIdentifier() {
  return "DATA";
}

inline bool DataLinkReferences_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLinkReferences_IngestIdentifier());
}

inline bool SizePrefixedDataLinkReferences_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, DataLinkReferences_IngestIdentifier(), true);
}

inline bool VerifyDataLinkReferences_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<DataLinkReferences_Ingest>(DataLinkReferences_IngestIdentifier());
}

inline bool VerifySizePrefixedDataLinkReferences_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<DataLinkReferences_Ingest>(DataLinkReferences_IngestIdentifier());
}

inline void FinishDataLinkReferences_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLinkReferences_Ingest> root) {
  fbb.Finish(root, DataLinkReferences_IngestIdentifier());
}

inline void FinishSizePrefixedDataLinkReferences_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<DataLinkReferences_Ingest> root) {
  fbb.FinishSizePrefixed(root, DataLinkReferences_IngestIdentifier());
}
