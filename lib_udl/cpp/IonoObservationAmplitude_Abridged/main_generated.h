...
struct IonoObservationAmplitude_Abridged;
struct IonoObservationAmplitude_AbridgedBuilder;
...
struct IonoObservationAmplitude_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef IonoObservationAmplitude_AbridgedBuilder Builder;
...
struct IonoObservationAmplitude_AbridgedBuilder {
  typedef IonoObservationAmplitude_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(IonoObservationAmplitude_Abridged::VT_NOTES, notes);
  }
  void add_dimensions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dimensions) {
    fbb_.AddOffset(IonoObservationAmplitude_Abridged::VT_DIMENSIONS, dimensions);
  }
  void add_dimensionName(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> dimensionName) {
    fbb_.AddOffset(IonoObservationAmplitude_Abridged::VT_DIMENSIONNAME, dimensionName);
  }
  void add_data(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> data) {
    fbb_.AddOffset(IonoObservationAmplitude_Abridged::VT_DATA, data);
  }
  explicit IonoObservationAmplitude_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<IonoObservationAmplitude_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<IonoObservationAmplitude_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<IonoObservationAmplitude_Abridged> CreateIonoObservationAmplitude_Abridged(
  ...
  IonoObservationAmplitude_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<IonoObservationAmplitude_Abridged> CreateIonoObservationAmplitude_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const IonoObservationAmplitude_Abridged *GetIonoObservationAmplitude_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<IonoObservationAmplitude_Abridged>(buf);
}

inline const IonoObservationAmplitude_Abridged *GetSizePrefixedIonoObservationAmplitude_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<IonoObservationAmplitude_Abridged>(buf);
}

inline const char *IonoObservationAmplitude_AbridgedIdentifier() {
  return "IONO";
}

inline bool IonoObservationAmplitude_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationAmplitude_AbridgedIdentifier());
}

inline bool SizePrefixedIonoObservationAmplitude_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, IonoObservationAmplitude_AbridgedIdentifier(), true);
}

inline bool VerifyIonoObservationAmplitude_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<IonoObservationAmplitude_Abridged>(IonoObservationAmplitude_AbridgedIdentifier());
}

inline bool VerifySizePrefixedIonoObservationAmplitude_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<IonoObservationAmplitude_Abridged>(IonoObservationAmplitude_AbridgedIdentifier());
}

inline void FinishIonoObservationAmplitude_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationAmplitude_Abridged> root) {
  fbb.Finish(root, IonoObservationAmplitude_AbridgedIdentifier());
}

inline void FinishSizePrefixedIonoObservationAmplitude_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<IonoObservationAmplitude_Abridged> root) {
  fbb.FinishSizePrefixed(root, IonoObservationAmplitude_AbridgedIdentifier());
}
