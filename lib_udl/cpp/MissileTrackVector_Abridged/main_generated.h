...
struct MissileTrackVector_Abridged;
struct MissileTrackVector_AbridgedBuilder;

/// /// Schema for Missile Track Vector data.
struct MissileTrackVector_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef MissileTrackVector_AbridgedBuilder Builder;
...
struct MissileTrackVector_AbridgedBuilder {
  typedef MissileTrackVector_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(MissileTrackVector_Abridged::VT_TYPE, type);
  }
  void add_object(::flatbuffers::Offset<::flatbuffers::String> object) {
    fbb_.AddOffset(MissileTrackVector_Abridged::VT_OBJECT, object);
  }
  void add_epoch(::flatbuffers::Offset<::flatbuffers::String> epoch) {
    fbb_.AddOffset(MissileTrackVector_Abridged::VT_EPOCH, epoch);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(MissileTrackVector_Abridged::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(MissileTrackVector_Abridged::VT_ORIGSENSORID, origSensorId);
  }
  void add_pos(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> pos) {
    fbb_.AddOffset(MissileTrackVector_Abridged::VT_POS, pos);
  }
  void add_vel(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> vel) {
    fbb_.AddOffset(MissileTrackVector_Abridged::VT_VEL, vel);
  }
  void add_accel(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> accel) {
    fbb_.AddOffset(MissileTrackVector_Abridged::VT_ACCEL, accel);
  }
  void add_course(double course) {
    fbb_.AddElement<double>(MissileTrackVector_Abridged::VT_COURSE, course, 0.0);
  }
  void add_spd(double spd) {
    fbb_.AddElement<double>(MissileTrackVector_Abridged::VT_SPD, spd, 0.0);
  }
  void add_referenceFrame(::flatbuffers::Offset<::flatbuffers::String> referenceFrame) {
    fbb_.AddOffset(MissileTrackVector_Abridged::VT_REFERENCEFRAME, referenceFrame);
  }
  void add_cov(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> cov) {
    fbb_.AddOffset(MissileTrackVector_Abridged::VT_COV, cov);
  }
  void add_covReferenceFrame(::flatbuffers::Offset<::flatbuffers::String> covReferenceFrame) {
    fbb_.AddOffset(MissileTrackVector_Abridged::VT_COVREFERENCEFRAME, covReferenceFrame);
  }
  void add_vectorLat(double vectorLat) {
    fbb_.AddElement<double>(MissileTrackVector_Abridged::VT_VECTORLAT, vectorLat, 0.0);
  }
  void add_vectorLon(double vectorLon) {
    fbb_.AddElement<double>(MissileTrackVector_Abridged::VT_VECTORLON, vectorLon, 0.0);
  }
  void add_vectorAlt(double vectorAlt) {
    fbb_.AddElement<double>(MissileTrackVector_Abridged::VT_VECTORALT, vectorAlt, 0.0);
  }
  void add_confidence(int32_t confidence) {
    fbb_.AddElement<int32_t>(MissileTrackVector_Abridged::VT_CONFIDENCE, confidence, 0);
  }
  void add_status(::flatbuffers::Offset<::flatbuffers::String> status) {
    fbb_.AddOffset(MissileTrackVector_Abridged::VT_STATUS, status);
  }
  void add_timeSource(::flatbuffers::Offset<::flatbuffers::String> timeSource) {
    fbb_.AddOffset(MissileTrackVector_Abridged::VT_TIMESOURCE, timeSource);
  }
  void add_quat(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> quat) {
    fbb_.AddOffset(MissileTrackVector_Abridged::VT_QUAT, quat);
  }
  void add_flightAz(double flightAz) {
    fbb_.AddElement<double>(MissileTrackVector_Abridged::VT_FLIGHTAZ, flightAz, 0.0);
  }
  explicit MissileTrackVector_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<MissileTrackVector_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<MissileTrackVector_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<MissileTrackVector_Abridged> CreateMissileTrackVector_Abridged(
    ...
    double flightAz = 0.0) {
  MissileTrackVector_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<MissileTrackVector_Abridged> CreateMissileTrackVector_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const MissileTrackVector_Abridged *GetMissileTrackVector_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<MissileTrackVector_Abridged>(buf);
}

inline const MissileTrackVector_Abridged *GetSizePrefixedMissileTrackVector_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<MissileTrackVector_Abridged>(buf);
}

inline const char *MissileTrackVector_AbridgedIdentifier() {
  return "MISS";
}

inline bool MissileTrackVector_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MissileTrackVector_AbridgedIdentifier());
}

inline bool SizePrefixedMissileTrackVector_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, MissileTrackVector_AbridgedIdentifier(), true);
}

inline bool VerifyMissileTrackVector_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<MissileTrackVector_Abridged>(MissileTrackVector_AbridgedIdentifier());
}

inline bool VerifySizePrefixedMissileTrackVector_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<MissileTrackVector_Abridged>(MissileTrackVector_AbridgedIdentifier());
}

inline void FinishMissileTrackVector_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MissileTrackVector_Abridged> root) {
  fbb.Finish(root, MissileTrackVector_AbridgedIdentifier());
}

inline void FinishSizePrefixedMissileTrackVector_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MissileTrackVector_Abridged> root) {
  fbb.FinishSizePrefixed(root, MissileTrackVector_AbridgedIdentifier());
}
