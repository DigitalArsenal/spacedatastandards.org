...
struct OnorbitDetails;
struct OnorbitDetailsBuilder;

enum OnorbitDetails_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  OnorbitDetails_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  OnorbitDetails_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  OnorbitDetails_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  OnorbitDetails_dataMode_Enum_EXERCISE = 3,
  OnorbitDetails_dataMode_Enum_MIN = OnorbitDetails_dataMode_Enum_REAL,
  OnorbitDetails_dataMode_Enum_MAX = OnorbitDetails_dataMode_Enum_EXERCISE
};

inline const OnorbitDetails_dataMode_Enum (&EnumValuesOnorbitDetails_dataMode_Enum())[4] {
  static const OnorbitDetails_dataMode_Enum values[] = {
    OnorbitDetails_dataMode_Enum_REAL,
    OnorbitDetails_dataMode_Enum_TEST,
    OnorbitDetails_dataMode_Enum_SIMULATED,
    OnorbitDetails_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesOnorbitDetails_dataMode_Enum() {
...
inline const char *EnumNameOnorbitDetails_dataMode_Enum(OnorbitDetails_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, OnorbitDetails_dataMode_Enum_REAL, OnorbitDetails_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOnorbitDetails_dataMode_Enum()[index];
}

/// /// Contains details of the OnOrbit object.
struct OnorbitDetails FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef OnorbitDetailsBuilder Builder;
  ...
  OnorbitDetails_dataMode_Enum dataMode() const {
    return static_cast<OnorbitDetails_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct OnorbitDetailsBuilder {
  typedef OnorbitDetails Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(OnorbitDetails::VT_ID, id);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(OnorbitDetails::VT_IDONORBIT, idOnOrbit);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(OnorbitDetails::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_lastObTime(::flatbuffers::Offset<::flatbuffers::String> lastObTime) {
    fbb_.AddOffset(OnorbitDetails::VT_LASTOBTIME, lastObTime);
  }
  void add_vismag(double vismag) {
    fbb_.AddElement<double>(OnorbitDetails::VT_VISMAG, vismag, 0.0);
  }
  void add_vismagMin(double vismagMin) {
    fbb_.AddElement<double>(OnorbitDetails::VT_VISMAGMIN, vismagMin, 0.0);
  }
  void add_vismagMax(double vismagMax) {
    fbb_.AddElement<double>(OnorbitDetails::VT_VISMAGMAX, vismagMax, 0.0);
  }
  void add_vismagMean(double vismagMean) {
    fbb_.AddElement<double>(OnorbitDetails::VT_VISMAGMEAN, vismagMean, 0.0);
  }
  void add_rcs(double rcs) {
    fbb_.AddElement<double>(OnorbitDetails::VT_RCS, rcs, 0.0);
  }
  void add_rcsMin(double rcsMin) {
    fbb_.AddElement<double>(OnorbitDetails::VT_RCSMIN, rcsMin, 0.0);
  }
  void add_rcsMax(double rcsMax) {
    fbb_.AddElement<double>(OnorbitDetails::VT_RCSMAX, rcsMax, 0.0);
  }
  void add_rcsMean(double rcsMean) {
    fbb_.AddElement<double>(OnorbitDetails::VT_RCSMEAN, rcsMean, 0.0);
  }
  void add_bolDeltaV(double bolDeltaV) {
    fbb_.AddElement<double>(OnorbitDetails::VT_BOLDELTAV, bolDeltaV, 0.0);
  }
  void add_maxDeltaV(double maxDeltaV) {
    fbb_.AddElement<double>(OnorbitDetails::VT_MAXDELTAV, maxDeltaV, 0.0);
  }
  void add_deltaVUnc(double deltaVUnc) {
    fbb_.AddElement<double>(OnorbitDetails::VT_DELTAVUNC, deltaVUnc, 0.0);
  }
  void add_estDeltaVDuration(double estDeltaVDuration) {
    fbb_.AddElement<double>(OnorbitDetails::VT_ESTDELTAVDURATION, estDeltaVDuration, 0.0);
  }
  void add_numMission(int32_t numMission) {
    fbb_.AddElement<int32_t>(OnorbitDetails::VT_NUMMISSION, numMission, 0);
  }
  void add_missionTypes(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> missionTypes) {
    fbb_.AddOffset(OnorbitDetails::VT_MISSIONTYPES, missionTypes);
  }
  void add_busType(::flatbuffers::Offset<::flatbuffers::String> busType) {
    fbb_.AddOffset(OnorbitDetails::VT_BUSTYPE, busType);
  }
  void add_geoSlot(double geoSlot) {
    fbb_.AddElement<double>(OnorbitDetails::VT_GEOSLOT, geoSlot, 0.0);
  }
  void add_driftRate(double driftRate) {
    fbb_.AddElement<double>(OnorbitDetails::VT_DRIFTRATE, driftRate, 0.0);
  }
  void add_dryMass(double dryMass) {
    fbb_.AddElement<double>(OnorbitDetails::VT_DRYMASS, dryMass, 0.0);
  }
  void add_additionalMass(double additionalMass) {
    fbb_.AddElement<double>(OnorbitDetails::VT_ADDITIONALMASS, additionalMass, 0.0);
  }
  void add_launchMassMin(double launchMassMin) {
    fbb_.AddElement<double>(OnorbitDetails::VT_LAUNCHMASSMIN, launchMassMin, 0.0);
  }
  void add_launchMass(double launchMass) {
    fbb_.AddElement<double>(OnorbitDetails::VT_LAUNCHMASS, launchMass, 0.0);
  }
  void add_launchMassMax(double launchMassMax) {
    fbb_.AddElement<double>(OnorbitDetails::VT_LAUNCHMASSMAX, launchMassMax, 0.0);
  }
  void add_bolFuelMass(double bolFuelMass) {
    fbb_.AddElement<double>(OnorbitDetails::VT_BOLFUELMASS, bolFuelMass, 0.0);
  }
  void add_currentMass(double currentMass) {
    fbb_.AddElement<double>(OnorbitDetails::VT_CURRENTMASS, currentMass, 0.0);
  }
  void add_totalMassUnc(double totalMassUnc) {
    fbb_.AddElement<double>(OnorbitDetails::VT_TOTALMASSUNC, totalMassUnc, 0.0);
  }
  void add_solarArrayArea(double solarArrayArea) {
    fbb_.AddElement<double>(OnorbitDetails::VT_SOLARARRAYAREA, solarArrayArea, 0.0);
  }
  void add_maneuverable(bool maneuverable) {
    fbb_.AddElement<uint8_t>(OnorbitDetails::VT_MANEUVERABLE, static_cast<uint8_t>(maneuverable), 0);
  }
  void add_fuelRemaining(double fuelRemaining) {
    fbb_.AddElement<double>(OnorbitDetails::VT_FUELREMAINING, fuelRemaining, 0.0);
  }
  void add_crossSection(double crossSection) {
    fbb_.AddElement<double>(OnorbitDetails::VT_CROSSSECTION, crossSection, 0.0);
  }
  void add_busCrossSection(double busCrossSection) {
    fbb_.AddElement<double>(OnorbitDetails::VT_BUSCROSSSECTION, busCrossSection, 0.0);
  }
  void add_maxRadius(double maxRadius) {
    fbb_.AddElement<double>(OnorbitDetails::VT_MAXRADIUS, maxRadius, 0.0);
  }
  void add_colaRadius(double colaRadius) {
    fbb_.AddElement<double>(OnorbitDetails::VT_COLARADIUS, colaRadius, 0.0);
  }
  void add_adeptRadius(double adeptRadius) {
    fbb_.AddElement<double>(OnorbitDetails::VT_ADEPTRADIUS, adeptRadius, 0.0);
  }
  void add_numDeployable(int32_t numDeployable) {
    fbb_.AddElement<int32_t>(OnorbitDetails::VT_NUMDEPLOYABLE, numDeployable, 0);
  }
  void add_depNames(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> depNames) {
    fbb_.AddOffset(OnorbitDetails::VT_DEPNAMES, depNames);
  }
  void add_depEstMasses(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> depEstMasses) {
    fbb_.AddOffset(OnorbitDetails::VT_DEPESTMASSES, depEstMasses);
  }
  void add_depMassUncs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> depMassUncs) {
    fbb_.AddOffset(OnorbitDetails::VT_DEPMASSUNCS, depMassUncs);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(OnorbitDetails::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(OnorbitDetails::VT_ORIGIN, origin);
  }
  void add_lastObSource(::flatbuffers::Offset<::flatbuffers::String> lastObSource) {
    fbb_.AddOffset(OnorbitDetails::VT_LASTOBSOURCE, lastObSource);
  }
  void add_dataMode(OnorbitDetails_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(OnorbitDetails::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(OnorbitDetails::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(OnorbitDetails::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(OnorbitDetails::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(OnorbitDetails::VT_UPDATEDBY, updatedBy);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(OnorbitDetails::VT_ORIGNETWORK, origNetwork);
  }
  explicit OnorbitDetailsBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<OnorbitDetails> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<OnorbitDetails>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<OnorbitDetails> CreateOnorbitDetails(
    ...
    OnorbitDetails_dataMode_Enum dataMode = OnorbitDetails_dataMode_Enum_REAL,
  ...
  OnorbitDetailsBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<OnorbitDetails> CreateOnorbitDetailsDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const OnorbitDetails *GetOnorbitDetails(const void *buf) {
  return ::flatbuffers::GetRoot<OnorbitDetails>(buf);
}

inline const OnorbitDetails *GetSizePrefixedOnorbitDetails(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<OnorbitDetails>(buf);
}

inline const char *OnorbitDetailsIdentifier() {
  return "ONOR";
}

inline bool OnorbitDetailsBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OnorbitDetailsIdentifier());
}

inline bool SizePrefixedOnorbitDetailsBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OnorbitDetailsIdentifier(), true);
}

inline bool VerifyOnorbitDetailsBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<OnorbitDetails>(OnorbitDetailsIdentifier());
}

inline bool VerifySizePrefixedOnorbitDetailsBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<OnorbitDetails>(OnorbitDetailsIdentifier());
}

inline void FinishOnorbitDetailsBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OnorbitDetails> root) {
  fbb.Finish(root, OnorbitDetailsIdentifier());
}

inline void FinishSizePrefixedOnorbitDetailsBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OnorbitDetails> root) {
  fbb.FinishSizePrefixed(root, OnorbitDetailsIdentifier());
}
