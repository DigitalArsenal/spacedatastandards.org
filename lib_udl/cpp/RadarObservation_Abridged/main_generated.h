...
struct RadarObservation_Abridged;
struct RadarObservation_AbridgedBuilder;

enum RadarObservation_Abridged_dataMode_Enum : int8_t {
  ...
  RadarObservation_Abridged_dataMode_Enum_MIN = RadarObservation_Abridged_dataMode_Enum_REAL,
  RadarObservation_Abridged_dataMode_Enum_MAX = RadarObservation_Abridged_dataMode_Enum_EXERCISE
};

inline const RadarObservation_Abridged_dataMode_Enum (&EnumValuesRadarObservation_Abridged_dataMode_Enum())[4] {
  static const RadarObservation_Abridged_dataMode_Enum values[] = {
    RadarObservation_Abridged_dataMode_Enum_REAL,
    RadarObservation_Abridged_dataMode_Enum_TEST,
    RadarObservation_Abridged_dataMode_Enum_SIMULATED,
    RadarObservation_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesRadarObservation_Abridged_dataMode_Enum() {
...
inline const char *EnumNameRadarObservation_Abridged_dataMode_Enum(RadarObservation_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, RadarObservation_Abridged_dataMode_Enum_REAL, RadarObservation_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesRadarObservation_Abridged_dataMode_Enum()[index];
}

enum RadarObservation_Abridged_senReferenceFrame_Enum : int8_t {
  ...
  RadarObservation_Abridged_senReferenceFrame_Enum_MIN = RadarObservation_Abridged_senReferenceFrame_Enum_J2000,
  RadarObservation_Abridged_senReferenceFrame_Enum_MAX = RadarObservation_Abridged_senReferenceFrame_Enum_GCRF
};

inline const RadarObservation_Abridged_senReferenceFrame_Enum (&EnumValuesRadarObservation_Abridged_senReferenceFrame_Enum())[6] {
  static const RadarObservation_Abridged_senReferenceFrame_Enum values[] = {
    RadarObservation_Abridged_senReferenceFrame_Enum_J2000,
    RadarObservation_Abridged_senReferenceFrame_Enum_EFG_TDR,
    RadarObservation_Abridged_senReferenceFrame_Enum_ECR_ECEF,
    RadarObservation_Abridged_senReferenceFrame_Enum_TEME,
    RadarObservation_Abridged_senReferenceFrame_Enum_ITRF,
    RadarObservation_Abridged_senReferenceFrame_Enum_GCRF
  };
  return values;
}

inline const char * const *EnumNamesRadarObservation_Abridged_senReferenceFrame_Enum() {
...
inline const char *EnumNameRadarObservation_Abridged_senReferenceFrame_Enum(RadarObservation_Abridged_senReferenceFrame_Enum e) {
  if (::flatbuffers::IsOutRange(e, RadarObservation_Abridged_senReferenceFrame_Enum_J2000, RadarObservation_Abridged_senReferenceFrame_Enum_GCRF)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesRadarObservation_Abridged_senReferenceFrame_Enum()[index];
}
...
struct RadarObservation_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef RadarObservation_AbridgedBuilder Builder;
  ...
  RadarObservation_Abridged_dataMode_Enum dataMode() const {
    return static_cast<RadarObservation_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
  ...
  RadarObservation_Abridged_senReferenceFrame_Enum senReferenceFrame() const {
    return static_cast<RadarObservation_Abridged_senReferenceFrame_Enum>(GetField<int8_t>(VT_SENREFERENCEFRAME, 0));
  }
...
struct RadarObservation_AbridgedBuilder {
  typedef RadarObservation_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_obTime(::flatbuffers::Offset<::flatbuffers::String> obTime) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_OBTIME, obTime);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_IDONORBIT, idOnOrbit);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_IDSENSOR, idSensor);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(RadarObservation_Abridged::VT_SATNO, satNo, 0);
  }
  void add_taskId(::flatbuffers::Offset<::flatbuffers::String> taskId) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_TASKID, taskId);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_TRANSACTIONID, transactionId);
  }
  void add_trackId(::flatbuffers::Offset<::flatbuffers::String> trackId) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_TRACKID, trackId);
  }
  void add_obPosition(::flatbuffers::Offset<::flatbuffers::String> obPosition) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_OBPOSITION, obPosition);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_ORIGOBJECTID, origObjectId);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_ORIGSENSORID, origSensorId);
  }
  void add_uct(bool uct) {
    fbb_.AddElement<uint8_t>(RadarObservation_Abridged::VT_UCT, static_cast<uint8_t>(uct), 0);
  }
  void add_azimuth(double azimuth) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_AZIMUTH, azimuth, 0.0);
  }
  void add_azimuthUnc(double azimuthUnc) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_AZIMUTHUNC, azimuthUnc, 0.0);
  }
  void add_azimuthBias(double azimuthBias) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_AZIMUTHBIAS, azimuthBias, 0.0);
  }
  void add_azimuthRate(double azimuthRate) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_AZIMUTHRATE, azimuthRate, 0.0);
  }
  void add_elevation(double elevation) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_ELEVATION, elevation, 0.0);
  }
  void add_elevationUnc(double elevationUnc) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_ELEVATIONUNC, elevationUnc, 0.0);
  }
  void add_elevationBias(double elevationBias) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_ELEVATIONBIAS, elevationBias, 0.0);
  }
  void add_elevationRate(double elevationRate) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_ELEVATIONRATE, elevationRate, 0.0);
  }
  void add_range(double range) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_RANGE, range, 0.0);
  }
  void add_rangeAccel(double rangeAccel) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_RANGEACCEL, rangeAccel, 0.0);
  }
  void add_rangeAccelUnc(double rangeAccelUnc) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_RANGEACCELUNC, rangeAccelUnc, 0.0);
  }
  void add_rangeUnc(double rangeUnc) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_RANGEUNC, rangeUnc, 0.0);
  }
  void add_rangeBias(double rangeBias) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_RANGEBIAS, rangeBias, 0.0);
  }
  void add_rangeRate(double rangeRate) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_RANGERATE, rangeRate, 0.0);
  }
  void add_rangeRateUnc(double rangeRateUnc) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_RANGERATEUNC, rangeRateUnc, 0.0);
  }
  void add_doppler(double doppler) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_DOPPLER, doppler, 0.0);
  }
  void add_dopplerUnc(double dopplerUnc) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_DOPPLERUNC, dopplerUnc, 0.0);
  }
  void add_ra(double ra) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_RA, ra, 0.0);
  }
  void add_declination(double declination) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_DECLINATION, declination, 0.0);
  }
  void add_x(double x) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_X, x, 0.0);
  }
  void add_y(double y) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_Y, y, 0.0);
  }
  void add_z(double z) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_Z, z, 0.0);
  }
  void add_xvel(double xvel) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_XVEL, xvel, 0.0);
  }
  void add_yvel(double yvel) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_YVEL, yvel, 0.0);
  }
  void add_zvel(double zvel) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_ZVEL, zvel, 0.0);
  }
  void add_senx(double senx) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_SENX, senx, 0.0);
  }
  void add_seny(double seny) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_SENY, seny, 0.0);
  }
  void add_senz(double senz) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_SENZ, senz, 0.0);
  }
  void add_rcs(double rcs) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_RCS, rcs, 0.0);
  }
  void add_rcsUnc(double rcsUnc) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_RCSUNC, rcsUnc, 0.0);
  }
  void add_orthogonalRcs(double orthogonalRcs) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_ORTHOGONALRCS, orthogonalRcs, 0.0);
  }
  void add_orthogonalRcsUnc(double orthogonalRcsUnc) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_ORTHOGONALRCSUNC, orthogonalRcsUnc, 0.0);
  }
  void add_snr(double snr) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_SNR, snr, 0.0);
  }
  void add_beam(double beam) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_BEAM, beam, 0.0);
  }
  void add_timingBias(double timingBias) {
    fbb_.AddElement<double>(RadarObservation_Abridged::VT_TIMINGBIAS, timingBias, 0.0);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_RAWFILEURI, rawFileURI);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(RadarObservation_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(RadarObservation_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_senReferenceFrame(RadarObservation_Abridged_senReferenceFrame_Enum senReferenceFrame) {
    fbb_.AddElement<int8_t>(RadarObservation_Abridged::VT_SENREFERENCEFRAME, static_cast<int8_t>(senReferenceFrame), 0);
  }
  void add_descriptor(::flatbuffers::Offset<::flatbuffers::String> descriptor) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_DESCRIPTOR, descriptor);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(RadarObservation_Abridged::VT_TYPE, type);
  }
  explicit RadarObservation_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<RadarObservation_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<RadarObservation_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<RadarObservation_Abridged> CreateRadarObservation_Abridged(
    ...
    RadarObservation_Abridged_dataMode_Enum dataMode = RadarObservation_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0,
    RadarObservation_Abridged_senReferenceFrame_Enum senReferenceFrame = RadarObservation_Abridged_senReferenceFrame_Enum_J2000,
    ::flatbuffers::Offset<::flatbuffers::String> descriptor = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0,
    ::flatbuffers::Offset<::flatbuffers::String> sourceDL = 0,
    ::flatbuffers::Offset<::flatbuffers::String> type = 0) {
  RadarObservation_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<RadarObservation_Abridged> CreateRadarObservation_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const RadarObservation_Abridged *GetRadarObservation_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<RadarObservation_Abridged>(buf);
}

inline const RadarObservation_Abridged *GetSizePrefixedRadarObservation_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<RadarObservation_Abridged>(buf);
}

inline const char *RadarObservation_AbridgedIdentifier() {
  return "RADA";
}

inline bool RadarObservation_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RadarObservation_AbridgedIdentifier());
}

inline bool SizePrefixedRadarObservation_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, RadarObservation_AbridgedIdentifier(), true);
}

inline bool VerifyRadarObservation_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<RadarObservation_Abridged>(RadarObservation_AbridgedIdentifier());
}

inline bool VerifySizePrefixedRadarObservation_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<RadarObservation_Abridged>(RadarObservation_AbridgedIdentifier());
}

inline void FinishRadarObservation_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RadarObservation_Abridged> root) {
  fbb.Finish(root, RadarObservation_AbridgedIdentifier());
}

inline void FinishSizePrefixedRadarObservation_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<RadarObservation_Abridged> root) {
  fbb.FinishSizePrefixed(root, RadarObservation_AbridgedIdentifier());
}
