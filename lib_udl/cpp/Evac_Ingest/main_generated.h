...
enum Evac_Ingest_type_Enum : int8_t {
  /// No description available.
  Evac_Ingest_type_Enum_REQUEST = 0,
  /// No description available.
  Evac_Ingest_type_Enum_RESPONSE = 1,
  Evac_Ingest_type_Enum_MIN = Evac_Ingest_type_Enum_REQUEST,
  Evac_Ingest_type_Enum_MAX = Evac_Ingest_type_Enum_RESPONSE
};

inline const Evac_Ingest_type_Enum (&EnumValuesEvac_Ingest_type_Enum())[2] {
  static const Evac_Ingest_type_Enum values[] = {
    Evac_Ingest_type_Enum_REQUEST,
    Evac_Ingest_type_Enum_RESPONSE
  };
  return values;
}

inline const char * const *EnumNamesEvac_Ingest_type_Enum() {
...
inline const char *EnumNameEvac_Ingest_type_Enum(Evac_Ingest_type_Enum e) {
  if (::flatbuffers::IsOutRange(e, Evac_Ingest_type_Enum_REQUEST, Evac_Ingest_type_Enum_RESPONSE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEvac_Ingest_type_Enum()[index];
}

enum Evac_Ingest_dataMode_Enum : int8_t {
  ...
  Evac_Ingest_dataMode_Enum_MIN = Evac_Ingest_dataMode_Enum_REAL,
  Evac_Ingest_dataMode_Enum_MAX = Evac_Ingest_dataMode_Enum_EXERCISE
};

inline const Evac_Ingest_dataMode_Enum (&EnumValuesEvac_Ingest_dataMode_Enum())[4] {
  static const Evac_Ingest_dataMode_Enum values[] = {
    Evac_Ingest_dataMode_Enum_REAL,
    Evac_Ingest_dataMode_Enum_TEST,
    Evac_Ingest_dataMode_Enum_SIMULATED,
    Evac_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesEvac_Ingest_dataMode_Enum() {
...
inline const char *EnumNameEvac_Ingest_dataMode_Enum(Evac_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Evac_Ingest_dataMode_Enum_REAL, Evac_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEvac_Ingest_dataMode_Enum()[index];
}

/// /// Casualty report and evacuation request. Used to report and request support to evacuate friendly and enemy casualties.
struct Evac_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Evac_IngestBuilder Builder;
  ...
  Evac_Ingest_type_Enum type() const {
    return static_cast<Evac_Ingest_type_Enum>(GetField<int8_t>(VT_TYPE, 0));
  }
  ...
  Evac_Ingest_dataMode_Enum dataMode() const {
    return static_cast<Evac_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Evac_IngestBuilder {
  typedef Evac_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Evac_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Evac_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_medevacId(::flatbuffers::Offset<::flatbuffers::String> medevacId) {
    fbb_.AddOffset(Evac_Ingest::VT_MEDEVACID, medevacId);
  }
  void add_type(Evac_Ingest_type_Enum type) {
    fbb_.AddElement<int8_t>(Evac_Ingest::VT_TYPE, static_cast<int8_t>(type), 0);
  }
  void add_missionType(::flatbuffers::Offset<::flatbuffers::String> missionType) {
    fbb_.AddOffset(Evac_Ingest::VT_MISSIONTYPE, missionType);
  }
  void add_idWeatherReport(::flatbuffers::Offset<::flatbuffers::String> idWeatherReport) {
    fbb_.AddOffset(Evac_Ingest::VT_IDWEATHERREPORT, idWeatherReport);
  }
  void add_numKIA(int32_t numKIA) {
    fbb_.AddElement<int32_t>(Evac_Ingest::VT_NUMKIA, numKIA, 0);
  }
  void add_numWIA(int32_t numWIA) {
    fbb_.AddElement<int32_t>(Evac_Ingest::VT_NUMWIA, numWIA, 0);
  }
  void add_numLitter(int32_t numLitter) {
    fbb_.AddElement<int32_t>(Evac_Ingest::VT_NUMLITTER, numLitter, 0);
  }
  void add_numAmbulatory(int32_t numAmbulatory) {
    fbb_.AddElement<int32_t>(Evac_Ingest::VT_NUMAMBULATORY, numAmbulatory, 0);
  }
  void add_medicReq(bool medicReq) {
    fbb_.AddElement<uint8_t>(Evac_Ingest::VT_MEDICREQ, static_cast<uint8_t>(medicReq), 0);
  }
  void add_reqNum(::flatbuffers::Offset<::flatbuffers::String> reqNum) {
    fbb_.AddOffset(Evac_Ingest::VT_REQNUM, reqNum);
  }
  void add_reqTime(::flatbuffers::Offset<::flatbuffers::String> reqTime) {
    fbb_.AddOffset(Evac_Ingest::VT_REQTIME, reqTime);
  }
  void add_reqCallSign(::flatbuffers::Offset<::flatbuffers::String> reqCallSign) {
    fbb_.AddOffset(Evac_Ingest::VT_REQCALLSIGN, reqCallSign);
  }
  void add_pickupTime(::flatbuffers::Offset<::flatbuffers::String> pickupTime) {
    fbb_.AddOffset(Evac_Ingest::VT_PICKUPTIME, pickupTime);
  }
  void add_pickupLat(double pickupLat) {
    fbb_.AddElement<double>(Evac_Ingest::VT_PICKUPLAT, pickupLat, 0.0);
  }
  void add_pickupLon(double pickupLon) {
    fbb_.AddElement<double>(Evac_Ingest::VT_PICKUPLON, pickupLon, 0.0);
  }
  void add_pickupAlt(double pickupAlt) {
    fbb_.AddElement<double>(Evac_Ingest::VT_PICKUPALT, pickupAlt, 0.0);
  }
  void add_ce(double ce) {
    fbb_.AddElement<double>(Evac_Ingest::VT_CE, ce, 0.0);
  }
  void add_le(double le) {
    fbb_.AddElement<double>(Evac_Ingest::VT_LE, le, 0.0);
  }
  void add_terrain(::flatbuffers::Offset<::flatbuffers::String> terrain) {
    fbb_.AddOffset(Evac_Ingest::VT_TERRAIN, terrain);
  }
  void add_obstaclesRemarks(::flatbuffers::Offset<::flatbuffers::String> obstaclesRemarks) {
    fbb_.AddOffset(Evac_Ingest::VT_OBSTACLESREMARKS, obstaclesRemarks);
  }
  void add_terrainRemarks(::flatbuffers::Offset<::flatbuffers::String> terrainRemarks) {
    fbb_.AddOffset(Evac_Ingest::VT_TERRAINREMARKS, terrainRemarks);
  }
  void add_zoneName(::flatbuffers::Offset<::flatbuffers::String> zoneName) {
    fbb_.AddOffset(Evac_Ingest::VT_ZONENAME, zoneName);
  }
  void add_zoneMarking(::flatbuffers::Offset<::flatbuffers::String> zoneMarking) {
    fbb_.AddOffset(Evac_Ingest::VT_ZONEMARKING, zoneMarking);
  }
  void add_zoneSecurity(::flatbuffers::Offset<::flatbuffers::String> zoneSecurity) {
    fbb_.AddOffset(Evac_Ingest::VT_ZONESECURITY, zoneSecurity);
  }
  void add_zoneMarkingColor(::flatbuffers::Offset<::flatbuffers::String> zoneMarkingColor) {
    fbb_.AddOffset(Evac_Ingest::VT_ZONEMARKINGCOLOR, zoneMarkingColor);
  }
  void add_zoneHot(bool zoneHot) {
    fbb_.AddElement<uint8_t>(Evac_Ingest::VT_ZONEHOT, static_cast<uint8_t>(zoneHot), 0);
  }
  void add_cntctFreq(double cntctFreq) {
    fbb_.AddElement<double>(Evac_Ingest::VT_CNTCTFREQ, cntctFreq, 0.0);
  }
  void add_zoneContrCallSign(::flatbuffers::Offset<::flatbuffers::String> zoneContrCallSign) {
    fbb_.AddOffset(Evac_Ingest::VT_ZONECONTRCALLSIGN, zoneContrCallSign);
  }
  void add_numCasualties(int32_t numCasualties) {
    fbb_.AddElement<int32_t>(Evac_Ingest::VT_NUMCASUALTIES, numCasualties, 0);
  }
  void add_comments(::flatbuffers::Offset<::flatbuffers::String> comments) {
    fbb_.AddOffset(Evac_Ingest::VT_COMMENTS, comments);
  }
  void add_casualtyInfo(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> casualtyInfo) {
    fbb_.AddOffset(Evac_Ingest::VT_CASUALTYINFO, casualtyInfo);
  }
  void add_enemyData(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> enemyData) {
    fbb_.AddOffset(Evac_Ingest::VT_ENEMYDATA, enemyData);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Evac_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Evac_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Evac_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Evac_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Evac_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(Evac_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Evac_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit Evac_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Evac_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Evac_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Evac_Ingest> CreateEvac_Ingest(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::String> id = 0,
    ::flatbuffers::Offset<::flatbuffers::String> classificationMarking = 0,
    ::flatbuffers::Offset<::flatbuffers::String> medevacId = 0,
    Evac_Ingest_type_Enum type = Evac_Ingest_type_Enum_REQUEST,
    ...
    Evac_Ingest_dataMode_Enum dataMode = Evac_Ingest_dataMode_Enum_REAL) {
  Evac_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Evac_Ingest> CreateEvac_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Evac_Ingest *GetEvac_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<Evac_Ingest>(buf);
}

inline const Evac_Ingest *GetSizePrefixedEvac_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Evac_Ingest>(buf);
}

inline const char *Evac_IngestIdentifier() {
  return "EVAC";
}

inline bool Evac_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Evac_IngestIdentifier());
}

inline bool SizePrefixedEvac_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Evac_IngestIdentifier(), true);
}

inline bool VerifyEvac_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Evac_Ingest>(Evac_IngestIdentifier());
}

inline bool VerifySizePrefixedEvac_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Evac_Ingest>(Evac_IngestIdentifier());
}

inline void FinishEvac_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Evac_Ingest> root) {
  fbb.Finish(root, Evac_IngestIdentifier());
}

inline void FinishSizePrefixedEvac_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Evac_Ingest> root) {
  fbb.FinishSizePrefixed(root, Evac_IngestIdentifier());
}
