...
struct LogisticsTransportationPlans_Full;
...
struct LogisticsTransportationPlans_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef LogisticsTransportationPlans_FullBuilder Builder;
...
struct LogisticsTransportationPlans_FullBuilder {
  typedef LogisticsTransportationPlans_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_plansNumber(::flatbuffers::Offset<::flatbuffers::String> plansNumber) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_PLANSNUMBER, plansNumber);
  }
  void add_missionChange(bool missionChange) {
    fbb_.AddElement<uint8_t>(LogisticsTransportationPlans_Full::VT_MISSIONCHANGE, static_cast<uint8_t>(missionChange), 0);
  }
  void add_planDefinition(::flatbuffers::Offset<::flatbuffers::String> planDefinition) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_PLANDEFINITION, planDefinition);
  }
  void add_statusCode(::flatbuffers::Offset<::flatbuffers::String> statusCode) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_STATUSCODE, statusCode);
  }
  void add_coordinator(::flatbuffers::Offset<::flatbuffers::String> coordinator) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_COORDINATOR, coordinator);
  }
  void add_coordinatorUnit(::flatbuffers::Offset<::flatbuffers::String> coordinatorUnit) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_COORDINATORUNIT, coordinatorUnit);
  }
  void add_originICAO(::flatbuffers::Offset<::flatbuffers::String> originICAO) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_ORIGINICAO, originICAO);
  }
  void add_estDepTime(::flatbuffers::Offset<::flatbuffers::String> estDepTime) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_ESTDEPTIME, estDepTime);
  }
  void add_estArrTime(::flatbuffers::Offset<::flatbuffers::String> estArrTime) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_ESTARRTIME, estArrTime);
  }
  void add_destinationICAO(::flatbuffers::Offset<::flatbuffers::String> destinationICAO) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_DESTINATIONICAO, destinationICAO);
  }
  void add_logisticMasterRecordId(::flatbuffers::Offset<::flatbuffers::String> logisticMasterRecordId) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_LOGISTICMASTERRECORDID, logisticMasterRecordId);
  }
  void add_tpTailNumber(::flatbuffers::Offset<::flatbuffers::String> tpTailNumber) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_TPTAILNUMBER, tpTailNumber);
  }
  void add_tpAircraftMDS(::flatbuffers::Offset<::flatbuffers::String> tpAircraftMDS) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_TPAIRCRAFTMDS, tpAircraftMDS);
  }
  void add_majcom(::flatbuffers::Offset<::flatbuffers::String> majcom) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_MAJCOM, majcom);
  }
  void add_approxArrTime(::flatbuffers::Offset<::flatbuffers::String> approxArrTime) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_APPROXARRTIME, approxArrTime);
  }
  void add_duration(::flatbuffers::Offset<::flatbuffers::String> duration) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_DURATION, duration);
  }
  void add_actDepTime(::flatbuffers::Offset<::flatbuffers::String> actDepTime) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_ACTDEPTIME, actDepTime);
  }
  void add_closedDate(::flatbuffers::Offset<::flatbuffers::String> closedDate) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_CLOSEDDATE, closedDate);
  }
  void add_cancelledDate(::flatbuffers::Offset<::flatbuffers::String> cancelledDate) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_CANCELLEDDATE, cancelledDate);
  }
  void add_aircraftStatus(::flatbuffers::Offset<::flatbuffers::String> aircraftStatus) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_AIRCRAFTSTATUS, aircraftStatus);
  }
  void add_numEnrouteStops(int32_t numEnrouteStops) {
    fbb_.AddElement<int32_t>(LogisticsTransportationPlans_Full::VT_NUMENROUTESTOPS, numEnrouteStops, 0);
  }
  void add_serialNumber(::flatbuffers::Offset<::flatbuffers::String> serialNumber) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_SERIALNUMBER, serialNumber);
  }
  void add_numTransLoads(int32_t numTransLoads) {
    fbb_.AddElement<int32_t>(LogisticsTransportationPlans_Full::VT_NUMTRANSLOADS, numTransLoads, 0);
  }
  void add_lastChangedDate(::flatbuffers::Offset<::flatbuffers::String> lastChangedDate) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_LASTCHANGEDDATE, lastChangedDate);
  }
  void add_logisticsSegments(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsSegments) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_LOGISTICSSEGMENTS, logisticsSegments);
  }
  void add_logisticsTransportationPlansRemarks(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> logisticsTransportationPlansRemarks) {
    fbb_.AddOffset(LogisticsTransportationPlans_Full::VT_LOGISTICSTRANSPORTATIONPLANSREMARKS, logisticsTransportationPlansRemarks);
  }
  explicit LogisticsTransportationPlans_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<LogisticsTransportationPlans_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<LogisticsTransportationPlans_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<LogisticsTransportationPlans_Full> CreateLogisticsTransportationPlans_Full(
  ...
  LogisticsTransportationPlans_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<LogisticsTransportationPlans_Full> CreateLogisticsTransportationPlans_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const LogisticsTransportationPlans_Full *GetLogisticsTransportationPlans_Full(const void *buf) {
  return ::flatbuffers::GetRoot<LogisticsTransportationPlans_Full>(buf);
}

inline const LogisticsTransportationPlans_Full *GetSizePrefixedLogisticsTransportationPlans_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<LogisticsTransportationPlans_Full>(buf);
}

inline const char *LogisticsTransportationPlans_FullIdentifier() {
  return "LOGI";
}

inline bool LogisticsTransportationPlans_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsTransportationPlans_FullIdentifier());
}

inline bool SizePrefixedLogisticsTransportationPlans_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, LogisticsTransportationPlans_FullIdentifier(), true);
}

inline bool VerifyLogisticsTransportationPlans_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<LogisticsTransportationPlans_Full>(LogisticsTransportationPlans_FullIdentifier());
}

inline bool VerifySizePrefixedLogisticsTransportationPlans_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<LogisticsTransportationPlans_Full>(LogisticsTransportationPlans_FullIdentifier());
}

inline void FinishLogisticsTransportationPlans_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsTransportationPlans_Full> root) {
  fbb.Finish(root, LogisticsTransportationPlans_FullIdentifier());
}

inline void FinishSizePrefixedLogisticsTransportationPlans_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<LogisticsTransportationPlans_Full> root) {
  fbb.FinishSizePrefixed(root, LogisticsTransportationPlans_FullIdentifier());
}
