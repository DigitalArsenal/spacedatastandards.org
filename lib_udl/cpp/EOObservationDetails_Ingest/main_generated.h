...
struct EOObservationDetails_Ingest;
struct EOObservationDetails_IngestBuilder;

enum EOObservationDetails_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  EOObservationDetails_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  EOObservationDetails_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  EOObservationDetails_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  EOObservationDetails_Ingest_dataMode_Enum_EXERCISE = 3,
  EOObservationDetails_Ingest_dataMode_Enum_MIN = EOObservationDetails_Ingest_dataMode_Enum_REAL,
  EOObservationDetails_Ingest_dataMode_Enum_MAX = EOObservationDetails_Ingest_dataMode_Enum_EXERCISE
};

inline const EOObservationDetails_Ingest_dataMode_Enum (&EnumValuesEOObservationDetails_Ingest_dataMode_Enum())[4] {
  static const EOObservationDetails_Ingest_dataMode_Enum values[] = {
    EOObservationDetails_Ingest_dataMode_Enum_REAL,
    EOObservationDetails_Ingest_dataMode_Enum_TEST,
    EOObservationDetails_Ingest_dataMode_Enum_SIMULATED,
    EOObservationDetails_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesEOObservationDetails_Ingest_dataMode_Enum() {
...
inline const char *EnumNameEOObservationDetails_Ingest_dataMode_Enum(EOObservationDetails_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, EOObservationDetails_Ingest_dataMode_Enum_REAL, EOObservationDetails_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEOObservationDetails_Ingest_dataMode_Enum()[index];
}

/// /// Model representation of additional detailed observation data for electro-optical based sensor phenomenologies.
struct EOObservationDetails_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EOObservationDetails_IngestBuilder Builder;
  ...
  EOObservationDetails_Ingest_dataMode_Enum dataMode() const {
    return static_cast<EOObservationDetails_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct EOObservationDetails_IngestBuilder {
  typedef EOObservationDetails_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_idEOObservation(::flatbuffers::Offset<::flatbuffers::String> idEOObservation) {
    fbb_.AddOffset(EOObservationDetails_Ingest::VT_IDEOOBSERVATION, idEOObservation);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(EOObservationDetails_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_obTime(::flatbuffers::Offset<::flatbuffers::String> obTime) {
    fbb_.AddOffset(EOObservationDetails_Ingest::VT_OBTIME, obTime);
  }
  void add_predictedRa(double predictedRa) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_PREDICTEDRA, predictedRa, 0.0);
  }
  void add_predictedDeclination(double predictedDeclination) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_PREDICTEDDECLINATION, predictedDeclination, 0.0);
  }
  void add_predictedAzimuth(double predictedAzimuth) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_PREDICTEDAZIMUTH, predictedAzimuth, 0.0);
  }
  void add_predictedElevation(double predictedElevation) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_PREDICTEDELEVATION, predictedElevation, 0.0);
  }
  void add_sunAzimuth(double sunAzimuth) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_SUNAZIMUTH, sunAzimuth, 0.0);
  }
  void add_sunElevation(double sunElevation) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_SUNELEVATION, sunElevation, 0.0);
  }
  void add_numSpectralFilters(int32_t numSpectralFilters) {
    fbb_.AddElement<int32_t>(EOObservationDetails_Ingest::VT_NUMSPECTRALFILTERS, numSpectralFilters, 0);
  }
  void add_spectralFilters(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> spectralFilters) {
    fbb_.AddOffset(EOObservationDetails_Ingest::VT_SPECTRALFILTERS, spectralFilters);
  }
  void add_spectralZMFL(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> spectralZMFL) {
    fbb_.AddOffset(EOObservationDetails_Ingest::VT_SPECTRALZMFL, spectralZMFL);
  }
  ...
  void add_extinctionCoeffsUnc(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> extinctionCoeffsUnc) {
    fbb_.AddOffset(EOObservationDetails_Ingest::VT_EXTINCTIONCOEFFSUNC, extinctionCoeffsUnc);
  }
  void add_colorCoeffs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> colorCoeffs) {
    fbb_.AddOffset(EOObservationDetails_Ingest::VT_COLORCOEFFS, colorCoeffs);
  }
  void add_numNeutralDensityFilters(int32_t numNeutralDensityFilters) {
    fbb_.AddElement<int32_t>(EOObservationDetails_Ingest::VT_NUMNEUTRALDENSITYFILTERS, numNeutralDensityFilters, 0);
  }
  void add_neutralDensityFilterNames(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> neutralDensityFilterNames) {
    fbb_.AddOffset(EOObservationDetails_Ingest::VT_NEUTRALDENSITYFILTERNAMES, neutralDensityFilterNames);
  }
  void add_neutralDensityFilterTransmissions(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> neutralDensityFilterTransmissions) {
    fbb_.AddOffset(EOObservationDetails_Ingest::VT_NEUTRALDENSITYFILTERTRANSMISSIONS, neutralDensityFilterTransmissions);
  }
  void add_neutralDensityFilterTransmissionsUnc(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> neutralDensityFilterTransmissionsUnc) {
    fbb_.AddOffset(EOObservationDetails_Ingest::VT_NEUTRALDENSITYFILTERTRANSMISSIONSUNC, neutralDensityFilterTransmissionsUnc);
  }
  void add_gain(double gain) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_GAIN, gain, 0.0);
  }
  void add_ifov(double ifov) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_IFOV, ifov, 0.0);
  }
  void add_pixelArrayWidth(int32_t pixelArrayWidth) {
    fbb_.AddElement<int32_t>(EOObservationDetails_Ingest::VT_PIXELARRAYWIDTH, pixelArrayWidth, 0);
  }
  void add_pixelArrayHeight(int32_t pixelArrayHeight) {
    fbb_.AddElement<int32_t>(EOObservationDetails_Ingest::VT_PIXELARRAYHEIGHT, pixelArrayHeight, 0);
  }
  void add_pixelMin(int32_t pixelMin) {
    fbb_.AddElement<int32_t>(EOObservationDetails_Ingest::VT_PIXELMIN, pixelMin, 0);
  }
  void add_pixelMax(int32_t pixelMax) {
    fbb_.AddElement<int32_t>(EOObservationDetails_Ingest::VT_PIXELMAX, pixelMax, 0);
  }
  void add_centroidRow(double centroidRow) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_CENTROIDROW, centroidRow, 0.0);
  }
  void add_centroidColumn(double centroidColumn) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_CENTROIDCOLUMN, centroidColumn, 0.0);
  }
  void add_rowVariance(double rowVariance) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_ROWVARIANCE, rowVariance, 0.0);
  }
  void add_columnVariance(double columnVariance) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_COLUMNVARIANCE, columnVariance, 0.0);
  }
  void add_rowColCov(double rowColCov) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_ROWCOLCOV, rowColCov, 0.0);
  }
  void add_distFromStreakCenter(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> distFromStreakCenter) {
    fbb_.AddOffset(EOObservationDetails_Ingest::VT_DISTFROMSTREAKCENTER, distFromStreakCenter);
  }
  void add_surfBrightness(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> surfBrightness) {
    fbb_.AddOffset(EOObservationDetails_Ingest::VT_SURFBRIGHTNESS, surfBrightness);
  }
  void add_surfBrightnessUnc(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> surfBrightnessUnc) {
    fbb_.AddOffset(EOObservationDetails_Ingest::VT_SURFBRIGHTNESSUNC, surfBrightnessUnc);
  }
  void add_timesUnc(double timesUnc) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_TIMESUNC, timesUnc, 0.0);
  }
  void add_ccdTemp(double ccdTemp) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_CCDTEMP, ccdTemp, 0.0);
  }
  void add_currentSpectralFilterNum(int32_t currentSpectralFilterNum) {
    fbb_.AddElement<int32_t>(EOObservationDetails_Ingest::VT_CURRENTSPECTRALFILTERNUM, currentSpectralFilterNum, 0);
  }
  void add_currentNeutralDensityFilterNum(int32_t currentNeutralDensityFilterNum) {
    fbb_.AddElement<int32_t>(EOObservationDetails_Ingest::VT_CURRENTNEUTRALDENSITYFILTERNUM, currentNeutralDensityFilterNum, 0);
  }
  void add_binningHoriz(int32_t binningHoriz) {
    fbb_.AddElement<int32_t>(EOObservationDetails_Ingest::VT_BINNINGHORIZ, binningHoriz, 0);
  }
  void add_binningVert(int32_t binningVert) {
    fbb_.AddElement<int32_t>(EOObservationDetails_Ingest::VT_BINNINGVERT, binningVert, 0);
  }
  void add_pcalNumStars(int32_t pcalNumStars) {
    fbb_.AddElement<int32_t>(EOObservationDetails_Ingest::VT_PCALNUMSTARS, pcalNumStars, 0);
  }
  void add_ccdObjPosX(double ccdObjPosX) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_CCDOBJPOSX, ccdObjPosX, 0.0);
  }
  void add_ccdObjPosY(double ccdObjPosY) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_CCDOBJPOSY, ccdObjPosY, 0.0);
  }
  void add_ccdObjWidth(double ccdObjWidth) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_CCDOBJWIDTH, ccdObjWidth, 0.0);
  }
  void add_backgroundSignal(double backgroundSignal) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_BACKGROUNDSIGNAL, backgroundSignal, 0.0);
  }
  void add_backgroundSignalUnc(double backgroundSignalUnc) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_BACKGROUNDSIGNALUNC, backgroundSignalUnc, 0.0);
  }
  void add_peakApertureCount(double peakApertureCount) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_PEAKAPERTURECOUNT, peakApertureCount, 0.0);
  }
  void add_peakBackgroundCount(int32_t peakBackgroundCount) {
    fbb_.AddElement<int32_t>(EOObservationDetails_Ingest::VT_PEAKBACKGROUNDCOUNT, peakBackgroundCount, 0);
  }
  void add_snrEst(double snrEst) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_SNREST, snrEst, 0.0);
  }
  void add_magInstrumental(double magInstrumental) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_MAGINSTRUMENTAL, magInstrumental, 0.0);
  }
  void add_magInstrumentalUnc(double magInstrumentalUnc) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_MAGINSTRUMENTALUNC, magInstrumentalUnc, 0.0);
  }
  void add_opticalCrossSection(double opticalCrossSection) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_OPTICALCROSSSECTION, opticalCrossSection, 0.0);
  }
  void add_opticalCrossSectionUnc(double opticalCrossSectionUnc) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_OPTICALCROSSSECTIONUNC, opticalCrossSectionUnc, 0.0);
  }
  void add_sunStatePosX(double sunStatePosX) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_SUNSTATEPOSX, sunStatePosX, 0.0);
  }
  void add_sunStatePosY(double sunStatePosY) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_SUNSTATEPOSY, sunStatePosY, 0.0);
  }
  void add_sunStatePosZ(double sunStatePosZ) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_SUNSTATEPOSZ, sunStatePosZ, 0.0);
  }
  void add_sunStateVelX(double sunStateVelX) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_SUNSTATEVELX, sunStateVelX, 0.0);
  }
  void add_sunStateVelY(double sunStateVelY) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_SUNSTATEVELY, sunStateVelY, 0.0);
  }
  void add_sunStateVelZ(double sunStateVelZ) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_SUNSTATEVELZ, sunStateVelZ, 0.0);
  }
  void add_numCatalogStars(int32_t numCatalogStars) {
    fbb_.AddElement<int32_t>(EOObservationDetails_Ingest::VT_NUMCATALOGSTARS, numCatalogStars, 0);
  }
  void add_numDetectedStars(int32_t numDetectedStars) {
    fbb_.AddElement<int32_t>(EOObservationDetails_Ingest::VT_NUMDETECTEDSTARS, numDetectedStars, 0);
  }
  void add_numCorrelatedStars(int32_t numCorrelatedStars) {
    fbb_.AddElement<int32_t>(EOObservationDetails_Ingest::VT_NUMCORRELATEDSTARS, numCorrelatedStars, 0);
  }
  void add_predictedRaUnc(double predictedRaUnc) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_PREDICTEDRAUNC, predictedRaUnc, 0.0);
  }
  void add_predictedDeclinationUnc(double predictedDeclinationUnc) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_PREDICTEDDECLINATIONUNC, predictedDeclinationUnc, 0.0);
  }
  void add_raCov(double raCov) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_RACOV, raCov, 0.0);
  }
  void add_declinationCov(double declinationCov) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_DECLINATIONCOV, declinationCov, 0.0);
  }
  void add_raDeclinationCov(double raDeclinationCov) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_RADECLINATIONCOV, raDeclinationCov, 0.0);
  }
  void add_acalCrPixX(double acalCrPixX) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_ACALCRPIXX, acalCrPixX, 0.0);
  }
  void add_acalCrPixY(double acalCrPixY) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_ACALCRPIXY, acalCrPixY, 0.0);
  }
  void add_acalCrValX(double acalCrValX) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_ACALCRVALX, acalCrValX, 0.0);
  }
  void add_acalCrValY(double acalCrValY) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_ACALCRVALY, acalCrValY, 0.0);
  }
  void add_acalNumStars(int32_t acalNumStars) {
    fbb_.AddElement<int32_t>(EOObservationDetails_Ingest::VT_ACALNUMSTARS, acalNumStars, 0);
  }
  void add_objSunRange(double objSunRange) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_OBJSUNRANGE, objSunRange, 0.0);
  }
  void add_phaseAngBisect(double phaseAngBisect) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_PHASEANGBISECT, phaseAngBisect, 0.0);
  }
  void add_solarDiskFrac(double solarDiskFrac) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_SOLARDISKFRAC, solarDiskFrac, 0.0);
  }
  void add_toes(double toes) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_TOES, toes, 0.0);
  }
  void add_does(double does) {
    fbb_.AddElement<double>(EOObservationDetails_Ingest::VT_DOES, does, 0.0);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(EOObservationDetails_Ingest::VT_SOURCE, source);
  }
  void add_dataMode(EOObservationDetails_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(EOObservationDetails_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(EOObservationDetails_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(EOObservationDetails_Ingest::VT_CREATEDBY, createdBy);
  }
  explicit EOObservationDetails_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<EOObservationDetails_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<EOObservationDetails_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<EOObservationDetails_Ingest> CreateEOObservationDetails_Ingest(
    ...
    EOObservationDetails_Ingest_dataMode_Enum dataMode = EOObservationDetails_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0) {
  EOObservationDetails_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<EOObservationDetails_Ingest> CreateEOObservationDetails_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const EOObservationDetails_Ingest *GetEOObservationDetails_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<EOObservationDetails_Ingest>(buf);
}

inline const EOObservationDetails_Ingest *GetSizePrefixedEOObservationDetails_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EOObservationDetails_Ingest>(buf);
}

inline const char *EOObservationDetails_IngestIdentifier() {
  return "EOOB";
}

inline bool EOObservationDetails_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EOObservationDetails_IngestIdentifier());
}

inline bool SizePrefixedEOObservationDetails_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EOObservationDetails_IngestIdentifier(), true);
}

inline bool VerifyEOObservationDetails_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EOObservationDetails_Ingest>(EOObservationDetails_IngestIdentifier());
}

inline bool VerifySizePrefixedEOObservationDetails_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EOObservationDetails_Ingest>(EOObservationDetails_IngestIdentifier());
}

inline void FinishEOObservationDetails_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EOObservationDetails_Ingest> root) {
  fbb.Finish(root, EOObservationDetails_IngestIdentifier());
}

inline void FinishSizePrefixedEOObservationDetails_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EOObservationDetails_Ingest> root) {
  fbb.FinishSizePrefixed(root, EOObservationDetails_IngestIdentifier());
}
