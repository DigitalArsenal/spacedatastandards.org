...
struct Equipment_Ingest;
struct Equipment_IngestBuilder;

enum Equipment_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  Equipment_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  Equipment_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  Equipment_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  Equipment_Ingest_dataMode_Enum_EXERCISE = 3,
  Equipment_Ingest_dataMode_Enum_MIN = Equipment_Ingest_dataMode_Enum_REAL,
  Equipment_Ingest_dataMode_Enum_MAX = Equipment_Ingest_dataMode_Enum_EXERCISE
};

inline const Equipment_Ingest_dataMode_Enum (&EnumValuesEquipment_Ingest_dataMode_Enum())[4] {
  static const Equipment_Ingest_dataMode_Enum values[] = {
    Equipment_Ingest_dataMode_Enum_REAL,
    Equipment_Ingest_dataMode_Enum_TEST,
    Equipment_Ingest_dataMode_Enum_SIMULATED,
    Equipment_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesEquipment_Ingest_dataMode_Enum() {
...
inline const char *EnumNameEquipment_Ingest_dataMode_Enum(Equipment_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Equipment_Ingest_dataMode_Enum_REAL, Equipment_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEquipment_Ingest_dataMode_Enum()[index];
}

/// /// Properties and characteristics of equipment that can be associated with a site or other entity.
struct Equipment_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Equipment_IngestBuilder Builder;
  ...
  Equipment_Ingest_dataMode_Enum dataMode() const {
    return static_cast<Equipment_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Equipment_IngestBuilder {
  typedef Equipment_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Equipment_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Equipment_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idParentEquipment(::flatbuffers::Offset<::flatbuffers::String> idParentEquipment) {
    fbb_.AddOffset(Equipment_Ingest::VT_IDPARENTEQUIPMENT, idParentEquipment);
  }
  void add_idSite(::flatbuffers::Offset<::flatbuffers::String> idSite) {
    fbb_.AddOffset(Equipment_Ingest::VT_IDSITE, idSite);
  }
  void add_idOperatingUnit(::flatbuffers::Offset<::flatbuffers::String> idOperatingUnit) {
    fbb_.AddOffset(Equipment_Ingest::VT_IDOPERATINGUNIT, idOperatingUnit);
  }
  void add_altEqpId(::flatbuffers::Offset<::flatbuffers::String> altEqpId) {
    fbb_.AddOffset(Equipment_Ingest::VT_ALTEQPID, altEqpId);
  }
  void add_eqpCode(::flatbuffers::Offset<::flatbuffers::String> eqpCode) {
    fbb_.AddOffset(Equipment_Ingest::VT_EQPCODE, eqpCode);
  }
  void add_eqpIdNum(::flatbuffers::Offset<::flatbuffers::String> eqpIdNum) {
    fbb_.AddOffset(Equipment_Ingest::VT_EQPIDNUM, eqpIdNum);
  }
  void add_countryCode(::flatbuffers::Offset<::flatbuffers::String> countryCode) {
    fbb_.AddOffset(Equipment_Ingest::VT_COUNTRYCODE, countryCode);
  }
  void add_altCountryCode(::flatbuffers::Offset<::flatbuffers::String> altCountryCode) {
    fbb_.AddOffset(Equipment_Ingest::VT_ALTCOUNTRYCODE, altCountryCode);
  }
  void add_wac(::flatbuffers::Offset<::flatbuffers::String> wac) {
    fbb_.AddOffset(Equipment_Ingest::VT_WAC, wac);
  }
  void add_seqNum(int32_t seqNum) {
    fbb_.AddElement<int32_t>(Equipment_Ingest::VT_SEQNUM, seqNum, 0);
  }
  void add_nomen(::flatbuffers::Offset<::flatbuffers::String> nomen) {
    fbb_.AddOffset(Equipment_Ingest::VT_NOMEN, nomen);
  }
  void add_operStatus(::flatbuffers::Offset<::flatbuffers::String> operStatus) {
    fbb_.AddOffset(Equipment_Ingest::VT_OPERSTATUS, operStatus);
  }
  void add_condition(::flatbuffers::Offset<::flatbuffers::String> condition) {
    fbb_.AddOffset(Equipment_Ingest::VT_CONDITION, condition);
  }
  void add_conditionAvail(::flatbuffers::Offset<::flatbuffers::String> conditionAvail) {
    fbb_.AddOffset(Equipment_Ingest::VT_CONDITIONAVAIL, conditionAvail);
  }
  void add_eval(int32_t eval) {
    fbb_.AddElement<int32_t>(Equipment_Ingest::VT_EVAL, eval, 0);
  }
  void add_fpa(::flatbuffers::Offset<::flatbuffers::String> fpa) {
    fbb_.AddOffset(Equipment_Ingest::VT_FPA, fpa);
  }
  void add_function(::flatbuffers::Offset<::flatbuffers::String> function) {
    fbb_.AddOffset(Equipment_Ingest::VT_FUNCTION, function);
  }
  void add_ident(::flatbuffers::Offset<::flatbuffers::String> ident) {
    fbb_.AddOffset(Equipment_Ingest::VT_IDENT, ident);
  }
  void add_allegiance(::flatbuffers::Offset<::flatbuffers::String> allegiance) {
    fbb_.AddOffset(Equipment_Ingest::VT_ALLEGIANCE, allegiance);
  }
  void add_altAllegiance(::flatbuffers::Offset<::flatbuffers::String> altAllegiance) {
    fbb_.AddOffset(Equipment_Ingest::VT_ALTALLEGIANCE, altAllegiance);
  }
  void add_locReason(::flatbuffers::Offset<::flatbuffers::String> locReason) {
    fbb_.AddOffset(Equipment_Ingest::VT_LOCREASON, locReason);
  }
  void add_operAreaPrimary(::flatbuffers::Offset<::flatbuffers::String> operAreaPrimary) {
    fbb_.AddOffset(Equipment_Ingest::VT_OPERAREAPRIMARY, operAreaPrimary);
  }
  void add_functPrimary(::flatbuffers::Offset<::flatbuffers::String> functPrimary) {
    fbb_.AddOffset(Equipment_Ingest::VT_FUNCTPRIMARY, functPrimary);
  }
  void add_coordDatum(::flatbuffers::Offset<::flatbuffers::String> coordDatum) {
    fbb_.AddOffset(Equipment_Ingest::VT_COORDDATUM, coordDatum);
  }
  void add_coord(::flatbuffers::Offset<::flatbuffers::String> coord) {
    fbb_.AddOffset(Equipment_Ingest::VT_COORD, coord);
  }
  void add_coordDerivAcc(double coordDerivAcc) {
    fbb_.AddElement<double>(Equipment_Ingest::VT_COORDDERIVACC, coordDerivAcc, 0.0);
  }
  void add_lat(double lat) {
    fbb_.AddElement<double>(Equipment_Ingest::VT_LAT, lat, 0.0);
  }
  void add_lon(double lon) {
    fbb_.AddElement<double>(Equipment_Ingest::VT_LON, lon, 0.0);
  }
  void add_elevMsl(double elevMsl) {
    fbb_.AddElement<double>(Equipment_Ingest::VT_ELEVMSL, elevMsl, 0.0);
  }
  void add_elevMslConfLvl(int32_t elevMslConfLvl) {
    fbb_.AddElement<int32_t>(Equipment_Ingest::VT_ELEVMSLCONFLVL, elevMslConfLvl, 0);
  }
  void add_elevMslDerivAcc(double elevMslDerivAcc) {
    fbb_.AddElement<double>(Equipment_Ingest::VT_ELEVMSLDERIVACC, elevMslDerivAcc, 0.0);
  }
  void add_geoidalMslSep(double geoidalMslSep) {
    fbb_.AddElement<double>(Equipment_Ingest::VT_GEOIDALMSLSEP, geoidalMslSep, 0.0);
  }
  void add_milGridSys(::flatbuffers::Offset<::flatbuffers::String> milGridSys) {
    fbb_.AddOffset(Equipment_Ingest::VT_MILGRIDSYS, milGridSys);
  }
  void add_milGrid(::flatbuffers::Offset<::flatbuffers::String> milGrid) {
    fbb_.AddOffset(Equipment_Ingest::VT_MILGRID, milGrid);
  }
  void add_utm(::flatbuffers::Offset<::flatbuffers::String> utm) {
    fbb_.AddOffset(Equipment_Ingest::VT_UTM, utm);
  }
  void add_airDefArea(::flatbuffers::Offset<::flatbuffers::String> airDefArea) {
    fbb_.AddOffset(Equipment_Ingest::VT_AIRDEFAREA, airDefArea);
  }
  void add_polSubdiv(::flatbuffers::Offset<::flatbuffers::String> polSubdiv) {
    fbb_.AddOffset(Equipment_Ingest::VT_POLSUBDIV, polSubdiv);
  }
  void add_qtyOH(int32_t qtyOH) {
    fbb_.AddElement<int32_t>(Equipment_Ingest::VT_QTYOH, qtyOH, 0);
  }
  void add_symCode(::flatbuffers::Offset<::flatbuffers::String> symCode) {
    fbb_.AddOffset(Equipment_Ingest::VT_SYMCODE, symCode);
  }
  void add_classRating(::flatbuffers::Offset<::flatbuffers::String> classRating) {
    fbb_.AddOffset(Equipment_Ingest::VT_CLASSRATING, classRating);
  }
  void add_recStatus(::flatbuffers::Offset<::flatbuffers::String> recStatus) {
    fbb_.AddOffset(Equipment_Ingest::VT_RECSTATUS, recStatus);
  }
  void add_reviewDate(::flatbuffers::Offset<::flatbuffers::String> reviewDate) {
    fbb_.AddOffset(Equipment_Ingest::VT_REVIEWDATE, reviewDate);
  }
  void add_resProd(::flatbuffers::Offset<::flatbuffers::String> resProd) {
    fbb_.AddOffset(Equipment_Ingest::VT_RESPROD, resProd);
  }
  void add_referenceDoc(::flatbuffers::Offset<::flatbuffers::String> referenceDoc) {
    fbb_.AddOffset(Equipment_Ingest::VT_REFERENCEDOC, referenceDoc);
  }
  void add_srcTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcTyps) {
    fbb_.AddOffset(Equipment_Ingest::VT_SRCTYPS, srcTyps);
  }
  void add_srcIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcIds) {
    fbb_.AddOffset(Equipment_Ingest::VT_SRCIDS, srcIds);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Equipment_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Equipment_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Equipment_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Equipment_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(Equipment_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Equipment_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit Equipment_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Equipment_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Equipment_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Equipment_Ingest> CreateEquipment_Ingest(
    ...
    Equipment_Ingest_dataMode_Enum dataMode = Equipment_Ingest_dataMode_Enum_REAL) {
  Equipment_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Equipment_Ingest> CreateEquipment_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Equipment_Ingest *GetEquipment_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<Equipment_Ingest>(buf);
}

inline const Equipment_Ingest *GetSizePrefixedEquipment_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Equipment_Ingest>(buf);
}

inline const char *Equipment_IngestIdentifier() {
  return "EQUI";
}

inline bool Equipment_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Equipment_IngestIdentifier());
}

inline bool SizePrefixedEquipment_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Equipment_IngestIdentifier(), true);
}

inline bool VerifyEquipment_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Equipment_Ingest>(Equipment_IngestIdentifier());
}

inline bool VerifySizePrefixedEquipment_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Equipment_Ingest>(Equipment_IngestIdentifier());
}

inline void FinishEquipment_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Equipment_Ingest> root) {
  fbb.Finish(root, Equipment_IngestIdentifier());
}

inline void FinishSizePrefixedEquipment_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Equipment_Ingest> root) {
  fbb.FinishSizePrefixed(root, Equipment_IngestIdentifier());
}
