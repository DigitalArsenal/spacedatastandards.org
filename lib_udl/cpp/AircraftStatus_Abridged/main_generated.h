...
struct AircraftStatus_Abridged;
struct AircraftStatus_AbridgedBuilder;

enum AircraftStatus_Abridged_airToAirStatus_Enum : int8_t {
  /// No description available.
  AircraftStatus_Abridged_airToAirStatus_Enum_OPERATIONAL = 0,
  /// No description available.
  AircraftStatus_Abridged_airToAirStatus_Enum_NON_OPERATIONAL = 1,
  /// No description available.
  AircraftStatus_Abridged_airToAirStatus_Enum_OFF = 2,
  AircraftStatus_Abridged_airToAirStatus_Enum_MIN = AircraftStatus_Abridged_airToAirStatus_Enum_OPERATIONAL,
  AircraftStatus_Abridged_airToAirStatus_Enum_MAX = AircraftStatus_Abridged_airToAirStatus_Enum_OFF
};

inline const AircraftStatus_Abridged_airToAirStatus_Enum (&EnumValuesAircraftStatus_Abridged_airToAirStatus_Enum())[3] {
  static const AircraftStatus_Abridged_airToAirStatus_Enum values[] = {
    AircraftStatus_Abridged_airToAirStatus_Enum_OPERATIONAL,
    AircraftStatus_Abridged_airToAirStatus_Enum_NON_OPERATIONAL,
    AircraftStatus_Abridged_airToAirStatus_Enum_OFF
  };
  return values;
}

inline const char * const *EnumNamesAircraftStatus_Abridged_airToAirStatus_Enum() {
...
inline const char *EnumNameAircraftStatus_Abridged_airToAirStatus_Enum(AircraftStatus_Abridged_airToAirStatus_Enum e) {
  if (::flatbuffers::IsOutRange(e, AircraftStatus_Abridged_airToAirStatus_Enum_OPERATIONAL, AircraftStatus_Abridged_airToAirStatus_Enum_OFF)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAircraftStatus_Abridged_airToAirStatus_Enum()[index];
}

enum AircraftStatus_Abridged_airToGroundStatus_Enum : int8_t {
  /// No description available.
  AircraftStatus_Abridged_airToGroundStatus_Enum_OPERATIONAL = 0,
  /// No description available.
  AircraftStatus_Abridged_airToGroundStatus_Enum_NON_OPERATIONAL = 1,
  /// No description available.
  AircraftStatus_Abridged_airToGroundStatus_Enum_OFF = 2,
  AircraftStatus_Abridged_airToGroundStatus_Enum_MIN = AircraftStatus_Abridged_airToGroundStatus_Enum_OPERATIONAL,
  AircraftStatus_Abridged_airToGroundStatus_Enum_MAX = AircraftStatus_Abridged_airToGroundStatus_Enum_OFF
};

inline const AircraftStatus_Abridged_airToGroundStatus_Enum (&EnumValuesAircraftStatus_Abridged_airToGroundStatus_Enum())[3] {
  static const AircraftStatus_Abridged_airToGroundStatus_Enum values[] = {
    AircraftStatus_Abridged_airToGroundStatus_Enum_OPERATIONAL,
    AircraftStatus_Abridged_airToGroundStatus_Enum_NON_OPERATIONAL,
    AircraftStatus_Abridged_airToGroundStatus_Enum_OFF
  };
  return values;
}

inline const char * const *EnumNamesAircraftStatus_Abridged_airToGroundStatus_Enum() {
  static const char * const names[4] = {
    "OPERATIONAL",
    "NON_OPERATIONAL",
    "OFF",
...
inline const char *EnumNameAircraftStatus_Abridged_airToGroundStatus_Enum(AircraftStatus_Abridged_airToGroundStatus_Enum e) {
  if (::flatbuffers::IsOutRange(e, AircraftStatus_Abridged_airToGroundStatus_Enum_OPERATIONAL, AircraftStatus_Abridged_airToGroundStatus_Enum_OFF)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAircraftStatus_Abridged_airToGroundStatus_Enum()[index];
}

enum AircraftStatus_Abridged_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  AircraftStatus_Abridged_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  AircraftStatus_Abridged_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  AircraftStatus_Abridged_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  AircraftStatus_Abridged_dataMode_Enum_EXERCISE = 3,
  AircraftStatus_Abridged_dataMode_Enum_MIN = AircraftStatus_Abridged_dataMode_Enum_REAL,
  AircraftStatus_Abridged_dataMode_Enum_MAX = AircraftStatus_Abridged_dataMode_Enum_EXERCISE
};

inline const AircraftStatus_Abridged_dataMode_Enum (&EnumValuesAircraftStatus_Abridged_dataMode_Enum())[4] {
  static const AircraftStatus_Abridged_dataMode_Enum values[] = {
    AircraftStatus_Abridged_dataMode_Enum_REAL,
    AircraftStatus_Abridged_dataMode_Enum_TEST,
    AircraftStatus_Abridged_dataMode_Enum_SIMULATED,
    AircraftStatus_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesAircraftStatus_Abridged_dataMode_Enum() {
...
inline const char *EnumNameAircraftStatus_Abridged_dataMode_Enum(AircraftStatus_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, AircraftStatus_Abridged_dataMode_Enum_REAL, AircraftStatus_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesAircraftStatus_Abridged_dataMode_Enum()[index];
}
...
struct AircraftStatus_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef AircraftStatus_AbridgedBuilder Builder;
  ...
  /// Constraints: Minimum length = 0, Maximum length = 16
  AircraftStatus_Abridged_airToAirStatus_Enum airToAirStatus() const {
    return static_cast<AircraftStatus_Abridged_airToAirStatus_Enum>(GetField<int8_t>(VT_AIRTOAIRSTATUS, 0));
  }
  /// The status of the air-to-ground weapon release system (OPERATIONAL, NON-OPERATIONAL, OFF).
  /// Example: /// Example: OPERATIONAL
  /// Constraints: Minimum length = 0, Maximum length = 16
  AircraftStatus_Abridged_airToGroundStatus_Enum airToGroundStatus() const {
    return static_cast<AircraftStatus_Abridged_airToGroundStatus_Enum>(GetField<int8_t>(VT_AIRTOGROUNDSTATUS, 0));
  }
  ...
  AircraftStatus_Abridged_dataMode_Enum dataMode() const {
    return static_cast<AircraftStatus_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct AircraftStatus_AbridgedBuilder {
  typedef AircraftStatus_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idAircraft(::flatbuffers::Offset<::flatbuffers::String> idAircraft) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_IDAIRCRAFT, idAircraft);
  }
  void add_altAircraftId(::flatbuffers::Offset<::flatbuffers::String> altAircraftId) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_ALTAIRCRAFTID, altAircraftId);
  }
  void add_currentState(::flatbuffers::Offset<::flatbuffers::String> currentState) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_CURRENTSTATE, currentState);
  }
  void add_idAirfield(::flatbuffers::Offset<::flatbuffers::String> idAirfield) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_IDAIRFIELD, idAirfield);
  }
  void add_geoLoc(::flatbuffers::Offset<::flatbuffers::String> geoLoc) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_GEOLOC, geoLoc);
  }
  void add_previousICAO(::flatbuffers::Offset<::flatbuffers::String> previousICAO) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_PREVIOUSICAO, previousICAO);
  }
  void add_currentICAO(::flatbuffers::Offset<::flatbuffers::String> currentICAO) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_CURRENTICAO, currentICAO);
  }
  void add_nextICAO(::flatbuffers::Offset<::flatbuffers::String> nextICAO) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_NEXTICAO, nextICAO);
  }
  void add_flightPhase(::flatbuffers::Offset<::flatbuffers::String> flightPhase) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_FLIGHTPHASE, flightPhase);
  }
  void add_taStartTime(::flatbuffers::Offset<::flatbuffers::String> taStartTime) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_TASTARTTIME, taStartTime);
  }
  void add_earliestTAEndTime(::flatbuffers::Offset<::flatbuffers::String> earliestTAEndTime) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_EARLIESTTAENDTIME, earliestTAEndTime);
  }
  void add_missionReadiness(::flatbuffers::Offset<::flatbuffers::String> missionReadiness) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_MISSIONREADINESS, missionReadiness);
  }
  void add_fuel(int32_t fuel) {
    fbb_.AddElement<int32_t>(AircraftStatus_Abridged::VT_FUEL, fuel, 0);
  }
  void add_fuelFunction(::flatbuffers::Offset<::flatbuffers::String> fuelFunction) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_FUELFUNCTION, fuelFunction);
  }
  void add_gunCapable(bool gunCapable) {
    fbb_.AddElement<uint8_t>(AircraftStatus_Abridged::VT_GUNCAPABLE, static_cast<uint8_t>(gunCapable), 0);
  }
  void add_gunRdsType(::flatbuffers::Offset<::flatbuffers::String> gunRdsType) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_GUNRDSTYPE, gunRdsType);
  }
  void add_gunRdsMin(int32_t gunRdsMin) {
    fbb_.AddElement<int32_t>(AircraftStatus_Abridged::VT_GUNRDSMIN, gunRdsMin, 0);
  }
  void add_gunRdsMax(int32_t gunRdsMax) {
    fbb_.AddElement<int32_t>(AircraftStatus_Abridged::VT_GUNRDSMAX, gunRdsMax, 0);
  }
  void add_airToAirStatus(AircraftStatus_Abridged_airToAirStatus_Enum airToAirStatus) {
    fbb_.AddElement<int8_t>(AircraftStatus_Abridged::VT_AIRTOAIRSTATUS, static_cast<int8_t>(airToAirStatus), 0);
  }
  void add_airToGroundStatus(AircraftStatus_Abridged_airToGroundStatus_Enum airToGroundStatus) {
    fbb_.AddElement<int8_t>(AircraftStatus_Abridged::VT_AIRTOGROUNDSTATUS, static_cast<int8_t>(airToGroundStatus), 0);
  }
  void add_inventory(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> inventory) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_INVENTORY, inventory);
  }
  void add_inventoryMin(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> inventoryMin) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_INVENTORYMIN, inventoryMin);
  }
  void add_inventoryMax(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> inventoryMax) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_INVENTORYMAX, inventoryMax);
  }
  void add_unavailableSys(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> unavailableSys) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_UNAVAILABLESYS, unavailableSys);
  }
  void add_additionalSys(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> additionalSys) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_ADDITIONALSYS, additionalSys);
  }
  void add_notes(::flatbuffers::Offset<::flatbuffers::String> notes) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_NOTES, notes);
  }
  void add_mxRemark(::flatbuffers::Offset<::flatbuffers::String> mxRemark) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_MXREMARK, mxRemark);
  }
  void add_maintStatus(::flatbuffers::Offset<::flatbuffers::String> maintStatus) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_MAINTSTATUS, maintStatus);
  }
  void add_maintStatusDriver(::flatbuffers::Offset<::flatbuffers::String> maintStatusDriver) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_MAINTSTATUSDRIVER, maintStatusDriver);
  }
  void add_maintPriority(::flatbuffers::Offset<::flatbuffers::String> maintPriority) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_MAINTPRIORITY, maintPriority);
  }
  void add_alphaStatusCode(::flatbuffers::Offset<::flatbuffers::String> alphaStatusCode) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_ALPHASTATUSCODE, alphaStatusCode);
  }
  void add_maintStatusUpdate(::flatbuffers::Offset<::flatbuffers::String> maintStatusUpdate) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_MAINTSTATUSUPDATE, maintStatusUpdate);
  }
  void add_lastInspectionDate(::flatbuffers::Offset<::flatbuffers::String> lastInspectionDate) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_LASTINSPECTIONDATE, lastInspectionDate);
  }
  void add_maintPoc(::flatbuffers::Offset<::flatbuffers::String> maintPoc) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_MAINTPOC, maintPoc);
  }
  void add_groundStatus(::flatbuffers::Offset<::flatbuffers::String> groundStatus) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_GROUNDSTATUS, groundStatus);
  }
  void add_contaminationStatus(::flatbuffers::Offset<::flatbuffers::String> contaminationStatus) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_CONTAMINATIONSTATUS, contaminationStatus);
  }
  void add_fuelStatus(::flatbuffers::Offset<::flatbuffers::String> fuelStatus) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_FUELSTATUS, fuelStatus);
  }
  void add_lastUpdatedBy(::flatbuffers::Offset<::flatbuffers::String> lastUpdatedBy) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_LASTUPDATEDBY, lastUpdatedBy);
  }
  void add_troubleshootEtic(::flatbuffers::Offset<::flatbuffers::String> troubleshootEtic) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_TROUBLESHOOTETIC, troubleshootEtic);
  }
  void add_etic(::flatbuffers::Offset<::flatbuffers::String> etic) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_ETIC, etic);
  }
  void add_parkLocation(::flatbuffers::Offset<::flatbuffers::String> parkLocation) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_PARKLOCATION, parkLocation);
  }
  void add_parkLocationSystem(::flatbuffers::Offset<::flatbuffers::String> parkLocationSystem) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_PARKLOCATIONSYSTEM, parkLocationSystem);
  }
  void add_idPOI(::flatbuffers::Offset<::flatbuffers::String> idPOI) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_IDPOI, idPOI);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_ORIGIN, origin);
  }
  void add_dataMode(AircraftStatus_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(AircraftStatus_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(AircraftStatus_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  explicit AircraftStatus_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<AircraftStatus_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<AircraftStatus_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<AircraftStatus_Abridged> CreateAircraftStatus_Abridged(
    ...
    int32_t gunRdsMin = 0,
    int32_t gunRdsMax = 0,
    AircraftStatus_Abridged_airToAirStatus_Enum airToAirStatus = AircraftStatus_Abridged_airToAirStatus_Enum_OPERATIONAL,
    AircraftStatus_Abridged_airToGroundStatus_Enum airToGroundStatus = AircraftStatus_Abridged_airToGroundStatus_Enum_OPERATIONAL,
    ...
    AircraftStatus_Abridged_dataMode_Enum dataMode = AircraftStatus_Abridged_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  AircraftStatus_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<AircraftStatus_Abridged> CreateAircraftStatus_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const AircraftStatus_Abridged *GetAircraftStatus_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<AircraftStatus_Abridged>(buf);
}

inline const AircraftStatus_Abridged *GetSizePrefixedAircraftStatus_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<AircraftStatus_Abridged>(buf);
}

inline const char *AircraftStatus_AbridgedIdentifier() {
  return "AIRC";
}

inline bool AircraftStatus_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftStatus_AbridgedIdentifier());
}

inline bool SizePrefixedAircraftStatus_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, AircraftStatus_AbridgedIdentifier(), true);
}

inline bool VerifyAircraftStatus_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<AircraftStatus_Abridged>(AircraftStatus_AbridgedIdentifier());
}

inline bool VerifySizePrefixedAircraftStatus_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<AircraftStatus_Abridged>(AircraftStatus_AbridgedIdentifier());
}

inline void FinishAircraftStatus_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftStatus_Abridged> root) {
  fbb.Finish(root, AircraftStatus_AbridgedIdentifier());
}

inline void FinishSizePrefixedAircraftStatus_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<AircraftStatus_Abridged> root) {
  fbb.FinishSizePrefixed(root, AircraftStatus_AbridgedIdentifier());
}
