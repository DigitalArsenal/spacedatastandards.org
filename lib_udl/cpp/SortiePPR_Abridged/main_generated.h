...
struct SortiePPR_Abridged;
struct SortiePPR_AbridgedBuilder;

enum SortiePPR_Abridged_type_Enum : int8_t {
  /// No description available.
  SortiePPR_Abridged_type_Enum_M = 0,
  /// No description available.
  SortiePPR_Abridged_type_Enum_C = 1,
  SortiePPR_Abridged_type_Enum_MIN = SortiePPR_Abridged_type_Enum_M,
  SortiePPR_Abridged_type_Enum_MAX = SortiePPR_Abridged_type_Enum_C
};

inline const SortiePPR_Abridged_type_Enum (&EnumValuesSortiePPR_Abridged_type_Enum())[2] {
  static const SortiePPR_Abridged_type_Enum values[] = {
    SortiePPR_Abridged_type_Enum_M,
    SortiePPR_Abridged_type_Enum_C
  };
  return values;
}

inline const char * const *EnumNamesSortiePPR_Abridged_type_Enum() {
...
inline const char *EnumNameSortiePPR_Abridged_type_Enum(SortiePPR_Abridged_type_Enum e) {
  if (::flatbuffers::IsOutRange(e, SortiePPR_Abridged_type_Enum_M, SortiePPR_Abridged_type_Enum_C)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSortiePPR_Abridged_type_Enum()[index];
}

enum SortiePPR_Abridged_dataMode_Enum : int8_t {
  ...
  SortiePPR_Abridged_dataMode_Enum_MIN = SortiePPR_Abridged_dataMode_Enum_REAL,
  SortiePPR_Abridged_dataMode_Enum_MAX = SortiePPR_Abridged_dataMode_Enum_EXERCISE
};

inline const SortiePPR_Abridged_dataMode_Enum (&EnumValuesSortiePPR_Abridged_dataMode_Enum())[4] {
  static const SortiePPR_Abridged_dataMode_Enum values[] = {
    SortiePPR_Abridged_dataMode_Enum_REAL,
    SortiePPR_Abridged_dataMode_Enum_TEST,
    SortiePPR_Abridged_dataMode_Enum_SIMULATED,
    SortiePPR_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSortiePPR_Abridged_dataMode_Enum() {
...
inline const char *EnumNameSortiePPR_Abridged_dataMode_Enum(SortiePPR_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SortiePPR_Abridged_dataMode_Enum_REAL, SortiePPR_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSortiePPR_Abridged_dataMode_Enum()[index];
}
...
struct SortiePPR_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SortiePPR_AbridgedBuilder Builder;
  ...
  SortiePPR_Abridged_type_Enum type() const {
    return static_cast<SortiePPR_Abridged_type_Enum>(GetField<int8_t>(VT_TYPE, 0));
  }
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SortiePPR_Abridged_dataMode_Enum dataMode() const {
    return static_cast<SortiePPR_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SortiePPR_AbridgedBuilder {
  typedef SortiePPR_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SortiePPR_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SortiePPR_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idSortie(::flatbuffers::Offset<::flatbuffers::String> idSortie) {
    fbb_.AddOffset(SortiePPR_Abridged::VT_IDSORTIE, idSortie);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(SortiePPR_Abridged::VT_EXTERNALID, externalId);
  }
  void add_number(::flatbuffers::Offset<::flatbuffers::String> number) {
    fbb_.AddOffset(SortiePPR_Abridged::VT_NUMBER, number);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(SortiePPR_Abridged::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(SortiePPR_Abridged::VT_ENDTIME, endTime);
  }
  void add_requestor(::flatbuffers::Offset<::flatbuffers::String> requestor) {
    fbb_.AddOffset(SortiePPR_Abridged::VT_REQUESTOR, requestor);
  }
  void add_grantor(::flatbuffers::Offset<::flatbuffers::String> grantor) {
    fbb_.AddOffset(SortiePPR_Abridged::VT_GRANTOR, grantor);
  }
  void add_type(SortiePPR_Abridged_type_Enum type) {
    fbb_.AddElement<int8_t>(SortiePPR_Abridged::VT_TYPE, static_cast<int8_t>(type), 0);
  }
  void add_remarks(::flatbuffers::Offset<::flatbuffers::String> remarks) {
    fbb_.AddOffset(SortiePPR_Abridged::VT_REMARKS, remarks);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SortiePPR_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SortiePPR_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(SortiePPR_Abridged::VT_SOURCEDL, sourceDL);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SortiePPR_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SortiePPR_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SortiePPR_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(SortiePPR_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SortiePPR_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit SortiePPR_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SortiePPR_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SortiePPR_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SortiePPR_Abridged> CreateSortiePPR_Abridged(
    ...
    SortiePPR_Abridged_type_Enum type = SortiePPR_Abridged_type_Enum_M,
    ...
    SortiePPR_Abridged_dataMode_Enum dataMode = SortiePPR_Abridged_dataMode_Enum_REAL) {
  SortiePPR_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SortiePPR_Abridged> CreateSortiePPR_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const SortiePPR_Abridged *GetSortiePPR_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<SortiePPR_Abridged>(buf);
}

inline const SortiePPR_Abridged *GetSizePrefixedSortiePPR_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SortiePPR_Abridged>(buf);
}

inline const char *SortiePPR_AbridgedIdentifier() {
  return "SORT";
}

inline bool SortiePPR_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SortiePPR_AbridgedIdentifier());
}

inline bool SizePrefixedSortiePPR_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SortiePPR_AbridgedIdentifier(), true);
}

inline bool VerifySortiePPR_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SortiePPR_Abridged>(SortiePPR_AbridgedIdentifier());
}

inline bool VerifySizePrefixedSortiePPR_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SortiePPR_Abridged>(SortiePPR_AbridgedIdentifier());
}

inline void FinishSortiePPR_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SortiePPR_Abridged> root) {
  fbb.Finish(root, SortiePPR_AbridgedIdentifier());
}

inline void FinishSizePrefixedSortiePPR_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SortiePPR_Abridged> root) {
  fbb.FinishSizePrefixed(root, SortiePPR_AbridgedIdentifier());
}
