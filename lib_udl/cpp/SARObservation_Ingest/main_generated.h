...
struct SARObservation_Ingest;
struct SARObservation_IngestBuilder;

enum SARObservation_Ingest_dataMode_Enum : int8_t {
  ...
  SARObservation_Ingest_dataMode_Enum_MIN = SARObservation_Ingest_dataMode_Enum_REAL,
  SARObservation_Ingest_dataMode_Enum_MAX = SARObservation_Ingest_dataMode_Enum_EXERCISE
};

inline const SARObservation_Ingest_dataMode_Enum (&EnumValuesSARObservation_Ingest_dataMode_Enum())[4] {
  static const SARObservation_Ingest_dataMode_Enum values[] = {
    SARObservation_Ingest_dataMode_Enum_REAL,
    SARObservation_Ingest_dataMode_Enum_TEST,
    SARObservation_Ingest_dataMode_Enum_SIMULATED,
    SARObservation_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSARObservation_Ingest_dataMode_Enum() {
...
inline const char *EnumNameSARObservation_Ingest_dataMode_Enum(SARObservation_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SARObservation_Ingest_dataMode_Enum_REAL, SARObservation_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSARObservation_Ingest_dataMode_Enum()[index];
}
...
struct SARObservation_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SARObservation_IngestBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SARObservation_Ingest_dataMode_Enum dataMode() const {
    return static_cast<SARObservation_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SARObservation_IngestBuilder {
  typedef SARObservation_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SARObservation_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SARObservation_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(SARObservation_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(SARObservation_Ingest::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(SARObservation_Ingest::VT_ORIGOBJECTID, origObjectId);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(SARObservation_Ingest::VT_IDSENSOR, idSensor);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(SARObservation_Ingest::VT_ORIGSENSORID, origSensorId);
  }
  void add_externalId(::flatbuffers::Offset<::flatbuffers::String> externalId) {
    fbb_.AddOffset(SARObservation_Ingest::VT_EXTERNALID, externalId);
  }
  void add_collectionId(::flatbuffers::Offset<::flatbuffers::String> collectionId) {
    fbb_.AddOffset(SARObservation_Ingest::VT_COLLECTIONID, collectionId);
  }
  void add_detectionId(::flatbuffers::Offset<::flatbuffers::String> detectionId) {
    fbb_.AddOffset(SARObservation_Ingest::VT_DETECTIONID, detectionId);
  }
  void add_collectionStart(::flatbuffers::Offset<::flatbuffers::String> collectionStart) {
    fbb_.AddOffset(SARObservation_Ingest::VT_COLLECTIONSTART, collectionStart);
  }
  void add_collectionEnd(::flatbuffers::Offset<::flatbuffers::String> collectionEnd) {
    fbb_.AddOffset(SARObservation_Ingest::VT_COLLECTIONEND, collectionEnd);
  }
  void add_centerTime(::flatbuffers::Offset<::flatbuffers::String> centerTime) {
    fbb_.AddOffset(SARObservation_Ingest::VT_CENTERTIME, centerTime);
  }
  void add_detectionStart(::flatbuffers::Offset<::flatbuffers::String> detectionStart) {
    fbb_.AddOffset(SARObservation_Ingest::VT_DETECTIONSTART, detectionStart);
  }
  void add_detectionEnd(::flatbuffers::Offset<::flatbuffers::String> detectionEnd) {
    fbb_.AddOffset(SARObservation_Ingest::VT_DETECTIONEND, detectionEnd);
  }
  void add_dwellTime(double dwellTime) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_DWELLTIME, dwellTime, 0.0);
  }
  void add_orbitState(::flatbuffers::Offset<::flatbuffers::String> orbitState) {
    fbb_.AddOffset(SARObservation_Ingest::VT_ORBITSTATE, orbitState);
  }
  void add_sarMode(::flatbuffers::Offset<::flatbuffers::String> sarMode) {
    fbb_.AddOffset(SARObservation_Ingest::VT_SARMODE, sarMode);
  }
  void add_operatingBand(::flatbuffers::Offset<::flatbuffers::String> operatingBand) {
    fbb_.AddOffset(SARObservation_Ingest::VT_OPERATINGBAND, operatingBand);
  }
  void add_operatingFreq(double operatingFreq) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_OPERATINGFREQ, operatingFreq, 0.0);
  }
  void add_snr(double snr) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_SNR, snr, 0.0);
  }
  void add_txPolarization(::flatbuffers::Offset<::flatbuffers::String> txPolarization) {
    fbb_.AddOffset(SARObservation_Ingest::VT_TXPOLARIZATION, txPolarization);
  }
  void add_rxPolarization(::flatbuffers::Offset<::flatbuffers::String> rxPolarization) {
    fbb_.AddOffset(SARObservation_Ingest::VT_RXPOLARIZATION, rxPolarization);
  }
  void add_grazeAngle(double grazeAngle) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_GRAZEANGLE, grazeAngle, 0.0);
  }
  void add_incidenceAngle(double incidenceAngle) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_INCIDENCEANGLE, incidenceAngle, 0.0);
  }
  void add_squintAngle(double squintAngle) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_SQUINTANGLE, squintAngle, 0.0);
  }
  void add_pulseBandwidth(double pulseBandwidth) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_PULSEBANDWIDTH, pulseBandwidth, 0.0);
  }
  void add_pulseDuration(double pulseDuration) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_PULSEDURATION, pulseDuration, 0.0);
  }
  void add_continuousSpotAngle(double continuousSpotAngle) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_CONTINUOUSSPOTANGLE, continuousSpotAngle, 0.0);
  }
  void add_slantRange(double slantRange) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_SLANTRANGE, slantRange, 0.0);
  }
  void add_nearRange(double nearRange) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_NEARRANGE, nearRange, 0.0);
  }
  void add_farRange(double farRange) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_FARRANGE, farRange, 0.0);
  }
  void add_swathLength(double swathLength) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_SWATHLENGTH, swathLength, 0.0);
  }
  void add_area(::flatbuffers::Offset<::flatbuffers::String> area) {
    fbb_.AddOffset(SARObservation_Ingest::VT_AREA, area);
  }
  void add_atext(::flatbuffers::Offset<::flatbuffers::String> atext) {
    fbb_.AddOffset(SARObservation_Ingest::VT_ATEXT, atext);
  }
  void add_agjson(::flatbuffers::Offset<::flatbuffers::String> agjson) {
    fbb_.AddOffset(SARObservation_Ingest::VT_AGJSON, agjson);
  }
  void add_atype(::flatbuffers::Offset<::flatbuffers::String> atype) {
    fbb_.AddOffset(SARObservation_Ingest::VT_ATYPE, atype);
  }
  void add_andims(int32_t andims) {
    fbb_.AddElement<int32_t>(SARObservation_Ingest::VT_ANDIMS, andims, 0);
  }
  void add_asrid(int32_t asrid) {
    fbb_.AddElement<int32_t>(SARObservation_Ingest::VT_ASRID, asrid, 0);
  }
  void add_spacingRange(double spacingRange) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_SPACINGRANGE, spacingRange, 0.0);
  }
  void add_spacingAzimuth(double spacingAzimuth) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_SPACINGAZIMUTH, spacingAzimuth, 0.0);
  }
  void add_looksAzimuth(int32_t looksAzimuth) {
    fbb_.AddElement<int32_t>(SARObservation_Ingest::VT_LOOKSAZIMUTH, looksAzimuth, 0);
  }
  void add_looksRange(int32_t looksRange) {
    fbb_.AddElement<int32_t>(SARObservation_Ingest::VT_LOOKSRANGE, looksRange, 0);
  }
  void add_resolutionRange(double resolutionRange) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_RESOLUTIONRANGE, resolutionRange, 0.0);
  }
  void add_resolutionAzimuth(double resolutionAzimuth) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_RESOLUTIONAZIMUTH, resolutionAzimuth, 0.0);
  }
  void add_obDirection(::flatbuffers::Offset<::flatbuffers::String> obDirection) {
    fbb_.AddOffset(SARObservation_Ingest::VT_OBDIRECTION, obDirection);
  }
  void add_coordSys(::flatbuffers::Offset<::flatbuffers::String> coordSys) {
    fbb_.AddOffset(SARObservation_Ingest::VT_COORDSYS, coordSys);
  }
  void add_targetposx(double targetposx) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_TARGETPOSX, targetposx, 0.0);
  }
  void add_targetposy(double targetposy) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_TARGETPOSY, targetposy, 0.0);
  }
  void add_targetposz(double targetposz) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_TARGETPOSZ, targetposz, 0.0);
  }
  void add_senalt(double senalt) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_SENALT, senalt, 0.0);
  }
  void add_senvelx(double senvelx) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_SENVELX, senvelx, 0.0);
  }
  void add_senvely(double senvely) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_SENVELY, senvely, 0.0);
  }
  void add_senvelz(double senvelz) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_SENVELZ, senvelz, 0.0);
  }
  void add_senlatStart(double senlatStart) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_SENLATSTART, senlatStart, 0.0);
  }
  void add_senlonStart(double senlonStart) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_SENLONSTART, senlonStart, 0.0);
  }
  void add_senlatEnd(double senlatEnd) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_SENLATEND, senlatEnd, 0.0);
  }
  void add_senlonEnd(double senlonEnd) {
    fbb_.AddElement<double>(SARObservation_Ingest::VT_SENLONEND, senlonEnd, 0.0);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(SARObservation_Ingest::VT_TRANSACTIONID, transactionId);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(SARObservation_Ingest::VT_TAGS, tags);
  }
  void add_srcTyps(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcTyps) {
    fbb_.AddOffset(SARObservation_Ingest::VT_SRCTYPS, srcTyps);
  }
  void add_srcIds(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> srcIds) {
    fbb_.AddOffset(SARObservation_Ingest::VT_SRCIDS, srcIds);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SARObservation_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SARObservation_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SARObservation_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SARObservation_Ingest::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SARObservation_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  void add_sourceDL(::flatbuffers::Offset<::flatbuffers::String> sourceDL) {
    fbb_.AddOffset(SARObservation_Ingest::VT_SOURCEDL, sourceDL);
  }
  void add_dataMode(SARObservation_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SARObservation_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit SARObservation_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SARObservation_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SARObservation_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SARObservation_Ingest> CreateSARObservation_Ingest(
    ...
    SARObservation_Ingest_dataMode_Enum dataMode = SARObservation_Ingest_dataMode_Enum_REAL) {
  SARObservation_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SARObservation_Ingest> CreateSARObservation_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const SARObservation_Ingest *GetSARObservation_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<SARObservation_Ingest>(buf);
}

inline const SARObservation_Ingest *GetSizePrefixedSARObservation_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SARObservation_Ingest>(buf);
}

inline const char *SARObservation_IngestIdentifier() {
  return "SARO";
}

inline bool SARObservation_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SARObservation_IngestIdentifier());
}

inline bool SizePrefixedSARObservation_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SARObservation_IngestIdentifier(), true);
}

inline bool VerifySARObservation_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SARObservation_Ingest>(SARObservation_IngestIdentifier());
}

inline bool VerifySizePrefixedSARObservation_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SARObservation_Ingest>(SARObservation_IngestIdentifier());
}

inline void FinishSARObservation_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SARObservation_Ingest> root) {
  fbb.Finish(root, SARObservation_IngestIdentifier());
}

inline void FinishSizePrefixedSARObservation_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SARObservation_Ingest> root) {
  fbb.FinishSizePrefixed(root, SARObservation_IngestIdentifier());
}
