...
struct OnorbitEvent_Ingest;
struct OnorbitEvent_IngestBuilder;

enum OnorbitEvent_Ingest_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  OnorbitEvent_Ingest_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  OnorbitEvent_Ingest_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  OnorbitEvent_Ingest_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  OnorbitEvent_Ingest_dataMode_Enum_EXERCISE = 3,
  OnorbitEvent_Ingest_dataMode_Enum_MIN = OnorbitEvent_Ingest_dataMode_Enum_REAL,
  OnorbitEvent_Ingest_dataMode_Enum_MAX = OnorbitEvent_Ingest_dataMode_Enum_EXERCISE
};

inline const OnorbitEvent_Ingest_dataMode_Enum (&EnumValuesOnorbitEvent_Ingest_dataMode_Enum())[4] {
  static const OnorbitEvent_Ingest_dataMode_Enum values[] = {
    OnorbitEvent_Ingest_dataMode_Enum_REAL,
    OnorbitEvent_Ingest_dataMode_Enum_TEST,
    OnorbitEvent_Ingest_dataMode_Enum_SIMULATED,
    OnorbitEvent_Ingest_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesOnorbitEvent_Ingest_dataMode_Enum() {
...
inline const char *EnumNameOnorbitEvent_Ingest_dataMode_Enum(OnorbitEvent_Ingest_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, OnorbitEvent_Ingest_dataMode_Enum_REAL, OnorbitEvent_Ingest_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesOnorbitEvent_Ingest_dataMode_Enum()[index];
}

/// /// No description available.
struct OnorbitEvent_Ingest FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef OnorbitEvent_IngestBuilder Builder;
  ...
  OnorbitEvent_Ingest_dataMode_Enum dataMode() const {
    return static_cast<OnorbitEvent_Ingest_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct OnorbitEvent_IngestBuilder {
  typedef OnorbitEvent_Ingest Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_derivedFrom(::flatbuffers::Offset<::flatbuffers::String> derivedFrom) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_DERIVEDFROM, derivedFrom);
  }
  void add_declassificationDate(::flatbuffers::Offset<::flatbuffers::String> declassificationDate) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_DECLASSIFICATIONDATE, declassificationDate);
  }
  void add_declassificationString(::flatbuffers::Offset<::flatbuffers::String> declassificationString) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_DECLASSIFICATIONSTRING, declassificationString);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_IDONORBIT, idOnOrbit);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(OnorbitEvent_Ingest::VT_SATNO, satNo, 0);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_ORIGOBJECTID, origObjectId);
  }
  void add_eventTime(::flatbuffers::Offset<::flatbuffers::String> eventTime) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_EVENTTIME, eventTime);
  }
  void add_eventTimeNotes(::flatbuffers::Offset<::flatbuffers::String> eventTimeNotes) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_EVENTTIMENOTES, eventTimeNotes);
  }
  void add_operatorOrgId(::flatbuffers::Offset<::flatbuffers::String> operatorOrgId) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_OPERATORORGID, operatorOrgId);
  }
  void add_ownerOrgId(::flatbuffers::Offset<::flatbuffers::String> ownerOrgId) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_OWNERORGID, ownerOrgId);
  }
  void add_lesseeOrgId(::flatbuffers::Offset<::flatbuffers::String> lesseeOrgId) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_LESSEEORGID, lesseeOrgId);
  }
  void add_operatedOnBehalfOfOrgId(::flatbuffers::Offset<::flatbuffers::String> operatedOnBehalfOfOrgId) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_OPERATEDONBEHALFOFORGID, operatedOnBehalfOfOrgId);
  }
  void add_geoPosition(double geoPosition) {
    fbb_.AddElement<double>(OnorbitEvent_Ingest::VT_GEOPOSITION, geoPosition, 0.0);
  }
  void add_planeSlot(::flatbuffers::Offset<::flatbuffers::String> planeSlot) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_PLANESLOT, planeSlot);
  }
  void add_planeNumber(::flatbuffers::Offset<::flatbuffers::String> planeNumber) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_PLANENUMBER, planeNumber);
  }
  void add_positionStatus(::flatbuffers::Offset<::flatbuffers::String> positionStatus) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_POSITIONSTATUS, positionStatus);
  }
  void add_untilTime(::flatbuffers::Offset<::flatbuffers::String> untilTime) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_UNTILTIME, untilTime);
  }
  void add_officialLossDate(::flatbuffers::Offset<::flatbuffers::String> officialLossDate) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_OFFICIALLOSSDATE, officialLossDate);
  }
  void add_netAmount(double netAmount) {
    fbb_.AddElement<double>(OnorbitEvent_Ingest::VT_NETAMOUNT, netAmount, 0.0);
  }
  void add_underlyingCause(::flatbuffers::Offset<::flatbuffers::String> underlyingCause) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_UNDERLYINGCAUSE, underlyingCause);
  }
  void add_capabilityLoss(double capabilityLoss) {
    fbb_.AddElement<double>(OnorbitEvent_Ingest::VT_CAPABILITYLOSS, capabilityLoss, 0.0);
  }
  void add_capacityLoss(double capacityLoss) {
    fbb_.AddElement<double>(OnorbitEvent_Ingest::VT_CAPACITYLOSS, capacityLoss, 0.0);
  }
  void add_insuranceLoss(double insuranceLoss) {
    fbb_.AddElement<double>(OnorbitEvent_Ingest::VT_INSURANCELOSS, insuranceLoss, 0.0);
  }
  void add_thirdPartyInsuranceLoss(double thirdPartyInsuranceLoss) {
    fbb_.AddElement<double>(OnorbitEvent_Ingest::VT_THIRDPARTYINSURANCELOSS, thirdPartyInsuranceLoss, 0.0);
  }
  void add_injured(int32_t injured) {
    fbb_.AddElement<int32_t>(OnorbitEvent_Ingest::VT_INJURED, injured, 0);
  }
  void add_killed(int32_t killed) {
    fbb_.AddElement<int32_t>(OnorbitEvent_Ingest::VT_KILLED, killed, 0);
  }
  void add_lifeLost(double lifeLost) {
    fbb_.AddElement<double>(OnorbitEvent_Ingest::VT_LIFELOST, lifeLost, 0.0);
  }
  void add_ageAtEvent(double ageAtEvent) {
    fbb_.AddElement<double>(OnorbitEvent_Ingest::VT_AGEATEVENT, ageAtEvent, 0.0);
  }
  void add_achievedFlightPhase(::flatbuffers::Offset<::flatbuffers::String> achievedFlightPhase) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_ACHIEVEDFLIGHTPHASE, achievedFlightPhase);
  }
  void add_occurrenceFlightPhase(::flatbuffers::Offset<::flatbuffers::String> occurrenceFlightPhase) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_OCCURRENCEFLIGHTPHASE, occurrenceFlightPhase);
  }
  void add_stageAtFault(::flatbuffers::Offset<::flatbuffers::String> stageAtFault) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_STAGEATFAULT, stageAtFault);
  }
  void add_equipmentAtFault(::flatbuffers::Offset<::flatbuffers::String> equipmentAtFault) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_EQUIPMENTATFAULT, equipmentAtFault);
  }
  void add_equipmentTypeAtFault(::flatbuffers::Offset<::flatbuffers::String> equipmentTypeAtFault) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_EQUIPMENTTYPEATFAULT, equipmentTypeAtFault);
  }
  void add_equipmentPartAtFault(::flatbuffers::Offset<::flatbuffers::String> equipmentPartAtFault) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_EQUIPMENTPARTATFAULT, equipmentPartAtFault);
  }
  void add_consequentialEquipmentFailure(::flatbuffers::Offset<::flatbuffers::String> consequentialEquipmentFailure) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_CONSEQUENTIALEQUIPMENTFAILURE, consequentialEquipmentFailure);
  }
  void add_inclined(bool inclined) {
    fbb_.AddElement<uint8_t>(OnorbitEvent_Ingest::VT_INCLINED, static_cast<uint8_t>(inclined), 0);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_DESCRIPTION, description);
  }
  void add_remarks(::flatbuffers::Offset<::flatbuffers::String> remarks) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_REMARKS, remarks);
  }
  void add_insuranceLossNotes(::flatbuffers::Offset<::flatbuffers::String> insuranceLossNotes) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_INSURANCELOSSNOTES, insuranceLossNotes);
  }
  void add_capabilityLossNotes(::flatbuffers::Offset<::flatbuffers::String> capabilityLossNotes) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_CAPABILITYLOSSNOTES, capabilityLossNotes);
  }
  void add_insuranceCarriedNotes(::flatbuffers::Offset<::flatbuffers::String> insuranceCarriedNotes) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_INSURANCECARRIEDNOTES, insuranceCarriedNotes);
  }
  void add_equipmentCausingLossNotes(::flatbuffers::Offset<::flatbuffers::String> equipmentCausingLossNotes) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_EQUIPMENTCAUSINGLOSSNOTES, equipmentCausingLossNotes);
  }
  void add_eventType(::flatbuffers::Offset<::flatbuffers::String> eventType) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_EVENTTYPE, eventType);
  }
  void add_eventResult(::flatbuffers::Offset<::flatbuffers::String> eventResult) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_EVENTRESULT, eventResult);
  }
  void add_objectStatus(::flatbuffers::Offset<::flatbuffers::String> objectStatus) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_OBJECTSTATUS, objectStatus);
  }
  void add_satellitePosition(::flatbuffers::Offset<::flatbuffers::String> satellitePosition) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_SATELLITEPOSITION, satellitePosition);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_ORIGIN, origin);
  }
  void add_dataMode(OnorbitEvent_Ingest_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(OnorbitEvent_Ingest::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_CREATEDBY, createdBy);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(OnorbitEvent_Ingest::VT_ORIGNETWORK, origNetwork);
  }
  explicit OnorbitEvent_IngestBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<OnorbitEvent_Ingest> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<OnorbitEvent_Ingest>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<OnorbitEvent_Ingest> CreateOnorbitEvent_Ingest(
    ...
    OnorbitEvent_Ingest_dataMode_Enum dataMode = OnorbitEvent_Ingest_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> createdAt = 0,
    ::flatbuffers::Offset<::flatbuffers::String> createdBy = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  OnorbitEvent_IngestBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<OnorbitEvent_Ingest> CreateOnorbitEvent_IngestDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateOnorbitEvent_Ingest(
      _fbb,
      id__,
...
inline const OnorbitEvent_Ingest *GetOnorbitEvent_Ingest(const void *buf) {
  return ::flatbuffers::GetRoot<OnorbitEvent_Ingest>(buf);
}

inline const OnorbitEvent_Ingest *GetSizePrefixedOnorbitEvent_Ingest(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<OnorbitEvent_Ingest>(buf);
}

inline const char *OnorbitEvent_IngestIdentifier() {
  return "ONOR";
}

inline bool OnorbitEvent_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OnorbitEvent_IngestIdentifier());
}

inline bool SizePrefixedOnorbitEvent_IngestBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, OnorbitEvent_IngestIdentifier(), true);
}

inline bool VerifyOnorbitEvent_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<OnorbitEvent_Ingest>(OnorbitEvent_IngestIdentifier());
}

inline bool VerifySizePrefixedOnorbitEvent_IngestBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<OnorbitEvent_Ingest>(OnorbitEvent_IngestIdentifier());
}

inline void FinishOnorbitEvent_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OnorbitEvent_Ingest> root) {
  fbb.Finish(root, OnorbitEvent_IngestIdentifier());
}

inline void FinishSizePrefixedOnorbitEvent_IngestBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<OnorbitEvent_Ingest> root) {
  fbb.FinishSizePrefixed(root, OnorbitEvent_IngestIdentifier());
}
