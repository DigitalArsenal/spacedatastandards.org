...
struct EffectRequest_Full;
struct EffectRequest_FullBuilder;

enum EffectRequest_Full_dataMode_Enum : int8_t {
  /// Data collected or produced that pertains to real-world objects, events, and analysis.
  EffectRequest_Full_dataMode_Enum_REAL = 0,
  /// Specific datasets used to evaluate compliance with specifications and requirements, and for validating technical, functional, and performance characteristics.
  EffectRequest_Full_dataMode_Enum_TEST = 1,
  /// Synthetic data generated by a model to mimic real-world datasets.
  EffectRequest_Full_dataMode_Enum_SIMULATED = 2,
  /// Data pertaining to a government or military exercise. The data may include both real and simulated data.
  EffectRequest_Full_dataMode_Enum_EXERCISE = 3,
  EffectRequest_Full_dataMode_Enum_MIN = EffectRequest_Full_dataMode_Enum_REAL,
  EffectRequest_Full_dataMode_Enum_MAX = EffectRequest_Full_dataMode_Enum_EXERCISE
};

inline const EffectRequest_Full_dataMode_Enum (&EnumValuesEffectRequest_Full_dataMode_Enum())[4] {
  static const EffectRequest_Full_dataMode_Enum values[] = {
    EffectRequest_Full_dataMode_Enum_REAL,
    EffectRequest_Full_dataMode_Enum_TEST,
    EffectRequest_Full_dataMode_Enum_SIMULATED,
    EffectRequest_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesEffectRequest_Full_dataMode_Enum() {
...
inline const char *EnumNameEffectRequest_Full_dataMode_Enum(EffectRequest_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, EffectRequest_Full_dataMode_Enum_REAL, EffectRequest_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesEffectRequest_Full_dataMode_Enum()[index];
}

/// /// A request for various effects on a target.
struct EffectRequest_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef EffectRequest_FullBuilder Builder;
  ...
  EffectRequest_Full_dataMode_Enum dataMode() const {
    return static_cast<EffectRequest_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct EffectRequest_FullBuilder {
  typedef EffectRequest_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(EffectRequest_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(EffectRequest_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_externalRequestId(::flatbuffers::Offset<::flatbuffers::String> externalRequestId) {
    fbb_.AddOffset(EffectRequest_Full::VT_EXTERNALREQUESTID, externalRequestId);
  }
  void add_effectList(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> effectList) {
    fbb_.AddOffset(EffectRequest_Full::VT_EFFECTLIST, effectList);
  }
  void add_state(::flatbuffers::Offset<::flatbuffers::String> state) {
    fbb_.AddOffset(EffectRequest_Full::VT_STATE, state);
  }
  void add_context(::flatbuffers::Offset<::flatbuffers::String> context) {
    fbb_.AddOffset(EffectRequest_Full::VT_CONTEXT, context);
  }
  void add_startTime(::flatbuffers::Offset<::flatbuffers::String> startTime) {
    fbb_.AddOffset(EffectRequest_Full::VT_STARTTIME, startTime);
  }
  void add_endTime(::flatbuffers::Offset<::flatbuffers::String> endTime) {
    fbb_.AddOffset(EffectRequest_Full::VT_ENDTIME, endTime);
  }
  void add_deadlineType(::flatbuffers::Offset<::flatbuffers::String> deadlineType) {
    fbb_.AddOffset(EffectRequest_Full::VT_DEADLINETYPE, deadlineType);
  }
  void add_targetSrcType(::flatbuffers::Offset<::flatbuffers::String> targetSrcType) {
    fbb_.AddOffset(EffectRequest_Full::VT_TARGETSRCTYPE, targetSrcType);
  }
  void add_targetSrcId(::flatbuffers::Offset<::flatbuffers::String> targetSrcId) {
    fbb_.AddOffset(EffectRequest_Full::VT_TARGETSRCID, targetSrcId);
  }
  void add_priority(::flatbuffers::Offset<::flatbuffers::String> priority) {
    fbb_.AddOffset(EffectRequest_Full::VT_PRIORITY, priority);
  }
  void add_modelClass(::flatbuffers::Offset<::flatbuffers::String> modelClass) {
    fbb_.AddOffset(EffectRequest_Full::VT_MODELCLASS, modelClass);
  }
  void add_metricTypes(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> metricTypes) {
    fbb_.AddOffset(EffectRequest_Full::VT_METRICTYPES, metricTypes);
  }
  void add_metricWeights(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> metricWeights) {
    fbb_.AddOffset(EffectRequest_Full::VT_METRICWEIGHTS, metricWeights);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(EffectRequest_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(EffectRequest_Full::VT_CREATEDBY, createdBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(EffectRequest_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(EffectRequest_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(EffectRequest_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(EffectRequest_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(EffectRequest_Full::VT_ORIGNETWORK, origNetwork);
  }
  explicit EffectRequest_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<EffectRequest_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<EffectRequest_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<EffectRequest_Full> CreateEffectRequest_Full(
    ...
    EffectRequest_Full_dataMode_Enum dataMode = EffectRequest_Full_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  EffectRequest_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<EffectRequest_Full> CreateEffectRequest_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateEffectRequest_Full(
      _fbb,
      id__,
...
inline const EffectRequest_Full *GetEffectRequest_Full(const void *buf) {
  return ::flatbuffers::GetRoot<EffectRequest_Full>(buf);
}

inline const EffectRequest_Full *GetSizePrefixedEffectRequest_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<EffectRequest_Full>(buf);
}

inline const char *EffectRequest_FullIdentifier() {
  return "EFFE";
}

inline bool EffectRequest_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EffectRequest_FullIdentifier());
}

inline bool SizePrefixedEffectRequest_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, EffectRequest_FullIdentifier(), true);
}

inline bool VerifyEffectRequest_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<EffectRequest_Full>(EffectRequest_FullIdentifier());
}

inline bool VerifySizePrefixedEffectRequest_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<EffectRequest_Full>(EffectRequest_FullIdentifier());
}

inline void FinishEffectRequest_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EffectRequest_Full> root) {
  fbb.Finish(root, EffectRequest_FullIdentifier());
}

inline void FinishSizePrefixedEffectRequest_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<EffectRequest_Full> root) {
  fbb.FinishSizePrefixed(root, EffectRequest_FullIdentifier());
}
