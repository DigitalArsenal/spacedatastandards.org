...
struct StarCatalog_Abridged;
struct StarCatalog_AbridgedBuilder;

enum StarCatalog_Abridged_astrometryOrigin_Enum : int8_t {
  ...
  StarCatalog_Abridged_astrometryOrigin_Enum_MIN = StarCatalog_Abridged_astrometryOrigin_Enum_GAIADR3,
  StarCatalog_Abridged_astrometryOrigin_Enum_MAX = StarCatalog_Abridged_astrometryOrigin_Enum_USNOBSC
};

inline const StarCatalog_Abridged_astrometryOrigin_Enum (&EnumValuesStarCatalog_Abridged_astrometryOrigin_Enum())[3] {
  static const StarCatalog_Abridged_astrometryOrigin_Enum values[] = {
    StarCatalog_Abridged_astrometryOrigin_Enum_GAIADR3,
    StarCatalog_Abridged_astrometryOrigin_Enum_HIPPARCOS,
    StarCatalog_Abridged_astrometryOrigin_Enum_USNOBSC
  };
  return values;
}

inline const char * const *EnumNamesStarCatalog_Abridged_astrometryOrigin_Enum() {
...
inline const char *EnumNameStarCatalog_Abridged_astrometryOrigin_Enum(StarCatalog_Abridged_astrometryOrigin_Enum e) {
  if (::flatbuffers::IsOutRange(e, StarCatalog_Abridged_astrometryOrigin_Enum_GAIADR3, StarCatalog_Abridged_astrometryOrigin_Enum_USNOBSC)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesStarCatalog_Abridged_astrometryOrigin_Enum()[index];
}

enum StarCatalog_Abridged_dataMode_Enum : int8_t {
  ...
  StarCatalog_Abridged_dataMode_Enum_MIN = StarCatalog_Abridged_dataMode_Enum_REAL,
  StarCatalog_Abridged_dataMode_Enum_MAX = StarCatalog_Abridged_dataMode_Enum_EXERCISE
};

inline const StarCatalog_Abridged_dataMode_Enum (&EnumValuesStarCatalog_Abridged_dataMode_Enum())[4] {
  static const StarCatalog_Abridged_dataMode_Enum values[] = {
    StarCatalog_Abridged_dataMode_Enum_REAL,
    StarCatalog_Abridged_dataMode_Enum_TEST,
    StarCatalog_Abridged_dataMode_Enum_SIMULATED,
    StarCatalog_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesStarCatalog_Abridged_dataMode_Enum() {
...
inline const char *EnumNameStarCatalog_Abridged_dataMode_Enum(StarCatalog_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, StarCatalog_Abridged_dataMode_Enum_REAL, StarCatalog_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesStarCatalog_Abridged_dataMode_Enum()[index];
}

/// /// The star catalog provides the position, proper motion, parallax, and photometric magnitudes at various bandpasses of a star.
struct StarCatalog_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef StarCatalog_AbridgedBuilder Builder;
  ...
  StarCatalog_Abridged_astrometryOrigin_Enum astrometryOrigin() const {
    return static_cast<StarCatalog_Abridged_astrometryOrigin_Enum>(GetField<int8_t>(VT_ASTROMETRYORIGIN, 0));
  }
  ...
  StarCatalog_Abridged_dataMode_Enum dataMode() const {
    return static_cast<StarCatalog_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct StarCatalog_AbridgedBuilder {
  typedef StarCatalog_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(StarCatalog_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(StarCatalog_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_csId(int64_t csId) {
    fbb_.AddElement<int64_t>(StarCatalog_Abridged::VT_CSID, csId, 0);
  }
  void add_gncCatId(int32_t gncCatId) {
    fbb_.AddElement<int32_t>(StarCatalog_Abridged::VT_GNCCATID, gncCatId, 0);
  }
  void add_gaiadr3CatId(int64_t gaiadr3CatId) {
    fbb_.AddElement<int64_t>(StarCatalog_Abridged::VT_GAIADR3CATID, gaiadr3CatId, 0);
  }
  void add_hipCatId(int32_t hipCatId) {
    fbb_.AddElement<int32_t>(StarCatalog_Abridged::VT_HIPCATID, hipCatId, 0);
  }
  void add_catVersion(::flatbuffers::Offset<::flatbuffers::String> catVersion) {
    fbb_.AddOffset(StarCatalog_Abridged::VT_CATVERSION, catVersion);
  }
  void add_ra(double ra) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_RA, ra, 0.0);
  }
  void add_raUnc(double raUnc) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_RAUNC, raUnc, 0.0);
  }
  void add_dec(double dec) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_DEC, dec, 0.0);
  }
  void add_decUnc(double decUnc) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_DECUNC, decUnc, 0.0);
  }
  void add_posUncFlag(bool posUncFlag) {
    fbb_.AddElement<uint8_t>(StarCatalog_Abridged::VT_POSUNCFLAG, static_cast<uint8_t>(posUncFlag), 0);
  }
  void add_parallax(double parallax) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_PARALLAX, parallax, 0.0);
  }
  void add_parallaxUnc(double parallaxUnc) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_PARALLAXUNC, parallaxUnc, 0.0);
  }
  void add_pmra(double pmra) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_PMRA, pmra, 0.0);
  }
  void add_pmraUnc(double pmraUnc) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_PMRAUNC, pmraUnc, 0.0);
  }
  void add_pmdec(double pmdec) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_PMDEC, pmdec, 0.0);
  }
  void add_pmdecUnc(double pmdecUnc) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_PMDECUNC, pmdecUnc, 0.0);
  }
  void add_pmUncFlag(bool pmUncFlag) {
    fbb_.AddElement<uint8_t>(StarCatalog_Abridged::VT_PMUNCFLAG, static_cast<uint8_t>(pmUncFlag), 0);
  }
  void add_astrometryOrigin(StarCatalog_Abridged_astrometryOrigin_Enum astrometryOrigin) {
    fbb_.AddElement<int8_t>(StarCatalog_Abridged::VT_ASTROMETRYORIGIN, static_cast<int8_t>(astrometryOrigin), 0);
  }
  void add_starEpoch(double starEpoch) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_STAREPOCH, starEpoch, 0.0);
  }
  void add_gmag(double gmag) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_GMAG, gmag, 0.0);
  }
  void add_gmagUnc(double gmagUnc) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_GMAGUNC, gmagUnc, 0.0);
  }
  void add_bpmag(double bpmag) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_BPMAG, bpmag, 0.0);
  }
  void add_bpmagUnc(double bpmagUnc) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_BPMAGUNC, bpmagUnc, 0.0);
  }
  void add_rpmag(double rpmag) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_RPMAG, rpmag, 0.0);
  }
  void add_rpmagUnc(double rpmagUnc) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_RPMAGUNC, rpmagUnc, 0.0);
  }
  void add_jmag(double jmag) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_JMAG, jmag, 0.0);
  }
  void add_jmagUnc(double jmagUnc) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_JMAGUNC, jmagUnc, 0.0);
  }
  void add_kmag(double kmag) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_KMAG, kmag, 0.0);
  }
  void add_kmagUnc(double kmagUnc) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_KMAGUNC, kmagUnc, 0.0);
  }
  void add_hmag(double hmag) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_HMAG, hmag, 0.0);
  }
  void add_hmagUnc(double hmagUnc) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_HMAGUNC, hmagUnc, 0.0);
  }
  void add_varFlag(bool varFlag) {
    fbb_.AddElement<uint8_t>(StarCatalog_Abridged::VT_VARFLAG, static_cast<uint8_t>(varFlag), 0);
  }
  void add_multFlag(bool multFlag) {
    fbb_.AddElement<uint8_t>(StarCatalog_Abridged::VT_MULTFLAG, static_cast<uint8_t>(multFlag), 0);
  }
  void add_neighborId(int32_t neighborId) {
    fbb_.AddElement<int32_t>(StarCatalog_Abridged::VT_NEIGHBORID, neighborId, 0);
  }
  void add_neighborFlag(bool neighborFlag) {
    fbb_.AddElement<uint8_t>(StarCatalog_Abridged::VT_NEIGHBORFLAG, static_cast<uint8_t>(neighborFlag), 0);
  }
  void add_neighborDistance(double neighborDistance) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_NEIGHBORDISTANCE, neighborDistance, 0.0);
  }
  void add_shiftFlag(bool shiftFlag) {
    fbb_.AddElement<uint8_t>(StarCatalog_Abridged::VT_SHIFTFLAG, static_cast<uint8_t>(shiftFlag), 0);
  }
  void add_shift(double shift) {
    fbb_.AddElement<double>(StarCatalog_Abridged::VT_SHIFT, shift, 0.0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(StarCatalog_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(StarCatalog_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(StarCatalog_Abridged::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(StarCatalog_Abridged::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(StarCatalog_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(StarCatalog_Abridged::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(StarCatalog_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(StarCatalog_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(StarCatalog_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  explicit StarCatalog_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<StarCatalog_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<StarCatalog_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<StarCatalog_Abridged> CreateStarCatalog_Abridged(
    ...
    StarCatalog_Abridged_astrometryOrigin_Enum astrometryOrigin = StarCatalog_Abridged_astrometryOrigin_Enum_GAIADR3,
    ...
    StarCatalog_Abridged_dataMode_Enum dataMode = StarCatalog_Abridged_dataMode_Enum_REAL) {
  StarCatalog_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<StarCatalog_Abridged> CreateStarCatalog_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateStarCatalog_Abridged(
      _fbb,
      id__,
...
inline const StarCatalog_Abridged *GetStarCatalog_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<StarCatalog_Abridged>(buf);
}

inline const StarCatalog_Abridged *GetSizePrefixedStarCatalog_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<StarCatalog_Abridged>(buf);
}

inline const char *StarCatalog_AbridgedIdentifier() {
  return "STAR";
}

inline bool StarCatalog_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, StarCatalog_AbridgedIdentifier());
}

inline bool SizePrefixedStarCatalog_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, StarCatalog_AbridgedIdentifier(), true);
}

inline bool VerifyStarCatalog_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<StarCatalog_Abridged>(StarCatalog_AbridgedIdentifier());
}

inline bool VerifySizePrefixedStarCatalog_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<StarCatalog_Abridged>(StarCatalog_AbridgedIdentifier());
}

inline void FinishStarCatalog_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<StarCatalog_Abridged> root) {
  fbb.Finish(root, StarCatalog_AbridgedIdentifier());
}

inline void FinishSizePrefixedStarCatalog_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<StarCatalog_Abridged> root) {
  fbb.FinishSizePrefixed(root, StarCatalog_AbridgedIdentifier());
}
