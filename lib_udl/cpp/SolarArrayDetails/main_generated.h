...
struct SolarArrayDetails;
struct SolarArrayDetailsBuilder;

enum SolarArrayDetails_dataMode_Enum : int8_t {
  ...
  SolarArrayDetails_dataMode_Enum_MIN = SolarArrayDetails_dataMode_Enum_REAL,
  SolarArrayDetails_dataMode_Enum_MAX = SolarArrayDetails_dataMode_Enum_EXERCISE
};

inline const SolarArrayDetails_dataMode_Enum (&EnumValuesSolarArrayDetails_dataMode_Enum())[4] {
  static const SolarArrayDetails_dataMode_Enum values[] = {
    SolarArrayDetails_dataMode_Enum_REAL,
    SolarArrayDetails_dataMode_Enum_TEST,
    SolarArrayDetails_dataMode_Enum_SIMULATED,
    SolarArrayDetails_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesSolarArrayDetails_dataMode_Enum() {
...
inline const char *EnumNameSolarArrayDetails_dataMode_Enum(SolarArrayDetails_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, SolarArrayDetails_dataMode_Enum_REAL, SolarArrayDetails_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesSolarArrayDetails_dataMode_Enum()[index];
}
...
struct SolarArrayDetails FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef SolarArrayDetailsBuilder Builder;
  ...
  /// Constraints: Minimum length = 1, Maximum length = 32
  SolarArrayDetails_dataMode_Enum dataMode() const {
    return static_cast<SolarArrayDetails_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct SolarArrayDetailsBuilder {
  typedef SolarArrayDetails Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(SolarArrayDetails::VT_ID, id);
  }
  void add_idSolarArray(::flatbuffers::Offset<::flatbuffers::String> idSolarArray) {
    fbb_.AddOffset(SolarArrayDetails::VT_IDSOLARARRAY, idSolarArray);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(SolarArrayDetails::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(SolarArrayDetails::VT_TYPE, type);
  }
  void add_technology(::flatbuffers::Offset<::flatbuffers::String> technology) {
    fbb_.AddOffset(SolarArrayDetails::VT_TECHNOLOGY, technology);
  }
  void add_junctionTechnology(::flatbuffers::Offset<::flatbuffers::String> junctionTechnology) {
    fbb_.AddOffset(SolarArrayDetails::VT_JUNCTIONTECHNOLOGY, junctionTechnology);
  }
  void add_manufacturerOrgId(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrgId) {
    fbb_.AddOffset(SolarArrayDetails::VT_MANUFACTURERORGID, manufacturerOrgId);
  }
  void add_span(double span) {
    fbb_.AddElement<double>(SolarArrayDetails::VT_SPAN, span, 0.0);
  }
  void add_area(double area) {
    fbb_.AddElement<double>(SolarArrayDetails::VT_AREA, area, 0.0);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(SolarArrayDetails::VT_DESCRIPTION, description);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(SolarArrayDetails::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(SolarArrayDetails::VT_CREATEDBY, createdBy);
  }
  void add_updatedAt(::flatbuffers::Offset<::flatbuffers::String> updatedAt) {
    fbb_.AddOffset(SolarArrayDetails::VT_UPDATEDAT, updatedAt);
  }
  void add_updatedBy(::flatbuffers::Offset<::flatbuffers::String> updatedBy) {
    fbb_.AddOffset(SolarArrayDetails::VT_UPDATEDBY, updatedBy);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(SolarArrayDetails::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(SolarArrayDetails::VT_ORIGIN, origin);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(SolarArrayDetails::VT_ORIGNETWORK, origNetwork);
  }
  void add_dataMode(SolarArrayDetails_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(SolarArrayDetails::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(SolarArrayDetails::VT_TAGS, tags);
  }
  void add_manufacturerOrg(::flatbuffers::Offset<::flatbuffers::String> manufacturerOrg) {
    fbb_.AddOffset(SolarArrayDetails::VT_MANUFACTURERORG, manufacturerOrg);
  }
  explicit SolarArrayDetailsBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<SolarArrayDetails> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<SolarArrayDetails>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<SolarArrayDetails> CreateSolarArrayDetails(
    ...
    SolarArrayDetails_dataMode_Enum dataMode = SolarArrayDetails_dataMode_Enum_REAL,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags = 0,
    ::flatbuffers::Offset<::flatbuffers::String> manufacturerOrg = 0) {
  SolarArrayDetailsBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<SolarArrayDetails> CreateSolarArrayDetailsDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const SolarArrayDetails *GetSolarArrayDetails(const void *buf) {
  return ::flatbuffers::GetRoot<SolarArrayDetails>(buf);
}

inline const SolarArrayDetails *GetSizePrefixedSolarArrayDetails(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<SolarArrayDetails>(buf);
}

inline const char *SolarArrayDetailsIdentifier() {
  return "SOLA";
}

inline bool SolarArrayDetailsBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SolarArrayDetailsIdentifier());
}

inline bool SizePrefixedSolarArrayDetailsBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, SolarArrayDetailsIdentifier(), true);
}

inline bool VerifySolarArrayDetailsBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<SolarArrayDetails>(SolarArrayDetailsIdentifier());
}

inline bool VerifySizePrefixedSolarArrayDetailsBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<SolarArrayDetails>(SolarArrayDetailsIdentifier());
}

inline void FinishSolarArrayDetailsBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SolarArrayDetails> root) {
  fbb.Finish(root, SolarArrayDetailsIdentifier());
}

inline void FinishSizePrefixedSolarArrayDetailsBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<SolarArrayDetails> root) {
  fbb.FinishSizePrefixed(root, SolarArrayDetailsIdentifier());
}
