...
struct Conjunction_Abridged;
struct Conjunction_AbridgedBuilder;

enum Conjunction_Abridged_dataMode_Enum : int8_t {
  ...
  Conjunction_Abridged_dataMode_Enum_MIN = Conjunction_Abridged_dataMode_Enum_REAL,
  Conjunction_Abridged_dataMode_Enum_MAX = Conjunction_Abridged_dataMode_Enum_EXERCISE
};

inline const Conjunction_Abridged_dataMode_Enum (&EnumValuesConjunction_Abridged_dataMode_Enum())[4] {
  static const Conjunction_Abridged_dataMode_Enum values[] = {
    Conjunction_Abridged_dataMode_Enum_REAL,
    Conjunction_Abridged_dataMode_Enum_TEST,
    Conjunction_Abridged_dataMode_Enum_SIMULATED,
    Conjunction_Abridged_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesConjunction_Abridged_dataMode_Enum() {
...
inline const char *EnumNameConjunction_Abridged_dataMode_Enum(Conjunction_Abridged_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Conjunction_Abridged_dataMode_Enum_REAL, Conjunction_Abridged_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesConjunction_Abridged_dataMode_Enum()[index];
}

/// /// Stores the results of a particular Conjunction Assessment (CA) run.
struct Conjunction_Abridged FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Conjunction_AbridgedBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_SATNO1 = 130,
    VT_SATNO2 = 132,
    VT_ORIGIDONORBIT1 = 134,
    VT_ORIGIDONORBIT2 = 136,
    VT_ORIGNETWORK = 138
  };
  ...
  Conjunction_Abridged_dataMode_Enum dataMode() const {
    return static_cast<Conjunction_Abridged_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
...
struct Conjunction_AbridgedBuilder {
  typedef Conjunction_Abridged Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Conjunction_Abridged::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Conjunction_Abridged::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_idOnOrbit1(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit1) {
    fbb_.AddOffset(Conjunction_Abridged::VT_IDONORBIT1, idOnOrbit1);
  }
  void add_idOnOrbit2(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit2) {
    fbb_.AddOffset(Conjunction_Abridged::VT_IDONORBIT2, idOnOrbit2);
  }
  void add_type(::flatbuffers::Offset<::flatbuffers::String> type) {
    fbb_.AddOffset(Conjunction_Abridged::VT_TYPE, type);
  }
  void add_tca(::flatbuffers::Offset<::flatbuffers::String> tca) {
    fbb_.AddOffset(Conjunction_Abridged::VT_TCA, tca);
  }
  void add_missDistance(double missDistance) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_MISSDISTANCE, missDistance, 0.0);
  }
  void add_collisionProb(double collisionProb) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_COLLISIONPROB, collisionProb, 0.0);
  }
  void add_collisionProbMethod(::flatbuffers::Offset<::flatbuffers::String> collisionProbMethod) {
    fbb_.AddOffset(Conjunction_Abridged::VT_COLLISIONPROBMETHOD, collisionProbMethod);
  }
  void add_ephemName1(::flatbuffers::Offset<::flatbuffers::String> ephemName1) {
    fbb_.AddOffset(Conjunction_Abridged::VT_EPHEMNAME1, ephemName1);
  }
  void add_esId1(::flatbuffers::Offset<::flatbuffers::String> esId1) {
    fbb_.AddOffset(Conjunction_Abridged::VT_ESID1, esId1);
  }
  void add_ephemName2(::flatbuffers::Offset<::flatbuffers::String> ephemName2) {
    fbb_.AddOffset(Conjunction_Abridged::VT_EPHEMNAME2, ephemName2);
  }
  void add_esId2(::flatbuffers::Offset<::flatbuffers::String> esId2) {
    fbb_.AddOffset(Conjunction_Abridged::VT_ESID2, esId2);
  }
  void add_relPosR(double relPosR) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_RELPOSR, relPosR, 0.0);
  }
  void add_relPosT(double relPosT) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_RELPOST, relPosT, 0.0);
  }
  void add_relPosN(double relPosN) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_RELPOSN, relPosN, 0.0);
  }
  void add_relVelMag(double relVelMag) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_RELVELMAG, relVelMag, 0.0);
  }
  void add_relVelR(double relVelR) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_RELVELR, relVelR, 0.0);
  }
  void add_relVelT(double relVelT) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_RELVELT, relVelT, 0.0);
  }
  void add_relVelN(double relVelN) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_RELVELN, relVelN, 0.0);
  }
  void add_screenEntryTime(::flatbuffers::Offset<::flatbuffers::String> screenEntryTime) {
    fbb_.AddOffset(Conjunction_Abridged::VT_SCREENENTRYTIME, screenEntryTime);
  }
  void add_screenExitTime(::flatbuffers::Offset<::flatbuffers::String> screenExitTime) {
    fbb_.AddOffset(Conjunction_Abridged::VT_SCREENEXITTIME, screenExitTime);
  }
  void add_screenVolumeX(double screenVolumeX) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_SCREENVOLUMEX, screenVolumeX, 0.0);
  }
  void add_screenVolumeY(double screenVolumeY) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_SCREENVOLUMEY, screenVolumeY, 0.0);
  }
  void add_screenVolumeZ(double screenVolumeZ) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_SCREENVOLUMEZ, screenVolumeZ, 0.0);
  }
  void add_volShape(::flatbuffers::Offset<::flatbuffers::String> volShape) {
    fbb_.AddOffset(Conjunction_Abridged::VT_VOLSHAPE, volShape);
  }
  void add_volEntryTime(::flatbuffers::Offset<::flatbuffers::String> volEntryTime) {
    fbb_.AddOffset(Conjunction_Abridged::VT_VOLENTRYTIME, volEntryTime);
  }
  void add_volExitTime(::flatbuffers::Offset<::flatbuffers::String> volExitTime) {
    fbb_.AddOffset(Conjunction_Abridged::VT_VOLEXITTIME, volExitTime);
  }
  void add_penetrationLevelSigma(double penetrationLevelSigma) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_PENETRATIONLEVELSIGMA, penetrationLevelSigma, 0.0);
  }
  void add_idStateVector1(::flatbuffers::Offset<::flatbuffers::String> idStateVector1) {
    fbb_.AddOffset(Conjunction_Abridged::VT_IDSTATEVECTOR1, idStateVector1);
  }
  void add_lastObTime1(::flatbuffers::Offset<::flatbuffers::String> lastObTime1) {
    fbb_.AddOffset(Conjunction_Abridged::VT_LASTOBTIME1, lastObTime1);
  }
  void add_cdAoM1(double cdAoM1) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_CDAOM1, cdAoM1, 0.0);
  }
  void add_crAoM1(double crAoM1) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_CRAOM1, crAoM1, 0.0);
  }
  void add_thrustAccel1(double thrustAccel1) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_THRUSTACCEL1, thrustAccel1, 0.0);
  }
  void add_idStateVector2(::flatbuffers::Offset<::flatbuffers::String> idStateVector2) {
    fbb_.AddOffset(Conjunction_Abridged::VT_IDSTATEVECTOR2, idStateVector2);
  }
  void add_lastObTime2(::flatbuffers::Offset<::flatbuffers::String> lastObTime2) {
    fbb_.AddOffset(Conjunction_Abridged::VT_LASTOBTIME2, lastObTime2);
  }
  void add_cdAoM2(double cdAoM2) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_CDAOM2, cdAoM2, 0.0);
  }
  void add_crAoM2(double crAoM2) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_CRAOM2, crAoM2, 0.0);
  }
  void add_thrustAccel2(double thrustAccel2) {
    fbb_.AddElement<double>(Conjunction_Abridged::VT_THRUSTACCEL2, thrustAccel2, 0.0);
  }
  void add_comments(::flatbuffers::Offset<::flatbuffers::String> comments) {
    fbb_.AddOffset(Conjunction_Abridged::VT_COMMENTS, comments);
  }
  void add_ccir(::flatbuffers::Offset<::flatbuffers::String> ccir) {
    fbb_.AddOffset(Conjunction_Abridged::VT_CCIR, ccir);
  }
  void add_concernNotes(::flatbuffers::Offset<::flatbuffers::String> concernNotes) {
    fbb_.AddOffset(Conjunction_Abridged::VT_CONCERNNOTES, concernNotes);
  }
  void add_stateDeptNotified(bool stateDeptNotified) {
    fbb_.AddElement<uint8_t>(Conjunction_Abridged::VT_STATEDEPTNOTIFIED, static_cast<uint8_t>(stateDeptNotified), 0);
  }
  void add_ownerContacted(bool ownerContacted) {
    fbb_.AddElement<uint8_t>(Conjunction_Abridged::VT_OWNERCONTACTED, static_cast<uint8_t>(ownerContacted), 0);
  }
  void add_rawFileURI(::flatbuffers::Offset<::flatbuffers::String> rawFileURI) {
    fbb_.AddOffset(Conjunction_Abridged::VT_RAWFILEURI, rawFileURI);
  }
  void add_messageFor(::flatbuffers::Offset<::flatbuffers::String> messageFor) {
    fbb_.AddOffset(Conjunction_Abridged::VT_MESSAGEFOR, messageFor);
  }
  void add_messageId(::flatbuffers::Offset<::flatbuffers::String> messageId) {
    fbb_.AddOffset(Conjunction_Abridged::VT_MESSAGEID, messageId);
  }
  void add_uvwWarn(bool uvwWarn) {
    fbb_.AddElement<uint8_t>(Conjunction_Abridged::VT_UVWWARN, static_cast<uint8_t>(uvwWarn), 0);
  }
  void add_smallRelVelWarning(bool smallRelVelWarning) {
    fbb_.AddElement<uint8_t>(Conjunction_Abridged::VT_SMALLRELVELWARNING, static_cast<uint8_t>(smallRelVelWarning), 0);
  }
  void add_largeRelPosWarning(bool largeRelPosWarning) {
    fbb_.AddElement<uint8_t>(Conjunction_Abridged::VT_LARGERELPOSWARNING, static_cast<uint8_t>(largeRelPosWarning), 0);
  }
  void add_smallCovWarning(bool smallCovWarning) {
    fbb_.AddElement<uint8_t>(Conjunction_Abridged::VT_SMALLCOVWARNING, static_cast<uint8_t>(smallCovWarning), 0);
  }
  void add_largeCovWarning(bool largeCovWarning) {
    fbb_.AddElement<uint8_t>(Conjunction_Abridged::VT_LARGECOVWARNING, static_cast<uint8_t>(largeCovWarning), 0);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(Conjunction_Abridged::VT_TRANSACTIONID, transactionId);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Conjunction_Abridged::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Conjunction_Abridged::VT_ORIGIN, origin);
  }
  void add_originator(::flatbuffers::Offset<::flatbuffers::String> originator) {
    fbb_.AddOffset(Conjunction_Abridged::VT_ORIGINATOR, originator);
  }
  void add_eventId(::flatbuffers::Offset<::flatbuffers::String> eventId) {
    fbb_.AddOffset(Conjunction_Abridged::VT_EVENTID, eventId);
  }
  void add_descriptor(::flatbuffers::Offset<::flatbuffers::String> descriptor) {
    fbb_.AddOffset(Conjunction_Abridged::VT_DESCRIPTOR, descriptor);
  }
  void add_dataMode(Conjunction_Abridged_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Conjunction_Abridged::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Conjunction_Abridged::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Conjunction_Abridged::VT_CREATEDBY, createdBy);
  }
  void add_stateVector1(::flatbuffers::Offset<::flatbuffers::String> stateVector1) {
    fbb_.AddOffset(Conjunction_Abridged::VT_STATEVECTOR1, stateVector1);
  }
  void add_stateVector2(::flatbuffers::Offset<::flatbuffers::String> stateVector2) {
    fbb_.AddOffset(Conjunction_Abridged::VT_STATEVECTOR2, stateVector2);
  }
  void add_satNo1(int32_t satNo1) {
    fbb_.AddElement<int32_t>(Conjunction_Abridged::VT_SATNO1, satNo1, 0);
  }
  void add_satNo2(int32_t satNo2) {
    fbb_.AddElement<int32_t>(Conjunction_Abridged::VT_SATNO2, satNo2, 0);
  }
  void add_origIdOnOrbit1(::flatbuffers::Offset<::flatbuffers::String> origIdOnOrbit1) {
    fbb_.AddOffset(Conjunction_Abridged::VT_ORIGIDONORBIT1, origIdOnOrbit1);
  }
  void add_origIdOnOrbit2(::flatbuffers::Offset<::flatbuffers::String> origIdOnOrbit2) {
    fbb_.AddOffset(Conjunction_Abridged::VT_ORIGIDONORBIT2, origIdOnOrbit2);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Conjunction_Abridged::VT_ORIGNETWORK, origNetwork);
  }
  explicit Conjunction_AbridgedBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Conjunction_Abridged> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Conjunction_Abridged>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Conjunction_Abridged> CreateConjunction_Abridged(
    ...
    Conjunction_Abridged_dataMode_Enum dataMode = Conjunction_Abridged_dataMode_Enum_REAL,
  ...
  Conjunction_AbridgedBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Conjunction_Abridged> CreateConjunction_AbridgedDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return CreateConjunction_Abridged(
      _fbb,
      id__,
...
inline const Conjunction_Abridged *GetConjunction_Abridged(const void *buf) {
  return ::flatbuffers::GetRoot<Conjunction_Abridged>(buf);
}

inline const Conjunction_Abridged *GetSizePrefixedConjunction_Abridged(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Conjunction_Abridged>(buf);
}

inline const char *Conjunction_AbridgedIdentifier() {
  return "CONJ";
}

inline bool Conjunction_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Conjunction_AbridgedIdentifier());
}

inline bool SizePrefixedConjunction_AbridgedBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Conjunction_AbridgedIdentifier(), true);
}

inline bool VerifyConjunction_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Conjunction_Abridged>(Conjunction_AbridgedIdentifier());
}

inline bool VerifySizePrefixedConjunction_AbridgedBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Conjunction_Abridged>(Conjunction_AbridgedIdentifier());
}

inline void FinishConjunction_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Conjunction_Abridged> root) {
  fbb.Finish(root, Conjunction_AbridgedIdentifier());
}

inline void FinishSizePrefixedConjunction_AbridgedBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Conjunction_Abridged> root) {
  fbb.FinishSizePrefixed(root, Conjunction_AbridgedIdentifier());
}
