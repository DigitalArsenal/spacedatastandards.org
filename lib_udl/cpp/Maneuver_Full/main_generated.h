...
struct Maneuver_Full;
struct Maneuver_FullBuilder;

enum Maneuver_Full_dataMode_Enum : int8_t {
  ...
  Maneuver_Full_dataMode_Enum_MIN = Maneuver_Full_dataMode_Enum_REAL,
  Maneuver_Full_dataMode_Enum_MAX = Maneuver_Full_dataMode_Enum_EXERCISE
};

inline const Maneuver_Full_dataMode_Enum (&EnumValuesManeuver_Full_dataMode_Enum())[4] {
  static const Maneuver_Full_dataMode_Enum values[] = {
    Maneuver_Full_dataMode_Enum_REAL,
    Maneuver_Full_dataMode_Enum_TEST,
    Maneuver_Full_dataMode_Enum_SIMULATED,
    Maneuver_Full_dataMode_Enum_EXERCISE
  };
  return values;
}

inline const char * const *EnumNamesManeuver_Full_dataMode_Enum() {
...
inline const char *EnumNameManeuver_Full_dataMode_Enum(Maneuver_Full_dataMode_Enum e) {
  if (::flatbuffers::IsOutRange(e, Maneuver_Full_dataMode_Enum_REAL, Maneuver_Full_dataMode_Enum_EXERCISE)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesManeuver_Full_dataMode_Enum()[index];
}

enum Maneuver_Full_sourcedDataTypes_Enum : int8_t {
  ...
  Maneuver_Full_sourcedDataTypes_Enum_MIN = Maneuver_Full_sourcedDataTypes_Enum_EO,
  Maneuver_Full_sourcedDataTypes_Enum_MAX = Maneuver_Full_sourcedDataTypes_Enum_SV
};

inline const Maneuver_Full_sourcedDataTypes_Enum (&EnumValuesManeuver_Full_sourcedDataTypes_Enum())[6] {
  static const Maneuver_Full_sourcedDataTypes_Enum values[] = {
    Maneuver_Full_sourcedDataTypes_Enum_EO,
    Maneuver_Full_sourcedDataTypes_Enum_RADAR,
    Maneuver_Full_sourcedDataTypes_Enum_RF,
    Maneuver_Full_sourcedDataTypes_Enum_DOA,
    Maneuver_Full_sourcedDataTypes_Enum_ELSET,
    Maneuver_Full_sourcedDataTypes_Enum_SV
  };
  return values;
}

inline const char * const *EnumNamesManeuver_Full_sourcedDataTypes_Enum() {
...
inline const char *EnumNameManeuver_Full_sourcedDataTypes_Enum(Maneuver_Full_sourcedDataTypes_Enum e) {
  if (::flatbuffers::IsOutRange(e, Maneuver_Full_sourcedDataTypes_Enum_EO, Maneuver_Full_sourcedDataTypes_Enum_SV)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesManeuver_Full_sourcedDataTypes_Enum()[index];
}

/// /// Model representation of on-orbit object maneuver information for detected, possible, and confirmed maneuvers.
struct Maneuver_Full FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef Maneuver_FullBuilder Builder;
  ...
  Maneuver_Full_dataMode_Enum dataMode() const {
    return static_cast<Maneuver_Full_dataMode_Enum>(GetField<int8_t>(VT_DATAMODE, 0));
  }
  ...
  /// Constraints: No constraints specified.
  Maneuver_Full_sourcedDataTypes_Enum sourcedDataTypes() const {
    return static_cast<Maneuver_Full_sourcedDataTypes_Enum>(GetField<int8_t>(VT_SOURCEDDATATYPES, 0));
  }
  /// No description provided.
  /// Example: /// Example: No example provided.
  /// Constraints: No constraints specified.
...
struct Maneuver_FullBuilder {
  typedef Maneuver_Full Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_id(::flatbuffers::Offset<::flatbuffers::String> id) {
    fbb_.AddOffset(Maneuver_Full::VT_ID, id);
  }
  void add_classificationMarking(::flatbuffers::Offset<::flatbuffers::String> classificationMarking) {
    fbb_.AddOffset(Maneuver_Full::VT_CLASSIFICATIONMARKING, classificationMarking);
  }
  void add_satNo(int32_t satNo) {
    fbb_.AddElement<int32_t>(Maneuver_Full::VT_SATNO, satNo, 0);
  }
  void add_reportTime(::flatbuffers::Offset<::flatbuffers::String> reportTime) {
    fbb_.AddOffset(Maneuver_Full::VT_REPORTTIME, reportTime);
  }
  void add_eventStartTime(::flatbuffers::Offset<::flatbuffers::String> eventStartTime) {
    fbb_.AddOffset(Maneuver_Full::VT_EVENTSTARTTIME, eventStartTime);
  }
  void add_eventEndTime(::flatbuffers::Offset<::flatbuffers::String> eventEndTime) {
    fbb_.AddOffset(Maneuver_Full::VT_EVENTENDTIME, eventEndTime);
  }
  void add_totalBurnTime(double totalBurnTime) {
    fbb_.AddElement<double>(Maneuver_Full::VT_TOTALBURNTIME, totalBurnTime, 0.0);
  }
  void add_odFitEndTime(::flatbuffers::Offset<::flatbuffers::String> odFitEndTime) {
    fbb_.AddOffset(Maneuver_Full::VT_ODFITENDTIME, odFitEndTime);
  }
  void add_idOnOrbit(::flatbuffers::Offset<::flatbuffers::String> idOnOrbit) {
    fbb_.AddOffset(Maneuver_Full::VT_IDONORBIT, idOnOrbit);
  }
  void add_idSensor(::flatbuffers::Offset<::flatbuffers::String> idSensor) {
    fbb_.AddOffset(Maneuver_Full::VT_IDSENSOR, idSensor);
  }
  void add_uct(bool uct) {
    fbb_.AddElement<uint8_t>(Maneuver_Full::VT_UCT, static_cast<uint8_t>(uct), 0);
  }
  void add_maneuverUnc(double maneuverUnc) {
    fbb_.AddElement<double>(Maneuver_Full::VT_MANEUVERUNC, maneuverUnc, 0.0);
  }
  void add_characterization(::flatbuffers::Offset<::flatbuffers::String> characterization) {
    fbb_.AddOffset(Maneuver_Full::VT_CHARACTERIZATION, characterization);
  }
  void add_characterizationUnc(double characterizationUnc) {
    fbb_.AddElement<double>(Maneuver_Full::VT_CHARACTERIZATIONUNC, characterizationUnc, 0.0);
  }
  void add_eventId(::flatbuffers::Offset<::flatbuffers::String> eventId) {
    fbb_.AddOffset(Maneuver_Full::VT_EVENTID, eventId);
  }
  void add_origObjectId(::flatbuffers::Offset<::flatbuffers::String> origObjectId) {
    fbb_.AddOffset(Maneuver_Full::VT_ORIGOBJECTID, origObjectId);
  }
  void add_origSensorId(::flatbuffers::Offset<::flatbuffers::String> origSensorId) {
    fbb_.AddOffset(Maneuver_Full::VT_ORIGSENSORID, origSensorId);
  }
  void add_status(::flatbuffers::Offset<::flatbuffers::String> status) {
    fbb_.AddOffset(Maneuver_Full::VT_STATUS, status);
  }
  void add_deltaPos(double deltaPos) {
    fbb_.AddElement<double>(Maneuver_Full::VT_DELTAPOS, deltaPos, 0.0);
  }
  void add_deltaPosU(double deltaPosU) {
    fbb_.AddElement<double>(Maneuver_Full::VT_DELTAPOSU, deltaPosU, 0.0);
  }
  void add_deltaPosV(double deltaPosV) {
    fbb_.AddElement<double>(Maneuver_Full::VT_DELTAPOSV, deltaPosV, 0.0);
  }
  void add_deltaPosW(double deltaPosW) {
    fbb_.AddElement<double>(Maneuver_Full::VT_DELTAPOSW, deltaPosW, 0.0);
  }
  void add_deltaVel(double deltaVel) {
    fbb_.AddElement<double>(Maneuver_Full::VT_DELTAVEL, deltaVel, 0.0);
  }
  void add_deltaVelU(double deltaVelU) {
    fbb_.AddElement<double>(Maneuver_Full::VT_DELTAVELU, deltaVelU, 0.0);
  }
  void add_deltaVelV(double deltaVelV) {
    fbb_.AddElement<double>(Maneuver_Full::VT_DELTAVELV, deltaVelV, 0.0);
  }
  void add_deltaVelW(double deltaVelW) {
    fbb_.AddElement<double>(Maneuver_Full::VT_DELTAVELW, deltaVelW, 0.0);
  }
  void add_deltaMass(double deltaMass) {
    fbb_.AddElement<double>(Maneuver_Full::VT_DELTAMASS, deltaMass, 0.0);
  }
  void add_preEventIdElset(::flatbuffers::Offset<::flatbuffers::String> preEventIdElset) {
    fbb_.AddOffset(Maneuver_Full::VT_PREEVENTIDELSET, preEventIdElset);
  }
  void add_preEventElset(::flatbuffers::Offset<::flatbuffers::String> preEventElset) {
    fbb_.AddOffset(Maneuver_Full::VT_PREEVENTELSET, preEventElset);
  }
  void add_preEventIdStateVector(::flatbuffers::Offset<::flatbuffers::String> preEventIdStateVector) {
    fbb_.AddOffset(Maneuver_Full::VT_PREEVENTIDSTATEVECTOR, preEventIdStateVector);
  }
  void add_preEventStateVector(::flatbuffers::Offset<::flatbuffers::String> preEventStateVector) {
    fbb_.AddOffset(Maneuver_Full::VT_PREEVENTSTATEVECTOR, preEventStateVector);
  }
  void add_prePosX(double prePosX) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PREPOSX, prePosX, 0.0);
  }
  void add_prePosY(double prePosY) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PREPOSY, prePosY, 0.0);
  }
  void add_prePosZ(double prePosZ) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PREPOSZ, prePosZ, 0.0);
  }
  void add_preVelX(double preVelX) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PREVELX, preVelX, 0.0);
  }
  void add_preVelY(double preVelY) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PREVELY, preVelY, 0.0);
  }
  void add_preVelZ(double preVelZ) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PREVELZ, preVelZ, 0.0);
  }
  void add_preRadiationPressCoeff(double preRadiationPressCoeff) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PRERADIATIONPRESSCOEFF, preRadiationPressCoeff, 0.0);
  }
  void add_preBallisticCoeff(double preBallisticCoeff) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PREBALLISTICCOEFF, preBallisticCoeff, 0.0);
  }
  void add_preApogee(double preApogee) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PREAPOGEE, preApogee, 0.0);
  }
  void add_prePerigee(double prePerigee) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PREPERIGEE, prePerigee, 0.0);
  }
  void add_preInclination(double preInclination) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PREINCLINATION, preInclination, 0.0);
  }
  void add_preEccentricity(double preEccentricity) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PREECCENTRICITY, preEccentricity, 0.0);
  }
  void add_prePeriod(double prePeriod) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PREPERIOD, prePeriod, 0.0);
  }
  void add_preRAAN(double preRAAN) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PRERAAN, preRAAN, 0.0);
  }
  void add_preSMA(double preSMA) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PRESMA, preSMA, 0.0);
  }
  void add_preGeoLongitude(double preGeoLongitude) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PREGEOLONGITUDE, preGeoLongitude, 0.0);
  }
  void add_preDriftRate(double preDriftRate) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PREDRIFTRATE, preDriftRate, 0.0);
  }
  void add_preSigmaU(double preSigmaU) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PRESIGMAU, preSigmaU, 0.0);
  }
  void add_preSigmaV(double preSigmaV) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PRESIGMAV, preSigmaV, 0.0);
  }
  void add_preSigmaW(double preSigmaW) {
    fbb_.AddElement<double>(Maneuver_Full::VT_PRESIGMAW, preSigmaW, 0.0);
  }
  void add_postEventIdElset(::flatbuffers::Offset<::flatbuffers::String> postEventIdElset) {
    fbb_.AddOffset(Maneuver_Full::VT_POSTEVENTIDELSET, postEventIdElset);
  }
  void add_postEventElset(::flatbuffers::Offset<::flatbuffers::String> postEventElset) {
    fbb_.AddOffset(Maneuver_Full::VT_POSTEVENTELSET, postEventElset);
  }
  void add_postEventIdStateVector(::flatbuffers::Offset<::flatbuffers::String> postEventIdStateVector) {
    fbb_.AddOffset(Maneuver_Full::VT_POSTEVENTIDSTATEVECTOR, postEventIdStateVector);
  }
  void add_postEventStateVector(::flatbuffers::Offset<::flatbuffers::String> postEventStateVector) {
    fbb_.AddOffset(Maneuver_Full::VT_POSTEVENTSTATEVECTOR, postEventStateVector);
  }
  void add_postPosX(double postPosX) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTPOSX, postPosX, 0.0);
  }
  void add_postPosY(double postPosY) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTPOSY, postPosY, 0.0);
  }
  void add_postPosZ(double postPosZ) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTPOSZ, postPosZ, 0.0);
  }
  void add_postVelX(double postVelX) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTVELX, postVelX, 0.0);
  }
  void add_postVelY(double postVelY) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTVELY, postVelY, 0.0);
  }
  void add_postVelZ(double postVelZ) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTVELZ, postVelZ, 0.0);
  }
  void add_postRadiationPressCoeff(double postRadiationPressCoeff) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTRADIATIONPRESSCOEFF, postRadiationPressCoeff, 0.0);
  }
  void add_postBallisticCoeff(double postBallisticCoeff) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTBALLISTICCOEFF, postBallisticCoeff, 0.0);
  }
  void add_postApogee(double postApogee) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTAPOGEE, postApogee, 0.0);
  }
  void add_postPerigee(double postPerigee) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTPERIGEE, postPerigee, 0.0);
  }
  void add_postInclination(double postInclination) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTINCLINATION, postInclination, 0.0);
  }
  void add_postEccentricity(double postEccentricity) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTECCENTRICITY, postEccentricity, 0.0);
  }
  void add_postPeriod(double postPeriod) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTPERIOD, postPeriod, 0.0);
  }
  void add_postRAAN(double postRAAN) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTRAAN, postRAAN, 0.0);
  }
  void add_postSMA(double postSMA) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTSMA, postSMA, 0.0);
  }
  void add_postGeoLongitude(double postGeoLongitude) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTGEOLONGITUDE, postGeoLongitude, 0.0);
  }
  void add_postDriftRate(double postDriftRate) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTDRIFTRATE, postDriftRate, 0.0);
  }
  void add_postSigmaU(double postSigmaU) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTSIGMAU, postSigmaU, 0.0);
  }
  void add_postSigmaV(double postSigmaV) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTSIGMAV, postSigmaV, 0.0);
  }
  void add_postSigmaW(double postSigmaW) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTSIGMAW, postSigmaW, 0.0);
  }
  void add_cov(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> cov) {
    fbb_.AddOffset(Maneuver_Full::VT_COV, cov);
  }
  void add_postMass(double postMass) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTMASS, postMass, 0.0);
  }
  void add_postArea(double postArea) {
    fbb_.AddElement<double>(Maneuver_Full::VT_POSTAREA, postArea, 0.0);
  }
  void add_numObs(int32_t numObs) {
    fbb_.AddElement<int32_t>(Maneuver_Full::VT_NUMOBS, numObs, 0);
  }
  void add_description(::flatbuffers::Offset<::flatbuffers::String> description) {
    fbb_.AddOffset(Maneuver_Full::VT_DESCRIPTION, description);
  }
  void add_descriptor(::flatbuffers::Offset<::flatbuffers::String> descriptor) {
    fbb_.AddOffset(Maneuver_Full::VT_DESCRIPTOR, descriptor);
  }
  void add_stateModel(::flatbuffers::Offset<::flatbuffers::String> stateModel) {
    fbb_.AddOffset(Maneuver_Full::VT_STATEMODEL, stateModel);
  }
  void add_stateModelVersion(double stateModelVersion) {
    fbb_.AddElement<double>(Maneuver_Full::VT_STATEMODELVERSION, stateModelVersion, 0.0);
  }
  void add_numAccelPoints(int32_t numAccelPoints) {
    fbb_.AddElement<int32_t>(Maneuver_Full::VT_NUMACCELPOINTS, numAccelPoints, 0);
  }
  void add_mnvrAccelTimes(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> mnvrAccelTimes) {
    fbb_.AddOffset(Maneuver_Full::VT_MNVRACCELTIMES, mnvrAccelTimes);
  }
  void add_mnvrAccels(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> mnvrAccels) {
    fbb_.AddOffset(Maneuver_Full::VT_MNVRACCELS, mnvrAccels);
  }
  void add_mnvrAccelUncs(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> mnvrAccelUncs) {
    fbb_.AddOffset(Maneuver_Full::VT_MNVRACCELUNCS, mnvrAccelUncs);
  }
  void add_source(::flatbuffers::Offset<::flatbuffers::String> source) {
    fbb_.AddOffset(Maneuver_Full::VT_SOURCE, source);
  }
  void add_origin(::flatbuffers::Offset<::flatbuffers::String> origin) {
    fbb_.AddOffset(Maneuver_Full::VT_ORIGIN, origin);
  }
  void add_dataMode(Maneuver_Full_dataMode_Enum dataMode) {
    fbb_.AddElement<int8_t>(Maneuver_Full::VT_DATAMODE, static_cast<int8_t>(dataMode), 0);
  }
  void add_createdAt(::flatbuffers::Offset<::flatbuffers::String> createdAt) {
    fbb_.AddOffset(Maneuver_Full::VT_CREATEDAT, createdAt);
  }
  void add_createdBy(::flatbuffers::Offset<::flatbuffers::String> createdBy) {
    fbb_.AddOffset(Maneuver_Full::VT_CREATEDBY, createdBy);
  }
  void add_tags(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> tags) {
    fbb_.AddOffset(Maneuver_Full::VT_TAGS, tags);
  }
  void add_algorithm(::flatbuffers::Offset<::flatbuffers::String> algorithm) {
    fbb_.AddOffset(Maneuver_Full::VT_ALGORITHM, algorithm);
  }
  void add_sourcedData(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>> sourcedData) {
    fbb_.AddOffset(Maneuver_Full::VT_SOURCEDDATA, sourcedData);
  }
  void add_sourcedDataTypes(Maneuver_Full_sourcedDataTypes_Enum sourcedDataTypes) {
    fbb_.AddElement<int8_t>(Maneuver_Full::VT_SOURCEDDATATYPES, static_cast<int8_t>(sourcedDataTypes), 0);
  }
  void add_onOrbit(::flatbuffers::Offset<::flatbuffers::String> onOrbit) {
    fbb_.AddOffset(Maneuver_Full::VT_ONORBIT, onOrbit);
  }
  void add_transactionId(::flatbuffers::Offset<::flatbuffers::String> transactionId) {
    fbb_.AddOffset(Maneuver_Full::VT_TRANSACTIONID, transactionId);
  }
  void add_origNetwork(::flatbuffers::Offset<::flatbuffers::String> origNetwork) {
    fbb_.AddOffset(Maneuver_Full::VT_ORIGNETWORK, origNetwork);
  }
  explicit Maneuver_FullBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<Maneuver_Full> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<Maneuver_Full>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<Maneuver_Full> CreateManeuver_Full(
    ...
    Maneuver_Full_dataMode_Enum dataMode = Maneuver_Full_dataMode_Enum_REAL,
    ...
    Maneuver_Full_sourcedDataTypes_Enum sourcedDataTypes = Maneuver_Full_sourcedDataTypes_Enum_EO,
    ::flatbuffers::Offset<::flatbuffers::String> onOrbit = 0,
    ::flatbuffers::Offset<::flatbuffers::String> transactionId = 0,
    ::flatbuffers::Offset<::flatbuffers::String> origNetwork = 0) {
  Maneuver_FullBuilder builder_(_fbb);
...
inline ::flatbuffers::Offset<Maneuver_Full> CreateManeuver_FullDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
...
inline const Maneuver_Full *GetManeuver_Full(const void *buf) {
  return ::flatbuffers::GetRoot<Maneuver_Full>(buf);
}

inline const Maneuver_Full *GetSizePrefixedManeuver_Full(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<Maneuver_Full>(buf);
}

inline const char *Maneuver_FullIdentifier() {
  return "MANE";
}

inline bool Maneuver_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Maneuver_FullIdentifier());
}

inline bool SizePrefixedManeuver_FullBufferHasIdentifier(const void *buf) {
  return ::flatbuffers::BufferHasIdentifier(
      buf, Maneuver_FullIdentifier(), true);
}

inline bool VerifyManeuver_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Maneuver_Full>(Maneuver_FullIdentifier());
}

inline bool VerifySizePrefixedManeuver_FullBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Maneuver_Full>(Maneuver_FullIdentifier());
}

inline void FinishManeuver_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Maneuver_Full> root) {
  fbb.Finish(root, Maneuver_FullIdentifier());
}

inline void FinishSizePrefixedManeuver_FullBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<Maneuver_Full> root) {
  fbb.FinishSizePrefixed(root, Maneuver_FullIdentifier());
}
