 ...
 */
@Suppress("unused")
class Mti_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Mti_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsMti_Abridged(_bb: ByteBuffer): Mti_Abridged = getRootAsMti_Abridged(_bb, Mti_Abridged())
        fun getRootAsMti_Abridged(_bb: ByteBuffer, obj: Mti_Abridged): Mti_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Mti_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MTIA")
        fun createMti_Abridged(builder: FlatBufferBuilder, classificationMarkingOffset: Int, sourceOffset: Int, originOffset: Int, idOffset: Int, dataMode: Byte, createdByOffset: Int, createdAtOffset: Int, p3Offset: Int, p6Offset: Int, p7Offset: Int, p8Offset: Int, p9: Int, p10: Int, missionsOffset: Int, dwellsOffset: Int, hrrsOffset: Int, jobDefsOffset: Int, freeTextsOffset: Int, platformLocsOffset: Int, jobRequestsOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endMti_Abridged(builder)
        }
        fun startMti_Abridged(builder: FlatBufferBuilder) = builder.startTable(21)
        ...
        fun endMti_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMtiAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MTIA")
        fun finishSizePrefixedMti_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MTIA")
    }
}
