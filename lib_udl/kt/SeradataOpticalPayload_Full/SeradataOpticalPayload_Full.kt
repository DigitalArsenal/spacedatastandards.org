 ...
 */
@Suppress("unused")
class SeradataOpticalPayload_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SeradataOpticalPayload_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val sourceAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(52, 1)
    fun sourceInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 52, 1)
    /**
    ...
    val originAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(54, 1)
    fun originInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 54, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsSeradataOpticalPayload_Full(_bb: ByteBuffer): SeradataOpticalPayload_Full = getRootAsSeradataOpticalPayload_Full(_bb, SeradataOpticalPayload_Full())
        fun getRootAsSeradataOpticalPayload_Full(_bb: ByteBuffer, obj: SeradataOpticalPayload_Full): SeradataOpticalPayload_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SeradataOpticalPayload_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SERA")
        fun createSeradataOpticalPayload_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, spacecraftIdOffset: Int, idSensorOffset: Int, hostedForCompanyOrgIdOffset: Int, manufacturerOrgIdOffset: Int, imagingPayloadCategoryOffset: Int, nameOffset: Int, spectralBandOffset: Int, spectralFrequencyLimitsOffset: Int, numberOfFilmReturnCanisters: Int, bestResolution: Double, swathWidth: Double, recorderSizeOffset: Int, fieldOfView: Double, fieldOfRegard: Double, pointingMethodOffset: Int, groundStationsOffset: Int, groundStationLocationsOffset: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endSeradataOpticalPayload_Full(builder)
        }
        fun startSeradataOpticalPayload_Full(builder: FlatBufferBuilder) = builder.startTable(28)
        ...
        fun addSource(builder: FlatBufferBuilder, source: Int) = builder.addOffset(24, source, 0)
        fun addOrigin(builder: FlatBufferBuilder, origin: Int) = builder.addOffset(25, origin, 0)
        ...
        fun endSeradataOpticalPayload_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSeradataOpticalPayloadFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SERA")
        fun finishSizePrefixedSeradataOpticalPayload_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SERA")
    }
}
