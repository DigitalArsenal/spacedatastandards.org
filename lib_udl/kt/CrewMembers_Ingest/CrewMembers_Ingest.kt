 ...
 */
@Suppress("unused")
class CrewMembers_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : CrewMembers_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsCrewMembers_Ingest(_bb: ByteBuffer): CrewMembers_Ingest = getRootAsCrewMembers_Ingest(_bb, CrewMembers_Ingest())
        fun getRootAsCrewMembers_Ingest(_bb: ByteBuffer, obj: CrewMembers_Ingest): CrewMembers_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun CrewMembers_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "CREW")
        fun createCrewMembers_Ingest(builder: FlatBufferBuilder, lastNameOffset: Int, firstNameOffset: Int, middleInitialOffset: Int, memberIdOffset: Int, civilian: Boolean, commander: Boolean, last4SsnOffset: Int, dodIdOffset: Int, dutyPositionOffset: Int, crewPositionOffset: Int, memberTypeOffset: Int, branchOffset: Int, rankOffset: Int, wingOffset: Int, squadronOffset: Int, memberRemarksOffset: Int, usernameOffset: Int) : Int {
            ...
            return endCrewMembers_Ingest(builder)
        }
        fun startCrewMembers_Ingest(builder: FlatBufferBuilder) = builder.startTable(17)
        ...
        fun endCrewMembers_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishCrewMembersIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "CREW")
        fun finishSizePrefixedCrewMembers_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "CREW")
    }
}
