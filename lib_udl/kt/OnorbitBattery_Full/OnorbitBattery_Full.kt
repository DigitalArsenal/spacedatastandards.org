 ...
 */
@Suppress("unused")
class OnorbitBattery_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitBattery_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbitBattery_Full(_bb: ByteBuffer): OnorbitBattery_Full = getRootAsOnorbitBattery_Full(_bb, OnorbitBattery_Full())
        fun getRootAsOnorbitBattery_Full(_bb: ByteBuffer, obj: OnorbitBattery_Full): OnorbitBattery_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitBattery_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitBattery_Full(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, idBatteryOffset: Int, classificationMarkingOffset: Int, quantity: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int, batteryOffset: Int) : Int {
            ...
            return endOnorbitBattery_Full(builder)
        }
        fun startOnorbitBattery_Full(builder: FlatBufferBuilder) = builder.startTable(14)
        ...
        fun endOnorbitBattery_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitBatteryFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitBattery_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
