 ...
 */
@Suppress("unused")
class EventEvolution_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EventEvolution_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val areaAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(36, 1)
    fun areaInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 36, 1)
    /**
    ...
    val atextAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(38, 1)
    fun atextInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 38, 1)
    /**
    ...
    val agjsonAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(40, 1)
    fun agjsonInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 40, 1)
    /**
    ...
    val atypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(42, 1)
    fun atypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 42, 1)
    /**
    ...
    val createdAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(52, 1)
    fun createdAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 52, 1)
    /**
    ...
    val createdByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(54, 1)
    fun createdByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 54, 1)
    /**
     * Source of the data.
    ...
    val sourceAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(56, 1)
    fun sourceInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 56, 1)
    /**
    ...
    val originAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(58, 1)
    fun originInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 58, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsEventEvolution_Ingest(_bb: ByteBuffer): EventEvolution_Ingest = getRootAsEventEvolution_Ingest(_bb, EventEvolution_Ingest())
        fun getRootAsEventEvolution_Ingest(_bb: ByteBuffer, obj: EventEvolution_Ingest): EventEvolution_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EventEvolution_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EVEN")
        fun createEventEvolution_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, eventIdOffset: Int, categoryOffset: Int, summaryOffset: Int, startTimeOffset: Int, endTimeOffset: Int, statusOffset: Int, countryCodeOffset: Int, geoAdminLevel1Offset: Int, geoAdminLevel2Offset: Int, geoAdminLevel3Offset: Int, redact: Boolean, srcTypsOffset: Int, srcIdsOffset: Int, dataDescriptionOffset: Int, areaOffset: Int, atextOffset: Int, agjsonOffset: Int, atypeOffset: Int, andims: Int, asrid: Int, urlOffset: Int, tagsOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endEventEvolution_Ingest(builder)
        }
        fun startEventEvolution_Ingest(builder: FlatBufferBuilder) = builder.startTable(30)
        ...
        fun addArea(builder: FlatBufferBuilder, area: Int) = builder.addOffset(16, area, 0)
        fun addAtext(builder: FlatBufferBuilder, atext: Int) = builder.addOffset(17, atext, 0)
        fun addAgjson(builder: FlatBufferBuilder, agjson: Int) = builder.addOffset(18, agjson, 0)
        fun addAtype(builder: FlatBufferBuilder, atype: Int) = builder.addOffset(19, atype, 0)
        fun addAndims(builder: FlatBufferBuilder, andims: Int) = builder.addInt(20, andims, 0)
        fun addAsrid(builder: FlatBufferBuilder, asrid: Int) = builder.addInt(21, asrid, 0)
        fun addUrl(builder: FlatBufferBuilder, url: Int) = builder.addOffset(22, url, 0)
        ...
        fun addCreatedAt(builder: FlatBufferBuilder, createdAt: Int) = builder.addOffset(24, createdAt, 0)
        fun addCreatedBy(builder: FlatBufferBuilder, createdBy: Int) = builder.addOffset(25, createdBy, 0)
        fun addSource(builder: FlatBufferBuilder, source: Int) = builder.addOffset(26, source, 0)
        fun addOrigin(builder: FlatBufferBuilder, origin: Int) = builder.addOffset(27, origin, 0)
        ...
        fun endEventEvolution_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEventEvolutionIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EVEN")
        fun finishSizePrefixedEventEvolution_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EVEN")
    }
}
