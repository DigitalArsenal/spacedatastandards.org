 ...
 */
@Suppress("unused")
class VideoStreams_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : VideoStreams_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsVideoStreams_Abridged(_bb: ByteBuffer): VideoStreams_Abridged = getRootAsVideoStreams_Abridged(_bb, VideoStreams_Abridged())
        fun getRootAsVideoStreams_Abridged(_bb: ByteBuffer, obj: VideoStreams_Abridged): VideoStreams_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun VideoStreams_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "VIDE")
        fun createVideoStreams_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, nameOffset: Int, descriptionOffset: Int, startTimeOffset: Int, stopTimeOffset: Int, sourceOffset: Int, tokenValueOffset: Int, videoUrlsOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, origNetworkOffset: Int, originOffset: Int) : Int {
            ...
            return endVideoStreams_Abridged(builder)
        }
        fun startVideoStreams_Abridged(builder: FlatBufferBuilder) = builder.startTable(14)
        ...
        fun endVideoStreams_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishVideoStreamsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "VIDE")
        fun finishSizePrefixedVideoStreams_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "VIDE")
    }
}
