 ...
 */
@Suppress("unused")
class SiteStatus_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SiteStatus_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createSiteStatus_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idSiteOffset: Int, siteTypeOffset: Int, mobileAltIdOffset: Int, poiidOffset: Int, trackIdOffset: Int, trackRefL16Offset: Int, opsCapabilityOffset: Int, instStatus: Byte, fpcon: Byte, hpcon: Byte, cpcon: Byte, reportTimeOffset: Int, timeFunctionOffset: Int, weatherMessageOffset: Int, pes: Boolean, hotInventory: Int, coldInventory: Int, samModeOffset: Int, radiateModeOffset: Int, opsImpairmentOffset: Int, commImpairmentOffset: Int, cat: Byte, eoc: Byte, linkOffset: Int, linkStatusOffset: Int, radarSystemOffset: Int, radarStatusOffset: Int, missileOffset: Int, missileInventoryOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endSiteStatus_Abridged(builder)
        }
        fun startSiteStatus_Abridged(builder: FlatBufferBuilder) = builder.startTable(37)
        ...
        fun endSiteStatus_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSiteStatusAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SITE")
        fun finishSizePrefixedSiteStatus_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SITE")
    }
}
