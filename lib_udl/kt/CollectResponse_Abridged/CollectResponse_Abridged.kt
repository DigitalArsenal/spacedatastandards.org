 ...
 */
@Suppress("unused")
class CollectResponse_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : CollectResponse_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val idPlanAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(18, 1)
    fun idPlanInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 18, 1)
    /**
    ...
    val externalIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(20, 1)
    fun externalIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 20, 1)
    /**
    ...
    val statusAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(22, 1)
    fun statusInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 22, 1)
    /**
    ...
    val actualStartTimeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(24, 1)
    fun actualStartTimeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 24, 1)
    /**
    ...
    val actualEndTimeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(26, 1)
    fun actualEndTimeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 26, 1)
    /**
    ...
    val altStartTimeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(28, 1)
    fun altStartTimeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 28, 1)
    /**
    ...
    val altEndTimeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(30, 1)
    fun altEndTimeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 30, 1)
    /**
    ...
    val errCodeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(32, 1)
    fun errCodeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 32, 1)
    /**
    ...
    val notesAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(38, 1)
    fun notesInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 38, 1)
    /**
    ...
    val idSensorAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(50, 1)
    fun idSensorInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 50, 1)
    /**
    ...
    val origSensorIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(52, 1)
    fun origSensorIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 52, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsCollectResponse_Abridged(_bb: ByteBuffer): CollectResponse_Abridged = getRootAsCollectResponse_Abridged(_bb, CollectResponse_Abridged())
        fun getRootAsCollectResponse_Abridged(_bb: ByteBuffer, obj: CollectResponse_Abridged): CollectResponse_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun CollectResponse_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "COLL")
        fun createCollectResponse_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idRequestOffset: Int, idOnOrbitOffset: Int, origObjectIdOffset: Int, satNo: Int, taskIdOffset: Int, idPlanOffset: Int, externalIdOffset: Int, statusOffset: Int, actualStartTimeOffset: Int, actualEndTimeOffset: Int, altStartTimeOffset: Int, altEndTimeOffset: Int, errCodeOffset: Int, srcTypsOffset: Int, srcIdsOffset: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, idSensorOffset: Int, origSensorIdOffset: Int, dataMode: Byte) : Int {
            ...
            return endCollectResponse_Abridged(builder)
        }
        fun startCollectResponse_Abridged(builder: FlatBufferBuilder) = builder.startTable(26)
        ...
        fun addIdPlan(builder: FlatBufferBuilder, idPlan: Int) = builder.addOffset(7, idPlan, 0)
        fun addExternalId(builder: FlatBufferBuilder, externalId: Int) = builder.addOffset(8, externalId, 0)
        fun addStatus(builder: FlatBufferBuilder, status: Int) = builder.addOffset(9, status, 0)
        fun addActualStartTime(builder: FlatBufferBuilder, actualStartTime: Int) = builder.addOffset(10, actualStartTime, 0)
        fun addActualEndTime(builder: FlatBufferBuilder, actualEndTime: Int) = builder.addOffset(11, actualEndTime, 0)
        fun addAltStartTime(builder: FlatBufferBuilder, altStartTime: Int) = builder.addOffset(12, altStartTime, 0)
        fun addAltEndTime(builder: FlatBufferBuilder, altEndTime: Int) = builder.addOffset(13, altEndTime, 0)
        fun addErrCode(builder: FlatBufferBuilder, errCode: Int) = builder.addOffset(14, errCode, 0)
        fun addSrcTyps(builder: FlatBufferBuilder, srcTyps: Int) = builder.addOffset(15, srcTyps, 0)
        ...
        fun addSrcIds(builder: FlatBufferBuilder, srcIds: Int) = builder.addOffset(16, srcIds, 0)
        ...
        fun addNotes(builder: FlatBufferBuilder, notes: Int) = builder.addOffset(17, notes, 0)
        ...
        fun addIdSensor(builder: FlatBufferBuilder, idSensor: Int) = builder.addOffset(23, idSensor, 0)
        fun addOrigSensorId(builder: FlatBufferBuilder, origSensorId: Int) = builder.addOffset(24, origSensorId, 0)
        fun addDataMode(builder: FlatBufferBuilder, dataMode: Byte) = builder.addByte(25, dataMode, 0)
        fun endCollectResponse_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishCollectResponseAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "COLL")
        fun finishSizePrefixedCollectResponse_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "COLL")
    }
}
