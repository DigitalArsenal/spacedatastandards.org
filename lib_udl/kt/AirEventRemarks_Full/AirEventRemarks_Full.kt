 ...
 */
@Suppress("unused")
class AirEventRemarks_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirEventRemarks_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirEventRemarks_Full(_bb: ByteBuffer): AirEventRemarks_Full = getRootAsAirEventRemarks_Full(_bb, AirEventRemarks_Full())
        fun getRootAsAirEventRemarks_Full(_bb: ByteBuffer, obj: AirEventRemarks_Full): AirEventRemarks_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirEventRemarks_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRE")
        fun createAirEventRemarks_Full(builder: FlatBufferBuilder, externalRemarkIdOffset: Int, textOffset: Int, dateOffset: Int, userOffset: Int) : Int {
            ...
            return endAirEventRemarks_Full(builder)
        }
        fun startAirEventRemarks_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endAirEventRemarks_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirEventRemarksFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRE")
        fun finishSizePrefixedAirEventRemarks_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRE")
    }
}
