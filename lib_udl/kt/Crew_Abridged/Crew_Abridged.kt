 ...
 */
@Suppress("unused")
class Crew_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Crew_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createCrew_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, origCrewIdOffset: Int, crewNameOffset: Int, statusOffset: Int, idSortieOffset: Int, legalAlertTimeOffset: Int, legalBravoTimeOffset: Int, alertedTimeOffset: Int, returnTimeOffset: Int, fdpEligTypeOffset: Int, fdpTypeOffset: Int, crewTypeOffset: Int, armsCrewUnitOffset: Int, crewMembersOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endCrew_Abridged(builder)
        }
        fun startCrew_Abridged(builder: FlatBufferBuilder) = builder.startTable(23)
        ...
        fun endCrew_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishCrewAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "CREW")
        fun finishSizePrefixedCrew_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "CREW")
    }
}
