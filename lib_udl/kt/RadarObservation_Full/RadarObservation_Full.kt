 ...
 */
@Suppress("unused")
class RadarObservation_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : RadarObservation_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val onOrbitAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(114, 1)
    fun onOrbitInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 114, 1)
    /**
    ...
    val origNetworkAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(120, 1)
    fun origNetworkInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 120, 1)
    /**
    ...
    val sourceDlAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(122, 1)
    fun sourceDlInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 122, 1)
    /**
    ...
    companion object {
        ...
        fun createRadarObservation_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, obTimeOffset: Int, idOnOrbitOffset: Int, idSensorOffset: Int, satNo: Int, taskIdOffset: Int, transactionIdOffset: Int, trackIdOffset: Int, obPositionOffset: Int, origObjectIdOffset: Int, origSensorIdOffset: Int, uct: Boolean, azimuth: Double, azimuthUnc: Double, azimuthBias: Double, azimuthRate: Double, elevation: Double, elevationUnc: Double, elevationBias: Double, elevationRate: Double, range: Double, rangeAccel: Double, rangeAccelUnc: Double, rangeUnc: Double, rangeBias: Double, rangeRate: Double, rangeRateUnc: Double, doppler: Double, dopplerUnc: Double, ra: Double, declination: Double, x: Double, y: Double, z: Double, xvel: Double, yvel: Double, zvel: Double, senx: Double, seny: Double, senz: Double, rcs: Double, rcsUnc: Double, orthogonalRcs: Double, orthogonalRcsUnc: Double, snr: Double, beam: Double, timingBias: Double, rawFileUriOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, tagsOffset: Int, createdAtOffset: Int, createdByOffset: Int, onOrbitOffset: Int, senReferenceFrame: Byte, descriptorOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int, typeOffset: Int) : Int {
            ...
            addUct(builder, uct)
            return endRadarObservation_Full(builder)
        }
        fun startRadarObservation_Full(builder: FlatBufferBuilder) = builder.startTable(61)
        ...
        fun addOnOrbit(builder: FlatBufferBuilder, onOrbit: Int) = builder.addOffset(55, onOrbit, 0)
        fun addSenReferenceFrame(builder: FlatBufferBuilder, senReferenceFrame: Byte) = builder.addByte(56, senReferenceFrame, 0)
        fun addDescriptor(builder: FlatBufferBuilder, descriptor: Int) = builder.addOffset(57, descriptor, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(58, origNetwork, 0)
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(59, sourceDl, 0)
        fun addType(builder: FlatBufferBuilder, type: Int) = builder.addOffset(60, type, 0)
        fun endRadarObservation_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishRadarObservationFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "RADA")
        fun finishSizePrefixedRadarObservation_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "RADA")
    }
}
