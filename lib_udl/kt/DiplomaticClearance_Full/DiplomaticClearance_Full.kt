 ...
 */
@Suppress("unused")
class DiplomaticClearance_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DiplomaticClearance_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDiplomaticClearance_Full(_bb: ByteBuffer): DiplomaticClearance_Full = getRootAsDiplomaticClearance_Full(_bb, DiplomaticClearance_Full())
        fun getRootAsDiplomaticClearance_Full(_bb: ByteBuffer, obj: DiplomaticClearance_Full): DiplomaticClearance_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DiplomaticClearance_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DIPL")
        fun createDiplomaticClearance_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idMissionOffset: Int, externalWorksheetIdOffset: Int, dipWorksheetNameOffset: Int, firstDepDateOffset: Int, docDeadlineOffset: Int, apacsIdOffset: Int, diplomaticClearanceDetailsOffset: Int, diplomaticClearanceRemarksOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endDiplomaticClearance_Full(builder)
        }
        fun startDiplomaticClearance_Full(builder: FlatBufferBuilder) = builder.startTable(19)
        ...
        fun endDiplomaticClearance_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDiplomaticClearanceFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DIPL")
        fun finishSizePrefixedDiplomaticClearance_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DIPL")
    }
}
