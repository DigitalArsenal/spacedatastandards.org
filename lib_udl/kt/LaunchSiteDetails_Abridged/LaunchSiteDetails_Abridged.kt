 ...
 */
@Suppress("unused")
class LaunchSiteDetails_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LaunchSiteDetails_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLaunchSiteDetails_Abridged(_bb: ByteBuffer): LaunchSiteDetails_Abridged = getRootAsLaunchSiteDetails_Abridged(_bb, LaunchSiteDetails_Abridged())
        fun getRootAsLaunchSiteDetails_Abridged(_bb: ByteBuffer, obj: LaunchSiteDetails_Abridged): LaunchSiteDetails_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LaunchSiteDetails_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LAUN")
        fun createLaunchSiteDetails_Abridged(builder: FlatBufferBuilder, idOffset: Int, idLaunchSiteOffset: Int, classificationMarkingOffset: Int, idLocationOffset: Int, launchGroupOffset: Int, availableInclinationsOffset: Int, descriptionOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, locationOffset: Int) : Int {
            ...
            return endLaunchSiteDetails_Abridged(builder)
        }
        fun startLaunchSiteDetails_Abridged(builder: FlatBufferBuilder) = builder.startTable(14)
        ...
        fun endLaunchSiteDetails_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLaunchSiteDetailsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LAUN")
        fun finishSizePrefixedLaunchSiteDetails_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LAUN")
    }
}
