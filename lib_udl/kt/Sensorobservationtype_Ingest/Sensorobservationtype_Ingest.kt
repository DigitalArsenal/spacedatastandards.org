 ...
 */
@Suppress("unused")
class Sensorobservationtype_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Sensorobservationtype_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSensorobservationtype_Ingest(_bb: ByteBuffer): Sensorobservationtype_Ingest = getRootAsSensorobservationtype_Ingest(_bb, Sensorobservationtype_Ingest())
        fun getRootAsSensorobservationtype_Ingest(_bb: ByteBuffer, obj: Sensorobservationtype_Ingest): Sensorobservationtype_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Sensorobservationtype_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SENS")
        fun createSensorobservationtype_Ingest(builder: FlatBufferBuilder, idOffset: Int, typeOffset: Int, createdAtOffset: Int, createdByOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endSensorobservationtype_Ingest(builder)
        }
        fun startSensorobservationtype_Ingest(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endSensorobservationtype_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSensorobservationtypeIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SENS")
        fun finishSizePrefixedSensorobservationtype_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SENS")
    }
}
