 ...
 */
@Suppress("unused")
class FlightPlanPointGroups_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : FlightPlanPointGroups_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsFlightPlanPointGroups_Full(_bb: ByteBuffer): FlightPlanPointGroups_Full = getRootAsFlightPlanPointGroups_Full(_bb, FlightPlanPointGroups_Full())
        fun getRootAsFlightPlanPointGroups_Full(_bb: ByteBuffer, obj: FlightPlanPointGroups_Full): FlightPlanPointGroups_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun FlightPlanPointGroups_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "FLIG")
        fun createFlightPlanPointGroups_Full(builder: FlatBufferBuilder, pointGroupNameOffset: Int, worstFuelCaseOffset: Int, lsafNameOffset: Int, lsafDistance: Double, fsafDistance: Double, etopsDistance: Double, lsafTimeOffset: Int, fsafTimeOffset: Int, etopsTimeOffset: Int, lsafAvgWindFactor: Double, fsafAvgWindFactor: Double, etopsAvgWindFactor: Double, lsafTempDev: Double, fsafTempDev: Double, etopsTempDev: Double, lsafReqFuel: Double, fsafReqFuel: Double, etopsReqFuel: Double, fromTakeoffTimeOffset: Int, plannedFuel: Double, fuelCalcAlt: Double, fuelCalcSpd: Double, avgFuelFlow: Double, flightPlanPointsOffset: Int) : Int {
            ...
            return endFlightPlanPointGroups_Full(builder)
        }
        fun startFlightPlanPointGroups_Full(builder: FlatBufferBuilder) = builder.startTable(24)
        ...
        fun endFlightPlanPointGroups_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishFlightPlanPointGroupsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "FLIG")
        fun finishSizePrefixedFlightPlanPointGroups_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "FLIG")
    }
}
