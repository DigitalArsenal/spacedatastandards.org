 ...
 */
@Suppress("unused")
class Navigation_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Navigation_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsNavigation_Full(_bb: ByteBuffer): Navigation_Full = getRootAsNavigation_Full(_bb, Navigation_Full())
        fun getRootAsNavigation_Full(_bb: ByteBuffer, obj: Navigation_Full): Navigation_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Navigation_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "NAVI")
        fun createNavigation_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idEntityOffset: Int, nameOffset: Int, descriptionOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, entityOffset: Int) : Int {
            ...
            return endNavigation_Full(builder)
        }
        fun startNavigation_Full(builder: FlatBufferBuilder) = builder.startTable(14)
        ...
        fun endNavigation_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishNavigationFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "NAVI")
        fun finishSizePrefixedNavigation_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "NAVI")
    }
}
