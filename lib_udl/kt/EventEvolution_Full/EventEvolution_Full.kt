 ...
 */
@Suppress("unused")
class EventEvolution_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EventEvolution_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createEventEvolution_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, eventIdOffset: Int, categoryOffset: Int, summaryOffset: Int, startTimeOffset: Int, endTimeOffset: Int, statusOffset: Int, countryCodeOffset: Int, geoAdminLevel1Offset: Int, geoAdminLevel2Offset: Int, geoAdminLevel3Offset: Int, redact: Boolean, srcTypsOffset: Int, srcIdsOffset: Int, dataDescriptionOffset: Int, areaOffset: Int, atextOffset: Int, agjsonOffset: Int, atypeOffset: Int, andims: Int, asrid: Int, urlOffset: Int, tagsOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endEventEvolution_Full(builder)
        }
        fun startEventEvolution_Full(builder: FlatBufferBuilder) = builder.startTable(30)
        ...
        fun endEventEvolution_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEventEvolutionFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EVEN")
        fun finishSizePrefixedEventEvolution_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EVEN")
    }
}
