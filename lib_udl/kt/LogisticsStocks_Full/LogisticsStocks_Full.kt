 ...
 */
@Suppress("unused")
class LogisticsStocks_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LogisticsStocks_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLogisticsStocks_Full(_bb: ByteBuffer): LogisticsStocks_Full = getRootAsLogisticsStocks_Full(_bb, LogisticsStocks_Full())
        fun getRootAsLogisticsStocks_Full(_bb: ByteBuffer, obj: LogisticsStocks_Full): LogisticsStocks_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LogisticsStocks_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOGI")
        fun createLogisticsStocks_Full(builder: FlatBufferBuilder, sourceIcaoOffset: Int, quantity: Int, stockCheckTimeOffset: Int, stockPocOffset: Int) : Int {
            ...
            return endLogisticsStocks_Full(builder)
        }
        fun startLogisticsStocks_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endLogisticsStocks_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLogisticsStocksFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOGI")
        fun finishSizePrefixedLogisticsStocks_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOGI")
    }
}
