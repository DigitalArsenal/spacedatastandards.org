 ...
 */
@Suppress("unused")
class OnorbitBattery_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitBattery_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val batteryAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(26, 1)
    fun batteryInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 26, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsOnorbitBattery_Abridged(_bb: ByteBuffer): OnorbitBattery_Abridged = getRootAsOnorbitBattery_Abridged(_bb, OnorbitBattery_Abridged())
        fun getRootAsOnorbitBattery_Abridged(_bb: ByteBuffer, obj: OnorbitBattery_Abridged): OnorbitBattery_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitBattery_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitBattery_Abridged(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, idBatteryOffset: Int, classificationMarkingOffset: Int, quantity: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int, batteryOffset: Int) : Int {
            ...
            return endOnorbitBattery_Abridged(builder)
        }
        fun startOnorbitBattery_Abridged(builder: FlatBufferBuilder) = builder.startTable(12)
        ...
        fun addBattery(builder: FlatBufferBuilder, battery: Int) = builder.addOffset(11, battery, 0)
        fun endOnorbitBattery_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitBatteryAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitBattery_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
