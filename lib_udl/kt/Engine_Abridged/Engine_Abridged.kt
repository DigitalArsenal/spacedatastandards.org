 ...
 */
@Suppress("unused")
class Engine_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Engine_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEngine_Abridged(_bb: ByteBuffer): Engine_Abridged = getRootAsEngine_Abridged(_bb, Engine_Abridged())
        fun getRootAsEngine_Abridged(_bb: ByteBuffer, obj: Engine_Abridged): Engine_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Engine_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ENGI")
        fun createEngine_Abridged(builder: FlatBufferBuilder, idOffset: Int, nameOffset: Int, classificationMarkingOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endEngine_Abridged(builder)
        }
        fun startEngine_Abridged(builder: FlatBufferBuilder) = builder.startTable(9)
        ...
        fun endEngine_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEngineAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ENGI")
        fun finishSizePrefixedEngine_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ENGI")
    }
}
