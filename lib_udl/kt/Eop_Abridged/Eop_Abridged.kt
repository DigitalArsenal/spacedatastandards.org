 ...
 */
@Suppress("unused")
class Eop_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Eop_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createEop_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, eopDateOffset: Int, polarMotionState: Byte, polarMotionX: Double, polarMotionXunc: Double, polarMotionY: Double, polarMotionYunc: Double, ut1Utcstate: Byte, ut1Utc: Double, ut1Utcunc: Double, lod: Double, lodUnc: Double, nutationState: Byte, dPsi: Double, dPsiunc: Double, dEpsilon: Double, dEpsilonUnc: Double, dX: Double, dXunc: Double, dY: Double, dYunc: Double, polarMotionXb: Double, polarMotionYb: Double, ut1Utcb: Double, dPsib: Double, dEpsilonB: Double, dXb: Double, dYb: Double, precessionNutationStdOffset: Int, rawFileUriOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endEop_Abridged(builder)
        }
        fun startEop_Abridged(builder: FlatBufferBuilder) = builder.startTable(37)
        ...
        fun endEop_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEopAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EOPA")
        fun finishSizePrefixedEop_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EOPA")
    }
}
