 ...
 */
@Suppress("unused")
class AirspaceControlMeans_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirspaceControlMeans_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirspaceControlMeans_Ingest(_bb: ByteBuffer): AirspaceControlMeans_Ingest = getRootAsAirspaceControlMeans_Ingest(_bb, AirspaceControlMeans_Ingest())
        fun getRootAsAirspaceControlMeans_Ingest(_bb: ByteBuffer, obj: AirspaceControlMeans_Ingest): AirspaceControlMeans_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirspaceControlMeans_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRS")
        fun createAirspaceControlMeans_Ingest(builder: FlatBufferBuilder, cmTypeOffset: Int, cmIdOffset: Int, cmShape: Byte, usageOffset: Int, link16IdOffset: Int, transAltitudeOffset: Int, geoDatumAltOffset: Int, coord0Offset: Int, coord1Offset: Int, bearing0: Double, bearing1: Double, radMag0: Double, radMag1: Double, radMagUnitOffset: Int, polyCoordOffset: Int, trackLeg: Int, widthLeft: Double, widthRight: Double, width: Double, widthUnitOffset: Int, corrWayPointsOffset: Int, orbitAlignmentOffset: Int, effVdimOffset: Int, airspaceTimePeriodOffset: Int, airspaceControlPointOffset: Int, ctrlAuthOffset: Int, ctrlAuthFreqsOffset: Int, genTextIndOffset: Int, freeTextOffset: Int) : Int {
            ...
            return endAirspaceControlMeans_Ingest(builder)
        }
        fun startAirspaceControlMeans_Ingest(builder: FlatBufferBuilder) = builder.startTable(29)
        ...
        fun endAirspaceControlMeans_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirspaceControlMeansIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRS")
        fun finishSizePrefixedAirspaceControlMeans_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRS")
    }
}
