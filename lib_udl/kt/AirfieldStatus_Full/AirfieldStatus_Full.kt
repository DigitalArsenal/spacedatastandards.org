 ...
 */
@Suppress("unused")
class AirfieldStatus_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirfieldStatus_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createAirfieldStatus_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idAirfieldOffset: Int, altAirfieldIdOffset: Int, passengerServiceMog: Int, fleetServiceMog: Int, cargoMog: Int, fuelMog: Int, fuelTypesOffset: Int, fuelQtysOffset: Int, mxMog: Int, operatingMog: Int, numCog: Int, wideWorkingMog: Int, wideParkingMog: Int, narrowWorkingMog: Int, narrowParkingMog: Int, mheTypesOffset: Int, mheQtysOffset: Int, medCapOffset: Int, arffCatOffset: Int, gseTime: Int, priRwyNumOffset: Int, rwyCondReading: Int, rwyFrictionFactor: Int, rwyMarkingsOffset: Int, messageOffset: Int, priFreq: Double, slotTypesReqOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endAirfieldStatus_Full(builder)
        }
        fun startAirfieldStatus_Full(builder: FlatBufferBuilder) = builder.startTable(38)
        ...
        fun endAirfieldStatus_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirfieldStatusFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRF")
        fun finishSizePrefixedAirfieldStatus_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRF")
    }
}
