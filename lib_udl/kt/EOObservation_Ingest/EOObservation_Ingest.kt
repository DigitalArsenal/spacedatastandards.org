 ...
 */
@Suppress("unused")
class EOObservation_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EOObservation_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createEOObservation_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, obTimeOffset: Int, corrQuality: Double, idOnOrbitOffset: Int, idSensorOffset: Int, idSkyImageryOffset: Int, collectMethodOffset: Int, satNo: Int, taskIdOffset: Int, transactionIdOffset: Int, trackIdOffset: Int, obPositionOffset: Int, origObjectIdOffset: Int, origSensorIdOffset: Int, uct: Boolean, azimuth: Double, azimuthUnc: Double, azimuthBias: Double, azimuthRate: Double, elevation: Double, elevationUnc: Double, elevationBias: Double, elevationRate: Double, range: Double, rangeUnc: Double, rangeBias: Double, rangeRate: Double, rangeRateUnc: Double, ra: Double, raRate: Double, raUnc: Double, raBias: Double, declination: Double, declinationRate: Double, declinationUnc: Double, declinationBias: Double, losx: Double, losy: Double, losz: Double, losUnc: Double, losxvel: Double, losyvel: Double, loszvel: Double, senlat: Double, senlon: Double, senalt: Double, senx: Double, seny: Double, senz: Double, senvelx: Double, senvely: Double, senvelz: Double, senQuatOffset: Int, fovCount: Int, expDuration: Double, zeroptd: Double, netObjSig: Double, netObjSigUnc: Double, mag: Double, magUnc: Double, magNormRange: Double, geolat: Double, geolon: Double, geoalt: Double, georange: Double, skyBkgrnd: Double, primaryExtinction: Double, primaryExtinctionUnc: Double, solarPhaseAngle: Double, solarEqPhaseAngle: Double, solarDecAngle: Double, shutterDelay: Double, timingBias: Double, rawFileUriOffset: Int, intensity: Double, bgIntensity: Double, descriptorOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, tagsOffset: Int, createdAtOffset: Int, createdByOffset: Int, zeroPtdUnc: Double, eoobservationDetailsOffset: Int, referenceFrame: Byte, senReferenceFrame: Byte, umbra: Boolean, penumbra: Boolean, origNetworkOffset: Int, sourceDlOffset: Int, typeOffset: Int) : Int {
            ...
            addUct(builder, uct)
            return endEOObservation_Ingest(builder)
        }
        fun startEOObservation_Ingest(builder: FlatBufferBuilder) = builder.startTable(93)
        ...
        fun addReferenceFrame(builder: FlatBufferBuilder, referenceFrame: Byte) = builder.addByte(86, referenceFrame, 0)
        fun addSenReferenceFrame(builder: FlatBufferBuilder, senReferenceFrame: Byte) = builder.addByte(87, senReferenceFrame, 0)
        fun addUmbra(builder: FlatBufferBuilder, umbra: Boolean) = builder.addBoolean(88, umbra, false)
        fun addPenumbra(builder: FlatBufferBuilder, penumbra: Boolean) = builder.addBoolean(89, penumbra, false)
        ...
        fun addType(builder: FlatBufferBuilder, type: Int) = builder.addOffset(92, type, 0)
        fun endEOObservation_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEOObservationIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EOOB")
        fun finishSizePrefixedEOObservation_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EOOB")
    }
}
