 ...
 */
@Suppress("unused")
class SeradataRadarPayload_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SeradataRadarPayload_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createSeradataRadarPayload_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, spacecraftIdOffset: Int, idSensorOffset: Int, hostedForCompanyOrgIdOffset: Int, manufacturerOrgIdOffset: Int, categoryOffset: Int, nameOffset: Int, frequencyBandOffset: Int, frequency: Double, waveLength: Double, bestResolution: Double, swathWidth: Double, recorderSizeOffset: Int, fieldOfView: Double, fieldOfRegard: Double, pointingMethodOffset: Int, groundStationsOffset: Int, groundStationLocationsOffset: Int, transmitPolarizationOffset: Int, receivePolarizationOffset: Int, dutyCycleOffset: Int, partnerSpacecraftOffset: Int, constellationInterferometricCapabilityOffset: Int, notesOffset: Int, bandwidth: Double, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endSeradataRadarPayload_Ingest(builder)
        }
        fun startSeradataRadarPayload_Ingest(builder: FlatBufferBuilder) = builder.startTable(32)
        ...
        fun endSeradataRadarPayload_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSeradataRadarPayloadIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SERA")
        fun finishSizePrefixedSeradataRadarPayload_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SERA")
    }
}
