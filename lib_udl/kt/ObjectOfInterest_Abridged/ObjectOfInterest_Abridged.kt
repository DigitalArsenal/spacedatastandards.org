 ...
 */
@Suppress("unused")
class ObjectOfInterest_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : ObjectOfInterest_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val originAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(84, 1)
    fun originInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 84, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsObjectOfInterest_Abridged(_bb: ByteBuffer): ObjectOfInterest_Abridged = getRootAsObjectOfInterest_Abridged(_bb, ObjectOfInterest_Abridged())
        fun getRootAsObjectOfInterest_Abridged(_bb: ByteBuffer, obj: ObjectOfInterest_Abridged): ObjectOfInterest_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun ObjectOfInterest_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "OBJE")
        fun createObjectOfInterest_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, satNo: Int, nameOffset: Int, sensorTaskingStartTimeOffset: Int, sensorTaskingStopTimeOffset: Int, priority: Int, statusOffset: Int, statusDateOffset: Int, descriptionOffset: Int, lastObTimeOffset: Int, missedObTimeOffset: Int, deltaVsOffset: Int, deltaTsOffset: Int, svEpochOffset: Int, x: Double, y: Double, z: Double, xvel: Double, yvel: Double, zvel: Double, elsetEpochOffset: Int, meanMotion: Double, eccentricity: Double, inclination: Double, raan: Double, argOfPerigee: Double, meanAnomaly: Double, revNo: Int, bStar: Double, meanMotionDot: Double, meanMotionDdot: Double, semiMajorAxis: Double, period: Double, apogee: Double, perigee: Double, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endObjectOfInterest_Abridged(builder)
        }
        fun startObjectOfInterest_Abridged(builder: FlatBufferBuilder) = builder.startTable(43)
        ...
        fun addOrigin(builder: FlatBufferBuilder, origin: Int) = builder.addOffset(40, origin, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(41, origNetwork, 0)
        fun addDataMode(builder: FlatBufferBuilder, dataMode: Byte) = builder.addByte(42, dataMode, 0)
        fun endObjectOfInterest_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishObjectOfInterestAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "OBJE")
        fun finishSizePrefixedObjectOfInterest_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "OBJE")
    }
}
