 ...
 */
@Suppress("unused")
class AircraftMissionRequirements_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AircraftMissionRequirements_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAircraftMissionRequirements_Full(_bb: ByteBuffer): AircraftMissionRequirements_Full = getRootAsAircraftMissionRequirements_Full(_bb, AircraftMissionRequirements_Full())
        fun getRootAsAircraftMissionRequirements_Full(_bb: ByteBuffer, obj: AircraftMissionRequirements_Full): AircraftMissionRequirements_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AircraftMissionRequirements_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRC")
        fun createAircraftMissionRequirements_Full(builder: FlatBufferBuilder, gdssReqIdOffset: Int, onloadId: Int, onloadLocodeOffset: Int, offloadId: Int, offloadLocodeOffset: Int, ulnOffset: Int, transReqNumOffset: Int, projNameOffset: Int, oplanOffset: Int, numPax: Int, numLitter: Int, numAmbulatory: Int, numAttendant: Int, bulkWeight: Double, oversizeWeight: Double, outsizeWeight: Double, eadOffset: Int, ladOffset: Int) : Int {
            ...
            return endAircraftMissionRequirements_Full(builder)
        }
        fun startAircraftMissionRequirements_Full(builder: FlatBufferBuilder) = builder.startTable(18)
        ...
        fun endAircraftMissionRequirements_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAircraftMissionRequirementsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRC")
        fun finishSizePrefixedAircraftMissionRequirements_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRC")
    }
}
