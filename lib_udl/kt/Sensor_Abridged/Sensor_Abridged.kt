 ...
 */
@Suppress("unused")
class Sensor_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Sensor_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createSensor_Abridged(builder: FlatBufferBuilder, idSensorOffset: Int, sensorNameOffset: Int, classificationMarkingOffset: Int, sensorNumber: Int, shortNameOffset: Int, dataControlOffset: Int, afIdOffset: Int, asrTypeOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, active: Boolean, sensorcharacteristicsOffset: Int, sensorStatsOffset: Int, sensorlimitsCollectionOffset: Int, entityOffset: Int, idEntityOffset: Int, sensorObservationTypeOffset: Int, sensorTypeOffset: Int) : Int {
            ...
            return endSensor_Abridged(builder)
        }
        fun startSensor_Abridged(builder: FlatBufferBuilder) = builder.startTable(22)
        ...
        fun endSensor_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSensorAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SENS")
        fun finishSizePrefixedSensor_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SENS")
    }
}
