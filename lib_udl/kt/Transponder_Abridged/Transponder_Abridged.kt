 ...
 */
@Suppress("unused")
class Transponder_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Transponder_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsTransponder_Abridged(_bb: ByteBuffer): Transponder_Abridged = getRootAsTransponder_Abridged(_bb, Transponder_Abridged())
        fun getRootAsTransponder_Abridged(_bb: ByteBuffer, obj: Transponder_Abridged): Transponder_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Transponder_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "TRAN")
        fun createTransponder_Abridged(builder: FlatBufferBuilder, idOffset: Int, idCommOffset: Int, nameOffset: Int, classificationMarkingOffset: Int, nidOffset: Int, tidOffset: Int, ttf: Double, symbolRate: Double, fec: Int, modulationOffset: Int, formatOffset: Int, systemOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int) : Int {
            ...
            return endTransponder_Abridged(builder)
        }
        fun startTransponder_Abridged(builder: FlatBufferBuilder) = builder.startTable(18)
        ...
        fun endTransponder_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishTransponderAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "TRAN")
        fun finishSizePrefixedTransponder_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "TRAN")
    }
}
