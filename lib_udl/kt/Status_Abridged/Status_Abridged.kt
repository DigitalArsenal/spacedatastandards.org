 ...
 */
@Suppress("unused")
class Status_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Status_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsStatus_Abridged(_bb: ByteBuffer): Status_Abridged = getRootAsStatus_Abridged(_bb, Status_Abridged())
        fun getRootAsStatus_Abridged(_bb: ByteBuffer, obj: Status_Abridged): Status_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Status_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "STAT")
        fun createStatus_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, derivedFromOffset: Int, declassificationDateOffset: Int, declassificationStringOffset: Int, idEntityOffset: Int, state: Byte, sysCap: Byte, opsCap: Byte, sourceOffset: Int, subStatusCollectionOffset: Int, dataMode: Byte, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, originOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endStatus_Abridged(builder)
        }
        fun startStatus_Abridged(builder: FlatBufferBuilder) = builder.startTable(17)
        ...
        fun endStatus_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishStatusAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "STAT")
        fun finishSizePrefixedStatus_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "STAT")
    }
}
