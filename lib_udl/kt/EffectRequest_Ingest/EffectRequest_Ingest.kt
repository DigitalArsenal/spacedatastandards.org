 ...
 */
@Suppress("unused")
class EffectRequest_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EffectRequest_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createEffectRequest_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, externalRequestIdOffset: Int, effectListOffset: Int, stateOffset: Int, contextOffset: Int, startTimeOffset: Int, endTimeOffset: Int, deadlineTypeOffset: Int, targetSrcTypeOffset: Int, targetSrcIdOffset: Int, priorityOffset: Int, modelClassOffset: Int, metricTypesOffset: Int, metricWeightsOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endEffectRequest_Ingest(builder)
        }
        fun startEffectRequest_Ingest(builder: FlatBufferBuilder) = builder.startTable(21)
        ...
        fun endEffectRequest_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEffectRequestIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EFFE")
        fun finishSizePrefixedEffectRequest_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EFFE")
    }
}
