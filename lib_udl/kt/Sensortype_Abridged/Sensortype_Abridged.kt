 ...
 */
@Suppress("unused")
class Sensortype_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Sensortype_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSensortype_Abridged(_bb: ByteBuffer): Sensortype_Abridged = getRootAsSensortype_Abridged(_bb, Sensortype_Abridged())
        fun getRootAsSensortype_Abridged(_bb: ByteBuffer, obj: Sensortype_Abridged): Sensortype_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Sensortype_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SENS")
        fun createSensortype_Abridged(builder: FlatBufferBuilder, id: Int, typeOffset: Int, createdAtOffset: Int, createdByOffset: Int, origNetworkOffset: Int) : Int {
            ...
            addId(builder, id)
            return endSensortype_Abridged(builder)
        }
        fun startSensortype_Abridged(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endSensortype_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSensortypeAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SENS")
        fun finishSizePrefixedSensortype_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SENS")
    }
}
