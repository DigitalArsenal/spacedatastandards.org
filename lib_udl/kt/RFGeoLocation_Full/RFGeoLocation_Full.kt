 ...
 */
@Suppress("unused")
class RFGeoLocation_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : RFGeoLocation_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val areaAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(60, 1)
    fun areaInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 60, 1)
    /**
    ...
    val passGroupIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(66, 1)
    fun passGroupIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 66, 1)
    /**
    ...
    val algVersionAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(68, 1)
    fun algVersionInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 68, 1)
    /**
    ...
    val externalIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(70, 1)
    fun externalIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 70, 1)
    /**
    ...
    val sourceDlAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(84, 1)
    fun sourceDlInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 84, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsRFGeoLocation_Full(_bb: ByteBuffer): RFGeoLocation_Full = getRootAsRFGeoLocation_Full(_bb, RFGeoLocation_Full())
        fun getRootAsRFGeoLocation_Full(_bb: ByteBuffer, obj: RFGeoLocation_Full): RFGeoLocation_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun RFGeoLocation_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "RFGE")
        fun createRFGeoLocation_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, orderIdOffset: Int, createdTsOffset: Int, receivedTsOffset: Int, startTimeOffset: Int, endTimeOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, constellationOffset: Int, signalOfInterestOffset: Int, idRfemitterOffset: Int, origRfemitterIdOffset: Int, numBursts: Int, minFreq: Double, maxFreq: Double, centerFreq: Double, detectLat: Double, detectLon: Double, detectAlt: Double, confSemiMajor: Double, confSemiMinor: Double, confOrientation: Double, confArea: Double, atypeOffset: Int, agjsonOffset: Int, atextOffset: Int, areaOffset: Int, andims: Int, asrid: Int, passGroupIdOffset: Int, algVersionOffset: Int, externalIdOffset: Int, tagsOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int, dataMode: Byte, onOrbitOffset: Int) : Int {
            ...
            return endRFGeoLocation_Full(builder)
        }
        fun startRFGeoLocation_Full(builder: FlatBufferBuilder) = builder.startTable(43)
        ...
        fun addArea(builder: FlatBufferBuilder, area: Int) = builder.addOffset(28, area, 0)
        fun addAndims(builder: FlatBufferBuilder, andims: Int) = builder.addInt(29, andims, 0)
        fun addAsrid(builder: FlatBufferBuilder, asrid: Int) = builder.addInt(30, asrid, 0)
        fun addPassGroupId(builder: FlatBufferBuilder, passGroupId: Int) = builder.addOffset(31, passGroupId, 0)
        fun addAlgVersion(builder: FlatBufferBuilder, algVersion: Int) = builder.addOffset(32, algVersion, 0)
        fun addExternalId(builder: FlatBufferBuilder, externalId: Int) = builder.addOffset(33, externalId, 0)
        ...
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(40, sourceDl, 0)
        ...
        fun endRFGeoLocation_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishRFGeoLocationFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "RFGE")
        fun finishSizePrefixedRFGeoLocation_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "RFGE")
    }
}
