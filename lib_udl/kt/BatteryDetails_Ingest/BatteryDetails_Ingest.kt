 ...
 */
@Suppress("unused")
class BatteryDetails_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : BatteryDetails_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsBatteryDetails_Ingest(_bb: ByteBuffer): BatteryDetails_Ingest = getRootAsBatteryDetails_Ingest(_bb, BatteryDetails_Ingest())
        fun getRootAsBatteryDetails_Ingest(_bb: ByteBuffer, obj: BatteryDetails_Ingest): BatteryDetails_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun BatteryDetails_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "BATT")
        fun createBatteryDetails_Ingest(builder: FlatBufferBuilder, idOffset: Int, idBatteryOffset: Int, classificationMarkingOffset: Int, technologyOffset: Int, capacity: Double, dischargeDepth: Double, modelOffset: Int, descriptionOffset: Int, manufacturerOrgIdOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, tagsOffset: Int) : Int {
            ...
            return endBatteryDetails_Ingest(builder)
        }
        fun startBatteryDetails_Ingest(builder: FlatBufferBuilder) = builder.startTable(16)
        ...
        fun endBatteryDetails_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishBatteryDetailsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "BATT")
        fun finishSizePrefixedBatteryDetails_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "BATT")
    }
}
