 ...
 */
@Suppress("unused")
class SkyImagery_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SkyImagery_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createSkyImagery_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, origObjectIdOffset: Int, idAttitudeSetOffset: Int, idSensorOffset: Int, satNo: Int, origSensorIdOffset: Int, senlat: Double, senlon: Double, senalt: Double, senx: Double, seny: Double, senz: Double, senQuatOffset: Int, senQuatDotOffset: Int, imageTypeOffset: Int, expStartTimeOffset: Int, expEndTimeOffset: Int, imageSourceInfoOffset: Int, topLeftStartAz: Double, topLeftStartEl: Double, topLeftStopAz: Double, topLeftStopEl: Double, imageSetIdOffset: Int, imageSetLength: Int, sequenceId: Int, frameFovwidth: Double, frameFovheight: Double, pixelFovwidth: Double, pixelFovheight: Double, frameWidthPixels: Int, frameHeightPixels: Int, pixelBitDepth: Int, annotationKeyOffset: Int, calibrationKeyOffset: Int, filenameOffset: Int, filesize: Long, checksumValueOffset: Int, transactionIdOffset: Int, tagsOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int, descriptionOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, eoObservationsOffset: Int) : Int {
            ...
            return endSkyImagery_Ingest(builder)
        }
        fun startSkyImagery_Ingest(builder: FlatBufferBuilder) = builder.startTable(50)
        ...
        fun addEoObservations(builder: FlatBufferBuilder, eoObservations: Int) = builder.addOffset(49, eoObservations, 0)
        ...
        fun endSkyImagery_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSkyImageryIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SKYI")
        fun finishSizePrefixedSkyImagery_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SKYI")
    }
}
