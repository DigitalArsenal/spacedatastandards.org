 ...
 */
@Suppress("unused")
class SortiePPR_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SortiePPR_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(32, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 32, 1)
    /**
    ...
    val sourceDlAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(34, 1)
    fun sourceDlInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 34, 1)
    /**
     * Source of the data.
    ...
    companion object {
        ...
        fun getRootAsSortiePPR_Full(_bb: ByteBuffer): SortiePPR_Full = getRootAsSortiePPR_Full(_bb, SortiePPR_Full())
        fun getRootAsSortiePPR_Full(_bb: ByteBuffer, obj: SortiePPR_Full): SortiePPR_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SortiePPR_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SORT")
        fun createSortiePPR_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idSortieOffset: Int, externalIdOffset: Int, numberOffset: Int, startTimeOffset: Int, endTimeOffset: Int, requestorOffset: Int, grantorOffset: Int, type: Byte, remarksOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endSortiePPR_Full(builder)
        }
        fun startSortiePPR_Full(builder: FlatBufferBuilder) = builder.startTable(20)
        ...
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(14, updatedBy, 0)
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(15, sourceDl, 0)
        ...
        fun endSortiePPR_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSortiePPRFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SORT")
        fun finishSizePrefixedSortiePPR_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SORT")
    }
}
