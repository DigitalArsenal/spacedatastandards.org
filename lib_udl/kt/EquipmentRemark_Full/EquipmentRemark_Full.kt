 ...
 */
@Suppress("unused")
class EquipmentRemark_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EquipmentRemark_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEquipmentRemark_Full(_bb: ByteBuffer): EquipmentRemark_Full = getRootAsEquipmentRemark_Full(_bb, EquipmentRemark_Full())
        fun getRootAsEquipmentRemark_Full(_bb: ByteBuffer, obj: EquipmentRemark_Full): EquipmentRemark_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EquipmentRemark_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EQUI")
        fun createEquipmentRemark_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idEquipmentOffset: Int, altRmkIdOffset: Int, nameOffset: Int, typeOffset: Int, textOffset: Int, codeOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte) : Int {
            ...
            return endEquipmentRemark_Full(builder)
        }
        fun startEquipmentRemark_Full(builder: FlatBufferBuilder) = builder.startTable(15)
        ...
        fun endEquipmentRemark_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEquipmentRemarkFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EQUI")
        fun finishSizePrefixedEquipmentRemark_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EQUI")
    }
}
