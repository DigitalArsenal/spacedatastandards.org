 ...
 */
@Suppress("unused")
class IonoObservationRange_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationRange_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationRange_Abridged(_bb: ByteBuffer): IonoObservationRange_Abridged = getRootAsIonoObservationRange_Abridged(_bb, IonoObservationRange_Abridged())
        fun getRootAsIonoObservationRange_Abridged(_bb: ByteBuffer, obj: IonoObservationRange_Abridged): IonoObservationRange_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationRange_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationRange_Abridged(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int) : Int {
            ...
            return endIonoObservationRange_Abridged(builder)
        }
        fun startIonoObservationRange_Abridged(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationRange_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationRangeAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationRange_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
