 ...
 */
@Suppress("unused")
class FlightPlanMessages_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : FlightPlanMessages_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsFlightPlanMessages_Full(_bb: ByteBuffer): FlightPlanMessages_Full = getRootAsFlightPlanMessages_Full(_bb, FlightPlanMessages_Full())
        fun getRootAsFlightPlanMessages_Full(_bb: ByteBuffer, obj: FlightPlanMessages_Full): FlightPlanMessages_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun FlightPlanMessages_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "FLIG")
        fun createFlightPlanMessages_Full(builder: FlatBufferBuilder, severityOffset: Int, wpNumOffset: Int, routePathOffset: Int, msgTextOffset: Int) : Int {
            ...
            return endFlightPlanMessages_Full(builder)
        }
        fun startFlightPlanMessages_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endFlightPlanMessages_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishFlightPlanMessagesFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "FLIG")
        fun finishSizePrefixedFlightPlanMessages_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "FLIG")
    }
}
