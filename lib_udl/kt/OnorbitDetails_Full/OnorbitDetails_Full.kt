 ...
 */
@Suppress("unused")
class OnorbitDetails_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitDetails_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createOnorbitDetails_Full(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, classificationMarkingOffset: Int, lastObTimeOffset: Int, vismag: Double, vismagMin: Double, vismagMax: Double, vismagMean: Double, rcs: Double, rcsMin: Double, rcsMax: Double, rcsMean: Double, bolDeltaV: Double, maxDeltaV: Double, deltaVunc: Double, estDeltaVduration: Double, numMission: Int, missionTypesOffset: Int, busTypeOffset: Int, geoSlot: Double, driftRate: Double, dryMass: Double, additionalMass: Double, launchMassMin: Double, launchMass: Double, launchMassMax: Double, bolFuelMass: Double, currentMass: Double, totalMassUnc: Double, solarArrayArea: Double, maneuverable: Boolean, fuelRemaining: Double, crossSection: Double, busCrossSection: Double, maxRadius: Double, colaRadius: Double, adeptRadius: Double, numDeployable: Int, depNamesOffset: Int, depEstMassesOffset: Int, depMassUncsOffset: Int, sourceOffset: Int, originOffset: Int, lastObSourceOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endOnorbitDetails_Full(builder)
        }
        fun startOnorbitDetails_Full(builder: FlatBufferBuilder) = builder.startTable(50)
        ...
        fun endOnorbitDetails_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitDetailsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitDetails_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
