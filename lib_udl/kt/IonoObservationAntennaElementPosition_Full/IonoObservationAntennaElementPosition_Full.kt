 ...
 */
@Suppress("unused")
class IonoObservationAntennaElementPosition_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationAntennaElementPosition_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationAntennaElementPosition_Full(_bb: ByteBuffer): IonoObservationAntennaElementPosition_Full = getRootAsIonoObservationAntennaElementPosition_Full(_bb, IonoObservationAntennaElementPosition_Full())
        fun getRootAsIonoObservationAntennaElementPosition_Full(_bb: ByteBuffer, obj: IonoObservationAntennaElementPosition_Full): IonoObservationAntennaElementPosition_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationAntennaElementPosition_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationAntennaElementPosition_Full(builder: FlatBufferBuilder, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int) : Int {
            builder.startTable(3)
            addData(builder, dataOffset)
            addDimensionName(builder, dimensionNameOffset)
            addDimensions(builder, dimensionsOffset)
            return endIonoObservationAntennaElementPosition_Full(builder)
        }
        fun startIonoObservationAntennaElementPosition_Full(builder: FlatBufferBuilder) = builder.startTable(3)
        ...
        fun endIonoObservationAntennaElementPosition_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationAntennaElementPositionFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationAntennaElementPosition_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
