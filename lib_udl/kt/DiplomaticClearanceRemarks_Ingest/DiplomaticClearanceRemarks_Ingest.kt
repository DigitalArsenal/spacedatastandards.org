 ...
 */
@Suppress("unused")
class DiplomaticClearanceRemarks_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DiplomaticClearanceRemarks_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDiplomaticClearanceRemarks_Ingest(_bb: ByteBuffer): DiplomaticClearanceRemarks_Ingest = getRootAsDiplomaticClearanceRemarks_Ingest(_bb, DiplomaticClearanceRemarks_Ingest())
        fun getRootAsDiplomaticClearanceRemarks_Ingest(_bb: ByteBuffer, obj: DiplomaticClearanceRemarks_Ingest): DiplomaticClearanceRemarks_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DiplomaticClearanceRemarks_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DIPL")
        fun createDiplomaticClearanceRemarks_Ingest(builder: FlatBufferBuilder, gdssRemarkIdOffset: Int, textOffset: Int, dateOffset: Int, userOffset: Int) : Int {
            ...
            return endDiplomaticClearanceRemarks_Ingest(builder)
        }
        fun startDiplomaticClearanceRemarks_Ingest(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endDiplomaticClearanceRemarks_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDiplomaticClearanceRemarksIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DIPL")
        fun finishSizePrefixedDiplomaticClearanceRemarks_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DIPL")
    }
}
