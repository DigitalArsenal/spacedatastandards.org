 ...
 */
@Suppress("unused")
class AirTaskingOrder_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirTaskingOrder_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirTaskingOrder_Ingest(_bb: ByteBuffer): AirTaskingOrder_Ingest = getRootAsAirTaskingOrder_Ingest(_bb, AirTaskingOrder_Ingest())
        fun getRootAsAirTaskingOrder_Ingest(_bb: ByteBuffer, obj: AirTaskingOrder_Ingest): AirTaskingOrder_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirTaskingOrder_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRT")
        fun createAirTaskingOrder_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, rawFileUriOffset: Int, opExerNameOffset: Int, msgOriginatorOffset: Int, msgSnOffset: Int, msgMonthOffset: Int, msgQualifierOffset: Int, ackReqIndOffset: Int, ackUnitInstructionsOffset: Int, beginTsOffset: Int, endTsOffset: Int, genTextOffset: Int, acMsnTaskingOffset: Int, navalFltOpsOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, sourceDlOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endAirTaskingOrder_Ingest(builder)
        }
        fun startAirTaskingOrder_Ingest(builder: FlatBufferBuilder) = builder.startTable(22)
        ...
        fun endAirTaskingOrder_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirTaskingOrderIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRT")
        fun finishSizePrefixedAirTaskingOrder_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRT")
    }
}
