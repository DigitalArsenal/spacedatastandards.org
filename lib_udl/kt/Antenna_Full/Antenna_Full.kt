 ...
 */
@Suppress("unused")
class Antenna_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Antenna_Full {
        __init(_i, _bb)
        return this
    }
    /**
     ...
     * Constraints: No constraints specified.
     */
    fun antennaDetails(j: Int) : String? {
        val o = __offset(24)
        return if (o != 0) {
    ...
    val antennaDetailsLength : Int
        get() {
            val o = __offset(24); return if (o != 0) __vector_len(o) else 0
        }
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsAntenna_Full(_bb: ByteBuffer): Antenna_Full = getRootAsAntenna_Full(_bb, Antenna_Full())
        fun getRootAsAntenna_Full(_bb: ByteBuffer, obj: Antenna_Full): Antenna_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Antenna_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ANTE")
        fun createAntenna_Full(builder: FlatBufferBuilder, idOffset: Int, nameOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, antennaDetailsOffset: Int) : Int {
            builder.startTable(11)
            addAntennaDetails(builder, antennaDetailsOffset)
            ...
            return endAntenna_Full(builder)
        }
        fun startAntenna_Full(builder: FlatBufferBuilder) = builder.startTable(11)
        ...
        fun addAntennaDetails(builder: FlatBufferBuilder, antennaDetails: Int) = builder.addOffset(10, antennaDetails, 0)
        fun createAntennaDetailsVector(builder: FlatBufferBuilder, data: IntArray) : Int {
        ...
        fun startAntennaDetailsVector(builder: FlatBufferBuilder, numElems: Int) = builder.startVector(4, numElems, 4)
        fun endAntenna_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAntennaFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ANTE")
        fun finishSizePrefixedAntenna_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ANTE")
    }
}
