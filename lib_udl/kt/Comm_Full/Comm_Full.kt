 ...
 */
@Suppress("unused")
class Comm_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Comm_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsComm_Full(_bb: ByteBuffer): Comm_Full = getRootAsComm_Full(_bb, Comm_Full())
        fun getRootAsComm_Full(_bb: ByteBuffer, obj: Comm_Full): Comm_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Comm_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "COMM")
        fun createComm_Full(builder: FlatBufferBuilder, idOffset: Int, idEntityOffset: Int, nameOffset: Int, classificationMarkingOffset: Int, descriptionOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, entityOffset: Int, transpondersOffset: Int) : Int {
            ...
            return endComm_Full(builder)
        }
        fun startComm_Full(builder: FlatBufferBuilder) = builder.startTable(15)
        ...
        fun addTransponders(builder: FlatBufferBuilder, transponders: Int) = builder.addOffset(14, transponders, 0)
        ...
        fun endComm_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishCommFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "COMM")
        fun finishSizePrefixedComm_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "COMM")
    }
}
