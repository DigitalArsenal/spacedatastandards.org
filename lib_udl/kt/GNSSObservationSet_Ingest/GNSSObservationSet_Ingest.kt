 ...
 */
@Suppress("unused")
class GNSSObservationSet_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : GNSSObservationSet_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createGNSSObservationSet_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, markerTypeOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, tsOffset: Int, outage: Int, gDop: Double, hDop: Double, pDop: Double, tDop: Double, vDop: Double, esIdOffset: Int, receiverOffset: Int, boresightOffset: Int, quatOffset: Int, lat: Double, lon: Double, alt: Double, satVelocityOffset: Int, obsCodesOffset: Int, trackingStatus: Int, navigationStatusOffset: Int, agcState: Int, srcTypsOffset: Int, srcIdsOffset: Int, tagsOffset: Int, transactionIdOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int, gnssObservationListOffset: Int) : Int {
            ...
            return endGNSSObservationSet_Ingest(builder)
        }
        fun startGNSSObservationSet_Ingest(builder: FlatBufferBuilder) = builder.startTable(36)
        ...
        fun endGNSSObservationSet_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishGNSSObservationSetIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "GNSS")
        fun finishSizePrefixedGNSSObservationSet_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "GNSS")
    }
}
