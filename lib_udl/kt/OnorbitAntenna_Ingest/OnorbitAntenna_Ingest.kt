 ...
 */
@Suppress("unused")
class OnorbitAntenna_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitAntenna_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbitAntenna_Ingest(_bb: ByteBuffer): OnorbitAntenna_Ingest = getRootAsOnorbitAntenna_Ingest(_bb, OnorbitAntenna_Ingest())
        fun getRootAsOnorbitAntenna_Ingest(_bb: ByteBuffer, obj: OnorbitAntenna_Ingest): OnorbitAntenna_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitAntenna_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitAntenna_Ingest(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, idAntennaOffset: Int, classificationMarkingOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, antennaOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endOnorbitAntenna_Ingest(builder)
        }
        fun startOnorbitAntenna_Ingest(builder: FlatBufferBuilder) = builder.startTable(11)
        ...
        fun endOnorbitAntenna_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitAntennaIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitAntenna_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
