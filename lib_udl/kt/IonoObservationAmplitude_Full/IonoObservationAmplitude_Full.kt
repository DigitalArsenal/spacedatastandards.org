 ...
 */
@Suppress("unused")
class IonoObservationAmplitude_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationAmplitude_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationAmplitude_Full(_bb: ByteBuffer): IonoObservationAmplitude_Full = getRootAsIonoObservationAmplitude_Full(_bb, IonoObservationAmplitude_Full())
        fun getRootAsIonoObservationAmplitude_Full(_bb: ByteBuffer, obj: IonoObservationAmplitude_Full): IonoObservationAmplitude_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationAmplitude_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationAmplitude_Full(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int) : Int {
            ...
            return endIonoObservationAmplitude_Full(builder)
        }
        fun startIonoObservationAmplitude_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationAmplitude_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationAmplitudeFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationAmplitude_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
