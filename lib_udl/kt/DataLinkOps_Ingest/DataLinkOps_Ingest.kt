 ...
 */
@Suppress("unused")
class DataLinkOps_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DataLinkOps_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDataLinkOps_Ingest(_bb: ByteBuffer): DataLinkOps_Ingest = getRootAsDataLinkOps_Ingest(_bb, DataLinkOps_Ingest())
        fun getRootAsDataLinkOps_Ingest(_bb: ByteBuffer, obj: DataLinkOps_Ingest): DataLinkOps_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DataLinkOps_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DATA")
        fun createDataLinkOps_Ingest(builder: FlatBufferBuilder, linkNameOffset: Int, linkStartTimeOffset: Int, linkStopTimeOffset: Int, linkStopTimeModOffset: Int, linkDetailsOffset: Int) : Int {
            ...
            return endDataLinkOps_Ingest(builder)
        }
        fun startDataLinkOps_Ingest(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endDataLinkOps_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDataLinkOpsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DATA")
        fun finishSizePrefixedDataLinkOps_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DATA")
    }
}
