 ...
 */
@Suppress("unused")
class OnboardNavigation_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnboardNavigation_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOnboardNavigation_Ingest(_bb: ByteBuffer): OnboardNavigation_Ingest = getRootAsOnboardNavigation_Ingest(_bb, OnboardNavigation_Ingest())
        fun getRootAsOnboardNavigation_Ingest(_bb: ByteBuffer, obj: OnboardNavigation_Ingest): OnboardNavigation_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnboardNavigation_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONBO")
        fun createOnboardNavigation_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, startTimeOffset: Int, endTimeOffset: Int, esIdOffset: Int, starCatNameOffset: Int, starCatLoadTimeOffset: Int, idStateVectorOffset: Int, tsOffset: Int, referenceFrame: Byte, sunSensorOffset: Int, magOffset: Int, starTrackerOffset: Int, deltaPosOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endOnboardNavigation_Ingest(builder)
        }
        fun startOnboardNavigation_Ingest(builder: FlatBufferBuilder) = builder.startTable(23)
        ...
        fun endOnboardNavigation_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnboardNavigationIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONBO")
        fun finishSizePrefixedOnboardNavigation_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONBO")
    }
}
