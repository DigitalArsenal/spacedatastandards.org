 ...
 */
@Suppress("unused")
class GroundImagery_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : GroundImagery_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val transactionIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(46, 1)
    fun transactionIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 46, 1)
    /**
    ...
    val formatAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(54, 1)
    fun formatInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 54, 1)
    /**
    ...
    val checksumValueAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(58, 1)
    fun checksumValueInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 58, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsGroundImagery_Ingest(_bb: ByteBuffer): GroundImagery_Ingest = getRootAsGroundImagery_Ingest(_bb, GroundImagery_Ingest())
        fun getRootAsGroundImagery_Ingest(_bb: ByteBuffer, obj: GroundImagery_Ingest): GroundImagery_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun GroundImagery_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "GROU")
        fun createGroundImagery_Ingest(builder: FlatBufferBuilder, idOffset: Int, idSensorOffset: Int, classificationMarkingOffset: Int, imageTimeOffset: Int, filenameOffset: Int, regionOffset: Int, regionTextOffset: Int, regionGeoJsonOffset: Int, regionTypeOffset: Int, regionNdims: Int, regionSrid: Int, origSensorIdOffset: Int, subjectIdOffset: Int, nameOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, transactionIdOffset: Int, tagsOffset: Int, keywordsOffset: Int, notesOffset: Int, formatOffset: Int, filesize: Long, checksumValueOffset: Int) : Int {
            ...
            return endGroundImagery_Ingest(builder)
        }
        fun startGroundImagery_Ingest(builder: FlatBufferBuilder) = builder.startTable(28)
        ...
        fun addTransactionId(builder: FlatBufferBuilder, transactionId: Int) = builder.addOffset(21, transactionId, 0)
        ...
        fun addKeywords(builder: FlatBufferBuilder, keywords: Int) = builder.addOffset(23, keywords, 0)
        ...
        fun addFormat(builder: FlatBufferBuilder, format: Int) = builder.addOffset(25, format, 0)
        fun addFilesize(builder: FlatBufferBuilder, filesize: Long) = builder.addLong(26, filesize, 0L)
        fun addChecksumValue(builder: FlatBufferBuilder, checksumValue: Int) = builder.addOffset(27, checksumValue, 0)
        fun endGroundImagery_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishGroundImageryIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "GROU")
        fun finishSizePrefixedGroundImagery_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "GROU")
    }
}
