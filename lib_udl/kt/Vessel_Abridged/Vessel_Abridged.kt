 ...
 */
@Suppress("unused")
class Vessel_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Vessel_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val altVesselIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(10, 1)
    fun altVesselIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 10, 1)
    /**
    ...
    val idOrganizationAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(12, 1)
    fun idOrganizationInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 12, 1)
    /**
    ...
    val vesselNameAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(14, 1)
    fun vesselNameInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 14, 1)
    /**
    ...
    val vesselTypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(16, 1)
    fun vesselTypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 16, 1)
    /**
    ...
    val vesselClassAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(18, 1)
    fun vesselClassInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 18, 1)
    /**
    ...
    val vesselDescriptionAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(20, 1)
    fun vesselDescriptionInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 20, 1)
    /**
    ...
    val sconumAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(22, 1)
    fun sconumInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 22, 1)
    /**
    ...
    val mmsiAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(26, 1)
    fun mmsiInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 26, 1)
    /**
    ...
    val yearBuiltAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(32, 1)
    fun yearBuiltInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 32, 1)
    /**
    ...
    val vesselBuilderAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(34, 1)
    fun vesselBuilderInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 34, 1)
    /**
    ...
    val firstSeenAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(38, 1)
    fun firstSeenInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 38, 1)
    /**
    ...
    val sternTypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(50, 1)
    fun sternTypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 50, 1)
    /**
    ...
    val propTypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(56, 1)
    fun propTypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 56, 1)
    /**
    ...
    val hullNumAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(58, 1)
    fun hullNumInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 58, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsVessel_Abridged(_bb: ByteBuffer): Vessel_Abridged = getRootAsVessel_Abridged(_bb, Vessel_Abridged())
        fun getRootAsVessel_Abridged(_bb: ByteBuffer, obj: Vessel_Abridged): Vessel_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Vessel_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "VESS")
        fun createVessel_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idEntityOffset: Int, altVesselIdOffset: Int, idOrganizationOffset: Int, vesselNameOffset: Int, vesselTypeOffset: Int, vesselClassOffset: Int, vesselDescriptionOffset: Int, sconumOffset: Int, imon: Int, mmsiOffset: Int, callsignOffset: Int, vesselFlagOffset: Int, yearBuiltOffset: Int, vesselBuilderOffset: Int, statusOffset: Int, firstSeenOffset: Int, length: Double, width: Double, maxDraught: Double, vslWt: Double, maxSpeed: Double, sternTypeOffset: Int, numBlades: Int, numShafts: Int, propTypeOffset: Int, hullNumOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endVessel_Abridged(builder)
        }
        fun startVessel_Abridged(builder: FlatBufferBuilder) = builder.startTable(34)
        ...
        fun addAltVesselId(builder: FlatBufferBuilder, altVesselId: Int) = builder.addOffset(3, altVesselId, 0)
        fun addIdOrganization(builder: FlatBufferBuilder, idOrganization: Int) = builder.addOffset(4, idOrganization, 0)
        fun addVesselName(builder: FlatBufferBuilder, vesselName: Int) = builder.addOffset(5, vesselName, 0)
        fun addVesselType(builder: FlatBufferBuilder, vesselType: Int) = builder.addOffset(6, vesselType, 0)
        fun addVesselClass(builder: FlatBufferBuilder, vesselClass: Int) = builder.addOffset(7, vesselClass, 0)
        fun addVesselDescription(builder: FlatBufferBuilder, vesselDescription: Int) = builder.addOffset(8, vesselDescription, 0)
        fun addSconum(builder: FlatBufferBuilder, sconum: Int) = builder.addOffset(9, sconum, 0)
        fun addImon(builder: FlatBufferBuilder, imon: Int) = builder.addInt(10, imon, 0)
        fun addMmsi(builder: FlatBufferBuilder, mmsi: Int) = builder.addOffset(11, mmsi, 0)
        ...
        fun addYearBuilt(builder: FlatBufferBuilder, yearBuilt: Int) = builder.addOffset(14, yearBuilt, 0)
        fun addVesselBuilder(builder: FlatBufferBuilder, vesselBuilder: Int) = builder.addOffset(15, vesselBuilder, 0)
        fun addStatus(builder: FlatBufferBuilder, status: Int) = builder.addOffset(16, status, 0)
        fun addFirstSeen(builder: FlatBufferBuilder, firstSeen: Int) = builder.addOffset(17, firstSeen, 0)
        fun addLength(builder: FlatBufferBuilder, length: Double) = builder.addDouble(18, length, 0.0)
        fun addWidth(builder: FlatBufferBuilder, width: Double) = builder.addDouble(19, width, 0.0)
        fun addMaxDraught(builder: FlatBufferBuilder, maxDraught: Double) = builder.addDouble(20, maxDraught, 0.0)
        fun addVslWt(builder: FlatBufferBuilder, vslWt: Double) = builder.addDouble(21, vslWt, 0.0)
        fun addMaxSpeed(builder: FlatBufferBuilder, maxSpeed: Double) = builder.addDouble(22, maxSpeed, 0.0)
        fun addSternType(builder: FlatBufferBuilder, sternType: Int) = builder.addOffset(23, sternType, 0)
        fun addNumBlades(builder: FlatBufferBuilder, numBlades: Int) = builder.addInt(24, numBlades, 0)
        fun addNumShafts(builder: FlatBufferBuilder, numShafts: Int) = builder.addInt(25, numShafts, 0)
        fun addPropType(builder: FlatBufferBuilder, propType: Int) = builder.addOffset(26, propType, 0)
        fun addHullNum(builder: FlatBufferBuilder, hullNum: Int) = builder.addOffset(27, hullNum, 0)
        ...
        fun endVessel_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishVesselAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "VESS")
        fun finishSizePrefixedVessel_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "VESS")
    }
}
