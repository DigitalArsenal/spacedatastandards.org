 ...
 */
@Suppress("unused")
class POI_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : POI_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val atextAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(66, 1)
    fun atextInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 66, 1)
    /**
    ...
    val atypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(70, 1)
    fun atypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 70, 1)
    /**
    ...
    val createdAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(76, 1)
    fun createdAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 76, 1)
    /**
    ...
    val createdByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(78, 1)
    fun createdByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 78, 1)
    /**
    ...
    val sourceAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(82, 1)
    fun sourceInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 82, 1)
    /**
    ...
    val assetAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(90, 1)
    fun assetInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 90, 1)
    /**
    ...
    val beNumberAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(92, 1)
    fun beNumberInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 92, 1)
    /**
    ...
    val transactionIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(98, 1)
    fun transactionIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 98, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsPOI_Abridged(_bb: ByteBuffer): POI_Abridged = getRootAsPOI_Abridged(_bb, POI_Abridged())
        fun getRootAsPOI_Abridged(_bb: ByteBuffer, obj: POI_Abridged): POI_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun POI_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "POIA")
        fun createPOI_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, ppsOffset: Int, msnidOffset: Int, pri: Int, trkidOffset: Int, idWeatherReportOffset: Int, poiidOffset: Int, nameOffset: Int, descOffset: Int, specOffset: Int, identOffset: Int, envOffset: Int, platOffset: Int, activityOffset: Int, tsOffset: Int, startOffset: Int, staleOffset: Int, howOffset: Int, typeOffset: Int, lat: Double, lon: Double, alt: Double, az: Double, el: Double, le: Double, ce: Double, elleOffset: Int, cntctOffset: Int, conf: Double, urlsOffset: Int, atextOffset: Int, agjsonOffset: Int, atypeOffset: Int, andims: Int, asrid: Int, createdAtOffset: Int, createdByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, dataMode: Byte, originOffset: Int, groupsOffset: Int, assetOffset: Int, beNumberOffset: Int, orientation: Double, origNetworkOffset: Int, transactionIdOffset: Int) : Int {
            ...
            return endPOI_Abridged(builder)
        }
        fun startPOI_Abridged(builder: FlatBufferBuilder) = builder.startTable(48)
        ...
        fun addAtext(builder: FlatBufferBuilder, atext: Int) = builder.addOffset(31, atext, 0)
        fun addAgjson(builder: FlatBufferBuilder, agjson: Int) = builder.addOffset(32, agjson, 0)
        fun addAtype(builder: FlatBufferBuilder, atype: Int) = builder.addOffset(33, atype, 0)
        fun addAndims(builder: FlatBufferBuilder, andims: Int) = builder.addInt(34, andims, 0)
        fun addAsrid(builder: FlatBufferBuilder, asrid: Int) = builder.addInt(35, asrid, 0)
        fun addCreatedAt(builder: FlatBufferBuilder, createdAt: Int) = builder.addOffset(36, createdAt, 0)
        fun addCreatedBy(builder: FlatBufferBuilder, createdBy: Int) = builder.addOffset(37, createdBy, 0)
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(38, sourceDl, 0)
        fun addSource(builder: FlatBufferBuilder, source: Int) = builder.addOffset(39, source, 0)
        ...
        fun addGroups(builder: FlatBufferBuilder, groups: Int) = builder.addOffset(42, groups, 0)
        ...
        fun addAsset(builder: FlatBufferBuilder, asset: Int) = builder.addOffset(43, asset, 0)
        fun addBeNumber(builder: FlatBufferBuilder, beNumber: Int) = builder.addOffset(44, beNumber, 0)
        fun addOrientation(builder: FlatBufferBuilder, orientation: Double) = builder.addDouble(45, orientation, 0.0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(46, origNetwork, 0)
        fun addTransactionId(builder: FlatBufferBuilder, transactionId: Int) = builder.addOffset(47, transactionId, 0)
        fun endPOI_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishPOIAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "POIA")
        fun finishSizePrefixedPOI_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "POIA")
    }
}
