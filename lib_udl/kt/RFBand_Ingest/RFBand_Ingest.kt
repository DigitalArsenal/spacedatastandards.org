 ...
 */
@Suppress("unused")
class RFBand_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : RFBand_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createRFBand_Ingest(builder: FlatBufferBuilder, idOffset: Int, idEntityOffset: Int, classificationMarkingOffset: Int, nameOffset: Int, bandOffset: Int, mode: Byte, purpose: Byte, freqMin: Double, freqMax: Double, centerFreq: Double, peakGain: Double, edgeGain: Double, bandwidth: Double, beamwidth: Double, polarization: Byte, erp: Double, eirp: Double, sourceOffset: Int, originOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endRFBand_Ingest(builder)
        }
        fun startRFBand_Ingest(builder: FlatBufferBuilder) = builder.startTable(23)
        ...
        fun endRFBand_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishRFBandIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "RFBA")
        fun finishSizePrefixedRFBand_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "RFBA")
    }
}
