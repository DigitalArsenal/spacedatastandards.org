 ...
 */
@Suppress("unused")
class SkyImagery_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SkyImagery_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val idAttitudeSetAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(12, 1)
    fun idAttitudeSetInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 12, 1)
    /**
    ...
    val imageTypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(36, 1)
    fun imageTypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 36, 1)
    /**
    ...
    val expStartTimeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(38, 1)
    fun expStartTimeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 38, 1)
    /**
    ...
    val expEndTimeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(40, 1)
    fun expEndTimeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 40, 1)
    /**
    ...
    val imageSourceInfoAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(42, 1)
    fun imageSourceInfoInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 42, 1)
    /**
    ...
    val imageSetIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(52, 1)
    fun imageSetIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 52, 1)
    /**
    ...
    val annotationKeyAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(72, 1)
    fun annotationKeyInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 72, 1)
    /**
    ...
    val calibrationKeyAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(74, 1)
    fun calibrationKeyInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 74, 1)
    /**
    ...
    val filenameAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(76, 1)
    fun filenameInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 76, 1)
    /**
    ...
    val checksumValueAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(80, 1)
    fun checksumValueInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 80, 1)
    /**
    ...
    val transactionIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(82, 1)
    fun transactionIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 82, 1)
    /**
    ...
    val origNetworkAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(90, 1)
    fun origNetworkInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 90, 1)
    /**
    ...
    val descriptionAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(94, 1)
    fun descriptionInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 94, 1)
    /**
    ...
    val createdAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(98, 1)
    fun createdAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 98, 1)
    /**
    ...
    val createdByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(100, 1)
    fun createdByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 100, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsSkyImagery_Abridged(_bb: ByteBuffer): SkyImagery_Abridged = getRootAsSkyImagery_Abridged(_bb, SkyImagery_Abridged())
        fun getRootAsSkyImagery_Abridged(_bb: ByteBuffer, obj: SkyImagery_Abridged): SkyImagery_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SkyImagery_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SKYI")
        fun createSkyImagery_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, origObjectIdOffset: Int, idAttitudeSetOffset: Int, idSensorOffset: Int, satNo: Int, origSensorIdOffset: Int, senlat: Double, senlon: Double, senalt: Double, senx: Double, seny: Double, senz: Double, senQuatOffset: Int, senQuatDotOffset: Int, imageTypeOffset: Int, expStartTimeOffset: Int, expEndTimeOffset: Int, imageSourceInfoOffset: Int, topLeftStartAz: Double, topLeftStartEl: Double, topLeftStopAz: Double, topLeftStopEl: Double, imageSetIdOffset: Int, imageSetLength: Int, sequenceId: Int, frameFovwidth: Double, frameFovheight: Double, pixelFovwidth: Double, pixelFovheight: Double, frameWidthPixels: Int, frameHeightPixels: Int, pixelBitDepth: Int, annotationKeyOffset: Int, calibrationKeyOffset: Int, filenameOffset: Int, filesize: Long, checksumValueOffset: Int, transactionIdOffset: Int, tagsOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int, descriptionOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int) : Int {
            ...
            return endSkyImagery_Abridged(builder)
        }
        fun startSkyImagery_Abridged(builder: FlatBufferBuilder) = builder.startTable(49)
        ...
        fun addIdAttitudeSet(builder: FlatBufferBuilder, idAttitudeSet: Int) = builder.addOffset(4, idAttitudeSet, 0)
        ...
        fun addSenlat(builder: FlatBufferBuilder, senlat: Double) = builder.addDouble(8, senlat, 0.0)
        fun addSenlon(builder: FlatBufferBuilder, senlon: Double) = builder.addDouble(9, senlon, 0.0)
        fun addSenalt(builder: FlatBufferBuilder, senalt: Double) = builder.addDouble(10, senalt, 0.0)
        fun addSenx(builder: FlatBufferBuilder, senx: Double) = builder.addDouble(11, senx, 0.0)
        fun addSeny(builder: FlatBufferBuilder, seny: Double) = builder.addDouble(12, seny, 0.0)
        fun addSenz(builder: FlatBufferBuilder, senz: Double) = builder.addDouble(13, senz, 0.0)
        fun addSenQuat(builder: FlatBufferBuilder, senQuat: Int) = builder.addOffset(14, senQuat, 0)
        ...
        fun addSenQuatDot(builder: FlatBufferBuilder, senQuatDot: Int) = builder.addOffset(15, senQuatDot, 0)
        ...
        fun addImageType(builder: FlatBufferBuilder, imageType: Int) = builder.addOffset(16, imageType, 0)
        fun addExpStartTime(builder: FlatBufferBuilder, expStartTime: Int) = builder.addOffset(17, expStartTime, 0)
        fun addExpEndTime(builder: FlatBufferBuilder, expEndTime: Int) = builder.addOffset(18, expEndTime, 0)
        fun addImageSourceInfo(builder: FlatBufferBuilder, imageSourceInfo: Int) = builder.addOffset(19, imageSourceInfo, 0)
        fun addTopLeftStartAz(builder: FlatBufferBuilder, topLeftStartAz: Double) = builder.addDouble(20, topLeftStartAz, 0.0)
        fun addTopLeftStartEl(builder: FlatBufferBuilder, topLeftStartEl: Double) = builder.addDouble(21, topLeftStartEl, 0.0)
        fun addTopLeftStopAz(builder: FlatBufferBuilder, topLeftStopAz: Double) = builder.addDouble(22, topLeftStopAz, 0.0)
        fun addTopLeftStopEl(builder: FlatBufferBuilder, topLeftStopEl: Double) = builder.addDouble(23, topLeftStopEl, 0.0)
        fun addImageSetId(builder: FlatBufferBuilder, imageSetId: Int) = builder.addOffset(24, imageSetId, 0)
        fun addImageSetLength(builder: FlatBufferBuilder, imageSetLength: Int) = builder.addInt(25, imageSetLength, 0)
        fun addSequenceId(builder: FlatBufferBuilder, sequenceId: Int) = builder.addInt(26, sequenceId, 0)
        fun addFrameFOVWidth(builder: FlatBufferBuilder, frameFovwidth: Double) = builder.addDouble(27, frameFovwidth, 0.0)
        fun addFrameFOVHeight(builder: FlatBufferBuilder, frameFovheight: Double) = builder.addDouble(28, frameFovheight, 0.0)
        fun addPixelFOVWidth(builder: FlatBufferBuilder, pixelFovwidth: Double) = builder.addDouble(29, pixelFovwidth, 0.0)
        fun addPixelFOVHeight(builder: FlatBufferBuilder, pixelFovheight: Double) = builder.addDouble(30, pixelFovheight, 0.0)
        fun addFrameWidthPixels(builder: FlatBufferBuilder, frameWidthPixels: Int) = builder.addInt(31, frameWidthPixels, 0)
        fun addFrameHeightPixels(builder: FlatBufferBuilder, frameHeightPixels: Int) = builder.addInt(32, frameHeightPixels, 0)
        fun addPixelBitDepth(builder: FlatBufferBuilder, pixelBitDepth: Int) = builder.addInt(33, pixelBitDepth, 0)
        fun addAnnotationKey(builder: FlatBufferBuilder, annotationKey: Int) = builder.addOffset(34, annotationKey, 0)
        fun addCalibrationKey(builder: FlatBufferBuilder, calibrationKey: Int) = builder.addOffset(35, calibrationKey, 0)
        fun addFilename(builder: FlatBufferBuilder, filename: Int) = builder.addOffset(36, filename, 0)
        fun addFilesize(builder: FlatBufferBuilder, filesize: Long) = builder.addLong(37, filesize, 0L)
        fun addChecksumValue(builder: FlatBufferBuilder, checksumValue: Int) = builder.addOffset(38, checksumValue, 0)
        fun addTransactionId(builder: FlatBufferBuilder, transactionId: Int) = builder.addOffset(39, transactionId, 0)
        fun addTags(builder: FlatBufferBuilder, tags: Int) = builder.addOffset(40, tags, 0)
        ...
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(43, origNetwork, 0)
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(44, sourceDl, 0)
        fun addDescription(builder: FlatBufferBuilder, description: Int) = builder.addOffset(45, description, 0)
        fun addDataMode(builder: FlatBufferBuilder, dataMode: Byte) = builder.addByte(46, dataMode, 0)
        fun addCreatedAt(builder: FlatBufferBuilder, createdAt: Int) = builder.addOffset(47, createdAt, 0)
        fun addCreatedBy(builder: FlatBufferBuilder, createdBy: Int) = builder.addOffset(48, createdBy, 0)
        fun endSkyImagery_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSkyImageryAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SKYI")
        fun finishSizePrefixedSkyImagery_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SKYI")
    }
}
