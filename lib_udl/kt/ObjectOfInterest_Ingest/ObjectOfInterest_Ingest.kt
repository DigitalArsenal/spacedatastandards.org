 ...
 */
@Suppress("unused")
class ObjectOfInterest_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : ObjectOfInterest_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createObjectOfInterest_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, satNo: Int, nameOffset: Int, sensorTaskingStartTimeOffset: Int, sensorTaskingStopTimeOffset: Int, priority: Int, statusOffset: Int, statusDateOffset: Int, descriptionOffset: Int, lastObTimeOffset: Int, missedObTimeOffset: Int, deltaVsOffset: Int, deltaTsOffset: Int, svEpochOffset: Int, x: Double, y: Double, z: Double, xvel: Double, yvel: Double, zvel: Double, elsetEpochOffset: Int, meanMotion: Double, eccentricity: Double, inclination: Double, raan: Double, argOfPerigee: Double, meanAnomaly: Double, revNo: Int, bStar: Double, meanMotionDot: Double, meanMotionDdot: Double, semiMajorAxis: Double, period: Double, apogee: Double, perigee: Double, affectedObjectsOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endObjectOfInterest_Ingest(builder)
        }
        fun startObjectOfInterest_Ingest(builder: FlatBufferBuilder) = builder.startTable(44)
        ...
        fun endObjectOfInterest_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishObjectOfInterestIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "OBJE")
        fun finishSizePrefixedObjectOfInterest_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "OBJE")
    }
}
