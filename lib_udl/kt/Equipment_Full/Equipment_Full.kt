 ...
 */
@Suppress("unused")
class Equipment_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Equipment_Full {
        __init(_i, _bb)
        return this
    }
    /**
     ...
     * Constraints: No constraints specified.
     */
    fun equipmentRemarks(j: Int) : String? {
        val o = __offset(100)
        return if (o != 0) {
            __string(__vector(o) + j * 4)
        } else {
    ...
    val equipmentRemarksLength : Int
        get() {
    ...
    val createdAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(102, 1)
    fun createdAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 102, 1)
    /**
    ...
    val createdByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(104, 1)
    fun createdByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 104, 1)
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(106, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 106, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(108, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 108, 1)
    /**
     * Source of the data.
    ...
    companion object {
        ...
        fun createEquipment_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idParentEquipmentOffset: Int, idSiteOffset: Int, idOperatingUnitOffset: Int, altEqpIdOffset: Int, eqpCodeOffset: Int, eqpIdNumOffset: Int, countryCodeOffset: Int, altCountryCodeOffset: Int, wacOffset: Int, seqNum: Int, nomenOffset: Int, operStatusOffset: Int, conditionOffset: Int, conditionAvailOffset: Int, eval: Int, fpaOffset: Int, functionOffset: Int, identOffset: Int, allegianceOffset: Int, altAllegianceOffset: Int, locReasonOffset: Int, operAreaPrimaryOffset: Int, functPrimaryOffset: Int, coordDatumOffset: Int, coordOffset: Int, coordDerivAcc: Double, lat: Double, lon: Double, elevMsl: Double, elevMslConfLvl: Int, elevMslDerivAcc: Double, geoidalMslSep: Double, milGridSysOffset: Int, milGridOffset: Int, utmOffset: Int, airDefAreaOffset: Int, polSubdivOffset: Int, qtyOh: Int, symCodeOffset: Int, classRatingOffset: Int, recStatusOffset: Int, reviewDateOffset: Int, resProdOffset: Int, referenceDocOffset: Int, srcTypsOffset: Int, srcIdsOffset: Int, equipmentRemarksOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte) : Int {
            ...
            addEquipmentRemarks(builder, equipmentRemarksOffset)
            ...
            return endEquipment_Full(builder)
        }
        fun startEquipment_Full(builder: FlatBufferBuilder) = builder.startTable(56)
        ...
        fun addEquipmentRemarks(builder: FlatBufferBuilder, equipmentRemarks: Int) = builder.addOffset(48, equipmentRemarks, 0)
        fun createEquipmentRemarksVector(builder: FlatBufferBuilder, data: IntArray) : Int {
            builder.startVector(4, data.size, 4)
            for (i in data.size - 1 downTo 0) {
                builder.addOffset(data[i])
            }
        ...
        fun startEquipmentRemarksVector(builder: FlatBufferBuilder, numElems: Int) = builder.startVector(4, numElems, 4)
        fun addCreatedAt(builder: FlatBufferBuilder, createdAt: Int) = builder.addOffset(49, createdAt, 0)
        fun addCreatedBy(builder: FlatBufferBuilder, createdBy: Int) = builder.addOffset(50, createdBy, 0)
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(51, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(52, updatedBy, 0)
        ...
        fun endEquipment_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEquipmentFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EQUI")
        fun finishSizePrefixedEquipment_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EQUI")
    }
}
