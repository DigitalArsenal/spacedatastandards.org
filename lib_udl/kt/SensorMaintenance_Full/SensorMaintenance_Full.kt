 ...
 */
@Suppress("unused")
class SensorMaintenance_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SensorMaintenance_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSensorMaintenance_Full(_bb: ByteBuffer): SensorMaintenance_Full = getRootAsSensorMaintenance_Full(_bb, SensorMaintenance_Full())
        fun getRootAsSensorMaintenance_Full(_bb: ByteBuffer, obj: SensorMaintenance_Full): SensorMaintenance_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SensorMaintenance_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SENS")
        fun createSensorMaintenance_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, siteCodeOffset: Int, idSensorOffset: Int, startTimeOffset: Int, endTimeOffset: Int, recallOffset: Int, durationOffset: Int, mwOpsCapOffset: Int, ssOpsCapOffset: Int, mdOpsCapOffset: Int, impactedFacesOffset: Int, equipStatusOffset: Int, activityOffset: Int, remarkOffset: Int, requestorOffset: Int, changerOffset: Int, approverOffset: Int, eowIdOffset: Int, revOffset: Int, priorityOffset: Int, relOffset: Int, lineNumberOffset: Int, resourceOffset: Int, inactiveDateOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int, updatedAtOffset: Int, updatedByOffset: Int) : Int {
            ...
            return endSensorMaintenance_Full(builder)
        }
        fun startSensorMaintenance_Full(builder: FlatBufferBuilder) = builder.startTable(33)
        ...
        fun endSensorMaintenance_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSensorMaintenanceFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SENS")
        fun finishSizePrefixedSensorMaintenance_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SENS")
    }
}
