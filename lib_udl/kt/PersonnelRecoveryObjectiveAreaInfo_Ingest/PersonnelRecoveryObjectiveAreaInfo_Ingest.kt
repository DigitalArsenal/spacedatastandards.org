 ...
 */
@Suppress("unused")
class PersonnelRecoveryObjectiveAreaInfo_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : PersonnelRecoveryObjectiveAreaInfo_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsPersonnelRecoveryObjectiveAreaInfo_Ingest(_bb: ByteBuffer): PersonnelRecoveryObjectiveAreaInfo_Ingest = getRootAsPersonnelRecoveryObjectiveAreaInfo_Ingest(_bb, PersonnelRecoveryObjectiveAreaInfo_Ingest())
        fun getRootAsPersonnelRecoveryObjectiveAreaInfo_Ingest(_bb: ByteBuffer, obj: PersonnelRecoveryObjectiveAreaInfo_Ingest): PersonnelRecoveryObjectiveAreaInfo_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun PersonnelRecoveryObjectiveAreaInfo_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "PERS")
        fun createPersonnelRecoveryObjectiveAreaInfo_Ingest(builder: FlatBufferBuilder, pzLocationOffset: Int, pzDescOffset: Int, oscCallSignOffset: Int, oscFreq: Double, enemyDataOffset: Int) : Int {
            ...
            return endPersonnelRecoveryObjectiveAreaInfo_Ingest(builder)
        }
        fun startPersonnelRecoveryObjectiveAreaInfo_Ingest(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endPersonnelRecoveryObjectiveAreaInfo_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishPersonnelRecoveryObjectiveAreaInfoIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "PERS")
        fun finishSizePrefixedPersonnelRecoveryObjectiveAreaInfo_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "PERS")
    }
}
