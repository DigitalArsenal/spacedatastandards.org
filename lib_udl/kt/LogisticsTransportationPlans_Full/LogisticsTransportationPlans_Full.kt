 ...
 */
@Suppress("unused")
class LogisticsTransportationPlans_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LogisticsTransportationPlans_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLogisticsTransportationPlans_Full(_bb: ByteBuffer): LogisticsTransportationPlans_Full = getRootAsLogisticsTransportationPlans_Full(_bb, LogisticsTransportationPlans_Full())
        fun getRootAsLogisticsTransportationPlans_Full(_bb: ByteBuffer, obj: LogisticsTransportationPlans_Full): LogisticsTransportationPlans_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LogisticsTransportationPlans_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOGI")
        fun createLogisticsTransportationPlans_Full(builder: FlatBufferBuilder, plansNumberOffset: Int, missionChange: Boolean, planDefinitionOffset: Int, statusCodeOffset: Int, coordinatorOffset: Int, coordinatorUnitOffset: Int, originIcaoOffset: Int, estDepTimeOffset: Int, estArrTimeOffset: Int, destinationIcaoOffset: Int, logisticMasterRecordIdOffset: Int, tpTailNumberOffset: Int, tpAircraftMdsOffset: Int, majcomOffset: Int, approxArrTimeOffset: Int, durationOffset: Int, actDepTimeOffset: Int, closedDateOffset: Int, cancelledDateOffset: Int, aircraftStatusOffset: Int, numEnrouteStops: Int, serialNumberOffset: Int, numTransLoads: Int, lastChangedDateOffset: Int, logisticsSegmentsOffset: Int, logisticsTransportationPlansRemarksOffset: Int) : Int {
            ...
            return endLogisticsTransportationPlans_Full(builder)
        }
        fun startLogisticsTransportationPlans_Full(builder: FlatBufferBuilder) = builder.startTable(26)
        ...
        fun endLogisticsTransportationPlans_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLogisticsTransportationPlansFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOGI")
        fun finishSizePrefixedLogisticsTransportationPlans_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOGI")
    }
}
