 ...
 */
@Suppress("unused")
class SolarArrayDetails_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SolarArrayDetails_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val manufacturerOrgAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(42, 1)
    fun manufacturerOrgInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 42, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsSolarArrayDetails_Full(_bb: ByteBuffer): SolarArrayDetails_Full = getRootAsSolarArrayDetails_Full(_bb, SolarArrayDetails_Full())
        fun getRootAsSolarArrayDetails_Full(_bb: ByteBuffer, obj: SolarArrayDetails_Full): SolarArrayDetails_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SolarArrayDetails_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SOLA")
        fun createSolarArrayDetails_Full(builder: FlatBufferBuilder, idOffset: Int, idSolarArrayOffset: Int, classificationMarkingOffset: Int, typeOffset: Int, technologyOffset: Int, junctionTechnologyOffset: Int, manufacturerOrgIdOffset: Int, span: Double, area: Double, descriptionOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, tagsOffset: Int, manufacturerOrgOffset: Int) : Int {
            ...
            return endSolarArrayDetails_Full(builder)
        }
        fun startSolarArrayDetails_Full(builder: FlatBufferBuilder) = builder.startTable(20)
        ...
        fun addTags(builder: FlatBufferBuilder, tags: Int) = builder.addOffset(18, tags, 0)
        ...
        fun addManufacturerOrg(builder: FlatBufferBuilder, manufacturerOrg: Int) = builder.addOffset(19, manufacturerOrg, 0)
        fun endSolarArrayDetails_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSolarArrayDetailsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SOLA")
        fun finishSizePrefixedSolarArrayDetails_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SOLA")
    }
}
