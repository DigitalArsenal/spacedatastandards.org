 ...
 */
@Suppress("unused")
class PersonnelRecoveryObjectiveAreaInfo_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : PersonnelRecoveryObjectiveAreaInfo_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsPersonnelRecoveryObjectiveAreaInfo_Full(_bb: ByteBuffer): PersonnelRecoveryObjectiveAreaInfo_Full = getRootAsPersonnelRecoveryObjectiveAreaInfo_Full(_bb, PersonnelRecoveryObjectiveAreaInfo_Full())
        fun getRootAsPersonnelRecoveryObjectiveAreaInfo_Full(_bb: ByteBuffer, obj: PersonnelRecoveryObjectiveAreaInfo_Full): PersonnelRecoveryObjectiveAreaInfo_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun PersonnelRecoveryObjectiveAreaInfo_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "PERS")
        fun createPersonnelRecoveryObjectiveAreaInfo_Full(builder: FlatBufferBuilder, pzLocationOffset: Int, pzDescOffset: Int, oscCallSignOffset: Int, oscFreq: Double, enemyDataOffset: Int) : Int {
            ...
            return endPersonnelRecoveryObjectiveAreaInfo_Full(builder)
        }
        fun startPersonnelRecoveryObjectiveAreaInfo_Full(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endPersonnelRecoveryObjectiveAreaInfo_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishPersonnelRecoveryObjectiveAreaInfoFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "PERS")
        fun finishSizePrefixedPersonnelRecoveryObjectiveAreaInfo_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "PERS")
    }
}
