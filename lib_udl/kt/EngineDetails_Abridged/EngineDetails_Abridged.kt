 ...
 */
@Suppress("unused")
class EngineDetails_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EngineDetails_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEngineDetails_Abridged(_bb: ByteBuffer): EngineDetails_Abridged = getRootAsEngineDetails_Abridged(_bb, EngineDetails_Abridged())
        fun getRootAsEngineDetails_Abridged(_bb: ByteBuffer, obj: EngineDetails_Abridged): EngineDetails_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EngineDetails_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ENGI")
        fun createEngineDetails_Abridged(builder: FlatBufferBuilder, idOffset: Int, idEngineOffset: Int, classificationMarkingOffset: Int, familyOffset: Int, cycleTypeOffset: Int, characteristicTypeOffset: Int, manufacturerOrgIdOffset: Int, specificImpulse: Double, burnTime: Double, seaLevelThrust: Double, vacuumThrust: Double, chamberPressure: Double, nozzleExpansionRatio: Double, maxFirings: Int, propellantOffset: Int, oxidizerOffset: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endEngineDetails_Abridged(builder)
        }
        fun startEngineDetails_Abridged(builder: FlatBufferBuilder) = builder.startTable(23)
        ...
        fun endEngineDetails_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEngineDetailsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ENGI")
        fun finishSizePrefixedEngineDetails_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ENGI")
    }
}
