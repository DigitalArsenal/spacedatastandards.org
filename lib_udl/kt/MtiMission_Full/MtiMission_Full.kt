 ...
 */
@Suppress("unused")
class MtiMission_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : MtiMission_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsMtiMission_Full(_bb: ByteBuffer): MtiMission_Full = getRootAsMtiMission_Full(_bb, MtiMission_Full())
        fun getRootAsMtiMission_Full(_bb: ByteBuffer, obj: MtiMission_Full): MtiMission_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun MtiMission_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MTIM")
        fun createMtiMission_Full(builder: FlatBufferBuilder, m1Offset: Int, m2Offset: Int, m3Offset: Int, m4Offset: Int, msnRefTsOffset: Int) : Int {
            ...
            return endMtiMission_Full(builder)
        }
        fun startMtiMission_Full(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endMtiMission_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMtiMissionFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MTIM")
        fun finishSizePrefixedMtiMission_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MTIM")
    }
}
