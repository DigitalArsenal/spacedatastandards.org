 ...
 */
@Suppress("unused")
class BatteryDetails_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : BatteryDetails_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val manufacturerOrgAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(40, 1)
    fun manufacturerOrgInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 40, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsBatteryDetails_Full(_bb: ByteBuffer): BatteryDetails_Full = getRootAsBatteryDetails_Full(_bb, BatteryDetails_Full())
        fun getRootAsBatteryDetails_Full(_bb: ByteBuffer, obj: BatteryDetails_Full): BatteryDetails_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun BatteryDetails_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "BATT")
        fun createBatteryDetails_Full(builder: FlatBufferBuilder, idOffset: Int, idBatteryOffset: Int, classificationMarkingOffset: Int, technologyOffset: Int, capacity: Double, dischargeDepth: Double, modelOffset: Int, descriptionOffset: Int, manufacturerOrgIdOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, tagsOffset: Int, manufacturerOrgOffset: Int) : Int {
            ...
            return endBatteryDetails_Full(builder)
        }
        fun startBatteryDetails_Full(builder: FlatBufferBuilder) = builder.startTable(19)
        ...
        fun addManufacturerOrg(builder: FlatBufferBuilder, manufacturerOrg: Int) = builder.addOffset(18, manufacturerOrg, 0)
        fun endBatteryDetails_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishBatteryDetailsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "BATT")
        fun finishSizePrefixedBatteryDetails_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "BATT")
    }
}
