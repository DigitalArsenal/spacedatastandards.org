 ...
 */
@Suppress("unused")
class EvacCasualtyInfo_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EvacCasualtyInfo_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createEvacCasualtyInfo_Full(builder: FlatBufferBuilder, priorityOffset: Int, evacTypeOffset: Int, casualtyTypeOffset: Int, bodyPartOffset: Int, contamTypeOffset: Int, specMedEquipOffset: Int, casualtyKeyOffset: Int, patientStatusOffset: Int, patientIdentityOffset: Int, nationalityOffset: Int, payGradeOffset: Int, nameOffset: Int, age: Int, genderOffset: Int, last4SsnOffset: Int, bloodTypeOffset: Int, serviceOffset: Int, callSignOffset: Int, occSpecialityOffset: Int, burialLocationOffset: Int, collectionPointOffset: Int, careProviderUrnOffset: Int, dispositionTypeOffset: Int, dispositionOffset: Int, reportGenOffset: Int, reportTimeOffset: Int, commentsOffset: Int, etiologyOffset: Int, treatmentOffset: Int, vitalSignDataOffset: Int, healthStateOffset: Int, conditionOffset: Int, medicationOffset: Int, injuryOffset: Int, allergyOffset: Int) : Int {
            ...
            return endEvacCasualtyInfo_Full(builder)
        }
        fun startEvacCasualtyInfo_Full(builder: FlatBufferBuilder) = builder.startTable(35)
        ...
        fun endEvacCasualtyInfo_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEvacCasualtyInfoFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EVAC")
        fun finishSizePrefixedEvacCasualtyInfo_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EVAC")
    }
}
