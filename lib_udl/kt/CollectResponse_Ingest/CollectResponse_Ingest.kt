 ...
 */
@Suppress("unused")
class CollectResponse_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : CollectResponse_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createCollectResponse_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idRequestOffset: Int, idOnOrbitOffset: Int, origObjectIdOffset: Int, satNo: Int, taskIdOffset: Int, idPlanOffset: Int, externalIdOffset: Int, statusOffset: Int, actualStartTimeOffset: Int, actualEndTimeOffset: Int, altStartTimeOffset: Int, altEndTimeOffset: Int, errCodeOffset: Int, srcTypsOffset: Int, srcIdsOffset: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, idSensorOffset: Int, origSensorIdOffset: Int, dataMode: Byte, tagsOffset: Int) : Int {
            ...
            return endCollectResponse_Ingest(builder)
        }
        fun startCollectResponse_Ingest(builder: FlatBufferBuilder) = builder.startTable(27)
        ...
        fun endCollectResponse_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishCollectResponseIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "COLL")
        fun finishSizePrefixedCollectResponse_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "COLL")
    }
}
