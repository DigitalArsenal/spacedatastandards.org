 ...
 */
@Suppress("unused")
class Channel_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Channel_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsChannel_Abridged(_bb: ByteBuffer): Channel_Abridged = getRootAsChannel_Abridged(_bb, Channel_Abridged())
        fun getRootAsChannel_Abridged(_bb: ByteBuffer, obj: Channel_Abridged): Channel_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Channel_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "CHAN")
        fun createChannel_Abridged(builder: FlatBufferBuilder, idOffset: Int, idTransponderOffset: Int, nameOffset: Int, classificationMarkingOffset: Int, typeOffset: Int, idBeamOffset: Int, beamNameOffset: Int, idRfbandOffset: Int, encryptionOffset: Int, pkgOffset: Int, resOffset: Int, compressionOffset: Int, vpidOffset: Int, apidOffset: Int, sidOffset: Int, ownerOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int) : Int {
            ...
            return endChannel_Abridged(builder)
        }
        fun startChannel_Abridged(builder: FlatBufferBuilder) = builder.startTable(22)
        ...
        fun endChannel_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishChannelAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "CHAN")
        fun finishSizePrefixedChannel_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "CHAN")
    }
}
