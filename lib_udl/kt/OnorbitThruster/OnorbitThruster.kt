 ...
 */
@Suppress("unused")
class OnorbitThruster : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitThruster {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbitThruster(_bb: ByteBuffer): OnorbitThruster = getRootAsOnorbitThruster(_bb, OnorbitThruster())
        fun getRootAsOnorbitThruster(_bb: ByteBuffer, obj: OnorbitThruster): OnorbitThruster {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitThrusterBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitThruster(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, idEngineOffset: Int, classificationMarkingOffset: Int, typeOffset: Int, quantity: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, engineOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endOnorbitThruster(builder)
        }
        fun startOnorbitThruster(builder: FlatBufferBuilder) = builder.startTable(15)
        ...
        fun endOnorbitThruster(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitThrusterBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitThrusterBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
