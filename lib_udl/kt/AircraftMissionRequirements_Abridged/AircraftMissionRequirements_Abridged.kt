 ...
 */
@Suppress("unused")
class AircraftMissionRequirements_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AircraftMissionRequirements_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAircraftMissionRequirements_Abridged(_bb: ByteBuffer): AircraftMissionRequirements_Abridged = getRootAsAircraftMissionRequirements_Abridged(_bb, AircraftMissionRequirements_Abridged())
        fun getRootAsAircraftMissionRequirements_Abridged(_bb: ByteBuffer, obj: AircraftMissionRequirements_Abridged): AircraftMissionRequirements_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AircraftMissionRequirements_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRC")
        fun createAircraftMissionRequirements_Abridged(builder: FlatBufferBuilder, gdssReqIdOffset: Int, onloadId: Int, onloadLocodeOffset: Int, offloadId: Int, offloadLocodeOffset: Int, ulnOffset: Int, transReqNumOffset: Int, projNameOffset: Int, oplanOffset: Int, numPax: Int, numLitter: Int, numAmbulatory: Int, numAttendant: Int, bulkWeight: Double, oversizeWeight: Double, outsizeWeight: Double, eadOffset: Int, ladOffset: Int) : Int {
            ...
            return endAircraftMissionRequirements_Abridged(builder)
        }
        fun startAircraftMissionRequirements_Abridged(builder: FlatBufferBuilder) = builder.startTable(18)
        ...
        fun endAircraftMissionRequirements_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAircraftMissionRequirementsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRC")
        fun finishSizePrefixedAircraftMissionRequirements_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRC")
    }
}
