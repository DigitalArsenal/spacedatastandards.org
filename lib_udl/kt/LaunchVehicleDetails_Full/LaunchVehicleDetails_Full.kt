 ...
 */
@Suppress("unused")
class LaunchVehicleDetails_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LaunchVehicleDetails_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(104, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 104, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(106, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 106, 1)
    /**
     * Source of the data.
    ...
    val sourceAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(108, 1)
    fun sourceInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 108, 1)
    /**
    ...
    val originAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(110, 1)
    fun originInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 110, 1)
    /**
    ...
    val origNetworkAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(112, 1)
    fun origNetworkInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 112, 1)
    /**
    ...
    val manufacturerOrgAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(118, 1)
    fun manufacturerOrgInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 118, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsLaunchVehicleDetails_Full(_bb: ByteBuffer): LaunchVehicleDetails_Full = getRootAsLaunchVehicleDetails_Full(_bb, LaunchVehicleDetails_Full())
        fun getRootAsLaunchVehicleDetails_Full(_bb: ByteBuffer, obj: LaunchVehicleDetails_Full): LaunchVehicleDetails_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LaunchVehicleDetails_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LAUN")
        fun createLaunchVehicleDetails_Full(builder: FlatBufferBuilder, idOffset: Int, idLaunchVehicleOffset: Int, classificationMarkingOffset: Int, variantOffset: Int, minorVariantOffset: Int, categoryOffset: Int, manufacturerOrgIdOffset: Int, launchPrefixOffset: Int, familyOffset: Int, propellantOffset: Int, oxidizerOffset: Int, length: Double, diameter: Double, launchMass: Double, geoPayloadMass: Double, gtoPayloadMass: Double, leoPayloadMass: Double, ssoPayloadMass: Double, fairingLength: Double, fairingNameOffset: Int, fairingExternalDiameter: Double, fairingInternalDiameter: Double, fairingMass: Double, fairingMaterialOffset: Int, maxAccelLoad: Double, maxPayloadFreqLat: Double, maxPayloadFreqLon: Double, maxAcousticLevel: Double, maxAcousticLevelRange: Double, soundPressureLevel: Double, maxFlightShockForce: Double, maxFlightShockFreq: Double, maxFairingPressureChange: Double, estLaunchPrice: Double, estLaunchPriceTypical: Double, gtoInj3SigAccuracyApogeeTarget: Double, gtoInj3SigAccuracyApogeeMargin: Double, gtoInj3SigAccuracyPerigeeTarget: Double, gtoInj3SigAccuracyPerigeeMargin: Double, gtoInj3SigAccuracyInclinationTarget: Double, gtoInj3SigAccuracyInclinationMargin: Double, attitudeAccuracy: Double, payloadSeparationRate: Double, deploymentRotationRate: Double, sourceUrlOffset: Int, notesOffset: Int, fairingNotesOffset: Int, payloadNotesOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, tagsOffset: Int, manufacturerOrgOffset: Int) : Int {
            ...
            return endLaunchVehicleDetails_Full(builder)
        }
        fun startLaunchVehicleDetails_Full(builder: FlatBufferBuilder) = builder.startTable(58)
        ...
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(50, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(51, updatedBy, 0)
        fun addSource(builder: FlatBufferBuilder, source: Int) = builder.addOffset(52, source, 0)
        fun addOrigin(builder: FlatBufferBuilder, origin: Int) = builder.addOffset(53, origin, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(54, origNetwork, 0)
        fun addDataMode(builder: FlatBufferBuilder, dataMode: Byte) = builder.addByte(55, dataMode, 0)
        ...
        fun addManufacturerOrg(builder: FlatBufferBuilder, manufacturerOrg: Int) = builder.addOffset(57, manufacturerOrg, 0)
        fun endLaunchVehicleDetails_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLaunchVehicleDetailsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LAUN")
        fun finishSizePrefixedLaunchVehicleDetails_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LAUN")
    }
}
