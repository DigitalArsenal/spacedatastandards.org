 ...
 */
@Suppress("unused")
class IonoObservationStokes_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationStokes_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationStokes_Ingest(_bb: ByteBuffer): IonoObservationStokes_Ingest = getRootAsIonoObservationStokes_Ingest(_bb, IonoObservationStokes_Ingest())
        fun getRootAsIonoObservationStokes_Ingest(_bb: ByteBuffer, obj: IonoObservationStokes_Ingest): IonoObservationStokes_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationStokes_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationStokes_Ingest(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int, sOffset: Int) : Int {
            ...
            return endIonoObservationStokes_Ingest(builder)
        }
        fun startIonoObservationStokes_Ingest(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endIonoObservationStokes_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationStokesIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationStokes_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
