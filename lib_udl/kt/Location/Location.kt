...
class Location : Table() {
    ...
    fun __assign(_i: Int, _bb: ByteBuffer) : Location {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLocation(_bb: ByteBuffer): Location = getRootAsLocation(_bb, Location())
        fun getRootAsLocation(_bb: ByteBuffer, obj: Location): Location {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LocationBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOCA")
        fun createLocation(builder: FlatBufferBuilder, idLocationOffset: Int, classificationMarkingOffset: Int, nameOffset: Int, countryCodeOffset: Int, lat: Double, lon: Double, altitude: Double, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endLocation(builder)
        }
        fun startLocation(builder: FlatBufferBuilder) = builder.startTable(15)
        ...
        fun endLocation(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLocationBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOCA")
        fun finishSizePrefixedLocationBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOCA")
    }
}
