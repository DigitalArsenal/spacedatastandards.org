 ...
 */
@Suppress("unused")
class LogisticsSupportItems_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LogisticsSupportItems_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLogisticsSupportItems_Abridged(_bb: ByteBuffer): LogisticsSupportItems_Abridged = getRootAsLogisticsSupportItems_Abridged(_bb, LogisticsSupportItems_Abridged())
        fun getRootAsLogisticsSupportItems_Abridged(_bb: ByteBuffer, obj: LogisticsSupportItems_Abridged): LogisticsSupportItems_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LogisticsSupportItems_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOGI")
        fun createLogisticsSupportItems_Abridged(builder: FlatBufferBuilder, recoveryRequestTypeCodeOffset: Int, requestNumberOffset: Int, quantity: Int, descriptionOffset: Int, shipmentUnitIdOffset: Int, redeployShipmentUnitIdOffset: Int, jobControlNumberOffset: Int, sourceIcaoOffset: Int, deployPlanNumberOffset: Int, redeployPlanNumberOffset: Int, cannibalized: Boolean, siPocOffset: Int, readyTimeOffset: Int, receivedTimeOffset: Int, resupportFlag: Boolean, itemLastChangedDateOffset: Int, logisticsPartsOffset: Int, logisticsSpecialtiesOffset: Int, logisticsRemarksOffset: Int) : Int {
            ...
            return endLogisticsSupportItems_Abridged(builder)
        }
        fun startLogisticsSupportItems_Abridged(builder: FlatBufferBuilder) = builder.startTable(19)
        ...
        fun endLogisticsSupportItems_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLogisticsSupportItemsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOGI")
        fun finishSizePrefixedLogisticsSupportItems_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOGI")
    }
}
