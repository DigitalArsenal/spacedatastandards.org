 ...
 */
@Suppress("unused")
class MtiDwell_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : MtiDwell_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsMtiDwell_Full(_bb: ByteBuffer): MtiDwell_Full = getRootAsMtiDwell_Full(_bb, MtiDwell_Full())
        fun getRootAsMtiDwell_Full(_bb: ByteBuffer, obj: MtiDwell_Full): MtiDwell_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun MtiDwell_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MTID")
        fun createMtiDwell_Full(builder: FlatBufferBuilder, d2: Int, d3: Int, d4: Boolean, d5: Int, d6: Long, d7: Double, d8: Double, d9: Int, d10: Double, d11: Double, d12: Int, d13: Int, d14: Int, d15: Double, d16: Int, d17: Int, d18: Int, d19: Int, d20: Int, d21: Double, d22: Double, d23: Double, d24: Double, d25: Double, d26: Double, d27: Double, d28: Double, d29: Double, d30: Double, d31: Int, d32Offset: Int, dwelltsOffset: Int) : Int {
            ...
            addD2(builder, d2)
            addD4(builder, d4)
            return endMtiDwell_Full(builder)
        }
        fun startMtiDwell_Full(builder: FlatBufferBuilder) = builder.startTable(32)
        ...
        fun endMtiDwell_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMtiDwellFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MTID")
        fun finishSizePrefixedMtiDwell_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MTID")
    }
}
