 ...
 */
@Suppress("unused")
class Comm_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Comm_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsComm_Ingest(_bb: ByteBuffer): Comm_Ingest = getRootAsComm_Ingest(_bb, Comm_Ingest())
        fun getRootAsComm_Ingest(_bb: ByteBuffer, obj: Comm_Ingest): Comm_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Comm_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "COMM")
        fun createComm_Ingest(builder: FlatBufferBuilder, idOffset: Int, idEntityOffset: Int, nameOffset: Int, classificationMarkingOffset: Int, descriptionOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, entityOffset: Int) : Int {
            ...
            return endComm_Ingest(builder)
        }
        fun startComm_Ingest(builder: FlatBufferBuilder) = builder.startTable(12)
        ...
        fun endComm_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishCommIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "COMM")
        fun finishSizePrefixedComm_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "COMM")
    }
}
