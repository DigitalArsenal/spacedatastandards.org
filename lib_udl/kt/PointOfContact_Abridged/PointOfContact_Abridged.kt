 ...
 */
@Suppress("unused")
class PointOfContact_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : PointOfContact_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsPointOfContact_Abridged(_bb: ByteBuffer): PointOfContact_Abridged = getRootAsPointOfContact_Abridged(_bb, PointOfContact_Abridged())
        fun getRootAsPointOfContact_Abridged(_bb: ByteBuffer, obj: PointOfContact_Abridged): PointOfContact_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun PointOfContact_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "POIN")
        fun createPointOfContact_Abridged(builder: FlatBufferBuilder, pocSequenceId: Int, pocTypeNameOffset: Int, pocNameOffset: Int, officeOffset: Int, usernameOffset: Int, rankOffset: Int, pocOrgOffset: Int, phoneOffset: Int, remarkOffset: Int) : Int {
            ...
            return endPointOfContact_Abridged(builder)
        }
        fun startPointOfContact_Abridged(builder: FlatBufferBuilder) = builder.startTable(9)
        ...
        fun endPointOfContact_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishPointOfContactAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "POIN")
        fun finishSizePrefixedPointOfContact_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "POIN")
    }
}
