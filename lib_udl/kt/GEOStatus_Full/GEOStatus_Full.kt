 ...
 */
@Suppress("unused")
class GEOStatus_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : GEOStatus_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val onOrbitAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(52, 1)
    fun onOrbitInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 52, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsGEOStatus_Full(_bb: ByteBuffer): GEOStatus_Full = getRootAsGEOStatus_Full(_bb, GEOStatus_Full())
        fun getRootAsGEOStatus_Full(_bb: ByteBuffer, obj: GEOStatus_Full): GEOStatus_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun GEOStatus_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "GEOS")
        fun createGEOStatus_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, origObjectIdOffset: Int, ss: Double, sc: Double, relativeEnergy: Double, longitudeRate: Double, longitudeMin: Double, longitudeMax: Double, confidenceLevelOffset: Int, planeChangeStatusOffset: Int, troughTypeOffset: Int, lostFlag: Boolean, semiAnnualCorrFlag: Boolean, objectStatusOffset: Int, rawFileUriOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, onOrbitOffset: Int, satNo: Int, origNetworkOffset: Int) : Int {
            ...
            return endGEOStatus_Full(builder)
        }
        fun startGEOStatus_Full(builder: FlatBufferBuilder) = builder.startTable(27)
        ...
        fun addOnOrbit(builder: FlatBufferBuilder, onOrbit: Int) = builder.addOffset(24, onOrbit, 0)
        fun addSatNo(builder: FlatBufferBuilder, satNo: Int) = builder.addInt(25, satNo, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(26, origNetwork, 0)
        fun endGEOStatus_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishGEOStatusFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "GEOS")
        fun finishSizePrefixedGEOStatus_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "GEOS")
    }
}
