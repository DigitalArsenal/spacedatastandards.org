 ...
 */
@Suppress("unused")
class EquipmentRemark_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EquipmentRemark_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEquipmentRemark_Abridged(_bb: ByteBuffer): EquipmentRemark_Abridged = getRootAsEquipmentRemark_Abridged(_bb, EquipmentRemark_Abridged())
        fun getRootAsEquipmentRemark_Abridged(_bb: ByteBuffer, obj: EquipmentRemark_Abridged): EquipmentRemark_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EquipmentRemark_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EQUI")
        fun createEquipmentRemark_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idEquipmentOffset: Int, altRmkIdOffset: Int, nameOffset: Int, typeOffset: Int, textOffset: Int, codeOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte) : Int {
            ...
            return endEquipmentRemark_Abridged(builder)
        }
        fun startEquipmentRemark_Abridged(builder: FlatBufferBuilder) = builder.startTable(13)
        ...
        fun endEquipmentRemark_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEquipmentRemarkAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EQUI")
        fun finishSizePrefixedEquipmentRemark_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EQUI")
    }
}
