 ...
 */
@Suppress("unused")
class Transponder_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Transponder_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsTransponder_Ingest(_bb: ByteBuffer): Transponder_Ingest = getRootAsTransponder_Ingest(_bb, Transponder_Ingest())
        fun getRootAsTransponder_Ingest(_bb: ByteBuffer, obj: Transponder_Ingest): Transponder_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Transponder_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "TRAN")
        fun createTransponder_Ingest(builder: FlatBufferBuilder, idOffset: Int, idCommOffset: Int, nameOffset: Int, classificationMarkingOffset: Int, nidOffset: Int, tidOffset: Int, ttf: Double, symbolRate: Double, fec: Int, modulationOffset: Int, formatOffset: Int, systemOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int) : Int {
            ...
            return endTransponder_Ingest(builder)
        }
        fun startTransponder_Ingest(builder: FlatBufferBuilder) = builder.startTable(18)
        ...
        fun endTransponder_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishTransponderIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "TRAN")
        fun finishSizePrefixedTransponder_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "TRAN")
    }
}
