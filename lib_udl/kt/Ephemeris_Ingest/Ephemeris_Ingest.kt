 ...
 */
@Suppress("unused")
class Ephemeris_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Ephemeris_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createEphemeris_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, esIdOffset: Int, tsOffset: Int, xpos: Double, ypos: Double, zpos: Double, xvel: Double, yvel: Double, zvel: Double, xaccel: Double, yaccel: Double, zaccel: Double, covOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, dataMode: Byte, idOnOrbitOffset: Int, origObjectIdOffset: Int, originOffset: Int) : Int {
            ...
            return endEphemeris_Ingest(builder)
        }
        fun startEphemeris_Ingest(builder: FlatBufferBuilder) = builder.startTable(21)
        ...
        fun endEphemeris_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEphemerisIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EPHE")
        fun finishSizePrefixedEphemeris_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EPHE")
    }
}
