 ...
 */
@Suppress("unused")
class IonoObservationScalerInfo_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationScalerInfo_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationScalerInfo_Abridged(_bb: ByteBuffer): IonoObservationScalerInfo_Abridged = getRootAsIonoObservationScalerInfo_Abridged(_bb, IonoObservationScalerInfo_Abridged())
        fun getRootAsIonoObservationScalerInfo_Abridged(_bb: ByteBuffer, obj: IonoObservationScalerInfo_Abridged): IonoObservationScalerInfo_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationScalerInfo_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationScalerInfo_Abridged(builder: FlatBufferBuilder, typeOffset: Int, nameOffset: Int, organizationOffset: Int, version: Double, confidenceScore: Int, confidenceLevel: Int) : Int {
            ...
            return endIonoObservationScalerInfo_Abridged(builder)
        }
        fun startIonoObservationScalerInfo_Abridged(builder: FlatBufferBuilder) = builder.startTable(6)
        ...
        fun endIonoObservationScalerInfo_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationScalerInfoAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationScalerInfo_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
