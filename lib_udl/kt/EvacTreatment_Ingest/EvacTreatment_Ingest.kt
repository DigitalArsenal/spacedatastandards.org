 ...
 */
@Suppress("unused")
class EvacTreatment_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EvacTreatment_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEvacTreatment_Ingest(_bb: ByteBuffer): EvacTreatment_Ingest = getRootAsEvacTreatment_Ingest(_bb, EvacTreatment_Ingest())
        fun getRootAsEvacTreatment_Ingest(_bb: ByteBuffer, obj: EvacTreatment_Ingest): EvacTreatment_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EvacTreatment_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EVAC")
        fun createEvacTreatment_Ingest(builder: FlatBufferBuilder, typeOffset: Int, bodyPartOffset: Int, timeOffset: Int, commentsOffset: Int) : Int {
            builder.startTable(4)
            addComments(builder, commentsOffset)
            addTime(builder, timeOffset)
            addBodyPart(builder, bodyPartOffset)
            addType(builder, typeOffset)
            return endEvacTreatment_Ingest(builder)
        }
        fun startEvacTreatment_Ingest(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endEvacTreatment_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEvacTreatmentIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EVAC")
        fun finishSizePrefixedEvacTreatment_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EVAC")
    }
}
