 ...
 */
@Suppress("unused")
class Surface_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Surface_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSurface_Full(_bb: ByteBuffer): Surface_Full = getRootAsSurface_Full(_bb, Surface_Full())
        fun getRootAsSurface_Full(_bb: ByteBuffer, obj: Surface_Full): Surface_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Surface_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SURF")
        fun createSurface_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, nameOffset: Int, typeOffset: Int, idSiteOffset: Int, altSiteIdOffset: Int, primary: Boolean, lengthFt: Int, ldaFt: Int, widthFt: Int, lengthM: Int, ldaM: Int, widthM: Int, materialOffset: Int, conditionOffset: Int, rawWbcOffset: Int, pcnOffset: Int, lcn: Int, sWtKip: Int, tWtKip: Int, stWtKip: Int, ttWtKip: Int, ddWtKip: Int, sbttWtKip: Int, tdtWtkip: Int, trtWtKip: Int, ddtWtKip: Int, sWtKn: Int, tWtKn: Int, stWtKn: Int, ttWtKn: Int, ddWtKn: Int, sbttWtKn: Int, tdtWtKn: Int, trtWtKn: Int, ddtWtKn: Int, lighting: Boolean, lightsUnkn: Boolean, lightsAprch: Boolean, lightsVasi: Boolean, lightsPapi: Boolean, lightsOls: Boolean, lightsReil: Boolean, lightsTdzl: Boolean, lightsCl: Boolean, obstacle: Boolean, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endSurface_Full(builder)
        }
        fun startSurface_Full(builder: FlatBufferBuilder) = builder.startTable(54)
        ...
        fun endSurface_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSurfaceFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SURF")
        fun finishSizePrefixedSurface_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SURF")
    }
}
