 ...
 */
@Suppress("unused")
class AirEventReceivers_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirEventReceivers_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirEventReceivers_Abridged(_bb: ByteBuffer): AirEventReceivers_Abridged = getRootAsAirEventReceivers_Abridged(_bb, AirEventReceivers_Abridged())
        fun getRootAsAirEventReceivers_Abridged(_bb: ByteBuffer, obj: AirEventReceivers_Abridged): AirEventReceivers_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirEventReceivers_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRE")
        fun createAirEventReceivers_Abridged(builder: FlatBufferBuilder, idReceiverSortieOffset: Int, idReceiverMissionOffset: Int, idReceiverAirfieldOffset: Int, externalReceiverIdOffset: Int, receiverCoordOffset: Int, receiverMdsOffset: Int, amcReceiverMissionIdOffset: Int, altReceiverMissionIdOffset: Int, receiverCallSignOffset: Int, receiverOwnerOffset: Int, receiverPocOffset: Int, receiverLegNum: Int, receiverDeployedIcaoOffset: Int, receiverDeliveryMethodOffset: Int, fuelOn: Double, receiverCellPosition: Int, sequenceNumOffset: Int, recOrgOffset: Int, numRecAircraft: Int, receiverFuelTypeOffset: Int, receiverExerciseOffset: Int, packageIdOffset: Int) : Int {
            ...
            return endAirEventReceivers_Abridged(builder)
        }
        fun startAirEventReceivers_Abridged(builder: FlatBufferBuilder) = builder.startTable(22)
        ...
        fun endAirEventReceivers_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirEventReceiversAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRE")
        fun finishSizePrefixedAirEventReceivers_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRE")
    }
}
