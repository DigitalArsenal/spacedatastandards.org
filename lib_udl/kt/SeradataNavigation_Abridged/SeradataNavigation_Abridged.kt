 ...
 */
@Suppress("unused")
class SeradataNavigation_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SeradataNavigation_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSeradataNavigation_Abridged(_bb: ByteBuffer): SeradataNavigation_Abridged = getRootAsSeradataNavigation_Abridged(_bb, SeradataNavigation_Abridged())
        fun getRootAsSeradataNavigation_Abridged(_bb: ByteBuffer, obj: SeradataNavigation_Abridged): SeradataNavigation_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SeradataNavigation_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SERA")
        fun createSeradataNavigation_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idNavigationOffset: Int, spacecraftIdOffset: Int, hostedForCompanyOrgIdOffset: Int, manufacturerOrgIdOffset: Int, payloadTypeOffset: Int, modesOffset: Int, modeFrequencyOffset: Int, locationAccuracy: Double, partnerSpacecraftIdOffset: Int, areaCoverageOffset: Int, notesOffset: Int, nameOffset: Int, clockTypeOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endSeradataNavigation_Abridged(builder)
        }
        fun startSeradataNavigation_Abridged(builder: FlatBufferBuilder) = builder.startTable(21)
        ...
        fun endSeradataNavigation_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSeradataNavigationAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SERA")
        fun finishSizePrefixedSeradataNavigation_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SERA")
    }
}
