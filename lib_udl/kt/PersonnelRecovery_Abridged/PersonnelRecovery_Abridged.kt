 ...
 */
@Suppress("unused")
class PersonnelRecovery_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : PersonnelRecovery_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createPersonnelRecovery_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, typeOffset: Int, msgTimeOffset: Int, recovIdOffset: Int, idWeatherReportOffset: Int, pickupLat: Double, pickupLon: Double, pickupAlt: Double, termInd: Boolean, authStatusOffset: Int, numPersons: Int, milClassOffset: Int, natAlliance: Int, natAlliance1: Int, identityOffset: Int, commEq1Offset: Int, commEq2Offset: Int, commEq3Offset: Int, txFreq: Double, rxFreq: Double, numNonAmbulatory: Int, numAmbulatory: Int, numAmbulatoryInjured: Int, survivorRadioOffset: Int, survivorMessagesOffset: Int, beaconInd: Boolean, callSignOffset: Int, textMsgOffset: Int, authMethodOffset: Int, objectiveAreaInfoOffset: Int, executionInfoOffset: Int, origNetworkOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte) : Int {
            ...
            return endPersonnelRecovery_Abridged(builder)
        }
        fun startPersonnelRecovery_Abridged(builder: FlatBufferBuilder) = builder.startTable(38)
        ...
        fun endPersonnelRecovery_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishPersonnelRecoveryAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "PERS")
        fun finishSizePrefixedPersonnelRecovery_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "PERS")
    }
}
