 ...
 */
@Suppress("unused")
class DataLinkVoiceCoord_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DataLinkVoiceCoord_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDataLinkVoiceCoord_Abridged(_bb: ByteBuffer): DataLinkVoiceCoord_Abridged = getRootAsDataLinkVoiceCoord_Abridged(_bb, DataLinkVoiceCoord_Abridged())
        fun getRootAsDataLinkVoiceCoord_Abridged(_bb: ByteBuffer, obj: DataLinkVoiceCoord_Abridged): DataLinkVoiceCoord_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DataLinkVoiceCoord_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DATA")
        fun createDataLinkVoiceCoord_Abridged(builder: FlatBufferBuilder, voiceNetDesOffset: Int, freqDesOffset: Int, commPriOffset: Int, teleFreqNumsOffset: Int) : Int {
            ...
            return endDataLinkVoiceCoord_Abridged(builder)
        }
        fun startDataLinkVoiceCoord_Abridged(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endDataLinkVoiceCoord_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDataLinkVoiceCoordAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DATA")
        fun finishSizePrefixedDataLinkVoiceCoord_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DATA")
    }
}
