 ...
 */
@Suppress("unused")
class SolarArrayDetails : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SolarArrayDetails {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSolarArrayDetails(_bb: ByteBuffer): SolarArrayDetails = getRootAsSolarArrayDetails(_bb, SolarArrayDetails())
        fun getRootAsSolarArrayDetails(_bb: ByteBuffer, obj: SolarArrayDetails): SolarArrayDetails {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SolarArrayDetailsBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SOLA")
        fun createSolarArrayDetails(builder: FlatBufferBuilder, idOffset: Int, idSolarArrayOffset: Int, classificationMarkingOffset: Int, typeOffset: Int, technologyOffset: Int, junctionTechnologyOffset: Int, manufacturerOrgIdOffset: Int, span: Double, area: Double, descriptionOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, tagsOffset: Int, manufacturerOrgOffset: Int) : Int {
            ...
            return endSolarArrayDetails(builder)
        }
        fun startSolarArrayDetails(builder: FlatBufferBuilder) = builder.startTable(20)
        ...
        fun endSolarArrayDetails(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSolarArrayDetailsBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SOLA")
        fun finishSizePrefixedSolarArrayDetailsBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SOLA")
    }
}
