 ...
 */
@Suppress("unused")
class SeradataCommDetails_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SeradataCommDetails_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createSeradataCommDetails_Abridged(builder: FlatBufferBuilder, idOffset: Int, idCommOffset: Int, classificationMarkingOffset: Int, spacecraftIdOffset: Int, bandOffset: Int, solidStatePowerAmp: Double, travelingWaveTubeAmplifier: Double, gatewayUplinkFrom: Double, gatewayUplinkTo: Double, gatewayDownlinkFrom: Double, gatewayDownlinkTo: Double, polarizationOffset: Int, eirp: Double, bandwidth: Double, numOperationalTransponders: Int, numSpareTransponders: Int, hostedForCompanyOrgIdOffset: Int, manufacturerOrgIdOffset: Int, tradeLeaseOrgIdOffset: Int, num36MhzEquivalentTransponders: Int, htsNumUserSpotBeams: Int, htsUserDownlinkBandwidthPerBeam: Double, htsUserUplinkBandwidthPerBeam: Double, estHtsTotalUserDownlinkBandwidthPerBeam: Double, estHtsTotalUserUplinkBandwidthPerBeam: Double, estHtsTotalCapacity: Double, userDownlinkFrom: Double, userDownlinkTo: Double, userUplinkFrom: Double, userUplinkTo: Double, payloadNotesOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int) : Int {
            ...
            return endSeradataCommDetails_Abridged(builder)
        }
        fun startSeradataCommDetails_Abridged(builder: FlatBufferBuilder) = builder.startTable(37)
        ...
        fun endSeradataCommDetails_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSeradataCommDetailsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SERA")
        fun finishSizePrefixedSeradataCommDetails_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SERA")
    }
}
