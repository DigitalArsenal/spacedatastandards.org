 ...
 */
@Suppress("unused")
class AirspaceControlOrderReference_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirspaceControlOrderReference_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirspaceControlOrderReference_Full(_bb: ByteBuffer): AirspaceControlOrderReference_Full = getRootAsAirspaceControlOrderReference_Full(_bb, AirspaceControlOrderReference_Full())
        fun getRootAsAirspaceControlOrderReference_Full(_bb: ByteBuffer, obj: AirspaceControlOrderReference_Full): AirspaceControlOrderReference_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirspaceControlOrderReference_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRS")
        fun createAirspaceControlOrderReference_Full(builder: FlatBufferBuilder, refSidOffset: Int, refTypeOffset: Int, refOriginatorOffset: Int, refTsOffset: Int, refSerialNumOffset: Int, refSpecialNotationOffset: Int, refSicsOffset: Int) : Int {
            ...
            return endAirspaceControlOrderReference_Full(builder)
        }
        fun startAirspaceControlOrderReference_Full(builder: FlatBufferBuilder) = builder.startTable(7)
        ...
        fun endAirspaceControlOrderReference_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirspaceControlOrderReferenceFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRS")
        fun finishSizePrefixedAirspaceControlOrderReference_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRS")
    }
}
