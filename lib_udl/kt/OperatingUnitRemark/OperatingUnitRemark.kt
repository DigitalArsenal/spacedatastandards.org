 ...
 */
@Suppress("unused")
class OperatingUnitRemark : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OperatingUnitRemark {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOperatingUnitRemark(_bb: ByteBuffer): OperatingUnitRemark = getRootAsOperatingUnitRemark(_bb, OperatingUnitRemark())
        fun getRootAsOperatingUnitRemark(_bb: ByteBuffer, obj: OperatingUnitRemark): OperatingUnitRemark {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OperatingUnitRemarkBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "OPER")
        fun createOperatingUnitRemark(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOperatingUnitOffset: Int, altRmkIdOffset: Int, nameOffset: Int, typeOffset: Int, textOffset: Int, codeOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte) : Int {
            ...
            return endOperatingUnitRemark(builder)
        }
        fun startOperatingUnitRemark(builder: FlatBufferBuilder) = builder.startTable(15)
        ...
        fun endOperatingUnitRemark(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOperatingUnitRemarkBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "OPER")
        fun finishSizePrefixedOperatingUnitRemarkBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "OPER")
    }
}
