 ...
 */
@Suppress("unused")
class PersonnelRecoveryExecutionInfo_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : PersonnelRecoveryExecutionInfo_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsPersonnelRecoveryExecutionInfo_Full(_bb: ByteBuffer): PersonnelRecoveryExecutionInfo_Full = getRootAsPersonnelRecoveryExecutionInfo_Full(_bb, PersonnelRecoveryExecutionInfo_Full())
        fun getRootAsPersonnelRecoveryExecutionInfo_Full(_bb: ByteBuffer, obj: PersonnelRecoveryExecutionInfo_Full): PersonnelRecoveryExecutionInfo_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun PersonnelRecoveryExecutionInfo_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "PERS")
        fun createPersonnelRecoveryExecutionInfo_Full(builder: FlatBufferBuilder, initialPointOffset: Int, ingress: Double, objStrategyOffset: Int, egressPointOffset: Int, egress: Double, recoveryVehicleOffset: Int, escortVehicleOffset: Int) : Int {
            ...
            return endPersonnelRecoveryExecutionInfo_Full(builder)
        }
        fun startPersonnelRecoveryExecutionInfo_Full(builder: FlatBufferBuilder) = builder.startTable(7)
        ...
        fun endPersonnelRecoveryExecutionInfo_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishPersonnelRecoveryExecutionInfoFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "PERS")
        fun finishSizePrefixedPersonnelRecoveryExecutionInfo_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "PERS")
    }
}
