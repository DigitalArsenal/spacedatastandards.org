 ...
 */
@Suppress("unused")
class MtiFreeText_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : MtiFreeText_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsMtiFreeText_Ingest(_bb: ByteBuffer): MtiFreeText_Ingest = getRootAsMtiFreeText_Ingest(_bb, MtiFreeText_Ingest())
        fun getRootAsMtiFreeText_Ingest(_bb: ByteBuffer, obj: MtiFreeText_Ingest): MtiFreeText_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun MtiFreeText_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MTIF")
        fun createMtiFreeText_Ingest(builder: FlatBufferBuilder, f1Offset: Int, f2Offset: Int, f3Offset: Int) : Int {
            builder.startTable(3)
            addF3(builder, f3Offset)
            addF2(builder, f2Offset)
            addF1(builder, f1Offset)
            return endMtiFreeText_Ingest(builder)
        }
        fun startMtiFreeText_Ingest(builder: FlatBufferBuilder) = builder.startTable(3)
        ...
        fun endMtiFreeText_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMtiFreeTextIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MTIF")
        fun finishSizePrefixedMtiFreeText_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MTIF")
    }
}
