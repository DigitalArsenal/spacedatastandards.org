 ...
 */
@Suppress("unused")
class OrganizationDetails_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OrganizationDetails_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOrganizationDetails_Ingest(_bb: ByteBuffer): OrganizationDetails_Ingest = getRootAsOrganizationDetails_Ingest(_bb, OrganizationDetails_Ingest())
        fun getRootAsOrganizationDetails_Ingest(_bb: ByteBuffer, obj: OrganizationDetails_Ingest): OrganizationDetails_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OrganizationDetails_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ORGA")
        fun createOrganizationDetails_Ingest(builder: FlatBufferBuilder, idOffset: Int, idOrganizationOffset: Int, classificationMarkingOffset: Int, nameOffset: Int, emailOffset: Int, address1Offset: Int, address2Offset: Int, address3Offset: Int, geoAdminLevel1Offset: Int, geoAdminLevel2Offset: Int, geoAdminLevel3Offset: Int, postalCodeOffset: Int, descriptionOffset: Int, formerOrgIdOffset: Int, parentOrgIdOffset: Int, financialYearEndDateOffset: Int, revenue: Double, profit: Double, ebitda: Double, ftes: Int, brokerOffset: Int, ceoOffset: Int, cfoOffset: Int, ctoOffset: Int, riskManagerOffset: Int, massRanking: Int, revenueRanking: Int, financialNotesOffset: Int, servicesNotesOffset: Int, fleetPlanNotesOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, tagsOffset: Int, createdAtOffset: Int, createdByOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endOrganizationDetails_Ingest(builder)
        }
        fun startOrganizationDetails_Ingest(builder: FlatBufferBuilder) = builder.startTable(37)
        ...
        fun endOrganizationDetails_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOrganizationDetailsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ORGA")
        fun finishSizePrefixedOrganizationDetails_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ORGA")
    }
}
