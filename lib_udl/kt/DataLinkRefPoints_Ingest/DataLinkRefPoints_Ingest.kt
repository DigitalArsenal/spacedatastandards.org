 ...
 */
@Suppress("unused")
class DataLinkRefPoints_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DataLinkRefPoints_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDataLinkRefPoints_Ingest(_bb: ByteBuffer): DataLinkRefPoints_Ingest = getRootAsDataLinkRefPoints_Ingest(_bb, DataLinkRefPoints_Ingest())
        fun getRootAsDataLinkRefPoints_Ingest(_bb: ByteBuffer, obj: DataLinkRefPoints_Ingest): DataLinkRefPoints_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DataLinkRefPoints_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DATA")
        fun createDataLinkRefPoints_Ingest(builder: FlatBufferBuilder, refPointTypeOffset: Int, refDesOffset: Int, refLocNameOffset: Int, refLat: Double, refLon: Double, effEventTimeOffset: Int) : Int {
            ...
            return endDataLinkRefPoints_Ingest(builder)
        }
        fun startDataLinkRefPoints_Ingest(builder: FlatBufferBuilder) = builder.startTable(6)
        ...
        fun endDataLinkRefPoints_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDataLinkRefPointsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DATA")
        fun finishSizePrefixedDataLinkRefPoints_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DATA")
    }
}
