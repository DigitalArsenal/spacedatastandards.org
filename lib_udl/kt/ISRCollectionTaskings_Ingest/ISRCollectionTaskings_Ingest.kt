 ...
 */
@Suppress("unused")
class ISRCollectionTaskings_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : ISRCollectionTaskings_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createISRCollectionTaskings_Ingest(builder: FlatBufferBuilder, idOffset: Int, type: Byte, collectionType: Byte, taskingAorOffset: Int, eightLineOffset: Int, taskingPrimaryIntelDisciplineOffset: Int, taskingPrimarySubCategoryOffset: Int, taskingSecondaryIntelDisciplineOffset: Int, taskingSecondarySubCategoryOffset: Int, taskingRoleOffset: Int, taskingOperationOffset: Int, taskingPriority: Double, taskingSupportedUnitOffset: Int, taskingEmphasisOffset: Int, taskingRetaskTimeOffset: Int, taskingStartPointLat: Double, taskingStartPointLong: Double, taskingCollectionAreaOffset: Int, taskingJoaOffset: Int, taskingSyncMatrixBinOffset: Int, taskingCountryOffset: Int, taskingRegionOffset: Int, taskingSubRegionOffset: Int, sroTrackOffset: Int, specialComGuidanceOffset: Int, collectionPeriodsOffset: Int, taskingCollectionRequirementsOffset: Int) : Int {
            ...
            return endISRCollectionTaskings_Ingest(builder)
        }
        fun startISRCollectionTaskings_Ingest(builder: FlatBufferBuilder) = builder.startTable(27)
        ...
        fun endISRCollectionTaskings_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishISRCollectionTaskingsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ISRC")
        fun finishSizePrefixedISRCollectionTaskings_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ISRC")
    }
}
