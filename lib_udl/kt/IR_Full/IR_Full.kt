...
class IR_Full : Table() {
    ...
    fun __assign(_i: Int, _bb: ByteBuffer) : IR_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIR_Full(_bb: ByteBuffer): IR_Full = getRootAsIR_Full(_bb, IR_Full())
        fun getRootAsIR_Full(_bb: ByteBuffer, obj: IR_Full): IR_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IR_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IRFU")
        fun createIR_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idEntityOffset: Int, nameOffset: Int, descriptionOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, entityOffset: Int) : Int {
            ...
            return endIR_Full(builder)
        }
        fun startIR_Full(builder: FlatBufferBuilder) = builder.startTable(14)
        ...
        fun endIR_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIRFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IRFU")
        fun finishSizePrefixedIR_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IRFU")
    }
}
