 ...
 */
@Suppress("unused")
class Airfield_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Airfield_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(64, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 64, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(66, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 66, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsAirfield_Full(_bb: ByteBuffer): Airfield_Full = getRootAsAirfield_Full(_bb, Airfield_Full())
        fun getRootAsAirfield_Full(_bb: ByteBuffer, obj: Airfield_Full): Airfield_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Airfield_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRF")
        fun createAirfield_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idSiteOffset: Int, altAirfieldIdOffset: Int, wacInnrOffset: Int, zarIdOffset: Int, icaoOffset: Int, iataOffset: Int, faaOffset: Int, hostNatCodeOffset: Int, nameOffset: Int, typeOffset: Int, lat: Double, lon: Double, elevFt: Double, elevM: Double, magDec: Double, regionNameOffset: Int, countryCodeOffset: Int, cityOffset: Int, stateOffset: Int, geolocOffset: Int, gmtOffsetOffset: Int, suitabilityCodesOffset: Int, miscCodesOffset: Int, runways: Int, maxRunwayLength: Int, infoUrlOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endAirfield_Full(builder)
        }
        fun startAirfield_Full(builder: FlatBufferBuilder) = builder.startTable(37)
        ...
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(30, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(31, updatedBy, 0)
        ...
        fun endAirfield_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirfieldFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRF")
        fun finishSizePrefixedAirfield_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRF")
    }
}
