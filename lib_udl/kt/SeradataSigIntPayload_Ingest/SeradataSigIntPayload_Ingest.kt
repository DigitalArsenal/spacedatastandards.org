 ...
 */
@Suppress("unused")
class SeradataSigIntPayload_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SeradataSigIntPayload_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createSeradataSigIntPayload_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, spacecraftIdOffset: Int, idSensorOffset: Int, hostedForCompanyOrgIdOffset: Int, manufacturerOrgIdOffset: Int, typeOffset: Int, swathWidth: Double, groundStationsOffset: Int, groundStationLocationsOffset: Int, frequencyCoverageOffset: Int, positionalAccuracyOffset: Int, interceptParametersOffset: Int, nameOffset: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endSeradataSigIntPayload_Ingest(builder)
        }
        fun startSeradataSigIntPayload_Ingest(builder: FlatBufferBuilder) = builder.startTable(21)
        ...
        fun endSeradataSigIntPayload_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSeradataSigIntPayloadIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SERA")
        fun finishSizePrefixedSeradataSigIntPayload_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SERA")
    }
}
