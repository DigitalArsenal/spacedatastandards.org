 ...
 */
@Suppress("unused")
class IR_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IR_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIR_Abridged(_bb: ByteBuffer): IR_Abridged = getRootAsIR_Abridged(_bb, IR_Abridged())
        fun getRootAsIR_Abridged(_bb: ByteBuffer, obj: IR_Abridged): IR_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IR_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IRAB")
        fun createIR_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idEntityOffset: Int, nameOffset: Int, descriptionOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endIR_Abridged(builder)
        }
        fun startIR_Abridged(builder: FlatBufferBuilder) = builder.startTable(11)
        ...
        fun endIR_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIRAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IRAB")
        fun finishSizePrefixedIR_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IRAB")
    }
}
