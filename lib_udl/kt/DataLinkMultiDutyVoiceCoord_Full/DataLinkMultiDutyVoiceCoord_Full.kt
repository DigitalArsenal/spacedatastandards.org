 ...
 */
@Suppress("unused")
class DataLinkMultiDutyVoiceCoord_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DataLinkMultiDutyVoiceCoord_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDataLinkMultiDutyVoiceCoord_Full(_bb: ByteBuffer): DataLinkMultiDutyVoiceCoord_Full = getRootAsDataLinkMultiDutyVoiceCoord_Full(_bb, DataLinkMultiDutyVoiceCoord_Full())
        fun getRootAsDataLinkMultiDutyVoiceCoord_Full(_bb: ByteBuffer, obj: DataLinkMultiDutyVoiceCoord_Full): DataLinkMultiDutyVoiceCoord_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DataLinkMultiDutyVoiceCoord_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DATA")
        fun createDataLinkMultiDutyVoiceCoord_Full(builder: FlatBufferBuilder, multiVoiceNetDesOffset: Int, multiFreqDesOffset: Int, multiCommPriOffset: Int, multiTeleFreqNumsOffset: Int) : Int {
            ...
            return endDataLinkMultiDutyVoiceCoord_Full(builder)
        }
        fun startDataLinkMultiDutyVoiceCoord_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endDataLinkMultiDutyVoiceCoord_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDataLinkMultiDutyVoiceCoordFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DATA")
        fun finishSizePrefixedDataLinkMultiDutyVoiceCoord_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DATA")
    }
}
