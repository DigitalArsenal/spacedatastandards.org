 ...
 */
@Suppress("unused")
class LaunchDetection_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LaunchDetection_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val createdAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(48, 1)
    fun createdAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 48, 1)
    /**
    ...
    val createdByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(50, 1)
    fun createdByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 50, 1)
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(52, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 52, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(54, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 54, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsLaunchDetection_Abridged(_bb: ByteBuffer): LaunchDetection_Abridged = getRootAsLaunchDetection_Abridged(_bb, LaunchDetection_Abridged())
        fun getRootAsLaunchDetection_Abridged(_bb: ByteBuffer, obj: LaunchDetection_Abridged): LaunchDetection_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LaunchDetection_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LAUN")
        fun createLaunchDetection_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, launchTimeOffset: Int, messageTypeOffset: Int, launchLatitude: Double, launchLongitude: Double, launchAzimuth: Double, raan: Double, inclination: Double, observationTimeOffset: Int, observationLatitude: Double, observationLongitude: Double, observationAltitude: Double, stereoFlag: Boolean, highZenithAzimuth: Boolean, sequenceNumber: Int, eventIdOffset: Int, sourceOffset: Int, originOffset: Int, descriptorOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int) : Int {
            ...
            return endLaunchDetection_Abridged(builder)
        }
        fun startLaunchDetection_Abridged(builder: FlatBufferBuilder) = builder.startTable(26)
        ...
        fun addCreatedAt(builder: FlatBufferBuilder, createdAt: Int) = builder.addOffset(22, createdAt, 0)
        fun addCreatedBy(builder: FlatBufferBuilder, createdBy: Int) = builder.addOffset(23, createdBy, 0)
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(24, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(25, updatedBy, 0)
        fun endLaunchDetection_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLaunchDetectionAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LAUN")
        fun finishSizePrefixedLaunchDetection_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LAUN")
    }
}
