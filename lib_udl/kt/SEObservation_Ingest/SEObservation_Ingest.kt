 ...
 */
@Suppress("unused")
class SEObservation_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SEObservation_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSEObservation_Ingest(_bb: ByteBuffer): SEObservation_Ingest = getRootAsSEObservation_Ingest(_bb, SEObservation_Ingest())
        fun getRootAsSEObservation_Ingest(_bb: ByteBuffer, obj: SEObservation_Ingest): SEObservation_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SEObservation_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SEOB")
        fun createSEObservation_Ingest(builder: FlatBufferBuilder, obTypeOffset: Int, obUoMOffset: Int, obValue: Double, obStringOffset: Int, obArrayOffset: Int, obBool: Boolean, obQualityOffset: Int, obDescriptionOffset: Int) : Int {
            ...
            return endSEObservation_Ingest(builder)
        }
        fun startSEObservation_Ingest(builder: FlatBufferBuilder) = builder.startTable(8)
        ...
        fun endSEObservation_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSEObservationIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SEOB")
        fun finishSizePrefixedSEObservation_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SEOB")
    }
}
