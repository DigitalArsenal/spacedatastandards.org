 ...
 */
@Suppress("unused")
class DataLinkMultiDutyVoiceCoord_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DataLinkMultiDutyVoiceCoord_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDataLinkMultiDutyVoiceCoord_Abridged(_bb: ByteBuffer): DataLinkMultiDutyVoiceCoord_Abridged = getRootAsDataLinkMultiDutyVoiceCoord_Abridged(_bb, DataLinkMultiDutyVoiceCoord_Abridged())
        fun getRootAsDataLinkMultiDutyVoiceCoord_Abridged(_bb: ByteBuffer, obj: DataLinkMultiDutyVoiceCoord_Abridged): DataLinkMultiDutyVoiceCoord_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DataLinkMultiDutyVoiceCoord_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DATA")
        fun createDataLinkMultiDutyVoiceCoord_Abridged(builder: FlatBufferBuilder, multiVoiceNetDesOffset: Int, multiFreqDesOffset: Int, multiCommPriOffset: Int, multiTeleFreqNumsOffset: Int) : Int {
            ...
            return endDataLinkMultiDutyVoiceCoord_Abridged(builder)
        }
        fun startDataLinkMultiDutyVoiceCoord_Abridged(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endDataLinkMultiDutyVoiceCoord_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDataLinkMultiDutyVoiceCoordAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DATA")
        fun finishSizePrefixedDataLinkMultiDutyVoiceCoord_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DATA")
    }
}
