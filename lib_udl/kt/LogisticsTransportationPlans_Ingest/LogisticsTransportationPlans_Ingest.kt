 ...
 */
@Suppress("unused")
class LogisticsTransportationPlans_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LogisticsTransportationPlans_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLogisticsTransportationPlans_Ingest(_bb: ByteBuffer): LogisticsTransportationPlans_Ingest = getRootAsLogisticsTransportationPlans_Ingest(_bb, LogisticsTransportationPlans_Ingest())
        fun getRootAsLogisticsTransportationPlans_Ingest(_bb: ByteBuffer, obj: LogisticsTransportationPlans_Ingest): LogisticsTransportationPlans_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LogisticsTransportationPlans_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOGI")
        fun createLogisticsTransportationPlans_Ingest(builder: FlatBufferBuilder, plansNumberOffset: Int, missionChange: Boolean, planDefinitionOffset: Int, statusCodeOffset: Int, coordinatorOffset: Int, coordinatorUnitOffset: Int, originIcaoOffset: Int, estDepTimeOffset: Int, estArrTimeOffset: Int, destinationIcaoOffset: Int, logisticMasterRecordIdOffset: Int, tpTailNumberOffset: Int, tpAircraftMdsOffset: Int, majcomOffset: Int, approxArrTimeOffset: Int, durationOffset: Int, actDepTimeOffset: Int, closedDateOffset: Int, cancelledDateOffset: Int, aircraftStatusOffset: Int, numEnrouteStops: Int, serialNumberOffset: Int, numTransLoads: Int, lastChangedDateOffset: Int, logisticsSegmentsOffset: Int, logisticsTransportationPlansRemarksOffset: Int) : Int {
            ...
            return endLogisticsTransportationPlans_Ingest(builder)
        }
        fun startLogisticsTransportationPlans_Ingest(builder: FlatBufferBuilder) = builder.startTable(26)
        ...
        fun endLogisticsTransportationPlans_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLogisticsTransportationPlansIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOGI")
        fun finishSizePrefixedLogisticsTransportationPlans_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOGI")
    }
}
