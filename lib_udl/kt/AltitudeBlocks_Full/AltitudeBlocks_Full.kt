 ...
 */
@Suppress("unused")
class AltitudeBlocks_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AltitudeBlocks_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAltitudeBlocks_Full(_bb: ByteBuffer): AltitudeBlocks_Full = getRootAsAltitudeBlocks_Full(_bb, AltitudeBlocks_Full())
        fun getRootAsAltitudeBlocks_Full(_bb: ByteBuffer, obj: AltitudeBlocks_Full): AltitudeBlocks_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AltitudeBlocks_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ALTI")
        fun createAltitudeBlocks_Full(builder: FlatBufferBuilder, altitudeSequenceIdOffset: Int, lowerAltitude: Double, upperAltitude: Double) : Int {
            ...
            return endAltitudeBlocks_Full(builder)
        }
        fun startAltitudeBlocks_Full(builder: FlatBufferBuilder) = builder.startTable(3)
        ...
        fun endAltitudeBlocks_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAltitudeBlocksFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ALTI")
        fun finishSizePrefixedAltitudeBlocks_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ALTI")
    }
}
