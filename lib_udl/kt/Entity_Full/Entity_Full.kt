 ...
 */
@Suppress("unused")
class Entity_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Entity_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(26, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 26, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(28, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 28, 1)
    /**
     * Source of the data.
    ...
    val locationAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(36, 1)
    fun locationInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 36, 1)
    /**
     * No description provided.
     * Example: /// Example: No example provided.
     * Constraints: No constraints specified.
    ...
    val onOrbitAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(38, 1)
    fun onOrbitInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 38, 1)
    /**
    ...
    val operatingUnitAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(42, 1)
    fun operatingUnitInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 42, 1)
    /**
    ...
    val idOperatingUnitAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(44, 1)
    fun idOperatingUnitInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 44, 1)
    /**
     ...
     * Constraints: No constraints specified.
     */
    fun statusCollection(j: Int) : String? {
        val o = __offset(48)
        return if (o != 0) {
            __string(__vector(o) + j * 4)
        } else {
    ...
    val statusCollectionLength : Int
        get() {
    ...
    val rfBandsLength : Int
        get() {
            val o = __offset(50); return if (o != 0) __vector_len(o) else 0
        }
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsEntity_Full(_bb: ByteBuffer): Entity_Full = getRootAsEntity_Full(_bb, Entity_Full())
        fun getRootAsEntity_Full(_bb: ByteBuffer, obj: Entity_Full): Entity_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Entity_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ENTI")
        fun createEntity_Full(builder: FlatBufferBuilder, idEntityOffset: Int, nameOffset: Int, classificationMarkingOffset: Int, type: Byte, idLocationOffset: Int, countryCodeOffset: Int, ownerType: Byte, taskable: Boolean, urlsOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, locationOffset: Int, onOrbitOffset: Int, idOnOrbitOffset: Int, operatingUnitOffset: Int, idOperatingUnitOffset: Int, origNetworkOffset: Int, statusCollectionOffset: Int, rfBandsOffset: Int) : Int {
            builder.startTable(24)
            addRfBands(builder, rfBandsOffset)
            addStatusCollection(builder, statusCollectionOffset)
            addOrigNetwork(builder, origNetworkOffset)
            addIdOperatingUnit(builder, idOperatingUnitOffset)
            addOperatingUnit(builder, operatingUnitOffset)
            ...
            return endEntity_Full(builder)
        }
        fun startEntity_Full(builder: FlatBufferBuilder) = builder.startTable(24)
        ...
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(11, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(12, updatedBy, 0)
        ...
        fun addLocation(builder: FlatBufferBuilder, location: Int) = builder.addOffset(16, location, 0)
        fun addOnOrbit(builder: FlatBufferBuilder, onOrbit: Int) = builder.addOffset(17, onOrbit, 0)
        fun addIdOnOrbit(builder: FlatBufferBuilder, idOnOrbit: Int) = builder.addOffset(18, idOnOrbit, 0)
        fun addOperatingUnit(builder: FlatBufferBuilder, operatingUnit: Int) = builder.addOffset(19, operatingUnit, 0)
        fun addIdOperatingUnit(builder: FlatBufferBuilder, idOperatingUnit: Int) = builder.addOffset(20, idOperatingUnit, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(21, origNetwork, 0)
        fun addStatusCollection(builder: FlatBufferBuilder, statusCollection: Int) = builder.addOffset(22, statusCollection, 0)
        fun createStatusCollectionVector(builder: FlatBufferBuilder, data: IntArray) : Int {
            builder.startVector(4, data.size, 4)
            for (i in data.size - 1 downTo 0) {
                builder.addOffset(data[i])
            }
        ...
        fun startStatusCollectionVector(builder: FlatBufferBuilder, numElems: Int) = builder.startVector(4, numElems, 4)
        fun addRfBands(builder: FlatBufferBuilder, rfBands: Int) = builder.addOffset(23, rfBands, 0)
        fun createRfBandsVector(builder: FlatBufferBuilder, data: IntArray) : Int {
            builder.startVector(4, data.size, 4)
            for (i in data.size - 1 downTo 0) {
                builder.addOffset(data[i])
            }
        ...
        fun startRfBandsVector(builder: FlatBufferBuilder, numElems: Int) = builder.startVector(4, numElems, 4)
        fun endEntity_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEntityFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ENTI")
        fun finishSizePrefixedEntity_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ENTI")
    }
}
