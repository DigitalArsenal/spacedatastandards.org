...
class Antenna : Table() {
    ...
    fun __assign(_i: Int, _bb: ByteBuffer) : Antenna {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAntenna(_bb: ByteBuffer): Antenna = getRootAsAntenna(_bb, Antenna())
        fun getRootAsAntenna(_bb: ByteBuffer, obj: Antenna): Antenna {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AntennaBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ANTE")
        fun createAntenna(builder: FlatBufferBuilder, idOffset: Int, nameOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, antennaDetailsOffset: Int) : Int {
            ...
            return endAntenna(builder)
        }
        fun startAntenna(builder: FlatBufferBuilder) = builder.startTable(11)
        ...
        fun endAntenna(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAntennaBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ANTE")
        fun finishSizePrefixedAntennaBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ANTE")
    }
}
