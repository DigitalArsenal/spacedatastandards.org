 ...
 */
@Suppress("unused")
class LaunchSite_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LaunchSite_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLaunchSite_Abridged(_bb: ByteBuffer): LaunchSite_Abridged = getRootAsLaunchSite_Abridged(_bb, LaunchSite_Abridged())
        fun getRootAsLaunchSite_Abridged(_bb: ByteBuffer, obj: LaunchSite_Abridged): LaunchSite_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LaunchSite_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LAUN")
        fun createLaunchSite_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, codeOffset: Int, shortCodeOffset: Int, altCodeOffset: Int, idSiteOffset: Int, nameOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endLaunchSite_Abridged(builder)
        }
        fun startLaunchSite_Abridged(builder: FlatBufferBuilder) = builder.startTable(13)
        ...
        fun endLaunchSite_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLaunchSiteAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LAUN")
        fun finishSizePrefixedLaunchSite_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LAUN")
    }
}
