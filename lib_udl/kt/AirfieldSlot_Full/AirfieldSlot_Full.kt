 ...
 */
@Suppress("unused")
class AirfieldSlot_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirfieldSlot_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirfieldSlot_Full(_bb: ByteBuffer): AirfieldSlot_Full = getRootAsAirfieldSlot_Full(_bb, AirfieldSlot_Full())
        fun getRootAsAirfieldSlot_Full(_bb: ByteBuffer, obj: AirfieldSlot_Full): AirfieldSlot_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirfieldSlot_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRF")
        fun createAirfieldSlot_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, airfieldNameOffset: Int, icaoOffset: Int, idAirfieldOffset: Int, altAirfieldIdOffset: Int, nameOffset: Int, type: Byte, acSlotCat: Byte, capacity: Int, startTimeOffset: Int, endTimeOffset: Int, minSeparation: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endAirfieldSlot_Full(builder)
        }
        fun startAirfieldSlot_Full(builder: FlatBufferBuilder) = builder.startTable(23)
        ...
        fun endAirfieldSlot_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirfieldSlotFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRF")
        fun finishSizePrefixedAirfieldSlot_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRF")
    }
}
