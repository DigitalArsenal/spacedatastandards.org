 ...
 */
@Suppress("unused")
class AircraftMissionLocationTasking_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AircraftMissionLocationTasking_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAircraftMissionLocationTasking_Abridged(_bb: ByteBuffer): AircraftMissionLocationTasking_Abridged = getRootAsAircraftMissionLocationTasking_Abridged(_bb, AircraftMissionLocationTasking_Abridged())
        fun getRootAsAircraftMissionLocationTasking_Abridged(_bb: ByteBuffer, obj: AircraftMissionLocationTasking_Abridged): AircraftMissionLocationTasking_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AircraftMissionLocationTasking_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRC")
        fun createAircraftMissionLocationTasking_Abridged(builder: FlatBufferBuilder, startTimeOffset: Int, endTimeOffset: Int, msnLocNameOffset: Int, alt: Int, airMsnPriOffset: Int, areaGeoRad: Int, msnLocPtNameOffset: Int, msnLocPtLat: Double, msnLocPtLon: Double, msnLocPtBarTOffset: Int) : Int {
            ...
            return endAircraftMissionLocationTasking_Abridged(builder)
        }
        fun startAircraftMissionLocationTasking_Abridged(builder: FlatBufferBuilder) = builder.startTable(10)
        ...
        fun endAircraftMissionLocationTasking_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAircraftMissionLocationTaskingAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRC")
        fun finishSizePrefixedAircraftMissionLocationTasking_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRC")
    }
}
