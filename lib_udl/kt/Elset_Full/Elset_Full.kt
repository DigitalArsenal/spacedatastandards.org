 ...
 */
@Suppress("unused")
class Elset_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Elset_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val effectiveFromAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(52, 1)
    fun effectiveFromInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 52, 1)
    /**
    ...
    val effectiveUntilAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(54, 1)
    fun effectiveUntilInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 54, 1)
    /**
    ...
    val line1AsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(56, 1)
    fun line1InByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 56, 1)
    /**
    ...
    val line2AsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(58, 1)
    fun line2InByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 58, 1)
    /**
    ...
    val descriptorAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(60, 1)
    fun descriptorInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 60, 1)
    /**
    ...
    val rawFileUriAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(66, 1)
    fun rawFileUriInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 66, 1)
    /**
    ...
    val algorithmAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(78, 1)
    fun algorithmInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 78, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsElset_Full(_bb: ByteBuffer): Elset_Full = getRootAsElset_Full(_bb, Elset_Full())
        fun getRootAsElset_Full(_bb: ByteBuffer, obj: Elset_Full): Elset_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Elset_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ELSE")
        fun createElset_Full(builder: FlatBufferBuilder, idElsetOffset: Int, classificationMarkingOffset: Int, satNo: Int, epochOffset: Int, meanMotion: Double, idOnOrbitOffset: Int, uct: Boolean, eccentricity: Double, inclination: Double, raan: Double, argOfPerigee: Double, meanAnomaly: Double, revNo: Int, bStar: Double, agom: Double, ballisticCoeff: Double, meanMotionDot: Double, meanMotionDdot: Double, semiMajorAxis: Double, period: Double, apogee: Double, perigee: Double, origObjectIdOffset: Int, idOrbitDeterminationOffset: Int, effectiveFromOffset: Int, effectiveUntilOffset: Int, line1Offset: Int, line2Offset: Int, descriptorOffset: Int, createdAtOffset: Int, createdByOffset: Int, rawFileUriOffset: Int, originOffset: Int, sourceDlOffset: Int, sourceOffset: Int, dataMode: Byte, tagsOffset: Int, algorithmOffset: Int, sourcedDataOffset: Int, sourcedDataTypes: Byte, transactionIdOffset: Int, ephemType: Int, origNetworkOffset: Int, onOrbitOffset: Int) : Int {
            ...
            addUct(builder, uct)
            return endElset_Full(builder)
        }
        fun startElset_Full(builder: FlatBufferBuilder) = builder.startTable(44)
        ...
        fun addEffectiveFrom(builder: FlatBufferBuilder, effectiveFrom: Int) = builder.addOffset(24, effectiveFrom, 0)
        fun addEffectiveUntil(builder: FlatBufferBuilder, effectiveUntil: Int) = builder.addOffset(25, effectiveUntil, 0)
        fun addLine1(builder: FlatBufferBuilder, line1: Int) = builder.addOffset(26, line1, 0)
        fun addLine2(builder: FlatBufferBuilder, line2: Int) = builder.addOffset(27, line2, 0)
        fun addDescriptor(builder: FlatBufferBuilder, descriptor: Int) = builder.addOffset(28, descriptor, 0)
        ...
        fun addRawFileURI(builder: FlatBufferBuilder, rawFileUri: Int) = builder.addOffset(31, rawFileUri, 0)
        ...
        fun addTags(builder: FlatBufferBuilder, tags: Int) = builder.addOffset(36, tags, 0)
        ...
        fun addAlgorithm(builder: FlatBufferBuilder, algorithm: Int) = builder.addOffset(37, algorithm, 0)
        fun addSourcedData(builder: FlatBufferBuilder, sourcedData: Int) = builder.addOffset(38, sourcedData, 0)
        ...
        fun addSourcedDataTypes(builder: FlatBufferBuilder, sourcedDataTypes: Byte) = builder.addByte(39, sourcedDataTypes, 0)
        fun addTransactionId(builder: FlatBufferBuilder, transactionId: Int) = builder.addOffset(40, transactionId, 0)
        fun addEphemType(builder: FlatBufferBuilder, ephemType: Int) = builder.addInt(41, ephemType, 0)
        ...
        fun endElset_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishElsetFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ELSE")
        fun finishSizePrefixedElset_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ELSE")
    }
}
