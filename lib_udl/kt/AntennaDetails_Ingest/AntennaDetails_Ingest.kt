 ...
 */
@Suppress("unused")
class AntennaDetails_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AntennaDetails_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAntennaDetails_Ingest(_bb: ByteBuffer): AntennaDetails_Ingest = getRootAsAntennaDetails_Ingest(_bb, AntennaDetails_Ingest())
        fun getRootAsAntennaDetails_Ingest(_bb: ByteBuffer, obj: AntennaDetails_Ingest): AntennaDetails_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AntennaDetails_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ANTE")
        fun createAntennaDetails_Ingest(builder: FlatBufferBuilder, idOffset: Int, idAntennaOffset: Int, classificationMarkingOffset: Int, typeOffset: Int, positionOffset: Int, mode: Byte, steerable: Boolean, beamForming: Boolean, manufacturerOrgIdOffset: Int, diameter: Double, sizeOffset: Int, startFrequency: Double, endFrequency: Double, beamwidth: Double, gain: Double, gainTolerance: Double, polarization: Double, descriptionOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, tagsOffset: Int) : Int {
            ...
            return endAntennaDetails_Ingest(builder)
        }
        fun startAntennaDetails_Ingest(builder: FlatBufferBuilder) = builder.startTable(25)
        ...
        fun endAntennaDetails_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAntennaDetailsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ANTE")
        fun finishSizePrefixedAntennaDetails_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ANTE")
    }
}
