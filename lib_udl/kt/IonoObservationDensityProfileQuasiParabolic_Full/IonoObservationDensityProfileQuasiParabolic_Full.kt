 ...
 */
@Suppress("unused")
class IonoObservationDensityProfileQuasiParabolic_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationDensityProfileQuasiParabolic_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationDensityProfileQuasiParabolic_Full(_bb: ByteBuffer): IonoObservationDensityProfileQuasiParabolic_Full = getRootAsIonoObservationDensityProfileQuasiParabolic_Full(_bb, IonoObservationDensityProfileQuasiParabolic_Full())
        fun getRootAsIonoObservationDensityProfileQuasiParabolic_Full(_bb: ByteBuffer, obj: IonoObservationDensityProfileQuasiParabolic_Full): IonoObservationDensityProfileQuasiParabolic_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationDensityProfileQuasiParabolic_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationDensityProfileQuasiParabolic_Full(builder: FlatBufferBuilder, descriptionOffset: Int, earthRadius: Double, quasiParabolicSegmentsOffset: Int) : Int {
            builder.startTable(3)
            addEarthRadius(builder, earthRadius)
            addQuasiParabolicSegments(builder, quasiParabolicSegmentsOffset)
            addDescription(builder, descriptionOffset)
            return endIonoObservationDensityProfileQuasiParabolic_Full(builder)
        }
        fun startIonoObservationDensityProfileQuasiParabolic_Full(builder: FlatBufferBuilder) = builder.startTable(3)
        ...
        fun endIonoObservationDensityProfileQuasiParabolic_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationDensityProfileQuasiParabolicFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationDensityProfileQuasiParabolic_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
