 ...
 */
@Suppress("unused")
class SiteRemark_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SiteRemark_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSiteRemark_Ingest(_bb: ByteBuffer): SiteRemark_Ingest = getRootAsSiteRemark_Ingest(_bb, SiteRemark_Ingest())
        fun getRootAsSiteRemark_Ingest(_bb: ByteBuffer, obj: SiteRemark_Ingest): SiteRemark_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SiteRemark_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SITE")
        fun createSiteRemark_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idSiteOffset: Int, origRmkIdOffset: Int, nameOffset: Int, typeOffset: Int, textOffset: Int, codeOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endSiteRemark_Ingest(builder)
        }
        fun startSiteRemark_Ingest(builder: FlatBufferBuilder) = builder.startTable(14)
        ...
        fun endSiteRemark_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSiteRemarkIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SITE")
        fun finishSizePrefixedSiteRemark_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SITE")
    }
}
