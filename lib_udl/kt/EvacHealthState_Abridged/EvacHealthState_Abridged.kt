 ...
 */
@Suppress("unused")
class EvacHealthState_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EvacHealthState_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEvacHealthState_Abridged(_bb: ByteBuffer): EvacHealthState_Abridged = getRootAsEvacHealthState_Abridged(_bb, EvacHealthState_Abridged())
        fun getRootAsEvacHealthState_Abridged(_bb: ByteBuffer, obj: EvacHealthState_Abridged): EvacHealthState_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EvacHealthState_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EVAC")
        fun createEvacHealthState_Abridged(builder: FlatBufferBuilder, typeOffset: Int, healthStateCodeOffset: Int, medConfFactor: Int, timeOffset: Int) : Int {
            ...
            return endEvacHealthState_Abridged(builder)
        }
        fun startEvacHealthState_Abridged(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endEvacHealthState_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEvacHealthStateAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EVAC")
        fun finishSizePrefixedEvacHealthState_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EVAC")
    }
}
