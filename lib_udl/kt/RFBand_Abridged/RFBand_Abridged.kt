 ...
 */
@Suppress("unused")
class RFBand_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : RFBand_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsRFBand_Abridged(_bb: ByteBuffer): RFBand_Abridged = getRootAsRFBand_Abridged(_bb, RFBand_Abridged())
        fun getRootAsRFBand_Abridged(_bb: ByteBuffer, obj: RFBand_Abridged): RFBand_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun RFBand_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "RFBA")
        fun createRFBand_Abridged(builder: FlatBufferBuilder, idOffset: Int, idEntityOffset: Int, classificationMarkingOffset: Int, nameOffset: Int, bandOffset: Int, mode: Byte, purpose: Byte, freqMin: Double, freqMax: Double, centerFreq: Double, peakGain: Double, edgeGain: Double, bandwidth: Double, beamwidth: Double, polarization: Byte, erp: Double, eirp: Double, sourceOffset: Int, originOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endRFBand_Abridged(builder)
        }
        fun startRFBand_Abridged(builder: FlatBufferBuilder) = builder.startTable(23)
        ...
        fun endRFBand_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishRFBandAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "RFBA")
        fun finishSizePrefixedRFBand_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "RFBA")
    }
}
