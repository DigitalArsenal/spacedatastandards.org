 ...
 */
@Suppress("unused")
class EvacVitalSignData_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EvacVitalSignData_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEvacVitalSignData_Abridged(_bb: ByteBuffer): EvacVitalSignData_Abridged = getRootAsEvacVitalSignData_Abridged(_bb, EvacVitalSignData_Abridged())
        fun getRootAsEvacVitalSignData_Abridged(_bb: ByteBuffer, obj: EvacVitalSignData_Abridged): EvacVitalSignData_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EvacVitalSignData_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EVAC")
        fun createEvacVitalSignData_Abridged(builder: FlatBufferBuilder, vitalSignOffset: Int, vitalSign1: Double, vitalSign2: Double, medConfFactor: Int, timeOffset: Int) : Int {
            ...
            return endEvacVitalSignData_Abridged(builder)
        }
        fun startEvacVitalSignData_Abridged(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endEvacVitalSignData_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEvacVitalSignDataAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EVAC")
        fun finishSizePrefixedEvacVitalSignData_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EVAC")
    }
}
