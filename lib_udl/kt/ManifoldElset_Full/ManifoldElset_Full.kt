 ...
 */
@Suppress("unused")
class ManifoldElset_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : ManifoldElset_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(52, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 52, 1)
    /**
     * Source of the data.
    ...
    companion object {
        ...
        fun getRootAsManifoldElset_Full(_bb: ByteBuffer): ManifoldElset_Full = getRootAsManifoldElset_Full(_bb, ManifoldElset_Full())
        fun getRootAsManifoldElset_Full(_bb: ByteBuffer, obj: ManifoldElset_Full): ManifoldElset_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun ManifoldElset_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MANI")
        fun createManifoldElset_Full(builder: FlatBufferBuilder, idOffset: Int, idManifoldOffset: Int, classificationMarkingOffset: Int, tmpSatNo: Int, epochOffset: Int, meanMotion: Double, eccentricity: Double, inclination: Double, raan: Double, argOfPerigee: Double, meanAnomaly: Double, revNo: Int, bStar: Double, meanMotionDot: Double, meanMotionDdot: Double, semiMajorAxis: Double, period: Double, apogee: Double, perigee: Double, line1Offset: Int, line2Offset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endManifoldElset_Full(builder)
        }
        fun startManifoldElset_Full(builder: FlatBufferBuilder) = builder.startTable(29)
        ...
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(24, updatedBy, 0)
        ...
        fun endManifoldElset_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishManifoldElsetFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MANI")
        fun finishSizePrefixedManifoldElset_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MANI")
    }
}
