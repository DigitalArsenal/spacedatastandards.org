...
class Entity : Table() {
    ...
    companion object {
        ...
        fun startEntity(builder: FlatBufferBuilder) = builder.startTable(24)
        ...
        fun finishEntityBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ENTI")
        fun finishSizePrefixedEntityBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ENTI")
    }
}
