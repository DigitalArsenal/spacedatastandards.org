 ...
 */
@Suppress("unused")
class OnorbitAntenna_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitAntenna_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val antennaAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(22, 1)
    fun antennaInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 22, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbitAntenna_Abridged(_bb: ByteBuffer): OnorbitAntenna_Abridged = getRootAsOnorbitAntenna_Abridged(_bb, OnorbitAntenna_Abridged())
        fun getRootAsOnorbitAntenna_Abridged(_bb: ByteBuffer, obj: OnorbitAntenna_Abridged): OnorbitAntenna_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitAntenna_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitAntenna_Abridged(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, idAntennaOffset: Int, classificationMarkingOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, antennaOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endOnorbitAntenna_Abridged(builder)
        }
        fun startOnorbitAntenna_Abridged(builder: FlatBufferBuilder) = builder.startTable(11)
        ...
        fun addAntenna(builder: FlatBufferBuilder, antenna: Int) = builder.addOffset(9, antenna, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(10, origNetwork, 0)
        fun endOnorbitAntenna_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitAntennaAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitAntenna_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
