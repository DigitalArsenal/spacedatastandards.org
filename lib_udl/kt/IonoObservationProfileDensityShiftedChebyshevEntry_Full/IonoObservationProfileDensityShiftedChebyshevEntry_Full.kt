 ...
 */
@Suppress("unused")
class IonoObservationProfileDensityShiftedChebyshevEntry_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationProfileDensityShiftedChebyshevEntry_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationProfileDensityShiftedChebyshevEntry_Full(_bb: ByteBuffer): IonoObservationProfileDensityShiftedChebyshevEntry_Full = getRootAsIonoObservationProfileDensityShiftedChebyshevEntry_Full(_bb, IonoObservationProfileDensityShiftedChebyshevEntry_Full())
        fun getRootAsIonoObservationProfileDensityShiftedChebyshevEntry_Full(_bb: ByteBuffer, obj: IonoObservationProfileDensityShiftedChebyshevEntry_Full): IonoObservationProfileDensityShiftedChebyshevEntry_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationProfileDensityShiftedChebyshevEntry_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationProfileDensityShiftedChebyshevEntry_Full(builder: FlatBufferBuilder, layerOffset: Int, fstart: Double, fstop: Double, peakheight: Double, zhalfNm: Double, n: Int, coeffsOffset: Int, error: Double) : Int {
            ...
            return endIonoObservationProfileDensityShiftedChebyshevEntry_Full(builder)
        }
        fun startIonoObservationProfileDensityShiftedChebyshevEntry_Full(builder: FlatBufferBuilder) = builder.startTable(8)
        ...
        fun endIonoObservationProfileDensityShiftedChebyshevEntry_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationProfileDensityShiftedChebyshevEntryFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationProfileDensityShiftedChebyshevEntry_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
