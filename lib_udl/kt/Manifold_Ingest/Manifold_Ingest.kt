 ...
 */
@Suppress("unused")
class Manifold_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Manifold_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsManifold_Ingest(_bb: ByteBuffer): Manifold_Ingest = getRootAsManifold_Ingest(_bb, Manifold_Ingest())
        fun getRootAsManifold_Ingest(_bb: ByteBuffer, obj: Manifold_Ingest): Manifold_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Manifold_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MANI")
        fun createManifold_Ingest(builder: FlatBufferBuilder, idOffset: Int, idObjectOfInterestOffset: Int, classificationMarkingOffset: Int, statusOffset: Int, weight: Double, deltaV: Double, deltaT: Double, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endManifold_Ingest(builder)
        }
        fun startManifold_Ingest(builder: FlatBufferBuilder) = builder.startTable(13)
        ...
        fun endManifold_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishManifoldIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MANI")
        fun finishSizePrefixedManifold_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MANI")
    }
}
