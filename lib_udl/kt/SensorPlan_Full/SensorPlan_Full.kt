 ...
 */
@Suppress("unused")
class SensorPlan_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SensorPlan_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createSensorPlan_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, typeOffset: Int, recTypeOffset: Int, startTimeOffset: Int, endTimeOffset: Int, nameOffset: Int, idSensorOffset: Int, origSensorIdOffset: Int, purposeOffset: Int, senNetworkOffset: Int, reqTotal: Int, customerOffset: Int, statusOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int, collectRequestsOffset: Int, tagsOffset: Int) : Int {
            ...
            return endSensorPlan_Full(builder)
        }
        fun startSensorPlan_Full(builder: FlatBufferBuilder) = builder.startTable(24)
        ...
        fun addCollectRequests(builder: FlatBufferBuilder, collectRequests: Int) = builder.addOffset(22, collectRequests, 0)
        ...
        fun endSensorPlan_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSensorPlanFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SENS")
        fun finishSizePrefixedSensorPlan_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SENS")
    }
}
