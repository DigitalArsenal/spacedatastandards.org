 ...
 */
@Suppress("unused")
class Aircraft_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Aircraft_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val aircraftMdsAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(10, 1)
    fun aircraftMdsInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 10, 1)
    /**
    ...
    val tailNumberAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(12, 1)
    fun tailNumberInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 12, 1)
    /**
    ...
    val serialNumberAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(14, 1)
    fun serialNumberInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 14, 1)
    /**
    ...
    val ownerAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(16, 1)
    fun ownerInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 16, 1)
    /**
    ...
    val commandAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(18, 1)
    fun commandInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 18, 1)
    /**
    ...
    val dtdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(22, 1)
    fun dtdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 22, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsAircraft_Abridged(_bb: ByteBuffer): Aircraft_Abridged = getRootAsAircraft_Abridged(_bb, Aircraft_Abridged())
        fun getRootAsAircraft_Abridged(_bb: ByteBuffer, obj: Aircraft_Abridged): Aircraft_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Aircraft_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRC")
        fun createAircraft_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idEntityOffset: Int, aircraftMdsOffset: Int, tailNumberOffset: Int, serialNumberOffset: Int, ownerOffset: Int, commandOffset: Int, categoryOffset: Int, dtdOffset: Int, cruiseSpeed: Double, maxSpeed: Double, minReqRunwayM: Int, minReqRunwayFt: Int, nominalTatime: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endAircraft_Abridged(builder)
        }
        fun startAircraft_Abridged(builder: FlatBufferBuilder) = builder.startTable(23)
        ...
        fun addAircraftMDS(builder: FlatBufferBuilder, aircraftMds: Int) = builder.addOffset(3, aircraftMds, 0)
        fun addTailNumber(builder: FlatBufferBuilder, tailNumber: Int) = builder.addOffset(4, tailNumber, 0)
        fun addSerialNumber(builder: FlatBufferBuilder, serialNumber: Int) = builder.addOffset(5, serialNumber, 0)
        fun addOwner(builder: FlatBufferBuilder, owner: Int) = builder.addOffset(6, owner, 0)
        fun addCommand(builder: FlatBufferBuilder, command: Int) = builder.addOffset(7, command, 0)
        fun addCategory(builder: FlatBufferBuilder, category: Int) = builder.addOffset(8, category, 0)
        fun addDtd(builder: FlatBufferBuilder, dtd: Int) = builder.addOffset(9, dtd, 0)
        fun addCruiseSpeed(builder: FlatBufferBuilder, cruiseSpeed: Double) = builder.addDouble(10, cruiseSpeed, 0.0)
        fun addMaxSpeed(builder: FlatBufferBuilder, maxSpeed: Double) = builder.addDouble(11, maxSpeed, 0.0)
        fun addMinReqRunwayM(builder: FlatBufferBuilder, minReqRunwayM: Int) = builder.addInt(12, minReqRunwayM, 0)
        fun addMinReqRunwayFt(builder: FlatBufferBuilder, minReqRunwayFt: Int) = builder.addInt(13, minReqRunwayFt, 0)
        fun addNominalTATime(builder: FlatBufferBuilder, nominalTatime: Int) = builder.addInt(14, nominalTatime, 0)
        ...
        fun endAircraft_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAircraftAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRC")
        fun finishSizePrefixedAircraft_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRC")
    }
}
