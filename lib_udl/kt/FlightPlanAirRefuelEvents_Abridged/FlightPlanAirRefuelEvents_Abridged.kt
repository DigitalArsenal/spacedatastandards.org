 ...
 */
@Suppress("unused")
class FlightPlanAirRefuelEvents_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : FlightPlanAirRefuelEvents_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsFlightPlanAirRefuelEvents_Abridged(_bb: ByteBuffer): FlightPlanAirRefuelEvents_Abridged = getRootAsFlightPlanAirRefuelEvents_Abridged(_bb, FlightPlanAirRefuelEvents_Abridged())
        fun getRootAsFlightPlanAirRefuelEvents_Abridged(_bb: ByteBuffer, obj: FlightPlanAirRefuelEvents_Abridged): FlightPlanAirRefuelEvents_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun FlightPlanAirRefuelEvents_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "FLIG")
        fun createFlightPlanAirRefuelEvents_Abridged(builder: FlatBufferBuilder, arDegrade: Double, arNum: Int, arExchangedFuel: Double, divertFuel: Double, exitFuel: Double) : Int {
            ...
            return endFlightPlanAirRefuelEvents_Abridged(builder)
        }
        fun startFlightPlanAirRefuelEvents_Abridged(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endFlightPlanAirRefuelEvents_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishFlightPlanAirRefuelEventsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "FLIG")
        fun finishSizePrefixedFlightPlanAirRefuelEvents_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "FLIG")
    }
}
