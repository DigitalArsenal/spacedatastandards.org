 ...
 */
@Suppress("unused")
class IonoObservationTime_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationTime_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationTime_Full(_bb: ByteBuffer): IonoObservationTime_Full = getRootAsIonoObservationTime_Full(_bb, IonoObservationTime_Full())
        fun getRootAsIonoObservationTime_Full(_bb: ByteBuffer, obj: IonoObservationTime_Full): IonoObservationTime_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationTime_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationTime_Full(builder: FlatBufferBuilder, dimensionsOffset: Int, dimensionNameOffset: Int, notesOffset: Int, dataOffset: Int) : Int {
            ...
            return endIonoObservationTime_Full(builder)
        }
        fun startIonoObservationTime_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationTime_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationTimeFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationTime_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
