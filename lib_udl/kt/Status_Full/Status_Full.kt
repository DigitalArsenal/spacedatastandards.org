 ...
 */
@Suppress("unused")
class Status_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Status_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createStatus_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, derivedFromOffset: Int, declassificationDateOffset: Int, declassificationStringOffset: Int, idEntityOffset: Int, state: Byte, sysCap: Byte, opsCap: Byte, sourceOffset: Int, subStatusCollectionOffset: Int, dataMode: Byte, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, originOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endStatus_Full(builder)
        }
        fun startStatus_Full(builder: FlatBufferBuilder) = builder.startTable(19)
        ...
        fun endStatus_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishStatusFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "STAT")
        fun finishSizePrefixedStatus_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "STAT")
    }
}
