 ...
 */
@Suppress("unused")
class LaunchSiteDetails_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LaunchSiteDetails_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLaunchSiteDetails_Full(_bb: ByteBuffer): LaunchSiteDetails_Full = getRootAsLaunchSiteDetails_Full(_bb, LaunchSiteDetails_Full())
        fun getRootAsLaunchSiteDetails_Full(_bb: ByteBuffer, obj: LaunchSiteDetails_Full): LaunchSiteDetails_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LaunchSiteDetails_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LAUN")
        fun createLaunchSiteDetails_Full(builder: FlatBufferBuilder, idOffset: Int, idLaunchSiteOffset: Int, classificationMarkingOffset: Int, idLocationOffset: Int, launchGroupOffset: Int, availableInclinationsOffset: Int, descriptionOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, tagsOffset: Int, locationOffset: Int) : Int {
            ...
            return endLaunchSiteDetails_Full(builder)
        }
        fun startLaunchSiteDetails_Full(builder: FlatBufferBuilder) = builder.startTable(17)
        ...
        fun endLaunchSiteDetails_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLaunchSiteDetailsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LAUN")
        fun finishSizePrefixedLaunchSiteDetails_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LAUN")
    }
}
