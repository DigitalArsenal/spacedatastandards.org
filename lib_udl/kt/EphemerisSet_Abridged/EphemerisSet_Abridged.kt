 ...
 */
@Suppress("unused")
class EphemerisSet_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EphemerisSet_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createEphemerisSet_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, origObjectIdOffset: Int, pointStartTimeOffset: Int, usableStartTimeOffset: Int, pointEndTimeOffset: Int, usableEndTimeOffset: Int, stepSize: Int, numPoints: Int, typeOffset: Int, pedigreeOffset: Int, categoryOffset: Int, idStateVectorOffset: Int, hasMnvr: Boolean, idManeuversOffset: Int, hasCov: Boolean, hasAccel: Boolean, centBodyOffset: Int, integratorOffset: Int, geopotentialModelOffset: Int, dragModelOffset: Int, lunarSolar: Boolean, solidEarthTides: Boolean, bDot: Double, edr: Double, interpolationOffset: Int, interpolationDegree: Int, filenameOffset: Int, commentsOffset: Int, descriptionOffset: Int, descriptorOffset: Int, referenceFrame: Byte, covReferenceFrame: Byte, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, satNo: Int, transactionIdOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endEphemerisSet_Abridged(builder)
        }
        fun startEphemerisSet_Abridged(builder: FlatBufferBuilder) = builder.startTable(42)
        ...
        fun endEphemerisSet_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEphemerisSetAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EPHE")
        fun finishSizePrefixedEphemerisSet_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EPHE")
    }
}
