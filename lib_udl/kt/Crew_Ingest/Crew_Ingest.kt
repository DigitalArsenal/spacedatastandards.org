 ...
 */
@Suppress("unused")
class Crew_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Crew_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createCrew_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, origCrewIdOffset: Int, crewNameOffset: Int, statusOffset: Int, idSortieOffset: Int, legalAlertTimeOffset: Int, legalBravoTimeOffset: Int, alertedTimeOffset: Int, returnTimeOffset: Int, fdpEligTypeOffset: Int, fdpTypeOffset: Int, crewTypeOffset: Int, armsCrewUnitOffset: Int, crewMembersOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endCrew_Ingest(builder)
        }
        fun startCrew_Ingest(builder: FlatBufferBuilder) = builder.startTable(23)
        ...
        fun endCrew_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishCrewIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "CREW")
        fun finishSizePrefixedCrew_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "CREW")
    }
}
