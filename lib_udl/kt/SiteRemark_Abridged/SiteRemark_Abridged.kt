 ...
 */
@Suppress("unused")
class SiteRemark_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SiteRemark_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val origRmkIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(10, 1)
    fun origRmkIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 10, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsSiteRemark_Abridged(_bb: ByteBuffer): SiteRemark_Abridged = getRootAsSiteRemark_Abridged(_bb, SiteRemark_Abridged())
        fun getRootAsSiteRemark_Abridged(_bb: ByteBuffer, obj: SiteRemark_Abridged): SiteRemark_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SiteRemark_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SITE")
        fun createSiteRemark_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idSiteOffset: Int, origRmkIdOffset: Int, nameOffset: Int, typeOffset: Int, textOffset: Int, codeOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            addOrigRmkId(builder, origRmkIdOffset)
            addIdSite(builder, idSiteOffset)
            addClassificationMarking(builder, classificationMarkingOffset)
            addId(builder, idOffset)
            addDataMode(builder, dataMode)
            return endSiteRemark_Abridged(builder)
        }
        fun startSiteRemark_Abridged(builder: FlatBufferBuilder) = builder.startTable(14)
        fun addId(builder: FlatBufferBuilder, id: Int) = builder.addOffset(0, id, 0)
        fun addClassificationMarking(builder: FlatBufferBuilder, classificationMarking: Int) = builder.addOffset(1, classificationMarking, 0)
        fun addIdSite(builder: FlatBufferBuilder, idSite: Int) = builder.addOffset(2, idSite, 0)
        fun addOrigRmkId(builder: FlatBufferBuilder, origRmkId: Int) = builder.addOffset(3, origRmkId, 0)
        ...
        fun endSiteRemark_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSiteRemarkAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SITE")
        fun finishSizePrefixedSiteRemark_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SITE")
    }
}
