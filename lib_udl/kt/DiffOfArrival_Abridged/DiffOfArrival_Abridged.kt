 ...
 */
@Suppress("unused")
class DiffOfArrival_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DiffOfArrival_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val descriptorAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(78, 1)
    fun descriptorInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 78, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsDiffOfArrival_Abridged(_bb: ByteBuffer): DiffOfArrival_Abridged = getRootAsDiffOfArrival_Abridged(_bb, DiffOfArrival_Abridged())
        fun getRootAsDiffOfArrival_Abridged(_bb: ByteBuffer, obj: DiffOfArrival_Abridged): DiffOfArrival_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DiffOfArrival_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DIFF")
        fun createDiffOfArrival_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, obTimeOffset: Int, idOnOrbitOffset: Int, idSensor1Offset: Int, idSensor2Offset: Int, satNo: Int, taskIdOffset: Int, origObjectIdOffset: Int, origSensorId1Offset: Int, origSensorId2Offset: Int, uct: Boolean, sensor1Delay: Double, sensor2Delay: Double, senlat: Double, senlon: Double, senalt: Double, sen2lat: Double, sen2lon: Double, sen2alt: Double, frequency: Double, bandwidth: Double, deltaRange: Double, deltaRangeUnc: Double, deltaRangeRate: Double, deltaRangeRateUnc: Double, snr: Double, tdoa: Double, tdoaUnc: Double, fdoa: Double, fdoaUnc: Double, collectionModeOffset: Int, sourceOffset: Int, dataMode: Byte, originOffset: Int, createdAtOffset: Int, createdByOffset: Int, descriptorOffset: Int, transactionIdOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int) : Int {
            ...
            addUct(builder, uct)
            return endDiffOfArrival_Abridged(builder)
        }
        fun startDiffOfArrival_Abridged(builder: FlatBufferBuilder) = builder.startTable(41)
        ...
        fun addDescriptor(builder: FlatBufferBuilder, descriptor: Int) = builder.addOffset(37, descriptor, 0)
        ...
        fun endDiffOfArrival_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDiffOfArrivalAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DIFF")
        fun finishSizePrefixedDiffOfArrival_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DIFF")
    }
}
