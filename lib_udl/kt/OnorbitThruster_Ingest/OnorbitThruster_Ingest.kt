 ...
 */
@Suppress("unused")
class OnorbitThruster_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitThruster_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbitThruster_Ingest(_bb: ByteBuffer): OnorbitThruster_Ingest = getRootAsOnorbitThruster_Ingest(_bb, OnorbitThruster_Ingest())
        fun getRootAsOnorbitThruster_Ingest(_bb: ByteBuffer, obj: OnorbitThruster_Ingest): OnorbitThruster_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitThruster_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitThruster_Ingest(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, idEngineOffset: Int, classificationMarkingOffset: Int, typeOffset: Int, quantity: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, engineOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endOnorbitThruster_Ingest(builder)
        }
        fun startOnorbitThruster_Ingest(builder: FlatBufferBuilder) = builder.startTable(13)
        ...
        fun endOnorbitThruster_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitThrusterIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitThruster_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
