 ...
 */
@Suppress("unused")
class SEObservation_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SEObservation_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSEObservation_Full(_bb: ByteBuffer): SEObservation_Full = getRootAsSEObservation_Full(_bb, SEObservation_Full())
        fun getRootAsSEObservation_Full(_bb: ByteBuffer, obj: SEObservation_Full): SEObservation_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SEObservation_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SEOB")
        fun createSEObservation_Full(builder: FlatBufferBuilder, obTypeOffset: Int, obUoMOffset: Int, obValue: Double, obStringOffset: Int, obArrayOffset: Int, obBool: Boolean, obQualityOffset: Int, obDescriptionOffset: Int) : Int {
            ...
            return endSEObservation_Full(builder)
        }
        fun startSEObservation_Full(builder: FlatBufferBuilder) = builder.startTable(8)
        ...
        fun endSEObservation_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSEObservationFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SEOB")
        fun finishSizePrefixedSEObservation_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SEOB")
    }
}
