 ...
 */
@Suppress("unused")
class OnorbitList_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitList_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbitList_Full(_bb: ByteBuffer): OnorbitList_Full = getRootAsOnorbitList_Full(_bb, OnorbitList_Full())
        fun getRootAsOnorbitList_Full(_bb: ByteBuffer, obj: OnorbitList_Full): OnorbitList_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitList_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitList_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, nameOffset: Int, descriptionOffset: Int, onorbitsOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int) : Int {
            ...
            return endOnorbitList_Full(builder)
        }
        fun startOnorbitList_Full(builder: FlatBufferBuilder) = builder.startTable(12)
        ...
        fun addOnorbits(builder: FlatBufferBuilder, onorbits: Int) = builder.addOffset(4, onorbits, 0)
        ...
        fun startOnorbitsVector(builder: FlatBufferBuilder, numElems: Int) = builder.startVector(4, numElems, 4)
        ...
        fun endOnorbitList_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitListFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitList_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
