 ...
 */
@Suppress("unused")
class MissionAssignment_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : MissionAssignment_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createMissionAssignment_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, trkIdOffset: Int, tsOffset: Int, madOffset: Int, rcOffset: Int, rr: Int, tnoOffset: Int, twenvOffset: Int, lat: Double, lon: Double, orginxOffset: Int, envOffset: Int, szOffset: Int, index: Int, c1associateddmpis: Int, c2spcOffset: Int, c2airOffset: Int, c2surOffset: Int, c2lndOffset: Int, c2idOffset: Int, c2idamplifyingdescriptorOffset: Int, c2alt: Int, c2crs: Int, c2spd: Int, c2specialinterestindicatorOffset: Int, c2exerciseindicatorOffset: Int, c2exercisemofOffset: Int, c3lat: Double, c3lon: Double, c3elv: Double, c3ptlOffset: Int, c3ptnumOffset: Int, c4tgtOffset: Int, c4defOffset: Int, c4runin: Int, c4egress: Int, c4numberofstores: Int, c4typeofstores: Int, c4timediscreteOffset: Int, c4tm: Int, c4colon: Int, c4mod: Int, c5haeadj: Int, c5tw: Int, c5tgtbrng: Int, c5latlsb: Int, c5lonlsb: Int, c5elevationlsbs: Int, c5colon: Int, c6laser: Int, c6intel: Int, c6tnr3: Int, c6dspctOffset: Int, c6dspcOffset: Int, c6fplpmOffset: Int, c6longpmOffset: Int, c7tnorOffset: Int, c7in3p: Int, c7elang2: Double, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endMissionAssignment_Ingest(builder)
        }
        fun startMissionAssignment_Ingest(builder: FlatBufferBuilder) = builder.startTable(66)
        ...
        fun endMissionAssignment_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMissionAssignmentIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MISS")
        fun finishSizePrefixedMissionAssignment_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MISS")
    }
}
