 ...
 */
@Suppress("unused")
class AircraftMissionRemarks_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AircraftMissionRemarks_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAircraftMissionRemarks_Ingest(_bb: ByteBuffer): AircraftMissionRemarks_Ingest = getRootAsAircraftMissionRemarks_Ingest(_bb, AircraftMissionRemarks_Ingest())
        fun getRootAsAircraftMissionRemarks_Ingest(_bb: ByteBuffer, obj: AircraftMissionRemarks_Ingest): AircraftMissionRemarks_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AircraftMissionRemarks_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRC")
        fun createAircraftMissionRemarks_Ingest(builder: FlatBufferBuilder, gdssRemarkIdOffset: Int, typeOffset: Int, textOffset: Int, dateOffset: Int, userOffset: Int, itineraryNum: Int) : Int {
            ...
            return endAircraftMissionRemarks_Ingest(builder)
        }
        fun startAircraftMissionRemarks_Ingest(builder: FlatBufferBuilder) = builder.startTable(6)
        ...
        fun endAircraftMissionRemarks_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAircraftMissionRemarksIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRC")
        fun finishSizePrefixedAircraftMissionRemarks_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRC")
    }
}
