 ...
 */
@Suppress("unused")
class DataLinkMultiDuty_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DataLinkMultiDuty_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDataLinkMultiDuty_Full(_bb: ByteBuffer): DataLinkMultiDuty_Full = getRootAsDataLinkMultiDuty_Full(_bb, DataLinkMultiDuty_Full())
        fun getRootAsDataLinkMultiDuty_Full(_bb: ByteBuffer, obj: DataLinkMultiDuty_Full): DataLinkMultiDuty_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DataLinkMultiDuty_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DATA")
        fun createDataLinkMultiDuty_Full(builder: FlatBufferBuilder, unitDesOffset: Int, nameOffset: Int, rankOffset: Int, dutyOffset: Int, dutyTeleFreqNumsOffset: Int, multiDutyVoiceCoordOffset: Int) : Int {
            ...
            return endDataLinkMultiDuty_Full(builder)
        }
        fun startDataLinkMultiDuty_Full(builder: FlatBufferBuilder) = builder.startTable(6)
        ...
        fun endDataLinkMultiDuty_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDataLinkMultiDutyFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DATA")
        fun finishSizePrefixedDataLinkMultiDuty_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DATA")
    }
}
