 ...
 */
@Suppress("unused")
class Aircraft_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Aircraft_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val sourceDlAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(42, 1)
    fun sourceDlInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 42, 1)
    /**
     * Source of the data.
    ...
    companion object {
        ...
        fun createAircraft_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, entityOffset: Int, idEntityOffset: Int, aircraftMdsOffset: Int, tailNumberOffset: Int, serialNumberOffset: Int, ownerOffset: Int, commandOffset: Int, categoryOffset: Int, dtdOffset: Int, cruiseSpeed: Double, maxSpeed: Double, minReqRunwayM: Int, minReqRunwayFt: Int, nominalTatime: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endAircraft_Ingest(builder)
        }
        fun startAircraft_Ingest(builder: FlatBufferBuilder) = builder.startTable(24)
        ...
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(19, sourceDl, 0)
        ...
        fun endAircraft_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAircraftIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRC")
        fun finishSizePrefixedAircraft_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRC")
    }
}
