 ...
 */
@Suppress("unused")
class EvacMedication_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EvacMedication_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEvacMedication_Abridged(_bb: ByteBuffer): EvacMedication_Abridged = getRootAsEvacMedication_Abridged(_bb, EvacMedication_Abridged())
        fun getRootAsEvacMedication_Abridged(_bb: ByteBuffer, obj: EvacMedication_Abridged): EvacMedication_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EvacMedication_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EVAC")
        fun createEvacMedication_Abridged(builder: FlatBufferBuilder, typeOffset: Int, bodyPartOffset: Int, doseOffset: Int, adminRouteOffset: Int, timeOffset: Int, commentsOffset: Int) : Int {
            ...
            return endEvacMedication_Abridged(builder)
        }
        fun startEvacMedication_Abridged(builder: FlatBufferBuilder) = builder.startTable(6)
        ...
        fun endEvacMedication_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEvacMedicationAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EVAC")
        fun finishSizePrefixedEvacMedication_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EVAC")
    }
}
