 ...
 */
@Suppress("unused")
class IndividualAircraftTasking_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IndividualAircraftTasking_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIndividualAircraftTasking_Abridged(_bb: ByteBuffer): IndividualAircraftTasking_Abridged = getRootAsIndividualAircraftTasking_Abridged(_bb, IndividualAircraftTasking_Abridged())
        fun getRootAsIndividualAircraftTasking_Abridged(_bb: ByteBuffer, obj: IndividualAircraftTasking_Abridged): IndividualAircraftTasking_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IndividualAircraftTasking_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "INDI")
        fun createIndividualAircraftTasking_Abridged(builder: FlatBufferBuilder, numAcft: Int, acftTypeOffset: Int, callSignOffset: Int, priConfigCodeOffset: Int, secConfigCodeOffset: Int, link16CallSignOffset: Int, tacanChan: Int, juAddressOffset: Int, iffSifMode1CodeOffset: Int, iffSifMode2CodeOffset: Int, iffSifMode3CodeOffset: Int) : Int {
            ...
            return endIndividualAircraftTasking_Abridged(builder)
        }
        fun startIndividualAircraftTasking_Abridged(builder: FlatBufferBuilder) = builder.startTable(11)
        ...
        fun endIndividualAircraftTasking_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIndividualAircraftTaskingAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "INDI")
        fun finishSizePrefixedIndividualAircraftTasking_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "INDI")
    }
}
