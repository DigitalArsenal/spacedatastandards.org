 ...
 */
@Suppress("unused")
class Location_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Location_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLocation_Full(_bb: ByteBuffer): Location_Full = getRootAsLocation_Full(_bb, Location_Full())
        fun getRootAsLocation_Full(_bb: ByteBuffer, obj: Location_Full): Location_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Location_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOCA")
        fun createLocation_Full(builder: FlatBufferBuilder, idLocationOffset: Int, classificationMarkingOffset: Int, nameOffset: Int, countryCodeOffset: Int, lat: Double, lon: Double, altitude: Double, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endLocation_Full(builder)
        }
        fun startLocation_Full(builder: FlatBufferBuilder) = builder.startTable(15)
        ...
        fun endLocation_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLocationFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOCA")
        fun finishSizePrefixedLocation_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOCA")
    }
}
