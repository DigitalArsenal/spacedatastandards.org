...
class SeradataEarlyWarning_Ingest : Table() {
    ...
    companion object {
        ...
        fun SeradataEarlyWarning_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SERA")
        ...
        fun finishSeradataEarlyWarningIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SERA")
        fun finishSizePrefixedSeradataEarlyWarning_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SERA")
    }
}
