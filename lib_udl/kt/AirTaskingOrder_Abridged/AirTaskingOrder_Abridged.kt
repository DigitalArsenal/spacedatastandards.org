 ...
 */
@Suppress("unused")
class AirTaskingOrder_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirTaskingOrder_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirTaskingOrder_Abridged(_bb: ByteBuffer): AirTaskingOrder_Abridged = getRootAsAirTaskingOrder_Abridged(_bb, AirTaskingOrder_Abridged())
        fun getRootAsAirTaskingOrder_Abridged(_bb: ByteBuffer, obj: AirTaskingOrder_Abridged): AirTaskingOrder_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirTaskingOrder_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRT")
        fun createAirTaskingOrder_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, rawFileUriOffset: Int, opExerNameOffset: Int, msgOriginatorOffset: Int, msgSnOffset: Int, msgMonthOffset: Int, msgQualifierOffset: Int, ackReqIndOffset: Int, ackUnitInstructionsOffset: Int, beginTsOffset: Int, endTsOffset: Int, genTextOffset: Int, acMsnTaskingOffset: Int, navalFltOpsOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, sourceDlOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endAirTaskingOrder_Abridged(builder)
        }
        fun startAirTaskingOrder_Abridged(builder: FlatBufferBuilder) = builder.startTable(22)
        ...
        fun endAirTaskingOrder_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirTaskingOrderAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRT")
        fun finishSizePrefixedAirTaskingOrder_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRT")
    }
}
