 ...
 */
@Suppress("unused")
class ISRCollectionRequirements_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : ISRCollectionRequirements_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsISRCollectionRequirements_Abridged(_bb: ByteBuffer): ISRCollectionRequirements_Abridged = getRootAsISRCollectionRequirements_Abridged(_bb, ISRCollectionRequirements_Abridged())
        fun getRootAsISRCollectionRequirements_Abridged(_bb: ByteBuffer, obj: ISRCollectionRequirements_Abridged): ISRCollectionRequirements_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun ISRCollectionRequirements_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ISRC")
        fun createISRCollectionRequirements_Abridged(builder: FlatBufferBuilder, idOffset: Int, hashOffset: Int, typeOffset: Int, cridNumbersOffset: Int, priority: Double, recordIdOffset: Int, reconSurveyOffset: Int, intelDisciplineOffset: Int, secondary: Boolean, emphasized: Boolean, isPrismCr: Boolean, startOffset: Int, stopOffset: Int, operationOffset: Int, supportedUnitOffset: Int, countryOffset: Int, regionOffset: Int, subregionOffset: Int, specialComGuidanceOffset: Int, criticalTimesOffset: Int, exploitationRequirementOffset: Int, targetListOffset: Int) : Int {
            ...
            return endISRCollectionRequirements_Abridged(builder)
        }
        fun startISRCollectionRequirements_Abridged(builder: FlatBufferBuilder) = builder.startTable(22)
        ...
        fun endISRCollectionRequirements_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishISRCollectionRequirementsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ISRC")
        fun finishSizePrefixedISRCollectionRequirements_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ISRC")
    }
}
