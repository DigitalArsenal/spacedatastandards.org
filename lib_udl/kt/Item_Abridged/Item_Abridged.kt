 ...
 */
@Suppress("unused")
class Item_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Item_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createItem_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idAirLoadPlanOffset: Int, scanCodeOffset: Int, scGenToolOffset: Int, typeOffset: Int, cargoTypeOffset: Int, nameOffset: Int, destinationOffset: Int, departureOffset: Int, receivingUnitOffset: Int, receivingBranchOffset: Int, lastArrDateOffset: Int, ulnOffset: Int, weight: Double, weightTsOffset: Int, commodityCodeOffset: Int, commoditySysOffset: Int, productCodeOffset: Int, productSysOffset: Int, width: Double, length: Double, height: Double, volume: Double, cg: Double, fs: Double, centerlineOffset: Double, moment: Double, airdrop: Boolean, tcnOffset: Int, hazCodesOffset: Int, netExpWt: Double, container: Boolean, itemContainsOffset: Int, numPalletPos: Int, dvCodeOffset: Int, notesOffset: Int, keysOffset: Int, valuesOffset: Int, altDataFormatOffset: Int, accSystemOffset: Int, accSysNotesOffset: Int, accSysKeysOffset: Int, accSysValuesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endItem_Abridged(builder)
        }
        fun startItem_Abridged(builder: FlatBufferBuilder) = builder.startTable(51)
        ...
        fun endItem_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishItemAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ITEM")
        fun finishSizePrefixedItem_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ITEM")
    }
}
