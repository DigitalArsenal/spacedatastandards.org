 ...
 */
@Suppress("unused")
class DataLinkReferences_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DataLinkReferences_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDataLinkReferences_Ingest(_bb: ByteBuffer): DataLinkReferences_Ingest = getRootAsDataLinkReferences_Ingest(_bb, DataLinkReferences_Ingest())
        fun getRootAsDataLinkReferences_Ingest(_bb: ByteBuffer, obj: DataLinkReferences_Ingest): DataLinkReferences_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DataLinkReferences_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DATA")
        fun createDataLinkReferences_Ingest(builder: FlatBufferBuilder, refSerialIdOffset: Int, refTypeOffset: Int, refOriginatorOffset: Int, refTsOffset: Int, refSerialNumOffset: Int, refSpecialNotationOffset: Int, refSicsOffset: Int) : Int {
            ...
            return endDataLinkReferences_Ingest(builder)
        }
        fun startDataLinkReferences_Ingest(builder: FlatBufferBuilder) = builder.startTable(7)
        ...
        fun endDataLinkReferences_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDataLinkReferencesIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DATA")
        fun finishSizePrefixedDataLinkReferences_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DATA")
    }
}
