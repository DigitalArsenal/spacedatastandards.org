 ...
 */
@Suppress("unused")
class Operatingunit_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Operatingunit_Full {
        __init(_i, _bb)
        return this
    }
    /**
     ...
     * Constraints: No constraints specified.
     */
    fun operatingUnitRemarks(j: Int) : String? {
        val o = __offset(114)
        return if (o != 0) {
    ...
    val operatingUnitRemarksLength : Int
        get() {
    ...
    val createdAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(116, 1)
    fun createdAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 116, 1)
    /**
    ...
    val createdByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(118, 1)
    fun createdByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 118, 1)
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(120, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 120, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(122, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 122, 1)
    /**
     * Source of the data.
     * Example: /// Example: some.user
     * Constraints: Minimum length = 1, Maximum length = 64
    ...
    val sourceAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(124, 1)
    fun sourceInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 124, 1)
    /**
    ...
    val originAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(126, 1)
    fun originInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 126, 1)
    /**
    ...
    val organizationAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(130, 1)
    fun organizationInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 130, 1)
    /**
     * No description provided.
     * Example: /// Example: No example provided.
     * Constraints: No constraints specified.
    ...
    val locationAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(132, 1)
    fun locationInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 132, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsOperatingunit_Full(_bb: ByteBuffer): Operatingunit_Full = getRootAsOperatingunit_Full(_bb, Operatingunit_Full())
        fun getRootAsOperatingunit_Full(_bb: ByteBuffer, obj: Operatingunit_Full): Operatingunit_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Operatingunit_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "OPER")
        fun createOperatingunit_Full(builder: FlatBufferBuilder, idOperatingUnitOffset: Int, classificationMarkingOffset: Int, altOperatingUnitIdOffset: Int, nameOffset: Int, descriptionOffset: Int, idLocationOffset: Int, idContactOffset: Int, idOrganizationOffset: Int, unitIdentifierOffset: Int, countryCodeOffset: Int, altCountryCodeOffset: Int, wacOffset: Int, operStatusOffset: Int, conditionOffset: Int, conditionAvailOffset: Int, eval: Int, fpaOffset: Int, identOffset: Int, allegianceOffset: Int, altAllegianceOffset: Int, locNameOffset: Int, locReasonOffset: Int, forceOffset: Int, forceNameOffset: Int, functRoleOffset: Int, msnPrimaryOffset: Int, msnPrimarySpecialtyOffset: Int, masterUnit: Boolean, stylizedUnit: Boolean, divCatOffset: Int, echelonOffset: Int, echelonTierOffset: Int, fleetIdOffset: Int, deployStatusOffset: Int, flagFlownOffset: Int, coordDatumOffset: Int, coordOffset: Int, coordDerivAcc: Double, lat: Double, lon: Double, elevMsl: Double, elevMslConfLvl: Int, elevMslDerivAcc: Double, geoidalMslSep: Double, milGridSysOffset: Int, milGridOffset: Int, utmOffset: Int, airDefAreaOffset: Int, polSubdivOffset: Int, symCodeOffset: Int, classRatingOffset: Int, recStatusOffset: Int, reviewDateOffset: Int, resProdOffset: Int, referenceDocOffset: Int, operatingUnitRemarksOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, organizationOffset: Int, locationOffset: Int) : Int {
            ...
            addOperatingUnitRemarks(builder, operatingUnitRemarksOffset)
            ...
            return endOperatingunit_Full(builder)
        }
        fun startOperatingunit_Full(builder: FlatBufferBuilder) = builder.startTable(65)
        ...
        fun addOperatingUnitRemarks(builder: FlatBufferBuilder, operatingUnitRemarks: Int) = builder.addOffset(55, operatingUnitRemarks, 0)
        fun createOperatingUnitRemarksVector(builder: FlatBufferBuilder, data: IntArray) : Int {
        ...
        fun startOperatingUnitRemarksVector(builder: FlatBufferBuilder, numElems: Int) = builder.startVector(4, numElems, 4)
        fun addCreatedAt(builder: FlatBufferBuilder, createdAt: Int) = builder.addOffset(56, createdAt, 0)
        fun addCreatedBy(builder: FlatBufferBuilder, createdBy: Int) = builder.addOffset(57, createdBy, 0)
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(58, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(59, updatedBy, 0)
        fun addSource(builder: FlatBufferBuilder, source: Int) = builder.addOffset(60, source, 0)
        fun addOrigin(builder: FlatBufferBuilder, origin: Int) = builder.addOffset(61, origin, 0)
        fun addDataMode(builder: FlatBufferBuilder, dataMode: Byte) = builder.addByte(62, dataMode, 0)
        fun addOrganization(builder: FlatBufferBuilder, organization: Int) = builder.addOffset(63, organization, 0)
        fun addLocation(builder: FlatBufferBuilder, location: Int) = builder.addOffset(64, location, 0)
        fun endOperatingunit_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOperatingunitFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "OPER")
        fun finishSizePrefixedOperatingunit_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "OPER")
    }
}
