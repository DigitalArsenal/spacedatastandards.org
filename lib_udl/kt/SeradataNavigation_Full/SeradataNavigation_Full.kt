 ...
 */
@Suppress("unused")
class SeradataNavigation_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SeradataNavigation_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createSeradataNavigation_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idNavigationOffset: Int, spacecraftIdOffset: Int, hostedForCompanyOrgIdOffset: Int, manufacturerOrgIdOffset: Int, payloadTypeOffset: Int, modesOffset: Int, modeFrequencyOffset: Int, locationAccuracy: Double, partnerSpacecraftIdOffset: Int, areaCoverageOffset: Int, notesOffset: Int, nameOffset: Int, clockTypeOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endSeradataNavigation_Full(builder)
        }
        fun startSeradataNavigation_Full(builder: FlatBufferBuilder) = builder.startTable(23)
        ...
        fun endSeradataNavigation_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSeradataNavigationFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SERA")
        fun finishSizePrefixedSeradataNavigation_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SERA")
    }
}
