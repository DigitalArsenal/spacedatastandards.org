 ...
 */
@Suppress("unused")
class StateVector_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : StateVector_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val rawFileUriAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(168, 1)
    fun rawFileUriInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 168, 1)
    /**
     * Source of the data.
    ...
    val algorithmAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(178, 1)
    fun algorithmInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 178, 1)
    /**
    ...
    val descriptorAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(188, 1)
    fun descriptorInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 188, 1)
    /**
    ...
    val transactionIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(190, 1)
    fun transactionIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 190, 1)
    /**
    ...
    val origNetworkAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(192, 1)
    fun origNetworkInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 192, 1)
    /**
    ...
    companion object {
        ...
        fun createStateVector_Ingest(builder: FlatBufferBuilder, idStateVectorOffset: Int, classificationMarkingOffset: Int, epochOffset: Int, pedigreeOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, idOrbitDeterminationOffset: Int, uct: Boolean, xpos: Double, ypos: Double, zpos: Double, xvel: Double, yvel: Double, zvel: Double, referenceFrame: Byte, covOffset: Int, covReferenceFrame: Byte, covMethodOffset: Int, eqCovOffset: Int, xposAlt1: Double, yposAlt1: Double, zposAlt1: Double, xvelAlt1: Double, yvelAlt1: Double, zvelAlt1: Double, alt1ReferenceFrameOffset: Int, xposAlt2: Double, yposAlt2: Double, zposAlt2: Double, xvelAlt2: Double, yvelAlt2: Double, zvelAlt2: Double, alt2ReferenceFrameOffset: Int, posUnc: Double, velUnc: Double, mass: Double, area: Double, solarRadPressCoeff: Double, dragCoeff: Double, dragArea: Double, revNo: Int, geopotentialModelOffset: Int, dragModelOffset: Int, lunarSolar: Boolean, solarRadPress: Boolean, srpArea: Double, solidEarthTides: Boolean, inTrackThrust: Boolean, bDot: Double, edr: Double, thrustAccel: Double, cmOffset: Double, lastObStartOffset: Int, lastObEndOffset: Int, obsAvailable: Int, obsUsed: Int, tracksAvail: Int, tracksUsed: Int, recOdspan: Double, actualOdspan: Double, residualsAcc: Double, solarFluxF10: Double, solarFluxF10Avg: Double, solarFluxApavg: Double, taiUtc: Double, ut1Utc: Double, ut1Rate: Double, polarMotionX: Double, polarMotionY: Double, iau1980Terms: Int, leapSecondTimeOffset: Int, integratorModeOffset: Int, partialsOffset: Int, stepModeOffset: Int, fixedStep: Boolean, stepSizeSelectionOffset: Int, stepSize: Double, errorControl: Double, sigmaPosUvwOffset: Int, sigmaVelUvwOffset: Int, rms: Double, rawFileUriOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, tagsOffset: Int, algorithmOffset: Int, sourcedDataOffset: Int, sourcedDataTypes: Byte, createdAtOffset: Int, createdByOffset: Int, descriptorOffset: Int, transactionIdOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int) : Int {
            ...
            addUct(builder, uct)
            return endStateVector_Ingest(builder)
        }
        fun startStateVector_Ingest(builder: FlatBufferBuilder) = builder.startTable(96)
        ...
        fun addRawFileURI(builder: FlatBufferBuilder, rawFileUri: Int) = builder.addOffset(82, rawFileUri, 0)
        ...
        fun addTags(builder: FlatBufferBuilder, tags: Int) = builder.addOffset(86, tags, 0)
        ...
        fun addAlgorithm(builder: FlatBufferBuilder, algorithm: Int) = builder.addOffset(87, algorithm, 0)
        fun addSourcedData(builder: FlatBufferBuilder, sourcedData: Int) = builder.addOffset(88, sourcedData, 0)
        ...
        fun addSourcedDataTypes(builder: FlatBufferBuilder, sourcedDataTypes: Byte) = builder.addByte(89, sourcedDataTypes, 0)
        ...
        fun addDescriptor(builder: FlatBufferBuilder, descriptor: Int) = builder.addOffset(92, descriptor, 0)
        fun addTransactionId(builder: FlatBufferBuilder, transactionId: Int) = builder.addOffset(93, transactionId, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(94, origNetwork, 0)
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(95, sourceDl, 0)
        fun endStateVector_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishStateVectorIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "STAT")
        fun finishSizePrefixedStateVector_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "STAT")
    }
}
