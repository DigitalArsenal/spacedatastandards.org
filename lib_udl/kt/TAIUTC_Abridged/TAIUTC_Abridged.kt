 ...
 */
@Suppress("unused")
class TAIUTC_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : TAIUTC_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val adjustmentDateAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(8, 1)
    fun adjustmentDateInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 8, 1)
    /**
    ...
    val rawFileUriAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(14, 1)
    fun rawFileUriInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 14, 1)
    /**
     * Source of the data.
    ...
    companion object {
        ...
        fun getRootAsTAIUTC_Abridged(_bb: ByteBuffer): TAIUTC_Abridged = getRootAsTAIUTC_Abridged(_bb, TAIUTC_Abridged())
        fun getRootAsTAIUTC_Abridged(_bb: ByteBuffer, obj: TAIUTC_Abridged): TAIUTC_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun TAIUTC_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "TAIU")
        fun createTAIUTC_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, adjustmentDateOffset: Int, taiUtc: Double, multiplicationFactor: Double, rawFileUriOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int) : Int {
            builder.startTable(12)
            addMultiplicationFactor(builder, multiplicationFactor)
            ...
            addAdjustmentDate(builder, adjustmentDateOffset)
            addClassificationMarking(builder, classificationMarkingOffset)
            addId(builder, idOffset)
            addDataMode(builder, dataMode)
            return endTAIUTC_Abridged(builder)
        }
        fun startTAIUTC_Abridged(builder: FlatBufferBuilder) = builder.startTable(12)
        fun addId(builder: FlatBufferBuilder, id: Int) = builder.addOffset(0, id, 0)
        fun addClassificationMarking(builder: FlatBufferBuilder, classificationMarking: Int) = builder.addOffset(1, classificationMarking, 0)
        fun addAdjustmentDate(builder: FlatBufferBuilder, adjustmentDate: Int) = builder.addOffset(2, adjustmentDate, 0)
        fun addTaiUTC(builder: FlatBufferBuilder, taiUtc: Double) = builder.addDouble(3, taiUtc, 0.0)
        fun addMultiplicationFactor(builder: FlatBufferBuilder, multiplicationFactor: Double) = builder.addDouble(4, multiplicationFactor, 0.0)
        fun addRawFileURI(builder: FlatBufferBuilder, rawFileUri: Int) = builder.addOffset(5, rawFileUri, 0)
        ...
        fun endTAIUTC_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishTAIUTCAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "TAIU")
        fun finishSizePrefixedTAIUTC_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "TAIU")
    }
}
