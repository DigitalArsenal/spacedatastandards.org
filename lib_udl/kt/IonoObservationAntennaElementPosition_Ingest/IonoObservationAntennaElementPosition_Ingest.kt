 ...
 */
@Suppress("unused")
class IonoObservationAntennaElementPosition_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationAntennaElementPosition_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationAntennaElementPosition_Ingest(_bb: ByteBuffer): IonoObservationAntennaElementPosition_Ingest = getRootAsIonoObservationAntennaElementPosition_Ingest(_bb, IonoObservationAntennaElementPosition_Ingest())
        fun getRootAsIonoObservationAntennaElementPosition_Ingest(_bb: ByteBuffer, obj: IonoObservationAntennaElementPosition_Ingest): IonoObservationAntennaElementPosition_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationAntennaElementPosition_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationAntennaElementPosition_Ingest(builder: FlatBufferBuilder, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int) : Int {
            builder.startTable(3)
            addData(builder, dataOffset)
            addDimensionName(builder, dimensionNameOffset)
            addDimensions(builder, dimensionsOffset)
            return endIonoObservationAntennaElementPosition_Ingest(builder)
        }
        fun startIonoObservationAntennaElementPosition_Ingest(builder: FlatBufferBuilder) = builder.startTable(3)
        ...
        fun endIonoObservationAntennaElementPosition_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationAntennaElementPositionIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationAntennaElementPosition_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
