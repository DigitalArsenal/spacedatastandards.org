 ...
 */
@Suppress("unused")
class IonoObservationElevation_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationElevation_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationElevation_Full(_bb: ByteBuffer): IonoObservationElevation_Full = getRootAsIonoObservationElevation_Full(_bb, IonoObservationElevation_Full())
        fun getRootAsIonoObservationElevation_Full(_bb: ByteBuffer, obj: IonoObservationElevation_Full): IonoObservationElevation_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationElevation_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationElevation_Full(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int) : Int {
            ...
            return endIonoObservationElevation_Full(builder)
        }
        fun startIonoObservationElevation_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationElevation_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationElevationFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationElevation_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
