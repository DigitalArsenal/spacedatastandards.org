 ...
 */
@Suppress("unused")
class PassiveRadarObservation_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : PassiveRadarObservation_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val transactionIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(116, 1)
    fun transactionIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 116, 1)
    /**
    ...
    val createdAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(120, 1)
    fun createdAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 120, 1)
    /**
    ...
    val createdByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(122, 1)
    fun createdByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 122, 1)
    /**
     * Source of the data.
    ...
    val origNetworkAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(128, 1)
    fun origNetworkInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 128, 1)
    /**
    ...
    companion object {
        ...
        fun createPassiveRadarObservation_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, obTimeOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, idSensorOffset: Int, origSensorIdOffset: Int, idRfemitterOffset: Int, idSensorRefReceiverOffset: Int, extObservationIdOffset: Int, taskIdOffset: Int, trackIdOffset: Int, obPositionOffset: Int, uct: Boolean, azimuth: Double, azimuthUnc: Double, azimuthBias: Double, azimuthRate: Double, elevation: Double, elevationUnc: Double, elevationBias: Double, elevationRate: Double, delay: Double, delayUnc: Double, delayBias: Double, bistaticRange: Double, bistaticRangeUnc: Double, bistaticRangeBias: Double, bistaticRangeRate: Double, bistaticRangeRateUnc: Double, bistaticRangeAccel: Double, bistaticRangeAccelUnc: Double, doppler: Double, dopplerUnc: Double, coning: Double, coningUnc: Double, tof: Double, tofUnc: Double, tofBias: Double, accel: Double, accelUnc: Double, ra: Double, declination: Double, lat: Double, lon: Double, alt: Double, xvel: Double, yvel: Double, zvel: Double, rcs: Double, rcsUnc: Double, orthogonalRcs: Double, orthogonalRcsUnc: Double, snr: Double, timingBias: Double, transactionIdOffset: Int, descriptorOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int, dataMode: Byte, typeOffset: Int) : Int {
            ...
            addUct(builder, uct)
            return endPassiveRadarObservation_Abridged(builder)
        }
        fun startPassiveRadarObservation_Abridged(builder: FlatBufferBuilder) = builder.startTable(66)
        ...
        fun addTransactionId(builder: FlatBufferBuilder, transactionId: Int) = builder.addOffset(56, transactionId, 0)
        fun addDescriptor(builder: FlatBufferBuilder, descriptor: Int) = builder.addOffset(57, descriptor, 0)
        fun addCreatedAt(builder: FlatBufferBuilder, createdAt: Int) = builder.addOffset(58, createdAt, 0)
        fun addCreatedBy(builder: FlatBufferBuilder, createdBy: Int) = builder.addOffset(59, createdBy, 0)
        ...
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(62, origNetwork, 0)
        ...
        fun addType(builder: FlatBufferBuilder, type: Int) = builder.addOffset(65, type, 0)
        fun endPassiveRadarObservation_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishPassiveRadarObservationAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "PASS")
        fun finishSizePrefixedPassiveRadarObservation_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "PASS")
    }
}
