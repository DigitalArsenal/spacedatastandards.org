 ...
 */
@Suppress("unused")
class OnorbitThrusterStatus_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitThrusterStatus_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbitThrusterStatus_Ingest(_bb: ByteBuffer): OnorbitThrusterStatus_Ingest = getRootAsOnorbitThrusterStatus_Ingest(_bb, OnorbitThrusterStatus_Ingest())
        fun getRootAsOnorbitThrusterStatus_Ingest(_bb: ByteBuffer, obj: OnorbitThrusterStatus_Ingest): OnorbitThrusterStatus_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitThrusterStatus_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitThrusterStatus_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnorbitThrusterOffset: Int, nameOffset: Int, statusTimeOffset: Int, propMassMin: Double, propMassAvg: Double, propMassMedian: Double, propMassMax: Double, fuelMass: Double, fuelMassUnc: Double, totalDeltaV: Double, minDeltaV: Double, estDeltaV: Double, maxDeltaV: Double, thrustMax: Double, isp: Double, operational: Boolean, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endOnorbitThrusterStatus_Ingest(builder)
        }
        fun startOnorbitThrusterStatus_Ingest(builder: FlatBufferBuilder) = builder.startTable(24)
        ...
        fun endOnorbitThrusterStatus_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitThrusterStatusIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitThrusterStatus_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
