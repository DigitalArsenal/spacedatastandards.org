 ...
 */
@Suppress("unused")
class PersonnelRecoveryVehicle_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : PersonnelRecoveryVehicle_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsPersonnelRecoveryVehicle_Full(_bb: ByteBuffer): PersonnelRecoveryVehicle_Full = getRootAsPersonnelRecoveryVehicle_Full(_bb, PersonnelRecoveryVehicle_Full())
        fun getRootAsPersonnelRecoveryVehicle_Full(_bb: ByteBuffer, obj: PersonnelRecoveryVehicle_Full): PersonnelRecoveryVehicle_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun PersonnelRecoveryVehicle_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "PERS")
        fun createPersonnelRecoveryVehicle_Full(builder: FlatBufferBuilder, callSignOffset: Int, typeOffset: Int, primaryFreq: Double, strength: Int) : Int {
            builder.startTable(4)
            addPrimaryFreq(builder, primaryFreq)
            addStrength(builder, strength)
            addType(builder, typeOffset)
            addCallSign(builder, callSignOffset)
            return endPersonnelRecoveryVehicle_Full(builder)
        }
        fun startPersonnelRecoveryVehicle_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endPersonnelRecoveryVehicle_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishPersonnelRecoveryVehicleFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "PERS")
        fun finishSizePrefixedPersonnelRecoveryVehicle_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "PERS")
    }
}
