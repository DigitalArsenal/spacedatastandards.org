 ...
 */
@Suppress("unused")
class IonoObservationTraceGeneric_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationTraceGeneric_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationTraceGeneric_Full(_bb: ByteBuffer): IonoObservationTraceGeneric_Full = getRootAsIonoObservationTraceGeneric_Full(_bb, IonoObservationTraceGeneric_Full())
        fun getRootAsIonoObservationTraceGeneric_Full(_bb: ByteBuffer, obj: IonoObservationTraceGeneric_Full): IonoObservationTraceGeneric_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationTraceGeneric_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationTraceGeneric_Full(builder: FlatBufferBuilder, dataOffset: Int, dimensionNameOffset: Int, notesOffset: Int) : Int {
            builder.startTable(3)
            addNotes(builder, notesOffset)
            addDimensionName(builder, dimensionNameOffset)
            addData(builder, dataOffset)
            return endIonoObservationTraceGeneric_Full(builder)
        }
        fun startIonoObservationTraceGeneric_Full(builder: FlatBufferBuilder) = builder.startTable(3)
        ...
        fun endIonoObservationTraceGeneric_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationTraceGenericFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationTraceGeneric_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
