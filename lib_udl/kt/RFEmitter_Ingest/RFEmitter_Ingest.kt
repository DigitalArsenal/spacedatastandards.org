 ...
 */
@Suppress("unused")
class RFEmitter_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : RFEmitter_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsRFEmitter_Ingest(_bb: ByteBuffer): RFEmitter_Ingest = getRootAsRFEmitter_Ingest(_bb, RFEmitter_Ingest())
        fun getRootAsRFEmitter_Ingest(_bb: ByteBuffer, obj: RFEmitter_Ingest): RFEmitter_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun RFEmitter_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "RFEM")
        fun createRFEmitter_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idEntityOffset: Int, nameOffset: Int, typeOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, entityOffset: Int) : Int {
            ...
            return endRFEmitter_Ingest(builder)
        }
        fun startRFEmitter_Ingest(builder: FlatBufferBuilder) = builder.startTable(12)
        ...
        fun endRFEmitter_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishRFEmitterIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "RFEM")
        fun finishSizePrefixedRFEmitter_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "RFEM")
    }
}
