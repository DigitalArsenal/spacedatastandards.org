 ...
 */
@Suppress("unused")
class Country_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Country_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsCountry_Ingest(_bb: ByteBuffer): Country_Ingest = getRootAsCountry_Ingest(_bb, Country_Ingest())
        fun getRootAsCountry_Ingest(_bb: ByteBuffer, obj: Country_Ingest): Country_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Country_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "COUN")
        fun createCountry_Ingest(builder: FlatBufferBuilder, codeOffset: Int, nameOffset: Int, fipsCodeOffset: Int, iso3CodeOffset: Int, codeAltOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endCountry_Ingest(builder)
        }
        fun startCountry_Ingest(builder: FlatBufferBuilder) = builder.startTable(10)
        ...
        fun endCountry_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishCountryIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "COUN")
        fun finishSizePrefixedCountry_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "COUN")
    }
}
