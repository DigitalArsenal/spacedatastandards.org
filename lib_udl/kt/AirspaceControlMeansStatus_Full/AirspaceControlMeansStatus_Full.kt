 ...
 */
@Suppress("unused")
class AirspaceControlMeansStatus_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirspaceControlMeansStatus_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirspaceControlMeansStatus_Full(_bb: ByteBuffer): AirspaceControlMeansStatus_Full = getRootAsAirspaceControlMeansStatus_Full(_bb, AirspaceControlMeansStatus_Full())
        fun getRootAsAirspaceControlMeansStatus_Full(_bb: ByteBuffer, obj: AirspaceControlMeansStatus_Full): AirspaceControlMeansStatus_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirspaceControlMeansStatus_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRS")
        fun createAirspaceControlMeansStatus_Full(builder: FlatBufferBuilder, cmStatOffset: Int, cmStatIdOffset: Int, airspaceControlMeansOffset: Int) : Int {
            ...
            return endAirspaceControlMeansStatus_Full(builder)
        }
        fun startAirspaceControlMeansStatus_Full(builder: FlatBufferBuilder) = builder.startTable(3)
        ...
        fun endAirspaceControlMeansStatus_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirspaceControlMeansStatusFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRS")
        fun finishSizePrefixedAirspaceControlMeansStatus_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRS")
    }
}
