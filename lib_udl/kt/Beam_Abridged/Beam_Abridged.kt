 ...
 */
@Suppress("unused")
class Beam_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Beam_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsBeam_Abridged(_bb: ByteBuffer): Beam_Abridged = getRootAsBeam_Abridged(_bb, Beam_Abridged())
        fun getRootAsBeam_Abridged(_bb: ByteBuffer, obj: Beam_Abridged): Beam_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Beam_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "BEAM")
        fun createBeam_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, beamNameOffset: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endBeam_Abridged(builder)
        }
        fun startBeam_Abridged(builder: FlatBufferBuilder) = builder.startTable(10)
        ...
        fun endBeam_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishBeamAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "BEAM")
        fun finishSizePrefixedBeam_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "BEAM")
    }
}
