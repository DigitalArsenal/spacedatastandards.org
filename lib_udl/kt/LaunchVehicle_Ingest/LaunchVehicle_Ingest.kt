 ...
 */
@Suppress("unused")
class LaunchVehicle_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LaunchVehicle_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLaunchVehicle_Ingest(_bb: ByteBuffer): LaunchVehicle_Ingest = getRootAsLaunchVehicle_Ingest(_bb, LaunchVehicle_Ingest())
        fun getRootAsLaunchVehicle_Ingest(_bb: ByteBuffer, obj: LaunchVehicle_Ingest): LaunchVehicle_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LaunchVehicle_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LAUN")
        fun createLaunchVehicle_Ingest(builder: FlatBufferBuilder, idOffset: Int, nameOffset: Int, classificationMarkingOffset: Int, typeOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endLaunchVehicle_Ingest(builder)
        }
        fun startLaunchVehicle_Ingest(builder: FlatBufferBuilder) = builder.startTable(10)
        ...
        fun endLaunchVehicle_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLaunchVehicleIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LAUN")
        fun finishSizePrefixedLaunchVehicle_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LAUN")
    }
}
