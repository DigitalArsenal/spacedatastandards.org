 ...
 */
@Suppress("unused")
class Vessel_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Vessel_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createVessel_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, entityOffset: Int, idEntityOffset: Int, altVesselIdOffset: Int, idOrganizationOffset: Int, vesselNameOffset: Int, vesselTypeOffset: Int, vesselClassOffset: Int, vesselDescriptionOffset: Int, sconumOffset: Int, imon: Int, mmsiOffset: Int, callsignOffset: Int, vesselFlagOffset: Int, yearBuiltOffset: Int, vesselBuilderOffset: Int, statusOffset: Int, firstSeenOffset: Int, length: Double, width: Double, maxDraught: Double, vslWt: Double, maxSpeed: Double, sternTypeOffset: Int, numBlades: Int, numShafts: Int, propTypeOffset: Int, hullNumOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endVessel_Ingest(builder)
        }
        fun startVessel_Ingest(builder: FlatBufferBuilder) = builder.startTable(35)
        ...
        fun endVessel_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishVesselIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "VESS")
        fun finishSizePrefixedVessel_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "VESS")
    }
}
