 ...
 */
@Suppress("unused")
class IonoObservationPolarization_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationPolarization_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationPolarization_Ingest(_bb: ByteBuffer): IonoObservationPolarization_Ingest = getRootAsIonoObservationPolarization_Ingest(_bb, IonoObservationPolarization_Ingest())
        fun getRootAsIonoObservationPolarization_Ingest(_bb: ByteBuffer, obj: IonoObservationPolarization_Ingest): IonoObservationPolarization_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationPolarization_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationPolarization_Ingest(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, data: Byte) : Int {
            ...
            return endIonoObservationPolarization_Ingest(builder)
        }
        fun startIonoObservationPolarization_Ingest(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationPolarization_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationPolarizationIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationPolarization_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
