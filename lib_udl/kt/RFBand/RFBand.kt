...
class RFBand : Table() {
    ...
    fun __assign(_i: Int, _bb: ByteBuffer) : RFBand {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createRFBand(builder: FlatBufferBuilder, idOffset: Int, idEntityOffset: Int, classificationMarkingOffset: Int, nameOffset: Int, bandOffset: Int, mode: Byte, purpose: Byte, freqMin: Double, freqMax: Double, centerFreq: Double, peakGain: Double, edgeGain: Double, bandwidth: Double, beamwidth: Double, polarization: Byte, erp: Double, eirp: Double, sourceOffset: Int, originOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endRFBand(builder)
        }
        fun startRFBand(builder: FlatBufferBuilder) = builder.startTable(25)
        ...
        fun endRFBand(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishRFBandBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "RFBA")
        fun finishSizePrefixedRFBandBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "RFBA")
    }
}
