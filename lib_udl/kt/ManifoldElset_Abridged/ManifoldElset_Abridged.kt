 ...
 */
@Suppress("unused")
class ManifoldElset_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : ManifoldElset_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsManifoldElset_Abridged(_bb: ByteBuffer): ManifoldElset_Abridged = getRootAsManifoldElset_Abridged(_bb, ManifoldElset_Abridged())
        fun getRootAsManifoldElset_Abridged(_bb: ByteBuffer, obj: ManifoldElset_Abridged): ManifoldElset_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun ManifoldElset_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MANI")
        fun createManifoldElset_Abridged(builder: FlatBufferBuilder, idOffset: Int, idManifoldOffset: Int, classificationMarkingOffset: Int, tmpSatNo: Int, epochOffset: Int, meanMotion: Double, eccentricity: Double, inclination: Double, raan: Double, argOfPerigee: Double, meanAnomaly: Double, revNo: Int, bStar: Double, meanMotionDot: Double, meanMotionDdot: Double, semiMajorAxis: Double, period: Double, apogee: Double, perigee: Double, line1Offset: Int, line2Offset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endManifoldElset_Abridged(builder)
        }
        fun startManifoldElset_Abridged(builder: FlatBufferBuilder) = builder.startTable(27)
        ...
        fun endManifoldElset_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishManifoldElsetAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MANI")
        fun finishSizePrefixedManifoldElset_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MANI")
    }
}
