 ...
 */
@Suppress("unused")
class AirspaceTimePeriod_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirspaceTimePeriod_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirspaceTimePeriod_Full(_bb: ByteBuffer): AirspaceTimePeriod_Full = getRootAsAirspaceTimePeriod_Full(_bb, AirspaceTimePeriod_Full())
        fun getRootAsAirspaceTimePeriod_Full(_bb: ByteBuffer, obj: AirspaceTimePeriod_Full): AirspaceTimePeriod_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirspaceTimePeriod_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRS")
        fun createAirspaceTimePeriod_Full(builder: FlatBufferBuilder, timeModeOffset: Int, timeStartOffset: Int, timeEndOffset: Int, intFreqOffset: Int, intDurOffset: Int) : Int {
            ...
            return endAirspaceTimePeriod_Full(builder)
        }
        fun startAirspaceTimePeriod_Full(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endAirspaceTimePeriod_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirspaceTimePeriodFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRS")
        fun finishSizePrefixedAirspaceTimePeriod_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRS")
    }
}
