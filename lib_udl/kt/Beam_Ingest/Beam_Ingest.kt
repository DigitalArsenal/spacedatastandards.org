 ...
 */
@Suppress("unused")
class Beam_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Beam_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsBeam_Ingest(_bb: ByteBuffer): Beam_Ingest = getRootAsBeam_Ingest(_bb, Beam_Ingest())
        fun getRootAsBeam_Ingest(_bb: ByteBuffer, obj: Beam_Ingest): Beam_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Beam_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "BEAM")
        fun createBeam_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, beamNameOffset: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endBeam_Ingest(builder)
        }
        fun startBeam_Ingest(builder: FlatBufferBuilder) = builder.startTable(10)
        ...
        fun endBeam_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishBeamIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "BEAM")
        fun finishSizePrefixedBeam_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "BEAM")
    }
}
