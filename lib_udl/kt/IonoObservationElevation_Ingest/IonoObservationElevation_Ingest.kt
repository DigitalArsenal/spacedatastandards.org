 ...
 */
@Suppress("unused")
class IonoObservationElevation_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationElevation_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationElevation_Ingest(_bb: ByteBuffer): IonoObservationElevation_Ingest = getRootAsIonoObservationElevation_Ingest(_bb, IonoObservationElevation_Ingest())
        fun getRootAsIonoObservationElevation_Ingest(_bb: ByteBuffer, obj: IonoObservationElevation_Ingest): IonoObservationElevation_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationElevation_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationElevation_Ingest(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int) : Int {
            ...
            return endIonoObservationElevation_Ingest(builder)
        }
        fun startIonoObservationElevation_Ingest(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationElevation_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationElevationIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationElevation_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
