 ...
 */
@Suppress("unused")
class SubStatus_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SubStatus_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSubStatus_Full(_bb: ByteBuffer): SubStatus_Full = getRootAsSubStatus_Full(_bb, SubStatus_Full())
        fun getRootAsSubStatus_Full(_bb: ByteBuffer, obj: SubStatus_Full): SubStatus_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SubStatus_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SUBS")
        fun createSubStatus_Full(builder: FlatBufferBuilder, idOffset: Int, type: Byte, classificationMarkingOffset: Int, statusIdOffset: Int, status: Byte, notesOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int) : Int {
            ...
            return endSubStatus_Full(builder)
        }
        fun startSubStatus_Full(builder: FlatBufferBuilder) = builder.startTable(14)
        ...
        fun endSubStatus_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSubStatusFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SUBS")
        fun finishSizePrefixedSubStatus_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SUBS")
    }
}
