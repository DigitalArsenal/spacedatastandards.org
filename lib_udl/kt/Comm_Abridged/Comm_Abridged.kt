 ...
 */
@Suppress("unused")
class Comm_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Comm_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsComm_Abridged(_bb: ByteBuffer): Comm_Abridged = getRootAsComm_Abridged(_bb, Comm_Abridged())
        fun getRootAsComm_Abridged(_bb: ByteBuffer, obj: Comm_Abridged): Comm_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Comm_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "COMM")
        fun createComm_Abridged(builder: FlatBufferBuilder, idOffset: Int, idEntityOffset: Int, nameOffset: Int, classificationMarkingOffset: Int, descriptionOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int) : Int {
            ...
            return endComm_Abridged(builder)
        }
        fun startComm_Abridged(builder: FlatBufferBuilder) = builder.startTable(11)
        ...
        fun endComm_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishCommAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "COMM")
        fun finishSizePrefixedComm_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "COMM")
    }
}
