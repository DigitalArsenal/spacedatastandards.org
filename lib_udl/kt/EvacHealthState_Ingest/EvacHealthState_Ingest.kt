 ...
 */
@Suppress("unused")
class EvacHealthState_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EvacHealthState_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEvacHealthState_Ingest(_bb: ByteBuffer): EvacHealthState_Ingest = getRootAsEvacHealthState_Ingest(_bb, EvacHealthState_Ingest())
        fun getRootAsEvacHealthState_Ingest(_bb: ByteBuffer, obj: EvacHealthState_Ingest): EvacHealthState_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EvacHealthState_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EVAC")
        fun createEvacHealthState_Ingest(builder: FlatBufferBuilder, typeOffset: Int, healthStateCodeOffset: Int, medConfFactor: Int, timeOffset: Int) : Int {
            ...
            return endEvacHealthState_Ingest(builder)
        }
        fun startEvacHealthState_Ingest(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endEvacHealthState_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEvacHealthStateIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EVAC")
        fun finishSizePrefixedEvacHealthState_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EVAC")
    }
}
