 ...
 */
@Suppress("unused")
class OnorbitSolarArray_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitSolarArray_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val solarArrayAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(28, 1)
    fun solarArrayInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 28, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbitSolarArray_Full(_bb: ByteBuffer): OnorbitSolarArray_Full = getRootAsOnorbitSolarArray_Full(_bb, OnorbitSolarArray_Full())
        fun getRootAsOnorbitSolarArray_Full(_bb: ByteBuffer, obj: OnorbitSolarArray_Full): OnorbitSolarArray_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitSolarArray_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitSolarArray_Full(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, idSolarArrayOffset: Int, classificationMarkingOffset: Int, quantity: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, solarArrayOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endOnorbitSolarArray_Full(builder)
        }
        fun startOnorbitSolarArray_Full(builder: FlatBufferBuilder) = builder.startTable(14)
        ...
        fun addSolarArray(builder: FlatBufferBuilder, solarArray: Int) = builder.addOffset(12, solarArray, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(13, origNetwork, 0)
        fun endOnorbitSolarArray_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitSolarArrayFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitSolarArray_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
