 ...
 */
@Suppress("unused")
class SOICalibration_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SOICalibration_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSOICalibration_Ingest(_bb: ByteBuffer): SOICalibration_Ingest = getRootAsSOICalibration_Ingest(_bb, SOICalibration_Ingest())
        fun getRootAsSOICalibration_Ingest(_bb: ByteBuffer, obj: SOICalibration_Ingest): SOICalibration_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SOICalibration_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SOIC")
        fun createSOICalibration_Ingest(builder: FlatBufferBuilder, calExtinctionCoeff: Double, calSkyBg: Double, calBgIntensity: Double, calSpectralFilterSolarMag: Double, calZeroPoint: Double, calNumDetectedStars: Int, calNumCorrelatedStars: Int, calExtinctionCoeffUnc: Double, calExtinctionCoeffMaxUnc: Double, calTimeOffset: Int, calTypeOffset: Int) : Int {
            ...
            return endSOICalibration_Ingest(builder)
        }
        fun startSOICalibration_Ingest(builder: FlatBufferBuilder) = builder.startTable(11)
        ...
        fun endSOICalibration_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSOICalibrationIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SOIC")
        fun finishSizePrefixedSOICalibration_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SOIC")
    }
}
