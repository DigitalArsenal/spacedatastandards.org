 ...
 */
@Suppress("unused")
class AltitudeBlocks_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AltitudeBlocks_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAltitudeBlocks_Ingest(_bb: ByteBuffer): AltitudeBlocks_Ingest = getRootAsAltitudeBlocks_Ingest(_bb, AltitudeBlocks_Ingest())
        fun getRootAsAltitudeBlocks_Ingest(_bb: ByteBuffer, obj: AltitudeBlocks_Ingest): AltitudeBlocks_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AltitudeBlocks_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ALTI")
        fun createAltitudeBlocks_Ingest(builder: FlatBufferBuilder, altitudeSequenceIdOffset: Int, lowerAltitude: Double, upperAltitude: Double) : Int {
            ...
            return endAltitudeBlocks_Ingest(builder)
        }
        fun startAltitudeBlocks_Ingest(builder: FlatBufferBuilder) = builder.startTable(3)
        ...
        fun endAltitudeBlocks_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAltitudeBlocksIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ALTI")
        fun finishSizePrefixedAltitudeBlocks_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ALTI")
    }
}
