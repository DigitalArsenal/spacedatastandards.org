 ...
 */
@Suppress("unused")
class OnorbitSolarArray_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitSolarArray_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbitSolarArray_Ingest(_bb: ByteBuffer): OnorbitSolarArray_Ingest = getRootAsOnorbitSolarArray_Ingest(_bb, OnorbitSolarArray_Ingest())
        fun getRootAsOnorbitSolarArray_Ingest(_bb: ByteBuffer, obj: OnorbitSolarArray_Ingest): OnorbitSolarArray_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitSolarArray_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitSolarArray_Ingest(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, idSolarArrayOffset: Int, classificationMarkingOffset: Int, quantity: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, solarArrayOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endOnorbitSolarArray_Ingest(builder)
        }
        fun startOnorbitSolarArray_Ingest(builder: FlatBufferBuilder) = builder.startTable(12)
        ...
        fun endOnorbitSolarArray_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitSolarArrayIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitSolarArray_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
