 ...
 */
@Suppress("unused")
class VideoStreams_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : VideoStreams_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsVideoStreams_Ingest(_bb: ByteBuffer): VideoStreams_Ingest = getRootAsVideoStreams_Ingest(_bb, VideoStreams_Ingest())
        fun getRootAsVideoStreams_Ingest(_bb: ByteBuffer, obj: VideoStreams_Ingest): VideoStreams_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun VideoStreams_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "VIDE")
        fun createVideoStreams_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, nameOffset: Int, descriptionOffset: Int, startTimeOffset: Int, stopTimeOffset: Int, sourceOffset: Int, tokenValueOffset: Int, videoUrlsOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, origNetworkOffset: Int, originOffset: Int) : Int {
            ...
            return endVideoStreams_Ingest(builder)
        }
        fun startVideoStreams_Ingest(builder: FlatBufferBuilder) = builder.startTable(14)
        ...
        fun endVideoStreams_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishVideoStreamsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "VIDE")
        fun finishSizePrefixedVideoStreams_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "VIDE")
    }
}
