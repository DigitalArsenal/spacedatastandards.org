 ...
 */
@Suppress("unused")
class IonoObservationPolarization_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationPolarization_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationPolarization_Full(_bb: ByteBuffer): IonoObservationPolarization_Full = getRootAsIonoObservationPolarization_Full(_bb, IonoObservationPolarization_Full())
        fun getRootAsIonoObservationPolarization_Full(_bb: ByteBuffer, obj: IonoObservationPolarization_Full): IonoObservationPolarization_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationPolarization_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationPolarization_Full(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, data: Byte) : Int {
            ...
            return endIonoObservationPolarization_Full(builder)
        }
        fun startIonoObservationPolarization_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationPolarization_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationPolarizationFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationPolarization_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
