 ...
 */
@Suppress("unused")
class StateVector_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : StateVector_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val algorithmAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(174, 1)
    fun algorithmInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 174, 1)
    /**
    ...
    val createdAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(176, 1)
    fun createdAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 176, 1)
    /**
    ...
    val createdByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(178, 1)
    fun createdByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 178, 1)
    /**
    ...
    val descriptorAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(180, 1)
    fun descriptorInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 180, 1)
    /**
    ...
    val transactionIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(182, 1)
    fun transactionIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 182, 1)
    /**
    ...
    companion object {
        ...
        fun createStateVector_Abridged(builder: FlatBufferBuilder, idStateVectorOffset: Int, classificationMarkingOffset: Int, epochOffset: Int, pedigreeOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, idOrbitDeterminationOffset: Int, uct: Boolean, xpos: Double, ypos: Double, zpos: Double, xvel: Double, yvel: Double, zvel: Double, referenceFrame: Byte, covOffset: Int, covReferenceFrame: Byte, covMethodOffset: Int, eqCovOffset: Int, xposAlt1: Double, yposAlt1: Double, zposAlt1: Double, xvelAlt1: Double, yvelAlt1: Double, zvelAlt1: Double, alt1ReferenceFrameOffset: Int, xposAlt2: Double, yposAlt2: Double, zposAlt2: Double, xvelAlt2: Double, yvelAlt2: Double, zvelAlt2: Double, alt2ReferenceFrameOffset: Int, posUnc: Double, velUnc: Double, mass: Double, area: Double, solarRadPressCoeff: Double, dragCoeff: Double, dragArea: Double, revNo: Int, geopotentialModelOffset: Int, dragModelOffset: Int, lunarSolar: Boolean, solarRadPress: Boolean, srpArea: Double, solidEarthTides: Boolean, inTrackThrust: Boolean, bDot: Double, edr: Double, thrustAccel: Double, cmOffset: Double, lastObStartOffset: Int, lastObEndOffset: Int, obsAvailable: Int, obsUsed: Int, tracksAvail: Int, tracksUsed: Int, recOdspan: Double, actualOdspan: Double, residualsAcc: Double, solarFluxF10: Double, solarFluxF10Avg: Double, solarFluxApavg: Double, taiUtc: Double, ut1Utc: Double, ut1Rate: Double, polarMotionX: Double, polarMotionY: Double, iau1980Terms: Int, leapSecondTimeOffset: Int, integratorModeOffset: Int, partialsOffset: Int, stepModeOffset: Int, fixedStep: Boolean, stepSizeSelectionOffset: Int, stepSize: Double, errorControl: Double, sigmaPosUvwOffset: Int, sigmaVelUvwOffset: Int, rms: Double, sourceOffset: Int, originOffset: Int, dataMode: Byte, algorithmOffset: Int, createdAtOffset: Int, createdByOffset: Int, descriptorOffset: Int, transactionIdOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int) : Int {
            ...
            addUct(builder, uct)
            return endStateVector_Abridged(builder)
        }
        fun startStateVector_Abridged(builder: FlatBufferBuilder) = builder.startTable(92)
        ...
        fun addAlgorithm(builder: FlatBufferBuilder, algorithm: Int) = builder.addOffset(85, algorithm, 0)
        fun addCreatedAt(builder: FlatBufferBuilder, createdAt: Int) = builder.addOffset(86, createdAt, 0)
        fun addCreatedBy(builder: FlatBufferBuilder, createdBy: Int) = builder.addOffset(87, createdBy, 0)
        fun addDescriptor(builder: FlatBufferBuilder, descriptor: Int) = builder.addOffset(88, descriptor, 0)
        fun addTransactionId(builder: FlatBufferBuilder, transactionId: Int) = builder.addOffset(89, transactionId, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(90, origNetwork, 0)
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(91, sourceDl, 0)
        fun endStateVector_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishStateVectorAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "STAT")
        fun finishSizePrefixedStateVector_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "STAT")
    }
}
