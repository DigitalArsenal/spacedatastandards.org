 ...
 */
@Suppress("unused")
class AirfieldStatus_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirfieldStatus_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createAirfieldStatus_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idAirfieldOffset: Int, altAirfieldIdOffset: Int, passengerServiceMog: Int, fleetServiceMog: Int, cargoMog: Int, fuelMog: Int, fuelTypesOffset: Int, fuelQtysOffset: Int, mxMog: Int, operatingMog: Int, numCog: Int, wideWorkingMog: Int, wideParkingMog: Int, narrowWorkingMog: Int, narrowParkingMog: Int, mheTypesOffset: Int, mheQtysOffset: Int, medCapOffset: Int, arffCatOffset: Int, gseTime: Int, priRwyNumOffset: Int, rwyCondReading: Int, rwyFrictionFactor: Int, rwyMarkingsOffset: Int, messageOffset: Int, priFreq: Double, slotTypesReqOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endAirfieldStatus_Abridged(builder)
        }
        fun startAirfieldStatus_Abridged(builder: FlatBufferBuilder) = builder.startTable(36)
        ...
        fun endAirfieldStatus_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirfieldStatusAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRF")
        fun finishSizePrefixedAirfieldStatus_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRF")
    }
}
