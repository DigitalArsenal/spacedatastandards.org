 ...
 */
@Suppress("unused")
class PersonnelRecoveryExecutionInfo_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : PersonnelRecoveryExecutionInfo_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsPersonnelRecoveryExecutionInfo_Ingest(_bb: ByteBuffer): PersonnelRecoveryExecutionInfo_Ingest = getRootAsPersonnelRecoveryExecutionInfo_Ingest(_bb, PersonnelRecoveryExecutionInfo_Ingest())
        fun getRootAsPersonnelRecoveryExecutionInfo_Ingest(_bb: ByteBuffer, obj: PersonnelRecoveryExecutionInfo_Ingest): PersonnelRecoveryExecutionInfo_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun PersonnelRecoveryExecutionInfo_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "PERS")
        fun createPersonnelRecoveryExecutionInfo_Ingest(builder: FlatBufferBuilder, initialPointOffset: Int, ingress: Double, objStrategyOffset: Int, egressPointOffset: Int, egress: Double, recoveryVehicleOffset: Int, escortVehicleOffset: Int) : Int {
            ...
            return endPersonnelRecoveryExecutionInfo_Ingest(builder)
        }
        fun startPersonnelRecoveryExecutionInfo_Ingest(builder: FlatBufferBuilder) = builder.startTable(7)
        ...
        fun endPersonnelRecoveryExecutionInfo_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishPersonnelRecoveryExecutionInfoIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "PERS")
        fun finishSizePrefixedPersonnelRecoveryExecutionInfo_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "PERS")
    }
}
