 ...
 */
@Suppress("unused")
class PersonnelRecoveryEnemyData_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : PersonnelRecoveryEnemyData_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsPersonnelRecoveryEnemyData_Ingest(_bb: ByteBuffer): PersonnelRecoveryEnemyData_Ingest = getRootAsPersonnelRecoveryEnemyData_Ingest(_bb, PersonnelRecoveryEnemyData_Ingest())
        fun getRootAsPersonnelRecoveryEnemyData_Ingest(_bb: ByteBuffer, obj: PersonnelRecoveryEnemyData_Ingest): PersonnelRecoveryEnemyData_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun PersonnelRecoveryEnemyData_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "PERS")
        fun createPersonnelRecoveryEnemyData_Ingest(builder: FlatBufferBuilder, dirToEnemyOffset: Int, hostileFireTypeOffset: Int, friendliesRemarksOffset: Int, hlzRemarksOffset: Int) : Int {
            ...
            return endPersonnelRecoveryEnemyData_Ingest(builder)
        }
        fun startPersonnelRecoveryEnemyData_Ingest(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endPersonnelRecoveryEnemyData_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishPersonnelRecoveryEnemyDataIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "PERS")
        fun finishSizePrefixedPersonnelRecoveryEnemyData_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "PERS")
    }
}
