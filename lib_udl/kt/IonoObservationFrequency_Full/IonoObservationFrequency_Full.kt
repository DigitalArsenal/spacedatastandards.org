 ...
 */
@Suppress("unused")
class IonoObservationFrequency_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationFrequency_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationFrequency_Full(_bb: ByteBuffer): IonoObservationFrequency_Full = getRootAsIonoObservationFrequency_Full(_bb, IonoObservationFrequency_Full())
        fun getRootAsIonoObservationFrequency_Full(_bb: ByteBuffer, obj: IonoObservationFrequency_Full): IonoObservationFrequency_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationFrequency_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationFrequency_Full(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int) : Int {
            ...
            return endIonoObservationFrequency_Full(builder)
        }
        fun startIonoObservationFrequency_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationFrequency_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationFrequencyFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationFrequency_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
