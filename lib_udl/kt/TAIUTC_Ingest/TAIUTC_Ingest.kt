 ...
 */
@Suppress("unused")
class TAIUTC_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : TAIUTC_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsTAIUTC_Ingest(_bb: ByteBuffer): TAIUTC_Ingest = getRootAsTAIUTC_Ingest(_bb, TAIUTC_Ingest())
        fun getRootAsTAIUTC_Ingest(_bb: ByteBuffer, obj: TAIUTC_Ingest): TAIUTC_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun TAIUTC_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "TAIU")
        fun createTAIUTC_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, adjustmentDateOffset: Int, taiUtc: Double, multiplicationFactor: Double, rawFileUriOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int) : Int {
            ...
            return endTAIUTC_Ingest(builder)
        }
        fun startTAIUTC_Ingest(builder: FlatBufferBuilder) = builder.startTable(12)
        ...
        fun endTAIUTC_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishTAIUTCIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "TAIU")
        fun finishSizePrefixedTAIUTC_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "TAIU")
    }
}
