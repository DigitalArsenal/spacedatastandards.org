 ...
 */
@Suppress("unused")
class DiplomaticClearance_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DiplomaticClearance_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDiplomaticClearance_Ingest(_bb: ByteBuffer): DiplomaticClearance_Ingest = getRootAsDiplomaticClearance_Ingest(_bb, DiplomaticClearance_Ingest())
        fun getRootAsDiplomaticClearance_Ingest(_bb: ByteBuffer, obj: DiplomaticClearance_Ingest): DiplomaticClearance_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DiplomaticClearance_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DIPL")
        fun createDiplomaticClearance_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idMissionOffset: Int, externalWorksheetIdOffset: Int, dipWorksheetNameOffset: Int, firstDepDateOffset: Int, docDeadlineOffset: Int, apacsIdOffset: Int, diplomaticClearanceDetailsOffset: Int, diplomaticClearanceRemarksOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endDiplomaticClearance_Ingest(builder)
        }
        fun startDiplomaticClearance_Ingest(builder: FlatBufferBuilder) = builder.startTable(19)
        ...
        fun endDiplomaticClearance_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDiplomaticClearanceIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DIPL")
        fun finishSizePrefixedDiplomaticClearance_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DIPL")
    }
}
