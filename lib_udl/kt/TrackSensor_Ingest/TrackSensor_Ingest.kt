 ...
 */
@Suppress("unused")
class TrackSensor_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : TrackSensor_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsTrackSensor_Ingest(_bb: ByteBuffer): TrackSensor_Ingest = getRootAsTrackSensor_Ingest(_bb, TrackSensor_Ingest())
        fun getRootAsTrackSensor_Ingest(_bb: ByteBuffer, obj: TrackSensor_Ingest): TrackSensor_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun TrackSensor_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "TRAC")
        fun createTrackSensor_Ingest(builder: FlatBufferBuilder, range: Double, az: Double, sensorNumber: Int, sensorNameOffset: Int, missionNumberOffset: Int, minRangeLimit: Double, sensorFovtype: Byte) : Int {
            ...
            return endTrackSensor_Ingest(builder)
        }
        fun startTrackSensor_Ingest(builder: FlatBufferBuilder) = builder.startTable(7)
        ...
        fun endTrackSensor_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishTrackSensorIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "TRAC")
        fun finishSizePrefixedTrackSensor_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "TRAC")
    }
}
