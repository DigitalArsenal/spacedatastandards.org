 ...
 */
@Suppress("unused")
class OnorbitThrusterStatus_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitThrusterStatus_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbitThrusterStatus_Full(_bb: ByteBuffer): OnorbitThrusterStatus_Full = getRootAsOnorbitThrusterStatus_Full(_bb, OnorbitThrusterStatus_Full())
        fun getRootAsOnorbitThrusterStatus_Full(_bb: ByteBuffer, obj: OnorbitThrusterStatus_Full): OnorbitThrusterStatus_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitThrusterStatus_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitThrusterStatus_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnorbitThrusterOffset: Int, nameOffset: Int, statusTimeOffset: Int, propMassMin: Double, propMassAvg: Double, propMassMedian: Double, propMassMax: Double, fuelMass: Double, fuelMassUnc: Double, totalDeltaV: Double, minDeltaV: Double, estDeltaV: Double, maxDeltaV: Double, thrustMax: Double, isp: Double, operational: Boolean, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endOnorbitThrusterStatus_Full(builder)
        }
        fun startOnorbitThrusterStatus_Full(builder: FlatBufferBuilder) = builder.startTable(24)
        ...
        fun endOnorbitThrusterStatus_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitThrusterStatusFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitThrusterStatus_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
