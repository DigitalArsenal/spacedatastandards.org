 ...
 */
@Suppress("unused")
class DataLinkMultiDuty_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DataLinkMultiDuty_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDataLinkMultiDuty_Abridged(_bb: ByteBuffer): DataLinkMultiDuty_Abridged = getRootAsDataLinkMultiDuty_Abridged(_bb, DataLinkMultiDuty_Abridged())
        fun getRootAsDataLinkMultiDuty_Abridged(_bb: ByteBuffer, obj: DataLinkMultiDuty_Abridged): DataLinkMultiDuty_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DataLinkMultiDuty_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DATA")
        fun createDataLinkMultiDuty_Abridged(builder: FlatBufferBuilder, unitDesOffset: Int, nameOffset: Int, rankOffset: Int, dutyOffset: Int, dutyTeleFreqNumsOffset: Int, multiDutyVoiceCoordOffset: Int) : Int {
            ...
            return endDataLinkMultiDuty_Abridged(builder)
        }
        fun startDataLinkMultiDuty_Abridged(builder: FlatBufferBuilder) = builder.startTable(6)
        ...
        fun endDataLinkMultiDuty_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDataLinkMultiDutyAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DATA")
        fun finishSizePrefixedDataLinkMultiDuty_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DATA")
    }
}
