 ...
 */
@Suppress("unused")
class OnorbitSolarArray : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitSolarArray {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbitSolarArray(_bb: ByteBuffer): OnorbitSolarArray = getRootAsOnorbitSolarArray(_bb, OnorbitSolarArray())
        fun getRootAsOnorbitSolarArray(_bb: ByteBuffer, obj: OnorbitSolarArray): OnorbitSolarArray {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitSolarArrayBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitSolarArray(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, idSolarArrayOffset: Int, classificationMarkingOffset: Int, quantity: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, solarArrayOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endOnorbitSolarArray(builder)
        }
        fun startOnorbitSolarArray(builder: FlatBufferBuilder) = builder.startTable(14)
        ...
        fun endOnorbitSolarArray(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitSolarArrayBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitSolarArrayBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
