 ...
 */
@Suppress("unused")
class MtiHRR_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : MtiHRR_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsMtiHRR_Full(_bb: ByteBuffer): MtiHRR_Full = getRootAsMtiHRR_Full(_bb, MtiHRR_Full())
        fun getRootAsMtiHRR_Full(_bb: ByteBuffer, obj: MtiHRR_Full): MtiHRR_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun MtiHRR_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MTIH")
        fun createMtiHRR_Full(builder: FlatBufferBuilder, h2: Int, h3: Int, h4: Boolean, h5: Int, h6: Int, h7: Int, h8: Int, h9: Int, h10: Int, h11: Double, h12: Double, h13: Double, h14: Double, h15: Double, h16Offset: Int, h17Offset: Int, h18Offset: Int, h19: Double, h20: Int, h21: Int, h22: Int, h23Offset: Int, h24Offset: Int, h27: Int, h28: Long, h29: Int, h30: Int, h31: Int, h32Offset: Int) : Int {
            ...
            addH2(builder, h2)
            addH4(builder, h4)
            return endMtiHRR_Full(builder)
        }
        fun startMtiHRR_Full(builder: FlatBufferBuilder) = builder.startTable(29)
        ...
        fun endMtiHRR_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMtiHRRFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MTIH")
        fun finishSizePrefixedMtiHRR_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MTIH")
    }
}
