 ...
 */
@Suppress("unused")
class EvacCondition_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EvacCondition_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEvacCondition_Ingest(_bb: ByteBuffer): EvacCondition_Ingest = getRootAsEvacCondition_Ingest(_bb, EvacCondition_Ingest())
        fun getRootAsEvacCondition_Ingest(_bb: ByteBuffer, obj: EvacCondition_Ingest): EvacCondition_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EvacCondition_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EVAC")
        fun createEvacCondition_Ingest(builder: FlatBufferBuilder, typeOffset: Int, bodyPartOffset: Int, timeOffset: Int, commentsOffset: Int) : Int {
            builder.startTable(4)
            addComments(builder, commentsOffset)
            addTime(builder, timeOffset)
            addBodyPart(builder, bodyPartOffset)
            addType(builder, typeOffset)
            return endEvacCondition_Ingest(builder)
        }
        fun startEvacCondition_Ingest(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endEvacCondition_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEvacConditionIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EVAC")
        fun finishSizePrefixedEvacCondition_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EVAC")
    }
}
