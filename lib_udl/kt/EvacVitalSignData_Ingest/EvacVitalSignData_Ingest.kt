 ...
 */
@Suppress("unused")
class EvacVitalSignData_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EvacVitalSignData_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEvacVitalSignData_Ingest(_bb: ByteBuffer): EvacVitalSignData_Ingest = getRootAsEvacVitalSignData_Ingest(_bb, EvacVitalSignData_Ingest())
        fun getRootAsEvacVitalSignData_Ingest(_bb: ByteBuffer, obj: EvacVitalSignData_Ingest): EvacVitalSignData_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EvacVitalSignData_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EVAC")
        fun createEvacVitalSignData_Ingest(builder: FlatBufferBuilder, vitalSignOffset: Int, vitalSign1: Double, vitalSign2: Double, medConfFactor: Int, timeOffset: Int) : Int {
            ...
            return endEvacVitalSignData_Ingest(builder)
        }
        fun startEvacVitalSignData_Ingest(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endEvacVitalSignData_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEvacVitalSignDataIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EVAC")
        fun finishSizePrefixedEvacVitalSignData_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EVAC")
    }
}
