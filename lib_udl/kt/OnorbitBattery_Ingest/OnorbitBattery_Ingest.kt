 ...
 */
@Suppress("unused")
class OnorbitBattery_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitBattery_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbitBattery_Ingest(_bb: ByteBuffer): OnorbitBattery_Ingest = getRootAsOnorbitBattery_Ingest(_bb, OnorbitBattery_Ingest())
        fun getRootAsOnorbitBattery_Ingest(_bb: ByteBuffer, obj: OnorbitBattery_Ingest): OnorbitBattery_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitBattery_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitBattery_Ingest(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, idBatteryOffset: Int, classificationMarkingOffset: Int, quantity: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int, batteryOffset: Int) : Int {
            ...
            return endOnorbitBattery_Ingest(builder)
        }
        fun startOnorbitBattery_Ingest(builder: FlatBufferBuilder) = builder.startTable(12)
        ...
        fun endOnorbitBattery_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitBatteryIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitBattery_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
