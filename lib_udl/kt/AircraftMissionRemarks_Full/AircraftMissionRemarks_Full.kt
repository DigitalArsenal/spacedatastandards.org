 ...
 */
@Suppress("unused")
class AircraftMissionRemarks_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AircraftMissionRemarks_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAircraftMissionRemarks_Full(_bb: ByteBuffer): AircraftMissionRemarks_Full = getRootAsAircraftMissionRemarks_Full(_bb, AircraftMissionRemarks_Full())
        fun getRootAsAircraftMissionRemarks_Full(_bb: ByteBuffer, obj: AircraftMissionRemarks_Full): AircraftMissionRemarks_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AircraftMissionRemarks_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRC")
        fun createAircraftMissionRemarks_Full(builder: FlatBufferBuilder, gdssRemarkIdOffset: Int, typeOffset: Int, textOffset: Int, dateOffset: Int, userOffset: Int, itineraryNum: Int) : Int {
            ...
            return endAircraftMissionRemarks_Full(builder)
        }
        fun startAircraftMissionRemarks_Full(builder: FlatBufferBuilder) = builder.startTable(6)
        ...
        fun endAircraftMissionRemarks_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAircraftMissionRemarksFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRC")
        fun finishSizePrefixedAircraftMissionRemarks_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRC")
    }
}
