 ...
 */
@Suppress("unused")
class OnorbitEvent_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitEvent_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(110, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 110, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(112, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 112, 1)
    /**
    ...
    companion object {
        ...
        fun createOnorbitEvent_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, derivedFromOffset: Int, declassificationDateOffset: Int, declassificationStringOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, eventTimeOffset: Int, eventTimeNotesOffset: Int, operatorOrgIdOffset: Int, ownerOrgIdOffset: Int, lesseeOrgIdOffset: Int, operatedOnBehalfOfOrgIdOffset: Int, geoPosition: Double, planeSlotOffset: Int, planeNumberOffset: Int, positionStatusOffset: Int, untilTimeOffset: Int, officialLossDateOffset: Int, netAmount: Double, underlyingCauseOffset: Int, capabilityLoss: Double, capacityLoss: Double, insuranceLoss: Double, thirdPartyInsuranceLoss: Double, injured: Int, killed: Int, lifeLost: Double, ageAtEvent: Double, achievedFlightPhaseOffset: Int, occurrenceFlightPhaseOffset: Int, stageAtFaultOffset: Int, equipmentAtFaultOffset: Int, equipmentTypeAtFaultOffset: Int, equipmentPartAtFaultOffset: Int, consequentialEquipmentFailureOffset: Int, inclined: Boolean, descriptionOffset: Int, remarksOffset: Int, insuranceLossNotesOffset: Int, capabilityLossNotesOffset: Int, insuranceCarriedNotesOffset: Int, equipmentCausingLossNotesOffset: Int, eventTypeOffset: Int, eventResultOffset: Int, objectStatusOffset: Int, satellitePositionOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, onOrbitOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endOnorbitEvent_Full(builder)
        }
        fun startOnorbitEvent_Full(builder: FlatBufferBuilder) = builder.startTable(57)
        ...
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(53, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(54, updatedBy, 0)
        ...
        fun endOnorbitEvent_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitEventFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitEvent_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
