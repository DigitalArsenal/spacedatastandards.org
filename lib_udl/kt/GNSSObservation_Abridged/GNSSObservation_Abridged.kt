 ...
 */
@Suppress("unused")
class GNSSObservation_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : GNSSObservation_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsGNSSObservation_Abridged(_bb: ByteBuffer): GNSSObservation_Abridged = getRootAsGNSSObservation_Abridged(_bb, GNSSObservation_Abridged())
        fun getRootAsGNSSObservation_Abridged(_bb: ByteBuffer, obj: GNSSObservation_Abridged): GNSSObservation_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun GNSSObservation_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "GNSS")
        fun createGNSSObservation_Abridged(builder: FlatBufferBuilder, gnssSatIdOffset: Int, trackingStatus: Int, agcState: Int, obsCodeSetOffset: Int, obOffset: Int) : Int {
            ...
            return endGNSSObservation_Abridged(builder)
        }
        fun startGNSSObservation_Abridged(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endGNSSObservation_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishGNSSObservationAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "GNSS")
        fun finishSizePrefixedGNSSObservation_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "GNSS")
    }
}
