 ...
 */
@Suppress("unused")
class LogisticsRemarks_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LogisticsRemarks_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLogisticsRemarks_Ingest(_bb: ByteBuffer): LogisticsRemarks_Ingest = getRootAsLogisticsRemarks_Ingest(_bb, LogisticsRemarks_Ingest())
        fun getRootAsLogisticsRemarks_Ingest(_bb: ByteBuffer, obj: LogisticsRemarks_Ingest): LogisticsRemarks_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LogisticsRemarks_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOGI")
        fun createLogisticsRemarks_Ingest(builder: FlatBufferBuilder, usernameOffset: Int, remarkOffset: Int, lastChangedOffset: Int) : Int {
            builder.startTable(3)
            addLastChanged(builder, lastChangedOffset)
            addRemark(builder, remarkOffset)
            addUsername(builder, usernameOffset)
            return endLogisticsRemarks_Ingest(builder)
        }
        fun startLogisticsRemarks_Ingest(builder: FlatBufferBuilder) = builder.startTable(3)
        ...
        fun endLogisticsRemarks_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLogisticsRemarksIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOGI")
        fun finishSizePrefixedLogisticsRemarks_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOGI")
    }
}
