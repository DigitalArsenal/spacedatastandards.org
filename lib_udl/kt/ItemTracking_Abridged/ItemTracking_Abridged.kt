 ...
 */
@Suppress("unused")
class ItemTracking_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : ItemTracking_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsItemTracking_Abridged(_bb: ByteBuffer): ItemTracking_Abridged = getRootAsItemTracking_Abridged(_bb, ItemTracking_Abridged())
        fun getRootAsItemTracking_Abridged(_bb: ByteBuffer, obj: ItemTracking_Abridged): ItemTracking_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun ItemTracking_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ITEM")
        fun createItemTracking_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, scanCodeOffset: Int, scGenToolOffset: Int, scannerIdOffset: Int, tsOffset: Int, idItemOffset: Int, typeOffset: Int, lat: Double, lon: Double, scanTypeOffset: Int, dvCodeOffset: Int, notesOffset: Int, keysOffset: Int, valuesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endItemTracking_Abridged(builder)
        }
        fun startItemTracking_Abridged(builder: FlatBufferBuilder) = builder.startTable(22)
        ...
        fun endItemTracking_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishItemTrackingAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ITEM")
        fun finishSizePrefixedItemTracking_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ITEM")
    }
}
