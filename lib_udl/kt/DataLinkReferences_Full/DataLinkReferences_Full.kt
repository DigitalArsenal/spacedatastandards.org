 ...
 */
@Suppress("unused")
class DataLinkReferences_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DataLinkReferences_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDataLinkReferences_Full(_bb: ByteBuffer): DataLinkReferences_Full = getRootAsDataLinkReferences_Full(_bb, DataLinkReferences_Full())
        fun getRootAsDataLinkReferences_Full(_bb: ByteBuffer, obj: DataLinkReferences_Full): DataLinkReferences_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DataLinkReferences_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DATA")
        fun createDataLinkReferences_Full(builder: FlatBufferBuilder, refSerialIdOffset: Int, refTypeOffset: Int, refOriginatorOffset: Int, refTsOffset: Int, refSerialNumOffset: Int, refSpecialNotationOffset: Int, refSicsOffset: Int) : Int {
            ...
            return endDataLinkReferences_Full(builder)
        }
        fun startDataLinkReferences_Full(builder: FlatBufferBuilder) = builder.startTable(7)
        ...
        fun endDataLinkReferences_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDataLinkReferencesFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DATA")
        fun finishSizePrefixedDataLinkReferences_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DATA")
    }
}
