 ...
 */
@Suppress("unused")
class MtiJobRequest_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : MtiJobRequest_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsMtiJobRequest_Ingest(_bb: ByteBuffer): MtiJobRequest_Ingest = getRootAsMtiJobRequest_Ingest(_bb, MtiJobRequest_Ingest())
        fun getRootAsMtiJobRequest_Ingest(_bb: ByteBuffer, obj: MtiJobRequest_Ingest): MtiJobRequest_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun MtiJobRequest_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MTIJ")
        fun createMtiJobRequest_Ingest(builder: FlatBufferBuilder, r1Offset: Int, r2Offset: Int, r3: Int, r4: Double, r5: Double, r6: Double, r7: Double, r8: Double, r9: Double, r10: Double, r11: Double, r12Offset: Int, r13: Int, r14: Int, jobReqEstOffset: Int, r21: Int, r22: Int, r23: Int, r24Offset: Int, r25Offset: Int, r26: Boolean) : Int {
            ...
            addR26(builder, r26)
            return endMtiJobRequest_Ingest(builder)
        }
        fun startMtiJobRequest_Ingest(builder: FlatBufferBuilder) = builder.startTable(21)
        ...
        fun endMtiJobRequest_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMtiJobRequestIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MTIJ")
        fun finishSizePrefixedMtiJobRequest_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MTIJ")
    }
}
