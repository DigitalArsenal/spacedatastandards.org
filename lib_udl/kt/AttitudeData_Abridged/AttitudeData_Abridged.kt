 ...
 */
@Suppress("unused")
class AttitudeData_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AttitudeData_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createAttitudeData_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, asIdOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, tsOffset: Int, motionTypeOffset: Int, q1: Double, q2: Double, q3: Double, qc: Double, q1Dot: Double, q2Dot: Double, q3Dot: Double, qcDot: Double, xAngleOffset: Int, yAngleOffset: Int, zAngleOffset: Int, xRateOffset: Int, yRateOffset: Int, zRateOffset: Int, ra: Double, declination: Double, coningAngle: Double, precPeriod: Double, spinPeriod: Double, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endAttitudeData_Abridged(builder)
        }
        fun startAttitudeData_Abridged(builder: FlatBufferBuilder) = builder.startTable(33)
        ...
        fun endAttitudeData_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAttitudeDataAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ATTI")
        fun finishSizePrefixedAttitudeData_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ATTI")
    }
}
