 ...
 */
@Suppress("unused")
class TAIUTC_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : TAIUTC_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsTAIUTC_Full(_bb: ByteBuffer): TAIUTC_Full = getRootAsTAIUTC_Full(_bb, TAIUTC_Full())
        fun getRootAsTAIUTC_Full(_bb: ByteBuffer, obj: TAIUTC_Full): TAIUTC_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun TAIUTC_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "TAIU")
        fun createTAIUTC_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, adjustmentDateOffset: Int, taiUtc: Double, multiplicationFactor: Double, rawFileUriOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int) : Int {
            ...
            return endTAIUTC_Full(builder)
        }
        fun startTAIUTC_Full(builder: FlatBufferBuilder) = builder.startTable(14)
        ...
        fun endTAIUTC_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishTAIUTCFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "TAIU")
        fun finishSizePrefixedTAIUTC_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "TAIU")
    }
}
