 ...
 */
@Suppress("unused")
class CrewMembers_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : CrewMembers_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsCrewMembers_Full(_bb: ByteBuffer): CrewMembers_Full = getRootAsCrewMembers_Full(_bb, CrewMembers_Full())
        fun getRootAsCrewMembers_Full(_bb: ByteBuffer, obj: CrewMembers_Full): CrewMembers_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun CrewMembers_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "CREW")
        fun createCrewMembers_Full(builder: FlatBufferBuilder, lastNameOffset: Int, firstNameOffset: Int, middleInitialOffset: Int, memberIdOffset: Int, civilian: Boolean, commander: Boolean, last4SsnOffset: Int, dodIdOffset: Int, dutyPositionOffset: Int, crewPositionOffset: Int, memberTypeOffset: Int, branchOffset: Int, rankOffset: Int, wingOffset: Int, squadronOffset: Int, memberRemarksOffset: Int, usernameOffset: Int) : Int {
            ...
            return endCrewMembers_Full(builder)
        }
        fun startCrewMembers_Full(builder: FlatBufferBuilder) = builder.startTable(17)
        ...
        fun endCrewMembers_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishCrewMembersFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "CREW")
        fun finishSizePrefixedCrewMembers_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "CREW")
    }
}
