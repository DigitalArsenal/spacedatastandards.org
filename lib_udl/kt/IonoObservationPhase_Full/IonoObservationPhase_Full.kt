 ...
 */
@Suppress("unused")
class IonoObservationPhase_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationPhase_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationPhase_Full(_bb: ByteBuffer): IonoObservationPhase_Full = getRootAsIonoObservationPhase_Full(_bb, IonoObservationPhase_Full())
        fun getRootAsIonoObservationPhase_Full(_bb: ByteBuffer, obj: IonoObservationPhase_Full): IonoObservationPhase_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationPhase_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationPhase_Full(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int) : Int {
            ...
            return endIonoObservationPhase_Full(builder)
        }
        fun startIonoObservationPhase_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationPhase_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationPhaseFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationPhase_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
