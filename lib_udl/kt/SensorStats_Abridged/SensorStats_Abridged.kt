 ...
 */
@Suppress("unused")
class SensorStats_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SensorStats_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSensorStats_Abridged(_bb: ByteBuffer): SensorStats_Abridged = getRootAsSensorStats_Abridged(_bb, SensorStats_Abridged())
        fun getRootAsSensorStats_Abridged(_bb: ByteBuffer, obj: SensorStats_Abridged): SensorStats_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SensorStats_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SENS")
        fun createSensorStats_Abridged(builder: FlatBufferBuilder, idOffset: Int, idSensorOffset: Int, classificationMarkingOffset: Int, lastObTimeOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, dataMode: Byte) : Int {
            ...
            return endSensorStats_Abridged(builder)
        }
        fun startSensorStats_Abridged(builder: FlatBufferBuilder) = builder.startTable(10)
        ...
        fun endSensorStats_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSensorStatsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SENS")
        fun finishSizePrefixedSensorStats_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SENS")
    }
}
