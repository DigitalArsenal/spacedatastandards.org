 ...
 */
@Suppress("unused")
class IonoObservationCharAtts_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationCharAtts_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationCharAtts_Abridged(_bb: ByteBuffer): IonoObservationCharAtts_Abridged = getRootAsIonoObservationCharAtts_Abridged(_bb, IonoObservationCharAtts_Abridged())
        fun getRootAsIonoObservationCharAtts_Abridged(_bb: ByteBuffer, obj: IonoObservationCharAtts_Abridged): IonoObservationCharAtts_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationCharAtts_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationCharAtts_Abridged(builder: FlatBufferBuilder, ursiIdOffset: Int, charNameOffset: Int, lowerBound: Double, upperBound: Double, qOffset: Int, dOffset: Int, climateModelNameOffset: Int, climateModelOptionsOffset: Int, climateModelInputParamsOffset: Int, uncertaintyBoundTypeOffset: Int) : Int {
            ...
            return endIonoObservationCharAtts_Abridged(builder)
        }
        fun startIonoObservationCharAtts_Abridged(builder: FlatBufferBuilder) = builder.startTable(10)
        ...
        fun endIonoObservationCharAtts_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationCharAttsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationCharAtts_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
